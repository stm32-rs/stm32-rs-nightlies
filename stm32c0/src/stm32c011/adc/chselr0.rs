...
///Field `CHSEL(0-22)` reader - Channel-%s selection
...
///Field `CHSEL(0-22)` writer - Channel-%s selection
...
impl R {
    ...
    pub fn chsel_iter(&self) -> impl Iterator<Item = CHSEL_R> + '_ {
        (0..23).map(move |n| CHSEL_R::new(((self.bits >> n) & 1) != 0))
    }
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `CHSEL0` field.</div>
    #[inline(always)]
    pub fn chsel(&mut self, n: u8) -> CHSEL_W<'_, CHSELR0rs> {
        #[allow(clippy::no_effect)]
        [(); 23][n as usize];
        CHSEL_W::new(self, n)
    }
    ///Bit 0 - Channel-0 selection
    #[inline(always)]
    pub fn chsel0(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 0)
    }
    ///Bit 1 - Channel-1 selection
    #[inline(always)]
    pub fn chsel1(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 1)
    }
    ///Bit 2 - Channel-2 selection
    #[inline(always)]
    pub fn chsel2(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 2)
    }
    ///Bit 3 - Channel-3 selection
    #[inline(always)]
    pub fn chsel3(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 3)
    }
    ///Bit 4 - Channel-4 selection
    #[inline(always)]
    pub fn chsel4(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 4)
    }
    ///Bit 5 - Channel-5 selection
    #[inline(always)]
    pub fn chsel5(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 5)
    }
    ///Bit 6 - Channel-6 selection
    #[inline(always)]
    pub fn chsel6(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 6)
    }
    ///Bit 7 - Channel-7 selection
    #[inline(always)]
    pub fn chsel7(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 7)
    }
    ///Bit 8 - Channel-8 selection
    #[inline(always)]
    pub fn chsel8(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 8)
    }
    ///Bit 9 - Channel-9 selection
    #[inline(always)]
    pub fn chsel9(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 9)
    }
    ///Bit 10 - Channel-10 selection
    #[inline(always)]
    pub fn chsel10(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 10)
    }
    ///Bit 11 - Channel-11 selection
    #[inline(always)]
    pub fn chsel11(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 11)
    }
    ///Bit 12 - Channel-12 selection
    #[inline(always)]
    pub fn chsel12(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 12)
    }
    ///Bit 13 - Channel-13 selection
    #[inline(always)]
    pub fn chsel13(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 13)
    }
    ///Bit 14 - Channel-14 selection
    #[inline(always)]
    pub fn chsel14(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 14)
    }
    ///Bit 15 - Channel-15 selection
    #[inline(always)]
    pub fn chsel15(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 15)
    }
    ///Bit 16 - Channel-16 selection
    #[inline(always)]
    pub fn chsel16(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 16)
    }
    ///Bit 17 - Channel-17 selection
    #[inline(always)]
    pub fn chsel17(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 17)
    }
    ///Bit 18 - Channel-18 selection
    #[inline(always)]
    pub fn chsel18(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 18)
    }
    ///Bit 19 - Channel-19 selection
    #[inline(always)]
    pub fn chsel19(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 19)
    }
    ///Bit 20 - Channel-20 selection
    #[inline(always)]
    pub fn chsel20(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 20)
    }
    ///Bit 21 - Channel-21 selection
    #[inline(always)]
    pub fn chsel21(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 21)
    }
    ///Bit 22 - Channel-22 selection
    #[inline(always)]
    pub fn chsel22(&mut self) -> CHSEL_W<'_, CHSELR0rs> {
        CHSEL_W::new(self, 22)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#ADC:CHSELR0)*/
