...
impl R {
    ///Channel (1-3) Global interrupt flag
    ///
    ...
    pub fn gif_iter(&self) -> impl Iterator<Item = GIF_R> + '_ {
        (0..3).map(move |n| GIF_R::new(((self.bits >> (n * 4)) & 1) != 0))
    }
    ...
    ///Channel (1-3) Transfer Complete flag
    ///
    ...
    pub fn tcif_iter(&self) -> impl Iterator<Item = TCIF_R> + '_ {
        (0..3).map(move |n| TCIF_R::new(((self.bits >> (n * 4 + 1)) & 1) != 0))
    }
    ...
    ///Channel (1-3) Half Transfer Complete flag
    ///
    ...
    pub fn htif_iter(&self) -> impl Iterator<Item = HTIF_R> + '_ {
        (0..3).map(move |n| HTIF_R::new(((self.bits >> (n * 4 + 2)) & 1) != 0))
    }
    ...
    ///Channel (1-3) Transfer Error flag
    ///
    ...
    pub fn teif_iter(&self) -> impl Iterator<Item = TEIF_R> + '_ {
        (0..3).map(move |n| TEIF_R::new(((self.bits >> (n * 4 + 3)) & 1) != 0))
    }
