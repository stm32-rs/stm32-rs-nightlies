...
impl RegisterBlock {
    #[doc = "0x00..0x0c - DMA Multiplexer Channel %s Control register"]
    #[inline(always)]
    ...
    #[doc = "0x100..0x110 - DMAMUX request generator channel %s configuration register"]
    #[inline(always)]
