...
impl RegisterBlock {
    ///0x00..0x0c - DMA Multiplexer Channel %s Control register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#DMAMUX:CCR[0])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#DMAMUX:CSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#DMAMUX:CFR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#DMAMUX:RGCR[0])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#DMAMUX:RGCFR)
