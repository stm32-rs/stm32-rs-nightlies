...
impl W {
    ///Bits 0:7 - EXTIm GPIO port selection (m = 4 * (x - 1)) These bits are written by software to select the source input for EXTIm external interrupt. Other: reserved
    #[inline(always)]
    pub fn exti0(&mut self) -> EXTI0_W<EXTICR3rs> {
        EXTI0_W::new(self, 0)
    }
    ///Bits 8:15
    #[inline(always)]
    pub fn exti1(&mut self) -> EXTI1_W<EXTICR3rs> {
        EXTI1_W::new(self, 8)
    }
    ///Bits 16:23
    #[inline(always)]
    pub fn exti2(&mut self) -> EXTI2_W<EXTICR3rs> {
        EXTI2_W::new(self, 16)
    }
    ///Bits 24:31
    #[inline(always)]
    pub fn exti3(&mut self) -> EXTI3_W<EXTICR3rs> {
        EXTI3_W::new(self, 24)
    }
}
