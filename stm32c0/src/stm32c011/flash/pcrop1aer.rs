...
pub type PCROP1A_END_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
impl R {
    ///Bits 0:5 - PCROP1A area end offset Contains the offset of the last subpage of the PCROP1A area. Note: The number of effective bits depends on the size of the flash memory in the device.
    #[inline(always)]
    pub fn pcrop1a_end(&self) -> PCROP1A_END_R {
        PCROP1A_END_R::new((self.bits & 0x3f) as u8)
    }
