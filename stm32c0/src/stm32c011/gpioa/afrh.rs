...
///Field `AFSEL(8-15)` reader - Alternate function selection for port x, I/O y (y = 8 to 15) These bits are written by software to configure alternate function I/Os
pub use super::afrl::AFSEL_R;
///Field `AFSEL(8-15)` writer - Alternate function selection for port x, I/O y (y = 8 to 15) These bits are written by software to configure alternate function I/Os
pub use super::afrl::AFSEL_W;
///Alternate function selection for port x, I/O y (y = 8 to 15) These bits are written by software to configure alternate function I/Os
