...
///Field `AFSEL(0-7)` reader - Alternate function selection for port x pin y (y = 0 to 7) These bits are written by software to configure alternate function I/Os
...
///Field `AFSEL(0-7)` writer - Alternate function selection for port x pin y (y = 0 to 7) These bits are written by software to configure alternate function I/Os
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#GPIOA:AFRL)*/
pub struct AFRLrs;
