...
///Field `ID0` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID0_R = crate::BitReader;
///Field `ID1` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID1_R = crate::BitReader;
///Field `ID2` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID2_R = crate::BitReader;
///Field `ID3` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID3_R = crate::BitReader;
///Field `ID4` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID4_R = crate::BitReader;
///Field `ID5` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID5_R = crate::BitReader;
///Field `ID6` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID6_R = crate::BitReader;
///Field `ID7` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID7_R = crate::BitReader;
///Field `ID8` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID8_R = crate::BitReader;
///Field `ID9` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID9_R = crate::BitReader;
///Field `ID10` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID10_R = crate::BitReader;
///Field `ID11` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID11_R = crate::BitReader;
///Field `ID12` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID12_R = crate::BitReader;
///Field `ID13` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID13_R = crate::BitReader;
///Field `ID14` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
pub type ID14_R = crate::BitReader;
///Field `ID15` reader - Port x input data I/O y (y = 15 to 0) These bits are read-only. They contain the input value of the corresponding I/O port.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#GPIOA:IDR)*/
pub struct IDRrs;
