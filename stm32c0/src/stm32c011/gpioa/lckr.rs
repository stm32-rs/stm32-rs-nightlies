...
///Field `LCK0` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK0_R = crate::BitReader;
///Field `LCK0` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK1` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK1_R = crate::BitReader;
///Field `LCK1` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK2` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK2_R = crate::BitReader;
///Field `LCK2` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK3` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK3_R = crate::BitReader;
///Field `LCK3` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK4` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK4_R = crate::BitReader;
///Field `LCK4` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK5` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK5_R = crate::BitReader;
///Field `LCK5` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK6` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK6_R = crate::BitReader;
///Field `LCK6` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK7` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK7_R = crate::BitReader;
///Field `LCK7` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK8` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK8_R = crate::BitReader;
///Field `LCK8` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK9` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK9_R = crate::BitReader;
///Field `LCK9` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK10` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK10_R = crate::BitReader;
///Field `LCK10` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK11` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK11_R = crate::BitReader;
///Field `LCK11` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK12` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK12_R = crate::BitReader;
///Field `LCK12` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK13` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK13_R = crate::BitReader;
///Field `LCK13` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK14` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK14_R = crate::BitReader;
///Field `LCK14` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCK15` reader - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
pub type LCK15_R = crate::BitReader;
///Field `LCK15` writer - Port x lock I/O pin y (y = 15 to 0) These bits are read/write but can only be written when the LCKK bit is ‘0.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#GPIOA:LCKR)*/
pub struct LCKRrs;
