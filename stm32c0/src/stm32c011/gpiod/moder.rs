...
///Field `MODE0` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE0_R = crate::FieldReader;
///Field `MODE0` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE1` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE1_R = crate::FieldReader;
///Field `MODE1` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE2` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE2_R = crate::FieldReader;
///Field `MODE2` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE3` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE3_R = crate::FieldReader;
///Field `MODE3` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE3_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE4` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE4_R = crate::FieldReader;
///Field `MODE4` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE4_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE5` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE5_R = crate::FieldReader;
///Field `MODE5` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE5_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE6` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE6_R = crate::FieldReader;
///Field `MODE6` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE6_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE7` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE7_R = crate::FieldReader;
///Field `MODE7` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE7_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE8` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE8_R = crate::FieldReader;
///Field `MODE8` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE8_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE9` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE9_R = crate::FieldReader;
///Field `MODE9` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE9_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE10` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE10_R = crate::FieldReader;
///Field `MODE10` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE10_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE11` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE11_R = crate::FieldReader;
///Field `MODE11` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE11_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE12` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE12_R = crate::FieldReader;
///Field `MODE12` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE12_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE13` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE13_R = crate::FieldReader;
///Field `MODE13` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE13_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE14` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE14_R = crate::FieldReader;
///Field `MODE14` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE14_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MODE15` reader - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
pub type MODE15_R = crate::FieldReader;
///Field `MODE15` writer - Port x configuration for I/O y (y = 15 to 0) These bits are written by software to set the I/O to one of four operating modes.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#GPIOD:MODER)*/
pub struct MODERrs;
