...
pub use crate::stm32c011::gpioa::pupdr::PULL;
///Field `PUPD(0-15)` reader - Port x configuration pin %s
pub use crate::stm32c011::gpioa::pupdr::PUPD_R;
///Field `PUPD(0-15)` writer - Port x configuration pin %s
pub use crate::stm32c011::gpioa::pupdr::PUPD_W;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#GPIOF:PUPDR)*/
pub struct PUPDRrs;
