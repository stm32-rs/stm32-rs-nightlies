...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:TR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:DR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:ICSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:PRER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:WPR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:CALR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:TSTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:TSDR)
...
pub mod tsdr;
/**TSSSR (r) register accessor: RTC timestamp sub second register

You can [`read`](crate::Reg::read) this register and get [`tsssr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:TSSSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:ALRMAR)
...
pub mod alrmar;
/**ALRMASSR (rw) register accessor: RTC alarm A sub second register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:ALRMASSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:MISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#RTC:SCR)
