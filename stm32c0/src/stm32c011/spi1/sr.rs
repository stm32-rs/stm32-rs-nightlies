...
/**Underrun flag This flag is set by hardware and reset by a software sequence. Refer to page 1385 for the software sequence. Note: This bit is not used in SPI mode.
...
///Field `UDR` reader - Underrun flag This flag is set by hardware and reset by a software sequence. Refer to page 1385 for the software sequence. Note: This bit is not used in SPI mode.
...
/**Mode fault This flag is set by hardware and reset by a software sequence. Refer to (MODF) on page 1359 for the software sequence. Note: This bit is not used in I2S mode.
...
///Field `MODF` reader - Mode fault This flag is set by hardware and reset by a software sequence. Refer to (MODF) on page 1359 for the software sequence. Note: This bit is not used in I2S mode.
...
/**Overrun flag This flag is set by hardware and reset by a software sequence. Refer to page 1385 for the software sequence.
...
///Field `OVR` reader - Overrun flag This flag is set by hardware and reset by a software sequence. Refer to page 1385 for the software sequence.
...
/**FIFO reception level These bits are set and cleared by hardware. Note: These bits are not used in ImS mode and in SPI receive-only mode while CRC calculation is enabled.
...
///Field `FRLVL` reader - FIFO reception level These bits are set and cleared by hardware. Note: These bits are not used in ImS mode and in SPI receive-only mode while CRC calculation is enabled.
...
impl R {
    ...
    ///Bits 9:10 - FIFO reception level These bits are set and cleared by hardware. Note: These bits are not used in ImS mode and in SPI receive-only mode while CRC calculation is enabled.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#SPI1:SR)*/
pub struct SRrs;
