...
/**Field `OC1M1` reader - Output compare 1 mode (refer to bit 16 for OC1M\[3\]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M\[3\]
bit is not contiguous, located in bit 16.*/
pub type OC1M1_R = crate::FieldReader;
/**Field `OC1M1` writer - Output compare 1 mode (refer to bit 16 for OC1M\[3\]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M\[3\]
bit is not contiguous, located in bit 16.*/
pub type OC1M1_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
/**Field `OC1M2` reader - Output compare 1 mode (refer to bit 16 for OC1M\[3\]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M\[3\]
bit is not contiguous, located in bit 16.*/
pub type OC1M2_R = crate::BitReader;
/**Field `OC1M2` writer - Output compare 1 mode (refer to bit 16 for OC1M\[3\]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M\[3\]
bit is not contiguous, located in bit 16.*/
