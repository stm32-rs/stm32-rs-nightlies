...
///Field `OC3M1` reader - Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
pub type OC3M1_R = crate::FieldReader;
///Field `OC3M1` writer - Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
///Field `OC4M1` reader - Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
pub type OC4M1_R = crate::FieldReader;
///Field `OC4M1` writer - Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
///Field `OC3M2` reader - Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
pub type OC3M2_R = crate::BitReader;
///Field `OC3M2` writer - Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
pub type OC3M2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OC4M2` reader - Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
pub type OC4M2_R = crate::BitReader;
///Field `OC4M2` writer - Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C011.html#TIM3:CCMR2_output)*/
