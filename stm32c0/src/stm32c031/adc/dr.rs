...
///Field `DATA` reader - Converted data These bits are read-only. They contain the conversion result from the last converted channel. The data are left- or right-aligned as shown in OVSE = 0) on page 353. Just after a calibration is complete, DATA\[6:0\] contains the calibration factor.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C031.html#ADC:DR)*/
pub struct DRrs;
