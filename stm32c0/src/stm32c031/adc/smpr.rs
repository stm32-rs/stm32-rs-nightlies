...
///Field `SMPSEL(0-22)` reader - Channel-%s sampling time selection
...
///Field `SMPSEL(0-22)` writer - Channel-%s sampling time selection
...
impl R {
    ...
    ///Channel-(0-22) sampling time selection
    ///
    ...
    pub fn smpsel_iter(&self) -> impl Iterator<Item = SMPSEL_R> + '_ {
        (0..23).map(move |n| SMPSEL_R::new(((self.bits >> (n + 8)) & 1) != 0))
    }
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SMP1` field.</div>
    #[inline(always)]
    pub fn smp(&mut self, n: u8) -> SMP_W<'_, SMPRrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        SMP_W::new(self, n * 4)
    }
    ///Bits 0:2 - Sampling time selection 1
    #[inline(always)]
    pub fn smp1(&mut self) -> SMP_W<'_, SMPRrs> {
        SMP_W::new(self, 0)
    }
    ///Bits 4:6 - Sampling time selection 2
    #[inline(always)]
    pub fn smp2(&mut self) -> SMP_W<'_, SMPRrs> {
        SMP_W::new(self, 4)
    }
    ///Channel-(0-22) sampling time selection
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SMPSEL0` field.</div>
    #[inline(always)]
    pub fn smpsel(&mut self, n: u8) -> SMPSEL_W<'_, SMPRrs> {
        #[allow(clippy::no_effect)]
        [(); 23][n as usize];
    ...
    ///Bit 8 - Channel-0 sampling time selection
    #[inline(always)]
    pub fn smpsel0(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 8)
    }
    ///Bit 9 - Channel-1 sampling time selection
    #[inline(always)]
    pub fn smpsel1(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 9)
    }
    ///Bit 10 - Channel-2 sampling time selection
    #[inline(always)]
    pub fn smpsel2(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 10)
    }
    ///Bit 11 - Channel-3 sampling time selection
    #[inline(always)]
    pub fn smpsel3(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 11)
    }
    ///Bit 12 - Channel-4 sampling time selection
    #[inline(always)]
    pub fn smpsel4(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 12)
    }
    ///Bit 13 - Channel-5 sampling time selection
    #[inline(always)]
    pub fn smpsel5(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 13)
    }
    ///Bit 14 - Channel-6 sampling time selection
    #[inline(always)]
    pub fn smpsel6(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 14)
    }
    ///Bit 15 - Channel-7 sampling time selection
    #[inline(always)]
    pub fn smpsel7(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 15)
    }
    ///Bit 16 - Channel-8 sampling time selection
    #[inline(always)]
    pub fn smpsel8(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 16)
    }
    ///Bit 17 - Channel-9 sampling time selection
    #[inline(always)]
    pub fn smpsel9(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 17)
    }
    ///Bit 18 - Channel-10 sampling time selection
    #[inline(always)]
    pub fn smpsel10(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 18)
    }
    ///Bit 19 - Channel-11 sampling time selection
    #[inline(always)]
    pub fn smpsel11(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 19)
    }
    ///Bit 20 - Channel-12 sampling time selection
    #[inline(always)]
    pub fn smpsel12(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 20)
    }
    ///Bit 21 - Channel-13 sampling time selection
    #[inline(always)]
    pub fn smpsel13(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 21)
    }
    ///Bit 22 - Channel-14 sampling time selection
    #[inline(always)]
    pub fn smpsel14(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 22)
    }
    ///Bit 23 - Channel-15 sampling time selection
    #[inline(always)]
    pub fn smpsel15(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 23)
    }
    ///Bit 24 - Channel-16 sampling time selection
    #[inline(always)]
    pub fn smpsel16(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 24)
    }
    ///Bit 25 - Channel-17 sampling time selection
    #[inline(always)]
    pub fn smpsel17(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 25)
    }
    ///Bit 26 - Channel-18 sampling time selection
    #[inline(always)]
    pub fn smpsel18(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 26)
    }
    ///Bit 27 - Channel-19 sampling time selection
    #[inline(always)]
    pub fn smpsel19(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 27)
    }
    ///Bit 28 - Channel-20 sampling time selection
    #[inline(always)]
    pub fn smpsel20(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 28)
    }
    ///Bit 29 - Channel-21 sampling time selection
    #[inline(always)]
    pub fn smpsel21(&mut self) -> SMPSEL_W<'_, SMPRrs> {
        SMPSEL_W::new(self, 29)
    }
    ///Bit 30 - Channel-22 sampling time selection
    #[inline(always)]
    pub fn smpsel22(&mut self) -> SMPSEL_W<'_, SMPRrs> {
