...
///Field `CGIF(1-3)` writer - Channel %s Global interrupt clear
...
///Field `CTCIF(1-3)` writer - Channel %s Transfer Complete clear
...
///Field `CHTIF(1-3)` writer - Channel %s Half Transfer clear
...
///Field `CTEIF(1-3)` writer - Channel %s Transfer Error clear
...
impl W {
    ///Channel (1-3) Global interrupt clear
    ///
    ...
    ///Channel (1-3) Transfer Complete clear
    ///
    ...
    ///Channel (1-3) Half Transfer clear
    ///
    ...
    ///Channel (1-3) Transfer Error clear
    ///
