...
impl R {
    ///Bits 0:7 - Securable memory area size Contains the number of securable flash memory pages. Note: The number of effective bits depends on the size of the flash memory in the device.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C031.html#FLASH:SECR)*/
pub struct SECRrs;
