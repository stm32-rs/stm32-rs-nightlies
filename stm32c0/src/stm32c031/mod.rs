/*!Peripheral access API for STM32C031 microcontrollers (generated using svd2rust v0.33.4 (5b6615e 2024-06-16))
...
///I2C register block
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32C031.html#I2C)
pub struct I2C {
    _marker: PhantomData<*const ()>,
}
...
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32C031.html#SPI)
pub struct SPI {
    _marker: PhantomData<*const ()>,
}
