...
///Field `PD6` reader - Port C pull-down bit i (i = 15, 14, 13, 7, 6) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PC\[i\] I/O. On STM32C011xx, only PD15 and PD14 are available.
pub type PD6_R = crate::BitReader;
///Field `PD6` writer - Port C pull-down bit i (i = 15, 14, 13, 7, 6) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PC\[i\] I/O. On STM32C011xx, only PD15 and PD14 are available.
pub type PD6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD7` reader - Port C pull-down bit i (i = 15, 14, 13, 7, 6) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PC\[i\] I/O. On STM32C011xx, only PD15 and PD14 are available.
pub type PD7_R = crate::BitReader;
///Field `PD7` writer - Port C pull-down bit i (i = 15, 14, 13, 7, 6) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PC\[i\] I/O. On STM32C011xx, only PD15 and PD14 are available.
pub type PD7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD13` reader - Port C pull-down bit i (i = 15, 14, 13, 7, 6) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PC\[i\] I/O. On STM32C011xx, only PD15 and PD14 are available.
pub type PD13_R = crate::BitReader;
///Field `PD13` writer - Port C pull-down bit i (i = 15, 14, 13, 7, 6) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PC\[i\] I/O. On STM32C011xx, only PD15 and PD14 are available.
...
impl R {
    ///Bit 6 - Port C pull-down bit i (i = 15, 14, 13, 7, 6) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PC\[i\] I/O. On STM32C011xx, only PD15 and PD14 are available.
    #[inline(always)]
    pub fn pd6(&self) -> PD6_R {
        PD6_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Port C pull-down bit i (i = 15, 14, 13, 7, 6) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PC\[i\] I/O. On STM32C011xx, only PD15 and PD14 are available.
    #[inline(always)]
    pub fn pd7(&self) -> PD7_R {
        PD7_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 13 - Port C pull-down bit i (i = 15, 14, 13, 7, 6) Setting PDi bit while the APC bit of the PWR_CR3 register is set activates a pull-down device on the PC\[i\] I/O. On STM32C011xx, only PD15 and PD14 are available.
    #[inline(always)]
