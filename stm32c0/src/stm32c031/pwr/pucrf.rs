...
/**Field `PU0` reader - Port F pull-up bit i (i = 2 to 0) Setting PUi bit while the corresponding PDi bit is zero and the APC bit of the PWR_CR3 register is set activates a pull-up device on the PF\[i\]
I/O. On STM32C011xx, only PU2 is available.*/
pub type PU0_R = crate::BitReader;
/**Field `PU0` writer - Port F pull-up bit i (i = 2 to 0) Setting PUi bit while the corresponding PDi bit is zero and the APC bit of the PWR_CR3 register is set activates a pull-up device on the PF\[i\]
I/O. On STM32C011xx, only PU2 is available.*/
pub type PU0_W<'a, REG> = crate::BitWriter<'a, REG>;
/**Field `PU1` reader - Port F pull-up bit i (i = 2 to 0) Setting PUi bit while the corresponding PDi bit is zero and the APC bit of the PWR_CR3 register is set activates a pull-up device on the PF\[i\]
I/O. On STM32C011xx, only PU2 is available.*/
pub type PU1_R = crate::BitReader;
/**Field `PU1` writer - Port F pull-up bit i (i = 2 to 0) Setting PUi bit while the corresponding PDi bit is zero and the APC bit of the PWR_CR3 register is set activates a pull-up device on the PF\[i\]
I/O. On STM32C011xx, only PU2 is available.*/
...
impl R {
    /**Bit 0 - Port F pull-up bit i (i = 2 to 0) Setting PUi bit while the corresponding PDi bit is zero and the APC bit of the PWR_CR3 register is set activates a pull-up device on the PF\[i\]
    I/O. On STM32C011xx, only PU2 is available.*/
    #[inline(always)]
    pub fn pu0(&self) -> PU0_R {
        PU0_R::new((self.bits & 1) != 0)
    }
    /**Bit 1 - Port F pull-up bit i (i = 2 to 0) Setting PUi bit while the corresponding PDi bit is zero and the APC bit of the PWR_CR3 register is set activates a pull-up device on the PF\[i\]
    I/O. On STM32C011xx, only PU2 is available.*/
    #[inline(always)]
