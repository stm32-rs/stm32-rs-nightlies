...
impl W {
    ///Bit 0 - LSI oscillator enable Set and cleared by software to enable/disable the LSI oscillator:
    #[inline(always)]
    pub fn lsion(&mut self) -> LSION_W<'_, CSR2rs> {
        LSION_W::new(self, 0)
    }
    ///Bit 23 - Remove reset flags Set by software to clear the reset flags.
    #[inline(always)]
    pub fn rmvf(&mut self) -> RMVF_W<'_, CSR2rs> {
        RMVF_W::new(self, 23)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C031.html#RCC:CSR2)*/
pub struct CSR2rs;
