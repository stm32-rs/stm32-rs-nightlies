...
You can [`read`](crate::Reg::read) this register and get [`syscfg_itline0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C031.html#SYSCFG:SYSCFG_ITLINE0)*/
