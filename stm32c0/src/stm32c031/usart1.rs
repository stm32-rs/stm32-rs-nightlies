...
/**CR1_enabled (rw) register accessor: USART control register 1 \[alternate\]
...
pub mod cr1_enabled;
/**CR1_disabled (rw) register accessor: USART control register 1 \[alternate\]
...
pub mod rqr;
/**ISR_enabled (r) register accessor: USART interrupt and status register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`isr_enabled::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C031.html#USART1:ISR_enabled)
...
pub mod isr_enabled;
/**ISR_disabled (r) register accessor: USART interrupt and status register \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C031.html#USART1:RDR)
