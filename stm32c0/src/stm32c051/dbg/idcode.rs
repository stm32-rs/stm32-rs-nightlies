...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C051.html#DBG:IDCODE)*/
pub struct IDCODErs;
...
///`reset()` method sets IDCODE to value 0x1000_044c
impl crate::Resettable for IDCODErs {
    const RESET_VALUE: u32 = 0x1000_044c;
}
