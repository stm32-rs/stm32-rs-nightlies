...
/**Page number selection These bits select the page to erase: ... Note: Values corresponding to addresses outside the Main memory are not allowed. See Table 6 and Table 7.
...
pub type PNB_R = crate::FieldReader<PNB>;
impl PNB_R {
    ///Get enumerated values variant
    #[inline(always)]
...
pub type PNB_W<'a, REG> = crate::FieldWriter<'a, REG, 6, PNB>;
impl<'a, REG> PNB_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl From<SEC_PROT> for bool {
    #[inline(always)]
    fn from(variant: SEC_PROT) -> Self {
        variant as u8 != 0
    }
}
...
pub type SEC_PROT_R = crate::BitReader<SEC_PROT>;
impl SEC_PROT_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> SEC_PROT {
        match self.bits {
            false => SEC_PROT::B0x0,
            true => SEC_PROT::B0x1,
        }
...
pub type SEC_PROT_W<'a, REG> = crate::BitWriter<'a, REG, SEC_PROT>;
impl<'a, REG> SEC_PROT_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Disable (securable area accessible)
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(SEC_PROT::B0x0)
    }
    ///Enable (securable area not accessible)
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(SEC_PROT::B0x1)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C051.html#FLASH:CR)*/
pub struct CRrs;
