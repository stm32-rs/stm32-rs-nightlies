...
///Field `OPTKEY` writer - Option byte key The following values must be written consecutively to unlock the flash memory option registers, enabling option byte programming/erasing operations: KEY1: 0x0819 2A3B KEY2: 0x4C5D 6E7F
...
impl W {
    ...
    #[inline(always)]
    pub fn optkey(&mut self) -> OPTKEY_W<'_, OPTKEYRrs> {
        OPTKEY_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C051.html#FLASH:OPTKEYR)*/
