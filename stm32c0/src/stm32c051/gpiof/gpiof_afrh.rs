///Register `GPIOF_AFRH` reader
pub type R = crate::R<GPIOF_AFRHrs>;
///Register `GPIOF_AFRH` writer
pub type W = crate::W<GPIOF_AFRHrs>;
...
impl W {
    ///Bits 0:3 - Alternate function selection for port x, I/O y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel8(&mut self) -> AFSEL8_W<'_, GPIOF_AFRHrs> {
        AFSEL8_W::new(self, 0)
    }
    ///Bits 4:7 - Alternate function selection for port x, I/O y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel9(&mut self) -> AFSEL9_W<'_, GPIOF_AFRHrs> {
        AFSEL9_W::new(self, 4)
    }
    ///Bits 8:11 - Alternate function selection for port x, I/O y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel10(&mut self) -> AFSEL10_W<'_, GPIOF_AFRHrs> {
        AFSEL10_W::new(self, 8)
    }
    ///Bits 12:15 - Alternate function selection for port x, I/O y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel11(&mut self) -> AFSEL11_W<'_, GPIOF_AFRHrs> {
        AFSEL11_W::new(self, 12)
    }
    ///Bits 16:19 - Alternate function selection for port x, I/O y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel12(&mut self) -> AFSEL12_W<'_, GPIOF_AFRHrs> {
        AFSEL12_W::new(self, 16)
    }
    ///Bits 20:23 - Alternate function selection for port x, I/O y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel13(&mut self) -> AFSEL13_W<'_, GPIOF_AFRHrs> {
        AFSEL13_W::new(self, 20)
    }
    ///Bits 24:27 - Alternate function selection for port x, I/O y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel14(&mut self) -> AFSEL14_W<'_, GPIOF_AFRHrs> {
        AFSEL14_W::new(self, 24)
    }
    ///Bits 28:31 - Alternate function selection for port x, I/O y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel15(&mut self) -> AFSEL15_W<'_, GPIOF_AFRHrs> {
        AFSEL15_W::new(self, 28)
    }
}
/**GPIO alternate function high register

You can [`read`](crate::Reg::read) this register and get [`gpiof_afrh::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiof_afrh::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C051.html#GPIOF:GPIOF_AFRH)*/
pub struct GPIOF_AFRHrs;
impl crate::RegisterSpec for GPIOF_AFRHrs {
    type Ux = u32;
}
///`read()` method returns [`gpiof_afrh::R`](R) reader structure
impl crate::Readable for GPIOF_AFRHrs {}
///`write(|w| ..)` method takes [`gpiof_afrh::W`](W) writer structure
impl crate::Writable for GPIOF_AFRHrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets GPIOF_AFRH to value 0
impl crate::Resettable for GPIOF_AFRHrs {}
