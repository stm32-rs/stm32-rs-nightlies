///Register `GPIOF_AFRL` reader
pub type R = crate::R<GPIOF_AFRLrs>;
///Register `GPIOF_AFRL` writer
pub type W = crate::W<GPIOF_AFRLrs>;
...
impl W {
    ///Bits 0:3 - Alternate function selection for port x pin y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel0(&mut self) -> AFSEL0_W<'_, GPIOF_AFRLrs> {
        AFSEL0_W::new(self, 0)
    }
    ///Bits 4:7 - Alternate function selection for port x pin y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel1(&mut self) -> AFSEL1_W<'_, GPIOF_AFRLrs> {
        AFSEL1_W::new(self, 4)
    }
    ///Bits 8:11 - Alternate function selection for port x pin y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel2(&mut self) -> AFSEL2_W<'_, GPIOF_AFRLrs> {
        AFSEL2_W::new(self, 8)
    }
    ///Bits 12:15 - Alternate function selection for port x pin y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel3(&mut self) -> AFSEL3_W<'_, GPIOF_AFRLrs> {
        AFSEL3_W::new(self, 12)
    }
    ///Bits 16:19 - Alternate function selection for port x pin y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel4(&mut self) -> AFSEL4_W<'_, GPIOF_AFRLrs> {
        AFSEL4_W::new(self, 16)
    }
    ///Bits 20:23 - Alternate function selection for port x pin y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel5(&mut self) -> AFSEL5_W<'_, GPIOF_AFRLrs> {
        AFSEL5_W::new(self, 20)
    }
    ///Bits 24:27 - Alternate function selection for port x pin y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel6(&mut self) -> AFSEL6_W<'_, GPIOF_AFRLrs> {
        AFSEL6_W::new(self, 24)
    }
    ///Bits 28:31 - Alternate function selection for port x pin y These bits are written by software to configure alternate function I/Os
    #[inline(always)]
    pub fn afsel7(&mut self) -> AFSEL7_W<'_, GPIOF_AFRLrs> {
        AFSEL7_W::new(self, 28)
    }
}
/**GPIO alternate function low register

You can [`read`](crate::Reg::read) this register and get [`gpiof_afrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiof_afrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C051.html#GPIOF:GPIOF_AFRL)*/
pub struct GPIOF_AFRLrs;
impl crate::RegisterSpec for GPIOF_AFRLrs {
    type Ux = u32;
}
///`read()` method returns [`gpiof_afrl::R`](R) reader structure
impl crate::Readable for GPIOF_AFRLrs {}
///`write(|w| ..)` method takes [`gpiof_afrl::W`](W) writer structure
impl crate::Writable for GPIOF_AFRLrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets GPIOF_AFRL to value 0
impl crate::Resettable for GPIOF_AFRLrs {}
