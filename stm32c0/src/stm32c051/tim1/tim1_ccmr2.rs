///Register `TIM1_CCMR2` reader
pub type R = crate::R<TIM1_CCMR2rs>;
///Register `TIM1_CCMR2` writer
pub type W = crate::W<TIM1_CCMR2rs>;
...
///Field `IC3PSC` reader - Input capture 3 prescaler Refer to IC1PSC\[1:0\] description.
pub type IC3PSC_R = crate::FieldReader;
///Field `IC3PSC` writer - Input capture 3 prescaler Refer to IC1PSC\[1:0\] description.
pub type IC3PSC_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `IC3F` reader - Input capture 3 filter Refer to IC1F\[3:0\] description.
pub type IC3F_R = crate::FieldReader;
///Field `IC3F` writer - Input capture 3 filter Refer to IC1F\[3:0\] description.
...
///Field `IC4PSC` reader - Input capture 4 prescaler Refer to IC1PSC\[1:0\] description.
pub type IC4PSC_R = crate::FieldReader;
///Field `IC4PSC` writer - Input capture 4 prescaler Refer to IC1PSC\[1:0\] description.
pub type IC4PSC_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `IC4F` reader - Input capture 4 filter Refer to IC1F\[3:0\] description.
pub type IC4F_R = crate::FieldReader;
///Field `IC4F` writer - Input capture 4 filter Refer to IC1F\[3:0\] description.
...
impl W {
    ///Bits 0:1 - Capture/compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc3s(&mut self) -> CC3S_W<'_, TIM1_CCMR2rs> {
        CC3S_W::new(self, 0)
    }
    ///Bits 2:3 - Input capture 3 prescaler Refer to IC1PSC\[1:0\] description.
    #[inline(always)]
    pub fn ic3psc(&mut self) -> IC3PSC_W<'_, TIM1_CCMR2rs> {
        IC3PSC_W::new(self, 2)
    }
    ///Bits 4:7 - Input capture 3 filter Refer to IC1F\[3:0\] description.
    #[inline(always)]
    pub fn ic3f(&mut self) -> IC3F_W<'_, TIM1_CCMR2rs> {
        IC3F_W::new(self, 4)
    }
    ///Bits 8:9 - Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc4s(&mut self) -> CC4S_W<'_, TIM1_CCMR2rs> {
        CC4S_W::new(self, 8)
    }
    ///Bits 10:11 - Input capture 4 prescaler Refer to IC1PSC\[1:0\] description.
    #[inline(always)]
    pub fn ic4psc(&mut self) -> IC4PSC_W<'_, TIM1_CCMR2rs> {
        IC4PSC_W::new(self, 10)
    }
    ///Bits 12:15 - Input capture 4 filter Refer to IC1F\[3:0\] description.
    #[inline(always)]
    pub fn ic4f(&mut self) -> IC4F_W<'_, TIM1_CCMR2rs> {
        IC4F_W::new(self, 12)
    }
}
/**TIM1 capture/compare mode register 2

You can [`read`](crate::Reg::read) this register and get [`tim1_ccmr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim1_ccmr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C051.html#TIM1:TIM1_CCMR2)*/
pub struct TIM1_CCMR2rs;
impl crate::RegisterSpec for TIM1_CCMR2rs {
    type Ux = u32;
}
///`read()` method returns [`tim1_ccmr2::R`](R) reader structure
impl crate::Readable for TIM1_CCMR2rs {}
///`write(|w| ..)` method takes [`tim1_ccmr2::W`](W) writer structure
impl crate::Writable for TIM1_CCMR2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM1_CCMR2 to value 0
impl crate::Resettable for TIM1_CCMR2rs {}
