...
impl W {
    ///Bit 0 - Capture/Compare 1 output enable.
    #[inline(always)]
    pub fn cc1e(&mut self) -> CC1E_W<'_, TIM2_CCERrs> {
        CC1E_W::new(self, 0)
    }
    ///Bit 1 - Capture/Compare 1 output Polarity.
    #[inline(always)]
    pub fn cc1p(&mut self) -> CC1P_W<'_, TIM2_CCERrs> {
        CC1P_W::new(self, 1)
    }
    ///Bit 3 - Capture/Compare 1 output Polarity.
    #[inline(always)]
    pub fn cc1np(&mut self) -> CC1NP_W<'_, TIM2_CCERrs> {
        CC1NP_W::new(self, 3)
    }
    ///Bit 4 - Capture/Compare 2 output enable.
    #[inline(always)]
    pub fn cc2e(&mut self) -> CC2E_W<'_, TIM2_CCERrs> {
        CC2E_W::new(self, 4)
    }
    ///Bit 5 - Capture/Compare 2 output Polarity.
    #[inline(always)]
    pub fn cc2p(&mut self) -> CC2P_W<'_, TIM2_CCERrs> {
        CC2P_W::new(self, 5)
    }
    ///Bit 7 - Capture/Compare 2 output Polarity.
    #[inline(always)]
    pub fn cc2np(&mut self) -> CC2NP_W<'_, TIM2_CCERrs> {
        CC2NP_W::new(self, 7)
    }
    ///Bit 8 - Capture/Compare 3 output enable.
    #[inline(always)]
    pub fn cc3e(&mut self) -> CC3E_W<'_, TIM2_CCERrs> {
        CC3E_W::new(self, 8)
    }
    ///Bit 9 - Capture/Compare 3 output Polarity.
    #[inline(always)]
    pub fn cc3p(&mut self) -> CC3P_W<'_, TIM2_CCERrs> {
        CC3P_W::new(self, 9)
    }
    ///Bit 11 - Capture/Compare 3 output Polarity.
    #[inline(always)]
    pub fn cc3np(&mut self) -> CC3NP_W<'_, TIM2_CCERrs> {
        CC3NP_W::new(self, 11)
    }
    ///Bit 12 - Capture/Compare 4 output enable.
    #[inline(always)]
    pub fn cc4e(&mut self) -> CC4E_W<'_, TIM2_CCERrs> {
        CC4E_W::new(self, 12)
    }
    ///Bit 13 - Capture/Compare 4 output Polarity.
    #[inline(always)]
    pub fn cc4p(&mut self) -> CC4P_W<'_, TIM2_CCERrs> {
        CC4P_W::new(self, 13)
    }
    ///Bit 15 - Capture/Compare 4 output Polarity.
    #[inline(always)]
    pub fn cc4np(&mut self) -> CC4NP_W<'_, TIM2_CCERrs> {
        CC4NP_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C051.html#TIM2:TIM2_CCER)*/
