///Register `TIM3_CCMR1_ALTERNATE1` reader
pub type R = crate::R<TIM3_CCMR1_ALTERNATE1rs>;
///Register `TIM3_CCMR1_ALTERNATE1` writer
pub type W = crate::W<TIM3_CCMR1_ALTERNATE1rs>;
...
///Field `OC2M` reader - OC2M\[2:0\]: Output compare 2 mode refer to OC1M description on bits 6:4
pub type OC2M_R = crate::FieldReader;
///Field `OC2M` writer - OC2M\[2:0\]: Output compare 2 mode refer to OC1M description on bits 6:4
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM3_CCMR1_ALTERNATE1")
...
impl W {
    ///Bits 0:1 - Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        CC1S_W::new(self, 0)
    }
    ///Bit 2 - Output compare 1 fast enable This bit decreases the latency between a trigger event and a transition on the timer output. It must be used in one-pulse mode (OPM bit set in TIMx_CR1 register), to have the output pulse starting as soon as possible after the starting trigger.
    #[inline(always)]
    pub fn oc1fe(&mut self) -> OC1FE_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC1FE_W::new(self, 2)
    }
    ///Bit 3 - Output compare 1 preload enable
    #[inline(always)]
    pub fn oc1pe(&mut self) -> OC1PE_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC1PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC1M\[2:0\]: Output compare 1 mode These bits define the behavior of the output reference signal OC1REF from which OC1 and OC1N are derived. OC1REF is active high whereas OC1 and OC1N active level depends on CC1P and CC1NP bits. Note: In PWM mode, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from frozen mode to PWM mode. Note: The OC1M\[3\] bit is not contiguous, located in bit 16.
    #[inline(always)]
    pub fn oc1m(&mut self) -> OC1M_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC1M_W::new(self, 4)
    }
    ///Bit 7 - Output compare 1 clear enable
    #[inline(always)]
    pub fn oc1ce(&mut self) -> OC1CE_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC1CE_W::new(self, 7)
    }
    ///Bits 8:9 - Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc2s(&mut self) -> CC2S_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        CC2S_W::new(self, 8)
    }
    ///Bit 10 - Output compare 2 fast enable
    #[inline(always)]
    pub fn oc2fe(&mut self) -> OC2FE_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC2FE_W::new(self, 10)
    }
    ///Bit 11 - Output compare 2 preload enable
    #[inline(always)]
    pub fn oc2pe(&mut self) -> OC2PE_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC2PE_W::new(self, 11)
    }
    ///Bits 12:14 - OC2M\[2:0\]: Output compare 2 mode refer to OC1M description on bits 6:4
    #[inline(always)]
    pub fn oc2m(&mut self) -> OC2M_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC2M_W::new(self, 12)
    }
    ///Bit 15 - Output compare 2 clear enable
    #[inline(always)]
    pub fn oc2ce(&mut self) -> OC2CE_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC2CE_W::new(self, 15)
    }
    ///Bit 16 - OC1M\[3\]
    #[inline(always)]
    pub fn oc1m_1(&mut self) -> OC1M_1_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC1M_1_W::new(self, 16)
    }
    ///Bit 24 - OC2M\[3\]
    #[inline(always)]
    pub fn oc2m_1(&mut self) -> OC2M_1_W<'_, TIM3_CCMR1_ALTERNATE1rs> {
        OC2M_1_W::new(self, 24)
    }
}
/**TIM3 capture/compare mode register 1

You can [`read`](crate::Reg::read) this register and get [`tim3_ccmr1_alternate1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim3_ccmr1_alternate1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C051.html#TIM3:TIM3_CCMR1_ALTERNATE1)*/
pub struct TIM3_CCMR1_ALTERNATE1rs;
impl crate::RegisterSpec for TIM3_CCMR1_ALTERNATE1rs {
    type Ux = u32;
}
///`read()` method returns [`tim3_ccmr1_alternate1::R`](R) reader structure
impl crate::Readable for TIM3_CCMR1_ALTERNATE1rs {}
///`write(|w| ..)` method takes [`tim3_ccmr1_alternate1::W`](W) writer structure
impl crate::Writable for TIM3_CCMR1_ALTERNATE1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM3_CCMR1_ALTERNATE1 to value 0
impl crate::Resettable for TIM3_CCMR1_ALTERNATE1rs {}
