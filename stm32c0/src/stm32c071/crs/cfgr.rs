...
///Field `FELIM` reader - Frequency error limit FELIM contains the value to be used to evaluate the captured frequency error value latched in the FECAP\[15:0\] bits of the CRS_ISR register. Refer to Section 7.4.4 for more details about FECAP evaluation.
pub type FELIM_R = crate::FieldReader;
///Field `FELIM` writer - Frequency error limit FELIM contains the value to be used to evaluate the captured frequency error value latched in the FECAP\[15:0\] bits of the CRS_ISR register. Refer to Section 7.4.4 for more details about FECAP evaluation.
