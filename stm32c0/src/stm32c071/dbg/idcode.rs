...
///Field `DEV_ID` reader - Device identifier This field indicates the device ID. Refer to Table 152.
pub type DEV_ID_R = crate::FieldReader<u16>;
///Field `REV_ID` reader - Revision identifier This field indicates the revision of the device. Refer to Table 152.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C071.html#DBG:IDCODE)*/
pub struct IDCODErs;
...
///`reset()` method sets IDCODE to value 0x1000_0493
impl crate::Resettable for IDCODErs {
    const RESET_VALUE: u32 = 0x1000_0493;
}
