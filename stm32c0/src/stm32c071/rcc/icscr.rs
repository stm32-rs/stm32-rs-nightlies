...
///Field `HSICAL` reader - HSI48 clock calibration This bitfield directly acts on the HSI48 clock frequency. Its value is a sum of an internal factory-programmed number and the value of the HSITRIM\[6:0\] bitfield. In the factory, the internal number is set to calibrate the HSI48 clock frequency to 48 MHz (with HSITRIM\[6:0\] left at its reset value). Refer to the device datasheet for HSI48 calibration accuracy and for the frequency trimming granularity. Note: The trimming effect presents discontinuities at HSICAL\[7:0\] multiples of 64.
pub type HSICAL_R = crate::FieldReader;
///Field `HSITRIM` reader - HSI48 clock trimming The value of this bitfield contributes to the HSICAL\[7:0\] bitfield value. It allows HSI48 clock frequency user trimming. The HSI48 frequency accuracy as stated in the device datasheet applies when this bitfield is left at its reset value.
pub type HSITRIM_R = crate::FieldReader;
///Field `HSITRIM` writer - HSI48 clock trimming The value of this bitfield contributes to the HSICAL\[7:0\] bitfield value. It allows HSI48 clock frequency user trimming. The HSI48 frequency accuracy as stated in the device datasheet applies when this bitfield is left at its reset value.
