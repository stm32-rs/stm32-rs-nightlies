...
/**Field `DTG` reader - Dead-time generator setup This bit-field defines the duration of the dead-time inserted between the complementary outputs. DT correspond to this duration. DTG\[7:5\]
= 0xx => DT = DTG\[7:0\]
x t<sub>dtg</sub> with t <sub>dtg</sub>= t<sub>DTS</sub> DTG\[7:5\]
= 10x => DT = (64 + DTG\[5:0\]) x t<sub>dtg</sub> with t <sub>dtg</sub>= 2 x t<sub>DTS</sub> DTG\[7:5\]
= 110 => DT = (32 + DTG\[4:0\]) x t<sub>dtg</sub> with t <sub>dtg</sub>= 8 x t<sub>DTS</sub> DTG\[7:5\]
= 111 => DT = (32 + DTG\[4:0\]) x t<sub>dtg</sub> with t <sub>dtg</sub>= 16 x t<sub>DTS</sub> Example if t <sub>DTS</sub>= 125 ns (8 MHz), dead-time possible values are: 0 to 15875 ns by 125 ns steps, 16 s to 31750 ns by 250 ns steps, 32 s to 63 s by 1 s steps, 64 s to 126 s by 2 s steps Note: This bit-field can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).*/
pub type DTG_R = crate::FieldReader;
/**Field `DTG` writer - Dead-time generator setup This bit-field defines the duration of the dead-time inserted between the complementary outputs. DT correspond to this duration. DTG\[7:5\]
= 0xx => DT = DTG\[7:0\]
x t<sub>dtg</sub> with t <sub>dtg</sub>= t<sub>DTS</sub> DTG\[7:5\]
= 10x => DT = (64 + DTG\[5:0\]) x t<sub>dtg</sub> with t <sub>dtg</sub>= 2 x t<sub>DTS</sub> DTG\[7:5\]
= 110 => DT = (32 + DTG\[4:0\]) x t<sub>dtg</sub> with t <sub>dtg</sub>= 8 x t<sub>DTS</sub> DTG\[7:5\]
...
impl R {
    /**Bits 0:7 - Dead-time generator setup This bit-field defines the duration of the dead-time inserted between the complementary outputs. DT correspond to this duration. DTG\[7:5\]
    = 0xx => DT = DTG\[7:0\]
    x t<sub>dtg</sub> with t <sub>dtg</sub>= t<sub>DTS</sub> DTG\[7:5\]
    = 10x => DT = (64 + DTG\[5:0\]) x t<sub>dtg</sub> with t <sub>dtg</sub>= 2 x t<sub>DTS</sub> DTG\[7:5\]
    = 110 => DT = (32 + DTG\[4:0\]) x t<sub>dtg</sub> with t <sub>dtg</sub>= 8 x t<sub>DTS</sub> DTG\[7:5\]
