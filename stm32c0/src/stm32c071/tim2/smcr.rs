...
///Field `SMS1` reader - SMS\[2:0\]: Slave mode selection
pub type SMS1_R = crate::FieldReader;
///Field `SMS1` writer - SMS\[2:0\]: Slave mode selection
...
///Field `TS1` reader - TS\[2:0\]: Trigger selection
pub type TS1_R = crate::FieldReader;
///Field `TS1` writer - TS\[2:0\]: Trigger selection
