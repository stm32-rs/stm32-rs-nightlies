///Register `DMAMUX_C3CR` reader
pub type R = crate::R<DMAMUX_C3CRrs>;
///Register `DMAMUX_C3CR` writer
pub type W = crate::W<DMAMUX_C3CRrs>;
...
impl W {
    ///Bits 0:5 - DMA request identification Selects the input DMA request. See the DMAMUX table about assignments of multiplexer inputs to resources.
    #[inline(always)]
    pub fn dmareq_id(&mut self) -> DMAREQ_ID_W<'_, DMAMUX_C3CRrs> {
        DMAREQ_ID_W::new(self, 0)
    }
    ///Bit 8 - Synchronization overrun interrupt enable
    #[inline(always)]
    pub fn soie(&mut self) -> SOIE_W<'_, DMAMUX_C3CRrs> {
        SOIE_W::new(self, 8)
    }
    ///Bit 9 - Event generation enable
    #[inline(always)]
    pub fn ege(&mut self) -> EGE_W<'_, DMAMUX_C3CRrs> {
        EGE_W::new(self, 9)
    }
    ///Bit 16 - Synchronization enable
    #[inline(always)]
    pub fn se(&mut self) -> SE_W<'_, DMAMUX_C3CRrs> {
        SE_W::new(self, 16)
    }
    ///Bits 17:18 - Synchronization polarity Defines the edge polarity of the selected synchronization input:
    #[inline(always)]
    pub fn spol(&mut self) -> SPOL_W<'_, DMAMUX_C3CRrs> {
        SPOL_W::new(self, 17)
    }
    ///Bits 19:23 - Number of DMA requests minus 1 to forward Defines the number of DMA requests to forward to the DMA controller after a synchronization event, and/or the number of DMA requests before an output event is generated. This field must only be written when both SE and EGE bits are low.
    #[inline(always)]
    pub fn nbreq(&mut self) -> NBREQ_W<'_, DMAMUX_C3CRrs> {
        NBREQ_W::new(self, 19)
    }
    ///Bits 24:28 - Synchronization identification Selects the synchronization input (see Table 44: DMAMUX: assignment of synchronization inputs to resources).
    #[inline(always)]
    pub fn sync_id(&mut self) -> SYNC_ID_W<'_, DMAMUX_C3CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C091.html#DMAMUX:DMAMUX_C3CR)*/
pub struct DMAMUX_C3CRrs;
impl crate::RegisterSpec for DMAMUX_C3CRrs {
    type Ux = u32;
}
///`read()` method returns [`dmamux_c3cr::R`](R) reader structure
impl crate::Readable for DMAMUX_C3CRrs {}
///`write(|w| ..)` method takes [`dmamux_c3cr::W`](W) writer structure
impl crate::Writable for DMAMUX_C3CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DMAMUX_C3CR to value 0
impl crate::Resettable for DMAMUX_C3CRrs {}
