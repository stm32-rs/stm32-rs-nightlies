...
impl W {
    ...
    #[inline(always)]
    pub fn br0(&mut self) -> BR0_W<'_, GPIOC_BSRRrs> {
        BR0_W::new(self, 16)
    }
    ...
    #[inline(always)]
    pub fn br1(&mut self) -> BR1_W<'_, GPIOC_BSRRrs> {
        BR1_W::new(self, 17)
    }
    ...
    #[inline(always)]
    pub fn br2(&mut self) -> BR2_W<'_, GPIOC_BSRRrs> {
        BR2_W::new(self, 18)
    }
    ...
    #[inline(always)]
    pub fn br3(&mut self) -> BR3_W<'_, GPIOC_BSRRrs> {
        BR3_W::new(self, 19)
    }
    ...
    #[inline(always)]
    pub fn br4(&mut self) -> BR4_W<'_, GPIOC_BSRRrs> {
        BR4_W::new(self, 20)
    }
    ...
    #[inline(always)]
    pub fn br5(&mut self) -> BR5_W<'_, GPIOC_BSRRrs> {
        BR5_W::new(self, 21)
    }
    ...
    #[inline(always)]
    pub fn br6(&mut self) -> BR6_W<'_, GPIOC_BSRRrs> {
        BR6_W::new(self, 22)
    }
    ...
    #[inline(always)]
    pub fn br7(&mut self) -> BR7_W<'_, GPIOC_BSRRrs> {
        BR7_W::new(self, 23)
    }
    ...
    #[inline(always)]
    pub fn br8(&mut self) -> BR8_W<'_, GPIOC_BSRRrs> {
        BR8_W::new(self, 24)
    }
    ...
    #[inline(always)]
    pub fn br9(&mut self) -> BR9_W<'_, GPIOC_BSRRrs> {
        BR9_W::new(self, 25)
    }
    ...
    #[inline(always)]
    pub fn br10(&mut self) -> BR10_W<'_, GPIOC_BSRRrs> {
        BR10_W::new(self, 26)
    }
    ...
    #[inline(always)]
    pub fn br11(&mut self) -> BR11_W<'_, GPIOC_BSRRrs> {
        BR11_W::new(self, 27)
    }
    ...
    #[inline(always)]
    pub fn br12(&mut self) -> BR12_W<'_, GPIOC_BSRRrs> {
        BR12_W::new(self, 28)
    }
    ...
    #[inline(always)]
    pub fn br13(&mut self) -> BR13_W<'_, GPIOC_BSRRrs> {
        BR13_W::new(self, 29)
    }
    ...
    #[inline(always)]
    pub fn br14(&mut self) -> BR14_W<'_, GPIOC_BSRRrs> {
        BR14_W::new(self, 30)
    }
    ...
    #[inline(always)]
    pub fn br15(&mut self) -> BR15_W<'_, GPIOC_BSRRrs> {
        BR15_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C091.html#GPIOC:GPIOC_BSRR)*/
