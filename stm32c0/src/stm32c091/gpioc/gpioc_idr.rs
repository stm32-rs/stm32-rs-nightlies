///Register `GPIOC_IDR` reader
pub type R = crate::R<GPIOC_IDRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioc_idr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C091.html#GPIOC:GPIOC_IDR)*/
pub struct GPIOC_IDRrs;
impl crate::RegisterSpec for GPIOC_IDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpioc_idr::R`](R) reader structure
impl crate::Readable for GPIOC_IDRrs {}
///`reset()` method sets GPIOC_IDR to value 0
impl crate::Resettable for GPIOC_IDRrs {}
