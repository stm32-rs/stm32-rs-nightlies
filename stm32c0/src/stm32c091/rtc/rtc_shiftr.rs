///Register `RTC_SHIFTR` writer
pub type W = crate::W<RTC_SHIFTRrs>;
...
pub type ADD1S_W<'a, REG> = crate::BitWriter<'a, REG, ADD1S>;
...
impl core::fmt::Debug for crate::generic::Reg<RTC_SHIFTRrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn subfs(&mut self) -> SUBFS_W<'_, RTC_SHIFTRrs> {
        SUBFS_W::new(self, 0)
    }
    ///Bit 31 - Add one second This bit is write only and is always read as zero. Writing to this bit has no effect when a shift operation is pending (when SHPF = 1, in RTC_ICSR). This function is intended to be used with SUBFS (see description below) in order to effectively add a fraction of a second to the clock in an atomic operation.
    #[inline(always)]
    pub fn add1s(&mut self) -> ADD1S_W<'_, RTC_SHIFTRrs> {
        ADD1S_W::new(self, 31)
    }
}
...
pub struct RTC_SHIFTRrs;
impl crate::RegisterSpec for RTC_SHIFTRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`rtc_shiftr::W`](W) writer structure
impl crate::Writable for RTC_SHIFTRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RTC_SHIFTR to value 0
impl crate::Resettable for RTC_SHIFTRrs {}
