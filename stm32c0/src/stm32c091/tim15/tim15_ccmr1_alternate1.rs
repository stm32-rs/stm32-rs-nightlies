...
impl OC1FE_R {
    ...
    ///CC1 behaves normally depending on counter and CCR1 values even when the trigger is ON.
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == OC1FE::B0x0
    }
    ///An active edge on the trigger input acts like a compare match on CC1 output.
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == OC1FE::B0x1
    }
...
impl OC1PE_R {
    ...
    ///Preload register on TIMx_CCR1 disabled.
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == OC1PE::B0x0
    }
...
#[repr(u8)]
pub enum OC1M {
    ///0: Frozen - The comparison between the output compare register TIMx_CCR1 and the counter TIMx_CNT has no effect on the outputs.
    B0x0 = 0,
    ...
    B0x5 = 5,
    ///6: PWM mode 1 - Channel 1 is active as long as TIMx_CNTless thanTIMx_CCR1 else inactive.
    B0x6 = 6,
    ///7: PWM mode 2 - Channel 1 is inactive as long as TIMx_CNTless thanTIMx_CCR1 else active.
    B0x7 = 7,
}
...
impl W {
    ///Bits 0:1 - Capture/Compare 1 selection
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
        CC1S_W::new(self, 0)
    }
    ///Bit 2 - Output Compare 1 fast enable
    #[inline(always)]
    pub fn oc1fe(&mut self) -> OC1FE_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
        OC1FE_W::new(self, 2)
    }
    ///Bit 3 - Output Compare 1 preload enable
    #[inline(always)]
    pub fn oc1pe(&mut self) -> OC1PE_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
        OC1PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC1M\[2:0\]: Output Compare 1 mode
    #[inline(always)]
    pub fn oc1m(&mut self) -> OC1M_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
        OC1M_W::new(self, 4)
    }
    ///Bits 8:9 - Capture/Compare 2 selection
    #[inline(always)]
    pub fn cc2s(&mut self) -> CC2S_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
        CC2S_W::new(self, 8)
    }
    ///Bit 10 - Output Compare 2 fast enable
    #[inline(always)]
    pub fn oc2fe(&mut self) -> OC2FE_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
        OC2FE_W::new(self, 10)
    }
    ///Bit 11 - Output Compare 2 preload enable
    #[inline(always)]
    pub fn oc2pe(&mut self) -> OC2PE_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
        OC2PE_W::new(self, 11)
    }
    ///Bits 12:14 - OC2M\[2:0\]: Output Compare 2 mode
    #[inline(always)]
    pub fn oc2m(&mut self) -> OC2M_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
        OC2M_W::new(self, 12)
    }
    ///Bit 16 - OC1M\[3\]
    #[inline(always)]
    pub fn oc1m_1(&mut self) -> OC1M_1_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
        OC1M_1_W::new(self, 16)
    }
    ///Bit 24 - OC2M\[3\]
    #[inline(always)]
    pub fn oc2m_1(&mut self) -> OC2M_1_W<'_, TIM15_CCMR1_ALTERNATE1rs> {
