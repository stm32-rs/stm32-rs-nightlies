...
pub type R = crate::R<TIM17_CR2rs>;
///Register `TIM17_CR2` writer
pub type W = crate::W<TIM17_CR2rs>;
...
impl W {
    ///Bit 0 - Capture/compare preloaded control Note: This bit acts only on channels that have a complementary output.
    #[inline(always)]
    pub fn ccpc(&mut self) -> CCPC_W<'_, TIM17_CR2rs> {
        CCPC_W::new(self, 0)
    }
    ///Bit 2 - Capture/compare control update selection Note: This bit acts only on channels that have a complementary output.
    #[inline(always)]
    pub fn ccus(&mut self) -> CCUS_W<'_, TIM17_CR2rs> {
        CCUS_W::new(self, 2)
    }
    ///Bit 3 - Capture/compare DMA selection
    #[inline(always)]
    pub fn ccds(&mut self) -> CCDS_W<'_, TIM17_CR2rs> {
        CCDS_W::new(self, 3)
    }
    ///Bit 8 - Output Idle state 1 (OC1 output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
    #[inline(always)]
    pub fn ois1(&mut self) -> OIS1_W<'_, TIM17_CR2rs> {
        OIS1_W::new(self, 8)
    }
    ///Bit 9 - Output Idle state 1 (OC1N output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
    #[inline(always)]
    pub fn ois1n(&mut self) -> OIS1N_W<'_, TIM17_CR2rs> {
        OIS1N_W::new(self, 9)
    }
}
/**TIM17 control register 2

You can [`read`](crate::Reg::read) this register and get [`tim17_cr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim17_cr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C091.html#TIM17:TIM17_CR2)*/
pub struct TIM17_CR2rs;
impl crate::RegisterSpec for TIM17_CR2rs {
    type Ux = u16;
}
///`read()` method returns [`tim17_cr2::R`](R) reader structure
impl crate::Readable for TIM17_CR2rs {}
///`write(|w| ..)` method takes [`tim17_cr2::W`](W) writer structure
impl crate::Writable for TIM17_CR2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM17_CR2 to value 0
impl crate::Resettable for TIM17_CR2rs {}
