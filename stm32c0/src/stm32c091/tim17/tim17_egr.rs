///Register `TIM17_EGR` writer
pub type W = crate::W<TIM17_EGRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<TIM17_EGRrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn ug(&mut self) -> UG_W<'_, TIM17_EGRrs> {
        UG_W::new(self, 0)
    }
    ///Bit 1 - Capture/Compare 1 generation This bit is set by software in order to generate an event, it is automatically cleared by hardware. If channel CC1 is configured as output: CC1IF flag is set, Corresponding interrupt or DMA request is sent if enabled. If channel CC1 is configured as input: The current value of the counter is captured in TIMx_CCR1 register. The CC1IF flag is set, the corresponding interrupt or DMA request is sent if enabled. The CC1OF flag is set if the CC1IF flag was already high.
    #[inline(always)]
    pub fn cc1g(&mut self) -> CC1G_W<'_, TIM17_EGRrs> {
        CC1G_W::new(self, 1)
    }
    ...
    #[inline(always)]
    pub fn comg(&mut self) -> COMG_W<'_, TIM17_EGRrs> {
        COMG_W::new(self, 5)
    }
    ///Bit 7 - Break generation This bit is set by software in order to generate an event, it is automatically cleared by hardware.
    #[inline(always)]
    pub fn bg(&mut self) -> BG_W<'_, TIM17_EGRrs> {
        BG_W::new(self, 7)
    }
}
/**TIM17 event generation register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim17_egr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C091.html#TIM17:TIM17_EGR)*/
pub struct TIM17_EGRrs;
impl crate::RegisterSpec for TIM17_EGRrs {
    type Ux = u16;
}
///`write(|w| ..)` method takes [`tim17_egr::W`](W) writer structure
impl crate::Writable for TIM17_EGRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM17_EGR to value 0
impl crate::Resettable for TIM17_EGRrs {}
