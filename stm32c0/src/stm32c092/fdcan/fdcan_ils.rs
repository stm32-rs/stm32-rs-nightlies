...
impl W {
    ///Bit 0 - RX FIFO bit grouping the following interruption
    #[inline(always)]
    pub fn rxfifo0(&mut self) -> RXFIFO0_W<'_, FDCAN_ILSrs> {
        RXFIFO0_W::new(self, 0)
    }
    ///Bit 1 - RX FIFO bit grouping the following interruption
    #[inline(always)]
    pub fn rxfifo1(&mut self) -> RXFIFO1_W<'_, FDCAN_ILSrs> {
        RXFIFO1_W::new(self, 1)
    }
    ///Bit 2 - Status message bit grouping the following interruption
    #[inline(always)]
    pub fn smsg(&mut self) -> SMSG_W<'_, FDCAN_ILSrs> {
        SMSG_W::new(self, 2)
    }
    ///Bit 3 - Tx FIFO ERROR grouping the following interruption
    #[inline(always)]
    pub fn tferr(&mut self) -> TFERR_W<'_, FDCAN_ILSrs> {
        TFERR_W::new(self, 3)
    }
    ///Bit 4 - Interrupt regrouping the following interruption
    #[inline(always)]
    pub fn misc(&mut self) -> MISC_W<'_, FDCAN_ILSrs> {
        MISC_W::new(self, 4)
    }
    ///Bit 5 - Bit and line error grouping the following interruption
    #[inline(always)]
    pub fn berr(&mut self) -> BERR_W<'_, FDCAN_ILSrs> {
        BERR_W::new(self, 5)
    }
    ///Bit 6 - Protocol error grouping the following interruption
    #[inline(always)]
    pub fn perr(&mut self) -> PERR_W<'_, FDCAN_ILSrs> {
        PERR_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C092.html#FDCAN:FDCAN_ILS)*/
