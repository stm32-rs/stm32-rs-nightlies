...
impl W {
    ...
    #[inline(always)]
    pub fn ctsovf(&mut self) -> CTSOVF_W<'_, RTC_SCRrs> {
        CTSOVF_W::new(self, 4)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C092.html#RTC:RTC_SCR)*/
