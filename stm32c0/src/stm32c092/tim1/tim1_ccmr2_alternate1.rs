///Register `TIM1_CCMR2_ALTERNATE1` reader
pub type R = crate::R<TIM1_CCMR2_ALTERNATE1rs>;
///Register `TIM1_CCMR2_ALTERNATE1` writer
pub type W = crate::W<TIM1_CCMR2_ALTERNATE1rs>;
...
///Field `OC3M` reader - OC3M\[2:0\]: Output compare 3 mode Refer to OC1M\[3:0\] description.
pub type OC3M_R = crate::FieldReader;
///Field `OC3M` writer - OC3M\[2:0\]: Output compare 3 mode Refer to OC1M\[3:0\] description.
...
///Field `OC4M` reader - OC4M\[2:0\]: Output compare 4 mode Refer to OC3M\[3:0\] description.
pub type OC4M_R = crate::FieldReader;
///Field `OC4M` writer - OC4M\[2:0\]: Output compare 4 mode Refer to OC3M\[3:0\] description.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM1_CCMR2_ALTERNATE1")
...
impl W {
    ///Bits 0:1 - Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc3s(&mut self) -> CC3S_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        CC3S_W::new(self, 0)
    }
    ///Bit 2 - Output compare 3 fast enable Refer to OC1FE description.
    #[inline(always)]
    pub fn oc3fe(&mut self) -> OC3FE_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        OC3FE_W::new(self, 2)
    }
    ///Bit 3 - Output compare 3 preload enable Refer to OC1PE description.
    #[inline(always)]
    pub fn oc3pe(&mut self) -> OC3PE_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        OC3PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC3M\[2:0\]: Output compare 3 mode Refer to OC1M\[3:0\] description.
    #[inline(always)]
    pub fn oc3m(&mut self) -> OC3M_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        OC3M_W::new(self, 4)
    }
    ///Bit 7 - Output compare 3 clear enable Refer to OC1CE description.
    #[inline(always)]
    pub fn oc3ce(&mut self) -> OC3CE_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        OC3CE_W::new(self, 7)
    }
    ///Bits 8:9 - Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc4s(&mut self) -> CC4S_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        CC4S_W::new(self, 8)
    }
    ///Bit 10 - Output compare 4 fast enable Refer to OC1FE description.
    #[inline(always)]
    pub fn oc4fe(&mut self) -> OC4FE_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        OC4FE_W::new(self, 10)
    }
    ///Bit 11 - Output compare 4 preload enable Refer to OC1PE description.
    #[inline(always)]
    pub fn oc4pe(&mut self) -> OC4PE_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        OC4PE_W::new(self, 11)
    }
    ///Bits 12:14 - OC4M\[2:0\]: Output compare 4 mode Refer to OC3M\[3:0\] description.
    #[inline(always)]
    pub fn oc4m(&mut self) -> OC4M_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        OC4M_W::new(self, 12)
    }
    ///Bit 15 - Output compare 4 clear enable Refer to OC1CE description.
    #[inline(always)]
    pub fn oc4ce(&mut self) -> OC4CE_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        OC4CE_W::new(self, 15)
    }
    ///Bit 16 - OC3M\[3\]
    #[inline(always)]
    pub fn oc3m_1(&mut self) -> OC3M_1_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
        OC3M_1_W::new(self, 16)
    }
    ///Bit 24 - OC4M\[3\]
    #[inline(always)]
    pub fn oc4m_1(&mut self) -> OC4M_1_W<'_, TIM1_CCMR2_ALTERNATE1rs> {
...
pub struct TIM1_CCMR2_ALTERNATE1rs;
impl crate::RegisterSpec for TIM1_CCMR2_ALTERNATE1rs {
    type Ux = u32;
}
///`read()` method returns [`tim1_ccmr2_alternate1::R`](R) reader structure
impl crate::Readable for TIM1_CCMR2_ALTERNATE1rs {}
///`write(|w| ..)` method takes [`tim1_ccmr2_alternate1::W`](W) writer structure
impl crate::Writable for TIM1_CCMR2_ALTERNATE1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM1_CCMR2_ALTERNATE1 to value 0
impl crate::Resettable for TIM1_CCMR2_ALTERNATE1rs {}
