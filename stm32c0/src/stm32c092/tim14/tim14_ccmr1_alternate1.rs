///Register `TIM14_CCMR1_ALTERNATE1` reader
pub type R = crate::R<TIM14_CCMR1_ALTERNATE1rs>;
///Register `TIM14_CCMR1_ALTERNATE1` writer
pub type W = crate::W<TIM14_CCMR1_ALTERNATE1rs>;
...
///Field `OC1M` reader - OC1M\[2:0\]: Output compare 1 mode (refer to bit 16 for OC1M\[3\]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M\[3\] bit is not contiguous, located in bit 16.
...
///Field `OC1M` writer - OC1M\[2:0\]: Output compare 1 mode (refer to bit 16 for OC1M\[3\]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M\[3\] bit is not contiguous, located in bit 16.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM14_CCMR1_ALTERNATE1")
...
impl W {
    ///Bits 0:1 - Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<'_, TIM14_CCMR1_ALTERNATE1rs> {
        CC1S_W::new(self, 0)
    }
    ///Bit 2 - Output compare 1 fast enable This bit decreases the latency between a trigger event and a transition on the timer output. It must be used in one-pulse mode (OPM bit set in TIMx_CR1 register), to have the output pulse starting as soon as possible after the starting trigger.
    #[inline(always)]
    pub fn oc1fe(&mut self) -> OC1FE_W<'_, TIM14_CCMR1_ALTERNATE1rs> {
        OC1FE_W::new(self, 2)
    }
    ///Bit 3 - Output compare 1 preload enable
    #[inline(always)]
    pub fn oc1pe(&mut self) -> OC1PE_W<'_, TIM14_CCMR1_ALTERNATE1rs> {
        OC1PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC1M\[2:0\]: Output compare 1 mode (refer to bit 16 for OC1M\[3\]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M\[3\] bit is not contiguous, located in bit 16.
    #[inline(always)]
    pub fn oc1m(&mut self) -> OC1M_W<'_, TIM14_CCMR1_ALTERNATE1rs> {
        OC1M_W::new(self, 4)
    }
    ///Bit 16 - OC1M\[3\]
    #[inline(always)]
    pub fn oc1m_1(&mut self) -> OC1M_1_W<'_, TIM14_CCMR1_ALTERNATE1rs> {
        OC1M_1_W::new(self, 16)
    }
}
/**TIM14 capture/compare mode register 1

You can [`read`](crate::Reg::read) this register and get [`tim14_ccmr1_alternate1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim14_ccmr1_alternate1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C092.html#TIM14:TIM14_CCMR1_ALTERNATE1)*/
pub struct TIM14_CCMR1_ALTERNATE1rs;
impl crate::RegisterSpec for TIM14_CCMR1_ALTERNATE1rs {
    type Ux = u32;
}
///`read()` method returns [`tim14_ccmr1_alternate1::R`](R) reader structure
impl crate::Readable for TIM14_CCMR1_ALTERNATE1rs {}
///`write(|w| ..)` method takes [`tim14_ccmr1_alternate1::W`](W) writer structure
impl crate::Writable for TIM14_CCMR1_ALTERNATE1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM14_CCMR1_ALTERNATE1 to value 0
impl crate::Resettable for TIM14_CCMR1_ALTERNATE1rs {}
