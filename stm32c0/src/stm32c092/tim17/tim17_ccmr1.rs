///Register `TIM17_CCMR1` reader
pub type R = crate::R<TIM17_CCMR1rs>;
///Register `TIM17_CCMR1` writer
pub type W = crate::W<TIM17_CCMR1rs>;
...
pub enum IC1F {
    ...
    B0x3 = 3,
    ///4: f<sub>SAMPLING</sub>=f<sub>DTS</sub>/2, N=
    B0x4 = 4,
...
impl IC1F_R {
    ...
    ///f<sub>SAMPLING</sub>=f<sub>DTS</sub>/2, N=
    #[inline(always)]
...
impl W {
    ///Bits 0:1 - Capture/Compare 1 Selection This bit-field defines the direction of the channel (input/output) as well as the used input. Others: Reserved Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<'_, TIM17_CCMR1rs> {
        CC1S_W::new(self, 0)
    }
    ///Bits 2:3 - Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E= 0 (TIMx_CCER register).
    #[inline(always)]
    pub fn ic1psc(&mut self) -> IC1PSC_W<'_, TIM17_CCMR1rs> {
        IC1PSC_W::new(self, 2)
    }
    ///Bits 4:7 - Input capture 1 filter This bit-field defines the frequency used to sample TI1 input and the length of the digital filter applied to TI1. The digital filter is made of an event counter in which N consecutive events are needed to validate a transition on the output:
    #[inline(always)]
    pub fn ic1f(&mut self) -> IC1F_W<'_, TIM17_CCMR1rs> {
        IC1F_W::new(self, 4)
    }
}
/**TIM17 capture/compare mode register 1

You can [`read`](crate::Reg::read) this register and get [`tim17_ccmr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim17_ccmr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C092.html#TIM17:TIM17_CCMR1)*/
pub struct TIM17_CCMR1rs;
impl crate::RegisterSpec for TIM17_CCMR1rs {
    type Ux = u32;
}
///`read()` method returns [`tim17_ccmr1::R`](R) reader structure
impl crate::Readable for TIM17_CCMR1rs {}
///`write(|w| ..)` method takes [`tim17_ccmr1::W`](W) writer structure
impl crate::Writable for TIM17_CCMR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM17_CCMR1 to value 0
impl crate::Resettable for TIM17_CCMR1rs {}
