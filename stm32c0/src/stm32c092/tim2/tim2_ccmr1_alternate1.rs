///Register `TIM2_CCMR1_ALTERNATE1` reader
pub type R = crate::R<TIM2_CCMR1_ALTERNATE1rs>;
///Register `TIM2_CCMR1_ALTERNATE1` writer
pub type W = crate::W<TIM2_CCMR1_ALTERNATE1rs>;
...
pub enum OC1M {
    ...
    B0x5 = 5,
    ///6: PWM mode 1 - In upcounting, channel 1 is active as long as TIMx_CNTless thanTIMx_CCR1 else inactive.
    B0x6 = 6,
    ///7: PWM mode 2 - In upcounting, channel 1 is inactive as long as TIMx_CNTless thanTIMx_CCR1 else active.
    B0x7 = 7,
}
...
impl OC1M_R {
    ...
    ///PWM mode 1 - In upcounting, channel 1 is active as long as TIMx_CNTless thanTIMx_CCR1 else inactive.
    #[inline(always)]
    pub fn is_b_0x6(&self) -> bool {
        *self == OC1M::B0x6
    }
    ///PWM mode 2 - In upcounting, channel 1 is inactive as long as TIMx_CNTless thanTIMx_CCR1 else active.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM2_CCMR1_ALTERNATE1")
...
impl W {
    ///Bits 0:1 - Capture/Compare 1 selection
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        CC1S_W::new(self, 0)
    }
    ///Bit 2 - Output compare 1 fast enable
    #[inline(always)]
    pub fn oc1fe(&mut self) -> OC1FE_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC1FE_W::new(self, 2)
    }
    ///Bit 3 - Output compare 1 preload enable
    #[inline(always)]
    pub fn oc1pe(&mut self) -> OC1PE_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC1PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC1M\[2:0\]: Output compare 1 mode
    #[inline(always)]
    pub fn oc1m(&mut self) -> OC1M_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC1M_W::new(self, 4)
    }
    ///Bit 7 - Output compare 1 clear enable
    #[inline(always)]
    pub fn oc1ce(&mut self) -> OC1CE_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC1CE_W::new(self, 7)
    }
    ///Bits 8:9 - Capture/Compare 2 selection
    #[inline(always)]
    pub fn cc2s(&mut self) -> CC2S_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        CC2S_W::new(self, 8)
    }
    ///Bit 10 - Output compare 2 fast enable
    #[inline(always)]
    pub fn oc2fe(&mut self) -> OC2FE_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC2FE_W::new(self, 10)
    }
    ///Bit 11 - Output compare 2 preload enable
    #[inline(always)]
    pub fn oc2pe(&mut self) -> OC2PE_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC2PE_W::new(self, 11)
    }
    ///Bits 12:14 - OC2M\[2:0\]: Output compare 2 mode
    #[inline(always)]
    pub fn oc2m(&mut self) -> OC2M_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC2M_W::new(self, 12)
    }
    ///Bit 15 - Output compare 2 clear enable
    #[inline(always)]
    pub fn oc2ce(&mut self) -> OC2CE_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC2CE_W::new(self, 15)
    }
    ///Bit 16 - OC1M\[3\]
    #[inline(always)]
    pub fn oc1m_1(&mut self) -> OC1M_1_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC1M_1_W::new(self, 16)
    }
    ///Bit 24 - OC2M\[3\]
    #[inline(always)]
    pub fn oc2m_1(&mut self) -> OC2M_1_W<'_, TIM2_CCMR1_ALTERNATE1rs> {
        OC2M_1_W::new(self, 24)
    }
}
/**TIM2 capture/compare mode register 1

You can [`read`](crate::Reg::read) this register and get [`tim2_ccmr1_alternate1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim2_ccmr1_alternate1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C092.html#TIM2:TIM2_CCMR1_ALTERNATE1)*/
pub struct TIM2_CCMR1_ALTERNATE1rs;
impl crate::RegisterSpec for TIM2_CCMR1_ALTERNATE1rs {
    type Ux = u32;
}
///`read()` method returns [`tim2_ccmr1_alternate1::R`](R) reader structure
impl crate::Readable for TIM2_CCMR1_ALTERNATE1rs {}
///`write(|w| ..)` method takes [`tim2_ccmr1_alternate1::W`](W) writer structure
impl crate::Writable for TIM2_CCMR1_ALTERNATE1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM2_CCMR1_ALTERNATE1 to value 0
impl crate::Resettable for TIM2_CCMR1_ALTERNATE1rs {}
