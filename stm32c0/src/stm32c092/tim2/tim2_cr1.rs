///Register `TIM2_CR1` reader
pub type R = crate::R<TIM2_CR1rs>;
///Register `TIM2_CR1` writer
pub type W = crate::W<TIM2_CR1rs>;
/**Counter enable
...
#[repr(u8)]
pub enum CKD {
    ///0: tless thansub>DTSless than/sub> = tless thansub>CK_INTless than/sub>
    B0x0 = 0,
    ///1: tless thansub>DTSless than/sub> = 2 X tless thansub>CK_INTless than/sub>
    B0x1 = 1,
    ///2: tless thansub>DTSless than/sub> = 4 X tless thansub>CK_INTless than/sub>
    B0x2 = 2,
}
...
impl CKD_R {
    ...
    ///tless thansub>DTSless than/sub> = tless thansub>CK_INTless than/sub>
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == CKD::B0x0
    }
    ///tless thansub>DTSless than/sub> = 2 X tless thansub>CK_INTless than/sub>
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == CKD::B0x1
    }
    ///tless thansub>DTSless than/sub> = 4 X tless thansub>CK_INTless than/sub>
    #[inline(always)]
    pub fn is_b_0x2(&self) -> bool {
        *self == CKD::B0x2
    }
...
impl W {
    ///Bit 0 - Counter enable
    #[inline(always)]
    pub fn cen(&mut self) -> CEN_W<'_, TIM2_CR1rs> {
        CEN_W::new(self, 0)
    }
    ///Bit 1 - Update disable
    #[inline(always)]
    pub fn udis(&mut self) -> UDIS_W<'_, TIM2_CR1rs> {
        UDIS_W::new(self, 1)
    }
    ///Bit 2 - Update request source
    #[inline(always)]
    pub fn urs(&mut self) -> URS_W<'_, TIM2_CR1rs> {
        URS_W::new(self, 2)
    }
    ///Bit 3 - One-pulse mode
    #[inline(always)]
    pub fn opm(&mut self) -> OPM_W<'_, TIM2_CR1rs> {
        OPM_W::new(self, 3)
    }
    ///Bit 4 - Direction
    #[inline(always)]
    pub fn dir(&mut self) -> DIR_W<'_, TIM2_CR1rs> {
        DIR_W::new(self, 4)
    }
    ///Bits 5:6 - Center-aligned mode selection
    #[inline(always)]
    pub fn cms(&mut self) -> CMS_W<'_, TIM2_CR1rs> {
        CMS_W::new(self, 5)
    }
    ///Bit 7 - Auto-reload preload enable
    #[inline(always)]
    pub fn arpe(&mut self) -> ARPE_W<'_, TIM2_CR1rs> {
        ARPE_W::new(self, 7)
    }
    ///Bits 8:9 - Clock division
    #[inline(always)]
    pub fn ckd(&mut self) -> CKD_W<'_, TIM2_CR1rs> {
        CKD_W::new(self, 8)
    }
    ///Bit 11 - UIF status bit remapping
    #[inline(always)]
    pub fn uifremap(&mut self) -> UIFREMAP_W<'_, TIM2_CR1rs> {
        UIFREMAP_W::new(self, 11)
    }
}
/**TIM2 control register 1

You can [`read`](crate::Reg::read) this register and get [`tim2_cr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim2_cr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C092.html#TIM2:TIM2_CR1)*/
pub struct TIM2_CR1rs;
impl crate::RegisterSpec for TIM2_CR1rs {
    type Ux = u16;
}
///`read()` method returns [`tim2_cr1::R`](R) reader structure
impl crate::Readable for TIM2_CR1rs {}
///`write(|w| ..)` method takes [`tim2_cr1::W`](W) writer structure
impl crate::Writable for TIM2_CR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM2_CR1 to value 0
impl crate::Resettable for TIM2_CR1rs {}
