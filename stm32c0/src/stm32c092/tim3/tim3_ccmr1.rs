///Register `TIM3_CCMR1` reader
pub type R = crate::R<TIM3_CCMR1rs>;
///Register `TIM3_CCMR1` writer
pub type W = crate::W<TIM3_CCMR1rs>;
...
impl W {
    ///Bits 0:1 - Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<'_, TIM3_CCMR1rs> {
        CC1S_W::new(self, 0)
    }
    ///Bits 2:3 - Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E=0 (TIMx_CCER register).
    #[inline(always)]
    pub fn ic1psc(&mut self) -> IC1PSC_W<'_, TIM3_CCMR1rs> {
        IC1PSC_W::new(self, 2)
    }
    ///Bits 4:7 - Input capture 1 filter This bit-field defines the frequency used to sample TI1 input and the length of the digital filter applied to TI1. The digital filter is made of an event counter in which N consecutive events are needed to validate a transition on the output:
    #[inline(always)]
    pub fn ic1f(&mut self) -> IC1F_W<'_, TIM3_CCMR1rs> {
        IC1F_W::new(self, 4)
    }
    ///Bits 8:9 - Capture/compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc2s(&mut self) -> CC2S_W<'_, TIM3_CCMR1rs> {
        CC2S_W::new(self, 8)
    }
    ///Bits 10:11 - Input capture 2 prescaler
    #[inline(always)]
    pub fn ic2psc(&mut self) -> IC2PSC_W<'_, TIM3_CCMR1rs> {
        IC2PSC_W::new(self, 10)
    }
    ///Bits 12:15 - Input capture 2 filter
    #[inline(always)]
    pub fn ic2f(&mut self) -> IC2F_W<'_, TIM3_CCMR1rs> {
        IC2F_W::new(self, 12)
    }
}
/**TIM3 capture/compare mode register 1

You can [`read`](crate::Reg::read) this register and get [`tim3_ccmr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim3_ccmr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32C092.html#TIM3:TIM3_CCMR1)*/
pub struct TIM3_CCMR1rs;
impl crate::RegisterSpec for TIM3_CCMR1rs {
    type Ux = u32;
}
///`read()` method returns [`tim3_ccmr1::R`](R) reader structure
impl crate::Readable for TIM3_CCMR1rs {}
///`write(|w| ..)` method takes [`tim3_ccmr1::W`](W) writer structure
impl crate::Writable for TIM3_CCMR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM3_CCMR1 to value 0
impl crate::Resettable for TIM3_CCMR1rs {}
