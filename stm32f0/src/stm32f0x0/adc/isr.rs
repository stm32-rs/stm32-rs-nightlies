...
pub type EOSEQ_W<'a, REG> = crate::BitWriter<'a, REG, EOSEQW>;
...
impl W {
    ...
    ///Bit 3 - End of sequence flag
    #[inline(always)]
    pub fn eoseq(&mut self) -> EOSEQ_W<ISRrs> {
        EOSEQ_W::new(self, 3)
    }
    ///Bit 4 - ADC overrun
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x0.html#ADC:ISR)*/
pub struct ISRrs;
