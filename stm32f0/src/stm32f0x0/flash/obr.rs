...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x0.html#Flash:OBR)*/
pub struct OBRrs;
...
///`reset()` method sets OBR to value 0x03ff_ff02
impl crate::Resettable for OBRrs {
    const RESET_VALUE: u32 = 0x03ff_ff02;
}
