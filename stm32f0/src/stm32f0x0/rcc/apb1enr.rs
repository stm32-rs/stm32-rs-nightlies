...
pub struct TIM3EN_R(crate::FieldReader<bool, TIM3EN_A>);
impl TIM3EN_R {
...
impl core::ops::Deref for TIM3EN_R {
    type Target = crate::FieldReader<bool, TIM3EN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
