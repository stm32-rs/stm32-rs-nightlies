...
pub struct TIM3RST_R(crate::FieldReader<bool, TIM3RST_A>);
impl TIM3RST_R {
...
impl core::ops::Deref for TIM3RST_R {
    type Target = crate::FieldReader<bool, TIM3RST_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub type USART2RST_R = TIM3RST_R;
...
pub type USART3RST_R = TIM3RST_R;
...
pub type USART4RST_R = TIM3RST_R;
...
pub type USART5RST_R = TIM3RST_R;
