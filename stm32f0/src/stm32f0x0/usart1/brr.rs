...
///Field `BRR` reader - mantissa of USARTDIV
pub type BRR_R = crate::FieldReader<u16>;
///Field `BRR` writer - mantissa of USARTDIV
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x0.html#USART1:BRR)*/
pub struct BRRrs;
