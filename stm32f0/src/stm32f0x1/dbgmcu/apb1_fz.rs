...
///Field `TIM3_counter_stopped_when_core_is_halted` reader - TIM6 counter stopped when core is halted
pub type TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_R = crate::BitReader;
///Field `TIM3_counter_stopped_when_core_is_halted` writer - TIM6 counter stopped when core is halted
pub type TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_W<'a, REG> = crate::BitWriter<'a, REG>;
...
///Field `DBG_CAN_STOP` reader - CAN stopped when core is halted
pub type DBG_CAN_STOP_R = crate::BitReader;
///Field `DBG_CAN_STOP` writer - CAN stopped when core is halted
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB1_FZ")
            ...
            .field(
                "tim3_counter_stopped_when_core_is_halted",
                &self.tim3_counter_stopped_when_core_is_halted(),
            )
...
impl W {
    ...
    pub fn tim3_counter_stopped_when_core_is_halted(
        &mut self,
    ) -> TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_W<'_, APB1_FZrs> {
        TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_W::new(self, 4)
    }
    ///Bit 5 - TIM7 counter stopped when core is halted
    #[inline(always)]
    ...
    ///Bit 25 - CAN stopped when core is halted
    #[inline(always)]
    pub fn dbg_can_stop(&mut self) -> DBG_CAN_STOP_W<'_, APB1_FZrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x1.html#DBGMCU:APB1_FZ)*/
