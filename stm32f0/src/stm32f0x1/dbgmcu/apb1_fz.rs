...
pub struct TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_R(crate::FieldReader<bool, bool>);
impl TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_R {
    pub(crate) fn new(bits: bool) -> Self {
        TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
