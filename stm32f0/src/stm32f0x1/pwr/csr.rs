...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CSR")
            ...
            .field("vrefintrdy", &self.vrefintrdy())
...
impl W {
    ...
    ///Bit 15 - Enable WKUP pin 8
    #[inline(always)]
    pub fn ewup8(&mut self) -> EWUP8_W<'_, CSRrs> {
        EWUP8_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x1.html#PWR:CSR)*/
pub struct CSRrs;
