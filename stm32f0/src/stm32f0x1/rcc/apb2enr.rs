...
///Field `USART7EN` reader - USART7 clock enable
pub use SYSCFGEN_R as USART7EN_R;
///Field `USART8EN` reader - USART8 clock enable
...
///Field `USART7EN` writer - USART7 clock enable
pub use SYSCFGEN_W as USART7EN_W;
///Field `USART8EN` writer - USART8 clock enable
...
impl W {
    ...
    ///Bit 6 - USART7 clock enable
    #[inline(always)]
    pub fn usart7en(&mut self) -> USART7EN_W<'_, APB2ENRrs> {
        USART7EN_W::new(self, 6)
    }
    ///Bit 7 - USART8 clock enable
    #[inline(always)]
    pub fn usart8en(&mut self) -> USART8EN_W<'_, APB2ENRrs> {
