...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `CHSEL0` field.</div>
    #[inline(always)]
    pub fn chsel(&mut self, n: u8) -> CHSEL_W<CHSELRrs> {
        #[allow(clippy::no_effect)]
        [(); 19][n as usize];
        CHSEL_W::new(self, n)
    }
    ///Bit 0 - Channel-x selection
    #[inline(always)]
    pub fn chsel0(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 0)
    }
    ///Bit 1 - Channel-x selection
    #[inline(always)]
    pub fn chsel1(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 1)
    }
    ///Bit 2 - Channel-x selection
    #[inline(always)]
    pub fn chsel2(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 2)
    }
    ///Bit 3 - Channel-x selection
    #[inline(always)]
    pub fn chsel3(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 3)
    }
    ///Bit 4 - Channel-x selection
    #[inline(always)]
    pub fn chsel4(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 4)
    }
    ///Bit 5 - Channel-x selection
    #[inline(always)]
    pub fn chsel5(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 5)
    }
    ///Bit 6 - Channel-x selection
    #[inline(always)]
    pub fn chsel6(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 6)
    }
    ///Bit 7 - Channel-x selection
    #[inline(always)]
    pub fn chsel7(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 7)
    }
    ///Bit 8 - Channel-x selection
    #[inline(always)]
    pub fn chsel8(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 8)
    }
    ///Bit 9 - Channel-x selection
    #[inline(always)]
    pub fn chsel9(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 9)
    }
    ///Bit 10 - Channel-x selection
    #[inline(always)]
    pub fn chsel10(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 10)
    }
    ///Bit 11 - Channel-x selection
    #[inline(always)]
    pub fn chsel11(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 11)
    }
    ///Bit 12 - Channel-x selection
    #[inline(always)]
    pub fn chsel12(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 12)
    }
    ///Bit 13 - Channel-x selection
    #[inline(always)]
    pub fn chsel13(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 13)
    }
    ///Bit 14 - Channel-x selection
    #[inline(always)]
    pub fn chsel14(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 14)
    }
    ///Bit 15 - Channel-x selection
    #[inline(always)]
    pub fn chsel15(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 15)
    }
    ///Bit 16 - Channel-x selection
    #[inline(always)]
    pub fn chsel16(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 16)
    }
    ///Bit 17 - Channel-x selection
    #[inline(always)]
    pub fn chsel17(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 17)
    }
    ///Bit 18 - Channel-x selection
    #[inline(always)]
    pub fn chsel18(&mut self) -> CHSEL_W<CHSELRrs> {
        CHSEL_W::new(self, 18)
    }
}
