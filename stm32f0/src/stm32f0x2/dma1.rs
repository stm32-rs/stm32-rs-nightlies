...
/**ISR (r) register accessor: DMA interrupt status register (DMA_ISR)

You can [`read`](crate::Reg::read) this register and get [`isr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x2.html#DMA1:ISR)

For information about available fields see [`mod@isr`] module*/
pub type ISR = crate::Reg<isr::ISRrs>;
///DMA interrupt status register (DMA_ISR)
pub mod isr;
/**IFCR (w) register accessor: DMA interrupt flag clear register (DMA_IFCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x2.html#DMA1:IFCR)
