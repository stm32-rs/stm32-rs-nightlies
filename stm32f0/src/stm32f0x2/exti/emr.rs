...
impl W {
    ...
    ///Bit 23 - Event Mask on line 23
    #[inline(always)]
    pub fn mr23(&mut self) -> MR23_W<'_, EMRrs> {
        MR23_W::new(self, 23)
    }
    ///Bit 24 - Event Mask on line 24
    #[inline(always)]
    pub fn mr24(&mut self) -> MR24_W<'_, EMRrs> {
        MR24_W::new(self, 24)
    }
    ///Bit 25 - Event Mask on line 25
    #[inline(always)]
    pub fn mr25(&mut self) -> MR25_W<'_, EMRrs> {
        MR25_W::new(self, 25)
    }
    ///Bit 26 - Event Mask on line 26
    #[inline(always)]
    pub fn mr26(&mut self) -> MR26_W<'_, EMRrs> {
        MR26_W::new(self, 26)
    }
    ///Bit 27 - Event Mask on line 27
    #[inline(always)]
    pub fn mr27(&mut self) -> MR27_W<'_, EMRrs> {
        MR27_W::new(self, 27)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x2.html#EXTI:EMR)*/
pub struct EMRrs;
