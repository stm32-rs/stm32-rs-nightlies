...
pub struct RAM_PARITY_CHECK_R(crate::FieldReader<bool, RAM_PARITY_CHECK_A>);
...
impl core::ops::Deref for RAM_PARITY_CHECK_R {
    type Target = crate::FieldReader<bool, RAM_PARITY_CHECK_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct BOOT_SEL_R(crate::FieldReader<bool, BOOT_SEL_A>);
impl BOOT_SEL_R {
    pub(crate) fn new(bits: bool) -> Self {
        BOOT_SEL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for BOOT_SEL_R {
    type Target = crate::FieldReader<bool, BOOT_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
