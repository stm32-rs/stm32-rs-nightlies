...
///Field `LCKK` reader - Port x lock bit y
...
///Field `LCKK` writer - Port x lock bit y
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x2.html#GPIOF:LCKR)*/
pub struct LCKRrs;
