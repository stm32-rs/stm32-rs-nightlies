...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim16_dma_rmp2(&mut self) -> TIM16_DMA_RMP2_W<CFGR1rs> {
        TIM16_DMA_RMP2_W::new(self, 13)
    }
    ///Bit 14 - TIM17 alternate DMA request remapping bit
    #[inline(always)]
    #[must_use]
    pub fn tim17_dma_rmp2(&mut self) -> TIM17_DMA_RMP2_W<CFGR1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi2_dma_rmp(&mut self) -> SPI2_DMA_RMP_W<CFGR1rs> {
        SPI2_DMA_RMP_W::new(self, 24)
    }
    ///Bit 25 - USART2 DMA request remapping bit
    #[inline(always)]
    #[must_use]
    pub fn usart2_dma_rmp(&mut self) -> USART2_DMA_RMP_W<CFGR1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c1_dma_rmp(&mut self) -> I2C1_DMA_RMP_W<CFGR1rs> {
        I2C1_DMA_RMP_W::new(self, 27)
    }
    ///Bit 28 - TIM1 DMA request remapping bit
    #[inline(always)]
    #[must_use]
    pub fn tim1_dma_rmp(&mut self) -> TIM1_DMA_RMP_W<CFGR1rs> {
        TIM1_DMA_RMP_W::new(self, 28)
    }
    ///Bit 29 - TIM2 DMA request remapping bit
    #[inline(always)]
    #[must_use]
    pub fn tim2_dma_rmp(&mut self) -> TIM2_DMA_RMP_W<CFGR1rs> {
        TIM2_DMA_RMP_W::new(self, 29)
    }
    ///Bit 30 - TIM3 DMA request remapping bit
    #[inline(always)]
    #[must_use]
    pub fn tim3_dma_rmp(&mut self) -> TIM3_DMA_RMP_W<CFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x2.html#SYSCFG:CFGR1)*/
pub struct CFGR1rs;
