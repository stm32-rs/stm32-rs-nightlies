...
impl crate::IsEnum for COMP2MODE {}
...
pub type COMP2MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2, COMP2MODE, crate::Safe>;
...
pub type COMP2OUTSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3, COMP2OUTSEL, crate::Safe>;
...
impl crate::IsEnum for COMP2HYST {}
...
pub type COMP2HYST_W<'a, REG> = crate::FieldWriter<'a, REG, 2, COMP2HYST, crate::Safe>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x8.html#COMP:CSR)*/
pub struct CSRrs;
