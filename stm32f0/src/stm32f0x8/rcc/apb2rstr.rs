...
#[doc = "Reader of field `USART8RST`"]
pub type USART8RST_R = crate::R<bool, SYSCFGRST_A>;
#[doc = "Write proxy for field `USART8RST`"]
...
#[doc = "Reader of field `USART7RST`"]
pub type USART7RST_R = crate::R<bool, SYSCFGRST_A>;
#[doc = "Write proxy for field `USART7RST`"]
