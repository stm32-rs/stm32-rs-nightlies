...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hsi14rdyie(&mut self) -> HSI14RDYIE_W<CIRrs> {
        HSI14RDYIE_W::new(self, 13)
    }
    ///Bit 14 - HSI48 ready interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn hsi48rdyie(&mut self) -> HSI48RDYIE_W<CIRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hsi14rdyc(&mut self) -> HSI14RDYC_W<CIRrs> {
        HSI14RDYC_W::new(self, 21)
    }
    ///Bit 22 - HSI48 Ready Interrupt Clear
    #[inline(always)]
    #[must_use]
    pub fn hsi48rdyc(&mut self) -> HSI48RDYC_W<CIRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x8.html#RCC:CIR)*/
pub struct CIRrs;
