...
///Field `G_IO1(1-6)` reader - G%s_IO1 analog switch enable
...
///Field `G_IO1(1-6)` writer - G%s_IO1 analog switch enable
...
///Field `G_IO2(1-6)` reader - G%s_IO2 analog switch enable
pub use G_IO1_R as G_IO2_R;
///Field `G_IO3(1-6)` reader - G%s_IO3 analog switch enable
pub use G_IO1_R as G_IO3_R;
///Field `G_IO4(1-6)` reader - G%s_IO4 analog switch enable
pub use G_IO1_R as G_IO4_R;
///Field `G_IO2(1-6)` writer - G%s_IO2 analog switch enable
pub use G_IO1_W as G_IO2_W;
///Field `G_IO3(1-6)` writer - G%s_IO3 analog switch enable
pub use G_IO1_W as G_IO3_W;
///Field `G_IO4(1-6)` writer - G%s_IO4 analog switch enable
pub use G_IO1_W as G_IO4_W;
impl R {
    ///G(1-6)_IO1 analog switch enable
    ///
    ...
    ///G(1-6)_IO2 analog switch enable
    ///
    ...
    ///G(1-6)_IO3 analog switch enable
    ///
    ...
    ///G(1-6)_IO4 analog switch enable
    ///
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F0x8.html#TSC:IOASCR)*/
pub struct IOASCRrs;
