...
impl W {
    ...
    ///Bit 22 - DBG_TIM15_STOP
    #[inline(always)]
    pub fn dbg_tim15_stop(&mut self) -> DBG_TIM15_STOP_W<'_, CRrs> {
        DBG_TIM15_STOP_W::new(self, 22)
    }
    ///Bit 23 - DBG_TIM16_STOP
    #[inline(always)]
    pub fn dbg_tim16_stop(&mut self) -> DBG_TIM16_STOP_W<'_, CRrs> {
        DBG_TIM16_STOP_W::new(self, 23)
    }
    ///Bit 24 - DBG_TIM17_STOP
    #[inline(always)]
    pub fn dbg_tim17_stop(&mut self) -> DBG_TIM17_STOP_W<'_, CRrs> {
