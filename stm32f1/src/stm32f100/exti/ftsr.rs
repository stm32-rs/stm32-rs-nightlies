...
///Field `TR(0-17)` reader - Falling trigger event configuration of line %s
...
///Field `TR(0-17)` writer - Falling trigger event configuration of line %s
...
impl R {
    ///Falling trigger event configuration of line (0-17)
    ///
    ...
    pub fn tr_iter(&self) -> impl Iterator<Item = TR_R> + '_ {
        (0..18).map(move |n| TR_R::new(((self.bits >> n) & 1) != 0))
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F100.html#EXTI:FTSR)*/
pub struct FTSRrs;
