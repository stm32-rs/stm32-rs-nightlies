...
///Field `TR(0-17)` reader - Rising trigger event configuration of line %s
...
///Field `TR(0-17)` writer - Rising trigger event configuration of line %s
...
impl R {
    ///Rising trigger event configuration of line (0-17)
    ///
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F100.html#EXTI:RTSR)*/
pub struct RTSRrs;
