...
///Field `SWIER(0-17)` reader - Software Interrupt on line %s
...
///Field `SWIER(0-17)` writer - Software Interrupt on line %s
...
impl R {
    ///Software Interrupt on line (0-17)
    ///
    ...
    pub fn swier_iter(&self) -> impl Iterator<Item = SWIER_R> + '_ {
        (0..18).map(move |n| SWIER_R::new(((self.bits >> n) & 1) != 0))
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F100.html#EXTI:SWIER)*/
pub struct SWIERrs;
