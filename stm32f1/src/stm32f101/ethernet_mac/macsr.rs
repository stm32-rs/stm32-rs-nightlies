...
impl W {
    ///Bit 3 - PMT status
    #[inline(always)]
    pub fn pmts(&mut self) -> PMTS_W<'_, MACSRrs> {
        PMTS_W::new(self, 3)
    }
    ///Bit 4 - MMC status
    #[inline(always)]
    pub fn mmcs(&mut self) -> MMCS_W<'_, MACSRrs> {
        MMCS_W::new(self, 4)
    }
    ///Bit 5 - MMC receive status
    #[inline(always)]
    pub fn mmcrs(&mut self) -> MMCRS_W<'_, MACSRrs> {
        MMCRS_W::new(self, 5)
    }
    ///Bit 6 - MMC transmit status
    #[inline(always)]
    pub fn mmcts(&mut self) -> MMCTS_W<'_, MACSRrs> {
        MMCTS_W::new(self, 6)
    }
    ///Bit 9 - Time stamp trigger status
    #[inline(always)]
