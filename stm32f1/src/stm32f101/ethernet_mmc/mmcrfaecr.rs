...
///Field `RFAEC` reader - Received frames with alignment error counter
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F101.html#Ethernet_MMC:MMCRFAECR)*/
