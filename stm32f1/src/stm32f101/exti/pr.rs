...
///Field `PR(0-18)` reader - Pending bit %s
...
///Field `PR(0-18)` writer - Pending bit %s
...
impl R {
    ...
    pub fn pr_iter(&self) -> impl Iterator<Item = PR_R> + '_ {
        (0..19).map(move |n| PR_R::new(((self.bits >> n) & 1) != 0))
    }
    ///Bit 0 - Pending bit 0
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F101.html#EXTI:PR)*/
pub struct PRrs;
