#[doc = "Reader of register FS_CID"]
pub type R = crate::R<u32, super::FS_CID>;
#[doc = "Writer for register FS_CID"]
pub type W = crate::W<u32, super::FS_CID>;
#[doc = "Register FS_CID `reset()`'s with value 0x1000"]
impl crate::ResetValue for super::FS_CID {
    type Type = u32;
    #[inline(always)]
