#[doc = "Reader of register FS_HCCHAR1"]
pub type R = crate::R<u32, super::FS_HCCHAR1>;
#[doc = "Writer for register FS_HCCHAR1"]
pub type W = crate::W<u32, super::FS_HCCHAR1>;
#[doc = "Register FS_HCCHAR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::FS_HCCHAR1 {
    type Type = u32;
    #[inline(always)]
