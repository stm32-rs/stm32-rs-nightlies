...
///Field `TR(0-18)` reader - Falling trigger event configuration of line %s
...
///Field `TR(0-18)` writer - Falling trigger event configuration of line %s
...
impl R {
    ///Falling trigger event configuration of line (0-18)
    ///
    ...
    pub fn tr_iter(&self) -> impl Iterator<Item = TR_R> + '_ {
        (0..19).map(move |n| TR_R::new(((self.bits >> n) & 1) != 0))
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F102.html#EXTI:FTSR)*/
pub struct FTSRrs;
