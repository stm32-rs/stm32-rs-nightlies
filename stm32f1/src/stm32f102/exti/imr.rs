...
///Field `MR(0-18)` reader - Interrupt Mask on line %s
...
///Field `MR(0-18)` writer - Interrupt Mask on line %s
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F102.html#EXTI:IMR)*/
pub struct IMRrs;
