#[doc = "Reader of register FS_HCINT3"]
pub type R = crate::R<u32, super::FS_HCINT3>;
#[doc = "Writer for register FS_HCINT3"]
pub type W = crate::W<u32, super::FS_HCINT3>;
#[doc = "Register FS_HCINT3 `reset()`'s with value 0"]
impl crate::ResetValue for super::FS_HCINT3 {
    type Type = u32;
    #[inline(always)]
