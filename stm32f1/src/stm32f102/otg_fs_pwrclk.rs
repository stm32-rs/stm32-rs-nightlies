...
/**PCGCCTL (rw) register accessor: OTG_FS power and clock gating control register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F102.html#OTG_FS_PWRCLK:PCGCCTL)
