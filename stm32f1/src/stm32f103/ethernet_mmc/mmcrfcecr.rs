...
///Field `RFCFC` reader - Received frames with CRC error counter
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F103.html#Ethernet_MMC:MMCRFCECR)*/
