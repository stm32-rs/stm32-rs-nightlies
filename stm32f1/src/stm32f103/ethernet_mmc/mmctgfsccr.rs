...
///Field `TGFSCC` reader - Transmitted good frames after a single collision counter
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F103.html#Ethernet_MMC:MMCTGFSCCR)*/
