...
///Field `SWIER(0-18)` reader - Software Interrupt on line %s
pub type SWIER_R = crate::BitReader<SWIER0W>;
impl SWIER_R {
...
///Field `SWIER(0-18)` writer - Software Interrupt on line %s
pub type SWIER_W<'a, REG> = crate::BitWriter<'a, REG, SWIER0W>;
...
impl R {
    ///Software Interrupt on line (0-18)
    ///
    ...
    pub fn swier_iter(&self) -> impl Iterator<Item = SWIER_R> + '_ {
        (0..19).map(move |n| SWIER_R::new(((self.bits >> n) & 1) != 0))
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F103.html#EXTI:SWIER)*/
pub struct SWIERrs;
