...
pub struct R(crate::R<FS_HCTSIZ1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_HCTSIZ1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_HCTSIZ1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_HCTSIZ1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FS_HCTSIZ1` writer"]
pub struct W(crate::W<FS_HCTSIZ1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FS_HCTSIZ1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FS_HCTSIZ1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FS_HCTSIZ1_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "OTG_FS host channel-1 transfer size register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [fs_hctsiz1](index.html) module"]
pub struct FS_HCTSIZ1_SPEC;
impl crate::RegisterSpec for FS_HCTSIZ1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [fs_hctsiz1::R](R) reader structure"]
impl crate::Readable for FS_HCTSIZ1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fs_hctsiz1::W](W) writer structure"]
impl crate::Writable for FS_HCTSIZ1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FS_HCTSIZ1 to value 0"]
impl crate::Resettable for FS_HCTSIZ1_SPEC {
    #[inline(always)]
