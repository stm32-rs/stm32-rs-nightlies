...
#[doc = "Reader of field `DBACKENDIE`"]
pub type DBACKENDIE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DBACKENDIE`"]
...
#[doc = "Reader of field `CEATENDIE`"]
pub type CEATENDIE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `CEATENDIE`"]
