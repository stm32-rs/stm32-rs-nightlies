...
impl W {
    ///Bits 0:3 - Endpoint Identifier
    #[inline(always)]
    pub fn ep_id(&mut self) -> EP_ID_W<'_, ISTRrs> {
        EP_ID_W::new(self, 0)
    }
    ///Bit 4 - Direction of transaction
    #[inline(always)]
    pub fn dir(&mut self) -> DIR_W<'_, ISTRrs> {
        DIR_W::new(self, 4)
    }
    ///Bit 8 - Expected start frame
    #[inline(always)]
    ...
    ///Bit 15 - Correct transfer
    #[inline(always)]
    pub fn ctr(&mut self) -> CTR_W<'_, ISTRrs> {
        CTR_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F103.html#USB:ISTR)*/
pub struct ISTRrs;
