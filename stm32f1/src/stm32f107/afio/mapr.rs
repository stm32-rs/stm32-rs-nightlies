...
impl W {
    ...
    ///Bits 13:14 - CAN1 remapping
    #[inline(always)]
    pub fn can1_remap(&mut self) -> CAN1_REMAP_W<'_, MAPRrs> {
    ...
    ///Bit 21 - Ethernet MAC I/O remapping
    #[inline(always)]
    pub fn eth_remap(&mut self) -> ETH_REMAP_W<'_, MAPRrs> {
        ETH_REMAP_W::new(self, 21)
    }
    ///Bit 22 - CAN2 I/O remapping
    #[inline(always)]
    pub fn can2_remap(&mut self) -> CAN2_REMAP_W<'_, MAPRrs> {
        CAN2_REMAP_W::new(self, 22)
    }
    ///Bit 23 - MII or RMII selection
    #[inline(always)]
    pub fn mii_rmii_sel(&mut self) -> MII_RMII_SEL_W<'_, MAPRrs> {
    ...
    ///Bit 28 - SPI3/I2S3 remapping
    #[inline(always)]
    pub fn spi3_remap(&mut self) -> SPI3_REMAP_W<'_, MAPRrs> {
        SPI3_REMAP_W::new(self, 28)
    }
    ///Bit 29 - TIM2 internal trigger 1 remapping
    #[inline(always)]
    pub fn tim2itr1_iremap(&mut self) -> TIM2ITR1_IREMAP_W<'_, MAPRrs> {
        TIM2ITR1_IREMAP_W::new(self, 29)
    }
    ///Bit 30 - Ethernet PTP PPS remapping
    #[inline(always)]
    pub fn ptp_pps_remap(&mut self) -> PTP_PPS_REMAP_W<'_, MAPRrs> {
