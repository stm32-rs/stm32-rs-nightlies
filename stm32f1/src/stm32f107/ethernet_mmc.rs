...
/**MMCCR (rw) register accessor: Ethernet MMC control register (ETH_MMCCR)
...
pub mod mmccr;
/**MMCRIR (rw) register accessor: Ethernet MMC receive interrupt register (ETH_MMCRIR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F107.html#Ethernet_MMC:MMCRIR)
...
pub mod mmcrir;
/**MMCTIR (rw) register accessor: Ethernet MMC transmit interrupt register (ETH_MMCTIR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F107.html#Ethernet_MMC:MMCTIR)
...
pub mod mmctir;
/**MMCRIMR (rw) register accessor: Ethernet MMC receive interrupt mask register (ETH_MMCRIMR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F107.html#Ethernet_MMC:MMCRIMR)
...
pub mod mmcrimr;
/**MMCTIMR (rw) register accessor: Ethernet MMC transmit interrupt mask register (ETH_MMCTIMR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F107.html#Ethernet_MMC:MMCTGFMSCCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F107.html#Ethernet_MMC:MMCRFCECR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F107.html#Ethernet_MMC:MMCRFAECR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F107.html#Ethernet_MMC:MMCRGUFCR)
