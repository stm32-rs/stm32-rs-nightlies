...
///Field `TR(0-19)` reader - Falling trigger event configuration of line %s
...
///Field `TR(0-19)` writer - Falling trigger event configuration of line %s
...
impl R {
    ///Falling trigger event configuration of line (0-19)
    ///
    ...
    pub fn tr_iter(&self) -> impl Iterator<Item = TR_R> + '_ {
        (0..20).map(move |n| TR_R::new(((self.bits >> n) & 1) != 0))
    }
