...
///Field `TR(0-19)` reader - Rising trigger event configuration of line %s
...
///Field `TR(0-19)` writer - Rising trigger event configuration of line %s
...
impl R {
    ///Rising trigger event configuration of line (0-19)
    ///
