...
pub type R = crate::R<u32, super::SR4>;
#[doc = "Writer for register SR4"]
pub type W = crate::W<u32, super::SR4>;
#[doc = "Register SR4 `reset()`'s with value 0x40"]
impl crate::ResetValue for super::SR4 {
    type Type = u32;
    #[inline(always)]
