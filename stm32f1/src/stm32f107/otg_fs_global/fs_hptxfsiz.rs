#[doc = "Reader of register FS_HPTXFSIZ"]
pub type R = crate::R<u32, super::FS_HPTXFSIZ>;
#[doc = "Writer for register FS_HPTXFSIZ"]
pub type W = crate::W<u32, super::FS_HPTXFSIZ>;
#[doc = "Register FS_HPTXFSIZ `reset()`'s with value 0x0200_0600"]
impl crate::ResetValue for super::FS_HPTXFSIZ {
    type Type = u32;
    #[inline(always)]
