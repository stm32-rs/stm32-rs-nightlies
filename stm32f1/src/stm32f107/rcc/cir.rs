...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pll2rdyie(&mut self) -> PLL2RDYIE_W<CIRrs> {
        PLL2RDYIE_W::new(self, 13)
    }
    #[doc = "Bit 14 - PLL3 Ready Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pll3rdyie(&mut self) -> PLL3RDYIE_W<CIRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pll2rdyc(&mut self) -> PLL2RDYC_W<CIRrs> {
        PLL2RDYC_W::new(self, 21)
    }
    #[doc = "Bit 22 - PLL3 Ready Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn pll3rdyc(&mut self) -> PLL3RDYC_W<CIRrs> {
