...
impl W {
    ...
    ///Bit 13 - PLL2 Ready Interrupt Enable
    #[inline(always)]
    pub fn pll2rdyie(&mut self) -> PLL2RDYIE_W<'_, CIRrs> {
        PLL2RDYIE_W::new(self, 13)
    }
    ///Bit 14 - PLL3 Ready Interrupt Enable
    #[inline(always)]
    pub fn pll3rdyie(&mut self) -> PLL3RDYIE_W<'_, CIRrs> {
        PLL3RDYIE_W::new(self, 14)
    }
    ...
    #[inline(always)]
    pub fn pll2rdyc(&mut self) -> PLL2RDYC_W<'_, CIRrs> {
        PLL2RDYC_W::new(self, 21)
    }
    ///Bit 22 - PLL3 Ready Interrupt Clear
    #[inline(always)]
    pub fn pll3rdyc(&mut self) -> PLL3RDYC_W<'_, CIRrs> {
        PLL3RDYC_W::new(self, 22)
    }
