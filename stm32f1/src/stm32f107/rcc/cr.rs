...
pub struct PLL2ON_R(crate::FieldReader<bool, bool>);
impl PLL2ON_R {
    pub(crate) fn new(bits: bool) -> Self {
        PLL2ON_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PLL2ON_R {
...
pub struct PLL3ON_R(crate::FieldReader<bool, bool>);
impl PLL3ON_R {
    pub(crate) fn new(bits: bool) -> Self {
        PLL3ON_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PLL3ON_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
