#[doc = "Reader of register FS_HCTSIZ0"]
pub type R = crate::R<u32, super::FS_HCTSIZ0>;
#[doc = "Writer for register FS_HCTSIZ0"]
pub type W = crate::W<u32, super::FS_HCTSIZ0>;
#[doc = "Register FS_HCTSIZ0 `reset()`'s with value 0"]
impl crate::ResetValue for super::FS_HCTSIZ0 {
    type Type = u32;
    #[inline(always)]
