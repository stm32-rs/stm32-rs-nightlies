...
///Field `RFAEC` reader - Received frames alignment error counter
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#Ethernet_MMC:MMCRFAECR)*/
