#[doc = "Reader of register FS_HCCHAR5"]
pub type R = crate::R<u32, super::FS_HCCHAR5>;
#[doc = "Writer for register FS_HCCHAR5"]
pub type W = crate::W<u32, super::FS_HCCHAR5>;
#[doc = "Register FS_HCCHAR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::FS_HCCHAR5 {
    type Type = u32;
    #[inline(always)]
