#[doc = "Reader of register FS_HCINT2"]
pub type R = crate::R<u32, super::FS_HCINT2>;
#[doc = "Writer for register FS_HCINT2"]
pub type W = crate::W<u32, super::FS_HCINT2>;
#[doc = "Register FS_HCINT2 `reset()`'s with value 0"]
impl crate::ResetValue for super::FS_HCINT2 {
    type Type = u32;
    #[inline(always)]
