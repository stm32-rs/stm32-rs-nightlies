#[doc = "Reader of register FS_HCINT6"]
pub type R = crate::R<u32, super::FS_HCINT6>;
#[doc = "Writer for register FS_HCINT6"]
pub type W = crate::W<u32, super::FS_HCINT6>;
#[doc = "Register FS_HCINT6 `reset()`'s with value 0"]
impl crate::ResetValue for super::FS_HCINT6 {
    type Type = u32;
    #[inline(always)]
