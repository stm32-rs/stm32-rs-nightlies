#[doc = "Reader of register FS_HPTXSTS"]
pub type R = crate::R<u32, super::FS_HPTXSTS>;
#[doc = "Writer for register FS_HPTXSTS"]
pub type W = crate::W<u32, super::FS_HPTXSTS>;
#[doc = "Register FS_HPTXSTS `reset()`'s with value 0x0008_0100"]
impl crate::ResetValue for super::FS_HPTXSTS {
    type Type = u32;
    #[inline(always)]
