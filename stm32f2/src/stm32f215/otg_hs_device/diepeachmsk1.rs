...
impl W {
    ...
    ///Bit 5 - IN token received with EP mismatch mask
    #[inline(always)]
    pub fn inepnmm(&mut self) -> INEPNMM_W<'_, DIEPEACHMSK1rs> {
    ...
    ///Bit 9 - BNA interrupt mask
    #[inline(always)]
    pub fn bim(&mut self) -> BIM_W<'_, DIEPEACHMSK1rs> {
        BIM_W::new(self, 9)
    }
    ///Bit 13 - NAK interrupt mask
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#OTG_HS_DEVICE:DIEPEACHMSK1)*/
