#[doc = "Reader of register OTG_HS_GNPTXFSIZ_Host"]
pub type R = crate::R<u32, super::OTG_HS_GNPTXFSIZ_HOST>;
#[doc = "Writer for register OTG_HS_GNPTXFSIZ_Host"]
pub type W = crate::W<u32, super::OTG_HS_GNPTXFSIZ_HOST>;
#[doc = "Register OTG_HS_GNPTXFSIZ_Host `reset()`'s with value 0x0200"]
impl crate::ResetValue for super::OTG_HS_GNPTXFSIZ_HOST {
    type Type = u32;
    #[inline(always)]
