...
impl From<TIFRFE_A> for bool {
    #[inline(always)]
    fn from(variant: TIFRFE_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `TIFRFE`"]
pub type TIFRFE_R = crate::R<bool, TIFRFE_A>;
impl TIFRFE_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> TIFRFE_A {
        match self.bits {
            false => TIFRFE_A::NOERROR,
            true => TIFRFE_A::ERROR,
        }
    }
