...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn tim2_or(&self) -> &TIM2_OR {
        &self.tim2_or
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:EGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:CCMR1_Output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:CCMR1_Input)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:CCMR2_Output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:CCMR2_Input)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:CNT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:CCR[1])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:DMAR)

For information about available fields see [`mod@dmar`] module*/
pub type DMAR = crate::Reg<dmar::DMARrs>;
///DMA address for full transfer
pub mod dmar;
/**TIM2_OR (rw) register accessor: TIM2 option register

You can [`read`](crate::Reg::read) this register and get [`tim2_or::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim2_or::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM2:TIM2_OR)

For information about available fields see [`mod@tim2_or`] module*/
pub type TIM2_OR = crate::Reg<tim2_or::TIM2_ORrs>;
