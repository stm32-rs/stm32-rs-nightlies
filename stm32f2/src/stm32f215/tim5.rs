...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn tim5_or(&self) -> &TIM5_OR {
        &self.tim5_or
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:EGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:CCMR1_Output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:CCMR1_Input)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:CCMR2_Output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:CCMR2_Input)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:CNT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:CCR[1])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:DMAR)

For information about available fields see [`mod@dmar`] module*/
pub type DMAR = crate::Reg<dmar::DMARrs>;
///DMA address for full transfer
pub mod dmar;
/**TIM5_OR (rw) register accessor: TIM5 option register

You can [`read`](crate::Reg::read) this register and get [`tim5_or::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim5_or::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F215.html#TIM5:TIM5_OR)

For information about available fields see [`mod@tim5_or`] module*/
pub type TIM5_OR = crate::Reg<tim5_or::TIM5_ORrs>;
