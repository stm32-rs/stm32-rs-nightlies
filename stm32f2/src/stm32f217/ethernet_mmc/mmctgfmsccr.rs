...
///Field `TGFMSCC` reader - Transmitted good frames more single collision counter
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#Ethernet_MMC:MMCTGFMSCCR)*/
