...
impl RegisterBlock {
    ...
    ///0x44 - OTG_HS device each in endpoint-1 interrupt register
    #[inline(always)]
    pub const fn diepeachmsk1(&self) -> &DIEPEACHMSK1 {
        &self.diepeachmsk1
    }
    ///0x84 - OTG_HS device each OUT endpoint-1 interrupt register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DCFG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DCTL)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DSTS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DIEPMSK)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DOEPMSK)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DAINT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DAINTMSK)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DVBUSDIS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DVBUSPULSE)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DTHRCTL)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DIEPEMPMSK)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DEACHINT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DEACHINTMSK)
...
pub mod deachintmsk;
/**DIEPEACHMSK1 (rw) register accessor: OTG_HS device each in endpoint-1 interrupt register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DIEPEACHMSK1)
...
/**DOEPEACHMSK1 (rw) register accessor: OTG_HS device each OUT endpoint-1 interrupt register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#OTG_HS_DEVICE:DOEPEACHMSK1)
