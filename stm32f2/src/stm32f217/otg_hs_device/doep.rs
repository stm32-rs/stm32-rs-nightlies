...
impl DOEP {
    ...
    ///0x10 - OTG_HS device endpoint-2 transfer size register
    #[inline(always)]
...
pub mod ctl;
/**INT (rw) register accessor: OTG_HS device endpoint-1 interrupt register
...
pub mod int;
/**DMA (rw) register accessor: OTG_HS device endpoint-1 DMA address register
...
pub mod dma;
/**TSIZ (rw) register accessor: OTG_HS device endpoint-2 transfer size register
