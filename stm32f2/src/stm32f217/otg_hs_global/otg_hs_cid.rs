#[doc = "Reader of register OTG_HS_CID"]
pub type R = crate::R<u32, super::OTG_HS_CID>;
#[doc = "Writer for register OTG_HS_CID"]
pub type W = crate::W<u32, super::OTG_HS_CID>;
#[doc = "Register OTG_HS_CID `reset()`'s with value 0x1200"]
impl crate::ResetValue for super::OTG_HS_CID {
    type Type = u32;
    #[inline(always)]
