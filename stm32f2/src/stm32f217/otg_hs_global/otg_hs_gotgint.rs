#[doc = "Reader of register OTG_HS_GOTGINT"]
pub type R = crate::R<u32, super::OTG_HS_GOTGINT>;
#[doc = "Writer for register OTG_HS_GOTGINT"]
pub type W = crate::W<u32, super::OTG_HS_GOTGINT>;
#[doc = "Register OTG_HS_GOTGINT `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HS_GOTGINT {
    type Type = u32;
    #[inline(always)]
