#[doc = "Reader of register OTG_HS_GRSTCTL"]
pub type R = crate::R<u32, super::OTG_HS_GRSTCTL>;
#[doc = "Writer for register OTG_HS_GRSTCTL"]
pub type W = crate::W<u32, super::OTG_HS_GRSTCTL>;
#[doc = "Register OTG_HS_GRSTCTL `reset()`'s with value 0x2000_0000"]
impl crate::ResetValue for super::OTG_HS_GRSTCTL {
    type Type = u32;
    #[inline(always)]
