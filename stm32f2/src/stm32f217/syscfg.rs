...
You can [`read`](crate::Reg::read) this register and get [`memrm::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`memrm::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#SYSCFG:MEMRM)

For information about available fields see [`mod@memrm`] module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#SYSCFG:PMC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#SYSCFG:EXTICR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#SYSCFG:EXTICR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#SYSCFG:EXTICR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#SYSCFG:EXTICR4)

For information about available fields see [`mod@exticr4`] module*/
pub type EXTICR4 = crate::Reg<exticr4::EXTICR4rs>;
///external interrupt configuration register 4
pub mod exticr4;
/**CMPCR (rw) register accessor: Compensation cell control register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F217.html#SYSCFG:CMPCR)
