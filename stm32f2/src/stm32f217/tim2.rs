...
#[doc = "DMA address for full transfer"]
pub mod dmar;
#[doc = "TIM2 option register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim2_or](tim2_or) module"]
pub type TIM2_OR = crate::Reg<u32, _TIM2_OR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _TIM2_OR;
#[doc = "`read()` method returns [tim2_or::R](tim2_or::R) reader structure"]
impl crate::Readable for TIM2_OR {}
#[doc = "`write(|w| ..)` method takes [tim2_or::W](tim2_or::W) writer structure"]
impl crate::Writable for TIM2_OR {}
#[doc = "TIM2 option register"]
pub mod tim2_or;
