#[doc = "Reader of register TIM2_OR"]
pub type R = crate::R<u32, super::TIM2_OR>;
#[doc = "Writer for register TIM2_OR"]
pub type W = crate::W<u32, super::TIM2_OR>;
#[doc = "Register TIM2_OR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM2_OR {
    type Type = u32;
    #[inline(always)]
