...
#[doc = "DMA address for full transfer"]
pub mod dmar;
#[doc = "TIM5 option register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim5_or](tim5_or) module"]
pub type TIM5_OR = crate::Reg<u32, _TIM5_OR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _TIM5_OR;
#[doc = "`read()` method returns [tim5_or::R](tim5_or::R) reader structure"]
impl crate::Readable for TIM5_OR {}
#[doc = "`write(|w| ..)` method takes [tim5_or::W](tim5_or::W) writer structure"]
impl crate::Writable for TIM5_OR {}
#[doc = "TIM5 option register"]
pub mod tim5_or;
