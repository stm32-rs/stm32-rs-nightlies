#[doc = "Reader of register TIM5_OR"]
pub type R = crate::R<u32, super::TIM5_OR>;
#[doc = "Writer for register TIM5_OR"]
pub type W = crate::W<u32, super::TIM5_OR>;
#[doc = "Register TIM5_OR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM5_OR {
    type Type = u32;
    #[inline(always)]
