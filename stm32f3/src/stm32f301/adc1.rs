...
impl RegisterBlock {
    ...
    ///0x60..0x70 - ADC offset register%s
    ///
    ...
    ///0x80..0x90 - ADC offset register%s
    ///
...
pub mod jsqr;
/**OFR (rw) register accessor: ADC offset register%s
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F301.html#ADC1:OFR[1])

For information about available fields see [`mod@ofr`] module*/
pub type OFR = crate::Reg<ofr::OFRrs>;
///ADC offset register%s
pub mod ofr;
/**JDR (r) register accessor: ADC offset register%s

You can [`read`](crate::Reg::read) this register and get [`jdr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F301.html#ADC1:JDR[1])
