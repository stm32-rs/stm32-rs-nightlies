...
#[doc = "Reader of field `JADST`"]
pub type JADST_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `JADST`"]
...
impl ADSTP_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, ADSTP_A> {
        use crate::Variant::*;
        match self.bits {
            true => Val(ADSTP_A::STOP),
            i => Res(i),
        }
    }
