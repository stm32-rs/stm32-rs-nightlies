...
pub struct ADVREGEN_R(crate::FieldReader<u8, ADVREGEN_A>);
impl ADVREGEN_R {
...
impl core::ops::Deref for ADVREGEN_R {
    type Target = crate::FieldReader<u8, ADVREGEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[doc = "Field `JADST` reader - ADC stop of injected conversion command"]
pub struct JADST_R(crate::FieldReader<bool, bool>);
impl JADST_R {
    pub(crate) fn new(bits: bool) -> Self {
        JADST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for JADST_R {
...
#[doc = "Field `JADST` writer - ADC stop of injected conversion command"]
pub struct JADST_W<'a> {
    w: &'a mut W,
}
impl<'a> JADST_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn jadst(&self) -> JADST_R {
        JADST_R::new(((self.bits >> 5) & 0x01) != 0)
    }
