...
///Field `OFFSET` reader - Data offset 1 for the channel programmed into bits OFFSET1_CH
pub type OFFSET_R = crate::FieldReader<u16>;
///Field `OFFSET` writer - Data offset 1 for the channel programmed into bits OFFSET1_CH
pub type OFFSET_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16, crate::Safe>;
///Field `OFFSET_CH` reader - Channel selection for the Data offset 1
pub type OFFSET_CH_R = crate::FieldReader;
///Field `OFFSET_CH` writer - Channel selection for the Data offset 1
