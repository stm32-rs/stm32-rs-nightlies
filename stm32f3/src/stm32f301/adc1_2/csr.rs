...
#[doc = "Slave ADC ready"]
pub type ADRDY_SLV_A = ADRDY_MST_A;
#[doc = "Field `ADRDY_SLV` reader - Slave ADC ready"]
pub type ADRDY_SLV_R = ADRDY_MST_R;
...
pub struct ADRDY_MST_R(crate::FieldReader<bool, ADRDY_MST_A>);
impl ADRDY_MST_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for ADRDY_MST_R {
    type Target = crate::FieldReader<bool, ADRDY_MST_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
