...
pub struct COMP2_INP_DAC_R(crate::FieldReader<bool, bool>);
impl COMP2_INP_DAC_R {
    pub(crate) fn new(bits: bool) -> Self {
        COMP2_INP_DAC_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COMP2_INP_DAC_R {
...
pub struct COMP2_INP_DAC_W<'a> {
    w: &'a mut W,
}
impl<'a> COMP2_INP_DAC_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn comp2_inp_dac(&self) -> COMP2_INP_DAC_R {
        COMP2_INP_DAC_R::new(((self.bits >> 1) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Comparator 2 enable"]
    ...
    #[doc = "Bit 1 - Comparator 2 non inverting input connection to DAC output"]
    #[inline(always)]
    pub fn comp2_inp_dac(&mut self) -> COMP2_INP_DAC_W {
        COMP2_INP_DAC_W { w: self }
    }
