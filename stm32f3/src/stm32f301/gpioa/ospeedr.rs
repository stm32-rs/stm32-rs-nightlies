...
pub type OSPEEDR_R = crate::FieldReader<OUTPUT_SPEED>;
impl OSPEEDR_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Option<OUTPUT_SPEED> {
        match self.bits {
            0 => Some(OUTPUT_SPEED::LowSpeed),
            1 => Some(OUTPUT_SPEED::MediumSpeed),
            3 => Some(OUTPUT_SPEED::HighSpeed),
            _ => None,
        }
    }
    ///Low speed
...
pub type OSPEEDR_W<'a, REG> = crate::FieldWriter<'a, REG, 2, OUTPUT_SPEED>;
