...
pub use crate::stm32f301::gpioa::pupdr::PULL;
///Field `PUPDR(0-15)` reader - Port x configuration pin %s
pub use crate::stm32f301::gpioa::pupdr::PUPDR_R;
///Field `PUPDR(0-15)` writer - Port x configuration pin %s
pub use crate::stm32f301::gpioa::pupdr::PUPDR_W;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F301.html#GPIOC:PUPDR)*/
pub struct PUPDRrs;
...
///`reset()` method sets PUPDR to value 0x0c00_0000
