...
impl ENCODER_MODE_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Option<ENCODER_MODE> {
        match self.bits {
            0 => Some(ENCODER_MODE::NoRedirection),
            1 => Some(ENCODER_MODE::MapTim2tim15),
            _ => None,
        }
    }
    ///No redirection
...
pub type ENCODER_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2, ENCODER_MODE>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F301.html#SYSCFG:CFGR1)*/
pub struct CFGR1rs;
