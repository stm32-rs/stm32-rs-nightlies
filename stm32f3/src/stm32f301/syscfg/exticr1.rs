...
impl From<EXTI_ABCF> for u8 {
    #[inline(always)]
    fn from(variant: EXTI_ABCF) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for EXTI_ABCF {
    type Ux = u8;
}
impl crate::IsEnum for EXTI_ABCF {}
///Field `EXTI0` reader - EXTI 0 configuration bits
pub type EXTI0_R = crate::FieldReader<EXTI_ABCF>;
impl EXTI0_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Option<EXTI_ABCF> {
        match self.bits {
            0 => Some(EXTI_ABCF::Pa),
            1 => Some(EXTI_ABCF::Pb),
            2 => Some(EXTI_ABCF::Pc),
...
pub type EXTI0_W<'a, REG> = crate::FieldWriter<'a, REG, 4, EXTI_ABCF>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn pa(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCF::Pa)
    }
    ///Select PBx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pb(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCF::Pb)
    }
    ///Select PCx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pc(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCF::Pc)
    }
    ///Select PFx as the source input for the EXTIX external interrupt
    #[inline(always)]
    pub fn pf(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCF::Pf)
    }
}
...
pub type EXTI3_R = crate::FieldReader<EXTI_ABC>;
impl EXTI3_R {
    ///Get enumerated values variant
    #[inline(always)]
...
pub type EXTI3_W<'a, REG> = crate::FieldWriter<'a, REG, 4, EXTI_ABC>;
