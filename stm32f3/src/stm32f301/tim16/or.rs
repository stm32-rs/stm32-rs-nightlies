...
///Field `TI1_RMP` reader - Timer 16 input 1 connection
pub type TI1_RMP_R = crate::FieldReader;
///Field `TI1_RMP` writer - Timer 16 input 1 connection
pub type TI1_RMP_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - Timer 16 input 1 connection
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F301.html#TIM16:OR)*/
pub struct ORrs;
