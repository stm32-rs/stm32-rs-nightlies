...
impl W {
    ...
    ///Bit 24 - G7_IO1 Schmitt trigger hysteresis mode
    #[inline(always)]
    pub fn g7_io1(&mut self) -> G_IO1_W<IOHCRrs> {
        G_IO1_W::new(self, 24)
    }
    ///Bit 28 - G8_IO1 Schmitt trigger hysteresis mode
    #[inline(always)]
    pub fn g8_io1(&mut self) -> G_IO1_W<IOHCRrs> {
        G_IO1_W::new(self, 28)
    }
    ///G(1-8)_IO2 Schmitt trigger hysteresis mode
    ///
    ...
    ///Bit 25 - G7_IO2 Schmitt trigger hysteresis mode
    #[inline(always)]
    pub fn g7_io2(&mut self) -> G_IO2_W<IOHCRrs> {
        G_IO2_W::new(self, 25)
    }
    ///Bit 29 - G8_IO2 Schmitt trigger hysteresis mode
    #[inline(always)]
    pub fn g8_io2(&mut self) -> G_IO2_W<IOHCRrs> {
        G_IO2_W::new(self, 29)
    }
    ///G(1-8)_IO3 Schmitt trigger hysteresis mode
    ///
    ...
    ///Bit 26 - G7_IO3 Schmitt trigger hysteresis mode
    #[inline(always)]
    pub fn g7_io3(&mut self) -> G_IO3_W<IOHCRrs> {
        G_IO3_W::new(self, 26)
    }
    ///Bit 30 - G8_IO3 Schmitt trigger hysteresis mode
    #[inline(always)]
    pub fn g8_io3(&mut self) -> G_IO3_W<IOHCRrs> {
        G_IO3_W::new(self, 30)
    }
    ///G(1-8)_IO4 Schmitt trigger hysteresis mode
    ///
    ...
    ///Bit 27 - G7_IO4 Schmitt trigger hysteresis mode
    #[inline(always)]
    pub fn g7_io4(&mut self) -> G_IO4_W<IOHCRrs> {
        G_IO4_W::new(self, 27)
    }
    ///Bit 31 - G8_IO4 Schmitt trigger hysteresis mode
    #[inline(always)]
    pub fn g8_io4(&mut self) -> G_IO4_W<IOHCRrs> {
        G_IO4_W::new(self, 31)
    }
}
