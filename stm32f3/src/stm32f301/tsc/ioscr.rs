...
impl W {
    ...
    ///Bit 28 - G8_IO1 sampling mode
    #[inline(always)]
    pub fn g8_io1(&mut self) -> G_IO1_W<'_, IOSCRrs> {
        G_IO1_W::new(self, 28)
    }
    ///G(1-8)_IO2 sampling mode
    ///
    ...
    ///Bit 29 - G8_IO2 sampling mode
    #[inline(always)]
    pub fn g8_io2(&mut self) -> G_IO2_W<'_, IOSCRrs> {
        G_IO2_W::new(self, 29)
    }
    ///G(1-8)_IO3 sampling mode
    ///
    ...
    ///Bit 30 - G8_IO3 sampling mode
    #[inline(always)]
    pub fn g8_io3(&mut self) -> G_IO3_W<'_, IOSCRrs> {
        G_IO3_W::new(self, 30)
    }
    ///G(1-8)_IO4 sampling mode
    ///
    ...
    ///Bit 31 - G8_IO4 sampling mode
    #[inline(always)]
    pub fn g8_io4(&mut self) -> G_IO4_W<'_, IOSCRrs> {
        G_IO4_W::new(self, 31)
    }
}
