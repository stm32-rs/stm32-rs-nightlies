...
///Field `G_IO1(1-8)` reader - G%s_IO1 sampling mode
...
///Field `G_IO1(1-8)` writer - G%s_IO1 sampling mode
...
///Field `G_IO2(1-8)` reader - G%s_IO2 sampling mode
pub use G_IO1_R as G_IO2_R;
///Field `G_IO3(1-8)` reader - G%s_IO3 sampling mode
pub use G_IO1_R as G_IO3_R;
///Field `G_IO4(1-8)` reader - G%s_IO4 sampling mode
pub use G_IO1_R as G_IO4_R;
///Field `G_IO2(1-8)` writer - G%s_IO2 sampling mode
pub use G_IO1_W as G_IO2_W;
///Field `G_IO3(1-8)` writer - G%s_IO3 sampling mode
pub use G_IO1_W as G_IO3_W;
///Field `G_IO4(1-8)` writer - G%s_IO4 sampling mode
...
impl W {
    ...
    ///Bit 24 - G7_IO1 sampling mode
    #[inline(always)]
    pub fn g7_io1(&mut self) -> G_IO1_W<IOSCRrs> {
        G_IO1_W::new(self, 24)
    }
    ///Bit 28 - G8_IO1 sampling mode
    #[inline(always)]
    pub fn g8_io1(&mut self) -> G_IO1_W<IOSCRrs> {
        G_IO1_W::new(self, 28)
    }
    ///G(1-8)_IO2 sampling mode
    ///
    ...
    ///Bit 25 - G7_IO2 sampling mode
    #[inline(always)]
    pub fn g7_io2(&mut self) -> G_IO2_W<IOSCRrs> {
        G_IO2_W::new(self, 25)
    }
    ///Bit 29 - G8_IO2 sampling mode
    #[inline(always)]
    pub fn g8_io2(&mut self) -> G_IO2_W<IOSCRrs> {
        G_IO2_W::new(self, 29)
    }
    ///G(1-8)_IO3 sampling mode
    ///
    ...
    ///Bit 26 - G7_IO3 sampling mode
    #[inline(always)]
    pub fn g7_io3(&mut self) -> G_IO3_W<IOSCRrs> {
        G_IO3_W::new(self, 26)
    }
    ///Bit 30 - G8_IO3 sampling mode
    #[inline(always)]
    pub fn g8_io3(&mut self) -> G_IO3_W<IOSCRrs> {
        G_IO3_W::new(self, 30)
    }
    ///G(1-8)_IO4 sampling mode
    ///
    ...
    ///Bit 27 - G7_IO4 sampling mode
    #[inline(always)]
    pub fn g7_io4(&mut self) -> G_IO4_W<IOSCRrs> {
        G_IO4_W::new(self, 27)
    }
    ///Bit 31 - G8_IO4 sampling mode
    #[inline(always)]
    pub fn g8_io4(&mut self) -> G_IO4_W<IOSCRrs> {
        G_IO4_W::new(self, 31)
    }
}
