...
pub type COMP2INPSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type COMP2WINMODE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMP2_CSR")
            ...
            .field("comp2winmode", &self.comp2winmode())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp2_inp_dac(&mut self) -> COMP2_INP_DAC_W<COMP2_CSRrs> {
        COMP2_INP_DAC_W::new(self, 1)
    }
    ///Bits 2:3 - Comparator 2 mode
    #[inline(always)]
    #[must_use]
    pub fn comp2mode(&mut self) -> COMP2MODE_W<COMP2_CSRrs> {
        COMP2MODE_W::new(self, 2)
    }
    ///Bits 4:6 - Comparator 2 inverting input selection
    #[inline(always)]
    #[must_use]
    ...
    pub fn comp2inpsel(&mut self) -> COMP2INPSEL_W<COMP2_CSRrs> {
        COMP2INPSEL_W::new(self, 7)
    }
    ///Bit 9 - Comparator 2 window mode
    #[inline(always)]
    #[must_use]
    pub fn comp2winmode(&mut self) -> COMP2WINMODE_W<COMP2_CSRrs> {
        COMP2WINMODE_W::new(self, 9)
    }
    ///Bits 10:13 - Comparator 2 output selection
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp2hyst(&mut self) -> COMP2HYST_W<COMP2_CSRrs> {
        COMP2HYST_W::new(self, 16)
    }
    ///Bits 18:20 - Comparator 2 blanking source
    #[inline(always)]
    #[must_use]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F302.html#COMP:COMP2_CSR)*/
