...
pub enum TSEL1 {
    ...
    Tim2trgo = 4,
    ///5: Timer 4 TRGO event (STM32F302x6/8 only)
    Tim4trgo = 5,
    ///6: EXTI line 9
    Exti9 = 6,
    ///7: Software trigger
...
impl TSEL1_R {
    ...
    ///Timer 3 TRGO event depending on the value of DAC_TRIG_RMP bit in SYSCFG_CFGR1 register (STM32F302x6/8 only)
    #[inline(always)]
    ...
    ///Timer 4 TRGO event (STM32F302x6/8 only)
    #[inline(always)]
