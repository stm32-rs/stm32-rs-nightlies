...
impl W {
    ///Bit 0 - Pending bit 0
    #[inline(always)]
    pub fn pr0(&mut self) -> PR0_W<PR1rs> {
        PR0_W::new(self, 0)
    }
    ///Bit 1 - Pending bit 1
    #[inline(always)]
    pub fn pr1(&mut self) -> PR1_W<PR1rs> {
        PR1_W::new(self, 1)
    }
    ///Bit 2 - Pending bit 2
    #[inline(always)]
    pub fn pr2(&mut self) -> PR2_W<PR1rs> {
        PR2_W::new(self, 2)
    }
    ///Bit 3 - Pending bit 3
    #[inline(always)]
    pub fn pr3(&mut self) -> PR3_W<PR1rs> {
        PR3_W::new(self, 3)
    }
    ///Bit 4 - Pending bit 4
    #[inline(always)]
    pub fn pr4(&mut self) -> PR4_W<PR1rs> {
        PR4_W::new(self, 4)
    }
    ///Bit 5 - Pending bit 5
    #[inline(always)]
    pub fn pr5(&mut self) -> PR5_W<PR1rs> {
        PR5_W::new(self, 5)
    }
    ///Bit 6 - Pending bit 6
    #[inline(always)]
    pub fn pr6(&mut self) -> PR6_W<PR1rs> {
        PR6_W::new(self, 6)
    }
    ///Bit 7 - Pending bit 7
    #[inline(always)]
    pub fn pr7(&mut self) -> PR7_W<PR1rs> {
        PR7_W::new(self, 7)
    }
    ///Bit 8 - Pending bit 8
    #[inline(always)]
    pub fn pr8(&mut self) -> PR8_W<PR1rs> {
        PR8_W::new(self, 8)
    }
    ///Bit 9 - Pending bit 9
    #[inline(always)]
    pub fn pr9(&mut self) -> PR9_W<PR1rs> {
        PR9_W::new(self, 9)
    }
    ///Bit 10 - Pending bit 10
    #[inline(always)]
    pub fn pr10(&mut self) -> PR10_W<PR1rs> {
        PR10_W::new(self, 10)
    }
    ///Bit 11 - Pending bit 11
    #[inline(always)]
    pub fn pr11(&mut self) -> PR11_W<PR1rs> {
        PR11_W::new(self, 11)
    }
    ///Bit 12 - Pending bit 12
    #[inline(always)]
    pub fn pr12(&mut self) -> PR12_W<PR1rs> {
        PR12_W::new(self, 12)
    }
    ///Bit 13 - Pending bit 13
    #[inline(always)]
    pub fn pr13(&mut self) -> PR13_W<PR1rs> {
        PR13_W::new(self, 13)
    }
    ///Bit 14 - Pending bit 14
    #[inline(always)]
    pub fn pr14(&mut self) -> PR14_W<PR1rs> {
        PR14_W::new(self, 14)
    }
    ///Bit 15 - Pending bit 15
    #[inline(always)]
    pub fn pr15(&mut self) -> PR15_W<PR1rs> {
        PR15_W::new(self, 15)
    }
    ///Bit 16 - Pending bit 16
    #[inline(always)]
    pub fn pr16(&mut self) -> PR16_W<PR1rs> {
        PR16_W::new(self, 16)
    }
    ///Bit 17 - Pending bit 17
    #[inline(always)]
    pub fn pr17(&mut self) -> PR17_W<PR1rs> {
        PR17_W::new(self, 17)
    }
    ///Bit 18 - Pending bit 18
    #[inline(always)]
    pub fn pr18(&mut self) -> PR18_W<PR1rs> {
        PR18_W::new(self, 18)
    }
    ///Bit 19 - Pending bit 19
    #[inline(always)]
    pub fn pr19(&mut self) -> PR19_W<PR1rs> {
        PR19_W::new(self, 19)
    }
    ///Bit 20 - Pending bit 20
    #[inline(always)]
    pub fn pr20(&mut self) -> PR20_W<PR1rs> {
        PR20_W::new(self, 20)
    }
    ///Bit 21 - Pending bit 21
    #[inline(always)]
    pub fn pr21(&mut self) -> PR21_W<PR1rs> {
        PR21_W::new(self, 21)
    }
    ///Bit 22 - Pending bit 22
    #[inline(always)]
    pub fn pr22(&mut self) -> PR22_W<PR1rs> {
        PR22_W::new(self, 22)
    }
    ///Bit 29 - Pending bit 29
    #[inline(always)]
    pub fn pr29(&mut self) -> PR29_W<PR1rs> {
        PR29_W::new(self, 29)
    }
    ///Bit 30 - Pending bit 30
    #[inline(always)]
    pub fn pr30(&mut self) -> PR30_W<PR1rs> {
        PR30_W::new(self, 30)
    }
    ///Bit 31 - Pending bit 31
    #[inline(always)]
    pub fn pr31(&mut self) -> PR31_W<PR1rs> {
        PR31_W::new(self, 31)
    }
}
/**Pending register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F302.html#EXTI:PR1)*/
pub struct PR1rs;
