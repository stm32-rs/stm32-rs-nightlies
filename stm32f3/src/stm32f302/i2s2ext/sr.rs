...
impl From<TIFRFER> for bool {
    #[inline(always)]
    fn from(variant: TIFRFER) -> Self {
        variant as u8 != 0
    }
}
///Field `TIFRFE` reader - TI frame format error
pub type TIFRFE_R = crate::BitReader<TIFRFER>;
impl TIFRFE_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TIFRFER {
        match self.bits {
            false => TIFRFER::NoError,
            true => TIFRFER::Error,
        }
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F302.html#I2S2ext:SR)*/
pub struct SRrs;
