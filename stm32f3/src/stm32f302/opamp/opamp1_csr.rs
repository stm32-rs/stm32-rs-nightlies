...
#[doc = "Reader of field `OPAMP1EN`"]
pub type OPAMP1EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OPAMP1EN`"]
pub struct OPAMP1EN_W<'a> {
    w: &'a mut W,
}
impl<'a> OPAMP1EN_W<'a> {
...
impl R {
    ...
    pub fn opamp1en(&self) -> OPAMP1EN_R {
        OPAMP1EN_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - FORCE_VP"]
    #[inline(always)]
