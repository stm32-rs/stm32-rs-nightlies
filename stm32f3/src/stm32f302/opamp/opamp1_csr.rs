...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opamp1en(&mut self) -> OPAMP1EN_W<OPAMP1_CSRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcm_en(&mut self) -> TCM_EN_W<OPAMP1_CSRrs> {
        TCM_EN_W::new(self, 7)
    }
    #[doc = "Bit 8 - OPAMP inverting input secondary selection"]
    #[inline(always)]
    #[must_use]
    pub fn vms_sel(&mut self) -> VMS_SEL_W<OPAMP1_CSRrs> {
        VMS_SEL_W::new(self, 8)
    }
    #[doc = "Bits 9:10 - OPAMP Non inverting input secondary selection"]
    #[inline(always)]
    #[must_use]
    pub fn vps_sel(&mut self) -> VPS_SEL_W<OPAMP1_CSRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn user_trim(&mut self) -> USER_TRIM_W<OPAMP1_CSRrs> {
