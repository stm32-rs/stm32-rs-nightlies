...
pub type USB_IT_RMP_R = crate::R<bool, USB_IT_RMP_A>;
impl USB_IT_RMP_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Reader of field `DAC1_TRIG_RMP`"]
pub type DAC1_TRIG_RMP_R = crate::R<bool, DAC1_TRIG_RMP_A>;
...
#[doc = "Write proxy for field `DAC1_TRIG_RMP`"]
...
pub type ADC2_DMA_RMP_R = crate::R<bool, ADC2_DMA_RMP_A>;
impl ADC2_DMA_RMP_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
pub type TIM6_DAC1_DMA_RMP_R = crate::R<bool, TIM6_DAC1_DMA_RMP_A>;
...
impl<'a> TIM6_DAC1_DMA_RMP_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TIM6_DAC1_DMA_RMP_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
