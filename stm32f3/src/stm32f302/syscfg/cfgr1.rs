...
pub enum MEM_MODE {
    ...
    Sram = 3,
    ///4: FMC Bank (Only the first two banks) (Available on STM32F302xD/E only)
    Fmc = 4,
}
...
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TIM6_DAC1_DMA_RMP {
    ///0: TIM6_UP and DAC_CH1 DMA requests mapped on DMA2 channel 3
    NotRemapped = 0,
    ///1: TIM6_UP and DAC_CH1 DMA requests mapped on DMA1 channel 3
    Remapped = 1,
}
impl From<TIM6_DAC1_DMA_RMP> for bool {
    #[inline(always)]
    fn from(variant: TIM6_DAC1_DMA_RMP) -> Self {
        variant as u8 != 0
    }
}
///Field `TIM6_DAC1_DMA_RMP` reader - TIM6 and DAC1 DMA request remapping bit
pub type TIM6_DAC1_DMA_RMP_R = crate::BitReader<TIM6_DAC1_DMA_RMP>;
impl TIM6_DAC1_DMA_RMP_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TIM6_DAC1_DMA_RMP {
        match self.bits {
            false => TIM6_DAC1_DMA_RMP::NotRemapped,
            true => TIM6_DAC1_DMA_RMP::Remapped,
        }
    }
    ///TIM6_UP and DAC_CH1 DMA requests mapped on DMA2 channel 3
    #[inline(always)]
    pub fn is_not_remapped(&self) -> bool {
        *self == TIM6_DAC1_DMA_RMP::NotRemapped
    }
    ///TIM6_UP and DAC_CH1 DMA requests mapped on DMA1 channel 3
    #[inline(always)]
    pub fn is_remapped(&self) -> bool {
        *self == TIM6_DAC1_DMA_RMP::Remapped
    }
}
///Field `TIM6_DAC1_DMA_RMP` writer - TIM6 and DAC1 DMA request remapping bit
pub type TIM6_DAC1_DMA_RMP_W<'a, REG> = crate::BitWriter<'a, REG, TIM6_DAC1_DMA_RMP>;
impl<'a, REG> TIM6_DAC1_DMA_RMP_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///TIM6_UP and DAC_CH1 DMA requests mapped on DMA2 channel 3
    #[inline(always)]
    pub fn not_remapped(self) -> &'a mut crate::W<REG> {
        self.variant(TIM6_DAC1_DMA_RMP::NotRemapped)
    }
    ///TIM6_UP and DAC_CH1 DMA requests mapped on DMA1 channel 3
    #[inline(always)]
    pub fn remapped(self) -> &'a mut crate::W<REG> {
        self.variant(TIM6_DAC1_DMA_RMP::Remapped)
    }
}
...
impl W {
    ...
    ///Bit 5 - USB interrupt remap
    #[inline(always)]
    pub fn usb_it_rmp(&mut self) -> USB_IT_RMP_W<'_, CFGR1rs> {
        USB_IT_RMP_W::new(self, 5)
    }
    ///Bit 6 - Timer 1 ITR3 selection
    #[inline(always)]
    pub fn tim1_itr3_rmp(&mut self) -> TIM1_ITR3_RMP_W<'_, CFGR1rs> {
        TIM1_ITR3_RMP_W::new(self, 6)
    }
    ///Bit 7 - DAC trigger remap (when TSEL = 001)
    #[inline(always)]
    pub fn dac1_trig_rmp(&mut self) -> DAC1_TRIG_RMP_W<'_, CFGR1rs> {
        DAC1_TRIG_RMP_W::new(self, 7)
    }
    ///Bit 8 - ADC24 DMA remapping bit
    #[inline(always)]
    pub fn adc2_dma_rmp(&mut self) -> ADC2_DMA_RMP_W<'_, CFGR1rs> {
    ...
    ///Bit 13 - TIM6 and DAC1 DMA request remapping bit
    #[inline(always)]
    pub fn tim6_dac1_dma_rmp(&mut self) -> TIM6_DAC1_DMA_RMP_W<'_, CFGR1rs> {
        TIM6_DAC1_DMA_RMP_W::new(self, 13)
    }
    ///Bit 16 - Fast Mode Plus (FM+) driving capability activation bits.
    #[inline(always)]
    ...
    ///Bits 22:23 - Encoder mode
    #[inline(always)]
    pub fn encoder_mode(&mut self) -> ENCODER_MODE_W<'_, CFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F302.html#SYSCFG:CFGR1)*/
pub struct CFGR1rs;
