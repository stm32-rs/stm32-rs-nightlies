...
///Field `C5IF` reader - Capture/Compare 5 interrupt flag
pub type C5IF_R = crate::BitReader;
///Field `C5IF` writer - Capture/Compare 5 interrupt flag
pub type C5IF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `C6IF` reader - Capture/Compare 6 interrupt flag
pub type C6IF_R = crate::BitReader;
///Field `C6IF` writer - Capture/Compare 6 interrupt flag
...
impl W {
    ...
    ///Bit 16 - Capture/Compare 5 interrupt flag
    #[inline(always)]
    pub fn c5if(&mut self) -> C5IF_W<'_, SRrs> {
        C5IF_W::new(self, 16)
    }
    ///Bit 17 - Capture/Compare 6 interrupt flag
    #[inline(always)]
    pub fn c6if(&mut self) -> C6IF_W<'_, SRrs> {
        C6IF_W::new(self, 17)
    }
}
/**status register
