...
pub mod rir;
/**RDTR (r) register accessor: receive FIFO mailbox data length control and time stamp register
...
pub mod rdtr;
/**RDLR (r) register accessor: receive FIFO mailbox data low register
