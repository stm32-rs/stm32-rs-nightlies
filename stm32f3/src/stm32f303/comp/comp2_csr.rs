...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMP2_CSR")
            ...
            .field("comp2inmsel3", &self.comp2inmsel3())
            .finish()
    }
}
impl W {
    ...
    ///Bits 2:3 - Comparator 2 mode
    #[inline(always)]
    pub fn comp2mode(&mut self) -> COMP2MODE_W<'_, COMP2_CSRrs> {
    ...
    ///Bit 9 - Comparator 2 window mode
    #[inline(always)]
    pub fn comp2winmode(&mut self) -> COMP2WINMODE_W<'_, COMP2_CSRrs> {
    ...
    ///Bits 16:17 - Comparator 2 hysteresis
    #[inline(always)]
    pub fn comp2hyst(&mut self) -> COMP2HYST_W<'_, COMP2_CSRrs> {
    ...
    ///Bit 22 - Comparator 2 inverting input selection
    #[inline(always)]
    pub fn comp2inmsel3(&mut self) -> COMP2INMSEL3_W<'_, COMP2_CSRrs> {
