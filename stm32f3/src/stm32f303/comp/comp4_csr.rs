...
impl W {
    ///Bit 0 - Comparator 4 enable
    #[inline(always)]
    pub fn comp4en(&mut self) -> COMP4EN_W<'_, COMP4_CSRrs> {
        COMP4EN_W::new(self, 0)
    }
    ///Bits 2:3 - Comparator 4 mode
    #[inline(always)]
    pub fn comp4mode(&mut self) -> COMP4MODE_W<'_, COMP4_CSRrs> {
        COMP4MODE_W::new(self, 2)
    }
    ///Bits 4:6 - Comparator 4 inverting input selection
    #[inline(always)]
    pub fn comp4inmsel(&mut self) -> COMP4INMSEL_W<'_, COMP4_CSRrs> {
        COMP4INMSEL_W::new(self, 4)
    }
    ///Bit 7 - Comparator 4 non inverted input
    #[inline(always)]
    pub fn comp4inpsel(&mut self) -> COMP4INPSEL_W<'_, COMP4_CSRrs> {
        COMP4INPSEL_W::new(self, 7)
    }
    ///Bit 9 - Comparator 4 window mode
    #[inline(always)]
    pub fn comp4winmode(&mut self) -> COMP4WINMODE_W<'_, COMP4_CSRrs> {
        COMP4WINMODE_W::new(self, 9)
    }
    ///Bits 10:13 - Comparator 4 output selection
    #[inline(always)]
    pub fn comp4outsel(&mut self) -> COMP4OUTSEL_W<'_, COMP4_CSRrs> {
        COMP4OUTSEL_W::new(self, 10)
    }
    ///Bit 15 - Comparator 4 output polarity
    #[inline(always)]
    pub fn comp4pol(&mut self) -> COMP4POL_W<'_, COMP4_CSRrs> {
        COMP4POL_W::new(self, 15)
    }
    ///Bits 16:17 - Comparator 4 hysteresis
    #[inline(always)]
    pub fn comp4hyst(&mut self) -> COMP4HYST_W<'_, COMP4_CSRrs> {
        COMP4HYST_W::new(self, 16)
    }
    ///Bits 18:20 - Comparator 4 blanking source
    #[inline(always)]
    pub fn comp4_blanking(&mut self) -> COMP4_BLANKING_W<'_, COMP4_CSRrs> {
        COMP4_BLANKING_W::new(self, 18)
    }
    ///Bit 22 - Comparator 4 inverting input selection
    #[inline(always)]
    pub fn comp4inmsel3(&mut self) -> COMP4INMSEL3_W<'_, COMP4_CSRrs> {
        COMP4INMSEL3_W::new(self, 22)
    }
    ///Bit 31 - Comparator 4 lock
    #[inline(always)]
    pub fn comp4lock(&mut self) -> COMP4LOCK_W<'_, COMP4_CSRrs> {
