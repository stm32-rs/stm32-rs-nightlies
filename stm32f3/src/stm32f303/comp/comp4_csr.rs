...
#[doc = "Reader of field `COMP4WINMODE`"]
pub type COMP4WINMODE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `COMP4WINMODE`"]
pub struct COMP4WINMODE_W<'a> {
    w: &'a mut W,
}
impl<'a> COMP4WINMODE_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn comp4winmode(&self) -> COMP4WINMODE_R {
        COMP4WINMODE_R::new(((self.bits >> 9) & 0x01) != 0)
    }
