...
impl W {
    ...
    ///Bits 2:3 - Comparator 6 mode
    #[inline(always)]
    pub fn comp6mode(&mut self) -> COMP6MODE_W<COMP6_CSRrs> {
    ...
    ///Bit 7 - Comparator 6 non inverted input
    #[inline(always)]
    pub fn comp6inpsel(&mut self) -> COMP6INPSEL_W<COMP6_CSRrs> {
        COMP6INPSEL_W::new(self, 7)
    }
    ///Bit 9 - Comparator 6 window mode
    #[inline(always)]
    pub fn comp6winmode(&mut self) -> COMP6WINMODE_W<COMP6_CSRrs> {
    ...
    ///Bits 16:17 - Comparator 6 hysteresis
    #[inline(always)]
    pub fn comp6hyst(&mut self) -> COMP6HYST_W<COMP6_CSRrs> {
