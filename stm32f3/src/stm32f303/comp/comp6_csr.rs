...
pub type COMP6MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type COMP6INPSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type COMP6WINMODE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type COMP6HYST_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMP6_CSR")
            ...
            .field("comp6winmode", &self.comp6winmode())
            .field("comp6mode", &self.comp6mode())
            .field("comp6inpsel", &self.comp6inpsel())
            .field("comp6hyst", &self.comp6hyst())
...
impl W {
    ...
    ///Bits 2:3 - Comparator 6 mode
    #[inline(always)]
    pub fn comp6mode(&mut self) -> COMP6MODE_W<'_, COMP6_CSRrs> {
        COMP6MODE_W::new(self, 2)
    }
    ///Bits 4:6 - Comparator 6 inverting input selection
    #[inline(always)]
    ...
    ///Bit 7 - Comparator 6 non inverted input
    #[inline(always)]
    pub fn comp6inpsel(&mut self) -> COMP6INPSEL_W<'_, COMP6_CSRrs> {
        COMP6INPSEL_W::new(self, 7)
    }
    ///Bit 9 - Comparator 6 window mode
    #[inline(always)]
    pub fn comp6winmode(&mut self) -> COMP6WINMODE_W<'_, COMP6_CSRrs> {
        COMP6WINMODE_W::new(self, 9)
    }
    ///Bits 10:13 - Comparator 6 output selection
    #[inline(always)]
    ...
    ///Bits 16:17 - Comparator 6 hysteresis
    #[inline(always)]
    pub fn comp6hyst(&mut self) -> COMP6HYST_W<'_, COMP6_CSRrs> {
        COMP6HYST_W::new(self, 16)
    }
    ///Bits 18:20 - Comparator 6 blanking source
    #[inline(always)]
