...
pub type TR29_A = TR0_A;
#[doc = "Reader of field `TR29`"]
pub type TR29_R = crate::R<bool, TR0_A>;
#[doc = "Write proxy for field `TR29`"]
pub struct TR29_W<'a> {
    w: &'a mut W,
}
impl<'a> TR29_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TR29_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
pub type TR30_A = TR0_A;
#[doc = "Reader of field `TR30`"]
pub type TR30_R = crate::R<bool, TR0_A>;
#[doc = "Write proxy for field `TR30`"]
pub struct TR30_W<'a> {
    w: &'a mut W,
}
impl<'a> TR30_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TR30_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
pub type TR31_A = TR0_A;
#[doc = "Reader of field `TR31`"]
pub type TR31_R = crate::R<bool, TR0_A>;
#[doc = "Write proxy for field `TR31`"]
pub struct TR31_W<'a> {
    w: &'a mut W,
}
impl<'a> TR31_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TR31_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
