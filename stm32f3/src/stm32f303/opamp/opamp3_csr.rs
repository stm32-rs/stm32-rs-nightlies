///Register `OPAMP3_CSR` reader
pub type R = crate::R<OPAMP3_CSRrs>;
///Register `OPAMP3_CSR` writer
pub type W = crate::W<OPAMP3_CSRrs>;
///Field `OPAMP3EN` reader - OPAMP3 enable
pub type OPAMP3EN_R = crate::BitReader;
///Field `OPAMP3EN` writer - OPAMP3 enable
pub type OPAMP3EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OPAMP3_CSR")
            .field("opamp3en", &self.opamp3en())
...
impl W {
    ///Bit 0 - OPAMP3 enable
    #[inline(always)]
    pub fn opamp3en(&mut self) -> OPAMP3EN_W<'_, OPAMP3_CSRrs> {
        OPAMP3EN_W::new(self, 0)
    }
    ///Bit 1 - FORCE_VP
    #[inline(always)]
    pub fn force_vp(&mut self) -> FORCE_VP_W<'_, OPAMP3_CSRrs> {
        FORCE_VP_W::new(self, 1)
    }
    ///Bits 2:3 - OPAMP Non inverting input selection
    #[inline(always)]
    pub fn vp_sel(&mut self) -> VP_SEL_W<'_, OPAMP3_CSRrs> {
        VP_SEL_W::new(self, 2)
    }
    ///Bits 5:6 - OPAMP inverting input selection
    #[inline(always)]
    pub fn vm_sel(&mut self) -> VM_SEL_W<'_, OPAMP3_CSRrs> {
        VM_SEL_W::new(self, 5)
    }
    ///Bit 7 - Timer controlled Mux mode enable
    #[inline(always)]
    pub fn tcm_en(&mut self) -> TCM_EN_W<'_, OPAMP3_CSRrs> {
        TCM_EN_W::new(self, 7)
    }
    ///Bit 8 - OPAMP inverting input secondary selection
    #[inline(always)]
    pub fn vms_sel(&mut self) -> VMS_SEL_W<'_, OPAMP3_CSRrs> {
        VMS_SEL_W::new(self, 8)
    }
    ///Bits 9:10 - OPAMP Non inverting input secondary selection
    #[inline(always)]
    pub fn vps_sel(&mut self) -> VPS_SEL_W<'_, OPAMP3_CSRrs> {
        VPS_SEL_W::new(self, 9)
    }
    ///Bit 11 - Calibration mode enable
    #[inline(always)]
    pub fn calon(&mut self) -> CALON_W<'_, OPAMP3_CSRrs> {
        CALON_W::new(self, 11)
    }
    ///Bits 12:13 - Calibration selection
    #[inline(always)]
    pub fn calsel(&mut self) -> CALSEL_W<'_, OPAMP3_CSRrs> {
        CALSEL_W::new(self, 12)
    }
    ///Bits 14:17 - Gain in PGA mode
    #[inline(always)]
    pub fn pga_gain(&mut self) -> PGA_GAIN_W<'_, OPAMP3_CSRrs> {
        PGA_GAIN_W::new(self, 14)
    }
    ///Bit 18 - User trimming enable
    #[inline(always)]
    pub fn user_trim(&mut self) -> USER_TRIM_W<'_, OPAMP3_CSRrs> {
        USER_TRIM_W::new(self, 18)
    }
    ///Bits 19:23 - Offset trimming value (PMOS)
    #[inline(always)]
    pub fn trimoffsetp(&mut self) -> TRIMOFFSETP_W<'_, OPAMP3_CSRrs> {
        TRIMOFFSETP_W::new(self, 19)
    }
    ///Bits 24:28 - Offset trimming value (NMOS)
    #[inline(always)]
    pub fn trimoffsetn(&mut self) -> TRIMOFFSETN_W<'_, OPAMP3_CSRrs> {
        TRIMOFFSETN_W::new(self, 24)
    }
    ///Bit 29 - TSTREF
    #[inline(always)]
    pub fn tstref(&mut self) -> TSTREF_W<'_, OPAMP3_CSRrs> {
        TSTREF_W::new(self, 29)
    }
    ///Bit 31 - OPAMP lock
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<'_, OPAMP3_CSRrs> {
        LOCK_W::new(self, 31)
    }
}
...
pub struct OPAMP3_CSRrs;
impl crate::RegisterSpec for OPAMP3_CSRrs {
    type Ux = u32;
}
///`read()` method returns [`opamp3_csr::R`](R) reader structure
impl crate::Readable for OPAMP3_CSRrs {}
///`write(|w| ..)` method takes [`opamp3_csr::W`](W) writer structure
impl crate::Writable for OPAMP3_CSRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OPAMP3_CSR to value 0
impl crate::Resettable for OPAMP3_CSRrs {}
