...
///Field `OPAMP4EN` reader - OPAMP4 enable
pub type OPAMP4EN_R = crate::BitReader;
///Field `OPAMP4EN` writer - OPAMP4 enable
...
impl W {
    ///Bit 0 - OPAMP4 enable
    #[inline(always)]
    pub fn opamp4en(&mut self) -> OPAMP4EN_W<'_, OPAMP4_CSRrs> {
    ...
    ///Bit 7 - Timer controlled Mux mode enable
    #[inline(always)]
    pub fn tcm_en(&mut self) -> TCM_EN_W<'_, OPAMP4_CSRrs> {
        TCM_EN_W::new(self, 7)
    }
    ///Bit 8 - OPAMP inverting input secondary selection
    #[inline(always)]
    pub fn vms_sel(&mut self) -> VMS_SEL_W<'_, OPAMP4_CSRrs> {
        VMS_SEL_W::new(self, 8)
    }
    ///Bits 9:10 - OPAMP Non inverting input secondary selection
    #[inline(always)]
    pub fn vps_sel(&mut self) -> VPS_SEL_W<'_, OPAMP4_CSRrs> {
    ...
    ///Bit 18 - User trimming enable
    #[inline(always)]
    pub fn user_trim(&mut self) -> USER_TRIM_W<'_, OPAMP4_CSRrs> {
    ...
    ///Bit 29 - TSTREF
    #[inline(always)]
    pub fn tstref(&mut self) -> TSTREF_W<'_, OPAMP4_CSRrs> {
