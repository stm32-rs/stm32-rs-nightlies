...
impl<'a> TIM8SW_W<'a> {
    ...
    #[inline(always)]
    pub fn pclk2(self) -> &'a mut W {
        self.variant(TIM8SW_A::PCLK2)
    }
    #[doc = "PLL vco output (running up to 144 MHz)"]
    #[inline(always)]
    pub fn pll(self) -> &'a mut W {
        self.variant(TIM8SW_A::PLL)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl<'a> TIM20SW_W<'a> {
    ...
    #[inline(always)]
    pub fn pclk2(self) -> &'a mut W {
        self.variant(TIM20SW_A::PCLK2)
    }
    #[doc = "PLL vco output (running up to 144 MHz)"]
    #[inline(always)]
    pub fn pll(self) -> &'a mut W {
        self.variant(TIM20SW_A::PLL)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
