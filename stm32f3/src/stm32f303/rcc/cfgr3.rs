...
impl W {
    ...
    ///Bit 9 - Timer8 clock source selection
    #[inline(always)]
    pub fn tim8sw(&mut self) -> TIM8SW_W<'_, CFGR3rs> {
        TIM8SW_W::new(self, 9)
    }
    ///Bit 10 - Timer15 clock source selection
    #[inline(always)]
    ...
    ///Bit 15 - Timer20 clock source selection
    #[inline(always)]
    pub fn tim20sw(&mut self) -> TIM20SW_W<'_, CFGR3rs> {
    ...
    ///Bits 20:21 - UART4 clock source selection
    #[inline(always)]
    pub fn uart4sw(&mut self) -> UART4SW_W<'_, CFGR3rs> {
        UART4SW_W::new(self, 20)
    }
    ///Bits 22:23 - UART5 clock source selection
    #[inline(always)]
    pub fn uart5sw(&mut self) -> UART5SW_W<'_, CFGR3rs> {
        UART5SW_W::new(self, 22)
    }
    ///Bit 24 - Timer2 clock source selection
    #[inline(always)]
    pub fn tim2sw(&mut self) -> TIM2SW_W<'_, CFGR3rs> {
        TIM2SW_W::new(self, 24)
    }
    ///Bit 25 - Timer34 clock source selection
    #[inline(always)]
    pub fn tim34sw(&mut self) -> TIM34SW_W<'_, CFGR3rs> {
