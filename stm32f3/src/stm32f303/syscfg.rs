...
impl RegisterBlock {
    ...
    ///0x48 - SYSCFG configuration register 4
    #[inline(always)]
    pub const fn cfgr4(&self) -> &CFGR4 {
        &self.cfgr4
    }
    ///0x50 - SYSCFG configuration register 3
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F303.html#SYSCFG:EXTICR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F303.html#SYSCFG:EXTICR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F303.html#SYSCFG:EXTICR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F303.html#SYSCFG:CFGR2)
...
pub mod cfgr3;
/**CFGR4 (rw) register accessor: SYSCFG configuration register 4
