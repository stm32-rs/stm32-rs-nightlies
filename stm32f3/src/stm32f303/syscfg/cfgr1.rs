...
impl W {
    ...
    ///Bit 13 - TIM6 and DAC1 DMA request remapping bit
    #[inline(always)]
    pub fn tim6_dac1_ch1_dma_rmp(&mut self) -> TIM6_DAC1_CH1_DMA_RMP_W<'_, CFGR1rs> {
        TIM6_DAC1_CH1_DMA_RMP_W::new(self, 13)
    }
    ///Bit 14 - TIM7 and DAC2 DMA request remapping bit
    #[inline(always)]
    pub fn tim7_dac1_ch2_dma_rmp(&mut self) -> TIM7_DAC1_CH2_DMA_RMP_W<'_, CFGR1rs> {
        TIM7_DAC1_CH2_DMA_RMP_W::new(self, 14)
    }
    ///Bit 15 - DAC2 channel1 DMA remap
    #[inline(always)]
    pub fn dac2_ch1_dma_rmp(&mut self) -> DAC2_CH1_DMA_RMP_W<'_, CFGR1rs> {
