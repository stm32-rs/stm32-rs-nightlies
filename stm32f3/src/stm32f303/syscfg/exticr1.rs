...
impl From<EXTI_ABCDEFG> for u8 {
    #[inline(always)]
    fn from(variant: EXTI_ABCDEFG) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for EXTI_ABCDEFG {
    type Ux = u8;
}
impl crate::IsEnum for EXTI_ABCDEFG {}
///Field `EXTI3` reader - EXTI 3 configuration bits
pub type EXTI3_R = crate::FieldReader<EXTI_ABCDEFG>;
impl EXTI3_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Option<EXTI_ABCDEFG> {
        match self.bits {
            0 => Some(EXTI_ABCDEFG::Pa),
            1 => Some(EXTI_ABCDEFG::Pb),
            2 => Some(EXTI_ABCDEFG::Pc),
            3 => Some(EXTI_ABCDEFG::Pd),
            4 => Some(EXTI_ABCDEFG::Pe),
            5 => Some(EXTI_ABCDEFG::Pf),
            6 => Some(EXTI_ABCDEFG::Pg),
            _ => None,
        }
    }
    ///Select PAx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn is_pa(&self) -> bool {
        *self == EXTI_ABCDEFG::Pa
    }
    ///Select PBx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn is_pb(&self) -> bool {
        *self == EXTI_ABCDEFG::Pb
    }
    ///Select PCx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn is_pc(&self) -> bool {
        *self == EXTI_ABCDEFG::Pc
    }
    ///Select PDx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn is_pd(&self) -> bool {
        *self == EXTI_ABCDEFG::Pd
    }
    ///Select PEx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn is_pe(&self) -> bool {
        *self == EXTI_ABCDEFG::Pe
    }
    ///Select PFx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn is_pf(&self) -> bool {
        *self == EXTI_ABCDEFG::Pf
    }
    ///Select PGx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn is_pg(&self) -> bool {
        *self == EXTI_ABCDEFG::Pg
    }
}
///Field `EXTI3` writer - EXTI 3 configuration bits
pub type EXTI3_W<'a, REG> = crate::FieldWriter<'a, REG, 4, EXTI_ABCDEFG>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn pa(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEFG::Pa)
    }
    ///Select PBx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pb(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEFG::Pb)
    }
    ///Select PCx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pc(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEFG::Pc)
    }
    ///Select PDx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pd(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEFG::Pd)
    }
    ///Select PEx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pe(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEFG::Pe)
    }
    ///Select PFx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pf(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEFG::Pf)
    }
    ///Select PGx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pg(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEFG::Pg)
    }
}
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F303.html#SYSCFG:EXTICR1)*/
