...
pub enum EXTI0 {
    ...
    Pf0 = 5,
    ///6: Select PG0 as the source input for the EXTI0 external interrupt
    Pg0 = 6,
    ///7: Select PH0 as the source input for the EXTI0 external interrupt
    Ph0 = 7,
}
...
pub enum EXTI1 {
    ...
    Pf1 = 5,
    ///6: Select PG1 as the source input for the EXTI1 external interrupt
    Pg1 = 6,
    ///7: Select PH1 as the source input for the EXTI1 external interrupt
    Ph1 = 7,
}
...
pub enum EXTI2 {
    ...
    Pf2 = 5,
    ///6: Select PG2 as the source input for the EXTI2 external interrupt
    Pg2 = 6,
    ///7: Select PH2 as the source input for the EXTI2 external interrupt
    Ph2 = 7,
}
...
pub enum EXTI3 {
    ...
    Pe3 = 4,
    ///5: Select PF3 as the source input for the EXTI3 external interrupt
    Pf3 = 5,
    ///6: Select PG3 as the source input for the EXTI3 external interrupt
    Pg3 = 6,
}
