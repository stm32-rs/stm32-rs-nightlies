...
pub use super::exticr1::EXTI3_R as EXTI9_R;
///Field `EXTI10` reader - EXTI 10 configuration bits
pub use super::exticr1::EXTI3_R as EXTI10_R;
///Field `EXTI11` reader - EXTI 11 configuration bits
pub use super::exticr1::EXTI3_R as EXTI11_R;
...
pub use super::exticr1::EXTI3_W as EXTI9_W;
///Field `EXTI10` writer - EXTI 10 configuration bits
pub use super::exticr1::EXTI3_W as EXTI10_W;
///Field `EXTI11` writer - EXTI 11 configuration bits
pub use super::exticr1::EXTI3_W as EXTI11_W;
