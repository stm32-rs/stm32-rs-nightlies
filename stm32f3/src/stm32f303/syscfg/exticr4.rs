...
pub use super::exticr1::EXTI3_R as EXTI12_R;
///Field `EXTI13` reader - EXTI 13 configuration bits
pub use super::exticr1::EXTI3_R as EXTI13_R;
///Field `EXTI14` reader - EXTI 14 configuration bits
pub use super::exticr1::EXTI3_R as EXTI14_R;
///Field `EXTI15` reader - EXTI 15 configuration bits
pub use super::exticr1::EXTI3_R as EXTI15_R;
///Field `EXTI12` writer - EXTI 12 configuration bits
pub use super::exticr1::EXTI3_W as EXTI12_W;
///Field `EXTI13` writer - EXTI 13 configuration bits
pub use super::exticr1::EXTI3_W as EXTI13_W;
///Field `EXTI14` writer - EXTI 14 configuration bits
pub use super::exticr1::EXTI3_W as EXTI14_W;
///Field `EXTI15` writer - EXTI 15 configuration bits
pub use super::exticr1::EXTI3_W as EXTI15_W;
///EXTI 12 configuration bits
pub use super::exticr1::EXTI_ABCDEFG;
impl R {
