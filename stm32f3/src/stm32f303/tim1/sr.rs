...
impl CC1IF_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, CC1IF_A> {
        use crate::Variant::*;
        match self.bits {
            true => Val(CC1IF_A::MATCH),
            i => Res(i),
        }
    }
...
pub type CC2IF_R = crate::R<bool, CC1IF_A>;
#[doc = "Capture/Compare 2 interrupt flag"]
...
pub type CC3IF_R = crate::R<bool, CC1IF_A>;
#[doc = "Capture/Compare 3 interrupt flag"]
...
pub type CC4IF_R = crate::R<bool, CC1IF_A>;
#[doc = "Capture/Compare 4 interrupt flag"]
...
impl CC1OF_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, CC1OF_A> {
        use crate::Variant::*;
        match self.bits {
            true => Val(CC1OF_A::OVERCAPTURE),
            i => Res(i),
        }
    }
...
pub type CC2OF_R = crate::R<bool, CC1OF_A>;
#[doc = "Capture/compare 2 overcapture flag"]
...
pub type CC3OF_R = crate::R<bool, CC1OF_A>;
#[doc = "Capture/Compare 3 overcapture flag"]
...
pub type CC4OF_R = crate::R<bool, CC1OF_A>;
#[doc = "Capture/Compare 4 overcapture flag"]
...
#[doc = "Reader of field `C5IF`"]
pub type C5IF_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `C5IF`"]
pub struct C5IF_W<'a> {
    w: &'a mut W,
}
impl<'a> C5IF_W<'a> {
...
#[doc = "Reader of field `C6IF`"]
pub type C6IF_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `C6IF`"]
pub struct C6IF_W<'a> {
    w: &'a mut W,
}
impl<'a> C6IF_W<'a> {
