...
///Field `G_IO1(1-8)` reader - G%s_IO1 channel mode
...
///Field `G_IO1(1-8)` writer - G%s_IO1 channel mode
...
///Field `G_IO2(1-8)` reader - G%s_IO2 channel mode
pub use G_IO1_R as G_IO2_R;
///Field `G_IO3(1-8)` reader - G%s_IO3 channel mode
pub use G_IO1_R as G_IO3_R;
///Field `G_IO4(1-8)` reader - G%s_IO4 channel mode
pub use G_IO1_R as G_IO4_R;
///Field `G_IO2(1-8)` writer - G%s_IO2 channel mode
pub use G_IO1_W as G_IO2_W;
///Field `G_IO3(1-8)` writer - G%s_IO3 channel mode
pub use G_IO1_W as G_IO3_W;
///Field `G_IO4(1-8)` writer - G%s_IO4 channel mode
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F303.html#TSC:IOCCR)*/
pub struct IOCCRrs;
