...
impl W {
    ...
    ///Bit 8 - Debug Timer 14 stopped when Core is halted
    #[inline(always)]
    pub fn dbg_timer14_stop(&mut self) -> DBG_TIMER14_STOP_W<'_, APB1_FZrs> {
        DBG_TIMER14_STOP_W::new(self, 8)
    }
    ///Bit 9 - Debug Timer 18 stopped when Core is halted
    #[inline(always)]
    pub fn dbg_tim18_stop(&mut self) -> DBG_TIM18_STOP_W<'_, APB1_FZrs> {
    ...
    ///Bit 21 - SMBUS timeout mode stopped when Core is halted
    #[inline(always)]
    pub fn i2c1_smbus_timeout(&mut self) -> I2C1_SMBUS_TIMEOUT_W<'_, APB1_FZrs> {
        I2C1_SMBUS_TIMEOUT_W::new(self, 21)
    }
    ///Bit 22 - SMBUS timeout mode stopped when Core is halted
    #[inline(always)]
    pub fn i2c2_smbus_timeout(&mut self) -> I2C2_SMBUS_TIMEOUT_W<'_, APB1_FZrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F373.html#DBGMCU:APB1_FZ)*/
