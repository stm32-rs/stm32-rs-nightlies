...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr23(&mut self) -> MR23_W<IMRrs> {
        MR23_W::new(self, 23)
    }
    ///Bit 24 - Interrupt Mask on line 24
    #[inline(always)]
    #[must_use]
    pub fn mr24(&mut self) -> MR24_W<IMRrs> {
        MR24_W::new(self, 24)
    }
    ///Bit 25 - Interrupt Mask on line 25
    #[inline(always)]
    #[must_use]
    pub fn mr25(&mut self) -> MR25_W<IMRrs> {
        MR25_W::new(self, 25)
    }
    ///Bit 26 - Interrupt Mask on line 26
    #[inline(always)]
    #[must_use]
    pub fn mr26(&mut self) -> MR26_W<IMRrs> {
        MR26_W::new(self, 26)
    }
    ///Bit 27 - Interrupt Mask on line 27
    #[inline(always)]
    #[must_use]
    pub fn mr27(&mut self) -> MR27_W<IMRrs> {
        MR27_W::new(self, 27)
    }
    ///Bit 28 - Interrupt Mask on line 28
    #[inline(always)]
    #[must_use]
    pub fn mr28(&mut self) -> MR28_W<IMRrs> {
        MR28_W::new(self, 28)
    }
}
