...
pub struct SRAM_PARITY_CHECK_R(crate::FieldReader<bool, SRAM_PARITY_CHECK_A>);
...
impl core::ops::Deref for SRAM_PARITY_CHECK_R {
    type Target = crate::FieldReader<bool, SRAM_PARITY_CHECK_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct SDADC12_VDD_MONITOR_R(crate::FieldReader<bool, SDADC12_VDD_MONITOR_A>);
impl SDADC12_VDD_MONITOR_R {
    pub(crate) fn new(bits: bool) -> Self {
        SDADC12_VDD_MONITOR_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for SDADC12_VDD_MONITOR_R {
    type Target = crate::FieldReader<bool, SDADC12_VDD_MONITOR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl R {
    ...
    pub fn sdadc12_vdd_monitor(&self) -> SDADC12_VDD_MONITOR_R {
        SDADC12_VDD_MONITOR_R::new(((self.bits >> 15) & 0x01) != 0)
    }
