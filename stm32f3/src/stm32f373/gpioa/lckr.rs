...
impl W {
    ...
    ///Bit 12 - Port x lock pin 12
    #[inline(always)]
    pub fn lck12(&mut self) -> LCK_W<'_, LCKRrs> {
        LCK_W::new(self, 12)
    }
    ///Bit 13 - Port x lock pin 13
    #[inline(always)]
    pub fn lck13(&mut self) -> LCK_W<'_, LCKRrs> {
        LCK_W::new(self, 13)
    }
    ///Bit 14 - Port x lock pin 14
    #[inline(always)]
    pub fn lck14(&mut self) -> LCK_W<'_, LCKRrs> {
        LCK_W::new(self, 14)
    }
    ///Bit 15 - Port x lock pin 15
    #[inline(always)]
    pub fn lck15(&mut self) -> LCK_W<'_, LCKRrs> {
        LCK_W::new(self, 15)
    }
    ///Bit 16 - Lok Key
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F373.html#GPIOA:LCKR)*/
pub struct LCKRrs;
