...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ensd1(&mut self) -> ENSD1_W<CRrs> {
        ENSD1_W::new(self, 9)
    }
    ///Bit 10 - ENable SD2 ADC
    #[inline(always)]
    #[must_use]
    pub fn ensd2(&mut self) -> ENSD2_W<CRrs> {
        ENSD2_W::new(self, 10)
    }
    ///Bit 11 - ENable SD3 ADC
    #[inline(always)]
    #[must_use]
    pub fn ensd3(&mut self) -> ENSD3_W<CRrs> {
        ENSD3_W::new(self, 11)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F373.html#PWR:CR)*/
pub struct CRrs;
