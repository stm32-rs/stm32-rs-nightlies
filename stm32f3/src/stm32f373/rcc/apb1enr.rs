...
pub type TIM18EN_A = TIM2EN_A;
#[doc = "Reader of field `TIM18EN`"]
pub type TIM18EN_R = crate::R<bool, TIM2EN_A>;
#[doc = "Write proxy for field `TIM18EN`"]
pub struct TIM18EN_W<'a> {
    w: &'a mut W,
}
impl<'a> TIM18EN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TIM18EN_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl R {
    ...
    pub fn tim18en(&self) -> TIM18EN_R {
        TIM18EN_R::new(((self.bits >> 9) & 0x01) != 0)
    }
