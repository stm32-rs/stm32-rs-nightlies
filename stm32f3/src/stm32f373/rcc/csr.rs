...
///Field `V18PWRRSTF` reader - Reset flag of the 1.8 V domain
...
///Field `V18PWRRSTF` writer - Reset flag of the 1.8 V domain
...
impl W {
    ...
    ///Bit 23 - Reset flag of the 1.8 V domain
    #[inline(always)]
    pub fn v18pwrrstf(&mut self) -> V18PWRRSTF_W<'_, CSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F373.html#RCC:CSR)*/
pub struct CSRrs;
