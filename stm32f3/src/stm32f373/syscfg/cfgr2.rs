...
pub enum LOCKUP_LOCK {
    ///0: Cortex-M4F LOCKUP output disconnected from TIM1/15/16/17 Break input
    Disconnected = 0,
    ///1: Cortex-M4F LOCKUP output connected to TIM1/15/16/17 Break input
    Connected = 1,
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F373.html#SYSCFG:CFGR2)*/
pub struct CFGR2rs;
