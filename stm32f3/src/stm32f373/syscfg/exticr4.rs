...
pub use super::exticr3::EXTI11_R as EXTI12_R;
///Field `EXTI13` reader - EXTI 13 configuration bits
pub use super::exticr3::EXTI11_R as EXTI13_R;
///Field `EXTI12` writer - EXTI 12 configuration bits
pub use super::exticr3::EXTI11_W as EXTI12_W;
///Field `EXTI13` writer - EXTI 13 configuration bits
pub use super::exticr3::EXTI11_W as EXTI13_W;
///EXTI 12 configuration bits
pub use super::exticr3::EXTI_ACDE;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F373.html#SYSCFG:EXTICR4)*/
