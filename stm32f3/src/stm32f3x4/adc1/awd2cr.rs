...
///Field `AWD2CH(0-17)` reader - AWD2CH
...
///Field `AWD2CH(0-17)` writer - AWD2CH
...
impl R {
    ...
    pub fn awd2ch(&self, n: u8) -> AWD2CH_R {
        ...
        [(); 18][n as usize];
        AWD2CH_R::new(((self.bits >> (n + 1)) & 1) != 0)
    }
    ///Iterator for array of:
    ///AWD2CH
    #[inline(always)]
    pub fn awd2ch_iter(&self) -> impl Iterator<Item = AWD2CH_R> + '_ {
        (0..18).map(move |n| AWD2CH_R::new(((self.bits >> (n + 1)) & 1) != 0))
    }
    ///Bit 1 - AWD2CH
    #[inline(always)]
