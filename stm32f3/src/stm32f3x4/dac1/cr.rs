...
pub enum TSEL1 {
    ...
    Tim7trgo = 2,
    ///3: Timer15 TRGO or HRTM1_DACTRG1 event
    Tim15trgo = 3,
    ///4: Timer 2 TRGO event
    Tim2trgo = 4,
    ///5: HRTIM1_DACTRG2 (DAC1) or HRTM1_DACTRG3 (DAC2) event
    DacTrg2 = 5,
    ///6: EXTI line 9
    Exti9 = 6,
    ///7: Software trigger
...
impl TSEL1_R {
    ...
    ///Timer15 TRGO or HRTM1_DACTRG1 event
    #[inline(always)]
    ...
    ///HRTIM1_DACTRG2 (DAC1) or HRTM1_DACTRG3 (DAC2) event
    #[inline(always)]
    pub fn is_dac_trg2(&self) -> bool {
        *self == TSEL1::DacTrg2
    }
    ///EXTI line 9
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    ///HRTIM1_DACTRG2 (DAC1) or HRTM1_DACTRG3 (DAC2) event
    #[inline(always)]
    pub fn dac_trg2(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::DacTrg2)
    }
    ///EXTI line 9
    #[inline(always)]
