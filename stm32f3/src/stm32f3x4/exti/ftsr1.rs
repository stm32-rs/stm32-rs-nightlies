...
///Field `TR30` reader - Falling trigger event configuration of line 30.
pub use TR0_R as TR30_R;
///Field `TR31` reader - Falling trigger event configuration of line 31
...
///Field `TR30` writer - Falling trigger event configuration of line 30.
pub use TR0_W as TR30_W;
///Field `TR31` writer - Falling trigger event configuration of line 31
...
impl W {
    ...
    ///Bit 29 - Falling trigger event configuration of line 29
    #[inline(always)]
    pub fn tr29(&mut self) -> TR29_W<'_, FTSR1rs> {
        TR29_W::new(self, 29)
    }
    ///Bit 30 - Falling trigger event configuration of line 30.
    #[inline(always)]
    pub fn tr30(&mut self) -> TR30_W<'_, FTSR1rs> {
        TR30_W::new(self, 30)
    }
    ///Bit 31 - Falling trigger event configuration of line 31
    #[inline(always)]
    pub fn tr31(&mut self) -> TR31_W<'_, FTSR1rs> {
        TR31_W::new(self, 31)
    }
}
