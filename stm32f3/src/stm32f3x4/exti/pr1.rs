...
#[doc = "Pending bit 29"]
pub type PR29_A = PR0_A;
#[doc = "Reader of field `PR29`"]
pub type PR29_R = crate::R<bool, PR0_A>;
#[doc = "Pending bit 29"]
pub type PR29_AW = PR0_AW;
#[doc = "Write proxy for field `PR29`"]
pub struct PR29_W<'a> {
    w: &'a mut W,
}
impl<'a> PR29_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PR29_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
#[doc = "Pending bit 30"]
pub type PR30_A = PR0_A;
#[doc = "Reader of field `PR30`"]
pub type PR30_R = crate::R<bool, PR0_A>;
#[doc = "Pending bit 30"]
pub type PR30_AW = PR0_AW;
#[doc = "Write proxy for field `PR30`"]
pub struct PR30_W<'a> {
    w: &'a mut W,
}
impl<'a> PR30_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PR30_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
#[doc = "Pending bit 31"]
pub type PR31_A = PR0_A;
#[doc = "Reader of field `PR31`"]
pub type PR31_R = crate::R<bool, PR0_A>;
#[doc = "Pending bit 31"]
pub type PR31_AW = PR0_AW;
#[doc = "Write proxy for field `PR31`"]
pub struct PR31_W<'a> {
    w: &'a mut W,
}
impl<'a> PR31_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PR31_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
