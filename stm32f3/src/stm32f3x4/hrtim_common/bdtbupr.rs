...
pub type R = crate::R<BDTBUPRrs>;
///Register `BDTBUPR` writer
pub type W = crate::W<BDTBUPRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timx_cr(&mut self) -> TIMX_CR_W<BDTBUPRrs> {
        TIMX_CR_W::new(self, 0)
    }
    ///Bit 1 - HRTIM_TIMxICR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_icr(&mut self) -> TIMX_ICR_W<BDTBUPRrs> {
        TIMX_ICR_W::new(self, 1)
    }
    ///Bit 2 - HRTIM_TIMxDIER register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_dier(&mut self) -> TIMX_DIER_W<BDTBUPRrs> {
        TIMX_DIER_W::new(self, 2)
    }
    ///Bit 3 - HRTIM_CNTxR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_cnt(&mut self) -> TIMX_CNT_W<BDTBUPRrs> {
        TIMX_CNT_W::new(self, 3)
    }
    ///Bit 4 - HRTIM_PERxR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_per(&mut self) -> TIMX_PER_W<BDTBUPRrs> {
        TIMX_PER_W::new(self, 4)
    }
    ///Bit 5 - HRTIM_REPxR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_rep(&mut self) -> TIMX_REP_W<BDTBUPRrs> {
        TIMX_REP_W::new(self, 5)
    }
    ///Bit 6 - HRTIM_CMP1xR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_cmp1(&mut self) -> TIMX_CMP1_W<BDTBUPRrs> {
        TIMX_CMP1_W::new(self, 6)
    }
    ///Bit 7 - HRTIM_CMP2xR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_cmp2(&mut self) -> TIMX_CMP2_W<BDTBUPRrs> {
        TIMX_CMP2_W::new(self, 7)
    }
    ///Bit 8 - HRTIM_CMP3xR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_cmp3(&mut self) -> TIMX_CMP3_W<BDTBUPRrs> {
        TIMX_CMP3_W::new(self, 8)
    }
    ///Bit 9 - HRTIM_CMP4xR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_cmp4(&mut self) -> TIMX_CMP4_W<BDTBUPRrs> {
        TIMX_CMP4_W::new(self, 9)
    }
    ///Bit 10 - HRTIM_DTxR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_dtx_r(&mut self) -> TIMX_DTX_R_W<BDTBUPRrs> {
        TIMX_DTX_R_W::new(self, 10)
    }
    ///Bit 11 - HRTIM_SET1xR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_set1r(&mut self) -> TIMX_SET1R_W<BDTBUPRrs> {
        TIMX_SET1R_W::new(self, 11)
    }
    ///Bit 12 - HRTIM_RST1xR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_rst1r(&mut self) -> TIMX_RST1R_W<BDTBUPRrs> {
        TIMX_RST1R_W::new(self, 12)
    }
    ///Bit 13 - HRTIM_SET2xR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_set2r(&mut self) -> TIMX_SET2R_W<BDTBUPRrs> {
        TIMX_SET2R_W::new(self, 13)
    }
    ///Bit 14 - HRTIM_RST2xR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_rst2r(&mut self) -> TIMX_RST2R_W<BDTBUPRrs> {
        TIMX_RST2R_W::new(self, 14)
    }
    ///Bit 15 - HRTIM_EEFxR1 register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_eefr1(&mut self) -> TIMX_EEFR1_W<BDTBUPRrs> {
        TIMX_EEFR1_W::new(self, 15)
    }
    ///Bit 16 - HRTIM_EEFxR2 register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_eefr2(&mut self) -> TIMX_EEFR2_W<BDTBUPRrs> {
        TIMX_EEFR2_W::new(self, 16)
    }
    ///Bit 17 - HRTIM_RSTxR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_rstr(&mut self) -> TIMX_RSTR_W<BDTBUPRrs> {
        TIMX_RSTR_W::new(self, 17)
    }
    ///Bit 18 - HRTIM_CHPxR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_chpr(&mut self) -> TIMX_CHPR_W<BDTBUPRrs> {
        TIMX_CHPR_W::new(self, 18)
    }
    ///Bit 19 - HRTIM_OUTxR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_outr(&mut self) -> TIMX_OUTR_W<BDTBUPRrs> {
        TIMX_OUTR_W::new(self, 19)
    }
    ///Bit 20 - HRTIM_FLTxR register update enable
    #[inline(always)]
    #[must_use]
    pub fn timx_fltr(&mut self) -> TIMX_FLTR_W<BDTBUPRrs> {
        TIMX_FLTR_W::new(self, 20)
    }
}
/**Burst DMA Timerx update Register

You can [`read`](crate::Reg::read) this register and get [`bdtbupr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bdtbupr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F3x4.html#HRTIM_Common:BDTBUPR)*/
pub struct BDTBUPRrs;
impl crate::RegisterSpec for BDTBUPRrs {
    type Ux = u32;
}
///`read()` method returns [`bdtbupr::R`](R) reader structure
impl crate::Readable for BDTBUPRrs {}
///`write(|w| ..)` method takes [`bdtbupr::W`](W) writer structure
impl crate::Writable for BDTBUPRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets BDTBUPR to value 0
impl crate::Resettable for BDTBUPRrs {
