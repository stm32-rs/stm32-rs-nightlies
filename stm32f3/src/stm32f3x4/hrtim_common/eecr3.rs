...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EE6F` field.</div>
    #[inline(always)]
    pub fn eef(&mut self, n: u8) -> EEF_W<EECR3rs> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
        EEF_W::new(self, n * 6)
    }
    ///Bits 0:3 - EE6F
    #[inline(always)]
    pub fn ee6f(&mut self) -> EEF_W<EECR3rs> {
        EEF_W::new(self, 0)
    }
    ///Bits 6:9 - EE7F
    #[inline(always)]
    pub fn ee7f(&mut self) -> EEF_W<EECR3rs> {
        EEF_W::new(self, 6)
    }
    ///Bits 12:15 - EE8F
    #[inline(always)]
    pub fn ee8f(&mut self) -> EEF_W<EECR3rs> {
        EEF_W::new(self, 12)
    }
    ///Bits 18:21 - EE9F
    #[inline(always)]
    pub fn ee9f(&mut self) -> EEF_W<EECR3rs> {
        EEF_W::new(self, 18)
    }
    ///Bits 24:27 - EE10F
    #[inline(always)]
    pub fn ee10f(&mut self) -> EEF_W<EECR3rs> {
        EEF_W::new(self, 24)
    }
    ///Bits 30:31 - EEVSD
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F3x4.html#HRTIM_Common:EECR3)*/
pub struct EECR3rs;
