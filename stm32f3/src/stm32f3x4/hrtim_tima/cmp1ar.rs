#[doc = "Reader of register CMP1AR"]
pub type R = crate::R<u32, super::CMP1AR>;
#[doc = "Writer for register CMP1AR"]
pub type W = crate::W<u32, super::CMP1AR>;
#[doc = "Register CMP1AR `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP1AR {
    type Type = u32;
    #[inline(always)]
