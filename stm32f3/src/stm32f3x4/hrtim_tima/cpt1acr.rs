...
pub type TECMP2_A = TBCMP1_A;
#[doc = "Field `TECMP2` reader - Timer E Compare 2"]
pub type TECMP2_R = TBCMP1_R;
...
pub type TECMP1_A = TBCMP1_A;
#[doc = "Field `TECMP1` reader - Timer E Compare 1"]
pub type TECMP1_R = TBCMP1_R;
...
pub type TE1RST_A = TB1RST_A;
#[doc = "Field `TE1RST` reader - Timer E output 1 Reset"]
pub type TE1RST_R = TB1RST_R;
...
pub type TE1SET_A = TB1SET_A;
#[doc = "Field `TE1SET` reader - Timer E output 1 Set"]
pub type TE1SET_R = TB1SET_R;
...
pub type TDCMP2_A = TBCMP1_A;
#[doc = "Field `TDCMP2` reader - Timer D Compare 2"]
pub type TDCMP2_R = TBCMP1_R;
...
pub type TDCMP1_A = TBCMP1_A;
#[doc = "Field `TDCMP1` reader - Timer D Compare 1"]
pub type TDCMP1_R = TBCMP1_R;
...
pub type TD1RST_A = TB1RST_A;
#[doc = "Field `TD1RST` reader - Timer D output 1 Reset"]
pub type TD1RST_R = TB1RST_R;
...
pub type TD1SET_A = TB1SET_A;
#[doc = "Field `TD1SET` reader - Timer D output 1 Set"]
pub type TD1SET_R = TB1SET_R;
...
pub type TCCMP2_A = TBCMP1_A;
#[doc = "Field `TCCMP2` reader - Timer C Compare 2"]
pub type TCCMP2_R = TBCMP1_R;
...
impl<'a> TCCMP2_W<'a> {
    ...
    #[inline(always)]
    pub fn trigger_capture(self) -> &'a mut W {
        self.variant(TCCMP2_A::TRIGGERCAPTURE)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub type TCCMP1_A = TBCMP1_A;
#[doc = "Field `TCCMP1` reader - Timer C Compare 1"]
pub type TCCMP1_R = TBCMP1_R;
...
impl<'a> TCCMP1_W<'a> {
    ...
    #[inline(always)]
    pub fn trigger_capture(self) -> &'a mut W {
        self.variant(TCCMP1_A::TRIGGERCAPTURE)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
#[doc = "Timer C output 1 Reset"]
pub type TC1RST_A = TB1RST_A;
#[doc = "Field `TC1RST` reader - Timer C output 1 Reset"]
pub type TC1RST_R = TB1RST_R;
...
impl<'a> TC1RST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TC1RST_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Timer X output Y active to inactive transition has no effect"]
    #[inline(always)]
    pub fn no_effect(self) -> &'a mut W {
        self.variant(TC1RST_A::NOEFFECT)
    }
    #[doc = "Timer X output Y active to inactive transition triggers capture Z"]
    #[inline(always)]
    pub fn trigger_capture(self) -> &'a mut W {
        self.variant(TC1RST_A::TRIGGERCAPTURE)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
#[doc = "Timer C output 1 Set"]
pub type TC1SET_A = TB1SET_A;
#[doc = "Field `TC1SET` reader - Timer C output 1 Set"]
pub type TC1SET_R = TB1SET_R;
...
impl<'a> TC1SET_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TC1SET_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Timer X output Y inactive to active transition has no effect"]
    #[inline(always)]
    pub fn no_effect(self) -> &'a mut W {
        self.variant(TC1SET_A::NOEFFECT)
    }
    #[doc = "Timer X output Y inactive to active transition triggers capture Z"]
    #[inline(always)]
    pub fn trigger_capture(self) -> &'a mut W {
        self.variant(TC1SET_A::TRIGGERCAPTURE)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub type TBCMP2_A = TBCMP1_A;
#[doc = "Field `TBCMP2` reader - Timer B Compare 2"]
pub type TBCMP2_R = TBCMP1_R;
...
pub struct TBCMP1_R(crate::FieldReader<bool, TBCMP1_A>);
impl TBCMP1_R {
...
impl core::ops::Deref for TBCMP1_R {
    type Target = crate::FieldReader<bool, TBCMP1_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TB1RST_R(crate::FieldReader<bool, TB1RST_A>);
impl TB1RST_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TB1RST_R {
    type Target = crate::FieldReader<bool, TB1RST_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TB1SET_R(crate::FieldReader<bool, TB1SET_A>);
impl TB1SET_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TB1SET_R {
    type Target = crate::FieldReader<bool, TB1SET_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
