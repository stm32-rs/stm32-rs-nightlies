...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ckpscx(&mut self) -> CKPSCX_W<TIMACRrs> {
        CKPSCX_W::new(self, 0)
    }
    ///Bit 3 - Continuous mode
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F3x4.html#HRTIM_TIMA:TIMACR)*/
pub struct TIMACRrs;
impl crate::RegisterSpec for TIMACRrs {
    type Ux = u32;
}
///`read()` method returns [`timacr::R`](R) reader structure
impl crate::Readable for TIMACRrs {}
///`write(|w| ..)` method takes [`timacr::W`](W) writer structure
impl crate::Writable for TIMACRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMACR to value 0
