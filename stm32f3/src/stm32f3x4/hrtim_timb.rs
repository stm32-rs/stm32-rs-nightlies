...
#[doc = "TIMxDIER5"]
pub mod timbdier;
#[doc = "Timerx Counter Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cntbr](cntbr) module"]
pub type CNTBR = crate::Reg<u32, _CNTBR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CNTBR;
#[doc = "`read()` method returns [cntbr::R](cntbr::R) reader structure"]
impl crate::Readable for CNTBR {}
#[doc = "`write(|w| ..)` method takes [cntbr::W](cntbr::W) writer structure"]
impl crate::Writable for CNTBR {}
#[doc = "Timerx Counter Register"]
pub mod cntbr;
