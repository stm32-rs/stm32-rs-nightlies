#[doc = "Reader of register CMP2BR"]
pub type R = crate::R<u32, super::CMP2BR>;
#[doc = "Writer for register CMP2BR"]
pub type W = crate::W<u32, super::CMP2BR>;
#[doc = "Register CMP2BR `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP2BR {
    type Type = u32;
    #[inline(always)]
