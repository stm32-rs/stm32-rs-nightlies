///Register `TIMBDIER` reader
pub type R = crate::R<TIMBDIERrs>;
///Register `TIMBDIER` writer
...
You can [`read`](crate::Reg::read) this register and get [`timbdier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timbdier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`timbdier::R`](R) reader structure
impl crate::Readable for TIMBDIERrs {}
///`write(|w| ..)` method takes [`timbdier::W`](W) writer structure
impl crate::Writable for TIMBDIERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMBDIER to value 0
