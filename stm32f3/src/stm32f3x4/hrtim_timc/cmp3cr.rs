#[doc = "Reader of register CMP3CR"]
pub type R = crate::R<u32, super::CMP3CR>;
#[doc = "Writer for register CMP3CR"]
pub type W = crate::W<u32, super::CMP3CR>;
#[doc = "Register CMP3CR `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP3CR {
    type Type = u32;
    #[inline(always)]
