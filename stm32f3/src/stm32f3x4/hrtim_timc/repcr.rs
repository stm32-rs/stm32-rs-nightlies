#[doc = "Reader of register REPCR"]
pub type R = crate::R<u32, super::REPCR>;
#[doc = "Writer for register REPCR"]
pub type W = crate::W<u32, super::REPCR>;
#[doc = "Register REPCR `reset()`'s with value 0"]
impl crate::ResetValue for super::REPCR {
    type Type = u32;
    #[inline(always)]
