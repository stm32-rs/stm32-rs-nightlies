#[doc = "Reader of register CMP1CDR"]
pub type R = crate::R<u32, super::CMP1CDR>;
#[doc = "Writer for register CMP1CDR"]
pub type W = crate::W<u32, super::CMP1CDR>;
#[doc = "Register CMP1CDR `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP1CDR {
    type Type = u32;
    #[inline(always)]
