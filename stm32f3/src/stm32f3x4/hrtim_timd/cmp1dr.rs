///Register `CMP1DR` reader
pub type R = crate::R<CMP1DRrs>;
///Register `CMP1DR` writer
...
///`read()` method returns [`cmp1dr::R`](R) reader structure
impl crate::Readable for CMP1DRrs {}
///`write(|w| ..)` method takes [`cmp1dr::W`](W) writer structure
impl crate::Writable for CMP1DRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CMP1DR to value 0
