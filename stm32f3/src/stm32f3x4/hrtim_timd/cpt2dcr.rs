#[doc = "Reader of register CPT2DCR"]
pub type R = crate::R<u32, super::CPT2DCR>;
#[doc = "Writer for register CPT2DCR"]
pub type W = crate::W<u32, super::CPT2DCR>;
#[doc = "Register CPT2DCR `reset()`'s with value 0"]
impl crate::ResetValue for super::CPT2DCR {
    type Type = u32;
    #[inline(always)]
...
pub type TC1RST_A = TE1RST_A;
#[doc = "Reader of field `TC1RST`"]
pub type TC1RST_R = crate::R<bool, TE1RST_A>;
...
pub type TC1SET_A = TE1SET_A;
#[doc = "Reader of field `TC1SET`"]
pub type TC1SET_R = crate::R<bool, TE1SET_A>;
