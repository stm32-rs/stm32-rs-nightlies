...
pub type R = crate::R<RSTD1Rrs>;
#[doc = "Register `RSTD1R` writer"]
pub type W = crate::W<RSTD1Rrs>;
#[doc = "SRT\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srt(&mut self) -> SRT_W<RSTD1Rrs> {
        SRT_W::new(self, 0)
    }
    #[doc = "Bit 1 - RESYNC"]
    #[inline(always)]
    #[must_use]
    pub fn resync(&mut self) -> RESYNC_W<RSTD1Rrs> {
        RESYNC_W::new(self, 1)
    }
    #[doc = "Bit 2 - PER"]
    #[inline(always)]
    #[must_use]
    pub fn per(&mut self) -> PER_W<RSTD1Rrs> {
        PER_W::new(self, 2)
    }
    #[doc = "Bit 3 - CMP1"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1(&mut self) -> CMP1_W<RSTD1Rrs> {
        CMP1_W::new(self, 3)
    }
    #[doc = "Bit 4 - CMP2"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> CMP2_W<RSTD1Rrs> {
        CMP2_W::new(self, 4)
    }
    #[doc = "Bit 5 - CMP3"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3(&mut self) -> CMP3_W<RSTD1Rrs> {
        CMP3_W::new(self, 5)
    }
    #[doc = "Bit 6 - CMP4"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> CMP4_W<RSTD1Rrs> {
        CMP4_W::new(self, 6)
    }
    #[doc = "Bit 7 - MSTPER"]
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MSTPER_W<RSTD1Rrs> {
        MSTPER_W::new(self, 7)
    }
    #[doc = "Bit 8 - MSTCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> MSTCMP1_W<RSTD1Rrs> {
        MSTCMP1_W::new(self, 8)
    }
    #[doc = "Bit 9 - MSTCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> MSTCMP2_W<RSTD1Rrs> {
        MSTCMP2_W::new(self, 9)
    }
    #[doc = "Bit 10 - MSTCMP3"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> MSTCMP3_W<RSTD1Rrs> {
        MSTCMP3_W::new(self, 10)
    }
    #[doc = "Bit 11 - MSTCMP4"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> MSTCMP4_W<RSTD1Rrs> {
        MSTCMP4_W::new(self, 11)
    }
    #[doc = "Bit 12 - TIMEVNT1"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt1(&mut self) -> TIMEVNT1_W<RSTD1Rrs> {
        TIMEVNT1_W::new(self, 12)
    }
    #[doc = "Bit 13 - TIMEVNT2"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt2(&mut self) -> TIMEVNT2_W<RSTD1Rrs> {
        TIMEVNT2_W::new(self, 13)
    }
    #[doc = "Bit 14 - TIMEVNT3"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt3(&mut self) -> TIMEVNT3_W<RSTD1Rrs> {
        TIMEVNT3_W::new(self, 14)
    }
    #[doc = "Bit 15 - TIMEVNT4"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt4(&mut self) -> TIMEVNT4_W<RSTD1Rrs> {
        TIMEVNT4_W::new(self, 15)
    }
    #[doc = "Bit 16 - TIMEVNT5"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt5(&mut self) -> TIMEVNT5_W<RSTD1Rrs> {
        TIMEVNT5_W::new(self, 16)
    }
    #[doc = "Bit 17 - TIMEVNT6"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt6(&mut self) -> TIMEVNT6_W<RSTD1Rrs> {
        TIMEVNT6_W::new(self, 17)
    }
    #[doc = "Bit 18 - TIMEVNT7"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt7(&mut self) -> TIMEVNT7_W<RSTD1Rrs> {
        TIMEVNT7_W::new(self, 18)
    }
    #[doc = "Bit 19 - TIMEVNT8"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt8(&mut self) -> TIMEVNT8_W<RSTD1Rrs> {
        TIMEVNT8_W::new(self, 19)
    }
    #[doc = "Bit 20 - TIMEVNT9"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt9(&mut self) -> TIMEVNT9_W<RSTD1Rrs> {
        TIMEVNT9_W::new(self, 20)
    }
    #[doc = "Bit 21 - EXTEVNT1"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> EXTEVNT1_W<RSTD1Rrs> {
        EXTEVNT1_W::new(self, 21)
    }
    #[doc = "Bit 22 - EXTEVNT2"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> EXTEVNT2_W<RSTD1Rrs> {
        EXTEVNT2_W::new(self, 22)
    }
    #[doc = "Bit 23 - EXTEVNT3"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> EXTEVNT3_W<RSTD1Rrs> {
        EXTEVNT3_W::new(self, 23)
    }
    #[doc = "Bit 24 - EXTEVNT4"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> EXTEVNT4_W<RSTD1Rrs> {
        EXTEVNT4_W::new(self, 24)
    }
    #[doc = "Bit 25 - EXTEVNT5"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> EXTEVNT5_W<RSTD1Rrs> {
        EXTEVNT5_W::new(self, 25)
    }
    #[doc = "Bit 26 - EXTEVNT6"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> EXTEVNT6_W<RSTD1Rrs> {
        EXTEVNT6_W::new(self, 26)
    }
    #[doc = "Bit 27 - EXTEVNT7"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> EXTEVNT7_W<RSTD1Rrs> {
        EXTEVNT7_W::new(self, 27)
    }
    #[doc = "Bit 28 - EXTEVNT8"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> EXTEVNT8_W<RSTD1Rrs> {
        EXTEVNT8_W::new(self, 28)
    }
    #[doc = "Bit 29 - EXTEVNT9"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> EXTEVNT9_W<RSTD1Rrs> {
        EXTEVNT9_W::new(self, 29)
    }
    #[doc = "Bit 30 - EXTEVNT10"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> EXTEVNT10_W<RSTD1Rrs> {
        EXTEVNT10_W::new(self, 30)
    }
    #[doc = "Bit 31 - UPDATE"]
    #[inline(always)]
    #[must_use]
    pub fn update(&mut self) -> UPDATE_W<RSTD1Rrs> {
