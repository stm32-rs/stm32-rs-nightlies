#[doc = "Reader of register CMP1ER"]
pub type R = crate::R<u32, super::CMP1ER>;
#[doc = "Writer for register CMP1ER"]
pub type W = crate::W<u32, super::CMP1ER>;
#[doc = "Register CMP1ER `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP1ER {
    type Type = u32;
    #[inline(always)]
