...
pub type R = crate::R<TIMECRrs>;
///Register `TIMECR` writer
pub type W = crate::W<TIMECRrs>;
...
pub type CKPSCX_W<'a, REG> = crate::FieldWriter<'a, REG, 3, u8, crate::Safe>;
/**Continuous mode
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ckpscx(&mut self) -> CKPSCX_W<TIMECRrs> {
        CKPSCX_W::new(self, 0)
    }
    ///Bit 3 - Continuous mode
    #[inline(always)]
    #[must_use]
    pub fn cont(&mut self) -> CONT_W<TIMECRrs> {
        CONT_W::new(self, 3)
    }
    ///Bit 4 - Re-triggerable mode
    #[inline(always)]
    #[must_use]
    pub fn retrig(&mut self) -> RETRIG_W<TIMECRrs> {
        RETRIG_W::new(self, 4)
    }
    ///Bit 5 - Half mode enable
    #[inline(always)]
    #[must_use]
    pub fn half(&mut self) -> HALF_W<TIMECRrs> {
        HALF_W::new(self, 5)
    }
    ///Bit 6 - Push-Pull mode enable
    #[inline(always)]
    #[must_use]
    pub fn pshpll(&mut self) -> PSHPLL_W<TIMECRrs> {
        PSHPLL_W::new(self, 6)
    }
    ///Bit 10 - Synchronization Resets Timer x
    #[inline(always)]
    #[must_use]
    pub fn syncrstx(&mut self) -> SYNCRSTX_W<TIMECRrs> {
        SYNCRSTX_W::new(self, 10)
    }
    ///Bit 11 - Synchronization Starts Timer x
    #[inline(always)]
    #[must_use]
    pub fn syncstrtx(&mut self) -> SYNCSTRTX_W<TIMECRrs> {
        SYNCSTRTX_W::new(self, 11)
    }
    ///Bits 12:13 - Delayed CMP2 mode
    #[inline(always)]
    #[must_use]
    pub fn delcmp2(&mut self) -> DELCMP2_W<TIMECRrs> {
        DELCMP2_W::new(self, 12)
    }
    ///Bits 14:15 - Delayed CMP4 mode
    #[inline(always)]
    #[must_use]
    pub fn delcmp4(&mut self) -> DELCMP4_W<TIMECRrs> {
        DELCMP4_W::new(self, 14)
    }
    ///Bit 17 - Timer x Repetition update
    #[inline(always)]
    #[must_use]
    pub fn tx_repu(&mut self) -> TX_REPU_W<TIMECRrs> {
        TX_REPU_W::new(self, 17)
    }
    ///Bit 18 - Timerx reset update
    #[inline(always)]
    #[must_use]
    pub fn tx_rstu(&mut self) -> TX_RSTU_W<TIMECRrs> {
        TX_RSTU_W::new(self, 18)
    }
    ///Bit 20 - TBU
    #[inline(always)]
    #[must_use]
    pub fn tbu(&mut self) -> TBU_W<TIMECRrs> {
        TBU_W::new(self, 20)
    }
    ///Bit 21 - TCU
    #[inline(always)]
    #[must_use]
    pub fn tcu(&mut self) -> TCU_W<TIMECRrs> {
        TCU_W::new(self, 21)
    }
    ///Bit 22 - TDU
    #[inline(always)]
    #[must_use]
    pub fn tdu(&mut self) -> TDU_W<TIMECRrs> {
        TDU_W::new(self, 22)
    }
    ///Bit 23 - TEU
    #[inline(always)]
    #[must_use]
    pub fn teu(&mut self) -> TEU_W<TIMECRrs> {
        TEU_W::new(self, 23)
    }
    ///Bit 24 - Master Timer update
    #[inline(always)]
    #[must_use]
    pub fn mstu(&mut self) -> MSTU_W<TIMECRrs> {
        MSTU_W::new(self, 24)
    }
    ///Bits 25:26 - AC Synchronization
    #[inline(always)]
    #[must_use]
    pub fn dacsync(&mut self) -> DACSYNC_W<TIMECRrs> {
        DACSYNC_W::new(self, 25)
    }
    ///Bit 27 - Preload enable
    #[inline(always)]
    #[must_use]
    pub fn preen(&mut self) -> PREEN_W<TIMECRrs> {
        PREEN_W::new(self, 27)
    }
    ///Bits 28:31 - Update Gating
    #[inline(always)]
    #[must_use]
    pub fn updgat(&mut self) -> UPDGAT_W<TIMECRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F3x4.html#HRTIM_TIME:TIMECR)*/
pub struct TIMECRrs;
impl crate::RegisterSpec for TIMECRrs {
    type Ux = u32;
}
///`read()` method returns [`timecr::R`](R) reader structure
impl crate::Readable for TIMECRrs {}
///`write(|w| ..)` method takes [`timecr::W`](W) writer structure
impl crate::Writable for TIMECRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMECR to value 0
impl crate::Resettable for TIMECRrs {
