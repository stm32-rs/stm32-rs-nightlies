...
///Field `SADD` reader - Slave address bit 9:8 (master mode)
pub type SADD_R = crate::FieldReader<u16>;
///Field `SADD` writer - Slave address bit 9:8 (master mode)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F3x4.html#I2C1:CR2)*/
pub struct CR2rs;
