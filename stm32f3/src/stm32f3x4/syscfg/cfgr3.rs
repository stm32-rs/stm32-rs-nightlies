...
pub struct DAC1_TRIG5_RMP_R(crate::FieldReader<bool, DAC1_TRIG5_RMP_A>);
impl DAC1_TRIG5_RMP_R {
    pub(crate) fn new(bits: bool) -> Self {
        DAC1_TRIG5_RMP_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for DAC1_TRIG5_RMP_R {
    type Target = crate::FieldReader<bool, DAC1_TRIG5_RMP_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct DAC1_TRIG3_RMP_R(crate::FieldReader<bool, DAC1_TRIG3_RMP_A>);
impl DAC1_TRIG3_RMP_R {
    pub(crate) fn new(bits: bool) -> Self {
        DAC1_TRIG3_RMP_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for DAC1_TRIG3_RMP_R {
    type Target = crate::FieldReader<bool, DAC1_TRIG3_RMP_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
