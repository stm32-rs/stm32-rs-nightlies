...
///Field `SMS_3` reader - Slave mode selection bit3
pub type SMS_3_R = crate::BitReader;
///Field `SMS_3` writer - Slave mode selection bit3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F3x4.html#TIM2:SMCR)*/
pub struct SMCRrs;
