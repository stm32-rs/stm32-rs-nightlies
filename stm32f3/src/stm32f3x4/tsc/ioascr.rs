...
impl W {
    ...
    ///Bit 28 - G8_IO1 analog switch enable
    #[inline(always)]
    pub fn g8_io1(&mut self) -> G_IO1_W<'_, IOASCRrs> {
        G_IO1_W::new(self, 28)
    }
    ///G(1-8)_IO2 analog switch enable
    ///
    ...
    ///Bit 29 - G8_IO2 analog switch enable
    #[inline(always)]
    pub fn g8_io2(&mut self) -> G_IO2_W<'_, IOASCRrs> {
        G_IO2_W::new(self, 29)
    }
    ///G(1-8)_IO3 analog switch enable
    ///
    ...
    ///Bit 30 - G8_IO3 analog switch enable
    #[inline(always)]
    pub fn g8_io3(&mut self) -> G_IO3_W<'_, IOASCRrs> {
        G_IO3_W::new(self, 30)
    }
    ///G(1-8)_IO4 analog switch enable
    ///
    ...
    ///Bit 31 - G8_IO4 analog switch enable
    #[inline(always)]
    pub fn g8_io4(&mut self) -> G_IO4_W<'_, IOASCRrs> {
        G_IO4_W::new(self, 31)
    }
}
