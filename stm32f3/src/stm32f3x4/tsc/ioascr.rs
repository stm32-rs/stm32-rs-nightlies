...
///Field `G_IO1(1-8)` reader - G%s_IO1 analog switch enable
...
///Field `G_IO1(1-8)` writer - G%s_IO1 analog switch enable
...
///Field `G_IO2(1-8)` reader - G%s_IO2 analog switch enable
pub use G_IO1_R as G_IO2_R;
///Field `G_IO3(1-8)` reader - G%s_IO3 analog switch enable
pub use G_IO1_R as G_IO3_R;
///Field `G_IO4(1-8)` reader - G%s_IO4 analog switch enable
pub use G_IO1_R as G_IO4_R;
///Field `G_IO2(1-8)` writer - G%s_IO2 analog switch enable
pub use G_IO1_W as G_IO2_W;
///Field `G_IO3(1-8)` writer - G%s_IO3 analog switch enable
pub use G_IO1_W as G_IO3_W;
///Field `G_IO4(1-8)` writer - G%s_IO4 analog switch enable
...
impl R {
    ...
    ///G(1-8)_IO4 analog switch enable
    ///
...
impl W {
    ...
    ///Bit 28 - G8_IO1 analog switch enable
    #[inline(always)]
    pub fn g8_io1(&mut self) -> G_IO1_W<IOASCRrs> {
        G_IO1_W::new(self, 28)
    }
    ///G(1-8)_IO2 analog switch enable
    ///
    ...
    ///Bit 29 - G8_IO2 analog switch enable
    #[inline(always)]
    pub fn g8_io2(&mut self) -> G_IO2_W<IOASCRrs> {
        G_IO2_W::new(self, 29)
    }
    ///G(1-8)_IO3 analog switch enable
    ///
    ...
    ///Bit 30 - G8_IO3 analog switch enable
    #[inline(always)]
    pub fn g8_io3(&mut self) -> G_IO3_W<IOASCRrs> {
        G_IO3_W::new(self, 30)
    }
    ///G(1-8)_IO4 analog switch enable
    ///
    ...
    ///Bit 31 - G8_IO4 analog switch enable
    #[inline(always)]
    pub fn g8_io4(&mut self) -> G_IO4_W<IOASCRrs> {
        G_IO4_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F3x4.html#TSC:IOASCR)*/
pub struct IOASCRrs;
