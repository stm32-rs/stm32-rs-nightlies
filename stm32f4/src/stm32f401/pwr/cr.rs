    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn on(self) -> &'a mut crate::W<REG> {
        self.variant(MRLVDS::On)
    }
    ///Main Regulator in under-drive mode and Flash memory in power-down when the device is in Stop under-drive mode
    #[inline(always)]
    pub fn under_drive(self) -> &'a mut crate::W<REG> {
        self.variant(MRLVDS::UnderDrive)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F401.html#PWR:CR)*/
pub struct CRrs;
