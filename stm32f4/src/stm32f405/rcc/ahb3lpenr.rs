...
///Field `FSMCLPEN` reader - Flexible static memory controller module clock enable during Sleep mode
...
///Field `FSMCLPEN` writer - Flexible static memory controller module clock enable during Sleep mode
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F405.html#RCC:AHB3LPENR)*/
