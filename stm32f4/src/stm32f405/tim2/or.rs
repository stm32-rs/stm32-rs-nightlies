...
impl ITR1_RMP_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<ITR1_RMP> {
        match self.bits {
            0 => Some(ITR1_RMP::Tim8Trgout),
            2 => Some(ITR1_RMP::OtgFsSof),
            3 => Some(ITR1_RMP::OtgHsSof),
            _ => None,
        }
    }
...
pub type ITR1_RMP_W<'a, REG> = crate::FieldWriter<'a, REG, 2, ITR1_RMP>;
