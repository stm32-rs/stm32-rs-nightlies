...
///Field `EN(1-1)` reader - DAC channel%s enable
...
///Field `EN(1-1)` writer - DAC channel%s enable
...
///Field `BOFF(1-1)` reader - DAC channel%s output buffer disable
...
///Field `BOFF(1-1)` writer - DAC channel%s output buffer disable
...
///Field `TEN(1-1)` reader - DAC channel%s trigger enable
...
///Field `TEN(1-1)` writer - DAC channel%s trigger enable
...
///Field `WAVE(1-1)` reader - DAC channel%s noise/triangle wave generation enable
...
///Field `WAVE(1-1)` writer - DAC channel%s noise/triangle wave generation enable
...
///Field `MAMP(1-1)` reader - DAC channel%s mask/amplitude selector
...
///Field `MAMP(1-1)` writer - DAC channel%s mask/amplitude selector
...
///Field `DMAEN(1-1)` reader - DAC channel%s DMA enable
...
///Field `DMAEN(1-1)` writer - DAC channel%s DMA enable
...
///Field `DMAUDRIE(1-1)` reader - DAC channel%s DMA Underrun Interrupt enable
...
///Field `DMAUDRIE(1-1)` writer - DAC channel%s DMA Underrun Interrupt enable
...
impl R {
    ...
    pub fn en(&self, n: u8) -> EN_R {
        ...
        [(); 1][n as usize];
        EN_R::new(((self.bits >> (n * 0)) & 1) != 0)
    }
    ///Iterator for array of:
    ///DAC channel(1-1) enable
    #[inline(always)]
    pub fn en_iter(&self) -> impl Iterator<Item = EN_R> + '_ {
        (0..1).map(move |n| EN_R::new(((self.bits >> (n * 0)) & 1) != 0))
    }
    ...
    ///DAC channel(1-1) output buffer disable
    ///
    ...
    pub fn boff(&self, n: u8) -> BOFF_R {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        BOFF_R::new(((self.bits >> (n * 0 + 1)) & 1) != 0)
    }
    ///Iterator for array of:
    ///DAC channel(1-1) output buffer disable
    #[inline(always)]
    pub fn boff_iter(&self) -> impl Iterator<Item = BOFF_R> + '_ {
        (0..1).map(move |n| BOFF_R::new(((self.bits >> (n * 0 + 1)) & 1) != 0))
    }
    ...
    ///DAC channel(1-1) trigger enable
    ///
    ...
    pub fn ten(&self, n: u8) -> TEN_R {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        TEN_R::new(((self.bits >> (n * 0 + 2)) & 1) != 0)
    }
    ///Iterator for array of:
    ///DAC channel(1-1) trigger enable
    #[inline(always)]
    pub fn ten_iter(&self) -> impl Iterator<Item = TEN_R> + '_ {
        (0..1).map(move |n| TEN_R::new(((self.bits >> (n * 0 + 2)) & 1) != 0))
    }
    ...
    ///DAC channel(1-1) noise/triangle wave generation enable
    ///
    ...
    pub fn wave(&self, n: u8) -> WAVE_R {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        WAVE_R::new(((self.bits >> (n * 0 + 6)) & 3) as u8)
    }
    ///Iterator for array of:
    ///DAC channel(1-1) noise/triangle wave generation enable
    #[inline(always)]
    pub fn wave_iter(&self) -> impl Iterator<Item = WAVE_R> + '_ {
        (0..1).map(move |n| WAVE_R::new(((self.bits >> (n * 0 + 6)) & 3) as u8))
    }
    ...
    ///DAC channel(1-1) mask/amplitude selector
    ///
    ...
    pub fn mamp(&self, n: u8) -> MAMP_R {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        MAMP_R::new(((self.bits >> (n * 0 + 8)) & 0x0f) as u8)
    }
    ///Iterator for array of:
    ///DAC channel(1-1) mask/amplitude selector
    #[inline(always)]
    pub fn mamp_iter(&self) -> impl Iterator<Item = MAMP_R> + '_ {
        (0..1).map(move |n| MAMP_R::new(((self.bits >> (n * 0 + 8)) & 0x0f) as u8))
    }
    ...
    pub fn dmaen(&self, n: u8) -> DMAEN_R {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        DMAEN_R::new(((self.bits >> (n * 0 + 12)) & 1) != 0)
    }
    ///Iterator for array of:
    ///DAC channel(1-1) DMA enable
    #[inline(always)]
    pub fn dmaen_iter(&self) -> impl Iterator<Item = DMAEN_R> + '_ {
        (0..1).map(move |n| DMAEN_R::new(((self.bits >> (n * 0 + 12)) & 1) != 0))
    }
    ...
    ///DAC channel(1-1) DMA Underrun Interrupt enable
    ///
    ...
    pub fn dmaudrie(&self, n: u8) -> DMAUDRIE_R {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        DMAUDRIE_R::new(((self.bits >> (n * 0 + 13)) & 1) != 0)
    }
    ///Iterator for array of:
    ///DAC channel(1-1) DMA Underrun Interrupt enable
    #[inline(always)]
    pub fn dmaudrie_iter(&self) -> impl Iterator<Item = DMAUDRIE_R> + '_ {
        (0..1).map(move |n| DMAUDRIE_R::new(((self.bits >> (n * 0 + 13)) & 1) != 0))
    }
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EN1` field.</div>
    #[inline(always)]
    pub fn en(&mut self, n: u8) -> EN_W<'_, CRrs> {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        EN_W::new(self, n * 0)
    }
    ///Bit 0 - DAC channel1 enable
    #[inline(always)]
    pub fn en1(&mut self) -> EN_W<'_, CRrs> {
        EN_W::new(self, 0)
    }
    ///DAC channel(1-1) output buffer disable
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `BOFF1` field.</div>
    #[inline(always)]
    pub fn boff(&mut self, n: u8) -> BOFF_W<'_, CRrs> {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        BOFF_W::new(self, n * 0 + 1)
    }
    ///Bit 1 - DAC channel1 output buffer disable
    #[inline(always)]
    pub fn boff1(&mut self) -> BOFF_W<'_, CRrs> {
        BOFF_W::new(self, 1)
    }
    ///DAC channel(1-1) trigger enable
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `TEN1` field.</div>
    #[inline(always)]
    pub fn ten(&mut self, n: u8) -> TEN_W<'_, CRrs> {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        TEN_W::new(self, n * 0 + 2)
    }
    ///Bit 2 - DAC channel1 trigger enable
    #[inline(always)]
    pub fn ten1(&mut self) -> TEN_W<'_, CRrs> {
        TEN_W::new(self, 2)
    }
    ///Bits 3:5 - DAC channel1 trigger selection
    #[inline(always)]
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `WAVE1` field.</div>
    #[inline(always)]
    pub fn wave(&mut self, n: u8) -> WAVE_W<'_, CRrs> {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        WAVE_W::new(self, n * 0 + 6)
    }
    ///Bits 6:7 - DAC channel1 noise/triangle wave generation enable
    #[inline(always)]
    pub fn wave1(&mut self) -> WAVE_W<'_, CRrs> {
        WAVE_W::new(self, 6)
    }
    ///DAC channel(1-1) mask/amplitude selector
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `MAMP1` field.</div>
    #[inline(always)]
    pub fn mamp(&mut self, n: u8) -> MAMP_W<'_, CRrs> {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        MAMP_W::new(self, n * 0 + 8)
    }
    ///Bits 8:11 - DAC channel1 mask/amplitude selector
    #[inline(always)]
    pub fn mamp1(&mut self) -> MAMP_W<'_, CRrs> {
        MAMP_W::new(self, 8)
    }
    ///DAC channel(1-1) DMA enable
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DMAEN1` field.</div>
    #[inline(always)]
    pub fn dmaen(&mut self, n: u8) -> DMAEN_W<'_, CRrs> {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        DMAEN_W::new(self, n * 0 + 12)
    }
    ///Bit 12 - DAC channel1 DMA enable
    #[inline(always)]
    pub fn dmaen1(&mut self) -> DMAEN_W<'_, CRrs> {
        DMAEN_W::new(self, 12)
    }
    ///DAC channel(1-1) DMA Underrun Interrupt enable
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DMAUDRIE1` field.</div>
    #[inline(always)]
    pub fn dmaudrie(&mut self, n: u8) -> DMAUDRIE_W<'_, CRrs> {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
        DMAUDRIE_W::new(self, n * 0 + 13)
    }
    ///Bit 13 - DAC channel1 DMA Underrun Interrupt enable
    #[inline(always)]
    pub fn dmaudrie1(&mut self) -> DMAUDRIE_W<'_, CRrs> {
