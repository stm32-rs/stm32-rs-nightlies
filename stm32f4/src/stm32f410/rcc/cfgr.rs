...
impl From<MCO1EN> for bool {
    #[inline(always)]
    fn from(variant: MCO1EN) -> Self {
        variant as u8 != 0
    }
}
///Field `MCO1EN` reader - MCO output enable
pub type MCO1EN_R = crate::BitReader<MCO1EN>;
impl MCO1EN_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> MCO1EN {
        match self.bits {
            false => MCO1EN::Disabled,
            true => MCO1EN::Enabled,
        }
    }
    ///MCO output disabled
...
pub type MCO1EN_W<'a, REG> = crate::BitWriter<'a, REG, MCO1EN>;
impl<'a, REG> MCO1EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///MCO output disabled
    ...
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(MCO1EN::Disabled)
    }
    ///MCO output enabled
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(MCO1EN::Enabled)
    }
}
...
impl W {
    ...
    ///Bit 8 - MCO output enable
    #[inline(always)]
    pub fn mco1en(&mut self) -> MCO1EN_W<'_, CFGRrs> {
        MCO1EN_W::new(self, 8)
    }
    ///Bit 9 - MCO output enable
    #[inline(always)]
    pub fn mco2en(&mut self) -> MCO2EN_W<'_, CFGRrs> {
        MCO2EN_W::new(self, 9)
    }
    ///Bits 10:12 - APB Low speed prescaler (APB1)
    #[inline(always)]
