...
impl JEXTSEL_R {
    ...
    pub const fn variant(&self) -> Option<JEXTSEL> {
        match self.bits {
            0 => Some(JEXTSEL::Tim1cc4),
            1 => Some(JEXTSEL::Tim1trgo),
            2 => Some(JEXTSEL::Tim2cc1),
            3 => Some(JEXTSEL::Tim2trgo),
            4 => Some(JEXTSEL::Tim3cc2),
            5 => Some(JEXTSEL::Tim3cc4),
            6 => Some(JEXTSEL::Tim4cc1),
            7 => Some(JEXTSEL::Tim4cc2),
            8 => Some(JEXTSEL::Tim4cc3),
            9 => Some(JEXTSEL::Tim4trgo),
            10 => Some(JEXTSEL::Tim5cc4),
            11 => Some(JEXTSEL::Tim5trgo),
            15 => Some(JEXTSEL::Exti15),
            _ => None,
        }
    }
    ///Timer 1 CC4 event
...
impl EXTSEL_R {
    ...
    pub const fn variant(&self) -> Option<EXTSEL> {
        match self.bits {
            ...
            4 => Some(EXTSEL::Tim2cc3),
            5 => Some(EXTSEL::Tim2cc4),
            6 => Some(EXTSEL::Tim2trgo),
            7 => Some(EXTSEL::Tim3cc1),
            8 => Some(EXTSEL::Tim3trgo),
            9 => Some(EXTSEL::Tim4cc4),
            10 => Some(EXTSEL::Tim5cc1),
            11 => Some(EXTSEL::Tim5cc2),
            12 => Some(EXTSEL::Tim5cc3),
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F411.html#ADC1:CR2)*/
pub struct CR2rs;
