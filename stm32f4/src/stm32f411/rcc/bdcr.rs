...
///Field `LSEMOD` reader - External low speed oscillator
...
///Field `LSEMOD` writer - External low speed oscillator
...
impl R {
    ...
    ///Bit 3 - External low speed oscillator
    #[inline(always)]
...
impl W {
    ...
    ///Bit 3 - External low speed oscillator
    #[inline(always)]
    pub fn lsemod(&mut self) -> LSEMOD_W<'_, BDCRrs> {
        LSEMOD_W::new(self, 3)
    }
    ///Bits 8:9 - RTC clock source selection
    #[inline(always)]
