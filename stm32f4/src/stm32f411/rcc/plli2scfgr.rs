...
///Field `PLLI2SM` reader - Division factor for the audio PLL (PLLI2S) input clock
pub type PLLI2SM_R = crate::FieldReader;
///Field `PLLI2SM` writer - Division factor for the audio PLL (PLLI2S) input clock
...
impl R {
    ///Bits 0:5 - Division factor for the audio PLL (PLLI2S) input clock
    #[inline(always)]
