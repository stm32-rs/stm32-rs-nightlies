...
impl W {
    ///Bit 0 - DCDET
    #[inline(always)]
    pub fn dcdet(&mut self) -> DCDET_W<'_, GCCFGrs> {
        DCDET_W::new(self, 0)
    }
    ///Bit 1 - PDET
    #[inline(always)]
    pub fn pdet(&mut self) -> PDET_W<'_, GCCFGrs> {
        PDET_W::new(self, 1)
    }
    ///Bit 2 - SDET
    #[inline(always)]
    pub fn sdet(&mut self) -> SDET_W<'_, GCCFGrs> {
        SDET_W::new(self, 2)
    }
    ///Bit 3 - PS2DET
    #[inline(always)]
    pub fn ps2det(&mut self) -> PS2DET_W<'_, GCCFGrs> {
        PS2DET_W::new(self, 3)
    }
    ///Bit 16 - PWRDWN
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F412.html#OTG_FS_GLOBAL:GCCFG)*/
pub struct GCCFGrs;
