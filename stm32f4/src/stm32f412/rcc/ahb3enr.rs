...
///Field `FSMCEN` reader - Flexible memory controller module clock enable
...
///Field `FSMCEN` writer - Flexible memory controller module clock enable
...
///Field `QSPIEN` reader - QUADSPI memory controller module clock enable
pub use FSMCEN_R as QSPIEN_R;
///Field `QSPIEN` writer - QUADSPI memory controller module clock enable
