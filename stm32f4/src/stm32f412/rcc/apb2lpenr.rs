...
///Field `EXTITEN` reader - EXTIT APB and SYSCTRL PFREE clock enable during Sleep mode
pub type EXTITEN_R = crate::BitReader;
///Field `EXTITEN` writer - EXTIT APB and SYSCTRL PFREE clock enable during Sleep mode
pub type EXTITEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    ///Bit 15 - EXTIT APB and SYSCTRL PFREE clock enable during Sleep mode
    #[inline(always)]
    pub fn extiten(&mut self) -> EXTITEN_W<'_, APB2LPENRrs> {
