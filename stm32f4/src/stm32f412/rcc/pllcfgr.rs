...
///Field `PLLM` reader - Division factor for the main PLL (PLL) input clock
pub type PLLM_R = crate::FieldReader;
///Field `PLLM` writer - Division factor for the main PLL (PLL) input clock
...
impl R {
    ///Bits 0:5 - Division factor for the main PLL (PLL) input clock
    #[inline(always)]
