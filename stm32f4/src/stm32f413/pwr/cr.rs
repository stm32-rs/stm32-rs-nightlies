...
///Field `LPLVDS` reader - Main regulator Low Voltage in Deep Sleep
...
///Field `LPLVDS` writer - Main regulator Low Voltage in Deep Sleep
...
impl R {
    ...
    ///Bit 10 - Main regulator Low Voltage in Deep Sleep
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F413.html#PWR:CR)*/
pub struct CRrs;
