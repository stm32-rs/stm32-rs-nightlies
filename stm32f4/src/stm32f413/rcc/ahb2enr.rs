...
impl From<CRYPEN> for bool {
    #[inline(always)]
    fn from(variant: CRYPEN) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CRYPEN` reader - CRYP clock enable"]
pub type CRYPEN_R = crate::BitReader<CRYPEN>;
impl CRYPEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> CRYPEN {
        match self.bits {
            false => CRYPEN::Disabled,
            true => CRYPEN::Enabled,
        }
    }
...
pub type CRYPEN_W<'a, REG> = crate::BitWriter<'a, REG, CRYPEN>;
impl<'a, REG> CRYPEN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(CRYPEN::Disabled)
    }
    #[doc = "The selected clock is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(CRYPEN::Enabled)
    }
}
