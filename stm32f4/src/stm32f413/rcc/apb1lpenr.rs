...
///Field `LPTIMER1LPEN` reader - TIM14 clock enable during Sleep mode
...
///Field `CAN1LPEN` reader - CAN1LPEN
pub use TIM2LPEN_R as CAN1LPEN_R;
///Field `CAN2LPEN` reader - CAN2LPEN
pub use TIM2LPEN_R as CAN2LPEN_R;
///Field `CAN3LPEN` reader - CAN3 clock enable during Sleep mode
...
///Field `DACLPEN` reader - DAC clock enable during Sleep mode
...
///Field `LPTIMER1LPEN` writer - TIM14 clock enable during Sleep mode
...
///Field `CAN1LPEN` writer - CAN1LPEN
pub use TIM2LPEN_W as CAN1LPEN_W;
///Field `CAN2LPEN` writer - CAN2LPEN
pub use TIM2LPEN_W as CAN2LPEN_W;
///Field `CAN3LPEN` writer - CAN3 clock enable during Sleep mode
...
///Field `DACLPEN` writer - DAC clock enable during Sleep mode
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB1LPENR")
            ...
            .field("lptimer1lpen", &self.lptimer1lpen())
...
impl W {
    ...
    ///Bit 9 - TIM14 clock enable during Sleep mode
    #[inline(always)]
    pub fn lptimer1lpen(&mut self) -> LPTIMER1LPEN_W<'_, APB1LPENRrs> {
        LPTIMER1LPEN_W::new(self, 9)
    }
    ///Bit 10 - RTC APB clock enable during Sleep mode
    #[inline(always)]
    ...
    ///Bit 27 - CAN3 clock enable during Sleep mode
    #[inline(always)]
    pub fn can3lpen(&mut self) -> CAN3LPEN_W<'_, APB1LPENRrs> {
        CAN3LPEN_W::new(self, 27)
    }
    ///Bit 28 - Power interface clock enable during Sleep mode
    #[inline(always)]
    ...
    ///Bit 30 - UART7 clock enable during Sleep mode
    #[inline(always)]
    pub fn uart7lpen(&mut self) -> UART7LPEN_W<'_, APB1LPENRrs> {
        UART7LPEN_W::new(self, 30)
    }
    ///Bit 31 - UART8 clock enable during Sleep mode
    #[inline(always)]
    pub fn uart8lpen(&mut self) -> UART8LPEN_W<'_, APB1LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F413.html#RCC:APB1LPENR)*/
