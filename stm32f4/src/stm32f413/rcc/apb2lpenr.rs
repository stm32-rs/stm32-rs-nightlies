...
impl W {
    ...
    ///Bit 7 - UART10 clock enable during Sleep mode
    #[inline(always)]
    pub fn uart10lpen(&mut self) -> UART10LPEN_W<'_, APB2LPENRrs> {
    ...
    ///Bit 24 - DFSDMLPEN
    #[inline(always)]
    pub fn dfsdmlpen(&mut self) -> DFSDMLPEN_W<'_, APB2LPENRrs> {
        DFSDMLPEN_W::new(self, 24)
    }
    ///Bit 25 - DFSDM2 clock enable during Sleep mode
    #[inline(always)]
    pub fn dfsdm2lpen(&mut self) -> DFSDM2LPEN_W<'_, APB2LPENRrs> {
