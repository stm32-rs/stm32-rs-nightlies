...
///Field `LSEMOD` reader - External low-speed oscillator bypass
...
///Field `LSEMOD` writer - External low-speed oscillator bypass
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F413.html#RCC:BDCR)*/
pub struct BDCRrs;
