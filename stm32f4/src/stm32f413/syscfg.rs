...
impl RegisterBlock {
    ...
    ///0x30 - DFSDM Multi-channel delay control register
    #[inline(always)]
    pub const fn mchdlycr(&self) -> &MCHDLYCR {
        &self.mchdlycr
    }
}
...
pub mod cmpcr;
/**CFGR (rw) register accessor: I2C_BUFOUT
...
For information about available fields see [`mod@mchdlycr`]
module*/
pub type MCHDLYCR = crate::Reg<mchdlycr::MCHDLYCRrs>;
