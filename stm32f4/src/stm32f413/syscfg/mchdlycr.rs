...
pub enum MCHDLYEN1 {
    /**0: Delay clock for DFSDM1 is disabled (G\[2:1\]
    = 0)*/
    Disabled = 0,
    /**1: Delay clock for DFSDM1 is enabled (G\[2:1\]
    = 1)*/
    Enabled = 1,
}
...
impl MCHDLYEN1_R {
    ...
    /**Delay clock for DFSDM1 is disabled (G\[2:1\]
    = 0)*/
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == MCHDLYEN1::Disabled
    }
    /**Delay clock for DFSDM1 is enabled (G\[2:1\]
    = 1)*/
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MCHDLYEN2 {
    /**0: Delay clock for DFSDM2 is disabled (G\[6:3\]
    = 0)*/
    Disabled = 0,
    /**1: Delay clock for DFSDM2 is enabled (G\[6:3\]
    = 1)*/
    Enabled = 1,
}
...
impl MCHDLYEN2_R {
    ...
    /**Delay clock for DFSDM2 is disabled (G\[6:3\]
    = 0)*/
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == MCHDLYEN2::Disabled
    }
    /**Delay clock for DFSDM2 is enabled (G\[6:3\]
    = 1)*/
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
...
impl W {
    ///Bit 0 - Bitstream clock source selection
    #[inline(always)]
    pub fn bscksel(&mut self) -> BSCKSEL_W<MCHDLYCRrs> {
        BSCKSEL_W::new(self, 0)
    }
    ///Bit 1 - MCHDLY clock enable for DFSDM1
    #[inline(always)]
    pub fn mchdlyen1(&mut self) -> MCHDLYEN1_W<MCHDLYCRrs> {
        MCHDLYEN1_W::new(self, 1)
    }
    ///Bit 2 - Source selection for DatIn0 of DFSDM1
    #[inline(always)]
    pub fn dfsdm1_d0sel(&mut self) -> DFSDM1_D0SEL_W<MCHDLYCRrs> {
        DFSDM1_D0SEL_W::new(self, 2)
    }
    ///Bit 3 - Source selection for DatIn2 of DFSDM1
    #[inline(always)]
    pub fn dfsdm1_d2sel(&mut self) -> DFSDM1_D2SEL_W<MCHDLYCRrs> {
        DFSDM1_D2SEL_W::new(self, 3)
    }
    ///Bit 4 - Distribution of the DFSDM1 bitstream clock gated by TIM4 OC2
    #[inline(always)]
    pub fn dfsdm1_ck02sel(&mut self) -> DFSDM1_CK02SEL_W<MCHDLYCRrs> {
        DFSDM1_CK02SEL_W::new(self, 4)
    }
    ///Bit 5 - Distribution of the DFSDM1 bitstream clock gated by TIM4 OC1
    #[inline(always)]
    pub fn dfsdm1_ck13sel(&mut self) -> DFSDM1_CK13SEL_W<MCHDLYCRrs> {
        DFSDM1_CK13SEL_W::new(self, 5)
    }
    ///Bit 6 - CkIn source selection for DFSDM1
    #[inline(always)]
    pub fn dfsdm1_cfg(&mut self) -> DFSDM1_CFG_W<MCHDLYCRrs> {
        DFSDM1_CFG_W::new(self, 6)
    }
    ///Bit 7 - Source selection for DFSDM1_CKOUT
    #[inline(always)]
    pub fn dfsdm1_ckosel(&mut self) -> DFSDM1_CKOSEL_W<MCHDLYCRrs> {
        DFSDM1_CKOSEL_W::new(self, 7)
    }
    ///Bit 8 - MCHDLY clock enable for DFSDM2
    #[inline(always)]
    pub fn mchdlyen2(&mut self) -> MCHDLYEN2_W<MCHDLYCRrs> {
        MCHDLYEN2_W::new(self, 8)
    }
    ///Bit 9 - Source selection for DatIn0 of DFSDM2
    #[inline(always)]
    pub fn dfsdm2_d0sel(&mut self) -> DFSDM2_D0SEL_W<MCHDLYCRrs> {
        DFSDM2_D0SEL_W::new(self, 9)
    }
    ///Bit 10 - Source selection for DatIn2 of DFSDM2
    #[inline(always)]
    pub fn dfsdm2_d2sel(&mut self) -> DFSDM2_D2SEL_W<MCHDLYCRrs> {
        DFSDM2_D2SEL_W::new(self, 10)
    }
    ///Bit 11 - Source selection for DatIn4 of DFSDM2
    #[inline(always)]
    pub fn dfsdm2_d4sel(&mut self) -> DFSDM2_D4SEL_W<MCHDLYCRrs> {
        DFSDM2_D4SEL_W::new(self, 11)
    }
    ///Bit 12 - Source selection for DatIn6 of DFSDM2
    #[inline(always)]
    pub fn dfsdm2_d6sel(&mut self) -> DFSDM2_D6SEL_W<MCHDLYCRrs> {
        DFSDM2_D6SEL_W::new(self, 12)
    }
    ///Bit 13 - Distribution of the DFSDM2 bitstream clock gated by TIM3 OC4
    #[inline(always)]
    pub fn dfsdm2_ck04sel(&mut self) -> DFSDM2_CK04SEL_W<MCHDLYCRrs> {
        DFSDM2_CK04SEL_W::new(self, 13)
    }
    ///Bit 14 - Distribution of the DFSDM2 bitstream clock gated by TIM3 OC3
    #[inline(always)]
    pub fn dfsdm2_ck15sel(&mut self) -> DFSDM2_CK15SEL_W<MCHDLYCRrs> {
        DFSDM2_CK15SEL_W::new(self, 14)
    }
    ///Bit 15 - Distribution of the DFSDM2 bitstream clock gated by TIM3 OC2
    #[inline(always)]
    pub fn dfsdm2_ck26sel(&mut self) -> DFSDM2_CK26SEL_W<MCHDLYCRrs> {
        DFSDM2_CK26SEL_W::new(self, 15)
    }
    ///Bit 16 - Distribution of the DFSDM2 bitstream clock gated by TIM3 OC1
    #[inline(always)]
    pub fn dfsdm2_ck37sel(&mut self) -> DFSDM2_CK37SEL_W<MCHDLYCRrs> {
        DFSDM2_CK37SEL_W::new(self, 16)
    }
    ///Bit 17 - CkIn source selection for DFSDM2
    #[inline(always)]
    pub fn dfsdm2_cfg(&mut self) -> DFSDM2_CFG_W<MCHDLYCRrs> {
        DFSDM2_CFG_W::new(self, 17)
    }
    ///Bit 18 - Source selection for DFSDM2_CKOUT
    #[inline(always)]
    pub fn dfsdm2_ckosel(&mut self) -> DFSDM2_CKOSEL_W<MCHDLYCRrs> {
