...
impl W {
    ///Bit 0 - Filter mode
    #[inline(always)]
    pub fn fbm0(&mut self) -> FBM0_W<'_, FM1Rrs> {
        FBM0_W::new(self, 0)
    }
    ///Bit 1 - Filter mode
    #[inline(always)]
    pub fn fbm1(&mut self) -> FBM1_W<'_, FM1Rrs> {
        FBM1_W::new(self, 1)
    }
    ///Bit 2 - Filter mode
    #[inline(always)]
    pub fn fbm2(&mut self) -> FBM2_W<'_, FM1Rrs> {
        FBM2_W::new(self, 2)
    }
    ///Bit 3 - Filter mode
    #[inline(always)]
    pub fn fbm3(&mut self) -> FBM3_W<'_, FM1Rrs> {
        FBM3_W::new(self, 3)
    }
    ///Bit 4 - Filter mode
    #[inline(always)]
    pub fn fbm4(&mut self) -> FBM4_W<'_, FM1Rrs> {
        FBM4_W::new(self, 4)
    }
    ///Bit 5 - Filter mode
    #[inline(always)]
    pub fn fbm5(&mut self) -> FBM5_W<'_, FM1Rrs> {
        FBM5_W::new(self, 5)
    }
    ///Bit 6 - Filter mode
    #[inline(always)]
    pub fn fbm6(&mut self) -> FBM6_W<'_, FM1Rrs> {
        FBM6_W::new(self, 6)
    }
    ///Bit 7 - Filter mode
    #[inline(always)]
    pub fn fbm7(&mut self) -> FBM7_W<'_, FM1Rrs> {
        FBM7_W::new(self, 7)
    }
    ///Bit 8 - Filter mode
    #[inline(always)]
    pub fn fbm8(&mut self) -> FBM8_W<'_, FM1Rrs> {
        FBM8_W::new(self, 8)
    }
    ///Bit 9 - Filter mode
    #[inline(always)]
    pub fn fbm9(&mut self) -> FBM9_W<'_, FM1Rrs> {
        FBM9_W::new(self, 9)
    }
    ///Bit 10 - Filter mode
    #[inline(always)]
    pub fn fbm10(&mut self) -> FBM10_W<'_, FM1Rrs> {
        FBM10_W::new(self, 10)
    }
    ///Bit 11 - Filter mode
    #[inline(always)]
    pub fn fbm11(&mut self) -> FBM11_W<'_, FM1Rrs> {
        FBM11_W::new(self, 11)
    }
    ///Bit 12 - Filter mode
    #[inline(always)]
    pub fn fbm12(&mut self) -> FBM12_W<'_, FM1Rrs> {
        FBM12_W::new(self, 12)
    }
    ///Bit 13 - Filter mode
    #[inline(always)]
    pub fn fbm13(&mut self) -> FBM13_W<'_, FM1Rrs> {
        FBM13_W::new(self, 13)
    }
    ///Bit 14 - Filter mode
    #[inline(always)]
    pub fn fbm14(&mut self) -> FBM14_W<'_, FM1Rrs> {
        FBM14_W::new(self, 14)
    }
    ///Bit 15 - Filter mode
    #[inline(always)]
    pub fn fbm15(&mut self) -> FBM15_W<'_, FM1Rrs> {
        FBM15_W::new(self, 15)
    }
    ///Bit 16 - Filter mode
    #[inline(always)]
    pub fn fbm16(&mut self) -> FBM16_W<'_, FM1Rrs> {
        FBM16_W::new(self, 16)
    }
    ///Bit 17 - Filter mode
    #[inline(always)]
    pub fn fbm17(&mut self) -> FBM17_W<'_, FM1Rrs> {
        FBM17_W::new(self, 17)
    }
    ///Bit 18 - Filter mode
    #[inline(always)]
    pub fn fbm18(&mut self) -> FBM18_W<'_, FM1Rrs> {
        FBM18_W::new(self, 18)
    }
    ///Bit 19 - Filter mode
    #[inline(always)]
    pub fn fbm19(&mut self) -> FBM19_W<'_, FM1Rrs> {
        FBM19_W::new(self, 19)
    }
    ///Bit 20 - Filter mode
    #[inline(always)]
    pub fn fbm20(&mut self) -> FBM20_W<'_, FM1Rrs> {
        FBM20_W::new(self, 20)
    }
    ///Bit 21 - Filter mode
    #[inline(always)]
    pub fn fbm21(&mut self) -> FBM21_W<'_, FM1Rrs> {
        FBM21_W::new(self, 21)
    }
    ///Bit 22 - Filter mode
    #[inline(always)]
    pub fn fbm22(&mut self) -> FBM22_W<'_, FM1Rrs> {
        FBM22_W::new(self, 22)
    }
    ///Bit 23 - Filter mode
    #[inline(always)]
    pub fn fbm23(&mut self) -> FBM23_W<'_, FM1Rrs> {
        FBM23_W::new(self, 23)
    }
    ///Bit 24 - Filter mode
    #[inline(always)]
    pub fn fbm24(&mut self) -> FBM24_W<'_, FM1Rrs> {
        FBM24_W::new(self, 24)
    }
    ///Bit 25 - Filter mode
    #[inline(always)]
    pub fn fbm25(&mut self) -> FBM25_W<'_, FM1Rrs> {
        FBM25_W::new(self, 25)
    }
    ///Bit 26 - Filter mode
    #[inline(always)]
    pub fn fbm26(&mut self) -> FBM26_W<'_, FM1Rrs> {
        FBM26_W::new(self, 26)
    }
    ///Bit 27 - Filter mode
    #[inline(always)]
    pub fn fbm27(&mut self) -> FBM27_W<'_, FM1Rrs> {
        FBM27_W::new(self, 27)
    }
}
