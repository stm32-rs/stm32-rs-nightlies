///Register `PCR4` reader
pub type R = crate::R<PCR4rs>;
///Register `PCR4` writer
...
impl W {
    ///Bit 1 - PWAITEN
    #[inline(always)]
    pub fn pwaiten(&mut self) -> PWAITEN_W<'_, PCR4rs> {
        PWAITEN_W::new(self, 1)
    }
    ///Bit 2 - PBKEN
    #[inline(always)]
    pub fn pbken(&mut self) -> PBKEN_W<'_, PCR4rs> {
        PBKEN_W::new(self, 2)
    }
    ///Bit 3 - PTYP
    #[inline(always)]
    pub fn ptyp(&mut self) -> PTYP_W<'_, PCR4rs> {
        PTYP_W::new(self, 3)
    }
    ///Bits 4:5 - PWID
    #[inline(always)]
    pub fn pwid(&mut self) -> PWID_W<'_, PCR4rs> {
        PWID_W::new(self, 4)
    }
    ///Bit 6 - ECCEN
    #[inline(always)]
    pub fn eccen(&mut self) -> ECCEN_W<'_, PCR4rs> {
        ECCEN_W::new(self, 6)
    }
    ///Bits 9:12 - TCLR
    #[inline(always)]
    pub fn tclr(&mut self) -> TCLR_W<'_, PCR4rs> {
        TCLR_W::new(self, 9)
    }
    ///Bits 13:16 - TAR
    #[inline(always)]
    pub fn tar(&mut self) -> TAR_W<'_, PCR4rs> {
        TAR_W::new(self, 13)
    }
    ///Bits 17:19 - ECCPS
    #[inline(always)]
    pub fn eccps(&mut self) -> ECCPS_W<'_, PCR4rs> {
        ECCPS_W::new(self, 17)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#FSMC:PCR4)*/
pub struct PCR4rs;
impl crate::RegisterSpec for PCR4rs {
    type Ux = u32;
}
///`read()` method returns [`pcr4::R`](R) reader structure
impl crate::Readable for PCR4rs {}
///`write(|w| ..)` method takes [`pcr4::W`](W) writer structure
