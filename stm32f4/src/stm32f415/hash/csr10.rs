...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CSR10")
            .field("csr10", &self.csr10())
            .finish()
    }
}
impl W {
    ///Bits 0:31 - CSR10
    #[inline(always)]
    pub fn csr10(&mut self) -> CSR10_W<'_, CSR10rs> {
        CSR10_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#HASH:CSR10)*/
pub struct CSR10rs;
