...
impl W {
    ///Bits 0:6 - Transfer size
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, DIEPTSIZ0rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:20 - Packet count
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, DIEPTSIZ0rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_FS_DEVICE:DIEPTSIZ0)*/
