///Register `FS_HCINTMSK0` reader
pub type R = crate::R<FS_HCINTMSK0rs>;
///Register `FS_HCINTMSK0` writer
pub type W = crate::W<FS_HCINTMSK0rs>;
...
impl W {
    ///Bit 0 - Transfer completed mask
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, FS_HCINTMSK0rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - Channel halted mask
    #[inline(always)]
    pub fn chhm(&mut self) -> CHHM_W<'_, FS_HCINTMSK0rs> {
        CHHM_W::new(self, 1)
    }
    ///Bit 3 - STALL response received interrupt mask
    #[inline(always)]
    pub fn stallm(&mut self) -> STALLM_W<'_, FS_HCINTMSK0rs> {
        STALLM_W::new(self, 3)
    }
    ///Bit 4 - NAK response received interrupt mask
    #[inline(always)]
    pub fn nakm(&mut self) -> NAKM_W<'_, FS_HCINTMSK0rs> {
        NAKM_W::new(self, 4)
    }
    ///Bit 5 - ACK response received/transmitted interrupt mask
    #[inline(always)]
    pub fn ackm(&mut self) -> ACKM_W<'_, FS_HCINTMSK0rs> {
        ACKM_W::new(self, 5)
    }
    ///Bit 6 - response received interrupt mask
    #[inline(always)]
    pub fn nyet(&mut self) -> NYET_W<'_, FS_HCINTMSK0rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - Transaction error mask
    #[inline(always)]
    pub fn txerrm(&mut self) -> TXERRM_W<'_, FS_HCINTMSK0rs> {
        TXERRM_W::new(self, 7)
    }
    ///Bit 8 - Babble error mask
    #[inline(always)]
    pub fn bberrm(&mut self) -> BBERRM_W<'_, FS_HCINTMSK0rs> {
        BBERRM_W::new(self, 8)
    }
    ///Bit 9 - Frame overrun mask
    #[inline(always)]
    pub fn frmorm(&mut self) -> FRMORM_W<'_, FS_HCINTMSK0rs> {
        FRMORM_W::new(self, 9)
    }
    ///Bit 10 - Data toggle error mask
    #[inline(always)]
    pub fn dterrm(&mut self) -> DTERRM_W<'_, FS_HCINTMSK0rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_FS_HOST:FS_HCINTMSK0)*/
pub struct FS_HCINTMSK0rs;
impl crate::RegisterSpec for FS_HCINTMSK0rs {
    type Ux = u32;
}
///`read()` method returns [`fs_hcintmsk0::R`](R) reader structure
impl crate::Readable for FS_HCINTMSK0rs {}
///`write(|w| ..)` method takes [`fs_hcintmsk0::W`](W) writer structure
impl crate::Writable for FS_HCINTMSK0rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_HCINTMSK0 to value 0
impl crate::Resettable for FS_HCINTMSK0rs {}
