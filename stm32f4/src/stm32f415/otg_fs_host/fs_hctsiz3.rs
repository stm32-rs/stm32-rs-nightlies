///Register `FS_HCTSIZ3` reader
pub type R = crate::R<FS_HCTSIZ3rs>;
///Register `FS_HCTSIZ3` writer
pub type W = crate::W<FS_HCTSIZ3rs>;
...
impl W {
    ///Bits 0:18 - Transfer size
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, FS_HCTSIZ3rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - Packet count
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, FS_HCTSIZ3rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - Data PID
    #[inline(always)]
    pub fn dpid(&mut self) -> DPID_W<'_, FS_HCTSIZ3rs> {
        DPID_W::new(self, 29)
    }
}
...
pub struct FS_HCTSIZ3rs;
impl crate::RegisterSpec for FS_HCTSIZ3rs {
    type Ux = u32;
}
///`read()` method returns [`fs_hctsiz3::R`](R) reader structure
impl crate::Readable for FS_HCTSIZ3rs {}
///`write(|w| ..)` method takes [`fs_hctsiz3::W`](W) writer structure
impl crate::Writable for FS_HCTSIZ3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_HCTSIZ3 to value 0
impl crate::Resettable for FS_HCTSIZ3rs {}
