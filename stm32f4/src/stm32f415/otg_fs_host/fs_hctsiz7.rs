///Register `FS_HCTSIZ7` reader
pub type R = crate::R<FS_HCTSIZ7rs>;
///Register `FS_HCTSIZ7` writer
pub type W = crate::W<FS_HCTSIZ7rs>;
...
impl W {
    ///Bits 0:18 - Transfer size
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, FS_HCTSIZ7rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - Packet count
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, FS_HCTSIZ7rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - Data PID
    #[inline(always)]
    pub fn dpid(&mut self) -> DPID_W<'_, FS_HCTSIZ7rs> {
        DPID_W::new(self, 29)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_FS_HOST:FS_HCTSIZ7)*/
pub struct FS_HCTSIZ7rs;
impl crate::RegisterSpec for FS_HCTSIZ7rs {
    type Ux = u32;
}
///`read()` method returns [`fs_hctsiz7::R`](R) reader structure
impl crate::Readable for FS_HCTSIZ7rs {}
///`write(|w| ..)` method takes [`fs_hctsiz7::W`](W) writer structure
impl crate::Writable for FS_HCTSIZ7rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_HCTSIZ7 to value 0
impl crate::Resettable for FS_HCTSIZ7rs {}
