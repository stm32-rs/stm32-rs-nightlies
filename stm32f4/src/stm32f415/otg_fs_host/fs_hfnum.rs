...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_FS_HOST:FS_HFNUM)*/
pub struct FS_HFNUMrs;
impl crate::RegisterSpec for FS_HFNUMrs {
    type Ux = u32;
}
///`read()` method returns [`fs_hfnum::R`](R) reader structure
impl crate::Readable for FS_HFNUMrs {}
///`reset()` method sets FS_HFNUM to value 0x3fff
