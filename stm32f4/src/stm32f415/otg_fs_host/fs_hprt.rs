///Register `FS_HPRT` reader
pub type R = crate::R<FS_HPRTrs>;
///Register `FS_HPRT` writer
...
impl W {
    ///Bit 1 - Port connect detected
    #[inline(always)]
    pub fn pcdet(&mut self) -> PCDET_W<'_, FS_HPRTrs> {
        PCDET_W::new(self, 1)
    }
    ///Bit 2 - Port enable
    #[inline(always)]
    pub fn pena(&mut self) -> PENA_W<'_, FS_HPRTrs> {
        PENA_W::new(self, 2)
    }
    ///Bit 3 - Port enable/disable change
    #[inline(always)]
    pub fn penchng(&mut self) -> PENCHNG_W<'_, FS_HPRTrs> {
        PENCHNG_W::new(self, 3)
    }
    ///Bit 5 - Port overcurrent change
    #[inline(always)]
    pub fn pocchng(&mut self) -> POCCHNG_W<'_, FS_HPRTrs> {
        POCCHNG_W::new(self, 5)
    }
    ///Bit 6 - Port resume
    #[inline(always)]
    pub fn pres(&mut self) -> PRES_W<'_, FS_HPRTrs> {
        PRES_W::new(self, 6)
    }
    ///Bit 7 - Port suspend
    #[inline(always)]
    pub fn psusp(&mut self) -> PSUSP_W<'_, FS_HPRTrs> {
        PSUSP_W::new(self, 7)
    }
    ///Bit 8 - Port reset
    #[inline(always)]
    pub fn prst(&mut self) -> PRST_W<'_, FS_HPRTrs> {
        PRST_W::new(self, 8)
    }
    ///Bit 12 - Port power
    #[inline(always)]
    pub fn ppwr(&mut self) -> PPWR_W<'_, FS_HPRTrs> {
        PPWR_W::new(self, 12)
    }
    ///Bits 13:16 - Port test control
    #[inline(always)]
    pub fn ptctl(&mut self) -> PTCTL_W<'_, FS_HPRTrs> {
        PTCTL_W::new(self, 13)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_FS_HOST:FS_HPRT)*/
pub struct FS_HPRTrs;
impl crate::RegisterSpec for FS_HPRTrs {
    type Ux = u32;
}
///`read()` method returns [`fs_hprt::R`](R) reader structure
impl crate::Readable for FS_HPRTrs {}
///`write(|w| ..)` method takes [`fs_hprt::W`](W) writer structure
impl crate::Writable for FS_HPRTrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_HPRT to value 0
