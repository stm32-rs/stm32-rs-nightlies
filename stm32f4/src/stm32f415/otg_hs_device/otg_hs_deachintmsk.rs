///Register `OTG_HS_DEACHINTMSK` reader
pub type R = crate::R<OTG_HS_DEACHINTMSKrs>;
///Register `OTG_HS_DEACHINTMSK` writer
pub type W = crate::W<OTG_HS_DEACHINTMSKrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_DEACHINTMSK")
...
impl W {
    ///Bit 1 - IN Endpoint 1 interrupt mask bit
    #[inline(always)]
    pub fn iep1intm(&mut self) -> IEP1INTM_W<'_, OTG_HS_DEACHINTMSKrs> {
        IEP1INTM_W::new(self, 1)
    }
    ///Bit 17 - OUT Endpoint 1 interrupt mask bit
    #[inline(always)]
    pub fn oep1intm(&mut self) -> OEP1INTM_W<'_, OTG_HS_DEACHINTMSKrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_HS_DEVICE:OTG_HS_DEACHINTMSK)*/
pub struct OTG_HS_DEACHINTMSKrs;
impl crate::RegisterSpec for OTG_HS_DEACHINTMSKrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_deachintmsk::R`](R) reader structure
impl crate::Readable for OTG_HS_DEACHINTMSKrs {}
///`write(|w| ..)` method takes [`otg_hs_deachintmsk::W`](W) writer structure
impl crate::Writable for OTG_HS_DEACHINTMSKrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DEACHINTMSK to value 0
impl crate::Resettable for OTG_HS_DEACHINTMSKrs {}
