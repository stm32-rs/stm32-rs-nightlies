///Register `OTG_HS_DIEPMSK` reader
pub type R = crate::R<OTG_HS_DIEPMSKrs>;
///Register `OTG_HS_DIEPMSK` writer
pub type W = crate::W<OTG_HS_DIEPMSKrs>;
...
impl W {
    ///Bit 0 - Transfer completed interrupt mask
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, OTG_HS_DIEPMSKrs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - Endpoint disabled interrupt mask
    #[inline(always)]
    pub fn epdm(&mut self) -> EPDM_W<'_, OTG_HS_DIEPMSKrs> {
        EPDM_W::new(self, 1)
    }
    ///Bit 3 - Timeout condition mask (nonisochronous endpoints)
    #[inline(always)]
    pub fn tom(&mut self) -> TOM_W<'_, OTG_HS_DIEPMSKrs> {
        TOM_W::new(self, 3)
    }
    ///Bit 4 - IN token received when TxFIFO empty mask
    #[inline(always)]
    pub fn ittxfemsk(&mut self) -> ITTXFEMSK_W<'_, OTG_HS_DIEPMSKrs> {
        ITTXFEMSK_W::new(self, 4)
    }
    ///Bit 5 - IN token received with EP mismatch mask
    #[inline(always)]
    pub fn inepnmm(&mut self) -> INEPNMM_W<'_, OTG_HS_DIEPMSKrs> {
        INEPNMM_W::new(self, 5)
    }
    ///Bit 6 - IN endpoint NAK effective mask
    #[inline(always)]
    pub fn inepnem(&mut self) -> INEPNEM_W<'_, OTG_HS_DIEPMSKrs> {
        INEPNEM_W::new(self, 6)
    }
    ///Bit 8 - FIFO underrun mask
    #[inline(always)]
    pub fn txfurm(&mut self) -> TXFURM_W<'_, OTG_HS_DIEPMSKrs> {
        TXFURM_W::new(self, 8)
    }
    ///Bit 9 - BNA interrupt mask
    #[inline(always)]
    pub fn bim(&mut self) -> BIM_W<'_, OTG_HS_DIEPMSKrs> {
        BIM_W::new(self, 9)
    }
}
...
pub struct OTG_HS_DIEPMSKrs;
impl crate::RegisterSpec for OTG_HS_DIEPMSKrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_diepmsk::R`](R) reader structure
impl crate::Readable for OTG_HS_DIEPMSKrs {}
///`write(|w| ..)` method takes [`otg_hs_diepmsk::W`](W) writer structure
impl crate::Writable for OTG_HS_DIEPMSKrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DIEPMSK to value 0
impl crate::Resettable for OTG_HS_DIEPMSKrs {}
