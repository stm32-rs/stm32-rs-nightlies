///Register `OTG_HS_DOEPCTL0` reader
pub type R = crate::R<OTG_HS_DOEPCTL0rs>;
///Register `OTG_HS_DOEPCTL0` writer
pub type W = crate::W<OTG_HS_DOEPCTL0rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_DOEPCTL0")
...
impl W {
    ///Bit 20 - Snoop mode
    #[inline(always)]
    pub fn snpm(&mut self) -> SNPM_W<'_, OTG_HS_DOEPCTL0rs> {
        SNPM_W::new(self, 20)
    }
    ///Bit 21 - STALL handshake
    #[inline(always)]
    pub fn stall(&mut self) -> STALL_W<'_, OTG_HS_DOEPCTL0rs> {
        STALL_W::new(self, 21)
    }
    ///Bit 26 - Clear NAK
    #[inline(always)]
    pub fn cnak(&mut self) -> CNAK_W<'_, OTG_HS_DOEPCTL0rs> {
        CNAK_W::new(self, 26)
    }
    ///Bit 27 - Set NAK
    #[inline(always)]
    pub fn snak(&mut self) -> SNAK_W<'_, OTG_HS_DOEPCTL0rs> {
        SNAK_W::new(self, 27)
    }
    ///Bit 31 - Endpoint enable
    #[inline(always)]
    pub fn epena(&mut self) -> EPENA_W<'_, OTG_HS_DOEPCTL0rs> {
        EPENA_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_HS_DEVICE:OTG_HS_DOEPCTL0)*/
pub struct OTG_HS_DOEPCTL0rs;
impl crate::RegisterSpec for OTG_HS_DOEPCTL0rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_doepctl0::R`](R) reader structure
impl crate::Readable for OTG_HS_DOEPCTL0rs {}
///`write(|w| ..)` method takes [`otg_hs_doepctl0::W`](W) writer structure
impl crate::Writable for OTG_HS_DOEPCTL0rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DOEPCTL0 to value 0x8000
impl crate::Resettable for OTG_HS_DOEPCTL0rs {
