///Register `OTG_HS_GINTSTS` reader
pub type R = crate::R<OTG_HS_GINTSTSrs>;
///Register `OTG_HS_GINTSTS` writer
pub type W = crate::W<OTG_HS_GINTSTSrs>;
...
impl W {
    ///Bit 1 - Mode mismatch interrupt
    #[inline(always)]
    pub fn mmis(&mut self) -> MMIS_W<'_, OTG_HS_GINTSTSrs> {
        MMIS_W::new(self, 1)
    }
    ///Bit 3 - Start of frame
    #[inline(always)]
    pub fn sof(&mut self) -> SOF_W<'_, OTG_HS_GINTSTSrs> {
        SOF_W::new(self, 3)
    }
    ///Bit 10 - Early suspend
    #[inline(always)]
    pub fn esusp(&mut self) -> ESUSP_W<'_, OTG_HS_GINTSTSrs> {
        ESUSP_W::new(self, 10)
    }
    ///Bit 11 - USB suspend
    #[inline(always)]
    pub fn usbsusp(&mut self) -> USBSUSP_W<'_, OTG_HS_GINTSTSrs> {
        USBSUSP_W::new(self, 11)
    }
    ///Bit 12 - USB reset
    #[inline(always)]
    pub fn usbrst(&mut self) -> USBRST_W<'_, OTG_HS_GINTSTSrs> {
        USBRST_W::new(self, 12)
    }
    ///Bit 13 - Enumeration done
    #[inline(always)]
    pub fn enumdne(&mut self) -> ENUMDNE_W<'_, OTG_HS_GINTSTSrs> {
        ENUMDNE_W::new(self, 13)
    }
    ///Bit 14 - Isochronous OUT packet dropped interrupt
    #[inline(always)]
    pub fn isoodrp(&mut self) -> ISOODRP_W<'_, OTG_HS_GINTSTSrs> {
        ISOODRP_W::new(self, 14)
    }
    ///Bit 15 - End of periodic frame interrupt
    #[inline(always)]
    pub fn eopf(&mut self) -> EOPF_W<'_, OTG_HS_GINTSTSrs> {
        EOPF_W::new(self, 15)
    }
    ///Bit 20 - Incomplete isochronous IN transfer
    #[inline(always)]
    pub fn iisoixfr(&mut self) -> IISOIXFR_W<'_, OTG_HS_GINTSTSrs> {
        IISOIXFR_W::new(self, 20)
    }
    ///Bit 21 - Incomplete periodic transfer
    #[inline(always)]
    pub fn pxfr_incompisoout(&mut self) -> PXFR_INCOMPISOOUT_W<'_, OTG_HS_GINTSTSrs> {
        PXFR_INCOMPISOOUT_W::new(self, 21)
    }
    ///Bit 22 - Data fetch suspended
    #[inline(always)]
    pub fn datafsusp(&mut self) -> DATAFSUSP_W<'_, OTG_HS_GINTSTSrs> {
        DATAFSUSP_W::new(self, 22)
    }
    ///Bit 28 - Connector ID status change
    #[inline(always)]
    pub fn cidschg(&mut self) -> CIDSCHG_W<'_, OTG_HS_GINTSTSrs> {
        CIDSCHG_W::new(self, 28)
    }
    ///Bit 29 - Disconnect detected interrupt
    #[inline(always)]
    pub fn discint(&mut self) -> DISCINT_W<'_, OTG_HS_GINTSTSrs> {
        DISCINT_W::new(self, 29)
    }
    ///Bit 30 - Session request/new session detected interrupt
    #[inline(always)]
    pub fn srqint(&mut self) -> SRQINT_W<'_, OTG_HS_GINTSTSrs> {
        SRQINT_W::new(self, 30)
    }
    ///Bit 31 - Resume/remote wakeup detected interrupt
    #[inline(always)]
    pub fn wkuint(&mut self) -> WKUINT_W<'_, OTG_HS_GINTSTSrs> {
...
pub struct OTG_HS_GINTSTSrs;
impl crate::RegisterSpec for OTG_HS_GINTSTSrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_gintsts::R`](R) reader structure
impl crate::Readable for OTG_HS_GINTSTSrs {}
///`write(|w| ..)` method takes [`otg_hs_gintsts::W`](W) writer structure
impl crate::Writable for OTG_HS_GINTSTSrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_GINTSTS to value 0x0400_0020
impl crate::Resettable for OTG_HS_GINTSTSrs {
