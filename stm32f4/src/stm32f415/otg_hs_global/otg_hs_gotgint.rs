///Register `OTG_HS_GOTGINT` reader
pub type R = crate::R<OTG_HS_GOTGINTrs>;
///Register `OTG_HS_GOTGINT` writer
pub type W = crate::W<OTG_HS_GOTGINTrs>;
...
impl W {
    ///Bit 2 - Session end detected
    #[inline(always)]
    pub fn sedet(&mut self) -> SEDET_W<'_, OTG_HS_GOTGINTrs> {
        SEDET_W::new(self, 2)
    }
    ///Bit 8 - Session request success status change
    #[inline(always)]
    pub fn srsschg(&mut self) -> SRSSCHG_W<'_, OTG_HS_GOTGINTrs> {
        SRSSCHG_W::new(self, 8)
    }
    ///Bit 9 - Host negotiation success status change
    #[inline(always)]
    pub fn hnsschg(&mut self) -> HNSSCHG_W<'_, OTG_HS_GOTGINTrs> {
        HNSSCHG_W::new(self, 9)
    }
    ///Bit 17 - Host negotiation detected
    #[inline(always)]
    pub fn hngdet(&mut self) -> HNGDET_W<'_, OTG_HS_GOTGINTrs> {
        HNGDET_W::new(self, 17)
    }
    ///Bit 18 - A-device timeout change
    #[inline(always)]
    pub fn adtochg(&mut self) -> ADTOCHG_W<'_, OTG_HS_GOTGINTrs> {
        ADTOCHG_W::new(self, 18)
    }
    ///Bit 19 - Debounce done
    #[inline(always)]
    pub fn dbcdne(&mut self) -> DBCDNE_W<'_, OTG_HS_GOTGINTrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_HS_GLOBAL:OTG_HS_GOTGINT)*/
pub struct OTG_HS_GOTGINTrs;
impl crate::RegisterSpec for OTG_HS_GOTGINTrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_gotgint::R`](R) reader structure
impl crate::Readable for OTG_HS_GOTGINTrs {}
///`write(|w| ..)` method takes [`otg_hs_gotgint::W`](W) writer structure
impl crate::Writable for OTG_HS_GOTGINTrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_GOTGINT to value 0
impl crate::Resettable for OTG_HS_GOTGINTrs {}
