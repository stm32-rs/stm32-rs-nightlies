///Register `OTG_HS_GRXSTSR_Host` reader
pub type R = crate::R<OTG_HS_GRXSTSR_HOSTrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_GRXSTSR_Host")
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_HS_GLOBAL:OTG_HS_GRXSTSR_Host)*/
pub struct OTG_HS_GRXSTSR_HOSTrs;
impl crate::RegisterSpec for OTG_HS_GRXSTSR_HOSTrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_grxstsr_host::R`](R) reader structure
impl crate::Readable for OTG_HS_GRXSTSR_HOSTrs {}
///`reset()` method sets OTG_HS_GRXSTSR_Host to value 0
impl crate::Resettable for OTG_HS_GRXSTSR_HOSTrs {}
