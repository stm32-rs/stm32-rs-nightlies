///Register `OTG_HS_HCINTMSK9` reader
pub type R = crate::R<OTG_HS_HCINTMSK9rs>;
///Register `OTG_HS_HCINTMSK9` writer
pub type W = crate::W<OTG_HS_HCINTMSK9rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_HCINTMSK9")
...
impl W {
    ///Bit 0 - Transfer completed mask
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, OTG_HS_HCINTMSK9rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - Channel halted mask
    #[inline(always)]
    pub fn chhm(&mut self) -> CHHM_W<'_, OTG_HS_HCINTMSK9rs> {
        CHHM_W::new(self, 1)
    }
    ///Bit 2 - AHB error
    #[inline(always)]
    pub fn ahberr(&mut self) -> AHBERR_W<'_, OTG_HS_HCINTMSK9rs> {
        AHBERR_W::new(self, 2)
    }
    ///Bit 3 - STALL response received interrupt mask
    #[inline(always)]
    pub fn stallm(&mut self) -> STALLM_W<'_, OTG_HS_HCINTMSK9rs> {
        STALLM_W::new(self, 3)
    }
    ///Bit 4 - NAK response received interrupt mask
    #[inline(always)]
    pub fn nakm(&mut self) -> NAKM_W<'_, OTG_HS_HCINTMSK9rs> {
        NAKM_W::new(self, 4)
    }
    ///Bit 5 - ACK response received/transmitted interrupt mask
    #[inline(always)]
    pub fn ackm(&mut self) -> ACKM_W<'_, OTG_HS_HCINTMSK9rs> {
        ACKM_W::new(self, 5)
    }
    ///Bit 6 - response received interrupt mask
    #[inline(always)]
    pub fn nyet(&mut self) -> NYET_W<'_, OTG_HS_HCINTMSK9rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - Transaction error mask
    #[inline(always)]
    pub fn txerrm(&mut self) -> TXERRM_W<'_, OTG_HS_HCINTMSK9rs> {
        TXERRM_W::new(self, 7)
    }
    ///Bit 8 - Babble error mask
    #[inline(always)]
    pub fn bberrm(&mut self) -> BBERRM_W<'_, OTG_HS_HCINTMSK9rs> {
        BBERRM_W::new(self, 8)
    }
    ///Bit 9 - Frame overrun mask
    #[inline(always)]
    pub fn frmorm(&mut self) -> FRMORM_W<'_, OTG_HS_HCINTMSK9rs> {
        FRMORM_W::new(self, 9)
    }
    ///Bit 10 - Data toggle error mask
    #[inline(always)]
    pub fn dterrm(&mut self) -> DTERRM_W<'_, OTG_HS_HCINTMSK9rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F415.html#OTG_HS_HOST:OTG_HS_HCINTMSK9)*/
pub struct OTG_HS_HCINTMSK9rs;
impl crate::RegisterSpec for OTG_HS_HCINTMSK9rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_hcintmsk9::R`](R) reader structure
impl crate::Readable for OTG_HS_HCINTMSK9rs {}
///`write(|w| ..)` method takes [`otg_hs_hcintmsk9::W`](W) writer structure
impl crate::Writable for OTG_HS_HCINTMSK9rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_HCINTMSK9 to value 0
impl crate::Resettable for OTG_HS_HCINTMSK9rs {}
