...
impl W {
    ///Bit 0 - Filter FIFO assignment for filter 0
    #[inline(always)]
    pub fn ffa0(&mut self) -> FFA0_W<'_, FFA1Rrs> {
        FFA0_W::new(self, 0)
    }
    ///Bit 1 - Filter FIFO assignment for filter 1
    #[inline(always)]
    pub fn ffa1(&mut self) -> FFA1_W<'_, FFA1Rrs> {
        FFA1_W::new(self, 1)
    }
    ///Bit 2 - Filter FIFO assignment for filter 2
    #[inline(always)]
    pub fn ffa2(&mut self) -> FFA2_W<'_, FFA1Rrs> {
        FFA2_W::new(self, 2)
    }
    ///Bit 3 - Filter FIFO assignment for filter 3
    #[inline(always)]
    pub fn ffa3(&mut self) -> FFA3_W<'_, FFA1Rrs> {
        FFA3_W::new(self, 3)
    }
    ///Bit 4 - Filter FIFO assignment for filter 4
    #[inline(always)]
    pub fn ffa4(&mut self) -> FFA4_W<'_, FFA1Rrs> {
        FFA4_W::new(self, 4)
    }
    ///Bit 5 - Filter FIFO assignment for filter 5
    #[inline(always)]
    pub fn ffa5(&mut self) -> FFA5_W<'_, FFA1Rrs> {
        FFA5_W::new(self, 5)
    }
    ///Bit 6 - Filter FIFO assignment for filter 6
    #[inline(always)]
    pub fn ffa6(&mut self) -> FFA6_W<'_, FFA1Rrs> {
        FFA6_W::new(self, 6)
    }
    ///Bit 7 - Filter FIFO assignment for filter 7
    #[inline(always)]
    pub fn ffa7(&mut self) -> FFA7_W<'_, FFA1Rrs> {
        FFA7_W::new(self, 7)
    }
    ///Bit 8 - Filter FIFO assignment for filter 8
    #[inline(always)]
    pub fn ffa8(&mut self) -> FFA8_W<'_, FFA1Rrs> {
        FFA8_W::new(self, 8)
    }
    ///Bit 9 - Filter FIFO assignment for filter 9
    #[inline(always)]
    pub fn ffa9(&mut self) -> FFA9_W<'_, FFA1Rrs> {
        FFA9_W::new(self, 9)
    }
    ///Bit 10 - Filter FIFO assignment for filter 10
    #[inline(always)]
    pub fn ffa10(&mut self) -> FFA10_W<'_, FFA1Rrs> {
        FFA10_W::new(self, 10)
    }
    ///Bit 11 - Filter FIFO assignment for filter 11
    #[inline(always)]
    pub fn ffa11(&mut self) -> FFA11_W<'_, FFA1Rrs> {
        FFA11_W::new(self, 11)
    }
    ///Bit 12 - Filter FIFO assignment for filter 12
    #[inline(always)]
    pub fn ffa12(&mut self) -> FFA12_W<'_, FFA1Rrs> {
        FFA12_W::new(self, 12)
    }
    ///Bit 13 - Filter FIFO assignment for filter 13
    #[inline(always)]
    pub fn ffa13(&mut self) -> FFA13_W<'_, FFA1Rrs> {
        FFA13_W::new(self, 13)
    }
    ///Bit 14 - Filter FIFO assignment for filter 14
    #[inline(always)]
    pub fn ffa14(&mut self) -> FFA14_W<'_, FFA1Rrs> {
        FFA14_W::new(self, 14)
    }
    ///Bit 15 - Filter FIFO assignment for filter 15
    #[inline(always)]
    pub fn ffa15(&mut self) -> FFA15_W<'_, FFA1Rrs> {
        FFA15_W::new(self, 15)
    }
    ///Bit 16 - Filter FIFO assignment for filter 16
    #[inline(always)]
    pub fn ffa16(&mut self) -> FFA16_W<'_, FFA1Rrs> {
        FFA16_W::new(self, 16)
    }
    ///Bit 17 - Filter FIFO assignment for filter 17
    #[inline(always)]
    pub fn ffa17(&mut self) -> FFA17_W<'_, FFA1Rrs> {
        FFA17_W::new(self, 17)
    }
    ///Bit 18 - Filter FIFO assignment for filter 18
    #[inline(always)]
    pub fn ffa18(&mut self) -> FFA18_W<'_, FFA1Rrs> {
        FFA18_W::new(self, 18)
    }
    ///Bit 19 - Filter FIFO assignment for filter 19
    #[inline(always)]
    pub fn ffa19(&mut self) -> FFA19_W<'_, FFA1Rrs> {
        FFA19_W::new(self, 19)
    }
    ///Bit 20 - Filter FIFO assignment for filter 20
    #[inline(always)]
    pub fn ffa20(&mut self) -> FFA20_W<'_, FFA1Rrs> {
        FFA20_W::new(self, 20)
    }
    ///Bit 21 - Filter FIFO assignment for filter 21
    #[inline(always)]
    pub fn ffa21(&mut self) -> FFA21_W<'_, FFA1Rrs> {
        FFA21_W::new(self, 21)
    }
    ///Bit 22 - Filter FIFO assignment for filter 22
    #[inline(always)]
    pub fn ffa22(&mut self) -> FFA22_W<'_, FFA1Rrs> {
        FFA22_W::new(self, 22)
    }
    ///Bit 23 - Filter FIFO assignment for filter 23
    #[inline(always)]
    pub fn ffa23(&mut self) -> FFA23_W<'_, FFA1Rrs> {
        FFA23_W::new(self, 23)
    }
    ///Bit 24 - Filter FIFO assignment for filter 24
    #[inline(always)]
    pub fn ffa24(&mut self) -> FFA24_W<'_, FFA1Rrs> {
        FFA24_W::new(self, 24)
    }
    ///Bit 25 - Filter FIFO assignment for filter 25
    #[inline(always)]
    pub fn ffa25(&mut self) -> FFA25_W<'_, FFA1Rrs> {
        FFA25_W::new(self, 25)
    }
    ///Bit 26 - Filter FIFO assignment for filter 26
    #[inline(always)]
    pub fn ffa26(&mut self) -> FFA26_W<'_, FFA1Rrs> {
        FFA26_W::new(self, 26)
    }
    ///Bit 27 - Filter FIFO assignment for filter 27
    #[inline(always)]
    pub fn ffa27(&mut self) -> FFA27_W<'_, FFA1Rrs> {
        FFA27_W::new(self, 27)
    }
}
