...
impl W {
    ///Bit 0 - b192
    #[inline(always)]
    pub fn b192(&mut self) -> B192_W<'_, K0RRrs> {
        B192_W::new(self, 0)
    }
    ///Bit 1 - b193
    #[inline(always)]
    pub fn b193(&mut self) -> B193_W<'_, K0RRrs> {
        B193_W::new(self, 1)
    }
    ///Bit 2 - b194
    #[inline(always)]
    pub fn b194(&mut self) -> B194_W<'_, K0RRrs> {
        B194_W::new(self, 2)
    }
    ///Bit 3 - b195
    #[inline(always)]
    pub fn b195(&mut self) -> B195_W<'_, K0RRrs> {
        B195_W::new(self, 3)
    }
    ///Bit 4 - b196
    #[inline(always)]
    pub fn b196(&mut self) -> B196_W<'_, K0RRrs> {
        B196_W::new(self, 4)
    }
    ///Bit 5 - b197
    #[inline(always)]
    pub fn b197(&mut self) -> B197_W<'_, K0RRrs> {
        B197_W::new(self, 5)
    }
    ///Bit 6 - b198
    #[inline(always)]
    pub fn b198(&mut self) -> B198_W<'_, K0RRrs> {
        B198_W::new(self, 6)
    }
    ///Bit 7 - b199
    #[inline(always)]
    pub fn b199(&mut self) -> B199_W<'_, K0RRrs> {
        B199_W::new(self, 7)
    }
    ///Bit 8 - b200
    #[inline(always)]
    pub fn b200(&mut self) -> B200_W<'_, K0RRrs> {
        B200_W::new(self, 8)
    }
    ///Bit 9 - b201
    #[inline(always)]
    pub fn b201(&mut self) -> B201_W<'_, K0RRrs> {
        B201_W::new(self, 9)
    }
    ///Bit 10 - b202
    #[inline(always)]
    pub fn b202(&mut self) -> B202_W<'_, K0RRrs> {
        B202_W::new(self, 10)
    }
    ///Bit 11 - b203
    #[inline(always)]
    pub fn b203(&mut self) -> B203_W<'_, K0RRrs> {
        B203_W::new(self, 11)
    }
    ///Bit 12 - b204
    #[inline(always)]
    pub fn b204(&mut self) -> B204_W<'_, K0RRrs> {
        B204_W::new(self, 12)
    }
    ///Bit 13 - b205
    #[inline(always)]
    pub fn b205(&mut self) -> B205_W<'_, K0RRrs> {
        B205_W::new(self, 13)
    }
    ///Bit 14 - b206
    #[inline(always)]
    pub fn b206(&mut self) -> B206_W<'_, K0RRrs> {
        B206_W::new(self, 14)
    }
    ///Bit 15 - b207
    #[inline(always)]
    pub fn b207(&mut self) -> B207_W<'_, K0RRrs> {
        B207_W::new(self, 15)
    }
    ///Bit 16 - b208
    #[inline(always)]
    pub fn b208(&mut self) -> B208_W<'_, K0RRrs> {
        B208_W::new(self, 16)
    }
    ///Bit 17 - b209
    #[inline(always)]
    pub fn b209(&mut self) -> B209_W<'_, K0RRrs> {
        B209_W::new(self, 17)
    }
    ///Bit 18 - b210
    #[inline(always)]
    pub fn b210(&mut self) -> B210_W<'_, K0RRrs> {
        B210_W::new(self, 18)
    }
    ///Bit 19 - b211
    #[inline(always)]
    pub fn b211(&mut self) -> B211_W<'_, K0RRrs> {
        B211_W::new(self, 19)
    }
    ///Bit 20 - b212
    #[inline(always)]
    pub fn b212(&mut self) -> B212_W<'_, K0RRrs> {
        B212_W::new(self, 20)
    }
    ///Bit 21 - b213
    #[inline(always)]
    pub fn b213(&mut self) -> B213_W<'_, K0RRrs> {
        B213_W::new(self, 21)
    }
    ///Bit 22 - b214
    #[inline(always)]
    pub fn b214(&mut self) -> B214_W<'_, K0RRrs> {
        B214_W::new(self, 22)
    }
    ///Bit 23 - b215
    #[inline(always)]
    pub fn b215(&mut self) -> B215_W<'_, K0RRrs> {
        B215_W::new(self, 23)
    }
    ///Bit 24 - b216
    #[inline(always)]
    pub fn b216(&mut self) -> B216_W<'_, K0RRrs> {
        B216_W::new(self, 24)
    }
    ///Bit 25 - b217
    #[inline(always)]
    pub fn b217(&mut self) -> B217_W<'_, K0RRrs> {
        B217_W::new(self, 25)
    }
    ///Bit 26 - b218
    #[inline(always)]
    pub fn b218(&mut self) -> B218_W<'_, K0RRrs> {
        B218_W::new(self, 26)
    }
    ///Bit 27 - b219
    #[inline(always)]
    pub fn b219(&mut self) -> B219_W<'_, K0RRrs> {
        B219_W::new(self, 27)
    }
    ///Bit 28 - b220
    #[inline(always)]
    pub fn b220(&mut self) -> B220_W<'_, K0RRrs> {
        B220_W::new(self, 28)
    }
    ///Bit 29 - b221
    #[inline(always)]
    pub fn b221(&mut self) -> B221_W<'_, K0RRrs> {
        B221_W::new(self, 29)
    }
    ///Bit 30 - b222
    #[inline(always)]
    pub fn b222(&mut self) -> B222_W<'_, K0RRrs> {
        B222_W::new(self, 30)
    }
    ///Bit 31 - b223
    #[inline(always)]
    pub fn b223(&mut self) -> B223_W<'_, K0RRrs> {
        B223_W::new(self, 31)
    }
}
/**key registers
