///Register `S3FCR` reader
pub type R = crate::R<S3FCRrs>;
///Register `S3FCR` writer
pub type W = crate::W<S3FCRrs>;
...
impl W {
    ///Bits 0:1 - FIFO threshold selection
    #[inline(always)]
    pub fn fth(&mut self) -> FTH_W<'_, S3FCRrs> {
        FTH_W::new(self, 0)
    }
    ///Bit 2 - Direct mode disable
    #[inline(always)]
    pub fn dmdis(&mut self) -> DMDIS_W<'_, S3FCRrs> {
        DMDIS_W::new(self, 2)
    }
    ///Bit 7 - FIFO error interrupt enable
    #[inline(always)]
    pub fn feie(&mut self) -> FEIE_W<'_, S3FCRrs> {
        FEIE_W::new(self, 7)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F417.html#DMA2:S3FCR)*/
pub struct S3FCRrs;
impl crate::RegisterSpec for S3FCRrs {
    type Ux = u32;
}
///`read()` method returns [`s3fcr::R`](R) reader structure
impl crate::Readable for S3FCRrs {}
///`write(|w| ..)` method takes [`s3fcr::W`](W) writer structure
impl crate::Writable for S3FCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets S3FCR to value 0x21
impl crate::Resettable for S3FCRrs {
