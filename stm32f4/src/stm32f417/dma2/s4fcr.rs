///Register `S4FCR` reader
pub type R = crate::R<S4FCRrs>;
///Register `S4FCR` writer
pub type W = crate::W<S4FCRrs>;
...
impl W {
    ///Bits 0:1 - FIFO threshold selection
    #[inline(always)]
    pub fn fth(&mut self) -> FTH_W<'_, S4FCRrs> {
        FTH_W::new(self, 0)
    }
    ///Bit 2 - Direct mode disable
    #[inline(always)]
    pub fn dmdis(&mut self) -> DMDIS_W<'_, S4FCRrs> {
        DMDIS_W::new(self, 2)
    }
    ///Bit 7 - FIFO error interrupt enable
    #[inline(always)]
    pub fn feie(&mut self) -> FEIE_W<'_, S4FCRrs> {
        FEIE_W::new(self, 7)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F417.html#DMA2:S4FCR)*/
pub struct S4FCRrs;
impl crate::RegisterSpec for S4FCRrs {
    type Ux = u32;
}
///`read()` method returns [`s4fcr::R`](R) reader structure
impl crate::Readable for S4FCRrs {}
///`write(|w| ..)` method takes [`s4fcr::W`](W) writer structure
impl crate::Writable for S4FCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets S4FCR to value 0x21
impl crate::Resettable for S4FCRrs {
