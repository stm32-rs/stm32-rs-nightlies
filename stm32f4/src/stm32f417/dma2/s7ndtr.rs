///Register `S7NDTR` reader
pub type R = crate::R<S7NDTRrs>;
///Register `S7NDTR` writer
...
impl W {
    ///Bits 0:15 - Number of data items to transfer
    #[inline(always)]
    pub fn ndt(&mut self) -> NDT_W<'_, S7NDTRrs> {
        NDT_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F417.html#DMA2:S7NDTR)*/
pub struct S7NDTRrs;
impl crate::RegisterSpec for S7NDTRrs {
    type Ux = u32;
}
///`read()` method returns [`s7ndtr::R`](R) reader structure
impl crate::Readable for S7NDTRrs {}
///`write(|w| ..)` method takes [`s7ndtr::W`](W) writer structure
