///Register `DIEPCTL3` reader
pub type R = crate::R<DIEPCTL3rs>;
///Register `DIEPCTL3` writer
...
impl W {
    ///Bits 0:10 - MPSIZ
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MPSIZ_W<'_, DIEPCTL3rs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bit 15 - USBAEP
    #[inline(always)]
    pub fn usbaep(&mut self) -> USBAEP_W<'_, DIEPCTL3rs> {
        USBAEP_W::new(self, 15)
    }
    ///Bits 18:19 - EPTYP
    #[inline(always)]
    pub fn eptyp(&mut self) -> EPTYP_W<'_, DIEPCTL3rs> {
        EPTYP_W::new(self, 18)
    }
    ///Bit 21 - Stall
    #[inline(always)]
    pub fn stall(&mut self) -> STALL_W<'_, DIEPCTL3rs> {
        STALL_W::new(self, 21)
    }
    ///Bits 22:25 - TXFNUM
    #[inline(always)]
    pub fn txfnum(&mut self) -> TXFNUM_W<'_, DIEPCTL3rs> {
        TXFNUM_W::new(self, 22)
    }
    ///Bit 26 - CNAK
    #[inline(always)]
    pub fn cnak(&mut self) -> CNAK_W<'_, DIEPCTL3rs> {
        CNAK_W::new(self, 26)
    }
    ///Bit 27 - SNAK
    #[inline(always)]
    pub fn snak(&mut self) -> SNAK_W<'_, DIEPCTL3rs> {
        SNAK_W::new(self, 27)
    }
    ///Bit 28 - SD0PID/SEVNFRM
    #[inline(always)]
    pub fn sd0pid_sevnfrm(&mut self) -> SD0PID_SEVNFRM_W<'_, DIEPCTL3rs> {
        SD0PID_SEVNFRM_W::new(self, 28)
    }
    ///Bit 29 - SODDFRM
    #[inline(always)]
    pub fn soddfrm(&mut self) -> SODDFRM_W<'_, DIEPCTL3rs> {
        SODDFRM_W::new(self, 29)
    }
    ///Bit 30 - EPDIS
    #[inline(always)]
    pub fn epdis(&mut self) -> EPDIS_W<'_, DIEPCTL3rs> {
        EPDIS_W::new(self, 30)
    }
    ///Bit 31 - EPENA
    #[inline(always)]
    pub fn epena(&mut self) -> EPENA_W<'_, DIEPCTL3rs> {
        EPENA_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F417.html#OTG_FS_DEVICE:DIEPCTL3)*/
pub struct DIEPCTL3rs;
impl crate::RegisterSpec for DIEPCTL3rs {
    type Ux = u32;
}
///`read()` method returns [`diepctl3::R`](R) reader structure
impl crate::Readable for DIEPCTL3rs {}
///`write(|w| ..)` method takes [`diepctl3::W`](W) writer structure
