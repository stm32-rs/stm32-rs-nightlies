///Register `DIEPTSIZ2` reader
pub type R = crate::R<DIEPTSIZ2rs>;
///Register `DIEPTSIZ2` writer
...
impl W {
    ///Bits 0:18 - Transfer size
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, DIEPTSIZ2rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - Packet count
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, DIEPTSIZ2rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - Multi count
    #[inline(always)]
    pub fn mcnt(&mut self) -> MCNT_W<'_, DIEPTSIZ2rs> {
        MCNT_W::new(self, 29)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F417.html#OTG_FS_DEVICE:DIEPTSIZ2)*/
pub struct DIEPTSIZ2rs;
impl crate::RegisterSpec for DIEPTSIZ2rs {
    type Ux = u32;
}
///`read()` method returns [`dieptsiz2::R`](R) reader structure
impl crate::Readable for DIEPTSIZ2rs {}
///`write(|w| ..)` method takes [`dieptsiz2::W`](W) writer structure
