///Register `FS_HCTSIZ5` reader
pub type R = crate::R<FS_HCTSIZ5rs>;
///Register `FS_HCTSIZ5` writer
...
impl W {
    ///Bits 0:18 - Transfer size
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, FS_HCTSIZ5rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - Packet count
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, FS_HCTSIZ5rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - Data PID
    #[inline(always)]
    pub fn dpid(&mut self) -> DPID_W<'_, FS_HCTSIZ5rs> {
        DPID_W::new(self, 29)
    }
}
...
///`read()` method returns [`fs_hctsiz5::R`](R) reader structure
impl crate::Readable for FS_HCTSIZ5rs {}
///`write(|w| ..)` method takes [`fs_hctsiz5::W`](W) writer structure
impl crate::Writable for FS_HCTSIZ5rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_HCTSIZ5 to value 0
