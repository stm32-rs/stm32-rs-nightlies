///Register `OTG_HS_DCTL` reader
pub type R = crate::R<OTG_HS_DCTLrs>;
///Register `OTG_HS_DCTL` writer
pub type W = crate::W<OTG_HS_DCTLrs>;
...
impl W {
    ///Bit 0 - Remote wakeup signaling
    #[inline(always)]
    pub fn rwusig(&mut self) -> RWUSIG_W<'_, OTG_HS_DCTLrs> {
        RWUSIG_W::new(self, 0)
    }
    ///Bit 1 - Soft disconnect
    #[inline(always)]
    pub fn sdis(&mut self) -> SDIS_W<'_, OTG_HS_DCTLrs> {
        SDIS_W::new(self, 1)
    }
    ///Bits 4:6 - Test control
    #[inline(always)]
    pub fn tctl(&mut self) -> TCTL_W<'_, OTG_HS_DCTLrs> {
        TCTL_W::new(self, 4)
    }
    ///Bit 7 - Set global IN NAK
    #[inline(always)]
    pub fn sginak(&mut self) -> SGINAK_W<'_, OTG_HS_DCTLrs> {
        SGINAK_W::new(self, 7)
    }
    ///Bit 8 - Clear global IN NAK
    #[inline(always)]
    pub fn cginak(&mut self) -> CGINAK_W<'_, OTG_HS_DCTLrs> {
        CGINAK_W::new(self, 8)
    }
    ///Bit 9 - Set global OUT NAK
    #[inline(always)]
    pub fn sgonak(&mut self) -> SGONAK_W<'_, OTG_HS_DCTLrs> {
        SGONAK_W::new(self, 9)
    }
    ///Bit 10 - Clear global OUT NAK
    #[inline(always)]
    pub fn cgonak(&mut self) -> CGONAK_W<'_, OTG_HS_DCTLrs> {
        CGONAK_W::new(self, 10)
    }
    ///Bit 11 - Power-on programming done
    #[inline(always)]
    pub fn poprgdne(&mut self) -> POPRGDNE_W<'_, OTG_HS_DCTLrs> {
...
pub struct OTG_HS_DCTLrs;
impl crate::RegisterSpec for OTG_HS_DCTLrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_dctl::R`](R) reader structure
impl crate::Readable for OTG_HS_DCTLrs {}
///`write(|w| ..)` method takes [`otg_hs_dctl::W`](W) writer structure
impl crate::Writable for OTG_HS_DCTLrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DCTL to value 0
impl crate::Resettable for OTG_HS_DCTLrs {}
