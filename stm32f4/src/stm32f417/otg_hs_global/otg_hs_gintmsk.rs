///Register `OTG_HS_GINTMSK` reader
pub type R = crate::R<OTG_HS_GINTMSKrs>;
///Register `OTG_HS_GINTMSK` writer
pub type W = crate::W<OTG_HS_GINTMSKrs>;
...
impl W {
    ///Bit 1 - Mode mismatch interrupt mask
    #[inline(always)]
    pub fn mmism(&mut self) -> MMISM_W<'_, OTG_HS_GINTMSKrs> {
        MMISM_W::new(self, 1)
    }
    ///Bit 2 - OTG interrupt mask
    #[inline(always)]
    pub fn otgint(&mut self) -> OTGINT_W<'_, OTG_HS_GINTMSKrs> {
        OTGINT_W::new(self, 2)
    }
    ///Bit 3 - Start of frame mask
    #[inline(always)]
    pub fn sofm(&mut self) -> SOFM_W<'_, OTG_HS_GINTMSKrs> {
        SOFM_W::new(self, 3)
    }
    ///Bit 4 - Receive FIFO nonempty mask
    #[inline(always)]
    pub fn rxflvlm(&mut self) -> RXFLVLM_W<'_, OTG_HS_GINTMSKrs> {
        RXFLVLM_W::new(self, 4)
    }
    ///Bit 5 - Nonperiodic TxFIFO empty mask
    #[inline(always)]
    pub fn nptxfem(&mut self) -> NPTXFEM_W<'_, OTG_HS_GINTMSKrs> {
        NPTXFEM_W::new(self, 5)
    }
    ///Bit 6 - Global nonperiodic IN NAK effective mask
    #[inline(always)]
    pub fn ginakeffm(&mut self) -> GINAKEFFM_W<'_, OTG_HS_GINTMSKrs> {
        GINAKEFFM_W::new(self, 6)
    }
    ///Bit 7 - Global OUT NAK effective mask
    #[inline(always)]
    pub fn gonakeffm(&mut self) -> GONAKEFFM_W<'_, OTG_HS_GINTMSKrs> {
        GONAKEFFM_W::new(self, 7)
    }
    ///Bit 10 - Early suspend mask
    #[inline(always)]
    pub fn esuspm(&mut self) -> ESUSPM_W<'_, OTG_HS_GINTMSKrs> {
        ESUSPM_W::new(self, 10)
    }
    ///Bit 11 - USB suspend mask
    #[inline(always)]
    pub fn usbsuspm(&mut self) -> USBSUSPM_W<'_, OTG_HS_GINTMSKrs> {
        USBSUSPM_W::new(self, 11)
    }
    ///Bit 12 - USB reset mask
    #[inline(always)]
    pub fn usbrst(&mut self) -> USBRST_W<'_, OTG_HS_GINTMSKrs> {
        USBRST_W::new(self, 12)
    }
    ///Bit 13 - Enumeration done mask
    #[inline(always)]
    pub fn enumdnem(&mut self) -> ENUMDNEM_W<'_, OTG_HS_GINTMSKrs> {
        ENUMDNEM_W::new(self, 13)
    }
    ///Bit 14 - Isochronous OUT packet dropped interrupt mask
    #[inline(always)]
    pub fn isoodrpm(&mut self) -> ISOODRPM_W<'_, OTG_HS_GINTMSKrs> {
        ISOODRPM_W::new(self, 14)
    }
    ///Bit 15 - End of periodic frame interrupt mask
    #[inline(always)]
    pub fn eopfm(&mut self) -> EOPFM_W<'_, OTG_HS_GINTMSKrs> {
        EOPFM_W::new(self, 15)
    }
    ///Bit 17 - Endpoint mismatch interrupt mask
    #[inline(always)]
    pub fn epmism(&mut self) -> EPMISM_W<'_, OTG_HS_GINTMSKrs> {
        EPMISM_W::new(self, 17)
    }
    ///Bit 18 - IN endpoints interrupt mask
    #[inline(always)]
    pub fn iepint(&mut self) -> IEPINT_W<'_, OTG_HS_GINTMSKrs> {
        IEPINT_W::new(self, 18)
    }
    ///Bit 19 - OUT endpoints interrupt mask
    #[inline(always)]
    pub fn oepint(&mut self) -> OEPINT_W<'_, OTG_HS_GINTMSKrs> {
        OEPINT_W::new(self, 19)
    }
    ///Bit 20 - Incomplete isochronous IN transfer mask
    #[inline(always)]
    pub fn iisoixfrm(&mut self) -> IISOIXFRM_W<'_, OTG_HS_GINTMSKrs> {
        IISOIXFRM_W::new(self, 20)
    }
    ///Bit 21 - Incomplete periodic transfer mask
    #[inline(always)]
    pub fn pxfrm_iisooxfrm(&mut self) -> PXFRM_IISOOXFRM_W<'_, OTG_HS_GINTMSKrs> {
        PXFRM_IISOOXFRM_W::new(self, 21)
    }
    ///Bit 22 - Data fetch suspended mask
    #[inline(always)]
    pub fn fsuspm(&mut self) -> FSUSPM_W<'_, OTG_HS_GINTMSKrs> {
        FSUSPM_W::new(self, 22)
    }
    ///Bit 25 - Host channels interrupt mask
    #[inline(always)]
    pub fn hcim(&mut self) -> HCIM_W<'_, OTG_HS_GINTMSKrs> {
        HCIM_W::new(self, 25)
    }
    ///Bit 26 - Periodic TxFIFO empty mask
    #[inline(always)]
    pub fn ptxfem(&mut self) -> PTXFEM_W<'_, OTG_HS_GINTMSKrs> {
        PTXFEM_W::new(self, 26)
    }
    ///Bit 28 - Connector ID status change mask
    #[inline(always)]
    pub fn cidschgm(&mut self) -> CIDSCHGM_W<'_, OTG_HS_GINTMSKrs> {
        CIDSCHGM_W::new(self, 28)
    }
    ///Bit 29 - Disconnect detected interrupt mask
    #[inline(always)]
    pub fn discint(&mut self) -> DISCINT_W<'_, OTG_HS_GINTMSKrs> {
        DISCINT_W::new(self, 29)
    }
    ///Bit 30 - Session request/new session detected interrupt mask
    #[inline(always)]
    pub fn srqim(&mut self) -> SRQIM_W<'_, OTG_HS_GINTMSKrs> {
        SRQIM_W::new(self, 30)
    }
    ///Bit 31 - Resume/remote wakeup detected interrupt mask
    #[inline(always)]
    pub fn wuim(&mut self) -> WUIM_W<'_, OTG_HS_GINTMSKrs> {
        WUIM_W::new(self, 31)
    }
}
...
pub struct OTG_HS_GINTMSKrs;
impl crate::RegisterSpec for OTG_HS_GINTMSKrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_gintmsk::R`](R) reader structure
impl crate::Readable for OTG_HS_GINTMSKrs {}
///`write(|w| ..)` method takes [`otg_hs_gintmsk::W`](W) writer structure
impl crate::Writable for OTG_HS_GINTMSKrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_GINTMSK to value 0
impl crate::Resettable for OTG_HS_GINTMSKrs {}
