///Register `OTG_HS_HCSPLT7` reader
pub type R = crate::R<OTG_HS_HCSPLT7rs>;
///Register `OTG_HS_HCSPLT7` writer
pub type W = crate::W<OTG_HS_HCSPLT7rs>;
...
impl W {
    ///Bits 0:6 - Port address
    #[inline(always)]
    pub fn prtaddr(&mut self) -> PRTADDR_W<'_, OTG_HS_HCSPLT7rs> {
        PRTADDR_W::new(self, 0)
    }
    ///Bits 7:13 - Hub address
    #[inline(always)]
    pub fn hubaddr(&mut self) -> HUBADDR_W<'_, OTG_HS_HCSPLT7rs> {
        HUBADDR_W::new(self, 7)
    }
    ///Bits 14:15 - XACTPOS
    #[inline(always)]
    pub fn xactpos(&mut self) -> XACTPOS_W<'_, OTG_HS_HCSPLT7rs> {
        XACTPOS_W::new(self, 14)
    }
    ///Bit 16 - Do complete split
    #[inline(always)]
    pub fn complsplt(&mut self) -> COMPLSPLT_W<'_, OTG_HS_HCSPLT7rs> {
        COMPLSPLT_W::new(self, 16)
    }
    ///Bit 31 - Split enable
    #[inline(always)]
    pub fn spliten(&mut self) -> SPLITEN_W<'_, OTG_HS_HCSPLT7rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F417.html#OTG_HS_HOST:OTG_HS_HCSPLT7)*/
pub struct OTG_HS_HCSPLT7rs;
impl crate::RegisterSpec for OTG_HS_HCSPLT7rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_hcsplt7::R`](R) reader structure
impl crate::Readable for OTG_HS_HCSPLT7rs {}
///`write(|w| ..)` method takes [`otg_hs_hcsplt7::W`](W) writer structure
impl crate::Writable for OTG_HS_HCSPLT7rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_HCSPLT7 to value 0
impl crate::Resettable for OTG_HS_HCSPLT7rs {}
