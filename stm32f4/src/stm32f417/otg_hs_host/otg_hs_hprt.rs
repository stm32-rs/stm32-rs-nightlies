///Register `OTG_HS_HPRT` reader
pub type R = crate::R<OTG_HS_HPRTrs>;
///Register `OTG_HS_HPRT` writer
pub type W = crate::W<OTG_HS_HPRTrs>;
...
impl W {
    ///Bit 1 - Port connect detected
    #[inline(always)]
    pub fn pcdet(&mut self) -> PCDET_W<'_, OTG_HS_HPRTrs> {
        PCDET_W::new(self, 1)
    }
    ///Bit 2 - Port enable
    #[inline(always)]
    pub fn pena(&mut self) -> PENA_W<'_, OTG_HS_HPRTrs> {
        PENA_W::new(self, 2)
    }
    ///Bit 3 - Port enable/disable change
    #[inline(always)]
    pub fn penchng(&mut self) -> PENCHNG_W<'_, OTG_HS_HPRTrs> {
        PENCHNG_W::new(self, 3)
    }
    ///Bit 5 - Port overcurrent change
    #[inline(always)]
    pub fn pocchng(&mut self) -> POCCHNG_W<'_, OTG_HS_HPRTrs> {
        POCCHNG_W::new(self, 5)
    }
    ///Bit 6 - Port resume
    #[inline(always)]
    pub fn pres(&mut self) -> PRES_W<'_, OTG_HS_HPRTrs> {
        PRES_W::new(self, 6)
    }
    ///Bit 7 - Port suspend
    #[inline(always)]
    pub fn psusp(&mut self) -> PSUSP_W<'_, OTG_HS_HPRTrs> {
        PSUSP_W::new(self, 7)
    }
    ///Bit 8 - Port reset
    #[inline(always)]
    pub fn prst(&mut self) -> PRST_W<'_, OTG_HS_HPRTrs> {
        PRST_W::new(self, 8)
    }
    ///Bit 12 - Port power
    #[inline(always)]
    pub fn ppwr(&mut self) -> PPWR_W<'_, OTG_HS_HPRTrs> {
        PPWR_W::new(self, 12)
    }
    ///Bits 13:16 - Port test control
    #[inline(always)]
    pub fn ptctl(&mut self) -> PTCTL_W<'_, OTG_HS_HPRTrs> {
        PTCTL_W::new(self, 13)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F417.html#OTG_HS_HOST:OTG_HS_HPRT)*/
pub struct OTG_HS_HPRTrs;
impl crate::RegisterSpec for OTG_HS_HPRTrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_hprt::R`](R) reader structure
impl crate::Readable for OTG_HS_HPRTrs {}
///`write(|w| ..)` method takes [`otg_hs_hprt::W`](W) writer structure
impl crate::Writable for OTG_HS_HPRTrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_HPRT to value 0
impl crate::Resettable for OTG_HS_HPRTrs {}
