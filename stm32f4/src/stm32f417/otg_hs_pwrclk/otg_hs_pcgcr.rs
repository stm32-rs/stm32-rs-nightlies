///Register `OTG_HS_PCGCR` reader
pub type R = crate::R<OTG_HS_PCGCRrs>;
///Register `OTG_HS_PCGCR` writer
pub type W = crate::W<OTG_HS_PCGCRrs>;
...
impl W {
    ///Bit 0 - Stop PHY clock
    #[inline(always)]
    pub fn stppclk(&mut self) -> STPPCLK_W<'_, OTG_HS_PCGCRrs> {
        STPPCLK_W::new(self, 0)
    }
    ///Bit 1 - Gate HCLK
    #[inline(always)]
    pub fn gatehclk(&mut self) -> GATEHCLK_W<'_, OTG_HS_PCGCRrs> {
        GATEHCLK_W::new(self, 1)
    }
    ///Bit 4 - PHY suspended
    #[inline(always)]
    pub fn physusp(&mut self) -> PHYSUSP_W<'_, OTG_HS_PCGCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F417.html#OTG_HS_PWRCLK:OTG_HS_PCGCR)*/
pub struct OTG_HS_PCGCRrs;
impl crate::RegisterSpec for OTG_HS_PCGCRrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_pcgcr::R`](R) reader structure
impl crate::Readable for OTG_HS_PCGCRrs {}
///`write(|w| ..)` method takes [`otg_hs_pcgcr::W`](W) writer structure
impl crate::Writable for OTG_HS_PCGCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_PCGCR to value 0
impl crate::Resettable for OTG_HS_PCGCRrs {}
