...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MER {
    ///1: Erase activated for bank 1 sectors
    MassErase = 1,
}
...
impl MER_R {
    ...
    ///Erase activated for bank 1 sectors
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MER1 {
    ///1: Erase activated for bank 2 sectors
    MassErase = 1,
}
...
impl MER1_R {
    ...
    ///Erase activated for bank 2 sectors
    #[inline(always)]
    pub fn is_mass_erase(&self) -> bool {
        *self == MER1::MassErase
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F427.html#FLASH:CR)*/
pub struct CRrs;
