...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DB1M {
    ///0: Single bank with contiguous addresses in bank 1
    SingleBank = 0,
    ///1: Dual bank with two banks of 512kB
    DualBank = 1,
}
...
impl DB1M_R {
    ...
    ///Single bank with contiguous addresses in bank 1
    #[inline(always)]
    pub fn is_single_bank(&self) -> bool {
        *self == DB1M::SingleBank
    }
    ///Dual bank with two banks of 512kB
    #[inline(always)]
...
impl W {
    ...
    ///Bit 4 - Dual-bank Boot option byte
    #[inline(always)]
    pub fn bfb2(&mut self) -> BFB2_W<OPTCRrs> {
        BFB2_W::new(self, 4)
    }
    ///Bit 5 - WDG_SW User option bytes
    #[inline(always)]
    ...
    ///Bit 30 - Dual-bank on 1 Mbyte Flash memory devices
    #[inline(always)]
    pub fn db1m(&mut self) -> DB1M_W<OPTCRrs> {
        DB1M_W::new(self, 30)
    }
    ///Bit 31 - Selection of protection mode for nWPRi bits
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F429.html#FLASH:OPTCR)*/
pub struct OPTCRrs;
