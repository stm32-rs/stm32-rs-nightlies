...
impl W {
    ///Bits 0:4 - 13th conversion in regular sequence
    #[inline(always)]
    pub fn sq13(&mut self) -> SQ13_W<'_, SQR1rs> {
        SQ13_W::new(self, 0)
    }
    ///Bits 5:9 - 14th conversion in regular sequence
    #[inline(always)]
    pub fn sq14(&mut self) -> SQ14_W<'_, SQR1rs> {
        SQ14_W::new(self, 5)
    }
    ///Bits 10:14 - 15th conversion in regular sequence
    #[inline(always)]
    pub fn sq15(&mut self) -> SQ15_W<'_, SQR1rs> {
        SQ15_W::new(self, 10)
    }
    ///Bits 15:19 - 16th conversion in regular sequence
    #[inline(always)]
    pub fn sq16(&mut self) -> SQ16_W<'_, SQR1rs> {
        SQ16_W::new(self, 15)
    }
    ///Bits 20:23 - Regular channel sequence length
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#ADC1:SQR1)*/
pub struct SQR1rs;
