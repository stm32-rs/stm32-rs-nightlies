...
pub type R = crate::R<F7R2rs>;
///Register `F7R2` writer
pub type W = crate::W<F7R2rs>;
...
impl W {
    ///Bit 0 - Filter bits
    #[inline(always)]
    pub fn fb0(&mut self) -> FB0_W<'_, F7R2rs> {
        FB0_W::new(self, 0)
    }
    ///Bit 1 - Filter bits
    #[inline(always)]
    pub fn fb1(&mut self) -> FB1_W<'_, F7R2rs> {
        FB1_W::new(self, 1)
    }
    ///Bit 2 - Filter bits
    #[inline(always)]
    pub fn fb2(&mut self) -> FB2_W<'_, F7R2rs> {
        FB2_W::new(self, 2)
    }
    ///Bit 3 - Filter bits
    #[inline(always)]
    pub fn fb3(&mut self) -> FB3_W<'_, F7R2rs> {
        FB3_W::new(self, 3)
    }
    ///Bit 4 - Filter bits
    #[inline(always)]
    pub fn fb4(&mut self) -> FB4_W<'_, F7R2rs> {
        FB4_W::new(self, 4)
    }
    ///Bit 5 - Filter bits
    #[inline(always)]
    pub fn fb5(&mut self) -> FB5_W<'_, F7R2rs> {
        FB5_W::new(self, 5)
    }
    ///Bit 6 - Filter bits
    #[inline(always)]
    pub fn fb6(&mut self) -> FB6_W<'_, F7R2rs> {
        FB6_W::new(self, 6)
    }
    ///Bit 7 - Filter bits
    #[inline(always)]
    pub fn fb7(&mut self) -> FB7_W<'_, F7R2rs> {
        FB7_W::new(self, 7)
    }
    ///Bit 8 - Filter bits
    #[inline(always)]
    pub fn fb8(&mut self) -> FB8_W<'_, F7R2rs> {
        FB8_W::new(self, 8)
    }
    ///Bit 9 - Filter bits
    #[inline(always)]
    pub fn fb9(&mut self) -> FB9_W<'_, F7R2rs> {
        FB9_W::new(self, 9)
    }
    ///Bit 10 - Filter bits
    #[inline(always)]
    pub fn fb10(&mut self) -> FB10_W<'_, F7R2rs> {
        FB10_W::new(self, 10)
    }
    ///Bit 11 - Filter bits
    #[inline(always)]
    pub fn fb11(&mut self) -> FB11_W<'_, F7R2rs> {
        FB11_W::new(self, 11)
    }
    ///Bit 12 - Filter bits
    #[inline(always)]
    pub fn fb12(&mut self) -> FB12_W<'_, F7R2rs> {
        FB12_W::new(self, 12)
    }
    ///Bit 13 - Filter bits
    #[inline(always)]
    pub fn fb13(&mut self) -> FB13_W<'_, F7R2rs> {
        FB13_W::new(self, 13)
    }
    ///Bit 14 - Filter bits
    #[inline(always)]
    pub fn fb14(&mut self) -> FB14_W<'_, F7R2rs> {
        FB14_W::new(self, 14)
    }
    ///Bit 15 - Filter bits
    #[inline(always)]
    pub fn fb15(&mut self) -> FB15_W<'_, F7R2rs> {
        FB15_W::new(self, 15)
    }
    ///Bit 16 - Filter bits
    #[inline(always)]
    pub fn fb16(&mut self) -> FB16_W<'_, F7R2rs> {
        FB16_W::new(self, 16)
    }
    ///Bit 17 - Filter bits
    #[inline(always)]
    pub fn fb17(&mut self) -> FB17_W<'_, F7R2rs> {
        FB17_W::new(self, 17)
    }
    ///Bit 18 - Filter bits
    #[inline(always)]
    pub fn fb18(&mut self) -> FB18_W<'_, F7R2rs> {
        FB18_W::new(self, 18)
    }
    ///Bit 19 - Filter bits
    #[inline(always)]
    pub fn fb19(&mut self) -> FB19_W<'_, F7R2rs> {
        FB19_W::new(self, 19)
    }
    ///Bit 20 - Filter bits
    #[inline(always)]
    pub fn fb20(&mut self) -> FB20_W<'_, F7R2rs> {
        FB20_W::new(self, 20)
    }
    ///Bit 21 - Filter bits
    #[inline(always)]
    pub fn fb21(&mut self) -> FB21_W<'_, F7R2rs> {
        FB21_W::new(self, 21)
    }
    ///Bit 22 - Filter bits
    #[inline(always)]
    pub fn fb22(&mut self) -> FB22_W<'_, F7R2rs> {
        FB22_W::new(self, 22)
    }
    ///Bit 23 - Filter bits
    #[inline(always)]
    pub fn fb23(&mut self) -> FB23_W<'_, F7R2rs> {
        FB23_W::new(self, 23)
    }
    ///Bit 24 - Filter bits
    #[inline(always)]
    pub fn fb24(&mut self) -> FB24_W<'_, F7R2rs> {
        FB24_W::new(self, 24)
    }
    ///Bit 25 - Filter bits
    #[inline(always)]
    pub fn fb25(&mut self) -> FB25_W<'_, F7R2rs> {
        FB25_W::new(self, 25)
    }
    ///Bit 26 - Filter bits
    #[inline(always)]
    pub fn fb26(&mut self) -> FB26_W<'_, F7R2rs> {
        FB26_W::new(self, 26)
    }
    ///Bit 27 - Filter bits
    #[inline(always)]
    pub fn fb27(&mut self) -> FB27_W<'_, F7R2rs> {
        FB27_W::new(self, 27)
    }
    ///Bit 28 - Filter bits
    #[inline(always)]
    pub fn fb28(&mut self) -> FB28_W<'_, F7R2rs> {
        FB28_W::new(self, 28)
    }
    ///Bit 29 - Filter bits
    #[inline(always)]
    pub fn fb29(&mut self) -> FB29_W<'_, F7R2rs> {
        FB29_W::new(self, 29)
    }
    ///Bit 30 - Filter bits
    #[inline(always)]
    pub fn fb30(&mut self) -> FB30_W<'_, F7R2rs> {
        FB30_W::new(self, 30)
    }
    ///Bit 31 - Filter bits
    #[inline(always)]
    pub fn fb31(&mut self) -> FB31_W<'_, F7R2rs> {
        FB31_W::new(self, 31)
    }
}
