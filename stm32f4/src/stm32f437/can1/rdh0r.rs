...
You can [`read`](crate::Reg::read) this register and get [`rdh0r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#CAN1:RDH0R)*/
pub struct RDH0Rrs;
impl crate::RegisterSpec for RDH0Rrs {
    type Ux = u32;
}
///`read()` method returns [`rdh0r::R`](R) reader structure
impl crate::Readable for RDH0Rrs {}
///`reset()` method sets RDH0R to value 0
impl crate::Resettable for RDH0Rrs {}
