///Register `TDH1R` reader
pub type R = crate::R<TDH1Rrs>;
///Register `TDH1R` writer
pub type W = crate::W<TDH1Rrs>;
...
impl W {
    ///Bits 0:7 - DATA4
    #[inline(always)]
    pub fn data4(&mut self) -> DATA4_W<'_, TDH1Rrs> {
        DATA4_W::new(self, 0)
    }
    ///Bits 8:15 - DATA5
    #[inline(always)]
    pub fn data5(&mut self) -> DATA5_W<'_, TDH1Rrs> {
        DATA5_W::new(self, 8)
    }
    ///Bits 16:23 - DATA6
    #[inline(always)]
    pub fn data6(&mut self) -> DATA6_W<'_, TDH1Rrs> {
        DATA6_W::new(self, 16)
    }
    ///Bits 24:31 - DATA7
    #[inline(always)]
    pub fn data7(&mut self) -> DATA7_W<'_, TDH1Rrs> {
        DATA7_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#CAN1:TDH1R)*/
pub struct TDH1Rrs;
impl crate::RegisterSpec for TDH1Rrs {
    type Ux = u32;
}
///`read()` method returns [`tdh1r::R`](R) reader structure
impl crate::Readable for TDH1Rrs {}
///`write(|w| ..)` method takes [`tdh1r::W`](W) writer structure
impl crate::Writable for TDH1Rrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TDH1R to value 0
impl crate::Resettable for TDH1Rrs {}
