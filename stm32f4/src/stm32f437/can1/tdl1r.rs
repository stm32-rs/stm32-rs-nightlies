...
pub type R = crate::R<TDL1Rrs>;
///Register `TDL1R` writer
pub type W = crate::W<TDL1Rrs>;
...
impl W {
    ///Bits 0:7 - DATA0
    #[inline(always)]
    pub fn data0(&mut self) -> DATA0_W<'_, TDL1Rrs> {
        DATA0_W::new(self, 0)
    }
    ///Bits 8:15 - DATA1
    #[inline(always)]
    pub fn data1(&mut self) -> DATA1_W<'_, TDL1Rrs> {
        DATA1_W::new(self, 8)
    }
    ///Bits 16:23 - DATA2
    #[inline(always)]
    pub fn data2(&mut self) -> DATA2_W<'_, TDL1Rrs> {
        DATA2_W::new(self, 16)
    }
    ///Bits 24:31 - DATA3
    #[inline(always)]
    pub fn data3(&mut self) -> DATA3_W<'_, TDL1Rrs> {
        DATA3_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#CAN1:TDL1R)*/
pub struct TDL1Rrs;
impl crate::RegisterSpec for TDL1Rrs {
    type Ux = u32;
}
///`read()` method returns [`tdl1r::R`](R) reader structure
impl crate::Readable for TDL1Rrs {}
///`write(|w| ..)` method takes [`tdl1r::W`](W) writer structure
impl crate::Writable for TDL1Rrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TDL1R to value 0
impl crate::Resettable for TDL1Rrs {}
