...
pub type R = crate::R<TI0Rrs>;
///Register `TI0R` writer
pub type W = crate::W<TI0Rrs>;
...
impl W {
    ///Bit 0 - TXRQ
    #[inline(always)]
    pub fn txrq(&mut self) -> TXRQ_W<'_, TI0Rrs> {
        TXRQ_W::new(self, 0)
    }
    ///Bit 1 - RTR
    #[inline(always)]
    pub fn rtr(&mut self) -> RTR_W<'_, TI0Rrs> {
        RTR_W::new(self, 1)
    }
    ///Bit 2 - IDE
    #[inline(always)]
    pub fn ide(&mut self) -> IDE_W<'_, TI0Rrs> {
        IDE_W::new(self, 2)
    }
    ///Bits 3:20 - EXID
    #[inline(always)]
    pub fn exid(&mut self) -> EXID_W<'_, TI0Rrs> {
        EXID_W::new(self, 3)
    }
    ///Bits 21:31 - STID
    #[inline(always)]
    pub fn stid(&mut self) -> STID_W<'_, TI0Rrs> {
        STID_W::new(self, 21)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#CAN1:TI0R)*/
pub struct TI0Rrs;
impl crate::RegisterSpec for TI0Rrs {
    type Ux = u32;
}
///`read()` method returns [`ti0r::R`](R) reader structure
impl crate::Readable for TI0Rrs {}
///`write(|w| ..)` method takes [`ti0r::W`](W) writer structure
impl crate::Writable for TI0Rrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TI0R to value 0
impl crate::Resettable for TI0Rrs {}
