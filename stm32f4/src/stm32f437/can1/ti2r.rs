///Register `TI2R` reader
pub type R = crate::R<TI2Rrs>;
///Register `TI2R` writer
pub type W = crate::W<TI2Rrs>;
...
impl W {
    ///Bit 0 - TXRQ
    #[inline(always)]
    pub fn txrq(&mut self) -> TXRQ_W<'_, TI2Rrs> {
        TXRQ_W::new(self, 0)
    }
    ///Bit 1 - RTR
    #[inline(always)]
    pub fn rtr(&mut self) -> RTR_W<'_, TI2Rrs> {
        RTR_W::new(self, 1)
    }
    ///Bit 2 - IDE
    #[inline(always)]
    pub fn ide(&mut self) -> IDE_W<'_, TI2Rrs> {
        IDE_W::new(self, 2)
    }
    ///Bits 3:20 - EXID
    #[inline(always)]
    pub fn exid(&mut self) -> EXID_W<'_, TI2Rrs> {
        EXID_W::new(self, 3)
    }
    ///Bits 21:31 - STID
    #[inline(always)]
    pub fn stid(&mut self) -> STID_W<'_, TI2Rrs> {
        STID_W::new(self, 21)
    }
}
/**mailbox identifier register

You can [`read`](crate::Reg::read) this register and get [`ti2r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ti2r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#CAN1:TI2R)*/
pub struct TI2Rrs;
impl crate::RegisterSpec for TI2Rrs {
    type Ux = u32;
}
///`read()` method returns [`ti2r::R`](R) reader structure
impl crate::Readable for TI2Rrs {}
///`write(|w| ..)` method takes [`ti2r::W`](W) writer structure
impl crate::Writable for TI2Rrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TI2R to value 0
impl crate::Resettable for TI2Rrs {}
