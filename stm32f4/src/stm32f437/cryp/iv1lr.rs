...
impl W {
    ///Bit 0 - IV95
    #[inline(always)]
    pub fn iv95(&mut self) -> IV95_W<'_, IV1LRrs> {
        IV95_W::new(self, 0)
    }
    ///Bit 1 - IV94
    #[inline(always)]
    pub fn iv94(&mut self) -> IV94_W<'_, IV1LRrs> {
        IV94_W::new(self, 1)
    }
    ///Bit 2 - IV93
    #[inline(always)]
    pub fn iv93(&mut self) -> IV93_W<'_, IV1LRrs> {
        IV93_W::new(self, 2)
    }
    ///Bit 3 - IV92
    #[inline(always)]
    pub fn iv92(&mut self) -> IV92_W<'_, IV1LRrs> {
        IV92_W::new(self, 3)
    }
    ///Bit 4 - IV91
    #[inline(always)]
    pub fn iv91(&mut self) -> IV91_W<'_, IV1LRrs> {
        IV91_W::new(self, 4)
    }
    ///Bit 5 - IV90
    #[inline(always)]
    pub fn iv90(&mut self) -> IV90_W<'_, IV1LRrs> {
        IV90_W::new(self, 5)
    }
    ///Bit 6 - IV89
    #[inline(always)]
    pub fn iv89(&mut self) -> IV89_W<'_, IV1LRrs> {
        IV89_W::new(self, 6)
    }
    ///Bit 7 - IV88
    #[inline(always)]
    pub fn iv88(&mut self) -> IV88_W<'_, IV1LRrs> {
        IV88_W::new(self, 7)
    }
    ///Bit 8 - IV87
    #[inline(always)]
    pub fn iv87(&mut self) -> IV87_W<'_, IV1LRrs> {
        IV87_W::new(self, 8)
    }
    ///Bit 9 - IV86
    #[inline(always)]
    pub fn iv86(&mut self) -> IV86_W<'_, IV1LRrs> {
        IV86_W::new(self, 9)
    }
    ///Bit 10 - IV85
    #[inline(always)]
    pub fn iv85(&mut self) -> IV85_W<'_, IV1LRrs> {
        IV85_W::new(self, 10)
    }
    ///Bit 11 - IV84
    #[inline(always)]
    pub fn iv84(&mut self) -> IV84_W<'_, IV1LRrs> {
        IV84_W::new(self, 11)
    }
    ///Bit 12 - IV83
    #[inline(always)]
    pub fn iv83(&mut self) -> IV83_W<'_, IV1LRrs> {
        IV83_W::new(self, 12)
    }
    ///Bit 13 - IV82
    #[inline(always)]
    pub fn iv82(&mut self) -> IV82_W<'_, IV1LRrs> {
        IV82_W::new(self, 13)
    }
    ///Bit 14 - IV81
    #[inline(always)]
    pub fn iv81(&mut self) -> IV81_W<'_, IV1LRrs> {
        IV81_W::new(self, 14)
    }
    ///Bit 15 - IV80
    #[inline(always)]
    pub fn iv80(&mut self) -> IV80_W<'_, IV1LRrs> {
        IV80_W::new(self, 15)
    }
    ///Bit 16 - IV79
    #[inline(always)]
    pub fn iv79(&mut self) -> IV79_W<'_, IV1LRrs> {
        IV79_W::new(self, 16)
    }
    ///Bit 17 - IV78
    #[inline(always)]
    pub fn iv78(&mut self) -> IV78_W<'_, IV1LRrs> {
        IV78_W::new(self, 17)
    }
    ///Bit 18 - IV77
    #[inline(always)]
    pub fn iv77(&mut self) -> IV77_W<'_, IV1LRrs> {
        IV77_W::new(self, 18)
    }
    ///Bit 19 - IV76
    #[inline(always)]
    pub fn iv76(&mut self) -> IV76_W<'_, IV1LRrs> {
        IV76_W::new(self, 19)
    }
    ///Bit 20 - IV75
    #[inline(always)]
    pub fn iv75(&mut self) -> IV75_W<'_, IV1LRrs> {
        IV75_W::new(self, 20)
    }
    ///Bit 21 - IV74
    #[inline(always)]
    pub fn iv74(&mut self) -> IV74_W<'_, IV1LRrs> {
        IV74_W::new(self, 21)
    }
    ///Bit 22 - IV73
    #[inline(always)]
    pub fn iv73(&mut self) -> IV73_W<'_, IV1LRrs> {
        IV73_W::new(self, 22)
    }
    ///Bit 23 - IV72
    #[inline(always)]
    pub fn iv72(&mut self) -> IV72_W<'_, IV1LRrs> {
        IV72_W::new(self, 23)
    }
    ///Bit 24 - IV71
    #[inline(always)]
    pub fn iv71(&mut self) -> IV71_W<'_, IV1LRrs> {
        IV71_W::new(self, 24)
    }
    ///Bit 25 - IV70
    #[inline(always)]
    pub fn iv70(&mut self) -> IV70_W<'_, IV1LRrs> {
        IV70_W::new(self, 25)
    }
    ///Bit 26 - IV69
    #[inline(always)]
    pub fn iv69(&mut self) -> IV69_W<'_, IV1LRrs> {
        IV69_W::new(self, 26)
    }
    ///Bit 27 - IV68
    #[inline(always)]
    pub fn iv68(&mut self) -> IV68_W<'_, IV1LRrs> {
        IV68_W::new(self, 27)
    }
    ///Bit 28 - IV67
    #[inline(always)]
    pub fn iv67(&mut self) -> IV67_W<'_, IV1LRrs> {
        IV67_W::new(self, 28)
    }
    ///Bit 29 - IV66
    #[inline(always)]
    pub fn iv66(&mut self) -> IV66_W<'_, IV1LRrs> {
        IV66_W::new(self, 29)
    }
    ///Bit 30 - IV65
    #[inline(always)]
    pub fn iv65(&mut self) -> IV65_W<'_, IV1LRrs> {
        IV65_W::new(self, 30)
    }
    ///Bit 31 - IV64
    #[inline(always)]
    pub fn iv64(&mut self) -> IV64_W<'_, IV1LRrs> {
        IV64_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#CRYP:IV1LR)*/
pub struct IV1LRrs;
