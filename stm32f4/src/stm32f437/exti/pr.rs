...
impl W {
    ...
    ///Bit 18 - Pending bit 18
    #[inline(always)]
    pub fn pr18(&mut self) -> PR18_W<'_, PRrs> {
        PR18_W::new(self, 18)
    }
    ///Bit 19 - Pending bit 19
    #[inline(always)]
    ...
    ///Bit 20 - Pending bit 20
    #[inline(always)]
    pub fn pr20(&mut self) -> PR20_W<'_, PRrs> {
        PR20_W::new(self, 20)
    }
    ///Bit 21 - Pending bit 21
    #[inline(always)]
    pub fn pr21(&mut self) -> PR21_W<'_, PRrs> {
        PR21_W::new(self, 21)
    }
    ///Bit 22 - Pending bit 22
    #[inline(always)]
    pub fn pr22(&mut self) -> PR22_W<'_, PRrs> {
        PR22_W::new(self, 22)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#EXTI:PR)*/
pub struct PRrs;
