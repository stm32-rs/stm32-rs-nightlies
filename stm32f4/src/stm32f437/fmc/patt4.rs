...
impl W {
    ///Bits 0:7 - ATTSETx
    #[inline(always)]
    pub fn attsetx(&mut self) -> ATTSETX_W<'_, PATT4rs> {
        ATTSETX_W::new(self, 0)
    }
    ///Bits 8:15 - ATTWAITx
    #[inline(always)]
    pub fn attwaitx(&mut self) -> ATTWAITX_W<'_, PATT4rs> {
        ATTWAITX_W::new(self, 8)
    }
    ///Bits 16:23 - ATTHOLDx
    #[inline(always)]
    pub fn attholdx(&mut self) -> ATTHOLDX_W<'_, PATT4rs> {
        ATTHOLDX_W::new(self, 16)
    }
    ///Bits 24:31 - ATTHIZx
    #[inline(always)]
    pub fn atthizx(&mut self) -> ATTHIZX_W<'_, PATT4rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#FMC:PATT4)*/
pub struct PATT4rs;
