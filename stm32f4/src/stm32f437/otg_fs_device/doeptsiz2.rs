...
impl W {
    ...
    ///Bits 29:30 - Received data PID/SETUP packet count
    #[inline(always)]
    pub fn rxdpid_stupcnt(&mut self) -> RXDPID_STUPCNT_W<'_, DOEPTSIZ2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#OTG_FS_DEVICE:DOEPTSIZ2)*/
