///Register `FS_DIEPTXF2` reader
pub type R = crate::R<FS_DIEPTXF2rs>;
///Register `FS_DIEPTXF2` writer
pub type W = crate::W<FS_DIEPTXF2rs>;
///Field `INEPTXSA` reader - IN endpoint FIFO3 transmit RAM start address
pub type INEPTXSA_R = crate::FieldReader<u16>;
///Field `INEPTXSA` writer - IN endpoint FIFO3 transmit RAM start address
...
impl W {
    ///Bits 0:15 - IN endpoint FIFO3 transmit RAM start address
    #[inline(always)]
    pub fn ineptxsa(&mut self) -> INEPTXSA_W<'_, FS_DIEPTXF2rs> {
        INEPTXSA_W::new(self, 0)
    }
    ///Bits 16:31 - IN endpoint TxFIFO depth
    #[inline(always)]
    pub fn ineptxfd(&mut self) -> INEPTXFD_W<'_, FS_DIEPTXF2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#OTG_FS_GLOBAL:FS_DIEPTXF2)*/
pub struct FS_DIEPTXF2rs;
impl crate::RegisterSpec for FS_DIEPTXF2rs {
    type Ux = u32;
}
///`read()` method returns [`fs_dieptxf2::R`](R) reader structure
impl crate::Readable for FS_DIEPTXF2rs {}
///`write(|w| ..)` method takes [`fs_dieptxf2::W`](W) writer structure
impl crate::Writable for FS_DIEPTXF2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_DIEPTXF2 to value 0x0200_0400
