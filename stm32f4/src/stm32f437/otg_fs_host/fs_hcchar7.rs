///Register `FS_HCCHAR7` reader
pub type R = crate::R<FS_HCCHAR7rs>;
///Register `FS_HCCHAR7` writer
pub type W = crate::W<FS_HCCHAR7rs>;
...
impl W {
    ///Bits 0:10 - Maximum packet size
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MPSIZ_W<'_, FS_HCCHAR7rs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bits 11:14 - Endpoint number
    #[inline(always)]
    pub fn epnum(&mut self) -> EPNUM_W<'_, FS_HCCHAR7rs> {
        EPNUM_W::new(self, 11)
    }
    ///Bit 15 - Endpoint direction
    #[inline(always)]
    pub fn epdir(&mut self) -> EPDIR_W<'_, FS_HCCHAR7rs> {
        EPDIR_W::new(self, 15)
    }
    ///Bit 17 - Low-speed device
    #[inline(always)]
    pub fn lsdev(&mut self) -> LSDEV_W<'_, FS_HCCHAR7rs> {
        LSDEV_W::new(self, 17)
    }
    ///Bits 18:19 - Endpoint type
    #[inline(always)]
    pub fn eptyp(&mut self) -> EPTYP_W<'_, FS_HCCHAR7rs> {
        EPTYP_W::new(self, 18)
    }
    ///Bits 20:21 - Multicount
    #[inline(always)]
    pub fn mcnt(&mut self) -> MCNT_W<'_, FS_HCCHAR7rs> {
        MCNT_W::new(self, 20)
    }
    ///Bits 22:28 - Device address
    #[inline(always)]
    pub fn dad(&mut self) -> DAD_W<'_, FS_HCCHAR7rs> {
        DAD_W::new(self, 22)
    }
    ///Bit 29 - Odd frame
    #[inline(always)]
    pub fn oddfrm(&mut self) -> ODDFRM_W<'_, FS_HCCHAR7rs> {
        ODDFRM_W::new(self, 29)
    }
    ///Bit 30 - Channel disable
    #[inline(always)]
    pub fn chdis(&mut self) -> CHDIS_W<'_, FS_HCCHAR7rs> {
        CHDIS_W::new(self, 30)
    }
    ///Bit 31 - Channel enable
    #[inline(always)]
    pub fn chena(&mut self) -> CHENA_W<'_, FS_HCCHAR7rs> {
        CHENA_W::new(self, 31)
    }
}
/**OTG_FS host channel-7 characteristics register (OTG_FS_HCCHAR7)

You can [`read`](crate::Reg::read) this register and get [`fs_hcchar7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fs_hcchar7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#OTG_FS_HOST:FS_HCCHAR7)*/
pub struct FS_HCCHAR7rs;
impl crate::RegisterSpec for FS_HCCHAR7rs {
    type Ux = u32;
}
///`read()` method returns [`fs_hcchar7::R`](R) reader structure
impl crate::Readable for FS_HCCHAR7rs {}
///`write(|w| ..)` method takes [`fs_hcchar7::W`](W) writer structure
impl crate::Writable for FS_HCCHAR7rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_HCCHAR7 to value 0
impl crate::Resettable for FS_HCCHAR7rs {}
