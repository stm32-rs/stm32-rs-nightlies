///Register `FS_HCINTMSK7` reader
pub type R = crate::R<FS_HCINTMSK7rs>;
///Register `FS_HCINTMSK7` writer
...
impl W {
    ///Bit 0 - Transfer completed mask
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, FS_HCINTMSK7rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - Channel halted mask
    #[inline(always)]
    pub fn chhm(&mut self) -> CHHM_W<'_, FS_HCINTMSK7rs> {
        CHHM_W::new(self, 1)
    }
    ///Bit 3 - STALL response received interrupt mask
    #[inline(always)]
    pub fn stallm(&mut self) -> STALLM_W<'_, FS_HCINTMSK7rs> {
        STALLM_W::new(self, 3)
    }
    ///Bit 4 - NAK response received interrupt mask
    #[inline(always)]
    pub fn nakm(&mut self) -> NAKM_W<'_, FS_HCINTMSK7rs> {
        NAKM_W::new(self, 4)
    }
    ///Bit 5 - ACK response received/transmitted interrupt mask
    #[inline(always)]
    pub fn ackm(&mut self) -> ACKM_W<'_, FS_HCINTMSK7rs> {
        ACKM_W::new(self, 5)
    }
    ///Bit 6 - response received interrupt mask
    #[inline(always)]
    pub fn nyet(&mut self) -> NYET_W<'_, FS_HCINTMSK7rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - Transaction error mask
    #[inline(always)]
    pub fn txerrm(&mut self) -> TXERRM_W<'_, FS_HCINTMSK7rs> {
        TXERRM_W::new(self, 7)
    }
    ///Bit 8 - Babble error mask
    #[inline(always)]
    pub fn bberrm(&mut self) -> BBERRM_W<'_, FS_HCINTMSK7rs> {
        BBERRM_W::new(self, 8)
    }
    ///Bit 9 - Frame overrun mask
    #[inline(always)]
    pub fn frmorm(&mut self) -> FRMORM_W<'_, FS_HCINTMSK7rs> {
        FRMORM_W::new(self, 9)
    }
    ///Bit 10 - Data toggle error mask
    #[inline(always)]
    pub fn dterrm(&mut self) -> DTERRM_W<'_, FS_HCINTMSK7rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#OTG_FS_HOST:FS_HCINTMSK7)*/
pub struct FS_HCINTMSK7rs;
impl crate::RegisterSpec for FS_HCINTMSK7rs {
    type Ux = u32;
}
///`read()` method returns [`fs_hcintmsk7::R`](R) reader structure
impl crate::Readable for FS_HCINTMSK7rs {}
///`write(|w| ..)` method takes [`fs_hcintmsk7::W`](W) writer structure
impl crate::Writable for FS_HCINTMSK7rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_HCINTMSK7 to value 0
