///Register `OTG_HS_DIEPCTL4` reader
pub type R = crate::R<OTG_HS_DIEPCTL4rs>;
///Register `OTG_HS_DIEPCTL4` writer
pub type W = crate::W<OTG_HS_DIEPCTL4rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_DIEPCTL4")
...
impl W {
    ///Bits 0:10 - Maximum packet size
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MPSIZ_W<'_, OTG_HS_DIEPCTL4rs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bit 15 - USB active endpoint
    #[inline(always)]
    pub fn usbaep(&mut self) -> USBAEP_W<'_, OTG_HS_DIEPCTL4rs> {
        USBAEP_W::new(self, 15)
    }
    ///Bits 18:19 - Endpoint type
    #[inline(always)]
    pub fn eptyp(&mut self) -> EPTYP_W<'_, OTG_HS_DIEPCTL4rs> {
        EPTYP_W::new(self, 18)
    }
    ///Bit 21 - STALL handshake
    #[inline(always)]
    pub fn stall(&mut self) -> STALL_W<'_, OTG_HS_DIEPCTL4rs> {
        STALL_W::new(self, 21)
    }
    ///Bits 22:25 - TxFIFO number
    #[inline(always)]
    pub fn txfnum(&mut self) -> TXFNUM_W<'_, OTG_HS_DIEPCTL4rs> {
        TXFNUM_W::new(self, 22)
    }
    ///Bit 26 - Clear NAK
    #[inline(always)]
    pub fn cnak(&mut self) -> CNAK_W<'_, OTG_HS_DIEPCTL4rs> {
        CNAK_W::new(self, 26)
    }
    ///Bit 27 - Set NAK
    #[inline(always)]
    pub fn snak(&mut self) -> SNAK_W<'_, OTG_HS_DIEPCTL4rs> {
        SNAK_W::new(self, 27)
    }
    ///Bit 28 - Set DATA0 PID
    #[inline(always)]
    pub fn sd0pid_sevnfrm(&mut self) -> SD0PID_SEVNFRM_W<'_, OTG_HS_DIEPCTL4rs> {
        SD0PID_SEVNFRM_W::new(self, 28)
    }
    ///Bit 29 - Set odd frame
    #[inline(always)]
    pub fn soddfrm(&mut self) -> SODDFRM_W<'_, OTG_HS_DIEPCTL4rs> {
        SODDFRM_W::new(self, 29)
    }
    ///Bit 30 - Endpoint disable
    #[inline(always)]
    pub fn epdis(&mut self) -> EPDIS_W<'_, OTG_HS_DIEPCTL4rs> {
        EPDIS_W::new(self, 30)
    }
    ///Bit 31 - Endpoint enable
    #[inline(always)]
    pub fn epena(&mut self) -> EPENA_W<'_, OTG_HS_DIEPCTL4rs> {
        EPENA_W::new(self, 31)
    }
}
...
pub struct OTG_HS_DIEPCTL4rs;
impl crate::RegisterSpec for OTG_HS_DIEPCTL4rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_diepctl4::R`](R) reader structure
impl crate::Readable for OTG_HS_DIEPCTL4rs {}
///`write(|w| ..)` method takes [`otg_hs_diepctl4::W`](W) writer structure
impl crate::Writable for OTG_HS_DIEPCTL4rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DIEPCTL4 to value 0
impl crate::Resettable for OTG_HS_DIEPCTL4rs {}
