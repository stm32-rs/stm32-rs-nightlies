///Register `OTG_HS_DIEPEACHMSK1` reader
pub type R = crate::R<OTG_HS_DIEPEACHMSK1rs>;
///Register `OTG_HS_DIEPEACHMSK1` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_DIEPEACHMSK1")
...
impl W {
    ///Bit 0 - Transfer completed interrupt mask
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, OTG_HS_DIEPEACHMSK1rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - Endpoint disabled interrupt mask
    #[inline(always)]
    pub fn epdm(&mut self) -> EPDM_W<'_, OTG_HS_DIEPEACHMSK1rs> {
        EPDM_W::new(self, 1)
    }
    ///Bit 3 - Timeout condition mask (nonisochronous endpoints)
    #[inline(always)]
    pub fn tom(&mut self) -> TOM_W<'_, OTG_HS_DIEPEACHMSK1rs> {
        TOM_W::new(self, 3)
    }
    ///Bit 4 - IN token received when TxFIFO empty mask
    #[inline(always)]
    pub fn ittxfemsk(&mut self) -> ITTXFEMSK_W<'_, OTG_HS_DIEPEACHMSK1rs> {
        ITTXFEMSK_W::new(self, 4)
    }
    ///Bit 5 - IN token received with EP mismatch mask
    #[inline(always)]
    pub fn inepnmm(&mut self) -> INEPNMM_W<'_, OTG_HS_DIEPEACHMSK1rs> {
        INEPNMM_W::new(self, 5)
    }
    ///Bit 6 - IN endpoint NAK effective mask
    #[inline(always)]
    pub fn inepnem(&mut self) -> INEPNEM_W<'_, OTG_HS_DIEPEACHMSK1rs> {
        INEPNEM_W::new(self, 6)
    }
    ///Bit 8 - FIFO underrun mask
    #[inline(always)]
    pub fn txfurm(&mut self) -> TXFURM_W<'_, OTG_HS_DIEPEACHMSK1rs> {
        TXFURM_W::new(self, 8)
    }
    ///Bit 9 - BNA interrupt mask
    #[inline(always)]
    pub fn bim(&mut self) -> BIM_W<'_, OTG_HS_DIEPEACHMSK1rs> {
        BIM_W::new(self, 9)
    }
    ///Bit 13 - NAK interrupt mask
    #[inline(always)]
    pub fn nakm(&mut self) -> NAKM_W<'_, OTG_HS_DIEPEACHMSK1rs> {
        NAKM_W::new(self, 13)
    }
}
/**OTG_HS device each in endpoint-1 interrupt register

You can [`read`](crate::Reg::read) this register and get [`otg_hs_diepeachmsk1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hs_diepeachmsk1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`otg_hs_diepeachmsk1::R`](R) reader structure
impl crate::Readable for OTG_HS_DIEPEACHMSK1rs {}
///`write(|w| ..)` method takes [`otg_hs_diepeachmsk1::W`](W) writer structure
impl crate::Writable for OTG_HS_DIEPEACHMSK1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DIEPEACHMSK1 to value 0
