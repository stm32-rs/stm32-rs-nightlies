///Register `OTG_HS_DOEPCTL3` reader
pub type R = crate::R<OTG_HS_DOEPCTL3rs>;
///Register `OTG_HS_DOEPCTL3` writer
pub type W = crate::W<OTG_HS_DOEPCTL3rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_DOEPCTL3")
...
impl W {
    ///Bits 0:10 - Maximum packet size
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MPSIZ_W<'_, OTG_HS_DOEPCTL3rs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bit 15 - USB active endpoint
    #[inline(always)]
    pub fn usbaep(&mut self) -> USBAEP_W<'_, OTG_HS_DOEPCTL3rs> {
        USBAEP_W::new(self, 15)
    }
    ///Bits 18:19 - Endpoint type
    #[inline(always)]
    pub fn eptyp(&mut self) -> EPTYP_W<'_, OTG_HS_DOEPCTL3rs> {
        EPTYP_W::new(self, 18)
    }
    ///Bit 20 - Snoop mode
    #[inline(always)]
    pub fn snpm(&mut self) -> SNPM_W<'_, OTG_HS_DOEPCTL3rs> {
        SNPM_W::new(self, 20)
    }
    ///Bit 21 - STALL handshake
    #[inline(always)]
    pub fn stall(&mut self) -> STALL_W<'_, OTG_HS_DOEPCTL3rs> {
        STALL_W::new(self, 21)
    }
    ///Bit 26 - Clear NAK
    #[inline(always)]
    pub fn cnak(&mut self) -> CNAK_W<'_, OTG_HS_DOEPCTL3rs> {
        CNAK_W::new(self, 26)
    }
    ///Bit 27 - Set NAK
    #[inline(always)]
    pub fn snak(&mut self) -> SNAK_W<'_, OTG_HS_DOEPCTL3rs> {
        SNAK_W::new(self, 27)
    }
    ///Bit 28 - Set DATA0 PID/Set even frame
    #[inline(always)]
    pub fn sd0pid_sevnfrm(&mut self) -> SD0PID_SEVNFRM_W<'_, OTG_HS_DOEPCTL3rs> {
        SD0PID_SEVNFRM_W::new(self, 28)
    }
    ///Bit 29 - Set odd frame
    #[inline(always)]
    pub fn soddfrm(&mut self) -> SODDFRM_W<'_, OTG_HS_DOEPCTL3rs> {
        SODDFRM_W::new(self, 29)
    }
    ///Bit 30 - Endpoint disable
    #[inline(always)]
    pub fn epdis(&mut self) -> EPDIS_W<'_, OTG_HS_DOEPCTL3rs> {
        EPDIS_W::new(self, 30)
    }
    ///Bit 31 - Endpoint enable
    #[inline(always)]
    pub fn epena(&mut self) -> EPENA_W<'_, OTG_HS_DOEPCTL3rs> {
        EPENA_W::new(self, 31)
    }
}
...
pub struct OTG_HS_DOEPCTL3rs;
impl crate::RegisterSpec for OTG_HS_DOEPCTL3rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_doepctl3::R`](R) reader structure
impl crate::Readable for OTG_HS_DOEPCTL3rs {}
///`write(|w| ..)` method takes [`otg_hs_doepctl3::W`](W) writer structure
impl crate::Writable for OTG_HS_DOEPCTL3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DOEPCTL3 to value 0
impl crate::Resettable for OTG_HS_DOEPCTL3rs {}
