///Register `OTG_HS_DOEPINT1` reader
pub type R = crate::R<OTG_HS_DOEPINT1rs>;
///Register `OTG_HS_DOEPINT1` writer
pub type W = crate::W<OTG_HS_DOEPINT1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_DOEPINT1")
...
impl W {
    ///Bit 0 - Transfer completed interrupt
    #[inline(always)]
    pub fn xfrc(&mut self) -> XFRC_W<'_, OTG_HS_DOEPINT1rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - Endpoint disabled interrupt
    #[inline(always)]
    pub fn epdisd(&mut self) -> EPDISD_W<'_, OTG_HS_DOEPINT1rs> {
        EPDISD_W::new(self, 1)
    }
    ///Bit 3 - SETUP phase done
    #[inline(always)]
    pub fn stup(&mut self) -> STUP_W<'_, OTG_HS_DOEPINT1rs> {
        STUP_W::new(self, 3)
    }
    ///Bit 4 - OUT token received when endpoint disabled
    #[inline(always)]
    pub fn otepdis(&mut self) -> OTEPDIS_W<'_, OTG_HS_DOEPINT1rs> {
        OTEPDIS_W::new(self, 4)
    }
    ///Bit 6 - Back-to-back SETUP packets received
    #[inline(always)]
    pub fn b2bstup(&mut self) -> B2BSTUP_W<'_, OTG_HS_DOEPINT1rs> {
        B2BSTUP_W::new(self, 6)
    }
    ///Bit 14 - NYET interrupt
    #[inline(always)]
    pub fn nyet(&mut self) -> NYET_W<'_, OTG_HS_DOEPINT1rs> {
        NYET_W::new(self, 14)
    }
}
...
pub struct OTG_HS_DOEPINT1rs;
impl crate::RegisterSpec for OTG_HS_DOEPINT1rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_doepint1::R`](R) reader structure
impl crate::Readable for OTG_HS_DOEPINT1rs {}
///`write(|w| ..)` method takes [`otg_hs_doepint1::W`](W) writer structure
impl crate::Writable for OTG_HS_DOEPINT1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DOEPINT1 to value 0
impl crate::Resettable for OTG_HS_DOEPINT1rs {}
