///Register `OTG_HS_DSTS` reader
pub type R = crate::R<OTG_HS_DSTSrs>;
...
pub struct OTG_HS_DSTSrs;
impl crate::RegisterSpec for OTG_HS_DSTSrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_dsts::R`](R) reader structure
impl crate::Readable for OTG_HS_DSTSrs {}
///`reset()` method sets OTG_HS_DSTS to value 0x10
impl crate::Resettable for OTG_HS_DSTSrs {
