///Register `OTG_HS_GOTGCTL` reader
pub type R = crate::R<OTG_HS_GOTGCTLrs>;
///Register `OTG_HS_GOTGCTL` writer
pub type W = crate::W<OTG_HS_GOTGCTLrs>;
...
impl W {
    ///Bit 1 - Session request
    #[inline(always)]
    pub fn srq(&mut self) -> SRQ_W<'_, OTG_HS_GOTGCTLrs> {
        SRQ_W::new(self, 1)
    }
    ///Bit 9 - HNP request
    #[inline(always)]
    pub fn hnprq(&mut self) -> HNPRQ_W<'_, OTG_HS_GOTGCTLrs> {
        HNPRQ_W::new(self, 9)
    }
    ///Bit 10 - Host set HNP enable
    #[inline(always)]
    pub fn hshnpen(&mut self) -> HSHNPEN_W<'_, OTG_HS_GOTGCTLrs> {
        HSHNPEN_W::new(self, 10)
    }
    ///Bit 11 - Device HNP enabled
    #[inline(always)]
    pub fn dhnpen(&mut self) -> DHNPEN_W<'_, OTG_HS_GOTGCTLrs> {
...
pub struct OTG_HS_GOTGCTLrs;
impl crate::RegisterSpec for OTG_HS_GOTGCTLrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_gotgctl::R`](R) reader structure
impl crate::Readable for OTG_HS_GOTGCTLrs {}
///`write(|w| ..)` method takes [`otg_hs_gotgctl::W`](W) writer structure
impl crate::Writable for OTG_HS_GOTGCTLrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_GOTGCTL to value 0x0800
impl crate::Resettable for OTG_HS_GOTGCTLrs {
