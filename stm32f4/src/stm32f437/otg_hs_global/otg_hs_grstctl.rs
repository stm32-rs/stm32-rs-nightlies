///Register `OTG_HS_GRSTCTL` reader
pub type R = crate::R<OTG_HS_GRSTCTLrs>;
///Register `OTG_HS_GRSTCTL` writer
pub type W = crate::W<OTG_HS_GRSTCTLrs>;
...
///Field `DMAREQ` reader - DMA request signal
...
impl W {
    ///Bit 0 - Core soft reset
    #[inline(always)]
    pub fn csrst(&mut self) -> CSRST_W<'_, OTG_HS_GRSTCTLrs> {
        CSRST_W::new(self, 0)
    }
    ///Bit 1 - HCLK soft reset
    #[inline(always)]
    pub fn hsrst(&mut self) -> HSRST_W<'_, OTG_HS_GRSTCTLrs> {
        HSRST_W::new(self, 1)
    }
    ///Bit 2 - Host frame counter reset
    #[inline(always)]
    pub fn fcrst(&mut self) -> FCRST_W<'_, OTG_HS_GRSTCTLrs> {
        FCRST_W::new(self, 2)
    }
    ///Bit 4 - RxFIFO flush
    #[inline(always)]
    pub fn rxfflsh(&mut self) -> RXFFLSH_W<'_, OTG_HS_GRSTCTLrs> {
        RXFFLSH_W::new(self, 4)
    }
    ///Bit 5 - TxFIFO flush
    #[inline(always)]
    pub fn txfflsh(&mut self) -> TXFFLSH_W<'_, OTG_HS_GRSTCTLrs> {
        TXFFLSH_W::new(self, 5)
    }
    ///Bits 6:10 - TxFIFO number
    #[inline(always)]
    pub fn txfnum(&mut self) -> TXFNUM_W<'_, OTG_HS_GRSTCTLrs> {
        TXFNUM_W::new(self, 6)
    }
}
...
pub struct OTG_HS_GRSTCTLrs;
impl crate::RegisterSpec for OTG_HS_GRSTCTLrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_grstctl::R`](R) reader structure
impl crate::Readable for OTG_HS_GRSTCTLrs {}
///`write(|w| ..)` method takes [`otg_hs_grstctl::W`](W) writer structure
impl crate::Writable for OTG_HS_GRSTCTLrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_GRSTCTL to value 0x2000_0000
impl crate::Resettable for OTG_HS_GRSTCTLrs {
