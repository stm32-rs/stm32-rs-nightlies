///Register `OTG_HS_GUSBCFG` reader
pub type R = crate::R<OTG_HS_GUSBCFGrs>;
///Register `OTG_HS_GUSBCFG` writer
pub type W = crate::W<OTG_HS_GUSBCFGrs>;
...
impl W {
    ///Bits 0:2 - FS timeout calibration
    #[inline(always)]
    pub fn tocal(&mut self) -> TOCAL_W<'_, OTG_HS_GUSBCFGrs> {
        TOCAL_W::new(self, 0)
    }
    ///Bit 6 - USB 2.0 high-speed ULPI PHY or USB 1.1 full-speed serial transceiver select
    #[inline(always)]
    pub fn physel(&mut self) -> PHYSEL_W<'_, OTG_HS_GUSBCFGrs> {
        PHYSEL_W::new(self, 6)
    }
    ///Bit 8 - SRP-capable
    #[inline(always)]
    pub fn srpcap(&mut self) -> SRPCAP_W<'_, OTG_HS_GUSBCFGrs> {
        SRPCAP_W::new(self, 8)
    }
    ///Bit 9 - HNP-capable
    #[inline(always)]
    pub fn hnpcap(&mut self) -> HNPCAP_W<'_, OTG_HS_GUSBCFGrs> {
        HNPCAP_W::new(self, 9)
    }
    ///Bits 10:13 - USB turnaround time
    #[inline(always)]
    pub fn trdt(&mut self) -> TRDT_W<'_, OTG_HS_GUSBCFGrs> {
        TRDT_W::new(self, 10)
    }
    ///Bit 15 - PHY Low-power clock select
    #[inline(always)]
    pub fn phylpcs(&mut self) -> PHYLPCS_W<'_, OTG_HS_GUSBCFGrs> {
        PHYLPCS_W::new(self, 15)
    }
    ///Bit 17 - ULPI FS/LS select
    #[inline(always)]
    pub fn ulpifsls(&mut self) -> ULPIFSLS_W<'_, OTG_HS_GUSBCFGrs> {
        ULPIFSLS_W::new(self, 17)
    }
    ///Bit 18 - ULPI Auto-resume
    #[inline(always)]
    pub fn ulpiar(&mut self) -> ULPIAR_W<'_, OTG_HS_GUSBCFGrs> {
        ULPIAR_W::new(self, 18)
    }
    ///Bit 19 - ULPI Clock SuspendM
    #[inline(always)]
    pub fn ulpicsm(&mut self) -> ULPICSM_W<'_, OTG_HS_GUSBCFGrs> {
        ULPICSM_W::new(self, 19)
    }
    ///Bit 20 - ULPI External VBUS Drive
    #[inline(always)]
    pub fn ulpievbusd(&mut self) -> ULPIEVBUSD_W<'_, OTG_HS_GUSBCFGrs> {
        ULPIEVBUSD_W::new(self, 20)
    }
    ///Bit 21 - ULPI external VBUS indicator
    #[inline(always)]
    pub fn ulpievbusi(&mut self) -> ULPIEVBUSI_W<'_, OTG_HS_GUSBCFGrs> {
        ULPIEVBUSI_W::new(self, 21)
    }
    ///Bit 22 - TermSel DLine pulsing selection
    #[inline(always)]
    pub fn tsdps(&mut self) -> TSDPS_W<'_, OTG_HS_GUSBCFGrs> {
        TSDPS_W::new(self, 22)
    }
    ///Bit 23 - Indicator complement
    #[inline(always)]
    pub fn pcci(&mut self) -> PCCI_W<'_, OTG_HS_GUSBCFGrs> {
        PCCI_W::new(self, 23)
    }
    ///Bit 24 - Indicator pass through
    #[inline(always)]
    pub fn ptci(&mut self) -> PTCI_W<'_, OTG_HS_GUSBCFGrs> {
        PTCI_W::new(self, 24)
    }
    ///Bit 25 - ULPI interface protect disable
    #[inline(always)]
    pub fn ulpiipd(&mut self) -> ULPIIPD_W<'_, OTG_HS_GUSBCFGrs> {
        ULPIIPD_W::new(self, 25)
    }
    ///Bit 29 - Forced host mode
    #[inline(always)]
    pub fn fhmod(&mut self) -> FHMOD_W<'_, OTG_HS_GUSBCFGrs> {
        FHMOD_W::new(self, 29)
    }
    ///Bit 30 - Forced peripheral mode
    #[inline(always)]
    pub fn fdmod(&mut self) -> FDMOD_W<'_, OTG_HS_GUSBCFGrs> {
        FDMOD_W::new(self, 30)
    }
    ///Bit 31 - Corrupt Tx packet
    #[inline(always)]
    pub fn ctxpkt(&mut self) -> CTXPKT_W<'_, OTG_HS_GUSBCFGrs> {
...
pub struct OTG_HS_GUSBCFGrs;
impl crate::RegisterSpec for OTG_HS_GUSBCFGrs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_gusbcfg::R`](R) reader structure
impl crate::Readable for OTG_HS_GUSBCFGrs {}
///`write(|w| ..)` method takes [`otg_hs_gusbcfg::W`](W) writer structure
impl crate::Writable for OTG_HS_GUSBCFGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_GUSBCFG to value 0x0a00
impl crate::Resettable for OTG_HS_GUSBCFGrs {
