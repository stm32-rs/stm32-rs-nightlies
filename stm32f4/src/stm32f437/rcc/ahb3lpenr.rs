...
///Field `FMCLPEN` reader - Flexible static memory controller module clock enable during Sleep mode
pub type FMCLPEN_R = crate::BitReader;
///Field `FMCLPEN` writer - Flexible static memory controller module clock enable during Sleep mode
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F437.html#RCC:AHB3LPENR)*/
