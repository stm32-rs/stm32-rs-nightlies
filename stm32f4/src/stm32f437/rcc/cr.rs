...
pub type PLLSAION_R = crate::BitReader;
///Field `PLLSAION` writer - PLLSAI enable
pub type PLLSAION_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PLLSAIRDY` reader - PLLSAI clock ready flag
pub type PLLSAIRDY_R = crate::BitReader;
///Field `PLLSAIRDY` writer - PLLSAI clock ready flag
pub type PLLSAIRDY_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    ///Bit 29 - PLLSAI clock ready flag
    #[inline(always)]
    pub fn pllsairdy(&mut self) -> PLLSAIRDY_W<'_, CRrs> {
        PLLSAIRDY_W::new(self, 29)
    }
}
