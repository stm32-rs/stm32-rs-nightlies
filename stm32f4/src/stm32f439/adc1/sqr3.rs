...
impl W {
    ///Bits 0:4 - 1st conversion in regular sequence
    #[inline(always)]
    pub fn sq1(&mut self) -> SQ1_W<'_, SQR3rs> {
        SQ1_W::new(self, 0)
    }
    ///Bits 5:9 - 2nd conversion in regular sequence
    #[inline(always)]
    pub fn sq2(&mut self) -> SQ2_W<'_, SQR3rs> {
        SQ2_W::new(self, 5)
    }
    ///Bits 10:14 - 3rd conversion in regular sequence
    #[inline(always)]
    pub fn sq3(&mut self) -> SQ3_W<'_, SQR3rs> {
        SQ3_W::new(self, 10)
    }
    ///Bits 15:19 - 4th conversion in regular sequence
    #[inline(always)]
    pub fn sq4(&mut self) -> SQ4_W<'_, SQR3rs> {
        SQ4_W::new(self, 15)
    }
    ///Bits 20:24 - 5th conversion in regular sequence
    #[inline(always)]
    pub fn sq5(&mut self) -> SQ5_W<'_, SQR3rs> {
        SQ5_W::new(self, 20)
    }
    ///Bits 25:29 - 6th conversion in regular sequence
    #[inline(always)]
    pub fn sq6(&mut self) -> SQ6_W<'_, SQR3rs> {
        SQ6_W::new(self, 25)
    }
}
