///Register `RDL0R` reader
pub type R = crate::R<RDL0Rrs>;
...
You can [`read`](crate::Reg::read) this register and get [`rdl0r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#CAN1:RDL0R)*/
pub struct RDL0Rrs;
impl crate::RegisterSpec for RDL0Rrs {
    type Ux = u32;
}
///`read()` method returns [`rdl0r::R`](R) reader structure
impl crate::Readable for RDL0Rrs {}
///`reset()` method sets RDL0R to value 0
impl crate::Resettable for RDL0Rrs {}
