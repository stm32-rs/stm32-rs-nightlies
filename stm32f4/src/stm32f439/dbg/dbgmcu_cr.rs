///Register `DBGMCU_CR` reader
pub type R = crate::R<DBGMCU_CRrs>;
///Register `DBGMCU_CR` writer
...
impl W {
    ///Bit 0 - DBG_SLEEP
    #[inline(always)]
    pub fn dbg_sleep(&mut self) -> DBG_SLEEP_W<'_, DBGMCU_CRrs> {
        DBG_SLEEP_W::new(self, 0)
    }
    ///Bit 1 - DBG_STOP
    #[inline(always)]
    pub fn dbg_stop(&mut self) -> DBG_STOP_W<'_, DBGMCU_CRrs> {
        DBG_STOP_W::new(self, 1)
    }
    ///Bit 2 - DBG_STANDBY
    #[inline(always)]
    pub fn dbg_standby(&mut self) -> DBG_STANDBY_W<'_, DBGMCU_CRrs> {
        DBG_STANDBY_W::new(self, 2)
    }
    ///Bit 5 - TRACE_IOEN
    #[inline(always)]
    pub fn trace_ioen(&mut self) -> TRACE_IOEN_W<'_, DBGMCU_CRrs> {
        TRACE_IOEN_W::new(self, 5)
    }
    ///Bits 6:7 - TRACE_MODE
    #[inline(always)]
    pub fn trace_mode(&mut self) -> TRACE_MODE_W<'_, DBGMCU_CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#DBG:DBGMCU_CR)*/
pub struct DBGMCU_CRrs;
impl crate::RegisterSpec for DBGMCU_CRrs {
    type Ux = u32;
}
///`read()` method returns [`dbgmcu_cr::R`](R) reader structure
impl crate::Readable for DBGMCU_CRrs {}
///`write(|w| ..)` method takes [`dbgmcu_cr::W`](W) writer structure
impl crate::Writable for DBGMCU_CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DBGMCU_CR to value 0
