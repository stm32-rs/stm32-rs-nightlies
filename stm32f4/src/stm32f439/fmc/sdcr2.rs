...
///Field `CLK` reader - SDRAM clock configuration
pub type CLK_R = crate::FieldReader;
///Field `CLK` writer - SDRAM clock configuration
pub type CLK_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl W {
    ...
    ///Bits 10:11 - SDRAM clock configuration
    #[inline(always)]
    pub fn clk(&mut self) -> CLK_W<'_, SDCR2rs> {
        CLK_W::new(self, 10)
    }
}
