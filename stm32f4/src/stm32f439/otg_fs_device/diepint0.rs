///Register `DIEPINT0` reader
pub type R = crate::R<DIEPINT0rs>;
///Register `DIEPINT0` writer
pub type W = crate::W<DIEPINT0rs>;
...
impl W {
    ///Bit 0 - XFRC
    #[inline(always)]
    pub fn xfrc(&mut self) -> XFRC_W<'_, DIEPINT0rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - EPDISD
    #[inline(always)]
    pub fn epdisd(&mut self) -> EPDISD_W<'_, DIEPINT0rs> {
        EPDISD_W::new(self, 1)
    }
    ///Bit 3 - TOC
    #[inline(always)]
    pub fn toc(&mut self) -> TOC_W<'_, DIEPINT0rs> {
        TOC_W::new(self, 3)
    }
    ///Bit 4 - ITTXFE
    #[inline(always)]
    pub fn ittxfe(&mut self) -> ITTXFE_W<'_, DIEPINT0rs> {
        ITTXFE_W::new(self, 4)
    }
    ///Bit 6 - INEPNE
    #[inline(always)]
    pub fn inepne(&mut self) -> INEPNE_W<'_, DIEPINT0rs> {
        INEPNE_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#OTG_FS_DEVICE:DIEPINT0)*/
pub struct DIEPINT0rs;
impl crate::RegisterSpec for DIEPINT0rs {
    type Ux = u32;
}
///`read()` method returns [`diepint0::R`](R) reader structure
impl crate::Readable for DIEPINT0rs {}
///`write(|w| ..)` method takes [`diepint0::W`](W) writer structure
impl crate::Writable for DIEPINT0rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DIEPINT0 to value 0x80
impl crate::Resettable for DIEPINT0rs {
