...
impl W {
    ///Bits 0:18 - Transfer size
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, DIEPTSIZ1rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - Packet count
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, DIEPTSIZ1rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - Multi count
    #[inline(always)]
    pub fn mcnt(&mut self) -> MCNT_W<'_, DIEPTSIZ1rs> {
        MCNT_W::new(self, 29)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#OTG_FS_DEVICE:DIEPTSIZ1)*/
