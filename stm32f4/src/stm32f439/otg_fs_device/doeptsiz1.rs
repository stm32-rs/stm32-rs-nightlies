...
impl W {
    ///Bits 0:18 - Transfer size
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, DOEPTSIZ1rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - Packet count
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, DOEPTSIZ1rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - Received data PID/SETUP packet count
    #[inline(always)]
    pub fn rxdpid_stupcnt(&mut self) -> RXDPID_STUPCNT_W<'_, DOEPTSIZ1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#OTG_FS_DEVICE:DOEPTSIZ1)*/
