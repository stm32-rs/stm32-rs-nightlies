///Register `FS_DCTL` reader
pub type R = crate::R<FS_DCTLrs>;
///Register `FS_DCTL` writer
...
impl W {
    ///Bit 0 - Remote wakeup signaling
    #[inline(always)]
    pub fn rwusig(&mut self) -> RWUSIG_W<'_, FS_DCTLrs> {
        RWUSIG_W::new(self, 0)
    }
    ///Bit 1 - Soft disconnect
    #[inline(always)]
    pub fn sdis(&mut self) -> SDIS_W<'_, FS_DCTLrs> {
        SDIS_W::new(self, 1)
    }
    ///Bits 4:6 - Test control
    #[inline(always)]
    pub fn tctl(&mut self) -> TCTL_W<'_, FS_DCTLrs> {
        TCTL_W::new(self, 4)
    }
    ///Bit 7 - Set global IN NAK
    #[inline(always)]
    pub fn sginak(&mut self) -> SGINAK_W<'_, FS_DCTLrs> {
        SGINAK_W::new(self, 7)
    }
    ///Bit 8 - Clear global IN NAK
    #[inline(always)]
    pub fn cginak(&mut self) -> CGINAK_W<'_, FS_DCTLrs> {
        CGINAK_W::new(self, 8)
    }
    ///Bit 9 - Set global OUT NAK
    #[inline(always)]
    pub fn sgonak(&mut self) -> SGONAK_W<'_, FS_DCTLrs> {
        SGONAK_W::new(self, 9)
    }
    ///Bit 10 - Clear global OUT NAK
    #[inline(always)]
    pub fn cgonak(&mut self) -> CGONAK_W<'_, FS_DCTLrs> {
        CGONAK_W::new(self, 10)
    }
    ///Bit 11 - Power-on programming done
    #[inline(always)]
    pub fn poprgdne(&mut self) -> POPRGDNE_W<'_, FS_DCTLrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#OTG_FS_DEVICE:FS_DCTL)*/
pub struct FS_DCTLrs;
impl crate::RegisterSpec for FS_DCTLrs {
    type Ux = u32;
}
///`read()` method returns [`fs_dctl::R`](R) reader structure
impl crate::Readable for FS_DCTLrs {}
///`write(|w| ..)` method takes [`fs_dctl::W`](W) writer structure
impl crate::Writable for FS_DCTLrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_DCTL to value 0
