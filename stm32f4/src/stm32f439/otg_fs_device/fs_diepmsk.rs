///Register `FS_DIEPMSK` reader
pub type R = crate::R<FS_DIEPMSKrs>;
///Register `FS_DIEPMSK` writer
...
impl W {
    ///Bit 0 - Transfer completed interrupt mask
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, FS_DIEPMSKrs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - Endpoint disabled interrupt mask
    #[inline(always)]
    pub fn epdm(&mut self) -> EPDM_W<'_, FS_DIEPMSKrs> {
        EPDM_W::new(self, 1)
    }
    ///Bit 3 - Timeout condition mask (Non-isochronous endpoints)
    #[inline(always)]
    pub fn tom(&mut self) -> TOM_W<'_, FS_DIEPMSKrs> {
        TOM_W::new(self, 3)
    }
    ///Bit 4 - IN token received when TxFIFO empty mask
    #[inline(always)]
    pub fn ittxfemsk(&mut self) -> ITTXFEMSK_W<'_, FS_DIEPMSKrs> {
        ITTXFEMSK_W::new(self, 4)
    }
    ///Bit 5 - IN token received with EP mismatch mask
    #[inline(always)]
    pub fn inepnmm(&mut self) -> INEPNMM_W<'_, FS_DIEPMSKrs> {
        INEPNMM_W::new(self, 5)
    }
    ///Bit 6 - IN endpoint NAK effective mask
    #[inline(always)]
    pub fn inepnem(&mut self) -> INEPNEM_W<'_, FS_DIEPMSKrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#OTG_FS_DEVICE:FS_DIEPMSK)*/
pub struct FS_DIEPMSKrs;
impl crate::RegisterSpec for FS_DIEPMSKrs {
    type Ux = u32;
}
///`read()` method returns [`fs_diepmsk::R`](R) reader structure
impl crate::Readable for FS_DIEPMSKrs {}
///`write(|w| ..)` method takes [`fs_diepmsk::W`](W) writer structure
impl crate::Writable for FS_DIEPMSKrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_DIEPMSK to value 0
