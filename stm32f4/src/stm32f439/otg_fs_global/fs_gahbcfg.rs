///Register `FS_GAHBCFG` reader
pub type R = crate::R<FS_GAHBCFGrs>;
///Register `FS_GAHBCFG` writer
...
impl W {
    ///Bit 0 - Global interrupt mask
    #[inline(always)]
    pub fn gint(&mut self) -> GINT_W<'_, FS_GAHBCFGrs> {
        GINT_W::new(self, 0)
    }
    ///Bit 7 - TxFIFO empty level
    #[inline(always)]
    pub fn txfelvl(&mut self) -> TXFELVL_W<'_, FS_GAHBCFGrs> {
        TXFELVL_W::new(self, 7)
    }
    ///Bit 8 - Periodic TxFIFO empty level
    #[inline(always)]
    pub fn ptxfelvl(&mut self) -> PTXFELVL_W<'_, FS_GAHBCFGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#OTG_FS_GLOBAL:FS_GAHBCFG)*/
pub struct FS_GAHBCFGrs;
impl crate::RegisterSpec for FS_GAHBCFGrs {
    type Ux = u32;
}
///`read()` method returns [`fs_gahbcfg::R`](R) reader structure
impl crate::Readable for FS_GAHBCFGrs {}
///`write(|w| ..)` method takes [`fs_gahbcfg::W`](W) writer structure
impl crate::Writable for FS_GAHBCFGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FS_GAHBCFG to value 0
