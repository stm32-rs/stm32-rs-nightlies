...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#OTG_FS_GLOBAL:FS_GNPTXSTS)*/
pub struct FS_GNPTXSTSrs;
impl crate::RegisterSpec for FS_GNPTXSTSrs {
    type Ux = u32;
}
///`read()` method returns [`fs_gnptxsts::R`](R) reader structure
impl crate::Readable for FS_GNPTXSTSrs {}
///`reset()` method sets FS_GNPTXSTS to value 0x0008_0200
