///Register `OTG_HS_DIEPINT2` reader
pub type R = crate::R<OTG_HS_DIEPINT2rs>;
///Register `OTG_HS_DIEPINT2` writer
pub type W = crate::W<OTG_HS_DIEPINT2rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_DIEPINT2")
...
impl W {
    ///Bit 0 - Transfer completed interrupt
    #[inline(always)]
    pub fn xfrc(&mut self) -> XFRC_W<'_, OTG_HS_DIEPINT2rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - Endpoint disabled interrupt
    #[inline(always)]
    pub fn epdisd(&mut self) -> EPDISD_W<'_, OTG_HS_DIEPINT2rs> {
        EPDISD_W::new(self, 1)
    }
    ///Bit 3 - Timeout condition
    #[inline(always)]
    pub fn toc(&mut self) -> TOC_W<'_, OTG_HS_DIEPINT2rs> {
        TOC_W::new(self, 3)
    }
    ///Bit 4 - IN token received when TxFIFO is empty
    #[inline(always)]
    pub fn ittxfe(&mut self) -> ITTXFE_W<'_, OTG_HS_DIEPINT2rs> {
        ITTXFE_W::new(self, 4)
    }
    ///Bit 6 - IN endpoint NAK effective
    #[inline(always)]
    pub fn inepne(&mut self) -> INEPNE_W<'_, OTG_HS_DIEPINT2rs> {
        INEPNE_W::new(self, 6)
    }
    ///Bit 8 - Transmit Fifo Underrun
    #[inline(always)]
    pub fn txfifoudrn(&mut self) -> TXFIFOUDRN_W<'_, OTG_HS_DIEPINT2rs> {
        TXFIFOUDRN_W::new(self, 8)
    }
    ///Bit 9 - Buffer not available interrupt
    #[inline(always)]
    pub fn bna(&mut self) -> BNA_W<'_, OTG_HS_DIEPINT2rs> {
        BNA_W::new(self, 9)
    }
    ///Bit 11 - Packet dropped status
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PKTDRPSTS_W<'_, OTG_HS_DIEPINT2rs> {
        PKTDRPSTS_W::new(self, 11)
    }
    ///Bit 12 - Babble error interrupt
    #[inline(always)]
    pub fn berr(&mut self) -> BERR_W<'_, OTG_HS_DIEPINT2rs> {
        BERR_W::new(self, 12)
    }
    ///Bit 13 - NAK interrupt
    #[inline(always)]
    pub fn nak(&mut self) -> NAK_W<'_, OTG_HS_DIEPINT2rs> {
        NAK_W::new(self, 13)
    }
}
...
pub struct OTG_HS_DIEPINT2rs;
impl crate::RegisterSpec for OTG_HS_DIEPINT2rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_diepint2::R`](R) reader structure
impl crate::Readable for OTG_HS_DIEPINT2rs {}
///`write(|w| ..)` method takes [`otg_hs_diepint2::W`](W) writer structure
impl crate::Writable for OTG_HS_DIEPINT2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DIEPINT2 to value 0
impl crate::Resettable for OTG_HS_DIEPINT2rs {}
