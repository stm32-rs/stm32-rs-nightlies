///Register `OTG_HS_DTXFSTS0` reader
pub type R = crate::R<OTG_HS_DTXFSTS0rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_DTXFSTS0")
...
pub struct OTG_HS_DTXFSTS0rs;
impl crate::RegisterSpec for OTG_HS_DTXFSTS0rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_dtxfsts0::R`](R) reader structure
impl crate::Readable for OTG_HS_DTXFSTS0rs {}
///`reset()` method sets OTG_HS_DTXFSTS0 to value 0
impl crate::Resettable for OTG_HS_DTXFSTS0rs {}
