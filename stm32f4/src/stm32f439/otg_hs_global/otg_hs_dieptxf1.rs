///Register `OTG_HS_DIEPTXF1` reader
pub type R = crate::R<OTG_HS_DIEPTXF1rs>;
///Register `OTG_HS_DIEPTXF1` writer
pub type W = crate::W<OTG_HS_DIEPTXF1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HS_DIEPTXF1")
...
impl W {
    ///Bits 0:15 - IN endpoint FIFOx transmit RAM start address
    #[inline(always)]
    pub fn ineptxsa(&mut self) -> INEPTXSA_W<'_, OTG_HS_DIEPTXF1rs> {
        INEPTXSA_W::new(self, 0)
    }
    ///Bits 16:31 - IN endpoint TxFIFO depth
    #[inline(always)]
    pub fn ineptxfd(&mut self) -> INEPTXFD_W<'_, OTG_HS_DIEPTXF1rs> {
...
pub struct OTG_HS_DIEPTXF1rs;
impl crate::RegisterSpec for OTG_HS_DIEPTXF1rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hs_dieptxf1::R`](R) reader structure
impl crate::Readable for OTG_HS_DIEPTXF1rs {}
///`write(|w| ..)` method takes [`otg_hs_dieptxf1::W`](W) writer structure
impl crate::Writable for OTG_HS_DIEPTXF1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OTG_HS_DIEPTXF1 to value 0x0200_0400
impl crate::Resettable for OTG_HS_DIEPTXF1rs {
