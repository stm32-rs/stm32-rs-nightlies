...
///Field `PLLI2SNx` reader - PLLI2S multiplication factor for VCO
pub type PLLI2SNX_R = crate::FieldReader<u16>;
///Field `PLLI2SNx` writer - PLLI2S multiplication factor for VCO
pub type PLLI2SNX_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `PLLI2SRx` reader - PLLI2S division factor for I2S clocks
pub type PLLI2SRX_R = crate::FieldReader;
///Field `PLLI2SRx` writer - PLLI2S division factor for I2S clocks
...
impl W {
    ///Bits 6:14 - PLLI2S multiplication factor for VCO
    #[inline(always)]
    pub fn plli2snx(&mut self) -> PLLI2SNX_W<'_, PLLI2SCFGRrs> {
        PLLI2SNX_W::new(self, 6)
    }
    ///Bits 28:30 - PLLI2S division factor for I2S clocks
    #[inline(always)]
    pub fn plli2srx(&mut self) -> PLLI2SRX_W<'_, PLLI2SCFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F439.html#RCC:PLLI2SCFGR)*/
