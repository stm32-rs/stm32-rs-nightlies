...
///Field `MUTEDET` reader - Mute detection interrupt enable
pub type MUTEDET_R = crate::BitReader;
///Field `MUTEDET` writer - Mute detection interrupt enable
pub type MUTEDET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WCKCFG` reader - Wrong clock configuration interrupt enable
pub type WCKCFG_R = crate::BitReader;
///Field `WCKCFG` writer - Wrong clock configuration interrupt enable
...
///Field `LFSDET` reader - Late frame synchronization detection interrupt enable
pub type LFSDET_R = crate::BitReader;
///Field `LFSDET` writer - Late frame synchronization detection interrupt enable
...
impl W {
    ...
    ///Bit 1 - Mute detection interrupt enable
    #[inline(always)]
    pub fn mutedet(&mut self) -> MUTEDET_W<'_, AIMrs> {
        MUTEDET_W::new(self, 1)
    }
    ///Bit 2 - Wrong clock configuration interrupt enable
    #[inline(always)]
    pub fn wckcfg(&mut self) -> WCKCFG_W<'_, AIMrs> {
        WCKCFG_W::new(self, 2)
    }
    ///Bit 3 - FIFO request interrupt enable
    #[inline(always)]
    ...
    ///Bit 6 - Late frame synchronization detection interrupt enable
    #[inline(always)]
    pub fn lfsdet(&mut self) -> LFSDET_W<'_, AIMrs> {
        LFSDET_W::new(self, 6)
    }
}
