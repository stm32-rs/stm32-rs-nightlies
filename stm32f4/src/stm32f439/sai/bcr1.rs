...
///Field `OutDri` reader - Output drive
pub type OUT_DRI_R = crate::BitReader;
///Field `OutDri` writer - Output drive
pub type OUT_DRI_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAIBEN` reader - Audio block B enable
pub type SAIBEN_R = crate::BitReader;
///Field `SAIBEN` writer - Audio block B enable
pub type SAIBEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
///Field `MCJDIV` reader - Master clock divider
pub type MCJDIV_R = crate::FieldReader;
///Field `MCJDIV` writer - Master clock divider
pub type MCJDIV_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
...
impl W {
    ...
    ///Bit 13 - Output drive
    #[inline(always)]
    pub fn out_dri(&mut self) -> OUT_DRI_W<'_, BCR1rs> {
        OUT_DRI_W::new(self, 13)
    }
    ///Bit 16 - Audio block B enable
    #[inline(always)]
    pub fn saiben(&mut self) -> SAIBEN_W<'_, BCR1rs> {
        SAIBEN_W::new(self, 16)
    }
    ///Bit 17 - DMA enable
    #[inline(always)]
    ...
    ///Bits 20:23 - Master clock divider
    #[inline(always)]
    pub fn mcjdiv(&mut self) -> MCJDIV_W<'_, BCR1rs> {
        MCJDIV_W::new(self, 20)
    }
}
