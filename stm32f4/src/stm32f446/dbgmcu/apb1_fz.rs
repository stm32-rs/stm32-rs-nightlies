...
pub type DBG_I2CFMP_SMBUS_TIMEOUT_R = crate::BitReader;
///Field `DBG_I2CFMP_SMBUS_TIMEOUT` writer - SMBUS timeout mode stopped when Core is halted
pub type DBG_I2CFMP_SMBUS_TIMEOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB1_FZ")
            ...
            .field("dbg_i2cfmp_smbus_timeout", &self.dbg_i2cfmp_smbus_timeout())
...
impl W {
    ...
    ///Bit 24 - SMBUS timeout mode stopped when Core is halted
    #[inline(always)]
    pub fn dbg_i2cfmp_smbus_timeout(&mut self) -> DBG_I2CFMP_SMBUS_TIMEOUT_W<'_, APB1_FZrs> {
        DBG_I2CFMP_SMBUS_TIMEOUT_W::new(self, 24)
    }
    ///Bit 25 - DBG_CAN1_STOP
    #[inline(always)]
