/*!Peripheral access API for STM32F446 microcontrollers (generated using svd2rust v0.37.1 (773caae 2025-10-19))
...
pub static __INTERRUPTS: [Vector; 97] = [
    ...
    Vector { _handler: FMPI2C1 },
    Vector {
        _handler: FMPI2C1_ERROR,
    },
];
...
pub enum Interrupt {
    ...
    QUAD_SPI = 92,
    ///93 - HDMI-CEC global interrupt
    HDMI_CEC = 93,
    ///94 - SPDIF-Rx global interrupt
    SPDIF_RX = 94,
    ///95 - FMPI2C1 event interrupt
    FMPI2C1 = 95,
    ///96 - FMPI2C1 error interrupt
    FMPI2C1_ERROR = 96,
}
...
pub type HDMI_CEC = crate::Periph<hdmi_cec::RegisterBlock, 0x4000_6c00>;
