...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fmssr(&mut self) -> FMSSR_W<CRrs> {
        FMSSR_W::new(self, 20)
    }
    #[doc = "Bit 21 - Flash Interface Stop while System Run"]
    #[inline(always)]
    #[must_use]
    pub fn fissr(&mut self) -> FISSR_W<CRrs> {
        FISSR_W::new(self, 21)
    }
}
