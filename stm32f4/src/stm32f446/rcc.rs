...
impl RegisterBlock {
    ...
    ///0x8c - Dedicated Clock Configuration Register
    #[inline(always)]
    pub const fn dckcfgr(&self) -> &DCKCFGR {
        &self.dckcfgr
    }
    ///0x90 - clocks gated enable register
    #[inline(always)]
    pub const fn ckgatenr(&self) -> &CKGATENR {
        &self.ckgatenr
    }
    ///0x94 - dedicated clocks configuration register 2
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:CFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:CIR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:AHB1RSTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:AHB3RSTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:APB1RSTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:APB2RSTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:AHB2ENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:AHB3ENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:APB1ENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:APB2ENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:AHB1LPENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:AHB2LPENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:AHB3LPENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:APB1LPENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:APB2LPENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:BDCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:CSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:SSCGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:PLLI2SCFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:PLLSAICFGR)

For information about available fields see [`mod@pllsaicfgr`] module*/
pub type PLLSAICFGR = crate::Reg<pllsaicfgr::PLLSAICFGRrs>;
///PLL configuration register
pub mod pllsaicfgr;
/**DCKCFGR (rw) register accessor: Dedicated Clock Configuration Register

You can [`read`](crate::Reg::read) this register and get [`dckcfgr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dckcfgr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:DCKCFGR)

For information about available fields see [`mod@dckcfgr`] module*/
pub type DCKCFGR = crate::Reg<dckcfgr::DCKCFGRrs>;
///Dedicated Clock Configuration Register
pub mod dckcfgr;
/**CKGATENR (rw) register accessor: clocks gated enable register

You can [`read`](crate::Reg::read) this register and get [`ckgatenr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ckgatenr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F446.html#RCC:CKGATENR)

For information about available fields see [`mod@ckgatenr`] module*/
pub type CKGATENR = crate::Reg<ckgatenr::CKGATENRrs>;
///clocks gated enable register
pub mod ckgatenr;
/**DCKCFGR2 (rw) register accessor: dedicated clocks configuration register 2
