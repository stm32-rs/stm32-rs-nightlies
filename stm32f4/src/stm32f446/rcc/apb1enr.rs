...
///Field `SPDIFEN` reader - SPDIF-IN clock enable
...
///Field `CECEN` reader - CEC interface clock enable
...
///Field `SPDIFEN` writer - SPDIF-IN clock enable
...
///Field `CECEN` writer - CEC interface clock enable
...
impl W {
    ...
    ///Bit 16 - SPDIF-IN clock enable
    #[inline(always)]
    pub fn spdifen(&mut self) -> SPDIFEN_W<'_, APB1ENRrs> {
        SPDIFEN_W::new(self, 16)
    }
    ///Bit 17 - USART 2 clock enable
    #[inline(always)]
