...
///Field `PWRCTRL` reader - Power supply control bits. These bits are used to define the current functional state of the card clock
...
///Field `PWRCTRL` writer - Power supply control bits. These bits are used to define the current functional state of the card clock
...
impl R {
    ///Bits 0:1 - Power supply control bits. These bits are used to define the current functional state of the card clock
    #[inline(always)]
