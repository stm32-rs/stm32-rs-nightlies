...
///Field `WCMSB` reader - WordCount MSB This field configures the most significant byte of the header packet word count for long packets, or data 1 for short packets.
pub type WCMSB_R = crate::FieldReader;
///Field `WCMSB` writer - WordCount MSB This field configures the most significant byte of the header packet word count for long packets, or data 1 for short packets.
...
impl R {
    ...
    ///Bits 16:23 - WordCount MSB This field configures the most significant byte of the header packet word count for long packets, or data 1 for short packets.
    #[inline(always)]
