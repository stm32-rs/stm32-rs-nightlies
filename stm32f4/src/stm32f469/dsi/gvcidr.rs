...
///Field `VCID` reader - Virtual channel ID This field indicates the generic interface read-back virtual channel identification.
pub type VCID_R = crate::FieldReader;
///Field `VCID` writer - Virtual channel ID This field indicates the generic interface read-back virtual channel identification.
pub type VCID_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - Virtual channel ID This field indicates the generic interface read-back virtual channel identification.
    #[inline(always)]
