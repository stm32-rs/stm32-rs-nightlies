...
/**Acknowledge error %s interrupt enable
...
impl From<AEIE> for bool {
    #[inline(always)]
    fn from(variant: AEIE) -> Self {
        variant as u8 != 0
    }
}
///Field `AEIE(0-15)` reader - Acknowledge error %s interrupt enable
pub type AEIE_R = crate::BitReader<AEIE>;
impl AEIE_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> AEIE {
        match self.bits {
            false => AEIE::B0x0,
            true => AEIE::B0x1,
        }
    }
    ///Interrupt on acknowledge error 0 disabled
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == AEIE::B0x0
    }
    ///Interrupt on acknowledge error 0 enabled
    #[inline(always)]
...
pub type AEIE_W<'a, REG> = crate::BitWriter<'a, REG, AEIE>;
impl<'a, REG> AEIE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn b_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(AEIE::B0x0)
    }
    ///Interrupt on acknowledge error 0 enabled
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(AEIE::B0x1)
    }
}
/**PHY error %s interrupt enable
...
impl PEIE_R {
    ...
    ///Interrupt on PHY error 0 disabled
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == PEIE::B0x0
    }
    ///Interrupt on PHY error 0 enabled
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == PEIE::B0x1
    }
