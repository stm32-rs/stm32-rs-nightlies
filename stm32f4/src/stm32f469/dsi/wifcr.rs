...
///Field `CRRIF` writer - Clear regulator ready interrupt flag Write 1 clears the RRIF flag in the DSI_WSR register.
...
impl W {
    ...
    ///Bit 13 - Clear regulator ready interrupt flag Write 1 clears the RRIF flag in the DSI_WSR register.
    #[inline(always)]
