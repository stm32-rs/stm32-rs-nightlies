...
///Field `DSIEN` reader - DSI clocks enable
...
///Field `DSIEN` writer - DSI clocks enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F469.html#RCC:APB2ENR)*/
