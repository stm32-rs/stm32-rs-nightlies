...
impl W {
    ...
    ///Bit 27 - 48 MHz clock source selection
    #[inline(always)]
    pub fn ck48msel(&mut self) -> CK48MSEL_W<'_, DCKCFGRrs> {
        CK48MSEL_W::new(self, 27)
    }
    ///Bit 28 - SDIO clock source selection
    #[inline(always)]
    pub fn sdiosel(&mut self) -> SDIOSEL_W<'_, DCKCFGRrs> {
        SDIOSEL_W::new(self, 28)
    }
    ///Bit 29 - DSI clock source selection
    #[inline(always)]
    pub fn dsisel(&mut self) -> DSISEL_W<'_, DCKCFGRrs> {
        DSISEL_W::new(self, 29)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F469.html#RCC:DCKCFGR)*/
