...
pub type IM_R = crate::BitReader<IM>;
impl IM_R {
...
pub type IM_W<'a, REG> = crate::BitWriter<'a, REG, IM>;
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `IM0` field.</div>
    #[inline(always)]
    pub fn im(&mut self, n: u8) -> IM_W<IMRrs> {
        #[allow(clippy::no_effect)]
        [(); 24][n as usize];
        IM_W::new(self, n)
    }
    ///Bit 0 - Interrupt Mask on line 0
    #[inline(always)]
    pub fn im0(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 0)
    }
    ///Bit 1 - Interrupt Mask on line 1
    #[inline(always)]
    pub fn im1(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 1)
    }
    ///Bit 2 - Interrupt Mask on line 2
    #[inline(always)]
    pub fn im2(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 2)
    }
    ///Bit 3 - Interrupt Mask on line 3
    #[inline(always)]
    pub fn im3(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 3)
    }
    ///Bit 4 - Interrupt Mask on line 4
    #[inline(always)]
    pub fn im4(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 4)
    }
    ///Bit 5 - Interrupt Mask on line 5
    #[inline(always)]
    pub fn im5(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 5)
    }
    ///Bit 6 - Interrupt Mask on line 6
    #[inline(always)]
    pub fn im6(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 6)
    }
    ///Bit 7 - Interrupt Mask on line 7
    #[inline(always)]
    pub fn im7(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 7)
    }
    ///Bit 8 - Interrupt Mask on line 8
    #[inline(always)]
    pub fn im8(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 8)
    }
    ///Bit 9 - Interrupt Mask on line 9
    #[inline(always)]
    pub fn im9(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 9)
    }
    ///Bit 10 - Interrupt Mask on line 10
    #[inline(always)]
    pub fn im10(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 10)
    }
    ///Bit 11 - Interrupt Mask on line 11
    #[inline(always)]
    pub fn im11(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 11)
    }
    ///Bit 12 - Interrupt Mask on line 12
    #[inline(always)]
    pub fn im12(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 12)
    }
    ///Bit 13 - Interrupt Mask on line 13
    #[inline(always)]
    pub fn im13(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 13)
    }
    ///Bit 14 - Interrupt Mask on line 14
    #[inline(always)]
    pub fn im14(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 14)
    }
    ///Bit 15 - Interrupt Mask on line 15
    #[inline(always)]
    pub fn im15(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 15)
    }
    ///Bit 16 - Interrupt Mask on line 16
    #[inline(always)]
    pub fn im16(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 16)
    }
    ///Bit 17 - Interrupt Mask on line 17
    #[inline(always)]
    pub fn im17(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 17)
    }
    ///Bit 18 - Interrupt Mask on line 18
    #[inline(always)]
    pub fn im18(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 18)
    }
    ///Bit 19 - Interrupt Mask on line 19
    #[inline(always)]
    pub fn im19(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 19)
    }
    ///Bit 20 - Interrupt Mask on line 20
    #[inline(always)]
    pub fn im20(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 20)
    }
    ///Bit 21 - Interrupt Mask on line 21
    #[inline(always)]
    pub fn im21(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 21)
    }
    ///Bit 22 - Interrupt Mask on line 22
    #[inline(always)]
    pub fn im22(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 22)
    }
    ///Bit 23 - Interrupt Mask on line 23
    #[inline(always)]
    pub fn im23(&mut self) -> IM_W<IMRrs> {
        IM_W::new(self, 23)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F722.html#EXTI:IMR)*/
pub struct IMRrs;
