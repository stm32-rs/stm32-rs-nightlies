...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RDERRIE {
    ///0: PCROP error interrupt generation disabled
    Disabled = 0,
    ///1: PCROP error interrupt generation enabled
    Enabled = 1,
}
...
impl RDERRIE_R {
    ...
    ///PCROP error interrupt generation disabled
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == RDERRIE::Disabled
    }
    ///PCROP error interrupt generation enabled
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F722.html#FLASH:CR)*/
pub struct CRrs;
