...
///Field `RTCAPBEN` reader - RTCAPB clock enable
...
///Field `RTCAPBEN` writer - RTCAPB clock enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F722.html#RCC:APB1ENR)*/
