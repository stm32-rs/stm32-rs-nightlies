...
impl W {
    ///Bit 1 - TIMESTAMP mapping
    #[inline(always)]
    pub fn tsinsel(&mut self) -> TSINSEL_W<'_, ORrs> {
        TSINSEL_W::new(self, 1)
    }
    ///Bit 3 - RTC_ALARM on PC13 output type
    #[inline(always)]
    pub fn rtc_alarm_type(&mut self) -> RTC_ALARM_TYPE_W<'_, ORrs> {
        RTC_ALARM_TYPE_W::new(self, 3)
    }
}
/**option register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F722.html#RTC:OR)*/
pub struct ORrs;
