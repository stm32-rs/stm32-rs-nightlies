...
///Field `SMS` reader - Slave mode selection - bit\[2:0\]
...
///Field `SMS` writer - Slave mode selection - bit\[2:0\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F722.html#TIM1:SMCR)*/
pub struct SMCRrs;
