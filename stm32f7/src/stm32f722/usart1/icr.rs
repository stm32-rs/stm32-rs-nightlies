...
///Field `TCBGTCF` writer - Transmission completed before guard time clear flag
pub type TCBGTCF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F722.html#USART1:ICR)*/
pub struct ICRrs;
...
impl crate::Writable for ICRrs {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0002_1bdf;
}
