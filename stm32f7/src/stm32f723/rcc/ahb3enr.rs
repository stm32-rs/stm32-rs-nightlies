...
///Field `FMCEN` reader - Flexible memory controller module clock enable
...
///Field `FMCEN` writer - Flexible memory controller module clock enable
...
///Field `QSPIEN` reader - Quad SPI memory controller clock enable
pub use FMCEN_R as QSPIEN_R;
///Field `QSPIEN` writer - Quad SPI memory controller clock enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F723.html#RCC:AHB3ENR)*/
