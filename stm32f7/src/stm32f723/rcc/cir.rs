...
impl W {
    ...
    ///Bit 13 - PLLI2S ready interrupt enable
    #[inline(always)]
    pub fn plli2srdyie(&mut self) -> PLLI2SRDYIE_W<'_, CIRrs> {
        PLLI2SRDYIE_W::new(self, 13)
    }
    ///Bit 14 - PLLSAI Ready Interrupt Enable
    #[inline(always)]
    pub fn pllsairdyie(&mut self) -> PLLSAIRDYIE_W<'_, CIRrs> {
    ...
    #[inline(always)]
    pub fn plli2srdyc(&mut self) -> PLLI2SRDYC_W<'_, CIRrs> {
        PLLI2SRDYC_W::new(self, 21)
    }
    ///Bit 22 - PLLSAI Ready Interrupt Clear
    #[inline(always)]
    pub fn pllsairdyc(&mut self) -> PLLSAIRDYC_W<'_, CIRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F723.html#RCC:CIR)*/
pub struct CIRrs;
