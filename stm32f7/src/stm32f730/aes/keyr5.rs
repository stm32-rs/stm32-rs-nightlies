...
pub type AES_KEYR5_R = crate::FieldReader<u32>;
///Field `AES_KEYR5` writer - AES key register (MSB key \[191:160\])
pub type AES_KEYR5_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("KEYR5")
            .field("aes_keyr5", &self.aes_keyr5())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aes_keyr5(&mut self) -> AES_KEYR5_W<KEYR5rs> {
        AES_KEYR5_W::new(self, 0)
    }
}
/**key register 5
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F730.html#AES:KEYR5)*/
pub struct KEYR5rs;
