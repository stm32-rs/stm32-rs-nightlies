...
///Field `SWIER(0-23)` reader - Software Interrupt on line %s
...
///Field `SWIER(0-23)` writer - Software Interrupt on line %s
...
impl R {
    ///Software Interrupt on line (0-23)
    ///
    ...
    pub fn swier_iter(&self) -> impl Iterator<Item = SWIER_R> + '_ {
        (0..24).map(move |n| SWIER_R::new(((self.bits >> n) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn swier23(&self) -> SWIER_R {
        SWIER_R::new(((self.bits >> 23) & 1) != 0)
    }
}
...
impl W {
    ...
    ///Bit 23 - Software Interrupt on line 23
    #[inline(always)]
    pub fn swier23(&mut self) -> SWIER_W<'_, SWIERrs> {
        SWIER_W::new(self, 23)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F730.html#EXTI:SWIER)*/
pub struct SWIERrs;
