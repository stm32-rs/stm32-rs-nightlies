...
#[doc = "Software Interrupt on line 22"]
pub type SWIER23_A = SWIER0_A;
#[doc = "Field `SWIER23` reader - Software Interrupt on line 22"]
pub type SWIER23_R = SWIER0_R;
#[doc = "Field `SWIER23` writer - Software Interrupt on line 22"]
pub struct SWIER23_W<'a> {
    w: &'a mut W,
}
impl<'a> SWIER23_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: SWIER23_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Generates an interrupt request"]
    #[inline(always)]
    pub fn pend(self) -> &'a mut W {
        self.variant(SWIER23_A::PEND)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn swier23(&self) -> SWIER23_R {
        SWIER23_R::new(((self.bits >> 23) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Software Interrupt on line 0"]
    ...
    #[doc = "Bit 23 - Software Interrupt on line 22"]
    #[inline(always)]
    pub fn swier23(&mut self) -> SWIER23_W {
        SWIER23_W { w: self }
    }
