...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F730.html#FLASH:OPTCR1)*/
pub struct OPTCR1rs;
...
///`reset()` method sets OPTCR1 to value 0x0040_0080
impl crate::Resettable for OPTCR1rs {
    const RESET_VALUE: u32 = 0x0040_0080;
}
