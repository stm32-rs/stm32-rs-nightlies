...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `PCROP0` field.</div>
    #[inline(always)]
    pub fn pcrop(&mut self, n: u8) -> PCROP_W<OPTCR2rs> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
        PCROP_W::new(self, n)
    }
    ///Bit 0 - PCROP option byte
    #[inline(always)]
    pub fn pcrop0(&mut self) -> PCROP_W<OPTCR2rs> {
        PCROP_W::new(self, 0)
    }
    ///Bit 1 - PCROP option byte
    #[inline(always)]
    pub fn pcrop1(&mut self) -> PCROP_W<OPTCR2rs> {
        PCROP_W::new(self, 1)
    }
    ///Bit 2 - PCROP option byte
    #[inline(always)]
    pub fn pcrop2(&mut self) -> PCROP_W<OPTCR2rs> {
        PCROP_W::new(self, 2)
    }
    ///Bit 3 - PCROP option byte
    #[inline(always)]
    pub fn pcrop3(&mut self) -> PCROP_W<OPTCR2rs> {
        PCROP_W::new(self, 3)
    }
    ///Bit 4 - PCROP option byte
    #[inline(always)]
    pub fn pcrop4(&mut self) -> PCROP_W<OPTCR2rs> {
        PCROP_W::new(self, 4)
    }
    ///Bit 5 - PCROP option byte
    #[inline(always)]
    pub fn pcrop5(&mut self) -> PCROP_W<OPTCR2rs> {
        PCROP_W::new(self, 5)
    }
    ///Bit 6 - PCROP option byte
    #[inline(always)]
    pub fn pcrop6(&mut self) -> PCROP_W<OPTCR2rs> {
        PCROP_W::new(self, 6)
    }
    ///Bit 7 - PCROP option byte
    #[inline(always)]
    pub fn pcrop7(&mut self) -> PCROP_W<OPTCR2rs> {
        PCROP_W::new(self, 7)
    }
    ///Bit 31 - PCROP zone preserved when RDP level decreased
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F730.html#FLASH:OPTCR2)*/
pub struct OPTCR2rs;
