...
pub struct R(crate::R<OTG_HS_PCGCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_HS_PCGCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_HS_PCGCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_HS_PCGCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OTG_HS_PCGCR` writer"]
pub struct W(crate::W<OTG_HS_PCGCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OTG_HS_PCGCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OTG_HS_PCGCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OTG_HS_PCGCR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Power and clock gating control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [otg_hs_pcgcr](index.html) module"]
