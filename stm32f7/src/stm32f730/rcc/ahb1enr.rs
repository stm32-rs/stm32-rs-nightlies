...
pub type DTCMRAMEN_A = GPIOAEN_A;
#[doc = "Field `DTCMRAMEN` reader - CCM data RAM clock enable"]
pub type DTCMRAMEN_R = GPIOAEN_R;
#[doc = "Field `DTCMRAMEN` writer - CCM data RAM clock enable"]
pub struct DTCMRAMEN_W<'a> {
    w: &'a mut W,
}
impl<'a> DTCMRAMEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: DTCMRAMEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "The selected clock is disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(DTCMRAMEN_A::DISABLED)
    }
    #[doc = "The selected clock is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(DTCMRAMEN_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn dtcmramen(&self) -> DTCMRAMEN_R {
        DTCMRAMEN_R::new(((self.bits >> 20) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 20 - CCM data RAM clock enable"]
    #[inline(always)]
    pub fn dtcmramen(&mut self) -> DTCMRAMEN_W {
        DTCMRAMEN_W { w: self }
    }
    #[doc = "Bit 18 - Backup SRAM interface clock enable"]
    #[inline(always)]
