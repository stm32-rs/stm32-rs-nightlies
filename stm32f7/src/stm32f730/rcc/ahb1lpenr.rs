...
#[doc = "Reader of field `AXILPEN`"]
pub type AXILPEN_R = crate::R<bool, GPIOALPEN_A>;
#[doc = "Write proxy for field `AXILPEN`"]
...
#[doc = "Reader of field `DTCMLPEN`"]
pub type DTCMLPEN_R = crate::R<bool, GPIOALPEN_A>;
#[doc = "Write proxy for field `DTCMLPEN`"]
