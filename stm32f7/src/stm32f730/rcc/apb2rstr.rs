...
#[doc = "SDMMC2 reset"]
pub type SDMMC2RST_A = TIM1RST_A;
#[doc = "Field `SDMMC2RST` reader - SDMMC2 reset"]
pub type SDMMC2RST_R = TIM1RST_R;
...
pub type USBPHYCRST_A = TIM1RST_A;
#[doc = "Field `USBPHYCRST` reader - USB OTG HS PHY controller reset"]
pub type USBPHYCRST_R = TIM1RST_R;
#[doc = "Field `USBPHYCRST` writer - USB OTG HS PHY controller reset"]
pub struct USBPHYCRST_W<'a> {
    w: &'a mut W,
}
impl<'a> USBPHYCRST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: USBPHYCRST_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Reset the selected module"]
    #[inline(always)]
    pub fn reset(self) -> &'a mut W {
        self.variant(USBPHYCRST_A::RESET)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl W {
    ...
    #[doc = "Bit 31 - USB OTG HS PHY controller reset"]
    #[inline(always)]
    pub fn usbphycrst(&mut self) -> USBPHYCRST_W {
        USBPHYCRST_W { w: self }
    }
