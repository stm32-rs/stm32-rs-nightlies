...
///Field `USBPHYCRST` reader - USB OTG HS PHY controller reset
...
///Field `USBPHYCRST` writer - USB OTG HS PHY controller reset
...
impl W {
    ...
    ///Bit 7 - SDMMC2 reset
    #[inline(always)]
    pub fn sdmmc2rst(&mut self) -> SDMMC2RST_W<APB2RSTRrs> {
    ...
    ///Bit 11 - SDMMC1 reset
    #[inline(always)]
    pub fn sdmmc1rst(&mut self) -> SDMMC1RST_W<APB2RSTRrs> {
    ...
    ///Bit 31 - USB OTG HS PHY controller reset
    #[inline(always)]
    pub fn usbphycrst(&mut self) -> USBPHYCRST_W<APB2RSTRrs> {
        USBPHYCRST_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F730.html#RCC:APB2RSTR)*/
