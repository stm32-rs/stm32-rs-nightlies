...
///Field `ASTRTEN` reader - Asynchronous start enable
...
///Field `ASTRTEN` writer - Asynchronous start enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F730.html#SPI1:I2SCFGR)*/
