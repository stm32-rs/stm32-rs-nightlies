...
///Field `TR(0-23)` reader - Falling trigger event configuration of line %s
...
///Field `TR(0-23)` writer - Falling trigger event configuration of line %s
...
impl R {
    ///Falling trigger event configuration of line (0-23)
    ///
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `TR0` field.</div>
    #[inline(always)]
    pub fn tr(&mut self, n: u8) -> TR_W<'_, FTSRrs> {
        #[allow(clippy::no_effect)]
        [(); 24][n as usize];
        TR_W::new(self, n)
    }
    ///Bit 0 - Falling trigger event configuration of line 0
    #[inline(always)]
    pub fn tr0(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 0)
    }
    ///Bit 1 - Falling trigger event configuration of line 1
    #[inline(always)]
    pub fn tr1(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 1)
    }
    ///Bit 2 - Falling trigger event configuration of line 2
    #[inline(always)]
    pub fn tr2(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 2)
    }
    ///Bit 3 - Falling trigger event configuration of line 3
    #[inline(always)]
    pub fn tr3(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 3)
    }
    ///Bit 4 - Falling trigger event configuration of line 4
    #[inline(always)]
    pub fn tr4(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 4)
    }
    ///Bit 5 - Falling trigger event configuration of line 5
    #[inline(always)]
    pub fn tr5(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 5)
    }
    ///Bit 6 - Falling trigger event configuration of line 6
    #[inline(always)]
    pub fn tr6(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 6)
    }
    ///Bit 7 - Falling trigger event configuration of line 7
    #[inline(always)]
    pub fn tr7(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 7)
    }
    ///Bit 8 - Falling trigger event configuration of line 8
    #[inline(always)]
    pub fn tr8(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 8)
    }
    ///Bit 9 - Falling trigger event configuration of line 9
    #[inline(always)]
    pub fn tr9(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 9)
    }
    ///Bit 10 - Falling trigger event configuration of line 10
    #[inline(always)]
    pub fn tr10(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 10)
    }
    ///Bit 11 - Falling trigger event configuration of line 11
    #[inline(always)]
    pub fn tr11(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 11)
    }
    ///Bit 12 - Falling trigger event configuration of line 12
    #[inline(always)]
    pub fn tr12(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 12)
    }
    ///Bit 13 - Falling trigger event configuration of line 13
    #[inline(always)]
    pub fn tr13(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 13)
    }
    ///Bit 14 - Falling trigger event configuration of line 14
    #[inline(always)]
    pub fn tr14(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 14)
    }
    ///Bit 15 - Falling trigger event configuration of line 15
    #[inline(always)]
    pub fn tr15(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 15)
    }
    ///Bit 16 - Falling trigger event configuration of line 16
    #[inline(always)]
    pub fn tr16(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 16)
    }
    ///Bit 17 - Falling trigger event configuration of line 17
    #[inline(always)]
    pub fn tr17(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 17)
    }
    ///Bit 18 - Falling trigger event configuration of line 18
    #[inline(always)]
    pub fn tr18(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 18)
    }
    ///Bit 19 - Falling trigger event configuration of line 19
    #[inline(always)]
    pub fn tr19(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 19)
    }
    ///Bit 20 - Falling trigger event configuration of line 20
    #[inline(always)]
    pub fn tr20(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 20)
    }
    ///Bit 21 - Falling trigger event configuration of line 21
    #[inline(always)]
    pub fn tr21(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 21)
    }
    ///Bit 22 - Falling trigger event configuration of line 22
    #[inline(always)]
    pub fn tr22(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 22)
    }
    ///Bit 23 - Falling trigger event configuration of line 23
    #[inline(always)]
    pub fn tr23(&mut self) -> TR_W<'_, FTSRrs> {
        TR_W::new(self, 23)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F732.html#EXTI:FTSR)*/
pub struct FTSRrs;
