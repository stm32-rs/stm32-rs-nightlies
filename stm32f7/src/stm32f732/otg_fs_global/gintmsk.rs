...
///Field `LPMIN` reader - LPM interrupt mask
pub type LPMIN_R = crate::BitReader;
///Field `LPMIN` writer - LPM interrupt mask
...
impl W {
    ...
    ///Bit 21 - Incomplete periodic transfer mask(Host mode)/Incomplete isochronous OUT transfer mask(Device mode)
    #[inline(always)]
    pub fn ipxfrm_iisooxfrm(&mut self) -> IPXFRM_IISOOXFRM_W<'_, GINTMSKrs> {
        IPXFRM_IISOOXFRM_W::new(self, 21)
    }
    ///Bit 23 - Reset detected interrupt mask
    #[inline(always)]
    pub fn rstdetm(&mut self) -> RSTDETM_W<'_, GINTMSKrs> {
        RSTDETM_W::new(self, 23)
    }
    ///Bit 24 - Host port interrupt mask
    #[inline(always)]
    pub fn prtim(&mut self) -> PRTIM_W<'_, GINTMSKrs> {
        PRTIM_W::new(self, 24)
    }
    ///Bit 25 - Host channels interrupt mask
    #[inline(always)]
    ...
    ///Bit 27 - LPM interrupt mask
    #[inline(always)]
    pub fn lpmin(&mut self) -> LPMIN_W<'_, GINTMSKrs> {
        LPMIN_W::new(self, 27)
    }
    ///Bit 28 - Connector ID status change mask
    #[inline(always)]
