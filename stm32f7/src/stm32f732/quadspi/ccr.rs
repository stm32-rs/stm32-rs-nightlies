...
///Field `DHHC` reader - DDR hold half cycle
...
///Field `DHHC` writer - DDR hold half cycle
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F732.html#QUADSPI:CCR)*/
pub struct CCRrs;
