...
///Field `RTCAPBLPEN` reader - RTCAPB clock enable during Sleep mode
...
///Field `RTCAPBLPEN` writer - RTCAPB clock enable during Sleep mode
...
impl R {
    ...
    ///Bit 10 - RTCAPB clock enable during Sleep mode
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F732.html#RCC:APB1LPENR)*/
