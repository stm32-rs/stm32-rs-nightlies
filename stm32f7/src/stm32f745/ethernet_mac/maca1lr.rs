...
///Field `MACA1L` reader - MACA1LR
pub type MACA1L_R = crate::FieldReader<u32>;
///Field `MACA1L` writer - MACA1LR
pub type MACA1L_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
    ///Bits 0:31 - MACA1LR
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F745.html#Ethernet_MAC:MACA1LR)*/
