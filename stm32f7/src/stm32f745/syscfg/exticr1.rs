...
pub enum EXTI0 {
    ...
    Pj = 9,
    ///10: Select PKx as the source input for the EXTIx external interrupt
    Pk = 10,
}
...
impl EXTI0_R {
    ...
    ///Select PKx as the source input for the EXTIx external interrupt
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    ///Select PKx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pk(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI0::Pk)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F745.html#SYSCFG:EXTICR1)*/
