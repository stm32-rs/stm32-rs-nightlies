...
impl W {
    ...
    ///Bits 0:4 - 1 conversion in regular sequence
    #[inline(always)]
    pub fn sq1(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 0)
    }
    ///Bits 5:9 - 2 conversion in regular sequence
    #[inline(always)]
    pub fn sq2(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 5)
    }
    ///Bits 10:14 - 3 conversion in regular sequence
    #[inline(always)]
    pub fn sq3(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 10)
    }
    ///Bits 15:19 - 4 conversion in regular sequence
    #[inline(always)]
    pub fn sq4(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 15)
    }
    ///Bits 20:24 - 5 conversion in regular sequence
    #[inline(always)]
    pub fn sq5(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 20)
    }
    ///Bits 25:29 - 6 conversion in regular sequence
    #[inline(always)]
    pub fn sq6(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 25)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F750.html#ADC1:SQR3)*/
pub struct SQR3rs;
