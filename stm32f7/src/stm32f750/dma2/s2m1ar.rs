#[doc = "Reader of register S2M1AR"]
pub type R = crate::R<u32, super::S2M1AR>;
#[doc = "Writer for register S2M1AR"]
pub type W = crate::W<u32, super::S2M1AR>;
#[doc = "Register S2M1AR `reset()`'s with value 0"]
impl crate::ResetValue for super::S2M1AR {
    type Type = u32;
    #[inline(always)]
