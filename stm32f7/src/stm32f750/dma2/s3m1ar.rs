#[doc = "Reader of register S3M1AR"]
pub type R = crate::R<u32, super::S3M1AR>;
#[doc = "Writer for register S3M1AR"]
pub type W = crate::W<u32, super::S3M1AR>;
#[doc = "Register S3M1AR `reset()`'s with value 0"]
impl crate::ResetValue for super::S3M1AR {
    type Type = u32;
    #[inline(always)]
