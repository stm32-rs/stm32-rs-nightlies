#[doc = "Reader of register S6M1AR"]
pub type R = crate::R<u32, super::S6M1AR>;
#[doc = "Writer for register S6M1AR"]
pub type W = crate::W<u32, super::S6M1AR>;
#[doc = "Register S6M1AR `reset()`'s with value 0"]
impl crate::ResetValue for super::S6M1AR {
    type Type = u32;
    #[inline(always)]
