...
pub use crate::stm32f750::gpioa::ospeedr::OSPEEDR_R;
///Field `OSPEEDR(0-15)` writer - Port x configuration pin %s
pub use crate::stm32f750::gpioa::ospeedr::OSPEEDR_W;
///Port x configuration pin %s
pub use crate::stm32f750::gpioa::ospeedr::OUTPUT_SPEED;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F750.html#GPIOD:OSPEEDR)*/
