#[doc = "Reader of register OTG_FS_HPTXSTS"]
pub type R = crate::R<u32, super::OTG_FS_HPTXSTS>;
#[doc = "Writer for register OTG_FS_HPTXSTS"]
pub type W = crate::W<u32, super::OTG_FS_HPTXSTS>;
#[doc = "Register OTG_FS_HPTXSTS `reset()`'s with value 0x0008_0100"]
impl crate::ResetValue for super::OTG_FS_HPTXSTS {
    type Type = u32;
    #[inline(always)]
