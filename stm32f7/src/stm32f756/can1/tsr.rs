...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `RQCP0` field.</div>
    #[inline(always)]
    pub fn rqcp(&mut self, n: u8) -> RQCP_W<TSRrs> {
        #[allow(clippy::no_effect)]
        [(); 3][n as usize];
        RQCP_W::new(self, n * 8)
    }
    ///Bit 0 - RQCP0
    #[inline(always)]
    pub fn rqcp0(&mut self) -> RQCP_W<TSRrs> {
        RQCP_W::new(self, 0)
    }
    ///Bit 8 - RQCP1
    #[inline(always)]
    pub fn rqcp1(&mut self) -> RQCP_W<TSRrs> {
        RQCP_W::new(self, 8)
    }
    ///Bit 16 - RQCP2
    #[inline(always)]
    pub fn rqcp2(&mut self) -> RQCP_W<TSRrs> {
        RQCP_W::new(self, 16)
    }
    ///TXOK(0-2)
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `TXOK0` field.</div>
    #[inline(always)]
    pub fn txok(&mut self, n: u8) -> TXOK_W<TSRrs> {
        #[allow(clippy::no_effect)]
        [(); 3][n as usize];
    ...
    ///Bit 1 - TXOK0
    #[inline(always)]
    pub fn txok0(&mut self) -> TXOK_W<TSRrs> {
        TXOK_W::new(self, 1)
    }
    ///Bit 9 - TXOK1
    #[inline(always)]
    pub fn txok1(&mut self) -> TXOK_W<TSRrs> {
        TXOK_W::new(self, 9)
    }
    ///Bit 17 - TXOK2
    #[inline(always)]
    pub fn txok2(&mut self) -> TXOK_W<TSRrs> {
        TXOK_W::new(self, 17)
    }
    ///ALST(0-2)
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `ALST0` field.</div>
    #[inline(always)]
    pub fn alst(&mut self, n: u8) -> ALST_W<TSRrs> {
        #[allow(clippy::no_effect)]
        [(); 3][n as usize];
    ...
    ///Bit 2 - ALST0
    #[inline(always)]
    pub fn alst0(&mut self) -> ALST_W<TSRrs> {
        ALST_W::new(self, 2)
    }
    ///Bit 10 - ALST1
    #[inline(always)]
    pub fn alst1(&mut self) -> ALST_W<TSRrs> {
        ALST_W::new(self, 10)
    }
    ///Bit 18 - ALST2
    #[inline(always)]
    pub fn alst2(&mut self) -> ALST_W<TSRrs> {
        ALST_W::new(self, 18)
    }
    ///TERR(0-2)
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `TERR0` field.</div>
    #[inline(always)]
    pub fn terr(&mut self, n: u8) -> TERR_W<TSRrs> {
        #[allow(clippy::no_effect)]
        [(); 3][n as usize];
    ...
    ///Bit 3 - TERR0
    #[inline(always)]
    pub fn terr0(&mut self) -> TERR_W<TSRrs> {
        TERR_W::new(self, 3)
    }
    ///Bit 11 - TERR1
    #[inline(always)]
    pub fn terr1(&mut self) -> TERR_W<TSRrs> {
        TERR_W::new(self, 11)
    }
    ///Bit 19 - TERR2
    #[inline(always)]
    pub fn terr2(&mut self) -> TERR_W<TSRrs> {
        TERR_W::new(self, 19)
    }
    ///ABRQ(0-2)
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `ABRQ0` field.</div>
    #[inline(always)]
    pub fn abrq(&mut self, n: u8) -> ABRQ_W<TSRrs> {
        #[allow(clippy::no_effect)]
        [(); 3][n as usize];
    ...
    ///Bit 7 - ABRQ0
    #[inline(always)]
    pub fn abrq0(&mut self) -> ABRQ_W<TSRrs> {
        ABRQ_W::new(self, 7)
    }
    ///Bit 15 - ABRQ1
    #[inline(always)]
    pub fn abrq1(&mut self) -> ABRQ_W<TSRrs> {
        ABRQ_W::new(self, 15)
    }
    ///Bit 23 - ABRQ2
    #[inline(always)]
    pub fn abrq2(&mut self) -> ABRQ_W<TSRrs> {
        ABRQ_W::new(self, 23)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F756.html#CAN1:TSR)*/
pub struct TSRrs;
