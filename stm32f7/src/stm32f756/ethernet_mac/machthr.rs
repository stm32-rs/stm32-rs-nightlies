...
///Field `HTH` reader - Upper 32 bits of hash table
pub type HTH_R = crate::FieldReader<u32>;
///Field `HTH` writer - Upper 32 bits of hash table
pub type HTH_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
