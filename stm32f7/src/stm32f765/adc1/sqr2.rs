...
impl W {
    ...
    ///Bits 15:19 - 10 conversion in regular sequence
    #[inline(always)]
    pub fn sq10(&mut self) -> SQ_W<SQR2rs> {
        SQ_W::new(self, 15)
    }
    ///Bits 20:24 - 11 conversion in regular sequence
    #[inline(always)]
    pub fn sq11(&mut self) -> SQ_W<SQR2rs> {
        SQ_W::new(self, 20)
    }
    ///Bits 25:29 - 12 conversion in regular sequence
    #[inline(always)]
    pub fn sq12(&mut self) -> SQ_W<SQR2rs> {
        SQ_W::new(self, 25)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#ADC1:SQR2)*/
pub struct SQR2rs;
