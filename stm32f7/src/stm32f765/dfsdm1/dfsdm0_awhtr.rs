///Register `DFSDM0_AWHTR` reader
pub type R = crate::R<DFSDM0_AWHTRrs>;
///Register `DFSDM0_AWHTR` writer
pub type W = crate::W<DFSDM0_AWHTRrs>;
...
impl W {
    ///Bits 0:3 - Break signal assignment to analog watchdog high threshold event
    #[inline(always)]
    pub fn bkawh(&mut self) -> BKAWH_W<DFSDM0_AWHTRrs> {
        BKAWH_W::new(self, 0)
    }
    ///Bits 8:31 - Analog watchdog high threshold
    #[inline(always)]
    pub fn awht(&mut self) -> AWHT_W<DFSDM0_AWHTRrs> {
        AWHT_W::new(self, 8)
    }
}
/**DFSDM analog watchdog high threshold register

You can [`read`](crate::Reg::read) this register and get [`dfsdm0_awhtr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm0_awhtr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM0_AWHTR)*/
pub struct DFSDM0_AWHTRrs;
impl crate::RegisterSpec for DFSDM0_AWHTRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm0_awhtr::R`](R) reader structure
impl crate::Readable for DFSDM0_AWHTRrs {}
///`write(|w| ..)` method takes [`dfsdm0_awhtr::W`](W) writer structure
impl crate::Writable for DFSDM0_AWHTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM0_AWHTR to value 0
impl crate::Resettable for DFSDM0_AWHTRrs {
