///Register `DFSDM0_CR1` reader
pub type R = crate::R<DFSDM0_CR1rs>;
///Register `DFSDM0_CR1` writer
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm0_cr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm0_cr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dfsdm0_cr1::R`](R) reader structure
impl crate::Readable for DFSDM0_CR1rs {}
///`write(|w| ..)` method takes [`dfsdm0_cr1::W`](W) writer structure
impl crate::Writable for DFSDM0_CR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM0_CR1 to value 0
