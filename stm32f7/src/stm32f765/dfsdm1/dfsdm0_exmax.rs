...
pub type R = crate::R<DFSDM0_EXMAXrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm0_exmax::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM0_EXMAX)*/
pub struct DFSDM0_EXMAXrs;
impl crate::RegisterSpec for DFSDM0_EXMAXrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm0_exmax::R`](R) reader structure
impl crate::Readable for DFSDM0_EXMAXrs {}
///`reset()` method sets DFSDM0_EXMAX to value 0
impl crate::Resettable for DFSDM0_EXMAXrs {
