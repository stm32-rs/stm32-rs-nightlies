...
You can [`read`](crate::Reg::read) this register and get [`dfsdm0_exmin::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dfsdm0_exmin::R`](R) reader structure
impl crate::Readable for DFSDM0_EXMINrs {}
///`reset()` method sets DFSDM0_EXMIN to value 0x7fff_ff00
