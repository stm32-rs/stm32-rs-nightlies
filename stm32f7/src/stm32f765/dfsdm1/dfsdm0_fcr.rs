///Register `DFSDM0_FCR` reader
pub type R = crate::R<DFSDM0_FCRrs>;
///Register `DFSDM0_FCR` writer
pub type W = crate::W<DFSDM0_FCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iosr(&mut self) -> IOSR_W<DFSDM0_FCRrs> {
        IOSR_W::new(self, 0)
    }
    ///Bits 16:25 - Sinc filter oversampling ratio (decimation rate)
    #[inline(always)]
    #[must_use]
    pub fn fosr(&mut self) -> FOSR_W<DFSDM0_FCRrs> {
        FOSR_W::new(self, 16)
    }
    ///Bits 29:31 - Sinc filter order
    #[inline(always)]
    #[must_use]
    pub fn ford(&mut self) -> FORD_W<DFSDM0_FCRrs> {
        FORD_W::new(self, 29)
    }
}
/**DFSDM filter control register

You can [`read`](crate::Reg::read) this register and get [`dfsdm0_fcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm0_fcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM0_FCR)*/
pub struct DFSDM0_FCRrs;
impl crate::RegisterSpec for DFSDM0_FCRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm0_fcr::R`](R) reader structure
impl crate::Readable for DFSDM0_FCRrs {}
///`write(|w| ..)` method takes [`dfsdm0_fcr::W`](W) writer structure
impl crate::Writable for DFSDM0_FCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM0_FCR to value 0
impl crate::Resettable for DFSDM0_FCRrs {
