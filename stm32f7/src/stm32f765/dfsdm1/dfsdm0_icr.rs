...
pub type R = crate::R<DFSDM0_ICRrs>;
///Register `DFSDM0_ICR` writer
pub type W = crate::W<DFSDM0_ICRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrjovrf(&mut self) -> CLRJOVRF_W<DFSDM0_ICRrs> {
        CLRJOVRF_W::new(self, 2)
    }
    ///Bit 3 - Clear the regular conversion overrun flag
    #[inline(always)]
    #[must_use]
    pub fn clrrovrf(&mut self) -> CLRROVRF_W<DFSDM0_ICRrs> {
        CLRROVRF_W::new(self, 3)
    }
    ///Bits 16:23 - Clear the clock absence flag
    #[inline(always)]
    #[must_use]
    pub fn clrckabf(&mut self) -> CLRCKABF_W<DFSDM0_ICRrs> {
        CLRCKABF_W::new(self, 16)
    }
    ///Bits 24:31 - Clear the short-circuit detector flag
    #[inline(always)]
    #[must_use]
    pub fn clrscdf(&mut self) -> CLRSCDF_W<DFSDM0_ICRrs> {
        CLRSCDF_W::new(self, 24)
    }
}
/**DFSDM interrupt flag clear register

You can [`read`](crate::Reg::read) this register and get [`dfsdm0_icr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm0_icr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM0_ICR)*/
pub struct DFSDM0_ICRrs;
impl crate::RegisterSpec for DFSDM0_ICRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm0_icr::R`](R) reader structure
impl crate::Readable for DFSDM0_ICRrs {}
///`write(|w| ..)` method takes [`dfsdm0_icr::W`](W) writer structure
impl crate::Writable for DFSDM0_ICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM0_ICR to value 0
impl crate::Resettable for DFSDM0_ICRrs {
