///Register `DFSDM2_AWCFR` reader
pub type R = crate::R<DFSDM2_AWCFRrs>;
///Register `DFSDM2_AWCFR` writer
pub type W = crate::W<DFSDM2_AWCFRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrawltf(&mut self) -> CLRAWLTF_W<DFSDM2_AWCFRrs> {
        CLRAWLTF_W::new(self, 0)
    }
    ///Bits 8:15 - Clear the analog watchdog high threshold flag
    #[inline(always)]
    #[must_use]
    pub fn clrawhtf(&mut self) -> CLRAWHTF_W<DFSDM2_AWCFRrs> {
        CLRAWHTF_W::new(self, 8)
    }
}
/**DFSDM analog watchdog clear flag register

You can [`read`](crate::Reg::read) this register and get [`dfsdm2_awcfr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm2_awcfr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM2_AWCFR)*/
pub struct DFSDM2_AWCFRrs;
impl crate::RegisterSpec for DFSDM2_AWCFRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm2_awcfr::R`](R) reader structure
impl crate::Readable for DFSDM2_AWCFRrs {}
///`write(|w| ..)` method takes [`dfsdm2_awcfr::W`](W) writer structure
impl crate::Writable for DFSDM2_AWCFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM2_AWCFR to value 0
impl crate::Resettable for DFSDM2_AWCFRrs {
