///Register `DFSDM2_AWHTR` reader
pub type R = crate::R<DFSDM2_AWHTRrs>;
///Register `DFSDM2_AWHTR` writer
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm2_awhtr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm2_awhtr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dfsdm2_awhtr::R`](R) reader structure
impl crate::Readable for DFSDM2_AWHTRrs {}
///`write(|w| ..)` method takes [`dfsdm2_awhtr::W`](W) writer structure
impl crate::Writable for DFSDM2_AWHTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM2_AWHTR to value 0
