#[doc = "Reader of register DFSDM2_AWHTR"]
pub type R = crate::R<u32, super::DFSDM2_AWHTR>;
#[doc = "Writer for register DFSDM2_AWHTR"]
pub type W = crate::W<u32, super::DFSDM2_AWHTR>;
#[doc = "Register DFSDM2_AWHTR `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM2_AWHTR {
    type Type = u32;
    #[inline(always)]
