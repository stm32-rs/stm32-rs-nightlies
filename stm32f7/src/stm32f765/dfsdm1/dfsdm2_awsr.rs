...
pub type R = crate::R<DFSDM2_AWSRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm2_awsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM2_AWSR)*/
pub struct DFSDM2_AWSRrs;
impl crate::RegisterSpec for DFSDM2_AWSRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm2_awsr::R`](R) reader structure
impl crate::Readable for DFSDM2_AWSRrs {}
///`reset()` method sets DFSDM2_AWSR to value 0
impl crate::Resettable for DFSDM2_AWSRrs {
