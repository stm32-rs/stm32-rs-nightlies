...
pub type R = crate::R<DFSDM2_EXMINrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm2_exmin::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM2_EXMIN)*/
pub struct DFSDM2_EXMINrs;
impl crate::RegisterSpec for DFSDM2_EXMINrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm2_exmin::R`](R) reader structure
impl crate::Readable for DFSDM2_EXMINrs {}
///`reset()` method sets DFSDM2_EXMIN to value 0x7fff_ff00
impl crate::Resettable for DFSDM2_EXMINrs {
