...
pub type R = crate::R<DFSDM2_ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm2_isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM2_ISR)*/
pub struct DFSDM2_ISRrs;
impl crate::RegisterSpec for DFSDM2_ISRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm2_isr::R`](R) reader structure
impl crate::Readable for DFSDM2_ISRrs {}
///`reset()` method sets DFSDM2_ISR to value 0x00ff_0000
impl crate::Resettable for DFSDM2_ISRrs {
