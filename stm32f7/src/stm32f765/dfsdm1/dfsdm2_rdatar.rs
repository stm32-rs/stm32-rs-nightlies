...
pub type R = crate::R<DFSDM2_RDATARrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm2_rdatar::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM2_RDATAR)*/
pub struct DFSDM2_RDATARrs;
impl crate::RegisterSpec for DFSDM2_RDATARrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm2_rdatar::R`](R) reader structure
impl crate::Readable for DFSDM2_RDATARrs {}
///`reset()` method sets DFSDM2_RDATAR to value 0
impl crate::Resettable for DFSDM2_RDATARrs {
