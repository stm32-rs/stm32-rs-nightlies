///Register `DFSDM3_AWLTR` reader
pub type R = crate::R<DFSDM3_AWLTRrs>;
///Register `DFSDM3_AWLTR` writer
pub type W = crate::W<DFSDM3_AWLTRrs>;
...
impl W {
    ///Bits 0:3 - Break signal assignment to analog watchdog low threshold event
    #[inline(always)]
    pub fn bkawl(&mut self) -> BKAWL_W<DFSDM3_AWLTRrs> {
        BKAWL_W::new(self, 0)
    }
    ///Bits 8:31 - Analog watchdog low threshold
    #[inline(always)]
    pub fn awlt(&mut self) -> AWLT_W<DFSDM3_AWLTRrs> {
        AWLT_W::new(self, 8)
    }
}
/**DFSDM analog watchdog low threshold register

You can [`read`](crate::Reg::read) this register and get [`dfsdm3_awltr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm3_awltr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM3_AWLTR)*/
pub struct DFSDM3_AWLTRrs;
impl crate::RegisterSpec for DFSDM3_AWLTRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm3_awltr::R`](R) reader structure
impl crate::Readable for DFSDM3_AWLTRrs {}
///`write(|w| ..)` method takes [`dfsdm3_awltr::W`](W) writer structure
impl crate::Writable for DFSDM3_AWLTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM3_AWLTR to value 0
impl crate::Resettable for DFSDM3_AWLTRrs {
