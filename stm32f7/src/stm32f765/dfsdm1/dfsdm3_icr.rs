...
pub type R = crate::R<DFSDM3_ICRrs>;
///Register `DFSDM3_ICR` writer
pub type W = crate::W<DFSDM3_ICRrs>;
...
impl W {
    ///Bit 2 - Clear the injected conversion overrun flag
    #[inline(always)]
    pub fn clrjovrf(&mut self) -> CLRJOVRF_W<DFSDM3_ICRrs> {
        CLRJOVRF_W::new(self, 2)
    }
    ///Bit 3 - Clear the regular conversion overrun flag
    #[inline(always)]
    pub fn clrrovrf(&mut self) -> CLRROVRF_W<DFSDM3_ICRrs> {
        CLRROVRF_W::new(self, 3)
    }
    ///Bits 16:23 - Clear the clock absence flag
    #[inline(always)]
    pub fn clrckabf(&mut self) -> CLRCKABF_W<DFSDM3_ICRrs> {
        CLRCKABF_W::new(self, 16)
    }
    ///Bits 24:31 - Clear the short-circuit detector flag
    #[inline(always)]
    pub fn clrscdf(&mut self) -> CLRSCDF_W<DFSDM3_ICRrs> {
        CLRSCDF_W::new(self, 24)
    }
}
/**DFSDM interrupt flag clear register

You can [`read`](crate::Reg::read) this register and get [`dfsdm3_icr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm3_icr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM3_ICR)*/
pub struct DFSDM3_ICRrs;
impl crate::RegisterSpec for DFSDM3_ICRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm3_icr::R`](R) reader structure
impl crate::Readable for DFSDM3_ICRrs {}
///`write(|w| ..)` method takes [`dfsdm3_icr::W`](W) writer structure
impl crate::Writable for DFSDM3_ICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM3_ICR to value 0
impl crate::Resettable for DFSDM3_ICRrs {
