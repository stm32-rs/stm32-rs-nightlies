...
pub type R = crate::R<DFSDM3_ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm3_isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM3_ISR)*/
pub struct DFSDM3_ISRrs;
impl crate::RegisterSpec for DFSDM3_ISRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm3_isr::R`](R) reader structure
impl crate::Readable for DFSDM3_ISRrs {}
///`reset()` method sets DFSDM3_ISR to value 0x00ff_0000
impl crate::Resettable for DFSDM3_ISRrs {
