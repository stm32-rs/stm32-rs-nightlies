...
pub type R = crate::R<DFSDM3_RDATARrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm3_rdatar::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM3_RDATAR)*/
pub struct DFSDM3_RDATARrs;
impl crate::RegisterSpec for DFSDM3_RDATARrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm3_rdatar::R`](R) reader structure
impl crate::Readable for DFSDM3_RDATARrs {}
///`reset()` method sets DFSDM3_RDATAR to value 0
impl crate::Resettable for DFSDM3_RDATARrs {
