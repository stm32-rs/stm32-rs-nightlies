...
pub type R = crate::R<DFSDM_AWSCD4Rrs>;
///Register `DFSDM_AWSCD4R` writer
pub type W = crate::W<DFSDM_AWSCD4Rrs>;
...
impl W {
    ///Bits 0:7 - short-circuit detector threshold for channel 4
    #[inline(always)]
    pub fn scdt(&mut self) -> SCDT_W<DFSDM_AWSCD4Rrs> {
        SCDT_W::new(self, 0)
    }
    ///Bits 12:15 - Break signal assignment for short-circuit detector on channel 4
    #[inline(always)]
    pub fn bkscd(&mut self) -> BKSCD_W<DFSDM_AWSCD4Rrs> {
        BKSCD_W::new(self, 12)
    }
    ///Bits 16:20 - Analog watchdog filter oversampling ratio (decimation rate) on channel 4
    #[inline(always)]
    pub fn awfosr(&mut self) -> AWFOSR_W<DFSDM_AWSCD4Rrs> {
        AWFOSR_W::new(self, 16)
    }
    ///Bits 22:23 - Analog watchdog Sinc filter order on channel 4
    #[inline(always)]
    pub fn awford(&mut self) -> AWFORD_W<DFSDM_AWSCD4Rrs> {
        AWFORD_W::new(self, 22)
    }
}
/**DFSDM analog watchdog and short-circuit detector register

You can [`read`](crate::Reg::read) this register and get [`dfsdm_awscd4r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_awscd4r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM_AWSCD4R)*/
pub struct DFSDM_AWSCD4Rrs;
impl crate::RegisterSpec for DFSDM_AWSCD4Rrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_awscd4r::R`](R) reader structure
impl crate::Readable for DFSDM_AWSCD4Rrs {}
///`write(|w| ..)` method takes [`dfsdm_awscd4r::W`](W) writer structure
impl crate::Writable for DFSDM_AWSCD4Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_AWSCD4R to value 0
impl crate::Resettable for DFSDM_AWSCD4Rrs {
