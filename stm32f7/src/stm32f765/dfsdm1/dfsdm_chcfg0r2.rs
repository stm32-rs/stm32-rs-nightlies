///Register `DFSDM_CHCFG0R2` reader
pub type R = crate::R<DFSDM_CHCFG0R2rs>;
///Register `DFSDM_CHCFG0R2` writer
pub type W = crate::W<DFSDM_CHCFG0R2rs>;
...
impl W {
    ///Bits 3:7 - Data right bit-shift for channel 0
    #[inline(always)]
    pub fn dtrbs(&mut self) -> DTRBS_W<DFSDM_CHCFG0R2rs> {
        DTRBS_W::new(self, 3)
    }
    ///Bits 8:31 - 24-bit calibration offset for channel 0
    #[inline(always)]
    pub fn offset(&mut self) -> OFFSET_W<DFSDM_CHCFG0R2rs> {
        OFFSET_W::new(self, 8)
    }
}
...
pub struct DFSDM_CHCFG0R2rs;
impl crate::RegisterSpec for DFSDM_CHCFG0R2rs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_chcfg0r2::R`](R) reader structure
impl crate::Readable for DFSDM_CHCFG0R2rs {}
///`write(|w| ..)` method takes [`dfsdm_chcfg0r2::W`](W) writer structure
impl crate::Writable for DFSDM_CHCFG0R2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CHCFG0R2 to value 0
impl crate::Resettable for DFSDM_CHCFG0R2rs {
