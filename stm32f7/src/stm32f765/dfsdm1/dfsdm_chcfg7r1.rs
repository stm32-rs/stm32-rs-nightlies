...
pub type R = crate::R<DFSDM_CHCFG7R1rs>;
///Register `DFSDM_CHCFG7R1` writer
pub type W = crate::W<DFSDM_CHCFG7R1rs>;
...
impl W {
    ///Bits 0:1 - Serial interface type for channel 7
    #[inline(always)]
    pub fn sitp(&mut self) -> SITP_W<DFSDM_CHCFG7R1rs> {
        SITP_W::new(self, 0)
    }
    ///Bits 2:3 - SPI clock select for channel 7
    #[inline(always)]
    pub fn spicksel(&mut self) -> SPICKSEL_W<DFSDM_CHCFG7R1rs> {
        SPICKSEL_W::new(self, 2)
    }
    ///Bit 5 - Short-circuit detector enable on channel 7
    #[inline(always)]
    pub fn scden(&mut self) -> SCDEN_W<DFSDM_CHCFG7R1rs> {
        SCDEN_W::new(self, 5)
    }
    ///Bit 6 - Clock absence detector enable on channel 7
    #[inline(always)]
    pub fn ckaben(&mut self) -> CKABEN_W<DFSDM_CHCFG7R1rs> {
        CKABEN_W::new(self, 6)
    }
    ///Bit 7 - Channel 7 enable
    #[inline(always)]
    pub fn chen(&mut self) -> CHEN_W<DFSDM_CHCFG7R1rs> {
        CHEN_W::new(self, 7)
    }
    ///Bit 8 - Channel inputs selection
    #[inline(always)]
    pub fn chinsel(&mut self) -> CHINSEL_W<DFSDM_CHCFG7R1rs> {
        CHINSEL_W::new(self, 8)
    }
    ///Bits 12:13 - Input data multiplexer for channel 7
    #[inline(always)]
    pub fn datmpx(&mut self) -> DATMPX_W<DFSDM_CHCFG7R1rs> {
        DATMPX_W::new(self, 12)
    }
    ///Bits 14:15 - Data packing mode in DFSDM_CHDATINyR register
    #[inline(always)]
    pub fn datpack(&mut self) -> DATPACK_W<DFSDM_CHCFG7R1rs> {
        DATPACK_W::new(self, 14)
    }
    ///Bits 16:23 - Output serial clock divider
    #[inline(always)]
    pub fn ckoutdiv(&mut self) -> CKOUTDIV_W<DFSDM_CHCFG7R1rs> {
        CKOUTDIV_W::new(self, 16)
    }
    ///Bit 30 - Output serial clock source selection
    #[inline(always)]
    pub fn ckoutsrc(&mut self) -> CKOUTSRC_W<DFSDM_CHCFG7R1rs> {
        CKOUTSRC_W::new(self, 30)
    }
    ///Bit 31 - Global enable for DFSDM interface
    #[inline(always)]
    pub fn dfsdmen(&mut self) -> DFSDMEN_W<DFSDM_CHCFG7R1rs> {
        DFSDMEN_W::new(self, 31)
    }
}
/**DFSDM channel configuration 7 register 1

You can [`read`](crate::Reg::read) this register and get [`dfsdm_chcfg7r1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_chcfg7r1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM_CHCFG7R1)*/
pub struct DFSDM_CHCFG7R1rs;
impl crate::RegisterSpec for DFSDM_CHCFG7R1rs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_chcfg7r1::R`](R) reader structure
impl crate::Readable for DFSDM_CHCFG7R1rs {}
///`write(|w| ..)` method takes [`dfsdm_chcfg7r1::W`](W) writer structure
impl crate::Writable for DFSDM_CHCFG7R1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CHCFG7R1 to value 0
impl crate::Resettable for DFSDM_CHCFG7R1rs {
