...
pub type R = crate::R<DFSDM_CHDATIN0Rrs>;
///Register `DFSDM_CHDATIN0R` writer
pub type W = crate::W<DFSDM_CHDATIN0Rrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_CHDATIN0R")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn indat0(&mut self) -> INDAT0_W<DFSDM_CHDATIN0Rrs> {
        INDAT0_W::new(self, 0)
    }
    ///Bits 16:31 - Input data for channel 1
    #[inline(always)]
    #[must_use]
    pub fn indat1(&mut self) -> INDAT1_W<DFSDM_CHDATIN0Rrs> {
        INDAT1_W::new(self, 16)
    }
}
/**DFSDM channel data input register

You can [`read`](crate::Reg::read) this register and get [`dfsdm_chdatin0r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_chdatin0r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F765.html#DFSDM1:DFSDM_CHDATIN0R)*/
pub struct DFSDM_CHDATIN0Rrs;
impl crate::RegisterSpec for DFSDM_CHDATIN0Rrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_chdatin0r::R`](R) reader structure
impl crate::Readable for DFSDM_CHDATIN0Rrs {}
///`write(|w| ..)` method takes [`dfsdm_chdatin0r::W`](W) writer structure
impl crate::Writable for DFSDM_CHDATIN0Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CHDATIN0R to value 0
impl crate::Resettable for DFSDM_CHDATIN0Rrs {
