///Register `DFSDM_CHDATIN5R` reader
pub type R = crate::R<DFSDM_CHDATIN5Rrs>;
///Register `DFSDM_CHDATIN5R` writer
pub type W = crate::W<DFSDM_CHDATIN5Rrs>;
///Field `INDAT0` reader - Input data for channel 5
pub type INDAT0_R = crate::FieldReader<u16>;
///Field `INDAT0` writer - Input data for channel 5
pub type INDAT0_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `INDAT1` reader - Input data for channel 6
pub type INDAT1_R = crate::FieldReader<u16>;
///Field `INDAT1` writer - Input data for channel 6
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_CHDATIN5R")
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_chdatin5r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_chdatin5r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dfsdm_chdatin5r::R`](R) reader structure
impl crate::Readable for DFSDM_CHDATIN5Rrs {}
///`write(|w| ..)` method takes [`dfsdm_chdatin5r::W`](W) writer structure
impl crate::Writable for DFSDM_CHDATIN5Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CHDATIN5R to value 0
