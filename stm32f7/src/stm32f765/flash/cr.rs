...
pub struct MER1_R(crate::FieldReader<bool, MER1_A>);
impl MER1_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for MER1_R {
    type Target = crate::FieldReader<bool, MER1_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct MER2_R(crate::FieldReader<bool, MER2_A>);
impl MER2_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for MER2_R {
    type Target = crate::FieldReader<bool, MER2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
