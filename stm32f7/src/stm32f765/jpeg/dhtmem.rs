...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dhtmem_ram(&mut self) -> DHTMEM_RAM_W<DHTMEMrs> {
        DHTMEM_RAM_W::new(self, 0)
    }
}
#[doc = "JPEG DHTMem tables\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dhtmem::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dhtmem::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DHTMEMrs;
