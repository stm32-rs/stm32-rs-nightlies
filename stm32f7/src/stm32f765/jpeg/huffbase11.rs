#[doc = "Reader of register HUFFBASE11"]
pub type R = crate::R<u32, super::HUFFBASE11>;
#[doc = "Writer for register HUFFBASE11"]
pub type W = crate::W<u32, super::HUFFBASE11>;
#[doc = "Register HUFFBASE11 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE11 {
    type Type = u32;
    #[inline(always)]
