#[doc = "Reader of register HUFFBASE13"]
pub type R = crate::R<u32, super::HUFFBASE13>;
#[doc = "Writer for register HUFFBASE13"]
pub type W = crate::W<u32, super::HUFFBASE13>;
#[doc = "Register HUFFBASE13 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE13 {
    type Type = u32;
    #[inline(always)]
