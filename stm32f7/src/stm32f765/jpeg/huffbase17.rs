#[doc = "Reader of register HUFFBASE17"]
pub type R = crate::R<u32, super::HUFFBASE17>;
#[doc = "Writer for register HUFFBASE17"]
pub type W = crate::W<u32, super::HUFFBASE17>;
#[doc = "Register HUFFBASE17 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE17 {
    type Type = u32;
    #[inline(always)]
