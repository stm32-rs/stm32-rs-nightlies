#[doc = "Reader of register HUFFBASE21"]
pub type R = crate::R<u32, super::HUFFBASE21>;
#[doc = "Writer for register HUFFBASE21"]
pub type W = crate::W<u32, super::HUFFBASE21>;
#[doc = "Register HUFFBASE21 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE21 {
    type Type = u32;
    #[inline(always)]
