#[doc = "Register `HUFFBASE30` reader"]
pub struct R(crate::R<HUFFBASE30_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HUFFBASE30_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HUFFBASE30_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HUFFBASE30_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HUFFBASE30` writer"]
pub struct W(crate::W<HUFFBASE30_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HUFFBASE30_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HUFFBASE30_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HUFFBASE30_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "JPEG HuffSymb tables\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [huffbase30](index.html) module"]
pub struct HUFFBASE30_SPEC;
impl crate::RegisterSpec for HUFFBASE30_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [huffbase30::R](R) reader structure"]
impl crate::Readable for HUFFBASE30_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [huffbase30::W](W) writer structure"]
impl crate::Writable for HUFFBASE30_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HUFFBASE30 to value 0"]
impl crate::Resettable for HUFFBASE30_SPEC {
    #[inline(always)]
