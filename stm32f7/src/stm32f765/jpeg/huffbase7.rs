#[doc = "Register `HUFFBASE7` reader"]
pub struct R(crate::R<HUFFBASE7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HUFFBASE7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HUFFBASE7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HUFFBASE7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HUFFBASE7` writer"]
pub struct W(crate::W<HUFFBASE7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HUFFBASE7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HUFFBASE7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HUFFBASE7_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "JPEG HuffSymb tables\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [huffbase7](index.html) module"]
pub struct HUFFBASE7_SPEC;
impl crate::RegisterSpec for HUFFBASE7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [huffbase7::R](R) reader structure"]
impl crate::Readable for HUFFBASE7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [huffbase7::W](W) writer structure"]
impl crate::Writable for HUFFBASE7_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HUFFBASE7 to value 0"]
impl crate::Resettable for HUFFBASE7_SPEC {
    #[inline(always)]
