#[doc = "Reader of register HUFFBASE8"]
pub type R = crate::R<u32, super::HUFFBASE8>;
#[doc = "Writer for register HUFFBASE8"]
pub type W = crate::W<u32, super::HUFFBASE8>;
#[doc = "Register HUFFBASE8 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE8 {
    type Type = u32;
    #[inline(always)]
