#[doc = "Reader of register HUFFENC_AC1_0"]
pub type R = crate::R<u32, super::HUFFENC_AC1_0>;
#[doc = "Writer for register HUFFENC_AC1_0"]
pub type W = crate::W<u32, super::HUFFENC_AC1_0>;
#[doc = "Register HUFFENC_AC1_0 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFENC_AC1_0 {
    type Type = u32;
    #[inline(always)]
