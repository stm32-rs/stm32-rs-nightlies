#[doc = "Reader of register HUFFENC_DC0_6"]
pub type R = crate::R<u32, super::HUFFENC_DC0_6>;
#[doc = "Writer for register HUFFENC_DC0_6"]
pub type W = crate::W<u32, super::HUFFENC_DC0_6>;
#[doc = "Register HUFFENC_DC0_6 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFENC_DC0_6 {
    type Type = u32;
    #[inline(always)]
