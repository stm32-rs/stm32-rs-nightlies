#[doc = "Reader of register HUFFSYMB36"]
pub type R = crate::R<u32, super::HUFFSYMB36>;
#[doc = "Writer for register HUFFSYMB36"]
pub type W = crate::W<u32, super::HUFFSYMB36>;
#[doc = "Register HUFFSYMB36 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFSYMB36 {
    type Type = u32;
    #[inline(always)]
