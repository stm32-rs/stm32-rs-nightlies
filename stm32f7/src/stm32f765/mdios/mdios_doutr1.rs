...
#[doc = "Writer for register MDIOS_DOUTR1"]
pub type W = crate::W<u32, super::MDIOS_DOUTR1>;
#[doc = "Register MDIOS_DOUTR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::MDIOS_DOUTR1 {
    type Type = u32;
    #[inline(always)]
