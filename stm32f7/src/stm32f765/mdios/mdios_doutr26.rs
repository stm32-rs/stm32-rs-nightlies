...
pub struct W(crate::W<MDIOS_DOUTR26_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDIOS_DOUTR26_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDIOS_DOUTR26_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDIOS_DOUTR26_SPEC>) -> Self {
        W(writer)
    }
}
