...
pub struct JPEGLPEN_R(crate::FieldReader<bool, bool>);
impl JPEGLPEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        JPEGLPEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for JPEGLPEN_R {
...
impl R {
    ...
    pub fn jpeglpen(&self) -> JPEGLPEN_R {
        JPEGLPEN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 7 - USB OTG FS clock enable during Sleep mode"]
    ...
    #[doc = "Bit 1 - JPEG module enabled during Sleep mode"]
    #[inline(always)]
    pub fn jpeglpen(&mut self) -> JPEGLPEN_W {
        JPEGLPEN_W { w: self }
    }
