...
///Field `GPIOJEN` reader - IO port J clock enable
pub use GPIOAEN_R as GPIOJEN_R;
///Field `GPIOKEN` reader - IO port K clock enable
...
///Field `DTCMRAMEN` reader - CCM data RAM clock enable
...
///Field `GPIOJEN` writer - IO port J clock enable
pub use GPIOAEN_W as GPIOJEN_W;
///Field `GPIOKEN` writer - IO port K clock enable
...
///Field `DTCMRAMEN` writer - CCM data RAM clock enable
...
impl W {
    ...
    ///Bit 9 - IO port J clock enable
    #[inline(always)]
    pub fn gpiojen(&mut self) -> GPIOJEN_W<'_, AHB1ENRrs> {
        GPIOJEN_W::new(self, 9)
    }
    ///Bit 10 - IO port K clock enable
    #[inline(always)]
    pub fn gpioken(&mut self) -> GPIOKEN_W<'_, AHB1ENRrs> {
    ...
    ///Bit 20 - CCM data RAM clock enable
    #[inline(always)]
    pub fn dtcmramen(&mut self) -> DTCMRAMEN_W<'_, AHB1ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F767.html#RCC:AHB1ENR)*/
