...
///Field `RTCAPBEN` reader - RTC register interface clock enable
...
///Field `SPDIFRXEN` reader - SPDIF-RX clock enable
...
///Field `CECEN` reader - HDMI-CEN clock enable
...
///Field `RTCAPBEN` writer - RTC register interface clock enable
...
///Field `SPDIFRXEN` writer - SPDIF-RX clock enable
...
///Field `CECEN` writer - HDMI-CEN clock enable
...
impl R {
    ...
    ///Bit 10 - RTC register interface clock enable
    #[inline(always)]
...
impl W {
    ...
    ///Bit 13 - CAN 3 clock enable
    #[inline(always)]
    pub fn can3en(&mut self) -> CAN3EN_W<'_, APB1ENRrs> {
    ...
    ///Bit 16 - SPDIF-RX clock enable
    #[inline(always)]
    pub fn spdifrxen(&mut self) -> SPDIFRXEN_W<'_, APB1ENRrs> {
    ...
    ///Bit 24 - I2C4 clock enable
    #[inline(always)]
    pub fn i2c4en(&mut self) -> I2C4EN_W<'_, APB1ENRrs> {
    ...
    ///Bit 30 - UART7 clock enable
    #[inline(always)]
    pub fn uart7en(&mut self) -> UART7EN_W<'_, APB1ENRrs> {
        UART7EN_W::new(self, 30)
    }
    ///Bit 31 - UART8 clock enable
    #[inline(always)]
    pub fn uart8en(&mut self) -> UART8EN_W<'_, APB1ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F767.html#RCC:APB1ENR)*/
