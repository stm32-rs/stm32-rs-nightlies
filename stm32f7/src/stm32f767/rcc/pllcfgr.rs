...
///Field `PLLR` reader - PLL division factor for DSI clock
pub type PLLR_R = crate::FieldReader;
///Field `PLLR` writer - PLL division factor for DSI clock
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F767.html#RCC:PLLCFGR)*/
