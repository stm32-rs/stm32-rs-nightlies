...
/**Field `BKDFBKE` reader - BRK DFSDM_BREAK\[0\]
enable*/
pub type BKDFBKE_R = crate::BitReader;
/**Field `BKDFBKE` writer - BRK DFSDM_BREAK\[0\]
enable*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F767.html#TIM1:AF1)*/
pub struct AF1rs;
