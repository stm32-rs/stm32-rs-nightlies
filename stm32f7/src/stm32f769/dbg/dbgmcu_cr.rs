...
///Field `TRACE_CLKINEN` reader - TRACE_CLKINEN
pub type TRACE_CLKINEN_R = crate::BitReader;
///Field `TRACE_CLKINEN` writer - TRACE_CLKINEN
pub type TRACE_CLKINEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    ///Bit 5 - TRACE_CLKINEN
    #[inline(always)]
    pub fn trace_clkinen(&self) -> TRACE_CLKINEN_R {
        TRACE_CLKINEN_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bits 6:7 - TRACE_MODE
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DBGMCU_CR")
            ...
            .field("trace_clkinen", &self.trace_clkinen())
...
impl W {
    ...
    ///Bit 5 - TRACE_CLKINEN
    #[inline(always)]
    pub fn trace_clkinen(&mut self) -> TRACE_CLKINEN_W<'_, DBGMCU_CRrs> {
        TRACE_CLKINEN_W::new(self, 5)
    }
    ///Bits 6:7 - TRACE_MODE
    #[inline(always)]
