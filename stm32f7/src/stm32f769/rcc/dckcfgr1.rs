...
impl W {
    ///Bits 0:4 - PLLI2S division factor for SAI1 clock
    #[inline(always)]
    pub fn plli2sdivq(&mut self) -> PLLI2SDIVQ_W<'_, DCKCFGR1rs> {
        PLLI2SDIVQ_W::new(self, 0)
    }
    ///Bits 8:12 - PLLSAI division factor for SAI1 clock
    #[inline(always)]
    pub fn pllsaidivq(&mut self) -> PLLSAIDIVQ_W<'_, DCKCFGR1rs> {
        PLLSAIDIVQ_W::new(self, 8)
    }
    ///Bits 16:17 - division factor for LCD_CLK
    #[inline(always)]
    pub fn pllsaidivr(&mut self) -> PLLSAIDIVR_W<'_, DCKCFGR1rs> {
        PLLSAIDIVR_W::new(self, 16)
    }
    ///Bits 20:21 - SAI1 clock source selection
    #[inline(always)]
    pub fn sai1sel(&mut self) -> SAI1SEL_W<'_, DCKCFGR1rs> {
        SAI1SEL_W::new(self, 20)
    }
    ///Bits 22:23 - SAI2 clock source selection
    #[inline(always)]
    pub fn sai2sel(&mut self) -> SAI2SEL_W<'_, DCKCFGR1rs> {
        SAI2SEL_W::new(self, 22)
    }
    ///Bit 24 - Timers clocks prescalers selection
    #[inline(always)]
    pub fn timpre(&mut self) -> TIMPRE_W<'_, DCKCFGR1rs> {
        TIMPRE_W::new(self, 24)
    }
    ///Bit 25 - DFSDM1 clock source selection
    #[inline(always)]
    pub fn dfsdm1sel(&mut self) -> DFSDM1SEL_W<'_, DCKCFGR1rs> {
        DFSDM1SEL_W::new(self, 25)
    }
    ///Bit 26 - DFSDM1 AUDIO clock source selection
    #[inline(always)]
    pub fn adfsdm1sel(&mut self) -> ADFSDM1SEL_W<'_, DCKCFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F769.html#RCC:DCKCFGR1)*/
