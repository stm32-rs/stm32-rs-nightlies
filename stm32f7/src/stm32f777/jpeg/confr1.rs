...
///Field `DE` reader - Decoding Enable
pub type DE_R = crate::BitReader;
///Field `DE` writer - Decoding Enable
pub type DE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COLORSPACE` reader - Color Space
pub type COLORSPACE_R = crate::FieldReader;
///Field `COLORSPACE` writer - Color Space
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F777.html#JPEG:CONFR1)*/
pub struct CONFR1rs;
