...
///Field `SPI6EN` reader - SPI6 clock enable
...
///Field `SPI6EN` writer - SPI6 clock enable
...
impl W {
    ...
    ///Bit 30 - MDIO clock enable
    #[inline(always)]
    pub fn mdioen(&mut self) -> MDIOEN_W<'_, APB2ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F777.html#RCC:APB2ENR)*/
