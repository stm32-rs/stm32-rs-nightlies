///Register `DBGMCU_APB1_FZ` reader
pub type R = crate::R<DBGMCU_APB1_FZrs>;
///Register `DBGMCU_APB1_FZ` writer
...
///Field `DBG_IWDEG_STOP` reader - DBG_IWDEG_STOP
pub type DBG_IWDEG_STOP_R = crate::BitReader;
///Field `DBG_IWDEG_STOP` writer - DBG_IWDEG_STOP
pub type DBG_IWDEG_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DBG_CAN3_STOP` reader - DBG_CAN3_STOP
pub type DBG_CAN3_STOP_R = crate::BitReader;
///Field `DBG_CAN3_STOP` writer - DBG_CAN3_STOP
pub type DBG_CAN3_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
...
///Field `DBG_I2C4_SMBUS_TIMEOUT` reader - DBG_I2C4_SMBUS_TIMEOUT
pub type DBG_I2C4_SMBUS_TIMEOUT_R = crate::BitReader;
///Field `DBG_I2C4_SMBUS_TIMEOUT` writer - DBG_I2C4_SMBUS_TIMEOUT
pub type DBG_I2C4_SMBUS_TIMEOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DBGMCU_APB1_FZ")
            ...
            .field("dbg_can3_stop", &self.dbg_can3_stop())
            ...
            .field("dbg_i2c4_smbus_timeout", &self.dbg_i2c4_smbus_timeout())
...
impl W {
    ///Bit 0 - DBG_TIM2_STOP
    #[inline(always)]
    pub fn dbg_tim2_stop(&mut self) -> DBG_TIM2_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_TIM2_STOP_W::new(self, 0)
    }
    ///Bit 1 - DBG_TIM3 _STOP
    #[inline(always)]
    pub fn dbg_tim3_stop(&mut self) -> DBG_TIM3_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_TIM3_STOP_W::new(self, 1)
    }
    ///Bit 2 - DBG_TIM4_STOP
    #[inline(always)]
    pub fn dbg_tim4_stop(&mut self) -> DBG_TIM4_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_TIM4_STOP_W::new(self, 2)
    }
    ///Bit 3 - DBG_TIM5_STOP
    #[inline(always)]
    pub fn dbg_tim5_stop(&mut self) -> DBG_TIM5_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_TIM5_STOP_W::new(self, 3)
    }
    ///Bit 4 - DBG_TIM6_STOP
    #[inline(always)]
    pub fn dbg_tim6_stop(&mut self) -> DBG_TIM6_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_TIM6_STOP_W::new(self, 4)
    }
    ///Bit 5 - DBG_TIM7_STOP
    #[inline(always)]
    pub fn dbg_tim7_stop(&mut self) -> DBG_TIM7_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_TIM7_STOP_W::new(self, 5)
    }
    ///Bit 6 - DBG_TIM12_STOP
    #[inline(always)]
    pub fn dbg_tim12_stop(&mut self) -> DBG_TIM12_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_TIM12_STOP_W::new(self, 6)
    }
    ///Bit 7 - DBG_TIM13_STOP
    #[inline(always)]
    pub fn dbg_tim13_stop(&mut self) -> DBG_TIM13_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_TIM13_STOP_W::new(self, 7)
    }
    ///Bit 8 - DBG_TIM14_STOP
    #[inline(always)]
    pub fn dbg_tim14_stop(&mut self) -> DBG_TIM14_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_TIM14_STOP_W::new(self, 8)
    }
    ///Bit 9 - DBG_LPTIM1_STOP
    #[inline(always)]
    pub fn dbg_lptim1_stop(&mut self) -> DBG_LPTIM1_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_LPTIM1_STOP_W::new(self, 9)
    }
    ///Bit 10 - DBG_RTC_STOP
    #[inline(always)]
    pub fn dbg_rtc_stop(&mut self) -> DBG_RTC_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_RTC_STOP_W::new(self, 10)
    }
    ///Bit 11 - DBG_WWDG_STOP
    #[inline(always)]
    pub fn dbg_wwdg_stop(&mut self) -> DBG_WWDG_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_WWDG_STOP_W::new(self, 11)
    }
    ///Bit 12 - DBG_IWDEG_STOP
    #[inline(always)]
    pub fn dbg_iwdeg_stop(&mut self) -> DBG_IWDEG_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_IWDEG_STOP_W::new(self, 12)
    }
    ///Bit 13 - DBG_CAN3_STOP
    #[inline(always)]
    pub fn dbg_can3_stop(&mut self) -> DBG_CAN3_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_CAN3_STOP_W::new(self, 13)
    }
    ///Bit 21 - DBG_J2C1_SMBUS_TIMEOUT
    #[inline(always)]
    pub fn dbg_j2c1_smbus_timeout(&mut self) -> DBG_J2C1_SMBUS_TIMEOUT_W<'_, DBGMCU_APB1_FZrs> {
        DBG_J2C1_SMBUS_TIMEOUT_W::new(self, 21)
    }
    ///Bit 22 - DBG_J2C2_SMBUS_TIMEOUT
    #[inline(always)]
    pub fn dbg_j2c2_smbus_timeout(&mut self) -> DBG_J2C2_SMBUS_TIMEOUT_W<'_, DBGMCU_APB1_FZrs> {
        DBG_J2C2_SMBUS_TIMEOUT_W::new(self, 22)
    }
    ///Bit 23 - DBG_J2C3SMBUS_TIMEOUT
    #[inline(always)]
    pub fn dbg_j2c3smbus_timeout(&mut self) -> DBG_J2C3SMBUS_TIMEOUT_W<'_, DBGMCU_APB1_FZrs> {
        DBG_J2C3SMBUS_TIMEOUT_W::new(self, 23)
    }
    ///Bit 24 - DBG_I2C4_SMBUS_TIMEOUT
    #[inline(always)]
    pub fn dbg_i2c4_smbus_timeout(&mut self) -> DBG_I2C4_SMBUS_TIMEOUT_W<'_, DBGMCU_APB1_FZrs> {
        DBG_I2C4_SMBUS_TIMEOUT_W::new(self, 24)
    }
    ///Bit 25 - DBG_CAN1_STOP
    #[inline(always)]
    pub fn dbg_can1_stop(&mut self) -> DBG_CAN1_STOP_W<'_, DBGMCU_APB1_FZrs> {
        DBG_CAN1_STOP_W::new(self, 25)
    }
    ///Bit 26 - DBG_CAN2_STOP
    #[inline(always)]
    pub fn dbg_can2_stop(&mut self) -> DBG_CAN2_STOP_W<'_, DBGMCU_APB1_FZrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F778.html#DBG:DBGMCU_APB1_FZ)*/
pub struct DBGMCU_APB1_FZrs;
impl crate::RegisterSpec for DBGMCU_APB1_FZrs {
    type Ux = u32;
}
///`read()` method returns [`dbgmcu_apb1_fz::R`](R) reader structure
impl crate::Readable for DBGMCU_APB1_FZrs {}
///`write(|w| ..)` method takes [`dbgmcu_apb1_fz::W`](W) writer structure
impl crate::Writable for DBGMCU_APB1_FZrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DBGMCU_APB1_FZ to value 0
