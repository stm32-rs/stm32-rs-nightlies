///Register `DBGMCU_APB2_FZ` reader
pub type R = crate::R<DBGMCU_APB2_FZrs>;
///Register `DBGMCU_APB2_FZ` writer
...
impl W {
    ///Bit 0 - TIM1 counter stopped when core is halted
    #[inline(always)]
    pub fn dbg_tim1_stop(&mut self) -> DBG_TIM1_STOP_W<'_, DBGMCU_APB2_FZrs> {
        DBG_TIM1_STOP_W::new(self, 0)
    }
    ///Bit 1 - TIM8 counter stopped when core is halted
    #[inline(always)]
    pub fn dbg_tim8_stop(&mut self) -> DBG_TIM8_STOP_W<'_, DBGMCU_APB2_FZrs> {
        DBG_TIM8_STOP_W::new(self, 1)
    }
    ///Bit 16 - TIM9 counter stopped when core is halted
    #[inline(always)]
    pub fn dbg_tim9_stop(&mut self) -> DBG_TIM9_STOP_W<'_, DBGMCU_APB2_FZrs> {
        DBG_TIM9_STOP_W::new(self, 16)
    }
    ///Bit 17 - TIM10 counter stopped when core is halted
    #[inline(always)]
    pub fn dbg_tim10_stop(&mut self) -> DBG_TIM10_STOP_W<'_, DBGMCU_APB2_FZrs> {
        DBG_TIM10_STOP_W::new(self, 17)
    }
    ///Bit 18 - TIM11 counter stopped when core is halted
    #[inline(always)]
    pub fn dbg_tim11_stop(&mut self) -> DBG_TIM11_STOP_W<'_, DBGMCU_APB2_FZrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F778.html#DBG:DBGMCU_APB2_FZ)*/
pub struct DBGMCU_APB2_FZrs;
impl crate::RegisterSpec for DBGMCU_APB2_FZrs {
    type Ux = u32;
}
///`read()` method returns [`dbgmcu_apb2_fz::R`](R) reader structure
impl crate::Readable for DBGMCU_APB2_FZrs {}
///`write(|w| ..)` method takes [`dbgmcu_apb2_fz::W`](W) writer structure
impl crate::Writable for DBGMCU_APB2_FZrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DBGMCU_APB2_FZ to value 0
