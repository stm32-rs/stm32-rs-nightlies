...
///Field `EOC2` reader - EOC2
pub use EOC1_R as EOC2_R;
///Field `EOC3` reader - EOC3
pub use EOC1_R as EOC3_R;
///Field `JEOC2` reader - JEOC2
pub use JEOC1_R as JEOC2_R;
///Field `JEOC3` reader - JEOC3
pub use JEOC1_R as JEOC3_R;
///Field `JSTRT2` reader - JSTRT2
pub use JSTRT1_R as JSTRT2_R;
///Field `JSTRT3` reader - JSTRT3
pub use JSTRT1_R as JSTRT3_R;
///Field `OVR2` reader - OVR2
pub use OVR1_R as OVR2_R;
///Field `OVR3` reader - OVR3
pub use OVR1_R as OVR3_R;
///Field `STRT2` reader - STRT2
pub use STRT1_R as STRT2_R;
///Field `STRT3` reader - STRT3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F779.html#ADC_Common:CSR)*/
pub struct CSRrs;
