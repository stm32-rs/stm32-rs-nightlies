...
///Field `DBG_I2C3_SMBUS_TIMEOUT` reader - DBG_I2C3_SMBUS_TIMEOUT
pub type DBG_I2C3_SMBUS_TIMEOUT_R = crate::BitReader;
///Field `DBG_I2C3_SMBUS_TIMEOUT` writer - DBG_I2C3_SMBUS_TIMEOUT
pub type DBG_I2C3_SMBUS_TIMEOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DBG_I2C4_SMBUS_TIMEOUT` reader - DBG_I2C4SMBUS_TIMEOUT
pub type DBG_I2C4_SMBUS_TIMEOUT_R = crate::BitReader;
///Field `DBG_I2C4_SMBUS_TIMEOUT` writer - DBG_I2C4SMBUS_TIMEOUT
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB1_FZ")
            ...
            .field("dbg_i2c3_smbus_timeout", &self.dbg_i2c3_smbus_timeout())
...
impl W {
    ...
    ///Bit 9 - DBG_LPTIM1_STOP
    #[inline(always)]
    pub fn dbg_lptim1_stop(&mut self) -> DBG_LPTIM1_STOP_W<'_, APB1_FZrs> {
    ...
    ///Bit 13 - DBG_CAN3_STOP
    #[inline(always)]
    pub fn dbg_can3_stop(&mut self) -> DBG_CAN3_STOP_W<'_, APB1_FZrs> {
    ...
    ///Bit 23 - DBG_I2C3_SMBUS_TIMEOUT
    #[inline(always)]
    pub fn dbg_i2c3_smbus_timeout(&mut self) -> DBG_I2C3_SMBUS_TIMEOUT_W<'_, APB1_FZrs> {
        DBG_I2C3_SMBUS_TIMEOUT_W::new(self, 23)
    }
    ///Bit 24 - DBG_I2C4SMBUS_TIMEOUT
    #[inline(always)]
    pub fn dbg_i2c4_smbus_timeout(&mut self) -> DBG_I2C4_SMBUS_TIMEOUT_W<'_, APB1_FZrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F779.html#DBGMCU:APB1_FZ)*/
