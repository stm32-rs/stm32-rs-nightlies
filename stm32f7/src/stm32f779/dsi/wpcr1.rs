...
impl W {
    ...
    ///Bits 2:3 - High-Speed Transmission Delay on Data Lanes
    #[inline(always)]
    pub fn hstxdll(&mut self) -> HSTXDLL_W<WPCR1rs> {
        HSTXDLL_W::new(self, 2)
    }
    ///Bits 6:7 - Low-Power transmission Slew Rate Compensation on Clock Lane
    #[inline(always)]
    pub fn lpsrcl(&mut self) -> LPSRCL_W<WPCR1rs> {
        LPSRCL_W::new(self, 6)
    }
    ///Bits 8:9 - Low-Power transmission Slew Rate Compensation on Data Lanes
    #[inline(always)]
    pub fn lpsrdl(&mut self) -> LPSRDL_W<WPCR1rs> {
        LPSRDL_W::new(self, 8)
    }
    ///Bit 12 - SDD Control
    #[inline(always)]
    pub fn sdcc(&mut self) -> SDCC_W<WPCR1rs> {
        SDCC_W::new(self, 12)
    }
    ///Bits 16:17 - High-Speed Transmission Slew Rate Control on Clock Lane
    #[inline(always)]
