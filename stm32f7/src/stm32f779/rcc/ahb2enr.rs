...
impl W {
    ...
    ///Bit 1 - JPEG enable
    #[inline(always)]
    pub fn jpegen(&mut self) -> JPEGEN_W<'_, AHB2ENRrs> {
        JPEGEN_W::new(self, 1)
    }
    ///Bit 4 - Cryptographic modules clock enable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F779.html#RCC:AHB2ENR)*/
