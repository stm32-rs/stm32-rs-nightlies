...
///Field `CAN3LPEN` reader - CAN 3 clock enable during Sleep mode
...
///Field `CAN3LPEN` writer - CAN 3 clock enable during Sleep mode
...
impl R {
    ...
    ///Bit 13 - CAN 3 clock enable during Sleep mode
    #[inline(always)]
...
impl W {
    ...
    ///Bit 16 - SPDIF-RX clock enable during sleep mode
    #[inline(always)]
    pub fn spdifrxlpen(&mut self) -> SPDIFRXLPEN_W<'_, APB1LPENRrs> {
    ...
    ///Bit 24 - I2C4 clock enable during Sleep mode
    #[inline(always)]
    pub fn i2c4lpen(&mut self) -> I2C4LPEN_W<'_, APB1LPENRrs> {
    ...
    ///Bit 27 - HDMI-CEN clock enable during Sleep mode
    #[inline(always)]
    pub fn ceclpen(&mut self) -> CECLPEN_W<'_, APB1LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F779.html#RCC:APB1LPENR)*/
