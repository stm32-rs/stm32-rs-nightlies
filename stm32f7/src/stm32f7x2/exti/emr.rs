...
pub type EM_R = crate::BitReader<EM0>;
impl EM_R {
...
pub type EM_W<'a, REG> = crate::BitWriter<'a, REG, EM0>;
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EM0` field.</div>
    #[inline(always)]
    pub fn em(&mut self, n: u8) -> EM_W<EMRrs> {
        #[allow(clippy::no_effect)]
        [(); 24][n as usize];
        EM_W::new(self, n)
    }
    ///Bit 0 - Event Mask on line 0
    #[inline(always)]
    pub fn em0(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 0)
    }
    ///Bit 1 - Event Mask on line 1
    #[inline(always)]
    pub fn em1(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 1)
    }
    ///Bit 2 - Event Mask on line 2
    #[inline(always)]
    pub fn em2(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 2)
    }
    ///Bit 3 - Event Mask on line 3
    #[inline(always)]
    pub fn em3(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 3)
    }
    ///Bit 4 - Event Mask on line 4
    #[inline(always)]
    pub fn em4(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 4)
    }
    ///Bit 5 - Event Mask on line 5
    #[inline(always)]
    pub fn em5(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 5)
    }
    ///Bit 6 - Event Mask on line 6
    #[inline(always)]
    pub fn em6(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 6)
    }
    ///Bit 7 - Event Mask on line 7
    #[inline(always)]
    pub fn em7(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 7)
    }
    ///Bit 8 - Event Mask on line 8
    #[inline(always)]
    pub fn em8(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 8)
    }
    ///Bit 9 - Event Mask on line 9
    #[inline(always)]
    pub fn em9(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 9)
    }
    ///Bit 10 - Event Mask on line 10
    #[inline(always)]
    pub fn em10(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 10)
    }
    ///Bit 11 - Event Mask on line 11
    #[inline(always)]
    pub fn em11(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 11)
    }
    ///Bit 12 - Event Mask on line 12
    #[inline(always)]
    pub fn em12(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 12)
    }
    ///Bit 13 - Event Mask on line 13
    #[inline(always)]
    pub fn em13(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 13)
    }
    ///Bit 14 - Event Mask on line 14
    #[inline(always)]
    pub fn em14(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 14)
    }
    ///Bit 15 - Event Mask on line 15
    #[inline(always)]
    pub fn em15(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 15)
    }
    ///Bit 16 - Event Mask on line 16
    #[inline(always)]
    pub fn em16(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 16)
    }
    ///Bit 17 - Event Mask on line 17
    #[inline(always)]
    pub fn em17(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 17)
    }
    ///Bit 18 - Event Mask on line 18
    #[inline(always)]
    pub fn em18(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 18)
    }
    ///Bit 19 - Event Mask on line 19
    #[inline(always)]
    pub fn em19(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 19)
    }
    ///Bit 20 - Event Mask on line 20
    #[inline(always)]
    pub fn em20(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 20)
    }
    ///Bit 21 - Event Mask on line 21
    #[inline(always)]
    pub fn em21(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 21)
    }
    ///Bit 22 - Event Mask on line 22
    #[inline(always)]
    pub fn em22(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 22)
    }
    ///Bit 23 - Event Mask on line 23
    #[inline(always)]
    pub fn em23(&mut self) -> EM_W<EMRrs> {
        EM_W::new(self, 23)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x2.html#EXTI:EMR)*/
pub struct EMRrs;
