...
#[doc = "Flash option control register 1"]
pub mod optcr1;
#[doc = "Flash option control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [optcr2](optcr2) module"]
pub type OPTCR2 = crate::Reg<u32, _OPTCR2>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _OPTCR2;
#[doc = "`read()` method returns [optcr2::R](optcr2::R) reader structure"]
impl crate::Readable for OPTCR2 {}
#[doc = "`write(|w| ..)` method takes [optcr2::W](optcr2::W) writer structure"]
impl crate::Writable for OPTCR2 {}
#[doc = "Flash option control register"]
pub mod optcr2;
