...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x2.html#FLASH:ACR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x2.html#FLASH:KEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x2.html#FLASH:OPTKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x2.html#FLASH:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x2.html#FLASH:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x2.html#FLASH:OPTCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x2.html#FLASH:OPTCR1)
...
pub mod optcr1;
/**OPTCR2 (rw) register accessor: Flash option control register

You can [`read`](crate::Reg::read) this register and get [`optcr2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`optcr2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x2.html#FLASH:OPTCR2)
