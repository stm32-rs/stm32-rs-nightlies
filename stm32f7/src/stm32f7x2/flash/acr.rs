...
pub struct ARTEN_R(crate::FieldReader<bool, ARTEN_A>);
impl ARTEN_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for ARTEN_R {
    type Target = crate::FieldReader<bool, ARTEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct ARTRST_R(crate::FieldReader<bool, ARTRST_A>);
impl ARTRST_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for ARTRST_R {
    type Target = crate::FieldReader<bool, ARTRST_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
