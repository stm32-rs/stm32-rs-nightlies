#[doc = "Reader of register OTG_FS_HCTSIZ0"]
pub type R = crate::R<u32, super::OTG_FS_HCTSIZ0>;
#[doc = "Writer for register OTG_FS_HCTSIZ0"]
pub type W = crate::W<u32, super::OTG_FS_HCTSIZ0>;
#[doc = "Register OTG_FS_HCTSIZ0 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_FS_HCTSIZ0 {
    type Type = u32;
    #[inline(always)]
