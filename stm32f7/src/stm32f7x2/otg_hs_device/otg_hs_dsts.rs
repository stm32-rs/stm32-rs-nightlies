...
pub struct R(crate::R<OTG_HS_DSTS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_HS_DSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_HS_DSTS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_HS_DSTS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "OTG_HS device status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [otg_hs_dsts](index.html) module"]
