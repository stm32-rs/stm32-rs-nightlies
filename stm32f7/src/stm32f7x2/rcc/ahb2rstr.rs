...
pub type OTGFSRST_A = AESRST_A;
#[doc = "Field `OTGFSRST` reader - USB OTG FS module reset"]
pub type OTGFSRST_R = AESRST_R;
...
pub struct AESRST_R(crate::FieldReader<bool, AESRST_A>);
impl AESRST_R {
...
impl core::ops::Deref for AESRST_R {
    type Target = crate::FieldReader<bool, AESRST_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl R {
    ...
    pub fn aesrst(&self) -> AESRST_R {
        AESRST_R::new(((self.bits >> 4) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 7 - USB OTG FS module reset"]
