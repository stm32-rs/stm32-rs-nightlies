...
pub type SDMMC2RST_R = crate::R<bool, TIM1RST_A>;
...
#[doc = "Reader of field `USBPHYCRST`"]
pub type USBPHYCRST_R = crate::R<bool, TIM1RST_A>;
#[doc = "Write proxy for field `USBPHYCRST`"]
