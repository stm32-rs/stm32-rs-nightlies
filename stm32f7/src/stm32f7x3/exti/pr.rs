...
#[doc = "Pending bit 23"]
pub type PR23_A = PR0_A;
#[doc = "Field `PR23` reader - Pending bit 23"]
pub type PR23_R = PR0_R;
#[doc = "Pending bit 23"]
pub type PR23_AW = PR0_AW;
...
impl<'a> PR23_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PR23_AW) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Clears pending bit"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
        self.variant(PR23_AW::CLEAR)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn pr23(&self) -> PR23_R {
        PR23_R::new(((self.bits >> 23) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Pending bit 0"]
