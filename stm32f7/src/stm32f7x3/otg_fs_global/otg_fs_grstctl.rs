#[doc = "Reader of register OTG_FS_GRSTCTL"]
pub type R = crate::R<u32, super::OTG_FS_GRSTCTL>;
#[doc = "Writer for register OTG_FS_GRSTCTL"]
pub type W = crate::W<u32, super::OTG_FS_GRSTCTL>;
#[doc = "Register OTG_FS_GRSTCTL `reset()`'s with value 0x2000_0000"]
impl crate::ResetValue for super::OTG_FS_GRSTCTL {
    type Type = u32;
    #[inline(always)]
