#[doc = "Reader of register OTG_FS_HCFG"]
pub type R = crate::R<u32, super::OTG_FS_HCFG>;
#[doc = "Writer for register OTG_FS_HCFG"]
pub type W = crate::W<u32, super::OTG_FS_HCFG>;
#[doc = "Register OTG_FS_HCFG `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_FS_HCFG {
    type Type = u32;
    #[inline(always)]
