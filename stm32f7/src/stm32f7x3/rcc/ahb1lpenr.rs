...
pub type AXILPEN_A = GPIOALPEN_A;
#[doc = "Field `AXILPEN` reader - AXI to AHB bridge clock enable during Sleep mode"]
pub type AXILPEN_R = GPIOALPEN_R;
#[doc = "Field `AXILPEN` writer - AXI to AHB bridge clock enable during Sleep mode"]
pub struct AXILPEN_W<'a> {
    w: &'a mut W,
}
impl<'a> AXILPEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: AXILPEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Selected module is disabled during Sleep mode"]
    #[inline(always)]
    pub fn disabled_in_sleep(self) -> &'a mut W {
        self.variant(AXILPEN_A::DISABLEDINSLEEP)
    }
    #[doc = "Selected module is enabled during Sleep mode"]
    #[inline(always)]
    pub fn enabled_in_sleep(self) -> &'a mut W {
        self.variant(AXILPEN_A::ENABLEDINSLEEP)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub type DTCMLPEN_A = GPIOALPEN_A;
#[doc = "Field `DTCMLPEN` reader - DTCM RAM interface clock enable during Sleep mode"]
pub type DTCMLPEN_R = GPIOALPEN_R;
#[doc = "Field `DTCMLPEN` writer - DTCM RAM interface clock enable during Sleep mode"]
pub struct DTCMLPEN_W<'a> {
    w: &'a mut W,
}
impl<'a> DTCMLPEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: DTCMLPEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Selected module is disabled during Sleep mode"]
    #[inline(always)]
    pub fn disabled_in_sleep(self) -> &'a mut W {
        self.variant(DTCMLPEN_A::DISABLEDINSLEEP)
    }
    #[doc = "Selected module is enabled during Sleep mode"]
    #[inline(always)]
    pub fn enabled_in_sleep(self) -> &'a mut W {
        self.variant(DTCMLPEN_A::ENABLEDINSLEEP)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl W {
    ...
    #[doc = "Bit 13 - AXI to AHB bridge clock enable during Sleep mode"]
    #[inline(always)]
    pub fn axilpen(&mut self) -> AXILPEN_W {
        AXILPEN_W { w: self }
    }
    #[doc = "Bit 20 - DTCM RAM interface clock enable during Sleep mode"]
    #[inline(always)]
    pub fn dtcmlpen(&mut self) -> DTCMLPEN_W {
        DTCMLPEN_W { w: self }
    }
