...
pub type OTGFSEN_A = AESEN_A;
#[doc = "Field `OTGFSEN` reader - USB OTG FS clock enable"]
pub type OTGFSEN_R = AESEN_R;
...
pub struct AESEN_R(crate::FieldReader<bool, AESEN_A>);
impl AESEN_R {
...
impl core::ops::Deref for AESEN_R {
    type Target = crate::FieldReader<bool, AESEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
