...
pub struct AESLPEN_R(crate::FieldReader<bool, AESLPEN_A>);
impl AESLPEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        AESLPEN_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for AESLPEN_R {
    type Target = crate::FieldReader<bool, AESLPEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl R {
    ...
    pub fn aeslpen(&self) -> AESLPEN_R {
        AESLPEN_R::new(((self.bits >> 4) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 7 - USB OTG FS clock enable during Sleep mode"]
