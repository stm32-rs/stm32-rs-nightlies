...
pub type SDMMC2EN_A = TIM1EN_A;
#[doc = "Reader of field `SDMMC2EN`"]
pub type SDMMC2EN_R = crate::R<bool, TIM1EN_A>;
...
pub type USBPHYCEN_A = TIM1EN_A;
#[doc = "Reader of field `USBPHYCEN`"]
pub type USBPHYCEN_R = crate::R<bool, TIM1EN_A>;
#[doc = "Write proxy for field `USBPHYCEN`"]
pub struct USBPHYCEN_W<'a> {
    w: &'a mut W,
}
impl<'a> USBPHYCEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: USBPHYCEN_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl W {
    ...
    #[doc = "Bit 31 - USB OTG HS PHY controller clock enable"]
    #[inline(always)]
    pub fn usbphycen(&mut self) -> USBPHYCEN_W {
        USBPHYCEN_W { w: self }
    }
}
