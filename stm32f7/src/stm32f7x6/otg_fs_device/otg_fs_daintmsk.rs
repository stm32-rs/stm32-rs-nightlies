#[doc = "Reader of register OTG_FS_DAINTMSK"]
pub type R = crate::R<u32, super::OTG_FS_DAINTMSK>;
#[doc = "Writer for register OTG_FS_DAINTMSK"]
pub type W = crate::W<u32, super::OTG_FS_DAINTMSK>;
#[doc = "Register OTG_FS_DAINTMSK `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_FS_DAINTMSK {
    type Type = u32;
    #[inline(always)]
