#[doc = "Reader of register OTG_FS_DIEPTXF0_Device"]
pub type R = crate::R<u32, super::OTG_FS_DIEPTXF0_DEVICE>;
#[doc = "Writer for register OTG_FS_DIEPTXF0_Device"]
pub type W = crate::W<u32, super::OTG_FS_DIEPTXF0_DEVICE>;
#[doc = "Register OTG_FS_DIEPTXF0_Device `reset()`'s with value 0x0200"]
impl crate::ResetValue for super::OTG_FS_DIEPTXF0_DEVICE {
    type Type = u32;
    #[inline(always)]
