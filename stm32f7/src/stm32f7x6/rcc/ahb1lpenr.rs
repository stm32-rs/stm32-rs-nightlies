...
pub struct AXILPEN_R(crate::FieldReader<bool, bool>);
impl AXILPEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        AXILPEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for AXILPEN_R {
...
pub struct DTCMLPEN_R(crate::FieldReader<bool, bool>);
impl DTCMLPEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        DTCMLPEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DTCMLPEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
