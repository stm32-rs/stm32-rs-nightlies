...
impl W {
    ...
    ///Bit 9 - DBG_LPTIM1_STOP
    #[inline(always)]
    pub fn dbg_lptim1_stop(&mut self) -> DBG_LPTIM1_STOP_W<APB1_FZrs> {
    ...
    ///Bit 13 - DBG_CAN3_STOP
    #[inline(always)]
    pub fn dbg_can3_stop(&mut self) -> DBG_CAN3_STOP_W<APB1_FZrs> {
    ...
    ///Bit 23 - DBG_I2C3_SMBUS_TIMEOUT
    #[inline(always)]
    pub fn dbg_i2c3_smbus_timeout(&mut self) -> DBG_I2C3_SMBUS_TIMEOUT_W<APB1_FZrs> {
        DBG_I2C3_SMBUS_TIMEOUT_W::new(self, 23)
    }
    ///Bit 24 - DBG_I2C4SMBUS_TIMEOUT
    #[inline(always)]
    pub fn dbg_i2c4_smbus_timeout(&mut self) -> DBG_I2C4_SMBUS_TIMEOUT_W<APB1_FZrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32F7x7.html#DBGMCU:APB1_FZ)*/
