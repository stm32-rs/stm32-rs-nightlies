#[doc = "Register `DFSDM1_FCR` reader"]
pub struct R(crate::R<DFSDM1_FCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM1_FCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM1_FCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM1_FCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM1_FCR` writer"]
pub struct W(crate::W<DFSDM1_FCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM1_FCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFSDM1_FCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFSDM1_FCR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "DFSDM filter control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm1_fcr](index.html) module"]
pub struct DFSDM1_FCR_SPEC;
impl crate::RegisterSpec for DFSDM1_FCR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm1_fcr::R](R) reader structure"]
impl crate::Readable for DFSDM1_FCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm1_fcr::W](W) writer structure"]
impl crate::Writable for DFSDM1_FCR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DFSDM1_FCR to value 0"]
impl crate::Resettable for DFSDM1_FCR_SPEC {
    #[inline(always)]
