#[doc = "Register `DFSDM1_JDATAR` reader"]
pub struct R(crate::R<DFSDM1_JDATAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM1_JDATAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM1_JDATAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM1_JDATAR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DFSDM data register for injected group\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm1_jdatar](index.html) module"]
pub struct DFSDM1_JDATAR_SPEC;
impl crate::RegisterSpec for DFSDM1_JDATAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm1_jdatar::R](R) reader structure"]
impl crate::Readable for DFSDM1_JDATAR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DFSDM1_JDATAR to value 0"]
impl crate::Resettable for DFSDM1_JDATAR_SPEC {
    #[inline(always)]
