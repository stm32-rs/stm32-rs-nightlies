#[doc = "Reader of register HUFFBASE0"]
pub type R = crate::R<u32, super::HUFFBASE0>;
#[doc = "Writer for register HUFFBASE0"]
pub type W = crate::W<u32, super::HUFFBASE0>;
#[doc = "Register HUFFBASE0 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE0 {
    type Type = u32;
    #[inline(always)]
