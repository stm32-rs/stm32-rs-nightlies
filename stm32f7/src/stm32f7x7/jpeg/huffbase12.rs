#[doc = "Reader of register HUFFBASE12"]
pub type R = crate::R<u32, super::HUFFBASE12>;
#[doc = "Writer for register HUFFBASE12"]
pub type W = crate::W<u32, super::HUFFBASE12>;
#[doc = "Register HUFFBASE12 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE12 {
    type Type = u32;
    #[inline(always)]
