#[doc = "Reader of register HUFFBASE14"]
pub type R = crate::R<u32, super::HUFFBASE14>;
#[doc = "Writer for register HUFFBASE14"]
pub type W = crate::W<u32, super::HUFFBASE14>;
#[doc = "Register HUFFBASE14 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE14 {
    type Type = u32;
    #[inline(always)]
