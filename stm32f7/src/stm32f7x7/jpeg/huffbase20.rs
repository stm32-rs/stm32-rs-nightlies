#[doc = "Reader of register HUFFBASE20"]
pub type R = crate::R<u32, super::HUFFBASE20>;
#[doc = "Writer for register HUFFBASE20"]
pub type W = crate::W<u32, super::HUFFBASE20>;
#[doc = "Register HUFFBASE20 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE20 {
    type Type = u32;
    #[inline(always)]
