#[doc = "Reader of register HUFFBASE22"]
pub type R = crate::R<u32, super::HUFFBASE22>;
#[doc = "Writer for register HUFFBASE22"]
pub type W = crate::W<u32, super::HUFFBASE22>;
#[doc = "Register HUFFBASE22 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE22 {
    type Type = u32;
    #[inline(always)]
