#[doc = "Reader of register HUFFBASE24"]
pub type R = crate::R<u32, super::HUFFBASE24>;
#[doc = "Writer for register HUFFBASE24"]
pub type W = crate::W<u32, super::HUFFBASE24>;
#[doc = "Register HUFFBASE24 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE24 {
    type Type = u32;
    #[inline(always)]
