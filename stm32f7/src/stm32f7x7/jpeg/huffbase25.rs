#[doc = "Reader of register HUFFBASE25"]
pub type R = crate::R<u32, super::HUFFBASE25>;
#[doc = "Writer for register HUFFBASE25"]
pub type W = crate::W<u32, super::HUFFBASE25>;
#[doc = "Register HUFFBASE25 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE25 {
    type Type = u32;
    #[inline(always)]
