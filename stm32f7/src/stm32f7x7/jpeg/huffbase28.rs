#[doc = "Reader of register HUFFBASE28"]
pub type R = crate::R<u32, super::HUFFBASE28>;
#[doc = "Writer for register HUFFBASE28"]
pub type W = crate::W<u32, super::HUFFBASE28>;
#[doc = "Register HUFFBASE28 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE28 {
    type Type = u32;
    #[inline(always)]
