#[doc = "Reader of register HUFFBASE29"]
pub type R = crate::R<u32, super::HUFFBASE29>;
#[doc = "Writer for register HUFFBASE29"]
pub type W = crate::W<u32, super::HUFFBASE29>;
#[doc = "Register HUFFBASE29 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE29 {
    type Type = u32;
    #[inline(always)]
