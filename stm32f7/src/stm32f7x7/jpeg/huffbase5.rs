#[doc = "Reader of register HUFFBASE5"]
pub type R = crate::R<u32, super::HUFFBASE5>;
#[doc = "Writer for register HUFFBASE5"]
pub type W = crate::W<u32, super::HUFFBASE5>;
#[doc = "Register HUFFBASE5 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE5 {
    type Type = u32;
    #[inline(always)]
