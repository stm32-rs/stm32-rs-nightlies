#[doc = "Reader of register HUFFBASE6"]
pub type R = crate::R<u32, super::HUFFBASE6>;
#[doc = "Writer for register HUFFBASE6"]
pub type W = crate::W<u32, super::HUFFBASE6>;
#[doc = "Register HUFFBASE6 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE6 {
    type Type = u32;
    #[inline(always)]
