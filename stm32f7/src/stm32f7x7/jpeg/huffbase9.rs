#[doc = "Reader of register HUFFBASE9"]
pub type R = crate::R<u32, super::HUFFBASE9>;
#[doc = "Writer for register HUFFBASE9"]
pub type W = crate::W<u32, super::HUFFBASE9>;
#[doc = "Register HUFFBASE9 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE9 {
    type Type = u32;
    #[inline(always)]
