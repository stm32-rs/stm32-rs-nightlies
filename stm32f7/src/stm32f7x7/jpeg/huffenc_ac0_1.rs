#[doc = "Reader of register HUFFENC_AC0_1"]
pub type R = crate::R<u32, super::HUFFENC_AC0_1>;
#[doc = "Writer for register HUFFENC_AC0_1"]
pub type W = crate::W<u32, super::HUFFENC_AC0_1>;
#[doc = "Register HUFFENC_AC0_1 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFENC_AC0_1 {
    type Type = u32;
    #[inline(always)]
