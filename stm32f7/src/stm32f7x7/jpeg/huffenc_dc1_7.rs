#[doc = "Reader of register HUFFENC_DC1_7"]
pub type R = crate::R<u32, super::HUFFENC_DC1_7>;
#[doc = "Writer for register HUFFENC_DC1_7"]
pub type W = crate::W<u32, super::HUFFENC_DC1_7>;
#[doc = "Register HUFFENC_DC1_7 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFENC_DC1_7 {
    type Type = u32;
    #[inline(always)]
