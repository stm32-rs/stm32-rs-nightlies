#[doc = "Reader of register HUFFSYMB3"]
pub type R = crate::R<u32, super::HUFFSYMB3>;
#[doc = "Writer for register HUFFSYMB3"]
pub type W = crate::W<u32, super::HUFFSYMB3>;
#[doc = "Register HUFFSYMB3 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFSYMB3 {
    type Type = u32;
    #[inline(always)]
