#[doc = "Reader of register HUFFSYMB4"]
pub type R = crate::R<u32, super::HUFFSYMB4>;
#[doc = "Writer for register HUFFSYMB4"]
pub type W = crate::W<u32, super::HUFFSYMB4>;
#[doc = "Register HUFFSYMB4 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFSYMB4 {
    type Type = u32;
    #[inline(always)]
