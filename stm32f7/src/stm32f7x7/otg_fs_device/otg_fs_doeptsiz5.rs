#[doc = "Reader of register OTG_FS_DOEPTSIZ5"]
pub type R = crate::R<u32, super::OTG_FS_DOEPTSIZ5>;
#[doc = "Writer for register OTG_FS_DOEPTSIZ5"]
pub type W = crate::W<u32, super::OTG_FS_DOEPTSIZ5>;
#[doc = "Register OTG_FS_DOEPTSIZ5 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_FS_DOEPTSIZ5 {
    type Type = u32;
    #[inline(always)]
