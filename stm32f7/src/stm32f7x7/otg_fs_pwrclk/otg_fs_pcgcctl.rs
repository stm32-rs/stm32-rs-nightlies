#[doc = "Reader of register OTG_FS_PCGCCTL"]
pub type R = crate::R<u32, super::OTG_FS_PCGCCTL>;
#[doc = "Writer for register OTG_FS_PCGCCTL"]
pub type W = crate::W<u32, super::OTG_FS_PCGCCTL>;
#[doc = "Register OTG_FS_PCGCCTL `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_FS_PCGCCTL {
    type Type = u32;
    #[inline(always)]
