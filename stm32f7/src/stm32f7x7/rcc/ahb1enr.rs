...
#[doc = "DTCM data RAM clock enable"]
pub type DTCMRAMEN_A = OTGHSULPIEN_A;
#[doc = "Reader of field `DTCMRAMEN`"]
pub type DTCMRAMEN_R = crate::R<bool, OTGHSULPIEN_A>;
#[doc = "Write proxy for field `DTCMRAMEN`"]
...
impl R {
    ...
    #[doc = "Bit 20 - DTCM data RAM clock enable"]
    #[inline(always)]
