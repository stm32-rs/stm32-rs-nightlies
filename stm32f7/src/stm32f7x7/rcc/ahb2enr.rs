...
pub struct JPEGEN_R(crate::FieldReader<bool, bool>);
impl JPEGEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        JPEGEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for JPEGEN_R {
...
impl R {
    ...
    pub fn jpegen(&self) -> JPEGEN_R {
        JPEGEN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 7 - USB OTG FS clock enable"]
    ...
    #[doc = "Bit 1 - JPEG enable"]
    #[inline(always)]
    pub fn jpegen(&mut self) -> JPEGEN_W {
        JPEGEN_W { w: self }
    }
