...
impl<'a> SPDIFRXLPEN_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled_in_sleep(self) -> &'a mut W {
        self.variant(SPDIFRXLPEN_A::DISABLEDINSLEEP)
    }
    #[doc = "Selected module is enabled during Sleep mode"]
    #[inline(always)]
    pub fn enabled_in_sleep(self) -> &'a mut W {
        self.variant(SPDIFRXLPEN_A::ENABLEDINSLEEP)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub type I2C4LPEN_R = TIM2LPEN_R;
...
impl<'a> I2C4LPEN_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled_in_sleep(self) -> &'a mut W {
        self.variant(I2C4LPEN_A::DISABLEDINSLEEP)
    }
    #[doc = "Selected module is enabled during Sleep mode"]
    #[inline(always)]
    pub fn enabled_in_sleep(self) -> &'a mut W {
        self.variant(I2C4LPEN_A::ENABLEDINSLEEP)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub struct CAN3LPEN_R(crate::FieldReader<bool, bool>);
impl CAN3LPEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        CAN3LPEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CAN3LPEN_R {
...
impl R {
    ...
    pub fn can3lpen(&self) -> CAN3LPEN_R {
        CAN3LPEN_R::new(((self.bits >> 13) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - TIM2 clock enable during Sleep mode"]
