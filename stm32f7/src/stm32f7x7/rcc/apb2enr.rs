...
pub type MDIOEN_A = TIM1EN_A;
#[doc = "Field `MDIOEN` reader - MDIO clock enable"]
pub type MDIOEN_R = TIM1EN_R;
#[doc = "Field `MDIOEN` writer - MDIO clock enable"]
pub struct MDIOEN_W<'a> {
    w: &'a mut W,
}
impl<'a> MDIOEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: MDIOEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "The selected clock is disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(MDIOEN_A::DISABLED)
    }
    #[doc = "The selected clock is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(MDIOEN_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn mdioen(&self) -> MDIOEN_R {
        MDIOEN_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    #[doc = "Bit 29 - DFSDM1 clock enable"]
    #[inline(always)]
    pub fn dfsdm1en(&self) -> DFSDM1EN_R {
        DFSDM1EN_R::new(((self.bits >> 29) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 30 - MDIO clock enable"]
    #[inline(always)]
    pub fn mdioen(&mut self) -> MDIOEN_W {
        MDIOEN_W { w: self }
    }
    #[doc = "Bit 29 - DFSDM1 clock enable"]
    #[inline(always)]
