...
pub struct MDIORST_R(crate::FieldReader<bool, bool>);
impl MDIORST_R {
    pub(crate) fn new(bits: bool) -> Self {
        MDIORST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MDIORST_R {
...
impl R {
    ...
    pub fn mdiorst(&self) -> MDIORST_R {
        MDIORST_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    #[doc = "Bit 29 - DFSDM 1 reset"]
    #[inline(always)]
    pub fn dfsdm1rst(&self) -> DFSDM1RST_R {
        DFSDM1RST_R::new(((self.bits >> 29) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 30 - MDIO reset"]
    #[inline(always)]
    pub fn mdiorst(&mut self) -> MDIORST_W {
        MDIORST_W { w: self }
    }
    #[doc = "Bit 29 - DFSDM 1 reset"]
    #[inline(always)]
