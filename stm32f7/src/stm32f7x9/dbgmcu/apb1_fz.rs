...
pub struct DBG_CAN3_STOP_R(crate::FieldReader<bool, bool>);
impl DBG_CAN3_STOP_R {
    pub(crate) fn new(bits: bool) -> Self {
        DBG_CAN3_STOP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DBG_CAN3_STOP_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DBG_I2C3_SMBUS_TIMEOUT_R(crate::FieldReader<bool, bool>);
impl DBG_I2C3_SMBUS_TIMEOUT_R {
    pub(crate) fn new(bits: bool) -> Self {
        DBG_I2C3_SMBUS_TIMEOUT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DBG_I2C3_SMBUS_TIMEOUT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DBG_I2C4_SMBUS_TIMEOUT_R(crate::FieldReader<bool, bool>);
impl DBG_I2C4_SMBUS_TIMEOUT_R {
    pub(crate) fn new(bits: bool) -> Self {
        DBG_I2C4_SMBUS_TIMEOUT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DBG_I2C4_SMBUS_TIMEOUT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
