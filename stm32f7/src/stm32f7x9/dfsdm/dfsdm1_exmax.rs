#[doc = "Register `DFSDM1_EXMAX` reader"]
pub struct R(crate::R<DFSDM1_EXMAX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM1_EXMAX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM1_EXMAX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM1_EXMAX_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DFSDM Extremes detector maximum register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm1_exmax](index.html) module"]
pub struct DFSDM1_EXMAX_SPEC;
impl crate::RegisterSpec for DFSDM1_EXMAX_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm1_exmax::R](R) reader structure"]
impl crate::Readable for DFSDM1_EXMAX_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DFSDM1_EXMAX to value 0"]
impl crate::Resettable for DFSDM1_EXMAX_SPEC {
    #[inline(always)]
