#[doc = "Reader of register HUFFBASE1"]
pub type R = crate::R<u32, super::HUFFBASE1>;
#[doc = "Writer for register HUFFBASE1"]
pub type W = crate::W<u32, super::HUFFBASE1>;
#[doc = "Register HUFFBASE1 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE1 {
    type Type = u32;
    #[inline(always)]
