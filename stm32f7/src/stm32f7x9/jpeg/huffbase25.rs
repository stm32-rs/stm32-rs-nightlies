#[doc = "Register `HUFFBASE25` reader"]
pub struct R(crate::R<HUFFBASE25_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HUFFBASE25_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HUFFBASE25_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HUFFBASE25_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HUFFBASE25` writer"]
pub struct W(crate::W<HUFFBASE25_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HUFFBASE25_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HUFFBASE25_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HUFFBASE25_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "JPEG HuffSymb tables\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [huffbase25](index.html) module"]
pub struct HUFFBASE25_SPEC;
impl crate::RegisterSpec for HUFFBASE25_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [huffbase25::R](R) reader structure"]
impl crate::Readable for HUFFBASE25_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [huffbase25::W](W) writer structure"]
impl crate::Writable for HUFFBASE25_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HUFFBASE25 to value 0"]
impl crate::Resettable for HUFFBASE25_SPEC {
    #[inline(always)]
