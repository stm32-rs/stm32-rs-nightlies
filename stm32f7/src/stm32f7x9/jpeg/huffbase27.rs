#[doc = "Reader of register HUFFBASE27"]
pub type R = crate::R<u32, super::HUFFBASE27>;
#[doc = "Writer for register HUFFBASE27"]
pub type W = crate::W<u32, super::HUFFBASE27>;
#[doc = "Register HUFFBASE27 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE27 {
    type Type = u32;
    #[inline(always)]
