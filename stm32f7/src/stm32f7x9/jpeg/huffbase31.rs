#[doc = "Reader of register HUFFBASE31"]
pub type R = crate::R<u32, super::HUFFBASE31>;
#[doc = "Writer for register HUFFBASE31"]
pub type W = crate::W<u32, super::HUFFBASE31>;
#[doc = "Register HUFFBASE31 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE31 {
    type Type = u32;
    #[inline(always)]
