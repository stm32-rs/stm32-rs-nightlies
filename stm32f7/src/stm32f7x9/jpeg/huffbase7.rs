#[doc = "Reader of register HUFFBASE7"]
pub type R = crate::R<u32, super::HUFFBASE7>;
#[doc = "Writer for register HUFFBASE7"]
pub type W = crate::W<u32, super::HUFFBASE7>;
#[doc = "Register HUFFBASE7 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFBASE7 {
    type Type = u32;
    #[inline(always)]
