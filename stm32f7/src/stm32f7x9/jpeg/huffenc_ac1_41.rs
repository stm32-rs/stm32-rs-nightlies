#[doc = "Reader of register HUFFENC_AC1_41"]
pub type R = crate::R<u32, super::HUFFENC_AC1_41>;
#[doc = "Writer for register HUFFENC_AC1_41"]
pub type W = crate::W<u32, super::HUFFENC_AC1_41>;
#[doc = "Register HUFFENC_AC1_41 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFENC_AC1_41 {
    type Type = u32;
    #[inline(always)]
