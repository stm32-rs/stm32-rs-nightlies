#[doc = "Reader of register HUFFENC_AC1_80"]
pub type R = crate::R<u32, super::HUFFENC_AC1_80>;
#[doc = "Writer for register HUFFENC_AC1_80"]
pub type W = crate::W<u32, super::HUFFENC_AC1_80>;
#[doc = "Register HUFFENC_AC1_80 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFENC_AC1_80 {
    type Type = u32;
    #[inline(always)]
