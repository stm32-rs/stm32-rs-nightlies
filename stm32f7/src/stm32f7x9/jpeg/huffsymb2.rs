#[doc = "Reader of register HUFFSYMB2"]
pub type R = crate::R<u32, super::HUFFSYMB2>;
#[doc = "Writer for register HUFFSYMB2"]
pub type W = crate::W<u32, super::HUFFSYMB2>;
#[doc = "Register HUFFSYMB2 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFSYMB2 {
    type Type = u32;
    #[inline(always)]
