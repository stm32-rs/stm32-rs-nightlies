#[doc = "Reader of register HUFFSYMB50"]
pub type R = crate::R<u32, super::HUFFSYMB50>;
#[doc = "Writer for register HUFFSYMB50"]
pub type W = crate::W<u32, super::HUFFSYMB50>;
#[doc = "Register HUFFSYMB50 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFSYMB50 {
    type Type = u32;
    #[inline(always)]
