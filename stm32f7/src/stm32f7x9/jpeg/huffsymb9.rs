#[doc = "Reader of register HUFFSYMB9"]
pub type R = crate::R<u32, super::HUFFSYMB9>;
#[doc = "Writer for register HUFFSYMB9"]
pub type W = crate::W<u32, super::HUFFSYMB9>;
#[doc = "Register HUFFSYMB9 `reset()`'s with value 0"]
impl crate::ResetValue for super::HUFFSYMB9 {
    type Type = u32;
    #[inline(always)]
