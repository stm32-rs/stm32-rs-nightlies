#[doc = "Reader of register OTG_FS_DCTL"]
pub type R = crate::R<u32, super::OTG_FS_DCTL>;
#[doc = "Writer for register OTG_FS_DCTL"]
pub type W = crate::W<u32, super::OTG_FS_DCTL>;
#[doc = "Register OTG_FS_DCTL `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_FS_DCTL {
    type Type = u32;
    #[inline(always)]
