#[doc = "Reader of register OTG_FS_HNPTXFSIZ_Host"]
pub type R = crate::R<u32, super::OTG_FS_HNPTXFSIZ_HOST>;
#[doc = "Writer for register OTG_FS_HNPTXFSIZ_Host"]
pub type W = crate::W<u32, super::OTG_FS_HNPTXFSIZ_HOST>;
#[doc = "Register OTG_FS_HNPTXFSIZ_Host `reset()`'s with value 0x0200"]
impl crate::ResetValue for super::OTG_FS_HNPTXFSIZ_HOST {
    type Type = u32;
    #[inline(always)]
