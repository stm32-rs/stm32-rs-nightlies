...
impl<'a> SAI2LPEN_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled_in_sleep(self) -> &'a mut W {
        self.variant(SAI2LPEN_A::DISABLEDINSLEEP)
    }
    #[doc = "Selected module is enabled during Sleep mode"]
    #[inline(always)]
    pub fn enabled_in_sleep(self) -> &'a mut W {
        self.variant(SAI2LPEN_A::ENABLEDINSLEEP)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub type SDMMC1LPEN_R = TIM1LPEN_R;
...
impl<'a> SDMMC1LPEN_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled_in_sleep(self) -> &'a mut W {
        self.variant(SDMMC1LPEN_A::DISABLEDINSLEEP)
    }
    #[doc = "Selected module is enabled during Sleep mode"]
    #[inline(always)]
    pub fn enabled_in_sleep(self) -> &'a mut W {
        self.variant(SDMMC1LPEN_A::ENABLEDINSLEEP)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub struct MDIOLPEN_R(crate::FieldReader<bool, bool>);
impl MDIOLPEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        MDIOLPEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MDIOLPEN_R {
...
pub struct DFSDM1LPEN_R(crate::FieldReader<bool, bool>);
impl DFSDM1LPEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        DFSDM1LPEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DFSDM1LPEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn sdmmc2lpen(&self) -> SDMMC2LPEN_R {
        SDMMC2LPEN_R::new(((self.bits >> 7) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - TIM1 clock enable during Sleep mode"]
    ...
    #[doc = "Bit 30 - MDIO clock enable during Sleep mode"]
    #[inline(always)]
    pub fn mdiolpen(&mut self) -> MDIOLPEN_W {
        MDIOLPEN_W { w: self }
    }
    #[doc = "Bit 29 - DFSDM1 clock enable during Sleep mode"]
    #[inline(always)]
