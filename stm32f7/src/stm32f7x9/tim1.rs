...
#[doc = "capture/compare register 5"]
pub mod ccr5;
#[doc = "capture/compare register 6\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [crr6](crr6) module"]
pub type CRR6 = crate::Reg<u32, _CRR6>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CRR6;
#[doc = "`read()` method returns [crr6::R](crr6::R) reader structure"]
impl crate::Readable for CRR6 {}
#[doc = "`write(|w| ..)` method takes [crr6::W](crr6::W) writer structure"]
impl crate::Writable for CRR6 {}
#[doc = "capture/compare register 6"]
pub mod crr6;
