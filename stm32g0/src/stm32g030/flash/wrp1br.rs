...
///Field `WRP1B_STRT` writer - WRP area B start offset
...
///Field `WRP1B_END` writer - WRP area B end offset
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G030.html#FLASH:WRP1BR)*/
pub struct WRP1BRrs;
...
///`reset()` method sets WRP1BR to value 0xff
