...
///Field `CHSEL(0-18)` reader - Channel-%s selection
...
///Field `CHSEL(0-18)` writer - Channel-%s selection
...
///`reset()` method sets CHSELR0 to value 0x0fff_0000
