...
pub type LSERDY_W<'a, REG> = crate::BitWriter<'a, REG, LSERDY>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn not_ready(self) -> &'a mut crate::W<REG> {
        self.variant(LSERDY::NotReady)
    }
    ///LSE oscillator ready
    #[inline(always)]
    pub fn ready(self) -> &'a mut crate::W<REG> {
        self.variant(LSERDY::Ready)
    }
}
...
pub type LSECSSD_W<'a, REG> = crate::BitWriter<'a, REG, LSECSSD>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_failure(self) -> &'a mut crate::W<REG> {
        self.variant(LSECSSD::NoFailure)
    }
    ///Failure detected
    #[inline(always)]
    pub fn failure(self) -> &'a mut crate::W<REG> {
        self.variant(LSECSSD::Failure)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G041.html#RCC:BDCR)*/
pub struct BDCRrs;
