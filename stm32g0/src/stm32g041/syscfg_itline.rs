...
#[doc = "interrupt line 29 status register"]
pub mod itline29;
#[doc = "interrupt line 31 status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [itline31](itline31) module"]
pub type ITLINE31 = crate::Reg<u32, _ITLINE31>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ITLINE31;
#[doc = "`read()` method returns [itline31::R](itline31::R) reader structure"]
impl crate::Readable for ITLINE31 {}
#[doc = "interrupt line 31 status register"]
pub mod itline31;
