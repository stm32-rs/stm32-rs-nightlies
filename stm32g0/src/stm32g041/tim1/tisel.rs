...
impl W {
    ///Bits 0:3 - selects TI1\[0\] to TI1\[15\] input
    #[inline(always)]
    pub fn ti1sel3_0(&mut self) -> TI1SEL3_0_W<'_, TISELrs> {
        TI1SEL3_0_W::new(self, 0)
    }
    ///Bits 8:11 - selects TI2\[0\] to TI2\[15\] input
    #[inline(always)]
    pub fn ti2sel3_0(&mut self) -> TI2SEL3_0_W<'_, TISELrs> {
        TI2SEL3_0_W::new(self, 8)
    }
    ///Bits 16:19 - selects TI3\[0\] to TI3\[15\] input
    #[inline(always)]
    pub fn ti3sel3_0(&mut self) -> TI3SEL3_0_W<'_, TISELrs> {
        TI3SEL3_0_W::new(self, 16)
    }
    ///Bits 24:27 - selects TI4\[0\] to TI4\[15\] input
    #[inline(always)]
    pub fn ti4sel3_0(&mut self) -> TI4SEL3_0_W<'_, TISELrs> {
