...
///Field `CSOF(0-11)` writer - Synchronization Clear Overrun Flag %s
...
impl W {
    ///Synchronization Clear Overrun Flag (0-11)
    ///
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G050.html#DMAMUX:CFR)*/
pub struct CFRrs;
