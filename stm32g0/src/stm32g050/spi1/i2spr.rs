...
///Field `I2SDIV` reader - I2S linear prescaler I2SDIV \[7:0\] = 0 or I2SDIV \[7:0\] = 1 are forbidden values. Refer to . Note: These bits should be configured when the I2S is disabled. They are used only when the I2S is in master mode. They are not used in SPI mode.
pub type I2SDIV_R = crate::FieldReader;
///Field `I2SDIV` writer - I2S linear prescaler I2SDIV \[7:0\] = 0 or I2SDIV \[7:0\] = 1 are forbidden values. Refer to . Note: These bits should be configured when the I2S is disabled. They are used only when the I2S is in master mode. They are not used in SPI mode.
