///Register `AES_DINR` reader
pub type R = crate::R<AES_DINRrs>;
...
///`read()` method returns [`aes_dinr::R`](R) reader structure
impl crate::Readable for AES_DINRrs {}
