///Register `AES_IVR3` reader
pub type R = crate::R<AES_IVR3rs>;
///Register `AES_IVR3` writer
pub type W = crate::W<AES_IVR3rs>;
...
impl W {
    ...
    bitfield.*/
    #[inline(always)]
    pub fn ivi(&mut self) -> IVI_W<AES_IVR3rs> {
        IVI_W::new(self, 0)
    }
}
...
pub struct AES_IVR3rs;
impl crate::RegisterSpec for AES_IVR3rs {
    type Ux = u32;
}
///`read()` method returns [`aes_ivr3::R`](R) reader structure
impl crate::Readable for AES_IVR3rs {}
///`write(|w| ..)` method takes [`aes_ivr3::W`](W) writer structure
impl crate::Writable for AES_IVR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets AES_IVR3 to value 0
impl crate::Resettable for AES_IVR3rs {
