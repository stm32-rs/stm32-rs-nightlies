///Register `AES_KEYR0` reader
pub type R = crate::R<AES_KEYR0rs>;
...
///`read()` method returns [`aes_keyr0::R`](R) reader structure
impl crate::Readable for AES_KEYR0rs {}
