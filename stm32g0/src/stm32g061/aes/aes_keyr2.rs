///Register `AES_KEYR2` reader
pub type R = crate::R<AES_KEYR2rs>;
...
You can [`read`](crate::Reg::read) this register and get [`aes_keyr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`aes_keyr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`aes_keyr2::R`](R) reader structure
impl crate::Readable for AES_KEYR2rs {}
