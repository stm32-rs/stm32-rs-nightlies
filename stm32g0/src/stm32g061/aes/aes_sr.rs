///Register `AES_SR` reader
pub type R = crate::R<AES_SRrs>;
...
pub struct AES_SRrs;
impl crate::RegisterSpec for AES_SRrs {
    type Ux = u32;
}
///`read()` method returns [`aes_sr::R`](R) reader structure
impl crate::Readable for AES_SRrs {}
///`reset()` method sets AES_SR to value 0
impl crate::Resettable for AES_SRrs {
