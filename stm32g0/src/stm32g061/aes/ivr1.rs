...
///Field `IVI` reader - Initialization vector input, bits \[63:32\] Refer to the AES_IVR0 register for description of the IVI\[128:0\] bitfield.
pub type IVI_R = crate::FieldReader<u32>;
///Field `IVI` writer - Initialization vector input, bits \[63:32\] Refer to the AES_IVR0 register for description of the IVI\[128:0\] bitfield.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G061.html#AES:IVR1)*/
pub struct IVR1rs;
