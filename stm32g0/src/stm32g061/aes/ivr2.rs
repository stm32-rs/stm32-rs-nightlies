...
///Field `IVI` reader - Initialization vector input, bits \[95:64\] Refer to the AES_IVR0 register for description of the IVI\[128:0\] bitfield.
pub type IVI_R = crate::FieldReader<u32>;
///Field `IVI` writer - Initialization vector input, bits \[95:64\] Refer to the AES_IVR0 register for description of the IVI\[128:0\] bitfield.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G061.html#AES:IVR2)*/
pub struct IVR2rs;
