...
impl W {
    ...
    ///Bit 5 - Enable WKUP6 wakeup pin
    #[inline(always)]
    pub fn ewup6(&mut self) -> EWUP6_W<'_, CR3rs> {
        EWUP6_W::new(self, 5)
    }
    ///Bit 8 - SRAM retention in Standby mode
    #[inline(always)]
    ...
    ///Bit 9 - Ultra-low-power enable
    #[inline(always)]
    pub fn enb_ulp(&mut self) -> ENB_ULP_W<'_, CR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G061.html#PWR:CR3)*/
pub struct CR3rs;
