...
pub enum RNGSEL {
    ...
    Hsi16 = 1,
    ///2: SYSCLK clock selected
    Sysclk = 2,
    ///3: PLLQCLK clock selected
    Pllq = 3,
}
...
impl From<RNGDIV> for u8 {
    #[inline(always)]
    fn from(variant: RNGDIV) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for RNGDIV {
    type Ux = u8;
}
impl crate::IsEnum for RNGDIV {}
///Field `RNGDIV` reader - Division factor of RNG clock divider
pub type RNGDIV_R = crate::FieldReader<RNGDIV>;
impl RNGDIV_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> RNGDIV {
        match self.bits {
            0 => RNGDIV::Div1,
            1 => RNGDIV::Div2,
            2 => RNGDIV::Div4,
...
pub type RNGDIV_W<'a, REG> = crate::FieldWriter<'a, REG, 2, RNGDIV, crate::Safe>;
impl<'a, REG> RNGDIV_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    ...
    pub fn div1(self) -> &'a mut crate::W<REG> {
        self.variant(RNGDIV::Div1)
    }
    ///Divide by 2
    #[inline(always)]
    pub fn div2(self) -> &'a mut crate::W<REG> {
        self.variant(RNGDIV::Div2)
    }
    ///Divide by 4
    #[inline(always)]
    pub fn div4(self) -> &'a mut crate::W<REG> {
        self.variant(RNGDIV::Div4)
    }
    ///Divide by 8
    #[inline(always)]
    pub fn div8(self) -> &'a mut crate::W<REG> {
        self.variant(RNGDIV::Div8)
    }
}
...
impl W {
    ...
    ///Bits 28:29 - Division factor of RNG clock divider
    #[inline(always)]
    pub fn rngdiv(&mut self) -> RNGDIV_W<'_, CCIPRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G061.html#RCC:CCIPR)*/
pub struct CCIPRrs;
