...
/**RTC_OUT2 output enable Setting this bit allows to remap the RTC outputs on RTC_OUT2
...
///Field `OUT2EN` reader - RTC_OUT2 output enable Setting this bit allows to remap the RTC outputs on RTC_OUT2
...
///Field `OUT2EN` writer - RTC_OUT2 output enable Setting this bit allows to remap the RTC outputs on RTC_OUT2
...
impl R {
    ...
    ///Bit 31 - RTC_OUT2 output enable Setting this bit allows to remap the RTC outputs on RTC_OUT2
    #[inline(always)]
