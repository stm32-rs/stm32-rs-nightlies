...
///Field `FDCAN1_IT0` reader - FDCAN1_IT0
pub use TIM16_R as FDCAN1_IT0_R;
///Field `FDCAN2_IT0` reader - FDCAN2_IT0
pub use TIM16_R as FDCAN2_IT0_R;
impl R {
    ///Bit 0 - TIM16
    #[inline(always)]
    ...
    ///Bit 1 - FDCAN1_IT0
    #[inline(always)]
    pub fn fdcan1_it0(&self) -> FDCAN1_IT0_R {
        FDCAN1_IT0_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - FDCAN2_IT0
    #[inline(always)]
    pub fn fdcan2_it0(&self) -> FDCAN2_IT0_R {
        FDCAN2_IT0_R::new(((self.bits >> 2) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ITLINE21")
            ...
            .field("fdcan1_it0", &self.fdcan1_it0())
            .field("fdcan2_it0", &self.fdcan2_it0())
            .finish()
    }
}
