...
///Field `EXTI0` reader - GPIO port selection
...
///Field `EXTI0` writer - GPIO port selection
...
///Field `EXTI1` reader - GPIO port selection
pub use EXTI0_R as EXTI1_R;
///Field `EXTI2` reader - GPIO port selection
pub use EXTI0_R as EXTI2_R;
///Field `EXTI3` reader - GPIO port selection
pub use EXTI0_R as EXTI3_R;
///Field `EXTI1` writer - GPIO port selection
pub use EXTI0_W as EXTI1_W;
///Field `EXTI2` writer - GPIO port selection
pub use EXTI0_W as EXTI2_W;
///Field `EXTI3` writer - GPIO port selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G070.html#EXTI:EXTICR1)*/
