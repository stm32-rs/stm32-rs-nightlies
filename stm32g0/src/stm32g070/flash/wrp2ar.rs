...
///Field `WRP2A_STRT` reader - WRP2A_STRT
pub type WRP2A_STRT_R = crate::FieldReader;
///Field `WRP2A_STRT` writer - WRP2A_STRT
pub type WRP2A_STRT_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `WRP2A_END` reader - WRP2A_END
pub type WRP2A_END_R = crate::FieldReader;
///Field `WRP2A_END` writer - WRP2A_END
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G070.html#FLASH:WRP2AR)*/
pub struct WRP2ARrs;
