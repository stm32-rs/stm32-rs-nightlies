...
///Field `WRP2B_STRT` reader - WRP2B_STRT
pub type WRP2B_STRT_R = crate::FieldReader;
///Field `WRP2B_STRT` writer - WRP2B_STRT
pub type WRP2B_STRT_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `WRP2B_END` reader - WRP2B_END
pub type WRP2B_END_R = crate::FieldReader;
///Field `WRP2B_END` writer - WRP2B_END
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G070.html#FLASH:WRP2BR)*/
pub struct WRP2BRrs;
