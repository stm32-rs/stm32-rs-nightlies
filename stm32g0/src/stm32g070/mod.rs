/*!Peripheral access API for STM32G070 microcontrollers (generated using svd2rust v0.33.4 (5b6615e 2024-06-16))
...
///DMA controller
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32G070.html#DMA)
pub struct DMA {
    _marker: PhantomData<*const ()>,
}
...
///SysTick timer
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32G070.html#STK)
pub struct STK {
    _marker: PhantomData<*const ()>,
}
