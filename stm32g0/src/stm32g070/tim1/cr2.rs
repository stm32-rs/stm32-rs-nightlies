...
#[doc = "Field `OIS(1-6)` reader - Output Idle state (OC%s output)"]
...
#[doc = "Field `OIS(1-6)` writer - Output Idle state (OC%s output)"]
...
impl R {
    ...
    #[doc = "Output Idle state (OC(1-6) output)"]
    #[doc = ""]
    ...
    #[doc = "Bit 16 - Output Idle state (OC5 output)"]
    #[inline(always)]
    pub fn ois5(&self) -> OIS_R {
        OIS_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 18 - Output Idle state (OC6 output)"]
    #[inline(always)]
