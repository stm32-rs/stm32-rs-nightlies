...
#[doc = "Field `CGIF(1-7)` writer - Channel %s Global interrupt clear"]
...
#[doc = "Field `CTCIF(1-7)` writer - Channel %s Transfer Complete clear"]
...
#[doc = "Field `CHTIF(1-7)` writer - Channel %s Half Transfer clear"]
...
#[doc = "Field `CTEIF(1-7)` writer - Channel %s Transfer Error clear"]
