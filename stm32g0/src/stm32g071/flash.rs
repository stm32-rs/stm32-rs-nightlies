...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:ACR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:KEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:OPTKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:ECCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:ECCR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:OPTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:PCROP1ASR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:PCROP1AER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:WRP1AR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:WRP1BR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:PCROP1BSR)
...
pub mod pcrop1bsr;
/**PCROP1BER (r) register accessor: Flash PCROP zone B End address register

You can [`read`](crate::Reg::read) this register and get [`pcrop1ber::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
pub mod pcrop1ber;
/**SECR (r) register accessor: Flash Security register

You can [`read`](crate::Reg::read) this register and get [`secr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#FLASH:SECR)
