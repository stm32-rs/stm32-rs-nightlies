...
#[doc = "Reader of field `UCPD2_STROBE`"]
pub type UCPD2_STROBE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `UCPD2_STROBE`"]
...
#[doc = "Reader of field `UCPD1_STROBE`"]
pub type UCPD1_STROBE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `UCPD1_STROBE`"]
