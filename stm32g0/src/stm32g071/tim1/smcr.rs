...
pub type TS_4_R = crate::FieldReader;
///Field `TS_4` writer - Trigger selection
pub type TS_4_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type TS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl W {
    ...
    ///Bits 4:6 - Trigger selection
    #[inline(always)]
    pub fn ts_4(&mut self) -> TS_4_W<SMCRrs> {
        TS_4_W::new(self, 4)
    }
    ///Bit 7 - Master/Slave mode
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G071.html#TIM1:SMCR)*/
pub struct SMCRrs;
