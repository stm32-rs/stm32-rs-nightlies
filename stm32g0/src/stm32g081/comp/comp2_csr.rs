...
impl W {
    ...
    ///Bit 14 - Comparator 2 output selector
    #[inline(always)]
    pub fn winout(&mut self) -> WINOUT_W<'_, COMP2_CSRrs> {
    ...
    ///Bits 20:24 - Comparator 2 blanking source selector
    #[inline(always)]
    pub fn blanksel(&mut self) -> BLANKSEL_W<'_, COMP2_CSRrs> {
        BLANKSEL_W::new(self, 20)
    }
    ///Bit 30 - Comparator 2 output status
    #[inline(always)]
    pub fn value(&mut self) -> VALUE_W<'_, COMP2_CSRrs> {
        VALUE_W::new(self, 30)
    }
    ///Bit 31 - COMP2_CSR register lock
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#COMP:COMP2_CSR)*/
