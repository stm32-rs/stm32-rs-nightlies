...
/**ISR (r) register accessor: low interrupt status register

You can [`read`](crate::Reg::read) this register and get [`isr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#DMA:ISR)
...
pub mod isr;
/**IFCR (w) register accessor: high interrupt status register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#DMA:IFCR)
