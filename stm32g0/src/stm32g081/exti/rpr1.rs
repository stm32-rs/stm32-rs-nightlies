...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RPR1")
            ...
            .field("rpif17", &self.rpif17())
            .field("rpif18", &self.rpif18())
            .finish()
    }
}
impl W {
    ...
    ///Bit 17 - configurable event inputs x rising edge Pending bit.
    #[inline(always)]
    pub fn rpif17(&mut self) -> RPIF17_W<'_, RPR1rs> {
        RPIF17_W::new(self, 17)
    }
    ///Bit 18 - configurable event inputs x rising edge Pending bit.
    #[inline(always)]
    pub fn rpif18(&mut self) -> RPIF18_W<'_, RPR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#EXTI:RPR1)*/
pub struct RPR1rs;
