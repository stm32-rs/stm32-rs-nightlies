...
#[doc = "Field `OCCE(1-1)` reader - Output compare %s clear enable"]
pub type OCCE_R = crate::BitReader;
#[doc = "Field `OCCE(1-1)` writer - Output compare %s clear enable"]
pub type OCCE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OCM_3(1-1)` reader - Output compare %s mode, bit 3"]
pub type OCM_3_R = crate::BitReader;
#[doc = "Field `OCM_3(1-1)` writer - Output compare %s mode, bit 3"]
...
impl R {
    ...
    #[doc = "Output compare (1-1) clear enable"]
    #[doc = ""]
    ...
    #[doc = "Output compare (1-1) mode, bit 3"]
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `OC1M_3` field"]
    #[inline(always)]
