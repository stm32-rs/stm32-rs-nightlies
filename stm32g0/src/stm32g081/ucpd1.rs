...
/**CFGR1 (rw) register accessor: UCPD configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:CFGR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:CFGR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:IMR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:TX_ORDSETR)
...
pub mod tx_ordsetr;
/**TX_PAYSZR (rw) register accessor: UCPD Tx Paysize Register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:TX_PAYSZR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:TXDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:RX_ORDSETR)
...
pub mod rx_ordsetr;
/**RX_PAYSZR (rw) register accessor: UCPD Rx Paysize Register

You can [`read`](crate::Reg::read) this register and get [`rx_payszr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_payszr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:RXDR)

For information about available fields see [`mod@rxdr`] module*/
pub type RXDR = crate::Reg<rxdr::RXDRrs>;
///UCPD Receive Data Register
pub mod rxdr;
/**RX_ORDEXTR1 (rw) register accessor: UCPD Rx Ordered Set Extension Register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:RX_ORDEXTR1)
...
pub mod rx_ordextr1;
/**RX_ORDEXTR2 (rw) register accessor: UCPD Rx Ordered Set Extension Register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:RX_ORDEXTR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:IPVER)

For information about available fields see [`mod@ipver`] module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:IPID)

For information about available fields see [`mod@ipid`] module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G081.html#UCPD1:MID)
