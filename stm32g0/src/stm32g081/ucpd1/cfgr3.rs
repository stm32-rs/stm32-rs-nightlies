...
impl W {
    ///Bits 0:3 - TRIM1_NG_CCRPD
    #[inline(always)]
    pub fn trim1_ng_ccrpd(&mut self) -> TRIM1_NG_CCRPD_W<'_, CFGR3rs> {
        TRIM1_NG_CCRPD_W::new(self, 0)
    }
    ///Bits 4:8 - TRIM1_NG_CC1A5
    #[inline(always)]
    pub fn trim1_ng_cc1a5(&mut self) -> TRIM1_NG_CC1A5_W<'_, CFGR3rs> {
        TRIM1_NG_CC1A5_W::new(self, 4)
    }
    ///Bits 9:12 - TRIM1_NG_CC3A0
    #[inline(always)]
    pub fn trim1_ng_cc3a0(&mut self) -> TRIM1_NG_CC3A0_W<'_, CFGR3rs> {
        TRIM1_NG_CC3A0_W::new(self, 9)
    }
    ///Bits 16:19 - TRIM2_NG_CCRPD
    #[inline(always)]
    pub fn trim2_ng_ccrpd(&mut self) -> TRIM2_NG_CCRPD_W<'_, CFGR3rs> {
        TRIM2_NG_CCRPD_W::new(self, 16)
    }
    ///Bits 20:24 - TRIM2_NG_CC1A5
    #[inline(always)]
    pub fn trim2_ng_cc1a5(&mut self) -> TRIM2_NG_CC1A5_W<'_, CFGR3rs> {
        TRIM2_NG_CC1A5_W::new(self, 20)
    }
    ///Bits 25:28 - TRIM2_NG_CC3A0
    #[inline(always)]
    pub fn trim2_ng_cc3a0(&mut self) -> TRIM2_NG_CC3A0_W<'_, CFGR3rs> {
