...
///Field `CGIF(1-7)` reader - Channel %s Global interrupt clear
...
///Field `CTCIF(1-7)` reader - Channel %s Transfer Complete clear
...
///Field `CHTIF(1-7)` reader - Channel %s Half Transfer clear
...
///Field `CTEIF(1-7)` reader - Channel %s Transfer Error clear
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0B0.html#DMA1:IFCR)*/
pub struct IFCRrs;
