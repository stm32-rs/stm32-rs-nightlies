...
///Field `CSOF(0-6)` writer - Synchronization Clear Overrun Flag %s
...
impl W {
    ///Synchronization Clear Overrun Flag (0-6)
    ///
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0B0.html#DMAMUX:CFR)*/
pub struct CFRrs;
