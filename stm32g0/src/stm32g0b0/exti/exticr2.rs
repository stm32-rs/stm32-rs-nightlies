...
///Field `EXTI4` reader - GPIO port selection
pub use super::exticr1::EXTI0_R as EXTI4_R;
///Field `EXTI5` reader - GPIO port selection
pub use super::exticr1::EXTI0_R as EXTI5_R;
///Field `EXTI6` reader - GPIO port selection
pub use super::exticr1::EXTI0_R as EXTI6_R;
///Field `EXTI7` reader - GPIO port selection
pub use super::exticr1::EXTI0_R as EXTI7_R;
///Field `EXTI4` writer - GPIO port selection
pub use super::exticr1::EXTI0_W as EXTI4_W;
///Field `EXTI5` writer - GPIO port selection
pub use super::exticr1::EXTI0_W as EXTI5_W;
///Field `EXTI6` writer - GPIO port selection
pub use super::exticr1::EXTI0_W as EXTI6_W;
///Field `EXTI7` writer - GPIO port selection
