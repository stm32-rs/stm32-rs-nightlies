...
pub use TIM3RST_R as TIM4RST_R;
...
pub use TIM3RST_R as USART6RST_R;
...
pub use TIM3RST_R as SPI3RST_R;
...
pub use TIM3RST_R as I2C3RST_R;
...
pub use TIM3RST_W as TIM4RST_W;
...
pub use TIM3RST_W as USART6RST_W;
...
pub use TIM3RST_W as SPI3RST_W;
...
pub use TIM3RST_W as I2C3RST_W;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim4rst(&mut self) -> TIM4RST_W<APBRSTR1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart5rst(&mut self) -> USART5RST_W<APBRSTR1rs> {
        USART5RST_W::new(self, 8)
    }
    ///Bit 9 - USART6RST
    #[inline(always)]
    #[must_use]
    pub fn usart6rst(&mut self) -> USART6RST_W<APBRSTR1rs> {
