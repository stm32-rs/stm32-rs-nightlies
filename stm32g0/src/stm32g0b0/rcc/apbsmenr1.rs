...
pub use TIM3SMEN_R as TIM4SMEN_R;
...
pub use TIM3SMEN_R as USART5SMEN_R;
///Field `USART6SMEN` reader - USART6 clock enable
pub use TIM3SMEN_R as USART6SMEN_R;
...
pub use TIM3SMEN_R as USBSMEN_R;
...
pub use TIM3SMEN_R as SPI3SMEN_R;
...
pub use TIM3SMEN_R as I2C3SMEN_R;
...
pub use TIM3SMEN_W as TIM4SMEN_W;
...
pub use TIM3SMEN_W as USART5SMEN_W;
///Field `USART6SMEN` writer - USART6 clock enable
pub use TIM3SMEN_W as USART6SMEN_W;
...
pub use TIM3SMEN_W as USBSMEN_W;
...
pub use TIM3SMEN_W as SPI3SMEN_W;
...
pub use TIM3SMEN_W as I2C3SMEN_W;
...
impl W {
    ...
    ///Bit 2 - TIM4 timer clock enable during Sleep mode
    #[inline(always)]
    pub fn tim4smen(&mut self) -> TIM4SMEN_W<APBSMENR1rs> {
    ...
    ///Bit 8 - USART5 clock enable
    #[inline(always)]
    pub fn usart5smen(&mut self) -> USART5SMEN_W<APBSMENR1rs> {
        USART5SMEN_W::new(self, 8)
    }
    ///Bit 9 - USART6 clock enable
    #[inline(always)]
    pub fn usart6smen(&mut self) -> USART6SMEN_W<APBSMENR1rs> {
    ...
    ///Bit 13 - USB clock enable during Sleep mode
    #[inline(always)]
    pub fn usbsmen(&mut self) -> USBSMEN_W<APBSMENR1rs> {
    ...
    ///Bit 15 - SPI3 clock enable during Sleep mode
    #[inline(always)]
    pub fn spi3smen(&mut self) -> SPI3SMEN_W<APBSMENR1rs> {
    ...
    ///Bit 23 - I2C3 clock enable during Sleep mode
    #[inline(always)]
    pub fn i2c3smen(&mut self) -> I2C3SMEN_W<APBSMENR1rs> {
