...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FPR1")
            ...
            .field("fpif17", &self.fpif17())
            .field("fpif18", &self.fpif18())
...
impl W {
    ...
    ///Bit 17 - Falling edge event pending for configurable line
    #[inline(always)]
    pub fn fpif17(&mut self) -> FPIF17_W<'_, FPR1rs> {
        FPIF17_W::new(self, 17)
    }
    ///Bit 18 - Falling edge event pending for configurable line
    #[inline(always)]
    pub fn fpif18(&mut self) -> FPIF18_W<'_, FPR1rs> {
        FPIF18_W::new(self, 18)
    }
    ///Bit 20 - Falling edge event pending for configurable line
    #[inline(always)]
    pub fn fpif20(&mut self) -> FPIF20_W<'_, FPR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0B1.html#EXTI:FPR1)*/
pub struct FPR1rs;
