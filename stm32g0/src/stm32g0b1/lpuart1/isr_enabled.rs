...
///Field `RXFF` reader - RXFIFO full This bit is set by hardware when the number of received data corresponds to RXFIFOsize+1 (RXFIFO full + 1 data in the LPUART_RDR register. An interrupt is generated if the RXFFIE bit =1 in the LPUART_CR1 register.
...
impl R {
    ...
    ///Bit 24 - RXFIFO full This bit is set by hardware when the number of received data corresponds to RXFIFOsize+1 (RXFIFO full + 1 data in the LPUART_RDR register. An interrupt is generated if the RXFFIE bit =1 in the LPUART_CR1 register.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0B1.html#LPUART1:ISR_enabled)*/
