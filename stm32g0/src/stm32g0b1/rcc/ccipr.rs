...
pub type LPUART2SEL_R = crate::FieldReader<LPUART2SEL>;
impl LPUART2SEL_R {
    ///Get enumerated values variant
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn is_pclk(&self) -> bool {
        *self == LPUART2SEL::Pclk
    }
    ///SYSCLK clock selected
    #[inline(always)]
    pub fn is_sysclk(&self) -> bool {
        *self == LPUART2SEL::Sysclk
    }
    ///HSI16 clock selected
    #[inline(always)]
    pub fn is_hsi16(&self) -> bool {
        *self == LPUART2SEL::Hsi16
    }
    ///LSE clock selected
    #[inline(always)]
    pub fn is_lse(&self) -> bool {
...
pub type LPUART2SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2, LPUART2SEL, crate::Safe>;
impl<'a, REG> LPUART2SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn pclk(self) -> &'a mut crate::W<REG> {
        self.variant(LPUART2SEL::Pclk)
    }
    ///SYSCLK clock selected
    #[inline(always)]
    pub fn sysclk(self) -> &'a mut crate::W<REG> {
        self.variant(LPUART2SEL::Sysclk)
    }
    ///HSI16 clock selected
    #[inline(always)]
    pub fn hsi16(self) -> &'a mut crate::W<REG> {
        self.variant(LPUART2SEL::Hsi16)
    }
    ///LSE clock selected
    #[inline(always)]
    pub fn lse(self) -> &'a mut crate::W<REG> {
        self.variant(LPUART2SEL::Lse)
    }
}
///Field `LPUART1SEL` reader - LPUART1 clock source selection
pub use LPUART2SEL_R as LPUART1SEL_R;
///Field `LPUART1SEL` writer - LPUART1 clock source selection
pub use LPUART2SEL_W as LPUART1SEL_W;
