...
/**The bit indicates the number of correct. For debug purposes only.
...
///Field `RXSOP3OF4` reader - The bit indicates the number of correct. For debug purposes only.
...
impl R {
    ...
    ///Bit 3 - The bit indicates the number of correct. For debug purposes only.
    #[inline(always)]
