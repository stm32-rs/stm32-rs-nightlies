...
///AES status register
pub mod sr;
/**DINR (rw) register accessor: AES data input register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:DINR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:KEYR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:KEYR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:IVR0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:IVR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:IVR2)
...
pub mod ivr3;
/**KEYR4 (rw) register accessor: AES key register 4
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:KEYR4)

For information about available fields see [`mod@keyr4`] module*/
pub type KEYR4 = crate::Reg<keyr4::KEYR4rs>;
///AES key register 4
pub mod keyr4;
/**KEYR5 (rw) register accessor: AES key register 5
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:KEYR5)

For information about available fields see [`mod@keyr5`] module*/
pub type KEYR5 = crate::Reg<keyr5::KEYR5rs>;
///AES key register 5
pub mod keyr5;
/**KEYR6 (rw) register accessor: AES key register 6
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:KEYR6)

For information about available fields see [`mod@keyr6`] module*/
pub type KEYR6 = crate::Reg<keyr6::KEYR6rs>;
///AES key register 6
pub mod keyr6;
/**KEYR7 (rw) register accessor: AES key register 7
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:KEYR7)

For information about available fields see [`mod@keyr7`] module*/
pub type KEYR7 = crate::Reg<keyr7::KEYR7rs>;
///AES key register 7
pub mod keyr7;
/**SUSP0R (rw) register accessor: AES suspend registers
...
pub mod susp0r;
/**SUSP1R (rw) register accessor: AES suspend registers
...
///AES suspend registers
pub mod susp1r;
/**SUSP2R (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:SUSP2R)

For information about available fields see [`mod@susp2r`] module*/
pub type SUSP2R = crate::Reg<susp2r::SUSP2Rrs>;
///AES suspend registers
pub mod susp2r;
/**SUSP3R (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:SUSP3R)

For information about available fields see [`mod@susp3r`] module*/
pub type SUSP3R = crate::Reg<susp3r::SUSP3Rrs>;
///AES suspend registers
pub mod susp3r;
/**SUSP4R (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:SUSP4R)

For information about available fields see [`mod@susp4r`] module*/
pub type SUSP4R = crate::Reg<susp4r::SUSP4Rrs>;
///AES suspend registers
pub mod susp4r;
/**SUSP5R (rw) register accessor: AES suspend registers
...
///AES suspend registers
pub mod susp5r;
/**SUSP6R (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:SUSP6R)

For information about available fields see [`mod@susp6r`] module*/
pub type SUSP6R = crate::Reg<susp6r::SUSP6Rrs>;
///AES suspend registers
pub mod susp6r;
/**SUSP7R (rw) register accessor: AES suspend registers
