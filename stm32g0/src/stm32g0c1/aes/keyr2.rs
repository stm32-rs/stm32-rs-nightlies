...
///Field `KEY` reader - Cryptographic key, bits \[95:64\] Refer to the AES_KEYR0 register for description of the KEY\[255:0\] bitfield.
pub type KEY_R = crate::FieldReader<u32>;
///Field `KEY` writer - Cryptographic key, bits \[95:64\] Refer to the AES_KEYR0 register for description of the KEY\[255:0\] bitfield.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#AES:KEYR2)*/
pub struct KEYR2rs;
