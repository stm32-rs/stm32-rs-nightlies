...
///Field `KEY` reader - Cryptographic key, bits \[127:96\] Refer to the AES_KEYR0 register for description of the KEY\[255:0\] bitfield.
pub type KEY_R = crate::FieldReader<u32>;
///Field `KEY` writer - Cryptographic key, bits \[127:96\] Refer to the AES_KEYR0 register for description of the KEY\[255:0\] bitfield.
