...
#[doc = "Field `CGIF(1-7)` reader - Channel %s Global interrupt clear"]
...
#[doc = "Field `CTCIF(1-7)` reader - Channel %s Transfer Complete clear"]
...
#[doc = "Field `CHTIF(1-7)` reader - Channel %s Half Transfer clear"]
...
#[doc = "Field `CTEIF(1-7)` reader - Channel %s Transfer Error clear"]
...
impl R {
    #[doc = "Channel (1-7) Global interrupt clear"]
    #[doc = ""]
    ...
    pub fn cgif_iter(&self) -> impl Iterator<Item = CGIF_R> + '_ {
        (0..7).map(move |n| CGIF_R::new(((self.bits >> (n * 4)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn cgif6(&self) -> CGIF_R {
        CGIF_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 24 - Channel 7 Global interrupt clear"]
    #[inline(always)]
    pub fn cgif7(&self) -> CGIF_R {
        CGIF_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Channel (1-7) Transfer Complete clear"]
    #[doc = ""]
    ...
    pub fn ctcif_iter(&self) -> impl Iterator<Item = CTCIF_R> + '_ {
        (0..7).map(move |n| CTCIF_R::new(((self.bits >> (n * 4 + 1)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn ctcif6(&self) -> CTCIF_R {
        CTCIF_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 25 - Channel 7 Transfer Complete clear"]
    #[inline(always)]
    pub fn ctcif7(&self) -> CTCIF_R {
        CTCIF_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Channel (1-7) Half Transfer clear"]
    #[doc = ""]
    ...
    pub fn chtif_iter(&self) -> impl Iterator<Item = CHTIF_R> + '_ {
        (0..7).map(move |n| CHTIF_R::new(((self.bits >> (n * 4 + 2)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn chtif6(&self) -> CHTIF_R {
        CHTIF_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 26 - Channel 7 Half Transfer clear"]
    #[inline(always)]
    pub fn chtif7(&self) -> CHTIF_R {
        CHTIF_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Channel (1-7) Transfer Error clear"]
    #[doc = ""]
    ...
    pub fn cteif_iter(&self) -> impl Iterator<Item = CTEIF_R> + '_ {
        (0..7).map(move |n| CTEIF_R::new(((self.bits >> (n * 4 + 3)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn cteif6(&self) -> CTEIF_R {
        CTEIF_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 27 - Channel 7 Transfer Error clear"]
    #[inline(always)]
    pub fn cteif7(&self) -> CTEIF_R {
        CTEIF_R::new(((self.bits >> 27) & 1) != 0)
    }
}
