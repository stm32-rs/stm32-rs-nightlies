...
pub mod isr;
/**IFCR (r) register accessor: DMA interrupt flag clear register

You can [`read`](crate::Reg::read) this register and get [`ifcr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#DMA2:IFCR)
