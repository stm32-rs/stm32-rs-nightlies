...
pub mod cr;
/**NDTR (rw) register accessor: DMA channel 1 number of data tegister
...
pub mod ndtr;
/**PAR (rw) register accessor: DMA channel 1 peripheral address
...
pub mod par;
/**MAR (rw) register accessor: DMA channel 1 memory address
