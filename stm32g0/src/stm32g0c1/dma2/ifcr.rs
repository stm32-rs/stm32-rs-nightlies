...
///Field `CGIF(1-5)` writer - Channel %s Global interrupt clear
...
///Field `CTCIF(1-5)` writer - Channel %s Transfer Complete clear
...
///Field `CHTIF(1-5)` writer - Channel %s Half Transfer clear
...
///Field `CTEIF(1-5)` writer - Channel %s Transfer Error clear
