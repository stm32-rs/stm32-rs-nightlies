...
impl RegisterBlock {
    ...
    ///0x100..0x110 - DMAMUX request generator channel x configuration register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#DMAMUX:CCR[0])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#DMAMUX:CSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#DMAMUX:CFR)

For information about available fields see [`mod@cfr`] module*/
pub type CFR = crate::Reg<cfr::CFRrs>;
///DMAMUX request line multiplexer interrupt clear flag register
pub mod cfr;
/**RGCR (rw) register accessor: DMAMUX request generator channel x configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#DMAMUX:RGCR[0])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#DMAMUX:RGSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#DMAMUX:RGCFR)
