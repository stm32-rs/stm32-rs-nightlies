...
///Field `EXTI12` reader - GPIO port selection
pub use super::exticr1::EXTI0_R as EXTI12_R;
///Field `EXTI13` reader - GPIO port selection
pub use super::exticr1::EXTI0_R as EXTI13_R;
///Field `EXTI14` reader - GPIO port selection
pub use super::exticr1::EXTI0_R as EXTI14_R;
///Field `EXTI15` reader - GPIO port selection
pub use super::exticr1::EXTI0_R as EXTI15_R;
///Field `EXTI12` writer - GPIO port selection
pub use super::exticr1::EXTI0_W as EXTI12_W;
///Field `EXTI13` writer - GPIO port selection
pub use super::exticr1::EXTI0_W as EXTI13_W;
///Field `EXTI14` writer - GPIO port selection
pub use super::exticr1::EXTI0_W as EXTI14_W;
///Field `EXTI15` writer - GPIO port selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#EXTI:EXTICR4)*/
