...
pub type FT2_R = crate::BitReader<FALLING_TRIGGER>;
impl FT2_R {
...
pub type FT2_W<'a, REG> = crate::BitWriter<'a, REG, FALLING_TRIGGER>;
...
impl W {
    ///Bit 2 - Falling trigger event configuration bit of configurable line 34
    #[inline(always)]
    pub fn ft2(&mut self) -> FT2_W<'_, FTSR2rs> {
        FT2_W::new(self, 2)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#EXTI:FTSR2)*/
pub struct FTSR2rs;
