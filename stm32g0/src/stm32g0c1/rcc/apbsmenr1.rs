...
pub type CRSSSMEN_R = crate::BitReader;
///Field `CRSSSMEN` writer - CRSS clock enable during Sleep mode
pub type CRSSSMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fdcansmen(&mut self) -> FDCANSMEN_W<APBSMENR1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crsssmen(&mut self) -> CRSSSMEN_W<APBSMENR1rs> {
