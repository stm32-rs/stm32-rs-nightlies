...
impl W {
    ...
    #[inline(always)]
    pub fn pllsysrdyc(&mut self) -> PLLSYSRDYC_W<'_, CICRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G0C1.html#RCC:CICR)*/
pub struct CICRrs;
