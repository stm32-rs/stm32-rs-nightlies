...
///Field `CCENABLE` writer - CC line enable This bitfield enables CC1 and CC2 line analog PHYs (pull-ups and pull-downs) according to ANAMODE and ANASUBMODE\[1:0\] setting. A single line PHY can be enabled when, for example, the other line is driven by VCONN via an external VCONN switch. Enabling both PHYs is the normal usage for sink/source.
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CC1VCONNEN {
    ///0: VCONN switch for CC1 disabled
    Disabled = 0,
    ///1: VCONN switch for CC1 enabled
    Enabled = 1,
}
impl From<CC1VCONNEN> for bool {
    #[inline(always)]
    fn from(variant: CC1VCONNEN) -> Self {
        variant as u8 != 0
    }
}
///Field `CC1VCONNEN` reader - VCONN switch enable for CC1
pub type CC1VCONNEN_R = crate::BitReader<CC1VCONNEN>;
impl CC1VCONNEN_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> CC1VCONNEN {
        match self.bits {
            false => CC1VCONNEN::Disabled,
            true => CC1VCONNEN::Enabled,
        }
    }
    ///VCONN switch for CC1 disabled
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == CC1VCONNEN::Disabled
    }
    ///VCONN switch for CC1 enabled
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == CC1VCONNEN::Enabled
    }
}
///Field `CC1VCONNEN` writer - VCONN switch enable for CC1
pub type CC1VCONNEN_W<'a, REG> = crate::BitWriter<'a, REG, CC1VCONNEN>;
impl<'a, REG> CC1VCONNEN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///VCONN switch for CC1 disabled
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(CC1VCONNEN::Disabled)
    }
    ///VCONN switch for CC1 enabled
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(CC1VCONNEN::Enabled)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CC2VCONNEN {
    ///0: VCONN switch for CC2 disabled
    Disabled = 0,
    ///1: VCONN switch for CC2 enabled
    Enabled = 1,
}
impl From<CC2VCONNEN> for bool {
    #[inline(always)]
    fn from(variant: CC2VCONNEN) -> Self {
        variant as u8 != 0
    }
}
///Field `CC2VCONNEN` reader - VCONN switch enable for CC2
pub type CC2VCONNEN_R = crate::BitReader<CC2VCONNEN>;
impl CC2VCONNEN_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> CC2VCONNEN {
        match self.bits {
            false => CC2VCONNEN::Disabled,
            true => CC2VCONNEN::Enabled,
        }
    }
    ///VCONN switch for CC2 disabled
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == CC2VCONNEN::Disabled
    }
    ///VCONN switch for CC2 enabled
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == CC2VCONNEN::Enabled
    }
}
///Field `CC2VCONNEN` writer - VCONN switch enable for CC2
pub type CC2VCONNEN_W<'a, REG> = crate::BitWriter<'a, REG, CC2VCONNEN>;
impl<'a, REG> CC2VCONNEN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///VCONN switch for CC2 disabled
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(CC2VCONNEN::Disabled)
    }
    ///VCONN switch for CC2 enabled
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(CC2VCONNEN::Enabled)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DBATTEN {
    ///0: Dead battery function disabled
    Disabled = 0,
    ///1: Dead battery function enabled
    Enabled = 1,
}
impl From<DBATTEN> for bool {
    #[inline(always)]
    fn from(variant: DBATTEN) -> Self {
        variant as u8 != 0
    }
}
...
pub type DBATTEN_R = crate::BitReader<DBATTEN>;
impl DBATTEN_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> DBATTEN {
        match self.bits {
            false => DBATTEN::Disabled,
            true => DBATTEN::Enabled,
        }
    }
    ///Dead battery function disabled
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == DBATTEN::Disabled
    }
    ///Dead battery function enabled
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == DBATTEN::Enabled
    }
}
...
pub type DBATTEN_W<'a, REG> = crate::BitWriter<'a, REG, DBATTEN>;
impl<'a, REG> DBATTEN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Dead battery function disabled
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(DBATTEN::Disabled)
    }
    ///Dead battery function enabled
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(DBATTEN::Enabled)
    }
}
...
impl W {
    ...
    ///Bit 13 - VCONN switch enable for CC1
    #[inline(always)]
    pub fn cc1vconnen(&mut self) -> CC1VCONNEN_W<'_, CRrs> {
        CC1VCONNEN_W::new(self, 13)
    }
    ///Bit 14 - VCONN switch enable for CC2
    #[inline(always)]
    pub fn cc2vconnen(&mut self) -> CC2VCONNEN_W<'_, CRrs> {
        CC2VCONNEN_W::new(self, 14)
    }
    ///Bit 15 - Dead battery function enable The bit takes effect upon setting the USBPDstrobe bit of the SYS_CONFIG register. Dead battery function only operates if the external circuit is appropriately configured.
    #[inline(always)]
    pub fn dbatten(&mut self) -> DBATTEN_W<'_, CRrs> {
