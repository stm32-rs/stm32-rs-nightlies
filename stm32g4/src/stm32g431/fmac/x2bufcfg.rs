...
///Field `X2_BASE` reader - X1_BASE
pub type X2_BASE_R = crate::FieldReader;
///Field `X2_BASE` writer - X1_BASE
pub type X2_BASE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `X2_BUF_SIZE` reader - X1_BUF_SIZE
pub type X2_BUF_SIZE_R = crate::FieldReader;
///Field `X2_BUF_SIZE` writer - X1_BUF_SIZE
...
impl W {
    ///Bits 0:7 - X1_BASE
    #[inline(always)]
    pub fn x2_base(&mut self) -> X2_BASE_W<'_, X2BUFCFGrs> {
        X2_BASE_W::new(self, 0)
    }
    ///Bits 8:15 - X1_BUF_SIZE
    #[inline(always)]
    pub fn x2_buf_size(&mut self) -> X2_BUF_SIZE_W<'_, X2BUFCFGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G431.html#FMAC:X2BUFCFG)*/
