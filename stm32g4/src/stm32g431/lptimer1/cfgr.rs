...
impl TRIGSEL_R {
    ...
    pub const fn variant(&self) -> Option<TRIGSEL> {
        match self.bits {
            0 => Some(TRIGSEL::Trig0),
            1 => Some(TRIGSEL::Trig1),
            2 => Some(TRIGSEL::Trig2),
            3 => Some(TRIGSEL::Trig3),
            4 => Some(TRIGSEL::Trig4),
            5 => Some(TRIGSEL::Trig5),
            6 => Some(TRIGSEL::Trig6),
            7 => Some(TRIGSEL::Trig7),
            _ => None,
        }
    }
    ///lptim_ext_trig0
...
pub type TRIGSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4, TRIGSEL>;
