...
///Field `SYSCFGEN` reader - SYSCFG + COMP + VREFBUF + OPAMP clock enable
...
///Field `SYSCFGEN` writer - SYSCFG + COMP + VREFBUF + OPAMP clock enable
...
///Field `TIM20EN` writer - TIM20 timer clock enable
pub use SYSCFGEN_W as TIM20EN_W;
///Field `SAI1EN` writer - SAI1 clock enable
pub use SYSCFGEN_W as SAI1EN_W;
///Field `HRTIM1EN` writer - HRTIM1 clock enable
pub use SYSCFGEN_W as HRTIM1EN_W;
impl R {
    ///Bit 0 - SYSCFG + COMP + VREFBUF + OPAMP clock enable
    #[inline(always)]
...
impl W {
    ...
    ///Bit 20 - TIM20 timer clock enable
    #[inline(always)]
    pub fn tim20en(&mut self) -> TIM20EN_W<'_, APB2ENRrs> {
    ...
    ///Bit 26 - HRTIM1 clock enable
    #[inline(always)]
    pub fn hrtim1en(&mut self) -> HRTIM1EN_W<'_, APB2ENRrs> {
