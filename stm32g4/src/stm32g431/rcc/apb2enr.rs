...
///Field `SPI4EN` reader - SPI 4 clock enable
...
///Field `SPI4EN` writer - SPI 4 clock enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G431xx.html#RCC:APB2ENR)*/
