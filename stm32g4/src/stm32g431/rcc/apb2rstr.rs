...
///Field `TIM20RST` reader - TIM20 reset
...
///Field `HRTIM1RST` reader - HRTIM1 reset
...
///Field `TIM20RST` writer - TIM20 reset
...
///Field `HRTIM1RST` writer - HRTIM1 reset
...
impl W {
    ...
    ///Bit 20 - TIM20 reset
    #[inline(always)]
    pub fn tim20rst(&mut self) -> TIM20RST_W<'_, APB2RSTRrs> {
    ...
    ///Bit 26 - HRTIM1 reset
    #[inline(always)]
    pub fn hrtim1rst(&mut self) -> HRTIM1RST_W<'_, APB2RSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G431.html#RCC:APB2RSTR)*/
