...
///Field `OIS4N` reader - Output Idle state 4 (OC4N output)
pub type OIS4N_R = crate::BitReader;
///Field `OIS4N` writer - Output Idle state 4 (OC4N output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G431xx.html#TIM2:CR2)*/
pub struct CR2rs;
