...
pub type AES_DINR_R = crate::FieldReader<u32>;
///Field `AES_DINR` writer - Data Input Register
pub type AES_DINR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ///Bits 0:31 - Data Input Register
    #[inline(always)]
    pub fn aes_dinr(&mut self) -> AES_DINR_W<DINRrs> {
        AES_DINR_W::new(self, 0)
    }
}
/**data input register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441xx.html#AES:DINR)*/
pub struct DINRrs;
