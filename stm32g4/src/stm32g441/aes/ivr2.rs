...
pub type AES_IVR2_R = crate::FieldReader<u32>;
///Field `AES_IVR2` writer - Initialization Vector Register (IVR \[95:64\])
pub type AES_IVR2_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ///Bits 0:31 - Initialization Vector Register (IVR \[95:64\])
    #[inline(always)]
    pub fn aes_ivr2(&mut self) -> AES_IVR2_W<IVR2rs> {
        AES_IVR2_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441xx.html#AES:IVR2)*/
pub struct IVR2rs;
