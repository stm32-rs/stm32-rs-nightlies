...
pub type OTRIM1_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type OTRIM2_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441xx.html#DAC1:CCR)*/
pub struct CCRrs;
