...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `STRSTTRIGSEL1` field.</div>
    #[inline(always)]
    pub fn strsttrigsel(&mut self, n: u8) -> STRSTTRIGSEL_W<STMODRrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bits 0:3 - DAC Channel 1 Sawtooth Reset trigger selection
    #[inline(always)]
    pub fn strsttrigsel1(&mut self) -> STRSTTRIGSEL_W<STMODRrs> {
        STRSTTRIGSEL_W::new(self, 0)
    }
    ///Bits 16:19 - DAC Channel 1 Sawtooth Reset trigger selection
    #[inline(always)]
    pub fn strsttrigsel2(&mut self) -> STRSTTRIGSEL_W<STMODRrs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `STINCTRIGSEL1` field.</div>
    #[inline(always)]
    pub fn stinctrigsel(&mut self, n: u8) -> STINCTRIGSEL_W<STMODRrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bits 8:11 - DAC Channel 1 Sawtooth Increment trigger selection
    #[inline(always)]
    pub fn stinctrigsel1(&mut self) -> STINCTRIGSEL_W<STMODRrs> {
        STINCTRIGSEL_W::new(self, 8)
    }
    ///Bits 24:27 - DAC Channel 2 Sawtooth Increment trigger selection
    #[inline(always)]
    pub fn stinctrigsel2(&mut self) -> STINCTRIGSEL_W<STMODRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441.html#DAC1:STMODR)*/
pub struct STMODRrs;
