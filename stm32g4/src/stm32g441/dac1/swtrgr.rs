...
/**DAC channel%s software trigger B
...
impl From<SWTRIGB1> for bool {
    #[inline(always)]
    fn from(variant: SWTRIGB1) -> Self {
        variant as u8 != 0
    }
}
///Field `SWTRIGB(1-2)` writer - DAC channel%s software trigger B
pub type SWTRIGB_W<'a, REG> = crate::BitWriter<'a, REG, SWTRIGB1>;
impl<'a, REG> SWTRIGB_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///No trigger
    #[inline(always)]
    pub fn no_trigger(self) -> &'a mut crate::W<REG> {
        self.variant(SWTRIGB1::NoTrigger)
    }
    ///Trigger for sawtooth increment
    #[inline(always)]
    pub fn trigger(self) -> &'a mut crate::W<REG> {
        self.variant(SWTRIGB1::Trigger)
    }
}
...
impl W {
    ...
    #[inline(always)]
    pub fn swtrig(&mut self, n: u8) -> SWTRIG_W<'_, SWTRGRrs> {
    ...
    #[inline(always)]
    pub fn swtrig1(&mut self) -> SWTRIG_W<'_, SWTRGRrs> {
        SWTRIG_W::new(self, 0)
    }
    ///Bit 1 - DAC channel2 software trigger
    #[inline(always)]
    pub fn swtrig2(&mut self) -> SWTRIG_W<'_, SWTRGRrs> {
        SWTRIG_W::new(self, 1)
    }
    ///DAC channel(1-2) software trigger B
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SWTRIGB1` field.</div>
    #[inline(always)]
    pub fn swtrigb(&mut self, n: u8) -> SWTRIGB_W<'_, SWTRGRrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        SWTRIGB_W::new(self, n + 16)
    }
    ///Bit 16 - DAC channel1 software trigger B
    #[inline(always)]
    pub fn swtrigb1(&mut self) -> SWTRIGB_W<'_, SWTRGRrs> {
        SWTRIGB_W::new(self, 16)
    }
    ///Bit 17 - DAC channel2 software trigger B
    #[inline(always)]
    pub fn swtrigb2(&mut self) -> SWTRIGB_W<'_, SWTRGRrs> {
        SWTRIGB_W::new(self, 17)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441.html#DAC1:SWTRGR)*/
pub struct SWTRGRrs;
