...
///Field `RT29` reader - Rising trigger event configuration of line 29
pub use RT0_R as RT29_R;
///Field `RT30` reader - Rising trigger event configuration of line 30
pub use RT0_R as RT30_R;
///Field `RT31` reader - Rising trigger event configuration of line 31
...
///Field `RT29` writer - Rising trigger event configuration of line 29
pub use RT0_W as RT29_W;
///Field `RT30` writer - Rising trigger event configuration of line 30
pub use RT0_W as RT30_W;
///Field `RT31` writer - Rising trigger event configuration of line 31
...
impl W {
    ...
    ///Bit 17 - Rising trigger event configuration of line 17
    #[inline(always)]
    pub fn rt17(&mut self) -> RT17_W<'_, RTSR1rs> {
        RT17_W::new(self, 17)
    }
    ///Bit 19 - Rising trigger event configuration of line 19
    #[inline(always)]
    pub fn rt19(&mut self) -> RT19_W<'_, RTSR1rs> {
        RT19_W::new(self, 19)
    }
    ///Bit 20 - Rising trigger event configuration of line 20
    #[inline(always)]
    pub fn rt20(&mut self) -> RT20_W<'_, RTSR1rs> {
        RT20_W::new(self, 20)
    }
    ///Bit 21 - Rising trigger event configuration of line 21
    #[inline(always)]
    ...
    ///Bit 29 - Rising trigger event configuration of line 29
    #[inline(always)]
    pub fn rt29(&mut self) -> RT29_W<'_, RTSR1rs> {
        RT29_W::new(self, 29)
    }
    ///Bit 30 - Rising trigger event configuration of line 30
    #[inline(always)]
    pub fn rt30(&mut self) -> RT30_W<'_, RTSR1rs> {
        RT30_W::new(self, 30)
    }
    ///Bit 31 - Rising trigger event configuration of line 31
    #[inline(always)]
    pub fn rt31(&mut self) -> RT31_W<'_, RTSR1rs> {
        RT31_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441.html#EXTI:RTSR1)*/
pub struct RTSR1rs;
