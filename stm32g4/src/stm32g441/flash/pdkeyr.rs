...
///Field `PDKEYR` writer - Power-down in Run mode Flash key
...
impl W {
    ///Bits 0:31 - Power-down in Run mode Flash key
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441.html#FLASH:PDKEYR)*/
pub struct PDKEYRrs;
