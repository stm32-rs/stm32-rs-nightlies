...
pub type SEC_SIZE1_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
impl R {
    ///Bits 0:6 - sets the number of pages used in the Securable area.
    #[inline(always)]
    pub fn sec_size1(&self) -> SEC_SIZE1_R {
        SEC_SIZE1_R::new((self.bits & 0x7f) as u8)
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441.html#FLASH:SEC1R)*/
pub struct SEC1Rrs;
