...
impl R {
    ///Bits 0:5 - WRP second area B start offset
    #[inline(always)]
    pub fn wrp1b_strt(&self) -> WRP1B_STRT_R {
        WRP1B_STRT_R::new((self.bits & 0x3f) as u8)
    }
    ///Bits 16:21 - WRP second area B end offset
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441.html#FLASH:WRP1BR)*/
pub struct WRP1BRrs;
