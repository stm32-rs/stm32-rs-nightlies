...
impl W {
    ...
    ///Bit 8 - OPAINTOEN
    #[inline(always)]
    pub fn opaintoen(&mut self) -> OPAINTOEN_W<'_, OPAMP2_CSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441.html#OPAMP:OPAMP2_CSR)*/
