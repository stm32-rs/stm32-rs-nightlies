...
///Field `PU0` reader - Port A pull-up bit y (y=0..13)
pub type PU0_R = crate::BitReader;
///Field `PU0` writer - Port A pull-up bit y (y=0..13)
pub type PU0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU1` reader - Port A pull-up bit y (y=0..13)
pub type PU1_R = crate::BitReader;
///Field `PU1` writer - Port A pull-up bit y (y=0..13)
pub type PU1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU2` reader - Port A pull-up bit y (y=0..13)
pub type PU2_R = crate::BitReader;
///Field `PU2` writer - Port A pull-up bit y (y=0..13)
pub type PU2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU3` reader - Port A pull-up bit y (y=0..13)
pub type PU3_R = crate::BitReader;
///Field `PU3` writer - Port A pull-up bit y (y=0..13)
pub type PU3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU4` reader - Port A pull-up bit y (y=0..13)
pub type PU4_R = crate::BitReader;
///Field `PU4` writer - Port A pull-up bit y (y=0..13)
pub type PU4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU5` reader - Port A pull-up bit y (y=0..13)
pub type PU5_R = crate::BitReader;
///Field `PU5` writer - Port A pull-up bit y (y=0..13)
pub type PU5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU6` reader - Port A pull-up bit y (y=0..13)
pub type PU6_R = crate::BitReader;
///Field `PU6` writer - Port A pull-up bit y (y=0..13)
pub type PU6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU7` reader - Port A pull-up bit y (y=0..13)
pub type PU7_R = crate::BitReader;
///Field `PU7` writer - Port A pull-up bit y (y=0..13)
pub type PU7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU8` reader - Port A pull-up bit y (y=0..13)
pub type PU8_R = crate::BitReader;
///Field `PU8` writer - Port A pull-up bit y (y=0..13)
pub type PU8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU9` reader - Port A pull-up bit y (y=0..13)
pub type PU9_R = crate::BitReader;
///Field `PU9` writer - Port A pull-up bit y (y=0..13)
pub type PU9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU10` reader - Port A pull-up bit y (y=0..13)
pub type PU10_R = crate::BitReader;
///Field `PU10` writer - Port A pull-up bit y (y=0..13)
pub type PU10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU11` reader - Port A pull-up bit y (y=0..13)
pub type PU11_R = crate::BitReader;
///Field `PU11` writer - Port A pull-up bit y (y=0..13)
pub type PU11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU12` reader - Port A pull-up bit y (y=0..13)
pub type PU12_R = crate::BitReader;
///Field `PU12` writer - Port A pull-up bit y (y=0..13)
pub type PU12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU13` reader - Port A pull-up bit y (y=0..13)
pub type PU13_R = crate::BitReader;
///Field `PU13` writer - Port A pull-up bit y (y=0..13)
pub type PU13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU15` reader - Port A pull-up bit 15
pub type PU15_R = crate::BitReader;
///Field `PU15` writer - Port A pull-up bit 15
pub type PU15_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu0(&self) -> PU0_R {
        PU0_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu1(&self) -> PU1_R {
        PU1_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu2(&self) -> PU2_R {
        PU2_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu3(&self) -> PU3_R {
        PU3_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu4(&self) -> PU4_R {
        PU4_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu5(&self) -> PU5_R {
        PU5_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu6(&self) -> PU6_R {
        PU6_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu7(&self) -> PU7_R {
        PU7_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu8(&self) -> PU8_R {
        PU8_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu9(&self) -> PU9_R {
        PU9_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu10(&self) -> PU10_R {
        PU10_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu11(&self) -> PU11_R {
        PU11_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu12(&self) -> PU12_R {
        PU12_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - Port A pull-up bit y (y=0..13)
    #[inline(always)]
    pub fn pu13(&self) -> PU13_R {
        PU13_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 15 - Port A pull-up bit 15
    #[inline(always)]
