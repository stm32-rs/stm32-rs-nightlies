...
///Field `TIM4EN` reader - TIM4 timer clock enable Set and cleared by software.
pub use TIM2EN_R as TIM4EN_R;
///Field `TIM5EN` reader - TIM5 timer clock enable Set and cleared by software.
...
///Field `CRSEN` reader - CRS Recovery System clock enable Set and cleared by software.
...
///Field `WWDGEN` reader - Window watchdog clock enable Set by software to enable the window watchdog clock. Reset by hardware system reset. This bit can also be set by hardware if the WWDG_SW option bit is reset.
...
///Field `USBEN` reader - USB device clock enable Set and cleared by software.
pub use TIM2EN_R as USBEN_R;
///Field `FDCANEN` reader - FDCAN clock enable Set and cleared by software.
...
///Field `LPTIM1EN` reader - Low power timer 1 clock enable Set and cleared by software.
...
///Field `TIM4EN` writer - TIM4 timer clock enable Set and cleared by software.
pub use TIM2EN_W as TIM4EN_W;
///Field `TIM5EN` writer - TIM5 timer clock enable Set and cleared by software.
...
///Field `CRSEN` writer - CRS Recovery System clock enable Set and cleared by software.
...
///Field `WWDGEN` writer - Window watchdog clock enable Set by software to enable the window watchdog clock. Reset by hardware system reset. This bit can also be set by hardware if the WWDG_SW option bit is reset.
...
///Field `USBEN` writer - USB device clock enable Set and cleared by software.
pub use TIM2EN_W as USBEN_W;
///Field `FDCANEN` writer - FDCAN clock enable Set and cleared by software.
...
///Field `LPTIM1EN` writer - Low power timer 1 clock enable Set and cleared by software.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441.html#RCC:APB1ENR1)*/
