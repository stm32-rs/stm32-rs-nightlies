...
///Field `TIM20SMEN` reader - Timer 20clock enable during sleep mode
pub type TIM20SMEN_R = crate::BitReader;
///Field `TIM20SMEN` writer - Timer 20clock enable during sleep mode
pub type TIM20SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAI1SMEN` reader - SAI1 clock enable during sleep mode
pub type SAI1SMEN_R = crate::BitReader;
///Field `SAI1SMEN` writer - SAI1 clock enable during sleep mode
pub type SAI1SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HRTIM1SMEN` reader - HRTIMER clock enable during sleep mode
pub type HRTIM1SMEN_R = crate::BitReader;
///Field `HRTIM1SMEN` writer - HRTIMER clock enable during sleep mode
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441xx.html#RCC:APB2SMENR)*/
