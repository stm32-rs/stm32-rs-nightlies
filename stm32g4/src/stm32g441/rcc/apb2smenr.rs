...
///Field `SYSCFGSMEN` reader - SYSCFG + COMP + VREFBUF + OPAMP clocks enable during Sleep and Stop modes
pub type SYSCFGSMEN_R = crate::BitReader;
///Field `SYSCFGSMEN` writer - SYSCFG + COMP + VREFBUF + OPAMP clocks enable during Sleep and Stop modes
...
///Field `SPI4SMEN` reader - SPI4 timer clocks enable during Sleep and Stop modes
pub type SPI4SMEN_R = crate::BitReader;
///Field `SPI4SMEN` writer - SPI4 timer clocks enable during Sleep and Stop modes
...
///Field `TIM20SMEN` reader - TIM20 timer clocks enable during Sleep and Stop modes
pub type TIM20SMEN_R = crate::BitReader;
///Field `TIM20SMEN` writer - TIM20 timer clocks enable during Sleep and Stop modes
...
///Field `HRTIM1SMEN` reader - HRTIM1 timer clocks enable during Sleep and Stop modes
pub type HRTIM1SMEN_R = crate::BitReader;
///Field `HRTIM1SMEN` writer - HRTIM1 timer clocks enable during Sleep and Stop modes
pub type HRTIM1SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - SYSCFG + COMP + VREFBUF + OPAMP clocks enable during Sleep and Stop modes
    #[inline(always)]
    ...
    ///Bit 20 - TIM20 timer clocks enable during Sleep and Stop modes
    #[inline(always)]
    ...
    ///Bit 26 - HRTIM1 timer clocks enable during Sleep and Stop modes
    #[inline(always)]
