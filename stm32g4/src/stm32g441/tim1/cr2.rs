...
///Field `MMS_3` reader - Master mode selection - bit 3
pub type MMS_3_R = crate::BitReader;
///Field `MMS_3` writer - Master mode selection - bit 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G441xx.html#TIM1:CR2)*/
pub struct CR2rs;
