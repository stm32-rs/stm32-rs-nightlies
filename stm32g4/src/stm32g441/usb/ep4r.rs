...
pub type R = crate::R<EP4Rrs>;
///Register `EP4R` writer
pub type W = crate::W<EP4Rrs>;
///Field `EA` reader - EA
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ea(&mut self) -> EA_W<EP4Rrs> {
        EA_W::new(self, 0)
    }
    ///Bits 4:5 - STAT_TX
    #[inline(always)]
    #[must_use]
    pub fn stat_tx(&mut self) -> STAT_TX_W<EP4Rrs> {
        STAT_TX_W::new(self, 4)
    }
    ///Bit 6 - DTOG_TX
    #[inline(always)]
    #[must_use]
    pub fn dtog_tx(&mut self) -> DTOG_TX_W<EP4Rrs> {
        DTOG_TX_W::new(self, 6)
    }
    ///Bit 7 - CTR_TX
    #[inline(always)]
    #[must_use]
    pub fn ctr_tx(&mut self) -> CTR_TX_W<EP4Rrs> {
        CTR_TX_W::new(self, 7)
    }
    ///Bit 8 - EP_KIND
    #[inline(always)]
    #[must_use]
    pub fn ep_kind(&mut self) -> EP_KIND_W<EP4Rrs> {
        EP_KIND_W::new(self, 8)
    }
    ///Bits 9:10 - EP_TYPE
    #[inline(always)]
    #[must_use]
    pub fn ep_type(&mut self) -> EP_TYPE_W<EP4Rrs> {
        EP_TYPE_W::new(self, 9)
    }
    ///Bit 11 - SETUP
    #[inline(always)]
    #[must_use]
    pub fn setup(&mut self) -> SETUP_W<EP4Rrs> {
        SETUP_W::new(self, 11)
    }
    ///Bits 12:13 - STAT_RX
    #[inline(always)]
    #[must_use]
    pub fn stat_rx(&mut self) -> STAT_RX_W<EP4Rrs> {
        STAT_RX_W::new(self, 12)
    }
    ///Bit 14 - DTOG_RX
    #[inline(always)]
    #[must_use]
    pub fn dtog_rx(&mut self) -> DTOG_RX_W<EP4Rrs> {
        DTOG_RX_W::new(self, 14)
    }
    ///Bit 15 - CTR_RX
    #[inline(always)]
    #[must_use]
    pub fn ctr_rx(&mut self) -> CTR_RX_W<EP4Rrs> {
