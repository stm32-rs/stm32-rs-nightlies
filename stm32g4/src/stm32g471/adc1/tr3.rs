...
///Field `LT3` reader - Analog watchdog 3 lower threshold
pub type LT3_R = crate::FieldReader;
///Field `LT3` writer - Analog watchdog 3 lower threshold
pub type LT3_W<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
///Field `HT3` reader - Analog watchdog 3 higher threshold
pub type HT3_R = crate::FieldReader;
///Field `HT3` writer - Analog watchdog 3 higher threshold
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#ADC1:TR3)*/
pub struct TR3rs;
