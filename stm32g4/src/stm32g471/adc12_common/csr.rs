...
impl From<ADRDY_SLV> for bool {
    #[inline(always)]
    fn from(variant: ADRDY_SLV) -> Self {
        variant as u8 != 0
    }
}
///Field `ADRDY_SLV` reader - ADRDY_SLV
pub type ADRDY_SLV_R = crate::BitReader<ADRDY_SLV>;
impl ADRDY_SLV_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> ADRDY_SLV {
        match self.bits {
            false => ADRDY_SLV::NotReady,
            true => ADRDY_SLV::Ready,
        }
    }
    ///ADC is not ready to start conversion
    #[inline(always)]
    pub fn is_not_ready(&self) -> bool {
        *self == ADRDY_SLV::NotReady
    }
    ///ADC is ready to start conversion
    #[inline(always)]
    pub fn is_ready(&self) -> bool {
        *self == ADRDY_SLV::Ready
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#ADC12_Common:CSR)*/
pub struct CSRrs;
