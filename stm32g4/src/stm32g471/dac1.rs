...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn str1(&self) -> &STR1 {
        &self.str1
    }
    ///0x5c - Sawtooth register
    #[inline(always)]
    pub const fn str2(&self) -> &STR2 {
        &self.str2
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:SWTRGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DHR12R1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DHR12L1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DHR8R1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DHR12R2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DHR12L2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DHR8R2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DHR12RD)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DHR12LD)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DHR8RD)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DOR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:DOR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:CCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:MCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:SHSR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:SHSR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:SHHR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:SHRR)
...
pub mod shrr;
/**STR1 (rw) register accessor: Sawtooth register

You can [`read`](crate::Reg::read) this register and get [`str1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`str1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:STR1)

For information about available fields see [`mod@str1`]
module*/
pub type STR1 = crate::Reg<str1::STR1rs>;
///Sawtooth register
pub mod str1;
/**STR2 (rw) register accessor: Sawtooth register

You can [`read`](crate::Reg::read) this register and get [`str2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`str2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:STR2)

For information about available fields see [`mod@str2`]
module*/
pub type STR2 = crate::Reg<str2::STR2rs>;
///Sawtooth register
pub mod str2;
/**STMODR (rw) register accessor: Sawtooth Mode register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#DAC1:STMODR)

For information about available fields see [`mod@stmodr`]
module*/
pub type STMODR = crate::Reg<stmodr::STMODRrs>;
