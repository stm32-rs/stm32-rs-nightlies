...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:CREL)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:ENDN)
...
///FDCAN Core Release Register
pub mod endn;
/**DBTP (rw) register accessor: This register is only writable if bits CCCR.CCE and CCCR.INIT are set. The CAN bit time may be programed in the range of 4 to 25 time quanta. The CAN time quantum may be programmed in the range of 1 to 1024 FDCAN clock periods. tq = (DBRP + 1) FDCAN clock period. DTSEG1 is the sum of Prop_Seg and Phase_Seg1. DTSEG2 is Phase_Seg2. Therefore the length of the bit time is (programmed values) \[DTSEG1 + DTSEG2 + 3\]
tq or (functional values) \[Sync_Seg + Prop_Seg + Phase_Seg1 + Phase_Seg2\]
tq. The Information Processing Time (IPT) is zero, meaning the data for the next bit is available at the first clock edge after the sample point.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:DBTP)
...
tq. The Information Processing Time (IPT) is zero, meaning the data for the next bit is available at the first clock edge after the sample point.*/
pub mod dbtp;
/**TEST (rw) register accessor: Write access to the Test Register has to be enabled by setting bit CCCR\[TEST\]
to 1 . All Test Register functions are set to their reset values when bit CCCR\[TEST\]
is reset. Loop Back mode and software control of Tx pin FDCANx_TX are hardware test modes. Programming TX differently from 00 may disturb the message transfer on the CAN bus.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TEST)
...
is reset. Loop Back mode and software control of Tx pin FDCANx_TX are hardware test modes. Programming TX differently from 00 may disturb the message transfer on the CAN bus.*/
pub mod test;
/**RWD (rw) register accessor: The RAM Watchdog monitors the READY output of the Message RAM. A Message RAM access starts the Message RAM Watchdog Counter with the value configured by the RWD\[WDC\]
bits. The counter is reloaded with RWD\[WDC\]
bits when the Message RAM signals successful completion by activating its READY output. In case there is no response from the Message RAM until the counter has counted down to 0, the counter stops and interrupt flag IR\[WDI\]
bit is set. The RAM Watchdog Counter is clocked by the fdcan_pclk clock.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:RWD)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:CCCR)
...
pub mod cccr;
/**NBTP (rw) register accessor: FDCAN_NBTP
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:NBTP)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TSCC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TSCV)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TOCC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TOCV)
...
pub mod tocv;
/**ECR (r) register accessor: FDCAN Error Counter Register

You can [`read`](crate::Reg::read) this register and get [`ecr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:ECR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:PSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TDCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:IR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:IE)
...
pub mod ie;
/**ILS (rw) register accessor: The Interrupt Line Select register assigns an interrupt generated by a specific interrupt flag from the Interrupt Register to one of the two module interrupt lines. For interrupt generation the respective interrupt line has to be enabled via ILE\[EINT0\]
and ILE\[EINT1\].
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:ILS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:ILE)
...
pub mod ile;
/**RXGFC (rw) register accessor: Global settings for Message ID filtering. The Global Filter Configuration controls the filter path for standard and extended messages as described in Figure706: Standard Message ID filter path and Figure707: Extended Message ID filter path.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:RXGFC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:XIDAM)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:HPMS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:RXF0S)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:RXF0A)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:RXF1S)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:RXF1A)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXBC)
...
pub mod txbc;
/**TXFQS (r) register accessor: The Tx FIFO/Queue status is related to the pending Tx requests listed in register TXBRP. Therefore the effect of Add/Cancellation requests may be delayed due to a running Tx scan (TXBRP not yet updated).

You can [`read`](crate::Reg::read) this register and get [`txfqs::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXFQS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXBRP)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXBAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXBCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXBTO)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXBCF)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXBTIE)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXBCIE)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXEFS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:TXEFA)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#FDCAN:CKDIV)
