...
///Field `WRP1B_STRT` reader - WRP second area B start offset
pub type WRP1B_STRT_R = crate::FieldReader;
///Field `WRP1B_STRT` writer - WRP second area B start offset
pub type WRP1B_STRT_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `WRP1B_END` reader - WRP second area B end offset
pub type WRP1B_END_R = crate::FieldReader;
///Field `WRP1B_END` writer - WRP second area B end offset
