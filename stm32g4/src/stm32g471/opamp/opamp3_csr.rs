...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opaen(&mut self) -> OPAEN_W<OPAMP3_CSRrs> {
        OPAEN_W::new(self, 0)
    }
    ///Bit 1 - FORCE_VP
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usertrim(&mut self) -> USERTRIM_W<OPAMP3_CSRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opahsm(&mut self) -> OPAHSM_W<OPAMP3_CSRrs> {
        OPAHSM_W::new(self, 7)
    }
    ///Bit 8 - OPAINTOEN
    #[inline(always)]
    #[must_use]
    pub fn opaintoen(&mut self) -> OPAINTOEN_W<OPAMP3_CSRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn calout(&mut self) -> CALOUT_W<OPAMP3_CSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#OPAMP:OPAMP3_CSR)*/
