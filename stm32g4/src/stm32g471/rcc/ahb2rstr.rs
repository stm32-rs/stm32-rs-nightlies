...
///Field `ADC12RST` reader - ADC12 reset Set and cleared by software.
pub use GPIOARST_R as ADC12RST_R;
///Field `ADC345RST` reader - ADC345 reset Set and cleared by software.
...
///Field `DAC2RST` reader - DAC2 reset Set and cleared by software.
pub use GPIOARST_R as DAC2RST_R;
///Field `DAC3RST` reader - DAC3 reset Set and cleared by software.
pub use GPIOARST_R as DAC3RST_R;
///Field `DAC4RST` reader - DAC4 reset Set and cleared by software.
pub use GPIOARST_R as DAC4RST_R;
///Field `AESRST` reader - AESRST reset Set and cleared by software.
pub use GPIOARST_R as AESRST_R;
///Field `RNGRST` reader - RNG reset Set and cleared by software.
...
///Field `ADC12RST` writer - ADC12 reset Set and cleared by software.
pub use GPIOARST_W as ADC12RST_W;
///Field `ADC345RST` writer - ADC345 reset Set and cleared by software.
...
///Field `DAC2RST` writer - DAC2 reset Set and cleared by software.
pub use GPIOARST_W as DAC2RST_W;
///Field `DAC3RST` writer - DAC3 reset Set and cleared by software.
pub use GPIOARST_W as DAC3RST_W;
///Field `DAC4RST` writer - DAC4 reset Set and cleared by software.
pub use GPIOARST_W as DAC4RST_W;
///Field `AESRST` writer - AESRST reset Set and cleared by software.
pub use GPIOARST_W as AESRST_W;
///Field `RNGRST` writer - RNG reset Set and cleared by software.
