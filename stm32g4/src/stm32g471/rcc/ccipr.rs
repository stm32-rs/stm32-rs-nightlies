...
///Field `USART1SEL` reader - USART1 clock source selection This bit is set and cleared by software to select the USART1 clock source.
pub type USART1SEL_R = crate::FieldReader;
///Field `USART1SEL` writer - USART1 clock source selection This bit is set and cleared by software to select the USART1 clock source.
pub type USART1SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `USART2SEL` reader - USART2 clock source selection This bit is set and cleared by software to select the USART2 clock source.
pub type USART2SEL_R = crate::FieldReader;
///Field `USART2SEL` writer - USART2 clock source selection This bit is set and cleared by software to select the USART2 clock source.
pub type USART2SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `USART3SEL` reader - USART3 clock source selection This bit is set and cleared by software to select the USART3 clock source.
pub type USART3SEL_R = crate::FieldReader;
///Field `USART3SEL` writer - USART3 clock source selection This bit is set and cleared by software to select the USART3 clock source.
...
///Field `UART4SEL` reader - UART4 clock source selection This bit is set and cleared by software to select the UART4 clock source.
...
///Field `UART4SEL` writer - UART4 clock source selection This bit is set and cleared by software to select the UART4 clock source.
...
///Field `UART5SEL` reader - UART5 clock source selection These bits are set and cleared by software to select the UART5 clock source.
pub use UART4SEL_R as UART5SEL_R;
///Field `LPUART1SEL` reader - LPUART1 clock source selection These bits are set and cleared by software to select the LPUART1 clock source.
pub use UART4SEL_R as LPUART1SEL_R;
///Field `UART5SEL` writer - UART5 clock source selection These bits are set and cleared by software to select the UART5 clock source.
pub use UART4SEL_W as UART5SEL_W;
///Field `LPUART1SEL` writer - LPUART1 clock source selection These bits are set and cleared by software to select the LPUART1 clock source.
...
///Field `I2C1SEL` reader - I2C1 clock source selection These bits are set and cleared by software to select the I2C1 clock source.
...
///Field `I2C1SEL` writer - I2C1 clock source selection These bits are set and cleared by software to select the I2C1 clock source.
...
///Field `I2C2SEL` reader - I2C2 clock source selection These bits are set and cleared by software to select the I2C2 clock source.
pub use I2C1SEL_R as I2C2SEL_R;
///Field `I2C3SEL` reader - I2C3 clock source selection These bits are set and cleared by software to select the I2C3 clock source.
pub use I2C1SEL_R as I2C3SEL_R;
///Field `I2C2SEL` writer - I2C2 clock source selection These bits are set and cleared by software to select the I2C2 clock source.
pub use I2C1SEL_W as I2C2SEL_W;
///Field `I2C3SEL` writer - I2C3 clock source selection These bits are set and cleared by software to select the I2C3 clock source.
...
///Field `LPTIM1SEL` reader - Low power timer 1 clock source selection These bits are set and cleared by software to select the LPTIM1 clock source.
...
///Field `LPTIM1SEL` writer - Low power timer 1 clock source selection These bits are set and cleared by software to select the LPTIM1 clock source.
...
///Field `SAI1SEL` reader - clock source selection These bits are set and cleared by software to select the SAI clock source.
...
///Field `SAI1SEL` writer - clock source selection These bits are set and cleared by software to select the SAI clock source.
...
///Field `I2S23SEL` reader - clock source selection These bits are set and cleared by software to select the I2S23 clock source.
...
///Field `I2S23SEL` writer - clock source selection These bits are set and cleared by software to select the I2S23 clock source.
...
///Field `CLK48SEL` reader - 48 MHz clock source selection These bits are set and cleared by software to select the 48 MHz clock source used by USB device FS and RNG.
...
///Field `CLK48SEL` writer - 48 MHz clock source selection These bits are set and cleared by software to select the 48 MHz clock source used by USB device FS and RNG.
...
///Field `ADC12SEL` reader - ADC1/2 clock source selection These bits are set and cleared by software to select the clock source used by the ADC interface.
...
///Field `ADC12SEL` writer - ADC1/2 clock source selection These bits are set and cleared by software to select the clock source used by the ADC interface.
...
///Field `ADC345SEL` reader - ADC3/4/5 clock source selection These bits are set and cleared by software to select the clock source used by the ADC345 interface.
pub use ADC12SEL_R as ADC345SEL_R;
///Field `ADC345SEL` writer - ADC3/4/5 clock source selection These bits are set and cleared by software to select the clock source used by the ADC345 interface.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471.html#RCC:CCIPR)*/
pub struct CCIPRrs;
