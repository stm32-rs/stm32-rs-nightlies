...
///Field `PLLPEN` reader - Main PLL PLL P clock output enable
pub type PLLPEN_R = crate::BitReader;
///Field `PLLPEN` writer - Main PLL PLL P clock output enable
...
///Field `PLLP` reader - Main PLL division factor for PLL P clock.
...
///Field `PLLP` writer - Main PLL division factor for PLL P clock.
...
///Field `PLLQEN` reader - Main PLL Q clock output enable
pub type PLLQEN_R = crate::BitReader;
///Field `PLLQEN` writer - Main PLL Q clock output enable
...
///Field `PLLQ` reader - Main PLL division factor for PLL Q clock.
...
///Field `PLLQ` writer - Main PLL division factor for PLL Q clock.
...
///Field `PLLREN` reader - PLL R clock output enable
pub type PLLREN_R = crate::BitReader;
///Field `PLLREN` writer - PLL R clock output enable
pub type PLLREN_W<'a, REG> = crate::BitWriter<'a, REG>;
/**Main PLL division factor for PLL R clock (system clock)
...
///Field `PLLR` reader - Main PLL division factor for PLL R clock (system clock)
...
///Field `PLLR` writer - Main PLL division factor for PLL R clock (system clock)
...
///Field `PLLPDIV` reader - Main PLLP division factor
...
///Field `PLLPDIV` writer - Main PLLP division factor
...
impl R {
    ...
    ///Bits 4:7 - Division factor for the main PLL input clock
    #[inline(always)]
    ...
    ///Bit 16 - Main PLL PLL P clock output enable
    #[inline(always)]
    pub fn pllpen(&self) -> PLLPEN_R {
        PLLPEN_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - Main PLL division factor for PLL P clock.
    #[inline(always)]
    pub fn pllp(&self) -> PLLP_R {
        PLLP_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 20 - Main PLL Q clock output enable
    #[inline(always)]
    pub fn pllqen(&self) -> PLLQEN_R {
        PLLQEN_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bits 21:22 - Main PLL division factor for PLL Q clock.
    #[inline(always)]
    pub fn pllq(&self) -> PLLQ_R {
        PLLQ_R::new(((self.bits >> 21) & 3) as u8)
    }
    ///Bit 24 - PLL R clock output enable
    #[inline(always)]
    pub fn pllren(&self) -> PLLREN_R {
        PLLREN_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bits 25:26 - Main PLL division factor for PLL R clock (system clock)
    #[inline(always)]
    pub fn pllr(&self) -> PLLR_R {
        PLLR_R::new(((self.bits >> 25) & 3) as u8)
    }
    ///Bits 27:31 - Main PLLP division factor
    #[inline(always)]
