...
pub struct TERRF_R(crate::FieldReader<bool, bool>);
impl TERRF_R {
    pub(crate) fn new(bits: bool) -> Self {
        TERRF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TERRF_R {
...
pub struct IERRF_R(crate::FieldReader<bool, bool>);
impl IERRF_R {
    pub(crate) fn new(bits: bool) -> Self {
        IERRF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IERRF_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DIRF_R(crate::FieldReader<bool, bool>);
impl DIRF_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct IDXF_R(crate::FieldReader<bool, bool>);
impl IDXF_R {
    pub(crate) fn new(bits: bool) -> Self {
        IDXF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IDXF_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
