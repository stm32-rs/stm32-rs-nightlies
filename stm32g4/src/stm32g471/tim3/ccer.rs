...
#[doc = "Field `CCNE(1-4)` reader - Capture/Compare %s complementary output enable"]
pub type CCNE_R = crate::BitReader;
#[doc = "Field `CCNE(1-4)` writer - Capture/Compare %s complementary output enable"]
...
impl R {
    ...
    #[doc = "Capture/Compare (1-4) complementary output enable"]
    #[doc = ""]
