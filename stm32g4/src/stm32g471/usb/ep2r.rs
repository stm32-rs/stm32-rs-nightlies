...
pub type R = crate::R<EP2Rrs>;
///Register `EP2R` writer
pub type W = crate::W<EP2Rrs>;
///Field `EA` reader - EA
...
impl W {
    ///Bits 0:3 - EA
    #[inline(always)]
    pub fn ea(&mut self) -> EA_W<EP2Rrs> {
        EA_W::new(self, 0)
    }
    ///Bits 4:5 - STAT_TX
    #[inline(always)]
    pub fn stat_tx(&mut self) -> STAT_TX_W<EP2Rrs> {
        STAT_TX_W::new(self, 4)
    }
    ///Bit 6 - DTOG_TX
    #[inline(always)]
    pub fn dtog_tx(&mut self) -> DTOG_TX_W<EP2Rrs> {
        DTOG_TX_W::new(self, 6)
    }
    ///Bit 7 - CTR_TX
    #[inline(always)]
    pub fn ctr_tx(&mut self) -> CTR_TX_W<EP2Rrs> {
        CTR_TX_W::new(self, 7)
    }
    ///Bit 8 - EP_KIND
    #[inline(always)]
    pub fn ep_kind(&mut self) -> EP_KIND_W<EP2Rrs> {
        EP_KIND_W::new(self, 8)
    }
    ///Bits 9:10 - EP_TYPE
    #[inline(always)]
    pub fn ep_type(&mut self) -> EP_TYPE_W<EP2Rrs> {
        EP_TYPE_W::new(self, 9)
    }
    ///Bit 11 - SETUP
    #[inline(always)]
    pub fn setup(&mut self) -> SETUP_W<EP2Rrs> {
        SETUP_W::new(self, 11)
    }
    ///Bits 12:13 - STAT_RX
    #[inline(always)]
    pub fn stat_rx(&mut self) -> STAT_RX_W<EP2Rrs> {
        STAT_RX_W::new(self, 12)
    }
    ///Bit 14 - DTOG_RX
    #[inline(always)]
    pub fn dtog_rx(&mut self) -> DTOG_RX_W<EP2Rrs> {
        DTOG_RX_W::new(self, 14)
    }
    ///Bit 15 - CTR_RX
    #[inline(always)]
    pub fn ctr_rx(&mut self) -> CTR_RX_W<EP2Rrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G471xx.html#USB:EP2R)*/
pub struct EP2Rrs;
impl crate::RegisterSpec for EP2Rrs {
    type Ux = u32;
}
///`read()` method returns [`ep2r::R`](R) reader structure
impl crate::Readable for EP2Rrs {}
///`write(|w| ..)` method takes [`ep2r::W`](W) writer structure
impl crate::Writable for EP2Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EP2R to value 0
impl crate::Resettable for EP2Rrs {
