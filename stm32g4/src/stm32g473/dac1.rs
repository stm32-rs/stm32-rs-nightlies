...
impl RegisterBlock {
    ...
    ///0x58..0x60 - Sawtooth register
    ///
    ///<div class="warning">`n` is the index of register in the array. `n == 0` corresponds to `STR1` register.</div>
    #[inline(always)]
    pub const fn str(&self, n: usize) -> &STR {
        &self.str[n]
    }
    ///Iterator for array of:
    ///0x58..0x60 - Sawtooth register
    ...
    #[inline(always)]
    pub const fn str1(&self) -> &STR {
        self.str(0)
    }
    ///0x5c - Sawtooth register
    #[inline(always)]
    pub const fn str2(&self) -> &STR {
        self.str(1)
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#DAC1:DHR12R[1])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#DAC1:DHR12L[1])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#DAC1:DHR8R[1])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#DAC1:DOR[1])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#DAC1:SHSR[1])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#DAC1:STR[1])
