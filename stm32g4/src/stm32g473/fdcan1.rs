...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:ENDN)
...
pub mod dbtp;
/**TEST (rw) register accessor: Write access to the Test Register has to be enabled by setting bit CCCR\[TEST\] to 1 . All Test Register functions are set to their reset values when bit CCCR\[TEST\] is reset. Loop Back mode and software control of Tx pin FDCANx_TX are hardware test modes. Programming TX differently from 00 may disturb the message transfer on the CAN bus.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TEST)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:NBTP)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TSCC)

For information about available fields see [`mod@tscc`] module*/
pub type TSCC = crate::Reg<tscc::TSCCrs>;
///FDCAN Timestamp Counter Configuration Register
pub mod tscc;
/**TSCV (r) register accessor: FDCAN Timestamp Counter Value Register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TOCC)

For information about available fields see [`mod@tocc`] module*/
pub type TOCC = crate::Reg<tocc::TOCCrs>;
///FDCAN Timeout Counter Configuration Register
pub mod tocc;
/**TOCV (r) register accessor: FDCAN Timeout Counter Value Register

You can [`read`](crate::Reg::read) this register and get [`tocv::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:PSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:IR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:IE)
...
pub mod ie;
/**ILS (rw) register accessor: The Interrupt Line Select register assigns an interrupt generated by a specific interrupt flag from the Interrupt Register to one of the two module interrupt lines. For interrupt generation the respective interrupt line has to be enabled via ILE\[EINT0\] and ILE\[EINT1\].
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:ILE)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:RXF1S)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:RXF1A)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TXBC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TXBAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TXBCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TXBCF)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TXBTIE)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TXBCIE)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TXEFS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:TXEFA)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FDCAN1:CKDIV)
