...
///Field `SEC_PROT1` reader - Securable memory area protection bit for bank 1.
pub type SEC_PROT1_R = crate::BitReader;
///Field `SEC_PROT1` writer - Securable memory area protection bit for bank 1.
...
impl R {
    ...
    ///Bit 28 - Securable memory area protection bit for bank 1.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FLASH:CR)*/
pub struct CRrs;
