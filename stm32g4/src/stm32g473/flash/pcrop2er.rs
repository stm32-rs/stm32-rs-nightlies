...
///Field `PCROP2_END` reader - PCROP area end offset
pub type PCROP2_END_R = crate::FieldReader<u16>;
///Field `PCROP2_END` writer - PCROP area end offset
pub type PCROP2_END_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#FLASH:PCROP2ER)*/
...
///`reset()` method sets PCROP2ER to value 0
