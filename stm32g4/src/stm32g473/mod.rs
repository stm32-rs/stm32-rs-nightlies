/*!Peripheral access API for STM32G473 microcontrollers (generated using svd2rust v0.35.0 (b6ef0b0 2024-11-13))
...
///Serial peripheral interface/Inter-IC sound
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32G473.html#SPI4)
pub struct SPI4 {
    _marker: PhantomData<*const ()>,
}
...
impl FDCAN3 {
    ///Pointer to the register block
    pub const PTR: *const fdcan1::RegisterBlock = 0x4000_6c00 as *const _;
    ///Return the pointer to the register block
    #[inline(always)]
    pub const fn ptr() -> *const fdcan1::RegisterBlock {
        Self::PTR
