...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opaintoen(&mut self) -> OPAINTOEN_W<OPAMP1_CSRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trimoffsetp(&mut self) -> TRIMOFFSETP_W<OPAMP1_CSRrs> {
        TRIMOFFSETP_W::new(self, 19)
    }
    ///Bits 24:28 - TRIMOFFSETN
    #[inline(always)]
    #[must_use]
    pub fn trimoffsetn(&mut self) -> TRIMOFFSETN_W<OPAMP1_CSRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<OPAMP1_CSRrs> {
        LOCK_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G473xx.html#OPAMP:OPAMP1_CSR)*/
