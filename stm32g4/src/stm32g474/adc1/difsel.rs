...
///Field `DIFSEL(0-18)` reader - Differential mode for channel %s
...
///Field `DIFSEL(0-18)` writer - Differential mode for channel %s
...
impl R {
    ///Differential mode for channel (0-18)
    ///
...
impl W {
    ...
    ///Bit 18 - Differential mode for channel 18
    #[inline(always)]
    pub fn difsel18(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#ADC1:DIFSEL)*/
pub struct DIFSELrs;
