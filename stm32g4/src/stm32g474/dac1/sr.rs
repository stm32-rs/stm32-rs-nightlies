...
///Field `DACRDY(1-2)` writer - DAC channel%s ready status bit
pub type DACRDY_W<'a, REG> = crate::BitWriter<'a, REG, DAC1RDY>;
impl<'a, REG> DACRDY_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn not_ready(self) -> &'a mut crate::W<REG> {
        self.variant(DAC1RDY::NotReady)
    }
    ///DAC channelX is ready to accept the trigger or output data
    #[inline(always)]
    pub fn ready(self) -> &'a mut crate::W<REG> {
        self.variant(DAC1RDY::Ready)
    }
}
...
///Field `DORSTAT(1-2)` writer - DAC channel%s output register status bit
pub type DORSTAT_W<'a, REG> = crate::BitWriter<'a, REG, DORSTAT1>;
impl<'a, REG> DORSTAT_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///DOR\[11:0\] is used actual DAC output
    #[inline(always)]
    pub fn dor(self) -> &'a mut crate::W<REG> {
        self.variant(DORSTAT1::Dor)
    }
    ///DORB\[11:0\] is used actual DAC output
    #[inline(always)]
    pub fn dorb(self) -> &'a mut crate::W<REG> {
        self.variant(DORSTAT1::Dorb)
    }
}
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DAC1RDY` field.</div>
    #[inline(always)]
    pub fn dacrdy(&mut self, n: u8) -> DACRDY_W<'_, SRrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        DACRDY_W::new(self, n * 16 + 11)
    }
    ///Bit 11 - DAC channel1 ready status bit
    #[inline(always)]
    pub fn dac1rdy(&mut self) -> DACRDY_W<'_, SRrs> {
        DACRDY_W::new(self, 11)
    }
    ///Bit 27 - DAC channel2 ready status bit
    #[inline(always)]
    pub fn dac2rdy(&mut self) -> DACRDY_W<'_, SRrs> {
        DACRDY_W::new(self, 27)
    }
    ///DAC channel(1-2) output register status bit
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DORSTAT1` field.</div>
    #[inline(always)]
    pub fn dorstat(&mut self, n: u8) -> DORSTAT_W<'_, SRrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        DORSTAT_W::new(self, n * 16 + 12)
    }
    ///Bit 12 - DAC channel1 output register status bit
    #[inline(always)]
    pub fn dorstat1(&mut self) -> DORSTAT_W<'_, SRrs> {
        DORSTAT_W::new(self, 12)
    }
    ///Bit 28 - DAC channel2 output register status bit
    #[inline(always)]
    pub fn dorstat2(&mut self) -> DORSTAT_W<'_, SRrs> {
        DORSTAT_W::new(self, 28)
    }
    ///DAC channel(1-2) DMA underrun flag
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DMAUDR1` field.</div>
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#DAC1:SR)*/
pub struct SRrs;
