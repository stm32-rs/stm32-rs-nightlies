...
impl W {
    ...
    ///Bit 29 - Falling trigger event configuration of line 29
    #[inline(always)]
    pub fn ft29(&mut self) -> FT29_W<FTSR1rs> {
        FT29_W::new(self, 29)
    }
    ///Bit 30 - Falling trigger event configuration of line 30
    #[inline(always)]
    pub fn ft30(&mut self) -> FT30_W<FTSR1rs> {
        FT30_W::new(self, 30)
    }
    ///Bit 31 - Falling trigger event configuration of line 31
    #[inline(always)]
    pub fn ft31(&mut self) -> FT31_W<FTSR1rs> {
        FT31_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#EXTI:FTSR1)*/
pub struct FTSR1rs;
