...
impl<'a> RT29_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(RT29_A::DISABLED)
    }
    #[doc = "Rising edge trigger is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(RT29_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl<'a> RT30_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(RT30_A::DISABLED)
    }
    #[doc = "Rising edge trigger is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(RT30_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl<'a> RT31_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(RT31_A::DISABLED)
    }
    #[doc = "Rising edge trigger is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(RT31_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
