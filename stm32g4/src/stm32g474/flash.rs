...
impl RegisterBlock {
    ...
    ///0x44 - Flash PCROP2 Start address register
    #[inline(always)]
    pub const fn pcrop2sr(&self) -> &PCROP2SR {
        &self.pcrop2sr
    }
    ///0x48 - Flash PCROP2 End address register
    #[inline(always)]
    ...
    ///0x70 - Flash Securable area bank1 register
    #[inline(always)]
    pub const fn sec1r(&self) -> &SEC1R {
        &self.sec1r
    }
    ///0x74 - Flash Securable area bank2 register
    #[inline(always)]
    pub const fn sec2r(&self) -> &SEC2R {
        &self.sec2r
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:ACR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:PDKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:KEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:OPTKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:OPTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:PCROP1SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:PCROP1ER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:WRP1AR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:WRP1BR)

For information about available fields see [`mod@wrp1br`] module*/
pub type WRP1BR = crate::Reg<wrp1br::WRP1BRrs>;
///Flash Bank 1 WRP area B address register
pub mod wrp1br;
/**PCROP2SR (rw) register accessor: Flash PCROP2 Start address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:PCROP2SR)
...
pub mod pcrop2sr;
/**PCROP2ER (rw) register accessor: Flash PCROP2 End address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:PCROP2ER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:WRP2AR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:WRP2BR)
...
pub mod wrp2br;
/**SEC1R (rw) register accessor: Flash Securable area bank1 register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:SEC1R)
...
pub mod sec1r;
/**SEC2R (rw) register accessor: Flash Securable area bank2 register

You can [`read`](crate::Reg::read) this register and get [`sec2r::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sec2r::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#FLASH:SEC2R)

For information about available fields see [`mod@sec2r`] module*/
pub type SEC2R = crate::Reg<sec2r::SEC2Rrs>;
