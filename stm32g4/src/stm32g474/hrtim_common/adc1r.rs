...
///Field `MC1` reader - ADC trigger 1 on Master Compare 1
pub type MC1_R = crate::BitReader;
///Field `MC1` writer - ADC trigger 1 on Master Compare 1
pub type MC1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MC2` reader - ADC trigger 1 on Master Compare 2
pub type MC2_R = crate::BitReader;
///Field `MC2` writer - ADC trigger 1 on Master Compare 2
pub type MC2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MC3` reader - ADC trigger 1 on Master Compare 3
pub type MC3_R = crate::BitReader;
///Field `MC3` writer - ADC trigger 1 on Master Compare 3
pub type MC3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MC4` reader - ADC trigger 1 on Master Compare 4
pub type MC4_R = crate::BitReader;
///Field `MC4` writer - ADC trigger 1 on Master Compare 4
...
///Field `EEV1` reader - ADC trigger 1 on External Event 1
pub type EEV1_R = crate::BitReader;
///Field `EEV1` writer - ADC trigger 1 on External Event 1
pub type EEV1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EEV2` reader - ADC trigger 1 on External Event 2
pub type EEV2_R = crate::BitReader;
///Field `EEV2` writer - ADC trigger 1 on External Event 2
pub type EEV2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EEV3` reader - ADC trigger 1 on External Event 3
pub type EEV3_R = crate::BitReader;
///Field `EEV3` writer - ADC trigger 1 on External Event 3
pub type EEV3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EEV4` reader - ADC trigger 1 on External Event 4
pub type EEV4_R = crate::BitReader;
///Field `EEV4` writer - ADC trigger 1 on External Event 4
pub type EEV4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EEV5` reader - ADC trigger 1 on External Event 5
pub type EEV5_R = crate::BitReader;
///Field `EEV5` writer - ADC trigger 1 on External Event 5
