...
///Field `FC2` reader - Bit 10 - ADC trigger 1 on timer F compare 2
pub type FC2_R = crate::BitReader<FC2>;
impl FC2_R {
    ///Get enumerated values variant
    #[inline(always)]
...
///Field `FC2` writer - Bit 10 - ADC trigger 1 on timer F compare 2
pub type FC2_W<'a, REG> = crate::BitWriter<'a, REG, FC2>;
impl<'a, REG> FC2_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///No generation of ADC trigger on timer compare event
...
///Field `FPER` reader - Bit 24 - ADC trigger 1 on timer F period
...
///Field `FPER` writer - Bit 24 - ADC trigger 1 on timer F period
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `MC1` field.</div>
    #[inline(always)]
    pub fn mc(&mut self, n: u8) -> MC_W<ADC1Rrs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
        MC_W::new(self, n)
    }
    ///Bit 0 - ADC trigger 1 on Master Compare 1
    #[inline(always)]
    pub fn mc1(&mut self) -> MC_W<ADC1Rrs> {
        MC_W::new(self, 0)
    }
    ///Bit 1 - ADC trigger 1 on Master Compare 2
    #[inline(always)]
    pub fn mc2(&mut self) -> MC_W<ADC1Rrs> {
        MC_W::new(self, 1)
    }
    ///Bit 2 - ADC trigger 1 on Master Compare 3
    #[inline(always)]
    pub fn mc3(&mut self) -> MC_W<ADC1Rrs> {
        MC_W::new(self, 2)
    }
    ///Bit 3 - ADC trigger 1 on Master Compare 4
    #[inline(always)]
    pub fn mc4(&mut self) -> MC_W<ADC1Rrs> {
        MC_W::new(self, 3)
    }
    ///Bit 4 - ADC trigger 1 on Master Period
    #[inline(always)]
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EEV1` field.</div>
    #[inline(always)]
    pub fn eev(&mut self, n: u8) -> EEV_W<ADC1Rrs> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
        EEV_W::new(self, n + 5)
    }
    ///Bit 5 - ADC trigger 1 on External Event 1
    #[inline(always)]
    pub fn eev1(&mut self) -> EEV_W<ADC1Rrs> {
        EEV_W::new(self, 5)
    }
    ///Bit 6 - ADC trigger 1 on External Event 2
    #[inline(always)]
    pub fn eev2(&mut self) -> EEV_W<ADC1Rrs> {
        EEV_W::new(self, 6)
    }
    ///Bit 7 - ADC trigger 1 on External Event 3
    #[inline(always)]
    pub fn eev3(&mut self) -> EEV_W<ADC1Rrs> {
        EEV_W::new(self, 7)
    }
    ///Bit 8 - ADC trigger 1 on External Event 4
    #[inline(always)]
    pub fn eev4(&mut self) -> EEV_W<ADC1Rrs> {
        EEV_W::new(self, 8)
    }
    ///Bit 9 - ADC trigger 1 on External Event 5
    #[inline(always)]
    pub fn eev5(&mut self) -> EEV_W<ADC1Rrs> {
        EEV_W::new(self, 9)
    }
    ///Bit 10 - Bit 10 - ADC trigger 1 on timer F compare 2
    #[inline(always)]
