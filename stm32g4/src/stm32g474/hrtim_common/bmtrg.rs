...
pub struct EEV8_R(crate::FieldReader<bool, bool>);
impl EEV8_R {
    pub(crate) fn new(bits: bool) -> Self {
        EEV8_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EEV8_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EEV7_R(crate::FieldReader<bool, bool>);
impl EEV7_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct TDEEV8_R(crate::FieldReader<bool, bool>);
impl TDEEV8_R {
    pub(crate) fn new(bits: bool) -> Self {
        TDEEV8_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TDEEV8_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct TDEEV7_R(crate::FieldReader<bool, bool>);
impl TDEEV7_R {
    pub(crate) fn new(bits: bool) -> Self {
        TDEEV7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TDEEV7_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
