...
impl W {
    ...
    ///Bit 8 - FLT6E
    #[inline(always)]
    pub fn flt6e(&mut self) -> FLTE_W<FLTINR2rs> {
        FLTE_W::new(self, 8)
    }
    ///FLT(5-6)P
    ///
    ...
    ///Bit 9 - FLT6P
    #[inline(always)]
    pub fn flt6p(&mut self) -> FLTP_W<FLTINR2rs> {
        FLTP_W::new(self, 9)
    }
    ///Fault (5-6) source
    ///
    ...
    ///Bit 10 - Fault 6 source
    #[inline(always)]
    pub fn flt6src(&mut self) -> FLTSRC_W<FLTINR2rs> {
    ...
    ///Bits 11:14 - FLT6F
    #[inline(always)]
    pub fn flt6f(&mut self) -> FLTF_W<FLTINR2rs> {
        FLTF_W::new(self, 11)
    }
    ///Bit 7 - FLT5LCK
    #[inline(always)]
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT1SRC_1` field.</div>
    #[inline(always)]
    pub fn fltsrc_1(&mut self, n: u8) -> FLTSRC_1_W<FLTINR2rs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
    ...
    ///Bit 16 - Fault 1 source bit 1
    #[inline(always)]
    pub fn flt1src_1(&mut self) -> FLTSRC_1_W<FLTINR2rs> {
        FLTSRC_1_W::new(self, 16)
    }
    ///Bit 17 - Fault 2 source bit 1
    #[inline(always)]
    pub fn flt2src_1(&mut self) -> FLTSRC_1_W<FLTINR2rs> {
        FLTSRC_1_W::new(self, 17)
    }
    ///Bit 18 - Fault 3 source bit 1
    #[inline(always)]
    pub fn flt3src_1(&mut self) -> FLTSRC_1_W<FLTINR2rs> {
        FLTSRC_1_W::new(self, 18)
    }
    ///Bit 19 - Fault 4 source bit 1
    #[inline(always)]
    pub fn flt4src_1(&mut self) -> FLTSRC_1_W<FLTINR2rs> {
        FLTSRC_1_W::new(self, 19)
    }
    ///Bit 20 - Fault 5 source bit 1
    #[inline(always)]
    pub fn flt5src_1(&mut self) -> FLTSRC_1_W<FLTINR2rs> {
        FLTSRC_1_W::new(self, 20)
    }
    ///Bit 21 - Fault 6 source bit 1
    #[inline(always)]
    pub fn flt6src_1(&mut self) -> FLTSRC_1_W<FLTINR2rs> {
