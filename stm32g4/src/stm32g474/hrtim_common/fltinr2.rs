...
pub enum FLT5SRC {
    ...
    Input = 0,
    ///1: Fault input is connected to a COMPx output
    CompOutput = 1,
}
...
///Field `FLTSRC(5-6)` reader - Fault %s source
...
impl FLTSRC_R {
    ...
    ///Fault input is connected to a COMPx output
    #[inline(always)]
    pub fn is_comp_output(&self) -> bool {
        *self == FLT5SRC::CompOutput
    }
}
///Field `FLTSRC(5-6)` writer - Fault %s source
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    ///Fault input is connected to a COMPx output
    #[inline(always)]
    pub fn comp_output(self) -> &'a mut crate::W<REG> {
        self.variant(FLT5SRC::CompOutput)
    }
}
/**FLT%sF
...
pub use FLT5LCK_R as FLT6LCK_R;
///Field `FLT6LCK` writer - FLT6LCK
pub use FLT5LCK_W as FLT6LCK_W;
/**Fault %s source bit 1

Value on reset: 0*/
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FLT1SRC_1 {
    ///0: As described in FLTxSRC
    Default = 0,
    ///1: Fault input is EEV5_muxout input pin (when FLTxSRC == 0) / reserved
    Eev = 1,
}
impl From<FLT1SRC_1> for bool {
    #[inline(always)]
    fn from(variant: FLT1SRC_1) -> Self {
        variant as u8 != 0
    }
}
///Field `FLTSRC_1(1-6)` reader - Fault %s source bit 1
pub type FLTSRC_1_R = crate::BitReader<FLT1SRC_1>;
impl FLTSRC_1_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> FLT1SRC_1 {
        match self.bits {
            false => FLT1SRC_1::Default,
            true => FLT1SRC_1::Eev,
        }
    }
    ///As described in FLTxSRC
    #[inline(always)]
    pub fn is_default(&self) -> bool {
        *self == FLT1SRC_1::Default
    }
    ///Fault input is EEV5_muxout input pin (when FLTxSRC == 0) / reserved
    #[inline(always)]
    pub fn is_eev(&self) -> bool {
        *self == FLT1SRC_1::Eev
    }
}
///Field `FLTSRC_1(1-6)` writer - Fault %s source bit 1
pub type FLTSRC_1_W<'a, REG> = crate::BitWriter<'a, REG, FLT1SRC_1>;
impl<'a, REG> FLTSRC_1_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///As described in FLTxSRC
    ...
    pub fn default(self) -> &'a mut crate::W<REG> {
        self.variant(FLT1SRC_1::Default)
    }
    ///Fault input is EEV5_muxout input pin (when FLTxSRC == 0) / reserved
    #[inline(always)]
    pub fn eev(self) -> &'a mut crate::W<REG> {
        self.variant(FLT1SRC_1::Eev)
    }
}
/**FLTSD
...
impl R {
    ...
    pub fn flte_iter(&self) -> impl Iterator<Item = FLTE_R> + '_ {
        (0..2).map(move |n| FLTE_R::new(((self.bits >> (n * 8)) & 1) != 0))
    }
    ///Bit 0 - FLT5E
    #[inline(always)]
    ...
    pub fn fltp_iter(&self) -> impl Iterator<Item = FLTP_R> + '_ {
        (0..2).map(move |n| FLTP_R::new(((self.bits >> (n * 8 + 1)) & 1) != 0))
    }
    ///Bit 1 - FLT5P
    #[inline(always)]
    ...
    pub fn fltsrc_iter(&self) -> impl Iterator<Item = FLTSRC_R> + '_ {
        (0..2).map(move |n| FLTSRC_R::new(((self.bits >> (n * 8 + 2)) & 1) != 0))
    }
    ...
    pub fn fltf_iter(&self) -> impl Iterator<Item = FLTF_R> + '_ {
        (0..2).map(move |n| FLTF_R::new(((self.bits >> (n * 8 + 3)) & 0x0f) as u8))
    }
    ///Bits 3:6 - FLT5F
    #[inline(always)]
    ...
    ///Fault (1-6) source bit 1
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT1SRC_1` field.</div>
    #[inline(always)]
    pub fn fltsrc_1(&self, n: u8) -> FLTSRC_1_R {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
        FLTSRC_1_R::new(((self.bits >> (n + 16)) & 1) != 0)
    }
    ///Iterator for array of:
    ///Fault (1-6) source bit 1
    #[inline(always)]
    pub fn fltsrc_1_iter(&self) -> impl Iterator<Item = FLTSRC_1_R> + '_ {
        (0..6).map(move |n| FLTSRC_1_R::new(((self.bits >> (n + 16)) & 1) != 0))
    }
    ///Bit 16 - Fault 1 source bit 1
    #[inline(always)]
    pub fn flt1src_1(&self) -> FLTSRC_1_R {
        FLTSRC_1_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - Fault 2 source bit 1
    #[inline(always)]
    pub fn flt2src_1(&self) -> FLTSRC_1_R {
        FLTSRC_1_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - Fault 3 source bit 1
    #[inline(always)]
    pub fn flt3src_1(&self) -> FLTSRC_1_R {
        FLTSRC_1_R::new(((self.bits >> 18) & 1) != 0)
    }
    ///Bit 19 - Fault 4 source bit 1
    #[inline(always)]
    pub fn flt4src_1(&self) -> FLTSRC_1_R {
        FLTSRC_1_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 20 - Fault 5 source bit 1
    #[inline(always)]
    pub fn flt5src_1(&self) -> FLTSRC_1_R {
        FLTSRC_1_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - Fault 6 source bit 1
    #[inline(always)]
    pub fn flt6src_1(&self) -> FLTSRC_1_R {
        FLTSRC_1_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Bits 24:25 - FLTSD
    #[inline(always)]
...
impl W {
    ...
    ///Bit 8 - FLT6E
    #[inline(always)]
    pub fn flt6e(&mut self) -> FLTE_W<'_, FLTINR2rs> {
        FLTE_W::new(self, 8)
    }
    ///FLT(5-6)P
    ///
    ...
    ///Bit 9 - FLT6P
    #[inline(always)]
    pub fn flt6p(&mut self) -> FLTP_W<'_, FLTINR2rs> {
        FLTP_W::new(self, 9)
    }
    ///Fault (5-6) source
    ///
    ...
    ///Bit 10 - Fault 6 source
    #[inline(always)]
    pub fn flt6src(&mut self) -> FLTSRC_W<'_, FLTINR2rs> {
    ...
    ///Bits 11:14 - FLT6F
    #[inline(always)]
    pub fn flt6f(&mut self) -> FLTF_W<'_, FLTINR2rs> {
        FLTF_W::new(self, 11)
    }
    ///Bit 7 - FLT5LCK
    #[inline(always)]
    ...
    ///Bit 15 - FLT6LCK
    #[inline(always)]
    pub fn flt6lck(&mut self) -> FLT6LCK_W<'_, FLTINR2rs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT1SRC_1` field.</div>
    #[inline(always)]
    pub fn fltsrc_1(&mut self, n: u8) -> FLTSRC_1_W<'_, FLTINR2rs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
        FLTSRC_1_W::new(self, n + 16)
    }
    ///Bit 16 - Fault 1 source bit 1
    #[inline(always)]
    pub fn flt1src_1(&mut self) -> FLTSRC_1_W<'_, FLTINR2rs> {
        FLTSRC_1_W::new(self, 16)
    }
    ///Bit 17 - Fault 2 source bit 1
    #[inline(always)]
    pub fn flt2src_1(&mut self) -> FLTSRC_1_W<'_, FLTINR2rs> {
        FLTSRC_1_W::new(self, 17)
    }
    ///Bit 18 - Fault 3 source bit 1
    #[inline(always)]
    pub fn flt3src_1(&mut self) -> FLTSRC_1_W<'_, FLTINR2rs> {
        FLTSRC_1_W::new(self, 18)
    }
    ///Bit 19 - Fault 4 source bit 1
    #[inline(always)]
    pub fn flt4src_1(&mut self) -> FLTSRC_1_W<'_, FLTINR2rs> {
        FLTSRC_1_W::new(self, 19)
    }
    ///Bit 20 - Fault 5 source bit 1
    #[inline(always)]
    pub fn flt5src_1(&mut self) -> FLTSRC_1_W<'_, FLTINR2rs> {
        FLTSRC_1_W::new(self, 20)
    }
    ///Bit 21 - Fault 6 source bit 1
    #[inline(always)]
    pub fn flt6src_1(&mut self) -> FLTSRC_1_W<'_, FLTINR2rs> {
        FLTSRC_1_W::new(self, 21)
    }
    ///Bits 24:25 - FLTSD
    #[inline(always)]
