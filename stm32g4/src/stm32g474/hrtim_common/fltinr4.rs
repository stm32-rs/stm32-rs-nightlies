...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT5BLKE` field.</div>
    #[inline(always)]
    pub fn fltblke(&mut self, n: u8) -> FLTBLKE_W<FLTINR4rs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 0 - FLT5BLKE
    #[inline(always)]
    pub fn flt5blke(&mut self) -> FLTBLKE_W<FLTINR4rs> {
        FLTBLKE_W::new(self, 0)
    }
    ///Bit 8 - FLT6BLKE
    #[inline(always)]
    pub fn flt6blke(&mut self) -> FLTBLKE_W<FLTINR4rs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT5BLKS` field.</div>
    #[inline(always)]
    pub fn fltblks(&mut self, n: u8) -> FLTBLKS_W<FLTINR4rs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 1 - FLT5BLKS
    #[inline(always)]
    pub fn flt5blks(&mut self) -> FLTBLKS_W<FLTINR4rs> {
        FLTBLKS_W::new(self, 1)
    }
    ///Bit 9 - FLT6BLKS
    #[inline(always)]
    pub fn flt6blks(&mut self) -> FLTBLKS_W<FLTINR4rs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT5CNT` field.</div>
    #[inline(always)]
    pub fn fltcnt(&mut self, n: u8) -> FLTCNT_W<FLTINR4rs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bits 2:5 - FLT5CNT
    #[inline(always)]
    pub fn flt5cnt(&mut self) -> FLTCNT_W<FLTINR4rs> {
        FLTCNT_W::new(self, 2)
    }
    ///Bits 10:13 - FLT6CNT
    #[inline(always)]
    pub fn flt6cnt(&mut self) -> FLTCNT_W<FLTINR4rs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT5CRES` field.</div>
    #[inline(always)]
    pub fn fltcres(&mut self, n: u8) -> FLTCRES_W<FLTINR4rs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 6 - FLT5CRES
    #[inline(always)]
    pub fn flt5cres(&mut self) -> FLTCRES_W<FLTINR4rs> {
        FLTCRES_W::new(self, 6)
    }
    ///Bit 14 - FLT6CRES
    #[inline(always)]
    pub fn flt6cres(&mut self) -> FLTCRES_W<FLTINR4rs> {
