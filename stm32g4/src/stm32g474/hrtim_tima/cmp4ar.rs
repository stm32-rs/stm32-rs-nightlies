///Register `CMP4AR` reader
pub type R = crate::R<CMP4ARrs>;
///Register `CMP4AR` writer
pub type W = crate::W<CMP4ARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp4x(&mut self) -> CMP4X_W<CMP4ARrs> {
        CMP4X_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMA:CMP4AR)*/
pub struct CMP4ARrs;
impl crate::RegisterSpec for CMP4ARrs {
    type Ux = u32;
}
///`read()` method returns [`cmp4ar::R`](R) reader structure
impl crate::Readable for CMP4ARrs {}
///`write(|w| ..)` method takes [`cmp4ar::W`](W) writer structure
impl crate::Writable for CMP4ARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CMP4AR to value 0
impl crate::Resettable for CMP4ARrs {
