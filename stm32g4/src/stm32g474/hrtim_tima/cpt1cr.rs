...
impl W {
    ...
    ///Bit 12 - TF1SET
    #[inline(always)]
    pub fn tf1set(&mut self) -> TF1SET_W<CPT1CRrs> {
        TF1SET_W::new(self, 12)
    }
    ///Bit 13 - TF1RST
    #[inline(always)]
    pub fn tf1rst(&mut self) -> TF1RST_W<CPT1CRrs> {
        TF1RST_W::new(self, 13)
    }
    ///Bit 14 - TFCMP1
    #[inline(always)]
    pub fn tfcmp1(&mut self) -> TFCMP1_W<CPT1CRrs> {
        TFCMP1_W::new(self, 14)
    }
    ///Bit 15 - TFCMP2
    #[inline(always)]
    pub fn tfcmp2(&mut self) -> TFCMP2_W<CPT1CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMA:CPT1CR)*/
pub struct CPT1CRrs;
