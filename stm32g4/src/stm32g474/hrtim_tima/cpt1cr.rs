...
impl From<TF1SET> for bool {
    #[inline(always)]
    fn from(variant: TF1SET) -> Self {
        variant as u8 != 0
    }
}
///Field `TF1SET` reader - TF1SET
pub type TF1SET_R = crate::BitReader<TF1SET>;
impl TF1SET_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TF1SET {
        match self.bits {
            false => TF1SET::NoEffect,
            true => TF1SET::TriggerCapture,
        }
    }
    ///Timer X output Y inactive to active transition has no effect
    #[inline(always)]
    pub fn is_no_effect(&self) -> bool {
        *self == TF1SET::NoEffect
    }
    ///Timer X output Y inactive to active transition triggers capture Z
    #[inline(always)]
    pub fn is_trigger_capture(&self) -> bool {
        *self == TF1SET::TriggerCapture
    }
}
///Field `TF1SET` writer - TF1SET
pub type TF1SET_W<'a, REG> = crate::BitWriter<'a, REG, TF1SET>;
impl<'a, REG> TF1SET_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Timer X output Y inactive to active transition has no effect
    #[inline(always)]
    pub fn no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(TF1SET::NoEffect)
    }
    ///Timer X output Y inactive to active transition triggers capture Z
    #[inline(always)]
    pub fn trigger_capture(self) -> &'a mut crate::W<REG> {
        self.variant(TF1SET::TriggerCapture)
    }
}
/**TF1RST
...
impl From<TF1RST> for bool {
    #[inline(always)]
    fn from(variant: TF1RST) -> Self {
        variant as u8 != 0
    }
}
///Field `TF1RST` reader - TF1RST
pub type TF1RST_R = crate::BitReader<TF1RST>;
impl TF1RST_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TF1RST {
        match self.bits {
            false => TF1RST::NoEffect,
            true => TF1RST::TriggerCapture,
        }
    }
    ///Timer X output Y active to inactive transition has no effect
    #[inline(always)]
    pub fn is_no_effect(&self) -> bool {
        *self == TF1RST::NoEffect
    }
    ///Timer X output Y active to inactive transition triggers capture Z
    #[inline(always)]
    pub fn is_trigger_capture(&self) -> bool {
        *self == TF1RST::TriggerCapture
    }
}
///Field `TF1RST` writer - TF1RST
pub type TF1RST_W<'a, REG> = crate::BitWriter<'a, REG, TF1RST>;
impl<'a, REG> TF1RST_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Timer X output Y active to inactive transition has no effect
    #[inline(always)]
    pub fn no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(TF1RST::NoEffect)
    }
    ///Timer X output Y active to inactive transition triggers capture Z
    #[inline(always)]
    pub fn trigger_capture(self) -> &'a mut crate::W<REG> {
        self.variant(TF1RST::TriggerCapture)
    }
}
/**TFCMP1
...
impl From<TFCMP1> for bool {
    #[inline(always)]
    fn from(variant: TFCMP1) -> Self {
        variant as u8 != 0
    }
}
///Field `TFCMP1` reader - TFCMP1
pub type TFCMP1_R = crate::BitReader<TFCMP1>;
impl TFCMP1_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TFCMP1 {
        match self.bits {
            false => TFCMP1::NoEffect,
            true => TFCMP1::TriggerCapture,
        }
    }
    ///Timer X compare Y has no effect
    #[inline(always)]
    pub fn is_no_effect(&self) -> bool {
        *self == TFCMP1::NoEffect
    }
    ///Timer X compare Y triggers capture Z
    #[inline(always)]
    pub fn is_trigger_capture(&self) -> bool {
        *self == TFCMP1::TriggerCapture
    }
}
///Field `TFCMP1` writer - TFCMP1
pub type TFCMP1_W<'a, REG> = crate::BitWriter<'a, REG, TFCMP1>;
impl<'a, REG> TFCMP1_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Timer X compare Y has no effect
...
impl W {
    ...
    ///Bit 12 - TF1SET
    #[inline(always)]
    pub fn tf1set(&mut self) -> TF1SET_W<'_, CPT1CRrs> {
        TF1SET_W::new(self, 12)
    }
    ///Bit 13 - TF1RST
    #[inline(always)]
    pub fn tf1rst(&mut self) -> TF1RST_W<'_, CPT1CRrs> {
        TF1RST_W::new(self, 13)
    }
    ///Bit 14 - TFCMP1
    #[inline(always)]
    pub fn tfcmp1(&mut self) -> TFCMP1_W<'_, CPT1CRrs> {
        TFCMP1_W::new(self, 14)
    }
    ///Bit 15 - TFCMP2
    #[inline(always)]
    pub fn tfcmp2(&mut self) -> TFCMP2_W<'_, CPT1CRrs> {
        TFCMP2_W::new(self, 15)
    }
    ///Bit 16 - Timer B output 1 Set
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#HRTIM_TIMA:CPT1CR)*/
pub struct CPT1CRrs;
