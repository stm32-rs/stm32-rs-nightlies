...
impl W {
    ///Bit 0 - Dual Channel DAC trigger enable
    #[inline(always)]
    pub fn dcde(&mut self) -> DCDE_W<CR2rs> {
        DCDE_W::new(self, 0)
    }
    ///Bit 1 - Dual Channel DAC Step trigger
    #[inline(always)]
    pub fn dcds(&mut self) -> DCDS_W<CR2rs> {
        DCDS_W::new(self, 1)
    }
    ///Bit 2 - Dual Channel DAC Reset trigger
    #[inline(always)]
    pub fn dcdr(&mut self) -> DCDR_W<CR2rs> {
        DCDR_W::new(self, 2)
    }
    ///Bit 4 - Up-Down Mode
    #[inline(always)]
    pub fn udm(&mut self) -> UDM_W<CR2rs> {
        UDM_W::new(self, 4)
    }
    ///Bits 6:7 - Roll-Over Mode
    #[inline(always)]
    pub fn rom(&mut self) -> ROM_W<CR2rs> {
        ROM_W::new(self, 6)
    }
    ///Bits 8:9 - Output Roll-Over Mode
    #[inline(always)]
    pub fn outrom(&mut self) -> OUTROM_W<CR2rs> {
        OUTROM_W::new(self, 8)
    }
    ///Bits 10:11 - ADC Roll-Over Mode
    #[inline(always)]
    pub fn adrom(&mut self) -> ADROM_W<CR2rs> {
        ADROM_W::new(self, 10)
    }
    ///Bits 12:13 - Burst Mode Roll-Over Mode
    #[inline(always)]
    pub fn bmrom(&mut self) -> BMROM_W<CR2rs> {
        BMROM_W::new(self, 12)
    }
    ///Bits 14:15 - Fault and Event Roll-Over Mode
    #[inline(always)]
    pub fn ferom(&mut self) -> FEROM_W<CR2rs> {
        FEROM_W::new(self, 14)
    }
    ///Bit 16 - Greater than Compare 1 PWM mode
    #[inline(always)]
    pub fn gtcmp1(&mut self) -> GTCMP1_W<CR2rs> {
        GTCMP1_W::new(self, 16)
    }
    ///Bit 17 - Greater than Compare 3 PWM mode
    #[inline(always)]
    pub fn gtcmp3(&mut self) -> GTCMP3_W<CR2rs> {
        GTCMP3_W::new(self, 17)
    }
    ///Bit 20 - Triggered-half mode
    #[inline(always)]
    pub fn trghlf(&mut self) -> TRGHLF_W<CR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMA:CR2)*/
pub struct CR2rs;
