...
impl W {
    ///Bit 0 - External Event A Counter Enable
    #[inline(always)]
    pub fn eevace(&mut self) -> EEVACE_W<EEFR3rs> {
        EEVACE_W::new(self, 0)
    }
    ///Bit 1 - External Event A Counter Reset
    #[inline(always)]
    pub fn eevacres(&mut self) -> EEVACRES_W<EEFR3rs> {
        EEVACRES_W::new(self, 1)
    }
    ///Bit 2 - External Event A Reset Mode
    #[inline(always)]
    pub fn eevarstm(&mut self) -> EEVARSTM_W<EEFR3rs> {
        EEVARSTM_W::new(self, 2)
    }
    ///Bits 4:7 - External Event A Selection
    #[inline(always)]
    pub fn eevasel(&mut self) -> EEVASEL_W<EEFR3rs> {
        EEVASEL_W::new(self, 4)
    }
    ///Bits 8:13 - External Event A counter
    #[inline(always)]
    pub fn eevacnt(&mut self) -> EEVACNT_W<EEFR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMA:EEFR3)*/
pub struct EEFR3rs;
