...
pub type R = crate::R<FLTARrs>;
///Register `FLTAR` writer
pub type W = crate::W<FLTARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flt1en(&mut self) -> FLT1EN_W<FLTARrs> {
        FLT1EN_W::new(self, 0)
    }
    ///Bit 1 - Fault 2 enable
    #[inline(always)]
    #[must_use]
    pub fn flt2en(&mut self) -> FLT2EN_W<FLTARrs> {
        FLT2EN_W::new(self, 1)
    }
    ///Bit 2 - Fault 3 enable
    #[inline(always)]
    #[must_use]
    pub fn flt3en(&mut self) -> FLT3EN_W<FLTARrs> {
        FLT3EN_W::new(self, 2)
    }
    ///Bit 3 - Fault 4 enable
    #[inline(always)]
    #[must_use]
    pub fn flt4en(&mut self) -> FLT4EN_W<FLTARrs> {
        FLT4EN_W::new(self, 3)
    }
    ///Bit 4 - Fault 5 enable
    #[inline(always)]
    #[must_use]
    pub fn flt5en(&mut self) -> FLT5EN_W<FLTARrs> {
        FLT5EN_W::new(self, 4)
    }
    ///Bit 5 - Fault 6 enable
    #[inline(always)]
    #[must_use]
    pub fn flt6en(&mut self) -> FLT6EN_W<FLTARrs> {
        FLT6EN_W::new(self, 5)
    }
    ///Bit 31 - Fault sources Lock
    #[inline(always)]
    #[must_use]
    pub fn fltlck(&mut self) -> FLTLCK_W<FLTARrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMA:FLTAR)*/
pub struct FLTARrs;
impl crate::RegisterSpec for FLTARrs {
    type Ux = u32;
}
///`read()` method returns [`fltar::R`](R) reader structure
impl crate::Readable for FLTARrs {}
///`write(|w| ..)` method takes [`fltar::W`](W) writer structure
impl crate::Writable for FLTARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FLTAR to value 0
impl crate::Resettable for FLTARrs {
