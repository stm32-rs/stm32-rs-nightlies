...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timfcmp1(&mut self) -> TIMFCMP1_W<RSTARrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timfcpm2(&mut self) -> TIMFCPM2_W<RSTARrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMA:RSTAR)*/
pub struct RSTARrs;
