...
impl From<TIMFCMP1> for bool {
    #[inline(always)]
    fn from(variant: TIMFCMP1) -> Self {
        variant as u8 != 0
    }
}
///Field `TIMFCMP1` reader - Timer A Update reset
pub type TIMFCMP1_R = crate::BitReader<TIMFCMP1>;
impl TIMFCMP1_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TIMFCMP1 {
        match self.bits {
            false => TIMFCMP1::NoEffect,
            true => TIMFCMP1::ResetCounter,
        }
    }
    ///Timer Y compare Z event has no effect
    #[inline(always)]
    pub fn is_no_effect(&self) -> bool {
        *self == TIMFCMP1::NoEffect
    }
    ///Timer X counter is reset upon timer Y compare Z event
    #[inline(always)]
    pub fn is_reset_counter(&self) -> bool {
        *self == TIMFCMP1::ResetCounter
    }
}
///Field `TIMFCMP1` writer - Timer A Update reset
pub type TIMFCMP1_W<'a, REG> = crate::BitWriter<'a, REG, TIMFCMP1>;
impl<'a, REG> TIMFCMP1_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(TIMFCMP1::NoEffect)
    }
    ///Timer X counter is reset upon timer Y compare Z event
    #[inline(always)]
    pub fn reset_counter(self) -> &'a mut crate::W<REG> {
        self.variant(TIMFCMP1::ResetCounter)
    }
}
/**Timer A Update reset
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#HRTIM_TIMA:RSTR)*/
pub struct RSTRrs;
