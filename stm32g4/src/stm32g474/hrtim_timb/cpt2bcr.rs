...
pub type R = crate::R<CPT2BCRrs>;
///Register `CPT2BCR` writer
pub type W = crate::W<CPT2BCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swcpt(&mut self) -> SWCPT_W<CPT2BCRrs> {
        SWCPT_W::new(self, 0)
    }
    ///Bit 1 - Update Capture
    #[inline(always)]
    #[must_use]
    pub fn udpcpt(&mut self) -> UDPCPT_W<CPT2BCRrs> {
        UDPCPT_W::new(self, 1)
    }
    ///Bit 2 - External Event 1 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev1cpt(&mut self) -> EXEV1CPT_W<CPT2BCRrs> {
        EXEV1CPT_W::new(self, 2)
    }
    ///Bit 3 - External Event 2 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev2cpt(&mut self) -> EXEV2CPT_W<CPT2BCRrs> {
        EXEV2CPT_W::new(self, 3)
    }
    ///Bit 4 - External Event 3 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev3cpt(&mut self) -> EXEV3CPT_W<CPT2BCRrs> {
        EXEV3CPT_W::new(self, 4)
    }
    ///Bit 5 - External Event 4 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev4cpt(&mut self) -> EXEV4CPT_W<CPT2BCRrs> {
        EXEV4CPT_W::new(self, 5)
    }
    ///Bit 6 - External Event 5 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev5cpt(&mut self) -> EXEV5CPT_W<CPT2BCRrs> {
        EXEV5CPT_W::new(self, 6)
    }
    ///Bit 7 - External Event 6 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev6cpt(&mut self) -> EXEV6CPT_W<CPT2BCRrs> {
        EXEV6CPT_W::new(self, 7)
    }
    ///Bit 8 - External Event 7 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev7cpt(&mut self) -> EXEV7CPT_W<CPT2BCRrs> {
        EXEV7CPT_W::new(self, 8)
    }
    ///Bit 9 - External Event 8 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev8cpt(&mut self) -> EXEV8CPT_W<CPT2BCRrs> {
        EXEV8CPT_W::new(self, 9)
    }
    ///Bit 10 - External Event 9 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev9cpt(&mut self) -> EXEV9CPT_W<CPT2BCRrs> {
        EXEV9CPT_W::new(self, 10)
    }
    ///Bit 11 - External Event 10 Capture
    #[inline(always)]
    #[must_use]
    pub fn exev10cpt(&mut self) -> EXEV10CPT_W<CPT2BCRrs> {
        EXEV10CPT_W::new(self, 11)
    }
    ///Bit 12 - Timer A output 1 Set
    #[inline(always)]
    #[must_use]
    pub fn ta1set(&mut self) -> TA1SET_W<CPT2BCRrs> {
        TA1SET_W::new(self, 12)
    }
    ///Bit 13 - Timer A output 1 Reset
    #[inline(always)]
    #[must_use]
    pub fn ta1rst(&mut self) -> TA1RST_W<CPT2BCRrs> {
        TA1RST_W::new(self, 13)
    }
    ///Bit 14 - Timer A Compare 1
    #[inline(always)]
    #[must_use]
    pub fn tacmp1(&mut self) -> TACMP1_W<CPT2BCRrs> {
        TACMP1_W::new(self, 14)
    }
    ///Bit 15 - Timer A Compare 2
    #[inline(always)]
    #[must_use]
    pub fn tacmp2(&mut self) -> TACMP2_W<CPT2BCRrs> {
        TACMP2_W::new(self, 15)
    }
    ///Bit 16 - TF1SET
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> TF1SET_W<CPT2BCRrs> {
        TF1SET_W::new(self, 16)
    }
    ///Bit 17 - TF1RST
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> TF1RST_W<CPT2BCRrs> {
        TF1RST_W::new(self, 17)
    }
    ///Bit 18 - TFCMP1
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> TFCMP1_W<CPT2BCRrs> {
        TFCMP1_W::new(self, 18)
    }
    ///Bit 19 - TFCMP2
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> TFCMP2_W<CPT2BCRrs> {
        TFCMP2_W::new(self, 19)
    }
    ///Bit 20 - Timer C output 1 Set
    #[inline(always)]
    #[must_use]
    pub fn tc1set(&mut self) -> TC1SET_W<CPT2BCRrs> {
        TC1SET_W::new(self, 20)
    }
    ///Bit 21 - Timer C output 1 Reset
    #[inline(always)]
    #[must_use]
    pub fn tc1rst(&mut self) -> TC1RST_W<CPT2BCRrs> {
        TC1RST_W::new(self, 21)
    }
    ///Bit 22 - Timer C Compare 1
    #[inline(always)]
    #[must_use]
    pub fn tccmp1(&mut self) -> TCCMP1_W<CPT2BCRrs> {
        TCCMP1_W::new(self, 22)
    }
    ///Bit 23 - Timer C Compare 2
    #[inline(always)]
    #[must_use]
    pub fn tccmp2(&mut self) -> TCCMP2_W<CPT2BCRrs> {
        TCCMP2_W::new(self, 23)
    }
    ///Bit 24 - Timer D output 1 Set
    #[inline(always)]
    #[must_use]
    pub fn td1set(&mut self) -> TD1SET_W<CPT2BCRrs> {
        TD1SET_W::new(self, 24)
    }
    ///Bit 25 - Timer D output 1 Reset
    #[inline(always)]
    #[must_use]
    pub fn td1rst(&mut self) -> TD1RST_W<CPT2BCRrs> {
        TD1RST_W::new(self, 25)
    }
    ///Bit 26 - Timer D Compare 1
    #[inline(always)]
    #[must_use]
    pub fn tdcmp1(&mut self) -> TDCMP1_W<CPT2BCRrs> {
        TDCMP1_W::new(self, 26)
    }
    ///Bit 27 - Timer D Compare 2
    #[inline(always)]
    #[must_use]
    pub fn tdcmp2(&mut self) -> TDCMP2_W<CPT2BCRrs> {
        TDCMP2_W::new(self, 27)
    }
    ///Bit 28 - Timer E output 1 Set
    #[inline(always)]
    #[must_use]
    pub fn te1set(&mut self) -> TE1SET_W<CPT2BCRrs> {
        TE1SET_W::new(self, 28)
    }
    ///Bit 29 - Timer E output 1 Reset
    #[inline(always)]
    #[must_use]
    pub fn te1rst(&mut self) -> TE1RST_W<CPT2BCRrs> {
        TE1RST_W::new(self, 29)
    }
    ///Bit 30 - Timer E Compare 1
    #[inline(always)]
    #[must_use]
    pub fn tecmp1(&mut self) -> TECMP1_W<CPT2BCRrs> {
        TECMP1_W::new(self, 30)
    }
    ///Bit 31 - Timer E Compare 2
    #[inline(always)]
    #[must_use]
    pub fn tecmp2(&mut self) -> TECMP2_W<CPT2BCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMB:CPT2BCR)*/
pub struct CPT2BCRrs;
impl crate::RegisterSpec for CPT2BCRrs {
    type Ux = u32;
}
///`read()` method returns [`cpt2bcr::R`](R) reader structure
impl crate::Readable for CPT2BCRrs {}
///`write(|w| ..)` method takes [`cpt2bcr::W`](W) writer structure
impl crate::Writable for CPT2BCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CPT2BCR to value 0
impl crate::Resettable for CPT2BCRrs {
