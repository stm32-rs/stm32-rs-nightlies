#[doc = "Reader of register DTBR"]
pub type R = crate::R<u32, super::DTBR>;
#[doc = "Writer for register DTBR"]
pub type W = crate::W<u32, super::DTBR>;
#[doc = "Register DTBR `reset()`'s with value 0"]
impl crate::ResetValue for super::DTBR {
    type Type = u32;
    #[inline(always)]
