#[doc = "Reader of register FLTBR"]
pub type R = crate::R<u32, super::FLTBR>;
#[doc = "Writer for register FLTBR"]
pub type W = crate::W<u32, super::FLTBR>;
#[doc = "Register FLTBR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLTBR {
    type Type = u32;
    #[inline(always)]
