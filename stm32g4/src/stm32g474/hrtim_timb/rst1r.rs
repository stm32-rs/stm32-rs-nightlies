...
impl W {
    ...
    ///Bit 12 - Timer A Compare 1
    #[inline(always)]
    pub fn timacmp1(&mut self) -> TIMACMP1_W<RST1Rrs> {
    ...
    ///Bit 15 - Timer C Compare 4
    #[inline(always)]
    pub fn timccmp4(&mut self) -> TIMCCMP4_W<RST1Rrs> {
        TIMCCMP4_W::new(self, 15)
    }
    ///Bit 16 - Timer D Compare 3
    #[inline(always)]
    pub fn timdcmp3(&mut self) -> TIMDCMP3_W<RST1Rrs> {
    ...
    ///Bit 18 - Timer E Compare 1
    #[inline(always)]
    pub fn timecmp1(&mut self) -> TIMECMP1_W<RST1Rrs> {
