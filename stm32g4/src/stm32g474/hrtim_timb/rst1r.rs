...
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_R as TIMACMP1_R;
///Field `TIMACMP2` reader - Timer A Compare 2
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_R as TIMACMP2_R;
///Field `TIMCCMP3` reader - Timer C Compare 3
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_R as TIMCCMP3_R;
///Field `TIMCCMP4` reader - Timer C Compare 4
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_R as TIMCCMP4_R;
///Field `TIMDCMP3` reader - Timer D Compare 3
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_R as TIMDCMP3_R;
///Field `TIMDCMP4` reader - Timer D Compare 4
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_R as TIMDCMP4_R;
///Field `TIMECMP1` reader - Timer E Compare 1
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_R as TIMECMP1_R;
///Field `TIMECMP2` reader - Timer E Compare 2
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_R as TIMECMP2_R;
...
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_W as TIMACMP1_W;
///Field `TIMACMP2` writer - Timer A Compare 2
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_W as TIMACMP2_W;
///Field `TIMCCMP3` writer - Timer C Compare 3
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_W as TIMCCMP3_W;
///Field `TIMCCMP4` writer - Timer C Compare 4
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_W as TIMCCMP4_W;
///Field `TIMDCMP3` writer - Timer D Compare 3
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_W as TIMDCMP3_W;
///Field `TIMDCMP4` writer - Timer D Compare 4
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_W as TIMDCMP4_W;
///Field `TIMECMP1` writer - Timer E Compare 1
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_W as TIMECMP1_W;
///Field `TIMECMP2` writer - Timer E Compare 2
pub use crate::stm32g474::hrtim_tima::rst1r::TIMBCMP1_W as TIMECMP2_W;
...
impl W {
    ...
    ///Bit 12 - Timer A Compare 1
    #[inline(always)]
    pub fn timacmp1(&mut self) -> TIMACMP1_W<'_, RST1Rrs> {
    ...
    pub fn timccmp3(&mut self) -> TIMCCMP3_W<'_, RST1Rrs> {
        TIMCCMP3_W::new(self, 14)
    }
    ///Bit 15 - Timer C Compare 4
    #[inline(always)]
    pub fn timccmp4(&mut self) -> TIMCCMP4_W<'_, RST1Rrs> {
        TIMCCMP4_W::new(self, 15)
    }
    ///Bit 16 - Timer D Compare 3
    #[inline(always)]
    pub fn timdcmp3(&mut self) -> TIMDCMP3_W<'_, RST1Rrs> {
        TIMDCMP3_W::new(self, 16)
    }
    ///Bit 17 - Timer D Compare 4
    #[inline(always)]
    ...
    ///Bit 18 - Timer E Compare 1
    #[inline(always)]
    pub fn timecmp1(&mut self) -> TIMECMP1_W<'_, RST1Rrs> {
        TIMECMP1_W::new(self, 18)
    }
    ///Bit 19 - Timer E Compare 2
    #[inline(always)]
    pub fn timecmp2(&mut self) -> TIMECMP2_W<'_, RST1Rrs> {
        TIMECMP2_W::new(self, 19)
    }
    ///Bit 20 - Timer F Compare 3
    #[inline(always)]
    pub fn timfcmp3(&mut self) -> TIMFCMP3_W<'_, RST1Rrs> {
        TIMFCMP3_W::new(self, 20)
    }
    ///EXTEVNT(1-10)
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EXTEVNT1` field.</div>
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#HRTIM_TIMB:RST1R)*/
pub struct RST1Rrs;
