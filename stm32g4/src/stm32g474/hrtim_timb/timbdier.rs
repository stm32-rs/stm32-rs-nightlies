...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn set1x_ie(&mut self) -> SET1X_IE_W<TIMBDIERrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn set1x_de(&mut self) -> SET1X_DE_W<TIMBDIERrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMB:TIMBDIER)*/
