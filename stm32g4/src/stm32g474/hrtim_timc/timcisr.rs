...
pub struct O2CPY_R(crate::FieldReader<bool, bool>);
impl O2CPY_R {
    pub(crate) fn new(bits: bool) -> Self {
        O2CPY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for O2CPY_R {
...
pub struct O1CPY_R(crate::FieldReader<bool, bool>);
impl O1CPY_R {
    pub(crate) fn new(bits: bool) -> Self {
