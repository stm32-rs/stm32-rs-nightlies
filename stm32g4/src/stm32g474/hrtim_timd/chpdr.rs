///Register `CHPDR` reader
pub type R = crate::R<CHPDRrs>;
///Register `CHPDR` writer
...
///`read()` method returns [`chpdr::R`](R) reader structure
impl crate::Readable for CHPDRrs {}
///`write(|w| ..)` method takes [`chpdr::W`](W) writer structure
impl crate::Writable for CHPDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CHPDR to value 0
