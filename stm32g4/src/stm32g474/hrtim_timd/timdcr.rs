...
pub type R = crate::R<TIMDCRrs>;
///Register `TIMDCR` writer
pub type W = crate::W<TIMDCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ck_pscx(&mut self) -> CK_PSCX_W<TIMDCRrs> {
        CK_PSCX_W::new(self, 0)
    }
    ///Bit 3 - Continuous mode
    #[inline(always)]
    #[must_use]
    pub fn cont(&mut self) -> CONT_W<TIMDCRrs> {
        CONT_W::new(self, 3)
    }
    ///Bit 4 - Re-triggerable mode
    #[inline(always)]
    #[must_use]
    pub fn retrig(&mut self) -> RETRIG_W<TIMDCRrs> {
        RETRIG_W::new(self, 4)
    }
    ///Bit 5 - Half mode enable
    #[inline(always)]
    #[must_use]
    pub fn half(&mut self) -> HALF_W<TIMDCRrs> {
        HALF_W::new(self, 5)
    }
    ///Bit 6 - Push-Pull mode enable
    #[inline(always)]
    #[must_use]
    pub fn pshpll(&mut self) -> PSHPLL_W<TIMDCRrs> {
        PSHPLL_W::new(self, 6)
    }
    ///Bits 7:8 - Interleaved mode
    #[inline(always)]
    #[must_use]
    pub fn intlvd(&mut self) -> INTLVD_W<TIMDCRrs> {
        INTLVD_W::new(self, 7)
    }
    ///Bit 9 - Re-Synchronized Update
    #[inline(always)]
    #[must_use]
    pub fn rsyncu(&mut self) -> RSYNCU_W<TIMDCRrs> {
        RSYNCU_W::new(self, 9)
    }
    ///Bit 10 - Synchronization Resets Timer x
    #[inline(always)]
    #[must_use]
    pub fn syncrstx(&mut self) -> SYNCRSTX_W<TIMDCRrs> {
        SYNCRSTX_W::new(self, 10)
    }
    ///Bit 11 - Synchronization Starts Timer x
    #[inline(always)]
    #[must_use]
    pub fn syncstrtx(&mut self) -> SYNCSTRTX_W<TIMDCRrs> {
        SYNCSTRTX_W::new(self, 11)
    }
    ///Bits 12:13 - Delayed CMP2 mode
    #[inline(always)]
    #[must_use]
    pub fn delcmp2(&mut self) -> DELCMP2_W<TIMDCRrs> {
        DELCMP2_W::new(self, 12)
    }
    ///Bits 14:15 - Delayed CMP4 mode
    #[inline(always)]
    #[must_use]
    pub fn delcmp4(&mut self) -> DELCMP4_W<TIMDCRrs> {
        DELCMP4_W::new(self, 14)
    }
    ///Bit 16 - TFU
    #[inline(always)]
    #[must_use]
    pub fn tfu(&mut self) -> TFU_W<TIMDCRrs> {
        TFU_W::new(self, 16)
    }
    ///Bit 17 - Timer x Repetition update
    #[inline(always)]
    #[must_use]
    pub fn tx_repu(&mut self) -> TX_REPU_W<TIMDCRrs> {
        TX_REPU_W::new(self, 17)
    }
    ///Bit 18 - Timerx reset update
    #[inline(always)]
    #[must_use]
    pub fn tx_rstu(&mut self) -> TX_RSTU_W<TIMDCRrs> {
        TX_RSTU_W::new(self, 18)
    }
    ///Bit 19 - TAU
    #[inline(always)]
    #[must_use]
    pub fn tau(&mut self) -> TAU_W<TIMDCRrs> {
        TAU_W::new(self, 19)
    }
    ///Bit 20 - TBU
    #[inline(always)]
    #[must_use]
    pub fn tbu(&mut self) -> TBU_W<TIMDCRrs> {
        TBU_W::new(self, 20)
    }
    ///Bit 21 - TCU
    #[inline(always)]
    #[must_use]
    pub fn tcu(&mut self) -> TCU_W<TIMDCRrs> {
        TCU_W::new(self, 21)
    }
    ///Bit 23 - TEU
    #[inline(always)]
    #[must_use]
    pub fn teu(&mut self) -> TEU_W<TIMDCRrs> {
        TEU_W::new(self, 23)
    }
    ///Bit 24 - Master Timer update
    #[inline(always)]
    #[must_use]
    pub fn mstu(&mut self) -> MSTU_W<TIMDCRrs> {
        MSTU_W::new(self, 24)
    }
    ///Bits 25:26 - AC Synchronization
    #[inline(always)]
    #[must_use]
    pub fn dacsync(&mut self) -> DACSYNC_W<TIMDCRrs> {
        DACSYNC_W::new(self, 25)
    }
    ///Bit 27 - Preload enable
    #[inline(always)]
    #[must_use]
    pub fn preen(&mut self) -> PREEN_W<TIMDCRrs> {
        PREEN_W::new(self, 27)
    }
    ///Bits 28:31 - Update Gating
    #[inline(always)]
    #[must_use]
    pub fn updgat(&mut self) -> UPDGAT_W<TIMDCRrs> {
