#[doc = "Reader of register TIMDCR"]
pub type R = crate::R<u32, super::TIMDCR>;
#[doc = "Writer for register TIMDCR"]
pub type W = crate::W<u32, super::TIMDCR>;
#[doc = "Register TIMDCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMDCR {
    type Type = u32;
    #[inline(always)]
...
pub type TEU_R = crate::R<bool, bool>;
...
#[doc = "Reader of field `TFU`"]
pub type TFU_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TFU`"]
pub struct TFU_W<'a> {
    w: &'a mut W,
}
impl<'a> TFU_W<'a> {
