///Register `TIMDCR2` reader
pub type R = crate::R<TIMDCR2rs>;
///Register `TIMDCR2` writer
pub type W = crate::W<TIMDCR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcde(&mut self) -> DCDE_W<TIMDCR2rs> {
        DCDE_W::new(self, 0)
    }
    ///Bit 1 - Dual Channel DAC Step trigger
    #[inline(always)]
    #[must_use]
    pub fn dcds(&mut self) -> DCDS_W<TIMDCR2rs> {
        DCDS_W::new(self, 1)
    }
    ///Bit 2 - Dual Channel DAC Reset trigger
    #[inline(always)]
    #[must_use]
    pub fn dcdr(&mut self) -> DCDR_W<TIMDCR2rs> {
        DCDR_W::new(self, 2)
    }
    ///Bit 4 - Up-Down Mode
    #[inline(always)]
    #[must_use]
    pub fn udm(&mut self) -> UDM_W<TIMDCR2rs> {
        UDM_W::new(self, 4)
    }
    ///Bits 6:7 - Roll-Over Mode
    #[inline(always)]
    #[must_use]
    pub fn rom(&mut self) -> ROM_W<TIMDCR2rs> {
        ROM_W::new(self, 6)
    }
    ///Bits 8:9 - Output Roll-Over Mode
    #[inline(always)]
    #[must_use]
    pub fn outrom(&mut self) -> OUTROM_W<TIMDCR2rs> {
        OUTROM_W::new(self, 8)
    }
    ///Bits 10:11 - ADC Roll-Over Mode
    #[inline(always)]
    #[must_use]
    pub fn adrom(&mut self) -> ADROM_W<TIMDCR2rs> {
        ADROM_W::new(self, 10)
    }
    ///Bits 12:13 - Burst Mode Roll-Over Mode
    #[inline(always)]
    #[must_use]
    pub fn bmrom(&mut self) -> BMROM_W<TIMDCR2rs> {
        BMROM_W::new(self, 12)
    }
    ///Bits 14:15 - Fault and Event Roll-Over Mode
    #[inline(always)]
    #[must_use]
    pub fn ferom(&mut self) -> FEROM_W<TIMDCR2rs> {
        FEROM_W::new(self, 14)
    }
    ///Bit 16 - Greater than Compare 1 PWM mode
    #[inline(always)]
    #[must_use]
    pub fn gtcmp1(&mut self) -> GTCMP1_W<TIMDCR2rs> {
        GTCMP1_W::new(self, 16)
    }
    ///Bit 17 - Greater than Compare 3 PWM mode
    #[inline(always)]
    #[must_use]
    pub fn gtcmp3(&mut self) -> GTCMP3_W<TIMDCR2rs> {
        GTCMP3_W::new(self, 17)
    }
    ///Bit 20 - Triggered-half mode
    #[inline(always)]
    #[must_use]
    pub fn trghlf(&mut self) -> TRGHLF_W<TIMDCR2rs> {
        TRGHLF_W::new(self, 20)
    }
}
/**HRTIM Timerx Control Register 2

You can [`read`](crate::Reg::read) this register and get [`timdcr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timdcr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMD:TIMDCR2)*/
pub struct TIMDCR2rs;
impl crate::RegisterSpec for TIMDCR2rs {
    type Ux = u32;
}
///`read()` method returns [`timdcr2::R`](R) reader structure
impl crate::Readable for TIMDCR2rs {}
///`write(|w| ..)` method takes [`timdcr2::W`](W) writer structure
impl crate::Writable for TIMDCR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMDCR2 to value 0
impl crate::Resettable for TIMDCR2rs {
