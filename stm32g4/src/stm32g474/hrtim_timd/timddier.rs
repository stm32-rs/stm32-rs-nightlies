///Register `TIMDDIER` reader
pub type R = crate::R<TIMDDIERrs>;
///Register `TIMDDIER` writer
pub type W = crate::W<TIMDDIERrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1ie(&mut self) -> CMP1IE_W<TIMDDIERrs> {
        CMP1IE_W::new(self, 0)
    }
    ///Bit 1 - CMP2IE
    #[inline(always)]
    #[must_use]
    pub fn cmp2ie(&mut self) -> CMP2IE_W<TIMDDIERrs> {
        CMP2IE_W::new(self, 1)
    }
    ///Bit 2 - CMP3IE
    #[inline(always)]
    #[must_use]
    pub fn cmp3ie(&mut self) -> CMP3IE_W<TIMDDIERrs> {
        CMP3IE_W::new(self, 2)
    }
    ///Bit 3 - CMP4IE
    #[inline(always)]
    #[must_use]
    pub fn cmp4ie(&mut self) -> CMP4IE_W<TIMDDIERrs> {
        CMP4IE_W::new(self, 3)
    }
    ///Bit 4 - REPIE
    #[inline(always)]
    #[must_use]
    pub fn repie(&mut self) -> REPIE_W<TIMDDIERrs> {
        REPIE_W::new(self, 4)
    }
    ///Bit 6 - UPDIE
    #[inline(always)]
    #[must_use]
    pub fn updie(&mut self) -> UPDIE_W<TIMDDIERrs> {
        UPDIE_W::new(self, 6)
    }
    ///Bit 7 - CPT1IE
    #[inline(always)]
    #[must_use]
    pub fn cpt1ie(&mut self) -> CPT1IE_W<TIMDDIERrs> {
        CPT1IE_W::new(self, 7)
    }
    ///Bit 8 - CPT2IE
    #[inline(always)]
    #[must_use]
    pub fn cpt2ie(&mut self) -> CPT2IE_W<TIMDDIERrs> {
        CPT2IE_W::new(self, 8)
    }
    ///Bit 9 - SET1xIE
    #[inline(always)]
    #[must_use]
    pub fn set1x_ie(&mut self) -> SET1X_IE_W<TIMDDIERrs> {
        SET1X_IE_W::new(self, 9)
    }
    ///Bit 10 - RSTx1IE
    #[inline(always)]
    #[must_use]
    pub fn rstx1ie(&mut self) -> RSTX1IE_W<TIMDDIERrs> {
        RSTX1IE_W::new(self, 10)
    }
    ///Bit 11 - SETx2IE
    #[inline(always)]
    #[must_use]
    pub fn setx2ie(&mut self) -> SETX2IE_W<TIMDDIERrs> {
        SETX2IE_W::new(self, 11)
    }
    ///Bit 12 - RSTx2IE
    #[inline(always)]
    #[must_use]
    pub fn rstx2ie(&mut self) -> RSTX2IE_W<TIMDDIERrs> {
        RSTX2IE_W::new(self, 12)
    }
    ///Bit 13 - RSTIE
    #[inline(always)]
    #[must_use]
    pub fn rstie(&mut self) -> RSTIE_W<TIMDDIERrs> {
        RSTIE_W::new(self, 13)
    }
    ///Bit 14 - DLYPRTIE
    #[inline(always)]
    #[must_use]
    pub fn dlyprtie(&mut self) -> DLYPRTIE_W<TIMDDIERrs> {
        DLYPRTIE_W::new(self, 14)
    }
    ///Bit 16 - CMP1DE
    #[inline(always)]
    #[must_use]
    pub fn cmp1de(&mut self) -> CMP1DE_W<TIMDDIERrs> {
        CMP1DE_W::new(self, 16)
    }
    ///Bit 17 - CMP2DE
    #[inline(always)]
    #[must_use]
    pub fn cmp2de(&mut self) -> CMP2DE_W<TIMDDIERrs> {
        CMP2DE_W::new(self, 17)
    }
    ///Bit 18 - CMP3DE
    #[inline(always)]
    #[must_use]
    pub fn cmp3de(&mut self) -> CMP3DE_W<TIMDDIERrs> {
        CMP3DE_W::new(self, 18)
    }
    ///Bit 19 - CMP4DE
    #[inline(always)]
    #[must_use]
    pub fn cmp4de(&mut self) -> CMP4DE_W<TIMDDIERrs> {
        CMP4DE_W::new(self, 19)
    }
    ///Bit 20 - REPDE
    #[inline(always)]
    #[must_use]
    pub fn repde(&mut self) -> REPDE_W<TIMDDIERrs> {
        REPDE_W::new(self, 20)
    }
    ///Bit 22 - UPDDE
    #[inline(always)]
    #[must_use]
    pub fn updde(&mut self) -> UPDDE_W<TIMDDIERrs> {
        UPDDE_W::new(self, 22)
    }
    ///Bit 23 - CPT1DE
    #[inline(always)]
    #[must_use]
    pub fn cpt1de(&mut self) -> CPT1DE_W<TIMDDIERrs> {
        CPT1DE_W::new(self, 23)
    }
    ///Bit 24 - CPT2DE
    #[inline(always)]
    #[must_use]
    pub fn cpt2de(&mut self) -> CPT2DE_W<TIMDDIERrs> {
        CPT2DE_W::new(self, 24)
    }
    ///Bit 25 - SET1xDE
    #[inline(always)]
    #[must_use]
    pub fn set1x_de(&mut self) -> SET1X_DE_W<TIMDDIERrs> {
        SET1X_DE_W::new(self, 25)
    }
    ///Bit 26 - RSTx1DE
    #[inline(always)]
    #[must_use]
    pub fn rstx1de(&mut self) -> RSTX1DE_W<TIMDDIERrs> {
        RSTX1DE_W::new(self, 26)
    }
    ///Bit 27 - SETx2DE
    #[inline(always)]
    #[must_use]
    pub fn setx2de(&mut self) -> SETX2DE_W<TIMDDIERrs> {
        SETX2DE_W::new(self, 27)
    }
    ///Bit 28 - RSTx2DE
    #[inline(always)]
    #[must_use]
    pub fn rstx2de(&mut self) -> RSTX2DE_W<TIMDDIERrs> {
        RSTX2DE_W::new(self, 28)
    }
    ///Bit 29 - RSTDE
    #[inline(always)]
    #[must_use]
    pub fn rstde(&mut self) -> RSTDE_W<TIMDDIERrs> {
        RSTDE_W::new(self, 29)
    }
    ///Bit 30 - DLYPRTDE
    #[inline(always)]
    #[must_use]
    pub fn dlyprtde(&mut self) -> DLYPRTDE_W<TIMDDIERrs> {
        DLYPRTDE_W::new(self, 30)
    }
}
/**TIMxDIER

You can [`read`](crate::Reg::read) this register and get [`timddier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timddier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMD:TIMDDIER)*/
pub struct TIMDDIERrs;
impl crate::RegisterSpec for TIMDDIERrs {
    type Ux = u32;
}
///`read()` method returns [`timddier::R`](R) reader structure
impl crate::Readable for TIMDDIERrs {}
///`write(|w| ..)` method takes [`timddier::W`](W) writer structure
impl crate::Writable for TIMDDIERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMDDIER to value 0
impl crate::Resettable for TIMDDIERrs {
