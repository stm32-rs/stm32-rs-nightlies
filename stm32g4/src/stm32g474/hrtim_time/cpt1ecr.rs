...
pub struct TFCMP2_R(crate::FieldReader<bool, bool>);
impl TFCMP2_R {
    pub(crate) fn new(bits: bool) -> Self {
        TFCMP2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TFCMP2_R {
...
pub struct TFCMP1_R(crate::FieldReader<bool, bool>);
impl TFCMP1_R {
    pub(crate) fn new(bits: bool) -> Self {
        TFCMP1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TFCMP1_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn tfcmp2(&self) -> TFCMP2_R {
        TFCMP2_R::new(((self.bits >> 31) & 0x01) != 0)
    }
    #[doc = "Bit 30 - TFCMP1"]
    #[inline(always)]
    pub fn tfcmp1(&self) -> TFCMP1_R {
        TFCMP1_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    #[doc = "Bit 29 - TF1RST"]
    #[inline(always)]
    pub fn tf1rst(&self) -> TF1RST_R {
        TF1RST_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    #[doc = "Bit 28 - TF1SET"]
    #[inline(always)]
    pub fn tf1set(&self) -> TF1SET_R {
        TF1SET_R::new(((self.bits >> 28) & 0x01) != 0)
    }
