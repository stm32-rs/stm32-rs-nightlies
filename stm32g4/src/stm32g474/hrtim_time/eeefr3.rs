...
pub type R = crate::R<EEEFR3rs>;
///Register `EEEFR3` writer
pub type W = crate::W<EEEFR3rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eevace(&mut self) -> EEVACE_W<EEEFR3rs> {
        EEVACE_W::new(self, 0)
    }
    ///Bit 1 - External Event A Counter Reset
    #[inline(always)]
    #[must_use]
    pub fn eevacres(&mut self) -> EEVACRES_W<EEEFR3rs> {
        EEVACRES_W::new(self, 1)
    }
    ///Bit 2 - External Event A Reset Mode
    #[inline(always)]
    #[must_use]
    pub fn eevarstm(&mut self) -> EEVARSTM_W<EEEFR3rs> {
        EEVARSTM_W::new(self, 2)
    }
    ///Bits 4:7 - External Event A Selection
    #[inline(always)]
    #[must_use]
    pub fn eevasel(&mut self) -> EEVASEL_W<EEEFR3rs> {
        EEVASEL_W::new(self, 4)
    }
    ///Bits 8:13 - External Event A counter
    #[inline(always)]
    #[must_use]
    pub fn eevacnt(&mut self) -> EEVACNT_W<EEEFR3rs> {
        EEVACNT_W::new(self, 8)
    }
}
/**HRTIM Timerx External Event Filtering Register 3

You can [`read`](crate::Reg::read) this register and get [`eeefr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eeefr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIME:EEEFR3)*/
pub struct EEEFR3rs;
impl crate::RegisterSpec for EEEFR3rs {
    type Ux = u32;
}
///`read()` method returns [`eeefr3::R`](R) reader structure
impl crate::Readable for EEEFR3rs {}
///`write(|w| ..)` method takes [`eeefr3::W`](W) writer structure
impl crate::Writable for EEEFR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EEEFR3 to value 0
impl crate::Resettable for EEEFR3rs {
