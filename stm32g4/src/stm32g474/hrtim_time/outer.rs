#[doc = "Reader of register OUTER"]
pub type R = crate::R<u32, super::OUTER>;
#[doc = "Writer for register OUTER"]
pub type W = crate::W<u32, super::OUTER>;
#[doc = "Register OUTER `reset()`'s with value 0"]
impl crate::ResetValue for super::OUTER {
    type Type = u32;
    #[inline(always)]
