...
impl W {
    ...
    ///Bit 12 - Timer A Compare 4
    #[inline(always)]
    pub fn timacmp4(&mut self) -> TIMACMP4_W<RST1Rrs> {
    ...
    ///Bit 15 - Timer C Compare 1
    #[inline(always)]
    pub fn timccmp1(&mut self) -> TIMCCMP1_W<RST1Rrs> {
    ...
    ///Bit 19 - Timer F Compare 3
    #[inline(always)]
    pub fn timfcmp3(&mut self) -> TIMFCMP3_W<RST1Rrs> {
        TIMFCMP3_W::new(self, 19)
    }
    ///Bit 20 - Timer F Compare 4
    #[inline(always)]
    pub fn timfcmp4(&mut self) -> TIMFCMP4_W<RST1Rrs> {
