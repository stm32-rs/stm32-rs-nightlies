...
pub use TIMFCMP1_R as TIMACMP1_R;
///Field `TIMACMP2` reader - Timer A Compare 2
pub use TIMFCMP1_R as TIMACMP2_R;
///Field `TIMACMP4` reader - Timer A Compare 4
pub use TIMFCMP1_R as TIMACMP4_R;
...
pub use TIMFCMP1_W as TIMACMP1_W;
///Field `TIMACMP2` writer - Timer A Compare 2
pub use TIMFCMP1_W as TIMACMP2_W;
///Field `TIMACMP4` writer - Timer A Compare 4
pub use TIMFCMP1_W as TIMACMP4_W;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIME:RSTR)*/
pub struct RSTRrs;
