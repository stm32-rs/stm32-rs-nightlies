...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ck_pscx(&mut self) -> CK_PSCX_W<TIMECRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn intlvd(&mut self) -> INTLVD_W<TIMECRrs> {
        INTLVD_W::new(self, 7)
    }
    ///Bit 9 - Re-Synchronized Update
    #[inline(always)]
    #[must_use]
    pub fn rsyncu(&mut self) -> RSYNCU_W<TIMECRrs> {
        RSYNCU_W::new(self, 9)
    }
    ///Bit 10 - Synchronization Resets Timer x
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfu(&mut self) -> TFU_W<TIMECRrs> {
        TFU_W::new(self, 16)
    }
    ///Bit 17 - Timer x Repetition update
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tau(&mut self) -> TAU_W<TIMECRrs> {
        TAU_W::new(self, 19)
    }
    ///Bit 20 - TBU
    #[inline(always)]
