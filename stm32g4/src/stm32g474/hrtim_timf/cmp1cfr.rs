///Register `CMP1CFR` reader
pub type R = crate::R<CMP1CFRrs>;
///Register `CMP1CFR` writer
...
You can [`read`](crate::Reg::read) this register and get [`cmp1cfr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmp1cfr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMF:CMP1CFR)*/
pub struct CMP1CFRrs;
impl crate::RegisterSpec for CMP1CFRrs {
    type Ux = u32;
}
///`read()` method returns [`cmp1cfr::R`](R) reader structure
impl crate::Readable for CMP1CFRrs {}
///`write(|w| ..)` method takes [`cmp1cfr::W`](W) writer structure
impl crate::Writable for CMP1CFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CMP1CFR to value 0
