#[doc = "Reader of register CMP1CFR"]
pub type R = crate::R<u32, super::CMP1CFR>;
#[doc = "Writer for register CMP1CFR"]
pub type W = crate::W<u32, super::CMP1CFR>;
#[doc = "Register CMP1CFR `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP1CFR {
    type Type = u32;
    #[inline(always)]
