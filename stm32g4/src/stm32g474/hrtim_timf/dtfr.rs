#[doc = "Reader of register DTFR"]
pub type R = crate::R<u32, super::DTFR>;
#[doc = "Writer for register DTFR"]
pub type W = crate::W<u32, super::DTFR>;
#[doc = "Register DTFR `reset()`'s with value 0"]
impl crate::ResetValue for super::DTFR {
    type Type = u32;
    #[inline(always)]
