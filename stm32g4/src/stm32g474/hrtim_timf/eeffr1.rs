///Register `EEFFR1` reader
pub type R = crate::R<EEFFR1rs>;
///Register `EEFFR1` writer
pub type W = crate::W<EEFFR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee1ltch(&mut self) -> EE1LTCH_W<EEFFR1rs> {
        EE1LTCH_W::new(self, 0)
    }
    ///Bits 1:4 - External Event 1 filter
    #[inline(always)]
    #[must_use]
    pub fn ee1fltr(&mut self) -> EE1FLTR_W<EEFFR1rs> {
        EE1FLTR_W::new(self, 1)
    }
    ///Bit 6 - External Event 2 latch
    #[inline(always)]
    #[must_use]
    pub fn ee2ltch(&mut self) -> EE2LTCH_W<EEFFR1rs> {
        EE2LTCH_W::new(self, 6)
    }
    ///Bits 7:10 - External Event 2 filter
    #[inline(always)]
    #[must_use]
    pub fn ee2fltr(&mut self) -> EE2FLTR_W<EEFFR1rs> {
        EE2FLTR_W::new(self, 7)
    }
    ///Bit 12 - External Event 3 latch
    #[inline(always)]
    #[must_use]
    pub fn ee3ltch(&mut self) -> EE3LTCH_W<EEFFR1rs> {
        EE3LTCH_W::new(self, 12)
    }
    ///Bits 13:16 - External Event 3 filter
    #[inline(always)]
    #[must_use]
    pub fn ee3fltr(&mut self) -> EE3FLTR_W<EEFFR1rs> {
        EE3FLTR_W::new(self, 13)
    }
    ///Bit 18 - External Event 4 latch
    #[inline(always)]
    #[must_use]
    pub fn ee4ltch(&mut self) -> EE4LTCH_W<EEFFR1rs> {
        EE4LTCH_W::new(self, 18)
    }
    ///Bits 19:22 - External Event 4 filter
    #[inline(always)]
    #[must_use]
    pub fn ee4fltr(&mut self) -> EE4FLTR_W<EEFFR1rs> {
        EE4FLTR_W::new(self, 19)
    }
    ///Bit 24 - External Event 5 latch
    #[inline(always)]
    #[must_use]
    pub fn ee5ltch(&mut self) -> EE5LTCH_W<EEFFR1rs> {
        EE5LTCH_W::new(self, 24)
    }
    ///Bits 25:28 - External Event 5 filter
    #[inline(always)]
    #[must_use]
    pub fn ee5fltr(&mut self) -> EE5FLTR_W<EEFFR1rs> {
        EE5FLTR_W::new(self, 25)
    }
}
/**Timerx External Event Filtering Register 1

You can [`read`](crate::Reg::read) this register and get [`eeffr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eeffr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMF:EEFFR1)*/
pub struct EEFFR1rs;
impl crate::RegisterSpec for EEFFR1rs {
    type Ux = u32;
}
///`read()` method returns [`eeffr1::R`](R) reader structure
impl crate::Readable for EEFFR1rs {}
///`write(|w| ..)` method takes [`eeffr1::W`](W) writer structure
impl crate::Writable for EEFFR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EEFFR1 to value 0
impl crate::Resettable for EEFFR1rs {
