///Register `FEEFR3` reader
pub type R = crate::R<FEEFR3rs>;
///Register `FEEFR3` writer
...
You can [`read`](crate::Reg::read) this register and get [`feefr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`feefr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMF:FEEFR3)*/
pub struct FEEFR3rs;
impl crate::RegisterSpec for FEEFR3rs {
    type Ux = u32;
}
///`read()` method returns [`feefr3::R`](R) reader structure
impl crate::Readable for FEEFR3rs {}
///`write(|w| ..)` method takes [`feefr3::W`](W) writer structure
impl crate::Writable for FEEFR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FEEFR3 to value 0
