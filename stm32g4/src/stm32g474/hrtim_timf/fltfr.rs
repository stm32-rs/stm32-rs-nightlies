...
pub type R = crate::R<FLTFRrs>;
///Register `FLTFR` writer
pub type W = crate::W<FLTFRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flt1en(&mut self) -> FLT1EN_W<FLTFRrs> {
        FLT1EN_W::new(self, 0)
    }
    ///Bit 1 - Fault 2 enable
    #[inline(always)]
    #[must_use]
    pub fn flt2en(&mut self) -> FLT2EN_W<FLTFRrs> {
        FLT2EN_W::new(self, 1)
    }
    ///Bit 2 - Fault 3 enable
    #[inline(always)]
    #[must_use]
    pub fn flt3en(&mut self) -> FLT3EN_W<FLTFRrs> {
        FLT3EN_W::new(self, 2)
    }
    ///Bit 3 - Fault 4 enable
    #[inline(always)]
    #[must_use]
    pub fn flt4en(&mut self) -> FLT4EN_W<FLTFRrs> {
        FLT4EN_W::new(self, 3)
    }
    ///Bit 4 - Fault 5 enable
    #[inline(always)]
    #[must_use]
    pub fn flt5en(&mut self) -> FLT5EN_W<FLTFRrs> {
        FLT5EN_W::new(self, 4)
    }
    ///Bit 5 - Fault 6 enable
    #[inline(always)]
    #[must_use]
    pub fn flt6en(&mut self) -> FLT6EN_W<FLTFRrs> {
        FLT6EN_W::new(self, 5)
    }
    ///Bit 31 - Fault sources Lock
    #[inline(always)]
    #[must_use]
    pub fn fltlck(&mut self) -> FLTLCK_W<FLTFRrs> {
        FLTLCK_W::new(self, 31)
    }
}
/**Timerx Fault Register

You can [`read`](crate::Reg::read) this register and get [`fltfr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fltfr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMF:FLTFR)*/
pub struct FLTFRrs;
impl crate::RegisterSpec for FLTFRrs {
    type Ux = u32;
}
///`read()` method returns [`fltfr::R`](R) reader structure
impl crate::Readable for FLTFRrs {}
///`write(|w| ..)` method takes [`fltfr::W`](W) writer structure
impl crate::Writable for FLTFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FLTFR to value 0
impl crate::Resettable for FLTFRrs {
