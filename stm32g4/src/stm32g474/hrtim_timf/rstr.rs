...
impl From<TIMECMP1> for bool {
    #[inline(always)]
    fn from(variant: TIMECMP1) -> Self {
        variant as u8 != 0
    }
}
///Field `TIMECMP1` reader - Timer A Update reset
pub type TIMECMP1_R = crate::BitReader<TIMECMP1>;
impl TIMECMP1_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TIMECMP1 {
        match self.bits {
            false => TIMECMP1::NoEffect,
            true => TIMECMP1::ResetCounter,
        }
    }
    ///Timer Y compare Z event has no effect
    #[inline(always)]
    pub fn is_no_effect(&self) -> bool {
        *self == TIMECMP1::NoEffect
    }
    ///Timer X counter is reset upon timer Y compare Z event
    #[inline(always)]
    pub fn is_reset_counter(&self) -> bool {
        *self == TIMECMP1::ResetCounter
    }
}
///Field `TIMECMP1` writer - Timer A Update reset
pub type TIMECMP1_W<'a, REG> = crate::BitWriter<'a, REG, TIMECMP1>;
impl<'a, REG> TIMECMP1_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(TIMECMP1::NoEffect)
    }
    ///Timer X counter is reset upon timer Y compare Z event
    #[inline(always)]
    pub fn reset_counter(self) -> &'a mut crate::W<REG> {
        self.variant(TIMECMP1::ResetCounter)
    }
}
/**Timer A Update reset
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMF:RSTR)*/
pub struct RSTRrs;
