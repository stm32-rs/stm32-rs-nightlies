...
///Timer A compare %s
pub use crate::stm32g474::hrtim_tima::set1r::CMP1;
///Field `CMP(1-4)` reader - Timer A compare %s
pub use crate::stm32g474::hrtim_tima::set1r::CMP_R;
///Field `CMP(1-4)` writer - Timer A compare %s
pub use crate::stm32g474::hrtim_tima::set1r::CMP_W;
///External Event %s
pub use crate::stm32g474::hrtim_tima::set1r::EXTEVNT1;
///Field `EXTEVNT(1-10)` reader - External Event %s
pub use crate::stm32g474::hrtim_tima::set1r::EXTEVNT_R;
///Field `EXTEVNT(1-10)` writer - External Event %s
pub use crate::stm32g474::hrtim_tima::set1r::EXTEVNT_W;
///Master Compare %s
pub use crate::stm32g474::hrtim_tima::set1r::MSTCMP1;
///Field `MSTCMP(1-4)` reader - Master Compare %s
pub use crate::stm32g474::hrtim_tima::set1r::MSTCMP_R;
///Field `MSTCMP(1-4)` writer - Master Compare %s
pub use crate::stm32g474::hrtim_tima::set1r::MSTCMP_W;
///Master Period
pub use crate::stm32g474::hrtim_tima::set1r::MSTPER;
///Field `MSTPER` reader - Master Period
pub use crate::stm32g474::hrtim_tima::set1r::MSTPER_R;
///Field `MSTPER` writer - Master Period
pub use crate::stm32g474::hrtim_tima::set1r::MSTPER_W;
///Timer A Period
pub use crate::stm32g474::hrtim_tima::set1r::PER;
///Field `PER` reader - Timer A Period
pub use crate::stm32g474::hrtim_tima::set1r::PER_R;
///Field `PER` writer - Timer A Period
pub use crate::stm32g474::hrtim_tima::set1r::PER_W;
///Timer A resynchronizaton
pub use crate::stm32g474::hrtim_tima::set1r::RESYNC;
///Field `RESYNC` reader - Timer A resynchronizaton
pub use crate::stm32g474::hrtim_tima::set1r::RESYNC_R;
///Field `RESYNC` writer - Timer A resynchronizaton
pub use crate::stm32g474::hrtim_tima::set1r::RESYNC_W;
///Software Set trigger
pub use crate::stm32g474::hrtim_tima::set1r::SST;
///Field `SST` reader - Software Set trigger
pub use crate::stm32g474::hrtim_tima::set1r::SST_R;
///Field `SST` writer - Software Set trigger
pub use crate::stm32g474::hrtim_tima::set1r::SST_W;
///Timer A Compare 3
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1;
///Field `TIMACMP3` reader - Timer A Compare 3
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_R as TIMACMP3_R;
///Field `TIMBCMP1` reader - Timer B Compare 1
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_R;
///Field `TIMBCMP4` reader - Timer B Compare 4
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_R as TIMBCMP4_R;
///Field `TIMCCMP1` reader - Timer C Compare 1
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_R as TIMCCMP1_R;
///Field `TIMCCMP4` reader - Timer C Compare 4
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_R as TIMCCMP4_R;
///Field `TIMDCMP3` reader - Timer D Compare 3
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_R as TIMDCMP3_R;
///Field `TIMDCMP4` reader - Timer D Compare 4
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_R as TIMDCMP4_R;
///Field `TIMECMP2` reader - Timer E Compare 2
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_R as TIMECMP2_R;
///Field `TIMECMP3` reader - Timer E Compare 3
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_R as TIMECMP3_R;
///Field `TIMACMP3` writer - Timer A Compare 3
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_W as TIMACMP3_W;
///Field `TIMBCMP1` writer - Timer B Compare 1
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_W;
///Field `TIMBCMP4` writer - Timer B Compare 4
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_W as TIMBCMP4_W;
///Field `TIMCCMP1` writer - Timer C Compare 1
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_W as TIMCCMP1_W;
///Field `TIMCCMP4` writer - Timer C Compare 4
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_W as TIMCCMP4_W;
///Field `TIMDCMP3` writer - Timer D Compare 3
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_W as TIMDCMP3_W;
///Field `TIMDCMP4` writer - Timer D Compare 4
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_W as TIMDCMP4_W;
///Field `TIMECMP2` writer - Timer E Compare 2
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_W as TIMECMP2_W;
///Field `TIMECMP3` writer - Timer E Compare 3
pub use crate::stm32g474::hrtim_tima::set1r::TIMBCMP1_W as TIMECMP3_W;
///Registers update (transfer preload to active)
pub use crate::stm32g474::hrtim_tima::set1r::UPDATE;
///Field `UPDATE` reader - Registers update (transfer preload to active)
pub use crate::stm32g474::hrtim_tima::set1r::UPDATE_R;
///Field `UPDATE` writer - Registers update (transfer preload to active)
pub use crate::stm32g474::hrtim_tima::set1r::UPDATE_W;
impl R {
    ...
    pub fn timbcmp1(&self) -> TIMBCMP1_R {
        TIMBCMP1_R::new(((self.bits >> 13) & 1) != 0)
    }
    ...
    pub fn timecmp3(&self) -> TIMECMP3_R {
        TIMECMP3_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///External Event (1-10)
    ///
...
impl W {
    ...
    ///Bit 13 - Timer B Compare 1
    #[inline(always)]
    pub fn timbcmp1(&mut self) -> TIMBCMP1_W<'_, SET1Rrs> {
        TIMBCMP1_W::new(self, 13)
    }
    ///Bit 14 - Timer B Compare 4
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#HRTIM_TIMF:SET1R)*/
pub struct SET1Rrs;
