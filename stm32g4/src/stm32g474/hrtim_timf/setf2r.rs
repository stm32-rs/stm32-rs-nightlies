///Register `SETF2R` reader
pub type R = crate::R<SETF2Rrs>;
///Register `SETF2R` writer
pub type W = crate::W<SETF2Rrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sst(&mut self) -> SST_W<SETF2Rrs> {
        SST_W::new(self, 0)
    }
    ///Bit 1 - RESYNC
    #[inline(always)]
    #[must_use]
    pub fn resync(&mut self) -> RESYNC_W<SETF2Rrs> {
        RESYNC_W::new(self, 1)
    }
    ///Bit 2 - PER
    #[inline(always)]
    #[must_use]
    pub fn per(&mut self) -> PER_W<SETF2Rrs> {
        PER_W::new(self, 2)
    }
    ///Bit 3 - CMP1
    #[inline(always)]
    #[must_use]
    pub fn cmp1(&mut self) -> CMP1_W<SETF2Rrs> {
        CMP1_W::new(self, 3)
    }
    ///Bit 4 - CMP2
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> CMP2_W<SETF2Rrs> {
        CMP2_W::new(self, 4)
    }
    ///Bit 5 - CMP3
    #[inline(always)]
    #[must_use]
    pub fn cmp3(&mut self) -> CMP3_W<SETF2Rrs> {
        CMP3_W::new(self, 5)
    }
    ///Bit 6 - CMP4
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> CMP4_W<SETF2Rrs> {
        CMP4_W::new(self, 6)
    }
    ///Bit 7 - MSTPER
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MSTPER_W<SETF2Rrs> {
        MSTPER_W::new(self, 7)
    }
    ///Bit 8 - MSTCMP1
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> MSTCMP1_W<SETF2Rrs> {
        MSTCMP1_W::new(self, 8)
    }
    ///Bit 9 - MSTCMP2
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> MSTCMP2_W<SETF2Rrs> {
        MSTCMP2_W::new(self, 9)
    }
    ///Bit 10 - MSTCMP3
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> MSTCMP3_W<SETF2Rrs> {
        MSTCMP3_W::new(self, 10)
    }
    ///Bit 11 - MSTCMP4
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> MSTCMP4_W<SETF2Rrs> {
        MSTCMP4_W::new(self, 11)
    }
    ///Bit 12 - TIMEVNT1
    #[inline(always)]
    #[must_use]
    pub fn timevnt1(&mut self) -> TIMEVNT1_W<SETF2Rrs> {
        TIMEVNT1_W::new(self, 12)
    }
    ///Bit 13 - TIMEVNT2
    #[inline(always)]
    #[must_use]
    pub fn timevnt2(&mut self) -> TIMEVNT2_W<SETF2Rrs> {
        TIMEVNT2_W::new(self, 13)
    }
    ///Bit 14 - TIMEVNT3
    #[inline(always)]
    #[must_use]
    pub fn timevnt3(&mut self) -> TIMEVNT3_W<SETF2Rrs> {
        TIMEVNT3_W::new(self, 14)
    }
    ///Bit 15 - TIMEVNT4
    #[inline(always)]
    #[must_use]
    pub fn timevnt4(&mut self) -> TIMEVNT4_W<SETF2Rrs> {
        TIMEVNT4_W::new(self, 15)
    }
    ///Bit 16 - TIMEVNT5
    #[inline(always)]
    #[must_use]
    pub fn timevnt5(&mut self) -> TIMEVNT5_W<SETF2Rrs> {
        TIMEVNT5_W::new(self, 16)
    }
    ///Bit 17 - TIMEVNT6
    #[inline(always)]
    #[must_use]
    pub fn timevnt6(&mut self) -> TIMEVNT6_W<SETF2Rrs> {
        TIMEVNT6_W::new(self, 17)
    }
    ///Bit 18 - TIMEVNT7
    #[inline(always)]
    #[must_use]
    pub fn timevnt7(&mut self) -> TIMEVNT7_W<SETF2Rrs> {
        TIMEVNT7_W::new(self, 18)
    }
    ///Bit 19 - TIMEVNT8
    #[inline(always)]
    #[must_use]
    pub fn timevnt8(&mut self) -> TIMEVNT8_W<SETF2Rrs> {
        TIMEVNT8_W::new(self, 19)
    }
    ///Bit 20 - TIMEVNT9
    #[inline(always)]
    #[must_use]
    pub fn timevnt9(&mut self) -> TIMEVNT9_W<SETF2Rrs> {
        TIMEVNT9_W::new(self, 20)
    }
    ///Bit 21 - EXTEVNT1
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> EXTEVNT1_W<SETF2Rrs> {
        EXTEVNT1_W::new(self, 21)
    }
    ///Bit 22 - EXTEVNT2
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> EXTEVNT2_W<SETF2Rrs> {
        EXTEVNT2_W::new(self, 22)
    }
    ///Bit 23 - EXTEVNT3
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> EXTEVNT3_W<SETF2Rrs> {
        EXTEVNT3_W::new(self, 23)
    }
    ///Bit 24 - EXTEVNT4
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> EXTEVNT4_W<SETF2Rrs> {
        EXTEVNT4_W::new(self, 24)
    }
    ///Bit 25 - EXTEVNT5
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> EXTEVNT5_W<SETF2Rrs> {
        EXTEVNT5_W::new(self, 25)
    }
    ///Bit 26 - EXTEVNT6
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> EXTEVNT6_W<SETF2Rrs> {
        EXTEVNT6_W::new(self, 26)
    }
    ///Bit 27 - EXTEVNT7
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> EXTEVNT7_W<SETF2Rrs> {
        EXTEVNT7_W::new(self, 27)
    }
    ///Bit 28 - EXTEVNT8
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> EXTEVNT8_W<SETF2Rrs> {
        EXTEVNT8_W::new(self, 28)
    }
    ///Bit 29 - EXTEVNT9
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> EXTEVNT9_W<SETF2Rrs> {
        EXTEVNT9_W::new(self, 29)
    }
    ///Bit 30 - EXTEVNT10
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> EXTEVNT10_W<SETF2Rrs> {
        EXTEVNT10_W::new(self, 30)
    }
    ///Bit 31 - UPDATE
    #[inline(always)]
    #[must_use]
    pub fn update(&mut self) -> UPDATE_W<SETF2Rrs> {
        UPDATE_W::new(self, 31)
    }
}
/**Timerx Output2 Set Register

You can [`read`](crate::Reg::read) this register and get [`setf2r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`setf2r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMF:SETF2R)*/
pub struct SETF2Rrs;
impl crate::RegisterSpec for SETF2Rrs {
    type Ux = u32;
}
///`read()` method returns [`setf2r::R`](R) reader structure
impl crate::Readable for SETF2Rrs {}
///`write(|w| ..)` method takes [`setf2r::W`](W) writer structure
impl crate::Writable for SETF2Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SETF2R to value 0
impl crate::Resettable for SETF2Rrs {
