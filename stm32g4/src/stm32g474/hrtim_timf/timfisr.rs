///Register `TIMFISR` reader
pub type R = crate::R<TIMFISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`timfisr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#HRTIM_TIMF:TIMFISR)*/
pub struct TIMFISRrs;
impl crate::RegisterSpec for TIMFISRrs {
    type Ux = u32;
}
///`read()` method returns [`timfisr::R`](R) reader structure
impl crate::Readable for TIMFISRrs {}
///`reset()` method sets TIMFISR to value 0
impl crate::Resettable for TIMFISRrs {
