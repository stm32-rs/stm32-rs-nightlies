...
///Field `CCMSRAMSMEN` reader - CCM SRAM interface clocks enable during Sleep and Stop modes Set and cleared by software.
pub type CCMSRAMSMEN_R = crate::BitReader;
///Field `CCMSRAMSMEN` writer - CCM SRAM interface clocks enable during Sleep and Stop modes Set and cleared by software.
pub type CCMSRAMSMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SRAM2SMEN` reader - SRAM2 interface clocks enable during Sleep and Stop modes Set and cleared by software.
pub type SRAM2SMEN_R = crate::BitReader;
///Field `SRAM2SMEN` writer - SRAM2 interface clocks enable during Sleep and Stop modes Set and cleared by software.
pub type SRAM2SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC12SMEN` reader - ADC12 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type ADC12SMEN_R = crate::BitReader;
///Field `ADC12SMEN` writer - ADC12 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type ADC12SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC345SMEN` reader - ADC345 clock enable Set and cleared by software.
pub type ADC345SMEN_R = crate::BitReader;
///Field `ADC345SMEN` writer - ADC345 clock enable Set and cleared by software.
pub type ADC345SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DAC1SMEN` reader - DAC1 clock enable Set and cleared by software.
pub type DAC1SMEN_R = crate::BitReader;
///Field `DAC1SMEN` writer - DAC1 clock enable Set and cleared by software.
pub type DAC1SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DAC2SMEN` reader - DAC2 clock enable Set and cleared by software.
pub type DAC2SMEN_R = crate::BitReader;
///Field `DAC2SMEN` writer - DAC2 clock enable Set and cleared by software.
pub type DAC2SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DAC3SMEN` reader - DAC3 clock enable Set and cleared by software.
pub type DAC3SMEN_R = crate::BitReader;
///Field `DAC3SMEN` writer - DAC3 clock enable Set and cleared by software.
pub type DAC3SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DAC4SMEN` reader - DAC4 clock enable Set and cleared by software.
pub type DAC4SMEN_R = crate::BitReader;
///Field `DAC4SMEN` writer - DAC4 clock enable Set and cleared by software.
pub type DAC4SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AESSMEN` reader - AESM clocks enable Set and cleared by software.
pub type AESSMEN_R = crate::BitReader;
///Field `AESSMEN` writer - AESM clocks enable Set and cleared by software.
pub type AESSMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RNGEN` reader - RNG enable Set and cleared by software.
pub type RNGEN_R = crate::BitReader;
///Field `RNGEN` writer - RNG enable Set and cleared by software.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#RCC:AHB2SMENR)*/
