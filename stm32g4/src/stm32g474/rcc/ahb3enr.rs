...
///Field `FMCEN` reader - Flexible static memory controller clock enable Set and cleared by software.
...
///Field `FMCEN` writer - Flexible static memory controller clock enable Set and cleared by software.
...
///Field `QSPIEN` reader - QUADSPI memory interface clock enable Set and cleared by software.
pub use FMCEN_R as QSPIEN_R;
///Field `QSPIEN` writer - QUADSPI memory interface clock enable Set and cleared by software.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#RCC:AHB3ENR)*/
