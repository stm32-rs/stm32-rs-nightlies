...
///Field `FMCSMEN` reader - Flexible static memory controller clocks enable during Sleep and Stop modes Set and cleared by software.
pub type FMCSMEN_R = crate::BitReader;
///Field `FMCSMEN` writer - Flexible static memory controller clocks enable during Sleep and Stop modes Set and cleared by software.
pub type FMCSMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `QSPISMEN` reader - QUADSPI memory interface clock enable during Sleep and Stop modes Set and cleared by software.
pub type QSPISMEN_R = crate::BitReader;
///Field `QSPISMEN` writer - QUADSPI memory interface clock enable during Sleep and Stop modes Set and cleared by software.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#RCC:AHB3SMENR)*/
