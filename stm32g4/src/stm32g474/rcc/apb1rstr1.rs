...
///Field `USBRST` reader - USBD reset
...
///Field `I2C3RST` reader - I2C3 interface reset
...
///Field `USBRST` writer - USBD reset
...
///Field `I2C3RST` writer - I2C3 interface reset
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#RCC:APB1RSTR1)*/
