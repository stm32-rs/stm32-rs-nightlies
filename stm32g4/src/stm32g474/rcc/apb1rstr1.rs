...
///Field `TIM4RST` reader - TIM3 timer reset Set and cleared by software.
pub use TIM2RST_R as TIM4RST_R;
///Field `TIM5RST` reader - TIM5 timer reset Set and cleared by software.
...
///Field `USBRST` reader - USB device reset Set and reset by software.
pub use TIM2RST_R as USBRST_R;
///Field `FDCANRST` reader - FDCAN reset Set and reset by software.
...
///Field `TIM4RST` writer - TIM3 timer reset Set and cleared by software.
pub use TIM2RST_W as TIM4RST_W;
///Field `TIM5RST` writer - TIM5 timer reset Set and cleared by software.
...
///Field `USBRST` writer - USB device reset Set and reset by software.
pub use TIM2RST_W as USBRST_W;
///Field `FDCANRST` writer - FDCAN reset Set and reset by software.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#RCC:APB1RSTR1)*/
