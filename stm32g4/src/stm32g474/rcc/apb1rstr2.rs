...
///Field `LPUART1RST` reader - Low-power UART 1 reset Set and cleared by software.
...
///Field `LPUART1RST` writer - Low-power UART 1 reset Set and cleared by software.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#RCC:APB1RSTR2)*/
