...
///Field `SPI4RST` reader - SPI 4 reset
...
///Field `TIM20RST` reader - Timer 20 reset
...
///Field `HRTIM1RST` reader - HRTIMER reset
...
///Field `SPI4RST` writer - SPI 4 reset
...
///Field `TIM20RST` writer - Timer 20 reset
...
///Field `HRTIM1RST` writer - HRTIMER reset
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474xx.html#RCC:APB2RSTR)*/
