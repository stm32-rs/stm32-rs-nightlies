...
///Field `CSSC` writer - Clock security system interrupt clear This bit is set by software to clear the CSSF flag.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G474.html#RCC:CICR)*/
pub struct CICRrs;
