...
pub struct IERRIE_R(crate::FieldReader<bool, bool>);
impl IERRIE_R {
    pub(crate) fn new(bits: bool) -> Self {
        IERRIE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IERRIE_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DIRIE_R(crate::FieldReader<bool, bool>);
impl DIRIE_R {
    pub(crate) fn new(bits: bool) -> Self {
        DIRIE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DIRIE_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct IDXIE_R(crate::FieldReader<bool, bool>);
impl IDXIE_R {
    pub(crate) fn new(bits: bool) -> Self {
        IDXIE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IDXIE_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
