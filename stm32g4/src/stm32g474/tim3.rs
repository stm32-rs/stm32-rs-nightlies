...
pub mod egr;
/**CCMR1_Input (rw) register accessor: TIM2 capture/compare mode register 1 \[alternate\]
...
/**CCMR2_Input (rw) register accessor: TIM2 capture/compare mode register 2 \[alternate\]
