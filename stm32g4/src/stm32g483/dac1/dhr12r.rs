...
///Field `DACCDHR` reader - DAC channel1 12-bit right-aligned data These bits are written by software which specifies 12-bit data for DAC channel1.
pub type DACCDHR_R = crate::FieldReader<u16>;
///Field `DACCDHR` writer - DAC channel1 12-bit right-aligned data These bits are written by software which specifies 12-bit data for DAC channel1.
...
impl W {
    ///Bits 0:11 - DAC channel1 12-bit right-aligned data These bits are written by software which specifies 12-bit data for DAC channel1.
    #[inline(always)]
    pub fn daccdhr(&mut self) -> DACCDHR_W<'_, DHR12Rrs> {
        DACCDHR_W::new(self, 0)
    }
    ///Bits 16:27 - DAC channel1 12-bit right-aligned data B
    #[inline(always)]
    pub fn dacc1dhrb(&mut self) -> DACC1DHRB_W<'_, DHR12Rrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G483.html#DAC1:DHR12R[1])*/
pub struct DHR12Rrs;
