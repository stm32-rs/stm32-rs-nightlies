...
///Mute mode request
pub use crate::stm32g483::usart1::rqr::MMRQ;
///Field `MMRQ` writer - Mute mode request
pub use crate::stm32g483::usart1::rqr::MMRQ_W;
///Receive data flush request
pub use crate::stm32g483::usart1::rqr::RXFRQ;
///Field `RXFRQ` writer - Receive data flush request
pub use crate::stm32g483::usart1::rqr::RXFRQ_W;
///Send break request
pub use crate::stm32g483::usart1::rqr::SBKRQ;
///Field `SBKRQ` writer - Send break request
pub use crate::stm32g483::usart1::rqr::SBKRQ_W;
///TXFRQ
pub use crate::stm32g483::usart1::rqr::TXFRQ;
///Field `TXFRQ` writer - TXFRQ
pub use crate::stm32g483::usart1::rqr::TXFRQ_W;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G483.html#LPUART1:RQR)*/
pub struct RQRrs;
