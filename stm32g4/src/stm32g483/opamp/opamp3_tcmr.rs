#[doc = "Reader of register OPAMP3_TCMR"]
pub type R = crate::R<u32, super::OPAMP3_TCMR>;
#[doc = "Writer for register OPAMP3_TCMR"]
pub type W = crate::W<u32, super::OPAMP3_TCMR>;
#[doc = "Register OPAMP3_TCMR `reset()`'s with value 0"]
...
impl<'a> VPS_SEL_W<'a> {
    ...
    pub fn dac3_ch2(self) -> &'a mut W {
        self.variant(VPS_SEL_A::DAC3_CH2)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
