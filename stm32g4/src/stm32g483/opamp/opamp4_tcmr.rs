#[doc = "Reader of register OPAMP4_TCMR"]
pub type R = crate::R<u32, super::OPAMP4_TCMR>;
#[doc = "Writer for register OPAMP4_TCMR"]
pub type W = crate::W<u32, super::OPAMP4_TCMR>;
#[doc = "Register OPAMP4_TCMR `reset()`'s with value 0"]
impl crate::ResetValue for super::OPAMP4_TCMR {
    type Type = u32;
    #[inline(always)]
...
impl VPS_SEL_R {
    ...
    #[doc = "Checks if the value of the field is `DAC4_CH1`"]
    #[inline(always)]
    pub fn is_dac4_ch1(&self) -> bool {
        *self == VPS_SEL_A::DAC4_CH1
    }
}
...
impl<'a> VPS_SEL_W<'a> {
    ...
    pub fn dac4_ch1(self) -> &'a mut W {
        self.variant(VPS_SEL_A::DAC4_CH1)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
