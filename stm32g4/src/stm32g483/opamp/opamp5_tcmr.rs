#[doc = "Reader of register OPAMP5_TCMR"]
pub type R = crate::R<u32, super::OPAMP5_TCMR>;
#[doc = "Writer for register OPAMP5_TCMR"]
pub type W = crate::W<u32, super::OPAMP5_TCMR>;
#[doc = "Register OPAMP5_TCMR `reset()`'s with value 0"]
impl crate::ResetValue for super::OPAMP5_TCMR {
    type Type = u32;
    #[inline(always)]
...
impl<'a> VPS_SEL_W<'a> {
    ...
    pub fn dac4_ch2(self) -> &'a mut W {
        self.variant(VPS_SEL_A::DAC4_CH2)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
