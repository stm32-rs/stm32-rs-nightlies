...
///Field `FMCRST` reader - Flexible static memory controller reset Set and cleared by software.
...
///Field `FMCRST` writer - Flexible static memory controller reset Set and cleared by software.
...
///Field `QSPIRST` reader - QUADSPI reset Set and cleared by software.
pub use FMCRST_R as QSPIRST_R;
///Field `QSPIRST` writer - QUADSPI reset Set and cleared by software.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G483.html#RCC:AHB3RSTR)*/
