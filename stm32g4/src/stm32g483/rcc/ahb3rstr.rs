...
///Field `FMCRST` reader - Flexible static memory controller reset
...
///Field `FMCRST` writer - Flexible static memory controller reset
...
///Field `QSPIRST` reader - QUADSPI reset
pub use FMCRST_R as QSPIRST_R;
///Field `QSPIRST` writer - QUADSPI reset
pub use FMCRST_W as QSPIRST_W;
impl R {
    ///Bit 0 - Flexible static memory controller reset
    #[inline(always)]
