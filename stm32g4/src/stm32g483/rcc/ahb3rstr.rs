...
///Field `QSPIRST` reader - Quad SPI 1 module reset
pub use FMCRST_R as QSPIRST_R;
///Field `QSPIRST` writer - Quad SPI 1 module reset
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G483xx.html#RCC:AHB3RSTR)*/
