...
#[doc = "Field `OISN(1-4)` reader - Output Idle state (OC%sN output)"]
pub type OISN_R = crate::BitReader;
#[doc = "Field `OISN(1-4)` writer - Output Idle state (OC%sN output)"]
...
impl R {
    ...
    #[doc = "Output Idle state (OC(1-4)N output)"]
    #[doc = ""]
    ...
    #[doc = "Bit 15 - Output Idle state (OC4N output)"]
    #[inline(always)]
