...
///Field `LT2` reader - Analog watchdog 2 lower threshold
pub type LT2_R = crate::FieldReader;
///Field `LT2` writer - Analog watchdog 2 lower threshold
pub type LT2_W<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
///Field `HT2` reader - Analog watchdog 2 higher threshold
pub type HT2_R = crate::FieldReader;
///Field `HT2` writer - Analog watchdog 2 higher threshold
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#ADC3:TR2)*/
pub struct TR2rs;
