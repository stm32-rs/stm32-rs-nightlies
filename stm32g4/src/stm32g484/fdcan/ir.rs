...
///Field `TEFN` reader - Tx even FIFO new entry
pub type TEFN_R = crate::BitReader;
///Field `TEFN` writer - Tx even FIFO new entry
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#FDCAN:IR)*/
pub struct IRrs;
