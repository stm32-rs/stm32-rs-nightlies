...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `MC1` field.</div>
    #[inline(always)]
    pub fn mc(&mut self, n: u8) -> MC_W<ADC2Rrs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
        MC_W::new(self, n)
    }
    ///Bit 0 - ADC trigger 2 on Master Compare 1
    #[inline(always)]
    pub fn mc1(&mut self) -> MC_W<ADC2Rrs> {
        MC_W::new(self, 0)
    }
    ///Bit 1 - ADC trigger 2 on Master Compare 2
    #[inline(always)]
    pub fn mc2(&mut self) -> MC_W<ADC2Rrs> {
        MC_W::new(self, 1)
    }
    ///Bit 2 - ADC trigger 2 on Master Compare 3
    #[inline(always)]
    pub fn mc3(&mut self) -> MC_W<ADC2Rrs> {
        MC_W::new(self, 2)
    }
    ///Bit 3 - ADC trigger 2 on Master Compare 4
    #[inline(always)]
    pub fn mc4(&mut self) -> MC_W<ADC2Rrs> {
        MC_W::new(self, 3)
    }
    ///Bit 4 - ADC trigger 2 on Master Period
    #[inline(always)]
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EEV6` field.</div>
    #[inline(always)]
    pub fn eev(&mut self, n: u8) -> EEV_W<ADC2Rrs> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
        EEV_W::new(self, n + 5)
    }
    ///Bit 5 - ADC trigger 2 on External Event 6
    #[inline(always)]
    pub fn eev6(&mut self) -> EEV_W<ADC2Rrs> {
        EEV_W::new(self, 5)
    }
    ///Bit 6 - ADC trigger 2 on External Event 7
    #[inline(always)]
    pub fn eev7(&mut self) -> EEV_W<ADC2Rrs> {
        EEV_W::new(self, 6)
    }
    ///Bit 7 - ADC trigger 2 on External Event 8
    #[inline(always)]
    pub fn eev8(&mut self) -> EEV_W<ADC2Rrs> {
        EEV_W::new(self, 7)
    }
    ///Bit 8 - ADC trigger 2 on External Event 9
    #[inline(always)]
    pub fn eev9(&mut self) -> EEV_W<ADC2Rrs> {
        EEV_W::new(self, 8)
    }
    ///Bit 9 - ADC trigger 2 on External Event 10
    #[inline(always)]
    pub fn eev10(&mut self) -> EEV_W<ADC2Rrs> {
        EEV_W::new(self, 9)
    }
    ///Bit 10 - ADC trigger 2 on Timer A compare 2
    #[inline(always)]
