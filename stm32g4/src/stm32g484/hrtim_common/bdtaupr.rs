...
impl W {
    ...
    ///Bit 21 - TIMxCR2
    #[inline(always)]
    pub fn cr2(&mut self) -> CR2_W<BDTAUPRrs> {
        CR2_W::new(self, 21)
    }
    ///Bit 22 - TIMxEEFR3
    #[inline(always)]
    pub fn eefr3(&mut self) -> EEFR3_W<BDTAUPRrs> {
        EEFR3_W::new(self, 22)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_Common:BDTAUPR)*/
