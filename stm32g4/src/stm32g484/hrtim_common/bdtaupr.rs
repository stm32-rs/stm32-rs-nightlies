...
///Field `CR2` reader - TIMxCR2
pub use CR_R as CR2_R;
///Field `EEFR3` reader - TIMxEEFR3
pub use CR_R as EEFR3_R;
...
///Field `CR2` writer - TIMxCR2
pub use CR_W as CR2_W;
///Field `EEFR3` writer - TIMxEEFR3
pub use CR_W as EEFR3_W;
impl R {
    ...
    pub fn cr2(&self) -> CR2_R {
        CR2_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Bit 22 - TIMxEEFR3
    #[inline(always)]
    pub fn eefr3(&self) -> EEFR3_R {
        EEFR3_R::new(((self.bits >> 22) & 1) != 0)
    }
}
...
impl W {
    ...
    ///Bit 10 - HRTIM_DTxR register update enable
    #[inline(always)]
    pub fn _dtx_r(&mut self) -> _DTX_R_W<'_, BDTAUPRrs> {
    ...
    ///Bit 21 - TIMxCR2
    #[inline(always)]
    pub fn cr2(&mut self) -> CR2_W<'_, BDTAUPRrs> {
        CR2_W::new(self, 21)
    }
    ///Bit 22 - TIMxEEFR3
    #[inline(always)]
    pub fn eefr3(&mut self) -> EEFR3_W<'_, BDTAUPRrs> {
        EEFR3_W::new(self, 22)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#HRTIM_Common:BDTAUPR)*/
