...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timx_cr2(&mut self) -> TIMX_CR2_W<BDTDUPRrs> {
        TIMX_CR2_W::new(self, 21)
    }
    ///Bit 22 - TIMxEEFR3
    #[inline(always)]
    #[must_use]
    pub fn timx_eefr3(&mut self) -> TIMX_EEFR3_W<BDTDUPRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_Common:BDTDUPR)*/
