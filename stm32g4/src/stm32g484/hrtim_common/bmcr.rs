...
///Field `TBM(A,B,C,D,E,F)` reader - Timer %s Burst Mode
pub use MTBM_R as TBM_R;
///Field `TBM(A,B,C,D,E,F)` writer - Timer %s Burst Mode
...
impl R {
    ...
    pub fn tbm_iter(&self) -> impl Iterator<Item = TBM_R> + '_ {
        (0..6).map(move |n| TBM_R::new(((self.bits >> (n + 17)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn tfbm(&self) -> TBM_R {
        TBM_R::new(((self.bits >> 22) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 22 - Timer F Burst Mode
    #[inline(always)]
    pub fn tfbm(&mut self) -> TBM_W<'_, BMCRrs> {
        TBM_W::new(self, 22)
    }
    ///Bit 31 - Burst Mode Status
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#HRTIM_Common:BMCR)*/
pub struct BMCRrs;
