...
pub type TDEEV7_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdeev7(&mut self) -> TDEEV7_W<BMTRGrs> {
        TDEEV7_W::new(self, 27)
    }
    ///Bit 28 - TDEEV8
    #[inline(always)]
    #[must_use]
    pub fn tdeev8(&mut self) -> TDEEV8_W<BMTRGrs> {
        TDEEV8_W::new(self, 28)
    }
    ///Bit 29 - EEV7
    #[inline(always)]
    #[must_use]
    pub fn eev7(&mut self) -> EEV7_W<BMTRGrs> {
        EEV7_W::new(self, 29)
    }
    ///Bit 30 - EEV8
    #[inline(always)]
    #[must_use]
    pub fn eev8(&mut self) -> EEV8_W<BMTRGrs> {
        EEV8_W::new(self, 30)
    }
    ///Bit 31 - OCHPEV
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_Common:BMTRG)*/
pub struct BMTRGrs;
