...
///Field `TFCMP1` reader - Timer F compare 1 event
...
///Field `TFCMP1` writer - Timer F compare 1 event
...
///Field `TFREP` reader - Timer F repetition
pub use TAREP_R as TFREP_R;
...
///Field `TFREP` writer - Timer F repetition
pub use TAREP_W as TFREP_W;
...
///Field `TFRST` reader - Timer F reset
pub use TARST_R as TFRST_R;
...
///Field `TFRST` writer - Timer F reset
pub use TARST_W as TFRST_W;
...
impl R {
    ...
    #[inline(always)]
    pub fn tfrep(&self) -> TFREP_R {
        TFREP_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Bit 22 - TDCMP2
    #[inline(always)]
...
impl W {
    ...
    ///Bit 18 - Timer F reset
    #[inline(always)]
    pub fn tfrst(&mut self) -> TFRST_W<'_, BMTRGRrs> {
        TFRST_W::new(self, 18)
    }
    ///Bit 19 - TDRST
    #[inline(always)]
    ...
    ///Bit 21 - Timer F repetition
    #[inline(always)]
    pub fn tfrep(&mut self) -> TFREP_W<'_, BMTRGRrs> {
        TFREP_W::new(self, 21)
    }
    ///Bit 22 - TDCMP2
    #[inline(always)]
    ...
    ///Bit 23 - Timer F compare 1 event
    #[inline(always)]
    pub fn tfcmp1(&mut self) -> TFCMP1_W<'_, BMTRGRrs> {
        TFCMP1_W::new(self, 23)
    }
    ///Bit 24 - TEREP
    #[inline(always)]
