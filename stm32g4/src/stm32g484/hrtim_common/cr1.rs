...
///Field `TUDIS(A,B,C,D,E,F)` reader - Timer %s Update Disable
pub use MUDIS_R as TUDIS_R;
///Field `TUDIS(A,B,C,D,E,F)` writer - Timer %s Update Disable
...
pub enum AD1USRC {
    ...
    TimerE = 5,
    ///6: ADC trigger update from timer F
    TimerF = 6,
}
...
impl ADUSRC_R {
    ...
    ///ADC trigger update from timer F
    #[inline(always)]
    pub fn is_timer_f(&self) -> bool {
        *self == AD1USRC::TimerF
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    ///ADC trigger update from timer F
    #[inline(always)]
    pub fn timer_f(self) -> &'a mut crate::W<REG> {
        self.variant(AD1USRC::TimerF)
    }
}
impl R {
    ...
    ///Timer (A,B,C,D,E,F) Update Disable
    ///
    ...
    pub fn tudis_iter(&self) -> impl Iterator<Item = TUDIS_R> + '_ {
        (0..6).map(move |n| TUDIS_R::new(((self.bits >> (n + 1)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn tfudis(&self) -> TUDIS_R {
        TUDIS_R::new(((self.bits >> 6) & 1) != 0)
    }
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `TAUDIS` field.</div>
    #[inline(always)]
    pub fn tudis(&mut self, n: u8) -> TUDIS_W<CR1rs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
    ...
    ///Bit 1 - Timer A Update Disable
    #[inline(always)]
    pub fn taudis(&mut self) -> TUDIS_W<CR1rs> {
        TUDIS_W::new(self, 1)
    }
    ///Bit 2 - Timer B Update Disable
    #[inline(always)]
    pub fn tbudis(&mut self) -> TUDIS_W<CR1rs> {
        TUDIS_W::new(self, 2)
    }
    ///Bit 3 - Timer C Update Disable
    #[inline(always)]
    pub fn tcudis(&mut self) -> TUDIS_W<CR1rs> {
        TUDIS_W::new(self, 3)
    }
    ///Bit 4 - Timer D Update Disable
    #[inline(always)]
    pub fn tdudis(&mut self) -> TUDIS_W<CR1rs> {
        TUDIS_W::new(self, 4)
    }
    ///Bit 5 - Timer E Update Disable
    #[inline(always)]
    pub fn teudis(&mut self) -> TUDIS_W<CR1rs> {
        TUDIS_W::new(self, 5)
    }
    ///Bit 6 - Timer F Update Disable
    #[inline(always)]
    pub fn tfudis(&mut self) -> TUDIS_W<CR1rs> {
        TUDIS_W::new(self, 6)
    }
    ///ADC Trigger (1-4) Update Source
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `AD1USRC` field.</div>
    #[inline(always)]
    pub fn adusrc(&mut self, n: u8) -> ADUSRC_W<CR1rs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    ///Bits 16:18 - ADC Trigger 1 Update Source
    #[inline(always)]
    pub fn ad1usrc(&mut self) -> ADUSRC_W<CR1rs> {
        ADUSRC_W::new(self, 16)
    }
    ///Bits 19:21 - ADC Trigger 2 Update Source
    #[inline(always)]
    pub fn ad2usrc(&mut self) -> ADUSRC_W<CR1rs> {
        ADUSRC_W::new(self, 19)
    }
    ///Bits 22:24 - ADC Trigger 3 Update Source
    #[inline(always)]
    pub fn ad3usrc(&mut self) -> ADUSRC_W<CR1rs> {
        ADUSRC_W::new(self, 22)
    }
    ///Bits 25:27 - ADC Trigger 4 Update Source
    #[inline(always)]
    pub fn ad4usrc(&mut self) -> ADUSRC_W<CR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_Common:CR1)*/
pub struct CR1rs;
