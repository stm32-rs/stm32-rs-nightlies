...
///Field `TSWU(A,B,C,D,E,F)` reader - Timer %s Software Update
pub use MSWU_R as TSWU_R;
///Field `TSWU(A,B,C,D,E,F)` writer - Timer %s Software Update
...
///Field `TRST(A,B,C,D,E,F)` reader - Timer %s counter software reset
pub use MRST_R as TRST_R;
///Field `TRST(A,B,C,D,E,F)` writer - Timer %s counter software reset
pub use MRST_W as TRST_W;
///Field `SWP(A,B,C,D,E,F)` reader - Swap Timer %s outputs
pub type SWP_R = crate::BitReader;
///Field `SWP(A,B,C,D,E,F)` writer - Swap Timer %s outputs
...
impl R {
    ...
    ///Timer (A,B,C,D,E,F) Software Update
    ///
    ...
    pub fn tswu_iter(&self) -> impl Iterator<Item = TSWU_R> + '_ {
        (0..6).map(move |n| TSWU_R::new(((self.bits >> (n + 1)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn tfswu(&self) -> TSWU_R {
        TSWU_R::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    ///Timer (A,B,C,D,E,F) counter software reset
    ///
    ...
    pub fn trst_iter(&self) -> impl Iterator<Item = TRST_R> + '_ {
        (0..6).map(move |n| TRST_R::new(((self.bits >> (n + 9)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn tfrst(&self) -> TRST_R {
        TRST_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Swap Timer (A,B,C,D,E,F) outputs
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SWPA` field.</div>
    #[inline(always)]
    pub fn swp(&self, n: u8) -> SWP_R {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
        SWP_R::new(((self.bits >> (n + 16)) & 1) != 0)
    }
    ///Iterator for array of:
    ///Swap Timer (A,B,C,D,E,F) outputs
    #[inline(always)]
    pub fn swp_iter(&self) -> impl Iterator<Item = SWP_R> + '_ {
        (0..6).map(move |n| SWP_R::new(((self.bits >> (n + 16)) & 1) != 0))
    }
    ///Bit 16 - Swap Timer A outputs
    #[inline(always)]
    pub fn swpa(&self) -> SWP_R {
        SWP_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - Swap Timer B outputs
    #[inline(always)]
    pub fn swpb(&self) -> SWP_R {
        SWP_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - Swap Timer C outputs
    #[inline(always)]
    pub fn swpc(&self) -> SWP_R {
        SWP_R::new(((self.bits >> 18) & 1) != 0)
    }
    ///Bit 19 - Swap Timer D outputs
    #[inline(always)]
    pub fn swpd(&self) -> SWP_R {
        SWP_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 20 - Swap Timer E outputs
    #[inline(always)]
    pub fn swpe(&self) -> SWP_R {
        SWP_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - Swap Timer F outputs
    #[inline(always)]
    pub fn swpf(&self) -> SWP_R {
        SWP_R::new(((self.bits >> 21) & 1) != 0)
    }
}
...
impl W {
    ...
    ///Bit 6 - Timer F Software Update
    #[inline(always)]
    pub fn tfswu(&mut self) -> TSWU_W<'_, CR2rs> {
        TSWU_W::new(self, 6)
    }
    ///Bit 8 - Master Counter software reset
    #[inline(always)]
    ...
    ///Bit 14 - Timer F counter software reset
    #[inline(always)]
    pub fn tfrst(&mut self) -> TRST_W<'_, CR2rs> {
        TRST_W::new(self, 14)
    }
    ///Swap Timer (A,B,C,D,E,F) outputs
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SWPA` field.</div>
    #[inline(always)]
    pub fn swp(&mut self, n: u8) -> SWP_W<'_, CR2rs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
        SWP_W::new(self, n + 16)
    }
    ///Bit 16 - Swap Timer A outputs
    #[inline(always)]
    pub fn swpa(&mut self) -> SWP_W<'_, CR2rs> {
        SWP_W::new(self, 16)
    }
    ///Bit 17 - Swap Timer B outputs
    #[inline(always)]
    pub fn swpb(&mut self) -> SWP_W<'_, CR2rs> {
        SWP_W::new(self, 17)
    }
    ///Bit 18 - Swap Timer C outputs
    #[inline(always)]
    pub fn swpc(&mut self) -> SWP_W<'_, CR2rs> {
        SWP_W::new(self, 18)
    }
    ///Bit 19 - Swap Timer D outputs
    #[inline(always)]
    pub fn swpd(&mut self) -> SWP_W<'_, CR2rs> {
        SWP_W::new(self, 19)
    }
    ///Bit 20 - Swap Timer E outputs
    #[inline(always)]
    pub fn swpe(&mut self) -> SWP_W<'_, CR2rs> {
        SWP_W::new(self, 20)
    }
    ///Bit 21 - Swap Timer F outputs
    #[inline(always)]
    pub fn swpf(&mut self) -> SWP_W<'_, CR2rs> {
        SWP_W::new(self, 21)
    }
}
/**Control Register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#HRTIM_Common:CR2)*/
pub struct CR2rs;
