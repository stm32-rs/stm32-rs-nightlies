...
impl W {
    ...
    ///Bit 6 - Timer F Software Update
    #[inline(always)]
    pub fn tfswu(&mut self) -> TSWU_W<CR2rs> {
        TSWU_W::new(self, 6)
    }
    ///Bit 8 - Master Counter software reset
    #[inline(always)]
    ...
    ///Bit 14 - Timer F counter software reset
    #[inline(always)]
    pub fn tfrst(&mut self) -> TRST_W<CR2rs> {
        TRST_W::new(self, 14)
    }
    ///Swap Timer (A,B,C,D,E,F) outputs
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SWPA` field.</div>
    #[inline(always)]
    pub fn swp(&mut self, n: u8) -> SWP_W<CR2rs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
        SWP_W::new(self, n + 16)
    }
    ///Bit 16 - Swap Timer A outputs
    #[inline(always)]
    pub fn swpa(&mut self) -> SWP_W<CR2rs> {
        SWP_W::new(self, 16)
    }
    ///Bit 17 - Swap Timer B outputs
    #[inline(always)]
    pub fn swpb(&mut self) -> SWP_W<CR2rs> {
        SWP_W::new(self, 17)
    }
    ///Bit 18 - Swap Timer C outputs
    #[inline(always)]
    pub fn swpc(&mut self) -> SWP_W<CR2rs> {
        SWP_W::new(self, 18)
    }
    ///Bit 19 - Swap Timer D outputs
    #[inline(always)]
    pub fn swpd(&mut self) -> SWP_W<CR2rs> {
        SWP_W::new(self, 19)
    }
    ///Bit 20 - Swap Timer E outputs
    #[inline(always)]
    pub fn swpe(&mut self) -> SWP_W<CR2rs> {
        SWP_W::new(self, 20)
    }
    ///Bit 21 - Swap Timer F outputs
    #[inline(always)]
    pub fn swpf(&mut self) -> SWP_W<CR2rs> {
        SWP_W::new(self, 21)
    }
}
/**Control Register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_Common:CR2)*/
pub struct CR2rs;
