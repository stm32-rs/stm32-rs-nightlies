...
///Field `EESRC(6-10)` reader - EE%sSRC
...
///Field `EESRC(6-10)` writer - EE%sSRC
...
///Field `EEPOL(6-10)` reader - EE%sPOL
...
///Field `EEPOL(6-10)` writer - EE%sPOL
...
///Field `EESNS(6-10)` reader - EE%sSNS
...
///Field `EESNS(6-10)` writer - EE%sSNS
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_Common:EECR2)*/
pub struct EECR2rs;
