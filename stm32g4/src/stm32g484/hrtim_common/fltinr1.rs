    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn comp_output(self) -> &'a mut crate::W<REG> {
        self.variant(FLT1SRC::CompOutput)
    }
}
/**FLT%sF
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_Common:FLTINR1)*/
