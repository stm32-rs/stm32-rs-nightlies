...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT1BLKE` field.</div>
    #[inline(always)]
    pub fn fltblke(&mut self, n: u8) -> FLTBLKE_W<FLTINR3rs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    ///Bit 0 - FLT1BLKE
    #[inline(always)]
    pub fn flt1blke(&mut self) -> FLTBLKE_W<FLTINR3rs> {
        FLTBLKE_W::new(self, 0)
    }
    ///Bit 8 - FLT2BLKE
    #[inline(always)]
    pub fn flt2blke(&mut self) -> FLTBLKE_W<FLTINR3rs> {
        FLTBLKE_W::new(self, 8)
    }
    ///Bit 16 - FLT3BLKE
    #[inline(always)]
    pub fn flt3blke(&mut self) -> FLTBLKE_W<FLTINR3rs> {
        FLTBLKE_W::new(self, 16)
    }
    ///Bit 24 - FLT4BLKE
    #[inline(always)]
    pub fn flt4blke(&mut self) -> FLTBLKE_W<FLTINR3rs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT1BLKS` field.</div>
    #[inline(always)]
    pub fn fltblks(&mut self, n: u8) -> FLTBLKS_W<FLTINR3rs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    ///Bit 1 - FLT1BLKS
    #[inline(always)]
    pub fn flt1blks(&mut self) -> FLTBLKS_W<FLTINR3rs> {
        FLTBLKS_W::new(self, 1)
    }
    ///Bit 9 - FLT2BLKS
    #[inline(always)]
    pub fn flt2blks(&mut self) -> FLTBLKS_W<FLTINR3rs> {
        FLTBLKS_W::new(self, 9)
    }
    ///Bit 17 - FLT3BLKS
    #[inline(always)]
    pub fn flt3blks(&mut self) -> FLTBLKS_W<FLTINR3rs> {
        FLTBLKS_W::new(self, 17)
    }
    ///Bit 25 - FLT4BLKS
    #[inline(always)]
    pub fn flt4blks(&mut self) -> FLTBLKS_W<FLTINR3rs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT1CNT` field.</div>
    #[inline(always)]
    pub fn fltcnt(&mut self, n: u8) -> FLTCNT_W<FLTINR3rs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    ///Bits 2:5 - FLT1CNT
    #[inline(always)]
    pub fn flt1cnt(&mut self) -> FLTCNT_W<FLTINR3rs> {
        FLTCNT_W::new(self, 2)
    }
    ///Bits 10:13 - FLT2CNT
    #[inline(always)]
    pub fn flt2cnt(&mut self) -> FLTCNT_W<FLTINR3rs> {
        FLTCNT_W::new(self, 10)
    }
    ///Bits 18:21 - FLT3CNT
    #[inline(always)]
    pub fn flt3cnt(&mut self) -> FLTCNT_W<FLTINR3rs> {
        FLTCNT_W::new(self, 18)
    }
    ///Bits 26:29 - FLT4CNT
    #[inline(always)]
    pub fn flt4cnt(&mut self) -> FLTCNT_W<FLTINR3rs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT1CRES` field.</div>
    #[inline(always)]
    pub fn fltcres(&mut self, n: u8) -> FLTCRES_W<FLTINR3rs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    ///Bit 6 - FLT1CRES
    #[inline(always)]
    pub fn flt1cres(&mut self) -> FLTCRES_W<FLTINR3rs> {
        FLTCRES_W::new(self, 6)
    }
    ///Bit 14 - FLT2CRES
    #[inline(always)]
    pub fn flt2cres(&mut self) -> FLTCRES_W<FLTINR3rs> {
        FLTCRES_W::new(self, 14)
    }
    ///Bit 22 - FLT3CRES
    #[inline(always)]
    pub fn flt3cres(&mut self) -> FLTCRES_W<FLTINR3rs> {
        FLTCRES_W::new(self, 22)
    }
    ///Bit 30 - FLT4CRES
    #[inline(always)]
    pub fn flt4cres(&mut self) -> FLTCRES_W<FLTINR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_Common:FLTINR3)*/
