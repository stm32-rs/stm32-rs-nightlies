...
impl W {
    ...
    #[inline(always)]
    pub fn flt6c(&mut self) -> FLT6C_W<'_, ICRrs> {
        FLT6C_W::new(self, 6)
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#HRTIM_Common:ICR)*/
pub struct ICRrs;
...
impl crate::Writable for ICRrs {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0003_007f;
}
