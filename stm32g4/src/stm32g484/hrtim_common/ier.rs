...
///Field `FLT6IE` reader - Fault 6 Interrupt Enable
pub use FLT1IE_R as FLT6IE_R;
...
///Field `FLT6IE` writer - Fault 6 Interrupt Enable
pub use FLT1IE_W as FLT6IE_W;
...
impl W {
    ...
    ///Bit 6 - Fault 6 Interrupt Enable
    #[inline(always)]
    pub fn flt6ie(&mut self) -> FLT6IE_W<'_, IERrs> {
        FLT6IE_W::new(self, 6)
    }
    ///Bit 16 - DLL Ready Interrupt Enable
    #[inline(always)]
    pub fn dllrdyie(&mut self) -> DLLRDYIE_W<'_, IERrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#HRTIM_Common:IER)*/
pub struct IERrs;
