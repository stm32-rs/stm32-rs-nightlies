...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> TF1SET_W<CPT2ACRrs> {
        TF1SET_W::new(self, 12)
    }
    ///Bit 13 - TF1RST
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> TF1RST_W<CPT2ACRrs> {
        TF1RST_W::new(self, 13)
    }
    ///Bit 14 - TFCMP1
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> TFCMP1_W<CPT2ACRrs> {
        TFCMP1_W::new(self, 14)
    }
    ///Bit 15 - TFCMP2
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> TFCMP2_W<CPT2ACRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_TIMA:CPT2ACR)*/
