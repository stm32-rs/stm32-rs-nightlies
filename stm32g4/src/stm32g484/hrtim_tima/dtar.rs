#[doc = "Reader of register DTAR"]
pub type R = crate::R<u32, super::DTAR>;
#[doc = "Writer for register DTAR"]
pub type W = crate::W<u32, super::DTAR>;
#[doc = "Register DTAR `reset()`'s with value 0"]
impl crate::ResetValue for super::DTAR {
    type Type = u32;
    #[inline(always)]
