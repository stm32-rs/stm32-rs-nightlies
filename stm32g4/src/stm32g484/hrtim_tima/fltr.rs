...
///Field `FLTEN(1-6)` reader - Fault %s enable
...
///Field `FLTEN(1-6)` writer - Fault %s enable
...
impl R {
    ...
    pub fn flten_iter(&self) -> impl Iterator<Item = FLTEN_R> + '_ {
        (0..6).map(move |n| FLTEN_R::new(((self.bits >> n) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn flt6en(&self) -> FLTEN_R {
        FLTEN_R::new(((self.bits >> 5) & 1) != 0)
    }
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `FLT1EN` field.</div>
    #[inline(always)]
    pub fn flten(&mut self, n: u8) -> FLTEN_W<FLTRrs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
        FLTEN_W::new(self, n)
    }
    ///Bit 0 - Fault 1 enable
    #[inline(always)]
    pub fn flt1en(&mut self) -> FLTEN_W<FLTRrs> {
        FLTEN_W::new(self, 0)
    }
    ///Bit 1 - Fault 2 enable
    #[inline(always)]
    pub fn flt2en(&mut self) -> FLTEN_W<FLTRrs> {
        FLTEN_W::new(self, 1)
    }
    ///Bit 2 - Fault 3 enable
    #[inline(always)]
    pub fn flt3en(&mut self) -> FLTEN_W<FLTRrs> {
        FLTEN_W::new(self, 2)
    }
    ///Bit 3 - Fault 4 enable
    #[inline(always)]
    pub fn flt4en(&mut self) -> FLTEN_W<FLTRrs> {
        FLTEN_W::new(self, 3)
    }
    ///Bit 4 - Fault 5 enable
    #[inline(always)]
    pub fn flt5en(&mut self) -> FLTEN_W<FLTRrs> {
        FLTEN_W::new(self, 4)
    }
    ///Bit 5 - Fault 6 enable
    #[inline(always)]
    pub fn flt6en(&mut self) -> FLTEN_W<FLTRrs> {
        FLTEN_W::new(self, 5)
    }
    ///Bit 31 - Fault sources Lock
    #[inline(always)]
    pub fn fltlck(&mut self) -> FLTLCK_W<FLTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_TIMA:FLTR)*/
pub struct FLTRrs;
