...
pub use TIMBCMP1_R as TIMFCMP4_R;
...
pub use TIMBCMP1_W as TIMFCMP4_W;
/**External Event %s
...
impl R {
    ...
    pub fn timccmp2(&self) -> TIMCCMP2_R {
        TIMCCMP2_R::new(((self.bits >> 14) & 1) != 0)
    }
    ...
    pub fn timdcmp1(&self) -> TIMDCMP1_R {
        TIMDCMP1_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - Timer D Compare 2
    #[inline(always)]
    pub fn timdcmp2(&self) -> TIMDCMP2_R {
        TIMDCMP2_R::new(((self.bits >> 17) & 1) != 0)
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#HRTIM_TIMA:SET1R)*/
pub struct SET1Rrs;
