...
impl core::fmt::Debug for crate::generic::Reg<TIMAICRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_TIMA:TIMAICR)*/
pub struct TIMAICRrs;
impl crate::RegisterSpec for TIMAICRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`timaicr::W`](W) writer structure
impl crate::Writable for TIMAICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMAICR to value 0
