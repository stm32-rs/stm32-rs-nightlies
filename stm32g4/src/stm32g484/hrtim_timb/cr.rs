...
///Continuous mode
pub use crate::stm32g484::hrtim_master::cr::CONT;
///Field `CONT` reader - Continuous mode
pub use crate::stm32g484::hrtim_master::cr::CONT_R;
///Field `CONT` writer - Continuous mode
pub use crate::stm32g484::hrtim_master::cr::CONT_W;
///Half mode enable
pub use crate::stm32g484::hrtim_master::cr::HALF;
///Field `HALF` reader - Half mode enable
pub use crate::stm32g484::hrtim_master::cr::HALF_R;
///Field `HALF` writer - Half mode enable
pub use crate::stm32g484::hrtim_master::cr::HALF_W;
///Re-triggerable mode
pub use crate::stm32g484::hrtim_master::cr::RETRIG;
///Field `RETRIG` reader - Re-triggerable mode
pub use crate::stm32g484::hrtim_master::cr::RETRIG_R;
///Field `RETRIG` writer - Re-triggerable mode
pub use crate::stm32g484::hrtim_master::cr::RETRIG_W;
///Push-Pull mode enable
pub use crate::stm32g484::hrtim_tima::cr::PSHPLL;
///Field `PSHPLL` reader - Push-Pull mode enable
pub use crate::stm32g484::hrtim_tima::cr::PSHPLL_R;
///Field `PSHPLL` writer - Push-Pull mode enable
pub use crate::stm32g484::hrtim_tima::cr::PSHPLL_W;
...
pub use crate::stm32g484::hrtim_master::cr::SYNCRST;
///Field `SYNCRST` reader - Synchronization Resets Timer x
pub use crate::stm32g484::hrtim_master::cr::SYNCRST_R;
///Field `SYNCRST` writer - Synchronization Resets Timer x
pub use crate::stm32g484::hrtim_master::cr::SYNCRST_W;
///Synchronization Starts Timer x
pub use crate::stm32g484::hrtim_master::cr::SYNCSTRT;
///Field `SYNCSTRT` reader - Synchronization Starts Timer x
pub use crate::stm32g484::hrtim_master::cr::SYNCSTRT_R;
///Field `SYNCSTRT` writer - Synchronization Starts Timer x
pub use crate::stm32g484::hrtim_master::cr::SYNCSTRT_W;
///Delayed CMP2 mode
pub use crate::stm32g484::hrtim_tima::cr::DELCMP2;
///Field `DELCMP2` reader - Delayed CMP2 mode
pub use crate::stm32g484::hrtim_tima::cr::DELCMP2_R;
///Field `DELCMP2` writer - Delayed CMP2 mode
pub use crate::stm32g484::hrtim_tima::cr::DELCMP2_W;
///Delayed CMP4 mode
pub use crate::stm32g484::hrtim_tima::cr::DELCMP4;
///Field `DELCMP4` reader - Delayed CMP4 mode
pub use crate::stm32g484::hrtim_tima::cr::DELCMP4_R;
///Field `DELCMP4` writer - Delayed CMP4 mode
pub use crate::stm32g484::hrtim_tima::cr::DELCMP4_W;
/**TFU
...
impl From<TFU> for bool {
    #[inline(always)]
    fn from(variant: TFU) -> Self {
        variant as u8 != 0
    }
}
///Field `TFU` reader - TFU
pub type TFU_R = crate::BitReader<TFU>;
impl TFU_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TFU {
        match self.bits {
            false => TFU::Disabled,
            true => TFU::Enabled,
        }
...
pub type TFU_W<'a, REG> = crate::BitWriter<'a, REG, TFU>;
impl<'a, REG> TFU_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(TFU::Disabled)
    }
    ///Update by timer x enabled
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(TFU::Enabled)
    }
}
///AC Synchronization
pub use crate::stm32g484::hrtim_master::cr::DACSYNC;
///Field `DACSYNC` reader - AC Synchronization
pub use crate::stm32g484::hrtim_master::cr::DACSYNC_R;
///Field `DACSYNC` writer - AC Synchronization
pub use crate::stm32g484::hrtim_master::cr::DACSYNC_W;
///Preload enable
pub use crate::stm32g484::hrtim_master::cr::PREEN;
///Field `PREEN` reader - Preload enable
pub use crate::stm32g484::hrtim_master::cr::PREEN_R;
///Field `PREEN` writer - Preload enable
pub use crate::stm32g484::hrtim_master::cr::PREEN_W;
///Master Timer update
pub use crate::stm32g484::hrtim_tima::cr::MSTU;
///Field `MSTU` reader - Master Timer update
pub use crate::stm32g484::hrtim_tima::cr::MSTU_R;
///Field `MSTU` writer - Master Timer update
pub use crate::stm32g484::hrtim_tima::cr::MSTU_W;
///Timer x Repetition update
pub use crate::stm32g484::hrtim_tima::cr::TREPU;
///Field `TREPU` reader - Timer x Repetition update
pub use crate::stm32g484::hrtim_tima::cr::TREPU_R;
///Field `TREPU` writer - Timer x Repetition update
pub use crate::stm32g484::hrtim_tima::cr::TREPU_W;
///Timerx reset update
pub use crate::stm32g484::hrtim_tima::cr::TRSTU;
///Field `TRSTU` reader - Timerx reset update
pub use crate::stm32g484::hrtim_tima::cr::TRSTU_R;
///Field `TRSTU` writer - Timerx reset update
pub use crate::stm32g484::hrtim_tima::cr::TRSTU_W;
///Update Gating
pub use crate::stm32g484::hrtim_tima::cr::UPDGAT;
///Field `UPDGAT` reader - Update Gating
pub use crate::stm32g484::hrtim_tima::cr::UPDGAT_R;
///Field `UPDGAT` writer - Update Gating
pub use crate::stm32g484::hrtim_tima::cr::UPDGAT_W;
///Field `TAU` reader - TAU
pub use TFU_R as TAU_R;
///Field `TCU` reader - TCU
pub use TFU_R as TCU_R;
///Field `TDU` reader - TDU
pub use TFU_R as TDU_R;
///Field `TEU` reader - TEU
pub use TFU_R as TEU_R;
///Field `TAU` writer - TAU
pub use TFU_W as TAU_W;
///Field `TCU` writer - TCU
pub use TFU_W as TCU_W;
///Field `TDU` writer - TDU
pub use TFU_W as TDU_W;
///Field `TEU` writer - TEU
pub use TFU_W as TEU_W;
impl R {
...
impl W {
    ...
    ///Bits 7:8 - Interleaved mode
    #[inline(always)]
    pub fn intlvd(&mut self) -> INTLVD_W<'_, CRrs> {
        INTLVD_W::new(self, 7)
    }
    ///Bit 9 - Re-Synchronized Update
    #[inline(always)]
    pub fn rsyncu(&mut self) -> RSYNCU_W<'_, CRrs> {
        RSYNCU_W::new(self, 9)
    }
    ///Bit 10 - Synchronization Resets Timer x
    #[inline(always)]
    ...
    ///Bit 16 - TFU
    #[inline(always)]
    pub fn tfu(&mut self) -> TFU_W<'_, CRrs> {
        TFU_W::new(self, 16)
    }
    ///Bit 17 - Timer x Repetition update
    #[inline(always)]
    ...
    ///Bit 19 - TAU
    #[inline(always)]
    pub fn tau(&mut self) -> TAU_W<'_, CRrs> {
        TAU_W::new(self, 19)
    }
    ///Bit 21 - TCU
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#HRTIM_TIMB:CR)*/
pub struct CRrs;
