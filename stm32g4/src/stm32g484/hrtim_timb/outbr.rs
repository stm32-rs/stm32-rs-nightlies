#[doc = "Reader of register OUTBR"]
pub type R = crate::R<u32, super::OUTBR>;
#[doc = "Writer for register OUTBR"]
pub type W = crate::W<u32, super::OUTBR>;
#[doc = "Register OUTBR `reset()`'s with value 0"]
impl crate::ResetValue for super::OUTBR {
    type Type = u32;
    #[inline(always)]
