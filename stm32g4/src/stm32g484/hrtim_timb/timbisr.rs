///Register `TIMBISR` reader
pub type R = crate::R<TIMBISRrs>;
...
pub struct TIMBISRrs;
impl crate::RegisterSpec for TIMBISRrs {
    type Ux = u32;
}
///`read()` method returns [`timbisr::R`](R) reader structure
impl crate::Readable for TIMBISRrs {}
///`reset()` method sets TIMBISR to value 0
impl crate::Resettable for TIMBISRrs {
