...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> TF1SET_W<CPT1CCRrs> {
        TF1SET_W::new(self, 20)
    }
    ///Bit 21 - TF1RST
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> TF1RST_W<CPT1CCRrs> {
        TF1RST_W::new(self, 21)
    }
    ///Bit 22 - TFCMP1
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> TFCMP1_W<CPT1CCRrs> {
        TFCMP1_W::new(self, 22)
    }
    ///Bit 23 - TFCMP2
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> TFCMP2_W<CPT1CCRrs> {
        TFCMP2_W::new(self, 23)
    }
    ///Bit 24 - Timer D output 1 Set
    #[inline(always)]
    #[must_use]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_TIMC:CPT1CCR)*/
pub struct CPT1CCRrs;
impl crate::RegisterSpec for CPT1CCRrs {
    type Ux = u32;
}
///`read()` method returns [`cpt1ccr::R`](R) reader structure
impl crate::Readable for CPT1CCRrs {}
///`write(|w| ..)` method takes [`cpt1ccr::W`](W) writer structure
impl crate::Writable for CPT1CCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CPT1CCR to value 0
