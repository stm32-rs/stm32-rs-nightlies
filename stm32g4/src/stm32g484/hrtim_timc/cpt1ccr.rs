#[doc = "Reader of register CPT1CCR"]
pub type R = crate::R<u32, super::CPT1CCR>;
#[doc = "Writer for register CPT1CCR"]
pub type W = crate::W<u32, super::CPT1CCR>;
#[doc = "Register CPT1CCR `reset()`'s with value 0"]
impl crate::ResetValue for super::CPT1CCR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn tfcmp2(&self) -> TFCMP2_R {
        TFCMP2_R::new(((self.bits >> 23) & 0x01) != 0)
    }
    #[doc = "Bit 22 - TFCMP1"]
    #[inline(always)]
    pub fn tfcmp1(&self) -> TFCMP1_R {
        TFCMP1_R::new(((self.bits >> 22) & 0x01) != 0)
    }
    #[doc = "Bit 21 - TF1RST"]
    #[inline(always)]
