...
impl W {
    ...
    ///Bit 12 - Timer A Compare 2
    #[inline(always)]
    pub fn timacmp2(&mut self) -> TIMACMP2_W<RST1Rrs> {
        TIMACMP2_W::new(self, 12)
    }
    ///Bit 13 - Timer A Compare 3
    #[inline(always)]
    pub fn timacmp3(&mut self) -> TIMACMP3_W<RST1Rrs> {
    ...
    ///Bit 15 - Timer B Compare 3
    #[inline(always)]
    pub fn timbcmp3(&mut self) -> TIMBCMP3_W<RST1Rrs> {
    ...
    ///Bit 17 - Timer D Compare 4
    #[inline(always)]
    pub fn timdcmp4(&mut self) -> TIMDCMP4_W<RST1Rrs> {
    ...
    ///Bit 20 - Timer F Compare 2
    #[inline(always)]
    pub fn timfcmp2(&mut self) -> TIMFCMP2_W<RST1Rrs> {
