...
impl From<TIMACMP2> for bool {
    #[inline(always)]
    fn from(variant: TIMACMP2) -> Self {
        variant as u8 != 0
    }
}
///Field `TIMACMP2` reader - Timer A Compare 2
pub type TIMACMP2_R = crate::BitReader<TIMACMP2>;
impl TIMACMP2_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TIMACMP2 {
        match self.bits {
            false => TIMACMP2::NoEffect,
            true => TIMACMP2::SetInactive,
        }
    }
    ///Timer event has no effect
    #[inline(always)]
    pub fn is_no_effect(&self) -> bool {
        *self == TIMACMP2::NoEffect
    }
    ///Timer event forces the output to its inactive state
    #[inline(always)]
    pub fn is_set_inactive(&self) -> bool {
        *self == TIMACMP2::SetInactive
    }
}
///Field `TIMACMP2` writer - Timer A Compare 2
pub type TIMACMP2_W<'a, REG> = crate::BitWriter<'a, REG, TIMACMP2>;
impl<'a, REG> TIMACMP2_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Timer event has no effect
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_TIMC:RST1R)*/
pub struct RST1Rrs;
