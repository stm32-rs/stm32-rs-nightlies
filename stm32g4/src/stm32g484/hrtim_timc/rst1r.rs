...
///CMP%s
pub use crate::stm32g484::hrtim_tima::rst1r::CMP1;
///Field `CMP(1-4)` reader - CMP%s
pub use crate::stm32g484::hrtim_tima::rst1r::CMP_R;
///Field `CMP(1-4)` writer - CMP%s
pub use crate::stm32g484::hrtim_tima::rst1r::CMP_W;
///EXTEVNT%s
pub use crate::stm32g484::hrtim_tima::rst1r::EXTEVNT1;
///Field `EXTEVNT(1-10)` reader - EXTEVNT%s
pub use crate::stm32g484::hrtim_tima::rst1r::EXTEVNT_R;
///Field `EXTEVNT(1-10)` writer - EXTEVNT%s
pub use crate::stm32g484::hrtim_tima::rst1r::EXTEVNT_W;
///MSTCMP%s
pub use crate::stm32g484::hrtim_tima::rst1r::MSTCMP1;
///Field `MSTCMP(1-4)` reader - MSTCMP%s
pub use crate::stm32g484::hrtim_tima::rst1r::MSTCMP_R;
///Field `MSTCMP(1-4)` writer - MSTCMP%s
pub use crate::stm32g484::hrtim_tima::rst1r::MSTCMP_W;
///MSTPER
pub use crate::stm32g484::hrtim_tima::rst1r::MSTPER;
///Field `MSTPER` reader - MSTPER
pub use crate::stm32g484::hrtim_tima::rst1r::MSTPER_R;
///Field `MSTPER` writer - MSTPER
pub use crate::stm32g484::hrtim_tima::rst1r::MSTPER_W;
///PER
pub use crate::stm32g484::hrtim_tima::rst1r::PER;
///Field `PER` reader - PER
pub use crate::stm32g484::hrtim_tima::rst1r::PER_R;
///Field `PER` writer - PER
pub use crate::stm32g484::hrtim_tima::rst1r::PER_W;
///RESYNC
pub use crate::stm32g484::hrtim_tima::rst1r::RESYNC;
///Field `RESYNC` reader - RESYNC
pub use crate::stm32g484::hrtim_tima::rst1r::RESYNC_R;
///Field `RESYNC` writer - RESYNC
pub use crate::stm32g484::hrtim_tima::rst1r::RESYNC_W;
///SRT
pub use crate::stm32g484::hrtim_tima::rst1r::SRT;
///Field `SRT` reader - SRT
pub use crate::stm32g484::hrtim_tima::rst1r::SRT_R;
///Field `SRT` writer - SRT
pub use crate::stm32g484::hrtim_tima::rst1r::SRT_W;
///Timer A Compare 2
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1;
///Field `TIMACMP2` reader - Timer A Compare 2
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_R as TIMACMP2_R;
///Field `TIMACMP3` reader - Timer A Compare 3
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_R as TIMACMP3_R;
///Field `TIMBCMP2` reader - Timer B Compare 2
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_R as TIMBCMP2_R;
///Field `TIMBCMP3` reader - Timer B Compare 3
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_R as TIMBCMP3_R;
///Field `TIMDCMP2` reader - Timer D Compare 2
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_R as TIMDCMP2_R;
///Field `TIMDCMP4` reader - Timer D Compare 4
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_R as TIMDCMP4_R;
///Field `TIMECMP3` reader - Timer E Compare 3
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_R as TIMECMP3_R;
///Field `TIMECMP4` reader - Timer E Compare 4
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_R as TIMECMP4_R;
///Field `TIMFCMP2` reader - Timer F Compare 2
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_R as TIMFCMP2_R;
///Field `TIMACMP2` writer - Timer A Compare 2
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_W as TIMACMP2_W;
///Field `TIMACMP3` writer - Timer A Compare 3
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_W as TIMACMP3_W;
///Field `TIMBCMP2` writer - Timer B Compare 2
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_W as TIMBCMP2_W;
///Field `TIMBCMP3` writer - Timer B Compare 3
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_W as TIMBCMP3_W;
///Field `TIMDCMP2` writer - Timer D Compare 2
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_W as TIMDCMP2_W;
///Field `TIMDCMP4` writer - Timer D Compare 4
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_W as TIMDCMP4_W;
///Field `TIMECMP3` writer - Timer E Compare 3
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_W as TIMECMP3_W;
///Field `TIMECMP4` writer - Timer E Compare 4
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_W as TIMECMP4_W;
///Field `TIMFCMP2` writer - Timer F Compare 2
pub use crate::stm32g484::hrtim_tima::rst1r::TIMBCMP1_W as TIMFCMP2_W;
///UPDATE
pub use crate::stm32g484::hrtim_tima::rst1r::UPDATE;
///Field `UPDATE` reader - UPDATE
pub use crate::stm32g484::hrtim_tima::rst1r::UPDATE_R;
///Field `UPDATE` writer - UPDATE
pub use crate::stm32g484::hrtim_tima::rst1r::UPDATE_W;
impl R {
    ///Bit 0 - SRT
    #[inline(always)]
...
impl W {
    ...
    ///Bit 12 - Timer A Compare 2
    #[inline(always)]
    pub fn timacmp2(&mut self) -> TIMACMP2_W<'_, RST1Rrs> {
        TIMACMP2_W::new(self, 12)
    }
    ///Bit 13 - Timer A Compare 3
    #[inline(always)]
    pub fn timacmp3(&mut self) -> TIMACMP3_W<'_, RST1Rrs> {
        TIMACMP3_W::new(self, 13)
    }
    ///Bit 14 - Timer B Compare 2
    #[inline(always)]
    pub fn timbcmp2(&mut self) -> TIMBCMP2_W<'_, RST1Rrs> {
        TIMBCMP2_W::new(self, 14)
    }
    ///Bit 15 - Timer B Compare 3
    #[inline(always)]
    pub fn timbcmp3(&mut self) -> TIMBCMP3_W<'_, RST1Rrs> {
        TIMBCMP3_W::new(self, 15)
    }
    ///Bit 16 - Timer D Compare 2
    #[inline(always)]
    pub fn timdcmp2(&mut self) -> TIMDCMP2_W<'_, RST1Rrs> {
        TIMDCMP2_W::new(self, 16)
    }
    ///Bit 17 - Timer D Compare 4
    #[inline(always)]
    pub fn timdcmp4(&mut self) -> TIMDCMP4_W<'_, RST1Rrs> {
        TIMDCMP4_W::new(self, 17)
    }
    ///Bit 18 - Timer E Compare 3
    #[inline(always)]
    pub fn timecmp3(&mut self) -> TIMECMP3_W<'_, RST1Rrs> {
        TIMECMP3_W::new(self, 18)
    }
    ///Bit 19 - Timer E Compare 4
    #[inline(always)]
    pub fn timecmp4(&mut self) -> TIMECMP4_W<'_, RST1Rrs> {
        TIMECMP4_W::new(self, 19)
    }
    ///Bit 20 - Timer F Compare 2
    #[inline(always)]
    pub fn timfcmp2(&mut self) -> TIMFCMP2_W<'_, RST1Rrs> {
        TIMFCMP2_W::new(self, 20)
    }
    ///EXTEVNT(1-10)
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EXTEVNT1` field.</div>
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#HRTIM_TIMC:RST1R)*/
pub struct RST1Rrs;
