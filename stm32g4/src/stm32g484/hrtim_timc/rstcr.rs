...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timfcmp1(&mut self) -> TIMFCMP1_W<RSTCRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timfcpm2(&mut self) -> TIMFCPM2_W<RSTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_TIMC:RSTCR)*/
pub struct RSTCRrs;
