...
pub use TACMP1_R as TFCMP1_R;
///Field `TFCMP2` reader - TFCMP2
pub use TACMP1_R as TFCMP2_R;
...
pub use TACMP1_W as TFCMP1_W;
///Field `TFCMP2` writer - TFCMP2
pub use TACMP1_W as TFCMP2_W;
...
impl W {
    ...
    ///Bit 12 - Timer A output 1 Set
    #[inline(always)]
    pub fn ta1set(&mut self) -> TA1SET_W<CPT1CRrs> {
        TA1SET_W::new(self, 12)
    }
    ///Bit 13 - Timer A output 1 Reset
    #[inline(always)]
    pub fn ta1rst(&mut self) -> TA1RST_W<CPT1CRrs> {
        TA1RST_W::new(self, 13)
    }
    ///Bit 14 - Timer A Compare 1
    #[inline(always)]
    pub fn tacmp1(&mut self) -> TACMP1_W<CPT1CRrs> {
        TACMP1_W::new(self, 14)
    }
    ///Bit 15 - Timer A Compare 2
    #[inline(always)]
    pub fn tacmp2(&mut self) -> TACMP2_W<CPT1CRrs> {
