#[doc = "Reader of register FLTDR"]
pub type R = crate::R<u32, super::FLTDR>;
#[doc = "Writer for register FLTDR"]
pub type W = crate::W<u32, super::FLTDR>;
#[doc = "Register FLTDR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLTDR {
    type Type = u32;
    #[inline(always)]
