///Register `CHPER` reader
pub type R = crate::R<CHPERrs>;
///Register `CHPER` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_TIME:CHPER)*/
pub struct CHPERrs;
impl crate::RegisterSpec for CHPERrs {
    type Ux = u32;
}
///`read()` method returns [`chper::R`](R) reader structure
impl crate::Readable for CHPERrs {}
///`write(|w| ..)` method takes [`chper::W`](W) writer structure
impl crate::Writable for CHPERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CHPER to value 0
