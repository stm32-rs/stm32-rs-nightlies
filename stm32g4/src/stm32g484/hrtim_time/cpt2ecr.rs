...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> TF1SET_W<CPT2ECRrs> {
        TF1SET_W::new(self, 28)
    }
    #[doc = "Bit 29 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> TF1RST_W<CPT2ECRrs> {
        TF1RST_W::new(self, 29)
    }
    #[doc = "Bit 30 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> TFCMP1_W<CPT2ECRrs> {
        TFCMP1_W::new(self, 30)
    }
    #[doc = "Bit 31 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> TFCMP2_W<CPT2ECRrs> {
        TFCMP2_W::new(self, 31)
    }
}
#[doc = "CPT2xCR\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpt2ecr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpt2ecr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
