    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn set_active(self) -> &'a mut crate::W<REG> {
        self.variant(TIMACMP4::SetActive)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_TIME:SET1R)*/
pub struct SET1Rrs;
