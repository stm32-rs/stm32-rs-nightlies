#[doc = "Reader of register CHPFR"]
pub type R = crate::R<u32, super::CHPFR>;
#[doc = "Writer for register CHPFR"]
pub type W = crate::W<u32, super::CHPFR>;
#[doc = "Register CHPFR `reset()`'s with value 0"]
impl crate::ResetValue for super::CHPFR {
    type Type = u32;
    #[inline(always)]
