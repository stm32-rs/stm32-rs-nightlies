...
You can [`read`](crate::Reg::read) this register and get [`cpt2fr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`cpt2fr::R`](R) reader structure
impl crate::Readable for CPT2FRrs {}
///`reset()` method sets CPT2FR to value 0
