...
pub type R = crate::R<RSTFRrs>;
///Register `RSTFR` writer
pub type W = crate::W<RSTFRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timfcmp1(&mut self) -> TIMFCMP1_W<RSTFRrs> {
        TIMFCMP1_W::new(self, 0)
    }
    ///Bit 1 - Timer A Update reset
    #[inline(always)]
    #[must_use]
    pub fn updt(&mut self) -> UPDT_W<RSTFRrs> {
        UPDT_W::new(self, 1)
    }
    ///Bit 2 - Timer A compare 2 reset
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> CMP2_W<RSTFRrs> {
        CMP2_W::new(self, 2)
    }
    ///Bit 3 - Timer A compare 4 reset
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> CMP4_W<RSTFRrs> {
        CMP4_W::new(self, 3)
    }
    ///Bit 4 - Master timer Period
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MSTPER_W<RSTFRrs> {
        MSTPER_W::new(self, 4)
    }
    ///Bit 5 - Master compare 1
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> MSTCMP1_W<RSTFRrs> {
        MSTCMP1_W::new(self, 5)
    }
    ///Bit 6 - Master compare 2
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> MSTCMP2_W<RSTFRrs> {
        MSTCMP2_W::new(self, 6)
    }
    ///Bit 7 - Master compare 3
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> MSTCMP3_W<RSTFRrs> {
        MSTCMP3_W::new(self, 7)
    }
    ///Bit 8 - Master compare 4
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> MSTCMP4_W<RSTFRrs> {
        MSTCMP4_W::new(self, 8)
    }
    ///Bit 9 - External Event 1
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> EXTEVNT1_W<RSTFRrs> {
        EXTEVNT1_W::new(self, 9)
    }
    ///Bit 10 - External Event 2
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> EXTEVNT2_W<RSTFRrs> {
        EXTEVNT2_W::new(self, 10)
    }
    ///Bit 11 - External Event 3
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> EXTEVNT3_W<RSTFRrs> {
        EXTEVNT3_W::new(self, 11)
    }
    ///Bit 12 - External Event 4
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> EXTEVNT4_W<RSTFRrs> {
        EXTEVNT4_W::new(self, 12)
    }
    ///Bit 13 - External Event 5
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> EXTEVNT5_W<RSTFRrs> {
        EXTEVNT5_W::new(self, 13)
    }
    ///Bit 14 - External Event 6
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> EXTEVNT6_W<RSTFRrs> {
        EXTEVNT6_W::new(self, 14)
    }
    ///Bit 15 - External Event 7
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> EXTEVNT7_W<RSTFRrs> {
        EXTEVNT7_W::new(self, 15)
    }
    ///Bit 16 - External Event 8
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> EXTEVNT8_W<RSTFRrs> {
        EXTEVNT8_W::new(self, 16)
    }
    ///Bit 17 - External Event 9
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> EXTEVNT9_W<RSTFRrs> {
        EXTEVNT9_W::new(self, 17)
    }
    ///Bit 18 - External Event 10
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> EXTEVNT10_W<RSTFRrs> {
        EXTEVNT10_W::new(self, 18)
    }
    ///Bit 19 - Timer A Compare 1
    #[inline(always)]
    #[must_use]
    pub fn timacmp1(&mut self) -> TIMACMP1_W<RSTFRrs> {
        TIMACMP1_W::new(self, 19)
    }
    ///Bit 20 - Timer A Compare 2
    #[inline(always)]
    #[must_use]
    pub fn timacmp2(&mut self) -> TIMACMP2_W<RSTFRrs> {
        TIMACMP2_W::new(self, 20)
    }
    ///Bit 21 - Timer A Compare 4
    #[inline(always)]
    #[must_use]
    pub fn timacmp4(&mut self) -> TIMACMP4_W<RSTFRrs> {
        TIMACMP4_W::new(self, 21)
    }
    ///Bit 22 - Timer B Compare 1
    #[inline(always)]
    #[must_use]
    pub fn timbcmp1(&mut self) -> TIMBCMP1_W<RSTFRrs> {
        TIMBCMP1_W::new(self, 22)
    }
    ///Bit 23 - Timer B Compare 2
    #[inline(always)]
    #[must_use]
    pub fn timbcmp2(&mut self) -> TIMBCMP2_W<RSTFRrs> {
        TIMBCMP2_W::new(self, 23)
    }
    ///Bit 24 - Timer B Compare 4
    #[inline(always)]
    #[must_use]
    pub fn timbcmp4(&mut self) -> TIMBCMP4_W<RSTFRrs> {
        TIMBCMP4_W::new(self, 24)
    }
    ///Bit 25 - Timer C Compare 1
    #[inline(always)]
    #[must_use]
    pub fn timccmp1(&mut self) -> TIMCCMP1_W<RSTFRrs> {
        TIMCCMP1_W::new(self, 25)
    }
    ///Bit 26 - Timer C Compare 2
    #[inline(always)]
    #[must_use]
    pub fn timccmp2(&mut self) -> TIMCCMP2_W<RSTFRrs> {
        TIMCCMP2_W::new(self, 26)
    }
    ///Bit 27 - Timer C Compare 4
    #[inline(always)]
    #[must_use]
    pub fn timccmp4(&mut self) -> TIMCCMP4_W<RSTFRrs> {
        TIMCCMP4_W::new(self, 27)
    }
    ///Bit 28 - Timer D Compare 1
    #[inline(always)]
    #[must_use]
    pub fn timdcmp1(&mut self) -> TIMDCMP1_W<RSTFRrs> {
        TIMDCMP1_W::new(self, 28)
    }
    ///Bit 29 - Timer D Compare 2
    #[inline(always)]
    #[must_use]
    pub fn timdcmp2(&mut self) -> TIMDCMP2_W<RSTFRrs> {
        TIMDCMP2_W::new(self, 29)
    }
    ///Bit 30 - Timer D Compare 4
    #[inline(always)]
    #[must_use]
    pub fn timdcmp4(&mut self) -> TIMDCMP4_W<RSTFRrs> {
        TIMDCMP4_W::new(self, 30)
    }
    ///Bit 31 - Timer F Compare 2
    #[inline(always)]
    #[must_use]
    pub fn timfcpm2(&mut self) -> TIMFCPM2_W<RSTFRrs> {
        TIMFCPM2_W::new(self, 31)
    }
}
/**TimerA Reset Register

You can [`read`](crate::Reg::read) this register and get [`rstfr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rstfr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#HRTIM_TIMF:RSTFR)*/
pub struct RSTFRrs;
impl crate::RegisterSpec for RSTFRrs {
    type Ux = u32;
}
///`read()` method returns [`rstfr::R`](R) reader structure
impl crate::Readable for RSTFRrs {}
///`write(|w| ..)` method takes [`rstfr::W`](W) writer structure
impl crate::Writable for RSTFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RSTFR to value 0
impl crate::Resettable for RSTFRrs {
