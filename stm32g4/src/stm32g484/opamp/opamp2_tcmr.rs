///Register `OPAMP2_TCMR` reader
pub type R = crate::R<OPAMP2_TCMRrs>;
///Register `OPAMP2_TCMR` writer
...
///VPS_SEL
pub use super::opamp2_csr::VP_SEL;
///Field `VPS_SEL` reader - VPS_SEL
pub use super::opamp2_csr::VP_SEL_R as VPS_SEL_R;
///Field `VPS_SEL` writer - VPS_SEL
pub use super::opamp2_csr::VP_SEL_W as VPS_SEL_W;
impl R {
    ///Bit 0 - VMS_SEL
    #[inline(always)]
...
impl W {
    ///Bit 0 - VMS_SEL
    #[inline(always)]
    pub fn vms_sel(&mut self) -> VMS_SEL_W<'_, OPAMP2_TCMRrs> {
        VMS_SEL_W::new(self, 0)
    }
    ///Bits 1:2 - VPS_SEL
    #[inline(always)]
    pub fn vps_sel(&mut self) -> VPS_SEL_W<'_, OPAMP2_TCMRrs> {
        VPS_SEL_W::new(self, 1)
    }
    ///Bit 3 - T1CM_EN
    #[inline(always)]
    pub fn t1cm_en(&mut self) -> T1CM_EN_W<'_, OPAMP2_TCMRrs> {
        T1CM_EN_W::new(self, 3)
    }
    ///Bit 4 - T8CM_EN
    #[inline(always)]
    pub fn t8cm_en(&mut self) -> T8CM_EN_W<'_, OPAMP2_TCMRrs> {
        T8CM_EN_W::new(self, 4)
    }
    ///Bit 5 - T20CM_EN
    #[inline(always)]
    pub fn t20cm_en(&mut self) -> T20CM_EN_W<'_, OPAMP2_TCMRrs> {
        T20CM_EN_W::new(self, 5)
    }
    ///Bit 31 - LOCK
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<'_, OPAMP2_TCMRrs> {
        LOCK_W::new(self, 31)
    }
}
/**OPAMP2 control/status register

You can [`read`](crate::Reg::read) this register and get [`opamp2_tcmr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opamp2_tcmr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#OPAMP:OPAMP2_TCMR)*/
pub struct OPAMP2_TCMRrs;
impl crate::RegisterSpec for OPAMP2_TCMRrs {
    type Ux = u32;
}
///`read()` method returns [`opamp2_tcmr::R`](R) reader structure
impl crate::Readable for OPAMP2_TCMRrs {}
///`write(|w| ..)` method takes [`opamp2_tcmr::W`](W) writer structure
