...
impl W {
    ///Bit 0 - Operational amplifier Enable
    #[inline(always)]
    pub fn opaen(&mut self) -> OPAEN_W<OPAMP5_CSRrs> {
        OPAEN_W::new(self, 0)
    }
    ///Bit 1 - FORCE_VP
    #[inline(always)]
    pub fn force_vp(&mut self) -> FORCE_VP_W<OPAMP5_CSRrs> {
        FORCE_VP_W::new(self, 1)
    }
    ///Bits 2:3 - VP_SEL
    #[inline(always)]
    pub fn vp_sel(&mut self) -> VP_SEL_W<OPAMP5_CSRrs> {
        VP_SEL_W::new(self, 2)
    }
    ///Bit 4 - USERTRIM
    #[inline(always)]
    pub fn usertrim(&mut self) -> USERTRIM_W<OPAMP5_CSRrs> {
        USERTRIM_W::new(self, 4)
    }
    ///Bits 5:6 - VM_SEL
    #[inline(always)]
    pub fn vm_sel(&mut self) -> VM_SEL_W<OPAMP5_CSRrs> {
        VM_SEL_W::new(self, 5)
    }
    ///Bit 7 - OPAHSM
    #[inline(always)]
    pub fn opahsm(&mut self) -> OPAHSM_W<OPAMP5_CSRrs> {
        OPAHSM_W::new(self, 7)
    }
    ///Bit 8 - OPAINTOEN
    #[inline(always)]
    pub fn opaintoen(&mut self) -> OPAINTOEN_W<OPAMP5_CSRrs> {
        OPAINTOEN_W::new(self, 8)
    }
    ///Bit 11 - CALON
    #[inline(always)]
    pub fn calon(&mut self) -> CALON_W<OPAMP5_CSRrs> {
        CALON_W::new(self, 11)
    }
    ///Bits 12:13 - CALSEL
    #[inline(always)]
    pub fn calsel(&mut self) -> CALSEL_W<OPAMP5_CSRrs> {
        CALSEL_W::new(self, 12)
    }
    ///Bits 14:18 - PGA_GAIN
    #[inline(always)]
    pub fn pga_gain(&mut self) -> PGA_GAIN_W<OPAMP5_CSRrs> {
        PGA_GAIN_W::new(self, 14)
    }
    ///Bits 19:23 - TRIMOFFSETP
    #[inline(always)]
    pub fn trimoffsetp(&mut self) -> TRIMOFFSETP_W<OPAMP5_CSRrs> {
        TRIMOFFSETP_W::new(self, 19)
    }
    ///Bits 24:28 - TRIMOFFSETN
    #[inline(always)]
    pub fn trimoffsetn(&mut self) -> TRIMOFFSETN_W<OPAMP5_CSRrs> {
        TRIMOFFSETN_W::new(self, 24)
    }
    ///Bit 30 - CALOUT
    #[inline(always)]
    pub fn calout(&mut self) -> CALOUT_W<OPAMP5_CSRrs> {
        CALOUT_W::new(self, 30)
    }
    ///Bit 31 - LOCK
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<OPAMP5_CSRrs> {
        LOCK_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#OPAMP:OPAMP5_CSR)*/
