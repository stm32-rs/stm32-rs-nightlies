///Register `OPAMP6_TCMR` reader
pub type R = crate::R<OPAMP6_TCMRrs>;
///Register `OPAMP6_TCMR` writer
pub type W = crate::W<OPAMP6_TCMRrs>;
...
///VPS_SEL
pub use super::opamp6_csr::VP_SEL;
///Field `VPS_SEL` reader - VPS_SEL
pub use super::opamp6_csr::VP_SEL_R as VPS_SEL_R;
///Field `VPS_SEL` writer - VPS_SEL
pub use super::opamp6_csr::VP_SEL_W as VPS_SEL_W;
impl R {
    ///Bit 0 - VMS_SEL
    #[inline(always)]
...
impl W {
    ///Bit 0 - VMS_SEL
    #[inline(always)]
    pub fn vms_sel(&mut self) -> VMS_SEL_W<'_, OPAMP6_TCMRrs> {
        VMS_SEL_W::new(self, 0)
    }
    ///Bits 1:2 - VPS_SEL
    #[inline(always)]
    pub fn vps_sel(&mut self) -> VPS_SEL_W<'_, OPAMP6_TCMRrs> {
        VPS_SEL_W::new(self, 1)
    }
    ///Bit 3 - T1CM_EN
    #[inline(always)]
    pub fn t1cm_en(&mut self) -> T1CM_EN_W<'_, OPAMP6_TCMRrs> {
        T1CM_EN_W::new(self, 3)
    }
    ///Bit 4 - T8CM_EN
    #[inline(always)]
    pub fn t8cm_en(&mut self) -> T8CM_EN_W<'_, OPAMP6_TCMRrs> {
        T8CM_EN_W::new(self, 4)
    }
    ///Bit 5 - T20CM_EN
    #[inline(always)]
    pub fn t20cm_en(&mut self) -> T20CM_EN_W<'_, OPAMP6_TCMRrs> {
        T20CM_EN_W::new(self, 5)
    }
    ///Bit 31 - LOCK
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<'_, OPAMP6_TCMRrs> {
        LOCK_W::new(self, 31)
    }
}
/**OPAMP6 control/status register

You can [`read`](crate::Reg::read) this register and get [`opamp6_tcmr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opamp6_tcmr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484.html#OPAMP:OPAMP6_TCMR)*/
pub struct OPAMP6_TCMRrs;
impl crate::RegisterSpec for OPAMP6_TCMRrs {
    type Ux = u32;
}
///`read()` method returns [`opamp6_tcmr::R`](R) reader structure
impl crate::Readable for OPAMP6_TCMRrs {}
///`write(|w| ..)` method takes [`opamp6_tcmr::W`](W) writer structure
impl crate::Writable for OPAMP6_TCMRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OPAMP6_TCMR to value 0
impl crate::Resettable for OPAMP6_TCMRrs {}
