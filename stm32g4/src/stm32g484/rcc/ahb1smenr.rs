...
pub struct CORDICSMEN_R(crate::FieldReader<bool, bool>);
impl CORDICSMEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        CORDICSMEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORDICSMEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct FMACSMEN_R(crate::FieldReader<bool, bool>);
impl FMACSMEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        FMACSMEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FMACSMEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
