...
///Field `CRSEN` reader - CRSclock enable
...
///Field `CRSEN` writer - CRSclock enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#RCC:APB1ENR1)*/
