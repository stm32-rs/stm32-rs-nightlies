...
///Field `CRSSMEN` reader - CRS clock enable during sleep mode
pub type CRSSMEN_R = crate::BitReader;
///Field `CRSSMEN` writer - CRS clock enable during sleep mode
...
///Field `LPTIM1SMEN` reader - Low Power Timer1 clock enable during sleep mode
pub type LPTIM1SMEN_R = crate::BitReader;
///Field `LPTIM1SMEN` writer - Low Power Timer1 clock enable during sleep mode
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G484xx.html#RCC:APB1SMENR1)*/
