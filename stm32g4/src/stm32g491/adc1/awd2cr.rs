...
///Field `AWD2CH(0-18)` reader - Analog watchdog 2 channel selection
...
///Field `AWD2CH(0-18)` writer - Analog watchdog 2 channel selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G491.html#ADC1:AWD2CR)*/
pub struct AWD2CRrs;
