...
///Field `SEC_SIZE1` reader - sets the number of pages used in the Securable area.
pub type SEC_SIZE1_R = crate::FieldReader<u16>;
///Field `SEC_SIZE1` writer - sets the number of pages used in the Securable area.
pub type SEC_SIZE1_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
...
impl R {
    ///Bits 0:8 - sets the number of pages used in the Securable area.
    #[inline(always)]
    pub fn sec_size1(&self) -> SEC_SIZE1_R {
        SEC_SIZE1_R::new((self.bits & 0x01ff) as u16)
    }
...
///`reset()` method sets SEC1R to value 0xfff0_f000
impl crate::Resettable for SEC1Rrs {
    const RESET_VALUE: u32 = 0xfff0_f000;
}
