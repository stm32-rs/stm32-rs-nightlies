...
pub use crate::stm32g491::gpioa::ospeedr::OSPEEDR_R;
///Field `OSPEEDR(0-15)` writer - Port x configuration pin %s
pub use crate::stm32g491::gpioa::ospeedr::OSPEEDR_W;
///Port x configuration pin %s
pub use crate::stm32g491::gpioa::ospeedr::OUTPUT_SPEED;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G491.html#GPIOC:OSPEEDR)*/
