...
///Field `TIM2SMEN` reader - TIM2 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM2SMEN_R = crate::BitReader;
///Field `TIM2SMEN` writer - TIM2 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM2SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM3SMEN` reader - TIM3 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM3SMEN_R = crate::BitReader;
///Field `TIM3SMEN` writer - TIM3 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM3SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM4SMEN` reader - TIM4 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM4SMEN_R = crate::BitReader;
///Field `TIM4SMEN` writer - TIM4 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM4SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM5SMEN` reader - TIM5 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM5SMEN_R = crate::BitReader;
///Field `TIM5SMEN` writer - TIM5 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM5SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM6SMEN` reader - TIM6 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM6SMEN_R = crate::BitReader;
///Field `TIM6SMEN` writer - TIM6 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM6SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM7SMEN` reader - TIM7 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM7SMEN_R = crate::BitReader;
///Field `TIM7SMEN` writer - TIM7 timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type TIM7SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRSSMEN` reader - CRS timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type CRSSMEN_R = crate::BitReader;
///Field `CRSSMEN` writer - CRS timer clocks enable during Sleep and Stop modes Set and cleared by software.
pub type CRSSMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RTCAPBSMEN` reader - RTC APB clock enable during Sleep and Stop modes Set and cleared by software
pub type RTCAPBSMEN_R = crate::BitReader;
///Field `RTCAPBSMEN` writer - RTC APB clock enable during Sleep and Stop modes Set and cleared by software
...
///Field `SPI2SMEN` reader - SPI2 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type SPI2SMEN_R = crate::BitReader;
///Field `SPI2SMEN` writer - SPI2 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type SPI2SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI3SMEN` reader - SPI3 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type SPI3SMEN_R = crate::BitReader;
///Field `SPI3SMEN` writer - SPI3 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type SPI3SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USART2SMEN` reader - USART2 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type USART2SMEN_R = crate::BitReader;
///Field `USART2SMEN` writer - USART2 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type USART2SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USART3SMEN` reader - USART3 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type USART3SMEN_R = crate::BitReader;
///Field `USART3SMEN` writer - USART3 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type USART3SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART4SMEN` reader - UART4 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type UART4SMEN_R = crate::BitReader;
///Field `UART4SMEN` writer - UART4 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type UART4SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART5SMEN` reader - UART5 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type UART5SMEN_R = crate::BitReader;
///Field `UART5SMEN` writer - UART5 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type UART5SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C1SMEN` reader - I2C1 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type I2C1SMEN_R = crate::BitReader;
///Field `I2C1SMEN` writer - I2C1 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type I2C1SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C2SMEN` reader - I2C2 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type I2C2SMEN_R = crate::BitReader;
///Field `I2C2SMEN` writer - I2C2 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type I2C2SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USBSMEN` reader - USB device clocks enable during Sleep and Stop modes Set and cleared by software.
pub type USBSMEN_R = crate::BitReader;
///Field `USBSMEN` writer - USB device clocks enable during Sleep and Stop modes Set and cleared by software.
pub type USBSMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FDCANSMEN` reader - FDCAN clocks enable during Sleep and Stop modes Set and cleared by software.
pub type FDCANSMEN_R = crate::BitReader;
///Field `FDCANSMEN` writer - FDCAN clocks enable during Sleep and Stop modes Set and cleared by software.
pub type FDCANSMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWRSMEN` reader - Power interface clocks enable during Sleep and Stop modes Set and cleared by software.
pub type PWRSMEN_R = crate::BitReader;
///Field `PWRSMEN` writer - Power interface clocks enable during Sleep and Stop modes Set and cleared by software.
pub type PWRSMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C3SMEN` reader - I2C3 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type I2C3SMEN_R = crate::BitReader;
///Field `I2C3SMEN` writer - I2C3 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type I2C3SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPTIM1SMEN` reader - Low power timer 1 clocks enable during Sleep and Stop modes Set and cleared by software.
pub type LPTIM1SMEN_R = crate::BitReader;
///Field `LPTIM1SMEN` writer - Low power timer 1 clocks enable during Sleep and Stop modes Set and cleared by software.
...
impl W {
    ...
    ///Bit 15 - SPI3 clocks enable during Sleep and Stop modes Set and cleared by software.
    #[inline(always)]
    pub fn spi3smen(&mut self) -> SPI3SMEN_W<APB1SMENR1rs> {
    ...
    ///Bit 25 - FDCAN clocks enable during Sleep and Stop modes Set and cleared by software.
    #[inline(always)]
    pub fn fdcansmen(&mut self) -> FDCANSMEN_W<APB1SMENR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G491.html#RCC:APB1SMENR1)*/
