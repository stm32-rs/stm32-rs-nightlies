...
impl From<LP_MODE> for bool {
    #[inline(always)]
    fn from(variant: LP_MODE) -> Self {
        variant as u8 != 0
    }
}
///Field `LP_MODE` reader - LP_MODE
pub type LP_MODE_R = crate::BitReader<LP_MODE>;
impl LP_MODE_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> LP_MODE {
        match self.bits {
            false => LP_MODE::Disabled,
            true => LP_MODE::Enabled,
        }
    }
    ///No low-power mode
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == LP_MODE::Disabled
    }
    ///Enter low-power mode
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == LP_MODE::Enabled
    }
}
///Field `LP_MODE` writer - LP_MODE
pub type LP_MODE_W<'a, REG> = crate::BitWriter<'a, REG, LP_MODE>;
impl<'a, REG> LP_MODE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///No low-power mode
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(LP_MODE::Disabled)
    }
    ///Enter low-power mode
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(LP_MODE::Enabled)
    }
}
/**FSUSP
...
impl W {
    ...
    ///Bit 2 - LP_MODE
    #[inline(always)]
    pub fn lp_mode(&mut self) -> LP_MODE_W<'_, CNTRrs> {
    ...
    ///Bit 5 - L1RESUME
    #[inline(always)]
    pub fn l1resume(&mut self) -> L1RESUME_W<'_, CNTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G491.html#USB:CNTR)*/
pub struct CNTRrs;
