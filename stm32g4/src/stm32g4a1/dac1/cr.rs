...
impl TSEL1_R {
    ...
    pub const fn variant(&self) -> TSEL1 {
        match self.bits {
            ...
            7 => TSEL1::Tim6trgo,
            8 => TSEL1::Tim3trgo,
            9 => TSEL1::HrtimDacReset1,
            10 => TSEL1::HrtimDacReset2,
            11 => TSEL1::HrtimDacReset3,
            12 => TSEL1::HrtimDacReset4,
            13 => TSEL1::HrtimDacReset5,
            14 => TSEL1::HrtimDacReset6,
            15 => TSEL1::HrtimDacX,
            _ => unreachable!(),
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn tim1or8trgo(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Tim1or8trgo)
    }
    ///Timer 7 TRGO event
    #[inline(always)]
...
impl W {
    ...
    ///Bit 16 - DAC channel2 enable
    #[inline(always)]
    pub fn en2(&mut self) -> EN_W<'_, CRrs> {
        EN_W::new(self, 16)
    }
    ///DAC channel(1-2) trigger enable
    ///
    ...
    ///Bit 17 - DAC channel2 trigger enable
    #[inline(always)]
    pub fn ten2(&mut self) -> TEN_W<'_, CRrs> {
        TEN_W::new(self, 17)
    }
    ///Bits 2:5 - DAC channel1 trigger selection These bits select the external event used to trigger DAC channel1. Note: Only used if bit TEN1 = 1 (DAC channel1 trigger enabled).
    #[inline(always)]
    ...
    ///Bits 22:23 - DAC channel2 noise/triangle wave generation enable
    #[inline(always)]
    pub fn wave2(&mut self) -> WAVE_W<'_, CRrs> {
        WAVE_W::new(self, 22)
    }
    ///DAC channel(1-2) mask/amplitude selector
    ///
    ...
    ///Bits 24:27 - DAC channel2 mask/amplitude selector
    #[inline(always)]
    pub fn mamp2(&mut self) -> MAMP_W<'_, CRrs> {
        MAMP_W::new(self, 24)
    }
    ///DAC channel(1-2) DMA enable
    ///
    ...
    ///Bit 28 - DAC channel2 DMA enable
    #[inline(always)]
    pub fn dmaen2(&mut self) -> DMAEN_W<'_, CRrs> {
        DMAEN_W::new(self, 28)
    }
    ///DAC channel(1-2) DMA Underrun Interrupt enable
    ///
    ...
    ///Bit 29 - DAC channel2 DMA Underrun Interrupt enable
    #[inline(always)]
    pub fn dmaudrie2(&mut self) -> DMAUDRIE_W<'_, CRrs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `CEN1` field.</div>
    #[inline(always)]
    pub fn cen(&mut self, n: u8) -> CEN_W<'_, CRrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 14 - DAC channel1 calibration enable
    #[inline(always)]
    pub fn cen1(&mut self) -> CEN_W<'_, CRrs> {
        CEN_W::new(self, 14)
    }
    ///Bit 30 - DAC channel2 calibration enable
    #[inline(always)]
    pub fn cen2(&mut self) -> CEN_W<'_, CRrs> {
        CEN_W::new(self, 30)
    }
    ///Bits 18:21 - DAC channel2 trigger selection These bits select the external event used to trigger DAC channel2 Note: Only used if bit TEN2 = 1 (DAC channel2 trigger enabled).
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G4A1.html#DAC1:CR)*/
pub struct CRrs;
