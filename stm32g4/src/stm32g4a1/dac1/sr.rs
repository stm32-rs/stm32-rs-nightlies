...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DAC1RDY` field.</div>
    #[inline(always)]
    pub fn dacrdy(&mut self, n: u8) -> DACRDY_W<SRrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 11 - DAC channel1 ready status bit
    #[inline(always)]
    pub fn dac1rdy(&mut self) -> DACRDY_W<SRrs> {
        DACRDY_W::new(self, 11)
    }
    ///Bit 27 - DAC channel2 ready status bit
    #[inline(always)]
    pub fn dac2rdy(&mut self) -> DACRDY_W<SRrs> {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DORSTAT1` field.</div>
    #[inline(always)]
    pub fn dorstat(&mut self, n: u8) -> DORSTAT_W<SRrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 12 - DAC channel1 output register status bit
    #[inline(always)]
    pub fn dorstat1(&mut self) -> DORSTAT_W<SRrs> {
        DORSTAT_W::new(self, 12)
    }
    ///Bit 28 - DAC channel2 output register status bit
    #[inline(always)]
    pub fn dorstat2(&mut self) -> DORSTAT_W<SRrs> {
