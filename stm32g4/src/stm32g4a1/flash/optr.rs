...
///Field `PB4_PUPEN` reader - PB4 pull-up enable
pub type PB4_PUPEN_R = crate::BitReader;
///Field `PB4_PUPEN` writer - PB4 pull-up enable
pub type PB4_PUPEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    ///Bit 22 - PB4 pull-up enable
    #[inline(always)]
    pub fn pb4_pupen(&self) -> PB4_PUPEN_R {
        PB4_PUPEN_R::new(((self.bits >> 22) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 22 - PB4 pull-up enable
    #[inline(always)]
    pub fn pb4_pupen(&mut self) -> PB4_PUPEN_W<'_, OPTRrs> {
        PB4_PUPEN_W::new(self, 22)
    }
    ///Bit 23 - Boot configuration
    #[inline(always)]
