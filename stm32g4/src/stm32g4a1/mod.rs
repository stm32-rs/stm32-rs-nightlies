/*!Peripheral access API for STM32G4A1XX microcontrollers (generated using svd2rust v0.35.0 (b6ef0b0 2024-11-13))
...
///USB_FS_device
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32G4A1xx.html#USB)
pub struct USB {
    _marker: PhantomData<*const ()>,
}
