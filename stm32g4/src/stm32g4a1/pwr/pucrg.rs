...
///Field `PU0` reader - Port G pull-up bit y (y=0..10)
pub type PU0_R = crate::BitReader;
///Field `PU0` writer - Port G pull-up bit y (y=0..10)
pub type PU0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU1` reader - Port G pull-up bit y (y=0..10)
pub type PU1_R = crate::BitReader;
///Field `PU1` writer - Port G pull-up bit y (y=0..10)
pub type PU1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU2` reader - Port G pull-up bit y (y=0..10)
pub type PU2_R = crate::BitReader;
///Field `PU2` writer - Port G pull-up bit y (y=0..10)
pub type PU2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU3` reader - Port G pull-up bit y (y=0..10)
pub type PU3_R = crate::BitReader;
///Field `PU3` writer - Port G pull-up bit y (y=0..10)
pub type PU3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU4` reader - Port G pull-up bit y (y=0..10)
pub type PU4_R = crate::BitReader;
///Field `PU4` writer - Port G pull-up bit y (y=0..10)
pub type PU4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU5` reader - Port G pull-up bit y (y=0..10)
pub type PU5_R = crate::BitReader;
///Field `PU5` writer - Port G pull-up bit y (y=0..10)
pub type PU5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU6` reader - Port G pull-up bit y (y=0..10)
pub type PU6_R = crate::BitReader;
///Field `PU6` writer - Port G pull-up bit y (y=0..10)
pub type PU6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU7` reader - Port G pull-up bit y (y=0..10)
pub type PU7_R = crate::BitReader;
///Field `PU7` writer - Port G pull-up bit y (y=0..10)
pub type PU7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU8` reader - Port G pull-up bit y (y=0..10)
pub type PU8_R = crate::BitReader;
///Field `PU8` writer - Port G pull-up bit y (y=0..10)
pub type PU8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU9` reader - Port G pull-up bit y (y=0..10)
pub type PU9_R = crate::BitReader;
///Field `PU9` writer - Port G pull-up bit y (y=0..10)
pub type PU9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU10` reader - Port G pull-up bit y (y=0..10)
pub type PU10_R = crate::BitReader;
///Field `PU10` writer - Port G pull-up bit y (y=0..10)
pub type PU10_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu0(&self) -> PU0_R {
        PU0_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu1(&self) -> PU1_R {
        PU1_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu2(&self) -> PU2_R {
        PU2_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu3(&self) -> PU3_R {
        PU3_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu4(&self) -> PU4_R {
        PU4_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu5(&self) -> PU5_R {
        PU5_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu6(&self) -> PU6_R {
        PU6_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu7(&self) -> PU7_R {
        PU7_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu8(&self) -> PU8_R {
        PU8_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu9(&self) -> PU9_R {
        PU9_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
...
impl W {
    ///Bit 0 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu0(&mut self) -> PU0_W<'_, PUCRGrs> {
        PU0_W::new(self, 0)
    }
    ///Bit 1 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu1(&mut self) -> PU1_W<'_, PUCRGrs> {
        PU1_W::new(self, 1)
    }
    ///Bit 2 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu2(&mut self) -> PU2_W<'_, PUCRGrs> {
        PU2_W::new(self, 2)
    }
    ///Bit 3 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu3(&mut self) -> PU3_W<'_, PUCRGrs> {
        PU3_W::new(self, 3)
    }
    ///Bit 4 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu4(&mut self) -> PU4_W<'_, PUCRGrs> {
        PU4_W::new(self, 4)
    }
    ///Bit 5 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu5(&mut self) -> PU5_W<'_, PUCRGrs> {
        PU5_W::new(self, 5)
    }
    ///Bit 6 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu6(&mut self) -> PU6_W<'_, PUCRGrs> {
        PU6_W::new(self, 6)
    }
    ///Bit 7 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu7(&mut self) -> PU7_W<'_, PUCRGrs> {
        PU7_W::new(self, 7)
    }
    ///Bit 8 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu8(&mut self) -> PU8_W<'_, PUCRGrs> {
        PU8_W::new(self, 8)
    }
    ///Bit 9 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu9(&mut self) -> PU9_W<'_, PUCRGrs> {
        PU9_W::new(self, 9)
    }
    ///Bit 10 - Port G pull-up bit y (y=0..10)
    #[inline(always)]
    pub fn pu10(&mut self) -> PU10_W<'_, PUCRGrs> {
        PU10_W::new(self, 10)
    }
}
