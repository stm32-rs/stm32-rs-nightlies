...
pub struct SMSPS_R(crate::FieldReader<bool, bool>);
impl SMSPS_R {
    pub(crate) fn new(bits: bool) -> Self {
        SMSPS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SMSPS_R {
...
pub struct SMSPE_R(crate::FieldReader<bool, bool>);
impl SMSPE_R {
    pub(crate) fn new(bits: bool) -> Self {
        SMSPE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SMSPE_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
