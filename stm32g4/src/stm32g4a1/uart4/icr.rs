...
pub use crate::stm32g4a1::usart1::icr::CMCF;
///Field `CMCF` writer - Character match clear flag
pub use crate::stm32g4a1::usart1::icr::CMCF_W;
///CTS clear flag
pub use crate::stm32g4a1::usart1::icr::CTSCF;
///Field `CTSCF` writer - CTS clear flag
pub use crate::stm32g4a1::usart1::icr::CTSCF_W;
///Framing error clear flag
pub use crate::stm32g4a1::usart1::icr::FECF;
///Field `FECF` writer - Framing error clear flag
pub use crate::stm32g4a1::usart1::icr::FECF_W;
///Idle line detected clear flag
pub use crate::stm32g4a1::usart1::icr::IDLECF;
///Field `IDLECF` writer - Idle line detected clear flag
pub use crate::stm32g4a1::usart1::icr::IDLECF_W;
///LIN break detection clear flag
pub use crate::stm32g4a1::usart1::icr::LBDCF;
///Field `LBDCF` writer - LIN break detection clear flag
pub use crate::stm32g4a1::usart1::icr::LBDCF_W;
///Noise detected clear flag
pub use crate::stm32g4a1::usart1::icr::NCF;
///Field `NCF` writer - Noise detected clear flag
pub use crate::stm32g4a1::usart1::icr::NCF_W;
///Overrun error clear flag
pub use crate::stm32g4a1::usart1::icr::ORECF;
///Field `ORECF` writer - Overrun error clear flag
pub use crate::stm32g4a1::usart1::icr::ORECF_W;
///Parity error clear flag
pub use crate::stm32g4a1::usart1::icr::PECF;
///Field `PECF` writer - Parity error clear flag
pub use crate::stm32g4a1::usart1::icr::PECF_W;
///Receiver timeout clear flag
pub use crate::stm32g4a1::usart1::icr::RTOCF;
///Field `RTOCF` writer - Receiver timeout clear flag
pub use crate::stm32g4a1::usart1::icr::RTOCF_W;
///TCBGTCF
pub use crate::stm32g4a1::usart1::icr::TCBGTCF;
///Field `TCBGTCF` writer - TCBGTCF
pub use crate::stm32g4a1::usart1::icr::TCBGTCF_W;
///Transmission complete clear flag
pub use crate::stm32g4a1::usart1::icr::TCCF;
///Field `TCCF` writer - Transmission complete clear flag
pub use crate::stm32g4a1::usart1::icr::TCCF_W;
///TXFECF
pub use crate::stm32g4a1::usart1::icr::TXFECF;
///Field `TXFECF` writer - TXFECF
pub use crate::stm32g4a1::usart1::icr::TXFECF_W;
///Wakeup from Stop mode clear flag
pub use crate::stm32g4a1::usart1::icr::WUCF;
///Field `WUCF` writer - Wakeup from Stop mode clear flag
pub use crate::stm32g4a1::usart1::icr::WUCF_W;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32G4A1.html#UART4:ICR)*/
pub struct ICRrs;
