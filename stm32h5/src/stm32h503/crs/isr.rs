...
///Field `FECAP` reader - Frequency error capture FECAP is the frequency error counter value latched in the time of the last SYNC event. Refer to Section 10.5.3 for more details about FECAP usage.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#CRS:ISR)*/
pub struct ISRrs;
