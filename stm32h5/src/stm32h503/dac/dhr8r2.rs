...
///Field `DACC2DHRB` reader - DAC channel2 8-bit right-aligned data These bits are written by software. They specify 8-bit data for DAC channel2 when the DAC operates in Double data mode.
pub type DACC2DHRB_R = crate::FieldReader;
///Field `DACC2DHRB` writer - DAC channel2 8-bit right-aligned data These bits are written by software. They specify 8-bit data for DAC channel2 when the DAC operates in Double data mode.
