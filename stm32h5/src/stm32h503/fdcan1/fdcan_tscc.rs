...
///Field `TCP` reader - Timestamp counter prescaler Configures the timestamp and timeout counters time unit in multiples of CAN bit times .
pub type TCP_R = crate::FieldReader;
///Field `TCP` writer - Timestamp counter prescaler Configures the timestamp and timeout counters time unit in multiples of CAN bit times .
...
impl R {
    ...
    ///Bits 16:19 - Timestamp counter prescaler Configures the timestamp and timeout counters time unit in multiples of CAN bit times .
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#FDCAN1:FDCAN_TSCC)*/
