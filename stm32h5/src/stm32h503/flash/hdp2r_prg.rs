...
///Field `HDP2_STRT` writer - Bank 2 HDPL barrier start set in number of 8 Kbytes sectors
...
///Field `HDP2_END` writer - Bank 2 HDPL barrier end set in number of 8 Kbytes sectors
