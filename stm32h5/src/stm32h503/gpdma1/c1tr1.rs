///Register `C1TR1` reader
pub type R = crate::R<C1TR1rs>;
///Register `C1TR1` writer
...
You can [`read`](crate::Reg::read) this register and get [`c1tr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c1tr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`c1tr1::R`](R) reader structure
impl crate::Readable for C1TR1rs {}
///`write(|w| ..)` method takes [`c1tr1::W`](W) writer structure
impl crate::Writable for C1TR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets C1TR1 to value 0
