...
pub enum TRIGM {
    ...
    BlockLevel = 0,
    #[doc = "1: At repeated block level: the first burst read of a 2D/repeated block transfer is conditioned by one hit trigger"]
...
impl TRIGM_R {
    ...
    #[doc = "At repeated block level: the first burst read of a 2D/repeated block transfer is conditioned by one hit trigger"]
    #[inline(always)]
...
= 11 and (SWREQ =1 or (SWREQ = 0 and DREQ =0 )), the shortened burst transfer (by singles or/and by bursts of lower length) is conditioned once by the trigger. Note: When the programmed destination burst is internally shortened by singles or/and by bursts of lower length (versus FIFO size, versus block size, 1-Kbyte boundary address crossing): if the trigger is conditioning the programmed destination burst (if TRIGM\\[1:0\\]
= 11 and SWREQ = 0 and DREQ = 1), this shortened destination burst transfer is conditioned once by the trigger."]
pub type TRIGM_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, TRIGM>;
...
pub enum TCEM {
    ...
    BlockLevel = 0,
    #[doc = "1: At repeated block level: the complete (and the half) transfer event is generated at the end (respectively half of the end) of the 2D/repeated block."]
    RepeatedBlockLevel = 1,
...
impl TCEM_R {
    ...
    #[doc = "At repeated block level: the complete (and the half) transfer event is generated at the end (respectively half of the end) of the 2D/repeated block."]
    #[inline(always)]
    pub fn is_repeated_block_level(&self) -> bool {
...
= 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI&lt;sub>0 &lt;/sub>data transfer is null/void (i.e. directly programmed by the internal register file with GPDMA_CxBR1.BNDT\\[15:0\\]
=0 ), then the half transfer event is not generated, and the transfer complete event is generated when is completed the loading of the LLI&lt;sub>1&lt;/sub>."]
pub type TCEM_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, TCEM>;
...
#[doc = "GPDMA channel 7 transfer register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`c7tr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`c7tr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C7TR2rs;
