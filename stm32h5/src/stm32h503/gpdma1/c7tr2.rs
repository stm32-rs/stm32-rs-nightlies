///Register `C7TR2` reader
pub type R = crate::R<C7TR2rs>;
///Register `C7TR2` writer
pub type W = crate::W<C7TR2rs>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SWREQ {
    /**0: No software request. The selected hardware request REQSEL\[7:0\]
...
impl SWREQ_R {
    ...
    /**No software request. The selected hardware request REQSEL\[7:0\]
    is taken into account*/
    #[inline(always)]
...
pub enum TRIGM {
    ...
    BlockLevel = 0,
    ///1: At repeated block level: the first burst read of a 2D/repeated block transfer is conditioned by one hit trigger
    RepeatedBlockLevel = 1,
...
impl TRIGM_R {
    ...
    pub const fn variant(&self) -> TRIGM {
        match self.bits {
            0 => TRIGM::BlockLevel,
            1 => TRIGM::RepeatedBlockLevel,
            2 => TRIGM::LinkLevel,
            3 => TRIGM::ProgrammedBurstLevel,
            _ => unreachable!(),
        }
    }
    ...
    #[inline(always)]
    pub fn is_repeated_block_level(&self) -> bool {
        *self == TRIGM::RepeatedBlockLevel
    }
...
pub type TRIGM_W<'a, REG> = crate::FieldWriter<'a, REG, 2, TRIGM, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    ///At repeated block level: the first burst read of a 2D/repeated block transfer is conditioned by one hit trigger
    #[inline(always)]
    pub fn repeated_block_level(self) -> &'a mut crate::W<REG> {
        self.variant(TRIGM::RepeatedBlockLevel)
    }
    ///At link level: a LLI link transfer is conditioned by one hit trigger
    #[inline(always)]
...
/**trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per Section 14.3.7), with an active trigger event if TRIGPOL\[1:0\]
different 00.
...
/**Field `TRIGSEL` reader - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per Section 14.3.7), with an active trigger event if TRIGPOL\[1:0\]
different 00.*/
...
/**Field `TRIGSEL` writer - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per Section 14.3.7), with an active trigger event if TRIGPOL\[1:0\]
different 00.*/
...
/**transfer complete event mode These bits define the transfer granularity for the transfer complete and half transfer complete events generation. Note: If the initial LLI 0 data transfer is null/void (directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
= 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI 0 data transfer is null/void (directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
= 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI 0 data transfer is null/void (i.e. directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
=0 ), then the half transfer event is not generated, and the transfer complete event is generated when is completed the loading of the LLI 1 .
...
pub enum TCEM {
    ...
    BlockLevel = 0,
    ///1: At repeated block level: the complete (and the half) transfer event is generated at the end (respectively half of the end) of the 2D/repeated block.
    RepeatedBlockLevel = 1,
...
/**Field `TCEM` reader - transfer complete event mode These bits define the transfer granularity for the transfer complete and half transfer complete events generation. Note: If the initial LLI 0 data transfer is null/void (directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
= 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI 0 data transfer is null/void (directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
= 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI 0 data transfer is null/void (i.e. directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
=0 ), then the half transfer event is not generated, and the transfer complete event is generated when is completed the loading of the LLI 1 .*/
...
impl TCEM_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> TCEM {
        match self.bits {
            0 => TCEM::BlockLevel,
            1 => TCEM::RepeatedBlockLevel,
            2 => TCEM::LliLevel,
            3 => TCEM::ChannelLevel,
            _ => unreachable!(),
        }
...
/**Field `TCEM` writer - transfer complete event mode These bits define the transfer granularity for the transfer complete and half transfer complete events generation. Note: If the initial LLI 0 data transfer is null/void (directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
= 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI 0 data transfer is null/void (directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
= 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI 0 data transfer is null/void (i.e. directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
=0 ), then the half transfer event is not generated, and the transfer complete event is generated when is completed the loading of the LLI 1 .*/
pub type TCEM_W<'a, REG> = crate::FieldWriter<'a, REG, 2, TCEM, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn repeated_block_level(self) -> &'a mut crate::W<REG> {
        self.variant(TCEM::RepeatedBlockLevel)
    }
    ///At LLI level: the complete transfer event is generated at the end of the LLI transfer. The half transfer event is generated at the half of the LLI data transfer
    #[inline(always)]
...
impl R {
    ...
    /**Bits 16:21 - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per Section 14.3.7), with an active trigger event if TRIGPOL\[1:0\]
    different 00.*/
    #[inline(always)]
    ...
    /**Bits 30:31 - transfer complete event mode These bits define the transfer granularity for the transfer complete and half transfer complete events generation. Note: If the initial LLI 0 data transfer is null/void (directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
    = 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI 0 data transfer is null/void (directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
    = 0), then neither the complete transfer event nor the half transfer event is generated. Note: If the initial LLI 0 data transfer is null/void (i.e. directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
    =0 ), then the half transfer event is not generated, and the transfer complete event is generated when is completed the loading of the LLI 1 .*/
    #[inline(always)]
...
impl W {
    ...
    value) to different active GPDMA channels (GPDMA_CxCR.EN = 1 and GPDMA_CxTR2.SWREQ = 0 for these channels). GPDMA is not intended to hardware support the case of simultaneous enabled channels incorrectly configured with a same hardware peripheral request signal, and there is no user setting error reporting.*/
    #[inline(always)]
    pub fn reqsel(&mut self) -> REQSEL_W<C7TR2rs> {
        REQSEL_W::new(self, 0)
    }
    ///Bit 9 - software request This bit is internally taken into account when GPDMA_CxCR.EN is asserted.
    #[inline(always)]
    pub fn swreq(&mut self) -> SWREQ_W<C7TR2rs> {
        SWREQ_W::new(self, 9)
    }
    ///Bit 10 - destination hardware request This bit is ignored if channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer). Else: Note: If the channel x is activated (GPDMA_CxCR.EN is asserted) with SWREQ = 0 and PFREQ = 1 (peripheral hardware request with peripheral flow-control mode), any software assertion to this DREQ bit is ignored: in peripheral flow-control mode, only a peripheral-to-memory transfer is supported.
    #[inline(always)]
    pub fn dreq(&mut self) -> DREQ_W<C7TR2rs> {
        DREQ_W::new(self, 10)
    }
    ///Bit 11 - Block hardware request If the channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer), this bit is ignored. Else:
    #[inline(always)]
    pub fn breq(&mut self) -> BREQ_W<C7TR2rs> {
        BREQ_W::new(self, 11)
    }
    /**Bit 12 - Hardware request in peripheral flow control mode Important: If a given channel x is not implemented with this feature, this bit is reserved and PFREQ is not present (see Section 14.3.2 for the list of the implemented channels with this feature. If the channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer), this bit is ignored. Else: Note: In peripheral flow control mode, there are the following restrictions: Note: no 2D/repeated block support (GPDMA_CxBR1.BRC\[10:0\]
    must be set to 0) Note: the peripheral must be set as the source of the transfer (DREQ = 0). Note: data packing to a wider destination width is not supported (if destination width source data width, GPDMA_CxTR1.PAM\[1\]
    ...
    must be programmed as a multiple of the source (peripheral) burst size.*/
    #[inline(always)]
    pub fn pfreq(&mut self) -> PFREQ_W<C7TR2rs> {
        PFREQ_W::new(self, 12)
    }
    ///Bits 14:15 - trigger mode These bits define the transfer granularity for its conditioning by the trigger.
    #[inline(always)]
    pub fn trigm(&mut self) -> TRIGM_W<C7TR2rs> {
        TRIGM_W::new(self, 14)
    }
    /**Bits 16:21 - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per Section 14.3.7), with an active trigger event if TRIGPOL\[1:0\]
    different 00.*/
    #[inline(always)]
    pub fn trigsel(&mut self) -> TRIGSEL_W<C7TR2rs> {
        TRIGSEL_W::new(self, 16)
    }
    ///Bits 24:25 - trigger event polarity These bits define the polarity of the selected trigger event input defined by TRIGSEL\[5:0\].
    #[inline(always)]
    pub fn trigpol(&mut self) -> TRIGPOL_W<C7TR2rs> {
    ...
    =0 ), then the half transfer event is not generated, and the transfer complete event is generated when is completed the loading of the LLI 1 .*/
    #[inline(always)]
    pub fn tcem(&mut self) -> TCEM_W<C7TR2rs> {
        TCEM_W::new(self, 30)
    }
}
/**GPDMA channel 7 transfer register 2

You can [`read`](crate::Reg::read) this register and get [`c7tr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c7tr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#GPDMA1:C7TR2)*/
pub struct C7TR2rs;
impl crate::RegisterSpec for C7TR2rs {
    type Ux = u32;
}
///`read()` method returns [`c7tr2::R`](R) reader structure
impl crate::Readable for C7TR2rs {}
///`write(|w| ..)` method takes [`c7tr2::W`](W) writer structure
impl crate::Writable for C7TR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets C7TR2 to value 0
impl crate::Resettable for C7TR2rs {
