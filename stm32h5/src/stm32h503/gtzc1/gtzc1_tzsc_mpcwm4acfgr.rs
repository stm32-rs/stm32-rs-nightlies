...
pub type R = crate::R<GTZC1_TZSC_MPCWM4ACFGRrs>;
///Register `GTZC1_TZSC_MPCWM4ACFGR` writer
pub type W = crate::W<GTZC1_TZSC_MPCWM4ACFGRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GTZC1_TZSC_MPCWM4ACFGR")
...
impl W {
    ///Bit 0 - Sub-region z enable
    #[inline(always)]
    pub fn sren(&mut self) -> SREN_W<GTZC1_TZSC_MPCWM4ACFGRrs> {
        SREN_W::new(self, 0)
    }
    ///Bit 1 - Sub-region z lock This bit, once set, can be cleared only by a system reset.
    #[inline(always)]
    pub fn srlock(&mut self) -> SRLOCK_W<GTZC1_TZSC_MPCWM4ACFGRrs> {
        SRLOCK_W::new(self, 1)
    }
    ///Bit 9 - Privileged sub-region z This bit is taken into account only if SREN is set.
    #[inline(always)]
    pub fn priv_(&mut self) -> PRIV_W<GTZC1_TZSC_MPCWM4ACFGRrs> {
        PRIV_W::new(self, 9)
    }
}
/**GTZC1 TZSC BKPSRAM sub-region A watermark configuration register

You can [`read`](crate::Reg::read) this register and get [`gtzc1_tzsc_mpcwm4acfgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gtzc1_tzsc_mpcwm4acfgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#GTZC1:GTZC1_TZSC_MPCWM4ACFGR)*/
pub struct GTZC1_TZSC_MPCWM4ACFGRrs;
impl crate::RegisterSpec for GTZC1_TZSC_MPCWM4ACFGRrs {
    type Ux = u32;
}
///`read()` method returns [`gtzc1_tzsc_mpcwm4acfgr::R`](R) reader structure
impl crate::Readable for GTZC1_TZSC_MPCWM4ACFGRrs {}
///`write(|w| ..)` method takes [`gtzc1_tzsc_mpcwm4acfgr::W`](W) writer structure
impl crate::Writable for GTZC1_TZSC_MPCWM4ACFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GTZC1_TZSC_MPCWM4ACFGR to value 0
impl crate::Resettable for GTZC1_TZSC_MPCWM4ACFGRrs {
