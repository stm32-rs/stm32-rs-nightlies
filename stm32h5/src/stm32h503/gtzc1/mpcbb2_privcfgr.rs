...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `PRIV0` field.</div>
    #[inline(always)]
    pub fn priv_(&mut self, n: u8) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        PRIV_W::new(self, n)
    }
    ///Bit 0 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv0(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 0)
    }
    ///Bit 1 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv1(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 1)
    }
    ///Bit 2 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv2(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 2)
    }
    ///Bit 3 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv3(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 3)
    }
    ///Bit 4 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv4(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 4)
    }
    ///Bit 5 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv5(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 5)
    }
    ///Bit 6 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv6(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 6)
    }
    ///Bit 7 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv7(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 7)
    }
    ///Bit 8 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv8(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 8)
    }
    ///Bit 9 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv9(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 9)
    }
    ///Bit 10 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv10(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 10)
    }
    ///Bit 11 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv11(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 11)
    }
    ///Bit 12 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv12(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 12)
    }
    ///Bit 13 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv13(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 13)
    }
    ///Bit 14 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv14(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 14)
    }
    ///Bit 15 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv15(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 15)
    }
    ///Bit 16 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv16(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 16)
    }
    ///Bit 17 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv17(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 17)
    }
    ///Bit 18 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv18(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 18)
    }
    ///Bit 19 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv19(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 19)
    }
    ///Bit 20 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv20(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 20)
    }
    ///Bit 21 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv21(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 21)
    }
    ///Bit 22 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv22(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 22)
    }
    ///Bit 23 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv23(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 23)
    }
    ///Bit 24 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv24(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 24)
    }
    ///Bit 25 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv25(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 25)
    }
    ///Bit 26 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv26(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 26)
    }
    ///Bit 27 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv27(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 27)
    }
    ///Bit 28 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv28(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 28)
    }
    ///Bit 29 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv29(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 29)
    }
    ///Bit 30 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv30(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 30)
    }
    ///Bit 31 - Privileged configuration for block y, belonging to super-block x (y = 31 to 0).
    #[inline(always)]
    pub fn priv31(&mut self) -> PRIV_W<MPCBB2_PRIVCFGRrs> {
        PRIV_W::new(self, 31)
    }
}
