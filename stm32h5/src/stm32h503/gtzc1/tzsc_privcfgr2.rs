...
impl W {
    ///Bit 0 - privileged access mode for FDCAN1
    #[inline(always)]
    pub fn fdcan1priv(&mut self) -> FDCAN1PRIV_W<TZSC_PRIVCFGR2rs> {
        FDCAN1PRIV_W::new(self, 0)
    }
    ///Bit 3 - privileged access mode for OPAMP
    #[inline(always)]
    pub fn opamppriv(&mut self) -> OPAMPPRIV_W<TZSC_PRIVCFGR2rs> {
        OPAMPPRIV_W::new(self, 3)
    }
    ///Bit 4 - privileged access mode for COMP
    #[inline(always)]
    pub fn comppriv(&mut self) -> COMPPRIV_W<TZSC_PRIVCFGR2rs> {
    ...
    ///Bit 19 - privileged access mode for USBSF
    #[inline(always)]
    pub fn usbfspriv(&mut self) -> USBFSPRIV_W<TZSC_PRIVCFGR2rs> {
        USBFSPRIV_W::new(self, 19)
    }
    ///Bit 25 - privileged access mode for LPUART
    #[inline(always)]
    pub fn lpuart1priv(&mut self) -> LPUART1PRIV_W<TZSC_PRIVCFGR2rs> {
        LPUART1PRIV_W::new(self, 25)
    }
    ///Bit 28 - privileged access mode for LPTIM1
    #[inline(always)]
    pub fn lptim1priv(&mut self) -> LPTIM1PRIV_W<TZSC_PRIVCFGR2rs> {
