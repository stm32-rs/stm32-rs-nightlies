...
///Field `CS17` reader - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
pub type CS17_R = crate::FieldReader<u32>;
///Field `CS17` writer - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#HASH:CSR17)*/
pub struct CSR17rs;
