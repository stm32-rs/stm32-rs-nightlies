...
///Field `CS44` reader - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
pub type CS44_R = crate::FieldReader<u32>;
///Field `CS44` writer - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#HASH:CSR44)*/
pub struct CSR44rs;
