...
///Field `CS47` reader - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
pub type CS47_R = crate::FieldReader<u32>;
///Field `CS47` writer - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
...
impl W {
    ///Bits 0:31 - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
    #[inline(always)]
    pub fn cs47(&mut self) -> CS47_W<'_, CSR47rs> {
        CS47_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#HASH:CSR47)*/
pub struct CSR47rs;
