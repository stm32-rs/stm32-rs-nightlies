...
///Field `CS50` reader - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
pub type CS50_R = crate::FieldReader<u32>;
///Field `CS50` writer - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
...
impl W {
    ///Bits 0:31 - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
    #[inline(always)]
    pub fn cs50(&mut self) -> CS50_W<'_, CSR50rs> {
        CS50_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#HASH:CSR50)*/
pub struct CSR50rs;
