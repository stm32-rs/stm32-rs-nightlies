...
///Field `DATAIN` writer - Data input Writing this register pushes the current register content into the FIFO, and the register takes the new value presented on the AHB bus. Reading this register returns zeros.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#HASH:DIN)*/
pub struct DINrs;
