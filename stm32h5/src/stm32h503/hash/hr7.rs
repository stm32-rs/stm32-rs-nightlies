...
///Field `H7` reader - Hash data x Refer to Section 24.7.4: HASH digest registers introduction.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#HASH:HR7)*/
pub struct HR7rs;
