...
impl core::fmt::Debug for crate::generic::Reg<I3C_CRrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn dcnt(&mut self) -> DCNT_W<I3C_CRrs> {
        DCNT_W::new(self, 0)
    }
    ...
    #[inline(always)]
    pub fn rnw(&mut self) -> RNW_W<I3C_CRrs> {
        RNW_W::new(self, 16)
    }
    ...
    #[inline(always)]
    pub fn add(&mut self) -> ADD_W<I3C_CRrs> {
        ADD_W::new(self, 17)
    }
    ...
    and must be consistently programmed vs the maximum IBI payload data size which is defined by I3C_IBIDR.IBIP\[2:0\]. Others: reserved*/
    #[inline(always)]
    pub fn mtype(&mut self) -> MTYPE_W<I3C_CRrs> {
        MTYPE_W::new(self, 27)
    }
    ///Bit 31 - message end type (when the I3C is acting as controller)
    #[inline(always)]
    pub fn mend(&mut self) -> MEND_W<I3C_CRrs> {
        MEND_W::new(self, 31)
    }
}
/**I3C message control register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3c_cr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#I3C1:I3C_CR)*/
pub struct I3C_CRrs;
impl crate::RegisterSpec for I3C_CRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`i3c_cr::W`](W) writer structure
impl crate::Writable for I3C_CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets I3C_CR to value 0
impl crate::Resettable for I3C_CRrs {
