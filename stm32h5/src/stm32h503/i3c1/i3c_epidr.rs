...
pub type R = crate::R<I3C_EPIDRrs>;
///Register `I3C_EPIDR` writer
pub type W = crate::W<I3C_EPIDRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mipiid(&mut self) -> MIPIID_W<I3C_EPIDRrs> {
        MIPIID_W::new(self, 12)
    }
}
/**I3C extended provisioned ID register

You can [`read`](crate::Reg::read) this register and get [`i3c_epidr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3c_epidr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#I3C1:I3C_EPIDR)*/
pub struct I3C_EPIDRrs;
impl crate::RegisterSpec for I3C_EPIDRrs {
    type Ux = u32;
}
///`read()` method returns [`i3c_epidr::R`](R) reader structure
impl crate::Readable for I3C_EPIDRrs {}
///`write(|w| ..)` method takes [`i3c_epidr::W`](W) writer structure
impl crate::Writable for I3C_EPIDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets I3C_EPIDR to value 0x0208_0000
impl crate::Resettable for I3C_EPIDRrs {
