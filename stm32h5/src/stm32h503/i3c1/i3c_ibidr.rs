...
pub type R = crate::R<I3C_IBIDRrs>;
///Register `I3C_IBIDR` writer
pub type W = crate::W<I3C_IBIDRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ibidb0(&mut self) -> IBIDB0_W<I3C_IBIDRrs> {
        IBIDB0_W::new(self, 0)
    }
    ///Bits 8:15 - 8-bit IBI payload data (next byte on I3C bus after IBIDB0\[7:0\]).
    #[inline(always)]
    #[must_use]
    pub fn ibidb1(&mut self) -> IBIDB1_W<I3C_IBIDRrs> {
        IBIDB1_W::new(self, 8)
    }
    ///Bits 16:23 - 8-bit IBI payload data (next byte on I3C bus after IBIDB1\[7:0\]).
    #[inline(always)]
    #[must_use]
    pub fn ibidb2(&mut self) -> IBIDB2_W<I3C_IBIDRrs> {
        IBIDB2_W::new(self, 16)
    }
    ///Bits 24:31 - 8-bit IBI payload data (latest byte on I3C bus).
    #[inline(always)]
    #[must_use]
    pub fn ibidb3(&mut self) -> IBIDB3_W<I3C_IBIDRrs> {
        IBIDB3_W::new(self, 24)
    }
}
/**I3C IBI payload data register

You can [`read`](crate::Reg::read) this register and get [`i3c_ibidr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3c_ibidr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#I3C1:I3C_IBIDR)*/
pub struct I3C_IBIDRrs;
impl crate::RegisterSpec for I3C_IBIDRrs {
    type Ux = u32;
}
///`read()` method returns [`i3c_ibidr::R`](R) reader structure
impl crate::Readable for I3C_IBIDRrs {}
///`write(|w| ..)` method takes [`i3c_ibidr::W`](W) writer structure
impl crate::Writable for I3C_IBIDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets I3C_IBIDR to value 0
impl crate::Resettable for I3C_IBIDRrs {
