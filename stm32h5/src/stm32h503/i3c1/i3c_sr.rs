...
You can [`read`](crate::Reg::read) this register and get [`i3c_sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`i3c_sr::R`](R) reader structure
impl crate::Readable for I3C_SRrs {}
///`reset()` method sets I3C_SR to value 0
