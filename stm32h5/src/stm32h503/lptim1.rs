...
pub mod isr_output;
/**ISR_intput (r) register accessor: LPTIM1 interrupt and status register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`isr_intput::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPTIM1:ISR_intput)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPTIM1:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPTIM1:CNT)
