...
///Field `CC2CF` writer - Capture/compare 2 clear flag Writing 1 to this bit clears the CC2IF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Please refer to .
pub type CC2CF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CMP2OKCF` writer - Compare register 2 update OK clear flag Writing 1 to this bit clears the CMP2OK flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Please refer to .
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPTIM1:ICR_output)*/
