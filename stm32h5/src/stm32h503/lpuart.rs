...
/**CR1_enabled (rw) register accessor: LPUART control register 1 \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:CR1_enabled)
...
pub mod cr1_enabled;
/**CR1_disabled (rw) register accessor: LPUART control register 1 \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:CR1_disabled)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:BRR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:RQR)
...
pub mod rqr;
/**ISR_enabled (r) register accessor: LPUART interrupt and status register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`isr_enabled::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:ISR_enabled)
...
pub mod isr_enabled;
/**ISR_disabled (r) register accessor: LPUART interrupt and status register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`isr_disabled::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:ISR_disabled)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:RDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:TDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#LPUART:PRESC)
