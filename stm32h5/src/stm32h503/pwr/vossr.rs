...
/**Ready bit for V CORE voltage scaling output selection.
...
///Field `VOSRDY` reader - Ready bit for V CORE voltage scaling output selection.
...
/**voltage output scaling currently applied to V CORE This field provides the last VOS value.
...
///Field `ACTVOS` reader - voltage output scaling currently applied to V CORE This field provides the last VOS value.
...
impl R {
    ///Bit 3 - Ready bit for V CORE voltage scaling output selection.
    #[inline(always)]
    ...
    ///Bits 14:15 - voltage output scaling currently applied to V CORE This field provides the last VOS value.
    #[inline(always)]
