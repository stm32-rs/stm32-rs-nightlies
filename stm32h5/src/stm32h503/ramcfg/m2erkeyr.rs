...
#[doc = "RAMCFG memory 2 erase key register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`m2erkeyr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct M2ERKEYRrs;
impl crate::RegisterSpec for M2ERKEYRrs {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`m2erkeyr::W`](W) writer structure"]
impl crate::Writable for M2ERKEYRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets M2ERKEYR to value 0"]
