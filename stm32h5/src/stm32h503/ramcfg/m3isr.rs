...
#[doc = "RAMCFG memory interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`m3isr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct M3ISRrs;
impl crate::RegisterSpec for M3ISRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`m3isr::R`](R) reader structure"]
impl crate::Readable for M3ISRrs {}
#[doc = "`reset()` method sets M3ISR to value 0"]
