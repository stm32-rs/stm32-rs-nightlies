...
///Field `GTZC1LPEN` reader - GTZC1 clock enable during sleep mode
...
///Field `GTZC1LPEN` writer - GTZC1 clock enable during sleep mode
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHB1LPENR")
            ...
            .field("gtzc1lpen", &self.gtzc1lpen())
            .finish()
    }
}
impl W {
    ...
    ///Bit 24 - GTZC1 clock enable during sleep mode
    #[inline(always)]
    pub fn gtzc1lpen(&mut self) -> GTZC1LPEN_W<'_, AHB1LPENRrs> {
