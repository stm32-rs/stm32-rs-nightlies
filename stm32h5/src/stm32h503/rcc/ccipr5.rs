...
///Field `DAC1SEL` reader - DAC hold clock
...
///Field `DAC1SEL` writer - DAC hold clock
...
///Field `FDCANSEL` reader - FDCAN1 kernel clock source selection
...
///Field `FDCANSEL` writer - FDCAN1 kernel clock source selection
