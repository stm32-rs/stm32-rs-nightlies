...
/**Calibration output selection When COE = 1, this bit selects which signal is output on CALIB. These frequencies are valid for RTCCLK at 32.768 kHz and prescalers at their default values (PREDIV_A = 127 and PREDIV_S = 255). Refer to Section 31.3.17: Calibration clock output.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#RTC:CR)*/
pub struct CRrs;
