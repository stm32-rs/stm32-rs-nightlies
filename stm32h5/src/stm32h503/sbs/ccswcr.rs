...
pub type SW_ANSRC1_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
...
pub type SW_APSRC1_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
...
pub type SW_ANSRC2_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
///Field `SW_APSRC2` reader - PMOS compensation code for the V DDIO power rails This bitfield is written by software to define an I/O compensation cell code for PMOS transistors of the VDDIO power rail. This code is applied to the I/O when CS2 is set in SBS_CCSR.
pub type SW_APSRC2_R = crate::FieldReader;
///Field `SW_APSRC2` writer - PMOS compensation code for the V DDIO power rails This bitfield is written by software to define an I/O compensation cell code for PMOS transistors of the VDDIO power rail. This code is applied to the I/O when CS2 is set in SBS_CCSR.
pub type SW_APSRC2_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
impl R {
    ...
    ///Bits 12:15 - PMOS compensation code for the V DDIO power rails This bitfield is written by software to define an I/O compensation cell code for PMOS transistors of the VDDIO power rail. This code is applied to the I/O when CS2 is set in SBS_CCSR.
    #[inline(always)]
