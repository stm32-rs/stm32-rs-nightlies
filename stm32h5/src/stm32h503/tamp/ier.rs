...
impl W {
    ...
    ///Bit 22 - Internal tamper 7 interrupt enable
    #[inline(always)]
    pub fn itamp7ie(&mut self) -> ITAMP7IE_W<'_, IERrs> {
    ...
    ///Bit 24 - Internal tamper 9 interrupt enable
    #[inline(always)]
    pub fn itamp9ie(&mut self) -> ITAMP9IE_W<'_, IERrs> {
        ITAMP9IE_W::new(self, 24)
    }
    ///Bit 26 - Internal tamper 11 interrupt enable
    #[inline(always)]
    pub fn itamp11ie(&mut self) -> ITAMP11IE_W<'_, IERrs> {
        ITAMP11IE_W::new(self, 26)
    }
    ///Bit 27 - Internal tamper 12 interrupt enable
    #[inline(always)]
    pub fn itamp12ie(&mut self) -> ITAMP12IE_W<'_, IERrs> {
        ITAMP12IE_W::new(self, 27)
    }
    ///Bit 28 - Internal tamper 13 interrupt enable
    #[inline(always)]
    pub fn itamp13ie(&mut self) -> ITAMP13IE_W<'_, IERrs> {
        ITAMP13IE_W::new(self, 28)
    }
    ///Bit 30 - Internal tamper 15 interrupt enable
    #[inline(always)]
    pub fn itamp15ie(&mut self) -> ITAMP15IE_W<'_, IERrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H503.html#TAMP:IER)*/
pub struct IERrs;
