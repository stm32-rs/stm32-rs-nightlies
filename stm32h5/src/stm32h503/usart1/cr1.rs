...
#[doc = "Field `RXNEIE` reader - RXFIFO not empty interrupt enable This bit is set and cleared by software."]
...
#[doc = "Field `RXNEIE` writer - RXFIFO not empty interrupt enable This bit is set and cleared by software."]
...
#[doc = "Field `TXEIE` reader - TXFIFO not full interrupt enable This bit is set and cleared by software."]
...
#[doc = "Field `TXEIE` writer - TXFIFO not full interrupt enable This bit is set and cleared by software."]
...
#[doc = "Word length This bit is used in conjunction with bit 28 (M1) to determine the word length. It is set or cleared by software (refer to bit 28 (M1)description). This bit can only be written when the USART is disabled (UE=0).\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum M0 {
...
#[doc = "Word length This bit must be used in conjunction with bit 12 (M0) to determine the word length. It is set or cleared by software. M\\[1:0\\]
