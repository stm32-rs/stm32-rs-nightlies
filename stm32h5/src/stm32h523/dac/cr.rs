...
impl TSEL1_R {
    ...
    ///LPTIM2 CH1 event
    #[inline(always)]
    pub fn is_lptim2ch1(&self) -> bool {
        *self == TSEL1::Lptim2ch1
    }
    ///EXTI line 9
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    ///LPTIM2 CH1 event
    #[inline(always)]
    pub fn lptim2ch1(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Lptim2ch1)
    }
    ///EXTI line 9
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#DAC:CR)*/
pub struct CRrs;
