...
///Field `MODE1` reader - DAC channel1 mode
pub type MODE1_R = crate::FieldReader;
///Field `MODE1` writer - DAC channel1 mode
...
///Field `MODE2` reader - DAC channel2 mode
pub type MODE2_R = crate::FieldReader;
///Field `MODE2` writer - DAC channel2 mode
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#DAC:MCR)*/
pub struct MCRrs;
