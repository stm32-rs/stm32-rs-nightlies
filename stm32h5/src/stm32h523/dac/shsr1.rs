...
///Field `TSAMPLE1` reader - DAC channel1 sample time (only valid in Sample and hold mode)
pub type TSAMPLE1_R = crate::FieldReader<u16>;
///Field `TSAMPLE1` writer - DAC channel1 sample time (only valid in Sample and hold mode)
