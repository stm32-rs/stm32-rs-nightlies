...
impl W {
    ...
    ///Bit 6 - TIM12 stop in debug
    #[inline(always)]
    pub fn dbg_tim12_stop(&mut self) -> DBG_TIM12_STOP_W<'_, APB1LFZRrs> {
        DBG_TIM12_STOP_W::new(self, 6)
    }
    ///Bit 7 - TIM13 stop in debug
    #[inline(always)]
    pub fn dbg_tim13_stop(&mut self) -> DBG_TIM13_STOP_W<'_, APB1LFZRrs> {
        DBG_TIM13_STOP_W::new(self, 7)
    }
    ///Bit 8 - TIM14 stop in debug
    #[inline(always)]
    pub fn dbg_tim14_stop(&mut self) -> DBG_TIM14_STOP_W<'_, APB1LFZRrs> {
    ...
    ///Bit 23 - I3C1 SCL stall counter stop in debug
    #[inline(always)]
    pub fn dbg_i3c1_stop(&mut self) -> DBG_I3C1_STOP_W<'_, APB1LFZRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#DBGMCU:APB1LFZR)*/
