...
///Field `MESSAGE` reader - Debug host to device mailbox message.
pub type MESSAGE_R = crate::FieldReader<u32>;
///Field `MESSAGE` writer - Debug host to device mailbox message.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#DBGMCU:DBG_AUTH_HOST)*/
