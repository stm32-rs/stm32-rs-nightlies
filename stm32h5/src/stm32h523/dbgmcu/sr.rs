...
///Field `AP_PRESENT` reader - Bit n identifies whether access port AP n is present in device
pub type AP_PRESENT_R = crate::FieldReader<u16>;
///Field `AP_ENABLED` reader - Bit n identifies whether access port AP n is open (can be accessed via the debug port) or locked (debug access to the AP is blocked)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#DBGMCU:SR)*/
pub struct SRrs;
