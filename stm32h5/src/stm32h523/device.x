...
PROVIDE(TIM1_UPD = DefaultHandler);
PROVIDE(TIM1_TRGI_COM_DIR_IDX = DefaultHandler);
...
PROVIDE(TIM8_BRK_TERR_IERR = DefaultHandler);
PROVIDE(TIM8_UPD = DefaultHandler);
PROVIDE(TIM8_TRGI_DIR_IDX = DefaultHandler);
...
PROVIDE(DTS_OR_DTS_WKUP = DefaultHandler);
...
PROVIDE(I3C2_ERR = DefaultHandler);
