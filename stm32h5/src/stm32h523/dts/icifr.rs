...
///Field `TS1_CITEF` reader - Interrupt clear flag for end of measurement on temperature sensor 1
pub type TS1_CITEF_R = crate::BitReader;
///Field `TS1_CITEF` writer - Interrupt clear flag for end of measurement on temperature sensor 1
pub type TS1_CITEF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TS1_CITLF` reader - Interrupt clear flag for low threshold on temperature sensor 1
pub type TS1_CITLF_R = crate::BitReader;
///Field `TS1_CITLF` writer - Interrupt clear flag for low threshold on temperature sensor 1
pub type TS1_CITLF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TS1_CITHF` reader - Interrupt clear flag for high threshold on temperature sensor 1
pub type TS1_CITHF_R = crate::BitReader;
///Field `TS1_CITHF` writer - Interrupt clear flag for high threshold on temperature sensor 1
pub type TS1_CITHF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TS1_CAITEF` reader - Write once bit.
pub type TS1_CAITEF_R = crate::BitReader;
///Field `TS1_CAITEF` writer - Write once bit.
pub type TS1_CAITEF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TS1_CAITLF` reader - Asynchronous interrupt clear flag for low threshold on temperature sensor 1
pub type TS1_CAITLF_R = crate::BitReader;
///Field `TS1_CAITLF` writer - Asynchronous interrupt clear flag for low threshold on temperature sensor 1
pub type TS1_CAITLF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TS1_CAITHF` reader - Asynchronous interrupt clear flag for high threshold on temperature sensor 1
pub type TS1_CAITHF_R = crate::BitReader;
///Field `TS1_CAITHF` writer - Asynchronous interrupt clear flag for high threshold on temperature sensor 1
