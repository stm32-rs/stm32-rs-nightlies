...
///Field `EXTI4` reader - EXTI4 GPIO port selection
pub type EXTI4_R = crate::FieldReader;
///Field `EXTI4` writer - EXTI4 GPIO port selection
pub type EXTI4_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `EXTI5` reader - EXTI5 GPIO port selection
pub type EXTI5_R = crate::FieldReader;
///Field `EXTI5` writer - EXTI5 GPIO port selection
pub type EXTI5_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `EXTI6` reader - EXTI6 GPIO port selection
pub type EXTI6_R = crate::FieldReader;
///Field `EXTI6` writer - EXTI6 GPIO port selection
pub type EXTI6_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `EXTI7` reader - EXTI7 GPIO port selection
pub type EXTI7_R = crate::FieldReader;
///Field `EXTI7` writer - EXTI7 GPIO port selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#EXTI:EXTICR2)*/
