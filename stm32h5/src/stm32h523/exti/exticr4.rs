...
///Field `EXTI12` reader - EXTI12 GPIO port selection
pub type EXTI12_R = crate::FieldReader;
///Field `EXTI12` writer - EXTI12 GPIO port selection
pub type EXTI12_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `EXTI13` reader - EXTI13 GPIO port selection
pub type EXTI13_R = crate::FieldReader;
///Field `EXTI13` writer - EXTI13 GPIO port selection
pub type EXTI13_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `EXTI14` reader - EXTI14 GPIO port selection
pub type EXTI14_R = crate::FieldReader;
///Field `EXTI14` writer - EXTI14 GPIO port selection
pub type EXTI14_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `EXTI15` reader - EXTI15 GPIO port selection
pub type EXTI15_R = crate::FieldReader;
///Field `EXTI15` writer - EXTI15 GPIO port selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#EXTI:EXTICR4)*/
