...
///Field `LOCK` reader - Global security and privilege configuration registers (EXTI_SECCFGR and EXTI_PRIVCFGR) lock
pub type LOCK_R = crate::BitReader;
///Field `LOCK` writer - Global security and privilege configuration registers (EXTI_SECCFGR and EXTI_PRIVCFGR) lock
...
impl W {
    ///Bit 0 - Global security and privilege configuration registers (EXTI_SECCFGR and EXTI_PRIVCFGR) lock
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<'_, LOCKRrs> {
        LOCK_W::new(self, 0)
    }
}
/**EXTI lock register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#EXTI:LOCKR)*/
pub struct LOCKRrs;
