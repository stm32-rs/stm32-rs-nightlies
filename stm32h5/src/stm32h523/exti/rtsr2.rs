...
///Field `RT46` reader - Rising trigger event configuration bit of configurable event input xless thansup>(1)less than/sup>
...
///Field `RT46` writer - Rising trigger event configuration bit of configurable event input xless thansup>(1)less than/sup>
...
///Field `RT50` reader - Rising trigger event configuration bit of configurable event input xless thansup>(1)less than/sup>
pub use RT46_R as RT50_R;
///Field `RT53` reader - Rising trigger event configuration bit of configurable event input x
pub use RT46_R as RT53_R;
///Field `RT50` writer - Rising trigger event configuration bit of configurable event input xless thansup>(1)less than/sup>
pub use RT46_W as RT50_W;
///Field `RT53` writer - Rising trigger event configuration bit of configurable event input x
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#EXTI:RTSR2)*/
pub struct RTSR2rs;
