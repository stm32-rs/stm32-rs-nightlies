...
///Field `SWI46` reader - Software interrupt on event x
...
///Field `SWI46` writer - Software interrupt on event x
...
///Field `SWI50` reader - Software interrupt on event x
pub use SWI46_R as SWI50_R;
///Field `SWI53` reader - Software interrupt on event x
pub use SWI46_R as SWI53_R;
///Field `SWI50` writer - Software interrupt on event x
pub use SWI46_W as SWI50_W;
///Field `SWI53` writer - Software interrupt on event x
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#EXTI:SWIER2)*/
pub struct SWIER2rs;
