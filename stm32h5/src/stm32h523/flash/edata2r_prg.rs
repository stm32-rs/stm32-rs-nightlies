...
///Field `EDATA2_STRT` reader - EDATA2_STRT contains the start sectors of the flash high-cycle data area in Bank2 There is no hardware effect to those bits.
pub type EDATA2_STRT_R = crate::FieldReader;
///Field `EDATA2_STRT` writer - EDATA2_STRT contains the start sectors of the flash high-cycle data area in Bank2 There is no hardware effect to those bits.
...
///Field `EDATA2_EN` writer - Bank2 flash high-cycle data enable
