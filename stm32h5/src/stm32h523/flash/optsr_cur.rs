...
///Field `IO_VDD_HSLV` reader - High-speed IO at low Vless thansub>DDless than/sub> voltage configuration bit.
...
///Field `SWAP_BANK` reader - Bank swapping option status bit
