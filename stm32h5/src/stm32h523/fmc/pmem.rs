...
///Field `MEMSET` reader - Common memory x setup time
pub type MEMSET_R = crate::FieldReader;
///Field `MEMSET` writer - Common memory x setup time
...
///Field `MEMHIZ` reader - Common memory x data bus Hi-Z time
pub type MEMHIZ_R = crate::FieldReader;
///Field `MEMHIZ` writer - Common memory x data bus Hi-Z time
