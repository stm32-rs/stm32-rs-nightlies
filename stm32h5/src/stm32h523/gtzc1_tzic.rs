...
impl RegisterBlock {
    ///0x00 - GTZC1 TZIC interrupt enable register 1
    #[inline(always)]
    ...
    ///0x10 - GTZC1 TZIC status register 1
    #[inline(always)]
    pub const fn sr1(&self) -> &SR1 {
        &self.sr1
    }
    ///0x14 - GTZC1 TZIC status register 2
    #[inline(always)]
    pub const fn sr2(&self) -> &SR2 {
        &self.sr2
    }
    ///0x18 - GTZC1 TZIC status register 3
    #[inline(always)]
    ...
    ///0x20 - GTZC1 TZIC flag clear register 1
    #[inline(always)]
    pub const fn fcr1(&self) -> &FCR1 {
        &self.fcr1
    }
    ///0x24 - GTZC1 TZIC flag clear register 2
    #[inline(always)]
    pub const fn fcr2(&self) -> &FCR2 {
        &self.fcr2
    }
    ///0x28 - GTZC1 TZIC flag clear register 3
    #[inline(always)]
...
/**IER1 (rw) register accessor: GTZC1 TZIC interrupt enable register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZIC:IER1)
...
pub mod ier1;
/**IER2 (rw) register accessor: GTZC1 TZIC interrupt enable register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZIC:IER2)
...
pub mod ier2;
/**IER3 (rw) register accessor: GTZC1 TZIC interrupt enable register 3
...
pub mod ier3;
/**IER4 (rw) register accessor: GTZC1 TZIC interrupt enable register 4
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZIC:IER4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZIC:FCR1)
...
pub mod fcr1;
/**FCR2 (w) register accessor: GTZC1 TZIC flag clear register 2
...
pub mod fcr2;
/**FCR3 (w) register accessor: GTZC1 TZIC flag clear register 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZIC:FCR3)
...
pub mod fcr3;
/**FCR4 (w) register accessor: GTZC1 TZIC flag clear register 4
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZIC:FCR4)
