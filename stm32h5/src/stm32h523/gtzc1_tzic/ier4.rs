...
impl W {
    ...
    ///Bit 1 - illegal access interrupt enable for GPDMA2
    #[inline(always)]
    pub fn gpdma2ie(&mut self) -> GPDMA2IE_W<'_, IER4rs> {
    ...
    pub fn otfdec1ie(&mut self) -> OTFDEC1IE_W<'_, IER4rs> {
        OTFDEC1IE_W::new(self, 4)
    }
    ///Bit 6 - illegal access interrupt enable for SBS
    #[inline(always)]
    pub fn sbsie(&mut self) -> SBSIE_W<'_, IER4rs> {
        SBSIE_W::new(self, 6)
    }
    ///Bit 7 - illegal access interrupt enable for RTC
    #[inline(always)]
    ...
    ///Bit 19 - illegal access interrupt enable for MPCWM2 (FMC_NOR bank), MPCWM3 (FMC_NAND bank and FMC_SDRAM bank 1), and MPCWM4 (FMC_SDRAM bank 2)
    #[inline(always)]
    pub fn fmc_memie(&mut self) -> FMC_MEMIE_W<'_, IER4rs> {
