...
impl W {
    ///Bit 0 - subregion B enable
    #[inline(always)]
    pub fn sren(&mut self) -> SREN_W<'_, MPCWM1BCFGRrs> {
        SREN_W::new(self, 0)
    }
    ///Bit 1 - subregion B lock
    #[inline(always)]
    pub fn srlock(&mut self) -> SRLOCK_W<'_, MPCWM1BCFGRrs> {
        SRLOCK_W::new(self, 1)
    }
    ///Bit 8 - Secure subregion B of base region x
    #[inline(always)]
    pub fn sec(&mut self) -> SEC_W<'_, MPCWM1BCFGRrs> {
        SEC_W::new(self, 8)
    }
    ///Bit 9 - Privileged subregion B of base region x
    #[inline(always)]
    pub fn priv_(&mut self) -> PRIV_W<'_, MPCWM1BCFGRrs> {
        PRIV_W::new(self, 9)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZSC:MPCWM1BCFGR)*/
