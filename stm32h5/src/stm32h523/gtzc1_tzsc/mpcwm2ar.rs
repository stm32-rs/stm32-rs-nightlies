...
///Field `SUBA_START` reader - Start of subregion A in region x
pub type SUBA_START_R = crate::FieldReader<u16>;
///Field `SUBA_START` writer - Start of subregion A in region x
pub type SUBA_START_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `SUBA_LENGTH` reader - Length of subregion A in region x
pub type SUBA_LENGTH_R = crate::FieldReader<u16>;
///Field `SUBA_LENGTH` writer - Length of subregion A in region x
...
impl W {
    ///Bits 0:10 - Start of subregion A in region x
    #[inline(always)]
    pub fn suba_start(&mut self) -> SUBA_START_W<'_, MPCWM2ARrs> {
        SUBA_START_W::new(self, 0)
    }
    ///Bits 16:27 - Length of subregion A in region x
    #[inline(always)]
    pub fn suba_length(&mut self) -> SUBA_LENGTH_W<'_, MPCWM2ARrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZSC:MPCWM2AR)*/
