///Register `MPCWM2BR` reader
pub type R = crate::R<MPCWM2BRrs>;
///Register `MPCWM2BR` writer
pub type W = crate::W<MPCWM2BRrs>;
...
impl W {
    ///Bits 0:10 - Start of subregion B in region x
    #[inline(always)]
    pub fn subb_start(&mut self) -> SUBB_START_W<'_, MPCWM2BRrs> {
        SUBB_START_W::new(self, 0)
    }
    ///Bits 16:27 - Length of subregion B in region x
    #[inline(always)]
    pub fn subb_length(&mut self) -> SUBB_LENGTH_W<'_, MPCWM2BRrs> {
        SUBB_LENGTH_W::new(self, 16)
    }
}
/**GTZC1 TZSC memory 2 subregion B watermark register

You can [`read`](crate::Reg::read) this register and get [`mpcwm2br::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcwm2br::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZSC:MPCWM2BR)*/
pub struct MPCWM2BRrs;
impl crate::RegisterSpec for MPCWM2BRrs {
    type Ux = u32;
}
///`read()` method returns [`mpcwm2br::R`](R) reader structure
impl crate::Readable for MPCWM2BRrs {}
///`write(|w| ..)` method takes [`mpcwm2br::W`](W) writer structure
impl crate::Writable for MPCWM2BRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MPCWM2BR to value 0
impl crate::Resettable for MPCWM2BRrs {}
