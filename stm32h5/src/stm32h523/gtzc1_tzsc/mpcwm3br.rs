...
impl W {
    ///Bits 0:10 - Start of subregion B in region x
    #[inline(always)]
    pub fn subb_start(&mut self) -> SUBB_START_W<MPCWM3BRrs> {
        SUBB_START_W::new(self, 0)
    }
    ///Bits 16:27 - Length of subregion B in region x
    #[inline(always)]
    pub fn subb_length(&mut self) -> SUBB_LENGTH_W<MPCWM3BRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZSC:MPCWM3BR)*/
