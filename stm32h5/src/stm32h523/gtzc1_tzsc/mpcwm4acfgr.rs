...
impl W {
    ///Bit 0 - subregion A enable
    #[inline(always)]
    pub fn sren(&mut self) -> SREN_W<MPCWM4ACFGRrs> {
        SREN_W::new(self, 0)
    }
    ///Bit 1 - subregion A lock
    #[inline(always)]
    pub fn srlock(&mut self) -> SRLOCK_W<MPCWM4ACFGRrs> {
        SRLOCK_W::new(self, 1)
    }
    ///Bit 8 - Secure subregion A of base region x
    #[inline(always)]
    pub fn sec(&mut self) -> SEC_W<MPCWM4ACFGRrs> {
        SEC_W::new(self, 8)
    }
    ///Bit 9 - Privileged subregion A of base region x
    #[inline(always)]
    pub fn priv_(&mut self) -> PRIV_W<MPCWM4ACFGRrs> {
        PRIV_W::new(self, 9)
    }
}
