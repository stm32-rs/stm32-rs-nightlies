///Register `MPCWM4BR` reader
pub type R = crate::R<MPCWM4BRrs>;
///Register `MPCWM4BR` writer
...
impl W {
    ///Bits 0:10 - Start of subregion B in region x
    #[inline(always)]
    pub fn subb_start(&mut self) -> SUBB_START_W<'_, MPCWM4BRrs> {
        SUBB_START_W::new(self, 0)
    }
    ///Bits 16:27 - Length of subregion B in region x
    #[inline(always)]
    pub fn subb_length(&mut self) -> SUBB_LENGTH_W<'_, MPCWM4BRrs> {
        SUBB_LENGTH_W::new(self, 16)
    }
}
/**GTZC1 TZSC memory 4 subregion B watermark register

You can [`read`](crate::Reg::read) this register and get [`mpcwm4br::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcwm4br::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#GTZC1_TZSC:MPCWM4BR)*/
pub struct MPCWM4BRrs;
impl crate::RegisterSpec for MPCWM4BRrs {
    type Ux = u32;
}
///`read()` method returns [`mpcwm4br::R`](R) reader structure
impl crate::Readable for MPCWM4BRrs {}
///`write(|w| ..)` method takes [`mpcwm4br::W`](W) writer structure
