...
///Field `I3C2SEC` reader - secure access mode for I3C2
pub type I3C2SEC_R = crate::BitReader;
///Field `I3C2SEC` writer - secure access mode for I3C2
pub type I3C2SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn i3c2sec(&self) -> I3C2SEC_R {
        I3C2SEC_R::new(((self.bits >> 2) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 2 - secure access mode for I3C2
    #[inline(always)]
    pub fn i3c2sec(&mut self) -> I3C2SEC_W<'_, SECCFGR3rs> {
        I3C2SEC_W::new(self, 2)
    }
    ///Bit 8 - secure access mode for CRC
    #[inline(always)]
