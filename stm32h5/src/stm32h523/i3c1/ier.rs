...
///Field `CFNFIE` reader - C-FIFO not full interrupt enable when the I3C acts as controller
pub type CFNFIE_R = crate::BitReader;
///Field `SFNEIE` reader - S-FIFO not empty interrupt enable when the I3C acts as controller
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#I3C1:IER)*/
pub struct IERrs;
