...
impl W {
    ///Bit 0 - Capture/compare 1 interrupt enable
    #[inline(always)]
    pub fn cc1ie(&mut self) -> CC1IE_W<DIER_ALTERNATE1rs> {
        CC1IE_W::new(self, 0)
    }
    ///Bit 1 - Autoreload match Interrupt Enable
    #[inline(always)]
    pub fn arrmie(&mut self) -> ARRMIE_W<DIER_ALTERNATE1rs> {
        ARRMIE_W::new(self, 1)
    }
    ///Bit 2 - External trigger valid edge Interrupt Enable
    #[inline(always)]
    pub fn exttrigie(&mut self) -> EXTTRIGIE_W<DIER_ALTERNATE1rs> {
        EXTTRIGIE_W::new(self, 2)
    }
    ///Bit 4 - Autoreload register update OK Interrupt Enable
    #[inline(always)]
    pub fn arrokie(&mut self) -> ARROKIE_W<DIER_ALTERNATE1rs> {
        ARROKIE_W::new(self, 4)
    }
    ///Bit 5 - Direction change to UP Interrupt Enable
    #[inline(always)]
    pub fn upie(&mut self) -> UPIE_W<DIER_ALTERNATE1rs> {
        UPIE_W::new(self, 5)
    }
    ///Bit 6 - Direction change to down Interrupt Enable
    #[inline(always)]
    pub fn downie(&mut self) -> DOWNIE_W<DIER_ALTERNATE1rs> {
        DOWNIE_W::new(self, 6)
    }
    ///Bit 7 - Update event interrupt enable
    #[inline(always)]
    pub fn ueie(&mut self) -> UEIE_W<DIER_ALTERNATE1rs> {
        UEIE_W::new(self, 7)
    }
    ///Bit 8 - Repetition register update OK interrupt Enable
    #[inline(always)]
    pub fn repokie(&mut self) -> REPOKIE_W<DIER_ALTERNATE1rs> {
        REPOKIE_W::new(self, 8)
    }
    ///Bit 9 - Capture/compare 2 interrupt enable
    #[inline(always)]
    pub fn cc2ie(&mut self) -> CC2IE_W<DIER_ALTERNATE1rs> {
        CC2IE_W::new(self, 9)
    }
    ///Bit 12 - Capture/compare 1 over-capture interrupt enable
    #[inline(always)]
    pub fn cc1oie(&mut self) -> CC1OIE_W<DIER_ALTERNATE1rs> {
        CC1OIE_W::new(self, 12)
    }
    ///Bit 13 - Capture/compare 2 over-capture interrupt enable
    #[inline(always)]
    pub fn cc2oie(&mut self) -> CC2OIE_W<DIER_ALTERNATE1rs> {
        CC2OIE_W::new(self, 13)
    }
    ///Bit 16 - Capture/compare 1 DMA request enable
    #[inline(always)]
    pub fn cc1de(&mut self) -> CC1DE_W<DIER_ALTERNATE1rs> {
        CC1DE_W::new(self, 16)
    }
    ///Bit 23 - Update event DMA request enable
    #[inline(always)]
    pub fn uede(&mut self) -> UEDE_W<DIER_ALTERNATE1rs> {
        UEDE_W::new(self, 23)
    }
    ///Bit 25 - Capture/compare 2 DMA request enable
    #[inline(always)]
    pub fn cc2de(&mut self) -> CC2DE_W<DIER_ALTERNATE1rs> {
        CC2DE_W::new(self, 25)
    }
}
