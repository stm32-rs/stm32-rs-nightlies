///Register `ICR_ALTERNATE1` writer
pub type W = crate::W<ICR_ALTERNATE1rs>;
...
impl core::fmt::Debug for crate::generic::Reg<ICR_ALTERNATE1rs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn cc1cf(&mut self) -> CC1CF_W<ICR_ALTERNATE1rs> {
        CC1CF_W::new(self, 0)
    }
    ///Bit 1 - Autoreload match clear flag
    #[inline(always)]
    pub fn arrmcf(&mut self) -> ARRMCF_W<ICR_ALTERNATE1rs> {
        ARRMCF_W::new(self, 1)
    }
    ///Bit 2 - External trigger valid edge clear flag
    #[inline(always)]
    pub fn exttrigcf(&mut self) -> EXTTRIGCF_W<ICR_ALTERNATE1rs> {
        EXTTRIGCF_W::new(self, 2)
    }
    ///Bit 4 - Autoreload register update OK clear flag
    #[inline(always)]
    pub fn arrokcf(&mut self) -> ARROKCF_W<ICR_ALTERNATE1rs> {
        ARROKCF_W::new(self, 4)
    }
    ///Bit 5 - Direction change to UP clear flag
    #[inline(always)]
    pub fn upcf(&mut self) -> UPCF_W<ICR_ALTERNATE1rs> {
        UPCF_W::new(self, 5)
    }
    ///Bit 6 - Direction change to down clear flag
    #[inline(always)]
    pub fn downcf(&mut self) -> DOWNCF_W<ICR_ALTERNATE1rs> {
        DOWNCF_W::new(self, 6)
    }
    ///Bit 7 - Update event clear flag
    #[inline(always)]
    pub fn uecf(&mut self) -> UECF_W<ICR_ALTERNATE1rs> {
        UECF_W::new(self, 7)
    }
    ///Bit 8 - Repetition register update OK clear flag
    #[inline(always)]
    pub fn repokcf(&mut self) -> REPOKCF_W<ICR_ALTERNATE1rs> {
        REPOKCF_W::new(self, 8)
    }
    ///Bit 9 - Capture/compare 2 clear flag
    #[inline(always)]
    pub fn cc2cf(&mut self) -> CC2CF_W<ICR_ALTERNATE1rs> {
        CC2CF_W::new(self, 9)
    }
    ///Bit 12 - Capture/compare 1 over-capture clear flag
    #[inline(always)]
    pub fn cc1ocf(&mut self) -> CC1OCF_W<ICR_ALTERNATE1rs> {
        CC1OCF_W::new(self, 12)
    }
    ///Bit 13 - Capture/compare 2 over-capture clear flag
    #[inline(always)]
    pub fn cc2ocf(&mut self) -> CC2OCF_W<ICR_ALTERNATE1rs> {
        CC2OCF_W::new(self, 13)
    }
    ///Bit 24 - Interrupt enable register update OK clear flag
    #[inline(always)]
    pub fn dierokcf(&mut self) -> DIEROKCF_W<ICR_ALTERNATE1rs> {
        DIEROKCF_W::new(self, 24)
    }
}
/**LPTIM2 interrupt clear register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr_alternate1::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#LPTIM2:ICR_ALTERNATE1)*/
pub struct ICR_ALTERNATE1rs;
impl crate::RegisterSpec for ICR_ALTERNATE1rs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`icr_alternate1::W`](W) writer structure
impl crate::Writable for ICR_ALTERNATE1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets ICR_ALTERNATE1 to value 0
impl crate::Resettable for ICR_ALTERNATE1rs {}
