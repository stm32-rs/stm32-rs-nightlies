...
pub mod cr1;
/**CR1_ALTERNATE1 (rw) register accessor: LPUART control register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#LPUART:CR1_ALTERNATE1)
...
pub mod isr;
/**ISR_ALTERNATE1 (r) register accessor: LPUART interrupt and status register

You can [`read`](crate::Reg::read) this register and get [`isr_alternate1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#LPUART:ISR_ALTERNATE1)
