...
impl W {
    ///Bits 0:2 - Instruction mode
    #[inline(always)]
    pub fn imode(&mut self) -> IMODE_W<'_, WCCRrs> {
        IMODE_W::new(self, 0)
    }
    ///Bit 3 - Instruction double transfer rate
    #[inline(always)]
    pub fn idtr(&mut self) -> IDTR_W<'_, WCCRrs> {
        IDTR_W::new(self, 3)
    }
    ///Bits 4:5 - Instruction size
    #[inline(always)]
    pub fn isize(&mut self) -> ISIZE_W<'_, WCCRrs> {
        ISIZE_W::new(self, 4)
    }
    ///Bits 8:10 - Address mode
    #[inline(always)]
    pub fn admode(&mut self) -> ADMODE_W<'_, WCCRrs> {
        ADMODE_W::new(self, 8)
    }
    ///Bit 11 - Address double transfer rate
    #[inline(always)]
    pub fn addtr(&mut self) -> ADDTR_W<'_, WCCRrs> {
        ADDTR_W::new(self, 11)
    }
    ///Bits 12:13 - Address size
    #[inline(always)]
    pub fn adsize(&mut self) -> ADSIZE_W<'_, WCCRrs> {
        ADSIZE_W::new(self, 12)
    }
    ///Bits 16:18 - Alternate-byte mode
    #[inline(always)]
    pub fn abmode(&mut self) -> ABMODE_W<'_, WCCRrs> {
        ABMODE_W::new(self, 16)
    }
    ///Bit 19 - Alternate bytes double transfer rate
    #[inline(always)]
    pub fn abdtr(&mut self) -> ABDTR_W<'_, WCCRrs> {
        ABDTR_W::new(self, 19)
    }
    ///Bits 20:21 - Alternate-byte size
    #[inline(always)]
    pub fn absize(&mut self) -> ABSIZE_W<'_, WCCRrs> {
        ABSIZE_W::new(self, 20)
    }
    ///Bits 24:26 - Data mode
    #[inline(always)]
    pub fn dmode(&mut self) -> DMODE_W<'_, WCCRrs> {
        DMODE_W::new(self, 24)
    }
    ///Bit 27 - data double transfer rate
    #[inline(always)]
    pub fn ddtr(&mut self) -> DDTR_W<'_, WCCRrs> {
        DDTR_W::new(self, 27)
    }
    ///Bit 29 - DQS enable
    #[inline(always)]
    pub fn dqse(&mut self) -> DQSE_W<'_, WCCRrs> {
        DQSE_W::new(self, 29)
    }
}
