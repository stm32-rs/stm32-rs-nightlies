...
///Field `ABDTR` reader - Alternate-byte double transfer rate
...
///Field `ABDTR` writer - Alternate-byte double transfer rate
...
///Field `ABSIZE` reader - Alternate-byte size
...
///Field `ABSIZE` writer - Alternate-byte size
