...
impl RegisterBlock {
    ...
    ///0x60 - RAMCFG memory 2 write protection register 3
    #[inline(always)]
    pub const fn m2wpr3(&self) -> &M2WPR3 {
        &self.m2wpr3
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M1CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M1ISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M1ERKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M2CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M2IER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M2ISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M2SEAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M2ICR)
...
pub mod m2wpr1;
/**M2WPR2 (rw) register accessor: RAMCFG memory 2 write protection register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M2WPR2)
...
pub mod m2wpr2;
/**M2WPR3 (rw) register accessor: RAMCFG memory 2 write protection register 3

You can [`read`](crate::Reg::read) this register and get [`m2wpr3::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m2wpr3::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M2WPR3)

For information about available fields see [`mod@m2wpr3`] module*/
pub type M2WPR3 = crate::Reg<m2wpr3::M2WPR3rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M2ECCKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M2ERKEYR)
...
pub mod m2erkeyr;
/**M3CR (rw) register accessor: RAMCFG memory 3 control register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M3CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M3IER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M3ISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M3DEAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M3ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M3ECCKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M3ERKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M4ERKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M5CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M5ISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M5SEAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M5DEAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M5ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RAMCFG:M5ERKEYR)
