...
impl W {
    ///Bit 0 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p64wp(&mut self) -> P64WP_W<M2WPR3rs> {
        P64WP_W::new(self, 0)
    }
    ///Bit 1 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p65wp(&mut self) -> P65WP_W<M2WPR3rs> {
        P65WP_W::new(self, 1)
    }
    ///Bit 2 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p66wp(&mut self) -> P66WP_W<M2WPR3rs> {
        P66WP_W::new(self, 2)
    }
    ///Bit 3 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p67wp(&mut self) -> P67WP_W<M2WPR3rs> {
        P67WP_W::new(self, 3)
    }
    ///Bit 4 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p68wp(&mut self) -> P68WP_W<M2WPR3rs> {
        P68WP_W::new(self, 4)
    }
    ///Bit 5 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p69wp(&mut self) -> P69WP_W<M2WPR3rs> {
        P69WP_W::new(self, 5)
    }
    ///Bit 6 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p70wp(&mut self) -> P70WP_W<M2WPR3rs> {
        P70WP_W::new(self, 6)
    }
    ///Bit 7 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p71wp(&mut self) -> P71WP_W<M2WPR3rs> {
        P71WP_W::new(self, 7)
    }
    ///Bit 8 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p72wp(&mut self) -> P72WP_W<M2WPR3rs> {
        P72WP_W::new(self, 8)
    }
    ///Bit 9 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p73wp(&mut self) -> P73WP_W<M2WPR3rs> {
        P73WP_W::new(self, 9)
    }
    ///Bit 10 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p74wp(&mut self) -> P74WP_W<M2WPR3rs> {
        P74WP_W::new(self, 10)
    }
    ///Bit 11 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p75wp(&mut self) -> P75WP_W<M2WPR3rs> {
        P75WP_W::new(self, 11)
    }
    ///Bit 12 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p76wp(&mut self) -> P76WP_W<M2WPR3rs> {
        P76WP_W::new(self, 12)
    }
    ///Bit 13 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p77wp(&mut self) -> P77WP_W<M2WPR3rs> {
        P77WP_W::new(self, 13)
    }
    ///Bit 14 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p78wp(&mut self) -> P78WP_W<M2WPR3rs> {
        P78WP_W::new(self, 14)
    }
    ///Bit 15 - SRAM2 1-Kbyte page y write protection
    #[inline(always)]
    pub fn p79wp(&mut self) -> P79WP_W<M2WPR3rs> {
        P79WP_W::new(self, 15)
    }
}
