...
impl W {
    ...
    ///Bit 25 - USART6 clock enable
    #[inline(always)]
    pub fn usart6en(&mut self) -> USART6EN_W<APB1LENRrs> {
        USART6EN_W::new(self, 25)
    }
    ///Bit 26 - USART10 clock enable
    #[inline(always)]
    pub fn usart10en(&mut self) -> USART10EN_W<APB1LENRrs> {
        USART10EN_W::new(self, 26)
    }
    ///Bit 27 - USART11 clock enable
    #[inline(always)]
    pub fn usart11en(&mut self) -> USART11EN_W<APB1LENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RCC:APB1LENR)*/
