...
///Field `WWDGLPEN` reader - WWDG clock enable during Sleep mode
...
///Field `I3C1LPEN` reader - I3C1 clock enable during Sleep mode
pub use TIM2LPEN_R as I3C1LPEN_R;
///Field `CRSLPEN` reader - CRS clock enable during Sleep mode
...
///Field `USART10LPEN` reader - USART10 clock enable during Sleep mode
pub use TIM2LPEN_R as USART10LPEN_R;
///Field `USART11LPEN` reader - USART11 clock enable during Sleep mode
pub use TIM2LPEN_R as USART11LPEN_R;
///Field `CECLPEN` reader - HDMI-CEC clock enable during Sleep mode
...
///Field `WWDGLPEN` writer - WWDG clock enable during Sleep mode
...
///Field `I3C1LPEN` writer - I3C1 clock enable during Sleep mode
pub use TIM2LPEN_W as I3C1LPEN_W;
///Field `CRSLPEN` writer - CRS clock enable during Sleep mode
...
///Field `USART10LPEN` writer - USART10 clock enable during Sleep mode
pub use TIM2LPEN_W as USART10LPEN_W;
///Field `USART11LPEN` writer - USART11 clock enable during Sleep mode
pub use TIM2LPEN_W as USART11LPEN_W;
///Field `CECLPEN` writer - HDMI-CEC clock enable during Sleep mode
...
impl W {
    ...
    ///Bit 25 - USART6 clock enable during Sleep mode
    #[inline(always)]
    pub fn usart6lpen(&mut self) -> USART6LPEN_W<'_, APB1LLPENRrs> {
        USART6LPEN_W::new(self, 25)
    }
    ///Bit 26 - USART10 clock enable during Sleep mode
    #[inline(always)]
    pub fn usart10lpen(&mut self) -> USART10LPEN_W<'_, APB1LLPENRrs> {
        USART10LPEN_W::new(self, 26)
    }
    ///Bit 27 - USART11 clock enable during Sleep mode
    #[inline(always)]
    pub fn usart11lpen(&mut self) -> USART11LPEN_W<'_, APB1LLPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RCC:APB1LLPENR)*/
...
impl crate::Resettable for APB1LLPENRrs {
    const RESET_VALUE: u32 = 0x13fe_c87f;
}
