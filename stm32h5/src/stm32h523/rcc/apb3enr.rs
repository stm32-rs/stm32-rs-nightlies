...
///Field `SBSEN` reader - SBS clock enable
...
///Field `SBSEN` writer - SBS clock enable
...
///Field `LPTIM3EN` reader - LPTIM3 clock enable
pub use SBSEN_R as LPTIM3EN_R;
///Field `LPTIM4EN` reader - LPTIM4 clock enable
pub use SBSEN_R as LPTIM4EN_R;
///Field `LPTIM5EN` reader - LPTIM5 clock enable
pub use SBSEN_R as LPTIM5EN_R;
///Field `LPTIM6EN` reader - LPTIM6 clock enable
pub use SBSEN_R as LPTIM6EN_R;
///Field `VREFEN` reader - VREFBUF clock enable
pub use SBSEN_R as VREFEN_R;
///Field `RTCAPBEN` reader - RTC APB interface clock enable
...
///Field `LPTIM3EN` writer - LPTIM3 clock enable
pub use SBSEN_W as LPTIM3EN_W;
///Field `LPTIM4EN` writer - LPTIM4 clock enable
pub use SBSEN_W as LPTIM4EN_W;
///Field `LPTIM5EN` writer - LPTIM5 clock enable
pub use SBSEN_W as LPTIM5EN_W;
///Field `LPTIM6EN` writer - LPTIM6 clock enable
pub use SBSEN_W as LPTIM6EN_W;
///Field `VREFEN` writer - VREFBUF clock enable
pub use SBSEN_W as VREFEN_W;
///Field `RTCAPBEN` writer - RTC APB interface clock enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#RCC:APB3ENR)*/
