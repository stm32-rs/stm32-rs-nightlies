...
///Field `TAMP8POM` reader - Tamper 8 potential mode
pub type TAMP8POM_R = crate::BitReader;
///Field `TAMP8POM` writer - Tamper 8 potential mode
pub type TAMP8POM_W<'a, REG> = crate::BitWriter<'a, REG>;
...
///Field `TAMP8TRG` reader - Active level for tamper 8 input (active mode disabled)
pub type TAMP8TRG_R = crate::BitReader;
///Field `TAMP8TRG` writer - Active level for tamper 8 input (active mode disabled)
...
impl R {
    ...
    #[inline(always)]
    pub fn tamp8pom(&self) -> TAMP8POM_R {
        TAMP8POM_R::new(((self.bits >> 7) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 7 - Tamper 8 potential mode
    #[inline(always)]
    pub fn tamp8pom(&mut self) -> TAMP8POM_W<'_, CR2rs> {
        TAMP8POM_W::new(self, 7)
    }
    ///Bit 16 - Tamper 1 mask
    #[inline(always)]
