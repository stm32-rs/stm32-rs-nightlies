...
///Field `TAMP8MF` reader - TAMP8 secure interrupt masked flag
...
///Field `ITAMP12MF` reader - internal tamper 12 secure interrupt masked flag
pub type ITAMP12MF_R = crate::BitReader;
///Field `ITAMP13MF` reader - internal tamper 13 secure interrupt masked flag
pub type ITAMP13MF_R = crate::BitReader;
///Field `ITAMP15MF` reader - internal tamper 15 secure interrupt masked flag
