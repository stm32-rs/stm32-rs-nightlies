...
///Field `TI1SEL` reader - Selects tim_ti1\[0..15\] input
pub type TI1SEL_R = crate::FieldReader;
///Field `TI1SEL` writer - Selects tim_ti1\[0..15\] input
pub type TI1SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TI2SEL` reader - Selects tim_ti2\[0..15\] input
pub type TI2SEL_R = crate::FieldReader;
///Field `TI2SEL` writer - Selects tim_ti2\[0..15\] input
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#TIM12:TISEL)*/
pub struct TISELrs;
