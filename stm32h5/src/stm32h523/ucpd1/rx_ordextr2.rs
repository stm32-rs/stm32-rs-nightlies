...
///Field `RXSOPX2` reader - Ordered set 2 received
pub type RXSOPX2_R = crate::FieldReader<u32>;
///Field `RXSOPX2` writer - Ordered set 2 received
...
impl W {
    ///Bits 0:19 - Ordered set 2 received
    #[inline(always)]
    pub fn rxsopx2(&mut self) -> RXSOPX2_W<'_, RX_ORDEXTR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#UCPD1:RX_ORDEXTR2)*/
