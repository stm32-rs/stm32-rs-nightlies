...
///Field `RXSOP3OF4` reader - The bit indicates the number of correct K-codes.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#UCPD1:RX_ORDSETR)*/
