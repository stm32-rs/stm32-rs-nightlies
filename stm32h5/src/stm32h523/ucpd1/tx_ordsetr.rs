...
///Field `TXORDSET` reader - Ordered set to transmit
pub type TXORDSET_R = crate::FieldReader<u32>;
///Field `TXORDSET` writer - Ordered set to transmit
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#UCPD1:TX_ORDSETR)*/
