...
///Field `TXPAYSZ` reader - Payload size yet to transmit
pub type TXPAYSZ_R = crate::FieldReader<u16>;
///Field `TXPAYSZ` writer - Payload size yet to transmit
...
impl W {
    ///Bits 0:9 - Payload size yet to transmit
    #[inline(always)]
    pub fn txpaysz(&mut self) -> TXPAYSZ_W<'_, TX_PAYSZRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#UCPD1:TX_PAYSZR)*/
