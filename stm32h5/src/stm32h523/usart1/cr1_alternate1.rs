...
///Field `WAKE` reader - Receiver wake-up method
pub type WAKE_R = crate::BitReader;
///Field `WAKE` writer - Receiver wake-up method
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#USART1:CR1_ALTERNATE1)*/
