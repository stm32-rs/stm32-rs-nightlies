...
/**Wake-up from low-power mode clear flag
...
///Field `WUCF` writer - Wake-up from low-power mode clear flag
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#USART1:ICR)*/
pub struct ICRrs;
