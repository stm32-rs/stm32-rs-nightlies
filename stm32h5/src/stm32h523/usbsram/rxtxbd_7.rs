///Register `RXTXBD_7` reader
pub type R = crate::R<RXTXBD_7rs>;
///Register `RXTXBD_7` writer
pub type W = crate::W<RXTXBD_7rs>;
...
impl W {
    ///Bits 0:15 - Reception buffer address
    #[inline(always)]
    pub fn addr_rx(&mut self) -> ADDR_RX_W<'_, RXTXBD_7rs> {
        ADDR_RX_W::new(self, 0)
    }
    ///Bits 26:30 - Number of blocks
    #[inline(always)]
    pub fn num_block(&mut self) -> NUM_BLOCK_W<'_, RXTXBD_7rs> {
        NUM_BLOCK_W::new(self, 26)
    }
    ///Bit 31 - Block size
    #[inline(always)]
    pub fn blsize(&mut self) -> BLSIZE_W<'_, RXTXBD_7rs> {
        BLSIZE_W::new(self, 31)
    }
}
/**Channel/endpoint receive buffer descriptor 7

You can [`read`](crate::Reg::read) this register and get [`rxtxbd_7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rxtxbd_7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H523.html#USBSRAM:RXTXBD_7)*/
pub struct RXTXBD_7rs;
impl crate::RegisterSpec for RXTXBD_7rs {
    type Ux = u32;
}
///`read()` method returns [`rxtxbd_7::R`](R) reader structure
impl crate::Readable for RXTXBD_7rs {}
///`write(|w| ..)` method takes [`rxtxbd_7::W`](W) writer structure
impl crate::Writable for RXTXBD_7rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RXTXBD_7 to value 0
impl crate::Resettable for RXTXBD_7rs {}
