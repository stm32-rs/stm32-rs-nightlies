...
///Field `OFFSET_EN` reader - Offset y enable
...
///Field `OFFSET_EN` writer - Offset y enable
...
impl W {
    ...
    ///Bit 24 - Positive offset
    #[inline(always)]
    pub fn offsetpos(&mut self) -> OFFSETPOS_W<OFRrs> {
        OFFSETPOS_W::new(self, 24)
    }
    ///Bit 25 - Saturation enable
    #[inline(always)]
    pub fn saten(&mut self) -> SATEN_W<OFRrs> {
        SATEN_W::new(self, 25)
    }
    ///Bits 26:30 - Channel selection for the data offset y
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#ADC1:OFR[1])*/
pub struct OFRrs;
