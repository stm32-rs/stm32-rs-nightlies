...
///Field `THOLD1` reader - DAC channel1 hold time (only valid in Sample and hold mode)
pub type THOLD1_R = crate::FieldReader<u16>;
///Field `THOLD1` writer - DAC channel1 hold time (only valid in Sample and hold mode)
pub type THOLD1_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `THOLD2` reader - DAC channel2 hold time (only valid in Sample and hold mode).
pub type THOLD2_R = crate::FieldReader<u16>;
///Field `THOLD2` writer - DAC channel2 hold time (only valid in Sample and hold mode).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#DAC:SHHR)*/
pub struct SHHRrs;
