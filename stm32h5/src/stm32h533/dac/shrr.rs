...
///Field `TREFRESH1` reader - DAC channel1 refresh time (only valid in Sample and hold mode)
pub type TREFRESH1_R = crate::FieldReader;
///Field `TREFRESH1` writer - DAC channel1 refresh time (only valid in Sample and hold mode)
pub type TREFRESH1_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `TREFRESH2` reader - DAC channel2 refresh time (only valid in Sample and hold mode)
pub type TREFRESH2_R = crate::FieldReader;
///Field `TREFRESH2` writer - DAC channel2 refresh time (only valid in Sample and hold mode)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#DAC:SHRR)*/
pub struct SHRRrs;
