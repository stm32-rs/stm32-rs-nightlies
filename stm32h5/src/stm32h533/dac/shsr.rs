...
///Field `TSAMPLE` reader - DAC channel1 sample time (only valid in Sample and hold mode)
pub type TSAMPLE_R = crate::FieldReader<u16>;
///Field `TSAMPLE` writer - DAC channel1 sample time (only valid in Sample and hold mode)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#DAC:SHSR[1])*/
pub struct SHSRrs;
