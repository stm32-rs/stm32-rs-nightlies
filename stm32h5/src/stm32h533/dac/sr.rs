...
///Field `CAL_FLAG1` reader - DAC channel1 calibration offset status
pub type CAL_FLAG1_R = crate::BitReader;
///Field `BWST1` reader - DAC channel1 busy writing sample time flag
pub type BWST1_R = crate::BitReader;
///Field `DAC2RDY` reader - DAC channel2 ready status bit
pub type DAC2RDY_R = crate::BitReader;
///Field `DORSTAT2` reader - DAC channel2 output register status bit
...
///Field `CAL_FLAG2` reader - DAC channel2 calibration offset status
pub type CAL_FLAG2_R = crate::BitReader;
///Field `BWST2` reader - DAC channel2 busy writing sample time flag
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#DAC:SR)*/
pub struct SRrs;
