...
///Field `CMDENDADDR` reader - end address of range to which the cache maintenance command specified in DCACHE_CR.
pub type CMDENDADDR_R = crate::FieldReader<u32>;
///Field `CMDENDADDR` writer - end address of range to which the cache maintenance command specified in DCACHE_CR.
