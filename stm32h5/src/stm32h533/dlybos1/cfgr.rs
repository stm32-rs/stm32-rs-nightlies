...
///Field `SEL` reader - Phase for the output clock.
pub type SEL_R = crate::FieldReader;
///Field `SEL` writer - Phase for the output clock.
pub type SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `UNIT` reader - Delay of a unit delay cell.
pub type UNIT_R = crate::FieldReader;
///Field `UNIT` writer - Delay of a unit delay cell.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#DLYBOS1:CFGR)*/
pub struct CFGRrs;
