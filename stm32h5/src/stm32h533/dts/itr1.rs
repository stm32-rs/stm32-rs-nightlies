...
///Field `TS1_LITTHD` reader - Low interrupt threshold for temperature sensor 1
pub type TS1_LITTHD_R = crate::FieldReader<u16>;
///Field `TS1_LITTHD` writer - Low interrupt threshold for temperature sensor 1
pub type TS1_LITTHD_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `TS1_HITTHD` reader - High interrupt threshold for temperature sensor 1
pub type TS1_HITTHD_R = crate::FieldReader<u16>;
///Field `TS1_HITTHD` writer - High interrupt threshold for temperature sensor 1
