...
///Field `TS1_RAMP_COEFF` reader - Engineering value of the ramp coefficient for the temperature sensor 1.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#DTS:RAMPVALR)*/
