...
///Field `TS1_FMT0` reader - Engineering value of the frequency measured at T0 for
pub type TS1_FMT0_R = crate::FieldReader<u16>;
///Field `TS1_T0` reader - Engineering value of the T0 temperature for temperature sensor 1.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#DTS:T0VALR1)*/
