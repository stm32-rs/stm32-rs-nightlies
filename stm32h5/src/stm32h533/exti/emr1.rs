...
/**CPU wake-up with event generation mask on event input x
...
///Field `EM0` reader - CPU wake-up with event generation mask on event input x
...
///Field `EM0` writer - CPU wake-up with event generation mask on event input x
...
///Field `EM1` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM1_R;
///Field `EM2` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM2_R;
///Field `EM3` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM3_R;
///Field `EM4` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM4_R;
///Field `EM5` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM5_R;
///Field `EM6` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM6_R;
///Field `EM7` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM7_R;
///Field `EM8` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM8_R;
///Field `EM9` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM9_R;
///Field `EM10` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM10_R;
///Field `EM11` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM11_R;
///Field `EM12` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM12_R;
///Field `EM13` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM13_R;
///Field `EM14` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM14_R;
///Field `EM15` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM15_R;
///Field `EM16` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM16_R;
///Field `EM17` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM17_R;
///Field `EM18` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM18_R;
///Field `EM19` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM19_R;
///Field `EM20` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM20_R;
///Field `EM21` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM21_R;
///Field `EM22` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM22_R;
///Field `EM23` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM23_R;
///Field `EM24` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM24_R;
///Field `EM25` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM25_R;
///Field `EM26` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM26_R;
///Field `EM27` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM27_R;
///Field `EM28` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM28_R;
///Field `EM29` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM29_R;
///Field `EM30` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM30_R;
///Field `EM31` reader - CPU wake-up with event generation mask on event input x
pub use EM0_R as EM31_R;
///Field `EM1` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM1_W;
///Field `EM2` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM2_W;
///Field `EM3` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM3_W;
///Field `EM4` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM4_W;
///Field `EM5` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM5_W;
///Field `EM6` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM6_W;
///Field `EM7` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM7_W;
///Field `EM8` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM8_W;
///Field `EM9` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM9_W;
///Field `EM10` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM10_W;
///Field `EM11` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM11_W;
///Field `EM12` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM12_W;
///Field `EM13` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM13_W;
///Field `EM14` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM14_W;
///Field `EM15` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM15_W;
///Field `EM16` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM16_W;
///Field `EM17` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM17_W;
///Field `EM18` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM18_W;
///Field `EM19` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM19_W;
///Field `EM20` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM20_W;
///Field `EM21` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM21_W;
///Field `EM22` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM22_W;
///Field `EM23` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM23_W;
///Field `EM24` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM24_W;
///Field `EM25` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM25_W;
///Field `EM26` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM26_W;
///Field `EM27` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM27_W;
///Field `EM28` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM28_W;
///Field `EM29` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM29_W;
///Field `EM30` writer - CPU wake-up with event generation mask on event input x
pub use EM0_W as EM30_W;
///Field `EM31` writer - CPU wake-up with event generation mask on event input x
...
impl W {
    ...
    ///Bit 17 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    pub fn em17(&mut self) -> EM17_W<'_, EMR1rs> {
        EM17_W::new(self, 17)
    }
    ///Bit 18 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    pub fn em18(&mut self) -> EM18_W<'_, EMR1rs> {
        EM18_W::new(self, 18)
    }
    ///Bit 19 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    ...
    ///Bit 20 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    pub fn em20(&mut self) -> EM20_W<'_, EMR1rs> {
        EM20_W::new(self, 20)
    }
    ///Bit 21 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    ...
    ///Bit 22 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    pub fn em22(&mut self) -> EM22_W<'_, EMR1rs> {
        EM22_W::new(self, 22)
    }
    ///Bit 23 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    ...
    ///Bit 24 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    pub fn em24(&mut self) -> EM24_W<'_, EMR1rs> {
        EM24_W::new(self, 24)
    }
    ///Bit 25 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    ...
    ///Bit 27 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
    pub fn em27(&mut self) -> EM27_W<'_, EMR1rs> {
        EM27_W::new(self, 27)
    }
    ///Bit 28 - CPU wake-up with event generation mask on event input x
    #[inline(always)]
