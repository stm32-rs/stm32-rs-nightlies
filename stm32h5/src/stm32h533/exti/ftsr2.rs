...
///Field `FT46` reader - Falling trigger event configuration bit of configurable event input x less thansup>(1)less than/sup>
...
///Field `FT46` writer - Falling trigger event configuration bit of configurable event input x less thansup>(1)less than/sup>
...
///Field `FT50` reader - Falling trigger event configuration bit of configurable event input x less thansup>(1)less than/sup>
pub use FT46_R as FT50_R;
///Field `FT53` reader - Falling trigger event configuration bit of configurable event input x
pub use FT46_R as FT53_R;
///Field `FT50` writer - Falling trigger event configuration bit of configurable event input x less thansup>(1)less than/sup>
pub use FT46_W as FT50_W;
///Field `FT53` writer - Falling trigger event configuration bit of configurable event input x
