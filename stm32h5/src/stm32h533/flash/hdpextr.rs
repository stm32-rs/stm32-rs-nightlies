...
///Field `HDP1_EXT` reader - HDP area extension in 8 Kbytes sectors in Bank1.
pub type HDP1_EXT_R = crate::FieldReader;
///Field `HDP1_EXT` writer - HDP area extension in 8 Kbytes sectors in Bank1.
pub type HDP1_EXT_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `HDP2_EXT` reader - HDP area extension in 8 Kbytes sectors in Bank2.
pub type HDP2_EXT_R = crate::FieldReader;
///Field `HDP2_EXT` writer - HDP area extension in 8 Kbytes sectors in Bank2.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#FLASH:HDPEXTR)*/
