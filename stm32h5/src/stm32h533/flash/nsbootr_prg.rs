...
///Field `NSBOOT_LOCK` reader - Field locking the values of SWAP_ BANK, and NSBOOTADD settings.
pub type NSBOOT_LOCK_R = crate::FieldReader;
///Field `NSBOOT_LOCK` writer - Field locking the values of SWAP_ BANK, and NSBOOTADD settings.
pub type NSBOOT_LOCK_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `NSBOOTADD` reader - Non secure unique boot entry address
pub type NSBOOTADD_R = crate::FieldReader<u32>;
///Field `NSBOOTADD` writer - Non secure unique boot entry address
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#FLASH:NSBOOTR_PRG)*/
