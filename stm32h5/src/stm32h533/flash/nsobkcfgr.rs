...
impl W {
    ///Bit 0 - OBKCFGR lock option configuration bit
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<'_, NSOBKCFGRrs> {
        LOCK_W::new(self, 0)
    }
    ///Bit 1 - OBK swap sector request bit
    #[inline(always)]
    pub fn swap_sect_req(&mut self) -> SWAP_SECT_REQ_W<'_, NSOBKCFGRrs> {
        SWAP_SECT_REQ_W::new(self, 1)
    }
    ///Bit 2 - alternate sector bit
    #[inline(always)]
    pub fn alt_sect(&mut self) -> ALT_SECT_W<'_, NSOBKCFGRrs> {
        ALT_SECT_W::new(self, 2)
    }
    ///Bit 3 - alternate sector erase bit
    #[inline(always)]
    pub fn alt_sect_erase(&mut self) -> ALT_SECT_ERASE_W<'_, NSOBKCFGRrs> {
        ALT_SECT_ERASE_W::new(self, 3)
    }
    ///Bits 16:24 - Key index (offset /16 bits) pointing for next swap.
    #[inline(always)]
    pub fn swap_offset(&mut self) -> SWAP_OFFSET_W<'_, NSOBKCFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#FLASH:NSOBKCFGR)*/
