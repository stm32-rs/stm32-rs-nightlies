...
///Field `DATA_OP` reader - Flash high-cycle data area operation interrupted
pub type DATA_OP_R = crate::BitReader;
///Field `BK_OP` reader - Interrupted operation bank
pub type BK_OP_R = crate::BitReader;
///Field `SYSF_OP` reader - Operation in system flash memory interrupted
pub type SYSF_OP_R = crate::BitReader;
///Field `OTP_OP` reader - OTP operation interrupted
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#FLASH:OPSR)*/
pub struct OPSRrs;
