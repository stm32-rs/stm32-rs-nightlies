///Register `SECBB2R1` reader
pub type R = crate::R<SECBB2R1rs>;
///Register `SECBB2R1` writer
...
impl W {
    ///Bits 0:31 - Secure/non-secure flash Bank2 sector attribute
    #[inline(always)]
    pub fn secbb2(&mut self) -> SECBB2_W<'_, SECBB2R1rs> {
        SECBB2_W::new(self, 0)
    }
}
/**FLASH secure block-based register for Bank2

You can [`read`](crate::Reg::read) this register and get [`secbb2r1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`secbb2r1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#FLASH:SECBB2R1)*/
pub struct SECBB2R1rs;
impl crate::RegisterSpec for SECBB2R1rs {
    type Ux = u32;
}
///`read()` method returns [`secbb2r1::R`](R) reader structure
impl crate::Readable for SECBB2R1rs {}
///`write(|w| ..)` method takes [`secbb2r1::W`](W) writer structure
