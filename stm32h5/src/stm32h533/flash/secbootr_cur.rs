...
///Field `SECBOOT_LOCK` reader - Field locking the values of UBE, SWAP_BANK, and SECBOOTADD settings.
pub type SECBOOT_LOCK_R = crate::FieldReader;
///Field `SECBOOTADD` reader - Unique boot entry secure address
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#FLASH:SECBOOTR_CUR)*/
