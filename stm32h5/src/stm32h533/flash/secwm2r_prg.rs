...
impl W {
    ///Bits 0:6 - Bank2 security WM area start sector
    #[inline(always)]
    pub fn secwm2_strt(&mut self) -> SECWM2_STRT_W<SECWM2R_PRGrs> {
        SECWM2_STRT_W::new(self, 0)
    }
    ///Bits 16:22 - Bank2 security WM area end sector
    #[inline(always)]
    pub fn secwm2_end(&mut self) -> SECWM2_END_W<SECWM2R_PRGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#FLASH:SECWM2R_PRG)*/
