...
///Field `IRS` reader - Interrupt rising edge status
...
///Field `IRS` writer - Interrupt rising edge status
...
///Field `ILS` reader - Interrupt high-level status
...
///Field `ILS` writer - Interrupt high-level status
...
///Field `IFS` reader - Interrupt falling edge status
...
///Field `IFS` writer - Interrupt falling edge status
