...
impl RegisterBlock {
    ...
    ///0x0c - GPDMA nonsecure masked interrupt status register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#GPDMA1:SECCFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#GPDMA1:RCFGLOCKR)
...
pub mod rcfglockr;
/**MISR (r) register accessor: GPDMA nonsecure masked interrupt status register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#GPDMA1:SMISR)
