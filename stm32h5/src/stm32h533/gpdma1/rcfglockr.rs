...
///Field `LOCK(0-7)` reader - lock the configuration of GPDMA_SECCFGR.
pub type LOCK_R = crate::BitReader;
///Field `LOCK(0-7)` writer - lock the configuration of GPDMA_SECCFGR.
pub type LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///lock the configuration of GPDMA_SECCFGR.
    ///
