...
pub use crate::stm32h533::gpioa::seccfgr::SECURE_PIN;
///Field `SEC(0-15)` reader - I/O pin of Port x secure bit enable y
pub use crate::stm32h533::gpioa::seccfgr::SEC_R;
///Field `SEC(0-15)` writer - I/O pin of Port x secure bit enable y
pub use crate::stm32h533::gpioa::seccfgr::SEC_W;
impl R {
    ///I/O pin of Port x secure bit enable y
    ///
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#GPIOD:SECCFGR)*/
