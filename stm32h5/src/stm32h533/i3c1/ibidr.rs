...
/**Field `IBIDB0` reader - 8-bit IBI payload data (earliest byte on I3C bus, MDB\[7:0\]
mandatory data byte).*/
pub type IBIDB0_R = crate::FieldReader;
/**Field `IBIDB0` writer - 8-bit IBI payload data (earliest byte on I3C bus, MDB\[7:0\]
mandatory data byte).*/
...
impl R {
    /**Bits 0:7 - 8-bit IBI payload data (earliest byte on I3C bus, MDB\[7:0\]
    mandatory data byte).*/
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#I3C1:IBIDR)*/
pub struct IBIDRrs;
