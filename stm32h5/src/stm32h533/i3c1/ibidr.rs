...
///Field `IBIDB0` reader - 8-bit IBI payload data (earliest byte on I3C bus, MDB\[7:0\] mandatory data byte).
pub type IBIDB0_R = crate::FieldReader;
///Field `IBIDB0` writer - 8-bit IBI payload data (earliest byte on I3C bus, MDB\[7:0\] mandatory data byte).
