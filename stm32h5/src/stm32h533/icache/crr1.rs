...
///Field `BASEADDR` reader - base address for region x
pub type BASEADDR_R = crate::FieldReader;
///Field `BASEADDR` writer - base address for region x
...
///Field `REMAPADDR` reader - remapped address for region x
pub type REMAPADDR_R = crate::FieldReader<u16>;
///Field `REMAPADDR` writer - remapped address for region x
