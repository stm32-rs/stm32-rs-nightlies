...
impl W {
    ...
    #[inline(always)]
    pub fn cc1cf(&mut self) -> CC1CF_W<'_, ICR_ALTERNATE1rs> {
        CC1CF_W::new(self, 0)
    }
    ///Bit 1 - Autoreload match clear flag
    #[inline(always)]
    pub fn arrmcf(&mut self) -> ARRMCF_W<'_, ICR_ALTERNATE1rs> {
        ARRMCF_W::new(self, 1)
    }
    ///Bit 2 - External trigger valid edge clear flag
    #[inline(always)]
    pub fn exttrigcf(&mut self) -> EXTTRIGCF_W<'_, ICR_ALTERNATE1rs> {
        EXTTRIGCF_W::new(self, 2)
    }
    ///Bit 4 - Autoreload register update OK clear flag
    #[inline(always)]
    pub fn arrokcf(&mut self) -> ARROKCF_W<'_, ICR_ALTERNATE1rs> {
        ARROKCF_W::new(self, 4)
    }
    ///Bit 5 - Direction change to UP clear flag
    #[inline(always)]
    pub fn upcf(&mut self) -> UPCF_W<'_, ICR_ALTERNATE1rs> {
        UPCF_W::new(self, 5)
    }
    ///Bit 6 - Direction change to down clear flag
    #[inline(always)]
    pub fn downcf(&mut self) -> DOWNCF_W<'_, ICR_ALTERNATE1rs> {
        DOWNCF_W::new(self, 6)
    }
    ///Bit 7 - Update event clear flag
    #[inline(always)]
    pub fn uecf(&mut self) -> UECF_W<'_, ICR_ALTERNATE1rs> {
        UECF_W::new(self, 7)
    }
    ///Bit 8 - Repetition register update OK clear flag
    #[inline(always)]
    pub fn repokcf(&mut self) -> REPOKCF_W<'_, ICR_ALTERNATE1rs> {
        REPOKCF_W::new(self, 8)
    }
    ///Bit 9 - Capture/compare 2 clear flag
    #[inline(always)]
    pub fn cc2cf(&mut self) -> CC2CF_W<'_, ICR_ALTERNATE1rs> {
        CC2CF_W::new(self, 9)
    }
    ///Bit 12 - Capture/compare 1 over-capture clear flag
    #[inline(always)]
    pub fn cc1ocf(&mut self) -> CC1OCF_W<'_, ICR_ALTERNATE1rs> {
        CC1OCF_W::new(self, 12)
    }
    ///Bit 13 - Capture/compare 2 over-capture clear flag
    #[inline(always)]
    pub fn cc2ocf(&mut self) -> CC2OCF_W<'_, ICR_ALTERNATE1rs> {
        CC2OCF_W::new(self, 13)
    }
    ///Bit 24 - Interrupt enable register update OK clear flag
    #[inline(always)]
    pub fn dierokcf(&mut self) -> DIEROKCF_W<'_, ICR_ALTERNATE1rs> {
