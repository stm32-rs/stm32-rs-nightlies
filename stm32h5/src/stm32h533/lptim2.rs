...
impl RegisterBlock {
    ///0x00 - LPTIM2 interrupt and status register
    #[inline(always)]
    ...
    ///0x04 - LPTIM2 interrupt clear register
    #[inline(always)]
    ...
    ///0x08 - LPTIM2 interrupt enable register
    #[inline(always)]
...
/**ISR (r) register accessor: LPTIM2 interrupt and status register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`isr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:ISR)
...
pub mod isr;
/**ISR_ALTERNATE1 (r) register accessor: LPTIM2 interrupt and status register

You can [`read`](crate::Reg::read) this register and get [`isr_alternate1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:ISR_ALTERNATE1)
...
/**ICR (w) register accessor: LPTIM2 interrupt clear register \[alternate\]

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:ICR)
...
pub mod icr;
/**ICR_ALTERNATE1 (w) register accessor: LPTIM2 interrupt clear register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:ICR_ALTERNATE1)

For information about available fields see [`mod@icr_alternate1`]
module*/
pub type ICR_ALTERNATE1 = crate::Reg<icr_alternate1::ICR_ALTERNATE1rs>;
///LPTIM2 interrupt clear register
pub mod icr_alternate1;
/**DIER (rw) register accessor: LPTIM2 interrupt enable register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`dier::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dier::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:DIER)
...
pub mod dier;
/**DIER_ALTERNATE1 (rw) register accessor: LPTIM2 interrupt enable register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:DIER_ALTERNATE1)

For information about available fields see [`mod@dier_alternate1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:CFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:CCR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:CNT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:CFGR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:RCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:CCMR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPTIM2:CCR2)
