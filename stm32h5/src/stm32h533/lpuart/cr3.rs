...
///Field `WUS` reader - Wake-up from low-power mode interrupt flag selection
...
///Field `WUS` writer - Wake-up from low-power mode interrupt flag selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#LPUART:CR3)*/
pub struct CR3rs;
