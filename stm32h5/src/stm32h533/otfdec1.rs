...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:PRIVCFGR)
...
pub mod privcfgr;
/**R1CFGR (rw) register accessor: OTFDEC region 1 configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R1CFGR)
...
pub mod r1cfgr;
/**R1STARTADDR (rw) register accessor: OTFDEC region 1 start address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R1STARTADDR)
...
pub mod r1startaddr;
/**R1ENDADDR (rw) register accessor: OTFDEC region 1 end address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R1ENDADDR)
...
pub mod r1endaddr;
/**R1NONCER0 (rw) register accessor: OTFDEC region 1 nonce register 0
...
pub mod r1noncer0;
/**R1NONCER1 (rw) register accessor: OTFDEC region 1 nonce register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R1NONCER1)
...
pub mod r1noncer1;
/**R1KEYR0 (w) register accessor: OTFDEC region 1 key register 0
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R1KEYR0)
...
pub mod r1keyr0;
/**R1KEYR1 (w) register accessor: OTFDEC region 1 key register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R1KEYR1)
...
pub mod r1keyr1;
/**R1KEYR2 (w) register accessor: OTFDEC region 1 key register 2
...
pub mod r1keyr2;
/**R1KEYR3 (w) register accessor: OTFDEC region 1 key register 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R1KEYR3)
...
pub mod r1keyr3;
/**R2CFGR (rw) register accessor: OTFDEC region 2 configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R2CFGR)
...
pub mod r2cfgr;
/**R2STARTADDR (rw) register accessor: OTFDEC region 2 start address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R2STARTADDR)
...
pub mod r2startaddr;
/**R2ENDADDR (rw) register accessor: OTFDEC region 2 end address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R2ENDADDR)
...
pub mod r2endaddr;
/**R2NONCER0 (rw) register accessor: OTFDEC region 2 nonce register 0
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R2NONCER0)
...
pub mod r2noncer0;
/**R2NONCER1 (rw) register accessor: OTFDEC region 2 nonce register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R2NONCER1)
...
pub mod r2noncer1;
/**R2KEYR0 (w) register accessor: OTFDEC region 2 key register 0
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R2KEYR0)
...
pub mod r2keyr0;
/**R2KEYR1 (w) register accessor: OTFDEC region 2 key register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R2KEYR1)
...
pub mod r2keyr1;
/**R2KEYR2 (w) register accessor: OTFDEC region 2 key register 2
...
pub mod r2keyr2;
/**R2KEYR3 (w) register accessor: OTFDEC region 2 key register 3
...
pub mod r2keyr3;
/**R3CFGR (rw) register accessor: OTFDEC region 3 configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R3CFGR)
...
pub mod r3cfgr;
/**R3STARTADDR (rw) register accessor: OTFDEC region 3 start address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R3STARTADDR)
...
pub mod r3startaddr;
/**R3ENDADDR (rw) register accessor: OTFDEC region 3 end address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R3ENDADDR)
...
pub mod r3endaddr;
/**R3NONCER0 (rw) register accessor: OTFDEC region 3 nonce register 0
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R3NONCER0)
...
pub mod r3noncer0;
/**R3NONCER1 (rw) register accessor: OTFDEC region 3 nonce register 1
...
pub mod r3noncer1;
/**R3KEYR0 (w) register accessor: OTFDEC region 3 key register 0
...
pub mod r3keyr0;
/**R3KEYR1 (w) register accessor: OTFDEC region 3 key register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R3KEYR1)
...
pub mod r3keyr1;
/**R3KEYR2 (w) register accessor: OTFDEC region 3 key register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R3KEYR2)
...
pub mod r3keyr2;
/**R3KEYR3 (w) register accessor: OTFDEC region 3 key register 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R3KEYR3)
...
pub mod r3keyr3;
/**R4CFGR (rw) register accessor: OTFDEC region 4 configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R4CFGR)
...
pub mod r4cfgr;
/**R4STARTADDR (rw) register accessor: OTFDEC region 4 start address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R4STARTADDR)
...
pub mod r4startaddr;
/**R4ENDADDR (rw) register accessor: OTFDEC region 4 end address register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R4ENDADDR)
...
pub mod r4endaddr;
/**R4NONCER0 (rw) register accessor: OTFDEC region 4 nonce register 0
...
pub mod r4noncer0;
/**R4NONCER1 (rw) register accessor: OTFDEC region 4 nonce register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R4NONCER1)
...
pub mod r4noncer1;
/**R4KEYR0 (w) register accessor: OTFDEC region 4 key register 0
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R4KEYR0)
...
pub mod r4keyr0;
/**R4KEYR1 (w) register accessor: OTFDEC region 4 key register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R4KEYR1)
...
pub mod r4keyr1;
/**R4KEYR2 (w) register accessor: OTFDEC region 4 key register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R4KEYR2)
...
pub mod r4keyr2;
/**R4KEYR3 (w) register accessor: OTFDEC region 4 key register 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:R4KEYR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:ISR)

For information about available fields see [`mod@isr`] module*/
pub type ISR = crate::Reg<isr::ISRrs>;
///OTFDEC interrupt status register
pub mod isr;
/**ICR (w) register accessor: OTFDEC interrupt clear register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#OTFDEC1:IER)
