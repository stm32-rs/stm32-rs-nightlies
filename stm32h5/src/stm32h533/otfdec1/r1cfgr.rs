...
///Field `REG_VERSION` reader - region firmware version
pub type REG_VERSION_R = crate::FieldReader<u16>;
///Field `REG_VERSION` writer - region firmware version
pub type REG_VERSION_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ...
    #[inline(always)]
    pub fn reg_version(&self) -> REG_VERSION_R {
        REG_VERSION_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
...
impl W {
    ...
    ///Bits 16:31 - region firmware version
    #[inline(always)]
    pub fn reg_version(&mut self) -> REG_VERSION_W<'_, R1CFGRrs> {
        REG_VERSION_W::new(self, 16)
    }
}
