...
///Field `REG_END_ADDR` reader - Region AHB end address
pub type REG_END_ADDR_R = crate::FieldReader<u32>;
///Field `REG_END_ADDR` writer - Region AHB end address
pub type REG_END_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Region AHB end address
    #[inline(always)]
    pub fn reg_end_addr(&self) -> REG_END_ADDR_R {
        REG_END_ADDR_R::new(self.bits)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("R2ENDADDR")
            .field("reg_end_addr", &self.reg_end_addr())
            .finish()
    }
}
impl W {
    ///Bits 0:31 - Region AHB end address
    #[inline(always)]
    pub fn reg_end_addr(&mut self) -> REG_END_ADDR_W<'_, R2ENDADDRrs> {
        REG_END_ADDR_W::new(self, 0)
    }
}
