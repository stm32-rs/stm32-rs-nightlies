...
///Field `REG_START_ADDR` reader - Region AHB start address
pub type REG_START_ADDR_R = crate::FieldReader<u32>;
///Field `REG_START_ADDR` writer - Region AHB start address
pub type REG_START_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Region AHB start address
    #[inline(always)]
    pub fn reg_start_addr(&self) -> REG_START_ADDR_R {
        REG_START_ADDR_R::new(self.bits)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("R3STARTADDR")
            .field("reg_start_addr", &self.reg_start_addr())
            .finish()
    }
}
impl W {
    ///Bits 0:31 - Region AHB start address
    #[inline(always)]
    pub fn reg_start_addr(&mut self) -> REG_START_ADDR_W<'_, R3STARTADDRrs> {
        REG_START_ADDR_W::new(self, 0)
    }
}
