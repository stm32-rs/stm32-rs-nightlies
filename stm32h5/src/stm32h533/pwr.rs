...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn pmcr_alternate1(&self) -> &PMCR_ALTERNATE1 {
    ...
    ///0x40 - PWR wake-up status clear register
    #[inline(always)]
    pub const fn wuscr(&self) -> &WUSCR {
        &self.wuscr
    }
    ///0x44 - PWR wake-up status register
    #[inline(always)]
    pub const fn wusr(&self) -> &WUSR {
        &self.wusr
    }
    ///0x48 - PWR wake-up configuration register
    #[inline(always)]
...
pub mod pmcr;
/**PMCR_ALTERNATE1 (rw) register accessor: PWR power mode control register

You can [`read`](crate::Reg::read) this register and get [`pmcr_alternate1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pmcr_alternate1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:PMCR_ALTERNATE1)

For information about available fields see [`mod@pmcr_alternate1`] module*/
pub type PMCR_ALTERNATE1 = crate::Reg<pmcr_alternate1::PMCR_ALTERNATE1rs>;
///PWR power mode control register
pub mod pmcr_alternate1;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:PMSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:VOSSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:DBPCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:BDSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:SCCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:VMSR)
...
pub mod vmsr;
/**WUSCR (w) register accessor: PWR wake-up status clear register
...
pub mod wuscr;
/**WUSR (r) register accessor: PWR wake-up status register
...
pub mod wusr;
/**WUCR (rw) register accessor: PWR wake-up configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:WUCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:IORETR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:PRIVCFGR)
