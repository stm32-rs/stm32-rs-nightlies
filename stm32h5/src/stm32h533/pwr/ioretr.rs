...
///Field `IORETEN` reader - IO retention enable
...
///Field `IORETEN` writer - IO retention enable
...
/**IO retention enable for JTAG IOs
...
///Field `JTAGIORETEN` reader - IO retention enable for JTAG IOs
...
///Field `JTAGIORETEN` writer - IO retention enable for JTAG IOs
