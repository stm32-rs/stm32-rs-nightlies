...
impl W {
    ///Bit 0 - low-power mode selection
    #[inline(always)]
    pub fn lpms(&mut self) -> LPMS_W<PMCR_ALTERNATE1rs> {
        LPMS_W::new(self, 0)
    }
    ///Bits 2:3 - system Stop mode voltage scaling selection
    #[inline(always)]
    pub fn svos(&mut self) -> SVOS_W<PMCR_ALTERNATE1rs> {
        SVOS_W::new(self, 2)
    }
    ///Bit 7 - clear Standby and Stop flags (always read as 0)
    #[inline(always)]
    pub fn cssf(&mut self) -> CSSF_W<PMCR_ALTERNATE1rs> {
        CSSF_W::new(self, 7)
    }
    ///Bit 9 - flash memory low-power mode in Stop mode
    #[inline(always)]
    pub fn flps(&mut self) -> FLPS_W<PMCR_ALTERNATE1rs> {
        FLPS_W::new(self, 9)
    }
    ///Bit 12 - analog switch Vless thansub>BOOSTless than/sub> control
    #[inline(always)]
    pub fn booste(&mut self) -> BOOSTE_W<PMCR_ALTERNATE1rs> {
        BOOSTE_W::new(self, 12)
    }
    ///Bit 13 - analog voltage ready
    #[inline(always)]
    pub fn avd_ready(&mut self) -> AVD_READY_W<PMCR_ALTERNATE1rs> {
        AVD_READY_W::new(self, 13)
    }
    ///Bit 23 - AHB SRAM3 shut-off in Stop mode.
    #[inline(always)]
    pub fn sram3so(&mut self) -> SRAM3SO_W<PMCR_ALTERNATE1rs> {
        SRAM3SO_W::new(self, 23)
    }
    ///Bit 24 - AHB SRAM2 low 16-Kbyte shut-off in Stop mode.
    #[inline(always)]
    pub fn sram2_16lso(&mut self) -> SRAM2_16LSO_W<PMCR_ALTERNATE1rs> {
        SRAM2_16LSO_W::new(self, 24)
    }
    ///Bit 25 - AHB SRAM2 high 16-Kbyte shut-off in Stop mode.
    #[inline(always)]
    pub fn sram2_16hso(&mut self) -> SRAM2_16HSO_W<PMCR_ALTERNATE1rs> {
        SRAM2_16HSO_W::new(self, 25)
    }
    ///Bit 26 - AHB SRAM2 48-Kbyte shut-off in Stop mode.
    #[inline(always)]
    pub fn sram2_48so(&mut self) -> SRAM2_48SO_W<PMCR_ALTERNATE1rs> {
        SRAM2_48SO_W::new(self, 26)
    }
    ///Bit 27 - AHB SRAM1 shut-off in Stop mode
    #[inline(always)]
    pub fn sram1so(&mut self) -> SRAM1SO_W<PMCR_ALTERNATE1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:PMCR_ALTERNATE1)*/
