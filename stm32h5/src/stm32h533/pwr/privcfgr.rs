...
///Field `SPRIV` reader - PWR secure functions privilege configuration
pub type SPRIV_R = crate::BitReader;
///Field `SPRIV` writer - PWR secure functions privilege configuration
pub type SPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
/**PWR non-secure functions privilege configuration
...
///Field `NSPRIV` reader - PWR non-secure functions privilege configuration
...
///Field `NSPRIV` writer - PWR non-secure functions privilege configuration
