...
///Field `PLS` reader - programmable voltage detector (PVD) level selection
...
///Field `PLS` writer - programmable voltage detector (PVD) level selection
...
///Field `AVDEN` reader - peripheral voltage monitor on Vless thansub>DDAless than/sub> enable
...
///Field `AVDEN` writer - peripheral voltage monitor on Vless thansub>DDAless than/sub> enable
...
///Field `ALS` reader - analog voltage detector (AVD) level selection
...
///Field `ALS` writer - analog voltage detector (AVD) level selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:VMCR)*/
pub struct VMCRrs;
