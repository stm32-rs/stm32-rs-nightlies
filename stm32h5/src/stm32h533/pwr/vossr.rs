...
/**Ready bit for Vless thansub>COREless than/sub> voltage scaling output selection.
...
///Field `VOSRDY` reader - Ready bit for Vless thansub>COREless than/sub> voltage scaling output selection.
...
/**voltage output scaling currently applied to Vless thansub>COREless than/sub>
...
///Field `ACTVOS` reader - voltage output scaling currently applied to Vless thansub>COREless than/sub>
