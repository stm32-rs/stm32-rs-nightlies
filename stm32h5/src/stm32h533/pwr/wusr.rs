...
///Field `WUF1` reader - wake-up pin WUFx flag
...
///Field `WUF2` reader - wake-up pin WUFx flag
pub use WUF1_R as WUF2_R;
///Field `WUF3` reader - wake-up pin WUFx flag
pub use WUF1_R as WUF3_R;
///Field `WUF4` reader - wake-up pin WUFx flag
pub use WUF1_R as WUF4_R;
///Field `WUF5` reader - wake-up pin WUFx flag
pub use WUF1_R as WUF5_R;
///Field `WUF6` reader - wake-up pin WUFx flag
pub use WUF1_R as WUF6_R;
///Field `WUF7` reader - wake-up pin WUFx flag
pub use WUF1_R as WUF7_R;
///Field `WUF8` reader - wake-up pin WUFx flag
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#PWR:WUSR)*/
pub struct WUSRrs;
