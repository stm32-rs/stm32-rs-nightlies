...
///Field `GPDMA1LPEN` reader - GPDMA1 clock enable during Sleep mode
...
///Field `GPDMA1LPEN` writer - GPDMA1 clock enable during Sleep mode
...
///Field `GPDMA2LPEN` reader - GPDMA2 clock enable during Sleep mode
pub use GPDMA1LPEN_R as GPDMA2LPEN_R;
///Field `FLITFLPEN` reader - Flash interface (FLITF) clock enable during Sleep mode
...
///Field `CORDICLPEN` reader - CORDIC clock enable during Sleep mode
pub use GPDMA1LPEN_R as CORDICLPEN_R;
///Field `FMACLPEN` reader - FMAC clock enable during Sleep mode
pub use GPDMA1LPEN_R as FMACLPEN_R;
///Field `RAMCFGLPEN` reader - RAMCFG clock enable during Sleep mode
pub use GPDMA1LPEN_R as RAMCFGLPEN_R;
///Field `ETHLPEN` reader - ETH clock enable during Sleep mode
pub use GPDMA1LPEN_R as ETHLPEN_R;
///Field `ETHTXLPEN` reader - ETHTX clock enable during Sleep mode
pub use GPDMA1LPEN_R as ETHTXLPEN_R;
///Field `ETHRXLPEN` reader - ETHRX clock enable during Sleep mode
pub use GPDMA1LPEN_R as ETHRXLPEN_R;
///Field `TZSC1LPEN` reader - TZSC1 clock enable during Sleep mode
pub use GPDMA1LPEN_R as TZSC1LPEN_R;
///Field `BKPRAMLPEN` reader - BKPRAM clock enable during Sleep mode
pub use GPDMA1LPEN_R as BKPRAMLPEN_R;
///Field `ICACHELPEN` reader - ICACHE clock enable during Sleep mode
pub use GPDMA1LPEN_R as ICACHELPEN_R;
///Field `DCACHELPEN` reader - DCACHE clock enable during Sleep mode
pub use GPDMA1LPEN_R as DCACHELPEN_R;
///Field `SRAM1LPEN` reader - SRAM1 clock enable during Sleep mode
pub use GPDMA1LPEN_R as SRAM1LPEN_R;
///Field `GPDMA2LPEN` writer - GPDMA2 clock enable during Sleep mode
pub use GPDMA1LPEN_W as GPDMA2LPEN_W;
///Field `FLITFLPEN` writer - Flash interface (FLITF) clock enable during Sleep mode
...
///Field `CORDICLPEN` writer - CORDIC clock enable during Sleep mode
pub use GPDMA1LPEN_W as CORDICLPEN_W;
///Field `FMACLPEN` writer - FMAC clock enable during Sleep mode
pub use GPDMA1LPEN_W as FMACLPEN_W;
///Field `RAMCFGLPEN` writer - RAMCFG clock enable during Sleep mode
pub use GPDMA1LPEN_W as RAMCFGLPEN_W;
///Field `ETHLPEN` writer - ETH clock enable during Sleep mode
pub use GPDMA1LPEN_W as ETHLPEN_W;
///Field `ETHTXLPEN` writer - ETHTX clock enable during Sleep mode
pub use GPDMA1LPEN_W as ETHTXLPEN_W;
///Field `ETHRXLPEN` writer - ETHRX clock enable during Sleep mode
pub use GPDMA1LPEN_W as ETHRXLPEN_W;
///Field `TZSC1LPEN` writer - TZSC1 clock enable during Sleep mode
pub use GPDMA1LPEN_W as TZSC1LPEN_W;
///Field `BKPRAMLPEN` writer - BKPRAM clock enable during Sleep mode
pub use GPDMA1LPEN_W as BKPRAMLPEN_W;
///Field `ICACHELPEN` writer - ICACHE clock enable during Sleep mode
pub use GPDMA1LPEN_W as ICACHELPEN_W;
///Field `DCACHELPEN` writer - DCACHE clock enable during Sleep mode
pub use GPDMA1LPEN_W as DCACHELPEN_W;
///Field `SRAM1LPEN` writer - SRAM1 clock enable during Sleep mode
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RCC:AHB1LPENR)*/
...
impl crate::Resettable for AHB1LPENRrs {
    const RESET_VALUE: u32 = 0xf102_1103;
}
