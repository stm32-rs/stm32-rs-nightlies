...
///Field `GPIOAEN` reader - GPIOA clock enable
...
///Field `GPIOAEN` writer - GPIOA clock enable
...
///Field `GPIOBEN` reader - GPIOB clock enable
pub use GPIOAEN_R as GPIOBEN_R;
///Field `GPIOCEN` reader - GPIOC clock enable
pub use GPIOAEN_R as GPIOCEN_R;
///Field `GPIODEN` reader - GPIOD clock enable
pub use GPIOAEN_R as GPIODEN_R;
///Field `GPIOEEN` reader - GPIOE clock enable
pub use GPIOAEN_R as GPIOEEN_R;
///Field `GPIOFEN` reader - GPIOF clock enable
pub use GPIOAEN_R as GPIOFEN_R;
///Field `GPIOGEN` reader - GPIOG clock enable
pub use GPIOAEN_R as GPIOGEN_R;
///Field `GPIOHEN` reader - GPIOH clock enable
pub use GPIOAEN_R as GPIOHEN_R;
///Field `GPIOIEN` reader - GPIOI clock enable
...
///Field `DCMI_PSSIEN` reader - digital camera interface clock enable (DCMI or PSSI depending which interface is active)
...
///Field `SAESEN` reader - SAES clock enable
pub use GPIOAEN_R as SAESEN_R;
///Field `SRAM2EN` reader - SRAM2 clock enable
pub use GPIOAEN_R as SRAM2EN_R;
///Field `SRAM3EN` reader - SRAM3 clock enable
pub use GPIOAEN_R as SRAM3EN_R;
///Field `GPIOBEN` writer - GPIOB clock enable
pub use GPIOAEN_W as GPIOBEN_W;
///Field `GPIOCEN` writer - GPIOC clock enable
pub use GPIOAEN_W as GPIOCEN_W;
///Field `GPIODEN` writer - GPIOD clock enable
pub use GPIOAEN_W as GPIODEN_W;
///Field `GPIOEEN` writer - GPIOE clock enable
pub use GPIOAEN_W as GPIOEEN_W;
///Field `GPIOFEN` writer - GPIOF clock enable
pub use GPIOAEN_W as GPIOFEN_W;
///Field `GPIOGEN` writer - GPIOG clock enable
pub use GPIOAEN_W as GPIOGEN_W;
///Field `GPIOHEN` writer - GPIOH clock enable
pub use GPIOAEN_W as GPIOHEN_W;
///Field `GPIOIEN` writer - GPIOI clock enable
...
///Field `DCMI_PSSIEN` writer - digital camera interface clock enable (DCMI or PSSI depending which interface is active)
...
impl W {
    ...
    ///Bit 20 - SAES clock enable
    #[inline(always)]
    pub fn saesen(&mut self) -> SAESEN_W<AHB2ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RCC:AHB2ENR)*/
