...
///Field `GPIOIRST` reader - GPIOI block reset
...
///Field `DCMI_PSSIRST` reader - digital camera interface block reset (DCMI or PSSI depending which interface is active)
pub use GPIOARST_R as DCMI_PSSIRST_R;
///Field `AESRST` reader - AES block reset
pub use GPIOARST_R as AESRST_R;
///Field `HASHRST` reader - HASH block reset
pub use GPIOARST_R as HASHRST_R;
///Field `RNGRST` reader - RNG block reset
...
///Field `GPIOIRST` writer - GPIOI block reset
...
///Field `DCMI_PSSIRST` writer - digital camera interface block reset (DCMI or PSSI depending which interface is active)
pub use GPIOARST_W as DCMI_PSSIRST_W;
///Field `AESRST` writer - AES block reset
pub use GPIOARST_W as AESRST_W;
///Field `HASHRST` writer - HASH block reset
pub use GPIOARST_W as HASHRST_W;
///Field `RNGRST` writer - RNG block reset
