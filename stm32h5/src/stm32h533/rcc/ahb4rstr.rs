...
///Field `OTFDEC1RST` reader - OTFDEC1 block reset
...
///Field `OTFDEC1RST` writer - OTFDEC1 block reset
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RCC:AHB4RSTR)*/
