...
///Field `TIM15EN` reader - TIM15 clock enable
...
///Field `TIM15EN` writer - TIM15 clock enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RCC:APB2ENR)*/
