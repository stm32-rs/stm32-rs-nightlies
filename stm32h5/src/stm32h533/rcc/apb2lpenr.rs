...
///Field `SPI1LPEN` reader - SPI1 clock enable during Sleep mode
...
///Field `TIM15LPEN` reader - TIM15 clock enable during Sleep mode
...
///Field `SPI1LPEN` writer - SPI1 clock enable during Sleep mode
...
///Field `TIM15LPEN` writer - TIM15 clock enable during Sleep mode
...
impl crate::Resettable for APB2LPENRrs {
    const RESET_VALUE: u32 = 0x0109_7800;
}
