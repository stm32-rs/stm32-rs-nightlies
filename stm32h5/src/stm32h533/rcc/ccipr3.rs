...
///Field `SPI1SEL` reader - SPI1 kernel clock source selection
...
///Field `SPI1SEL` writer - SPI1 kernel clock source selection
...
///Field `SPI2SEL` reader - SPI2 kernel clock source selection
pub use SPI1SEL_R as SPI2SEL_R;
///Field `SPI3SEL` reader - SPI3 kernel clock source selection
pub use SPI1SEL_R as SPI3SEL_R;
///Field `SPI2SEL` writer - SPI2 kernel clock source selection
pub use SPI1SEL_W as SPI2SEL_W;
///Field `SPI3SEL` writer - SPI3 kernel clock source selection
...
///Field `SPI4SEL` reader - SPI4 kernel clock source selection
...
///Field `SPI4SEL` writer - SPI4 kernel clock source selection
