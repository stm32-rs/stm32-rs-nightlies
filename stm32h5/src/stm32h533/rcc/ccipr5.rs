...
/**ADC and DAC kernel clock source selection
...
///Field `ADCDACSEL` reader - ADC and DAC kernel clock source selection
...
///Field `ADCDACSEL` writer - ADC and DAC kernel clock source selection
...
///Field `DACSEL` reader - DAC sample and hold clock
...
///Field `DACSEL` writer - DAC sample and hold clock
...
///Field `FDCANSEL` reader - FDCAN1 and FDCAN2 kernel clock source selection
...
///Field `FDCANSEL` writer - FDCAN1 and FDCAN2 kernel clock source selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RCC:CCIPR5)*/
pub struct CCIPR5rs;
