...
///Field `PLL2N` reader - Multiplication factor for PLL2VCO
pub type PLL2N_R = crate::FieldReader<u16>;
///Field `PLL2N` writer - Multiplication factor for PLL2VCO
pub type PLL2N_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `PLL2P` reader - PLL2 DIVP division factor
pub type PLL2P_R = crate::FieldReader;
///Field `PLL2P` writer - PLL2 DIVP division factor
pub type PLL2P_W<'a, REG> = crate::FieldWriter<'a, REG, 7, u8, crate::Safe>;
///Field `PLL2Q` reader - PLL2 DIVQ division factor
pub type PLL2Q_R = crate::FieldReader;
///Field `PLL2Q` writer - PLL2 DIVQ division factor
pub type PLL2Q_W<'a, REG> = crate::FieldWriter<'a, REG, 7, u8, crate::Safe>;
///Field `PLL2R` reader - PLL2 DIVR division factor
pub type PLL2R_R = crate::FieldReader;
///Field `PLL2R` writer - PLL2 DIVR division factor
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RCC:PLL2DIVR)*/
