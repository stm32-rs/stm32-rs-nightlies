...
///Field `PLL3N` reader - Multiplication factor for PLL3VCO
pub type PLL3N_R = crate::FieldReader<u16>;
///Field `PLL3N` writer - Multiplication factor for PLL3VCO
pub type PLL3N_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `PLL3P` reader - PLL3 DIVP division factor
pub type PLL3P_R = crate::FieldReader;
///Field `PLL3P` writer - PLL3 DIVP division factor
pub type PLL3P_W<'a, REG> = crate::FieldWriter<'a, REG, 7, u8, crate::Safe>;
///Field `PLL3Q` reader - PLL3 DIVQ division factor
pub type PLL3Q_R = crate::FieldReader;
///Field `PLL3Q` writer - PLL3 DIVQ division factor
pub type PLL3Q_W<'a, REG> = crate::FieldWriter<'a, REG, 7, u8, crate::Safe>;
///Field `PLL3R` reader - PLL3 DIVR division factor
pub type PLL3R_R = crate::FieldReader;
///Field `PLL3R` writer - PLL3 DIVR division factor
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RCC:PLL3DIVR)*/
