...
/**HSI clock configuration and status bits security
...
///Field `HSISEC` reader - HSI clock configuration and status bits security
...
///Field `HSISEC` writer - HSI clock configuration and status bits security
...
///Field `HSESEC` reader - HSE clock configuration bits, status bits and HSE_CSS security
pub use HSISEC_R as HSESEC_R;
///Field `CSISEC` reader - CSI clock configuration and status bits security
pub use HSISEC_R as CSISEC_R;
///Field `LSISEC` reader - LSI clock configuration and status bits security
pub use HSISEC_R as LSISEC_R;
///Field `LSESEC` reader - LSE clock configuration and status bits security
pub use HSISEC_R as LSESEC_R;
///Field `SYSCLKSEC` reader - SYSCLK clock selection, STOPWUCK bit, clock output on MCO configuration security
pub use HSISEC_R as SYSCLKSEC_R;
///Field `PRESCSEC` reader - AHBx/APBx prescaler configuration bits security
pub use HSISEC_R as PRESCSEC_R;
///Field `PLL1SEC` reader - PLL1 clock configuration and status bits security
pub use HSISEC_R as PLL1SEC_R;
///Field `PLL2SEC` reader - PLL2 clock configuration and status bits security
pub use HSISEC_R as PLL2SEC_R;
///Field `PLL3SEC` reader - PLL3 clock configuration and status bits security
pub use HSISEC_R as PLL3SEC_R;
///Field `HSI48SEC` reader - HSI48 clock configuration and status bits security
pub use HSISEC_R as HSI48SEC_R;
///Field `RMVFSEC` reader - Remove reset flag security
pub use HSISEC_R as RMVFSEC_R;
///Field `CKPERSELSEC` reader - per_ck selection security
pub use HSISEC_R as CKPERSELSEC_R;
///Field `HSESEC` writer - HSE clock configuration bits, status bits and HSE_CSS security
pub use HSISEC_W as HSESEC_W;
///Field `CSISEC` writer - CSI clock configuration and status bits security
pub use HSISEC_W as CSISEC_W;
///Field `LSISEC` writer - LSI clock configuration and status bits security
pub use HSISEC_W as LSISEC_W;
///Field `LSESEC` writer - LSE clock configuration and status bits security
pub use HSISEC_W as LSESEC_W;
///Field `SYSCLKSEC` writer - SYSCLK clock selection, STOPWUCK bit, clock output on MCO configuration security
pub use HSISEC_W as SYSCLKSEC_W;
///Field `PRESCSEC` writer - AHBx/APBx prescaler configuration bits security
pub use HSISEC_W as PRESCSEC_W;
///Field `PLL1SEC` writer - PLL1 clock configuration and status bits security
pub use HSISEC_W as PLL1SEC_W;
///Field `PLL2SEC` writer - PLL2 clock configuration and status bits security
pub use HSISEC_W as PLL2SEC_W;
///Field `PLL3SEC` writer - PLL3 clock configuration and status bits security
pub use HSISEC_W as PLL3SEC_W;
///Field `HSI48SEC` writer - HSI48 clock configuration and status bits security
pub use HSISEC_W as HSI48SEC_W;
///Field `RMVFSEC` writer - Remove reset flag security
pub use HSISEC_W as RMVFSEC_W;
///Field `CKPERSELSEC` writer - per_ck selection security
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RCC:SECCFGR)*/
