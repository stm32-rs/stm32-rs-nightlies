...
///Field `WUTMF` reader - Wake-up timer nonsecure masked flag
...
///Field `TSMF` reader - Timestamp nonsecure masked flag
...
///Field `TSOVMF` reader - Timestamp overflow nonsecure masked flag
...
///Field `ITSMF` reader - Internal timestamp nonsecure masked flag
...
///Field `SSRUMF` reader - SSR underflow nonsecure masked flag
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RTC:MISR)*/
pub struct MISRrs;
