...
///Field `WUTSEC` reader - Wake-up timer protection
pub type WUTSEC_R = crate::BitReader;
///Field `WUTSEC` writer - Wake-up timer protection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#RTC:SECCFGR)*/
