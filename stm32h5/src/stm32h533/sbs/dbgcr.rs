...
///Field `AP_UNLOCK` reader - access port unlock
pub type AP_UNLOCK_R = crate::FieldReader;
///Field `AP_UNLOCK` writer - access port unlock
pub type AP_UNLOCK_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DBG_UNLOCK` reader - debug unlock when DBG_AUTH_HDPL is reached
pub type DBG_UNLOCK_R = crate::FieldReader;
///Field `DBG_UNLOCK` writer - debug unlock when DBG_AUTH_HDPL is reached
pub type DBG_UNLOCK_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DBG_AUTH_HDPL` reader - authenticated debug temporal isolation level
pub type DBG_AUTH_HDPL_R = crate::FieldReader;
///Field `DBG_AUTH_HDPL` writer - authenticated debug temporal isolation level
pub type DBG_AUTH_HDPL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DBG_AUTH_SEC` reader - control debug opening secure/non-secure
pub type DBG_AUTH_SEC_R = crate::FieldReader;
///Field `DBG_AUTH_SEC` writer - control debug opening secure/non-secure
