...
///Field `DPSMACT` reader - Data path state machine active, i.
pub type DPSMACT_R = crate::BitReader;
///Field `CPSMACT` reader - Command path state machine active, i.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#SDMMC1:STAR)*/
pub struct STARrs;
