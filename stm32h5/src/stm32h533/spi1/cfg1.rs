...
///Field `DSIZE` reader - number of bits in a single SPI data frame
pub type DSIZE_R = crate::FieldReader;
///Field `DSIZE` writer - number of bits in a single SPI data frame
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#SPI1:CFG1)*/
pub struct CFG1rs;
