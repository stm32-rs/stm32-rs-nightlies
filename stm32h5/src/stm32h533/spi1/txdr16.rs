...
impl W {
    ...
    #[inline(always)]
    pub fn txdr(&mut self) -> TXDR_W<'_, TXDR16rs> {
        TXDR_W::new(self, 0)
    }
}
/**Direct 16-bit access to transmit data register

You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`txdr16::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#SPI1:TXDR16)*/
pub struct TXDR16rs;
