...
///Field `TAMP8E` reader - Tamper detection on TAMP_IN8 enableless thansup>(1)less than/sup>
pub type TAMP8E_R = crate::BitReader;
///Field `TAMP8E` writer - Tamper detection on TAMP_IN8 enableless thansup>(1)less than/sup>
