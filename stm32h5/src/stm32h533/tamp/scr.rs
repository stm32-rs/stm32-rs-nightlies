...
///Field `CTAMP8F` writer - Clear TAMP8 detection flag
...
///Field `CITAMP12F` writer - Clear ITAMP12 detection flag
pub type CITAMP12F_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CITAMP13F` writer - Clear ITAMP13 detection flag
pub type CITAMP13F_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CITAMP15F` writer - Clear ITAMP15 detection flag
...
impl W {
    ...
    #[inline(always)]
    pub fn citamp12f(&mut self) -> CITAMP12F_W<'_, SCRrs> {
        CITAMP12F_W::new(self, 27)
    }
    ///Bit 28 - Clear ITAMP13 detection flag
    #[inline(always)]
    pub fn citamp13f(&mut self) -> CITAMP13F_W<'_, SCRrs> {
        CITAMP13F_W::new(self, 28)
    }
    ///Bit 30 - Clear ITAMP15 detection flag
    #[inline(always)]
    pub fn citamp15f(&mut self) -> CITAMP15F_W<'_, SCRrs> {
