...
///Field `CNT` reader - or UIFCPY: Value depends on IUFREMAP in TIMx_CR1.
pub type CNT_R = crate::FieldReader<u16>;
///Field `CNT` writer - or UIFCPY: Value depends on IUFREMAP in TIMx_CR1.
...
impl R {
    ///Bits 0:15 - or UIFCPY: Value depends on IUFREMAP in TIMx_CR1.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#TIM12:CNT)*/
pub struct CNTrs;
