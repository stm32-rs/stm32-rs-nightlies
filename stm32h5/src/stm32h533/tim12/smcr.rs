...
///Field `TS` reader - Trigger selection (see bits 21:20 for TS\[4:3\])
pub type TS_R = crate::FieldReader;
///Field `TS` writer - Trigger selection (see bits 21:20 for TS\[4:3\])
...
///Field `SMS_2` reader - Slave mode selection
pub type SMS_2_R = crate::BitReader;
///Field `SMS_2` writer - Slave mode selection
pub type SMS_2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TS_2` reader - Trigger selection (see bits 21:20 for TS\[4:3\])
pub type TS_2_R = crate::FieldReader;
///Field `TS_2` writer - Trigger selection (see bits 21:20 for TS\[4:3\])
...
impl R {
    ...
    ///Bits 4:6 - Trigger selection (see bits 21:20 for TS\[4:3\])
    #[inline(always)]
    pub fn ts(&self) -> TS_R {
    ...
    ///Bits 20:21 - Trigger selection (see bits 21:20 for TS\[4:3\])
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#TIM12:SMCR)*/
pub struct SMCRrs;
