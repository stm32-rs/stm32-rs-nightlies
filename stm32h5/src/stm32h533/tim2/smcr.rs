...
///Field `SMS_L` reader - SMS\[2:0\]: Slave mode selection
pub type SMS_L_R = crate::FieldReader;
///Field `SMS_L` writer - SMS\[2:0\]: Slave mode selection
...
///Field `TS_L` reader - TS\[2:0\]: Trigger selection
pub type TS_L_R = crate::FieldReader;
///Field `TS_L` writer - TS\[2:0\]: Trigger selection
