...
///Field `UIFCPY` reader - Value depends on IUFREMAP in TIMx_CR1.
...
///Field `UIFCPY` writer - Value depends on IUFREMAP in TIMx_CR1.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#TIM3:CNT)*/
pub struct CNTrs;
