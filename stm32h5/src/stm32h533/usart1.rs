...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn cr1_alternate1(&self) -> &CR1_ALTERNATE1 {
...
/**CR1 (rw) register accessor: USART control register 1

You can [`read`](crate::Reg::read) this register and get [`cr1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cr1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:CR1)
...
pub mod cr1;
/**CR1_ALTERNATE1 (rw) register accessor: USART control register 1

You can [`read`](crate::Reg::read) this register and get [`cr1_alternate1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cr1_alternate1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:CR1_ALTERNATE1)

For information about available fields see [`mod@cr1_alternate1`]
module*/
pub type CR1_ALTERNATE1 = crate::Reg<cr1_alternate1::CR1_ALTERNATE1rs>;
///USART control register 1
pub mod cr1_alternate1;
/**CR2 (rw) register accessor: USART control register 2

You can [`read`](crate::Reg::read) this register and get [`cr2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cr2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:CR3)
...
pub mod cr3;
/**CR3_ALTERNATE1 (rw) register accessor: USART control register 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:CR3_ALTERNATE1)

For information about available fields see [`mod@cr3_alternate1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:BRR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:GTPR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:RTOR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:RQR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:ISR)
...
pub mod isr;
/**ISR_ALTERNATE1 (r) register accessor: USART interrupt and status register

You can [`read`](crate::Reg::read) this register and get [`isr_alternate1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:ISR_ALTERNATE1)

For information about available fields see [`mod@isr_alternate1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:RDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:TDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USART1:PRESC)
