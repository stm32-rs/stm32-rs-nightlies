///Register `RXTXBD_6` reader
pub type R = crate::R<RXTXBD_6rs>;
///Register `RXTXBD_6` writer
pub type W = crate::W<RXTXBD_6rs>;
...
impl W {
    ///Bits 0:15 - Reception buffer address
    #[inline(always)]
    pub fn addr_rx(&mut self) -> ADDR_RX_W<'_, RXTXBD_6rs> {
        ADDR_RX_W::new(self, 0)
    }
    ///Bits 26:30 - Number of blocks
    #[inline(always)]
    pub fn num_block(&mut self) -> NUM_BLOCK_W<'_, RXTXBD_6rs> {
        NUM_BLOCK_W::new(self, 26)
    }
    ///Bit 31 - Block size
    #[inline(always)]
    pub fn blsize(&mut self) -> BLSIZE_W<'_, RXTXBD_6rs> {
        BLSIZE_W::new(self, 31)
    }
}
/**Channel/endpoint receive buffer descriptor 6

You can [`read`](crate::Reg::read) this register and get [`rxtxbd_6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rxtxbd_6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USBSRAM:RXTXBD_6)*/
pub struct RXTXBD_6rs;
impl crate::RegisterSpec for RXTXBD_6rs {
    type Ux = u32;
}
///`read()` method returns [`rxtxbd_6::R`](R) reader structure
impl crate::Readable for RXTXBD_6rs {}
///`write(|w| ..)` method takes [`rxtxbd_6::W`](W) writer structure
impl crate::Writable for RXTXBD_6rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RXTXBD_6 to value 0
impl crate::Resettable for RXTXBD_6rs {}
