///Register `TXRXBD_0_ALTERNATE1` reader
pub type R = crate::R<TXRXBD_0_ALTERNATE1rs>;
///Register `TXRXBD_0_ALTERNATE1` writer
pub type W = crate::W<TXRXBD_0_ALTERNATE1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TXRXBD_0_ALTERNATE1")
...
impl W {
    ///Bits 0:15 - Reception buffer address
    #[inline(always)]
    pub fn addr_rx(&mut self) -> ADDR_RX_W<'_, TXRXBD_0_ALTERNATE1rs> {
        ADDR_RX_W::new(self, 0)
    }
    ///Bits 26:30 - Number of blocks
    #[inline(always)]
    pub fn num_block(&mut self) -> NUM_BLOCK_W<'_, TXRXBD_0_ALTERNATE1rs> {
        NUM_BLOCK_W::new(self, 26)
    }
    ///Bit 31 - Block size
    #[inline(always)]
    pub fn blsize(&mut self) -> BLSIZE_W<'_, TXRXBD_0_ALTERNATE1rs> {
        BLSIZE_W::new(self, 31)
    }
}
/**Channel/endpoint receive buffer descriptor 0

You can [`read`](crate::Reg::read) this register and get [`txrxbd_0_alternate1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`txrxbd_0_alternate1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USBSRAM:TXRXBD_0_ALTERNATE1)*/
pub struct TXRXBD_0_ALTERNATE1rs;
impl crate::RegisterSpec for TXRXBD_0_ALTERNATE1rs {
    type Ux = u32;
}
///`read()` method returns [`txrxbd_0_alternate1::R`](R) reader structure
impl crate::Readable for TXRXBD_0_ALTERNATE1rs {}
///`write(|w| ..)` method takes [`txrxbd_0_alternate1::W`](W) writer structure
impl crate::Writable for TXRXBD_0_ALTERNATE1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TXRXBD_0_ALTERNATE1 to value 0
impl crate::Resettable for TXRXBD_0_ALTERNATE1rs {}
