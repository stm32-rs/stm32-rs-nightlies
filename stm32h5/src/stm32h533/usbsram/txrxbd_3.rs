///Register `TXRXBD_3` reader
pub type R = crate::R<TXRXBD_3rs>;
///Register `TXRXBD_3` writer
pub type W = crate::W<TXRXBD_3rs>;
...
impl W {
    ///Bits 0:15 - Transmission buffer address
    #[inline(always)]
    pub fn addr_tx(&mut self) -> ADDR_TX_W<'_, TXRXBD_3rs> {
        ADDR_TX_W::new(self, 0)
    }
    ///Bits 16:25 - Transmission byte count
    #[inline(always)]
    pub fn count_tx(&mut self) -> COUNT_TX_W<'_, TXRXBD_3rs> {
        COUNT_TX_W::new(self, 16)
    }
}
/**Channel/endpoint transmit buffer descriptor 3

You can [`read`](crate::Reg::read) this register and get [`txrxbd_3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`txrxbd_3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#USBSRAM:TXRXBD_3)*/
pub struct TXRXBD_3rs;
impl crate::RegisterSpec for TXRXBD_3rs {
    type Ux = u32;
}
///`read()` method returns [`txrxbd_3::R`](R) reader structure
impl crate::Readable for TXRXBD_3rs {}
///`write(|w| ..)` method takes [`txrxbd_3::W`](W) writer structure
impl crate::Writable for TXRXBD_3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TXRXBD_3 to value 0
impl crate::Resettable for TXRXBD_3rs {}
