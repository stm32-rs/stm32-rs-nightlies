...
///Field `EWIF` reader - Early wake-up interrupt flag
...
///Field `EWIF` writer - Early wake-up interrupt flag
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H533.html#WWDG:SR)*/
pub struct SRrs;
