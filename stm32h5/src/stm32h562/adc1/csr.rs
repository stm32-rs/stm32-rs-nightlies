...
///Field `JQOVF_MST` reader - Injected Context Queue Overflow flag of the master ADC This bit is a copy of the JQOVF bit in the corresponding ADC_ISR register.
pub type JQOVF_MST_R = crate::BitReader;
///Field `ADRDY_SLV` reader - Slave ADC ready This bit is a copy of the ADRDY bit in the corresponding ADC_ISR register.
pub type ADRDY_SLV_R = crate::BitReader;
///Field `EOSMP_SLV` reader - End of Sampling phase flag of the slave ADC This bit is a copy of the EOSMP2 bit in the corresponding ADC_ISR register.
pub type EOSMP_SLV_R = crate::BitReader;
///Field `EOC_SLV` reader - End of regular conversion of the slave ADC This bit is a copy of the EOC bit in the corresponding ADC_ISR register.
pub type EOC_SLV_R = crate::BitReader;
///Field `EOS_SLV` reader - End of regular sequence flag of the slave ADC. This bit is a copy of the EOS bit in the corresponding ADC_ISR register.
pub type EOS_SLV_R = crate::BitReader;
///Field `OVR_SLV` reader - Overrun flag of the slave ADC This bit is a copy of the OVR bit in the corresponding ADC_ISR register.
pub type OVR_SLV_R = crate::BitReader;
///Field `JEOC_SLV` reader - End of injected conversion flag of the slave ADC This bit is a copy of the JEOC bit in the corresponding ADC_ISR register.
pub type JEOC_SLV_R = crate::BitReader;
///Field `JEOS_SLV` reader - End of injected sequence flag of the slave ADC This bit is a copy of the JEOS bit in the corresponding ADC_ISR register.
pub type JEOS_SLV_R = crate::BitReader;
///Field `AWD1_SLV` reader - Analog watchdog 1 flag of the slave ADC This bit is a copy of the AWD1 bit in the corresponding ADC_ISR register.
pub type AWD1_SLV_R = crate::BitReader;
///Field `AWD2_SLV` reader - Analog watchdog 2 flag of the slave ADC This bit is a copy of the AWD2 bit in the corresponding ADC_ISR register.
pub type AWD2_SLV_R = crate::BitReader;
///Field `AWD3_SLV` reader - Analog watchdog 3 flag of the slave ADC This bit is a copy of the AWD3 bit in the corresponding ADC_ISR register.
pub type AWD3_SLV_R = crate::BitReader;
///Field `JQOVF_SLV` reader - Injected Context Queue Overflow flag of the slave ADC This bit is a copy of the JQOVF bit in the corresponding ADC_ISR register.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#ADC1:CSR)*/
pub struct CSRrs;
