...
impl W {
    ...
    ///Bit 8 - GPDMA1 channel 8 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma1_8_stop(&mut self) -> DBG_GPDMA1_8_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA1_8_STOP_W::new(self, 8)
    }
    ///Bit 9 - GPDMA1 channel 9 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma1_9_stop(&mut self) -> DBG_GPDMA1_9_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA1_9_STOP_W::new(self, 9)
    }
    ///Bit 10 - GPDMA1 channel 10 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma1_10_stop(&mut self) -> DBG_GPDMA1_10_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA1_10_STOP_W::new(self, 10)
    }
    ///Bit 11 - GPDMA1 channel 11 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma1_11_stop(&mut self) -> DBG_GPDMA1_11_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA1_11_STOP_W::new(self, 11)
    }
    ///Bit 12 - GPDMA1 channel 12 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma1_12_stop(&mut self) -> DBG_GPDMA1_12_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA1_12_STOP_W::new(self, 12)
    }
    ///Bit 13 - GPDMA1 channel 13 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma1_13_stop(&mut self) -> DBG_GPDMA1_13_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA1_13_STOP_W::new(self, 13)
    }
    ///Bit 14 - GPDMA1 channel 14 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma1_14_stop(&mut self) -> DBG_GPDMA1_14_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA1_14_STOP_W::new(self, 14)
    }
    ///Bit 15 - GPDMA1 channel 15 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma1_15_stop(&mut self) -> DBG_GPDMA1_15_STOP_W<'_, AHB1FZRrs> {
    ...
    ///Bit 24 - GPDMA2 channel 8 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma2_8_stop(&mut self) -> DBG_GPDMA2_8_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA2_8_STOP_W::new(self, 24)
    }
    ///Bit 25 - GPDMA2 channel 9 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma2_9_stop(&mut self) -> DBG_GPDMA2_9_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA2_9_STOP_W::new(self, 25)
    }
    ///Bit 26 - GPDMA2 channel 10 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma2_10_stop(&mut self) -> DBG_GPDMA2_10_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA2_10_STOP_W::new(self, 26)
    }
    ///Bit 27 - GPDMA2 channel 11 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma2_11_stop(&mut self) -> DBG_GPDMA2_11_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA2_11_STOP_W::new(self, 27)
    }
    ///Bit 28 - GPDMA2 channel 12 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma2_12_stop(&mut self) -> DBG_GPDMA2_12_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA2_12_STOP_W::new(self, 28)
    }
    ///Bit 29 - GPDMA2 channel 13 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma2_13_stop(&mut self) -> DBG_GPDMA2_13_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA2_13_STOP_W::new(self, 29)
    }
    ///Bit 30 - GPDMA2 channel 14 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma2_14_stop(&mut self) -> DBG_GPDMA2_14_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA2_14_STOP_W::new(self, 30)
    }
    ///Bit 31 - GPDMA2 channel 15 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma2_15_stop(&mut self) -> DBG_GPDMA2_15_STOP_W<'_, AHB1FZRrs> {
