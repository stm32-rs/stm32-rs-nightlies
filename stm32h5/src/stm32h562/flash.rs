...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:OPTKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:OPTCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:NSSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:NSCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:NSCCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECCCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:PRIVCFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:NSOBKCFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECOBKCFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:HDPEXTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:OPTSR_PRG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:NSEPOCHR_CUR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:OPTSR2_CUR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:OPTSR2_PRG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:NSBOOTR_CUR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:NSBOOTR_PRG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:BOOTR_PRG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:OTPBLR_CUR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:OTPBLR_PRG)

For information about available fields see [`mod@otpblr_prg`] module*/
pub type OTPBLR_PRG = crate::Reg<otpblr_prg::OTPBLR_PRGrs>;
///FLASH non-secure OTP block lock
pub mod otpblr_prg;
/**SECBB1R1 (rw) register accessor: FLASH secure block based register for Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECBB1R1)
...
pub mod secbb1r1;
/**SECBB1R2 (rw) register accessor: FLASH secure block based register for Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECBB1R2)

For information about available fields see [`mod@secbb1r2`] module*/
pub type SECBB1R2 = crate::Reg<secbb1r2::SECBB1R2rs>;
///FLASH secure block based register for Bank 1
pub mod secbb1r2;
/**SECBB1R3 (rw) register accessor: FLASH secure block based register for Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECBB1R3)

For information about available fields see [`mod@secbb1r3`] module*/
pub type SECBB1R3 = crate::Reg<secbb1r3::SECBB1R3rs>;
///FLASH secure block based register for Bank 1
pub mod secbb1r3;
/**SECBB1R4 (rw) register accessor: FLASH secure block based register for Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECBB1R4)

For information about available fields see [`mod@secbb1r4`] module*/
pub type SECBB1R4 = crate::Reg<secbb1r4::SECBB1R4rs>;
///FLASH secure block based register for Bank 1
pub mod secbb1r4;
/**PRIVBB1R1 (rw) register accessor: FLASH privilege block based register for Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:PRIVBB1R1)
...
pub mod privbb1r1;
/**PRIVBB1R2 (rw) register accessor: FLASH privilege block based register for Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:PRIVBB1R2)

For information about available fields see [`mod@privbb1r2`] module*/
pub type PRIVBB1R2 = crate::Reg<privbb1r2::PRIVBB1R2rs>;
///FLASH privilege block based register for Bank 1
pub mod privbb1r2;
/**PRIVBB1R3 (rw) register accessor: FLASH privilege block based register for Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:PRIVBB1R3)

For information about available fields see [`mod@privbb1r3`] module*/
pub type PRIVBB1R3 = crate::Reg<privbb1r3::PRIVBB1R3rs>;
///FLASH privilege block based register for Bank 1
pub mod privbb1r3;
/**PRIVBB1R4 (rw) register accessor: FLASH privilege block based register for Bank 1
...
///FLASH privilege block based register for Bank 1
pub mod privbb1r4;
/**SECWM1R_CUR (r) register accessor: FLASH security watermark for Bank 1

You can [`read`](crate::Reg::read) this register and get [`secwm1r_cur::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECWM1R_CUR)
...
pub mod secwm1r_cur;
/**SECWM1R_PRG (rw) register accessor: FLASH security watermark for Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECWM1R_PRG)
...
///FLASH security watermark for Bank 1
pub mod secwm1r_prg;
/**WRP1R_CUR (r) register accessor: FLASH write sector group protection for Bank 1

You can [`read`](crate::Reg::read) this register and get [`wrp1r_cur::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:WRP1R_CUR)
...
pub mod wrp1r_cur;
/**WRP1R_PRG (rw) register accessor: FLASH write sector group protection for Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:WRP1R_PRG)

For information about available fields see [`mod@wrp1r_prg`] module*/
pub type WRP1R_PRG = crate::Reg<wrp1r_prg::WRP1R_PRGrs>;
///FLASH write sector group protection for Bank 1
pub mod wrp1r_prg;
/**EDATA1R_CUR (r) register accessor: FLASH data sector configuration Bank 1

You can [`read`](crate::Reg::read) this register and get [`edata1r_cur::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:EDATA1R_CUR)
...
pub mod edata1r_cur;
/**EDATA1R_PRG (rw) register accessor: FLASH data sector configuration Bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:EDATA1R_PRG)
...
///FLASH data sector configuration Bank 1
pub mod edata1r_prg;
/**HDP1R_CUR (r) register accessor: FLASH HDP Bank 1 configuration
...
pub mod hdp1r_cur;
/**HDP1R_PRG (rw) register accessor: FLASH HDP Bank 1 configuration
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:HDP1R_PRG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:ECCDETR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:ECCDR)

For information about available fields see [`mod@eccdr`] module*/
pub type ECCDR = crate::Reg<eccdr::ECCDRrs>;
///FLASH ECC data
pub mod eccdr;
/**SECBB2R1 (rw) register accessor: FLASH secure block-based register for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECBB2R1)
...
pub mod secbb2r1;
/**SECBB2R2 (rw) register accessor: FLASH secure block-based register for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECBB2R2)

For information about available fields see [`mod@secbb2r2`] module*/
pub type SECBB2R2 = crate::Reg<secbb2r2::SECBB2R2rs>;
///FLASH secure block-based register for Bank 2
pub mod secbb2r2;
/**SECBB2R3 (rw) register accessor: FLASH secure block-based register for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECBB2R3)

For information about available fields see [`mod@secbb2r3`] module*/
pub type SECBB2R3 = crate::Reg<secbb2r3::SECBB2R3rs>;
///FLASH secure block-based register for Bank 2
pub mod secbb2r3;
/**SECBB2R4 (rw) register accessor: FLASH secure block-based register for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECBB2R4)

For information about available fields see [`mod@secbb2r4`] module*/
pub type SECBB2R4 = crate::Reg<secbb2r4::SECBB2R4rs>;
///FLASH secure block-based register for Bank 2
pub mod secbb2r4;
/**PRIVBB2R1 (rw) register accessor: FLASH privilege block-based register for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:PRIVBB2R1)
...
pub mod privbb2r1;
/**PRIVBB2R2 (rw) register accessor: FLASH privilege block-based register for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:PRIVBB2R2)

For information about available fields see [`mod@privbb2r2`] module*/
pub type PRIVBB2R2 = crate::Reg<privbb2r2::PRIVBB2R2rs>;
///FLASH privilege block-based register for Bank 2
pub mod privbb2r2;
/**PRIVBB2R3 (rw) register accessor: FLASH privilege block-based register for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:PRIVBB2R3)

For information about available fields see [`mod@privbb2r3`] module*/
pub type PRIVBB2R3 = crate::Reg<privbb2r3::PRIVBB2R3rs>;
///FLASH privilege block-based register for Bank 2
pub mod privbb2r3;
/**PRIVBB2R4 (rw) register accessor: FLASH privilege block-based register for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:PRIVBB2R4)

For information about available fields see [`mod@privbb2r4`] module*/
pub type PRIVBB2R4 = crate::Reg<privbb2r4::PRIVBB2R4rs>;
///FLASH privilege block-based register for Bank 2
pub mod privbb2r4;
/**SECWM2R_CUR (r) register accessor: FLASH security watermark for Bank 2

You can [`read`](crate::Reg::read) this register and get [`secwm2r_cur::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECWM2R_CUR)
...
pub mod secwm2r_cur;
/**SECWM2R_PRG (rw) register accessor: FLASH security watermark for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:SECWM2R_PRG)
...
///FLASH security watermark for Bank 2
pub mod secwm2r_prg;
/**WRP2R_CUR (r) register accessor: FLASH write sector group protection for Bank 2

You can [`read`](crate::Reg::read) this register and get [`wrp2r_cur::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:WRP2R_CUR)
...
pub mod wrp2r_cur;
/**WRP2R_PRG (rw) register accessor: FLASH write sector group protection for Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:WRP2R_PRG)

For information about available fields see [`mod@wrp2r_prg`] module*/
pub type WRP2R_PRG = crate::Reg<wrp2r_prg::WRP2R_PRGrs>;
///FLASH write sector group protection for Bank 2
pub mod wrp2r_prg;
/**EDATA2R_CUR (r) register accessor: FLASH data sectors configuration Bank 2

You can [`read`](crate::Reg::read) this register and get [`edata2r_cur::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:EDATA2R_CUR)
...
pub mod edata2r_cur;
/**EDATA2R_PRG (rw) register accessor: FLASH data sector configuration Bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:EDATA2R_PRG)
...
pub mod edata2r_prg;
/**HDP2R_CUR (r) register accessor: FLASH HDP Bank 2 configuration

You can [`read`](crate::Reg::read) this register and get [`hdp2r_cur::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:HDP2R_CUR)
...
pub mod hdp2r_cur;
/**HDP2R_PRG (rw) register accessor: FLASH HDP Bank 2 configuration
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#FLASH:HDP2R_PRG)
