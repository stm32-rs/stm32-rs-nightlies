///Register `C6TR2` reader
pub type R = crate::R<C6TR2rs>;
///Register `C6TR2` writer
pub type W = crate::W<C6TR2rs>;
...
/**trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per ), with an active trigger event if TRIGPOL\[1:0\]
≠ 00.
...
/**transfer complete event mode These bits define the transfer granularity for the transfer complete and half transfer complete events generation. Note: If the initial LLI0 data transfer is null/void (directly programmed by the internal register file with GPDMA_CxBR1.BNDT\[15:0\]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> REQSEL_W<C6TR2rs> {
        REQSEL_W::new(self, 0)
    }
    ///Bit 9 - software request This bit is internally taken into account when GPDMA_CxCR.EN is asserted.
    #[inline(always)]
    #[must_use]
    pub fn swreq(&mut self) -> SWREQ_W<C6TR2rs> {
        SWREQ_W::new(self, 9)
    }
    ///Bit 10 - destination hardware request This bit is ignored if channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer). Else: Note: If the channel x is activated (GPDMA_CxCR.EN is asserted) with SWREQ = 0 and PFREQ = 1 (peripheral hardware request with peripheral flow-control mode), any software assertion to this DREQ bit is ignored: in peripheral flow-control mode, only a peripheral-to-memory transfer is supported.
    #[inline(always)]
    #[must_use]
    pub fn dreq(&mut self) -> DREQ_W<C6TR2rs> {
        DREQ_W::new(self, 10)
    }
    ///Bit 11 - Block hardware request If the channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer), this bit is ignored. Else:
    #[inline(always)]
    #[must_use]
    pub fn breq(&mut self) -> BREQ_W<C6TR2rs> {
        BREQ_W::new(self, 11)
    }
    /**Bit 12 - Hardware request in peripheral flow control mode Important: If a given channel x is not implemented with this feature, this bit is reserved and PFREQ is not present (see for the list of the implemented channels with this feature. If the channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer), this bit is ignored. Else: Note: In peripheral flow control mode, there are the following restrictions: - no 2D/repeated block support (GPDMA_CxBR1.BRC\[10:0\]
    must be set to 0 if present) - the peripheral must be set as the source of the transfer (DREQ = 0). - data packing to a wider destination width is not supported (if destination width > source data width, GPDMA_CxTR1.PAM\[1\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pfreq(&mut self) -> PFREQ_W<C6TR2rs> {
        PFREQ_W::new(self, 12)
    }
    /**Bits 14:15 - trigger mode These bits define the transfer granularity for its conditioning by the trigger. If the channel x is enabled (GPDMA_CxCR.EN asserted) with TRIGPOL\[1:0\]
    = 00 or 11, these TRIGM\[1:0\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn trigm(&mut self) -> TRIGM_W<C6TR2rs> {
        TRIGM_W::new(self, 14)
    }
    /**Bits 16:21 - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per ), with an active trigger event if TRIGPOL\[1:0\]
    ≠ 00.*/
    #[inline(always)]
    #[must_use]
    pub fn trigsel(&mut self) -> TRIGSEL_W<C6TR2rs> {
        TRIGSEL_W::new(self, 16)
    }
    ///Bits 24:25 - trigger event polarity These bits define the polarity of the selected trigger event input defined by TRIGSEL\[5:0\].
    #[inline(always)]
    #[must_use]
    pub fn trigpol(&mut self) -> TRIGPOL_W<C6TR2rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcem(&mut self) -> TCEM_W<C6TR2rs> {
        TCEM_W::new(self, 30)
    }
}
/**GPDMA channel 6 transfer register 2

You can [`read`](crate::Reg::read) this register and get [`c6tr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c6tr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#GPDMA1:C6TR2)*/
pub struct C6TR2rs;
impl crate::RegisterSpec for C6TR2rs {
    type Ux = u32;
}
///`read()` method returns [`c6tr2::R`](R) reader structure
impl crate::Readable for C6TR2rs {}
///`write(|w| ..)` method takes [`c6tr2::W`](W) writer structure
impl crate::Writable for C6TR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets C6TR2 to value 0
impl crate::Resettable for C6TR2rs {
