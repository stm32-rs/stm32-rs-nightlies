...
/**LBAR (rw) register accessor: GPDMA channel 6 linked-list base address register
...
pub mod lbar;
/**FCR (w) register accessor: GPDMA channel 6 flag clear register
...
pub mod fcr;
/**SR (r) register accessor: GPDMA channel 6 status register
...
pub mod sr;
/**CR (rw) register accessor: GPDMA channel 6 control register
...
pub mod cr;
/**TR1 (rw) register accessor: GPDMA channel 6 transfer register 1
...
pub mod tr1;
/**TR2 (rw) register accessor: GPDMA channel 6 transfer register 2
...
pub mod br1;
/**SAR (rw) register accessor: GPDMA channel 6 source address register
...
pub mod sar;
/**DAR (rw) register accessor: GPDMA channel 6 destination address register
