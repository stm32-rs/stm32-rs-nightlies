...
/**privileged state of channel x (x = 7 to 0)
...
///Field `PRIV(0-7)` reader - privileged state of channel x (x = 7 to 0)
...
///Field `PRIV(0-7)` writer - privileged state of channel x (x = 7 to 0)
