...
#[doc = "GTZC1 SRAM1 MPCBB privileged configuration for super-block 3 register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gtzc1_mpcbb1_privcfgr3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gtzc1_mpcbb1_privcfgr3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
