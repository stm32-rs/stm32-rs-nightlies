...
impl W {
    ...
    #[inline(always)]
    pub fn cspi4f(&mut self) -> CSPI4F_W<FCR2rs> {
        CSPI4F_W::new(self, 15)
    }
    ///Bit 16 - clear the illegal access flag for SPI6
    #[inline(always)]
    pub fn cspi6f(&mut self) -> CSPI6F_W<FCR2rs> {
    ...
    #[inline(always)]
    pub fn cusbf(&mut self) -> CUSBF_W<FCR2rs> {
        CUSBF_W::new(self, 19)
    }
    ///Bit 24 - clear the illegal access flag for SPI5
    #[inline(always)]
    pub fn cspi5f(&mut self) -> CSPI5F_W<FCR2rs> {
    ...
    #[inline(always)]
    pub fn ci2c4f(&mut self) -> CI2C4F_W<FCR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#GTZC1_TZIC:FCR2)*/
pub struct FCR2rs;
