#[doc = "Register `MPCWM1BR` reader"]
pub type R = crate::R<MPCWM1BRrs>;
#[doc = "Register `MPCWM1BR` writer"]
...
#[doc = "GTZC1 TZSC memory 1 sub-region B watermark register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcwm1br::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcwm1br::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPCWM1BRrs;
impl crate::RegisterSpec for MPCWM1BRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpcwm1br::R`](R) reader structure"]
impl crate::Readable for MPCWM1BRrs {}
#[doc = "`write(|w| ..)` method takes [`mpcwm1br::W`](W) writer structure"]
impl crate::Writable for MPCWM1BRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPCWM1BR to value 0"]
