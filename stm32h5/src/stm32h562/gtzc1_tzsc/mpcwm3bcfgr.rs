#[doc = "Register `MPCWM3BCFGR` reader"]
pub type R = crate::R<MPCWM3BCFGRrs>;
#[doc = "Register `MPCWM3BCFGR` writer"]
...
#[doc = "GTZC1 TZSC memory 3 sub-region B watermark configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcwm3bcfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcwm3bcfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPCWM3BCFGRrs;
impl crate::RegisterSpec for MPCWM3BCFGRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpcwm3bcfgr::R`](R) reader structure"]
impl crate::Readable for MPCWM3BCFGRrs {}
#[doc = "`write(|w| ..)` method takes [`mpcwm3bcfgr::W`](W) writer structure"]
impl crate::Writable for MPCWM3BCFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPCWM3BCFGR to value 0"]
