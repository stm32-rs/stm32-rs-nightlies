...
impl W {
    ...
    ///Bit 6 - privileged access mode for TIM12
    #[inline(always)]
    pub fn tim12priv(&mut self) -> TIM12PRIV_W<'_, PRIVCFGR1rs> {
        TIM12PRIV_W::new(self, 6)
    }
    ///Bit 7 - privileged access mode for TIM13
    #[inline(always)]
    pub fn tim13priv(&mut self) -> TIM13PRIV_W<'_, PRIVCFGR1rs> {
        TIM13PRIV_W::new(self, 7)
    }
    ///Bit 8 - privileged access mode for TIM14
    #[inline(always)]
    pub fn tim14priv(&mut self) -> TIM14PRIV_W<'_, PRIVCFGR1rs> {
    ...
    ///Bit 12 - privileged access mode for SPI3
    #[inline(always)]
    pub fn spi3priv(&mut self) -> SPI3PRIV_W<'_, PRIVCFGR1rs> {
    ...
    ///Bit 19 - privileged access mode for I3C1
    #[inline(always)]
    pub fn i3c1priv(&mut self) -> I3C1PRIV_W<'_, PRIVCFGR1rs> {
    ...
    ///Bit 21 - privileged access mode for USART6
    #[inline(always)]
    pub fn usart6priv(&mut self) -> USART6PRIV_W<'_, PRIVCFGR1rs> {
        USART6PRIV_W::new(self, 21)
    }
    ///Bit 22 - privileged access mode for USART10
    #[inline(always)]
    pub fn usart10priv(&mut self) -> USART10PRIV_W<'_, PRIVCFGR1rs> {
        USART10PRIV_W::new(self, 22)
    }
    ///Bit 23 - privileged access mode for USART11
    #[inline(always)]
    pub fn usart11priv(&mut self) -> USART11PRIV_W<'_, PRIVCFGR1rs> {
        USART11PRIV_W::new(self, 23)
    }
    ///Bit 24 - privileged access mode for HDMICEC
    #[inline(always)]
    pub fn hdmicecpriv(&mut self) -> HDMICECPRIV_W<'_, PRIVCFGR1rs> {
        HDMICECPRIV_W::new(self, 24)
    }
    ///Bit 25 - privileged access mode for DAC1
    #[inline(always)]
    pub fn dac1priv(&mut self) -> DAC1PRIV_W<'_, PRIVCFGR1rs> {
        DAC1PRIV_W::new(self, 25)
    }
    ///Bit 26 - privileged access mode for UART7
    #[inline(always)]
    pub fn uart7priv(&mut self) -> UART7PRIV_W<'_, PRIVCFGR1rs> {
        UART7PRIV_W::new(self, 26)
    }
    ///Bit 27 - privileged access mode for UART8
    #[inline(always)]
    pub fn uart8priv(&mut self) -> UART8PRIV_W<'_, PRIVCFGR1rs> {
        UART8PRIV_W::new(self, 27)
    }
    ///Bit 28 - privileged access mode for UART9
    #[inline(always)]
    pub fn uart9priv(&mut self) -> UART9PRIV_W<'_, PRIVCFGR1rs> {
        UART9PRIV_W::new(self, 28)
    }
    ///Bit 29 - privileged access mode for UART12
    #[inline(always)]
    pub fn uart12priv(&mut self) -> UART12PRIV_W<'_, PRIVCFGR1rs> {
        UART12PRIV_W::new(self, 29)
    }
    ///Bit 30 - privileged access mode for DTS
    #[inline(always)]
    pub fn dtspriv(&mut self) -> DTSPRIV_W<'_, PRIVCFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#GTZC1_TZSC:PRIVCFGR1)*/
