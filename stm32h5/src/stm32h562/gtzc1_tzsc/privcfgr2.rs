...
pub type SPI5PRIV_R = crate::BitReader;
///Field `SPI5PRIV` writer - privileged access mode for SPI5
pub type SPI5PRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ///Bit 0 - privileged access mode for FDCAN1
    #[inline(always)]
    pub fn fdcan1priv(&mut self) -> FDCAN1PRIV_W<'_, PRIVCFGR2rs> {
        FDCAN1PRIV_W::new(self, 0)
    }
    ///Bit 1 - privileged access mode for FDCAN2
    #[inline(always)]
    pub fn fdcan2priv(&mut self) -> FDCAN2PRIV_W<'_, PRIVCFGR2rs> {
        FDCAN2PRIV_W::new(self, 1)
    }
    ///Bit 2 - privileged access mode for UCPD
    #[inline(always)]
    pub fn ucpdpriv(&mut self) -> UCPDPRIV_W<'_, PRIVCFGR2rs> {
        UCPDPRIV_W::new(self, 2)
    }
    ///Bit 8 - privileged access mode for TIM1
    #[inline(always)]
    pub fn tim1priv(&mut self) -> TIM1PRIV_W<'_, PRIVCFGR2rs> {
        TIM1PRIV_W::new(self, 8)
    }
    ///Bit 9 - privileged access mode for SPI1
    #[inline(always)]
    pub fn spi1priv(&mut self) -> SPI1PRIV_W<'_, PRIVCFGR2rs> {
    ...
    pub fn tim17priv(&mut self) -> TIM17PRIV_W<'_, PRIVCFGR2rs> {
        TIM17PRIV_W::new(self, 14)
    }
    ///Bit 15 - privileged access mode for SPI4
    #[inline(always)]
    pub fn spi4priv(&mut self) -> SPI4PRIV_W<'_, PRIVCFGR2rs> {
        SPI4PRIV_W::new(self, 15)
    }
    ///Bit 16 - privileged access mode for SPI6
    #[inline(always)]
    pub fn spi6priv(&mut self) -> SPI6PRIV_W<'_, PRIVCFGR2rs> {
    ...
    ///Bit 19 - privileged access mode for USB
    #[inline(always)]
    pub fn usbpriv(&mut self) -> USBPRIV_W<'_, PRIVCFGR2rs> {
        USBPRIV_W::new(self, 19)
    }
    ///Bit 24 - privileged access mode for SPI5
    #[inline(always)]
    pub fn spi5priv(&mut self) -> SPI5PRIV_W<'_, PRIVCFGR2rs> {
        SPI5PRIV_W::new(self, 24)
    }
    ///Bit 25 - privileged access mode for LPUART
    #[inline(always)]
    pub fn lpuart1priv(&mut self) -> LPUART1PRIV_W<'_, PRIVCFGR2rs> {
        LPUART1PRIV_W::new(self, 25)
    }
    ///Bit 26 - privileged access mode for I2C3
    #[inline(always)]
    pub fn i2c3priv(&mut self) -> I2C3PRIV_W<'_, PRIVCFGR2rs> {
        I2C3PRIV_W::new(self, 26)
    }
    ///Bit 27 - privileged access mode for I2C4
    #[inline(always)]
    pub fn i2c4priv(&mut self) -> I2C4PRIV_W<'_, PRIVCFGR2rs> {
        I2C4PRIV_W::new(self, 27)
    }
    ///Bit 28 - privileged access mode for LPTIM1
    #[inline(always)]
    pub fn lptim1priv(&mut self) -> LPTIM1PRIV_W<'_, PRIVCFGR2rs> {
        LPTIM1PRIV_W::new(self, 28)
    }
    ///Bit 29 - privileged access mode for LPTIM3
    #[inline(always)]
    pub fn lptim3priv(&mut self) -> LPTIM3PRIV_W<'_, PRIVCFGR2rs> {
        LPTIM3PRIV_W::new(self, 29)
    }
    ///Bit 30 - privileged access mode for LPTIM4
    #[inline(always)]
    pub fn lptim4priv(&mut self) -> LPTIM4PRIV_W<'_, PRIVCFGR2rs> {
        LPTIM4PRIV_W::new(self, 30)
    }
    ///Bit 31 - privileged access mode for LPTIM5
    #[inline(always)]
    pub fn lptim5priv(&mut self) -> LPTIM5PRIV_W<'_, PRIVCFGR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#GTZC1_TZSC:PRIVCFGR2)*/
