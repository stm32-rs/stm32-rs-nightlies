...
pub type TIM12SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TIM13SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TIM14SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type I3C1SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type USART6SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type USART10SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type USART11SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HDMICECSEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type UART7SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type UART8SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type UART9SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type UART12SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DTSSEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    ///Bit 2 - secure access mode for TIM4
    #[inline(always)]
    pub fn tim4sec(&mut self) -> TIM4SEC_W<'_, SECCFGR1rs> {
        TIM4SEC_W::new(self, 2)
    }
    ///Bit 3 - secure access mode for TIM5
    #[inline(always)]
    pub fn tim5sec(&mut self) -> TIM5SEC_W<'_, SECCFGR1rs> {
        TIM5SEC_W::new(self, 3)
    }
    ///Bit 4 - secure access mode for TIM6
    #[inline(always)]
    pub fn tim6sec(&mut self) -> TIM6SEC_W<'_, SECCFGR1rs> {
        TIM6SEC_W::new(self, 4)
    }
    ///Bit 5 - secure access mode for TIM7
    #[inline(always)]
    pub fn tim7sec(&mut self) -> TIM7SEC_W<'_, SECCFGR1rs> {
        TIM7SEC_W::new(self, 5)
    }
    ///Bit 6 - secure access mode for TIM12
    #[inline(always)]
    pub fn tim12sec(&mut self) -> TIM12SEC_W<'_, SECCFGR1rs> {
        TIM12SEC_W::new(self, 6)
    }
    ///Bit 7 - secure access mode for TIM13
    #[inline(always)]
    pub fn tim13sec(&mut self) -> TIM13SEC_W<'_, SECCFGR1rs> {
        TIM13SEC_W::new(self, 7)
    }
    ///Bit 8 - secure access mode for TIM14
    #[inline(always)]
    pub fn tim14sec(&mut self) -> TIM14SEC_W<'_, SECCFGR1rs> {
        TIM14SEC_W::new(self, 8)
    }
    ///Bit 9 - secure access mode for WWDG
    #[inline(always)]
    pub fn wwdgsec(&mut self) -> WWDGSEC_W<'_, SECCFGR1rs> {
        WWDGSEC_W::new(self, 9)
    }
    ///Bit 10 - secure access mode for IWDG
    #[inline(always)]
    pub fn iwdgsec(&mut self) -> IWDGSEC_W<'_, SECCFGR1rs> {
        IWDGSEC_W::new(self, 10)
    }
    ///Bit 11 - secure access mode for SPI2
    #[inline(always)]
    pub fn spi2sec(&mut self) -> SPI2SEC_W<'_, SECCFGR1rs> {
        SPI2SEC_W::new(self, 11)
    }
    ///Bit 12 - secure access mode for SPI3
    #[inline(always)]
    pub fn spi3sec(&mut self) -> SPI3SEC_W<'_, SECCFGR1rs> {
        SPI3SEC_W::new(self, 12)
    }
    ///Bit 13 - secure access mode for USART2
    #[inline(always)]
    pub fn usart2sec(&mut self) -> USART2SEC_W<'_, SECCFGR1rs> {
        USART2SEC_W::new(self, 13)
    }
    ///Bit 14 - secure access mode for USART3
    #[inline(always)]
    pub fn usart3sec(&mut self) -> USART3SEC_W<'_, SECCFGR1rs> {
        USART3SEC_W::new(self, 14)
    }
    ///Bit 15 - secure access mode for UART4
    #[inline(always)]
    pub fn uart4sec(&mut self) -> UART4SEC_W<'_, SECCFGR1rs> {
        UART4SEC_W::new(self, 15)
    }
    ///Bit 16 - secure access mode for UART5
    #[inline(always)]
    pub fn uart5sec(&mut self) -> UART5SEC_W<'_, SECCFGR1rs> {
        UART5SEC_W::new(self, 16)
    }
    ///Bit 17 - secure access mode for I2C1
    #[inline(always)]
    pub fn i2c1sec(&mut self) -> I2C1SEC_W<'_, SECCFGR1rs> {
        I2C1SEC_W::new(self, 17)
    }
    ///Bit 18 - secure access mode for I2C2
    #[inline(always)]
    pub fn i2c2sec(&mut self) -> I2C2SEC_W<'_, SECCFGR1rs> {
        I2C2SEC_W::new(self, 18)
    }
    ///Bit 19 - secure access mode for I3C1
    #[inline(always)]
    pub fn i3c1sec(&mut self) -> I3C1SEC_W<'_, SECCFGR1rs> {
        I3C1SEC_W::new(self, 19)
    }
    ///Bit 20 - secure access mode for CRS
    #[inline(always)]
    pub fn crssec(&mut self) -> CRSSEC_W<'_, SECCFGR1rs> {
        CRSSEC_W::new(self, 20)
    }
    ///Bit 21 - secure access mode for USART6
    #[inline(always)]
    pub fn usart6sec(&mut self) -> USART6SEC_W<'_, SECCFGR1rs> {
        USART6SEC_W::new(self, 21)
    }
    ///Bit 22 - secure access mode for USART10
    #[inline(always)]
    pub fn usart10sec(&mut self) -> USART10SEC_W<'_, SECCFGR1rs> {
        USART10SEC_W::new(self, 22)
    }
    ///Bit 23 - secure access mode for USART11
    #[inline(always)]
    pub fn usart11sec(&mut self) -> USART11SEC_W<'_, SECCFGR1rs> {
        USART11SEC_W::new(self, 23)
    }
    ///Bit 24 - secure access mode for HDMICEC
    #[inline(always)]
    pub fn hdmicecsec(&mut self) -> HDMICECSEC_W<'_, SECCFGR1rs> {
        HDMICECSEC_W::new(self, 24)
    }
    ///Bit 25 - secure access mode for DAC1
    #[inline(always)]
    pub fn dac1sec(&mut self) -> DAC1SEC_W<'_, SECCFGR1rs> {
        DAC1SEC_W::new(self, 25)
    }
    ///Bit 26 - secure access mode for UART7
    #[inline(always)]
    pub fn uart7sec(&mut self) -> UART7SEC_W<'_, SECCFGR1rs> {
        UART7SEC_W::new(self, 26)
    }
    ///Bit 27 - secure access mode for UART8
    #[inline(always)]
    pub fn uart8sec(&mut self) -> UART8SEC_W<'_, SECCFGR1rs> {
        UART8SEC_W::new(self, 27)
    }
    ///Bit 28 - secure access mode for UART9
    #[inline(always)]
    pub fn uart9sec(&mut self) -> UART9SEC_W<'_, SECCFGR1rs> {
        UART9SEC_W::new(self, 28)
    }
    ///Bit 29 - secure access mode for UART12
    #[inline(always)]
    pub fn uart12sec(&mut self) -> UART12SEC_W<'_, SECCFGR1rs> {
        UART12SEC_W::new(self, 29)
    }
    ///Bit 30 - secure access mode for DTS
    #[inline(always)]
    pub fn dtssec(&mut self) -> DTSSEC_W<'_, SECCFGR1rs> {
        DTSSEC_W::new(self, 30)
    }
    ///Bit 31 - secure access mode for LPTIM2
    #[inline(always)]
    pub fn lptim2sec(&mut self) -> LPTIM2SEC_W<'_, SECCFGR1rs> {
        LPTIM2SEC_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#GTZC1_TZSC:SECCFGR1)*/
