...
impl W {
    ...
    ///Bit 6 - secure access mode for TIM12
    #[inline(always)]
    pub fn tim12sec(&mut self) -> TIM12SEC_W<SECCFGR1rs> {
        TIM12SEC_W::new(self, 6)
    }
    ///Bit 7 - secure access mode for TIM13
    #[inline(always)]
    pub fn tim13sec(&mut self) -> TIM13SEC_W<SECCFGR1rs> {
        TIM13SEC_W::new(self, 7)
    }
    ///Bit 8 - secure access mode for TIM14
    #[inline(always)]
    pub fn tim14sec(&mut self) -> TIM14SEC_W<SECCFGR1rs> {
    ...
    ///Bit 19 - secure access mode for I3C1
    #[inline(always)]
    pub fn i3c1sec(&mut self) -> I3C1SEC_W<SECCFGR1rs> {
    ...
    ///Bit 21 - secure access mode for USART6
    #[inline(always)]
    pub fn usart6sec(&mut self) -> USART6SEC_W<SECCFGR1rs> {
        USART6SEC_W::new(self, 21)
    }
    ///Bit 22 - secure access mode for USART10
    #[inline(always)]
    pub fn usart10sec(&mut self) -> USART10SEC_W<SECCFGR1rs> {
        USART10SEC_W::new(self, 22)
    }
    ///Bit 23 - secure access mode for USART11
    #[inline(always)]
    pub fn usart11sec(&mut self) -> USART11SEC_W<SECCFGR1rs> {
        USART11SEC_W::new(self, 23)
    }
    ///Bit 24 - secure access mode for HDMICEC
    #[inline(always)]
    pub fn hdmicecsec(&mut self) -> HDMICECSEC_W<SECCFGR1rs> {
        HDMICECSEC_W::new(self, 24)
    }
    ///Bit 25 - secure access mode for DAC1
    #[inline(always)]
    pub fn dac1sec(&mut self) -> DAC1SEC_W<SECCFGR1rs> {
        DAC1SEC_W::new(self, 25)
    }
    ///Bit 26 - secure access mode for UART7
    #[inline(always)]
    pub fn uart7sec(&mut self) -> UART7SEC_W<SECCFGR1rs> {
        UART7SEC_W::new(self, 26)
    }
    ///Bit 27 - secure access mode for UART8
    #[inline(always)]
    pub fn uart8sec(&mut self) -> UART8SEC_W<SECCFGR1rs> {
        UART8SEC_W::new(self, 27)
    }
    ///Bit 28 - secure access mode for UART9
    #[inline(always)]
    pub fn uart9sec(&mut self) -> UART9SEC_W<SECCFGR1rs> {
        UART9SEC_W::new(self, 28)
    }
    ///Bit 29 - secure access mode for UART12
    #[inline(always)]
    pub fn uart12sec(&mut self) -> UART12SEC_W<SECCFGR1rs> {
        UART12SEC_W::new(self, 29)
    }
    ///Bit 30 - secure access mode for DTS
    #[inline(always)]
    pub fn dtssec(&mut self) -> DTSSEC_W<SECCFGR1rs> {
