...
#[doc = "HASH digest register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hr10::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HR10rs;
impl crate::RegisterSpec for HR10rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hr10::R`](R) reader structure"]
impl crate::Readable for HR10rs {}
#[doc = "`reset()` method sets HR10 to value 0"]
