#[doc = "Register `CR_ALTERNATE` writer"]
...
#[doc = "I3C message control register alternate\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cr_alternate::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CR_ALTERNATErs;
impl crate::RegisterSpec for CR_ALTERNATErs {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`cr_alternate::W`](W) writer structure"]
impl crate::Writable for CR_ALTERNATErs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CR_ALTERNATE to value 0"]
