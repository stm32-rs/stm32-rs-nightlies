...
/**Field `PW` reader - Pulse width This bitfield defines the pulse duration, as following: t PW = PW\[7:0\]
x t PWG*/
pub type PW_R = crate::FieldReader;
/**Field `PW` writer - Pulse width This bitfield defines the pulse duration, as following: t PW = PW\[7:0\]
x t PWG*/
...
impl R {
    ...
    /**Bits 16:23 - Pulse width This bitfield defines the pulse duration, as following: t PW = PW\[7:0\]
    x t PWG*/
    #[inline(always)]
    pub fn pw(&self) -> PW_R {
