...
///Field `DTAE` reader - Deadtime asymmetric enable Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BDTR register).
pub type DTAE_R = crate::BitReader;
///Field `DTAE` writer - Deadtime asymmetric enable Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BDTR register).
pub type DTAE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DTPE` reader - Deadtime preload enable Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BDTR register).
pub type DTPE_R = crate::BitReader;
///Field `DTPE` writer - Deadtime preload enable Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BDTR register).
...
impl W {
    ///Bits 0:7 - Dead-time falling edge generator setup This bit-field defines the duration of the dead-time inserted between the complementary outputs, on the falling edge. DTGF\[7:5\]=0xx = DTF=DTGF\[7:0\]x tdtg with tdtg=tDTS. DTGF\[7:5\]=10x = DTF=(64+DTGF\[5:0\])xtdtg with Tdtg=2xtDTS. DTGF\[7:5\]=110 = DTF=(32+DTGF\[4:0\])xtdtg with Tdtg=8xtDTS. DTGF\[7:5\]=111 = DTF=(32+DTGF\[4:0\])xtdtg with Tdtg=16xtDTS. Example if TDTS=125ns (8MHz), dead-time possible values are: 0 to 15875 ns by 125 ns steps, 16 us to 31750 ns by 250 ns steps, 32 us to 63us by 1 us steps, 64 us to 126 us by 2 us steps Note: This bit-field can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BDTR register).
    #[inline(always)]
    pub fn dtgf(&mut self) -> DTGF_W<'_, DTR2rs> {
        DTGF_W::new(self, 0)
    }
    ///Bit 16 - Deadtime asymmetric enable Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BDTR register).
    #[inline(always)]
    pub fn dtae(&mut self) -> DTAE_W<'_, DTR2rs> {
        DTAE_W::new(self, 16)
    }
    ///Bit 17 - Deadtime preload enable Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BDTR register).
    #[inline(always)]
    pub fn dtpe(&mut self) -> DTPE_W<'_, DTR2rs> {
        DTPE_W::new(self, 17)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#TIM15:DTR2)*/
pub struct DTR2rs;
