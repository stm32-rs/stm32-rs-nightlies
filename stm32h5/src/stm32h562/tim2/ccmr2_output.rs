...
///Field `OC3M` reader - Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
///Field `OC3M` writer - Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
///Field `OC4M` reader - Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
pub use OC3M_R as OC4M_R;
///Field `OC4M` writer - Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
///Field `OC3M_3` reader - Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
///Field `OC3M_3` writer - Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
///Field `OC4M_3` reader - Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
pub use OC3M_3_R as OC4M_3_R;
///Field `OC4M_3` writer - Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
