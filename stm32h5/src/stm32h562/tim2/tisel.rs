...
///Field `TI1SEL` reader - Selects tim_ti1\[0..15\] input ... Refer to for product specific implementation.
...
///Field `TI1SEL` writer - Selects tim_ti1\[0..15\] input ... Refer to for product specific implementation.
...
///Field `TI2SEL` reader - Selects tim_ti2\[0..15\] input ... Refer to for product specific implementation.
pub use TI1SEL_R as TI2SEL_R;
///Field `TI3SEL` reader - Selects tim_ti3\[0..15\] input ... Refer to for product specific implementation.
pub use TI1SEL_R as TI3SEL_R;
///Field `TI4SEL` reader - Selects tim_ti4\[0..15\] input ... Refer to for product specific implementation.
pub use TI1SEL_R as TI4SEL_R;
///Field `TI2SEL` writer - Selects tim_ti2\[0..15\] input ... Refer to for product specific implementation.
pub use TI1SEL_W as TI2SEL_W;
///Field `TI3SEL` writer - Selects tim_ti3\[0..15\] input ... Refer to for product specific implementation.
pub use TI1SEL_W as TI3SEL_W;
///Field `TI4SEL` writer - Selects tim_ti4\[0..15\] input ... Refer to for product specific implementation.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#TIM2:TISEL)*/
pub struct TISELrs;
