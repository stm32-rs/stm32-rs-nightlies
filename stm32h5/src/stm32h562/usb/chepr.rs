...
///Field `LS_EP` reader - Low speed endpointhost with HUB only Host mode This bit is set by the software to send an LS transaction to the corresponding endpoint.
pub type LS_EP_R = crate::BitReader;
///Field `LS_EP` writer - Low speed endpointhost with HUB only Host mode This bit is set by the software to send an LS transaction to the corresponding endpoint.
...
impl R {
    ...
    ///Bit 24 - Low speed endpointhost with HUB only Host mode This bit is set by the software to send an LS transaction to the corresponding endpoint.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H562.html#USB:CHEP[0]R)*/
pub struct CHEPRrs;
