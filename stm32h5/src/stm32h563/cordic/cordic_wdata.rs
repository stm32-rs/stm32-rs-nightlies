...
pub type W = crate::W<CORDIC_WDATArs>;
...
impl core::fmt::Debug for crate::generic::Reg<CORDIC_WDATArs> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn arg(&mut self) -> ARG_W<CORDIC_WDATArs> {
        ARG_W::new(self, 0)
    }
}
/**CORDIC argument register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cordic_wdata::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#CORDIC:CORDIC_WDATA)*/
pub struct CORDIC_WDATArs;
impl crate::RegisterSpec for CORDIC_WDATArs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`cordic_wdata::W`](W) writer structure
impl crate::Writable for CORDIC_WDATArs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CORDIC_WDATA to value 0
impl crate::Resettable for CORDIC_WDATArs {
