...
///Field `DACCDHR` reader - DAC channel1 12-bit left-aligned data These bits are written by software. They specify 12-bit data for DAC channel1.
pub type DACCDHR_R = crate::FieldReader<u16>;
///Field `DACCDHR` writer - DAC channel1 12-bit left-aligned data These bits are written by software. They specify 12-bit data for DAC channel1.
pub type DACCDHR_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16, crate::Safe>;
///Field `DACC1DHRB` reader - DAC channel1 12-bit left-aligned data B These bits are written by software. They specify 12-bit data for DAC channel1 when the DAC operates in Double data mode.
pub type DACC1DHRB_R = crate::FieldReader<u16>;
///Field `DACC1DHRB` writer - DAC channel1 12-bit left-aligned data B These bits are written by software. They specify 12-bit data for DAC channel1 when the DAC operates in Double data mode.
...
impl W {
    ///Bits 4:15 - DAC channel1 12-bit left-aligned data These bits are written by software. They specify 12-bit data for DAC channel1.
    #[inline(always)]
    pub fn daccdhr(&mut self) -> DACCDHR_W<'_, DHR12Lrs> {
        DACCDHR_W::new(self, 4)
    }
    ///Bits 20:31 - DAC channel1 12-bit left-aligned data B These bits are written by software. They specify 12-bit data for DAC channel1 when the DAC operates in Double data mode.
    #[inline(always)]
    pub fn dacc1dhrb(&mut self) -> DACC1DHRB_W<'_, DHR12Lrs> {
