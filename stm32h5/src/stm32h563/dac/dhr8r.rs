...
///Field `DACCDHR` reader - DAC channel1 8-bit right-aligned data These bits are written by software. They specify 8-bit data for DAC channel1.
pub type DACCDHR_R = crate::FieldReader;
///Field `DACCDHR` writer - DAC channel1 8-bit right-aligned data These bits are written by software. They specify 8-bit data for DAC channel1.
pub type DACCDHR_W<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
///Field `DACC1DHRB` reader - DAC channel1 8-bit right-aligned data These bits are written by software. They specify 8-bit data for DAC channel1 when the DAC operates in Double data mode.
pub type DACC1DHRB_R = crate::FieldReader;
///Field `DACC1DHRB` writer - DAC channel1 8-bit right-aligned data These bits are written by software. They specify 8-bit data for DAC channel1 when the DAC operates in Double data mode.
...
impl W {
    ...
    ///Bits 8:15 - DAC channel1 8-bit right-aligned data These bits are written by software. They specify 8-bit data for DAC channel1 when the DAC operates in Double data mode.
    #[inline(always)]
    pub fn dacc1dhrb(&mut self) -> DACC1DHRB_W<'_, DHR8Rrs> {
