...
///Field `CBSYENDF` writer - clear full invalidate busy end flag Set by software.
...
///Field `CCMDENDF` writer - clear command end flag Set by software.
...
impl W {
    ///Bit 1 - clear full invalidate busy end flag Set by software.
    #[inline(always)]
    ...
    ///Bit 4 - clear command end flag Set by software.
    #[inline(always)]
