...
///Field `TSSS` reader - Timestamp subseconds The value in this field is the subseconds part of the update.
pub type TSSS_R = crate::FieldReader<u32>;
///Field `TSSS` writer - Timestamp subseconds The value in this field is the subseconds part of the update.
...
impl R {
    ///Bits 0:30 - Timestamp subseconds The value in this field is the subseconds part of the update.
    #[inline(always)]
