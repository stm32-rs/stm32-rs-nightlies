...
///Field `RXCRCERR` reader - Rx CRC Error Packets This field indicates the number of packets received with CRC error.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#ETH:RX_CRC_ERROR_PACKETS)*/
