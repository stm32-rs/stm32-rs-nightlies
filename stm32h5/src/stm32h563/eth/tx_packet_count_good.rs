...
///Field `TXPKTG` reader - Tx Packet Count Good This field indicates the number of good packets transmitted.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#ETH:TX_PACKET_COUNT_GOOD)*/
