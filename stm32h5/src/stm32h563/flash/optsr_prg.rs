...
///Field `PRODUCT_STATE` writer - Life state code (based on Hamming 8,4). More information in Section7.6.11: Product state transitions.
pub type PRODUCT_STATE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `IO_VDD_HSLV` reader - High-speed IO at low VDD voltage configuration bit. This bit can be set only with VDD below 2.7V.
pub type IO_VDD_HSLV_R = crate::BitReader;
///Field `IO_VDD_HSLV` writer - High-speed IO at low VDD voltage configuration bit. This bit can be set only with VDD below 2.7V.
pub type IO_VDD_HSLV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IO_VDDIO2_HSLV` reader - High-speed IO at low VDDIO2 voltage configuration bit. This bit can be set only with VDDIO2 below 2.7V.
pub type IO_VDDIO2_HSLV_R = crate::BitReader;
///Field `IO_VDDIO2_HSLV` writer - High-speed IO at low VDDIO2 voltage configuration bit. This bit can be set only with VDDIO2 below 2.7V.
...
impl R {
    ...
    ///Bit 16 - High-speed IO at low VDD voltage configuration bit. This bit can be set only with VDD below 2.7V.
    #[inline(always)]
    pub fn io_vdd_hslv(&self) -> IO_VDD_HSLV_R {
        IO_VDD_HSLV_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - High-speed IO at low VDDIO2 voltage configuration bit. This bit can be set only with VDDIO2 below 2.7V.
    #[inline(always)]
