...
pub type R = crate::R<PRIVBB1R2rs>;
///Register `PRIVBB1R2` writer
pub type W = crate::W<PRIVBB1R2rs>;
...
impl W {
    ///Bits 0:31 - Privileged/unprivileged 8-Kbyte flash Bank 1 sector attribute
    #[inline(always)]
    pub fn privbb1(&mut self) -> PRIVBB1_W<'_, PRIVBB1R2rs> {
        PRIVBB1_W::new(self, 0)
    }
}
/**FLASH privilege block based register for Bank 1

You can [`read`](crate::Reg::read) this register and get [`privbb1r2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`privbb1r2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#FLASH:PRIVBB1R2)*/
pub struct PRIVBB1R2rs;
impl crate::RegisterSpec for PRIVBB1R2rs {
    type Ux = u32;
}
///`read()` method returns [`privbb1r2::R`](R) reader structure
impl crate::Readable for PRIVBB1R2rs {}
///`write(|w| ..)` method takes [`privbb1r2::W`](W) writer structure
impl crate::Writable for PRIVBB1R2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PRIVBB1R2 to value 0
impl crate::Resettable for PRIVBB1R2rs {}
