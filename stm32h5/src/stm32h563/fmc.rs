...
impl RegisterBlock {
    ...
    ///0x148..0x150 - SDRAM timing registers %s
    ///
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#FMC:BCR[2])
...
pub mod sdcr2;
/**SDTR (rw) register accessor: SDRAM timing registers %s
