...
impl CH2D {
    ///0x00 - GPDMA channel 6 linked-list base address register
    #[inline(always)]
    pub const fn lbar(&self) -> &LBAR {
        &self.lbar
    }
    ///0x0c - GPDMA channel 6 flag clear register
    #[inline(always)]
    pub const fn fcr(&self) -> &FCR {
        &self.fcr
    }
    ///0x10 - GPDMA channel 6 status register
    #[inline(always)]
    pub const fn sr(&self) -> &SR {
        &self.sr
    }
    ///0x14 - GPDMA channel 6 control register
    #[inline(always)]
    pub const fn cr(&self) -> &CR {
        &self.cr
    }
    ///0x40 - GPDMA channel 6 transfer register 1
    #[inline(always)]
    pub const fn tr1(&self) -> &TR1 {
        &self.tr1
    }
    ///0x44 - GPDMA channel 6 transfer register 2
    #[inline(always)]
    pub const fn tr2(&self) -> &TR2 {
        &self.tr2
    }
    ///0x48 - GPDMA channel 6 alternate block register 1
    #[inline(always)]
    pub const fn br1(&self) -> &BR1 {
        &self.br1
    }
    ///0x4c - GPDMA channel 6 source address register
    #[inline(always)]
    pub const fn sar(&self) -> &SAR {
        &self.sar
    }
    ///0x50 - GPDMA channel 6 destination address register
    #[inline(always)]
    pub const fn dar(&self) -> &DAR {
        &self.dar
    }
    ///0x54 - GPDMA channel 6 transfer register 3
    #[inline(always)]
    pub const fn tr3(&self) -> &TR3 {
        &self.tr3
    }
    ///0x58 - GPDMA channel 6 block register 2
    #[inline(always)]
    pub const fn br2(&self) -> &BR2 {
        &self.br2
    }
    ///0x7c - GPDMA channel 6 alternate linked-list address register
    #[inline(always)]
    pub const fn llr(&self) -> &LLR {
        &self.llr
    }
}
pub use crate::stm32h563::gpdma1::ch::cr;
pub use crate::stm32h563::gpdma1::ch::fcr;
pub use crate::stm32h563::gpdma1::ch::lbar;
pub use crate::stm32h563::gpdma1::ch::sr;
pub use crate::stm32h563::gpdma1::ch::tr1;
pub use crate::stm32h563::gpdma1::ch::tr2;
pub use crate::stm32h563::gpdma1::ch::CR;
pub use crate::stm32h563::gpdma1::ch::FCR;
pub use crate::stm32h563::gpdma1::ch::LBAR;
pub use crate::stm32h563::gpdma1::ch::SR;
pub use crate::stm32h563::gpdma1::ch::TR1;
pub use crate::stm32h563::gpdma1::ch::TR2;
/**BR1 (rw) register accessor: GPDMA channel 6 alternate block register 1
...
pub mod br1;
pub use crate::stm32h563::gpdma1::ch::dar;
pub use crate::stm32h563::gpdma1::ch::sar;
pub use crate::stm32h563::gpdma1::ch::DAR;
pub use crate::stm32h563::gpdma1::ch::SAR;
/**TR3 (rw) register accessor: GPDMA channel 6 transfer register 3
...
pub mod tr3;
/**BR2 (rw) register accessor: GPDMA channel 6 block register 2
...
pub mod br2;
/**LLR (rw) register accessor: GPDMA channel 6 alternate linked-list address register
