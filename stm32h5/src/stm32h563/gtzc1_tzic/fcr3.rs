...
impl W {
    ...
    #[inline(always)]
    pub fn clptim6f(&mut self) -> CLPTIM6F_W<FCR3rs> {
        CLPTIM6F_W::new(self, 0)
    }
    ///Bit 1 - clear illegal access flag for VREFBUF
    #[inline(always)]
    pub fn cvrefbuff(&mut self) -> CVREFBUFF_W<FCR3rs> {
    ...
    #[inline(always)]
    pub fn cethf(&mut self) -> CETHF_W<FCR3rs> {
        CETHF_W::new(self, 11)
    }
    ...
    #[inline(always)]
    pub fn cfmcf(&mut self) -> CFMCF_W<FCR3rs> {
        CFMCF_W::new(self, 23)
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#GTZC1_TZIC:FCR3)*/
pub struct FCR3rs;
