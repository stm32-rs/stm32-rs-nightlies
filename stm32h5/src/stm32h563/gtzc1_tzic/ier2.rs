...
impl W {
    ...
    ///Bit 24 - illegal access interrupt enable for SPI5
    #[inline(always)]
    pub fn spi5ie(&mut self) -> SPI5IE_W<IER2rs> {
    ...
    ///Bit 27 - illegal access interrupt enable for I2C4
    #[inline(always)]
    pub fn i2c4ie(&mut self) -> I2C4IE_W<IER2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#GTZC1_TZIC:IER2)*/
pub struct IER2rs;
