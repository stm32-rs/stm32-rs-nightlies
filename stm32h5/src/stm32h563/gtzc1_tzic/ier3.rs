...
impl W {
    ///Bit 0 - illegal access interrupt enable for LPTIM6
    #[inline(always)]
    pub fn lptim6ie(&mut self) -> LPTIM6IE_W<IER3rs> {
        LPTIM6IE_W::new(self, 0)
    }
    ///Bit 1 - illegal access interrupt enable for VREFBUF
    #[inline(always)]
    pub fn vrefbufie(&mut self) -> VREFBUFIE_W<IER3rs> {
    ...
    ///Bit 11 - illegal access interrupt enable for register of ETH
    #[inline(always)]
    pub fn ethie(&mut self) -> ETHIE_W<IER3rs> {
        ETHIE_W::new(self, 11)
    }
    ///Bit 12 - illegal access interrupt enable for ICACHE
    #[inline(always)]
    ...
    ///Bit 14 - illegal access interrupt enable for ADC1 and ADC2
    #[inline(always)]
    pub fn adc12ie(&mut self) -> ADC12IE_W<IER3rs> {
    ...
    ///Bit 23 - illegal access interrupt enable for FMC
    #[inline(always)]
    pub fn fmcie(&mut self) -> FMCIE_W<IER3rs> {
        FMCIE_W::new(self, 23)
    }
    ///Bit 24 - illegal access interrupt enable for OCTOSPI1
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#GTZC1_TZIC:IER3)*/
pub struct IER3rs;
