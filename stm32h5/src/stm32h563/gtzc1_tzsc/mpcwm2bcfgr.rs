#[doc = "Register `MPCWM2BCFGR` reader"]
pub type R = crate::R<MPCWM2BCFGRrs>;
#[doc = "Register `MPCWM2BCFGR` writer"]
...
#[doc = "GTZC1 TZSC memory 2 sub-region B watermark configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcwm2bcfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcwm2bcfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPCWM2BCFGRrs;
impl crate::RegisterSpec for MPCWM2BCFGRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpcwm2bcfgr::R`](R) reader structure"]
impl crate::Readable for MPCWM2BCFGRrs {}
#[doc = "`write(|w| ..)` method takes [`mpcwm2bcfgr::W`](W) writer structure"]
impl crate::Writable for MPCWM2BCFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPCWM2BCFGR to value 0"]
