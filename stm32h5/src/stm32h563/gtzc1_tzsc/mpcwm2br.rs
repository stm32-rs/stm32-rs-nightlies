#[doc = "Register `MPCWM2BR` reader"]
pub type R = crate::R<MPCWM2BRrs>;
#[doc = "Register `MPCWM2BR` writer"]
...
#[doc = "GTZC1 TZSC memory 2 sub-region B watermark register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcwm2br::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcwm2br::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPCWM2BRrs;
impl crate::RegisterSpec for MPCWM2BRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpcwm2br::R`](R) reader structure"]
impl crate::Readable for MPCWM2BRrs {}
#[doc = "`write(|w| ..)` method takes [`mpcwm2br::W`](W) writer structure"]
impl crate::Writable for MPCWM2BRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPCWM2BR to value 0"]
