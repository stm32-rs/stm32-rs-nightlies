#[doc = "Register `MPCWM3AR` reader"]
pub type R = crate::R<MPCWM3ARrs>;
#[doc = "Register `MPCWM3AR` writer"]
...
#[doc = "GTZC1 TZSC memory 3 sub-region A watermark register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcwm3ar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcwm3ar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPCWM3ARrs;
impl crate::RegisterSpec for MPCWM3ARrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpcwm3ar::R`](R) reader structure"]
impl crate::Readable for MPCWM3ARrs {}
#[doc = "`write(|w| ..)` method takes [`mpcwm3ar::W`](W) writer structure"]
impl crate::Writable for MPCWM3ARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPCWM3AR to value 0"]
