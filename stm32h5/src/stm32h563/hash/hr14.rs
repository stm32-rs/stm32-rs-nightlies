...
#[doc = "HASH digest register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hr14::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HR14rs;
impl crate::RegisterSpec for HR14rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hr14::R`](R) reader structure"]
impl crate::Readable for HR14rs {}
#[doc = "`reset()` method sets HR14 to value 0"]
