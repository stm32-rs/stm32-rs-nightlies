...
///Field `CAPPEND` reader - IBI MDB support for pending read notification This bit is written by software during bus initialization (i.e. I3C_CFGR.EN=0) and indicates the support (or not) of the pending read notification via the IBI MDB\[7:0\] value. This bit is used to return the GETCAP3 byte in response to the GETCAPS CCC format 1.
pub type CAPPEND_R = crate::BitReader;
///Field `CAPPEND` writer - IBI MDB support for pending read notification This bit is written by software during bus initialization (i.e. I3C_CFGR.EN=0) and indicates the support (or not) of the pending read notification via the IBI MDB\[7:0\] value. This bit is used to return the GETCAP3 byte in response to the GETCAPS CCC format 1.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#I3C:GETCAPR)*/
