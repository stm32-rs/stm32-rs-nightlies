#[doc = "Register `CRR1` reader"]
pub type R = crate::R<CRR1rs>;
#[doc = "Register `CRR1` writer"]
...
#[doc = "ICACHE region 1 configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`crr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`crr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CRR1rs;
impl crate::RegisterSpec for CRR1rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`crr1::R`](R) reader structure"]
impl crate::Readable for CRR1rs {}
#[doc = "`write(|w| ..)` method takes [`crr1::W`](W) writer structure"]
impl crate::Writable for CRR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRR1 to value 0x0200"]
