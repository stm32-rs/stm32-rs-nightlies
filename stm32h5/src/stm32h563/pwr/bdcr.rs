...
///Field `BREN` reader - Backup RAM retention in Standby and Vsub BAT/sub modes When this bit set, the backup regulator (used to maintain the backup RAM content in Standby and Vsub BAT/sub modes) is enabled. If BREN is cleared, the backup regulator is switched off. The backup RAM can still be used in Run and Stop modes. However its content is lost in Standby and Vsub BAT/sub modes. If BREN is set, the application must wait till the backup regulator ready flag (BRRDY) is set to indicate that the data written into the SRAM is maintained in Standby and Vsub BAT/sub modes.
...
///Field `BREN` writer - Backup RAM retention in Standby and Vsub BAT/sub modes When this bit set, the backup regulator (used to maintain the backup RAM content in Standby and Vsub BAT/sub modes) is enabled. If BREN is cleared, the backup regulator is switched off. The backup RAM can still be used in Run and Stop modes. However its content is lost in Standby and Vsub BAT/sub modes. If BREN is set, the application must wait till the backup regulator ready flag (BRRDY) is set to indicate that the data written into the SRAM is maintained in Standby and Vsub BAT/sub modes.
...
///Field `VBE` reader - Vsub BAT/sub charging enable Note: Reset only by POR,.
...
///Field `VBE` writer - Vsub BAT/sub charging enable Note: Reset only by POR,.
...
///Field `VBRS` reader - Vsub BAT/sub charging resistor selection
...
///Field `VBRS` writer - Vsub BAT/sub charging resistor selection
...
impl R {
    ///Bit 0 - Backup RAM retention in Standby and Vsub BAT/sub modes When this bit set, the backup regulator (used to maintain the backup RAM content in Standby and Vsub BAT/sub modes) is enabled. If BREN is cleared, the backup regulator is switched off. The backup RAM can still be used in Run and Stop modes. However its content is lost in Standby and Vsub BAT/sub modes. If BREN is set, the application must wait till the backup regulator ready flag (BRRDY) is set to indicate that the data written into the SRAM is maintained in Standby and Vsub BAT/sub modes.
    #[inline(always)]
    ...
    ///Bit 8 - Vsub BAT/sub charging enable Note: Reset only by POR,.
    #[inline(always)]
    pub fn vbe(&self) -> VBE_R {
        VBE_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Vsub BAT/sub charging resistor selection
    #[inline(always)]
