...
/**Vsub BAT/sub level monitoring versus low threshold
...
///Field `VBATL` reader - Vsub BAT/sub level monitoring versus low threshold
...
/**Vsub BAT/sub level monitoring versus high threshold
...
///Field `VBATH` reader - Vsub BAT/sub level monitoring versus high threshold
...
impl R {
    ...
    ///Bit 20 - Vsub BAT/sub level monitoring versus low threshold
    #[inline(always)]
    pub fn vbatl(&self) -> VBATL_R {
        VBATL_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - Vsub BAT/sub level monitoring versus high threshold
    #[inline(always)]
