...
/**peripheral voltage monitor on Vsub DDA/sub enable
...
///Field `AVDEN` reader - peripheral voltage monitor on Vsub DDA/sub enable
...
///Field `AVDEN` writer - peripheral voltage monitor on Vsub DDA/sub enable
...
impl R {
    ...
    ///Bit 8 - peripheral voltage monitor on Vsub DDA/sub enable
    #[inline(always)]
