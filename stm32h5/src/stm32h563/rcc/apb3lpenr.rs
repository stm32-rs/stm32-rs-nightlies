...
impl W {
    ...
    ///Bit 5 - SPI5 clock enable during Slsleepeep mode Set and reset by software.
    #[inline(always)]
    pub fn spi5lpen(&mut self) -> SPI5LPEN_W<'_, APB3LPENRrs> {
    ...
    ///Bit 8 - I2C4 clock enable during sleep mode Set and reset by software.
    #[inline(always)]
    pub fn i2c4lpen(&mut self) -> I2C4LPEN_W<'_, APB3LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#RCC:APB3LPENR)*/
