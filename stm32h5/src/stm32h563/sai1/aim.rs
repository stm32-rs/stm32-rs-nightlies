...
/**Wrong clock configuration interrupt enable. This bit is set and cleared by software. This bit is taken into account only if the audio block is configured as a master (MODE\[1\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#SAI1:AIM)*/
pub struct AIMrs;
