...
///Field `RESPCMD` reader - Response command index Read-only bit field. Contains the command index of the last command response received.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#SDMMC1:RESPCMDR)*/
