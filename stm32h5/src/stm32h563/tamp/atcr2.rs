...
///Field `ATOSEL1` reader - Active tamper shared output 1 selection The selected output must be available in the package pinout. Bits 9:8 are the mirror of ATOSEL1\[1:0\] in the TAMP_ATCR1, and so can also be read or written through TAMP_ATCR1.
pub type ATOSEL1_R = crate::FieldReader;
///Field `ATOSEL1` writer - Active tamper shared output 1 selection The selected output must be available in the package pinout. Bits 9:8 are the mirror of ATOSEL1\[1:0\] in the TAMP_ATCR1, and so can also be read or written through TAMP_ATCR1.
pub type ATOSEL1_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `ATOSEL2` reader - Active tamper shared output 2 selection The selected output must be available in the package pinout. Bits 12:11 are the mirror of ATOSEL2\[1:0\] in the TAMP_ATCR1, and so can also be read or written through TAMP_ATCR1.
pub type ATOSEL2_R = crate::FieldReader;
///Field `ATOSEL2` writer - Active tamper shared output 2 selection The selected output must be available in the package pinout. Bits 12:11 are the mirror of ATOSEL2\[1:0\] in the TAMP_ATCR1, and so can also be read or written through TAMP_ATCR1.
pub type ATOSEL2_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `ATOSEL3` reader - Active tamper shared output 3 selection The selected output must be available in the package pinout. Bits 15:14 are the mirror of ATOSEL3\[1:0\] in the TAMP_ATCR1, and so can also be read or written through TAMP_ATCR1.
pub type ATOSEL3_R = crate::FieldReader;
///Field `ATOSEL3` writer - Active tamper shared output 3 selection The selected output must be available in the package pinout. Bits 15:14 are the mirror of ATOSEL3\[1:0\] in the TAMP_ATCR1, and so can also be read or written through TAMP_ATCR1.
pub type ATOSEL3_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `ATOSEL4` reader - Active tamper shared output 4 selection The selected output must be available in the package pinout. Bits 18:17 are the mirror of ATOSEL2\[1:0\] in the TAMP_ATCR1, and so can also be read or written through TAMP_ATCR1.
pub type ATOSEL4_R = crate::FieldReader;
///Field `ATOSEL4` writer - Active tamper shared output 4 selection The selected output must be available in the package pinout. Bits 18:17 are the mirror of ATOSEL2\[1:0\] in the TAMP_ATCR1, and so can also be read or written through TAMP_ATCR1.
...
impl W {
    ...
    ///Bits 29:31 - Active tamper shared output 8 selection The selected output must be available in the package pinout.
    #[inline(always)]
    pub fn atosel8(&mut self) -> ATOSEL8_W<'_, ATCR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#TAMP:ATCR2)*/
pub struct ATCR2rs;
