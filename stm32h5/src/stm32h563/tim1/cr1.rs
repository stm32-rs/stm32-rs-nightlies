...
///Field `CKD` reader - Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t&lt;sub>DTS&lt;/sub>)used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),
...
///Field `CKD` writer - Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t&lt;sub>DTS&lt;/sub>)used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),
