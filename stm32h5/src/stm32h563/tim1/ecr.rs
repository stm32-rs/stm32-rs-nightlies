...
/**Field `PW` reader - Pulse width This bitfield defines the pulse duration, as following: tsub PW/sub = PW\[7:0\]
x tsub PWG/sub*/
pub type PW_R = crate::FieldReader;
/**Field `PW` writer - Pulse width This bitfield defines the pulse duration, as following: tsub PW/sub = PW\[7:0\]
x tsub PWG/sub*/
...
impl R {
    ...
    /**Bits 16:23 - Pulse width This bitfield defines the pulse duration, as following: tsub PW/sub = PW\[7:0\]
    x tsub PWG/sub*/
    #[inline(always)]
    pub fn pw(&self) -> PW_R {
