...
/**COM interrupt flag This flag is set by hardware on COM event (when capture/compare Control bitsCCxE, CCxNE, OCxMhave been updated). It is cleared by software.
...
///Field `COMIF` reader - COM interrupt flag This flag is set by hardware on COM event (when capture/compare Control bitsCCxE, CCxNE, OCxMhave been updated). It is cleared by software.
...
///Field `COMIF` writer - COM interrupt flag This flag is set by hardware on COM event (when capture/compare Control bitsCCxE, CCxNE, OCxMhave been updated). It is cleared by software.
...
impl R {
    ...
    ///Bit 5 - COM interrupt flag This flag is set by hardware on COM event (when capture/compare Control bitsCCxE, CCxNE, OCxMhave been updated). It is cleared by software.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H563.html#TIM1:SR)*/
pub struct SRrs;
