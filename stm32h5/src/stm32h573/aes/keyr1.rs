...
///Field `KEY` writer - Cryptographic key, bits \[63:32\] Refer to the AES_KEYR0 register for description of the KEY\[255:0\] bitfield.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#AES:KEYR1)*/
pub struct KEYR1rs;
