...
///Field `KEY` writer - Cryptographic key, bits \[159:128\] Refer to the AES_KEYR0 register for description of the KEY\[255:0\] bitfield.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#AES:KEYR4)*/
pub struct KEYR4rs;
