...
///Field `DACC2DHRB` reader - DAC channel2 12-bit right-aligned data These bits are written by software. They specify 12-bit data for DAC channel2 when the DAC operates in DMA Double data mode.
pub type DACC2DHRB_R = crate::FieldReader<u16>;
///Field `DACC2DHRB` writer - DAC channel2 12-bit right-aligned data These bits are written by software. They specify 12-bit data for DAC channel2 when the DAC operates in DMA Double data mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#DAC:DHR12R2)*/
