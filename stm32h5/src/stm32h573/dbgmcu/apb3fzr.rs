...
///Field `DBG_I2C4_STOP` reader - I2C4 SMBUS timeout stop in debug
pub type DBG_I2C4_STOP_R = crate::BitReader;
///Field `DBG_I2C4_STOP` writer - I2C4 SMBUS timeout stop in debug
...
///Field `DBG_LPTIM6_STOP` reader - LPTIM6 stop in debug
pub type DBG_LPTIM6_STOP_R = crate::BitReader;
///Field `DBG_LPTIM6_STOP` writer - LPTIM6 stop in debug
...
impl W {
    ///Bit 10 - I2C3 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c3_stop(&mut self) -> DBG_I2C3_STOP_W<'_, APB3FZRrs> {
        DBG_I2C3_STOP_W::new(self, 10)
    }
    ///Bit 11 - I2C4 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c4_stop(&mut self) -> DBG_I2C4_STOP_W<'_, APB3FZRrs> {
    ...
    ///Bit 18 - LPTIM3 stop in debug
    #[inline(always)]
    pub fn dbg_lptim3_stop(&mut self) -> DBG_LPTIM3_STOP_W<'_, APB3FZRrs> {
        DBG_LPTIM3_STOP_W::new(self, 18)
    }
    ///Bit 19 - LPTIM4 stop in debug
    #[inline(always)]
    pub fn dbg_lptim4_stop(&mut self) -> DBG_LPTIM4_STOP_W<'_, APB3FZRrs> {
        DBG_LPTIM4_STOP_W::new(self, 19)
    }
    ///Bit 20 - LPTIM5 stop in debug
    #[inline(always)]
    pub fn dbg_lptim5_stop(&mut self) -> DBG_LPTIM5_STOP_W<'_, APB3FZRrs> {
        DBG_LPTIM5_STOP_W::new(self, 20)
    }
    ///Bit 21 - LPTIM6 stop in debug
    #[inline(always)]
    pub fn dbg_lptim6_stop(&mut self) -> DBG_LPTIM6_STOP_W<'_, APB3FZRrs> {
