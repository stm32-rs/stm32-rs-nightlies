...
///Field `SA` reader - Source Address When this bit is set, the MAC Addressx\[47:0\] is used to compare with the SA fields of the received packet. When this bit is reset, the MAC Address x\[47:0\] is used to compare with the DA fields of the received packet.
pub type SA_R = crate::BitReader;
///Field `SA` writer - Source Address When this bit is set, the MAC Addressx\[47:0\] is used to compare with the SA fields of the received packet. When this bit is reset, the MAC Address x\[47:0\] is used to compare with the DA fields of the received packet.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#ETH:MACA1HR)*/
