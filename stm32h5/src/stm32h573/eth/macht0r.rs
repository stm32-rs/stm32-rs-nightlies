...
///Field `HT31T0` reader - MAC Hash Table First 32 Bits This field contains the first 32 Bits \[31:0\] of the Hash table.
pub type HT31T0_R = crate::FieldReader<u32>;
///Field `HT31T0` writer - MAC Hash Table First 32 Bits This field contains the first 32 Bits \[31:0\] of the Hash table.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#ETH:MACHT0R)*/
