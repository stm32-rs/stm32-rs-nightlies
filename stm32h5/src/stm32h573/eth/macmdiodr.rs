...
///Field `RA` reader - Register Address This field is valid only when C45E is set. It contains the Register Address in the PHY to which the MDIO frame is intended for.
pub type RA_R = crate::FieldReader<u16>;
///Field `RA` writer - Register Address This field is valid only when C45E is set. It contains the Register Address in the PHY to which the MDIO frame is intended for.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#ETH:MACMDIODR)*/
