...
///Field `MACRWKPFR` reader - Remote wakeup packet filter Refer to Table648, Table649 and Table650 for details on register content and programming sequence.
pub type MACRWKPFR_R = crate::FieldReader<u32>;
///Field `MACRWKPFR` writer - Remote wakeup packet filter Refer to Table648, Table649 and Table650 for details on register content and programming sequence.
pub type MACRWKPFR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Remote wakeup packet filter Refer to Table648, Table649 and Table650 for details on register content and programming sequence.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#ETH:MACRWKPFR)*/
