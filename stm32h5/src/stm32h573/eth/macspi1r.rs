...
/**Field `SPI1` reader - Source Port Identity 1 This field indicates bits \[63:32\]
of sourcePortIdentity of PTP node.*/
pub type SPI1_R = crate::FieldReader<u32>;
/**Field `SPI1` writer - Source Port Identity 1 This field indicates bits \[63:32\]
of sourcePortIdentity of PTP node.*/
pub type SPI1_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    /**Bits 0:31 - Source Port Identity 1 This field indicates bits \[63:32\]
    of sourcePortIdentity of PTP node.*/
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#ETH:MACSPI1R)*/
