...
///Field `TSS` reader - Timestamp Seconds The value in this field is the seconds part of the update.
pub type TSS_R = crate::FieldReader<u32>;
///Field `TSS` writer - Timestamp Seconds The value in this field is the seconds part of the update.
pub type TSS_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Timestamp Seconds The value in this field is the seconds part of the update.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#ETH:MACSTSUR)*/
