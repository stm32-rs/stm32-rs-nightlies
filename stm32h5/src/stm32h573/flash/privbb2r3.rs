...
pub type R = crate::R<PRIVBB2R3rs>;
///Register `PRIVBB2R3` writer
pub type W = crate::W<PRIVBB2R3rs>;
...
impl W {
    ///Bits 0:31 - Privileged / non-privileged 8-Kbyte flash Bank 2 sector attribute
    #[inline(always)]
    pub fn privbb2(&mut self) -> PRIVBB2_W<'_, PRIVBB2R3rs> {
        PRIVBB2_W::new(self, 0)
    }
}
/**FLASH privilege block-based register for Bank 2

You can [`read`](crate::Reg::read) this register and get [`privbb2r3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`privbb2r3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#FLASH:PRIVBB2R3)*/
pub struct PRIVBB2R3rs;
impl crate::RegisterSpec for PRIVBB2R3rs {
    type Ux = u32;
}
///`read()` method returns [`privbb2r3::R`](R) reader structure
impl crate::Readable for PRIVBB2R3rs {}
///`write(|w| ..)` method takes [`privbb2r3::W`](W) writer structure
impl crate::Writable for PRIVBB2R3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PRIVBB2R3 to value 0
impl crate::Resettable for PRIVBB2R3rs {}
