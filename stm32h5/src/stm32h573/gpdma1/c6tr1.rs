...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pam_1(&mut self) -> PAM_1_W<C6TR1rs> {
        PAM_1_W::new(self, 11)
    }
    ///Bits 11:12 - PAM value when source data width is higher than destination data width
    #[inline(always)]
    #[must_use]
    pub fn pam_2(&mut self) -> PAM_2_W<C6TR1rs> {
        PAM_2_W::new(self, 11)
    }
    ///Bit 13 - source byte exchange within the unaligned half-word of each source word If the source data width is shorter than a word, this bit is ignored. If the source data width is a word:
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#GPDMA1:C6TR1)*/
pub struct C6TR1rs;
