///Register `C7TR3` reader
pub type R = crate::R<C7TR3rs>;
///Register `C7TR3` writer
pub type W = crate::W<C7TR3rs>;
...
impl W {
    ...
    is not applied.*/
    #[inline(always)]
    pub fn sao(&mut self) -> SAO_W<C7TR3rs> {
        SAO_W::new(self, 0)
    }
    /**Bits 16:28 - destination address offset increment The destination address, pointed by GPDMA_CxDAR, is incremented or decremented (depending on GPDMA_CxBR1.DDEC) by this offset DAO\[12:0\]
    for each programmed destination burst. This offset is not including and is added to the programmed burst size when the completed burst is addressed in incremented mode (GPDMA_CxTR1.DINC = 1). Note: A destination address offset must be aligned with the programmed data width of a destination burst (DAO\[2:0\]
    versus GPDMA_CxTR1.DDW_LOG2\[1:0\]). Else, a user setting error is reported and no transfer is issued.*/
    #[inline(always)]
    pub fn dao(&mut self) -> DAO_W<C7TR3rs> {
        DAO_W::new(self, 16)
    }
}
/**GPDMA channel 7 transfer register 3

You can [`read`](crate::Reg::read) this register and get [`c7tr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c7tr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#GPDMA1:C7TR3)*/
pub struct C7TR3rs;
impl crate::RegisterSpec for C7TR3rs {
    type Ux = u32;
}
///`read()` method returns [`c7tr3::R`](R) reader structure
impl crate::Readable for C7TR3rs {}
///`write(|w| ..)` method takes [`c7tr3::W`](W) writer structure
impl crate::Writable for C7TR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets C7TR3 to value 0
impl crate::Resettable for C7TR3rs {
