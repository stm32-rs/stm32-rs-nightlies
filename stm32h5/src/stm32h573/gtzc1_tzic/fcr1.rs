...
impl W {
    ...
    #[inline(always)]
    pub fn ci3c1f(&mut self) -> CI3C1F_W<FCR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#GTZC1_TZIC:FCR1)*/
pub struct FCR1rs;
