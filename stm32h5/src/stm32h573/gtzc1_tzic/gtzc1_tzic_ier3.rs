...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GTZC1_TZIC_IER3")
...
impl W {
    ...
    ///Bit 16 - illegal access interrupt enable for AES
    #[inline(always)]
    pub fn aesie(&mut self) -> AESIE_W<GTZC1_TZIC_IER3rs> {
        AESIE_W::new(self, 16)
    }
    ///Bit 17 - illegal access interrupt enable for HASH
    #[inline(always)]
    ...
    ///Bit 19 - illegal access interrupt enable for SAES
    #[inline(always)]
    pub fn saesie(&mut self) -> SAESIE_W<GTZC1_TZIC_IER3rs> {
        SAESIE_W::new(self, 19)
    }
    ///Bit 20 - illegal access interrupt enable for PKA
    #[inline(always)]
    pub fn pkaie(&mut self) -> PKAIE_W<GTZC1_TZIC_IER3rs> {
        PKAIE_W::new(self, 20)
    }
    ///Bit 21 - illegal access interrupt enable for SDMMC2
    #[inline(always)]
...
You can [`read`](crate::Reg::read) this register and get [`gtzc1_tzic_ier3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gtzc1_tzic_ier3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#GTZC1_TZIC:GTZC1_TZIC_IER3)*/
