///Register `GTZC1_TZIC_SR1` reader
...
///Field `TIM13F` reader - illegal access flag for TIM13
pub type TIM13F_R = crate::BitReader;
///Field `TIM14F` reader - illegal access flag for TIM14
...
impl R {
    ...
    ///Bit 7 - illegal access flag for TIM13
    #[inline(always)]
    pub fn tim13f(&self) -> TIM13F_R {
        TIM13F_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - illegal access flag for TIM14
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GTZC1_TZIC_SR1")
            ...
            .field("tim13f", &self.tim13f())
            .field("tim14f", &self.tim14f())
...
You can [`read`](crate::Reg::read) this register and get [`gtzc1_tzic_sr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#GTZC1_TZIC:GTZC1_TZIC_SR1)*/
pub struct GTZC1_TZIC_SR1rs;
impl crate::RegisterSpec for GTZC1_TZIC_SR1rs {
    type Ux = u32;
}
///`read()` method returns [`gtzc1_tzic_sr1::R`](R) reader structure
impl crate::Readable for GTZC1_TZIC_SR1rs {}
///`reset()` method sets GTZC1_TZIC_SR1 to value 0
