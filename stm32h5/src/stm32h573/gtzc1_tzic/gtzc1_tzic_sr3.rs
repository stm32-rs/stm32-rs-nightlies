...
///Field `SDMMC2F` reader - illegal access flag for SDMMC2
...
impl R {
    ...
    ///Bit 21 - illegal access flag for SDMMC2
    #[inline(always)]
...
You can [`read`](crate::Reg::read) this register and get [`gtzc1_tzic_sr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#GTZC1_TZIC:GTZC1_TZIC_SR3)*/
