...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IER1")
            ...
            .field("tim12ie", &self.tim12ie())
            .field("tim13ie", &self.tim13ie())
            .field("tim14ie", &self.tim14ie())
            ...
            .field("i3c1ie", &self.i3c1ie())
            .field("crsie", &self.crsie())
            .field("usart6ie", &self.usart6ie())
            .field("usart10ie", &self.usart10ie())
            .field("usart11ie", &self.usart11ie())
            .field("hdmicecie", &self.hdmicecie())
            .field("dac1ie", &self.dac1ie())
            .field("uart7ie", &self.uart7ie())
            .field("uart8ie", &self.uart8ie())
            .field("uart9ie", &self.uart9ie())
            .field("uart12ie", &self.uart12ie())
            .field("dtsie", &self.dtsie())
...
impl W {
    ...
    ///Bit 6 - illegal access interrupt enable for TIM12
    #[inline(always)]
    pub fn tim12ie(&mut self) -> TIM12IE_W<'_, IER1rs> {
        TIM12IE_W::new(self, 6)
    }
    ///Bit 7 - illegal access interrupt enable for TIM13
    #[inline(always)]
    pub fn tim13ie(&mut self) -> TIM13IE_W<'_, IER1rs> {
        TIM13IE_W::new(self, 7)
    }
    ///Bit 8 - illegal access interrupt enable for TIM14
    #[inline(always)]
    pub fn tim14ie(&mut self) -> TIM14IE_W<'_, IER1rs> {
    ...
    ///Bit 19 - illegal access interrupt enable for I3C1
    #[inline(always)]
    pub fn i3c1ie(&mut self) -> I3C1IE_W<'_, IER1rs> {
    ...
    ///Bit 21 - illegal access interrupt enable for USART6
    #[inline(always)]
    pub fn usart6ie(&mut self) -> USART6IE_W<'_, IER1rs> {
        USART6IE_W::new(self, 21)
    }
    ///Bit 22 - illegal access interrupt enable for USART10
    #[inline(always)]
    pub fn usart10ie(&mut self) -> USART10IE_W<'_, IER1rs> {
        USART10IE_W::new(self, 22)
    }
    ///Bit 23 - illegal access interrupt enable for USART11
    #[inline(always)]
    pub fn usart11ie(&mut self) -> USART11IE_W<'_, IER1rs> {
        USART11IE_W::new(self, 23)
    }
    ///Bit 24 - illegal access interrupt enable for HDMICEC
    #[inline(always)]
    pub fn hdmicecie(&mut self) -> HDMICECIE_W<'_, IER1rs> {
        HDMICECIE_W::new(self, 24)
    }
    ///Bit 25 - illegal access interrupt enable for DAC1
    #[inline(always)]
    pub fn dac1ie(&mut self) -> DAC1IE_W<'_, IER1rs> {
        DAC1IE_W::new(self, 25)
    }
    ///Bit 26 - illegal access interrupt enable for UART7
    #[inline(always)]
    pub fn uart7ie(&mut self) -> UART7IE_W<'_, IER1rs> {
        UART7IE_W::new(self, 26)
    }
    ///Bit 27 - illegal access interrupt enable for UART8
    #[inline(always)]
    pub fn uart8ie(&mut self) -> UART8IE_W<'_, IER1rs> {
        UART8IE_W::new(self, 27)
    }
    ///Bit 28 - illegal access interrupt enable for UART9
    #[inline(always)]
    pub fn uart9ie(&mut self) -> UART9IE_W<'_, IER1rs> {
        UART9IE_W::new(self, 28)
    }
    ///Bit 29 - illegal access interrupt enable for UART12
    #[inline(always)]
    pub fn uart12ie(&mut self) -> UART12IE_W<'_, IER1rs> {
        UART12IE_W::new(self, 29)
    }
    ///Bit 30 - illegal access interrupt enable for DTS
    #[inline(always)]
    pub fn dtsie(&mut self) -> DTSIE_W<'_, IER1rs> {
        DTSIE_W::new(self, 30)
    }
    ///Bit 31 - illegal access interrupt enable for LPTIM2
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#GTZC1_TZIC:IER1)*/
pub struct IER1rs;
