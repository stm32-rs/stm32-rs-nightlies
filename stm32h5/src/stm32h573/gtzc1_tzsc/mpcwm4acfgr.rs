#[doc = "Register `MPCWM4ACFGR` reader"]
pub type R = crate::R<MPCWM4ACFGRrs>;
#[doc = "Register `MPCWM4ACFGR` writer"]
...
#[doc = "GTZC1 TZSC memory 4 sub-region A watermark configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcwm4acfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcwm4acfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPCWM4ACFGRrs;
impl crate::RegisterSpec for MPCWM4ACFGRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpcwm4acfgr::R`](R) reader structure"]
impl crate::Readable for MPCWM4ACFGRrs {}
#[doc = "`write(|w| ..)` method takes [`mpcwm4acfgr::W`](W) writer structure"]
impl crate::Writable for MPCWM4ACFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPCWM4ACFGR to value 0"]
