...
///Field `ETHLPEN` reader - ETH clock enable during Sleep mode Set and reset by software
pub use GPDMA1LPEN_R as ETHLPEN_R;
///Field `ETHTXLPEN` reader - ETHTX clock enable during sleep mode Set and reset by software
pub use GPDMA1LPEN_R as ETHTXLPEN_R;
///Field `ETHRXLPEN` reader - ETHRX clock enable during sleep mode Set and reset by software
pub use GPDMA1LPEN_R as ETHRXLPEN_R;
...
///Field `ETHLPEN` writer - ETH clock enable during Sleep mode Set and reset by software
pub use GPDMA1LPEN_W as ETHLPEN_W;
///Field `ETHTXLPEN` writer - ETHTX clock enable during sleep mode Set and reset by software
pub use GPDMA1LPEN_W as ETHTXLPEN_W;
///Field `ETHRXLPEN` writer - ETHRX clock enable during sleep mode Set and reset by software
pub use GPDMA1LPEN_W as ETHRXLPEN_W;
...
impl R {
    ...
    ///Bit 19 - ETH clock enable during Sleep mode Set and reset by software
    #[inline(always)]
    pub fn ethlpen(&self) -> ETHLPEN_R {
        ETHLPEN_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 20 - ETHTX clock enable during sleep mode Set and reset by software
    #[inline(always)]
    pub fn ethtxlpen(&self) -> ETHTXLPEN_R {
        ETHTXLPEN_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - ETHRX clock enable during sleep mode Set and reset by software
    #[inline(always)]
...
impl W {
    ...
    ///Bit 14 - CORDIC clock enable during sleep mode Set and reset by software.
    #[inline(always)]
    pub fn cordiclpen(&mut self) -> CORDICLPEN_W<AHB1LPENRrs> {
        CORDICLPEN_W::new(self, 14)
    }
    ///Bit 15 - FMAC clock enable during sleep mode Set and reset by software.
    #[inline(always)]
    pub fn fmaclpen(&mut self) -> FMACLPEN_W<AHB1LPENRrs> {
    ...
    ///Bit 19 - ETH clock enable during Sleep mode Set and reset by software
    #[inline(always)]
    pub fn ethlpen(&mut self) -> ETHLPEN_W<AHB1LPENRrs> {
        ETHLPEN_W::new(self, 19)
    }
    ///Bit 20 - ETHTX clock enable during sleep mode Set and reset by software
    #[inline(always)]
    pub fn ethtxlpen(&mut self) -> ETHTXLPEN_W<AHB1LPENRrs> {
        ETHTXLPEN_W::new(self, 20)
    }
    ///Bit 21 - ETHRX clock enable during sleep mode Set and reset by software
    #[inline(always)]
    pub fn ethrxlpen(&mut self) -> ETHRXLPEN_W<AHB1LPENRrs> {
        ETHRXLPEN_W::new(self, 21)
    }
    ///Bit 24 - TZSC1 clock enable during sleep mode Set and reset by software
    #[inline(always)]
    pub fn tzsc1lpen(&mut self) -> TZSC1LPEN_W<AHB1LPENRrs> {
    ...
    ///Bit 30 - DCACHE clock enable during sleep mode Set and reset by software
    #[inline(always)]
    pub fn dcachelpen(&mut self) -> DCACHELPEN_W<AHB1LPENRrs> {
