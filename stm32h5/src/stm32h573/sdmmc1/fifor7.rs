///Register `FIFOR7` reader
pub type R = crate::R<FIFOR7rs>;
///Register `FIFOR7` writer
...
You can [`read`](crate::Reg::read) this register and get [`fifor7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fifor7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#SDMMC1:FIFOR7)*/
pub struct FIFOR7rs;
impl crate::RegisterSpec for FIFOR7rs {
    type Ux = u32;
}
///`read()` method returns [`fifor7::R`](R) reader structure
impl crate::Readable for FIFOR7rs {}
///`write(|w| ..)` method takes [`fifor7::W`](W) writer structure
