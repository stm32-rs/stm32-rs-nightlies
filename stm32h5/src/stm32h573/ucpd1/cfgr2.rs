...
///Field `RXAFILTEN` reader - Rx analog filter enable Setting the bit enables the Rx analog filter required for optimum Power Delivery reception.
pub use WUPEN_R as RXAFILTEN_R;
///Field `RXAFILTEN` writer - Rx analog filter enable Setting the bit enables the Rx analog filter required for optimum Power Delivery reception.
pub use WUPEN_W as RXAFILTEN_W;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H573.html#UCPD1:CFGR2)*/
pub struct CFGR2rs;
