...
pub enum TSEL1 {
    ...
    ///13: EXTI line 9
    Exti9 = 13,
    ///14: Timer 23 TRGO event
    Tim23trgo = 14,
    ///15: Timer 24 TRGO event
    Tim24trgo = 15,
}
...
impl TSEL1_R {
    ...
    pub const fn variant(&self) -> Option<TSEL1> {
        match self.bits {
            ...
            11 => Some(TSEL1::Lptim1out),
            12 => Some(TSEL1::Lptim2out),
            13 => Some(TSEL1::Exti9),
            14 => Some(TSEL1::Tim23trgo),
            15 => Some(TSEL1::Tim24trgo),
            _ => None,
        }
    }
    ///Software trigger
    ...
    ///LPTIM1 OUT event
    #[inline(always)]
    pub fn is_lptim1out(&self) -> bool {
        *self == TSEL1::Lptim1out
    }
    ///LPTIM2 OUT event
    #[inline(always)]
    pub fn is_lptim2out(&self) -> bool {
    ...
    ///Timer 23 TRGO event
    #[inline(always)]
    pub fn is_tim23trgo(&self) -> bool {
        *self == TSEL1::Tim23trgo
    }
    ///Timer 24 TRGO event
    #[inline(always)]
    pub fn is_tim24trgo(&self) -> bool {
        *self == TSEL1::Tim24trgo
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    ///LPTIM1 OUT event
    #[inline(always)]
    pub fn lptim1out(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Lptim1out)
    }
    ///LPTIM2 OUT event
    #[inline(always)]
    pub fn lptim2out(self) -> &'a mut crate::W<REG> {
    ...
    ///Timer 23 TRGO event
    #[inline(always)]
    pub fn tim23trgo(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Tim23trgo)
    }
    ///Timer 24 TRGO event
    #[inline(always)]
    pub fn tim24trgo(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Tim24trgo)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H723.html#DAC:CR)*/
pub struct CRrs;
