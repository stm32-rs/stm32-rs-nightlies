...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H723.html#DBGMCU:IDC)*/
pub struct IDCrs;
...
///`reset()` method sets IDC to value 0x1000_0483
impl crate::Resettable for IDCrs {
    const RESET_VALUE: u32 = 0x1000_0483;
}
