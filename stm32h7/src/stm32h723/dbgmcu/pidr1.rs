...
///Field `PARTNUM` reader - Part number field, bits \[11:8\]
pub type PARTNUM_R = crate::FieldReader;
///Field `JEP106ID` reader - JEP106 identity code field, bits \[3:0\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H723.html#DBGMCU:PIDR1)*/
pub struct PIDR1rs;
