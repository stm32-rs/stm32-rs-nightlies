...
impl W {
    ///Bit 17 - Configurable event inputs x+32 Pending bit
    #[inline(always)]
    pub fn pr49(&mut self) -> PR49_W<CPUPR2rs> {
        PR49_W::new(self, 17)
    }
    ///Bit 19 - Configurable event inputs x+32 Pending bit
    #[inline(always)]
    pub fn pr51(&mut self) -> PR51_W<CPUPR2rs> {
        PR51_W::new(self, 19)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H723.html#EXTI:CPUPR2)*/
pub struct CPUPR2rs;
