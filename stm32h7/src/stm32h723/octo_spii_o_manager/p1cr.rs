...
///Field `CLKEN` reader - CLK/CLKn Enable for Port n
pub type CLKEN_R = crate::BitReader;
///Field `CLKEN` writer - CLK/CLKn Enable for Port n
pub type CLKEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLKSRC` reader - CLK/CLKn Source for Port n
pub type CLKSRC_R = crate::BitReader;
///Field `CLKSRC` writer - CLK/CLKn Source for Port n
...
impl W {
    ///Bit 0 - CLK/CLKn Enable for Port n
    #[inline(always)]
    pub fn clken(&mut self) -> CLKEN_W<'_, P1CRrs> {
        CLKEN_W::new(self, 0)
    }
    ///Bit 1 - CLK/CLKn Source for Port n
    #[inline(always)]
    pub fn clksrc(&mut self) -> CLKSRC_W<'_, P1CRrs> {
        CLKSRC_W::new(self, 1)
    }
    ///Bit 4 - DQSEN
    #[inline(always)]
    pub fn dqsen(&mut self) -> DQSEN_W<'_, P1CRrs> {
        DQSEN_W::new(self, 4)
    }
    ///Bit 5 - DQSSRC
    #[inline(always)]
    pub fn dqssrc(&mut self) -> DQSSRC_W<'_, P1CRrs> {
        DQSSRC_W::new(self, 5)
    }
    ///Bit 8 - NCSEN
    #[inline(always)]
    pub fn ncsen(&mut self) -> NCSEN_W<'_, P1CRrs> {
        NCSEN_W::new(self, 8)
    }
    ///Bit 9 - NCSSRC
    #[inline(always)]
    pub fn ncssrc(&mut self) -> NCSSRC_W<'_, P1CRrs> {
        NCSSRC_W::new(self, 9)
    }
    ///Bit 16 - IOLEN
    #[inline(always)]
    pub fn iolen(&mut self) -> IOLEN_W<'_, P1CRrs> {
        IOLEN_W::new(self, 16)
    }
    ///Bits 17:18 - IOLSRC
    #[inline(always)]
    pub fn iolsrc(&mut self) -> IOLSRC_W<'_, P1CRrs> {
        IOLSRC_W::new(self, 17)
    }
    ///Bit 24 - IOHEN
    #[inline(always)]
    pub fn iohen(&mut self) -> IOHEN_W<'_, P1CRrs> {
        IOHEN_W::new(self, 24)
    }
    ///Bits 25:26 - IOHSRC
    #[inline(always)]
    pub fn iohsrc(&mut self) -> IOHSRC_W<'_, P1CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H723.html#OctoSPII_O_Manager:P1CR)*/
pub struct P1CRrs;
