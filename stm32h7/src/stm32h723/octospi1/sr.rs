...
///Field `TEF` reader - Clear transfer error flag
...
///Field `TCF` reader - Clear transfer complete flag
...
///Field `SMF` reader - Clear status match flag
...
///Field `TOF` reader - Clear timeout flag
