...
impl W {
    ///Bit 0 - MDMA Peripheral Clock Enable
    #[inline(always)]
    pub fn mdmaen(&mut self) -> MDMAEN_W<C1_AHB3ENRrs> {
        MDMAEN_W::new(self, 0)
    }
    ///Bit 4 - DMA2D Peripheral Clock Enable
    #[inline(always)]
    pub fn dma2den(&mut self) -> DMA2DEN_W<C1_AHB3ENRrs> {
        DMA2DEN_W::new(self, 4)
    }
    ///Bit 12 - FMC Peripheral Clocks Enable
    #[inline(always)]
    pub fn fmcen(&mut self) -> FMCEN_W<C1_AHB3ENRrs> {
        FMCEN_W::new(self, 12)
    }
    ///Bit 14 - OCTOSPI1 and OCTOSPI1 delay clock enable
    #[inline(always)]
    pub fn octospi1en(&mut self) -> OCTOSPI1EN_W<C1_AHB3ENRrs> {
        OCTOSPI1EN_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1 and SDMMC1 Delay Clock Enable
    #[inline(always)]
    pub fn sdmmc1en(&mut self) -> SDMMC1EN_W<C1_AHB3ENRrs> {
        SDMMC1EN_W::new(self, 16)
    }
    ///Bit 19 - OCTOSPI2 clock enable Set and reset by software.
    #[inline(always)]
    pub fn octospi2en(&mut self) -> OCTOSPI2EN_W<C1_AHB3ENRrs> {
        OCTOSPI2EN_W::new(self, 19)
    }
    ///Bit 21 - OCTOSPIM clock enable Set and reset by software.
    #[inline(always)]
    pub fn iomngren(&mut self) -> IOMNGREN_W<C1_AHB3ENRrs> {
        IOMNGREN_W::new(self, 21)
    }
    ///Bit 22 - OTFD1 clock enable Set and reset by software.
    #[inline(always)]
    pub fn otfd1en(&mut self) -> OTFD1EN_W<C1_AHB3ENRrs> {
        OTFD1EN_W::new(self, 22)
    }
    ///Bit 23 - OTFD2 clock enable Set and reset by software.
    #[inline(always)]
    pub fn otfd2en(&mut self) -> OTFD2EN_W<C1_AHB3ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H723.html#RCC:C1_AHB3ENR)*/
