...
/**CR1 (rw) register accessor: Configuration register 1
...
pub mod cr1;
/**CR2 (rw) register accessor: Configuration register 2
...
pub mod cr2;
/**FRCR (rw) register accessor: This register has no meaning in AC97 and SPDIF audio protocol
...
pub mod frcr;
/**SLOTR (rw) register accessor: This register has no meaning in AC97 and SPDIF audio protocol
...
///This register has no meaning in AC97 and SPDIF audio protocol
pub mod slotr;
/**IM (rw) register accessor: Interrupt mask register 2
