...
/**ISR (r) register accessor: BDMA interrupt status register

You can [`read`](crate::Reg::read) this register and get [`isr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H725.html#BDMA:ISR)

For information about available fields see [`mod@isr`] module*/
pub type ISR = crate::Reg<isr::ISRrs>;
///BDMA interrupt status register
pub mod isr;
/**IFCR (w) register accessor: BDMA interrupt flag clear register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H725.html#BDMA:IFCR)
