...
///Field `I2C5` reader - I2C5 SMBUS timeout stop in debug
pub type I2C5_R = crate::BitReader;
///Field `I2C5` writer - I2C5 SMBUS timeout stop in debug
pub type I2C5_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    ///Bit 25 - I2C5 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn i2c5(&self) -> I2C5_R {
        I2C5_R::new(((self.bits >> 25) & 1) != 0)
    }
}
...
impl W {
    ...
    ///Bit 25 - I2C5 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn i2c5(&mut self) -> I2C5_W<'_, APB1LFZ1rs> {
        I2C5_W::new(self, 25)
    }
}
/**
