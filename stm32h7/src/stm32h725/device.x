...
PROVIDE(LTDC_ERR = DefaultHandler);
...
PROVIDE(BDMA_CH0 = DefaultHandler);
...
PROVIDE(ECC_DIAG_IT = DefaultHandler);
PROVIDE(SAI4 = DefaultHandler);
PROVIDE(TEMP_IT = DefaultHandler);
...
PROVIDE(CORDIC_IT = DefaultHandler);
