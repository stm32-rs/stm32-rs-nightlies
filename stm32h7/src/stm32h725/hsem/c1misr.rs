...
///Field `ISEM0` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM0_R = crate::BitReader;
///Field `ISEM1` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM1_R = crate::BitReader;
///Field `ISEM2` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM2_R = crate::BitReader;
///Field `ISEM3` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM3_R = crate::BitReader;
///Field `ISEM4` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM4_R = crate::BitReader;
///Field `ISEM5` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM5_R = crate::BitReader;
///Field `ISEM6` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM6_R = crate::BitReader;
///Field `ISEM7` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM7_R = crate::BitReader;
///Field `ISEM8` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM8_R = crate::BitReader;
///Field `ISEM9` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM9_R = crate::BitReader;
///Field `ISEM10` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM10_R = crate::BitReader;
///Field `ISEM11` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM11_R = crate::BitReader;
///Field `ISEM12` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM12_R = crate::BitReader;
///Field `ISEM13` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM13_R = crate::BitReader;
///Field `ISEM14` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM14_R = crate::BitReader;
///Field `ISEM15` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM15_R = crate::BitReader;
///Field `ISEM16` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM16_R = crate::BitReader;
///Field `ISEM17` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM17_R = crate::BitReader;
///Field `ISEM18` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM18_R = crate::BitReader;
///Field `ISEM19` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM19_R = crate::BitReader;
///Field `ISEM20` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM20_R = crate::BitReader;
///Field `ISEM21` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM21_R = crate::BitReader;
///Field `ISEM22` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM22_R = crate::BitReader;
///Field `ISEM23` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM23_R = crate::BitReader;
///Field `ISEM24` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM24_R = crate::BitReader;
///Field `ISEM25` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM25_R = crate::BitReader;
///Field `ISEM26` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM26_R = crate::BitReader;
///Field `ISEM27` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM27_R = crate::BitReader;
///Field `ISEM28` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM28_R = crate::BitReader;
///Field `ISEM29` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM29_R = crate::BitReader;
///Field `ISEM30` reader - masked interrupt(N) semaphore n status bit after enable (mask)
pub type ISEM30_R = crate::BitReader;
///Field `ISEM31` reader - masked interrupt(N) semaphore n status bit after enable (mask)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H725.html#HSEM:C1MISR)*/
pub struct C1MISRrs;
