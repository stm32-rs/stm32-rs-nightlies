///Register `OTFDEC_ISR` reader
pub type R = crate::R<OTFDEC_ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`otfdec_isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H725.html#OTFDEC1:OTFDEC_ISR)*/
pub struct OTFDEC_ISRrs;
impl crate::RegisterSpec for OTFDEC_ISRrs {
    type Ux = u32;
}
///`read()` method returns [`otfdec_isr::R`](R) reader structure
impl crate::Readable for OTFDEC_ISRrs {}
///`reset()` method sets OTFDEC_ISR to value 0
impl crate::Resettable for OTFDEC_ISRrs {
