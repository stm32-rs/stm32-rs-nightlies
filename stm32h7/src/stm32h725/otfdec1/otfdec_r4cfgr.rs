///Register `OTFDEC_R4CFGR` reader
pub type R = crate::R<OTFDEC_R4CFGRrs>;
///Register `OTFDEC_R4CFGR` writer
pub type W = crate::W<OTFDEC_R4CFGRrs>;
...
impl W {
    ///Bit 0 - region on-the-fly decryption enable Note: When this bit is set region context (version, key, nonce) must be valid or garbage will be decrypted.
    #[inline(always)]
    pub fn reg_en(&mut self) -> REG_EN_W<OTFDEC_R4CFGRrs> {
        REG_EN_W::new(self, 0)
    }
    ///Bit 1 - region config lock This bit-field is set once, i.e. if this bit is set it can only be reset to “0” if OTFDEC is reset. Setting this bit forces KEYLOCK bit to “1”.
    #[inline(always)]
    pub fn configlock(&mut self) -> CONFIGLOCK_W<OTFDEC_R4CFGRrs> {
        CONFIGLOCK_W::new(self, 1)
    }
    ///Bit 2 - region key lock This bitfield is set once, i.e. if this bit is set it can only be reset to “0” if the OTFDEC is reset.
    #[inline(always)]
    pub fn keylock(&mut self) -> KEYLOCK_W<OTFDEC_R4CFGRrs> {
        KEYLOCK_W::new(self, 2)
    }
    ///Bits 4:5 - operating mode This bitfield selects the OTFDEC operating mode for this region: When MODE is not equal to 11 the standard AES encryption mode is activated. When either of the MODE bits are changed the region’s key and associated CRC are zeroed.
    #[inline(always)]
    pub fn mode(&mut self) -> MODE_W<OTFDEC_R4CFGRrs> {
        MODE_W::new(self, 4)
    }
    ///Bits 16:31 - region firmware version This 16-bit bitfield must be correctly initialized before the region corresponding REG_EN bit is set in the RxCFGR register.
    #[inline(always)]
    pub fn regx_version(&mut self) -> REGX_VERSION_W<OTFDEC_R4CFGRrs> {
        REGX_VERSION_W::new(self, 16)
    }
}
/**OTFDEC region 4 configuration register

You can [`read`](crate::Reg::read) this register and get [`otfdec_r4cfgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otfdec_r4cfgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H725.html#OTFDEC1:OTFDEC_R4CFGR)*/
pub struct OTFDEC_R4CFGRrs;
impl crate::RegisterSpec for OTFDEC_R4CFGRrs {
    type Ux = u32;
}
///`read()` method returns [`otfdec_r4cfgr::R`](R) reader structure
impl crate::Readable for OTFDEC_R4CFGRrs {}
///`write(|w| ..)` method takes [`otfdec_r4cfgr::W`](W) writer structure
impl crate::Writable for OTFDEC_R4CFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTFDEC_R4CFGR to value 0
impl crate::Resettable for OTFDEC_R4CFGRrs {
