...
impl W {
    ...
    ///Bit 26 - USB_PHY1 clock enable during CSleep mode
    #[inline(always)]
    pub fn usb1otghsulpilpen(&mut self) -> USB1OTGHSULPILPEN_W<AHB1LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H725.html#RCC:AHB1LPENR)*/
