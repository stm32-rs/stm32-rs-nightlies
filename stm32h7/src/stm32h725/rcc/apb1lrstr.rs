...
///Field `I2C5RST` reader - I2C5 block reset
...
///Field `I2C5RST` writer - I2C5 block reset
...
impl W {
    ...
    ///Bit 16 - SPDIFRX block reset
    #[inline(always)]
    pub fn spdifrxrst(&mut self) -> SPDIFRXRST_W<APB1LRSTRrs> {
    ...
    ///Bit 25 - I2C5 block reset
    #[inline(always)]
    pub fn i2c5rst(&mut self) -> I2C5RST_W<APB1LRSTRrs> {
        I2C5RST_W::new(self, 25)
    }
    ///Bit 27 - HDMI-CEC block reset
    #[inline(always)]
    ...
    ///Bit 29 - DAC1 and 2 Blocks Reset
    #[inline(always)]
    pub fn dac12rst(&mut self) -> DAC12RST_W<APB1LRSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H725.html#RCC:APB1LRSTR)*/
