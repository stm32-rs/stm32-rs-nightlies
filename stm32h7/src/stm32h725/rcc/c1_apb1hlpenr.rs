...
impl W {
    ///Bit 1 - Clock Recovery System peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn crslpen(&mut self) -> CRSLPEN_W<'_, C1_APB1HLPENRrs> {
        CRSLPEN_W::new(self, 1)
    }
    ///Bit 2 - SWPMI Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn swpmilpen(&mut self) -> SWPMILPEN_W<'_, C1_APB1HLPENRrs> {
        SWPMILPEN_W::new(self, 2)
    }
    ///Bit 4 - OPAMP peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn opamplpen(&mut self) -> OPAMPLPEN_W<'_, C1_APB1HLPENRrs> {
        OPAMPLPEN_W::new(self, 4)
    }
    ///Bit 5 - MDIOS peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn mdioslpen(&mut self) -> MDIOSLPEN_W<'_, C1_APB1HLPENRrs> {
        MDIOSLPEN_W::new(self, 5)
    }
    ///Bit 8 - FDCAN Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn fdcanlpen(&mut self) -> FDCANLPEN_W<'_, C1_APB1HLPENRrs> {
        FDCANLPEN_W::new(self, 8)
    }
    ///Bit 24 - TIM23 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn tim23lpen(&mut self) -> TIM23LPEN_W<'_, C1_APB1HLPENRrs> {
        TIM23LPEN_W::new(self, 24)
    }
    ///Bit 25 - TIM24 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn tim24lpen(&mut self) -> TIM24LPEN_W<'_, C1_APB1HLPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H725.html#RCC:C1_APB1HLPENR)*/
