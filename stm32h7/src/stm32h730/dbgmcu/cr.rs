...
///Field `DBGSLEEP_D1` reader - D1 domain debug in Sleep mode enable
pub type DBGSLEEP_D1_R = crate::BitReader;
///Field `DBGSLEEP_D1` writer - D1 domain debug in Sleep mode enable
pub type DBGSLEEP_D1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DBGSTOP_D1` reader - D1 domain debug in Stop mode enable
pub type DBGSTOP_D1_R = crate::BitReader;
///Field `DBGSTOP_D1` writer - D1 domain debug in Stop mode enable
pub type DBGSTOP_D1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DBGSTBY_D1` reader - D1 domain debug in Standby mode enable
pub type DBGSTBY_D1_R = crate::BitReader;
///Field `DBGSTBY_D1` writer - D1 domain debug in Standby mode enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H730.html#DBGMCU:CR)*/
pub struct CRrs;
