...
pub use crate::stm32h730::gpioa::moder::MODE;
///Field `MODER(0-15)` reader - Port x configuration pin %s
pub use crate::stm32h730::gpioa::moder::MODER_R;
///Field `MODER(0-15)` writer - Port x configuration pin %s
pub use crate::stm32h730::gpioa::moder::MODER_W;
impl R {
...
///`reset()` method sets MODER to value 0x00ff_0000
