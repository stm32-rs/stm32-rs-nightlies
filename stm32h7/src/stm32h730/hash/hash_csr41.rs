...
///Field `CS41` reader - Context swap x
pub type CS41_R = crate::FieldReader<u32>;
///Field `CS41` writer - Context swap x
...
impl W {
    ///Bits 0:31 - Context swap x
    #[inline(always)]
    pub fn cs41(&mut self) -> CS41_W<'_, HASH_CSR41rs> {
        CS41_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H730.html#HASH:HASH_CSR41)*/
