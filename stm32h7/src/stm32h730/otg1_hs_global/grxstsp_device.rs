...
///Field `STSPHST` reader - Frame number
pub type STSPHST_R = crate::FieldReader;
impl R {
    ...
    ///Bits 27:30 - Frame number
    #[inline(always)]
    pub fn stsphst(&self) -> STSPHST_R {
        STSPHST_R::new(((self.bits >> 27) & 0x0f) as u8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H730.html#OTG1_HS_GLOBAL:GRXSTSP_Device)*/
