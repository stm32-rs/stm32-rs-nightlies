...
///Field `USB1OTGHSULPIEN` reader - USB_PHY1 Clocks Enable
pub use DMA1EN_R as USB1OTGHSULPIEN_R;
...
///Field `USB1OTGHSULPIEN` writer - USB_PHY1 Clocks Enable
pub use DMA1EN_W as USB1OTGHSULPIEN_W;
impl R {
    ...
    pub fn usb1otghsulpien(&self) -> USB1OTGHSULPIEN_R {
        USB1OTGHSULPIEN_R::new(((self.bits >> 26) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("C1_AHB1ENR")
            ...
            .field("usb1otghsulpien", &self.usb1otghsulpien())
            .finish()
    }
}
impl W {
    ...
    ///Bit 26 - USB_PHY1 Clocks Enable
    #[inline(always)]
    pub fn usb1otghsulpien(&mut self) -> USB1OTGHSULPIEN_W<C1_AHB1ENRrs> {
        USB1OTGHSULPIEN_W::new(self, 26)
    }
}
