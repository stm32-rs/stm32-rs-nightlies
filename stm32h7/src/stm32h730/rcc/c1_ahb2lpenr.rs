...
pub type R = crate::R<C1_AHB2LPENRrs>;
///Register `C1_AHB2LPENR` writer
pub type W = crate::W<C1_AHB2LPENRrs>;
/**DCMI_PSSILPEN
...
impl W {
    ///Bit 0 - DCMI_PSSILPEN
    #[inline(always)]
    pub fn dcmi_pssilpen(&mut self) -> DCMI_PSSILPEN_W<'_, C1_AHB2LPENRrs> {
        DCMI_PSSILPEN_W::new(self, 0)
    }
    ///Bit 4 - CRYPT peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn cryptlpen(&mut self) -> CRYPTLPEN_W<'_, C1_AHB2LPENRrs> {
        CRYPTLPEN_W::new(self, 4)
    }
    ///Bit 5 - HASH peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn hashlpen(&mut self) -> HASHLPEN_W<'_, C1_AHB2LPENRrs> {
        HASHLPEN_W::new(self, 5)
    }
    ///Bit 6 - RNG peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn rnglpen(&mut self) -> RNGLPEN_W<'_, C1_AHB2LPENRrs> {
        RNGLPEN_W::new(self, 6)
    }
    ///Bit 9 - SDMMC2 and SDMMC2 Delay Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn sdmmc2lpen(&mut self) -> SDMMC2LPEN_W<'_, C1_AHB2LPENRrs> {
        SDMMC2LPEN_W::new(self, 9)
    }
    ///Bit 16 - FMAC peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn fmaclpen(&mut self) -> FMACLPEN_W<'_, C1_AHB2LPENRrs> {
        FMACLPEN_W::new(self, 16)
    }
    ///Bit 17 - CORDIC peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn cordiclpen(&mut self) -> CORDICLPEN_W<'_, C1_AHB2LPENRrs> {
        CORDICLPEN_W::new(self, 17)
    }
    ///Bit 29 - SRAM1 Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn sram1lpen(&mut self) -> SRAM1LPEN_W<'_, C1_AHB2LPENRrs> {
        SRAM1LPEN_W::new(self, 29)
    }
    ///Bit 30 - SRAM2 Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn sram2lpen(&mut self) -> SRAM2LPEN_W<'_, C1_AHB2LPENRrs> {
...
pub struct C1_AHB2LPENRrs;
impl crate::RegisterSpec for C1_AHB2LPENRrs {
    type Ux = u32;
}
///`read()` method returns [`c1_ahb2lpenr::R`](R) reader structure
impl crate::Readable for C1_AHB2LPENRrs {}
///`write(|w| ..)` method takes [`c1_ahb2lpenr::W`](W) writer structure
impl crate::Writable for C1_AHB2LPENRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C1_AHB2LPENR to value 0x6003_0271
impl crate::Resettable for C1_AHB2LPENRrs {
