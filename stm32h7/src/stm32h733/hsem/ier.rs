...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `ISE0` field.</div>
    #[inline(always)]
    pub fn ise(&mut self, n: u8) -> ISE_W<'_, IERrs> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        ISE_W::new(self, n)
    }
    ///Bit 0 - Interrupt semaphore 0 enable bit
    #[inline(always)]
    pub fn ise0(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 0)
    }
    ///Bit 1 - Interrupt semaphore 1 enable bit
    #[inline(always)]
    pub fn ise1(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 1)
    }
    ///Bit 2 - Interrupt semaphore 2 enable bit
    #[inline(always)]
    pub fn ise2(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 2)
    }
    ///Bit 3 - Interrupt semaphore 3 enable bit
    #[inline(always)]
    pub fn ise3(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 3)
    }
    ///Bit 4 - Interrupt semaphore 4 enable bit
    #[inline(always)]
    pub fn ise4(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 4)
    }
    ///Bit 5 - Interrupt semaphore 5 enable bit
    #[inline(always)]
    pub fn ise5(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 5)
    }
    ///Bit 6 - Interrupt semaphore 6 enable bit
    #[inline(always)]
    pub fn ise6(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 6)
    }
    ///Bit 7 - Interrupt semaphore 7 enable bit
    #[inline(always)]
    pub fn ise7(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 7)
    }
    ///Bit 8 - Interrupt semaphore 8 enable bit
    #[inline(always)]
    pub fn ise8(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 8)
    }
    ///Bit 9 - Interrupt semaphore 9 enable bit
    #[inline(always)]
    pub fn ise9(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 9)
    }
    ///Bit 10 - Interrupt semaphore 10 enable bit
    #[inline(always)]
    pub fn ise10(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 10)
    }
    ///Bit 11 - Interrupt semaphore 11 enable bit
    #[inline(always)]
    pub fn ise11(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 11)
    }
    ///Bit 12 - Interrupt semaphore 12 enable bit
    #[inline(always)]
    pub fn ise12(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 12)
    }
    ///Bit 13 - Interrupt semaphore 13 enable bit
    #[inline(always)]
    pub fn ise13(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 13)
    }
    ///Bit 14 - Interrupt semaphore 14 enable bit
    #[inline(always)]
    pub fn ise14(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 14)
    }
    ///Bit 15 - Interrupt semaphore 15 enable bit
    #[inline(always)]
    pub fn ise15(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 15)
    }
    ///Bit 16 - Interrupt semaphore 16 enable bit
    #[inline(always)]
    pub fn ise16(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 16)
    }
    ///Bit 17 - Interrupt semaphore 17 enable bit
    #[inline(always)]
    pub fn ise17(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 17)
    }
    ///Bit 18 - Interrupt semaphore 18 enable bit
    #[inline(always)]
    pub fn ise18(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 18)
    }
    ///Bit 19 - Interrupt semaphore 19 enable bit
    #[inline(always)]
    pub fn ise19(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 19)
    }
    ///Bit 20 - Interrupt semaphore 20 enable bit
    #[inline(always)]
    pub fn ise20(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 20)
    }
    ///Bit 21 - Interrupt semaphore 21 enable bit
    #[inline(always)]
    pub fn ise21(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 21)
    }
    ///Bit 22 - Interrupt semaphore 22 enable bit
    #[inline(always)]
    pub fn ise22(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 22)
    }
    ///Bit 23 - Interrupt semaphore 23 enable bit
    #[inline(always)]
    pub fn ise23(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 23)
    }
    ///Bit 24 - Interrupt semaphore 24 enable bit
    #[inline(always)]
    pub fn ise24(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 24)
    }
    ///Bit 25 - Interrupt semaphore 25 enable bit
    #[inline(always)]
    pub fn ise25(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 25)
    }
    ///Bit 26 - Interrupt semaphore 26 enable bit
    #[inline(always)]
    pub fn ise26(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 26)
    }
    ///Bit 27 - Interrupt semaphore 27 enable bit
    #[inline(always)]
    pub fn ise27(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 27)
    }
    ///Bit 28 - Interrupt semaphore 28 enable bit
    #[inline(always)]
    pub fn ise28(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 28)
    }
    ///Bit 29 - Interrupt semaphore 29 enable bit
    #[inline(always)]
    pub fn ise29(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 29)
    }
    ///Bit 30 - Interrupt semaphore 30 enable bit
    #[inline(always)]
    pub fn ise30(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 30)
    }
    ///Bit 31 - Interrupt semaphore 31 enable bit
    #[inline(always)]
    pub fn ise31(&mut self) -> ISE_W<'_, IERrs> {
        ISE_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H733.html#HSEM:IER)*/
pub struct IERrs;
