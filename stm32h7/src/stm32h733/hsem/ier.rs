...
impl W {
    ...
    ///Bit 16 - Interrupt semaphore 16 enable bit
    #[inline(always)]
    pub fn ise16(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 16)
    }
    ///Bit 17 - Interrupt semaphore 17 enable bit
    #[inline(always)]
    pub fn ise17(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 17)
    }
    ///Bit 18 - Interrupt semaphore 18 enable bit
    #[inline(always)]
    pub fn ise18(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 18)
    }
    ///Bit 19 - Interrupt semaphore 19 enable bit
    #[inline(always)]
    pub fn ise19(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 19)
    }
    ///Bit 20 - Interrupt semaphore 20 enable bit
    #[inline(always)]
    pub fn ise20(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 20)
    }
    ///Bit 21 - Interrupt semaphore 21 enable bit
    #[inline(always)]
    pub fn ise21(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 21)
    }
    ///Bit 22 - Interrupt semaphore 22 enable bit
    #[inline(always)]
    pub fn ise22(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 22)
    }
    ///Bit 23 - Interrupt semaphore 23 enable bit
    #[inline(always)]
    pub fn ise23(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 23)
    }
    ///Bit 24 - Interrupt semaphore 24 enable bit
    #[inline(always)]
    pub fn ise24(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 24)
    }
    ///Bit 25 - Interrupt semaphore 25 enable bit
    #[inline(always)]
    pub fn ise25(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 25)
    }
    ///Bit 26 - Interrupt semaphore 26 enable bit
    #[inline(always)]
    pub fn ise26(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 26)
    }
    ///Bit 27 - Interrupt semaphore 27 enable bit
    #[inline(always)]
    pub fn ise27(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 27)
    }
    ///Bit 28 - Interrupt semaphore 28 enable bit
    #[inline(always)]
    pub fn ise28(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 28)
    }
    ///Bit 29 - Interrupt semaphore 29 enable bit
    #[inline(always)]
    pub fn ise29(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 29)
    }
    ///Bit 30 - Interrupt semaphore 30 enable bit
    #[inline(always)]
    pub fn ise30(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 30)
    }
    ///Bit 31 - Interrupt semaphore 31 enable bit
    #[inline(always)]
    pub fn ise31(&mut self) -> ISE_W<IERrs> {
        ISE_W::new(self, 31)
    }
}
