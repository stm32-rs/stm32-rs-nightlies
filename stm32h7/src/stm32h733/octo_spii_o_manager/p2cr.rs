...
///Field `IOHSRC` reader - IOHSRC
pub type IOHSRC_R = crate::FieldReader;
///Field `IOHSRC` writer - IOHSRC
...
impl W {
    ///Bit 0 - CLKEN
    #[inline(always)]
    pub fn clken(&mut self) -> CLKEN_W<'_, P2CRrs> {
        CLKEN_W::new(self, 0)
    }
    ///Bit 1 - CLKSRC
    #[inline(always)]
    pub fn clksrc(&mut self) -> CLKSRC_W<'_, P2CRrs> {
        CLKSRC_W::new(self, 1)
    }
    ///Bit 4 - DQSEN
    #[inline(always)]
    pub fn dqsen(&mut self) -> DQSEN_W<'_, P2CRrs> {
        DQSEN_W::new(self, 4)
    }
    ///Bit 5 - DQSSRC
    #[inline(always)]
    pub fn dqssrc(&mut self) -> DQSSRC_W<'_, P2CRrs> {
        DQSSRC_W::new(self, 5)
    }
    ///Bit 8 - NCSEN
    #[inline(always)]
    pub fn ncsen(&mut self) -> NCSEN_W<'_, P2CRrs> {
        NCSEN_W::new(self, 8)
    }
    ///Bit 9 - NCSSRC
    #[inline(always)]
    pub fn ncssrc(&mut self) -> NCSSRC_W<'_, P2CRrs> {
        NCSSRC_W::new(self, 9)
    }
    ///Bit 16 - IOLEN
    #[inline(always)]
    pub fn iolen(&mut self) -> IOLEN_W<'_, P2CRrs> {
        IOLEN_W::new(self, 16)
    }
    ///Bits 17:18 - IOLSRC
    #[inline(always)]
    pub fn iolsrc(&mut self) -> IOLSRC_W<'_, P2CRrs> {
        IOLSRC_W::new(self, 17)
    }
    ///Bit 24 - IOHEN
    #[inline(always)]
    pub fn iohen(&mut self) -> IOHEN_W<'_, P2CRrs> {
        IOHEN_W::new(self, 24)
    }
    ///Bits 25:26 - IOHSRC
    #[inline(always)]
    pub fn iohsrc(&mut self) -> IOHSRC_W<'_, P2CRrs> {
        IOHSRC_W::new(self, 25)
    }
}
/**OctoSPI IO Manager Port 2 configuration register

You can [`read`](crate::Reg::read) this register and get [`p2cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p2cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H733.html#OctoSPII_O_Manager:P2CR)*/
pub struct P2CRrs;
