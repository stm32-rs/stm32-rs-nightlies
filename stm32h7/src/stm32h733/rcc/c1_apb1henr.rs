...
impl W {
    ///Bit 1 - Clock Recovery System peripheral clock enable
    #[inline(always)]
    pub fn crsen(&mut self) -> CRSEN_W<'_, C1_APB1HENRrs> {
        CRSEN_W::new(self, 1)
    }
    ///Bit 2 - SWPMI Peripheral Clocks Enable
    #[inline(always)]
    pub fn swpmien(&mut self) -> SWPMIEN_W<'_, C1_APB1HENRrs> {
        SWPMIEN_W::new(self, 2)
    }
    ///Bit 4 - OPAMP peripheral clock enable
    #[inline(always)]
    pub fn opampen(&mut self) -> OPAMPEN_W<'_, C1_APB1HENRrs> {
        OPAMPEN_W::new(self, 4)
    }
    ///Bit 5 - MDIOS peripheral clock enable
    #[inline(always)]
    pub fn mdiosen(&mut self) -> MDIOSEN_W<'_, C1_APB1HENRrs> {
        MDIOSEN_W::new(self, 5)
    }
    ///Bit 8 - FDCAN Peripheral Clocks Enable
    #[inline(always)]
    pub fn fdcanen(&mut self) -> FDCANEN_W<'_, C1_APB1HENRrs> {
        FDCANEN_W::new(self, 8)
    }
    ///Bit 24 - TIM23 Peripheral Clocks Enable
    #[inline(always)]
    pub fn tim23en(&mut self) -> TIM23EN_W<'_, C1_APB1HENRrs> {
        TIM23EN_W::new(self, 24)
    }
    ///Bit 25 - TIM24 Peripheral Clocks Enable
    #[inline(always)]
    pub fn tim24en(&mut self) -> TIM24EN_W<'_, C1_APB1HENRrs> {
