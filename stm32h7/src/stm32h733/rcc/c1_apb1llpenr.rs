...
///Field `I2C5LPEN` reader - I2C5 Peripheral Clocks Enable During CSleep Mode
pub use TIM2LPEN_R as I2C5LPEN_R;
///Field `CECLPEN` reader - CEC Peripheral Clocks Enable During CSleep Mode
...
///Field `I2C5LPEN` writer - I2C5 Peripheral Clocks Enable During CSleep Mode
pub use TIM2LPEN_W as I2C5LPEN_W;
///Field `CECLPEN` writer - CEC Peripheral Clocks Enable During CSleep Mode
...
impl W {
    ///Bit 0 - TIM2 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn tim2lpen(&mut self) -> TIM2LPEN_W<'_, C1_APB1LLPENRrs> {
        TIM2LPEN_W::new(self, 0)
    }
    ///Bit 1 - TIM3 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn tim3lpen(&mut self) -> TIM3LPEN_W<'_, C1_APB1LLPENRrs> {
        TIM3LPEN_W::new(self, 1)
    }
    ///Bit 2 - TIM4 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn tim4lpen(&mut self) -> TIM4LPEN_W<'_, C1_APB1LLPENRrs> {
        TIM4LPEN_W::new(self, 2)
    }
    ///Bit 3 - TIM5 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn tim5lpen(&mut self) -> TIM5LPEN_W<'_, C1_APB1LLPENRrs> {
        TIM5LPEN_W::new(self, 3)
    }
    ///Bit 4 - TIM6 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn tim6lpen(&mut self) -> TIM6LPEN_W<'_, C1_APB1LLPENRrs> {
        TIM6LPEN_W::new(self, 4)
    }
    ///Bit 5 - TIM7 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn tim7lpen(&mut self) -> TIM7LPEN_W<'_, C1_APB1LLPENRrs> {
        TIM7LPEN_W::new(self, 5)
    }
    ///Bit 6 - TIM12 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn tim12lpen(&mut self) -> TIM12LPEN_W<'_, C1_APB1LLPENRrs> {
        TIM12LPEN_W::new(self, 6)
    }
    ///Bit 7 - TIM13 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn tim13lpen(&mut self) -> TIM13LPEN_W<'_, C1_APB1LLPENRrs> {
        TIM13LPEN_W::new(self, 7)
    }
    ///Bit 8 - TIM14 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn tim14lpen(&mut self) -> TIM14LPEN_W<'_, C1_APB1LLPENRrs> {
        TIM14LPEN_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn lptim1lpen(&mut self) -> LPTIM1LPEN_W<'_, C1_APB1LLPENRrs> {
        LPTIM1LPEN_W::new(self, 9)
    }
    ///Bit 14 - SPI2 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn spi2lpen(&mut self) -> SPI2LPEN_W<'_, C1_APB1LLPENRrs> {
        SPI2LPEN_W::new(self, 14)
    }
    ///Bit 15 - SPI3 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn spi3lpen(&mut self) -> SPI3LPEN_W<'_, C1_APB1LLPENRrs> {
        SPI3LPEN_W::new(self, 15)
    }
    ///Bit 16 - SPDIFRX Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn spdifrxlpen(&mut self) -> SPDIFRXLPEN_W<'_, C1_APB1LLPENRrs> {
        SPDIFRXLPEN_W::new(self, 16)
    }
    ///Bit 17 - USART2 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn usart2lpen(&mut self) -> USART2LPEN_W<'_, C1_APB1LLPENRrs> {
        USART2LPEN_W::new(self, 17)
    }
    ///Bit 18 - USART3 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn usart3lpen(&mut self) -> USART3LPEN_W<'_, C1_APB1LLPENRrs> {
        USART3LPEN_W::new(self, 18)
    }
    ///Bit 19 - UART4 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn uart4lpen(&mut self) -> UART4LPEN_W<'_, C1_APB1LLPENRrs> {
        UART4LPEN_W::new(self, 19)
    }
    ///Bit 20 - UART5 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn uart5lpen(&mut self) -> UART5LPEN_W<'_, C1_APB1LLPENRrs> {
        UART5LPEN_W::new(self, 20)
    }
    ///Bit 21 - I2C1 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn i2c1lpen(&mut self) -> I2C1LPEN_W<'_, C1_APB1LLPENRrs> {
        I2C1LPEN_W::new(self, 21)
    }
    ///Bit 22 - I2C2 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn i2c2lpen(&mut self) -> I2C2LPEN_W<'_, C1_APB1LLPENRrs> {
        I2C2LPEN_W::new(self, 22)
    }
    ///Bit 23 - I2C3 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn i2c3lpen(&mut self) -> I2C3LPEN_W<'_, C1_APB1LLPENRrs> {
        I2C3LPEN_W::new(self, 23)
    }
    ///Bit 25 - I2C5 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn i2c5lpen(&mut self) -> I2C5LPEN_W<'_, C1_APB1LLPENRrs> {
        I2C5LPEN_W::new(self, 25)
    }
    ///Bit 27 - CEC Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn ceclpen(&mut self) -> CECLPEN_W<'_, C1_APB1LLPENRrs> {
        CECLPEN_W::new(self, 27)
    }
    ///Bit 29 - DAC1/2 peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn dac12lpen(&mut self) -> DAC12LPEN_W<'_, C1_APB1LLPENRrs> {
        DAC12LPEN_W::new(self, 29)
    }
    ///Bit 30 - UART7 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn uart7lpen(&mut self) -> UART7LPEN_W<'_, C1_APB1LLPENRrs> {
        UART7LPEN_W::new(self, 30)
    }
    ///Bit 31 - UART8 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn uart8lpen(&mut self) -> UART8LPEN_W<'_, C1_APB1LLPENRrs> {
...
///`reset()` method sets C1_APB1LLPENR to value 0xe8ff_cbff
impl crate::Resettable for C1_APB1LLPENRrs {
    const RESET_VALUE: u32 = 0xe8ff_cbff;
}
