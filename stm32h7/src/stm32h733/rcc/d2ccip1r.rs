...
///Field `SWPMISEL` reader - SWPMI kernel clock source selection
...
///Field `SWPMISEL` writer - SWPMI kernel clock source selection
...
impl W {
    ...
    ///Bits 20:21 - SPDIFRX kernel clock source selection
    #[inline(always)]
    pub fn spdifrxsel(&mut self) -> SPDIFRXSEL_W<'_, D2CCIP1Rrs> {
    ...
    ///Bit 31 - SWPMI kernel clock source selection
    #[inline(always)]
    pub fn swpmisel(&mut self) -> SWPMISEL_W<'_, D2CCIP1Rrs> {
