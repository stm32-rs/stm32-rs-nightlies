...
///Field `OSVR` reader - Oversampling ratio This bitfield is set and cleared by software to define the oversampling ratio. 2: 3x ... 1023: 1024x Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing).
pub type OSVR_R = crate::FieldReader<u16>;
///Field `OSVR` writer - Oversampling ratio This bitfield is set and cleared by software to define the oversampling ratio. 2: 3x ... 1023: 1024x Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing).
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `RSHIFT1` field.</div>
    #[inline(always)]
    pub fn rshift(&mut self, n: u8) -> RSHIFT_W<CFGR2rs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    ///Bit 11 - Right-shift data after Offset 1 correction
    #[inline(always)]
    pub fn rshift1(&mut self) -> RSHIFT_W<CFGR2rs> {
        RSHIFT_W::new(self, 11)
    }
    ///Bit 12 - Right-shift data after Offset 2 correction
    #[inline(always)]
    pub fn rshift2(&mut self) -> RSHIFT_W<CFGR2rs> {
        RSHIFT_W::new(self, 12)
    }
    ///Bit 13 - Right-shift data after Offset 3 correction
    #[inline(always)]
    pub fn rshift3(&mut self) -> RSHIFT_W<CFGR2rs> {
        RSHIFT_W::new(self, 13)
    }
    ///Bit 14 - Right-shift data after Offset 4 correction
    #[inline(always)]
    pub fn rshift4(&mut self) -> RSHIFT_W<CFGR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#ADC1:CFGR2)*/
pub struct CFGR2rs;
