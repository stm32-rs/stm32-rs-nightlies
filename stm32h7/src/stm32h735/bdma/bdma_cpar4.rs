///Register `BDMA_CPAR4` reader
pub type R = crate::R<BDMA_CPAR4rs>;
///Register `BDMA_CPAR4` writer
pub type W = crate::W<BDMA_CPAR4rs>;
...
impl W {
    ...
    are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory destination address if DIR = 1 and the memory source address if DIR = 0. In peripheral-to-peripheral mode, this register identifies the peripheral destination address DIR = 1 and the peripheral source address if DIR = 0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1).*/
    #[inline(always)]
    pub fn pa(&mut self) -> PA_W<BDMA_CPAR4rs> {
        PA_W::new(self, 0)
    }
}
/**

You can [`read`](crate::Reg::read) this register and get [`bdma_cpar4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bdma_cpar4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#BDMA:BDMA_CPAR4)*/
pub struct BDMA_CPAR4rs;
impl crate::RegisterSpec for BDMA_CPAR4rs {
    type Ux = u32;
}
///`read()` method returns [`bdma_cpar4::R`](R) reader structure
impl crate::Readable for BDMA_CPAR4rs {}
///`write(|w| ..)` method takes [`bdma_cpar4::W`](W) writer structure
impl crate::Writable for BDMA_CPAR4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets BDMA_CPAR4 to value 0
impl crate::Resettable for BDMA_CPAR4rs {
