///Register `APB4FZ2` reader
pub type R = crate::R<APB4FZ2rs>;
///Register `APB4FZ2` writer
...
///Field `DBG_WDGLSD1` reader - LS watchdog for D1 stop in debug
pub type DBG_WDGLSD1_R = crate::BitReader;
///Field `DBG_WDGLSD1` writer - LS watchdog for D1 stop in debug
pub type DBG_WDGLSD1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DBG_WDGLSD2` reader - LS watchdog for D2 stop in debug
pub type DBG_WDGLSD2_R = crate::BitReader;
///Field `DBG_WDGLSD2` writer - LS watchdog for D2 stop in debug
...
///`read()` method returns [`apb4fz2::R`](R) reader structure
impl crate::Readable for APB4FZ2rs {}
///`write(|w| ..)` method takes [`apb4fz2::W`](W) writer structure
impl crate::Writable for APB4FZ2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APB4FZ2 to value 0
