...
///Field `CSOF(0-15)` writer - Clear synchronization overrun event flag Writing 1 in each bit clears the corresponding overrun flag SOFx in the DMAMUX_CSR register.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#DMAMUX1:CFR)*/
pub struct CFRrs;
