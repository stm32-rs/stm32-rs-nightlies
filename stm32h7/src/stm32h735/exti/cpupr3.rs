...
impl W {
    ///Bit 18 - Configurable event inputs x+64 Pending bit
    #[inline(always)]
    pub fn pr82(&mut self) -> PR82_W<'_, CPUPR3rs> {
        PR82_W::new(self, 18)
    }
    ///Bit 20 - Configurable event inputs x+64 Pending bit
    #[inline(always)]
    pub fn pr84(&mut self) -> PR84_W<'_, CPUPR3rs> {
        PR84_W::new(self, 20)
    }
    ///Bit 21 - Configurable event inputs x+64 Pending bit
    #[inline(always)]
    pub fn pr85(&mut self) -> PR85_W<'_, CPUPR3rs> {
        PR85_W::new(self, 21)
    }
    ///Bit 22 - Configurable event inputs x+64 Pending bit
    #[inline(always)]
    pub fn pr86(&mut self) -> PR86_W<'_, CPUPR3rs> {
        PR86_W::new(self, 22)
    }
}
