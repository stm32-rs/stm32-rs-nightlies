///Register `FMAC_PARAM` reader
pub type R = crate::R<FMAC_PARAMrs>;
///Register `FMAC_PARAM` writer
pub type W = crate::W<FMAC_PARAMrs>;
...
impl W {
    ///Bits 0:7 - Input parameter P. The value of this parameter is dependent on the function This bitfield can not be modified when a function is ongoing (START = 1)
    #[inline(always)]
    pub fn p(&mut self) -> P_W<FMAC_PARAMrs> {
        P_W::new(self, 0)
    }
    ///Bits 8:15 - Input parameter Q. The value of this parameter is dependent on the function. This bitfield can not be modified when a function is ongoing (START = 1)
    #[inline(always)]
    pub fn q(&mut self) -> Q_W<FMAC_PARAMrs> {
        Q_W::new(self, 8)
    }
    ///Bits 16:23 - Input parameter R. The value of this parameter is dependent on the function. This bitfield can not be modified when a function is ongoing (START = 1)
    #[inline(always)]
    pub fn r(&mut self) -> R_W<FMAC_PARAMrs> {
        R_W::new(self, 16)
    }
    ///Bits 24:30 - Function 2: Load X2 buffer 3: Load Y buffer 4 to 7: Reserved 8: Convolution (FIR filter) 9: IIR filter (direct form 1) This bitfield can not be modified when a function is ongoing (START = 1)
    #[inline(always)]
    pub fn func(&mut self) -> FUNC_W<FMAC_PARAMrs> {
        FUNC_W::new(self, 24)
    }
    ///Bit 31 - Enable execution Setting this bit triggers the execution of the function selected in the FUNC bitfield. Resetting it by software stops any ongoing function. For initialization functions, this bit is reset by hardware.
    #[inline(always)]
    pub fn start(&mut self) -> START_W<FMAC_PARAMrs> {
        START_W::new(self, 31)
    }
}
/**FMAC parameter register

You can [`read`](crate::Reg::read) this register and get [`fmac_param::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmac_param::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#FMAC:FMAC_PARAM)*/
pub struct FMAC_PARAMrs;
impl crate::RegisterSpec for FMAC_PARAMrs {
    type Ux = u32;
}
///`read()` method returns [`fmac_param::R`](R) reader structure
impl crate::Readable for FMAC_PARAMrs {}
///`write(|w| ..)` method takes [`fmac_param::W`](W) writer structure
impl crate::Writable for FMAC_PARAMrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FMAC_PARAM to value 0
impl crate::Resettable for FMAC_PARAMrs {
