///Register `FMAC_RDATA` reader
pub type R = crate::R<FMAC_RDATArs>;
...
You can [`read`](crate::Reg::read) this register and get [`fmac_rdata::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#FMAC:FMAC_RDATA)*/
pub struct FMAC_RDATArs;
impl crate::RegisterSpec for FMAC_RDATArs {
    type Ux = u32;
}
///`read()` method returns [`fmac_rdata::R`](R) reader structure
impl crate::Readable for FMAC_RDATArs {}
///`reset()` method sets FMAC_RDATA to value 0
impl crate::Resettable for FMAC_RDATArs {
