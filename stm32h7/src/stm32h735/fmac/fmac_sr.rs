///Register `FMAC_SR` reader
pub type R = crate::R<FMAC_SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`fmac_sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#FMAC:FMAC_SR)*/
pub struct FMAC_SRrs;
impl crate::RegisterSpec for FMAC_SRrs {
    type Ux = u32;
}
///`read()` method returns [`fmac_sr::R`](R) reader structure
impl crate::Readable for FMAC_SRrs {}
///`reset()` method sets FMAC_SR to value 0x01
impl crate::Resettable for FMAC_SRrs {
