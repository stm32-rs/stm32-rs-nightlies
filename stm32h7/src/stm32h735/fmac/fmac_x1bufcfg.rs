///Register `FMAC_X1BUFCFG` reader
pub type R = crate::R<FMAC_X1BUFCFGrs>;
///Register `FMAC_X1BUFCFG` writer
pub type W = crate::W<FMAC_X1BUFCFGrs>;
...
impl W {
    ///Bits 0:7 - Base address of X1 buffer
    #[inline(always)]
    pub fn x1_base(&mut self) -> X1_BASE_W<FMAC_X1BUFCFGrs> {
        X1_BASE_W::new(self, 0)
    }
    ///Bits 8:15 - Allocated size of X1 buffer in 16-bit words The minimum buffer size is the number of feed-forward taps in the filter (+ the watermark threshold - 1).
    #[inline(always)]
    pub fn x1_buf_size(&mut self) -> X1_BUF_SIZE_W<FMAC_X1BUFCFGrs> {
        X1_BUF_SIZE_W::new(self, 8)
    }
    ///Bits 24:25 - Watermark for buffer full flag Defines the threshold for setting the X1 buffer full flag when operating in circular mode. The flag is set if the number of free spaces in the buffer is less than 2FULL_WM. 2: Threshold = 4 3: Threshold = 8 Setting a threshold greater than 1 allows several data to be transferred into the buffer under one interrupt. Threshold should be set to 1 if DMA write requests are enabled (DMAWEN = 1 in FMAC_CR register).
    #[inline(always)]
    pub fn full_wm(&mut self) -> FULL_WM_W<FMAC_X1BUFCFGrs> {
        FULL_WM_W::new(self, 24)
    }
}
/**FMAC X1 buffer configuration register

You can [`read`](crate::Reg::read) this register and get [`fmac_x1bufcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmac_x1bufcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#FMAC:FMAC_X1BUFCFG)*/
pub struct FMAC_X1BUFCFGrs;
impl crate::RegisterSpec for FMAC_X1BUFCFGrs {
    type Ux = u32;
}
///`read()` method returns [`fmac_x1bufcfg::R`](R) reader structure
impl crate::Readable for FMAC_X1BUFCFGrs {}
///`write(|w| ..)` method takes [`fmac_x1bufcfg::W`](W) writer structure
impl crate::Writable for FMAC_X1BUFCFGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FMAC_X1BUFCFG to value 0
impl crate::Resettable for FMAC_X1BUFCFGrs {
