///Register `FMAC_YBUFCFG` reader
pub type R = crate::R<FMAC_YBUFCFGrs>;
///Register `FMAC_YBUFCFG` writer
pub type W = crate::W<FMAC_YBUFCFGrs>;
...
impl W {
    ///Bits 0:7 - Base address of Y buffer
    #[inline(always)]
    pub fn y_base(&mut self) -> Y_BASE_W<FMAC_YBUFCFGrs> {
        Y_BASE_W::new(self, 0)
    }
    ///Bits 8:15 - Size of Y buffer in 16-bit words For FIR filters, the minimum buffer size is 1 (+ the watermark threshold). For IIR filters the minimum buffer size is the number of feedback taps (+ the watermark threshold).
    #[inline(always)]
    pub fn y_buf_size(&mut self) -> Y_BUF_SIZE_W<FMAC_YBUFCFGrs> {
        Y_BUF_SIZE_W::new(self, 8)
    }
    ///Bits 24:25 - Watermark for buffer empty flag Defines the threshold for setting the Y buffer empty flag when operating in circular mode. The flag is set if the number of unread values in the buffer is less than 2EMPTY_WM. 2: Threshold = 4 3: Threshold = 8 Setting a threshold greater than 1 allows several data to be transferred from the buffer under one interrupt. Threshold should be set to 1 if DMA read requests are enabled (DMAREN = 1 in FMAC_CR register).
    #[inline(always)]
    pub fn empty_wm(&mut self) -> EMPTY_WM_W<FMAC_YBUFCFGrs> {
        EMPTY_WM_W::new(self, 24)
    }
}
/**FMAC Y buffer configuration register

You can [`read`](crate::Reg::read) this register and get [`fmac_ybufcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmac_ybufcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#FMAC:FMAC_YBUFCFG)*/
pub struct FMAC_YBUFCFGrs;
impl crate::RegisterSpec for FMAC_YBUFCFGrs {
    type Ux = u32;
}
///`read()` method returns [`fmac_ybufcfg::R`](R) reader structure
impl crate::Readable for FMAC_YBUFCFGrs {}
///`write(|w| ..)` method takes [`fmac_ybufcfg::W`](W) writer structure
impl crate::Writable for FMAC_YBUFCFGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FMAC_YBUFCFG to value 0
impl crate::Resettable for FMAC_YBUFCFGrs {
