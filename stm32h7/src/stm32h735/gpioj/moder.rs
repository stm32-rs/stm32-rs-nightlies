...
pub use crate::stm32h735::gpioa::moder::MODE;
///Field `MODER(0-15)` reader - Port x configuration pin %s
pub use crate::stm32h735::gpioa::moder::MODER_R;
///Field `MODER(0-15)` writer - Port x configuration pin %s
pub use crate::stm32h735::gpioa::moder::MODER_W;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#GPIOJ:MODER)*/
pub struct MODERrs;
