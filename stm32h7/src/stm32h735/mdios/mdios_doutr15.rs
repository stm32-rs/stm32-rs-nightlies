...
pub struct W(crate::W<MDIOS_DOUTR15_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDIOS_DOUTR15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDIOS_DOUTR15_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDIOS_DOUTR15_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DOUT15` reader - Output data sent to MDIO Master during read frames"]
pub struct DOUT15_R(crate::FieldReader<u16, u16>);
impl DOUT15_R {
...
impl crate::Writable for MDIOS_DOUTR15_SPEC {
    type Writer = W;
}
