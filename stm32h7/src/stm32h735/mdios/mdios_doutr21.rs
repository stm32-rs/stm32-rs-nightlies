...
pub struct W(crate::W<MDIOS_DOUTR21_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDIOS_DOUTR21_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDIOS_DOUTR21_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDIOS_DOUTR21_SPEC>) -> Self {
        W(writer)
    }
}
