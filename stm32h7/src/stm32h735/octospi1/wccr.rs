...
pub type ISIZE_R = crate::BitReader;
///Field `ISIZE` writer - Instruction size
pub type ISIZE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H73x.html#OCTOSPI1:WCCR)*/
pub struct WCCRrs;
