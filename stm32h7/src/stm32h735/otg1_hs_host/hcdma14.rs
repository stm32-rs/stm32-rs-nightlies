...
pub struct R(crate::R<HCDMA14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HCDMA14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HCDMA14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HCDMA14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HCDMA14` writer"]
pub struct W(crate::W<HCDMA14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HCDMA14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HCDMA14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HCDMA14_SPEC>) -> Self {
        W(writer)
    }
}
