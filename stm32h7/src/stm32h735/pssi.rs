...
/**PSSI_CR (rw) register accessor: PSSI control register
...
pub mod pssi_cr;
/**PSSI_SR (r) register accessor: PSSI status register
...
pub mod pssi_ris;
/**PSSI_IER (rw) register accessor: PSSI interrupt enable register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#PSSI:PSSI_IER)
