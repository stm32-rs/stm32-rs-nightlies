///Register `PSSI_DR` reader
pub type R = crate::R<PSSI_DRrs>;
///Register `PSSI_DR` writer
pub type W = crate::W<PSSI_DRrs>;
...
impl W {
    ///Bits 0:7 - Data byte 0
    #[inline(always)]
    pub fn byte0(&mut self) -> BYTE0_W<PSSI_DRrs> {
        BYTE0_W::new(self, 0)
    }
    ///Bits 8:15 - Data byte 1
    #[inline(always)]
    pub fn byte1(&mut self) -> BYTE1_W<PSSI_DRrs> {
        BYTE1_W::new(self, 8)
    }
    ///Bits 16:23 - Data byte 2
    #[inline(always)]
    pub fn byte2(&mut self) -> BYTE2_W<PSSI_DRrs> {
        BYTE2_W::new(self, 16)
    }
    ///Bits 24:31 - Data byte 3
    #[inline(always)]
    pub fn byte3(&mut self) -> BYTE3_W<PSSI_DRrs> {
        BYTE3_W::new(self, 24)
    }
}
/**PSSI data register

You can [`read`](crate::Reg::read) this register and get [`pssi_dr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pssi_dr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H735.html#PSSI:PSSI_DR)*/
pub struct PSSI_DRrs;
impl crate::RegisterSpec for PSSI_DRrs {
    type Ux = u32;
}
///`read()` method returns [`pssi_dr::R`](R) reader structure
impl crate::Readable for PSSI_DRrs {}
///`write(|w| ..)` method takes [`pssi_dr::W`](W) writer structure
impl crate::Writable for PSSI_DRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PSSI_DR to value 0
impl crate::Resettable for PSSI_DRrs {
