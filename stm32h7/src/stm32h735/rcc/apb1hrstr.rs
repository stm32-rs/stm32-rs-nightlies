...
pub type TIM23RST_A = CRSRST_A;
#[doc = "Field `TIM23RST` reader - TIM23 block reset"]
pub type TIM23RST_R = CRSRST_R;
#[doc = "Field `TIM23RST` writer - TIM23 block reset"]
pub struct TIM23RST_W<'a> {
    w: &'a mut W,
}
impl<'a> TIM23RST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TIM23RST_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Reset the selected module"]
    #[inline(always)]
    pub fn reset(self) -> &'a mut W {
        self.variant(TIM23RST_A::RESET)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub type TIM24RST_A = CRSRST_A;
#[doc = "Field `TIM24RST` reader - TIM24 block reset"]
pub type TIM24RST_R = CRSRST_R;
#[doc = "Field `TIM24RST` writer - TIM24 block reset"]
pub struct TIM24RST_W<'a> {
    w: &'a mut W,
}
impl<'a> TIM24RST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TIM24RST_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Reset the selected module"]
    #[inline(always)]
    pub fn reset(self) -> &'a mut W {
        self.variant(TIM24RST_A::RESET)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn tim23rst(&self) -> TIM23RST_R {
        TIM23RST_R::new(((self.bits >> 24) & 0x01) != 0)
    }
    #[doc = "Bit 25 - TIM24 block reset"]
    #[inline(always)]
    pub fn tim24rst(&self) -> TIM24RST_R {
        TIM24RST_R::new(((self.bits >> 25) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - Clock Recovery System reset"]
    ...
    #[doc = "Bit 24 - TIM23 block reset"]
    #[inline(always)]
    pub fn tim23rst(&mut self) -> TIM23RST_W {
        TIM23RST_W { w: self }
    }
    #[doc = "Bit 25 - TIM24 block reset"]
    #[inline(always)]
    pub fn tim24rst(&mut self) -> TIM24RST_W {
        TIM24RST_W { w: self }
    }
