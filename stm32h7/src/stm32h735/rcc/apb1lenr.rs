...
#[doc = "I2C5 block enable"]
pub type I2C5EN_A = TIM2EN_A;
#[doc = "Field `I2C5EN` reader - I2C5 block enable"]
pub type I2C5EN_R = TIM2EN_R;
...
impl<'a> I2C5EN_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(I2C5EN_A::DISABLED)
    }
    #[doc = "The selected clock is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(I2C5EN_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn i2c5en(&self) -> I2C5EN_R {
        I2C5EN_R::new(((self.bits >> 25) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - TIM peripheral clock enable"]
