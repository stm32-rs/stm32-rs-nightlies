...
///Field `UART9RST` reader - UART9 block reset
...
///Field `UART9RST` writer - UART9 block reset
...
impl W {
    ...
    ///Bit 7 - USART10 block reset
    #[inline(always)]
    pub fn usart10rst(&mut self) -> USART10RST_W<APB2RSTRrs> {
