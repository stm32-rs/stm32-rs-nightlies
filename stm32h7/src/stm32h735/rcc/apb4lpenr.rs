...
///Field `DTSLPEN` reader - Digital temperature sensor block enable during CSleep Mode
...
///Field `DTSLPEN` writer - Digital temperature sensor block enable during CSleep Mode
