...
///Field `USB1OTGHSULPILPEN` reader - USB_PHY1 clock enable during CSleep mode
...
///Field `USB1OTGHSULPILPEN` writer - USB_PHY1 clock enable during CSleep mode
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("C1_AHB1LPENR")
            ...
            .field("usb1otghsulpilpen", &self.usb1otghsulpilpen())
            .finish()
    }
}
impl W {
    ...
    ///Bit 26 - USB_PHY1 clock enable during CSleep mode
    #[inline(always)]
    pub fn usb1otghsulpilpen(&mut self) -> USB1OTGHSULPILPEN_W<C1_AHB1LPENRrs> {
        USB1OTGHSULPILPEN_W::new(self, 26)
    }
}
