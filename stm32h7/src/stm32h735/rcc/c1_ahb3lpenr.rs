...
impl W {
    ...
    ///Bit 8 - Flash interface Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn flashlpen(&mut self) -> FLASHLPEN_W<C1_AHB3LPENRrs> {
    ...
    ///Bit 14 - QUADSPI and QUADSPI Delay Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn octo1lpen(&mut self) -> OCTO1LPEN_W<C1_AHB3LPENRrs> {
        OCTO1LPEN_W::new(self, 14)
    }
    ///Bit 14 - OCTOSPI1 and OCTOSPI1 delay block enable during CSleep Mode
    #[inline(always)]
    pub fn octospi1lpen(&mut self) -> OCTOSPI1LPEN_W<C1_AHB3LPENRrs> {
    ...
    ///Bit 19 - OCTOSPI2 and OCTOSPI2 delay clock enable during CSleep mode Set and reset by software.
    #[inline(always)]
    pub fn octo2lpen(&mut self) -> OCTO2LPEN_W<C1_AHB3LPENRrs> {
        OCTO2LPEN_W::new(self, 19)
    }
    ///Bit 19 - OCTOSPI2 and OCTOSPI2 delay block enable during CSleep Mode
    #[inline(always)]
    pub fn octospi2lpen(&mut self) -> OCTOSPI2LPEN_W<C1_AHB3LPENRrs> {
        OCTOSPI2LPEN_W::new(self, 19)
    }
    ///Bit 21 - OCTOSPIM block clock enable during CSleep mode Set and reset by software.
    #[inline(always)]
    pub fn iomngrlpen(&mut self) -> IOMNGRLPEN_W<C1_AHB3LPENRrs> {
        IOMNGRLPEN_W::new(self, 21)
    }
    ///Bit 22 - OTFD1 block clock enable during CSleep mode Set and reset by software.
    #[inline(always)]
    pub fn otfd1lpen(&mut self) -> OTFD1LPEN_W<C1_AHB3LPENRrs> {
        OTFD1LPEN_W::new(self, 22)
    }
    ///Bit 23 - OTFD2 block clock enable during CSleep mode Set and reset by software.
    #[inline(always)]
    pub fn otfd2lpen(&mut self) -> OTFD2LPEN_W<C1_AHB3LPENRrs> {
        OTFD2LPEN_W::new(self, 23)
    }
    ///Bit 28 - D1DTCM1 Block Clock Enable During CSleep mode
    #[inline(always)]
    pub fn dtcm1lpen(&mut self) -> DTCM1LPEN_W<C1_AHB3LPENRrs> {
