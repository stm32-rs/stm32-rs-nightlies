...
impl From<I2C1235SEL> for u8 {
    #[inline(always)]
    fn from(variant: I2C1235SEL) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for I2C1235SEL {
    type Ux = u8;
}
impl crate::IsEnum for I2C1235SEL {}
///Field `I2C1235SEL` reader - I2C1,2,3 kernel clock source selection
pub type I2C1235SEL_R = crate::FieldReader<I2C1235SEL>;
impl I2C1235SEL_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> I2C1235SEL {
        match self.bits {
            0 => I2C1235SEL::RccPclk1,
            1 => I2C1235SEL::Pll3R,
            2 => I2C1235SEL::HsiKer,
            3 => I2C1235SEL::CsiKer,
            _ => unreachable!(),
    ...
    #[inline(always)]
    pub fn is_rcc_pclk1(&self) -> bool {
        *self == I2C1235SEL::RccPclk1
    }
    ///pll3_r selected as peripheral clock
    #[inline(always)]
    pub fn is_pll3_r(&self) -> bool {
        *self == I2C1235SEL::Pll3R
    }
    ///hsi_ker selected as peripheral clock
    #[inline(always)]
    pub fn is_hsi_ker(&self) -> bool {
        *self == I2C1235SEL::HsiKer
    }
    ///csi_ker selected as peripheral clock
    #[inline(always)]
    pub fn is_csi_ker(&self) -> bool {
        *self == I2C1235SEL::CsiKer
    }
}
///Field `I2C1235SEL` writer - I2C1,2,3 kernel clock source selection
pub type I2C1235SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2, I2C1235SEL, crate::Safe>;
impl<'a, REG> I2C1235SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn rcc_pclk1(self) -> &'a mut crate::W<REG> {
        self.variant(I2C1235SEL::RccPclk1)
    }
    ///pll3_r selected as peripheral clock
    #[inline(always)]
    pub fn pll3_r(self) -> &'a mut crate::W<REG> {
        self.variant(I2C1235SEL::Pll3R)
    }
    ///hsi_ker selected as peripheral clock
    #[inline(always)]
    pub fn hsi_ker(self) -> &'a mut crate::W<REG> {
        self.variant(I2C1235SEL::HsiKer)
    }
    ///csi_ker selected as peripheral clock
    #[inline(always)]
    pub fn csi_ker(self) -> &'a mut crate::W<REG> {
        self.variant(I2C1235SEL::CsiKer)
    }
}
...
impl W {
    ...
    ///Bits 12:13 - I2C1,2,3 kernel clock source selection
    #[inline(always)]
    pub fn i2c1235sel(&mut self) -> I2C1235SEL_W<D2CCIP2Rrs> {
        I2C1235SEL_W::new(self, 12)
    }
    ///Bits 20:21 - USBOTG 1 and 2 kernel clock source selection
    #[inline(always)]
