...
impl JEXTSEL_R {
    ...
    pub fn variant(&self) -> Option<JEXTSEL_A> {
        match self.bits {
            5 => Some(JEXTSEL_A::TIM4_TRGO),
            7 => Some(JEXTSEL_A::TIM8_CC4),
            9 => Some(JEXTSEL_A::TIM8_TRGO),
            10 => Some(JEXTSEL_A::TIM8_TRGO2),
            16 => Some(JEXTSEL_A::HRTIM1_ADCTRG2),
            17 => Some(JEXTSEL_A::HRTIM1_ADCTRG4),
            18 => Some(JEXTSEL_A::LPTIM1_OUT),
            19 => Some(JEXTSEL_A::LPTIM2_OUT),
            20 => Some(JEXTSEL_A::LPTIM3_OUT),
