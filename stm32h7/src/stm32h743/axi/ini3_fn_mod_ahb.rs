#[doc = "Reader of register INI3_FN_MOD_AHB"]
pub type R = crate::R<u32, super::INI3_FN_MOD_AHB>;
#[doc = "Writer for register INI3_FN_MOD_AHB"]
pub type W = crate::W<u32, super::INI3_FN_MOD_AHB>;
#[doc = "Register INI3_FN_MOD_AHB `reset()`'s with value 0x04"]
impl crate::ResetValue for super::INI3_FN_MOD_AHB {
    type Type = u32;
    #[inline(always)]
