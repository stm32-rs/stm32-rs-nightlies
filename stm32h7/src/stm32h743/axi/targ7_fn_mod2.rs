...
impl W {
    ///Bit 0 - Disable packing of beats to match the output data width
    #[inline(always)]
    pub fn bypass_merge(&mut self) -> BYPASS_MERGE_W<'_, TARG7_FN_MOD2rs> {
        BYPASS_MERGE_W::new(self, 0)
    }
}
/**AXI interconnect - TARG x bus matrix functionality 2 register

You can [`read`](crate::Reg::read) this register and get [`targ7_fn_mod2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`targ7_fn_mod2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H743.html#AXI:TARG7_FN_MOD2)*/
