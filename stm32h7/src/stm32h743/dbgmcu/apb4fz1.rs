...
pub type DBG_IWDG1_R = crate::BitReader;
///Field `DBG_IWDG1` writer - Independent watchdog for D1 stop in debug
pub type DBG_IWDG1_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB4FZ1")
            ...
            .field("dbg_iwdg1", &self.dbg_iwdg1())
            .finish()
    }
}
impl W {
    ...
    ///Bit 18 - Independent watchdog for D1 stop in debug
    #[inline(always)]
    pub fn dbg_iwdg1(&mut self) -> DBG_IWDG1_W<'_, APB4FZ1rs> {
        DBG_IWDG1_W::new(self, 18)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H743.html#DBGMCU:APB4FZ1)*/
