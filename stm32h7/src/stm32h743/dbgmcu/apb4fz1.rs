...
pub struct DBG_IWDG1_R(crate::FieldReader<bool, bool>);
impl DBG_IWDG1_R {
    pub(crate) fn new(bits: bool) -> Self {
        DBG_IWDG1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DBG_IWDG1_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DBG_IWDG1_W<'a> {
    w: &'a mut W,
}
impl<'a> DBG_IWDG1_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn dbg_iwdg1(&self) -> DBG_IWDG1_R {
        DBG_IWDG1_R::new(((self.bits >> 18) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 7 - I2C4 SMBUS timeout stop in debug"]
    ...
    #[doc = "Bit 18 - Independent watchdog for D1 stop in debug"]
    #[inline(always)]
    pub fn dbg_iwdg1(&mut self) -> DBG_IWDG1_W {
        DBG_IWDG1_W { w: self }
    }
