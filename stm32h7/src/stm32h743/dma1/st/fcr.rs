...
pub struct TRBUFF_R(crate::FieldReader<bool, TRBUFF_A>);
impl TRBUFF_R {
    pub(crate) fn new(bits: bool) -> Self {
        TRBUFF_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for TRBUFF_R {
    type Target = crate::FieldReader<bool, TRBUFF_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> TRBUFF_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: TRBUFF_A) -> &'a mut W {
        self.bit(variant.into())
    }
...
impl R {
    ...
    pub fn trbuff(&self) -> TRBUFF_R {
        TRBUFF_R::new(((self.bits >> 20) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 7 - FIFO error interrupt enable"]
