...
impl W {
    ///Bit 0 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr64(&mut self) -> MR64_W<'_, CPUIMR3rs> {
        MR64_W::new(self, 0)
    }
    ///Bit 1 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr65(&mut self) -> MR65_W<'_, CPUIMR3rs> {
        MR65_W::new(self, 1)
    }
    ///Bit 2 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr66(&mut self) -> MR66_W<'_, CPUIMR3rs> {
        MR66_W::new(self, 2)
    }
    ///Bit 3 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr67(&mut self) -> MR67_W<'_, CPUIMR3rs> {
        MR67_W::new(self, 3)
    }
    ///Bit 4 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr68(&mut self) -> MR68_W<'_, CPUIMR3rs> {
        MR68_W::new(self, 4)
    }
    ///Bit 5 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr69(&mut self) -> MR69_W<'_, CPUIMR3rs> {
        MR69_W::new(self, 5)
    }
    ///Bit 6 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr70(&mut self) -> MR70_W<'_, CPUIMR3rs> {
        MR70_W::new(self, 6)
    }
    ///Bit 7 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr71(&mut self) -> MR71_W<'_, CPUIMR3rs> {
        MR71_W::new(self, 7)
    }
    ///Bit 8 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr72(&mut self) -> MR72_W<'_, CPUIMR3rs> {
        MR72_W::new(self, 8)
    }
    ///Bit 9 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr73(&mut self) -> MR73_W<'_, CPUIMR3rs> {
        MR73_W::new(self, 9)
    }
    ///Bit 10 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr74(&mut self) -> MR74_W<'_, CPUIMR3rs> {
        MR74_W::new(self, 10)
    }
    ///Bit 11 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr75(&mut self) -> MR75_W<'_, CPUIMR3rs> {
        MR75_W::new(self, 11)
    }
    ///Bit 12 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr76(&mut self) -> MR76_W<'_, CPUIMR3rs> {
        MR76_W::new(self, 12)
    }
    ///Bit 13 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr77(&mut self) -> MR77_W<'_, CPUIMR3rs> {
        MR77_W::new(self, 13)
    }
    ///Bit 14 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr78(&mut self) -> MR78_W<'_, CPUIMR3rs> {
        MR78_W::new(self, 14)
    }
    ///Bit 15 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr79(&mut self) -> MR79_W<'_, CPUIMR3rs> {
        MR79_W::new(self, 15)
    }
    ///Bit 16 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr80(&mut self) -> MR80_W<'_, CPUIMR3rs> {
        MR80_W::new(self, 16)
    }
    ///Bit 18 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr82(&mut self) -> MR82_W<'_, CPUIMR3rs> {
        MR82_W::new(self, 18)
    }
    ///Bit 20 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr84(&mut self) -> MR84_W<'_, CPUIMR3rs> {
        MR84_W::new(self, 20)
    }
    ///Bit 21 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr85(&mut self) -> MR85_W<'_, CPUIMR3rs> {
        MR85_W::new(self, 21)
    }
    ///Bit 22 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr86(&mut self) -> MR86_W<'_, CPUIMR3rs> {
        MR86_W::new(self, 22)
    }
    ///Bit 23 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr87(&mut self) -> MR87_W<'_, CPUIMR3rs> {
        MR87_W::new(self, 23)
    }
    ///Bit 24 - CPU Interrupt Mask on Direct Event input x+64
    #[inline(always)]
    pub fn mr88(&mut self) -> MR88_W<'_, CPUIMR3rs> {
        MR88_W::new(self, 24)
    }
}
/**EXTI interrupt mask register

You can [`read`](crate::Reg::read) this register and get [`cpuimr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpuimr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H743.html#EXTI:CPUIMR3)*/
pub struct CPUIMR3rs;
impl crate::RegisterSpec for CPUIMR3rs {
    type Ux = u32;
}
///`read()` method returns [`cpuimr3::R`](R) reader structure
impl crate::Readable for CPUIMR3rs {}
///`write(|w| ..)` method takes [`cpuimr3::W`](W) writer structure
impl crate::Writable for CPUIMR3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CPUIMR3 to value 0
