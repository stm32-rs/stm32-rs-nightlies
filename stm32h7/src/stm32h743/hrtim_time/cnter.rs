///Register `CNTER` reader
pub type R = crate::R<CNTERrs>;
///Register `CNTER` writer
pub type W = crate::W<CNTERrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CNTER").field("cntx", &self.cntx()).finish()
    }
}
impl W {
    ///Bits 0:15 - Timerx Counter value
    #[inline(always)]
    #[must_use]
    pub fn cntx(&mut self) -> CNTX_W<CNTERrs> {
        CNTX_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H743.html#HRTIM_TIME:CNTER)*/
pub struct CNTERrs;
impl crate::RegisterSpec for CNTERrs {
    type Ux = u32;
}
///`read()` method returns [`cnter::R`](R) reader structure
impl crate::Readable for CNTERrs {}
///`write(|w| ..)` method takes [`cnter::W`](W) writer structure
impl crate::Writable for CNTERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CNTER to value 0
impl crate::Resettable for CNTERrs {
