/*!Peripheral access API for STM32H743 microcontrollers (generated using svd2rust v0.36.1 (4052ce6 2025-04-04))
...
pub enum Interrupt {
    ...
    RTC_ALARM = 41,
    ///43 - TIM8 break and TIM12 global interrupts
    TIM8_BRK_TIM12 = 43,
    ///44 - TIM8 update and TIM13 global interrupts
    TIM8_UP_TIM13 = 44,
    ///45 - TIM8 trigger /commutation and TIM14 global interrupts
...
///ECC controller is associated to each RAM area
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32H743.html#RAMECC2)
