#[doc = "Reader of register DOEPTSIZ7"]
pub type R = crate::R<u32, super::DOEPTSIZ7>;
#[doc = "Writer for register DOEPTSIZ7"]
pub type W = crate::W<u32, super::DOEPTSIZ7>;
#[doc = "Register DOEPTSIZ7 `reset()`'s with value 0"]
impl crate::ResetValue for super::DOEPTSIZ7 {
    type Type = u32;
    #[inline(always)]
