#[doc = "Reader of register HCTSIZ13"]
pub type R = crate::R<u32, super::HCTSIZ13>;
#[doc = "Writer for register HCTSIZ13"]
pub type W = crate::W<u32, super::HCTSIZ13>;
#[doc = "Register HCTSIZ13 `reset()`'s with value 0"]
impl crate::ResetValue for super::HCTSIZ13 {
    type Type = u32;
    #[inline(always)]
