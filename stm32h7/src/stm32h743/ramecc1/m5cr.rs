#[doc = "Reader of register M5CR"]
pub type R = crate::R<u32, super::M5CR>;
#[doc = "Writer for register M5CR"]
pub type W = crate::W<u32, super::M5CR>;
#[doc = "Register M5CR `reset()`'s with value 0"]
impl crate::ResetValue for super::M5CR {
    type Type = u32;
    #[inline(always)]
