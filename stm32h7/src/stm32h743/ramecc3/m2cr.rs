#[doc = "Reader of register M2CR"]
pub type R = crate::R<u32, super::M2CR>;
#[doc = "Writer for register M2CR"]
pub type W = crate::W<u32, super::M2CR>;
#[doc = "Register M2CR `reset()`'s with value 0"]
impl crate::ResetValue for super::M2CR {
    type Type = u32;
    #[inline(always)]
