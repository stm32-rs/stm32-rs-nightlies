...
///Field `USB2OTGULPIEN` reader - USB_PHY2 Clocks Enable
pub use DMA1EN_R as USB2OTGULPIEN_R;
...
///Field `USB2OTGULPIEN` writer - USB_PHY2 Clocks Enable
pub use DMA1EN_W as USB2OTGULPIEN_W;
impl R {
    ...
    #[inline(always)]
    pub fn usb2otgulpien(&self) -> USB2OTGULPIEN_R {
        USB2OTGULPIEN_R::new(((self.bits >> 28) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHB1ENR")
            ...
            .field("usb2otgulpien", &self.usb2otgulpien())
            .finish()
    }
}
impl W {
    ...
    ///Bit 27 - USB2OTG Peripheral Clocks Enable
    #[inline(always)]
    pub fn usb2otgen(&mut self) -> USB2OTGEN_W<AHB1ENRrs> {
        USB2OTGEN_W::new(self, 27)
    }
    ///Bit 28 - USB_PHY2 Clocks Enable
    #[inline(always)]
    pub fn usb2otgulpien(&mut self) -> USB2OTGULPIEN_W<AHB1ENRrs> {
        USB2OTGULPIEN_W::new(self, 28)
    }
}
