#[doc = "Reader of register INI1_FN_MOD2"]
pub type R = crate::R<u32, super::INI1_FN_MOD2>;
#[doc = "Writer for register INI1_FN_MOD2"]
pub type W = crate::W<u32, super::INI1_FN_MOD2>;
#[doc = "Register INI1_FN_MOD2 `reset()`'s with value 0x04"]
impl crate::ResetValue for super::INI1_FN_MOD2 {
    type Type = u32;
    #[inline(always)]
