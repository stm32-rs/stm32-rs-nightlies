///Register `CPUIMR1` reader
pub type R = crate::R<CPUIMR1rs>;
///Register `CPUIMR1` writer
pub type W = crate::W<CPUIMR1rs>;
...
impl W {
    ///Bit 0 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr0(&mut self) -> MR0_W<'_, CPUIMR1rs> {
        MR0_W::new(self, 0)
    }
    ///Bit 1 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr1(&mut self) -> MR1_W<'_, CPUIMR1rs> {
        MR1_W::new(self, 1)
    }
    ///Bit 2 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr2(&mut self) -> MR2_W<'_, CPUIMR1rs> {
        MR2_W::new(self, 2)
    }
    ///Bit 3 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr3(&mut self) -> MR3_W<'_, CPUIMR1rs> {
        MR3_W::new(self, 3)
    }
    ///Bit 4 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr4(&mut self) -> MR4_W<'_, CPUIMR1rs> {
        MR4_W::new(self, 4)
    }
    ///Bit 5 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr5(&mut self) -> MR5_W<'_, CPUIMR1rs> {
        MR5_W::new(self, 5)
    }
    ///Bit 6 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr6(&mut self) -> MR6_W<'_, CPUIMR1rs> {
        MR6_W::new(self, 6)
    }
    ///Bit 7 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr7(&mut self) -> MR7_W<'_, CPUIMR1rs> {
        MR7_W::new(self, 7)
    }
    ///Bit 8 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr8(&mut self) -> MR8_W<'_, CPUIMR1rs> {
        MR8_W::new(self, 8)
    }
    ///Bit 9 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr9(&mut self) -> MR9_W<'_, CPUIMR1rs> {
        MR9_W::new(self, 9)
    }
    ///Bit 10 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr10(&mut self) -> MR10_W<'_, CPUIMR1rs> {
        MR10_W::new(self, 10)
    }
    ///Bit 11 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr11(&mut self) -> MR11_W<'_, CPUIMR1rs> {
        MR11_W::new(self, 11)
    }
    ///Bit 12 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr12(&mut self) -> MR12_W<'_, CPUIMR1rs> {
        MR12_W::new(self, 12)
    }
    ///Bit 13 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr13(&mut self) -> MR13_W<'_, CPUIMR1rs> {
        MR13_W::new(self, 13)
    }
    ///Bit 14 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr14(&mut self) -> MR14_W<'_, CPUIMR1rs> {
        MR14_W::new(self, 14)
    }
    ///Bit 15 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr15(&mut self) -> MR15_W<'_, CPUIMR1rs> {
        MR15_W::new(self, 15)
    }
    ///Bit 16 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr16(&mut self) -> MR16_W<'_, CPUIMR1rs> {
        MR16_W::new(self, 16)
    }
    ///Bit 17 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr17(&mut self) -> MR17_W<'_, CPUIMR1rs> {
        MR17_W::new(self, 17)
    }
    ///Bit 18 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr18(&mut self) -> MR18_W<'_, CPUIMR1rs> {
        MR18_W::new(self, 18)
    }
    ///Bit 19 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr19(&mut self) -> MR19_W<'_, CPUIMR1rs> {
        MR19_W::new(self, 19)
    }
    ///Bit 20 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr20(&mut self) -> MR20_W<'_, CPUIMR1rs> {
        MR20_W::new(self, 20)
    }
    ///Bit 21 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr21(&mut self) -> MR21_W<'_, CPUIMR1rs> {
        MR21_W::new(self, 21)
    }
    ///Bit 22 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr22(&mut self) -> MR22_W<'_, CPUIMR1rs> {
        MR22_W::new(self, 22)
    }
    ///Bit 23 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr23(&mut self) -> MR23_W<'_, CPUIMR1rs> {
        MR23_W::new(self, 23)
    }
    ///Bit 24 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr24(&mut self) -> MR24_W<'_, CPUIMR1rs> {
        MR24_W::new(self, 24)
    }
    ///Bit 25 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr25(&mut self) -> MR25_W<'_, CPUIMR1rs> {
        MR25_W::new(self, 25)
    }
    ///Bit 26 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr26(&mut self) -> MR26_W<'_, CPUIMR1rs> {
        MR26_W::new(self, 26)
    }
    ///Bit 27 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr27(&mut self) -> MR27_W<'_, CPUIMR1rs> {
        MR27_W::new(self, 27)
    }
    ///Bit 28 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr28(&mut self) -> MR28_W<'_, CPUIMR1rs> {
        MR28_W::new(self, 28)
    }
    ///Bit 29 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr29(&mut self) -> MR29_W<'_, CPUIMR1rs> {
        MR29_W::new(self, 29)
    }
    ///Bit 30 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr30(&mut self) -> MR30_W<'_, CPUIMR1rs> {
        MR30_W::new(self, 30)
    }
    ///Bit 31 - Rising trigger event configuration bit of Configurable Event input
    #[inline(always)]
    pub fn mr31(&mut self) -> MR31_W<'_, CPUIMR1rs> {
        MR31_W::new(self, 31)
    }
}
/**EXTI interrupt mask register

You can [`read`](crate::Reg::read) this register and get [`cpuimr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpuimr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H743V.html#EXTI:CPUIMR1)*/
pub struct CPUIMR1rs;
impl crate::RegisterSpec for CPUIMR1rs {
    type Ux = u32;
}
///`read()` method returns [`cpuimr1::R`](R) reader structure
impl crate::Readable for CPUIMR1rs {}
///`write(|w| ..)` method takes [`cpuimr1::W`](W) writer structure
impl crate::Writable for CPUIMR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CPUIMR1 to value 0xffc0_0000
impl crate::Resettable for CPUIMR1rs {
