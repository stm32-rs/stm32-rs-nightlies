...
#[doc = "Timerx Interrupt Clear Register"]
pub mod timaicr;
#[doc = "TIMxDIER5\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timadier5](timadier5) module"]
pub type TIMADIER5 = crate::Reg<u32, _TIMADIER5>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _TIMADIER5;
#[doc = "`read()` method returns [timadier5::R](timadier5::R) reader structure"]
impl crate::Readable for TIMADIER5 {}
#[doc = "`write(|w| ..)` method takes [timadier5::W](timadier5::W) writer structure"]
impl crate::Writable for TIMADIER5 {}
#[doc = "TIMxDIER5"]
pub mod timadier5;
