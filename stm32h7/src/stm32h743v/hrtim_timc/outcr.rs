#[doc = "Reader of register OUTCR"]
pub type R = crate::R<u32, super::OUTCR>;
#[doc = "Writer for register OUTCR"]
pub type W = crate::W<u32, super::OUTCR>;
#[doc = "Register OUTCR `reset()`'s with value 0"]
impl crate::ResetValue for super::OUTCR {
    type Type = u32;
    #[inline(always)]
