...
#[doc = "`read()` method returns [r10::R](R) reader structure"]
impl crate::Readable for R10_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r10::W](W) writer structure"]
impl crate::Writable for R10_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R10 to value 0"]
