#[doc = "Reader of register BNDTR"]
pub type R = crate::R<u32, super::BNDTR>;
#[doc = "Writer for register BNDTR"]
pub type W = crate::W<u32, super::BNDTR>;
#[doc = "Register BNDTR `reset()`'s with value 0"]
impl crate::ResetValue for super::BNDTR {
    type Type = u32;
    #[inline(always)]
