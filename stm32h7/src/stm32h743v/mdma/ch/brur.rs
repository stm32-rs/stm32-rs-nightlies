#[doc = "Reader of register BRUR"]
pub type R = crate::R<u32, super::BRUR>;
#[doc = "Writer for register BRUR"]
pub type W = crate::W<u32, super::BRUR>;
#[doc = "Register BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::BRUR {
    type Type = u32;
    #[inline(always)]
