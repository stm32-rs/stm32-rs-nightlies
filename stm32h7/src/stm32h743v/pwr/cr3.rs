...
///Field `SCUEN` reader - SD converter Enable
pub type SCUEN_R = crate::BitReader;
///Field `SCUEN` writer - SD converter Enable
...
impl W {
    ...
    ///Bit 2 - SD converter Enable
    #[inline(always)]
    pub fn scuen(&mut self) -> SCUEN_W<'_, CR3rs> {
        SCUEN_W::new(self, 2)
    }
    ///Bit 8 - VBAT charging enable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H743V.html#PWR:CR3)*/
pub struct CR3rs;
