...
///Field `USB2OTGULPILPEN` reader - USB_PHY2 clocks enable during CSleep mode
pub use DMA1LPEN_R as USB2OTGULPILPEN_R;
...
///Field `USB2OTGULPILPEN` writer - USB_PHY2 clocks enable during CSleep mode
pub use DMA1LPEN_W as USB2OTGULPILPEN_W;
impl R {
    ...
    #[inline(always)]
    pub fn usb2otgulpilpen(&self) -> USB2OTGULPILPEN_R {
        USB2OTGULPILPEN_R::new(((self.bits >> 28) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("C1_AHB1LPENR")
            ...
            .field("usb2otgulpilpen", &self.usb2otgulpilpen())
            .finish()
    }
}
impl W {
    ...
    ///Bit 26 - USB_PHY1 clock enable during CSleep mode
    #[inline(always)]
    pub fn usb1otgulpilpen(&mut self) -> USB1OTGULPILPEN_W<C1_AHB1LPENRrs> {
        USB1OTGULPILPEN_W::new(self, 26)
    }
    ///Bit 27 - USB2OTG peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn usb2otglpen(&mut self) -> USB2OTGLPEN_W<C1_AHB1LPENRrs> {
        USB2OTGLPEN_W::new(self, 27)
    }
    ///Bit 28 - USB_PHY2 clocks enable during CSleep mode
    #[inline(always)]
    pub fn usb2otgulpilpen(&mut self) -> USB2OTGULPILPEN_W<C1_AHB1LPENRrs> {
        USB2OTGULPILPEN_W::new(self, 28)
    }
}
