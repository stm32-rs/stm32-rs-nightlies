...
impl W {
    ...
    ///Bit 28 - USB_PHY2 clocks enable during CSleep mode
    #[inline(always)]
    pub fn usb2otgulpilpen(&mut self) -> USB2OTGULPILPEN_W<'_, C1_AHB1LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H743V.html#RCC:C1_AHB1LPENR)*/
