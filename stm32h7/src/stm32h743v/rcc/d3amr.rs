...
///Field `BKPRAMAMEN` reader - Backup RAM Autonomous mode enable
...
///Field `BKPRAMAMEN` writer - Backup RAM Autonomous mode enable
...
impl W {
    ...
    ///Bit 28 - Backup RAM Autonomous mode enable
    #[inline(always)]
    pub fn bkpramamen(&mut self) -> BKPRAMAMEN_W<'_, D3AMRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H743V.html#RCC:D3AMR)*/
pub struct D3AMRrs;
