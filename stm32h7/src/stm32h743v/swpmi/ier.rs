...
#[doc = "Reader of field `RDYIE`"]
pub type RDYIE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RDYIE`"]
pub struct RDYIE_W<'a> {
    w: &'a mut W,
}
impl<'a> RDYIE_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn rdyie(&self) -> RDYIE_R {
        RDYIE_R::new(((self.bits >> 11) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Receive buffer full interrupt enable"]
