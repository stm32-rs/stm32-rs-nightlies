...
///Field `CGIF(1-8)` writer - Channel %s Global interrupt clear
...
///Field `CTCIF(1-8)` writer - Channel %s Transfer Complete clear
...
///Field `CHTIF(1-8)` writer - Channel %s Half Transfer clear
...
///Field `CTEIF(1-8)` writer - Channel %s Transfer Error clear
...
impl W {
    ///Channel (1-8) Global interrupt clear
    ///
    ...
    #[inline(always)]
    pub fn cgif8(&mut self) -> CGIF_W<'_, IFCRrs> {
        CGIF_W::new(self, 28)
    }
    ///Channel (1-8) Transfer Complete clear
    ///
    ...
    #[inline(always)]
    pub fn ctcif8(&mut self) -> CTCIF_W<'_, IFCRrs> {
        CTCIF_W::new(self, 29)
    }
    ///Channel (1-8) Half Transfer clear
    ///
    ...
    #[inline(always)]
    pub fn chtif8(&mut self) -> CHTIF_W<'_, IFCRrs> {
        CHTIF_W::new(self, 30)
    }
    ///Channel (1-8) Transfer Error clear
    ///
    ...
    #[inline(always)]
    pub fn cteif8(&mut self) -> CTEIF_W<'_, IFCRrs> {
        CTEIF_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#BDMA:IFCR)*/
pub struct IFCRrs;
