...
///Field `FECAP` reader - Frequency error capture FECAP is the frequency error counter value latched in the time of the last SYNC event. Refer to Section7.3.4: Frequency error evaluation and automatic trimming for more details about FECAP usage.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#CRS:ISR)*/
pub struct ISRrs;
