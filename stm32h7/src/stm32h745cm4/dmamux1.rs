...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#DMAMUX1:C[0]CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#DMAMUX1:CSR)

For information about available fields see [`mod@csr`] module*/
pub type CSR = crate::Reg<csr::CSRrs>;
///
pub mod csr;
/**CFR (rw) register accessor:
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#DMAMUX1:CFR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#DMAMUX1:RG[0]CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#DMAMUX1:RGSR)

For information about available fields see [`mod@rgsr`] module*/
pub type RGSR = crate::Reg<rgsr::RGSRrs>;
///
pub mod rgsr;
/**RGCFR (rw) register accessor:
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#DMAMUX1:RGCFR)
