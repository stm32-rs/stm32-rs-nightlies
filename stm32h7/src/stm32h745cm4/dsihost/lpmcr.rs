...
impl W {
    ///Bits 0:7 - VACT largest packet size
    #[inline(always)]
    pub fn vlpsize(&mut self) -> VLPSIZE_W<'_, LPMCRrs> {
        VLPSIZE_W::new(self, 0)
    }
    ///Bits 16:23 - Largest packet size
    #[inline(always)]
    pub fn lpsize(&mut self) -> LPSIZE_W<'_, LPMCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#DSIHOST:LPMCR)*/
pub struct LPMCRrs;
