...
///Timer A compare %s
pub use crate::stm32h745cm4::hrtim_tima::set1r::CMP1;
///Field `CMP(1-4)` reader - Timer A compare %s
pub use crate::stm32h745cm4::hrtim_tima::set1r::CMP_R;
///Field `CMP(1-4)` writer - Timer A compare %s
pub use crate::stm32h745cm4::hrtim_tima::set1r::CMP_W;
///External Event %s
pub use crate::stm32h745cm4::hrtim_tima::set1r::EXTEVNT1;
///Field `EXTEVNT(1-10)` reader - External Event %s
pub use crate::stm32h745cm4::hrtim_tima::set1r::EXTEVNT_R;
///Field `EXTEVNT(1-10)` writer - External Event %s
pub use crate::stm32h745cm4::hrtim_tima::set1r::EXTEVNT_W;
///Master Compare %s
pub use crate::stm32h745cm4::hrtim_tima::set1r::MSTCMP1;
///Field `MSTCMP(1-4)` reader - Master Compare %s
pub use crate::stm32h745cm4::hrtim_tima::set1r::MSTCMP_R;
///Field `MSTCMP(1-4)` writer - Master Compare %s
pub use crate::stm32h745cm4::hrtim_tima::set1r::MSTCMP_W;
///Master Period
pub use crate::stm32h745cm4::hrtim_tima::set1r::MSTPER;
///Field `MSTPER` reader - Master Period
pub use crate::stm32h745cm4::hrtim_tima::set1r::MSTPER_R;
///Field `MSTPER` writer - Master Period
pub use crate::stm32h745cm4::hrtim_tima::set1r::MSTPER_W;
///Timer A Period
pub use crate::stm32h745cm4::hrtim_tima::set1r::PER;
///Field `PER` reader - Timer A Period
pub use crate::stm32h745cm4::hrtim_tima::set1r::PER_R;
///Field `PER` writer - Timer A Period
pub use crate::stm32h745cm4::hrtim_tima::set1r::PER_W;
///Timer A resynchronizaton
pub use crate::stm32h745cm4::hrtim_tima::set1r::RESYNC;
///Field `RESYNC` reader - Timer A resynchronizaton
pub use crate::stm32h745cm4::hrtim_tima::set1r::RESYNC_R;
///Field `RESYNC` writer - Timer A resynchronizaton
pub use crate::stm32h745cm4::hrtim_tima::set1r::RESYNC_W;
///Software Set trigger
pub use crate::stm32h745cm4::hrtim_tima::set1r::SST;
///Field `SST` reader - Software Set trigger
pub use crate::stm32h745cm4::hrtim_tima::set1r::SST_R;
///Field `SST` writer - Software Set trigger
pub use crate::stm32h745cm4::hrtim_tima::set1r::SST_W;
///Timer A Compare 2
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1;
///Field `TIMACMP2` reader - Timer A Compare 2
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_R as TIMACMP2_R;
///Field `TIMACMP3` reader - Timer A Compare 3
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_R as TIMACMP3_R;
///Field `TIMBCMP2` reader - Timer B Compare 2
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_R as TIMBCMP2_R;
///Field `TIMBCMP3` reader - Timer B Compare 3
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_R as TIMBCMP3_R;
///Field `TIMDCMP2` reader - Timer D Compare 2
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_R as TIMDCMP2_R;
///Field `TIMDCMP4` reader - Timer D Compare 4
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_R as TIMDCMP4_R;
///Field `TIMECMP2` reader - Timer E Compare 2
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_R as TIMECMP2_R;
///Field `TIMECMP3` reader - Timer E Compare 3
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_R as TIMECMP3_R;
///Field `TIMECMP4` reader - Timer E Compare 4
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_R as TIMECMP4_R;
///Field `TIMACMP2` writer - Timer A Compare 2
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_W as TIMACMP2_W;
///Field `TIMACMP3` writer - Timer A Compare 3
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_W as TIMACMP3_W;
///Field `TIMBCMP2` writer - Timer B Compare 2
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_W as TIMBCMP2_W;
///Field `TIMBCMP3` writer - Timer B Compare 3
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_W as TIMBCMP3_W;
///Field `TIMDCMP2` writer - Timer D Compare 2
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_W as TIMDCMP2_W;
///Field `TIMDCMP4` writer - Timer D Compare 4
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_W as TIMDCMP4_W;
///Field `TIMECMP2` writer - Timer E Compare 2
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_W as TIMECMP2_W;
///Field `TIMECMP3` writer - Timer E Compare 3
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_W as TIMECMP3_W;
///Field `TIMECMP4` writer - Timer E Compare 4
pub use crate::stm32h745cm4::hrtim_tima::set1r::TIMBCMP1_W as TIMECMP4_W;
///Registers update (transfer preload to active)
pub use crate::stm32h745cm4::hrtim_tima::set1r::UPDATE;
///Field `UPDATE` reader - Registers update (transfer preload to active)
pub use crate::stm32h745cm4::hrtim_tima::set1r::UPDATE_R;
///Field `UPDATE` writer - Registers update (transfer preload to active)
pub use crate::stm32h745cm4::hrtim_tima::set1r::UPDATE_W;
impl R {
    ...
    pub fn timecmp2(&self) -> TIMECMP2_R {
        TIMECMP2_R::new(((self.bits >> 18) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 13 - Timer A Compare 3
    #[inline(always)]
    pub fn timacmp3(&mut self) -> TIMACMP3_W<'_, SET1Rrs> {
        TIMACMP3_W::new(self, 13)
    }
    ///Bit 14 - Timer B Compare 2
    #[inline(always)]
    pub fn timbcmp2(&mut self) -> TIMBCMP2_W<'_, SET1Rrs> {
    ...
    pub fn timecmp2(&mut self) -> TIMECMP2_W<'_, SET1Rrs> {
        TIMECMP2_W::new(self, 18)
    }
    ///Bit 19 - Timer E Compare 3
    #[inline(always)]
    pub fn timecmp3(&mut self) -> TIMECMP3_W<'_, SET1Rrs> {
        TIMECMP3_W::new(self, 19)
    }
    ///Bit 20 - Timer E Compare 4
    #[inline(always)]
    pub fn timecmp4(&mut self) -> TIMECMP4_W<'_, SET1Rrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#HRTIM_TIMC:SET1R)*/
pub struct SET1Rrs;
