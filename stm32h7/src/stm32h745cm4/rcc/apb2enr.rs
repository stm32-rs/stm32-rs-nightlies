...
impl W {
    ...
    ///Bit 24 - SAI3 Peripheral Clocks Enable
    #[inline(always)]
    pub fn sai3en(&mut self) -> SAI3EN_W<'_, APB2ENRrs> {
    ...
    ///Bit 29 - HRTIM peripheral clock enable
    #[inline(always)]
    pub fn hrtimen(&mut self) -> HRTIMEN_W<'_, APB2ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#RCC:APB2ENR)*/
