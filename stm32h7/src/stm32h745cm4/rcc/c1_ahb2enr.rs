...
impl W {
    ///Bit 0 - DCMI peripheral clock
    #[inline(always)]
    pub fn dcmien(&mut self) -> DCMIEN_W<C1_AHB2ENRrs> {
        DCMIEN_W::new(self, 0)
    }
    ///Bit 4 - CRYPT peripheral clock enable
    #[inline(always)]
    pub fn crypten(&mut self) -> CRYPTEN_W<C1_AHB2ENRrs> {
        CRYPTEN_W::new(self, 4)
    }
    ///Bit 5 - HASH peripheral clock enable
    #[inline(always)]
    pub fn hashen(&mut self) -> HASHEN_W<C1_AHB2ENRrs> {
        HASHEN_W::new(self, 5)
    }
    ///Bit 6 - RNG peripheral clocks enable
    #[inline(always)]
    pub fn rngen(&mut self) -> RNGEN_W<C1_AHB2ENRrs> {
        RNGEN_W::new(self, 6)
    }
    ///Bit 9 - SDMMC2 and SDMMC2 delay clock enable
    #[inline(always)]
    pub fn sdmmc2en(&mut self) -> SDMMC2EN_W<C1_AHB2ENRrs> {
        SDMMC2EN_W::new(self, 9)
    }
    ///Bit 29 - SRAM1 block enable
    #[inline(always)]
    pub fn sram1en(&mut self) -> SRAM1EN_W<C1_AHB2ENRrs> {
        SRAM1EN_W::new(self, 29)
    }
    ///Bit 30 - SRAM2 block enable
    #[inline(always)]
    pub fn sram2en(&mut self) -> SRAM2EN_W<C1_AHB2ENRrs> {
        SRAM2EN_W::new(self, 30)
    }
    ///Bit 31 - SRAM3 block enable
    #[inline(always)]
    pub fn sram3en(&mut self) -> SRAM3EN_W<C1_AHB2ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#RCC:C1_AHB2ENR)*/
