///Register `C1_APB1LENR` reader
pub type R = crate::R<C1_APB1LENRrs>;
///Register `C1_APB1LENR` writer
...
///Field `WWDG2EN` reader - WWDG2 peripheral clock enable
...
///Field `DAC12EN` reader - DAC1&2 peripheral clock enable
...
///Field `WWDG2EN` writer - WWDG2 peripheral clock enable
...
///Field `DAC12EN` writer - DAC1&2 peripheral clock enable
...
impl R {
    ...
    ///Bit 11 - WWDG2 peripheral clock enable
    #[inline(always)]
...
impl W {
    ///Bit 0 - TIM peripheral clock enable
    #[inline(always)]
    pub fn tim2en(&mut self) -> TIM2EN_W<'_, C1_APB1LENRrs> {
        TIM2EN_W::new(self, 0)
    }
    ///Bit 1 - TIM peripheral clock enable
    #[inline(always)]
    pub fn tim3en(&mut self) -> TIM3EN_W<'_, C1_APB1LENRrs> {
        TIM3EN_W::new(self, 1)
    }
    ///Bit 2 - TIM peripheral clock enable
    #[inline(always)]
    pub fn tim4en(&mut self) -> TIM4EN_W<'_, C1_APB1LENRrs> {
        TIM4EN_W::new(self, 2)
    }
    ///Bit 3 - TIM peripheral clock enable
    #[inline(always)]
    pub fn tim5en(&mut self) -> TIM5EN_W<'_, C1_APB1LENRrs> {
        TIM5EN_W::new(self, 3)
    }
    ///Bit 4 - TIM peripheral clock enable
    #[inline(always)]
    pub fn tim6en(&mut self) -> TIM6EN_W<'_, C1_APB1LENRrs> {
        TIM6EN_W::new(self, 4)
    }
    ///Bit 5 - TIM peripheral clock enable
    #[inline(always)]
    pub fn tim7en(&mut self) -> TIM7EN_W<'_, C1_APB1LENRrs> {
        TIM7EN_W::new(self, 5)
    }
    ///Bit 6 - TIM peripheral clock enable
    #[inline(always)]
    pub fn tim12en(&mut self) -> TIM12EN_W<'_, C1_APB1LENRrs> {
        TIM12EN_W::new(self, 6)
    }
    ///Bit 7 - TIM peripheral clock enable
    #[inline(always)]
    pub fn tim13en(&mut self) -> TIM13EN_W<'_, C1_APB1LENRrs> {
        TIM13EN_W::new(self, 7)
    }
    ///Bit 8 - TIM peripheral clock enable
    #[inline(always)]
    pub fn tim14en(&mut self) -> TIM14EN_W<'_, C1_APB1LENRrs> {
        TIM14EN_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1 Peripheral Clocks Enable
    #[inline(always)]
    pub fn lptim1en(&mut self) -> LPTIM1EN_W<'_, C1_APB1LENRrs> {
        LPTIM1EN_W::new(self, 9)
    }
    ///Bit 11 - WWDG2 peripheral clock enable
    #[inline(always)]
    pub fn wwdg2en(&mut self) -> WWDG2EN_W<'_, C1_APB1LENRrs> {
        WWDG2EN_W::new(self, 11)
    }
    ///Bit 14 - SPI2 Peripheral Clocks Enable
    #[inline(always)]
    pub fn spi2en(&mut self) -> SPI2EN_W<'_, C1_APB1LENRrs> {
        SPI2EN_W::new(self, 14)
    }
    ///Bit 15 - SPI3 Peripheral Clocks Enable
    #[inline(always)]
    pub fn spi3en(&mut self) -> SPI3EN_W<'_, C1_APB1LENRrs> {
        SPI3EN_W::new(self, 15)
    }
    ///Bit 16 - SPDIFRX Peripheral Clocks Enable
    #[inline(always)]
    pub fn spdifrxen(&mut self) -> SPDIFRXEN_W<'_, C1_APB1LENRrs> {
        SPDIFRXEN_W::new(self, 16)
    }
    ///Bit 17 - USART2 Peripheral Clocks Enable
    #[inline(always)]
    pub fn usart2en(&mut self) -> USART2EN_W<'_, C1_APB1LENRrs> {
        USART2EN_W::new(self, 17)
    }
    ///Bit 18 - USART3 Peripheral Clocks Enable
    #[inline(always)]
    pub fn usart3en(&mut self) -> USART3EN_W<'_, C1_APB1LENRrs> {
        USART3EN_W::new(self, 18)
    }
    ///Bit 19 - UART4 Peripheral Clocks Enable
    #[inline(always)]
    pub fn uart4en(&mut self) -> UART4EN_W<'_, C1_APB1LENRrs> {
        UART4EN_W::new(self, 19)
    }
    ///Bit 20 - UART5 Peripheral Clocks Enable
    #[inline(always)]
    pub fn uart5en(&mut self) -> UART5EN_W<'_, C1_APB1LENRrs> {
        UART5EN_W::new(self, 20)
    }
    ///Bit 21 - I2C1 Peripheral Clocks Enable
    #[inline(always)]
    pub fn i2c1en(&mut self) -> I2C1EN_W<'_, C1_APB1LENRrs> {
        I2C1EN_W::new(self, 21)
    }
    ///Bit 22 - I2C2 Peripheral Clocks Enable
    #[inline(always)]
    pub fn i2c2en(&mut self) -> I2C2EN_W<'_, C1_APB1LENRrs> {
        I2C2EN_W::new(self, 22)
    }
    ///Bit 23 - I2C3 Peripheral Clocks Enable
    #[inline(always)]
    pub fn i2c3en(&mut self) -> I2C3EN_W<'_, C1_APB1LENRrs> {
        I2C3EN_W::new(self, 23)
    }
    ///Bit 27 - HDMI-CEC peripheral clock enable
    #[inline(always)]
    pub fn cecen(&mut self) -> CECEN_W<'_, C1_APB1LENRrs> {
        CECEN_W::new(self, 27)
    }
    ///Bit 29 - DAC1&2 peripheral clock enable
    #[inline(always)]
    pub fn dac12en(&mut self) -> DAC12EN_W<'_, C1_APB1LENRrs> {
        DAC12EN_W::new(self, 29)
    }
    ///Bit 30 - UART7 Peripheral Clocks Enable
    #[inline(always)]
    pub fn uart7en(&mut self) -> UART7EN_W<'_, C1_APB1LENRrs> {
        UART7EN_W::new(self, 30)
    }
    ///Bit 31 - UART8 Peripheral Clocks Enable
    #[inline(always)]
    pub fn uart8en(&mut self) -> UART8EN_W<'_, C1_APB1LENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#RCC:C1_APB1LENR)*/
pub struct C1_APB1LENRrs;
impl crate::RegisterSpec for C1_APB1LENRrs {
    type Ux = u32;
}
///`read()` method returns [`c1_apb1lenr::R`](R) reader structure
impl crate::Readable for C1_APB1LENRrs {}
///`write(|w| ..)` method takes [`c1_apb1lenr::W`](W) writer structure
impl crate::Writable for C1_APB1LENRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C1_APB1LENR to value 0
