///Register `C1_RSR` reader
pub type R = crate::R<C1_RSRrs>;
///Register `C1_RSR` writer
...
impl W {
    ///Bit 16 - Remove reset flag
    #[inline(always)]
    pub fn rmvf(&mut self) -> RMVF_W<'_, C1_RSRrs> {
        RMVF_W::new(self, 16)
    }
    ///Bit 17 - CPU reset flag
    #[inline(always)]
    pub fn cpurstf(&mut self) -> CPURSTF_W<'_, C1_RSRrs> {
        CPURSTF_W::new(self, 17)
    }
    ///Bit 19 - D1 domain power switch reset flag
    #[inline(always)]
    pub fn d1rstf(&mut self) -> D1RSTF_W<'_, C1_RSRrs> {
        D1RSTF_W::new(self, 19)
    }
    ///Bit 20 - D2 domain power switch reset flag
    #[inline(always)]
    pub fn d2rstf(&mut self) -> D2RSTF_W<'_, C1_RSRrs> {
        D2RSTF_W::new(self, 20)
    }
    ///Bit 21 - BOR reset flag
    #[inline(always)]
    pub fn borrstf(&mut self) -> BORRSTF_W<'_, C1_RSRrs> {
        BORRSTF_W::new(self, 21)
    }
    ///Bit 22 - Pin reset flag (NRST)
    #[inline(always)]
    pub fn pinrstf(&mut self) -> PINRSTF_W<'_, C1_RSRrs> {
        PINRSTF_W::new(self, 22)
    }
    ///Bit 23 - POR/PDR reset flag
    #[inline(always)]
    pub fn porrstf(&mut self) -> PORRSTF_W<'_, C1_RSRrs> {
        PORRSTF_W::new(self, 23)
    }
    ///Bit 24 - System reset from CPU reset flag
    #[inline(always)]
    pub fn sftrstf(&mut self) -> SFTRSTF_W<'_, C1_RSRrs> {
        SFTRSTF_W::new(self, 24)
    }
    ///Bit 26 - Independent Watchdog reset flag
    #[inline(always)]
    pub fn iwdg1rstf(&mut self) -> IWDG1RSTF_W<'_, C1_RSRrs> {
        IWDG1RSTF_W::new(self, 26)
    }
    ///Bit 28 - Window Watchdog reset flag
    #[inline(always)]
    pub fn wwdg1rstf(&mut self) -> WWDG1RSTF_W<'_, C1_RSRrs> {
        WWDG1RSTF_W::new(self, 28)
    }
    ///Bit 30 - Reset due to illegal D1 DStandby or CPU CStop flag
    #[inline(always)]
    pub fn lpwrrstf(&mut self) -> LPWRRSTF_W<'_, C1_RSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM4.html#RCC:C1_RSR)*/
pub struct C1_RSRrs;
impl crate::RegisterSpec for C1_RSRrs {
    type Ux = u32;
}
///`read()` method returns [`c1_rsr::R`](R) reader structure
impl crate::Readable for C1_RSRrs {}
///`write(|w| ..)` method takes [`c1_rsr::W`](W) writer structure
impl crate::Writable for C1_RSRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C1_RSR to value 0
