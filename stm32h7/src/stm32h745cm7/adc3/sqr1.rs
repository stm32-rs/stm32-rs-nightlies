...
impl W {
    ...
    ///Bits 6:10 - 1 conversion in regular sequence
    #[inline(always)]
    pub fn sq1(&mut self) -> SQ_W<'_, SQR1rs> {
        SQ_W::new(self, 6)
    }
    ///Bits 12:16 - 2 conversion in regular sequence
    #[inline(always)]
    pub fn sq2(&mut self) -> SQ_W<'_, SQR1rs> {
        SQ_W::new(self, 12)
    }
    ///Bits 18:22 - 3 conversion in regular sequence
    #[inline(always)]
    pub fn sq3(&mut self) -> SQ_W<'_, SQR1rs> {
        SQ_W::new(self, 18)
    }
    ///Bits 24:28 - 4 conversion in regular sequence
    #[inline(always)]
    pub fn sq4(&mut self) -> SQ_W<'_, SQR1rs> {
        SQ_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#ADC3:SQR1)*/
pub struct SQR1rs;
