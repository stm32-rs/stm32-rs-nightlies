...
impl W {
    ...
    ///Bits 0:4 - 5 conversion in regular sequence
    #[inline(always)]
    pub fn sq5(&mut self) -> SQ_W<'_, SQR2rs> {
        SQ_W::new(self, 0)
    }
    ///Bits 6:10 - 6 conversion in regular sequence
    #[inline(always)]
    pub fn sq6(&mut self) -> SQ_W<'_, SQR2rs> {
        SQ_W::new(self, 6)
    }
    ///Bits 12:16 - 7 conversion in regular sequence
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#ADC3:SQR2)*/
pub struct SQR2rs;
