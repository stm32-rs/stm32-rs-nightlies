///Register `INI6_READ_QOS` reader
pub type R = crate::R<INI6_READ_QOSrs>;
///Register `INI6_READ_QOS` writer
...
impl W {
    ///Bits 0:3 - Read channel QoS setting
    #[inline(always)]
    pub fn ar_qos(&mut self) -> AR_QOS_W<'_, INI6_READ_QOSrs> {
        AR_QOS_W::new(self, 0)
    }
}
/**AXI interconnect - INI x read QoS register

You can [`read`](crate::Reg::read) this register and get [`ini6_read_qos::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ini6_read_qos::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`ini6_read_qos::R`](R) reader structure
impl crate::Readable for INI6_READ_QOSrs {}
///`write(|w| ..)` method takes [`ini6_read_qos::W`](W) writer structure
impl crate::Writable for INI6_READ_QOSrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets INI6_READ_QOS to value 0x04
