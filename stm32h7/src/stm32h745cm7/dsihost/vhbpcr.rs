...
///Field `HBP` writer - Horizontal back-porch duration
...
impl W {
    ///Bits 0:11 - Horizontal back-porch duration
    #[inline(always)]
    pub fn hbp(&mut self) -> HBP_W<'_, VHBPCRrs> {
        HBP_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#DSIHOST:VHBPCR)*/
pub struct VHBPCRrs;
