...
pub type R = crate::R<BOOT4_CURR_rs>;
///Register `BOOT4_CURR_` writer
pub type W = crate::W<BOOT4_CURR_rs>;
...
impl W {
    ///Bits 0:15 - Arm Cortex-M4 boot address 0
    #[inline(always)]
    pub fn boot_cm4_add0(&mut self) -> BOOT_CM4_ADD0_W<'_, BOOT4_CURR_rs> {
        BOOT_CM4_ADD0_W::new(self, 0)
    }
    ///Bits 16:31 - Arm Cortex-M4 boot address 1
    #[inline(always)]
    pub fn boot_cm4_add1(&mut self) -> BOOT_CM4_ADD1_W<'_, BOOT4_CURR_rs> {
        BOOT_CM4_ADD1_W::new(self, 16)
    }
}
/**FLASH register boot address for Arm Cortex-M4 core

You can [`read`](crate::Reg::read) this register and get [`boot4_curr_::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`boot4_curr_::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#FLASH:BOOT4_CURR_)*/
pub struct BOOT4_CURR_rs;
impl crate::RegisterSpec for BOOT4_CURR_rs {
    type Ux = u32;
}
///`read()` method returns [`boot4_curr_::R`](R) reader structure
impl crate::Readable for BOOT4_CURR_rs {}
///`write(|w| ..)` method takes [`boot4_curr_::W`](W) writer structure
impl crate::Writable for BOOT4_CURR_rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets BOOT4_CURR_ to value 0
impl crate::Resettable for BOOT4_CURR_rs {}
