...
impl W {
    ...
    ///Bit 11 - ADC trigger 2 on Timer A compare 3
    #[inline(always)]
    pub fn ac3(&mut self) -> AC3_W<ADC2Rrs> {
        AC3_W::new(self, 11)
    }
    ///Bit 12 - ADC trigger 2 on Timer A compare 4
    #[inline(always)]
    ...
    ///Bit 15 - ADC trigger 2 on Timer B compare 3
    #[inline(always)]
    pub fn bc3(&mut self) -> BC3_W<ADC2Rrs> {
        BC3_W::new(self, 15)
    }
    ///Bit 16 - ADC trigger 2 on Timer B compare 4
    #[inline(always)]
    ...
    ///Bit 19 - ADC trigger 2 on Timer C compare 3
    #[inline(always)]
    pub fn cc3(&mut self) -> CC3_W<ADC2Rrs> {
        CC3_W::new(self, 19)
    }
    ///Bit 20 - ADC trigger 2 on Timer C compare 4
    #[inline(always)]
    ...
    ///Bit 24 - ADC trigger 2 on Timer D compare 3
    #[inline(always)]
    pub fn dc3(&mut self) -> DC3_W<ADC2Rrs> {
        DC3_W::new(self, 24)
    }
    ///Bit 25 - ADC trigger 2 on Timer D compare 4
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#HRTIM_Common:ADC2R)*/
pub struct ADC2Rrs;
