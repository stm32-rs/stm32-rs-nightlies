...
///Continuous mode
pub use crate::stm32h745cm7::hrtim_master::cr::CONT;
///Field `CONT` reader - Continuous mode
pub use crate::stm32h745cm7::hrtim_master::cr::CONT_R;
///Field `CONT` writer - Continuous mode
pub use crate::stm32h745cm7::hrtim_master::cr::CONT_W;
///Half mode enable
pub use crate::stm32h745cm7::hrtim_master::cr::HALF;
///Field `HALF` reader - Half mode enable
pub use crate::stm32h745cm7::hrtim_master::cr::HALF_R;
///Field `HALF` writer - Half mode enable
pub use crate::stm32h745cm7::hrtim_master::cr::HALF_W;
///Re-triggerable mode
pub use crate::stm32h745cm7::hrtim_master::cr::RETRIG;
///Field `RETRIG` reader - Re-triggerable mode
pub use crate::stm32h745cm7::hrtim_master::cr::RETRIG_R;
///Field `RETRIG` writer - Re-triggerable mode
pub use crate::stm32h745cm7::hrtim_master::cr::RETRIG_W;
...
pub use crate::stm32h745cm7::hrtim_master::cr::SYNCRST;
///Field `SYNCRST` reader - Synchronization Resets Timer x
pub use crate::stm32h745cm7::hrtim_master::cr::SYNCRST_R;
///Field `SYNCRST` writer - Synchronization Resets Timer x
pub use crate::stm32h745cm7::hrtim_master::cr::SYNCRST_W;
///Synchronization Starts Timer x
pub use crate::stm32h745cm7::hrtim_master::cr::SYNCSTRT;
///Field `SYNCSTRT` reader - Synchronization Starts Timer x
pub use crate::stm32h745cm7::hrtim_master::cr::SYNCSTRT_R;
///Field `SYNCSTRT` writer - Synchronization Starts Timer x
pub use crate::stm32h745cm7::hrtim_master::cr::SYNCSTRT_W;
/**Delayed CMP2 mode
...
///AC Synchronization
pub use crate::stm32h745cm7::hrtim_master::cr::DACSYNC;
///Field `DACSYNC` reader - AC Synchronization
pub use crate::stm32h745cm7::hrtim_master::cr::DACSYNC_R;
///Field `DACSYNC` writer - AC Synchronization
pub use crate::stm32h745cm7::hrtim_master::cr::DACSYNC_W;
///Preload enable
pub use crate::stm32h745cm7::hrtim_master::cr::PREEN;
///Field `PREEN` reader - Preload enable
pub use crate::stm32h745cm7::hrtim_master::cr::PREEN_R;
///Field `PREEN` writer - Preload enable
pub use crate::stm32h745cm7::hrtim_master::cr::PREEN_W;
/**Update Gating
