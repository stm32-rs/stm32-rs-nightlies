...
///Continuous mode
pub use crate::stm32h745cm7::hrtim_tima::cr::CONT;
///Field `CONT` reader - Continuous mode
pub use crate::stm32h745cm7::hrtim_tima::cr::CONT_R;
///Field `CONT` writer - Continuous mode
pub use crate::stm32h745cm7::hrtim_tima::cr::CONT_W;
///Delayed CMP2 mode
...
///Half mode enable
pub use crate::stm32h745cm7::hrtim_tima::cr::HALF;
///Field `HALF` reader - Half mode enable
pub use crate::stm32h745cm7::hrtim_tima::cr::HALF_R;
///Field `HALF` writer - Half mode enable
pub use crate::stm32h745cm7::hrtim_tima::cr::HALF_W;
...
///Re-triggerable mode
pub use crate::stm32h745cm7::hrtim_tima::cr::RETRIG;
///Field `RETRIG` reader - Re-triggerable mode
pub use crate::stm32h745cm7::hrtim_tima::cr::RETRIG_R;
///Field `RETRIG` writer - Re-triggerable mode
pub use crate::stm32h745cm7::hrtim_tima::cr::RETRIG_W;
///Synchronization Resets Timer x
pub use crate::stm32h745cm7::hrtim_tima::cr::SYNCRST;
///Field `SYNCRST` reader - Synchronization Resets Timer x
pub use crate::stm32h745cm7::hrtim_tima::cr::SYNCRST_R;
///Field `SYNCRST` writer - Synchronization Resets Timer x
pub use crate::stm32h745cm7::hrtim_tima::cr::SYNCRST_W;
///Synchronization Starts Timer x
pub use crate::stm32h745cm7::hrtim_tima::cr::SYNCSTRT;
///Field `SYNCSTRT` reader - Synchronization Starts Timer x
pub use crate::stm32h745cm7::hrtim_tima::cr::SYNCSTRT_R;
///Field `SYNCSTRT` writer - Synchronization Starts Timer x
pub use crate::stm32h745cm7::hrtim_tima::cr::SYNCSTRT_W;
...
///AC Synchronization
pub use crate::stm32h745cm7::hrtim_tima::cr::DACSYNC;
///Field `DACSYNC` reader - AC Synchronization
pub use crate::stm32h745cm7::hrtim_tima::cr::DACSYNC_R;
///Field `DACSYNC` writer - AC Synchronization
pub use crate::stm32h745cm7::hrtim_tima::cr::DACSYNC_W;
///Master Timer update
...
///Preload enable
pub use crate::stm32h745cm7::hrtim_tima::cr::PREEN;
///Field `PREEN` reader - Preload enable
pub use crate::stm32h745cm7::hrtim_tima::cr::PREEN_R;
///Field `PREEN` writer - Preload enable
pub use crate::stm32h745cm7::hrtim_tima::cr::PREEN_W;
///Update Gating
