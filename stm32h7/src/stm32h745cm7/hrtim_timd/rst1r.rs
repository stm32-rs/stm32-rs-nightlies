...
///CMP%s
pub use crate::stm32h745cm7::hrtim_tima::rst1r::CMP1;
///Field `CMP(1-4)` reader - CMP%s
pub use crate::stm32h745cm7::hrtim_tima::rst1r::CMP_R;
///Field `CMP(1-4)` writer - CMP%s
pub use crate::stm32h745cm7::hrtim_tima::rst1r::CMP_W;
///EXTEVNT%s
pub use crate::stm32h745cm7::hrtim_tima::rst1r::EXTEVNT1;
///Field `EXTEVNT(1-10)` reader - EXTEVNT%s
pub use crate::stm32h745cm7::hrtim_tima::rst1r::EXTEVNT_R;
///Field `EXTEVNT(1-10)` writer - EXTEVNT%s
pub use crate::stm32h745cm7::hrtim_tima::rst1r::EXTEVNT_W;
///MSTCMP%s
pub use crate::stm32h745cm7::hrtim_tima::rst1r::MSTCMP1;
///Field `MSTCMP(1-4)` reader - MSTCMP%s
pub use crate::stm32h745cm7::hrtim_tima::rst1r::MSTCMP_R;
///Field `MSTCMP(1-4)` writer - MSTCMP%s
pub use crate::stm32h745cm7::hrtim_tima::rst1r::MSTCMP_W;
///MSTPER
pub use crate::stm32h745cm7::hrtim_tima::rst1r::MSTPER;
///Field `MSTPER` reader - MSTPER
pub use crate::stm32h745cm7::hrtim_tima::rst1r::MSTPER_R;
///Field `MSTPER` writer - MSTPER
pub use crate::stm32h745cm7::hrtim_tima::rst1r::MSTPER_W;
///PER
pub use crate::stm32h745cm7::hrtim_tima::rst1r::PER;
///Field `PER` reader - PER
pub use crate::stm32h745cm7::hrtim_tima::rst1r::PER_R;
///Field `PER` writer - PER
pub use crate::stm32h745cm7::hrtim_tima::rst1r::PER_W;
///RESYNC
pub use crate::stm32h745cm7::hrtim_tima::rst1r::RESYNC;
///Field `RESYNC` reader - RESYNC
pub use crate::stm32h745cm7::hrtim_tima::rst1r::RESYNC_R;
///Field `RESYNC` writer - RESYNC
pub use crate::stm32h745cm7::hrtim_tima::rst1r::RESYNC_W;
///SRT
pub use crate::stm32h745cm7::hrtim_tima::rst1r::SRT;
///Field `SRT` reader - SRT
pub use crate::stm32h745cm7::hrtim_tima::rst1r::SRT_R;
///Field `SRT` writer - SRT
pub use crate::stm32h745cm7::hrtim_tima::rst1r::SRT_W;
///Timer A Compare 1
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1;
///Field `TIMACMP1` reader - Timer A Compare 1
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_R as TIMACMP1_R;
///Field `TIMACMP4` reader - Timer A Compare 4
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_R as TIMACMP4_R;
///Field `TIMBCMP2` reader - Timer B Compare 2
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_R as TIMBCMP2_R;
///Field `TIMBCMP4` reader - Timer B Compare 4
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_R as TIMBCMP4_R;
///Field `TIMCCMP1` reader - Timer C Compare 1
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_R as TIMCCMP1_R;
///Field `TIMCCMP3` reader - Timer C Compare 3
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_R as TIMCCMP3_R;
///Field `TIMCCMP4` reader - Timer C Compare 4
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_R as TIMCCMP4_R;
///Field `TIMECMP1` reader - Timer E Compare 1
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_R as TIMECMP1_R;
///Field `TIMECMP2` reader - Timer E Compare 2
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_R as TIMECMP2_R;
///Field `TIMACMP1` writer - Timer A Compare 1
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_W as TIMACMP1_W;
///Field `TIMACMP4` writer - Timer A Compare 4
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_W as TIMACMP4_W;
///Field `TIMBCMP2` writer - Timer B Compare 2
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_W as TIMBCMP2_W;
///Field `TIMBCMP4` writer - Timer B Compare 4
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_W as TIMBCMP4_W;
///Field `TIMCCMP1` writer - Timer C Compare 1
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_W as TIMCCMP1_W;
///Field `TIMCCMP3` writer - Timer C Compare 3
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_W as TIMCCMP3_W;
///Field `TIMCCMP4` writer - Timer C Compare 4
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_W as TIMCCMP4_W;
///Field `TIMECMP1` writer - Timer E Compare 1
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_W as TIMECMP1_W;
///Field `TIMECMP2` writer - Timer E Compare 2
pub use crate::stm32h745cm7::hrtim_tima::rst1r::TIMBCMP1_W as TIMECMP2_W;
///UPDATE
pub use crate::stm32h745cm7::hrtim_tima::rst1r::UPDATE;
///Field `UPDATE` reader - UPDATE
pub use crate::stm32h745cm7::hrtim_tima::rst1r::UPDATE_R;
///Field `UPDATE` writer - UPDATE
pub use crate::stm32h745cm7::hrtim_tima::rst1r::UPDATE_W;
impl R {
    ///Bit 0 - SRT
    #[inline(always)]
    ...
    pub fn timccmp3(&self) -> TIMCCMP3_R {
        TIMCCMP3_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - Timer C Compare 4
    #[inline(always)]
    pub fn timccmp4(&self) -> TIMCCMP4_R {
        TIMCCMP4_R::new(((self.bits >> 18) & 1) != 0)
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#HRTIM_TIMD:RST1R)*/
pub struct RST1Rrs;
