///Register `CONFRN3` reader
pub type R = crate::R<CONFRN3rs>;
///Register `CONFRN3` writer
pub type W = crate::W<CONFRN3rs>;
...
impl W {
    ///Bit 0 - Huffman DC Selects the Huffman table for encoding the DC coefficients.
    #[inline(always)]
    pub fn hd(&mut self) -> HD_W<'_, CONFRN3rs> {
        HD_W::new(self, 0)
    }
    ///Bit 1 - Huffman AC Selects the Huffman table for encoding the AC coefficients.
    #[inline(always)]
    pub fn ha(&mut self) -> HA_W<'_, CONFRN3rs> {
        HA_W::new(self, 1)
    }
    ///Bits 2:3 - Quantization Table Selects quantization table associated with a color component.
    #[inline(always)]
    pub fn qt(&mut self) -> QT_W<'_, CONFRN3rs> {
        QT_W::new(self, 2)
    }
    ///Bits 4:7 - Number of Block Number of data units minus 1 that belong to a particular color in the MCU.
    #[inline(always)]
    pub fn nb(&mut self) -> NB_W<'_, CONFRN3rs> {
        NB_W::new(self, 4)
    }
    ///Bits 8:11 - Vertical Sampling Factor Vertical sampling factor for component i.
    #[inline(always)]
    pub fn vsf(&mut self) -> VSF_W<'_, CONFRN3rs> {
        VSF_W::new(self, 8)
    }
    ///Bits 12:15 - Horizontal Sampling Factor Horizontal sampling factor for component i.
    #[inline(always)]
    pub fn hsf(&mut self) -> HSF_W<'_, CONFRN3rs> {
        HSF_W::new(self, 12)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#JPEG:CONFRN3)*/
pub struct CONFRN3rs;
impl crate::RegisterSpec for CONFRN3rs {
    type Ux = u32;
}
///`read()` method returns [`confrn3::R`](R) reader structure
impl crate::Readable for CONFRN3rs {}
///`write(|w| ..)` method takes [`confrn3::W`](W) writer structure
impl crate::Writable for CONFRN3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CONFRN3 to value 0
impl crate::Resettable for CONFRN3rs {}
