...
///Field `RXFLVL` reader - RxFIFO nonempty
pub type RXFLVL_R = crate::BitReader;
///Field `NPTXFE` reader - Nonperiodic TxFIFO empty
pub type NPTXFE_R = crate::BitReader;
///Field `GINAKEFF` reader - Global IN nonperiodic NAK effective
pub type GINAKEFF_R = crate::BitReader;
///Field `BOUTNAKEFF` reader - Global OUT NAK effective
...
///Field `PXFR_INCOMPISOOUT` reader - Incomplete periodic transfer
pub type PXFR_INCOMPISOOUT_R = crate::BitReader;
///Field `PXFR_INCOMPISOOUT` writer - Incomplete periodic transfer
...
///Field `WKUINT` reader - Resume/remote wakeup detected interrupt
pub type WKUINT_R = crate::BitReader;
///Field `WKUINT` writer - Resume/remote wakeup detected interrupt
...
impl W {
    ...
    ///Bit 21 - Incomplete periodic transfer
    #[inline(always)]
    pub fn pxfr_incompisoout(&mut self) -> PXFR_INCOMPISOOUT_W<'_, GINTSTSrs> {
    ...
    ///Bit 31 - Resume/remote wakeup detected interrupt
    #[inline(always)]
    pub fn wkuint(&mut self) -> WKUINT_W<'_, GINTSTSrs> {
