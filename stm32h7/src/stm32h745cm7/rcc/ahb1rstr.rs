...
///Field `ARTRST` reader - ART block reset
...
///Field `ARTRST` writer - ART block reset
...
impl W {
    ...
    ///Bit 14 - ART block reset
    #[inline(always)]
    pub fn artrst(&mut self) -> ARTRST_W<'_, AHB1RSTRrs> {
        ARTRST_W::new(self, 14)
    }
    ///Bit 15 - ETH1MAC block reset
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#RCC:AHB1RSTR)*/
