...
impl W {
    ...
    ///Bit 11 - WWDG2 peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn wwdg2lpen(&mut self) -> WWDG2LPEN_W<'_, C1_APB1LLPENRrs> {
        WWDG2LPEN_W::new(self, 11)
    }
    ///Bit 14 - SPI2 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#RCC:C1_APB1LLPENR)*/
