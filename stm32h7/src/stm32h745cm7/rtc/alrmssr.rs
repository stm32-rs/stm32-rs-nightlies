...
pub type MASKSS_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#RTC:ALRM[A]SSR)*/
