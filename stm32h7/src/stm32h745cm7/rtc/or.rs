...
///Field `RTC_ALARM_TYPE` reader - RTC_ALARM output type on PC13
pub type RTC_ALARM_TYPE_R = crate::BitReader;
///Field `RTC_ALARM_TYPE` writer - RTC_ALARM output type on PC13
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#RTC:OR)*/
pub struct ORrs;
