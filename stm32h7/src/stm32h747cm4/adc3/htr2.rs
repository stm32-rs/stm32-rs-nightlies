#[doc = "Reader of register HTR2"]
pub type R = crate::R<u32, super::HTR2>;
#[doc = "Writer for register HTR2"]
pub type W = crate::W<u32, super::HTR2>;
#[doc = "Register HTR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::HTR2 {
    type Type = u32;
    #[inline(always)]
