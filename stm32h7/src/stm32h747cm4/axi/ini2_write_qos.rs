///Register `INI2_WRITE_QOS` reader
pub type R = crate::R<INI2_WRITE_QOSrs>;
///Register `INI2_WRITE_QOS` writer
...
impl W {
    ///Bits 0:3 - Write channel QoS setting
    #[inline(always)]
    pub fn aw_qos(&mut self) -> AW_QOS_W<'_, INI2_WRITE_QOSrs> {
        AW_QOS_W::new(self, 0)
    }
}
/**AXI interconnect - INI x write QoS register

You can [`read`](crate::Reg::read) this register and get [`ini2_write_qos::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ini2_write_qos::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`ini2_write_qos::R`](R) reader structure
impl crate::Readable for INI2_WRITE_QOSrs {}
///`write(|w| ..)` method takes [`ini2_write_qos::W`](W) writer structure
impl crate::Writable for INI2_WRITE_QOSrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets INI2_WRITE_QOS to value 0x04
