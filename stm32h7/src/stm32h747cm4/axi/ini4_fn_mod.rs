#[doc = "Reader of register INI4_FN_MOD"]
pub type R = crate::R<u32, super::INI4_FN_MOD>;
#[doc = "Writer for register INI4_FN_MOD"]
pub type W = crate::W<u32, super::INI4_FN_MOD>;
#[doc = "Register INI4_FN_MOD `reset()`'s with value 0x04"]
impl crate::ResetValue for super::INI4_FN_MOD {
    type Type = u32;
    #[inline(always)]
