#[doc = "Reader of register TARG1_FN_MOD_LB"]
pub type R = crate::R<u32, super::TARG1_FN_MOD_LB>;
#[doc = "Writer for register TARG1_FN_MOD_LB"]
pub type W = crate::W<u32, super::TARG1_FN_MOD_LB>;
#[doc = "Register TARG1_FN_MOD_LB `reset()`'s with value 0x04"]
impl crate::ResetValue for super::TARG1_FN_MOD_LB {
    type Type = u32;
    #[inline(always)]
