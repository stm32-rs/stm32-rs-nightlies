...
///Field `OF(0-7)` reader - :0\]: Trigger overrun event flag
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM4.html#DMAMUX1:RGSR)*/
pub struct RGSRrs;
