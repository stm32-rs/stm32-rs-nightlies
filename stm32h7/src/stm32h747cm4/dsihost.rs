...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn vvpbccr(&self) -> &VVPBCCR {
        &self.vvpbccr
    }
...
pub mod psr;
/**ISR0 (rw) register accessor: DSI Host interrupt and status register 0
...
pub mod isr0;
/**ISR1 (rw) register accessor: DSI Host interrupt and status register 1
...
pub mod vvsaccr;
/**VVPBCCR (rw) register accessor: DSI Host video VBP current configuration register

You can [`read`](crate::Reg::read) this register and get [`vvpbccr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vvpbccr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#DSIHOST:VVPBCCR)

For information about available fields see [`mod@vvpbccr`]
module*/
pub type VVPBCCR = crate::Reg<vvpbccr::VVPBCCRrs>;
...
pub mod wier;
/**WISR (rw) register accessor: DSI wrapper interrupt and status register

You can [`read`](crate::Reg::read) this register and get [`wisr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wisr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
