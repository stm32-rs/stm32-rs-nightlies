#[doc = "Reader of register CLCR"]
pub type R = crate::R<u32, super::CLCR>;
#[doc = "Writer for register CLCR"]
pub type W = crate::W<u32, super::CLCR>;
#[doc = "Register CLCR `reset()`'s with value 0"]
impl crate::ResetValue for super::CLCR {
    type Type = u32;
    #[inline(always)]
