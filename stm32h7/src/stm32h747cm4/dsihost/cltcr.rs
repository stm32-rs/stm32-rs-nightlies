#[doc = "Reader of register CLTCR"]
pub type R = crate::R<u32, super::CLTCR>;
#[doc = "Writer for register CLTCR"]
pub type W = crate::W<u32, super::CLTCR>;
#[doc = "Register CLTCR `reset()`'s with value 0"]
impl crate::ResetValue for super::CLTCR {
    type Type = u32;
    #[inline(always)]
