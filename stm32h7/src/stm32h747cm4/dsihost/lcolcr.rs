...
///Field `LPE` reader - Loosely packet enable
pub type LPE_R = crate::BitReader;
///Field `LPE` writer - Loosely packet enable
...
impl W {
    ///Bits 0:3 - Color coding
    #[inline(always)]
    pub fn colc(&mut self) -> COLC_W<'_, LCOLCRrs> {
        COLC_W::new(self, 0)
    }
    ///Bit 8 - Loosely packet enable
    #[inline(always)]
    pub fn lpe(&mut self) -> LPE_W<'_, LCOLCRrs> {
        LPE_W::new(self, 8)
    }
}
