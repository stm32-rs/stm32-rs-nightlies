#[doc = "Reader of register TCCR0"]
pub type R = crate::R<u32, super::TCCR0>;
#[doc = "Writer for register TCCR0"]
pub type W = crate::W<u32, super::TCCR0>;
#[doc = "Register TCCR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::TCCR0 {
    type Type = u32;
    #[inline(always)]
