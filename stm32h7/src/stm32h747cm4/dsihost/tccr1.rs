#[doc = "Reader of register TCCR1"]
pub type R = crate::R<u32, super::TCCR1>;
#[doc = "Writer for register TCCR1"]
pub type W = crate::W<u32, super::TCCR1>;
#[doc = "Register TCCR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::TCCR1 {
    type Type = u32;
    #[inline(always)]
