#[doc = "Reader of register VLCCR"]
pub type R = crate::R<u32, super::VLCCR>;
#[doc = "Writer for register VLCCR"]
pub type W = crate::W<u32, super::VLCCR>;
#[doc = "Register VLCCR `reset()`'s with value 0"]
impl crate::ResetValue for super::VLCCR {
    type Type = u32;
    #[inline(always)]
