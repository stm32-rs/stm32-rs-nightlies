#[doc = "Reader of register VPCCR"]
pub type R = crate::R<u32, super::VPCCR>;
#[doc = "Writer for register VPCCR"]
pub type W = crate::W<u32, super::VPCCR>;
#[doc = "Register VPCCR `reset()`'s with value 0"]
impl crate::ResetValue for super::VPCCR {
    type Type = u32;
    #[inline(always)]
