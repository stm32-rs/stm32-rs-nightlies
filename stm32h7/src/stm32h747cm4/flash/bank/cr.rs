...
#[doc = "Register CR `reset()`'s with value 0x31"]
...
#[doc = "Reader of field `CRCRDERRIE`"]
pub type CRCRDERRIE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `CRCRDERRIE`"]
pub struct CRCRDERRIE_W<'a> {
    w: &'a mut W,
}
impl<'a> CRCRDERRIE_W<'a> {
...
impl R {
    ...
    pub fn crcrderrie(&self) -> CRCRDERRIE_R {
        CRCRDERRIE_R::new(((self.bits >> 28) & 0x01) != 0)
    }
...
impl W {
    #[doc = "Bit 28 - Bank 1 CRC read error interrupt enable bit"]
    #[inline(always)]
    pub fn crcrderrie(&mut self) -> CRCRDERRIE_W {
        CRCRDERRIE_W { w: self }
    }
    #[doc = "Bit 27 - Bank 1 CRC end of calculation interrupt enable bit"]
    #[inline(always)]
