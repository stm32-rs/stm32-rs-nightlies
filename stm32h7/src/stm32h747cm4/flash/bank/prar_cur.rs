...
#[doc = "Writer for register PRAR_CUR"]
pub type W = crate::W<u32, super::PRAR_CUR>;
#[doc = "Register PRAR_CUR `reset()`'s with value 0"]
impl crate::ResetValue for super::PRAR_CUR {
    type Type = u32;
    #[inline(always)]
