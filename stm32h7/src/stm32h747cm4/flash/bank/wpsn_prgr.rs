#[doc = "Reader of register WPSN_PRGR"]
pub type R = crate::R<u32, super::WPSN_PRGR>;
#[doc = "Writer for register WPSN_PRGR"]
pub type W = crate::W<u32, super::WPSN_PRGR>;
#[doc = "Register WPSN_PRGR `reset()`'s with value 0"]
impl crate::ResetValue for super::WPSN_PRGR {
    type Type = u32;
    #[inline(always)]
