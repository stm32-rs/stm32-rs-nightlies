#[doc = "Reader of register OPTSR_CUR"]
pub type R = crate::R<u32, super::OPTSR_CUR>;
#[doc = "Writer for register OPTSR_CUR"]
pub type W = crate::W<u32, super::OPTSR_CUR>;
#[doc = "Register OPTSR_CUR `reset()`'s with value 0"]
impl crate::ResetValue for super::OPTSR_CUR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `OPTCHANGEERR`"]
pub type OPTCHANGEERR_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OPTCHANGEERR`"]
...
#[doc = "Reader of field `RST_STDY_D1`"]
pub type RST_STDY_D1_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RST_STDY_D1`"]
...
#[doc = "Reader of field `OPT_BUSY`"]
pub type OPT_BUSY_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OPT_BUSY`"]
