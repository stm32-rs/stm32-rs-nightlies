#[doc = "Reader of register CSR18"]
pub type R = crate::R<u32, super::CSR18>;
#[doc = "Writer for register CSR18"]
pub type W = crate::W<u32, super::CSR18>;
#[doc = "Register CSR18 `reset()`'s with value 0"]
...
#[doc = "Reader of field `CSR18`"]
pub type CSR18_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `CSR18`"]
