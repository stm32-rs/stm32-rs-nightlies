#[doc = "Reader of register CSR26"]
pub type R = crate::R<u32, super::CSR26>;
#[doc = "Writer for register CSR26"]
pub type W = crate::W<u32, super::CSR26>;
#[doc = "Register CSR26 `reset()`'s with value 0"]
...
#[doc = "Reader of field `CSR26`"]
pub type CSR26_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `CSR26`"]
