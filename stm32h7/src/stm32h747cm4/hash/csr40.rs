#[doc = "Reader of register CSR40"]
pub type R = crate::R<u32, super::CSR40>;
#[doc = "Writer for register CSR40"]
pub type W = crate::W<u32, super::CSR40>;
#[doc = "Register CSR40 `reset()`'s with value 0"]
...
#[doc = "Reader of field `CSR40`"]
pub type CSR40_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `CSR40`"]
