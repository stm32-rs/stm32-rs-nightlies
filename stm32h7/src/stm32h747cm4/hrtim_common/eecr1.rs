...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EE1SRC` field.</div>
    #[inline(always)]
    pub fn eesrc(&mut self, n: u8) -> EESRC_W<EECR1rs> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
    ...
    ///Bits 0:1 - External Event 1 Source
    #[inline(always)]
    pub fn ee1src(&mut self) -> EESRC_W<EECR1rs> {
        EESRC_W::new(self, 0)
    }
    ///Bits 6:7 - External Event 2 Source
    #[inline(always)]
    pub fn ee2src(&mut self) -> EESRC_W<EECR1rs> {
        EESRC_W::new(self, 6)
    }
    ///Bits 12:13 - External Event 3 Source
    #[inline(always)]
    pub fn ee3src(&mut self) -> EESRC_W<EECR1rs> {
        EESRC_W::new(self, 12)
    }
    ///Bits 18:19 - External Event 4 Source
    #[inline(always)]
    pub fn ee4src(&mut self) -> EESRC_W<EECR1rs> {
        EESRC_W::new(self, 18)
    }
    ///Bits 24:25 - External Event 5 Source
    #[inline(always)]
    pub fn ee5src(&mut self) -> EESRC_W<EECR1rs> {
        EESRC_W::new(self, 24)
    }
    ///External Event (1-5) Polarity
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EE1POL` field.</div>
    #[inline(always)]
    pub fn eepol(&mut self, n: u8) -> EEPOL_W<EECR1rs> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
    ...
    ///Bit 2 - External Event 1 Polarity
    #[inline(always)]
    pub fn ee1pol(&mut self) -> EEPOL_W<EECR1rs> {
        EEPOL_W::new(self, 2)
    }
    ///Bit 8 - External Event 2 Polarity
    #[inline(always)]
    pub fn ee2pol(&mut self) -> EEPOL_W<EECR1rs> {
        EEPOL_W::new(self, 8)
    }
    ///Bit 14 - External Event 3 Polarity
    #[inline(always)]
    pub fn ee3pol(&mut self) -> EEPOL_W<EECR1rs> {
        EEPOL_W::new(self, 14)
    }
    ///Bit 20 - External Event 4 Polarity
    #[inline(always)]
    pub fn ee4pol(&mut self) -> EEPOL_W<EECR1rs> {
        EEPOL_W::new(self, 20)
    }
    ///Bit 26 - External Event 5 Polarity
    #[inline(always)]
    pub fn ee5pol(&mut self) -> EEPOL_W<EECR1rs> {
        EEPOL_W::new(self, 26)
    }
    ///External Event (1-5) Sensitivity
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EE1SNS` field.</div>
    #[inline(always)]
    pub fn eesns(&mut self, n: u8) -> EESNS_W<EECR1rs> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
    ...
    ///Bits 3:4 - External Event 1 Sensitivity
    #[inline(always)]
    pub fn ee1sns(&mut self) -> EESNS_W<EECR1rs> {
        EESNS_W::new(self, 3)
    }
    ///Bits 9:10 - External Event 2 Sensitivity
    #[inline(always)]
    pub fn ee2sns(&mut self) -> EESNS_W<EECR1rs> {
        EESNS_W::new(self, 9)
    }
    ///Bits 15:16 - External Event 3 Sensitivity
    #[inline(always)]
    pub fn ee3sns(&mut self) -> EESNS_W<EECR1rs> {
        EESNS_W::new(self, 15)
    }
    ///Bits 21:22 - External Event 4 Sensitivity
    #[inline(always)]
    pub fn ee4sns(&mut self) -> EESNS_W<EECR1rs> {
        EESNS_W::new(self, 21)
    }
    ///Bits 27:28 - External Event 5 Sensitivity
    #[inline(always)]
    pub fn ee5sns(&mut self) -> EESNS_W<EECR1rs> {
        EESNS_W::new(self, 27)
    }
    ///External Event (1-5) Fast mode
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `EE1FAST` field.</div>
    #[inline(always)]
    pub fn eefast(&mut self, n: u8) -> EEFAST_W<EECR1rs> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
    ...
    ///Bit 5 - External Event 1 Fast mode
    #[inline(always)]
    pub fn ee1fast(&mut self) -> EEFAST_W<EECR1rs> {
        EEFAST_W::new(self, 5)
    }
    ///Bit 11 - External Event 2 Fast mode
    #[inline(always)]
    pub fn ee2fast(&mut self) -> EEFAST_W<EECR1rs> {
        EEFAST_W::new(self, 11)
    }
    ///Bit 17 - External Event 3 Fast mode
    #[inline(always)]
    pub fn ee3fast(&mut self) -> EEFAST_W<EECR1rs> {
        EEFAST_W::new(self, 17)
    }
    ///Bit 23 - External Event 4 Fast mode
    #[inline(always)]
    pub fn ee4fast(&mut self) -> EEFAST_W<EECR1rs> {
        EEFAST_W::new(self, 23)
    }
    ///Bit 29 - External Event 5 Fast mode
    #[inline(always)]
    pub fn ee5fast(&mut self) -> EEFAST_W<EECR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#HRTIM_Common:EECR1)*/
pub struct EECR1rs;
