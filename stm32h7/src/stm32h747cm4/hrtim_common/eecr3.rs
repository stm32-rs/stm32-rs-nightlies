...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee6src(&mut self) -> EE6SRC_W<EECR3rs> {
        EE6SRC_W::new(self, 0)
    }
    ///Bit 2 - EE6POL
    #[inline(always)]
    #[must_use]
    pub fn ee6pol(&mut self) -> EE6POL_W<EECR3rs> {
        EE6POL_W::new(self, 2)
    }
    ///Bits 3:4 - EE6SNS
    #[inline(always)]
    #[must_use]
    pub fn ee6sns(&mut self) -> EE6SNS_W<EECR3rs> {
        EE6SNS_W::new(self, 3)
    }
    ///Bits 6:7 - EE7SRC
    #[inline(always)]
    #[must_use]
    pub fn ee7src(&mut self) -> EE7SRC_W<EECR3rs> {
        EE7SRC_W::new(self, 6)
    }
    ///Bit 8 - EE7POL
    #[inline(always)]
    #[must_use]
    pub fn ee7pol(&mut self) -> EE7POL_W<EECR3rs> {
        EE7POL_W::new(self, 8)
    }
    ///Bits 9:10 - EE7SNS
    #[inline(always)]
    #[must_use]
    pub fn ee7sns(&mut self) -> EE7SNS_W<EECR3rs> {
        EE7SNS_W::new(self, 9)
    }
    ///Bits 12:13 - EE8SRC
    #[inline(always)]
    #[must_use]
    pub fn ee8src(&mut self) -> EE8SRC_W<EECR3rs> {
        EE8SRC_W::new(self, 12)
    }
    ///Bit 14 - EE8POL
    #[inline(always)]
    #[must_use]
    pub fn ee8pol(&mut self) -> EE8POL_W<EECR3rs> {
        EE8POL_W::new(self, 14)
    }
    ///Bits 15:16 - EE8SNS
    #[inline(always)]
    #[must_use]
    pub fn ee8sns(&mut self) -> EE8SNS_W<EECR3rs> {
        EE8SNS_W::new(self, 15)
    }
    ///Bits 18:19 - EE9SRC
    #[inline(always)]
    #[must_use]
    pub fn ee9src(&mut self) -> EE9SRC_W<EECR3rs> {
        EE9SRC_W::new(self, 18)
    }
    ///Bit 20 - EE9POL
    #[inline(always)]
    #[must_use]
    pub fn ee9pol(&mut self) -> EE9POL_W<EECR3rs> {
        EE9POL_W::new(self, 20)
    }
    ///Bits 21:22 - EE9SNS
    #[inline(always)]
    #[must_use]
    pub fn ee9sns(&mut self) -> EE9SNS_W<EECR3rs> {
        EE9SNS_W::new(self, 21)
    }
    ///Bits 24:25 - EE10SRC
    #[inline(always)]
    #[must_use]
    pub fn ee10src(&mut self) -> EE10SRC_W<EECR3rs> {
        EE10SRC_W::new(self, 24)
    }
    ///Bit 26 - EE10POL
    #[inline(always)]
    #[must_use]
    pub fn ee10pol(&mut self) -> EE10POL_W<EECR3rs> {
        EE10POL_W::new(self, 26)
    }
    ///Bits 27:28 - EE10SNS
    #[inline(always)]
    #[must_use]
    pub fn ee10sns(&mut self) -> EE10SNS_W<EECR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#HRTIM_Common:EECR3)*/
pub struct EECR3rs;
