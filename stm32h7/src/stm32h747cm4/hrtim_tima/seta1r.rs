///Register `SETA1R` reader
pub type R = crate::R<SETA1Rrs>;
///Register `SETA1R` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#HRTIM_TIMA:SETA1R)*/
pub struct SETA1Rrs;
impl crate::RegisterSpec for SETA1Rrs {
    type Ux = u32;
}
///`read()` method returns [`seta1r::R`](R) reader structure
impl crate::Readable for SETA1Rrs {}
///`write(|w| ..)` method takes [`seta1r::W`](W) writer structure
impl crate::Writable for SETA1Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SETA1R to value 0
