#[doc = "Reader of register CHPBR"]
pub type R = crate::R<u32, super::CHPBR>;
#[doc = "Writer for register CHPBR"]
pub type W = crate::W<u32, super::CHPBR>;
#[doc = "Register CHPBR `reset()`'s with value 0"]
impl crate::ResetValue for super::CHPBR {
    type Type = u32;
    #[inline(always)]
