///Register `REPBR` reader
pub type R = crate::R<REPBRrs>;
///Register `REPBR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REPBR").field("repx", &self.repx()).finish()
    }
}
impl W {
    ///Bits 0:7 - Timerx Repetition counter value
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#HRTIM_TIMB:REPBR)*/
pub struct REPBRrs;
impl crate::RegisterSpec for REPBRrs {
    type Ux = u32;
}
///`read()` method returns [`repbr::R`](R) reader structure
impl crate::Readable for REPBRrs {}
///`write(|w| ..)` method takes [`repbr::W`](W) writer structure
impl crate::Writable for REPBRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets REPBR to value 0
