#[doc = "Reader of register CMP4CR"]
pub type R = crate::R<u32, super::CMP4CR>;
#[doc = "Writer for register CMP4CR"]
pub type W = crate::W<u32, super::CMP4CR>;
#[doc = "Register CMP4CR `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP4CR {
    type Type = u32;
    #[inline(always)]
