///Register `TIMCICR` writer
pub type W = crate::W<TIMCICRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<TIMCICRrs> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1c(&mut self) -> CMP1C_W<TIMCICRrs> {
        CMP1C_W::new(self, 0)
    }
    ///Bit 1 - Compare 2 Interrupt flag Clear
    #[inline(always)]
    #[must_use]
    pub fn cmp2c(&mut self) -> CMP2C_W<TIMCICRrs> {
        CMP2C_W::new(self, 1)
    }
    ///Bit 2 - Compare 3 Interrupt flag Clear
    #[inline(always)]
    #[must_use]
    pub fn cmp3c(&mut self) -> CMP3C_W<TIMCICRrs> {
        CMP3C_W::new(self, 2)
    }
    ///Bit 3 - Compare 4 Interrupt flag Clear
    #[inline(always)]
    #[must_use]
    pub fn cmp4c(&mut self) -> CMP4C_W<TIMCICRrs> {
        CMP4C_W::new(self, 3)
    }
    ///Bit 4 - Repetition Interrupt flag Clear
    #[inline(always)]
    #[must_use]
    pub fn repc(&mut self) -> REPC_W<TIMCICRrs> {
        REPC_W::new(self, 4)
    }
    ///Bit 6 - Update Interrupt flag Clear
    #[inline(always)]
    #[must_use]
    pub fn updc(&mut self) -> UPDC_W<TIMCICRrs> {
        UPDC_W::new(self, 6)
    }
    ///Bit 7 - Capture1 Interrupt flag Clear
    #[inline(always)]
    #[must_use]
    pub fn cpt1c(&mut self) -> CPT1C_W<TIMCICRrs> {
        CPT1C_W::new(self, 7)
    }
    ///Bit 8 - Capture2 Interrupt flag Clear
    #[inline(always)]
    #[must_use]
    pub fn cpt2c(&mut self) -> CPT2C_W<TIMCICRrs> {
        CPT2C_W::new(self, 8)
    }
    ///Bit 9 - Output 1 Set flag Clear
    #[inline(always)]
    #[must_use]
    pub fn set1x_c(&mut self) -> SET1X_C_W<TIMCICRrs> {
        SET1X_C_W::new(self, 9)
    }
    ///Bit 10 - Output 1 Reset flag Clear
    #[inline(always)]
    #[must_use]
    pub fn rstx1c(&mut self) -> RSTX1C_W<TIMCICRrs> {
        RSTX1C_W::new(self, 10)
    }
    ///Bit 11 - Output 2 Set flag Clear
    #[inline(always)]
    #[must_use]
    pub fn set2x_c(&mut self) -> SET2X_C_W<TIMCICRrs> {
        SET2X_C_W::new(self, 11)
    }
    ///Bit 12 - Output 2 Reset flag Clear
    #[inline(always)]
    #[must_use]
    pub fn rstx2c(&mut self) -> RSTX2C_W<TIMCICRrs> {
        RSTX2C_W::new(self, 12)
    }
    ///Bit 13 - Reset Interrupt flag Clear
    #[inline(always)]
    #[must_use]
    pub fn rstc(&mut self) -> RSTC_W<TIMCICRrs> {
        RSTC_W::new(self, 13)
    }
    ///Bit 14 - Delayed Protection Flag Clear
    #[inline(always)]
    #[must_use]
    pub fn dlyprtc(&mut self) -> DLYPRTC_W<TIMCICRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#HRTIM_TIMC:TIMCICR)*/
pub struct TIMCICRrs;
impl crate::RegisterSpec for TIMCICRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`timcicr::W`](W) writer structure
impl crate::Writable for TIMCICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMCICR to value 0
impl crate::Resettable for TIMCICRrs {
