///Register `CMP1CDR` reader
pub type R = crate::R<CMP1CDRrs>;
///Register `CMP1CDR` writer
...
///`read()` method returns [`cmp1cdr::R`](R) reader structure
impl crate::Readable for CMP1CDRrs {}
///`write(|w| ..)` method takes [`cmp1cdr::W`](W) writer structure
impl crate::Writable for CMP1CDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CMP1CDR to value 0
