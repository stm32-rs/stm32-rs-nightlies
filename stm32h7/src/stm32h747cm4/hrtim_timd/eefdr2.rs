...
pub type R = crate::R<EEFDR2rs>;
///Register `EEFDR2` writer
pub type W = crate::W<EEFDR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee6ltch(&mut self) -> EE6LTCH_W<EEFDR2rs> {
        EE6LTCH_W::new(self, 0)
    }
    ///Bits 1:4 - External Event 6 filter
    #[inline(always)]
    #[must_use]
    pub fn ee6fltr(&mut self) -> EE6FLTR_W<EEFDR2rs> {
        EE6FLTR_W::new(self, 1)
    }
    ///Bit 6 - External Event 7 latch
    #[inline(always)]
    #[must_use]
    pub fn ee7ltch(&mut self) -> EE7LTCH_W<EEFDR2rs> {
        EE7LTCH_W::new(self, 6)
    }
    ///Bits 7:10 - External Event 7 filter
    #[inline(always)]
    #[must_use]
    pub fn ee7fltr(&mut self) -> EE7FLTR_W<EEFDR2rs> {
        EE7FLTR_W::new(self, 7)
    }
    ///Bit 12 - External Event 8 latch
    #[inline(always)]
    #[must_use]
    pub fn ee8ltch(&mut self) -> EE8LTCH_W<EEFDR2rs> {
        EE8LTCH_W::new(self, 12)
    }
    ///Bits 13:16 - External Event 8 filter
    #[inline(always)]
    #[must_use]
    pub fn ee8fltr(&mut self) -> EE8FLTR_W<EEFDR2rs> {
        EE8FLTR_W::new(self, 13)
    }
    ///Bit 18 - External Event 9 latch
    #[inline(always)]
    #[must_use]
    pub fn ee9ltch(&mut self) -> EE9LTCH_W<EEFDR2rs> {
        EE9LTCH_W::new(self, 18)
    }
    ///Bits 19:22 - External Event 9 filter
    #[inline(always)]
    #[must_use]
    pub fn ee9fltr(&mut self) -> EE9FLTR_W<EEFDR2rs> {
        EE9FLTR_W::new(self, 19)
    }
    ///Bit 24 - External Event 10 latch
    #[inline(always)]
    #[must_use]
    pub fn ee10ltch(&mut self) -> EE10LTCH_W<EEFDR2rs> {
        EE10LTCH_W::new(self, 24)
    }
    ///Bits 25:28 - External Event 10 filter
    #[inline(always)]
    #[must_use]
    pub fn ee10fltr(&mut self) -> EE10FLTR_W<EEFDR2rs> {
