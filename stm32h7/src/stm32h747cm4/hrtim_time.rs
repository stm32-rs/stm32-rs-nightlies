...
#[doc = "Timerx Interrupt Clear Register"]
pub mod timeicr;
#[doc = "TIMxDIER5\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timedier5](timedier5) module"]
pub type TIMEDIER5 = crate::Reg<u32, _TIMEDIER5>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _TIMEDIER5;
#[doc = "`read()` method returns [timedier5::R](timedier5::R) reader structure"]
impl crate::Readable for TIMEDIER5 {}
#[doc = "`write(|w| ..)` method takes [timedier5::W](timedier5::W) writer structure"]
impl crate::Writable for TIMEDIER5 {}
#[doc = "TIMxDIER5"]
pub mod timedier5;
