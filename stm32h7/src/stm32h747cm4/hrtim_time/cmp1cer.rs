#[doc = "Reader of register CMP1CER"]
pub type R = crate::R<u32, super::CMP1CER>;
#[doc = "Writer for register CMP1CER"]
pub type W = crate::W<u32, super::CMP1CER>;
#[doc = "Register CMP1CER `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP1CER {
    type Type = u32;
    #[inline(always)]
