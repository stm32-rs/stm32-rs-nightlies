...
pub type R = crate::R<PERERrs>;
///Register `PERER` writer
pub type W = crate::W<PERERrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn perx(&mut self) -> PERX_W<PERERrs> {
        PERX_W::new(self, 0)
    }
}
