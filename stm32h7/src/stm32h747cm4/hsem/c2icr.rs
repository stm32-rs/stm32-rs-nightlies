...
///Field `ISEM(0-31)` reader - Interrupt(2) semaphore %s clear
pub type ISEM_R = crate::BitReader;
///Field `ISEM(0-31)` writer - Interrupt(2) semaphore %s clear
pub type ISEM_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Interrupt(2) semaphore (0-31) clear
    ///
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `ISEM0` field.</div>
    #[inline(always)]
    pub fn isem(&mut self, n: u8) -> ISEM_W<C2ICRrs> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        ISEM_W::new(self, n)
    }
    ///Bit 0 - Interrupt(2) semaphore 0 clear
    #[inline(always)]
    pub fn isem0(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 0)
    }
    ///Bit 1 - Interrupt(2) semaphore 1 clear
    #[inline(always)]
    pub fn isem1(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 1)
    }
    ///Bit 2 - Interrupt(2) semaphore 2 clear
    #[inline(always)]
    pub fn isem2(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 2)
    }
    ///Bit 3 - Interrupt(2) semaphore 3 clear
    #[inline(always)]
    pub fn isem3(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 3)
    }
    ///Bit 4 - Interrupt(2) semaphore 4 clear
    #[inline(always)]
    pub fn isem4(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 4)
    }
    ///Bit 5 - Interrupt(2) semaphore 5 clear
    #[inline(always)]
    pub fn isem5(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 5)
    }
    ///Bit 6 - Interrupt(2) semaphore 6 clear
    #[inline(always)]
    pub fn isem6(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 6)
    }
    ///Bit 7 - Interrupt(2) semaphore 7 clear
    #[inline(always)]
    pub fn isem7(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 7)
    }
    ///Bit 8 - Interrupt(2) semaphore 8 clear
    #[inline(always)]
    pub fn isem8(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 8)
    }
    ///Bit 9 - Interrupt(2) semaphore 9 clear
    #[inline(always)]
    pub fn isem9(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 9)
    }
    ///Bit 10 - Interrupt(2) semaphore 10 clear
    #[inline(always)]
    pub fn isem10(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 10)
    }
    ///Bit 11 - Interrupt(2) semaphore 11 clear
    #[inline(always)]
    pub fn isem11(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 11)
    }
    ///Bit 12 - Interrupt(2) semaphore 12 clear
    #[inline(always)]
    pub fn isem12(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 12)
    }
    ///Bit 13 - Interrupt(2) semaphore 13 clear
    #[inline(always)]
    pub fn isem13(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 13)
    }
    ///Bit 14 - Interrupt(2) semaphore 14 clear
    #[inline(always)]
    pub fn isem14(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 14)
    }
    ///Bit 15 - Interrupt(2) semaphore 15 clear
    #[inline(always)]
    pub fn isem15(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 15)
    }
    ///Bit 16 - Interrupt(2) semaphore 16 clear
    #[inline(always)]
    pub fn isem16(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 16)
    }
    ///Bit 17 - Interrupt(2) semaphore 17 clear
    #[inline(always)]
    pub fn isem17(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 17)
    }
    ///Bit 18 - Interrupt(2) semaphore 18 clear
    #[inline(always)]
    pub fn isem18(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 18)
    }
    ///Bit 19 - Interrupt(2) semaphore 19 clear
    #[inline(always)]
    pub fn isem19(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 19)
    }
    ///Bit 20 - Interrupt(2) semaphore 20 clear
    #[inline(always)]
    pub fn isem20(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 20)
    }
    ///Bit 21 - Interrupt(2) semaphore 21 clear
    #[inline(always)]
    pub fn isem21(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 21)
    }
    ///Bit 22 - Interrupt(2) semaphore 22 clear
    #[inline(always)]
    pub fn isem22(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 22)
    }
    ///Bit 23 - Interrupt(2) semaphore 23 clear
    #[inline(always)]
    pub fn isem23(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 23)
    }
    ///Bit 24 - Interrupt(2) semaphore 24 clear
    #[inline(always)]
    pub fn isem24(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 24)
    }
    ///Bit 25 - Interrupt(2) semaphore 25 clear
    #[inline(always)]
    pub fn isem25(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 25)
    }
    ///Bit 26 - Interrupt(2) semaphore 26 clear
    #[inline(always)]
    pub fn isem26(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 26)
    }
    ///Bit 27 - Interrupt(2) semaphore 27 clear
    #[inline(always)]
    pub fn isem27(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 27)
    }
    ///Bit 28 - Interrupt(2) semaphore 28 clear
    #[inline(always)]
    pub fn isem28(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 28)
    }
    ///Bit 29 - Interrupt(2) semaphore 29 clear
    #[inline(always)]
    pub fn isem29(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 29)
    }
    ///Bit 30 - Interrupt(2) semaphore 30 clear
    #[inline(always)]
    pub fn isem30(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 30)
    }
    ///Bit 31 - Interrupt(2) semaphore 31 clear
    #[inline(always)]
    pub fn isem31(&mut self) -> ISEM_W<C2ICRrs> {
        ISEM_W::new(self, 31)
    }
}
/**HSEM Interrupt clear register of Line 2
