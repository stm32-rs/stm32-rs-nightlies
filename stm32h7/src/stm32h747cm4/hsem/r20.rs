#[doc = "Register `R20` reader"]
pub struct R(crate::R<R20_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R20_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R20_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R20_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R20` writer"]
pub struct W(crate::W<R20_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R20_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R20_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R20_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "HSEM register HSEM_R0 HSEM_R31\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [r20](index.html) module"]
pub struct R20_SPEC;
impl crate::RegisterSpec for R20_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [r20::R](R) reader structure"]
impl crate::Readable for R20_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r20::W](W) writer structure"]
impl crate::Writable for R20_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R20 to value 0"]
impl crate::Resettable for R20_SPEC {
    #[inline(always)]
