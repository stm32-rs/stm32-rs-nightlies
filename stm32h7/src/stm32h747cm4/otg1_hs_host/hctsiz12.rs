#[doc = "Reader of register HCTSIZ12"]
pub type R = crate::R<u32, super::HCTSIZ12>;
#[doc = "Writer for register HCTSIZ12"]
pub type W = crate::W<u32, super::HCTSIZ12>;
#[doc = "Register HCTSIZ12 `reset()`'s with value 0"]
impl crate::ResetValue for super::HCTSIZ12 {
    type Type = u32;
    #[inline(always)]
