...
///Field `SDEXTHP` reader - Step-down converter forced ON and in High Power MR mode
pub type SDEXTHP_R = crate::BitReader;
///Field `SDEXTHP` writer - Step-down converter forced ON and in High Power MR mode
pub type SDEXTHP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDLEVEL` reader - Step-down converter voltage output level selection
pub type SDLEVEL_R = crate::FieldReader;
///Field `SDLEVEL` writer - Step-down converter voltage output level selection
...
impl R {
    ...
    ///Bit 3 - Step-down converter forced ON and in High Power MR mode
    #[inline(always)]
    pub fn sdexthp(&self) -> SDEXTHP_R {
        SDEXTHP_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bits 4:5 - Step-down converter voltage output level selection
    #[inline(always)]
