...
///Field `USB1OTGHSEN` reader - Enable of USB1OTG (OTG_HS1) peripheral clocks
...
///Field `USB1OTGHSEN` writer - Enable of USB1OTG (OTG_HS1) peripheral clocks
...
impl R {
    ...
    ///Bit 25 - Enable of USB1OTG (OTG_HS1) peripheral clocks
    #[inline(always)]
...
impl W {
    ...
    ///Bit 14 - ART Clock enable
    #[inline(always)]
    pub fn arten(&mut self) -> ARTEN_W<'_, AHB1ENRrs> {
        ARTEN_W::new(self, 14)
    }
    ///Bit 15 - Ethernet MAC bus interface Clock Enable
    #[inline(always)]
    ...
    ///Bit 27 - USB2OTG Peripheral Clocks Enable
    #[inline(always)]
    pub fn usb2otghsen(&mut self) -> USB2OTGHSEN_W<'_, AHB1ENRrs> {
        USB2OTGHSEN_W::new(self, 27)
    }
    ///Bit 28 - USB_PHY2 Clocks Enable
    #[inline(always)]
    pub fn usb2otghsulpien(&mut self) -> USB2OTGHSULPIEN_W<'_, AHB1ENRrs> {
