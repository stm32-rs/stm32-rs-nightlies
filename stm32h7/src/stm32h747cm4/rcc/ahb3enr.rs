...
///Field `FLITFEN` reader - D1 FLASH Interface Enable
pub use MDMAEN_R as FLITFEN_R;
...
///Field `FLITFEN` writer - D1 FLASH Interface Enable
pub use MDMAEN_W as FLITFEN_W;
...
impl R {
    ...
    ///Bit 8 - D1 FLASH Interface Enable
    #[inline(always)]
...
impl W {
    ...
    ///Bit 8 - D1 FLASH Interface Enable
    #[inline(always)]
    pub fn flitfen(&mut self) -> FLITFEN_W<'_, AHB3ENRrs> {
