#[doc = "Reader of register C1_AHB1ENR"]
pub type R = crate::R<u32, super::C1_AHB1ENR>;
#[doc = "Writer for register C1_AHB1ENR"]
pub type W = crate::W<u32, super::C1_AHB1ENR>;
#[doc = "Register C1_AHB1ENR `reset()`'s with value 0"]
impl crate::ResetValue for super::C1_AHB1ENR {
    type Type = u32;
    #[inline(always)]
...
pub type ARTEN_A = DMA1EN_A;
#[doc = "Reader of field `ARTEN`"]
pub type ARTEN_R = crate::R<bool, DMA1EN_A>;
...
impl R {
    ...
    pub fn arten(&self) -> ARTEN_R {
        ARTEN_R::new(((self.bits >> 14) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - DMA1 Clock Enable"]
