...
pub type WWDG2EN_A = TIM2EN_A;
#[doc = "Field `WWDG2EN` reader - WWDG2 peripheral clock enable"]
pub type WWDG2EN_R = TIM2EN_R;
#[doc = "Field `WWDG2EN` writer - WWDG2 peripheral clock enable"]
pub struct WWDG2EN_W<'a> {
    w: &'a mut W,
}
impl<'a> WWDG2EN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: WWDG2EN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "The selected clock is disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(WWDG2EN_A::DISABLED)
    }
    #[doc = "The selected clock is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(WWDG2EN_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn wwdg2en(&self) -> WWDG2EN_R {
        WWDG2EN_R::new(((self.bits >> 11) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - TIM peripheral clock enable"]
    ...
    #[doc = "Bit 11 - WWDG2 peripheral clock enable"]
    #[inline(always)]
    pub fn wwdg2en(&mut self) -> WWDG2EN_W {
        WWDG2EN_W { w: self }
    }
