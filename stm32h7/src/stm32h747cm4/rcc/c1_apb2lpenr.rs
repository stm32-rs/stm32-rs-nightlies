...
impl W {
    ...
    ///Bit 23 - SAI2 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn sai2lpen(&mut self) -> SAI2LPEN_W<'_, C1_APB2LPENRrs> {
        SAI2LPEN_W::new(self, 23)
    }
    ///Bit 24 - SAI3 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn sai3lpen(&mut self) -> SAI3LPEN_W<'_, C1_APB2LPENRrs> {
    ...
    ///Bit 29 - HRTIM peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn hrtimlpen(&mut self) -> HRTIMLPEN_W<'_, C1_APB2LPENRrs> {
