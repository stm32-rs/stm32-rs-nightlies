...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpurstf(&mut self) -> CPURSTF_W<RSRrs> {
        CPURSTF_W::new(self, 17)
    }
    ///Bit 19 - D1 domain power switch reset flag
    #[inline(always)]
    #[must_use]
    pub fn d1rstf(&mut self) -> D1RSTF_W<RSRrs> {
        D1RSTF_W::new(self, 19)
    }
    ///Bit 20 - D2 domain power switch reset flag
    #[inline(always)]
    #[must_use]
    pub fn d2rstf(&mut self) -> D2RSTF_W<RSRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn porrstf(&mut self) -> PORRSTF_W<RSRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iwdg1rstf(&mut self) -> IWDG1RSTF_W<RSRrs> {
        IWDG1RSTF_W::new(self, 26)
    }
    ///Bit 28 - Window Watchdog reset flag
    #[inline(always)]
    #[must_use]
    pub fn wwdg1rstf(&mut self) -> WWDG1RSTF_W<RSRrs> {
