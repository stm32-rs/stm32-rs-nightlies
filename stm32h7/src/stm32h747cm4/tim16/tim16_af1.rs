...
/**Field `BKDFBK1E` reader - BRK dfsdm1_break\[1\]
enable*/
pub type BKDFBK1E_R = crate::BitReader;
/**Field `BKDFBK1E` writer - BRK dfsdm1_break\[1\]
enable*/
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkine(&mut self) -> BKINE_W<TIM16_AF1rs> {
        BKINE_W::new(self, 0)
    }
    ///Bit 1 - BRK COMP1 enable
    #[inline(always)]
    #[must_use]
    pub fn bkcmp1e(&mut self) -> BKCMP1E_W<TIM16_AF1rs> {
        BKCMP1E_W::new(self, 1)
    }
    ///Bit 2 - BRK COMP2 enable
    #[inline(always)]
    #[must_use]
    pub fn bkcmp2e(&mut self) -> BKCMP2E_W<TIM16_AF1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkdfbk1e(&mut self) -> BKDFBK1E_W<TIM16_AF1rs> {
        BKDFBK1E_W::new(self, 8)
    }
    ///Bit 9 - BRK BKIN input polarity
    #[inline(always)]
    #[must_use]
    pub fn bkinp(&mut self) -> BKINP_W<TIM16_AF1rs> {
        BKINP_W::new(self, 9)
    }
    ///Bit 10 - BRK COMP1 input polarity
    #[inline(always)]
    #[must_use]
    pub fn bkcmp1p(&mut self) -> BKCMP1P_W<TIM16_AF1rs> {
        BKCMP1P_W::new(self, 10)
    }
    ///Bit 11 - BRK COMP2 input polarity
    #[inline(always)]
    #[must_use]
    pub fn bkcmp2p(&mut self) -> BKCMP2P_W<TIM16_AF1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#TIM16:TIM16_AF1)*/
...
///`reset()` method sets TIM16_AF1 to value 0
