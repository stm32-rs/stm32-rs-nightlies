///Register `INI3_FN_MOD` reader
pub type R = crate::R<INI3_FN_MODrs>;
///Register `INI3_FN_MOD` writer
...
impl W {
    ///Bit 0 - Override ASIB read issuing capability
    #[inline(always)]
    pub fn read_iss_override(&mut self) -> READ_ISS_OVERRIDE_W<'_, INI3_FN_MODrs> {
        READ_ISS_OVERRIDE_W::new(self, 0)
    }
    ///Bit 1 - Override ASIB write issuing capability
    #[inline(always)]
    pub fn write_iss_override(&mut self) -> WRITE_ISS_OVERRIDE_W<'_, INI3_FN_MODrs> {
        WRITE_ISS_OVERRIDE_W::new(self, 1)
    }
}
/**AXI interconnect - INI x issuing functionality modification register

You can [`read`](crate::Reg::read) this register and get [`ini3_fn_mod::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ini3_fn_mod::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#AXI:INI3_FN_MOD)*/
pub struct INI3_FN_MODrs;
impl crate::RegisterSpec for INI3_FN_MODrs {
    type Ux = u32;
}
///`read()` method returns [`ini3_fn_mod::R`](R) reader structure
impl crate::Readable for INI3_FN_MODrs {}
///`write(|w| ..)` method takes [`ini3_fn_mod::W`](W) writer structure
impl crate::Writable for INI3_FN_MODrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets INI3_FN_MOD to value 0x04
