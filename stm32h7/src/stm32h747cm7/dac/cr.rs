...
impl TSEL1_R {
    ...
    pub const fn variant(&self) -> Option<TSEL1> {
        match self.bits {
            ...
            9 => Some(TSEL1::Hrtim1dac1),
            10 => Some(TSEL1::Hrtim1dac2),
    ...
    ///hrtim1_dactrg1
    #[inline(always)]
    pub fn is_hrtim1dac1(&self) -> bool {
        *self == TSEL1::Hrtim1dac1
    }
    ///hrtim1_dactrg2
    #[inline(always)]
    pub fn is_hrtim1dac2(&self) -> bool {
        *self == TSEL1::Hrtim1dac2
    }
    ///LPTIM1 OUT event
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    ///hrtim1_dactrg1
    #[inline(always)]
    pub fn hrtim1dac1(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Hrtim1dac1)
    }
    ///hrtim1_dactrg2
    #[inline(always)]
    pub fn hrtim1dac2(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Hrtim1dac2)
    }
    ///LPTIM1 OUT event
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#DAC:CR)*/
pub struct CRrs;
