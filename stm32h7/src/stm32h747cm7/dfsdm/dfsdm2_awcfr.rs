#[doc = "Reader of register DFSDM2_AWCFR"]
pub type R = crate::R<u32, super::DFSDM2_AWCFR>;
#[doc = "Writer for register DFSDM2_AWCFR"]
pub type W = crate::W<u32, super::DFSDM2_AWCFR>;
#[doc = "Register DFSDM2_AWCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM2_AWCFR {
    type Type = u32;
    #[inline(always)]
