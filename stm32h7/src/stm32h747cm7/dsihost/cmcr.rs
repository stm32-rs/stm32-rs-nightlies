#[doc = "Reader of register CMCR"]
pub type R = crate::R<u32, super::CMCR>;
#[doc = "Writer for register CMCR"]
pub type W = crate::W<u32, super::CMCR>;
#[doc = "Register CMCR `reset()`'s with value 0"]
impl crate::ResetValue for super::CMCR {
    type Type = u32;
    #[inline(always)]
