#[doc = "Reader of register GHCR"]
pub type R = crate::R<u32, super::GHCR>;
#[doc = "Writer for register GHCR"]
pub type W = crate::W<u32, super::GHCR>;
#[doc = "Register GHCR `reset()`'s with value 0"]
impl crate::ResetValue for super::GHCR {
    type Type = u32;
    #[inline(always)]
