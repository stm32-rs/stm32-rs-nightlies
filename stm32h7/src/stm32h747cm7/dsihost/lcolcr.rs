#[doc = "Reader of register LCOLCR"]
pub type R = crate::R<u32, super::LCOLCR>;
#[doc = "Writer for register LCOLCR"]
pub type W = crate::W<u32, super::LCOLCR>;
#[doc = "Register LCOLCR `reset()`'s with value 0"]
impl crate::ResetValue for super::LCOLCR {
    type Type = u32;
    #[inline(always)]
