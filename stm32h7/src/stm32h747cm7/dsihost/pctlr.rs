#[doc = "Reader of register PCTLR"]
pub type R = crate::R<u32, super::PCTLR>;
#[doc = "Writer for register PCTLR"]
pub type W = crate::W<u32, super::PCTLR>;
#[doc = "Register PCTLR `reset()`'s with value 0"]
impl crate::ResetValue for super::PCTLR {
    type Type = u32;
    #[inline(always)]
