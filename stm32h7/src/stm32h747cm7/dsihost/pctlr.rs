...
impl W {
    ///Bit 1 - Digital enable
    #[inline(always)]
    pub fn den(&mut self) -> DEN_W<'_, PCTLRrs> {
        DEN_W::new(self, 1)
    }
    ///Bit 2 - Clock enable
    #[inline(always)]
    pub fn cke(&mut self) -> CKE_W<'_, PCTLRrs> {
        CKE_W::new(self, 2)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#DSIHOST:PCTLR)*/
pub struct PCTLRrs;
