#[doc = "Reader of register VLCR"]
pub type R = crate::R<u32, super::VLCR>;
#[doc = "Writer for register VLCR"]
pub type W = crate::W<u32, super::VLCR>;
#[doc = "Register VLCR `reset()`'s with value 0"]
impl crate::ResetValue for super::VLCR {
    type Type = u32;
    #[inline(always)]
