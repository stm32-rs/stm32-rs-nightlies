...
///Field `ADDRLO` reader - MAC Address 3 \[31:0\]
pub type ADDRLO_R = crate::FieldReader<u32>;
///Field `ADDRLO` writer - MAC Address 3 \[31:0\]
pub type ADDRLO_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - MAC Address 3 \[31:0\]
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#Ethernet_MAC:MACA3LR)*/
