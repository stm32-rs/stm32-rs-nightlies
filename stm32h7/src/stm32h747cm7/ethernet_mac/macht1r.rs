#[doc = "Reader of register MACHT1R"]
pub type R = crate::R<u32, super::MACHT1R>;
#[doc = "Writer for register MACHT1R"]
pub type W = crate::W<u32, super::MACHT1R>;
#[doc = "Register MACHT1R `reset()`'s with value 0"]
impl crate::ResetValue for super::MACHT1R {
    type Type = u32;
    #[inline(always)]
