...
///Field `L4SP0` reader - Layer 4 Source Port Number Field
pub type L4SP0_R = crate::FieldReader<u16>;
///Field `L4SP0` writer - Layer 4 Source Port Number Field
pub type L4SP0_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `L4DP0` reader - Layer 4 Destination Port Number Field
pub type L4DP0_R = crate::FieldReader<u16>;
///Field `L4DP0` writer - Layer 4 Destination Port Number Field
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#Ethernet_MAC:MACL4A0R)*/
