///Register `C1PR1` reader
pub type R = crate::R<C1PR1rs>;
///Register `C1PR1` writer
pub type W = crate::W<C1PR1rs>;
...
impl W {
    ///Bit 0 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr0(&mut self) -> PR0_W<'_, C1PR1rs> {
        PR0_W::new(self, 0)
    }
    ///Bit 1 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr1(&mut self) -> PR1_W<'_, C1PR1rs> {
        PR1_W::new(self, 1)
    }
    ///Bit 2 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr2(&mut self) -> PR2_W<'_, C1PR1rs> {
        PR2_W::new(self, 2)
    }
    ///Bit 3 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr3(&mut self) -> PR3_W<'_, C1PR1rs> {
        PR3_W::new(self, 3)
    }
    ///Bit 4 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr4(&mut self) -> PR4_W<'_, C1PR1rs> {
        PR4_W::new(self, 4)
    }
    ///Bit 5 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr5(&mut self) -> PR5_W<'_, C1PR1rs> {
        PR5_W::new(self, 5)
    }
    ///Bit 6 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr6(&mut self) -> PR6_W<'_, C1PR1rs> {
        PR6_W::new(self, 6)
    }
    ///Bit 7 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr7(&mut self) -> PR7_W<'_, C1PR1rs> {
        PR7_W::new(self, 7)
    }
    ///Bit 8 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr8(&mut self) -> PR8_W<'_, C1PR1rs> {
        PR8_W::new(self, 8)
    }
    ///Bit 9 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr9(&mut self) -> PR9_W<'_, C1PR1rs> {
        PR9_W::new(self, 9)
    }
    ///Bit 10 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr10(&mut self) -> PR10_W<'_, C1PR1rs> {
        PR10_W::new(self, 10)
    }
    ///Bit 11 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr11(&mut self) -> PR11_W<'_, C1PR1rs> {
        PR11_W::new(self, 11)
    }
    ///Bit 12 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr12(&mut self) -> PR12_W<'_, C1PR1rs> {
        PR12_W::new(self, 12)
    }
    ///Bit 13 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr13(&mut self) -> PR13_W<'_, C1PR1rs> {
        PR13_W::new(self, 13)
    }
    ///Bit 14 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr14(&mut self) -> PR14_W<'_, C1PR1rs> {
        PR14_W::new(self, 14)
    }
    ///Bit 15 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr15(&mut self) -> PR15_W<'_, C1PR1rs> {
        PR15_W::new(self, 15)
    }
    ///Bit 16 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr16(&mut self) -> PR16_W<'_, C1PR1rs> {
        PR16_W::new(self, 16)
    }
    ///Bit 17 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr17(&mut self) -> PR17_W<'_, C1PR1rs> {
        PR17_W::new(self, 17)
    }
    ///Bit 18 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr18(&mut self) -> PR18_W<'_, C1PR1rs> {
        PR18_W::new(self, 18)
    }
    ///Bit 19 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr19(&mut self) -> PR19_W<'_, C1PR1rs> {
        PR19_W::new(self, 19)
    }
    ///Bit 20 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr20(&mut self) -> PR20_W<'_, C1PR1rs> {
        PR20_W::new(self, 20)
    }
    ///Bit 21 - CPU Event mask on Event input x
    #[inline(always)]
    pub fn pr21(&mut self) -> PR21_W<'_, C1PR1rs> {
        PR21_W::new(self, 21)
    }
}
/**EXTI pending register

You can [`read`](crate::Reg::read) this register and get [`c1pr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c1pr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#EXTI:C1PR1)*/
pub struct C1PR1rs;
impl crate::RegisterSpec for C1PR1rs {
    type Ux = u32;
}
///`read()` method returns [`c1pr1::R`](R) reader structure
impl crate::Readable for C1PR1rs {}
///`write(|w| ..)` method takes [`c1pr1::W`](W) writer structure
impl crate::Writable for C1PR1rs {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x003f_ffff;
}
///`reset()` method sets C1PR1 to value 0
impl crate::Resettable for C1PR1rs {}
