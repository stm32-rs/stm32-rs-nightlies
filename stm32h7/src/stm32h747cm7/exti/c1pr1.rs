#[doc = "Reader of register C1PR1"]
pub type R = crate::R<u32, super::C1PR1>;
#[doc = "Writer for register C1PR1"]
pub type W = crate::W<u32, super::C1PR1>;
#[doc = "Register C1PR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::C1PR1 {
    type Type = u32;
    #[inline(always)]
