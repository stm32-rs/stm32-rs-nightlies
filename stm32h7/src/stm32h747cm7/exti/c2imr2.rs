...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr32(&mut self) -> MR32_W<C2IMR2rs> {
        MR32_W::new(self, 0)
    }
    ///Bit 1 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr33(&mut self) -> MR33_W<C2IMR2rs> {
        MR33_W::new(self, 1)
    }
    ///Bit 2 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr34(&mut self) -> MR34_W<C2IMR2rs> {
        MR34_W::new(self, 2)
    }
    ///Bit 3 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr35(&mut self) -> MR35_W<C2IMR2rs> {
        MR35_W::new(self, 3)
    }
    ///Bit 4 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr36(&mut self) -> MR36_W<C2IMR2rs> {
        MR36_W::new(self, 4)
    }
    ///Bit 5 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr37(&mut self) -> MR37_W<C2IMR2rs> {
        MR37_W::new(self, 5)
    }
    ///Bit 6 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr38(&mut self) -> MR38_W<C2IMR2rs> {
        MR38_W::new(self, 6)
    }
    ///Bit 7 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr39(&mut self) -> MR39_W<C2IMR2rs> {
        MR39_W::new(self, 7)
    }
    ///Bit 8 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr40(&mut self) -> MR40_W<C2IMR2rs> {
        MR40_W::new(self, 8)
    }
    ///Bit 9 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr41(&mut self) -> MR41_W<C2IMR2rs> {
        MR41_W::new(self, 9)
    }
    ///Bit 10 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr42(&mut self) -> MR42_W<C2IMR2rs> {
        MR42_W::new(self, 10)
    }
    ///Bit 11 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr43(&mut self) -> MR43_W<C2IMR2rs> {
        MR43_W::new(self, 11)
    }
    ///Bit 12 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr44(&mut self) -> MR44_W<C2IMR2rs> {
        MR44_W::new(self, 12)
    }
    ///Bit 14 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr46(&mut self) -> MR46_W<C2IMR2rs> {
        MR46_W::new(self, 14)
    }
    ///Bit 15 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr47(&mut self) -> MR47_W<C2IMR2rs> {
        MR47_W::new(self, 15)
    }
    ///Bit 16 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr48(&mut self) -> MR48_W<C2IMR2rs> {
        MR48_W::new(self, 16)
    }
    ///Bit 17 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr49(&mut self) -> MR49_W<C2IMR2rs> {
        MR49_W::new(self, 17)
    }
    ///Bit 18 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr50(&mut self) -> MR50_W<C2IMR2rs> {
        MR50_W::new(self, 18)
    }
    ///Bit 19 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr51(&mut self) -> MR51_W<C2IMR2rs> {
        MR51_W::new(self, 19)
    }
    ///Bit 20 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr52(&mut self) -> MR52_W<C2IMR2rs> {
        MR52_W::new(self, 20)
    }
    ///Bit 21 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr53(&mut self) -> MR53_W<C2IMR2rs> {
        MR53_W::new(self, 21)
    }
    ///Bit 22 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr54(&mut self) -> MR54_W<C2IMR2rs> {
        MR54_W::new(self, 22)
    }
    ///Bit 23 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr55(&mut self) -> MR55_W<C2IMR2rs> {
        MR55_W::new(self, 23)
    }
    ///Bit 24 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr56(&mut self) -> MR56_W<C2IMR2rs> {
        MR56_W::new(self, 24)
    }
    ///Bit 25 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr57(&mut self) -> MR57_W<C2IMR2rs> {
        MR57_W::new(self, 25)
    }
    ///Bit 26 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr58(&mut self) -> MR58_W<C2IMR2rs> {
        MR58_W::new(self, 26)
    }
    ///Bit 27 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr59(&mut self) -> MR59_W<C2IMR2rs> {
        MR59_W::new(self, 27)
    }
    ///Bit 28 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr60(&mut self) -> MR60_W<C2IMR2rs> {
        MR60_W::new(self, 28)
    }
    ///Bit 29 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr61(&mut self) -> MR61_W<C2IMR2rs> {
        MR61_W::new(self, 29)
    }
    ///Bit 30 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr62(&mut self) -> MR62_W<C2IMR2rs> {
        MR62_W::new(self, 30)
    }
    ///Bit 31 - CPU2 interrupt Mask on Direct Event input x+32
    #[inline(always)]
    #[must_use]
    pub fn mr63(&mut self) -> MR63_W<C2IMR2rs> {
        MR63_W::new(self, 31)
    }
}
