...
impl W {
    ///Bit 0 - Reject Remote Frames Extended
    #[inline(always)]
    pub fn rrfe(&mut self) -> RRFE_W<GFCrs> {
        RRFE_W::new(self, 0)
    }
    ///Bit 1 - Reject Remote Frames Standard
    #[inline(always)]
    pub fn rrfs(&mut self) -> RRFS_W<GFCrs> {
        RRFS_W::new(self, 1)
    }
    ///Bits 2:3 - Accept Non-matching Frames Extended
    #[inline(always)]
    pub fn anfe(&mut self) -> ANFE_W<GFCrs> {
        ANFE_W::new(self, 2)
    }
    ///Bits 4:5 - Accept Non-matching Frames Standard
    #[inline(always)]
    pub fn anfs(&mut self) -> ANFS_W<GFCrs> {
        ANFS_W::new(self, 4)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#FDCAN1:GFC)*/
pub struct GFCrs;
