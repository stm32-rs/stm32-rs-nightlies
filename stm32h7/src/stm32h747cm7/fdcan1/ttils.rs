...
impl W {
    ///Bit 0 - Start of Basic Cycle Interrupt Line
    #[inline(always)]
    pub fn sbcl(&mut self) -> SBCL_W<TTILSrs> {
        SBCL_W::new(self, 0)
    }
    ///Bit 1 - Start of Matrix Cycle Interrupt Line
    #[inline(always)]
    pub fn smcl(&mut self) -> SMCL_W<TTILSrs> {
        SMCL_W::new(self, 1)
    }
    ///Bit 2 - Change of Synchronization Mode Interrupt Line
    #[inline(always)]
    pub fn csml(&mut self) -> CSML_W<TTILSrs> {
        CSML_W::new(self, 2)
    }
    ///Bit 3 - Start of Gap Interrupt Line
    #[inline(always)]
    pub fn sogl(&mut self) -> SOGL_W<TTILSrs> {
        SOGL_W::new(self, 3)
    }
    ///Bit 4 - Register Time Mark Interrupt Line
    #[inline(always)]
    pub fn rtmil(&mut self) -> RTMIL_W<TTILSrs> {
        RTMIL_W::new(self, 4)
    }
    ///Bit 5 - Trigger Time Mark Event Internal Interrupt Line
    #[inline(always)]
    pub fn ttmil(&mut self) -> TTMIL_W<TTILSrs> {
        TTMIL_W::new(self, 5)
    }
    ///Bit 6 - Stop Watch Event Interrupt Line
    #[inline(always)]
    pub fn swel(&mut self) -> SWEL_W<TTILSrs> {
        SWEL_W::new(self, 6)
    }
    ///Bit 7 - Global Time Wrap Interrupt Line
    #[inline(always)]
    pub fn gtwl(&mut self) -> GTWL_W<TTILSrs> {
        GTWL_W::new(self, 7)
    }
    ///Bit 8 - Global Time Discontinuity Interrupt Line
    #[inline(always)]
    pub fn gtdl(&mut self) -> GTDL_W<TTILSrs> {
        GTDL_W::new(self, 8)
    }
    ///Bit 9 - Global Time Error Interrupt Line
    #[inline(always)]
    pub fn gtel(&mut self) -> GTEL_W<TTILSrs> {
        GTEL_W::new(self, 9)
    }
    ///Bit 10 - Tx Count Underflow Interrupt Line
    #[inline(always)]
    pub fn txul(&mut self) -> TXUL_W<TTILSrs> {
        TXUL_W::new(self, 10)
    }
    ///Bit 11 - Tx Count Overflow Interrupt Line
    #[inline(always)]
    pub fn txol(&mut self) -> TXOL_W<TTILSrs> {
        TXOL_W::new(self, 11)
    }
    ///Bit 12 - Scheduling Error 1 Interrupt Line
    #[inline(always)]
    pub fn se1l(&mut self) -> SE1L_W<TTILSrs> {
        SE1L_W::new(self, 12)
    }
    ///Bit 13 - Scheduling Error 2 Interrupt Line
    #[inline(always)]
    pub fn se2l(&mut self) -> SE2L_W<TTILSrs> {
        SE2L_W::new(self, 13)
    }
    ///Bit 14 - Change Error Level Interrupt Line
    #[inline(always)]
    pub fn elcl(&mut self) -> ELCL_W<TTILSrs> {
        ELCL_W::new(self, 14)
    }
    ///Bit 15 - Initialization Watch Trigger Interrupt Line
    #[inline(always)]
    pub fn iwtgl(&mut self) -> IWTGL_W<TTILSrs> {
        IWTGL_W::new(self, 15)
    }
    ///Bit 16 - Watch Trigger Interrupt Line
    #[inline(always)]
    pub fn wtl(&mut self) -> WTL_W<TTILSrs> {
        WTL_W::new(self, 16)
    }
    ///Bit 17 - Application Watchdog Interrupt Line
    #[inline(always)]
    pub fn awl(&mut self) -> AWL_W<TTILSrs> {
        AWL_W::new(self, 17)
    }
    ///Bit 18 - Configuration Error Interrupt Line
    #[inline(always)]
    pub fn cerl(&mut self) -> CERL_W<TTILSrs> {
        CERL_W::new(self, 18)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#FDCAN1:TTILS)*/
pub struct TTILSrs;
