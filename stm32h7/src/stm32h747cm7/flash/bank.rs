...
#[doc = "`write(|w| ..)` method takes [prar_cur::W](prar_cur::W) writer structure"]
impl crate::Writable for PRAR_CUR {}
#[doc = "FLASH protection address for bank 1"]
pub mod prar_cur;
...
#[doc = "`write(|w| ..)` method takes [wpsn_curr::W](wpsn_curr::W) writer structure"]
impl crate::Writable for WPSN_CURR {}
#[doc = "FLASH write sector protection for bank 1"]
pub mod wpsn_curr;
