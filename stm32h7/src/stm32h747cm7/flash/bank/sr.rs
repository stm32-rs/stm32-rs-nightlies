...
#[doc = "Reader of field `CRCRDERR`"]
pub type CRCRDERR_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `CRCRDERR`"]
...
#[doc = "Reader of field `SNECCERR`"]
pub type SNECCERR_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SNECCERR`"]
