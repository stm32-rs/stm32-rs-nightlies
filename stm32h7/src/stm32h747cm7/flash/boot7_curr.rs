...
pub struct BOOT_CM7_ADD1_R(crate::FieldReader<u16, u16>);
impl BOOT_CM7_ADD1_R {
    pub(crate) fn new(bits: u16) -> Self {
        BOOT_CM7_ADD1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BOOT_CM7_ADD1_R {
...
pub struct BOOT_CM7_ADD0_R(crate::FieldReader<u16, u16>);
impl BOOT_CM7_ADD0_R {
    pub(crate) fn new(bits: u16) -> Self {
        BOOT_CM7_ADD0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BOOT_CM7_ADD0_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
