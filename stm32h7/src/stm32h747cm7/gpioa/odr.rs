...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `ODR0` field.</div>
    #[inline(always)]
    pub fn odr(&mut self, n: u8) -> ODR_W<'_, ODRrs> {
        #[allow(clippy::no_effect)]
        [(); 16][n as usize];
        ODR_W::new(self, n)
    }
    ///Bit 0 - Port output data pin 0
    #[inline(always)]
    pub fn odr0(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 0)
    }
    ///Bit 1 - Port output data pin 1
    #[inline(always)]
    pub fn odr1(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 1)
    }
    ///Bit 2 - Port output data pin 2
    #[inline(always)]
    pub fn odr2(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 2)
    }
    ///Bit 3 - Port output data pin 3
    #[inline(always)]
    pub fn odr3(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 3)
    }
    ///Bit 4 - Port output data pin 4
    #[inline(always)]
    pub fn odr4(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 4)
    }
    ///Bit 5 - Port output data pin 5
    #[inline(always)]
    pub fn odr5(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 5)
    }
    ///Bit 6 - Port output data pin 6
    #[inline(always)]
    pub fn odr6(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 6)
    }
    ///Bit 7 - Port output data pin 7
    #[inline(always)]
    pub fn odr7(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 7)
    }
    ///Bit 8 - Port output data pin 8
    #[inline(always)]
    pub fn odr8(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 8)
    }
    ///Bit 9 - Port output data pin 9
    #[inline(always)]
    pub fn odr9(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 9)
    }
    ///Bit 10 - Port output data pin 10
    #[inline(always)]
    pub fn odr10(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 10)
    }
    ///Bit 11 - Port output data pin 11
    #[inline(always)]
    pub fn odr11(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 11)
    }
    ///Bit 12 - Port output data pin 12
    #[inline(always)]
    pub fn odr12(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 12)
    }
    ///Bit 13 - Port output data pin 13
    #[inline(always)]
    pub fn odr13(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 13)
    }
    ///Bit 14 - Port output data pin 14
    #[inline(always)]
    pub fn odr14(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 14)
    }
    ///Bit 15 - Port output data pin 15
    #[inline(always)]
    pub fn odr15(&mut self) -> ODR_W<'_, ODRrs> {
        ODR_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#GPIOA:ODR)*/
pub struct ODRrs;
