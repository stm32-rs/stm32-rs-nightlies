...
///Field `_DTxR` reader - HRTIM_DTxR register update enable
pub use CR_R as _DTX_R_R;
...
///Field `_DTxR` writer - HRTIM_DTxR register update enable
pub use CR_W as _DTX_R_W;
...
impl R {
    ...
    #[inline(always)]
    pub fn _dtx_r(&self) -> _DTX_R_R {
        _DTX_R_R::new(((self.bits >> 10) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 10 - HRTIM_DTxR register update enable
    #[inline(always)]
    pub fn _dtx_r(&mut self) -> _DTX_R_W<BDTAUPRrs> {
        _DTX_R_W::new(self, 10)
    }
    ///Bit 11 - HRTIM_SET1xR register update enable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_Common:BDTAUPR)*/
