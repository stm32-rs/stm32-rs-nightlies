...
#[doc = "Master Timer Interrupt Clear Register"]
pub mod micr;
#[doc = "MDIER4\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mdier4](mdier4) module"]
pub type MDIER4 = crate::Reg<u32, _MDIER4>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _MDIER4;
#[doc = "`read()` method returns [mdier4::R](mdier4::R) reader structure"]
impl crate::Readable for MDIER4 {}
#[doc = "`write(|w| ..)` method takes [mdier4::W](mdier4::W) writer structure"]
impl crate::Writable for MDIER4 {}
#[doc = "MDIER4"]
pub mod mdier4;
