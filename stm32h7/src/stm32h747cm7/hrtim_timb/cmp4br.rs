///Register `CMP4BR` reader
pub type R = crate::R<CMP4BRrs>;
///Register `CMP4BR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_TIMB:CMP4BR)*/
pub struct CMP4BRrs;
impl crate::RegisterSpec for CMP4BRrs {
    type Ux = u32;
}
///`read()` method returns [`cmp4br::R`](R) reader structure
impl crate::Readable for CMP4BRrs {}
///`write(|w| ..)` method takes [`cmp4br::W`](W) writer structure
impl crate::Writable for CMP4BRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CMP4BR to value 0
