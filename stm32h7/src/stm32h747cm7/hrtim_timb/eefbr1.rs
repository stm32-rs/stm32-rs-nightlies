///Register `EEFBR1` reader
pub type R = crate::R<EEFBR1rs>;
///Register `EEFBR1` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_TIMB:EEFBR1)*/
pub struct EEFBR1rs;
impl crate::RegisterSpec for EEFBR1rs {
    type Ux = u32;
}
///`read()` method returns [`eefbr1::R`](R) reader structure
impl crate::Readable for EEFBR1rs {}
///`write(|w| ..)` method takes [`eefbr1::W`](W) writer structure
impl crate::Writable for EEFBR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EEFBR1 to value 0
