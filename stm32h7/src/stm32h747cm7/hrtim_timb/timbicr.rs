...
impl core::fmt::Debug for crate::generic::Reg<TIMBICRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_TIMB:TIMBICR)*/
pub struct TIMBICRrs;
impl crate::RegisterSpec for TIMBICRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`timbicr::W`](W) writer structure
impl crate::Writable for TIMBICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMBICR to value 0
