///Register `SETC1R` reader
pub type R = crate::R<SETC1Rrs>;
///Register `SETC1R` writer
pub type W = crate::W<SETC1Rrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sst(&mut self) -> SST_W<SETC1Rrs> {
        SST_W::new(self, 0)
    }
    ///Bit 1 - Timer A resynchronizaton
    #[inline(always)]
    #[must_use]
    pub fn resync(&mut self) -> RESYNC_W<SETC1Rrs> {
        RESYNC_W::new(self, 1)
    }
    ///Bit 2 - Timer A Period
    #[inline(always)]
    #[must_use]
    pub fn per(&mut self) -> PER_W<SETC1Rrs> {
        PER_W::new(self, 2)
    }
    ///Bit 3 - Timer A compare 1
    #[inline(always)]
    #[must_use]
    pub fn cmp1(&mut self) -> CMP1_W<SETC1Rrs> {
        CMP1_W::new(self, 3)
    }
    ///Bit 4 - Timer A compare 2
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> CMP2_W<SETC1Rrs> {
        CMP2_W::new(self, 4)
    }
    ///Bit 5 - Timer A compare 3
    #[inline(always)]
    #[must_use]
    pub fn cmp3(&mut self) -> CMP3_W<SETC1Rrs> {
        CMP3_W::new(self, 5)
    }
    ///Bit 6 - Timer A compare 4
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> CMP4_W<SETC1Rrs> {
        CMP4_W::new(self, 6)
    }
    ///Bit 7 - Master Period
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MSTPER_W<SETC1Rrs> {
        MSTPER_W::new(self, 7)
    }
    ///Bit 8 - Master Compare 1
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> MSTCMP1_W<SETC1Rrs> {
        MSTCMP1_W::new(self, 8)
    }
    ///Bit 9 - Master Compare 2
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> MSTCMP2_W<SETC1Rrs> {
        MSTCMP2_W::new(self, 9)
    }
    ///Bit 10 - Master Compare 3
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> MSTCMP3_W<SETC1Rrs> {
        MSTCMP3_W::new(self, 10)
    }
    ///Bit 11 - Master Compare 4
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> MSTCMP4_W<SETC1Rrs> {
        MSTCMP4_W::new(self, 11)
    }
    ///Bit 12 - Timer Event 1
    #[inline(always)]
    #[must_use]
    pub fn timevnt1(&mut self) -> TIMEVNT1_W<SETC1Rrs> {
        TIMEVNT1_W::new(self, 12)
    }
    ///Bit 13 - Timer Event 2
    #[inline(always)]
    #[must_use]
    pub fn timevnt2(&mut self) -> TIMEVNT2_W<SETC1Rrs> {
        TIMEVNT2_W::new(self, 13)
    }
    ///Bit 14 - Timer Event 3
    #[inline(always)]
    #[must_use]
    pub fn timevnt3(&mut self) -> TIMEVNT3_W<SETC1Rrs> {
        TIMEVNT3_W::new(self, 14)
    }
    ///Bit 15 - Timer Event 4
    #[inline(always)]
    #[must_use]
    pub fn timevnt4(&mut self) -> TIMEVNT4_W<SETC1Rrs> {
        TIMEVNT4_W::new(self, 15)
    }
    ///Bit 16 - Timer Event 5
    #[inline(always)]
    #[must_use]
    pub fn timevnt5(&mut self) -> TIMEVNT5_W<SETC1Rrs> {
        TIMEVNT5_W::new(self, 16)
    }
    ///Bit 17 - Timer Event 6
    #[inline(always)]
    #[must_use]
    pub fn timevnt6(&mut self) -> TIMEVNT6_W<SETC1Rrs> {
        TIMEVNT6_W::new(self, 17)
    }
    ///Bit 18 - Timer Event 7
    #[inline(always)]
    #[must_use]
    pub fn timevnt7(&mut self) -> TIMEVNT7_W<SETC1Rrs> {
        TIMEVNT7_W::new(self, 18)
    }
    ///Bit 19 - Timer Event 8
    #[inline(always)]
    #[must_use]
    pub fn timevnt8(&mut self) -> TIMEVNT8_W<SETC1Rrs> {
        TIMEVNT8_W::new(self, 19)
    }
    ///Bit 20 - Timer Event 9
    #[inline(always)]
    #[must_use]
    pub fn timevnt9(&mut self) -> TIMEVNT9_W<SETC1Rrs> {
        TIMEVNT9_W::new(self, 20)
    }
    ///Bit 21 - External Event 1
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> EXTEVNT1_W<SETC1Rrs> {
        EXTEVNT1_W::new(self, 21)
    }
    ///Bit 22 - External Event 2
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> EXTEVNT2_W<SETC1Rrs> {
        EXTEVNT2_W::new(self, 22)
    }
    ///Bit 23 - External Event 3
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> EXTEVNT3_W<SETC1Rrs> {
        EXTEVNT3_W::new(self, 23)
    }
    ///Bit 24 - External Event 4
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> EXTEVNT4_W<SETC1Rrs> {
        EXTEVNT4_W::new(self, 24)
    }
    ///Bit 25 - External Event 5
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> EXTEVNT5_W<SETC1Rrs> {
        EXTEVNT5_W::new(self, 25)
    }
    ///Bit 26 - External Event 6
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> EXTEVNT6_W<SETC1Rrs> {
        EXTEVNT6_W::new(self, 26)
    }
    ///Bit 27 - External Event 7
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> EXTEVNT7_W<SETC1Rrs> {
        EXTEVNT7_W::new(self, 27)
    }
    ///Bit 28 - External Event 8
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> EXTEVNT8_W<SETC1Rrs> {
        EXTEVNT8_W::new(self, 28)
    }
    ///Bit 29 - External Event 9
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> EXTEVNT9_W<SETC1Rrs> {
        EXTEVNT9_W::new(self, 29)
    }
    ///Bit 30 - External Event 10
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> EXTEVNT10_W<SETC1Rrs> {
        EXTEVNT10_W::new(self, 30)
    }
    ///Bit 31 - Registers update (transfer preload to active)
    #[inline(always)]
    #[must_use]
    pub fn update(&mut self) -> UPDATE_W<SETC1Rrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_TIMC:SETC1R)*/
pub struct SETC1Rrs;
impl crate::RegisterSpec for SETC1Rrs {
    type Ux = u32;
}
///`read()` method returns [`setc1r::R`](R) reader structure
impl crate::Readable for SETC1Rrs {}
///`write(|w| ..)` method takes [`setc1r::W`](W) writer structure
impl crate::Writable for SETC1Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SETC1R to value 0
impl crate::Resettable for SETC1Rrs {
