///Register `EEFDR1` reader
pub type R = crate::R<EEFDR1rs>;
///Register `EEFDR1` writer
pub type W = crate::W<EEFDR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee1ltch(&mut self) -> EE1LTCH_W<EEFDR1rs> {
        EE1LTCH_W::new(self, 0)
    }
    ///Bits 1:4 - External Event 1 filter
    #[inline(always)]
    #[must_use]
    pub fn ee1fltr(&mut self) -> EE1FLTR_W<EEFDR1rs> {
        EE1FLTR_W::new(self, 1)
    }
    ///Bit 6 - External Event 2 latch
    #[inline(always)]
    #[must_use]
    pub fn ee2ltch(&mut self) -> EE2LTCH_W<EEFDR1rs> {
        EE2LTCH_W::new(self, 6)
    }
    ///Bits 7:10 - External Event 2 filter
    #[inline(always)]
    #[must_use]
    pub fn ee2fltr(&mut self) -> EE2FLTR_W<EEFDR1rs> {
        EE2FLTR_W::new(self, 7)
    }
    ///Bit 12 - External Event 3 latch
    #[inline(always)]
    #[must_use]
    pub fn ee3ltch(&mut self) -> EE3LTCH_W<EEFDR1rs> {
        EE3LTCH_W::new(self, 12)
    }
    ///Bits 13:16 - External Event 3 filter
    #[inline(always)]
    #[must_use]
    pub fn ee3fltr(&mut self) -> EE3FLTR_W<EEFDR1rs> {
        EE3FLTR_W::new(self, 13)
    }
    ///Bit 18 - External Event 4 latch
    #[inline(always)]
    #[must_use]
    pub fn ee4ltch(&mut self) -> EE4LTCH_W<EEFDR1rs> {
        EE4LTCH_W::new(self, 18)
    }
    ///Bits 19:22 - External Event 4 filter
    #[inline(always)]
    #[must_use]
    pub fn ee4fltr(&mut self) -> EE4FLTR_W<EEFDR1rs> {
        EE4FLTR_W::new(self, 19)
    }
    ///Bit 24 - External Event 5 latch
    #[inline(always)]
    #[must_use]
    pub fn ee5ltch(&mut self) -> EE5LTCH_W<EEFDR1rs> {
        EE5LTCH_W::new(self, 24)
    }
    ///Bits 25:28 - External Event 5 filter
    #[inline(always)]
    #[must_use]
    pub fn ee5fltr(&mut self) -> EE5FLTR_W<EEFDR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_TIMD:EEFDR1)*/
pub struct EEFDR1rs;
impl crate::RegisterSpec for EEFDR1rs {
    type Ux = u32;
}
///`read()` method returns [`eefdr1::R`](R) reader structure
impl crate::Readable for EEFDR1rs {}
///`write(|w| ..)` method takes [`eefdr1::W`](W) writer structure
impl crate::Writable for EEFDR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EEFDR1 to value 0
impl crate::Resettable for EEFDR1rs {
