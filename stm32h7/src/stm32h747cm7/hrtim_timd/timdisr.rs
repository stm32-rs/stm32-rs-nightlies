...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_TIMD:TIMDISR)*/
pub struct TIMDISRrs;
impl crate::RegisterSpec for TIMDISRrs {
    type Ux = u32;
}
///`read()` method returns [`timdisr::R`](R) reader structure
impl crate::Readable for TIMDISRrs {}
///`reset()` method sets TIMDISR to value 0
