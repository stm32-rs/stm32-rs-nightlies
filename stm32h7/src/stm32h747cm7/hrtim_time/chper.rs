#[doc = "Reader of register CHPER"]
pub type R = crate::R<u32, super::CHPER>;
#[doc = "Writer for register CHPER"]
pub type W = crate::W<u32, super::CHPER>;
#[doc = "Register CHPER `reset()`'s with value 0"]
impl crate::ResetValue for super::CHPER {
    type Type = u32;
    #[inline(always)]
