...
pub type R = crate::R<EEFER1rs>;
///Register `EEFER1` writer
pub type W = crate::W<EEFER1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee1ltch(&mut self) -> EE1LTCH_W<EEFER1rs> {
        EE1LTCH_W::new(self, 0)
    }
    ///Bits 1:4 - External Event 1 filter
    #[inline(always)]
    #[must_use]
    pub fn ee1fltr(&mut self) -> EE1FLTR_W<EEFER1rs> {
        EE1FLTR_W::new(self, 1)
    }
    ///Bit 6 - External Event 2 latch
    #[inline(always)]
    #[must_use]
    pub fn ee2ltch(&mut self) -> EE2LTCH_W<EEFER1rs> {
        EE2LTCH_W::new(self, 6)
    }
    ///Bits 7:10 - External Event 2 filter
    #[inline(always)]
    #[must_use]
    pub fn ee2fltr(&mut self) -> EE2FLTR_W<EEFER1rs> {
        EE2FLTR_W::new(self, 7)
    }
    ///Bit 12 - External Event 3 latch
    #[inline(always)]
    #[must_use]
    pub fn ee3ltch(&mut self) -> EE3LTCH_W<EEFER1rs> {
        EE3LTCH_W::new(self, 12)
    }
    ///Bits 13:16 - External Event 3 filter
    #[inline(always)]
    #[must_use]
    pub fn ee3fltr(&mut self) -> EE3FLTR_W<EEFER1rs> {
        EE3FLTR_W::new(self, 13)
    }
    ///Bit 18 - External Event 4 latch
    #[inline(always)]
    #[must_use]
    pub fn ee4ltch(&mut self) -> EE4LTCH_W<EEFER1rs> {
        EE4LTCH_W::new(self, 18)
    }
    ///Bits 19:22 - External Event 4 filter
    #[inline(always)]
    #[must_use]
    pub fn ee4fltr(&mut self) -> EE4FLTR_W<EEFER1rs> {
        EE4FLTR_W::new(self, 19)
    }
    ///Bit 24 - External Event 5 latch
    #[inline(always)]
    #[must_use]
    pub fn ee5ltch(&mut self) -> EE5LTCH_W<EEFER1rs> {
        EE5LTCH_W::new(self, 24)
    }
    ///Bits 25:28 - External Event 5 filter
    #[inline(always)]
    #[must_use]
    pub fn ee5fltr(&mut self) -> EE5FLTR_W<EEFER1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_TIME:EEFER1)*/
pub struct EEFER1rs;
impl crate::RegisterSpec for EEFER1rs {
    type Ux = u32;
}
///`read()` method returns [`eefer1::R`](R) reader structure
impl crate::Readable for EEFER1rs {}
///`write(|w| ..)` method takes [`eefer1::W`](W) writer structure
impl crate::Writable for EEFER1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EEFER1 to value 0
impl crate::Resettable for EEFER1rs {
