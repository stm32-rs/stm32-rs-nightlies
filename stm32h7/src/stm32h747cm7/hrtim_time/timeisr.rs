///Register `TIMEISR` reader
pub type R = crate::R<TIMEISRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_TIME:TIMEISR)*/
pub struct TIMEISRrs;
impl crate::RegisterSpec for TIMEISRrs {
    type Ux = u32;
}
///`read()` method returns [`timeisr::R`](R) reader structure
impl crate::Readable for TIMEISRrs {}
///`reset()` method sets TIMEISR to value 0
impl crate::Resettable for TIMEISRrs {
