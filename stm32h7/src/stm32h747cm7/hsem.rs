...
impl RegisterBlock {
    ...
    ///0x100 - HSEM Interrupt enable register of Line 1
    #[inline(always)]
    pub const fn c1ier(&self) -> &C1IER {
        &self.c1ier
    }
    ///0x104 - HSEM Interrupt clear register of Line 1
    #[inline(always)]
    pub const fn c1icr(&self) -> &C1ICR {
        &self.c1icr
    }
    ///0x108 - HSEM Interrupt status register of Line 1
    #[inline(always)]
    pub const fn c1isr(&self) -> &C1ISR {
        &self.c1isr
    }
    ///0x10c - HSEM Masked interrupt status of Line 1
    #[inline(always)]
    pub const fn c1misr(&self) -> &C1MISR {
        &self.c1misr
    }
    ///0x110 - HSEM Interrupt enable register of Line 2
    #[inline(always)]
    pub const fn c2ier(&self) -> &C2IER {
        &self.c2ier
    }
    ///0x114 - HSEM Interrupt clear register of Line 2
    #[inline(always)]
    pub const fn c2icr(&self) -> &C2ICR {
        &self.c2icr
    }
    ///0x118 - HSEM Interrupt status register of Line 2
    #[inline(always)]
    pub const fn c2isr(&self) -> &C2ISR {
        &self.c2isr
    }
    ///0x11c - HSEM Masked interrupt status register of Line 2
    #[inline(always)]
...
pub mod rlr;
/**C1IER (rw) register accessor: HSEM Interrupt enable register of Line 1
...
///HSEM Interrupt enable register of Line 1
pub mod c1ier;
/**C1ICR (rw) register accessor: HSEM Interrupt clear register of Line 1
...
pub mod c1icr;
/**C1ISR (r) register accessor: HSEM Interrupt status register of Line 1
...
///HSEM Interrupt status register of Line 1
pub mod c1isr;
/**C1MISR (r) register accessor: HSEM Masked interrupt status of Line 1
...
pub mod keyr;
/**C2IER (rw) register accessor: HSEM Interrupt enable register of Line 2
...
pub mod c2ier;
/**C2ICR (rw) register accessor: HSEM Interrupt clear register of Line 2
...
pub mod c2icr;
/**C2ISR (rw) register accessor: HSEM Interrupt status register of Line 2

You can [`read`](crate::Reg::read) this register and get [`c2isr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c2isr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
pub mod c2isr;
/**C2MISR (rw) register accessor: HSEM Masked interrupt status register of Line 2

You can [`read`](crate::Reg::read) this register and get [`c2misr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c2misr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
