...
///Field `ISEM(0-31)` reader - Interrupt(1) semaphore %s enable bit
pub type ISEM_R = crate::BitReader;
///Field `ISEM(0-31)` writer - Interrupt(1) semaphore %s enable bit
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn isem(&mut self, n: u8) -> ISEM_W<C1IERrs> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        ISEM_W::new(self, n)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn isem0(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 0)
    }
    ///Bit 1 - Interrupt(1) semaphore 1 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem1(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 1)
    }
    ///Bit 2 - Interrupt(1) semaphore 2 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem2(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 2)
    }
    ///Bit 3 - Interrupt(1) semaphore 3 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem3(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 3)
    }
    ///Bit 4 - Interrupt(1) semaphore 4 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem4(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 4)
    }
    ///Bit 5 - Interrupt(1) semaphore 5 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem5(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 5)
    }
    ///Bit 6 - Interrupt(1) semaphore 6 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem6(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 6)
    }
    ///Bit 7 - Interrupt(1) semaphore 7 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem7(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 7)
    }
    ///Bit 8 - Interrupt(1) semaphore 8 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem8(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 8)
    }
    ///Bit 9 - Interrupt(1) semaphore 9 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem9(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 9)
    }
    ///Bit 10 - Interrupt(1) semaphore 10 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem10(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 10)
    }
    ///Bit 11 - Interrupt(1) semaphore 11 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem11(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 11)
    }
    ///Bit 12 - Interrupt(1) semaphore 12 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem12(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 12)
    }
    ///Bit 13 - Interrupt(1) semaphore 13 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem13(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 13)
    }
    ///Bit 14 - Interrupt(1) semaphore 14 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem14(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 14)
    }
    ///Bit 15 - Interrupt(1) semaphore 15 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem15(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 15)
    }
    ///Bit 16 - Interrupt(1) semaphore 16 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem16(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 16)
    }
    ///Bit 17 - Interrupt(1) semaphore 17 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem17(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 17)
    }
    ///Bit 18 - Interrupt(1) semaphore 18 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem18(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 18)
    }
    ///Bit 19 - Interrupt(1) semaphore 19 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem19(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 19)
    }
    ///Bit 20 - Interrupt(1) semaphore 20 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem20(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 20)
    }
    ///Bit 21 - Interrupt(1) semaphore 21 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem21(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 21)
    }
    ///Bit 22 - Interrupt(1) semaphore 22 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem22(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 22)
    }
    ///Bit 23 - Interrupt(1) semaphore 23 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem23(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 23)
    }
    ///Bit 24 - Interrupt(1) semaphore 24 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem24(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 24)
    }
    ///Bit 25 - Interrupt(1) semaphore 25 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem25(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 25)
    }
    ///Bit 26 - Interrupt(1) semaphore 26 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem26(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 26)
    }
    ///Bit 27 - Interrupt(1) semaphore 27 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem27(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 27)
    }
    ///Bit 28 - Interrupt(1) semaphore 28 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem28(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 28)
    }
    ///Bit 29 - Interrupt(1) semaphore 29 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem29(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 29)
    }
    ///Bit 30 - Interrupt(1) semaphore 30 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem30(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 30)
    }
    ///Bit 31 - Interrupt(1) semaphore 31 enable bit
    #[inline(always)]
    #[must_use]
    pub fn isem31(&mut self) -> ISEM_W<C1IERrs> {
        ISEM_W::new(self, 31)
    }
}
