#[doc = "Register `R21` reader"]
pub struct R(crate::R<R21_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R21_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R21_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R21_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R21` writer"]
pub struct W(crate::W<R21_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R21_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R21_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R21_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "HSEM register HSEM_R0 HSEM_R31\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [r21](index.html) module"]
pub struct R21_SPEC;
impl crate::RegisterSpec for R21_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [r21::R](R) reader structure"]
impl crate::Readable for R21_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r21::W](W) writer structure"]
impl crate::Writable for R21_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R21 to value 0"]
impl crate::Resettable for R21_SPEC {
    #[inline(always)]
