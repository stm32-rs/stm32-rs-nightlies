...
impl W {
    ///Bits 0:4 - Trim for NMOS differential pairs
    #[inline(always)]
    pub fn trimoffsetn(&mut self) -> TRIMOFFSETN_W<'_, OPAMP2_OTRrs> {
        TRIMOFFSETN_W::new(self, 0)
    }
    ///Bits 8:12 - Trim for PMOS differential pairs
    #[inline(always)]
    pub fn trimoffsetp(&mut self) -> TRIMOFFSETP_W<'_, OPAMP2_OTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#OPAMP:OPAMP2_OTR)*/
