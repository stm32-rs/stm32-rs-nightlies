...
impl W {
    ...
    ///Bit 6 - Back-to-back SETUP packets received mask
    #[inline(always)]
    pub fn b2bstup(&mut self) -> B2BSTUP_W<DOEPMSKrs> {
        B2BSTUP_W::new(self, 6)
    }
    ///Bit 8 - OUT packet error mask
    #[inline(always)]
    pub fn opem(&mut self) -> OPEM_W<DOEPMSKrs> {
        OPEM_W::new(self, 8)
    }
    ///Bit 9 - BNA interrupt mask
    #[inline(always)]
    pub fn boim(&mut self) -> BOIM_W<DOEPMSKrs> {
        BOIM_W::new(self, 9)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#OTG1_HS_DEVICE:DOEPMSK)*/
