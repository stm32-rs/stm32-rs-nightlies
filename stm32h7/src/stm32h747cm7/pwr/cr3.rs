...
#[doc = "Reader of field `SDEXTRDY`"]
pub type SDEXTRDY_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SDEXTRDY`"]
...
#[doc = "Reader of field `SDLEVEL`"]
pub type SDLEVEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `SDLEVEL`"]
...
#[doc = "Reader of field `SDEXTHP`"]
pub type SDEXTHP_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SDEXTHP`"]
