...
///Field `GECCDEBWIE` reader - Global ECC double error on byte write interrupt enable
pub type GECCDEBWIE_R = crate::BitReader;
///Field `GECCDEBWIE` writer - Global ECC double error on byte write interrupt enable
...
impl R {
    ...
    ///Bit 3 - Global ECC double error on byte write interrupt enable
    #[inline(always)]
