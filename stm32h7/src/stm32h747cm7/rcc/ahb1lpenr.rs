...
impl W {
    ...
    ///Bit 14 - ART Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn artlpen(&mut self) -> ARTLPEN_W<AHB1LPENRrs> {
    ...
    ///Bit 27 - USB2OTG peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn usb2otglpen(&mut self) -> USB2OTGLPEN_W<AHB1LPENRrs> {
        USB2OTGLPEN_W::new(self, 27)
    }
    ///Bit 28 - USB_PHY2 clocks enable during CSleep mode
    #[inline(always)]
    pub fn usb2ulpilpen(&mut self) -> USB2ULPILPEN_W<AHB1LPENRrs> {
