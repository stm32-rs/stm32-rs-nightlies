...
impl W {
    ...
    ///Bit 4 - DSI Peripheral Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn dsilpen(&mut self) -> DSILPEN_W<'_, APB3LPENRrs> {
        DSILPEN_W::new(self, 4)
    }
    ///Bit 6 - WWDG1 Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn wwdg1lpen(&mut self) -> WWDG1LPEN_W<'_, APB3LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#RCC:APB3LPENR)*/
