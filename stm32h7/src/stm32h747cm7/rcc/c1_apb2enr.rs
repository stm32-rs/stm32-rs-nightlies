...
impl W {
    ///Bit 0 - TIM1 peripheral clock enable
    #[inline(always)]
    pub fn tim1en(&mut self) -> TIM1EN_W<C1_APB2ENRrs> {
        TIM1EN_W::new(self, 0)
    }
    ///Bit 1 - TIM8 peripheral clock enable
    #[inline(always)]
    pub fn tim8en(&mut self) -> TIM8EN_W<C1_APB2ENRrs> {
        TIM8EN_W::new(self, 1)
    }
    ///Bit 4 - USART1 Peripheral Clocks Enable
    #[inline(always)]
    pub fn usart1en(&mut self) -> USART1EN_W<C1_APB2ENRrs> {
        USART1EN_W::new(self, 4)
    }
    ///Bit 5 - USART6 Peripheral Clocks Enable
    #[inline(always)]
    pub fn usart6en(&mut self) -> USART6EN_W<C1_APB2ENRrs> {
        USART6EN_W::new(self, 5)
    }
    ///Bit 12 - SPI1 Peripheral Clocks Enable
    #[inline(always)]
    pub fn spi1en(&mut self) -> SPI1EN_W<C1_APB2ENRrs> {
        SPI1EN_W::new(self, 12)
    }
    ///Bit 13 - SPI4 Peripheral Clocks Enable
    #[inline(always)]
    pub fn spi4en(&mut self) -> SPI4EN_W<C1_APB2ENRrs> {
        SPI4EN_W::new(self, 13)
    }
    ///Bit 16 - TIM15 peripheral clock enable
    #[inline(always)]
    pub fn tim15en(&mut self) -> TIM15EN_W<C1_APB2ENRrs> {
        TIM15EN_W::new(self, 16)
    }
    ///Bit 17 - TIM16 peripheral clock enable
    #[inline(always)]
    pub fn tim16en(&mut self) -> TIM16EN_W<C1_APB2ENRrs> {
        TIM16EN_W::new(self, 17)
    }
    ///Bit 18 - TIM17 peripheral clock enable
    #[inline(always)]
    pub fn tim17en(&mut self) -> TIM17EN_W<C1_APB2ENRrs> {
        TIM17EN_W::new(self, 18)
    }
    ///Bit 20 - SPI5 Peripheral Clocks Enable
    #[inline(always)]
    pub fn spi5en(&mut self) -> SPI5EN_W<C1_APB2ENRrs> {
        SPI5EN_W::new(self, 20)
    }
    ///Bit 22 - SAI1 Peripheral Clocks Enable
    #[inline(always)]
    pub fn sai1en(&mut self) -> SAI1EN_W<C1_APB2ENRrs> {
        SAI1EN_W::new(self, 22)
    }
    ///Bit 23 - SAI2 Peripheral Clocks Enable
    #[inline(always)]
    pub fn sai2en(&mut self) -> SAI2EN_W<C1_APB2ENRrs> {
        SAI2EN_W::new(self, 23)
    }
    ///Bit 24 - SAI3 Peripheral Clocks Enable
    #[inline(always)]
    pub fn sai3en(&mut self) -> SAI3EN_W<C1_APB2ENRrs> {
        SAI3EN_W::new(self, 24)
    }
    ///Bit 28 - DFSDM1 Peripheral Clocks Enable
    #[inline(always)]
    pub fn dfsdm1en(&mut self) -> DFSDM1EN_W<C1_APB2ENRrs> {
        DFSDM1EN_W::new(self, 28)
    }
    ///Bit 29 - HRTIM peripheral clock enable
    #[inline(always)]
    pub fn hrtimen(&mut self) -> HRTIMEN_W<C1_APB2ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#RCC:C1_APB2ENR)*/
