#[doc = "Reader of register C1_APB2LPENR"]
pub type R = crate::R<u32, super::C1_APB2LPENR>;
#[doc = "Writer for register C1_APB2LPENR"]
pub type W = crate::W<u32, super::C1_APB2LPENR>;
#[doc = "Register C1_APB2LPENR `reset()`'s with value 0"]
impl crate::ResetValue for super::C1_APB2LPENR {
    type Type = u32;
    #[inline(always)]
