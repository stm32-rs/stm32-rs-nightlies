#[doc = "Reader of register C1_APB3ENR"]
pub type R = crate::R<u32, super::C1_APB3ENR>;
#[doc = "Writer for register C1_APB3ENR"]
pub type W = crate::W<u32, super::C1_APB3ENR>;
#[doc = "Register C1_APB3ENR `reset()`'s with value 0"]
impl crate::ResetValue for super::C1_APB3ENR {
    type Type = u32;
    #[inline(always)]
...
pub type DSIEN_R = crate::R<bool, LTDCEN_A>;
