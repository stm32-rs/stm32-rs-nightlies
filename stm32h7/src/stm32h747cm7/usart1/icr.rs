...
pub type TCBGTC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn tcbgtc(&mut self) -> TCBGTC_W<ICRrs> {
        TCBGTC_W::new(self, 7)
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#USART1:ICR)*/
pub struct ICRrs;
