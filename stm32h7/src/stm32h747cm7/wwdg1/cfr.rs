...
///Field `W` reader - 7-bit window value These bits contain the window value to be compared to the downcounter.
...
///Field `WDGTB` reader - Timer base The time base of the prescaler can be modified as follows:
...
///Field `WDGTB` writer - Timer base The time base of the prescaler can be modified as follows:
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H747_CM7.html#WWDG1:CFR)*/
pub struct CFRrs;
