...
impl W {
    ///Bit 0 - COMP channel 1 enable bit
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<COMP1_CFGR2rs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - Scaler bridge enable
    #[inline(always)]
    pub fn brgen(&mut self) -> BRGEN_W<COMP1_CFGR2rs> {
        BRGEN_W::new(self, 1)
    }
    ///Bit 2 - Voltage scaler enable bit
    #[inline(always)]
    pub fn scalen(&mut self) -> SCALEN_W<COMP1_CFGR2rs> {
        SCALEN_W::new(self, 2)
    }
    ///Bit 3 - COMP channel 1 polarity selection bit
    #[inline(always)]
    pub fn polarity(&mut self) -> POLARITY_W<COMP1_CFGR2rs> {
        POLARITY_W::new(self, 3)
    }
    ///Bit 4 - Window comparator mode selection bit
    #[inline(always)]
    pub fn winmode(&mut self) -> WINMODE_W<COMP1_CFGR2rs> {
        WINMODE_W::new(self, 4)
    }
    ///Bit 6 - COMP channel 1 interrupt enable
    #[inline(always)]
    pub fn iten(&mut self) -> ITEN_W<COMP1_CFGR2rs> {
        ITEN_W::new(self, 6)
    }
    ///Bits 8:9 - COMP channel 1 hysteresis selection bits
    #[inline(always)]
    pub fn hyst(&mut self) -> HYST_W<COMP1_CFGR2rs> {
        HYST_W::new(self, 8)
    }
    ///Bits 12:13 - Power Mode of the COMP channel 1
    #[inline(always)]
    pub fn pwrmode(&mut self) -> PWRMODE_W<COMP1_CFGR2rs> {
        PWRMODE_W::new(self, 12)
    }
    ///Bits 16:18 - COMP channel 1 inverting input selection field
    #[inline(always)]
    pub fn inmsel(&mut self) -> INMSEL_W<COMP1_CFGR2rs> {
        INMSEL_W::new(self, 16)
    }
    ///Bit 20 - COMP channel 1 non-inverting input selection bit
    #[inline(always)]
    pub fn inpsel(&mut self) -> INPSEL_W<COMP1_CFGR2rs> {
        INPSEL_W::new(self, 20)
    }
    ///Bits 24:27 - COMP channel 1 blanking source selection bits
    #[inline(always)]
    pub fn blanking(&mut self) -> BLANKING_W<COMP1_CFGR2rs> {
        BLANKING_W::new(self, 24)
    }
    ///Bit 31 - Lock bit
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<COMP1_CFGR2rs> {
        LOCK_W::new(self, 31)
    }
}
