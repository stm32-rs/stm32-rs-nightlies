...
impl W {
    ///Bit 0 - b160
    #[inline(always)]
    pub fn b160(&mut self) -> B160_W<'_, K1LRrs> {
        B160_W::new(self, 0)
    }
    ///Bit 1 - b161
    #[inline(always)]
    pub fn b161(&mut self) -> B161_W<'_, K1LRrs> {
        B161_W::new(self, 1)
    }
    ///Bit 2 - b162
    #[inline(always)]
    pub fn b162(&mut self) -> B162_W<'_, K1LRrs> {
        B162_W::new(self, 2)
    }
    ///Bit 3 - b163
    #[inline(always)]
    pub fn b163(&mut self) -> B163_W<'_, K1LRrs> {
        B163_W::new(self, 3)
    }
    ///Bit 4 - b164
    #[inline(always)]
    pub fn b164(&mut self) -> B164_W<'_, K1LRrs> {
        B164_W::new(self, 4)
    }
    ///Bit 5 - b165
    #[inline(always)]
    pub fn b165(&mut self) -> B165_W<'_, K1LRrs> {
        B165_W::new(self, 5)
    }
    ///Bit 6 - b166
    #[inline(always)]
    pub fn b166(&mut self) -> B166_W<'_, K1LRrs> {
        B166_W::new(self, 6)
    }
    ///Bit 7 - b167
    #[inline(always)]
    pub fn b167(&mut self) -> B167_W<'_, K1LRrs> {
        B167_W::new(self, 7)
    }
    ///Bit 8 - b168
    #[inline(always)]
    pub fn b168(&mut self) -> B168_W<'_, K1LRrs> {
        B168_W::new(self, 8)
    }
    ///Bit 9 - b169
    #[inline(always)]
    pub fn b169(&mut self) -> B169_W<'_, K1LRrs> {
        B169_W::new(self, 9)
    }
    ///Bit 10 - b170
    #[inline(always)]
    pub fn b170(&mut self) -> B170_W<'_, K1LRrs> {
        B170_W::new(self, 10)
    }
    ///Bit 11 - b171
    #[inline(always)]
    pub fn b171(&mut self) -> B171_W<'_, K1LRrs> {
        B171_W::new(self, 11)
    }
    ///Bit 12 - b172
    #[inline(always)]
    pub fn b172(&mut self) -> B172_W<'_, K1LRrs> {
        B172_W::new(self, 12)
    }
    ///Bit 13 - b173
    #[inline(always)]
    pub fn b173(&mut self) -> B173_W<'_, K1LRrs> {
        B173_W::new(self, 13)
    }
    ///Bit 14 - b174
    #[inline(always)]
    pub fn b174(&mut self) -> B174_W<'_, K1LRrs> {
        B174_W::new(self, 14)
    }
    ///Bit 15 - b175
    #[inline(always)]
    pub fn b175(&mut self) -> B175_W<'_, K1LRrs> {
        B175_W::new(self, 15)
    }
    ///Bit 16 - b176
    #[inline(always)]
    pub fn b176(&mut self) -> B176_W<'_, K1LRrs> {
        B176_W::new(self, 16)
    }
    ///Bit 17 - b177
    #[inline(always)]
    pub fn b177(&mut self) -> B177_W<'_, K1LRrs> {
        B177_W::new(self, 17)
    }
    ///Bit 18 - b178
    #[inline(always)]
    pub fn b178(&mut self) -> B178_W<'_, K1LRrs> {
        B178_W::new(self, 18)
    }
    ///Bit 19 - b179
    #[inline(always)]
    pub fn b179(&mut self) -> B179_W<'_, K1LRrs> {
        B179_W::new(self, 19)
    }
    ///Bit 20 - b180
    #[inline(always)]
    pub fn b180(&mut self) -> B180_W<'_, K1LRrs> {
        B180_W::new(self, 20)
    }
    ///Bit 21 - b181
    #[inline(always)]
    pub fn b181(&mut self) -> B181_W<'_, K1LRrs> {
        B181_W::new(self, 21)
    }
    ///Bit 22 - b182
    #[inline(always)]
    pub fn b182(&mut self) -> B182_W<'_, K1LRrs> {
        B182_W::new(self, 22)
    }
    ///Bit 23 - b183
    #[inline(always)]
    pub fn b183(&mut self) -> B183_W<'_, K1LRrs> {
        B183_W::new(self, 23)
    }
    ///Bit 24 - b184
    #[inline(always)]
    pub fn b184(&mut self) -> B184_W<'_, K1LRrs> {
        B184_W::new(self, 24)
    }
    ///Bit 25 - b185
    #[inline(always)]
    pub fn b185(&mut self) -> B185_W<'_, K1LRrs> {
        B185_W::new(self, 25)
    }
    ///Bit 26 - b186
    #[inline(always)]
    pub fn b186(&mut self) -> B186_W<'_, K1LRrs> {
        B186_W::new(self, 26)
    }
    ///Bit 27 - b187
    #[inline(always)]
    pub fn b187(&mut self) -> B187_W<'_, K1LRrs> {
        B187_W::new(self, 27)
    }
    ///Bit 28 - b188
    #[inline(always)]
    pub fn b188(&mut self) -> B188_W<'_, K1LRrs> {
        B188_W::new(self, 28)
    }
    ///Bit 29 - b189
    #[inline(always)]
    pub fn b189(&mut self) -> B189_W<'_, K1LRrs> {
        B189_W::new(self, 29)
    }
    ///Bit 30 - b190
    #[inline(always)]
    pub fn b190(&mut self) -> B190_W<'_, K1LRrs> {
        B190_W::new(self, 30)
    }
    ///Bit 31 - b191
    #[inline(always)]
    pub fn b191(&mut self) -> B191_W<'_, K1LRrs> {
        B191_W::new(self, 31)
    }
}
/**key registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#CRYP:K1LR)*/
pub struct K1LRrs;
