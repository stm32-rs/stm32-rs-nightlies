...
impl W {
    ///Bit 0 - b96
    #[inline(always)]
    pub fn b96(&mut self) -> B96_W<'_, K2LRrs> {
        B96_W::new(self, 0)
    }
    ///Bit 1 - b97
    #[inline(always)]
    pub fn b97(&mut self) -> B97_W<'_, K2LRrs> {
        B97_W::new(self, 1)
    }
    ///Bit 2 - b98
    #[inline(always)]
    pub fn b98(&mut self) -> B98_W<'_, K2LRrs> {
        B98_W::new(self, 2)
    }
    ///Bit 3 - b99
    #[inline(always)]
    pub fn b99(&mut self) -> B99_W<'_, K2LRrs> {
        B99_W::new(self, 3)
    }
    ///Bit 4 - b100
    #[inline(always)]
    pub fn b100(&mut self) -> B100_W<'_, K2LRrs> {
        B100_W::new(self, 4)
    }
    ///Bit 5 - b101
    #[inline(always)]
    pub fn b101(&mut self) -> B101_W<'_, K2LRrs> {
        B101_W::new(self, 5)
    }
    ///Bit 6 - b102
    #[inline(always)]
    pub fn b102(&mut self) -> B102_W<'_, K2LRrs> {
        B102_W::new(self, 6)
    }
    ///Bit 7 - b103
    #[inline(always)]
    pub fn b103(&mut self) -> B103_W<'_, K2LRrs> {
        B103_W::new(self, 7)
    }
    ///Bit 8 - b104
    #[inline(always)]
    pub fn b104(&mut self) -> B104_W<'_, K2LRrs> {
        B104_W::new(self, 8)
    }
    ///Bit 9 - b105
    #[inline(always)]
    pub fn b105(&mut self) -> B105_W<'_, K2LRrs> {
        B105_W::new(self, 9)
    }
    ///Bit 10 - b106
    #[inline(always)]
    pub fn b106(&mut self) -> B106_W<'_, K2LRrs> {
        B106_W::new(self, 10)
    }
    ///Bit 11 - b107
    #[inline(always)]
    pub fn b107(&mut self) -> B107_W<'_, K2LRrs> {
        B107_W::new(self, 11)
    }
    ///Bit 12 - b108
    #[inline(always)]
    pub fn b108(&mut self) -> B108_W<'_, K2LRrs> {
        B108_W::new(self, 12)
    }
    ///Bit 13 - b109
    #[inline(always)]
    pub fn b109(&mut self) -> B109_W<'_, K2LRrs> {
        B109_W::new(self, 13)
    }
    ///Bit 14 - b110
    #[inline(always)]
    pub fn b110(&mut self) -> B110_W<'_, K2LRrs> {
        B110_W::new(self, 14)
    }
    ///Bit 15 - b111
    #[inline(always)]
    pub fn b111(&mut self) -> B111_W<'_, K2LRrs> {
        B111_W::new(self, 15)
    }
    ///Bit 16 - b112
    #[inline(always)]
    pub fn b112(&mut self) -> B112_W<'_, K2LRrs> {
        B112_W::new(self, 16)
    }
    ///Bit 17 - b113
    #[inline(always)]
    pub fn b113(&mut self) -> B113_W<'_, K2LRrs> {
        B113_W::new(self, 17)
    }
    ///Bit 18 - b114
    #[inline(always)]
    pub fn b114(&mut self) -> B114_W<'_, K2LRrs> {
        B114_W::new(self, 18)
    }
    ///Bit 19 - b115
    #[inline(always)]
    pub fn b115(&mut self) -> B115_W<'_, K2LRrs> {
        B115_W::new(self, 19)
    }
    ///Bit 20 - b116
    #[inline(always)]
    pub fn b116(&mut self) -> B116_W<'_, K2LRrs> {
        B116_W::new(self, 20)
    }
    ///Bit 21 - b117
    #[inline(always)]
    pub fn b117(&mut self) -> B117_W<'_, K2LRrs> {
        B117_W::new(self, 21)
    }
    ///Bit 22 - b118
    #[inline(always)]
    pub fn b118(&mut self) -> B118_W<'_, K2LRrs> {
        B118_W::new(self, 22)
    }
    ///Bit 23 - b119
    #[inline(always)]
    pub fn b119(&mut self) -> B119_W<'_, K2LRrs> {
        B119_W::new(self, 23)
    }
    ///Bit 24 - b120
    #[inline(always)]
    pub fn b120(&mut self) -> B120_W<'_, K2LRrs> {
        B120_W::new(self, 24)
    }
    ///Bit 25 - b121
    #[inline(always)]
    ...
    ///Bit 26 - b122
    #[inline(always)]
    pub fn b122(&mut self) -> B122_W<'_, K2LRrs> {
        B122_W::new(self, 26)
    }
    ///Bit 27 - b123
    #[inline(always)]
    pub fn b123(&mut self) -> B123_W<'_, K2LRrs> {
        B123_W::new(self, 27)
    }
    ///Bit 28 - b124
    #[inline(always)]
    pub fn b124(&mut self) -> B124_W<'_, K2LRrs> {
        B124_W::new(self, 28)
    }
    ///Bit 29 - b125
    #[inline(always)]
    pub fn b125(&mut self) -> B125_W<'_, K2LRrs> {
        B125_W::new(self, 29)
    }
    ///Bit 30 - b126
    #[inline(always)]
    pub fn b126(&mut self) -> B126_W<'_, K2LRrs> {
        B126_W::new(self, 30)
    }
    ///Bit 31 - b127
    #[inline(always)]
    pub fn b127(&mut self) -> B127_W<'_, K2LRrs> {
        B127_W::new(self, 31)
    }
}
/**key registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#CRYP:K2LR)*/
pub struct K2LRrs;
