...
impl W {
    ///Bit 0 - b32
    #[inline(always)]
    pub fn b32(&mut self) -> B32_W<K3LRrs> {
        B32_W::new(self, 0)
    }
    ///Bit 1 - b33
    #[inline(always)]
    pub fn b33(&mut self) -> B33_W<K3LRrs> {
        B33_W::new(self, 1)
    }
    ///Bit 2 - b34
    #[inline(always)]
    pub fn b34(&mut self) -> B34_W<K3LRrs> {
        B34_W::new(self, 2)
    }
    ///Bit 3 - b35
    #[inline(always)]
    pub fn b35(&mut self) -> B35_W<K3LRrs> {
        B35_W::new(self, 3)
    }
    ///Bit 4 - b36
    #[inline(always)]
    pub fn b36(&mut self) -> B36_W<K3LRrs> {
        B36_W::new(self, 4)
    }
    ///Bit 5 - b37
    #[inline(always)]
    pub fn b37(&mut self) -> B37_W<K3LRrs> {
        B37_W::new(self, 5)
    }
    ///Bit 6 - b38
    #[inline(always)]
    pub fn b38(&mut self) -> B38_W<K3LRrs> {
        B38_W::new(self, 6)
    }
    ///Bit 7 - b39
    #[inline(always)]
    pub fn b39(&mut self) -> B39_W<K3LRrs> {
        B39_W::new(self, 7)
    }
    ///Bit 8 - b40
    #[inline(always)]
    pub fn b40(&mut self) -> B40_W<K3LRrs> {
        B40_W::new(self, 8)
    }
    ///Bit 9 - b41
    #[inline(always)]
    pub fn b41(&mut self) -> B41_W<K3LRrs> {
        B41_W::new(self, 9)
    }
    ///Bit 10 - b42
    #[inline(always)]
    pub fn b42(&mut self) -> B42_W<K3LRrs> {
        B42_W::new(self, 10)
    }
    ///Bit 11 - b43
    #[inline(always)]
    pub fn b43(&mut self) -> B43_W<K3LRrs> {
        B43_W::new(self, 11)
    }
    ///Bit 12 - b44
    #[inline(always)]
    pub fn b44(&mut self) -> B44_W<K3LRrs> {
        B44_W::new(self, 12)
    }
    ///Bit 13 - b45
    #[inline(always)]
    pub fn b45(&mut self) -> B45_W<K3LRrs> {
        B45_W::new(self, 13)
    }
    ///Bit 14 - b46
    #[inline(always)]
    pub fn b46(&mut self) -> B46_W<K3LRrs> {
        B46_W::new(self, 14)
    }
    ///Bit 15 - b47
    #[inline(always)]
    pub fn b47(&mut self) -> B47_W<K3LRrs> {
        B47_W::new(self, 15)
    }
    ///Bit 16 - b48
    #[inline(always)]
    pub fn b48(&mut self) -> B48_W<K3LRrs> {
        B48_W::new(self, 16)
    }
    ///Bit 17 - b49
    #[inline(always)]
    pub fn b49(&mut self) -> B49_W<K3LRrs> {
        B49_W::new(self, 17)
    }
    ///Bit 18 - b50
    #[inline(always)]
    pub fn b50(&mut self) -> B50_W<K3LRrs> {
        B50_W::new(self, 18)
    }
    ///Bit 19 - b51
    #[inline(always)]
    pub fn b51(&mut self) -> B51_W<K3LRrs> {
        B51_W::new(self, 19)
    }
    ///Bit 20 - b52
    #[inline(always)]
    pub fn b52(&mut self) -> B52_W<K3LRrs> {
        B52_W::new(self, 20)
    }
    ///Bit 21 - b53
    #[inline(always)]
    pub fn b53(&mut self) -> B53_W<K3LRrs> {
        B53_W::new(self, 21)
    }
    ///Bit 22 - b54
    #[inline(always)]
    pub fn b54(&mut self) -> B54_W<K3LRrs> {
        B54_W::new(self, 22)
    }
    ///Bit 23 - b55
    #[inline(always)]
    pub fn b55(&mut self) -> B55_W<K3LRrs> {
        B55_W::new(self, 23)
    }
    ///Bit 24 - b56
    #[inline(always)]
    pub fn b56(&mut self) -> B56_W<K3LRrs> {
        B56_W::new(self, 24)
    }
    ///Bit 25 - b57
    #[inline(always)]
    pub fn b57(&mut self) -> B57_W<K3LRrs> {
        B57_W::new(self, 25)
    }
    ///Bit 26 - b58
    #[inline(always)]
    pub fn b58(&mut self) -> B58_W<K3LRrs> {
        B58_W::new(self, 26)
    }
    ///Bit 27 - b59
    #[inline(always)]
    pub fn b59(&mut self) -> B59_W<K3LRrs> {
        B59_W::new(self, 27)
    }
    ///Bit 28 - b60
    #[inline(always)]
    pub fn b60(&mut self) -> B60_W<K3LRrs> {
        B60_W::new(self, 28)
    }
    ///Bit 29 - b61
    #[inline(always)]
    pub fn b61(&mut self) -> B61_W<K3LRrs> {
        B61_W::new(self, 29)
    }
    ///Bit 30 - b62
    #[inline(always)]
    pub fn b62(&mut self) -> B62_W<K3LRrs> {
        B62_W::new(self, 30)
    }
    ///Bit 31 - b63
    #[inline(always)]
    pub fn b63(&mut self) -> B63_W<K3LRrs> {
        B63_W::new(self, 31)
    }
}
/**key registers
