...
///Field `COF(0-7)` writer - Clear trigger overrun event flag Writing 1 in each bit clears the corresponding overrun flag OFx in the DMAMUX_RGSR register.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#DMAMUX1:RGCFR)*/
pub struct RGCFRrs;
