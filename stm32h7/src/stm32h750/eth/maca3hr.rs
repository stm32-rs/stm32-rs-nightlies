...
/**Field `SA` reader - Source Address When this bit is set, the MAC Address1\[47:0\]
...
/**Field `SA` writer - Source Address When this bit is set, the MAC Address1\[47:0\]
is used to compare with the SA fields of the received packet. When this bit is reset, the MAC Address x\[47:0\]
is used to compare with the DA fields of the received packet.*/
...
impl R {
    ...
    /**Bit 30 - Source Address When this bit is set, the MAC Address1\[47:0\]
    is used to compare with the SA fields of the received packet. When this bit is reset, the MAC Address x\[47:0\]
    is used to compare with the DA fields of the received packet.*/
    #[inline(always)]
    pub fn sa(&self) -> SA_R {
