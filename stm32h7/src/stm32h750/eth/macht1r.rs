...
/**Field `HT63T32` reader - MAC Hash Table Second 32 Bits This field contains the second 32 Bits \[63:32\]
of the Hash table.*/
pub type HT63T32_R = crate::FieldReader<u32>;
/**Field `HT63T32` writer - MAC Hash Table Second 32 Bits This field contains the second 32 Bits \[63:32\]
of the Hash table.*/
pub type HT63T32_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    /**Bits 0:31 - MAC Hash Table Second 32 Bits This field contains the second 32 Bits \[63:32\]
    of the Hash table.*/
    #[inline(always)]
