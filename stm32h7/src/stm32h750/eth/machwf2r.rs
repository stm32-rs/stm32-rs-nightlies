...
///Field `PPSOUTNUM` reader - Number of PPS Outputs This field indicates the number of PPS outputs:
pub type PPSOUTNUM_R = crate::FieldReader;
///Field `AUXSNAPNUM` reader - Number of Auxiliary Snapshot Inputs This field indicates the number of auxiliary snapshot inputs:
...
impl R {
    ...
    ///Bits 24:26 - Number of PPS Outputs This field indicates the number of PPS outputs:
    #[inline(always)]
    pub fn ppsoutnum(&self) -> PPSOUTNUM_R {
        PPSOUTNUM_R::new(((self.bits >> 24) & 7) as u8)
    }
    ///Bits 28:30 - Number of Auxiliary Snapshot Inputs This field indicates the number of auxiliary snapshot inputs:
    #[inline(always)]
