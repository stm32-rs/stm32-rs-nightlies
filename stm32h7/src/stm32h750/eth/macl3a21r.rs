...
/**Field `L3A21` reader - Layer 3 Address 2 Field When the L3PEN1 and L3SAM1 bits are set in the (ETH_MACL3L4C1R), this field contains the value to be matched with Bits\[95:64\]
of the IP Source Address field in the IPv6 packets. When the L3PEN1 and L3DAM1 bits are set in the (ETH_MACL3L4C1R), this field contains the value to be matched with Bits\[95:64\]
of the IP Destination Address field in the IPv6 packets. When the L3PEN1 bit is reset in the , this field is not used.*/
pub type L3A21_R = crate::FieldReader<u32>;
/**Field `L3A21` writer - Layer 3 Address 2 Field When the L3PEN1 and L3SAM1 bits are set in the (ETH_MACL3L4C1R), this field contains the value to be matched with Bits\[95:64\]
of the IP Source Address field in the IPv6 packets. When the L3PEN1 and L3DAM1 bits are set in the (ETH_MACL3L4C1R), this field contains the value to be matched with Bits\[95:64\]
of the IP Destination Address field in the IPv6 packets. When the L3PEN1 bit is reset in the , this field is not used.*/
pub type L3A21_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    /**Bits 0:31 - Layer 3 Address 2 Field When the L3PEN1 and L3SAM1 bits are set in the (ETH_MACL3L4C1R), this field contains the value to be matched with Bits\[95:64\]
    of the IP Source Address field in the IPv6 packets. When the L3PEN1 and L3DAM1 bits are set in the (ETH_MACL3L4C1R), this field contains the value to be matched with Bits\[95:64\]
    of the IP Destination Address field in the IPv6 packets. When the L3PEN1 bit is reset in the , this field is not used.*/
    #[inline(always)]
