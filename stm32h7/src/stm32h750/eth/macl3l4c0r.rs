...
/**Field `L3HSBM0` reader - Layer 3 IP SA higher bits match This field contains the number of lower bits of IP source address that are masked for matching in the IPv4 packets. The following list describes the values of this field: 2: Two LSbs \[1:0\]
are masked .. 31: All bits except MSb are masked. Condition: IPv6 packets: This field contains Bits\[4:0\]
...
/**Field `L3HSBM0` writer - Layer 3 IP SA higher bits match This field contains the number of lower bits of IP source address that are masked for matching in the IPv4 packets. The following list describes the values of this field: 2: Two LSbs \[1:0\]
are masked .. 31: All bits except MSb are masked. Condition: IPv6 packets: This field contains Bits\[4:0\]
of L3HSBM0. These bits indicate the number of higher bits of IP source or destination address matched in the IPv6 packets. This field is valid and applicable only when the L3DAM0 or L3SAM0 bit is set high.*/
pub type L3HSBM0_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
/**Field `L3HDBM0` reader - Layer 3 IP DA higher bits match This field contains the number of higher bits of IP Destination Address that are masked in the IPv4 packets: 2: Two LSbs \[1:0\]
...
and L3HSBM0 bits: 2: Two LSbs \[1:0\]
are masked .. 31: All bits except MSb are masked. This field is valid and applicable only when the L3DAM0 or L3SAM0 bit is set.*/
pub type L3HDBM0_R = crate::FieldReader;
/**Field `L3HDBM0` writer - Layer 3 IP DA higher bits match This field contains the number of higher bits of IP Destination Address that are masked in the IPv4 packets: 2: Two LSbs \[1:0\]
are masked .. 31: All bits except MSb are masked. Bits\[12:11\]
of this field correspond to Bits\[6:5\]
of L3HSBM0 which indicate the number of lower bits of IP Source or Destination Address that are masked in the IPv6 packets. Number of bits masked is given by concatenated values of the L3HDBM0\[1:0\]
and L3HSBM0 bits: 2: Two LSbs \[1:0\]
...
impl R {
    ...
    /**Bits 11:15 - Layer 3 IP DA higher bits match This field contains the number of higher bits of IP Destination Address that are masked in the IPv4 packets: 2: Two LSbs \[1:0\]
    are masked .. 31: All bits except MSb are masked. Bits\[12:11\]
    of this field correspond to Bits\[6:5\]
    of L3HSBM0 which indicate the number of lower bits of IP Source or Destination Address that are masked in the IPv6 packets. Number of bits masked is given by concatenated values of the L3HDBM0\[1:0\]
    and L3HSBM0 bits: 2: Two LSbs \[1:0\]
