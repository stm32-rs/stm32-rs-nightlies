...
/**Field `L3HSBM1` reader - Layer 3 IP SA Higher Bits Match This field contains the number of lower bits of IP Source Address that are masked for matching in the IPv4 packets. The following list describes the values of this field: 2: Two LSbs \[1:0\]
are masked .. 31: All bits except MSb are masked. This field contains Bits\[4:0\]
...
/**Field `L3HSBM1` writer - Layer 3 IP SA Higher Bits Match This field contains the number of lower bits of IP Source Address that are masked for matching in the IPv4 packets. The following list describes the values of this field: 2: Two LSbs \[1:0\]
are masked .. 31: All bits except MSb are masked. This field contains Bits\[4:0\]
of L3HSBM1. These bits indicate the number of higher bits of IP Source or Destination Address matched in the IPv6 packets. This field is valid and applicable only when the L3DAM1 or L3SAM1 bit is set high.*/
pub type L3HSBM1_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
/**Field `L3HDBM1` reader - Layer 3 IP DA higher bits match This field contains the number of lower bits of IP Destination Address that are masked for matching in the IPv4 packets. The following list describes the values of this field: 2: Two LSbs \[1:0\]
are masked .. 31: All bits except MSb are masked. Bits\[12:11\]
...
and L3HSBM1 bits: 2: Two LSbs \[1:0\]
are masked .. 127: All bits except MSb are masked This field is valid and applicable only when the L3DAM1 or L3SAM1 bit is set.*/
pub type L3HDBM1_R = crate::FieldReader;
/**Field `L3HDBM1` writer - Layer 3 IP DA higher bits match This field contains the number of lower bits of IP Destination Address that are masked for matching in the IPv4 packets. The following list describes the values of this field: 2: Two LSbs \[1:0\]
are masked .. 31: All bits except MSb are masked. Bits\[12:11\]
of this field correspond to Bits\[6:5\]
of L3HSBM1, which indicate the number of lower bits of IP Source or Destination Address that are masked in the IPv6 packets. The following list describes the concatenated values of the L3HDBM1\[1:0\]
and L3HSBM1 bits: 2: Two LSbs \[1:0\]
...
impl R {
    ...
    /**Bits 6:10 - Layer 3 IP SA Higher Bits Match This field contains the number of lower bits of IP Source Address that are masked for matching in the IPv4 packets. The following list describes the values of this field: 2: Two LSbs \[1:0\]
    are masked .. 31: All bits except MSb are masked. This field contains Bits\[4:0\]
    of L3HSBM1. These bits indicate the number of higher bits of IP Source or Destination Address matched in the IPv6 packets. This field is valid and applicable only when the L3DAM1 or L3SAM1 bit is set high.*/
    #[inline(always)]
    ...
    /**Bits 11:15 - Layer 3 IP DA higher bits match This field contains the number of lower bits of IP Destination Address that are masked for matching in the IPv4 packets. The following list describes the values of this field: 2: Two LSbs \[1:0\]
    are masked .. 31: All bits except MSb are masked. Bits\[12:11\]
    of this field correspond to Bits\[6:5\]
    of L3HSBM1, which indicate the number of lower bits of IP Source or Destination Address that are masked in the IPv6 packets. The following list describes the concatenated values of the L3HDBM1\[1:0\]
    and L3HSBM1 bits: 2: Two LSbs \[1:0\]
