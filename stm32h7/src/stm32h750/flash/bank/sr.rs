...
///Field `BSY` writer - Bank 1 ongoing program flag
...
///Field `OPERR` reader - Bank 1 write/erase error flag
pub type OPERR_R = crate::BitReader;
///Field `OPERR` writer - Bank 1 write/erase error flag
...
///Field `CRCEND` reader - Bank 1 CRC-complete flag
