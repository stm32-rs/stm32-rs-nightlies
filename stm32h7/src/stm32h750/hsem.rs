...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#HSEM:R[0])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#HSEM:RLR[0])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#HSEM:IER)
...
pub mod ier;
/**ICR (r) register accessor: HSEM Interrupt clear register

You can [`read`](crate::Reg::read) this register and get [`icr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#HSEM:ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#HSEM:ISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#HSEM:MISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#HSEM:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#HSEM:KEYR)
