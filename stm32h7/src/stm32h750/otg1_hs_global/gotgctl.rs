...
///Field `VBVALOVAL` reader - VBUS valid override value
pub type VBVALOVAL_R = crate::BitReader;
///Field `VBVALOVAL` writer - VBUS valid override value
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#OTG1_HS_GLOBAL:GOTGCTL)*/
