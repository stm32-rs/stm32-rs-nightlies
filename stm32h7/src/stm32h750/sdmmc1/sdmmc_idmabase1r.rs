///Register `SDMMC_IDMABASE1R` reader
pub type R = crate::R<SDMMC_IDMABASE1Rrs>;
///Register `SDMMC_IDMABASE1R` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SDMMC_IDMABASE1R")
...
You can [`read`](crate::Reg::read) this register and get [`sdmmc_idmabase1r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sdmmc_idmabase1r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#SDMMC1:SDMMC_IDMABASE1R)*/
pub struct SDMMC_IDMABASE1Rrs;
impl crate::RegisterSpec for SDMMC_IDMABASE1Rrs {
    type Ux = u32;
}
///`read()` method returns [`sdmmc_idmabase1r::R`](R) reader structure
impl crate::Readable for SDMMC_IDMABASE1Rrs {}
///`write(|w| ..)` method takes [`sdmmc_idmabase1r::W`](W) writer structure
impl crate::Writable for SDMMC_IDMABASE1Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDMMC_IDMABASE1R to value 0
