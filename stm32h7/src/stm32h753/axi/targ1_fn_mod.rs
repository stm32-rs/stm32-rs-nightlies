#[doc = "Reader of register TARG1_FN_MOD"]
pub type R = crate::R<u32, super::TARG1_FN_MOD>;
#[doc = "Writer for register TARG1_FN_MOD"]
pub type W = crate::W<u32, super::TARG1_FN_MOD>;
#[doc = "Register TARG1_FN_MOD `reset()`'s with value 0x04"]
impl crate::ResetValue for super::TARG1_FN_MOD {
    type Type = u32;
    #[inline(always)]
