...
pub struct ET_R(crate::FieldReader<bool, bool>);
impl ET_R {
    pub(crate) fn new(bits: bool) -> Self {
        ET_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ET_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    #[inline(always)]
    pub fn et(&self) -> ET_R {
        ET_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    #[doc = "Bit 11 - Early Receive Interrupt"]
    #[inline(always)]
    pub fn er(&self) -> ER_R {
        ER_R::new(((self.bits >> 11) & 0x01) != 0)
    }
