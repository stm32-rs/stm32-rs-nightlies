#[doc = "Reader of register MACLMIR"]
pub type R = crate::R<u32, super::MACLMIR>;
#[doc = "Writer for register MACLMIR"]
pub type W = crate::W<u32, super::MACLMIR>;
#[doc = "Register MACLMIR `reset()`'s with value 0"]
impl crate::ResetValue for super::MACLMIR {
    type Type = u32;
    #[inline(always)]
