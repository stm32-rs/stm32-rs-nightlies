#[doc = "Reader of register OPTSR_CUR_"]
pub type R = crate::R<u32, super::OPTSR_CUR_>;
#[doc = "Writer for register OPTSR_CUR_"]
pub type W = crate::W<u32, super::OPTSR_CUR_>;
#[doc = "Register OPTSR_CUR_ `reset()`'s with value 0"]
impl crate::ResetValue for super::OPTSR_CUR_ {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `PERSO_OK`"]
pub type PERSO_OK_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `PERSO_OK`"]
