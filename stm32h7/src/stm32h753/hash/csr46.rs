#[doc = "Reader of register CSR46"]
pub type R = crate::R<u32, super::CSR46>;
#[doc = "Writer for register CSR46"]
pub type W = crate::W<u32, super::CSR46>;
#[doc = "Register CSR46 `reset()`'s with value 0"]
...
#[doc = "Reader of field `CSR46`"]
pub type CSR46_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `CSR46`"]
