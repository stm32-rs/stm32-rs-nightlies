#[doc = "Reader of register CSR53"]
pub type R = crate::R<u32, super::CSR53>;
#[doc = "Writer for register CSR53"]
pub type W = crate::W<u32, super::CSR53>;
#[doc = "Register CSR53 `reset()`'s with value 0"]
...
#[doc = "Reader of field `CSR53`"]
pub type CSR53_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `CSR53`"]
