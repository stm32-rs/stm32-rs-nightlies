#[doc = "Reader of register CMP1CBR"]
pub type R = crate::R<u32, super::CMP1CBR>;
#[doc = "Writer for register CMP1CBR"]
pub type W = crate::W<u32, super::CMP1CBR>;
#[doc = "Register CMP1CBR `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP1CBR {
    type Type = u32;
    #[inline(always)]
