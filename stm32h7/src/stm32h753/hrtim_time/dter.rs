#[doc = "Reader of register DTER"]
pub type R = crate::R<u32, super::DTER>;
#[doc = "Writer for register DTER"]
pub type W = crate::W<u32, super::DTER>;
#[doc = "Register DTER `reset()`'s with value 0"]
impl crate::ResetValue for super::DTER {
    type Type = u32;
    #[inline(always)]
