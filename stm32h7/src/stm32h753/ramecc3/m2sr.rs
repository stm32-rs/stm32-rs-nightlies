#[doc = "Reader of register M2SR"]
pub type R = crate::R<u32, super::M2SR>;
#[doc = "Writer for register M2SR"]
pub type W = crate::W<u32, super::M2SR>;
#[doc = "Register M2SR `reset()`'s with value 0"]
impl crate::ResetValue for super::M2SR {
    type Type = u32;
    #[inline(always)]
