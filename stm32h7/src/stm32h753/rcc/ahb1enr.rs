...
///Field `USB2OTGHSULPIEN` reader - Enable USB_PHY2 clocks
...
///Field `USB2OTGHSULPIEN` writer - Enable USB_PHY2 clocks
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb2otghsulpien(&mut self) -> USB2OTGHSULPIEN_W<AHB1ENRrs> {
        USB2OTGHSULPIEN_W::new(self, 18)
    }
    ///Bit 25 - USB1OTG Peripheral Clocks Enable
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb2ulpien(&mut self) -> USB2ULPIEN_W<AHB1ENRrs> {
