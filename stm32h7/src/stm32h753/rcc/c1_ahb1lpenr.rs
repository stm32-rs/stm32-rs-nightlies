...
pub type USB2OTGLPEN_R = DMA1LPEN_R;
...
impl<'a> USB2OTGLPEN_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(USB2OTGLPEN_A::DISABLED)
    }
    #[doc = "The selected clock is enabled during csleep mode"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(USB2OTGLPEN_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub type USB2ULPILPEN_R = DMA1LPEN_R;
...
impl<'a> USB2ULPILPEN_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(USB2ULPILPEN_A::DISABLED)
    }
    #[doc = "The selected clock is enabled during csleep mode"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(USB2ULPILPEN_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
