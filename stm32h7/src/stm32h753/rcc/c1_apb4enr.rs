#[doc = "Reader of register C1_APB4ENR"]
pub type R = crate::R<u32, super::C1_APB4ENR>;
#[doc = "Writer for register C1_APB4ENR"]
pub type W = crate::W<u32, super::C1_APB4ENR>;
#[doc = "Register C1_APB4ENR `reset()`'s with value 0"]
impl crate::ResetValue for super::C1_APB4ENR {
    type Type = u32;
    #[inline(always)]
