...
///Field `DIVP12` reader - PLL1 DIVP division factor
pub type DIVP12_R = crate::FieldReader;
///Field `DIVP12` writer - PLL1 DIVP division factor
pub type DIVP12_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
impl R {
    ...
    #[inline(always)]
    pub fn divp12(&self) -> DIVP12_R {
        DIVP12_R::new(((self.bits >> 9) & 0x7f) as u8)
    }
...
impl W {
    ...
    ///Bits 9:15 - PLL1 DIVP division factor
    #[inline(always)]
    pub fn divp12(&mut self) -> DIVP12_W<PLL2DIVRrs> {
        DIVP12_W::new(self, 9)
    }
    ///Bits 16:22 - PLL1 DIVQ division factor
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H753.html#RCC:PLL2DIVR)*/
