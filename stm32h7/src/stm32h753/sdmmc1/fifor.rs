#[doc = "Reader of register FIFOR"]
pub type R = crate::R<u32, super::FIFOR>;
#[doc = "Writer for register FIFOR"]
pub type W = crate::W<u32, super::FIFOR>;
#[doc = "Register FIFOR `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR {
    type Type = u32;
    #[inline(always)]
