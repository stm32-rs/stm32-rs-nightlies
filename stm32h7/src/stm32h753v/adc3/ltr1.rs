#[doc = "Reader of register LTR1"]
pub type R = crate::R<u32, super::LTR1>;
#[doc = "Writer for register LTR1"]
pub type W = crate::W<u32, super::LTR1>;
#[doc = "Register LTR1 `reset()`'s with value 0x0fff_0000"]
impl crate::ResetValue for super::LTR1 {
    type Type = u32;
    #[inline(always)]
