...
pub struct CSGCMCCM3_R(crate::FieldReader<u32, u32>);
impl CSGCMCCM3_R {
    pub(crate) fn new(bits: u32) -> Self {
        CSGCMCCM3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CSGCMCCM3_R {
...
pub struct CSGCMCCM3_W<'a> {
    w: &'a mut W,
}
impl<'a> CSGCMCCM3_W<'a> {
...
impl R {
    ...
    pub fn csgcmccm3(&self) -> CSGCMCCM3_R {
        CSGCMCCM3_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - CSGCMCCM3"]
    #[inline(always)]
    pub fn csgcmccm3(&mut self) -> CSGCMCCM3_W {
        CSGCMCCM3_W { w: self }
    }
