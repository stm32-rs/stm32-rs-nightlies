...
pub struct CSGCMCCM7_R(crate::FieldReader<u32, u32>);
impl CSGCMCCM7_R {
    pub(crate) fn new(bits: u32) -> Self {
        CSGCMCCM7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CSGCMCCM7_R {
...
pub struct CSGCMCCM7_W<'a> {
    w: &'a mut W,
}
impl<'a> CSGCMCCM7_W<'a> {
...
impl R {
    ...
    pub fn csgcmccm7(&self) -> CSGCMCCM7_R {
        CSGCMCCM7_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - CSGCMCCM7"]
    #[inline(always)]
    pub fn csgcmccm7(&mut self) -> CSGCMCCM7_W {
        CSGCMCCM7_W { w: self }
    }
