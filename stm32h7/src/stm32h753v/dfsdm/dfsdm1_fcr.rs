#[doc = "Reader of register DFSDM1_FCR"]
pub type R = crate::R<u32, super::DFSDM1_FCR>;
#[doc = "Writer for register DFSDM1_FCR"]
pub type W = crate::W<u32, super::DFSDM1_FCR>;
#[doc = "Register DFSDM1_FCR `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM1_FCR {
    type Type = u32;
    #[inline(always)]
