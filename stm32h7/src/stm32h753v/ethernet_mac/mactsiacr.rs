#[doc = "Reader of register MACTSIACR"]
pub type R = crate::R<u32, super::MACTSIACR>;
#[doc = "Writer for register MACTSIACR"]
pub type W = crate::W<u32, super::MACTSIACR>;
#[doc = "Register MACTSIACR `reset()`'s with value 0"]
impl crate::ResetValue for super::MACTSIACR {
    type Type = u32;
    #[inline(always)]
