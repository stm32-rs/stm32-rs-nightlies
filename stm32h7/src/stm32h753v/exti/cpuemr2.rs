...
impl W {
    ///Bit 0 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr32(&mut self) -> MR32_W<CPUEMR2rs> {
        MR32_W::new(self, 0)
    }
    ///Bit 1 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr33(&mut self) -> MR33_W<CPUEMR2rs> {
        MR33_W::new(self, 1)
    }
    ///Bit 2 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr34(&mut self) -> MR34_W<CPUEMR2rs> {
        MR34_W::new(self, 2)
    }
    ///Bit 3 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr35(&mut self) -> MR35_W<CPUEMR2rs> {
        MR35_W::new(self, 3)
    }
    ///Bit 4 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr36(&mut self) -> MR36_W<CPUEMR2rs> {
        MR36_W::new(self, 4)
    }
    ///Bit 5 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr37(&mut self) -> MR37_W<CPUEMR2rs> {
        MR37_W::new(self, 5)
    }
    ///Bit 6 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr38(&mut self) -> MR38_W<CPUEMR2rs> {
        MR38_W::new(self, 6)
    }
    ///Bit 7 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr39(&mut self) -> MR39_W<CPUEMR2rs> {
        MR39_W::new(self, 7)
    }
    ///Bit 8 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr40(&mut self) -> MR40_W<CPUEMR2rs> {
        MR40_W::new(self, 8)
    }
    ///Bit 9 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr41(&mut self) -> MR41_W<CPUEMR2rs> {
        MR41_W::new(self, 9)
    }
    ///Bit 10 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr42(&mut self) -> MR42_W<CPUEMR2rs> {
        MR42_W::new(self, 10)
    }
    ///Bit 11 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr43(&mut self) -> MR43_W<CPUEMR2rs> {
        MR43_W::new(self, 11)
    }
    ///Bit 12 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr44(&mut self) -> MR44_W<CPUEMR2rs> {
        MR44_W::new(self, 12)
    }
    ///Bit 14 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr46(&mut self) -> MR46_W<CPUEMR2rs> {
        MR46_W::new(self, 14)
    }
    ///Bit 15 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr47(&mut self) -> MR47_W<CPUEMR2rs> {
        MR47_W::new(self, 15)
    }
    ///Bit 16 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr48(&mut self) -> MR48_W<CPUEMR2rs> {
        MR48_W::new(self, 16)
    }
    ///Bit 17 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr49(&mut self) -> MR49_W<CPUEMR2rs> {
        MR49_W::new(self, 17)
    }
    ///Bit 18 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr50(&mut self) -> MR50_W<CPUEMR2rs> {
        MR50_W::new(self, 18)
    }
    ///Bit 19 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr51(&mut self) -> MR51_W<CPUEMR2rs> {
        MR51_W::new(self, 19)
    }
    ///Bit 20 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr52(&mut self) -> MR52_W<CPUEMR2rs> {
        MR52_W::new(self, 20)
    }
    ///Bit 21 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr53(&mut self) -> MR53_W<CPUEMR2rs> {
        MR53_W::new(self, 21)
    }
    ///Bit 22 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr54(&mut self) -> MR54_W<CPUEMR2rs> {
        MR54_W::new(self, 22)
    }
    ///Bit 23 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr55(&mut self) -> MR55_W<CPUEMR2rs> {
        MR55_W::new(self, 23)
    }
    ///Bit 24 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr56(&mut self) -> MR56_W<CPUEMR2rs> {
        MR56_W::new(self, 24)
    }
    ///Bit 25 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr57(&mut self) -> MR57_W<CPUEMR2rs> {
        MR57_W::new(self, 25)
    }
    ///Bit 26 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr58(&mut self) -> MR58_W<CPUEMR2rs> {
        MR58_W::new(self, 26)
    }
    ///Bit 27 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr59(&mut self) -> MR59_W<CPUEMR2rs> {
        MR59_W::new(self, 27)
    }
    ///Bit 28 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr60(&mut self) -> MR60_W<CPUEMR2rs> {
        MR60_W::new(self, 28)
    }
    ///Bit 29 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr61(&mut self) -> MR61_W<CPUEMR2rs> {
        MR61_W::new(self, 29)
    }
    ///Bit 30 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr62(&mut self) -> MR62_W<CPUEMR2rs> {
        MR62_W::new(self, 30)
    }
    ///Bit 31 - CPU Interrupt Mask on Direct Event input x+32
    #[inline(always)]
    pub fn mr63(&mut self) -> MR63_W<CPUEMR2rs> {
        MR63_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H753.html#EXTI:CPUEMR2)*/
