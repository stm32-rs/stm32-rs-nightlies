...
impl W {
    ...
    ///Bit 4 - IWDG1 control option status bit
    #[inline(always)]
    pub fn iwdg1_sw(&mut self) -> IWDG1_SW_W<'_, OPTSR_CURrs> {
    ...
    ///Bit 7 - D1 DStandby entry reset option status bit
    #[inline(always)]
    pub fn nrst_stby_d1(&mut self) -> NRST_STBY_D1_W<'_, OPTSR_CURrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H753V.html#FLASH:OPTSR_CUR)*/
