...
pub use crate::stm32h753v::gpioa::pupdr::PULL;
///Field `PUPDR(0-15)` reader - Port x configuration pin %s
pub use crate::stm32h753v::gpioa::pupdr::PUPDR_R;
///Field `PUPDR(0-15)` writer - Port x configuration pin %s
pub use crate::stm32h753v::gpioa::pupdr::PUPDR_W;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H753V.html#GPIOB:PUPDR)*/
pub struct PUPDRrs;
