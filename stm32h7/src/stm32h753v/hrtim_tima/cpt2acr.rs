///Register `CPT2ACR` reader
pub type R = crate::R<CPT2ACRrs>;
///Register `CPT2ACR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H753.html#HRTIM_TIMA:CPT2ACR)*/
pub struct CPT2ACRrs;
impl crate::RegisterSpec for CPT2ACRrs {
    type Ux = u32;
}
///`read()` method returns [`cpt2acr::R`](R) reader structure
impl crate::Readable for CPT2ACRrs {}
///`write(|w| ..)` method takes [`cpt2acr::W`](W) writer structure
impl crate::Writable for CPT2ACRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CPT2ACR to value 0
