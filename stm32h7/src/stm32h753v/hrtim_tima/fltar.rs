#[doc = "Reader of register FLTAR"]
pub type R = crate::R<u32, super::FLTAR>;
#[doc = "Writer for register FLTAR"]
pub type W = crate::W<u32, super::FLTAR>;
#[doc = "Register FLTAR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLTAR {
    type Type = u32;
    #[inline(always)]
