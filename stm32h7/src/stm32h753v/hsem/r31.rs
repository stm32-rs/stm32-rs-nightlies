#[doc = "Register `R31` reader"]
pub struct R(crate::R<R31_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R31_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R31_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R31_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R31` writer"]
pub struct W(crate::W<R31_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R31_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R31_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R31_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "HSEM register HSEM_R0 HSEM_R31\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [r31](index.html) module"]
pub struct R31_SPEC;
impl crate::RegisterSpec for R31_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [r31::R](R) reader structure"]
impl crate::Readable for R31_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r31::W](W) writer structure"]
impl crate::Writable for R31_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R31 to value 0"]
impl crate::Resettable for R31_SPEC {
    #[inline(always)]
