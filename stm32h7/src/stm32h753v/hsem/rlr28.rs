#[doc = "Register `RLR28` reader"]
pub struct R(crate::R<RLR28_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR28_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR28_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR28_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HSEM Read lock register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rlr28](index.html) module"]
pub struct RLR28_SPEC;
impl crate::RegisterSpec for RLR28_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rlr28::R](R) reader structure"]
impl crate::Readable for RLR28_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RLR28 to value 0"]
impl crate::Resettable for RLR28_SPEC {
    #[inline(always)]
