#[doc = "Reader of register OPAMP1_HSOTR"]
pub type R = crate::R<u32, super::OPAMP1_HSOTR>;
#[doc = "Writer for register OPAMP1_HSOTR"]
pub type W = crate::W<u32, super::OPAMP1_HSOTR>;
#[doc = "Register OPAMP1_HSOTR `reset()`'s with value 0"]
impl crate::ResetValue for super::OPAMP1_HSOTR {
    type Type = u32;
    #[inline(always)]
