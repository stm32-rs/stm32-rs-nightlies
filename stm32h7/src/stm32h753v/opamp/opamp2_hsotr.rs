#[doc = "Reader of register OPAMP2_HSOTR"]
pub type R = crate::R<u32, super::OPAMP2_HSOTR>;
#[doc = "Writer for register OPAMP2_HSOTR"]
pub type W = crate::W<u32, super::OPAMP2_HSOTR>;
#[doc = "Register OPAMP2_HSOTR `reset()`'s with value 0"]
impl crate::ResetValue for super::OPAMP2_HSOTR {
    type Type = u32;
    #[inline(always)]
