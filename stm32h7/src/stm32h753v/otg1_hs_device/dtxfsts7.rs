#[doc = "Reader of register DTXFSTS7"]
pub type R = crate::R<u32, super::DTXFSTS7>;
#[doc = "Writer for register DTXFSTS7"]
pub type W = crate::W<u32, super::DTXFSTS7>;
#[doc = "Register DTXFSTS7 `reset()`'s with value 0"]
impl crate::ResetValue for super::DTXFSTS7 {
    type Type = u32;
    #[inline(always)]
