#[doc = "Reader of register HNPTXFSIZ_Host"]
pub type R = crate::R<u32, super::HNPTXFSIZ_HOST>;
#[doc = "Writer for register HNPTXFSIZ_Host"]
pub type W = crate::W<u32, super::HNPTXFSIZ_HOST>;
#[doc = "Register HNPTXFSIZ_Host `reset()`'s with value 0x0200"]
impl crate::ResetValue for super::HNPTXFSIZ_HOST {
    type Type = u32;
    #[inline(always)]
