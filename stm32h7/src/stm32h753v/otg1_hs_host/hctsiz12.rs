...
pub struct R(crate::R<HCTSIZ12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HCTSIZ12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HCTSIZ12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HCTSIZ12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HCTSIZ12` writer"]
pub struct W(crate::W<HCTSIZ12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HCTSIZ12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HCTSIZ12_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HCTSIZ12_SPEC>) -> Self {
        W(writer)
    }
}
