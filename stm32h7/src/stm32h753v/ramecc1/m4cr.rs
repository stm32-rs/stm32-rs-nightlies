#[doc = "Reader of register M4CR"]
pub type R = crate::R<u32, super::M4CR>;
#[doc = "Writer for register M4CR"]
pub type W = crate::W<u32, super::M4CR>;
#[doc = "Register M4CR `reset()`'s with value 0"]
impl crate::ResetValue for super::M4CR {
    type Type = u32;
    #[inline(always)]
