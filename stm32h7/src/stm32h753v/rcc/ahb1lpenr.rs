...
///Field `USB1OTGHSLPEN` reader - USB1OTG peripheral clock enable during CSleep mode
pub use DMA1LPEN_R as USB1OTGHSLPEN_R;
...
///Field `USB1OTGHSLPEN` writer - USB1OTG peripheral clock enable during CSleep mode
pub use DMA1LPEN_W as USB1OTGHSLPEN_W;
...
impl R {
    ...
    pub fn usb1otghslpen(&self) -> USB1OTGHSLPEN_R {
        USB1OTGHSLPEN_R::new(((self.bits >> 25) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHB1LPENR")
            ...
            .field("usb1otghslpen", &self.usb1otghslpen())
...
impl W {
    ...
    ///Bit 25 - USB1OTG peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn usb1otghslpen(&mut self) -> USB1OTGHSLPEN_W<AHB1LPENRrs> {
        USB1OTGHSLPEN_W::new(self, 25)
    }
    ///Bit 26 - USB_PHY1 clock enable during CSleep mode
    #[inline(always)]
    ...
    ///Bit 27 - USB2OTG peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn usb2otghslpen(&mut self) -> USB2OTGHSLPEN_W<AHB1LPENRrs> {
        USB2OTGHSLPEN_W::new(self, 27)
    }
    ///Bit 28 - USB_PHY2 clocks enable during CSleep mode
    #[inline(always)]
    pub fn usb2otghsulpilpen(&mut self) -> USB2OTGHSULPILPEN_W<AHB1LPENRrs> {
