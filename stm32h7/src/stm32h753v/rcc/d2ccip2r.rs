...
pub struct USART16SEL_R(crate::FieldReader<u8, USART16SEL_A>);
impl USART16SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        USART16SEL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<USART16SEL_A> {
        match self.bits {
            0 => Some(USART16SEL_A::RCC_PCLK2),
            1 => Some(USART16SEL_A::PLL2_Q),
            2 => Some(USART16SEL_A::PLL3_Q),
            3 => Some(USART16SEL_A::HSI_KER),
            4 => Some(USART16SEL_A::CSI_KER),
...
impl core::ops::Deref for USART16SEL_R {
    type Target = crate::FieldReader<u8, USART16SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct I2C123SEL_R(crate::FieldReader<u8, I2C123SEL_A>);
impl I2C123SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        I2C123SEL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for I2C123SEL_R {
    type Target = crate::FieldReader<u8, I2C123SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
