...
impl OC3M_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, OC3M_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(OC3M_A::FROZEN),
            1 => Val(OC3M_A::ACTIVEONMATCH),
            2 => Val(OC3M_A::INACTIVEONMATCH),
            3 => Val(OC3M_A::TOGGLE),
            4 => Val(OC3M_A::FORCEINACTIVE),
            5 => Val(OC3M_A::FORCEACTIVE),
            6 => Val(OC3M_A::PWMMODE1),
            7 => Val(OC3M_A::PWMMODE2),
            8 => Val(OC3M_A::OPMMODE1),
            9 => Val(OC3M_A::OPMMODE2),
            12 => Val(OC3M_A::COMBINEDPWMMODE1),
            13 => Val(OC3M_A::COMBINEDPWMMODE2),
            14 => Val(OC3M_A::ASYMMETRICPWMMODE1),
            15 => Val(OC3M_A::ASYMMETRICPWMMODE2),
            i => Res(i),
        }
    }
...
impl<'a> OC3M_W<'a> {
    ...
    pub fn opm_mode1(self) -> &'a mut W {
        self.variant(OC3M_A::OPMMODE1)
    }
    #[doc = "Inversely to OpmMode1"]
    #[inline(always)]
    pub fn opm_mode2(self) -> &'a mut W {
        self.variant(OC3M_A::OPMMODE2)
    }
    ...
    pub fn combined_pwm_mode1(self) -> &'a mut W {
        self.variant(OC3M_A::COMBINEDPWMMODE1)
    }
    ...
    pub fn combined_pwm_mode2(self) -> &'a mut W {
        self.variant(OC3M_A::COMBINEDPWMMODE2)
    }
    ...
    pub fn asymmetric_pwm_mode1(self) -> &'a mut W {
        self.variant(OC3M_A::ASYMMETRICPWMMODE1)
    }
    ...
    pub fn asymmetric_pwm_mode2(self) -> &'a mut W {
        self.variant(OC3M_A::ASYMMETRICPWMMODE2)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
#[doc = "Reader of field `OC4M_4`"]
pub type OC4M_4_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OC4M_4`"]
pub struct OC4M_4_W<'a> {
    w: &'a mut W,
}
impl<'a> OC4M_4_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn oc4m_4(&self) -> OC4M_4_R {
        OC4M_4_R::new(((self.bits >> 24) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - Capture/Compare 3 selection"]
    ...
    #[doc = "Bit 24 - Output Compare 4 mode - bit 3"]
    #[inline(always)]
    pub fn oc4m_4(&mut self) -> OC4M_4_W {
        OC4M_4_W { w: self }
    }
}
