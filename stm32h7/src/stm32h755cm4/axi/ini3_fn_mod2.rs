...
pub type R = crate::R<INI3_FN_MOD2rs>;
///Register `INI3_FN_MOD2` writer
pub type W = crate::W<INI3_FN_MOD2rs>;
...
impl W {
    ///Bit 0 - Disables alteration of transactions by the up-sizer unless required by the protocol
    #[inline(always)]
    pub fn bypass_merge(&mut self) -> BYPASS_MERGE_W<'_, INI3_FN_MOD2rs> {
        BYPASS_MERGE_W::new(self, 0)
    }
}
/**AXI interconnect - INI x functionality modification 2 register

You can [`read`](crate::Reg::read) this register and get [`ini3_fn_mod2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ini3_fn_mod2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#AXI:INI3_FN_MOD2)*/
pub struct INI3_FN_MOD2rs;
impl crate::RegisterSpec for INI3_FN_MOD2rs {
    type Ux = u32;
}
///`read()` method returns [`ini3_fn_mod2::R`](R) reader structure
impl crate::Readable for INI3_FN_MOD2rs {}
///`write(|w| ..)` method takes [`ini3_fn_mod2::W`](W) writer structure
impl crate::Writable for INI3_FN_MOD2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets INI3_FN_MOD2 to value 0x04
impl crate::Resettable for INI3_FN_MOD2rs {
