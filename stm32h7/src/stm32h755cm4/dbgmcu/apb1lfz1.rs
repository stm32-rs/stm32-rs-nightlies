...
impl W {
    ///Bit 0 - TIM2 stop in debug
    #[inline(always)]
    pub fn dbg_tim2(&mut self) -> DBG_TIM2_W<'_, APB1LFZ1rs> {
        DBG_TIM2_W::new(self, 0)
    }
    ///Bit 1 - TIM3 stop in debug
    #[inline(always)]
    pub fn dbg_tim3(&mut self) -> DBG_TIM3_W<'_, APB1LFZ1rs> {
        DBG_TIM3_W::new(self, 1)
    }
    ///Bit 2 - TIM4 stop in debug
    #[inline(always)]
    pub fn dbg_tim4(&mut self) -> DBG_TIM4_W<'_, APB1LFZ1rs> {
        DBG_TIM4_W::new(self, 2)
    }
    ///Bit 3 - TIM5 stop in debug
    #[inline(always)]
    pub fn dbg_tim5(&mut self) -> DBG_TIM5_W<'_, APB1LFZ1rs> {
        DBG_TIM5_W::new(self, 3)
    }
    ///Bit 4 - TIM6 stop in debug
    #[inline(always)]
    pub fn dbg_tim6(&mut self) -> DBG_TIM6_W<'_, APB1LFZ1rs> {
        DBG_TIM6_W::new(self, 4)
    }
    ///Bit 5 - TIM7 stop in debug
    #[inline(always)]
    pub fn dbg_tim7(&mut self) -> DBG_TIM7_W<'_, APB1LFZ1rs> {
        DBG_TIM7_W::new(self, 5)
    }
    ///Bit 6 - TIM12 stop in debug
    #[inline(always)]
    pub fn dbg_tim12(&mut self) -> DBG_TIM12_W<'_, APB1LFZ1rs> {
        DBG_TIM12_W::new(self, 6)
    }
    ///Bit 7 - TIM13 stop in debug
    #[inline(always)]
    pub fn dbg_tim13(&mut self) -> DBG_TIM13_W<'_, APB1LFZ1rs> {
        DBG_TIM13_W::new(self, 7)
    }
    ///Bit 8 - TIM14 stop in debug
    #[inline(always)]
    pub fn dbg_tim14(&mut self) -> DBG_TIM14_W<'_, APB1LFZ1rs> {
        DBG_TIM14_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1 stop in debug
    #[inline(always)]
    pub fn dbg_lptim1(&mut self) -> DBG_LPTIM1_W<'_, APB1LFZ1rs> {
        DBG_LPTIM1_W::new(self, 9)
    }
    ///Bit 11 - WWDG2 stop in debug
    #[inline(always)]
    pub fn dbg_wwdg2(&mut self) -> DBG_WWDG2_W<'_, APB1LFZ1rs> {
        DBG_WWDG2_W::new(self, 11)
    }
    ///Bit 21 - I2C1 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c1(&mut self) -> DBG_I2C1_W<'_, APB1LFZ1rs> {
        DBG_I2C1_W::new(self, 21)
    }
    ///Bit 22 - I2C2 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c2(&mut self) -> DBG_I2C2_W<'_, APB1LFZ1rs> {
        DBG_I2C2_W::new(self, 22)
    }
    ///Bit 23 - I2C3 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c3(&mut self) -> DBG_I2C3_W<'_, APB1LFZ1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#DBGMCU:APB1LFZ1)*/
