...
impl W {
    ...
    ///Bits 16:27 - Delay line length value
    #[inline(always)]
    pub fn lng(&mut self) -> LNG_W<'_, CFGRrs> {
        LNG_W::new(self, 16)
    }
    ///Bit 31 - Length valid flag
    #[inline(always)]
    pub fn lngf(&mut self) -> LNGF_W<'_, CFGRrs> {
        LNGF_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#DELAY_Block_SDMMC1:CFGR)*/
pub struct CFGRrs;
