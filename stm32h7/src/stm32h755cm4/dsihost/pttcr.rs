...
///Field `TX_TRIG` reader - Transmission trigger
pub type TX_TRIG_R = crate::FieldReader;
///Field `TX_TRIG` writer - Transmission trigger
...
impl W {
    ///Bits 0:3 - Transmission trigger
    #[inline(always)]
    pub fn tx_trig(&mut self) -> TX_TRIG_W<'_, PTTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#DSIHOST:PTTCR)*/
pub struct PTTCRrs;
