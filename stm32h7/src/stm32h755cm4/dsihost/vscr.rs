...
impl W {
    ///Bit 0 - Enable
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, VSCRrs> {
        EN_W::new(self, 0)
    }
    ///Bit 8 - Update register
    #[inline(always)]
    pub fn ur(&mut self) -> UR_W<'_, VSCRrs> {
        UR_W::new(self, 8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#DSIHOST:VSCR)*/
pub struct VSCRrs;
