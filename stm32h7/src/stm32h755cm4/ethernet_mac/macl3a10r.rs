...
///Field `L3A10` reader - Layer 3 Address 1 Field
pub type L3A10_R = crate::FieldReader<u32>;
///Field `L3A10` writer - Layer 3 Address 1 Field
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#Ethernet_MAC:MACL3A10R)*/
