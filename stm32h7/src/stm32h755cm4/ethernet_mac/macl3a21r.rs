...
///Field `L3A21` reader - Layer 3 Address 2 Field
pub type L3A21_R = crate::FieldReader<u32>;
///Field `L3A21` writer - Layer 3 Address 2 Field
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#Ethernet_MAC:MACL3A21R)*/
