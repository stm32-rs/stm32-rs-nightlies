...
impl W {
    ...
    ///Bit 5 - IWDG2 control mode option status bit
    #[inline(always)]
    pub fn iwdg2_sw(&mut self) -> IWDG2_SW_W<'_, OPTSR_CUR_rs> {
    ...
    ///Bit 7 - D1 domain DStandby entry reset option status bit
    #[inline(always)]
    pub fn rst_stdy_d1(&mut self) -> RST_STDY_D1_W<'_, OPTSR_CUR_rs> {
    ...
    ///Bit 22 - Arm Cortex
    #[inline(always)]
    pub fn boot_cm4(&mut self) -> BOOT_CM4_W<'_, OPTSR_CUR_rs> {
        BOOT_CM4_W::new(self, 22)
    }
    ///Bit 23 - Arm Cortex
    #[inline(always)]
    pub fn boot_cm7(&mut self) -> BOOT_CM7_W<'_, OPTSR_CUR_rs> {
        BOOT_CM7_W::new(self, 23)
    }
    ///Bit 24 - D2 domain DStop entry reset option status bit
    #[inline(always)]
    pub fn nrst_stop_d2(&mut self) -> NRST_STOP_D2_W<'_, OPTSR_CUR_rs> {
        NRST_STOP_D2_W::new(self, 24)
    }
    ///Bit 25 - D2 domain DStandby entry reset option status bit
    #[inline(always)]
    pub fn nrst_stby_d2(&mut self) -> NRST_STBY_D2_W<'_, OPTSR_CUR_rs> {
