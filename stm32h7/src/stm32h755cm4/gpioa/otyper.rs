...
impl W {
    ...
    ///Bit 12 - Port x configuration pin 12
    #[inline(always)]
    pub fn ot12(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 12)
    }
    ///Bit 13 - Port x configuration pin 13
    #[inline(always)]
    pub fn ot13(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 13)
    }
    ///Bit 14 - Port x configuration pin 14
    #[inline(always)]
    pub fn ot14(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 14)
    }
    ///Bit 15 - Port x configuration pin 15
    #[inline(always)]
    pub fn ot15(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#GPIOA:OTYPER)*/
pub struct OTYPERrs;
