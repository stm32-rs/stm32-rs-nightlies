...
pub use crate::stm32h755cm4::gpioa::ospeedr::OSPEEDR_R;
///Field `OSPEEDR(0-15)` writer - Port x configuration pin %s
pub use crate::stm32h755cm4::gpioa::ospeedr::OSPEEDR_W;
///Port x configuration pin %s
pub use crate::stm32h755cm4::gpioa::ospeedr::OUTPUT_SPEED;
impl R {
