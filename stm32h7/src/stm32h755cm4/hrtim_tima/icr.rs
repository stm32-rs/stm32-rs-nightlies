...
pub use crate::stm32h755cm4::hrtim_master::icr::CMP1CW;
///Field `CMPC(1-4)` writer - Compare %s Interrupt flag Clear
pub use crate::stm32h755cm4::hrtim_master::icr::CMPC_W;
///Field `REPC` writer - Repetition Interrupt flag Clear
pub use crate::stm32h755cm4::hrtim_master::icr::CMPC_W as REPC_W;
///Field `UPDC` writer - Update Interrupt flag Clear
pub use crate::stm32h755cm4::hrtim_master::icr::CMPC_W as UPDC_W;
///Field `CPTC(1-2)` writer - Capture%s Interrupt flag Clear
pub use crate::stm32h755cm4::hrtim_master::icr::CMPC_W as CPTC_W;
///Field `SETC(1-2)` writer - Output %s Set flag Clear
pub use crate::stm32h755cm4::hrtim_master::icr::CMPC_W as SETC_W;
///Field `RST1C` writer - Output 1 Reset flag Clear
pub use crate::stm32h755cm4::hrtim_master::icr::CMPC_W as RST1C_W;
///Field `RST2C` writer - Output 2 Reset flag Clear
pub use crate::stm32h755cm4::hrtim_master::icr::CMPC_W as RST2C_W;
///Field `RSTC` writer - Reset Interrupt flag Clear
pub use crate::stm32h755cm4::hrtim_master::icr::CMPC_W as RSTC_W;
///Field `DLYPRTC` writer - Delayed Protection Flag Clear
pub use crate::stm32h755cm4::hrtim_master::icr::CMPC_W as DLYPRTC_W;
