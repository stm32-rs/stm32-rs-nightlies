...
///Continuous mode
pub use crate::stm32h755cm4::hrtim_master::cr::CONT;
///Field `CONT` reader - Continuous mode
pub use crate::stm32h755cm4::hrtim_master::cr::CONT_R;
///Field `CONT` writer - Continuous mode
pub use crate::stm32h755cm4::hrtim_master::cr::CONT_W;
///Half mode enable
pub use crate::stm32h755cm4::hrtim_master::cr::HALF;
///Field `HALF` reader - Half mode enable
pub use crate::stm32h755cm4::hrtim_master::cr::HALF_R;
///Field `HALF` writer - Half mode enable
pub use crate::stm32h755cm4::hrtim_master::cr::HALF_W;
///Re-triggerable mode
pub use crate::stm32h755cm4::hrtim_master::cr::RETRIG;
///Field `RETRIG` reader - Re-triggerable mode
pub use crate::stm32h755cm4::hrtim_master::cr::RETRIG_R;
///Field `RETRIG` writer - Re-triggerable mode
pub use crate::stm32h755cm4::hrtim_master::cr::RETRIG_W;
///Synchronization Resets Timer x
pub use crate::stm32h755cm4::hrtim_master::cr::SYNCRST;
///Field `SYNCRST` reader - Synchronization Resets Timer x
pub use crate::stm32h755cm4::hrtim_master::cr::SYNCRST_R;
///Field `SYNCRST` writer - Synchronization Resets Timer x
pub use crate::stm32h755cm4::hrtim_master::cr::SYNCRST_W;
///Synchronization Starts Timer x
pub use crate::stm32h755cm4::hrtim_master::cr::SYNCSTRT;
///Field `SYNCSTRT` reader - Synchronization Starts Timer x
pub use crate::stm32h755cm4::hrtim_master::cr::SYNCSTRT_R;
///Field `SYNCSTRT` writer - Synchronization Starts Timer x
pub use crate::stm32h755cm4::hrtim_master::cr::SYNCSTRT_W;
///Delayed CMP2 mode
pub use crate::stm32h755cm4::hrtim_tima::cr::DELCMP2;
///Field `DELCMP2` reader - Delayed CMP2 mode
pub use crate::stm32h755cm4::hrtim_tima::cr::DELCMP2_R;
///Field `DELCMP2` writer - Delayed CMP2 mode
pub use crate::stm32h755cm4::hrtim_tima::cr::DELCMP2_W;
///Delayed CMP4 mode
pub use crate::stm32h755cm4::hrtim_tima::cr::DELCMP4;
///Field `DELCMP4` reader - Delayed CMP4 mode
pub use crate::stm32h755cm4::hrtim_tima::cr::DELCMP4_R;
///Field `DELCMP4` writer - Delayed CMP4 mode
pub use crate::stm32h755cm4::hrtim_tima::cr::DELCMP4_W;
///Push-Pull mode enable
pub use crate::stm32h755cm4::hrtim_tima::cr::PSHPLL;
///Field `PSHPLL` reader - Push-Pull mode enable
pub use crate::stm32h755cm4::hrtim_tima::cr::PSHPLL_R;
///Field `PSHPLL` writer - Push-Pull mode enable
pub use crate::stm32h755cm4::hrtim_tima::cr::PSHPLL_W;
///Timer x Repetition update
pub use crate::stm32h755cm4::hrtim_tima::cr::TREPU;
///Field `TREPU` reader - Timer x Repetition update
pub use crate::stm32h755cm4::hrtim_tima::cr::TREPU_R;
///Field `TREPU` writer - Timer x Repetition update
pub use crate::stm32h755cm4::hrtim_tima::cr::TREPU_W;
///Timerx reset update
pub use crate::stm32h755cm4::hrtim_tima::cr::TRSTU;
///Field `TRSTU` reader - Timerx reset update
pub use crate::stm32h755cm4::hrtim_tima::cr::TRSTU_R;
///Field `TRSTU` writer - Timerx reset update
pub use crate::stm32h755cm4::hrtim_tima::cr::TRSTU_W;
/**TBU
...
///AC Synchronization
pub use crate::stm32h755cm4::hrtim_master::cr::DACSYNC;
///Field `DACSYNC` reader - AC Synchronization
pub use crate::stm32h755cm4::hrtim_master::cr::DACSYNC_R;
///Field `DACSYNC` writer - AC Synchronization
pub use crate::stm32h755cm4::hrtim_master::cr::DACSYNC_W;
///Preload enable
pub use crate::stm32h755cm4::hrtim_master::cr::PREEN;
///Field `PREEN` reader - Preload enable
pub use crate::stm32h755cm4::hrtim_master::cr::PREEN_R;
///Field `PREEN` writer - Preload enable
pub use crate::stm32h755cm4::hrtim_master::cr::PREEN_W;
///Master Timer update
pub use crate::stm32h755cm4::hrtim_tima::cr::MSTU;
///Field `MSTU` reader - Master Timer update
pub use crate::stm32h755cm4::hrtim_tima::cr::MSTU_R;
///Field `MSTU` writer - Master Timer update
pub use crate::stm32h755cm4::hrtim_tima::cr::MSTU_W;
///Update Gating
pub use crate::stm32h755cm4::hrtim_tima::cr::UPDGAT;
///Field `UPDGAT` reader - Update Gating
pub use crate::stm32h755cm4::hrtim_tima::cr::UPDGAT_R;
///Field `UPDGAT` writer - Update Gating
pub use crate::stm32h755cm4::hrtim_tima::cr::UPDGAT_W;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#HRTIM_TIMC:CR)*/
pub struct CRrs;
