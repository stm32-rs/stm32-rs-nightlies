...
impl W {
    ...
    ///Bit 2 - SD converter Enable
    #[inline(always)]
    pub fn sden(&mut self) -> SDEN_W<'_, CR3rs> {
        SDEN_W::new(self, 2)
    }
    ///Bit 3 - SMPS step-down converter forced ON and in High Power MR mode
    #[inline(always)]
    pub fn sdexthp(&mut self) -> SDEXTHP_W<'_, CR3rs> {
        SDEXTHP_W::new(self, 3)
    }
    ///Bits 4:5 - SMPS step-down converter voltage output level selection
    #[inline(always)]
    pub fn sdlevel(&mut self) -> SDLEVEL_W<'_, CR3rs> {
    ...
    ///Bit 16 - SMPS step-down converter external supply ready
    #[inline(always)]
    pub fn sdextrdy(&mut self) -> SDEXTRDY_W<'_, CR3rs> {
