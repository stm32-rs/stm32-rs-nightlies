...
impl W {
    ///Bit 3 - LTDC peripheral clock enable
    #[inline(always)]
    pub fn ltdcen(&mut self) -> LTDCEN_W<'_, C1_APB3ENRrs> {
        LTDCEN_W::new(self, 3)
    }
    ///Bit 4 - DSI Peripheral clocks enable
    #[inline(always)]
    pub fn dsien(&mut self) -> DSIEN_W<'_, C1_APB3ENRrs> {
        DSIEN_W::new(self, 4)
    }
    ///Bit 6 - WWDG1 Clock Enable
    #[inline(always)]
    pub fn wwdg1en(&mut self) -> WWDG1EN_W<'_, C1_APB3ENRrs> {
