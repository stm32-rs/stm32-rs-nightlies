...
///Field `DIVN1` reader - Multiplication factor for PLL1 VCO
pub type DIVN1_R = crate::FieldReader<u16>;
///Field `DIVN1` writer - Multiplication factor for PLL1 VCO
...
///Field `DIVP1` reader - PLL1 DIVP division factor
...
///Field `DIVP1` writer - PLL1 DIVP division factor
...
///Field `DIVQ1` reader - PLL1 DIVQ division factor
pub type DIVQ1_R = crate::FieldReader;
///Field `DIVQ1` writer - PLL1 DIVQ division factor
pub type DIVQ1_W<'a, REG> = crate::FieldWriter<'a, REG, 7, u8, crate::Safe>;
///Field `DIVR1` reader - PLL1 DIVR division factor
pub type DIVR1_R = crate::FieldReader;
///Field `DIVR1` writer - PLL1 DIVR division factor
...
impl W {
    ///Bits 0:8 - Multiplication factor for PLL1 VCO
    #[inline(always)]
    pub fn divn1(&mut self) -> DIVN1_W<'_, PLL1DIVRrs> {
        DIVN1_W::new(self, 0)
    }
    ///Bits 9:15 - PLL1 DIVP division factor
    #[inline(always)]
    pub fn divp1(&mut self) -> DIVP1_W<'_, PLL1DIVRrs> {
        DIVP1_W::new(self, 9)
    }
    ///Bits 16:22 - PLL1 DIVQ division factor
    #[inline(always)]
    pub fn divq1(&mut self) -> DIVQ1_W<'_, PLL1DIVRrs> {
        DIVQ1_W::new(self, 16)
    }
    ///Bits 24:30 - PLL1 DIVR division factor
    #[inline(always)]
    pub fn divr1(&mut self) -> DIVR1_W<'_, PLL1DIVRrs> {
        DIVR1_W::new(self, 24)
    }
}
