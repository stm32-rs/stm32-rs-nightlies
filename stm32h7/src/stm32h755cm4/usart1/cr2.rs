...
///Field `DIS_NSS` writer - When the DSI_NSS bit is set, the NSS pin input is ignored
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM4.html#USART1:CR2)*/
pub struct CR2rs;
