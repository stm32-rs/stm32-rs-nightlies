...
///Field `AWD3CH(0-19)` reader - ADC analog watchdog 3 monitored channel selection
...
///Field `AWD3CH(0-19)` writer - ADC analog watchdog 3 monitored channel selection
...
impl R {
    ...
    pub fn awd3ch(&self, n: u8) -> AWD3CH_R {
        ...
        [(); 20][n as usize];
        AWD3CH_R::new(((self.bits >> (n + 1)) & 1) != 0)
    }
    ///Iterator for array of:
    ///ADC analog watchdog 3 monitored channel selection
    #[inline(always)]
    pub fn awd3ch_iter(&self) -> impl Iterator<Item = AWD3CH_R> + '_ {
        (0..20).map(move |n| AWD3CH_R::new(((self.bits >> (n + 1)) & 1) != 0))
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM7.html#ADC3:AWD3CR)*/
pub struct AWD3CRrs;
