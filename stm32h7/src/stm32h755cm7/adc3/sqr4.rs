...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SQ15` field.</div>
    #[inline(always)]
    pub fn sq(&mut self, n: u8) -> SQ_W<'_, SQR4rs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        SQ_W::new(self, n * 6)
    }
    ///Bits 0:4 - 15 conversion in regular sequence
    #[inline(always)]
    pub fn sq15(&mut self) -> SQ_W<'_, SQR4rs> {
        SQ_W::new(self, 0)
    }
    ///Bits 6:10 - 16 conversion in regular sequence
    #[inline(always)]
    pub fn sq16(&mut self) -> SQ_W<'_, SQR4rs> {
        SQ_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM7.html#ADC3:SQR4)*/
pub struct SQR4rs;
