...
///Field `GIF(1-8)` reader - Channel %s Global interrupt flag
...
///Field `TCIF(1-8)` reader - Channel %s Transfer Complete flag
...
///Field `HTIF(1-8)` reader - Channel %s Half Transfer Complete flag
...
///Field `TEIF(1-8)` reader - Channel %s Transfer Error flag
...
impl R {
    ///Channel (1-8) Global interrupt flag
    ///
    ...
    ///Channel (1-8) Transfer Complete flag
    ///
    ...
    ///Channel (1-8) Half Transfer Complete flag
    ///
    ...
    ///Channel (1-8) Transfer Error flag
    ///
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM7.html#BDMA:ISR)*/
pub struct ISRrs;
