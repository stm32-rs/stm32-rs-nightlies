...
impl W {
    ///Bit 0 - TIM1 stop in debug
    #[inline(always)]
    pub fn dbg_tim1(&mut self) -> DBG_TIM1_W<APB2FZ2rs> {
        DBG_TIM1_W::new(self, 0)
    }
    ///Bit 1 - TIM8 stop in debug
    #[inline(always)]
    pub fn dbg_tim8(&mut self) -> DBG_TIM8_W<APB2FZ2rs> {
        DBG_TIM8_W::new(self, 1)
    }
    ///Bit 16 - TIM15 stop in debug
    #[inline(always)]
    pub fn dbg_tim15(&mut self) -> DBG_TIM15_W<APB2FZ2rs> {
        DBG_TIM15_W::new(self, 16)
    }
    ///Bit 17 - TIM16 stop in debug
    #[inline(always)]
    pub fn dbg_tim16(&mut self) -> DBG_TIM16_W<APB2FZ2rs> {
        DBG_TIM16_W::new(self, 17)
    }
    ///Bit 18 - TIM17 stop in debug
    #[inline(always)]
    pub fn dbg_tim17(&mut self) -> DBG_TIM17_W<APB2FZ2rs> {
        DBG_TIM17_W::new(self, 18)
    }
    ///Bit 29 - HRTIM stop in debug
    #[inline(always)]
    pub fn dbg_hrtim(&mut self) -> DBG_HRTIM_W<APB2FZ2rs> {
