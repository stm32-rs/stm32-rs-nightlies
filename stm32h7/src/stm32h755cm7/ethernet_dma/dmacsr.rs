...
impl W {
    ...
    ///Bits 16:18 - Tx DMA Error Bits
    #[inline(always)]
    pub fn teb(&mut self) -> TEB_W<'_, DMACSRrs> {
        TEB_W::new(self, 16)
    }
    ///Bits 19:21 - Rx DMA Error Bits
    #[inline(always)]
    pub fn reb(&mut self) -> REB_W<'_, DMACSRrs> {
        REB_W::new(self, 19)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM7.html#Ethernet_DMA:DMACSR)*/
pub struct DMACSRrs;
