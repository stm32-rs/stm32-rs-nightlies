...
impl W {
    ///Bit 17 - CPU2 configurable event inputs x+32 Pending bit
    #[inline(always)]
    pub fn pr49(&mut self) -> PR49_W<'_, C2PR2rs> {
        PR49_W::new(self, 17)
    }
    ///Bit 19 - CPU2 configurable event inputs x+32 Pending bit
    #[inline(always)]
    pub fn pr51(&mut self) -> PR51_W<'_, C2PR2rs> {
        PR51_W::new(self, 19)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM7.html#EXTI:C2PR2)*/
pub struct C2PR2rs;
