...
impl W {
    ///Bits 0:15 - Arm Cortex-M7 boot address 0
    #[inline(always)]
    pub fn boot_cm7_add0(&mut self) -> BOOT_CM7_ADD0_W<'_, BOOT7_CURRrs> {
        BOOT_CM7_ADD0_W::new(self, 0)
    }
    ///Bits 16:31 - Arm Cortex-M7 boot address 1
    #[inline(always)]
    pub fn boot_cm7_add1(&mut self) -> BOOT_CM7_ADD1_W<'_, BOOT7_CURRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM7.html#FLASH:BOOT7_CURR)*/
