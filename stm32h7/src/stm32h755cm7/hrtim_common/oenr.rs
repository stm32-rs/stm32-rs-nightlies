...
///Field `T1OEN(A,B,C,D,E)` reader - Timer %s Output 1 Enable
...
///Field `T1OEN(A,B,C,D,E)` writer - Timer %s Output 1 Enable
...
///Field `T2OEN(A,B,C,D,E)` reader - Timer %s Output 2 Enable
pub use T1OEN_R as T2OEN_R;
///Field `T2OEN(A,B,C,D,E)` writer - Timer %s Output 2 Enable
pub use T1OEN_W as T2OEN_W;
impl R {
    ///Timer (A,B,C,D,E) Output 1 Enable
    ///
    ...
    ///Timer (A,B,C,D,E) Output 2 Enable
    ///
