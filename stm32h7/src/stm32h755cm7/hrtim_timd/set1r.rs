...
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_R as TIMACMP1_R;
...
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_R as TIMBCMP2_R;
...
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_R as TIMCCMP3_R;
///Field `TIMCCMP4` reader - Timer C Compare 4
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_R as TIMCCMP4_R;
///Field `TIMECMP1` reader - Timer E Compare 1
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_R as TIMECMP1_R;
///Field `TIMECMP2` reader - Timer E Compare 2
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_R as TIMECMP2_R;
///Field `TIMACMP1` writer - Timer A Compare 1
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_W as TIMACMP1_W;
...
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_W as TIMBCMP2_W;
...
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_W as TIMCCMP3_W;
///Field `TIMCCMP4` writer - Timer C Compare 4
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_W as TIMCCMP4_W;
///Field `TIMECMP1` writer - Timer E Compare 1
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_W as TIMECMP1_W;
///Field `TIMECMP2` writer - Timer E Compare 2
pub use crate::stm32h755cm7::hrtim_tima::set1r::TIMBCMP1_W as TIMECMP2_W;
...
impl W {
    ...
    ///Bit 12 - Timer A Compare 1
    #[inline(always)]
    pub fn timacmp1(&mut self) -> TIMACMP1_W<SET1Rrs> {
    ...
    ///Bit 18 - Timer C Compare 4
    #[inline(always)]
    pub fn timccmp4(&mut self) -> TIMCCMP4_W<SET1Rrs> {
        TIMCCMP4_W::new(self, 18)
    }
    ///Bit 19 - Timer E Compare 1
    #[inline(always)]
    pub fn timecmp1(&mut self) -> TIMECMP1_W<SET1Rrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H755_CM7.html#HRTIM_TIMD:SET1R)*/
pub struct SET1Rrs;
