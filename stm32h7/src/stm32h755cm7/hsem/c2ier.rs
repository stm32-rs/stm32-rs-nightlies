...
///Field `ISE` reader - Interrupt semaphore x enable bit
pub type ISE_R = crate::FieldReader<u32>;
///Field `ISE` writer - Interrupt semaphore x enable bit
pub type ISE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Interrupt semaphore x enable bit
    #[inline(always)]
...
impl W {
    ///Bits 0:31 - Interrupt semaphore x enable bit
    #[inline(always)]
    pub fn ise(&mut self) -> ISE_W<C2IERrs> {
        ISE_W::new(self, 0)
    }
}
