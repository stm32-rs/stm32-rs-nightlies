    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn set_inactive(self) -> &'a mut crate::W<REG> {
        self.variant(TIMACMP3::SetInactive)
    }
}
///Field `TIMACMP4` reader - Timer A Compare 4
pub use TIMACMP3_R as TIMACMP4_R;
///Field `TIMBCMP3` reader - Timer B Compare 3
pub use TIMACMP3_R as TIMBCMP3_R;
...
pub use TIMACMP3_W as TIMCCMP2_W;
///Field `TIMDCMP1` writer - Timer D Compare 1
pub use TIMACMP3_W as TIMDCMP1_W;
///Field `TIMDCMP2` writer - Timer D Compare 2
pub use TIMACMP3_W as TIMDCMP2_W;
