...
impl W {
    ...
    ///Bit 21 - Incomplete periodic transfer mask
    #[inline(always)]
    pub fn pxfrm_iisooxfrm(&mut self) -> PXFRM_IISOOXFRM_W<GINTMSKrs> {
    ...
    ///Bit 23 - Reset detected interrupt mask
    #[inline(always)]
    pub fn rstde(&mut self) -> RSTDE_W<GINTMSKrs> {
        RSTDE_W::new(self, 23)
    }
    ///Bit 25 - Host channels interrupt mask
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#OTG1_HS_GLOBAL:GINTMSK)*/
