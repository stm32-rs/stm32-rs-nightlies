...
impl W {
    ...
    ///Bit 5 - HSI divider flag
    #[inline(always)]
    pub fn hsidivf(&mut self) -> HSIDIVF_W<'_, CRrs> {
    ...
    ///Bit 8 - CSI clock ready flag
    #[inline(always)]
    pub fn csirdy(&mut self) -> CSIRDY_W<'_, CRrs> {
        CSIRDY_W::new(self, 8)
    }
    ///Bit 9 - CSI clock enable in Stop mode
    #[inline(always)]
    ...
    ///Bit 13 - RC48 clock ready flag
    #[inline(always)]
    pub fn hsi48rdy(&mut self) -> HSI48RDY_W<'_, CRrs> {
        HSI48RDY_W::new(self, 13)
    }
    ///Bit 14 - D1 domain clocks ready flag
    #[inline(always)]
    pub fn d1ckrdy(&mut self) -> D1CKRDY_W<'_, CRrs> {
        D1CKRDY_W::new(self, 14)
    }
    ///Bit 15 - D2 domain clocks ready flag
    #[inline(always)]
    pub fn d2ckrdy(&mut self) -> D2CKRDY_W<'_, CRrs> {
    ...
    ///Bit 25 - PLL1 clock ready flag
    #[inline(always)]
    pub fn pll1rdy(&mut self) -> PLL1RDY_W<'_, CRrs> {
    ...
    ///Bit 27 - PLL2 clock ready flag
    #[inline(always)]
    pub fn pll2rdy(&mut self) -> PLL2RDY_W<'_, CRrs> {
    ...
    ///Bit 29 - PLL3 clock ready flag
    #[inline(always)]
    pub fn pll3rdy(&mut self) -> PLL3RDY_W<'_, CRrs> {
