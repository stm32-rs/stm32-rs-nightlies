...
impl OCCE_R {
    ...
    ///OCxRef is cleared as soon as a High level is detected on ETRF signal
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == OC1CE::Enabled
    }
...
impl W {
    ...
    ///Bit 24 - Output compare 2 mode, bit 3
    #[inline(always)]
    pub fn oc2m_3(&mut self) -> OCM_3_W<'_, CCMR1_OUTPUTrs> {
        OCM_3_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#TIM1:CCMR1_Output)*/
