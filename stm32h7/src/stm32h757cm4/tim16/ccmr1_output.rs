...
///Field `OCM_3(1-1)` reader - Output compare %s mode, bit 3
pub type OCM_3_R = crate::BitReader;
///Field `OCM_3(1-1)` writer - Output compare %s mode, bit 3
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `OC1M_3` field.</div>
    #[inline(always)]
    pub fn ocm_3(&mut self, n: u8) -> OCM_3_W<'_, CCMR1_OUTPUTrs> {
        #[allow(clippy::no_effect)]
        [(); 1][n as usize];
    ...
    ///Bit 16 - Output compare 1 mode, bit 3
    #[inline(always)]
    pub fn oc1m_3(&mut self) -> OCM_3_W<'_, CCMR1_OUTPUTrs> {
        OCM_3_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM4.html#TIM16:CCMR1_Output)*/
