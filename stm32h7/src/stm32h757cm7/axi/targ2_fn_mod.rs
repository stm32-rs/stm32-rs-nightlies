///Register `TARG2_FN_MOD` reader
pub type R = crate::R<TARG2_FN_MODrs>;
///Register `TARG2_FN_MOD` writer
pub type W = crate::W<TARG2_FN_MODrs>;
...
impl W {
    ///Bit 0 - Override AMIB read issuing capability
    #[inline(always)]
    pub fn read_iss_override(&mut self) -> READ_ISS_OVERRIDE_W<'_, TARG2_FN_MODrs> {
        READ_ISS_OVERRIDE_W::new(self, 0)
    }
    ///Bit 1 - Override AMIB write issuing capability
    #[inline(always)]
    pub fn write_iss_override(&mut self) -> WRITE_ISS_OVERRIDE_W<'_, TARG2_FN_MODrs> {
        WRITE_ISS_OVERRIDE_W::new(self, 1)
    }
}
/**AXI interconnect - TARG x long burst functionality modification

You can [`read`](crate::Reg::read) this register and get [`targ2_fn_mod::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`targ2_fn_mod::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#AXI:TARG2_FN_MOD)*/
pub struct TARG2_FN_MODrs;
impl crate::RegisterSpec for TARG2_FN_MODrs {
    type Ux = u32;
}
///`read()` method returns [`targ2_fn_mod::R`](R) reader structure
impl crate::Readable for TARG2_FN_MODrs {}
///`write(|w| ..)` method takes [`targ2_fn_mod::W`](W) writer structure
impl crate::Writable for TARG2_FN_MODrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TARG2_FN_MOD to value 0x04
impl crate::Resettable for TARG2_FN_MODrs {
