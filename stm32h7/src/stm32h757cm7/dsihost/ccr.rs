...
///Field `TXECKDIV` reader - TX escape clock division
pub type TXECKDIV_R = crate::FieldReader;
///Field `TXECKDIV` writer - TX escape clock division
pub type TXECKDIV_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `TOCKDIV` reader - Timeout clock division
pub type TOCKDIV_R = crate::FieldReader;
///Field `TOCKDIV` writer - Timeout clock division
...
impl W {
    ///Bits 0:7 - TX escape clock division
    #[inline(always)]
    pub fn txeckdiv(&mut self) -> TXECKDIV_W<'_, CCRrs> {
        TXECKDIV_W::new(self, 0)
    }
    ///Bits 8:15 - Timeout clock division
    #[inline(always)]
    pub fn tockdiv(&mut self) -> TOCKDIV_W<'_, CCRrs> {
