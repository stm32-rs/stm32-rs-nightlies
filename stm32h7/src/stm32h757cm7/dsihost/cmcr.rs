...
impl W {
    ///Bit 0 - Tearing effect acknowledge request enable
    #[inline(always)]
    pub fn teare(&mut self) -> TEARE_W<'_, CMCRrs> {
        TEARE_W::new(self, 0)
    }
    ///Bit 1 - Acknowledge request enable
    #[inline(always)]
    pub fn are(&mut self) -> ARE_W<'_, CMCRrs> {
        ARE_W::new(self, 1)
    }
    ///Bit 8 - Generic short write zero parameters transmission
    #[inline(always)]
    pub fn gsw0tx(&mut self) -> GSW0TX_W<'_, CMCRrs> {
        GSW0TX_W::new(self, 8)
    }
    ///Bit 9 - Generic short write one parameters transmission
    #[inline(always)]
    pub fn gsw1tx(&mut self) -> GSW1TX_W<'_, CMCRrs> {
        GSW1TX_W::new(self, 9)
    }
    ///Bit 10 - Generic short write two parameters transmission
    #[inline(always)]
    pub fn gsw2tx(&mut self) -> GSW2TX_W<'_, CMCRrs> {
        GSW2TX_W::new(self, 10)
    }
    ///Bit 11 - Generic short read zero parameters transmission
    #[inline(always)]
    pub fn gsr0tx(&mut self) -> GSR0TX_W<'_, CMCRrs> {
        GSR0TX_W::new(self, 11)
    }
    ///Bit 12 - Generic short read one parameters transmission
    #[inline(always)]
    pub fn gsr1tx(&mut self) -> GSR1TX_W<'_, CMCRrs> {
        GSR1TX_W::new(self, 12)
    }
    ///Bit 13 - Generic short read two parameters transmission
    #[inline(always)]
    pub fn gsr2tx(&mut self) -> GSR2TX_W<'_, CMCRrs> {
        GSR2TX_W::new(self, 13)
    }
    ///Bit 14 - Generic long write transmission
    #[inline(always)]
    pub fn glwtx(&mut self) -> GLWTX_W<'_, CMCRrs> {
        GLWTX_W::new(self, 14)
    }
    ///Bit 16 - DCS short write zero parameter transmission
    #[inline(always)]
    pub fn dsw0tx(&mut self) -> DSW0TX_W<'_, CMCRrs> {
        DSW0TX_W::new(self, 16)
    }
    ///Bit 17 - DCS short read one parameter transmission
    #[inline(always)]
    pub fn dsw1tx(&mut self) -> DSW1TX_W<'_, CMCRrs> {
        DSW1TX_W::new(self, 17)
    }
    ///Bit 18 - DCS short read zero parameter transmission
    #[inline(always)]
    pub fn dsr0tx(&mut self) -> DSR0TX_W<'_, CMCRrs> {
        DSR0TX_W::new(self, 18)
    }
    ///Bit 19 - DCS long write transmission
    #[inline(always)]
    pub fn dlwtx(&mut self) -> DLWTX_W<'_, CMCRrs> {
        DLWTX_W::new(self, 19)
    }
    ///Bit 24 - Maximum read packet size
    #[inline(always)]
    pub fn mrdps(&mut self) -> MRDPS_W<'_, CMCRrs> {
        MRDPS_W::new(self, 24)
    }
}
