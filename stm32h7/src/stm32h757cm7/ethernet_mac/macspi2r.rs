...
///Field `SPI2` reader - Source Port Identity 2
pub type SPI2_R = crate::FieldReader<u16>;
///Field `SPI2` writer - Source Port Identity 2
pub type SPI2_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - Source Port Identity 2
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#Ethernet_MAC:MACSPI2R)*/
