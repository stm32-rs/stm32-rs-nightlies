///Register `C1PR2` reader
pub type R = crate::R<C1PR2rs>;
///Register `C1PR2` writer
pub type W = crate::W<C1PR2rs>;
...
impl W {
    ///Bit 17 - Configurable event inputs x+32 Pending bit
    #[inline(always)]
    pub fn pr49(&mut self) -> PR49_W<'_, C1PR2rs> {
        PR49_W::new(self, 17)
    }
    ///Bit 19 - Configurable event inputs x+32 Pending bit
    #[inline(always)]
    pub fn pr51(&mut self) -> PR51_W<'_, C1PR2rs> {
        PR51_W::new(self, 19)
    }
}
/**EXTI pending register

You can [`read`](crate::Reg::read) this register and get [`c1pr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c1pr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#EXTI:C1PR2)*/
pub struct C1PR2rs;
impl crate::RegisterSpec for C1PR2rs {
    type Ux = u32;
}
///`read()` method returns [`c1pr2::R`](R) reader structure
impl crate::Readable for C1PR2rs {}
///`write(|w| ..)` method takes [`c1pr2::W`](W) writer structure
impl crate::Writable for C1PR2rs {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x000a_0000;
}
///`reset()` method sets C1PR2 to value 0
impl crate::Resettable for C1PR2rs {}
