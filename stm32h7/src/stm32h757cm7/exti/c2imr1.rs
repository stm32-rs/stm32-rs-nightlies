...
impl W {
    ///Bit 0 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr0(&mut self) -> MR0_W<C2IMR1rs> {
        MR0_W::new(self, 0)
    }
    ///Bit 1 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr1(&mut self) -> MR1_W<C2IMR1rs> {
        MR1_W::new(self, 1)
    }
    ///Bit 2 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr2(&mut self) -> MR2_W<C2IMR1rs> {
        MR2_W::new(self, 2)
    }
    ///Bit 3 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr3(&mut self) -> MR3_W<C2IMR1rs> {
        MR3_W::new(self, 3)
    }
    ///Bit 4 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr4(&mut self) -> MR4_W<C2IMR1rs> {
        MR4_W::new(self, 4)
    }
    ///Bit 5 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr5(&mut self) -> MR5_W<C2IMR1rs> {
        MR5_W::new(self, 5)
    }
    ///Bit 6 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr6(&mut self) -> MR6_W<C2IMR1rs> {
        MR6_W::new(self, 6)
    }
    ///Bit 7 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr7(&mut self) -> MR7_W<C2IMR1rs> {
        MR7_W::new(self, 7)
    }
    ///Bit 8 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr8(&mut self) -> MR8_W<C2IMR1rs> {
        MR8_W::new(self, 8)
    }
    ///Bit 9 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr9(&mut self) -> MR9_W<C2IMR1rs> {
        MR9_W::new(self, 9)
    }
    ///Bit 10 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr10(&mut self) -> MR10_W<C2IMR1rs> {
        MR10_W::new(self, 10)
    }
    ///Bit 11 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr11(&mut self) -> MR11_W<C2IMR1rs> {
        MR11_W::new(self, 11)
    }
    ///Bit 12 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr12(&mut self) -> MR12_W<C2IMR1rs> {
        MR12_W::new(self, 12)
    }
    ///Bit 13 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr13(&mut self) -> MR13_W<C2IMR1rs> {
        MR13_W::new(self, 13)
    }
    ///Bit 14 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr14(&mut self) -> MR14_W<C2IMR1rs> {
        MR14_W::new(self, 14)
    }
    ///Bit 15 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr15(&mut self) -> MR15_W<C2IMR1rs> {
        MR15_W::new(self, 15)
    }
    ///Bit 16 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr16(&mut self) -> MR16_W<C2IMR1rs> {
        MR16_W::new(self, 16)
    }
    ///Bit 17 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr17(&mut self) -> MR17_W<C2IMR1rs> {
        MR17_W::new(self, 17)
    }
    ///Bit 18 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr18(&mut self) -> MR18_W<C2IMR1rs> {
        MR18_W::new(self, 18)
    }
    ///Bit 19 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr19(&mut self) -> MR19_W<C2IMR1rs> {
        MR19_W::new(self, 19)
    }
    ///Bit 20 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr20(&mut self) -> MR20_W<C2IMR1rs> {
        MR20_W::new(self, 20)
    }
    ///Bit 21 - CPU2 interrupt mask on Configurable Event input
    #[inline(always)]
    pub fn mr21(&mut self) -> MR21_W<C2IMR1rs> {
        MR21_W::new(self, 21)
    }
    ///Bit 22 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr22(&mut self) -> MR22_W<C2IMR1rs> {
        MR22_W::new(self, 22)
    }
    ///Bit 23 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr23(&mut self) -> MR23_W<C2IMR1rs> {
        MR23_W::new(self, 23)
    }
    ///Bit 24 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr24(&mut self) -> MR24_W<C2IMR1rs> {
        MR24_W::new(self, 24)
    }
    ///Bit 25 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr25(&mut self) -> MR25_W<C2IMR1rs> {
        MR25_W::new(self, 25)
    }
    ///Bit 26 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr26(&mut self) -> MR26_W<C2IMR1rs> {
        MR26_W::new(self, 26)
    }
    ///Bit 27 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr27(&mut self) -> MR27_W<C2IMR1rs> {
        MR27_W::new(self, 27)
    }
    ///Bit 28 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr28(&mut self) -> MR28_W<C2IMR1rs> {
        MR28_W::new(self, 28)
    }
    ///Bit 29 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr29(&mut self) -> MR29_W<C2IMR1rs> {
        MR29_W::new(self, 29)
    }
    ///Bit 30 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr30(&mut self) -> MR30_W<C2IMR1rs> {
        MR30_W::new(self, 30)
    }
    ///Bit 31 - CPU2 interrupt mask on Direct Event input
    #[inline(always)]
    pub fn mr31(&mut self) -> MR31_W<C2IMR1rs> {
        MR31_W::new(self, 31)
    }
}
