...
impl W {
    ///Bits 0:15 - Arm Cortex-M4 boot address 0 configuration
    #[inline(always)]
    pub fn boot_cm4_add0(&mut self) -> BOOT_CM4_ADD0_W<'_, BOOT4_PRGR_rs> {
        BOOT_CM4_ADD0_W::new(self, 0)
    }
    ///Bits 16:31 - Arm Cortex-M4 boot address 1 configuration
    #[inline(always)]
    pub fn boot_cm4_add1(&mut self) -> BOOT_CM4_ADD1_W<'_, BOOT4_PRGR_rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#FLASH:BOOT4_PRGR_)*/
