...
impl W {
    ...
    ///Bit 16 - Interrupt semaphore 16 clear bit
    #[inline(always)]
    pub fn isc16(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 16)
    }
    ///Bit 17 - Interrupt semaphore 17 clear bit
    #[inline(always)]
    pub fn isc17(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 17)
    }
    ///Bit 18 - Interrupt semaphore 18 clear bit
    #[inline(always)]
    pub fn isc18(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 18)
    }
    ///Bit 19 - Interrupt semaphore 19 clear bit
    #[inline(always)]
    pub fn isc19(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 19)
    }
    ///Bit 20 - Interrupt semaphore 20 clear bit
    #[inline(always)]
    pub fn isc20(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 20)
    }
    ///Bit 21 - Interrupt semaphore 21 clear bit
    #[inline(always)]
    pub fn isc21(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 21)
    }
    ///Bit 22 - Interrupt semaphore 22 clear bit
    #[inline(always)]
    pub fn isc22(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 22)
    }
    ///Bit 23 - Interrupt semaphore 23 clear bit
    #[inline(always)]
    pub fn isc23(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 23)
    }
    ///Bit 24 - Interrupt semaphore 24 clear bit
    #[inline(always)]
    pub fn isc24(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 24)
    }
    ///Bit 25 - Interrupt semaphore 25 clear bit
    #[inline(always)]
    pub fn isc25(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 25)
    }
    ///Bit 26 - Interrupt semaphore 26 clear bit
    #[inline(always)]
    pub fn isc26(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 26)
    }
    ///Bit 27 - Interrupt semaphore 27 clear bit
    #[inline(always)]
    pub fn isc27(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 27)
    }
    ///Bit 28 - Interrupt semaphore 28 clear bit
    #[inline(always)]
    pub fn isc28(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 28)
    }
    ///Bit 29 - Interrupt semaphore 29 clear bit
    #[inline(always)]
    pub fn isc29(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 29)
    }
    ///Bit 30 - Interrupt semaphore 30 clear bit
    #[inline(always)]
    pub fn isc30(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 30)
    }
    ///Bit 31 - Interrupt semaphore 31 clear bit
    #[inline(always)]
    pub fn isc31(&mut self) -> ISC_W<'_, C1ICRrs> {
        ISC_W::new(self, 31)
    }
}
