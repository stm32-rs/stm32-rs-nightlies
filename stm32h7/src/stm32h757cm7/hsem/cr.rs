...
///Field `COREID` writer - COREID of semaphores to be cleared
...
impl W {
    ///Bits 8:11 - COREID of semaphores to be cleared
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HSEM:CR)*/
pub struct CRrs;
