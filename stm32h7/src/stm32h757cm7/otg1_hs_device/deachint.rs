...
impl W {
    ///Bit 1 - IN endpoint 1interrupt bit
    #[inline(always)]
    pub fn iep1int(&mut self) -> IEP1INT_W<'_, DEACHINTrs> {
        IEP1INT_W::new(self, 1)
    }
    ///Bit 17 - OUT endpoint 1 interrupt bit
    #[inline(always)]
    pub fn oep1int(&mut self) -> OEP1INT_W<'_, DEACHINTrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#OTG1_HS_DEVICE:DEACHINT)*/
