...
impl W {
    ...
    ///Bit 14 - ART Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn artlpen(&mut self) -> ARTLPEN_W<'_, AHB1LPENRrs> {
    ...
    ///Bit 25 - USB1OTG peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn usb1otglpen(&mut self) -> USB1OTGLPEN_W<'_, AHB1LPENRrs> {
        USB1OTGLPEN_W::new(self, 25)
    }
    ///Bit 26 - USB_PHY1 clock enable during CSleep mode
    #[inline(always)]
    pub fn usb1otgulpilpen(&mut self) -> USB1OTGULPILPEN_W<'_, AHB1LPENRrs> {
        USB1OTGULPILPEN_W::new(self, 26)
    }
    ///Bit 27 - USB2OTG peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn usb2otglpen(&mut self) -> USB2OTGLPEN_W<'_, AHB1LPENRrs> {
        USB2OTGLPEN_W::new(self, 27)
    }
    ///Bit 28 - USB_PHY2 clocks enable during CSleep mode
    #[inline(always)]
    pub fn usb2ulpilpen(&mut self) -> USB2ULPILPEN_W<'_, AHB1LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#RCC:AHB1LPENR)*/
