...
impl W {
    ...
    ///Bit 21 - BDMA Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn bdmalpen(&mut self) -> BDMALPEN_W<'_, AHB4LPENRrs> {
        BDMALPEN_W::new(self, 21)
    }
    ///Bit 24 - ADC3 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn adc3lpen(&mut self) -> ADC3LPEN_W<'_, AHB4LPENRrs> {
    ...
    ///Bit 29 - SRAM4 Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn sram4lpen(&mut self) -> SRAM4LPEN_W<'_, AHB4LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#RCC:AHB4LPENR)*/
...
///`reset()` method sets AHB4LPENR to value 0
