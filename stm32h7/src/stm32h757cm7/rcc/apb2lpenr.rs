...
impl W {
    ...
    ///Bit 24 - SAI3 Peripheral Clocks Enable During CSleep Mode
    #[inline(always)]
    pub fn sai3lpen(&mut self) -> SAI3LPEN_W<'_, APB2LPENRrs> {
    ...
    ///Bit 29 - HRTIM peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn hrtimlpen(&mut self) -> HRTIMLPEN_W<'_, APB2LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#RCC:APB2LPENR)*/
