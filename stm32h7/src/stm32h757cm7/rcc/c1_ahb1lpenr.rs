...
impl W {
    ...
    ///Bit 14 - ART Clock Enable During CSleep Mode
    #[inline(always)]
    pub fn artlpen(&mut self) -> ARTLPEN_W<C1_AHB1LPENRrs> {
    ...
    ///Bit 28 - USB_PHY2 clocks enable during CSleep mode
    #[inline(always)]
    pub fn usb2ulpilpen(&mut self) -> USB2ULPILPEN_W<C1_AHB1LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#RCC:C1_AHB1LPENR)*/
