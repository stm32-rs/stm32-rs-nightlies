...
///Field `TSEG2` reader - Nominal Time segment after sample point
pub type TSEG2_R = crate::FieldReader;
///Field `TSEG2` writer - Nominal Time segment after sample point
...
///Field `NSJW` reader - NSJW: Nominal (Re)Synchronization Jump Width
pub type NSJW_R = crate::FieldReader;
///Field `NSJW` writer - NSJW: Nominal (Re)Synchronization Jump Width
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7A3.html#CAN_CCU:FDCAN_NBTP)*/
...
///`reset()` method sets FDCAN_NBTP to value 0x0a33
