...
impl W {
    ...
    ///Bits 3:4 - Activity
    #[inline(always)]
    pub fn act(&mut self) -> ACT_W<FDCAN_PSRrs> {
        ACT_W::new(self, 3)
    }
    ///Bit 5 - Error Passive
    #[inline(always)]
    pub fn ep(&mut self) -> EP_W<FDCAN_PSRrs> {
        EP_W::new(self, 5)
    }
    ///Bit 6 - Warning Status
    #[inline(always)]
    pub fn ew(&mut self) -> EW_W<FDCAN_PSRrs> {
        EW_W::new(self, 6)
    }
    ///Bit 7 - Bus_Off Status
    #[inline(always)]
    pub fn bo(&mut self) -> BO_W<FDCAN_PSRrs> {
        BO_W::new(self, 7)
    }
    ///Bits 8:10 - Data Last Error Code
    #[inline(always)]
    ...
    ///Bits 16:22 - Transmitter Delay Compensation Value
    #[inline(always)]
    pub fn tdcv(&mut self) -> TDCV_W<FDCAN_PSRrs> {
        TDCV_W::new(self, 16)
    }
}
