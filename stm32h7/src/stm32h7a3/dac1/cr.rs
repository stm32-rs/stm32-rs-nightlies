...
pub enum TSEL1 {
    ...
    ///13: EXTI line 9
    Exti9 = 13,
    ///14: LPTIM2 (DAC1)/ LPTIM3 (DAC2) OUT event
    Lptim2or3out = 14,
}
...
impl TSEL1_R {
    ...
    ///LPTIM2 (DAC1)/ LPTIM3 (DAC2) OUT event
    #[inline(always)]
    pub fn is_lptim2or3out(&self) -> bool {
        *self == TSEL1::Lptim2or3out
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    ///LPTIM2 (DAC1)/ LPTIM3 (DAC2) OUT event
    #[inline(always)]
    pub fn lptim2or3out(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Lptim2or3out)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7A3.html#DAC1:CR)*/
pub struct CRrs;
