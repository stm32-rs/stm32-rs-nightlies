...
/**Field `PLSSKP` reader - Pulses to skip for input data skipping function immediately after writing to this field. Reading of PLSSKP\[5:0\]
...
/**Field `PLSSKP` writer - Pulses to skip for input data skipping function immediately after writing to this field. Reading of PLSSKP\[5:0\]
returns current value of pulses which will be skipped. If PLSSKP\[5:0\]=0 then all required data samples were already skipped. Note: User can update PLSSKP\[5:0\]
also when PLSSKP\[5:0\]
is not zero. 0-63: Defines the number of serial input samples that will be skipped. Skipping is applied*/
pub type PLSSKP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    /**Bits 0:5 - Pulses to skip for input data skipping function immediately after writing to this field. Reading of PLSSKP\[5:0\]
    returns current value of pulses which will be skipped. If PLSSKP\[5:0\]=0 then all required data samples were already skipped. Note: User can update PLSSKP\[5:0\]
    also when PLSSKP\[5:0\]
    is not zero. 0-63: Defines the number of serial input samples that will be skipped. Skipping is applied*/
    #[inline(always)]
