...
///Field `CLRCKABF` reader - Clear the clock absence flag CLRCKABF\[y\]=0: Writing '0â has no effect CLRCKABF\[y\]=1: Writing '1â to position y clears the corresponding CKABF\[y\] bit in the DFSDM_FLTxISR register. When the transceiver is not yet synchronized, the clock absence flag is set and cannot be cleared by CLRCKABF\[y\]. Note: CLRCKABF\[7:0\] is present only in DFSDM_FLT0ICR register (filter x=0)
pub type CLRCKABF_R = crate::FieldReader;
///Field `CLRCKABF` writer - Clear the clock absence flag CLRCKABF\[y\]=0: Writing '0â has no effect CLRCKABF\[y\]=1: Writing '1â to position y clears the corresponding CKABF\[y\] bit in the DFSDM_FLTxISR register. When the transceiver is not yet synchronized, the clock absence flag is set and cannot be cleared by CLRCKABF\[y\]. Note: CLRCKABF\[7:0\] is present only in DFSDM_FLT0ICR register (filter x=0)
pub type CLRCKABF_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `CLRSCDF` reader - Clear the short-circuit detector flag CLRSCDF\[y\]=0: Writing '0â has no effect CLRSCDF\[y\]=1: Writing '1â to position y clears the corresponding SCDF\[y\] bit in the DFSDM_FLTxISR register Note: CLRSCDF\[7:0\] is present only in DFSDM_FLT0ICR register (filter x=0)
pub type CLRSCDF_R = crate::FieldReader;
///Field `CLRSCDF` writer - Clear the short-circuit detector flag CLRSCDF\[y\]=0: Writing '0â has no effect CLRSCDF\[y\]=1: Writing '1â to position y clears the corresponding SCDF\[y\] bit in the DFSDM_FLTxISR register Note: CLRSCDF\[7:0\] is present only in DFSDM_FLT0ICR register (filter x=0)
...
impl R {
    ...
    ///Bits 16:23 - Clear the clock absence flag CLRCKABF\[y\]=0: Writing '0â has no effect CLRCKABF\[y\]=1: Writing '1â to position y clears the corresponding CKABF\[y\] bit in the DFSDM_FLTxISR register. When the transceiver is not yet synchronized, the clock absence flag is set and cannot be cleared by CLRCKABF\[y\]. Note: CLRCKABF\[7:0\] is present only in DFSDM_FLT0ICR register (filter x=0)
    #[inline(always)]
    pub fn clrckabf(&self) -> CLRCKABF_R {
        CLRCKABF_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - Clear the short-circuit detector flag CLRSCDF\[y\]=0: Writing '0â has no effect CLRSCDF\[y\]=1: Writing '1â to position y clears the corresponding SCDF\[y\] bit in the DFSDM_FLTxISR register Note: CLRSCDF\[7:0\] is present only in DFSDM_FLT0ICR register (filter x=0)
    #[inline(always)]
