...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7A3.html#GPIOC:MODER)

For information about available fields see [`mod@moder`] module*/
pub type MODER = crate::Reg<moder::MODERrs>;
///GPIO port mode register
pub mod moder;
pub use crate::stm32h7a3::gpioa::otyper;
pub use crate::stm32h7a3::gpioa::OTYPER;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7A3.html#GPIOC:OSPEEDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7A3.html#GPIOC:PUPDR)

For information about available fields see [`mod@pupdr`] module*/
pub type PUPDR = crate::Reg<pupdr::PUPDRrs>;
///GPIO port pull-up/pull-down register
pub mod pupdr;
pub use crate::stm32h7a3::gpioa::afrh;
pub use crate::stm32h7a3::gpioa::afrl;
pub use crate::stm32h7a3::gpioa::bsrr;
pub use crate::stm32h7a3::gpioa::idr;
pub use crate::stm32h7a3::gpioa::lckr;
pub use crate::stm32h7a3::gpioa::odr;
pub use crate::stm32h7a3::gpioa::AFRH;
pub use crate::stm32h7a3::gpioa::AFRL;
pub use crate::stm32h7a3::gpioa::BSRR;
pub use crate::stm32h7a3::gpioa::IDR;
