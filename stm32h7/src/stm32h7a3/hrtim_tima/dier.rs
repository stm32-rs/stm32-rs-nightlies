...
///CMP%sDE
pub use crate::stm32h7a3::hrtim_master::dier::CMP1DE;
///CMP%sIE
pub use crate::stm32h7a3::hrtim_master::dier::CMP1IE;
///Field `CMPDE(1-4)` reader - CMP%sDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_R;
///Field `REPDE` reader - REPDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_R as REPDE_R;
///Field `UPDDE` reader - UPDDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_R as UPDDE_R;
///Field `CPTDE(1-2)` reader - CPT%sDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_R as CPTDE_R;
///Field `SETDE(1-2)` reader - Output %s set DMA request enable
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_R as SETDE_R;
///Field `RST1DE` reader - RSTx1DE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_R as RST1DE_R;
///Field `RST2DE` reader - RSTx2DE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_R as RST2DE_R;
///Field `RSTDE` reader - RSTDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_R as RSTDE_R;
///Field `DLYPRTDE` reader - DLYPRTDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_R as DLYPRTDE_R;
///Field `CMPDE(1-4)` writer - CMP%sDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_W;
///Field `REPDE` writer - REPDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_W as REPDE_W;
///Field `UPDDE` writer - UPDDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_W as UPDDE_W;
///Field `CPTDE(1-2)` writer - CPT%sDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_W as CPTDE_W;
///Field `SETDE(1-2)` writer - Output %s set DMA request enable
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_W as SETDE_W;
///Field `RST1DE` writer - RSTx1DE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_W as RST1DE_W;
///Field `RST2DE` writer - RSTx2DE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_W as RST2DE_W;
///Field `RSTDE` writer - RSTDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_W as RSTDE_W;
///Field `DLYPRTDE` writer - DLYPRTDE
pub use crate::stm32h7a3::hrtim_master::dier::CMPDE_W as DLYPRTDE_W;
///Field `CMPIE(1-4)` reader - CMP%sIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_R;
///Field `REPIE` reader - REPIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_R as REPIE_R;
///Field `UPDIE` reader - UPDIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_R as UPDIE_R;
///Field `CPTIE(1-2)` reader - CPT%sIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_R as CPTIE_R;
///Field `SETIE(1-2)` reader - Output %s set interrupt enable
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_R as SETIE_R;
///Field `RST1IE` reader - RSTx1IE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_R as RST1IE_R;
///Field `RST2IE` reader - RSTx2IE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_R as RST2IE_R;
///Field `RSTIE` reader - RSTIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_R as RSTIE_R;
///Field `DLYPRTIE` reader - DLYPRTIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_R as DLYPRTIE_R;
///Field `CMPIE(1-4)` writer - CMP%sIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_W;
///Field `REPIE` writer - REPIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_W as REPIE_W;
///Field `UPDIE` writer - UPDIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_W as UPDIE_W;
///Field `CPTIE(1-2)` writer - CPT%sIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_W as CPTIE_W;
///Field `SETIE(1-2)` writer - Output %s set interrupt enable
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_W as SETIE_W;
///Field `RST1IE` writer - RSTx1IE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_W as RST1IE_W;
///Field `RST2IE` writer - RSTx2IE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_W as RST2IE_W;
///Field `RSTIE` writer - RSTIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_W as RSTIE_W;
///Field `DLYPRTIE` writer - DLYPRTIE
pub use crate::stm32h7a3::hrtim_master::dier::CMPIE_W as DLYPRTIE_W;
impl R {
    ///CMP(1-4)IE
    ///
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7A3.html#HRTIM_TIMA:DIER)*/
pub struct DIERrs;
