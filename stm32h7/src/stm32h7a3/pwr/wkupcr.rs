...
///Field `WKUPC1` reader - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC1_R = crate::BitReader;
///Field `WKUPC1` writer - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WKUPC2` reader - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC2_R = crate::BitReader;
///Field `WKUPC2` writer - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WKUPC3` reader - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC3_R = crate::BitReader;
///Field `WKUPC3` writer - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WKUPC4` reader - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC4_R = crate::BitReader;
///Field `WKUPC4` writer - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WKUPC5` reader - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC5_R = crate::BitReader;
///Field `WKUPC5` writer - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WKUPC6` reader - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
pub type WKUPC6_R = crate::BitReader;
///Field `WKUPC6` writer - Clear Wakeup pin flag for WKUP. These bits are always read as 0.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7A3.html#PWR:WKUPCR)*/
pub struct WKUPCRrs;
