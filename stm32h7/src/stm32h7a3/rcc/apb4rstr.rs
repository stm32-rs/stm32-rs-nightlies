...
impl W {
    ...
    ///Bit 13 - DAC2 (containing one converter) reset Set and reset by software.
    #[inline(always)]
    pub fn dac2rst(&mut self) -> DAC2RST_W<'_, APB4RSTRrs> {
    ...
    ///Bit 27 - DFSDM2 block reset Set and reset by software.
    #[inline(always)]
    pub fn dfsdm2rst(&mut self) -> DFSDM2RST_W<'_, APB4RSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7A3.html#RCC:APB4RSTR)*/
