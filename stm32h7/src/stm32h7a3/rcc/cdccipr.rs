...
impl W {
    ///Bits 0:1 - FMC kernel clock source selection
    #[inline(always)]
    pub fn fmcsel(&mut self) -> FMCSEL_W<'_, CDCCIPRrs> {
        FMCSEL_W::new(self, 0)
    }
    ///Bits 4:5 - OCTOSPI kernel clock source selection
    #[inline(always)]
    pub fn octospisel(&mut self) -> OCTOSPISEL_W<'_, CDCCIPRrs> {
        OCTOSPISEL_W::new(self, 4)
    }
    ///Bit 16 - SDMMC kernel clock source selection
    #[inline(always)]
    pub fn sdmmcsel(&mut self) -> SDMMCSEL_W<'_, CDCCIPRrs> {
        SDMMCSEL_W::new(self, 16)
    }
    ///Bits 28:29 - per_ck clock source selection
    #[inline(always)]
    pub fn ckpersel(&mut self) -> CKPERSEL_W<'_, CDCCIPRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7A3.html#RCC:CDCCIPR)*/
