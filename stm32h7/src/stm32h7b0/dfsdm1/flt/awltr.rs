...
///Field `BKAWL` reader - Break signal assignment to analog watchdog low threshold event BKAWL\[i\] = 0: Break i signal is not assigned to an analog watchdog low threshold event BKAWL\[i\] = 1: Break i signal is assigned to an analog watchdog low threshold event
pub type BKAWL_R = crate::FieldReader;
///Field `BKAWL` writer - Break signal assignment to analog watchdog low threshold event BKAWL\[i\] = 0: Break i signal is not assigned to an analog watchdog low threshold event BKAWL\[i\] = 1: Break i signal is assigned to an analog watchdog low threshold event
