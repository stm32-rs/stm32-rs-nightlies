...
/**Field `SCDIE` reader - Short-circuit detector interrupt enable Please see the explanation of SCDF\[7:0\]
in DFSDM_FLTxISR. Note: SCDIE is present only in DFSDM_FLT0CR2 register (filter x=0)*/
pub type SCDIE_R = crate::BitReader;
/**Field `SCDIE` writer - Short-circuit detector interrupt enable Please see the explanation of SCDF\[7:0\]
in DFSDM_FLTxISR. Note: SCDIE is present only in DFSDM_FLT0CR2 register (filter x=0)*/
pub type SCDIE_W<'a, REG> = crate::BitWriter<'a, REG>;
/**Field `CKABIE` reader - Clock absence interrupt enable Please see the explanation of CKABF\[7:0\]
in DFSDM_FLTxISR. Note: CKABIE is present only in DFSDM_FLT0CR2 register (filter x=0)*/
pub type CKABIE_R = crate::BitReader;
/**Field `CKABIE` writer - Clock absence interrupt enable Please see the explanation of CKABF\[7:0\]
in DFSDM_FLTxISR. Note: CKABIE is present only in DFSDM_FLT0CR2 register (filter x=0)*/
pub type CKABIE_W<'a, REG> = crate::BitWriter<'a, REG>;
/**Field `EXCH` reader - Extremes detector channel selection These bits select the input channels to be taken by the Extremes detector. EXCH\[y\]
...
/**Field `EXCH` writer - Extremes detector channel selection These bits select the input channels to be taken by the Extremes detector. EXCH\[y\]
= 0: Extremes detector does not accept data from channel y EXCH\[y\]
= 1: Extremes detector accepts data from channel y*/
pub type EXCH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
/**Field `AWDCH` reader - Analog watchdog channel selection These bits select the input channel to be guarded continuously by the analog watchdog. AWDCH\[y\]
...
/**Field `AWDCH` writer - Analog watchdog channel selection These bits select the input channel to be guarded continuously by the analog watchdog. AWDCH\[y\]
= 0: Analog watchdog is disabled on channel y AWDCH\[y\]
= 1: Analog watchdog is enabled on channel y*/
...
impl R {
    ...
    /**Bit 5 - Short-circuit detector interrupt enable Please see the explanation of SCDF\[7:0\]
    in DFSDM_FLTxISR. Note: SCDIE is present only in DFSDM_FLT0CR2 register (filter x=0)*/
    #[inline(always)]
    pub fn scdie(&self) -> SCDIE_R {
        SCDIE_R::new(((self.bits >> 5) & 1) != 0)
    }
    /**Bit 6 - Clock absence interrupt enable Please see the explanation of CKABF\[7:0\]
    in DFSDM_FLTxISR. Note: CKABIE is present only in DFSDM_FLT0CR2 register (filter x=0)*/
    #[inline(always)]
    pub fn ckabie(&self) -> CKABIE_R {
        CKABIE_R::new(((self.bits >> 6) & 1) != 0)
    }
    /**Bits 8:15 - Extremes detector channel selection These bits select the input channels to be taken by the Extremes detector. EXCH\[y\]
    = 0: Extremes detector does not accept data from channel y EXCH\[y\]
    = 1: Extremes detector accepts data from channel y*/
    #[inline(always)]
    ...
    /**Bits 16:23 - Analog watchdog channel selection These bits select the input channel to be guarded continuously by the analog watchdog. AWDCH\[y\]
    = 0: Analog watchdog is disabled on channel y AWDCH\[y\]
    = 1: Analog watchdog is enabled on channel y*/
    #[inline(always)]
