...
impl W {
    ...
    ///Bit 6 - D1 DStop entry reset option status bit
    #[inline(always)]
    pub fn nrst_stop(&mut self) -> NRST_STOP_W<'_, OPTSR_CURrs> {
        NRST_STOP_W::new(self, 6)
    }
    ///Bit 7 - D1 DStandby entry reset option status bit
    #[inline(always)]
    pub fn nrst_stdy(&mut self) -> NRST_STDY_W<'_, OPTSR_CURrs> {
    ...
    ///Bit 16 - IWDG Stop mode freeze option status bit
    #[inline(always)]
    pub fn vddmmc_hslv(&mut self) -> VDDMMC_HSLV_W<'_, OPTSR_CURrs> {
        VDDMMC_HSLV_W::new(self, 16)
    }
    ///Bit 17 - IWDG Stop mode freeze option status bit
    #[inline(always)]
    pub fn wdg_fz_stop(&mut self) -> WDG_FZ_STOP_W<'_, OPTSR_CURrs> {
    ...
    ///Bit 29 - I/O high-speed at low-voltage status bit (PRODUCT_BELOW_25V)
    #[inline(always)]
    pub fn vddio_hslv(&mut self) -> VDDIO_HSLV_W<'_, OPTSR_CURrs> {
