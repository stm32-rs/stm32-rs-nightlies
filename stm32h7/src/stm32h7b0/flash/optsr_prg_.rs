...
impl W {
    ...
    ///Bit 6 - Option byte erase after D1 DStop option configuration bit
    #[inline(always)]
    pub fn nrst_stop(&mut self) -> NRST_STOP_W<'_, OPTSR_PRG_rs> {
        NRST_STOP_W::new(self, 6)
    }
    ///Bit 7 - Option byte erase after D1 DStandby option configuration bit
    #[inline(always)]
    pub fn nrst_stdy(&mut self) -> NRST_STDY_W<'_, OPTSR_PRG_rs> {
    ...
    ///Bit 16 - VDDMMC_HSLV
    #[inline(always)]
    pub fn vddmmc_hslv(&mut self) -> VDDMMC_HSLV_W<'_, OPTSR_PRG_rs> {
        VDDMMC_HSLV_W::new(self, 16)
    }
    ///Bit 17 - IWDG Stop mode freeze option configuration bit
    #[inline(always)]
    pub fn wdg_fz_stop(&mut self) -> WDG_FZ_STOP_W<'_, OPTSR_PRG_rs> {
    ...
    ///Bit 29 - VDDIO_HSLV
    #[inline(always)]
    pub fn vddio_hslv(&mut self) -> VDDIO_HSLV_W<'_, OPTSR_PRG_rs> {
