...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `ISC0` field.</div>
    #[inline(always)]
    pub fn isc(&mut self, n: u8) -> ISC_W<ICRrs> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        ISC_W::new(self, n)
    }
    ///Bit 0 - Interrupt semaphore 0 clear bit
    #[inline(always)]
    pub fn isc0(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 0)
    }
    ///Bit 1 - Interrupt semaphore 1 clear bit
    #[inline(always)]
    pub fn isc1(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 1)
    }
    ///Bit 2 - Interrupt semaphore 2 clear bit
    #[inline(always)]
    pub fn isc2(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 2)
    }
    ///Bit 3 - Interrupt semaphore 3 clear bit
    #[inline(always)]
    pub fn isc3(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 3)
    }
    ///Bit 4 - Interrupt semaphore 4 clear bit
    #[inline(always)]
    pub fn isc4(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 4)
    }
    ///Bit 5 - Interrupt semaphore 5 clear bit
    #[inline(always)]
    pub fn isc5(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 5)
    }
    ///Bit 6 - Interrupt semaphore 6 clear bit
    #[inline(always)]
    pub fn isc6(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 6)
    }
    ///Bit 7 - Interrupt semaphore 7 clear bit
    #[inline(always)]
    pub fn isc7(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 7)
    }
    ///Bit 8 - Interrupt semaphore 8 clear bit
    #[inline(always)]
    pub fn isc8(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 8)
    }
    ///Bit 9 - Interrupt semaphore 9 clear bit
    #[inline(always)]
    pub fn isc9(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 9)
    }
    ///Bit 10 - Interrupt semaphore 10 clear bit
    #[inline(always)]
    pub fn isc10(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 10)
    }
    ///Bit 11 - Interrupt semaphore 11 clear bit
    #[inline(always)]
    pub fn isc11(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 11)
    }
    ///Bit 12 - Interrupt semaphore 12 clear bit
    #[inline(always)]
    pub fn isc12(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 12)
    }
    ///Bit 13 - Interrupt semaphore 13 clear bit
    #[inline(always)]
    pub fn isc13(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 13)
    }
    ///Bit 14 - Interrupt semaphore 14 clear bit
    #[inline(always)]
    pub fn isc14(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 14)
    }
    ///Bit 15 - Interrupt semaphore 15 clear bit
    #[inline(always)]
    pub fn isc15(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 15)
    }
    ///Bit 16 - Interrupt semaphore 16 clear bit
    #[inline(always)]
    pub fn isc16(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 16)
    }
    ///Bit 17 - Interrupt semaphore 17 clear bit
    #[inline(always)]
    pub fn isc17(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 17)
    }
    ///Bit 18 - Interrupt semaphore 18 clear bit
    #[inline(always)]
    pub fn isc18(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 18)
    }
    ///Bit 19 - Interrupt semaphore 19 clear bit
    #[inline(always)]
    pub fn isc19(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 19)
    }
    ///Bit 20 - Interrupt semaphore 20 clear bit
    #[inline(always)]
    pub fn isc20(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 20)
    }
    ///Bit 21 - Interrupt semaphore 21 clear bit
    #[inline(always)]
    pub fn isc21(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 21)
    }
    ///Bit 22 - Interrupt semaphore 22 clear bit
    #[inline(always)]
    pub fn isc22(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 22)
    }
    ///Bit 23 - Interrupt semaphore 23 clear bit
    #[inline(always)]
    pub fn isc23(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 23)
    }
    ///Bit 24 - Interrupt semaphore 24 clear bit
    #[inline(always)]
    pub fn isc24(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 24)
    }
    ///Bit 25 - Interrupt semaphore 25 clear bit
    #[inline(always)]
    pub fn isc25(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 25)
    }
    ///Bit 26 - Interrupt semaphore 26 clear bit
    #[inline(always)]
    pub fn isc26(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 26)
    }
    ///Bit 27 - Interrupt semaphore 27 clear bit
    #[inline(always)]
    pub fn isc27(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 27)
    }
    ///Bit 28 - Interrupt semaphore 28 clear bit
    #[inline(always)]
    pub fn isc28(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 28)
    }
    ///Bit 29 - Interrupt semaphore 29 clear bit
    #[inline(always)]
    pub fn isc29(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 29)
    }
    ///Bit 30 - Interrupt semaphore 30 clear bit
    #[inline(always)]
    pub fn isc30(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 30)
    }
    ///Bit 31 - Interrupt semaphore 31 clear bit
    #[inline(always)]
    pub fn isc31(&mut self) -> ISC_W<ICRrs> {
        ISC_W::new(self, 31)
    }
}
