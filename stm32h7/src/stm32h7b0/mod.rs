/*!Peripheral access API for STM32H7B0 microcontrollers (generated using svd2rust v0.35.0 (b6ef0b0 2024-11-13))
...
///Low power timer
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#LPTIM3)
pub struct LPTIM3 {
    _marker: PhantomData<*const ()>,
}
...
///General purpose timers
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#TIM4)
pub struct TIM4 {
    _marker: PhantomData<*const ()>,
}
...
///General purpose timers
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#TIM14)
pub struct TIM14 {
    _marker: PhantomData<*const ()>,
}
...
///OctoSPI
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#OCTOSPI2)
pub struct OCTOSPI2 {
    _marker: PhantomData<*const ()>,
}
...
impl BDMA1 {
    ///Pointer to the register block
    pub const PTR: *const bdma2::RegisterBlock = 0x4802_2c00 as *const _;
    ///Return the pointer to the register block
    #[inline(always)]
    pub const fn ptr() -> *const bdma2::RegisterBlock {
        Self::PTR
...
///Analog to Digital Converter
///
///See peripheral [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#ADC2)
pub struct ADC2 {
    _marker: PhantomData<*const ()>,
}
