...
impl W {
    ///Bits 0:4 - Number of dummy cycles
    #[inline(always)]
    pub fn dcyc(&mut self) -> DCYC_W<'_, TCRrs> {
        DCYC_W::new(self, 0)
    }
    ///Bit 28 - Delay hold quarter cycle
    #[inline(always)]
    pub fn dhqc(&mut self) -> DHQC_W<'_, TCRrs> {
        DHQC_W::new(self, 28)
    }
    ///Bit 30 - Sample shift
    #[inline(always)]
    pub fn sshift(&mut self) -> SSHIFT_W<'_, TCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#OCTOSPI1:TCR)*/
pub struct TCRrs;
