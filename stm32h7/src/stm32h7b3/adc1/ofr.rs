...
///Field `OFFSET` reader - ADC offset number 1 offset level
pub type OFFSET_R = crate::FieldReader<u32>;
///Field `OFFSET` writer - ADC offset number 1 offset level
pub type OFFSET_W<'a, REG> = crate::FieldWriter<'a, REG, 26, u32>;
///Field `OFFSET_CH` reader - ADC offset number 1 channel selection
pub type OFFSET_CH_R = crate::FieldReader;
///Field `OFFSET_CH` writer - ADC offset number 1 channel selection
...
impl W {
    ...
    ///Bit 31 - Signed saturation enable
    #[inline(always)]
    pub fn ssate(&mut self) -> SSATE_W<OFRrs> {
        SSATE_W::new(self, 31)
    }
}
