#[doc = "Reader of register TARG2_FN_MOD"]
pub type R = crate::R<u32, super::TARG2_FN_MOD>;
#[doc = "Writer for register TARG2_FN_MOD"]
pub type W = crate::W<u32, super::TARG2_FN_MOD>;
#[doc = "Register TARG2_FN_MOD `reset()`'s with value 0x04"]
impl crate::ResetValue for super::TARG2_FN_MOD {
    type Type = u32;
    #[inline(always)]
