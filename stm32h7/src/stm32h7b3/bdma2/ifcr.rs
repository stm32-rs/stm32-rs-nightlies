...
impl<'a> CGIF8_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CGIF8_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
#[doc = "Channel x transfer complete clear This bit is set and cleared by software."]
pub type CTCIF8_AW = CTCIF1_AW;
#[doc = "Write proxy for field `CTCIF8`"]
pub struct CTCIF8_W<'a> {
    w: &'a mut W,
}
impl<'a> CTCIF8_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CTCIF8_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
#[doc = "Channel x half transfer clear This bit is set and cleared by software."]
pub type CHTIF8_AW = CHTIF1_AW;
#[doc = "Write proxy for field `CHTIF8`"]
pub struct CHTIF8_W<'a> {
    w: &'a mut W,
}
impl<'a> CHTIF8_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CHTIF8_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl<'a> CTEIF8_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CTEIF8_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
