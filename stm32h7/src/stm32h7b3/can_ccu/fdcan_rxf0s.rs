...
pub struct F0G_R(crate::FieldReader<u8, u8>);
impl F0G_R {
    pub(crate) fn new(bits: u8) -> Self {
        F0G_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for F0G_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct F0P_R(crate::FieldReader<u8, u8>);
impl F0P_R {
    pub(crate) fn new(bits: u8) -> Self {
        F0P_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for F0P_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
