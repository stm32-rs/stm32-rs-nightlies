...
impl W {
    ...
    ///Bits 8:14 - Rx FIFO 1 Get Index
    #[inline(always)]
    pub fn f1gi(&mut self) -> F1GI_W<FDCAN_RXF1Srs> {
        F1GI_W::new(self, 8)
    }
    ///Bits 16:22 - Rx FIFO 1 Put Index
    #[inline(always)]
    pub fn f1pi(&mut self) -> F1PI_W<FDCAN_RXF1Srs> {
        F1PI_W::new(self, 16)
    }
    ///Bit 24 - Rx FIFO 1 Full
    #[inline(always)]
    pub fn f1f(&mut self) -> F1F_W<FDCAN_RXF1Srs> {
        F1F_W::new(self, 24)
    }
    ///Bit 25 - Rx FIFO 1 Message Lost
    #[inline(always)]
    pub fn rf1l(&mut self) -> RF1L_W<FDCAN_RXF1Srs> {
        RF1L_W::new(self, 25)
    }
    ///Bits 30:31 - Debug Message Status
    #[inline(always)]
    pub fn dms(&mut self) -> DMS_W<FDCAN_RXF1Srs> {
        DMS_W::new(self, 30)
    }
}
