#[doc = "Reader of register COMP1_CFGR1"]
pub type R = crate::R<u32, super::COMP1_CFGR1>;
#[doc = "Writer for register COMP1_CFGR1"]
pub type W = crate::W<u32, super::COMP1_CFGR1>;
#[doc = "Register COMP1_CFGR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::COMP1_CFGR1 {
    type Type = u32;
    #[inline(always)]
