#[doc = "Writer for register COMP1_ICFR"]
pub type W = crate::W<u32, super::COMP1_ICFR>;
#[doc = "Register COMP1_ICFR `reset()`'s with value 0"]
impl crate::ResetValue for super::COMP1_ICFR {
    type Type = u32;
    #[inline(always)]
