...
///Field `CLRAWLTF(0-7)` reader - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
...
///Field `CLRAWLTF(0-7)` writer - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
...
///Field `CLRAWHTF(0-7)` reader - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
...
///Field `CLRAWHTF(0-7)` writer - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
...
impl R {
    ...
    ///Bit 0 - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawltf0(&self) -> CLRAWLTF_R {
        CLRAWLTF_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawltf1(&self) -> CLRAWLTF_R {
        CLRAWLTF_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawltf2(&self) -> CLRAWLTF_R {
        CLRAWLTF_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawltf3(&self) -> CLRAWLTF_R {
        CLRAWLTF_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawltf4(&self) -> CLRAWLTF_R {
        CLRAWLTF_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawltf5(&self) -> CLRAWLTF_R {
        CLRAWLTF_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawltf6(&self) -> CLRAWLTF_R {
        CLRAWLTF_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Clear the analog watchdog low threshold flag CLRAWLTF\[y\]=0: Writing '0' has no effect CLRAWLTF\[y\]=1: Writing '1' to position y clears the corresponding AWLTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    ...
    ///Bit 8 - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawhtf0(&self) -> CLRAWHTF_R {
        CLRAWHTF_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawhtf1(&self) -> CLRAWHTF_R {
        CLRAWHTF_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawhtf2(&self) -> CLRAWHTF_R {
        CLRAWHTF_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawhtf3(&self) -> CLRAWHTF_R {
        CLRAWHTF_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawhtf4(&self) -> CLRAWHTF_R {
        CLRAWHTF_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawhtf5(&self) -> CLRAWHTF_R {
        CLRAWHTF_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
    pub fn clrawhtf6(&self) -> CLRAWHTF_R {
        CLRAWHTF_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - Clear the analog watchdog high threshold flag CLRAWHTF\[y\]=0: Writing '0' has no effect CLRAWHTF\[y\]=1: Writing '1' to position y clears the corresponding AWHTF\[y\] bit in the DFSDM_FLTxAWSR register
    #[inline(always)]
