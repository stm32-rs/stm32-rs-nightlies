#[doc = "Reader of register GPDR"]
pub type R = crate::R<u32, super::GPDR>;
#[doc = "Writer for register GPDR"]
pub type W = crate::W<u32, super::GPDR>;
#[doc = "Register GPDR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPDR {
    type Type = u32;
    #[inline(always)]
