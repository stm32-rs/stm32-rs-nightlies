#[doc = "Reader of register GPSR"]
pub type R = crate::R<u32, super::GPSR>;
#[doc = "Writer for register GPSR"]
pub type W = crate::W<u32, super::GPSR>;
#[doc = "Register GPSR `reset()`'s with value 0x15"]
impl crate::ResetValue for super::GPSR {
    type Type = u32;
    #[inline(always)]
