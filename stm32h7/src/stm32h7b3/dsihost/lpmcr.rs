#[doc = "Reader of register LPMCR"]
pub type R = crate::R<u32, super::LPMCR>;
#[doc = "Writer for register LPMCR"]
pub type W = crate::W<u32, super::LPMCR>;
#[doc = "Register LPMCR `reset()`'s with value 0"]
impl crate::ResetValue for super::LPMCR {
    type Type = u32;
    #[inline(always)]
