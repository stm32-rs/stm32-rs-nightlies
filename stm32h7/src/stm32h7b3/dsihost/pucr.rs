#[doc = "Reader of register PUCR"]
pub type R = crate::R<u32, super::PUCR>;
#[doc = "Writer for register PUCR"]
pub type W = crate::W<u32, super::PUCR>;
#[doc = "Register PUCR `reset()`'s with value 0"]
impl crate::ResetValue for super::PUCR {
    type Type = u32;
    #[inline(always)]
