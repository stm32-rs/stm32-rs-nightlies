#[doc = "Reader of register TCCR2"]
pub type R = crate::R<u32, super::TCCR2>;
#[doc = "Writer for register TCCR2"]
pub type W = crate::W<u32, super::TCCR2>;
#[doc = "Register TCCR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::TCCR2 {
    type Type = u32;
    #[inline(always)]
