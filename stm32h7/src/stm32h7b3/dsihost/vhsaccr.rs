#[doc = "Reader of register VHSACCR"]
pub type R = crate::R<u32, super::VHSACCR>;
#[doc = "Writer for register VHSACCR"]
pub type W = crate::W<u32, super::VHSACCR>;
#[doc = "Register VHSACCR `reset()`'s with value 0"]
impl crate::ResetValue for super::VHSACCR {
    type Type = u32;
    #[inline(always)]
