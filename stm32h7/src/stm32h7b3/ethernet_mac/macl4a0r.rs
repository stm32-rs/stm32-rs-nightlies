#[doc = "Reader of register MACL4A0R"]
pub type R = crate::R<u32, super::MACL4A0R>;
#[doc = "Writer for register MACL4A0R"]
pub type W = crate::W<u32, super::MACL4A0R>;
#[doc = "Register MACL4A0R `reset()`'s with value 0"]
impl crate::ResetValue for super::MACL4A0R {
    type Type = u32;
    #[inline(always)]
