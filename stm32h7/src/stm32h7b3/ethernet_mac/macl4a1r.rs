#[doc = "Reader of register MACL4A1R"]
pub type R = crate::R<u32, super::MACL4A1R>;
#[doc = "Writer for register MACL4A1R"]
pub type W = crate::W<u32, super::MACL4A1R>;
#[doc = "Register MACL4A1R `reset()`'s with value 0"]
impl crate::ResetValue for super::MACL4A1R {
    type Type = u32;
    #[inline(always)]
