...
impl RegisterBlock {
    #[doc = "0x100 - FDCAN TT Trigger Select Register"]
    #[inline(always)]
    pub fn ttts(&self) -> &TTTS {
        unsafe { &*(((self as *const Self) as *const u8).add(256usize) as *const TTTS) }
    }
    #[doc = "0x100 - FDCAN TT Trigger Select Register"]
    #[inline(always)]
    pub fn ttts_mut(&self) -> &mut TTTS {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(256usize) as *mut TTTS) }
    }
    #[doc = "0x100 - FDCAN TT Trigger Memory Configuration Register"]
    #[inline(always)]
    pub fn tttmc(&self) -> &TTTMC {
        unsafe { &*(((self as *const Self) as *const u8).add(256usize) as *const TTTMC) }
    }
    #[doc = "0x100 - FDCAN TT Trigger Memory Configuration Register"]
    #[inline(always)]
    pub fn tttmc_mut(&self) -> &mut TTTMC {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(256usize) as *mut TTTMC) }
    }
}
