#[doc = "Reader of register TTTS"]
pub type R = crate::R<u32, super::TTTS>;
#[doc = "Writer for register TTTS"]
pub type W = crate::W<u32, super::TTTS>;
#[doc = "Register TTTS `reset()`'s with value 0"]
impl crate::ResetValue for super::TTTS {
    type Type = u32;
    #[inline(always)]
