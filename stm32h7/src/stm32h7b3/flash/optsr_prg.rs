...
impl W {
    ...
    ///Bit 7 - Option byte erase after D1 DStandby option configuration bit
    #[inline(always)]
    pub fn nrst_stdy(&mut self) -> NRST_STDY_W<OPTSR_PRGrs> {
    ...
    ///Bit 16 - VDDMMC_HSLV
    #[inline(always)]
    pub fn vddmmc_hslv(&mut self) -> VDDMMC_HSLV_W<OPTSR_PRGrs> {
        VDDMMC_HSLV_W::new(self, 16)
    }
    ///Bit 17 - IWDG Stop mode freeze option configuration bit
    #[inline(always)]
    pub fn wdg_fz_stop(&mut self) -> WDG_FZ_STOP_W<OPTSR_PRGrs> {
    ...
    ///Bit 29 - VDDIO_HSLV
    #[inline(always)]
    pub fn vddio_hslv(&mut self) -> VDDIO_HSLV_W<OPTSR_PRGrs> {
