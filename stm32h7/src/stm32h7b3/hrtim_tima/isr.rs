...
pub use crate::stm32h7b3::hrtim_master::isr::CMP1;
///Field `CMP(1-4)` reader - Compare %s Interrupt Flag
pub use crate::stm32h7b3::hrtim_master::isr::CMP_R;
///Repetition Interrupt Flag
pub use crate::stm32h7b3::hrtim_master::isr::REP;
///Field `REP` reader - Repetition Interrupt Flag
pub use crate::stm32h7b3::hrtim_master::isr::REP_R;
///Update Interrupt Flag
pub use crate::stm32h7b3::hrtim_master::isr::UPD;
///Field `UPD` reader - Update Interrupt Flag
pub use crate::stm32h7b3::hrtim_master::isr::UPD_R;
