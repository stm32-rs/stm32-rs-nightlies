///Register `CMP1CBR` reader
pub type R = crate::R<CMP1CBRrs>;
///Register `CMP1CBR` writer
pub type W = crate::W<CMP1CBRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1x(&mut self) -> CMP1X_W<CMP1CBRrs> {
        CMP1X_W::new(self, 0)
    }
    ///Bits 16:23 - Timerx Repetition value (aliased from HRTIM_REPx register)
    #[inline(always)]
    #[must_use]
    pub fn repx(&mut self) -> REPX_W<CMP1CBRrs> {
        REPX_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#HRTIM_TIMB:CMP1CBR)*/
pub struct CMP1CBRrs;
impl crate::RegisterSpec for CMP1CBRrs {
    type Ux = u32;
}
///`read()` method returns [`cmp1cbr::R`](R) reader structure
impl crate::Readable for CMP1CBRrs {}
///`write(|w| ..)` method takes [`cmp1cbr::W`](W) writer structure
impl crate::Writable for CMP1CBRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CMP1CBR to value 0
impl crate::Resettable for CMP1CBRrs {
