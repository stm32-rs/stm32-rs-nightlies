...
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMDCMP3_R;
...
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMDCMP3_W;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3.html#HRTIM_TIMB:SET1R)*/
pub struct SET1Rrs;
