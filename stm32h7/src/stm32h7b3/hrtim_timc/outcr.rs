...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#HRTIM_TIMC:OUTCR)*/
pub struct OUTCRrs;
impl crate::RegisterSpec for OUTCRrs {
    type Ux = u32;
}
///`read()` method returns [`outcr::R`](R) reader structure
impl crate::Readable for OUTCRrs {}
///`write(|w| ..)` method takes [`outcr::W`](W) writer structure
impl crate::Writable for OUTCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OUTCR to value 0
