///Register `CPT1ECR` reader
pub type R = crate::R<CPT1ECRrs>;
///Register `CPT1ECR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#HRTIM_TIME:CPT1ECR)*/
pub struct CPT1ECRrs;
impl crate::RegisterSpec for CPT1ECRrs {
    type Ux = u32;
}
///`read()` method returns [`cpt1ecr::R`](R) reader structure
impl crate::Readable for CPT1ECRrs {}
///`write(|w| ..)` method takes [`cpt1ecr::W`](W) writer structure
impl crate::Writable for CPT1ECRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CPT1ECR to value 0
