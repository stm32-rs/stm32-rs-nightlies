...
///Timer A compare %s
pub use crate::stm32h7b3::hrtim_tima::set1r::CMP1;
///Field `CMP(1-4)` reader - Timer A compare %s
pub use crate::stm32h7b3::hrtim_tima::set1r::CMP_R;
///Field `CMP(1-4)` writer - Timer A compare %s
pub use crate::stm32h7b3::hrtim_tima::set1r::CMP_W;
///External Event %s
pub use crate::stm32h7b3::hrtim_tima::set1r::EXTEVNT1;
///Field `EXTEVNT(1-10)` reader - External Event %s
pub use crate::stm32h7b3::hrtim_tima::set1r::EXTEVNT_R;
///Field `EXTEVNT(1-10)` writer - External Event %s
pub use crate::stm32h7b3::hrtim_tima::set1r::EXTEVNT_W;
///Master Compare %s
pub use crate::stm32h7b3::hrtim_tima::set1r::MSTCMP1;
///Field `MSTCMP(1-4)` reader - Master Compare %s
pub use crate::stm32h7b3::hrtim_tima::set1r::MSTCMP_R;
///Field `MSTCMP(1-4)` writer - Master Compare %s
pub use crate::stm32h7b3::hrtim_tima::set1r::MSTCMP_W;
///Master Period
pub use crate::stm32h7b3::hrtim_tima::set1r::MSTPER;
///Field `MSTPER` reader - Master Period
pub use crate::stm32h7b3::hrtim_tima::set1r::MSTPER_R;
///Field `MSTPER` writer - Master Period
pub use crate::stm32h7b3::hrtim_tima::set1r::MSTPER_W;
///Timer A Period
pub use crate::stm32h7b3::hrtim_tima::set1r::PER;
///Field `PER` reader - Timer A Period
pub use crate::stm32h7b3::hrtim_tima::set1r::PER_R;
///Field `PER` writer - Timer A Period
pub use crate::stm32h7b3::hrtim_tima::set1r::PER_W;
///Timer A resynchronizaton
pub use crate::stm32h7b3::hrtim_tima::set1r::RESYNC;
///Field `RESYNC` reader - Timer A resynchronizaton
pub use crate::stm32h7b3::hrtim_tima::set1r::RESYNC_R;
///Field `RESYNC` writer - Timer A resynchronizaton
pub use crate::stm32h7b3::hrtim_tima::set1r::RESYNC_W;
///Software Set trigger
pub use crate::stm32h7b3::hrtim_tima::set1r::SST;
///Field `SST` reader - Software Set trigger
pub use crate::stm32h7b3::hrtim_tima::set1r::SST_R;
///Field `SST` writer - Software Set trigger
pub use crate::stm32h7b3::hrtim_tima::set1r::SST_W;
///Timer A Compare 3
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1;
///Field `TIMACMP3` reader - Timer A Compare 3
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMACMP3_R;
///Field `TIMACMP4` reader - Timer A Compare 4
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMACMP4_R;
///Field `TIMBCMP3` reader - Timer B Compare 3
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMBCMP3_R;
///Field `TIMBCMP4` reader - Timer B Compare 4
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMBCMP4_R;
///Field `TIMCCMP1` reader - Timer C Compare 1
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMCCMP1_R;
///Field `TIMCCMP2` reader - Timer C Compare 2
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMCCMP2_R;
///Field `TIMDCMP1` reader - Timer D Compare 1
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMDCMP1_R;
///Field `TIMDCMP2` reader - Timer D Compare 2
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMDCMP2_R;
///Field `TIMDCMP4` reader - Timer D Compare 4
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_R as TIMDCMP4_R;
///Field `TIMACMP3` writer - Timer A Compare 3
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMACMP3_W;
///Field `TIMACMP4` writer - Timer A Compare 4
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMACMP4_W;
///Field `TIMBCMP3` writer - Timer B Compare 3
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMBCMP3_W;
///Field `TIMBCMP4` writer - Timer B Compare 4
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMBCMP4_W;
///Field `TIMCCMP1` writer - Timer C Compare 1
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMCCMP1_W;
///Field `TIMCCMP2` writer - Timer C Compare 2
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMCCMP2_W;
///Field `TIMDCMP1` writer - Timer D Compare 1
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMDCMP1_W;
///Field `TIMDCMP2` writer - Timer D Compare 2
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMDCMP2_W;
///Field `TIMDCMP4` writer - Timer D Compare 4
pub use crate::stm32h7b3::hrtim_tima::set1r::TIMBCMP1_W as TIMDCMP4_W;
///Registers update (transfer preload to active)
pub use crate::stm32h7b3::hrtim_tima::set1r::UPDATE;
///Field `UPDATE` reader - Registers update (transfer preload to active)
pub use crate::stm32h7b3::hrtim_tima::set1r::UPDATE_R;
///Field `UPDATE` writer - Registers update (transfer preload to active)
pub use crate::stm32h7b3::hrtim_tima::set1r::UPDATE_W;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3.html#HRTIM_TIME:SET1R)*/
pub struct SET1Rrs;
