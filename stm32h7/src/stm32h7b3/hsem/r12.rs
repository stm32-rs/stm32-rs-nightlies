...
#[doc = "`read()` method returns [r12::R](R) reader structure"]
impl crate::Readable for R12_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r12::W](W) writer structure"]
impl crate::Writable for R12_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R12 to value 0"]
