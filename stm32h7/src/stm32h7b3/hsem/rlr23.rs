#[doc = "Register `RLR23` reader"]
pub struct R(crate::R<RLR23_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR23_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR23_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR23_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HSEM Read lock register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rlr23](index.html) module"]
pub struct RLR23_SPEC;
impl crate::RegisterSpec for RLR23_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rlr23::R](R) reader structure"]
impl crate::Readable for RLR23_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RLR23 to value 0"]
impl crate::Resettable for RLR23_SPEC {
    #[inline(always)]
