#[doc = "Reader of register WABR"]
pub type R = crate::R<u32, super::WABR>;
#[doc = "Writer for register WABR"]
pub type W = crate::W<u32, super::WABR>;
#[doc = "Register WABR `reset()`'s with value 0"]
impl crate::ResetValue for super::WABR {
    type Type = u32;
    #[inline(always)]
