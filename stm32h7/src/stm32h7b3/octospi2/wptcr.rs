#[doc = "Reader of register WPTCR"]
pub type R = crate::R<u32, super::WPTCR>;
#[doc = "Writer for register WPTCR"]
pub type W = crate::W<u32, super::WPTCR>;
#[doc = "Register WPTCR `reset()`'s with value 0"]
impl crate::ResetValue for super::WPTCR {
    type Type = u32;
    #[inline(always)]
