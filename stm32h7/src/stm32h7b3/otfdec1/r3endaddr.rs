#[doc = "Reader of register R3ENDADDR"]
pub type R = crate::R<u32, super::R3ENDADDR>;
#[doc = "Writer for register R3ENDADDR"]
pub type W = crate::W<u32, super::R3ENDADDR>;
#[doc = "Register R3ENDADDR `reset()`'s with value 0x0fff"]
impl crate::ResetValue for super::R3ENDADDR {
    type Type = u32;
    #[inline(always)]
