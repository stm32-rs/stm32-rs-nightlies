#[doc = "Reader of register DIEPTXF0_Device"]
pub type R = crate::R<u32, super::DIEPTXF0_DEVICE>;
#[doc = "Writer for register DIEPTXF0_Device"]
pub type W = crate::W<u32, super::DIEPTXF0_DEVICE>;
#[doc = "Register DIEPTXF0_Device `reset()`'s with value 0x0200"]
impl crate::ResetValue for super::DIEPTXF0_DEVICE {
    type Type = u32;
    #[inline(always)]
