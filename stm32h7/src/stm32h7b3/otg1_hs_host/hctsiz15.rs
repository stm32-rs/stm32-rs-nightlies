#[doc = "Reader of register HCTSIZ15"]
pub type R = crate::R<u32, super::HCTSIZ15>;
#[doc = "Writer for register HCTSIZ15"]
pub type W = crate::W<u32, super::HCTSIZ15>;
#[doc = "Register HCTSIZ15 `reset()`'s with value 0"]
impl crate::ResetValue for super::HCTSIZ15 {
    type Type = u32;
    #[inline(always)]
