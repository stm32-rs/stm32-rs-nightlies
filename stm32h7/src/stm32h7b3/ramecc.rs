...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn m4fecr(&self) -> &M4FECR {
        unsafe { &*(((self as *const Self) as *const u8).add(144usize) as *const M4FECR) }
    }
    #[doc = "0x90 - RAMECC monitor x failing ECC error code register"]
    #[inline(always)]
    pub fn m4fecr_mut(&self) -> &mut M4FECR {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(144usize) as *mut M4FECR) }
    }
    #[doc = "0x90 - RAMECC monitor x failing data high register"]
    #[inline(always)]
    pub fn m4fdrh(&self) -> &M4FDRH {
        unsafe { &*(((self as *const Self) as *const u8).add(144usize) as *const M4FDRH) }
    }
    #[doc = "0x90 - RAMECC monitor x failing data high register"]
    #[inline(always)]
    pub fn m4fdrh_mut(&self) -> &mut M4FDRH {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(144usize) as *mut M4FDRH) }
    }
}
