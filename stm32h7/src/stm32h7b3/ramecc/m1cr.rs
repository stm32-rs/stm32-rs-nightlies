#[doc = "Reader of register M1CR"]
pub type R = crate::R<u32, super::M1CR>;
#[doc = "Writer for register M1CR"]
pub type W = crate::W<u32, super::M1CR>;
#[doc = "Register M1CR `reset()`'s with value 0"]
impl crate::ResetValue for super::M1CR {
    type Type = u32;
    #[inline(always)]
