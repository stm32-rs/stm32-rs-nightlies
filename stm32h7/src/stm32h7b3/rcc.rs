...
#[doc = "RCC PLL3 Fractional Divider Register"]
pub mod pll3fracr;
#[doc = "RCC Domain 1 Kernel Clock Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cdccipr](cdccipr) module"]
pub type CDCCIPR = crate::Reg<u32, _CDCCIPR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CDCCIPR;
#[doc = "`read()` method returns [cdccipr::R](cdccipr::R) reader structure"]
impl crate::Readable for CDCCIPR {}
#[doc = "`write(|w| ..)` method takes [cdccipr::W](cdccipr::W) writer structure"]
impl crate::Writable for CDCCIPR {}
#[doc = "RCC Domain 1 Kernel Clock Configuration Register"]
pub mod cdccipr;
#[doc = "RCC Domain 2 Kernel Clock Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cdccip1r](cdccip1r) module"]
pub type CDCCIP1R = crate::Reg<u32, _CDCCIP1R>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CDCCIP1R;
#[doc = "`read()` method returns [cdccip1r::R](cdccip1r::R) reader structure"]
impl crate::Readable for CDCCIP1R {}
#[doc = "`write(|w| ..)` method takes [cdccip1r::W](cdccip1r::W) writer structure"]
impl crate::Writable for CDCCIP1R {}
#[doc = "RCC Domain 2 Kernel Clock Configuration Register"]
pub mod cdccip1r;
#[doc = "RCC Domain 2 Kernel Clock Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cdccip2r](cdccip2r) module"]
pub type CDCCIP2R = crate::Reg<u32, _CDCCIP2R>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CDCCIP2R;
#[doc = "`read()` method returns [cdccip2r::R](cdccip2r::R) reader structure"]
impl crate::Readable for CDCCIP2R {}
#[doc = "`write(|w| ..)` method takes [cdccip2r::W](cdccip2r::W) writer structure"]
impl crate::Writable for CDCCIP2R {}
#[doc = "RCC Domain 2 Kernel Clock Configuration Register"]
pub mod cdccip2r;
#[doc = "RCC Domain 3 Kernel Clock Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [srdccipr](srdccipr) module"]
pub type SRDCCIPR = crate::Reg<u32, _SRDCCIPR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SRDCCIPR;
#[doc = "`read()` method returns [srdccipr::R](srdccipr::R) reader structure"]
impl crate::Readable for SRDCCIPR {}
#[doc = "`write(|w| ..)` method takes [srdccipr::W](srdccipr::W) writer structure"]
impl crate::Writable for SRDCCIPR {}
#[doc = "RCC Domain 3 Kernel Clock Configuration Register"]
pub mod srdccipr;
