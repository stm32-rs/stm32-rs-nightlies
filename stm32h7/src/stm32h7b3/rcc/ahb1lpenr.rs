...
///Field `USB1ULPILPEN` reader - USB_PHY1 clock enable during CSleep mode Set and reset by software.
...
///Field `USB1ULPILPEN` writer - USB_PHY1 clock enable during CSleep mode Set and reset by software.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHB1LPENR")
            ...
            .field("usb1ulpilpen", &self.usb1ulpilpen())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb1ulpilpen(&mut self) -> USB1ULPILPEN_W<AHB1LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#RCC:AHB1LPENR)*/
