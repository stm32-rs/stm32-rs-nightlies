#[doc = "Reader of register APB1HLPENR"]
pub type R = crate::R<u32, super::APB1HLPENR>;
#[doc = "Writer for register APB1HLPENR"]
pub type W = crate::W<u32, super::APB1HLPENR>;
#[doc = "Register APB1HLPENR `reset()`'s with value 0"]
impl crate::ResetValue for super::APB1HLPENR {
    type Type = u32;
    #[inline(always)]
