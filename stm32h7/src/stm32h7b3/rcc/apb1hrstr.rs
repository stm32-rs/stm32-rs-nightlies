...
///Field `SWPMIRST` reader - SWPMI block reset Set and reset by software.
...
///Field `SWPMIRST` writer - SWPMI block reset Set and reset by software.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#RCC:APB1HRSTR)*/
