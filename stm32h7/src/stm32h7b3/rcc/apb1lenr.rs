#[doc = "Reader of register APB1LENR"]
pub type R = crate::R<u32, super::APB1LENR>;
#[doc = "Writer for register APB1LENR"]
pub type W = crate::W<u32, super::APB1LENR>;
#[doc = "Register APB1LENR `reset()`'s with value 0"]
impl crate::ResetValue for super::APB1LENR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 29 - DAC1 (containing two converters) peripheral clock enable"]
    #[inline(always)]
