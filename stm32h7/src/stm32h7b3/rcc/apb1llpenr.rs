...
#[doc = "Register APB1LLPENR `reset()`'s with value 0xe8ff_c3ff"]
...
pub type DAC1LPEN_A = TIM2LPEN_A;
#[doc = "Reader of field `DAC1LPEN`"]
pub type DAC1LPEN_R = crate::R<bool, TIM2LPEN_A>;
#[doc = "Write proxy for field `DAC1LPEN`"]
pub struct DAC1LPEN_W<'a> {
    w: &'a mut W,
}
impl<'a> DAC1LPEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: DAC1LPEN_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl R {
    ...
    #[doc = "Bit 29 - DAC1 (containing two converters) peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn dac1lpen(&self) -> DAC1LPEN_R {
        DAC1LPEN_R::new(((self.bits >> 29) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 29 - DAC1 (containing two converters) peripheral clock enable during CSleep mode"]
    #[inline(always)]
    pub fn dac1lpen(&mut self) -> DAC1LPEN_W {
        DAC1LPEN_W { w: self }
    }
    #[doc = "Bit 30 - UART7 Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
