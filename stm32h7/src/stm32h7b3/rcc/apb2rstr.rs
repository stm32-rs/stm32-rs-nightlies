...
pub type USART10RST_A = TIM1RST_A;
#[doc = "Field `USART10RST` reader - USART10 block reset Set and reset by software."]
pub type USART10RST_R = TIM1RST_R;
#[doc = "Field `USART10RST` writer - USART10 block reset Set and reset by software."]
pub struct USART10RST_W<'a> {
    w: &'a mut W,
}
impl<'a> USART10RST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: USART10RST_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Reset the selected module"]
    #[inline(always)]
    pub fn reset(self) -> &'a mut W {
        self.variant(USART10RST_A::RESET)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn usart10rst(&self) -> USART10RST_R {
        USART10RST_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    ...
    pub fn dfsdm1rst(&self) -> DFSDM1RST_R {
        DFSDM1RST_R::new(((self.bits >> 30) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - TIM1 block reset Set and reset by software."]
    ...
    #[doc = "Bit 7 - USART10 block reset Set and reset by software."]
    #[inline(always)]
    pub fn usart10rst(&mut self) -> USART10RST_W {
        USART10RST_W { w: self }
    }
    #[doc = "Bit 12 - SPI1 block reset Set and reset by software."]
    #[inline(always)]
