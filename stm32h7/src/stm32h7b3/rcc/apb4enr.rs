...
#[doc = "Register APB4ENR `reset()`'s with value 0x0001_0000"]
...
pub type DAC2EN_R = crate::R<bool, SYSCFGEN_A>;
...
impl R {
    ...
    #[doc = "Bit 13 - DAC2 (containing one converter) peripheral clock enable"]
    #[inline(always)]
