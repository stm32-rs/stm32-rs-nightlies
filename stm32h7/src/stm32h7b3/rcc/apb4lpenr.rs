...
#[doc = "Register APB4LPENR `reset()`'s with value 0x0c01_e6aa"]
...
#[doc = "Reader of field `DAC2LPEN`"]
pub type DAC2LPEN_R = crate::R<bool, SYSCFGLPEN_A>;
#[doc = "Write proxy for field `DAC2LPEN`"]
...
impl R {
    ...
    #[doc = "Bit 13 - DAC2 (containing one converter) peripheral clock enable during CSleep mode"]
    #[inline(always)]
