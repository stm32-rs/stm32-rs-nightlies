#[doc = "Reader of register CDCCIP1R"]
pub type R = crate::R<u32, super::CDCCIP1R>;
#[doc = "Writer for register CDCCIP1R"]
pub type W = crate::W<u32, super::CDCCIP1R>;
#[doc = "Register CDCCIP1R `reset()`'s with value 0"]
impl crate::ResetValue for super::CDCCIP1R {
    type Type = u32;
    #[inline(always)]
...
pub type SPDIFRXSEL_R = crate::R<u8, SPDIFRXSEL_A>;
impl SPDIFRXSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Reader of field `SAI2ASEL`"]
pub type SAI2ASEL_R = crate::R<u8, SAI2ASEL_A>;
impl SAI2ASEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, SAI2ASEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(SAI2ASEL_A::PLL1_Q),
            1 => Val(SAI2ASEL_A::PLL2_P),
            2 => Val(SAI2ASEL_A::PLL3_P),
            3 => Val(SAI2ASEL_A::I2S_CKIN),
            4 => Val(SAI2ASEL_A::PER),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `PLL1_Q`"]
...
#[doc = "Write proxy for field `SAI2ASEL`"]
...
#[doc = "Reader of field `SAI2BSEL`"]
pub type SAI2BSEL_R = crate::R<u8, SAI2ASEL_A>;
#[doc = "Write proxy for field `SAI2BSEL`"]
...
impl R {
    ...
    #[doc = "Bits 6:8 - SAI2 kernel clock source A source selection"]
    #[inline(always)]
    pub fn sai2asel(&self) -> SAI2ASEL_R {
        SAI2ASEL_R::new(((self.bits >> 6) & 0x07) as u8)
    }
    #[doc = "Bits 9:11 - SAI2 kernel clock source B source selection"]
    #[inline(always)]
