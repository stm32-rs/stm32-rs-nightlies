#[doc = "Reader of register CDCCIPR"]
pub type R = crate::R<u32, super::CDCCIPR>;
#[doc = "Writer for register CDCCIPR"]
pub type W = crate::W<u32, super::CDCCIPR>;
#[doc = "Register CDCCIPR `reset()`'s with value 0"]
impl crate::ResetValue for super::CDCCIPR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `OCTOSPISEL`"]
pub type OCTOSPISEL_R = crate::R<u8, FMCSEL_A>;
#[doc = "Write proxy for field `OCTOSPISEL`"]
