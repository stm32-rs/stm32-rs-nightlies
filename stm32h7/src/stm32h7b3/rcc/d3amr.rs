...
pub type DAC2AMEN_A = BDMAAMEN_A;
#[doc = "Reader of field `DAC2AMEN`"]
pub type DAC2AMEN_R = crate::R<bool, BDMAAMEN_A>;
#[doc = "Write proxy for field `DAC2AMEN`"]
...
impl R {
    ...
    #[doc = "Bit 13 - DAC2 (containing one converter) Autonomous mode enable"]
    #[inline(always)]
