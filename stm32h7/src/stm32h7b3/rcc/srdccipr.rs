#[doc = "Reader of register SRDCCIPR"]
pub type R = crate::R<u32, super::SRDCCIPR>;
#[doc = "Writer for register SRDCCIPR"]
pub type W = crate::W<u32, super::SRDCCIPR>;
#[doc = "Register SRDCCIPR `reset()`'s with value 0"]
impl crate::ResetValue for super::SRDCCIPR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `DFSDM2SEL`"]
pub type DFSDM2SEL_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DFSDM2SEL`"]
...
impl R {
    ...
    #[doc = "Bit 27 - DFSDM2 kernel clock source selection"]
    #[inline(always)]
