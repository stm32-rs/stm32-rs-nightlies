///Register `TAMP_BKP7R` reader
pub type R = crate::R<TAMP_BKP7Rrs>;
///Register `TAMP_BKP7R` writer
...
You can [`read`](crate::Reg::read) this register and get [`tamp_bkp7r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tamp_bkp7r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`tamp_bkp7r::R`](R) reader structure
impl crate::Readable for TAMP_BKP7Rrs {}
///`write(|w| ..)` method takes [`tamp_bkp7r::W`](W) writer structure
impl crate::Writable for TAMP_BKP7Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TAMP_BKP7R to value 0
