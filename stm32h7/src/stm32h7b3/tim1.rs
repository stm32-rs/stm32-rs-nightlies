...
impl RegisterBlock {
    ...
    ///0x64 - TIM1 Alternate function odfsdm1_breakster 2
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:EGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CCMR1_Output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CCMR1_Input)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CCMR2_Output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CCMR2_Input)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CNT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CCR[1])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:DMAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:RCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:BDTR)
...
pub mod bdtr;
/**CCMR3_Output (rw) register accessor: capture/compare mode register 3 (output mode)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CCMR3_Output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CCR5)
...
///capture/compare register
pub mod ccr5;
/**CRR6 (rw) register accessor: capture/compare register 6

You can [`read`](crate::Reg::read) this register and get [`crr6::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`crr6::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:CRR6)

For information about available fields see [`mod@crr6`]
module*/
pub type CRR6 = crate::Reg<crr6::CRR6rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:AF1)
...
pub mod af1;
/**AF2 (rw) register accessor: TIM1 Alternate function odfsdm1_breakster 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:AF2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B3x.html#TIM1:TISEL)
