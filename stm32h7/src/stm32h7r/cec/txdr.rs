...
///Field `TXD` writer - Tx data TXD is a write-only register containing the data byte to be transmitted.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#CEC:TXDR)*/
pub struct TXDRrs;
