...
/**Field `WLRU` reader - Ratio for WLRU\[3:0\]
arbitration A client gets a portion of the total bandwidth = Ratio(client) / Sum(all ratio) ...*/
pub type WLRU_R = crate::FieldReader;
/**Field `WLRU` writer - Ratio for WLRU\[3:0\]
arbitration A client gets a portion of the total bandwidth = Ratio(client) / Sum(all ratio) ...*/
