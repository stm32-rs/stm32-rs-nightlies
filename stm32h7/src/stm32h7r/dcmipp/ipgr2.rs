...
///Field `PSTART` reader - Request to lock the IP-Plug, to allow reconfiguration. PSTART must be reset to 0 after configuration is completed, to restart the IP-Plug.
pub type PSTART_R = crate::BitReader;
///Field `PSTART` writer - Request to lock the IP-Plug, to allow reconfiguration. PSTART must be reset to 0 after configuration is completed, to restart the IP-Plug.
