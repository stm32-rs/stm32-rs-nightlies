...
/**Field `BSM` reader - Current Byte select mode Modes 10 and 11 work only with EDM \[2:0\]
...
impl R {
    ...
    /**Bits 7:8 - Current Byte select mode Modes 10 and 11 work only with EDM \[2:0\]
    = 000 into the DCMIPP_PRCR register.*/
    #[inline(always)]
