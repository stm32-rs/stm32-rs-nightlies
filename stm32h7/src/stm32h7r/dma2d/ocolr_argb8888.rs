///Register `OCOLR_ARGB8888` reader
pub type R = crate::R<OCOLR_ARGB8888rs>;
///Register `OCOLR_ARGB8888` writer
pub type W = crate::W<OCOLR_ARGB8888rs>;
...
impl W {
    ///Bits 0:7 - Blue value of the output image in ARGB8888 or RGB888
    #[inline(always)]
    pub fn blue(&mut self) -> BLUE_W<'_, OCOLR_ARGB8888rs> {
        BLUE_W::new(self, 0)
    }
    ///Bits 8:15 - Green value of the output image in ARGB8888 or RGB888
    #[inline(always)]
    pub fn green(&mut self) -> GREEN_W<'_, OCOLR_ARGB8888rs> {
        GREEN_W::new(self, 8)
    }
    ///Bits 16:23 - Red value of the output image in ARGB8888 or RGB888 mode
    #[inline(always)]
    pub fn red(&mut self) -> RED_W<'_, OCOLR_ARGB8888rs> {
        RED_W::new(self, 16)
    }
    ///Bits 24:31 - Alpha channel value of the output color in ARGB8888 mode (otherwise reserved)
    #[inline(always)]
    pub fn alpha(&mut self) -> ALPHA_W<'_, OCOLR_ARGB8888rs> {
        ALPHA_W::new(self, 24)
    }
}
/**DMA2D output color register

You can [`read`](crate::Reg::read) this register and get [`ocolr_argb8888::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocolr_argb8888::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#DMA2D:OCOLR_ARGB8888)*/
pub struct OCOLR_ARGB8888rs;
impl crate::RegisterSpec for OCOLR_ARGB8888rs {
    type Ux = u32;
}
///`read()` method returns [`ocolr_argb8888::R`](R) reader structure
impl crate::Readable for OCOLR_ARGB8888rs {}
///`write(|w| ..)` method takes [`ocolr_argb8888::W`](W) writer structure
impl crate::Writable for OCOLR_ARGB8888rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OCOLR_ARGB8888 to value 0
impl crate::Resettable for OCOLR_ARGB8888rs {}
