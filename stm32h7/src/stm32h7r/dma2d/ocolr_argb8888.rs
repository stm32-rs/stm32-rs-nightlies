...
impl W {
    ///Bits 0:7 - Blue value of the output image in ARGB8888 or RGB888
    #[inline(always)]
    pub fn blue(&mut self) -> BLUE_W<OCOLR_ARGB8888rs> {
        BLUE_W::new(self, 0)
    }
    ///Bits 8:15 - Green value of the output image in ARGB8888 or RGB888
    #[inline(always)]
    pub fn green(&mut self) -> GREEN_W<OCOLR_ARGB8888rs> {
        GREEN_W::new(self, 8)
    }
    ///Bits 16:23 - Red value of the output image in ARGB8888 or RGB888 mode
    #[inline(always)]
    pub fn red(&mut self) -> RED_W<OCOLR_ARGB8888rs> {
        RED_W::new(self, 16)
    }
    ///Bits 24:31 - Alpha channel value of the output color in ARGB8888 mode (otherwise reserved)
    #[inline(always)]
    pub fn alpha(&mut self) -> ALPHA_W<OCOLR_ARGB8888rs> {
        ALPHA_W::new(self, 24)
    }
}
