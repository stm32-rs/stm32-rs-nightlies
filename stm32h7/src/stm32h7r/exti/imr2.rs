...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr41(&mut self) -> MR41_W<IMR2rs> {
        MR41_W::new(self, 9)
    }
    ///Bit 10 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr42(&mut self) -> MR42_W<IMR2rs> {
        MR42_W::new(self, 10)
    }
    ///Bit 11 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr43(&mut self) -> MR43_W<IMR2rs> {
        MR43_W::new(self, 11)
    }
    ///Bit 12 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr44(&mut self) -> MR44_W<IMR2rs> {
        MR44_W::new(self, 12)
    }
    ///Bit 13 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr45(&mut self) -> MR45_W<IMR2rs> {
        MR45_W::new(self, 13)
    }
    ///Bit 14 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr46(&mut self) -> MR46_W<IMR2rs> {
        MR46_W::new(self, 14)
    }
    ///Bit 15 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr47(&mut self) -> MR47_W<IMR2rs> {
        MR47_W::new(self, 15)
    }
    ///Bit 16 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr48(&mut self) -> MR48_W<IMR2rs> {
        MR48_W::new(self, 16)
    }
    ///Bit 17 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr49(&mut self) -> MR49_W<IMR2rs> {
        MR49_W::new(self, 17)
    }
    ///Bit 18 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr50(&mut self) -> MR50_W<IMR2rs> {
        MR50_W::new(self, 18)
    }
    ///Bit 19 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr51(&mut self) -> MR51_W<IMR2rs> {
        MR51_W::new(self, 19)
    }
    ///Bit 20 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr52(&mut self) -> MR52_W<IMR2rs> {
        MR52_W::new(self, 20)
    }
    ///Bit 21 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr53(&mut self) -> MR53_W<IMR2rs> {
        MR53_W::new(self, 21)
    }
    ///Bit 22 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr54(&mut self) -> MR54_W<IMR2rs> {
        MR54_W::new(self, 22)
    }
    ///Bit 23 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr55(&mut self) -> MR55_W<IMR2rs> {
        MR55_W::new(self, 23)
    }
    ///Bit 24 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr56(&mut self) -> MR56_W<IMR2rs> {
        MR56_W::new(self, 24)
    }
    ///Bit 25 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr57(&mut self) -> MR57_W<IMR2rs> {
        MR57_W::new(self, 25)
    }
    ///Bit 26 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr58(&mut self) -> MR58_W<IMR2rs> {
        MR58_W::new(self, 26)
    }
    ///Bit 27 - CPU interrupt mask on direct event input i
    #[inline(always)]
    #[must_use]
    pub fn mr59(&mut self) -> MR59_W<IMR2rs> {
        MR59_W::new(self, 27)
    }
}
