...
pub mod bcr1;
/**BTR1 (rw) register accessor: SRAM/NOR-flash chip-select timing registers for bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:BTR1)
...
pub mod btr1;
/**BCR2 (rw) register accessor: SRAM/NOR-flash chip-select control registers for bank 2
...
pub mod bcr2;
/**BTR2 (rw) register accessor: SRAM/NOR-flash chip-select timing registers for bank 2
...
pub mod btr2;
/**BCR3 (rw) register accessor: SRAM/NOR-flash chip-select control registers for bank 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:BCR3)
...
pub mod bcr3;
/**BTR3 (rw) register accessor: SRAM/NOR-flash chip-select timing registers for bank 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:BTR3)
...
pub mod btr3;
/**BCR4 (rw) register accessor: SRAM/NOR-flash chip-select control registers for bank 4
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:BCR4)
...
pub mod bcr4;
/**BTR4 (rw) register accessor: SRAM/NOR-flash chip-select timing registers for bank 4
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:BTR4)
...
pub mod eccr;
/**BWTR1 (rw) register accessor: SRAM/NOR-flash write timing registers for bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:BWTR1)
...
pub mod bwtr1;
/**BWTR2 (rw) register accessor: SRAM/NOR-flash write timing registers for bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:BWTR2)
...
pub mod bwtr2;
/**BWTR3 (rw) register accessor: SRAM/NOR-flash write timing registers for bank 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:BWTR3)
...
pub mod bwtr3;
/**BWTR4 (rw) register accessor: SRAM/NOR-flash write timing registers for bank 4
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:BWTR4)
...
pub mod sdcr2;
/**SDTR1 (rw) register accessor: SDRAM Timing registers for SDRAM memory bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:SDTR1)
...
pub mod sdtr1;
/**SDTR2 (rw) register accessor: SDRAM Timing registers for SDRAM memory bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:SDTR2)
