...
///Field `ECC` reader - ECC result This field contains the value computed by the ECC computation logic. Table 184 describes the contents of these bitfields.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#FMC:ECCR)*/
pub struct ECCRrs;
