...
///Field `EV1EN` reader - event 1 enable This bit enables the complex event 1 generation.
pub type EV1EN_R = crate::BitReader;
///Field `EV1EN` writer - event 1 enable This bit enables the complex event 1 generation.
pub type EV1EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EV2EN` reader - event 2 enable This bit enables the complex event 2 generation.
pub type EV2EN_R = crate::BitReader;
///Field `EV2EN` writer - event 2 enable This bit enables the complex event 2 generation.
pub type EV2EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EV3EN` reader - event 3 enable This bit enables the complex event 3 generation.
pub type EV3EN_R = crate::BitReader;
///Field `EV3EN` writer - event 3 enable This bit enables the complex event 3 generation.
pub type EV3EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EV4EN` reader - event 4 enable This bit enables the complex event 4 generation.
pub type EV4EN_R = crate::BitReader;
///Field `EV4EN` writer - event 4 enable This bit enables the complex event 4 generation.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#GFXTIM:EVCR)*/
pub struct EVCRrs;
