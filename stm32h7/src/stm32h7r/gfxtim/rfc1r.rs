...
///Field `FRAME` reader - frame number Current value of the relative frame counter 1.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#GFXTIM:RFC1R)*/
pub struct RFC1Rrs;
