...
///Field `AFCEN` writer - absolute frame counter enable This bit enables the absolute frame counter.
pub type AFCEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FAFCR` writer - force absolute frame counter reset This bit forces the reset of the absolute frame counter.
pub type FAFCR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ALCEN` writer - absolute line counter enable This bit enables the absolute line counter.
pub type ALCEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FALCR` writer - force absolute line counter reset This bit forces the reset of the absolute line counter.
pub type FALCR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RFC1EN` writer - relative frame counter 1 enable This bit enables the relative frame counter 1.
pub type RFC1EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RFC1CM` reader - relative frame counter 1 continuous mode This bit enables the continuous mode of the relative frame counter 1.
pub type RFC1CM_R = crate::BitReader;
///Field `RFC1CM` writer - relative frame counter 1 continuous mode This bit enables the continuous mode of the relative frame counter 1.
pub type RFC1CM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FRFC1R` writer - force relative frame counter 1 reload This bit forces the reload of the relative frame counter 1.
pub type FRFC1R_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RFC2EN` writer - relative frame counter 2 enable This bit enables the relative frame counter 2.
pub type RFC2EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RFC2CM` reader - relative frame counter 2 continuous mode This bit enables the continuous mode of the relative frame counter 2.
pub type RFC2CM_R = crate::BitReader;
///Field `RFC2CM` writer - relative frame counter 2 continuous mode This bit enables the continuous mode of the relative frame counter 2.
pub type RFC2CM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FRFC2R` writer - force relative frame counter 2 reload This bit forces the reload of the relative frame counter 2.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#GFXTIM:TCR)*/
pub struct TCRrs;
