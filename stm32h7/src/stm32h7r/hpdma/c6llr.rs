///Register `C6LLR` reader
pub type R = crate::R<C6LLRrs>;
///Register `C6LLR` writer
...
You can [`read`](crate::Reg::read) this register and get [`c6llr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c6llr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`c6llr::R`](R) reader structure
impl crate::Readable for C6LLRrs {}
///`write(|w| ..)` method takes [`c6llr::W`](W) writer structure
impl crate::Writable for C6LLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets C6LLR to value 0
