...
impl CH {
    ///0x00 - HPDMA channel 0 linked-list base address register
    #[inline(always)]
    pub const fn lbar(&self) -> &LBAR {
        &self.lbar
    }
    ///0x0c - HPDMA channel 0 flag clear register
    #[inline(always)]
    pub const fn fcr(&self) -> &FCR {
        &self.fcr
    }
    ///0x10 - HPDMA channel 0 status register
    #[inline(always)]
    pub const fn sr(&self) -> &SR {
        &self.sr
    }
    ///0x14 - HPDMA channel 0 control register
    #[inline(always)]
    pub const fn cr(&self) -> &CR {
        &self.cr
    }
    ///0x40 - HPDMA channel 0 transfer register 1
    #[inline(always)]
    pub const fn tr1(&self) -> &TR1 {
        &self.tr1
    }
    ///0x44 - HPDMA channel 0 transfer register 2
    #[inline(always)]
    pub const fn tr2(&self) -> &TR2 {
        &self.tr2
    }
    ///0x48 - HPDMA channel 0 block register 1
    #[inline(always)]
    pub const fn br1(&self) -> &BR1 {
        &self.br1
    }
    ///0x4c - HPDMA channel 0 source address register
    #[inline(always)]
    pub const fn sar(&self) -> &SAR {
        &self.sar
    }
    ///0x50 - HPDMA channel 0 destination address register
    #[inline(always)]
    pub const fn dar(&self) -> &DAR {
        &self.dar
    }
    ///0x7c - HPDMA channel 0 linked-list address register
    #[inline(always)]
    pub const fn llr(&self) -> &LLR {
        &self.llr
    }
}
/**LBAR (rw) register accessor: HPDMA channel 0 linked-list base address register
...
For information about available fields see [`mod@lbar`]
module*/
pub type LBAR = crate::Reg<lbar::LBARrs>;
///HPDMA channel 0 linked-list base address register
pub mod lbar;
/**FCR (w) register accessor: HPDMA channel 0 flag clear register
...
pub mod fcr;
/**SR (r) register accessor: HPDMA channel 0 status register
...
pub mod sr;
/**CR (rw) register accessor: HPDMA channel 0 control register
...
pub mod cr;
/**TR1 (rw) register accessor: HPDMA channel 0 transfer register 1
...
pub mod tr1;
/**TR2 (rw) register accessor: HPDMA channel 0 transfer register 2
...
pub mod tr2;
/**BR1 (rw) register accessor: HPDMA channel 0 block register 1
...
For information about available fields see [`mod@br1`]
module*/
pub type BR1 = crate::Reg<br1::BR1rs>;
///HPDMA channel 0 block register 1
pub mod br1;
/**SAR (rw) register accessor: HPDMA channel 0 source address register
...
pub mod sar;
/**DAR (rw) register accessor: HPDMA channel 0 destination address register
...
pub mod dar;
/**LLR (rw) register accessor: HPDMA channel 0 linked-list address register
...
For information about available fields see [`mod@llr`]
module*/
