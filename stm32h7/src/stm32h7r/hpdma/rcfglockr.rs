...
///Field `LOCK0` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK0_R = crate::BitReader;
///Field `LOCK0` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK1` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK1_R = crate::BitReader;
///Field `LOCK1` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK2` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK2_R = crate::BitReader;
///Field `LOCK2` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK3` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK3_R = crate::BitReader;
///Field `LOCK3` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK4` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK4_R = crate::BitReader;
///Field `LOCK4` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK5` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK5_R = crate::BitReader;
///Field `LOCK5` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK6` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK6_R = crate::BitReader;
///Field `LOCK6` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK7` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK7_R = crate::BitReader;
///Field `LOCK7` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK8` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK8_R = crate::BitReader;
///Field `LOCK8` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK9` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK9_R = crate::BitReader;
///Field `LOCK9` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK10` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK10_R = crate::BitReader;
///Field `LOCK10` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK11` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK11_R = crate::BitReader;
///Field `LOCK11` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK12` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK12_R = crate::BitReader;
///Field `LOCK12` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK13` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK13_R = crate::BitReader;
///Field `LOCK13` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK14` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK14_R = crate::BitReader;
///Field `LOCK14` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOCK15` reader - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
pub type LOCK15_R = crate::BitReader;
///Field `LOCK15` writer - lock the configuration of HPDMA_PRIVCFGR.PRIVx until a global HPDMA reset This bit is cleared after reset and, once set, it cannot be reset until a global HPDMA reset.
