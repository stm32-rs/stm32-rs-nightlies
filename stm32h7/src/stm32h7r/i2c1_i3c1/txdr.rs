...
///Field `TXDATA` reader - 8-bit transmit data Data byte to be transmitted to the I<sup>2</sup>C bus Note: These bits can be written only when TXE = 1.
pub type TXDATA_R = crate::FieldReader;
///Field `TXDATA` writer - 8-bit transmit data Data byte to be transmitted to the I<sup>2</sup>C bus Note: These bits can be written only when TXE = 1.
