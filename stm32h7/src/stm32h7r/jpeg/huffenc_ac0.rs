...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hcode0(&mut self) -> HCODE0_W<HUFFENC_AC0rs> {
        HCODE0_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 0 Number of bits in the Huffman code HCODE0 minus 1.
    #[inline(always)]
    #[must_use]
    pub fn hlen0(&mut self) -> HLEN0_W<HUFFENC_AC0rs> {
        HLEN0_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 1 8 least significant bits of the Huffman code. If the Huffman code is less than 8 bits long, the unused bits must be 0.
    #[inline(always)]
    #[must_use]
    pub fn hcode1(&mut self) -> HCODE1_W<HUFFENC_AC0rs> {
        HCODE1_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 1 Number of bits in the Huffman code HCODE1 minus 1.
    #[inline(always)]
    #[must_use]
    pub fn hlen1(&mut self) -> HLEN1_W<HUFFENC_AC0rs> {
        HLEN1_W::new(self, 24)
    }
}
