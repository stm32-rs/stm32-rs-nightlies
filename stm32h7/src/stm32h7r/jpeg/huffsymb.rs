...
impl W {
    ///Bits 0:7 - Data 0 Huffman symbol.
    #[inline(always)]
    pub fn data0(&mut self) -> DATA0_W<HUFFSYMBrs> {
        DATA0_W::new(self, 0)
    }
    ///Bits 8:15 - Data 1 Huffman symbol.
    #[inline(always)]
    pub fn data1(&mut self) -> DATA1_W<HUFFSYMBrs> {
        DATA1_W::new(self, 8)
    }
    ///Bits 16:23 - Data 2 Huffman symbol.
    #[inline(always)]
    pub fn data2(&mut self) -> DATA2_W<HUFFSYMBrs> {
        DATA2_W::new(self, 16)
    }
    ///Bits 24:31 - Data 3 Huffman symbol.
    #[inline(always)]
    pub fn data3(&mut self) -> DATA3_W<HUFFSYMBrs> {
        DATA3_W::new(self, 24)
    }
}
/**JPEG Huffman symbol
