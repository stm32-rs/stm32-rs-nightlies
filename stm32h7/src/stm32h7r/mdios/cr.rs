...
///Field `WRIE` reader - register write interrupt enable Note: When this bit is set, an interrupt is generated if any of the read flags (WRF\[31:0\] in the MDIOS_WRFR register) is set.
pub type WRIE_R = crate::BitReader;
///Field `WRIE` writer - register write interrupt enable Note: When this bit is set, an interrupt is generated if any of the read flags (WRF\[31:0\] in the MDIOS_WRFR register) is set.
pub type WRIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RDIE` reader - register read interrupt enable Note: When this bit is set, an interrupt is generated if any of the read flags (RDF\[31:0\] in the MDIOS_RDFR register) is set.
pub type RDIE_R = crate::BitReader;
///Field `RDIE` writer - register read interrupt enable Note: When this bit is set, an interrupt is generated if any of the read flags (RDF\[31:0\] in the MDIOS_RDFR register) is set.
