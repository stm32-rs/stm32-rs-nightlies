...
///Field `CWRF` reader - clear the write flag Writing 1 to CWRFx clears the WRFx bit in the MDIOS_WRF register.
pub type CWRF_R = crate::FieldReader<u32>;
///Field `CWRF` writer - clear the write flag Writing 1 to CWRFx clears the WRFx bit in the MDIOS_WRF register.
