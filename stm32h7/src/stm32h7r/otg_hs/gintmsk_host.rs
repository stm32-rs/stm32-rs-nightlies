...
impl W {
    ///Bit 1 - Mode mismatch interrupt mask
    #[inline(always)]
    pub fn mmism(&mut self) -> MMISM_W<'_, GINTMSK_HOSTrs> {
        MMISM_W::new(self, 1)
    }
    ///Bit 2 - OTG interrupt mask
    #[inline(always)]
    pub fn otgint(&mut self) -> OTGINT_W<'_, GINTMSK_HOSTrs> {
        OTGINT_W::new(self, 2)
    }
    ///Bit 3 - Start of frame mask
    #[inline(always)]
    pub fn sofm(&mut self) -> SOFM_W<'_, GINTMSK_HOSTrs> {
        SOFM_W::new(self, 3)
    }
    ///Bit 4 - Receive FIFO non-empty mask
    #[inline(always)]
    pub fn rxflvlm(&mut self) -> RXFLVLM_W<'_, GINTMSK_HOSTrs> {
        RXFLVLM_W::new(self, 4)
    }
    ///Bit 5 - Non-periodic Tx FIFO empty mask
    #[inline(always)]
    pub fn nptxfem(&mut self) -> NPTXFEM_W<'_, GINTMSK_HOSTrs> {
        NPTXFEM_W::new(self, 5)
    }
    ///Bit 21 - Incomplete periodic transfer mask
    #[inline(always)]
    pub fn ipxfrm(&mut self) -> IPXFRM_W<'_, GINTMSK_HOSTrs> {
        IPXFRM_W::new(self, 21)
    }
    ///Bit 25 - Host channels interrupt mask
    #[inline(always)]
    pub fn hcim(&mut self) -> HCIM_W<'_, GINTMSK_HOSTrs> {
        HCIM_W::new(self, 25)
    }
    ///Bit 26 - Periodic Tx FIFO empty mask
    #[inline(always)]
    pub fn ptxfem(&mut self) -> PTXFEM_W<'_, GINTMSK_HOSTrs> {
        PTXFEM_W::new(self, 26)
    }
    ///Bit 27 - LPM interrupt mask
    #[inline(always)]
    pub fn lpmintm(&mut self) -> LPMINTM_W<'_, GINTMSK_HOSTrs> {
        LPMINTM_W::new(self, 27)
    }
    ///Bit 28 - Connector ID status change mask
    #[inline(always)]
    pub fn cidschgm(&mut self) -> CIDSCHGM_W<'_, GINTMSK_HOSTrs> {
        CIDSCHGM_W::new(self, 28)
    }
    ///Bit 29 - Disconnect detected interrupt mask
    #[inline(always)]
    pub fn discint(&mut self) -> DISCINT_W<'_, GINTMSK_HOSTrs> {
        DISCINT_W::new(self, 29)
    }
    ///Bit 30 - Session request/new session detected interrupt mask
    #[inline(always)]
    pub fn srqim(&mut self) -> SRQIM_W<'_, GINTMSK_HOSTrs> {
        SRQIM_W::new(self, 30)
    }
    ///Bit 31 - Resume/remote wakeup detected interrupt mask
    #[inline(always)]
    pub fn wuim(&mut self) -> WUIM_W<'_, GINTMSK_HOSTrs> {
        WUIM_W::new(self, 31)
    }
}
