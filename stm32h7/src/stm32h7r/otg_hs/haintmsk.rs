...
///Field `HAINTM` reader - Channel interrupt mask One bit per channel: Bit 0 for channel 0, bit 15 for channel 15
pub type HAINTM_R = crate::FieldReader<u16>;
///Field `HAINTM` writer - Channel interrupt mask One bit per channel: Bit 0 for channel 0, bit 15 for channel 15
