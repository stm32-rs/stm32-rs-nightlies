...
///Field `PTXSA` reader - Host periodic Tx FIFO start address This field configures the memory start address for periodic transmit FIFO RAM.
pub type PTXSA_R = crate::FieldReader<u16>;
///Field `PTXSA` writer - Host periodic Tx FIFO start address This field configures the memory start address for periodic transmit FIFO RAM.
pub type PTXSA_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `PTXFSIZ` reader - Host periodic Tx FIFO depth This value is in terms of 32-bit words. Minimum value is 16
pub type PTXFSIZ_R = crate::FieldReader<u16>;
///Field `PTXFSIZ` writer - Host periodic Tx FIFO depth This value is in terms of 32-bit words. Minimum value is 16
...
impl W {
    ...
    ///Bits 16:31 - Host periodic Tx FIFO depth This value is in terms of 32-bit words. Minimum value is 16
    #[inline(always)]
    pub fn ptxfsiz(&mut self) -> PTXFSIZ_W<'_, HPTXFSIZrs> {
...
///`reset()` method sets HPTXFSIZ to value 0x0400_0800
