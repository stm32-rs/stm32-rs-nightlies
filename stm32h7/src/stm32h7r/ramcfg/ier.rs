...
///Field `GIE` reader - Global interrupt enable When GIE bit is set to 1, an interrupt is generated when an enabled global ECC error (GECCDEBWIE, GECCDEIE or GECCSEIE) occurs.
pub type GIE_R = crate::BitReader;
///Field `GIE` writer - Global interrupt enable When GIE bit is set to 1, an interrupt is generated when an enabled global ECC error (GECCDEBWIE, GECCDEIE or GECCSEIE) occurs.
pub type GIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GECCSEIE` reader - Global ECC single error interrupt enable When GECCSEIE bit is set to 1, an interrupt is generated when an ECC single error occurs during a read operation from RAM.
pub type GECCSEIE_R = crate::BitReader;
///Field `GECCSEIE` writer - Global ECC single error interrupt enable When GECCSEIE bit is set to 1, an interrupt is generated when an ECC single error occurs during a read operation from RAM.
pub type GECCSEIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GECCDEIE` reader - Global ECC double error interrupt enable When GECCDEIE bit is set to 1, an interrupt is generated when an ECC double detection error occurs during a read operation from RAM.
pub type GECCDEIE_R = crate::BitReader;
///Field `GECCDEIE` writer - Global ECC double error interrupt enable When GECCDEIE bit is set to 1, an interrupt is generated when an ECC double detection error occurs during a read operation from RAM.
pub type GECCDEIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GECCDEBWIE` reader - Global ECC double error on byte write (BW) interrupt enable When GECCDEBWIE bit is set to 1, an interrupt is generated when an ECC double detection error occurs during a byte write operation to RAM (incomplete word write).
pub type GECCDEBWIE_R = crate::BitReader;
///Field `GECCDEBWIE` writer - Global ECC double error on byte write (BW) interrupt enable When GECCDEBWIE bit is set to 1, an interrupt is generated when an ECC double detection error occurs during a byte write operation to RAM (incomplete word write).
