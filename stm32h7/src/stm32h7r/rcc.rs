...
impl RegisterBlock {
    ...
    ///0x180 - RCC APB5 sleep clock register
    #[inline(always)]
...
For information about available fields see [`mod@cdcfgr`]
module*/
...
For information about available fields see [`mod@bmcfgr`]
module*/
...
For information about available fields see [`mod@pll1divr1`]
module*/
...
For information about available fields see [`mod@pll2divr1`]
module*/
...
For information about available fields see [`mod@pll3divr1`]
module*/
...
For information about available fields see [`mod@ahb5rstr`]
module*/
...
For information about available fields see [`mod@apb5rstr`]
module*/
pub type APB5RSTR = crate::Reg<apb5rstr::APB5RSTRrs>;
///RCC APB5 peripheral reset register
pub mod apb5rstr;
/**APB1LRSTR (rw) register accessor: RCC APB1 peripheral reset register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#RCC:APB1LRSTR)
...
pub mod apb1lrstr;
/**APB1HRSTR (rw) register accessor: RCC APB1 peripheral reset register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#RCC:APB1HRSTR)
...
For information about available fields see [`mod@ckgdisr`]
module*/
...
For information about available fields see [`mod@pll1divr2`]
module*/
...
For information about available fields see [`mod@pll2divr2`]
module*/
...
For information about available fields see [`mod@pll3divr2`]
module*/
...
For information about available fields see [`mod@pll1sscgr`]
module*/
...
For information about available fields see [`mod@pll2sscgr`]
module*/
...
For information about available fields see [`mod@pll3sscgr`]
module*/
...
For information about available fields see [`mod@ckprotr`]
module*/
...
For information about available fields see [`mod@ahb5enr`]
module*/
...
For information about available fields see [`mod@apb5enr`]
module*/
pub type APB5ENR = crate::Reg<apb5enr::APB5ENRrs>;
///RCC APB5 clock enable register
pub mod apb5enr;
/**APB1LENR (rw) register accessor: RCC APB1 clock enable register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#RCC:APB1LENR)
...
pub mod apb1lenr;
/**APB1HENR (rw) register accessor: RCC APB1 clock enable register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#RCC:APB1HENR)
...
For information about available fields see [`mod@ahb5lpenr`]
module*/
...
pub mod ahb3lpenr;
/**APB1LLPENR (rw) register accessor: RCC APB1 low-power clock enable register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#RCC:APB1LLPENR)
...
pub mod apb1llpenr;
/**APB1HLPENR (rw) register accessor: RCC APB1 low-power clock enable register 2
...
pub mod apb4lpenr;
/**APB5LPENR (rw) register accessor: RCC APB5 sleep clock register
...
For information about available fields see [`mod@apb5lpenr`]
module*/
