...
///Field `GPDMA1LPEN` reader - GPDMA1 clock enable in low-power mode Set and reset by software.
...
///Field `GPDMA1LPEN` writer - GPDMA1 clock enable in low-power mode Set and reset by software.
...
///Field `ADC12LPEN` reader - ADC1 and 2 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the ADC1 and 2 are the kernel clock selected by ADCSEL and provided to ADCx_CK input, and the rcc_hclk1 bus interface clock.
pub use GPDMA1LPEN_R as ADC12LPEN_R;
///Field `ETH1MACLPEN` reader - ETH1 MAC peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_R as ETH1MACLPEN_R;
///Field `ETH1TXLPEN` reader - ETH1 transmission peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_R as ETH1TXLPEN_R;
///Field `ETH1RXLPEN` reader - ETH1 reception peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_R as ETH1RXLPEN_R;
///Field `ADC12LPEN` writer - ADC1 and 2 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the ADC1 and 2 are the kernel clock selected by ADCSEL and provided to ADCx_CK input, and the rcc_hclk1 bus interface clock.
pub use GPDMA1LPEN_W as ADC12LPEN_W;
///Field `ETH1MACLPEN` writer - ETH1 MAC peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_W as ETH1MACLPEN_W;
///Field `ETH1TXLPEN` writer - ETH1 transmission peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_W as ETH1TXLPEN_W;
///Field `ETH1RXLPEN` writer - ETH1 reception peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_W as ETH1RXLPEN_W;
///Field `USBPDCTRL` reader - USBPHYC common block power-down control Set and reset by software.
pub type USBPDCTRL_R = crate::BitReader;
///Field `USBPDCTRL` writer - USBPHYC common block power-down control Set and reset by software.
pub type USBPDCTRL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OTGHSLPEN` reader - OTGHS peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_R as OTGHSLPEN_R;
///Field `USBPHYCLPEN` reader - USBPHYC peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_R as USBPHYCLPEN_R;
///Field `OTGFSLPEN` reader - OTGFS clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_R as OTGFSLPEN_R;
///Field `ADFLPEN` reader - ADF clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_R as ADFLPEN_R;
///Field `OTGHSLPEN` writer - OTGHS peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_W as OTGHSLPEN_W;
///Field `USBPHYCLPEN` writer - USBPHYC peripheral clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_W as USBPHYCLPEN_W;
///Field `OTGFSLPEN` writer - OTGFS clock enable in low-power mode Set and reset by software.
pub use GPDMA1LPEN_W as OTGFSLPEN_W;
///Field `ADFLPEN` writer - ADF clock enable in low-power mode Set and reset by software.
