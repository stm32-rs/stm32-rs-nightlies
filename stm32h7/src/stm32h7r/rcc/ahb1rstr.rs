...
///Field `GPDMA1RST` reader - GPDMA1 blocks reset Set and reset by software.
...
///Field `GPDMA1RST` writer - GPDMA1 blocks reset Set and reset by software.
...
///Field `ETH1MACRST` reader - ETH1 block reset Set and reset by software.
pub use GPDMA1RST_R as ETH1MACRST_R;
///Field `OTGHSRST` reader - OTGHS block reset Set and reset by software.
pub use GPDMA1RST_R as OTGHSRST_R;
///Field `USBPHYCRST` reader - USBPHYC block reset Set and reset by software.
pub use GPDMA1RST_R as USBPHYCRST_R;
///Field `OTGFSRST` reader - OTGFS block reset Set and reset by software.
pub use GPDMA1RST_R as OTGFSRST_R;
///Field `ADFRST` reader - ADF block reset Set and reset by software.
...
///Field `ETH1MACRST` writer - ETH1 block reset Set and reset by software.
pub use GPDMA1RST_W as ETH1MACRST_W;
///Field `OTGHSRST` writer - OTGHS block reset Set and reset by software.
pub use GPDMA1RST_W as OTGHSRST_W;
///Field `USBPHYCRST` writer - USBPHYC block reset Set and reset by software.
pub use GPDMA1RST_W as USBPHYCRST_W;
///Field `OTGFSRST` writer - OTGFS block reset Set and reset by software.
pub use GPDMA1RST_W as OTGFSRST_W;
///Field `ADFRST` writer - ADF block reset Set and reset by software.
