...
///Field `PSSILPEN` reader - PSSI peripheral clock enable in low-power mode Set and reset by software.
...
///Field `PSSILPEN` writer - PSSI peripheral clock enable in low-power mode Set and reset by software.
...
///Field `SDMMC2LPEN` reader - SDMMC2 and SDMMC2 delay clock enable in low-power mode Set and reset by software.
pub use PSSILPEN_R as SDMMC2LPEN_R;
///Field `CORDICLPEN` reader - CORDIC clock enable in low-power mode Set and reset by software.
pub use PSSILPEN_R as CORDICLPEN_R;
///Field `SRAM1LPEN` reader - SRAM1 clock enable in low-power mode Set and reset by software.
pub use PSSILPEN_R as SRAM1LPEN_R;
///Field `SRAM2LPEN` reader - SRAM2 clock enable in low-power mode Set and reset by software.
pub use PSSILPEN_R as SRAM2LPEN_R;
///Field `SDMMC2LPEN` writer - SDMMC2 and SDMMC2 delay clock enable in low-power mode Set and reset by software.
pub use PSSILPEN_W as SDMMC2LPEN_W;
///Field `CORDICLPEN` writer - CORDIC clock enable in low-power mode Set and reset by software.
pub use PSSILPEN_W as CORDICLPEN_W;
///Field `SRAM1LPEN` writer - SRAM1 clock enable in low-power mode Set and reset by software.
pub use PSSILPEN_W as SRAM1LPEN_W;
///Field `SRAM2LPEN` writer - SRAM2 clock enable in low-power mode Set and reset by software.
