...
///Field `GPIOMEN` reader - GPIOM peripheral clock enable Set and reset by software.
pub use GPIOAEN_R as GPIOMEN_R;
///Field `GPIONEN` reader - GPION peripheral clock enable Set and reset by software.
pub use GPIOAEN_R as GPIONEN_R;
///Field `GPIOOEN` reader - GPIOO peripheral clock enable Set and reset by software.
pub use GPIOAEN_R as GPIOOEN_R;
///Field `GPIOPEN` reader - GPIOP peripheral clock enable Set and reset by software.
...
///Field `GPIOMEN` writer - GPIOM peripheral clock enable Set and reset by software.
pub use GPIOAEN_W as GPIOMEN_W;
///Field `GPIONEN` writer - GPION peripheral clock enable Set and reset by software.
pub use GPIOAEN_W as GPIONEN_W;
///Field `GPIOOEN` writer - GPIOO peripheral clock enable Set and reset by software.
pub use GPIOAEN_W as GPIOOEN_W;
///Field `GPIOPEN` writer - GPIOP peripheral clock enable Set and reset by software.
