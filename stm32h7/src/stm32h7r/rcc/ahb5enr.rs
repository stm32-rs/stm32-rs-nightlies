...
///Field `HPDMA1EN` reader - HPDMA1 peripheral clock enable Set and reset by software.
...
///Field `HPDMA1EN` writer - HPDMA1 peripheral clock enable Set and reset by software.
...
///Field `JPEGEN` reader - JPEG peripheral clock enable Set and reset by software.
pub use HPDMA1EN_R as JPEGEN_R;
///Field `FMCEN` reader - FMC and MCE3 peripheral clocks enable Set and reset by software. The hardware prevents writing this bit if FMCCKP = 1. The peripheral clocks of the FMC are the kernel clock selected by FMCSEL, and the hclk5 bus interface clock.
pub use HPDMA1EN_R as FMCEN_R;
///Field `XSPI1EN` reader - XSPI1 and MCE1 peripheral clocks enable Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
pub use HPDMA1EN_R as XSPI1EN_R;
///Field `SDMMC1EN` reader - SDMMC1 and DB_SDMMC1 peripheral clocks enable Set and reset by software.
pub use HPDMA1EN_R as SDMMC1EN_R;
///Field `XSPI2EN` reader - XSPI2 and MCE2 peripheral clocks enable Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
pub use HPDMA1EN_R as XSPI2EN_R;
///Field `XSPIMEN` reader - XSPIM peripheral clock enable Set and reset by software.
pub use HPDMA1EN_R as XSPIMEN_R;
///Field `GFXMMUEN` reader - GFXMMU peripheral clock enable Set and reset by software.
pub use HPDMA1EN_R as GFXMMUEN_R;
///Field `GPUEN` reader - GPU peripheral clock enable Set and reset by software.
pub use HPDMA1EN_R as GPUEN_R;
///Field `DMA2DEN` writer - DMA2D peripheral clock enable Set and reset by software.
pub use HPDMA1EN_W as DMA2DEN_W;
///Field `JPEGEN` writer - JPEG peripheral clock enable Set and reset by software.
pub use HPDMA1EN_W as JPEGEN_W;
///Field `FMCEN` writer - FMC and MCE3 peripheral clocks enable Set and reset by software. The hardware prevents writing this bit if FMCCKP = 1. The peripheral clocks of the FMC are the kernel clock selected by FMCSEL, and the hclk5 bus interface clock.
pub use HPDMA1EN_W as FMCEN_W;
///Field `XSPI1EN` writer - XSPI1 and MCE1 peripheral clocks enable Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
pub use HPDMA1EN_W as XSPI1EN_W;
///Field `SDMMC1EN` writer - SDMMC1 and DB_SDMMC1 peripheral clocks enable Set and reset by software.
pub use HPDMA1EN_W as SDMMC1EN_W;
///Field `XSPI2EN` writer - XSPI2 and MCE2 peripheral clocks enable Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
pub use HPDMA1EN_W as XSPI2EN_W;
///Field `XSPIMEN` writer - XSPIM peripheral clock enable Set and reset by software.
pub use HPDMA1EN_W as XSPIMEN_W;
///Field `GFXMMUEN` writer - GFXMMU peripheral clock enable Set and reset by software.
pub use HPDMA1EN_W as GFXMMUEN_W;
///Field `GPUEN` writer - GPU peripheral clock enable Set and reset by software.
pub use HPDMA1EN_W as GPUEN_W;
impl R {
...
impl W {
    ///Bit 0 - HPDMA1 peripheral clock enable Set and reset by software.
    #[inline(always)]
    pub fn hpdma1en(&mut self) -> HPDMA1EN_W<AHB5ENRrs> {
        HPDMA1EN_W::new(self, 0)
    }
    ///Bit 1 - DMA2D peripheral clock enable Set and reset by software.
    #[inline(always)]
    pub fn dma2den(&mut self) -> DMA2DEN_W<AHB5ENRrs> {
        DMA2DEN_W::new(self, 1)
    }
    ///Bit 3 - JPEG peripheral clock enable Set and reset by software.
    #[inline(always)]
    pub fn jpegen(&mut self) -> JPEGEN_W<AHB5ENRrs> {
        JPEGEN_W::new(self, 3)
    }
    ///Bit 4 - FMC and MCE3 peripheral clocks enable Set and reset by software. The hardware prevents writing this bit if FMCCKP = 1. The peripheral clocks of the FMC are the kernel clock selected by FMCSEL, and the hclk5 bus interface clock.
    #[inline(always)]
    pub fn fmcen(&mut self) -> FMCEN_W<AHB5ENRrs> {
        FMCEN_W::new(self, 4)
    }
    ///Bit 5 - XSPI1 and MCE1 peripheral clocks enable Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
    #[inline(always)]
    pub fn xspi1en(&mut self) -> XSPI1EN_W<AHB5ENRrs> {
        XSPI1EN_W::new(self, 5)
    }
    ///Bit 8 - SDMMC1 and DB_SDMMC1 peripheral clocks enable Set and reset by software.
    #[inline(always)]
    pub fn sdmmc1en(&mut self) -> SDMMC1EN_W<AHB5ENRrs> {
        SDMMC1EN_W::new(self, 8)
    }
    ///Bit 12 - XSPI2 and MCE2 peripheral clocks enable Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
    #[inline(always)]
    pub fn xspi2en(&mut self) -> XSPI2EN_W<AHB5ENRrs> {
        XSPI2EN_W::new(self, 12)
    }
    ///Bit 14 - XSPIM peripheral clock enable Set and reset by software.
    #[inline(always)]
    pub fn xspimen(&mut self) -> XSPIMEN_W<AHB5ENRrs> {
        XSPIMEN_W::new(self, 14)
    }
    ///Bit 19 - GFXMMU peripheral clock enable Set and reset by software.
    #[inline(always)]
    pub fn gfxmmuen(&mut self) -> GFXMMUEN_W<AHB5ENRrs> {
        GFXMMUEN_W::new(self, 19)
    }
    ///Bit 20 - GPU peripheral clock enable Set and reset by software.
    #[inline(always)]
    pub fn gpuen(&mut self) -> GPUEN_W<AHB5ENRrs> {
        GPUEN_W::new(self, 20)
    }
}
