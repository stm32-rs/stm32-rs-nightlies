...
///Field `SPI1RST` reader - SPI2S1 block reset Set and reset by software.
...
///Field `TIM9RST` reader - TIM9 block reset Set and reset by software.
...
///Field `SPI1RST` writer - SPI2S1 block reset Set and reset by software.
...
///Field `TIM9RST` writer - TIM9 block reset Set and reset by software.
