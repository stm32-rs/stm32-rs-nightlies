...
///Field `SPI1RST` reader - SPI2S1 block reset
...
///Field `TIM9RST` reader - TIM9 block reset
...
///Field `SPI1RST` writer - SPI2S1 block reset
...
///Field `TIM9RST` writer - TIM9 block reset
