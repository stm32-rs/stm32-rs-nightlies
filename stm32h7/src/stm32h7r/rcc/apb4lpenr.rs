...
///Field `SBSLPEN` reader - SBS peripheral clock enable in low-power mode Set and reset by software.
...
///Field `SBSLPEN` writer - SBS peripheral clock enable in low-power mode Set and reset by software.
...
///Field `LPUART1LPEN` reader - LPUART1 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPUART1 are the kernel clock selected by LPUART1SEL and provided to UCLK input, and the rcc_pclk4 bus interface clock.
pub use SBSLPEN_R as LPUART1LPEN_R;
///Field `SPI6LPEN` reader - SPI/I2S6 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the SPI/I2S6 are the kernel clock selected by SPI6SEL and provided to com_ck input, and the rcc_pclk4 bus interface clock.
pub use SBSLPEN_R as SPI6LPEN_R;
///Field `LPTIM2LPEN` reader - LPTIM2 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPTIM2 are the kernel clock selected by LPTIM23SEL and provided to clk_lpt input, and the pclk4 bus interface clock.
pub use SBSLPEN_R as LPTIM2LPEN_R;
///Field `LPTIM3LPEN` reader - LPTIM3 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPTIM3 are the kernel clock selected by LPTIM23SEL and provided to clk_lpt input, and the pclk4 bus interface clock.
pub use SBSLPEN_R as LPTIM3LPEN_R;
///Field `LPTIM4LPEN` reader - LPTIM4 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPTIM4 are the kernel clock selected by LPTIM45SEL and provided to clk_lpt input, and the pclk4 bus interface clock.
pub use SBSLPEN_R as LPTIM4LPEN_R;
///Field `LPTIM5LPEN` reader - LPTIM5 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPTIM5 are the kernel clock selected by LPTIM45SEL and provided to clk_lpt input, and the pclk4 bus interface clock.
pub use SBSLPEN_R as LPTIM5LPEN_R;
///Field `VREFLPEN` reader - VREF peripheral clock enable in low-power mode Set and reset by software.
pub use SBSLPEN_R as VREFLPEN_R;
///Field `RTCAPBLPEN` reader - RTC APB clock enable in low-power mode Set and reset by software.
pub use SBSLPEN_R as RTCAPBLPEN_R;
///Field `TMPSENSLPEN` reader - temperature sensor peripheral clock enable in low-power mode Set and reset by software.
pub use SBSLPEN_R as TMPSENSLPEN_R;
///Field `LPUART1LPEN` writer - LPUART1 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPUART1 are the kernel clock selected by LPUART1SEL and provided to UCLK input, and the rcc_pclk4 bus interface clock.
pub use SBSLPEN_W as LPUART1LPEN_W;
///Field `SPI6LPEN` writer - SPI/I2S6 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the SPI/I2S6 are the kernel clock selected by SPI6SEL and provided to com_ck input, and the rcc_pclk4 bus interface clock.
pub use SBSLPEN_W as SPI6LPEN_W;
///Field `LPTIM2LPEN` writer - LPTIM2 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPTIM2 are the kernel clock selected by LPTIM23SEL and provided to clk_lpt input, and the pclk4 bus interface clock.
pub use SBSLPEN_W as LPTIM2LPEN_W;
///Field `LPTIM3LPEN` writer - LPTIM3 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPTIM3 are the kernel clock selected by LPTIM23SEL and provided to clk_lpt input, and the pclk4 bus interface clock.
pub use SBSLPEN_W as LPTIM3LPEN_W;
///Field `LPTIM4LPEN` writer - LPTIM4 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPTIM4 are the kernel clock selected by LPTIM45SEL and provided to clk_lpt input, and the pclk4 bus interface clock.
pub use SBSLPEN_W as LPTIM4LPEN_W;
///Field `LPTIM5LPEN` writer - LPTIM5 peripheral clocks enable in low-power mode Set and reset by software. The peripheral clocks of the LPTIM5 are the kernel clock selected by LPTIM45SEL and provided to clk_lpt input, and the pclk4 bus interface clock.
pub use SBSLPEN_W as LPTIM5LPEN_W;
///Field `VREFLPEN` writer - VREF peripheral clock enable in low-power mode Set and reset by software.
pub use SBSLPEN_W as VREFLPEN_W;
///Field `RTCAPBLPEN` writer - RTC APB clock enable in low-power mode Set and reset by software.
pub use SBSLPEN_W as RTCAPBLPEN_W;
///Field `TMPSENSLPEN` writer - temperature sensor peripheral clock enable in low-power mode Set and reset by software.
