...
///Field `SPI6RST` reader - SPI/I2S6 block reset Set and reset by software.
...
///Field `TMPSENSRST` reader - TMPSENS block reset Set and reset by software.
...
///Field `SPI6RST` writer - SPI/I2S6 block reset Set and reset by software.
...
///Field `TMPSENSRST` writer - TMPSENS block reset Set and reset by software.
