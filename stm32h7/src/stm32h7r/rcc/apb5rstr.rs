...
///Field `LTDCRST` reader - LTDC block reset Set and reset by software.
...
///Field `LTDCRST` writer - LTDC block reset Set and reset by software.
...
///Field `DCMIPPRST` reader - DCMIPP block reset Set and reset by software.
pub use LTDCRST_R as DCMIPPRST_R;
///Field `GFXTIMRST` reader - GFXTIM block reset Set and reset by software.
pub use LTDCRST_R as GFXTIMRST_R;
///Field `DCMIPPRST` writer - DCMIPP block reset Set and reset by software.
pub use LTDCRST_W as DCMIPPRST_W;
///Field `GFXTIMRST` writer - GFXTIM block reset Set and reset by software.
...
impl W {
    ///Bit 1 - LTDC block reset Set and reset by software.
    #[inline(always)]
    pub fn ltdcrst(&mut self) -> LTDCRST_W<APB5RSTRrs> {
        LTDCRST_W::new(self, 1)
    }
    ///Bit 2 - DCMIPP block reset Set and reset by software.
    #[inline(always)]
    pub fn dcmipprst(&mut self) -> DCMIPPRST_W<APB5RSTRrs> {
        DCMIPPRST_W::new(self, 2)
    }
    ///Bit 4 - GFXTIM block reset Set and reset by software.
    #[inline(always)]
    pub fn gfxtimrst(&mut self) -> GFXTIMRST_W<APB5RSTRrs> {
