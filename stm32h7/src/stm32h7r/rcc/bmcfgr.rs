...
/**Bus matrix clock prescaler Set and reset by software to control the division factor of rcc_hclk\[5:1\]
...
/**Field `HPRE` reader - Bus matrix clock prescaler Set and reset by software to control the division factor of rcc_hclk\[5:1\]
and rcc_aclk. This group of clocks is also named sys_bus_ck. Changing this division ratio has an impact on the frequency of all bus matrix clocks. 0xxx: sys_bus_ck= sys_cpu_ck (default after reset) Note: The clocks are divided by the new prescaler factor from 1 to 16 periods of the slowest APB clock among rcc_pclk1,2,4,5 after BMPRE update. Note: Note also that frequency of rcc_hclk\[5:1\]
= rcc_aclk = sys_bus_ck.*/
...
/**Field `HPRE` writer - Bus matrix clock prescaler Set and reset by software to control the division factor of rcc_hclk\[5:1\]
and rcc_aclk. This group of clocks is also named sys_bus_ck. Changing this division ratio has an impact on the frequency of all bus matrix clocks. 0xxx: sys_bus_ck= sys_cpu_ck (default after reset) Note: The clocks are divided by the new prescaler factor from 1 to 16 periods of the slowest APB clock among rcc_pclk1,2,4,5 after BMPRE update. Note: Note also that frequency of rcc_hclk\[5:1\]
= rcc_aclk = sys_bus_ck.*/
...
impl R {
    /**Bits 0:3 - Bus matrix clock prescaler Set and reset by software to control the division factor of rcc_hclk\[5:1\]
    and rcc_aclk. This group of clocks is also named sys_bus_ck. Changing this division ratio has an impact on the frequency of all bus matrix clocks. 0xxx: sys_bus_ck= sys_cpu_ck (default after reset) Note: The clocks are divided by the new prescaler factor from 1 to 16 periods of the slowest APB clock among rcc_pclk1,2,4,5 after BMPRE update. Note: Note also that frequency of rcc_hclk\[5:1\]
    = rcc_aclk = sys_bus_ck.*/
    #[inline(always)]
...
impl W {
    ...
    = rcc_aclk = sys_bus_ck.*/
    #[inline(always)]
    pub fn hpre(&mut self) -> HPRE_W<BMCFGRrs> {
        HPRE_W::new(self, 0)
    }
}
