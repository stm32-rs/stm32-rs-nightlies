...
///Field `FRACN` reader - fractional part of the multiplication factor for PLL2 VCO
pub type FRACN_R = crate::FieldReader<u16>;
///Field `FRACN` writer - fractional part of the multiplication factor for PLL2 VCO
...
impl W {
    ///Bits 3:15 - fractional part of the multiplication factor for PLL2 VCO
    #[inline(always)]
    pub fn fracn(&mut self) -> FRACN_W<'_, PLL2FRACRrs> {
        FRACN_W::new(self, 3)
    }
}
