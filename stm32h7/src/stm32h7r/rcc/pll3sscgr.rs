...
///Field `MODPER` reader - Modulation Period Adjustment for PLL3
pub type MODPER_R = crate::FieldReader<u16>;
///Field `MODPER` writer - Modulation Period Adjustment for PLL3
pub type MODPER_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `TPDFNDIS` reader - Dithering TPDF noise control for PLL3
pub type TPDFNDIS_R = crate::BitReader;
///Field `TPDFNDIS` writer - Dithering TPDF noise control for PLL3
pub type TPDFNDIS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RPDFNDIS` reader - Dithering RPDF noise control for PLL3
pub type RPDFNDIS_R = crate::BitReader;
///Field `RPDFNDIS` writer - Dithering RPDF noise control for PLL3
pub type RPDFNDIS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPREADSEL` reader - Spread spectrum clock generator mode for PLL3
pub type SPREADSEL_R = crate::BitReader;
///Field `SPREADSEL` writer - Spread spectrum clock generator mode for PLL3
pub type SPREADSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INCSTEP` reader - Modulation Depth Adjustment for PLL3
pub type INCSTEP_R = crate::FieldReader<u16>;
///Field `INCSTEP` writer - Modulation Depth Adjustment for PLL3
pub type INCSTEP_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
impl R {
    ///Bits 0:12 - Modulation Period Adjustment for PLL3
    #[inline(always)]
    pub fn modper(&self) -> MODPER_R {
        MODPER_R::new((self.bits & 0x1fff) as u16)
    }
    ///Bit 13 - Dithering TPDF noise control for PLL3
    #[inline(always)]
    pub fn tpdfndis(&self) -> TPDFNDIS_R {
        TPDFNDIS_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - Dithering RPDF noise control for PLL3
    #[inline(always)]
    pub fn rpdfndis(&self) -> RPDFNDIS_R {
        RPDFNDIS_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - Spread spectrum clock generator mode for PLL3
    #[inline(always)]
    pub fn spreadsel(&self) -> SPREADSEL_R {
        SPREADSEL_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bits 16:30 - Modulation Depth Adjustment for PLL3
    #[inline(always)]
...
impl W {
    ///Bits 0:12 - Modulation Period Adjustment for PLL3
    #[inline(always)]
    pub fn modper(&mut self) -> MODPER_W<'_, PLL3SSCGRrs> {
        MODPER_W::new(self, 0)
    }
    ///Bit 13 - Dithering TPDF noise control for PLL3
    #[inline(always)]
    pub fn tpdfndis(&mut self) -> TPDFNDIS_W<'_, PLL3SSCGRrs> {
        TPDFNDIS_W::new(self, 13)
    }
    ///Bit 14 - Dithering RPDF noise control for PLL3
    #[inline(always)]
    pub fn rpdfndis(&mut self) -> RPDFNDIS_W<'_, PLL3SSCGRrs> {
        RPDFNDIS_W::new(self, 14)
    }
    ///Bit 15 - Spread spectrum clock generator mode for PLL3
    #[inline(always)]
    pub fn spreadsel(&mut self) -> SPREADSEL_W<'_, PLL3SSCGRrs> {
        SPREADSEL_W::new(self, 15)
    }
    ///Bits 16:30 - Modulation Depth Adjustment for PLL3
    #[inline(always)]
    pub fn incstep(&mut self) -> INCSTEP_W<'_, PLL3SSCGRrs> {
