...
///Field `DBG_UNLOCK` reader - debug unlock Write 0xB4 to this bitfield to open the debug when HDPL in SBS_HDPLSR equals to DBG_AUTH_HDPL in this register.
pub type DBG_UNLOCK_R = crate::FieldReader;
///Field `DBG_UNLOCK` writer - debug unlock Write 0xB4 to this bitfield to open the debug when HDPL in SBS_HDPLSR equals to DBG_AUTH_HDPL in this register.
pub type DBG_UNLOCK_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DBG_AUTH_HDPL` reader - authenticated debug hide protection level Writing to this bitfield defines at which HDPL the authenticated debug opens. Note: Writing any other values is ignored. Reading any other value means the authenticated debug always fails.
pub type DBG_AUTH_HDPL_R = crate::FieldReader;
///Field `DBG_AUTH_HDPL` writer - authenticated debug hide protection level Writing to this bitfield defines at which HDPL the authenticated debug opens. Note: Writing any other values is ignored. Reading any other value means the authenticated debug always fails.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#SBS:DBGCR)*/
pub struct DBGCRrs;
