...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fmplus_pb6(&mut self) -> FMPLUS_PB6_W<PMCRrs> {
        FMPLUS_PB6_W::new(self, 4)
    }
    ///Bit 5 - Fast-mode Plus on PB(7)
    #[inline(always)]
    #[must_use]
    pub fn fmplus_pb7(&mut self) -> FMPLUS_PB7_W<PMCRrs> {
        FMPLUS_PB7_W::new(self, 5)
    }
    ///Bit 6 - Fast-mode Plus on PB(8)
    #[inline(always)]
    #[must_use]
    pub fn fmplus_pb8(&mut self) -> FMPLUS_PB8_W<PMCRrs> {
        FMPLUS_PB8_W::new(self, 6)
    }
    ///Bit 7 - Fast-mode Plus on PB(9)
    #[inline(always)]
    #[must_use]
    pub fn fmplus_pb9(&mut self) -> FMPLUS_PB9_W<PMCRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eth_physel(&mut self) -> ETH_PHYSEL_W<PMCRrs> {
        ETH_PHYSEL_W::new(self, 21)
    }
    ///Bit 28 - AXIRAM wait state Set this bit to add one wait state to all AXIRAMs when ECC = 0. When ECC = 1 there is one wait state by default.
    #[inline(always)]
    #[must_use]
    pub fn axiram_ws(&mut self) -> AXIRAM_WS_W<PMCRrs> {
