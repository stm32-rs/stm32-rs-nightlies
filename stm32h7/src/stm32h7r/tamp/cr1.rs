...
///Field `TAMP6E` reader - Tamper detection on TAMP_IN6 enable<sup>(1)</sup>
pub type TAMP6E_R = crate::BitReader;
///Field `TAMP6E` writer - Tamper detection on TAMP_IN6 enable<sup>(1)</sup>
pub type TAMP6E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP7E` reader - Tamper detection on TAMP_IN7 enable<sup>(1)</sup>
pub type TAMP7E_R = crate::BitReader;
///Field `TAMP7E` writer - Tamper detection on TAMP_IN7 enable<sup>(1)</sup>
pub type TAMP7E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP8E` reader - Tamper detection on TAMP_IN8 enable<sup>(1)</sup>
pub type TAMP8E_R = crate::BitReader;
///Field `TAMP8E` writer - Tamper detection on TAMP_IN8 enable<sup>(1)</sup>
...
impl W {
    ...
    ///Bit 30 - Internal tamper 15 enable
    #[inline(always)]
    pub fn itamp15e(&mut self) -> ITAMP15E_W<'_, CR1rs> {
