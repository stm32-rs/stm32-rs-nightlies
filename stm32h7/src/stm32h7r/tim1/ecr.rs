...
///Field `PW` reader - Pulse width This bitfield defines the pulse duration, as following: t<sub>PW</sub> = PW\[7:0\] x t<sub>PWG</sub>
pub type PW_R = crate::FieldReader;
///Field `PW` writer - Pulse width This bitfield defines the pulse duration, as following: t<sub>PW</sub> = PW\[7:0\] x t<sub>PWG</sub>
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#TIM1:ECR)*/
pub struct ECRrs;
