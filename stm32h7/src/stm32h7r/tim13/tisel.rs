...
///Field `TI1SEL` reader - selects tim_ti1_in\[15:0\] input ... Refer to Table 656: Interconnect to the tim_ti1 input multiplexer for interconnects list.
pub type TI1SEL_R = crate::FieldReader;
///Field `TI1SEL` writer - selects tim_ti1_in\[15:0\] input ... Refer to Table 656: Interconnect to the tim_ti1 input multiplexer for interconnects list.
