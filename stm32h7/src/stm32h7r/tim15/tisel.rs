...
/**Field `TI1SEL` reader - selects tim_ti1_in\[15:0\]
input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.*/
pub type TI1SEL_R = crate::FieldReader;
/**Field `TI1SEL` writer - selects tim_ti1_in\[15:0\]
input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.*/
pub type TI1SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
/**Field `TI2SEL` reader - selects tim_ti2_in\[15:0\]
input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.*/
pub type TI2SEL_R = crate::FieldReader;
/**Field `TI2SEL` writer - selects tim_ti2_in\[15:0\]
input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.*/
pub type TI2SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    /**Bits 0:3 - selects tim_ti1_in\[15:0\]
    input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.*/
    #[inline(always)]
    pub fn ti1sel(&self) -> TI1SEL_R {
        TI1SEL_R::new((self.bits & 0x0f) as u8)
    }
    /**Bits 8:11 - selects tim_ti2_in\[15:0\]
    input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.*/
    #[inline(always)]
