...
///Field `TI1SEL` reader - selects tim_ti1_in\[15:0\] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.
pub type TI1SEL_R = crate::FieldReader;
///Field `TI1SEL` writer - selects tim_ti1_in\[15:0\] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.
pub type TI1SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TI2SEL` reader - selects tim_ti2_in\[15:0\] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.
pub type TI2SEL_R = crate::FieldReader;
///Field `TI2SEL` writer - selects tim_ti2_in\[15:0\] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#TIM15:TISEL)*/
pub struct TISELrs;
