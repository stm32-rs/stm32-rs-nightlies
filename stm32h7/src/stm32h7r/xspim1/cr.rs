...
///Field `MUXEN` reader - Multiplexed mode enable This bit enables the multiplexing of the two XSPIs.
pub type MUXEN_R = crate::BitReader;
///Field `MUXEN` writer - Multiplexed mode enable This bit enables the multiplexing of the two XSPIs.
...
///Field `REQ2ACK_TIME` reader - REQ to ACK time In Multiplexed mode (MUXEN = 1), this field defines the time between two transactions.
pub type REQ2ACK_TIME_R = crate::FieldReader;
///Field `REQ2ACK_TIME` writer - REQ to ACK time In Multiplexed mode (MUXEN = 1), this field defines the time between two transactions.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#XSPIM1:CR)*/
pub struct CRrs;
