...
///Field `BSSEL` reader - Bitstream selection This field is set and cleared by software. It is used to select the bitstream to be processed for DFLT0. others: reserved Note: This field can be write-protected (see Section 46.4.13: Register protection for details).
pub type BSSEL_R = crate::FieldReader;
///Field `BSSEL` writer - Bitstream selection This field is set and cleared by software. It is used to select the bitstream to be processed for DFLT0. others: reserved Note: This field can be write-protected (see Section 46.4.13: Register protection for details).
pub type BSSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
/**Field `BSMXACTIVE` reader - BSMX active flag This bit is set and cleared by hardware. It is used by the application to check if the BSMX is effectively enabled (active) or not. BSSEL\[4:0\]
...
impl R {
    ...
    /**Bit 31 - BSMX active flag This bit is set and cleared by hardware. It is used by the application to check if the BSMX is effectively enabled (active) or not. BSSEL\[4:0\]
    can only be updated when BSMXACTIVE is set to 0. This BSMXACTIVE flag cannot go to 0 if DFLT0 is enabled.*/
    #[inline(always)]
