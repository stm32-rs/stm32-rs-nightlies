...
/**Field `DFLTEN` writer - DFLT0 enable This bit is set and cleared by software. It is used to control the start of acquisition of the DFLT0 path. This bit behavior depends on ACQMOD\[2:0\]
and external events. The serial or parallel interface delivering the samples must be enabled as well.*/
...
impl W {
    /**Bit 0 - DFLT0 enable This bit is set and cleared by software. It is used to control the start of acquisition of the DFLT0 path. This bit behavior depends on ACQMOD\[2:0\]
    and external events. The serial or parallel interface delivering the samples must be enabled as well.*/
    #[inline(always)]
    #[must_use]
