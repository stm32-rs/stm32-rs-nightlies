...
///Field `FTHIE` reader - RXFIFO threshold interrupt enable This bit is set and cleared by software.
pub type FTHIE_R = crate::BitReader;
///Field `FTHIE` writer - RXFIFO threshold interrupt enable This bit is set and cleared by software.
pub type FTHIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOVRIE` reader - Data overflow interrupt enable This bit is set and cleared by software.
pub type DOVRIE_R = crate::BitReader;
///Field `DOVRIE` writer - Data overflow interrupt enable This bit is set and cleared by software.
pub type DOVRIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SATIE` reader - Saturation detection interrupt enable This bit is set and cleared by software.
pub type SATIE_R = crate::BitReader;
///Field `SATIE` writer - Saturation detection interrupt enable This bit is set and cleared by software.
pub type SATIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CKABIE` reader - Clock absence detection interrupt enable This bit is set and cleared by software.
pub type CKABIE_R = crate::BitReader;
///Field `CKABIE` writer - Clock absence detection interrupt enable This bit is set and cleared by software.
pub type CKABIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RFOVRIE` reader - Reshape filter overrun interrupt enable This bit is set and cleared by software.
pub type RFOVRIE_R = crate::BitReader;
///Field `RFOVRIE` writer - Reshape filter overrun interrupt enable This bit is set and cleared by software.
pub type RFOVRIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDDETIE` reader - Sound activity detection interrupt enable This bit is set and cleared by software.
pub type SDDETIE_R = crate::BitReader;
///Field `SDDETIE` writer - Sound activity detection interrupt enable This bit is set and cleared by software.
pub type SDDETIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDLVLIE` reader - SAD sound-level value ready enable This bit is set and cleared by software.
pub type SDLVLIE_R = crate::BitReader;
///Field `SDLVLIE` writer - SAD sound-level value ready enable This bit is set and cleared by software.
...
impl W {
    ///Bit 0 - RXFIFO threshold interrupt enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn fthie(&mut self) -> FTHIE_W<'_, DFLT0IERrs> {
        FTHIE_W::new(self, 0)
    }
    ///Bit 1 - Data overflow interrupt enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn dovrie(&mut self) -> DOVRIE_W<'_, DFLT0IERrs> {
        DOVRIE_W::new(self, 1)
    }
    ///Bit 9 - Saturation detection interrupt enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn satie(&mut self) -> SATIE_W<'_, DFLT0IERrs> {
        SATIE_W::new(self, 9)
    }
    ///Bit 10 - Clock absence detection interrupt enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn ckabie(&mut self) -> CKABIE_W<'_, DFLT0IERrs> {
        CKABIE_W::new(self, 10)
    }
    ///Bit 11 - Reshape filter overrun interrupt enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn rfovrie(&mut self) -> RFOVRIE_W<'_, DFLT0IERrs> {
        RFOVRIE_W::new(self, 11)
    }
    ///Bit 12 - Sound activity detection interrupt enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn sddetie(&mut self) -> SDDETIE_W<'_, DFLT0IERrs> {
        SDDETIE_W::new(self, 12)
    }
    ///Bit 13 - SAD sound-level value ready enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn sdlvlie(&mut self) -> SDLVLIE_W<'_, DFLT0IERrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#ADF:DFLT0IER)*/
