...
///Field `DIEN` reader - DMA input enable When this bit is set, DMA requests are automatically generated by the peripheral during the input data phase.
pub type DIEN_R = crate::BitReader;
///Field `DIEN` writer - DMA input enable When this bit is set, DMA requests are automatically generated by the peripheral during the input data phase.
pub type DIEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOEN` reader - DMA output enable When this bit is set, DMA requests are automatically generated by the peripheral during the output data phase.
pub type DOEN_R = crate::BitReader;
///Field `DOEN` writer - DMA output enable When this bit is set, DMA requests are automatically generated by the peripheral during the output data phase.
