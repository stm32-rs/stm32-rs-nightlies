...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_0_stop(&mut self) -> DBG_HPDMA_0_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_0_STOP_W::new(self, 0)
    }
    ///Bit 1 - HPDMA channel 1 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_1_stop(&mut self) -> DBG_HPDMA_1_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_1_STOP_W::new(self, 1)
    }
    ///Bit 2 - HPDMA channel 2 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_2_stop(&mut self) -> DBG_HPDMA_2_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_2_STOP_W::new(self, 2)
    }
    ///Bit 3 - HPDMA channel 3 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_3_stop(&mut self) -> DBG_HPDMA_3_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_3_STOP_W::new(self, 3)
    }
    ///Bit 4 - HPDMA channel 4 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_4_stop(&mut self) -> DBG_HPDMA_4_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_4_STOP_W::new(self, 4)
    }
    ///Bit 5 - HPDMA channel 5 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_5_stop(&mut self) -> DBG_HPDMA_5_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_5_STOP_W::new(self, 5)
    }
    ///Bit 6 - HPDMA channel 6 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_6_stop(&mut self) -> DBG_HPDMA_6_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_6_STOP_W::new(self, 6)
    }
    ///Bit 7 - HPDMA channel 7 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_7_stop(&mut self) -> DBG_HPDMA_7_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_7_STOP_W::new(self, 7)
    }
    ///Bit 8 - HPDMA channel 8 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_8_stop(&mut self) -> DBG_HPDMA_8_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_8_STOP_W::new(self, 8)
    }
    ///Bit 9 - HPDMA channel 9 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_9_stop(&mut self) -> DBG_HPDMA_9_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_9_STOP_W::new(self, 9)
    }
    ///Bit 10 - HPDMA channel 10 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_10_stop(&mut self) -> DBG_HPDMA_10_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_10_STOP_W::new(self, 10)
    }
    ///Bit 11 - HPDMA channel 11 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_11_stop(&mut self) -> DBG_HPDMA_11_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_11_STOP_W::new(self, 11)
    }
    ///Bit 12 - HPDMA channel 12 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_12_stop(&mut self) -> DBG_HPDMA_12_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_12_STOP_W::new(self, 12)
    }
    ///Bit 13 - HPDMA channel 13 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_13_stop(&mut self) -> DBG_HPDMA_13_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_13_STOP_W::new(self, 13)
    }
    ///Bit 14 - HPDMA channel 14 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_14_stop(&mut self) -> DBG_HPDMA_14_STOP_W<AHB5FZRrs> {
        DBG_HPDMA_14_STOP_W::new(self, 14)
    }
    ///Bit 15 - HPDMA channel 15 stop in debug
    #[inline(always)]
    #[must_use]
    pub fn dbg_hpdma_15_stop(&mut self) -> DBG_HPDMA_15_STOP_W<AHB5FZRrs> {
