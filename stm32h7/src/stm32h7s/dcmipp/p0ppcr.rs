...
/**Field `BSM` reader - Byte select mode Modes 10 and 11 work only with EDM \[2:0\]
= 000 into the DCMIPP_PRCR register.*/
pub type BSM_R = crate::FieldReader;
/**Field `BSM` writer - Byte select mode Modes 10 and 11 work only with EDM \[2:0\]
= 000 into the DCMIPP_PRCR register.*/
...
impl R {
    ...
    /**Bits 7:8 - Byte select mode Modes 10 and 11 work only with EDM \[2:0\]
    = 000 into the DCMIPP_PRCR register.*/
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DCMIPP:P0PPCR)*/
pub struct P0PPCRrs;
