...
///Field `CERRF` writer - Synchronization error interrupt status clear Writing a 1 into this bit clears the ERRF bit in DCMIPP_PRSR. This bit is available only in embedded synchronization mode.
...
impl W {
    ...
    #[inline(always)]
    pub fn cerrf(&mut self) -> CERRF_W<PRFCRrs> {
        CERRF_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DCMIPP:PRFCR)*/
pub struct PRFCRrs;
