...
/**Field `CS` reader - CLUT size These bits define the size of the CLUT used for the foreground image. The number of CLUT entries is equal to CS\[7:0\]
+ 1.*/
pub type CS_R = crate::FieldReader;
/**Field `CS` writer - CLUT size These bits define the size of the CLUT used for the foreground image. The number of CLUT entries is equal to CS\[7:0\]
+ 1.*/
...
/**Field `ALPHA` reader - Alpha value These bits define a fixed alpha channel value which can replace the original alpha value, or be multiplied by the original alpha value, according to the alpha mode selected through AM\[1:0\]
in this register.*/
pub type ALPHA_R = crate::FieldReader;
/**Field `ALPHA` writer - Alpha value These bits define a fixed alpha channel value which can replace the original alpha value, or be multiplied by the original alpha value, according to the alpha mode selected through AM\[1:0\]
in this register.*/
...
impl R {
    ...
    /**Bits 8:15 - CLUT size These bits define the size of the CLUT used for the foreground image. The number of CLUT entries is equal to CS\[7:0\]
    + 1.*/
    #[inline(always)]
    pub fn cs(&self) -> CS_R {
    ...
    /**Bits 24:31 - Alpha value These bits define a fixed alpha channel value which can replace the original alpha value, or be multiplied by the original alpha value, according to the alpha mode selected through AM\[1:0\]
    in this register.*/
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn css(&mut self) -> CSS_W<FGPFCCRrs> {
        CSS_W::new(self, 18)
    }
    ///Bit 20 - Alpha inverted This bit inverts the alpha value.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:FGPFCCR)*/
