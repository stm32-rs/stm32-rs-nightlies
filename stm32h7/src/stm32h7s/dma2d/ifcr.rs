...
///Field `CTEIF` reader - Clear transfer error interrupt flag Programming this bit to 1 clears the TEIF flag in DMA2D_ISR.
pub type CTEIF_R = crate::BitReader;
///Field `CTEIF` writer - Clear transfer error interrupt flag Programming this bit to 1 clears the TEIF flag in DMA2D_ISR.
pub type CTEIF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CTCIF` reader - Clear transfer complete interrupt flag Programming this bit to 1 clears the TCIF flag in DMA2D_ISR.
pub type CTCIF_R = crate::BitReader;
///Field `CTCIF` writer - Clear transfer complete interrupt flag Programming this bit to 1 clears the TCIF flag in DMA2D_ISR.
pub type CTCIF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CTWIF` reader - Clear transfer watermark interrupt flag Programming this bit to 1 clears the TWIF flag in DMA2D_ISR.
pub type CTWIF_R = crate::BitReader;
///Field `CTWIF` writer - Clear transfer watermark interrupt flag Programming this bit to 1 clears the TWIF flag in DMA2D_ISR.
pub type CTWIF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAECIF` reader - Clear CLUT access error interrupt flag Programming this bit to 1 clears the CAEIF flag in DMA2D_ISR.
pub type CAECIF_R = crate::BitReader;
///Field `CAECIF` writer - Clear CLUT access error interrupt flag Programming this bit to 1 clears the CAEIF flag in DMA2D_ISR.
pub type CAECIF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CCTCIF` reader - Clear CLUT transfer complete interrupt flag Programming this bit to 1 clears the CTCIF flag in DMA2D_ISR.
pub type CCTCIF_R = crate::BitReader;
///Field `CCTCIF` writer - Clear CLUT transfer complete interrupt flag Programming this bit to 1 clears the CTCIF flag in DMA2D_ISR.
pub type CCTCIF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CCEIF` reader - Clear configuration error interrupt flag Programming this bit to 1 clears the CEIF flag in DMA2D_ISR.
pub type CCEIF_R = crate::BitReader;
///Field `CCEIF` writer - Clear configuration error interrupt flag Programming this bit to 1 clears the CEIF flag in DMA2D_ISR.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:IFCR)*/
pub struct IFCRrs;
