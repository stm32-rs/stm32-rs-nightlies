...
/**Field `LO` reader - Line offset This field gives the line offset used for the output, expressed: in pixels when LOM = 0 in DMA2D_CR. Only LO\[13:0\]
bits are considered, LO\[15:14\]
bits are ignored. in bytes when LOM = 1 This value is used for the address generation. It is added at the end of each line to determine the starting address of the next line.*/
pub type LO_R = crate::FieldReader<u16>;
/**Field `LO` writer - Line offset This field gives the line offset used for the output, expressed: in pixels when LOM = 0 in DMA2D_CR. Only LO\[13:0\]
bits are considered, LO\[15:14\]
bits are ignored. in bytes when LOM = 1 This value is used for the address generation. It is added at the end of each line to determine the starting address of the next line.*/
pub type LO_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    /**Bits 0:15 - Line offset This field gives the line offset used for the output, expressed: in pixels when LOM = 0 in DMA2D_CR. Only LO\[13:0\]
    bits are considered, LO\[15:14\]
    bits are ignored. in bytes when LOM = 1 This value is used for the address generation. It is added at the end of each line to determine the starting address of the next line.*/
    #[inline(always)]
    pub fn lo(&self) -> LO_R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:OOR)*/
pub struct OORrs;
