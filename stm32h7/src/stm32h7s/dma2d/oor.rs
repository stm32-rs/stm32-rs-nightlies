...
///Field `LO` reader - Line offset This field gives the line offset used for the output, expressed: in pixels when LOM = 0 in DMA2D_CR. Only LO\[13:0\] bits are considered, LO\[15:14\] bits are ignored. in bytes when LOM = 1 This value is used for the address generation. It is added at the end of each line to determine the starting address of the next line.
pub type LO_R = crate::FieldReader<u16>;
///Field `LO` writer - Line offset This field gives the line offset used for the output, expressed: in pixels when LOM = 0 in DMA2D_CR. Only LO\[13:0\] bits are considered, LO\[15:14\] bits are ignored. in bytes when LOM = 1 This value is used for the address generation. It is added at the end of each line to determine the starting address of the next line.
...
impl W {
    ///Bits 0:15 - Line offset This field gives the line offset used for the output, expressed: in pixels when LOM = 0 in DMA2D_CR. Only LO\[13:0\] bits are considered, LO\[15:14\] bits are ignored. in bytes when LOM = 1 This value is used for the address generation. It is added at the end of each line to determine the starting address of the next line.
    #[inline(always)]
    pub fn lo(&mut self) -> LO_W<'_, OORrs> {
        LO_W::new(self, 0)
    }
}
