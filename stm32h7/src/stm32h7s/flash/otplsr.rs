...
/**Field `OTPL` reader - OTP lock n Block n corresponds to OTP 16-bit word 32 x n to 32 x n + 31. OTPL\[n\]
...
impl R {
    /**Bits 0:15 - OTP lock n Block n corresponds to OTP 16-bit word 32 x n to 32 x n + 31. OTPL\[n\]
    = 1 indicates that all OTP 16-bit words in OTP Block n are locked and can no longer be programmed. OTPL\[n\]
    = 0 indicates that all OTP 16-bit words in OTP Block n are not locked and can still be modified.*/
    #[inline(always)]
