...
///Field `LINE` reader - line number Compare value 1 for the absolute line counter.
pub type LINE_R = crate::FieldReader<u16>;
///Field `LINE` writer - line number Compare value 1 for the absolute line counter.
...
impl W {
    ///Bits 0:11 - line number Compare value 1 for the absolute line counter.
    #[inline(always)]
    pub fn line(&mut self) -> LINE_W<ALCC1Rrs> {
        LINE_W::new(self, 0)
    }
}
