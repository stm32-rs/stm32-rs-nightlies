...
///Field `TES` reader - tearing source This field selects the tearing-effect source.
pub type TES_R = crate::FieldReader;
///Field `TES` writer - tearing source This field selects the tearing-effect source.
pub type TES_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TEPOL` reader - tearing--effect polarity This bit selects the tearing-effect polarity.
pub type TEPOL_R = crate::BitReader;
///Field `TEPOL` writer - tearing--effect polarity This bit selects the tearing-effect polarity.
pub type TEPOL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYNCS` reader - synchronization source This field selects the synchronization signals (HSYNC and VSYNC) sources.
pub type SYNCS_R = crate::FieldReader;
///Field `SYNCS` writer - synchronization source This field selects the synchronization signals (HSYNC and VSYNC) sources.
pub type SYNCS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `FCCOE` reader - frame-clock calibration output enable This bit enables the frame-clock output.
pub type FCCOE_R = crate::BitReader;
///Field `FCCOE` writer - frame-clock calibration output enable This bit enables the frame-clock output.
pub type FCCOE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCCOE` reader - line-clock calibration output enable This bit enables the line-clock output.
pub type LCCOE_R = crate::BitReader;
///Field `LCCOE` writer - line-clock calibration output enable This bit enables the line-clock output.
