...
///Field `AFCS` reader - absolute frame counter status This bit returns the status of the absolute frame counter.
pub type AFCS_R = crate::BitReader;
///Field `ALCS` reader - absolute line counter status This bit returns the status of the absolute line counter.
pub type ALCS_R = crate::BitReader;
///Field `RFC1S` reader - relative frame counter 1 status This bit returns the status of the relative frame counter 1.
pub type RFC1S_R = crate::BitReader;
///Field `RFC2S` reader - relative frame counter 2 status This bit returns the status of the relative frame counter 2.
