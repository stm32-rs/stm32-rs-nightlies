...
///Field `RELOAD` reader - reload value Reload value of the watchdog counter.
pub type RELOAD_R = crate::FieldReader<u16>;
///Field `RELOAD` writer - reload value Reload value of the watchdog counter.
...
impl W {
    ///Bits 0:15 - reload value Reload value of the watchdog counter.
    #[inline(always)]
    pub fn reload(&mut self) -> RELOAD_W<'_, WDGRRrs> {
        RELOAD_W::new(self, 0)
    }
}
