...
/**Field `TRIGSEL` reader - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per Section 14.3.6), with an active trigger event if TRIGPOL\[1:0\]
different from 00.*/
pub type TRIGSEL_R = crate::FieldReader;
/**Field `TRIGSEL` writer - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per Section 14.3.6), with an active trigger event if TRIGPOL\[1:0\]
different from 00.*/
...
impl R {
    ...
    /**Bits 16:21 - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per Section 14.3.6), with an active trigger event if TRIGPOL\[1:0\]
    different from 00.*/
    #[inline(always)]
