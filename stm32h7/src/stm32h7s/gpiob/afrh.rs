...
///Field `AFR(EL8,EL9,EL10,EL11,EL12,EL13,EL14,EL15)` writer - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os. Note: The bitfield is reserved and must be kept to reset value when the corresponding I/O is not available on the selected package.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#GPIOB:AFRH)*/
pub struct AFRHrs;
