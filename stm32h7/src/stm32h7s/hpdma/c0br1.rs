...
pub type R = crate::R<C0BR1rs>;
///Register `C0BR1` writer
pub type W = crate::W<C0BR1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("C0BR1").field("bndt", &self.bndt()).finish()
    }
}
impl W {
    /**Bits 0:15 - block number of data bytes to transfer from the source Block size transferred from the source. When the channel is enabled, this field becomes read-only and is decremented, indicating the remaining number of data items in the current source block to be transferred. BNDT\[15:0\]
    ...
    versus HPDMA_CxTR1.DDW_LOG2\[1:0\]). Else a user setting error is reported and no transfer is issued.*/
    #[inline(always)]
    pub fn bndt(&mut self) -> BNDT_W<C0BR1rs> {
        BNDT_W::new(self, 0)
    }
}
/**HPDMA channel 0 block register 1

You can [`read`](crate::Reg::read) this register and get [`c0br1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c0br1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#HPDMA:C0BR1)*/
pub struct C0BR1rs;
impl crate::RegisterSpec for C0BR1rs {
    type Ux = u32;
}
///`read()` method returns [`c0br1::R`](R) reader structure
impl crate::Readable for C0BR1rs {}
///`write(|w| ..)` method takes [`c0br1::W`](W) writer structure
impl crate::Writable for C0BR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets C0BR1 to value 0
impl crate::Resettable for C0BR1rs {
