///Register `C1BR1` reader
pub type R = crate::R<C1BR1rs>;
///Register `C1BR1` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("C1BR1").field("bndt", &self.bndt()).finish()
    }
}
impl W {
    /**Bits 0:15 - block number of data bytes to transfer from the source Block size transferred from the source. When the channel is enabled, this field becomes read-only and is decremented, indicating the remaining number of data items in the current source block to be transferred. BNDT\[15:0\]
...
You can [`read`](crate::Reg::read) this register and get [`c1br1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c1br1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#HPDMA:C1BR1)*/
pub struct C1BR1rs;
impl crate::RegisterSpec for C1BR1rs {
    type Ux = u32;
}
///`read()` method returns [`c1br1::R`](R) reader structure
impl crate::Readable for C1BR1rs {}
///`write(|w| ..)` method takes [`c1br1::W`](W) writer structure
impl crate::Writable for C1BR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets C1BR1 to value 0
