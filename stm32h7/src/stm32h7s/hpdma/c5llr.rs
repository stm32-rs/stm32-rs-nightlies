///Register `C5LLR` reader
pub type R = crate::R<C5LLRrs>;
///Register `C5LLR` writer
pub type W = crate::W<C5LLRrs>;
...
impl W {
    ...
    = 0, the current LLI is the last one. The channel transfer is completed without any update of the linked-list HPDMA register file. Else, this field is the pointer to the memory address offset from which the next linked-list data structure is automatically fetched from, once the data transfer is completed, in order to conditionally update the linked-list HPDMA internal register file (HPDMA_CxTR1, HPDMA_CxTR2, HPDMA_CxBR1, HPDMA_CxSAR, HPDMA_CxDAR and HPDMA_CxLLR). Note: The user must program the pointer to be 32-bit aligned. The two low-significant bits are write ignored.*/
    #[inline(always)]
    pub fn la(&mut self) -> LA_W<C5LLRrs> {
        LA_W::new(self, 2)
    }
    ///Bit 16 - Update HPDMA_CxLLR register from memory This bit is used to control the update of HPDMA_CxLLR from the memory during the link transfer.
    #[inline(always)]
    pub fn ull(&mut self) -> ULL_W<C5LLRrs> {
        ULL_W::new(self, 16)
    }
    ///Bit 27 - Update HPDMA_CxDAR register from memory This bit is used to control the update of HPDMA_CxDAR from the memory during the link transfer.
    #[inline(always)]
    pub fn uda(&mut self) -> UDA_W<C5LLRrs> {
        UDA_W::new(self, 27)
    }
    ///Bit 28 - update HPDMA_CxSAR from memory This bit controls the update of HPDMA_CxSAR from the memory during the link transfer.
    #[inline(always)]
    pub fn usa(&mut self) -> USA_W<C5LLRrs> {
        USA_W::new(self, 28)
    }
    /**Bit 29 - Update HPDMA_CxBR1 from memory This bit controls the update of HPDMA_CxBR1 from the memory during the link transfer. If UB1 = 0 and if HPDMA_CxLLR different from 0, the linked-list is not completed. HPDMA_CxBR1.BNDT\[15:0\]
    is then restored to the programmed value after data transfer is completed and before the link transfer.*/
    #[inline(always)]
    pub fn ub1(&mut self) -> UB1_W<C5LLRrs> {
        UB1_W::new(self, 29)
    }
    ///Bit 30 - Update HPDMA_CxTR2 from memory This bit controls the update of HPDMA_CxTR2 from the memory during the link transfer.
    #[inline(always)]
    pub fn ut2(&mut self) -> UT2_W<C5LLRrs> {
        UT2_W::new(self, 30)
    }
    ///Bit 31 - Update HPDMA_CxTR1 from memory This bit controls the update of HPDMA_CxTR1 from the memory during the link transfer.
    #[inline(always)]
    pub fn ut1(&mut self) -> UT1_W<C5LLRrs> {
        UT1_W::new(self, 31)
    }
}
/**HPDMA channel 5 linked-list address register

You can [`read`](crate::Reg::read) this register and get [`c5llr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c5llr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#HPDMA:C5LLR)*/
pub struct C5LLRrs;
impl crate::RegisterSpec for C5LLRrs {
    type Ux = u32;
}
///`read()` method returns [`c5llr::R`](R) reader structure
impl crate::Readable for C5LLRrs {}
///`write(|w| ..)` method takes [`c5llr::W`](W) writer structure
impl crate::Writable for C5LLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets C5LLR to value 0
impl crate::Resettable for C5LLRrs {
