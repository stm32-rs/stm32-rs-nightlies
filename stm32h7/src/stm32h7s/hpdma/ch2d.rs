...
/**LBAR (rw) register accessor: HPDMA channel 12 linked-list base address register
...
pub mod lbar;
/**FCR (w) register accessor: HPDMA channel 12 flag clear register
...
pub mod fcr;
/**SR (r) register accessor: HPDMA channel 12 status register
...
pub mod sr;
/**CR (rw) register accessor: HPDMA channel 12 control register
...
pub mod cr;
/**TR1 (rw) register accessor: HPDMA channel 12 transfer register 1
...
pub mod tr1;
/**TR2 (rw) register accessor: HPDMA channel 12 transfer register 2
...
pub mod br1;
/**SAR (rw) register accessor: HPDMA channel 12 source address register
...
pub mod sar;
/**DAR (rw) register accessor: HPDMA channel 12 destination address register
