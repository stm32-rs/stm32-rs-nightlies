...
///Field `DE` reader - Codec operation as coder or decoder This bit selects the code or decode process
pub type DE_R = crate::BitReader;
///Field `DE` writer - Codec operation as coder or decoder This bit selects the code or decode process
pub type DE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COLSPACE` reader - Color space This filed defines the number of quantization tables minus 1 to insert in the output stream.
pub type COLSPACE_R = crate::FieldReader;
///Field `COLSPACE` writer - Color space This filed defines the number of quantization tables minus 1 to insert in the output stream.
...
///Field `HDR` reader - Header processing This bit enables the header processing (generation/parsing).
pub type HDR_R = crate::BitReader;
///Field `HDR` writer - Header processing This bit enables the header processing (generation/parsing).
...
impl W {
    ...
    ///Bits 4:5 - Color space This filed defines the number of quantization tables minus 1 to insert in the output stream.
    #[inline(always)]
    pub fn colspace(&mut self) -> COLSPACE_W<'_, CONFR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#JPEG:CONFR1)*/
pub struct CONFR1rs;
