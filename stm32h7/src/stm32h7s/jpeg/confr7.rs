...
///Field `QT` reader - Quantization table Selects quantization table used for component 3.
pub type QT_R = crate::FieldReader;
///Field `QT` writer - Quantization table Selects quantization table used for component 3.
...
///Field `VSF` reader - Vertical sampling factor Vertical sampling factor for component 3.
pub type VSF_R = crate::FieldReader;
///Field `VSF` writer - Vertical sampling factor Vertical sampling factor for component 3.
pub type VSF_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `HSF` reader - Horizontal sampling factor Horizontal sampling factor for component 3.
pub type HSF_R = crate::FieldReader;
///Field `HSF` writer - Horizontal sampling factor Horizontal sampling factor for component 3.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#JPEG:CONFR7)*/
pub struct CONFR7rs;
