...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn qcoef0(&mut self) -> QCOEF0_W<QMEM3rs> {
        QCOEF0_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 1 8-bit quantization coefficient.
    #[inline(always)]
    #[must_use]
    pub fn qcoef1(&mut self) -> QCOEF1_W<QMEM3rs> {
        QCOEF1_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 2 8-bit quantization coefficient.
    #[inline(always)]
    #[must_use]
    pub fn qcoef2(&mut self) -> QCOEF2_W<QMEM3rs> {
        QCOEF2_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 3 8-bit quantization coefficient.
    #[inline(always)]
    #[must_use]
    pub fn qcoef3(&mut self) -> QCOEF3_W<QMEM3rs> {
