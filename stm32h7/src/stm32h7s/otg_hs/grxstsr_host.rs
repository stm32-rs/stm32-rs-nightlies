...
///Field `CHNUM` reader - Channel number Indicates the channel number to which the current received packet belongs.
pub type CHNUM_R = crate::FieldReader;
///Field `BCNT` reader - Byte count Indicates the byte count of the received IN data packet.
pub type BCNT_R = crate::FieldReader<u16>;
///Field `DPID` reader - Data PID Indicates the data PID of the received packet
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#OTG_HS:GRXSTSR_HOST)*/
