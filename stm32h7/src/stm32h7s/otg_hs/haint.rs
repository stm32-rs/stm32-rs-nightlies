...
///Field `HAINT` reader - Channel interrupts One bit per channel: Bit 0 for Channel 0, bit 15 for Channel 15
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#OTG_HS:HAINT)*/
pub struct HAINTrs;
