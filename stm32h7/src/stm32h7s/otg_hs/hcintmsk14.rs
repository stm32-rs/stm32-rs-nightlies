///Register `HCINTMSK14` reader
pub type R = crate::R<HCINTMSK14rs>;
///Register `HCINTMSK14` writer
pub type W = crate::W<HCINTMSK14rs>;
...
impl W {
    ///Bit 0 - Transfer completed mask
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, HCINTMSK14rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - Channel halted mask
    #[inline(always)]
    pub fn chhm(&mut self) -> CHHM_W<'_, HCINTMSK14rs> {
        CHHM_W::new(self, 1)
    }
    ///Bit 2 - AHB error.
    #[inline(always)]
    pub fn ahberrm(&mut self) -> AHBERRM_W<'_, HCINTMSK14rs> {
        AHBERRM_W::new(self, 2)
    }
    ///Bit 3 - STALL response received interrupt mask.
    #[inline(always)]
    pub fn stallm(&mut self) -> STALLM_W<'_, HCINTMSK14rs> {
        STALLM_W::new(self, 3)
    }
    ///Bit 4 - NAK response received interrupt mask.
    #[inline(always)]
    pub fn nakm(&mut self) -> NAKM_W<'_, HCINTMSK14rs> {
        NAKM_W::new(self, 4)
    }
    ///Bit 5 - ACK response received/transmitted interrupt mask.
    #[inline(always)]
    pub fn ackm(&mut self) -> ACKM_W<'_, HCINTMSK14rs> {
        ACKM_W::new(self, 5)
    }
    ///Bit 6 - response received interrupt mask.
    #[inline(always)]
    pub fn nyet(&mut self) -> NYET_W<'_, HCINTMSK14rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - Transaction error mask.
    #[inline(always)]
    pub fn txerrm(&mut self) -> TXERRM_W<'_, HCINTMSK14rs> {
        TXERRM_W::new(self, 7)
    }
    ///Bit 8 - Babble error mask.
    #[inline(always)]
    pub fn bberrm(&mut self) -> BBERRM_W<'_, HCINTMSK14rs> {
        BBERRM_W::new(self, 8)
    }
    ///Bit 9 - Frame overrun mask.
    #[inline(always)]
    pub fn frmorm(&mut self) -> FRMORM_W<'_, HCINTMSK14rs> {
        FRMORM_W::new(self, 9)
    }
    ///Bit 10 - Data toggle error mask.
    #[inline(always)]
    pub fn dterrm(&mut self) -> DTERRM_W<'_, HCINTMSK14rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#OTG_HS:HCINTMSK14)*/
pub struct HCINTMSK14rs;
impl crate::RegisterSpec for HCINTMSK14rs {
    type Ux = u32;
}
///`read()` method returns [`hcintmsk14::R`](R) reader structure
impl crate::Readable for HCINTMSK14rs {}
///`write(|w| ..)` method takes [`hcintmsk14::W`](W) writer structure
impl crate::Writable for HCINTMSK14rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HCINTMSK14 to value 0
impl crate::Resettable for HCINTMSK14rs {}
