...
///Field `GATEEN` reader - Enable active clock gating The application programs GATEEN to enable Active Clock Gating feature for the PHY and AHB clocks.
pub type GATEEN_R = crate::BitReader;
///Field `GATEEN` writer - Enable active clock gating The application programs GATEEN to enable Active Clock Gating feature for the PHY and AHB clocks.
pub type GATEEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CNTGATECLK` reader - Counter for clock gating Indicates to the controller how many PHY Clock cycles and AHB Clock cycles of 'IDLE' (no activity) the controller waits for before Gating the respective PHY and AHB clocks internal to the controller.
pub type CNTGATECLK_R = crate::FieldReader;
///Field `CNTGATECLK` writer - Counter for clock gating Indicates to the controller how many PHY Clock cycles and AHB Clock cycles of 'IDLE' (no activity) the controller waits for before Gating the respective PHY and AHB clocks internal to the controller.
pub type CNTGATECLK_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `RAMGATEEN` reader - Enable RAM clock gating Enable gating of the FIFO RAM.
pub type RAMGATEEN_R = crate::BitReader;
///Field `RAMGATEEN` writer - Enable RAM clock gating Enable gating of the FIFO RAM.
...
impl W {
    ///Bit 0 - Enable active clock gating The application programs GATEEN to enable Active Clock Gating feature for the PHY and AHB clocks.
    #[inline(always)]
    pub fn gateen(&mut self) -> GATEEN_W<PCGCCTL1rs> {
        GATEEN_W::new(self, 0)
    }
    ///Bits 1:2 - Counter for clock gating Indicates to the controller how many PHY Clock cycles and AHB Clock cycles of 'IDLE' (no activity) the controller waits for before Gating the respective PHY and AHB clocks internal to the controller.
    #[inline(always)]
    pub fn cntgateclk(&mut self) -> CNTGATECLK_W<PCGCCTL1rs> {
        CNTGATECLK_W::new(self, 1)
    }
    ///Bit 3 - Enable RAM clock gating Enable gating of the FIFO RAM.
    #[inline(always)]
    pub fn ramgateen(&mut self) -> RAMGATEEN_W<PCGCCTL1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#OTG_HS:PCGCCTL1)*/
