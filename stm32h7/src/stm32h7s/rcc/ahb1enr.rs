...
///Field `ADC12EN` reader - ADC1 and 2 peripheral clocks enable Set and reset by software. The peripheral clocks of the ADC1 and 2 are the kernel clock selected by ADCSEL and provided to ADCx_CK input, and the hclk1 bus interface clock.
pub use GPDMA1EN_R as ADC12EN_R;
///Field `ETH1MACEN` reader - ETH1 MAC peripheral clock enable Set and reset by software.
pub use GPDMA1EN_R as ETH1MACEN_R;
///Field `ETH1TXEN` reader - ETH1 transmission clock enable Set and reset by software.
pub use GPDMA1EN_R as ETH1TXEN_R;
///Field `ETH1RXEN` reader - ETH1 reception clock enable Set and reset by software.
pub use GPDMA1EN_R as ETH1RXEN_R;
///Field `OTGHSEN` reader - OTGHS clocks enable Set and reset by software.
pub use GPDMA1EN_R as OTGHSEN_R;
///Field `USBPHYCEN` reader - USBPHYC clocks enable Set and reset by software.
pub use GPDMA1EN_R as USBPHYCEN_R;
///Field `OTGFSEN` reader - OTGFS peripheral clocks enable Set and reset by software.
pub use GPDMA1EN_R as OTGFSEN_R;
///Field `ADFEN` reader - ADF clocks enable Set and reset by software.
pub use GPDMA1EN_R as ADFEN_R;
///Field `ADC12EN` writer - ADC1 and 2 peripheral clocks enable Set and reset by software. The peripheral clocks of the ADC1 and 2 are the kernel clock selected by ADCSEL and provided to ADCx_CK input, and the hclk1 bus interface clock.
pub use GPDMA1EN_W as ADC12EN_W;
///Field `ETH1MACEN` writer - ETH1 MAC peripheral clock enable Set and reset by software.
pub use GPDMA1EN_W as ETH1MACEN_W;
///Field `ETH1TXEN` writer - ETH1 transmission clock enable Set and reset by software.
pub use GPDMA1EN_W as ETH1TXEN_W;
///Field `ETH1RXEN` writer - ETH1 reception clock enable Set and reset by software.
pub use GPDMA1EN_W as ETH1RXEN_W;
///Field `OTGHSEN` writer - OTGHS clocks enable Set and reset by software.
pub use GPDMA1EN_W as OTGHSEN_W;
///Field `USBPHYCEN` writer - USBPHYC clocks enable Set and reset by software.
pub use GPDMA1EN_W as USBPHYCEN_W;
///Field `OTGFSEN` writer - OTGFS peripheral clocks enable Set and reset by software.
pub use GPDMA1EN_W as OTGFSEN_W;
///Field `ADFEN` writer - ADF clocks enable Set and reset by software.
pub use GPDMA1EN_W as ADFEN_W;
impl R {
    ...
    #[inline(always)]
    pub fn adfen(&self) -> ADFEN_R {
        ADFEN_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl W {
    ...
    ///Bit 26 - USBPHYC clocks enable Set and reset by software.
    #[inline(always)]
    pub fn usbphycen(&mut self) -> USBPHYCEN_W<AHB1ENRrs> {
        USBPHYCEN_W::new(self, 26)
    }
    ///Bit 27 - OTGFS peripheral clocks enable Set and reset by software.
    #[inline(always)]
    pub fn otgfsen(&mut self) -> OTGFSEN_W<AHB1ENRrs> {
        OTGFSEN_W::new(self, 27)
    }
    ///Bit 31 - ADF clocks enable Set and reset by software.
    #[inline(always)]
    pub fn adfen(&mut self) -> ADFEN_W<AHB1ENRrs> {
        ADFEN_W::new(self, 31)
    }
}
