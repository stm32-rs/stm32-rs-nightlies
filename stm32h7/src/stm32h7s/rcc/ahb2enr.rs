...
///Field `PSSIEN` reader - PSSI peripheral clocks enable Set and reset by software.
...
///Field `PSSIEN` writer - PSSI peripheral clocks enable Set and reset by software.
...
impl W {
    ///Bit 1 - PSSI peripheral clocks enable Set and reset by software.
    #[inline(always)]
    pub fn pssien(&mut self) -> PSSIEN_W<AHB2ENRrs> {
        PSSIEN_W::new(self, 1)
    }
    ///Bit 9 - SDMMC2 and SDMMC2 delay clock enable Set and reset by software.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:AHB2ENR)*/
