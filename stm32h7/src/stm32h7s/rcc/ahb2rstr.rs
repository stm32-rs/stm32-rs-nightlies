...
///Field `PSSIRST` reader - PSSI block reset Set and reset by software.
...
///Field `PSSIRST` writer - PSSI block reset Set and reset by software.
...
///Field `CORDICRST` reader - CORDIC reset Set and reset by software.
...
///Field `CORDICRST` writer - CORDIC reset Set and reset by software.
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pssirst(&mut self) -> PSSIRST_W<AHB2RSTRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cordicrst(&mut self) -> CORDICRST_W<AHB2RSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:AHB2RSTR)*/
