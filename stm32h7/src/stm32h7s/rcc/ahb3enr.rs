...
///Field `CRYPEN` reader - CRYP peripheral clock enable Set and reset by software.
pub use RNGEN_R as CRYPEN_R;
///Field `SAESEN` reader - SAES peripheral clock enable Set and reset by software. This bit controls the enable of the clock delivered to the SAES.
pub use RNGEN_R as SAESEN_R;
///Field `PKAEN` reader - PKA peripheral clock enable Set and reset by software.
...
///Field `CRYPEN` writer - CRYP peripheral clock enable Set and reset by software.
pub use RNGEN_W as CRYPEN_W;
///Field `SAESEN` writer - SAES peripheral clock enable Set and reset by software. This bit controls the enable of the clock delivered to the SAES.
pub use RNGEN_W as SAESEN_W;
///Field `PKAEN` writer - PKA peripheral clock enable Set and reset by software.
