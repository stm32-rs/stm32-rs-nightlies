...
///Field `RNGLPEN` reader - RNG peripheral clock enable in low-power mode Set and reset by software.
...
///Field `RNGLPEN` writer - RNG peripheral clock enable in low-power mode Set and reset by software.
...
///Field `HASHLPEN` reader - HASH peripheral clock enable in low-power mode Set and reset by software.
pub use RNGLPEN_R as HASHLPEN_R;
///Field `CRYPLPEN` reader - CRYP peripheral clock enable in low-power mode Set and reset by software.
pub use RNGLPEN_R as CRYPLPEN_R;
///Field `SAESLPEN` reader - SAES peripheral clock enable in low-power mode Set and reset by software.
pub use RNGLPEN_R as SAESLPEN_R;
///Field `PKALPEN` reader - PKA peripheral clock enable in low-power mode Set and reset by software.
pub use RNGLPEN_R as PKALPEN_R;
///Field `HASHLPEN` writer - HASH peripheral clock enable in low-power mode Set and reset by software.
pub use RNGLPEN_W as HASHLPEN_W;
///Field `CRYPLPEN` writer - CRYP peripheral clock enable in low-power mode Set and reset by software.
pub use RNGLPEN_W as CRYPLPEN_W;
///Field `SAESLPEN` writer - SAES peripheral clock enable in low-power mode Set and reset by software.
pub use RNGLPEN_W as SAESLPEN_W;
///Field `PKALPEN` writer - PKA peripheral clock enable in low-power mode Set and reset by software.
