...
///Field `AXISRAMLPEN` reader - AXISRAM\[4:1\] low-power peripheral clock enable Set and reset by software.
...
///Field `AXISRAMLPEN` writer - AXISRAM\[4:1\] low-power peripheral clock enable Set and reset by software.
