...
///Field `HPDMA1RST` reader - HPDMA1 block reset Set and reset by software.
...
///Field `HPDMA1RST` writer - HPDMA1 block reset Set and reset by software.
...
///Field `JPEGRST` reader - JPEG block reset Set and reset by software.
pub use HPDMA1RST_R as JPEGRST_R;
///Field `FMCRST` reader - FMC and MCE3 blocks reset Set and reset by software. The hardware prevents writing this bit if FMCCKP = 1.
pub use HPDMA1RST_R as FMCRST_R;
///Field `XSPI1RST` reader - XSPI1 and MCE1 blocks reset Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
pub use HPDMA1RST_R as XSPI1RST_R;
///Field `SDMMC1RST` reader - SDMMC1 and DB_SDMMC1 blocks reset Set and reset by software.
pub use HPDMA1RST_R as SDMMC1RST_R;
///Field `XSPI2RST` reader - XSPI2 and MCE2 blocks reset Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
pub use HPDMA1RST_R as XSPI2RST_R;
///Field `XSPIMRST` reader - XSPIM reset Set and reset by software.
pub use HPDMA1RST_R as XSPIMRST_R;
///Field `GFXMMURST` reader - GFXMMU block reset Set and reset by software.
pub use HPDMA1RST_R as GFXMMURST_R;
///Field `GPURST` reader - GPU block reset Set and reset by software.
...
///Field `JPEGRST` writer - JPEG block reset Set and reset by software.
pub use HPDMA1RST_W as JPEGRST_W;
///Field `FMCRST` writer - FMC and MCE3 blocks reset Set and reset by software. The hardware prevents writing this bit if FMCCKP = 1.
pub use HPDMA1RST_W as FMCRST_W;
///Field `XSPI1RST` writer - XSPI1 and MCE1 blocks reset Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
pub use HPDMA1RST_W as XSPI1RST_W;
///Field `SDMMC1RST` writer - SDMMC1 and DB_SDMMC1 blocks reset Set and reset by software.
pub use HPDMA1RST_W as SDMMC1RST_W;
///Field `XSPI2RST` writer - XSPI2 and MCE2 blocks reset Set and reset by software. The hardware prevents writing this bit if XSPICKP = 1.
pub use HPDMA1RST_W as XSPI2RST_W;
///Field `XSPIMRST` writer - XSPIM reset Set and reset by software.
pub use HPDMA1RST_W as XSPIMRST_W;
///Field `GFXMMURST` writer - GFXMMU block reset Set and reset by software.
pub use HPDMA1RST_W as GFXMMURST_W;
///Field `GPURST` writer - GPU block reset Set and reset by software.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:AHB5RSTR)*/
