...
///Field `TIM2LPEN` reader - TIM2 peripheral clock enable in low-power mode Set and reset by software.
...
///Field `TIM2LPEN` writer - TIM2 peripheral clock enable in low-power mode Set and reset by software.
...
///Field `TIM3LPEN` reader - TIM3 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as TIM3LPEN_R;
///Field `TIM4LPEN` reader - TIM4 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as TIM4LPEN_R;
///Field `TIM5LPEN` reader - TIM5 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as TIM5LPEN_R;
///Field `TIM6LPEN` reader - TIM6 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as TIM6LPEN_R;
///Field `TIM7LPEN` reader - TIM7 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as TIM7LPEN_R;
///Field `TIM12LPEN` reader - TIM12 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as TIM12LPEN_R;
///Field `TIM13LPEN` reader - TIM13 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as TIM13LPEN_R;
///Field `TIM14LPEN` reader - TIM14 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as TIM14LPEN_R;
///Field `LPTIM1LPEN` reader - LPTIM1 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as LPTIM1LPEN_R;
///Field `WWDGLPEN` reader - WWDG clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as WWDGLPEN_R;
///Field `SPI2LPEN` reader - SPI2 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as SPI2LPEN_R;
///Field `SPI3LPEN` reader - SPI3 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as SPI3LPEN_R;
///Field `SPDIFRXLPEN` reader - SPDIFRX peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as SPDIFRXLPEN_R;
///Field `USART2LPEN` reader - USART2 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as USART2LPEN_R;
///Field `USART3LPEN` reader - USART3 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as USART3LPEN_R;
///Field `UART4LPEN` reader - UART4 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as UART4LPEN_R;
///Field `UART5LPEN` reader - UART5 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as UART5LPEN_R;
///Field `I2C1_I3C1LPEN` reader - I2C1/I3C1 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as I2C1_I3C1LPEN_R;
///Field `I2C2LPEN` reader - I2C2 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as I2C2LPEN_R;
///Field `I2C3LPEN` reader - I2C3 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as I2C3LPEN_R;
///Field `HDMICECLPEN` reader - HDMI-CEC peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as HDMICECLPEN_R;
///Field `UART7LPEN` reader - UART7 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as UART7LPEN_R;
///Field `UART8LPEN` reader - UART8 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_R as UART8LPEN_R;
///Field `TIM3LPEN` writer - TIM3 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as TIM3LPEN_W;
///Field `TIM4LPEN` writer - TIM4 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as TIM4LPEN_W;
///Field `TIM5LPEN` writer - TIM5 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as TIM5LPEN_W;
///Field `TIM6LPEN` writer - TIM6 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as TIM6LPEN_W;
///Field `TIM7LPEN` writer - TIM7 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as TIM7LPEN_W;
///Field `TIM12LPEN` writer - TIM12 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as TIM12LPEN_W;
///Field `TIM13LPEN` writer - TIM13 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as TIM13LPEN_W;
///Field `TIM14LPEN` writer - TIM14 peripheral clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as TIM14LPEN_W;
///Field `LPTIM1LPEN` writer - LPTIM1 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as LPTIM1LPEN_W;
///Field `WWDGLPEN` writer - WWDG clock enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as WWDGLPEN_W;
///Field `SPI2LPEN` writer - SPI2 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as SPI2LPEN_W;
///Field `SPI3LPEN` writer - SPI3 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as SPI3LPEN_W;
///Field `SPDIFRXLPEN` writer - SPDIFRX peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as SPDIFRXLPEN_W;
///Field `USART2LPEN` writer - USART2 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as USART2LPEN_W;
///Field `USART3LPEN` writer - USART3 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as USART3LPEN_W;
///Field `UART4LPEN` writer - UART4 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as UART4LPEN_W;
///Field `UART5LPEN` writer - UART5 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as UART5LPEN_W;
///Field `I2C1_I3C1LPEN` writer - I2C1/I3C1 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as I2C1_I3C1LPEN_W;
///Field `I2C2LPEN` writer - I2C2 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as I2C2LPEN_W;
///Field `I2C3LPEN` writer - I2C3 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as I2C3LPEN_W;
///Field `HDMICECLPEN` writer - HDMI-CEC peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as HDMICECLPEN_W;
///Field `UART7LPEN` writer - UART7 peripheral clocks enable in low-power mode Set and reset by software.
pub use TIM2LPEN_W as UART7LPEN_W;
///Field `UART8LPEN` writer - UART8 peripheral clocks enable in low-power mode Set and reset by software.
...
impl R {
    ...
    #[inline(always)]
    pub fn i2c1_i3c1lpen(&self) -> I2C1_I3C1LPEN_R {
        I2C1_I3C1LPEN_R::new(((self.bits >> 21) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn hdmiceclpen(&self) -> HDMICECLPEN_R {
        HDMICECLPEN_R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB1LLPENR")
            ...
            .field("hdmiceclpen", &self.hdmiceclpen())
...
impl W {
    ...
    ///Bit 21 - I2C1/I3C1 peripheral clocks enable in low-power mode Set and reset by software.
    #[inline(always)]
    pub fn i2c1_i3c1lpen(&mut self) -> I2C1_I3C1LPEN_W<APB1LLPENRrs> {
        I2C1_I3C1LPEN_W::new(self, 21)
    }
    ///Bit 22 - I2C2 peripheral clocks enable in low-power mode Set and reset by software.
    #[inline(always)]
    ...
    ///Bit 27 - HDMI-CEC peripheral clocks enable in low-power mode Set and reset by software.
    #[inline(always)]
    pub fn hdmiceclpen(&mut self) -> HDMICECLPEN_W<APB1LLPENRrs> {
        HDMICECLPEN_W::new(self, 27)
    }
    ///Bit 30 - UART7 peripheral clocks enable in low-power mode Set and reset by software.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:APB1LLPENR)*/
...
///`reset()` method sets APB1LLPENR to value 0xc8ff_cbff
impl crate::Resettable for APB1LLPENRrs {
    const RESET_VALUE: u32 = 0xc8ff_cbff;
}
