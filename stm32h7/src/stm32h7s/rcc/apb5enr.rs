...
///Field `LTDCEN` reader - LTDC peripheral clock enable Provides the pixel clock (ltdc_clk) to the LTDC block. Set and reset by software.
...
///Field `LTDCEN` writer - LTDC peripheral clock enable Provides the pixel clock (ltdc_clk) to the LTDC block. Set and reset by software.
...
///Field `DCMIPPEN` reader - DCMIPP peripheral clock enable Set and reset by software.
pub use LTDCEN_R as DCMIPPEN_R;
///Field `GFXTIMEN` reader - GFXTIM peripheral clock enable Set and reset by software.
pub use LTDCEN_R as GFXTIMEN_R;
///Field `DCMIPPEN` writer - DCMIPP peripheral clock enable Set and reset by software.
pub use LTDCEN_W as DCMIPPEN_W;
///Field `GFXTIMEN` writer - GFXTIM peripheral clock enable Set and reset by software.
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ltdcen(&mut self) -> LTDCEN_W<APB5ENRrs> {
        LTDCEN_W::new(self, 1)
    }
    ///Bit 2 - DCMIPP peripheral clock enable Set and reset by software.
    #[inline(always)]
    #[must_use]
    pub fn dcmippen(&mut self) -> DCMIPPEN_W<APB5ENRrs> {
        DCMIPPEN_W::new(self, 2)
    }
    ///Bit 4 - GFXTIM peripheral clock enable Set and reset by software.
    #[inline(always)]
    #[must_use]
    pub fn gfxtimen(&mut self) -> GFXTIMEN_W<APB5ENRrs> {
