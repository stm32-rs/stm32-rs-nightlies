...
///Field `LTDCLPEN` reader - LTDC peripheral clock enable in low-power mode Set and reset by software.
...
///Field `LTDCLPEN` writer - LTDC peripheral clock enable in low-power mode Set and reset by software.
...
///Field `DCMIPPLPEN` reader - DCMIPP peripheral clock enable in low-power mode Set and reset by software.
pub use LTDCLPEN_R as DCMIPPLPEN_R;
///Field `GFXTIMLPEN` reader - GFXTIM peripheral clock enable in low-power mode Set and reset by software.
pub use LTDCLPEN_R as GFXTIMLPEN_R;
///Field `DCMIPPLPEN` writer - DCMIPP peripheral clock enable in low-power mode Set and reset by software.
pub use LTDCLPEN_W as DCMIPPLPEN_W;
///Field `GFXTIMLPEN` writer - GFXTIM peripheral clock enable in low-power mode Set and reset by software.
...
impl W {
    ///Bit 1 - LTDC peripheral clock enable in low-power mode Set and reset by software.
    #[inline(always)]
    pub fn ltdclpen(&mut self) -> LTDCLPEN_W<APB5LPENRrs> {
        LTDCLPEN_W::new(self, 1)
    }
    ///Bit 2 - DCMIPP peripheral clock enable in low-power mode Set and reset by software.
    #[inline(always)]
    pub fn dcmipplpen(&mut self) -> DCMIPPLPEN_W<APB5LPENRrs> {
        DCMIPPLPEN_W::new(self, 2)
    }
    ///Bit 4 - GFXTIM peripheral clock enable in low-power mode Set and reset by software.
    #[inline(always)]
    pub fn gfxtimlpen(&mut self) -> GFXTIMLPEN_W<APB5LPENRrs> {
