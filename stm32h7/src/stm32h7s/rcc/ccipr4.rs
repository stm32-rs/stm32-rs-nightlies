...
///Field `SPI6SEL` reader - SPI/I2S6 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
///Field `SPI6SEL` writer - SPI/I2S6 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
///Field `LPTIM23SEL` reader - LPTIM2 and LPTIM3 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
///Field `LPTIM23SEL` writer - LPTIM2 and LPTIM3 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
///Field `LPTIM45SEL` reader - LPTIM4, and LPTIM5 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
///Field `LPTIM45SEL` writer - LPTIM4, and LPTIM5 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:CCIPR4)*/
pub struct CCIPR4rs;
