...
///Field `CSIRDYC` reader - CSI ready interrupt clear
...
///Field `CSIRDYC` writer - CSI ready interrupt clear
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:CICR)*/
pub struct CICRrs;
