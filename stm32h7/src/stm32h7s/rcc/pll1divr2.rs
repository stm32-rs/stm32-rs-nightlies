...
///Field `DIVS` reader - PLL1 DIVS division factor
pub type DIVS_R = crate::FieldReader;
///Field `DIVS` writer - PLL1 DIVS division factor
pub type DIVS_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2 - PLL1 DIVS division factor
    #[inline(always)]
...
impl W {
    ///Bits 0:2 - PLL1 DIVS division factor
    #[inline(always)]
    pub fn divs(&mut self) -> DIVS_W<'_, PLL1DIVR2rs> {
        DIVS_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:PLL1DIVR2)*/
