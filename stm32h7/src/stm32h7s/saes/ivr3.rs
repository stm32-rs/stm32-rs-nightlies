...
///Field `IVI` reader - Initialization vector input, bits \[127:96\] Refer to the SAES_IVR0 register for description of the IVI\[128:0\] bitfield.
pub type IVI_R = crate::FieldReader<u32>;
///Field `IVI` writer - Initialization vector input, bits \[127:96\] Refer to the SAES_IVR0 register for description of the IVI\[128:0\] bitfield.
...
impl W {
    ///Bits 0:31 - Initialization vector input, bits \[127:96\] Refer to the SAES_IVR0 register for description of the IVI\[128:0\] bitfield.
    #[inline(always)]
    pub fn ivi(&mut self) -> IVI_W<'_, IVR3rs> {
        IVI_W::new(self, 0)
    }
}
