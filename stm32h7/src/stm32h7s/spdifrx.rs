...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn fmt0_dr_alternate2(&self) -> &FMT0_DR_ALTERNATE2 {
        unsafe { &*(self as *const Self).cast::<u8>().add(16).cast() }
    }
    ///0x10 - SPDIFRX data input register
    #[inline(always)]
    pub const fn fmt0_dr_alternate1(&self) -> &FMT0_DR_ALTERNATE1 {
        unsafe { &*(self as *const Self).cast::<u8>().add(16).cast() }
    }
    ///0x10 - SPDIFRX data input register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#SPDIFRX:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#SPDIFRX:IMR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#SPDIFRX:IFCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#SPDIFRX:FMT0_DR)

For information about available fields see [`mod@fmt0_dr`]
module*/
pub type FMT0_DR = crate::Reg<fmt0_dr::FMT0_DRrs>;
///SPDIFRX data input register
pub mod fmt0_dr;
/**FMT0_DR_alternate1 (r) register accessor: SPDIFRX data input register

You can [`read`](crate::Reg::read) this register and get [`fmt0_dr_alternate1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#SPDIFRX:FMT0_DR_alternate1)

For information about available fields see [`mod@fmt0_dr_alternate1`]
module*/
#[doc(alias = "FMT0_DR_alternate1")]
pub type FMT0_DR_ALTERNATE1 = crate::Reg<fmt0_dr_alternate1::FMT0_DR_ALTERNATE1rs>;
///SPDIFRX data input register
pub mod fmt0_dr_alternate1;
/**FMT0_DR_alternate2 (r) register accessor: SPDIFRX data input register

You can [`read`](crate::Reg::read) this register and get [`fmt0_dr_alternate2::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#SPDIFRX:FMT0_DR_alternate2)

For information about available fields see [`mod@fmt0_dr_alternate2`]
module*/
#[doc(alias = "FMT0_DR_alternate2")]
pub type FMT0_DR_ALTERNATE2 = crate::Reg<fmt0_dr_alternate2::FMT0_DR_ALTERNATE2rs>;
///SPDIFRX data input register
pub mod fmt0_dr_alternate2;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#SPDIFRX:CSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#SPDIFRX:DIR)
