...
///Field `ATPER` reader - Active tamper output change period The tamper output is changed every CK_ATPER = (2<sup>ATPER </sup>x CK_ATPRE) cycles. Refer to Table 386: Minimum ATPER value.
pub type ATPER_R = crate::FieldReader;
///Field `ATPER` writer - Active tamper output change period The tamper output is changed every CK_ATPER = (2<sup>ATPER </sup>x CK_ATPRE) cycles. Refer to Table 386: Minimum ATPER value.
...
impl W {
    ...
    ///Bit 3 - Tamper 4 active mode
    #[inline(always)]
    pub fn tamp4am(&mut self) -> TAMP4AM_W<'_, ATCR1rs> {
        TAMP4AM_W::new(self, 3)
    }
    ///Bit 4 - Tamper 5 active mode
    #[inline(always)]
    pub fn tamp5am(&mut self) -> TAMP5AM_W<'_, ATCR1rs> {
        TAMP5AM_W::new(self, 4)
    }
    ///Bit 5 - Tamper 6 active mode
    #[inline(always)]
    pub fn tamp6am(&mut self) -> TAMP6AM_W<'_, ATCR1rs> {
        TAMP6AM_W::new(self, 5)
    }
    ///Bit 6 - Tamper 7 active mode
    #[inline(always)]
    pub fn tamp7am(&mut self) -> TAMP7AM_W<'_, ATCR1rs> {
        TAMP7AM_W::new(self, 6)
    }
    ///Bit 7 - Tamper 8 active mode
    #[inline(always)]
    pub fn tamp8am(&mut self) -> TAMP8AM_W<'_, ATCR1rs> {
    ...
    ///Bits 14:15 - Active tamper shared output 4 selection The selected output must be available in the package pinout.
    #[inline(always)]
    pub fn atosel4(&mut self) -> ATOSEL4_W<'_, ATCR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#TAMP:ATCR1)*/
pub struct ATCR1rs;
