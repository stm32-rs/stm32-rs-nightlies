...
/**Field `TI1SEL` reader - Selects tim_ti1\[15:0\]
input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
pub type TI1SEL_R = crate::FieldReader;
/**Field `TI1SEL` writer - Selects tim_ti1\[15:0\]
input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
pub type TI1SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
/**Field `TI2SEL` reader - Selects tim_ti2\[15:0\]
input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
pub type TI2SEL_R = crate::FieldReader;
/**Field `TI2SEL` writer - Selects tim_ti2\[15:0\]
input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
pub type TI2SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
/**Field `TI3SEL` reader - Selects tim_ti3\[15:0\]
input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
pub type TI3SEL_R = crate::FieldReader;
/**Field `TI3SEL` writer - Selects tim_ti3\[15:0\]
input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
pub type TI3SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
/**Field `TI4SEL` reader - Selects tim_ti4\[15:0\]
input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
pub type TI4SEL_R = crate::FieldReader;
/**Field `TI4SEL` writer - Selects tim_ti4\[15:0\]
input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
pub type TI4SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    /**Bits 0:3 - Selects tim_ti1\[15:0\]
    input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
    #[inline(always)]
    pub fn ti1sel(&self) -> TI1SEL_R {
        TI1SEL_R::new((self.bits & 0x0f) as u8)
    }
    /**Bits 8:11 - Selects tim_ti2\[15:0\]
    input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
    #[inline(always)]
    pub fn ti2sel(&self) -> TI2SEL_R {
        TI2SEL_R::new(((self.bits >> 8) & 0x0f) as u8)
    }
    /**Bits 16:19 - Selects tim_ti3\[15:0\]
    input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
    #[inline(always)]
    pub fn ti3sel(&self) -> TI3SEL_R {
        TI3SEL_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
    /**Bits 24:27 - Selects tim_ti4\[15:0\]
    input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.*/
    #[inline(always)]
