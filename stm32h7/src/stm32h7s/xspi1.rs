...
impl RegisterBlock {
    ///0x00 - XSPI control register
    #[inline(always)]
    pub const fn cr(&self) -> &CR {
        &self.cr
    }
    ///0x08 - XSPI device configuration register 1
    #[inline(always)]
    pub const fn dcr1(&self) -> &DCR1 {
        &self.dcr1
    }
    ///0x0c - XSPI device configuration register 2
    #[inline(always)]
    pub const fn dcr2(&self) -> &DCR2 {
        &self.dcr2
    }
    ///0x10 - XSPI device configuration register 3
    #[inline(always)]
    pub const fn dcr3(&self) -> &DCR3 {
        &self.dcr3
    }
    ///0x14 - XSPI device configuration register 4
    #[inline(always)]
    pub const fn dcr4(&self) -> &DCR4 {
        &self.dcr4
    }
    ///0x20 - XSPI status register
    #[inline(always)]
    pub const fn sr(&self) -> &SR {
        &self.sr
    }
    ///0x24 - XSPI flag clear register
    #[inline(always)]
    pub const fn fcr(&self) -> &FCR {
        &self.fcr
    }
    ///0x40 - XSPI data length register
    #[inline(always)]
    pub const fn dlr(&self) -> &DLR {
        &self.dlr
    }
    ///0x48 - XSPIaddress register
    #[inline(always)]
    pub const fn ar(&self) -> &AR {
        &self.ar
    }
    ///0x50 - XSPI data register
    #[inline(always)]
    pub const fn dr(&self) -> &DR {
        &self.dr
    }
    ///0x80 - XSPI polling status mask register
    #[inline(always)]
    pub const fn psmkr(&self) -> &PSMKR {
        &self.psmkr
    }
    ///0x88 - XSPI polling status match register
    #[inline(always)]
    pub const fn psmar(&self) -> &PSMAR {
        &self.psmar
    }
    ///0x90 - XSPI polling interval register
    #[inline(always)]
    pub const fn pir(&self) -> &PIR {
        &self.pir
    }
    ///0x100 - XSPI communication configuration register
    #[inline(always)]
    pub const fn ccr(&self) -> &CCR {
        &self.ccr
    }
    ///0x108 - XSPI timing configuration register
    #[inline(always)]
    pub const fn tcr(&self) -> &TCR {
        &self.tcr
    }
    ///0x110 - XSPI instruction register
    #[inline(always)]
    pub const fn ir(&self) -> &IR {
        &self.ir
    }
    ///0x120 - XSPI alternate bytes register
    #[inline(always)]
    pub const fn abr(&self) -> &ABR {
        &self.abr
    }
    ///0x130 - XSPI low-power timeout register
    #[inline(always)]
    pub const fn lptr(&self) -> &LPTR {
        &self.lptr
    }
    ///0x140 - XSPI wrap communication configuration register
    #[inline(always)]
    pub const fn wpccr(&self) -> &WPCCR {
        &self.wpccr
    }
    ///0x148 - XSPI wrap timing configuration register
    #[inline(always)]
    pub const fn wptcr(&self) -> &WPTCR {
        &self.wptcr
    }
    ///0x150 - XSPI wrap instruction register
    #[inline(always)]
    pub const fn wpir(&self) -> &WPIR {
        &self.wpir
    }
    ///0x160 - XSPI wrap alternate byte register
    #[inline(always)]
    pub const fn wpabr(&self) -> &WPABR {
        &self.wpabr
    }
    ///0x180 - XSPI write communication configuration register
    #[inline(always)]
    pub const fn wccr(&self) -> &WCCR {
        &self.wccr
    }
    ///0x188 - XSPI write timing configuration register
    #[inline(always)]
    pub const fn wtcr(&self) -> &WTCR {
        &self.wtcr
    }
    ///0x190 - XSPI write instruction register
    #[inline(always)]
    pub const fn wir(&self) -> &WIR {
        &self.wir
    }
    ///0x1a0 - XSPI write alternate byte register
    #[inline(always)]
    pub const fn wabr(&self) -> &WABR {
        &self.wabr
    }
    ///0x200 - XSPI HyperBus latency configuration register
    #[inline(always)]
    pub const fn hlcr(&self) -> &HLCR {
        &self.hlcr
    }
    ///0x210 - XSPI full-cycle calibration configuration
    #[inline(always)]
    pub const fn calfcr(&self) -> &CALFCR {
        &self.calfcr
    }
    ///0x218 - XSPI DLL master calibration configuration
    #[inline(always)]
    pub const fn calmr(&self) -> &CALMR {
        &self.calmr
    }
    ///0x220 - XSPI DLL slave output calibration configuration
    #[inline(always)]
    pub const fn calsor(&self) -> &CALSOR {
        &self.calsor
    }
    ///0x228 - XSPI DLL slave input calibration configuration
    #[inline(always)]
    pub const fn calsir(&self) -> &CALSIR {
        &self.calsir
    }
}
/**CR (rw) register accessor: XSPI control register

You can [`read`](crate::Reg::read) this register and get [`cr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:CR)
...
pub mod cr;
/**DCR1 (rw) register accessor: XSPI device configuration register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:DCR1)
...
pub mod dcr1;
/**DCR2 (rw) register accessor: XSPI device configuration register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:DCR2)
...
pub mod dcr2;
/**DCR3 (rw) register accessor: XSPI device configuration register 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:DCR3)
...
pub mod dcr3;
/**DCR4 (rw) register accessor: XSPI device configuration register 4
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:DCR4)
...
pub mod dcr4;
/**SR (r) register accessor: XSPI status register

You can [`read`](crate::Reg::read) this register and get [`sr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:SR)
...
pub mod sr;
/**FCR (w) register accessor: XSPI flag clear register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:FCR)
...
pub mod fcr;
/**DLR (rw) register accessor: XSPI data length register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:DLR)
...
pub mod dlr;
/**AR (rw) register accessor: XSPIaddress register
...
pub mod ar;
/**DR (rw) register accessor: XSPI data register

You can [`read`](crate::Reg::read) this register and get [`dr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:DR)
...
///XSPI data register
pub mod dr;
/**PSMKR (rw) register accessor: XSPI polling status mask register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:PSMKR)
...
pub mod psmkr;
/**PSMAR (rw) register accessor: XSPI polling status match register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:PSMAR)
...
pub mod psmar;
/**PIR (rw) register accessor: XSPI polling interval register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:PIR)
...
pub mod pir;
/**CCR (rw) register accessor: XSPI communication configuration register

You can [`read`](crate::Reg::read) this register and get [`ccr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:CCR)
...
pub mod ccr;
/**TCR (rw) register accessor: XSPI timing configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:TCR)
...
pub mod tcr;
/**IR (rw) register accessor: XSPI instruction register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:IR)
...
pub mod ir;
/**ABR (rw) register accessor: XSPI alternate bytes register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:ABR)
...
pub mod abr;
/**LPTR (rw) register accessor: XSPI low-power timeout register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:LPTR)
...
pub mod lptr;
/**WPCCR (rw) register accessor: XSPI wrap communication configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:WPCCR)
...
pub mod wpccr;
/**WPTCR (rw) register accessor: XSPI wrap timing configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:WPTCR)
...
pub mod wptcr;
/**WPIR (rw) register accessor: XSPI wrap instruction register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:WPIR)
...
pub mod wpir;
/**WPABR (rw) register accessor: XSPI wrap alternate byte register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:WPABR)
...
pub mod wpabr;
/**WCCR (rw) register accessor: XSPI write communication configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:WCCR)
...
pub mod wccr;
/**WTCR (rw) register accessor: XSPI write timing configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:WTCR)
...
pub mod wtcr;
/**WIR (rw) register accessor: XSPI write instruction register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:WIR)
...
pub mod wir;
/**WABR (rw) register accessor: XSPI write alternate byte register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:WABR)
...
pub mod wabr;
/**HLCR (rw) register accessor: XSPI HyperBus latency configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:HLCR)
...
pub mod hlcr;
/**CALFCR (r) register accessor: XSPI full-cycle calibration configuration

You can [`read`](crate::Reg::read) this register and get [`calfcr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:CALFCR)

For information about available fields see [`mod@calfcr`]
module*/
pub type CALFCR = crate::Reg<calfcr::CALFCRrs>;
///XSPI full-cycle calibration configuration
pub mod calfcr;
/**CALMR (rw) register accessor: XSPI DLL master calibration configuration
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:CALMR)

For information about available fields see [`mod@calmr`]
module*/
pub type CALMR = crate::Reg<calmr::CALMRrs>;
///XSPI DLL master calibration configuration
pub mod calmr;
/**CALSOR (rw) register accessor: XSPI DLL slave output calibration configuration
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:CALSOR)

For information about available fields see [`mod@calsor`]
module*/
pub type CALSOR = crate::Reg<calsor::CALSORrs>;
///XSPI DLL slave output calibration configuration
pub mod calsor;
/**CALSIR (rw) register accessor: XSPI DLL slave input calibration configuration
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#XSPI1:CALSIR)

For information about available fields see [`mod@calsir`]
module*/
