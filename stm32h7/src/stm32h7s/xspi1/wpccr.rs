...
///Field `IMODE` reader - Instruction mode This field defines the instruction phase mode of operation. Others: reserved
pub type IMODE_R = crate::FieldReader;
///Field `IMODE` writer - Instruction mode This field defines the instruction phase mode of operation. Others: reserved
...
///Field `ADMODE` reader - Address mode This field defines the address phase mode of operation. Others: reserved
pub type ADMODE_R = crate::FieldReader;
///Field `ADMODE` writer - Address mode This field defines the address phase mode of operation. Others: reserved
...
///Field `DMODE` reader - Data mode This field defines the data phase mode of operation. 101; data on 16 lines Others: reserved
pub type DMODE_R = crate::FieldReader;
///Field `DMODE` writer - Data mode This field defines the data phase mode of operation. 101; data on 16 lines Others: reserved
...
impl W {
    ///Bits 0:2 - Instruction mode This field defines the instruction phase mode of operation. Others: reserved
    #[inline(always)]
    pub fn imode(&mut self) -> IMODE_W<'_, WPCCRrs> {
        IMODE_W::new(self, 0)
    }
    ///Bit 3 - Instruction double transfer rate This bit sets the DTR mode for the instruction phase.
    #[inline(always)]
    pub fn idtr(&mut self) -> IDTR_W<'_, WPCCRrs> {
        IDTR_W::new(self, 3)
    }
    ///Bits 4:5 - Instruction size This field defines instruction size.
    #[inline(always)]
    pub fn isize(&mut self) -> ISIZE_W<'_, WPCCRrs> {
        ISIZE_W::new(self, 4)
    }
    ///Bits 8:10 - Address mode This field defines the address phase mode of operation. Others: reserved
    #[inline(always)]
    pub fn admode(&mut self) -> ADMODE_W<'_, WPCCRrs> {
        ADMODE_W::new(self, 8)
    }
    ///Bit 11 - Address double transfer rate This bit sets the DTR mode for the address phase.
    #[inline(always)]
    pub fn addtr(&mut self) -> ADDTR_W<'_, WPCCRrs> {
        ADDTR_W::new(self, 11)
    }
    ///Bits 12:13 - Address size This field defines address size.
    #[inline(always)]
    pub fn adsize(&mut self) -> ADSIZE_W<'_, WPCCRrs> {
        ADSIZE_W::new(self, 12)
    }
    ///Bits 16:18 - Alternate-byte mode This field defines the alternate byte phase mode of operation.
    #[inline(always)]
    pub fn abmode(&mut self) -> ABMODE_W<'_, WPCCRrs> {
        ABMODE_W::new(self, 16)
    }
    ///Bit 19 - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase.
    #[inline(always)]
    pub fn abdtr(&mut self) -> ABDTR_W<'_, WPCCRrs> {
        ABDTR_W::new(self, 19)
    }
    ///Bits 20:21 - Alternate bytes size This bit defines alternate bytes size.
    #[inline(always)]
    pub fn absize(&mut self) -> ABSIZE_W<'_, WPCCRrs> {
        ABSIZE_W::new(self, 20)
    }
    ///Bits 24:26 - Data mode This field defines the data phase mode of operation. 101; data on 16 lines Others: reserved
    #[inline(always)]
    pub fn dmode(&mut self) -> DMODE_W<'_, WPCCRrs> {
        DMODE_W::new(self, 24)
    }
    ///Bit 27 - Data double transfer rate This bit sets the DTR mode for the data phase.
    #[inline(always)]
    pub fn ddtr(&mut self) -> DDTR_W<'_, WPCCRrs> {
        DDTR_W::new(self, 27)
    }
    ///Bit 29 - DQS enable This bit enables the data strobe management.
    #[inline(always)]
    pub fn dqse(&mut self) -> DQSE_W<'_, WPCCRrs> {
        DQSE_W::new(self, 29)
    }
}
