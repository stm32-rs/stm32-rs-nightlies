...
pub type VLCDEN_R = crate::BitReader;
///Field `VLCDEN` writer - VLCD enable
pub type VLCDEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    ///Bit 24 - VLCD enable
    #[inline(always)]
    pub fn vlcden(&mut self) -> VLCDEN_W<'_, CCRrs> {
        VLCDEN_W::new(self, 24)
    }
    ///Bit 25 - Low Frequency Mode enable
    #[inline(always)]
    pub fn lfmen(&mut self) -> LFMEN_W<'_, CCRrs> {
        LFMEN_W::new(self, 25)
    }
}
