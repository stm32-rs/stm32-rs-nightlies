...
impl W {
    ///Bit 0 - Software Interrupt on line 0
    #[inline(always)]
    pub fn swi0(&mut self) -> SWI0_W<'_, SWIERrs> {
        SWI0_W::new(self, 0)
    }
    ///Bit 1 - Software Interrupt on line 1
    #[inline(always)]
    pub fn swi1(&mut self) -> SWI1_W<'_, SWIERrs> {
        SWI1_W::new(self, 1)
    }
    ///Bit 2 - Software Interrupt on line 2
    #[inline(always)]
    pub fn swi2(&mut self) -> SWI2_W<'_, SWIERrs> {
        SWI2_W::new(self, 2)
    }
    ///Bit 3 - Software Interrupt on line 3
    #[inline(always)]
    pub fn swi3(&mut self) -> SWI3_W<'_, SWIERrs> {
        SWI3_W::new(self, 3)
    }
    ///Bit 4 - Software Interrupt on line 4
    #[inline(always)]
    pub fn swi4(&mut self) -> SWI4_W<'_, SWIERrs> {
        SWI4_W::new(self, 4)
    }
    ///Bit 5 - Software Interrupt on line 5
    #[inline(always)]
    pub fn swi5(&mut self) -> SWI5_W<'_, SWIERrs> {
        SWI5_W::new(self, 5)
    }
    ///Bit 6 - Software Interrupt on line 6
    #[inline(always)]
    pub fn swi6(&mut self) -> SWI6_W<'_, SWIERrs> {
        SWI6_W::new(self, 6)
    }
    ///Bit 7 - Software Interrupt on line 7
    #[inline(always)]
    pub fn swi7(&mut self) -> SWI7_W<'_, SWIERrs> {
        SWI7_W::new(self, 7)
    }
    ///Bit 8 - Software Interrupt on line 8
    #[inline(always)]
    pub fn swi8(&mut self) -> SWI8_W<'_, SWIERrs> {
        SWI8_W::new(self, 8)
    }
    ///Bit 9 - Software Interrupt on line 9
    #[inline(always)]
    pub fn swi9(&mut self) -> SWI9_W<'_, SWIERrs> {
        SWI9_W::new(self, 9)
    }
    ///Bit 10 - Software Interrupt on line 10
    #[inline(always)]
    pub fn swi10(&mut self) -> SWI10_W<'_, SWIERrs> {
        SWI10_W::new(self, 10)
    }
    ///Bit 11 - Software Interrupt on line 11
    #[inline(always)]
    pub fn swi11(&mut self) -> SWI11_W<'_, SWIERrs> {
        SWI11_W::new(self, 11)
    }
    ///Bit 12 - Software Interrupt on line 12
    #[inline(always)]
    pub fn swi12(&mut self) -> SWI12_W<'_, SWIERrs> {
        SWI12_W::new(self, 12)
    }
    ///Bit 13 - Software Interrupt on line 13
    #[inline(always)]
    pub fn swi13(&mut self) -> SWI13_W<'_, SWIERrs> {
        SWI13_W::new(self, 13)
    }
    ///Bit 14 - Software Interrupt on line 14
    #[inline(always)]
    pub fn swi14(&mut self) -> SWI14_W<'_, SWIERrs> {
        SWI14_W::new(self, 14)
    }
    ///Bit 15 - Software Interrupt on line 15
    #[inline(always)]
    pub fn swi15(&mut self) -> SWI15_W<'_, SWIERrs> {
        SWI15_W::new(self, 15)
    }
    ///Bit 16 - Software Interrupt on line 16
    #[inline(always)]
    pub fn swi16(&mut self) -> SWI16_W<'_, SWIERrs> {
        SWI16_W::new(self, 16)
    }
    ///Bit 17 - Software Interrupt on line 17
    #[inline(always)]
    pub fn swi17(&mut self) -> SWI17_W<'_, SWIERrs> {
        SWI17_W::new(self, 17)
    }
    ///Bit 19 - Software Interrupt on line 19
    #[inline(always)]
    pub fn swi19(&mut self) -> SWI19_W<'_, SWIERrs> {
        SWI19_W::new(self, 19)
    }
    ///Bit 20 - Software Interrupt on line 20
    #[inline(always)]
    pub fn swi20(&mut self) -> SWI20_W<'_, SWIERrs> {
        SWI20_W::new(self, 20)
    }
    ///Bit 21 - Software Interrupt on line 21
    #[inline(always)]
    pub fn swi21(&mut self) -> SWI21_W<'_, SWIERrs> {
        SWI21_W::new(self, 21)
    }
    ///Bit 22 - Software Interrupt on line 22
    #[inline(always)]
    pub fn swi22(&mut self) -> SWI22_W<'_, SWIERrs> {
        SWI22_W::new(self, 22)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x0.html#EXTI:SWIER)*/
pub struct SWIERrs;
