...
pub mod cfgr;
/**CIER (r) register accessor: Clock interrupt enable register

You can [`read`](crate::Reg::read) this register and get [`cier::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
