...
pub enum EXTI_ABCDEH {
    ...
    Pe = 4,
    ///5: Select PHx as the source input for the EXTIx external interrupt
    Ph = 5,
}
impl From<EXTI_ABCDEH> for u8 {
    #[inline(always)]
    fn from(variant: EXTI_ABCDEH) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for EXTI_ABCDEH {
    type Ux = u8;
}
impl crate::IsEnum for EXTI_ABCDEH {}
///Field `EXTI0` reader - EXTI x configuration (x = 0 to 3)
pub type EXTI0_R = crate::FieldReader<EXTI_ABCDEH>;
impl EXTI0_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Option<EXTI_ABCDEH> {
        match self.bits {
            0 => Some(EXTI_ABCDEH::Pa),
            1 => Some(EXTI_ABCDEH::Pb),
            2 => Some(EXTI_ABCDEH::Pc),
            3 => Some(EXTI_ABCDEH::Pd),
            4 => Some(EXTI_ABCDEH::Pe),
            5 => Some(EXTI_ABCDEH::Ph),
            _ => None,
        }
    }
...
pub type EXTI0_W<'a, REG> = crate::FieldWriter<'a, REG, 4, EXTI_ABCDEH>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn pa(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEH::Pa)
    }
    ///Select PBx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pb(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEH::Pb)
    }
    ///Select PCx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pc(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEH::Pc)
    }
    ///Select PDx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pd(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEH::Pd)
    }
    ///Select PEx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn pe(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEH::Pe)
    }
    ///Select PHx as the source input for the EXTIx external interrupt
    #[inline(always)]
    pub fn ph(self) -> &'a mut crate::W<REG> {
        self.variant(EXTI_ABCDEH::Ph)
    }
}
...
pub type EXTI2_R = crate::FieldReader<EXTI_ABCDE>;
impl EXTI2_R {
    ///Get enumerated values variant
    #[inline(always)]
...
pub type EXTI2_W<'a, REG> = crate::FieldWriter<'a, REG, 4, EXTI_ABCDE>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x0.html#SYSCFG:EXTICR1)*/
