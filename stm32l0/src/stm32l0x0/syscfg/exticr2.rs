...
pub use super::exticr1::EXTI2_R as EXTI5_R;
///Field `EXTI6` reader - EXTI x configuration (x = 4 to 7)
pub use super::exticr1::EXTI2_R as EXTI6_R;
///Field `EXTI7` reader - EXTI x configuration (x = 4 to 7)
pub use super::exticr1::EXTI2_R as EXTI7_R;
...
pub use super::exticr1::EXTI2_W as EXTI5_W;
///Field `EXTI6` writer - EXTI x configuration (x = 4 to 7)
pub use super::exticr1::EXTI2_W as EXTI6_W;
///Field `EXTI7` writer - EXTI x configuration (x = 4 to 7)
pub use super::exticr1::EXTI2_W as EXTI7_W;
