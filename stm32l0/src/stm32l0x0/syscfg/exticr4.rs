...
pub use super::exticr1::EXTI2_R as EXTI12_R;
///Field `EXTI13` reader - EXTI13
pub use super::exticr1::EXTI2_R as EXTI13_R;
///Field `EXTI14` reader - EXTI14
pub use super::exticr1::EXTI2_R as EXTI14_R;
///Field `EXTI15` reader - EXTI x configuration (x = 12 to 15)
pub use super::exticr1::EXTI2_R as EXTI15_R;
///Field `EXTI12` writer - EXTI12
pub use super::exticr1::EXTI2_W as EXTI12_W;
///Field `EXTI13` writer - EXTI13
pub use super::exticr1::EXTI2_W as EXTI13_W;
///Field `EXTI14` writer - EXTI14
pub use super::exticr1::EXTI2_W as EXTI14_W;
///Field `EXTI15` writer - EXTI x configuration (x = 12 to 15)
pub use super::exticr1::EXTI2_W as EXTI15_W;
///EXTI12
