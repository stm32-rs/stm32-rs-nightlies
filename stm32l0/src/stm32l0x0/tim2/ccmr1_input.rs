...
impl ICPSC_R {
    ...
    pub const fn variant(&self) -> IC1PSC {
        match self.bits {
            0 => IC1PSC::NoPrescaler,
            1 => IC1PSC::TwoEvents,
            2 => IC1PSC::FourEvents,
            3 => IC1PSC::EightEvents,
            _ => unreachable!(),
        }
    }
