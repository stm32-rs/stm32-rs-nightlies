    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn negative(self) -> &'a mut crate::W<REG> {
        self.variant(CC1NP::Negative)
    }
    ///Positive polarity
    #[inline(always)]
    pub fn positive(self) -> &'a mut crate::W<REG> {
        self.variant(CC1NP::Positive)
    }
}
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x0.html#TIM22:CCER)*/
pub struct CCERrs;
