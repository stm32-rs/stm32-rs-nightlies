...
pub type IV2_R = crate::FieldReader<u32>;
///Field `IV2` writer - Initialization Vector Register (IVR \[95:64\])
pub type IV2_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IVR2").field("iv2", &self.iv2()).finish()
    }
}
impl W {
    ///Bits 0:31 - Initialization Vector Register (IVR \[95:64\])
    #[inline(always)]
    #[must_use]
    pub fn iv2(&mut self) -> IV2_W<IVR2rs> {
        IV2_W::new(self, 0)
    }
}
