...
pub type KEY2_R = crate::FieldReader<u32>;
///Field `KEY2` writer - AES key register (key \[95:64\])
pub type KEY2_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("KEYR2").field("key2", &self.key2()).finish()
    }
}
impl W {
    ///Bits 0:31 - AES key register (key \[95:64\])
    #[inline(always)]
    #[must_use]
    pub fn key2(&mut self) -> KEY2_W<KEYR2rs> {
        KEY2_W::new(self, 0)
    }
}
/**key register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x1.html#AES:KEYR2)*/
pub struct KEYR2rs;
