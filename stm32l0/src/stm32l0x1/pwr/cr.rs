...
/**Regulator in Low-power deepsleep mode This bit allows switching the regulator to low-power mode when the CPU enters Stop mode. Its behavior depends on LPSDSR bit
...
///Field `LPDS` reader - Regulator in Low-power deepsleep mode This bit allows switching the regulator to low-power mode when the CPU enters Stop mode. Its behavior depends on LPSDSR bit
...
///Field `LPDS` writer - Regulator in Low-power deepsleep mode This bit allows switching the regulator to low-power mode when the CPU enters Stop mode. Its behavior depends on LPSDSR bit
...
impl R {
    ...
    ///Bit 16 - Regulator in Low-power deepsleep mode This bit allows switching the regulator to low-power mode when the CPU enters Stop mode. Its behavior depends on LPSDSR bit
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x1.html#PWR:CR)*/
pub struct CRrs;
