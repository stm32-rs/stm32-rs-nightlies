...
///Field `IOPEEN` reader - IO port E clock enable bit
...
///Field `IOPEEN` writer - IO port E clock enable bit
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x1.html#RCC:IOPENR)*/
pub struct IOPENRrs;
