...
pub type COMP1VALUE_W<'a, REG> = crate::BitWriter<'a, REG, COMP1VALUER>;
impl<'a, REG> COMP1VALUE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Comparator values are not equal
    ...
    pub fn not_equal(self) -> &'a mut crate::W<REG> {
        self.variant(COMP1VALUER::NotEqual)
    }
    ///Comparator values are equal
    #[inline(always)]
    pub fn equal(self) -> &'a mut crate::W<REG> {
        self.variant(COMP1VALUER::Equal)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn read_write(self) -> &'a mut crate::W<REG> {
        self.variant(COMP1LOCK::ReadWrite)
    }
    ///COMP1_CSR\[31:0\] for comparator 1 are read-only
    #[inline(always)]
    pub fn read_only(self) -> &'a mut crate::W<REG> {
        self.variant(COMP1LOCK::ReadOnly)
    }
}
impl R {
...
impl W {
    ...
    ///Bits 4:5 - Comparator 1 Input Minus connection configuration bit
    #[inline(always)]
    pub fn comp1innsel(&mut self) -> COMP1INNSEL_W<'_, COMP1_CSRrs> {
        COMP1INNSEL_W::new(self, 4)
    }
    ///Bit 8 - Comparator 1 window mode selection bit
    #[inline(always)]
    pub fn comp1wm(&mut self) -> COMP1WM_W<'_, COMP1_CSRrs> {
        COMP1WM_W::new(self, 8)
    }
    ///Bit 12 - Comparator 1 LPTIM input propagation bit
    #[inline(always)]
    pub fn comp1lptimin1(&mut self) -> COMP1LPTIMIN1_W<'_, COMP1_CSRrs> {
        COMP1LPTIMIN1_W::new(self, 12)
    }
    ///Bit 15 - Comparator 1 polarity selection bit
    #[inline(always)]
    pub fn comp1polarity(&mut self) -> COMP1POLARITY_W<'_, COMP1_CSRrs> {
        COMP1POLARITY_W::new(self, 15)
    }
    ///Bit 30 - Comparator 1 output status bit
    #[inline(always)]
    pub fn comp1value(&mut self) -> COMP1VALUE_W<'_, COMP1_CSRrs> {
        COMP1VALUE_W::new(self, 30)
    }
    ///Bit 31 - COMP1_CSR register lock bit
    #[inline(always)]
