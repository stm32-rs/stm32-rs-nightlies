...
pub type IV0_R = crate::FieldReader<u32>;
///Field `IV0` writer - initialization vector register (LSB IVR \[31:0\])
pub type IV0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IVR0").field("iv0", &self.iv0()).finish()
    }
}
impl W {
    ///Bits 0:31 - initialization vector register (LSB IVR \[31:0\])
    #[inline(always)]
    pub fn iv0(&mut self) -> IV0_W<IVR0rs> {
        IV0_W::new(self, 0)
    }
}
