...
pub enum TSEL1 {
    ...
    ///2: Timer 3 CH3 event
    Tim3ch3 = 2,
    ///3: Timer 21 TRGO event
    Tim21trgo = 3,
    ///4: Timer 2 TRGO event
    Tim2trgo = 4,
    ///5: Timer 7 TRGO event
    Tim7trgo = 5,
    ///6: EXTI line 9
    Exti9 = 6,
    ///7: Software trigger
...
impl TSEL1_R {
    ...
    ///Timer 21 TRGO event
    #[inline(always)]
    pub fn is_tim21trgo(&self) -> bool {
        *self == TSEL1::Tim21trgo
    }
    ///Timer 2 TRGO event
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn tim3ch3(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Tim3ch3)
    }
    ///Timer 21 TRGO event
    #[inline(always)]
    pub fn tim21trgo(self) -> &'a mut crate::W<REG> {
        self.variant(TSEL1::Tim21trgo)
    }
    ///Timer 2 TRGO event
    #[inline(always)]
