...
///Field `AFR(EL0,EL1,EL2,EL3,EL4,EL5,EL6,EL7)` reader - Alternate function selection for port x pin y (y = 0..7)
...
///Field `AFR(EL0,EL1,EL2,EL3,EL4,EL5,EL6,EL7)` writer - Alternate function selection for port x pin y (y = 0..7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x2.html#GPIOB:AFRL)*/
pub struct AFRLrs;
