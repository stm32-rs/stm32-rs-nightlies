...
///Field `TOUCHRST` reader - Touch Sensing reset
...
///Field `TOUCHRST` writer - Touch Sensing reset
...
impl W {
    ...
    ///Bit 16 - Touch Sensing reset
    #[inline(always)]
    pub fn touchrst(&mut self) -> TOUCHRST_W<'_, AHBRSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x2.html#RCC:AHBRSTR)*/
