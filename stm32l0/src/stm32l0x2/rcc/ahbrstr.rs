...
pub type RNGRST_R = crate::R<bool, CRYPRST_A>;
...
pub type TOUCHRST_A = CRYPRST_A;
#[doc = "Reader of field `TOUCHRST`"]
pub type TOUCHRST_R = crate::R<bool, CRYPRST_A>;
#[doc = "Write proxy for field `TOUCHRST`"]
