...
///Field `TIM3EN` reader - Timer3 clock enable bit
...
///Field `USBEN` reader - USB clock enable bit
pub use TIM2EN_R as USBEN_R;
///Field `CRSEN` reader - Clock recovery system clock enable bit
pub use TIM2EN_R as CRSEN_R;
///Field `PWREN` reader - Power interface clock enable bit
pub use TIM2EN_R as PWREN_R;
///Field `DACEN` reader - DAC interface clock enable bit
...
///Field `TIM3EN` writer - Timer3 clock enable bit
...
///Field `USBEN` writer - USB clock enable bit
pub use TIM2EN_W as USBEN_W;
///Field `CRSEN` writer - Clock recovery system clock enable bit
pub use TIM2EN_W as CRSEN_W;
///Field `PWREN` writer - Power interface clock enable bit
pub use TIM2EN_W as PWREN_W;
///Field `DACEN` writer - DAC interface clock enable bit
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crsen(&mut self) -> CRSEN_W<APB1ENRrs> {
        CRSEN_W::new(self, 27)
    }
    ///Bit 28 - Power interface clock enable bit
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x2.html#RCC:APB1ENR)*/
