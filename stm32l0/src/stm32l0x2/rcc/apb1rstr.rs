...
#[doc = "UART2 reset"]
pub type LPUART12RST_A = TIM2RST_A;
#[doc = "Field `LPUART12RST` reader - UART2 reset"]
pub type LPUART12RST_R = TIM2RST_R;
...
impl<'a> LPUART12RST_W<'a> {
    ...
    #[inline(always)]
    pub fn reset(self) -> &'a mut W {
        self.variant(LPUART12RST_A::RESET)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub type WWDRST_A = TIM2RST_A;
#[doc = "Field `WWDRST` reader - Window watchdog reset"]
pub type WWDRST_R = TIM2RST_R;
