...
///Field `CALW8` reader - Use a 8-second calibration cycle period
...
///Field `CALW8` writer - Use a 8-second calibration cycle period
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x2.html#RTC:CALR)*/
pub struct CALRrs;
