...
///Field `RTC_OUT_RMP` reader - RTC_ALARM on PC13 output type
pub type RTC_OUT_RMP_R = crate::BitReader;
///Field `RTC_OUT_RMP` writer - RTC_ALARM on PC13 output type
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x2.html#RTC:OR)*/
pub struct ORrs;
