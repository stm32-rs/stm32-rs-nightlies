...
pub type IV3_R = crate::FieldReader<u32>;
///Field `IV3` writer - Initialization Vector Register (MSB IVR \[127:96\])
pub type IV3_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IVR3").field("iv3", &self.iv3()).finish()
    }
}
impl W {
    ///Bits 0:31 - Initialization Vector Register (MSB IVR \[127:96\])
    #[inline(always)]
    #[must_use]
    pub fn iv3(&mut self) -> IV3_W<IVR3rs> {
        IV3_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x3.html#AES:IVR3)*/
pub struct IVR3rs;
