...
pub type KEY1_R = crate::FieldReader<u32>;
///Field `KEY1` writer - AES key register (key \[63:32\])
pub type KEY1_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("KEYR1").field("key1", &self.key1()).finish()
    }
}
impl W {
    ///Bits 0:31 - AES key register (key \[63:32\])
    #[inline(always)]
    pub fn key1(&mut self) -> KEY1_W<KEYR1rs> {
        KEY1_W::new(self, 0)
    }
}
/**key register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x3.html#AES:KEYR1)*/
pub struct KEYR1rs;
