...
///Field `IM26` reader - Interrupt Mask on line 27
pub use IM0_R as IM26_R;
///Field `IM28` reader - Interrupt Mask on line 27
pub use IM0_R as IM28_R;
///Field `IM29` reader - Interrupt Mask on line 27
...
///Field `IM26` writer - Interrupt Mask on line 27
pub use IM0_W as IM26_W;
///Field `IM28` writer - Interrupt Mask on line 27
pub use IM0_W as IM28_W;
///Field `IM29` writer - Interrupt Mask on line 27
...
impl W {
    ///Bit 0 - Interrupt Mask on line 0
    #[inline(always)]
    pub fn im0(&mut self) -> IM0_W<'_, IMRrs> {
        IM0_W::new(self, 0)
    }
    ///Bit 1 - Interrupt Mask on line 1
    #[inline(always)]
    pub fn im1(&mut self) -> IM1_W<'_, IMRrs> {
        IM1_W::new(self, 1)
    }
    ///Bit 2 - Interrupt Mask on line 2
    #[inline(always)]
    pub fn im2(&mut self) -> IM2_W<'_, IMRrs> {
        IM2_W::new(self, 2)
    }
    ///Bit 3 - Interrupt Mask on line 3
    #[inline(always)]
    pub fn im3(&mut self) -> IM3_W<'_, IMRrs> {
        IM3_W::new(self, 3)
    }
    ///Bit 4 - Interrupt Mask on line 4
    #[inline(always)]
    pub fn im4(&mut self) -> IM4_W<'_, IMRrs> {
        IM4_W::new(self, 4)
    }
    ///Bit 5 - Interrupt Mask on line 5
    #[inline(always)]
    pub fn im5(&mut self) -> IM5_W<'_, IMRrs> {
        IM5_W::new(self, 5)
    }
    ///Bit 6 - Interrupt Mask on line 6
    #[inline(always)]
    pub fn im6(&mut self) -> IM6_W<'_, IMRrs> {
        IM6_W::new(self, 6)
    }
    ///Bit 7 - Interrupt Mask on line 7
    #[inline(always)]
    pub fn im7(&mut self) -> IM7_W<'_, IMRrs> {
        IM7_W::new(self, 7)
    }
    ///Bit 8 - Interrupt Mask on line 8
    #[inline(always)]
    pub fn im8(&mut self) -> IM8_W<'_, IMRrs> {
        IM8_W::new(self, 8)
    }
    ///Bit 9 - Interrupt Mask on line 9
    #[inline(always)]
    pub fn im9(&mut self) -> IM9_W<'_, IMRrs> {
        IM9_W::new(self, 9)
    }
    ///Bit 10 - Interrupt Mask on line 10
    #[inline(always)]
    pub fn im10(&mut self) -> IM10_W<'_, IMRrs> {
        IM10_W::new(self, 10)
    }
    ///Bit 11 - Interrupt Mask on line 11
    #[inline(always)]
    pub fn im11(&mut self) -> IM11_W<'_, IMRrs> {
        IM11_W::new(self, 11)
    }
    ///Bit 12 - Interrupt Mask on line 12
    #[inline(always)]
    pub fn im12(&mut self) -> IM12_W<'_, IMRrs> {
        IM12_W::new(self, 12)
    }
    ///Bit 13 - Interrupt Mask on line 13
    #[inline(always)]
    pub fn im13(&mut self) -> IM13_W<'_, IMRrs> {
        IM13_W::new(self, 13)
    }
    ///Bit 14 - Interrupt Mask on line 14
    #[inline(always)]
    pub fn im14(&mut self) -> IM14_W<'_, IMRrs> {
        IM14_W::new(self, 14)
    }
    ///Bit 15 - Interrupt Mask on line 15
    #[inline(always)]
    pub fn im15(&mut self) -> IM15_W<'_, IMRrs> {
        IM15_W::new(self, 15)
    }
    ///Bit 16 - Interrupt Mask on line 16
    #[inline(always)]
    pub fn im16(&mut self) -> IM16_W<'_, IMRrs> {
        IM16_W::new(self, 16)
    }
    ///Bit 17 - Interrupt Mask on line 17
    #[inline(always)]
    pub fn im17(&mut self) -> IM17_W<'_, IMRrs> {
        IM17_W::new(self, 17)
    }
    ///Bit 18 - Interrupt Mask on line 18
    #[inline(always)]
    pub fn im18(&mut self) -> IM18_W<'_, IMRrs> {
        IM18_W::new(self, 18)
    }
    ///Bit 19 - Interrupt Mask on line 19
    #[inline(always)]
    pub fn im19(&mut self) -> IM19_W<'_, IMRrs> {
        IM19_W::new(self, 19)
    }
    ///Bit 20 - Interrupt Mask on line 20
    #[inline(always)]
    pub fn im20(&mut self) -> IM20_W<'_, IMRrs> {
        IM20_W::new(self, 20)
    }
    ///Bit 21 - Interrupt Mask on line 21
    #[inline(always)]
    pub fn im21(&mut self) -> IM21_W<'_, IMRrs> {
        IM21_W::new(self, 21)
    }
    ///Bit 22 - Interrupt Mask on line 22
    #[inline(always)]
    pub fn im22(&mut self) -> IM22_W<'_, IMRrs> {
        IM22_W::new(self, 22)
    }
    ///Bit 23 - Interrupt Mask on line 23
    #[inline(always)]
    pub fn im23(&mut self) -> IM23_W<'_, IMRrs> {
        IM23_W::new(self, 23)
    }
    ///Bit 24 - Interrupt Mask on line 24
    #[inline(always)]
    pub fn im24(&mut self) -> IM24_W<'_, IMRrs> {
        IM24_W::new(self, 24)
    }
    ///Bit 25 - Interrupt Mask on line 25
    #[inline(always)]
    pub fn im25(&mut self) -> IM25_W<'_, IMRrs> {
        IM25_W::new(self, 25)
    }
    ///Bit 26 - Interrupt Mask on line 27
    #[inline(always)]
    pub fn im26(&mut self) -> IM26_W<'_, IMRrs> {
        IM26_W::new(self, 26)
    }
    ///Bit 28 - Interrupt Mask on line 27
    #[inline(always)]
    pub fn im28(&mut self) -> IM28_W<'_, IMRrs> {
        IM28_W::new(self, 28)
    }
    ///Bit 29 - Interrupt Mask on line 27
    #[inline(always)]
    pub fn im29(&mut self) -> IM29_W<'_, IMRrs> {
        IM29_W::new(self, 29)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x3.html#EXTI:IMR)*/
pub struct IMRrs;
...
impl crate::Resettable for IMRrs {
    const RESET_VALUE: u32 = 0xff84_0000;
}
