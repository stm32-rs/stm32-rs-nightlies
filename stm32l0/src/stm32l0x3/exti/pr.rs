...
impl W {
    ///Bit 0 - Pending bit 0
    #[inline(always)]
    pub fn pif0(&mut self) -> PIF0_W<'_, PRrs> {
        PIF0_W::new(self, 0)
    }
    ///Bit 1 - Pending bit 1
    #[inline(always)]
    pub fn pif1(&mut self) -> PIF1_W<'_, PRrs> {
        PIF1_W::new(self, 1)
    }
    ///Bit 2 - Pending bit 2
    #[inline(always)]
    pub fn pif2(&mut self) -> PIF2_W<'_, PRrs> {
        PIF2_W::new(self, 2)
    }
    ///Bit 3 - Pending bit 3
    #[inline(always)]
    pub fn pif3(&mut self) -> PIF3_W<'_, PRrs> {
        PIF3_W::new(self, 3)
    }
    ///Bit 4 - Pending bit 4
    #[inline(always)]
    pub fn pif4(&mut self) -> PIF4_W<'_, PRrs> {
        PIF4_W::new(self, 4)
    }
    ///Bit 5 - Pending bit 5
    #[inline(always)]
    pub fn pif5(&mut self) -> PIF5_W<'_, PRrs> {
        PIF5_W::new(self, 5)
    }
    ///Bit 6 - Pending bit 6
    #[inline(always)]
    pub fn pif6(&mut self) -> PIF6_W<'_, PRrs> {
        PIF6_W::new(self, 6)
    }
    ///Bit 7 - Pending bit 7
    #[inline(always)]
    pub fn pif7(&mut self) -> PIF7_W<'_, PRrs> {
        PIF7_W::new(self, 7)
    }
    ///Bit 8 - Pending bit 8
    #[inline(always)]
    pub fn pif8(&mut self) -> PIF8_W<'_, PRrs> {
        PIF8_W::new(self, 8)
    }
    ///Bit 9 - Pending bit 9
    #[inline(always)]
    pub fn pif9(&mut self) -> PIF9_W<'_, PRrs> {
        PIF9_W::new(self, 9)
    }
    ///Bit 10 - Pending bit 10
    #[inline(always)]
    pub fn pif10(&mut self) -> PIF10_W<'_, PRrs> {
        PIF10_W::new(self, 10)
    }
    ///Bit 11 - Pending bit 11
    #[inline(always)]
    pub fn pif11(&mut self) -> PIF11_W<'_, PRrs> {
        PIF11_W::new(self, 11)
    }
    ///Bit 12 - Pending bit 12
    #[inline(always)]
    pub fn pif12(&mut self) -> PIF12_W<'_, PRrs> {
        PIF12_W::new(self, 12)
    }
    ///Bit 13 - Pending bit 13
    #[inline(always)]
    pub fn pif13(&mut self) -> PIF13_W<'_, PRrs> {
        PIF13_W::new(self, 13)
    }
    ///Bit 14 - Pending bit 14
    #[inline(always)]
    pub fn pif14(&mut self) -> PIF14_W<'_, PRrs> {
        PIF14_W::new(self, 14)
    }
    ///Bit 15 - Pending bit 15
    #[inline(always)]
    pub fn pif15(&mut self) -> PIF15_W<'_, PRrs> {
        PIF15_W::new(self, 15)
    }
    ///Bit 16 - Pending bit 16
    #[inline(always)]
    pub fn pif16(&mut self) -> PIF16_W<'_, PRrs> {
        PIF16_W::new(self, 16)
    }
    ///Bit 17 - Pending bit 17
    #[inline(always)]
    pub fn pif17(&mut self) -> PIF17_W<'_, PRrs> {
        PIF17_W::new(self, 17)
    }
    ///Bit 19 - Pending bit 19
    #[inline(always)]
    pub fn pif19(&mut self) -> PIF19_W<'_, PRrs> {
        PIF19_W::new(self, 19)
    }
    ///Bit 20 - Pending bit 20
    #[inline(always)]
    pub fn pif20(&mut self) -> PIF20_W<'_, PRrs> {
        PIF20_W::new(self, 20)
    }
    ///Bit 21 - Pending bit 21
    #[inline(always)]
    pub fn pif21(&mut self) -> PIF21_W<'_, PRrs> {
        PIF21_W::new(self, 21)
    }
    ///Bit 22 - Pending bit 22
    #[inline(always)]
    pub fn pif22(&mut self) -> PIF22_W<'_, PRrs> {
        PIF22_W::new(self, 22)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L0x3.html#EXTI:PR)*/
pub struct PRrs;
