...
#[doc = "Field `OSPEED(0-15)` reader - Port x configuration pin %s"]
...
#[doc = "Field `OSPEED(0-15)` writer - Port x configuration pin %s"]
pub type OSPEED_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, OSPEED0>;
...
impl R {
    ...
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `OSPEED0` field"]
    #[inline(always)]
