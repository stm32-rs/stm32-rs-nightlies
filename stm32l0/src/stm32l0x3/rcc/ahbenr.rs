...
///Field `TOUCHEN` reader - Touch Sensing clock enable bit
pub use DMAEN_R as TOUCHEN_R;
///Field `RNGEN` reader - Random Number Generator clock enable bit
...
///Field `TOUCHEN` writer - Touch Sensing clock enable bit
pub use DMAEN_W as TOUCHEN_W;
///Field `RNGEN` writer - Random Number Generator clock enable bit
...
impl W {
    ...
    ///Bit 16 - Touch Sensing clock enable bit
    #[inline(always)]
    pub fn touchen(&mut self) -> TOUCHEN_W<'_, AHBENRrs> {
        TOUCHEN_W::new(self, 16)
    }
    ///Bit 20 - Random Number Generator clock enable bit
    #[inline(always)]
