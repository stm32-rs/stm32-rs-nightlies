...
pub type DACSMEN_A = LPTIM1SMEN_A;
#[doc = "Reader of field `DACSMEN`"]
pub type DACSMEN_R = crate::R<bool, LPTIM1SMEN_A>;
#[doc = "Write proxy for field `DACSMEN`"]
...
pub type USBSMEN_A = LPTIM1SMEN_A;
#[doc = "Reader of field `USBSMEN`"]
pub type USBSMEN_R = crate::R<bool, LPTIM1SMEN_A>;
