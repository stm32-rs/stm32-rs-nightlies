...
///Field `HSI48RDYIE` writer - HSI48 ready interrupt flag
...
impl W {
    ...
    ///Bit 2 - HSI16 ready interrupt flag
    #[inline(always)]
    pub fn hsi16rdyie(&mut self) -> HSI16RDYIE_W<CIERrs> {
    ...
    pub fn hsi48rdyie(&mut self) -> HSI48RDYIE_W<CIERrs> {
        HSI48RDYIE_W::new(self, 6)
    }
    ///Bit 7 - LSE CSS interrupt flag
    #[inline(always)]
    pub fn csslse(&mut self) -> CSSLSE_W<CIERrs> {
        CSSLSE_W::new(self, 7)
    }
}
