...
///Field `SMP30` reader - Channel 30 sampling time selection
pub type SMP30_R = crate::FieldReader;
///Field `SMP30` writer - Channel 30 sampling time selection
pub type SMP30_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `SMP31` reader - Channel 31 sampling time selection
pub type SMP31_R = crate::FieldReader;
///Field `SMP31` writer - Channel 31 sampling time selection
pub type SMP31_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2 - Channel 30 sampling time selection
    #[inline(always)]
    pub fn smp30(&self) -> SMP30_R {
        SMP30_R::new((self.bits & 7) as u8)
    }
    ///Bits 3:5 - Channel 31 sampling time selection
    #[inline(always)]
