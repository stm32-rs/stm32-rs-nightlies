...
impl W {
    ...
    ///Bits 0:4 - 7 conversion in regular sequence
    #[inline(always)]
    pub fn sq7(&mut self) -> SQ_W<'_, SQR4rs> {
        SQ_W::new(self, 0)
    }
    ///Bits 5:9 - 8 conversion in regular sequence
    #[inline(always)]
    pub fn sq8(&mut self) -> SQ_W<'_, SQR4rs> {
        SQ_W::new(self, 5)
    }
    ///Bits 10:14 - 9 conversion in regular sequence
    #[inline(always)]
    pub fn sq9(&mut self) -> SQ_W<'_, SQR4rs> {
        SQ_W::new(self, 10)
    }
    ///Bits 15:19 - 10 conversion in regular sequence
    #[inline(always)]
    pub fn sq10(&mut self) -> SQ_W<'_, SQR4rs> {
        SQ_W::new(self, 15)
    }
    ///Bits 20:24 - 11 conversion in regular sequence
    #[inline(always)]
    pub fn sq11(&mut self) -> SQ_W<'_, SQR4rs> {
        SQ_W::new(self, 20)
    }
    ///Bits 25:29 - 12 conversion in regular sequence
    #[inline(always)]
    pub fn sq12(&mut self) -> SQ_W<'_, SQR4rs> {
        SQ_W::new(self, 25)
    }
}
