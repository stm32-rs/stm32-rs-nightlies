...
impl From<MR> for bool {
    #[inline(always)]
    fn from(variant: MR) -> Self {
        variant as u8 != 0
    }
}
///Field `MR(0-22)` reader - Interrupt mask on line x
pub type MR_R = crate::BitReader<MR>;
impl MR_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> MR {
        match self.bits {
            false => MR::Masked,
            true => MR::Unmasked,
        }
...
///Field `MR(0-22)` writer - Interrupt mask on line x
pub type MR_W<'a, REG> = crate::BitWriter<'a, REG, MR>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn masked(self) -> &'a mut crate::W<REG> {
        self.variant(MR::Masked)
    }
    ///Interrupt request line is unmasked
    #[inline(always)]
    pub fn unmasked(self) -> &'a mut crate::W<REG> {
        self.variant(MR::Unmasked)
    }
}
impl R {
    ///Interrupt mask on line x
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `MR0` field.</div>
    #[inline(always)]
    pub fn mr(&mut self, n: u8) -> MR_W<IMRrs> {
        #[allow(clippy::no_effect)]
        [(); 23][n as usize];
        MR_W::new(self, n)
    }
    ///Bit 0 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr0(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 0)
    }
    ///Bit 1 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr1(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 1)
    }
    ///Bit 2 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr2(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 2)
    }
    ///Bit 3 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr3(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 3)
    }
    ///Bit 4 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr4(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 4)
    }
    ///Bit 5 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr5(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 5)
    }
    ///Bit 6 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr6(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 6)
    }
    ///Bit 7 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr7(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 7)
    }
    ///Bit 8 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr8(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 8)
    }
    ///Bit 9 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr9(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 9)
    }
    ///Bit 10 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr10(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 10)
    }
    ///Bit 11 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr11(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 11)
    }
    ///Bit 12 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr12(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 12)
    }
    ///Bit 13 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr13(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 13)
    }
    ///Bit 14 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr14(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 14)
    }
    ///Bit 15 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr15(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 15)
    }
    ///Bit 16 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr16(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 16)
    }
    ///Bit 17 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr17(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 17)
    }
    ///Bit 18 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr18(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 18)
    }
    ///Bit 19 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr19(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 19)
    }
    ///Bit 20 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr20(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 20)
    }
    ///Bit 21 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr21(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 21)
    }
    ///Bit 22 - Interrupt mask on line x
    #[inline(always)]
    pub fn mr22(&mut self) -> MR_W<IMRrs> {
        MR_W::new(self, 22)
    }
}
/**IMR
