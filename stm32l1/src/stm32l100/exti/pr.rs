...
///Field `PR1` reader - Pending bit
pub use PR0_R as PR1_R;
///Field `PR2` reader - Pending bit
pub use PR0_R as PR2_R;
///Field `PR3` reader - Pending bit
pub use PR0_R as PR3_R;
///Field `PR4` reader - Pending bit
pub use PR0_R as PR4_R;
///Field `PR5` reader - Pending bit
pub use PR0_R as PR5_R;
///Field `PR6` reader - Pending bit
pub use PR0_R as PR6_R;
///Field `PR7` reader - Pending bit
pub use PR0_R as PR7_R;
///Field `PR8` reader - Pending bit
pub use PR0_R as PR8_R;
///Field `PR9` reader - Pending bit
pub use PR0_R as PR9_R;
///Field `PR10` reader - Pending bit
pub use PR0_R as PR10_R;
///Field `PR11` reader - Pending bit
pub use PR0_R as PR11_R;
///Field `PR12` reader - Pending bit
pub use PR0_R as PR12_R;
///Field `PR13` reader - Pending bit
pub use PR0_R as PR13_R;
///Field `PR14` reader - Pending bit
pub use PR0_R as PR14_R;
///Field `PR15` reader - Pending bit
pub use PR0_R as PR15_R;
///Field `PR16` reader - Pending bit
pub use PR0_R as PR16_R;
///Field `PR17` reader - Pending bit
pub use PR0_R as PR17_R;
///Field `PR18` reader - Pending bit
pub use PR0_R as PR18_R;
///Field `PR19` reader - Pending bit
pub use PR0_R as PR19_R;
///Field `PR20` reader - Pending bit
pub use PR0_R as PR20_R;
///Field `PR21` reader - Pending bit
pub use PR0_R as PR21_R;
///Field `PR22` reader - Pending bit
pub use PR0_R as PR22_R;
///Field `PR1` writer - Pending bit
pub use PR0_W as PR1_W;
///Field `PR2` writer - Pending bit
pub use PR0_W as PR2_W;
///Field `PR3` writer - Pending bit
pub use PR0_W as PR3_W;
///Field `PR4` writer - Pending bit
pub use PR0_W as PR4_W;
///Field `PR5` writer - Pending bit
pub use PR0_W as PR5_W;
///Field `PR6` writer - Pending bit
pub use PR0_W as PR6_W;
///Field `PR7` writer - Pending bit
pub use PR0_W as PR7_W;
///Field `PR8` writer - Pending bit
pub use PR0_W as PR8_W;
///Field `PR9` writer - Pending bit
pub use PR0_W as PR9_W;
///Field `PR10` writer - Pending bit
pub use PR0_W as PR10_W;
///Field `PR11` writer - Pending bit
pub use PR0_W as PR11_W;
///Field `PR12` writer - Pending bit
pub use PR0_W as PR12_W;
///Field `PR13` writer - Pending bit
pub use PR0_W as PR13_W;
///Field `PR14` writer - Pending bit
pub use PR0_W as PR14_W;
///Field `PR15` writer - Pending bit
pub use PR0_W as PR15_W;
///Field `PR16` writer - Pending bit
pub use PR0_W as PR16_W;
///Field `PR17` writer - Pending bit
pub use PR0_W as PR17_W;
///Field `PR18` writer - Pending bit
pub use PR0_W as PR18_W;
///Field `PR19` writer - Pending bit
pub use PR0_W as PR19_W;
///Field `PR20` writer - Pending bit
pub use PR0_W as PR20_W;
///Field `PR21` writer - Pending bit
pub use PR0_W as PR21_W;
///Field `PR22` writer - Pending bit
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L100.html#EXTI:PR)*/
pub struct PRrs;
...
impl crate::Writable for PRrs {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x007f_ffff;
}
