...
impl MCOSEL_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> MCOSEL {
        match self.bits {
            0 => MCOSEL::NoClock,
            1 => MCOSEL::Sysclk,
            2 => MCOSEL::Hsi,
...
pub type MCOSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3, MCOSEL, crate::Safe>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L100.html#RCC:CFGR)*/
pub struct CFGRrs;
