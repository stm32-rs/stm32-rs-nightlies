...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SQ1` field.</div>
    #[inline(always)]
    pub fn sq(&mut self, n: u8) -> SQ_W<SQR5rs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
        SQ_W::new(self, n * 5)
    }
    ///Bits 0:4 - 1 conversion in regular sequence
    #[inline(always)]
    pub fn sq1(&mut self) -> SQ_W<SQR5rs> {
        SQ_W::new(self, 0)
    }
    ///Bits 5:9 - 2 conversion in regular sequence
    #[inline(always)]
    pub fn sq2(&mut self) -> SQ_W<SQR5rs> {
        SQ_W::new(self, 5)
    }
    ///Bits 10:14 - 3 conversion in regular sequence
    #[inline(always)]
    pub fn sq3(&mut self) -> SQ_W<SQR5rs> {
        SQ_W::new(self, 10)
    }
    ///Bits 15:19 - 4 conversion in regular sequence
    #[inline(always)]
    pub fn sq4(&mut self) -> SQ_W<SQR5rs> {
        SQ_W::new(self, 15)
    }
    ///Bits 20:24 - 5 conversion in regular sequence
    #[inline(always)]
    pub fn sq5(&mut self) -> SQ_W<SQR5rs> {
        SQ_W::new(self, 20)
    }
    ///Bits 25:29 - 6 conversion in regular sequence
    #[inline(always)]
    pub fn sq6(&mut self) -> SQ_W<SQR5rs> {
        SQ_W::new(self, 25)
    }
}
