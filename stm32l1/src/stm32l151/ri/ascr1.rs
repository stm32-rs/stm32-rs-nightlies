...
impl W {
    ///Bit 0 - Analog switch control
    #[inline(always)]
    pub fn ch0gr1_1(&mut self) -> CH0GR1_1_W<'_, ASCR1rs> {
        CH0GR1_1_W::new(self, 0)
    }
    ///Bit 1 - Analog switch control
    #[inline(always)]
    pub fn ch1gr1_2(&mut self) -> CH1GR1_2_W<'_, ASCR1rs> {
        CH1GR1_2_W::new(self, 1)
    }
    ///Bit 2 - Analog switch control
    #[inline(always)]
    pub fn ch2gr1_3(&mut self) -> CH2GR1_3_W<'_, ASCR1rs> {
        CH2GR1_3_W::new(self, 2)
    }
    ///Bit 3 - Analog switch control
    #[inline(always)]
    pub fn ch3gr1_4(&mut self) -> CH3GR1_4_W<'_, ASCR1rs> {
        CH3GR1_4_W::new(self, 3)
    }
    ///Bit 4 - Analog switch control
    #[inline(always)]
    pub fn ch31gr11_5(&mut self) -> CH31GR11_5_W<'_, ASCR1rs> {
        CH31GR11_5_W::new(self, 4)
    }
    ///Bit 5 - Comparator 1 analog switch
    #[inline(always)]
    pub fn comp1_sw1(&mut self) -> COMP1_SW1_W<'_, ASCR1rs> {
        COMP1_SW1_W::new(self, 5)
    }
    ///Bit 6 - Analog switch control
    #[inline(always)]
    pub fn ch6gr2_1(&mut self) -> CH6GR2_1_W<'_, ASCR1rs> {
        CH6GR2_1_W::new(self, 6)
    }
    ///Bit 7 - Analog switch control
    #[inline(always)]
    pub fn ch7gr2_2(&mut self) -> CH7GR2_2_W<'_, ASCR1rs> {
        CH7GR2_2_W::new(self, 7)
    }
    ///Bit 8 - Analog switch control
    #[inline(always)]
    pub fn ch8gr3_1(&mut self) -> CH8GR3_1_W<'_, ASCR1rs> {
        CH8GR3_1_W::new(self, 8)
    }
    ///Bit 9 - Analog switch control
    #[inline(always)]
    pub fn ch9gr3_2(&mut self) -> CH9GR3_2_W<'_, ASCR1rs> {
        CH9GR3_2_W::new(self, 9)
    }
    ///Bit 10 - Analog switch control
    #[inline(always)]
    pub fn ch10gr8_1(&mut self) -> CH10GR8_1_W<'_, ASCR1rs> {
        CH10GR8_1_W::new(self, 10)
    }
    ///Bit 11 - Analog switch control
    #[inline(always)]
    pub fn ch11gr8_2(&mut self) -> CH11GR8_2_W<'_, ASCR1rs> {
        CH11GR8_2_W::new(self, 11)
    }
    ///Bit 12 - Analog switch control
    #[inline(always)]
    pub fn ch12gr8_3(&mut self) -> CH12GR8_3_W<'_, ASCR1rs> {
        CH12GR8_3_W::new(self, 12)
    }
    ///Bit 13 - Analog switch control
    #[inline(always)]
    pub fn ch13gr8_4(&mut self) -> CH13GR8_4_W<'_, ASCR1rs> {
        CH13GR8_4_W::new(self, 13)
    }
    ///Bit 14 - Analog switch control
    #[inline(always)]
    pub fn ch14gr9_1(&mut self) -> CH14GR9_1_W<'_, ASCR1rs> {
        CH14GR9_1_W::new(self, 14)
    }
    ///Bit 15 - Analog switch control
    #[inline(always)]
    pub fn ch15gr9_2(&mut self) -> CH15GR9_2_W<'_, ASCR1rs> {
        CH15GR9_2_W::new(self, 15)
    }
    ///Bit 16 - Analog switch control
    #[inline(always)]
    pub fn ch31gr7_1(&mut self) -> CH31GR7_1_W<'_, ASCR1rs> {
        CH31GR7_1_W::new(self, 16)
    }
    ///Bit 18 - Analog switch control
    #[inline(always)]
    pub fn ch18gr7_1(&mut self) -> CH18GR7_1_W<'_, ASCR1rs> {
        CH18GR7_1_W::new(self, 18)
    }
    ///Bit 19 - Analog switch control
    #[inline(always)]
    pub fn ch19gr7_2(&mut self) -> CH19GR7_2_W<'_, ASCR1rs> {
        CH19GR7_2_W::new(self, 19)
    }
    ///Bit 20 - Analog switch control
    #[inline(always)]
    pub fn ch20gr7_3(&mut self) -> CH20GR7_3_W<'_, ASCR1rs> {
        CH20GR7_3_W::new(self, 20)
    }
    ///Bit 21 - Analog switch control
    #[inline(always)]
    pub fn ch21gr7_4(&mut self) -> CH21GR7_4_W<'_, ASCR1rs> {
        CH21GR7_4_W::new(self, 21)
    }
    ///Bit 22 - Analog I/O switch control of channel CH22
    #[inline(always)]
    pub fn ch22(&mut self) -> CH22_W<'_, ASCR1rs> {
        CH22_W::new(self, 22)
    }
    ///Bit 23 - Analog I/O switch control of channel CH23
    #[inline(always)]
    pub fn ch23(&mut self) -> CH23_W<'_, ASCR1rs> {
        CH23_W::new(self, 23)
    }
    ///Bit 24 - Analog I/O switch control of channel CH24
    #[inline(always)]
    pub fn ch24(&mut self) -> CH24_W<'_, ASCR1rs> {
        CH24_W::new(self, 24)
    }
    ///Bit 25 - Analog I/O switch control of channel CH25
    #[inline(always)]
    pub fn ch25(&mut self) -> CH25_W<'_, ASCR1rs> {
        CH25_W::new(self, 25)
    }
    ///Bit 26 - ADC analog switch selection for internal node to comparator 1
    #[inline(always)]
    pub fn vcomp(&mut self) -> VCOMP_W<'_, ASCR1rs> {
        VCOMP_W::new(self, 26)
    }
    ///Bit 27 - Analog switch control
    #[inline(always)]
    pub fn ch27gr11_1(&mut self) -> CH27GR11_1_W<'_, ASCR1rs> {
        CH27GR11_1_W::new(self, 27)
    }
    ///Bit 28 - Analog switch control
    #[inline(always)]
    pub fn ch28gr11_2(&mut self) -> CH28GR11_2_W<'_, ASCR1rs> {
        CH28GR11_2_W::new(self, 28)
    }
    ///Bit 29 - Analog switch control
    #[inline(always)]
    pub fn ch29gr11_3(&mut self) -> CH29GR11_3_W<'_, ASCR1rs> {
        CH29GR11_3_W::new(self, 29)
    }
    ///Bit 30 - Analog switch control
    #[inline(always)]
    pub fn ch30gr11_4(&mut self) -> CH30GR11_4_W<'_, ASCR1rs> {
        CH30GR11_4_W::new(self, 30)
    }
    ///Bit 31 - Switch control mode
    #[inline(always)]
    pub fn scm(&mut self) -> SCM_W<'_, ASCR1rs> {
        SCM_W::new(self, 31)
    }
}
