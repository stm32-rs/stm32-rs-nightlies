...
///Field `PSC` reader - Prescaler valueThe counter clock frequency CK_CNT is equal to fCK_PSC / (PSC\[15:0\] + 1).
pub type PSC_R = crate::FieldReader<u16>;
///Field `PSC` writer - Prescaler valueThe counter clock frequency CK_CNT is equal to fCK_PSC / (PSC\[15:0\] + 1).
