...
/**Field `PSC` reader - Prescaler valueThe counter clock frequency CK_CNT is equal to fCK_PSC / (PSC\[15:0\]
+ 1).*/
pub type PSC_R = crate::FieldReader<u16>;
/**Field `PSC` writer - Prescaler valueThe counter clock frequency CK_CNT is equal to fCK_PSC / (PSC\[15:0\]
+ 1).*/
pub type PSC_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16, crate::Safe>;
impl R {
    /**Bits 0:15 - Prescaler valueThe counter clock frequency CK_CNT is equal to fCK_PSC / (PSC\[15:0\]
    + 1).*/
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L151.html#TIM6:PSC)*/
pub struct PSCrs;
