...
///Field `IVI` reader - Initialization Vector Register
pub type IVI_R = crate::FieldReader<u32>;
///Field `IVI` writer - Initialization Vector Register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L152.html#AES:IVR2)*/
pub struct IVR2rs;
