...
impl W {
    ///Bit 0 - OPAMP1 power down
    #[inline(always)]
    pub fn opa1pd(&mut self) -> OPA1PD_W<CSRrs> {
        OPA1PD_W::new(self, 0)
    }
    ///Bit 1 - Switch 3 for OPAMP1 enable
    #[inline(always)]
    pub fn s3sel1(&mut self) -> S3SEL1_W<CSRrs> {
        S3SEL1_W::new(self, 1)
    }
    ///Bit 2 - Switch 4 for OPAMP1 enable
    #[inline(always)]
    pub fn s4sel1(&mut self) -> S4SEL1_W<CSRrs> {
        S4SEL1_W::new(self, 2)
    }
    ///Bit 3 - Switch 5 for OPAMP1 enable
    #[inline(always)]
    pub fn s5sel1(&mut self) -> S5SEL1_W<CSRrs> {
        S5SEL1_W::new(self, 3)
    }
    ///Bit 4 - Switch 6 for OPAMP1 enable
    #[inline(always)]
    pub fn s6sel1(&mut self) -> S6SEL1_W<CSRrs> {
        S6SEL1_W::new(self, 4)
    }
    ///Bit 5 - OPAMP1 offset calibration for P differential pair
    #[inline(always)]
    pub fn opa1cal_l(&mut self) -> OPA1CAL_L_W<CSRrs> {
        OPA1CAL_L_W::new(self, 5)
    }
    ///Bit 6 - OPAMP1 offset calibration for N differential pair
    #[inline(always)]
    pub fn opa1cal_h(&mut self) -> OPA1CAL_H_W<CSRrs> {
        OPA1CAL_H_W::new(self, 6)
    }
    ///Bit 7 - OPAMP1 low power mode
    #[inline(always)]
    pub fn opa1lpm(&mut self) -> OPA1LPM_W<CSRrs> {
        OPA1LPM_W::new(self, 7)
    }
    ///Bit 8 - OPAMP2 power down
    #[inline(always)]
    pub fn opa2pd(&mut self) -> OPA2PD_W<CSRrs> {
        OPA2PD_W::new(self, 8)
    }
    ///Bit 9 - Switch 3 for OPAMP2 enable
    #[inline(always)]
    pub fn s3sel2(&mut self) -> S3SEL2_W<CSRrs> {
        S3SEL2_W::new(self, 9)
    }
    ///Bit 10 - Switch 4 for OPAMP2 enable
    #[inline(always)]
    pub fn s4sel2(&mut self) -> S4SEL2_W<CSRrs> {
        S4SEL2_W::new(self, 10)
    }
    ///Bit 11 - Switch 5 for OPAMP2 enable
    #[inline(always)]
    pub fn s5sel2(&mut self) -> S5SEL2_W<CSRrs> {
        S5SEL2_W::new(self, 11)
    }
    ///Bit 12 - Switch 6 for OPAMP2 enable
    #[inline(always)]
    pub fn s6sel2(&mut self) -> S6SEL2_W<CSRrs> {
        S6SEL2_W::new(self, 12)
    }
    ///Bit 13 - OPAMP2 offset Calibration for P differential pair
    #[inline(always)]
    pub fn opa2cal_l(&mut self) -> OPA2CAL_L_W<CSRrs> {
        OPA2CAL_L_W::new(self, 13)
    }
    ///Bit 14 - OPAMP2 offset calibration for N differential pair
    #[inline(always)]
    pub fn opa2cal_h(&mut self) -> OPA2CAL_H_W<CSRrs> {
        OPA2CAL_H_W::new(self, 14)
    }
    ///Bit 15 - OPAMP2 low power mode
    #[inline(always)]
    pub fn opa2lpm(&mut self) -> OPA2LPM_W<CSRrs> {
        OPA2LPM_W::new(self, 15)
    }
    ///Bit 16 - OPAMP3 power down
    #[inline(always)]
    pub fn opa3pd(&mut self) -> OPA3PD_W<CSRrs> {
        OPA3PD_W::new(self, 16)
    }
    ///Bit 17 - Switch 3 for OPAMP3 Enable
    #[inline(always)]
    pub fn s3sel3(&mut self) -> S3SEL3_W<CSRrs> {
        S3SEL3_W::new(self, 17)
    }
    ///Bit 18 - Switch 4 for OPAMP3 enable
    #[inline(always)]
    pub fn s4sel3(&mut self) -> S4SEL3_W<CSRrs> {
        S4SEL3_W::new(self, 18)
    }
    ///Bit 19 - Switch 5 for OPAMP3 enable
    #[inline(always)]
    pub fn s5sel3(&mut self) -> S5SEL3_W<CSRrs> {
        S5SEL3_W::new(self, 19)
    }
    ///Bit 20 - Switch 6 for OPAMP3 enable
    #[inline(always)]
    pub fn s6sel3(&mut self) -> S6SEL3_W<CSRrs> {
        S6SEL3_W::new(self, 20)
    }
    ///Bit 21 - OPAMP3 offset Calibration for P differential pair
    #[inline(always)]
    pub fn opa3cal_l(&mut self) -> OPA3CAL_L_W<CSRrs> {
        OPA3CAL_L_W::new(self, 21)
    }
    ///Bit 22 - OPAMP3 offset calibration for N differential pair
    #[inline(always)]
    pub fn opa3cal_h(&mut self) -> OPA3CAL_H_W<CSRrs> {
        OPA3CAL_H_W::new(self, 22)
    }
    ///Bit 23 - OPAMP3 low power mode
    #[inline(always)]
    pub fn opa3lpm(&mut self) -> OPA3LPM_W<CSRrs> {
        OPA3LPM_W::new(self, 23)
    }
    ///Bit 24 - Switch SanA enable for OPAMP1
    #[inline(always)]
    pub fn anawsel1(&mut self) -> ANAWSEL1_W<CSRrs> {
        ANAWSEL1_W::new(self, 24)
    }
    ///Bit 25 - Switch SanA enable for OPAMP2
    #[inline(always)]
    pub fn anawsel2(&mut self) -> ANAWSEL2_W<CSRrs> {
        ANAWSEL2_W::new(self, 25)
    }
    ///Bit 26 - Switch SanA enable for OPAMP3
    #[inline(always)]
    pub fn anawsel3(&mut self) -> ANAWSEL3_W<CSRrs> {
        ANAWSEL3_W::new(self, 26)
    }
    ///Bit 27 - Switch 7 for OPAMP2 enable
    #[inline(always)]
    pub fn s7sel2(&mut self) -> S7SEL2_W<CSRrs> {
        S7SEL2_W::new(self, 27)
    }
    ///Bit 28 - Power range selection
    #[inline(always)]
    pub fn aop_range(&mut self) -> AOP_RANGE_W<CSRrs> {
        AOP_RANGE_W::new(self, 28)
    }
    ///Bit 29 - OPAMP1 calibration output
    #[inline(always)]
    pub fn opa1calout(&mut self) -> OPA1CALOUT_W<CSRrs> {
        OPA1CALOUT_W::new(self, 29)
    }
    ///Bit 30 - OPAMP2 calibration output
    #[inline(always)]
    pub fn opa2calout(&mut self) -> OPA2CALOUT_W<CSRrs> {
        OPA2CALOUT_W::new(self, 30)
    }
    ///Bit 31 - OPAMP3 calibration output
    #[inline(always)]
    pub fn opa3calout(&mut self) -> OPA3CALOUT_W<CSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L152.html#OPAMP:CSR)*/
pub struct CSRrs;
