...
///Field `LSECSSIE` reader - LSE CSS interrupt enable
pub type LSECSSIE_R = crate::BitReader;
///Field `LSECSSIE` writer - LSE CSS interrupt enable
...
///Field `LSECSSC` writer - LSE CSS interrupt clear
...
impl R {
    ...
    ///Bit 14 - LSE CSS interrupt enable
    #[inline(always)]
...
impl W {
    ...
    ///Bit 22 - LSE CSS interrupt clear
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L152.html#RCC:CIR)*/
pub struct CIRrs;
