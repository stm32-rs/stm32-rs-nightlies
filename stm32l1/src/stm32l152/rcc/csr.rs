...
impl W {
    ...
    ///Bit 11 - CSS on LSE enable
    #[inline(always)]
    pub fn lsecsson(&mut self) -> LSECSSON_W<CSRrs> {
        LSECSSON_W::new(self, 11)
    }
    ///Bit 12 - CSS on LSE failure Detection
    #[inline(always)]
    pub fn lsecssd(&mut self) -> LSECSSD_W<CSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L152.html#RCC:CSR)*/
pub struct CSRrs;
