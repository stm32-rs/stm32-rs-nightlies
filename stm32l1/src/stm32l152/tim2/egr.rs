...
///Field `CCG(1-4)` reader - Capture/compare %s generation
pub type CCG_R = crate::BitReader<CC1GW>;
impl CCG_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Option<CC1GW> {
        match self.bits {
            true => Some(CC1GW::Trigger),
            _ => None,
        }
    }
...
pub type TG_R = crate::BitReader<TGW>;
impl TG_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Option<TGW> {
        match self.bits {
            true => Some(TGW::Trigger),
            _ => None,
        }
    }
...
impl R {
    ...
    pub fn ccg(&self, n: u8) -> CCG_R {
        ...
        [(); 4][n as usize];
        CCG_R::new(((self.bits >> (n + 1)) & 1) != 0)
    }
    ///Iterator for array of:
    ///Capture/compare (1-4) generation
    #[inline(always)]
    pub fn ccg_iter(&self) -> impl Iterator<Item = CCG_R> + '_ {
        (0..4).map(move |n| CCG_R::new(((self.bits >> (n + 1)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn cc2g(&self) -> CCG_R {
        CCG_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Capture/compare 3 generation
    #[inline(always)]
    pub fn cc3g(&self) -> CCG_R {
        CCG_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Capture/compare 4 generation
    #[inline(always)]
    pub fn cc4g(&self) -> CCG_R {
        CCG_R::new(((self.bits >> 4) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 2 - Capture/compare 2 generation
    #[inline(always)]
    pub fn cc2g(&mut self) -> CCG_W<'_, EGRrs> {
        CCG_W::new(self, 2)
    }
    ///Bit 3 - Capture/compare 3 generation
    #[inline(always)]
    pub fn cc3g(&mut self) -> CCG_W<'_, EGRrs> {
        CCG_W::new(self, 3)
    }
    ///Bit 4 - Capture/compare 4 generation
    #[inline(always)]
    pub fn cc4g(&mut self) -> CCG_W<'_, EGRrs> {
        CCG_W::new(self, 4)
    }
    ///Bit 6 - Trigger generation
    #[inline(always)]
