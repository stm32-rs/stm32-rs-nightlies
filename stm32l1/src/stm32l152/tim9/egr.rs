...
///Field `CCG(1-2)` reader - Capture/compare %s generation
...
impl R {
    ...
    pub fn ccg_iter(&self) -> impl Iterator<Item = CCG_R> + '_ {
        (0..2).map(move |n| CCG_R::new(((self.bits >> (n + 1)) & 1) != 0))
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L152.html#TIM9:EGR)*/
pub struct EGRrs;
