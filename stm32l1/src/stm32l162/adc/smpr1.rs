...
impl W {
    ...
    ///Bits 0:2 - Channel 20 sample time selection
    #[inline(always)]
    pub fn smp20(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 0)
    }
    ///Bits 3:5 - Channel 21 sample time selection
    #[inline(always)]
    pub fn smp21(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 3)
    }
    ///Bits 6:8 - Channel 22 sample time selection
    #[inline(always)]
    pub fn smp22(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 6)
    }
    ///Bits 9:11 - Channel 23 sample time selection
    #[inline(always)]
    pub fn smp23(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 9)
    }
    ///Bits 12:14 - Channel 24 sample time selection
    #[inline(always)]
    pub fn smp24(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 12)
    }
    ///Bits 15:17 - Channel 25 sample time selection
    #[inline(always)]
    pub fn smp25(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 15)
    }
    ///Bits 18:20 - Channel 26 sample time selection
    #[inline(always)]
    pub fn smp26(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 18)
    }
    ///Bits 21:23 - Channel 27 sample time selection
    #[inline(always)]
    pub fn smp27(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 21)
    }
    ///Bits 24:26 - Channel 28 sample time selection
    #[inline(always)]
    pub fn smp28(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 24)
    }
    ///Bits 27:29 - Channel 29 sample time selection
    #[inline(always)]
    pub fn smp29(&mut self) -> SMP_W<SMPR1rs> {
        SMP_W::new(self, 27)
    }
}
