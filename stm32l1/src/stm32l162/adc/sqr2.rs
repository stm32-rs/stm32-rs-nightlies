...
///Field `SQ(19-24)` reader - %s conversion in regular sequence
pub type SQ_R = crate::FieldReader;
///Field `SQ(19-24)` writer - %s conversion in regular sequence
pub type SQ_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///(19-24) conversion in regular sequence
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SQ19` field.</div>
    #[inline(always)]
    ...
    ///Bits 0:4 - 19 conversion in regular sequence
    #[inline(always)]
    pub fn sq19(&self) -> SQ_R {
        SQ_R::new((self.bits & 0x1f) as u8)
    }
    ///Bits 5:9 - 20 conversion in regular sequence
    #[inline(always)]
    pub fn sq20(&self) -> SQ_R {
        SQ_R::new(((self.bits >> 5) & 0x1f) as u8)
    }
    ///Bits 10:14 - 21 conversion in regular sequence
    #[inline(always)]
    pub fn sq21(&self) -> SQ_R {
        SQ_R::new(((self.bits >> 10) & 0x1f) as u8)
    }
    ///Bits 15:19 - 22 conversion in regular sequence
    #[inline(always)]
    pub fn sq22(&self) -> SQ_R {
        SQ_R::new(((self.bits >> 15) & 0x1f) as u8)
    }
    ///Bits 20:24 - 23 conversion in regular sequence
    #[inline(always)]
    pub fn sq23(&self) -> SQ_R {
        SQ_R::new(((self.bits >> 20) & 0x1f) as u8)
    }
    ///Bits 25:29 - 24 conversion in regular sequence
    #[inline(always)]
    pub fn sq24(&self) -> SQ_R {
...
impl W {
    ...
    ///Bits 0:4 - 19 conversion in regular sequence
    #[inline(always)]
    pub fn sq19(&mut self) -> SQ_W<'_, SQR2rs> {
        SQ_W::new(self, 0)
    }
    ///Bits 5:9 - 20 conversion in regular sequence
    #[inline(always)]
    pub fn sq20(&mut self) -> SQ_W<'_, SQR2rs> {
        SQ_W::new(self, 5)
    }
    ///Bits 10:14 - 21 conversion in regular sequence
    #[inline(always)]
    pub fn sq21(&mut self) -> SQ_W<'_, SQR2rs> {
        SQ_W::new(self, 10)
    }
    ///Bits 15:19 - 22 conversion in regular sequence
    #[inline(always)]
    pub fn sq22(&mut self) -> SQ_W<'_, SQR2rs> {
        SQ_W::new(self, 15)
    }
    ///Bits 20:24 - 23 conversion in regular sequence
    #[inline(always)]
    pub fn sq23(&mut self) -> SQ_W<'_, SQR2rs> {
        SQ_W::new(self, 20)
    }
    ///Bits 25:29 - 24 conversion in regular sequence
    #[inline(always)]
    pub fn sq24(&mut self) -> SQ_W<'_, SQR2rs> {
        SQ_W::new(self, 25)
    }
}
