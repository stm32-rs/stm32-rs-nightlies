...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SQ13` field.</div>
    #[inline(always)]
    pub fn sq(&mut self, n: u8) -> SQ_W<'_, SQR3rs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
        SQ_W::new(self, n * 5)
    }
    ///Bits 0:4 - 13 conversion in regular sequence
    #[inline(always)]
    pub fn sq13(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 0)
    }
    ///Bits 5:9 - 14 conversion in regular sequence
    #[inline(always)]
    pub fn sq14(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 5)
    }
    ///Bits 10:14 - 15 conversion in regular sequence
    #[inline(always)]
    pub fn sq15(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 10)
    }
    ///Bits 15:19 - 16 conversion in regular sequence
    #[inline(always)]
    pub fn sq16(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 15)
    }
    ///Bits 20:24 - 17 conversion in regular sequence
    #[inline(always)]
    pub fn sq17(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 20)
    }
    ///Bits 25:29 - 18 conversion in regular sequence
    #[inline(always)]
    pub fn sq18(&mut self) -> SQ_W<'_, SQR3rs> {
        SQ_W::new(self, 25)
    }
}
