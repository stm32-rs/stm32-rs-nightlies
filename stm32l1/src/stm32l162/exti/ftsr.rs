...
///Field `TR(0-22)` reader - Falling edge trigger event configuration bit of line x
...
///Field `TR(0-22)` writer - Falling edge trigger event configuration bit of line x
