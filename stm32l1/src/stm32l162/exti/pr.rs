...
///Field `PR(0-22)` reader - Pending bit
pub type PR_R = crate::BitReader<PRR>;
impl PR_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> PRR {
        match self.bits {
            false => PRR::NotPending,
            true => PRR::Pending,
        }
    }
...
impl From<PRW> for bool {
    #[inline(always)]
    fn from(variant: PRW) -> Self {
        variant as u8 != 0
    }
}
///Field `PR(0-22)` writer - Pending bit
pub type PR_W<'a, REG> = crate::BitWriter1C<'a, REG, PRW>;
...
impl R {
    ...
    pub fn pr_iter(&self) -> impl Iterator<Item = PR_R> + '_ {
        (0..23).map(move |n| PR_R::new(((self.bits >> n) & 1) != 0))
    }
    ///Bit 0 - Pending bit
    #[inline(always)]
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `PR0` field.</div>
    #[inline(always)]
    pub fn pr(&mut self, n: u8) -> PR_W<PRrs> {
        #[allow(clippy::no_effect)]
        [(); 23][n as usize];
        PR_W::new(self, n)
    }
    ///Bit 0 - Pending bit
    #[inline(always)]
    pub fn pr0(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 0)
    }
    ///Bit 1 - Pending bit
    #[inline(always)]
    pub fn pr1(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 1)
    }
    ///Bit 2 - Pending bit
    #[inline(always)]
    pub fn pr2(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 2)
    }
    ///Bit 3 - Pending bit
    #[inline(always)]
    pub fn pr3(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 3)
    }
    ///Bit 4 - Pending bit
    #[inline(always)]
    pub fn pr4(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 4)
    }
    ///Bit 5 - Pending bit
    #[inline(always)]
    pub fn pr5(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 5)
    }
    ///Bit 6 - Pending bit
    #[inline(always)]
    pub fn pr6(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 6)
    }
    ///Bit 7 - Pending bit
    #[inline(always)]
    pub fn pr7(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 7)
    }
    ///Bit 8 - Pending bit
    #[inline(always)]
    pub fn pr8(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 8)
    }
    ///Bit 9 - Pending bit
    #[inline(always)]
    pub fn pr9(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 9)
    }
    ///Bit 10 - Pending bit
    #[inline(always)]
    pub fn pr10(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 10)
    }
    ///Bit 11 - Pending bit
    #[inline(always)]
    pub fn pr11(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 11)
    }
    ///Bit 12 - Pending bit
    #[inline(always)]
    pub fn pr12(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 12)
    }
    ///Bit 13 - Pending bit
    #[inline(always)]
    pub fn pr13(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 13)
    }
    ///Bit 14 - Pending bit
    #[inline(always)]
    pub fn pr14(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 14)
    }
    ///Bit 15 - Pending bit
    #[inline(always)]
    pub fn pr15(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 15)
    }
    ///Bit 16 - Pending bit
    #[inline(always)]
    pub fn pr16(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 16)
    }
    ///Bit 17 - Pending bit
    #[inline(always)]
    pub fn pr17(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 17)
    }
    ///Bit 18 - Pending bit
    #[inline(always)]
    pub fn pr18(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 18)
    }
    ///Bit 19 - Pending bit
    #[inline(always)]
    pub fn pr19(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 19)
    }
    ///Bit 20 - Pending bit
    #[inline(always)]
    pub fn pr20(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 20)
    }
    ///Bit 21 - Pending bit
    #[inline(always)]
    pub fn pr21(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 21)
    }
    ///Bit 22 - Pending bit
    #[inline(always)]
    pub fn pr22(&mut self) -> PR_W<PRrs> {
        PR_W::new(self, 22)
    }
}
/**PR
