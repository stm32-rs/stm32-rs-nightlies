...
impl From<SWIERW> for bool {
    #[inline(always)]
    fn from(variant: SWIERW) -> Self {
        variant as u8 != 0
    }
}
///Field `SWIER(0-22)` reader - Software Interrupt on line %s
pub type SWIER_R = crate::BitReader<SWIERW>;
impl SWIER_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Option<SWIERW> {
        match self.bits {
            true => Some(SWIERW::Pend),
            _ => None,
        }
    }
...
pub type SWIER_W<'a, REG> = crate::BitWriter<'a, REG, SWIERW>;
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SWIER0` field.</div>
    #[inline(always)]
    pub fn swier(&mut self, n: u8) -> SWIER_W<SWIERrs> {
        #[allow(clippy::no_effect)]
        [(); 23][n as usize];
        SWIER_W::new(self, n)
    }
    ///Bit 0 - Software Interrupt on line 0
    #[inline(always)]
    pub fn swier0(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 0)
    }
    ///Bit 1 - Software Interrupt on line 1
    #[inline(always)]
    pub fn swier1(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 1)
    }
    ///Bit 2 - Software Interrupt on line 2
    #[inline(always)]
    pub fn swier2(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 2)
    }
    ///Bit 3 - Software Interrupt on line 3
    #[inline(always)]
    pub fn swier3(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 3)
    }
    ///Bit 4 - Software Interrupt on line 4
    #[inline(always)]
    pub fn swier4(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 4)
    }
    ///Bit 5 - Software Interrupt on line 5
    #[inline(always)]
    pub fn swier5(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 5)
    }
    ///Bit 6 - Software Interrupt on line 6
    #[inline(always)]
    pub fn swier6(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 6)
    }
    ///Bit 7 - Software Interrupt on line 7
    #[inline(always)]
    pub fn swier7(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 7)
    }
    ///Bit 8 - Software Interrupt on line 8
    #[inline(always)]
    pub fn swier8(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 8)
    }
    ///Bit 9 - Software Interrupt on line 9
    #[inline(always)]
    pub fn swier9(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 9)
    }
    ///Bit 10 - Software Interrupt on line 10
    #[inline(always)]
    pub fn swier10(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 10)
    }
    ///Bit 11 - Software Interrupt on line 11
    #[inline(always)]
    pub fn swier11(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 11)
    }
    ///Bit 12 - Software Interrupt on line 12
    #[inline(always)]
    pub fn swier12(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 12)
    }
    ///Bit 13 - Software Interrupt on line 13
    #[inline(always)]
    pub fn swier13(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 13)
    }
    ///Bit 14 - Software Interrupt on line 14
    #[inline(always)]
    pub fn swier14(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 14)
    }
    ///Bit 15 - Software Interrupt on line 15
    #[inline(always)]
    pub fn swier15(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 15)
    }
    ///Bit 16 - Software Interrupt on line 16
    #[inline(always)]
    pub fn swier16(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 16)
    }
    ///Bit 17 - Software Interrupt on line 17
    #[inline(always)]
    pub fn swier17(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 17)
    }
    ///Bit 18 - Software Interrupt on line 18
    #[inline(always)]
    pub fn swier18(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 18)
    }
    ///Bit 19 - Software Interrupt on line 19
    #[inline(always)]
    pub fn swier19(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 19)
    }
    ///Bit 20 - Software Interrupt on line 20
    #[inline(always)]
    pub fn swier20(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 20)
    }
    ///Bit 21 - Software Interrupt on line 21
    #[inline(always)]
    pub fn swier21(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 21)
    }
    ///Bit 22 - Software Interrupt on line 22
    #[inline(always)]
    pub fn swier22(&mut self) -> SWIER_W<SWIERrs> {
        SWIER_W::new(self, 22)
    }
}
/**SWIER
