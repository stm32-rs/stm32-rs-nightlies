...
#[doc = "Field `AFR(L0,L1,L2,L3,L4,L5,L6,L7)` reader - Alternate function selection for port x bit y (y = 0..7)"]
...
#[doc = "Field `AFR(L0,L1,L2,L3,L4,L5,L6,L7)` writer - Alternate function selection for port x bit y (y = 0..7)"]
pub type AFR_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 4, AFRL0>;
...
impl R {
    #[doc = "Alternate function selection for port x bit y (y = 0..7)"]
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `AFRL0` field"]
    #[inline(always)]
