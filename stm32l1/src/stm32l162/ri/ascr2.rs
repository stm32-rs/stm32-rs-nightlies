...
impl W {
    ///Bit 0 - GR10_1 analog switch control
    #[inline(always)]
    pub fn gr10_1(&mut self) -> GR10_1_W<'_, ASCR2rs> {
        GR10_1_W::new(self, 0)
    }
    ///Bit 1 - GR10_2 analog switch control
    #[inline(always)]
    pub fn gr10_2(&mut self) -> GR10_2_W<'_, ASCR2rs> {
        GR10_2_W::new(self, 1)
    }
    ///Bit 2 - GR10_3 analog switch control
    #[inline(always)]
    pub fn gr10_3(&mut self) -> GR10_3_W<'_, ASCR2rs> {
        GR10_3_W::new(self, 2)
    }
    ///Bit 3 - GR10_4 analog switch control
    #[inline(always)]
    pub fn gr10_4(&mut self) -> GR10_4_W<'_, ASCR2rs> {
        GR10_4_W::new(self, 3)
    }
    ///Bit 4 - GR6_1 analog switch control
    #[inline(always)]
    pub fn gr6_1(&mut self) -> GR6_1_W<'_, ASCR2rs> {
        GR6_1_W::new(self, 4)
    }
    ///Bit 5 - GR6_2 analog switch control
    #[inline(always)]
    pub fn gr6_2(&mut self) -> GR6_2_W<'_, ASCR2rs> {
        GR6_2_W::new(self, 5)
    }
    ///Bit 6 - GR5_1 analog switch control
    #[inline(always)]
    pub fn gr5_1(&mut self) -> GR5_1_W<'_, ASCR2rs> {
        GR5_1_W::new(self, 6)
    }
    ///Bit 7 - GR5_2 analog switch control
    #[inline(always)]
    pub fn gr5_2(&mut self) -> GR5_2_W<'_, ASCR2rs> {
        GR5_2_W::new(self, 7)
    }
    ///Bit 8 - GR5_3 analog switch control
    #[inline(always)]
    pub fn gr5_3(&mut self) -> GR5_3_W<'_, ASCR2rs> {
        GR5_3_W::new(self, 8)
    }
    ///Bit 9 - GR4_1 analog switch control
    #[inline(always)]
    pub fn gr4_1(&mut self) -> GR4_1_W<'_, ASCR2rs> {
        GR4_1_W::new(self, 9)
    }
    ///Bit 10 - GR4_2 analog switch control
    #[inline(always)]
    pub fn gr4_2(&mut self) -> GR4_2_W<'_, ASCR2rs> {
        GR4_2_W::new(self, 10)
    }
    ///Bit 11 - GR4_3 analog switch control
    #[inline(always)]
    pub fn gr4_3(&mut self) -> GR4_3_W<'_, ASCR2rs> {
        GR4_3_W::new(self, 11)
    }
    ///Bit 16 - GR3_3 analog switch control
    #[inline(always)]
    pub fn gr3_3(&mut self) -> GR3_3_W<'_, ASCR2rs> {
        GR3_3_W::new(self, 16)
    }
    ///Bit 17 - GR3_4 analog switch control
    #[inline(always)]
    pub fn gr3_4(&mut self) -> GR3_4_W<'_, ASCR2rs> {
        GR3_4_W::new(self, 17)
    }
    ///Bit 18 - GR3_5 analog switch control
    #[inline(always)]
    pub fn gr3_5(&mut self) -> GR3_5_W<'_, ASCR2rs> {
        GR3_5_W::new(self, 18)
    }
    ///Bit 19 - GR9_3 analog switch control
    #[inline(always)]
    pub fn gr9_3(&mut self) -> GR9_3_W<'_, ASCR2rs> {
        GR9_3_W::new(self, 19)
    }
    ///Bit 20 - GR9_4 analog switch control
    #[inline(always)]
    pub fn gr9_4(&mut self) -> GR9_4_W<'_, ASCR2rs> {
        GR9_4_W::new(self, 20)
    }
    ///Bit 21 - GR2_3 analog switch control
    #[inline(always)]
    pub fn gr2_3(&mut self) -> GR2_3_W<'_, ASCR2rs> {
        GR2_3_W::new(self, 21)
    }
    ///Bit 22 - GR2_4 analog switch control
    #[inline(always)]
    pub fn gr2_4(&mut self) -> GR2_4_W<'_, ASCR2rs> {
        GR2_4_W::new(self, 22)
    }
    ///Bit 23 - GR2_5 analog switch control
    #[inline(always)]
    pub fn gr2_5(&mut self) -> GR2_5_W<'_, ASCR2rs> {
        GR2_5_W::new(self, 23)
    }
    ///Bit 24 - GR7_5 analog switch control
    #[inline(always)]
    pub fn gr7_5(&mut self) -> GR7_5_W<'_, ASCR2rs> {
        GR7_5_W::new(self, 24)
    }
    ///Bit 25 - GR7_6 analog switch control
    #[inline(always)]
    pub fn gr7_6(&mut self) -> GR7_6_W<'_, ASCR2rs> {
        GR7_6_W::new(self, 25)
    }
    ///Bit 26 - GR7_7 analog switch control
    #[inline(always)]
    pub fn gr7_7(&mut self) -> GR7_7_W<'_, ASCR2rs> {
        GR7_7_W::new(self, 26)
    }
    ///Bit 27 - GR6_3 analog switch control
    #[inline(always)]
    pub fn gr6_3(&mut self) -> GR6_3_W<'_, ASCR2rs> {
        GR6_3_W::new(self, 27)
    }
    ///Bit 28 - GR6_4 analog switch control
    #[inline(always)]
    pub fn gr6_4(&mut self) -> GR6_4_W<'_, ASCR2rs> {
        GR6_4_W::new(self, 28)
    }
    ///Bit 29 - GR5_4 analog switch control
    #[inline(always)]
    pub fn gr5_4(&mut self) -> GR5_4_W<'_, ASCR2rs> {
        GR5_4_W::new(self, 29)
    }
}
