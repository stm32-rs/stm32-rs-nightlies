...
///Field `DELAY` reader - Delay between 2 sampling phases These bits are set and cleared by software. These bits are used in dual interleaved modes. Refer to Table 112 for the value of ADC resolution versus DELAY bits values. Note: The software is allowed to write these bits only when the ADCs are disabled (ADCAL = 0, JADSTART = 0, ADSTART = 0, ADSTP = 0, ADDIS = 0 and ADEN = 0).
pub type DELAY_R = crate::FieldReader;
///Field `DELAY` writer - Delay between 2 sampling phases These bits are set and cleared by software. These bits are used in dual interleaved modes. Refer to Table 112 for the value of ADC resolution versus DELAY bits values. Note: The software is allowed to write these bits only when the ADCs are disabled (ADCAL = 0, JADSTART = 0, ADSTART = 0, ADSTP = 0, ADDIS = 0 and ADEN = 0).
...
/**V<sub>REFINT</sub> enable This bit is set and cleared by software to enable/disable the V<sub>REFINT</sub> channel.
...
///Field `CH17SEL` reader - CH17 selection This bit is set and cleared by software to control channel 17.
pub type CH17SEL_R = crate::BitReader;
///Field `CH17SEL` writer - CH17 selection This bit is set and cleared by software to control channel 17.
pub type CH17SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH18SEL` reader - CH18 selection This bit is set and cleared by software to control channel 18.
pub type CH18SEL_R = crate::BitReader;
///Field `CH18SEL` writer - CH18 selection This bit is set and cleared by software to control channel 18.
