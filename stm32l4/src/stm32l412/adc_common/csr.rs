...
/**End of regular conversion flag of the master ADC
...
///Field `EOC_SLV` reader - End of regular conversion flag of the slave ADC
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L412.html#ADC_Common:CSR)*/
pub struct CSRrs;
