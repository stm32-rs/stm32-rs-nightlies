...
pub type TRIMLPOFFSETN_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type TRIMLPOFFSETP_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
impl R {
...
impl W {
    ///Bits 0:4 - Trim for NMOS differential pairs
    #[inline(always)]
    pub fn trimlpoffsetn(&mut self) -> TRIMLPOFFSETN_W<'_, OPAMP1_LPOTRrs> {
        TRIMLPOFFSETN_W::new(self, 0)
    }
    ///Bits 8:12 - Trim for PMOS differential pairs
    #[inline(always)]
    pub fn trimlpoffsetp(&mut self) -> TRIMLPOFFSETP_W<'_, OPAMP1_LPOTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L412.html#OPAMP:OPAMP1_LPOTR)*/
