...
///Field `BKDFBK0E` reader - BRK DFSDM_BREAK\[0\] enable
pub type BKDFBK0E_R = crate::BitReader;
///Field `BKDFBK0E` writer - BRK DFSDM_BREAK\[0\] enable
...
impl W {
    ...
    ///Bit 8 - BRK DFSDM_BREAK\[0\] enable
    #[inline(always)]
    pub fn bkdfbk0e(&mut self) -> BKDFBK0E_W<'_, OR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L412.html#TIM1:OR2)*/
pub struct OR2rs;
