...
///Field `CNT` reader - Most significant part counter value
pub type CNT_R = crate::FieldReader<u32>;
///Field `CNT` writer - Most significant part counter value
pub type CNT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
    ///Bits 0:31 - Most significant part counter value
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L412.html#TIM2:CNT)*/
pub struct CNTrs;
