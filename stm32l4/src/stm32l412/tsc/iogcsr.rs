...
///Field `GE(1-7)` reader - Analog I/O group x enable
...
///Field `GE(1-7)` writer - Analog I/O group x enable
...
///Field `GS(1-7)` reader - Analog I/O group x status
...
impl R {
    ...
    pub fn ge_iter(&self) -> impl Iterator<Item = GE_R> + '_ {
        (0..7).map(move |n| GE_R::new(((self.bits >> n) & 1) != 0))
    }
    ...
    pub fn gs_iter(&self) -> impl Iterator<Item = GS_R> + '_ {
        (0..7).map(move |n| GS_R::new(((self.bits >> (n + 16)) & 1) != 0))
    }
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `G1E` field.</div>
    #[inline(always)]
    pub fn ge(&mut self, n: u8) -> GE_W<'_, IOGCSRrs> {
        #[allow(clippy::no_effect)]
        [(); 7][n as usize];
        GE_W::new(self, n)
    }
    ///Bit 0 - Analog I/O group x enable
    #[inline(always)]
    pub fn g1e(&mut self) -> GE_W<'_, IOGCSRrs> {
        GE_W::new(self, 0)
    }
    ///Bit 1 - Analog I/O group x enable
    #[inline(always)]
    pub fn g2e(&mut self) -> GE_W<'_, IOGCSRrs> {
        GE_W::new(self, 1)
    }
    ///Bit 2 - Analog I/O group x enable
    #[inline(always)]
    pub fn g3e(&mut self) -> GE_W<'_, IOGCSRrs> {
        GE_W::new(self, 2)
    }
    ///Bit 3 - Analog I/O group x enable
    #[inline(always)]
    pub fn g4e(&mut self) -> GE_W<'_, IOGCSRrs> {
        GE_W::new(self, 3)
    }
    ///Bit 4 - Analog I/O group x enable
    #[inline(always)]
    pub fn g5e(&mut self) -> GE_W<'_, IOGCSRrs> {
        GE_W::new(self, 4)
    }
    ///Bit 5 - Analog I/O group x enable
    #[inline(always)]
    pub fn g6e(&mut self) -> GE_W<'_, IOGCSRrs> {
        GE_W::new(self, 5)
    }
    ///Bit 6 - Analog I/O group x enable
    #[inline(always)]
    pub fn g7e(&mut self) -> GE_W<'_, IOGCSRrs> {
        GE_W::new(self, 6)
    }
}
