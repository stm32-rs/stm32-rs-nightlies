...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L412.html#USB:EP[0]R)*/
pub struct EPRrs;
...
impl crate::Writable for EPRrs {
    ...
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0x8080;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0x7070;
}
