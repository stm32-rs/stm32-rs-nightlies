...
impl From<DFSDMCFG> for bool {
    #[inline(always)]
    fn from(variant: DFSDMCFG) -> Self {
        variant as u8 != 0
    }
}
///Field `DFSDMCFG` reader - DFSDM mode configuration
pub type DFSDMCFG_R = crate::BitReader<DFSDMCFG>;
impl DFSDMCFG_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> DFSDMCFG {
        match self.bits {
            false => DFSDMCFG::Disabled,
            true => DFSDMCFG::Enabled,
        }
    }
    ///DFSDM mode disabled
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == DFSDMCFG::Disabled
    }
    ///DFSDM mode enabled
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == DFSDMCFG::Enabled
    }
}
///Field `DFSDMCFG` writer - DFSDM mode configuration
pub type DFSDMCFG_W<'a, REG> = crate::BitWriter<'a, REG, DFSDMCFG>;
impl<'a, REG> DFSDMCFG_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///DFSDM mode disabled
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(DFSDMCFG::Disabled)
    }
    ///DFSDM mode enabled
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(DFSDMCFG::Enabled)
    }
}
/**RES
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#ADC1:CFGR)*/
pub struct CFGRrs;
