...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum LOCK {
    ///0: COMPx_CSR\[31:0\] for comparator x are read/write
    Unlocked = 0,
    ///1: COMPx_CSR\[31:0\] for comparator x are read-only
    Locked = 1,
}
...
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///COMPx_CSR\[31:0\] for comparator x are read/write
    #[inline(always)]
    pub fn unlocked(self) -> &'a mut crate::W<REG> {
        self.variant(LOCK::Unlocked)
    }
    ///COMPx_CSR\[31:0\] for comparator x are read-only
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#COMP:COMP1_CSR)*/
