...
///Field `THOLD1` writer - DAC Channel 1 hold Time
pub type THOLD1_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16, crate::Safe>;
///Field `THOLD2` reader - DAC Channel 2 hold time
pub type THOLD2_R = crate::FieldReader<u16>;
///Field `THOLD2` writer - DAC Channel 2 hold time
pub type THOLD2_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16, crate::Safe>;
impl R {
