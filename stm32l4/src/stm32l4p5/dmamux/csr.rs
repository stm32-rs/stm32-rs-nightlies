...
///Field `SOF(0-13)` reader - Synchronization Overrun Flag %s
...
impl R {
    ///Synchronization Overrun Flag (0-13)
    ///
    ...
    pub fn sof_iter(&self) -> impl Iterator<Item = SOF_R> + '_ {
        (0..14).map(move |n| SOF_R::new(((self.bits >> n) & 1) != 0))
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#DMAMUX:CSR)*/
pub struct CSRrs;
