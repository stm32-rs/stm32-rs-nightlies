...
impl W {
    ///Bit 0 - Mode 0 / mode 3
    #[inline(always)]
    pub fn ckmode(&mut self) -> CKMODE_W<'_, DCR1rs> {
        CKMODE_W::new(self, 0)
    }
    ///Bit 1 - Free running clock
    #[inline(always)]
    ...
    ///Bit 3 - Delay block bypass
    #[inline(always)]
    pub fn dlybyp(&mut self) -> DLYBYP_W<'_, DCR1rs> {
        DLYBYP_W::new(self, 3)
    }
    ///Bits 8:13 - Chip-select high time
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#OCTOSPI1:DCR1)*/
pub struct DCR1rs;
