...
///Field `R1MODE` reader - Main regulator Range 1 mode
...
///Field `R1MODE` writer - Main regulator Range 1 mode
...
impl R {
    ///Bit 8 - Main regulator Range 1 mode
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#PWR:CR5)*/
pub struct CR5rs;
