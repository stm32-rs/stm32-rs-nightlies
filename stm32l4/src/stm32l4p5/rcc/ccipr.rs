...
impl CLK48SEL_R {
    ...
    pub const fn variant(&self) -> CLK48SEL {
        match self.bits {
            0 => CLK48SEL::Hsi48,
            1 => CLK48SEL::Pll48m2clk,
            2 => CLK48SEL::Pll48m1clk,
            3 => CLK48SEL::Msi,
            _ => unreachable!(),
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "PLL48M2CLK clock selected"]
    #[inline(always)]
    pub fn pll48m2clk(self) -> &'a mut crate::W<REG> {
        self.variant(CLK48SEL::Pll48m2clk)
    }
    #[doc = "PLL48M1CLK clock selected"]
    #[inline(always)]
    pub fn pll48m1clk(self) -> &'a mut crate::W<REG> {
        self.variant(CLK48SEL::Pll48m1clk)
    }
    #[doc = "MSI clock selected"]
    #[inline(always)]
...
impl ADCSEL_R {
    ...
    pub const fn variant(&self) -> Option<ADCSEL> {
        match self.bits {
            0 => Some(ADCSEL::NoClock),
            1 => Some(ADCSEL::Plladc1clk),
            3 => Some(ADCSEL::Sysclk),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "PLLADC1CLK clock selected"]
    #[inline(always)]
    pub fn plladc1clk(self) -> &'a mut crate::W<REG> {
        self.variant(ADCSEL::Plladc1clk)
    }
    #[doc = "SYSCLK clock selected"]
    #[inline(always)]
    pub fn sysclk(self) -> &'a mut crate::W<REG> {
