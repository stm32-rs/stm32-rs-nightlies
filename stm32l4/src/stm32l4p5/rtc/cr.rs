...
pub use ALRAE_R as ALRBE_R;
///Field `ALRBE` writer - Alarm B enable
pub use ALRAE_W as ALRBE_W;
/**Wakeup timer enable
...
pub use ALRAIE_R as ALRBIE_R;
///Field `ALRBIE` writer - Alarm B interrupt enable
pub use ALRAIE_W as ALRBIE_W;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#RTC:CR)*/
pub struct CRrs;
