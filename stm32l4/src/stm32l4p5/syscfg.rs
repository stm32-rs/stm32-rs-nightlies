...
#[doc = "SKR"]
pub mod skr;
#[doc = "SWPR2 (rw) register accessor: write protection register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`swpr2::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`swpr2::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@swpr2`]
module"]
