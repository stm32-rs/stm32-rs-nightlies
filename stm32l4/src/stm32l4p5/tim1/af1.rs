...
/**Field `BKDF1BK0E` reader - BRK dfsdm1_break\[0\]
enable This bit enables the dfsdm1_break\[0\]
for the timer s BRK input. dfsdm1_break\[0\]
...
/**Field `BKDF1BK0E` writer - BRK dfsdm1_break\[0\]
enable This bit enables the dfsdm1_break\[0\]
for the timer s BRK input. dfsdm1_break\[0\]
output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).*/
