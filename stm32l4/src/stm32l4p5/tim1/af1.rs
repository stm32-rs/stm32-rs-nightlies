...
///Field `BKDF1BK0E` reader - BRK dfsdm1_break\[0\] enable This bit enables the dfsdm1_break\[0\] for the timer s BRK input. dfsdm1_break\[0\] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
pub type BKDF1BK0E_R = crate::BitReader;
///Field `BKDF1BK0E` writer - BRK dfsdm1_break\[0\] enable This bit enables the dfsdm1_break\[0\] for the timer s BRK input. dfsdm1_break\[0\] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
impl W {
    ...
    ///Bit 8 - BRK dfsdm1_break\[0\] enable This bit enables the dfsdm1_break\[0\] for the timer s BRK input. dfsdm1_break\[0\] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    #[inline(always)]
    pub fn bkdf1bk0e(&mut self) -> BKDF1BK0E_W<AF1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#TIM1:AF1)*/
pub struct AF1rs;
