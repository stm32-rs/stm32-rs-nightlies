...
///Field `SMS3` reader - Bit 3 of Slave mode selection
pub type SMS3_R = crate::BitReader;
///Field `SMS3` writer - Bit 3 of Slave mode selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#TIM1:SMCR)*/
pub struct SMCRrs;
