...
#[doc = "Field `CCIF(1-2)` reader - Capture/compare %s interrupt flag"]
pub type CCIF_R = crate::BitReader;
#[doc = "Field `CCIF(1-2)` writer - Capture/compare %s interrupt flag"]
...
#[doc = "Field `CCOF(1-2)` reader - Capture/Compare %s overcapture flag"]
pub type CCOF_R = crate::BitReader;
#[doc = "Field `CCOF(1-2)` writer - Capture/Compare %s overcapture flag"]
...
impl R {
    ...
    #[doc = "Capture/compare (1-2) interrupt flag"]
    #[doc = ""]
    ...
    #[doc = "Capture/Compare (1-2) overcapture flag"]
    #[doc = ""]
    ...
    pub fn ccof_iter(&self) -> impl Iterator<Item = CCOF_R> + '_ {
        (0..2).map(move |n| CCOF_R::new(((self.bits >> (n * 0 + 9)) & 1) != 0))
    }
