...
/**Field `BKDF1BK2E` reader - BRK dfsdm1_break\[2\]
enable This bit enables the dfsdm1_break\[2\]
for the timer s BRK input. dfsdm1_break\[2\]
output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).*/
pub type BKDF1BK2E_R = crate::BitReader;
/**Field `BKDF1BK2E` writer - BRK dfsdm1_break\[2\]
enable This bit enables the dfsdm1_break\[2\]
for the timer s BRK input. dfsdm1_break\[2\]
output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).*/
...
impl W {
    ...
    output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).*/
    #[inline(always)]
    pub fn bkdf1bk2e(&mut self) -> BKDF1BK2E_W<AF1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#TIM17:AF1)*/
pub struct AF1rs;
