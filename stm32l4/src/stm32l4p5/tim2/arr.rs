...
///Field `ARR` reader - Low Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 25.3.1: Time-base unit on page 786 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
pub type ARR_R = crate::FieldReader<u32>;
///Field `ARR` writer - Low Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 25.3.1: Time-base unit on page 786 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4P5.html#TIM2:ARR)*/
pub struct ARRrs;
