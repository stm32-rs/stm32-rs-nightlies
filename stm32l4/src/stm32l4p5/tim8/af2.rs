...
/**Field `BK2DF1BK3E` reader - BRK2 dfsdm1_break\[3\]
enable This bit enables the dfsdm1_break\[3\]
for the timer s BRK2 input. dfsdm1_break\[3\]
...
/**Field `BK2DF1BK3E` writer - BRK2 dfsdm1_break\[3\]
enable This bit enables the dfsdm1_break\[3\]
for the timer s BRK2 input. dfsdm1_break\[3\]
output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).*/
