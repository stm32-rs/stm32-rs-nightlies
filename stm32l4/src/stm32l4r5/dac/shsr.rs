...
///Field `TSAMPLE` reader - DAC Channel 1 sample Time
pub type TSAMPLE_R = crate::FieldReader<u16>;
///Field `TSAMPLE` writer - DAC Channel 1 sample Time
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#DAC:SHSR[1])*/
pub struct SHSRrs;
