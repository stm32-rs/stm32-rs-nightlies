///Register `CH2AWSCDR` reader
pub type R = crate::R<CH2AWSCDRrs>;
///Register `CH2AWSCDR` writer
...
You can [`read`](crate::Reg::read) this register and get [`ch2awscdr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch2awscdr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`ch2awscdr::R`](R) reader structure
impl crate::Readable for CH2AWSCDRrs {}
///`write(|w| ..)` method takes [`ch2awscdr::W`](W) writer structure
