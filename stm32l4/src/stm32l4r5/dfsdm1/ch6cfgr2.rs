///Register `CH6CFGR2` reader
pub type R = crate::R<CH6CFGR2rs>;
///Register `CH6CFGR2` writer
...
///`read()` method returns [`ch6cfgr2::R`](R) reader structure
impl crate::Readable for CH6CFGR2rs {}
///`write(|w| ..)` method takes [`ch6cfgr2::W`](W) writer structure
