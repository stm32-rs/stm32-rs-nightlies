///Register `DFSDM_FLT0AWHTR` reader
pub type R = crate::R<DFSDM_FLT0AWHTRrs>;
///Register `DFSDM_FLT0AWHTR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT0AWHTR")
...
///`read()` method returns [`dfsdm_flt0awhtr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT0AWHTRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt0awhtr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT0AWHTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT0AWHTR to value 0
