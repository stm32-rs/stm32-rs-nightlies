///Register `DFSDM_FLT0CR2` reader
pub type R = crate::R<DFSDM_FLT0CR2rs>;
///Register `DFSDM_FLT0CR2` writer
...
///`read()` method returns [`dfsdm_flt0cr2::R`](R) reader structure
impl crate::Readable for DFSDM_FLT0CR2rs {}
///`write(|w| ..)` method takes [`dfsdm_flt0cr2::W`](W) writer structure
impl crate::Writable for DFSDM_FLT0CR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT0CR2 to value 0
