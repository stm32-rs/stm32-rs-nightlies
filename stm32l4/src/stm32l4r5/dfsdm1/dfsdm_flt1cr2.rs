///Register `DFSDM_FLT1CR2` reader
pub type R = crate::R<DFSDM_FLT1CR2rs>;
///Register `DFSDM_FLT1CR2` writer
pub type W = crate::W<DFSDM_FLT1CR2rs>;
...
impl W {
    ///Bit 0 - Injected end of conversion interrupt enable
    #[inline(always)]
    pub fn jeocie(&mut self) -> JEOCIE_W<DFSDM_FLT1CR2rs> {
        JEOCIE_W::new(self, 0)
    }
    ///Bit 1 - Regular end of conversion interrupt enable
    #[inline(always)]
    pub fn reocie(&mut self) -> REOCIE_W<DFSDM_FLT1CR2rs> {
        REOCIE_W::new(self, 1)
    }
    ///Bit 2 - Injected data overrun interrupt enable
    #[inline(always)]
    pub fn jovrie(&mut self) -> JOVRIE_W<DFSDM_FLT1CR2rs> {
        JOVRIE_W::new(self, 2)
    }
    ///Bit 3 - Regular data overrun interrupt enable
    #[inline(always)]
    pub fn rovrie(&mut self) -> ROVRIE_W<DFSDM_FLT1CR2rs> {
        ROVRIE_W::new(self, 3)
    }
    ///Bit 4 - Analog watchdog interrupt enable
    #[inline(always)]
    pub fn awdie(&mut self) -> AWDIE_W<DFSDM_FLT1CR2rs> {
        AWDIE_W::new(self, 4)
    }
    ///Bit 5 - Short-circuit detector interrupt enable
    #[inline(always)]
    pub fn scdie(&mut self) -> SCDIE_W<DFSDM_FLT1CR2rs> {
        SCDIE_W::new(self, 5)
    }
    ///Bit 6 - Clock absence interrupt enable
    #[inline(always)]
    pub fn ckabie(&mut self) -> CKABIE_W<DFSDM_FLT1CR2rs> {
        CKABIE_W::new(self, 6)
    }
    ///Bits 8:15 - Extremes detector channel selection
    #[inline(always)]
    pub fn exch(&mut self) -> EXCH_W<DFSDM_FLT1CR2rs> {
        EXCH_W::new(self, 8)
    }
    ///Bits 16:23 - Analog watchdog channel selection
    #[inline(always)]
    pub fn awdch(&mut self) -> AWDCH_W<DFSDM_FLT1CR2rs> {
        AWDCH_W::new(self, 16)
    }
}
/**control register 2

You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt1cr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_flt1cr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#DFSDM1:DFSDM_FLT1CR2)*/
pub struct DFSDM_FLT1CR2rs;
impl crate::RegisterSpec for DFSDM_FLT1CR2rs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt1cr2::R`](R) reader structure
impl crate::Readable for DFSDM_FLT1CR2rs {}
///`write(|w| ..)` method takes [`dfsdm_flt1cr2::W`](W) writer structure
impl crate::Writable for DFSDM_FLT1CR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT1CR2 to value 0
impl crate::Resettable for DFSDM_FLT1CR2rs {
