...
pub type R = crate::R<DFSDM_FLT1RDATARrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT1RDATAR")
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt1rdatar::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#DFSDM1:DFSDM_FLT1RDATAR)*/
pub struct DFSDM_FLT1RDATARrs;
impl crate::RegisterSpec for DFSDM_FLT1RDATARrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt1rdatar::R`](R) reader structure
impl crate::Readable for DFSDM_FLT1RDATARrs {}
///`reset()` method sets DFSDM_FLT1RDATAR to value 0
impl crate::Resettable for DFSDM_FLT1RDATARrs {
