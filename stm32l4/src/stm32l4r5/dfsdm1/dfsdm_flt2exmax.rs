...
pub type R = crate::R<DFSDM_FLT2EXMAXrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT2EXMAX")
...
pub struct DFSDM_FLT2EXMAXrs;
impl crate::RegisterSpec for DFSDM_FLT2EXMAXrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt2exmax::R`](R) reader structure
impl crate::Readable for DFSDM_FLT2EXMAXrs {}
///`reset()` method sets DFSDM_FLT2EXMAX to value 0x8000_0000
impl crate::Resettable for DFSDM_FLT2EXMAXrs {
