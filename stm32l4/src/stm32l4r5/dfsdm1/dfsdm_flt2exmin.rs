///Register `DFSDM_FLT2EXMIN` reader
pub type R = crate::R<DFSDM_FLT2EXMINrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT2EXMIN")
...
pub struct DFSDM_FLT2EXMINrs;
impl crate::RegisterSpec for DFSDM_FLT2EXMINrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt2exmin::R`](R) reader structure
impl crate::Readable for DFSDM_FLT2EXMINrs {}
///`reset()` method sets DFSDM_FLT2EXMIN to value 0x7fff_ff00
impl crate::Resettable for DFSDM_FLT2EXMINrs {
