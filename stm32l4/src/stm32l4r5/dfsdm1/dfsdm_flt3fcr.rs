///Register `DFSDM_FLT3FCR` reader
pub type R = crate::R<DFSDM_FLT3FCRrs>;
///Register `DFSDM_FLT3FCR` writer
pub type W = crate::W<DFSDM_FLT3FCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iosr(&mut self) -> IOSR_W<DFSDM_FLT3FCRrs> {
        IOSR_W::new(self, 0)
    }
    ///Bits 16:25 - Sinc filter oversampling ratio (decimation rate)
    #[inline(always)]
    #[must_use]
    pub fn fosr(&mut self) -> FOSR_W<DFSDM_FLT3FCRrs> {
        FOSR_W::new(self, 16)
    }
    ///Bits 29:31 - Sinc filter order
    #[inline(always)]
    #[must_use]
    pub fn ford(&mut self) -> FORD_W<DFSDM_FLT3FCRrs> {
        FORD_W::new(self, 29)
    }
}
/**filter control register

You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt3fcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_flt3fcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#DFSDM1:DFSDM_FLT3FCR)*/
pub struct DFSDM_FLT3FCRrs;
impl crate::RegisterSpec for DFSDM_FLT3FCRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt3fcr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT3FCRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt3fcr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT3FCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT3FCR to value 0
impl crate::Resettable for DFSDM_FLT3FCRrs {
