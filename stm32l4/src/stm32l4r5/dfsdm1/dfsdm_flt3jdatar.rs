///Register `DFSDM_FLT3JDATAR` reader
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT3JDATAR")
...
///`read()` method returns [`dfsdm_flt3jdatar::R`](R) reader structure
impl crate::Readable for DFSDM_FLT3JDATARrs {}
///`reset()` method sets DFSDM_FLT3JDATAR to value 0
