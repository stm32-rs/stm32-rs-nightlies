///Register `DFSDM_FLT3RDATAR` reader
pub type R = crate::R<DFSDM_FLT3RDATARrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT3RDATAR")
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt3rdatar::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#DFSDM1:DFSDM_FLT3RDATAR)*/
pub struct DFSDM_FLT3RDATARrs;
impl crate::RegisterSpec for DFSDM_FLT3RDATARrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt3rdatar::R`](R) reader structure
impl crate::Readable for DFSDM_FLT3RDATARrs {}
///`reset()` method sets DFSDM_FLT3RDATAR to value 0
impl crate::Resettable for DFSDM_FLT3RDATARrs {
