///Register `FLT1ISR` reader
pub type R = crate::R<FLT1ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`flt1isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#DFSDM1:FLT1ISR)*/
pub struct FLT1ISRrs;
impl crate::RegisterSpec for FLT1ISRrs {
    type Ux = u32;
}
///`read()` method returns [`flt1isr::R`](R) reader structure
impl crate::Readable for FLT1ISRrs {}
///`reset()` method sets FLT1ISR to value 0x00ff_0000
impl crate::Resettable for FLT1ISRrs {
