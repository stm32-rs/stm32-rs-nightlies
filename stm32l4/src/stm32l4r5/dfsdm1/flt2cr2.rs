///Register `FLT2CR2` reader
pub type R = crate::R<FLT2CR2rs>;
///Register `FLT2CR2` writer
...
You can [`read`](crate::Reg::read) this register and get [`flt2cr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flt2cr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`flt2cr2::R`](R) reader structure
impl crate::Readable for FLT2CR2rs {}
///`write(|w| ..)` method takes [`flt2cr2::W`](W) writer structure
