...
pub type PCROP2_END_R = crate::FieldReader<u32>;
///Field `PCROP2_END` writer - Bank 2 PCROP area end offset
pub type PCROP2_END_W<'a, REG> = crate::FieldWriter<'a, REG, 17, u32, crate::Safe>;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#FLASH:PCROP2ER)*/
...
///`reset()` method sets PCROP2ER to value 0x0ff0_0000
