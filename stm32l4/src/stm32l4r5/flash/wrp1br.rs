...
///Field `WRP1B_STRT` reader - Bank 2 WRP first area A start offset
pub type WRP1B_STRT_R = crate::FieldReader;
///Field `WRP1B_STRT` writer - Bank 2 WRP first area A start offset
pub type WRP1B_STRT_W<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
///Field `WRP1B_END` reader - Bank 2 WRP first area A end offset
pub type WRP1B_END_R = crate::FieldReader;
///Field `WRP1B_END` writer - Bank 2 WRP first area A end offset
