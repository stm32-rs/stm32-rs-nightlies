...
///Field `WRP2A_STRT` reader - WRP first area A start offset
pub type WRP2A_STRT_R = crate::FieldReader;
///Field `WRP2A_STRT` writer - WRP first area A start offset
pub type WRP2A_STRT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `WRP2A_END` reader - WRP first area A end offset
pub type WRP2A_END_R = crate::FieldReader;
///Field `WRP2A_END` writer - WRP first area A end offset
pub type WRP2A_END_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - WRP first area A start offset
    #[inline(always)]
    pub fn wrp2a_strt(&self) -> WRP2A_STRT_R {
        WRP2A_STRT_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 16:23 - WRP first area A end offset
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#FLASH:WRP2AR)*/
pub struct WRP2ARrs;
