...
pub type WRP2B_STRT_W<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
...
pub type WRP2B_END_W<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#FLASH:WRP2BR)*/
pub struct WRP2BRrs;
