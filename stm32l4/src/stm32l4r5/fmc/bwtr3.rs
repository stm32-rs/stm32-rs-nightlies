...
impl W {
    ...
    ///Bits 20:23 - CLKDIV
    #[inline(always)]
    pub fn clkdiv(&mut self) -> CLKDIV_W<BWTR3rs> {
        CLKDIV_W::new(self, 20)
    }
    ///Bits 24:27 - DATLAT
    #[inline(always)]
    pub fn datlat(&mut self) -> DATLAT_W<BWTR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#FMC:BWTR3)*/
pub struct BWTR3rs;
