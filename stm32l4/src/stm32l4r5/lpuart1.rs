...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn cr1_alternate(&self) -> &CR1_ALTERNATE {
    ...
    #[inline(always)]
    pub const fn isr_alternate(&self) -> &ISR_ALTERNATE {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:CR1)
...
pub mod cr1;
/**CR1_ALTERNATE (rw) register accessor: LPUART control register 1

You can [`read`](crate::Reg::read) this register and get [`cr1_alternate::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cr1_alternate::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:CR1_ALTERNATE)

For information about available fields see [`mod@cr1_alternate`]
module*/
pub type CR1_ALTERNATE = crate::Reg<cr1_alternate::CR1_ALTERNATErs>;
///LPUART control register 1
pub mod cr1_alternate;
/**CR2 (rw) register accessor: LPUART control register 2

You can [`read`](crate::Reg::read) this register and get [`cr2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cr2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:CR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:BRR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:RQR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:ISR)
...
pub mod isr;
/**ISR_ALTERNATE (r) register accessor: LPUART interrupt and status register

You can [`read`](crate::Reg::read) this register and get [`isr_alternate::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:ISR_ALTERNATE)

For information about available fields see [`mod@isr_alternate`]
module*/
pub type ISR_ALTERNATE = crate::Reg<isr_alternate::ISR_ALTERNATErs>;
///LPUART interrupt and status register
pub mod isr_alternate;
/**ICR (w) register accessor: LPUART interrupt flag clear register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:RDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:TDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#LPUART1:PRESC)
