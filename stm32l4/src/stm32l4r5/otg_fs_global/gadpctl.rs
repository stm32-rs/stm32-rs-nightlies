...
pub type PRBPER_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
pub type ADPRST_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    ///Bit 19 - ADP reset
    #[inline(always)]
    pub fn adprst(&mut self) -> ADPRST_W<'_, GADPCTLrs> {
        ADPRST_W::new(self, 19)
    }
    ///Bit 20 - ADP enable
    #[inline(always)]
