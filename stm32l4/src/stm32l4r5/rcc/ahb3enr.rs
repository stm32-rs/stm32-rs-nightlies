...
///Field `OSPI1EN` reader - OSPI1 memory interface clock enable
pub type OSPI1EN_R = crate::BitReader;
///Field `OSPI1EN` writer - OSPI1 memory interface clock enable
...
impl R {
    ...
    ///Bit 8 - OSPI1 memory interface clock enable
    #[inline(always)]
