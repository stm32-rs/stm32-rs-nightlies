...
///Field `OSPI1RST` reader - OSPI1 memory interface reset
pub type OSPI1RST_R = crate::BitReader;
///Field `OSPI1RST` writer - OSPI1 memory interface reset
pub type OSPI1RST_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    ///Bit 8 - OSPI1 memory interface reset
    #[inline(always)]
