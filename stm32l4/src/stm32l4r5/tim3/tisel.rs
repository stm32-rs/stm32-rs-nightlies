...
///Field `TI3SEL` reader - TI3\[0\] to TI3\[15\] input selection These bits select the TI3\[0\] to TI3\[15\] input source. Others: Reserved
pub type TI3SEL_R = crate::FieldReader;
///Field `TI3SEL` writer - TI3\[0\] to TI3\[15\] input selection These bits select the TI3\[0\] to TI3\[15\] input source. Others: Reserved
pub type TI3SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TI4SEL` reader - TI4\[0\] to TI4\[15\] input selection These bits select the TI4\[0\] to TI4\[15\] input source. Others: Reserved
pub type TI4SEL_R = crate::FieldReader;
///Field `TI4SEL` writer - TI4\[0\] to TI4\[15\] input selection These bits select the TI4\[0\] to TI4\[15\] input source. Others: Reserved
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R5.html#TIM3:TISEL)*/
pub struct TISELrs;
