...
///Field `CH17SEL` reader - CH17 selection
pub type CH17SEL_R = crate::BitReader;
///Field `CH17SEL` writer - CH17 selection
pub type CH17SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH18SEL` reader - CH18 selection
pub type CH18SEL_R = crate::BitReader;
///Field `CH18SEL` writer - CH18 selection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#ADC_Common:CCR)*/
pub struct CCRrs;
