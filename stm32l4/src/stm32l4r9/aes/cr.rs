...
///Field `CHMOD_2` reader - Chaining mode selection, bit \[2\]
...
///Field `CHMOD_2` writer - Chaining mode selection, bit \[2\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#AES:CR)*/
pub struct CRrs;
