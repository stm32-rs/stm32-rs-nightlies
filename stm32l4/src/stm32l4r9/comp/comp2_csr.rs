...
///Field `COMP2_INMSEL` reader - Comparator 2 Input Minus connection configuration bit
pub type COMP2_INMSEL_R = crate::FieldReader;
///Field `COMP2_INMSEL` writer - Comparator 2 Input Minus connection configuration bit
pub type COMP2_INMSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `COMP2_INPSEL` reader - Comparator 2 Input Plus connection configuration bit
pub type COMP2_INPSEL_R = crate::BitReader;
///Field `COMP2_INPSEL` writer - Comparator 2 Input Plus connection configuration bit
...
///Field `COMP2_LOCK` writer - COMP2_CSR register lock bit
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#COMP:COMP2_CSR)*/
