...
pub type R = crate::R<CH3CFGR2rs>;
#[doc = "Register `CH3CFGR2` writer"]
pub type W = crate::W<CH3CFGR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtrbs(&mut self) -> DTRBS_W<CH3CFGR2rs> {
        DTRBS_W::new(self, 3)
    }
    #[doc = "Bits 8:31 - OFFSET"]
    #[inline(always)]
    #[must_use]
    pub fn offset(&mut self) -> OFFSET_W<CH3CFGR2rs> {
        OFFSET_W::new(self, 8)
    }
}
#[doc = "CH3CFGR2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch3cfgr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch3cfgr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH3CFGR2rs;
impl crate::RegisterSpec for CH3CFGR2rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch3cfgr2::R`](R) reader structure"]
impl crate::Readable for CH3CFGR2rs {}
#[doc = "`write(|w| ..)` method takes [`ch3cfgr2::W`](W) writer structure"]
impl crate::Writable for CH3CFGR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH3CFGR2 to value 0"]
impl crate::Resettable for CH3CFGR2rs {
