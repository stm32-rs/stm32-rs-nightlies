...
pub type R = crate::R<DFSDM_FLT0EXMAXrs>;
...
#[doc = "Extremes detector maximum register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dfsdm_flt0exmax::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DFSDM_FLT0EXMAXrs;
impl crate::RegisterSpec for DFSDM_FLT0EXMAXrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt0exmax::R`](R) reader structure"]
impl crate::Readable for DFSDM_FLT0EXMAXrs {}
#[doc = "`reset()` method sets DFSDM_FLT0EXMAX to value 0x8000_0000"]
impl crate::Resettable for DFSDM_FLT0EXMAXrs {
