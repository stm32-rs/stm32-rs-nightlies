///Register `DFSDM_FLT2AWCFR` reader
pub type R = crate::R<DFSDM_FLT2AWCFRrs>;
///Register `DFSDM_FLT2AWCFR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT2AWCFR")
...
///`read()` method returns [`dfsdm_flt2awcfr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT2AWCFRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt2awcfr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT2AWCFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT2AWCFR to value 0
