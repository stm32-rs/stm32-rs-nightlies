...
pub type R = crate::R<DFSDM_FLT2AWHTRrs>;
#[doc = "Register `DFSDM_FLT2AWHTR` writer"]
pub type W = crate::W<DFSDM_FLT2AWHTRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkawh(&mut self) -> BKAWH_W<DFSDM_FLT2AWHTRrs> {
        BKAWH_W::new(self, 0)
    }
    #[doc = "Bits 8:31 - Analog watchdog high threshold"]
    #[inline(always)]
    #[must_use]
    pub fn awht(&mut self) -> AWHT_W<DFSDM_FLT2AWHTRrs> {
        AWHT_W::new(self, 8)
    }
}
#[doc = "analog watchdog high threshold register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dfsdm_flt2awhtr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dfsdm_flt2awhtr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DFSDM_FLT2AWHTRrs;
impl crate::RegisterSpec for DFSDM_FLT2AWHTRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt2awhtr::R`](R) reader structure"]
impl crate::Readable for DFSDM_FLT2AWHTRrs {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt2awhtr::W`](W) writer structure"]
impl crate::Writable for DFSDM_FLT2AWHTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DFSDM_FLT2AWHTR to value 0"]
impl crate::Resettable for DFSDM_FLT2AWHTRrs {
