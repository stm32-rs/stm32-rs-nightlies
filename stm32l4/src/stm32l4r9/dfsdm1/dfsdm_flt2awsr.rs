///Register `DFSDM_FLT2AWSR` reader
pub type R = crate::R<DFSDM_FLT2AWSRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt2awsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#DFSDM1:DFSDM_FLT2AWSR)*/
pub struct DFSDM_FLT2AWSRrs;
impl crate::RegisterSpec for DFSDM_FLT2AWSRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt2awsr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT2AWSRrs {}
///`reset()` method sets DFSDM_FLT2AWSR to value 0
impl crate::Resettable for DFSDM_FLT2AWSRrs {
