...
pub type R = crate::R<DFSDM_FLT2CR1rs>;
#[doc = "Register `DFSDM_FLT2CR1` writer"]
pub type W = crate::W<DFSDM_FLT2CR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfen(&mut self) -> DFEN_W<DFSDM_FLT2CR1rs> {
        DFEN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Start a conversion of the injected group of channels"]
    #[inline(always)]
    #[must_use]
    pub fn jswstart(&mut self) -> JSWSTART_W<DFSDM_FLT2CR1rs> {
        JSWSTART_W::new(self, 1)
    }
    #[doc = "Bit 3 - Launch an injected conversion synchronously with the DFSDM0 JSWSTART trigger"]
    #[inline(always)]
    #[must_use]
    pub fn jsync(&mut self) -> JSYNC_W<DFSDM_FLT2CR1rs> {
        JSYNC_W::new(self, 3)
    }
    #[doc = "Bit 4 - Scanning conversion mode for injected conversions"]
    #[inline(always)]
    #[must_use]
    pub fn jscan(&mut self) -> JSCAN_W<DFSDM_FLT2CR1rs> {
        JSCAN_W::new(self, 4)
    }
    #[doc = "Bit 5 - DMA channel enabled to read data for the injected channel group"]
    #[inline(always)]
    #[must_use]
    pub fn jdmaen(&mut self) -> JDMAEN_W<DFSDM_FLT2CR1rs> {
        JDMAEN_W::new(self, 5)
    }
    #[doc = "Bits 8:10 - Trigger signal selection for launching injected conversions"]
    #[inline(always)]
    #[must_use]
    pub fn jextsel(&mut self) -> JEXTSEL_W<DFSDM_FLT2CR1rs> {
        JEXTSEL_W::new(self, 8)
    }
    #[doc = "Bits 13:14 - Trigger enable and trigger edge selection for injected conversions"]
    #[inline(always)]
    #[must_use]
    pub fn jexten(&mut self) -> JEXTEN_W<DFSDM_FLT2CR1rs> {
        JEXTEN_W::new(self, 13)
    }
    #[doc = "Bit 17 - Software start of a conversion on the regular channel"]
    #[inline(always)]
    #[must_use]
    pub fn rswstart(&mut self) -> RSWSTART_W<DFSDM_FLT2CR1rs> {
        RSWSTART_W::new(self, 17)
    }
    #[doc = "Bit 18 - Continuous mode selection for regular conversions"]
    #[inline(always)]
    #[must_use]
    pub fn rcont(&mut self) -> RCONT_W<DFSDM_FLT2CR1rs> {
        RCONT_W::new(self, 18)
    }
    #[doc = "Bit 19 - Launch regular conversion synchronously with DFSDM0"]
    #[inline(always)]
    #[must_use]
    pub fn rsync(&mut self) -> RSYNC_W<DFSDM_FLT2CR1rs> {
        RSYNC_W::new(self, 19)
    }
    #[doc = "Bit 21 - DMA channel enabled to read data for the regular conversion"]
    #[inline(always)]
    #[must_use]
    pub fn rdmaen(&mut self) -> RDMAEN_W<DFSDM_FLT2CR1rs> {
        RDMAEN_W::new(self, 21)
    }
    #[doc = "Bits 24:26 - Regular channel selection"]
    #[inline(always)]
    #[must_use]
    pub fn rch(&mut self) -> RCH_W<DFSDM_FLT2CR1rs> {
        RCH_W::new(self, 24)
    }
    #[doc = "Bit 29 - Fast conversion mode selection for regular conversions"]
    #[inline(always)]
    #[must_use]
    pub fn fast(&mut self) -> FAST_W<DFSDM_FLT2CR1rs> {
        FAST_W::new(self, 29)
    }
    #[doc = "Bit 30 - Analog watchdog fast mode select"]
    #[inline(always)]
    #[must_use]
    pub fn awfsel(&mut self) -> AWFSEL_W<DFSDM_FLT2CR1rs> {
        AWFSEL_W::new(self, 30)
    }
}
#[doc = "control register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dfsdm_flt2cr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dfsdm_flt2cr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DFSDM_FLT2CR1rs;
impl crate::RegisterSpec for DFSDM_FLT2CR1rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt2cr1::R`](R) reader structure"]
impl crate::Readable for DFSDM_FLT2CR1rs {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt2cr1::W`](W) writer structure"]
impl crate::Writable for DFSDM_FLT2CR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DFSDM_FLT2CR1 to value 0"]
impl crate::Resettable for DFSDM_FLT2CR1rs {
