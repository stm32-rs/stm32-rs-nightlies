...
pub type R = crate::R<DFSDM_FLT2FCRrs>;
#[doc = "Register `DFSDM_FLT2FCR` writer"]
pub type W = crate::W<DFSDM_FLT2FCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iosr(&mut self) -> IOSR_W<DFSDM_FLT2FCRrs> {
        IOSR_W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Sinc filter oversampling ratio (decimation rate)"]
    #[inline(always)]
    #[must_use]
    pub fn fosr(&mut self) -> FOSR_W<DFSDM_FLT2FCRrs> {
        FOSR_W::new(self, 16)
    }
    #[doc = "Bits 29:31 - Sinc filter order"]
    #[inline(always)]
    #[must_use]
    pub fn ford(&mut self) -> FORD_W<DFSDM_FLT2FCRrs> {
        FORD_W::new(self, 29)
    }
}
#[doc = "filter control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dfsdm_flt2fcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dfsdm_flt2fcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DFSDM_FLT2FCRrs;
impl crate::RegisterSpec for DFSDM_FLT2FCRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt2fcr::R`](R) reader structure"]
impl crate::Readable for DFSDM_FLT2FCRrs {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt2fcr::W`](W) writer structure"]
impl crate::Writable for DFSDM_FLT2FCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DFSDM_FLT2FCR to value 0"]
impl crate::Resettable for DFSDM_FLT2FCRrs {
