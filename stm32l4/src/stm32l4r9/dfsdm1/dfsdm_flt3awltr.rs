///Register `DFSDM_FLT3AWLTR` reader
pub type R = crate::R<DFSDM_FLT3AWLTRrs>;
///Register `DFSDM_FLT3AWLTR` writer
pub type W = crate::W<DFSDM_FLT3AWLTRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT3AWLTR")
...
impl W {
    ///Bits 0:3 - Break signal assignment to analog watchdog low threshold event
    #[inline(always)]
    pub fn bkawl(&mut self) -> BKAWL_W<DFSDM_FLT3AWLTRrs> {
        BKAWL_W::new(self, 0)
    }
    ///Bits 8:31 - Analog watchdog low threshold
    #[inline(always)]
    pub fn awlt(&mut self) -> AWLT_W<DFSDM_FLT3AWLTRrs> {
        AWLT_W::new(self, 8)
    }
}
...
pub struct DFSDM_FLT3AWLTRrs;
impl crate::RegisterSpec for DFSDM_FLT3AWLTRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt3awltr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT3AWLTRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt3awltr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT3AWLTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT3AWLTR to value 0
impl crate::Resettable for DFSDM_FLT3AWLTRrs {
