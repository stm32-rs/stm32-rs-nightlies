///Register `DFSDM_FLT3EXMIN` reader
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT3EXMIN")
...
///`read()` method returns [`dfsdm_flt3exmin::R`](R) reader structure
impl crate::Readable for DFSDM_FLT3EXMINrs {}
///`reset()` method sets DFSDM_FLT3EXMIN to value 0x7fff_ff00
