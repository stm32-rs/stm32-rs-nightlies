...
pub mod cltcr;
#[doc = "DLTRC (rw) register accessor: DSI Host Data Lane Timer Configuration Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dltrc::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dltrc::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@dltrc`]
module"]
...
pub mod vscr;
#[doc = "LCVCIDR (r) register accessor: DSI Host LTDC Current VCID Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lcvcidr::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcvcidr`]
module"]
