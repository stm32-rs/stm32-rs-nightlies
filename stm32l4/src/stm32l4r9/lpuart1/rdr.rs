...
///Field `RDR` reader - Receive data value Contains the received data character. The RDR register provides the parallel interface between the input shift register and the internal bus (see Figure 347). When receiving with the parity enabled, the value read in the MSB bit is the received parity bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#LPUART1:RDR)*/
pub struct RDRrs;
