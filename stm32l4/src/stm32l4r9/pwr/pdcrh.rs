...
/**Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
...
///Field `PD0` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
...
///Field `PD0` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
...
///Field `PD1` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD1_R;
///Field `PD2` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD2_R;
///Field `PD3` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD3_R;
///Field `PD4` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD4_R;
///Field `PD5` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD5_R;
///Field `PD6` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD6_R;
///Field `PD7` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD7_R;
///Field `PD8` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD8_R;
///Field `PD9` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD9_R;
///Field `PD10` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD10_R;
///Field `PD11` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD11_R;
///Field `PD12` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD12_R;
///Field `PD13` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD13_R;
///Field `PD14` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD14_R;
///Field `PD15` reader - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_R as PD15_R;
///Field `PD1` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD1_W;
///Field `PD2` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD2_W;
///Field `PD3` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD3_W;
///Field `PD4` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD4_W;
///Field `PD5` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD5_W;
///Field `PD6` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD6_W;
///Field `PD7` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD7_W;
///Field `PD8` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD8_W;
///Field `PD9` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD9_W;
///Field `PD10` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD10_W;
///Field `PD11` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD11_W;
///Field `PD12` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD12_W;
///Field `PD13` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD13_W;
///Field `PD14` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
pub use PD0_W as PD14_W;
///Field `PD15` writer - Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH\[y\] when APC bit is set in PWR_CR3 register.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#PWR:PDCRH)*/
pub struct PDCRHrs;
