...
pub struct GFXMMUSMEN_R(crate::FieldReader<bool, bool>);
impl GFXMMUSMEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        GFXMMUSMEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GFXMMUSMEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GFXMMUSMEN_W<'a> {
    w: &'a mut W,
}
impl<'a> GFXMMUSMEN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn gfxmmusmen(&self) -> GFXMMUSMEN_R {
        GFXMMUSMEN_R::new(((self.bits >> 18) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - DMA1 clocks enable during Sleep and Stop modes"]
    ...
    #[doc = "Bit 18 - GFXMMU clock enable during Sleep and Stop modes"]
    #[inline(always)]
    pub fn gfxmmusmen(&mut self) -> GFXMMUSMEN_W {
        GFXMMUSMEN_W { w: self }
    }
