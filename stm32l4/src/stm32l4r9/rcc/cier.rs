...
pub type PLLSAI2RDYIE_R = crate::BitReader;
///Field `PLLSAI2RDYIE` writer - PLLSAI2 ready interrupt enable
pub type PLLSAI2RDYIE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#RCC:CIER)*/
pub struct CIERrs;
