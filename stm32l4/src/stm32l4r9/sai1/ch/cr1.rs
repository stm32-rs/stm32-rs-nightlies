...
impl From<NOMCK> for bool {
    #[inline(always)]
    fn from(variant: NOMCK) -> Self {
        variant as u8 != 0
    }
}
///Field `NOMCK` reader - No divider
pub type NOMCK_R = crate::BitReader<NOMCK>;
impl NOMCK_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> NOMCK {
        match self.bits {
            false => NOMCK::MasterClock,
            true => NOMCK::NoDiv,
        }
    }
...
pub type NOMCK_W<'a, REG> = crate::BitWriter<'a, REG, NOMCK>;
impl<'a, REG> NOMCK_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///MCLK output is enabled. Forces the ratio between FS and MCLK to 256 or 512 according to the OSR value
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Master clock frequency = FFS x 256
    #[inline(always)]
    pub fn multiplier256(self) -> &'a mut crate::W<REG> {
        self.variant(OSR::Multiplier256)
    }
    ///Master clock frequency = FFS x 512
    #[inline(always)]
    pub fn multiplier512(self) -> &'a mut crate::W<REG> {
        self.variant(OSR::Multiplier512)
    }
}
impl R {
...
impl W {
    ...
    ///Bit 19 - No divider
    #[inline(always)]
    pub fn nomck(&mut self) -> NOMCK_W<'_, CR1rs> {
        NOMCK_W::new(self, 19)
    }
    ///Bits 20:25 - Master clock divider
    #[inline(always)]
