...
///Field `BK2DF1BK1E` reader - BRK2 dfsdm1_break\[1\] enable This bit enables the dfsdm1_break\[1\] for the timer s BRK2 input. dfsdm1_break\[1\] output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
pub type BK2DF1BK1E_R = crate::BitReader;
///Field `BK2DF1BK1E` writer - BRK2 dfsdm1_break\[1\] enable This bit enables the dfsdm1_break\[1\] for the timer s BRK2 input. dfsdm1_break\[1\] output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
impl W {
    ...
    ///Bit 8 - BRK2 dfsdm1_break\[1\] enable This bit enables the dfsdm1_break\[1\] for the timer s BRK2 input. dfsdm1_break\[1\] output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    #[inline(always)]
    pub fn bk2df1bk1e(&mut self) -> BK2DF1BK1E_W<'_, OR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#TIM1:OR3)*/
pub struct OR3rs;
