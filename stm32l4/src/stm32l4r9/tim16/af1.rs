...
/**Field `BKDF1BK1E` reader - BRK dfsdm1_break\[1\]
enable This bit enables the dfsdm1_break\[1\]
for the timer s BRK input. dfsdm1_break\[1\]
...
/**Field `BKDF1BK1E` writer - BRK dfsdm1_break\[1\]
enable This bit enables the dfsdm1_break\[1\]
for the timer s BRK input. dfsdm1_break\[1\]
output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#TIM16:AF1)*/
pub struct AF1rs;
