...
pub type TI1_RMP_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2 - Input capture 1 remap
    #[inline(always)]
    pub fn ti1_rmp(&self) -> TI1_RMP_R {
        TI1_RMP_R::new((self.bits & 7) as u8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#TIM16:OR1)*/
pub struct OR1rs;
