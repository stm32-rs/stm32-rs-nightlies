...
impl W {
    ///Bits 0:30 - Least significant part of counter value
    #[inline(always)]
    pub fn cnt(&mut self) -> CNT_W<CNT_ALTERNATErs> {
        CNT_W::new(self, 0)
    }
    ///Bit 31 - UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register
    #[inline(always)]
    pub fn uifcpy(&mut self) -> UIFCPY_W<CNT_ALTERNATErs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#TIM3:CNT_ALTERNATE)*/
