...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#USART1:CR1)
...
pub mod cr1;
/**CR1_ALTERNATE (rw) register accessor: USART control register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#USART1:CR1_ALTERNATE)
...
pub mod isr;
/**ISR_ALTERNATE (r) register accessor: USART interrupt and status register

You can [`read`](crate::Reg::read) this register and get [`isr_alternate::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4R9.html#USART1:ISR_ALTERNATE)
