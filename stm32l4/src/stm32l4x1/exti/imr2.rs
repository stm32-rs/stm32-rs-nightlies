...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr36(&mut self) -> MR36_W<IMR2rs> {
        MR36_W::new(self, 4)
    }
    ///Bit 5 - Interrupt Mask on external/internal line 37
    #[inline(always)]
    #[must_use]
    pub fn mr37(&mut self) -> MR37_W<IMR2rs> {
        MR37_W::new(self, 5)
    }
    ///Bit 6 - Interrupt Mask on external/internal line 38
    #[inline(always)]
    #[must_use]
    pub fn mr38(&mut self) -> MR38_W<IMR2rs> {
        MR38_W::new(self, 6)
    }
    ///Bit 7 - Interrupt Mask on external/internal line 39
    #[inline(always)]
    #[must_use]
    pub fn mr39(&mut self) -> MR39_W<IMR2rs> {
        MR39_W::new(self, 7)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x1.html#EXTI:IMR2)*/
pub struct IMR2rs;
