...
#[doc = "Reader of field `USBF`"]
pub type USBF_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `USBF`"]
pub struct USBF_W<'a> {
    w: &'a mut W,
}
impl<'a> USBF_W<'a> {
...
impl R {
    ...
    #[doc = "Bit 18 - USART1 clock enable"]
    #[inline(always)]
    pub fn usart1en(&self) -> USART1EN_R {
        USART1EN_R::new(((self.bits >> 18) & 0x01) != 0)
    }
    ...
    pub fn usbf(&self) -> USBF_R {
        USBF_R::new(((self.bits >> 26) & 0x01) != 0)
    }
