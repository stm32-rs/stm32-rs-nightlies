...
impl W {
    ...
    ///Bit 2 - Single wire protocol clock enable
    #[inline(always)]
    pub fn swpmi1en(&mut self) -> SWPMI1EN_W<'_, APB1ENR2rs> {
    ...
    ///Bit 24 - DFSDMEN enable
    #[inline(always)]
    pub fn dfsdmen(&mut self) -> DFSDMEN_W<'_, APB1ENR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x1.html#RCC:APB1ENR2)*/
