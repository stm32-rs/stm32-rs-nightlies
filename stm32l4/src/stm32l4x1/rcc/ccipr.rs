...
///Field `USART4SEL` reader - USART4 clock source selection
...
///Field `USART4SEL` writer - USART4 clock source selection
...
impl W {
    ...
    ///Bits 6:7 - USART4 clock source selection
    #[inline(always)]
    pub fn usart4sel(&mut self) -> USART4SEL_W<'_, CCIPRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x1.html#RCC:CCIPR)*/
pub struct CCIPRrs;
