...
/**Field `BK2DFBK1E` reader - BRK2 DFSDM_BREAK\[1\]
enable*/
pub type BK2DFBK1E_R = crate::BitReader;
/**Field `BK2DFBK1E` writer - BRK2 DFSDM_BREAK\[1\]
enable*/
...
impl W {
    ...
    enable*/
    #[inline(always)]
    pub fn bk2dfbk1e(&mut self) -> BK2DFBK1E_W<OR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x1.html#TIM1:OR3)*/
pub struct OR3rs;
