...
///Field `OC3M_bit3` reader - Output Compare 1 mode - bit 3
pub type OC3M_BIT3_R = crate::BitReader;
///Field `OC3M_bit3` writer - Output Compare 1 mode - bit 3
...
///Field `OC4M_bit3` reader - Output Compare 2 mode - bit 3
pub type OC4M_BIT3_R = crate::BitReader;
///Field `OC4M_bit3` writer - Output Compare 2 mode - bit 3
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CCMR2_Output")
            ...
            .field("oc3m_bit3", &self.oc3m_bit3())
