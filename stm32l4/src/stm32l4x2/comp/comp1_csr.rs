    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn pb1(self) -> &'a mut crate::W<REG> {
        self.variant(INMSEL::Pb1)
    }
    ///GPIO selected with INMESEL
    #[inline(always)]
    pub fn extended(self) -> &'a mut crate::W<REG> {
        self.variant(INMSEL::Extended)
    }
}
...
impl INMESEL_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> INMESEL {
        match self.bits {
            0 => INMESEL::Pc4,
            1 => INMESEL::Pa0,
            2 => INMESEL::Pa4,
...
pub type INMESEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2, INMESEL, crate::Safe>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x2.html#COMP:COMP1_CSR)*/
