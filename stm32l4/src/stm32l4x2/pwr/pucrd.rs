...
impl W {
    ...
    ///Bit 7 - Port D pull-up bit y (y=0..15)
    #[inline(always)]
    pub fn pu7(&mut self) -> PU7_W<'_, PUCRDrs> {
        PU7_W::new(self, 7)
    }
    ///Bit 8 - Port D pull-up bit y (y=0..15)
    #[inline(always)]
    ...
    ///Bit 14 - Port D pull-up bit y (y=0..15)
    #[inline(always)]
    pub fn pu14(&mut self) -> PU14_W<'_, PUCRDrs> {
        PU14_W::new(self, 14)
    }
    ///Bit 15 - Port D pull-up bit y (y=0..15)
    #[inline(always)]
    pub fn pu15(&mut self) -> PU15_W<'_, PUCRDrs> {
        PU15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x2.html#PWR:PUCRD)*/
pub struct PUCRDrs;
