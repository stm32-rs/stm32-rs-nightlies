...
impl W {
    ///Bits 0:1 - External trigger remap on ADC1 analog watchdog
    #[inline(always)]
    pub fn etr_adc1_rmp(&mut self) -> ETR_ADC1_RMP_W<'_, OR1rs> {
        ETR_ADC1_RMP_W::new(self, 0)
    }
    ///Bits 2:3 - External trigger remap on ADC3 analog watchdog
    #[inline(always)]
    pub fn etr_adc3_rmp(&mut self) -> ETR_ADC3_RMP_W<'_, OR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x2.html#TIM1:OR1)*/
pub struct OR1rs;
