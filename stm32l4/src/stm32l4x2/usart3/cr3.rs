...
pub struct UCESM_R(crate::FieldReader<bool, UCESM_A>);
impl UCESM_R {
    pub(crate) fn new(bits: bool) -> Self {
        UCESM_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for UCESM_R {
    type Target = crate::FieldReader<bool, UCESM_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct UCESM_W<'a> {
    w: &'a mut W,
}
impl<'a> UCESM_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: UCESM_A) -> &'a mut W {
        self.bit(variant.into())
    }
...
impl R {
    ...
    pub fn ucesm(&self) -> UCESM_R {
        UCESM_R::new(((self.bits >> 23) & 0x01) != 0)
    }
