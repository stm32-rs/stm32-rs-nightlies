...
///Field `TREFRESH1` reader - DAC Channel 1 refresh Time
pub type TREFRESH1_R = crate::FieldReader;
///Field `TREFRESH1` writer - DAC Channel 1 refresh Time
pub type TREFRESH1_W<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
///Field `TREFRESH2` reader - DAC Channel 2 refresh Time
pub type TREFRESH2_R = crate::FieldReader;
///Field `TREFRESH2` writer - DAC Channel 2 refresh Time
pub type TREFRESH2_W<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
impl R {
...
///`reset()` method sets SHRR to value 0x01
