...
pub use crate::stm32l4x3::gpioa::moder::MODE;
///Field `MODER(0-15)` reader - Port x configuration pin %s
pub use crate::stm32l4x3::gpioa::moder::MODER_R;
///Field `MODER(0-15)` writer - Port x configuration pin %s
pub use crate::stm32l4x3::gpioa::moder::MODER_W;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#GPIOC:MODER)*/
pub struct MODERrs;
