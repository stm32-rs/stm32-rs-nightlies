...
///Field `HSI48ON` reader - Set and cleared by software. Cleared by hardware to stop the HSI48 when entering in Stop, Standby or Shutdown modes.
pub type HSI48ON_R = crate::BitReader;
///Field `HSI48ON` writer - Set and cleared by software. Cleared by hardware to stop the HSI48 when entering in Stop, Standby or Shutdown modes.
pub type HSI48ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HSI48RDY` reader - Set by hardware to indicate that HSI48 oscillator is stable. This bit is set only when HSI48 is enabled by software by setting HSI48ON.
pub type HSI48RDY_R = crate::BitReader;
///Field `HSI48CAL` reader - These bits are initialized at startup with the factory-programmed HSI48 calibration trim value.
