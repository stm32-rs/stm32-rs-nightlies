...
impl RegisterBlock {
    ...
    ///0x24 - 32-bit counter register
    #[inline(always)]
    pub const fn cnt32(&self) -> &CNT32 {
    ...
    ///0x50 - TIM2 option register 1
    #[inline(always)]
    pub const fn or1(&self) -> &OR1 {
        &self.or1
    }
    ///0x60 - TIM2 option register 2
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:EGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CCMR1_Output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CCMR1_Input)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CCMR2_Output)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CCMR2_Input)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CNT)

For information about available fields see [`mod@cnt`] module*/
pub type CNT = crate::Reg<cnt::CNTrs>;
///counter
pub mod cnt;
/**CNT32 (rw) register accessor: 32-bit counter register

You can [`read`](crate::Reg::read) this register and get [`cnt32::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cnt32::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CNT32)

For information about available fields see [`mod@cnt32`] module*/
pub type CNT32 = crate::Reg<cnt32::CNT32rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:CCR[1])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:DMAR)

For information about available fields see [`mod@dmar`] module*/
pub type DMAR = crate::Reg<dmar::DMARrs>;
///DMA address for full transfer
pub mod dmar;
/**OR1 (rw) register accessor: TIM2 option register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:OR1)

For information about available fields see [`mod@or1`] module*/
pub type OR1 = crate::Reg<or1::OR1rs>;
///TIM2 option register 1
pub mod or1;
/**OR2 (rw) register accessor: TIM2 option register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x3.html#TIM2:OR2)
