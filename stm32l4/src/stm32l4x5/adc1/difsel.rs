...
///Field `DIFSEL(0-17)` reader - Differential mode for channel %s
...
///Field `DIFSEL(0-17)` writer - Differential mode for channel %s
...
impl R {
    ///Differential mode for channel (0-17)
    ///
    ...
    pub fn difsel(&self, n: u8) -> DIFSEL_R {
        ...
        [(); 18][n as usize];
        DIFSEL_R::new(((self.bits >> (n + 1)) & 1) != 0)
    }
    ///Iterator for array of:
    ///Differential mode for channel (0-17)
    #[inline(always)]
    pub fn difsel_iter(&self) -> impl Iterator<Item = DIFSEL_R> + '_ {
        (0..18).map(move |n| DIFSEL_R::new(((self.bits >> (n + 1)) & 1) != 0))
    }
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DIFSEL0` field.</div>
    #[inline(always)]
    pub fn difsel(&mut self, n: u8) -> DIFSEL_W<'_, DIFSELrs> {
        #[allow(clippy::no_effect)]
        [(); 18][n as usize];
        DIFSEL_W::new(self, n + 1)
    }
    ///Bit 1 - Differential mode for channel 0
    #[inline(always)]
    pub fn difsel0(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 1)
    }
    ///Bit 2 - Differential mode for channel 1
    #[inline(always)]
    pub fn difsel1(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 2)
    }
    ///Bit 3 - Differential mode for channel 2
    #[inline(always)]
    pub fn difsel2(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 3)
    }
    ///Bit 4 - Differential mode for channel 3
    #[inline(always)]
    pub fn difsel3(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 4)
    }
    ///Bit 5 - Differential mode for channel 4
    #[inline(always)]
    pub fn difsel4(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 5)
    }
    ///Bit 6 - Differential mode for channel 5
    #[inline(always)]
    pub fn difsel5(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 6)
    }
    ///Bit 7 - Differential mode for channel 6
    #[inline(always)]
    pub fn difsel6(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 7)
    }
    ///Bit 8 - Differential mode for channel 7
    #[inline(always)]
    pub fn difsel7(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 8)
    }
    ///Bit 9 - Differential mode for channel 8
    #[inline(always)]
    pub fn difsel8(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 9)
    }
    ///Bit 10 - Differential mode for channel 9
    #[inline(always)]
    pub fn difsel9(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 10)
    }
    ///Bit 11 - Differential mode for channel 10
    #[inline(always)]
    pub fn difsel10(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 11)
    }
    ///Bit 12 - Differential mode for channel 11
    #[inline(always)]
    pub fn difsel11(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 12)
    }
    ///Bit 13 - Differential mode for channel 12
    #[inline(always)]
    pub fn difsel12(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 13)
    }
    ///Bit 14 - Differential mode for channel 13
    #[inline(always)]
    pub fn difsel13(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 14)
    }
    ///Bit 15 - Differential mode for channel 14
    #[inline(always)]
    pub fn difsel14(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 15)
    }
    ///Bit 16 - Differential mode for channel 15
    #[inline(always)]
    pub fn difsel15(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 16)
    }
    ///Bit 17 - Differential mode for channel 16
    #[inline(always)]
    pub fn difsel16(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
        DIFSEL_W::new(self, 17)
    }
    ///Bit 18 - Differential mode for channel 17
    #[inline(always)]
    pub fn difsel17(&mut self) -> DIFSEL_W<'_, DIFSELrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#ADC1:DIFSEL)*/
pub struct DIFSELrs;
