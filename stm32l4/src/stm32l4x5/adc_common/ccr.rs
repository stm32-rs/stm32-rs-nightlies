...
pub use VBATEN_R as VSENSEEN_R;
///Field `VSENSEEN` writer - Temperature sensor selection
pub use VBATEN_W as VSENSEEN_W;
impl R {
    ...
    ///Bit 23 - VBAT selection
    #[inline(always)]
    pub fn vbaten(&self) -> VBATEN_R {
        VBATEN_R::new(((self.bits >> 23) & 1) != 0)
    }
    ///Bit 24 - Temperature sensor selection
    #[inline(always)]
    pub fn vsenseen(&self) -> VSENSEEN_R {
        VSENSEEN_R::new(((self.bits >> 24) & 1) != 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#ADC_Common:CCR)*/
pub struct CCRrs;
