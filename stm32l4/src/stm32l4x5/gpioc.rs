...
impl RegisterBlock {
    ...
    ///0x2c - GPIO port analog switch control register
    #[inline(always)]
    pub const fn ascr(&self) -> &ASCR {
        &self.ascr
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:MODER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:OTYPER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:OSPEEDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:PUPDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:IDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:ODR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:BSRR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:LCKR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:AFRL)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:AFRH)
...
pub mod afrh;
/**ASCR (rw) register accessor: GPIO port analog switch control register

You can [`read`](crate::Reg::read) this register and get [`ascr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ascr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:ASCR)

For information about available fields see [`mod@ascr`]
module*/
pub type ASCR = crate::Reg<ascr::ASCRrs>;
///GPIO port analog switch control register
pub mod ascr;
/**BRR (rw) register accessor: GPIO port bit reset register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#GPIOC:BRR)
