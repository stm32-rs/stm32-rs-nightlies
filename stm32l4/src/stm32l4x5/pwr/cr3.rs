...
///Field `EWF` reader - Enable internal wakeup line
pub type EWF_R = crate::BitReader;
///Field `EWF` writer - Enable internal wakeup line
...
impl W {
    ...
    ///Bit 15 - Enable internal wakeup line
    #[inline(always)]
    pub fn ewf(&mut self) -> EWF_W<'_, CR3rs> {
        EWF_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#PWR:CR3)*/
pub struct CR3rs;
