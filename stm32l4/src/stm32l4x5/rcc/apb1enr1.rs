...
#[doc = "Field `CRSEN` reader - Clock Recovery System clock enable (this bit is reserved for STM32L47x/L48x devices)"]
pub type CRSEN_R = crate::BitReader;
#[doc = "Field `CRSEN` writer - Clock Recovery System clock enable (this bit is reserved for STM32L47x/L48x devices)"]
...
impl R {
    ...
    #[doc = "Bit 24 - Clock Recovery System clock enable (this bit is reserved for STM32L47x/L48x devices)"]
    #[inline(always)]
