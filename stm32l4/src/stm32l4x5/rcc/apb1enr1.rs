...
pub type UART5EN_R = crate::BitReader<UART5EN>;
impl UART5EN_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> UART5EN {
        match self.bits {
            false => UART5EN::Disabled,
            true => UART5EN::Enabled,
        }
    }
    ///UART5 clock disabled
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == UART5EN::Disabled
    }
    ///UART5 clock enabled
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == UART5EN::Enabled
    }
}
///Field `UART5EN` writer - UART5 clock enable
pub type UART5EN_W<'a, REG> = crate::BitWriter<'a, REG, UART5EN>;
impl<'a, REG> UART5EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///UART5 clock disabled
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(UART5EN::Disabled)
    }
    ///UART5 clock enabled
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(UART5EN::Enabled)
    }
}
/**I2C1 clock enable
...
///Field `CRSEN` reader - Clock Recovery System clock enable (this bit is reserved for STM32L47x/L48x devices)
pub type CRSEN_R = crate::BitReader;
///Field `CRSEN` writer - Clock Recovery System clock enable (this bit is reserved for STM32L47x/L48x devices)
...
impl R {
    ...
    ///Bit 24 - Clock Recovery System clock enable (this bit is reserved for STM32L47x/L48x devices)
    #[inline(always)]
