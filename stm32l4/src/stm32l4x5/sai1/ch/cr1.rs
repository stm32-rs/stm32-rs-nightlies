...
///Field `SAIEN` reader - Audio block A enable
...
///Field `SAIEN` writer - Audio block A enable
...
impl W {
    ///Bits 0:1 - Audio block mode
    #[inline(always)]
    pub fn mode(&mut self) -> MODE_W<'_, CR1rs> {
        MODE_W::new(self, 0)
    }
    ///Bits 2:3 - Protocol configuration
    #[inline(always)]
    pub fn prtcfg(&mut self) -> PRTCFG_W<'_, CR1rs> {
        PRTCFG_W::new(self, 2)
    }
    ///Bits 5:7 - Data size
    #[inline(always)]
    pub fn ds(&mut self) -> DS_W<'_, CR1rs> {
        DS_W::new(self, 5)
    }
    ///Bit 8 - Least significant bit first
    #[inline(always)]
    ...
    ///Bit 9 - Clock strobing edge
    #[inline(always)]
    pub fn ckstr(&mut self) -> CKSTR_W<'_, CR1rs> {
        CKSTR_W::new(self, 9)
    }
    ///Bits 10:11 - Synchronization enable
    #[inline(always)]
    pub fn syncen(&mut self) -> SYNCEN_W<'_, CR1rs> {
        SYNCEN_W::new(self, 10)
    }
    ///Bit 12 - Mono mode
    #[inline(always)]
    pub fn mono(&mut self) -> MONO_W<'_, CR1rs> {
        MONO_W::new(self, 12)
    }
    ///Bit 13 - Output drive
    #[inline(always)]
    pub fn outdriv(&mut self) -> OUTDRIV_W<'_, CR1rs> {
        OUTDRIV_W::new(self, 13)
    }
    ///Bit 16 - Audio block A enable
    #[inline(always)]
    pub fn saien(&mut self) -> SAIEN_W<'_, CR1rs> {
        SAIEN_W::new(self, 16)
    }
    ///Bit 17 - DMA enable
    #[inline(always)]
    pub fn dmaen(&mut self) -> DMAEN_W<'_, CR1rs> {
        DMAEN_W::new(self, 17)
    }
    ///Bit 19 - No divider
    #[inline(always)]
    pub fn nodiv(&mut self) -> NODIV_W<'_, CR1rs> {
        NODIV_W::new(self, 19)
    }
    ///Bits 20:23 - Master clock divider
    #[inline(always)]
    pub fn mckdiv(&mut self) -> MCKDIV_W<'_, CR1rs> {
