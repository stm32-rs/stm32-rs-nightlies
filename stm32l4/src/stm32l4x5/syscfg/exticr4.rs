...
pub type EXTI12_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type EXTI13_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type EXTI14_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type EXTI15_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#SYSCFG:EXTICR4)*/
