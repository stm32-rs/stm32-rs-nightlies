...
///Field `BK2DFBK3E` reader - BRK2 DFSDM_BREAK\[3\] enable
pub type BK2DFBK3E_R = crate::BitReader;
///Field `BK2DFBK3E` writer - BRK2 DFSDM_BREAK\[3\] enable
pub type BK2DFBK3E_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    ///Bit 8 - BRK2 DFSDM_BREAK\[3\] enable
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OR3")
            ...
            .field("bk2dfbk3e", &self.bk2dfbk3e())
...
impl W {
    ...
    ///Bit 8 - BRK2 DFSDM_BREAK\[3\] enable
    #[inline(always)]
    pub fn bk2dfbk3e(&mut self) -> BK2DFBK3E_W<'_, OR3rs> {
        BK2DFBK3E_W::new(self, 8)
    }
    ///Bit 9 - BRK2 BKIN input polarity
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x5.html#TIM8:OR3)*/
pub struct OR3rs;
