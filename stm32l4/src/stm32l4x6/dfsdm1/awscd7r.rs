#[doc = "Reader of register AWSCD7R"]
pub type R = crate::R<u32, super::AWSCD7R>;
#[doc = "Writer for register AWSCD7R"]
pub type W = crate::W<u32, super::AWSCD7R>;
#[doc = "Register AWSCD7R `reset()`'s with value 0"]
impl crate::ResetValue for super::AWSCD7R {
    type Type = u32;
    #[inline(always)]
