#[doc = "Reader of register DFSDM0_AWCFR"]
pub type R = crate::R<u32, super::DFSDM0_AWCFR>;
#[doc = "Writer for register DFSDM0_AWCFR"]
pub type W = crate::W<u32, super::DFSDM0_AWCFR>;
#[doc = "Register DFSDM0_AWCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM0_AWCFR {
    type Type = u32;
    #[inline(always)]
