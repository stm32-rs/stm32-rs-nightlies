#[doc = "Reader of register DFSDM1_AWCFR"]
pub type R = crate::R<u32, super::DFSDM1_AWCFR>;
#[doc = "Writer for register DFSDM1_AWCFR"]
pub type W = crate::W<u32, super::DFSDM1_AWCFR>;
#[doc = "Register DFSDM1_AWCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM1_AWCFR {
    type Type = u32;
    #[inline(always)]
