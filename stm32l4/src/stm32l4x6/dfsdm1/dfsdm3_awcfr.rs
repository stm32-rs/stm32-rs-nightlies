#[doc = "Reader of register DFSDM3_AWCFR"]
pub type R = crate::R<u32, super::DFSDM3_AWCFR>;
#[doc = "Writer for register DFSDM3_AWCFR"]
pub type W = crate::W<u32, super::DFSDM3_AWCFR>;
#[doc = "Register DFSDM3_AWCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM3_AWCFR {
    type Type = u32;
    #[inline(always)]
