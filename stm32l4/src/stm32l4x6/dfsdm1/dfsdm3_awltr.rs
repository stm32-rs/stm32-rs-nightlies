#[doc = "Reader of register DFSDM3_AWLTR"]
pub type R = crate::R<u32, super::DFSDM3_AWLTR>;
#[doc = "Writer for register DFSDM3_AWLTR"]
pub type W = crate::W<u32, super::DFSDM3_AWLTR>;
#[doc = "Register DFSDM3_AWLTR `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM3_AWLTR {
    type Type = u32;
    #[inline(always)]
