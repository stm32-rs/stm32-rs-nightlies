...
pub struct RegisterBlock {
    ...
    pub brr: BRR,
    #[doc = "0x2c - GPIO port analog switch control register"]
    pub ascr: ASCR,
}
...
#[doc = "GPIO port bit reset register"]
pub mod brr;
#[doc = "GPIO port analog switch control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ascr](ascr) module"]
pub type ASCR = crate::Reg<u32, _ASCR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ASCR;
#[doc = "`read()` method returns [ascr::R](ascr::R) reader structure"]
impl crate::Readable for ASCR {}
#[doc = "`write(|w| ..)` method takes [ascr::W](ascr::W) writer structure"]
impl crate::Writable for ASCR {}
#[doc = "GPIO port analog switch control register"]
pub mod ascr;
