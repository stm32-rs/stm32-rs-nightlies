...
/**Field `MUX_SEG` reader - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\[31:28\]
or SEG\[15:12\]. See Section19.3.7.*/
pub type MUX_SEG_R = crate::BitReader;
/**Field `MUX_SEG` writer - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\[31:28\]
or SEG\[15:12\]. See Section19.3.7.*/
...
impl R {
    ...
    /**Bit 7 - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\[31:28\]
    or SEG\[15:12\]. See Section19.3.7.*/
    #[inline(always)]
