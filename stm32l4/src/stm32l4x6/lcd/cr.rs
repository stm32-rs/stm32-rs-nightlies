...
///Field `VSEL` reader - Voltage source selection The VSEL bit determines the voltage source for the LCD.
pub type VSEL_R = crate::BitReader;
///Field `VSEL` writer - Voltage source selection The VSEL bit determines the voltage source for the LCD.
pub type VSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DUTY` reader - Duty selection These bits determine the duty cycle.Unused COM pins can serve as general purpose input pins if COMIN is set. Values 101, 110 and 111 are forbidden. Others: Reserved
pub type DUTY_R = crate::FieldReader;
///Field `DUTY` writer - Duty selection These bits determine the duty cycle.Unused COM pins can serve as general purpose input pins if COMIN is set. Values 101, 110 and 111 are forbidden. Others: Reserved
...
///Field `MUX_SEG` reader - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\[31:28\] or SEG\[15:12\]. See Section19.3.7.
pub type MUX_SEG_R = crate::BitReader;
///Field `MUX_SEG` writer - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\[31:28\] or SEG\[15:12\]. See Section19.3.7.
...
impl R {
    ...
    ///Bit 1 - Voltage source selection The VSEL bit determines the voltage source for the LCD.
    #[inline(always)]
    pub fn vsel(&self) -> VSEL_R {
        VSEL_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:4 - Duty selection These bits determine the duty cycle.Unused COM pins can serve as general purpose input pins if COMIN is set. Values 101, 110 and 111 are forbidden. Others: Reserved
    #[inline(always)]
    ...
    ///Bit 7 - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\[31:28\] or SEG\[15:12\]. See Section19.3.7.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 8 - Voltage output buffer enable This bit is used to enable/disable the voltage output buffer for higher driving capability.
    #[inline(always)]
    pub fn bufen(&mut self) -> BUFEN_W<CRrs> {
        BUFEN_W::new(self, 8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x6.html#LCD:CR)*/
pub struct CRrs;
