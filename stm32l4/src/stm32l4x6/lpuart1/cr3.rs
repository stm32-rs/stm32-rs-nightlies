...
///Field `UCESM_` reader - LPUART Clock Enable in Stop mode
pub type UCESM__R = crate::BitReader;
///Field `UCESM_` writer - LPUART Clock Enable in Stop mode
...
impl R {
    ...
    ///Bit 23 - LPUART Clock Enable in Stop mode
    #[inline(always)]
...
impl W {
    ...
    ///Bit 23 - LPUART Clock Enable in Stop mode
    #[inline(always)]
    pub fn ucesm_(&mut self) -> UCESM__W<'_, CR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x6.html#LPUART1:CR3)*/
pub struct CR3rs;
