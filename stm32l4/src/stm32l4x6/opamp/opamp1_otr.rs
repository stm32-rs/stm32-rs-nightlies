#[doc = "Reader of register OPAMP1_OTR"]
pub type R = crate::R<u32, super::OPAMP1_OTR>;
#[doc = "Writer for register OPAMP1_OTR"]
pub type W = crate::W<u32, super::OPAMP1_OTR>;
#[doc = "Register OPAMP1_OTR `reset()`'s with value 0"]
impl crate::ResetValue for super::OPAMP1_OTR {
    type Type = u32;
    #[inline(always)]
