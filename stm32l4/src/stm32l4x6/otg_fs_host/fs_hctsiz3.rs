...
pub struct R(crate::R<FS_HCTSIZ3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_HCTSIZ3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_HCTSIZ3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_HCTSIZ3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FS_HCTSIZ3` writer"]
pub struct W(crate::W<FS_HCTSIZ3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FS_HCTSIZ3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FS_HCTSIZ3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FS_HCTSIZ3_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "OTG_FS host channel-3 transfer size register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [fs_hctsiz3](index.html) module"]
pub struct FS_HCTSIZ3_SPEC;
impl crate::RegisterSpec for FS_HCTSIZ3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [fs_hctsiz3::R](R) reader structure"]
impl crate::Readable for FS_HCTSIZ3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fs_hctsiz3::W](W) writer structure"]
impl crate::Writable for FS_HCTSIZ3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FS_HCTSIZ3 to value 0"]
impl crate::Resettable for FS_HCTSIZ3_SPEC {
    #[inline(always)]
