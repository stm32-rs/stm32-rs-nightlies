...
///Field `HASH1EN` reader - HASH clock enable
pub type HASH1EN_R = crate::BitReader;
///Field `HASH1EN` writer - HASH clock enable
...
impl W {
    ...
    ///Bit 17 - HASH clock enable
    #[inline(always)]
    pub fn hash1en(&mut self) -> HASH1EN_W<'_, AHB2ENRrs> {
        HASH1EN_W::new(self, 17)
    }
    ///Bit 18 - Random Number Generator clock enable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x6.html#RCC:AHB2ENR)*/
