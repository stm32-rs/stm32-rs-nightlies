...
///Field `HASH1RST` reader - Hash reset
pub type HASH1RST_R = crate::BitReader;
///Field `HASH1RST` writer - Hash reset
...
impl W {
    ...
    ///Bit 17 - Hash reset
    #[inline(always)]
    pub fn hash1rst(&mut self) -> HASH1RST_W<'_, AHB2RSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x6.html#RCC:AHB2RSTR)*/
