...
pub type HASH1SMEN_R = crate::BitReader;
///Field `HASH1SMEN` writer - HASH clock enable during Sleep and Stop modes
pub type HASH1SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    ///Bit 17 - HASH clock enable during Sleep and Stop modes
    #[inline(always)]
    pub fn hash1smen(&mut self) -> HASH1SMEN_W<'_, AHB2SMENRrs> {
        HASH1SMEN_W::new(self, 17)
    }
    ///Bit 18 - Random Number Generator clocks enable during Sleep and Stop modes
    #[inline(always)]
