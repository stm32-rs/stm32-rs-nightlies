...
pub type CAN2SMEN_R = crate::BitReader;
///Field `CAN2SMEN` writer - CAN2 clocks enable during Sleep and Stop modes
pub type CAN2SMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    ///Bit 26 - CAN2 clocks enable during Sleep and Stop modes
    #[inline(always)]
    pub fn can2smen(&mut self) -> CAN2SMEN_W<'_, APB1SMENR1rs> {
        CAN2SMEN_W::new(self, 26)
    }
    ///Bit 28 - Power interface clocks enable during Sleep and Stop modes
    #[inline(always)]
