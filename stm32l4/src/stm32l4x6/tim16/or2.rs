...
///Field `BKDFBK1E` reader - BRK DFSDM_BREAK\[1\] enable
pub type BKDFBK1E_R = crate::BitReader;
///Field `BKDFBK1E` writer - BRK DFSDM_BREAK\[1\] enable
...
impl R {
    ...
    ///Bit 8 - BRK DFSDM_BREAK\[1\] enable
    #[inline(always)]
...
impl W {
    ...
    ///Bit 8 - BRK DFSDM_BREAK\[1\] enable
    #[inline(always)]
    pub fn bkdfbk1e(&mut self) -> BKDFBK1E_W<'_, OR2rs> {
