...
impl W {
    ...
    ///Bit 1 - External trigger remap
    #[inline(always)]
    pub fn etr1_rmp(&mut self) -> ETR1_RMP_W<'_, OR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x6.html#TIM2:OR1)*/
pub struct OR1rs;
