...
///Field `BKDFBK2E` reader - BRK DFSDM_BREAK2 enable
pub type BKDFBK2E_R = crate::BitReader;
///Field `BKDFBK2E` writer - BRK DFSDM_BREAK2 enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L4x6.html#TIM8:OR2)*/
pub struct OR2rs;
