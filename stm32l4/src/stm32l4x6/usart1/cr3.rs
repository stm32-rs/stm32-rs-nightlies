...
///Field `UCESM_` reader - USART Clock Enable in Stop mode.
pub type UCESM__R = crate::BitReader;
///Field `UCESM_` writer - USART Clock Enable in Stop mode.
pub type UCESM__W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn ucesm_(&self) -> UCESM__R {
        UCESM__R::new(((self.bits >> 23) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 23 - USART Clock Enable in Stop mode.
    #[inline(always)]
    pub fn ucesm_(&mut self) -> UCESM__W<CR3rs> {
        UCESM__W::new(self, 23)
    }
    ///Bit 24 - Transmission complete before guard time interrupt enable
    #[inline(always)]
