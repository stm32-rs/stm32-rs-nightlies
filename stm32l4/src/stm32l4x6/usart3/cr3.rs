...
///Field `TCBGTIE_` reader - Transmission complete before guard time interrupt enable
pub type TCBGTIE__R = crate::BitReader;
///Field `TCBGTIE_` writer - Transmission complete before guard time interrupt enable
pub type TCBGTIE__W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn tcbgtie_(&self) -> TCBGTIE__R {
        TCBGTIE__R::new(((self.bits >> 24) & 1) != 0)
    }
}
...
impl W {
    ...
    ///Bit 24 - Transmission complete before guard time interrupt enable
    #[inline(always)]
    pub fn tcbgtie_(&mut self) -> TCBGTIE__W<CR3rs> {
        TCBGTIE__W::new(self, 24)
    }
}
/**Control register 3
