...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn indat0(&mut self) -> INDAT0_W<CH0DATINRrs> {
        INDAT0_W::new(self, 0)
    }
    ///Bits 16:31 - INDAT1
    #[inline(always)]
    #[must_use]
    pub fn indat1(&mut self) -> INDAT1_W<CH0DATINRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#DFSDM1:CH0DATINR)*/
