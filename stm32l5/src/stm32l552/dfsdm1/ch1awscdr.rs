#[doc = "Reader of register CH1AWSCDR"]
pub type R = crate::R<u32, super::CH1AWSCDR>;
#[doc = "Writer for register CH1AWSCDR"]
pub type W = crate::W<u32, super::CH1AWSCDR>;
#[doc = "Register CH1AWSCDR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1AWSCDR {
    type Type = u32;
    #[inline(always)]
