///Register `CH3AWSCDR` reader
pub type R = crate::R<CH3AWSCDRrs>;
///Register `CH3AWSCDR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#DFSDM1:CH3AWSCDR)*/
pub struct CH3AWSCDRrs;
impl crate::RegisterSpec for CH3AWSCDRrs {
    type Ux = u32;
}
///`read()` method returns [`ch3awscdr::R`](R) reader structure
impl crate::Readable for CH3AWSCDRrs {}
///`write(|w| ..)` method takes [`ch3awscdr::W`](W) writer structure
