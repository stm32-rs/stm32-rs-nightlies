...
pub type R = crate::R<CH3CFGR1rs>;
///Register `CH3CFGR1` writer
pub type W = crate::W<CH3CFGR1rs>;
...
impl W {
    ///Bits 0:1 - SITP
    #[inline(always)]
    pub fn sitp(&mut self) -> SITP_W<CH3CFGR1rs> {
        SITP_W::new(self, 0)
    }
    ///Bits 2:3 - SPICKSEL
    #[inline(always)]
    pub fn spicksel(&mut self) -> SPICKSEL_W<CH3CFGR1rs> {
        SPICKSEL_W::new(self, 2)
    }
    ///Bit 5 - SCDEN
    #[inline(always)]
    pub fn scden(&mut self) -> SCDEN_W<CH3CFGR1rs> {
        SCDEN_W::new(self, 5)
    }
    ///Bit 6 - CKABEN
    #[inline(always)]
    pub fn ckaben(&mut self) -> CKABEN_W<CH3CFGR1rs> {
        CKABEN_W::new(self, 6)
    }
    ///Bit 7 - CHEN
    #[inline(always)]
    pub fn chen(&mut self) -> CHEN_W<CH3CFGR1rs> {
        CHEN_W::new(self, 7)
    }
    ///Bit 8 - CHINSEL
    #[inline(always)]
    pub fn chinsel(&mut self) -> CHINSEL_W<CH3CFGR1rs> {
        CHINSEL_W::new(self, 8)
    }
    ///Bits 12:13 - DATMPX
    #[inline(always)]
    pub fn datmpx(&mut self) -> DATMPX_W<CH3CFGR1rs> {
        DATMPX_W::new(self, 12)
    }
    ///Bits 14:15 - DATPACK
    #[inline(always)]
    pub fn datpack(&mut self) -> DATPACK_W<CH3CFGR1rs> {
        DATPACK_W::new(self, 14)
    }
    ///Bits 16:23 - Output serial clock divider
    #[inline(always)]
    pub fn ckoutdiv(&mut self) -> CKOUTDIV_W<CH3CFGR1rs> {
        CKOUTDIV_W::new(self, 16)
    }
    ///Bit 30 - Output serial clock source selection
    #[inline(always)]
    pub fn ckoutsrc(&mut self) -> CKOUTSRC_W<CH3CFGR1rs> {
        CKOUTSRC_W::new(self, 30)
    }
    ///Bit 31 - Global enable for DFSDM interface
    #[inline(always)]
    pub fn dfsdmen(&mut self) -> DFSDMEN_W<CH3CFGR1rs> {
...
pub struct CH3CFGR1rs;
impl crate::RegisterSpec for CH3CFGR1rs {
    type Ux = u32;
}
///`read()` method returns [`ch3cfgr1::R`](R) reader structure
impl crate::Readable for CH3CFGR1rs {}
///`write(|w| ..)` method takes [`ch3cfgr1::W`](W) writer structure
impl crate::Writable for CH3CFGR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CH3CFGR1 to value 0
impl crate::Resettable for CH3CFGR1rs {
