...
impl W {
    ...
    ///Bits 16:23 - Output serial clock divider
    #[inline(always)]
    pub fn ckoutdiv(&mut self) -> CKOUTDIV_W<CH4CFGR1rs> {
        CKOUTDIV_W::new(self, 16)
    }
    ///Bit 30 - Output serial clock source selection
    #[inline(always)]
    pub fn ckoutsrc(&mut self) -> CKOUTSRC_W<CH4CFGR1rs> {
        CKOUTSRC_W::new(self, 30)
    }
    ///Bit 31 - Global enable for DFSDM interface
    #[inline(always)]
    pub fn dfsdmen(&mut self) -> DFSDMEN_W<CH4CFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#DFSDM1:CH4CFGR1)*/
