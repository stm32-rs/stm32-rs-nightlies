///Register `CH6AWSCDR` reader
pub type R = crate::R<CH6AWSCDRrs>;
///Register `CH6AWSCDR` writer
pub type W = crate::W<CH6AWSCDRrs>;
...
impl W {
    ///Bits 0:7 - SCDT
    #[inline(always)]
    pub fn scdt(&mut self) -> SCDT_W<CH6AWSCDRrs> {
        SCDT_W::new(self, 0)
    }
    ///Bits 12:15 - BKSCD
    #[inline(always)]
    pub fn bkscd(&mut self) -> BKSCD_W<CH6AWSCDRrs> {
        BKSCD_W::new(self, 12)
    }
    ///Bits 16:20 - AWFOSR
    #[inline(always)]
    pub fn awfosr(&mut self) -> AWFOSR_W<CH6AWSCDRrs> {
        AWFOSR_W::new(self, 16)
    }
    ///Bits 22:23 - AWFORD
    #[inline(always)]
    pub fn awford(&mut self) -> AWFORD_W<CH6AWSCDRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#DFSDM1:CH6AWSCDR)*/
pub struct CH6AWSCDRrs;
impl crate::RegisterSpec for CH6AWSCDRrs {
    type Ux = u32;
}
///`read()` method returns [`ch6awscdr::R`](R) reader structure
impl crate::Readable for CH6AWSCDRrs {}
///`write(|w| ..)` method takes [`ch6awscdr::W`](W) writer structure
impl crate::Writable for CH6AWSCDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CH6AWSCDR to value 0
impl crate::Resettable for CH6AWSCDRrs {
