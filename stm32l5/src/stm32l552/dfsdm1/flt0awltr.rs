#[doc = "Reader of register FLT0AWLTR"]
pub type R = crate::R<u32, super::FLT0AWLTR>;
#[doc = "Writer for register FLT0AWLTR"]
pub type W = crate::W<u32, super::FLT0AWLTR>;
#[doc = "Register FLT0AWLTR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT0AWLTR {
    type Type = u32;
    #[inline(always)]
