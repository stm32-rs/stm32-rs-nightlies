#[doc = "Reader of register FLT1AWHTR"]
pub type R = crate::R<u32, super::FLT1AWHTR>;
#[doc = "Writer for register FLT1AWHTR"]
pub type W = crate::W<u32, super::FLT1AWHTR>;
#[doc = "Register FLT1AWHTR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT1AWHTR {
    type Type = u32;
    #[inline(always)]
