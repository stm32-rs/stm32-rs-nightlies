#[doc = "Reader of register FLT2AWCFR"]
pub type R = crate::R<u32, super::FLT2AWCFR>;
#[doc = "Writer for register FLT2AWCFR"]
pub type W = crate::W<u32, super::FLT2AWCFR>;
#[doc = "Register FLT2AWCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT2AWCFR {
    type Type = u32;
    #[inline(always)]
