#[doc = "Reader of register FLT2AWLTR"]
pub type R = crate::R<u32, super::FLT2AWLTR>;
#[doc = "Writer for register FLT2AWLTR"]
pub type W = crate::W<u32, super::FLT2AWLTR>;
#[doc = "Register FLT2AWLTR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT2AWLTR {
    type Type = u32;
    #[inline(always)]
