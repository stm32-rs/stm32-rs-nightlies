...
pub type R = crate::R<FLT2CR1rs>;
///Register `FLT2CR1` writer
pub type W = crate::W<FLT2CR1rs>;
...
impl W {
    ///Bit 0 - DFSDM enable
    #[inline(always)]
    pub fn dfen(&mut self) -> DFEN_W<FLT2CR1rs> {
        DFEN_W::new(self, 0)
    }
    ///Bit 1 - Start a conversion of the injected group of channels
    #[inline(always)]
    pub fn jswstart(&mut self) -> JSWSTART_W<FLT2CR1rs> {
        JSWSTART_W::new(self, 1)
    }
    ///Bit 3 - Launch an injected conversion synchronously with the DFSDM0 JSWSTART trigger
    #[inline(always)]
    pub fn jsync(&mut self) -> JSYNC_W<FLT2CR1rs> {
        JSYNC_W::new(self, 3)
    }
    ///Bit 4 - Scanning conversion mode for injected conversions
    #[inline(always)]
    pub fn jscan(&mut self) -> JSCAN_W<FLT2CR1rs> {
        JSCAN_W::new(self, 4)
    }
    ///Bit 5 - DMA channel enabled to read data for the injected channel group
    #[inline(always)]
    pub fn jdmaen(&mut self) -> JDMAEN_W<FLT2CR1rs> {
        JDMAEN_W::new(self, 5)
    }
    ///Bits 8:10 - Trigger signal selection for launching injected conversions
    #[inline(always)]
    pub fn jextsel(&mut self) -> JEXTSEL_W<FLT2CR1rs> {
        JEXTSEL_W::new(self, 8)
    }
    ///Bits 13:14 - Trigger enable and trigger edge selection for injected conversions
    #[inline(always)]
    pub fn jexten(&mut self) -> JEXTEN_W<FLT2CR1rs> {
        JEXTEN_W::new(self, 13)
    }
    ///Bit 17 - Software start of a conversion on the regular channel
    #[inline(always)]
    pub fn rswstart(&mut self) -> RSWSTART_W<FLT2CR1rs> {
        RSWSTART_W::new(self, 17)
    }
    ///Bit 18 - Continuous mode selection for regular conversions
    #[inline(always)]
    pub fn rcont(&mut self) -> RCONT_W<FLT2CR1rs> {
        RCONT_W::new(self, 18)
    }
    ///Bit 19 - Launch regular conversion synchronously with DFSDM0
    #[inline(always)]
    pub fn rsync(&mut self) -> RSYNC_W<FLT2CR1rs> {
        RSYNC_W::new(self, 19)
    }
    ///Bit 21 - DMA channel enabled to read data for the regular conversion
    #[inline(always)]
    pub fn rdmaen(&mut self) -> RDMAEN_W<FLT2CR1rs> {
        RDMAEN_W::new(self, 21)
    }
    ///Bits 24:26 - Regular channel selection
    #[inline(always)]
    pub fn rch(&mut self) -> RCH_W<FLT2CR1rs> {
        RCH_W::new(self, 24)
    }
    ///Bit 29 - Fast conversion mode selection for regular conversions
    #[inline(always)]
    pub fn fast(&mut self) -> FAST_W<FLT2CR1rs> {
        FAST_W::new(self, 29)
    }
    ///Bit 30 - Analog watchdog fast mode select
    #[inline(always)]
    pub fn awfsel(&mut self) -> AWFSEL_W<FLT2CR1rs> {
        AWFSEL_W::new(self, 30)
    }
}
/**control register 1

You can [`read`](crate::Reg::read) this register and get [`flt2cr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flt2cr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#DFSDM1:FLT2CR1)*/
pub struct FLT2CR1rs;
impl crate::RegisterSpec for FLT2CR1rs {
    type Ux = u32;
}
///`read()` method returns [`flt2cr1::R`](R) reader structure
impl crate::Readable for FLT2CR1rs {}
///`write(|w| ..)` method takes [`flt2cr1::W`](W) writer structure
impl crate::Writable for FLT2CR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FLT2CR1 to value 0
impl crate::Resettable for FLT2CR1rs {
