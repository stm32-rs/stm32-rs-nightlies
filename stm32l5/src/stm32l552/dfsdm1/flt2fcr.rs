#[doc = "Reader of register FLT2FCR"]
pub type R = crate::R<u32, super::FLT2FCR>;
#[doc = "Writer for register FLT2FCR"]
pub type W = crate::W<u32, super::FLT2FCR>;
#[doc = "Register FLT2FCR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT2FCR {
    type Type = u32;
    #[inline(always)]
