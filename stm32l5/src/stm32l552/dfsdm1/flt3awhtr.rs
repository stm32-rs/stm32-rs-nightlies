#[doc = "Reader of register FLT3AWHTR"]
pub type R = crate::R<u32, super::FLT3AWHTR>;
#[doc = "Writer for register FLT3AWHTR"]
pub type W = crate::W<u32, super::FLT3AWHTR>;
#[doc = "Register FLT3AWHTR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT3AWHTR {
    type Type = u32;
    #[inline(always)]
