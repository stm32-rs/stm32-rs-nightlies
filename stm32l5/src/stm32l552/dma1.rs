...
impl RegisterBlock {
    ...
    ///0x08..0x1c - Channel cluster: CCR?, CNDTR?, CPAR?, CM0AR?, and CM1AR? registers
    #[inline(always)]
    pub const fn ch1(&self) -> &CH {
        self.ch(0)
    }
    ///0x1c..0x30 - Channel cluster: CCR?, CNDTR?, CPAR?, CM0AR?, and CM1AR? registers
    #[inline(always)]
    pub const fn ch2(&self) -> &CH {
        self.ch(1)
    }
    ///0x30..0x44 - Channel cluster: CCR?, CNDTR?, CPAR?, CM0AR?, and CM1AR? registers
    #[inline(always)]
    pub const fn ch3(&self) -> &CH {
        self.ch(2)
    }
    ///0x44..0x58 - Channel cluster: CCR?, CNDTR?, CPAR?, CM0AR?, and CM1AR? registers
    #[inline(always)]
    pub const fn ch4(&self) -> &CH {
        self.ch(3)
    }
    ///0x58..0x6c - Channel cluster: CCR?, CNDTR?, CPAR?, CM0AR?, and CM1AR? registers
    #[inline(always)]
    pub const fn ch5(&self) -> &CH {
        self.ch(4)
    }
    ///0x6c..0x80 - Channel cluster: CCR?, CNDTR?, CPAR?, CM0AR?, and CM1AR? registers
    #[inline(always)]
    pub const fn ch6(&self) -> &CH {
        self.ch(5)
    }
    ///0x80..0x94 - Channel cluster: CCR?, CNDTR?, CPAR?, CM0AR?, and CM1AR? registers
    #[inline(always)]
    pub const fn ch7(&self) -> &CH {
        self.ch(6)
    }
    ///0x94..0xa8 - Channel cluster: CCR?, CNDTR?, CPAR?, CM0AR?, and CM1AR? registers
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#DMA1:ISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#DMA1:IFCR)
