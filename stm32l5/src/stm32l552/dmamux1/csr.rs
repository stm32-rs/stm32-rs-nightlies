...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SOF0` field.</div>
    #[inline(always)]
    pub fn sof(&mut self, n: u8) -> SOF_W<CSRrs> {
        #[allow(clippy::no_effect)]
        [(); 16][n as usize];
        SOF_W::new(self, n)
    }
    ///Bit 0 - Synchronization Overrun Flag 0
    #[inline(always)]
    pub fn sof0(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 0)
    }
    ///Bit 1 - Synchronization Overrun Flag 1
    #[inline(always)]
    pub fn sof1(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 1)
    }
    ///Bit 2 - Synchronization Overrun Flag 2
    #[inline(always)]
    pub fn sof2(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 2)
    }
    ///Bit 3 - Synchronization Overrun Flag 3
    #[inline(always)]
    pub fn sof3(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 3)
    }
    ///Bit 4 - Synchronization Overrun Flag 4
    #[inline(always)]
    pub fn sof4(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 4)
    }
    ///Bit 5 - Synchronization Overrun Flag 5
    #[inline(always)]
    pub fn sof5(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 5)
    }
    ///Bit 6 - Synchronization Overrun Flag 6
    #[inline(always)]
    pub fn sof6(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 6)
    }
    ///Bit 7 - Synchronization Overrun Flag 7
    #[inline(always)]
    pub fn sof7(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 7)
    }
    ///Bit 8 - Synchronization Overrun Flag 8
    #[inline(always)]
    pub fn sof8(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 8)
    }
    ///Bit 9 - Synchronization Overrun Flag 9
    #[inline(always)]
    pub fn sof9(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 9)
    }
    ///Bit 10 - Synchronization Overrun Flag 10
    #[inline(always)]
    pub fn sof10(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 10)
    }
    ///Bit 11 - Synchronization Overrun Flag 11
    #[inline(always)]
    pub fn sof11(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 11)
    }
    ///Bit 12 - Synchronization Overrun Flag 12
    #[inline(always)]
    pub fn sof12(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 12)
    }
    ///Bit 13 - Synchronization Overrun Flag 13
    #[inline(always)]
    pub fn sof13(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 13)
    }
    ///Bit 14 - Synchronization Overrun Flag 14
    #[inline(always)]
    pub fn sof14(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 14)
    }
    ///Bit 15 - Synchronization Overrun Flag 15
    #[inline(always)]
    pub fn sof15(&mut self) -> SOF_W<CSRrs> {
        SOF_W::new(self, 15)
    }
}
