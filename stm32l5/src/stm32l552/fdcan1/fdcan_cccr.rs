...
///Field `BSE` reader - FDCAN Bit Rate Switching
pub type BSE_R = crate::BitReader;
///Field `BSE` writer - FDCAN Bit Rate Switching
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csa(&mut self) -> CSA_W<FDCAN_CCCRrs> {
        CSA_W::new(self, 3)
    }
    ///Bit 4 - Clock Stop Request
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn bse(&mut self) -> BSE_W<FDCAN_CCCRrs> {
        BSE_W::new(self, 9)
    }
    ///Bit 12 - Protocol Exception Handling Disable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#FDCAN1:FDCAN_CCCR)*/
