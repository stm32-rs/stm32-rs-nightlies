...
#[doc = "Writer for register FDCAN_TOCV"]
pub type W = crate::W<u32, super::FDCAN_TOCV>;
#[doc = "Register FDCAN_TOCV `reset()`'s with value 0xffff"]
impl crate::ResetValue for super::FDCAN_TOCV {
    type Type = u32;
    #[inline(always)]
