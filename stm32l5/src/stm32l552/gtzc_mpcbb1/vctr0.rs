...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b0(&mut self) -> B0_W<VCTR0rs> {
        B0_W::new(self, 0)
    }
    #[doc = "Bit 1 - B1"]
    #[inline(always)]
    #[must_use]
    pub fn b1(&mut self) -> B1_W<VCTR0rs> {
        B1_W::new(self, 1)
    }
    #[doc = "Bit 2 - B2"]
    #[inline(always)]
    #[must_use]
    pub fn b2(&mut self) -> B2_W<VCTR0rs> {
        B2_W::new(self, 2)
    }
    #[doc = "Bit 3 - B3"]
    #[inline(always)]
    #[must_use]
    pub fn b3(&mut self) -> B3_W<VCTR0rs> {
        B3_W::new(self, 3)
    }
    #[doc = "Bit 4 - B4"]
    #[inline(always)]
    #[must_use]
    pub fn b4(&mut self) -> B4_W<VCTR0rs> {
        B4_W::new(self, 4)
    }
    #[doc = "Bit 5 - B5"]
    #[inline(always)]
    #[must_use]
    pub fn b5(&mut self) -> B5_W<VCTR0rs> {
        B5_W::new(self, 5)
    }
    #[doc = "Bit 6 - B6"]
    #[inline(always)]
    #[must_use]
    pub fn b6(&mut self) -> B6_W<VCTR0rs> {
        B6_W::new(self, 6)
    }
    #[doc = "Bit 7 - B7"]
    #[inline(always)]
    #[must_use]
    pub fn b7(&mut self) -> B7_W<VCTR0rs> {
        B7_W::new(self, 7)
    }
    #[doc = "Bit 8 - B8"]
    #[inline(always)]
    #[must_use]
    pub fn b8(&mut self) -> B8_W<VCTR0rs> {
        B8_W::new(self, 8)
    }
    #[doc = "Bit 9 - B9"]
    #[inline(always)]
    #[must_use]
    pub fn b9(&mut self) -> B9_W<VCTR0rs> {
        B9_W::new(self, 9)
    }
    #[doc = "Bit 10 - B10"]
    #[inline(always)]
    #[must_use]
    pub fn b10(&mut self) -> B10_W<VCTR0rs> {
        B10_W::new(self, 10)
    }
    #[doc = "Bit 11 - B11"]
    #[inline(always)]
    #[must_use]
    pub fn b11(&mut self) -> B11_W<VCTR0rs> {
        B11_W::new(self, 11)
    }
    #[doc = "Bit 12 - B12"]
    #[inline(always)]
    #[must_use]
    pub fn b12(&mut self) -> B12_W<VCTR0rs> {
        B12_W::new(self, 12)
    }
    #[doc = "Bit 13 - B13"]
    #[inline(always)]
    #[must_use]
    pub fn b13(&mut self) -> B13_W<VCTR0rs> {
        B13_W::new(self, 13)
    }
    #[doc = "Bit 14 - B14"]
    #[inline(always)]
    #[must_use]
    pub fn b14(&mut self) -> B14_W<VCTR0rs> {
        B14_W::new(self, 14)
    }
    #[doc = "Bit 15 - B15"]
    #[inline(always)]
    #[must_use]
    pub fn b15(&mut self) -> B15_W<VCTR0rs> {
        B15_W::new(self, 15)
    }
    #[doc = "Bit 16 - B16"]
    #[inline(always)]
    #[must_use]
    pub fn b16(&mut self) -> B16_W<VCTR0rs> {
        B16_W::new(self, 16)
    }
    #[doc = "Bit 17 - B17"]
    #[inline(always)]
    #[must_use]
    pub fn b17(&mut self) -> B17_W<VCTR0rs> {
        B17_W::new(self, 17)
    }
    #[doc = "Bit 18 - B18"]
    #[inline(always)]
    #[must_use]
    pub fn b18(&mut self) -> B18_W<VCTR0rs> {
        B18_W::new(self, 18)
    }
    #[doc = "Bit 19 - B19"]
    #[inline(always)]
    #[must_use]
    pub fn b19(&mut self) -> B19_W<VCTR0rs> {
        B19_W::new(self, 19)
    }
    #[doc = "Bit 20 - B20"]
    #[inline(always)]
    #[must_use]
    pub fn b20(&mut self) -> B20_W<VCTR0rs> {
        B20_W::new(self, 20)
    }
    #[doc = "Bit 21 - B21"]
    #[inline(always)]
    #[must_use]
    pub fn b21(&mut self) -> B21_W<VCTR0rs> {
        B21_W::new(self, 21)
    }
    #[doc = "Bit 22 - B22"]
    #[inline(always)]
    #[must_use]
    pub fn b22(&mut self) -> B22_W<VCTR0rs> {
        B22_W::new(self, 22)
    }
    #[doc = "Bit 23 - B23"]
    #[inline(always)]
    #[must_use]
    pub fn b23(&mut self) -> B23_W<VCTR0rs> {
        B23_W::new(self, 23)
    }
    #[doc = "Bit 24 - B24"]
    #[inline(always)]
    #[must_use]
    pub fn b24(&mut self) -> B24_W<VCTR0rs> {
        B24_W::new(self, 24)
    }
    #[doc = "Bit 25 - B25"]
    #[inline(always)]
    #[must_use]
    pub fn b25(&mut self) -> B25_W<VCTR0rs> {
        B25_W::new(self, 25)
    }
    #[doc = "Bit 26 - B26"]
    #[inline(always)]
    #[must_use]
    pub fn b26(&mut self) -> B26_W<VCTR0rs> {
        B26_W::new(self, 26)
    }
    #[doc = "Bit 27 - B27"]
    #[inline(always)]
    #[must_use]
    pub fn b27(&mut self) -> B27_W<VCTR0rs> {
        B27_W::new(self, 27)
    }
    #[doc = "Bit 28 - B28"]
    #[inline(always)]
    #[must_use]
    pub fn b28(&mut self) -> B28_W<VCTR0rs> {
        B28_W::new(self, 28)
    }
    #[doc = "Bit 29 - B29"]
    #[inline(always)]
    #[must_use]
    pub fn b29(&mut self) -> B29_W<VCTR0rs> {
        B29_W::new(self, 29)
    }
    #[doc = "Bit 30 - B30"]
    #[inline(always)]
    #[must_use]
    pub fn b30(&mut self) -> B30_W<VCTR0rs> {
        B30_W::new(self, 30)
    }
    #[doc = "Bit 31 - B31"]
    #[inline(always)]
    #[must_use]
    pub fn b31(&mut self) -> B31_W<VCTR0rs> {
        B31_W::new(self, 31)
    }
}
#[doc = "MPCBBx vector register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vctr0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`vctr0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VCTR0rs;
