...
impl W {
    ///Bit 0 - B608
    #[inline(always)]
    pub fn b608(&mut self) -> B608_W<'_, VCTR19rs> {
        B608_W::new(self, 0)
    }
    ///Bit 1 - B609
    #[inline(always)]
    pub fn b609(&mut self) -> B609_W<'_, VCTR19rs> {
        B609_W::new(self, 1)
    }
    ///Bit 2 - B610
    #[inline(always)]
    pub fn b610(&mut self) -> B610_W<'_, VCTR19rs> {
        B610_W::new(self, 2)
    }
    ///Bit 3 - B611
    #[inline(always)]
    pub fn b611(&mut self) -> B611_W<'_, VCTR19rs> {
        B611_W::new(self, 3)
    }
    ///Bit 4 - B612
    #[inline(always)]
    pub fn b612(&mut self) -> B612_W<'_, VCTR19rs> {
        B612_W::new(self, 4)
    }
    ///Bit 5 - B613
    #[inline(always)]
    pub fn b613(&mut self) -> B613_W<'_, VCTR19rs> {
        B613_W::new(self, 5)
    }
    ///Bit 6 - B614
    #[inline(always)]
    pub fn b614(&mut self) -> B614_W<'_, VCTR19rs> {
        B614_W::new(self, 6)
    }
    ///Bit 7 - B615
    #[inline(always)]
    pub fn b615(&mut self) -> B615_W<'_, VCTR19rs> {
        B615_W::new(self, 7)
    }
    ///Bit 8 - B616
    #[inline(always)]
    pub fn b616(&mut self) -> B616_W<'_, VCTR19rs> {
        B616_W::new(self, 8)
    }
    ///Bit 9 - B617
    #[inline(always)]
    pub fn b617(&mut self) -> B617_W<'_, VCTR19rs> {
        B617_W::new(self, 9)
    }
    ///Bit 10 - B618
    #[inline(always)]
    pub fn b618(&mut self) -> B618_W<'_, VCTR19rs> {
        B618_W::new(self, 10)
    }
    ///Bit 11 - B619
    #[inline(always)]
    pub fn b619(&mut self) -> B619_W<'_, VCTR19rs> {
        B619_W::new(self, 11)
    }
    ///Bit 12 - B620
    #[inline(always)]
    pub fn b620(&mut self) -> B620_W<'_, VCTR19rs> {
        B620_W::new(self, 12)
    }
    ///Bit 13 - B621
    #[inline(always)]
    pub fn b621(&mut self) -> B621_W<'_, VCTR19rs> {
        B621_W::new(self, 13)
    }
    ///Bit 14 - B622
    #[inline(always)]
    pub fn b622(&mut self) -> B622_W<'_, VCTR19rs> {
        B622_W::new(self, 14)
    }
    ///Bit 15 - B623
    #[inline(always)]
    pub fn b623(&mut self) -> B623_W<'_, VCTR19rs> {
        B623_W::new(self, 15)
    }
    ///Bit 16 - B624
    #[inline(always)]
    pub fn b624(&mut self) -> B624_W<'_, VCTR19rs> {
        B624_W::new(self, 16)
    }
    ///Bit 17 - B625
    #[inline(always)]
    pub fn b625(&mut self) -> B625_W<'_, VCTR19rs> {
        B625_W::new(self, 17)
    }
    ///Bit 18 - B626
    #[inline(always)]
    pub fn b626(&mut self) -> B626_W<'_, VCTR19rs> {
        B626_W::new(self, 18)
    }
    ///Bit 19 - B627
    #[inline(always)]
    pub fn b627(&mut self) -> B627_W<'_, VCTR19rs> {
        B627_W::new(self, 19)
    }
    ///Bit 20 - B628
    #[inline(always)]
    pub fn b628(&mut self) -> B628_W<'_, VCTR19rs> {
        B628_W::new(self, 20)
    }
    ///Bit 21 - B629
    #[inline(always)]
    pub fn b629(&mut self) -> B629_W<'_, VCTR19rs> {
        B629_W::new(self, 21)
    }
    ///Bit 22 - B630
    #[inline(always)]
    pub fn b630(&mut self) -> B630_W<'_, VCTR19rs> {
        B630_W::new(self, 22)
    }
    ///Bit 23 - B631
    #[inline(always)]
    pub fn b631(&mut self) -> B631_W<'_, VCTR19rs> {
        B631_W::new(self, 23)
    }
    ///Bit 24 - B632
    #[inline(always)]
    pub fn b632(&mut self) -> B632_W<'_, VCTR19rs> {
        B632_W::new(self, 24)
    }
    ///Bit 25 - B633
    #[inline(always)]
    pub fn b633(&mut self) -> B633_W<'_, VCTR19rs> {
        B633_W::new(self, 25)
    }
    ///Bit 26 - B634
    #[inline(always)]
    pub fn b634(&mut self) -> B634_W<'_, VCTR19rs> {
        B634_W::new(self, 26)
    }
    ///Bit 27 - B635
    #[inline(always)]
    pub fn b635(&mut self) -> B635_W<'_, VCTR19rs> {
        B635_W::new(self, 27)
    }
    ///Bit 28 - B636
    #[inline(always)]
    pub fn b636(&mut self) -> B636_W<'_, VCTR19rs> {
        B636_W::new(self, 28)
    }
    ///Bit 29 - B637
    #[inline(always)]
    pub fn b637(&mut self) -> B637_W<'_, VCTR19rs> {
        B637_W::new(self, 29)
    }
    ///Bit 30 - B638
    #[inline(always)]
    pub fn b638(&mut self) -> B638_W<'_, VCTR19rs> {
        B638_W::new(self, 30)
    }
    ///Bit 31 - B639
    #[inline(always)]
    pub fn b639(&mut self) -> B639_W<'_, VCTR19rs> {
        B639_W::new(self, 31)
    }
}
