...
impl W {
    ///Bit 0 - B800
    #[inline(always)]
    pub fn b800(&mut self) -> B800_W<'_, VCTR25rs> {
        B800_W::new(self, 0)
    }
    ///Bit 1 - B801
    #[inline(always)]
    pub fn b801(&mut self) -> B801_W<'_, VCTR25rs> {
        B801_W::new(self, 1)
    }
    ///Bit 2 - B802
    #[inline(always)]
    pub fn b802(&mut self) -> B802_W<'_, VCTR25rs> {
        B802_W::new(self, 2)
    }
    ///Bit 3 - B803
    #[inline(always)]
    pub fn b803(&mut self) -> B803_W<'_, VCTR25rs> {
        B803_W::new(self, 3)
    }
    ///Bit 4 - B804
    #[inline(always)]
    pub fn b804(&mut self) -> B804_W<'_, VCTR25rs> {
        B804_W::new(self, 4)
    }
    ///Bit 5 - B805
    #[inline(always)]
    pub fn b805(&mut self) -> B805_W<'_, VCTR25rs> {
        B805_W::new(self, 5)
    }
    ///Bit 6 - B806
    #[inline(always)]
    pub fn b806(&mut self) -> B806_W<'_, VCTR25rs> {
        B806_W::new(self, 6)
    }
    ///Bit 7 - B807
    #[inline(always)]
    pub fn b807(&mut self) -> B807_W<'_, VCTR25rs> {
        B807_W::new(self, 7)
    }
    ///Bit 8 - B808
    #[inline(always)]
    pub fn b808(&mut self) -> B808_W<'_, VCTR25rs> {
        B808_W::new(self, 8)
    }
    ///Bit 9 - B809
    #[inline(always)]
    pub fn b809(&mut self) -> B809_W<'_, VCTR25rs> {
        B809_W::new(self, 9)
    }
    ///Bit 10 - B810
    #[inline(always)]
    pub fn b810(&mut self) -> B810_W<'_, VCTR25rs> {
        B810_W::new(self, 10)
    }
    ///Bit 11 - B811
    #[inline(always)]
    pub fn b811(&mut self) -> B811_W<'_, VCTR25rs> {
        B811_W::new(self, 11)
    }
    ///Bit 12 - B812
    #[inline(always)]
    pub fn b812(&mut self) -> B812_W<'_, VCTR25rs> {
        B812_W::new(self, 12)
    }
    ///Bit 13 - B813
    #[inline(always)]
    pub fn b813(&mut self) -> B813_W<'_, VCTR25rs> {
        B813_W::new(self, 13)
    }
    ///Bit 14 - B814
    #[inline(always)]
    pub fn b814(&mut self) -> B814_W<'_, VCTR25rs> {
        B814_W::new(self, 14)
    }
    ///Bit 15 - B815
    #[inline(always)]
    pub fn b815(&mut self) -> B815_W<'_, VCTR25rs> {
        B815_W::new(self, 15)
    }
    ///Bit 16 - B816
    #[inline(always)]
    pub fn b816(&mut self) -> B816_W<'_, VCTR25rs> {
        B816_W::new(self, 16)
    }
    ///Bit 17 - B817
    #[inline(always)]
    pub fn b817(&mut self) -> B817_W<'_, VCTR25rs> {
        B817_W::new(self, 17)
    }
    ///Bit 18 - B818
    #[inline(always)]
    pub fn b818(&mut self) -> B818_W<'_, VCTR25rs> {
        B818_W::new(self, 18)
    }
    ///Bit 19 - B819
    #[inline(always)]
    pub fn b819(&mut self) -> B819_W<'_, VCTR25rs> {
        B819_W::new(self, 19)
    }
    ///Bit 20 - B820
    #[inline(always)]
    pub fn b820(&mut self) -> B820_W<'_, VCTR25rs> {
        B820_W::new(self, 20)
    }
    ///Bit 21 - B821
    #[inline(always)]
    pub fn b821(&mut self) -> B821_W<'_, VCTR25rs> {
        B821_W::new(self, 21)
    }
    ///Bit 22 - B822
    #[inline(always)]
    pub fn b822(&mut self) -> B822_W<'_, VCTR25rs> {
        B822_W::new(self, 22)
    }
    ///Bit 23 - B823
    #[inline(always)]
    pub fn b823(&mut self) -> B823_W<'_, VCTR25rs> {
        B823_W::new(self, 23)
    }
    ///Bit 24 - B824
    #[inline(always)]
    pub fn b824(&mut self) -> B824_W<'_, VCTR25rs> {
        B824_W::new(self, 24)
    }
    ///Bit 25 - B825
    #[inline(always)]
    pub fn b825(&mut self) -> B825_W<'_, VCTR25rs> {
        B825_W::new(self, 25)
    }
    ///Bit 26 - B826
    #[inline(always)]
    pub fn b826(&mut self) -> B826_W<'_, VCTR25rs> {
        B826_W::new(self, 26)
    }
    ///Bit 27 - B827
    #[inline(always)]
    pub fn b827(&mut self) -> B827_W<'_, VCTR25rs> {
        B827_W::new(self, 27)
    }
    ///Bit 28 - B828
    #[inline(always)]
    pub fn b828(&mut self) -> B828_W<'_, VCTR25rs> {
        B828_W::new(self, 28)
    }
    ///Bit 29 - B829
    #[inline(always)]
    pub fn b829(&mut self) -> B829_W<'_, VCTR25rs> {
        B829_W::new(self, 29)
    }
    ///Bit 30 - B830
    #[inline(always)]
    pub fn b830(&mut self) -> B830_W<'_, VCTR25rs> {
        B830_W::new(self, 30)
    }
    ///Bit 31 - B831
    #[inline(always)]
    pub fn b831(&mut self) -> B831_W<'_, VCTR25rs> {
        B831_W::new(self, 31)
    }
}
