...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b1696(&mut self) -> B1696_W<VCTR53rs> {
        B1696_W::new(self, 0)
    }
    #[doc = "Bit 1 - B1697"]
    #[inline(always)]
    #[must_use]
    pub fn b1697(&mut self) -> B1697_W<VCTR53rs> {
        B1697_W::new(self, 1)
    }
    #[doc = "Bit 2 - B1698"]
    #[inline(always)]
    #[must_use]
    pub fn b1698(&mut self) -> B1698_W<VCTR53rs> {
        B1698_W::new(self, 2)
    }
    #[doc = "Bit 3 - B1699"]
    #[inline(always)]
    #[must_use]
    pub fn b1699(&mut self) -> B1699_W<VCTR53rs> {
        B1699_W::new(self, 3)
    }
    #[doc = "Bit 4 - B1700"]
    #[inline(always)]
    #[must_use]
    pub fn b1700(&mut self) -> B1700_W<VCTR53rs> {
        B1700_W::new(self, 4)
    }
    #[doc = "Bit 5 - B1701"]
    #[inline(always)]
    #[must_use]
    pub fn b1701(&mut self) -> B1701_W<VCTR53rs> {
        B1701_W::new(self, 5)
    }
    #[doc = "Bit 6 - B1702"]
    #[inline(always)]
    #[must_use]
    pub fn b1702(&mut self) -> B1702_W<VCTR53rs> {
        B1702_W::new(self, 6)
    }
    #[doc = "Bit 7 - B1703"]
    #[inline(always)]
    #[must_use]
    pub fn b1703(&mut self) -> B1703_W<VCTR53rs> {
        B1703_W::new(self, 7)
    }
    #[doc = "Bit 8 - B1704"]
    #[inline(always)]
    #[must_use]
    pub fn b1704(&mut self) -> B1704_W<VCTR53rs> {
        B1704_W::new(self, 8)
    }
    #[doc = "Bit 9 - B1705"]
    #[inline(always)]
    #[must_use]
    pub fn b1705(&mut self) -> B1705_W<VCTR53rs> {
        B1705_W::new(self, 9)
    }
    #[doc = "Bit 10 - B1706"]
    #[inline(always)]
    #[must_use]
    pub fn b1706(&mut self) -> B1706_W<VCTR53rs> {
        B1706_W::new(self, 10)
    }
    #[doc = "Bit 11 - B1707"]
    #[inline(always)]
    #[must_use]
    pub fn b1707(&mut self) -> B1707_W<VCTR53rs> {
        B1707_W::new(self, 11)
    }
    #[doc = "Bit 12 - B1708"]
    #[inline(always)]
    #[must_use]
    pub fn b1708(&mut self) -> B1708_W<VCTR53rs> {
        B1708_W::new(self, 12)
    }
    #[doc = "Bit 13 - B1709"]
    #[inline(always)]
    #[must_use]
    pub fn b1709(&mut self) -> B1709_W<VCTR53rs> {
        B1709_W::new(self, 13)
    }
    #[doc = "Bit 14 - B1710"]
    #[inline(always)]
    #[must_use]
    pub fn b1710(&mut self) -> B1710_W<VCTR53rs> {
        B1710_W::new(self, 14)
    }
    #[doc = "Bit 15 - B1711"]
    #[inline(always)]
    #[must_use]
    pub fn b1711(&mut self) -> B1711_W<VCTR53rs> {
        B1711_W::new(self, 15)
    }
    #[doc = "Bit 16 - B1712"]
    #[inline(always)]
    #[must_use]
    pub fn b1712(&mut self) -> B1712_W<VCTR53rs> {
        B1712_W::new(self, 16)
    }
    #[doc = "Bit 17 - B1713"]
    #[inline(always)]
    #[must_use]
    pub fn b1713(&mut self) -> B1713_W<VCTR53rs> {
        B1713_W::new(self, 17)
    }
    #[doc = "Bit 18 - B1714"]
    #[inline(always)]
    #[must_use]
    pub fn b1714(&mut self) -> B1714_W<VCTR53rs> {
        B1714_W::new(self, 18)
    }
    #[doc = "Bit 19 - B1715"]
    #[inline(always)]
    #[must_use]
    pub fn b1715(&mut self) -> B1715_W<VCTR53rs> {
        B1715_W::new(self, 19)
    }
    #[doc = "Bit 20 - B1716"]
    #[inline(always)]
    #[must_use]
    pub fn b1716(&mut self) -> B1716_W<VCTR53rs> {
        B1716_W::new(self, 20)
    }
    #[doc = "Bit 21 - B1717"]
    #[inline(always)]
    #[must_use]
    pub fn b1717(&mut self) -> B1717_W<VCTR53rs> {
        B1717_W::new(self, 21)
    }
    #[doc = "Bit 22 - B1718"]
    #[inline(always)]
    #[must_use]
    pub fn b1718(&mut self) -> B1718_W<VCTR53rs> {
        B1718_W::new(self, 22)
    }
    #[doc = "Bit 23 - B1719"]
    #[inline(always)]
    #[must_use]
    pub fn b1719(&mut self) -> B1719_W<VCTR53rs> {
        B1719_W::new(self, 23)
    }
    #[doc = "Bit 24 - B1720"]
    #[inline(always)]
    #[must_use]
    pub fn b1720(&mut self) -> B1720_W<VCTR53rs> {
        B1720_W::new(self, 24)
    }
    #[doc = "Bit 25 - B1721"]
    #[inline(always)]
    #[must_use]
    pub fn b1721(&mut self) -> B1721_W<VCTR53rs> {
        B1721_W::new(self, 25)
    }
    #[doc = "Bit 26 - B1722"]
    #[inline(always)]
    #[must_use]
    pub fn b1722(&mut self) -> B1722_W<VCTR53rs> {
        B1722_W::new(self, 26)
    }
    #[doc = "Bit 27 - B1723"]
    #[inline(always)]
    #[must_use]
    pub fn b1723(&mut self) -> B1723_W<VCTR53rs> {
        B1723_W::new(self, 27)
    }
    #[doc = "Bit 28 - B1724"]
    #[inline(always)]
    #[must_use]
    pub fn b1724(&mut self) -> B1724_W<VCTR53rs> {
        B1724_W::new(self, 28)
    }
    #[doc = "Bit 29 - B1725"]
    #[inline(always)]
    #[must_use]
    pub fn b1725(&mut self) -> B1725_W<VCTR53rs> {
        B1725_W::new(self, 29)
    }
    #[doc = "Bit 30 - B1726"]
    #[inline(always)]
    #[must_use]
    pub fn b1726(&mut self) -> B1726_W<VCTR53rs> {
        B1726_W::new(self, 30)
    }
    #[doc = "Bit 31 - B1727"]
    #[inline(always)]
    #[must_use]
    pub fn b1727(&mut self) -> B1727_W<VCTR53rs> {
        B1727_W::new(self, 31)
    }
}
#[doc = "MPCBBx vector register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vctr53::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`vctr53::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VCTR53rs;
