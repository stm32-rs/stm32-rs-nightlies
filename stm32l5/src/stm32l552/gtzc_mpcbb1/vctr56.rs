...
impl W {
    ///Bit 0 - B1792
    #[inline(always)]
    pub fn b1792(&mut self) -> B1792_W<'_, VCTR56rs> {
        B1792_W::new(self, 0)
    }
    ///Bit 1 - B1793
    #[inline(always)]
    pub fn b1793(&mut self) -> B1793_W<'_, VCTR56rs> {
        B1793_W::new(self, 1)
    }
    ///Bit 2 - B1794
    #[inline(always)]
    pub fn b1794(&mut self) -> B1794_W<'_, VCTR56rs> {
        B1794_W::new(self, 2)
    }
    ///Bit 3 - B1795
    #[inline(always)]
    pub fn b1795(&mut self) -> B1795_W<'_, VCTR56rs> {
        B1795_W::new(self, 3)
    }
    ///Bit 4 - B1796
    #[inline(always)]
    pub fn b1796(&mut self) -> B1796_W<'_, VCTR56rs> {
        B1796_W::new(self, 4)
    }
    ///Bit 5 - B1797
    #[inline(always)]
    pub fn b1797(&mut self) -> B1797_W<'_, VCTR56rs> {
        B1797_W::new(self, 5)
    }
    ///Bit 6 - B1798
    #[inline(always)]
    pub fn b1798(&mut self) -> B1798_W<'_, VCTR56rs> {
        B1798_W::new(self, 6)
    }
    ///Bit 7 - B1799
    #[inline(always)]
    pub fn b1799(&mut self) -> B1799_W<'_, VCTR56rs> {
        B1799_W::new(self, 7)
    }
    ///Bit 8 - B1800
    #[inline(always)]
    pub fn b1800(&mut self) -> B1800_W<'_, VCTR56rs> {
        B1800_W::new(self, 8)
    }
    ///Bit 9 - B1801
    #[inline(always)]
    pub fn b1801(&mut self) -> B1801_W<'_, VCTR56rs> {
        B1801_W::new(self, 9)
    }
    ///Bit 10 - B1802
    #[inline(always)]
    pub fn b1802(&mut self) -> B1802_W<'_, VCTR56rs> {
        B1802_W::new(self, 10)
    }
    ///Bit 11 - B1803
    #[inline(always)]
    pub fn b1803(&mut self) -> B1803_W<'_, VCTR56rs> {
        B1803_W::new(self, 11)
    }
    ///Bit 12 - B1804
    #[inline(always)]
    pub fn b1804(&mut self) -> B1804_W<'_, VCTR56rs> {
        B1804_W::new(self, 12)
    }
    ///Bit 13 - B1805
    #[inline(always)]
    pub fn b1805(&mut self) -> B1805_W<'_, VCTR56rs> {
        B1805_W::new(self, 13)
    }
    ///Bit 14 - B1806
    #[inline(always)]
    pub fn b1806(&mut self) -> B1806_W<'_, VCTR56rs> {
        B1806_W::new(self, 14)
    }
    ///Bit 15 - B1807
    #[inline(always)]
    pub fn b1807(&mut self) -> B1807_W<'_, VCTR56rs> {
        B1807_W::new(self, 15)
    }
    ///Bit 16 - B1808
    #[inline(always)]
    pub fn b1808(&mut self) -> B1808_W<'_, VCTR56rs> {
        B1808_W::new(self, 16)
    }
    ///Bit 17 - B1809
    #[inline(always)]
    pub fn b1809(&mut self) -> B1809_W<'_, VCTR56rs> {
        B1809_W::new(self, 17)
    }
    ///Bit 18 - B1810
    #[inline(always)]
    pub fn b1810(&mut self) -> B1810_W<'_, VCTR56rs> {
        B1810_W::new(self, 18)
    }
    ///Bit 19 - B1811
    #[inline(always)]
    pub fn b1811(&mut self) -> B1811_W<'_, VCTR56rs> {
        B1811_W::new(self, 19)
    }
    ///Bit 20 - B1812
    #[inline(always)]
    pub fn b1812(&mut self) -> B1812_W<'_, VCTR56rs> {
        B1812_W::new(self, 20)
    }
    ///Bit 21 - B1813
    #[inline(always)]
    pub fn b1813(&mut self) -> B1813_W<'_, VCTR56rs> {
        B1813_W::new(self, 21)
    }
    ///Bit 22 - B1814
    #[inline(always)]
    pub fn b1814(&mut self) -> B1814_W<'_, VCTR56rs> {
        B1814_W::new(self, 22)
    }
    ///Bit 23 - B1815
    #[inline(always)]
    pub fn b1815(&mut self) -> B1815_W<'_, VCTR56rs> {
        B1815_W::new(self, 23)
    }
    ///Bit 24 - B1816
    #[inline(always)]
    pub fn b1816(&mut self) -> B1816_W<'_, VCTR56rs> {
        B1816_W::new(self, 24)
    }
    ///Bit 25 - B1817
    #[inline(always)]
    pub fn b1817(&mut self) -> B1817_W<'_, VCTR56rs> {
        B1817_W::new(self, 25)
    }
    ///Bit 26 - B1818
    #[inline(always)]
    pub fn b1818(&mut self) -> B1818_W<'_, VCTR56rs> {
        B1818_W::new(self, 26)
    }
    ///Bit 27 - B1819
    #[inline(always)]
    pub fn b1819(&mut self) -> B1819_W<'_, VCTR56rs> {
        B1819_W::new(self, 27)
    }
    ///Bit 28 - B1820
    #[inline(always)]
    pub fn b1820(&mut self) -> B1820_W<'_, VCTR56rs> {
        B1820_W::new(self, 28)
    }
    ///Bit 29 - B1821
    #[inline(always)]
    pub fn b1821(&mut self) -> B1821_W<'_, VCTR56rs> {
        B1821_W::new(self, 29)
    }
    ///Bit 30 - B1822
    #[inline(always)]
    pub fn b1822(&mut self) -> B1822_W<'_, VCTR56rs> {
        B1822_W::new(self, 30)
    }
    ///Bit 31 - B1823
    #[inline(always)]
    pub fn b1823(&mut self) -> B1823_W<'_, VCTR56rs> {
        B1823_W::new(self, 31)
    }
}
