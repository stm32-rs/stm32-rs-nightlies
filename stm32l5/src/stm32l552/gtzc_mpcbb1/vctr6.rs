///Register `VCTR6` reader
pub type R = crate::R<VCTR6rs>;
///Register `VCTR6` writer
pub type W = crate::W<VCTR6rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("VCTR6")
            .field("b192", &self.b192())
            .field("b193", &self.b193())
            .field("b194", &self.b194())
            .field("b195", &self.b195())
            .field("b196", &self.b196())
            .field("b197", &self.b197())
            .field("b198", &self.b198())
            .field("b199", &self.b199())
            .field("b200", &self.b200())
            .field("b201", &self.b201())
            .field("b202", &self.b202())
            .field("b203", &self.b203())
            .field("b204", &self.b204())
            .field("b205", &self.b205())
            .field("b206", &self.b206())
            .field("b207", &self.b207())
            .field("b208", &self.b208())
            .field("b209", &self.b209())
            .field("b210", &self.b210())
            .field("b211", &self.b211())
            .field("b212", &self.b212())
            .field("b213", &self.b213())
            .field("b214", &self.b214())
            .field("b215", &self.b215())
            .field("b216", &self.b216())
            .field("b217", &self.b217())
            .field("b218", &self.b218())
            .field("b219", &self.b219())
            .field("b220", &self.b220())
            .field("b221", &self.b221())
            .field("b222", &self.b222())
            .field("b223", &self.b223())
            .finish()
    }
}
impl W {
    ///Bit 0 - B192
    #[inline(always)]
    pub fn b192(&mut self) -> B192_W<VCTR6rs> {
        B192_W::new(self, 0)
    }
    ///Bit 1 - B193
    #[inline(always)]
    pub fn b193(&mut self) -> B193_W<VCTR6rs> {
        B193_W::new(self, 1)
    }
    ///Bit 2 - B194
    #[inline(always)]
    pub fn b194(&mut self) -> B194_W<VCTR6rs> {
        B194_W::new(self, 2)
    }
    ///Bit 3 - B195
    #[inline(always)]
    pub fn b195(&mut self) -> B195_W<VCTR6rs> {
        B195_W::new(self, 3)
    }
    ///Bit 4 - B196
    #[inline(always)]
    pub fn b196(&mut self) -> B196_W<VCTR6rs> {
        B196_W::new(self, 4)
    }
    ///Bit 5 - B197
    #[inline(always)]
    pub fn b197(&mut self) -> B197_W<VCTR6rs> {
        B197_W::new(self, 5)
    }
    ///Bit 6 - B198
    #[inline(always)]
    pub fn b198(&mut self) -> B198_W<VCTR6rs> {
        B198_W::new(self, 6)
    }
    ///Bit 7 - B199
    #[inline(always)]
    pub fn b199(&mut self) -> B199_W<VCTR6rs> {
        B199_W::new(self, 7)
    }
    ///Bit 8 - B200
    #[inline(always)]
    pub fn b200(&mut self) -> B200_W<VCTR6rs> {
        B200_W::new(self, 8)
    }
    ///Bit 9 - B201
    #[inline(always)]
    pub fn b201(&mut self) -> B201_W<VCTR6rs> {
        B201_W::new(self, 9)
    }
    ///Bit 10 - B202
    #[inline(always)]
    pub fn b202(&mut self) -> B202_W<VCTR6rs> {
        B202_W::new(self, 10)
    }
    ///Bit 11 - B203
    #[inline(always)]
    pub fn b203(&mut self) -> B203_W<VCTR6rs> {
        B203_W::new(self, 11)
    }
    ///Bit 12 - B204
    #[inline(always)]
    pub fn b204(&mut self) -> B204_W<VCTR6rs> {
        B204_W::new(self, 12)
    }
    ///Bit 13 - B205
    #[inline(always)]
    pub fn b205(&mut self) -> B205_W<VCTR6rs> {
        B205_W::new(self, 13)
    }
    ///Bit 14 - B206
    #[inline(always)]
    pub fn b206(&mut self) -> B206_W<VCTR6rs> {
        B206_W::new(self, 14)
    }
    ///Bit 15 - B207
    #[inline(always)]
    pub fn b207(&mut self) -> B207_W<VCTR6rs> {
        B207_W::new(self, 15)
    }
    ///Bit 16 - B208
    #[inline(always)]
    pub fn b208(&mut self) -> B208_W<VCTR6rs> {
        B208_W::new(self, 16)
    }
    ///Bit 17 - B209
    #[inline(always)]
    pub fn b209(&mut self) -> B209_W<VCTR6rs> {
        B209_W::new(self, 17)
    }
    ///Bit 18 - B210
    #[inline(always)]
    pub fn b210(&mut self) -> B210_W<VCTR6rs> {
        B210_W::new(self, 18)
    }
    ///Bit 19 - B211
    #[inline(always)]
    pub fn b211(&mut self) -> B211_W<VCTR6rs> {
        B211_W::new(self, 19)
    }
    ///Bit 20 - B212
    #[inline(always)]
    pub fn b212(&mut self) -> B212_W<VCTR6rs> {
        B212_W::new(self, 20)
    }
    ///Bit 21 - B213
    #[inline(always)]
    pub fn b213(&mut self) -> B213_W<VCTR6rs> {
        B213_W::new(self, 21)
    }
    ///Bit 22 - B214
    #[inline(always)]
    pub fn b214(&mut self) -> B214_W<VCTR6rs> {
        B214_W::new(self, 22)
    }
    ///Bit 23 - B215
    #[inline(always)]
    pub fn b215(&mut self) -> B215_W<VCTR6rs> {
        B215_W::new(self, 23)
    }
    ///Bit 24 - B216
    #[inline(always)]
    pub fn b216(&mut self) -> B216_W<VCTR6rs> {
        B216_W::new(self, 24)
    }
    ///Bit 25 - B217
    #[inline(always)]
    pub fn b217(&mut self) -> B217_W<VCTR6rs> {
        B217_W::new(self, 25)
    }
    ///Bit 26 - B218
    #[inline(always)]
    pub fn b218(&mut self) -> B218_W<VCTR6rs> {
        B218_W::new(self, 26)
    }
    ///Bit 27 - B219
    #[inline(always)]
    pub fn b219(&mut self) -> B219_W<VCTR6rs> {
        B219_W::new(self, 27)
    }
    ///Bit 28 - B220
    #[inline(always)]
    pub fn b220(&mut self) -> B220_W<VCTR6rs> {
        B220_W::new(self, 28)
    }
    ///Bit 29 - B221
    #[inline(always)]
    pub fn b221(&mut self) -> B221_W<VCTR6rs> {
        B221_W::new(self, 29)
    }
    ///Bit 30 - B222
    #[inline(always)]
    pub fn b222(&mut self) -> B222_W<VCTR6rs> {
        B222_W::new(self, 30)
    }
    ///Bit 31 - B223
    #[inline(always)]
    pub fn b223(&mut self) -> B223_W<VCTR6rs> {
        B223_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`vctr6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vctr6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#GTZC_MPCBB1:VCTR6)*/
pub struct VCTR6rs;
impl crate::RegisterSpec for VCTR6rs {
    type Ux = u32;
}
///`read()` method returns [`vctr6::R`](R) reader structure
impl crate::Readable for VCTR6rs {}
///`write(|w| ..)` method takes [`vctr6::W`](W) writer structure
impl crate::Writable for VCTR6rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets VCTR6 to value 0xffff_ffff
impl crate::Resettable for VCTR6rs {
