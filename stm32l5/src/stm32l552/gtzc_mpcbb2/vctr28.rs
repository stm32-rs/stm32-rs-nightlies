...
impl W {
    ///Bit 0 - B896
    #[inline(always)]
    pub fn b896(&mut self) -> B896_W<VCTR28rs> {
        B896_W::new(self, 0)
    }
    ///Bit 1 - B897
    #[inline(always)]
    pub fn b897(&mut self) -> B897_W<VCTR28rs> {
        B897_W::new(self, 1)
    }
    ///Bit 2 - B898
    #[inline(always)]
    pub fn b898(&mut self) -> B898_W<VCTR28rs> {
        B898_W::new(self, 2)
    }
    ///Bit 3 - B899
    #[inline(always)]
    pub fn b899(&mut self) -> B899_W<VCTR28rs> {
        B899_W::new(self, 3)
    }
    ///Bit 4 - B900
    #[inline(always)]
    pub fn b900(&mut self) -> B900_W<VCTR28rs> {
        B900_W::new(self, 4)
    }
    ///Bit 5 - B901
    #[inline(always)]
    pub fn b901(&mut self) -> B901_W<VCTR28rs> {
        B901_W::new(self, 5)
    }
    ///Bit 6 - B902
    #[inline(always)]
    pub fn b902(&mut self) -> B902_W<VCTR28rs> {
        B902_W::new(self, 6)
    }
    ///Bit 7 - B903
    #[inline(always)]
    pub fn b903(&mut self) -> B903_W<VCTR28rs> {
        B903_W::new(self, 7)
    }
    ///Bit 8 - B904
    #[inline(always)]
    pub fn b904(&mut self) -> B904_W<VCTR28rs> {
        B904_W::new(self, 8)
    }
    ///Bit 9 - B905
    #[inline(always)]
    pub fn b905(&mut self) -> B905_W<VCTR28rs> {
        B905_W::new(self, 9)
    }
    ///Bit 10 - B906
    #[inline(always)]
    pub fn b906(&mut self) -> B906_W<VCTR28rs> {
        B906_W::new(self, 10)
    }
    ///Bit 11 - B907
    #[inline(always)]
    pub fn b907(&mut self) -> B907_W<VCTR28rs> {
        B907_W::new(self, 11)
    }
    ///Bit 12 - B908
    #[inline(always)]
    pub fn b908(&mut self) -> B908_W<VCTR28rs> {
        B908_W::new(self, 12)
    }
    ///Bit 13 - B909
    #[inline(always)]
    pub fn b909(&mut self) -> B909_W<VCTR28rs> {
        B909_W::new(self, 13)
    }
    ///Bit 14 - B910
    #[inline(always)]
    pub fn b910(&mut self) -> B910_W<VCTR28rs> {
        B910_W::new(self, 14)
    }
    ///Bit 15 - B911
    #[inline(always)]
    pub fn b911(&mut self) -> B911_W<VCTR28rs> {
        B911_W::new(self, 15)
    }
    ///Bit 16 - B912
    #[inline(always)]
    pub fn b912(&mut self) -> B912_W<VCTR28rs> {
        B912_W::new(self, 16)
    }
    ///Bit 17 - B913
    #[inline(always)]
    pub fn b913(&mut self) -> B913_W<VCTR28rs> {
        B913_W::new(self, 17)
    }
    ///Bit 18 - B914
    #[inline(always)]
    pub fn b914(&mut self) -> B914_W<VCTR28rs> {
        B914_W::new(self, 18)
    }
    ///Bit 19 - B915
    #[inline(always)]
    pub fn b915(&mut self) -> B915_W<VCTR28rs> {
        B915_W::new(self, 19)
    }
    ///Bit 20 - B916
    #[inline(always)]
    pub fn b916(&mut self) -> B916_W<VCTR28rs> {
        B916_W::new(self, 20)
    }
    ///Bit 21 - B917
    #[inline(always)]
    pub fn b917(&mut self) -> B917_W<VCTR28rs> {
        B917_W::new(self, 21)
    }
    ///Bit 22 - B918
    #[inline(always)]
    pub fn b918(&mut self) -> B918_W<VCTR28rs> {
        B918_W::new(self, 22)
    }
    ///Bit 23 - B919
    #[inline(always)]
    pub fn b919(&mut self) -> B919_W<VCTR28rs> {
        B919_W::new(self, 23)
    }
    ///Bit 24 - B920
    #[inline(always)]
    pub fn b920(&mut self) -> B920_W<VCTR28rs> {
        B920_W::new(self, 24)
    }
    ///Bit 25 - B921
    #[inline(always)]
    pub fn b921(&mut self) -> B921_W<VCTR28rs> {
        B921_W::new(self, 25)
    }
    ///Bit 26 - B922
    #[inline(always)]
    pub fn b922(&mut self) -> B922_W<VCTR28rs> {
        B922_W::new(self, 26)
    }
    ///Bit 27 - B923
    #[inline(always)]
    pub fn b923(&mut self) -> B923_W<VCTR28rs> {
        B923_W::new(self, 27)
    }
    ///Bit 28 - B924
    #[inline(always)]
    pub fn b924(&mut self) -> B924_W<VCTR28rs> {
        B924_W::new(self, 28)
    }
    ///Bit 29 - B925
    #[inline(always)]
    pub fn b925(&mut self) -> B925_W<VCTR28rs> {
        B925_W::new(self, 29)
    }
    ///Bit 30 - B926
    #[inline(always)]
    pub fn b926(&mut self) -> B926_W<VCTR28rs> {
        B926_W::new(self, 30)
    }
    ///Bit 31 - B927
    #[inline(always)]
    pub fn b927(&mut self) -> B927_W<VCTR28rs> {
        B927_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#GTZC_MPCBB2:VCTR28)*/
pub struct VCTR28rs;
