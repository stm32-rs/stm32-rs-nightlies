...
impl W {
    ///Bit 0 - B1472
    #[inline(always)]
    pub fn b1472(&mut self) -> B1472_W<VCTR46rs> {
        B1472_W::new(self, 0)
    }
    ///Bit 1 - B1473
    #[inline(always)]
    pub fn b1473(&mut self) -> B1473_W<VCTR46rs> {
        B1473_W::new(self, 1)
    }
    ///Bit 2 - B1474
    #[inline(always)]
    pub fn b1474(&mut self) -> B1474_W<VCTR46rs> {
        B1474_W::new(self, 2)
    }
    ///Bit 3 - B1475
    #[inline(always)]
    pub fn b1475(&mut self) -> B1475_W<VCTR46rs> {
        B1475_W::new(self, 3)
    }
    ///Bit 4 - B1476
    #[inline(always)]
    pub fn b1476(&mut self) -> B1476_W<VCTR46rs> {
        B1476_W::new(self, 4)
    }
    ///Bit 5 - B1477
    #[inline(always)]
    pub fn b1477(&mut self) -> B1477_W<VCTR46rs> {
        B1477_W::new(self, 5)
    }
    ///Bit 6 - B1478
    #[inline(always)]
    pub fn b1478(&mut self) -> B1478_W<VCTR46rs> {
        B1478_W::new(self, 6)
    }
    ///Bit 7 - B1479
    #[inline(always)]
    pub fn b1479(&mut self) -> B1479_W<VCTR46rs> {
        B1479_W::new(self, 7)
    }
    ///Bit 8 - B1480
    #[inline(always)]
    pub fn b1480(&mut self) -> B1480_W<VCTR46rs> {
        B1480_W::new(self, 8)
    }
    ///Bit 9 - B1481
    #[inline(always)]
    pub fn b1481(&mut self) -> B1481_W<VCTR46rs> {
        B1481_W::new(self, 9)
    }
    ///Bit 10 - B1482
    #[inline(always)]
    pub fn b1482(&mut self) -> B1482_W<VCTR46rs> {
        B1482_W::new(self, 10)
    }
    ///Bit 11 - B1483
    #[inline(always)]
    pub fn b1483(&mut self) -> B1483_W<VCTR46rs> {
        B1483_W::new(self, 11)
    }
    ///Bit 12 - B1484
    #[inline(always)]
    pub fn b1484(&mut self) -> B1484_W<VCTR46rs> {
        B1484_W::new(self, 12)
    }
    ///Bit 13 - B1485
    #[inline(always)]
    pub fn b1485(&mut self) -> B1485_W<VCTR46rs> {
        B1485_W::new(self, 13)
    }
    ///Bit 14 - B1486
    #[inline(always)]
    pub fn b1486(&mut self) -> B1486_W<VCTR46rs> {
        B1486_W::new(self, 14)
    }
    ///Bit 15 - B1487
    #[inline(always)]
    pub fn b1487(&mut self) -> B1487_W<VCTR46rs> {
        B1487_W::new(self, 15)
    }
    ///Bit 16 - B1488
    #[inline(always)]
    pub fn b1488(&mut self) -> B1488_W<VCTR46rs> {
        B1488_W::new(self, 16)
    }
    ///Bit 17 - B1489
    #[inline(always)]
    pub fn b1489(&mut self) -> B1489_W<VCTR46rs> {
        B1489_W::new(self, 17)
    }
    ///Bit 18 - B1490
    #[inline(always)]
    pub fn b1490(&mut self) -> B1490_W<VCTR46rs> {
        B1490_W::new(self, 18)
    }
    ///Bit 19 - B1491
    #[inline(always)]
    pub fn b1491(&mut self) -> B1491_W<VCTR46rs> {
        B1491_W::new(self, 19)
    }
    ///Bit 20 - B1492
    #[inline(always)]
    pub fn b1492(&mut self) -> B1492_W<VCTR46rs> {
        B1492_W::new(self, 20)
    }
    ///Bit 21 - B1493
    #[inline(always)]
    pub fn b1493(&mut self) -> B1493_W<VCTR46rs> {
        B1493_W::new(self, 21)
    }
    ///Bit 22 - B1494
    #[inline(always)]
    pub fn b1494(&mut self) -> B1494_W<VCTR46rs> {
        B1494_W::new(self, 22)
    }
    ///Bit 23 - B1495
    #[inline(always)]
    pub fn b1495(&mut self) -> B1495_W<VCTR46rs> {
        B1495_W::new(self, 23)
    }
    ///Bit 24 - B1496
    #[inline(always)]
    pub fn b1496(&mut self) -> B1496_W<VCTR46rs> {
        B1496_W::new(self, 24)
    }
    ///Bit 25 - B1497
    #[inline(always)]
    pub fn b1497(&mut self) -> B1497_W<VCTR46rs> {
        B1497_W::new(self, 25)
    }
    ///Bit 26 - B1498
    #[inline(always)]
    pub fn b1498(&mut self) -> B1498_W<VCTR46rs> {
        B1498_W::new(self, 26)
    }
    ///Bit 27 - B1499
    #[inline(always)]
    pub fn b1499(&mut self) -> B1499_W<VCTR46rs> {
        B1499_W::new(self, 27)
    }
    ///Bit 28 - B1500
    #[inline(always)]
    pub fn b1500(&mut self) -> B1500_W<VCTR46rs> {
        B1500_W::new(self, 28)
    }
    ///Bit 29 - B1501
    #[inline(always)]
    pub fn b1501(&mut self) -> B1501_W<VCTR46rs> {
        B1501_W::new(self, 29)
    }
    ///Bit 30 - B1502
    #[inline(always)]
    pub fn b1502(&mut self) -> B1502_W<VCTR46rs> {
        B1502_W::new(self, 30)
    }
    ///Bit 31 - B1503
    #[inline(always)]
    pub fn b1503(&mut self) -> B1503_W<VCTR46rs> {
        B1503_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#GTZC_MPCBB2:VCTR46)*/
pub struct VCTR46rs;
