...
impl W {
    ///Bit 0 - B256
    #[inline(always)]
    pub fn b256(&mut self) -> B256_W<'_, VCTR8rs> {
        B256_W::new(self, 0)
    }
    ///Bit 1 - B257
    #[inline(always)]
    pub fn b257(&mut self) -> B257_W<'_, VCTR8rs> {
        B257_W::new(self, 1)
    }
    ///Bit 2 - B258
    #[inline(always)]
    pub fn b258(&mut self) -> B258_W<'_, VCTR8rs> {
        B258_W::new(self, 2)
    }
    ///Bit 3 - B259
    #[inline(always)]
    pub fn b259(&mut self) -> B259_W<'_, VCTR8rs> {
        B259_W::new(self, 3)
    }
    ///Bit 4 - B260
    #[inline(always)]
    pub fn b260(&mut self) -> B260_W<'_, VCTR8rs> {
        B260_W::new(self, 4)
    }
    ///Bit 5 - B261
    #[inline(always)]
    pub fn b261(&mut self) -> B261_W<'_, VCTR8rs> {
        B261_W::new(self, 5)
    }
    ///Bit 6 - B262
    #[inline(always)]
    pub fn b262(&mut self) -> B262_W<'_, VCTR8rs> {
        B262_W::new(self, 6)
    }
    ///Bit 7 - B263
    #[inline(always)]
    pub fn b263(&mut self) -> B263_W<'_, VCTR8rs> {
        B263_W::new(self, 7)
    }
    ///Bit 8 - B264
    #[inline(always)]
    pub fn b264(&mut self) -> B264_W<'_, VCTR8rs> {
        B264_W::new(self, 8)
    }
    ///Bit 9 - B265
    #[inline(always)]
    pub fn b265(&mut self) -> B265_W<'_, VCTR8rs> {
        B265_W::new(self, 9)
    }
    ///Bit 10 - B266
    #[inline(always)]
    pub fn b266(&mut self) -> B266_W<'_, VCTR8rs> {
        B266_W::new(self, 10)
    }
    ///Bit 11 - B267
    #[inline(always)]
    pub fn b267(&mut self) -> B267_W<'_, VCTR8rs> {
        B267_W::new(self, 11)
    }
    ///Bit 12 - B268
    #[inline(always)]
    pub fn b268(&mut self) -> B268_W<'_, VCTR8rs> {
        B268_W::new(self, 12)
    }
    ///Bit 13 - B269
    #[inline(always)]
    pub fn b269(&mut self) -> B269_W<'_, VCTR8rs> {
        B269_W::new(self, 13)
    }
    ///Bit 14 - B270
    #[inline(always)]
    pub fn b270(&mut self) -> B270_W<'_, VCTR8rs> {
        B270_W::new(self, 14)
    }
    ///Bit 15 - B271
    #[inline(always)]
    pub fn b271(&mut self) -> B271_W<'_, VCTR8rs> {
        B271_W::new(self, 15)
    }
    ///Bit 16 - B272
    #[inline(always)]
    pub fn b272(&mut self) -> B272_W<'_, VCTR8rs> {
        B272_W::new(self, 16)
    }
    ///Bit 17 - B273
    #[inline(always)]
    pub fn b273(&mut self) -> B273_W<'_, VCTR8rs> {
        B273_W::new(self, 17)
    }
    ///Bit 18 - B274
    #[inline(always)]
    pub fn b274(&mut self) -> B274_W<'_, VCTR8rs> {
        B274_W::new(self, 18)
    }
    ///Bit 19 - B275
    #[inline(always)]
    pub fn b275(&mut self) -> B275_W<'_, VCTR8rs> {
        B275_W::new(self, 19)
    }
    ///Bit 20 - B276
    #[inline(always)]
    pub fn b276(&mut self) -> B276_W<'_, VCTR8rs> {
        B276_W::new(self, 20)
    }
    ///Bit 21 - B277
    #[inline(always)]
    pub fn b277(&mut self) -> B277_W<'_, VCTR8rs> {
        B277_W::new(self, 21)
    }
    ///Bit 22 - B278
    #[inline(always)]
    pub fn b278(&mut self) -> B278_W<'_, VCTR8rs> {
        B278_W::new(self, 22)
    }
    ///Bit 23 - B279
    #[inline(always)]
    pub fn b279(&mut self) -> B279_W<'_, VCTR8rs> {
        B279_W::new(self, 23)
    }
    ///Bit 24 - B280
    #[inline(always)]
    pub fn b280(&mut self) -> B280_W<'_, VCTR8rs> {
        B280_W::new(self, 24)
    }
    ///Bit 25 - B281
    #[inline(always)]
    pub fn b281(&mut self) -> B281_W<'_, VCTR8rs> {
        B281_W::new(self, 25)
    }
    ///Bit 26 - B282
    #[inline(always)]
    pub fn b282(&mut self) -> B282_W<'_, VCTR8rs> {
        B282_W::new(self, 26)
    }
    ///Bit 27 - B283
    #[inline(always)]
    pub fn b283(&mut self) -> B283_W<'_, VCTR8rs> {
        B283_W::new(self, 27)
    }
    ///Bit 28 - B284
    #[inline(always)]
    pub fn b284(&mut self) -> B284_W<'_, VCTR8rs> {
        B284_W::new(self, 28)
    }
    ///Bit 29 - B285
    #[inline(always)]
    pub fn b285(&mut self) -> B285_W<'_, VCTR8rs> {
        B285_W::new(self, 29)
    }
    ///Bit 30 - B286
    #[inline(always)]
    pub fn b286(&mut self) -> B286_W<'_, VCTR8rs> {
        B286_W::new(self, 30)
    }
    ///Bit 31 - B287
    #[inline(always)]
    pub fn b287(&mut self) -> B287_W<'_, VCTR8rs> {
        B287_W::new(self, 31)
    }
}
