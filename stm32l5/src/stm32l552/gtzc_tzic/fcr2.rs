...
impl W {
    ///Bit 0 - TIM8FC
    #[inline(always)]
    pub fn tim8fc(&mut self) -> TIM8FC_W<FCR2rs> {
        TIM8FC_W::new(self, 0)
    }
    ///Bit 1 - USART1FC
    #[inline(always)]
    pub fn usart1fc(&mut self) -> USART1FC_W<FCR2rs> {
        USART1FC_W::new(self, 1)
    }
    ///Bit 2 - TIM15FC
    #[inline(always)]
    pub fn tim15fc(&mut self) -> TIM15FC_W<FCR2rs> {
        TIM15FC_W::new(self, 2)
    }
    ///Bit 3 - TIM16FC
    #[inline(always)]
    pub fn tim16fc(&mut self) -> TIM16FC_W<FCR2rs> {
        TIM16FC_W::new(self, 3)
    }
    ///Bit 4 - TIM17FC
    #[inline(always)]
    pub fn tim17fc(&mut self) -> TIM17FC_W<FCR2rs> {
        TIM17FC_W::new(self, 4)
    }
    ///Bit 5 - SAI1FC
    #[inline(always)]
    pub fn sai1fc(&mut self) -> SAI1FC_W<FCR2rs> {
        SAI1FC_W::new(self, 5)
    }
    ///Bit 6 - SAI2FC
    #[inline(always)]
    pub fn sai2fc(&mut self) -> SAI2FC_W<FCR2rs> {
        SAI2FC_W::new(self, 6)
    }
    ///Bit 7 - DFSDM1FC
    #[inline(always)]
    pub fn dfsdm1fc(&mut self) -> DFSDM1FC_W<FCR2rs> {
        DFSDM1FC_W::new(self, 7)
    }
    ///Bit 8 - CRCFC
    #[inline(always)]
    pub fn crcfc(&mut self) -> CRCFC_W<FCR2rs> {
        CRCFC_W::new(self, 8)
    }
    ///Bit 9 - TSCFC
    #[inline(always)]
    pub fn tscfc(&mut self) -> TSCFC_W<FCR2rs> {
        TSCFC_W::new(self, 9)
    }
    ///Bit 10 - ICACHEFC
    #[inline(always)]
    pub fn icachefc(&mut self) -> ICACHEFC_W<FCR2rs> {
        ICACHEFC_W::new(self, 10)
    }
    ///Bit 11 - ADCFC
    #[inline(always)]
    pub fn adcfc(&mut self) -> ADCFC_W<FCR2rs> {
        ADCFC_W::new(self, 11)
    }
    ///Bit 12 - AESFC
    #[inline(always)]
    pub fn aesfc(&mut self) -> AESFC_W<FCR2rs> {
        AESFC_W::new(self, 12)
    }
    ///Bit 13 - HASHFC
    #[inline(always)]
    pub fn hashfc(&mut self) -> HASHFC_W<FCR2rs> {
        HASHFC_W::new(self, 13)
    }
    ///Bit 14 - RNGFC
    #[inline(always)]
    pub fn rngfc(&mut self) -> RNGFC_W<FCR2rs> {
        RNGFC_W::new(self, 14)
    }
    ///Bit 15 - PKAFC
    #[inline(always)]
    pub fn pkafc(&mut self) -> PKAFC_W<FCR2rs> {
        PKAFC_W::new(self, 15)
    }
    ///Bit 16 - SDMMC1FC
    #[inline(always)]
    pub fn sdmmc1fc(&mut self) -> SDMMC1FC_W<FCR2rs> {
        SDMMC1FC_W::new(self, 16)
    }
    ///Bit 17 - FMC_REGFC
    #[inline(always)]
    pub fn fmc_regfc(&mut self) -> FMC_REGFC_W<FCR2rs> {
        FMC_REGFC_W::new(self, 17)
    }
    ///Bit 18 - OCTOSPI1_REGFC
    #[inline(always)]
    pub fn octospi1_regfc(&mut self) -> OCTOSPI1_REGFC_W<FCR2rs> {
        OCTOSPI1_REGFC_W::new(self, 18)
    }
    ///Bit 19 - RTCFC
    #[inline(always)]
    pub fn rtcfc(&mut self) -> RTCFC_W<FCR2rs> {
        RTCFC_W::new(self, 19)
    }
    ///Bit 20 - PWRFC
    #[inline(always)]
    pub fn pwrfc(&mut self) -> PWRFC_W<FCR2rs> {
        PWRFC_W::new(self, 20)
    }
    ///Bit 21 - SYSCFGFC
    #[inline(always)]
    pub fn syscfgfc(&mut self) -> SYSCFGFC_W<FCR2rs> {
        SYSCFGFC_W::new(self, 21)
    }
    ///Bit 22 - DMA1FC
    #[inline(always)]
    pub fn dma1fc(&mut self) -> DMA1FC_W<FCR2rs> {
        DMA1FC_W::new(self, 22)
    }
    ///Bit 23 - DMA2FC
    #[inline(always)]
    pub fn dma2fc(&mut self) -> DMA2FC_W<FCR2rs> {
        DMA2FC_W::new(self, 23)
    }
    ///Bit 24 - DMAMUX1FC
    #[inline(always)]
    pub fn dmamux1fc(&mut self) -> DMAMUX1FC_W<FCR2rs> {
        DMAMUX1FC_W::new(self, 24)
    }
    ///Bit 25 - RCCFC
    #[inline(always)]
    pub fn rccfc(&mut self) -> RCCFC_W<FCR2rs> {
        RCCFC_W::new(self, 25)
    }
    ///Bit 26 - FLASHFC
    #[inline(always)]
    pub fn flashfc(&mut self) -> FLASHFC_W<FCR2rs> {
        FLASHFC_W::new(self, 26)
    }
    ///Bit 27 - FLASH_REGFC
    #[inline(always)]
    pub fn flash_regfc(&mut self) -> FLASH_REGFC_W<FCR2rs> {
        FLASH_REGFC_W::new(self, 27)
    }
    ///Bit 28 - EXTIFC
    #[inline(always)]
    pub fn extifc(&mut self) -> EXTIFC_W<FCR2rs> {
        EXTIFC_W::new(self, 28)
    }
    ///Bit 29 - OTFDEC1FC
    #[inline(always)]
    pub fn otfdec1fc(&mut self) -> OTFDEC1FC_W<FCR2rs> {
