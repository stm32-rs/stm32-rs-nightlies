...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dacie(&mut self) -> DACIE_W<IER1rs> {
        DACIE_W::new(self, 18)
    }
    ///Bit 19 - OPAMPIE
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbfsie(&mut self) -> USBFSIE_W<IER1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim1ie(&mut self) -> TIM1IE_W<IER1rs> {
        TIM1IE_W::new(self, 30)
    }
    ///Bit 31 - SPI1IE
    #[inline(always)]
    #[must_use]
    pub fn spi1ie(&mut self) -> SPI1IE_W<IER1rs> {
