...
impl W {
    ///Bits 0:10 - NSWM1STRT
    #[inline(always)]
    pub fn nswm1strt(&mut self) -> NSWM1STRT_W<'_, MPCWM1_NSWMR1rs> {
        NSWM1STRT_W::new(self, 0)
    }
    ///Bits 16:27 - NSWM1LGTH
    #[inline(always)]
    pub fn nswm1lgth(&mut self) -> NSWM1LGTH_W<'_, MPCWM1_NSWMR1rs> {
        NSWM1LGTH_W::new(self, 16)
    }
}
/**TZSC external memory non-secure watermark register 1

You can [`read`](crate::Reg::read) this register and get [`mpcwm1_nswmr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcwm1_nswmr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
