...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nswm2strt(&mut self) -> NSWM2STRT_W<MPCWM1_NSWMR2rs> {
        NSWM2STRT_W::new(self, 0)
    }
    #[doc = "Bits 16:27 - NSWM2LGTH"]
    #[inline(always)]
    #[must_use]
    pub fn nswm2lgth(&mut self) -> NSWM2LGTH_W<MPCWM1_NSWMR2rs> {
        NSWM2LGTH_W::new(self, 16)
    }
}
#[doc = "TZSC external memory non-secure watermark register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcwm1_nswmr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcwm1_nswmr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
