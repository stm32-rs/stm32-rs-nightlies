...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nswm1strt(&mut self) -> NSWM1STRT_W<MPCWM2_NSWMR1rs> {
        NSWM1STRT_W::new(self, 0)
    }
    #[doc = "Bits 16:27 - NSWM1LGTH"]
    #[inline(always)]
    #[must_use]
    pub fn nswm1lgth(&mut self) -> NSWM1LGTH_W<MPCWM2_NSWMR1rs> {
        NSWM1LGTH_W::new(self, 16)
    }
}
#[doc = "TZSC external memory non-secure watermark register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcwm2_nswmr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcwm2_nswmr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
