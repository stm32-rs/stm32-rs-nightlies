...
pub type DACPRIV_R = crate::BitReader;
///Field `DACPRIV` writer - DACPRIV
pub type DACPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    pub fn spi3priv(&mut self) -> SPI3PRIV_W<PRIVCFGR1rs> {
        SPI3PRIV_W::new(self, 9)
    }
    ///Bit 10 - USART2PRIV
    #[inline(always)]
    pub fn usart2priv(&mut self) -> USART2PRIV_W<PRIVCFGR1rs> {
        USART2PRIV_W::new(self, 10)
    }
    ///Bit 11 - USART3PRIV
    #[inline(always)]
    pub fn usart3priv(&mut self) -> USART3PRIV_W<PRIVCFGR1rs> {
        USART3PRIV_W::new(self, 11)
    }
    ///Bit 12 - UART4PRIV
    #[inline(always)]
    pub fn uart4priv(&mut self) -> UART4PRIV_W<PRIVCFGR1rs> {
        UART4PRIV_W::new(self, 12)
    }
    ///Bit 13 - UART5PRIV
    #[inline(always)]
    pub fn uart5priv(&mut self) -> UART5PRIV_W<PRIVCFGR1rs> {
        UART5PRIV_W::new(self, 13)
    }
    ///Bit 14 - I2C1PRIV
    #[inline(always)]
    pub fn i2c1priv(&mut self) -> I2C1PRIV_W<PRIVCFGR1rs> {
        I2C1PRIV_W::new(self, 14)
    }
    ///Bit 15 - I2C2PRIV
    #[inline(always)]
    pub fn i2c2priv(&mut self) -> I2C2PRIV_W<PRIVCFGR1rs> {
        I2C2PRIV_W::new(self, 15)
    }
    ///Bit 16 - I2C3PRIV
    #[inline(always)]
    pub fn i2c3priv(&mut self) -> I2C3PRIV_W<PRIVCFGR1rs> {
        I2C3PRIV_W::new(self, 16)
    }
    ///Bit 17 - CRSPRIV
    #[inline(always)]
    pub fn crspriv(&mut self) -> CRSPRIV_W<PRIVCFGR1rs> {
        CRSPRIV_W::new(self, 17)
    }
    ///Bit 18 - DACPRIV
    #[inline(always)]
    pub fn dacpriv(&mut self) -> DACPRIV_W<PRIVCFGR1rs> {
        DACPRIV_W::new(self, 18)
    }
    ///Bit 19 - OPAMPPRIV
    #[inline(always)]
    pub fn opamppriv(&mut self) -> OPAMPPRIV_W<PRIVCFGR1rs> {
        OPAMPPRIV_W::new(self, 19)
    }
    ///Bit 20 - LPTIM1PRIV
    #[inline(always)]
    pub fn lptim1priv(&mut self) -> LPTIM1PRIV_W<PRIVCFGR1rs> {
        LPTIM1PRIV_W::new(self, 20)
    }
    ///Bit 21 - LPUART1PRIV
    #[inline(always)]
    pub fn lpuart1priv(&mut self) -> LPUART1PRIV_W<PRIVCFGR1rs> {
        LPUART1PRIV_W::new(self, 21)
    }
    ///Bit 22 - I2C4PRIV
    #[inline(always)]
    pub fn i2c4priv(&mut self) -> I2C4PRIV_W<PRIVCFGR1rs> {
        I2C4PRIV_W::new(self, 22)
    }
    ///Bit 23 - LPTIM2PRIV
    #[inline(always)]
    pub fn lptim2priv(&mut self) -> LPTIM2PRIV_W<PRIVCFGR1rs> {
        LPTIM2PRIV_W::new(self, 23)
    }
    ///Bit 24 - LPTIM3PRIV
    #[inline(always)]
    pub fn lptim3priv(&mut self) -> LPTIM3PRIV_W<PRIVCFGR1rs> {
        LPTIM3PRIV_W::new(self, 24)
    }
    ///Bit 25 - FDCAN1PRIV
    #[inline(always)]
    pub fn fdcan1priv(&mut self) -> FDCAN1PRIV_W<PRIVCFGR1rs> {
        FDCAN1PRIV_W::new(self, 25)
    }
    ///Bit 26 - USBFSPRIV
    #[inline(always)]
    pub fn usbfspriv(&mut self) -> USBFSPRIV_W<PRIVCFGR1rs> {
        USBFSPRIV_W::new(self, 26)
    }
    ///Bit 27 - UCPD1PRIV
    #[inline(always)]
    pub fn ucpd1priv(&mut self) -> UCPD1PRIV_W<PRIVCFGR1rs> {
        UCPD1PRIV_W::new(self, 27)
    }
    ///Bit 28 - VREFBUFPRIV
    #[inline(always)]
    pub fn vrefbufpriv(&mut self) -> VREFBUFPRIV_W<PRIVCFGR1rs> {
        VREFBUFPRIV_W::new(self, 28)
    }
    ///Bit 29 - COMPPRIV
    #[inline(always)]
    pub fn comppriv(&mut self) -> COMPPRIV_W<PRIVCFGR1rs> {
        COMPPRIV_W::new(self, 29)
    }
    ///Bit 30 - TIM1PRIV
    #[inline(always)]
    pub fn tim1priv(&mut self) -> TIM1PRIV_W<PRIVCFGR1rs> {
        TIM1PRIV_W::new(self, 30)
    }
    ///Bit 31 - SPI1PRIV
    #[inline(always)]
    pub fn spi1priv(&mut self) -> SPI1PRIV_W<PRIVCFGR1rs> {
        SPI1PRIV_W::new(self, 31)
    }
}
