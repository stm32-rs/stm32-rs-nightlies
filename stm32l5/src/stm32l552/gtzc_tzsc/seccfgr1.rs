...
impl W {
    ...
    ///Bit 16 - I2C3SEC
    #[inline(always)]
    pub fn i2c3sec(&mut self) -> I2C3SEC_W<'_, SECCFGR1rs> {
    ...
    ///Bit 18 - DACSEC
    #[inline(always)]
    pub fn dacsec(&mut self) -> DACSEC_W<'_, SECCFGR1rs> {
        DACSEC_W::new(self, 18)
    }
    ///Bit 19 - OPAMPSEC
    #[inline(always)]
    pub fn opampsec(&mut self) -> OPAMPSEC_W<'_, SECCFGR1rs> {
        OPAMPSEC_W::new(self, 19)
    }
    ///Bit 20 - LPTIM1SEC
    #[inline(always)]
    pub fn lptim1sec(&mut self) -> LPTIM1SEC_W<'_, SECCFGR1rs> {
        LPTIM1SEC_W::new(self, 20)
    }
    ///Bit 21 - LPUART1SEC
    #[inline(always)]
    pub fn lpuart1sec(&mut self) -> LPUART1SEC_W<'_, SECCFGR1rs> {
    ...
    ///Bit 24 - LPTIM3SEC
    #[inline(always)]
    pub fn lptim3sec(&mut self) -> LPTIM3SEC_W<'_, SECCFGR1rs> {
    ...
    ///Bit 26 - USBFSSEC
    #[inline(always)]
    pub fn usbfssec(&mut self) -> USBFSSEC_W<'_, SECCFGR1rs> {
    ...
    ///Bit 28 - VREFBUFSEC
    #[inline(always)]
    pub fn vrefbufsec(&mut self) -> VREFBUFSEC_W<'_, SECCFGR1rs> {
        VREFBUFSEC_W::new(self, 28)
    }
    ///Bit 29 - COMPSEC
    #[inline(always)]
    pub fn compsec(&mut self) -> COMPSEC_W<'_, SECCFGR1rs> {
        COMPSEC_W::new(self, 29)
    }
    ///Bit 30 - TIM1SEC
    #[inline(always)]
    pub fn tim1sec(&mut self) -> TIM1SEC_W<'_, SECCFGR1rs> {
        TIM1SEC_W::new(self, 30)
    }
    ///Bit 31 - SPI1SEC
    #[inline(always)]
    pub fn spi1sec(&mut self) -> SPI1SEC_W<'_, SECCFGR1rs> {
