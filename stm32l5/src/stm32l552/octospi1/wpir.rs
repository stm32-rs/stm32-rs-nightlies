#[doc = "Reader of register WPIR"]
pub type R = crate::R<u32, super::WPIR>;
#[doc = "Writer for register WPIR"]
pub type W = crate::W<u32, super::WPIR>;
#[doc = "Register WPIR `reset()`'s with value 0"]
impl crate::ResetValue for super::WPIR {
    type Type = u32;
    #[inline(always)]
