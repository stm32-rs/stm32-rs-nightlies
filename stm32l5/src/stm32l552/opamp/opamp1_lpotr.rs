#[doc = "Reader of register OPAMP1_LPOTR"]
pub type R = crate::R<u32, super::OPAMP1_LPOTR>;
#[doc = "Writer for register OPAMP1_LPOTR"]
pub type W = crate::W<u32, super::OPAMP1_LPOTR>;
#[doc = "Register OPAMP1_LPOTR `reset()`'s with value 0"]
impl crate::ResetValue for super::OPAMP1_LPOTR {
    type Type = u32;
    #[inline(always)]
