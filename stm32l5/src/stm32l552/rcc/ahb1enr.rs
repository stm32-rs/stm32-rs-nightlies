...
impl W {
    ...
    ///Bit 22 - GTZCEN
    #[inline(always)]
    pub fn gtzcen(&mut self) -> GTZCEN_W<'_, AHB1ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#RCC:AHB1ENR)*/
