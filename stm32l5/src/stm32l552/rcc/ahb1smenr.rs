...
pub type GTZCSMEN_R = crate::BitReader;
///Field `GTZCSMEN` writer - GTZCSMEN
pub type GTZCSMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    ///Bit 22 - GTZCSMEN
    #[inline(always)]
    pub fn gtzcsmen(&mut self) -> GTZCSMEN_W<'_, AHB1SMENRrs> {
        GTZCSMEN_W::new(self, 22)
    }
    ///Bit 23 - ICACHESMEN
    #[inline(always)]
    pub fn icachesmen(&mut self) -> ICACHESMEN_W<'_, AHB1SMENRrs> {
        ICACHESMEN_W::new(self, 23)
    }
}
...
impl crate::Resettable for AHB1SMENRrs {
    const RESET_VALUE: u32 = 0x00c1_1307;
}
