...
pub struct GTZCSMEN_R(crate::FieldReader<bool, bool>);
impl GTZCSMEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        GTZCSMEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GTZCSMEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct ICACHESMEN_R(crate::FieldReader<bool, bool>);
impl ICACHESMEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        ICACHESMEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICACHESMEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
