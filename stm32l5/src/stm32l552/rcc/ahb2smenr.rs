...
///Field `PKASMEN` reader - PKASMEN
pub type PKASMEN_R = crate::BitReader;
///Field `PKASMEN` writer - PKASMEN
pub type PKASMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OTFDEC1SMEN` reader - OTFDEC1SMEN
pub type OTFDEC1SMEN_R = crate::BitReader;
///Field `OTFDEC1SMEN` writer - OTFDEC1SMEN
...
impl W {
    ...
    ///Bit 21 - OTFDEC1SMEN
    #[inline(always)]
    pub fn otfdec1smen(&mut self) -> OTFDEC1SMEN_W<'_, AHB2SMENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#RCC:AHB2SMENR)*/
...
///`reset()` method sets AHB2SMENR to value 0x006f_22ff
