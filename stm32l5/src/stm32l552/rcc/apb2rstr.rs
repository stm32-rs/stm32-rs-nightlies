...
pub type TIM8RST_R = SYSCFGRST_R;
...
pub type SAI1RST_R = SYSCFGRST_R;
...
pub type SAI2RST_A = SYSCFGRST_A;
#[doc = "Field `SAI2RST` reader - Serial audio interface 2 (SAI2) reset"]
pub type SAI2RST_R = SYSCFGRST_R;
