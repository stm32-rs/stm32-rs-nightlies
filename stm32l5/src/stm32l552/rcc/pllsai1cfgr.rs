...
///Field `PLLSAI1SRC` reader - PLLSAI1SRC
pub type PLLSAI1SRC_R = crate::FieldReader;
///Field `PLLSAI1SRC` writer - PLLSAI1SRC
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PLLSAI1CFGR")
            ...
            .field("pllsai1src", &self.pllsai1src())
            .finish()
    }
}
impl W {
    ///Bits 0:1 - PLLSAI1SRC
    #[inline(always)]
    pub fn pllsai1src(&mut self) -> PLLSAI1SRC_W<'_, PLLSAI1CFGRrs> {
        PLLSAI1SRC_W::new(self, 0)
    }
    ///Bits 4:7 - Division factor for PLLSAI1 input clock
    #[inline(always)]
    pub fn pllsai1m(&mut self) -> PLLSAI1M_W<'_, PLLSAI1CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#RCC:PLLSAI1CFGR)*/
