...
pub struct RegisterBlock {
    ...
    pub sdmmc_idmabase0r: crate::Reg<sdmmc_idmabase0r::SDMMC_IDMABASE0R_SPEC>,
    #[doc = "0x5c - The SDMMC_IDMABASE1R register contains the double buffer configuration second buffer memory base address."]
    pub sdmmc_idmabase1r: crate::Reg<sdmmc_idmabase1r::SDMMC_IDMABASE1R_SPEC>,
    _reserved21: [u8; 0x20],
    ...
    pub sdmmc_fifor: crate::Reg<sdmmc_fifor::SDMMC_FIFOR_SPEC>,
    _reserved22: [u8; 0x0370],
    #[doc = "0x3f4 - SDMMC IP version register"]
    pub sdmmc_ver: crate::Reg<sdmmc_ver::SDMMC_VER_SPEC>,
    #[doc = "0x3f8 - SDMMC IP identification register"]
    pub sdmmc_id: crate::Reg<sdmmc_id::SDMMC_ID_SPEC>,
}
...
#[doc = "SDMMC_IDMABASE0R register accessor: an alias for `Reg<SDMMC_IDMABASE0R_SPEC>`"]
...
#[doc = "SDMMC_IDMABASE1R register accessor: an alias for `Reg<SDMMC_IDMABASE1R_SPEC>`"]
...
#[doc = "SDMMC_FIFOR register accessor: an alias for `Reg<SDMMC_FIFOR_SPEC>`"]
...
pub mod sdmmc_fifor;
#[doc = "SDMMC_VER register accessor: an alias for `Reg<SDMMC_VER_SPEC>`"]
pub type SDMMC_VER = crate::Reg<sdmmc_ver::SDMMC_VER_SPEC>;
#[doc = "SDMMC IP version register"]
pub mod sdmmc_ver;
#[doc = "SDMMC_ID register accessor: an alias for `Reg<SDMMC_ID_SPEC>`"]
