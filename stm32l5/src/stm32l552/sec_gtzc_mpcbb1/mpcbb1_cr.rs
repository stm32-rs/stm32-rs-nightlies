#[doc = "Reader of register MPCBB1_CR"]
pub type R = crate::R<u32, super::MPCBB1_CR>;
#[doc = "Writer for register MPCBB1_CR"]
pub type W = crate::W<u32, super::MPCBB1_CR>;
#[doc = "Register MPCBB1_CR `reset()`'s with value 0"]
impl crate::ResetValue for super::MPCBB1_CR {
    type Type = u32;
    #[inline(always)]
