///Register `MPCBB1_VCTR22` reader
pub type R = crate::R<MPCBB1_VCTR22rs>;
///Register `MPCBB1_VCTR22` writer
pub type W = crate::W<MPCBB1_VCTR22rs>;
...
impl W {
    ///Bit 0 - B704
    #[inline(always)]
    pub fn b704(&mut self) -> B704_W<MPCBB1_VCTR22rs> {
        B704_W::new(self, 0)
    }
    ///Bit 1 - B705
    #[inline(always)]
    pub fn b705(&mut self) -> B705_W<MPCBB1_VCTR22rs> {
        B705_W::new(self, 1)
    }
    ///Bit 2 - B706
    #[inline(always)]
    pub fn b706(&mut self) -> B706_W<MPCBB1_VCTR22rs> {
        B706_W::new(self, 2)
    }
    ///Bit 3 - B707
    #[inline(always)]
    pub fn b707(&mut self) -> B707_W<MPCBB1_VCTR22rs> {
        B707_W::new(self, 3)
    }
    ///Bit 4 - B708
    #[inline(always)]
    pub fn b708(&mut self) -> B708_W<MPCBB1_VCTR22rs> {
        B708_W::new(self, 4)
    }
    ///Bit 5 - B709
    #[inline(always)]
    pub fn b709(&mut self) -> B709_W<MPCBB1_VCTR22rs> {
        B709_W::new(self, 5)
    }
    ///Bit 6 - B710
    #[inline(always)]
    pub fn b710(&mut self) -> B710_W<MPCBB1_VCTR22rs> {
        B710_W::new(self, 6)
    }
    ///Bit 7 - B711
    #[inline(always)]
    pub fn b711(&mut self) -> B711_W<MPCBB1_VCTR22rs> {
        B711_W::new(self, 7)
    }
    ///Bit 8 - B712
    #[inline(always)]
    pub fn b712(&mut self) -> B712_W<MPCBB1_VCTR22rs> {
        B712_W::new(self, 8)
    }
    ///Bit 9 - B713
    #[inline(always)]
    pub fn b713(&mut self) -> B713_W<MPCBB1_VCTR22rs> {
        B713_W::new(self, 9)
    }
    ///Bit 10 - B714
    #[inline(always)]
    pub fn b714(&mut self) -> B714_W<MPCBB1_VCTR22rs> {
        B714_W::new(self, 10)
    }
    ///Bit 11 - B715
    #[inline(always)]
    pub fn b715(&mut self) -> B715_W<MPCBB1_VCTR22rs> {
        B715_W::new(self, 11)
    }
    ///Bit 12 - B716
    #[inline(always)]
    pub fn b716(&mut self) -> B716_W<MPCBB1_VCTR22rs> {
        B716_W::new(self, 12)
    }
    ///Bit 13 - B717
    #[inline(always)]
    pub fn b717(&mut self) -> B717_W<MPCBB1_VCTR22rs> {
        B717_W::new(self, 13)
    }
    ///Bit 14 - B718
    #[inline(always)]
    pub fn b718(&mut self) -> B718_W<MPCBB1_VCTR22rs> {
        B718_W::new(self, 14)
    }
    ///Bit 15 - B719
    #[inline(always)]
    pub fn b719(&mut self) -> B719_W<MPCBB1_VCTR22rs> {
        B719_W::new(self, 15)
    }
    ///Bit 16 - B720
    #[inline(always)]
    pub fn b720(&mut self) -> B720_W<MPCBB1_VCTR22rs> {
        B720_W::new(self, 16)
    }
    ///Bit 17 - B721
    #[inline(always)]
    pub fn b721(&mut self) -> B721_W<MPCBB1_VCTR22rs> {
        B721_W::new(self, 17)
    }
    ///Bit 18 - B722
    #[inline(always)]
    pub fn b722(&mut self) -> B722_W<MPCBB1_VCTR22rs> {
        B722_W::new(self, 18)
    }
    ///Bit 19 - B723
    #[inline(always)]
    pub fn b723(&mut self) -> B723_W<MPCBB1_VCTR22rs> {
        B723_W::new(self, 19)
    }
    ///Bit 20 - B724
    #[inline(always)]
    pub fn b724(&mut self) -> B724_W<MPCBB1_VCTR22rs> {
        B724_W::new(self, 20)
    }
    ///Bit 21 - B725
    #[inline(always)]
    pub fn b725(&mut self) -> B725_W<MPCBB1_VCTR22rs> {
        B725_W::new(self, 21)
    }
    ///Bit 22 - B726
    #[inline(always)]
    pub fn b726(&mut self) -> B726_W<MPCBB1_VCTR22rs> {
        B726_W::new(self, 22)
    }
    ///Bit 23 - B727
    #[inline(always)]
    pub fn b727(&mut self) -> B727_W<MPCBB1_VCTR22rs> {
        B727_W::new(self, 23)
    }
    ///Bit 24 - B728
    #[inline(always)]
    pub fn b728(&mut self) -> B728_W<MPCBB1_VCTR22rs> {
        B728_W::new(self, 24)
    }
    ///Bit 25 - B729
    #[inline(always)]
    pub fn b729(&mut self) -> B729_W<MPCBB1_VCTR22rs> {
        B729_W::new(self, 25)
    }
    ///Bit 26 - B730
    #[inline(always)]
    pub fn b730(&mut self) -> B730_W<MPCBB1_VCTR22rs> {
        B730_W::new(self, 26)
    }
    ///Bit 27 - B731
    #[inline(always)]
    pub fn b731(&mut self) -> B731_W<MPCBB1_VCTR22rs> {
        B731_W::new(self, 27)
    }
    ///Bit 28 - B732
    #[inline(always)]
    pub fn b732(&mut self) -> B732_W<MPCBB1_VCTR22rs> {
        B732_W::new(self, 28)
    }
    ///Bit 29 - B733
    #[inline(always)]
    pub fn b733(&mut self) -> B733_W<MPCBB1_VCTR22rs> {
        B733_W::new(self, 29)
    }
    ///Bit 30 - B734
    #[inline(always)]
    pub fn b734(&mut self) -> B734_W<MPCBB1_VCTR22rs> {
        B734_W::new(self, 30)
    }
    ///Bit 31 - B735
    #[inline(always)]
    pub fn b735(&mut self) -> B735_W<MPCBB1_VCTR22rs> {
        B735_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr22::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr22::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR22)*/
pub struct MPCBB1_VCTR22rs;
impl crate::RegisterSpec for MPCBB1_VCTR22rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr22::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR22rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr22::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR22rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR22 to value 0
impl crate::Resettable for MPCBB1_VCTR22rs {
