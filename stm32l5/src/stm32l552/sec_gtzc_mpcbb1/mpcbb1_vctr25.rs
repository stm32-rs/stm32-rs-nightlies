...
pub type R = crate::R<MPCBB1_VCTR25rs>;
///Register `MPCBB1_VCTR25` writer
pub type W = crate::W<MPCBB1_VCTR25rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b800(&mut self) -> B800_W<MPCBB1_VCTR25rs> {
        B800_W::new(self, 0)
    }
    ///Bit 1 - B801
    #[inline(always)]
    #[must_use]
    pub fn b801(&mut self) -> B801_W<MPCBB1_VCTR25rs> {
        B801_W::new(self, 1)
    }
    ///Bit 2 - B802
    #[inline(always)]
    #[must_use]
    pub fn b802(&mut self) -> B802_W<MPCBB1_VCTR25rs> {
        B802_W::new(self, 2)
    }
    ///Bit 3 - B803
    #[inline(always)]
    #[must_use]
    pub fn b803(&mut self) -> B803_W<MPCBB1_VCTR25rs> {
        B803_W::new(self, 3)
    }
    ///Bit 4 - B804
    #[inline(always)]
    #[must_use]
    pub fn b804(&mut self) -> B804_W<MPCBB1_VCTR25rs> {
        B804_W::new(self, 4)
    }
    ///Bit 5 - B805
    #[inline(always)]
    #[must_use]
    pub fn b805(&mut self) -> B805_W<MPCBB1_VCTR25rs> {
        B805_W::new(self, 5)
    }
    ///Bit 6 - B806
    #[inline(always)]
    #[must_use]
    pub fn b806(&mut self) -> B806_W<MPCBB1_VCTR25rs> {
        B806_W::new(self, 6)
    }
    ///Bit 7 - B807
    #[inline(always)]
    #[must_use]
    pub fn b807(&mut self) -> B807_W<MPCBB1_VCTR25rs> {
        B807_W::new(self, 7)
    }
    ///Bit 8 - B808
    #[inline(always)]
    #[must_use]
    pub fn b808(&mut self) -> B808_W<MPCBB1_VCTR25rs> {
        B808_W::new(self, 8)
    }
    ///Bit 9 - B809
    #[inline(always)]
    #[must_use]
    pub fn b809(&mut self) -> B809_W<MPCBB1_VCTR25rs> {
        B809_W::new(self, 9)
    }
    ///Bit 10 - B810
    #[inline(always)]
    #[must_use]
    pub fn b810(&mut self) -> B810_W<MPCBB1_VCTR25rs> {
        B810_W::new(self, 10)
    }
    ///Bit 11 - B811
    #[inline(always)]
    #[must_use]
    pub fn b811(&mut self) -> B811_W<MPCBB1_VCTR25rs> {
        B811_W::new(self, 11)
    }
    ///Bit 12 - B812
    #[inline(always)]
    #[must_use]
    pub fn b812(&mut self) -> B812_W<MPCBB1_VCTR25rs> {
        B812_W::new(self, 12)
    }
    ///Bit 13 - B813
    #[inline(always)]
    #[must_use]
    pub fn b813(&mut self) -> B813_W<MPCBB1_VCTR25rs> {
        B813_W::new(self, 13)
    }
    ///Bit 14 - B814
    #[inline(always)]
    #[must_use]
    pub fn b814(&mut self) -> B814_W<MPCBB1_VCTR25rs> {
        B814_W::new(self, 14)
    }
    ///Bit 15 - B815
    #[inline(always)]
    #[must_use]
    pub fn b815(&mut self) -> B815_W<MPCBB1_VCTR25rs> {
        B815_W::new(self, 15)
    }
    ///Bit 16 - B816
    #[inline(always)]
    #[must_use]
    pub fn b816(&mut self) -> B816_W<MPCBB1_VCTR25rs> {
        B816_W::new(self, 16)
    }
    ///Bit 17 - B817
    #[inline(always)]
    #[must_use]
    pub fn b817(&mut self) -> B817_W<MPCBB1_VCTR25rs> {
        B817_W::new(self, 17)
    }
    ///Bit 18 - B818
    #[inline(always)]
    #[must_use]
    pub fn b818(&mut self) -> B818_W<MPCBB1_VCTR25rs> {
        B818_W::new(self, 18)
    }
    ///Bit 19 - B819
    #[inline(always)]
    #[must_use]
    pub fn b819(&mut self) -> B819_W<MPCBB1_VCTR25rs> {
        B819_W::new(self, 19)
    }
    ///Bit 20 - B820
    #[inline(always)]
    #[must_use]
    pub fn b820(&mut self) -> B820_W<MPCBB1_VCTR25rs> {
        B820_W::new(self, 20)
    }
    ///Bit 21 - B821
    #[inline(always)]
    #[must_use]
    pub fn b821(&mut self) -> B821_W<MPCBB1_VCTR25rs> {
        B821_W::new(self, 21)
    }
    ///Bit 22 - B822
    #[inline(always)]
    #[must_use]
    pub fn b822(&mut self) -> B822_W<MPCBB1_VCTR25rs> {
        B822_W::new(self, 22)
    }
    ///Bit 23 - B823
    #[inline(always)]
    #[must_use]
    pub fn b823(&mut self) -> B823_W<MPCBB1_VCTR25rs> {
        B823_W::new(self, 23)
    }
    ///Bit 24 - B824
    #[inline(always)]
    #[must_use]
    pub fn b824(&mut self) -> B824_W<MPCBB1_VCTR25rs> {
        B824_W::new(self, 24)
    }
    ///Bit 25 - B825
    #[inline(always)]
    #[must_use]
    pub fn b825(&mut self) -> B825_W<MPCBB1_VCTR25rs> {
        B825_W::new(self, 25)
    }
    ///Bit 26 - B826
    #[inline(always)]
    #[must_use]
    pub fn b826(&mut self) -> B826_W<MPCBB1_VCTR25rs> {
        B826_W::new(self, 26)
    }
    ///Bit 27 - B827
    #[inline(always)]
    #[must_use]
    pub fn b827(&mut self) -> B827_W<MPCBB1_VCTR25rs> {
        B827_W::new(self, 27)
    }
    ///Bit 28 - B828
    #[inline(always)]
    #[must_use]
    pub fn b828(&mut self) -> B828_W<MPCBB1_VCTR25rs> {
        B828_W::new(self, 28)
    }
    ///Bit 29 - B829
    #[inline(always)]
    #[must_use]
    pub fn b829(&mut self) -> B829_W<MPCBB1_VCTR25rs> {
        B829_W::new(self, 29)
    }
    ///Bit 30 - B830
    #[inline(always)]
    #[must_use]
    pub fn b830(&mut self) -> B830_W<MPCBB1_VCTR25rs> {
        B830_W::new(self, 30)
    }
    ///Bit 31 - B831
    #[inline(always)]
    #[must_use]
    pub fn b831(&mut self) -> B831_W<MPCBB1_VCTR25rs> {
        B831_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr25::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr25::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR25)*/
pub struct MPCBB1_VCTR25rs;
impl crate::RegisterSpec for MPCBB1_VCTR25rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr25::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR25rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr25::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR25rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR25 to value 0
impl crate::Resettable for MPCBB1_VCTR25rs {
