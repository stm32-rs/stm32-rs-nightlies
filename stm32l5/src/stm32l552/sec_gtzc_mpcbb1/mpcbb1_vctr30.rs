///Register `MPCBB1_VCTR30` reader
pub type R = crate::R<MPCBB1_VCTR30rs>;
///Register `MPCBB1_VCTR30` writer
pub type W = crate::W<MPCBB1_VCTR30rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b960(&mut self) -> B960_W<MPCBB1_VCTR30rs> {
        B960_W::new(self, 0)
    }
    ///Bit 1 - B961
    #[inline(always)]
    #[must_use]
    pub fn b961(&mut self) -> B961_W<MPCBB1_VCTR30rs> {
        B961_W::new(self, 1)
    }
    ///Bit 2 - B962
    #[inline(always)]
    #[must_use]
    pub fn b962(&mut self) -> B962_W<MPCBB1_VCTR30rs> {
        B962_W::new(self, 2)
    }
    ///Bit 3 - B963
    #[inline(always)]
    #[must_use]
    pub fn b963(&mut self) -> B963_W<MPCBB1_VCTR30rs> {
        B963_W::new(self, 3)
    }
    ///Bit 4 - B964
    #[inline(always)]
    #[must_use]
    pub fn b964(&mut self) -> B964_W<MPCBB1_VCTR30rs> {
        B964_W::new(self, 4)
    }
    ///Bit 5 - B965
    #[inline(always)]
    #[must_use]
    pub fn b965(&mut self) -> B965_W<MPCBB1_VCTR30rs> {
        B965_W::new(self, 5)
    }
    ///Bit 6 - B966
    #[inline(always)]
    #[must_use]
    pub fn b966(&mut self) -> B966_W<MPCBB1_VCTR30rs> {
        B966_W::new(self, 6)
    }
    ///Bit 7 - B967
    #[inline(always)]
    #[must_use]
    pub fn b967(&mut self) -> B967_W<MPCBB1_VCTR30rs> {
        B967_W::new(self, 7)
    }
    ///Bit 8 - B968
    #[inline(always)]
    #[must_use]
    pub fn b968(&mut self) -> B968_W<MPCBB1_VCTR30rs> {
        B968_W::new(self, 8)
    }
    ///Bit 9 - B969
    #[inline(always)]
    #[must_use]
    pub fn b969(&mut self) -> B969_W<MPCBB1_VCTR30rs> {
        B969_W::new(self, 9)
    }
    ///Bit 10 - B970
    #[inline(always)]
    #[must_use]
    pub fn b970(&mut self) -> B970_W<MPCBB1_VCTR30rs> {
        B970_W::new(self, 10)
    }
    ///Bit 11 - B971
    #[inline(always)]
    #[must_use]
    pub fn b971(&mut self) -> B971_W<MPCBB1_VCTR30rs> {
        B971_W::new(self, 11)
    }
    ///Bit 12 - B972
    #[inline(always)]
    #[must_use]
    pub fn b972(&mut self) -> B972_W<MPCBB1_VCTR30rs> {
        B972_W::new(self, 12)
    }
    ///Bit 13 - B973
    #[inline(always)]
    #[must_use]
    pub fn b973(&mut self) -> B973_W<MPCBB1_VCTR30rs> {
        B973_W::new(self, 13)
    }
    ///Bit 14 - B974
    #[inline(always)]
    #[must_use]
    pub fn b974(&mut self) -> B974_W<MPCBB1_VCTR30rs> {
        B974_W::new(self, 14)
    }
    ///Bit 15 - B975
    #[inline(always)]
    #[must_use]
    pub fn b975(&mut self) -> B975_W<MPCBB1_VCTR30rs> {
        B975_W::new(self, 15)
    }
    ///Bit 16 - B976
    #[inline(always)]
    #[must_use]
    pub fn b976(&mut self) -> B976_W<MPCBB1_VCTR30rs> {
        B976_W::new(self, 16)
    }
    ///Bit 17 - B977
    #[inline(always)]
    #[must_use]
    pub fn b977(&mut self) -> B977_W<MPCBB1_VCTR30rs> {
        B977_W::new(self, 17)
    }
    ///Bit 18 - B978
    #[inline(always)]
    #[must_use]
    pub fn b978(&mut self) -> B978_W<MPCBB1_VCTR30rs> {
        B978_W::new(self, 18)
    }
    ///Bit 19 - B979
    #[inline(always)]
    #[must_use]
    pub fn b979(&mut self) -> B979_W<MPCBB1_VCTR30rs> {
        B979_W::new(self, 19)
    }
    ///Bit 20 - B980
    #[inline(always)]
    #[must_use]
    pub fn b980(&mut self) -> B980_W<MPCBB1_VCTR30rs> {
        B980_W::new(self, 20)
    }
    ///Bit 21 - B981
    #[inline(always)]
    #[must_use]
    pub fn b981(&mut self) -> B981_W<MPCBB1_VCTR30rs> {
        B981_W::new(self, 21)
    }
    ///Bit 22 - B982
    #[inline(always)]
    #[must_use]
    pub fn b982(&mut self) -> B982_W<MPCBB1_VCTR30rs> {
        B982_W::new(self, 22)
    }
    ///Bit 23 - B983
    #[inline(always)]
    #[must_use]
    pub fn b983(&mut self) -> B983_W<MPCBB1_VCTR30rs> {
        B983_W::new(self, 23)
    }
    ///Bit 24 - B984
    #[inline(always)]
    #[must_use]
    pub fn b984(&mut self) -> B984_W<MPCBB1_VCTR30rs> {
        B984_W::new(self, 24)
    }
    ///Bit 25 - B985
    #[inline(always)]
    #[must_use]
    pub fn b985(&mut self) -> B985_W<MPCBB1_VCTR30rs> {
        B985_W::new(self, 25)
    }
    ///Bit 26 - B986
    #[inline(always)]
    #[must_use]
    pub fn b986(&mut self) -> B986_W<MPCBB1_VCTR30rs> {
        B986_W::new(self, 26)
    }
    ///Bit 27 - B987
    #[inline(always)]
    #[must_use]
    pub fn b987(&mut self) -> B987_W<MPCBB1_VCTR30rs> {
        B987_W::new(self, 27)
    }
    ///Bit 28 - B988
    #[inline(always)]
    #[must_use]
    pub fn b988(&mut self) -> B988_W<MPCBB1_VCTR30rs> {
        B988_W::new(self, 28)
    }
    ///Bit 29 - B989
    #[inline(always)]
    #[must_use]
    pub fn b989(&mut self) -> B989_W<MPCBB1_VCTR30rs> {
        B989_W::new(self, 29)
    }
    ///Bit 30 - B990
    #[inline(always)]
    #[must_use]
    pub fn b990(&mut self) -> B990_W<MPCBB1_VCTR30rs> {
        B990_W::new(self, 30)
    }
    ///Bit 31 - B991
    #[inline(always)]
    #[must_use]
    pub fn b991(&mut self) -> B991_W<MPCBB1_VCTR30rs> {
        B991_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr30::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr30::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR30)*/
pub struct MPCBB1_VCTR30rs;
impl crate::RegisterSpec for MPCBB1_VCTR30rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr30::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR30rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr30::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR30rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR30 to value 0
impl crate::Resettable for MPCBB1_VCTR30rs {
