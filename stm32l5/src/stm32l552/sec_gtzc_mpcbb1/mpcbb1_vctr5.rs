///Register `MPCBB1_VCTR5` reader
pub type R = crate::R<MPCBB1_VCTR5rs>;
///Register `MPCBB1_VCTR5` writer
pub type W = crate::W<MPCBB1_VCTR5rs>;
...
impl W {
    ///Bit 0 - B160
    #[inline(always)]
    pub fn b160(&mut self) -> B160_W<MPCBB1_VCTR5rs> {
        B160_W::new(self, 0)
    }
    ///Bit 1 - B161
    #[inline(always)]
    pub fn b161(&mut self) -> B161_W<MPCBB1_VCTR5rs> {
        B161_W::new(self, 1)
    }
    ///Bit 2 - B162
    #[inline(always)]
    pub fn b162(&mut self) -> B162_W<MPCBB1_VCTR5rs> {
        B162_W::new(self, 2)
    }
    ///Bit 3 - B163
    #[inline(always)]
    pub fn b163(&mut self) -> B163_W<MPCBB1_VCTR5rs> {
        B163_W::new(self, 3)
    }
    ///Bit 4 - B164
    #[inline(always)]
    pub fn b164(&mut self) -> B164_W<MPCBB1_VCTR5rs> {
        B164_W::new(self, 4)
    }
    ///Bit 5 - B165
    #[inline(always)]
    pub fn b165(&mut self) -> B165_W<MPCBB1_VCTR5rs> {
        B165_W::new(self, 5)
    }
    ///Bit 6 - B166
    #[inline(always)]
    pub fn b166(&mut self) -> B166_W<MPCBB1_VCTR5rs> {
        B166_W::new(self, 6)
    }
    ///Bit 7 - B167
    #[inline(always)]
    pub fn b167(&mut self) -> B167_W<MPCBB1_VCTR5rs> {
        B167_W::new(self, 7)
    }
    ///Bit 8 - B168
    #[inline(always)]
    pub fn b168(&mut self) -> B168_W<MPCBB1_VCTR5rs> {
        B168_W::new(self, 8)
    }
    ///Bit 9 - B169
    #[inline(always)]
    pub fn b169(&mut self) -> B169_W<MPCBB1_VCTR5rs> {
        B169_W::new(self, 9)
    }
    ///Bit 10 - B170
    #[inline(always)]
    pub fn b170(&mut self) -> B170_W<MPCBB1_VCTR5rs> {
        B170_W::new(self, 10)
    }
    ///Bit 11 - B171
    #[inline(always)]
    pub fn b171(&mut self) -> B171_W<MPCBB1_VCTR5rs> {
        B171_W::new(self, 11)
    }
    ///Bit 12 - B172
    #[inline(always)]
    pub fn b172(&mut self) -> B172_W<MPCBB1_VCTR5rs> {
        B172_W::new(self, 12)
    }
    ///Bit 13 - B173
    #[inline(always)]
    pub fn b173(&mut self) -> B173_W<MPCBB1_VCTR5rs> {
        B173_W::new(self, 13)
    }
    ///Bit 14 - B174
    #[inline(always)]
    pub fn b174(&mut self) -> B174_W<MPCBB1_VCTR5rs> {
        B174_W::new(self, 14)
    }
    ///Bit 15 - B175
    #[inline(always)]
    pub fn b175(&mut self) -> B175_W<MPCBB1_VCTR5rs> {
        B175_W::new(self, 15)
    }
    ///Bit 16 - B176
    #[inline(always)]
    pub fn b176(&mut self) -> B176_W<MPCBB1_VCTR5rs> {
        B176_W::new(self, 16)
    }
    ///Bit 17 - B177
    #[inline(always)]
    pub fn b177(&mut self) -> B177_W<MPCBB1_VCTR5rs> {
        B177_W::new(self, 17)
    }
    ///Bit 18 - B178
    #[inline(always)]
    pub fn b178(&mut self) -> B178_W<MPCBB1_VCTR5rs> {
        B178_W::new(self, 18)
    }
    ///Bit 19 - B179
    #[inline(always)]
    pub fn b179(&mut self) -> B179_W<MPCBB1_VCTR5rs> {
        B179_W::new(self, 19)
    }
    ///Bit 20 - B180
    #[inline(always)]
    pub fn b180(&mut self) -> B180_W<MPCBB1_VCTR5rs> {
        B180_W::new(self, 20)
    }
    ///Bit 21 - B181
    #[inline(always)]
    pub fn b181(&mut self) -> B181_W<MPCBB1_VCTR5rs> {
        B181_W::new(self, 21)
    }
    ///Bit 22 - B182
    #[inline(always)]
    pub fn b182(&mut self) -> B182_W<MPCBB1_VCTR5rs> {
        B182_W::new(self, 22)
    }
    ///Bit 23 - B183
    #[inline(always)]
    pub fn b183(&mut self) -> B183_W<MPCBB1_VCTR5rs> {
        B183_W::new(self, 23)
    }
    ///Bit 24 - B184
    #[inline(always)]
    pub fn b184(&mut self) -> B184_W<MPCBB1_VCTR5rs> {
        B184_W::new(self, 24)
    }
    ///Bit 25 - B185
    #[inline(always)]
    pub fn b185(&mut self) -> B185_W<MPCBB1_VCTR5rs> {
        B185_W::new(self, 25)
    }
    ///Bit 26 - B186
    #[inline(always)]
    pub fn b186(&mut self) -> B186_W<MPCBB1_VCTR5rs> {
        B186_W::new(self, 26)
    }
    ///Bit 27 - B187
    #[inline(always)]
    pub fn b187(&mut self) -> B187_W<MPCBB1_VCTR5rs> {
        B187_W::new(self, 27)
    }
    ///Bit 28 - B188
    #[inline(always)]
    pub fn b188(&mut self) -> B188_W<MPCBB1_VCTR5rs> {
        B188_W::new(self, 28)
    }
    ///Bit 29 - B189
    #[inline(always)]
    pub fn b189(&mut self) -> B189_W<MPCBB1_VCTR5rs> {
        B189_W::new(self, 29)
    }
    ///Bit 30 - B190
    #[inline(always)]
    pub fn b190(&mut self) -> B190_W<MPCBB1_VCTR5rs> {
        B190_W::new(self, 30)
    }
    ///Bit 31 - B191
    #[inline(always)]
    pub fn b191(&mut self) -> B191_W<MPCBB1_VCTR5rs> {
        B191_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR5)*/
pub struct MPCBB1_VCTR5rs;
impl crate::RegisterSpec for MPCBB1_VCTR5rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr5::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR5rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr5::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR5rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR5 to value 0
impl crate::Resettable for MPCBB1_VCTR5rs {
