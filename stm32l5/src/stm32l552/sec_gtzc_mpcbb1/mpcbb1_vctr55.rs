///Register `MPCBB1_VCTR55` reader
pub type R = crate::R<MPCBB1_VCTR55rs>;
///Register `MPCBB1_VCTR55` writer
pub type W = crate::W<MPCBB1_VCTR55rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b1760(&mut self) -> B1760_W<MPCBB1_VCTR55rs> {
        B1760_W::new(self, 0)
    }
    ///Bit 1 - B1761
    #[inline(always)]
    #[must_use]
    pub fn b1761(&mut self) -> B1761_W<MPCBB1_VCTR55rs> {
        B1761_W::new(self, 1)
    }
    ///Bit 2 - B1762
    #[inline(always)]
    #[must_use]
    pub fn b1762(&mut self) -> B1762_W<MPCBB1_VCTR55rs> {
        B1762_W::new(self, 2)
    }
    ///Bit 3 - B1763
    #[inline(always)]
    #[must_use]
    pub fn b1763(&mut self) -> B1763_W<MPCBB1_VCTR55rs> {
        B1763_W::new(self, 3)
    }
    ///Bit 4 - B1764
    #[inline(always)]
    #[must_use]
    pub fn b1764(&mut self) -> B1764_W<MPCBB1_VCTR55rs> {
        B1764_W::new(self, 4)
    }
    ///Bit 5 - B1765
    #[inline(always)]
    #[must_use]
    pub fn b1765(&mut self) -> B1765_W<MPCBB1_VCTR55rs> {
        B1765_W::new(self, 5)
    }
    ///Bit 6 - B1766
    #[inline(always)]
    #[must_use]
    pub fn b1766(&mut self) -> B1766_W<MPCBB1_VCTR55rs> {
        B1766_W::new(self, 6)
    }
    ///Bit 7 - B1767
    #[inline(always)]
    #[must_use]
    pub fn b1767(&mut self) -> B1767_W<MPCBB1_VCTR55rs> {
        B1767_W::new(self, 7)
    }
    ///Bit 8 - B1768
    #[inline(always)]
    #[must_use]
    pub fn b1768(&mut self) -> B1768_W<MPCBB1_VCTR55rs> {
        B1768_W::new(self, 8)
    }
    ///Bit 9 - B1769
    #[inline(always)]
    #[must_use]
    pub fn b1769(&mut self) -> B1769_W<MPCBB1_VCTR55rs> {
        B1769_W::new(self, 9)
    }
    ///Bit 10 - B1770
    #[inline(always)]
    #[must_use]
    pub fn b1770(&mut self) -> B1770_W<MPCBB1_VCTR55rs> {
        B1770_W::new(self, 10)
    }
    ///Bit 11 - B1771
    #[inline(always)]
    #[must_use]
    pub fn b1771(&mut self) -> B1771_W<MPCBB1_VCTR55rs> {
        B1771_W::new(self, 11)
    }
    ///Bit 12 - B1772
    #[inline(always)]
    #[must_use]
    pub fn b1772(&mut self) -> B1772_W<MPCBB1_VCTR55rs> {
        B1772_W::new(self, 12)
    }
    ///Bit 13 - B1773
    #[inline(always)]
    #[must_use]
    pub fn b1773(&mut self) -> B1773_W<MPCBB1_VCTR55rs> {
        B1773_W::new(self, 13)
    }
    ///Bit 14 - B1774
    #[inline(always)]
    #[must_use]
    pub fn b1774(&mut self) -> B1774_W<MPCBB1_VCTR55rs> {
        B1774_W::new(self, 14)
    }
    ///Bit 15 - B1775
    #[inline(always)]
    #[must_use]
    pub fn b1775(&mut self) -> B1775_W<MPCBB1_VCTR55rs> {
        B1775_W::new(self, 15)
    }
    ///Bit 16 - B1776
    #[inline(always)]
    #[must_use]
    pub fn b1776(&mut self) -> B1776_W<MPCBB1_VCTR55rs> {
        B1776_W::new(self, 16)
    }
    ///Bit 17 - B1777
    #[inline(always)]
    #[must_use]
    pub fn b1777(&mut self) -> B1777_W<MPCBB1_VCTR55rs> {
        B1777_W::new(self, 17)
    }
    ///Bit 18 - B1778
    #[inline(always)]
    #[must_use]
    pub fn b1778(&mut self) -> B1778_W<MPCBB1_VCTR55rs> {
        B1778_W::new(self, 18)
    }
    ///Bit 19 - B1779
    #[inline(always)]
    #[must_use]
    pub fn b1779(&mut self) -> B1779_W<MPCBB1_VCTR55rs> {
        B1779_W::new(self, 19)
    }
    ///Bit 20 - B1780
    #[inline(always)]
    #[must_use]
    pub fn b1780(&mut self) -> B1780_W<MPCBB1_VCTR55rs> {
        B1780_W::new(self, 20)
    }
    ///Bit 21 - B1781
    #[inline(always)]
    #[must_use]
    pub fn b1781(&mut self) -> B1781_W<MPCBB1_VCTR55rs> {
        B1781_W::new(self, 21)
    }
    ///Bit 22 - B1782
    #[inline(always)]
    #[must_use]
    pub fn b1782(&mut self) -> B1782_W<MPCBB1_VCTR55rs> {
        B1782_W::new(self, 22)
    }
    ///Bit 23 - B1783
    #[inline(always)]
    #[must_use]
    pub fn b1783(&mut self) -> B1783_W<MPCBB1_VCTR55rs> {
        B1783_W::new(self, 23)
    }
    ///Bit 24 - B1784
    #[inline(always)]
    #[must_use]
    pub fn b1784(&mut self) -> B1784_W<MPCBB1_VCTR55rs> {
        B1784_W::new(self, 24)
    }
    ///Bit 25 - B1785
    #[inline(always)]
    #[must_use]
    pub fn b1785(&mut self) -> B1785_W<MPCBB1_VCTR55rs> {
        B1785_W::new(self, 25)
    }
    ///Bit 26 - B1786
    #[inline(always)]
    #[must_use]
    pub fn b1786(&mut self) -> B1786_W<MPCBB1_VCTR55rs> {
        B1786_W::new(self, 26)
    }
    ///Bit 27 - B1787
    #[inline(always)]
    #[must_use]
    pub fn b1787(&mut self) -> B1787_W<MPCBB1_VCTR55rs> {
        B1787_W::new(self, 27)
    }
    ///Bit 28 - B1788
    #[inline(always)]
    #[must_use]
    pub fn b1788(&mut self) -> B1788_W<MPCBB1_VCTR55rs> {
        B1788_W::new(self, 28)
    }
    ///Bit 29 - B1789
    #[inline(always)]
    #[must_use]
    pub fn b1789(&mut self) -> B1789_W<MPCBB1_VCTR55rs> {
        B1789_W::new(self, 29)
    }
    ///Bit 30 - B1790
    #[inline(always)]
    #[must_use]
    pub fn b1790(&mut self) -> B1790_W<MPCBB1_VCTR55rs> {
        B1790_W::new(self, 30)
    }
    ///Bit 31 - B1791
    #[inline(always)]
    #[must_use]
    pub fn b1791(&mut self) -> B1791_W<MPCBB1_VCTR55rs> {
        B1791_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr55::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr55::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR55)*/
pub struct MPCBB1_VCTR55rs;
impl crate::RegisterSpec for MPCBB1_VCTR55rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr55::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR55rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr55::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR55rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR55 to value 0
impl crate::Resettable for MPCBB1_VCTR55rs {
