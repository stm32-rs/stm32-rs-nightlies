///Register `MPCBB2_VCTR2` reader
pub type R = crate::R<MPCBB2_VCTR2rs>;
///Register `MPCBB2_VCTR2` writer
pub type W = crate::W<MPCBB2_VCTR2rs>;
...
impl W {
    ///Bit 0 - B64
    #[inline(always)]
    pub fn b64(&mut self) -> B64_W<MPCBB2_VCTR2rs> {
        B64_W::new(self, 0)
    }
    ///Bit 1 - B65
    #[inline(always)]
    pub fn b65(&mut self) -> B65_W<MPCBB2_VCTR2rs> {
        B65_W::new(self, 1)
    }
    ///Bit 2 - B66
    #[inline(always)]
    pub fn b66(&mut self) -> B66_W<MPCBB2_VCTR2rs> {
        B66_W::new(self, 2)
    }
    ///Bit 3 - B67
    #[inline(always)]
    pub fn b67(&mut self) -> B67_W<MPCBB2_VCTR2rs> {
        B67_W::new(self, 3)
    }
    ///Bit 4 - B68
    #[inline(always)]
    pub fn b68(&mut self) -> B68_W<MPCBB2_VCTR2rs> {
        B68_W::new(self, 4)
    }
    ///Bit 5 - B69
    #[inline(always)]
    pub fn b69(&mut self) -> B69_W<MPCBB2_VCTR2rs> {
        B69_W::new(self, 5)
    }
    ///Bit 6 - B70
    #[inline(always)]
    pub fn b70(&mut self) -> B70_W<MPCBB2_VCTR2rs> {
        B70_W::new(self, 6)
    }
    ///Bit 7 - B71
    #[inline(always)]
    pub fn b71(&mut self) -> B71_W<MPCBB2_VCTR2rs> {
        B71_W::new(self, 7)
    }
    ///Bit 8 - B72
    #[inline(always)]
    pub fn b72(&mut self) -> B72_W<MPCBB2_VCTR2rs> {
        B72_W::new(self, 8)
    }
    ///Bit 9 - B73
    #[inline(always)]
    pub fn b73(&mut self) -> B73_W<MPCBB2_VCTR2rs> {
        B73_W::new(self, 9)
    }
    ///Bit 10 - B74
    #[inline(always)]
    pub fn b74(&mut self) -> B74_W<MPCBB2_VCTR2rs> {
        B74_W::new(self, 10)
    }
    ///Bit 11 - B75
    #[inline(always)]
    pub fn b75(&mut self) -> B75_W<MPCBB2_VCTR2rs> {
        B75_W::new(self, 11)
    }
    ///Bit 12 - B76
    #[inline(always)]
    pub fn b76(&mut self) -> B76_W<MPCBB2_VCTR2rs> {
        B76_W::new(self, 12)
    }
    ///Bit 13 - B77
    #[inline(always)]
    pub fn b77(&mut self) -> B77_W<MPCBB2_VCTR2rs> {
        B77_W::new(self, 13)
    }
    ///Bit 14 - B78
    #[inline(always)]
    pub fn b78(&mut self) -> B78_W<MPCBB2_VCTR2rs> {
        B78_W::new(self, 14)
    }
    ///Bit 15 - B79
    #[inline(always)]
    pub fn b79(&mut self) -> B79_W<MPCBB2_VCTR2rs> {
        B79_W::new(self, 15)
    }
    ///Bit 16 - B80
    #[inline(always)]
    pub fn b80(&mut self) -> B80_W<MPCBB2_VCTR2rs> {
        B80_W::new(self, 16)
    }
    ///Bit 17 - B81
    #[inline(always)]
    pub fn b81(&mut self) -> B81_W<MPCBB2_VCTR2rs> {
        B81_W::new(self, 17)
    }
    ///Bit 18 - B82
    #[inline(always)]
    pub fn b82(&mut self) -> B82_W<MPCBB2_VCTR2rs> {
        B82_W::new(self, 18)
    }
    ///Bit 19 - B83
    #[inline(always)]
    pub fn b83(&mut self) -> B83_W<MPCBB2_VCTR2rs> {
        B83_W::new(self, 19)
    }
    ///Bit 20 - B84
    #[inline(always)]
    pub fn b84(&mut self) -> B84_W<MPCBB2_VCTR2rs> {
        B84_W::new(self, 20)
    }
    ///Bit 21 - B85
    #[inline(always)]
    pub fn b85(&mut self) -> B85_W<MPCBB2_VCTR2rs> {
        B85_W::new(self, 21)
    }
    ///Bit 22 - B86
    #[inline(always)]
    pub fn b86(&mut self) -> B86_W<MPCBB2_VCTR2rs> {
        B86_W::new(self, 22)
    }
    ///Bit 23 - B87
    #[inline(always)]
    pub fn b87(&mut self) -> B87_W<MPCBB2_VCTR2rs> {
        B87_W::new(self, 23)
    }
    ///Bit 24 - B88
    #[inline(always)]
    pub fn b88(&mut self) -> B88_W<MPCBB2_VCTR2rs> {
        B88_W::new(self, 24)
    }
    ///Bit 25 - B89
    #[inline(always)]
    pub fn b89(&mut self) -> B89_W<MPCBB2_VCTR2rs> {
        B89_W::new(self, 25)
    }
    ///Bit 26 - B90
    #[inline(always)]
    pub fn b90(&mut self) -> B90_W<MPCBB2_VCTR2rs> {
        B90_W::new(self, 26)
    }
    ///Bit 27 - B91
    #[inline(always)]
    pub fn b91(&mut self) -> B91_W<MPCBB2_VCTR2rs> {
        B91_W::new(self, 27)
    }
    ///Bit 28 - B92
    #[inline(always)]
    pub fn b92(&mut self) -> B92_W<MPCBB2_VCTR2rs> {
        B92_W::new(self, 28)
    }
    ///Bit 29 - B93
    #[inline(always)]
    pub fn b93(&mut self) -> B93_W<MPCBB2_VCTR2rs> {
        B93_W::new(self, 29)
    }
    ///Bit 30 - B94
    #[inline(always)]
    pub fn b94(&mut self) -> B94_W<MPCBB2_VCTR2rs> {
        B94_W::new(self, 30)
    }
    ///Bit 31 - B95
    #[inline(always)]
    pub fn b95(&mut self) -> B95_W<MPCBB2_VCTR2rs> {
        B95_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb2_vctr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb2_vctr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#SEC_GTZC_MPCBB2:MPCBB2_VCTR2)*/
pub struct MPCBB2_VCTR2rs;
impl crate::RegisterSpec for MPCBB2_VCTR2rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb2_vctr2::R`](R) reader structure
impl crate::Readable for MPCBB2_VCTR2rs {}
///`write(|w| ..)` method takes [`mpcbb2_vctr2::W`](W) writer structure
impl crate::Writable for MPCBB2_VCTR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB2_VCTR2 to value 0xffff_ffff
impl crate::Resettable for MPCBB2_VCTR2rs {
