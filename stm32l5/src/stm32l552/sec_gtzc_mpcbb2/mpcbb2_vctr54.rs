///Register `MPCBB2_VCTR54` reader
pub type R = crate::R<MPCBB2_VCTR54rs>;
///Register `MPCBB2_VCTR54` writer
pub type W = crate::W<MPCBB2_VCTR54rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b1728(&mut self) -> B1728_W<MPCBB2_VCTR54rs> {
        B1728_W::new(self, 0)
    }
    ///Bit 1 - B1729
    #[inline(always)]
    #[must_use]
    pub fn b1729(&mut self) -> B1729_W<MPCBB2_VCTR54rs> {
        B1729_W::new(self, 1)
    }
    ///Bit 2 - B1730
    #[inline(always)]
    #[must_use]
    pub fn b1730(&mut self) -> B1730_W<MPCBB2_VCTR54rs> {
        B1730_W::new(self, 2)
    }
    ///Bit 3 - B1731
    #[inline(always)]
    #[must_use]
    pub fn b1731(&mut self) -> B1731_W<MPCBB2_VCTR54rs> {
        B1731_W::new(self, 3)
    }
    ///Bit 4 - B1732
    #[inline(always)]
    #[must_use]
    pub fn b1732(&mut self) -> B1732_W<MPCBB2_VCTR54rs> {
        B1732_W::new(self, 4)
    }
    ///Bit 5 - B1733
    #[inline(always)]
    #[must_use]
    pub fn b1733(&mut self) -> B1733_W<MPCBB2_VCTR54rs> {
        B1733_W::new(self, 5)
    }
    ///Bit 6 - B1734
    #[inline(always)]
    #[must_use]
    pub fn b1734(&mut self) -> B1734_W<MPCBB2_VCTR54rs> {
        B1734_W::new(self, 6)
    }
    ///Bit 7 - B1735
    #[inline(always)]
    #[must_use]
    pub fn b1735(&mut self) -> B1735_W<MPCBB2_VCTR54rs> {
        B1735_W::new(self, 7)
    }
    ///Bit 8 - B1736
    #[inline(always)]
    #[must_use]
    pub fn b1736(&mut self) -> B1736_W<MPCBB2_VCTR54rs> {
        B1736_W::new(self, 8)
    }
    ///Bit 9 - B1737
    #[inline(always)]
    #[must_use]
    pub fn b1737(&mut self) -> B1737_W<MPCBB2_VCTR54rs> {
        B1737_W::new(self, 9)
    }
    ///Bit 10 - B1738
    #[inline(always)]
    #[must_use]
    pub fn b1738(&mut self) -> B1738_W<MPCBB2_VCTR54rs> {
        B1738_W::new(self, 10)
    }
    ///Bit 11 - B1739
    #[inline(always)]
    #[must_use]
    pub fn b1739(&mut self) -> B1739_W<MPCBB2_VCTR54rs> {
        B1739_W::new(self, 11)
    }
    ///Bit 12 - B1740
    #[inline(always)]
    #[must_use]
    pub fn b1740(&mut self) -> B1740_W<MPCBB2_VCTR54rs> {
        B1740_W::new(self, 12)
    }
    ///Bit 13 - B1741
    #[inline(always)]
    #[must_use]
    pub fn b1741(&mut self) -> B1741_W<MPCBB2_VCTR54rs> {
        B1741_W::new(self, 13)
    }
    ///Bit 14 - B1742
    #[inline(always)]
    #[must_use]
    pub fn b1742(&mut self) -> B1742_W<MPCBB2_VCTR54rs> {
        B1742_W::new(self, 14)
    }
    ///Bit 15 - B1743
    #[inline(always)]
    #[must_use]
    pub fn b1743(&mut self) -> B1743_W<MPCBB2_VCTR54rs> {
        B1743_W::new(self, 15)
    }
    ///Bit 16 - B1744
    #[inline(always)]
    #[must_use]
    pub fn b1744(&mut self) -> B1744_W<MPCBB2_VCTR54rs> {
        B1744_W::new(self, 16)
    }
    ///Bit 17 - B1745
    #[inline(always)]
    #[must_use]
    pub fn b1745(&mut self) -> B1745_W<MPCBB2_VCTR54rs> {
        B1745_W::new(self, 17)
    }
    ///Bit 18 - B1746
    #[inline(always)]
    #[must_use]
    pub fn b1746(&mut self) -> B1746_W<MPCBB2_VCTR54rs> {
        B1746_W::new(self, 18)
    }
    ///Bit 19 - B1747
    #[inline(always)]
    #[must_use]
    pub fn b1747(&mut self) -> B1747_W<MPCBB2_VCTR54rs> {
        B1747_W::new(self, 19)
    }
    ///Bit 20 - B1748
    #[inline(always)]
    #[must_use]
    pub fn b1748(&mut self) -> B1748_W<MPCBB2_VCTR54rs> {
        B1748_W::new(self, 20)
    }
    ///Bit 21 - B1749
    #[inline(always)]
    #[must_use]
    pub fn b1749(&mut self) -> B1749_W<MPCBB2_VCTR54rs> {
        B1749_W::new(self, 21)
    }
    ///Bit 22 - B1750
    #[inline(always)]
    #[must_use]
    pub fn b1750(&mut self) -> B1750_W<MPCBB2_VCTR54rs> {
        B1750_W::new(self, 22)
    }
    ///Bit 23 - B1751
    #[inline(always)]
    #[must_use]
    pub fn b1751(&mut self) -> B1751_W<MPCBB2_VCTR54rs> {
        B1751_W::new(self, 23)
    }
    ///Bit 24 - B1752
    #[inline(always)]
    #[must_use]
    pub fn b1752(&mut self) -> B1752_W<MPCBB2_VCTR54rs> {
        B1752_W::new(self, 24)
    }
    ///Bit 25 - B1753
    #[inline(always)]
    #[must_use]
    pub fn b1753(&mut self) -> B1753_W<MPCBB2_VCTR54rs> {
        B1753_W::new(self, 25)
    }
    ///Bit 26 - B1754
    #[inline(always)]
    #[must_use]
    pub fn b1754(&mut self) -> B1754_W<MPCBB2_VCTR54rs> {
        B1754_W::new(self, 26)
    }
    ///Bit 27 - B1755
    #[inline(always)]
    #[must_use]
    pub fn b1755(&mut self) -> B1755_W<MPCBB2_VCTR54rs> {
        B1755_W::new(self, 27)
    }
    ///Bit 28 - B1756
    #[inline(always)]
    #[must_use]
    pub fn b1756(&mut self) -> B1756_W<MPCBB2_VCTR54rs> {
        B1756_W::new(self, 28)
    }
    ///Bit 29 - B1757
    #[inline(always)]
    #[must_use]
    pub fn b1757(&mut self) -> B1757_W<MPCBB2_VCTR54rs> {
        B1757_W::new(self, 29)
    }
    ///Bit 30 - B1758
    #[inline(always)]
    #[must_use]
    pub fn b1758(&mut self) -> B1758_W<MPCBB2_VCTR54rs> {
        B1758_W::new(self, 30)
    }
    ///Bit 31 - B1759
    #[inline(always)]
    #[must_use]
    pub fn b1759(&mut self) -> B1759_W<MPCBB2_VCTR54rs> {
        B1759_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb2_vctr54::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb2_vctr54::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#SEC_GTZC_MPCBB2:MPCBB2_VCTR54)*/
pub struct MPCBB2_VCTR54rs;
impl crate::RegisterSpec for MPCBB2_VCTR54rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb2_vctr54::R`](R) reader structure
impl crate::Readable for MPCBB2_VCTR54rs {}
///`write(|w| ..)` method takes [`mpcbb2_vctr54::W`](W) writer structure
impl crate::Writable for MPCBB2_VCTR54rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB2_VCTR54 to value 0
impl crate::Resettable for MPCBB2_VCTR54rs {
