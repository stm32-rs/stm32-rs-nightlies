///Register `MPCBB2_VCTR58` reader
pub type R = crate::R<MPCBB2_VCTR58rs>;
///Register `MPCBB2_VCTR58` writer
pub type W = crate::W<MPCBB2_VCTR58rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b1856(&mut self) -> B1856_W<MPCBB2_VCTR58rs> {
        B1856_W::new(self, 0)
    }
    ///Bit 1 - B1857
    #[inline(always)]
    #[must_use]
    pub fn b1857(&mut self) -> B1857_W<MPCBB2_VCTR58rs> {
        B1857_W::new(self, 1)
    }
    ///Bit 2 - B1858
    #[inline(always)]
    #[must_use]
    pub fn b1858(&mut self) -> B1858_W<MPCBB2_VCTR58rs> {
        B1858_W::new(self, 2)
    }
    ///Bit 3 - B1859
    #[inline(always)]
    #[must_use]
    pub fn b1859(&mut self) -> B1859_W<MPCBB2_VCTR58rs> {
        B1859_W::new(self, 3)
    }
    ///Bit 4 - B1860
    #[inline(always)]
    #[must_use]
    pub fn b1860(&mut self) -> B1860_W<MPCBB2_VCTR58rs> {
        B1860_W::new(self, 4)
    }
    ///Bit 5 - B1861
    #[inline(always)]
    #[must_use]
    pub fn b1861(&mut self) -> B1861_W<MPCBB2_VCTR58rs> {
        B1861_W::new(self, 5)
    }
    ///Bit 6 - B1862
    #[inline(always)]
    #[must_use]
    pub fn b1862(&mut self) -> B1862_W<MPCBB2_VCTR58rs> {
        B1862_W::new(self, 6)
    }
    ///Bit 7 - B1863
    #[inline(always)]
    #[must_use]
    pub fn b1863(&mut self) -> B1863_W<MPCBB2_VCTR58rs> {
        B1863_W::new(self, 7)
    }
    ///Bit 8 - B1864
    #[inline(always)]
    #[must_use]
    pub fn b1864(&mut self) -> B1864_W<MPCBB2_VCTR58rs> {
        B1864_W::new(self, 8)
    }
    ///Bit 9 - B1865
    #[inline(always)]
    #[must_use]
    pub fn b1865(&mut self) -> B1865_W<MPCBB2_VCTR58rs> {
        B1865_W::new(self, 9)
    }
    ///Bit 10 - B1866
    #[inline(always)]
    #[must_use]
    pub fn b1866(&mut self) -> B1866_W<MPCBB2_VCTR58rs> {
        B1866_W::new(self, 10)
    }
    ///Bit 11 - B1867
    #[inline(always)]
    #[must_use]
    pub fn b1867(&mut self) -> B1867_W<MPCBB2_VCTR58rs> {
        B1867_W::new(self, 11)
    }
    ///Bit 12 - B1868
    #[inline(always)]
    #[must_use]
    pub fn b1868(&mut self) -> B1868_W<MPCBB2_VCTR58rs> {
        B1868_W::new(self, 12)
    }
    ///Bit 13 - B1869
    #[inline(always)]
    #[must_use]
    pub fn b1869(&mut self) -> B1869_W<MPCBB2_VCTR58rs> {
        B1869_W::new(self, 13)
    }
    ///Bit 14 - B1870
    #[inline(always)]
    #[must_use]
    pub fn b1870(&mut self) -> B1870_W<MPCBB2_VCTR58rs> {
        B1870_W::new(self, 14)
    }
    ///Bit 15 - B1871
    #[inline(always)]
    #[must_use]
    pub fn b1871(&mut self) -> B1871_W<MPCBB2_VCTR58rs> {
        B1871_W::new(self, 15)
    }
    ///Bit 16 - B1872
    #[inline(always)]
    #[must_use]
    pub fn b1872(&mut self) -> B1872_W<MPCBB2_VCTR58rs> {
        B1872_W::new(self, 16)
    }
    ///Bit 17 - B1873
    #[inline(always)]
    #[must_use]
    pub fn b1873(&mut self) -> B1873_W<MPCBB2_VCTR58rs> {
        B1873_W::new(self, 17)
    }
    ///Bit 18 - B1874
    #[inline(always)]
    #[must_use]
    pub fn b1874(&mut self) -> B1874_W<MPCBB2_VCTR58rs> {
        B1874_W::new(self, 18)
    }
    ///Bit 19 - B1875
    #[inline(always)]
    #[must_use]
    pub fn b1875(&mut self) -> B1875_W<MPCBB2_VCTR58rs> {
        B1875_W::new(self, 19)
    }
    ///Bit 20 - B1876
    #[inline(always)]
    #[must_use]
    pub fn b1876(&mut self) -> B1876_W<MPCBB2_VCTR58rs> {
        B1876_W::new(self, 20)
    }
    ///Bit 21 - B1877
    #[inline(always)]
    #[must_use]
    pub fn b1877(&mut self) -> B1877_W<MPCBB2_VCTR58rs> {
        B1877_W::new(self, 21)
    }
    ///Bit 22 - B1878
    #[inline(always)]
    #[must_use]
    pub fn b1878(&mut self) -> B1878_W<MPCBB2_VCTR58rs> {
        B1878_W::new(self, 22)
    }
    ///Bit 23 - B1879
    #[inline(always)]
    #[must_use]
    pub fn b1879(&mut self) -> B1879_W<MPCBB2_VCTR58rs> {
        B1879_W::new(self, 23)
    }
    ///Bit 24 - B1880
    #[inline(always)]
    #[must_use]
    pub fn b1880(&mut self) -> B1880_W<MPCBB2_VCTR58rs> {
        B1880_W::new(self, 24)
    }
    ///Bit 25 - B1881
    #[inline(always)]
    #[must_use]
    pub fn b1881(&mut self) -> B1881_W<MPCBB2_VCTR58rs> {
        B1881_W::new(self, 25)
    }
    ///Bit 26 - B1882
    #[inline(always)]
    #[must_use]
    pub fn b1882(&mut self) -> B1882_W<MPCBB2_VCTR58rs> {
        B1882_W::new(self, 26)
    }
    ///Bit 27 - B1883
    #[inline(always)]
    #[must_use]
    pub fn b1883(&mut self) -> B1883_W<MPCBB2_VCTR58rs> {
        B1883_W::new(self, 27)
    }
    ///Bit 28 - B1884
    #[inline(always)]
    #[must_use]
    pub fn b1884(&mut self) -> B1884_W<MPCBB2_VCTR58rs> {
        B1884_W::new(self, 28)
    }
    ///Bit 29 - B1885
    #[inline(always)]
    #[must_use]
    pub fn b1885(&mut self) -> B1885_W<MPCBB2_VCTR58rs> {
        B1885_W::new(self, 29)
    }
    ///Bit 30 - B1886
    #[inline(always)]
    #[must_use]
    pub fn b1886(&mut self) -> B1886_W<MPCBB2_VCTR58rs> {
        B1886_W::new(self, 30)
    }
    ///Bit 31 - B1887
    #[inline(always)]
    #[must_use]
    pub fn b1887(&mut self) -> B1887_W<MPCBB2_VCTR58rs> {
        B1887_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb2_vctr58::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb2_vctr58::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L552.html#SEC_GTZC_MPCBB2:MPCBB2_VCTR58)*/
pub struct MPCBB2_VCTR58rs;
impl crate::RegisterSpec for MPCBB2_VCTR58rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb2_vctr58::R`](R) reader structure
impl crate::Readable for MPCBB2_VCTR58rs {}
///`write(|w| ..)` method takes [`mpcbb2_vctr58::W`](W) writer structure
impl crate::Writable for MPCBB2_VCTR58rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB2_VCTR58 to value 0
impl crate::Resettable for MPCBB2_VCTR58rs {
