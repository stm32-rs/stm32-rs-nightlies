...
pub struct SMS_BIT3_R(crate::FieldReader<bool, bool>);
impl SMS_BIT3_R {
    pub(crate) fn new(bits: bool) -> Self {
        SMS_BIT3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SMS_BIT3_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn sms_bit3(&self) -> SMS_BIT3_R {
        SMS_BIT3_R::new(((self.bits >> 16) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:2 - Slave mode selection"]
    ...
    #[doc = "Bit 16 - Slave mode selection - bit 3"]
    #[inline(always)]
    pub fn sms_bit3(&mut self) -> SMS_BIT3_W {
        SMS_BIT3_W { w: self }
    }
