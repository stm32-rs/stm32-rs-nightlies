...
enable"]
pub struct BKDF1BK1E_R(crate::FieldReader<bool, bool>);
impl BKDF1BK1E_R {
    pub(crate) fn new(bits: bool) -> Self {
        BKDF1BK1E_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BKDF1BK1E_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
enable"]
pub struct BKDF1BK1E_W<'a> {
    w: &'a mut W,
}
impl<'a> BKDF1BK1E_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
enable"]
    ...
    pub fn bkdf1bk1e(&self) -> BKDF1BK1E_R {
        BKDF1BK1E_R::new(((self.bits >> 8) & 0x01) != 0)
    }
...
enable"]
    #[inline(always)]
    pub fn bkdf1bk1e(&mut self) -> BKDF1BK1E_W {
        BKDF1BK1E_W { w: self }
    }
    #[doc = "Bit 9 - BRK BKIN input polarity"]
    #[inline(always)]
