...
pub struct UIFREMA_R(crate::FieldReader<bool, bool>);
impl UIFREMA_R {
    pub(crate) fn new(bits: bool) -> Self {
        UIFREMA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for UIFREMA_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn uifrema(&self) -> UIFREMA_R {
        UIFREMA_R::new(((self.bits >> 11) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 7 - Auto-reload preload enable"]
    ...
    #[doc = "Bit 11 - UIF status bit remapping"]
    #[inline(always)]
    pub fn uifrema(&mut self) -> UIFREMA_W {
        UIFREMA_W { w: self }
    }
