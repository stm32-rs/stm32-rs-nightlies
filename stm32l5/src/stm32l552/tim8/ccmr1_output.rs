...
#[doc = "Reader of field `OC1M_bit3`"]
pub type OC1M_BIT3_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OC1M_bit3`"]
pub struct OC1M_BIT3_W<'a> {
    w: &'a mut W,
}
impl<'a> OC1M_BIT3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `OC2M_bit3`"]
pub type OC2M_BIT3_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OC2M_bit3`"]
pub struct OC2M_BIT3_W<'a> {
    w: &'a mut W,
}
impl<'a> OC2M_BIT3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 16 - Output Compare 1 mode - bit 3"]
    #[inline(always)]
    pub fn oc1m_bit3(&mut self) -> OC1M_BIT3_W {
        OC1M_BIT3_W { w: self }
    }
    #[doc = "Bit 24 - Output Compare 2 mode - bit 3"]
    #[inline(always)]
    pub fn oc2m_bit3(&mut self) -> OC2M_BIT3_W {
        OC2M_BIT3_W { w: self }
    }
}
