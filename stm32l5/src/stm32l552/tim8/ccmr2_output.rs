...
#[doc = "Reader of field `OC3M_bit3`"]
pub type OC3M_BIT3_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OC3M_bit3`"]
pub struct OC3M_BIT3_W<'a> {
    w: &'a mut W,
}
impl<'a> OC3M_BIT3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `OC4M_bit3`"]
pub type OC4M_BIT3_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OC4M_bit3`"]
pub struct OC4M_BIT3_W<'a> {
    w: &'a mut W,
}
impl<'a> OC4M_BIT3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 16 - Output Compare 3 mode - bit 3"]
    #[inline(always)]
    pub fn oc3m_bit3(&mut self) -> OC3M_BIT3_W {
        OC3M_BIT3_W { w: self }
    }
    #[doc = "Bit 24 - Output Compare 4 mode - bit 3"]
    #[inline(always)]
    pub fn oc4m_bit3(&mut self) -> OC4M_BIT3_W {
        OC4M_BIT3_W { w: self }
    }
}
