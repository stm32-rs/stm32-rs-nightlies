#[doc = "Reader of register COUNT0_TX"]
pub type R = crate::R<u16, super::COUNT0_TX>;
#[doc = "Writer for register COUNT0_TX"]
pub type W = crate::W<u16, super::COUNT0_TX>;
#[doc = "Register COUNT0_TX `reset()`'s with value 0"]
...
#[doc = "Reader of field `COUNT0_TX`"]
pub type COUNT0_TX_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `COUNT0_TX`"]
