...
///Field `BESL` writer - BESL value
pub type BESL_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
impl R {
...
impl W {
    ...
    ///Bit 3 - RemoteWake value
    #[inline(always)]
    pub fn remwake(&mut self) -> REMWAKE_W<'_, LPMCSRrs> {
        REMWAKE_W::new(self, 3)
    }
    ///Bits 4:7 - BESL value
    #[inline(always)]
    pub fn besl(&mut self) -> BESL_W<'_, LPMCSRrs> {
        BESL_W::new(self, 4)
    }
}
