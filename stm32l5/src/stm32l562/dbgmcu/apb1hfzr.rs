...
impl W {
    ///Bit 1 - I2C4 stop in debug
    #[inline(always)]
    pub fn dbg_i2c4_stop(&mut self) -> DBG_I2C4_STOP_W<'_, APB1HFZRrs> {
    ...
    ///Bit 6 - LPTIM3 stop in debug
    #[inline(always)]
    pub fn dbg_lptim3_stop(&mut self) -> DBG_LPTIM3_STOP_W<'_, APB1HFZRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#DBGMCU:APB1HFZR)*/
