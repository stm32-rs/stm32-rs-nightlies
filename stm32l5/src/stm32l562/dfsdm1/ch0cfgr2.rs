#[doc = "Reader of register CH0CFGR2"]
pub type R = crate::R<u32, super::CH0CFGR2>;
#[doc = "Writer for register CH0CFGR2"]
pub type W = crate::W<u32, super::CH0CFGR2>;
#[doc = "Register CH0CFGR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::CH0CFGR2 {
    type Type = u32;
    #[inline(always)]
