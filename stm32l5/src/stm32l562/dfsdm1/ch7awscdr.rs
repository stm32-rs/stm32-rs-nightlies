...
pub type R = crate::R<CH7AWSCDRrs>;
#[doc = "Register `CH7AWSCDR` writer"]
pub type W = crate::W<CH7AWSCDRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scdt(&mut self) -> SCDT_W<CH7AWSCDRrs> {
        SCDT_W::new(self, 0)
    }
    #[doc = "Bits 12:15 - BKSCD"]
    #[inline(always)]
    #[must_use]
    pub fn bkscd(&mut self) -> BKSCD_W<CH7AWSCDRrs> {
        BKSCD_W::new(self, 12)
    }
    #[doc = "Bits 16:20 - AWFOSR"]
    #[inline(always)]
    #[must_use]
    pub fn awfosr(&mut self) -> AWFOSR_W<CH7AWSCDRrs> {
        AWFOSR_W::new(self, 16)
    }
    #[doc = "Bits 22:23 - AWFORD"]
    #[inline(always)]
    #[must_use]
    pub fn awford(&mut self) -> AWFORD_W<CH7AWSCDRrs> {
        AWFORD_W::new(self, 22)
    }
}
#[doc = "AWSCD7R\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch7awscdr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch7awscdr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH7AWSCDRrs;
impl crate::RegisterSpec for CH7AWSCDRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch7awscdr::R`](R) reader structure"]
impl crate::Readable for CH7AWSCDRrs {}
#[doc = "`write(|w| ..)` method takes [`ch7awscdr::W`](W) writer structure"]
impl crate::Writable for CH7AWSCDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH7AWSCDR to value 0"]
impl crate::Resettable for CH7AWSCDRrs {
