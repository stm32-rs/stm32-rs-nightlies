///Register `CH7CFGR1` reader
pub type R = crate::R<CH7CFGR1rs>;
///Register `CH7CFGR1` writer
pub type W = crate::W<CH7CFGR1rs>;
...
impl W {
    ///Bits 0:1 - SITP
    #[inline(always)]
    pub fn sitp(&mut self) -> SITP_W<CH7CFGR1rs> {
        SITP_W::new(self, 0)
    }
    ///Bits 2:3 - SPICKSEL
    #[inline(always)]
    pub fn spicksel(&mut self) -> SPICKSEL_W<CH7CFGR1rs> {
        SPICKSEL_W::new(self, 2)
    }
    ///Bit 5 - SCDEN
    #[inline(always)]
    pub fn scden(&mut self) -> SCDEN_W<CH7CFGR1rs> {
        SCDEN_W::new(self, 5)
    }
    ///Bit 6 - CKABEN
    #[inline(always)]
    pub fn ckaben(&mut self) -> CKABEN_W<CH7CFGR1rs> {
        CKABEN_W::new(self, 6)
    }
    ///Bit 7 - CHEN
    #[inline(always)]
    pub fn chen(&mut self) -> CHEN_W<CH7CFGR1rs> {
        CHEN_W::new(self, 7)
    }
    ///Bit 8 - CHINSEL
    #[inline(always)]
    pub fn chinsel(&mut self) -> CHINSEL_W<CH7CFGR1rs> {
        CHINSEL_W::new(self, 8)
    }
    ///Bits 12:13 - DATMPX
    #[inline(always)]
    pub fn datmpx(&mut self) -> DATMPX_W<CH7CFGR1rs> {
        DATMPX_W::new(self, 12)
    }
    ///Bits 14:15 - DATPACK
    #[inline(always)]
    pub fn datpack(&mut self) -> DATPACK_W<CH7CFGR1rs> {
        DATPACK_W::new(self, 14)
    }
    ///Bits 16:23 - Output serial clock divider
    #[inline(always)]
    pub fn ckoutdiv(&mut self) -> CKOUTDIV_W<CH7CFGR1rs> {
        CKOUTDIV_W::new(self, 16)
    }
    ///Bit 30 - Output serial clock source selection
    #[inline(always)]
    pub fn ckoutsrc(&mut self) -> CKOUTSRC_W<CH7CFGR1rs> {
        CKOUTSRC_W::new(self, 30)
    }
    ///Bit 31 - Global enable for DFSDM interface
    #[inline(always)]
    pub fn dfsdmen(&mut self) -> DFSDMEN_W<CH7CFGR1rs> {
        DFSDMEN_W::new(self, 31)
    }
}
/**CHCFG7R1

You can [`read`](crate::Reg::read) this register and get [`ch7cfgr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch7cfgr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#DFSDM1:CH7CFGR1)*/
pub struct CH7CFGR1rs;
impl crate::RegisterSpec for CH7CFGR1rs {
    type Ux = u32;
}
///`read()` method returns [`ch7cfgr1::R`](R) reader structure
impl crate::Readable for CH7CFGR1rs {}
///`write(|w| ..)` method takes [`ch7cfgr1::W`](W) writer structure
impl crate::Writable for CH7CFGR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH7CFGR1 to value 0
impl crate::Resettable for CH7CFGR1rs {}
