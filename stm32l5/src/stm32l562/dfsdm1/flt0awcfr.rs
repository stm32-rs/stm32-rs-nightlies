#[doc = "Reader of register FLT0AWCFR"]
pub type R = crate::R<u32, super::FLT0AWCFR>;
#[doc = "Writer for register FLT0AWCFR"]
pub type W = crate::W<u32, super::FLT0AWCFR>;
#[doc = "Register FLT0AWCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT0AWCFR {
    type Type = u32;
    #[inline(always)]
