#[doc = "Reader of register FLT0FCR"]
pub type R = crate::R<u32, super::FLT0FCR>;
#[doc = "Writer for register FLT0FCR"]
pub type W = crate::W<u32, super::FLT0FCR>;
#[doc = "Register FLT0FCR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT0FCR {
    type Type = u32;
    #[inline(always)]
