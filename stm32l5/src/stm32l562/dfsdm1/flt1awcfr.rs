#[doc = "Reader of register FLT1AWCFR"]
pub type R = crate::R<u32, super::FLT1AWCFR>;
#[doc = "Writer for register FLT1AWCFR"]
pub type W = crate::W<u32, super::FLT1AWCFR>;
#[doc = "Register FLT1AWCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT1AWCFR {
    type Type = u32;
    #[inline(always)]
