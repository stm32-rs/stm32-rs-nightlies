#[doc = "Reader of register FLT1AWLTR"]
pub type R = crate::R<u32, super::FLT1AWLTR>;
#[doc = "Writer for register FLT1AWLTR"]
pub type W = crate::W<u32, super::FLT1AWLTR>;
#[doc = "Register FLT1AWLTR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT1AWLTR {
    type Type = u32;
    #[inline(always)]
