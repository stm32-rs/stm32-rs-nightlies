#[doc = "Reader of register FLT1FCR"]
pub type R = crate::R<u32, super::FLT1FCR>;
#[doc = "Writer for register FLT1FCR"]
pub type W = crate::W<u32, super::FLT1FCR>;
#[doc = "Register FLT1FCR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT1FCR {
    type Type = u32;
    #[inline(always)]
