#[doc = "Reader of register FLT2AWHTR"]
pub type R = crate::R<u32, super::FLT2AWHTR>;
#[doc = "Writer for register FLT2AWHTR"]
pub type W = crate::W<u32, super::FLT2AWHTR>;
#[doc = "Register FLT2AWHTR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT2AWHTR {
    type Type = u32;
    #[inline(always)]
