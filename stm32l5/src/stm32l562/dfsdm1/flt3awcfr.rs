#[doc = "Reader of register FLT3AWCFR"]
pub type R = crate::R<u32, super::FLT3AWCFR>;
#[doc = "Writer for register FLT3AWCFR"]
pub type W = crate::W<u32, super::FLT3AWCFR>;
#[doc = "Register FLT3AWCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT3AWCFR {
    type Type = u32;
    #[inline(always)]
