#[doc = "Reader of register FLT3AWLTR"]
pub type R = crate::R<u32, super::FLT3AWLTR>;
#[doc = "Writer for register FLT3AWLTR"]
pub type W = crate::W<u32, super::FLT3AWLTR>;
#[doc = "Register FLT3AWLTR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT3AWLTR {
    type Type = u32;
    #[inline(always)]
