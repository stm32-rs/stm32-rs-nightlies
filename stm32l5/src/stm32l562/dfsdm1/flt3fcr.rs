#[doc = "Reader of register FLT3FCR"]
pub type R = crate::R<u32, super::FLT3FCR>;
#[doc = "Writer for register FLT3FCR"]
pub type W = crate::W<u32, super::FLT3FCR>;
#[doc = "Register FLT3FCR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLT3FCR {
    type Type = u32;
    #[inline(always)]
