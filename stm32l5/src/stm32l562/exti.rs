...
impl RegisterBlock {
    ...
    ///0x38 - EXTI security enable register
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn lockrg(&self) -> &LOCKRG {
        &self.lockrg
    }
    ...
    ///0x90 - EXTI CPUm wakeup with interrupt mask register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:RTSR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:SWIER1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:RPR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:FPR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:SECCFGR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:PRIVCFGR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:SWIER2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:RPR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:SECCFGR2)
...
pub mod seccfgr2;
/**PRIVCFGR2 (rw) register accessor: EXTI security enable register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:EXTICR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:EXTICR4)

For information about available fields see [`mod@exticr4`] module*/
pub type EXTICR4 = crate::Reg<exticr4::EXTICR4rs>;
///EXTI external interrupt selection register
pub mod exticr4;
/**LOCKRG (rw) register accessor: EXTI lock register

You can [`read`](crate::Reg::read) this register and get [`lockrg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lockrg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:LOCKRG)

For information about available fields see [`mod@lockrg`] module*/
pub type LOCKRG = crate::Reg<lockrg::LOCKRGrs>;
///EXTI lock register
pub mod lockrg;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:EMR1)

For information about available fields see [`mod@emr1`] module*/
pub type EMR1 = crate::Reg<emr1::EMR1rs>;
///EXTI CPU wakeup with event mask register
pub mod emr1;
/**IMR2 (rw) register accessor: EXTI CPUm wakeup with interrupt mask register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#EXTI:EMR2)
