...
pub struct ECCC2_R(crate::FieldReader<bool, bool>);
impl ECCC2_R {
    pub(crate) fn new(bits: bool) -> Self {
        ECCC2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ECCC2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct ECCD2_R(crate::FieldReader<bool, bool>);
impl ECCD2_R {
    pub(crate) fn new(bits: bool) -> Self {
        ECCD2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ECCD2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
