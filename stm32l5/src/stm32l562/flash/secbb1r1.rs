#[doc = "Reader of register SECBB1R1"]
pub type R = crate::R<u32, super::SECBB1R1>;
#[doc = "Writer for register SECBB1R1"]
pub type W = crate::W<u32, super::SECBB1R1>;
#[doc = "Register SECBB1R1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SECBB1R1 {
    type Type = u32;
    #[inline(always)]
