#[doc = "Reader of register SECBB2R3"]
pub type R = crate::R<u32, super::SECBB2R3>;
#[doc = "Writer for register SECBB2R3"]
pub type W = crate::W<u32, super::SECBB2R3>;
#[doc = "Register SECBB2R3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SECBB2R3 {
    type Type = u32;
    #[inline(always)]
