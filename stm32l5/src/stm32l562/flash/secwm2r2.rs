...
impl W {
    ///Bits 0:6 - PCROP2_PSTRT
    #[inline(always)]
    pub fn pcrop2_pstrt(&mut self) -> PCROP2_PSTRT_W<'_, SECWM2R2rs> {
        PCROP2_PSTRT_W::new(self, 0)
    }
    ///Bit 15 - PCROP2EN
    #[inline(always)]
    pub fn pcrop2en(&mut self) -> PCROP2EN_W<'_, SECWM2R2rs> {
        PCROP2EN_W::new(self, 15)
    }
    ///Bits 16:22 - HDP2_PEND
    #[inline(always)]
    pub fn hdp2_pend(&mut self) -> HDP2_PEND_W<'_, SECWM2R2rs> {
        HDP2_PEND_W::new(self, 16)
    }
    ///Bit 31 - HDP2EN
    #[inline(always)]
    pub fn hdp2en(&mut self) -> HDP2EN_W<'_, SECWM2R2rs> {
