...
pub struct WRP2B_PSTRT_R(crate::FieldReader<u8, u8>);
impl WRP2B_PSTRT_R {
    pub(crate) fn new(bits: u8) -> Self {
        WRP2B_PSTRT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WRP2B_PSTRT_R {
...
pub struct WRP2B_PEND_R(crate::FieldReader<u8, u8>);
impl WRP2B_PEND_R {
    pub(crate) fn new(bits: u8) -> Self {
        WRP2B_PEND_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WRP2B_PEND_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
