...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b0(&mut self) -> B0_W<VCTRrs> {
        B0_W::new(self, 0)
    }
    ///Bit 1 - B1
    #[inline(always)]
    #[must_use]
    pub fn b1(&mut self) -> B1_W<VCTRrs> {
        B1_W::new(self, 1)
    }
    ///Bit 2 - B2
    #[inline(always)]
    #[must_use]
    pub fn b2(&mut self) -> B2_W<VCTRrs> {
        B2_W::new(self, 2)
    }
    ///Bit 3 - B3
    #[inline(always)]
    #[must_use]
    pub fn b3(&mut self) -> B3_W<VCTRrs> {
        B3_W::new(self, 3)
    }
    ///Bit 4 - B4
    #[inline(always)]
    #[must_use]
    pub fn b4(&mut self) -> B4_W<VCTRrs> {
        B4_W::new(self, 4)
    }
    ///Bit 5 - B5
    #[inline(always)]
    #[must_use]
    pub fn b5(&mut self) -> B5_W<VCTRrs> {
        B5_W::new(self, 5)
    }
    ///Bit 6 - B6
    #[inline(always)]
    #[must_use]
    pub fn b6(&mut self) -> B6_W<VCTRrs> {
        B6_W::new(self, 6)
    }
    ///Bit 7 - B7
    #[inline(always)]
    #[must_use]
    pub fn b7(&mut self) -> B7_W<VCTRrs> {
        B7_W::new(self, 7)
    }
    ///Bit 8 - B8
    #[inline(always)]
    #[must_use]
    pub fn b8(&mut self) -> B8_W<VCTRrs> {
        B8_W::new(self, 8)
    }
    ///Bit 9 - B9
    #[inline(always)]
    #[must_use]
    pub fn b9(&mut self) -> B9_W<VCTRrs> {
        B9_W::new(self, 9)
    }
    ///Bit 10 - B10
    #[inline(always)]
    #[must_use]
    pub fn b10(&mut self) -> B10_W<VCTRrs> {
        B10_W::new(self, 10)
    }
    ///Bit 11 - B11
    #[inline(always)]
    #[must_use]
    pub fn b11(&mut self) -> B11_W<VCTRrs> {
        B11_W::new(self, 11)
    }
    ///Bit 12 - B12
    #[inline(always)]
    #[must_use]
    pub fn b12(&mut self) -> B12_W<VCTRrs> {
        B12_W::new(self, 12)
    }
    ///Bit 13 - B13
    #[inline(always)]
    #[must_use]
    pub fn b13(&mut self) -> B13_W<VCTRrs> {
        B13_W::new(self, 13)
    }
    ///Bit 14 - B14
    #[inline(always)]
    #[must_use]
    pub fn b14(&mut self) -> B14_W<VCTRrs> {
        B14_W::new(self, 14)
    }
    ///Bit 15 - B15
    #[inline(always)]
    #[must_use]
    pub fn b15(&mut self) -> B15_W<VCTRrs> {
        B15_W::new(self, 15)
    }
    ///Bit 16 - B16
    #[inline(always)]
    #[must_use]
    pub fn b16(&mut self) -> B16_W<VCTRrs> {
        B16_W::new(self, 16)
    }
    ///Bit 17 - B17
    #[inline(always)]
    #[must_use]
    pub fn b17(&mut self) -> B17_W<VCTRrs> {
        B17_W::new(self, 17)
    }
    ///Bit 18 - B18
    #[inline(always)]
    #[must_use]
    pub fn b18(&mut self) -> B18_W<VCTRrs> {
        B18_W::new(self, 18)
    }
    ///Bit 19 - B19
    #[inline(always)]
    #[must_use]
    pub fn b19(&mut self) -> B19_W<VCTRrs> {
        B19_W::new(self, 19)
    }
    ///Bit 20 - B20
    #[inline(always)]
    #[must_use]
    pub fn b20(&mut self) -> B20_W<VCTRrs> {
        B20_W::new(self, 20)
    }
    ///Bit 21 - B21
    #[inline(always)]
    #[must_use]
    pub fn b21(&mut self) -> B21_W<VCTRrs> {
        B21_W::new(self, 21)
    }
    ///Bit 22 - B22
    #[inline(always)]
    #[must_use]
    pub fn b22(&mut self) -> B22_W<VCTRrs> {
        B22_W::new(self, 22)
    }
    ///Bit 23 - B23
    #[inline(always)]
    #[must_use]
    pub fn b23(&mut self) -> B23_W<VCTRrs> {
        B23_W::new(self, 23)
    }
    ///Bit 24 - B24
    #[inline(always)]
    #[must_use]
    pub fn b24(&mut self) -> B24_W<VCTRrs> {
        B24_W::new(self, 24)
    }
    ///Bit 25 - B25
    #[inline(always)]
    #[must_use]
    pub fn b25(&mut self) -> B25_W<VCTRrs> {
        B25_W::new(self, 25)
    }
    ///Bit 26 - B26
    #[inline(always)]
    #[must_use]
    pub fn b26(&mut self) -> B26_W<VCTRrs> {
        B26_W::new(self, 26)
    }
    ///Bit 27 - B27
    #[inline(always)]
    #[must_use]
    pub fn b27(&mut self) -> B27_W<VCTRrs> {
        B27_W::new(self, 27)
    }
    ///Bit 28 - B28
    #[inline(always)]
    #[must_use]
    pub fn b28(&mut self) -> B28_W<VCTRrs> {
        B28_W::new(self, 28)
    }
    ///Bit 29 - B29
    #[inline(always)]
    #[must_use]
    pub fn b29(&mut self) -> B29_W<VCTRrs> {
        B29_W::new(self, 29)
    }
    ///Bit 30 - B30
    #[inline(always)]
    #[must_use]
    pub fn b30(&mut self) -> B30_W<VCTRrs> {
        B30_W::new(self, 30)
    }
    ///Bit 31 - B31
    #[inline(always)]
    #[must_use]
    pub fn b31(&mut self) -> B31_W<VCTRrs> {
        B31_W::new(self, 31)
    }
}
