...
impl W {
    ///Bit 0 - TIM8F
    #[inline(always)]
    pub fn tim8f(&mut self) -> TIM8F_W<'_, SR2rs> {
        TIM8F_W::new(self, 0)
    }
    ///Bit 1 - USART1F
    #[inline(always)]
    pub fn usart1f(&mut self) -> USART1F_W<'_, SR2rs> {
        USART1F_W::new(self, 1)
    }
    ///Bit 2 - TIM15F
    #[inline(always)]
    pub fn tim15f(&mut self) -> TIM15F_W<'_, SR2rs> {
        TIM15F_W::new(self, 2)
    }
    ///Bit 3 - TIM16F
    #[inline(always)]
    pub fn tim16f(&mut self) -> TIM16F_W<'_, SR2rs> {
        TIM16F_W::new(self, 3)
    }
    ///Bit 4 - TIM17F
    #[inline(always)]
    pub fn tim17f(&mut self) -> TIM17F_W<'_, SR2rs> {
        TIM17F_W::new(self, 4)
    }
    ///Bit 5 - SAI1F
    #[inline(always)]
    pub fn sai1f(&mut self) -> SAI1F_W<'_, SR2rs> {
        SAI1F_W::new(self, 5)
    }
    ///Bit 6 - SAI2F
    #[inline(always)]
    pub fn sai2f(&mut self) -> SAI2F_W<'_, SR2rs> {
        SAI2F_W::new(self, 6)
    }
    ///Bit 7 - DFSDM1F
    #[inline(always)]
    pub fn dfsdm1f(&mut self) -> DFSDM1F_W<'_, SR2rs> {
        DFSDM1F_W::new(self, 7)
    }
    ///Bit 8 - CRCF
    #[inline(always)]
    pub fn crcf(&mut self) -> CRCF_W<'_, SR2rs> {
        CRCF_W::new(self, 8)
    }
    ///Bit 9 - TSCF
    #[inline(always)]
    pub fn tscf(&mut self) -> TSCF_W<'_, SR2rs> {
        TSCF_W::new(self, 9)
    }
    ///Bit 10 - ICACHEF
    #[inline(always)]
    pub fn icachef(&mut self) -> ICACHEF_W<'_, SR2rs> {
        ICACHEF_W::new(self, 10)
    }
    ///Bit 11 - ADCF
    #[inline(always)]
    pub fn adcf(&mut self) -> ADCF_W<'_, SR2rs> {
        ADCF_W::new(self, 11)
    }
    ///Bit 12 - AESF
    #[inline(always)]
    pub fn aesf(&mut self) -> AESF_W<'_, SR2rs> {
        AESF_W::new(self, 12)
    }
    ///Bit 13 - HASHF
    #[inline(always)]
    pub fn hashf(&mut self) -> HASHF_W<'_, SR2rs> {
        HASHF_W::new(self, 13)
    }
    ///Bit 14 - RNGF
    #[inline(always)]
    pub fn rngf(&mut self) -> RNGF_W<'_, SR2rs> {
        RNGF_W::new(self, 14)
    }
    ///Bit 15 - PKAF
    #[inline(always)]
    pub fn pkaf(&mut self) -> PKAF_W<'_, SR2rs> {
        PKAF_W::new(self, 15)
    }
    ///Bit 16 - SDMMC1F
    #[inline(always)]
    pub fn sdmmc1f(&mut self) -> SDMMC1F_W<'_, SR2rs> {
        SDMMC1F_W::new(self, 16)
    }
    ///Bit 17 - FMC_REGF
    #[inline(always)]
    pub fn fmc_regf(&mut self) -> FMC_REGF_W<'_, SR2rs> {
        FMC_REGF_W::new(self, 17)
    }
    ///Bit 18 - OCTOSPI1_REGF
    #[inline(always)]
    pub fn octospi1_regf(&mut self) -> OCTOSPI1_REGF_W<'_, SR2rs> {
        OCTOSPI1_REGF_W::new(self, 18)
    }
    ///Bit 19 - RTCF
    #[inline(always)]
    pub fn rtcf(&mut self) -> RTCF_W<'_, SR2rs> {
        RTCF_W::new(self, 19)
    }
    ///Bit 20 - PWRF
    #[inline(always)]
    pub fn pwrf(&mut self) -> PWRF_W<'_, SR2rs> {
        PWRF_W::new(self, 20)
    }
    ///Bit 21 - SYSCFGF
    #[inline(always)]
    pub fn syscfgf(&mut self) -> SYSCFGF_W<'_, SR2rs> {
        SYSCFGF_W::new(self, 21)
    }
    ///Bit 22 - DMA1F
    #[inline(always)]
    pub fn dma1f(&mut self) -> DMA1F_W<'_, SR2rs> {
        DMA1F_W::new(self, 22)
    }
    ///Bit 23 - DMA2F
    #[inline(always)]
    pub fn dma2f(&mut self) -> DMA2F_W<'_, SR2rs> {
        DMA2F_W::new(self, 23)
    }
    ///Bit 24 - DMAMUX1F
    #[inline(always)]
    pub fn dmamux1f(&mut self) -> DMAMUX1F_W<'_, SR2rs> {
        DMAMUX1F_W::new(self, 24)
    }
    ///Bit 25 - RCCF
    #[inline(always)]
    pub fn rccf(&mut self) -> RCCF_W<'_, SR2rs> {
        RCCF_W::new(self, 25)
    }
    ///Bit 26 - FLASHF
    #[inline(always)]
    pub fn flashf(&mut self) -> FLASHF_W<'_, SR2rs> {
        FLASHF_W::new(self, 26)
    }
    ///Bit 27 - FLASH_REGF
    #[inline(always)]
    pub fn flash_regf(&mut self) -> FLASH_REGF_W<'_, SR2rs> {
        FLASH_REGF_W::new(self, 27)
    }
    ///Bit 28 - EXTIF
    #[inline(always)]
    pub fn extif(&mut self) -> EXTIF_W<'_, SR2rs> {
        EXTIF_W::new(self, 28)
    }
    ///Bit 29 - OTFDEC1F
    #[inline(always)]
    pub fn otfdec1f(&mut self) -> OTFDEC1F_W<'_, SR2rs> {
