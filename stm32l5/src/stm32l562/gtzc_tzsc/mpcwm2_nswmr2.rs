...
impl W {
    ///Bits 0:10 - NSWM2STRT
    #[inline(always)]
    pub fn nswm2strt(&mut self) -> NSWM2STRT_W<'_, MPCWM2_NSWMR2rs> {
        NSWM2STRT_W::new(self, 0)
    }
    ///Bits 16:27 - NSWM2LGTH
    #[inline(always)]
    pub fn nswm2lgth(&mut self) -> NSWM2LGTH_W<'_, MPCWM2_NSWMR2rs> {
        NSWM2LGTH_W::new(self, 16)
    }
}
/**TZSC external memory non-secure watermark register 2

You can [`read`](crate::Reg::read) this register and get [`mpcwm2_nswmr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcwm2_nswmr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
