...
impl RegisterBlock {
    ...
    ///0x20..0x30 - ICACHE region configuration register
    #[inline(always)]
    pub fn crr_iter(&self) -> impl Iterator<Item = &CRR> {
        self.crr.iter()
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#ICACHE:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#ICACHE:IER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#ICACHE:FCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#ICACHE:HMONR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#ICACHE:MMONR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#ICACHE:CRR[0])

For information about available fields see [`mod@crr`] module*/
pub type CRR = crate::Reg<crr::CRRrs>;
