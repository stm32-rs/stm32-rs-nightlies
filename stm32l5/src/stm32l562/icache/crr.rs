...
impl W {
    ///Bits 0:7 - BASEADDR
    #[inline(always)]
    pub fn baseaddr(&mut self) -> BASEADDR_W<'_, CRRrs> {
        BASEADDR_W::new(self, 0)
    }
    ///Bits 9:11 - RSIZE
    #[inline(always)]
    pub fn rsize(&mut self) -> RSIZE_W<'_, CRRrs> {
        RSIZE_W::new(self, 9)
    }
    ///Bit 15 - REN
    #[inline(always)]
    pub fn ren(&mut self) -> REN_W<'_, CRRrs> {
        REN_W::new(self, 15)
    }
    ///Bits 16:26 - REMAPADDR
    #[inline(always)]
    pub fn remapaddr(&mut self) -> REMAPADDR_W<'_, CRRrs> {
        REMAPADDR_W::new(self, 16)
    }
    ///Bit 28 - MSTSEL
    #[inline(always)]
    pub fn mstsel(&mut self) -> MSTSEL_W<'_, CRRrs> {
        MSTSEL_W::new(self, 28)
    }
    ///Bit 31 - HBURST
    #[inline(always)]
    pub fn hburst(&mut self) -> HBURST_W<'_, CRRrs> {
