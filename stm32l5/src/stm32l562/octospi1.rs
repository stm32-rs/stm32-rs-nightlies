...
impl RegisterBlock {
    ...
    ///0x140 - write communication configuration register
    #[inline(always)]
    pub const fn wpccr(&self) -> &WPCCR {
        &self.wpccr
    }
    ///0x148 - write timing configuration register
    #[inline(always)]
    pub const fn wptcr(&self) -> &WPTCR {
        &self.wptcr
    }
    ///0x150 - write instruction register
    #[inline(always)]
    pub const fn wpir(&self) -> &WPIR {
        &self.wpir
    }
    ///0x160 - write alternate bytes register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:DCR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:DCR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:DCR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:DCR4)
...
///DCR4
pub mod dcr4;
/**SR (w) register accessor: status register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:FCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:DLR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:AR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:DR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:PIR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:CCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:TCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:IR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:ABR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:LPTR)
...
pub mod lptr;
/**WPCCR (rw) register accessor: write communication configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:WPCCR)
...
pub mod wpccr;
/**WPTCR (rw) register accessor: write timing configuration register
...
pub mod wptcr;
/**WPIR (rw) register accessor: write instruction register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:WPIR)
...
pub mod wpir;
/**WPABR (rw) register accessor: write alternate bytes register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:WPABR)
...
pub mod wpabr;
/**WCCR (rw) register accessor: WCCR
...
///WCCR
pub mod wccr;
/**WTCR (rw) register accessor: WTCR
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:WTCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:WIR)
...
///WIR
pub mod wir;
/**WABR (rw) register accessor: WABR
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:WABR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OCTOSPI1:HLCR)
