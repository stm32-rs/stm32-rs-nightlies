...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn imode(&mut self) -> IMODE_W<LPTRrs> {
        IMODE_W::new(self, 0)
    }
    ///Bit 3 - Instruction double transfer rate
    #[inline(always)]
    #[must_use]
    pub fn idtr(&mut self) -> IDTR_W<LPTRrs> {
        IDTR_W::new(self, 3)
    }
    ///Bits 4:5 - Instruction size
    #[inline(always)]
    #[must_use]
    pub fn isize(&mut self) -> ISIZE_W<LPTRrs> {
        ISIZE_W::new(self, 4)
    }
    ///Bits 8:10 - Address mode
    #[inline(always)]
    #[must_use]
    pub fn admode(&mut self) -> ADMODE_W<LPTRrs> {
        ADMODE_W::new(self, 8)
    }
    ///Bit 11 - Address double transfer rate
    #[inline(always)]
    #[must_use]
    pub fn addtr(&mut self) -> ADDTR_W<LPTRrs> {
        ADDTR_W::new(self, 11)
    }
    ///Bits 12:13 - Address size
    #[inline(always)]
    #[must_use]
    pub fn adsize(&mut self) -> ADSIZE_W<LPTRrs> {
        ADSIZE_W::new(self, 12)
    }
    ///Bits 16:18 - Alternate byte mode
    #[inline(always)]
    #[must_use]
    pub fn abmode(&mut self) -> ABMODE_W<LPTRrs> {
        ABMODE_W::new(self, 16)
    }
    ///Bit 19 - Alternate bytes double transfer rate
    #[inline(always)]
    #[must_use]
    pub fn abdtr(&mut self) -> ABDTR_W<LPTRrs> {
        ABDTR_W::new(self, 19)
    }
    ///Bits 20:21 - Alternate bytes size
    #[inline(always)]
    #[must_use]
    pub fn absize(&mut self) -> ABSIZE_W<LPTRrs> {
        ABSIZE_W::new(self, 20)
    }
    ///Bits 24:26 - Data mode
    #[inline(always)]
    #[must_use]
    pub fn dmode(&mut self) -> DMODE_W<LPTRrs> {
        DMODE_W::new(self, 24)
    }
    ///Bit 27 - alternate bytes double transfer rate
    #[inline(always)]
    #[must_use]
    pub fn ddtr(&mut self) -> DDTR_W<LPTRrs> {
        DDTR_W::new(self, 27)
    }
    ///Bit 29 - DQS enable
    #[inline(always)]
    #[must_use]
    pub fn dqse(&mut self) -> DQSE_W<LPTRrs> {
        DQSE_W::new(self, 29)
    }
}
