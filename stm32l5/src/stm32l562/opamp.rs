...
#[doc = "OPAMP2 control/status register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opamp2_crs](opamp2_crs) module"]
pub type OPAMP2_CRS = crate::Reg<u32, _OPAMP2_CRS>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _OPAMP2_CRS;
#[doc = "`read()` method returns [opamp2_crs::R](opamp2_crs::R) reader structure"]
impl crate::Readable for OPAMP2_CRS {}
#[doc = "`write(|w| ..)` method takes [opamp2_crs::W](opamp2_crs::W) writer structure"]
impl crate::Writable for OPAMP2_CRS {}
#[doc = "OPAMP2 control/status register"]
pub mod opamp2_crs;
