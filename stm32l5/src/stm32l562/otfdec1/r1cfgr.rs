#[doc = "Reader of register R1CFGR"]
pub type R = crate::R<u32, super::R1CFGR>;
#[doc = "Writer for register R1CFGR"]
pub type W = crate::W<u32, super::R1CFGR>;
#[doc = "Register R1CFGR `reset()`'s with value 0"]
impl crate::ResetValue for super::R1CFGR {
    type Type = u32;
    #[inline(always)]
