#[doc = "Reader of register R1ENDADDR"]
pub type R = crate::R<u32, super::R1ENDADDR>;
#[doc = "Writer for register R1ENDADDR"]
pub type W = crate::W<u32, super::R1ENDADDR>;
#[doc = "Register R1ENDADDR `reset()`'s with value 0x0fff"]
impl crate::ResetValue for super::R1ENDADDR {
    type Type = u32;
    #[inline(always)]
