#[doc = "Reader of register R1NONCER1"]
pub type R = crate::R<u32, super::R1NONCER1>;
#[doc = "Writer for register R1NONCER1"]
pub type W = crate::W<u32, super::R1NONCER1>;
#[doc = "Register R1NONCER1 `reset()`'s with value 0"]
impl crate::ResetValue for super::R1NONCER1 {
    type Type = u32;
    #[inline(always)]
