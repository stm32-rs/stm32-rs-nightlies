#[doc = "Reader of register R1STARTADDR"]
pub type R = crate::R<u32, super::R1STARTADDR>;
#[doc = "Writer for register R1STARTADDR"]
pub type W = crate::W<u32, super::R1STARTADDR>;
#[doc = "Register R1STARTADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::R1STARTADDR {
    type Type = u32;
    #[inline(always)]
