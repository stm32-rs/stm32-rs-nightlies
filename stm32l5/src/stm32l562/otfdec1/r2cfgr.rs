///Register `R2CFGR` reader
pub type R = crate::R<R2CFGRrs>;
///Register `R2CFGR` writer
pub type W = crate::W<R2CFGRrs>;
...
impl W {
    ///Bit 0 - region on-the-fly decryption enable
    #[inline(always)]
    pub fn reg_en(&mut self) -> REG_EN_W<'_, R2CFGRrs> {
        REG_EN_W::new(self, 0)
    }
    ///Bit 1 - region config lock
    #[inline(always)]
    pub fn configlock(&mut self) -> CONFIGLOCK_W<'_, R2CFGRrs> {
        CONFIGLOCK_W::new(self, 1)
    }
    ///Bit 2 - region key lock
    #[inline(always)]
    pub fn keylock(&mut self) -> KEYLOCK_W<'_, R2CFGRrs> {
        KEYLOCK_W::new(self, 2)
    }
    ///Bits 4:5 - operating mode
    #[inline(always)]
    pub fn mode(&mut self) -> MODE_W<'_, R2CFGRrs> {
        MODE_W::new(self, 4)
    }
    ///Bits 16:31 - region firmware version
    #[inline(always)]
    pub fn regx_version(&mut self) -> REGX_VERSION_W<'_, R2CFGRrs> {
        REGX_VERSION_W::new(self, 16)
    }
}
/**OTFDEC region x configuration register

You can [`read`](crate::Reg::read) this register and get [`r2cfgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r2cfgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#OTFDEC1:R2CFGR)*/
pub struct R2CFGRrs;
impl crate::RegisterSpec for R2CFGRrs {
    type Ux = u32;
}
///`read()` method returns [`r2cfgr::R`](R) reader structure
impl crate::Readable for R2CFGRrs {}
///`write(|w| ..)` method takes [`r2cfgr::W`](W) writer structure
impl crate::Writable for R2CFGRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets R2CFGR to value 0
impl crate::Resettable for R2CFGRrs {}
