#[doc = "Reader of register R2STARTADDR"]
pub type R = crate::R<u32, super::R2STARTADDR>;
#[doc = "Writer for register R2STARTADDR"]
pub type W = crate::W<u32, super::R2STARTADDR>;
#[doc = "Register R2STARTADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::R2STARTADDR {
    type Type = u32;
    #[inline(always)]
