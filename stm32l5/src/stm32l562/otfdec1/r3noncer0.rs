#[doc = "Reader of register R3NONCER0"]
pub type R = crate::R<u32, super::R3NONCER0>;
#[doc = "Writer for register R3NONCER0"]
pub type W = crate::W<u32, super::R3NONCER0>;
#[doc = "Register R3NONCER0 `reset()`'s with value 0"]
impl crate::ResetValue for super::R3NONCER0 {
    type Type = u32;
    #[inline(always)]
