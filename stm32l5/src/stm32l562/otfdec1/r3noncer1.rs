#[doc = "Reader of register R3NONCER1"]
pub type R = crate::R<u32, super::R3NONCER1>;
#[doc = "Writer for register R3NONCER1"]
pub type W = crate::W<u32, super::R3NONCER1>;
#[doc = "Register R3NONCER1 `reset()`'s with value 0"]
impl crate::ResetValue for super::R3NONCER1 {
    type Type = u32;
    #[inline(always)]
