#[doc = "Reader of register R4ENDADDR"]
pub type R = crate::R<u32, super::R4ENDADDR>;
#[doc = "Writer for register R4ENDADDR"]
pub type W = crate::W<u32, super::R4ENDADDR>;
#[doc = "Register R4ENDADDR `reset()`'s with value 0x0fff"]
impl crate::ResetValue for super::R4ENDADDR {
    type Type = u32;
    #[inline(always)]
