#[doc = "Reader of register R4STARTADDR"]
pub type R = crate::R<u32, super::R4STARTADDR>;
#[doc = "Writer for register R4STARTADDR"]
pub type W = crate::W<u32, super::R4STARTADDR>;
#[doc = "Register R4STARTADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::R4STARTADDR {
    type Type = u32;
    #[inline(always)]
