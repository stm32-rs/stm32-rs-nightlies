...
impl RegisterBlock {
    ...
    ///0x78 - Power secure configuration register
    #[inline(always)]
    pub const fn seccfgr(&self) -> &SECCFGR {
        &self.seccfgr
    }
    ///0x80 - Power privilege configuration register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:CR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:SR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:SR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:SCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PUCRA)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PDCRA)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PUCRB)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PDCRB)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PUCRC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PDCRC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PUCRD)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PDCRD)

For information about available fields see [`mod@pdcrd`] module*/
pub type PDCRD = crate::Reg<pdcrd::PDCRDrs>;
///Power Port D pull-down control register
pub mod pdcrd;
/**PUCRE (rw) register accessor: Power Port E pull-up control register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PUCRE)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PDCRE)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PUCRF)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PDCRF)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PUCRG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PDCRG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PUCRH)
...
pub mod pdcrh;
/**SECCFGR (rw) register accessor: Power secure configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:SECCFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#PWR:PRIVCFGR)
