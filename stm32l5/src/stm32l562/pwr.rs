...
impl RegisterBlock {
    ...
    #[doc = "0x78 - Power secure configuration register"]
    #[inline(always)]
    pub const fn seccfgr(&self) -> &SECCFGR {
        &self.seccfgr
    }
    #[doc = "0x80 - Power privilege configuration register"]
    #[inline(always)]
