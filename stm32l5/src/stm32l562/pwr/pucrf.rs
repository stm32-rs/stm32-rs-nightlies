...
///Field `PU14` reader - Port F pull-up bit y (y=0..15)
pub type PU14_R = crate::BitReader;
///Field `PU14` writer - Port F pull-up bit y (y=0..15)
pub type PU14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU15` reader - Port F pull-up bit y (y=0..15)
pub type PU15_R = crate::BitReader;
///Field `PU15` writer - Port F pull-up bit y (y=0..15)
