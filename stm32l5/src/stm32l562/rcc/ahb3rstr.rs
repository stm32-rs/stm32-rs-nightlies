...
#[doc = "OSPI1RST"]
pub type OSPI1RST_A = FMCRST_A;
#[doc = "Field `OSPI1RST` reader - OSPI1RST"]
pub type OSPI1RST_R = FMCRST_R;
#[doc = "Field `OSPI1RST` writer - OSPI1RST"]
pub struct OSPI1RST_W<'a> {
    w: &'a mut W,
}
impl<'a> OSPI1RST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: OSPI1RST_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Reset the selected module"]
    #[inline(always)]
...
impl R {
    ...
    pub fn ospi1rst(&self) -> OSPI1RST_R {
        OSPI1RST_R::new(((self.bits >> 8) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Flexible memory controller reset"]
    ...
    #[doc = "Bit 8 - OSPI1RST"]
    #[inline(always)]
    pub fn ospi1rst(&mut self) -> OSPI1RST_W {
        OSPI1RST_W { w: self }
    }
