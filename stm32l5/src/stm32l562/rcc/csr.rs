...
///Field `LSIPREDIV` reader - LSIPREDIV
pub type LSIPREDIV_R = crate::BitReader;
///Field `LSIPREDIV` writer - LSIPREDIV
...
///Field `IWWDGRSTF` reader - Independent window watchdog reset flag
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CSR")
            ...
            .field("iwwdgrstf", &self.iwwdgrstf())
