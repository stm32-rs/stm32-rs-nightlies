...
impl W {
    ///Bit 0 - ALRAPRIV
    #[inline(always)]
    pub fn alrapriv(&mut self) -> ALRAPRIV_W<'_, PRIVCRrs> {
        ALRAPRIV_W::new(self, 0)
    }
    ///Bit 1 - ALRBPRIV
    #[inline(always)]
    pub fn alrbpriv(&mut self) -> ALRBPRIV_W<'_, PRIVCRrs> {
        ALRBPRIV_W::new(self, 1)
    }
    ///Bit 2 - WUTPRIV
    #[inline(always)]
    pub fn wutpriv(&mut self) -> WUTPRIV_W<'_, PRIVCRrs> {
        WUTPRIV_W::new(self, 2)
    }
    ///Bit 3 - TSPRIV
    #[inline(always)]
    pub fn tspriv(&mut self) -> TSPRIV_W<'_, PRIVCRrs> {
        TSPRIV_W::new(self, 3)
    }
    ///Bit 13 - CALPRIV
    #[inline(always)]
    pub fn calpriv(&mut self) -> CALPRIV_W<'_, PRIVCRrs> {
        CALPRIV_W::new(self, 13)
    }
    ///Bit 14 - INITPRIV
    #[inline(always)]
    pub fn initpriv(&mut self) -> INITPRIV_W<'_, PRIVCRrs> {
        INITPRIV_W::new(self, 14)
    }
    ///Bit 15 - PRIV
    #[inline(always)]
    pub fn priv_(&mut self) -> PRIV_W<'_, PRIVCRrs> {
        PRIV_W::new(self, 15)
    }
}
