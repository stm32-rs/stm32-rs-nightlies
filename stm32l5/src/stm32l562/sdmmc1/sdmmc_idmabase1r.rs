#[doc = "Reader of register SDMMC_IDMABASE1R"]
pub type R = crate::R<u32, super::SDMMC_IDMABASE1R>;
#[doc = "Writer for register SDMMC_IDMABASE1R"]
pub type W = crate::W<u32, super::SDMMC_IDMABASE1R>;
#[doc = "Register SDMMC_IDMABASE1R `reset()`'s with value 0"]
impl crate::ResetValue for super::SDMMC_IDMABASE1R {
    type Type = u32;
    #[inline(always)]
