...
pub type R = crate::R<MPCBB1_VCTR0rs>;
///Register `MPCBB1_VCTR0` writer
pub type W = crate::W<MPCBB1_VCTR0rs>;
///Field `B0` reader - B0
...
impl W {
    ///Bit 0 - B0
    #[inline(always)]
    pub fn b0(&mut self) -> B0_W<MPCBB1_VCTR0rs> {
        B0_W::new(self, 0)
    }
    ///Bit 1 - B1
    #[inline(always)]
    pub fn b1(&mut self) -> B1_W<MPCBB1_VCTR0rs> {
        B1_W::new(self, 1)
    }
    ///Bit 2 - B2
    #[inline(always)]
    pub fn b2(&mut self) -> B2_W<MPCBB1_VCTR0rs> {
        B2_W::new(self, 2)
    }
    ///Bit 3 - B3
    #[inline(always)]
    pub fn b3(&mut self) -> B3_W<MPCBB1_VCTR0rs> {
        B3_W::new(self, 3)
    }
    ///Bit 4 - B4
    #[inline(always)]
    pub fn b4(&mut self) -> B4_W<MPCBB1_VCTR0rs> {
        B4_W::new(self, 4)
    }
    ///Bit 5 - B5
    #[inline(always)]
    pub fn b5(&mut self) -> B5_W<MPCBB1_VCTR0rs> {
        B5_W::new(self, 5)
    }
    ///Bit 6 - B6
    #[inline(always)]
    pub fn b6(&mut self) -> B6_W<MPCBB1_VCTR0rs> {
        B6_W::new(self, 6)
    }
    ///Bit 7 - B7
    #[inline(always)]
    pub fn b7(&mut self) -> B7_W<MPCBB1_VCTR0rs> {
        B7_W::new(self, 7)
    }
    ///Bit 8 - B8
    #[inline(always)]
    pub fn b8(&mut self) -> B8_W<MPCBB1_VCTR0rs> {
        B8_W::new(self, 8)
    }
    ///Bit 9 - B9
    #[inline(always)]
    pub fn b9(&mut self) -> B9_W<MPCBB1_VCTR0rs> {
        B9_W::new(self, 9)
    }
    ///Bit 10 - B10
    #[inline(always)]
    pub fn b10(&mut self) -> B10_W<MPCBB1_VCTR0rs> {
        B10_W::new(self, 10)
    }
    ///Bit 11 - B11
    #[inline(always)]
    pub fn b11(&mut self) -> B11_W<MPCBB1_VCTR0rs> {
        B11_W::new(self, 11)
    }
    ///Bit 12 - B12
    #[inline(always)]
    pub fn b12(&mut self) -> B12_W<MPCBB1_VCTR0rs> {
        B12_W::new(self, 12)
    }
    ///Bit 13 - B13
    #[inline(always)]
    pub fn b13(&mut self) -> B13_W<MPCBB1_VCTR0rs> {
        B13_W::new(self, 13)
    }
    ///Bit 14 - B14
    #[inline(always)]
    pub fn b14(&mut self) -> B14_W<MPCBB1_VCTR0rs> {
        B14_W::new(self, 14)
    }
    ///Bit 15 - B15
    #[inline(always)]
    pub fn b15(&mut self) -> B15_W<MPCBB1_VCTR0rs> {
        B15_W::new(self, 15)
    }
    ///Bit 16 - B16
    #[inline(always)]
    pub fn b16(&mut self) -> B16_W<MPCBB1_VCTR0rs> {
        B16_W::new(self, 16)
    }
    ///Bit 17 - B17
    #[inline(always)]
    pub fn b17(&mut self) -> B17_W<MPCBB1_VCTR0rs> {
        B17_W::new(self, 17)
    }
    ///Bit 18 - B18
    #[inline(always)]
    pub fn b18(&mut self) -> B18_W<MPCBB1_VCTR0rs> {
        B18_W::new(self, 18)
    }
    ///Bit 19 - B19
    #[inline(always)]
    pub fn b19(&mut self) -> B19_W<MPCBB1_VCTR0rs> {
        B19_W::new(self, 19)
    }
    ///Bit 20 - B20
    #[inline(always)]
    pub fn b20(&mut self) -> B20_W<MPCBB1_VCTR0rs> {
        B20_W::new(self, 20)
    }
    ///Bit 21 - B21
    #[inline(always)]
    pub fn b21(&mut self) -> B21_W<MPCBB1_VCTR0rs> {
        B21_W::new(self, 21)
    }
    ///Bit 22 - B22
    #[inline(always)]
    pub fn b22(&mut self) -> B22_W<MPCBB1_VCTR0rs> {
        B22_W::new(self, 22)
    }
    ///Bit 23 - B23
    #[inline(always)]
    pub fn b23(&mut self) -> B23_W<MPCBB1_VCTR0rs> {
        B23_W::new(self, 23)
    }
    ///Bit 24 - B24
    #[inline(always)]
    pub fn b24(&mut self) -> B24_W<MPCBB1_VCTR0rs> {
        B24_W::new(self, 24)
    }
    ///Bit 25 - B25
    #[inline(always)]
    pub fn b25(&mut self) -> B25_W<MPCBB1_VCTR0rs> {
        B25_W::new(self, 25)
    }
    ///Bit 26 - B26
    #[inline(always)]
    pub fn b26(&mut self) -> B26_W<MPCBB1_VCTR0rs> {
        B26_W::new(self, 26)
    }
    ///Bit 27 - B27
    #[inline(always)]
    pub fn b27(&mut self) -> B27_W<MPCBB1_VCTR0rs> {
        B27_W::new(self, 27)
    }
    ///Bit 28 - B28
    #[inline(always)]
    pub fn b28(&mut self) -> B28_W<MPCBB1_VCTR0rs> {
        B28_W::new(self, 28)
    }
    ///Bit 29 - B29
    #[inline(always)]
    pub fn b29(&mut self) -> B29_W<MPCBB1_VCTR0rs> {
        B29_W::new(self, 29)
    }
    ///Bit 30 - B30
    #[inline(always)]
    pub fn b30(&mut self) -> B30_W<MPCBB1_VCTR0rs> {
        B30_W::new(self, 30)
    }
    ///Bit 31 - B31
    #[inline(always)]
    pub fn b31(&mut self) -> B31_W<MPCBB1_VCTR0rs> {
        B31_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR0)*/
pub struct MPCBB1_VCTR0rs;
impl crate::RegisterSpec for MPCBB1_VCTR0rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr0::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR0rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr0::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR0 to value 0xffff_ffff
impl crate::Resettable for MPCBB1_VCTR0rs {
