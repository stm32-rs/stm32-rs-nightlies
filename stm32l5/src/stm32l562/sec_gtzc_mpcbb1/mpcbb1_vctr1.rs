...
pub type R = crate::R<MPCBB1_VCTR1rs>;
///Register `MPCBB1_VCTR1` writer
pub type W = crate::W<MPCBB1_VCTR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b32(&mut self) -> B32_W<MPCBB1_VCTR1rs> {
        B32_W::new(self, 0)
    }
    ///Bit 1 - B33
    #[inline(always)]
    #[must_use]
    pub fn b33(&mut self) -> B33_W<MPCBB1_VCTR1rs> {
        B33_W::new(self, 1)
    }
    ///Bit 2 - B34
    #[inline(always)]
    #[must_use]
    pub fn b34(&mut self) -> B34_W<MPCBB1_VCTR1rs> {
        B34_W::new(self, 2)
    }
    ///Bit 3 - B35
    #[inline(always)]
    #[must_use]
    pub fn b35(&mut self) -> B35_W<MPCBB1_VCTR1rs> {
        B35_W::new(self, 3)
    }
    ///Bit 4 - B36
    #[inline(always)]
    #[must_use]
    pub fn b36(&mut self) -> B36_W<MPCBB1_VCTR1rs> {
        B36_W::new(self, 4)
    }
    ///Bit 5 - B37
    #[inline(always)]
    #[must_use]
    pub fn b37(&mut self) -> B37_W<MPCBB1_VCTR1rs> {
        B37_W::new(self, 5)
    }
    ///Bit 6 - B38
    #[inline(always)]
    #[must_use]
    pub fn b38(&mut self) -> B38_W<MPCBB1_VCTR1rs> {
        B38_W::new(self, 6)
    }
    ///Bit 7 - B39
    #[inline(always)]
    #[must_use]
    pub fn b39(&mut self) -> B39_W<MPCBB1_VCTR1rs> {
        B39_W::new(self, 7)
    }
    ///Bit 8 - B40
    #[inline(always)]
    #[must_use]
    pub fn b40(&mut self) -> B40_W<MPCBB1_VCTR1rs> {
        B40_W::new(self, 8)
    }
    ///Bit 9 - B41
    #[inline(always)]
    #[must_use]
    pub fn b41(&mut self) -> B41_W<MPCBB1_VCTR1rs> {
        B41_W::new(self, 9)
    }
    ///Bit 10 - B42
    #[inline(always)]
    #[must_use]
    pub fn b42(&mut self) -> B42_W<MPCBB1_VCTR1rs> {
        B42_W::new(self, 10)
    }
    ///Bit 11 - B43
    #[inline(always)]
    #[must_use]
    pub fn b43(&mut self) -> B43_W<MPCBB1_VCTR1rs> {
        B43_W::new(self, 11)
    }
    ///Bit 12 - B44
    #[inline(always)]
    #[must_use]
    pub fn b44(&mut self) -> B44_W<MPCBB1_VCTR1rs> {
        B44_W::new(self, 12)
    }
    ///Bit 13 - B45
    #[inline(always)]
    #[must_use]
    pub fn b45(&mut self) -> B45_W<MPCBB1_VCTR1rs> {
        B45_W::new(self, 13)
    }
    ///Bit 14 - B46
    #[inline(always)]
    #[must_use]
    pub fn b46(&mut self) -> B46_W<MPCBB1_VCTR1rs> {
        B46_W::new(self, 14)
    }
    ///Bit 15 - B47
    #[inline(always)]
    #[must_use]
    pub fn b47(&mut self) -> B47_W<MPCBB1_VCTR1rs> {
        B47_W::new(self, 15)
    }
    ///Bit 16 - B48
    #[inline(always)]
    #[must_use]
    pub fn b48(&mut self) -> B48_W<MPCBB1_VCTR1rs> {
        B48_W::new(self, 16)
    }
    ///Bit 17 - B49
    #[inline(always)]
    #[must_use]
    pub fn b49(&mut self) -> B49_W<MPCBB1_VCTR1rs> {
        B49_W::new(self, 17)
    }
    ///Bit 18 - B50
    #[inline(always)]
    #[must_use]
    pub fn b50(&mut self) -> B50_W<MPCBB1_VCTR1rs> {
        B50_W::new(self, 18)
    }
    ///Bit 19 - B51
    #[inline(always)]
    #[must_use]
    pub fn b51(&mut self) -> B51_W<MPCBB1_VCTR1rs> {
        B51_W::new(self, 19)
    }
    ///Bit 20 - B52
    #[inline(always)]
    #[must_use]
    pub fn b52(&mut self) -> B52_W<MPCBB1_VCTR1rs> {
        B52_W::new(self, 20)
    }
    ///Bit 21 - B53
    #[inline(always)]
    #[must_use]
    pub fn b53(&mut self) -> B53_W<MPCBB1_VCTR1rs> {
        B53_W::new(self, 21)
    }
    ///Bit 22 - B54
    #[inline(always)]
    #[must_use]
    pub fn b54(&mut self) -> B54_W<MPCBB1_VCTR1rs> {
        B54_W::new(self, 22)
    }
    ///Bit 23 - B55
    #[inline(always)]
    #[must_use]
    pub fn b55(&mut self) -> B55_W<MPCBB1_VCTR1rs> {
        B55_W::new(self, 23)
    }
    ///Bit 24 - B56
    #[inline(always)]
    #[must_use]
    pub fn b56(&mut self) -> B56_W<MPCBB1_VCTR1rs> {
        B56_W::new(self, 24)
    }
    ///Bit 25 - B57
    #[inline(always)]
    #[must_use]
    pub fn b57(&mut self) -> B57_W<MPCBB1_VCTR1rs> {
        B57_W::new(self, 25)
    }
    ///Bit 26 - B58
    #[inline(always)]
    #[must_use]
    pub fn b58(&mut self) -> B58_W<MPCBB1_VCTR1rs> {
        B58_W::new(self, 26)
    }
    ///Bit 27 - B59
    #[inline(always)]
    #[must_use]
    pub fn b59(&mut self) -> B59_W<MPCBB1_VCTR1rs> {
        B59_W::new(self, 27)
    }
    ///Bit 28 - B60
    #[inline(always)]
    #[must_use]
    pub fn b60(&mut self) -> B60_W<MPCBB1_VCTR1rs> {
        B60_W::new(self, 28)
    }
    ///Bit 29 - B61
    #[inline(always)]
    #[must_use]
    pub fn b61(&mut self) -> B61_W<MPCBB1_VCTR1rs> {
        B61_W::new(self, 29)
    }
    ///Bit 30 - B62
    #[inline(always)]
    #[must_use]
    pub fn b62(&mut self) -> B62_W<MPCBB1_VCTR1rs> {
        B62_W::new(self, 30)
    }
    ///Bit 31 - B63
    #[inline(always)]
    #[must_use]
    pub fn b63(&mut self) -> B63_W<MPCBB1_VCTR1rs> {
        B63_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR1)*/
pub struct MPCBB1_VCTR1rs;
impl crate::RegisterSpec for MPCBB1_VCTR1rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr1::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR1rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr1::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR1 to value 0xffff_ffff
impl crate::Resettable for MPCBB1_VCTR1rs {
