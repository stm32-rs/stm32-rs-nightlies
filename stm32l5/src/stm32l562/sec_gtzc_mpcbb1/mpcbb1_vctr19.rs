///Register `MPCBB1_VCTR19` reader
pub type R = crate::R<MPCBB1_VCTR19rs>;
///Register `MPCBB1_VCTR19` writer
pub type W = crate::W<MPCBB1_VCTR19rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b608(&mut self) -> B608_W<MPCBB1_VCTR19rs> {
        B608_W::new(self, 0)
    }
    ///Bit 1 - B609
    #[inline(always)]
    #[must_use]
    pub fn b609(&mut self) -> B609_W<MPCBB1_VCTR19rs> {
        B609_W::new(self, 1)
    }
    ///Bit 2 - B610
    #[inline(always)]
    #[must_use]
    pub fn b610(&mut self) -> B610_W<MPCBB1_VCTR19rs> {
        B610_W::new(self, 2)
    }
    ///Bit 3 - B611
    #[inline(always)]
    #[must_use]
    pub fn b611(&mut self) -> B611_W<MPCBB1_VCTR19rs> {
        B611_W::new(self, 3)
    }
    ///Bit 4 - B612
    #[inline(always)]
    #[must_use]
    pub fn b612(&mut self) -> B612_W<MPCBB1_VCTR19rs> {
        B612_W::new(self, 4)
    }
    ///Bit 5 - B613
    #[inline(always)]
    #[must_use]
    pub fn b613(&mut self) -> B613_W<MPCBB1_VCTR19rs> {
        B613_W::new(self, 5)
    }
    ///Bit 6 - B614
    #[inline(always)]
    #[must_use]
    pub fn b614(&mut self) -> B614_W<MPCBB1_VCTR19rs> {
        B614_W::new(self, 6)
    }
    ///Bit 7 - B615
    #[inline(always)]
    #[must_use]
    pub fn b615(&mut self) -> B615_W<MPCBB1_VCTR19rs> {
        B615_W::new(self, 7)
    }
    ///Bit 8 - B616
    #[inline(always)]
    #[must_use]
    pub fn b616(&mut self) -> B616_W<MPCBB1_VCTR19rs> {
        B616_W::new(self, 8)
    }
    ///Bit 9 - B617
    #[inline(always)]
    #[must_use]
    pub fn b617(&mut self) -> B617_W<MPCBB1_VCTR19rs> {
        B617_W::new(self, 9)
    }
    ///Bit 10 - B618
    #[inline(always)]
    #[must_use]
    pub fn b618(&mut self) -> B618_W<MPCBB1_VCTR19rs> {
        B618_W::new(self, 10)
    }
    ///Bit 11 - B619
    #[inline(always)]
    #[must_use]
    pub fn b619(&mut self) -> B619_W<MPCBB1_VCTR19rs> {
        B619_W::new(self, 11)
    }
    ///Bit 12 - B620
    #[inline(always)]
    #[must_use]
    pub fn b620(&mut self) -> B620_W<MPCBB1_VCTR19rs> {
        B620_W::new(self, 12)
    }
    ///Bit 13 - B621
    #[inline(always)]
    #[must_use]
    pub fn b621(&mut self) -> B621_W<MPCBB1_VCTR19rs> {
        B621_W::new(self, 13)
    }
    ///Bit 14 - B622
    #[inline(always)]
    #[must_use]
    pub fn b622(&mut self) -> B622_W<MPCBB1_VCTR19rs> {
        B622_W::new(self, 14)
    }
    ///Bit 15 - B623
    #[inline(always)]
    #[must_use]
    pub fn b623(&mut self) -> B623_W<MPCBB1_VCTR19rs> {
        B623_W::new(self, 15)
    }
    ///Bit 16 - B624
    #[inline(always)]
    #[must_use]
    pub fn b624(&mut self) -> B624_W<MPCBB1_VCTR19rs> {
        B624_W::new(self, 16)
    }
    ///Bit 17 - B625
    #[inline(always)]
    #[must_use]
    pub fn b625(&mut self) -> B625_W<MPCBB1_VCTR19rs> {
        B625_W::new(self, 17)
    }
    ///Bit 18 - B626
    #[inline(always)]
    #[must_use]
    pub fn b626(&mut self) -> B626_W<MPCBB1_VCTR19rs> {
        B626_W::new(self, 18)
    }
    ///Bit 19 - B627
    #[inline(always)]
    #[must_use]
    pub fn b627(&mut self) -> B627_W<MPCBB1_VCTR19rs> {
        B627_W::new(self, 19)
    }
    ///Bit 20 - B628
    #[inline(always)]
    #[must_use]
    pub fn b628(&mut self) -> B628_W<MPCBB1_VCTR19rs> {
        B628_W::new(self, 20)
    }
    ///Bit 21 - B629
    #[inline(always)]
    #[must_use]
    pub fn b629(&mut self) -> B629_W<MPCBB1_VCTR19rs> {
        B629_W::new(self, 21)
    }
    ///Bit 22 - B630
    #[inline(always)]
    #[must_use]
    pub fn b630(&mut self) -> B630_W<MPCBB1_VCTR19rs> {
        B630_W::new(self, 22)
    }
    ///Bit 23 - B631
    #[inline(always)]
    #[must_use]
    pub fn b631(&mut self) -> B631_W<MPCBB1_VCTR19rs> {
        B631_W::new(self, 23)
    }
    ///Bit 24 - B632
    #[inline(always)]
    #[must_use]
    pub fn b632(&mut self) -> B632_W<MPCBB1_VCTR19rs> {
        B632_W::new(self, 24)
    }
    ///Bit 25 - B633
    #[inline(always)]
    #[must_use]
    pub fn b633(&mut self) -> B633_W<MPCBB1_VCTR19rs> {
        B633_W::new(self, 25)
    }
    ///Bit 26 - B634
    #[inline(always)]
    #[must_use]
    pub fn b634(&mut self) -> B634_W<MPCBB1_VCTR19rs> {
        B634_W::new(self, 26)
    }
    ///Bit 27 - B635
    #[inline(always)]
    #[must_use]
    pub fn b635(&mut self) -> B635_W<MPCBB1_VCTR19rs> {
        B635_W::new(self, 27)
    }
    ///Bit 28 - B636
    #[inline(always)]
    #[must_use]
    pub fn b636(&mut self) -> B636_W<MPCBB1_VCTR19rs> {
        B636_W::new(self, 28)
    }
    ///Bit 29 - B637
    #[inline(always)]
    #[must_use]
    pub fn b637(&mut self) -> B637_W<MPCBB1_VCTR19rs> {
        B637_W::new(self, 29)
    }
    ///Bit 30 - B638
    #[inline(always)]
    #[must_use]
    pub fn b638(&mut self) -> B638_W<MPCBB1_VCTR19rs> {
        B638_W::new(self, 30)
    }
    ///Bit 31 - B639
    #[inline(always)]
    #[must_use]
    pub fn b639(&mut self) -> B639_W<MPCBB1_VCTR19rs> {
        B639_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr19::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr19::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR19)*/
pub struct MPCBB1_VCTR19rs;
impl crate::RegisterSpec for MPCBB1_VCTR19rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr19::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR19rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr19::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR19rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR19 to value 0
impl crate::Resettable for MPCBB1_VCTR19rs {
