...
pub type R = crate::R<MPCBB1_VCTR3rs>;
///Register `MPCBB1_VCTR3` writer
pub type W = crate::W<MPCBB1_VCTR3rs>;
...
impl W {
    ///Bit 0 - B96
    #[inline(always)]
    pub fn b96(&mut self) -> B96_W<MPCBB1_VCTR3rs> {
        B96_W::new(self, 0)
    }
    ///Bit 1 - B97
    #[inline(always)]
    pub fn b97(&mut self) -> B97_W<MPCBB1_VCTR3rs> {
        B97_W::new(self, 1)
    }
    ///Bit 2 - B98
    #[inline(always)]
    pub fn b98(&mut self) -> B98_W<MPCBB1_VCTR3rs> {
        B98_W::new(self, 2)
    }
    ///Bit 3 - B99
    #[inline(always)]
    pub fn b99(&mut self) -> B99_W<MPCBB1_VCTR3rs> {
        B99_W::new(self, 3)
    }
    ///Bit 4 - B100
    #[inline(always)]
    pub fn b100(&mut self) -> B100_W<MPCBB1_VCTR3rs> {
        B100_W::new(self, 4)
    }
    ///Bit 5 - B101
    #[inline(always)]
    pub fn b101(&mut self) -> B101_W<MPCBB1_VCTR3rs> {
        B101_W::new(self, 5)
    }
    ///Bit 6 - B102
    #[inline(always)]
    pub fn b102(&mut self) -> B102_W<MPCBB1_VCTR3rs> {
        B102_W::new(self, 6)
    }
    ///Bit 7 - B103
    #[inline(always)]
    pub fn b103(&mut self) -> B103_W<MPCBB1_VCTR3rs> {
        B103_W::new(self, 7)
    }
    ///Bit 8 - B104
    #[inline(always)]
    pub fn b104(&mut self) -> B104_W<MPCBB1_VCTR3rs> {
        B104_W::new(self, 8)
    }
    ///Bit 9 - B105
    #[inline(always)]
    pub fn b105(&mut self) -> B105_W<MPCBB1_VCTR3rs> {
        B105_W::new(self, 9)
    }
    ///Bit 10 - B106
    #[inline(always)]
    pub fn b106(&mut self) -> B106_W<MPCBB1_VCTR3rs> {
        B106_W::new(self, 10)
    }
    ///Bit 11 - B107
    #[inline(always)]
    pub fn b107(&mut self) -> B107_W<MPCBB1_VCTR3rs> {
        B107_W::new(self, 11)
    }
    ///Bit 12 - B108
    #[inline(always)]
    pub fn b108(&mut self) -> B108_W<MPCBB1_VCTR3rs> {
        B108_W::new(self, 12)
    }
    ///Bit 13 - B109
    #[inline(always)]
    pub fn b109(&mut self) -> B109_W<MPCBB1_VCTR3rs> {
        B109_W::new(self, 13)
    }
    ///Bit 14 - B110
    #[inline(always)]
    pub fn b110(&mut self) -> B110_W<MPCBB1_VCTR3rs> {
        B110_W::new(self, 14)
    }
    ///Bit 15 - B111
    #[inline(always)]
    pub fn b111(&mut self) -> B111_W<MPCBB1_VCTR3rs> {
        B111_W::new(self, 15)
    }
    ///Bit 16 - B112
    #[inline(always)]
    pub fn b112(&mut self) -> B112_W<MPCBB1_VCTR3rs> {
        B112_W::new(self, 16)
    }
    ///Bit 17 - B113
    #[inline(always)]
    pub fn b113(&mut self) -> B113_W<MPCBB1_VCTR3rs> {
        B113_W::new(self, 17)
    }
    ///Bit 18 - B114
    #[inline(always)]
    pub fn b114(&mut self) -> B114_W<MPCBB1_VCTR3rs> {
        B114_W::new(self, 18)
    }
    ///Bit 19 - B115
    #[inline(always)]
    pub fn b115(&mut self) -> B115_W<MPCBB1_VCTR3rs> {
        B115_W::new(self, 19)
    }
    ///Bit 20 - B116
    #[inline(always)]
    pub fn b116(&mut self) -> B116_W<MPCBB1_VCTR3rs> {
        B116_W::new(self, 20)
    }
    ///Bit 21 - B117
    #[inline(always)]
    pub fn b117(&mut self) -> B117_W<MPCBB1_VCTR3rs> {
        B117_W::new(self, 21)
    }
    ///Bit 22 - B118
    #[inline(always)]
    pub fn b118(&mut self) -> B118_W<MPCBB1_VCTR3rs> {
        B118_W::new(self, 22)
    }
    ///Bit 23 - B119
    #[inline(always)]
    pub fn b119(&mut self) -> B119_W<MPCBB1_VCTR3rs> {
        B119_W::new(self, 23)
    }
    ///Bit 24 - B120
    #[inline(always)]
    pub fn b120(&mut self) -> B120_W<MPCBB1_VCTR3rs> {
        B120_W::new(self, 24)
    }
    ///Bit 25 - B121
    #[inline(always)]
    pub fn b121(&mut self) -> B121_W<MPCBB1_VCTR3rs> {
        B121_W::new(self, 25)
    }
    ///Bit 26 - B122
    #[inline(always)]
    pub fn b122(&mut self) -> B122_W<MPCBB1_VCTR3rs> {
        B122_W::new(self, 26)
    }
    ///Bit 27 - B123
    #[inline(always)]
    pub fn b123(&mut self) -> B123_W<MPCBB1_VCTR3rs> {
        B123_W::new(self, 27)
    }
    ///Bit 28 - B124
    #[inline(always)]
    pub fn b124(&mut self) -> B124_W<MPCBB1_VCTR3rs> {
        B124_W::new(self, 28)
    }
    ///Bit 29 - B125
    #[inline(always)]
    pub fn b125(&mut self) -> B125_W<MPCBB1_VCTR3rs> {
        B125_W::new(self, 29)
    }
    ///Bit 30 - B126
    #[inline(always)]
    pub fn b126(&mut self) -> B126_W<MPCBB1_VCTR3rs> {
        B126_W::new(self, 30)
    }
    ///Bit 31 - B127
    #[inline(always)]
    pub fn b127(&mut self) -> B127_W<MPCBB1_VCTR3rs> {
        B127_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR3)*/
pub struct MPCBB1_VCTR3rs;
impl crate::RegisterSpec for MPCBB1_VCTR3rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr3::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR3rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr3::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR3 to value 0xffff_ffff
impl crate::Resettable for MPCBB1_VCTR3rs {
