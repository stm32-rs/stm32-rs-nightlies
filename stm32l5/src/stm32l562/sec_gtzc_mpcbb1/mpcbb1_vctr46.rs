///Register `MPCBB1_VCTR46` reader
pub type R = crate::R<MPCBB1_VCTR46rs>;
///Register `MPCBB1_VCTR46` writer
pub type W = crate::W<MPCBB1_VCTR46rs>;
...
impl W {
    ///Bit 0 - B1472
    #[inline(always)]
    pub fn b1472(&mut self) -> B1472_W<MPCBB1_VCTR46rs> {
        B1472_W::new(self, 0)
    }
    ///Bit 1 - B1473
    #[inline(always)]
    pub fn b1473(&mut self) -> B1473_W<MPCBB1_VCTR46rs> {
        B1473_W::new(self, 1)
    }
    ///Bit 2 - B1474
    #[inline(always)]
    pub fn b1474(&mut self) -> B1474_W<MPCBB1_VCTR46rs> {
        B1474_W::new(self, 2)
    }
    ///Bit 3 - B1475
    #[inline(always)]
    pub fn b1475(&mut self) -> B1475_W<MPCBB1_VCTR46rs> {
        B1475_W::new(self, 3)
    }
    ///Bit 4 - B1476
    #[inline(always)]
    pub fn b1476(&mut self) -> B1476_W<MPCBB1_VCTR46rs> {
        B1476_W::new(self, 4)
    }
    ///Bit 5 - B1477
    #[inline(always)]
    pub fn b1477(&mut self) -> B1477_W<MPCBB1_VCTR46rs> {
        B1477_W::new(self, 5)
    }
    ///Bit 6 - B1478
    #[inline(always)]
    pub fn b1478(&mut self) -> B1478_W<MPCBB1_VCTR46rs> {
        B1478_W::new(self, 6)
    }
    ///Bit 7 - B1479
    #[inline(always)]
    pub fn b1479(&mut self) -> B1479_W<MPCBB1_VCTR46rs> {
        B1479_W::new(self, 7)
    }
    ///Bit 8 - B1480
    #[inline(always)]
    pub fn b1480(&mut self) -> B1480_W<MPCBB1_VCTR46rs> {
        B1480_W::new(self, 8)
    }
    ///Bit 9 - B1481
    #[inline(always)]
    pub fn b1481(&mut self) -> B1481_W<MPCBB1_VCTR46rs> {
        B1481_W::new(self, 9)
    }
    ///Bit 10 - B1482
    #[inline(always)]
    pub fn b1482(&mut self) -> B1482_W<MPCBB1_VCTR46rs> {
        B1482_W::new(self, 10)
    }
    ///Bit 11 - B1483
    #[inline(always)]
    pub fn b1483(&mut self) -> B1483_W<MPCBB1_VCTR46rs> {
        B1483_W::new(self, 11)
    }
    ///Bit 12 - B1484
    #[inline(always)]
    pub fn b1484(&mut self) -> B1484_W<MPCBB1_VCTR46rs> {
        B1484_W::new(self, 12)
    }
    ///Bit 13 - B1485
    #[inline(always)]
    pub fn b1485(&mut self) -> B1485_W<MPCBB1_VCTR46rs> {
        B1485_W::new(self, 13)
    }
    ///Bit 14 - B1486
    #[inline(always)]
    pub fn b1486(&mut self) -> B1486_W<MPCBB1_VCTR46rs> {
        B1486_W::new(self, 14)
    }
    ///Bit 15 - B1487
    #[inline(always)]
    pub fn b1487(&mut self) -> B1487_W<MPCBB1_VCTR46rs> {
        B1487_W::new(self, 15)
    }
    ///Bit 16 - B1488
    #[inline(always)]
    pub fn b1488(&mut self) -> B1488_W<MPCBB1_VCTR46rs> {
        B1488_W::new(self, 16)
    }
    ///Bit 17 - B1489
    #[inline(always)]
    pub fn b1489(&mut self) -> B1489_W<MPCBB1_VCTR46rs> {
        B1489_W::new(self, 17)
    }
    ///Bit 18 - B1490
    #[inline(always)]
    pub fn b1490(&mut self) -> B1490_W<MPCBB1_VCTR46rs> {
        B1490_W::new(self, 18)
    }
    ///Bit 19 - B1491
    #[inline(always)]
    pub fn b1491(&mut self) -> B1491_W<MPCBB1_VCTR46rs> {
        B1491_W::new(self, 19)
    }
    ///Bit 20 - B1492
    #[inline(always)]
    pub fn b1492(&mut self) -> B1492_W<MPCBB1_VCTR46rs> {
        B1492_W::new(self, 20)
    }
    ///Bit 21 - B1493
    #[inline(always)]
    pub fn b1493(&mut self) -> B1493_W<MPCBB1_VCTR46rs> {
        B1493_W::new(self, 21)
    }
    ///Bit 22 - B1494
    #[inline(always)]
    pub fn b1494(&mut self) -> B1494_W<MPCBB1_VCTR46rs> {
        B1494_W::new(self, 22)
    }
    ///Bit 23 - B1495
    #[inline(always)]
    pub fn b1495(&mut self) -> B1495_W<MPCBB1_VCTR46rs> {
        B1495_W::new(self, 23)
    }
    ///Bit 24 - B1496
    #[inline(always)]
    pub fn b1496(&mut self) -> B1496_W<MPCBB1_VCTR46rs> {
        B1496_W::new(self, 24)
    }
    ///Bit 25 - B1497
    #[inline(always)]
    pub fn b1497(&mut self) -> B1497_W<MPCBB1_VCTR46rs> {
        B1497_W::new(self, 25)
    }
    ///Bit 26 - B1498
    #[inline(always)]
    pub fn b1498(&mut self) -> B1498_W<MPCBB1_VCTR46rs> {
        B1498_W::new(self, 26)
    }
    ///Bit 27 - B1499
    #[inline(always)]
    pub fn b1499(&mut self) -> B1499_W<MPCBB1_VCTR46rs> {
        B1499_W::new(self, 27)
    }
    ///Bit 28 - B1500
    #[inline(always)]
    pub fn b1500(&mut self) -> B1500_W<MPCBB1_VCTR46rs> {
        B1500_W::new(self, 28)
    }
    ///Bit 29 - B1501
    #[inline(always)]
    pub fn b1501(&mut self) -> B1501_W<MPCBB1_VCTR46rs> {
        B1501_W::new(self, 29)
    }
    ///Bit 30 - B1502
    #[inline(always)]
    pub fn b1502(&mut self) -> B1502_W<MPCBB1_VCTR46rs> {
        B1502_W::new(self, 30)
    }
    ///Bit 31 - B1503
    #[inline(always)]
    pub fn b1503(&mut self) -> B1503_W<MPCBB1_VCTR46rs> {
        B1503_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr46::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr46::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR46)*/
pub struct MPCBB1_VCTR46rs;
impl crate::RegisterSpec for MPCBB1_VCTR46rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr46::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR46rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr46::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR46rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR46 to value 0
impl crate::Resettable for MPCBB1_VCTR46rs {
