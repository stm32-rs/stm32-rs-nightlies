///Register `MPCBB1_VCTR53` reader
pub type R = crate::R<MPCBB1_VCTR53rs>;
///Register `MPCBB1_VCTR53` writer
pub type W = crate::W<MPCBB1_VCTR53rs>;
...
impl W {
    ///Bit 0 - B1696
    #[inline(always)]
    pub fn b1696(&mut self) -> B1696_W<MPCBB1_VCTR53rs> {
        B1696_W::new(self, 0)
    }
    ///Bit 1 - B1697
    #[inline(always)]
    pub fn b1697(&mut self) -> B1697_W<MPCBB1_VCTR53rs> {
        B1697_W::new(self, 1)
    }
    ///Bit 2 - B1698
    #[inline(always)]
    pub fn b1698(&mut self) -> B1698_W<MPCBB1_VCTR53rs> {
        B1698_W::new(self, 2)
    }
    ///Bit 3 - B1699
    #[inline(always)]
    pub fn b1699(&mut self) -> B1699_W<MPCBB1_VCTR53rs> {
        B1699_W::new(self, 3)
    }
    ///Bit 4 - B1700
    #[inline(always)]
    pub fn b1700(&mut self) -> B1700_W<MPCBB1_VCTR53rs> {
        B1700_W::new(self, 4)
    }
    ///Bit 5 - B1701
    #[inline(always)]
    pub fn b1701(&mut self) -> B1701_W<MPCBB1_VCTR53rs> {
        B1701_W::new(self, 5)
    }
    ///Bit 6 - B1702
    #[inline(always)]
    pub fn b1702(&mut self) -> B1702_W<MPCBB1_VCTR53rs> {
        B1702_W::new(self, 6)
    }
    ///Bit 7 - B1703
    #[inline(always)]
    pub fn b1703(&mut self) -> B1703_W<MPCBB1_VCTR53rs> {
        B1703_W::new(self, 7)
    }
    ///Bit 8 - B1704
    #[inline(always)]
    pub fn b1704(&mut self) -> B1704_W<MPCBB1_VCTR53rs> {
        B1704_W::new(self, 8)
    }
    ///Bit 9 - B1705
    #[inline(always)]
    pub fn b1705(&mut self) -> B1705_W<MPCBB1_VCTR53rs> {
        B1705_W::new(self, 9)
    }
    ///Bit 10 - B1706
    #[inline(always)]
    pub fn b1706(&mut self) -> B1706_W<MPCBB1_VCTR53rs> {
        B1706_W::new(self, 10)
    }
    ///Bit 11 - B1707
    #[inline(always)]
    pub fn b1707(&mut self) -> B1707_W<MPCBB1_VCTR53rs> {
        B1707_W::new(self, 11)
    }
    ///Bit 12 - B1708
    #[inline(always)]
    pub fn b1708(&mut self) -> B1708_W<MPCBB1_VCTR53rs> {
        B1708_W::new(self, 12)
    }
    ///Bit 13 - B1709
    #[inline(always)]
    pub fn b1709(&mut self) -> B1709_W<MPCBB1_VCTR53rs> {
        B1709_W::new(self, 13)
    }
    ///Bit 14 - B1710
    #[inline(always)]
    pub fn b1710(&mut self) -> B1710_W<MPCBB1_VCTR53rs> {
        B1710_W::new(self, 14)
    }
    ///Bit 15 - B1711
    #[inline(always)]
    pub fn b1711(&mut self) -> B1711_W<MPCBB1_VCTR53rs> {
        B1711_W::new(self, 15)
    }
    ///Bit 16 - B1712
    #[inline(always)]
    pub fn b1712(&mut self) -> B1712_W<MPCBB1_VCTR53rs> {
        B1712_W::new(self, 16)
    }
    ///Bit 17 - B1713
    #[inline(always)]
    pub fn b1713(&mut self) -> B1713_W<MPCBB1_VCTR53rs> {
        B1713_W::new(self, 17)
    }
    ///Bit 18 - B1714
    #[inline(always)]
    pub fn b1714(&mut self) -> B1714_W<MPCBB1_VCTR53rs> {
        B1714_W::new(self, 18)
    }
    ///Bit 19 - B1715
    #[inline(always)]
    pub fn b1715(&mut self) -> B1715_W<MPCBB1_VCTR53rs> {
        B1715_W::new(self, 19)
    }
    ///Bit 20 - B1716
    #[inline(always)]
    pub fn b1716(&mut self) -> B1716_W<MPCBB1_VCTR53rs> {
        B1716_W::new(self, 20)
    }
    ///Bit 21 - B1717
    #[inline(always)]
    pub fn b1717(&mut self) -> B1717_W<MPCBB1_VCTR53rs> {
        B1717_W::new(self, 21)
    }
    ///Bit 22 - B1718
    #[inline(always)]
    pub fn b1718(&mut self) -> B1718_W<MPCBB1_VCTR53rs> {
        B1718_W::new(self, 22)
    }
    ///Bit 23 - B1719
    #[inline(always)]
    pub fn b1719(&mut self) -> B1719_W<MPCBB1_VCTR53rs> {
        B1719_W::new(self, 23)
    }
    ///Bit 24 - B1720
    #[inline(always)]
    pub fn b1720(&mut self) -> B1720_W<MPCBB1_VCTR53rs> {
        B1720_W::new(self, 24)
    }
    ///Bit 25 - B1721
    #[inline(always)]
    pub fn b1721(&mut self) -> B1721_W<MPCBB1_VCTR53rs> {
        B1721_W::new(self, 25)
    }
    ///Bit 26 - B1722
    #[inline(always)]
    pub fn b1722(&mut self) -> B1722_W<MPCBB1_VCTR53rs> {
        B1722_W::new(self, 26)
    }
    ///Bit 27 - B1723
    #[inline(always)]
    pub fn b1723(&mut self) -> B1723_W<MPCBB1_VCTR53rs> {
        B1723_W::new(self, 27)
    }
    ///Bit 28 - B1724
    #[inline(always)]
    pub fn b1724(&mut self) -> B1724_W<MPCBB1_VCTR53rs> {
        B1724_W::new(self, 28)
    }
    ///Bit 29 - B1725
    #[inline(always)]
    pub fn b1725(&mut self) -> B1725_W<MPCBB1_VCTR53rs> {
        B1725_W::new(self, 29)
    }
    ///Bit 30 - B1726
    #[inline(always)]
    pub fn b1726(&mut self) -> B1726_W<MPCBB1_VCTR53rs> {
        B1726_W::new(self, 30)
    }
    ///Bit 31 - B1727
    #[inline(always)]
    pub fn b1727(&mut self) -> B1727_W<MPCBB1_VCTR53rs> {
        B1727_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb1_vctr53::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_vctr53::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#SEC_GTZC_MPCBB1:MPCBB1_VCTR53)*/
pub struct MPCBB1_VCTR53rs;
impl crate::RegisterSpec for MPCBB1_VCTR53rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb1_vctr53::R`](R) reader structure
impl crate::Readable for MPCBB1_VCTR53rs {}
///`write(|w| ..)` method takes [`mpcbb1_vctr53::W`](W) writer structure
impl crate::Writable for MPCBB1_VCTR53rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_VCTR53 to value 0
impl crate::Resettable for MPCBB1_VCTR53rs {
