///Register `MPCBB2_VCTR24` reader
pub type R = crate::R<MPCBB2_VCTR24rs>;
///Register `MPCBB2_VCTR24` writer
pub type W = crate::W<MPCBB2_VCTR24rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b768(&mut self) -> B768_W<MPCBB2_VCTR24rs> {
        B768_W::new(self, 0)
    }
    ///Bit 1 - B769
    #[inline(always)]
    #[must_use]
    pub fn b769(&mut self) -> B769_W<MPCBB2_VCTR24rs> {
        B769_W::new(self, 1)
    }
    ///Bit 2 - B770
    #[inline(always)]
    #[must_use]
    pub fn b770(&mut self) -> B770_W<MPCBB2_VCTR24rs> {
        B770_W::new(self, 2)
    }
    ///Bit 3 - B771
    #[inline(always)]
    #[must_use]
    pub fn b771(&mut self) -> B771_W<MPCBB2_VCTR24rs> {
        B771_W::new(self, 3)
    }
    ///Bit 4 - B772
    #[inline(always)]
    #[must_use]
    pub fn b772(&mut self) -> B772_W<MPCBB2_VCTR24rs> {
        B772_W::new(self, 4)
    }
    ///Bit 5 - B773
    #[inline(always)]
    #[must_use]
    pub fn b773(&mut self) -> B773_W<MPCBB2_VCTR24rs> {
        B773_W::new(self, 5)
    }
    ///Bit 6 - B774
    #[inline(always)]
    #[must_use]
    pub fn b774(&mut self) -> B774_W<MPCBB2_VCTR24rs> {
        B774_W::new(self, 6)
    }
    ///Bit 7 - B775
    #[inline(always)]
    #[must_use]
    pub fn b775(&mut self) -> B775_W<MPCBB2_VCTR24rs> {
        B775_W::new(self, 7)
    }
    ///Bit 8 - B776
    #[inline(always)]
    #[must_use]
    pub fn b776(&mut self) -> B776_W<MPCBB2_VCTR24rs> {
        B776_W::new(self, 8)
    }
    ///Bit 9 - B777
    #[inline(always)]
    #[must_use]
    pub fn b777(&mut self) -> B777_W<MPCBB2_VCTR24rs> {
        B777_W::new(self, 9)
    }
    ///Bit 10 - B778
    #[inline(always)]
    #[must_use]
    pub fn b778(&mut self) -> B778_W<MPCBB2_VCTR24rs> {
        B778_W::new(self, 10)
    }
    ///Bit 11 - B779
    #[inline(always)]
    #[must_use]
    pub fn b779(&mut self) -> B779_W<MPCBB2_VCTR24rs> {
        B779_W::new(self, 11)
    }
    ///Bit 12 - B780
    #[inline(always)]
    #[must_use]
    pub fn b780(&mut self) -> B780_W<MPCBB2_VCTR24rs> {
        B780_W::new(self, 12)
    }
    ///Bit 13 - B781
    #[inline(always)]
    #[must_use]
    pub fn b781(&mut self) -> B781_W<MPCBB2_VCTR24rs> {
        B781_W::new(self, 13)
    }
    ///Bit 14 - B782
    #[inline(always)]
    #[must_use]
    pub fn b782(&mut self) -> B782_W<MPCBB2_VCTR24rs> {
        B782_W::new(self, 14)
    }
    ///Bit 15 - B783
    #[inline(always)]
    #[must_use]
    pub fn b783(&mut self) -> B783_W<MPCBB2_VCTR24rs> {
        B783_W::new(self, 15)
    }
    ///Bit 16 - B784
    #[inline(always)]
    #[must_use]
    pub fn b784(&mut self) -> B784_W<MPCBB2_VCTR24rs> {
        B784_W::new(self, 16)
    }
    ///Bit 17 - B785
    #[inline(always)]
    #[must_use]
    pub fn b785(&mut self) -> B785_W<MPCBB2_VCTR24rs> {
        B785_W::new(self, 17)
    }
    ///Bit 18 - B786
    #[inline(always)]
    #[must_use]
    pub fn b786(&mut self) -> B786_W<MPCBB2_VCTR24rs> {
        B786_W::new(self, 18)
    }
    ///Bit 19 - B787
    #[inline(always)]
    #[must_use]
    pub fn b787(&mut self) -> B787_W<MPCBB2_VCTR24rs> {
        B787_W::new(self, 19)
    }
    ///Bit 20 - B788
    #[inline(always)]
    #[must_use]
    pub fn b788(&mut self) -> B788_W<MPCBB2_VCTR24rs> {
        B788_W::new(self, 20)
    }
    ///Bit 21 - B789
    #[inline(always)]
    #[must_use]
    pub fn b789(&mut self) -> B789_W<MPCBB2_VCTR24rs> {
        B789_W::new(self, 21)
    }
    ///Bit 22 - B790
    #[inline(always)]
    #[must_use]
    pub fn b790(&mut self) -> B790_W<MPCBB2_VCTR24rs> {
        B790_W::new(self, 22)
    }
    ///Bit 23 - B791
    #[inline(always)]
    #[must_use]
    pub fn b791(&mut self) -> B791_W<MPCBB2_VCTR24rs> {
        B791_W::new(self, 23)
    }
    ///Bit 24 - B792
    #[inline(always)]
    #[must_use]
    pub fn b792(&mut self) -> B792_W<MPCBB2_VCTR24rs> {
        B792_W::new(self, 24)
    }
    ///Bit 25 - B793
    #[inline(always)]
    #[must_use]
    pub fn b793(&mut self) -> B793_W<MPCBB2_VCTR24rs> {
        B793_W::new(self, 25)
    }
    ///Bit 26 - B794
    #[inline(always)]
    #[must_use]
    pub fn b794(&mut self) -> B794_W<MPCBB2_VCTR24rs> {
        B794_W::new(self, 26)
    }
    ///Bit 27 - B795
    #[inline(always)]
    #[must_use]
    pub fn b795(&mut self) -> B795_W<MPCBB2_VCTR24rs> {
        B795_W::new(self, 27)
    }
    ///Bit 28 - B796
    #[inline(always)]
    #[must_use]
    pub fn b796(&mut self) -> B796_W<MPCBB2_VCTR24rs> {
        B796_W::new(self, 28)
    }
    ///Bit 29 - B797
    #[inline(always)]
    #[must_use]
    pub fn b797(&mut self) -> B797_W<MPCBB2_VCTR24rs> {
        B797_W::new(self, 29)
    }
    ///Bit 30 - B798
    #[inline(always)]
    #[must_use]
    pub fn b798(&mut self) -> B798_W<MPCBB2_VCTR24rs> {
        B798_W::new(self, 30)
    }
    ///Bit 31 - B799
    #[inline(always)]
    #[must_use]
    pub fn b799(&mut self) -> B799_W<MPCBB2_VCTR24rs> {
        B799_W::new(self, 31)
    }
}
/**MPCBBx vector register

You can [`read`](crate::Reg::read) this register and get [`mpcbb2_vctr24::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb2_vctr24::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#SEC_GTZC_MPCBB2:MPCBB2_VCTR24)*/
pub struct MPCBB2_VCTR24rs;
impl crate::RegisterSpec for MPCBB2_VCTR24rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb2_vctr24::R`](R) reader structure
impl crate::Readable for MPCBB2_VCTR24rs {}
///`write(|w| ..)` method takes [`mpcbb2_vctr24::W`](W) writer structure
impl crate::Writable for MPCBB2_VCTR24rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB2_VCTR24 to value 0
impl crate::Resettable for MPCBB2_VCTR24rs {
