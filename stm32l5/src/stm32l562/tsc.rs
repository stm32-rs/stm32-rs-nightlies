...
#[doc = "I/O group x counter register"]
pub mod iog7cr;
#[doc = "I/O group x counter register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [iog8cr](iog8cr) module"]
pub type IOG8CR = crate::Reg<u32, _IOG8CR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _IOG8CR;
#[doc = "`read()` method returns [iog8cr::R](iog8cr::R) reader structure"]
impl crate::Readable for IOG8CR {}
#[doc = "I/O group x counter register"]
pub mod iog8cr;
