...
pub type DCDET_W<'a, REG> = crate::BitWriter<'a, REG, DCDET>;
impl<'a, REG> DCDET_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///data lines contact not detected
    ...
    pub fn not_detected(self) -> &'a mut crate::W<REG> {
        self.variant(DCDET::NotDetected)
    }
    ///data lines contact detected
    #[inline(always)]
    pub fn detected(self) -> &'a mut crate::W<REG> {
        self.variant(DCDET::Detected)
    }
}
...
pub type PDET_W<'a, REG> = crate::BitWriter<'a, REG, PDET>;
impl<'a, REG> PDET_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///no BCD support detected
    #[inline(always)]
    pub fn no_bcd(self) -> &'a mut crate::W<REG> {
        self.variant(PDET::NoBcd)
    }
    ///BCD support detected
    #[inline(always)]
    pub fn bcd(self) -> &'a mut crate::W<REG> {
        self.variant(PDET::Bcd)
    }
}
...
pub type SDET_W<'a, REG> = crate::BitWriter<'a, REG, SDET>;
impl<'a, REG> SDET_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///CDP detected
    #[inline(always)]
    pub fn cdp(self) -> &'a mut crate::W<REG> {
        self.variant(SDET::Cdp)
    }
    ///DCP detected
    #[inline(always)]
    pub fn dcp(self) -> &'a mut crate::W<REG> {
        self.variant(SDET::Dcp)
    }
}
...
pub type PS2DET_W<'a, REG> = crate::BitWriter<'a, REG, PS2DET>;
impl<'a, REG> PS2DET_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Normal port detected
    ...
    pub fn normal(self) -> &'a mut crate::W<REG> {
        self.variant(PS2DET::Normal)
    }
    ///PS2 port or proprietary charger detected
    #[inline(always)]
    pub fn ps2(self) -> &'a mut crate::W<REG> {
        self.variant(PS2DET::Ps2)
    }
}
/**DP pull-up control
...
impl W {
    ...
    ///Bit 4 - Data contact detection (DCD) status
    #[inline(always)]
    pub fn dcdet(&mut self) -> DCDET_W<'_, BCDRrs> {
        DCDET_W::new(self, 4)
    }
    ///Bit 5 - Primary detection (PD) status
    #[inline(always)]
    pub fn pdet(&mut self) -> PDET_W<'_, BCDRrs> {
        PDET_W::new(self, 5)
    }
    ///Bit 6 - Secondary detection (SD) status
    #[inline(always)]
    pub fn sdet(&mut self) -> SDET_W<'_, BCDRrs> {
        SDET_W::new(self, 6)
    }
    ///Bit 7 - DM pull-up detection status
    #[inline(always)]
    pub fn ps2det(&mut self) -> PS2DET_W<'_, BCDRrs> {
        PS2DET_W::new(self, 7)
    }
    ///Bit 15 - DP pull-up control
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32L562.html#USB:BCDR)*/
pub struct BCDRrs;
