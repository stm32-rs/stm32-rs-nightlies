///Register `AXIMC_M6_FN_MOD_AHB` reader
pub type R = crate::R<AXIMC_M6_FN_MOD_AHBrs>;
///Register `AXIMC_M6_FN_MOD_AHB` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AXIMC_M6_FN_MOD_AHB")
...
You can [`read`](crate::Reg::read) this register and get [`aximc_m6_fn_mod_ahb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`aximc_m6_fn_mod_ahb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#AXIMC_Mx:AXIMC_M6_FN_MOD_AHB)*/
pub struct AXIMC_M6_FN_MOD_AHBrs;
impl crate::RegisterSpec for AXIMC_M6_FN_MOD_AHBrs {
    type Ux = u32;
}
///`read()` method returns [`aximc_m6_fn_mod_ahb::R`](R) reader structure
impl crate::Readable for AXIMC_M6_FN_MOD_AHBrs {}
///`write(|w| ..)` method takes [`aximc_m6_fn_mod_ahb::W`](W) writer structure
impl crate::Writable for AXIMC_M6_FN_MOD_AHBrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets AXIMC_M6_FN_MOD_AHB to value 0
