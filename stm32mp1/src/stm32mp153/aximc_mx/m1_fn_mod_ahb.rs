///Register `M1_FN_MOD_AHB` reader
pub type R = crate::R<M1_FN_MOD_AHBrs>;
///Register `M1_FN_MOD_AHB` writer
pub type W = crate::W<M1_FN_MOD_AHBrs>;
...
impl W {
    ///Bit 0 - RD_INC_OVERRIDE
    #[inline(always)]
    pub fn rd_inc_override(&mut self) -> RD_INC_OVERRIDE_W<'_, M1_FN_MOD_AHBrs> {
        RD_INC_OVERRIDE_W::new(self, 0)
    }
    ///Bit 1 - WR_INC_OVERRIDE
    #[inline(always)]
    pub fn wr_inc_override(&mut self) -> WR_INC_OVERRIDE_W<'_, M1_FN_MOD_AHBrs> {
        WR_INC_OVERRIDE_W::new(self, 1)
    }
}
/**AXIMC master 1 AHB conversion override functionality register

You can [`read`](crate::Reg::read) this register and get [`m1_fn_mod_ahb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m1_fn_mod_ahb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#AXIMC_Mx:M1_FN_MOD_AHB)*/
pub struct M1_FN_MOD_AHBrs;
impl crate::RegisterSpec for M1_FN_MOD_AHBrs {
    type Ux = u32;
}
///`read()` method returns [`m1_fn_mod_ahb::R`](R) reader structure
impl crate::Readable for M1_FN_MOD_AHBrs {}
///`write(|w| ..)` method takes [`m1_fn_mod_ahb::W`](W) writer structure
impl crate::Writable for M1_FN_MOD_AHBrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets M1_FN_MOD_AHB to value 0
impl crate::Resettable for M1_FN_MOD_AHBrs {}
