///Register `M7_FN_MOD` reader
pub type R = crate::R<M7_FN_MODrs>;
///Register `M7_FN_MOD` writer
pub type W = crate::W<M7_FN_MODrs>;
...
impl W {
    ///Bit 0 - READ_ISS_OVERRIDE
    #[inline(always)]
    pub fn read_iss_override(&mut self) -> READ_ISS_OVERRIDE_W<'_, M7_FN_MODrs> {
        READ_ISS_OVERRIDE_W::new(self, 0)
    }
    ///Bit 1 - WRITE_ISS_OVERRIDE
    #[inline(always)]
    pub fn write_iss_override(&mut self) -> WRITE_ISS_OVERRIDE_W<'_, M7_FN_MODrs> {
        WRITE_ISS_OVERRIDE_W::new(self, 1)
    }
}
/**AXIMC master 7 issuing capability override functionality register

You can [`read`](crate::Reg::read) this register and get [`m7_fn_mod::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m7_fn_mod::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#AXIMC_Mx:M7_FN_MOD)*/
pub struct M7_FN_MODrs;
impl crate::RegisterSpec for M7_FN_MODrs {
    type Ux = u32;
}
///`read()` method returns [`m7_fn_mod::R`](R) reader structure
impl crate::Readable for M7_FN_MODrs {}
///`write(|w| ..)` method takes [`m7_fn_mod::W`](W) writer structure
impl crate::Writable for M7_FN_MODrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets M7_FN_MOD to value 0
impl crate::Resettable for M7_FN_MODrs {}
