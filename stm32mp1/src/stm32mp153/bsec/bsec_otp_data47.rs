///Register `BSEC_OTP_DATA47` reader
pub type R = crate::R<BSEC_OTP_DATA47rs>;
///Register `BSEC_OTP_DATA47` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BSEC_OTP_DATA47")
...
You can [`read`](crate::Reg::read) this register and get [`bsec_otp_data47::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bsec_otp_data47::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`bsec_otp_data47::R`](R) reader structure
impl crate::Readable for BSEC_OTP_DATA47rs {}
///`write(|w| ..)` method takes [`bsec_otp_data47::W`](W) writer structure
impl crate::Writable for BSEC_OTP_DATA47rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets BSEC_OTP_DATA47 to value 0
