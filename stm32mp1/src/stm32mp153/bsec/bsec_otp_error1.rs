...
pub type R = crate::R<BSEC_OTP_ERROR1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BSEC_OTP_ERROR1")
            .field("err", &self.err())
            .finish()
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`bsec_otp_error1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#BSEC:BSEC_OTP_ERROR1)*/
pub struct BSEC_OTP_ERROR1rs;
impl crate::RegisterSpec for BSEC_OTP_ERROR1rs {
    type Ux = u32;
}
///`read()` method returns [`bsec_otp_error1::R`](R) reader structure
impl crate::Readable for BSEC_OTP_ERROR1rs {}
///`reset()` method sets BSEC_OTP_ERROR1 to value 0
impl crate::Resettable for BSEC_OTP_ERROR1rs {
