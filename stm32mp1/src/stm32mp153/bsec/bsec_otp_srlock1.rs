...
pub type R = crate::R<BSEC_OTP_SRLOCK1rs>;
///Register `BSEC_OTP_SRLOCK1` writer
pub type W = crate::W<BSEC_OTP_SRLOCK1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BSEC_OTP_SRLOCK1")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srlock(&mut self) -> SRLOCK_W<BSEC_OTP_SRLOCK1rs> {
        SRLOCK_W::new(self, 0)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`bsec_otp_srlock1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bsec_otp_srlock1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#BSEC:BSEC_OTP_SRLOCK1)*/
pub struct BSEC_OTP_SRLOCK1rs;
impl crate::RegisterSpec for BSEC_OTP_SRLOCK1rs {
    type Ux = u32;
}
///`read()` method returns [`bsec_otp_srlock1::R`](R) reader structure
impl crate::Readable for BSEC_OTP_SRLOCK1rs {}
///`write(|w| ..)` method takes [`bsec_otp_srlock1::W`](W) writer structure
impl crate::Writable for BSEC_OTP_SRLOCK1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets BSEC_OTP_SRLOCK1 to value 0
impl crate::Resettable for BSEC_OTP_SRLOCK1rs {
