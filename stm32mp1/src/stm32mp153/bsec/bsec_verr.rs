...
You can [`read`](crate::Reg::read) this register and get [`bsec_verr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`bsec_verr::R`](R) reader structure
impl crate::Readable for BSEC_VERRrs {}
///`reset()` method sets BSEC_VERR to value 0x11
