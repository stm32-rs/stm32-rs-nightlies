///Register `CRYP_CSGCMCCM6R` reader
pub type R = crate::R<CRYP_CSGCMCCM6Rrs>;
///Register `CRYP_CSGCMCCM6R` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CRYP_CSGCMCCM6R")
...
You can [`read`](crate::Reg::read) this register and get [`cryp_csgcmccm6r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cryp_csgcmccm6r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`cryp_csgcmccm6r::R`](R) reader structure
impl crate::Readable for CRYP_CSGCMCCM6Rrs {}
///`write(|w| ..)` method takes [`cryp_csgcmccm6r::W`](W) writer structure
impl crate::Writable for CRYP_CSGCMCCM6Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CRYP_CSGCMCCM6R to value 0
