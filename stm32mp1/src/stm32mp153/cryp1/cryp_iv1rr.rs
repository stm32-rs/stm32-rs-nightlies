...
pub type R = crate::R<CRYP_IV1RRrs>;
///Register `CRYP_IV1RR` writer
pub type W = crate::W<CRYP_IV1RRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iv127(&mut self) -> IV127_W<CRYP_IV1RRrs> {
        IV127_W::new(self, 0)
    }
    ///Bit 1 - IV126
    #[inline(always)]
    #[must_use]
    pub fn iv126(&mut self) -> IV126_W<CRYP_IV1RRrs> {
        IV126_W::new(self, 1)
    }
    ///Bit 2 - IV125
    #[inline(always)]
    #[must_use]
    pub fn iv125(&mut self) -> IV125_W<CRYP_IV1RRrs> {
        IV125_W::new(self, 2)
    }
    ///Bit 3 - IV124
    #[inline(always)]
    #[must_use]
    pub fn iv124(&mut self) -> IV124_W<CRYP_IV1RRrs> {
        IV124_W::new(self, 3)
    }
    ///Bit 4 - IV123
    #[inline(always)]
    #[must_use]
    pub fn iv123(&mut self) -> IV123_W<CRYP_IV1RRrs> {
        IV123_W::new(self, 4)
    }
    ///Bit 5 - IV122
    #[inline(always)]
    #[must_use]
    pub fn iv122(&mut self) -> IV122_W<CRYP_IV1RRrs> {
        IV122_W::new(self, 5)
    }
    ///Bit 6 - IV121
    #[inline(always)]
    #[must_use]
    pub fn iv121(&mut self) -> IV121_W<CRYP_IV1RRrs> {
        IV121_W::new(self, 6)
    }
    ///Bit 7 - IV120
    #[inline(always)]
    #[must_use]
    pub fn iv120(&mut self) -> IV120_W<CRYP_IV1RRrs> {
        IV120_W::new(self, 7)
    }
    ///Bit 8 - IV119
    #[inline(always)]
    #[must_use]
    pub fn iv119(&mut self) -> IV119_W<CRYP_IV1RRrs> {
        IV119_W::new(self, 8)
    }
    ///Bit 9 - IV118
    #[inline(always)]
    #[must_use]
    pub fn iv118(&mut self) -> IV118_W<CRYP_IV1RRrs> {
        IV118_W::new(self, 9)
    }
    ///Bit 10 - IV117
    #[inline(always)]
    #[must_use]
    pub fn iv117(&mut self) -> IV117_W<CRYP_IV1RRrs> {
        IV117_W::new(self, 10)
    }
    ///Bit 11 - IV116
    #[inline(always)]
    #[must_use]
    pub fn iv116(&mut self) -> IV116_W<CRYP_IV1RRrs> {
        IV116_W::new(self, 11)
    }
    ///Bit 12 - IV115
    #[inline(always)]
    #[must_use]
    pub fn iv115(&mut self) -> IV115_W<CRYP_IV1RRrs> {
        IV115_W::new(self, 12)
    }
    ///Bit 13 - IV114
    #[inline(always)]
    #[must_use]
    pub fn iv114(&mut self) -> IV114_W<CRYP_IV1RRrs> {
        IV114_W::new(self, 13)
    }
    ///Bit 14 - IV113
    #[inline(always)]
    #[must_use]
    pub fn iv113(&mut self) -> IV113_W<CRYP_IV1RRrs> {
        IV113_W::new(self, 14)
    }
    ///Bit 15 - IV112
    #[inline(always)]
    #[must_use]
    pub fn iv112(&mut self) -> IV112_W<CRYP_IV1RRrs> {
        IV112_W::new(self, 15)
    }
    ///Bit 16 - IV111
    #[inline(always)]
    #[must_use]
    pub fn iv111(&mut self) -> IV111_W<CRYP_IV1RRrs> {
        IV111_W::new(self, 16)
    }
    ///Bit 17 - IV110
    #[inline(always)]
    #[must_use]
    pub fn iv110(&mut self) -> IV110_W<CRYP_IV1RRrs> {
        IV110_W::new(self, 17)
    }
    ///Bit 18 - IV109
    #[inline(always)]
    #[must_use]
    pub fn iv109(&mut self) -> IV109_W<CRYP_IV1RRrs> {
        IV109_W::new(self, 18)
    }
    ///Bit 19 - IV108
    #[inline(always)]
    #[must_use]
    pub fn iv108(&mut self) -> IV108_W<CRYP_IV1RRrs> {
        IV108_W::new(self, 19)
    }
    ///Bit 20 - IV107
    #[inline(always)]
    #[must_use]
    pub fn iv107(&mut self) -> IV107_W<CRYP_IV1RRrs> {
        IV107_W::new(self, 20)
    }
    ///Bit 21 - IV106
    #[inline(always)]
    #[must_use]
    pub fn iv106(&mut self) -> IV106_W<CRYP_IV1RRrs> {
        IV106_W::new(self, 21)
    }
    ///Bit 22 - IV105
    #[inline(always)]
    #[must_use]
    pub fn iv105(&mut self) -> IV105_W<CRYP_IV1RRrs> {
        IV105_W::new(self, 22)
    }
    ///Bit 23 - IV104
    #[inline(always)]
    #[must_use]
    pub fn iv104(&mut self) -> IV104_W<CRYP_IV1RRrs> {
        IV104_W::new(self, 23)
    }
    ///Bit 24 - IV103
    #[inline(always)]
    #[must_use]
    pub fn iv103(&mut self) -> IV103_W<CRYP_IV1RRrs> {
        IV103_W::new(self, 24)
    }
    ///Bit 25 - IV102
    #[inline(always)]
    #[must_use]
    pub fn iv102(&mut self) -> IV102_W<CRYP_IV1RRrs> {
        IV102_W::new(self, 25)
    }
    ///Bit 26 - IV101
    #[inline(always)]
    #[must_use]
    pub fn iv101(&mut self) -> IV101_W<CRYP_IV1RRrs> {
        IV101_W::new(self, 26)
    }
    ///Bit 27 - IV100
    #[inline(always)]
    #[must_use]
    pub fn iv100(&mut self) -> IV100_W<CRYP_IV1RRrs> {
        IV100_W::new(self, 27)
    }
    ///Bit 28 - IV99
    #[inline(always)]
    #[must_use]
    pub fn iv99(&mut self) -> IV99_W<CRYP_IV1RRrs> {
        IV99_W::new(self, 28)
    }
    ///Bit 29 - IV98
    #[inline(always)]
    #[must_use]
    pub fn iv98(&mut self) -> IV98_W<CRYP_IV1RRrs> {
        IV98_W::new(self, 29)
    }
    ///Bit 30 - IV97
    #[inline(always)]
    #[must_use]
    pub fn iv97(&mut self) -> IV97_W<CRYP_IV1RRrs> {
        IV97_W::new(self, 30)
    }
    ///Bit 31 - IV96
    #[inline(always)]
    #[must_use]
    pub fn iv96(&mut self) -> IV96_W<CRYP_IV1RRrs> {
        IV96_W::new(self, 31)
    }
}
/**Refer to Section39.6.17: CRYP initialization vector register 0L (CRYP_IV0LR) for details.

You can [`read`](crate::Reg::read) this register and get [`cryp_iv1rr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cryp_iv1rr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#CRYP1:CRYP_IV1RR)*/
pub struct CRYP_IV1RRrs;
impl crate::RegisterSpec for CRYP_IV1RRrs {
    type Ux = u32;
}
///`read()` method returns [`cryp_iv1rr::R`](R) reader structure
impl crate::Readable for CRYP_IV1RRrs {}
///`write(|w| ..)` method takes [`cryp_iv1rr::W`](W) writer structure
impl crate::Writable for CRYP_IV1RRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CRYP_IV1RR to value 0
impl crate::Resettable for CRYP_IV1RRrs {
