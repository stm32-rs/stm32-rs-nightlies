...
///Field `FEC` reader - FEC
pub type FEC_R = crate::FieldReader;
///Field `FEC` writer - FEC
...
You can [`read`](crate::Reg::read) this register and get [`dcmi_escr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dcmi_escr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DCMI:DCMI_ESCR)*/
pub struct DCMI_ESCRrs;
impl crate::RegisterSpec for DCMI_ESCRrs {
    type Ux = u32;
}
///`read()` method returns [`dcmi_escr::R`](R) reader structure
impl crate::Readable for DCMI_ESCRrs {}
///`write(|w| ..)` method takes [`dcmi_escr::W`](W) writer structure
impl crate::Writable for DCMI_ESCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DCMI_ESCR to value 0
