...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addrmap_row_b6(&mut self) -> ADDRMAP_ROW_B6_W<ADDRMAP10rs> {
        ADDRMAP_ROW_B6_W::new(self, 0)
    }
    ///Bits 8:11 - ADDRMAP_ROW_B7
    #[inline(always)]
    #[must_use]
    pub fn addrmap_row_b7(&mut self) -> ADDRMAP_ROW_B7_W<ADDRMAP10rs> {
        ADDRMAP_ROW_B7_W::new(self, 8)
    }
    ///Bits 16:19 - ADDRMAP_ROW_B8
    #[inline(always)]
    #[must_use]
    pub fn addrmap_row_b8(&mut self) -> ADDRMAP_ROW_B8_W<ADDRMAP10rs> {
        ADDRMAP_ROW_B8_W::new(self, 16)
    }
    ///Bits 24:27 - ADDRMAP_ROW_B9
    #[inline(always)]
    #[must_use]
    pub fn addrmap_row_b9(&mut self) -> ADDRMAP_ROW_B9_W<ADDRMAP10rs> {
