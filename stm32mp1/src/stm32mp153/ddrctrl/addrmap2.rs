...
impl W {
    ///Bits 0:3 - ADDRMAP_COL_B2
    #[inline(always)]
    pub fn addrmap_col_b2(&mut self) -> ADDRMAP_COL_B2_W<ADDRMAP2rs> {
        ADDRMAP_COL_B2_W::new(self, 0)
    }
    ///Bits 8:11 - ADDRMAP_COL_B3
    #[inline(always)]
    pub fn addrmap_col_b3(&mut self) -> ADDRMAP_COL_B3_W<ADDRMAP2rs> {
        ADDRMAP_COL_B3_W::new(self, 8)
    }
    ///Bits 16:19 - ADDRMAP_COL_B4
    #[inline(always)]
    pub fn addrmap_col_b4(&mut self) -> ADDRMAP_COL_B4_W<ADDRMAP2rs> {
        ADDRMAP_COL_B4_W::new(self, 16)
    }
    ///Bits 24:27 - ADDRMAP_COL_B5
    #[inline(always)]
    pub fn addrmap_col_b5(&mut self) -> ADDRMAP_COL_B5_W<ADDRMAP2rs> {
