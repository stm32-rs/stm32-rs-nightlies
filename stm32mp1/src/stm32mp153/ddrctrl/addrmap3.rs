...
impl W {
    ///Bits 0:3 - ADDRMAP_COL_B6
    #[inline(always)]
    pub fn addrmap_col_b6(&mut self) -> ADDRMAP_COL_B6_W<ADDRMAP3rs> {
        ADDRMAP_COL_B6_W::new(self, 0)
    }
    ///Bits 8:12 - ADDRMAP_COL_B7
    #[inline(always)]
    pub fn addrmap_col_b7(&mut self) -> ADDRMAP_COL_B7_W<ADDRMAP3rs> {
        ADDRMAP_COL_B7_W::new(self, 8)
    }
    ///Bits 16:20 - ADDRMAP_COL_B8
    #[inline(always)]
    pub fn addrmap_col_b8(&mut self) -> ADDRMAP_COL_B8_W<ADDRMAP3rs> {
        ADDRMAP_COL_B8_W::new(self, 16)
    }
    ///Bits 24:28 - ADDRMAP_COL_B9
    #[inline(always)]
    pub fn addrmap_col_b9(&mut self) -> ADDRMAP_COL_B9_W<ADDRMAP3rs> {
