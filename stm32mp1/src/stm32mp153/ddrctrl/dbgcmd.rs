...
impl W {
    ///Bit 0 - RANK0_REFRESH
    #[inline(always)]
    pub fn rank0_refresh(&mut self) -> RANK0_REFRESH_W<DBGCMDrs> {
        RANK0_REFRESH_W::new(self, 0)
    }
    ///Bit 4 - ZQ_CALIB_SHORT
    #[inline(always)]
    pub fn zq_calib_short(&mut self) -> ZQ_CALIB_SHORT_W<DBGCMDrs> {
        ZQ_CALIB_SHORT_W::new(self, 4)
    }
    ///Bit 5 - CTRLUPD
    #[inline(always)]
    pub fn ctrlupd(&mut self) -> CTRLUPD_W<DBGCMDrs> {
