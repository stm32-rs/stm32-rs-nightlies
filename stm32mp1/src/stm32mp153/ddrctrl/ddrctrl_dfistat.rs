...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRCTRL_DFISTAT")
...
You can [`read`](crate::Reg::read) this register and get [`ddrctrl_dfistat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
