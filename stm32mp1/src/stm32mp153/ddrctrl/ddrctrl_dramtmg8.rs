...
pub struct T_XS_X32_R(crate::FieldReader<u8, u8>);
impl T_XS_X32_R {
    pub(crate) fn new(bits: u8) -> Self {
        T_XS_X32_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for T_XS_X32_R {
...
pub struct T_XS_DLL_X32_R(crate::FieldReader<u8, u8>);
impl T_XS_DLL_X32_R {
    pub(crate) fn new(bits: u8) -> Self {
        T_XS_DLL_X32_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for T_XS_DLL_X32_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
