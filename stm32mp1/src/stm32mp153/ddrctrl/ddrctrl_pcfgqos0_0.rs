///Register `DDRCTRL_PCFGQOS0_0` reader
pub type R = crate::R<DDRCTRL_PCFGQOS0_0rs>;
///Register `DDRCTRL_PCFGQOS0_0` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRCTRL_PCFGQOS0_0")
...
You can [`read`](crate::Reg::read) this register and get [`ddrctrl_pcfgqos0_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrctrl_pcfgqos0_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`ddrctrl_pcfgqos0_0::R`](R) reader structure
impl crate::Readable for DDRCTRL_PCFGQOS0_0rs {}
///`write(|w| ..)` method takes [`ddrctrl_pcfgqos0_0::W`](W) writer structure
impl crate::Writable for DDRCTRL_PCFGQOS0_0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRCTRL_PCFGQOS0_0 to value 0x0200_0e00
