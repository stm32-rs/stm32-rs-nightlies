...
pub type R = crate::R<DDRCTRL_PCFGR_1rs>;
///Register `DDRCTRL_PCFGR_1` writer
pub type W = crate::W<DDRCTRL_PCFGR_1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRCTRL_PCFGR_1")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rd_port_priority(&mut self) -> RD_PORT_PRIORITY_W<DDRCTRL_PCFGR_1rs> {
        RD_PORT_PRIORITY_W::new(self, 0)
    }
    ///Bit 12 - RD_PORT_AGING_EN
    #[inline(always)]
    #[must_use]
    pub fn rd_port_aging_en(&mut self) -> RD_PORT_AGING_EN_W<DDRCTRL_PCFGR_1rs> {
        RD_PORT_AGING_EN_W::new(self, 12)
    }
    ///Bit 13 - RD_PORT_URGENT_EN
    #[inline(always)]
    #[must_use]
    pub fn rd_port_urgent_en(&mut self) -> RD_PORT_URGENT_EN_W<DDRCTRL_PCFGR_1rs> {
        RD_PORT_URGENT_EN_W::new(self, 13)
    }
    ///Bit 14 - RD_PORT_PAGEMATCH_EN
    #[inline(always)]
    #[must_use]
    pub fn rd_port_pagematch_en(&mut self) -> RD_PORT_PAGEMATCH_EN_W<DDRCTRL_PCFGR_1rs> {
        RD_PORT_PAGEMATCH_EN_W::new(self, 14)
    }
    ///Bit 16 - RDWR_ORDERED_EN
    #[inline(always)]
    #[must_use]
    pub fn rdwr_ordered_en(&mut self) -> RDWR_ORDERED_EN_W<DDRCTRL_PCFGR_1rs> {
        RDWR_ORDERED_EN_W::new(self, 16)
    }
}
/**DDRCTRL port 1 configuration read register

You can [`read`](crate::Reg::read) this register and get [`ddrctrl_pcfgr_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrctrl_pcfgr_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRCTRL:DDRCTRL_PCFGR_1)*/
pub struct DDRCTRL_PCFGR_1rs;
impl crate::RegisterSpec for DDRCTRL_PCFGR_1rs {
    type Ux = u32;
}
///`read()` method returns [`ddrctrl_pcfgr_1::R`](R) reader structure
impl crate::Readable for DDRCTRL_PCFGR_1rs {}
///`write(|w| ..)` method takes [`ddrctrl_pcfgr_1::W`](W) writer structure
impl crate::Writable for DDRCTRL_PCFGR_1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRCTRL_PCFGR_1 to value 0x4000
impl crate::Resettable for DDRCTRL_PCFGR_1rs {
