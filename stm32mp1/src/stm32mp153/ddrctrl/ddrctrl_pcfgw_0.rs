...
pub type R = crate::R<DDRCTRL_PCFGW_0rs>;
///Register `DDRCTRL_PCFGW_0` writer
pub type W = crate::W<DDRCTRL_PCFGW_0rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRCTRL_PCFGW_0")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wr_port_priority(&mut self) -> WR_PORT_PRIORITY_W<DDRCTRL_PCFGW_0rs> {
        WR_PORT_PRIORITY_W::new(self, 0)
    }
    ///Bit 12 - WR_PORT_AGING_EN
    #[inline(always)]
    #[must_use]
    pub fn wr_port_aging_en(&mut self) -> WR_PORT_AGING_EN_W<DDRCTRL_PCFGW_0rs> {
        WR_PORT_AGING_EN_W::new(self, 12)
    }
    ///Bit 13 - WR_PORT_URGENT_EN
    #[inline(always)]
    #[must_use]
    pub fn wr_port_urgent_en(&mut self) -> WR_PORT_URGENT_EN_W<DDRCTRL_PCFGW_0rs> {
        WR_PORT_URGENT_EN_W::new(self, 13)
    }
    ///Bit 14 - WR_PORT_PAGEMATCH_EN
    #[inline(always)]
    #[must_use]
    pub fn wr_port_pagematch_en(&mut self) -> WR_PORT_PAGEMATCH_EN_W<DDRCTRL_PCFGW_0rs> {
        WR_PORT_PAGEMATCH_EN_W::new(self, 14)
    }
}
/**DDRCTRL port 0 configuration write register

You can [`read`](crate::Reg::read) this register and get [`ddrctrl_pcfgw_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrctrl_pcfgw_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRCTRL:DDRCTRL_PCFGW_0)*/
pub struct DDRCTRL_PCFGW_0rs;
impl crate::RegisterSpec for DDRCTRL_PCFGW_0rs {
    type Ux = u32;
}
///`read()` method returns [`ddrctrl_pcfgw_0::R`](R) reader structure
impl crate::Readable for DDRCTRL_PCFGW_0rs {}
///`write(|w| ..)` method takes [`ddrctrl_pcfgw_0::W`](W) writer structure
impl crate::Writable for DDRCTRL_PCFGW_0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRCTRL_PCFGW_0 to value 0x4000
impl crate::Resettable for DDRCTRL_PCFGW_0rs {
