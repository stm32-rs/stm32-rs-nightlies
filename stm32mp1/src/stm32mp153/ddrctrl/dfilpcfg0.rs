...
impl W {
    ///Bit 0 - DFI_LP_EN_PD
    #[inline(always)]
    pub fn dfi_lp_en_pd(&mut self) -> DFI_LP_EN_PD_W<DFILPCFG0rs> {
        DFI_LP_EN_PD_W::new(self, 0)
    }
    ///Bits 4:7 - DFI_LP_WAKEUP_PD
    #[inline(always)]
    pub fn dfi_lp_wakeup_pd(&mut self) -> DFI_LP_WAKEUP_PD_W<DFILPCFG0rs> {
        DFI_LP_WAKEUP_PD_W::new(self, 4)
    }
    ///Bit 8 - DFI_LP_EN_SR
    #[inline(always)]
    pub fn dfi_lp_en_sr(&mut self) -> DFI_LP_EN_SR_W<DFILPCFG0rs> {
        DFI_LP_EN_SR_W::new(self, 8)
    }
    ///Bits 12:15 - DFI_LP_WAKEUP_SR
    #[inline(always)]
    pub fn dfi_lp_wakeup_sr(&mut self) -> DFI_LP_WAKEUP_SR_W<DFILPCFG0rs> {
        DFI_LP_WAKEUP_SR_W::new(self, 12)
    }
    ///Bit 16 - DFI_LP_EN_DPD
    #[inline(always)]
    pub fn dfi_lp_en_dpd(&mut self) -> DFI_LP_EN_DPD_W<DFILPCFG0rs> {
        DFI_LP_EN_DPD_W::new(self, 16)
    }
    ///Bits 20:23 - DFI_LP_WAKEUP_DPD
    #[inline(always)]
    pub fn dfi_lp_wakeup_dpd(&mut self) -> DFI_LP_WAKEUP_DPD_W<DFILPCFG0rs> {
        DFI_LP_WAKEUP_DPD_W::new(self, 20)
    }
    ///Bits 24:28 - DFI_TLP_RESP
    #[inline(always)]
    pub fn dfi_tlp_resp(&mut self) -> DFI_TLP_RESP_W<DFILPCFG0rs> {
