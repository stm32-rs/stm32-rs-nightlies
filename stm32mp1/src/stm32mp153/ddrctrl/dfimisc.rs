...
impl W {
    ///Bit 0 - DFI_INIT_COMPLETE_EN
    #[inline(always)]
    pub fn dfi_init_complete_en(&mut self) -> DFI_INIT_COMPLETE_EN_W<DFIMISCrs> {
        DFI_INIT_COMPLETE_EN_W::new(self, 0)
    }
    ///Bit 4 - CTL_IDLE_EN
    #[inline(always)]
    pub fn ctl_idle_en(&mut self) -> CTL_IDLE_EN_W<DFIMISCrs> {
        CTL_IDLE_EN_W::new(self, 4)
    }
    ///Bit 5 - DFI_INIT_START
    #[inline(always)]
    pub fn dfi_init_start(&mut self) -> DFI_INIT_START_W<DFIMISCrs> {
        DFI_INIT_START_W::new(self, 5)
    }
    ///Bits 8:12 - DFI_FREQUENCY
    #[inline(always)]
    pub fn dfi_frequency(&mut self) -> DFI_FREQUENCY_W<DFIMISCrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRCTRL:DFIMISC)*/
