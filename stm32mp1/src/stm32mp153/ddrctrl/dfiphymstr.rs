...
impl W {
    ///Bit 0 - DFI_PHYMSTR_EN
    #[inline(always)]
    pub fn dfi_phymstr_en(&mut self) -> DFI_PHYMSTR_EN_W<DFIPHYMSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRCTRL:DFIPHYMSTR)*/
