...
impl W {
    ///Bits 0:5 - DFI_TPHY_WRLAT
    #[inline(always)]
    pub fn dfi_tphy_wrlat(&mut self) -> DFI_TPHY_WRLAT_W<DFITMG0rs> {
        DFI_TPHY_WRLAT_W::new(self, 0)
    }
    ///Bits 8:13 - DFI_TPHY_WRDATA
    #[inline(always)]
    pub fn dfi_tphy_wrdata(&mut self) -> DFI_TPHY_WRDATA_W<DFITMG0rs> {
        DFI_TPHY_WRDATA_W::new(self, 8)
    }
    ///Bits 16:22 - DFI_T_RDDATA_EN
    #[inline(always)]
    pub fn dfi_t_rddata_en(&mut self) -> DFI_T_RDDATA_EN_W<DFITMG0rs> {
        DFI_T_RDDATA_EN_W::new(self, 16)
    }
    ///Bits 24:28 - DFI_T_CTRL_DELAY
    #[inline(always)]
    pub fn dfi_t_ctrl_delay(&mut self) -> DFI_T_CTRL_DELAY_W<DFITMG0rs> {
