...
impl W {
    ///Bits 0:9 - DFI_T_CTRLUP_MIN
    #[inline(always)]
    pub fn dfi_t_ctrlup_min(&mut self) -> DFI_T_CTRLUP_MIN_W<DFIUPD0rs> {
        DFI_T_CTRLUP_MIN_W::new(self, 0)
    }
    ///Bits 16:25 - DFI_T_CTRLUP_MAX
    #[inline(always)]
    pub fn dfi_t_ctrlup_max(&mut self) -> DFI_T_CTRLUP_MAX_W<DFIUPD0rs> {
        DFI_T_CTRLUP_MAX_W::new(self, 16)
    }
    ///Bit 29 - CTRLUPD_PRE_SRX
    #[inline(always)]
    pub fn ctrlupd_pre_srx(&mut self) -> CTRLUPD_PRE_SRX_W<DFIUPD0rs> {
        CTRLUPD_PRE_SRX_W::new(self, 29)
    }
    ///Bit 30 - DIS_AUTO_CTRLUPD_SRX
    #[inline(always)]
    pub fn dis_auto_ctrlupd_srx(&mut self) -> DIS_AUTO_CTRLUPD_SRX_W<DFIUPD0rs> {
        DIS_AUTO_CTRLUPD_SRX_W::new(self, 30)
    }
    ///Bit 31 - DIS_AUTO_CTRLUPD
    #[inline(always)]
    pub fn dis_auto_ctrlupd(&mut self) -> DIS_AUTO_CTRLUPD_W<DFIUPD0rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRCTRL:DFIUPD0)*/
