...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn t_ras_min(&mut self) -> T_RAS_MIN_W<DRAMTMG0rs> {
        T_RAS_MIN_W::new(self, 0)
    }
    ///Bits 8:14 - T_RAS_MAX
    #[inline(always)]
    #[must_use]
    pub fn t_ras_max(&mut self) -> T_RAS_MAX_W<DRAMTMG0rs> {
        T_RAS_MAX_W::new(self, 8)
    }
    ///Bits 16:21 - T_FAW
    #[inline(always)]
    #[must_use]
    pub fn t_faw(&mut self) -> T_FAW_W<DRAMTMG0rs> {
        T_FAW_W::new(self, 16)
    }
    ///Bits 24:30 - WR2PRE
    #[inline(always)]
    #[must_use]
    pub fn wr2pre(&mut self) -> WR2PRE_W<DRAMTMG0rs> {
