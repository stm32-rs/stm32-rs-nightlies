...
impl W {
    ///Bits 0:5 - WR2RD
    #[inline(always)]
    pub fn wr2rd(&mut self) -> WR2RD_W<DRAMTMG2rs> {
        WR2RD_W::new(self, 0)
    }
    ///Bits 8:13 - RD2WR
    #[inline(always)]
    pub fn rd2wr(&mut self) -> RD2WR_W<DRAMTMG2rs> {
        RD2WR_W::new(self, 8)
    }
    ///Bits 16:21 - READ_LATENCY
    #[inline(always)]
    pub fn read_latency(&mut self) -> READ_LATENCY_W<DRAMTMG2rs> {
        READ_LATENCY_W::new(self, 16)
    }
    ///Bits 24:29 - WRITE_LATENCY
    #[inline(always)]
    pub fn write_latency(&mut self) -> WRITE_LATENCY_W<DRAMTMG2rs> {
