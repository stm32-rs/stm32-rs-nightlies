...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn t_rp(&mut self) -> T_RP_W<DRAMTMG4rs> {
        T_RP_W::new(self, 0)
    }
    ///Bits 8:11 - T_RRD
    #[inline(always)]
    #[must_use]
    pub fn t_rrd(&mut self) -> T_RRD_W<DRAMTMG4rs> {
        T_RRD_W::new(self, 8)
    }
    ///Bits 16:19 - T_CCD
    #[inline(always)]
    #[must_use]
    pub fn t_ccd(&mut self) -> T_CCD_W<DRAMTMG4rs> {
        T_CCD_W::new(self, 16)
    }
    ///Bits 24:28 - T_RCD
    #[inline(always)]
    #[must_use]
    pub fn t_rcd(&mut self) -> T_RCD_W<DRAMTMG4rs> {
        T_RCD_W::new(self, 24)
    }
}
