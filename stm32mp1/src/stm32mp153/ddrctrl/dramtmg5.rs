...
impl W {
    ///Bits 0:4 - T_CKE
    #[inline(always)]
    pub fn t_cke(&mut self) -> T_CKE_W<DRAMTMG5rs> {
        T_CKE_W::new(self, 0)
    }
    ///Bits 8:13 - T_CKESR
    #[inline(always)]
    pub fn t_ckesr(&mut self) -> T_CKESR_W<DRAMTMG5rs> {
        T_CKESR_W::new(self, 8)
    }
    ///Bits 16:19 - T_CKSRE
    #[inline(always)]
    pub fn t_cksre(&mut self) -> T_CKSRE_W<DRAMTMG5rs> {
        T_CKSRE_W::new(self, 16)
    }
    ///Bits 24:27 - T_CKSRX
    #[inline(always)]
    pub fn t_cksrx(&mut self) -> T_CKSRX_W<DRAMTMG5rs> {
