...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr_type(&mut self) -> MR_TYPE_W<MRCTRL0rs> {
        MR_TYPE_W::new(self, 0)
    }
    ///Bit 4 - MR_RANK
    #[inline(always)]
    #[must_use]
    pub fn mr_rank(&mut self) -> MR_RANK_W<MRCTRL0rs> {
        MR_RANK_W::new(self, 4)
    }
    ///Bits 12:15 - MR_ADDR
    #[inline(always)]
    #[must_use]
    pub fn mr_addr(&mut self) -> MR_ADDR_W<MRCTRL0rs> {
        MR_ADDR_W::new(self, 12)
    }
    ///Bit 31 - MR_WR
    #[inline(always)]
    #[must_use]
    pub fn mr_wr(&mut self) -> MR_WR_W<MRCTRL0rs> {
        MR_WR_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRCTRL:MRCTRL0)*/
