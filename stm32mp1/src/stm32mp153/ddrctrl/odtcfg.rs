...
impl W {
    ///Bits 2:6 - RD_ODT_DELAY
    #[inline(always)]
    pub fn rd_odt_delay(&mut self) -> RD_ODT_DELAY_W<ODTCFGrs> {
        RD_ODT_DELAY_W::new(self, 2)
    }
    ///Bits 8:11 - RD_ODT_HOLD
    #[inline(always)]
    pub fn rd_odt_hold(&mut self) -> RD_ODT_HOLD_W<ODTCFGrs> {
        RD_ODT_HOLD_W::new(self, 8)
    }
    ///Bits 16:20 - WR_ODT_DELAY
    #[inline(always)]
    pub fn wr_odt_delay(&mut self) -> WR_ODT_DELAY_W<ODTCFGrs> {
        WR_ODT_DELAY_W::new(self, 16)
    }
    ///Bits 24:27 - WR_ODT_HOLD
    #[inline(always)]
    pub fn wr_odt_hold(&mut self) -> WR_ODT_HOLD_W<ODTCFGrs> {
