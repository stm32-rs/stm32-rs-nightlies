...
impl W {
    ///Bits 0:9 - RD_PORT_PRIORITY
    #[inline(always)]
    pub fn rd_port_priority(&mut self) -> RD_PORT_PRIORITY_W<PCFGR_0rs> {
        RD_PORT_PRIORITY_W::new(self, 0)
    }
    ///Bit 12 - RD_PORT_AGING_EN
    #[inline(always)]
    pub fn rd_port_aging_en(&mut self) -> RD_PORT_AGING_EN_W<PCFGR_0rs> {
        RD_PORT_AGING_EN_W::new(self, 12)
    }
    ///Bit 13 - RD_PORT_URGENT_EN
    #[inline(always)]
    pub fn rd_port_urgent_en(&mut self) -> RD_PORT_URGENT_EN_W<PCFGR_0rs> {
        RD_PORT_URGENT_EN_W::new(self, 13)
    }
    ///Bit 14 - RD_PORT_PAGEMATCH_EN
    #[inline(always)]
    pub fn rd_port_pagematch_en(&mut self) -> RD_PORT_PAGEMATCH_EN_W<PCFGR_0rs> {
        RD_PORT_PAGEMATCH_EN_W::new(self, 14)
    }
    ///Bit 16 - RDWR_ORDERED_EN
    #[inline(always)]
    pub fn rdwr_ordered_en(&mut self) -> RDWR_ORDERED_EN_W<PCFGR_0rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRCTRL:PCFGR_0)*/
