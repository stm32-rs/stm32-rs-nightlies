///Register `PCFGR_1` reader
pub type R = crate::R<PCFGR_1rs>;
///Register `PCFGR_1` writer
pub type W = crate::W<PCFGR_1rs>;
...
impl W {
    ///Bits 0:9 - RD_PORT_PRIORITY
    #[inline(always)]
    pub fn rd_port_priority(&mut self) -> RD_PORT_PRIORITY_W<'_, PCFGR_1rs> {
        RD_PORT_PRIORITY_W::new(self, 0)
    }
    ///Bit 12 - RD_PORT_AGING_EN
    #[inline(always)]
    pub fn rd_port_aging_en(&mut self) -> RD_PORT_AGING_EN_W<'_, PCFGR_1rs> {
        RD_PORT_AGING_EN_W::new(self, 12)
    }
    ///Bit 13 - RD_PORT_URGENT_EN
    #[inline(always)]
    pub fn rd_port_urgent_en(&mut self) -> RD_PORT_URGENT_EN_W<'_, PCFGR_1rs> {
        RD_PORT_URGENT_EN_W::new(self, 13)
    }
    ///Bit 14 - RD_PORT_PAGEMATCH_EN
    #[inline(always)]
    pub fn rd_port_pagematch_en(&mut self) -> RD_PORT_PAGEMATCH_EN_W<'_, PCFGR_1rs> {
        RD_PORT_PAGEMATCH_EN_W::new(self, 14)
    }
    ///Bit 16 - RDWR_ORDERED_EN
    #[inline(always)]
    pub fn rdwr_ordered_en(&mut self) -> RDWR_ORDERED_EN_W<'_, PCFGR_1rs> {
        RDWR_ORDERED_EN_W::new(self, 16)
    }
}
/**DDRCTRL port 1 configuration read register

You can [`read`](crate::Reg::read) this register and get [`pcfgr_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfgr_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRCTRL:PCFGR_1)*/
pub struct PCFGR_1rs;
impl crate::RegisterSpec for PCFGR_1rs {
    type Ux = u32;
}
///`read()` method returns [`pcfgr_1::R`](R) reader structure
impl crate::Readable for PCFGR_1rs {}
///`write(|w| ..)` method takes [`pcfgr_1::W`](W) writer structure
impl crate::Writable for PCFGR_1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PCFGR_1 to value 0x4000
impl crate::Resettable for PCFGR_1rs {
