...
impl W {
    ///Bits 0:9 - WR_PORT_PRIORITY
    #[inline(always)]
    pub fn wr_port_priority(&mut self) -> WR_PORT_PRIORITY_W<PCFGW_0rs> {
        WR_PORT_PRIORITY_W::new(self, 0)
    }
    ///Bit 12 - WR_PORT_AGING_EN
    #[inline(always)]
    pub fn wr_port_aging_en(&mut self) -> WR_PORT_AGING_EN_W<PCFGW_0rs> {
        WR_PORT_AGING_EN_W::new(self, 12)
    }
    ///Bit 13 - WR_PORT_URGENT_EN
    #[inline(always)]
    pub fn wr_port_urgent_en(&mut self) -> WR_PORT_URGENT_EN_W<PCFGW_0rs> {
        WR_PORT_URGENT_EN_W::new(self, 13)
    }
    ///Bit 14 - WR_PORT_PAGEMATCH_EN
    #[inline(always)]
    pub fn wr_port_pagematch_en(&mut self) -> WR_PORT_PAGEMATCH_EN_W<PCFGW_0rs> {
