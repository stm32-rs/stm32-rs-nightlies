...
impl W {
    ///Bits 0:10 - WQOS_MAP_TIMEOUT1
    #[inline(always)]
    pub fn wqos_map_timeout1(&mut self) -> WQOS_MAP_TIMEOUT1_W<PCFGWQOS1_1rs> {
        WQOS_MAP_TIMEOUT1_W::new(self, 0)
    }
    ///Bits 16:26 - WQOS_MAP_TIMEOUT2
    #[inline(always)]
    pub fn wqos_map_timeout2(&mut self) -> WQOS_MAP_TIMEOUT2_W<PCFGWQOS1_1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRCTRL:PCFGWQOS1_1)*/
