...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn selfref_en(&mut self) -> SELFREF_EN_W<PWRCTLrs> {
        SELFREF_EN_W::new(self, 0)
    }
    ///Bit 1 - POWERDOWN_EN
    #[inline(always)]
    #[must_use]
    pub fn powerdown_en(&mut self) -> POWERDOWN_EN_W<PWRCTLrs> {
        POWERDOWN_EN_W::new(self, 1)
    }
    ///Bit 2 - DEEPPOWERDOWN_EN
    #[inline(always)]
    #[must_use]
    pub fn deeppowerdown_en(&mut self) -> DEEPPOWERDOWN_EN_W<PWRCTLrs> {
        DEEPPOWERDOWN_EN_W::new(self, 2)
    }
    ///Bit 3 - EN_DFI_DRAM_CLK_DISABLE
    #[inline(always)]
    #[must_use]
    pub fn en_dfi_dram_clk_disable(&mut self) -> EN_DFI_DRAM_CLK_DISABLE_W<PWRCTLrs> {
        EN_DFI_DRAM_CLK_DISABLE_W::new(self, 3)
    }
    ///Bit 5 - SELFREF_SW
    #[inline(always)]
    #[must_use]
    pub fn selfref_sw(&mut self) -> SELFREF_SW_W<PWRCTLrs> {
        SELFREF_SW_W::new(self, 5)
    }
    ///Bit 7 - DIS_CAM_DRAIN_SELFREF
    #[inline(always)]
    #[must_use]
    pub fn dis_cam_drain_selfref(&mut self) -> DIS_CAM_DRAIN_SELFREF_W<PWRCTLrs> {
