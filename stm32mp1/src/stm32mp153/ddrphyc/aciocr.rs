...
impl W {
    ///Bit 0 - ACIOM
    #[inline(always)]
    pub fn aciom(&mut self) -> ACIOM_W<ACIOCRrs> {
        ACIOM_W::new(self, 0)
    }
    ///Bit 1 - ACOE
    #[inline(always)]
    pub fn acoe(&mut self) -> ACOE_W<ACIOCRrs> {
        ACOE_W::new(self, 1)
    }
    ///Bit 2 - ACODT
    #[inline(always)]
    pub fn acodt(&mut self) -> ACODT_W<ACIOCRrs> {
        ACODT_W::new(self, 2)
    }
    ///Bit 3 - ACPDD
    #[inline(always)]
    pub fn acpdd(&mut self) -> ACPDD_W<ACIOCRrs> {
        ACPDD_W::new(self, 3)
    }
    ///Bit 4 - ACPDR
    #[inline(always)]
    pub fn acpdr(&mut self) -> ACPDR_W<ACIOCRrs> {
        ACPDR_W::new(self, 4)
    }
    ///Bits 5:7 - CKODT
    #[inline(always)]
    pub fn ckodt(&mut self) -> CKODT_W<ACIOCRrs> {
        CKODT_W::new(self, 5)
    }
    ///Bits 8:10 - CKPDD
    #[inline(always)]
    pub fn ckpdd(&mut self) -> CKPDD_W<ACIOCRrs> {
        CKPDD_W::new(self, 8)
    }
    ///Bits 11:13 - CKPDR
    #[inline(always)]
    pub fn ckpdr(&mut self) -> CKPDR_W<ACIOCRrs> {
        CKPDR_W::new(self, 11)
    }
    ///Bit 14 - RANKODT
    #[inline(always)]
    pub fn rankodt(&mut self) -> RANKODT_W<ACIOCRrs> {
        RANKODT_W::new(self, 14)
    }
    ///Bit 18 - CSPDD
    #[inline(always)]
    pub fn cspdd(&mut self) -> CSPDD_W<ACIOCRrs> {
        CSPDD_W::new(self, 18)
    }
    ///Bit 22 - RANKPDR
    #[inline(always)]
    pub fn rankpdr(&mut self) -> RANKPDR_W<ACIOCRrs> {
        RANKPDR_W::new(self, 22)
    }
    ///Bit 26 - RSTODT
    #[inline(always)]
    pub fn rstodt(&mut self) -> RSTODT_W<ACIOCRrs> {
        RSTODT_W::new(self, 26)
    }
    ///Bit 27 - RSTPDD
    #[inline(always)]
    pub fn rstpdd(&mut self) -> RSTPDD_W<ACIOCRrs> {
        RSTPDD_W::new(self, 27)
    }
    ///Bit 28 - RSTPDR
    #[inline(always)]
    pub fn rstpdr(&mut self) -> RSTPDR_W<ACIOCRrs> {
        RSTPDR_W::new(self, 28)
    }
    ///Bit 29 - RSTIOM
    #[inline(always)]
    pub fn rstiom(&mut self) -> RSTIOM_W<ACIOCRrs> {
        RSTIOM_W::new(self, 29)
    }
    ///Bits 30:31 - ACSR
    #[inline(always)]
    pub fn acsr(&mut self) -> ACSR_W<ACIOCRrs> {
        ACSR_W::new(self, 30)
    }
}
