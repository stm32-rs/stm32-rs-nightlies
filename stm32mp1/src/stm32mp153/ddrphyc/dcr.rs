...
impl W {
    ///Bits 0:2 - DDRMD
    #[inline(always)]
    pub fn ddrmd(&mut self) -> DDRMD_W<DCRrs> {
        DDRMD_W::new(self, 0)
    }
    ///Bit 3 - DDR8BNK
    #[inline(always)]
    pub fn ddr8bnk(&mut self) -> DDR8BNK_W<DCRrs> {
        DDR8BNK_W::new(self, 3)
    }
    ///Bits 4:6 - PDQ
    #[inline(always)]
    pub fn pdq(&mut self) -> PDQ_W<DCRrs> {
        PDQ_W::new(self, 4)
    }
    ///Bit 7 - MPRDQ
    #[inline(always)]
    pub fn mprdq(&mut self) -> MPRDQ_W<DCRrs> {
        MPRDQ_W::new(self, 7)
    }
    ///Bits 8:9 - DDRTYPE
    #[inline(always)]
    pub fn ddrtype(&mut self) -> DDRTYPE_W<DCRrs> {
        DDRTYPE_W::new(self, 8)
    }
    ///Bit 27 - NOSRA
    #[inline(always)]
    pub fn nosra(&mut self) -> NOSRA_W<DCRrs> {
        NOSRA_W::new(self, 27)
    }
    ///Bit 28 - DDR2T
    #[inline(always)]
    pub fn ddr2t(&mut self) -> DDR2T_W<DCRrs> {
        DDR2T_W::new(self, 28)
    }
    ///Bit 29 - UDIMM
    #[inline(always)]
    pub fn udimm(&mut self) -> UDIMM_W<DCRrs> {
        UDIMM_W::new(self, 29)
    }
    ///Bit 30 - RDIMM
    #[inline(always)]
    pub fn rdimm(&mut self) -> RDIMM_W<DCRrs> {
        RDIMM_W::new(self, 30)
    }
    ///Bit 31 - TPD
    #[inline(always)]
    pub fn tpd(&mut self) -> TPD_W<DCRrs> {
        TPD_W::new(self, 31)
    }
}
/**DDRPHYC DC register
