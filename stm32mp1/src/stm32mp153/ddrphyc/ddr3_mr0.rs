...
impl W {
    ///Bits 0:1 - BL
    #[inline(always)]
    pub fn bl(&mut self) -> BL_W<DDR3_MR0rs> {
        BL_W::new(self, 0)
    }
    ///Bit 2 - CL0
    #[inline(always)]
    pub fn cl0(&mut self) -> CL0_W<DDR3_MR0rs> {
        CL0_W::new(self, 2)
    }
    ///Bit 3 - BT
    #[inline(always)]
    pub fn bt(&mut self) -> BT_W<DDR3_MR0rs> {
        BT_W::new(self, 3)
    }
    ///Bits 4:6 - CL
    #[inline(always)]
    pub fn cl(&mut self) -> CL_W<DDR3_MR0rs> {
        CL_W::new(self, 4)
    }
    ///Bit 7 - TM
    #[inline(always)]
    pub fn tm(&mut self) -> TM_W<DDR3_MR0rs> {
        TM_W::new(self, 7)
    }
    ///Bit 8 - DR
    #[inline(always)]
    pub fn dr(&mut self) -> DR_W<DDR3_MR0rs> {
        DR_W::new(self, 8)
    }
    ///Bits 9:11 - WR
    #[inline(always)]
    pub fn wr(&mut self) -> WR_W<DDR3_MR0rs> {
        WR_W::new(self, 9)
    }
    ///Bit 12 - PD
    #[inline(always)]
    pub fn pd(&mut self) -> PD_W<DDR3_MR0rs> {
        PD_W::new(self, 12)
    }
    ///Bits 13:15 - RSVD
    #[inline(always)]
    pub fn rsvd(&mut self) -> RSVD_W<DDR3_MR0rs> {
        RSVD_W::new(self, 13)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DDR3_MR0)*/
