...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn de(&mut self) -> DE_W<DDR3_MR1rs> {
        DE_W::new(self, 0)
    }
    ///Bit 1 - DIC0
    #[inline(always)]
    #[must_use]
    pub fn dic0(&mut self) -> DIC0_W<DDR3_MR1rs> {
        DIC0_W::new(self, 1)
    }
    ///Bit 2 - RTT0
    #[inline(always)]
    #[must_use]
    pub fn rtt0(&mut self) -> RTT0_W<DDR3_MR1rs> {
        RTT0_W::new(self, 2)
    }
    ///Bits 3:4 - AL
    #[inline(always)]
    #[must_use]
    pub fn al(&mut self) -> AL_W<DDR3_MR1rs> {
        AL_W::new(self, 3)
    }
    ///Bit 5 - DIC1
    #[inline(always)]
    #[must_use]
    pub fn dic1(&mut self) -> DIC1_W<DDR3_MR1rs> {
        DIC1_W::new(self, 5)
    }
    ///Bit 6 - RTT1
    #[inline(always)]
    #[must_use]
    pub fn rtt1(&mut self) -> RTT1_W<DDR3_MR1rs> {
        RTT1_W::new(self, 6)
    }
    ///Bit 7 - LEVEL
    #[inline(always)]
    #[must_use]
    pub fn level(&mut self) -> LEVEL_W<DDR3_MR1rs> {
        LEVEL_W::new(self, 7)
    }
    ///Bit 9 - RTT2
    #[inline(always)]
    #[must_use]
    pub fn rtt2(&mut self) -> RTT2_W<DDR3_MR1rs> {
        RTT2_W::new(self, 9)
    }
    ///Bit 11 - TDQS
    #[inline(always)]
    #[must_use]
    pub fn tdqs(&mut self) -> TDQS_W<DDR3_MR1rs> {
        TDQS_W::new(self, 11)
    }
    ///Bit 12 - QOFF
    #[inline(always)]
    #[must_use]
    pub fn qoff(&mut self) -> QOFF_W<DDR3_MR1rs> {
        QOFF_W::new(self, 12)
    }
}
