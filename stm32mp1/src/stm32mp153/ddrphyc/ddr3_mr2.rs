...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pasr(&mut self) -> PASR_W<DDR3_MR2rs> {
        PASR_W::new(self, 0)
    }
    ///Bits 3:5 - CWL
    #[inline(always)]
    #[must_use]
    pub fn cwl(&mut self) -> CWL_W<DDR3_MR2rs> {
        CWL_W::new(self, 3)
    }
    ///Bit 6 - ASR
    #[inline(always)]
    #[must_use]
    pub fn asr(&mut self) -> ASR_W<DDR3_MR2rs> {
        ASR_W::new(self, 6)
    }
    ///Bit 7 - SRT
    #[inline(always)]
    #[must_use]
    pub fn srt(&mut self) -> SRT_W<DDR3_MR2rs> {
        SRT_W::new(self, 7)
    }
    ///Bits 9:10 - RTTWR
    #[inline(always)]
    #[must_use]
    pub fn rttwr(&mut self) -> RTTWR_W<DDR3_MR2rs> {
        RTTWR_W::new(self, 9)
    }
}
