...
pub type R = crate::R<DDRPHYC_DX1GCRrs>;
///Register `DDRPHYC_DX1GCR` writer
pub type W = crate::W<DDRPHYC_DX1GCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dxen(&mut self) -> DXEN_W<DDRPHYC_DX1GCRrs> {
        DXEN_W::new(self, 0)
    }
    ///Bit 1 - DQSODT
    #[inline(always)]
    #[must_use]
    pub fn dqsodt(&mut self) -> DQSODT_W<DDRPHYC_DX1GCRrs> {
        DQSODT_W::new(self, 1)
    }
    ///Bit 2 - DQODT
    #[inline(always)]
    #[must_use]
    pub fn dqodt(&mut self) -> DQODT_W<DDRPHYC_DX1GCRrs> {
        DQODT_W::new(self, 2)
    }
    ///Bit 3 - DXIOM
    #[inline(always)]
    #[must_use]
    pub fn dxiom(&mut self) -> DXIOM_W<DDRPHYC_DX1GCRrs> {
        DXIOM_W::new(self, 3)
    }
    ///Bit 4 - DXPDD
    #[inline(always)]
    #[must_use]
    pub fn dxpdd(&mut self) -> DXPDD_W<DDRPHYC_DX1GCRrs> {
        DXPDD_W::new(self, 4)
    }
    ///Bit 5 - DXPDR
    #[inline(always)]
    #[must_use]
    pub fn dxpdr(&mut self) -> DXPDR_W<DDRPHYC_DX1GCRrs> {
        DXPDR_W::new(self, 5)
    }
    ///Bit 6 - DQSRPD
    #[inline(always)]
    #[must_use]
    pub fn dqsrpd(&mut self) -> DQSRPD_W<DDRPHYC_DX1GCRrs> {
        DQSRPD_W::new(self, 6)
    }
    ///Bits 7:8 - DSEN
    #[inline(always)]
    #[must_use]
    pub fn dsen(&mut self) -> DSEN_W<DDRPHYC_DX1GCRrs> {
        DSEN_W::new(self, 7)
    }
    ///Bit 9 - DQSRTT
    #[inline(always)]
    #[must_use]
    pub fn dqsrtt(&mut self) -> DQSRTT_W<DDRPHYC_DX1GCRrs> {
        DQSRTT_W::new(self, 9)
    }
    ///Bit 10 - DQRTT
    #[inline(always)]
    #[must_use]
    pub fn dqrtt(&mut self) -> DQRTT_W<DDRPHYC_DX1GCRrs> {
        DQRTT_W::new(self, 10)
    }
    ///Bits 11:12 - RTTOH
    #[inline(always)]
    #[must_use]
    pub fn rttoh(&mut self) -> RTTOH_W<DDRPHYC_DX1GCRrs> {
        RTTOH_W::new(self, 11)
    }
    ///Bit 13 - RTTOAL
    #[inline(always)]
    #[must_use]
    pub fn rttoal(&mut self) -> RTTOAL_W<DDRPHYC_DX1GCRrs> {
        RTTOAL_W::new(self, 13)
    }
    ///Bits 14:16 - R0RVSL
    #[inline(always)]
    #[must_use]
    pub fn r0rvsl(&mut self) -> R0RVSL_W<DDRPHYC_DX1GCRrs> {
        R0RVSL_W::new(self, 14)
    }
}
/**DDRPHYC byte lane 1 GC register

You can [`read`](crate::Reg::read) this register and get [`ddrphyc_dx1gcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrphyc_dx1gcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DDRPHYC_DX1GCR)*/
pub struct DDRPHYC_DX1GCRrs;
impl crate::RegisterSpec for DDRPHYC_DX1GCRrs {
    type Ux = u32;
}
///`read()` method returns [`ddrphyc_dx1gcr::R`](R) reader structure
impl crate::Readable for DDRPHYC_DX1GCRrs {}
///`write(|w| ..)` method takes [`ddrphyc_dx1gcr::W`](W) writer structure
impl crate::Writable for DDRPHYC_DX1GCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRPHYC_DX1GCR to value 0xee81
impl crate::Resettable for DDRPHYC_DX1GCRrs {
