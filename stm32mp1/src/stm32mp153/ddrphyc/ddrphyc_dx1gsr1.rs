///Register `DDRPHYC_DX1GSR1` reader
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRPHYC_DX1GSR1")
...
You can [`read`](crate::Reg::read) this register and get [`ddrphyc_dx1gsr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DDRPHYC_DX1GSR1)*/
pub struct DDRPHYC_DX1GSR1rs;
impl crate::RegisterSpec for DDRPHYC_DX1GSR1rs {
    type Ux = u32;
}
///`read()` method returns [`ddrphyc_dx1gsr1::R`](R) reader structure
impl crate::Readable for DDRPHYC_DX1GSR1rs {}
///`reset()` method sets DDRPHYC_DX1GSR1 to value 0
