///Register `DDRPHYC_DX3DQTR` reader
pub type R = crate::R<DDRPHYC_DX3DQTRrs>;
///Register `DDRPHYC_DX3DQTR` writer
pub type W = crate::W<DDRPHYC_DX3DQTRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRPHYC_DX3DQTR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dqdly0(&mut self) -> DQDLY0_W<DDRPHYC_DX3DQTRrs> {
        DQDLY0_W::new(self, 0)
    }
    ///Bits 4:7 - DQDLY1
    #[inline(always)]
    #[must_use]
    pub fn dqdly1(&mut self) -> DQDLY1_W<DDRPHYC_DX3DQTRrs> {
        DQDLY1_W::new(self, 4)
    }
    ///Bits 8:11 - DQDLY2
    #[inline(always)]
    #[must_use]
    pub fn dqdly2(&mut self) -> DQDLY2_W<DDRPHYC_DX3DQTRrs> {
        DQDLY2_W::new(self, 8)
    }
    ///Bits 12:15 - DQDLY3
    #[inline(always)]
    #[must_use]
    pub fn dqdly3(&mut self) -> DQDLY3_W<DDRPHYC_DX3DQTRrs> {
        DQDLY3_W::new(self, 12)
    }
    ///Bits 16:19 - DQDLY4
    #[inline(always)]
    #[must_use]
    pub fn dqdly4(&mut self) -> DQDLY4_W<DDRPHYC_DX3DQTRrs> {
        DQDLY4_W::new(self, 16)
    }
    ///Bits 20:23 - DQDLY5
    #[inline(always)]
    #[must_use]
    pub fn dqdly5(&mut self) -> DQDLY5_W<DDRPHYC_DX3DQTRrs> {
        DQDLY5_W::new(self, 20)
    }
    ///Bits 24:27 - DQDLY6
    #[inline(always)]
    #[must_use]
    pub fn dqdly6(&mut self) -> DQDLY6_W<DDRPHYC_DX3DQTRrs> {
        DQDLY6_W::new(self, 24)
    }
    ///Bits 28:31 - DQDLY7
    #[inline(always)]
    #[must_use]
    pub fn dqdly7(&mut self) -> DQDLY7_W<DDRPHYC_DX3DQTRrs> {
        DQDLY7_W::new(self, 28)
    }
}
/**DDRPHYC byte lane 3 DQT register

You can [`read`](crate::Reg::read) this register and get [`ddrphyc_dx3dqtr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrphyc_dx3dqtr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DDRPHYC_DX3DQTR)*/
pub struct DDRPHYC_DX3DQTRrs;
impl crate::RegisterSpec for DDRPHYC_DX3DQTRrs {
    type Ux = u32;
}
///`read()` method returns [`ddrphyc_dx3dqtr::R`](R) reader structure
impl crate::Readable for DDRPHYC_DX3DQTRrs {}
///`write(|w| ..)` method takes [`ddrphyc_dx3dqtr::W`](W) writer structure
impl crate::Writable for DDRPHYC_DX3DQTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRPHYC_DX3DQTR to value 0xffff_ffff
impl crate::Resettable for DDRPHYC_DX3DQTRrs {
