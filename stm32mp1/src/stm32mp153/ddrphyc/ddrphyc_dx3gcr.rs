///Register `DDRPHYC_DX3GCR` reader
pub type R = crate::R<DDRPHYC_DX3GCRrs>;
///Register `DDRPHYC_DX3GCR` writer
...
You can [`read`](crate::Reg::read) this register and get [`ddrphyc_dx3gcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrphyc_dx3gcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DDRPHYC_DX3GCR)*/
pub struct DDRPHYC_DX3GCRrs;
impl crate::RegisterSpec for DDRPHYC_DX3GCRrs {
    type Ux = u32;
}
///`read()` method returns [`ddrphyc_dx3gcr::R`](R) reader structure
impl crate::Readable for DDRPHYC_DX3GCRrs {}
///`write(|w| ..)` method takes [`ddrphyc_dx3gcr::W`](W) writer structure
impl crate::Writable for DDRPHYC_DX3GCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRPHYC_DX3GCR to value 0xee81
