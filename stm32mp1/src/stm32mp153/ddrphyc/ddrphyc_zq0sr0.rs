...
You can [`read`](crate::Reg::read) this register and get [`ddrphyc_zq0sr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DDRPHYC_ZQ0SR0)*/
