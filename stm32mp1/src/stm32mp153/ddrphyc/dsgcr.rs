...
impl W {
    ///Bit 0 - PUREN
    #[inline(always)]
    pub fn puren(&mut self) -> PUREN_W<DSGCRrs> {
        PUREN_W::new(self, 0)
    }
    ///Bit 1 - BDISEN
    #[inline(always)]
    pub fn bdisen(&mut self) -> BDISEN_W<DSGCRrs> {
        BDISEN_W::new(self, 1)
    }
    ///Bit 2 - ZUEN
    #[inline(always)]
    pub fn zuen(&mut self) -> ZUEN_W<DSGCRrs> {
        ZUEN_W::new(self, 2)
    }
    ///Bit 3 - LPIOPD
    #[inline(always)]
    pub fn lpiopd(&mut self) -> LPIOPD_W<DSGCRrs> {
        LPIOPD_W::new(self, 3)
    }
    ///Bit 4 - LPDLLPD
    #[inline(always)]
    pub fn lpdllpd(&mut self) -> LPDLLPD_W<DSGCRrs> {
        LPDLLPD_W::new(self, 4)
    }
    ///Bits 5:7 - DQSGX
    #[inline(always)]
    pub fn dqsgx(&mut self) -> DQSGX_W<DSGCRrs> {
        DQSGX_W::new(self, 5)
    }
    ///Bits 8:10 - DQSGE
    #[inline(always)]
    pub fn dqsge(&mut self) -> DQSGE_W<DSGCRrs> {
        DQSGE_W::new(self, 8)
    }
    ///Bit 11 - NOBUB
    #[inline(always)]
    pub fn nobub(&mut self) -> NOBUB_W<DSGCRrs> {
        NOBUB_W::new(self, 11)
    }
    ///Bit 12 - FXDLAT
    #[inline(always)]
    pub fn fxdlat(&mut self) -> FXDLAT_W<DSGCRrs> {
        FXDLAT_W::new(self, 12)
    }
    ///Bit 16 - CKEPDD
    #[inline(always)]
    pub fn ckepdd(&mut self) -> CKEPDD_W<DSGCRrs> {
        CKEPDD_W::new(self, 16)
    }
    ///Bit 20 - ODTPDD
    #[inline(always)]
    pub fn odtpdd(&mut self) -> ODTPDD_W<DSGCRrs> {
        ODTPDD_W::new(self, 20)
    }
    ///Bit 24 - NL2PD
    #[inline(always)]
    pub fn nl2pd(&mut self) -> NL2PD_W<DSGCRrs> {
        NL2PD_W::new(self, 24)
    }
    ///Bit 25 - NL2OE
    #[inline(always)]
    pub fn nl2oe(&mut self) -> NL2OE_W<DSGCRrs> {
        NL2OE_W::new(self, 25)
    }
    ///Bit 26 - TPDPD
    #[inline(always)]
    pub fn tpdpd(&mut self) -> TPDPD_W<DSGCRrs> {
        TPDPD_W::new(self, 26)
    }
    ///Bit 27 - TPDOE
    #[inline(always)]
    pub fn tpdoe(&mut self) -> TPDOE_W<DSGCRrs> {
        TPDOE_W::new(self, 27)
    }
    ///Bit 28 - CKOE
    #[inline(always)]
    pub fn ckoe(&mut self) -> CKOE_W<DSGCRrs> {
        CKOE_W::new(self, 28)
    }
    ///Bit 29 - ODTOE
    #[inline(always)]
    pub fn odtoe(&mut self) -> ODTOE_W<DSGCRrs> {
        ODTOE_W::new(self, 29)
    }
    ///Bit 30 - RSTOE
    #[inline(always)]
    pub fn rstoe(&mut self) -> RSTOE_W<DSGCRrs> {
        RSTOE_W::new(self, 30)
    }
    ///Bit 31 - CKEOE
    #[inline(always)]
    pub fn ckeoe(&mut self) -> CKEOE_W<DSGCRrs> {
        CKEOE_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DSGCR)*/
pub struct DSGCRrs;
