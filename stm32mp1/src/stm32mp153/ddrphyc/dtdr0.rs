...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtbyte0(&mut self) -> DTBYTE0_W<DTDR0rs> {
        DTBYTE0_W::new(self, 0)
    }
    ///Bits 8:15 - DTBYTE1
    #[inline(always)]
    #[must_use]
    pub fn dtbyte1(&mut self) -> DTBYTE1_W<DTDR0rs> {
        DTBYTE1_W::new(self, 8)
    }
    ///Bits 16:23 - DTBYTE2
    #[inline(always)]
    #[must_use]
    pub fn dtbyte2(&mut self) -> DTBYTE2_W<DTDR0rs> {
        DTBYTE2_W::new(self, 16)
    }
    ///Bits 24:31 - DTBYTE3
    #[inline(always)]
    #[must_use]
    pub fn dtbyte3(&mut self) -> DTBYTE3_W<DTDR0rs> {
