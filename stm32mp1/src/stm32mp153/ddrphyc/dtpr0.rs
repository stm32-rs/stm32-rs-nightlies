...
impl W {
    ///Bits 0:1 - TMRD
    #[inline(always)]
    pub fn tmrd(&mut self) -> TMRD_W<DTPR0rs> {
        TMRD_W::new(self, 0)
    }
    ///Bits 2:4 - TRTP
    #[inline(always)]
    pub fn trtp(&mut self) -> TRTP_W<DTPR0rs> {
        TRTP_W::new(self, 2)
    }
    ///Bits 5:7 - TWTR
    #[inline(always)]
    pub fn twtr(&mut self) -> TWTR_W<DTPR0rs> {
        TWTR_W::new(self, 5)
    }
    ///Bits 8:11 - TRP
    #[inline(always)]
    pub fn trp(&mut self) -> TRP_W<DTPR0rs> {
        TRP_W::new(self, 8)
    }
    ///Bits 12:15 - TRCD
    #[inline(always)]
    pub fn trcd(&mut self) -> TRCD_W<DTPR0rs> {
        TRCD_W::new(self, 12)
    }
    ///Bits 16:20 - TRAS
    #[inline(always)]
    pub fn tras(&mut self) -> TRAS_W<DTPR0rs> {
        TRAS_W::new(self, 16)
    }
    ///Bits 21:24 - TRRD
    #[inline(always)]
    pub fn trrd(&mut self) -> TRRD_W<DTPR0rs> {
        TRRD_W::new(self, 21)
    }
    ///Bits 25:30 - TRC
    #[inline(always)]
    pub fn trc(&mut self) -> TRC_W<DTPR0rs> {
        TRC_W::new(self, 25)
    }
    ///Bit 31 - TCCD
    #[inline(always)]
    pub fn tccd(&mut self) -> TCCD_W<DTPR0rs> {
        TCCD_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DTPR0)*/
pub struct DTPR0rs;
