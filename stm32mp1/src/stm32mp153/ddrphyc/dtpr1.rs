...
impl W {
    ///Bits 0:1 - TAOND
    #[inline(always)]
    pub fn taond(&mut self) -> TAOND_W<DTPR1rs> {
        TAOND_W::new(self, 0)
    }
    ///Bit 2 - TRTW
    #[inline(always)]
    pub fn trtw(&mut self) -> TRTW_W<DTPR1rs> {
        TRTW_W::new(self, 2)
    }
    ///Bits 3:8 - TFAW
    #[inline(always)]
    pub fn tfaw(&mut self) -> TFAW_W<DTPR1rs> {
        TFAW_W::new(self, 3)
    }
    ///Bits 9:10 - TMOD
    #[inline(always)]
    pub fn tmod(&mut self) -> TMOD_W<DTPR1rs> {
        TMOD_W::new(self, 9)
    }
    ///Bit 11 - TRTODT
    #[inline(always)]
    pub fn trtodt(&mut self) -> TRTODT_W<DTPR1rs> {
        TRTODT_W::new(self, 11)
    }
    ///Bits 16:23 - TRFC
    #[inline(always)]
    pub fn trfc(&mut self) -> TRFC_W<DTPR1rs> {
        TRFC_W::new(self, 16)
    }
    ///Bits 24:26 - TDQSCKMIN
    #[inline(always)]
    pub fn tdqsckmin(&mut self) -> TDQSCKMIN_W<DTPR1rs> {
        TDQSCKMIN_W::new(self, 24)
    }
    ///Bits 27:29 - TDQSCKMAX
    #[inline(always)]
    pub fn tdqsckmax(&mut self) -> TDQSCKMAX_W<DTPR1rs> {
