...
impl W {
    ///Bits 0:2 - SFBDLY
    #[inline(always)]
    pub fn sfbdly(&mut self) -> SFBDLY_W<DX0DLLCRrs> {
        SFBDLY_W::new(self, 0)
    }
    ///Bits 3:5 - SFWDLY
    #[inline(always)]
    pub fn sfwdly(&mut self) -> SFWDLY_W<DX0DLLCRrs> {
        SFWDLY_W::new(self, 3)
    }
    ///Bits 6:8 - MFBDLY
    #[inline(always)]
    pub fn mfbdly(&mut self) -> MFBDLY_W<DX0DLLCRrs> {
        MFBDLY_W::new(self, 6)
    }
    ///Bits 9:11 - MFWDLY
    #[inline(always)]
    pub fn mfwdly(&mut self) -> MFWDLY_W<DX0DLLCRrs> {
        MFWDLY_W::new(self, 9)
    }
    ///Bits 12:13 - SSTART
    #[inline(always)]
    pub fn sstart(&mut self) -> SSTART_W<DX0DLLCRrs> {
        SSTART_W::new(self, 12)
    }
    ///Bits 14:17 - SDPHASE
    #[inline(always)]
    pub fn sdphase(&mut self) -> SDPHASE_W<DX0DLLCRrs> {
        SDPHASE_W::new(self, 14)
    }
    ///Bit 18 - ATESTEN
    #[inline(always)]
    pub fn atesten(&mut self) -> ATESTEN_W<DX0DLLCRrs> {
        ATESTEN_W::new(self, 18)
    }
    ///Bit 19 - SDLBMODE
    #[inline(always)]
    pub fn sdlbmode(&mut self) -> SDLBMODE_W<DX0DLLCRrs> {
        SDLBMODE_W::new(self, 19)
    }
    ///Bit 30 - DLLSRST
    #[inline(always)]
    pub fn dllsrst(&mut self) -> DLLSRST_W<DX0DLLCRrs> {
        DLLSRST_W::new(self, 30)
    }
    ///Bit 31 - DLLDIS
    #[inline(always)]
    pub fn dlldis(&mut self) -> DLLDIS_W<DX0DLLCRrs> {
