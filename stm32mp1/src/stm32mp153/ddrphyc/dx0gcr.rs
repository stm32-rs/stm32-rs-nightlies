///Register `DX0GCR` reader
pub type R = crate::R<DX0GCRrs>;
///Register `DX0GCR` writer
pub type W = crate::W<DX0GCRrs>;
...
impl W {
    ///Bit 0 - DXEN
    #[inline(always)]
    pub fn dxen(&mut self) -> DXEN_W<'_, DX0GCRrs> {
        DXEN_W::new(self, 0)
    }
    ///Bit 1 - DQSODT
    #[inline(always)]
    pub fn dqsodt(&mut self) -> DQSODT_W<'_, DX0GCRrs> {
        DQSODT_W::new(self, 1)
    }
    ///Bit 2 - DQODT
    #[inline(always)]
    pub fn dqodt(&mut self) -> DQODT_W<'_, DX0GCRrs> {
        DQODT_W::new(self, 2)
    }
    ///Bit 3 - DXIOM
    #[inline(always)]
    pub fn dxiom(&mut self) -> DXIOM_W<'_, DX0GCRrs> {
        DXIOM_W::new(self, 3)
    }
    ///Bit 4 - DXPDD
    #[inline(always)]
    pub fn dxpdd(&mut self) -> DXPDD_W<'_, DX0GCRrs> {
        DXPDD_W::new(self, 4)
    }
    ///Bit 5 - DXPDR
    #[inline(always)]
    pub fn dxpdr(&mut self) -> DXPDR_W<'_, DX0GCRrs> {
        DXPDR_W::new(self, 5)
    }
    ///Bit 6 - DQSRPD
    #[inline(always)]
    pub fn dqsrpd(&mut self) -> DQSRPD_W<'_, DX0GCRrs> {
        DQSRPD_W::new(self, 6)
    }
    ///Bits 7:8 - DSEN
    #[inline(always)]
    pub fn dsen(&mut self) -> DSEN_W<'_, DX0GCRrs> {
        DSEN_W::new(self, 7)
    }
    ///Bit 9 - DQSRTT
    #[inline(always)]
    pub fn dqsrtt(&mut self) -> DQSRTT_W<'_, DX0GCRrs> {
        DQSRTT_W::new(self, 9)
    }
    ///Bit 10 - DQRTT
    #[inline(always)]
    pub fn dqrtt(&mut self) -> DQRTT_W<'_, DX0GCRrs> {
        DQRTT_W::new(self, 10)
    }
    ///Bits 11:12 - RTTOH
    #[inline(always)]
    pub fn rttoh(&mut self) -> RTTOH_W<'_, DX0GCRrs> {
        RTTOH_W::new(self, 11)
    }
    ///Bit 13 - RTTOAL
    #[inline(always)]
    pub fn rttoal(&mut self) -> RTTOAL_W<'_, DX0GCRrs> {
        RTTOAL_W::new(self, 13)
    }
    ///Bits 14:16 - R0RVSL
    #[inline(always)]
    pub fn r0rvsl(&mut self) -> R0RVSL_W<'_, DX0GCRrs> {
        R0RVSL_W::new(self, 14)
    }
}
/**DDRPHYC byte lane 0 GC register

You can [`read`](crate::Reg::read) this register and get [`dx0gcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dx0gcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DX0GCR)*/
pub struct DX0GCRrs;
impl crate::RegisterSpec for DX0GCRrs {
    type Ux = u32;
}
///`read()` method returns [`dx0gcr::R`](R) reader structure
impl crate::Readable for DX0GCRrs {}
///`write(|w| ..)` method takes [`dx0gcr::W`](W) writer structure
impl crate::Writable for DX0GCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DX0GCR to value 0xee81
impl crate::Resettable for DX0GCRrs {
