///Register `DX0GSR0` reader
pub type R = crate::R<DX0GSR0rs>;
...
You can [`read`](crate::Reg::read) this register and get [`dx0gsr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DX0GSR0)*/
pub struct DX0GSR0rs;
impl crate::RegisterSpec for DX0GSR0rs {
    type Ux = u16;
}
///`read()` method returns [`dx0gsr0::R`](R) reader structure
impl crate::Readable for DX0GSR0rs {}
///`reset()` method sets DX0GSR0 to value 0
impl crate::Resettable for DX0GSR0rs {}
