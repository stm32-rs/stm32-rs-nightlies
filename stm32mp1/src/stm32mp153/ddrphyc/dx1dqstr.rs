...
impl W {
    ///Bits 0:2 - R0DGSL
    #[inline(always)]
    pub fn r0dgsl(&mut self) -> R0DGSL_W<'_, DX1DQSTRrs> {
        R0DGSL_W::new(self, 0)
    }
    ///Bits 12:13 - R0DGPS
    #[inline(always)]
    pub fn r0dgps(&mut self) -> R0DGPS_W<'_, DX1DQSTRrs> {
        R0DGPS_W::new(self, 12)
    }
    ///Bits 20:22 - DQSDLY
    #[inline(always)]
    pub fn dqsdly(&mut self) -> DQSDLY_W<'_, DX1DQSTRrs> {
        DQSDLY_W::new(self, 20)
    }
    ///Bits 23:25 - DQSNDLY
    #[inline(always)]
    pub fn dqsndly(&mut self) -> DQSNDLY_W<'_, DX1DQSTRrs> {
        DQSNDLY_W::new(self, 23)
    }
    ///Bits 26:29 - DMDLY
    #[inline(always)]
    pub fn dmdly(&mut self) -> DMDLY_W<'_, DX1DQSTRrs> {
        DMDLY_W::new(self, 26)
    }
}
