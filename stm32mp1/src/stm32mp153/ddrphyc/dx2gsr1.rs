///Register `DX2GSR1` reader
pub type R = crate::R<DX2GSR1rs>;
...
You can [`read`](crate::Reg::read) this register and get [`dx2gsr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DX2GSR1)*/
pub struct DX2GSR1rs;
impl crate::RegisterSpec for DX2GSR1rs {
    type Ux = u32;
}
///`read()` method returns [`dx2gsr1::R`](R) reader structure
impl crate::Readable for DX2GSR1rs {}
///`reset()` method sets DX2GSR1 to value 0
impl crate::Resettable for DX2GSR1rs {}
