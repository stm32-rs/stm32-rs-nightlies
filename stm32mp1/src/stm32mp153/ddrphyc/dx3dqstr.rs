...
pub type R = crate::R<DX3DQSTRrs>;
///Register `DX3DQSTR` writer
pub type W = crate::W<DX3DQSTRrs>;
...
impl W {
    ///Bits 0:2 - R0DGSL
    #[inline(always)]
    pub fn r0dgsl(&mut self) -> R0DGSL_W<'_, DX3DQSTRrs> {
        R0DGSL_W::new(self, 0)
    }
    ///Bits 12:13 - R0DGPS
    #[inline(always)]
    pub fn r0dgps(&mut self) -> R0DGPS_W<'_, DX3DQSTRrs> {
        R0DGPS_W::new(self, 12)
    }
    ///Bits 20:22 - DQSDLY
    #[inline(always)]
    pub fn dqsdly(&mut self) -> DQSDLY_W<'_, DX3DQSTRrs> {
        DQSDLY_W::new(self, 20)
    }
    ///Bits 23:25 - DQSNDLY
    #[inline(always)]
    pub fn dqsndly(&mut self) -> DQSNDLY_W<'_, DX3DQSTRrs> {
        DQSNDLY_W::new(self, 23)
    }
    ///Bits 26:29 - DMDLY
    #[inline(always)]
    pub fn dmdly(&mut self) -> DMDLY_W<'_, DX3DQSTRrs> {
        DMDLY_W::new(self, 26)
    }
}
/**DDRPHYC byte lane 3 DQST register

You can [`read`](crate::Reg::read) this register and get [`dx3dqstr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dx3dqstr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:DX3DQSTR)*/
pub struct DX3DQSTRrs;
impl crate::RegisterSpec for DX3DQSTRrs {
    type Ux = u32;
}
///`read()` method returns [`dx3dqstr::R`](R) reader structure
impl crate::Readable for DX3DQSTRrs {}
///`write(|w| ..)` method takes [`dx3dqstr::W`](W) writer structure
impl crate::Writable for DX3DQSTRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DX3DQSTR to value 0x3db0_2000
impl crate::Resettable for DX3DQSTRrs {
