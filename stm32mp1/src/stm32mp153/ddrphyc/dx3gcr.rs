...
impl W {
    ///Bit 0 - DXEN
    #[inline(always)]
    pub fn dxen(&mut self) -> DXEN_W<DX3GCRrs> {
        DXEN_W::new(self, 0)
    }
    ///Bit 1 - DQSODT
    #[inline(always)]
    pub fn dqsodt(&mut self) -> DQSODT_W<DX3GCRrs> {
        DQSODT_W::new(self, 1)
    }
    ///Bit 2 - DQODT
    #[inline(always)]
    pub fn dqodt(&mut self) -> DQODT_W<DX3GCRrs> {
        DQODT_W::new(self, 2)
    }
    ///Bit 3 - DXIOM
    #[inline(always)]
    pub fn dxiom(&mut self) -> DXIOM_W<DX3GCRrs> {
        DXIOM_W::new(self, 3)
    }
    ///Bit 4 - DXPDD
    #[inline(always)]
    pub fn dxpdd(&mut self) -> DXPDD_W<DX3GCRrs> {
        DXPDD_W::new(self, 4)
    }
    ///Bit 5 - DXPDR
    #[inline(always)]
    pub fn dxpdr(&mut self) -> DXPDR_W<DX3GCRrs> {
        DXPDR_W::new(self, 5)
    }
    ///Bit 6 - DQSRPD
    #[inline(always)]
    pub fn dqsrpd(&mut self) -> DQSRPD_W<DX3GCRrs> {
        DQSRPD_W::new(self, 6)
    }
    ///Bits 7:8 - DSEN
    #[inline(always)]
    pub fn dsen(&mut self) -> DSEN_W<DX3GCRrs> {
        DSEN_W::new(self, 7)
    }
    ///Bit 9 - DQSRTT
    #[inline(always)]
    pub fn dqsrtt(&mut self) -> DQSRTT_W<DX3GCRrs> {
        DQSRTT_W::new(self, 9)
    }
    ///Bit 10 - DQRTT
    #[inline(always)]
    pub fn dqrtt(&mut self) -> DQRTT_W<DX3GCRrs> {
        DQRTT_W::new(self, 10)
    }
    ///Bits 11:12 - RTTOH
    #[inline(always)]
    pub fn rttoh(&mut self) -> RTTOH_W<DX3GCRrs> {
        RTTOH_W::new(self, 11)
    }
    ///Bit 13 - RTTOAL
    #[inline(always)]
    pub fn rttoal(&mut self) -> RTTOAL_W<DX3GCRrs> {
        RTTOAL_W::new(self, 13)
    }
    ///Bits 14:16 - R0RVSL
    #[inline(always)]
    pub fn r0rvsl(&mut self) -> R0RVSL_W<DX3GCRrs> {
