...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdodt(&mut self) -> RDODT_W<ODTCRrs> {
        RDODT_W::new(self, 0)
    }
    ///Bit 16 - WRODT
    #[inline(always)]
    #[must_use]
    pub fn wrodt(&mut self) -> WRODT_W<ODTCRrs> {
        WRODT_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:ODTCR)*/
pub struct ODTCRrs;
