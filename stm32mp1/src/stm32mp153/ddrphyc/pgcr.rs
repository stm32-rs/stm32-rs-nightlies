...
impl W {
    ///Bit 0 - ITMDMD
    #[inline(always)]
    pub fn itmdmd(&mut self) -> ITMDMD_W<PGCRrs> {
        ITMDMD_W::new(self, 0)
    }
    ///Bit 1 - DQSCFG
    #[inline(always)]
    pub fn dqscfg(&mut self) -> DQSCFG_W<PGCRrs> {
        DQSCFG_W::new(self, 1)
    }
    ///Bit 2 - DFTCMP
    #[inline(always)]
    pub fn dftcmp(&mut self) -> DFTCMP_W<PGCRrs> {
        DFTCMP_W::new(self, 2)
    }
    ///Bits 3:4 - DFTLMT
    #[inline(always)]
    pub fn dftlmt(&mut self) -> DFTLMT_W<PGCRrs> {
        DFTLMT_W::new(self, 3)
    }
    ///Bits 5:8 - DTOSEL
    #[inline(always)]
    pub fn dtosel(&mut self) -> DTOSEL_W<PGCRrs> {
        DTOSEL_W::new(self, 5)
    }
    ///Bits 9:11 - CKEN
    #[inline(always)]
    pub fn cken(&mut self) -> CKEN_W<PGCRrs> {
        CKEN_W::new(self, 9)
    }
    ///Bits 12:13 - CKDV
    #[inline(always)]
    pub fn ckdv(&mut self) -> CKDV_W<PGCRrs> {
        CKDV_W::new(self, 12)
    }
    ///Bit 14 - CKINV
    #[inline(always)]
    pub fn ckinv(&mut self) -> CKINV_W<PGCRrs> {
        CKINV_W::new(self, 14)
    }
    ///Bit 15 - IOLB
    #[inline(always)]
    pub fn iolb(&mut self) -> IOLB_W<PGCRrs> {
        IOLB_W::new(self, 15)
    }
    ///Bits 16:17 - IODDRM
    #[inline(always)]
    pub fn ioddrm(&mut self) -> IODDRM_W<PGCRrs> {
        IODDRM_W::new(self, 16)
    }
    ///Bits 18:21 - RANKEN
    #[inline(always)]
    pub fn ranken(&mut self) -> RANKEN_W<PGCRrs> {
        RANKEN_W::new(self, 18)
    }
    ///Bits 22:23 - ZKSEL
    #[inline(always)]
    pub fn zksel(&mut self) -> ZKSEL_W<PGCRrs> {
        ZKSEL_W::new(self, 22)
    }
    ///Bit 24 - PDDISDX
    #[inline(always)]
    pub fn pddisdx(&mut self) -> PDDISDX_W<PGCRrs> {
        PDDISDX_W::new(self, 24)
    }
    ///Bits 25:28 - RFSHDT
    #[inline(always)]
    pub fn rfshdt(&mut self) -> RFSHDT_W<PGCRrs> {
        RFSHDT_W::new(self, 25)
    }
    ///Bit 29 - LBDQSS
    #[inline(always)]
    pub fn lbdqss(&mut self) -> LBDQSS_W<PGCRrs> {
        LBDQSS_W::new(self, 29)
    }
    ///Bit 30 - LBGDQS
    #[inline(always)]
    pub fn lbgdqs(&mut self) -> LBGDQS_W<PGCRrs> {
        LBGDQS_W::new(self, 30)
    }
    ///Bit 31 - LBMODE
    #[inline(always)]
    pub fn lbmode(&mut self) -> LBMODE_W<PGCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:PGCR)*/
pub struct PGCRrs;
