...
impl W {
    ///Bit 0 - INIT
    #[inline(always)]
    pub fn init(&mut self) -> INIT_W<PIRrs> {
        INIT_W::new(self, 0)
    }
    ///Bit 1 - DLLSRST
    #[inline(always)]
    pub fn dllsrst(&mut self) -> DLLSRST_W<PIRrs> {
        DLLSRST_W::new(self, 1)
    }
    ///Bit 2 - DLLLOCK
    #[inline(always)]
    pub fn dlllock(&mut self) -> DLLLOCK_W<PIRrs> {
        DLLLOCK_W::new(self, 2)
    }
    ///Bit 3 - ZCAL
    #[inline(always)]
    pub fn zcal(&mut self) -> ZCAL_W<PIRrs> {
        ZCAL_W::new(self, 3)
    }
    ///Bit 4 - ITMSRST
    #[inline(always)]
    pub fn itmsrst(&mut self) -> ITMSRST_W<PIRrs> {
        ITMSRST_W::new(self, 4)
    }
    ///Bit 5 - DRAMRST
    #[inline(always)]
    pub fn dramrst(&mut self) -> DRAMRST_W<PIRrs> {
        DRAMRST_W::new(self, 5)
    }
    ///Bit 6 - DRAMINIT
    #[inline(always)]
    pub fn draminit(&mut self) -> DRAMINIT_W<PIRrs> {
        DRAMINIT_W::new(self, 6)
    }
    ///Bit 7 - QSTRN
    #[inline(always)]
    pub fn qstrn(&mut self) -> QSTRN_W<PIRrs> {
        QSTRN_W::new(self, 7)
    }
    ///Bit 8 - RVTRN
    #[inline(always)]
    pub fn rvtrn(&mut self) -> RVTRN_W<PIRrs> {
        RVTRN_W::new(self, 8)
    }
    ///Bit 16 - ICPC
    #[inline(always)]
    pub fn icpc(&mut self) -> ICPC_W<PIRrs> {
        ICPC_W::new(self, 16)
    }
    ///Bit 17 - DLLBYP
    #[inline(always)]
    pub fn dllbyp(&mut self) -> DLLBYP_W<PIRrs> {
        DLLBYP_W::new(self, 17)
    }
    ///Bit 18 - CTLDINIT
    #[inline(always)]
    pub fn ctldinit(&mut self) -> CTLDINIT_W<PIRrs> {
        CTLDINIT_W::new(self, 18)
    }
    ///Bit 28 - CLRSR
    #[inline(always)]
    pub fn clrsr(&mut self) -> CLRSR_W<PIRrs> {
        CLRSR_W::new(self, 28)
    }
    ///Bit 29 - LOCKBYP
    #[inline(always)]
    pub fn lockbyp(&mut self) -> LOCKBYP_W<PIRrs> {
        LOCKBYP_W::new(self, 29)
    }
    ///Bit 30 - ZCALBYP
    #[inline(always)]
    pub fn zcalbyp(&mut self) -> ZCALBYP_W<PIRrs> {
        ZCALBYP_W::new(self, 30)
    }
    ///Bit 31 - INITBYP
    #[inline(always)]
    pub fn initbyp(&mut self) -> INITBYP_W<PIRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DDRPHYC:PIR)*/
pub struct PIRrs;
