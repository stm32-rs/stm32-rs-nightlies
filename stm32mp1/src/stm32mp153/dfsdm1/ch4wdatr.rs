...
You can [`read`](crate::Reg::read) this register and get [`ch4wdatr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`ch4wdatr::R`](R) reader structure
