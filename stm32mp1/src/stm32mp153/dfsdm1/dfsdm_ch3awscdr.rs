///Register `DFSDM_CH3AWSCDR` reader
pub type R = crate::R<DFSDM_CH3AWSCDRrs>;
///Register `DFSDM_CH3AWSCDR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_CH3AWSCDR")
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_ch3awscdr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_ch3awscdr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dfsdm_ch3awscdr::R`](R) reader structure
impl crate::Readable for DFSDM_CH3AWSCDRrs {}
///`write(|w| ..)` method takes [`dfsdm_ch3awscdr::W`](W) writer structure
impl crate::Writable for DFSDM_CH3AWSCDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CH3AWSCDR to value 0
