...
pub type R = crate::R<DFSDM_CH6AWSCDRrs>;
///Register `DFSDM_CH6AWSCDR` writer
pub type W = crate::W<DFSDM_CH6AWSCDRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_CH6AWSCDR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scdt(&mut self) -> SCDT_W<DFSDM_CH6AWSCDRrs> {
        SCDT_W::new(self, 0)
    }
    ///Bits 12:15 - BKSCD
    #[inline(always)]
    #[must_use]
    pub fn bkscd(&mut self) -> BKSCD_W<DFSDM_CH6AWSCDRrs> {
        BKSCD_W::new(self, 12)
    }
    ///Bits 16:20 - AWFOSR
    #[inline(always)]
    #[must_use]
    pub fn awfosr(&mut self) -> AWFOSR_W<DFSDM_CH6AWSCDRrs> {
        AWFOSR_W::new(self, 16)
    }
    ///Bits 22:23 - AWFORD
    #[inline(always)]
    #[must_use]
    pub fn awford(&mut self) -> AWFORD_W<DFSDM_CH6AWSCDRrs> {
        AWFORD_W::new(self, 22)
    }
}
/**Short-circuit detector and analog watchdog settings for channel y.

You can [`read`](crate::Reg::read) this register and get [`dfsdm_ch6awscdr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_ch6awscdr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DFSDM1:DFSDM_CH6AWSCDR)*/
pub struct DFSDM_CH6AWSCDRrs;
impl crate::RegisterSpec for DFSDM_CH6AWSCDRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_ch6awscdr::R`](R) reader structure
impl crate::Readable for DFSDM_CH6AWSCDRrs {}
///`write(|w| ..)` method takes [`dfsdm_ch6awscdr::W`](W) writer structure
impl crate::Writable for DFSDM_CH6AWSCDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CH6AWSCDR to value 0
impl crate::Resettable for DFSDM_CH6AWSCDRrs {
