///Register `DFSDM_FLT0AWCFR` reader
pub type R = crate::R<DFSDM_FLT0AWCFRrs>;
///Register `DFSDM_FLT0AWCFR` writer
pub type W = crate::W<DFSDM_FLT0AWCFRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT0AWCFR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrawltf(&mut self) -> CLRAWLTF_W<DFSDM_FLT0AWCFRrs> {
        CLRAWLTF_W::new(self, 0)
    }
    ///Bits 8:15 - CLRAWHTF
    #[inline(always)]
    #[must_use]
    pub fn clrawhtf(&mut self) -> CLRAWHTF_W<DFSDM_FLT0AWCFRrs> {
...
pub struct DFSDM_FLT0AWCFRrs;
impl crate::RegisterSpec for DFSDM_FLT0AWCFRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt0awcfr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT0AWCFRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt0awcfr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT0AWCFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT0AWCFR to value 0
impl crate::Resettable for DFSDM_FLT0AWCFRrs {
