///Register `DFSDM_FLT0ICR` reader
pub type R = crate::R<DFSDM_FLT0ICRrs>;
///Register `DFSDM_FLT0ICR` writer
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt0icr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_flt0icr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dfsdm_flt0icr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT0ICRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt0icr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT0ICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT0ICR to value 0
