...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT2RDATAR")
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt2rdatar::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
