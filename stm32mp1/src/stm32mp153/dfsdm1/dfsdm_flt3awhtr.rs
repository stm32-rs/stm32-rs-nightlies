///Register `DFSDM_FLT3AWHTR` reader
pub type R = crate::R<DFSDM_FLT3AWHTRrs>;
///Register `DFSDM_FLT3AWHTR` writer
pub type W = crate::W<DFSDM_FLT3AWHTRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT3AWHTR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkawh(&mut self) -> BKAWH_W<DFSDM_FLT3AWHTRrs> {
        BKAWH_W::new(self, 0)
    }
    ///Bits 8:31 - AWHT
    #[inline(always)]
    #[must_use]
    pub fn awht(&mut self) -> AWHT_W<DFSDM_FLT3AWHTRrs> {
        AWHT_W::new(self, 8)
    }
}
...
pub struct DFSDM_FLT3AWHTRrs;
impl crate::RegisterSpec for DFSDM_FLT3AWHTRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt3awhtr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT3AWHTRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt3awhtr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT3AWHTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT3AWHTR to value 0
impl crate::Resettable for DFSDM_FLT3AWHTRrs {
