///Register `DFSDM_FLT5CR2` reader
pub type R = crate::R<DFSDM_FLT5CR2rs>;
///Register `DFSDM_FLT5CR2` writer
pub type W = crate::W<DFSDM_FLT5CR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn jeocie(&mut self) -> JEOCIE_W<DFSDM_FLT5CR2rs> {
        JEOCIE_W::new(self, 0)
    }
    ///Bit 1 - REOCIE
    #[inline(always)]
    #[must_use]
    pub fn reocie(&mut self) -> REOCIE_W<DFSDM_FLT5CR2rs> {
        REOCIE_W::new(self, 1)
    }
    ///Bit 2 - JOVRIE
    #[inline(always)]
    #[must_use]
    pub fn jovrie(&mut self) -> JOVRIE_W<DFSDM_FLT5CR2rs> {
        JOVRIE_W::new(self, 2)
    }
    ///Bit 3 - ROVRIE
    #[inline(always)]
    #[must_use]
    pub fn rovrie(&mut self) -> ROVRIE_W<DFSDM_FLT5CR2rs> {
        ROVRIE_W::new(self, 3)
    }
    ///Bit 4 - AWDIE
    #[inline(always)]
    #[must_use]
    pub fn awdie(&mut self) -> AWDIE_W<DFSDM_FLT5CR2rs> {
        AWDIE_W::new(self, 4)
    }
    ///Bit 5 - SCDIE
    #[inline(always)]
    #[must_use]
    pub fn scdie(&mut self) -> SCDIE_W<DFSDM_FLT5CR2rs> {
        SCDIE_W::new(self, 5)
    }
    ///Bit 6 - CKABIE
    #[inline(always)]
    #[must_use]
    pub fn ckabie(&mut self) -> CKABIE_W<DFSDM_FLT5CR2rs> {
        CKABIE_W::new(self, 6)
    }
    ///Bits 8:15 - EXCH
    #[inline(always)]
    #[must_use]
    pub fn exch(&mut self) -> EXCH_W<DFSDM_FLT5CR2rs> {
        EXCH_W::new(self, 8)
    }
    ///Bits 16:23 - AWDCH
    #[inline(always)]
    #[must_use]
    pub fn awdch(&mut self) -> AWDCH_W<DFSDM_FLT5CR2rs> {
        AWDCH_W::new(self, 16)
    }
}
/**DFSDM filter 5 control register 2

You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt5cr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_flt5cr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DFSDM1:DFSDM_FLT5CR2)*/
pub struct DFSDM_FLT5CR2rs;
impl crate::RegisterSpec for DFSDM_FLT5CR2rs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt5cr2::R`](R) reader structure
impl crate::Readable for DFSDM_FLT5CR2rs {}
///`write(|w| ..)` method takes [`dfsdm_flt5cr2::W`](W) writer structure
impl crate::Writable for DFSDM_FLT5CR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT5CR2 to value 0
impl crate::Resettable for DFSDM_FLT5CR2rs {
