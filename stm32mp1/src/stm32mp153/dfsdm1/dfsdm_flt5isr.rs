///Register `DFSDM_FLT5ISR` reader
pub type R = crate::R<DFSDM_FLT5ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt5isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DFSDM1:DFSDM_FLT5ISR)*/
pub struct DFSDM_FLT5ISRrs;
impl crate::RegisterSpec for DFSDM_FLT5ISRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt5isr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT5ISRrs {}
///`reset()` method sets DFSDM_FLT5ISR to value 0x00ff_0000
impl crate::Resettable for DFSDM_FLT5ISRrs {
