...
impl W {
    ///Bit 0 - JEOCIE
    #[inline(always)]
    pub fn jeocie(&mut self) -> JEOCIE_W<'_, FLT1CR2rs> {
        JEOCIE_W::new(self, 0)
    }
    ///Bit 1 - REOCIE
    #[inline(always)]
    pub fn reocie(&mut self) -> REOCIE_W<'_, FLT1CR2rs> {
        REOCIE_W::new(self, 1)
    }
    ///Bit 2 - JOVRIE
    #[inline(always)]
    pub fn jovrie(&mut self) -> JOVRIE_W<'_, FLT1CR2rs> {
        JOVRIE_W::new(self, 2)
    }
    ///Bit 3 - ROVRIE
    #[inline(always)]
    pub fn rovrie(&mut self) -> ROVRIE_W<'_, FLT1CR2rs> {
        ROVRIE_W::new(self, 3)
    }
    ///Bit 4 - AWDIE
    #[inline(always)]
    pub fn awdie(&mut self) -> AWDIE_W<'_, FLT1CR2rs> {
        AWDIE_W::new(self, 4)
    }
    ///Bit 5 - SCDIE
    #[inline(always)]
    pub fn scdie(&mut self) -> SCDIE_W<'_, FLT1CR2rs> {
        SCDIE_W::new(self, 5)
    }
    ///Bit 6 - CKABIE
    #[inline(always)]
    pub fn ckabie(&mut self) -> CKABIE_W<'_, FLT1CR2rs> {
        CKABIE_W::new(self, 6)
    }
    ///Bits 8:15 - EXCH
    #[inline(always)]
    pub fn exch(&mut self) -> EXCH_W<'_, FLT1CR2rs> {
        EXCH_W::new(self, 8)
    }
    ///Bits 16:23 - AWDCH
    #[inline(always)]
    pub fn awdch(&mut self) -> AWDCH_W<'_, FLT1CR2rs> {
        AWDCH_W::new(self, 16)
    }
}
