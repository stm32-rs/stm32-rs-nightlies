...
///Register `FLT2EXMIN` writer
pub type W = crate::W<FLT2EXMINrs>;
...
impl W {
    ///Bits 8:31 - EXMIN
    #[inline(always)]
    pub fn exmin(&mut self) -> EXMIN_W<'_, FLT2EXMINrs> {
        EXMIN_W::new(self, 8)
    }
}
/**DFSDM filter 2 extremes detector minimum register

You can [`read`](crate::Reg::read) this register and get [`flt2exmin::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flt2exmin::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`write(|w| ..)` method takes [`flt2exmin::W`](W) writer structure
impl crate::Writable for FLT2EXMINrs {
