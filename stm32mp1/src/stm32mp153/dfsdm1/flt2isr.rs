///Register `FLT2ISR` reader
pub type R = crate::R<FLT2ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`flt2isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DFSDM1:FLT2ISR)*/
pub struct FLT2ISRrs;
impl crate::RegisterSpec for FLT2ISRrs {
    type Ux = u32;
}
///`read()` method returns [`flt2isr::R`](R) reader structure
impl crate::Readable for FLT2ISRrs {}
///`reset()` method sets FLT2ISR to value 0x00ff_0000
impl crate::Resettable for FLT2ISRrs {
