///Register `FLT3ISR` reader
pub type R = crate::R<FLT3ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`flt3isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DFSDM1:FLT3ISR)*/
pub struct FLT3ISRrs;
impl crate::RegisterSpec for FLT3ISRrs {
    type Ux = u32;
}
///`read()` method returns [`flt3isr::R`](R) reader structure
impl crate::Readable for FLT3ISRrs {}
///`reset()` method sets FLT3ISR to value 0x00ff_0000
impl crate::Resettable for FLT3ISRrs {
