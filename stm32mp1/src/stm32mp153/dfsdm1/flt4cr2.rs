///Register `FLT4CR2` reader
pub type R = crate::R<FLT4CR2rs>;
///Register `FLT4CR2` writer
pub type W = crate::W<FLT4CR2rs>;
...
impl W {
    ///Bit 0 - JEOCIE
    #[inline(always)]
    pub fn jeocie(&mut self) -> JEOCIE_W<'_, FLT4CR2rs> {
        JEOCIE_W::new(self, 0)
    }
    ///Bit 1 - REOCIE
    #[inline(always)]
    pub fn reocie(&mut self) -> REOCIE_W<'_, FLT4CR2rs> {
        REOCIE_W::new(self, 1)
    }
    ///Bit 2 - JOVRIE
    #[inline(always)]
    pub fn jovrie(&mut self) -> JOVRIE_W<'_, FLT4CR2rs> {
        JOVRIE_W::new(self, 2)
    }
    ///Bit 3 - ROVRIE
    #[inline(always)]
    pub fn rovrie(&mut self) -> ROVRIE_W<'_, FLT4CR2rs> {
        ROVRIE_W::new(self, 3)
    }
    ///Bit 4 - AWDIE
    #[inline(always)]
    pub fn awdie(&mut self) -> AWDIE_W<'_, FLT4CR2rs> {
        AWDIE_W::new(self, 4)
    }
    ///Bit 5 - SCDIE
    #[inline(always)]
    pub fn scdie(&mut self) -> SCDIE_W<'_, FLT4CR2rs> {
        SCDIE_W::new(self, 5)
    }
    ///Bit 6 - CKABIE
    #[inline(always)]
    pub fn ckabie(&mut self) -> CKABIE_W<'_, FLT4CR2rs> {
        CKABIE_W::new(self, 6)
    }
    ///Bits 8:15 - EXCH
    #[inline(always)]
    pub fn exch(&mut self) -> EXCH_W<'_, FLT4CR2rs> {
        EXCH_W::new(self, 8)
    }
    ///Bits 16:23 - AWDCH
    #[inline(always)]
    pub fn awdch(&mut self) -> AWDCH_W<'_, FLT4CR2rs> {
        AWDCH_W::new(self, 16)
    }
}
/**DFSDM filter 4 control register 2

You can [`read`](crate::Reg::read) this register and get [`flt4cr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flt4cr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DFSDM1:FLT4CR2)*/
pub struct FLT4CR2rs;
impl crate::RegisterSpec for FLT4CR2rs {
    type Ux = u32;
}
///`read()` method returns [`flt4cr2::R`](R) reader structure
impl crate::Readable for FLT4CR2rs {}
///`write(|w| ..)` method takes [`flt4cr2::W`](W) writer structure
impl crate::Writable for FLT4CR2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FLT4CR2 to value 0
impl crate::Resettable for FLT4CR2rs {}
