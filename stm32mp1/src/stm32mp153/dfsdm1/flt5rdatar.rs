///Register `FLT5RDATAR` reader
pub type R = crate::R<FLT5RDATARrs>;
...
You can [`read`](crate::Reg::read) this register and get [`flt5rdatar::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DFSDM1:FLT5RDATAR)*/
pub struct FLT5RDATARrs;
impl crate::RegisterSpec for FLT5RDATARrs {
    type Ux = u32;
}
///`read()` method returns [`flt5rdatar::R`](R) reader structure
impl crate::Readable for FLT5RDATARrs {}
///`reset()` method sets FLT5RDATAR to value 0
impl crate::Resettable for FLT5RDATARrs {}
