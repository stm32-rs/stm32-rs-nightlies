...
impl core::fmt::Debug for crate::generic::Reg<DMA_LIFCRrs> {
...
You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_lifcr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
