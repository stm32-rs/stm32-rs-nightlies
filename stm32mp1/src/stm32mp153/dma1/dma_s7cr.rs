///Register `DMA_S7CR` reader
pub type R = crate::R<DMA_S7CRrs>;
///Register `DMA_S7CR` writer
...
You can [`read`](crate::Reg::read) this register and get [`dma_s7cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_s7cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dma_s7cr::R`](R) reader structure
impl crate::Readable for DMA_S7CRrs {}
///`write(|w| ..)` method takes [`dma_s7cr::W`](W) writer structure
impl crate::Writable for DMA_S7CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMA_S7CR to value 0
