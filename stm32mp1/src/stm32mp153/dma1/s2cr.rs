...
impl W {
    ///Bit 0 - EN
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<S2CRrs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - DMEIE
    #[inline(always)]
    pub fn dmeie(&mut self) -> DMEIE_W<S2CRrs> {
        DMEIE_W::new(self, 1)
    }
    ///Bit 2 - TEIE
    #[inline(always)]
    pub fn teie(&mut self) -> TEIE_W<S2CRrs> {
        TEIE_W::new(self, 2)
    }
    ///Bit 3 - HTIE
    #[inline(always)]
    pub fn htie(&mut self) -> HTIE_W<S2CRrs> {
        HTIE_W::new(self, 3)
    }
    ///Bit 4 - TCIE
    #[inline(always)]
    pub fn tcie(&mut self) -> TCIE_W<S2CRrs> {
        TCIE_W::new(self, 4)
    }
    ///Bit 5 - PFCTRL
    #[inline(always)]
    pub fn pfctrl(&mut self) -> PFCTRL_W<S2CRrs> {
        PFCTRL_W::new(self, 5)
    }
    ///Bits 6:7 - DIR
    #[inline(always)]
    pub fn dir(&mut self) -> DIR_W<S2CRrs> {
        DIR_W::new(self, 6)
    }
    ///Bit 8 - CIRC
    #[inline(always)]
    pub fn circ(&mut self) -> CIRC_W<S2CRrs> {
        CIRC_W::new(self, 8)
    }
    ///Bit 9 - PINC
    #[inline(always)]
    pub fn pinc(&mut self) -> PINC_W<S2CRrs> {
        PINC_W::new(self, 9)
    }
    ///Bit 10 - MINC
    #[inline(always)]
    pub fn minc(&mut self) -> MINC_W<S2CRrs> {
        MINC_W::new(self, 10)
    }
    ///Bits 11:12 - PSIZE
    #[inline(always)]
    pub fn psize(&mut self) -> PSIZE_W<S2CRrs> {
        PSIZE_W::new(self, 11)
    }
    ///Bits 13:14 - MSIZE
    #[inline(always)]
    pub fn msize(&mut self) -> MSIZE_W<S2CRrs> {
        MSIZE_W::new(self, 13)
    }
    ///Bit 15 - PINCOS
    #[inline(always)]
    pub fn pincos(&mut self) -> PINCOS_W<S2CRrs> {
        PINCOS_W::new(self, 15)
    }
    ///Bits 16:17 - PL
    #[inline(always)]
    pub fn pl(&mut self) -> PL_W<S2CRrs> {
        PL_W::new(self, 16)
    }
    ///Bit 18 - DBM
    #[inline(always)]
    pub fn dbm(&mut self) -> DBM_W<S2CRrs> {
        DBM_W::new(self, 18)
    }
    ///Bit 19 - CT
    #[inline(always)]
    pub fn ct(&mut self) -> CT_W<S2CRrs> {
        CT_W::new(self, 19)
    }
    ///Bits 21:22 - PBURST
    #[inline(always)]
    pub fn pburst(&mut self) -> PBURST_W<S2CRrs> {
        PBURST_W::new(self, 21)
    }
    ///Bits 23:24 - MBURST
    #[inline(always)]
    pub fn mburst(&mut self) -> MBURST_W<S2CRrs> {
