///Register `S4M0AR` reader
pub type R = crate::R<S4M0ARrs>;
///Register `S4M0AR` writer
pub type W = crate::W<S4M0ARrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("S4M0AR").field("m0a", &self.m0a()).finish()
    }
}
impl W {
    ///Bits 0:31 - M0A
    #[inline(always)]
    pub fn m0a(&mut self) -> M0A_W<'_, S4M0ARrs> {
        M0A_W::new(self, 0)
    }
}
...
pub struct S4M0ARrs;
impl crate::RegisterSpec for S4M0ARrs {
    type Ux = u32;
}
///`read()` method returns [`s4m0ar::R`](R) reader structure
impl crate::Readable for S4M0ARrs {}
///`write(|w| ..)` method takes [`s4m0ar::W`](W) writer structure
impl crate::Writable for S4M0ARrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets S4M0AR to value 0
impl crate::Resettable for S4M0ARrs {}
