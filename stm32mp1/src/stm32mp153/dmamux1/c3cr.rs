...
impl W {
    ///Bits 0:6 - DMAREQ_ID
    #[inline(always)]
    pub fn dmareq_id(&mut self) -> DMAREQ_ID_W<'_, C3CRrs> {
        DMAREQ_ID_W::new(self, 0)
    }
    ///Bit 8 - SOIE
    #[inline(always)]
    pub fn soie(&mut self) -> SOIE_W<'_, C3CRrs> {
        SOIE_W::new(self, 8)
    }
    ///Bit 9 - EGE
    #[inline(always)]
    pub fn ege(&mut self) -> EGE_W<'_, C3CRrs> {
        EGE_W::new(self, 9)
    }
    ///Bit 16 - SE
    #[inline(always)]
    pub fn se(&mut self) -> SE_W<'_, C3CRrs> {
        SE_W::new(self, 16)
    }
    ///Bits 17:18 - SPOL
    #[inline(always)]
    pub fn spol(&mut self) -> SPOL_W<'_, C3CRrs> {
        SPOL_W::new(self, 17)
    }
    ///Bits 19:23 - NBREQ
    #[inline(always)]
    pub fn nbreq(&mut self) -> NBREQ_W<'_, C3CRrs> {
        NBREQ_W::new(self, 19)
    }
    ///Bits 24:26 - SYNC_ID
    #[inline(always)]
    pub fn sync_id(&mut self) -> SYNC_ID_W<'_, C3CRrs> {
