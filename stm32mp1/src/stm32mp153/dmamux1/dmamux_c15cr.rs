///Register `DMAMUX_C15CR` reader
pub type R = crate::R<DMAMUX_C15CRrs>;
///Register `DMAMUX_C15CR` writer
pub type W = crate::W<DMAMUX_C15CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmareq_id(&mut self) -> DMAREQ_ID_W<DMAMUX_C15CRrs> {
        DMAREQ_ID_W::new(self, 0)
    }
    ///Bit 8 - SOIE
    #[inline(always)]
    #[must_use]
    pub fn soie(&mut self) -> SOIE_W<DMAMUX_C15CRrs> {
        SOIE_W::new(self, 8)
    }
    ///Bit 9 - EGE
    #[inline(always)]
    #[must_use]
    pub fn ege(&mut self) -> EGE_W<DMAMUX_C15CRrs> {
        EGE_W::new(self, 9)
    }
    ///Bit 16 - SE
    #[inline(always)]
    #[must_use]
    pub fn se(&mut self) -> SE_W<DMAMUX_C15CRrs> {
        SE_W::new(self, 16)
    }
    ///Bits 17:18 - SPOL
    #[inline(always)]
    #[must_use]
    pub fn spol(&mut self) -> SPOL_W<DMAMUX_C15CRrs> {
        SPOL_W::new(self, 17)
    }
    ///Bits 19:23 - NBREQ
    #[inline(always)]
    #[must_use]
    pub fn nbreq(&mut self) -> NBREQ_W<DMAMUX_C15CRrs> {
        NBREQ_W::new(self, 19)
    }
    ///Bits 24:26 - SYNC_ID
    #[inline(always)]
    #[must_use]
    pub fn sync_id(&mut self) -> SYNC_ID_W<DMAMUX_C15CRrs> {
        SYNC_ID_W::new(self, 24)
    }
}
/**DMAMUX request line multiplexer channel 15 configuration register

You can [`read`](crate::Reg::read) this register and get [`dmamux_c15cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmamux_c15cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DMAMUX1:DMAMUX_C15CR)*/
pub struct DMAMUX_C15CRrs;
impl crate::RegisterSpec for DMAMUX_C15CRrs {
    type Ux = u32;
}
///`read()` method returns [`dmamux_c15cr::R`](R) reader structure
impl crate::Readable for DMAMUX_C15CRrs {}
///`write(|w| ..)` method takes [`dmamux_c15cr::W`](W) writer structure
impl crate::Writable for DMAMUX_C15CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMAMUX_C15CR to value 0
impl crate::Resettable for DMAMUX_C15CRrs {
