///Register `DMAMUX_C2CR` reader
pub type R = crate::R<DMAMUX_C2CRrs>;
///Register `DMAMUX_C2CR` writer
pub type W = crate::W<DMAMUX_C2CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmareq_id(&mut self) -> DMAREQ_ID_W<DMAMUX_C2CRrs> {
        DMAREQ_ID_W::new(self, 0)
    }
    ///Bit 8 - SOIE
    #[inline(always)]
    #[must_use]
    pub fn soie(&mut self) -> SOIE_W<DMAMUX_C2CRrs> {
        SOIE_W::new(self, 8)
    }
    ///Bit 9 - EGE
    #[inline(always)]
    #[must_use]
    pub fn ege(&mut self) -> EGE_W<DMAMUX_C2CRrs> {
        EGE_W::new(self, 9)
    }
    ///Bit 16 - SE
    #[inline(always)]
    #[must_use]
    pub fn se(&mut self) -> SE_W<DMAMUX_C2CRrs> {
        SE_W::new(self, 16)
    }
    ///Bits 17:18 - SPOL
    #[inline(always)]
    #[must_use]
    pub fn spol(&mut self) -> SPOL_W<DMAMUX_C2CRrs> {
        SPOL_W::new(self, 17)
    }
    ///Bits 19:23 - NBREQ
    #[inline(always)]
    #[must_use]
    pub fn nbreq(&mut self) -> NBREQ_W<DMAMUX_C2CRrs> {
        NBREQ_W::new(self, 19)
    }
    ///Bits 24:26 - SYNC_ID
    #[inline(always)]
    #[must_use]
    pub fn sync_id(&mut self) -> SYNC_ID_W<DMAMUX_C2CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DMAMUX1:DMAMUX_C2CR)*/
pub struct DMAMUX_C2CRrs;
impl crate::RegisterSpec for DMAMUX_C2CRrs {
    type Ux = u32;
}
///`read()` method returns [`dmamux_c2cr::R`](R) reader structure
impl crate::Readable for DMAMUX_C2CRrs {}
///`write(|w| ..)` method takes [`dmamux_c2cr::W`](W) writer structure
impl crate::Writable for DMAMUX_C2CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMAMUX_C2CR to value 0
impl crate::Resettable for DMAMUX_C2CRrs {
