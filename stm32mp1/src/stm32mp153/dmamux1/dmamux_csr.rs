...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DMAMUX1:DMAMUX_CSR)*/
pub struct DMAMUX_CSRrs;
impl crate::RegisterSpec for DMAMUX_CSRrs {
    type Ux = u32;
}
///`read()` method returns [`dmamux_csr::R`](R) reader structure
impl crate::Readable for DMAMUX_CSRrs {}
///`reset()` method sets DMAMUX_CSR to value 0
