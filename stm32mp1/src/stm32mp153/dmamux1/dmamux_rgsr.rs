...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DMAMUX1:DMAMUX_RGSR)*/
pub struct DMAMUX_RGSRrs;
impl crate::RegisterSpec for DMAMUX_RGSRrs {
    type Ux = u32;
}
///`read()` method returns [`dmamux_rgsr::R`](R) reader structure
