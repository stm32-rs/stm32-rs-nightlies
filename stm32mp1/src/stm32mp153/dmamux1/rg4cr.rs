///Register `RG4CR` reader
pub type R = crate::R<RG4CRrs>;
///Register `RG4CR` writer
pub type W = crate::W<RG4CRrs>;
...
impl W {
    ///Bits 0:2 - SIG_ID
    #[inline(always)]
    pub fn sig_id(&mut self) -> SIG_ID_W<'_, RG4CRrs> {
        SIG_ID_W::new(self, 0)
    }
    ///Bit 8 - OIE
    #[inline(always)]
    pub fn oie(&mut self) -> OIE_W<'_, RG4CRrs> {
        OIE_W::new(self, 8)
    }
    ///Bit 16 - GE
    #[inline(always)]
    pub fn ge(&mut self) -> GE_W<'_, RG4CRrs> {
        GE_W::new(self, 16)
    }
    ///Bits 17:18 - GPOL
    #[inline(always)]
    pub fn gpol(&mut self) -> GPOL_W<'_, RG4CRrs> {
        GPOL_W::new(self, 17)
    }
    ///Bits 19:23 - GNBREQ
    #[inline(always)]
    pub fn gnbreq(&mut self) -> GNBREQ_W<'_, RG4CRrs> {
...
pub struct RG4CRrs;
impl crate::RegisterSpec for RG4CRrs {
    type Ux = u32;
}
///`read()` method returns [`rg4cr::R`](R) reader structure
impl crate::Readable for RG4CRrs {}
///`write(|w| ..)` method takes [`rg4cr::W`](W) writer structure
impl crate::Writable for RG4CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RG4CR to value 0
impl crate::Resettable for RG4CRrs {}
