...
pub type R = crate::R<DTS_ORrs>;
///Register `DTS_OR` writer
pub type W = crate::W<DTS_ORrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ts_op0(&mut self) -> TS_OP0_W<DTS_ORrs> {
        TS_OP0_W::new(self, 0)
    }
    ///Bit 1 - TS_Op1
    #[inline(always)]
    #[must_use]
    pub fn ts_op1(&mut self) -> TS_OP1_W<DTS_ORrs> {
        TS_OP1_W::new(self, 1)
    }
    ///Bit 2 - TS_Op2
    #[inline(always)]
    #[must_use]
    pub fn ts_op2(&mut self) -> TS_OP2_W<DTS_ORrs> {
        TS_OP2_W::new(self, 2)
    }
    ///Bit 3 - TS_Op3
    #[inline(always)]
    #[must_use]
    pub fn ts_op3(&mut self) -> TS_OP3_W<DTS_ORrs> {
        TS_OP3_W::new(self, 3)
    }
    ///Bit 4 - TS_Op4
    #[inline(always)]
    #[must_use]
    pub fn ts_op4(&mut self) -> TS_OP4_W<DTS_ORrs> {
        TS_OP4_W::new(self, 4)
    }
    ///Bit 5 - TS_Op5
    #[inline(always)]
    #[must_use]
    pub fn ts_op5(&mut self) -> TS_OP5_W<DTS_ORrs> {
        TS_OP5_W::new(self, 5)
    }
    ///Bit 6 - TS_Op6
    #[inline(always)]
    #[must_use]
    pub fn ts_op6(&mut self) -> TS_OP6_W<DTS_ORrs> {
        TS_OP6_W::new(self, 6)
    }
    ///Bit 7 - TS_Op7
    #[inline(always)]
    #[must_use]
    pub fn ts_op7(&mut self) -> TS_OP7_W<DTS_ORrs> {
        TS_OP7_W::new(self, 7)
    }
    ///Bit 8 - TS_Op8
    #[inline(always)]
    #[must_use]
    pub fn ts_op8(&mut self) -> TS_OP8_W<DTS_ORrs> {
        TS_OP8_W::new(self, 8)
    }
    ///Bit 9 - TS_Op9
    #[inline(always)]
    #[must_use]
    pub fn ts_op9(&mut self) -> TS_OP9_W<DTS_ORrs> {
        TS_OP9_W::new(self, 9)
    }
    ///Bit 10 - TS_Op10
    #[inline(always)]
    #[must_use]
    pub fn ts_op10(&mut self) -> TS_OP10_W<DTS_ORrs> {
        TS_OP10_W::new(self, 10)
    }
    ///Bit 11 - TS_Op11
    #[inline(always)]
    #[must_use]
    pub fn ts_op11(&mut self) -> TS_OP11_W<DTS_ORrs> {
        TS_OP11_W::new(self, 11)
    }
    ///Bit 12 - TS_Op12
    #[inline(always)]
    #[must_use]
    pub fn ts_op12(&mut self) -> TS_OP12_W<DTS_ORrs> {
        TS_OP12_W::new(self, 12)
    }
    ///Bit 13 - TS_Op13
    #[inline(always)]
    #[must_use]
    pub fn ts_op13(&mut self) -> TS_OP13_W<DTS_ORrs> {
        TS_OP13_W::new(self, 13)
    }
    ///Bit 14 - TS_Op14
    #[inline(always)]
    #[must_use]
    pub fn ts_op14(&mut self) -> TS_OP14_W<DTS_ORrs> {
        TS_OP14_W::new(self, 14)
    }
    ///Bit 15 - TS_Op15
    #[inline(always)]
    #[must_use]
    pub fn ts_op15(&mut self) -> TS_OP15_W<DTS_ORrs> {
        TS_OP15_W::new(self, 15)
    }
    ///Bit 16 - TS_Op16
    #[inline(always)]
    #[must_use]
    pub fn ts_op16(&mut self) -> TS_OP16_W<DTS_ORrs> {
        TS_OP16_W::new(self, 16)
    }
    ///Bit 17 - TS_Op17
    #[inline(always)]
    #[must_use]
    pub fn ts_op17(&mut self) -> TS_OP17_W<DTS_ORrs> {
        TS_OP17_W::new(self, 17)
    }
    ///Bit 18 - TS_Op18
    #[inline(always)]
    #[must_use]
    pub fn ts_op18(&mut self) -> TS_OP18_W<DTS_ORrs> {
        TS_OP18_W::new(self, 18)
    }
    ///Bit 19 - TS_Op19
    #[inline(always)]
    #[must_use]
    pub fn ts_op19(&mut self) -> TS_OP19_W<DTS_ORrs> {
        TS_OP19_W::new(self, 19)
    }
    ///Bit 20 - TS_Op20
    #[inline(always)]
    #[must_use]
    pub fn ts_op20(&mut self) -> TS_OP20_W<DTS_ORrs> {
        TS_OP20_W::new(self, 20)
    }
    ///Bit 21 - TS_Op21
    #[inline(always)]
    #[must_use]
    pub fn ts_op21(&mut self) -> TS_OP21_W<DTS_ORrs> {
        TS_OP21_W::new(self, 21)
    }
    ///Bit 22 - TS_Op22
    #[inline(always)]
    #[must_use]
    pub fn ts_op22(&mut self) -> TS_OP22_W<DTS_ORrs> {
        TS_OP22_W::new(self, 22)
    }
    ///Bit 23 - TS_Op23
    #[inline(always)]
    #[must_use]
    pub fn ts_op23(&mut self) -> TS_OP23_W<DTS_ORrs> {
        TS_OP23_W::new(self, 23)
    }
    ///Bit 24 - TS_Op24
    #[inline(always)]
    #[must_use]
    pub fn ts_op24(&mut self) -> TS_OP24_W<DTS_ORrs> {
        TS_OP24_W::new(self, 24)
    }
    ///Bit 25 - TS_Op25
    #[inline(always)]
    #[must_use]
    pub fn ts_op25(&mut self) -> TS_OP25_W<DTS_ORrs> {
        TS_OP25_W::new(self, 25)
    }
    ///Bit 26 - TS_Op26
    #[inline(always)]
    #[must_use]
    pub fn ts_op26(&mut self) -> TS_OP26_W<DTS_ORrs> {
        TS_OP26_W::new(self, 26)
    }
    ///Bit 27 - TS_Op27
    #[inline(always)]
    #[must_use]
    pub fn ts_op27(&mut self) -> TS_OP27_W<DTS_ORrs> {
        TS_OP27_W::new(self, 27)
    }
    ///Bit 28 - TS_Op28
    #[inline(always)]
    #[must_use]
    pub fn ts_op28(&mut self) -> TS_OP28_W<DTS_ORrs> {
        TS_OP28_W::new(self, 28)
    }
    ///Bit 29 - TS_Op29
    #[inline(always)]
    #[must_use]
    pub fn ts_op29(&mut self) -> TS_OP29_W<DTS_ORrs> {
        TS_OP29_W::new(self, 29)
    }
    ///Bit 30 - TS_Op30
    #[inline(always)]
    #[must_use]
    pub fn ts_op30(&mut self) -> TS_OP30_W<DTS_ORrs> {
        TS_OP30_W::new(self, 30)
    }
    ///Bit 31 - TS_Op31
    #[inline(always)]
    #[must_use]
    pub fn ts_op31(&mut self) -> TS_OP31_W<DTS_ORrs> {
        TS_OP31_W::new(self, 31)
    }
}
/**The DTS_OR contains general-purpose option bits.

You can [`read`](crate::Reg::read) this register and get [`dts_or::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dts_or::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#DTS:DTS_OR)*/
pub struct DTS_ORrs;
impl crate::RegisterSpec for DTS_ORrs {
    type Ux = u32;
}
///`read()` method returns [`dts_or::R`](R) reader structure
impl crate::Readable for DTS_ORrs {}
///`write(|w| ..)` method takes [`dts_or::W`](W) writer structure
impl crate::Writable for DTS_ORrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DTS_OR to value 0
impl crate::Resettable for DTS_ORrs {
