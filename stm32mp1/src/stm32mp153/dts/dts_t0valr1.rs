...
You can [`read`](crate::Reg::read) this register and get [`dts_t0valr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dts_t0valr1::R`](R) reader structure
impl crate::Readable for DTS_T0VALR1rs {}
///`reset()` method sets DTS_T0VALR1 to value 0
