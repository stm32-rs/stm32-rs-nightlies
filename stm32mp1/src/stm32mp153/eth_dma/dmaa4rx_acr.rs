...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdwc(&mut self) -> RDWC_W<DMAA4RX_ACRrs> {
        RDWC_W::new(self, 0)
    }
    ///Bits 8:11 - RPC
    #[inline(always)]
    #[must_use]
    pub fn rpc(&mut self) -> RPC_W<DMAA4RX_ACRrs> {
        RPC_W::new(self, 8)
    }
    ///Bits 16:19 - RHC
    #[inline(always)]
    #[must_use]
    pub fn rhc(&mut self) -> RHC_W<DMAA4RX_ACRrs> {
        RHC_W::new(self, 16)
    }
    ///Bits 24:25 - RDC
    #[inline(always)]
    #[must_use]
    pub fn rdc(&mut self) -> RDC_W<DMAA4RX_ACRrs> {
        RDC_W::new(self, 24)
    }
}
