...
pub struct R(crate::R<ETH_DMAC0CATXDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_DMAC0CATXDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_DMAC0CATXDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_DMAC0CATXDR_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct ETH_DMAC0CATXDR_SPEC;
impl crate::RegisterSpec for ETH_DMAC0CATXDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eth_dmac0catx_dr::R](R) reader structure"]
impl crate::Readable for ETH_DMAC0CATXDR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ETH_DMAC0CATxDR to value 0"]
impl crate::Resettable for ETH_DMAC0CATXDR_SPEC {
    #[inline(always)]
