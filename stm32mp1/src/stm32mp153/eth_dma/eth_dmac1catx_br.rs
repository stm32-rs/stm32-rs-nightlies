...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETH_DMAC1CATxBR")
...
You can [`read`](crate::Reg::read) this register and get [`eth_dmac1catx_br::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
