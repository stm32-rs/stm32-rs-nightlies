///Register `ETH_DMAC1TxCR` reader
pub type R = crate::R<ETH_DMAC1TX_CRrs>;
///Register `ETH_DMAC1TxCR` writer
...
You can [`read`](crate::Reg::read) this register and get [`eth_dmac1tx_cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_dmac1tx_cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`eth_dmac1tx_cr::R`](R) reader structure
impl crate::Readable for ETH_DMAC1TX_CRrs {}
///`write(|w| ..)` method takes [`eth_dmac1tx_cr::W`](W) writer structure
impl crate::Writable for ETH_DMAC1TX_CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_DMAC1TxCR to value 0
