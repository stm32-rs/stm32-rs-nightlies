///Register `ETH_MACL3A21R` reader
pub type R = crate::R<ETH_MACL3A21Rrs>;
///Register `ETH_MACL3A21R` writer
...
You can [`read`](crate::Reg::read) this register and get [`eth_macl3a21r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_macl3a21r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#ETH_MAC_MMC:ETH_MACL3A21R)*/
pub struct ETH_MACL3A21Rrs;
impl crate::RegisterSpec for ETH_MACL3A21Rrs {
    type Ux = u32;
}
///`read()` method returns [`eth_macl3a21r::R`](R) reader structure
impl crate::Readable for ETH_MACL3A21Rrs {}
///`write(|w| ..)` method takes [`eth_macl3a21r::W`](W) writer structure
impl crate::Writable for ETH_MACL3A21Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_MACL3A21R to value 0
