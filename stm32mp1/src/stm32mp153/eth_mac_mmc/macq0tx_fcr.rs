...
impl W {
    ///Bit 0 - FCB_BPA
    #[inline(always)]
    pub fn fcb_bpa(&mut self) -> FCB_BPA_W<MACQ0TX_FCRrs> {
        FCB_BPA_W::new(self, 0)
    }
    ///Bit 1 - TFE
    #[inline(always)]
    pub fn tfe(&mut self) -> TFE_W<MACQ0TX_FCRrs> {
        TFE_W::new(self, 1)
    }
    ///Bits 4:6 - PLT
    #[inline(always)]
    pub fn plt(&mut self) -> PLT_W<MACQ0TX_FCRrs> {
        PLT_W::new(self, 4)
    }
    ///Bit 7 - DZPQ
    #[inline(always)]
    pub fn dzpq(&mut self) -> DZPQ_W<MACQ0TX_FCRrs> {
        DZPQ_W::new(self, 7)
    }
    ///Bits 16:31 - PT
    #[inline(always)]
    pub fn pt(&mut self) -> PT_W<MACQ0TX_FCRrs> {
        PT_W::new(self, 16)
    }
}
