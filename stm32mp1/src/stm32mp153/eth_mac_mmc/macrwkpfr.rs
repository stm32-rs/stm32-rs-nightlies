...
impl W {
    ///Bit 16 - LPIEN
    #[inline(always)]
    pub fn lpien(&mut self) -> LPIEN_W<'_, MACRWKPFRrs> {
        LPIEN_W::new(self, 16)
    }
    ///Bit 17 - PLS
    #[inline(always)]
    pub fn pls(&mut self) -> PLS_W<'_, MACRWKPFRrs> {
        PLS_W::new(self, 17)
    }
    ///Bit 18 - PLSEN
    #[inline(always)]
    pub fn plsen(&mut self) -> PLSEN_W<'_, MACRWKPFRrs> {
        PLSEN_W::new(self, 18)
    }
    ///Bit 19 - LPITXA
    #[inline(always)]
    pub fn lpitxa(&mut self) -> LPITXA_W<'_, MACRWKPFRrs> {
        LPITXA_W::new(self, 19)
    }
    ///Bit 20 - LPITE
    #[inline(always)]
    pub fn lpite(&mut self) -> LPITE_W<'_, MACRWKPFRrs> {
        LPITE_W::new(self, 20)
    }
}
