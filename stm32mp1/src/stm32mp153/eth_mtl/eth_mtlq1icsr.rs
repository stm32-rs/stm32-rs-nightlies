///Register `ETH_MTLQ1ICSR` reader
pub type R = crate::R<ETH_MTLQ1ICSRrs>;
///Register `ETH_MTLQ1ICSR` writer
pub type W = crate::W<ETH_MTLQ1ICSRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn abpsis(&mut self) -> ABPSIS_W<ETH_MTLQ1ICSRrs> {
        ABPSIS_W::new(self, 1)
    }
    ///Bit 8 - TXUIE
    #[inline(always)]
    #[must_use]
    pub fn txuie(&mut self) -> TXUIE_W<ETH_MTLQ1ICSRrs> {
        TXUIE_W::new(self, 8)
    }
    ///Bit 9 - ABPSIE
    #[inline(always)]
    #[must_use]
    pub fn abpsie(&mut self) -> ABPSIE_W<ETH_MTLQ1ICSRrs> {
        ABPSIE_W::new(self, 9)
    }
    ///Bit 16 - RXOVFIS
    #[inline(always)]
    #[must_use]
    pub fn rxovfis(&mut self) -> RXOVFIS_W<ETH_MTLQ1ICSRrs> {
        RXOVFIS_W::new(self, 16)
    }
    ///Bit 24 - RXOIE
    #[inline(always)]
    #[must_use]
    pub fn rxoie(&mut self) -> RXOIE_W<ETH_MTLQ1ICSRrs> {
        RXOIE_W::new(self, 24)
    }
}
/**Queue 1 interrupt control status Register

You can [`read`](crate::Reg::read) this register and get [`eth_mtlq1icsr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_mtlq1icsr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#ETH_MTL:ETH_MTLQ1ICSR)*/
pub struct ETH_MTLQ1ICSRrs;
impl crate::RegisterSpec for ETH_MTLQ1ICSRrs {
    type Ux = u32;
}
///`read()` method returns [`eth_mtlq1icsr::R`](R) reader structure
impl crate::Readable for ETH_MTLQ1ICSRrs {}
///`write(|w| ..)` method takes [`eth_mtlq1icsr::W`](W) writer structure
impl crate::Writable for ETH_MTLQ1ICSRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_MTLQ1ICSR to value 0
impl crate::Resettable for ETH_MTLQ1ICSRrs {
