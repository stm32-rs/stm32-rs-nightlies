...
pub type R = crate::R<ETH_MTLRX_Q0OMRrs>;
///Register `ETH_MTLRxQ0OMR` writer
pub type W = crate::W<ETH_MTLRX_Q0OMRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtc(&mut self) -> RTC_W<ETH_MTLRX_Q0OMRrs> {
        RTC_W::new(self, 0)
    }
    ///Bit 3 - FUP
    #[inline(always)]
    #[must_use]
    pub fn fup(&mut self) -> FUP_W<ETH_MTLRX_Q0OMRrs> {
        FUP_W::new(self, 3)
    }
    ///Bit 4 - FEP
    #[inline(always)]
    #[must_use]
    pub fn fep(&mut self) -> FEP_W<ETH_MTLRX_Q0OMRrs> {
        FEP_W::new(self, 4)
    }
    ///Bit 5 - RSF
    #[inline(always)]
    #[must_use]
    pub fn rsf(&mut self) -> RSF_W<ETH_MTLRX_Q0OMRrs> {
        RSF_W::new(self, 5)
    }
    ///Bit 6 - DIS_TCP_EF
    #[inline(always)]
    #[must_use]
    pub fn dis_tcp_ef(&mut self) -> DIS_TCP_EF_W<ETH_MTLRX_Q0OMRrs> {
        DIS_TCP_EF_W::new(self, 6)
    }
    ///Bit 7 - EHFC
    #[inline(always)]
    #[must_use]
    pub fn ehfc(&mut self) -> EHFC_W<ETH_MTLRX_Q0OMRrs> {
        EHFC_W::new(self, 7)
    }
    ///Bits 8:10 - RFA
    #[inline(always)]
    #[must_use]
    pub fn rfa(&mut self) -> RFA_W<ETH_MTLRX_Q0OMRrs> {
        RFA_W::new(self, 8)
    }
    ///Bits 14:16 - RFD
    #[inline(always)]
    #[must_use]
    pub fn rfd(&mut self) -> RFD_W<ETH_MTLRX_Q0OMRrs> {
        RFD_W::new(self, 14)
    }
}
/**Rx queue 0 operating mode register

You can [`read`](crate::Reg::read) this register and get [`eth_mtlrx_q0omr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_mtlrx_q0omr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#ETH_MTL:ETH_MTLRxQ0OMR)*/
pub struct ETH_MTLRX_Q0OMRrs;
impl crate::RegisterSpec for ETH_MTLRX_Q0OMRrs {
    type Ux = u32;
}
///`read()` method returns [`eth_mtlrx_q0omr::R`](R) reader structure
impl crate::Readable for ETH_MTLRX_Q0OMRrs {}
///`write(|w| ..)` method takes [`eth_mtlrx_q0omr::W`](W) writer structure
impl crate::Writable for ETH_MTLRX_Q0OMRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_MTLRxQ0OMR to value 0x0070_0000
impl crate::Resettable for ETH_MTLRX_Q0OMRrs {
