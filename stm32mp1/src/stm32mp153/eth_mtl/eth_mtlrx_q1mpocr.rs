...
pub struct R(crate::R<ETH_MTLRXQ1MPOCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_MTLRXQ1MPOCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_MTLRXQ1MPOCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_MTLRXQ1MPOCR_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct ETH_MTLRXQ1MPOCR_SPEC;
impl crate::RegisterSpec for ETH_MTLRXQ1MPOCR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eth_mtlrx_q1mpocr::R](R) reader structure"]
impl crate::Readable for ETH_MTLRXQ1MPOCR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ETH_MTLRxQ1MPOCR to value 0"]
impl crate::Resettable for ETH_MTLRXQ1MPOCR_SPEC {
    #[inline(always)]
