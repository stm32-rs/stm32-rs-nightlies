///Register `ETH_MTLRxQ1OMR` reader
pub type R = crate::R<ETH_MTLRX_Q1OMRrs>;
///Register `ETH_MTLRxQ1OMR` writer
...
You can [`read`](crate::Reg::read) this register and get [`eth_mtlrx_q1omr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_mtlrx_q1omr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`eth_mtlrx_q1omr::R`](R) reader structure
impl crate::Readable for ETH_MTLRX_Q1OMRrs {}
///`write(|w| ..)` method takes [`eth_mtlrx_q1omr::W`](W) writer structure
impl crate::Writable for ETH_MTLRX_Q1OMRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_MTLRxQ1OMR to value 0x0070_0000
