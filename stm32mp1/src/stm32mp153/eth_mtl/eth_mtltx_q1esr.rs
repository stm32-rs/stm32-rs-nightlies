...
pub struct R(crate::R<ETH_MTLTXQ1ESR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_MTLTXQ1ESR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_MTLTXQ1ESR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_MTLTXQ1ESR_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct ETH_MTLTXQ1ESR_SPEC;
impl crate::RegisterSpec for ETH_MTLTXQ1ESR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eth_mtltx_q1esr::R](R) reader structure"]
impl crate::Readable for ETH_MTLTXQ1ESR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ETH_MTLTxQ1ESR to value 0"]
impl crate::Resettable for ETH_MTLTXQ1ESR_SPEC {
    #[inline(always)]
