...
pub type R = crate::R<MTLRX_Q1OMRrs>;
///Register `MTLRxQ1OMR` writer
pub type W = crate::W<MTLRX_Q1OMRrs>;
...
impl W {
    ///Bits 0:1 - RTC
    #[inline(always)]
    pub fn rtc(&mut self) -> RTC_W<'_, MTLRX_Q1OMRrs> {
        RTC_W::new(self, 0)
    }
    ///Bit 3 - FUP
    #[inline(always)]
    pub fn fup(&mut self) -> FUP_W<'_, MTLRX_Q1OMRrs> {
        FUP_W::new(self, 3)
    }
    ///Bit 4 - FEP
    #[inline(always)]
    pub fn fep(&mut self) -> FEP_W<'_, MTLRX_Q1OMRrs> {
        FEP_W::new(self, 4)
    }
    ///Bit 5 - RSF
    #[inline(always)]
    pub fn rsf(&mut self) -> RSF_W<'_, MTLRX_Q1OMRrs> {
        RSF_W::new(self, 5)
    }
    ///Bit 6 - DIS_TCP_EF
    #[inline(always)]
    pub fn dis_tcp_ef(&mut self) -> DIS_TCP_EF_W<'_, MTLRX_Q1OMRrs> {
        DIS_TCP_EF_W::new(self, 6)
    }
    ///Bit 7 - EHFC
    #[inline(always)]
    pub fn ehfc(&mut self) -> EHFC_W<'_, MTLRX_Q1OMRrs> {
        EHFC_W::new(self, 7)
    }
    ///Bits 8:10 - RFA
    #[inline(always)]
    pub fn rfa(&mut self) -> RFA_W<'_, MTLRX_Q1OMRrs> {
        RFA_W::new(self, 8)
    }
    ///Bits 14:16 - RFD
    #[inline(always)]
    pub fn rfd(&mut self) -> RFD_W<'_, MTLRX_Q1OMRrs> {
        RFD_W::new(self, 14)
    }
}
/**Rx queue 1 operating mode register

You can [`read`](crate::Reg::read) this register and get [`mtlrx_q1omr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mtlrx_q1omr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#ETH_MTL:MTLRxQ1OMR)*/
pub struct MTLRX_Q1OMRrs;
impl crate::RegisterSpec for MTLRX_Q1OMRrs {
    type Ux = u32;
}
///`read()` method returns [`mtlrx_q1omr::R`](R) reader structure
impl crate::Readable for MTLRX_Q1OMRrs {}
///`write(|w| ..)` method takes [`mtlrx_q1omr::W`](W) writer structure
impl crate::Writable for MTLRX_Q1OMRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MTLRxQ1OMR to value 0x0070_0000
impl crate::Resettable for MTLRX_Q1OMRrs {
