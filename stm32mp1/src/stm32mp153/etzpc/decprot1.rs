...
impl W {
    ///Bits 0:1 - DECPROT0
    #[inline(always)]
    pub fn decprot0(&mut self) -> DECPROT0_W<DECPROT1rs> {
        DECPROT0_W::new(self, 0)
    }
    ///Bits 2:3 - DECPROT1
    #[inline(always)]
    pub fn decprot1(&mut self) -> DECPROT1_W<DECPROT1rs> {
        DECPROT1_W::new(self, 2)
    }
    ///Bits 4:5 - DECPROT2
    #[inline(always)]
    pub fn decprot2(&mut self) -> DECPROT2_W<DECPROT1rs> {
        DECPROT2_W::new(self, 4)
    }
    ///Bits 6:7 - DECPROT3
    #[inline(always)]
    pub fn decprot3(&mut self) -> DECPROT3_W<DECPROT1rs> {
        DECPROT3_W::new(self, 6)
    }
    ///Bits 8:9 - DECPROT4
    #[inline(always)]
    pub fn decprot4(&mut self) -> DECPROT4_W<DECPROT1rs> {
        DECPROT4_W::new(self, 8)
    }
    ///Bits 10:11 - DECPROT5
    #[inline(always)]
    pub fn decprot5(&mut self) -> DECPROT5_W<DECPROT1rs> {
        DECPROT5_W::new(self, 10)
    }
    ///Bits 12:13 - DECPROT6
    #[inline(always)]
    pub fn decprot6(&mut self) -> DECPROT6_W<DECPROT1rs> {
        DECPROT6_W::new(self, 12)
    }
    ///Bits 14:15 - DECPROT7
    #[inline(always)]
    pub fn decprot7(&mut self) -> DECPROT7_W<DECPROT1rs> {
        DECPROT7_W::new(self, 14)
    }
    ///Bits 16:17 - DECPROT8
    #[inline(always)]
    pub fn decprot8(&mut self) -> DECPROT8_W<DECPROT1rs> {
        DECPROT8_W::new(self, 16)
    }
    ///Bits 18:19 - DECPROT9
    #[inline(always)]
    pub fn decprot9(&mut self) -> DECPROT9_W<DECPROT1rs> {
        DECPROT9_W::new(self, 18)
    }
    ///Bits 20:21 - DECPROT10
    #[inline(always)]
    pub fn decprot10(&mut self) -> DECPROT10_W<DECPROT1rs> {
        DECPROT10_W::new(self, 20)
    }
    ///Bits 22:23 - DECPROT11
    #[inline(always)]
    pub fn decprot11(&mut self) -> DECPROT11_W<DECPROT1rs> {
        DECPROT11_W::new(self, 22)
    }
    ///Bits 24:25 - DECPROT12
    #[inline(always)]
    pub fn decprot12(&mut self) -> DECPROT12_W<DECPROT1rs> {
        DECPROT12_W::new(self, 24)
    }
    ///Bits 26:27 - DECPROT13
    #[inline(always)]
    pub fn decprot13(&mut self) -> DECPROT13_W<DECPROT1rs> {
        DECPROT13_W::new(self, 26)
    }
    ///Bits 28:29 - DECPROT14
    #[inline(always)]
    pub fn decprot14(&mut self) -> DECPROT14_W<DECPROT1rs> {
        DECPROT14_W::new(self, 28)
    }
    ///Bits 30:31 - DECPROT15
    #[inline(always)]
    pub fn decprot15(&mut self) -> DECPROT15_W<DECPROT1rs> {
