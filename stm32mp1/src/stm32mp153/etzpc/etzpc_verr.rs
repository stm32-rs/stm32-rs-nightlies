...
You can [`read`](crate::Reg::read) this register and get [`etzpc_verr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#ETZPC:ETZPC_VERR)*/
pub struct ETZPC_VERRrs;
impl crate::RegisterSpec for ETZPC_VERRrs {
    type Ux = u32;
}
///`read()` method returns [`etzpc_verr::R`](R) reader structure
impl crate::Readable for ETZPC_VERRrs {}
///`reset()` method sets ETZPC_VERR to value 0x20
