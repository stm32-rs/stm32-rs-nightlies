///Register `EXTI_C2EMR1` reader
pub type R = crate::R<EXTI_C2EMR1rs>;
///Register `EXTI_C2EMR1` writer
pub type W = crate::W<EXTI_C2EMR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn em0(&mut self) -> EM0_W<EXTI_C2EMR1rs> {
        EM0_W::new(self, 0)
    }
    ///Bit 1 - EM1
    #[inline(always)]
    #[must_use]
    pub fn em1(&mut self) -> EM1_W<EXTI_C2EMR1rs> {
        EM1_W::new(self, 1)
    }
    ///Bit 2 - EM2
    #[inline(always)]
    #[must_use]
    pub fn em2(&mut self) -> EM2_W<EXTI_C2EMR1rs> {
        EM2_W::new(self, 2)
    }
    ///Bit 3 - EM3
    #[inline(always)]
    #[must_use]
    pub fn em3(&mut self) -> EM3_W<EXTI_C2EMR1rs> {
        EM3_W::new(self, 3)
    }
    ///Bit 4 - EM4
    #[inline(always)]
    #[must_use]
    pub fn em4(&mut self) -> EM4_W<EXTI_C2EMR1rs> {
        EM4_W::new(self, 4)
    }
    ///Bit 5 - EM5
    #[inline(always)]
    #[must_use]
    pub fn em5(&mut self) -> EM5_W<EXTI_C2EMR1rs> {
        EM5_W::new(self, 5)
    }
    ///Bit 6 - EM6
    #[inline(always)]
    #[must_use]
    pub fn em6(&mut self) -> EM6_W<EXTI_C2EMR1rs> {
        EM6_W::new(self, 6)
    }
    ///Bit 7 - EM7
    #[inline(always)]
    #[must_use]
    pub fn em7(&mut self) -> EM7_W<EXTI_C2EMR1rs> {
        EM7_W::new(self, 7)
    }
    ///Bit 8 - EM8
    #[inline(always)]
    #[must_use]
    pub fn em8(&mut self) -> EM8_W<EXTI_C2EMR1rs> {
        EM8_W::new(self, 8)
    }
    ///Bit 9 - EM9
    #[inline(always)]
    #[must_use]
    pub fn em9(&mut self) -> EM9_W<EXTI_C2EMR1rs> {
        EM9_W::new(self, 9)
    }
    ///Bit 10 - EM10
    #[inline(always)]
    #[must_use]
    pub fn em10(&mut self) -> EM10_W<EXTI_C2EMR1rs> {
        EM10_W::new(self, 10)
    }
    ///Bit 11 - EM11
    #[inline(always)]
    #[must_use]
    pub fn em11(&mut self) -> EM11_W<EXTI_C2EMR1rs> {
        EM11_W::new(self, 11)
    }
    ///Bit 12 - EM12
    #[inline(always)]
    #[must_use]
    pub fn em12(&mut self) -> EM12_W<EXTI_C2EMR1rs> {
        EM12_W::new(self, 12)
    }
    ///Bit 13 - EM13
    #[inline(always)]
    #[must_use]
    pub fn em13(&mut self) -> EM13_W<EXTI_C2EMR1rs> {
        EM13_W::new(self, 13)
    }
    ///Bit 14 - EM14
    #[inline(always)]
    #[must_use]
    pub fn em14(&mut self) -> EM14_W<EXTI_C2EMR1rs> {
        EM14_W::new(self, 14)
    }
    ///Bit 15 - EM15
    #[inline(always)]
    #[must_use]
    pub fn em15(&mut self) -> EM15_W<EXTI_C2EMR1rs> {
        EM15_W::new(self, 15)
    }
    ///Bit 17 - EM17
    #[inline(always)]
    #[must_use]
    pub fn em17(&mut self) -> EM17_W<EXTI_C2EMR1rs> {
        EM17_W::new(self, 17)
    }
    ///Bit 18 - EM18
    #[inline(always)]
    #[must_use]
    pub fn em18(&mut self) -> EM18_W<EXTI_C2EMR1rs> {
        EM18_W::new(self, 18)
    }
    ///Bit 19 - EM19
    #[inline(always)]
    #[must_use]
    pub fn em19(&mut self) -> EM19_W<EXTI_C2EMR1rs> {
        EM19_W::new(self, 19)
    }
}
/**EXTI CPU2 wakeup with event mask register

You can [`read`](crate::Reg::read) this register and get [`exti_c2emr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`exti_c2emr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#EXTI:EXTI_C2EMR1)*/
pub struct EXTI_C2EMR1rs;
impl crate::RegisterSpec for EXTI_C2EMR1rs {
    type Ux = u32;
}
///`read()` method returns [`exti_c2emr1::R`](R) reader structure
impl crate::Readable for EXTI_C2EMR1rs {}
///`write(|w| ..)` method takes [`exti_c2emr1::W`](W) writer structure
impl crate::Writable for EXTI_C2EMR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EXTI_C2EMR1 to value 0
impl crate::Resettable for EXTI_C2EMR1rs {
