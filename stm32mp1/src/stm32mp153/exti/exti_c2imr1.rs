...
pub type R = crate::R<EXTI_C2IMR1rs>;
///Register `EXTI_C2IMR1` writer
pub type W = crate::W<EXTI_C2IMR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn im0(&mut self) -> IM0_W<EXTI_C2IMR1rs> {
        IM0_W::new(self, 0)
    }
    ///Bit 1 - IM1
    #[inline(always)]
    #[must_use]
    pub fn im1(&mut self) -> IM1_W<EXTI_C2IMR1rs> {
        IM1_W::new(self, 1)
    }
    ///Bit 2 - IM2
    #[inline(always)]
    #[must_use]
    pub fn im2(&mut self) -> IM2_W<EXTI_C2IMR1rs> {
        IM2_W::new(self, 2)
    }
    ///Bit 3 - IM3
    #[inline(always)]
    #[must_use]
    pub fn im3(&mut self) -> IM3_W<EXTI_C2IMR1rs> {
        IM3_W::new(self, 3)
    }
    ///Bit 4 - IM4
    #[inline(always)]
    #[must_use]
    pub fn im4(&mut self) -> IM4_W<EXTI_C2IMR1rs> {
        IM4_W::new(self, 4)
    }
    ///Bit 5 - IM5
    #[inline(always)]
    #[must_use]
    pub fn im5(&mut self) -> IM5_W<EXTI_C2IMR1rs> {
        IM5_W::new(self, 5)
    }
    ///Bit 6 - IM6
    #[inline(always)]
    #[must_use]
    pub fn im6(&mut self) -> IM6_W<EXTI_C2IMR1rs> {
        IM6_W::new(self, 6)
    }
    ///Bit 7 - IM7
    #[inline(always)]
    #[must_use]
    pub fn im7(&mut self) -> IM7_W<EXTI_C2IMR1rs> {
        IM7_W::new(self, 7)
    }
    ///Bit 8 - IM8
    #[inline(always)]
    #[must_use]
    pub fn im8(&mut self) -> IM8_W<EXTI_C2IMR1rs> {
        IM8_W::new(self, 8)
    }
    ///Bit 9 - IM9
    #[inline(always)]
    #[must_use]
    pub fn im9(&mut self) -> IM9_W<EXTI_C2IMR1rs> {
        IM9_W::new(self, 9)
    }
    ///Bit 10 - IM10
    #[inline(always)]
    #[must_use]
    pub fn im10(&mut self) -> IM10_W<EXTI_C2IMR1rs> {
        IM10_W::new(self, 10)
    }
    ///Bit 11 - IM11
    #[inline(always)]
    #[must_use]
    pub fn im11(&mut self) -> IM11_W<EXTI_C2IMR1rs> {
        IM11_W::new(self, 11)
    }
    ///Bit 12 - IM12
    #[inline(always)]
    #[must_use]
    pub fn im12(&mut self) -> IM12_W<EXTI_C2IMR1rs> {
        IM12_W::new(self, 12)
    }
    ///Bit 13 - IM13
    #[inline(always)]
    #[must_use]
    pub fn im13(&mut self) -> IM13_W<EXTI_C2IMR1rs> {
        IM13_W::new(self, 13)
    }
    ///Bit 14 - IM14
    #[inline(always)]
    #[must_use]
    pub fn im14(&mut self) -> IM14_W<EXTI_C2IMR1rs> {
        IM14_W::new(self, 14)
    }
    ///Bit 15 - IM15
    #[inline(always)]
    #[must_use]
    pub fn im15(&mut self) -> IM15_W<EXTI_C2IMR1rs> {
        IM15_W::new(self, 15)
    }
    ///Bit 16 - IM16
    #[inline(always)]
    #[must_use]
    pub fn im16(&mut self) -> IM16_W<EXTI_C2IMR1rs> {
        IM16_W::new(self, 16)
    }
    ///Bit 17 - IM17
    #[inline(always)]
    #[must_use]
    pub fn im17(&mut self) -> IM17_W<EXTI_C2IMR1rs> {
        IM17_W::new(self, 17)
    }
    ///Bit 18 - IM18
    #[inline(always)]
    #[must_use]
    pub fn im18(&mut self) -> IM18_W<EXTI_C2IMR1rs> {
        IM18_W::new(self, 18)
    }
    ///Bit 19 - IM19
    #[inline(always)]
    #[must_use]
    pub fn im19(&mut self) -> IM19_W<EXTI_C2IMR1rs> {
        IM19_W::new(self, 19)
    }
    ///Bit 20 - IM20
    #[inline(always)]
    #[must_use]
    pub fn im20(&mut self) -> IM20_W<EXTI_C2IMR1rs> {
        IM20_W::new(self, 20)
    }
    ///Bit 21 - IM21
    #[inline(always)]
    #[must_use]
    pub fn im21(&mut self) -> IM21_W<EXTI_C2IMR1rs> {
        IM21_W::new(self, 21)
    }
    ///Bit 22 - IM22
    #[inline(always)]
    #[must_use]
    pub fn im22(&mut self) -> IM22_W<EXTI_C2IMR1rs> {
        IM22_W::new(self, 22)
    }
    ///Bit 23 - IM23
    #[inline(always)]
    #[must_use]
    pub fn im23(&mut self) -> IM23_W<EXTI_C2IMR1rs> {
        IM23_W::new(self, 23)
    }
    ///Bit 24 - IM24
    #[inline(always)]
    #[must_use]
    pub fn im24(&mut self) -> IM24_W<EXTI_C2IMR1rs> {
        IM24_W::new(self, 24)
    }
    ///Bit 25 - IM25
    #[inline(always)]
    #[must_use]
    pub fn im25(&mut self) -> IM25_W<EXTI_C2IMR1rs> {
        IM25_W::new(self, 25)
    }
    ///Bit 26 - IM26
    #[inline(always)]
    #[must_use]
    pub fn im26(&mut self) -> IM26_W<EXTI_C2IMR1rs> {
        IM26_W::new(self, 26)
    }
    ///Bit 27 - IM27
    #[inline(always)]
    #[must_use]
    pub fn im27(&mut self) -> IM27_W<EXTI_C2IMR1rs> {
        IM27_W::new(self, 27)
    }
    ///Bit 28 - IM28
    #[inline(always)]
    #[must_use]
    pub fn im28(&mut self) -> IM28_W<EXTI_C2IMR1rs> {
        IM28_W::new(self, 28)
    }
    ///Bit 29 - IM29
    #[inline(always)]
    #[must_use]
    pub fn im29(&mut self) -> IM29_W<EXTI_C2IMR1rs> {
        IM29_W::new(self, 29)
    }
    ///Bit 30 - IM30
    #[inline(always)]
    #[must_use]
    pub fn im30(&mut self) -> IM30_W<EXTI_C2IMR1rs> {
        IM30_W::new(self, 30)
    }
    ///Bit 31 - IM31
    #[inline(always)]
    #[must_use]
    pub fn im31(&mut self) -> IM31_W<EXTI_C2IMR1rs> {
        IM31_W::new(self, 31)
    }
}
/**Contains register bits for configurable events and Direct events.

You can [`read`](crate::Reg::read) this register and get [`exti_c2imr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`exti_c2imr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#EXTI:EXTI_C2IMR1)*/
pub struct EXTI_C2IMR1rs;
impl crate::RegisterSpec for EXTI_C2IMR1rs {
    type Ux = u32;
}
///`read()` method returns [`exti_c2imr1::R`](R) reader structure
impl crate::Readable for EXTI_C2IMR1rs {}
///`write(|w| ..)` method takes [`exti_c2imr1::W`](W) writer structure
impl crate::Writable for EXTI_C2IMR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EXTI_C2IMR1 to value 0xfffe_0000
impl crate::Resettable for EXTI_C2IMR1rs {
