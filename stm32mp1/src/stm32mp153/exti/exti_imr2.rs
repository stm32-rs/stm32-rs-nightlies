...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn im38(&mut self) -> IM38_W<EXTI_IMR2rs> {
        IM38_W::new(self, 6)
    }
    ///Bit 7 - IM39
    #[inline(always)]
    #[must_use]
    pub fn im39(&mut self) -> IM39_W<EXTI_IMR2rs> {
        IM39_W::new(self, 7)
    }
    ///Bit 8 - IM40
    #[inline(always)]
    #[must_use]
    pub fn im40(&mut self) -> IM40_W<EXTI_IMR2rs> {
        IM40_W::new(self, 8)
    }
    ///Bit 9 - IM41
    #[inline(always)]
    #[must_use]
    pub fn im41(&mut self) -> IM41_W<EXTI_IMR2rs> {
        IM41_W::new(self, 9)
    }
    ///Bit 10 - IM42
    #[inline(always)]
    #[must_use]
    pub fn im42(&mut self) -> IM42_W<EXTI_IMR2rs> {
        IM42_W::new(self, 10)
    }
    ///Bit 11 - IM43
    #[inline(always)]
    #[must_use]
    pub fn im43(&mut self) -> IM43_W<EXTI_IMR2rs> {
        IM43_W::new(self, 11)
    }
    ///Bit 12 - IM44
    #[inline(always)]
    #[must_use]
    pub fn im44(&mut self) -> IM44_W<EXTI_IMR2rs> {
        IM44_W::new(self, 12)
    }
    ///Bit 13 - IM45
    #[inline(always)]
    #[must_use]
    pub fn im45(&mut self) -> IM45_W<EXTI_IMR2rs> {
        IM45_W::new(self, 13)
    }
    ///Bit 14 - IM46
    #[inline(always)]
    #[must_use]
    pub fn im46(&mut self) -> IM46_W<EXTI_IMR2rs> {
        IM46_W::new(self, 14)
    }
    ///Bit 15 - IM47
    #[inline(always)]
    #[must_use]
    pub fn im47(&mut self) -> IM47_W<EXTI_IMR2rs> {
        IM47_W::new(self, 15)
    }
    ///Bit 16 - IM48
    #[inline(always)]
    #[must_use]
    pub fn im48(&mut self) -> IM48_W<EXTI_IMR2rs> {
        IM48_W::new(self, 16)
    }
    ///Bit 17 - IM49
    #[inline(always)]
    #[must_use]
    pub fn im49(&mut self) -> IM49_W<EXTI_IMR2rs> {
        IM49_W::new(self, 17)
    }
    ///Bit 18 - IM50
    #[inline(always)]
    #[must_use]
    pub fn im50(&mut self) -> IM50_W<EXTI_IMR2rs> {
        IM50_W::new(self, 18)
    }
    ///Bit 19 - IM51
    #[inline(always)]
    #[must_use]
    pub fn im51(&mut self) -> IM51_W<EXTI_IMR2rs> {
        IM51_W::new(self, 19)
    }
    ///Bit 20 - IM52
    #[inline(always)]
    #[must_use]
    pub fn im52(&mut self) -> IM52_W<EXTI_IMR2rs> {
        IM52_W::new(self, 20)
    }
    ///Bit 21 - IM53
    #[inline(always)]
    #[must_use]
    pub fn im53(&mut self) -> IM53_W<EXTI_IMR2rs> {
        IM53_W::new(self, 21)
    }
    ///Bit 22 - IM54
    #[inline(always)]
    #[must_use]
    pub fn im54(&mut self) -> IM54_W<EXTI_IMR2rs> {
        IM54_W::new(self, 22)
    }
    ///Bit 23 - IM55
    #[inline(always)]
    #[must_use]
    pub fn im55(&mut self) -> IM55_W<EXTI_IMR2rs> {
        IM55_W::new(self, 23)
    }
    ///Bit 24 - IM56
    #[inline(always)]
    #[must_use]
    pub fn im56(&mut self) -> IM56_W<EXTI_IMR2rs> {
        IM56_W::new(self, 24)
    }
    ///Bit 25 - IM57
    #[inline(always)]
    #[must_use]
    pub fn im57(&mut self) -> IM57_W<EXTI_IMR2rs> {
        IM57_W::new(self, 25)
    }
    ///Bit 26 - IM58
    #[inline(always)]
    #[must_use]
    pub fn im58(&mut self) -> IM58_W<EXTI_IMR2rs> {
        IM58_W::new(self, 26)
    }
    ///Bit 27 - IM59
    #[inline(always)]
    #[must_use]
    pub fn im59(&mut self) -> IM59_W<EXTI_IMR2rs> {
        IM59_W::new(self, 27)
    }
    ///Bit 28 - IM60
    #[inline(always)]
    #[must_use]
    pub fn im60(&mut self) -> IM60_W<EXTI_IMR2rs> {
        IM60_W::new(self, 28)
    }
    ///Bit 29 - IM61
    #[inline(always)]
    #[must_use]
    pub fn im61(&mut self) -> IM61_W<EXTI_IMR2rs> {
        IM61_W::new(self, 29)
    }
    ///Bit 30 - IM62
    #[inline(always)]
    #[must_use]
    pub fn im62(&mut self) -> IM62_W<EXTI_IMR2rs> {
        IM62_W::new(self, 30)
    }
    ///Bit 31 - IM63
    #[inline(always)]
    #[must_use]
    pub fn im63(&mut self) -> IM63_W<EXTI_IMR2rs> {
        IM63_W::new(self, 31)
    }
}
