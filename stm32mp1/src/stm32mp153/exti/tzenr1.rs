...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzen0(&mut self) -> TZEN0_W<TZENR1rs> {
        TZEN0_W::new(self, 0)
    }
    ///Bit 1 - TZEN1
    #[inline(always)]
    #[must_use]
    pub fn tzen1(&mut self) -> TZEN1_W<TZENR1rs> {
        TZEN1_W::new(self, 1)
    }
    ///Bit 2 - TZEN2
    #[inline(always)]
    #[must_use]
    pub fn tzen2(&mut self) -> TZEN2_W<TZENR1rs> {
        TZEN2_W::new(self, 2)
    }
    ///Bit 3 - TZEN3
    #[inline(always)]
    #[must_use]
    pub fn tzen3(&mut self) -> TZEN3_W<TZENR1rs> {
        TZEN3_W::new(self, 3)
    }
    ///Bit 4 - TZEN4
    #[inline(always)]
    #[must_use]
    pub fn tzen4(&mut self) -> TZEN4_W<TZENR1rs> {
        TZEN4_W::new(self, 4)
    }
    ///Bit 5 - TZEN5
    #[inline(always)]
    #[must_use]
    pub fn tzen5(&mut self) -> TZEN5_W<TZENR1rs> {
        TZEN5_W::new(self, 5)
    }
    ///Bit 6 - TZEN6
    #[inline(always)]
    #[must_use]
    pub fn tzen6(&mut self) -> TZEN6_W<TZENR1rs> {
        TZEN6_W::new(self, 6)
    }
    ///Bit 7 - TZEN7
    #[inline(always)]
    #[must_use]
    pub fn tzen7(&mut self) -> TZEN7_W<TZENR1rs> {
        TZEN7_W::new(self, 7)
    }
    ///Bit 8 - TZEN8
    #[inline(always)]
    #[must_use]
    pub fn tzen8(&mut self) -> TZEN8_W<TZENR1rs> {
        TZEN8_W::new(self, 8)
    }
    ///Bit 9 - TZEN9
    #[inline(always)]
    #[must_use]
    pub fn tzen9(&mut self) -> TZEN9_W<TZENR1rs> {
        TZEN9_W::new(self, 9)
    }
    ///Bit 10 - TZEN10
    #[inline(always)]
    #[must_use]
    pub fn tzen10(&mut self) -> TZEN10_W<TZENR1rs> {
        TZEN10_W::new(self, 10)
    }
    ///Bit 11 - TZEN11
    #[inline(always)]
    #[must_use]
    pub fn tzen11(&mut self) -> TZEN11_W<TZENR1rs> {
        TZEN11_W::new(self, 11)
    }
    ///Bit 12 - TZEN12
    #[inline(always)]
    #[must_use]
    pub fn tzen12(&mut self) -> TZEN12_W<TZENR1rs> {
        TZEN12_W::new(self, 12)
    }
    ///Bit 13 - TZEN13
    #[inline(always)]
    #[must_use]
    pub fn tzen13(&mut self) -> TZEN13_W<TZENR1rs> {
        TZEN13_W::new(self, 13)
    }
    ///Bit 14 - TZEN14
    #[inline(always)]
    #[must_use]
    pub fn tzen14(&mut self) -> TZEN14_W<TZENR1rs> {
        TZEN14_W::new(self, 14)
    }
    ///Bit 15 - TZEN15
    #[inline(always)]
    #[must_use]
    pub fn tzen15(&mut self) -> TZEN15_W<TZENR1rs> {
        TZEN15_W::new(self, 15)
    }
    ///Bit 17 - TZEN17
    #[inline(always)]
    #[must_use]
    pub fn tzen17(&mut self) -> TZEN17_W<TZENR1rs> {
        TZEN17_W::new(self, 17)
    }
    ///Bit 18 - TZEN18
    #[inline(always)]
    #[must_use]
    pub fn tzen18(&mut self) -> TZEN18_W<TZENR1rs> {
        TZEN18_W::new(self, 18)
    }
    ///Bit 19 - TZEN19
    #[inline(always)]
    #[must_use]
    pub fn tzen19(&mut self) -> TZEN19_W<TZENR1rs> {
        TZEN19_W::new(self, 19)
    }
    ///Bit 24 - TZEN24
    #[inline(always)]
    #[must_use]
    pub fn tzen24(&mut self) -> TZEN24_W<TZENR1rs> {
        TZEN24_W::new(self, 24)
    }
    ///Bit 26 - TZEN26
    #[inline(always)]
    #[must_use]
    pub fn tzen26(&mut self) -> TZEN26_W<TZENR1rs> {
