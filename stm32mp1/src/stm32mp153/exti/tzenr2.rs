...
impl W {
    ///Bit 9 - TZEN41
    #[inline(always)]
    pub fn tzen41(&mut self) -> TZEN41_W<TZENR2rs> {
        TZEN41_W::new(self, 9)
    }
    ///Bit 22 - TZEN54
    #[inline(always)]
    pub fn tzen54(&mut self) -> TZEN54_W<TZENR2rs> {
        TZEN54_W::new(self, 22)
    }
    ///Bit 23 - TZEN55
    #[inline(always)]
    pub fn tzen55(&mut self) -> TZEN55_W<TZENR2rs> {
        TZEN55_W::new(self, 23)
    }
    ///Bit 24 - TZEN56
    #[inline(always)]
    pub fn tzen56(&mut self) -> TZEN56_W<TZENR2rs> {
        TZEN56_W::new(self, 24)
    }
    ///Bit 25 - TZEN57
    #[inline(always)]
    pub fn tzen57(&mut self) -> TZEN57_W<TZENR2rs> {
        TZEN57_W::new(self, 25)
    }
    ///Bit 26 - TZEN58
    #[inline(always)]
    pub fn tzen58(&mut self) -> TZEN58_W<TZENR2rs> {
        TZEN58_W::new(self, 26)
    }
    ///Bit 27 - TZEN59
    #[inline(always)]
    pub fn tzen59(&mut self) -> TZEN59_W<TZENR2rs> {
        TZEN59_W::new(self, 27)
    }
    ///Bit 28 - TZEN60
    #[inline(always)]
    pub fn tzen60(&mut self) -> TZEN60_W<TZENR2rs> {
