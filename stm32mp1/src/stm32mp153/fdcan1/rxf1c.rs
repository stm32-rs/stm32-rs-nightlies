...
impl W {
    ///Bits 2:15 - F1SA
    #[inline(always)]
    pub fn f1sa(&mut self) -> F1SA_W<RXF1Crs> {
        F1SA_W::new(self, 2)
    }
    ///Bits 16:22 - F1S
    #[inline(always)]
    pub fn f1s(&mut self) -> F1S_W<RXF1Crs> {
        F1S_W::new(self, 16)
    }
    ///Bits 24:30 - F1WM
    #[inline(always)]
    pub fn f1wm(&mut self) -> F1WM_W<RXF1Crs> {
        F1WM_W::new(self, 24)
    }
    ///Bit 31 - F1OM
    #[inline(always)]
    pub fn f1om(&mut self) -> F1OM_W<RXF1Crs> {
        F1OM_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#FDCAN1:RXF1C)*/
pub struct RXF1Crs;
