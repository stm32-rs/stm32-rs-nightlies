...
impl W {
    ///Bits 8:13 - SNBR
    #[inline(always)]
    pub fn snbr(&mut self) -> SNBR_W<CSQCFGR3rs> {
        SNBR_W::new(self, 8)
    }
    ///Bit 16 - AC1T
    #[inline(always)]
    pub fn ac1t(&mut self) -> AC1T_W<CSQCFGR3rs> {
        AC1T_W::new(self, 16)
    }
    ///Bit 17 - AC2T
    #[inline(always)]
    pub fn ac2t(&mut self) -> AC2T_W<CSQCFGR3rs> {
        AC2T_W::new(self, 17)
    }
    ///Bit 18 - AC3T
    #[inline(always)]
    pub fn ac3t(&mut self) -> AC3T_W<CSQCFGR3rs> {
        AC3T_W::new(self, 18)
    }
    ///Bit 19 - AC4T
    #[inline(always)]
    pub fn ac4t(&mut self) -> AC4T_W<CSQCFGR3rs> {
        AC4T_W::new(self, 19)
    }
    ///Bit 20 - AC5T
    #[inline(always)]
    pub fn ac5t(&mut self) -> AC5T_W<CSQCFGR3rs> {
        AC5T_W::new(self, 20)
    }
    ///Bit 21 - SDT
    #[inline(always)]
    pub fn sdt(&mut self) -> SDT_W<CSQCFGR3rs> {
        SDT_W::new(self, 21)
    }
    ///Bit 22 - RAC1T
    #[inline(always)]
    pub fn rac1t(&mut self) -> RAC1T_W<CSQCFGR3rs> {
        RAC1T_W::new(self, 22)
    }
    ///Bit 23 - RAC2T
    #[inline(always)]
    pub fn rac2t(&mut self) -> RAC2T_W<CSQCFGR3rs> {
        RAC2T_W::new(self, 23)
    }
}
