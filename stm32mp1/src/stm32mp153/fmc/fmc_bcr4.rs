...
pub type R = crate::R<FMC_BCR4rs>;
///Register `FMC_BCR4` writer
pub type W = crate::W<FMC_BCR4rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mbken(&mut self) -> MBKEN_W<FMC_BCR4rs> {
        MBKEN_W::new(self, 0)
    }
    ///Bit 1 - MUXEN
    #[inline(always)]
    #[must_use]
    pub fn muxen(&mut self) -> MUXEN_W<FMC_BCR4rs> {
        MUXEN_W::new(self, 1)
    }
    ///Bits 2:3 - MTYP
    #[inline(always)]
    #[must_use]
    pub fn mtyp(&mut self) -> MTYP_W<FMC_BCR4rs> {
        MTYP_W::new(self, 2)
    }
    ///Bits 4:5 - MWID
    #[inline(always)]
    #[must_use]
    pub fn mwid(&mut self) -> MWID_W<FMC_BCR4rs> {
        MWID_W::new(self, 4)
    }
    ///Bit 6 - FACCEN
    #[inline(always)]
    #[must_use]
    pub fn faccen(&mut self) -> FACCEN_W<FMC_BCR4rs> {
        FACCEN_W::new(self, 6)
    }
    ///Bit 8 - BURSTEN
    #[inline(always)]
    #[must_use]
    pub fn bursten(&mut self) -> BURSTEN_W<FMC_BCR4rs> {
        BURSTEN_W::new(self, 8)
    }
    ///Bit 9 - WAITPOL
    #[inline(always)]
    #[must_use]
    pub fn waitpol(&mut self) -> WAITPOL_W<FMC_BCR4rs> {
        WAITPOL_W::new(self, 9)
    }
    ///Bit 11 - WAITCFG
    #[inline(always)]
    #[must_use]
    pub fn waitcfg(&mut self) -> WAITCFG_W<FMC_BCR4rs> {
        WAITCFG_W::new(self, 11)
    }
    ///Bit 12 - WREN
    #[inline(always)]
    #[must_use]
    pub fn wren(&mut self) -> WREN_W<FMC_BCR4rs> {
        WREN_W::new(self, 12)
    }
    ///Bit 13 - WAITEN
    #[inline(always)]
    #[must_use]
    pub fn waiten(&mut self) -> WAITEN_W<FMC_BCR4rs> {
        WAITEN_W::new(self, 13)
    }
    ///Bit 14 - EXTMOD
    #[inline(always)]
    #[must_use]
    pub fn extmod(&mut self) -> EXTMOD_W<FMC_BCR4rs> {
        EXTMOD_W::new(self, 14)
    }
    ///Bit 15 - ASYNCWAIT
    #[inline(always)]
    #[must_use]
    pub fn asyncwait(&mut self) -> ASYNCWAIT_W<FMC_BCR4rs> {
        ASYNCWAIT_W::new(self, 15)
    }
    ///Bits 16:18 - CPSIZE
    #[inline(always)]
    #[must_use]
    pub fn cpsize(&mut self) -> CPSIZE_W<FMC_BCR4rs> {
        CPSIZE_W::new(self, 16)
    }
    ///Bit 19 - CBURSTRW
    #[inline(always)]
    #[must_use]
    pub fn cburstrw(&mut self) -> CBURSTRW_W<FMC_BCR4rs> {
        CBURSTRW_W::new(self, 19)
    }
    ///Bit 20 - CCLKEN
    #[inline(always)]
    #[must_use]
    pub fn cclken(&mut self) -> CCLKEN_W<FMC_BCR4rs> {
        CCLKEN_W::new(self, 20)
    }
    ///Bits 22:23 - NBLSET
    #[inline(always)]
    #[must_use]
    pub fn nblset(&mut self) -> NBLSET_W<FMC_BCR4rs> {
        NBLSET_W::new(self, 22)
    }
    ///Bit 31 - FMCEN
    #[inline(always)]
    #[must_use]
    pub fn fmcen(&mut self) -> FMCEN_W<FMC_BCR4rs> {
        FMCEN_W::new(self, 31)
    }
}
/**This register contains the control information of each memory bank, used for SRAMs, PSRAM, FRAM and NOR Flash memories.

You can [`read`](crate::Reg::read) this register and get [`fmc_bcr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmc_bcr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#FMC:FMC_BCR4)*/
pub struct FMC_BCR4rs;
impl crate::RegisterSpec for FMC_BCR4rs {
    type Ux = u32;
}
///`read()` method returns [`fmc_bcr4::R`](R) reader structure
impl crate::Readable for FMC_BCR4rs {}
///`write(|w| ..)` method takes [`fmc_bcr4::W`](W) writer structure
impl crate::Writable for FMC_BCR4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FMC_BCR4 to value 0x30db
impl crate::Resettable for FMC_BCR4rs {
