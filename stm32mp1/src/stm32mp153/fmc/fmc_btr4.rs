///Register `FMC_BTR4` reader
pub type R = crate::R<FMC_BTR4rs>;
///Register `FMC_BTR4` writer
...
You can [`read`](crate::Reg::read) this register and get [`fmc_btr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmc_btr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#FMC:FMC_BTR4)*/
pub struct FMC_BTR4rs;
impl crate::RegisterSpec for FMC_BTR4rs {
    type Ux = u32;
}
///`read()` method returns [`fmc_btr4::R`](R) reader structure
impl crate::Readable for FMC_BTR4rs {}
///`write(|w| ..)` method takes [`fmc_btr4::W`](W) writer structure
impl crate::Writable for FMC_BTR4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FMC_BTR4 to value 0x0fff_ffff
