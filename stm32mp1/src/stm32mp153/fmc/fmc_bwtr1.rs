...
pub type R = crate::R<FMC_BWTR1rs>;
///Register `FMC_BWTR1` writer
pub type W = crate::W<FMC_BWTR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addset(&mut self) -> ADDSET_W<FMC_BWTR1rs> {
        ADDSET_W::new(self, 0)
    }
    ///Bits 4:7 - ADDHLD
    #[inline(always)]
    #[must_use]
    pub fn addhld(&mut self) -> ADDHLD_W<FMC_BWTR1rs> {
        ADDHLD_W::new(self, 4)
    }
    ///Bits 8:15 - DATAST
    #[inline(always)]
    #[must_use]
    pub fn datast(&mut self) -> DATAST_W<FMC_BWTR1rs> {
        DATAST_W::new(self, 8)
    }
    ///Bits 16:19 - BUSTURN
    #[inline(always)]
    #[must_use]
    pub fn busturn(&mut self) -> BUSTURN_W<FMC_BWTR1rs> {
        BUSTURN_W::new(self, 16)
    }
    ///Bits 28:29 - ACCMOD
    #[inline(always)]
    #[must_use]
    pub fn accmod(&mut self) -> ACCMOD_W<FMC_BWTR1rs> {
        ACCMOD_W::new(self, 28)
    }
    ///Bits 30:31 - DATAHLD
    #[inline(always)]
    #[must_use]
    pub fn datahld(&mut self) -> DATAHLD_W<FMC_BWTR1rs> {
...
You can [`read`](crate::Reg::read) this register and get [`fmc_bwtr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmc_bwtr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#FMC:FMC_BWTR1)*/
pub struct FMC_BWTR1rs;
impl crate::RegisterSpec for FMC_BWTR1rs {
    type Ux = u32;
}
///`read()` method returns [`fmc_bwtr1::R`](R) reader structure
impl crate::Readable for FMC_BWTR1rs {}
///`write(|w| ..)` method takes [`fmc_bwtr1::W`](W) writer structure
impl crate::Writable for FMC_BWTR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FMC_BWTR1 to value 0x000f_ffff
impl crate::Resettable for FMC_BWTR1rs {
