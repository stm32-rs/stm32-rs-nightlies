...
You can [`read`](crate::Reg::read) this register and get [`fmc_csqcfgr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmc_csqcfgr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#FMC:FMC_CSQCFGR3)*/
pub struct FMC_CSQCFGR3rs;
impl crate::RegisterSpec for FMC_CSQCFGR3rs {
    type Ux = u32;
}
///`read()` method returns [`fmc_csqcfgr3::R`](R) reader structure
impl crate::Readable for FMC_CSQCFGR3rs {}
///`write(|w| ..)` method takes [`fmc_csqcfgr3::W`](W) writer structure
impl crate::Writable for FMC_CSQCFGR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FMC_CSQCFGR3 to value 0
