...
You can [`read`](crate::Reg::read) this register and get [`fmc_sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#FMC:FMC_SR)*/
pub struct FMC_SRrs;
impl crate::RegisterSpec for FMC_SRrs {
    type Ux = u32;
}
///`read()` method returns [`fmc_sr::R`](R) reader structure
impl crate::Readable for FMC_SRrs {}
///`reset()` method sets FMC_SR to value 0x40
