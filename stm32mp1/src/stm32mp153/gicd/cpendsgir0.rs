...
impl W {
    ///Bits 0:1 - SGI_CLEAR_PENDING0
    #[inline(always)]
    pub fn sgi_clear_pending0(&mut self) -> SGI_CLEAR_PENDING0_W<CPENDSGIR0rs> {
        SGI_CLEAR_PENDING0_W::new(self, 0)
    }
    ///Bits 8:9 - SGI_CLEAR_PENDING1
    #[inline(always)]
    pub fn sgi_clear_pending1(&mut self) -> SGI_CLEAR_PENDING1_W<CPENDSGIR0rs> {
        SGI_CLEAR_PENDING1_W::new(self, 8)
    }
    ///Bits 16:17 - SGI_CLEAR_PENDING2
    #[inline(always)]
    pub fn sgi_clear_pending2(&mut self) -> SGI_CLEAR_PENDING2_W<CPENDSGIR0rs> {
        SGI_CLEAR_PENDING2_W::new(self, 16)
    }
    ///Bits 24:25 - SGI_CLEAR_PENDING3
    #[inline(always)]
    pub fn sgi_clear_pending3(&mut self) -> SGI_CLEAR_PENDING3_W<CPENDSGIR0rs> {
