///Register `CPENDSGIR0` reader
pub type R = crate::R<CPENDSGIR0rs>;
///Register `CPENDSGIR0` writer
pub type W = crate::W<CPENDSGIR0rs>;
...
impl W {
    ///Bits 0:1 - SGI_CLEAR_PENDING0
    #[inline(always)]
    pub fn sgi_clear_pending0(&mut self) -> SGI_CLEAR_PENDING0_W<'_, CPENDSGIR0rs> {
        SGI_CLEAR_PENDING0_W::new(self, 0)
    }
    ///Bits 8:9 - SGI_CLEAR_PENDING1
    #[inline(always)]
    pub fn sgi_clear_pending1(&mut self) -> SGI_CLEAR_PENDING1_W<'_, CPENDSGIR0rs> {
        SGI_CLEAR_PENDING1_W::new(self, 8)
    }
    ///Bits 16:17 - SGI_CLEAR_PENDING2
    #[inline(always)]
    pub fn sgi_clear_pending2(&mut self) -> SGI_CLEAR_PENDING2_W<'_, CPENDSGIR0rs> {
        SGI_CLEAR_PENDING2_W::new(self, 16)
    }
    ///Bits 24:25 - SGI_CLEAR_PENDING3
    #[inline(always)]
    pub fn sgi_clear_pending3(&mut self) -> SGI_CLEAR_PENDING3_W<'_, CPENDSGIR0rs> {
        SGI_CLEAR_PENDING3_W::new(self, 24)
    }
}
/**For SGI x*4 to SGI x*4+3

You can [`read`](crate::Reg::read) this register and get [`cpendsgir0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpendsgir0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:CPENDSGIR0)*/
pub struct CPENDSGIR0rs;
impl crate::RegisterSpec for CPENDSGIR0rs {
    type Ux = u32;
}
///`read()` method returns [`cpendsgir0::R`](R) reader structure
impl crate::Readable for CPENDSGIR0rs {}
///`write(|w| ..)` method takes [`cpendsgir0::W`](W) writer structure
impl crate::Writable for CPENDSGIR0rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CPENDSGIR0 to value 0
impl crate::Resettable for CPENDSGIR0rs {}
