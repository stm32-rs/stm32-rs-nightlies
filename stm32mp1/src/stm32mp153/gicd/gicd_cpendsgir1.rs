///Register `GICD_CPENDSGIR1` reader
pub type R = crate::R<GICD_CPENDSGIR1rs>;
///Register `GICD_CPENDSGIR1` writer
pub type W = crate::W<GICD_CPENDSGIR1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GICD_CPENDSGIR1")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sgi_clear_pending0(&mut self) -> SGI_CLEAR_PENDING0_W<GICD_CPENDSGIR1rs> {
        SGI_CLEAR_PENDING0_W::new(self, 0)
    }
    ///Bits 8:9 - SGI_CLEAR_PENDING1
    #[inline(always)]
    #[must_use]
    pub fn sgi_clear_pending1(&mut self) -> SGI_CLEAR_PENDING1_W<GICD_CPENDSGIR1rs> {
        SGI_CLEAR_PENDING1_W::new(self, 8)
    }
    ///Bits 16:17 - SGI_CLEAR_PENDING2
    #[inline(always)]
    #[must_use]
    pub fn sgi_clear_pending2(&mut self) -> SGI_CLEAR_PENDING2_W<GICD_CPENDSGIR1rs> {
        SGI_CLEAR_PENDING2_W::new(self, 16)
    }
    ///Bits 24:25 - SGI_CLEAR_PENDING3
    #[inline(always)]
    #[must_use]
    pub fn sgi_clear_pending3(&mut self) -> SGI_CLEAR_PENDING3_W<GICD_CPENDSGIR1rs> {
        SGI_CLEAR_PENDING3_W::new(self, 24)
    }
}
/**For SGI x*4 to SGI x*4+3

You can [`read`](crate::Reg::read) this register and get [`gicd_cpendsgir1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_cpendsgir1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:GICD_CPENDSGIR1)*/
pub struct GICD_CPENDSGIR1rs;
impl crate::RegisterSpec for GICD_CPENDSGIR1rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_cpendsgir1::R`](R) reader structure
impl crate::Readable for GICD_CPENDSGIR1rs {}
///`write(|w| ..)` method takes [`gicd_cpendsgir1::W`](W) writer structure
impl crate::Writable for GICD_CPENDSGIR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICD_CPENDSGIR1 to value 0
impl crate::Resettable for GICD_CPENDSGIR1rs {
