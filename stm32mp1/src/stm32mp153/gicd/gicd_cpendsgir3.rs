...
pub struct SGI_CLEAR_PENDING0_R(crate::FieldReader<u8, u8>);
impl SGI_CLEAR_PENDING0_R {
    pub(crate) fn new(bits: u8) -> Self {
        SGI_CLEAR_PENDING0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SGI_CLEAR_PENDING0_R {
...
pub struct SGI_CLEAR_PENDING1_R(crate::FieldReader<u8, u8>);
impl SGI_CLEAR_PENDING1_R {
    pub(crate) fn new(bits: u8) -> Self {
        SGI_CLEAR_PENDING1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SGI_CLEAR_PENDING1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SGI_CLEAR_PENDING2_R(crate::FieldReader<u8, u8>);
impl SGI_CLEAR_PENDING2_R {
    pub(crate) fn new(bits: u8) -> Self {
        SGI_CLEAR_PENDING2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SGI_CLEAR_PENDING2_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SGI_CLEAR_PENDING3_R(crate::FieldReader<u8, u8>);
impl SGI_CLEAR_PENDING3_R {
    pub(crate) fn new(bits: u8) -> Self {
        SGI_CLEAR_PENDING3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SGI_CLEAR_PENDING3_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
