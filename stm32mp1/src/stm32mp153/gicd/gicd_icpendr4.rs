...
pub type R = crate::R<GICD_ICPENDR4rs>;
#[doc = "Register `GICD_ICPENDR4` writer"]
pub type W = crate::W<GICD_ICPENDR4rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icpendr4(&mut self) -> ICPENDR4_W<GICD_ICPENDR4rs> {
...
pub struct GICD_ICPENDR4rs;
impl crate::RegisterSpec for GICD_ICPENDR4rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_icpendr4::R`](R) reader structure"]
impl crate::Readable for GICD_ICPENDR4rs {}
#[doc = "`write(|w| ..)` method takes [`gicd_icpendr4::W`](W) writer structure"]
impl crate::Writable for GICD_ICPENDR4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ICPENDR4 to value 0"]
impl crate::Resettable for GICD_ICPENDR4rs {
