///Register `GICD_IPRIORITYR6` reader
pub type R = crate::R<GICD_IPRIORITYR6rs>;
///Register `GICD_IPRIORITYR6` writer
...
///`read()` method returns [`gicd_ipriorityr6::R`](R) reader structure
impl crate::Readable for GICD_IPRIORITYR6rs {}
///`write(|w| ..)` method takes [`gicd_ipriorityr6::W`](W) writer structure
impl crate::Writable for GICD_IPRIORITYR6rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICD_IPRIORITYR6 to value 0
