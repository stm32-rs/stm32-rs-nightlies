///Register `GICD_ITARGETSR35` reader
pub type R = crate::R<GICD_ITARGETSR35rs>;
///Register `GICD_ITARGETSR35` writer
...
///`read()` method returns [`gicd_itargetsr35::R`](R) reader structure
impl crate::Readable for GICD_ITARGETSR35rs {}
///`write(|w| ..)` method takes [`gicd_itargetsr35::W`](W) writer structure
impl crate::Writable for GICD_ITARGETSR35rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICD_ITARGETSR35 to value 0
