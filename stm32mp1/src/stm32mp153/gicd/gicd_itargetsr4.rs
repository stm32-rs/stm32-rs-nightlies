///Register `GICD_ITARGETSR4` reader
pub type R = crate::R<GICD_ITARGETSR4rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:GICD_ITARGETSR4)*/
pub struct GICD_ITARGETSR4rs;
impl crate::RegisterSpec for GICD_ITARGETSR4rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_itargetsr4::R`](R) reader structure
impl crate::Readable for GICD_ITARGETSR4rs {}
///`reset()` method sets GICD_ITARGETSR4 to value 0
impl crate::Resettable for GICD_ITARGETSR4rs {
