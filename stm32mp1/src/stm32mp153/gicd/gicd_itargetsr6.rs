///Register `GICD_ITARGETSR6` reader
pub type R = crate::R<GICD_ITARGETSR6rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr6::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:GICD_ITARGETSR6)*/
pub struct GICD_ITARGETSR6rs;
impl crate::RegisterSpec for GICD_ITARGETSR6rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_itargetsr6::R`](R) reader structure
impl crate::Readable for GICD_ITARGETSR6rs {}
///`reset()` method sets GICD_ITARGETSR6 to value 0
impl crate::Resettable for GICD_ITARGETSR6rs {
