...
You can [`read`](crate::Reg::read) this register and get [`gicd_ppisr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`gicd_ppisr::R`](R) reader structure
impl crate::Readable for GICD_PPISRrs {}
///`reset()` method sets GICD_PPISR to value 0
