...
pub type R = crate::R<GICD_SPENDSGIR2rs>;
///Register `GICD_SPENDSGIR2` writer
pub type W = crate::W<GICD_SPENDSGIR2rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GICD_SPENDSGIR2")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sgi_set_pending0(&mut self) -> SGI_SET_PENDING0_W<GICD_SPENDSGIR2rs> {
        SGI_SET_PENDING0_W::new(self, 0)
    }
    ///Bits 8:9 - SGI_SET_PENDING1
    #[inline(always)]
    #[must_use]
    pub fn sgi_set_pending1(&mut self) -> SGI_SET_PENDING1_W<GICD_SPENDSGIR2rs> {
        SGI_SET_PENDING1_W::new(self, 8)
    }
    ///Bits 16:17 - SGI_SET_PENDING2
    #[inline(always)]
    #[must_use]
    pub fn sgi_set_pending2(&mut self) -> SGI_SET_PENDING2_W<GICD_SPENDSGIR2rs> {
        SGI_SET_PENDING2_W::new(self, 16)
    }
    ///Bits 24:25 - SGI_SET_PENDING3
    #[inline(always)]
    #[must_use]
    pub fn sgi_set_pending3(&mut self) -> SGI_SET_PENDING3_W<GICD_SPENDSGIR2rs> {
        SGI_SET_PENDING3_W::new(self, 24)
    }
}
/**For SGI x*4 to SGI x*4+3

You can [`read`](crate::Reg::read) this register and get [`gicd_spendsgir2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_spendsgir2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:GICD_SPENDSGIR2)*/
pub struct GICD_SPENDSGIR2rs;
impl crate::RegisterSpec for GICD_SPENDSGIR2rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_spendsgir2::R`](R) reader structure
impl crate::Readable for GICD_SPENDSGIR2rs {}
///`write(|w| ..)` method takes [`gicd_spendsgir2::W`](W) writer structure
impl crate::Writable for GICD_SPENDSGIR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICD_SPENDSGIR2 to value 0
impl crate::Resettable for GICD_SPENDSGIR2rs {
