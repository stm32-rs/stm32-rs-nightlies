...
impl W {
    ///Bits 0:1 - INT_CONFIG0
    #[inline(always)]
    pub fn int_config0(&mut self) -> INT_CONFIG0_W<ICFGR2rs> {
        INT_CONFIG0_W::new(self, 0)
    }
    ///Bits 2:3 - INT_CONFIG1
    #[inline(always)]
    pub fn int_config1(&mut self) -> INT_CONFIG1_W<ICFGR2rs> {
        INT_CONFIG1_W::new(self, 2)
    }
    ///Bits 4:5 - INT_CONFIG2
    #[inline(always)]
    pub fn int_config2(&mut self) -> INT_CONFIG2_W<ICFGR2rs> {
        INT_CONFIG2_W::new(self, 4)
    }
    ///Bits 6:7 - INT_CONFIG3
    #[inline(always)]
    pub fn int_config3(&mut self) -> INT_CONFIG3_W<ICFGR2rs> {
        INT_CONFIG3_W::new(self, 6)
    }
    ///Bits 8:9 - INT_CONFIG4
    #[inline(always)]
    pub fn int_config4(&mut self) -> INT_CONFIG4_W<ICFGR2rs> {
        INT_CONFIG4_W::new(self, 8)
    }
    ///Bits 10:11 - INT_CONFIG5
    #[inline(always)]
    pub fn int_config5(&mut self) -> INT_CONFIG5_W<ICFGR2rs> {
        INT_CONFIG5_W::new(self, 10)
    }
    ///Bits 12:13 - INT_CONFIG6
    #[inline(always)]
    pub fn int_config6(&mut self) -> INT_CONFIG6_W<ICFGR2rs> {
        INT_CONFIG6_W::new(self, 12)
    }
    ///Bits 14:15 - INT_CONFIG7
    #[inline(always)]
    pub fn int_config7(&mut self) -> INT_CONFIG7_W<ICFGR2rs> {
        INT_CONFIG7_W::new(self, 14)
    }
    ///Bits 16:17 - INT_CONFIG8
    #[inline(always)]
    pub fn int_config8(&mut self) -> INT_CONFIG8_W<ICFGR2rs> {
        INT_CONFIG8_W::new(self, 16)
    }
    ///Bits 18:19 - INT_CONFIG9
    #[inline(always)]
    pub fn int_config9(&mut self) -> INT_CONFIG9_W<ICFGR2rs> {
        INT_CONFIG9_W::new(self, 18)
    }
    ///Bits 20:21 - INT_CONFIG10
    #[inline(always)]
    pub fn int_config10(&mut self) -> INT_CONFIG10_W<ICFGR2rs> {
        INT_CONFIG10_W::new(self, 20)
    }
    ///Bits 22:23 - INT_CONFIG11
    #[inline(always)]
    pub fn int_config11(&mut self) -> INT_CONFIG11_W<ICFGR2rs> {
        INT_CONFIG11_W::new(self, 22)
    }
    ///Bits 24:25 - INT_CONFIG12
    #[inline(always)]
    pub fn int_config12(&mut self) -> INT_CONFIG12_W<ICFGR2rs> {
        INT_CONFIG12_W::new(self, 24)
    }
    ///Bits 26:27 - INT_CONFIG13
    #[inline(always)]
    pub fn int_config13(&mut self) -> INT_CONFIG13_W<ICFGR2rs> {
        INT_CONFIG13_W::new(self, 26)
    }
    ///Bits 28:29 - INT_CONFIG14
    #[inline(always)]
    pub fn int_config14(&mut self) -> INT_CONFIG14_W<ICFGR2rs> {
        INT_CONFIG14_W::new(self, 28)
    }
    ///Bits 30:31 - INT_CONFIG15
    #[inline(always)]
    pub fn int_config15(&mut self) -> INT_CONFIG15_W<ICFGR2rs> {
