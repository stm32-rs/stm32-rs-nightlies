///Register `ICFGR5` reader
pub type R = crate::R<ICFGR5rs>;
///Register `ICFGR5` writer
pub type W = crate::W<ICFGR5rs>;
...
impl W {
    ///Bits 0:1 - INT_CONFIG0
    #[inline(always)]
    pub fn int_config0(&mut self) -> INT_CONFIG0_W<'_, ICFGR5rs> {
        INT_CONFIG0_W::new(self, 0)
    }
    ///Bits 2:3 - INT_CONFIG1
    #[inline(always)]
    pub fn int_config1(&mut self) -> INT_CONFIG1_W<'_, ICFGR5rs> {
        INT_CONFIG1_W::new(self, 2)
    }
    ///Bits 4:5 - INT_CONFIG2
    #[inline(always)]
    pub fn int_config2(&mut self) -> INT_CONFIG2_W<'_, ICFGR5rs> {
        INT_CONFIG2_W::new(self, 4)
    }
    ///Bits 6:7 - INT_CONFIG3
    #[inline(always)]
    pub fn int_config3(&mut self) -> INT_CONFIG3_W<'_, ICFGR5rs> {
        INT_CONFIG3_W::new(self, 6)
    }
    ///Bits 8:9 - INT_CONFIG4
    #[inline(always)]
    pub fn int_config4(&mut self) -> INT_CONFIG4_W<'_, ICFGR5rs> {
        INT_CONFIG4_W::new(self, 8)
    }
    ///Bits 10:11 - INT_CONFIG5
    #[inline(always)]
    pub fn int_config5(&mut self) -> INT_CONFIG5_W<'_, ICFGR5rs> {
        INT_CONFIG5_W::new(self, 10)
    }
    ///Bits 12:13 - INT_CONFIG6
    #[inline(always)]
    pub fn int_config6(&mut self) -> INT_CONFIG6_W<'_, ICFGR5rs> {
        INT_CONFIG6_W::new(self, 12)
    }
    ///Bits 14:15 - INT_CONFIG7
    #[inline(always)]
    pub fn int_config7(&mut self) -> INT_CONFIG7_W<'_, ICFGR5rs> {
        INT_CONFIG7_W::new(self, 14)
    }
    ///Bits 16:17 - INT_CONFIG8
    #[inline(always)]
    pub fn int_config8(&mut self) -> INT_CONFIG8_W<'_, ICFGR5rs> {
        INT_CONFIG8_W::new(self, 16)
    }
    ///Bits 18:19 - INT_CONFIG9
    #[inline(always)]
    pub fn int_config9(&mut self) -> INT_CONFIG9_W<'_, ICFGR5rs> {
        INT_CONFIG9_W::new(self, 18)
    }
    ///Bits 20:21 - INT_CONFIG10
    #[inline(always)]
    pub fn int_config10(&mut self) -> INT_CONFIG10_W<'_, ICFGR5rs> {
        INT_CONFIG10_W::new(self, 20)
    }
    ///Bits 22:23 - INT_CONFIG11
    #[inline(always)]
    pub fn int_config11(&mut self) -> INT_CONFIG11_W<'_, ICFGR5rs> {
        INT_CONFIG11_W::new(self, 22)
    }
    ///Bits 24:25 - INT_CONFIG12
    #[inline(always)]
    pub fn int_config12(&mut self) -> INT_CONFIG12_W<'_, ICFGR5rs> {
        INT_CONFIG12_W::new(self, 24)
    }
    ///Bits 26:27 - INT_CONFIG13
    #[inline(always)]
    pub fn int_config13(&mut self) -> INT_CONFIG13_W<'_, ICFGR5rs> {
        INT_CONFIG13_W::new(self, 26)
    }
    ///Bits 28:29 - INT_CONFIG14
    #[inline(always)]
    pub fn int_config14(&mut self) -> INT_CONFIG14_W<'_, ICFGR5rs> {
        INT_CONFIG14_W::new(self, 28)
    }
    ///Bits 30:31 - INT_CONFIG15
    #[inline(always)]
    pub fn int_config15(&mut self) -> INT_CONFIG15_W<'_, ICFGR5rs> {
        INT_CONFIG15_W::new(self, 30)
    }
}
/**GICD interrupt configuration register 5

You can [`read`](crate::Reg::read) this register and get [`icfgr5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icfgr5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:ICFGR5)*/
pub struct ICFGR5rs;
impl crate::RegisterSpec for ICFGR5rs {
    type Ux = u32;
}
///`read()` method returns [`icfgr5::R`](R) reader structure
impl crate::Readable for ICFGR5rs {}
///`write(|w| ..)` method takes [`icfgr5::W`](W) writer structure
impl crate::Writable for ICFGR5rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets ICFGR5 to value 0x5555_5555
impl crate::Resettable for ICFGR5rs {
