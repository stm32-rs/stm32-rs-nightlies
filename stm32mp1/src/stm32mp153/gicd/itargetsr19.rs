///Register `ITARGETSR19` reader
pub type R = crate::R<ITARGETSR19rs>;
///Register `ITARGETSR19` writer
pub type W = crate::W<ITARGETSR19rs>;
...
impl W {
    ///Bits 0:1 - CPU_TARGETS0
    #[inline(always)]
    pub fn cpu_targets0(&mut self) -> CPU_TARGETS0_W<'_, ITARGETSR19rs> {
        CPU_TARGETS0_W::new(self, 0)
    }
    ///Bits 8:9 - CPU_TARGETS1
    #[inline(always)]
    pub fn cpu_targets1(&mut self) -> CPU_TARGETS1_W<'_, ITARGETSR19rs> {
        CPU_TARGETS1_W::new(self, 8)
    }
    ///Bits 16:17 - CPU_TARGETS2
    #[inline(always)]
    pub fn cpu_targets2(&mut self) -> CPU_TARGETS2_W<'_, ITARGETSR19rs> {
        CPU_TARGETS2_W::new(self, 16)
    }
    ///Bits 24:25 - CPU_TARGETS3
    #[inline(always)]
    pub fn cpu_targets3(&mut self) -> CPU_TARGETS3_W<'_, ITARGETSR19rs> {
        CPU_TARGETS3_W::new(self, 24)
    }
}
/**GICD interrupt processor target register 19

You can [`read`](crate::Reg::read) this register and get [`itargetsr19::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`itargetsr19::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:ITARGETSR19)*/
pub struct ITARGETSR19rs;
impl crate::RegisterSpec for ITARGETSR19rs {
    type Ux = u32;
}
///`read()` method returns [`itargetsr19::R`](R) reader structure
impl crate::Readable for ITARGETSR19rs {}
///`write(|w| ..)` method takes [`itargetsr19::W`](W) writer structure
impl crate::Writable for ITARGETSR19rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets ITARGETSR19 to value 0
impl crate::Resettable for ITARGETSR19rs {}
