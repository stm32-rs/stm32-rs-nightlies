///Register `ITARGETSR2` reader
pub type R = crate::R<ITARGETSR2rs>;
...
You can [`read`](crate::Reg::read) this register and get [`itargetsr2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:ITARGETSR2)*/
pub struct ITARGETSR2rs;
impl crate::RegisterSpec for ITARGETSR2rs {
    type Ux = u32;
}
///`read()` method returns [`itargetsr2::R`](R) reader structure
impl crate::Readable for ITARGETSR2rs {}
///`reset()` method sets ITARGETSR2 to value 0
impl crate::Resettable for ITARGETSR2rs {}
