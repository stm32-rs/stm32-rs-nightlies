///Register `ITARGETSR5` reader
pub type R = crate::R<ITARGETSR5rs>;
...
You can [`read`](crate::Reg::read) this register and get [`itargetsr5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:ITARGETSR5)*/
pub struct ITARGETSR5rs;
impl crate::RegisterSpec for ITARGETSR5rs {
    type Ux = u32;
}
///`read()` method returns [`itargetsr5::R`](R) reader structure
impl crate::Readable for ITARGETSR5rs {}
///`reset()` method sets ITARGETSR5 to value 0
impl crate::Resettable for ITARGETSR5rs {}
