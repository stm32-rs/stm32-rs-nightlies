...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sgiintid(&mut self) -> SGIINTID_W<SGIRrs> {
        SGIINTID_W::new(self, 0)
    }
    ///Bit 15 - NSATT
    #[inline(always)]
    #[must_use]
    pub fn nsatt(&mut self) -> NSATT_W<SGIRrs> {
        NSATT_W::new(self, 15)
    }
    ///Bits 16:17 - CPUTARGETLIST
    #[inline(always)]
    #[must_use]
    pub fn cputargetlist(&mut self) -> CPUTARGETLIST_W<SGIRrs> {
        CPUTARGETLIST_W::new(self, 16)
    }
    ///Bits 24:25 - TARGETLISTFILTER
    #[inline(always)]
    #[must_use]
    pub fn targetlistfilter(&mut self) -> TARGETLISTFILTER_W<SGIRrs> {
