///Register `SPENDSGIR1` reader
pub type R = crate::R<SPENDSGIR1rs>;
///Register `SPENDSGIR1` writer
pub type W = crate::W<SPENDSGIR1rs>;
...
impl W {
    ///Bits 0:1 - SGI_SET_PENDING0
    #[inline(always)]
    pub fn sgi_set_pending0(&mut self) -> SGI_SET_PENDING0_W<'_, SPENDSGIR1rs> {
        SGI_SET_PENDING0_W::new(self, 0)
    }
    ///Bits 8:9 - SGI_SET_PENDING1
    #[inline(always)]
    pub fn sgi_set_pending1(&mut self) -> SGI_SET_PENDING1_W<'_, SPENDSGIR1rs> {
        SGI_SET_PENDING1_W::new(self, 8)
    }
    ///Bits 16:17 - SGI_SET_PENDING2
    #[inline(always)]
    pub fn sgi_set_pending2(&mut self) -> SGI_SET_PENDING2_W<'_, SPENDSGIR1rs> {
        SGI_SET_PENDING2_W::new(self, 16)
    }
    ///Bits 24:25 - SGI_SET_PENDING3
    #[inline(always)]
    pub fn sgi_set_pending3(&mut self) -> SGI_SET_PENDING3_W<'_, SPENDSGIR1rs> {
        SGI_SET_PENDING3_W::new(self, 24)
    }
}
/**For SGI x*4 to SGI x*4+3

You can [`read`](crate::Reg::read) this register and get [`spendsgir1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spendsgir1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICD:SPENDSGIR1)*/
pub struct SPENDSGIR1rs;
impl crate::RegisterSpec for SPENDSGIR1rs {
    type Ux = u32;
}
///`read()` method returns [`spendsgir1::R`](R) reader structure
impl crate::Readable for SPENDSGIR1rs {}
///`write(|w| ..)` method takes [`spendsgir1::W`](W) writer structure
impl crate::Writable for SPENDSGIR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SPENDSGIR1 to value 0
impl crate::Resettable for SPENDSGIR1rs {}
