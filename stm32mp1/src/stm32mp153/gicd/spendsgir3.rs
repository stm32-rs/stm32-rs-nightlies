...
impl W {
    ///Bits 0:1 - SGI_SET_PENDING0
    #[inline(always)]
    pub fn sgi_set_pending0(&mut self) -> SGI_SET_PENDING0_W<SPENDSGIR3rs> {
        SGI_SET_PENDING0_W::new(self, 0)
    }
    ///Bits 8:9 - SGI_SET_PENDING1
    #[inline(always)]
    pub fn sgi_set_pending1(&mut self) -> SGI_SET_PENDING1_W<SPENDSGIR3rs> {
        SGI_SET_PENDING1_W::new(self, 8)
    }
    ///Bits 16:17 - SGI_SET_PENDING2
    #[inline(always)]
    pub fn sgi_set_pending2(&mut self) -> SGI_SET_PENDING2_W<SPENDSGIR3rs> {
        SGI_SET_PENDING2_W::new(self, 16)
    }
    ///Bits 24:25 - SGI_SET_PENDING3
    #[inline(always)]
    pub fn sgi_set_pending3(&mut self) -> SGI_SET_PENDING3_W<SPENDSGIR3rs> {
