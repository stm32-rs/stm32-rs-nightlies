...
For information about available fields see [`mod@hcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICH:VTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICH:EISR0)

For information about available fields see [`mod@eisr0`]
module*/
...
For information about available fields see [`mod@elsr0`]
module*/
...
For information about available fields see [`mod@apr0`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICH:LR0)

For information about available fields see [`mod@lr0`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICH:LR1)

For information about available fields see [`mod@lr1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICH:LR2)

For information about available fields see [`mod@lr2`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GICH:LR3)

For information about available fields see [`mod@lr3`]
module*/
