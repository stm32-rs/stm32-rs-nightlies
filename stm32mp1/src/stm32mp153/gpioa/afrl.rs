...
impl W {
    ...
    ///Bits 0:3 - AFR0
    #[inline(always)]
    pub fn afr0(&mut self) -> AFR_W<'_, AFRLrs> {
        AFR_W::new(self, 0)
    }
    ///Bits 4:7 - AFR1
    #[inline(always)]
    pub fn afr1(&mut self) -> AFR_W<'_, AFRLrs> {
        AFR_W::new(self, 4)
    }
    ///Bits 8:11 - AFR2
    #[inline(always)]
    pub fn afr2(&mut self) -> AFR_W<'_, AFRLrs> {
        AFR_W::new(self, 8)
    }
    ///Bits 12:15 - AFR3
    #[inline(always)]
    pub fn afr3(&mut self) -> AFR_W<'_, AFRLrs> {
        AFR_W::new(self, 12)
    }
    ///Bits 16:19 - AFR4
    #[inline(always)]
    pub fn afr4(&mut self) -> AFR_W<'_, AFRLrs> {
        AFR_W::new(self, 16)
    }
    ///Bits 20:23 - AFR5
    #[inline(always)]
    pub fn afr5(&mut self) -> AFR_W<'_, AFRLrs> {
        AFR_W::new(self, 20)
    }
    ///Bits 24:27 - AFR6
    #[inline(always)]
    pub fn afr6(&mut self) -> AFR_W<'_, AFRLrs> {
        AFR_W::new(self, 24)
    }
    ///Bits 28:31 - AFR7
    #[inline(always)]
    pub fn afr7(&mut self) -> AFR_W<'_, AFRLrs> {
        AFR_W::new(self, 28)
    }
}
