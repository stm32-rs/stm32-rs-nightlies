///Register `GPIOA_AFRH` reader
pub type R = crate::R<GPIOA_AFRHrs>;
///Register `GPIOA_AFRH` writer
pub type W = crate::W<GPIOA_AFRHrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn afr8(&mut self) -> AFR8_W<GPIOA_AFRHrs> {
        AFR8_W::new(self, 0)
    }
    ///Bits 4:7 - AFR9
    #[inline(always)]
    #[must_use]
    pub fn afr9(&mut self) -> AFR9_W<GPIOA_AFRHrs> {
        AFR9_W::new(self, 4)
    }
    ///Bits 8:11 - AFR10
    #[inline(always)]
    #[must_use]
    pub fn afr10(&mut self) -> AFR10_W<GPIOA_AFRHrs> {
        AFR10_W::new(self, 8)
    }
    ///Bits 12:15 - AFR11
    #[inline(always)]
    #[must_use]
    pub fn afr11(&mut self) -> AFR11_W<GPIOA_AFRHrs> {
        AFR11_W::new(self, 12)
    }
    ///Bits 16:19 - AFR12
    #[inline(always)]
    #[must_use]
    pub fn afr12(&mut self) -> AFR12_W<GPIOA_AFRHrs> {
        AFR12_W::new(self, 16)
    }
    ///Bits 20:23 - AFR13
    #[inline(always)]
    #[must_use]
    pub fn afr13(&mut self) -> AFR13_W<GPIOA_AFRHrs> {
        AFR13_W::new(self, 20)
    }
    ///Bits 24:27 - AFR14
    #[inline(always)]
    #[must_use]
    pub fn afr14(&mut self) -> AFR14_W<GPIOA_AFRHrs> {
        AFR14_W::new(self, 24)
    }
    ///Bits 28:31 - AFR15
    #[inline(always)]
    #[must_use]
    pub fn afr15(&mut self) -> AFR15_W<GPIOA_AFRHrs> {
        AFR15_W::new(self, 28)
    }
}
/**GPIO alternate function high register

You can [`read`](crate::Reg::read) this register and get [`gpioa_afrh::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_afrh::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOA:GPIOA_AFRH)*/
pub struct GPIOA_AFRHrs;
impl crate::RegisterSpec for GPIOA_AFRHrs {
    type Ux = u32;
}
///`read()` method returns [`gpioa_afrh::R`](R) reader structure
impl crate::Readable for GPIOA_AFRHrs {}
///`write(|w| ..)` method takes [`gpioa_afrh::W`](W) writer structure
impl crate::Writable for GPIOA_AFRHrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOA_AFRH to value 0
impl crate::Resettable for GPIOA_AFRHrs {
