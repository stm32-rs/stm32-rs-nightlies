...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn afr0(&mut self) -> AFR0_W<GPIOA_AFRLrs> {
        AFR0_W::new(self, 0)
    }
    ///Bits 4:7 - AFR1
    #[inline(always)]
    #[must_use]
    pub fn afr1(&mut self) -> AFR1_W<GPIOA_AFRLrs> {
        AFR1_W::new(self, 4)
    }
    ///Bits 8:11 - AFR2
    #[inline(always)]
    #[must_use]
    pub fn afr2(&mut self) -> AFR2_W<GPIOA_AFRLrs> {
        AFR2_W::new(self, 8)
    }
    ///Bits 12:15 - AFR3
    #[inline(always)]
    #[must_use]
    pub fn afr3(&mut self) -> AFR3_W<GPIOA_AFRLrs> {
        AFR3_W::new(self, 12)
    }
    ///Bits 16:19 - AFR4
    #[inline(always)]
    #[must_use]
    pub fn afr4(&mut self) -> AFR4_W<GPIOA_AFRLrs> {
        AFR4_W::new(self, 16)
    }
    ///Bits 20:23 - AFR5
    #[inline(always)]
    #[must_use]
    pub fn afr5(&mut self) -> AFR5_W<GPIOA_AFRLrs> {
        AFR5_W::new(self, 20)
    }
    ///Bits 24:27 - AFR6
    #[inline(always)]
    #[must_use]
    pub fn afr6(&mut self) -> AFR6_W<GPIOA_AFRLrs> {
        AFR6_W::new(self, 24)
    }
    ///Bits 28:31 - AFR7
    #[inline(always)]
    #[must_use]
    pub fn afr7(&mut self) -> AFR7_W<GPIOA_AFRLrs> {
        AFR7_W::new(self, 28)
    }
}
