///Register `GPIOA_HWCFGR10` reader
pub type R = crate::R<GPIOA_HWCFGR10rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioa_hwcfgr10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOA:GPIOA_HWCFGR10)*/
pub struct GPIOA_HWCFGR10rs;
impl crate::RegisterSpec for GPIOA_HWCFGR10rs {
    type Ux = u32;
}
///`read()` method returns [`gpioa_hwcfgr10::R`](R) reader structure
impl crate::Readable for GPIOA_HWCFGR10rs {}
///`reset()` method sets GPIOA_HWCFGR10 to value 0x0001_1240
impl crate::Resettable for GPIOA_HWCFGR10rs {
