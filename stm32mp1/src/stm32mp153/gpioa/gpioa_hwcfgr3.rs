...
pub type R = crate::R<GPIOA_HWCFGR3rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioa_hwcfgr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOA:GPIOA_HWCFGR3)*/
pub struct GPIOA_HWCFGR3rs;
impl crate::RegisterSpec for GPIOA_HWCFGR3rs {
    type Ux = u32;
}
///`read()` method returns [`gpioa_hwcfgr3::R`](R) reader structure
impl crate::Readable for GPIOA_HWCFGR3rs {}
///`reset()` method sets GPIOA_HWCFGR3 to value 0
impl crate::Resettable for GPIOA_HWCFGR3rs {
