...
pub type R = crate::R<GPIOB_HWCFGR7rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiob_hwcfgr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOB:GPIOB_HWCFGR7)*/
pub struct GPIOB_HWCFGR7rs;
impl crate::RegisterSpec for GPIOB_HWCFGR7rs {
    type Ux = u32;
}
///`read()` method returns [`gpiob_hwcfgr7::R`](R) reader structure
impl crate::Readable for GPIOB_HWCFGR7rs {}
///`reset()` method sets GPIOB_HWCFGR7 to value 0xffff_ffff
impl crate::Resettable for GPIOB_HWCFGR7rs {
