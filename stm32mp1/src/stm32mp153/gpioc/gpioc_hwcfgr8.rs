///Register `GPIOC_HWCFGR8` reader
pub type R = crate::R<GPIOC_HWCFGR8rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioc_hwcfgr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOC:GPIOC_HWCFGR8)*/
pub struct GPIOC_HWCFGR8rs;
impl crate::RegisterSpec for GPIOC_HWCFGR8rs {
    type Ux = u32;
}
///`read()` method returns [`gpioc_hwcfgr8::R`](R) reader structure
impl crate::Readable for GPIOC_HWCFGR8rs {}
///`reset()` method sets GPIOC_HWCFGR8 to value 0
impl crate::Resettable for GPIOC_HWCFGR8rs {
