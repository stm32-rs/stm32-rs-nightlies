...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn afr8(&mut self) -> AFR8_W<GPIOD_AFRHrs> {
        AFR8_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - AFR9"]
    #[inline(always)]
    #[must_use]
    pub fn afr9(&mut self) -> AFR9_W<GPIOD_AFRHrs> {
        AFR9_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - AFR10"]
    #[inline(always)]
    #[must_use]
    pub fn afr10(&mut self) -> AFR10_W<GPIOD_AFRHrs> {
        AFR10_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - AFR11"]
    #[inline(always)]
    #[must_use]
    pub fn afr11(&mut self) -> AFR11_W<GPIOD_AFRHrs> {
        AFR11_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - AFR12"]
    #[inline(always)]
    #[must_use]
    pub fn afr12(&mut self) -> AFR12_W<GPIOD_AFRHrs> {
        AFR12_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - AFR13"]
    #[inline(always)]
    #[must_use]
    pub fn afr13(&mut self) -> AFR13_W<GPIOD_AFRHrs> {
        AFR13_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - AFR14"]
    #[inline(always)]
    #[must_use]
    pub fn afr14(&mut self) -> AFR14_W<GPIOD_AFRHrs> {
        AFR14_W::new(self, 24)
    }
    #[doc = "Bits 28:31 - AFR15"]
    #[inline(always)]
    #[must_use]
    pub fn afr15(&mut self) -> AFR15_W<GPIOD_AFRHrs> {
        AFR15_W::new(self, 28)
    }
}
#[doc = "GPIO alternate function high register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpiod_afrh::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpiod_afrh::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
