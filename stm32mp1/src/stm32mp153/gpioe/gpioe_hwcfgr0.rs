...
pub type R = crate::R<GPIOE_HWCFGR0rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioe_hwcfgr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOE:GPIOE_HWCFGR0)*/
pub struct GPIOE_HWCFGR0rs;
impl crate::RegisterSpec for GPIOE_HWCFGR0rs {
    type Ux = u32;
}
///`read()` method returns [`gpioe_hwcfgr0::R`](R) reader structure
impl crate::Readable for GPIOE_HWCFGR0rs {}
///`reset()` method sets GPIOE_HWCFGR0 to value 0
impl crate::Resettable for GPIOE_HWCFGR0rs {
