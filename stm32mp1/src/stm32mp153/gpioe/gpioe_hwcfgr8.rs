///Register `GPIOE_HWCFGR8` reader
pub type R = crate::R<GPIOE_HWCFGR8rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioe_hwcfgr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOE:GPIOE_HWCFGR8)*/
pub struct GPIOE_HWCFGR8rs;
impl crate::RegisterSpec for GPIOE_HWCFGR8rs {
    type Ux = u32;
}
///`read()` method returns [`gpioe_hwcfgr8::R`](R) reader structure
impl crate::Readable for GPIOE_HWCFGR8rs {}
///`reset()` method sets GPIOE_HWCFGR8 to value 0
impl crate::Resettable for GPIOE_HWCFGR8rs {
