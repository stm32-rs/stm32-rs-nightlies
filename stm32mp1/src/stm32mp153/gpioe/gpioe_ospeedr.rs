...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ospeedr0(&mut self) -> OSPEEDR0_W<GPIOE_OSPEEDRrs> {
        OSPEEDR0_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - OSPEEDR1"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr1(&mut self) -> OSPEEDR1_W<GPIOE_OSPEEDRrs> {
        OSPEEDR1_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - OSPEEDR2"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr2(&mut self) -> OSPEEDR2_W<GPIOE_OSPEEDRrs> {
        OSPEEDR2_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - OSPEEDR3"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr3(&mut self) -> OSPEEDR3_W<GPIOE_OSPEEDRrs> {
        OSPEEDR3_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - OSPEEDR4"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr4(&mut self) -> OSPEEDR4_W<GPIOE_OSPEEDRrs> {
        OSPEEDR4_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - OSPEEDR5"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr5(&mut self) -> OSPEEDR5_W<GPIOE_OSPEEDRrs> {
        OSPEEDR5_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - OSPEEDR6"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr6(&mut self) -> OSPEEDR6_W<GPIOE_OSPEEDRrs> {
        OSPEEDR6_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - OSPEEDR7"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr7(&mut self) -> OSPEEDR7_W<GPIOE_OSPEEDRrs> {
        OSPEEDR7_W::new(self, 14)
    }
    #[doc = "Bits 16:17 - OSPEEDR8"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr8(&mut self) -> OSPEEDR8_W<GPIOE_OSPEEDRrs> {
        OSPEEDR8_W::new(self, 16)
    }
    #[doc = "Bits 18:19 - OSPEEDR9"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr9(&mut self) -> OSPEEDR9_W<GPIOE_OSPEEDRrs> {
        OSPEEDR9_W::new(self, 18)
    }
    #[doc = "Bits 20:21 - OSPEEDR10"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr10(&mut self) -> OSPEEDR10_W<GPIOE_OSPEEDRrs> {
        OSPEEDR10_W::new(self, 20)
    }
    #[doc = "Bits 22:23 - OSPEEDR11"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr11(&mut self) -> OSPEEDR11_W<GPIOE_OSPEEDRrs> {
        OSPEEDR11_W::new(self, 22)
    }
    #[doc = "Bits 24:25 - OSPEEDR12"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr12(&mut self) -> OSPEEDR12_W<GPIOE_OSPEEDRrs> {
        OSPEEDR12_W::new(self, 24)
    }
    #[doc = "Bits 26:27 - OSPEEDR13"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr13(&mut self) -> OSPEEDR13_W<GPIOE_OSPEEDRrs> {
        OSPEEDR13_W::new(self, 26)
    }
    #[doc = "Bits 28:29 - OSPEEDR14"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr14(&mut self) -> OSPEEDR14_W<GPIOE_OSPEEDRrs> {
        OSPEEDR14_W::new(self, 28)
    }
    #[doc = "Bits 30:31 - OSPEEDR15"]
    #[inline(always)]
    #[must_use]
    pub fn ospeedr15(&mut self) -> OSPEEDR15_W<GPIOE_OSPEEDRrs> {
        OSPEEDR15_W::new(self, 30)
    }
}
#[doc = "GPIO port output speed register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpioe_ospeedr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpioe_ospeedr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
