...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn afr8(&mut self) -> AFR8_W<GPIOF_AFRHrs> {
        AFR8_W::new(self, 0)
    }
    ///Bits 4:7 - AFR9
    #[inline(always)]
    #[must_use]
    pub fn afr9(&mut self) -> AFR9_W<GPIOF_AFRHrs> {
        AFR9_W::new(self, 4)
    }
    ///Bits 8:11 - AFR10
    #[inline(always)]
    #[must_use]
    pub fn afr10(&mut self) -> AFR10_W<GPIOF_AFRHrs> {
        AFR10_W::new(self, 8)
    }
    ///Bits 12:15 - AFR11
    #[inline(always)]
    #[must_use]
    pub fn afr11(&mut self) -> AFR11_W<GPIOF_AFRHrs> {
        AFR11_W::new(self, 12)
    }
    ///Bits 16:19 - AFR12
    #[inline(always)]
    #[must_use]
    pub fn afr12(&mut self) -> AFR12_W<GPIOF_AFRHrs> {
        AFR12_W::new(self, 16)
    }
    ///Bits 20:23 - AFR13
    #[inline(always)]
    #[must_use]
    pub fn afr13(&mut self) -> AFR13_W<GPIOF_AFRHrs> {
        AFR13_W::new(self, 20)
    }
    ///Bits 24:27 - AFR14
    #[inline(always)]
    #[must_use]
    pub fn afr14(&mut self) -> AFR14_W<GPIOF_AFRHrs> {
        AFR14_W::new(self, 24)
    }
    ///Bits 28:31 - AFR15
    #[inline(always)]
    #[must_use]
    pub fn afr15(&mut self) -> AFR15_W<GPIOF_AFRHrs> {
        AFR15_W::new(self, 28)
    }
}
