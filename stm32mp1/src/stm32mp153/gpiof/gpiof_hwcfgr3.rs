///Register `GPIOF_HWCFGR3` reader
pub type R = crate::R<GPIOF_HWCFGR3rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiof_hwcfgr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOF:GPIOF_HWCFGR3)*/
pub struct GPIOF_HWCFGR3rs;
impl crate::RegisterSpec for GPIOF_HWCFGR3rs {
    type Ux = u32;
}
///`read()` method returns [`gpiof_hwcfgr3::R`](R) reader structure
impl crate::Readable for GPIOF_HWCFGR3rs {}
///`reset()` method sets GPIOF_HWCFGR3 to value 0
impl crate::Resettable for GPIOF_HWCFGR3rs {
