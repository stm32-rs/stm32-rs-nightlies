...
pub type R = crate::R<GPIOF_HWCFGR4rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiof_hwcfgr4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOF:GPIOF_HWCFGR4)*/
pub struct GPIOF_HWCFGR4rs;
impl crate::RegisterSpec for GPIOF_HWCFGR4rs {
    type Ux = u32;
}
///`read()` method returns [`gpiof_hwcfgr4::R`](R) reader structure
impl crate::Readable for GPIOF_HWCFGR4rs {}
///`reset()` method sets GPIOF_HWCFGR4 to value 0
impl crate::Resettable for GPIOF_HWCFGR4rs {
