///Register `GPIOF_HWCFGR7` reader
pub type R = crate::R<GPIOF_HWCFGR7rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiof_hwcfgr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOF:GPIOF_HWCFGR7)*/
pub struct GPIOF_HWCFGR7rs;
impl crate::RegisterSpec for GPIOF_HWCFGR7rs {
    type Ux = u32;
}
///`read()` method returns [`gpiof_hwcfgr7::R`](R) reader structure
impl crate::Readable for GPIOF_HWCFGR7rs {}
///`reset()` method sets GPIOF_HWCFGR7 to value 0xffff_ffff
impl crate::Resettable for GPIOF_HWCFGR7rs {
