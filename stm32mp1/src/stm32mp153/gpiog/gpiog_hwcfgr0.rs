...
You can [`read`](crate::Reg::read) this register and get [`gpiog_hwcfgr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`gpiog_hwcfgr0::R`](R) reader structure
impl crate::Readable for GPIOG_HWCFGR0rs {}
///`reset()` method sets GPIOG_HWCFGR0 to value 0
