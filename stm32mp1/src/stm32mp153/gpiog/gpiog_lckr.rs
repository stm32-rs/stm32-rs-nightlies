...
pub type R = crate::R<GPIOG_LCKRrs>;
///Register `GPIOG_LCKR` writer
pub type W = crate::W<GPIOG_LCKRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lck0(&mut self) -> LCK0_W<GPIOG_LCKRrs> {
        LCK0_W::new(self, 0)
    }
    ///Bit 1 - LCK1
    #[inline(always)]
    #[must_use]
    pub fn lck1(&mut self) -> LCK1_W<GPIOG_LCKRrs> {
        LCK1_W::new(self, 1)
    }
    ///Bit 2 - LCK2
    #[inline(always)]
    #[must_use]
    pub fn lck2(&mut self) -> LCK2_W<GPIOG_LCKRrs> {
        LCK2_W::new(self, 2)
    }
    ///Bit 3 - LCK3
    #[inline(always)]
    #[must_use]
    pub fn lck3(&mut self) -> LCK3_W<GPIOG_LCKRrs> {
        LCK3_W::new(self, 3)
    }
    ///Bit 4 - LCK4
    #[inline(always)]
    #[must_use]
    pub fn lck4(&mut self) -> LCK4_W<GPIOG_LCKRrs> {
        LCK4_W::new(self, 4)
    }
    ///Bit 5 - LCK5
    #[inline(always)]
    #[must_use]
    pub fn lck5(&mut self) -> LCK5_W<GPIOG_LCKRrs> {
        LCK5_W::new(self, 5)
    }
    ///Bit 6 - LCK6
    #[inline(always)]
    #[must_use]
    pub fn lck6(&mut self) -> LCK6_W<GPIOG_LCKRrs> {
        LCK6_W::new(self, 6)
    }
    ///Bit 7 - LCK7
    #[inline(always)]
    #[must_use]
    pub fn lck7(&mut self) -> LCK7_W<GPIOG_LCKRrs> {
        LCK7_W::new(self, 7)
    }
    ///Bit 8 - LCK8
    #[inline(always)]
    #[must_use]
    pub fn lck8(&mut self) -> LCK8_W<GPIOG_LCKRrs> {
        LCK8_W::new(self, 8)
    }
    ///Bit 9 - LCK9
    #[inline(always)]
    #[must_use]
    pub fn lck9(&mut self) -> LCK9_W<GPIOG_LCKRrs> {
        LCK9_W::new(self, 9)
    }
    ///Bit 10 - LCK10
    #[inline(always)]
    #[must_use]
    pub fn lck10(&mut self) -> LCK10_W<GPIOG_LCKRrs> {
        LCK10_W::new(self, 10)
    }
    ///Bit 11 - LCK11
    #[inline(always)]
    #[must_use]
    pub fn lck11(&mut self) -> LCK11_W<GPIOG_LCKRrs> {
        LCK11_W::new(self, 11)
    }
    ///Bit 12 - LCK12
    #[inline(always)]
    #[must_use]
    pub fn lck12(&mut self) -> LCK12_W<GPIOG_LCKRrs> {
        LCK12_W::new(self, 12)
    }
    ///Bit 13 - LCK13
    #[inline(always)]
    #[must_use]
    pub fn lck13(&mut self) -> LCK13_W<GPIOG_LCKRrs> {
        LCK13_W::new(self, 13)
    }
    ///Bit 14 - LCK14
    #[inline(always)]
    #[must_use]
    pub fn lck14(&mut self) -> LCK14_W<GPIOG_LCKRrs> {
        LCK14_W::new(self, 14)
    }
    ///Bit 15 - LCK15
    #[inline(always)]
    #[must_use]
    pub fn lck15(&mut self) -> LCK15_W<GPIOG_LCKRrs> {
        LCK15_W::new(self, 15)
    }
    ///Bit 16 - LCKK
    #[inline(always)]
    #[must_use]
    pub fn lckk(&mut self) -> LCKK_W<GPIOG_LCKRrs> {
        LCKK_W::new(self, 16)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`gpiog_lckr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiog_lckr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOG:GPIOG_LCKR)*/
pub struct GPIOG_LCKRrs;
impl crate::RegisterSpec for GPIOG_LCKRrs {
    type Ux = u32;
}
///`read()` method returns [`gpiog_lckr::R`](R) reader structure
impl crate::Readable for GPIOG_LCKRrs {}
///`write(|w| ..)` method takes [`gpiog_lckr::W`](W) writer structure
impl crate::Writable for GPIOG_LCKRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOG_LCKR to value 0
impl crate::Resettable for GPIOG_LCKRrs {
