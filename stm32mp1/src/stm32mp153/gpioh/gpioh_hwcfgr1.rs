...
You can [`read`](crate::Reg::read) this register and get [`gpioh_hwcfgr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOH:GPIOH_HWCFGR1)*/
pub struct GPIOH_HWCFGR1rs;
impl crate::RegisterSpec for GPIOH_HWCFGR1rs {
    type Ux = u32;
}
///`read()` method returns [`gpioh_hwcfgr1::R`](R) reader structure
impl crate::Readable for GPIOH_HWCFGR1rs {}
///`reset()` method sets GPIOH_HWCFGR1 to value 0
