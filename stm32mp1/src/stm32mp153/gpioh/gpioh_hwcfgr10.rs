...
pub type R = crate::R<GPIOH_HWCFGR10rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioh_hwcfgr10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOH:GPIOH_HWCFGR10)*/
pub struct GPIOH_HWCFGR10rs;
impl crate::RegisterSpec for GPIOH_HWCFGR10rs {
    type Ux = u32;
}
///`read()` method returns [`gpioh_hwcfgr10::R`](R) reader structure
impl crate::Readable for GPIOH_HWCFGR10rs {}
///`reset()` method sets GPIOH_HWCFGR10 to value 0x0001_1240
impl crate::Resettable for GPIOH_HWCFGR10rs {
