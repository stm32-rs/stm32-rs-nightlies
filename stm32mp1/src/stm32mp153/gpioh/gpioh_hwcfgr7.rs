///Register `GPIOH_HWCFGR7` reader
pub type R = crate::R<GPIOH_HWCFGR7rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioh_hwcfgr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOH:GPIOH_HWCFGR7)*/
pub struct GPIOH_HWCFGR7rs;
impl crate::RegisterSpec for GPIOH_HWCFGR7rs {
    type Ux = u32;
}
///`read()` method returns [`gpioh_hwcfgr7::R`](R) reader structure
impl crate::Readable for GPIOH_HWCFGR7rs {}
///`reset()` method sets GPIOH_HWCFGR7 to value 0xffff_ffff
impl crate::Resettable for GPIOH_HWCFGR7rs {
