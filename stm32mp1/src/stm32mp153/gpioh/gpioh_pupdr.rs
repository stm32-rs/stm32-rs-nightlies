///Register `GPIOH_PUPDR` reader
pub type R = crate::R<GPIOH_PUPDRrs>;
///Register `GPIOH_PUPDR` writer
...
You can [`read`](crate::Reg::read) this register and get [`gpioh_pupdr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioh_pupdr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOH:GPIOH_PUPDR)*/
pub struct GPIOH_PUPDRrs;
impl crate::RegisterSpec for GPIOH_PUPDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpioh_pupdr::R`](R) reader structure
impl crate::Readable for GPIOH_PUPDRrs {}
///`write(|w| ..)` method takes [`gpioh_pupdr::W`](W) writer structure
impl crate::Writable for GPIOH_PUPDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOH_PUPDR to value 0
