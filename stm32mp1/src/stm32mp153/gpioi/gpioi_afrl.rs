...
pub type R = crate::R<GPIOI_AFRLrs>;
///Register `GPIOI_AFRL` writer
pub type W = crate::W<GPIOI_AFRLrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn afr0(&mut self) -> AFR0_W<GPIOI_AFRLrs> {
        AFR0_W::new(self, 0)
    }
    ///Bits 4:7 - AFR1
    #[inline(always)]
    #[must_use]
    pub fn afr1(&mut self) -> AFR1_W<GPIOI_AFRLrs> {
        AFR1_W::new(self, 4)
    }
    ///Bits 8:11 - AFR2
    #[inline(always)]
    #[must_use]
    pub fn afr2(&mut self) -> AFR2_W<GPIOI_AFRLrs> {
        AFR2_W::new(self, 8)
    }
    ///Bits 12:15 - AFR3
    #[inline(always)]
    #[must_use]
    pub fn afr3(&mut self) -> AFR3_W<GPIOI_AFRLrs> {
        AFR3_W::new(self, 12)
    }
    ///Bits 16:19 - AFR4
    #[inline(always)]
    #[must_use]
    pub fn afr4(&mut self) -> AFR4_W<GPIOI_AFRLrs> {
        AFR4_W::new(self, 16)
    }
    ///Bits 20:23 - AFR5
    #[inline(always)]
    #[must_use]
    pub fn afr5(&mut self) -> AFR5_W<GPIOI_AFRLrs> {
        AFR5_W::new(self, 20)
    }
    ///Bits 24:27 - AFR6
    #[inline(always)]
    #[must_use]
    pub fn afr6(&mut self) -> AFR6_W<GPIOI_AFRLrs> {
        AFR6_W::new(self, 24)
    }
    ///Bits 28:31 - AFR7
    #[inline(always)]
    #[must_use]
    pub fn afr7(&mut self) -> AFR7_W<GPIOI_AFRLrs> {
        AFR7_W::new(self, 28)
    }
}
/**GPIO alternate function low register

You can [`read`](crate::Reg::read) this register and get [`gpioi_afrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioi_afrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOI:GPIOI_AFRL)*/
pub struct GPIOI_AFRLrs;
impl crate::RegisterSpec for GPIOI_AFRLrs {
    type Ux = u32;
}
///`read()` method returns [`gpioi_afrl::R`](R) reader structure
impl crate::Readable for GPIOI_AFRLrs {}
///`write(|w| ..)` method takes [`gpioi_afrl::W`](W) writer structure
impl crate::Writable for GPIOI_AFRLrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOI_AFRL to value 0
impl crate::Resettable for GPIOI_AFRLrs {
