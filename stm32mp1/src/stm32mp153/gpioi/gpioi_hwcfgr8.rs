...
pub type R = crate::R<GPIOI_HWCFGR8rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioi_hwcfgr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOI:GPIOI_HWCFGR8)*/
pub struct GPIOI_HWCFGR8rs;
impl crate::RegisterSpec for GPIOI_HWCFGR8rs {
    type Ux = u32;
}
///`read()` method returns [`gpioi_hwcfgr8::R`](R) reader structure
impl crate::Readable for GPIOI_HWCFGR8rs {}
///`reset()` method sets GPIOI_HWCFGR8 to value 0
impl crate::Resettable for GPIOI_HWCFGR8rs {
