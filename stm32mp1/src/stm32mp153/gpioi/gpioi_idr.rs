///Register `GPIOI_IDR` reader
pub type R = crate::R<GPIOI_IDRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioi_idr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOI:GPIOI_IDR)*/
pub struct GPIOI_IDRrs;
impl crate::RegisterSpec for GPIOI_IDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpioi_idr::R`](R) reader structure
impl crate::Readable for GPIOI_IDRrs {}
///`reset()` method sets GPIOI_IDR to value 0
impl crate::Resettable for GPIOI_IDRrs {
