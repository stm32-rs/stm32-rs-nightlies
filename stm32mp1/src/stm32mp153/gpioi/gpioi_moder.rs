...
pub type R = crate::R<GPIOI_MODERrs>;
///Register `GPIOI_MODER` writer
pub type W = crate::W<GPIOI_MODERrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn moder0(&mut self) -> MODER0_W<GPIOI_MODERrs> {
        MODER0_W::new(self, 0)
    }
    ///Bits 2:3 - MODER1
    #[inline(always)]
    #[must_use]
    pub fn moder1(&mut self) -> MODER1_W<GPIOI_MODERrs> {
        MODER1_W::new(self, 2)
    }
    ///Bits 4:5 - MODER2
    #[inline(always)]
    #[must_use]
    pub fn moder2(&mut self) -> MODER2_W<GPIOI_MODERrs> {
        MODER2_W::new(self, 4)
    }
    ///Bits 6:7 - MODER3
    #[inline(always)]
    #[must_use]
    pub fn moder3(&mut self) -> MODER3_W<GPIOI_MODERrs> {
        MODER3_W::new(self, 6)
    }
    ///Bits 8:9 - MODER4
    #[inline(always)]
    #[must_use]
    pub fn moder4(&mut self) -> MODER4_W<GPIOI_MODERrs> {
        MODER4_W::new(self, 8)
    }
    ///Bits 10:11 - MODER5
    #[inline(always)]
    #[must_use]
    pub fn moder5(&mut self) -> MODER5_W<GPIOI_MODERrs> {
        MODER5_W::new(self, 10)
    }
    ///Bits 12:13 - MODER6
    #[inline(always)]
    #[must_use]
    pub fn moder6(&mut self) -> MODER6_W<GPIOI_MODERrs> {
        MODER6_W::new(self, 12)
    }
    ///Bits 14:15 - MODER7
    #[inline(always)]
    #[must_use]
    pub fn moder7(&mut self) -> MODER7_W<GPIOI_MODERrs> {
        MODER7_W::new(self, 14)
    }
    ///Bits 16:17 - MODER8
    #[inline(always)]
    #[must_use]
    pub fn moder8(&mut self) -> MODER8_W<GPIOI_MODERrs> {
        MODER8_W::new(self, 16)
    }
    ///Bits 18:19 - MODER9
    #[inline(always)]
    #[must_use]
    pub fn moder9(&mut self) -> MODER9_W<GPIOI_MODERrs> {
        MODER9_W::new(self, 18)
    }
    ///Bits 20:21 - MODER10
    #[inline(always)]
    #[must_use]
    pub fn moder10(&mut self) -> MODER10_W<GPIOI_MODERrs> {
        MODER10_W::new(self, 20)
    }
    ///Bits 22:23 - MODER11
    #[inline(always)]
    #[must_use]
    pub fn moder11(&mut self) -> MODER11_W<GPIOI_MODERrs> {
        MODER11_W::new(self, 22)
    }
    ///Bits 24:25 - MODER12
    #[inline(always)]
    #[must_use]
    pub fn moder12(&mut self) -> MODER12_W<GPIOI_MODERrs> {
        MODER12_W::new(self, 24)
    }
    ///Bits 26:27 - MODER13
    #[inline(always)]
    #[must_use]
    pub fn moder13(&mut self) -> MODER13_W<GPIOI_MODERrs> {
        MODER13_W::new(self, 26)
    }
    ///Bits 28:29 - MODER14
    #[inline(always)]
    #[must_use]
    pub fn moder14(&mut self) -> MODER14_W<GPIOI_MODERrs> {
        MODER14_W::new(self, 28)
    }
    ///Bits 30:31 - MODER15
    #[inline(always)]
    #[must_use]
    pub fn moder15(&mut self) -> MODER15_W<GPIOI_MODERrs> {
        MODER15_W::new(self, 30)
    }
}
/**GPIO port mode register

You can [`read`](crate::Reg::read) this register and get [`gpioi_moder::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioi_moder::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOI:GPIOI_MODER)*/
pub struct GPIOI_MODERrs;
impl crate::RegisterSpec for GPIOI_MODERrs {
    type Ux = u32;
}
///`read()` method returns [`gpioi_moder::R`](R) reader structure
impl crate::Readable for GPIOI_MODERrs {}
///`write(|w| ..)` method takes [`gpioi_moder::W`](W) writer structure
impl crate::Writable for GPIOI_MODERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOI_MODER to value 0xffff_ffff
impl crate::Resettable for GPIOI_MODERrs {
