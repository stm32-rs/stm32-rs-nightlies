///Register `GPIOJ_HWCFGR8` reader
pub type R = crate::R<GPIOJ_HWCFGR8rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioj_hwcfgr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOJ:GPIOJ_HWCFGR8)*/
pub struct GPIOJ_HWCFGR8rs;
impl crate::RegisterSpec for GPIOJ_HWCFGR8rs {
    type Ux = u32;
}
///`read()` method returns [`gpioj_hwcfgr8::R`](R) reader structure
impl crate::Readable for GPIOJ_HWCFGR8rs {}
///`reset()` method sets GPIOJ_HWCFGR8 to value 0
impl crate::Resettable for GPIOJ_HWCFGR8rs {
