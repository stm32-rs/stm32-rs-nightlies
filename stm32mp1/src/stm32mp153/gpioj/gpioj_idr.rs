...
You can [`read`](crate::Reg::read) this register and get [`gpioj_idr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`gpioj_idr::R`](R) reader structure
impl crate::Readable for GPIOJ_IDRrs {}
///`reset()` method sets GPIOJ_IDR to value 0
