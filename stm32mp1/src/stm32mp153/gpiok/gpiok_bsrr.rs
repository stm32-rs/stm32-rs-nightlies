...
impl core::fmt::Debug for crate::generic::Reg<GPIOK_BSRRrs> {
...
You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiok_bsrr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOK:GPIOK_BSRR)*/
pub struct GPIOK_BSRRrs;
impl crate::RegisterSpec for GPIOK_BSRRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`gpiok_bsrr::W`](W) writer structure
impl crate::Writable for GPIOK_BSRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOK_BSRR to value 0
