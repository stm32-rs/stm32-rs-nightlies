...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:MODER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:OTYPER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:OSPEEDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:PUPDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:IDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:ODR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:BSRR)

For information about available fields see [`mod@bsrr`] module*/
pub type BSRR = crate::Reg<bsrr::BSRRrs>;
///GPIO port bit set/reset register
pub mod bsrr;
/**LCKR (rw) register accessor: This register is used to lock the configuration of the port bits when a correct write sequence is applied to bit 16 (LCKK). The value of bits \[15:0\] is used to lock the configuration of the GPIO. During the write sequence, the value of LCKR\[15:0\] must not change. When the LOCK sequence has been applied on a port bit, the value of this port bit can no longer be modified until the next MCU reset or peripheral reset. A specific write sequence is used to write to the GPIOx_LCKR register. Only word access (32-bit long) is allowed during this locking sequence. Each lock bit freezes a specific configuration register (control and alternate function registers).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:LCKR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:AFRL)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:AFRH)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:BRR)

For information about available fields see [`mod@brr`] module*/
pub type BRR = crate::Reg<brr::BRRrs>;
///GPIO port bit reset register
pub mod brr;
/**SECCFGR (w) register accessor: This register provides write access security and can be written only by a secure access. It is used to configure a selected I/O as secure. A non-secure write access to this register is discarded.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:SECCFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR10)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR9)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:HWCFGR0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:VERR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:IPIDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#GPIOZ:SIDR)
