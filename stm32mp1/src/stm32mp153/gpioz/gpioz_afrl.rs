...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn afr0(&mut self) -> AFR0_W<GPIOZ_AFRLrs> {
        AFR0_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - AFR1"]
    #[inline(always)]
    #[must_use]
    pub fn afr1(&mut self) -> AFR1_W<GPIOZ_AFRLrs> {
        AFR1_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - AFR2"]
    #[inline(always)]
    #[must_use]
    pub fn afr2(&mut self) -> AFR2_W<GPIOZ_AFRLrs> {
        AFR2_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - AFR3"]
    #[inline(always)]
    #[must_use]
    pub fn afr3(&mut self) -> AFR3_W<GPIOZ_AFRLrs> {
        AFR3_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - AFR4"]
    #[inline(always)]
    #[must_use]
    pub fn afr4(&mut self) -> AFR4_W<GPIOZ_AFRLrs> {
        AFR4_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - AFR5"]
    #[inline(always)]
    #[must_use]
    pub fn afr5(&mut self) -> AFR5_W<GPIOZ_AFRLrs> {
        AFR5_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - AFR6"]
    #[inline(always)]
    #[must_use]
    pub fn afr6(&mut self) -> AFR6_W<GPIOZ_AFRLrs> {
        AFR6_W::new(self, 24)
    }
    #[doc = "Bits 28:31 - AFR7"]
    #[inline(always)]
    #[must_use]
    pub fn afr7(&mut self) -> AFR7_W<GPIOZ_AFRLrs> {
        AFR7_W::new(self, 28)
    }
}
#[doc = "GPIO alternate function low register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpioz_afrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpioz_afrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
