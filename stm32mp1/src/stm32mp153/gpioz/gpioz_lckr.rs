...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lck0(&mut self) -> LCK0_W<GPIOZ_LCKRrs> {
        LCK0_W::new(self, 0)
    }
    #[doc = "Bit 1 - LCK1"]
    #[inline(always)]
    #[must_use]
    pub fn lck1(&mut self) -> LCK1_W<GPIOZ_LCKRrs> {
        LCK1_W::new(self, 1)
    }
    #[doc = "Bit 2 - LCK2"]
    #[inline(always)]
    #[must_use]
    pub fn lck2(&mut self) -> LCK2_W<GPIOZ_LCKRrs> {
        LCK2_W::new(self, 2)
    }
    #[doc = "Bit 3 - LCK3"]
    #[inline(always)]
    #[must_use]
    pub fn lck3(&mut self) -> LCK3_W<GPIOZ_LCKRrs> {
        LCK3_W::new(self, 3)
    }
    #[doc = "Bit 4 - LCK4"]
    #[inline(always)]
    #[must_use]
    pub fn lck4(&mut self) -> LCK4_W<GPIOZ_LCKRrs> {
        LCK4_W::new(self, 4)
    }
    #[doc = "Bit 5 - LCK5"]
    #[inline(always)]
    #[must_use]
    pub fn lck5(&mut self) -> LCK5_W<GPIOZ_LCKRrs> {
        LCK5_W::new(self, 5)
    }
    #[doc = "Bit 6 - LCK6"]
    #[inline(always)]
    #[must_use]
    pub fn lck6(&mut self) -> LCK6_W<GPIOZ_LCKRrs> {
        LCK6_W::new(self, 6)
    }
    #[doc = "Bit 7 - LCK7"]
    #[inline(always)]
    #[must_use]
    pub fn lck7(&mut self) -> LCK7_W<GPIOZ_LCKRrs> {
        LCK7_W::new(self, 7)
    }
    #[doc = "Bit 8 - LCK8"]
    #[inline(always)]
    #[must_use]
    pub fn lck8(&mut self) -> LCK8_W<GPIOZ_LCKRrs> {
        LCK8_W::new(self, 8)
    }
    #[doc = "Bit 9 - LCK9"]
    #[inline(always)]
    #[must_use]
    pub fn lck9(&mut self) -> LCK9_W<GPIOZ_LCKRrs> {
        LCK9_W::new(self, 9)
    }
    #[doc = "Bit 10 - LCK10"]
    #[inline(always)]
    #[must_use]
    pub fn lck10(&mut self) -> LCK10_W<GPIOZ_LCKRrs> {
        LCK10_W::new(self, 10)
    }
    #[doc = "Bit 11 - LCK11"]
    #[inline(always)]
    #[must_use]
    pub fn lck11(&mut self) -> LCK11_W<GPIOZ_LCKRrs> {
        LCK11_W::new(self, 11)
    }
    #[doc = "Bit 12 - LCK12"]
    #[inline(always)]
    #[must_use]
    pub fn lck12(&mut self) -> LCK12_W<GPIOZ_LCKRrs> {
        LCK12_W::new(self, 12)
    }
    #[doc = "Bit 13 - LCK13"]
    #[inline(always)]
    #[must_use]
    pub fn lck13(&mut self) -> LCK13_W<GPIOZ_LCKRrs> {
        LCK13_W::new(self, 13)
    }
    #[doc = "Bit 14 - LCK14"]
    #[inline(always)]
    #[must_use]
    pub fn lck14(&mut self) -> LCK14_W<GPIOZ_LCKRrs> {
        LCK14_W::new(self, 14)
    }
    #[doc = "Bit 15 - LCK15"]
    #[inline(always)]
    #[must_use]
    pub fn lck15(&mut self) -> LCK15_W<GPIOZ_LCKRrs> {
        LCK15_W::new(self, 15)
    }
    #[doc = "Bit 16 - LCKK"]
    #[inline(always)]
    #[must_use]
    pub fn lckk(&mut self) -> LCKK_W<GPIOZ_LCKRrs> {
        LCKK_W::new(self, 16)
    }
}
...
must not change. When the LOCK sequence has been applied on a port bit, the value of this port bit can no longer be modified until the next MCU reset or peripheral reset. A specific write sequence is used to write to the GPIOx_LCKR register. Only word access (32-bit long) is allowed during this locking sequence. Each lock bit freezes a specific configuration register (control and alternate function registers).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpioz_lckr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpioz_lckr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
