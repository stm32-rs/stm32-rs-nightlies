...
impl W {
    ///Bit 0 - ODR0
    #[inline(always)]
    pub fn odr0(&mut self) -> ODR0_W<'_, GPIOZ_ODRrs> {
        ODR0_W::new(self, 0)
    }
    ///Bit 1 - ODR1
    #[inline(always)]
    pub fn odr1(&mut self) -> ODR1_W<'_, GPIOZ_ODRrs> {
        ODR1_W::new(self, 1)
    }
    ///Bit 2 - ODR2
    #[inline(always)]
    pub fn odr2(&mut self) -> ODR2_W<'_, GPIOZ_ODRrs> {
        ODR2_W::new(self, 2)
    }
    ///Bit 3 - ODR3
    #[inline(always)]
    pub fn odr3(&mut self) -> ODR3_W<'_, GPIOZ_ODRrs> {
        ODR3_W::new(self, 3)
    }
    ///Bit 4 - ODR4
    #[inline(always)]
    pub fn odr4(&mut self) -> ODR4_W<'_, GPIOZ_ODRrs> {
        ODR4_W::new(self, 4)
    }
    ///Bit 5 - ODR5
    #[inline(always)]
    pub fn odr5(&mut self) -> ODR5_W<'_, GPIOZ_ODRrs> {
        ODR5_W::new(self, 5)
    }
    ///Bit 6 - ODR6
    #[inline(always)]
    pub fn odr6(&mut self) -> ODR6_W<'_, GPIOZ_ODRrs> {
        ODR6_W::new(self, 6)
    }
    ///Bit 7 - ODR7
    #[inline(always)]
    pub fn odr7(&mut self) -> ODR7_W<'_, GPIOZ_ODRrs> {
        ODR7_W::new(self, 7)
    }
    ///Bit 8 - ODR8
    #[inline(always)]
    pub fn odr8(&mut self) -> ODR8_W<'_, GPIOZ_ODRrs> {
        ODR8_W::new(self, 8)
    }
    ///Bit 9 - ODR9
    #[inline(always)]
    pub fn odr9(&mut self) -> ODR9_W<'_, GPIOZ_ODRrs> {
        ODR9_W::new(self, 9)
    }
    ///Bit 10 - ODR10
    #[inline(always)]
    pub fn odr10(&mut self) -> ODR10_W<'_, GPIOZ_ODRrs> {
        ODR10_W::new(self, 10)
    }
    ///Bit 11 - ODR11
    #[inline(always)]
    pub fn odr11(&mut self) -> ODR11_W<'_, GPIOZ_ODRrs> {
        ODR11_W::new(self, 11)
    }
    ///Bit 12 - ODR12
    #[inline(always)]
    pub fn odr12(&mut self) -> ODR12_W<'_, GPIOZ_ODRrs> {
        ODR12_W::new(self, 12)
    }
    ///Bit 13 - ODR13
    #[inline(always)]
    pub fn odr13(&mut self) -> ODR13_W<'_, GPIOZ_ODRrs> {
        ODR13_W::new(self, 13)
    }
    ///Bit 14 - ODR14
    #[inline(always)]
    pub fn odr14(&mut self) -> ODR14_W<'_, GPIOZ_ODRrs> {
        ODR14_W::new(self, 14)
    }
    ///Bit 15 - ODR15
    #[inline(always)]
    pub fn odr15(&mut self) -> ODR15_W<'_, GPIOZ_ODRrs> {
        ODR15_W::new(self, 15)
    }
}
