...
impl W {
    ///Bits 0:1 - OSPEEDR0
    #[inline(always)]
    pub fn ospeedr0(&mut self) -> OSPEEDR0_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR0_W::new(self, 0)
    }
    ///Bits 2:3 - OSPEEDR1
    #[inline(always)]
    pub fn ospeedr1(&mut self) -> OSPEEDR1_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR1_W::new(self, 2)
    }
    ///Bits 4:5 - OSPEEDR2
    #[inline(always)]
    pub fn ospeedr2(&mut self) -> OSPEEDR2_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR2_W::new(self, 4)
    }
    ///Bits 6:7 - OSPEEDR3
    #[inline(always)]
    pub fn ospeedr3(&mut self) -> OSPEEDR3_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR3_W::new(self, 6)
    }
    ///Bits 8:9 - OSPEEDR4
    #[inline(always)]
    pub fn ospeedr4(&mut self) -> OSPEEDR4_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR4_W::new(self, 8)
    }
    ///Bits 10:11 - OSPEEDR5
    #[inline(always)]
    pub fn ospeedr5(&mut self) -> OSPEEDR5_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR5_W::new(self, 10)
    }
    ///Bits 12:13 - OSPEEDR6
    #[inline(always)]
    pub fn ospeedr6(&mut self) -> OSPEEDR6_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR6_W::new(self, 12)
    }
    ///Bits 14:15 - OSPEEDR7
    #[inline(always)]
    pub fn ospeedr7(&mut self) -> OSPEEDR7_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR7_W::new(self, 14)
    }
    ///Bits 16:17 - OSPEEDR8
    #[inline(always)]
    pub fn ospeedr8(&mut self) -> OSPEEDR8_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR8_W::new(self, 16)
    }
    ///Bits 18:19 - OSPEEDR9
    #[inline(always)]
    pub fn ospeedr9(&mut self) -> OSPEEDR9_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR9_W::new(self, 18)
    }
    ///Bits 20:21 - OSPEEDR10
    #[inline(always)]
    pub fn ospeedr10(&mut self) -> OSPEEDR10_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR10_W::new(self, 20)
    }
    ///Bits 22:23 - OSPEEDR11
    #[inline(always)]
    pub fn ospeedr11(&mut self) -> OSPEEDR11_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR11_W::new(self, 22)
    }
    ///Bits 24:25 - OSPEEDR12
    #[inline(always)]
    pub fn ospeedr12(&mut self) -> OSPEEDR12_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR12_W::new(self, 24)
    }
    ///Bits 26:27 - OSPEEDR13
    #[inline(always)]
    pub fn ospeedr13(&mut self) -> OSPEEDR13_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR13_W::new(self, 26)
    }
    ///Bits 28:29 - OSPEEDR14
    #[inline(always)]
    pub fn ospeedr14(&mut self) -> OSPEEDR14_W<'_, GPIOZ_OSPEEDRrs> {
        OSPEEDR14_W::new(self, 28)
    }
    ///Bits 30:31 - OSPEEDR15
    #[inline(always)]
    pub fn ospeedr15(&mut self) -> OSPEEDR15_W<'_, GPIOZ_OSPEEDRrs> {
