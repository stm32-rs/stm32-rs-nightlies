...
impl W {
    ///Bit 0 - OT0
    #[inline(always)]
    pub fn ot0(&mut self) -> OT0_W<'_, GPIOZ_OTYPERrs> {
        OT0_W::new(self, 0)
    }
    ///Bit 1 - OT1
    #[inline(always)]
    pub fn ot1(&mut self) -> OT1_W<'_, GPIOZ_OTYPERrs> {
        OT1_W::new(self, 1)
    }
    ///Bit 2 - OT2
    #[inline(always)]
    pub fn ot2(&mut self) -> OT2_W<'_, GPIOZ_OTYPERrs> {
        OT2_W::new(self, 2)
    }
    ///Bit 3 - OT3
    #[inline(always)]
    pub fn ot3(&mut self) -> OT3_W<'_, GPIOZ_OTYPERrs> {
        OT3_W::new(self, 3)
    }
    ///Bit 4 - OT4
    #[inline(always)]
    pub fn ot4(&mut self) -> OT4_W<'_, GPIOZ_OTYPERrs> {
        OT4_W::new(self, 4)
    }
    ///Bit 5 - OT5
    #[inline(always)]
    pub fn ot5(&mut self) -> OT5_W<'_, GPIOZ_OTYPERrs> {
        OT5_W::new(self, 5)
    }
    ///Bit 6 - OT6
    #[inline(always)]
    pub fn ot6(&mut self) -> OT6_W<'_, GPIOZ_OTYPERrs> {
        OT6_W::new(self, 6)
    }
    ///Bit 7 - OT7
    #[inline(always)]
    pub fn ot7(&mut self) -> OT7_W<'_, GPIOZ_OTYPERrs> {
        OT7_W::new(self, 7)
    }
    ///Bit 8 - OT8
    #[inline(always)]
    pub fn ot8(&mut self) -> OT8_W<'_, GPIOZ_OTYPERrs> {
        OT8_W::new(self, 8)
    }
    ///Bit 9 - OT9
    #[inline(always)]
    pub fn ot9(&mut self) -> OT9_W<'_, GPIOZ_OTYPERrs> {
        OT9_W::new(self, 9)
    }
    ///Bit 10 - OT10
    #[inline(always)]
    pub fn ot10(&mut self) -> OT10_W<'_, GPIOZ_OTYPERrs> {
        OT10_W::new(self, 10)
    }
    ///Bit 11 - OT11
    #[inline(always)]
    pub fn ot11(&mut self) -> OT11_W<'_, GPIOZ_OTYPERrs> {
        OT11_W::new(self, 11)
    }
    ///Bit 12 - OT12
    #[inline(always)]
    pub fn ot12(&mut self) -> OT12_W<'_, GPIOZ_OTYPERrs> {
        OT12_W::new(self, 12)
    }
    ///Bit 13 - OT13
    #[inline(always)]
    pub fn ot13(&mut self) -> OT13_W<'_, GPIOZ_OTYPERrs> {
        OT13_W::new(self, 13)
    }
    ///Bit 14 - OT14
    #[inline(always)]
    pub fn ot14(&mut self) -> OT14_W<'_, GPIOZ_OTYPERrs> {
        OT14_W::new(self, 14)
    }
    ///Bit 15 - OT15
    #[inline(always)]
    pub fn ot15(&mut self) -> OT15_W<'_, GPIOZ_OTYPERrs> {
        OT15_W::new(self, 15)
    }
}
