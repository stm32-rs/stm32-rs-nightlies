...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pupdr0(&mut self) -> PUPDR0_W<GPIOZ_PUPDRrs> {
        PUPDR0_W::new(self, 0)
    }
    ///Bits 2:3 - PUPDR1
    #[inline(always)]
    #[must_use]
    pub fn pupdr1(&mut self) -> PUPDR1_W<GPIOZ_PUPDRrs> {
        PUPDR1_W::new(self, 2)
    }
    ///Bits 4:5 - PUPDR2
    #[inline(always)]
    #[must_use]
    pub fn pupdr2(&mut self) -> PUPDR2_W<GPIOZ_PUPDRrs> {
        PUPDR2_W::new(self, 4)
    }
    ///Bits 6:7 - PUPDR3
    #[inline(always)]
    #[must_use]
    pub fn pupdr3(&mut self) -> PUPDR3_W<GPIOZ_PUPDRrs> {
        PUPDR3_W::new(self, 6)
    }
    ///Bits 8:9 - PUPDR4
    #[inline(always)]
    #[must_use]
    pub fn pupdr4(&mut self) -> PUPDR4_W<GPIOZ_PUPDRrs> {
        PUPDR4_W::new(self, 8)
    }
    ///Bits 10:11 - PUPDR5
    #[inline(always)]
    #[must_use]
    pub fn pupdr5(&mut self) -> PUPDR5_W<GPIOZ_PUPDRrs> {
        PUPDR5_W::new(self, 10)
    }
    ///Bits 12:13 - PUPDR6
    #[inline(always)]
    #[must_use]
    pub fn pupdr6(&mut self) -> PUPDR6_W<GPIOZ_PUPDRrs> {
        PUPDR6_W::new(self, 12)
    }
    ///Bits 14:15 - PUPDR7
    #[inline(always)]
    #[must_use]
    pub fn pupdr7(&mut self) -> PUPDR7_W<GPIOZ_PUPDRrs> {
        PUPDR7_W::new(self, 14)
    }
    ///Bits 16:17 - PUPDR8
    #[inline(always)]
    #[must_use]
    pub fn pupdr8(&mut self) -> PUPDR8_W<GPIOZ_PUPDRrs> {
        PUPDR8_W::new(self, 16)
    }
    ///Bits 18:19 - PUPDR9
    #[inline(always)]
    #[must_use]
    pub fn pupdr9(&mut self) -> PUPDR9_W<GPIOZ_PUPDRrs> {
        PUPDR9_W::new(self, 18)
    }
    ///Bits 20:21 - PUPDR10
    #[inline(always)]
    #[must_use]
    pub fn pupdr10(&mut self) -> PUPDR10_W<GPIOZ_PUPDRrs> {
        PUPDR10_W::new(self, 20)
    }
    ///Bits 22:23 - PUPDR11
    #[inline(always)]
    #[must_use]
    pub fn pupdr11(&mut self) -> PUPDR11_W<GPIOZ_PUPDRrs> {
        PUPDR11_W::new(self, 22)
    }
    ///Bits 24:25 - PUPDR12
    #[inline(always)]
    #[must_use]
    pub fn pupdr12(&mut self) -> PUPDR12_W<GPIOZ_PUPDRrs> {
        PUPDR12_W::new(self, 24)
    }
    ///Bits 26:27 - PUPDR13
    #[inline(always)]
    #[must_use]
    pub fn pupdr13(&mut self) -> PUPDR13_W<GPIOZ_PUPDRrs> {
        PUPDR13_W::new(self, 26)
    }
    ///Bits 28:29 - PUPDR14
    #[inline(always)]
    #[must_use]
    pub fn pupdr14(&mut self) -> PUPDR14_W<GPIOZ_PUPDRrs> {
        PUPDR14_W::new(self, 28)
    }
    ///Bits 30:31 - PUPDR15
    #[inline(always)]
    #[must_use]
    pub fn pupdr15(&mut self) -> PUPDR15_W<GPIOZ_PUPDRrs> {
