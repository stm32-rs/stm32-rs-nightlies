...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CR)
...
pub mod hash_cr;
/**HASH_DIN (rw) register accessor: HASH_DIN is the data input register.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_DIN)
...
pub mod hash_din;
/**HASH_STR (rw) register accessor: The HASH_STR register has two functions: It is used to define the number of valid bits in the last word of the message entered in the hash processor (that is the number of valid least significant bits in the last data written to the HASH_DIN register) It is used to start the processing of the last block in the message by writing the DCAL bit to 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_STR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_HR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_HR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_HR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_HR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_SR)
...
pub mod hash_sr;
/**HASH_CSR0 (rw) register accessor: These registers contain the complete internal register states of the hash processor. They are useful when a context swap has to be done because a high-priority task needs to use the hash processor while it is already used by another task. When such an event occurs, the HASH_CSRx registers have to be read and the read values have to be saved in the system memory space. Then the hash processor can be used by the preemptive task, and when the hash computation is complete, the saved context can be read from memory and written back into the HASH_CSRx registers.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR0)
...
pub mod hash_csr0;
/**HASH_CSR1 (rw) register accessor: HASH context swap registers
...
pub mod hash_csr1;
/**HASH_CSR2 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR2)
...
///HASH context swap registers
pub mod hash_csr2;
/**HASH_CSR3 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr3;
/**HASH_CSR4 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR4)
...
///HASH context swap registers
pub mod hash_csr4;
/**HASH_CSR5 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR5)
...
///HASH context swap registers
pub mod hash_csr5;
/**HASH_CSR6 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR6)
...
///HASH context swap registers
pub mod hash_csr6;
/**HASH_CSR7 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR7)
...
///HASH context swap registers
pub mod hash_csr7;
/**HASH_CSR8 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR8)
...
///HASH context swap registers
pub mod hash_csr8;
/**HASH_CSR9 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr9;
/**HASH_CSR10 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR10)
...
///HASH context swap registers
pub mod hash_csr10;
/**HASH_CSR11 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR11)
...
///HASH context swap registers
pub mod hash_csr11;
/**HASH_CSR12 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR12)
...
///HASH context swap registers
pub mod hash_csr12;
/**HASH_CSR13 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr13;
/**HASH_CSR14 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR14)
...
///HASH context swap registers
pub mod hash_csr14;
/**HASH_CSR15 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR15)
...
///HASH context swap registers
pub mod hash_csr15;
/**HASH_CSR16 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr16;
/**HASH_CSR17 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR17)
...
///HASH context swap registers
pub mod hash_csr17;
/**HASH_CSR18 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR18)
...
///HASH context swap registers
pub mod hash_csr18;
/**HASH_CSR19 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR19)
...
///HASH context swap registers
pub mod hash_csr19;
/**HASH_CSR20 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR20)
...
///HASH context swap registers
pub mod hash_csr20;
/**HASH_CSR21 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr21;
/**HASH_CSR22 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR22)
...
///HASH context swap registers
pub mod hash_csr22;
/**HASH_CSR23 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr23;
/**HASH_CSR24 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR24)
...
///HASH context swap registers
pub mod hash_csr24;
/**HASH_CSR25 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr25;
/**HASH_CSR26 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR26)
...
///HASH context swap registers
pub mod hash_csr26;
/**HASH_CSR27 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR27)
...
///HASH context swap registers
pub mod hash_csr27;
/**HASH_CSR28 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR28)
...
///HASH context swap registers
pub mod hash_csr28;
/**HASH_CSR29 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR29)
...
///HASH context swap registers
pub mod hash_csr29;
/**HASH_CSR30 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR30)
...
///HASH context swap registers
pub mod hash_csr30;
/**HASH_CSR31 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr31;
/**HASH_CSR32 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr32;
/**HASH_CSR33 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr33;
/**HASH_CSR34 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR34)
...
///HASH context swap registers
pub mod hash_csr34;
/**HASH_CSR35 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr35;
/**HASH_CSR36 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR36)
...
///HASH context swap registers
pub mod hash_csr36;
/**HASH_CSR37 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR37)
...
///HASH context swap registers
pub mod hash_csr37;
/**HASH_CSR38 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr38;
/**HASH_CSR39 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr39;
/**HASH_CSR40 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR40)
...
///HASH context swap registers
pub mod hash_csr40;
/**HASH_CSR41 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr41;
/**HASH_CSR42 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr42;
/**HASH_CSR43 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr43;
/**HASH_CSR44 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR44)
...
///HASH context swap registers
pub mod hash_csr44;
/**HASH_CSR45 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR45)
...
///HASH context swap registers
pub mod hash_csr45;
/**HASH_CSR46 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr46;
/**HASH_CSR47 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr47;
/**HASH_CSR48 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr48;
/**HASH_CSR49 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR49)
...
///HASH context swap registers
pub mod hash_csr49;
/**HASH_CSR50 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR50)
...
///HASH context swap registers
pub mod hash_csr50;
/**HASH_CSR51 (rw) register accessor: HASH context swap registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_CSR51)
...
///HASH context swap registers
pub mod hash_csr51;
/**HASH_CSR52 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr52;
/**HASH_CSR53 (rw) register accessor: HASH context swap registers
...
///HASH context swap registers
pub mod hash_csr53;
/**HASH_HR5 (r) register accessor: HASH digest register 5
...
pub mod hash_hr5;
/**HASH_HR6 (r) register accessor: HASH digest register 6

You can [`read`](crate::Reg::read) this register and get [`hash_hr6::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_HR6)
...
pub mod hash_hr6;
/**HASH_HR7 (r) register accessor: HASH digest register 7

You can [`read`](crate::Reg::read) this register and get [`hash_hr7::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_HR7)
...
pub mod hash_hr7;
/**HASH_HWCFGR (r) register accessor: HASH Hardware Configuration Register

You can [`read`](crate::Reg::read) this register and get [`hash_hwcfgr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_HWCFGR)
...
pub mod hash_hwcfgr;
/**HASH_VERR (r) register accessor: HASH Version Register

You can [`read`](crate::Reg::read) this register and get [`hash_verr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_VERR)
...
pub mod hash_verr;
/**HASH_IPIDR (r) register accessor: HASH Identification

You can [`read`](crate::Reg::read) this register and get [`hash_ipidr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_IPIDR)
...
///HASH Identification
pub mod hash_ipidr;
/**HASH_MID (r) register accessor: HASH Hardware Magic ID

You can [`read`](crate::Reg::read) this register and get [`hash_mid::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HASH1:HASH_MID)
