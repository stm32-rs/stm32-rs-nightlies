...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HDMI_CEC:CFGR)
...
pub mod cfgr;
/**TXDR (rw) register accessor: CEC Tx data register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HDMI_CEC:RXDR)
