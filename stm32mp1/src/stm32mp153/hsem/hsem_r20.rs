...
pub type R = crate::R<HSEM_R20rs>;
#[doc = "Register `HSEM_R20` writer"]
pub type W = crate::W<HSEM_R20rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn procid(&mut self) -> PROCID_W<HSEM_R20rs> {
        PROCID_W::new(self, 0)
    }
    #[doc = "Bits 8:11 - COREID"]
    #[inline(always)]
    #[must_use]
    pub fn coreid(&mut self) -> COREID_W<HSEM_R20rs> {
        COREID_W::new(self, 8)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<HSEM_R20rs> {
        LOCK_W::new(self, 31)
    }
}
#[doc = "The HSEM_Rx shall be used to perform a 2-step Write lock and Read back. Only Write accesses with authorized AHB bus master IDs are granted. Write accesses with unauthorized AHB bus master IDs are discarded.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hsem_r20::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hsem_r20::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSEM_R20rs;
impl crate::RegisterSpec for HSEM_R20rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsem_r20::R`](R) reader structure"]
impl crate::Readable for HSEM_R20rs {}
#[doc = "`write(|w| ..)` method takes [`hsem_r20::W`](W) writer structure"]
impl crate::Writable for HSEM_R20rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSEM_R20 to value 0"]
impl crate::Resettable for HSEM_R20rs {
