...
pub type R = crate::R<HSEM_RLR0rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR0)*/
pub struct HSEM_RLR0rs;
impl crate::RegisterSpec for HSEM_RLR0rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr0::R`](R) reader structure
impl crate::Readable for HSEM_RLR0rs {}
///`reset()` method sets HSEM_RLR0 to value 0
impl crate::Resettable for HSEM_RLR0rs {
