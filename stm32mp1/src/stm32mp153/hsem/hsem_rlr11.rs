///Register `HSEM_RLR11` reader
pub type R = crate::R<HSEM_RLR11rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR11)*/
pub struct HSEM_RLR11rs;
impl crate::RegisterSpec for HSEM_RLR11rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr11::R`](R) reader structure
impl crate::Readable for HSEM_RLR11rs {}
///`reset()` method sets HSEM_RLR11 to value 0
impl crate::Resettable for HSEM_RLR11rs {
