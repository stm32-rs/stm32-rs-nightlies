///Register `HSEM_RLR12` reader
pub type R = crate::R<HSEM_RLR12rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR12)*/
pub struct HSEM_RLR12rs;
impl crate::RegisterSpec for HSEM_RLR12rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr12::R`](R) reader structure
impl crate::Readable for HSEM_RLR12rs {}
///`reset()` method sets HSEM_RLR12 to value 0
impl crate::Resettable for HSEM_RLR12rs {
