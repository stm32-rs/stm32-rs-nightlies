///Register `HSEM_RLR13` reader
pub type R = crate::R<HSEM_RLR13rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR13)*/
pub struct HSEM_RLR13rs;
impl crate::RegisterSpec for HSEM_RLR13rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr13::R`](R) reader structure
impl crate::Readable for HSEM_RLR13rs {}
///`reset()` method sets HSEM_RLR13 to value 0
impl crate::Resettable for HSEM_RLR13rs {
