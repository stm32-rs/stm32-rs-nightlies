///Register `HSEM_RLR14` reader
pub type R = crate::R<HSEM_RLR14rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR14)*/
pub struct HSEM_RLR14rs;
impl crate::RegisterSpec for HSEM_RLR14rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr14::R`](R) reader structure
impl crate::Readable for HSEM_RLR14rs {}
///`reset()` method sets HSEM_RLR14 to value 0
impl crate::Resettable for HSEM_RLR14rs {
