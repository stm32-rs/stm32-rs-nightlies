///Register `HSEM_RLR17` reader
pub type R = crate::R<HSEM_RLR17rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR17)*/
pub struct HSEM_RLR17rs;
impl crate::RegisterSpec for HSEM_RLR17rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr17::R`](R) reader structure
impl crate::Readable for HSEM_RLR17rs {}
///`reset()` method sets HSEM_RLR17 to value 0
impl crate::Resettable for HSEM_RLR17rs {
