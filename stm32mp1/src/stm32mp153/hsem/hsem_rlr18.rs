///Register `HSEM_RLR18` reader
pub type R = crate::R<HSEM_RLR18rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR18)*/
pub struct HSEM_RLR18rs;
impl crate::RegisterSpec for HSEM_RLR18rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr18::R`](R) reader structure
impl crate::Readable for HSEM_RLR18rs {}
///`reset()` method sets HSEM_RLR18 to value 0
impl crate::Resettable for HSEM_RLR18rs {
