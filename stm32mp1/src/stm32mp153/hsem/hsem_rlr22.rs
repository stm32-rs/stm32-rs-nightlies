...
pub type R = crate::R<HSEM_RLR22rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR22)*/
pub struct HSEM_RLR22rs;
impl crate::RegisterSpec for HSEM_RLR22rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr22::R`](R) reader structure
impl crate::Readable for HSEM_RLR22rs {}
///`reset()` method sets HSEM_RLR22 to value 0
impl crate::Resettable for HSEM_RLR22rs {
