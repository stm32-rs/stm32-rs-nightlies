///Register `HSEM_RLR25` reader
pub type R = crate::R<HSEM_RLR25rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR25)*/
pub struct HSEM_RLR25rs;
impl crate::RegisterSpec for HSEM_RLR25rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr25::R`](R) reader structure
impl crate::Readable for HSEM_RLR25rs {}
///`reset()` method sets HSEM_RLR25 to value 0
impl crate::Resettable for HSEM_RLR25rs {
