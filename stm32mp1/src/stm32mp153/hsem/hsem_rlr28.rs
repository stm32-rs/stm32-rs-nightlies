///Register `HSEM_RLR28` reader
pub type R = crate::R<HSEM_RLR28rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR28)*/
pub struct HSEM_RLR28rs;
impl crate::RegisterSpec for HSEM_RLR28rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr28::R`](R) reader structure
impl crate::Readable for HSEM_RLR28rs {}
///`reset()` method sets HSEM_RLR28 to value 0
impl crate::Resettable for HSEM_RLR28rs {
