///Register `HSEM_RLR29` reader
pub type R = crate::R<HSEM_RLR29rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR29)*/
pub struct HSEM_RLR29rs;
impl crate::RegisterSpec for HSEM_RLR29rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr29::R`](R) reader structure
impl crate::Readable for HSEM_RLR29rs {}
///`reset()` method sets HSEM_RLR29 to value 0
impl crate::Resettable for HSEM_RLR29rs {
