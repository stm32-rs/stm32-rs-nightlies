///Register `HSEM_RLR3` reader
pub type R = crate::R<HSEM_RLR3rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR3)*/
pub struct HSEM_RLR3rs;
impl crate::RegisterSpec for HSEM_RLR3rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr3::R`](R) reader structure
impl crate::Readable for HSEM_RLR3rs {}
///`reset()` method sets HSEM_RLR3 to value 0
impl crate::Resettable for HSEM_RLR3rs {
