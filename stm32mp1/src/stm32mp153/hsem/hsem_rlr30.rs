///Register `HSEM_RLR30` reader
pub type R = crate::R<HSEM_RLR30rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR30)*/
pub struct HSEM_RLR30rs;
impl crate::RegisterSpec for HSEM_RLR30rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr30::R`](R) reader structure
impl crate::Readable for HSEM_RLR30rs {}
///`reset()` method sets HSEM_RLR30 to value 0
impl crate::Resettable for HSEM_RLR30rs {
