///Register `HSEM_RLR5` reader
pub type R = crate::R<HSEM_RLR5rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR5)*/
pub struct HSEM_RLR5rs;
impl crate::RegisterSpec for HSEM_RLR5rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr5::R`](R) reader structure
impl crate::Readable for HSEM_RLR5rs {}
///`reset()` method sets HSEM_RLR5 to value 0
impl crate::Resettable for HSEM_RLR5rs {
