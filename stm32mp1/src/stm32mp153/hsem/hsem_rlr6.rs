...
pub type R = crate::R<HSEM_RLR6rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR6)*/
pub struct HSEM_RLR6rs;
impl crate::RegisterSpec for HSEM_RLR6rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr6::R`](R) reader structure
impl crate::Readable for HSEM_RLR6rs {}
///`reset()` method sets HSEM_RLR6 to value 0
impl crate::Resettable for HSEM_RLR6rs {
