///Register `HSEM_RLR9` reader
pub type R = crate::R<HSEM_RLR9rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:HSEM_RLR9)*/
pub struct HSEM_RLR9rs;
impl crate::RegisterSpec for HSEM_RLR9rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr9::R`](R) reader structure
impl crate::Readable for HSEM_RLR9rs {}
///`reset()` method sets HSEM_RLR9 to value 0
impl crate::Resettable for HSEM_RLR9rs {
