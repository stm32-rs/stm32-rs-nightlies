///Register `R18` reader
pub type R = crate::R<R18rs>;
///Register `R18` writer
pub type W = crate::W<R18rs>;
...
impl W {
    ///Bits 0:7 - PROCID
    #[inline(always)]
    pub fn procid(&mut self) -> PROCID_W<'_, R18rs> {
        PROCID_W::new(self, 0)
    }
    ///Bits 8:11 - COREID
    #[inline(always)]
    pub fn coreid(&mut self) -> COREID_W<'_, R18rs> {
        COREID_W::new(self, 8)
    }
    ///Bit 31 - LOCK
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<'_, R18rs> {
        LOCK_W::new(self, 31)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`r18::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r18::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:R18)*/
pub struct R18rs;
impl crate::RegisterSpec for R18rs {
    type Ux = u32;
}
///`read()` method returns [`r18::R`](R) reader structure
impl crate::Readable for R18rs {}
///`write(|w| ..)` method takes [`r18::W`](W) writer structure
impl crate::Writable for R18rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets R18 to value 0
impl crate::Resettable for R18rs {}
