///Register `R5` reader
pub type R = crate::R<R5rs>;
///Register `R5` writer
pub type W = crate::W<R5rs>;
...
impl W {
    ///Bits 0:7 - PROCID
    #[inline(always)]
    pub fn procid(&mut self) -> PROCID_W<'_, R5rs> {
        PROCID_W::new(self, 0)
    }
    ///Bits 8:11 - COREID
    #[inline(always)]
    pub fn coreid(&mut self) -> COREID_W<'_, R5rs> {
        COREID_W::new(self, 8)
    }
    ///Bit 31 - LOCK
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<'_, R5rs> {
        LOCK_W::new(self, 31)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`r5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:R5)*/
pub struct R5rs;
impl crate::RegisterSpec for R5rs {
    type Ux = u32;
}
///`read()` method returns [`r5::R`](R) reader structure
impl crate::Readable for R5rs {}
///`write(|w| ..)` method takes [`r5::W`](W) writer structure
impl crate::Writable for R5rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets R5 to value 0
impl crate::Resettable for R5rs {}
