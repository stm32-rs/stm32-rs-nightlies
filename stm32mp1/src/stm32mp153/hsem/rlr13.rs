...
You can [`read`](crate::Reg::read) this register and get [`rlr13::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:RLR13)*/
pub struct RLR13rs;
impl crate::RegisterSpec for RLR13rs {
    type Ux = u32;
}
///`read()` method returns [`rlr13::R`](R) reader structure
impl crate::Readable for RLR13rs {}
///`reset()` method sets RLR13 to value 0
impl crate::Resettable for RLR13rs {}
