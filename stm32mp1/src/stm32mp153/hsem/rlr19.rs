///Register `RLR19` reader
pub type R = crate::R<RLR19rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr19::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:RLR19)*/
pub struct RLR19rs;
impl crate::RegisterSpec for RLR19rs {
    type Ux = u32;
}
///`read()` method returns [`rlr19::R`](R) reader structure
impl crate::Readable for RLR19rs {}
///`reset()` method sets RLR19 to value 0
impl crate::Resettable for RLR19rs {}
