///Register `RLR27` reader
pub type R = crate::R<RLR27rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr27::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:RLR27)*/
pub struct RLR27rs;
impl crate::RegisterSpec for RLR27rs {
    type Ux = u32;
}
///`read()` method returns [`rlr27::R`](R) reader structure
impl crate::Readable for RLR27rs {}
///`reset()` method sets RLR27 to value 0
impl crate::Resettable for RLR27rs {}
