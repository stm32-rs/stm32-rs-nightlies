///Register `RLR29` reader
pub type R = crate::R<RLR29rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr29::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:RLR29)*/
pub struct RLR29rs;
impl crate::RegisterSpec for RLR29rs {
    type Ux = u32;
}
///`read()` method returns [`rlr29::R`](R) reader structure
impl crate::Readable for RLR29rs {}
///`reset()` method sets RLR29 to value 0
impl crate::Resettable for RLR29rs {}
