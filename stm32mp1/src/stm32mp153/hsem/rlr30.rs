///Register `RLR30` reader
pub type R = crate::R<RLR30rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr30::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:RLR30)*/
pub struct RLR30rs;
impl crate::RegisterSpec for RLR30rs {
    type Ux = u32;
}
///`read()` method returns [`rlr30::R`](R) reader structure
impl crate::Readable for RLR30rs {}
///`reset()` method sets RLR30 to value 0
impl crate::Resettable for RLR30rs {}
