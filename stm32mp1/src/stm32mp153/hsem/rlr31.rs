///Register `RLR31` reader
pub type R = crate::R<RLR31rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr31::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#HSEM:RLR31)*/
pub struct RLR31rs;
impl crate::RegisterSpec for RLR31rs {
    type Ux = u32;
}
///`read()` method returns [`rlr31::R`](R) reader structure
impl crate::Readable for RLR31rs {}
///`reset()` method sets RLR31 to value 0
impl crate::Resettable for RLR31rs {}
