...
You can [`read`](crate::Reg::read) this register and get [`lptim_cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lptim_cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#LPTIM1:LPTIM_CR)*/
pub struct LPTIM_CRrs;
impl crate::RegisterSpec for LPTIM_CRrs {
    type Ux = u32;
}
///`read()` method returns [`lptim_cr::R`](R) reader structure
impl crate::Readable for LPTIM_CRrs {}
///`write(|w| ..)` method takes [`lptim_cr::W`](W) writer structure
impl crate::Writable for LPTIM_CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPTIM_CR to value 0
