...
You can [`read`](crate::Reg::read) this register and get [`lptim_verr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#LPTIM1:LPTIM_VERR)*/
pub struct LPTIM_VERRrs;
impl crate::RegisterSpec for LPTIM_VERRrs {
    type Ux = u32;
}
///`read()` method returns [`lptim_verr::R`](R) reader structure
impl crate::Readable for LPTIM_VERRrs {}
///`reset()` method sets LPTIM_VERR to value 0x14
