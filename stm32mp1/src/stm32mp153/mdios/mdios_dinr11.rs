...
pub type R = crate::R<MDIOS_DINR11rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDIOS:MDIOS_DINR11)*/
pub struct MDIOS_DINR11rs;
impl crate::RegisterSpec for MDIOS_DINR11rs {
    type Ux = u32;
}
///`read()` method returns [`mdios_dinr11::R`](R) reader structure
impl crate::Readable for MDIOS_DINR11rs {}
///`reset()` method sets MDIOS_DINR11 to value 0
impl crate::Resettable for MDIOS_DINR11rs {
