...
pub type R = crate::R<MDIOS_DINR20rs>;
...
pub struct MDIOS_DINR20rs;
impl crate::RegisterSpec for MDIOS_DINR20rs {
    type Ux = u32;
}
///`read()` method returns [`mdios_dinr20::R`](R) reader structure
impl crate::Readable for MDIOS_DINR20rs {}
///`reset()` method sets MDIOS_DINR20 to value 0
impl crate::Resettable for MDIOS_DINR20rs {
