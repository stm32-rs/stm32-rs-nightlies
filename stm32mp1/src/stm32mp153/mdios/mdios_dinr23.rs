...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDIOS:MDIOS_DINR23)*/
pub struct MDIOS_DINR23rs;
impl crate::RegisterSpec for MDIOS_DINR23rs {
    type Ux = u32;
}
///`read()` method returns [`mdios_dinr23::R`](R) reader structure
impl crate::Readable for MDIOS_DINR23rs {}
///`reset()` method sets MDIOS_DINR23 to value 0
