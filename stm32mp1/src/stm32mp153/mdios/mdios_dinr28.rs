...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDIOS:MDIOS_DINR28)*/
pub struct MDIOS_DINR28rs;
impl crate::RegisterSpec for MDIOS_DINR28rs {
    type Ux = u32;
}
///`read()` method returns [`mdios_dinr28::R`](R) reader structure
impl crate::Readable for MDIOS_DINR28rs {}
///`reset()` method sets MDIOS_DINR28 to value 0
