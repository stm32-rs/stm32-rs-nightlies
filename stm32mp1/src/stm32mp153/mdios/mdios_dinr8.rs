...
pub type R = crate::R<MDIOS_DINR8rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDIOS:MDIOS_DINR8)*/
pub struct MDIOS_DINR8rs;
impl crate::RegisterSpec for MDIOS_DINR8rs {
    type Ux = u32;
}
///`read()` method returns [`mdios_dinr8::R`](R) reader structure
impl crate::Readable for MDIOS_DINR8rs {}
///`reset()` method sets MDIOS_DINR8 to value 0
impl crate::Resettable for MDIOS_DINR8rs {
