...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:GISR0)
...
For information about available fields see [`mod@sgisr0`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C0ISR)

For information about available fields see [`mod@c0isr`]
module*/
...
For information about available fields see [`mod@c0ifcr`]
module*/
...
For information about available fields see [`mod@c0esr`]
module*/
...
pub mod c0cr;
/**C0TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C0TCR)

For information about available fields see [`mod@c0tcr`]
module*/
...
+ 0x00).*/
pub mod c0tcr;
/**C0BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C0BNDTR)

For information about available fields see [`mod@c0bndtr`]
module*/
...
+ 0x04).*/
pub mod c0bndtr;
/**C0SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
+ 0x08).*/
pub mod c0sar;
/**C0DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C0DAR)
...
+ 0x0C). M*/
pub mod c0dar;
/**C0BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C0BRUR)

For information about available fields see [`mod@c0brur`]
module*/
pub type C0BRUR = crate::Reg<c0brur::C0BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c0brur;
/**C0LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C0LAR)

For information about available fields see [`mod@c0lar`]
module*/
pub type C0LAR = crate::Reg<c0lar::C0LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c0lar;
/**C0TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c0tbr`]
module*/
pub type C0TBR = crate::Reg<c0tbr::C0TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c0tbr;
/**C0MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C0MAR)

For information about available fields see [`mod@c0mar`]
module*/
pub type C0MAR = crate::Reg<c0mar::C0MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c0mar;
/**C0MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c0mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C1ISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C1IFCR)

For information about available fields see [`mod@c1ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C1ESR)

For information about available fields see [`mod@c1esr`]
module*/
...
///This register is used to control the concerned channel.
pub mod c1cr;
/**C1TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C1TCR)

For information about available fields see [`mod@c1tcr`]
module*/
pub type C1TCR = crate::Reg<c1tcr::C1TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c1tcr;
/**C1BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c1bndtr`]
module*/
pub type C1BNDTR = crate::Reg<c1bndtr::C1BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c1bndtr;
/**C1SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
+ 0x08).*/
pub mod c1sar;
/**C1DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
+ 0x0C). M*/
pub mod c1dar;
/**C1BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c1brur`]
module*/
pub type C1BRUR = crate::Reg<c1brur::C1BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c1brur;
/**C1LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C1LAR)

For information about available fields see [`mod@c1lar`]
module*/
pub type C1LAR = crate::Reg<c1lar::C1LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c1lar;
/**C1TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c1tbr`]
module*/
pub type C1TBR = crate::Reg<c1tbr::C1TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c1tbr;
/**C1MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C1MAR)

For information about available fields see [`mod@c1mar`]
module*/
pub type C1MAR = crate::Reg<c1mar::C1MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c1mar;
/**C1MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c1mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C2ISR)
...
For information about available fields see [`mod@c2ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C2ESR)

For information about available fields see [`mod@c2esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C2CR)
...
///This register is used to control the concerned channel.
pub mod c2cr;
/**C2TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
For information about available fields see [`mod@c2tcr`]
module*/
pub type C2TCR = crate::Reg<c2tcr::C2TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c2tcr;
/**C2BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c2bndtr`]
module*/
pub type C2BNDTR = crate::Reg<c2bndtr::C2BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c2bndtr;
/**C2SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C2SAR)
...
+ 0x08).*/
pub mod c2sar;
/**C2DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C2DAR)
...
+ 0x0C). M*/
pub mod c2dar;
/**C2BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C2BRUR)

For information about available fields see [`mod@c2brur`]
module*/
pub type C2BRUR = crate::Reg<c2brur::C2BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c2brur;
/**C2LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C2LAR)

For information about available fields see [`mod@c2lar`]
module*/
pub type C2LAR = crate::Reg<c2lar::C2LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c2lar;
/**C2TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c2tbr`]
module*/
pub type C2TBR = crate::Reg<c2tbr::C2TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c2tbr;
/**C2MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c2mar`]
module*/
pub type C2MAR = crate::Reg<c2mar::C2MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c2mar;
/**C2MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c2mdr`]
module*/
...
For information about available fields see [`mod@c3isr`]
module*/
...
For information about available fields see [`mod@c3ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C3ESR)

For information about available fields see [`mod@c3esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C3CR)
...
///This register is used to control the concerned channel.
pub mod c3cr;
/**C3TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C3TCR)

For information about available fields see [`mod@c3tcr`]
module*/
pub type C3TCR = crate::Reg<c3tcr::C3TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c3tcr;
/**C3BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c3bndtr`]
module*/
pub type C3BNDTR = crate::Reg<c3bndtr::C3BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c3bndtr;
/**C3SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
+ 0x08).*/
pub mod c3sar;
/**C3DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
+ 0x0C). M*/
pub mod c3dar;
/**C3BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C3BRUR)

For information about available fields see [`mod@c3brur`]
module*/
pub type C3BRUR = crate::Reg<c3brur::C3BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c3brur;
/**C3LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C3LAR)

For information about available fields see [`mod@c3lar`]
module*/
pub type C3LAR = crate::Reg<c3lar::C3LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c3lar;
/**C3TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C3TBR)

For information about available fields see [`mod@c3tbr`]
module*/
pub type C3TBR = crate::Reg<c3tbr::C3TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c3tbr;
/**C3MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C3MAR)

For information about available fields see [`mod@c3mar`]
module*/
pub type C3MAR = crate::Reg<c3mar::C3MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c3mar;
/**C3MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C3MDR)

For information about available fields see [`mod@c3mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C4ISR)

For information about available fields see [`mod@c4isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C4IFCR)

For information about available fields see [`mod@c4ifcr`]
module*/
...
For information about available fields see [`mod@c4esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C4CR)
...
///This register is used to control the concerned channel.
pub mod c4cr;
/**C4TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
For information about available fields see [`mod@c4tcr`]
module*/
pub type C4TCR = crate::Reg<c4tcr::C4TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c4tcr;
/**C4BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c4bndtr`]
module*/
pub type C4BNDTR = crate::Reg<c4bndtr::C4BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c4bndtr;
/**C4SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C4SAR)
...
+ 0x08).*/
pub mod c4sar;
/**C4DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C4DAR)
...
+ 0x0C). M*/
pub mod c4dar;
/**C4BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c4brur`]
module*/
pub type C4BRUR = crate::Reg<c4brur::C4BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c4brur;
/**C4LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c4lar`]
module*/
pub type C4LAR = crate::Reg<c4lar::C4LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c4lar;
/**C4TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c4tbr`]
module*/
pub type C4TBR = crate::Reg<c4tbr::C4TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c4tbr;
/**C4MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c4mar`]
module*/
pub type C4MAR = crate::Reg<c4mar::C4MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c4mar;
/**C4MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c4mdr`]
module*/
...
For information about available fields see [`mod@c5isr`]
module*/
...
For information about available fields see [`mod@c5ifcr`]
module*/
...
For information about available fields see [`mod@c5esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5CR)
...
///This register is used to control the concerned channel.
pub mod c5cr;
/**C5TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5TCR)

For information about available fields see [`mod@c5tcr`]
module*/
pub type C5TCR = crate::Reg<c5tcr::C5TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c5tcr;
/**C5BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5BNDTR)

For information about available fields see [`mod@c5bndtr`]
module*/
pub type C5BNDTR = crate::Reg<c5bndtr::C5BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c5bndtr;
/**C5SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5SAR)
...
+ 0x08).*/
pub mod c5sar;
/**C5DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
+ 0x0C). M*/
pub mod c5dar;
/**C5BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5BRUR)

For information about available fields see [`mod@c5brur`]
module*/
pub type C5BRUR = crate::Reg<c5brur::C5BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c5brur;
/**C5LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5LAR)

For information about available fields see [`mod@c5lar`]
module*/
pub type C5LAR = crate::Reg<c5lar::C5LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c5lar;
/**C5TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c5tbr`]
module*/
pub type C5TBR = crate::Reg<c5tbr::C5TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c5tbr;
/**C5MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5MAR)

For information about available fields see [`mod@c5mar`]
module*/
pub type C5MAR = crate::Reg<c5mar::C5MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c5mar;
/**C5MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5MDR)

For information about available fields see [`mod@c5mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6ISR)

For information about available fields see [`mod@c6isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6IFCR)

For information about available fields see [`mod@c6ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6ESR)

For information about available fields see [`mod@c6esr`]
module*/
...
///This register is used to control the concerned channel.
pub mod c6cr;
/**C6TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
For information about available fields see [`mod@c6tcr`]
module*/
pub type C6TCR = crate::Reg<c6tcr::C6TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c6tcr;
/**C6BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6BNDTR)

For information about available fields see [`mod@c6bndtr`]
module*/
pub type C6BNDTR = crate::Reg<c6bndtr::C6BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c6bndtr;
/**C6SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6SAR)
...
+ 0x08).*/
pub mod c6sar;
/**C6DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
+ 0x0C). M*/
pub mod c6dar;
/**C6BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c6brur`]
module*/
pub type C6BRUR = crate::Reg<c6brur::C6BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c6brur;
/**C6LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6LAR)

For information about available fields see [`mod@c6lar`]
module*/
pub type C6LAR = crate::Reg<c6lar::C6LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c6lar;
/**C6TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6TBR)

For information about available fields see [`mod@c6tbr`]
module*/
pub type C6TBR = crate::Reg<c6tbr::C6TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c6tbr;
/**C6MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6MAR)

For information about available fields see [`mod@c6mar`]
module*/
pub type C6MAR = crate::Reg<c6mar::C6MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c6mar;
/**C6MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6MDR)

For information about available fields see [`mod@c6mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C7ISR)

For information about available fields see [`mod@c7isr`]
module*/
...
For information about available fields see [`mod@c7ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C7ESR)

For information about available fields see [`mod@c7esr`]
module*/
...
///This register is used to control the concerned channel.
pub mod c7cr;
/**C7TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C7TCR)

For information about available fields see [`mod@c7tcr`]
module*/
pub type C7TCR = crate::Reg<c7tcr::C7TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c7tcr;
/**C7BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C7BNDTR)

For information about available fields see [`mod@c7bndtr`]
module*/
pub type C7BNDTR = crate::Reg<c7bndtr::C7BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c7bndtr;
/**C7SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C7SAR)
...
+ 0x08).*/
pub mod c7sar;
/**C7DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C7DAR)
...
+ 0x0C). M*/
pub mod c7dar;
/**C7BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C7BRUR)

For information about available fields see [`mod@c7brur`]
module*/
pub type C7BRUR = crate::Reg<c7brur::C7BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c7brur;
/**C7LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c7lar`]
module*/
pub type C7LAR = crate::Reg<c7lar::C7LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c7lar;
/**C7TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C7TBR)

For information about available fields see [`mod@c7tbr`]
module*/
pub type C7TBR = crate::Reg<c7tbr::C7TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c7tbr;
/**C7MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c7mar`]
module*/
pub type C7MAR = crate::Reg<c7mar::C7MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c7mar;
/**C7MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c7mdr`]
module*/
...
For information about available fields see [`mod@c8isr`]
module*/
...
For information about available fields see [`mod@c8ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C8ESR)

For information about available fields see [`mod@c8esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C8CR)
...
///This register is used to control the concerned channel.
pub mod c8cr;
/**C8TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C8TCR)

For information about available fields see [`mod@c8tcr`]
module*/
pub type C8TCR = crate::Reg<c8tcr::C8TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c8tcr;
/**C8BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C8BNDTR)

For information about available fields see [`mod@c8bndtr`]
module*/
pub type C8BNDTR = crate::Reg<c8bndtr::C8BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c8bndtr;
/**C8SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
+ 0x08).*/
pub mod c8sar;
/**C8DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C8DAR)
...
+ 0x0C). M*/
pub mod c8dar;
/**C8BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C8BRUR)

For information about available fields see [`mod@c8brur`]
module*/
pub type C8BRUR = crate::Reg<c8brur::C8BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c8brur;
/**C8LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c8lar`]
module*/
pub type C8LAR = crate::Reg<c8lar::C8LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c8lar;
/**C8TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C8TBR)

For information about available fields see [`mod@c8tbr`]
module*/
pub type C8TBR = crate::Reg<c8tbr::C8TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c8tbr;
/**C8MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c8mar`]
module*/
pub type C8MAR = crate::Reg<c8mar::C8MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c8mar;
/**C8MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c8mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C9ISR)

For information about available fields see [`mod@c9isr`]
module*/
...
For information about available fields see [`mod@c9ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C9ESR)

For information about available fields see [`mod@c9esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C9CR)
...
///This register is used to control the concerned channel.
pub mod c9cr;
/**C9TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C9TCR)

For information about available fields see [`mod@c9tcr`]
module*/
pub type C9TCR = crate::Reg<c9tcr::C9TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c9tcr;
/**C9BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c9bndtr`]
module*/
pub type C9BNDTR = crate::Reg<c9bndtr::C9BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c9bndtr;
/**C9SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
+ 0x08).*/
pub mod c9sar;
/**C9DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
+ 0x0C). M*/
pub mod c9dar;
/**C9BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c9brur`]
module*/
pub type C9BRUR = crate::Reg<c9brur::C9BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c9brur;
/**C9LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C9LAR)

For information about available fields see [`mod@c9lar`]
module*/
pub type C9LAR = crate::Reg<c9lar::C9LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c9lar;
/**C9TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c9tbr`]
module*/
pub type C9TBR = crate::Reg<c9tbr::C9TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c9tbr;
/**C9MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C9MAR)

For information about available fields see [`mod@c9mar`]
module*/
pub type C9MAR = crate::Reg<c9mar::C9MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c9mar;
/**C9MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C9MDR)

For information about available fields see [`mod@c9mdr`]
module*/
...
For information about available fields see [`mod@c10isr`]
module*/
...
For information about available fields see [`mod@c10ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C10ESR)

For information about available fields see [`mod@c10esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C10CR)
...
///This register is used to control the concerned channel.
pub mod c10cr;
/**C10TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C10TCR)

For information about available fields see [`mod@c10tcr`]
module*/
pub type C10TCR = crate::Reg<c10tcr::C10TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c10tcr;
/**C10BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C10BNDTR)

For information about available fields see [`mod@c10bndtr`]
module*/
pub type C10BNDTR = crate::Reg<c10bndtr::C10BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c10bndtr;
/**C10SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
+ 0x08).*/
pub mod c10sar;
/**C10DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
+ 0x0C). M*/
pub mod c10dar;
/**C10BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c10brur`]
module*/
pub type C10BRUR = crate::Reg<c10brur::C10BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c10brur;
/**C10LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c10lar`]
module*/
pub type C10LAR = crate::Reg<c10lar::C10LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c10lar;
/**C10TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C10TBR)

For information about available fields see [`mod@c10tbr`]
module*/
pub type C10TBR = crate::Reg<c10tbr::C10TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c10tbr;
/**C10MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c10mar`]
module*/
pub type C10MAR = crate::Reg<c10mar::C10MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c10mar;
/**C10MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c10mdr`]
module*/
...
For information about available fields see [`mod@c11isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11IFCR)

For information about available fields see [`mod@c11ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11ESR)

For information about available fields see [`mod@c11esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11CR)
...
///This register is used to control the concerned channel.
pub mod c11cr;
/**C11TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11TCR)

For information about available fields see [`mod@c11tcr`]
module*/
pub type C11TCR = crate::Reg<c11tcr::C11TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c11tcr;
/**C11BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11BNDTR)

For information about available fields see [`mod@c11bndtr`]
module*/
pub type C11BNDTR = crate::Reg<c11bndtr::C11BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c11bndtr;
/**C11SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11SAR)
...
+ 0x08).*/
pub mod c11sar;
/**C11DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
+ 0x0C). M*/
pub mod c11dar;
/**C11BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11BRUR)

For information about available fields see [`mod@c11brur`]
module*/
pub type C11BRUR = crate::Reg<c11brur::C11BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c11brur;
/**C11LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c11lar`]
module*/
pub type C11LAR = crate::Reg<c11lar::C11LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c11lar;
/**C11TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11TBR)

For information about available fields see [`mod@c11tbr`]
module*/
pub type C11TBR = crate::Reg<c11tbr::C11TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c11tbr;
/**C11MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c11mar`]
module*/
pub type C11MAR = crate::Reg<c11mar::C11MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c11mar;
/**C11MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c11mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12ISR)

For information about available fields see [`mod@c12isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12IFCR)

For information about available fields see [`mod@c12ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12ESR)

For information about available fields see [`mod@c12esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12CR)
...
///This register is used to control the concerned channel.
pub mod c12cr;
/**C12TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12TCR)

For information about available fields see [`mod@c12tcr`]
module*/
pub type C12TCR = crate::Reg<c12tcr::C12TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c12tcr;
/**C12BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12BNDTR)

For information about available fields see [`mod@c12bndtr`]
module*/
pub type C12BNDTR = crate::Reg<c12bndtr::C12BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c12bndtr;
/**C12SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
+ 0x08).*/
pub mod c12sar;
/**C12DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12DAR)
...
+ 0x0C). M*/
pub mod c12dar;
/**C12BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c12brur`]
module*/
pub type C12BRUR = crate::Reg<c12brur::C12BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c12brur;
/**C12LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12LAR)

For information about available fields see [`mod@c12lar`]
module*/
pub type C12LAR = crate::Reg<c12lar::C12LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c12lar;
/**C12TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12TBR)

For information about available fields see [`mod@c12tbr`]
module*/
pub type C12TBR = crate::Reg<c12tbr::C12TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c12tbr;
/**C12MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c12mar`]
module*/
pub type C12MAR = crate::Reg<c12mar::C12MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c12mar;
/**C12MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12MDR)

For information about available fields see [`mod@c12mdr`]
module*/
...
For information about available fields see [`mod@c13isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C13IFCR)

For information about available fields see [`mod@c13ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C13ESR)

For information about available fields see [`mod@c13esr`]
module*/
...
///This register is used to control the concerned channel.
pub mod c13cr;
/**C13TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C13TCR)

For information about available fields see [`mod@c13tcr`]
module*/
pub type C13TCR = crate::Reg<c13tcr::C13TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c13tcr;
/**C13BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C13BNDTR)

For information about available fields see [`mod@c13bndtr`]
module*/
pub type C13BNDTR = crate::Reg<c13bndtr::C13BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c13bndtr;
/**C13SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
+ 0x08).*/
pub mod c13sar;
/**C13DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C13DAR)
...
+ 0x0C). M*/
pub mod c13dar;
/**C13BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c13brur`]
module*/
pub type C13BRUR = crate::Reg<c13brur::C13BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c13brur;
/**C13LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c13lar`]
module*/
pub type C13LAR = crate::Reg<c13lar::C13LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c13lar;
/**C13TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C13TBR)

For information about available fields see [`mod@c13tbr`]
module*/
pub type C13TBR = crate::Reg<c13tbr::C13TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c13tbr;
/**C13MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c13mar`]
module*/
pub type C13MAR = crate::Reg<c13mar::C13MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c13mar;
/**C13MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C13MDR)

For information about available fields see [`mod@c13mdr`]
module*/
...
For information about available fields see [`mod@c14isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C14IFCR)

For information about available fields see [`mod@c14ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C14ESR)

For information about available fields see [`mod@c14esr`]
module*/
...
///This register is used to control the concerned channel.
pub mod c14cr;
/**C14TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C14TCR)

For information about available fields see [`mod@c14tcr`]
module*/
pub type C14TCR = crate::Reg<c14tcr::C14TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c14tcr;
/**C14BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c14bndtr`]
module*/
pub type C14BNDTR = crate::Reg<c14bndtr::C14BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c14bndtr;
/**C14SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C14SAR)
...
+ 0x08).*/
pub mod c14sar;
/**C14DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
+ 0x0C). M*/
pub mod c14dar;
/**C14BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c14brur`]
module*/
pub type C14BRUR = crate::Reg<c14brur::C14BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c14brur;
/**C14LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C14LAR)

For information about available fields see [`mod@c14lar`]
module*/
pub type C14LAR = crate::Reg<c14lar::C14LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c14lar;
/**C14TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c14tbr`]
module*/
pub type C14TBR = crate::Reg<c14tbr::C14TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c14tbr;
/**C14MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c14mar`]
module*/
pub type C14MAR = crate::Reg<c14mar::C14MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c14mar;
/**C14MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C14MDR)

For information about available fields see [`mod@c14mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15ISR)

For information about available fields see [`mod@c15isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15IFCR)

For information about available fields see [`mod@c15ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15ESR)

For information about available fields see [`mod@c15esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15CR)
...
///This register is used to control the concerned channel.
pub mod c15cr;
/**C15TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
For information about available fields see [`mod@c15tcr`]
module*/
pub type C15TCR = crate::Reg<c15tcr::C15TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c15tcr;
/**C15BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15BNDTR)

For information about available fields see [`mod@c15bndtr`]
module*/
pub type C15BNDTR = crate::Reg<c15bndtr::C15BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c15bndtr;
/**C15SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
+ 0x08).*/
pub mod c15sar;
/**C15DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
+ 0x0C). M*/
pub mod c15dar;
/**C15BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15BRUR)

For information about available fields see [`mod@c15brur`]
module*/
pub type C15BRUR = crate::Reg<c15brur::C15BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c15brur;
/**C15LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c15lar`]
module*/
pub type C15LAR = crate::Reg<c15lar::C15LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c15lar;
/**C15TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15TBR)

For information about available fields see [`mod@c15tbr`]
module*/
pub type C15TBR = crate::Reg<c15tbr::C15TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c15tbr;
/**C15MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15MAR)

For information about available fields see [`mod@c15mar`]
module*/
pub type C15MAR = crate::Reg<c15mar::C15MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c15mar;
/**C15MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15MDR)

For information about available fields see [`mod@c15mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C16ISR)

For information about available fields see [`mod@c16isr`]
module*/
...
For information about available fields see [`mod@c16ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C16ESR)

For information about available fields see [`mod@c16esr`]
module*/
...
For information about available fields see [`mod@c16cr`]
module*/
pub type C16CR = crate::Reg<c16cr::C16CRrs>;
///This register is used to control the concerned channel.
pub mod c16cr;
/**C16TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C16TCR)

For information about available fields see [`mod@c16tcr`]
module*/
pub type C16TCR = crate::Reg<c16tcr::C16TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c16tcr;
/**C16BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C16BNDTR)

For information about available fields see [`mod@c16bndtr`]
module*/
pub type C16BNDTR = crate::Reg<c16bndtr::C16BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c16bndtr;
/**C16SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C16SAR)

For information about available fields see [`mod@c16sar`]
module*/
pub type C16SAR = crate::Reg<c16sar::C16SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c16sar;
/**C16DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c16dar`]
module*/
pub type C16DAR = crate::Reg<c16dar::C16DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c16dar;
/**C16BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c16brur`]
module*/
pub type C16BRUR = crate::Reg<c16brur::C16BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c16brur;
/**C16LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C16LAR)

For information about available fields see [`mod@c16lar`]
module*/
pub type C16LAR = crate::Reg<c16lar::C16LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c16lar;
/**C16TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C16TBR)

For information about available fields see [`mod@c16tbr`]
module*/
pub type C16TBR = crate::Reg<c16tbr::C16TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c16tbr;
/**C16MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c16mar`]
module*/
pub type C16MAR = crate::Reg<c16mar::C16MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c16mar;
/**C16MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C16MDR)

For information about available fields see [`mod@c16mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17ISR)

For information about available fields see [`mod@c17isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17IFCR)

For information about available fields see [`mod@c17ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17ESR)

For information about available fields see [`mod@c17esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17CR)

For information about available fields see [`mod@c17cr`]
module*/
pub type C17CR = crate::Reg<c17cr::C17CRrs>;
///This register is used to control the concerned channel.
pub mod c17cr;
/**C17TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17TCR)

For information about available fields see [`mod@c17tcr`]
module*/
pub type C17TCR = crate::Reg<c17tcr::C17TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c17tcr;
/**C17BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c17bndtr`]
module*/
pub type C17BNDTR = crate::Reg<c17bndtr::C17BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c17bndtr;
/**C17SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
For information about available fields see [`mod@c17sar`]
module*/
pub type C17SAR = crate::Reg<c17sar::C17SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c17sar;
/**C17DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c17dar`]
module*/
pub type C17DAR = crate::Reg<c17dar::C17DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c17dar;
/**C17BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17BRUR)

For information about available fields see [`mod@c17brur`]
module*/
pub type C17BRUR = crate::Reg<c17brur::C17BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c17brur;
/**C17LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c17lar`]
module*/
pub type C17LAR = crate::Reg<c17lar::C17LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c17lar;
/**C17TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17TBR)

For information about available fields see [`mod@c17tbr`]
module*/
pub type C17TBR = crate::Reg<c17tbr::C17TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c17tbr;
/**C17MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17MAR)

For information about available fields see [`mod@c17mar`]
module*/
pub type C17MAR = crate::Reg<c17mar::C17MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c17mar;
/**C17MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c17mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C18ISR)

For information about available fields see [`mod@c18isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C18IFCR)

For information about available fields see [`mod@c18ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C18ESR)

For information about available fields see [`mod@c18esr`]
module*/
...
For information about available fields see [`mod@c18cr`]
module*/
pub type C18CR = crate::Reg<c18cr::C18CRrs>;
///This register is used to control the concerned channel.
pub mod c18cr;
/**C18TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C18TCR)

For information about available fields see [`mod@c18tcr`]
module*/
pub type C18TCR = crate::Reg<c18tcr::C18TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c18tcr;
/**C18BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C18BNDTR)

For information about available fields see [`mod@c18bndtr`]
module*/
pub type C18BNDTR = crate::Reg<c18bndtr::C18BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c18bndtr;
/**C18SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C18SAR)

For information about available fields see [`mod@c18sar`]
module*/
pub type C18SAR = crate::Reg<c18sar::C18SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c18sar;
/**C18DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c18dar`]
module*/
pub type C18DAR = crate::Reg<c18dar::C18DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c18dar;
/**C18BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C18BRUR)

For information about available fields see [`mod@c18brur`]
module*/
pub type C18BRUR = crate::Reg<c18brur::C18BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c18brur;
/**C18LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c18lar`]
module*/
pub type C18LAR = crate::Reg<c18lar::C18LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c18lar;
/**C18TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c18tbr`]
module*/
pub type C18TBR = crate::Reg<c18tbr::C18TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c18tbr;
/**C18MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c18mar`]
module*/
pub type C18MAR = crate::Reg<c18mar::C18MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c18mar;
/**C18MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C18MDR)

For information about available fields see [`mod@c18mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C19ISR)

For information about available fields see [`mod@c19isr`]
module*/
...
For information about available fields see [`mod@c19ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C19ESR)

For information about available fields see [`mod@c19esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C19CR)

For information about available fields see [`mod@c19cr`]
module*/
pub type C19CR = crate::Reg<c19cr::C19CRrs>;
///This register is used to control the concerned channel.
pub mod c19cr;
/**C19TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C19TCR)

For information about available fields see [`mod@c19tcr`]
module*/
pub type C19TCR = crate::Reg<c19tcr::C19TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c19tcr;
/**C19BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C19BNDTR)

For information about available fields see [`mod@c19bndtr`]
module*/
pub type C19BNDTR = crate::Reg<c19bndtr::C19BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c19bndtr;
/**C19SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
For information about available fields see [`mod@c19sar`]
module*/
pub type C19SAR = crate::Reg<c19sar::C19SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c19sar;
/**C19DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c19dar`]
module*/
pub type C19DAR = crate::Reg<c19dar::C19DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c19dar;
/**C19BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C19BRUR)

For information about available fields see [`mod@c19brur`]
module*/
pub type C19BRUR = crate::Reg<c19brur::C19BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c19brur;
/**C19LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C19LAR)

For information about available fields see [`mod@c19lar`]
module*/
pub type C19LAR = crate::Reg<c19lar::C19LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c19lar;
/**C19TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c19tbr`]
module*/
pub type C19TBR = crate::Reg<c19tbr::C19TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c19tbr;
/**C19MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C19MAR)

For information about available fields see [`mod@c19mar`]
module*/
pub type C19MAR = crate::Reg<c19mar::C19MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c19mar;
/**C19MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c19mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C20ISR)

For information about available fields see [`mod@c20isr`]
module*/
...
For information about available fields see [`mod@c20ifcr`]
module*/
...
For information about available fields see [`mod@c20esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C20CR)

For information about available fields see [`mod@c20cr`]
module*/
pub type C20CR = crate::Reg<c20cr::C20CRrs>;
///This register is used to control the concerned channel.
pub mod c20cr;
/**C20TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C20TCR)

For information about available fields see [`mod@c20tcr`]
module*/
pub type C20TCR = crate::Reg<c20tcr::C20TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c20tcr;
/**C20BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c20bndtr`]
module*/
pub type C20BNDTR = crate::Reg<c20bndtr::C20BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c20bndtr;
/**C20SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C20SAR)

For information about available fields see [`mod@c20sar`]
module*/
pub type C20SAR = crate::Reg<c20sar::C20SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c20sar;
/**C20DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c20dar`]
module*/
pub type C20DAR = crate::Reg<c20dar::C20DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c20dar;
/**C20BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C20BRUR)

For information about available fields see [`mod@c20brur`]
module*/
pub type C20BRUR = crate::Reg<c20brur::C20BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c20brur;
/**C20LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c20lar`]
module*/
pub type C20LAR = crate::Reg<c20lar::C20LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c20lar;
/**C20TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C20TBR)

For information about available fields see [`mod@c20tbr`]
module*/
pub type C20TBR = crate::Reg<c20tbr::C20TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c20tbr;
/**C20MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C20MAR)

For information about available fields see [`mod@c20mar`]
module*/
pub type C20MAR = crate::Reg<c20mar::C20MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c20mar;
/**C20MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c20mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21ISR)

For information about available fields see [`mod@c21isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21IFCR)

For information about available fields see [`mod@c21ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21ESR)

For information about available fields see [`mod@c21esr`]
module*/
...
For information about available fields see [`mod@c21cr`]
module*/
pub type C21CR = crate::Reg<c21cr::C21CRrs>;
///This register is used to control the concerned channel.
pub mod c21cr;
/**C21TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21TCR)

For information about available fields see [`mod@c21tcr`]
module*/
pub type C21TCR = crate::Reg<c21tcr::C21TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c21tcr;
/**C21BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c21bndtr`]
module*/
pub type C21BNDTR = crate::Reg<c21bndtr::C21BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c21bndtr;
/**C21SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21SAR)

For information about available fields see [`mod@c21sar`]
module*/
pub type C21SAR = crate::Reg<c21sar::C21SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c21sar;
/**C21DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21DAR)

For information about available fields see [`mod@c21dar`]
module*/
pub type C21DAR = crate::Reg<c21dar::C21DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c21dar;
/**C21BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21BRUR)

For information about available fields see [`mod@c21brur`]
module*/
pub type C21BRUR = crate::Reg<c21brur::C21BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c21brur;
/**C21LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21LAR)

For information about available fields see [`mod@c21lar`]
module*/
pub type C21LAR = crate::Reg<c21lar::C21LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c21lar;
/**C21TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21TBR)

For information about available fields see [`mod@c21tbr`]
module*/
pub type C21TBR = crate::Reg<c21tbr::C21TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c21tbr;
/**C21MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c21mar`]
module*/
pub type C21MAR = crate::Reg<c21mar::C21MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c21mar;
/**C21MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21MDR)

For information about available fields see [`mod@c21mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C22ISR)

For information about available fields see [`mod@c22isr`]
module*/
...
For information about available fields see [`mod@c22ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C22ESR)

For information about available fields see [`mod@c22esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C22CR)

For information about available fields see [`mod@c22cr`]
module*/
pub type C22CR = crate::Reg<c22cr::C22CRrs>;
///This register is used to control the concerned channel.
pub mod c22cr;
/**C22TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C22TCR)

For information about available fields see [`mod@c22tcr`]
module*/
pub type C22TCR = crate::Reg<c22tcr::C22TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c22tcr;
/**C22BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c22bndtr`]
module*/
pub type C22BNDTR = crate::Reg<c22bndtr::C22BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c22bndtr;
/**C22SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C22SAR)

For information about available fields see [`mod@c22sar`]
module*/
pub type C22SAR = crate::Reg<c22sar::C22SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c22sar;
/**C22DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c22dar`]
module*/
pub type C22DAR = crate::Reg<c22dar::C22DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c22dar;
/**C22BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C22BRUR)

For information about available fields see [`mod@c22brur`]
module*/
pub type C22BRUR = crate::Reg<c22brur::C22BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c22brur;
/**C22LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C22LAR)

For information about available fields see [`mod@c22lar`]
module*/
pub type C22LAR = crate::Reg<c22lar::C22LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c22lar;
/**C22TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c22tbr`]
module*/
pub type C22TBR = crate::Reg<c22tbr::C22TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c22tbr;
/**C22MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C22MAR)

For information about available fields see [`mod@c22mar`]
module*/
pub type C22MAR = crate::Reg<c22mar::C22MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c22mar;
/**C22MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C22MDR)

For information about available fields see [`mod@c22mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C23ISR)

For information about available fields see [`mod@c23isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C23IFCR)

For information about available fields see [`mod@c23ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C23ESR)

For information about available fields see [`mod@c23esr`]
module*/
...
For information about available fields see [`mod@c23cr`]
module*/
pub type C23CR = crate::Reg<c23cr::C23CRrs>;
///This register is used to control the concerned channel.
pub mod c23cr;
/**C23TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C23TCR)

For information about available fields see [`mod@c23tcr`]
module*/
pub type C23TCR = crate::Reg<c23tcr::C23TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c23tcr;
/**C23BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c23bndtr`]
module*/
pub type C23BNDTR = crate::Reg<c23bndtr::C23BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c23bndtr;
/**C23SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C23SAR)

For information about available fields see [`mod@c23sar`]
module*/
pub type C23SAR = crate::Reg<c23sar::C23SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c23sar;
/**C23DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c23dar`]
module*/
pub type C23DAR = crate::Reg<c23dar::C23DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c23dar;
/**C23BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C23BRUR)

For information about available fields see [`mod@c23brur`]
module*/
pub type C23BRUR = crate::Reg<c23brur::C23BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c23brur;
/**C23LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C23LAR)

For information about available fields see [`mod@c23lar`]
module*/
pub type C23LAR = crate::Reg<c23lar::C23LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c23lar;
/**C23TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c23tbr`]
module*/
pub type C23TBR = crate::Reg<c23tbr::C23TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c23tbr;
/**C23MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C23MAR)

For information about available fields see [`mod@c23mar`]
module*/
pub type C23MAR = crate::Reg<c23mar::C23MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c23mar;
/**C23MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c23mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24ISR)

For information about available fields see [`mod@c24isr`]
module*/
...
For information about available fields see [`mod@c24ifcr`]
module*/
...
For information about available fields see [`mod@c24esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24CR)

For information about available fields see [`mod@c24cr`]
module*/
pub type C24CR = crate::Reg<c24cr::C24CRrs>;
///This register is used to control the concerned channel.
pub mod c24cr;
/**C24TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24TCR)

For information about available fields see [`mod@c24tcr`]
module*/
pub type C24TCR = crate::Reg<c24tcr::C24TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c24tcr;
/**C24BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24BNDTR)

For information about available fields see [`mod@c24bndtr`]
module*/
pub type C24BNDTR = crate::Reg<c24bndtr::C24BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c24bndtr;
/**C24SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24SAR)

For information about available fields see [`mod@c24sar`]
module*/
pub type C24SAR = crate::Reg<c24sar::C24SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c24sar;
/**C24DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24DAR)

For information about available fields see [`mod@c24dar`]
module*/
pub type C24DAR = crate::Reg<c24dar::C24DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c24dar;
/**C24BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24BRUR)

For information about available fields see [`mod@c24brur`]
module*/
pub type C24BRUR = crate::Reg<c24brur::C24BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c24brur;
/**C24LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c24lar`]
module*/
pub type C24LAR = crate::Reg<c24lar::C24LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c24lar;
/**C24TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c24tbr`]
module*/
pub type C24TBR = crate::Reg<c24tbr::C24TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c24tbr;
/**C24MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24MAR)

For information about available fields see [`mod@c24mar`]
module*/
pub type C24MAR = crate::Reg<c24mar::C24MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c24mar;
/**C24MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c24mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25ISR)

For information about available fields see [`mod@c25isr`]
module*/
...
For information about available fields see [`mod@c25ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25ESR)

For information about available fields see [`mod@c25esr`]
module*/
...
For information about available fields see [`mod@c25cr`]
module*/
pub type C25CR = crate::Reg<c25cr::C25CRrs>;
///This register is used to control the concerned channel.
pub mod c25cr;
/**C25TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
For information about available fields see [`mod@c25tcr`]
module*/
pub type C25TCR = crate::Reg<c25tcr::C25TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c25tcr;
/**C25BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25BNDTR)

For information about available fields see [`mod@c25bndtr`]
module*/
pub type C25BNDTR = crate::Reg<c25bndtr::C25BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c25bndtr;
/**C25SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25SAR)

For information about available fields see [`mod@c25sar`]
module*/
pub type C25SAR = crate::Reg<c25sar::C25SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c25sar;
/**C25DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25DAR)

For information about available fields see [`mod@c25dar`]
module*/
pub type C25DAR = crate::Reg<c25dar::C25DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c25dar;
/**C25BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25BRUR)

For information about available fields see [`mod@c25brur`]
module*/
pub type C25BRUR = crate::Reg<c25brur::C25BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c25brur;
/**C25LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25LAR)

For information about available fields see [`mod@c25lar`]
module*/
pub type C25LAR = crate::Reg<c25lar::C25LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c25lar;
/**C25TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25TBR)

For information about available fields see [`mod@c25tbr`]
module*/
pub type C25TBR = crate::Reg<c25tbr::C25TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c25tbr;
/**C25MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c25mar`]
module*/
pub type C25MAR = crate::Reg<c25mar::C25MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c25mar;
/**C25MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25MDR)

For information about available fields see [`mod@c25mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26ISR)

For information about available fields see [`mod@c26isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26IFCR)

For information about available fields see [`mod@c26ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26ESR)

For information about available fields see [`mod@c26esr`]
module*/
...
For information about available fields see [`mod@c26cr`]
module*/
pub type C26CR = crate::Reg<c26cr::C26CRrs>;
///This register is used to control the concerned channel.
pub mod c26cr;
/**C26TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26TCR)

For information about available fields see [`mod@c26tcr`]
module*/
pub type C26TCR = crate::Reg<c26tcr::C26TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c26tcr;
/**C26BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26BNDTR)

For information about available fields see [`mod@c26bndtr`]
module*/
pub type C26BNDTR = crate::Reg<c26bndtr::C26BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c26bndtr;
/**C26SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
For information about available fields see [`mod@c26sar`]
module*/
pub type C26SAR = crate::Reg<c26sar::C26SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c26sar;
/**C26DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26DAR)

For information about available fields see [`mod@c26dar`]
module*/
pub type C26DAR = crate::Reg<c26dar::C26DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c26dar;
/**C26BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26BRUR)

For information about available fields see [`mod@c26brur`]
module*/
pub type C26BRUR = crate::Reg<c26brur::C26BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c26brur;
/**C26LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
For information about available fields see [`mod@c26lar`]
module*/
pub type C26LAR = crate::Reg<c26lar::C26LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c26lar;
/**C26TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c26tbr`]
module*/
pub type C26TBR = crate::Reg<c26tbr::C26TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c26tbr;
/**C26MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
For information about available fields see [`mod@c26mar`]
module*/
pub type C26MAR = crate::Reg<c26mar::C26MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c26mar;
/**C26MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26MDR)

For information about available fields see [`mod@c26mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C27ISR)

For information about available fields see [`mod@c27isr`]
module*/
...
For information about available fields see [`mod@c27ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C27ESR)

For information about available fields see [`mod@c27esr`]
module*/
...
For information about available fields see [`mod@c27cr`]
module*/
pub type C27CR = crate::Reg<c27cr::C27CRrs>;
///This register is used to control the concerned channel.
pub mod c27cr;
/**C27TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
For information about available fields see [`mod@c27tcr`]
module*/
pub type C27TCR = crate::Reg<c27tcr::C27TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c27tcr;
/**C27BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C27BNDTR)

For information about available fields see [`mod@c27bndtr`]
module*/
pub type C27BNDTR = crate::Reg<c27bndtr::C27BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c27bndtr;
/**C27SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
For information about available fields see [`mod@c27sar`]
module*/
pub type C27SAR = crate::Reg<c27sar::C27SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c27sar;
/**C27DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c27dar`]
module*/
pub type C27DAR = crate::Reg<c27dar::C27DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c27dar;
/**C27BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
For information about available fields see [`mod@c27brur`]
module*/
pub type C27BRUR = crate::Reg<c27brur::C27BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c27brur;
/**C27LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C27LAR)

For information about available fields see [`mod@c27lar`]
module*/
pub type C27LAR = crate::Reg<c27lar::C27LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c27lar;
/**C27TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c27tbr`]
module*/
pub type C27TBR = crate::Reg<c27tbr::C27TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c27tbr;
/**C27MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C27MAR)

For information about available fields see [`mod@c27mar`]
module*/
pub type C27MAR = crate::Reg<c27mar::C27MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c27mar;
/**C27MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c27mdr`]
module*/
...
For information about available fields see [`mod@c28isr`]
module*/
...
For information about available fields see [`mod@c28ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C28ESR)

For information about available fields see [`mod@c28esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C28CR)

For information about available fields see [`mod@c28cr`]
module*/
pub type C28CR = crate::Reg<c28cr::C28CRrs>;
///This register is used to control the concerned channel.
pub mod c28cr;
/**C28TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
For information about available fields see [`mod@c28tcr`]
module*/
pub type C28TCR = crate::Reg<c28tcr::C28TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c28tcr;
/**C28BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C28BNDTR)

For information about available fields see [`mod@c28bndtr`]
module*/
pub type C28BNDTR = crate::Reg<c28bndtr::C28BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c28bndtr;
/**C28SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
For information about available fields see [`mod@c28sar`]
module*/
pub type C28SAR = crate::Reg<c28sar::C28SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c28sar;
/**C28DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c28dar`]
module*/
pub type C28DAR = crate::Reg<c28dar::C28DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c28dar;
/**C28BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C28BRUR)

For information about available fields see [`mod@c28brur`]
module*/
pub type C28BRUR = crate::Reg<c28brur::C28BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c28brur;
/**C28LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C28LAR)

For information about available fields see [`mod@c28lar`]
module*/
pub type C28LAR = crate::Reg<c28lar::C28LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c28lar;
/**C28TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c28tbr`]
module*/
pub type C28TBR = crate::Reg<c28tbr::C28TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c28tbr;
/**C28MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C28MAR)

For information about available fields see [`mod@c28mar`]
module*/
pub type C28MAR = crate::Reg<c28mar::C28MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c28mar;
/**C28MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c28mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29ISR)

For information about available fields see [`mod@c29isr`]
module*/
...
For information about available fields see [`mod@c29ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29ESR)

For information about available fields see [`mod@c29esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29CR)

For information about available fields see [`mod@c29cr`]
module*/
pub type C29CR = crate::Reg<c29cr::C29CRrs>;
///This register is used to control the concerned channel.
pub mod c29cr;
/**C29TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29TCR)

For information about available fields see [`mod@c29tcr`]
module*/
pub type C29TCR = crate::Reg<c29tcr::C29TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c29tcr;
/**C29BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29BNDTR)

For information about available fields see [`mod@c29bndtr`]
module*/
pub type C29BNDTR = crate::Reg<c29bndtr::C29BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c29bndtr;
/**C29SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29SAR)

For information about available fields see [`mod@c29sar`]
module*/
pub type C29SAR = crate::Reg<c29sar::C29SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c29sar;
/**C29DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c29dar`]
module*/
pub type C29DAR = crate::Reg<c29dar::C29DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c29dar;
/**C29BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29BRUR)

For information about available fields see [`mod@c29brur`]
module*/
pub type C29BRUR = crate::Reg<c29brur::C29BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c29brur;
/**C29LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29LAR)

For information about available fields see [`mod@c29lar`]
module*/
pub type C29LAR = crate::Reg<c29lar::C29LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c29lar;
/**C29TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29TBR)

For information about available fields see [`mod@c29tbr`]
module*/
pub type C29TBR = crate::Reg<c29tbr::C29TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c29tbr;
/**C29MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29MAR)

For information about available fields see [`mod@c29mar`]
module*/
pub type C29MAR = crate::Reg<c29mar::C29MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c29mar;
/**C29MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c29mdr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C30ISR)

For information about available fields see [`mod@c30isr`]
module*/
...
For information about available fields see [`mod@c30ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C30ESR)

For information about available fields see [`mod@c30esr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C30CR)

For information about available fields see [`mod@c30cr`]
module*/
pub type C30CR = crate::Reg<c30cr::C30CRrs>;
///This register is used to control the concerned channel.
pub mod c30cr;
/**C30TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
For information about available fields see [`mod@c30tcr`]
module*/
pub type C30TCR = crate::Reg<c30tcr::C30TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c30tcr;
/**C30BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c30bndtr`]
module*/
pub type C30BNDTR = crate::Reg<c30bndtr::C30BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c30bndtr;
/**C30SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C30SAR)

For information about available fields see [`mod@c30sar`]
module*/
pub type C30SAR = crate::Reg<c30sar::C30SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c30sar;
/**C30DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C30DAR)

For information about available fields see [`mod@c30dar`]
module*/
pub type C30DAR = crate::Reg<c30dar::C30DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c30dar;
/**C30BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C30BRUR)

For information about available fields see [`mod@c30brur`]
module*/
pub type C30BRUR = crate::Reg<c30brur::C30BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c30brur;
/**C30LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C30LAR)

For information about available fields see [`mod@c30lar`]
module*/
pub type C30LAR = crate::Reg<c30lar::C30LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c30lar;
/**C30TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
For information about available fields see [`mod@c30tbr`]
module*/
pub type C30TBR = crate::Reg<c30tbr::C30TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c30tbr;
/**C30MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C30MAR)

For information about available fields see [`mod@c30mar`]
module*/
pub type C30MAR = crate::Reg<c30mar::C30MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c30mar;
/**C30MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
For information about available fields see [`mod@c30mdr`]
module*/
...
For information about available fields see [`mod@c31isr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C31IFCR)

For information about available fields see [`mod@c31ifcr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C31ESR)

For information about available fields see [`mod@c31esr`]
module*/
...
For information about available fields see [`mod@c31cr`]
module*/
pub type C31CR = crate::Reg<c31cr::C31CRrs>;
///This register is used to control the concerned channel.
pub mod c31cr;
/**C31TCR (rw) register accessor: This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).
...
For information about available fields see [`mod@c31tcr`]
module*/
pub type C31TCR = crate::Reg<c31tcr::C31TCRrs>;
/**This register is used to configure the concerned channel. In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x00).*/
pub mod c31tcr;
/**C31BNDTR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).
...
For information about available fields see [`mod@c31bndtr`]
module*/
pub type C31BNDTR = crate::Reg<c31bndtr::C31BNDTRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x04).*/
pub mod c31bndtr;
/**C31SAR (rw) register accessor: In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C31SAR)

For information about available fields see [`mod@c31sar`]
module*/
pub type C31SAR = crate::Reg<c31sar::C31SARrs>;
/**In Linked List mode, at the end of a Block (single or last Block in repeated Block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x08).*/
pub mod c31sar;
/**C31DAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M
...
For information about available fields see [`mod@c31dar`]
module*/
pub type C31DAR = crate::Reg<c31dar::C31DARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x0C). M*/
pub mod c31dar;
/**C31BRUR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C31BRUR)

For information about available fields see [`mod@c31brur`]
module*/
pub type C31BRUR = crate::Reg<c31brur::C31BRURrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x10).*/
pub mod c31brur;
/**C31LAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C31LAR)

For information about available fields see [`mod@c31lar`]
module*/
pub type C31LAR = crate::Reg<c31lar::C31LARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.*/
pub mod c31lar;
/**C31TBR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C31TBR)

For information about available fields see [`mod@c31tbr`]
module*/
pub type C31TBR = crate::Reg<c31tbr::C31TBRrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x18).*/
pub mod c31tbr;
/**C31MAR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C31MAR)

For information about available fields see [`mod@c31mar`]
module*/
pub type C31MAR = crate::Reg<c31mar::C31MARrs>;
/**In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x20).*/
pub mod c31mar;
/**C31MDR (rw) register accessor: In Linked List mode, at the end of a block (single or last block in repeated block transfer mode), this register will be loaded from memory (from address given by current LAR\[31:0\]
+ 0x24).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C31MDR)

For information about available fields see [`mod@c31mdr`]
module*/
