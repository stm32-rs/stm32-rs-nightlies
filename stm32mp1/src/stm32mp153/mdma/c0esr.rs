///Register `C0ESR` reader
pub type R = crate::R<C0ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c0esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C0ESR)*/
pub struct C0ESRrs;
impl crate::RegisterSpec for C0ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c0esr::R`](R) reader structure
impl crate::Readable for C0ESRrs {}
///`reset()` method sets C0ESR to value 0
impl crate::Resettable for C0ESRrs {}
