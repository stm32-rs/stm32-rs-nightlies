///Register `C10ISR` reader
pub type R = crate::R<C10ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c10isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C10ISR)*/
pub struct C10ISRrs;
impl crate::RegisterSpec for C10ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c10isr::R`](R) reader structure
impl crate::Readable for C10ISRrs {}
///`reset()` method sets C10ISR to value 0
impl crate::Resettable for C10ISRrs {}
