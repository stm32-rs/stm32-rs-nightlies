...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bndt(&mut self) -> BNDT_W<C11BNDTRrs> {
        BNDT_W::new(self, 0)
    }
    ///Bit 18 - BRSUM
    #[inline(always)]
    #[must_use]
    pub fn brsum(&mut self) -> BRSUM_W<C11BNDTRrs> {
        BRSUM_W::new(self, 18)
    }
    ///Bit 19 - BRDUM
    #[inline(always)]
    #[must_use]
    pub fn brdum(&mut self) -> BRDUM_W<C11BNDTRrs> {
        BRDUM_W::new(self, 19)
    }
    ///Bits 20:31 - BRC
    #[inline(always)]
    #[must_use]
    pub fn brc(&mut self) -> BRC_W<C11BNDTRrs> {
        BRC_W::new(self, 20)
    }
}
