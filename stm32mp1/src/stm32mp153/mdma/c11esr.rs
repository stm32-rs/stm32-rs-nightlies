///Register `C11ESR` reader
pub type R = crate::R<C11ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c11esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11ESR)*/
pub struct C11ESRrs;
impl crate::RegisterSpec for C11ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c11esr::R`](R) reader structure
impl crate::Readable for C11ESRrs {}
///`reset()` method sets C11ESR to value 0
impl crate::Resettable for C11ESRrs {}
