///Register `C11ISR` reader
pub type R = crate::R<C11ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c11isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C11ISR)*/
pub struct C11ISRrs;
impl crate::RegisterSpec for C11ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c11isr::R`](R) reader structure
impl crate::Readable for C11ISRrs {}
///`reset()` method sets C11ISR to value 0
impl crate::Resettable for C11ISRrs {}
