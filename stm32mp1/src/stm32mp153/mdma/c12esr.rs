///Register `C12ESR` reader
pub type R = crate::R<C12ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c12esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12ESR)*/
pub struct C12ESRrs;
impl crate::RegisterSpec for C12ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c12esr::R`](R) reader structure
impl crate::Readable for C12ESRrs {}
///`reset()` method sets C12ESR to value 0
impl crate::Resettable for C12ESRrs {}
