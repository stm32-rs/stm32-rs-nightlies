///Register `C12ISR` reader
pub type R = crate::R<C12ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c12isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C12ISR)*/
pub struct C12ISRrs;
impl crate::RegisterSpec for C12ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c12isr::R`](R) reader structure
impl crate::Readable for C12ISRrs {}
///`reset()` method sets C12ISR to value 0
impl crate::Resettable for C12ISRrs {}
