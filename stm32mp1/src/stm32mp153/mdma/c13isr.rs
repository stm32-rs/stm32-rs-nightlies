///Register `C13ISR` reader
pub type R = crate::R<C13ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c13isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C13ISR)*/
pub struct C13ISRrs;
impl crate::RegisterSpec for C13ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c13isr::R`](R) reader structure
impl crate::Readable for C13ISRrs {}
///`reset()` method sets C13ISR to value 0
impl crate::Resettable for C13ISRrs {}
