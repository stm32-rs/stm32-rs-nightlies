...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn teie(&mut self) -> TEIE_W<C14CRrs> {
        TEIE_W::new(self, 1)
    }
    ///Bit 2 - CTCIE
    #[inline(always)]
    #[must_use]
    pub fn ctcie(&mut self) -> CTCIE_W<C14CRrs> {
        CTCIE_W::new(self, 2)
    }
    ///Bit 3 - BRTIE
    #[inline(always)]
    #[must_use]
    pub fn brtie(&mut self) -> BRTIE_W<C14CRrs> {
        BRTIE_W::new(self, 3)
    }
    ///Bit 4 - BTIE
    #[inline(always)]
    #[must_use]
    pub fn btie(&mut self) -> BTIE_W<C14CRrs> {
        BTIE_W::new(self, 4)
    }
    ///Bit 5 - TCIE
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pl(&mut self) -> PL_W<C14CRrs> {
        PL_W::new(self, 6)
    }
    ///Bit 12 - BEX
    #[inline(always)]
    #[must_use]
    pub fn bex(&mut self) -> BEX_W<C14CRrs> {
        BEX_W::new(self, 12)
    }
    ///Bit 13 - HEX
    #[inline(always)]
    #[must_use]
    pub fn hex(&mut self) -> HEX_W<C14CRrs> {
        HEX_W::new(self, 13)
    }
    ///Bit 14 - WEX
    #[inline(always)]
    #[must_use]
    pub fn wex(&mut self) -> WEX_W<C14CRrs> {
        WEX_W::new(self, 14)
    }
    ///Bit 16 - SWRQ
    #[inline(always)]
    #[must_use]
    pub fn swrq(&mut self) -> SWRQ_W<C14CRrs> {
        SWRQ_W::new(self, 16)
    }
}
