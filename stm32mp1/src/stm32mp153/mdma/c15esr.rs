///Register `C15ESR` reader
pub type R = crate::R<C15ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c15esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15ESR)*/
pub struct C15ESRrs;
impl crate::RegisterSpec for C15ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c15esr::R`](R) reader structure
impl crate::Readable for C15ESRrs {}
///`reset()` method sets C15ESR to value 0
impl crate::Resettable for C15ESRrs {}
