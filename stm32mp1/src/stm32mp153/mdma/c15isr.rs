///Register `C15ISR` reader
pub type R = crate::R<C15ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c15isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C15ISR)*/
pub struct C15ISRrs;
impl crate::RegisterSpec for C15ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c15isr::R`](R) reader structure
impl crate::Readable for C15ISRrs {}
///`reset()` method sets C15ISR to value 0
impl crate::Resettable for C15ISRrs {}
