///Register `C17ESR` reader
pub type R = crate::R<C17ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c17esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17ESR)*/
pub struct C17ESRrs;
impl crate::RegisterSpec for C17ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c17esr::R`](R) reader structure
impl crate::Readable for C17ESRrs {}
///`reset()` method sets C17ESR to value 0
impl crate::Resettable for C17ESRrs {}
