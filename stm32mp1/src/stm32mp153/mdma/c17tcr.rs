///Register `C17TCR` reader
pub type R = crate::R<C17TCRrs>;
///Register `C17TCR` writer
pub type W = crate::W<C17TCRrs>;
...
impl W {
    ///Bits 0:1 - SINC
    #[inline(always)]
    pub fn sinc(&mut self) -> SINC_W<'_, C17TCRrs> {
        SINC_W::new(self, 0)
    }
    ///Bits 2:3 - DINC
    #[inline(always)]
    pub fn dinc(&mut self) -> DINC_W<'_, C17TCRrs> {
        DINC_W::new(self, 2)
    }
    ///Bits 4:5 - SSIZE
    #[inline(always)]
    pub fn ssize(&mut self) -> SSIZE_W<'_, C17TCRrs> {
        SSIZE_W::new(self, 4)
    }
    ///Bits 6:7 - DSIZE
    #[inline(always)]
    pub fn dsize(&mut self) -> DSIZE_W<'_, C17TCRrs> {
        DSIZE_W::new(self, 6)
    }
    ///Bits 8:9 - SINCOS
    #[inline(always)]
    pub fn sincos(&mut self) -> SINCOS_W<'_, C17TCRrs> {
        SINCOS_W::new(self, 8)
    }
    ///Bits 10:11 - DINCOS
    #[inline(always)]
    pub fn dincos(&mut self) -> DINCOS_W<'_, C17TCRrs> {
        DINCOS_W::new(self, 10)
    }
    ///Bits 12:14 - SBURST
    #[inline(always)]
    pub fn sburst(&mut self) -> SBURST_W<'_, C17TCRrs> {
        SBURST_W::new(self, 12)
    }
    ///Bits 15:17 - DBURST
    #[inline(always)]
    pub fn dburst(&mut self) -> DBURST_W<'_, C17TCRrs> {
        DBURST_W::new(self, 15)
    }
    ///Bits 18:24 - TLEN
    #[inline(always)]
    pub fn tlen(&mut self) -> TLEN_W<'_, C17TCRrs> {
        TLEN_W::new(self, 18)
    }
    ///Bit 25 - PKE
    #[inline(always)]
    pub fn pke(&mut self) -> PKE_W<'_, C17TCRrs> {
        PKE_W::new(self, 25)
    }
    ///Bits 26:27 - PAM
    #[inline(always)]
    pub fn pam(&mut self) -> PAM_W<'_, C17TCRrs> {
        PAM_W::new(self, 26)
    }
    ///Bits 28:29 - TRGM
    #[inline(always)]
    pub fn trgm(&mut self) -> TRGM_W<'_, C17TCRrs> {
        TRGM_W::new(self, 28)
    }
    ///Bit 30 - SWRM
    #[inline(always)]
    pub fn swrm(&mut self) -> SWRM_W<'_, C17TCRrs> {
        SWRM_W::new(self, 30)
    }
    ///Bit 31 - BWM
    #[inline(always)]
    pub fn bwm(&mut self) -> BWM_W<'_, C17TCRrs> {
        BWM_W::new(self, 31)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`c17tcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c17tcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C17TCR)*/
pub struct C17TCRrs;
impl crate::RegisterSpec for C17TCRrs {
    type Ux = u32;
}
///`read()` method returns [`c17tcr::R`](R) reader structure
impl crate::Readable for C17TCRrs {}
///`write(|w| ..)` method takes [`c17tcr::W`](W) writer structure
impl crate::Writable for C17TCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C17TCR to value 0
impl crate::Resettable for C17TCRrs {}
