///Register `C18ISR` reader
pub type R = crate::R<C18ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c18isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C18ISR)*/
pub struct C18ISRrs;
impl crate::RegisterSpec for C18ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c18isr::R`](R) reader structure
impl crate::Readable for C18ISRrs {}
///`reset()` method sets C18ISR to value 0
impl crate::Resettable for C18ISRrs {}
