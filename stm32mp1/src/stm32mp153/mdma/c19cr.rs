///Register `C19CR` reader
pub type R = crate::R<C19CRrs>;
///Register `C19CR` writer
pub type W = crate::W<C19CRrs>;
///Field `EN` reader - EN
...
impl W {
    ///Bit 0 - EN
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, C19CRrs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - TEIE
    #[inline(always)]
    pub fn teie(&mut self) -> TEIE_W<'_, C19CRrs> {
        TEIE_W::new(self, 1)
    }
    ///Bit 2 - CTCIE
    #[inline(always)]
    pub fn ctcie(&mut self) -> CTCIE_W<'_, C19CRrs> {
        CTCIE_W::new(self, 2)
    }
    ///Bit 3 - BRTIE
    #[inline(always)]
    pub fn brtie(&mut self) -> BRTIE_W<'_, C19CRrs> {
        BRTIE_W::new(self, 3)
    }
    ///Bit 4 - BTIE
    #[inline(always)]
    pub fn btie(&mut self) -> BTIE_W<'_, C19CRrs> {
        BTIE_W::new(self, 4)
    }
    ///Bit 5 - TCIE
    #[inline(always)]
    pub fn tcie(&mut self) -> TCIE_W<'_, C19CRrs> {
        TCIE_W::new(self, 5)
    }
    ///Bits 6:7 - PL
    #[inline(always)]
    pub fn pl(&mut self) -> PL_W<'_, C19CRrs> {
        PL_W::new(self, 6)
    }
    ///Bit 12 - BEX
    #[inline(always)]
    pub fn bex(&mut self) -> BEX_W<'_, C19CRrs> {
        BEX_W::new(self, 12)
    }
    ///Bit 13 - HEX
    #[inline(always)]
    pub fn hex(&mut self) -> HEX_W<'_, C19CRrs> {
        HEX_W::new(self, 13)
    }
    ///Bit 14 - WEX
    #[inline(always)]
    pub fn wex(&mut self) -> WEX_W<'_, C19CRrs> {
        WEX_W::new(self, 14)
    }
    ///Bit 16 - SWRQ
    #[inline(always)]
    pub fn swrq(&mut self) -> SWRQ_W<'_, C19CRrs> {
        SWRQ_W::new(self, 16)
    }
}
/**This register is used to control the concerned channel.

You can [`read`](crate::Reg::read) this register and get [`c19cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c19cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C19CR)*/
pub struct C19CRrs;
impl crate::RegisterSpec for C19CRrs {
    type Ux = u32;
}
///`read()` method returns [`c19cr::R`](R) reader structure
impl crate::Readable for C19CRrs {}
///`write(|w| ..)` method takes [`c19cr::W`](W) writer structure
impl crate::Writable for C19CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C19CR to value 0
impl crate::Resettable for C19CRrs {}
