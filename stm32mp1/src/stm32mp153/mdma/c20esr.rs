///Register `C20ESR` reader
pub type R = crate::R<C20ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c20esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C20ESR)*/
pub struct C20ESRrs;
impl crate::RegisterSpec for C20ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c20esr::R`](R) reader structure
impl crate::Readable for C20ESRrs {}
///`reset()` method sets C20ESR to value 0
impl crate::Resettable for C20ESRrs {}
