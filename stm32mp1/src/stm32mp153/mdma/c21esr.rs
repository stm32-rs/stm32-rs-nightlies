///Register `C21ESR` reader
pub type R = crate::R<C21ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c21esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C21ESR)*/
pub struct C21ESRrs;
impl crate::RegisterSpec for C21ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c21esr::R`](R) reader structure
impl crate::Readable for C21ESRrs {}
///`reset()` method sets C21ESR to value 0
impl crate::Resettable for C21ESRrs {}
