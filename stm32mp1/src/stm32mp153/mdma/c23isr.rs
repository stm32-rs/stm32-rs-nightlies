///Register `C23ISR` reader
pub type R = crate::R<C23ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c23isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C23ISR)*/
pub struct C23ISRrs;
impl crate::RegisterSpec for C23ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c23isr::R`](R) reader structure
impl crate::Readable for C23ISRrs {}
///`reset()` method sets C23ISR to value 0
impl crate::Resettable for C23ISRrs {}
