///Register `C24ESR` reader
pub type R = crate::R<C24ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c24esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24ESR)*/
pub struct C24ESRrs;
impl crate::RegisterSpec for C24ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c24esr::R`](R) reader structure
impl crate::Readable for C24ESRrs {}
///`reset()` method sets C24ESR to value 0
impl crate::Resettable for C24ESRrs {}
