///Register `C24ISR` reader
pub type R = crate::R<C24ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c24isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C24ISR)*/
pub struct C24ISRrs;
impl crate::RegisterSpec for C24ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c24isr::R`](R) reader structure
impl crate::Readable for C24ISRrs {}
///`reset()` method sets C24ISR to value 0
impl crate::Resettable for C24ISRrs {}
