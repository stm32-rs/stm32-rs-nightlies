///Register `C25ESR` reader
pub type R = crate::R<C25ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c25esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C25ESR)*/
pub struct C25ESRrs;
impl crate::RegisterSpec for C25ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c25esr::R`](R) reader structure
impl crate::Readable for C25ESRrs {}
///`reset()` method sets C25ESR to value 0
impl crate::Resettable for C25ESRrs {}
