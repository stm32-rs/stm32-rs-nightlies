///Register `C26ESR` reader
pub type R = crate::R<C26ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c26esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26ESR)*/
pub struct C26ESRrs;
impl crate::RegisterSpec for C26ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c26esr::R`](R) reader structure
impl crate::Readable for C26ESRrs {}
///`reset()` method sets C26ESR to value 0
impl crate::Resettable for C26ESRrs {}
