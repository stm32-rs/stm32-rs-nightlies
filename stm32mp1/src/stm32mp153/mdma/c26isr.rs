///Register `C26ISR` reader
pub type R = crate::R<C26ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c26isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C26ISR)*/
pub struct C26ISRrs;
impl crate::RegisterSpec for C26ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c26isr::R`](R) reader structure
impl crate::Readable for C26ISRrs {}
///`reset()` method sets C26ISR to value 0
impl crate::Resettable for C26ISRrs {}
