///Register `C28ISR` reader
pub type R = crate::R<C28ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c28isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C28ISR)*/
pub struct C28ISRrs;
impl crate::RegisterSpec for C28ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c28isr::R`](R) reader structure
impl crate::Readable for C28ISRrs {}
///`reset()` method sets C28ISR to value 0
impl crate::Resettable for C28ISRrs {}
