///Register `C29ESR` reader
pub type R = crate::R<C29ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c29esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29ESR)*/
pub struct C29ESRrs;
impl crate::RegisterSpec for C29ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c29esr::R`](R) reader structure
impl crate::Readable for C29ESRrs {}
///`reset()` method sets C29ESR to value 0
impl crate::Resettable for C29ESRrs {}
