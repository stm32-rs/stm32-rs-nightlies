///Register `C29ISR` reader
pub type R = crate::R<C29ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c29isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C29ISR)*/
pub struct C29ISRrs;
impl crate::RegisterSpec for C29ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c29isr::R`](R) reader structure
impl crate::Readable for C29ISRrs {}
///`reset()` method sets C29ISR to value 0
impl crate::Resettable for C29ISRrs {}
