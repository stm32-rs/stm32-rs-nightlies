///Register `C2BNDTR` reader
pub type R = crate::R<C2BNDTRrs>;
///Register `C2BNDTR` writer
pub type W = crate::W<C2BNDTRrs>;
...
impl W {
    ///Bits 0:16 - BNDT
    #[inline(always)]
    pub fn bndt(&mut self) -> BNDT_W<'_, C2BNDTRrs> {
        BNDT_W::new(self, 0)
    }
    ///Bit 18 - BRSUM
    #[inline(always)]
    pub fn brsum(&mut self) -> BRSUM_W<'_, C2BNDTRrs> {
        BRSUM_W::new(self, 18)
    }
    ///Bit 19 - BRDUM
    #[inline(always)]
    pub fn brdum(&mut self) -> BRDUM_W<'_, C2BNDTRrs> {
        BRDUM_W::new(self, 19)
    }
    ///Bits 20:31 - BRC
    #[inline(always)]
    pub fn brc(&mut self) -> BRC_W<'_, C2BNDTRrs> {
        BRC_W::new(self, 20)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`c2bndtr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c2bndtr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C2BNDTR)*/
pub struct C2BNDTRrs;
impl crate::RegisterSpec for C2BNDTRrs {
    type Ux = u32;
}
///`read()` method returns [`c2bndtr::R`](R) reader structure
impl crate::Readable for C2BNDTRrs {}
///`write(|w| ..)` method takes [`c2bndtr::W`](W) writer structure
impl crate::Writable for C2BNDTRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C2BNDTR to value 0
impl crate::Resettable for C2BNDTRrs {}
