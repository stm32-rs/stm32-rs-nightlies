...
impl W {
    ...
    ///Bit 1 - TEIE
    #[inline(always)]
    pub fn teie(&mut self) -> TEIE_W<'_, C2CRrs> {
        TEIE_W::new(self, 1)
    }
    ///Bit 2 - CTCIE
    #[inline(always)]
    pub fn ctcie(&mut self) -> CTCIE_W<'_, C2CRrs> {
        CTCIE_W::new(self, 2)
    }
    ///Bit 3 - BRTIE
    #[inline(always)]
    pub fn brtie(&mut self) -> BRTIE_W<'_, C2CRrs> {
        BRTIE_W::new(self, 3)
    }
    ///Bit 4 - BTIE
    #[inline(always)]
    pub fn btie(&mut self) -> BTIE_W<'_, C2CRrs> {
        BTIE_W::new(self, 4)
    }
    ///Bit 5 - TCIE
    #[inline(always)]
    ...
    ///Bits 6:7 - PL
    #[inline(always)]
    pub fn pl(&mut self) -> PL_W<'_, C2CRrs> {
        PL_W::new(self, 6)
    }
    ///Bit 12 - BEX
    #[inline(always)]
    pub fn bex(&mut self) -> BEX_W<'_, C2CRrs> {
        BEX_W::new(self, 12)
    }
    ///Bit 13 - HEX
    #[inline(always)]
    pub fn hex(&mut self) -> HEX_W<'_, C2CRrs> {
        HEX_W::new(self, 13)
    }
    ///Bit 14 - WEX
    #[inline(always)]
    pub fn wex(&mut self) -> WEX_W<'_, C2CRrs> {
        WEX_W::new(self, 14)
    }
    ///Bit 16 - SWRQ
    #[inline(always)]
    pub fn swrq(&mut self) -> SWRQ_W<'_, C2CRrs> {
        SWRQ_W::new(self, 16)
    }
}
