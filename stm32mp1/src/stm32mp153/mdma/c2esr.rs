///Register `C2ESR` reader
pub type R = crate::R<C2ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c2esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C2ESR)*/
pub struct C2ESRrs;
impl crate::RegisterSpec for C2ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c2esr::R`](R) reader structure
impl crate::Readable for C2ESRrs {}
///`reset()` method sets C2ESR to value 0
impl crate::Resettable for C2ESRrs {}
