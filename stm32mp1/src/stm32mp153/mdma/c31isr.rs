///Register `C31ISR` reader
pub type R = crate::R<C31ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c31isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C31ISR)*/
pub struct C31ISRrs;
impl crate::RegisterSpec for C31ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c31isr::R`](R) reader structure
impl crate::Readable for C31ISRrs {}
///`reset()` method sets C31ISR to value 0
impl crate::Resettable for C31ISRrs {}
