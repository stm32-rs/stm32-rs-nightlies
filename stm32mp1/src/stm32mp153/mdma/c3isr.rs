///Register `C3ISR` reader
pub type R = crate::R<C3ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c3isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C3ISR)*/
pub struct C3ISRrs;
impl crate::RegisterSpec for C3ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c3isr::R`](R) reader structure
impl crate::Readable for C3ISRrs {}
///`reset()` method sets C3ISR to value 0
impl crate::Resettable for C3ISRrs {}
