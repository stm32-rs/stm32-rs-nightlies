///Register `C4ISR` reader
pub type R = crate::R<C4ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c4isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C4ISR)*/
pub struct C4ISRrs;
impl crate::RegisterSpec for C4ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c4isr::R`](R) reader structure
impl crate::Readable for C4ISRrs {}
///`reset()` method sets C4ISR to value 0
impl crate::Resettable for C4ISRrs {}
