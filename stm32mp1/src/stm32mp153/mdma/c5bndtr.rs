///Register `C5BNDTR` reader
pub type R = crate::R<C5BNDTRrs>;
///Register `C5BNDTR` writer
pub type W = crate::W<C5BNDTRrs>;
...
impl W {
    ///Bits 0:16 - BNDT
    #[inline(always)]
    pub fn bndt(&mut self) -> BNDT_W<'_, C5BNDTRrs> {
        BNDT_W::new(self, 0)
    }
    ///Bit 18 - BRSUM
    #[inline(always)]
    pub fn brsum(&mut self) -> BRSUM_W<'_, C5BNDTRrs> {
        BRSUM_W::new(self, 18)
    }
    ///Bit 19 - BRDUM
    #[inline(always)]
    pub fn brdum(&mut self) -> BRDUM_W<'_, C5BNDTRrs> {
        BRDUM_W::new(self, 19)
    }
    ///Bits 20:31 - BRC
    #[inline(always)]
    pub fn brc(&mut self) -> BRC_W<'_, C5BNDTRrs> {
        BRC_W::new(self, 20)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`c5bndtr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c5bndtr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5BNDTR)*/
pub struct C5BNDTRrs;
impl crate::RegisterSpec for C5BNDTRrs {
    type Ux = u32;
}
///`read()` method returns [`c5bndtr::R`](R) reader structure
impl crate::Readable for C5BNDTRrs {}
///`write(|w| ..)` method takes [`c5bndtr::W`](W) writer structure
impl crate::Writable for C5BNDTRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C5BNDTR to value 0
impl crate::Resettable for C5BNDTRrs {}
