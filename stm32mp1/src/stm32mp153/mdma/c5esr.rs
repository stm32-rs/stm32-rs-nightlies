///Register `C5ESR` reader
pub type R = crate::R<C5ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c5esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5ESR)*/
pub struct C5ESRrs;
impl crate::RegisterSpec for C5ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c5esr::R`](R) reader structure
impl crate::Readable for C5ESRrs {}
///`reset()` method sets C5ESR to value 0
impl crate::Resettable for C5ESRrs {}
