///Register `C5ISR` reader
pub type R = crate::R<C5ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c5isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C5ISR)*/
pub struct C5ISRrs;
impl crate::RegisterSpec for C5ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c5isr::R`](R) reader structure
impl crate::Readable for C5ISRrs {}
///`reset()` method sets C5ISR to value 0
impl crate::Resettable for C5ISRrs {}
