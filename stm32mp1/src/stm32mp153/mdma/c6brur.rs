...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn suv(&mut self) -> SUV_W<C6BRURrs> {
        SUV_W::new(self, 0)
    }
    ///Bits 16:31 - DUV
    #[inline(always)]
    #[must_use]
    pub fn duv(&mut self) -> DUV_W<C6BRURrs> {
        DUV_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C6BRUR)*/
pub struct C6BRURrs;
