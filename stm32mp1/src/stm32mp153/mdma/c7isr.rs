///Register `C7ISR` reader
pub type R = crate::R<C7ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c7isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C7ISR)*/
pub struct C7ISRrs;
impl crate::RegisterSpec for C7ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c7isr::R`](R) reader structure
impl crate::Readable for C7ISRrs {}
///`reset()` method sets C7ISR to value 0
impl crate::Resettable for C7ISRrs {}
