...
You can [`read`](crate::Reg::read) this register and get [`c9esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`c9esr::R`](R) reader structure
