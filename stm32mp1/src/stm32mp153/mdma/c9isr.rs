///Register `C9ISR` reader
pub type R = crate::R<C9ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c9isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:C9ISR)*/
pub struct C9ISRrs;
impl crate::RegisterSpec for C9ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c9isr::R`](R) reader structure
impl crate::Readable for C9ISRrs {}
///`reset()` method sets C9ISR to value 0
impl crate::Resettable for C9ISRrs {}
