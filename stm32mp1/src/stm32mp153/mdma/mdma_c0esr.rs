///Register `MDMA_C0ESR` reader
pub type R = crate::R<MDMA_C0ESRrs>;
...
pub struct MDMA_C0ESRrs;
impl crate::RegisterSpec for MDMA_C0ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c0esr::R`](R) reader structure
impl crate::Readable for MDMA_C0ESRrs {}
///`reset()` method sets MDMA_C0ESR to value 0
impl crate::Resettable for MDMA_C0ESRrs {
