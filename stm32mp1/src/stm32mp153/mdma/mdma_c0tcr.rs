...
pub type R = crate::R<MDMA_C0TCRrs>;
#[doc = "Register `MDMA_C0TCR` writer"]
pub type W = crate::W<MDMA_C0TCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sinc(&mut self) -> SINC_W<MDMA_C0TCRrs> {
        SINC_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - DINC"]
    #[inline(always)]
    #[must_use]
    pub fn dinc(&mut self) -> DINC_W<MDMA_C0TCRrs> {
        DINC_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - SSIZE"]
    #[inline(always)]
    #[must_use]
    pub fn ssize(&mut self) -> SSIZE_W<MDMA_C0TCRrs> {
        SSIZE_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - DSIZE"]
    #[inline(always)]
    #[must_use]
    pub fn dsize(&mut self) -> DSIZE_W<MDMA_C0TCRrs> {
        DSIZE_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - SINCOS"]
    #[inline(always)]
    #[must_use]
    pub fn sincos(&mut self) -> SINCOS_W<MDMA_C0TCRrs> {
        SINCOS_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - DINCOS"]
    #[inline(always)]
    #[must_use]
    pub fn dincos(&mut self) -> DINCOS_W<MDMA_C0TCRrs> {
        DINCOS_W::new(self, 10)
    }
    #[doc = "Bits 12:14 - SBURST"]
    #[inline(always)]
    #[must_use]
    pub fn sburst(&mut self) -> SBURST_W<MDMA_C0TCRrs> {
        SBURST_W::new(self, 12)
    }
    #[doc = "Bits 15:17 - DBURST"]
    #[inline(always)]
    #[must_use]
    pub fn dburst(&mut self) -> DBURST_W<MDMA_C0TCRrs> {
        DBURST_W::new(self, 15)
    }
    #[doc = "Bits 18:24 - TLEN"]
    #[inline(always)]
    #[must_use]
    pub fn tlen(&mut self) -> TLEN_W<MDMA_C0TCRrs> {
        TLEN_W::new(self, 18)
    }
    #[doc = "Bit 25 - PKE"]
    #[inline(always)]
    #[must_use]
    pub fn pke(&mut self) -> PKE_W<MDMA_C0TCRrs> {
        PKE_W::new(self, 25)
    }
    #[doc = "Bits 26:27 - PAM"]
    #[inline(always)]
    #[must_use]
    pub fn pam(&mut self) -> PAM_W<MDMA_C0TCRrs> {
        PAM_W::new(self, 26)
    }
    #[doc = "Bits 28:29 - TRGM"]
    #[inline(always)]
    #[must_use]
    pub fn trgm(&mut self) -> TRGM_W<MDMA_C0TCRrs> {
        TRGM_W::new(self, 28)
    }
    #[doc = "Bit 30 - SWRM"]
    #[inline(always)]
    #[must_use]
    pub fn swrm(&mut self) -> SWRM_W<MDMA_C0TCRrs> {
        SWRM_W::new(self, 30)
    }
    #[doc = "Bit 31 - BWM"]
    #[inline(always)]
    #[must_use]
    pub fn bwm(&mut self) -> BWM_W<MDMA_C0TCRrs> {
        BWM_W::new(self, 31)
    }
}
...
+ 0x00).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c0tcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdma_c0tcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDMA_C0TCRrs;
impl crate::RegisterSpec for MDMA_C0TCRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c0tcr::R`](R) reader structure"]
impl crate::Readable for MDMA_C0TCRrs {}
#[doc = "`write(|w| ..)` method takes [`mdma_c0tcr::W`](W) writer structure"]
impl crate::Writable for MDMA_C0TCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDMA_C0TCR to value 0"]
impl crate::Resettable for MDMA_C0TCRrs {
