...
pub type R = crate::R<MDMA_C10MARrs>;
///Register `MDMA_C10MAR` writer
pub type W = crate::W<MDMA_C10MARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mar(&mut self) -> MAR_W<MDMA_C10MARrs> {
        MAR_W::new(self, 0)
    }
}
...
pub struct MDMA_C10MARrs;
impl crate::RegisterSpec for MDMA_C10MARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c10mar::R`](R) reader structure
impl crate::Readable for MDMA_C10MARrs {}
///`write(|w| ..)` method takes [`mdma_c10mar::W`](W) writer structure
impl crate::Writable for MDMA_C10MARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C10MAR to value 0
impl crate::Resettable for MDMA_C10MARrs {
