...
pub type R = crate::R<MDMA_C10TBRrs>;
#[doc = "Register `MDMA_C10TBR` writer"]
pub type W = crate::W<MDMA_C10TBRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsel(&mut self) -> TSEL_W<MDMA_C10TBRrs> {
        TSEL_W::new(self, 0)
    }
    #[doc = "Bit 16 - SBUS"]
    #[inline(always)]
    #[must_use]
    pub fn sbus(&mut self) -> SBUS_W<MDMA_C10TBRrs> {
        SBUS_W::new(self, 16)
    }
    #[doc = "Bit 17 - DBUS"]
    #[inline(always)]
    #[must_use]
    pub fn dbus(&mut self) -> DBUS_W<MDMA_C10TBRrs> {
        DBUS_W::new(self, 17)
    }
}
...
+ 0x18).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c10tbr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdma_c10tbr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDMA_C10TBRrs;
impl crate::RegisterSpec for MDMA_C10TBRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c10tbr::R`](R) reader structure"]
impl crate::Readable for MDMA_C10TBRrs {}
#[doc = "`write(|w| ..)` method takes [`mdma_c10tbr::W`](W) writer structure"]
impl crate::Writable for MDMA_C10TBRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDMA_C10TBR to value 0"]
impl crate::Resettable for MDMA_C10TBRrs {
