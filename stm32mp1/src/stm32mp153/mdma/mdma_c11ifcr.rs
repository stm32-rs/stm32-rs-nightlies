///Register `MDMA_C11IFCR` writer
pub type W = crate::W<MDMA_C11IFCRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<MDMA_C11IFCRrs> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cteif(&mut self) -> CTEIF_W<MDMA_C11IFCRrs> {
        CTEIF_W::new(self, 0)
    }
    ///Bit 1 - CCTCIF
    #[inline(always)]
    #[must_use]
    pub fn cctcif(&mut self) -> CCTCIF_W<MDMA_C11IFCRrs> {
        CCTCIF_W::new(self, 1)
    }
    ///Bit 2 - CBRTIF
    #[inline(always)]
    #[must_use]
    pub fn cbrtif(&mut self) -> CBRTIF_W<MDMA_C11IFCRrs> {
        CBRTIF_W::new(self, 2)
    }
    ///Bit 3 - CBTIF
    #[inline(always)]
    #[must_use]
    pub fn cbtif(&mut self) -> CBTIF_W<MDMA_C11IFCRrs> {
        CBTIF_W::new(self, 3)
    }
    ///Bit 4 - CLTCIF
    #[inline(always)]
    #[must_use]
    pub fn cltcif(&mut self) -> CLTCIF_W<MDMA_C11IFCRrs> {
        CLTCIF_W::new(self, 4)
    }
}
...
pub struct MDMA_C11IFCRrs;
impl crate::RegisterSpec for MDMA_C11IFCRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`mdma_c11ifcr::W`](W) writer structure
impl crate::Writable for MDMA_C11IFCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C11IFCR to value 0
impl crate::Resettable for MDMA_C11IFCRrs {
