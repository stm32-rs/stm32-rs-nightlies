///Register `MDMA_C11LAR` reader
pub type R = crate::R<MDMA_C11LARrs>;
///Register `MDMA_C11LAR` writer
pub type W = crate::W<MDMA_C11LARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lar(&mut self) -> LAR_W<MDMA_C11LARrs> {
        LAR_W::new(self, 0)
    }
}
...
pub struct MDMA_C11LARrs;
impl crate::RegisterSpec for MDMA_C11LARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c11lar::R`](R) reader structure
impl crate::Readable for MDMA_C11LARrs {}
///`write(|w| ..)` method takes [`mdma_c11lar::W`](W) writer structure
impl crate::Writable for MDMA_C11LARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C11LAR to value 0
impl crate::Resettable for MDMA_C11LARrs {
