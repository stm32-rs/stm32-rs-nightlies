...
pub type R = crate::R<MDMA_C12SARrs>;
///Register `MDMA_C12SAR` writer
pub type W = crate::W<MDMA_C12SARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar(&mut self) -> SAR_W<MDMA_C12SARrs> {
        SAR_W::new(self, 0)
    }
}
...
pub struct MDMA_C12SARrs;
impl crate::RegisterSpec for MDMA_C12SARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c12sar::R`](R) reader structure
impl crate::Readable for MDMA_C12SARrs {}
///`write(|w| ..)` method takes [`mdma_c12sar::W`](W) writer structure
impl crate::Writable for MDMA_C12SARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C12SAR to value 0
impl crate::Resettable for MDMA_C12SARrs {
