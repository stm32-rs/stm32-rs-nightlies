...
pub type R = crate::R<MDMA_C13ISRrs>;
...
pub struct MDMA_C13ISRrs;
impl crate::RegisterSpec for MDMA_C13ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c13isr::R`](R) reader structure
impl crate::Readable for MDMA_C13ISRrs {}
///`reset()` method sets MDMA_C13ISR to value 0
impl crate::Resettable for MDMA_C13ISRrs {
