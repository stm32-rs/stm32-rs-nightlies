...
pub type R = crate::R<MDMA_C14ISRrs>;
...
pub struct MDMA_C14ISRrs;
impl crate::RegisterSpec for MDMA_C14ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c14isr::R`](R) reader structure
impl crate::Readable for MDMA_C14ISRrs {}
///`reset()` method sets MDMA_C14ISR to value 0
impl crate::Resettable for MDMA_C14ISRrs {
