...
pub type R = crate::R<MDMA_C14MARrs>;
#[doc = "Register `MDMA_C14MAR` writer"]
pub type W = crate::W<MDMA_C14MARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mar(&mut self) -> MAR_W<MDMA_C14MARrs> {
        MAR_W::new(self, 0)
    }
}
...
+ 0x20).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c14mar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdma_c14mar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDMA_C14MARrs;
impl crate::RegisterSpec for MDMA_C14MARrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c14mar::R`](R) reader structure"]
impl crate::Readable for MDMA_C14MARrs {}
#[doc = "`write(|w| ..)` method takes [`mdma_c14mar::W`](W) writer structure"]
impl crate::Writable for MDMA_C14MARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDMA_C14MAR to value 0"]
impl crate::Resettable for MDMA_C14MARrs {
