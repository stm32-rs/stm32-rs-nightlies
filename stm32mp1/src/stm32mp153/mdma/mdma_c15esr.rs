...
pub type R = crate::R<MDMA_C15ESRrs>;
...
#[doc = "MDMA channel 15 error status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c15esr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDMA_C15ESRrs;
impl crate::RegisterSpec for MDMA_C15ESRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c15esr::R`](R) reader structure"]
impl crate::Readable for MDMA_C15ESRrs {}
#[doc = "`reset()` method sets MDMA_C15ESR to value 0"]
impl crate::Resettable for MDMA_C15ESRrs {
