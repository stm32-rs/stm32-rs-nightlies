///Register `MDMA_C15ISR` reader
pub type R = crate::R<MDMA_C15ISRrs>;
...
pub struct MDMA_C15ISRrs;
impl crate::RegisterSpec for MDMA_C15ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c15isr::R`](R) reader structure
impl crate::Readable for MDMA_C15ISRrs {}
///`reset()` method sets MDMA_C15ISR to value 0
impl crate::Resettable for MDMA_C15ISRrs {
