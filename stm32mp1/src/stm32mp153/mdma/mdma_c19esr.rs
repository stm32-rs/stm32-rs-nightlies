...
pub type R = crate::R<MDMA_C19ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c19esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:MDMA_C19ESR)*/
pub struct MDMA_C19ESRrs;
impl crate::RegisterSpec for MDMA_C19ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c19esr::R`](R) reader structure
impl crate::Readable for MDMA_C19ESRrs {}
///`reset()` method sets MDMA_C19ESR to value 0
impl crate::Resettable for MDMA_C19ESRrs {
