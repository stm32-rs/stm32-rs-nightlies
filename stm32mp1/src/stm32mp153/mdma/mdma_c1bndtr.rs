...
pub type R = crate::R<MDMA_C1BNDTRrs>;
#[doc = "Register `MDMA_C1BNDTR` writer"]
pub type W = crate::W<MDMA_C1BNDTRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bndt(&mut self) -> BNDT_W<MDMA_C1BNDTRrs> {
        BNDT_W::new(self, 0)
    }
    #[doc = "Bit 18 - BRSUM"]
    #[inline(always)]
    #[must_use]
    pub fn brsum(&mut self) -> BRSUM_W<MDMA_C1BNDTRrs> {
        BRSUM_W::new(self, 18)
    }
    #[doc = "Bit 19 - BRDUM"]
    #[inline(always)]
    #[must_use]
    pub fn brdum(&mut self) -> BRDUM_W<MDMA_C1BNDTRrs> {
        BRDUM_W::new(self, 19)
    }
    #[doc = "Bits 20:31 - BRC"]
    #[inline(always)]
    #[must_use]
    pub fn brc(&mut self) -> BRC_W<MDMA_C1BNDTRrs> {
        BRC_W::new(self, 20)
    }
}
...
+ 0x04).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c1bndtr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdma_c1bndtr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDMA_C1BNDTRrs;
impl crate::RegisterSpec for MDMA_C1BNDTRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c1bndtr::R`](R) reader structure"]
impl crate::Readable for MDMA_C1BNDTRrs {}
#[doc = "`write(|w| ..)` method takes [`mdma_c1bndtr::W`](W) writer structure"]
impl crate::Writable for MDMA_C1BNDTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDMA_C1BNDTR to value 0"]
impl crate::Resettable for MDMA_C1BNDTRrs {
