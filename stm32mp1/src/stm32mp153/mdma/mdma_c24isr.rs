///Register `MDMA_C24ISR` reader
pub type R = crate::R<MDMA_C24ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c24isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:MDMA_C24ISR)*/
pub struct MDMA_C24ISRrs;
impl crate::RegisterSpec for MDMA_C24ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c24isr::R`](R) reader structure
impl crate::Readable for MDMA_C24ISRrs {}
///`reset()` method sets MDMA_C24ISR to value 0
impl crate::Resettable for MDMA_C24ISRrs {
