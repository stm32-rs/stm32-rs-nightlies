///Register `MDMA_C25MAR` reader
pub type R = crate::R<MDMA_C25MARrs>;
///Register `MDMA_C25MAR` writer
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c25mar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdma_c25mar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mdma_c25mar::R`](R) reader structure
impl crate::Readable for MDMA_C25MARrs {}
///`write(|w| ..)` method takes [`mdma_c25mar::W`](W) writer structure
impl crate::Writable for MDMA_C25MARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C25MAR to value 0
