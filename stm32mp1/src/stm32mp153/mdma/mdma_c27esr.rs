///Register `MDMA_C27ESR` reader
pub type R = crate::R<MDMA_C27ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c27esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:MDMA_C27ESR)*/
pub struct MDMA_C27ESRrs;
impl crate::RegisterSpec for MDMA_C27ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c27esr::R`](R) reader structure
impl crate::Readable for MDMA_C27ESRrs {}
///`reset()` method sets MDMA_C27ESR to value 0
impl crate::Resettable for MDMA_C27ESRrs {
