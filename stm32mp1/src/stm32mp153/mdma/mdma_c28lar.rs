...
pub type R = crate::R<MDMA_C28LARrs>;
///Register `MDMA_C28LAR` writer
pub type W = crate::W<MDMA_C28LARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lar(&mut self) -> LAR_W<MDMA_C28LARrs> {
        LAR_W::new(self, 0)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c28lar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdma_c28lar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#MDMA:MDMA_C28LAR)*/
pub struct MDMA_C28LARrs;
impl crate::RegisterSpec for MDMA_C28LARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c28lar::R`](R) reader structure
impl crate::Readable for MDMA_C28LARrs {}
///`write(|w| ..)` method takes [`mdma_c28lar::W`](W) writer structure
impl crate::Writable for MDMA_C28LARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C28LAR to value 0
impl crate::Resettable for MDMA_C28LARrs {
