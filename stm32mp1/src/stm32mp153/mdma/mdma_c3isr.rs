///Register `MDMA_C3ISR` reader
pub type R = crate::R<MDMA_C3ISRrs>;
...
pub struct MDMA_C3ISRrs;
impl crate::RegisterSpec for MDMA_C3ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c3isr::R`](R) reader structure
impl crate::Readable for MDMA_C3ISRrs {}
///`reset()` method sets MDMA_C3ISR to value 0
impl crate::Resettable for MDMA_C3ISRrs {
