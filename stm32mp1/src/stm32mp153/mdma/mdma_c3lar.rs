///Register `MDMA_C3LAR` reader
pub type R = crate::R<MDMA_C3LARrs>;
///Register `MDMA_C3LAR` writer
pub type W = crate::W<MDMA_C3LARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lar(&mut self) -> LAR_W<MDMA_C3LARrs> {
        LAR_W::new(self, 0)
    }
}
...
pub struct MDMA_C3LARrs;
impl crate::RegisterSpec for MDMA_C3LARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c3lar::R`](R) reader structure
impl crate::Readable for MDMA_C3LARrs {}
///`write(|w| ..)` method takes [`mdma_c3lar::W`](W) writer structure
impl crate::Writable for MDMA_C3LARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C3LAR to value 0
impl crate::Resettable for MDMA_C3LARrs {
