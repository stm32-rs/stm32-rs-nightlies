...
pub type R = crate::R<MDMA_C4BNDTRrs>;
///Register `MDMA_C4BNDTR` writer
pub type W = crate::W<MDMA_C4BNDTRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bndt(&mut self) -> BNDT_W<MDMA_C4BNDTRrs> {
        BNDT_W::new(self, 0)
    }
    ///Bit 18 - BRSUM
    #[inline(always)]
    #[must_use]
    pub fn brsum(&mut self) -> BRSUM_W<MDMA_C4BNDTRrs> {
        BRSUM_W::new(self, 18)
    }
    ///Bit 19 - BRDUM
    #[inline(always)]
    #[must_use]
    pub fn brdum(&mut self) -> BRDUM_W<MDMA_C4BNDTRrs> {
        BRDUM_W::new(self, 19)
    }
    ///Bits 20:31 - BRC
    #[inline(always)]
    #[must_use]
    pub fn brc(&mut self) -> BRC_W<MDMA_C4BNDTRrs> {
        BRC_W::new(self, 20)
    }
}
...
pub struct MDMA_C4BNDTRrs;
impl crate::RegisterSpec for MDMA_C4BNDTRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c4bndtr::R`](R) reader structure
impl crate::Readable for MDMA_C4BNDTRrs {}
///`write(|w| ..)` method takes [`mdma_c4bndtr::W`](W) writer structure
impl crate::Writable for MDMA_C4BNDTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C4BNDTR to value 0
impl crate::Resettable for MDMA_C4BNDTRrs {
