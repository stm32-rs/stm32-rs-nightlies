///Register `MDMA_C4ISR` reader
pub type R = crate::R<MDMA_C4ISRrs>;
...
pub struct MDMA_C4ISRrs;
impl crate::RegisterSpec for MDMA_C4ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c4isr::R`](R) reader structure
impl crate::Readable for MDMA_C4ISRrs {}
///`reset()` method sets MDMA_C4ISR to value 0
impl crate::Resettable for MDMA_C4ISRrs {
