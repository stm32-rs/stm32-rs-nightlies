...
pub type R = crate::R<MDMA_C6BRURrs>;
///Register `MDMA_C6BRUR` writer
pub type W = crate::W<MDMA_C6BRURrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn suv(&mut self) -> SUV_W<MDMA_C6BRURrs> {
        SUV_W::new(self, 0)
    }
    ///Bits 16:31 - DUV
    #[inline(always)]
    #[must_use]
    pub fn duv(&mut self) -> DUV_W<MDMA_C6BRURrs> {
        DUV_W::new(self, 16)
    }
}
...
pub struct MDMA_C6BRURrs;
impl crate::RegisterSpec for MDMA_C6BRURrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c6brur::R`](R) reader structure
impl crate::Readable for MDMA_C6BRURrs {}
///`write(|w| ..)` method takes [`mdma_c6brur::W`](W) writer structure
impl crate::Writable for MDMA_C6BRURrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C6BRUR to value 0
impl crate::Resettable for MDMA_C6BRURrs {
