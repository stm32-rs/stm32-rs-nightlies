///Register `MDMA_C6ESR` reader
pub type R = crate::R<MDMA_C6ESRrs>;
...
pub struct MDMA_C6ESRrs;
impl crate::RegisterSpec for MDMA_C6ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c6esr::R`](R) reader structure
impl crate::Readable for MDMA_C6ESRrs {}
///`reset()` method sets MDMA_C6ESR to value 0
impl crate::Resettable for MDMA_C6ESRrs {
