///Register `MDMA_C6ISR` reader
pub type R = crate::R<MDMA_C6ISRrs>;
...
pub struct MDMA_C6ISRrs;
impl crate::RegisterSpec for MDMA_C6ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c6isr::R`](R) reader structure
impl crate::Readable for MDMA_C6ISRrs {}
///`reset()` method sets MDMA_C6ISR to value 0
impl crate::Resettable for MDMA_C6ISRrs {
