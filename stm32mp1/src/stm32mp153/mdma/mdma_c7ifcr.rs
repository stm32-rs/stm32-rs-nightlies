...
impl core::fmt::Debug for crate::generic::Reg<MDMA_C7IFCRrs> {
...
///`write(|w| ..)` method takes [`mdma_c7ifcr::W`](W) writer structure
impl crate::Writable for MDMA_C7IFCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C7IFCR to value 0
