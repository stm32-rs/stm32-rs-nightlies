///Register `MDMA_C7ISR` reader
pub type R = crate::R<MDMA_C7ISRrs>;
...
pub struct MDMA_C7ISRrs;
impl crate::RegisterSpec for MDMA_C7ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c7isr::R`](R) reader structure
impl crate::Readable for MDMA_C7ISRrs {}
///`reset()` method sets MDMA_C7ISR to value 0
impl crate::Resettable for MDMA_C7ISRrs {
