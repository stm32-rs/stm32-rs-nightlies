...
pub type R = crate::R<MDMA_C8MARrs>;
///Register `MDMA_C8MAR` writer
pub type W = crate::W<MDMA_C8MARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mar(&mut self) -> MAR_W<MDMA_C8MARrs> {
        MAR_W::new(self, 0)
    }
}
...
pub struct MDMA_C8MARrs;
impl crate::RegisterSpec for MDMA_C8MARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c8mar::R`](R) reader structure
impl crate::Readable for MDMA_C8MARrs {}
///`write(|w| ..)` method takes [`mdma_c8mar::W`](W) writer structure
impl crate::Writable for MDMA_C8MARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C8MAR to value 0
impl crate::Resettable for MDMA_C8MARrs {
