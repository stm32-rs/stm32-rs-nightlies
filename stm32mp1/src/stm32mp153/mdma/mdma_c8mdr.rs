///Register `MDMA_C8MDR` reader
pub type R = crate::R<MDMA_C8MDRrs>;
///Register `MDMA_C8MDR` writer
pub type W = crate::W<MDMA_C8MDRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdr(&mut self) -> MDR_W<MDMA_C8MDRrs> {
        MDR_W::new(self, 0)
    }
}
...
pub struct MDMA_C8MDRrs;
impl crate::RegisterSpec for MDMA_C8MDRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c8mdr::R`](R) reader structure
impl crate::Readable for MDMA_C8MDRrs {}
///`write(|w| ..)` method takes [`mdma_c8mdr::W`](W) writer structure
impl crate::Writable for MDMA_C8MDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C8MDR to value 0
impl crate::Resettable for MDMA_C8MDRrs {
