///Register `MDMA_C9ESR` reader
pub type R = crate::R<MDMA_C9ESRrs>;
...
pub struct MDMA_C9ESRrs;
impl crate::RegisterSpec for MDMA_C9ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c9esr::R`](R) reader structure
impl crate::Readable for MDMA_C9ESRrs {}
///`reset()` method sets MDMA_C9ESR to value 0
impl crate::Resettable for MDMA_C9ESRrs {
