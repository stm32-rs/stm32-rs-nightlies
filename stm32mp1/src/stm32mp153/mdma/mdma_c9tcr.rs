...
pub type R = crate::R<MDMA_C9TCRrs>;
///Register `MDMA_C9TCR` writer
pub type W = crate::W<MDMA_C9TCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sinc(&mut self) -> SINC_W<MDMA_C9TCRrs> {
        SINC_W::new(self, 0)
    }
    ///Bits 2:3 - DINC
    #[inline(always)]
    #[must_use]
    pub fn dinc(&mut self) -> DINC_W<MDMA_C9TCRrs> {
        DINC_W::new(self, 2)
    }
    ///Bits 4:5 - SSIZE
    #[inline(always)]
    #[must_use]
    pub fn ssize(&mut self) -> SSIZE_W<MDMA_C9TCRrs> {
        SSIZE_W::new(self, 4)
    }
    ///Bits 6:7 - DSIZE
    #[inline(always)]
    #[must_use]
    pub fn dsize(&mut self) -> DSIZE_W<MDMA_C9TCRrs> {
        DSIZE_W::new(self, 6)
    }
    ///Bits 8:9 - SINCOS
    #[inline(always)]
    #[must_use]
    pub fn sincos(&mut self) -> SINCOS_W<MDMA_C9TCRrs> {
        SINCOS_W::new(self, 8)
    }
    ///Bits 10:11 - DINCOS
    #[inline(always)]
    #[must_use]
    pub fn dincos(&mut self) -> DINCOS_W<MDMA_C9TCRrs> {
        DINCOS_W::new(self, 10)
    }
    ///Bits 12:14 - SBURST
    #[inline(always)]
    #[must_use]
    pub fn sburst(&mut self) -> SBURST_W<MDMA_C9TCRrs> {
        SBURST_W::new(self, 12)
    }
    ///Bits 15:17 - DBURST
    #[inline(always)]
    #[must_use]
    pub fn dburst(&mut self) -> DBURST_W<MDMA_C9TCRrs> {
        DBURST_W::new(self, 15)
    }
    ///Bits 18:24 - TLEN
    #[inline(always)]
    #[must_use]
    pub fn tlen(&mut self) -> TLEN_W<MDMA_C9TCRrs> {
        TLEN_W::new(self, 18)
    }
    ///Bit 25 - PKE
    #[inline(always)]
    #[must_use]
    pub fn pke(&mut self) -> PKE_W<MDMA_C9TCRrs> {
        PKE_W::new(self, 25)
    }
    ///Bits 26:27 - PAM
    #[inline(always)]
    #[must_use]
    pub fn pam(&mut self) -> PAM_W<MDMA_C9TCRrs> {
        PAM_W::new(self, 26)
    }
    ///Bits 28:29 - TRGM
    #[inline(always)]
    #[must_use]
    pub fn trgm(&mut self) -> TRGM_W<MDMA_C9TCRrs> {
        TRGM_W::new(self, 28)
    }
    ///Bit 30 - SWRM
    #[inline(always)]
    #[must_use]
    pub fn swrm(&mut self) -> SWRM_W<MDMA_C9TCRrs> {
        SWRM_W::new(self, 30)
    }
    ///Bit 31 - BWM
    #[inline(always)]
    #[must_use]
    pub fn bwm(&mut self) -> BWM_W<MDMA_C9TCRrs> {
        BWM_W::new(self, 31)
    }
}
...
pub struct MDMA_C9TCRrs;
impl crate::RegisterSpec for MDMA_C9TCRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c9tcr::R`](R) reader structure
impl crate::Readable for MDMA_C9TCRrs {}
///`write(|w| ..)` method takes [`mdma_c9tcr::W`](W) writer structure
impl crate::Writable for MDMA_C9TCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C9TCR to value 0
impl crate::Resettable for MDMA_C9TCRrs {
