...
pub struct RegisterBlock {
    ...
    hs_diepeachmsk1: HS_DIEPEACHMSK1,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn hs_diepeachmsk1(&self) -> &HS_DIEPEACHMSK1 {
        &self.hs_diepeachmsk1
    }
...
/**GOTGCTL (rw) register accessor: The OTG_GOTGCTL register controls the behavior and reflects the status of the OTG function of the core.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GOTGCTL)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GOTGINT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GUSBCFG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GRSTCTL)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GINTSTS)
...
pub mod gintsts;
/**GINTMSK (rw) register accessor: This register works with the core interrupt register to interrupt the application. When an interrupt bit is masked, the interrupt associated with that bit is not generated. However, the core interrupt (OTG_GINTSTS) register bit corresponding to that interrupt is still set.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GINTMSK)
...
pub mod gintmsk;
/**GRXSTSR (r) register accessor: This description is for register OTG_GRXSTSR in Device mode. A read to the receive status debug read register returns the contents of the top of the receive FIFO. The core ignores the receive status read when the receive FIFO is empty and returns a value of 0x00000000.

You can [`read`](crate::Reg::read) this register and get [`grxstsr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GRXSTSR)
...
pub mod grxstsr;
/**GRXSTSP (r) register accessor: This description is for register OTG_GRXSTSP in Device mode. Similarly to OTG_GRXSTSR (receive status debug read register) where a read returns the contents of the top of the receive FIFO, a read to OTG_GRXSTSP (receive status read and pop register) additionally pops the top data entry out of the Rx FIFO. The core ignores the receive status pop/read when the receive FIFO is empty and returns a value of 0x00000000. The application must only pop the receive status FIFO when the receive FIFO non-empty bit of the core interrupt register (RXFLVL bit in OTG_GINTSTS) is asserted.

You can [`read`](crate::Reg::read) this register and get [`grxstsp::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GRXSTSP)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GRXFSIZ)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HNPTXFSIZ)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HNPTXSTS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GCCFG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:CID)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:GLPMCFG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HPTXFSIZ)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTXF1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTXF2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTXF3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTXF4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTXF5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTXF6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTXF7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTXF8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCFG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HFIR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HFNUM)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HPTXSTS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HAINT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HAINTMSK)
...
pub mod haintmsk;
/**HFLBADDR (rw) register accessor: This register holds the starting address of the frame list information (scatter/gather mode).
...
module*/
pub type HFLBADDR = crate::Reg<hflbaddr::HFLBADDRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HPRT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ0)
...
pub mod hctsiz0;
/**HCDMA0 (rw) register accessor: OTG host channel 0 DMA address register in buffer DMA \[alternate\]
...
pub mod hcdma0;
/**HCDMAB0 (r) register accessor: OTG host channel-n DMA address buffer register
...
For information about available fields see [`mod@hcdmab0`]
module*/
pub type HCDMAB0 = crate::Reg<hcdmab0::HCDMAB0rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK1)
...
pub mod hctsiz1;
/**HCDMA1 (rw) register accessor: OTG host channel 1 DMA address register in buffer DMA \[alternate\]
...
pub mod hcdma1;
/**HCDMAB1 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB1)

For information about available fields see [`mod@hcdmab1`]
module*/
pub type HCDMAB1 = crate::Reg<hcdmab1::HCDMAB1rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab1;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ2)
...
pub mod hctsiz2;
/**HCDMA2 (rw) register accessor: OTG host channel 2 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA2)
...
pub mod hcdma2;
/**HCDMAB2 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab2::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB2)

For information about available fields see [`mod@hcdmab2`]
module*/
pub type HCDMAB2 = crate::Reg<hcdmab2::HCDMAB2rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab2;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ3)
...
pub mod hctsiz3;
/**HCDMA3 (rw) register accessor: OTG host channel 3 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA3)
...
pub mod hcdma3;
/**HCDMAB3 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab3::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB3)

For information about available fields see [`mod@hcdmab3`]
module*/
pub type HCDMAB3 = crate::Reg<hcdmab3::HCDMAB3rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab3;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ4)
...
pub mod hctsiz4;
/**HCDMA4 (rw) register accessor: OTG host channel 4 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA4)
...
pub mod hcdma4;
/**HCDMAB4 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab4::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB4)

For information about available fields see [`mod@hcdmab4`]
module*/
pub type HCDMAB4 = crate::Reg<hcdmab4::HCDMAB4rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab4;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ5)
...
pub mod hctsiz5;
/**HCDMA5 (rw) register accessor: OTG host channel 5 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA5)
...
pub mod hcdma5;
/**HCDMAB5 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab5::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB5)

For information about available fields see [`mod@hcdmab5`]
module*/
pub type HCDMAB5 = crate::Reg<hcdmab5::HCDMAB5rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab5;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ6)
...
pub mod hctsiz6;
/**HCDMA6 (rw) register accessor: OTG host channel 6 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA6)
...
pub mod hcdma6;
/**HCDMAB6 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab6::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB6)

For information about available fields see [`mod@hcdmab6`]
module*/
pub type HCDMAB6 = crate::Reg<hcdmab6::HCDMAB6rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab6;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ7)
...
pub mod hctsiz7;
/**HCDMA7 (rw) register accessor: OTG host channel 7 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA7)
...
pub mod hcdma7;
/**HCDMAB7 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab7::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB7)

For information about available fields see [`mod@hcdmab7`]
module*/
pub type HCDMAB7 = crate::Reg<hcdmab7::HCDMAB7rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab7;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ8)
...
pub mod hctsiz8;
/**HCDMA8 (rw) register accessor: OTG host channel 8 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA8)
...
pub mod hcdma8;
/**HCDMAB8 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab8::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB8)

For information about available fields see [`mod@hcdmab8`]
module*/
pub type HCDMAB8 = crate::Reg<hcdmab8::HCDMAB8rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab8;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR9)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT9)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK9)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ9)
...
pub mod hctsiz9;
/**HCDMA9 (rw) register accessor: OTG host channel 9 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA9)
...
pub mod hcdma9;
/**HCDMAB9 (r) register accessor: OTG host channel-n DMA address buffer register
...
For information about available fields see [`mod@hcdmab9`]
module*/
pub type HCDMAB9 = crate::Reg<hcdmab9::HCDMAB9rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab9;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR10)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT10)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT10)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK10)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ10)
...
pub mod hctsiz10;
/**HCDMA10 (rw) register accessor: OTG host channel 10 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA10)
...
pub mod hcdma10;
/**HCDMAB10 (r) register accessor: OTG host channel-n DMA address buffer register
...
For information about available fields see [`mod@hcdmab10`]
module*/
pub type HCDMAB10 = crate::Reg<hcdmab10::HCDMAB10rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab10;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR11)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT11)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT11)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK11)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ11)
...
pub mod hctsiz11;
/**HCDMA11 (rw) register accessor: OTG host channel 11 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA11)
...
pub mod hcdma11;
/**HCDMAB11 (r) register accessor: OTG host channel-n DMA address buffer register
...
For information about available fields see [`mod@hcdmab11`]
module*/
pub type HCDMAB11 = crate::Reg<hcdmab11::HCDMAB11rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab11;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR12)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT12)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT12)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK12)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ12)
...
pub mod hctsiz12;
/**HCDMA12 (rw) register accessor: OTG host channel 12 DMA address register in buffer DMA \[alternate\]
...
pub mod hcdma12;
/**HCDMAB12 (r) register accessor: OTG host channel-n DMA address buffer register
...
For information about available fields see [`mod@hcdmab12`]
module*/
pub type HCDMAB12 = crate::Reg<hcdmab12::HCDMAB12rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab12;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR13)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT13)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT13)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK13)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ13)
...
pub mod hctsiz13;
/**HCDMA13 (rw) register accessor: OTG host channel 13 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA13)
...
pub mod hcdma13;
/**HCDMAB13 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab13::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB13)

For information about available fields see [`mod@hcdmab13`]
module*/
pub type HCDMAB13 = crate::Reg<hcdmab13::HCDMAB13rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab13;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR14)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT14)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT14)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK14)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ14)
...
pub mod hctsiz14;
/**HCDMA14 (rw) register accessor: OTG host channel 14 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA14)
...
pub mod hcdma14;
/**HCDMAB14 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab14::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB14)

For information about available fields see [`mod@hcdmab14`]
module*/
pub type HCDMAB14 = crate::Reg<hcdmab14::HCDMAB14rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab14;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCCHAR15)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCSPLT15)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINT15)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCINTMSK15)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCTSIZ15)
...
pub mod hctsiz15;
/**HCDMA15 (rw) register accessor: OTG host channel 15 DMA address register in buffer DMA \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMA15)
...
pub mod hcdma15;
/**HCDMAB15 (r) register accessor: OTG host channel-n DMA address buffer register

You can [`read`](crate::Reg::read) this register and get [`hcdmab15::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HCDMAB15)

For information about available fields see [`mod@hcdmab15`]
module*/
pub type HCDMAB15 = crate::Reg<hcdmab15::HCDMAB15rs>;
///OTG host channel-n DMA address buffer register
pub mod hcdmab15;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DCFG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DCTL)
...
pub mod dctl;
/**DSTS (r) register accessor: This register indicates the status of the core with respect to USB-related events. It must be read on interrupts from the device all interrupts (OTG_DAINT) register.

You can [`read`](crate::Reg::read) this register and get [`dsts::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DSTS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPMSK)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPMSK)
...
pub mod doepmsk;
/**DAINT (r) register accessor: When a significant event occurs on an endpoint, a OTG_DAINT register interrupts the application using the device OUT endpoints interrupt bit or device IN endpoints interrupt bit of the OTG_GINTSTS register (OEPINT or IEPINT in OTG_GINTSTS, respectively). There is one interrupt bit per endpoint, up to a maximum of 16 bits for OUT endpoints and 16 bits for IN endpoints. For a bidirectional endpoint, the corresponding IN and OUT interrupt bits are used. Bits in this register are set and cleared when the application sets and clears bits in the corresponding device endpoint-x interrupt register (OTG_DIEPINTx/OTG_DOEPINTx).

You can [`read`](crate::Reg::read) this register and get [`daint::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DAINT)
...
pub mod daint;
/**DAINTMSK (rw) register accessor: The OTG_DAINTMSK register works with the device endpoint interrupt register to interrupt the application when an event occurs on a device endpoint. However, the OTG_DAINT register bit corresponding to that interrupt is still set.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DAINTMSK)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DVBUSDIS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DTHRCTL)
...
pub mod dthrctl;
/**DIEPEMPMSK (rw) register accessor: This register is used to control the IN endpoint FIFO empty interrupt generation (TXFE_OTG_DIEPINTx).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPEMPMSK)
...
pub mod diepempmsk;
/**DEACHINT (r) register accessor: OTG device each endpoint interrupt register

You can [`read`](crate::Reg::read) this register and get [`deachint::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DEACHINT)
...
pub mod deachint;
/**DEACHINTMSK (rw) register accessor: There is one interrupt bit for endpoint 1 IN and one interrupt bit for endpoint 1 OUT.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DEACHINTMSK)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:HS_DOEPEACHMSK1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPCTL0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPINT0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTSIZ0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPDMA0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DTXFSTS0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPCTL1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPINT1)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod diepint1;
/**DIEPTSIZ1 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTSIZ1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPDMA1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DTXFSTS1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPCTL2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPINT2)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod diepint2;
/**DIEPTSIZ2 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTSIZ2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPDMA2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DTXFSTS2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPCTL3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPINT3)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod diepint3;
/**DIEPTSIZ3 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTSIZ3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPDMA3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DTXFSTS3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPCTL4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPINT4)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod diepint4;
/**DIEPTSIZ4 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTSIZ4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPDMA4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DTXFSTS4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPCTL5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPINT5)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod diepint5;
/**DIEPTSIZ5 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTSIZ5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DTXFSTS5)
...
///This read-only register contains the free space information for the device IN endpoint Tx FIFO.
pub mod dtxfsts5;
/**DIEPCTL6 (rw) register accessor: The application uses this register to control the behavior of each logical endpoint other than endpoint 0.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPCTL6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPINT6)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod diepint6;
/**DIEPTSIZ6 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPDMA6)
...
pub mod diepdma6;
/**DTXFSTS6 (r) register accessor: This read-only register contains the free space information for the device IN endpoint Tx FIFO.
...
///This read-only register contains the free space information for the device IN endpoint Tx FIFO.
pub mod dtxfsts6;
/**DIEPCTL7 (rw) register accessor: The application uses this register to control the behavior of each logical endpoint other than endpoint 0.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPCTL7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPINT7)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod diepint7;
/**DIEPTSIZ7 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTSIZ7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPDMA7)
...
pub mod diepdma7;
/**DTXFSTS7 (r) register accessor: This read-only register contains the free space information for the device IN endpoint Tx FIFO.

You can [`read`](crate::Reg::read) this register and get [`dtxfsts7::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DTXFSTS7)
...
///This read-only register contains the free space information for the device IN endpoint Tx FIFO.
pub mod dtxfsts7;
/**DIEPCTL8 (rw) register accessor: The application uses this register to control the behavior of each logical endpoint other than endpoint 0.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPCTL8)

For information about available fields see [`mod@diepctl8`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPINT8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPTSIZ8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DIEPDMA8)
...
pub mod diepdma8;
/**DTXFSTS8 (r) register accessor: This read-only register contains the free space information for the device IN endpoint Tx FIFO.
...
///This read-only register contains the free space information for the device IN endpoint Tx FIFO.
pub mod dtxfsts8;
/**DOEPCTL0 (rw) register accessor: This section describes the OTG_DOEPCTL0 register.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPCTL0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPINT0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPTSIZ0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPDMA0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPCTL1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPINT1)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod doepint1;
/**DOEPTSIZ1 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPTSIZ1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPDMA1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPCTL2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPINT2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPTSIZ2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPDMA2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPCTL3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPINT3)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod doepint3;
/**DOEPTSIZ3 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPTSIZ3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPDMA3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPCTL4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPINT4)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod doepint4;
/**DOEPTSIZ4 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPTSIZ4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPDMA4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPCTL5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPINT5)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod doepint5;
/**DOEPTSIZ5 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPTSIZ5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPDMA5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPCTL6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPINT6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPTSIZ6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPDMA6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPCTL7)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod doepint7;
/**DOEPTSIZ7 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPTSIZ7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPDMA7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPCTL8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPINT8)
...
///This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers.
pub mod doepint8;
/**DOEPTSIZ8 (rw) register accessor: The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPTSIZ8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:DOEPDMA8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:PCGCCTL)
