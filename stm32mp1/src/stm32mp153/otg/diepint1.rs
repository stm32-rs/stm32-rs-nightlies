...
impl W {
    ...
    ///Bit 2 - AHBERR
    #[inline(always)]
    pub fn ahberr(&mut self) -> AHBERR_W<'_, DIEPINT1rs> {
        AHBERR_W::new(self, 2)
    }
    ///Bit 3 - TOC
    #[inline(always)]
    ...
    ///Bit 5 - INEPNM
    #[inline(always)]
    pub fn inepnm(&mut self) -> INEPNM_W<'_, DIEPINT1rs> {
        INEPNM_W::new(self, 5)
    }
    ///Bit 8 - TXFIFOUDRN
    #[inline(always)]
    pub fn txfifoudrn(&mut self) -> TXFIFOUDRN_W<'_, DIEPINT1rs> {
        TXFIFOUDRN_W::new(self, 8)
    }
    ///Bit 9 - BNA
    #[inline(always)]
    pub fn bna(&mut self) -> BNA_W<'_, DIEPINT1rs> {
        BNA_W::new(self, 9)
    }
    ///Bit 11 - PKTDRPSTS
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PKTDRPSTS_W<'_, DIEPINT1rs> {
        PKTDRPSTS_W::new(self, 11)
    }
    ///Bit 13 - NAK
    #[inline(always)]
    pub fn nak(&mut self) -> NAK_W<'_, DIEPINT1rs> {
        NAK_W::new(self, 13)
    }
}
