///Register `DOEPCTL6` reader
pub type R = crate::R<DOEPCTL6rs>;
///Register `DOEPCTL6` writer
pub type W = crate::W<DOEPCTL6rs>;
...
impl W {
    ///Bits 0:10 - MPSIZ
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MPSIZ_W<'_, DOEPCTL6rs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bit 15 - USBAEP
    #[inline(always)]
    pub fn usbaep(&mut self) -> USBAEP_W<'_, DOEPCTL6rs> {
        USBAEP_W::new(self, 15)
    }
    ///Bits 18:19 - EPTYP
    #[inline(always)]
    pub fn eptyp(&mut self) -> EPTYP_W<'_, DOEPCTL6rs> {
        EPTYP_W::new(self, 18)
    }
    ///Bit 20 - SNPM
    #[inline(always)]
    pub fn snpm(&mut self) -> SNPM_W<'_, DOEPCTL6rs> {
        SNPM_W::new(self, 20)
    }
    ///Bit 21 - STALL
    #[inline(always)]
    pub fn stall(&mut self) -> STALL_W<'_, DOEPCTL6rs> {
        STALL_W::new(self, 21)
    }
    ///Bit 26 - CNAK
    #[inline(always)]
    pub fn cnak(&mut self) -> CNAK_W<'_, DOEPCTL6rs> {
        CNAK_W::new(self, 26)
    }
    ///Bit 27 - SNAK
    #[inline(always)]
    pub fn snak(&mut self) -> SNAK_W<'_, DOEPCTL6rs> {
        SNAK_W::new(self, 27)
    }
    ///Bit 28 - SD0PID_SEVNFRM
    #[inline(always)]
    pub fn sd0pid_sevnfrm(&mut self) -> SD0PID_SEVNFRM_W<'_, DOEPCTL6rs> {
        SD0PID_SEVNFRM_W::new(self, 28)
    }
    ///Bit 29 - SD1PID_SODDFRM
    #[inline(always)]
    pub fn sd1pid_soddfrm(&mut self) -> SD1PID_SODDFRM_W<'_, DOEPCTL6rs> {
        SD1PID_SODDFRM_W::new(self, 29)
    }
    ///Bit 30 - EPDIS
    #[inline(always)]
    pub fn epdis(&mut self) -> EPDIS_W<'_, DOEPCTL6rs> {
        EPDIS_W::new(self, 30)
    }
    ///Bit 31 - EPENA
    #[inline(always)]
    pub fn epena(&mut self) -> EPENA_W<'_, DOEPCTL6rs> {
        EPENA_W::new(self, 31)
    }
}
...
pub struct DOEPCTL6rs;
impl crate::RegisterSpec for DOEPCTL6rs {
    type Ux = u32;
}
///`read()` method returns [`doepctl6::R`](R) reader structure
impl crate::Readable for DOEPCTL6rs {}
///`write(|w| ..)` method takes [`doepctl6::W`](W) writer structure
impl crate::Writable for DOEPCTL6rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DOEPCTL6 to value 0
impl crate::Resettable for DOEPCTL6rs {}
