///Register `HCINTMSK10` reader
pub type R = crate::R<HCINTMSK10rs>;
///Register `HCINTMSK10` writer
pub type W = crate::W<HCINTMSK10rs>;
...
impl W {
    ///Bit 0 - XFRCM
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, HCINTMSK10rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - CHHM
    #[inline(always)]
    pub fn chhm(&mut self) -> CHHM_W<'_, HCINTMSK10rs> {
        CHHM_W::new(self, 1)
    }
    ///Bit 2 - AHBERRM
    #[inline(always)]
    pub fn ahberrm(&mut self) -> AHBERRM_W<'_, HCINTMSK10rs> {
        AHBERRM_W::new(self, 2)
    }
    ///Bit 3 - STALLM
    #[inline(always)]
    pub fn stallm(&mut self) -> STALLM_W<'_, HCINTMSK10rs> {
        STALLM_W::new(self, 3)
    }
    ///Bit 4 - NAKM
    #[inline(always)]
    pub fn nakm(&mut self) -> NAKM_W<'_, HCINTMSK10rs> {
        NAKM_W::new(self, 4)
    }
    ///Bit 5 - ACKM
    #[inline(always)]
    pub fn ackm(&mut self) -> ACKM_W<'_, HCINTMSK10rs> {
        ACKM_W::new(self, 5)
    }
    ///Bit 6 - NYET
    #[inline(always)]
    pub fn nyet(&mut self) -> NYET_W<'_, HCINTMSK10rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - TXERRM
    #[inline(always)]
    pub fn txerrm(&mut self) -> TXERRM_W<'_, HCINTMSK10rs> {
        TXERRM_W::new(self, 7)
    }
    ///Bit 8 - BBERRM
    #[inline(always)]
    pub fn bberrm(&mut self) -> BBERRM_W<'_, HCINTMSK10rs> {
        BBERRM_W::new(self, 8)
    }
    ///Bit 9 - FRMORM
    #[inline(always)]
    pub fn frmorm(&mut self) -> FRMORM_W<'_, HCINTMSK10rs> {
        FRMORM_W::new(self, 9)
    }
    ///Bit 10 - DTERRM
    #[inline(always)]
    pub fn dterrm(&mut self) -> DTERRM_W<'_, HCINTMSK10rs> {
        DTERRM_W::new(self, 10)
    }
    ///Bit 11 - BNAMSK
    #[inline(always)]
    pub fn bnamsk(&mut self) -> BNAMSK_W<'_, HCINTMSK10rs> {
        BNAMSK_W::new(self, 11)
    }
    ///Bit 13 - DESCLSTROLLMSK
    #[inline(always)]
    pub fn desclstrollmsk(&mut self) -> DESCLSTROLLMSK_W<'_, HCINTMSK10rs> {
...
pub struct HCINTMSK10rs;
impl crate::RegisterSpec for HCINTMSK10rs {
    type Ux = u32;
}
///`read()` method returns [`hcintmsk10::R`](R) reader structure
impl crate::Readable for HCINTMSK10rs {}
///`write(|w| ..)` method takes [`hcintmsk10::W`](W) writer structure
impl crate::Writable for HCINTMSK10rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HCINTMSK10 to value 0
impl crate::Resettable for HCINTMSK10rs {}
