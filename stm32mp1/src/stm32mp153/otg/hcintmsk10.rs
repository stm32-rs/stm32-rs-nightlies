...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrcm(&mut self) -> XFRCM_W<HCINTMSK10rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - CHHM
    #[inline(always)]
    #[must_use]
    pub fn chhm(&mut self) -> CHHM_W<HCINTMSK10rs> {
        CHHM_W::new(self, 1)
    }
    ///Bit 2 - AHBERRM
    #[inline(always)]
    #[must_use]
    pub fn ahberrm(&mut self) -> AHBERRM_W<HCINTMSK10rs> {
        AHBERRM_W::new(self, 2)
    }
    ///Bit 3 - STALLM
    #[inline(always)]
    #[must_use]
    pub fn stallm(&mut self) -> STALLM_W<HCINTMSK10rs> {
        STALLM_W::new(self, 3)
    }
    ///Bit 4 - NAKM
    #[inline(always)]
    #[must_use]
    pub fn nakm(&mut self) -> NAKM_W<HCINTMSK10rs> {
        NAKM_W::new(self, 4)
    }
    ///Bit 5 - ACKM
    #[inline(always)]
    #[must_use]
    pub fn ackm(&mut self) -> ACKM_W<HCINTMSK10rs> {
        ACKM_W::new(self, 5)
    }
    ///Bit 6 - NYET
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<HCINTMSK10rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - TXERRM
    #[inline(always)]
    #[must_use]
    pub fn txerrm(&mut self) -> TXERRM_W<HCINTMSK10rs> {
        TXERRM_W::new(self, 7)
    }
    ///Bit 8 - BBERRM
    #[inline(always)]
    #[must_use]
    pub fn bberrm(&mut self) -> BBERRM_W<HCINTMSK10rs> {
        BBERRM_W::new(self, 8)
    }
    ///Bit 9 - FRMORM
    #[inline(always)]
    #[must_use]
    pub fn frmorm(&mut self) -> FRMORM_W<HCINTMSK10rs> {
        FRMORM_W::new(self, 9)
    }
    ///Bit 10 - DTERRM
    #[inline(always)]
    #[must_use]
    pub fn dterrm(&mut self) -> DTERRM_W<HCINTMSK10rs> {
        DTERRM_W::new(self, 10)
    }
    ///Bit 11 - BNAMSK
    #[inline(always)]
    #[must_use]
    pub fn bnamsk(&mut self) -> BNAMSK_W<HCINTMSK10rs> {
        BNAMSK_W::new(self, 11)
    }
    ///Bit 13 - DESCLSTROLLMSK
    #[inline(always)]
    #[must_use]
    pub fn desclstrollmsk(&mut self) -> DESCLSTROLLMSK_W<HCINTMSK10rs> {
