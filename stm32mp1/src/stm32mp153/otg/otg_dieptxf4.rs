...
pub type R = crate::R<OTG_DIEPTXF4rs>;
///Register `OTG_DIEPTXF4` writer
pub type W = crate::W<OTG_DIEPTXF4rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ineptxsa(&mut self) -> INEPTXSA_W<OTG_DIEPTXF4rs> {
        INEPTXSA_W::new(self, 0)
    }
    ///Bits 16:31 - INEPTXFD
    #[inline(always)]
    #[must_use]
    pub fn ineptxfd(&mut self) -> INEPTXFD_W<OTG_DIEPTXF4rs> {
        INEPTXFD_W::new(self, 16)
    }
}
/**OTG device IN endpoint transmit FIFO 4 size register

You can [`read`](crate::Reg::read) this register and get [`otg_dieptxf4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_dieptxf4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:OTG_DIEPTXF4)*/
pub struct OTG_DIEPTXF4rs;
impl crate::RegisterSpec for OTG_DIEPTXF4rs {
    type Ux = u32;
}
///`read()` method returns [`otg_dieptxf4::R`](R) reader structure
impl crate::Readable for OTG_DIEPTXF4rs {}
///`write(|w| ..)` method takes [`otg_dieptxf4::W`](W) writer structure
impl crate::Writable for OTG_DIEPTXF4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_DIEPTXF4 to value 0x0200_0400
impl crate::Resettable for OTG_DIEPTXF4rs {
