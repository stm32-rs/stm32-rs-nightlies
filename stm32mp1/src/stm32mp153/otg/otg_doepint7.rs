...
pub type R = crate::R<OTG_DOEPINT7rs>;
///Register `OTG_DOEPINT7` writer
pub type W = crate::W<OTG_DOEPINT7rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrc(&mut self) -> XFRC_W<OTG_DOEPINT7rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - EPDISD
    #[inline(always)]
    #[must_use]
    pub fn epdisd(&mut self) -> EPDISD_W<OTG_DOEPINT7rs> {
        EPDISD_W::new(self, 1)
    }
    ///Bit 2 - AHBERR
    #[inline(always)]
    #[must_use]
    pub fn ahberr(&mut self) -> AHBERR_W<OTG_DOEPINT7rs> {
        AHBERR_W::new(self, 2)
    }
    ///Bit 3 - STUP
    #[inline(always)]
    #[must_use]
    pub fn stup(&mut self) -> STUP_W<OTG_DOEPINT7rs> {
        STUP_W::new(self, 3)
    }
    ///Bit 4 - OTEPDIS
    #[inline(always)]
    #[must_use]
    pub fn otepdis(&mut self) -> OTEPDIS_W<OTG_DOEPINT7rs> {
        OTEPDIS_W::new(self, 4)
    }
    ///Bit 5 - STSPHSRX
    #[inline(always)]
    #[must_use]
    pub fn stsphsrx(&mut self) -> STSPHSRX_W<OTG_DOEPINT7rs> {
        STSPHSRX_W::new(self, 5)
    }
    ///Bit 6 - B2BSTUP
    #[inline(always)]
    #[must_use]
    pub fn b2bstup(&mut self) -> B2BSTUP_W<OTG_DOEPINT7rs> {
        B2BSTUP_W::new(self, 6)
    }
    ///Bit 8 - OUTPKTERR
    #[inline(always)]
    #[must_use]
    pub fn outpkterr(&mut self) -> OUTPKTERR_W<OTG_DOEPINT7rs> {
        OUTPKTERR_W::new(self, 8)
    }
    ///Bit 9 - BNA
    #[inline(always)]
    #[must_use]
    pub fn bna(&mut self) -> BNA_W<OTG_DOEPINT7rs> {
        BNA_W::new(self, 9)
    }
    ///Bit 12 - BERR
    #[inline(always)]
    #[must_use]
    pub fn berr(&mut self) -> BERR_W<OTG_DOEPINT7rs> {
        BERR_W::new(self, 12)
    }
    ///Bit 13 - NAK
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<OTG_DOEPINT7rs> {
        NAK_W::new(self, 13)
    }
    ///Bit 14 - NYET
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<OTG_DOEPINT7rs> {
        NYET_W::new(self, 14)
    }
    ///Bit 15 - STPKTRX
    #[inline(always)]
    #[must_use]
    pub fn stpktrx(&mut self) -> STPKTRX_W<OTG_DOEPINT7rs> {
...
You can [`read`](crate::Reg::read) this register and get [`otg_doepint7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_doepint7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:OTG_DOEPINT7)*/
pub struct OTG_DOEPINT7rs;
impl crate::RegisterSpec for OTG_DOEPINT7rs {
    type Ux = u32;
}
///`read()` method returns [`otg_doepint7::R`](R) reader structure
impl crate::Readable for OTG_DOEPINT7rs {}
///`write(|w| ..)` method takes [`otg_doepint7::W`](W) writer structure
impl crate::Writable for OTG_DOEPINT7rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_DOEPINT7 to value 0x80
impl crate::Resettable for OTG_DOEPINT7rs {
