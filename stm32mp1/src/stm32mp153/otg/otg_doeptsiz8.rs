///Register `OTG_DOEPTSIZ8` reader
pub type R = crate::R<OTG_DOEPTSIZ8rs>;
///Register `OTG_DOEPTSIZ8` writer
...
///`read()` method returns [`otg_doeptsiz8::R`](R) reader structure
impl crate::Readable for OTG_DOEPTSIZ8rs {}
///`write(|w| ..)` method takes [`otg_doeptsiz8::W`](W) writer structure
impl crate::Writable for OTG_DOEPTSIZ8rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_DOEPTSIZ8 to value 0
