...
You can [`read`](crate::Reg::read) this register and get [`otg_dtxfsts7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`otg_dtxfsts7::R`](R) reader structure
impl crate::Readable for OTG_DTXFSTS7rs {}
///`reset()` method sets OTG_DTXFSTS7 to value 0x0200
