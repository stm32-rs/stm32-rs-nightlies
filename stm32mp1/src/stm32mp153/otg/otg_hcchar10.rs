///Register `OTG_HCCHAR10` reader
pub type R = crate::R<OTG_HCCHAR10rs>;
///Register `OTG_HCCHAR10` writer
pub type W = crate::W<OTG_HCCHAR10rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mpsiz(&mut self) -> MPSIZ_W<OTG_HCCHAR10rs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bits 11:14 - EPNUM
    #[inline(always)]
    #[must_use]
    pub fn epnum(&mut self) -> EPNUM_W<OTG_HCCHAR10rs> {
        EPNUM_W::new(self, 11)
    }
    ///Bit 15 - EPDIR
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EPDIR_W<OTG_HCCHAR10rs> {
        EPDIR_W::new(self, 15)
    }
    ///Bit 17 - LSDEV
    #[inline(always)]
    #[must_use]
    pub fn lsdev(&mut self) -> LSDEV_W<OTG_HCCHAR10rs> {
        LSDEV_W::new(self, 17)
    }
    ///Bits 18:19 - EPTYP
    #[inline(always)]
    #[must_use]
    pub fn eptyp(&mut self) -> EPTYP_W<OTG_HCCHAR10rs> {
        EPTYP_W::new(self, 18)
    }
    ///Bits 20:21 - MCNT
    #[inline(always)]
    #[must_use]
    pub fn mcnt(&mut self) -> MCNT_W<OTG_HCCHAR10rs> {
        MCNT_W::new(self, 20)
    }
    ///Bits 22:28 - DAD
    #[inline(always)]
    #[must_use]
    pub fn dad(&mut self) -> DAD_W<OTG_HCCHAR10rs> {
        DAD_W::new(self, 22)
    }
    ///Bit 30 - CHDIS
    #[inline(always)]
    #[must_use]
    pub fn chdis(&mut self) -> CHDIS_W<OTG_HCCHAR10rs> {
        CHDIS_W::new(self, 30)
    }
    ///Bit 31 - CHENA
    #[inline(always)]
    #[must_use]
    pub fn chena(&mut self) -> CHENA_W<OTG_HCCHAR10rs> {
        CHENA_W::new(self, 31)
    }
}
/**OTG host channel 10 characteristics register

You can [`read`](crate::Reg::read) this register and get [`otg_hcchar10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hcchar10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:OTG_HCCHAR10)*/
pub struct OTG_HCCHAR10rs;
impl crate::RegisterSpec for OTG_HCCHAR10rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hcchar10::R`](R) reader structure
impl crate::Readable for OTG_HCCHAR10rs {}
///`write(|w| ..)` method takes [`otg_hcchar10::W`](W) writer structure
impl crate::Writable for OTG_HCCHAR10rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_HCCHAR10 to value 0
impl crate::Resettable for OTG_HCCHAR10rs {
