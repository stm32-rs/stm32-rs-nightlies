///Register `OTG_HCCHAR14` reader
pub type R = crate::R<OTG_HCCHAR14rs>;
///Register `OTG_HCCHAR14` writer
...
You can [`read`](crate::Reg::read) this register and get [`otg_hcchar14::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hcchar14::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`otg_hcchar14::R`](R) reader structure
impl crate::Readable for OTG_HCCHAR14rs {}
///`write(|w| ..)` method takes [`otg_hcchar14::W`](W) writer structure
impl crate::Writable for OTG_HCCHAR14rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_HCCHAR14 to value 0
