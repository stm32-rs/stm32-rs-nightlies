...
You can [`read`](crate::Reg::read) this register and get [`otg_hcdmab0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`otg_hcdmab0::R`](R) reader structure
impl crate::Readable for OTG_HCDMAB0rs {}
///`reset()` method sets OTG_HCDMAB0 to value 0
