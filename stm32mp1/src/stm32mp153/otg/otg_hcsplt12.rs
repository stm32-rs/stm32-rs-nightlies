///Register `OTG_HCSPLT12` reader
pub type R = crate::R<OTG_HCSPLT12rs>;
///Register `OTG_HCSPLT12` writer
pub type W = crate::W<OTG_HCSPLT12rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prtaddr(&mut self) -> PRTADDR_W<OTG_HCSPLT12rs> {
        PRTADDR_W::new(self, 0)
    }
    ///Bits 7:13 - HUBADDR
    #[inline(always)]
    #[must_use]
    pub fn hubaddr(&mut self) -> HUBADDR_W<OTG_HCSPLT12rs> {
        HUBADDR_W::new(self, 7)
    }
    ///Bits 14:15 - XACTPOS
    #[inline(always)]
    #[must_use]
    pub fn xactpos(&mut self) -> XACTPOS_W<OTG_HCSPLT12rs> {
        XACTPOS_W::new(self, 14)
    }
    ///Bit 16 - COMPLSPLT
    #[inline(always)]
    #[must_use]
    pub fn complsplt(&mut self) -> COMPLSPLT_W<OTG_HCSPLT12rs> {
        COMPLSPLT_W::new(self, 16)
    }
    ///Bit 31 - SPLITEN
    #[inline(always)]
    #[must_use]
    pub fn spliten(&mut self) -> SPLITEN_W<OTG_HCSPLT12rs> {
        SPLITEN_W::new(self, 31)
    }
}
/**OTG host channel 12 split control register

You can [`read`](crate::Reg::read) this register and get [`otg_hcsplt12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hcsplt12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#OTG:OTG_HCSPLT12)*/
pub struct OTG_HCSPLT12rs;
impl crate::RegisterSpec for OTG_HCSPLT12rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hcsplt12::R`](R) reader structure
impl crate::Readable for OTG_HCSPLT12rs {}
///`write(|w| ..)` method takes [`otg_hcsplt12::W`](W) writer structure
impl crate::Writable for OTG_HCSPLT12rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_HCSPLT12 to value 0
impl crate::Resettable for OTG_HCSPLT12rs {
