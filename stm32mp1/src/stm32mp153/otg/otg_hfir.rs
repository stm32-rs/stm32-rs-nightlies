///Register `OTG_HFIR` reader
pub type R = crate::R<OTG_HFIRrs>;
///Register `OTG_HFIR` writer
...
You can [`read`](crate::Reg::read) this register and get [`otg_hfir::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hfir::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`otg_hfir::R`](R) reader structure
impl crate::Readable for OTG_HFIRrs {}
///`write(|w| ..)` method takes [`otg_hfir::W`](W) writer structure
impl crate::Writable for OTG_HFIRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_HFIR to value 0xea60
