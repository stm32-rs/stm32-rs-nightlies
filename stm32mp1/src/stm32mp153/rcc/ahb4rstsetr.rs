///Register `AHB4RSTSETR` reader
pub type R = crate::R<AHB4RSTSETRrs>;
///Register `AHB4RSTSETR` writer
pub type W = crate::W<AHB4RSTSETRrs>;
...
impl W {
    ///Bit 0 - GPIOARST
    #[inline(always)]
    pub fn gpioarst(&mut self) -> GPIOARST_W<'_, AHB4RSTSETRrs> {
        GPIOARST_W::new(self, 0)
    }
    ///Bit 1 - GPIOBRST
    #[inline(always)]
    pub fn gpiobrst(&mut self) -> GPIOBRST_W<'_, AHB4RSTSETRrs> {
        GPIOBRST_W::new(self, 1)
    }
    ///Bit 2 - GPIOCRST
    #[inline(always)]
    pub fn gpiocrst(&mut self) -> GPIOCRST_W<'_, AHB4RSTSETRrs> {
        GPIOCRST_W::new(self, 2)
    }
    ///Bit 3 - GPIODRST
    #[inline(always)]
    pub fn gpiodrst(&mut self) -> GPIODRST_W<'_, AHB4RSTSETRrs> {
        GPIODRST_W::new(self, 3)
    }
    ///Bit 4 - GPIOERST
    #[inline(always)]
    pub fn gpioerst(&mut self) -> GPIOERST_W<'_, AHB4RSTSETRrs> {
        GPIOERST_W::new(self, 4)
    }
    ///Bit 5 - GPIOFRST
    #[inline(always)]
    pub fn gpiofrst(&mut self) -> GPIOFRST_W<'_, AHB4RSTSETRrs> {
        GPIOFRST_W::new(self, 5)
    }
    ///Bit 6 - GPIOGRST
    #[inline(always)]
    pub fn gpiogrst(&mut self) -> GPIOGRST_W<'_, AHB4RSTSETRrs> {
        GPIOGRST_W::new(self, 6)
    }
    ///Bit 7 - GPIOHRST
    #[inline(always)]
    pub fn gpiohrst(&mut self) -> GPIOHRST_W<'_, AHB4RSTSETRrs> {
        GPIOHRST_W::new(self, 7)
    }
    ///Bit 8 - GPIOIRST
    #[inline(always)]
    pub fn gpioirst(&mut self) -> GPIOIRST_W<'_, AHB4RSTSETRrs> {
        GPIOIRST_W::new(self, 8)
    }
    ///Bit 9 - GPIOJRST
    #[inline(always)]
    pub fn gpiojrst(&mut self) -> GPIOJRST_W<'_, AHB4RSTSETRrs> {
        GPIOJRST_W::new(self, 9)
    }
    ///Bit 10 - GPIOKRST
    #[inline(always)]
    pub fn gpiokrst(&mut self) -> GPIOKRST_W<'_, AHB4RSTSETRrs> {
        GPIOKRST_W::new(self, 10)
    }
}
/**This register is used to activate the reset of the corresponding peripheral

You can [`read`](crate::Reg::read) this register and get [`ahb4rstsetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ahb4rstsetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:AHB4RSTSETR)*/
pub struct AHB4RSTSETRrs;
impl crate::RegisterSpec for AHB4RSTSETRrs {
    type Ux = u32;
}
///`read()` method returns [`ahb4rstsetr::R`](R) reader structure
impl crate::Readable for AHB4RSTSETRrs {}
///`write(|w| ..)` method takes [`ahb4rstsetr::W`](W) writer structure
impl crate::Writable for AHB4RSTSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets AHB4RSTSETR to value 0
impl crate::Resettable for AHB4RSTSETRrs {}
