...
impl W {
    ///Bit 0 - TIM2RST
    #[inline(always)]
    pub fn tim2rst(&mut self) -> TIM2RST_W<APB1RSTSETRrs> {
        TIM2RST_W::new(self, 0)
    }
    ///Bit 1 - TIM3RST
    #[inline(always)]
    pub fn tim3rst(&mut self) -> TIM3RST_W<APB1RSTSETRrs> {
        TIM3RST_W::new(self, 1)
    }
    ///Bit 2 - TIM4RST
    #[inline(always)]
    pub fn tim4rst(&mut self) -> TIM4RST_W<APB1RSTSETRrs> {
        TIM4RST_W::new(self, 2)
    }
    ///Bit 3 - TIM5RST
    #[inline(always)]
    pub fn tim5rst(&mut self) -> TIM5RST_W<APB1RSTSETRrs> {
        TIM5RST_W::new(self, 3)
    }
    ///Bit 4 - TIM6RST
    #[inline(always)]
    pub fn tim6rst(&mut self) -> TIM6RST_W<APB1RSTSETRrs> {
        TIM6RST_W::new(self, 4)
    }
    ///Bit 5 - TIM7RST
    #[inline(always)]
    pub fn tim7rst(&mut self) -> TIM7RST_W<APB1RSTSETRrs> {
        TIM7RST_W::new(self, 5)
    }
    ///Bit 6 - TIM12RST
    #[inline(always)]
    pub fn tim12rst(&mut self) -> TIM12RST_W<APB1RSTSETRrs> {
        TIM12RST_W::new(self, 6)
    }
    ///Bit 7 - TIM13RST
    #[inline(always)]
    pub fn tim13rst(&mut self) -> TIM13RST_W<APB1RSTSETRrs> {
        TIM13RST_W::new(self, 7)
    }
    ///Bit 8 - TIM14RST
    #[inline(always)]
    pub fn tim14rst(&mut self) -> TIM14RST_W<APB1RSTSETRrs> {
        TIM14RST_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1RST
    #[inline(always)]
    pub fn lptim1rst(&mut self) -> LPTIM1RST_W<APB1RSTSETRrs> {
        LPTIM1RST_W::new(self, 9)
    }
    ///Bit 11 - SPI2RST
    #[inline(always)]
    pub fn spi2rst(&mut self) -> SPI2RST_W<APB1RSTSETRrs> {
        SPI2RST_W::new(self, 11)
    }
    ///Bit 12 - SPI3RST
    #[inline(always)]
    pub fn spi3rst(&mut self) -> SPI3RST_W<APB1RSTSETRrs> {
        SPI3RST_W::new(self, 12)
    }
    ///Bit 14 - USART2RST
    #[inline(always)]
    pub fn usart2rst(&mut self) -> USART2RST_W<APB1RSTSETRrs> {
        USART2RST_W::new(self, 14)
    }
    ///Bit 15 - USART3RST
    #[inline(always)]
    pub fn usart3rst(&mut self) -> USART3RST_W<APB1RSTSETRrs> {
        USART3RST_W::new(self, 15)
    }
    ///Bit 16 - UART4RST
    #[inline(always)]
    pub fn uart4rst(&mut self) -> UART4RST_W<APB1RSTSETRrs> {
        UART4RST_W::new(self, 16)
    }
    ///Bit 17 - UART5RST
    #[inline(always)]
    pub fn uart5rst(&mut self) -> UART5RST_W<APB1RSTSETRrs> {
        UART5RST_W::new(self, 17)
    }
    ///Bit 18 - UART7RST
    #[inline(always)]
    pub fn uart7rst(&mut self) -> UART7RST_W<APB1RSTSETRrs> {
        UART7RST_W::new(self, 18)
    }
    ///Bit 19 - UART8RST
    #[inline(always)]
    pub fn uart8rst(&mut self) -> UART8RST_W<APB1RSTSETRrs> {
        UART8RST_W::new(self, 19)
    }
    ///Bit 21 - I2C1RST
    #[inline(always)]
    pub fn i2c1rst(&mut self) -> I2C1RST_W<APB1RSTSETRrs> {
        I2C1RST_W::new(self, 21)
    }
    ///Bit 22 - I2C2RST
    #[inline(always)]
    pub fn i2c2rst(&mut self) -> I2C2RST_W<APB1RSTSETRrs> {
        I2C2RST_W::new(self, 22)
    }
    ///Bit 23 - I2C3RST
    #[inline(always)]
    pub fn i2c3rst(&mut self) -> I2C3RST_W<APB1RSTSETRrs> {
        I2C3RST_W::new(self, 23)
    }
    ///Bit 24 - I2C5RST
    #[inline(always)]
    pub fn i2c5rst(&mut self) -> I2C5RST_W<APB1RSTSETRrs> {
        I2C5RST_W::new(self, 24)
    }
    ///Bit 26 - SPDIFRST
    #[inline(always)]
    pub fn spdifrst(&mut self) -> SPDIFRST_W<APB1RSTSETRrs> {
        SPDIFRST_W::new(self, 26)
    }
    ///Bit 27 - CECRST
    #[inline(always)]
    pub fn cecrst(&mut self) -> CECRST_W<APB1RSTSETRrs> {
        CECRST_W::new(self, 27)
    }
    ///Bit 29 - DAC12RST
    #[inline(always)]
    pub fn dac12rst(&mut self) -> DAC12RST_W<APB1RSTSETRrs> {
        DAC12RST_W::new(self, 29)
    }
    ///Bit 31 - MDIOSRST
    #[inline(always)]
    pub fn mdiosrst(&mut self) -> MDIOSRST_W<APB1RSTSETRrs> {
