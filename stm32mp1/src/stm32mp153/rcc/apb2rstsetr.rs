...
impl W {
    ///Bit 0 - TIM1RST
    #[inline(always)]
    pub fn tim1rst(&mut self) -> TIM1RST_W<APB2RSTSETRrs> {
        TIM1RST_W::new(self, 0)
    }
    ///Bit 1 - TIM8RST
    #[inline(always)]
    pub fn tim8rst(&mut self) -> TIM8RST_W<APB2RSTSETRrs> {
        TIM8RST_W::new(self, 1)
    }
    ///Bit 2 - TIM15RST
    #[inline(always)]
    pub fn tim15rst(&mut self) -> TIM15RST_W<APB2RSTSETRrs> {
        TIM15RST_W::new(self, 2)
    }
    ///Bit 3 - TIM16RST
    #[inline(always)]
    pub fn tim16rst(&mut self) -> TIM16RST_W<APB2RSTSETRrs> {
        TIM16RST_W::new(self, 3)
    }
    ///Bit 4 - TIM17RST
    #[inline(always)]
    pub fn tim17rst(&mut self) -> TIM17RST_W<APB2RSTSETRrs> {
        TIM17RST_W::new(self, 4)
    }
    ///Bit 8 - SPI1RST
    #[inline(always)]
    pub fn spi1rst(&mut self) -> SPI1RST_W<APB2RSTSETRrs> {
        SPI1RST_W::new(self, 8)
    }
    ///Bit 9 - SPI4RST
    #[inline(always)]
    pub fn spi4rst(&mut self) -> SPI4RST_W<APB2RSTSETRrs> {
        SPI4RST_W::new(self, 9)
    }
    ///Bit 10 - SPI5RST
    #[inline(always)]
    pub fn spi5rst(&mut self) -> SPI5RST_W<APB2RSTSETRrs> {
        SPI5RST_W::new(self, 10)
    }
    ///Bit 13 - USART6RST
    #[inline(always)]
    pub fn usart6rst(&mut self) -> USART6RST_W<APB2RSTSETRrs> {
        USART6RST_W::new(self, 13)
    }
    ///Bit 16 - SAI1RST
    #[inline(always)]
    pub fn sai1rst(&mut self) -> SAI1RST_W<APB2RSTSETRrs> {
        SAI1RST_W::new(self, 16)
    }
    ///Bit 17 - SAI2RST
    #[inline(always)]
    pub fn sai2rst(&mut self) -> SAI2RST_W<APB2RSTSETRrs> {
        SAI2RST_W::new(self, 17)
    }
    ///Bit 18 - SAI3RST
    #[inline(always)]
    pub fn sai3rst(&mut self) -> SAI3RST_W<APB2RSTSETRrs> {
        SAI3RST_W::new(self, 18)
    }
    ///Bit 20 - DFSDMRST
    #[inline(always)]
    pub fn dfsdmrst(&mut self) -> DFSDMRST_W<APB2RSTSETRrs> {
        DFSDMRST_W::new(self, 20)
    }
    ///Bit 24 - FDCANRST
    #[inline(always)]
    pub fn fdcanrst(&mut self) -> FDCANRST_W<APB2RSTSETRrs> {
