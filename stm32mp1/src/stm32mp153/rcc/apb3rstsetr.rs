...
impl W {
    ///Bit 0 - LPTIM2RST
    #[inline(always)]
    pub fn lptim2rst(&mut self) -> LPTIM2RST_W<APB3RSTSETRrs> {
        LPTIM2RST_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3RST
    #[inline(always)]
    pub fn lptim3rst(&mut self) -> LPTIM3RST_W<APB3RSTSETRrs> {
        LPTIM3RST_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4RST
    #[inline(always)]
    pub fn lptim4rst(&mut self) -> LPTIM4RST_W<APB3RSTSETRrs> {
        LPTIM4RST_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5RST
    #[inline(always)]
    pub fn lptim5rst(&mut self) -> LPTIM5RST_W<APB3RSTSETRrs> {
        LPTIM5RST_W::new(self, 3)
    }
    ///Bit 8 - SAI4RST
    #[inline(always)]
    pub fn sai4rst(&mut self) -> SAI4RST_W<APB3RSTSETRrs> {
        SAI4RST_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGRST
    #[inline(always)]
    pub fn syscfgrst(&mut self) -> SYSCFGRST_W<APB3RSTSETRrs> {
        SYSCFGRST_W::new(self, 11)
    }
    ///Bit 13 - VREFRST
    #[inline(always)]
    pub fn vrefrst(&mut self) -> VREFRST_W<APB3RSTSETRrs> {
        VREFRST_W::new(self, 13)
    }
    ///Bit 16 - DTSRST
    #[inline(always)]
    pub fn dtsrst(&mut self) -> DTSRST_W<APB3RSTSETRrs> {
