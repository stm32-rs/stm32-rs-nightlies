...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ltdcrst(&mut self) -> LTDCRST_W<APB4RSTCLRRrs> {
        LTDCRST_W::new(self, 0)
    }
    ///Bit 4 - DSIRST
    #[inline(always)]
    #[must_use]
    pub fn dsirst(&mut self) -> DSIRST_W<APB4RSTCLRRrs> {
        DSIRST_W::new(self, 4)
    }
    ///Bit 8 - DDRPERFMRST
    #[inline(always)]
    #[must_use]
    pub fn ddrperfmrst(&mut self) -> DDRPERFMRST_W<APB4RSTCLRRrs> {
        DDRPERFMRST_W::new(self, 8)
    }
    ///Bit 16 - USBPHYRST
    #[inline(always)]
    #[must_use]
    pub fn usbphyrst(&mut self) -> USBPHYRST_W<APB4RSTCLRRrs> {
