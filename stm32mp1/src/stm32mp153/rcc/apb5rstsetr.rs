///Register `APB5RSTSETR` reader
pub type R = crate::R<APB5RSTSETRrs>;
///Register `APB5RSTSETR` writer
pub type W = crate::W<APB5RSTSETRrs>;
...
impl W {
    ///Bit 0 - SPI6RST
    #[inline(always)]
    pub fn spi6rst(&mut self) -> SPI6RST_W<'_, APB5RSTSETRrs> {
        SPI6RST_W::new(self, 0)
    }
    ///Bit 2 - I2C4RST
    #[inline(always)]
    pub fn i2c4rst(&mut self) -> I2C4RST_W<'_, APB5RSTSETRrs> {
        I2C4RST_W::new(self, 2)
    }
    ///Bit 3 - I2C6RST
    #[inline(always)]
    pub fn i2c6rst(&mut self) -> I2C6RST_W<'_, APB5RSTSETRrs> {
        I2C6RST_W::new(self, 3)
    }
    ///Bit 4 - USART1RST
    #[inline(always)]
    pub fn usart1rst(&mut self) -> USART1RST_W<'_, APB5RSTSETRrs> {
        USART1RST_W::new(self, 4)
    }
    ///Bit 20 - STGENRST
    #[inline(always)]
    pub fn stgenrst(&mut self) -> STGENRST_W<'_, APB5RSTSETRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`apb5rstsetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`apb5rstsetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:APB5RSTSETR)*/
pub struct APB5RSTSETRrs;
impl crate::RegisterSpec for APB5RSTSETRrs {
    type Ux = u32;
}
///`read()` method returns [`apb5rstsetr::R`](R) reader structure
impl crate::Readable for APB5RSTSETRrs {}
///`write(|w| ..)` method takes [`apb5rstsetr::W`](W) writer structure
impl crate::Writable for APB5RSTSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets APB5RSTSETR to value 0
impl crate::Resettable for APB5RSTSETRrs {}
