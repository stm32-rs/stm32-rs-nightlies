...
impl W {
    ///Bit 0 - SPI6RST
    #[inline(always)]
    pub fn spi6rst(&mut self) -> SPI6RST_W<APB5RSTSETRrs> {
        SPI6RST_W::new(self, 0)
    }
    ///Bit 2 - I2C4RST
    #[inline(always)]
    pub fn i2c4rst(&mut self) -> I2C4RST_W<APB5RSTSETRrs> {
        I2C4RST_W::new(self, 2)
    }
    ///Bit 3 - I2C6RST
    #[inline(always)]
    pub fn i2c6rst(&mut self) -> I2C6RST_W<APB5RSTSETRrs> {
        I2C6RST_W::new(self, 3)
    }
    ///Bit 4 - USART1RST
    #[inline(always)]
    pub fn usart1rst(&mut self) -> USART1RST_W<APB5RSTSETRrs> {
        USART1RST_W::new(self, 4)
    }
    ///Bit 20 - STGENRST
    #[inline(always)]
    pub fn stgenrst(&mut self) -> STGENRST_W<APB5RSTSETRrs> {
