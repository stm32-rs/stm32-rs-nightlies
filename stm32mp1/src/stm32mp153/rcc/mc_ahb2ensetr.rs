...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma1en(&mut self) -> DMA1EN_W<MC_AHB2ENSETRrs> {
        DMA1EN_W::new(self, 0)
    }
    ///Bit 1 - DMA2EN
    #[inline(always)]
    #[must_use]
    pub fn dma2en(&mut self) -> DMA2EN_W<MC_AHB2ENSETRrs> {
        DMA2EN_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXEN
    #[inline(always)]
    #[must_use]
    pub fn dmamuxen(&mut self) -> DMAMUXEN_W<MC_AHB2ENSETRrs> {
        DMAMUXEN_W::new(self, 2)
    }
    ///Bit 5 - ADC12EN
    #[inline(always)]
    #[must_use]
    pub fn adc12en(&mut self) -> ADC12EN_W<MC_AHB2ENSETRrs> {
        ADC12EN_W::new(self, 5)
    }
    ///Bit 8 - USBOEN
    #[inline(always)]
    #[must_use]
    pub fn usboen(&mut self) -> USBOEN_W<MC_AHB2ENSETRrs> {
        USBOEN_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3EN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc3en(&mut self) -> SDMMC3EN_W<MC_AHB2ENSETRrs> {
