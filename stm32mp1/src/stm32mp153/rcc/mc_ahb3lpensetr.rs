///Register `MC_AHB3LPENSETR` reader
pub type R = crate::R<MC_AHB3LPENSETRrs>;
///Register `MC_AHB3LPENSETR` writer
pub type W = crate::W<MC_AHB3LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MC_AHB3LPENSETR")
...
impl W {
    ///Bit 0 - DCMILPEN
    #[inline(always)]
    pub fn dcmilpen(&mut self) -> DCMILPEN_W<'_, MC_AHB3LPENSETRrs> {
        DCMILPEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP2LPEN
    #[inline(always)]
    pub fn cryp2lpen(&mut self) -> CRYP2LPEN_W<'_, MC_AHB3LPENSETRrs> {
        CRYP2LPEN_W::new(self, 4)
    }
    ///Bit 5 - HASH2LPEN
    #[inline(always)]
    pub fn hash2lpen(&mut self) -> HASH2LPEN_W<'_, MC_AHB3LPENSETRrs> {
        HASH2LPEN_W::new(self, 5)
    }
    ///Bit 6 - RNG2LPEN
    #[inline(always)]
    pub fn rng2lpen(&mut self) -> RNG2LPEN_W<'_, MC_AHB3LPENSETRrs> {
        RNG2LPEN_W::new(self, 6)
    }
    ///Bit 7 - CRC2LPEN
    #[inline(always)]
    pub fn crc2lpen(&mut self) -> CRC2LPEN_W<'_, MC_AHB3LPENSETRrs> {
        CRC2LPEN_W::new(self, 7)
    }
    ///Bit 11 - HSEMLPEN
    #[inline(always)]
    pub fn hsemlpen(&mut self) -> HSEMLPEN_W<'_, MC_AHB3LPENSETRrs> {
        HSEMLPEN_W::new(self, 11)
    }
    ///Bit 12 - IPCCLPEN
    #[inline(always)]
    pub fn ipcclpen(&mut self) -> IPCCLPEN_W<'_, MC_AHB3LPENSETRrs> {
        IPCCLPEN_W::new(self, 12)
    }
}
/**This register is used by the MCU in order to set the PERxLPEN bit.

You can [`read`](crate::Reg::read) this register and get [`mc_ahb3lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_ahb3lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MC_AHB3LPENSETR)*/
pub struct MC_AHB3LPENSETRrs;
impl crate::RegisterSpec for MC_AHB3LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_ahb3lpensetr::R`](R) reader structure
impl crate::Readable for MC_AHB3LPENSETRrs {}
///`write(|w| ..)` method takes [`mc_ahb3lpensetr::W`](W) writer structure
impl crate::Writable for MC_AHB3LPENSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_AHB3LPENSETR to value 0x18f1
impl crate::Resettable for MC_AHB3LPENSETRrs {
