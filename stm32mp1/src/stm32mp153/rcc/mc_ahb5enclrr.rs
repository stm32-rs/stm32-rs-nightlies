...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpiozen(&mut self) -> GPIOZEN_W<MC_AHB5ENCLRRrs> {
        GPIOZEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP1EN
    #[inline(always)]
    #[must_use]
    pub fn cryp1en(&mut self) -> CRYP1EN_W<MC_AHB5ENCLRRrs> {
        CRYP1EN_W::new(self, 4)
    }
    ///Bit 5 - HASH1EN
    #[inline(always)]
    #[must_use]
    pub fn hash1en(&mut self) -> HASH1EN_W<MC_AHB5ENCLRRrs> {
        HASH1EN_W::new(self, 5)
    }
    ///Bit 6 - RNG1EN
    #[inline(always)]
    #[must_use]
    pub fn rng1en(&mut self) -> RNG1EN_W<MC_AHB5ENCLRRrs> {
        RNG1EN_W::new(self, 6)
    }
    ///Bit 8 - BKPSRAMEN
    #[inline(always)]
    #[must_use]
    pub fn bkpsramen(&mut self) -> BKPSRAMEN_W<MC_AHB5ENCLRRrs> {
