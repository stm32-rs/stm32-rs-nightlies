...
impl W {
    ///Bit 0 - GPIOZEN
    #[inline(always)]
    pub fn gpiozen(&mut self) -> GPIOZEN_W<MC_AHB5ENSETRrs> {
        GPIOZEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP1EN
    #[inline(always)]
    pub fn cryp1en(&mut self) -> CRYP1EN_W<MC_AHB5ENSETRrs> {
        CRYP1EN_W::new(self, 4)
    }
    ///Bit 5 - HASH1EN
    #[inline(always)]
    pub fn hash1en(&mut self) -> HASH1EN_W<MC_AHB5ENSETRrs> {
        HASH1EN_W::new(self, 5)
    }
    ///Bit 6 - RNG1EN
    #[inline(always)]
    pub fn rng1en(&mut self) -> RNG1EN_W<MC_AHB5ENSETRrs> {
        RNG1EN_W::new(self, 6)
    }
    ///Bit 8 - BKPSRAMEN
    #[inline(always)]
    pub fn bkpsramen(&mut self) -> BKPSRAMEN_W<MC_AHB5ENSETRrs> {
