///Register `MC_APB1ENCLRR` reader
pub type R = crate::R<MC_APB1ENCLRRrs>;
///Register `MC_APB1ENCLRR` writer
pub type W = crate::W<MC_APB1ENCLRRrs>;
...
impl W {
    ///Bit 0 - TIM2EN
    #[inline(always)]
    pub fn tim2en(&mut self) -> TIM2EN_W<'_, MC_APB1ENCLRRrs> {
        TIM2EN_W::new(self, 0)
    }
    ///Bit 1 - TIM3EN
    #[inline(always)]
    pub fn tim3en(&mut self) -> TIM3EN_W<'_, MC_APB1ENCLRRrs> {
        TIM3EN_W::new(self, 1)
    }
    ///Bit 2 - TIM4EN
    #[inline(always)]
    pub fn tim4en(&mut self) -> TIM4EN_W<'_, MC_APB1ENCLRRrs> {
        TIM4EN_W::new(self, 2)
    }
    ///Bit 3 - TIM5EN
    #[inline(always)]
    pub fn tim5en(&mut self) -> TIM5EN_W<'_, MC_APB1ENCLRRrs> {
        TIM5EN_W::new(self, 3)
    }
    ///Bit 4 - TIM6EN
    #[inline(always)]
    pub fn tim6en(&mut self) -> TIM6EN_W<'_, MC_APB1ENCLRRrs> {
        TIM6EN_W::new(self, 4)
    }
    ///Bit 5 - TIM7EN
    #[inline(always)]
    pub fn tim7en(&mut self) -> TIM7EN_W<'_, MC_APB1ENCLRRrs> {
        TIM7EN_W::new(self, 5)
    }
    ///Bit 6 - TIM12EN
    #[inline(always)]
    pub fn tim12en(&mut self) -> TIM12EN_W<'_, MC_APB1ENCLRRrs> {
        TIM12EN_W::new(self, 6)
    }
    ///Bit 7 - TIM13EN
    #[inline(always)]
    pub fn tim13en(&mut self) -> TIM13EN_W<'_, MC_APB1ENCLRRrs> {
        TIM13EN_W::new(self, 7)
    }
    ///Bit 8 - TIM14EN
    #[inline(always)]
    pub fn tim14en(&mut self) -> TIM14EN_W<'_, MC_APB1ENCLRRrs> {
        TIM14EN_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1EN
    #[inline(always)]
    pub fn lptim1en(&mut self) -> LPTIM1EN_W<'_, MC_APB1ENCLRRrs> {
        LPTIM1EN_W::new(self, 9)
    }
    ///Bit 11 - SPI2EN
    #[inline(always)]
    pub fn spi2en(&mut self) -> SPI2EN_W<'_, MC_APB1ENCLRRrs> {
        SPI2EN_W::new(self, 11)
    }
    ///Bit 12 - SPI3EN
    #[inline(always)]
    pub fn spi3en(&mut self) -> SPI3EN_W<'_, MC_APB1ENCLRRrs> {
        SPI3EN_W::new(self, 12)
    }
    ///Bit 14 - USART2EN
    #[inline(always)]
    pub fn usart2en(&mut self) -> USART2EN_W<'_, MC_APB1ENCLRRrs> {
        USART2EN_W::new(self, 14)
    }
    ///Bit 15 - USART3EN
    #[inline(always)]
    pub fn usart3en(&mut self) -> USART3EN_W<'_, MC_APB1ENCLRRrs> {
        USART3EN_W::new(self, 15)
    }
    ///Bit 16 - UART4EN
    #[inline(always)]
    pub fn uart4en(&mut self) -> UART4EN_W<'_, MC_APB1ENCLRRrs> {
        UART4EN_W::new(self, 16)
    }
    ///Bit 17 - UART5EN
    #[inline(always)]
    pub fn uart5en(&mut self) -> UART5EN_W<'_, MC_APB1ENCLRRrs> {
        UART5EN_W::new(self, 17)
    }
    ///Bit 18 - UART7EN
    #[inline(always)]
    pub fn uart7en(&mut self) -> UART7EN_W<'_, MC_APB1ENCLRRrs> {
        UART7EN_W::new(self, 18)
    }
    ///Bit 19 - UART8EN
    #[inline(always)]
    pub fn uart8en(&mut self) -> UART8EN_W<'_, MC_APB1ENCLRRrs> {
        UART8EN_W::new(self, 19)
    }
    ///Bit 21 - I2C1EN
    #[inline(always)]
    pub fn i2c1en(&mut self) -> I2C1EN_W<'_, MC_APB1ENCLRRrs> {
        I2C1EN_W::new(self, 21)
    }
    ///Bit 22 - I2C2EN
    #[inline(always)]
    pub fn i2c2en(&mut self) -> I2C2EN_W<'_, MC_APB1ENCLRRrs> {
        I2C2EN_W::new(self, 22)
    }
    ///Bit 23 - I2C3EN
    #[inline(always)]
    pub fn i2c3en(&mut self) -> I2C3EN_W<'_, MC_APB1ENCLRRrs> {
        I2C3EN_W::new(self, 23)
    }
    ///Bit 24 - I2C5EN
    #[inline(always)]
    pub fn i2c5en(&mut self) -> I2C5EN_W<'_, MC_APB1ENCLRRrs> {
        I2C5EN_W::new(self, 24)
    }
    ///Bit 26 - SPDIFEN
    #[inline(always)]
    pub fn spdifen(&mut self) -> SPDIFEN_W<'_, MC_APB1ENCLRRrs> {
        SPDIFEN_W::new(self, 26)
    }
    ///Bit 27 - CECEN
    #[inline(always)]
    pub fn cecen(&mut self) -> CECEN_W<'_, MC_APB1ENCLRRrs> {
        CECEN_W::new(self, 27)
    }
    ///Bit 29 - DAC12EN
    #[inline(always)]
    pub fn dac12en(&mut self) -> DAC12EN_W<'_, MC_APB1ENCLRRrs> {
        DAC12EN_W::new(self, 29)
    }
    ///Bit 31 - MDIOSEN
    #[inline(always)]
    pub fn mdiosen(&mut self) -> MDIOSEN_W<'_, MC_APB1ENCLRRrs> {
        MDIOSEN_W::new(self, 31)
    }
}
/**This register is used to clear the peripheral clock enable bit of the corresponding peripheral.

You can [`read`](crate::Reg::read) this register and get [`mc_apb1enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_apb1enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MC_APB1ENCLRR)*/
pub struct MC_APB1ENCLRRrs;
impl crate::RegisterSpec for MC_APB1ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_apb1enclrr::R`](R) reader structure
impl crate::Readable for MC_APB1ENCLRRrs {}
///`write(|w| ..)` method takes [`mc_apb1enclrr::W`](W) writer structure
impl crate::Writable for MC_APB1ENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_APB1ENCLRR to value 0
impl crate::Resettable for MC_APB1ENCLRRrs {}
