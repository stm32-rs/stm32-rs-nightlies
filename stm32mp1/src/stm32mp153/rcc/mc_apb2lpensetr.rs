///Register `MC_APB2LPENSETR` reader
pub type R = crate::R<MC_APB2LPENSETRrs>;
///Register `MC_APB2LPENSETR` writer
pub type W = crate::W<MC_APB2LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MC_APB2LPENSETR")
...
impl W {
    ///Bit 0 - TIM1LPEN
    #[inline(always)]
    pub fn tim1lpen(&mut self) -> TIM1LPEN_W<'_, MC_APB2LPENSETRrs> {
        TIM1LPEN_W::new(self, 0)
    }
    ///Bit 1 - TIM8LPEN
    #[inline(always)]
    pub fn tim8lpen(&mut self) -> TIM8LPEN_W<'_, MC_APB2LPENSETRrs> {
        TIM8LPEN_W::new(self, 1)
    }
    ///Bit 2 - TIM15LPEN
    #[inline(always)]
    pub fn tim15lpen(&mut self) -> TIM15LPEN_W<'_, MC_APB2LPENSETRrs> {
        TIM15LPEN_W::new(self, 2)
    }
    ///Bit 3 - TIM16LPEN
    #[inline(always)]
    pub fn tim16lpen(&mut self) -> TIM16LPEN_W<'_, MC_APB2LPENSETRrs> {
        TIM16LPEN_W::new(self, 3)
    }
    ///Bit 4 - TIM17LPEN
    #[inline(always)]
    pub fn tim17lpen(&mut self) -> TIM17LPEN_W<'_, MC_APB2LPENSETRrs> {
        TIM17LPEN_W::new(self, 4)
    }
    ///Bit 8 - SPI1LPEN
    #[inline(always)]
    pub fn spi1lpen(&mut self) -> SPI1LPEN_W<'_, MC_APB2LPENSETRrs> {
        SPI1LPEN_W::new(self, 8)
    }
    ///Bit 9 - SPI4LPEN
    #[inline(always)]
    pub fn spi4lpen(&mut self) -> SPI4LPEN_W<'_, MC_APB2LPENSETRrs> {
        SPI4LPEN_W::new(self, 9)
    }
    ///Bit 10 - SPI5LPEN
    #[inline(always)]
    pub fn spi5lpen(&mut self) -> SPI5LPEN_W<'_, MC_APB2LPENSETRrs> {
        SPI5LPEN_W::new(self, 10)
    }
    ///Bit 13 - USART6LPEN
    #[inline(always)]
    pub fn usart6lpen(&mut self) -> USART6LPEN_W<'_, MC_APB2LPENSETRrs> {
        USART6LPEN_W::new(self, 13)
    }
    ///Bit 16 - SAI1LPEN
    #[inline(always)]
    pub fn sai1lpen(&mut self) -> SAI1LPEN_W<'_, MC_APB2LPENSETRrs> {
        SAI1LPEN_W::new(self, 16)
    }
    ///Bit 17 - SAI2LPEN
    #[inline(always)]
    pub fn sai2lpen(&mut self) -> SAI2LPEN_W<'_, MC_APB2LPENSETRrs> {
        SAI2LPEN_W::new(self, 17)
    }
    ///Bit 18 - SAI3LPEN
    #[inline(always)]
    pub fn sai3lpen(&mut self) -> SAI3LPEN_W<'_, MC_APB2LPENSETRrs> {
        SAI3LPEN_W::new(self, 18)
    }
    ///Bit 20 - DFSDMLPEN
    #[inline(always)]
    pub fn dfsdmlpen(&mut self) -> DFSDMLPEN_W<'_, MC_APB2LPENSETRrs> {
        DFSDMLPEN_W::new(self, 20)
    }
    ///Bit 21 - ADFSDMLPEN
    #[inline(always)]
    pub fn adfsdmlpen(&mut self) -> ADFSDMLPEN_W<'_, MC_APB2LPENSETRrs> {
        ADFSDMLPEN_W::new(self, 21)
    }
    ///Bit 24 - FDCANLPEN
    #[inline(always)]
    pub fn fdcanlpen(&mut self) -> FDCANLPEN_W<'_, MC_APB2LPENSETRrs> {
        FDCANLPEN_W::new(self, 24)
    }
}
/**This register is used by the MCU in order to set the PERxLPEN bit.

You can [`read`](crate::Reg::read) this register and get [`mc_apb2lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_apb2lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MC_APB2LPENSETR)*/
pub struct MC_APB2LPENSETRrs;
impl crate::RegisterSpec for MC_APB2LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_apb2lpensetr::R`](R) reader structure
impl crate::Readable for MC_APB2LPENSETRrs {}
///`write(|w| ..)` method takes [`mc_apb2lpensetr::W`](W) writer structure
impl crate::Writable for MC_APB2LPENSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_APB2LPENSETR to value 0x0137_271f
impl crate::Resettable for MC_APB2LPENSETRrs {
