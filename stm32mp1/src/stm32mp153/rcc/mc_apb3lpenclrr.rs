///Register `MC_APB3LPENCLRR` reader
pub type R = crate::R<MC_APB3LPENCLRRrs>;
///Register `MC_APB3LPENCLRR` writer
pub type W = crate::W<MC_APB3LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MC_APB3LPENCLRR")
...
impl W {
    ///Bit 0 - LPTIM2LPEN
    #[inline(always)]
    pub fn lptim2lpen(&mut self) -> LPTIM2LPEN_W<'_, MC_APB3LPENCLRRrs> {
        LPTIM2LPEN_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3LPEN
    #[inline(always)]
    pub fn lptim3lpen(&mut self) -> LPTIM3LPEN_W<'_, MC_APB3LPENCLRRrs> {
        LPTIM3LPEN_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4LPEN
    #[inline(always)]
    pub fn lptim4lpen(&mut self) -> LPTIM4LPEN_W<'_, MC_APB3LPENCLRRrs> {
        LPTIM4LPEN_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5LPEN
    #[inline(always)]
    pub fn lptim5lpen(&mut self) -> LPTIM5LPEN_W<'_, MC_APB3LPENCLRRrs> {
        LPTIM5LPEN_W::new(self, 3)
    }
    ///Bit 8 - SAI4LPEN
    #[inline(always)]
    pub fn sai4lpen(&mut self) -> SAI4LPEN_W<'_, MC_APB3LPENCLRRrs> {
        SAI4LPEN_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGLPEN
    #[inline(always)]
    pub fn syscfglpen(&mut self) -> SYSCFGLPEN_W<'_, MC_APB3LPENCLRRrs> {
        SYSCFGLPEN_W::new(self, 11)
    }
    ///Bit 13 - VREFLPEN
    #[inline(always)]
    pub fn vreflpen(&mut self) -> VREFLPEN_W<'_, MC_APB3LPENCLRRrs> {
        VREFLPEN_W::new(self, 13)
    }
    ///Bit 16 - DTSLPEN
    #[inline(always)]
    pub fn dtslpen(&mut self) -> DTSLPEN_W<'_, MC_APB3LPENCLRRrs> {
        DTSLPEN_W::new(self, 16)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bit

You can [`read`](crate::Reg::read) this register and get [`mc_apb3lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_apb3lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MC_APB3LPENCLRR)*/
pub struct MC_APB3LPENCLRRrs;
impl crate::RegisterSpec for MC_APB3LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_apb3lpenclrr::R`](R) reader structure
impl crate::Readable for MC_APB3LPENCLRRrs {}
///`write(|w| ..)` method takes [`mc_apb3lpenclrr::W`](W) writer structure
impl crate::Writable for MC_APB3LPENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_APB3LPENCLRR to value 0x0003_290f
impl crate::Resettable for MC_APB3LPENCLRRrs {
