...
impl W {
    ///Bit 0 - LTDCLPEN
    #[inline(always)]
    pub fn ltdclpen(&mut self) -> LTDCLPEN_W<MC_APB4LPENCLRRrs> {
        LTDCLPEN_W::new(self, 0)
    }
    ///Bit 4 - DSILPEN
    #[inline(always)]
    pub fn dsilpen(&mut self) -> DSILPEN_W<MC_APB4LPENCLRRrs> {
        DSILPEN_W::new(self, 4)
    }
    ///Bit 8 - DDRPERFMLPEN
    #[inline(always)]
    pub fn ddrperfmlpen(&mut self) -> DDRPERFMLPEN_W<MC_APB4LPENCLRRrs> {
        DDRPERFMLPEN_W::new(self, 8)
    }
    ///Bit 16 - USBPHYLPEN
    #[inline(always)]
    pub fn usbphylpen(&mut self) -> USBPHYLPEN_W<MC_APB4LPENCLRRrs> {
        USBPHYLPEN_W::new(self, 16)
    }
    ///Bit 20 - STGENROLPEN
    #[inline(always)]
    pub fn stgenrolpen(&mut self) -> STGENROLPEN_W<MC_APB4LPENCLRRrs> {
        STGENROLPEN_W::new(self, 20)
    }
    ///Bit 21 - STGENROSTPEN
    #[inline(always)]
    pub fn stgenrostpen(&mut self) -> STGENROSTPEN_W<MC_APB4LPENCLRRrs> {
