///Register `MC_APB4LPENCLRR` reader
pub type R = crate::R<MC_APB4LPENCLRRrs>;
///Register `MC_APB4LPENCLRR` writer
pub type W = crate::W<MC_APB4LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MC_APB4LPENCLRR")
...
impl W {
    ///Bit 0 - LTDCLPEN
    #[inline(always)]
    pub fn ltdclpen(&mut self) -> LTDCLPEN_W<'_, MC_APB4LPENCLRRrs> {
        LTDCLPEN_W::new(self, 0)
    }
    ///Bit 4 - DSILPEN
    #[inline(always)]
    pub fn dsilpen(&mut self) -> DSILPEN_W<'_, MC_APB4LPENCLRRrs> {
        DSILPEN_W::new(self, 4)
    }
    ///Bit 8 - DDRPERFMLPEN
    #[inline(always)]
    pub fn ddrperfmlpen(&mut self) -> DDRPERFMLPEN_W<'_, MC_APB4LPENCLRRrs> {
        DDRPERFMLPEN_W::new(self, 8)
    }
    ///Bit 16 - USBPHYLPEN
    #[inline(always)]
    pub fn usbphylpen(&mut self) -> USBPHYLPEN_W<'_, MC_APB4LPENCLRRrs> {
        USBPHYLPEN_W::new(self, 16)
    }
    ///Bit 20 - STGENROLPEN
    #[inline(always)]
    pub fn stgenrolpen(&mut self) -> STGENROLPEN_W<'_, MC_APB4LPENCLRRrs> {
        STGENROLPEN_W::new(self, 20)
    }
    ///Bit 21 - STGENROSTPEN
    #[inline(always)]
    pub fn stgenrostpen(&mut self) -> STGENROSTPEN_W<'_, MC_APB4LPENCLRRrs> {
        STGENROSTPEN_W::new(self, 21)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bit

You can [`read`](crate::Reg::read) this register and get [`mc_apb4lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_apb4lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MC_APB4LPENCLRR)*/
pub struct MC_APB4LPENCLRRrs;
impl crate::RegisterSpec for MC_APB4LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_apb4lpenclrr::R`](R) reader structure
impl crate::Readable for MC_APB4LPENCLRRrs {}
///`write(|w| ..)` method takes [`mc_apb4lpenclrr::W`](W) writer structure
impl crate::Writable for MC_APB4LPENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_APB4LPENCLRR to value 0x0011_0111
impl crate::Resettable for MC_APB4LPENCLRRrs {
