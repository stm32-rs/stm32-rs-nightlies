///Register `MC_APB5ENCLRR` reader
pub type R = crate::R<MC_APB5ENCLRRrs>;
///Register `MC_APB5ENCLRR` writer
pub type W = crate::W<MC_APB5ENCLRRrs>;
...
impl W {
    ///Bit 0 - SPI6EN
    #[inline(always)]
    pub fn spi6en(&mut self) -> SPI6EN_W<'_, MC_APB5ENCLRRrs> {
        SPI6EN_W::new(self, 0)
    }
    ///Bit 2 - I2C4EN
    #[inline(always)]
    pub fn i2c4en(&mut self) -> I2C4EN_W<'_, MC_APB5ENCLRRrs> {
        I2C4EN_W::new(self, 2)
    }
    ///Bit 3 - I2C6EN
    #[inline(always)]
    pub fn i2c6en(&mut self) -> I2C6EN_W<'_, MC_APB5ENCLRRrs> {
        I2C6EN_W::new(self, 3)
    }
    ///Bit 4 - USART1EN
    #[inline(always)]
    pub fn usart1en(&mut self) -> USART1EN_W<'_, MC_APB5ENCLRRrs> {
        USART1EN_W::new(self, 4)
    }
    ///Bit 8 - RTCAPBEN
    #[inline(always)]
    pub fn rtcapben(&mut self) -> RTCAPBEN_W<'_, MC_APB5ENCLRRrs> {
        RTCAPBEN_W::new(self, 8)
    }
    ///Bit 11 - TZC1EN
    #[inline(always)]
    pub fn tzc1en(&mut self) -> TZC1EN_W<'_, MC_APB5ENCLRRrs> {
        TZC1EN_W::new(self, 11)
    }
    ///Bit 12 - TZC2EN
    #[inline(always)]
    pub fn tzc2en(&mut self) -> TZC2EN_W<'_, MC_APB5ENCLRRrs> {
        TZC2EN_W::new(self, 12)
    }
    ///Bit 13 - TZPCEN
    #[inline(always)]
    pub fn tzpcen(&mut self) -> TZPCEN_W<'_, MC_APB5ENCLRRrs> {
        TZPCEN_W::new(self, 13)
    }
    ///Bit 16 - BSECEN
    #[inline(always)]
    pub fn bsecen(&mut self) -> BSECEN_W<'_, MC_APB5ENCLRRrs> {
        BSECEN_W::new(self, 16)
    }
    ///Bit 20 - STGENEN
    #[inline(always)]
    pub fn stgenen(&mut self) -> STGENEN_W<'_, MC_APB5ENCLRRrs> {
        STGENEN_W::new(self, 20)
    }
}
/**This register is used to clear the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`mc_apb5enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_apb5enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MC_APB5ENCLRR)*/
pub struct MC_APB5ENCLRRrs;
impl crate::RegisterSpec for MC_APB5ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_apb5enclrr::R`](R) reader structure
impl crate::Readable for MC_APB5ENCLRRrs {}
///`write(|w| ..)` method takes [`mc_apb5enclrr::W`](W) writer structure
impl crate::Writable for MC_APB5ENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_APB5ENCLRR to value 0
impl crate::Resettable for MC_APB5ENCLRRrs {}
