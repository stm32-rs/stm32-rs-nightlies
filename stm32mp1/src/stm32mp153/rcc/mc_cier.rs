...
impl W {
    ///Bit 0 - LSIRDYIE
    #[inline(always)]
    pub fn lsirdyie(&mut self) -> LSIRDYIE_W<MC_CIERrs> {
        LSIRDYIE_W::new(self, 0)
    }
    ///Bit 1 - LSERDYIE
    #[inline(always)]
    pub fn lserdyie(&mut self) -> LSERDYIE_W<MC_CIERrs> {
        LSERDYIE_W::new(self, 1)
    }
    ///Bit 2 - HSIRDYIE
    #[inline(always)]
    pub fn hsirdyie(&mut self) -> HSIRDYIE_W<MC_CIERrs> {
        HSIRDYIE_W::new(self, 2)
    }
    ///Bit 3 - HSERDYIE
    #[inline(always)]
    pub fn hserdyie(&mut self) -> HSERDYIE_W<MC_CIERrs> {
        HSERDYIE_W::new(self, 3)
    }
    ///Bit 4 - CSIRDYIE
    #[inline(always)]
    pub fn csirdyie(&mut self) -> CSIRDYIE_W<MC_CIERrs> {
        CSIRDYIE_W::new(self, 4)
    }
    ///Bit 8 - PLL1DYIE
    #[inline(always)]
    pub fn pll1dyie(&mut self) -> PLL1DYIE_W<MC_CIERrs> {
        PLL1DYIE_W::new(self, 8)
    }
    ///Bit 9 - PLL2DYIE
    #[inline(always)]
    pub fn pll2dyie(&mut self) -> PLL2DYIE_W<MC_CIERrs> {
        PLL2DYIE_W::new(self, 9)
    }
    ///Bit 10 - PLL3DYIE
    #[inline(always)]
    pub fn pll3dyie(&mut self) -> PLL3DYIE_W<MC_CIERrs> {
        PLL3DYIE_W::new(self, 10)
    }
    ///Bit 11 - PLL4DYIE
    #[inline(always)]
    pub fn pll4dyie(&mut self) -> PLL4DYIE_W<MC_CIERrs> {
        PLL4DYIE_W::new(self, 11)
    }
    ///Bit 16 - LSECSSIE
    #[inline(always)]
    pub fn lsecssie(&mut self) -> LSECSSIE_W<MC_CIERrs> {
        LSECSSIE_W::new(self, 16)
    }
    ///Bit 20 - WKUPIE
    #[inline(always)]
    pub fn wkupie(&mut self) -> WKUPIE_W<MC_CIERrs> {
