///Register `MP_AHB4LPENCLRR` reader
pub type R = crate::R<MP_AHB4LPENCLRRrs>;
///Register `MP_AHB4LPENCLRR` writer
pub type W = crate::W<MP_AHB4LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MP_AHB4LPENCLRR")
...
impl W {
    ///Bit 0 - GPIOALPEN
    #[inline(always)]
    pub fn gpioalpen(&mut self) -> GPIOALPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOALPEN_W::new(self, 0)
    }
    ///Bit 1 - GPIOBLPEN
    #[inline(always)]
    pub fn gpioblpen(&mut self) -> GPIOBLPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOBLPEN_W::new(self, 1)
    }
    ///Bit 2 - GPIOCLPEN
    #[inline(always)]
    pub fn gpioclpen(&mut self) -> GPIOCLPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOCLPEN_W::new(self, 2)
    }
    ///Bit 3 - GPIODLPEN
    #[inline(always)]
    pub fn gpiodlpen(&mut self) -> GPIODLPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIODLPEN_W::new(self, 3)
    }
    ///Bit 4 - GPIOELPEN
    #[inline(always)]
    pub fn gpioelpen(&mut self) -> GPIOELPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOELPEN_W::new(self, 4)
    }
    ///Bit 5 - GPIOFLPEN
    #[inline(always)]
    pub fn gpioflpen(&mut self) -> GPIOFLPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOFLPEN_W::new(self, 5)
    }
    ///Bit 6 - GPIOGLPEN
    #[inline(always)]
    pub fn gpioglpen(&mut self) -> GPIOGLPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOGLPEN_W::new(self, 6)
    }
    ///Bit 7 - GPIOHLPEN
    #[inline(always)]
    pub fn gpiohlpen(&mut self) -> GPIOHLPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOHLPEN_W::new(self, 7)
    }
    ///Bit 8 - GPIOILPEN
    #[inline(always)]
    pub fn gpioilpen(&mut self) -> GPIOILPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOILPEN_W::new(self, 8)
    }
    ///Bit 9 - GPIOJLPEN
    #[inline(always)]
    pub fn gpiojlpen(&mut self) -> GPIOJLPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOJLPEN_W::new(self, 9)
    }
    ///Bit 10 - GPIOKLPEN
    #[inline(always)]
    pub fn gpioklpen(&mut self) -> GPIOKLPEN_W<'_, MP_AHB4LPENCLRRrs> {
        GPIOKLPEN_W::new(self, 10)
    }
}
/**This register is used by the MPU

You can [`read`](crate::Reg::read) this register and get [`mp_ahb4lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_ahb4lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MP_AHB4LPENCLRR)*/
pub struct MP_AHB4LPENCLRRrs;
impl crate::RegisterSpec for MP_AHB4LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_ahb4lpenclrr::R`](R) reader structure
impl crate::Readable for MP_AHB4LPENCLRRrs {}
///`write(|w| ..)` method takes [`mp_ahb4lpenclrr::W`](W) writer structure
impl crate::Writable for MP_AHB4LPENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_AHB4LPENCLRR to value 0x07ff
impl crate::Resettable for MP_AHB4LPENCLRRrs {
