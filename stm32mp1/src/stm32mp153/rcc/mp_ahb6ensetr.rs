///Register `MP_AHB6ENSETR` reader
pub type R = crate::R<MP_AHB6ENSETRrs>;
///Register `MP_AHB6ENSETR` writer
pub type W = crate::W<MP_AHB6ENSETRrs>;
...
impl W {
    ///Bit 0 - MDMAEN
    #[inline(always)]
    pub fn mdmaen(&mut self) -> MDMAEN_W<'_, MP_AHB6ENSETRrs> {
        MDMAEN_W::new(self, 0)
    }
    ///Bit 5 - GPUEN
    #[inline(always)]
    pub fn gpuen(&mut self) -> GPUEN_W<'_, MP_AHB6ENSETRrs> {
        GPUEN_W::new(self, 5)
    }
    ///Bit 7 - ETHCKEN
    #[inline(always)]
    pub fn ethcken(&mut self) -> ETHCKEN_W<'_, MP_AHB6ENSETRrs> {
        ETHCKEN_W::new(self, 7)
    }
    ///Bit 8 - ETHTXEN
    #[inline(always)]
    pub fn ethtxen(&mut self) -> ETHTXEN_W<'_, MP_AHB6ENSETRrs> {
        ETHTXEN_W::new(self, 8)
    }
    ///Bit 9 - ETHRXEN
    #[inline(always)]
    pub fn ethrxen(&mut self) -> ETHRXEN_W<'_, MP_AHB6ENSETRrs> {
        ETHRXEN_W::new(self, 9)
    }
    ///Bit 10 - ETHMACEN
    #[inline(always)]
    pub fn ethmacen(&mut self) -> ETHMACEN_W<'_, MP_AHB6ENSETRrs> {
        ETHMACEN_W::new(self, 10)
    }
    ///Bit 12 - FMCEN
    #[inline(always)]
    pub fn fmcen(&mut self) -> FMCEN_W<'_, MP_AHB6ENSETRrs> {
        FMCEN_W::new(self, 12)
    }
    ///Bit 14 - QSPIEN
    #[inline(always)]
    pub fn qspien(&mut self) -> QSPIEN_W<'_, MP_AHB6ENSETRrs> {
        QSPIEN_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1EN
    #[inline(always)]
    pub fn sdmmc1en(&mut self) -> SDMMC1EN_W<'_, MP_AHB6ENSETRrs> {
        SDMMC1EN_W::new(self, 16)
    }
    ///Bit 17 - SDMMC2EN
    #[inline(always)]
    pub fn sdmmc2en(&mut self) -> SDMMC2EN_W<'_, MP_AHB6ENSETRrs> {
        SDMMC2EN_W::new(self, 17)
    }
    ///Bit 20 - CRC1EN
    #[inline(always)]
    pub fn crc1en(&mut self) -> CRC1EN_W<'_, MP_AHB6ENSETRrs> {
        CRC1EN_W::new(self, 20)
    }
    ///Bit 24 - USBHEN
    #[inline(always)]
    pub fn usbhen(&mut self) -> USBHEN_W<'_, MP_AHB6ENSETRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`mp_ahb6ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_ahb6ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MP_AHB6ENSETR)*/
pub struct MP_AHB6ENSETRrs;
impl crate::RegisterSpec for MP_AHB6ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_ahb6ensetr::R`](R) reader structure
impl crate::Readable for MP_AHB6ENSETRrs {}
///`write(|w| ..)` method takes [`mp_ahb6ensetr::W`](W) writer structure
impl crate::Writable for MP_AHB6ENSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_AHB6ENSETR to value 0
impl crate::Resettable for MP_AHB6ENSETRrs {}
