///Register `MP_APB2LPENCLRR` reader
pub type R = crate::R<MP_APB2LPENCLRRrs>;
///Register `MP_APB2LPENCLRR` writer
pub type W = crate::W<MP_APB2LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MP_APB2LPENCLRR")
...
impl W {
    ///Bit 0 - TIM1LPEN
    #[inline(always)]
    pub fn tim1lpen(&mut self) -> TIM1LPEN_W<'_, MP_APB2LPENCLRRrs> {
        TIM1LPEN_W::new(self, 0)
    }
    ///Bit 1 - TIM8LPEN
    #[inline(always)]
    pub fn tim8lpen(&mut self) -> TIM8LPEN_W<'_, MP_APB2LPENCLRRrs> {
        TIM8LPEN_W::new(self, 1)
    }
    ///Bit 2 - TIM15LPEN
    #[inline(always)]
    pub fn tim15lpen(&mut self) -> TIM15LPEN_W<'_, MP_APB2LPENCLRRrs> {
        TIM15LPEN_W::new(self, 2)
    }
    ///Bit 3 - TIM16LPEN
    #[inline(always)]
    pub fn tim16lpen(&mut self) -> TIM16LPEN_W<'_, MP_APB2LPENCLRRrs> {
        TIM16LPEN_W::new(self, 3)
    }
    ///Bit 4 - TIM17LPEN
    #[inline(always)]
    pub fn tim17lpen(&mut self) -> TIM17LPEN_W<'_, MP_APB2LPENCLRRrs> {
        TIM17LPEN_W::new(self, 4)
    }
    ///Bit 8 - SPI1LPEN
    #[inline(always)]
    pub fn spi1lpen(&mut self) -> SPI1LPEN_W<'_, MP_APB2LPENCLRRrs> {
        SPI1LPEN_W::new(self, 8)
    }
    ///Bit 9 - SPI4LPEN
    #[inline(always)]
    pub fn spi4lpen(&mut self) -> SPI4LPEN_W<'_, MP_APB2LPENCLRRrs> {
        SPI4LPEN_W::new(self, 9)
    }
    ///Bit 10 - SPI5LPEN
    #[inline(always)]
    pub fn spi5lpen(&mut self) -> SPI5LPEN_W<'_, MP_APB2LPENCLRRrs> {
        SPI5LPEN_W::new(self, 10)
    }
    ///Bit 13 - USART6LPEN
    #[inline(always)]
    pub fn usart6lpen(&mut self) -> USART6LPEN_W<'_, MP_APB2LPENCLRRrs> {
        USART6LPEN_W::new(self, 13)
    }
    ///Bit 16 - SAI1LPEN
    #[inline(always)]
    pub fn sai1lpen(&mut self) -> SAI1LPEN_W<'_, MP_APB2LPENCLRRrs> {
        SAI1LPEN_W::new(self, 16)
    }
    ///Bit 17 - SAI2LPEN
    #[inline(always)]
    pub fn sai2lpen(&mut self) -> SAI2LPEN_W<'_, MP_APB2LPENCLRRrs> {
        SAI2LPEN_W::new(self, 17)
    }
    ///Bit 18 - SAI3LPEN
    #[inline(always)]
    pub fn sai3lpen(&mut self) -> SAI3LPEN_W<'_, MP_APB2LPENCLRRrs> {
        SAI3LPEN_W::new(self, 18)
    }
    ///Bit 20 - DFSDMLPEN
    #[inline(always)]
    pub fn dfsdmlpen(&mut self) -> DFSDMLPEN_W<'_, MP_APB2LPENCLRRrs> {
        DFSDMLPEN_W::new(self, 20)
    }
    ///Bit 21 - ADFSDMLPEN
    #[inline(always)]
    pub fn adfsdmlpen(&mut self) -> ADFSDMLPEN_W<'_, MP_APB2LPENCLRRrs> {
        ADFSDMLPEN_W::new(self, 21)
    }
    ///Bit 24 - FDCANLPEN
    #[inline(always)]
    pub fn fdcanlpen(&mut self) -> FDCANLPEN_W<'_, MP_APB2LPENCLRRrs> {
        FDCANLPEN_W::new(self, 24)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bits

You can [`read`](crate::Reg::read) this register and get [`mp_apb2lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_apb2lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MP_APB2LPENCLRR)*/
pub struct MP_APB2LPENCLRRrs;
impl crate::RegisterSpec for MP_APB2LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_apb2lpenclrr::R`](R) reader structure
impl crate::Readable for MP_APB2LPENCLRRrs {}
///`write(|w| ..)` method takes [`mp_apb2lpenclrr::W`](W) writer structure
impl crate::Writable for MP_APB2LPENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_APB2LPENCLRR to value 0x0137_271f
impl crate::Resettable for MP_APB2LPENCLRRrs {
