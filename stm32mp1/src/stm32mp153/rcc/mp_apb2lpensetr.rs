...
impl W {
    ///Bit 0 - TIM1LPEN
    #[inline(always)]
    pub fn tim1lpen(&mut self) -> TIM1LPEN_W<MP_APB2LPENSETRrs> {
        TIM1LPEN_W::new(self, 0)
    }
    ///Bit 1 - TIM8LPEN
    #[inline(always)]
    pub fn tim8lpen(&mut self) -> TIM8LPEN_W<MP_APB2LPENSETRrs> {
        TIM8LPEN_W::new(self, 1)
    }
    ///Bit 2 - TIM15LPEN
    #[inline(always)]
    pub fn tim15lpen(&mut self) -> TIM15LPEN_W<MP_APB2LPENSETRrs> {
        TIM15LPEN_W::new(self, 2)
    }
    ///Bit 3 - TIM16LPEN
    #[inline(always)]
    pub fn tim16lpen(&mut self) -> TIM16LPEN_W<MP_APB2LPENSETRrs> {
        TIM16LPEN_W::new(self, 3)
    }
    ///Bit 4 - TIM17LPEN
    #[inline(always)]
    pub fn tim17lpen(&mut self) -> TIM17LPEN_W<MP_APB2LPENSETRrs> {
        TIM17LPEN_W::new(self, 4)
    }
    ///Bit 8 - SPI1LPEN
    #[inline(always)]
    pub fn spi1lpen(&mut self) -> SPI1LPEN_W<MP_APB2LPENSETRrs> {
        SPI1LPEN_W::new(self, 8)
    }
    ///Bit 9 - SPI4LPEN
    #[inline(always)]
    pub fn spi4lpen(&mut self) -> SPI4LPEN_W<MP_APB2LPENSETRrs> {
        SPI4LPEN_W::new(self, 9)
    }
    ///Bit 10 - SPI5LPEN
    #[inline(always)]
    pub fn spi5lpen(&mut self) -> SPI5LPEN_W<MP_APB2LPENSETRrs> {
        SPI5LPEN_W::new(self, 10)
    }
    ///Bit 13 - USART6LPEN
    #[inline(always)]
    pub fn usart6lpen(&mut self) -> USART6LPEN_W<MP_APB2LPENSETRrs> {
        USART6LPEN_W::new(self, 13)
    }
    ///Bit 16 - SAI1LPEN
    #[inline(always)]
    pub fn sai1lpen(&mut self) -> SAI1LPEN_W<MP_APB2LPENSETRrs> {
        SAI1LPEN_W::new(self, 16)
    }
    ///Bit 17 - SAI2LPEN
    #[inline(always)]
    pub fn sai2lpen(&mut self) -> SAI2LPEN_W<MP_APB2LPENSETRrs> {
        SAI2LPEN_W::new(self, 17)
    }
    ///Bit 18 - SAI3LPEN
    #[inline(always)]
    pub fn sai3lpen(&mut self) -> SAI3LPEN_W<MP_APB2LPENSETRrs> {
        SAI3LPEN_W::new(self, 18)
    }
    ///Bit 20 - DFSDMLPEN
    #[inline(always)]
    pub fn dfsdmlpen(&mut self) -> DFSDMLPEN_W<MP_APB2LPENSETRrs> {
        DFSDMLPEN_W::new(self, 20)
    }
    ///Bit 21 - ADFSDMLPEN
    #[inline(always)]
    pub fn adfsdmlpen(&mut self) -> ADFSDMLPEN_W<MP_APB2LPENSETRrs> {
        ADFSDMLPEN_W::new(self, 21)
    }
    ///Bit 24 - FDCANLPEN
    #[inline(always)]
    pub fn fdcanlpen(&mut self) -> FDCANLPEN_W<MP_APB2LPENSETRrs> {
