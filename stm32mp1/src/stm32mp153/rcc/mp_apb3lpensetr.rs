...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lptim2lpen(&mut self) -> LPTIM2LPEN_W<MP_APB3LPENSETRrs> {
        LPTIM2LPEN_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3LPEN
    #[inline(always)]
    #[must_use]
    pub fn lptim3lpen(&mut self) -> LPTIM3LPEN_W<MP_APB3LPENSETRrs> {
        LPTIM3LPEN_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4LPEN
    #[inline(always)]
    #[must_use]
    pub fn lptim4lpen(&mut self) -> LPTIM4LPEN_W<MP_APB3LPENSETRrs> {
        LPTIM4LPEN_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5LPEN
    #[inline(always)]
    #[must_use]
    pub fn lptim5lpen(&mut self) -> LPTIM5LPEN_W<MP_APB3LPENSETRrs> {
        LPTIM5LPEN_W::new(self, 3)
    }
    ///Bit 8 - SAI4LPEN
    #[inline(always)]
    #[must_use]
    pub fn sai4lpen(&mut self) -> SAI4LPEN_W<MP_APB3LPENSETRrs> {
        SAI4LPEN_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGLPEN
    #[inline(always)]
    #[must_use]
    pub fn syscfglpen(&mut self) -> SYSCFGLPEN_W<MP_APB3LPENSETRrs> {
        SYSCFGLPEN_W::new(self, 11)
    }
    ///Bit 13 - VREFLPEN
    #[inline(always)]
    #[must_use]
    pub fn vreflpen(&mut self) -> VREFLPEN_W<MP_APB3LPENSETRrs> {
        VREFLPEN_W::new(self, 13)
    }
    ///Bit 16 - DTSLPEN
    #[inline(always)]
    #[must_use]
    pub fn dtslpen(&mut self) -> DTSLPEN_W<MP_APB3LPENSETRrs> {
