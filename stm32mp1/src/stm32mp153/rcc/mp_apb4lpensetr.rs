...
impl W {
    ///Bit 0 - LTDCLPEN
    #[inline(always)]
    pub fn ltdclpen(&mut self) -> LTDCLPEN_W<MP_APB4LPENSETRrs> {
        LTDCLPEN_W::new(self, 0)
    }
    ///Bit 4 - DSILPEN
    #[inline(always)]
    pub fn dsilpen(&mut self) -> DSILPEN_W<MP_APB4LPENSETRrs> {
        DSILPEN_W::new(self, 4)
    }
    ///Bit 8 - DDRPERFMLPEN
    #[inline(always)]
    pub fn ddrperfmlpen(&mut self) -> DDRPERFMLPEN_W<MP_APB4LPENSETRrs> {
        DDRPERFMLPEN_W::new(self, 8)
    }
    ///Bit 15 - IWDG2APBLPEN
    #[inline(always)]
    pub fn iwdg2apblpen(&mut self) -> IWDG2APBLPEN_W<MP_APB4LPENSETRrs> {
        IWDG2APBLPEN_W::new(self, 15)
    }
    ///Bit 16 - USBPHYLPEN
    #[inline(always)]
    pub fn usbphylpen(&mut self) -> USBPHYLPEN_W<MP_APB4LPENSETRrs> {
        USBPHYLPEN_W::new(self, 16)
    }
    ///Bit 20 - STGENROLPEN
    #[inline(always)]
    pub fn stgenrolpen(&mut self) -> STGENROLPEN_W<MP_APB4LPENSETRrs> {
        STGENROLPEN_W::new(self, 20)
    }
    ///Bit 21 - STGENROSTPEN
    #[inline(always)]
    pub fn stgenrostpen(&mut self) -> STGENROSTPEN_W<MP_APB4LPENSETRrs> {
