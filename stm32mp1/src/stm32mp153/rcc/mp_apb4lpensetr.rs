///Register `MP_APB4LPENSETR` reader
pub type R = crate::R<MP_APB4LPENSETRrs>;
///Register `MP_APB4LPENSETR` writer
pub type W = crate::W<MP_APB4LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MP_APB4LPENSETR")
...
impl W {
    ///Bit 0 - LTDCLPEN
    #[inline(always)]
    pub fn ltdclpen(&mut self) -> LTDCLPEN_W<'_, MP_APB4LPENSETRrs> {
        LTDCLPEN_W::new(self, 0)
    }
    ///Bit 4 - DSILPEN
    #[inline(always)]
    pub fn dsilpen(&mut self) -> DSILPEN_W<'_, MP_APB4LPENSETRrs> {
        DSILPEN_W::new(self, 4)
    }
    ///Bit 8 - DDRPERFMLPEN
    #[inline(always)]
    pub fn ddrperfmlpen(&mut self) -> DDRPERFMLPEN_W<'_, MP_APB4LPENSETRrs> {
        DDRPERFMLPEN_W::new(self, 8)
    }
    ///Bit 15 - IWDG2APBLPEN
    #[inline(always)]
    pub fn iwdg2apblpen(&mut self) -> IWDG2APBLPEN_W<'_, MP_APB4LPENSETRrs> {
        IWDG2APBLPEN_W::new(self, 15)
    }
    ///Bit 16 - USBPHYLPEN
    #[inline(always)]
    pub fn usbphylpen(&mut self) -> USBPHYLPEN_W<'_, MP_APB4LPENSETRrs> {
        USBPHYLPEN_W::new(self, 16)
    }
    ///Bit 20 - STGENROLPEN
    #[inline(always)]
    pub fn stgenrolpen(&mut self) -> STGENROLPEN_W<'_, MP_APB4LPENSETRrs> {
        STGENROLPEN_W::new(self, 20)
    }
    ///Bit 21 - STGENROSTPEN
    #[inline(always)]
    pub fn stgenrostpen(&mut self) -> STGENROSTPEN_W<'_, MP_APB4LPENSETRrs> {
        STGENROSTPEN_W::new(self, 21)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bits

You can [`read`](crate::Reg::read) this register and get [`mp_apb4lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_apb4lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:MP_APB4LPENSETR)*/
pub struct MP_APB4LPENSETRrs;
impl crate::RegisterSpec for MP_APB4LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_apb4lpensetr::R`](R) reader structure
impl crate::Readable for MP_APB4LPENSETRrs {}
///`write(|w| ..)` method takes [`mp_apb4lpensetr::W`](W) writer structure
impl crate::Writable for MP_APB4LPENSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_APB4LPENSETR to value 0x0011_8111
impl crate::Resettable for MP_APB4LPENSETRrs {
