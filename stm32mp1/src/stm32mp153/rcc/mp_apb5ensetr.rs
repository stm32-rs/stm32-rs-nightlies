...
impl W {
    ///Bit 0 - SPI6EN
    #[inline(always)]
    pub fn spi6en(&mut self) -> SPI6EN_W<MP_APB5ENSETRrs> {
        SPI6EN_W::new(self, 0)
    }
    ///Bit 2 - I2C4EN
    #[inline(always)]
    pub fn i2c4en(&mut self) -> I2C4EN_W<MP_APB5ENSETRrs> {
        I2C4EN_W::new(self, 2)
    }
    ///Bit 3 - I2C6EN
    #[inline(always)]
    pub fn i2c6en(&mut self) -> I2C6EN_W<MP_APB5ENSETRrs> {
        I2C6EN_W::new(self, 3)
    }
    ///Bit 4 - USART1EN
    #[inline(always)]
    pub fn usart1en(&mut self) -> USART1EN_W<MP_APB5ENSETRrs> {
        USART1EN_W::new(self, 4)
    }
    ///Bit 8 - RTCAPBEN
    #[inline(always)]
    pub fn rtcapben(&mut self) -> RTCAPBEN_W<MP_APB5ENSETRrs> {
        RTCAPBEN_W::new(self, 8)
    }
    ///Bit 11 - TZC1EN
    #[inline(always)]
    pub fn tzc1en(&mut self) -> TZC1EN_W<MP_APB5ENSETRrs> {
        TZC1EN_W::new(self, 11)
    }
    ///Bit 12 - TZC2EN
    #[inline(always)]
    pub fn tzc2en(&mut self) -> TZC2EN_W<MP_APB5ENSETRrs> {
        TZC2EN_W::new(self, 12)
    }
    ///Bit 13 - TZPCEN
    #[inline(always)]
    pub fn tzpcen(&mut self) -> TZPCEN_W<MP_APB5ENSETRrs> {
        TZPCEN_W::new(self, 13)
    }
    ///Bit 15 - IWDG1APBEN
    #[inline(always)]
    pub fn iwdg1apben(&mut self) -> IWDG1APBEN_W<MP_APB5ENSETRrs> {
        IWDG1APBEN_W::new(self, 15)
    }
    ///Bit 16 - BSECEN
    #[inline(always)]
    pub fn bsecen(&mut self) -> BSECEN_W<MP_APB5ENSETRrs> {
        BSECEN_W::new(self, 16)
    }
    ///Bit 20 - STGENEN
    #[inline(always)]
    pub fn stgenen(&mut self) -> STGENEN_W<MP_APB5ENSETRrs> {
