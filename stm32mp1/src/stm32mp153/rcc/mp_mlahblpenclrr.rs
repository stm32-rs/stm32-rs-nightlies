...
impl W {
    ///Bit 0 - SRAM1LPEN
    #[inline(always)]
    pub fn sram1lpen(&mut self) -> SRAM1LPEN_W<MP_MLAHBLPENCLRRrs> {
        SRAM1LPEN_W::new(self, 0)
    }
    ///Bit 1 - SRAM2LPEN
    #[inline(always)]
    pub fn sram2lpen(&mut self) -> SRAM2LPEN_W<MP_MLAHBLPENCLRRrs> {
        SRAM2LPEN_W::new(self, 1)
    }
    ///Bit 2 - SRAM34LPEN
    #[inline(always)]
    pub fn sram34lpen(&mut self) -> SRAM34LPEN_W<MP_MLAHBLPENCLRRrs> {
        SRAM34LPEN_W::new(self, 2)
    }
    ///Bit 4 - RETRAMLPEN
    #[inline(always)]
    pub fn retramlpen(&mut self) -> RETRAMLPEN_W<MP_MLAHBLPENCLRRrs> {
