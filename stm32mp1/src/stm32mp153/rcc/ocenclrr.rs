...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hsion(&mut self) -> HSION_W<OCENCLRRrs> {
        HSION_W::new(self, 0)
    }
    ///Bit 1 - HSIKERON
    #[inline(always)]
    #[must_use]
    pub fn hsikeron(&mut self) -> HSIKERON_W<OCENCLRRrs> {
        HSIKERON_W::new(self, 1)
    }
    ///Bit 4 - CSION
    #[inline(always)]
    #[must_use]
    pub fn csion(&mut self) -> CSION_W<OCENCLRRrs> {
        CSION_W::new(self, 4)
    }
    ///Bit 5 - CSIKERON
    #[inline(always)]
    #[must_use]
    pub fn csikeron(&mut self) -> CSIKERON_W<OCENCLRRrs> {
        CSIKERON_W::new(self, 5)
    }
    ///Bit 7 - DIGBYP
    #[inline(always)]
    #[must_use]
    pub fn digbyp(&mut self) -> DIGBYP_W<OCENCLRRrs> {
        DIGBYP_W::new(self, 7)
    }
    ///Bit 8 - HSEON
    #[inline(always)]
    #[must_use]
    pub fn hseon(&mut self) -> HSEON_W<OCENCLRRrs> {
        HSEON_W::new(self, 8)
    }
    ///Bit 9 - HSEKERON
    #[inline(always)]
    #[must_use]
    pub fn hsekeron(&mut self) -> HSEKERON_W<OCENCLRRrs> {
        HSEKERON_W::new(self, 9)
    }
    ///Bit 10 - HSEBYP
    #[inline(always)]
    #[must_use]
    pub fn hsebyp(&mut self) -> HSEBYP_W<OCENCLRRrs> {
