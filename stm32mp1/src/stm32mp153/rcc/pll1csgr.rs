...
impl W {
    ///Bits 0:12 - MOD_PER
    #[inline(always)]
    pub fn mod_per(&mut self) -> MOD_PER_W<PLL1CSGRrs> {
        MOD_PER_W::new(self, 0)
    }
    ///Bit 13 - TPDFN_DIS
    #[inline(always)]
    pub fn tpdfn_dis(&mut self) -> TPDFN_DIS_W<PLL1CSGRrs> {
        TPDFN_DIS_W::new(self, 13)
    }
    ///Bit 14 - RPDFN_DIS
    #[inline(always)]
    pub fn rpdfn_dis(&mut self) -> RPDFN_DIS_W<PLL1CSGRrs> {
        RPDFN_DIS_W::new(self, 14)
    }
    ///Bit 15 - SSCG_MODE
    #[inline(always)]
    pub fn sscg_mode(&mut self) -> SSCG_MODE_W<PLL1CSGRrs> {
        SSCG_MODE_W::new(self, 15)
    }
    ///Bits 16:30 - INC_STEP
    #[inline(always)]
    pub fn inc_step(&mut self) -> INC_STEP_W<PLL1CSGRrs> {
