///Register `PLL1CSGR` reader
pub type R = crate::R<PLL1CSGRrs>;
///Register `PLL1CSGR` writer
pub type W = crate::W<PLL1CSGRrs>;
...
impl W {
    ///Bits 0:12 - MOD_PER
    #[inline(always)]
    pub fn mod_per(&mut self) -> MOD_PER_W<'_, PLL1CSGRrs> {
        MOD_PER_W::new(self, 0)
    }
    ///Bit 13 - TPDFN_DIS
    #[inline(always)]
    pub fn tpdfn_dis(&mut self) -> TPDFN_DIS_W<'_, PLL1CSGRrs> {
        TPDFN_DIS_W::new(self, 13)
    }
    ///Bit 14 - RPDFN_DIS
    #[inline(always)]
    pub fn rpdfn_dis(&mut self) -> RPDFN_DIS_W<'_, PLL1CSGRrs> {
        RPDFN_DIS_W::new(self, 14)
    }
    ///Bit 15 - SSCG_MODE
    #[inline(always)]
    pub fn sscg_mode(&mut self) -> SSCG_MODE_W<'_, PLL1CSGRrs> {
        SSCG_MODE_W::new(self, 15)
    }
    ///Bits 16:30 - INC_STEP
    #[inline(always)]
    pub fn inc_step(&mut self) -> INC_STEP_W<'_, PLL1CSGRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`pll1csgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll1csgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:PLL1CSGR)*/
pub struct PLL1CSGRrs;
impl crate::RegisterSpec for PLL1CSGRrs {
    type Ux = u32;
}
///`read()` method returns [`pll1csgr::R`](R) reader structure
impl crate::Readable for PLL1CSGRrs {}
///`write(|w| ..)` method takes [`pll1csgr::W`](W) writer structure
impl crate::Writable for PLL1CSGRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PLL1CSGR to value 0
impl crate::Resettable for PLL1CSGRrs {}
