...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllon(&mut self) -> PLLON_W<PLL2CRrs> {
        PLLON_W::new(self, 0)
    }
    ///Bit 2 - SSCG_CTRL
    #[inline(always)]
    #[must_use]
    pub fn sscg_ctrl(&mut self) -> SSCG_CTRL_W<PLL2CRrs> {
        SSCG_CTRL_W::new(self, 2)
    }
    ///Bit 4 - DIVPEN
    #[inline(always)]
    #[must_use]
    pub fn divpen(&mut self) -> DIVPEN_W<PLL2CRrs> {
        DIVPEN_W::new(self, 4)
    }
    ///Bit 5 - DIVQEN
    #[inline(always)]
    #[must_use]
    pub fn divqen(&mut self) -> DIVQEN_W<PLL2CRrs> {
        DIVQEN_W::new(self, 5)
    }
    ///Bit 6 - DIVREN
    #[inline(always)]
    #[must_use]
    pub fn divren(&mut self) -> DIVREN_W<PLL2CRrs> {
        DIVREN_W::new(self, 6)
    }
}
