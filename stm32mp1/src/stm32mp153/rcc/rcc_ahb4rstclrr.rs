...
pub type R = crate::R<RCC_AHB4RSTCLRRrs>;
///Register `RCC_AHB4RSTCLRR` writer
pub type W = crate::W<RCC_AHB4RSTCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_AHB4RSTCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpioarst(&mut self) -> GPIOARST_W<RCC_AHB4RSTCLRRrs> {
        GPIOARST_W::new(self, 0)
    }
    ///Bit 1 - GPIOBRST
    #[inline(always)]
    #[must_use]
    pub fn gpiobrst(&mut self) -> GPIOBRST_W<RCC_AHB4RSTCLRRrs> {
        GPIOBRST_W::new(self, 1)
    }
    ///Bit 2 - GPIOCRST
    #[inline(always)]
    #[must_use]
    pub fn gpiocrst(&mut self) -> GPIOCRST_W<RCC_AHB4RSTCLRRrs> {
        GPIOCRST_W::new(self, 2)
    }
    ///Bit 3 - GPIODRST
    #[inline(always)]
    #[must_use]
    pub fn gpiodrst(&mut self) -> GPIODRST_W<RCC_AHB4RSTCLRRrs> {
        GPIODRST_W::new(self, 3)
    }
    ///Bit 4 - GPIOERST
    #[inline(always)]
    #[must_use]
    pub fn gpioerst(&mut self) -> GPIOERST_W<RCC_AHB4RSTCLRRrs> {
        GPIOERST_W::new(self, 4)
    }
    ///Bit 5 - GPIOFRST
    #[inline(always)]
    #[must_use]
    pub fn gpiofrst(&mut self) -> GPIOFRST_W<RCC_AHB4RSTCLRRrs> {
        GPIOFRST_W::new(self, 5)
    }
    ///Bit 6 - GPIOGRST
    #[inline(always)]
    #[must_use]
    pub fn gpiogrst(&mut self) -> GPIOGRST_W<RCC_AHB4RSTCLRRrs> {
        GPIOGRST_W::new(self, 6)
    }
    ///Bit 7 - GPIOHRST
    #[inline(always)]
    #[must_use]
    pub fn gpiohrst(&mut self) -> GPIOHRST_W<RCC_AHB4RSTCLRRrs> {
        GPIOHRST_W::new(self, 7)
    }
    ///Bit 8 - GPIOIRST
    #[inline(always)]
    #[must_use]
    pub fn gpioirst(&mut self) -> GPIOIRST_W<RCC_AHB4RSTCLRRrs> {
        GPIOIRST_W::new(self, 8)
    }
    ///Bit 9 - GPIOJRST
    #[inline(always)]
    #[must_use]
    pub fn gpiojrst(&mut self) -> GPIOJRST_W<RCC_AHB4RSTCLRRrs> {
        GPIOJRST_W::new(self, 9)
    }
    ///Bit 10 - GPIOKRST
    #[inline(always)]
    #[must_use]
    pub fn gpiokrst(&mut self) -> GPIOKRST_W<RCC_AHB4RSTCLRRrs> {
        GPIOKRST_W::new(self, 10)
    }
}
/**This register is used to release the reset of the corresponding peripheral.

You can [`read`](crate::Reg::read) this register and get [`rcc_ahb4rstclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_ahb4rstclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_AHB4RSTCLRR)*/
pub struct RCC_AHB4RSTCLRRrs;
impl crate::RegisterSpec for RCC_AHB4RSTCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_ahb4rstclrr::R`](R) reader structure
impl crate::Readable for RCC_AHB4RSTCLRRrs {}
///`write(|w| ..)` method takes [`rcc_ahb4rstclrr::W`](W) writer structure
impl crate::Writable for RCC_AHB4RSTCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_AHB4RSTCLRR to value 0
impl crate::Resettable for RCC_AHB4RSTCLRRrs {
