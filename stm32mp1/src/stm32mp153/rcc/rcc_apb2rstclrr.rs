///Register `RCC_APB2RSTCLRR` reader
pub type R = crate::R<RCC_APB2RSTCLRRrs>;
///Register `RCC_APB2RSTCLRR` writer
pub type W = crate::W<RCC_APB2RSTCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_APB2RSTCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim1rst(&mut self) -> TIM1RST_W<RCC_APB2RSTCLRRrs> {
        TIM1RST_W::new(self, 0)
    }
    ///Bit 1 - TIM8RST
    #[inline(always)]
    #[must_use]
    pub fn tim8rst(&mut self) -> TIM8RST_W<RCC_APB2RSTCLRRrs> {
        TIM8RST_W::new(self, 1)
    }
    ///Bit 2 - TIM15RST
    #[inline(always)]
    #[must_use]
    pub fn tim15rst(&mut self) -> TIM15RST_W<RCC_APB2RSTCLRRrs> {
        TIM15RST_W::new(self, 2)
    }
    ///Bit 3 - TIM16RST
    #[inline(always)]
    #[must_use]
    pub fn tim16rst(&mut self) -> TIM16RST_W<RCC_APB2RSTCLRRrs> {
        TIM16RST_W::new(self, 3)
    }
    ///Bit 4 - TIM17RST
    #[inline(always)]
    #[must_use]
    pub fn tim17rst(&mut self) -> TIM17RST_W<RCC_APB2RSTCLRRrs> {
        TIM17RST_W::new(self, 4)
    }
    ///Bit 8 - SPI1RST
    #[inline(always)]
    #[must_use]
    pub fn spi1rst(&mut self) -> SPI1RST_W<RCC_APB2RSTCLRRrs> {
        SPI1RST_W::new(self, 8)
    }
    ///Bit 9 - SPI4RST
    #[inline(always)]
    #[must_use]
    pub fn spi4rst(&mut self) -> SPI4RST_W<RCC_APB2RSTCLRRrs> {
        SPI4RST_W::new(self, 9)
    }
    ///Bit 10 - SPI5RST
    #[inline(always)]
    #[must_use]
    pub fn spi5rst(&mut self) -> SPI5RST_W<RCC_APB2RSTCLRRrs> {
        SPI5RST_W::new(self, 10)
    }
    ///Bit 13 - USART6RST
    #[inline(always)]
    #[must_use]
    pub fn usart6rst(&mut self) -> USART6RST_W<RCC_APB2RSTCLRRrs> {
        USART6RST_W::new(self, 13)
    }
    ///Bit 16 - SAI1RST
    #[inline(always)]
    #[must_use]
    pub fn sai1rst(&mut self) -> SAI1RST_W<RCC_APB2RSTCLRRrs> {
        SAI1RST_W::new(self, 16)
    }
    ///Bit 17 - SAI2RST
    #[inline(always)]
    #[must_use]
    pub fn sai2rst(&mut self) -> SAI2RST_W<RCC_APB2RSTCLRRrs> {
        SAI2RST_W::new(self, 17)
    }
    ///Bit 18 - SAI3RST
    #[inline(always)]
    #[must_use]
    pub fn sai3rst(&mut self) -> SAI3RST_W<RCC_APB2RSTCLRRrs> {
        SAI3RST_W::new(self, 18)
    }
    ///Bit 20 - DFSDMRST
    #[inline(always)]
    #[must_use]
    pub fn dfsdmrst(&mut self) -> DFSDMRST_W<RCC_APB2RSTCLRRrs> {
        DFSDMRST_W::new(self, 20)
    }
    ///Bit 24 - FDCANRST
    #[inline(always)]
    #[must_use]
    pub fn fdcanrst(&mut self) -> FDCANRST_W<RCC_APB2RSTCLRRrs> {
        FDCANRST_W::new(self, 24)
    }
}
/**This register is used to release the reset of the corresponding peripheral.

You can [`read`](crate::Reg::read) this register and get [`rcc_apb2rstclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_apb2rstclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_APB2RSTCLRR)*/
pub struct RCC_APB2RSTCLRRrs;
impl crate::RegisterSpec for RCC_APB2RSTCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_apb2rstclrr::R`](R) reader structure
impl crate::Readable for RCC_APB2RSTCLRRrs {}
///`write(|w| ..)` method takes [`rcc_apb2rstclrr::W`](W) writer structure
impl crate::Writable for RCC_APB2RSTCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_APB2RSTCLRR to value 0
impl crate::Resettable for RCC_APB2RSTCLRRrs {
