///Register `RCC_APB3DIVR` reader
pub type R = crate::R<RCC_APB3DIVRrs>;
///Register `RCC_APB3DIVR` writer
...
You can [`read`](crate::Reg::read) this register and get [`rcc_apb3divr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_apb3divr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_APB3DIVR)*/
pub struct RCC_APB3DIVRrs;
impl crate::RegisterSpec for RCC_APB3DIVRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_apb3divr::R`](R) reader structure
impl crate::Readable for RCC_APB3DIVRrs {}
///`write(|w| ..)` method takes [`rcc_apb3divr::W`](W) writer structure
impl crate::Writable for RCC_APB3DIVRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_APB3DIVR to value 0x8000_0000
