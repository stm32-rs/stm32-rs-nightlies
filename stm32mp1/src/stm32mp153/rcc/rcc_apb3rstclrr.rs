...
pub type R = crate::R<RCC_APB3RSTCLRRrs>;
///Register `RCC_APB3RSTCLRR` writer
pub type W = crate::W<RCC_APB3RSTCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_APB3RSTCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lptim2rst(&mut self) -> LPTIM2RST_W<RCC_APB3RSTCLRRrs> {
        LPTIM2RST_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3RST
    #[inline(always)]
    #[must_use]
    pub fn lptim3rst(&mut self) -> LPTIM3RST_W<RCC_APB3RSTCLRRrs> {
        LPTIM3RST_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4RST
    #[inline(always)]
    #[must_use]
    pub fn lptim4rst(&mut self) -> LPTIM4RST_W<RCC_APB3RSTCLRRrs> {
        LPTIM4RST_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5RST
    #[inline(always)]
    #[must_use]
    pub fn lptim5rst(&mut self) -> LPTIM5RST_W<RCC_APB3RSTCLRRrs> {
        LPTIM5RST_W::new(self, 3)
    }
    ///Bit 8 - SAI4RST
    #[inline(always)]
    #[must_use]
    pub fn sai4rst(&mut self) -> SAI4RST_W<RCC_APB3RSTCLRRrs> {
        SAI4RST_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGRST
    #[inline(always)]
    #[must_use]
    pub fn syscfgrst(&mut self) -> SYSCFGRST_W<RCC_APB3RSTCLRRrs> {
        SYSCFGRST_W::new(self, 11)
    }
    ///Bit 13 - VREFRST
    #[inline(always)]
    #[must_use]
    pub fn vrefrst(&mut self) -> VREFRST_W<RCC_APB3RSTCLRRrs> {
        VREFRST_W::new(self, 13)
    }
    ///Bit 16 - DTSRST
    #[inline(always)]
    #[must_use]
    pub fn dtsrst(&mut self) -> DTSRST_W<RCC_APB3RSTCLRRrs> {
        DTSRST_W::new(self, 16)
    }
}
/**This register is used to release the reset of the corresponding peripheral.

You can [`read`](crate::Reg::read) this register and get [`rcc_apb3rstclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_apb3rstclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_APB3RSTCLRR)*/
pub struct RCC_APB3RSTCLRRrs;
impl crate::RegisterSpec for RCC_APB3RSTCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_apb3rstclrr::R`](R) reader structure
impl crate::Readable for RCC_APB3RSTCLRRrs {}
///`write(|w| ..)` method takes [`rcc_apb3rstclrr::W`](W) writer structure
impl crate::Writable for RCC_APB3RSTCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_APB3RSTCLRR to value 0
impl crate::Resettable for RCC_APB3RSTCLRRrs {
