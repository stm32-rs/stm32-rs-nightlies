///Register `RCC_BR_RSTSCLRR` reader
pub type R = crate::R<RCC_BR_RSTSCLRRrs>;
///Register `RCC_BR_RSTSCLRR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_BR_RSTSCLRR")
...
You can [`read`](crate::Reg::read) this register and get [`rcc_br_rstsclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_br_rstsclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_BR_RSTSCLRR)*/
pub struct RCC_BR_RSTSCLRRrs;
impl crate::RegisterSpec for RCC_BR_RSTSCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_br_rstsclrr::R`](R) reader structure
impl crate::Readable for RCC_BR_RSTSCLRRrs {}
///`write(|w| ..)` method takes [`rcc_br_rstsclrr::W`](W) writer structure
impl crate::Writable for RCC_BR_RSTSCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_BR_RSTSCLRR to value 0x15
