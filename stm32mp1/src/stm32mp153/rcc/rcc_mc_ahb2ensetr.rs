...
pub type R = crate::R<RCC_MC_AHB2ENSETRrs>;
///Register `RCC_MC_AHB2ENSETR` writer
pub type W = crate::W<RCC_MC_AHB2ENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_AHB2ENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma1en(&mut self) -> DMA1EN_W<RCC_MC_AHB2ENSETRrs> {
        DMA1EN_W::new(self, 0)
    }
    ///Bit 1 - DMA2EN
    #[inline(always)]
    #[must_use]
    pub fn dma2en(&mut self) -> DMA2EN_W<RCC_MC_AHB2ENSETRrs> {
        DMA2EN_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXEN
    #[inline(always)]
    #[must_use]
    pub fn dmamuxen(&mut self) -> DMAMUXEN_W<RCC_MC_AHB2ENSETRrs> {
        DMAMUXEN_W::new(self, 2)
    }
    ///Bit 5 - ADC12EN
    #[inline(always)]
    #[must_use]
    pub fn adc12en(&mut self) -> ADC12EN_W<RCC_MC_AHB2ENSETRrs> {
        ADC12EN_W::new(self, 5)
    }
    ///Bit 8 - USBOEN
    #[inline(always)]
    #[must_use]
    pub fn usboen(&mut self) -> USBOEN_W<RCC_MC_AHB2ENSETRrs> {
        USBOEN_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3EN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc3en(&mut self) -> SDMMC3EN_W<RCC_MC_AHB2ENSETRrs> {
        SDMMC3EN_W::new(self, 16)
    }
}
/**This register is used to set the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mc_ahb2ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_ahb2ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MC_AHB2ENSETR)*/
pub struct RCC_MC_AHB2ENSETRrs;
impl crate::RegisterSpec for RCC_MC_AHB2ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_ahb2ensetr::R`](R) reader structure
impl crate::Readable for RCC_MC_AHB2ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mc_ahb2ensetr::W`](W) writer structure
impl crate::Writable for RCC_MC_AHB2ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_AHB2ENSETR to value 0
impl crate::Resettable for RCC_MC_AHB2ENSETRrs {
