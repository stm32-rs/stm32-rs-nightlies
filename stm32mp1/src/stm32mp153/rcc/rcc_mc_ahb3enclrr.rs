///Register `RCC_MC_AHB3ENCLRR` reader
pub type R = crate::R<RCC_MC_AHB3ENCLRRrs>;
///Register `RCC_MC_AHB3ENCLRR` writer
pub type W = crate::W<RCC_MC_AHB3ENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_AHB3ENCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcmien(&mut self) -> DCMIEN_W<RCC_MC_AHB3ENCLRRrs> {
        DCMIEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP2EN
    #[inline(always)]
    #[must_use]
    pub fn cryp2en(&mut self) -> CRYP2EN_W<RCC_MC_AHB3ENCLRRrs> {
        CRYP2EN_W::new(self, 4)
    }
    ///Bit 5 - HASH2EN
    #[inline(always)]
    #[must_use]
    pub fn hash2en(&mut self) -> HASH2EN_W<RCC_MC_AHB3ENCLRRrs> {
        HASH2EN_W::new(self, 5)
    }
    ///Bit 6 - RNG2EN
    #[inline(always)]
    #[must_use]
    pub fn rng2en(&mut self) -> RNG2EN_W<RCC_MC_AHB3ENCLRRrs> {
        RNG2EN_W::new(self, 6)
    }
    ///Bit 7 - CRC2EN
    #[inline(always)]
    #[must_use]
    pub fn crc2en(&mut self) -> CRC2EN_W<RCC_MC_AHB3ENCLRRrs> {
        CRC2EN_W::new(self, 7)
    }
    ///Bit 11 - HSEMEN
    #[inline(always)]
    #[must_use]
    pub fn hsemen(&mut self) -> HSEMEN_W<RCC_MC_AHB3ENCLRRrs> {
        HSEMEN_W::new(self, 11)
    }
    ///Bit 12 - IPCCEN
    #[inline(always)]
    #[must_use]
    pub fn ipccen(&mut self) -> IPCCEN_W<RCC_MC_AHB3ENCLRRrs> {
        IPCCEN_W::new(self, 12)
    }
}
/**This register is used to clear the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mc_ahb3enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_ahb3enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MC_AHB3ENCLRR)*/
pub struct RCC_MC_AHB3ENCLRRrs;
impl crate::RegisterSpec for RCC_MC_AHB3ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_ahb3enclrr::R`](R) reader structure
impl crate::Readable for RCC_MC_AHB3ENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mc_ahb3enclrr::W`](W) writer structure
impl crate::Writable for RCC_MC_AHB3ENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_AHB3ENCLRR to value 0
impl crate::Resettable for RCC_MC_AHB3ENCLRRrs {
