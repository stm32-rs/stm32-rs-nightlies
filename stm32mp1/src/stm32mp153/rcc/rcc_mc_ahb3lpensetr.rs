///Register `RCC_MC_AHB3LPENSETR` reader
pub type R = crate::R<RCC_MC_AHB3LPENSETRrs>;
///Register `RCC_MC_AHB3LPENSETR` writer
pub type W = crate::W<RCC_MC_AHB3LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_AHB3LPENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcmilpen(&mut self) -> DCMILPEN_W<RCC_MC_AHB3LPENSETRrs> {
        DCMILPEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP2LPEN
    #[inline(always)]
    #[must_use]
    pub fn cryp2lpen(&mut self) -> CRYP2LPEN_W<RCC_MC_AHB3LPENSETRrs> {
        CRYP2LPEN_W::new(self, 4)
    }
    ///Bit 5 - HASH2LPEN
    #[inline(always)]
    #[must_use]
    pub fn hash2lpen(&mut self) -> HASH2LPEN_W<RCC_MC_AHB3LPENSETRrs> {
        HASH2LPEN_W::new(self, 5)
    }
    ///Bit 6 - RNG2LPEN
    #[inline(always)]
    #[must_use]
    pub fn rng2lpen(&mut self) -> RNG2LPEN_W<RCC_MC_AHB3LPENSETRrs> {
        RNG2LPEN_W::new(self, 6)
    }
    ///Bit 7 - CRC2LPEN
    #[inline(always)]
    #[must_use]
    pub fn crc2lpen(&mut self) -> CRC2LPEN_W<RCC_MC_AHB3LPENSETRrs> {
        CRC2LPEN_W::new(self, 7)
    }
    ///Bit 11 - HSEMLPEN
    #[inline(always)]
    #[must_use]
    pub fn hsemlpen(&mut self) -> HSEMLPEN_W<RCC_MC_AHB3LPENSETRrs> {
        HSEMLPEN_W::new(self, 11)
    }
    ///Bit 12 - IPCCLPEN
    #[inline(always)]
    #[must_use]
    pub fn ipcclpen(&mut self) -> IPCCLPEN_W<RCC_MC_AHB3LPENSETRrs> {
        IPCCLPEN_W::new(self, 12)
    }
}
/**This register is used by the MCU in order to set the PERxLPEN bit.

You can [`read`](crate::Reg::read) this register and get [`rcc_mc_ahb3lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_ahb3lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MC_AHB3LPENSETR)*/
pub struct RCC_MC_AHB3LPENSETRrs;
impl crate::RegisterSpec for RCC_MC_AHB3LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_ahb3lpensetr::R`](R) reader structure
impl crate::Readable for RCC_MC_AHB3LPENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mc_ahb3lpensetr::W`](W) writer structure
impl crate::Writable for RCC_MC_AHB3LPENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_AHB3LPENSETR to value 0x18f1
impl crate::Resettable for RCC_MC_AHB3LPENSETRrs {
