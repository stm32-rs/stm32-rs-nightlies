///Register `RCC_MC_APB2ENSETR` reader
pub type R = crate::R<RCC_MC_APB2ENSETRrs>;
///Register `RCC_MC_APB2ENSETR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_APB2ENSETR")
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mc_apb2ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_apb2ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MC_APB2ENSETR)*/
pub struct RCC_MC_APB2ENSETRrs;
impl crate::RegisterSpec for RCC_MC_APB2ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_apb2ensetr::R`](R) reader structure
impl crate::Readable for RCC_MC_APB2ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mc_apb2ensetr::W`](W) writer structure
impl crate::Writable for RCC_MC_APB2ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_APB2ENSETR to value 0
