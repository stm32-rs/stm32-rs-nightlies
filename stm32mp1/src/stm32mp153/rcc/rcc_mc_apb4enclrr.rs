///Register `RCC_MC_APB4ENCLRR` reader
pub type R = crate::R<RCC_MC_APB4ENCLRRrs>;
///Register `RCC_MC_APB4ENCLRR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_APB4ENCLRR")
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mc_apb4enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_apb4enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MC_APB4ENCLRR)*/
pub struct RCC_MC_APB4ENCLRRrs;
impl crate::RegisterSpec for RCC_MC_APB4ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_apb4enclrr::R`](R) reader structure
impl crate::Readable for RCC_MC_APB4ENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mc_apb4enclrr::W`](W) writer structure
impl crate::Writable for RCC_MC_APB4ENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_APB4ENCLRR to value 0
