...
pub type R = crate::R<RCC_MC_APB5ENSETRrs>;
///Register `RCC_MC_APB5ENSETR` writer
pub type W = crate::W<RCC_MC_APB5ENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_APB5ENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi6en(&mut self) -> SPI6EN_W<RCC_MC_APB5ENSETRrs> {
        SPI6EN_W::new(self, 0)
    }
    ///Bit 2 - I2C4EN
    #[inline(always)]
    #[must_use]
    pub fn i2c4en(&mut self) -> I2C4EN_W<RCC_MC_APB5ENSETRrs> {
        I2C4EN_W::new(self, 2)
    }
    ///Bit 3 - I2C6EN
    #[inline(always)]
    #[must_use]
    pub fn i2c6en(&mut self) -> I2C6EN_W<RCC_MC_APB5ENSETRrs> {
        I2C6EN_W::new(self, 3)
    }
    ///Bit 4 - USART1EN
    #[inline(always)]
    #[must_use]
    pub fn usart1en(&mut self) -> USART1EN_W<RCC_MC_APB5ENSETRrs> {
        USART1EN_W::new(self, 4)
    }
    ///Bit 8 - RTCAPBEN
    #[inline(always)]
    #[must_use]
    pub fn rtcapben(&mut self) -> RTCAPBEN_W<RCC_MC_APB5ENSETRrs> {
        RTCAPBEN_W::new(self, 8)
    }
    ///Bit 11 - TZC1EN
    #[inline(always)]
    #[must_use]
    pub fn tzc1en(&mut self) -> TZC1EN_W<RCC_MC_APB5ENSETRrs> {
        TZC1EN_W::new(self, 11)
    }
    ///Bit 12 - TZC2EN
    #[inline(always)]
    #[must_use]
    pub fn tzc2en(&mut self) -> TZC2EN_W<RCC_MC_APB5ENSETRrs> {
        TZC2EN_W::new(self, 12)
    }
    ///Bit 13 - TZPCEN
    #[inline(always)]
    #[must_use]
    pub fn tzpcen(&mut self) -> TZPCEN_W<RCC_MC_APB5ENSETRrs> {
        TZPCEN_W::new(self, 13)
    }
    ///Bit 16 - BSECEN
    #[inline(always)]
    #[must_use]
    pub fn bsecen(&mut self) -> BSECEN_W<RCC_MC_APB5ENSETRrs> {
        BSECEN_W::new(self, 16)
    }
    ///Bit 20 - STGENEN
    #[inline(always)]
    #[must_use]
    pub fn stgenen(&mut self) -> STGENEN_W<RCC_MC_APB5ENSETRrs> {
        STGENEN_W::new(self, 20)
    }
}
/**This register is used to set the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mc_apb5ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_apb5ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MC_APB5ENSETR)*/
pub struct RCC_MC_APB5ENSETRrs;
impl crate::RegisterSpec for RCC_MC_APB5ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_apb5ensetr::R`](R) reader structure
impl crate::Readable for RCC_MC_APB5ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mc_apb5ensetr::W`](W) writer structure
impl crate::Writable for RCC_MC_APB5ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_APB5ENSETR to value 0
impl crate::Resettable for RCC_MC_APB5ENSETRrs {
