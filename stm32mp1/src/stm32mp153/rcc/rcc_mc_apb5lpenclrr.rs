///Register `RCC_MC_APB5LPENCLRR` reader
pub type R = crate::R<RCC_MC_APB5LPENCLRRrs>;
///Register `RCC_MC_APB5LPENCLRR` writer
pub type W = crate::W<RCC_MC_APB5LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_APB5LPENCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi6lpen(&mut self) -> SPI6LPEN_W<RCC_MC_APB5LPENCLRRrs> {
        SPI6LPEN_W::new(self, 0)
    }
    ///Bit 2 - I2C4LPEN
    #[inline(always)]
    #[must_use]
    pub fn i2c4lpen(&mut self) -> I2C4LPEN_W<RCC_MC_APB5LPENCLRRrs> {
        I2C4LPEN_W::new(self, 2)
    }
    ///Bit 3 - I2C6LPEN
    #[inline(always)]
    #[must_use]
    pub fn i2c6lpen(&mut self) -> I2C6LPEN_W<RCC_MC_APB5LPENCLRRrs> {
        I2C6LPEN_W::new(self, 3)
    }
    ///Bit 4 - USART1LPEN
    #[inline(always)]
    #[must_use]
    pub fn usart1lpen(&mut self) -> USART1LPEN_W<RCC_MC_APB5LPENCLRRrs> {
        USART1LPEN_W::new(self, 4)
    }
    ///Bit 8 - RTCAPBLPEN
    #[inline(always)]
    #[must_use]
    pub fn rtcapblpen(&mut self) -> RTCAPBLPEN_W<RCC_MC_APB5LPENCLRRrs> {
        RTCAPBLPEN_W::new(self, 8)
    }
    ///Bit 11 - TZC1LPEN
    #[inline(always)]
    #[must_use]
    pub fn tzc1lpen(&mut self) -> TZC1LPEN_W<RCC_MC_APB5LPENCLRRrs> {
        TZC1LPEN_W::new(self, 11)
    }
    ///Bit 12 - TZC2LPEN
    #[inline(always)]
    #[must_use]
    pub fn tzc2lpen(&mut self) -> TZC2LPEN_W<RCC_MC_APB5LPENCLRRrs> {
        TZC2LPEN_W::new(self, 12)
    }
    ///Bit 13 - TZPCLPEN
    #[inline(always)]
    #[must_use]
    pub fn tzpclpen(&mut self) -> TZPCLPEN_W<RCC_MC_APB5LPENCLRRrs> {
        TZPCLPEN_W::new(self, 13)
    }
    ///Bit 16 - BSECLPEN
    #[inline(always)]
    #[must_use]
    pub fn bseclpen(&mut self) -> BSECLPEN_W<RCC_MC_APB5LPENCLRRrs> {
        BSECLPEN_W::new(self, 16)
    }
    ///Bit 20 - STGENLPEN
    #[inline(always)]
    #[must_use]
    pub fn stgenlpen(&mut self) -> STGENLPEN_W<RCC_MC_APB5LPENCLRRrs> {
        STGENLPEN_W::new(self, 20)
    }
    ///Bit 21 - STGENSTPEN
    #[inline(always)]
    #[must_use]
    pub fn stgenstpen(&mut self) -> STGENSTPEN_W<RCC_MC_APB5LPENCLRRrs> {
        STGENSTPEN_W::new(self, 21)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mc_apb5lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_apb5lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MC_APB5LPENCLRR)*/
pub struct RCC_MC_APB5LPENCLRRrs;
impl crate::RegisterSpec for RCC_MC_APB5LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_apb5lpenclrr::R`](R) reader structure
impl crate::Readable for RCC_MC_APB5LPENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mc_apb5lpenclrr::W`](W) writer structure
impl crate::Writable for RCC_MC_APB5LPENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_APB5LPENCLRR to value 0x0011_391d
impl crate::Resettable for RCC_MC_APB5LPENCLRRrs {
