...
You can [`read`](crate::Reg::read) this register and get [`rcc_mc_cifr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_cifr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MC_CIFR)*/
pub struct RCC_MC_CIFRrs;
impl crate::RegisterSpec for RCC_MC_CIFRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_cifr::R`](R) reader structure
impl crate::Readable for RCC_MC_CIFRrs {}
///`write(|w| ..)` method takes [`rcc_mc_cifr::W`](W) writer structure
impl crate::Writable for RCC_MC_CIFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_CIFR to value 0
