///Register `RCC_MP_AHB2ENSETR` reader
pub type R = crate::R<RCC_MP_AHB2ENSETRrs>;
///Register `RCC_MP_AHB2ENSETR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_AHB2ENSETR")
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_ahb2ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_ahb2ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_AHB2ENSETR)*/
pub struct RCC_MP_AHB2ENSETRrs;
impl crate::RegisterSpec for RCC_MP_AHB2ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_ahb2ensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_AHB2ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_ahb2ensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_AHB2ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_AHB2ENSETR to value 0
