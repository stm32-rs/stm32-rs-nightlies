///Register `RCC_MP_AHB3LPENSETR` reader
pub type R = crate::R<RCC_MP_AHB3LPENSETRrs>;
///Register `RCC_MP_AHB3LPENSETR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_AHB3LPENSETR")
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_ahb3lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_ahb3lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_AHB3LPENSETR)*/
pub struct RCC_MP_AHB3LPENSETRrs;
impl crate::RegisterSpec for RCC_MP_AHB3LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_ahb3lpensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_AHB3LPENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_ahb3lpensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_AHB3LPENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_AHB3LPENSETR to value 0x18f1
