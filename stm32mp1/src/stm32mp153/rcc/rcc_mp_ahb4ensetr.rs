///Register `RCC_MP_AHB4ENSETR` reader
pub type R = crate::R<RCC_MP_AHB4ENSETRrs>;
///Register `RCC_MP_AHB4ENSETR` writer
pub type W = crate::W<RCC_MP_AHB4ENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_AHB4ENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpioaen(&mut self) -> GPIOAEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIOAEN_W::new(self, 0)
    }
    ///Bit 1 - GPIOBEN
    #[inline(always)]
    #[must_use]
    pub fn gpioben(&mut self) -> GPIOBEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIOBEN_W::new(self, 1)
    }
    ///Bit 2 - GPIOCEN
    #[inline(always)]
    #[must_use]
    pub fn gpiocen(&mut self) -> GPIOCEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIOCEN_W::new(self, 2)
    }
    ///Bit 3 - GPIODEN
    #[inline(always)]
    #[must_use]
    pub fn gpioden(&mut self) -> GPIODEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIODEN_W::new(self, 3)
    }
    ///Bit 4 - GPIOEEN
    #[inline(always)]
    #[must_use]
    pub fn gpioeen(&mut self) -> GPIOEEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIOEEN_W::new(self, 4)
    }
    ///Bit 5 - GPIOFEN
    #[inline(always)]
    #[must_use]
    pub fn gpiofen(&mut self) -> GPIOFEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIOFEN_W::new(self, 5)
    }
    ///Bit 6 - GPIOGEN
    #[inline(always)]
    #[must_use]
    pub fn gpiogen(&mut self) -> GPIOGEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIOGEN_W::new(self, 6)
    }
    ///Bit 7 - GPIOHEN
    #[inline(always)]
    #[must_use]
    pub fn gpiohen(&mut self) -> GPIOHEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIOHEN_W::new(self, 7)
    }
    ///Bit 8 - GPIOIEN
    #[inline(always)]
    #[must_use]
    pub fn gpioien(&mut self) -> GPIOIEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIOIEN_W::new(self, 8)
    }
    ///Bit 9 - GPIOJEN
    #[inline(always)]
    #[must_use]
    pub fn gpiojen(&mut self) -> GPIOJEN_W<RCC_MP_AHB4ENSETRrs> {
        GPIOJEN_W::new(self, 9)
    }
    ///Bit 10 - GPIOKEN
    #[inline(always)]
    #[must_use]
    pub fn gpioken(&mut self) -> GPIOKEN_W<RCC_MP_AHB4ENSETRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_ahb4ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_ahb4ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_AHB4ENSETR)*/
pub struct RCC_MP_AHB4ENSETRrs;
impl crate::RegisterSpec for RCC_MP_AHB4ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_ahb4ensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_AHB4ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_ahb4ensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_AHB4ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_AHB4ENSETR to value 0
impl crate::Resettable for RCC_MP_AHB4ENSETRrs {
