...
pub type R = crate::R<RCC_MP_AHB4LPENSETRrs>;
///Register `RCC_MP_AHB4LPENSETR` writer
pub type W = crate::W<RCC_MP_AHB4LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_AHB4LPENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpioalpen(&mut self) -> GPIOALPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOALPEN_W::new(self, 0)
    }
    ///Bit 1 - GPIOBLPEN
    #[inline(always)]
    #[must_use]
    pub fn gpioblpen(&mut self) -> GPIOBLPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOBLPEN_W::new(self, 1)
    }
    ///Bit 2 - GPIOCLPEN
    #[inline(always)]
    #[must_use]
    pub fn gpioclpen(&mut self) -> GPIOCLPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOCLPEN_W::new(self, 2)
    }
    ///Bit 3 - GPIODLPEN
    #[inline(always)]
    #[must_use]
    pub fn gpiodlpen(&mut self) -> GPIODLPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIODLPEN_W::new(self, 3)
    }
    ///Bit 4 - GPIOELPEN
    #[inline(always)]
    #[must_use]
    pub fn gpioelpen(&mut self) -> GPIOELPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOELPEN_W::new(self, 4)
    }
    ///Bit 5 - GPIOFLPEN
    #[inline(always)]
    #[must_use]
    pub fn gpioflpen(&mut self) -> GPIOFLPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOFLPEN_W::new(self, 5)
    }
    ///Bit 6 - GPIOGLPEN
    #[inline(always)]
    #[must_use]
    pub fn gpioglpen(&mut self) -> GPIOGLPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOGLPEN_W::new(self, 6)
    }
    ///Bit 7 - GPIOHLPEN
    #[inline(always)]
    #[must_use]
    pub fn gpiohlpen(&mut self) -> GPIOHLPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOHLPEN_W::new(self, 7)
    }
    ///Bit 8 - GPIOILPEN
    #[inline(always)]
    #[must_use]
    pub fn gpioilpen(&mut self) -> GPIOILPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOILPEN_W::new(self, 8)
    }
    ///Bit 9 - GPIOJLPEN
    #[inline(always)]
    #[must_use]
    pub fn gpiojlpen(&mut self) -> GPIOJLPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOJLPEN_W::new(self, 9)
    }
    ///Bit 10 - GPIOKLPEN
    #[inline(always)]
    #[must_use]
    pub fn gpioklpen(&mut self) -> GPIOKLPEN_W<RCC_MP_AHB4LPENSETRrs> {
        GPIOKLPEN_W::new(self, 10)
    }
}
/**This register is used by the MPU

You can [`read`](crate::Reg::read) this register and get [`rcc_mp_ahb4lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_ahb4lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_AHB4LPENSETR)*/
pub struct RCC_MP_AHB4LPENSETRrs;
impl crate::RegisterSpec for RCC_MP_AHB4LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_ahb4lpensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_AHB4LPENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_ahb4lpensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_AHB4LPENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_AHB4LPENSETR to value 0x07ff
impl crate::Resettable for RCC_MP_AHB4LPENSETRrs {
