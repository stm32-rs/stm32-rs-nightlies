...
pub type R = crate::R<RCC_MP_AHB6LPENCLRRrs>;
///Register `RCC_MP_AHB6LPENCLRR` writer
pub type W = crate::W<RCC_MP_AHB6LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_AHB6LPENCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdmalpen(&mut self) -> MDMALPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        MDMALPEN_W::new(self, 0)
    }
    ///Bit 5 - GPULPEN
    #[inline(always)]
    #[must_use]
    pub fn gpulpen(&mut self) -> GPULPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        GPULPEN_W::new(self, 5)
    }
    ///Bit 7 - ETHCKLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethcklpen(&mut self) -> ETHCKLPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        ETHCKLPEN_W::new(self, 7)
    }
    ///Bit 8 - ETHTXLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethtxlpen(&mut self) -> ETHTXLPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        ETHTXLPEN_W::new(self, 8)
    }
    ///Bit 9 - ETHRXLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethrxlpen(&mut self) -> ETHRXLPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        ETHRXLPEN_W::new(self, 9)
    }
    ///Bit 10 - ETHMACLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethmaclpen(&mut self) -> ETHMACLPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        ETHMACLPEN_W::new(self, 10)
    }
    ///Bit 11 - ETHSTPEN
    #[inline(always)]
    #[must_use]
    pub fn ethstpen(&mut self) -> ETHSTPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        ETHSTPEN_W::new(self, 11)
    }
    ///Bit 12 - FMCLPEN
    #[inline(always)]
    #[must_use]
    pub fn fmclpen(&mut self) -> FMCLPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        FMCLPEN_W::new(self, 12)
    }
    ///Bit 14 - QSPILPEN
    #[inline(always)]
    #[must_use]
    pub fn qspilpen(&mut self) -> QSPILPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        QSPILPEN_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1LPEN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc1lpen(&mut self) -> SDMMC1LPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        SDMMC1LPEN_W::new(self, 16)
    }
    ///Bit 17 - SDMMC2LPEN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc2lpen(&mut self) -> SDMMC2LPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        SDMMC2LPEN_W::new(self, 17)
    }
    ///Bit 20 - CRC1LPEN
    #[inline(always)]
    #[must_use]
    pub fn crc1lpen(&mut self) -> CRC1LPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        CRC1LPEN_W::new(self, 20)
    }
    ///Bit 24 - USBHLPEN
    #[inline(always)]
    #[must_use]
    pub fn usbhlpen(&mut self) -> USBHLPEN_W<RCC_MP_AHB6LPENCLRRrs> {
        USBHLPEN_W::new(self, 24)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bits

You can [`read`](crate::Reg::read) this register and get [`rcc_mp_ahb6lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_ahb6lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_AHB6LPENCLRR)*/
pub struct RCC_MP_AHB6LPENCLRRrs;
impl crate::RegisterSpec for RCC_MP_AHB6LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_ahb6lpenclrr::R`](R) reader structure
impl crate::Readable for RCC_MP_AHB6LPENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mp_ahb6lpenclrr::W`](W) writer structure
impl crate::Writable for RCC_MP_AHB6LPENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_AHB6LPENCLRR to value 0x0113_57a1
impl crate::Resettable for RCC_MP_AHB6LPENCLRRrs {
