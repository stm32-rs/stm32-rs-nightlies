...
pub type R = crate::R<RCC_MP_APB2ENSETRrs>;
///Register `RCC_MP_APB2ENSETR` writer
pub type W = crate::W<RCC_MP_APB2ENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_APB2ENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim1en(&mut self) -> TIM1EN_W<RCC_MP_APB2ENSETRrs> {
        TIM1EN_W::new(self, 0)
    }
    ///Bit 1 - TIM8EN
    #[inline(always)]
    #[must_use]
    pub fn tim8en(&mut self) -> TIM8EN_W<RCC_MP_APB2ENSETRrs> {
        TIM8EN_W::new(self, 1)
    }
    ///Bit 2 - TIM15EN
    #[inline(always)]
    #[must_use]
    pub fn tim15en(&mut self) -> TIM15EN_W<RCC_MP_APB2ENSETRrs> {
        TIM15EN_W::new(self, 2)
    }
    ///Bit 3 - TIM16EN
    #[inline(always)]
    #[must_use]
    pub fn tim16en(&mut self) -> TIM16EN_W<RCC_MP_APB2ENSETRrs> {
        TIM16EN_W::new(self, 3)
    }
    ///Bit 4 - TIM17EN
    #[inline(always)]
    #[must_use]
    pub fn tim17en(&mut self) -> TIM17EN_W<RCC_MP_APB2ENSETRrs> {
        TIM17EN_W::new(self, 4)
    }
    ///Bit 8 - SPI1EN
    #[inline(always)]
    #[must_use]
    pub fn spi1en(&mut self) -> SPI1EN_W<RCC_MP_APB2ENSETRrs> {
        SPI1EN_W::new(self, 8)
    }
    ///Bit 9 - SPI4EN
    #[inline(always)]
    #[must_use]
    pub fn spi4en(&mut self) -> SPI4EN_W<RCC_MP_APB2ENSETRrs> {
        SPI4EN_W::new(self, 9)
    }
    ///Bit 10 - SPI5EN
    #[inline(always)]
    #[must_use]
    pub fn spi5en(&mut self) -> SPI5EN_W<RCC_MP_APB2ENSETRrs> {
        SPI5EN_W::new(self, 10)
    }
    ///Bit 13 - USART6EN
    #[inline(always)]
    #[must_use]
    pub fn usart6en(&mut self) -> USART6EN_W<RCC_MP_APB2ENSETRrs> {
        USART6EN_W::new(self, 13)
    }
    ///Bit 16 - SAI1EN
    #[inline(always)]
    #[must_use]
    pub fn sai1en(&mut self) -> SAI1EN_W<RCC_MP_APB2ENSETRrs> {
        SAI1EN_W::new(self, 16)
    }
    ///Bit 17 - SAI2EN
    #[inline(always)]
    #[must_use]
    pub fn sai2en(&mut self) -> SAI2EN_W<RCC_MP_APB2ENSETRrs> {
        SAI2EN_W::new(self, 17)
    }
    ///Bit 18 - SAI3EN
    #[inline(always)]
    #[must_use]
    pub fn sai3en(&mut self) -> SAI3EN_W<RCC_MP_APB2ENSETRrs> {
        SAI3EN_W::new(self, 18)
    }
    ///Bit 20 - DFSDMEN
    #[inline(always)]
    #[must_use]
    pub fn dfsdmen(&mut self) -> DFSDMEN_W<RCC_MP_APB2ENSETRrs> {
        DFSDMEN_W::new(self, 20)
    }
    ///Bit 21 - ADFSDMEN
    #[inline(always)]
    #[must_use]
    pub fn adfsdmen(&mut self) -> ADFSDMEN_W<RCC_MP_APB2ENSETRrs> {
        ADFSDMEN_W::new(self, 21)
    }
    ///Bit 24 - FDCANEN
    #[inline(always)]
    #[must_use]
    pub fn fdcanen(&mut self) -> FDCANEN_W<RCC_MP_APB2ENSETRrs> {
        FDCANEN_W::new(self, 24)
    }
}
/**This register is used to set the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mp_apb2ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_apb2ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_APB2ENSETR)*/
pub struct RCC_MP_APB2ENSETRrs;
impl crate::RegisterSpec for RCC_MP_APB2ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_apb2ensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_APB2ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_apb2ensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_APB2ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_APB2ENSETR to value 0
impl crate::Resettable for RCC_MP_APB2ENSETRrs {
