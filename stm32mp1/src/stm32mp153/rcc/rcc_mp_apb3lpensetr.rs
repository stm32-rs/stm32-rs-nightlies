...
pub type R = crate::R<RCC_MP_APB3LPENSETRrs>;
///Register `RCC_MP_APB3LPENSETR` writer
pub type W = crate::W<RCC_MP_APB3LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_APB3LPENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lptim2lpen(&mut self) -> LPTIM2LPEN_W<RCC_MP_APB3LPENSETRrs> {
        LPTIM2LPEN_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3LPEN
    #[inline(always)]
    #[must_use]
    pub fn lptim3lpen(&mut self) -> LPTIM3LPEN_W<RCC_MP_APB3LPENSETRrs> {
        LPTIM3LPEN_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4LPEN
    #[inline(always)]
    #[must_use]
    pub fn lptim4lpen(&mut self) -> LPTIM4LPEN_W<RCC_MP_APB3LPENSETRrs> {
        LPTIM4LPEN_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5LPEN
    #[inline(always)]
    #[must_use]
    pub fn lptim5lpen(&mut self) -> LPTIM5LPEN_W<RCC_MP_APB3LPENSETRrs> {
        LPTIM5LPEN_W::new(self, 3)
    }
    ///Bit 8 - SAI4LPEN
    #[inline(always)]
    #[must_use]
    pub fn sai4lpen(&mut self) -> SAI4LPEN_W<RCC_MP_APB3LPENSETRrs> {
        SAI4LPEN_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGLPEN
    #[inline(always)]
    #[must_use]
    pub fn syscfglpen(&mut self) -> SYSCFGLPEN_W<RCC_MP_APB3LPENSETRrs> {
        SYSCFGLPEN_W::new(self, 11)
    }
    ///Bit 13 - VREFLPEN
    #[inline(always)]
    #[must_use]
    pub fn vreflpen(&mut self) -> VREFLPEN_W<RCC_MP_APB3LPENSETRrs> {
        VREFLPEN_W::new(self, 13)
    }
    ///Bit 16 - DTSLPEN
    #[inline(always)]
    #[must_use]
    pub fn dtslpen(&mut self) -> DTSLPEN_W<RCC_MP_APB3LPENSETRrs> {
        DTSLPEN_W::new(self, 16)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bits

You can [`read`](crate::Reg::read) this register and get [`rcc_mp_apb3lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_apb3lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_APB3LPENSETR)*/
pub struct RCC_MP_APB3LPENSETRrs;
impl crate::RegisterSpec for RCC_MP_APB3LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_apb3lpensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_APB3LPENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_apb3lpensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_APB3LPENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_APB3LPENSETR to value 0x0003_290f
impl crate::Resettable for RCC_MP_APB3LPENSETRrs {
