///Register `RCC_MP_APB4ENCLRR` reader
pub type R = crate::R<RCC_MP_APB4ENCLRRrs>;
///Register `RCC_MP_APB4ENCLRR` writer
pub type W = crate::W<RCC_MP_APB4ENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_APB4ENCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ltdcen(&mut self) -> LTDCEN_W<RCC_MP_APB4ENCLRRrs> {
        LTDCEN_W::new(self, 0)
    }
    ///Bit 4 - DSIEN
    #[inline(always)]
    #[must_use]
    pub fn dsien(&mut self) -> DSIEN_W<RCC_MP_APB4ENCLRRrs> {
        DSIEN_W::new(self, 4)
    }
    ///Bit 8 - DDRPERFMEN
    #[inline(always)]
    #[must_use]
    pub fn ddrperfmen(&mut self) -> DDRPERFMEN_W<RCC_MP_APB4ENCLRRrs> {
        DDRPERFMEN_W::new(self, 8)
    }
    ///Bit 15 - IWDG2APBEN
    #[inline(always)]
    #[must_use]
    pub fn iwdg2apben(&mut self) -> IWDG2APBEN_W<RCC_MP_APB4ENCLRRrs> {
        IWDG2APBEN_W::new(self, 15)
    }
    ///Bit 16 - USBPHYEN
    #[inline(always)]
    #[must_use]
    pub fn usbphyen(&mut self) -> USBPHYEN_W<RCC_MP_APB4ENCLRRrs> {
        USBPHYEN_W::new(self, 16)
    }
    ///Bit 20 - STGENROEN
    #[inline(always)]
    #[must_use]
    pub fn stgenroen(&mut self) -> STGENROEN_W<RCC_MP_APB4ENCLRRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_apb4enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_apb4enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_APB4ENCLRR)*/
pub struct RCC_MP_APB4ENCLRRrs;
impl crate::RegisterSpec for RCC_MP_APB4ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_apb4enclrr::R`](R) reader structure
impl crate::Readable for RCC_MP_APB4ENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mp_apb4enclrr::W`](W) writer structure
impl crate::Writable for RCC_MP_APB4ENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_APB4ENCLRR to value 0
impl crate::Resettable for RCC_MP_APB4ENCLRRrs {
