///Register `RCC_MP_APB5LPENSETR` reader
pub type R = crate::R<RCC_MP_APB5LPENSETRrs>;
///Register `RCC_MP_APB5LPENSETR` writer
pub type W = crate::W<RCC_MP_APB5LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_APB5LPENSETR")
            ...
            .field("iwdg1apblpen", &self.iwdg1apblpen())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi6lpen(&mut self) -> SPI6LPEN_W<RCC_MP_APB5LPENSETRrs> {
        SPI6LPEN_W::new(self, 0)
    }
    ///Bit 2 - I2C4LPEN
    #[inline(always)]
    #[must_use]
    pub fn i2c4lpen(&mut self) -> I2C4LPEN_W<RCC_MP_APB5LPENSETRrs> {
        I2C4LPEN_W::new(self, 2)
    }
    ///Bit 3 - I2C6LPEN
    #[inline(always)]
    #[must_use]
    pub fn i2c6lpen(&mut self) -> I2C6LPEN_W<RCC_MP_APB5LPENSETRrs> {
        I2C6LPEN_W::new(self, 3)
    }
    ///Bit 4 - USART1LPEN
    #[inline(always)]
    #[must_use]
    pub fn usart1lpen(&mut self) -> USART1LPEN_W<RCC_MP_APB5LPENSETRrs> {
        USART1LPEN_W::new(self, 4)
    }
    ///Bit 8 - RTCAPBLPEN
    #[inline(always)]
    #[must_use]
    pub fn rtcapblpen(&mut self) -> RTCAPBLPEN_W<RCC_MP_APB5LPENSETRrs> {
        RTCAPBLPEN_W::new(self, 8)
    }
    ///Bit 11 - TZC1LPEN
    #[inline(always)]
    #[must_use]
    pub fn tzc1lpen(&mut self) -> TZC1LPEN_W<RCC_MP_APB5LPENSETRrs> {
        TZC1LPEN_W::new(self, 11)
    }
    ///Bit 12 - TZC2LPEN
    #[inline(always)]
    #[must_use]
    pub fn tzc2lpen(&mut self) -> TZC2LPEN_W<RCC_MP_APB5LPENSETRrs> {
        TZC2LPEN_W::new(self, 12)
    }
    ///Bit 13 - TZPCLPEN
    #[inline(always)]
    #[must_use]
    pub fn tzpclpen(&mut self) -> TZPCLPEN_W<RCC_MP_APB5LPENSETRrs> {
        TZPCLPEN_W::new(self, 13)
    }
    ///Bit 15 - IWDG1APBLPEN
    #[inline(always)]
    #[must_use]
    pub fn iwdg1apblpen(&mut self) -> IWDG1APBLPEN_W<RCC_MP_APB5LPENSETRrs> {
        IWDG1APBLPEN_W::new(self, 15)
    }
    ///Bit 16 - BSECLPEN
    #[inline(always)]
    #[must_use]
    pub fn bseclpen(&mut self) -> BSECLPEN_W<RCC_MP_APB5LPENSETRrs> {
        BSECLPEN_W::new(self, 16)
    }
    ///Bit 20 - STGENLPEN
    #[inline(always)]
    #[must_use]
    pub fn stgenlpen(&mut self) -> STGENLPEN_W<RCC_MP_APB5LPENSETRrs> {
        STGENLPEN_W::new(self, 20)
    }
    ///Bit 21 - STGENSTPEN
    #[inline(always)]
    #[must_use]
    pub fn stgenstpen(&mut self) -> STGENSTPEN_W<RCC_MP_APB5LPENSETRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_apb5lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_apb5lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_APB5LPENSETR)*/
pub struct RCC_MP_APB5LPENSETRrs;
impl crate::RegisterSpec for RCC_MP_APB5LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_apb5lpensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_APB5LPENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_apb5lpensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_APB5LPENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_APB5LPENSETR to value 0x0011_391d
impl crate::Resettable for RCC_MP_APB5LPENSETRrs {
