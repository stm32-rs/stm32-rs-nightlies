...
pub type R = crate::R<RCC_MP_CIFRrs>;
///Register `RCC_MP_CIFR` writer
pub type W = crate::W<RCC_MP_CIFRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lsirdyf(&mut self) -> LSIRDYF_W<RCC_MP_CIFRrs> {
        LSIRDYF_W::new(self, 0)
    }
    ///Bit 1 - LSERDYF
    #[inline(always)]
    #[must_use]
    pub fn lserdyf(&mut self) -> LSERDYF_W<RCC_MP_CIFRrs> {
        LSERDYF_W::new(self, 1)
    }
    ///Bit 2 - HSIRDYF
    #[inline(always)]
    #[must_use]
    pub fn hsirdyf(&mut self) -> HSIRDYF_W<RCC_MP_CIFRrs> {
        HSIRDYF_W::new(self, 2)
    }
    ///Bit 3 - HSERDYF
    #[inline(always)]
    #[must_use]
    pub fn hserdyf(&mut self) -> HSERDYF_W<RCC_MP_CIFRrs> {
        HSERDYF_W::new(self, 3)
    }
    ///Bit 4 - CSIRDYF
    #[inline(always)]
    #[must_use]
    pub fn csirdyf(&mut self) -> CSIRDYF_W<RCC_MP_CIFRrs> {
        CSIRDYF_W::new(self, 4)
    }
    ///Bit 8 - PLL1DYF
    #[inline(always)]
    #[must_use]
    pub fn pll1dyf(&mut self) -> PLL1DYF_W<RCC_MP_CIFRrs> {
        PLL1DYF_W::new(self, 8)
    }
    ///Bit 9 - PLL2DYF
    #[inline(always)]
    #[must_use]
    pub fn pll2dyf(&mut self) -> PLL2DYF_W<RCC_MP_CIFRrs> {
        PLL2DYF_W::new(self, 9)
    }
    ///Bit 10 - PLL3DYF
    #[inline(always)]
    #[must_use]
    pub fn pll3dyf(&mut self) -> PLL3DYF_W<RCC_MP_CIFRrs> {
        PLL3DYF_W::new(self, 10)
    }
    ///Bit 11 - PLL4DYF
    #[inline(always)]
    #[must_use]
    pub fn pll4dyf(&mut self) -> PLL4DYF_W<RCC_MP_CIFRrs> {
        PLL4DYF_W::new(self, 11)
    }
    ///Bit 16 - LSECSSF
    #[inline(always)]
    #[must_use]
    pub fn lsecssf(&mut self) -> LSECSSF_W<RCC_MP_CIFRrs> {
        LSECSSF_W::new(self, 16)
    }
    ///Bit 20 - WKUPF
    #[inline(always)]
    #[must_use]
    pub fn wkupf(&mut self) -> WKUPF_W<RCC_MP_CIFRrs> {
        WKUPF_W::new(self, 20)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_cifr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_cifr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_CIFR)*/
pub struct RCC_MP_CIFRrs;
impl crate::RegisterSpec for RCC_MP_CIFRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_cifr::R`](R) reader structure
impl crate::Readable for RCC_MP_CIFRrs {}
///`write(|w| ..)` method takes [`rcc_mp_cifr::W`](W) writer structure
impl crate::Writable for RCC_MP_CIFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_CIFR to value 0
impl crate::Resettable for RCC_MP_CIFRrs {
