...
pub type R = crate::R<RCC_MP_IWDGFZCLRRrs>;
///Register `RCC_MP_IWDGFZCLRR` writer
pub type W = crate::W<RCC_MP_IWDGFZCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_IWDGFZCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fz_iwdg1(&mut self) -> FZ_IWDG1_W<RCC_MP_IWDGFZCLRRrs> {
        FZ_IWDG1_W::new(self, 0)
    }
    ///Bit 1 - FZ_IWDG2
    #[inline(always)]
    #[must_use]
    pub fn fz_iwdg2(&mut self) -> FZ_IWDG2_W<RCC_MP_IWDGFZCLRRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_iwdgfzclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_iwdgfzclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_IWDGFZCLRR)*/
pub struct RCC_MP_IWDGFZCLRRrs;
impl crate::RegisterSpec for RCC_MP_IWDGFZCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_iwdgfzclrr::R`](R) reader structure
impl crate::Readable for RCC_MP_IWDGFZCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mp_iwdgfzclrr::W`](W) writer structure
impl crate::Writable for RCC_MP_IWDGFZCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_IWDGFZCLRR to value 0
impl crate::Resettable for RCC_MP_IWDGFZCLRRrs {
