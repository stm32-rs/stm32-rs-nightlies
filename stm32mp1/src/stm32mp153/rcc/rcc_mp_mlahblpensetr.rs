///Register `RCC_MP_MLAHBLPENSETR` reader
pub type R = crate::R<RCC_MP_MLAHBLPENSETRrs>;
///Register `RCC_MP_MLAHBLPENSETR` writer
pub type W = crate::W<RCC_MP_MLAHBLPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_MLAHBLPENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sram1lpen(&mut self) -> SRAM1LPEN_W<RCC_MP_MLAHBLPENSETRrs> {
        SRAM1LPEN_W::new(self, 0)
    }
    ///Bit 1 - SRAM2LPEN
    #[inline(always)]
    #[must_use]
    pub fn sram2lpen(&mut self) -> SRAM2LPEN_W<RCC_MP_MLAHBLPENSETRrs> {
        SRAM2LPEN_W::new(self, 1)
    }
    ///Bit 2 - SRAM34LPEN
    #[inline(always)]
    #[must_use]
    pub fn sram34lpen(&mut self) -> SRAM34LPEN_W<RCC_MP_MLAHBLPENSETRrs> {
        SRAM34LPEN_W::new(self, 2)
    }
    ///Bit 4 - RETRAMLPEN
    #[inline(always)]
    #[must_use]
    pub fn retramlpen(&mut self) -> RETRAMLPEN_W<RCC_MP_MLAHBLPENSETRrs> {
        RETRAMLPEN_W::new(self, 4)
    }
}
/**This register is used by the MPU in order to set the PERxLPEN bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mp_mlahblpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_mlahblpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_MLAHBLPENSETR)*/
pub struct RCC_MP_MLAHBLPENSETRrs;
impl crate::RegisterSpec for RCC_MP_MLAHBLPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_mlahblpensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_MLAHBLPENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_mlahblpensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_MLAHBLPENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_MLAHBLPENSETR to value 0x17
impl crate::Resettable for RCC_MP_MLAHBLPENSETRrs {
