...
pub type R = crate::R<RCC_MP_RSTSCLRRrs>;
///Register `RCC_MP_RSTSCLRR` writer
pub type W = crate::W<RCC_MP_RSTSCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_RSTSCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn porrstf(&mut self) -> PORRSTF_W<RCC_MP_RSTSCLRRrs> {
        PORRSTF_W::new(self, 0)
    }
    ///Bit 1 - BORRSTF
    #[inline(always)]
    #[must_use]
    pub fn borrstf(&mut self) -> BORRSTF_W<RCC_MP_RSTSCLRRrs> {
        BORRSTF_W::new(self, 1)
    }
    ///Bit 2 - PADRSTF
    #[inline(always)]
    #[must_use]
    pub fn padrstf(&mut self) -> PADRSTF_W<RCC_MP_RSTSCLRRrs> {
        PADRSTF_W::new(self, 2)
    }
    ///Bit 3 - HCSSRSTF
    #[inline(always)]
    #[must_use]
    pub fn hcssrstf(&mut self) -> HCSSRSTF_W<RCC_MP_RSTSCLRRrs> {
        HCSSRSTF_W::new(self, 3)
    }
    ///Bit 4 - VCORERSTF
    #[inline(always)]
    #[must_use]
    pub fn vcorerstf(&mut self) -> VCORERSTF_W<RCC_MP_RSTSCLRRrs> {
        VCORERSTF_W::new(self, 4)
    }
    ///Bit 6 - MPSYSRSTF
    #[inline(always)]
    #[must_use]
    pub fn mpsysrstf(&mut self) -> MPSYSRSTF_W<RCC_MP_RSTSCLRRrs> {
        MPSYSRSTF_W::new(self, 6)
    }
    ///Bit 7 - MCSYSRSTF
    #[inline(always)]
    #[must_use]
    pub fn mcsysrstf(&mut self) -> MCSYSRSTF_W<RCC_MP_RSTSCLRRrs> {
        MCSYSRSTF_W::new(self, 7)
    }
    ///Bit 8 - IWDG1RSTF
    #[inline(always)]
    #[must_use]
    pub fn iwdg1rstf(&mut self) -> IWDG1RSTF_W<RCC_MP_RSTSCLRRrs> {
        IWDG1RSTF_W::new(self, 8)
    }
    ///Bit 9 - IWDG2RSTF
    #[inline(always)]
    #[must_use]
    pub fn iwdg2rstf(&mut self) -> IWDG2RSTF_W<RCC_MP_RSTSCLRRrs> {
        IWDG2RSTF_W::new(self, 9)
    }
    ///Bit 11 - STDBYRSTF
    #[inline(always)]
    #[must_use]
    pub fn stdbyrstf(&mut self) -> STDBYRSTF_W<RCC_MP_RSTSCLRRrs> {
        STDBYRSTF_W::new(self, 11)
    }
    ///Bit 12 - CSTDBYRSTF
    #[inline(always)]
    #[must_use]
    pub fn cstdbyrstf(&mut self) -> CSTDBYRSTF_W<RCC_MP_RSTSCLRRrs> {
        CSTDBYRSTF_W::new(self, 12)
    }
    ///Bit 13 - MPUP0RSTF
    #[inline(always)]
    #[must_use]
    pub fn mpup0rstf(&mut self) -> MPUP0RSTF_W<RCC_MP_RSTSCLRRrs> {
        MPUP0RSTF_W::new(self, 13)
    }
    ///Bit 14 - MPUP1RSTF
    #[inline(always)]
    #[must_use]
    pub fn mpup1rstf(&mut self) -> MPUP1RSTF_W<RCC_MP_RSTSCLRRrs> {
        MPUP1RSTF_W::new(self, 14)
    }
    ///Bit 15 - SPARE
    #[inline(always)]
    #[must_use]
    pub fn spare(&mut self) -> SPARE_W<RCC_MP_RSTSCLRRrs> {
        SPARE_W::new(self, 15)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_rstsclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_rstsclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_MP_RSTSCLRR)*/
pub struct RCC_MP_RSTSCLRRrs;
impl crate::RegisterSpec for RCC_MP_RSTSCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_rstsclrr::R`](R) reader structure
impl crate::Readable for RCC_MP_RSTSCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mp_rstsclrr::W`](W) writer structure
impl crate::Writable for RCC_MP_RSTSCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_RSTSCLRR to value 0
impl crate::Resettable for RCC_MP_RSTSCLRRrs {
