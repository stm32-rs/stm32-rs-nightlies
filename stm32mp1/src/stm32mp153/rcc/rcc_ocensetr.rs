///Register `RCC_OCENSETR` reader
pub type R = crate::R<RCC_OCENSETRrs>;
///Register `RCC_OCENSETR` writer
pub type W = crate::W<RCC_OCENSETRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hsion(&mut self) -> HSION_W<RCC_OCENSETRrs> {
        HSION_W::new(self, 0)
    }
    ///Bit 1 - HSIKERON
    #[inline(always)]
    #[must_use]
    pub fn hsikeron(&mut self) -> HSIKERON_W<RCC_OCENSETRrs> {
        HSIKERON_W::new(self, 1)
    }
    ///Bit 4 - CSION
    #[inline(always)]
    #[must_use]
    pub fn csion(&mut self) -> CSION_W<RCC_OCENSETRrs> {
        CSION_W::new(self, 4)
    }
    ///Bit 5 - CSIKERON
    #[inline(always)]
    #[must_use]
    pub fn csikeron(&mut self) -> CSIKERON_W<RCC_OCENSETRrs> {
        CSIKERON_W::new(self, 5)
    }
    ///Bit 7 - DIGBYP
    #[inline(always)]
    #[must_use]
    pub fn digbyp(&mut self) -> DIGBYP_W<RCC_OCENSETRrs> {
        DIGBYP_W::new(self, 7)
    }
    ///Bit 8 - HSEON
    #[inline(always)]
    #[must_use]
    pub fn hseon(&mut self) -> HSEON_W<RCC_OCENSETRrs> {
        HSEON_W::new(self, 8)
    }
    ///Bit 9 - HSEKERON
    #[inline(always)]
    #[must_use]
    pub fn hsekeron(&mut self) -> HSEKERON_W<RCC_OCENSETRrs> {
        HSEKERON_W::new(self, 9)
    }
    ///Bit 10 - HSEBYP
    #[inline(always)]
    #[must_use]
    pub fn hsebyp(&mut self) -> HSEBYP_W<RCC_OCENSETRrs> {
        HSEBYP_W::new(self, 10)
    }
    ///Bit 11 - HSECSSON
    #[inline(always)]
    #[must_use]
    pub fn hsecsson(&mut self) -> HSECSSON_W<RCC_OCENSETRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`rcc_ocensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_ocensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_OCENSETR)*/
pub struct RCC_OCENSETRrs;
impl crate::RegisterSpec for RCC_OCENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_ocensetr::R`](R) reader structure
impl crate::Readable for RCC_OCENSETRrs {}
///`write(|w| ..)` method takes [`rcc_ocensetr::W`](W) writer structure
impl crate::Writable for RCC_OCENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_OCENSETR to value 0x01
impl crate::Resettable for RCC_OCENSETRrs {
