///Register `RCC_PLL1CSGR` reader
pub type R = crate::R<RCC_PLL1CSGRrs>;
///Register `RCC_PLL1CSGR` writer
...
You can [`read`](crate::Reg::read) this register and get [`rcc_pll1csgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_pll1csgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_PLL1CSGR)*/
pub struct RCC_PLL1CSGRrs;
impl crate::RegisterSpec for RCC_PLL1CSGRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_pll1csgr::R`](R) reader structure
impl crate::Readable for RCC_PLL1CSGRrs {}
///`write(|w| ..)` method takes [`rcc_pll1csgr::W`](W) writer structure
impl crate::Writable for RCC_PLL1CSGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_PLL1CSGR to value 0
