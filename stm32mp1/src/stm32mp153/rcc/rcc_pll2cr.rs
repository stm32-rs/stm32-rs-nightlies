///Register `RCC_PLL2CR` reader
pub type R = crate::R<RCC_PLL2CRrs>;
///Register `RCC_PLL2CR` writer
pub type W = crate::W<RCC_PLL2CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllon(&mut self) -> PLLON_W<RCC_PLL2CRrs> {
        PLLON_W::new(self, 0)
    }
    ///Bit 2 - SSCG_CTRL
    #[inline(always)]
    #[must_use]
    pub fn sscg_ctrl(&mut self) -> SSCG_CTRL_W<RCC_PLL2CRrs> {
        SSCG_CTRL_W::new(self, 2)
    }
    ///Bit 4 - DIVPEN
    #[inline(always)]
    #[must_use]
    pub fn divpen(&mut self) -> DIVPEN_W<RCC_PLL2CRrs> {
        DIVPEN_W::new(self, 4)
    }
    ///Bit 5 - DIVQEN
    #[inline(always)]
    #[must_use]
    pub fn divqen(&mut self) -> DIVQEN_W<RCC_PLL2CRrs> {
        DIVQEN_W::new(self, 5)
    }
    ///Bit 6 - DIVREN
    #[inline(always)]
    #[must_use]
    pub fn divren(&mut self) -> DIVREN_W<RCC_PLL2CRrs> {
        DIVREN_W::new(self, 6)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`rcc_pll2cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_pll2cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_PLL2CR)*/
pub struct RCC_PLL2CRrs;
impl crate::RegisterSpec for RCC_PLL2CRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_pll2cr::R`](R) reader structure
impl crate::Readable for RCC_PLL2CRrs {}
///`write(|w| ..)` method takes [`rcc_pll2cr::W`](W) writer structure
impl crate::Writable for RCC_PLL2CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_PLL2CR to value 0
impl crate::Resettable for RCC_PLL2CRrs {
