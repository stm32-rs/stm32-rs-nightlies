...
pub type R = crate::R<RCC_PLL3CSGRrs>;
///Register `RCC_PLL3CSGR` writer
pub type W = crate::W<RCC_PLL3CSGRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mod_per(&mut self) -> MOD_PER_W<RCC_PLL3CSGRrs> {
        MOD_PER_W::new(self, 0)
    }
    ///Bit 13 - TPDFN_DIS
    #[inline(always)]
    #[must_use]
    pub fn tpdfn_dis(&mut self) -> TPDFN_DIS_W<RCC_PLL3CSGRrs> {
        TPDFN_DIS_W::new(self, 13)
    }
    ///Bit 14 - RPDFN_DIS
    #[inline(always)]
    #[must_use]
    pub fn rpdfn_dis(&mut self) -> RPDFN_DIS_W<RCC_PLL3CSGRrs> {
        RPDFN_DIS_W::new(self, 14)
    }
    ///Bit 15 - SSCG_MODE
    #[inline(always)]
    #[must_use]
    pub fn sscg_mode(&mut self) -> SSCG_MODE_W<RCC_PLL3CSGRrs> {
        SSCG_MODE_W::new(self, 15)
    }
    ///Bits 16:30 - INC_STEP
    #[inline(always)]
    #[must_use]
    pub fn inc_step(&mut self) -> INC_STEP_W<RCC_PLL3CSGRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`rcc_pll3csgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_pll3csgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_PLL3CSGR)*/
pub struct RCC_PLL3CSGRrs;
impl crate::RegisterSpec for RCC_PLL3CSGRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_pll3csgr::R`](R) reader structure
impl crate::Readable for RCC_PLL3CSGRrs {}
///`write(|w| ..)` method takes [`rcc_pll3csgr::W`](W) writer structure
impl crate::Writable for RCC_PLL3CSGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_PLL3CSGR to value 0
impl crate::Resettable for RCC_PLL3CSGRrs {
