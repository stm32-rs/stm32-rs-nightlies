...
pub type R = crate::R<RCC_PLL4CSGRrs>;
///Register `RCC_PLL4CSGR` writer
pub type W = crate::W<RCC_PLL4CSGRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mod_per(&mut self) -> MOD_PER_W<RCC_PLL4CSGRrs> {
        MOD_PER_W::new(self, 0)
    }
    ///Bit 13 - TPDFN_DIS
    #[inline(always)]
    #[must_use]
    pub fn tpdfn_dis(&mut self) -> TPDFN_DIS_W<RCC_PLL4CSGRrs> {
        TPDFN_DIS_W::new(self, 13)
    }
    ///Bit 14 - RPDFN_DIS
    #[inline(always)]
    #[must_use]
    pub fn rpdfn_dis(&mut self) -> RPDFN_DIS_W<RCC_PLL4CSGRrs> {
        RPDFN_DIS_W::new(self, 14)
    }
    ///Bit 15 - SSCG_MODE
    #[inline(always)]
    #[must_use]
    pub fn sscg_mode(&mut self) -> SSCG_MODE_W<RCC_PLL4CSGRrs> {
        SSCG_MODE_W::new(self, 15)
    }
    ///Bits 16:30 - INC_STEP
    #[inline(always)]
    #[must_use]
    pub fn inc_step(&mut self) -> INC_STEP_W<RCC_PLL4CSGRrs> {
