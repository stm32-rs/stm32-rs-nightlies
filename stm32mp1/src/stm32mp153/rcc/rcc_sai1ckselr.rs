///Register `RCC_SAI1CKSELR` reader
pub type R = crate::R<RCC_SAI1CKSELRrs>;
///Register `RCC_SAI1CKSELR` writer
...
You can [`read`](crate::Reg::read) this register and get [`rcc_sai1ckselr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_sai1ckselr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_SAI1CKSELR)*/
pub struct RCC_SAI1CKSELRrs;
impl crate::RegisterSpec for RCC_SAI1CKSELRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_sai1ckselr::R`](R) reader structure
impl crate::Readable for RCC_SAI1CKSELRrs {}
///`write(|w| ..)` method takes [`rcc_sai1ckselr::W`](W) writer structure
impl crate::Writable for RCC_SAI1CKSELRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_SAI1CKSELR to value 0
