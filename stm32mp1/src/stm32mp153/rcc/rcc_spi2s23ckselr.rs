///Register `RCC_SPI2S23CKSELR` reader
pub type R = crate::R<RCC_SPI2S23CKSELRrs>;
///Register `RCC_SPI2S23CKSELR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_SPI2S23CKSELR")
...
You can [`read`](crate::Reg::read) this register and get [`rcc_spi2s23ckselr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_spi2s23ckselr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#RCC:RCC_SPI2S23CKSELR)*/
pub struct RCC_SPI2S23CKSELRrs;
impl crate::RegisterSpec for RCC_SPI2S23CKSELRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_spi2s23ckselr::R`](R) reader structure
impl crate::Readable for RCC_SPI2S23CKSELRrs {}
///`write(|w| ..)` method takes [`rcc_spi2s23ckselr::W`](W) writer structure
impl crate::Writable for RCC_SPI2S23CKSELRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_SPI2S23CKSELR to value 0
