#[doc = "Register `RTC_SMISR` reader"]
pub struct R(crate::R<RTC_SMISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_SMISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_SMISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_SMISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "This register can be protected against non-secure access. Refer to Section50.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_smisr](index.html) module"]
pub struct RTC_SMISR_SPEC;
impl crate::RegisterSpec for RTC_SMISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_smisr::R](R) reader structure"]
impl crate::Readable for RTC_SMISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RTC_SMISR to value 0"]
impl crate::Resettable for RTC_SMISR_SPEC {
    #[inline(always)]
