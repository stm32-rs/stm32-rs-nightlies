///Register `SAI_ACR1` reader
pub type R = crate::R<SAI_ACR1rs>;
///Register `SAI_ACR1` writer
pub type W = crate::W<SAI_ACR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> MODE_W<SAI_ACR1rs> {
        MODE_W::new(self, 0)
    }
    ///Bits 2:3 - PRTCFG
    #[inline(always)]
    #[must_use]
    pub fn prtcfg(&mut self) -> PRTCFG_W<SAI_ACR1rs> {
        PRTCFG_W::new(self, 2)
    }
    ///Bits 5:7 - DS
    #[inline(always)]
    #[must_use]
    pub fn ds(&mut self) -> DS_W<SAI_ACR1rs> {
        DS_W::new(self, 5)
    }
    ///Bit 8 - LSBFIRST
    #[inline(always)]
    #[must_use]
    pub fn lsbfirst(&mut self) -> LSBFIRST_W<SAI_ACR1rs> {
        LSBFIRST_W::new(self, 8)
    }
    ///Bit 9 - CKSTR
    #[inline(always)]
    #[must_use]
    pub fn ckstr(&mut self) -> CKSTR_W<SAI_ACR1rs> {
        CKSTR_W::new(self, 9)
    }
    ///Bits 10:11 - SYNCEN
    #[inline(always)]
    #[must_use]
    pub fn syncen(&mut self) -> SYNCEN_W<SAI_ACR1rs> {
        SYNCEN_W::new(self, 10)
    }
    ///Bit 12 - MONO
    #[inline(always)]
    #[must_use]
    pub fn mono(&mut self) -> MONO_W<SAI_ACR1rs> {
        MONO_W::new(self, 12)
    }
    ///Bit 13 - OUTDRIV
    #[inline(always)]
    #[must_use]
    pub fn outdriv(&mut self) -> OUTDRIV_W<SAI_ACR1rs> {
        OUTDRIV_W::new(self, 13)
    }
    ///Bit 16 - SAIEN
    #[inline(always)]
    #[must_use]
    pub fn saien(&mut self) -> SAIEN_W<SAI_ACR1rs> {
        SAIEN_W::new(self, 16)
    }
    ///Bit 17 - DMAEN
    #[inline(always)]
    #[must_use]
    pub fn dmaen(&mut self) -> DMAEN_W<SAI_ACR1rs> {
        DMAEN_W::new(self, 17)
    }
    ///Bit 19 - NODIV
    #[inline(always)]
    #[must_use]
    pub fn nodiv(&mut self) -> NODIV_W<SAI_ACR1rs> {
        NODIV_W::new(self, 19)
    }
    ///Bits 20:25 - MCKDIV
    #[inline(always)]
    #[must_use]
    pub fn mckdiv(&mut self) -> MCKDIV_W<SAI_ACR1rs> {
        MCKDIV_W::new(self, 20)
    }
    ///Bit 26 - OSR
    #[inline(always)]
    #[must_use]
    pub fn osr(&mut self) -> OSR_W<SAI_ACR1rs> {
        OSR_W::new(self, 26)
    }
    ///Bit 27 - MCKEN
    #[inline(always)]
    #[must_use]
    pub fn mcken(&mut self) -> MCKEN_W<SAI_ACR1rs> {
        MCKEN_W::new(self, 27)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#SAI1:SAI_ACR1)*/
pub struct SAI_ACR1rs;
impl crate::RegisterSpec for SAI_ACR1rs {
    type Ux = u32;
}
///`read()` method returns [`sai_acr1::R`](R) reader structure
impl crate::Readable for SAI_ACR1rs {}
///`write(|w| ..)` method takes [`sai_acr1::W`](W) writer structure
impl crate::Writable for SAI_ACR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAI_ACR1 to value 0x40
impl crate::Resettable for SAI_ACR1rs {
