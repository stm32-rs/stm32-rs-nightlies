...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#SAI1:SAI_ASR)*/
pub struct SAI_ASRrs;
impl crate::RegisterSpec for SAI_ASRrs {
    type Ux = u32;
}
///`read()` method returns [`sai_asr::R`](R) reader structure
impl crate::Readable for SAI_ASRrs {}
///`reset()` method sets SAI_ASR to value 0x08
