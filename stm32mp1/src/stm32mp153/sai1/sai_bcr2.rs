///Register `SAI_BCR2` reader
pub type R = crate::R<SAI_BCR2rs>;
///Register `SAI_BCR2` writer
pub type W = crate::W<SAI_BCR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fth(&mut self) -> FTH_W<SAI_BCR2rs> {
        FTH_W::new(self, 0)
    }
    ///Bit 3 - FFLUSH
    #[inline(always)]
    #[must_use]
    pub fn fflush(&mut self) -> FFLUSH_W<SAI_BCR2rs> {
        FFLUSH_W::new(self, 3)
    }
    ///Bit 4 - TRIS
    #[inline(always)]
    #[must_use]
    pub fn tris(&mut self) -> TRIS_W<SAI_BCR2rs> {
        TRIS_W::new(self, 4)
    }
    ///Bit 5 - MUTE
    #[inline(always)]
    #[must_use]
    pub fn mute(&mut self) -> MUTE_W<SAI_BCR2rs> {
        MUTE_W::new(self, 5)
    }
    ///Bit 6 - MUTEVAL
    #[inline(always)]
    #[must_use]
    pub fn muteval(&mut self) -> MUTEVAL_W<SAI_BCR2rs> {
        MUTEVAL_W::new(self, 6)
    }
    ///Bits 7:12 - MUTECNT
    #[inline(always)]
    #[must_use]
    pub fn mutecnt(&mut self) -> MUTECNT_W<SAI_BCR2rs> {
        MUTECNT_W::new(self, 7)
    }
    ///Bit 13 - CPL
    #[inline(always)]
    #[must_use]
    pub fn cpl(&mut self) -> CPL_W<SAI_BCR2rs> {
        CPL_W::new(self, 13)
    }
    ///Bits 14:15 - COMP
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> COMP_W<SAI_BCR2rs> {
        COMP_W::new(self, 14)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#SAI1:SAI_BCR2)*/
pub struct SAI_BCR2rs;
impl crate::RegisterSpec for SAI_BCR2rs {
    type Ux = u32;
}
///`read()` method returns [`sai_bcr2::R`](R) reader structure
impl crate::Readable for SAI_BCR2rs {}
///`write(|w| ..)` method takes [`sai_bcr2::W`](W) writer structure
impl crate::Writable for SAI_BCR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAI_BCR2 to value 0
impl crate::Resettable for SAI_BCR2rs {
