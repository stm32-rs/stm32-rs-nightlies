...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#SAI1:SAI_BSR)*/
pub struct SAI_BSRrs;
impl crate::RegisterSpec for SAI_BSRrs {
    type Ux = u32;
}
///`read()` method returns [`sai_bsr::R`](R) reader structure
impl crate::Readable for SAI_BSRrs {}
///`reset()` method sets SAI_BSR to value 0x08
impl crate::Resettable for SAI_BSRrs {
