...
pub type R = crate::R<SDMMC_FIFOR0rs>;
///Register `SDMMC_FIFOR0` writer
pub type W = crate::W<SDMMC_FIFOR0rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fifodata(&mut self) -> FIFODATA_W<SDMMC_FIFOR0rs> {
...
You can [`read`](crate::Reg::read) this register and get [`sdmmc_fifor0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sdmmc_fifor0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#SDMMC1:SDMMC_FIFOR0)*/
pub struct SDMMC_FIFOR0rs;
impl crate::RegisterSpec for SDMMC_FIFOR0rs {
    type Ux = u32;
}
///`read()` method returns [`sdmmc_fifor0::R`](R) reader structure
impl crate::Readable for SDMMC_FIFOR0rs {}
///`write(|w| ..)` method takes [`sdmmc_fifor0::W`](W) writer structure
impl crate::Writable for SDMMC_FIFOR0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDMMC_FIFOR0 to value 0
impl crate::Resettable for SDMMC_FIFOR0rs {
