///Register `SDMMC_FIFOR10` reader
pub type R = crate::R<SDMMC_FIFOR10rs>;
///Register `SDMMC_FIFOR10` writer
...
You can [`read`](crate::Reg::read) this register and get [`sdmmc_fifor10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sdmmc_fifor10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`sdmmc_fifor10::R`](R) reader structure
impl crate::Readable for SDMMC_FIFOR10rs {}
///`write(|w| ..)` method takes [`sdmmc_fifor10::W`](W) writer structure
impl crate::Writable for SDMMC_FIFOR10rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDMMC_FIFOR10 to value 0
