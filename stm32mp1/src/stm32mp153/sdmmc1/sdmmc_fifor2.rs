///Register `SDMMC_FIFOR2` reader
pub type R = crate::R<SDMMC_FIFOR2rs>;
///Register `SDMMC_FIFOR2` writer
pub type W = crate::W<SDMMC_FIFOR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fifodata(&mut self) -> FIFODATA_W<SDMMC_FIFOR2rs> {
...
You can [`read`](crate::Reg::read) this register and get [`sdmmc_fifor2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sdmmc_fifor2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#SDMMC1:SDMMC_FIFOR2)*/
pub struct SDMMC_FIFOR2rs;
impl crate::RegisterSpec for SDMMC_FIFOR2rs {
    type Ux = u32;
}
///`read()` method returns [`sdmmc_fifor2::R`](R) reader structure
impl crate::Readable for SDMMC_FIFOR2rs {}
///`write(|w| ..)` method takes [`sdmmc_fifor2::W`](W) writer structure
impl crate::Writable for SDMMC_FIFOR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDMMC_FIFOR2 to value 0
impl crate::Resettable for SDMMC_FIFOR2rs {
