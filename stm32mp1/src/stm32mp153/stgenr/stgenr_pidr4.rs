...
You can [`read`](crate::Reg::read) this register and get [`stgenr_pidr4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#STGENR:STGENR_PIDR4)*/
