...
impl W {
    ///Bit 0 - HSLVEN_TRACE
    #[inline(always)]
    pub fn hslven_trace(&mut self) -> HSLVEN_TRACE_W<'_, IOCTRLSETRrs> {
        HSLVEN_TRACE_W::new(self, 0)
    }
    ///Bit 1 - HSLVEN_QUADSPI
    #[inline(always)]
    pub fn hslven_quadspi(&mut self) -> HSLVEN_QUADSPI_W<'_, IOCTRLSETRrs> {
        HSLVEN_QUADSPI_W::new(self, 1)
    }
    ///Bit 2 - HSLVEN_ETH
    #[inline(always)]
    pub fn hslven_eth(&mut self) -> HSLVEN_ETH_W<'_, IOCTRLSETRrs> {
        HSLVEN_ETH_W::new(self, 2)
    }
    ///Bit 3 - HSLVEN_SDMMC
    #[inline(always)]
    pub fn hslven_sdmmc(&mut self) -> HSLVEN_SDMMC_W<'_, IOCTRLSETRrs> {
        HSLVEN_SDMMC_W::new(self, 3)
    }
    ///Bit 4 - HSLVEN_SPI
    #[inline(always)]
    pub fn hslven_spi(&mut self) -> HSLVEN_SPI_W<'_, IOCTRLSETRrs> {
