...
pub type R = crate::R<SYSCFG_CMPENSETRrs>;
///Register `SYSCFG_CMPENSETR` writer
pub type W = crate::W<SYSCFG_CMPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYSCFG_CMPENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mpu_en(&mut self) -> MPU_EN_W<SYSCFG_CMPENSETRrs> {
        MPU_EN_W::new(self, 0)
    }
    ///Bit 1 - MCU_EN
    #[inline(always)]
    #[must_use]
    pub fn mcu_en(&mut self) -> MCU_EN_W<SYSCFG_CMPENSETRrs> {
        MCU_EN_W::new(self, 1)
    }
}
/**SYSCFG compensation cell enable set register

You can [`read`](crate::Reg::read) this register and get [`syscfg_cmpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`syscfg_cmpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#SYSCFG:SYSCFG_CMPENSETR)*/
pub struct SYSCFG_CMPENSETRrs;
impl crate::RegisterSpec for SYSCFG_CMPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`syscfg_cmpensetr::R`](R) reader structure
impl crate::Readable for SYSCFG_CMPENSETRrs {}
///`write(|w| ..)` method takes [`syscfg_cmpensetr::W`](W) writer structure
impl crate::Writable for SYSCFG_CMPENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SYSCFG_CMPENSETR to value 0
impl crate::Resettable for SYSCFG_CMPENSETRrs {
