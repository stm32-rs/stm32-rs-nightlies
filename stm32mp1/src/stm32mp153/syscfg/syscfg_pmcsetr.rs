...
pub type R = crate::R<SYSCFG_PMCSETRrs>;
///Register `SYSCFG_PMCSETR` writer
pub type W = crate::W<SYSCFG_PMCSETRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c1_fmp(&mut self) -> I2C1_FMP_W<SYSCFG_PMCSETRrs> {
        I2C1_FMP_W::new(self, 0)
    }
    ///Bit 1 - I2C2_FMP
    #[inline(always)]
    #[must_use]
    pub fn i2c2_fmp(&mut self) -> I2C2_FMP_W<SYSCFG_PMCSETRrs> {
        I2C2_FMP_W::new(self, 1)
    }
    ///Bit 2 - I2C3_FMP
    #[inline(always)]
    #[must_use]
    pub fn i2c3_fmp(&mut self) -> I2C3_FMP_W<SYSCFG_PMCSETRrs> {
        I2C3_FMP_W::new(self, 2)
    }
    ///Bit 3 - I2C4_FMP
    #[inline(always)]
    #[must_use]
    pub fn i2c4_fmp(&mut self) -> I2C4_FMP_W<SYSCFG_PMCSETRrs> {
        I2C4_FMP_W::new(self, 3)
    }
    ///Bit 4 - I2C5_FMP
    #[inline(always)]
    #[must_use]
    pub fn i2c5_fmp(&mut self) -> I2C5_FMP_W<SYSCFG_PMCSETRrs> {
        I2C5_FMP_W::new(self, 4)
    }
    ///Bit 5 - I2C6_FMP
    #[inline(always)]
    #[must_use]
    pub fn i2c6_fmp(&mut self) -> I2C6_FMP_W<SYSCFG_PMCSETRrs> {
        I2C6_FMP_W::new(self, 5)
    }
    ///Bit 8 - EN_BOOSTER
    #[inline(always)]
    #[must_use]
    pub fn en_booster(&mut self) -> EN_BOOSTER_W<SYSCFG_PMCSETRrs> {
        EN_BOOSTER_W::new(self, 8)
    }
    ///Bit 9 - ANASWVDD
    #[inline(always)]
    #[must_use]
    pub fn anaswvdd(&mut self) -> ANASWVDD_W<SYSCFG_PMCSETRrs> {
        ANASWVDD_W::new(self, 9)
    }
    ///Bit 16 - ETH_CLK_SEL
    #[inline(always)]
    #[must_use]
    pub fn eth_clk_sel(&mut self) -> ETH_CLK_SEL_W<SYSCFG_PMCSETRrs> {
        ETH_CLK_SEL_W::new(self, 16)
    }
    ///Bit 17 - ETH_REF_CLK_SEL
    #[inline(always)]
    #[must_use]
    pub fn eth_ref_clk_sel(&mut self) -> ETH_REF_CLK_SEL_W<SYSCFG_PMCSETRrs> {
        ETH_REF_CLK_SEL_W::new(self, 17)
    }
    ///Bit 20 - ETH_SELMII
    #[inline(always)]
    #[must_use]
    pub fn eth_selmii(&mut self) -> ETH_SELMII_W<SYSCFG_PMCSETRrs> {
        ETH_SELMII_W::new(self, 20)
    }
    ///Bits 21:23 - ETH_SEL
    #[inline(always)]
    #[must_use]
    pub fn eth_sel(&mut self) -> ETH_SEL_W<SYSCFG_PMCSETRrs> {
        ETH_SEL_W::new(self, 21)
    }
    ///Bit 24 - ANA0_SEL
    #[inline(always)]
    #[must_use]
    pub fn ana0_sel(&mut self) -> ANA0_SEL_W<SYSCFG_PMCSETRrs> {
        ANA0_SEL_W::new(self, 24)
    }
    ///Bit 25 - ANA1_SEL
    #[inline(always)]
    #[must_use]
    pub fn ana1_sel(&mut self) -> ANA1_SEL_W<SYSCFG_PMCSETRrs> {
        ANA1_SEL_W::new(self, 25)
    }
}
/**SYSCFG peripheral mode configuration set register

You can [`read`](crate::Reg::read) this register and get [`syscfg_pmcsetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`syscfg_pmcsetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#SYSCFG:SYSCFG_PMCSETR)*/
pub struct SYSCFG_PMCSETRrs;
impl crate::RegisterSpec for SYSCFG_PMCSETRrs {
    type Ux = u32;
}
///`read()` method returns [`syscfg_pmcsetr::R`](R) reader structure
impl crate::Readable for SYSCFG_PMCSETRrs {}
///`write(|w| ..)` method takes [`syscfg_pmcsetr::W`](W) writer structure
impl crate::Writable for SYSCFG_PMCSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SYSCFG_PMCSETR to value 0
impl crate::Resettable for SYSCFG_PMCSETRrs {
