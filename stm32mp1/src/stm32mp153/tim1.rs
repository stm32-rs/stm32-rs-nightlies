...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_EGR)
...
pub mod tim1_egr;
/**TIM1_CCMR1ALTERNATE1 (rw) register accessor: The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`tim1_ccmr1alternate1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim1_ccmr1alternate1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCMR1ALTERNATE1)
...
/**TIM1_CCMR2ALTERNATE17 (rw) register accessor: The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`tim1_ccmr2alternate17::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim1_ccmr2alternate17::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCMR2ALTERNATE17)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CNT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCR4)
...
pub mod tim1_ccr4;
/**TIM1_BDTR (rw) register accessor: As the bits BK2BID, BKBID, BK2DSRM, BKDSRM, BK2P, BK2E, BK2F\[3:0\], BKF\[3:0\], AOE, BKP, BKE, OSSI, OSSR and DTG\[7:0\]
can be write-locked depending on the LOCK configuration, it can be necessary to configure all of them during the first write access to the TIMx_BDTR register.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_BDTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_DMAR)
...
pub mod tim1_dmar;
/**TIM1_CCMR3 (rw) register accessor: The channels 5 and 6 can only be configured in output. Output compare mode:
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCMR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCR5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_CCR6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_AF1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_AF2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM1:TIM1_TISEL)
