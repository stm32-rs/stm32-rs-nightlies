...
For information about available fields see [`mod@_smcr`]
module*/
...
For information about available fields see [`mod@_ccmr1_input`]
module*/
...
For information about available fields see [`mod@_ccmr1_output`]
module*/
