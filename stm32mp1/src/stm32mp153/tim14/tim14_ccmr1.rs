...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1s(&mut self) -> CC1S_W<TIM14_CCMR1rs> {
        CC1S_W::new(self, 0)
    }
    #[doc = "Bit 2 - OC1FE"]
    #[inline(always)]
    #[must_use]
    pub fn oc1fe(&mut self) -> OC1FE_W<TIM14_CCMR1rs> {
        OC1FE_W::new(self, 2)
    }
    #[doc = "Bit 3 - OC1PE"]
    #[inline(always)]
    #[must_use]
    pub fn oc1pe(&mut self) -> OC1PE_W<TIM14_CCMR1rs> {
        OC1PE_W::new(self, 3)
    }
    #[doc = "Bits 4:6 - OC1M"]
    #[inline(always)]
    #[must_use]
    pub fn oc1m(&mut self) -> OC1M_W<TIM14_CCMR1rs> {
        OC1M_W::new(self, 4)
    }
    #[doc = "Bit 16 - OC1M3"]
    #[inline(always)]
    #[must_use]
    pub fn oc1m3(&mut self) -> OC1M3_W<TIM14_CCMR1rs> {
        OC1M3_W::new(self, 16)
    }
}
#[doc = "The channels can be used in input (capture mode) or in output (compare mode). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function in input and in output mode. For a given bit, OCxx describes its function when the channel is configured in output, ICxx describes its function when the channel is configured in input. So one must take care that the same bit can have a different meaning for the input stage and for the output stage. Output compare mode\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tim14_ccmr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tim14_ccmr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
