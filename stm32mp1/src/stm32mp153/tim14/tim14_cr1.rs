///Register `TIM14_CR1` reader
pub type R = crate::R<TIM14_CR1rs>;
///Register `TIM14_CR1` writer
pub type W = crate::W<TIM14_CR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cen(&mut self) -> CEN_W<TIM14_CR1rs> {
        CEN_W::new(self, 0)
    }
    ///Bit 1 - UDIS
    #[inline(always)]
    #[must_use]
    pub fn udis(&mut self) -> UDIS_W<TIM14_CR1rs> {
        UDIS_W::new(self, 1)
    }
    ///Bit 2 - URS
    #[inline(always)]
    #[must_use]
    pub fn urs(&mut self) -> URS_W<TIM14_CR1rs> {
        URS_W::new(self, 2)
    }
    ///Bit 3 - OPM
    #[inline(always)]
    #[must_use]
    pub fn opm(&mut self) -> OPM_W<TIM14_CR1rs> {
        OPM_W::new(self, 3)
    }
    ///Bit 7 - ARPE
    #[inline(always)]
    #[must_use]
    pub fn arpe(&mut self) -> ARPE_W<TIM14_CR1rs> {
        ARPE_W::new(self, 7)
    }
    ///Bits 8:9 - CKD
    #[inline(always)]
    #[must_use]
    pub fn ckd(&mut self) -> CKD_W<TIM14_CR1rs> {
        CKD_W::new(self, 8)
    }
    ///Bit 11 - UIFREMAP
    #[inline(always)]
    #[must_use]
    pub fn uifremap(&mut self) -> UIFREMAP_W<TIM14_CR1rs> {
        UIFREMAP_W::new(self, 11)
    }
}
/**TIM14 control register 1

You can [`read`](crate::Reg::read) this register and get [`tim14_cr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim14_cr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM14:TIM14_CR1)*/
pub struct TIM14_CR1rs;
impl crate::RegisterSpec for TIM14_CR1rs {
    type Ux = u16;
}
///`read()` method returns [`tim14_cr1::R`](R) reader structure
impl crate::Readable for TIM14_CR1rs {}
///`write(|w| ..)` method takes [`tim14_cr1::W`](W) writer structure
impl crate::Writable for TIM14_CR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
///`reset()` method sets TIM14_CR1 to value 0
impl crate::Resettable for TIM14_CR1rs {
