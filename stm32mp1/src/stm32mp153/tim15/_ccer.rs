...
impl W {
    ...
    ///Bit 2 - CC1NE
    #[inline(always)]
    pub fn cc1ne(&mut self) -> CC1NE_W<'_, _CCERrs> {
        CC1NE_W::new(self, 2)
    }
    ///Bit 3 - CC1NP
    #[inline(always)]
    ...
    ///Bit 4 - CC2E
    #[inline(always)]
    pub fn cc2e(&mut self) -> CC2E_W<'_, _CCERrs> {
        CC2E_W::new(self, 4)
    }
    ///Bit 5 - CC2P
    #[inline(always)]
    pub fn cc2p(&mut self) -> CC2P_W<'_, _CCERrs> {
        CC2P_W::new(self, 5)
    }
    ///Bit 7 - CC2NP
    #[inline(always)]
    pub fn cc2np(&mut self) -> CC2NP_W<'_, _CCERrs> {
        CC2NP_W::new(self, 7)
    }
}
