///Register `_CR1` reader
pub type R = crate::R<_CR1rs>;
///Register `_CR1` writer
...
impl W {
    ///Bit 0 - CEN
    #[inline(always)]
    pub fn cen(&mut self) -> CEN_W<'_, _CR1rs> {
        CEN_W::new(self, 0)
    }
    ///Bit 1 - UDIS
    #[inline(always)]
    pub fn udis(&mut self) -> UDIS_W<'_, _CR1rs> {
        UDIS_W::new(self, 1)
    }
    ///Bit 2 - URS
    #[inline(always)]
    pub fn urs(&mut self) -> URS_W<'_, _CR1rs> {
        URS_W::new(self, 2)
    }
    ///Bit 3 - OPM
    #[inline(always)]
    pub fn opm(&mut self) -> OPM_W<'_, _CR1rs> {
        OPM_W::new(self, 3)
    }
    ///Bit 7 - ARPE
    #[inline(always)]
    pub fn arpe(&mut self) -> ARPE_W<'_, _CR1rs> {
        ARPE_W::new(self, 7)
    }
    ///Bits 8:9 - CKD
    #[inline(always)]
    pub fn ckd(&mut self) -> CKD_W<'_, _CR1rs> {
        CKD_W::new(self, 8)
    }
    ///Bit 11 - UIFREMAP
    #[inline(always)]
    pub fn uifremap(&mut self) -> UIFREMAP_W<'_, _CR1rs> {
        UIFREMAP_W::new(self, 11)
    }
}
/**TIM15 control register 1

You can [`read`](crate::Reg::read) this register and get [`_cr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_cr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`_cr1::R`](R) reader structure
impl crate::Readable for _CR1rs {}
///`write(|w| ..)` method takes [`_cr1::W`](W) writer structure
