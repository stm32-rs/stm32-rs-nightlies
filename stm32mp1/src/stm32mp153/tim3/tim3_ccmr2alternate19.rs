...
pub type R = crate::R<TIM3_CCMR2ALTERNATE19rs>;
///Register `TIM3_CCMR2ALTERNATE19` writer
pub type W = crate::W<TIM3_CCMR2ALTERNATE19rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM3_CCMR2ALTERNATE19")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3s(&mut self) -> CC3S_W<TIM3_CCMR2ALTERNATE19rs> {
        CC3S_W::new(self, 0)
    }
    ///Bits 2:3 - IC3PSC
    #[inline(always)]
    #[must_use]
    pub fn ic3psc(&mut self) -> IC3PSC_W<TIM3_CCMR2ALTERNATE19rs> {
        IC3PSC_W::new(self, 2)
    }
    ///Bits 4:7 - IC3F
    #[inline(always)]
    #[must_use]
    pub fn ic3f(&mut self) -> IC3F_W<TIM3_CCMR2ALTERNATE19rs> {
        IC3F_W::new(self, 4)
    }
    ///Bits 8:9 - CC4S
    #[inline(always)]
    #[must_use]
    pub fn cc4s(&mut self) -> CC4S_W<TIM3_CCMR2ALTERNATE19rs> {
        CC4S_W::new(self, 8)
    }
    ///Bits 10:11 - IC4PSC
    #[inline(always)]
    #[must_use]
    pub fn ic4psc(&mut self) -> IC4PSC_W<TIM3_CCMR2ALTERNATE19rs> {
        IC4PSC_W::new(self, 10)
    }
    ///Bits 12:15 - IC4F
    #[inline(always)]
    #[must_use]
    pub fn ic4f(&mut self) -> IC4F_W<TIM3_CCMR2ALTERNATE19rs> {
        IC4F_W::new(self, 12)
    }
}
/**The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`tim3_ccmr2alternate19::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim3_ccmr2alternate19::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM3:TIM3_CCMR2ALTERNATE19)*/
pub struct TIM3_CCMR2ALTERNATE19rs;
impl crate::RegisterSpec for TIM3_CCMR2ALTERNATE19rs {
    type Ux = u32;
}
///`read()` method returns [`tim3_ccmr2alternate19::R`](R) reader structure
impl crate::Readable for TIM3_CCMR2ALTERNATE19rs {}
///`write(|w| ..)` method takes [`tim3_ccmr2alternate19::W`](W) writer structure
impl crate::Writable for TIM3_CCMR2ALTERNATE19rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM3_CCMR2ALTERNATE19 to value 0
impl crate::Resettable for TIM3_CCMR2ALTERNATE19rs {
