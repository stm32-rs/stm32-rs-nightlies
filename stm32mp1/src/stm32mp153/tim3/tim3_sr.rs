...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uif(&mut self) -> UIF_W<TIM3_SRrs> {
        UIF_W::new(self, 0)
    }
    #[doc = "Bit 1 - CC1IF"]
    #[inline(always)]
    #[must_use]
    pub fn cc1if(&mut self) -> CC1IF_W<TIM3_SRrs> {
        CC1IF_W::new(self, 1)
    }
    #[doc = "Bit 2 - CC2IF"]
    #[inline(always)]
    #[must_use]
    pub fn cc2if(&mut self) -> CC2IF_W<TIM3_SRrs> {
        CC2IF_W::new(self, 2)
    }
    #[doc = "Bit 3 - CC3IF"]
    #[inline(always)]
    #[must_use]
    pub fn cc3if(&mut self) -> CC3IF_W<TIM3_SRrs> {
        CC3IF_W::new(self, 3)
    }
    #[doc = "Bit 4 - CC4IF"]
    #[inline(always)]
    #[must_use]
    pub fn cc4if(&mut self) -> CC4IF_W<TIM3_SRrs> {
        CC4IF_W::new(self, 4)
    }
    #[doc = "Bit 5 - COMIF"]
    #[inline(always)]
    #[must_use]
    pub fn comif(&mut self) -> COMIF_W<TIM3_SRrs> {
        COMIF_W::new(self, 5)
    }
    #[doc = "Bit 6 - TIF"]
    #[inline(always)]
    #[must_use]
    pub fn tif(&mut self) -> TIF_W<TIM3_SRrs> {
        TIF_W::new(self, 6)
    }
    #[doc = "Bit 7 - BIF"]
    #[inline(always)]
    #[must_use]
    pub fn bif(&mut self) -> BIF_W<TIM3_SRrs> {
        BIF_W::new(self, 7)
    }
    #[doc = "Bit 8 - B2IF"]
    #[inline(always)]
    #[must_use]
    pub fn b2if(&mut self) -> B2IF_W<TIM3_SRrs> {
        B2IF_W::new(self, 8)
    }
    #[doc = "Bit 9 - CC1OF"]
    #[inline(always)]
    #[must_use]
    pub fn cc1of(&mut self) -> CC1OF_W<TIM3_SRrs> {
        CC1OF_W::new(self, 9)
    }
    #[doc = "Bit 10 - CC2OF"]
    #[inline(always)]
    #[must_use]
    pub fn cc2of(&mut self) -> CC2OF_W<TIM3_SRrs> {
        CC2OF_W::new(self, 10)
    }
    #[doc = "Bit 11 - CC3OF"]
    #[inline(always)]
    #[must_use]
    pub fn cc3of(&mut self) -> CC3OF_W<TIM3_SRrs> {
        CC3OF_W::new(self, 11)
    }
    #[doc = "Bit 12 - CC4OF"]
    #[inline(always)]
    #[must_use]
    pub fn cc4of(&mut self) -> CC4OF_W<TIM3_SRrs> {
        CC4OF_W::new(self, 12)
    }
    #[doc = "Bit 13 - SBIF"]
    #[inline(always)]
    #[must_use]
    pub fn sbif(&mut self) -> SBIF_W<TIM3_SRrs> {
        SBIF_W::new(self, 13)
    }
    #[doc = "Bit 16 - CC5IF"]
    #[inline(always)]
    #[must_use]
    pub fn cc5if(&mut self) -> CC5IF_W<TIM3_SRrs> {
        CC5IF_W::new(self, 16)
    }
    #[doc = "Bit 17 - CC6IF"]
    #[inline(always)]
    #[must_use]
    pub fn cc6if(&mut self) -> CC6IF_W<TIM3_SRrs> {
        CC6IF_W::new(self, 17)
    }
}
#[doc = "TIM3 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tim3_sr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tim3_sr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
