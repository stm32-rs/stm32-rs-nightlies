...
pub struct RegisterBlock {
    ...
    egr: EGR,
    _reserved6: [u8; 0x02],
    ccmr1alternate4: CCMR1ALTERNATE4,
    ccmr2alternate20: CCMR2ALTERNATE20,
    ccer: CCER,
    cnt: CNT,
    psc: PSC,
    _reserved11: [u8; 0x02],
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn ccmr1alternate4(&self) -> &CCMR1ALTERNATE4 {
        &self.ccmr1alternate4
    }
    ...
    #[inline(always)]
    pub const fn ccmr2alternate20(&self) -> &CCMR2ALTERNATE20 {
        &self.ccmr2alternate20
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:EGR)
...
You can [`read`](crate::Reg::read) this register and get [`ccmr1alternate4::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr1alternate4::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:CCMR1ALTERNATE4)

For information about available fields see [`mod@ccmr1alternate4`] module*/
pub type CCMR1ALTERNATE4 = crate::Reg<ccmr1alternate4::CCMR1ALTERNATE4rs>;
///The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:
pub mod ccmr1alternate4;
...
You can [`read`](crate::Reg::read) this register and get [`ccmr2alternate20::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr2alternate20::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:CCMR2ALTERNATE20)

For information about available fields see [`mod@ccmr2alternate20`] module*/
pub type CCMR2ALTERNATE20 = crate::Reg<ccmr2alternate20::CCMR2ALTERNATE20rs>;
///The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:
pub mod ccmr2alternate20;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:CCR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:CCR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:CCR5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:CCR6)
