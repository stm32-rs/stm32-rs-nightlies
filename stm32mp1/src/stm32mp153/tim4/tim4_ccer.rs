...
pub type R = crate::R<TIM4_CCERrs>;
///Register `TIM4_CCER` writer
pub type W = crate::W<TIM4_CCERrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1e(&mut self) -> CC1E_W<TIM4_CCERrs> {
        CC1E_W::new(self, 0)
    }
    ///Bit 1 - CC1P
    #[inline(always)]
    #[must_use]
    pub fn cc1p(&mut self) -> CC1P_W<TIM4_CCERrs> {
        CC1P_W::new(self, 1)
    }
    ///Bit 2 - CC1NE
    #[inline(always)]
    #[must_use]
    pub fn cc1ne(&mut self) -> CC1NE_W<TIM4_CCERrs> {
        CC1NE_W::new(self, 2)
    }
    ///Bit 3 - CC1NP
    #[inline(always)]
    #[must_use]
    pub fn cc1np(&mut self) -> CC1NP_W<TIM4_CCERrs> {
        CC1NP_W::new(self, 3)
    }
    ///Bit 4 - CC2E
    #[inline(always)]
    #[must_use]
    pub fn cc2e(&mut self) -> CC2E_W<TIM4_CCERrs> {
        CC2E_W::new(self, 4)
    }
    ///Bit 5 - CC2P
    #[inline(always)]
    #[must_use]
    pub fn cc2p(&mut self) -> CC2P_W<TIM4_CCERrs> {
        CC2P_W::new(self, 5)
    }
    ///Bit 6 - CC2NE
    #[inline(always)]
    #[must_use]
    pub fn cc2ne(&mut self) -> CC2NE_W<TIM4_CCERrs> {
        CC2NE_W::new(self, 6)
    }
    ///Bit 7 - CC2NP
    #[inline(always)]
    #[must_use]
    pub fn cc2np(&mut self) -> CC2NP_W<TIM4_CCERrs> {
        CC2NP_W::new(self, 7)
    }
    ///Bit 8 - CC3E
    #[inline(always)]
    #[must_use]
    pub fn cc3e(&mut self) -> CC3E_W<TIM4_CCERrs> {
        CC3E_W::new(self, 8)
    }
    ///Bit 9 - CC3P
    #[inline(always)]
    #[must_use]
    pub fn cc3p(&mut self) -> CC3P_W<TIM4_CCERrs> {
        CC3P_W::new(self, 9)
    }
    ///Bit 10 - CC3NE
    #[inline(always)]
    #[must_use]
    pub fn cc3ne(&mut self) -> CC3NE_W<TIM4_CCERrs> {
        CC3NE_W::new(self, 10)
    }
    ///Bit 11 - CC3NP
    #[inline(always)]
    #[must_use]
    pub fn cc3np(&mut self) -> CC3NP_W<TIM4_CCERrs> {
        CC3NP_W::new(self, 11)
    }
    ///Bit 12 - CC4E
    #[inline(always)]
    #[must_use]
    pub fn cc4e(&mut self) -> CC4E_W<TIM4_CCERrs> {
        CC4E_W::new(self, 12)
    }
    ///Bit 13 - CC4P
    #[inline(always)]
    #[must_use]
    pub fn cc4p(&mut self) -> CC4P_W<TIM4_CCERrs> {
        CC4P_W::new(self, 13)
    }
    ///Bit 15 - CC4NP
    #[inline(always)]
    #[must_use]
    pub fn cc4np(&mut self) -> CC4NP_W<TIM4_CCERrs> {
        CC4NP_W::new(self, 15)
    }
    ///Bit 16 - CC5E
    #[inline(always)]
    #[must_use]
    pub fn cc5e(&mut self) -> CC5E_W<TIM4_CCERrs> {
        CC5E_W::new(self, 16)
    }
    ///Bit 17 - CC5P
    #[inline(always)]
    #[must_use]
    pub fn cc5p(&mut self) -> CC5P_W<TIM4_CCERrs> {
        CC5P_W::new(self, 17)
    }
    ///Bit 20 - CC6E
    #[inline(always)]
    #[must_use]
    pub fn cc6e(&mut self) -> CC6E_W<TIM4_CCERrs> {
        CC6E_W::new(self, 20)
    }
    ///Bit 21 - CC6P
    #[inline(always)]
    #[must_use]
    pub fn cc6p(&mut self) -> CC6P_W<TIM4_CCERrs> {
        CC6P_W::new(self, 21)
    }
}
/**TIM4 capture/compare enable register

You can [`read`](crate::Reg::read) this register and get [`tim4_ccer::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim4_ccer::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:TIM4_CCER)*/
pub struct TIM4_CCERrs;
impl crate::RegisterSpec for TIM4_CCERrs {
    type Ux = u32;
}
///`read()` method returns [`tim4_ccer::R`](R) reader structure
impl crate::Readable for TIM4_CCERrs {}
///`write(|w| ..)` method takes [`tim4_ccer::W`](W) writer structure
impl crate::Writable for TIM4_CCERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM4_CCER to value 0
impl crate::Resettable for TIM4_CCERrs {
