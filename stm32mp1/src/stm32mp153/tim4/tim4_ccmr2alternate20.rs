///Register `TIM4_CCMR2ALTERNATE20` reader
pub type R = crate::R<TIM4_CCMR2ALTERNATE20rs>;
///Register `TIM4_CCMR2ALTERNATE20` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM4_CCMR2ALTERNATE20")
...
You can [`read`](crate::Reg::read) this register and get [`tim4_ccmr2alternate20::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim4_ccmr2alternate20::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:TIM4_CCMR2ALTERNATE20)*/
pub struct TIM4_CCMR2ALTERNATE20rs;
impl crate::RegisterSpec for TIM4_CCMR2ALTERNATE20rs {
    type Ux = u32;
}
///`read()` method returns [`tim4_ccmr2alternate20::R`](R) reader structure
impl crate::Readable for TIM4_CCMR2ALTERNATE20rs {}
///`write(|w| ..)` method takes [`tim4_ccmr2alternate20::W`](W) writer structure
impl crate::Writable for TIM4_CCMR2ALTERNATE20rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM4_CCMR2ALTERNATE20 to value 0
