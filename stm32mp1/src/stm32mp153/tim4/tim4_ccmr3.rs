...
pub type R = crate::R<TIM4_CCMR3rs>;
///Register `TIM4_CCMR3` writer
pub type W = crate::W<TIM4_CCMR3rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn oc5fe(&mut self) -> OC5FE_W<TIM4_CCMR3rs> {
        OC5FE_W::new(self, 2)
    }
    ///Bit 3 - OC5PE
    #[inline(always)]
    #[must_use]
    pub fn oc5pe(&mut self) -> OC5PE_W<TIM4_CCMR3rs> {
        OC5PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC5M
    #[inline(always)]
    #[must_use]
    pub fn oc5m(&mut self) -> OC5M_W<TIM4_CCMR3rs> {
        OC5M_W::new(self, 4)
    }
    ///Bit 7 - OC5CE
    #[inline(always)]
    #[must_use]
    pub fn oc5ce(&mut self) -> OC5CE_W<TIM4_CCMR3rs> {
        OC5CE_W::new(self, 7)
    }
    ///Bit 10 - OC6FE
    #[inline(always)]
    #[must_use]
    pub fn oc6fe(&mut self) -> OC6FE_W<TIM4_CCMR3rs> {
        OC6FE_W::new(self, 10)
    }
    ///Bit 11 - OC6PE
    #[inline(always)]
    #[must_use]
    pub fn oc6pe(&mut self) -> OC6PE_W<TIM4_CCMR3rs> {
        OC6PE_W::new(self, 11)
    }
    ///Bits 12:14 - OC6M
    #[inline(always)]
    #[must_use]
    pub fn oc6m(&mut self) -> OC6M_W<TIM4_CCMR3rs> {
        OC6M_W::new(self, 12)
    }
    ///Bit 15 - OC6CE
    #[inline(always)]
    #[must_use]
    pub fn oc6ce(&mut self) -> OC6CE_W<TIM4_CCMR3rs> {
        OC6CE_W::new(self, 15)
    }
    ///Bit 16 - OC5M3
    #[inline(always)]
    #[must_use]
    pub fn oc5m3(&mut self) -> OC5M3_W<TIM4_CCMR3rs> {
        OC5M3_W::new(self, 16)
    }
    ///Bit 24 - OC6M3
    #[inline(always)]
    #[must_use]
    pub fn oc6m3(&mut self) -> OC6M3_W<TIM4_CCMR3rs> {
        OC6M3_W::new(self, 24)
    }
}
/**The channels 5 and 6 can only be configured in output. Output compare mode:

You can [`read`](crate::Reg::read) this register and get [`tim4_ccmr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim4_ccmr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM4:TIM4_CCMR3)*/
pub struct TIM4_CCMR3rs;
impl crate::RegisterSpec for TIM4_CCMR3rs {
    type Ux = u32;
}
///`read()` method returns [`tim4_ccmr3::R`](R) reader structure
impl crate::Readable for TIM4_CCMR3rs {}
///`write(|w| ..)` method takes [`tim4_ccmr3::W`](W) writer structure
impl crate::Writable for TIM4_CCMR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM4_CCMR3 to value 0
impl crate::Resettable for TIM4_CCMR3rs {
