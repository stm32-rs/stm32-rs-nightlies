...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1s(&mut self) -> CC1S_W<CCMR1ALTERNATE5rs> {
        CC1S_W::new(self, 0)
    }
    ///Bits 2:3 - IC1PSC
    #[inline(always)]
    #[must_use]
    pub fn ic1psc(&mut self) -> IC1PSC_W<CCMR1ALTERNATE5rs> {
        IC1PSC_W::new(self, 2)
    }
    ///Bits 4:7 - IC1F
    #[inline(always)]
    #[must_use]
    pub fn ic1f(&mut self) -> IC1F_W<CCMR1ALTERNATE5rs> {
        IC1F_W::new(self, 4)
    }
    ///Bits 8:9 - CC2S
    #[inline(always)]
    #[must_use]
    pub fn cc2s(&mut self) -> CC2S_W<CCMR1ALTERNATE5rs> {
        CC2S_W::new(self, 8)
    }
    ///Bits 10:11 - IC2PSC
    #[inline(always)]
    #[must_use]
    pub fn ic2psc(&mut self) -> IC2PSC_W<CCMR1ALTERNATE5rs> {
        IC2PSC_W::new(self, 10)
    }
    ///Bits 12:15 - IC2F
    #[inline(always)]
    #[must_use]
    pub fn ic2f(&mut self) -> IC2F_W<CCMR1ALTERNATE5rs> {
        IC2F_W::new(self, 12)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM5:CCMR1ALTERNATE5)*/
