///Register `TIM5_DIER` reader
pub type R = crate::R<TIM5_DIERrs>;
///Register `TIM5_DIER` writer
...
You can [`read`](crate::Reg::read) this register and get [`tim5_dier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim5_dier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`tim5_dier::R`](R) reader structure
impl crate::Readable for TIM5_DIERrs {}
///`write(|w| ..)` method takes [`tim5_dier::W`](W) writer structure
impl crate::Writable for TIM5_DIERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
///`reset()` method sets TIM5_DIER to value 0
