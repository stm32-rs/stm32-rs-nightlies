...
pub type R = crate::R<TIM5_SRrs>;
///Register `TIM5_SR` writer
pub type W = crate::W<TIM5_SRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uif(&mut self) -> UIF_W<TIM5_SRrs> {
        UIF_W::new(self, 0)
    }
    ///Bit 1 - CC1IF
    #[inline(always)]
    #[must_use]
    pub fn cc1if(&mut self) -> CC1IF_W<TIM5_SRrs> {
        CC1IF_W::new(self, 1)
    }
    ///Bit 2 - CC2IF
    #[inline(always)]
    #[must_use]
    pub fn cc2if(&mut self) -> CC2IF_W<TIM5_SRrs> {
        CC2IF_W::new(self, 2)
    }
    ///Bit 3 - CC3IF
    #[inline(always)]
    #[must_use]
    pub fn cc3if(&mut self) -> CC3IF_W<TIM5_SRrs> {
        CC3IF_W::new(self, 3)
    }
    ///Bit 4 - CC4IF
    #[inline(always)]
    #[must_use]
    pub fn cc4if(&mut self) -> CC4IF_W<TIM5_SRrs> {
        CC4IF_W::new(self, 4)
    }
    ///Bit 5 - COMIF
    #[inline(always)]
    #[must_use]
    pub fn comif(&mut self) -> COMIF_W<TIM5_SRrs> {
        COMIF_W::new(self, 5)
    }
    ///Bit 6 - TIF
    #[inline(always)]
    #[must_use]
    pub fn tif(&mut self) -> TIF_W<TIM5_SRrs> {
        TIF_W::new(self, 6)
    }
    ///Bit 7 - BIF
    #[inline(always)]
    #[must_use]
    pub fn bif(&mut self) -> BIF_W<TIM5_SRrs> {
        BIF_W::new(self, 7)
    }
    ///Bit 8 - B2IF
    #[inline(always)]
    #[must_use]
    pub fn b2if(&mut self) -> B2IF_W<TIM5_SRrs> {
        B2IF_W::new(self, 8)
    }
    ///Bit 9 - CC1OF
    #[inline(always)]
    #[must_use]
    pub fn cc1of(&mut self) -> CC1OF_W<TIM5_SRrs> {
        CC1OF_W::new(self, 9)
    }
    ///Bit 10 - CC2OF
    #[inline(always)]
    #[must_use]
    pub fn cc2of(&mut self) -> CC2OF_W<TIM5_SRrs> {
        CC2OF_W::new(self, 10)
    }
    ///Bit 11 - CC3OF
    #[inline(always)]
    #[must_use]
    pub fn cc3of(&mut self) -> CC3OF_W<TIM5_SRrs> {
        CC3OF_W::new(self, 11)
    }
    ///Bit 12 - CC4OF
    #[inline(always)]
    #[must_use]
    pub fn cc4of(&mut self) -> CC4OF_W<TIM5_SRrs> {
        CC4OF_W::new(self, 12)
    }
    ///Bit 13 - SBIF
    #[inline(always)]
    #[must_use]
    pub fn sbif(&mut self) -> SBIF_W<TIM5_SRrs> {
        SBIF_W::new(self, 13)
    }
    ///Bit 16 - CC5IF
    #[inline(always)]
    #[must_use]
    pub fn cc5if(&mut self) -> CC5IF_W<TIM5_SRrs> {
        CC5IF_W::new(self, 16)
    }
    ///Bit 17 - CC6IF
    #[inline(always)]
    #[must_use]
    pub fn cc6if(&mut self) -> CC6IF_W<TIM5_SRrs> {
        CC6IF_W::new(self, 17)
    }
}
/**TIM5 status register

You can [`read`](crate::Reg::read) this register and get [`tim5_sr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim5_sr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM5:TIM5_SR)*/
pub struct TIM5_SRrs;
impl crate::RegisterSpec for TIM5_SRrs {
    type Ux = u32;
}
///`read()` method returns [`tim5_sr::R`](R) reader structure
impl crate::Readable for TIM5_SRrs {}
///`write(|w| ..)` method takes [`tim5_sr::W`](W) writer structure
impl crate::Writable for TIM5_SRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM5_SR to value 0
impl crate::Resettable for TIM5_SRrs {
