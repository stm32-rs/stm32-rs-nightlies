...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1ie(&mut self) -> CC1IE_W<TIM6_DIERrs> {
        CC1IE_W::new(self, 1)
    }
    ///Bit 2 - CC2IE
    #[inline(always)]
    #[must_use]
    pub fn cc2ie(&mut self) -> CC2IE_W<TIM6_DIERrs> {
        CC2IE_W::new(self, 2)
    }
    ///Bit 3 - CC3IE
    #[inline(always)]
    #[must_use]
    pub fn cc3ie(&mut self) -> CC3IE_W<TIM6_DIERrs> {
        CC3IE_W::new(self, 3)
    }
    ///Bit 4 - CC4IE
    #[inline(always)]
    #[must_use]
    pub fn cc4ie(&mut self) -> CC4IE_W<TIM6_DIERrs> {
        CC4IE_W::new(self, 4)
    }
    ///Bit 5 - COMIE
    #[inline(always)]
    #[must_use]
    pub fn comie(&mut self) -> COMIE_W<TIM6_DIERrs> {
        COMIE_W::new(self, 5)
    }
    ///Bit 6 - TIE
    #[inline(always)]
    #[must_use]
    pub fn tie(&mut self) -> TIE_W<TIM6_DIERrs> {
        TIE_W::new(self, 6)
    }
    ///Bit 7 - BIE
    #[inline(always)]
    #[must_use]
    pub fn bie(&mut self) -> BIE_W<TIM6_DIERrs> {
        BIE_W::new(self, 7)
    }
    ///Bit 8 - UDE
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1de(&mut self) -> CC1DE_W<TIM6_DIERrs> {
        CC1DE_W::new(self, 9)
    }
    ///Bit 10 - CC2DE
    #[inline(always)]
    #[must_use]
    pub fn cc2de(&mut self) -> CC2DE_W<TIM6_DIERrs> {
        CC2DE_W::new(self, 10)
    }
    ///Bit 11 - CC3DE
    #[inline(always)]
    #[must_use]
    pub fn cc3de(&mut self) -> CC3DE_W<TIM6_DIERrs> {
        CC3DE_W::new(self, 11)
    }
    ///Bit 12 - CC4DE
    #[inline(always)]
    #[must_use]
    pub fn cc4de(&mut self) -> CC4DE_W<TIM6_DIERrs> {
        CC4DE_W::new(self, 12)
    }
    ///Bit 13 - COMDE
    #[inline(always)]
    #[must_use]
    pub fn comde(&mut self) -> COMDE_W<TIM6_DIERrs> {
        COMDE_W::new(self, 13)
    }
    ///Bit 14 - TDE
    #[inline(always)]
    #[must_use]
    pub fn tde(&mut self) -> TDE_W<TIM6_DIERrs> {
        TDE_W::new(self, 14)
    }
}
