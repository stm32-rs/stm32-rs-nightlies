///Register `TIM6_SMCR` reader
pub type R = crate::R<TIM6_SMCRrs>;
///Register `TIM6_SMCR` writer
...
You can [`read`](crate::Reg::read) this register and get [`tim6_smcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim6_smcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`tim6_smcr::R`](R) reader structure
impl crate::Readable for TIM6_SMCRrs {}
///`write(|w| ..)` method takes [`tim6_smcr::W`](W) writer structure
impl crate::Writable for TIM6_SMCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM6_SMCR to value 0
