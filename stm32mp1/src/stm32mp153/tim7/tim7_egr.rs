...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1g(&mut self) -> CC1G_W<TIM7_EGRrs> {
        CC1G_W::new(self, 1)
    }
    ///Bit 2 - CC2G
    #[inline(always)]
    #[must_use]
    pub fn cc2g(&mut self) -> CC2G_W<TIM7_EGRrs> {
        CC2G_W::new(self, 2)
    }
    ///Bit 3 - CC3G
    #[inline(always)]
    #[must_use]
    pub fn cc3g(&mut self) -> CC3G_W<TIM7_EGRrs> {
        CC3G_W::new(self, 3)
    }
    ///Bit 4 - CC4G
    #[inline(always)]
    #[must_use]
    pub fn cc4g(&mut self) -> CC4G_W<TIM7_EGRrs> {
        CC4G_W::new(self, 4)
    }
    ///Bit 5 - COMG
    #[inline(always)]
    #[must_use]
    pub fn comg(&mut self) -> COMG_W<TIM7_EGRrs> {
        COMG_W::new(self, 5)
    }
    ///Bit 6 - TG
    #[inline(always)]
    #[must_use]
    pub fn tg(&mut self) -> TG_W<TIM7_EGRrs> {
        TG_W::new(self, 6)
    }
    ///Bit 7 - BG
    #[inline(always)]
    #[must_use]
    pub fn bg(&mut self) -> BG_W<TIM7_EGRrs> {
        BG_W::new(self, 7)
    }
    ///Bit 8 - B2G
    #[inline(always)]
    #[must_use]
    pub fn b2g(&mut self) -> B2G_W<TIM7_EGRrs> {
        B2G_W::new(self, 8)
    }
}
