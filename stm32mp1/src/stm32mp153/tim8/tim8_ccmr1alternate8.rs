///Register `TIM8_CCMR1ALTERNATE8` reader
pub type R = crate::R<TIM8_CCMR1ALTERNATE8rs>;
///Register `TIM8_CCMR1ALTERNATE8` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM8_CCMR1ALTERNATE8")
...
You can [`read`](crate::Reg::read) this register and get [`tim8_ccmr1alternate8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim8_ccmr1alternate8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM8:TIM8_CCMR1ALTERNATE8)*/
pub struct TIM8_CCMR1ALTERNATE8rs;
impl crate::RegisterSpec for TIM8_CCMR1ALTERNATE8rs {
    type Ux = u32;
}
///`read()` method returns [`tim8_ccmr1alternate8::R`](R) reader structure
impl crate::Readable for TIM8_CCMR1ALTERNATE8rs {}
///`write(|w| ..)` method takes [`tim8_ccmr1alternate8::W`](W) writer structure
impl crate::Writable for TIM8_CCMR1ALTERNATE8rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM8_CCMR1ALTERNATE8 to value 0
