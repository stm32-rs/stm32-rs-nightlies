...
pub type R = crate::R<TIM8_DIERrs>;
///Register `TIM8_DIER` writer
pub type W = crate::W<TIM8_DIERrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uie(&mut self) -> UIE_W<TIM8_DIERrs> {
        UIE_W::new(self, 0)
    }
    ///Bit 1 - CC1IE
    #[inline(always)]
    #[must_use]
    pub fn cc1ie(&mut self) -> CC1IE_W<TIM8_DIERrs> {
        CC1IE_W::new(self, 1)
    }
    ///Bit 2 - CC2IE
    #[inline(always)]
    #[must_use]
    pub fn cc2ie(&mut self) -> CC2IE_W<TIM8_DIERrs> {
        CC2IE_W::new(self, 2)
    }
    ///Bit 3 - CC3IE
    #[inline(always)]
    #[must_use]
    pub fn cc3ie(&mut self) -> CC3IE_W<TIM8_DIERrs> {
        CC3IE_W::new(self, 3)
    }
    ///Bit 4 - CC4IE
    #[inline(always)]
    #[must_use]
    pub fn cc4ie(&mut self) -> CC4IE_W<TIM8_DIERrs> {
        CC4IE_W::new(self, 4)
    }
    ///Bit 5 - COMIE
    #[inline(always)]
    #[must_use]
    pub fn comie(&mut self) -> COMIE_W<TIM8_DIERrs> {
        COMIE_W::new(self, 5)
    }
    ///Bit 6 - TIE
    #[inline(always)]
    #[must_use]
    pub fn tie(&mut self) -> TIE_W<TIM8_DIERrs> {
        TIE_W::new(self, 6)
    }
    ///Bit 7 - BIE
    #[inline(always)]
    #[must_use]
    pub fn bie(&mut self) -> BIE_W<TIM8_DIERrs> {
        BIE_W::new(self, 7)
    }
    ///Bit 8 - UDE
    #[inline(always)]
    #[must_use]
    pub fn ude(&mut self) -> UDE_W<TIM8_DIERrs> {
        UDE_W::new(self, 8)
    }
    ///Bit 9 - CC1DE
    #[inline(always)]
    #[must_use]
    pub fn cc1de(&mut self) -> CC1DE_W<TIM8_DIERrs> {
        CC1DE_W::new(self, 9)
    }
    ///Bit 10 - CC2DE
    #[inline(always)]
    #[must_use]
    pub fn cc2de(&mut self) -> CC2DE_W<TIM8_DIERrs> {
        CC2DE_W::new(self, 10)
    }
    ///Bit 11 - CC3DE
    #[inline(always)]
    #[must_use]
    pub fn cc3de(&mut self) -> CC3DE_W<TIM8_DIERrs> {
        CC3DE_W::new(self, 11)
    }
    ///Bit 12 - CC4DE
    #[inline(always)]
    #[must_use]
    pub fn cc4de(&mut self) -> CC4DE_W<TIM8_DIERrs> {
        CC4DE_W::new(self, 12)
    }
    ///Bit 13 - COMDE
    #[inline(always)]
    #[must_use]
    pub fn comde(&mut self) -> COMDE_W<TIM8_DIERrs> {
        COMDE_W::new(self, 13)
    }
    ///Bit 14 - TDE
    #[inline(always)]
    #[must_use]
    pub fn tde(&mut self) -> TDE_W<TIM8_DIERrs> {
        TDE_W::new(self, 14)
    }
}
/**TIM8 DMA/interrupt enable register

You can [`read`](crate::Reg::read) this register and get [`tim8_dier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim8_dier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TIM8:TIM8_DIER)*/
pub struct TIM8_DIERrs;
impl crate::RegisterSpec for TIM8_DIERrs {
    type Ux = u16;
}
///`read()` method returns [`tim8_dier::R`](R) reader structure
impl crate::Readable for TIM8_DIERrs {}
///`write(|w| ..)` method takes [`tim8_dier::W`](W) writer structure
impl crate::Writable for TIM8_DIERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
///`reset()` method sets TIM8_DIER to value 0
impl crate::Resettable for TIM8_DIERrs {
