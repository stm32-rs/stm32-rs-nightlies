...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn base_address_low(&mut self) -> BASE_ADDRESS_LOW_W<REGION_BASE_LOW2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TZC:REGION_BASE_LOW2)*/
