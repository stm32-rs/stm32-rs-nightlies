///Register `TZC_REGION_ATTRIBUTE4` reader
pub type R = crate::R<TZC_REGION_ATTRIBUTE4rs>;
///Register `TZC_REGION_ATTRIBUTE4` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TZC_REGION_ATTRIBUTE4")
...
You can [`read`](crate::Reg::read) this register and get [`tzc_region_attribute4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tzc_region_attribute4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#TZC:TZC_REGION_ATTRIBUTE4)*/
pub struct TZC_REGION_ATTRIBUTE4rs;
impl crate::RegisterSpec for TZC_REGION_ATTRIBUTE4rs {
    type Ux = u32;
}
///`read()` method returns [`tzc_region_attribute4::R`](R) reader structure
impl crate::Readable for TZC_REGION_ATTRIBUTE4rs {}
///`write(|w| ..)` method takes [`tzc_region_attribute4::W`](W) writer structure
impl crate::Writable for TZC_REGION_ATTRIBUTE4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TZC_REGION_ATTRIBUTE4 to value 0
