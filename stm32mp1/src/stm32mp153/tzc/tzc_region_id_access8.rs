...
pub type R = crate::R<TZC_REGION_ID_ACCESS8rs>;
///Register `TZC_REGION_ID_ACCESS8` writer
pub type W = crate::W<TZC_REGION_ID_ACCESS8rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TZC_REGION_ID_ACCESS8")
