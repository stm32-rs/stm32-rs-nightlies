...
impl W {
    ///Bit 0 - SWITHOST
    #[inline(always)]
    pub fn swithost(&mut self) -> SWITHOST_W<MISCrs> {
        SWITHOST_W::new(self, 0)
    }
    ///Bits 1:2 - PPCKDIS
    #[inline(always)]
    pub fn ppckdis(&mut self) -> PPCKDIS_W<MISCrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#USBPHYC:MISC)*/
pub struct MISCrs;
