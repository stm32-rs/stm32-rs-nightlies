...
impl W {
    ///Bit 0 - INCURREN
    #[inline(always)]
    pub fn incurren(&mut self) -> INCURREN_W<TUNE1rs> {
        INCURREN_W::new(self, 0)
    }
    ///Bit 1 - INCURRINT
    #[inline(always)]
    pub fn incurrint(&mut self) -> INCURRINT_W<TUNE1rs> {
        INCURRINT_W::new(self, 1)
    }
    ///Bit 2 - LFSCAPEN
    #[inline(always)]
    pub fn lfscapen(&mut self) -> LFSCAPEN_W<TUNE1rs> {
        LFSCAPEN_W::new(self, 2)
    }
    ///Bit 3 - HSDRVSLEW
    #[inline(always)]
    pub fn hsdrvslew(&mut self) -> HSDRVSLEW_W<TUNE1rs> {
        HSDRVSLEW_W::new(self, 3)
    }
    ///Bit 4 - HSDRVDCCUR
    #[inline(always)]
    pub fn hsdrvdccur(&mut self) -> HSDRVDCCUR_W<TUNE1rs> {
        HSDRVDCCUR_W::new(self, 4)
    }
    ///Bit 5 - HSDRVDCLEV
    #[inline(always)]
    pub fn hsdrvdclev(&mut self) -> HSDRVDCLEV_W<TUNE1rs> {
        HSDRVDCLEV_W::new(self, 5)
    }
    ///Bit 6 - HSDRVCURINCR
    #[inline(always)]
    pub fn hsdrvcurincr(&mut self) -> HSDRVCURINCR_W<TUNE1rs> {
        HSDRVCURINCR_W::new(self, 6)
    }
    ///Bit 7 - FSDRVRFADJ
    #[inline(always)]
    pub fn fsdrvrfadj(&mut self) -> FSDRVRFADJ_W<TUNE1rs> {
        FSDRVRFADJ_W::new(self, 7)
    }
    ///Bit 8 - HSDRVRFRED
    #[inline(always)]
    pub fn hsdrvrfred(&mut self) -> HSDRVRFRED_W<TUNE1rs> {
        HSDRVRFRED_W::new(self, 8)
    }
    ///Bits 9:12 - HSDRVCHKITRM
    #[inline(always)]
    pub fn hsdrvchkitrm(&mut self) -> HSDRVCHKITRM_W<TUNE1rs> {
        HSDRVCHKITRM_W::new(self, 9)
    }
    ///Bits 13:14 - HSDRVCHKZTRM
    #[inline(always)]
    pub fn hsdrvchkztrm(&mut self) -> HSDRVCHKZTRM_W<TUNE1rs> {
        HSDRVCHKZTRM_W::new(self, 13)
    }
    ///Bits 15:19 - OTPCOMP
    #[inline(always)]
    pub fn otpcomp(&mut self) -> OTPCOMP_W<TUNE1rs> {
        OTPCOMP_W::new(self, 15)
    }
    ///Bits 20:21 - SQLCHCTL
    #[inline(always)]
    pub fn sqlchctl(&mut self) -> SQLCHCTL_W<TUNE1rs> {
        SQLCHCTL_W::new(self, 20)
    }
    ///Bit 22 - HDRXGNEQEN
    #[inline(always)]
    pub fn hdrxgneqen(&mut self) -> HDRXGNEQEN_W<TUNE1rs> {
        HDRXGNEQEN_W::new(self, 22)
    }
    ///Bits 23:24 - HSRXOFF
    #[inline(always)]
    pub fn hsrxoff(&mut self) -> HSRXOFF_W<TUNE1rs> {
        HSRXOFF_W::new(self, 23)
    }
    ///Bit 25 - HSFALLPREEM
    #[inline(always)]
    pub fn hsfallpreem(&mut self) -> HSFALLPREEM_W<TUNE1rs> {
        HSFALLPREEM_W::new(self, 25)
    }
    ///Bit 26 - SHTCCTCTLPROT
    #[inline(always)]
    pub fn shtcctctlprot(&mut self) -> SHTCCTCTLPROT_W<TUNE1rs> {
        SHTCCTCTLPROT_W::new(self, 26)
    }
    ///Bit 27 - STAGSEL
    #[inline(always)]
    pub fn stagsel(&mut self) -> STAGSEL_W<TUNE1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#USBPHYC:TUNE1)*/
pub struct TUNE1rs;
