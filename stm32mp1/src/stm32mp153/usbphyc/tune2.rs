///Register `TUNE2` reader
pub type R = crate::R<TUNE2rs>;
///Register `TUNE2` writer
pub type W = crate::W<TUNE2rs>;
...
impl W {
    ///Bit 0 - INCURREN
    #[inline(always)]
    pub fn incurren(&mut self) -> INCURREN_W<'_, TUNE2rs> {
        INCURREN_W::new(self, 0)
    }
    ///Bit 1 - INCURRINT
    #[inline(always)]
    pub fn incurrint(&mut self) -> INCURRINT_W<'_, TUNE2rs> {
        INCURRINT_W::new(self, 1)
    }
    ///Bit 2 - LFSCAPEN
    #[inline(always)]
    pub fn lfscapen(&mut self) -> LFSCAPEN_W<'_, TUNE2rs> {
        LFSCAPEN_W::new(self, 2)
    }
    ///Bit 3 - HSDRVSLEW
    #[inline(always)]
    pub fn hsdrvslew(&mut self) -> HSDRVSLEW_W<'_, TUNE2rs> {
        HSDRVSLEW_W::new(self, 3)
    }
    ///Bit 4 - HSDRVDCCUR
    #[inline(always)]
    pub fn hsdrvdccur(&mut self) -> HSDRVDCCUR_W<'_, TUNE2rs> {
        HSDRVDCCUR_W::new(self, 4)
    }
    ///Bit 5 - HSDRVDCLEV
    #[inline(always)]
    pub fn hsdrvdclev(&mut self) -> HSDRVDCLEV_W<'_, TUNE2rs> {
        HSDRVDCLEV_W::new(self, 5)
    }
    ///Bit 6 - HSDRVCURINCR
    #[inline(always)]
    pub fn hsdrvcurincr(&mut self) -> HSDRVCURINCR_W<'_, TUNE2rs> {
        HSDRVCURINCR_W::new(self, 6)
    }
    ///Bit 7 - FSDRVRFADJ
    #[inline(always)]
    pub fn fsdrvrfadj(&mut self) -> FSDRVRFADJ_W<'_, TUNE2rs> {
        FSDRVRFADJ_W::new(self, 7)
    }
    ///Bit 8 - HSDRVRFRED
    #[inline(always)]
    pub fn hsdrvrfred(&mut self) -> HSDRVRFRED_W<'_, TUNE2rs> {
        HSDRVRFRED_W::new(self, 8)
    }
    ///Bits 9:12 - HSDRVCHKITRM
    #[inline(always)]
    pub fn hsdrvchkitrm(&mut self) -> HSDRVCHKITRM_W<'_, TUNE2rs> {
        HSDRVCHKITRM_W::new(self, 9)
    }
    ///Bits 13:14 - HSDRVCHKZTRM
    #[inline(always)]
    pub fn hsdrvchkztrm(&mut self) -> HSDRVCHKZTRM_W<'_, TUNE2rs> {
        HSDRVCHKZTRM_W::new(self, 13)
    }
    ///Bits 15:19 - OTPCOMP
    #[inline(always)]
    pub fn otpcomp(&mut self) -> OTPCOMP_W<'_, TUNE2rs> {
        OTPCOMP_W::new(self, 15)
    }
    ///Bits 20:21 - SQLCHCTL
    #[inline(always)]
    pub fn sqlchctl(&mut self) -> SQLCHCTL_W<'_, TUNE2rs> {
        SQLCHCTL_W::new(self, 20)
    }
    ///Bit 22 - HDRXGNEQEN
    #[inline(always)]
    pub fn hdrxgneqen(&mut self) -> HDRXGNEQEN_W<'_, TUNE2rs> {
        HDRXGNEQEN_W::new(self, 22)
    }
    ///Bits 23:24 - HSRXOFF
    #[inline(always)]
    pub fn hsrxoff(&mut self) -> HSRXOFF_W<'_, TUNE2rs> {
        HSRXOFF_W::new(self, 23)
    }
    ///Bit 25 - HSFALLPREEM
    #[inline(always)]
    pub fn hsfallpreem(&mut self) -> HSFALLPREEM_W<'_, TUNE2rs> {
        HSFALLPREEM_W::new(self, 25)
    }
    ///Bit 26 - SHTCCTCTLPROT
    #[inline(always)]
    pub fn shtcctctlprot(&mut self) -> SHTCCTCTLPROT_W<'_, TUNE2rs> {
        SHTCCTCTLPROT_W::new(self, 26)
    }
    ///Bit 27 - STAGSEL
    #[inline(always)]
    pub fn stagsel(&mut self) -> STAGSEL_W<'_, TUNE2rs> {
        STAGSEL_W::new(self, 27)
    }
}
/**This register is used to control the tune interface of the HS PHY, port #x.

You can [`read`](crate::Reg::read) this register and get [`tune2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tune2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP153.html#USBPHYC:TUNE2)*/
pub struct TUNE2rs;
impl crate::RegisterSpec for TUNE2rs {
    type Ux = u32;
}
///`read()` method returns [`tune2::R`](R) reader structure
impl crate::Readable for TUNE2rs {}
///`write(|w| ..)` method takes [`tune2::W`](W) writer structure
impl crate::Writable for TUNE2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TUNE2 to value 0x0407_0004
impl crate::Resettable for TUNE2rs {
