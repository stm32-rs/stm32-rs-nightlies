///Register `AXIMC_M0_FN_MOD_AHB` reader
pub type R = crate::R<AXIMC_M0_FN_MOD_AHBrs>;
///Register `AXIMC_M0_FN_MOD_AHB` writer
pub type W = crate::W<AXIMC_M0_FN_MOD_AHBrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AXIMC_M0_FN_MOD_AHB")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rd_inc_override(&mut self) -> RD_INC_OVERRIDE_W<AXIMC_M0_FN_MOD_AHBrs> {
        RD_INC_OVERRIDE_W::new(self, 0)
    }
    ///Bit 1 - WR_INC_OVERRIDE
    #[inline(always)]
    #[must_use]
    pub fn wr_inc_override(&mut self) -> WR_INC_OVERRIDE_W<AXIMC_M0_FN_MOD_AHBrs> {
        WR_INC_OVERRIDE_W::new(self, 1)
    }
}
/**AXIMC master 0 AHB conversion override functionality register

You can [`read`](crate::Reg::read) this register and get [`aximc_m0_fn_mod_ahb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`aximc_m0_fn_mod_ahb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#AXIMC_Mx:AXIMC_M0_FN_MOD_AHB)*/
pub struct AXIMC_M0_FN_MOD_AHBrs;
impl crate::RegisterSpec for AXIMC_M0_FN_MOD_AHBrs {
    type Ux = u32;
}
///`read()` method returns [`aximc_m0_fn_mod_ahb::R`](R) reader structure
impl crate::Readable for AXIMC_M0_FN_MOD_AHBrs {}
///`write(|w| ..)` method takes [`aximc_m0_fn_mod_ahb::W`](W) writer structure
impl crate::Writable for AXIMC_M0_FN_MOD_AHBrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets AXIMC_M0_FN_MOD_AHB to value 0
impl crate::Resettable for AXIMC_M0_FN_MOD_AHBrs {
