///Register `AXIMC_M1_READ_QOS` reader
pub type R = crate::R<AXIMC_M1_READ_QOSrs>;
///Register `AXIMC_M1_READ_QOS` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AXIMC_M1_READ_QOS")
...
You can [`read`](crate::Reg::read) this register and get [`aximc_m1_read_qos::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`aximc_m1_read_qos::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`aximc_m1_read_qos::R`](R) reader structure
impl crate::Readable for AXIMC_M1_READ_QOSrs {}
///`write(|w| ..)` method takes [`aximc_m1_read_qos::W`](W) writer structure
impl crate::Writable for AXIMC_M1_READ_QOSrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets AXIMC_M1_READ_QOS to value 0x06
