#[doc = "Reader of register AXIMC_M6_FN_MOD"]
pub type R = crate::R<u32, super::AXIMC_M6_FN_MOD>;
#[doc = "Writer for register AXIMC_M6_FN_MOD"]
pub type W = crate::W<u32, super::AXIMC_M6_FN_MOD>;
#[doc = "Register AXIMC_M6_FN_MOD `reset()`'s with value 0"]
impl crate::ResetValue for super::AXIMC_M6_FN_MOD {
    type Type = u32;
    #[inline(always)]
