#[doc = "Reader of register AXIMC_M6_FN_MOD2"]
pub type R = crate::R<u32, super::AXIMC_M6_FN_MOD2>;
#[doc = "Writer for register AXIMC_M6_FN_MOD2"]
pub type W = crate::W<u32, super::AXIMC_M6_FN_MOD2>;
#[doc = "Register AXIMC_M6_FN_MOD2 `reset()`'s with value 0"]
impl crate::ResetValue for super::AXIMC_M6_FN_MOD2 {
    type Type = u32;
    #[inline(always)]
