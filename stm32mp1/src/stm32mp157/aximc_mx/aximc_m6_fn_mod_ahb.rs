#[doc = "Reader of register AXIMC_M6_FN_MOD_AHB"]
pub type R = crate::R<u32, super::AXIMC_M6_FN_MOD_AHB>;
#[doc = "Writer for register AXIMC_M6_FN_MOD_AHB"]
pub type W = crate::W<u32, super::AXIMC_M6_FN_MOD_AHB>;
#[doc = "Register AXIMC_M6_FN_MOD_AHB `reset()`'s with value 0"]
impl crate::ResetValue for super::AXIMC_M6_FN_MOD_AHB {
    type Type = u32;
    #[inline(always)]
