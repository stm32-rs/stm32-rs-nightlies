///Register `AXIMC_M8_FN_MOD` reader
pub type R = crate::R<AXIMC_M8_FN_MODrs>;
///Register `AXIMC_M8_FN_MOD` writer
pub type W = crate::W<AXIMC_M8_FN_MODrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AXIMC_M8_FN_MOD")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_iss_override(&mut self) -> READ_ISS_OVERRIDE_W<AXIMC_M8_FN_MODrs> {
        READ_ISS_OVERRIDE_W::new(self, 0)
    }
    ///Bit 1 - WRITE_ISS_OVERRIDE
    #[inline(always)]
    #[must_use]
    pub fn write_iss_override(&mut self) -> WRITE_ISS_OVERRIDE_W<AXIMC_M8_FN_MODrs> {
        WRITE_ISS_OVERRIDE_W::new(self, 1)
    }
}
/**AXIMC master 8 issuing capability override functionality register

You can [`read`](crate::Reg::read) this register and get [`aximc_m8_fn_mod::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`aximc_m8_fn_mod::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#AXIMC_Mx:AXIMC_M8_FN_MOD)*/
pub struct AXIMC_M8_FN_MODrs;
impl crate::RegisterSpec for AXIMC_M8_FN_MODrs {
    type Ux = u32;
}
///`read()` method returns [`aximc_m8_fn_mod::R`](R) reader structure
impl crate::Readable for AXIMC_M8_FN_MODrs {}
///`write(|w| ..)` method takes [`aximc_m8_fn_mod::W`](W) writer structure
impl crate::Writable for AXIMC_M8_FN_MODrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets AXIMC_M8_FN_MOD to value 0
impl crate::Resettable for AXIMC_M8_FN_MODrs {
