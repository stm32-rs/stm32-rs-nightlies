...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AXIMC_PERIPH_ID_5")
...
You can [`read`](crate::Reg::read) this register and get [`aximc_periph_id_5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
