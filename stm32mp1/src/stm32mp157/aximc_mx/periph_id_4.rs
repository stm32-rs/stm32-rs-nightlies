...
///Field `JEP106CON` reader - JEP106CON
pub type JEP106CON_R = crate::FieldReader;
///Field `K4COUNT` reader - K4COUNT
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#AXIMC_Mx:PERIPH_ID_4)*/
