...
For information about available fields see [`mod@otp_config`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_CONTROL)

For information about available fields see [`mod@otp_control`]
module*/
...
For information about available fields see [`mod@otp_wrdata`]
module*/
...
For information about available fields see [`mod@otp_lock`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:DENABLE)

For information about available fields see [`mod@denable`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DISTURBED0)

For information about available fields see [`mod@otp_disturbed0`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DISTURBED1)

For information about available fields see [`mod@otp_disturbed1`]
module*/
...
For information about available fields see [`mod@otp_disturbed2`]
module*/
...
For information about available fields see [`mod@otp_error0`]
module*/
...
For information about available fields see [`mod@otp_error1`]
module*/
...
For information about available fields see [`mod@otp_error2`]
module*/
...
For information about available fields see [`mod@otp_wrlock0`]
module*/
...
For information about available fields see [`mod@otp_wrlock1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_WRLOCK2)

For information about available fields see [`mod@otp_wrlock2`]
module*/
...
For information about available fields see [`mod@otp_splock0`]
module*/
...
For information about available fields see [`mod@otp_splock1`]
module*/
...
For information about available fields see [`mod@otp_splock2`]
module*/
...
For information about available fields see [`mod@otp_swlock0`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_SWLOCK1)

For information about available fields see [`mod@otp_swlock1`]
module*/
...
For information about available fields see [`mod@otp_swlock2`]
module*/
...
For information about available fields see [`mod@otp_srlock0`]
module*/
...
For information about available fields see [`mod@otp_srlock1`]
module*/
...
For information about available fields see [`mod@otp_srlock2`]
module*/
...
For information about available fields see [`mod@jtagin`]
module*/
...
For information about available fields see [`mod@jtagout`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:SCRATCH)
...
pub mod scratch;
/**OTP_DATA0 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data0`]
module*/
pub type OTP_DATA0 = crate::Reg<otp_data0::OTP_DATA0rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data0;
/**OTP_DATA1 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data1`]
module*/
pub type OTP_DATA1 = crate::Reg<otp_data1::OTP_DATA1rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data1;
/**OTP_DATA2 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA2)

For information about available fields see [`mod@otp_data2`]
module*/
pub type OTP_DATA2 = crate::Reg<otp_data2::OTP_DATA2rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data2;
/**OTP_DATA3 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA3)

For information about available fields see [`mod@otp_data3`]
module*/
pub type OTP_DATA3 = crate::Reg<otp_data3::OTP_DATA3rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data3;
/**OTP_DATA4 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data4`]
module*/
pub type OTP_DATA4 = crate::Reg<otp_data4::OTP_DATA4rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data4;
/**OTP_DATA5 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA5)

For information about available fields see [`mod@otp_data5`]
module*/
pub type OTP_DATA5 = crate::Reg<otp_data5::OTP_DATA5rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data5;
/**OTP_DATA6 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data6`]
module*/
pub type OTP_DATA6 = crate::Reg<otp_data6::OTP_DATA6rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data6;
/**OTP_DATA7 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA7)

For information about available fields see [`mod@otp_data7`]
module*/
pub type OTP_DATA7 = crate::Reg<otp_data7::OTP_DATA7rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data7;
/**OTP_DATA8 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA8)

For information about available fields see [`mod@otp_data8`]
module*/
pub type OTP_DATA8 = crate::Reg<otp_data8::OTP_DATA8rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data8;
/**OTP_DATA9 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data9`]
module*/
pub type OTP_DATA9 = crate::Reg<otp_data9::OTP_DATA9rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data9;
/**OTP_DATA10 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA10)

For information about available fields see [`mod@otp_data10`]
module*/
pub type OTP_DATA10 = crate::Reg<otp_data10::OTP_DATA10rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data10;
/**OTP_DATA11 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data11`]
module*/
pub type OTP_DATA11 = crate::Reg<otp_data11::OTP_DATA11rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data11;
/**OTP_DATA12 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data12`]
module*/
pub type OTP_DATA12 = crate::Reg<otp_data12::OTP_DATA12rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data12;
/**OTP_DATA13 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA13)

For information about available fields see [`mod@otp_data13`]
module*/
pub type OTP_DATA13 = crate::Reg<otp_data13::OTP_DATA13rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data13;
/**OTP_DATA14 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA14)

For information about available fields see [`mod@otp_data14`]
module*/
pub type OTP_DATA14 = crate::Reg<otp_data14::OTP_DATA14rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data14;
/**OTP_DATA15 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data15`]
module*/
pub type OTP_DATA15 = crate::Reg<otp_data15::OTP_DATA15rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data15;
/**OTP_DATA16 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA16)

For information about available fields see [`mod@otp_data16`]
module*/
pub type OTP_DATA16 = crate::Reg<otp_data16::OTP_DATA16rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data16;
/**OTP_DATA17 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA17)

For information about available fields see [`mod@otp_data17`]
module*/
pub type OTP_DATA17 = crate::Reg<otp_data17::OTP_DATA17rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data17;
/**OTP_DATA18 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data18`]
module*/
pub type OTP_DATA18 = crate::Reg<otp_data18::OTP_DATA18rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data18;
/**OTP_DATA19 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data19`]
module*/
pub type OTP_DATA19 = crate::Reg<otp_data19::OTP_DATA19rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data19;
/**OTP_DATA20 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data20`]
module*/
pub type OTP_DATA20 = crate::Reg<otp_data20::OTP_DATA20rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data20;
/**OTP_DATA21 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data21`]
module*/
pub type OTP_DATA21 = crate::Reg<otp_data21::OTP_DATA21rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data21;
/**OTP_DATA22 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA22)

For information about available fields see [`mod@otp_data22`]
module*/
pub type OTP_DATA22 = crate::Reg<otp_data22::OTP_DATA22rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data22;
/**OTP_DATA23 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data23`]
module*/
pub type OTP_DATA23 = crate::Reg<otp_data23::OTP_DATA23rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data23;
/**OTP_DATA24 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data24`]
module*/
pub type OTP_DATA24 = crate::Reg<otp_data24::OTP_DATA24rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data24;
/**OTP_DATA25 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data25`]
module*/
pub type OTP_DATA25 = crate::Reg<otp_data25::OTP_DATA25rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data25;
/**OTP_DATA26 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA26)

For information about available fields see [`mod@otp_data26`]
module*/
pub type OTP_DATA26 = crate::Reg<otp_data26::OTP_DATA26rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data26;
/**OTP_DATA27 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data27`]
module*/
pub type OTP_DATA27 = crate::Reg<otp_data27::OTP_DATA27rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data27;
/**OTP_DATA28 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data28`]
module*/
pub type OTP_DATA28 = crate::Reg<otp_data28::OTP_DATA28rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data28;
/**OTP_DATA29 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA29)

For information about available fields see [`mod@otp_data29`]
module*/
pub type OTP_DATA29 = crate::Reg<otp_data29::OTP_DATA29rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data29;
/**OTP_DATA30 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data30`]
module*/
pub type OTP_DATA30 = crate::Reg<otp_data30::OTP_DATA30rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data30;
/**OTP_DATA31 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA31)

For information about available fields see [`mod@otp_data31`]
module*/
pub type OTP_DATA31 = crate::Reg<otp_data31::OTP_DATA31rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data31;
/**OTP_DATA32 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data32`]
module*/
pub type OTP_DATA32 = crate::Reg<otp_data32::OTP_DATA32rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data32;
/**OTP_DATA33 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data33`]
module*/
pub type OTP_DATA33 = crate::Reg<otp_data33::OTP_DATA33rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data33;
/**OTP_DATA34 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data34`]
module*/
pub type OTP_DATA34 = crate::Reg<otp_data34::OTP_DATA34rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data34;
/**OTP_DATA35 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data35`]
module*/
pub type OTP_DATA35 = crate::Reg<otp_data35::OTP_DATA35rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data35;
/**OTP_DATA36 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA36)

For information about available fields see [`mod@otp_data36`]
module*/
pub type OTP_DATA36 = crate::Reg<otp_data36::OTP_DATA36rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data36;
/**OTP_DATA37 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA37)

For information about available fields see [`mod@otp_data37`]
module*/
pub type OTP_DATA37 = crate::Reg<otp_data37::OTP_DATA37rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data37;
/**OTP_DATA38 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data38`]
module*/
pub type OTP_DATA38 = crate::Reg<otp_data38::OTP_DATA38rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data38;
/**OTP_DATA39 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data39`]
module*/
pub type OTP_DATA39 = crate::Reg<otp_data39::OTP_DATA39rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data39;
/**OTP_DATA40 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data40`]
module*/
pub type OTP_DATA40 = crate::Reg<otp_data40::OTP_DATA40rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data40;
/**OTP_DATA41 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data41`]
module*/
pub type OTP_DATA41 = crate::Reg<otp_data41::OTP_DATA41rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data41;
/**OTP_DATA42 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data42`]
module*/
pub type OTP_DATA42 = crate::Reg<otp_data42::OTP_DATA42rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data42;
/**OTP_DATA43 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data43`]
module*/
pub type OTP_DATA43 = crate::Reg<otp_data43::OTP_DATA43rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data43;
/**OTP_DATA44 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data44`]
module*/
pub type OTP_DATA44 = crate::Reg<otp_data44::OTP_DATA44rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data44;
/**OTP_DATA45 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data45`]
module*/
pub type OTP_DATA45 = crate::Reg<otp_data45::OTP_DATA45rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data45;
/**OTP_DATA46 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA46)

For information about available fields see [`mod@otp_data46`]
module*/
pub type OTP_DATA46 = crate::Reg<otp_data46::OTP_DATA46rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data46;
/**OTP_DATA47 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA47)

For information about available fields see [`mod@otp_data47`]
module*/
pub type OTP_DATA47 = crate::Reg<otp_data47::OTP_DATA47rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data47;
/**OTP_DATA48 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data48`]
module*/
pub type OTP_DATA48 = crate::Reg<otp_data48::OTP_DATA48rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data48;
/**OTP_DATA49 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA49)

For information about available fields see [`mod@otp_data49`]
module*/
pub type OTP_DATA49 = crate::Reg<otp_data49::OTP_DATA49rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data49;
/**OTP_DATA50 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data50`]
module*/
pub type OTP_DATA50 = crate::Reg<otp_data50::OTP_DATA50rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data50;
/**OTP_DATA51 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA51)

For information about available fields see [`mod@otp_data51`]
module*/
pub type OTP_DATA51 = crate::Reg<otp_data51::OTP_DATA51rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data51;
/**OTP_DATA52 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA52)

For information about available fields see [`mod@otp_data52`]
module*/
pub type OTP_DATA52 = crate::Reg<otp_data52::OTP_DATA52rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data52;
/**OTP_DATA53 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA53)

For information about available fields see [`mod@otp_data53`]
module*/
pub type OTP_DATA53 = crate::Reg<otp_data53::OTP_DATA53rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data53;
/**OTP_DATA54 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data54`]
module*/
pub type OTP_DATA54 = crate::Reg<otp_data54::OTP_DATA54rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data54;
/**OTP_DATA55 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA55)

For information about available fields see [`mod@otp_data55`]
module*/
pub type OTP_DATA55 = crate::Reg<otp_data55::OTP_DATA55rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data55;
/**OTP_DATA56 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA56)

For information about available fields see [`mod@otp_data56`]
module*/
pub type OTP_DATA56 = crate::Reg<otp_data56::OTP_DATA56rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data56;
/**OTP_DATA57 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data57`]
module*/
pub type OTP_DATA57 = crate::Reg<otp_data57::OTP_DATA57rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data57;
/**OTP_DATA58 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA58)

For information about available fields see [`mod@otp_data58`]
module*/
pub type OTP_DATA58 = crate::Reg<otp_data58::OTP_DATA58rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data58;
/**OTP_DATA59 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data59`]
module*/
pub type OTP_DATA59 = crate::Reg<otp_data59::OTP_DATA59rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data59;
/**OTP_DATA60 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data60`]
module*/
pub type OTP_DATA60 = crate::Reg<otp_data60::OTP_DATA60rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data60;
/**OTP_DATA61 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA61)

For information about available fields see [`mod@otp_data61`]
module*/
pub type OTP_DATA61 = crate::Reg<otp_data61::OTP_DATA61rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data61;
/**OTP_DATA62 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data62`]
module*/
pub type OTP_DATA62 = crate::Reg<otp_data62::OTP_DATA62rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data62;
/**OTP_DATA63 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data63`]
module*/
pub type OTP_DATA63 = crate::Reg<otp_data63::OTP_DATA63rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data63;
/**OTP_DATA64 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA64)

For information about available fields see [`mod@otp_data64`]
module*/
pub type OTP_DATA64 = crate::Reg<otp_data64::OTP_DATA64rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data64;
/**OTP_DATA65 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data65`]
module*/
pub type OTP_DATA65 = crate::Reg<otp_data65::OTP_DATA65rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data65;
/**OTP_DATA66 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA66)

For information about available fields see [`mod@otp_data66`]
module*/
pub type OTP_DATA66 = crate::Reg<otp_data66::OTP_DATA66rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data66;
/**OTP_DATA67 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data67`]
module*/
pub type OTP_DATA67 = crate::Reg<otp_data67::OTP_DATA67rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data67;
/**OTP_DATA68 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data68`]
module*/
pub type OTP_DATA68 = crate::Reg<otp_data68::OTP_DATA68rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data68;
/**OTP_DATA69 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data69`]
module*/
pub type OTP_DATA69 = crate::Reg<otp_data69::OTP_DATA69rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data69;
/**OTP_DATA70 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data70`]
module*/
pub type OTP_DATA70 = crate::Reg<otp_data70::OTP_DATA70rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data70;
/**OTP_DATA71 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data71`]
module*/
pub type OTP_DATA71 = crate::Reg<otp_data71::OTP_DATA71rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data71;
/**OTP_DATA72 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data72`]
module*/
pub type OTP_DATA72 = crate::Reg<otp_data72::OTP_DATA72rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data72;
/**OTP_DATA73 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA73)

For information about available fields see [`mod@otp_data73`]
module*/
pub type OTP_DATA73 = crate::Reg<otp_data73::OTP_DATA73rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data73;
/**OTP_DATA74 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data74`]
module*/
pub type OTP_DATA74 = crate::Reg<otp_data74::OTP_DATA74rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data74;
/**OTP_DATA75 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA75)

For information about available fields see [`mod@otp_data75`]
module*/
pub type OTP_DATA75 = crate::Reg<otp_data75::OTP_DATA75rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data75;
/**OTP_DATA76 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data76`]
module*/
pub type OTP_DATA76 = crate::Reg<otp_data76::OTP_DATA76rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data76;
/**OTP_DATA77 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA77)

For information about available fields see [`mod@otp_data77`]
module*/
pub type OTP_DATA77 = crate::Reg<otp_data77::OTP_DATA77rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data77;
/**OTP_DATA78 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data78`]
module*/
pub type OTP_DATA78 = crate::Reg<otp_data78::OTP_DATA78rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data78;
/**OTP_DATA79 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA79)

For information about available fields see [`mod@otp_data79`]
module*/
pub type OTP_DATA79 = crate::Reg<otp_data79::OTP_DATA79rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data79;
/**OTP_DATA80 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data80`]
module*/
pub type OTP_DATA80 = crate::Reg<otp_data80::OTP_DATA80rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data80;
/**OTP_DATA81 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA81)

For information about available fields see [`mod@otp_data81`]
module*/
pub type OTP_DATA81 = crate::Reg<otp_data81::OTP_DATA81rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data81;
/**OTP_DATA82 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data82`]
module*/
pub type OTP_DATA82 = crate::Reg<otp_data82::OTP_DATA82rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data82;
/**OTP_DATA83 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data83`]
module*/
pub type OTP_DATA83 = crate::Reg<otp_data83::OTP_DATA83rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data83;
/**OTP_DATA84 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data84`]
module*/
pub type OTP_DATA84 = crate::Reg<otp_data84::OTP_DATA84rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data84;
/**OTP_DATA85 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data85`]
module*/
pub type OTP_DATA85 = crate::Reg<otp_data85::OTP_DATA85rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data85;
/**OTP_DATA86 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA86)

For information about available fields see [`mod@otp_data86`]
module*/
pub type OTP_DATA86 = crate::Reg<otp_data86::OTP_DATA86rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data86;
/**OTP_DATA87 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data87`]
module*/
pub type OTP_DATA87 = crate::Reg<otp_data87::OTP_DATA87rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data87;
/**OTP_DATA88 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data88`]
module*/
pub type OTP_DATA88 = crate::Reg<otp_data88::OTP_DATA88rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data88;
/**OTP_DATA89 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA89)

For information about available fields see [`mod@otp_data89`]
module*/
pub type OTP_DATA89 = crate::Reg<otp_data89::OTP_DATA89rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data89;
/**OTP_DATA90 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data90`]
module*/
pub type OTP_DATA90 = crate::Reg<otp_data90::OTP_DATA90rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data90;
/**OTP_DATA91 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA91)

For information about available fields see [`mod@otp_data91`]
module*/
pub type OTP_DATA91 = crate::Reg<otp_data91::OTP_DATA91rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data91;
/**OTP_DATA92 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA92)

For information about available fields see [`mod@otp_data92`]
module*/
pub type OTP_DATA92 = crate::Reg<otp_data92::OTP_DATA92rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data92;
/**OTP_DATA93 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA93)

For information about available fields see [`mod@otp_data93`]
module*/
pub type OTP_DATA93 = crate::Reg<otp_data93::OTP_DATA93rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data93;
/**OTP_DATA94 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:OTP_DATA94)

For information about available fields see [`mod@otp_data94`]
module*/
pub type OTP_DATA94 = crate::Reg<otp_data94::OTP_DATA94rs>;
/**Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.*/
pub mod otp_data94;
/**OTP_DATA95 (rw) register accessor: Several OTP directly impact BSEC behavior, such as: BSEC_OTP_DATA0\[6:0\]
(see Table15: OTP modes definition on page175) BSEC_OTP_DATA1, 16 lsb used for SoC features control BSEC_OTP_DATA2, 2 lsb used to control the RAM handling The reset value depends on the actual OTP programmed value and the OTP mode.
...
For information about available fields see [`mod@otp_data95`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:VERR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#BSEC:IPIDR)
