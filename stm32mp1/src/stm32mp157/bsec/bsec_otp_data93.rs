...
pub type R = crate::R<BSEC_OTP_DATA93rs>;
///Register `BSEC_OTP_DATA93` writer
pub type W = crate::W<BSEC_OTP_DATA93rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BSEC_OTP_DATA93")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<BSEC_OTP_DATA93rs> {
        DATA_W::new(self, 0)
    }
}
