...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BSEC_OTP_ERROR2")
            .field("err", &self.err())
            .finish()
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`bsec_otp_error2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
