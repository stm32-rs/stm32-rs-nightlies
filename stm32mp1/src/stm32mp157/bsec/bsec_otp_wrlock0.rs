...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BSEC_OTP_WRLOCK0")
...
You can [`read`](crate::Reg::read) this register and get [`bsec_otp_wrlock0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
