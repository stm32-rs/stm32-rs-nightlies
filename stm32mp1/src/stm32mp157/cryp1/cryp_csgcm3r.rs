...
pub struct CSGCM3_R(crate::FieldReader<u32, u32>);
impl CSGCM3_R {
    pub(crate) fn new(bits: u32) -> Self {
        CSGCM3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CSGCM3_R {
...
impl R {
    ...
    pub fn csgcm3(&self) -> CSGCM3_R {
        CSGCM3_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - CSGCM3"]
    #[inline(always)]
    pub fn csgcm3(&mut self) -> CSGCM3_W {
        CSGCM3_W { w: self }
    }
