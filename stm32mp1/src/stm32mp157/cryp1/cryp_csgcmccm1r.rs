///Register `CRYP_CSGCMCCM1R` reader
pub type R = crate::R<CRYP_CSGCMCCM1Rrs>;
///Register `CRYP_CSGCMCCM1R` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CRYP_CSGCMCCM1R")
...
You can [`read`](crate::Reg::read) this register and get [`cryp_csgcmccm1r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cryp_csgcmccm1r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#CRYP1:CRYP_CSGCMCCM1R)*/
pub struct CRYP_CSGCMCCM1Rrs;
impl crate::RegisterSpec for CRYP_CSGCMCCM1Rrs {
    type Ux = u32;
}
///`read()` method returns [`cryp_csgcmccm1r::R`](R) reader structure
impl crate::Readable for CRYP_CSGCMCCM1Rrs {}
///`write(|w| ..)` method takes [`cryp_csgcmccm1r::W`](W) writer structure
impl crate::Writable for CRYP_CSGCMCCM1Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CRYP_CSGCMCCM1R to value 0
