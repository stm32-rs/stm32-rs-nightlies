#[doc = "Reader of register CRYP_DIN"]
pub type R = crate::R<u32, super::CRYP_DIN>;
#[doc = "Writer for register CRYP_DIN"]
pub type W = crate::W<u32, super::CRYP_DIN>;
#[doc = "Register CRYP_DIN `reset()`'s with value 0"]
impl crate::ResetValue for super::CRYP_DIN {
    type Type = u32;
    #[inline(always)]
