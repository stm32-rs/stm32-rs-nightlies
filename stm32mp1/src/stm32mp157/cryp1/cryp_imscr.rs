#[doc = "Reader of register CRYP_IMSCR"]
pub type R = crate::R<u32, super::CRYP_IMSCR>;
#[doc = "Writer for register CRYP_IMSCR"]
pub type W = crate::W<u32, super::CRYP_IMSCR>;
#[doc = "Register CRYP_IMSCR `reset()`'s with value 0"]
impl crate::ResetValue for super::CRYP_IMSCR {
    type Type = u32;
    #[inline(always)]
