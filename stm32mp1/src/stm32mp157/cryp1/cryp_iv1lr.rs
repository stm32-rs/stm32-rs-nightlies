...
pub type R = crate::R<CRYP_IV1LRrs>;
///Register `CRYP_IV1LR` writer
pub type W = crate::W<CRYP_IV1LRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iv95(&mut self) -> IV95_W<CRYP_IV1LRrs> {
        IV95_W::new(self, 0)
    }
    ///Bit 1 - IV94
    #[inline(always)]
    #[must_use]
    pub fn iv94(&mut self) -> IV94_W<CRYP_IV1LRrs> {
        IV94_W::new(self, 1)
    }
    ///Bit 2 - IV93
    #[inline(always)]
    #[must_use]
    pub fn iv93(&mut self) -> IV93_W<CRYP_IV1LRrs> {
        IV93_W::new(self, 2)
    }
    ///Bit 3 - IV92
    #[inline(always)]
    #[must_use]
    pub fn iv92(&mut self) -> IV92_W<CRYP_IV1LRrs> {
        IV92_W::new(self, 3)
    }
    ///Bit 4 - IV91
    #[inline(always)]
    #[must_use]
    pub fn iv91(&mut self) -> IV91_W<CRYP_IV1LRrs> {
        IV91_W::new(self, 4)
    }
    ///Bit 5 - IV90
    #[inline(always)]
    #[must_use]
    pub fn iv90(&mut self) -> IV90_W<CRYP_IV1LRrs> {
        IV90_W::new(self, 5)
    }
    ///Bit 6 - IV89
    #[inline(always)]
    #[must_use]
    pub fn iv89(&mut self) -> IV89_W<CRYP_IV1LRrs> {
        IV89_W::new(self, 6)
    }
    ///Bit 7 - IV88
    #[inline(always)]
    #[must_use]
    pub fn iv88(&mut self) -> IV88_W<CRYP_IV1LRrs> {
        IV88_W::new(self, 7)
    }
    ///Bit 8 - IV87
    #[inline(always)]
    #[must_use]
    pub fn iv87(&mut self) -> IV87_W<CRYP_IV1LRrs> {
        IV87_W::new(self, 8)
    }
    ///Bit 9 - IV86
    #[inline(always)]
    #[must_use]
    pub fn iv86(&mut self) -> IV86_W<CRYP_IV1LRrs> {
        IV86_W::new(self, 9)
    }
    ///Bit 10 - IV85
    #[inline(always)]
    #[must_use]
    pub fn iv85(&mut self) -> IV85_W<CRYP_IV1LRrs> {
        IV85_W::new(self, 10)
    }
    ///Bit 11 - IV84
    #[inline(always)]
    #[must_use]
    pub fn iv84(&mut self) -> IV84_W<CRYP_IV1LRrs> {
        IV84_W::new(self, 11)
    }
    ///Bit 12 - IV83
    #[inline(always)]
    #[must_use]
    pub fn iv83(&mut self) -> IV83_W<CRYP_IV1LRrs> {
        IV83_W::new(self, 12)
    }
    ///Bit 13 - IV82
    #[inline(always)]
    #[must_use]
    pub fn iv82(&mut self) -> IV82_W<CRYP_IV1LRrs> {
        IV82_W::new(self, 13)
    }
    ///Bit 14 - IV81
    #[inline(always)]
    #[must_use]
    pub fn iv81(&mut self) -> IV81_W<CRYP_IV1LRrs> {
        IV81_W::new(self, 14)
    }
    ///Bit 15 - IV80
    #[inline(always)]
    #[must_use]
    pub fn iv80(&mut self) -> IV80_W<CRYP_IV1LRrs> {
        IV80_W::new(self, 15)
    }
    ///Bit 16 - IV79
    #[inline(always)]
    #[must_use]
    pub fn iv79(&mut self) -> IV79_W<CRYP_IV1LRrs> {
        IV79_W::new(self, 16)
    }
    ///Bit 17 - IV78
    #[inline(always)]
    #[must_use]
    pub fn iv78(&mut self) -> IV78_W<CRYP_IV1LRrs> {
        IV78_W::new(self, 17)
    }
    ///Bit 18 - IV77
    #[inline(always)]
    #[must_use]
    pub fn iv77(&mut self) -> IV77_W<CRYP_IV1LRrs> {
        IV77_W::new(self, 18)
    }
    ///Bit 19 - IV76
    #[inline(always)]
    #[must_use]
    pub fn iv76(&mut self) -> IV76_W<CRYP_IV1LRrs> {
        IV76_W::new(self, 19)
    }
    ///Bit 20 - IV75
    #[inline(always)]
    #[must_use]
    pub fn iv75(&mut self) -> IV75_W<CRYP_IV1LRrs> {
        IV75_W::new(self, 20)
    }
    ///Bit 21 - IV74
    #[inline(always)]
    #[must_use]
    pub fn iv74(&mut self) -> IV74_W<CRYP_IV1LRrs> {
        IV74_W::new(self, 21)
    }
    ///Bit 22 - IV73
    #[inline(always)]
    #[must_use]
    pub fn iv73(&mut self) -> IV73_W<CRYP_IV1LRrs> {
        IV73_W::new(self, 22)
    }
    ///Bit 23 - IV72
    #[inline(always)]
    #[must_use]
    pub fn iv72(&mut self) -> IV72_W<CRYP_IV1LRrs> {
        IV72_W::new(self, 23)
    }
    ///Bit 24 - IV71
    #[inline(always)]
    #[must_use]
    pub fn iv71(&mut self) -> IV71_W<CRYP_IV1LRrs> {
        IV71_W::new(self, 24)
    }
    ///Bit 25 - IV70
    #[inline(always)]
    #[must_use]
    pub fn iv70(&mut self) -> IV70_W<CRYP_IV1LRrs> {
        IV70_W::new(self, 25)
    }
    ///Bit 26 - IV69
    #[inline(always)]
    #[must_use]
    pub fn iv69(&mut self) -> IV69_W<CRYP_IV1LRrs> {
        IV69_W::new(self, 26)
    }
    ///Bit 27 - IV68
    #[inline(always)]
    #[must_use]
    pub fn iv68(&mut self) -> IV68_W<CRYP_IV1LRrs> {
        IV68_W::new(self, 27)
    }
    ///Bit 28 - IV67
    #[inline(always)]
    #[must_use]
    pub fn iv67(&mut self) -> IV67_W<CRYP_IV1LRrs> {
        IV67_W::new(self, 28)
    }
    ///Bit 29 - IV66
    #[inline(always)]
    #[must_use]
    pub fn iv66(&mut self) -> IV66_W<CRYP_IV1LRrs> {
        IV66_W::new(self, 29)
    }
    ///Bit 30 - IV65
    #[inline(always)]
    #[must_use]
    pub fn iv65(&mut self) -> IV65_W<CRYP_IV1LRrs> {
        IV65_W::new(self, 30)
    }
    ///Bit 31 - IV64
    #[inline(always)]
    #[must_use]
    pub fn iv64(&mut self) -> IV64_W<CRYP_IV1LRrs> {
        IV64_W::new(self, 31)
    }
}
/**Refer to Section39.6.17: CRYP initialization vector register 0L (CRYP_IV0LR) for details.

You can [`read`](crate::Reg::read) this register and get [`cryp_iv1lr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cryp_iv1lr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#CRYP1:CRYP_IV1LR)*/
pub struct CRYP_IV1LRrs;
impl crate::RegisterSpec for CRYP_IV1LRrs {
    type Ux = u32;
}
///`read()` method returns [`cryp_iv1lr::R`](R) reader structure
impl crate::Readable for CRYP_IV1LRrs {}
///`write(|w| ..)` method takes [`cryp_iv1lr::W`](W) writer structure
impl crate::Writable for CRYP_IV1LRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CRYP_IV1LR to value 0
impl crate::Resettable for CRYP_IV1LRrs {
