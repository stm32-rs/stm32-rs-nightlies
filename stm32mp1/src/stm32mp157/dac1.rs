...
#[doc = "DAC sample and hold refresh time register"]
pub mod dac_shrr;
#[doc = "DAC IP hardware configuration register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dac_hwcfgr0](dac_hwcfgr0) module"]
pub type DAC_HWCFGR0 = crate::Reg<u32, _DAC_HWCFGR0>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _DAC_HWCFGR0;
#[doc = "`read()` method returns [dac_hwcfgr0::R](dac_hwcfgr0::R) reader structure"]
impl crate::Readable for DAC_HWCFGR0 {}
#[doc = "DAC IP hardware configuration register"]
pub mod dac_hwcfgr0;
