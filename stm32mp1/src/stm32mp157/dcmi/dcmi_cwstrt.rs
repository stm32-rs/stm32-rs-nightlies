#[doc = "Reader of register DCMI_CWSTRT"]
pub type R = crate::R<u32, super::DCMI_CWSTRT>;
#[doc = "Writer for register DCMI_CWSTRT"]
pub type W = crate::W<u32, super::DCMI_CWSTRT>;
#[doc = "Register DCMI_CWSTRT `reset()`'s with value 0"]
impl crate::ResetValue for super::DCMI_CWSTRT {
    type Type = u32;
    #[inline(always)]
