#[doc = "Reader of register DCMI_ESCR"]
pub type R = crate::R<u32, super::DCMI_ESCR>;
#[doc = "Writer for register DCMI_ESCR"]
pub type W = crate::W<u32, super::DCMI_ESCR>;
#[doc = "Register DCMI_ESCR `reset()`'s with value 0"]
impl crate::ResetValue for super::DCMI_ESCR {
    type Type = u32;
    #[inline(always)]
