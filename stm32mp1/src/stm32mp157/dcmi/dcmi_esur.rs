#[doc = "Reader of register DCMI_ESUR"]
pub type R = crate::R<u32, super::DCMI_ESUR>;
#[doc = "Writer for register DCMI_ESUR"]
pub type W = crate::W<u32, super::DCMI_ESUR>;
#[doc = "Register DCMI_ESUR `reset()`'s with value 0"]
impl crate::ResetValue for super::DCMI_ESUR {
    type Type = u32;
    #[inline(always)]
