...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addrmap_bank_b0(&mut self) -> ADDRMAP_BANK_B0_W<ADDRMAP1rs> {
        ADDRMAP_BANK_B0_W::new(self, 0)
    }
    ///Bits 8:13 - ADDRMAP_BANK_B1
    #[inline(always)]
    #[must_use]
    pub fn addrmap_bank_b1(&mut self) -> ADDRMAP_BANK_B1_W<ADDRMAP1rs> {
        ADDRMAP_BANK_B1_W::new(self, 8)
    }
    ///Bits 16:21 - ADDRMAP_BANK_B2
    #[inline(always)]
    #[must_use]
    pub fn addrmap_bank_b2(&mut self) -> ADDRMAP_BANK_B2_W<ADDRMAP1rs> {
