...
impl W {
    ///Bits 0:3 - ADDRMAP_ROW_B0
    #[inline(always)]
    pub fn addrmap_row_b0(&mut self) -> ADDRMAP_ROW_B0_W<ADDRMAP5rs> {
        ADDRMAP_ROW_B0_W::new(self, 0)
    }
    ///Bits 8:11 - ADDRMAP_ROW_B1
    #[inline(always)]
    pub fn addrmap_row_b1(&mut self) -> ADDRMAP_ROW_B1_W<ADDRMAP5rs> {
        ADDRMAP_ROW_B1_W::new(self, 8)
    }
    ///Bits 16:19 - ADDRMAP_ROW_B2_10
    #[inline(always)]
    pub fn addrmap_row_b2_10(&mut self) -> ADDRMAP_ROW_B2_10_W<ADDRMAP5rs> {
        ADDRMAP_ROW_B2_10_W::new(self, 16)
    }
    ///Bits 24:27 - ADDRMAP_ROW_B11
    #[inline(always)]
    pub fn addrmap_row_b11(&mut self) -> ADDRMAP_ROW_B11_W<ADDRMAP5rs> {
