...
impl W {
    ///Bits 0:3 - ADDRMAP_ROW_B12
    #[inline(always)]
    pub fn addrmap_row_b12(&mut self) -> ADDRMAP_ROW_B12_W<ADDRMAP6rs> {
        ADDRMAP_ROW_B12_W::new(self, 0)
    }
    ///Bits 8:11 - ADDRMAP_ROW_B13
    #[inline(always)]
    pub fn addrmap_row_b13(&mut self) -> ADDRMAP_ROW_B13_W<ADDRMAP6rs> {
        ADDRMAP_ROW_B13_W::new(self, 8)
    }
    ///Bits 16:19 - ADDRMAP_ROW_B14
    #[inline(always)]
    pub fn addrmap_row_b14(&mut self) -> ADDRMAP_ROW_B14_W<ADDRMAP6rs> {
        ADDRMAP_ROW_B14_W::new(self, 16)
    }
    ///Bits 24:27 - ADDRMAP_ROW_B15
    #[inline(always)]
    pub fn addrmap_row_b15(&mut self) -> ADDRMAP_ROW_B15_W<ADDRMAP6rs> {
        ADDRMAP_ROW_B15_W::new(self, 24)
    }
    ///Bit 31 - LPDDR3_6GB_12GB
    #[inline(always)]
    pub fn lpddr3_6gb_12gb(&mut self) -> LPDDR3_6GB_12GB_W<ADDRMAP6rs> {
