...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfi_alert_err_int_en(&mut self) -> DFI_ALERT_ERR_INT_EN_W<CRCPARCTL0rs> {
        DFI_ALERT_ERR_INT_EN_W::new(self, 0)
    }
    ///Bit 1 - DFI_ALERT_ERR_INT_CLR
    #[inline(always)]
    #[must_use]
    pub fn dfi_alert_err_int_clr(&mut self) -> DFI_ALERT_ERR_INT_CLR_W<CRCPARCTL0rs> {
        DFI_ALERT_ERR_INT_CLR_W::new(self, 1)
    }
    ///Bit 2 - DFI_ALERT_ERR_CNT_CLR
    #[inline(always)]
    #[must_use]
    pub fn dfi_alert_err_cnt_clr(&mut self) -> DFI_ALERT_ERR_CNT_CLR_W<CRCPARCTL0rs> {
