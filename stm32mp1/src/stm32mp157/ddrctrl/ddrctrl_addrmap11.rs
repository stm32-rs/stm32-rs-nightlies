...
pub struct ADDRMAP_ROW_B10_R(crate::FieldReader<u8, u8>);
impl ADDRMAP_ROW_B10_R {
    pub(crate) fn new(bits: u8) -> Self {
        ADDRMAP_ROW_B10_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADDRMAP_ROW_B10_R {
