...
pub struct DIS_WC_R(crate::FieldReader<bool, bool>);
impl DIS_WC_R {
    pub(crate) fn new(bits: bool) -> Self {
        DIS_WC_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DIS_WC_R {
...
pub struct DIS_COLLISION_PAGE_OPT_R(crate::FieldReader<bool, bool>);
impl DIS_COLLISION_PAGE_OPT_R {
    pub(crate) fn new(bits: bool) -> Self {
        DIS_COLLISION_PAGE_OPT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DIS_COLLISION_PAGE_OPT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
