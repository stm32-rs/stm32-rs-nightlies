...
pub struct PRE_OCD_X32_R(crate::FieldReader<u8, u8>);
impl PRE_OCD_X32_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRE_OCD_X32_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRE_OCD_X32_R {
...
pub struct DRAM_RSTN_X1024_R(crate::FieldReader<u16, u16>);
impl DRAM_RSTN_X1024_R {
    pub(crate) fn new(bits: u16) -> Self {
        DRAM_RSTN_X1024_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DRAM_RSTN_X1024_R {
