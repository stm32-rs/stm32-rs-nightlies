///Register `DDRCTRL_INIT1` reader
pub type R = crate::R<DDRCTRL_INIT1rs>;
///Register `DDRCTRL_INIT1` writer
...
You can [`read`](crate::Reg::read) this register and get [`ddrctrl_init1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrctrl_init1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DDRCTRL:DDRCTRL_INIT1)*/
pub struct DDRCTRL_INIT1rs;
impl crate::RegisterSpec for DDRCTRL_INIT1rs {
    type Ux = u32;
}
///`read()` method returns [`ddrctrl_init1::R`](R) reader structure
impl crate::Readable for DDRCTRL_INIT1rs {}
///`write(|w| ..)` method takes [`ddrctrl_init1::W`](W) writer structure
impl crate::Writable for DDRCTRL_INIT1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRCTRL_INIT1 to value 0
