...
pub type R = crate::R<DDRCTRL_PCFGQOS0_1rs>;
///Register `DDRCTRL_PCFGQOS0_1` writer
pub type W = crate::W<DDRCTRL_PCFGQOS0_1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRCTRL_PCFGQOS0_1")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rqos_map_level1(&mut self) -> RQOS_MAP_LEVEL1_W<DDRCTRL_PCFGQOS0_1rs> {
        RQOS_MAP_LEVEL1_W::new(self, 0)
    }
    ///Bits 8:11 - RQOS_MAP_LEVEL2
    #[inline(always)]
    #[must_use]
    pub fn rqos_map_level2(&mut self) -> RQOS_MAP_LEVEL2_W<DDRCTRL_PCFGQOS0_1rs> {
        RQOS_MAP_LEVEL2_W::new(self, 8)
    }
    ///Bits 16:17 - RQOS_MAP_REGION0
    #[inline(always)]
    #[must_use]
    pub fn rqos_map_region0(&mut self) -> RQOS_MAP_REGION0_W<DDRCTRL_PCFGQOS0_1rs> {
        RQOS_MAP_REGION0_W::new(self, 16)
    }
    ///Bits 20:21 - RQOS_MAP_REGION1
    #[inline(always)]
    #[must_use]
    pub fn rqos_map_region1(&mut self) -> RQOS_MAP_REGION1_W<DDRCTRL_PCFGQOS0_1rs> {
        RQOS_MAP_REGION1_W::new(self, 20)
    }
    ///Bits 24:25 - RQOS_MAP_REGION2
    #[inline(always)]
    #[must_use]
    pub fn rqos_map_region2(&mut self) -> RQOS_MAP_REGION2_W<DDRCTRL_PCFGQOS0_1rs> {
        RQOS_MAP_REGION2_W::new(self, 24)
    }
}
/**DDRCTRL port 1 read Q0S configuration register 0

You can [`read`](crate::Reg::read) this register and get [`ddrctrl_pcfgqos0_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrctrl_pcfgqos0_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DDRCTRL:DDRCTRL_PCFGQOS0_1)*/
pub struct DDRCTRL_PCFGQOS0_1rs;
impl crate::RegisterSpec for DDRCTRL_PCFGQOS0_1rs {
    type Ux = u32;
}
///`read()` method returns [`ddrctrl_pcfgqos0_1::R`](R) reader structure
impl crate::Readable for DDRCTRL_PCFGQOS0_1rs {}
///`write(|w| ..)` method takes [`ddrctrl_pcfgqos0_1::W`](W) writer structure
impl crate::Writable for DDRCTRL_PCFGQOS0_1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRCTRL_PCFGQOS0_1 to value 0x0200_0e00
impl crate::Resettable for DDRCTRL_PCFGQOS0_1rs {
