///Register `DDRCTRL_PCFGWQOS0_0` reader
pub type R = crate::R<DDRCTRL_PCFGWQOS0_0rs>;
///Register `DDRCTRL_PCFGWQOS0_0` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRCTRL_PCFGWQOS0_0")
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DDRCTRL:DDRCTRL_PCFGWQOS0_0)*/
pub struct DDRCTRL_PCFGWQOS0_0rs;
impl crate::RegisterSpec for DDRCTRL_PCFGWQOS0_0rs {
    type Ux = u32;
}
///`read()` method returns [`ddrctrl_pcfgwqos0_0::R`](R) reader structure
impl crate::Readable for DDRCTRL_PCFGWQOS0_0rs {}
///`write(|w| ..)` method takes [`ddrctrl_pcfgwqos0_0::W`](W) writer structure
impl crate::Writable for DDRCTRL_PCFGWQOS0_0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRCTRL_PCFGWQOS0_0 to value 0x0e00
