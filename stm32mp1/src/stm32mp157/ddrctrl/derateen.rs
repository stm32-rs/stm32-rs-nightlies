...
impl W {
    ///Bit 0 - DERATE_ENABLE
    #[inline(always)]
    pub fn derate_enable(&mut self) -> DERATE_ENABLE_W<DERATEENrs> {
        DERATE_ENABLE_W::new(self, 0)
    }
    ///Bits 1:2 - DERATE_VALUE
    #[inline(always)]
    pub fn derate_value(&mut self) -> DERATE_VALUE_W<DERATEENrs> {
        DERATE_VALUE_W::new(self, 1)
    }
    ///Bits 4:7 - DERATE_BYTE
    #[inline(always)]
    pub fn derate_byte(&mut self) -> DERATE_BYTE_W<DERATEENrs> {
