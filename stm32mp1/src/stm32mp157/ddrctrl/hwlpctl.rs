...
impl W {
    ///Bit 0 - HW_LP_EN
    #[inline(always)]
    pub fn hw_lp_en(&mut self) -> HW_LP_EN_W<HWLPCTLrs> {
        HW_LP_EN_W::new(self, 0)
    }
    ///Bit 1 - HW_LP_EXIT_IDLE_EN
    #[inline(always)]
    pub fn hw_lp_exit_idle_en(&mut self) -> HW_LP_EXIT_IDLE_EN_W<HWLPCTLrs> {
        HW_LP_EXIT_IDLE_EN_W::new(self, 1)
    }
    ///Bits 16:27 - HW_LP_IDLE_X32
    #[inline(always)]
    pub fn hw_lp_idle_x32(&mut self) -> HW_LP_IDLE_X32_W<HWLPCTLrs> {
