...
impl W {
    ///Bit 0 - DDR3
    #[inline(always)]
    pub fn ddr3(&mut self) -> DDR3_W<MSTRrs> {
        DDR3_W::new(self, 0)
    }
    ///Bit 2 - LPDDR2
    #[inline(always)]
    pub fn lpddr2(&mut self) -> LPDDR2_W<MSTRrs> {
        LPDDR2_W::new(self, 2)
    }
    ///Bit 3 - LPDDR3
    #[inline(always)]
    pub fn lpddr3(&mut self) -> LPDDR3_W<MSTRrs> {
        LPDDR3_W::new(self, 3)
    }
    ///Bit 9 - BURSTCHOP
    #[inline(always)]
    pub fn burstchop(&mut self) -> BURSTCHOP_W<MSTRrs> {
        BURSTCHOP_W::new(self, 9)
    }
    ///Bit 10 - EN_2T_TIMING_MODE
    #[inline(always)]
    pub fn en_2t_timing_mode(&mut self) -> EN_2T_TIMING_MODE_W<MSTRrs> {
        EN_2T_TIMING_MODE_W::new(self, 10)
    }
    ///Bits 12:13 - DATA_BUS_WIDTH
    #[inline(always)]
    pub fn data_bus_width(&mut self) -> DATA_BUS_WIDTH_W<MSTRrs> {
        DATA_BUS_WIDTH_W::new(self, 12)
    }
    ///Bit 15 - DLL_OFF_MODE
    #[inline(always)]
    pub fn dll_off_mode(&mut self) -> DLL_OFF_MODE_W<MSTRrs> {
        DLL_OFF_MODE_W::new(self, 15)
    }
    ///Bits 16:19 - BURST_RDWR
    #[inline(always)]
    pub fn burst_rdwr(&mut self) -> BURST_RDWR_W<MSTRrs> {
