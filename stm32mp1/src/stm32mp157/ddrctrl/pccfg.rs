...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn go2critical_en(&mut self) -> GO2CRITICAL_EN_W<PCCFGrs> {
        GO2CRITICAL_EN_W::new(self, 0)
    }
    ///Bit 4 - PAGEMATCH_LIMIT
    #[inline(always)]
    #[must_use]
    pub fn pagematch_limit(&mut self) -> PAGEMATCH_LIMIT_W<PCCFGrs> {
        PAGEMATCH_LIMIT_W::new(self, 4)
    }
    ///Bit 8 - BL_EXP_MODE
    #[inline(always)]
    #[must_use]
    pub fn bl_exp_mode(&mut self) -> BL_EXP_MODE_W<PCCFGrs> {
