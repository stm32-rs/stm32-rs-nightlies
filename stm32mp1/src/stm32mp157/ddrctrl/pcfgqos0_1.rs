...
impl W {
    ///Bits 0:3 - RQOS_MAP_LEVEL1
    #[inline(always)]
    pub fn rqos_map_level1(&mut self) -> RQOS_MAP_LEVEL1_W<PCFGQOS0_1rs> {
        RQOS_MAP_LEVEL1_W::new(self, 0)
    }
    ///Bits 8:11 - RQOS_MAP_LEVEL2
    #[inline(always)]
    pub fn rqos_map_level2(&mut self) -> RQOS_MAP_LEVEL2_W<PCFGQOS0_1rs> {
        RQOS_MAP_LEVEL2_W::new(self, 8)
    }
    ///Bits 16:17 - RQOS_MAP_REGION0
    #[inline(always)]
    pub fn rqos_map_region0(&mut self) -> RQOS_MAP_REGION0_W<PCFGQOS0_1rs> {
        RQOS_MAP_REGION0_W::new(self, 16)
    }
    ///Bits 20:21 - RQOS_MAP_REGION1
    #[inline(always)]
    pub fn rqos_map_region1(&mut self) -> RQOS_MAP_REGION1_W<PCFGQOS0_1rs> {
        RQOS_MAP_REGION1_W::new(self, 20)
    }
    ///Bits 24:25 - RQOS_MAP_REGION2
    #[inline(always)]
    pub fn rqos_map_region2(&mut self) -> RQOS_MAP_REGION2_W<PCFGQOS0_1rs> {
