///Register `PCFGQOS0_1` reader
pub type R = crate::R<PCFGQOS0_1rs>;
///Register `PCFGQOS0_1` writer
pub type W = crate::W<PCFGQOS0_1rs>;
...
impl W {
    ///Bits 0:3 - RQOS_MAP_LEVEL1
    #[inline(always)]
    pub fn rqos_map_level1(&mut self) -> RQOS_MAP_LEVEL1_W<'_, PCFGQOS0_1rs> {
        RQOS_MAP_LEVEL1_W::new(self, 0)
    }
    ///Bits 8:11 - RQOS_MAP_LEVEL2
    #[inline(always)]
    pub fn rqos_map_level2(&mut self) -> RQOS_MAP_LEVEL2_W<'_, PCFGQOS0_1rs> {
        RQOS_MAP_LEVEL2_W::new(self, 8)
    }
    ///Bits 16:17 - RQOS_MAP_REGION0
    #[inline(always)]
    pub fn rqos_map_region0(&mut self) -> RQOS_MAP_REGION0_W<'_, PCFGQOS0_1rs> {
        RQOS_MAP_REGION0_W::new(self, 16)
    }
    ///Bits 20:21 - RQOS_MAP_REGION1
    #[inline(always)]
    pub fn rqos_map_region1(&mut self) -> RQOS_MAP_REGION1_W<'_, PCFGQOS0_1rs> {
        RQOS_MAP_REGION1_W::new(self, 20)
    }
    ///Bits 24:25 - RQOS_MAP_REGION2
    #[inline(always)]
    pub fn rqos_map_region2(&mut self) -> RQOS_MAP_REGION2_W<'_, PCFGQOS0_1rs> {
        RQOS_MAP_REGION2_W::new(self, 24)
    }
}
/**DDRCTRL port 1 read Q0S configuration register 0

You can [`read`](crate::Reg::read) this register and get [`pcfgqos0_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfgqos0_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DDRCTRL:PCFGQOS0_1)*/
pub struct PCFGQOS0_1rs;
impl crate::RegisterSpec for PCFGQOS0_1rs {
    type Ux = u32;
}
///`read()` method returns [`pcfgqos0_1::R`](R) reader structure
impl crate::Readable for PCFGQOS0_1rs {}
///`write(|w| ..)` method takes [`pcfgqos0_1::W`](W) writer structure
impl crate::Writable for PCFGQOS0_1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PCFGQOS0_1 to value 0x0200_0e00
impl crate::Resettable for PCFGQOS0_1rs {
