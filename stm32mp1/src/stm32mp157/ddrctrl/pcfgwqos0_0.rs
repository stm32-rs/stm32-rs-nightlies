...
impl W {
    ///Bits 0:3 - WQOS_MAP_LEVEL1
    #[inline(always)]
    pub fn wqos_map_level1(&mut self) -> WQOS_MAP_LEVEL1_W<PCFGWQOS0_0rs> {
        WQOS_MAP_LEVEL1_W::new(self, 0)
    }
    ///Bits 8:11 - WQOS_MAP_LEVEL2
    #[inline(always)]
    pub fn wqos_map_level2(&mut self) -> WQOS_MAP_LEVEL2_W<PCFGWQOS0_0rs> {
        WQOS_MAP_LEVEL2_W::new(self, 8)
    }
    ///Bits 16:17 - WQOS_MAP_REGION0
    #[inline(always)]
    pub fn wqos_map_region0(&mut self) -> WQOS_MAP_REGION0_W<PCFGWQOS0_0rs> {
        WQOS_MAP_REGION0_W::new(self, 16)
    }
    ///Bits 20:21 - WQOS_MAP_REGION1
    #[inline(always)]
    pub fn wqos_map_region1(&mut self) -> WQOS_MAP_REGION1_W<PCFGWQOS0_0rs> {
        WQOS_MAP_REGION1_W::new(self, 20)
    }
    ///Bits 24:25 - WQOS_MAP_REGION2
    #[inline(always)]
    pub fn wqos_map_region2(&mut self) -> WQOS_MAP_REGION2_W<PCFGWQOS0_0rs> {
