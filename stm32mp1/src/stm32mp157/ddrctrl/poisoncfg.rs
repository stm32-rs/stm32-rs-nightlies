...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wr_poison_slverr_en(&mut self) -> WR_POISON_SLVERR_EN_W<POISONCFGrs> {
        WR_POISON_SLVERR_EN_W::new(self, 0)
    }
    ///Bit 4 - WR_POISON_INTR_EN
    #[inline(always)]
    #[must_use]
    pub fn wr_poison_intr_en(&mut self) -> WR_POISON_INTR_EN_W<POISONCFGrs> {
        WR_POISON_INTR_EN_W::new(self, 4)
    }
    ///Bit 8 - WR_POISON_INTR_CLR
    #[inline(always)]
    #[must_use]
    pub fn wr_poison_intr_clr(&mut self) -> WR_POISON_INTR_CLR_W<POISONCFGrs> {
        WR_POISON_INTR_CLR_W::new(self, 8)
    }
    ///Bit 16 - RD_POISON_SLVERR_EN
    #[inline(always)]
    #[must_use]
    pub fn rd_poison_slverr_en(&mut self) -> RD_POISON_SLVERR_EN_W<POISONCFGrs> {
        RD_POISON_SLVERR_EN_W::new(self, 16)
    }
    ///Bit 20 - RD_POISON_INTR_EN
    #[inline(always)]
    #[must_use]
    pub fn rd_poison_intr_en(&mut self) -> RD_POISON_INTR_EN_W<POISONCFGrs> {
        RD_POISON_INTR_EN_W::new(self, 20)
    }
    ///Bit 24 - RD_POISON_INTR_CLR
    #[inline(always)]
    #[must_use]
    pub fn rd_poison_intr_clr(&mut self) -> RD_POISON_INTR_CLR_W<POISONCFGrs> {
