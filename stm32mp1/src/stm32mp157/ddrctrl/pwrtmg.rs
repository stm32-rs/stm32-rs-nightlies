...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn powerdown_to_x32(&mut self) -> POWERDOWN_TO_X32_W<PWRTMGrs> {
        POWERDOWN_TO_X32_W::new(self, 0)
    }
    ///Bits 8:15 - T_DPD_X4096
    #[inline(always)]
    #[must_use]
    pub fn t_dpd_x4096(&mut self) -> T_DPD_X4096_W<PWRTMGrs> {
        T_DPD_X4096_W::new(self, 8)
    }
    ///Bits 16:23 - SELFREF_TO_X32
    #[inline(always)]
    #[must_use]
    pub fn selfref_to_x32(&mut self) -> SELFREF_TO_X32_W<PWRTMGrs> {
