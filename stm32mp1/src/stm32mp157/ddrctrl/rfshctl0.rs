...
impl W {
    ///Bit 2 - PER_BANK_REFRESH
    #[inline(always)]
    pub fn per_bank_refresh(&mut self) -> PER_BANK_REFRESH_W<RFSHCTL0rs> {
        PER_BANK_REFRESH_W::new(self, 2)
    }
    ///Bits 4:8 - REFRESH_BURST
    #[inline(always)]
    pub fn refresh_burst(&mut self) -> REFRESH_BURST_W<RFSHCTL0rs> {
        REFRESH_BURST_W::new(self, 4)
    }
    ///Bits 12:16 - REFRESH_TO_X32
    #[inline(always)]
    pub fn refresh_to_x32(&mut self) -> REFRESH_TO_X32_W<RFSHCTL0rs> {
        REFRESH_TO_X32_W::new(self, 12)
    }
    ///Bits 20:23 - REFRESH_MARGIN
    #[inline(always)]
    pub fn refresh_margin(&mut self) -> REFRESH_MARGIN_W<RFSHCTL0rs> {
