...
impl W {
    ///Bits 0:9 - T_RFC_MIN
    #[inline(always)]
    pub fn t_rfc_min(&mut self) -> T_RFC_MIN_W<RFSHTMGrs> {
        T_RFC_MIN_W::new(self, 0)
    }
    ///Bit 15 - LPDDR3_TREFBW_EN
    #[inline(always)]
    pub fn lpddr3_trefbw_en(&mut self) -> LPDDR3_TREFBW_EN_W<RFSHTMGrs> {
        LPDDR3_TREFBW_EN_W::new(self, 15)
    }
    ///Bits 16:27 - T_RFC_NOM_X1_X32
    #[inline(always)]
    pub fn t_rfc_nom_x1_x32(&mut self) -> T_RFC_NOM_X1_X32_W<RFSHTMGrs> {
        T_RFC_NOM_X1_X32_W::new(self, 16)
    }
    ///Bit 31 - T_RFC_NOM_X1_SEL
    #[inline(always)]
    pub fn t_rfc_nom_x1_sel(&mut self) -> T_RFC_NOM_X1_SEL_W<RFSHTMGrs> {
