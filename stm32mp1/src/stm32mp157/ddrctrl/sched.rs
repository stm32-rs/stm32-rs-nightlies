...
impl W {
    ///Bit 0 - FORCE_LOW_PRI_N
    #[inline(always)]
    pub fn force_low_pri_n(&mut self) -> FORCE_LOW_PRI_N_W<SCHEDrs> {
        FORCE_LOW_PRI_N_W::new(self, 0)
    }
    ///Bit 1 - PREFER_WRITE
    #[inline(always)]
    pub fn prefer_write(&mut self) -> PREFER_WRITE_W<SCHEDrs> {
        PREFER_WRITE_W::new(self, 1)
    }
    ///Bit 2 - PAGECLOSE
    #[inline(always)]
    pub fn pageclose(&mut self) -> PAGECLOSE_W<SCHEDrs> {
        PAGECLOSE_W::new(self, 2)
    }
    ///Bits 8:11 - LPR_NUM_ENTRIES
    #[inline(always)]
    pub fn lpr_num_entries(&mut self) -> LPR_NUM_ENTRIES_W<SCHEDrs> {
        LPR_NUM_ENTRIES_W::new(self, 8)
    }
    ///Bits 16:23 - GO2CRITICAL_HYSTERESIS
    #[inline(always)]
    pub fn go2critical_hysteresis(&mut self) -> GO2CRITICAL_HYSTERESIS_W<SCHEDrs> {
        GO2CRITICAL_HYSTERESIS_W::new(self, 16)
    }
    ///Bits 24:30 - RDWR_IDLE_GAP
    #[inline(always)]
    pub fn rdwr_idle_gap(&mut self) -> RDWR_IDLE_GAP_W<SCHEDrs> {
