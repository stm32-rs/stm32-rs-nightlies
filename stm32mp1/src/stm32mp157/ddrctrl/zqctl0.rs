...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn t_zq_short_nop(&mut self) -> T_ZQ_SHORT_NOP_W<ZQCTL0rs> {
        T_ZQ_SHORT_NOP_W::new(self, 0)
    }
    ///Bits 16:26 - T_ZQ_LONG_NOP
    #[inline(always)]
    #[must_use]
    pub fn t_zq_long_nop(&mut self) -> T_ZQ_LONG_NOP_W<ZQCTL0rs> {
        T_ZQ_LONG_NOP_W::new(self, 16)
    }
    ///Bit 29 - ZQ_RESISTOR_SHARED
    #[inline(always)]
    #[must_use]
    pub fn zq_resistor_shared(&mut self) -> ZQ_RESISTOR_SHARED_W<ZQCTL0rs> {
        ZQ_RESISTOR_SHARED_W::new(self, 29)
    }
    ///Bit 30 - DIS_SRX_ZQCL
    #[inline(always)]
    #[must_use]
    pub fn dis_srx_zqcl(&mut self) -> DIS_SRX_ZQCL_W<ZQCTL0rs> {
        DIS_SRX_ZQCL_W::new(self, 30)
    }
    ///Bit 31 - DIS_AUTO_ZQ
    #[inline(always)]
    #[must_use]
    pub fn dis_auto_zq(&mut self) -> DIS_AUTO_ZQ_W<ZQCTL0rs> {
