...
You can [`read`](crate::Reg::read) this register and get [`ddrperfm_ver::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DDRPERFM:DDRPERFM_VER)*/
pub struct DDRPERFM_VERrs;
impl crate::RegisterSpec for DDRPERFM_VERrs {
    type Ux = u32;
}
///`read()` method returns [`ddrperfm_ver::R`](R) reader structure
impl crate::Readable for DDRPERFM_VERrs {}
///`reset()` method sets DDRPERFM_VER to value 0x10
