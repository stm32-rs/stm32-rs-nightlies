...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRPHYC_DDR3_MR0")
            .field("bl", &self.bl())
            .field("cl0", &self.cl0())
            .field("bt", &self.bt())
            .field("cl", &self.cl())
...
You can [`read`](crate::Reg::read) this register and get [`ddrphyc_ddr3_mr0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrphyc_ddr3_mr0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
