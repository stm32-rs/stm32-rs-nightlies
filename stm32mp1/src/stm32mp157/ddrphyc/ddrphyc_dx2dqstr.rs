///Register `DDRPHYC_DX2DQSTR` reader
pub type R = crate::R<DDRPHYC_DX2DQSTRrs>;
///Register `DDRPHYC_DX2DQSTR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRPHYC_DX2DQSTR")
...
You can [`read`](crate::Reg::read) this register and get [`ddrphyc_dx2dqstr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrphyc_dx2dqstr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`ddrphyc_dx2dqstr::R`](R) reader structure
impl crate::Readable for DDRPHYC_DX2DQSTRrs {}
///`write(|w| ..)` method takes [`ddrphyc_dx2dqstr::W`](W) writer structure
impl crate::Writable for DDRPHYC_DX2DQSTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRPHYC_DX2DQSTR to value 0x3db0_2000
