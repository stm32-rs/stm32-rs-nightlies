...
pub type R = crate::R<DDRPHYC_DX3DLLCRrs>;
///Register `DDRPHYC_DX3DLLCR` writer
pub type W = crate::W<DDRPHYC_DX3DLLCRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DDRPHYC_DX3DLLCR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sfbdly(&mut self) -> SFBDLY_W<DDRPHYC_DX3DLLCRrs> {
        SFBDLY_W::new(self, 0)
    }
    ///Bits 3:5 - SFWDLY
    #[inline(always)]
    #[must_use]
    pub fn sfwdly(&mut self) -> SFWDLY_W<DDRPHYC_DX3DLLCRrs> {
        SFWDLY_W::new(self, 3)
    }
    ///Bits 6:8 - MFBDLY
    #[inline(always)]
    #[must_use]
    pub fn mfbdly(&mut self) -> MFBDLY_W<DDRPHYC_DX3DLLCRrs> {
        MFBDLY_W::new(self, 6)
    }
    ///Bits 9:11 - MFWDLY
    #[inline(always)]
    #[must_use]
    pub fn mfwdly(&mut self) -> MFWDLY_W<DDRPHYC_DX3DLLCRrs> {
        MFWDLY_W::new(self, 9)
    }
    ///Bits 12:13 - SSTART
    #[inline(always)]
    #[must_use]
    pub fn sstart(&mut self) -> SSTART_W<DDRPHYC_DX3DLLCRrs> {
        SSTART_W::new(self, 12)
    }
    ///Bits 14:17 - SDPHASE
    #[inline(always)]
    #[must_use]
    pub fn sdphase(&mut self) -> SDPHASE_W<DDRPHYC_DX3DLLCRrs> {
        SDPHASE_W::new(self, 14)
    }
    ///Bit 18 - ATESTEN
    #[inline(always)]
    #[must_use]
    pub fn atesten(&mut self) -> ATESTEN_W<DDRPHYC_DX3DLLCRrs> {
        ATESTEN_W::new(self, 18)
    }
    ///Bit 19 - SDLBMODE
    #[inline(always)]
    #[must_use]
    pub fn sdlbmode(&mut self) -> SDLBMODE_W<DDRPHYC_DX3DLLCRrs> {
        SDLBMODE_W::new(self, 19)
    }
    ///Bit 30 - DLLSRST
    #[inline(always)]
    #[must_use]
    pub fn dllsrst(&mut self) -> DLLSRST_W<DDRPHYC_DX3DLLCRrs> {
        DLLSRST_W::new(self, 30)
    }
    ///Bit 31 - DLLDIS
    #[inline(always)]
    #[must_use]
    pub fn dlldis(&mut self) -> DLLDIS_W<DDRPHYC_DX3DLLCRrs> {
        DLLDIS_W::new(self, 31)
    }
}
/**DDRPHYC byte lane 3 DLLC register

You can [`read`](crate::Reg::read) this register and get [`ddrphyc_dx3dllcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddrphyc_dx3dllcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DDRPHYC:DDRPHYC_DX3DLLCR)*/
pub struct DDRPHYC_DX3DLLCRrs;
impl crate::RegisterSpec for DDRPHYC_DX3DLLCRrs {
    type Ux = u32;
}
///`read()` method returns [`ddrphyc_dx3dllcr::R`](R) reader structure
impl crate::Readable for DDRPHYC_DX3DLLCRrs {}
///`write(|w| ..)` method takes [`ddrphyc_dx3dllcr::W`](W) writer structure
impl crate::Writable for DDRPHYC_DX3DLLCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DDRPHYC_DX3DLLCR to value 0x4000_0000
impl crate::Resettable for DDRPHYC_DX3DLLCRrs {
