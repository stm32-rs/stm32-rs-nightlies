///Register `DX1GSR1` reader
pub type R = crate::R<DX1GSR1rs>;
...
You can [`read`](crate::Reg::read) this register and get [`dx1gsr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DDRPHYC:DX1GSR1)*/
pub struct DX1GSR1rs;
impl crate::RegisterSpec for DX1GSR1rs {
    type Ux = u32;
}
///`read()` method returns [`dx1gsr1::R`](R) reader structure
impl crate::Readable for DX1GSR1rs {}
///`reset()` method sets DX1GSR1 to value 0
impl crate::Resettable for DX1GSR1rs {}
