...
impl W {
    ///Bits 0:3 - DQDLY0
    #[inline(always)]
    pub fn dqdly0(&mut self) -> DQDLY0_W<DX2DQTRrs> {
        DQDLY0_W::new(self, 0)
    }
    ///Bits 4:7 - DQDLY1
    #[inline(always)]
    pub fn dqdly1(&mut self) -> DQDLY1_W<DX2DQTRrs> {
        DQDLY1_W::new(self, 4)
    }
    ///Bits 8:11 - DQDLY2
    #[inline(always)]
    pub fn dqdly2(&mut self) -> DQDLY2_W<DX2DQTRrs> {
        DQDLY2_W::new(self, 8)
    }
    ///Bits 12:15 - DQDLY3
    #[inline(always)]
    pub fn dqdly3(&mut self) -> DQDLY3_W<DX2DQTRrs> {
        DQDLY3_W::new(self, 12)
    }
    ///Bits 16:19 - DQDLY4
    #[inline(always)]
    pub fn dqdly4(&mut self) -> DQDLY4_W<DX2DQTRrs> {
        DQDLY4_W::new(self, 16)
    }
    ///Bits 20:23 - DQDLY5
    #[inline(always)]
    pub fn dqdly5(&mut self) -> DQDLY5_W<DX2DQTRrs> {
        DQDLY5_W::new(self, 20)
    }
    ///Bits 24:27 - DQDLY6
    #[inline(always)]
    pub fn dqdly6(&mut self) -> DQDLY6_W<DX2DQTRrs> {
        DQDLY6_W::new(self, 24)
    }
    ///Bits 28:31 - DQDLY7
    #[inline(always)]
    pub fn dqdly7(&mut self) -> DQDLY7_W<DX2DQTRrs> {
