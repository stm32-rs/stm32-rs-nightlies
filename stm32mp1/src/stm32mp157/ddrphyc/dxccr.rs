...
impl W {
    ///Bit 0 - DXODT
    #[inline(always)]
    pub fn dxodt(&mut self) -> DXODT_W<DXCCRrs> {
        DXODT_W::new(self, 0)
    }
    ///Bit 1 - DXIOM
    #[inline(always)]
    pub fn dxiom(&mut self) -> DXIOM_W<DXCCRrs> {
        DXIOM_W::new(self, 1)
    }
    ///Bit 2 - DXPDD
    #[inline(always)]
    pub fn dxpdd(&mut self) -> DXPDD_W<DXCCRrs> {
        DXPDD_W::new(self, 2)
    }
    ///Bit 3 - DXPDR
    #[inline(always)]
    pub fn dxpdr(&mut self) -> DXPDR_W<DXCCRrs> {
        DXPDR_W::new(self, 3)
    }
    ///Bits 4:7 - DQSRES
    #[inline(always)]
    pub fn dqsres(&mut self) -> DQSRES_W<DXCCRrs> {
        DQSRES_W::new(self, 4)
    }
    ///Bits 8:11 - DQSNRES
    #[inline(always)]
    pub fn dqsnres(&mut self) -> DQSNRES_W<DXCCRrs> {
        DQSNRES_W::new(self, 8)
    }
    ///Bit 14 - DQSNRST
    #[inline(always)]
    pub fn dqsnrst(&mut self) -> DQSNRST_W<DXCCRrs> {
        DQSNRST_W::new(self, 14)
    }
    ///Bit 15 - RVSEL
    #[inline(always)]
    pub fn rvsel(&mut self) -> RVSEL_W<DXCCRrs> {
        RVSEL_W::new(self, 15)
    }
    ///Bit 16 - AWDT
    #[inline(always)]
    pub fn awdt(&mut self) -> AWDT_W<DXCCRrs> {
        AWDT_W::new(self, 16)
    }
}
