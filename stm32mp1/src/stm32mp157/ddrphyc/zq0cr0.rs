...
impl W {
    ///Bits 0:19 - ZDATA
    #[inline(always)]
    pub fn zdata(&mut self) -> ZDATA_W<ZQ0CR0rs> {
        ZDATA_W::new(self, 0)
    }
    ///Bit 28 - ZDEN
    #[inline(always)]
    pub fn zden(&mut self) -> ZDEN_W<ZQ0CR0rs> {
        ZDEN_W::new(self, 28)
    }
    ///Bit 29 - ZCALBYP
    #[inline(always)]
    pub fn zcalbyp(&mut self) -> ZCALBYP_W<ZQ0CR0rs> {
        ZCALBYP_W::new(self, 29)
    }
    ///Bit 30 - ZCAL
    #[inline(always)]
    pub fn zcal(&mut self) -> ZCAL_W<ZQ0CR0rs> {
        ZCAL_W::new(self, 30)
    }
    ///Bit 31 - ZQPD
    #[inline(always)]
    pub fn zqpd(&mut self) -> ZQPD_W<ZQ0CR0rs> {
        ZQPD_W::new(self, 31)
    }
}
