///Register `CH1DATINR` reader
pub type R = crate::R<CH1DATINRrs>;
///Register `CH1DATINR` writer
...
impl W {
    ///Bits 0:15 - INDAT0
    #[inline(always)]
    pub fn indat0(&mut self) -> INDAT0_W<'_, CH1DATINRrs> {
        INDAT0_W::new(self, 0)
    }
    ///Bits 16:31 - INDAT1
    #[inline(always)]
    pub fn indat1(&mut self) -> INDAT1_W<'_, CH1DATINRrs> {
        INDAT1_W::new(self, 16)
    }
}
/**This register contains 16-bit input data to be processed by DFSDM filter module.

You can [`read`](crate::Reg::read) this register and get [`ch1datinr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch1datinr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`ch1datinr::R`](R) reader structure
impl crate::Readable for CH1DATINRrs {}
///`write(|w| ..)` method takes [`ch1datinr::W`](W) writer structure
