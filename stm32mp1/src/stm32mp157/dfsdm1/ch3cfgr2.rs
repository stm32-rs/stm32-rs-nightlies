///Register `CH3CFGR2` reader
pub type R = crate::R<CH3CFGR2rs>;
///Register `CH3CFGR2` writer
...
impl W {
    ///Bits 3:7 - DTRBS
    #[inline(always)]
    pub fn dtrbs(&mut self) -> DTRBS_W<'_, CH3CFGR2rs> {
        DTRBS_W::new(self, 3)
    }
    ///Bits 8:31 - OFFSET
    #[inline(always)]
    pub fn offset(&mut self) -> OFFSET_W<'_, CH3CFGR2rs> {
        OFFSET_W::new(self, 8)
    }
}
...
///`read()` method returns [`ch3cfgr2::R`](R) reader structure
impl crate::Readable for CH3CFGR2rs {}
///`write(|w| ..)` method takes [`ch3cfgr2::W`](W) writer structure
