...
pub type R = crate::R<DFSDM_CH1AWSCDRrs>;
///Register `DFSDM_CH1AWSCDR` writer
pub type W = crate::W<DFSDM_CH1AWSCDRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_CH1AWSCDR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scdt(&mut self) -> SCDT_W<DFSDM_CH1AWSCDRrs> {
        SCDT_W::new(self, 0)
    }
    ///Bits 12:15 - BKSCD
    #[inline(always)]
    #[must_use]
    pub fn bkscd(&mut self) -> BKSCD_W<DFSDM_CH1AWSCDRrs> {
        BKSCD_W::new(self, 12)
    }
    ///Bits 16:20 - AWFOSR
    #[inline(always)]
    #[must_use]
    pub fn awfosr(&mut self) -> AWFOSR_W<DFSDM_CH1AWSCDRrs> {
        AWFOSR_W::new(self, 16)
    }
    ///Bits 22:23 - AWFORD
    #[inline(always)]
    #[must_use]
    pub fn awford(&mut self) -> AWFORD_W<DFSDM_CH1AWSCDRrs> {
...
pub struct DFSDM_CH1AWSCDRrs;
impl crate::RegisterSpec for DFSDM_CH1AWSCDRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_ch1awscdr::R`](R) reader structure
impl crate::Readable for DFSDM_CH1AWSCDRrs {}
///`write(|w| ..)` method takes [`dfsdm_ch1awscdr::W`](W) writer structure
impl crate::Writable for DFSDM_CH1AWSCDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CH1AWSCDR to value 0
impl crate::Resettable for DFSDM_CH1AWSCDRrs {
