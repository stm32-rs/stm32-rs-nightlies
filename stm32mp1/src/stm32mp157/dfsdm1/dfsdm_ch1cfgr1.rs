///Register `DFSDM_CH1CFGR1` reader
pub type R = crate::R<DFSDM_CH1CFGR1rs>;
///Register `DFSDM_CH1CFGR1` writer
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_ch1cfgr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_ch1cfgr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_CH1CFGR1)*/
pub struct DFSDM_CH1CFGR1rs;
impl crate::RegisterSpec for DFSDM_CH1CFGR1rs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_ch1cfgr1::R`](R) reader structure
impl crate::Readable for DFSDM_CH1CFGR1rs {}
///`write(|w| ..)` method takes [`dfsdm_ch1cfgr1::W`](W) writer structure
impl crate::Writable for DFSDM_CH1CFGR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CH1CFGR1 to value 0
