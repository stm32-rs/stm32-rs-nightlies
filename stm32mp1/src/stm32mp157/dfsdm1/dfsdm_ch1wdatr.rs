///Register `DFSDM_CH1WDATR` reader
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_ch1wdatr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_CH1WDATR)*/
pub struct DFSDM_CH1WDATRrs;
impl crate::RegisterSpec for DFSDM_CH1WDATRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_ch1wdatr::R`](R) reader structure
impl crate::Readable for DFSDM_CH1WDATRrs {}
///`reset()` method sets DFSDM_CH1WDATR to value 0
