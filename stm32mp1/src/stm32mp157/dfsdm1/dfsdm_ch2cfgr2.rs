#[doc = "Reader of register DFSDM_CH2CFGR2"]
pub type R = crate::R<u32, super::DFSDM_CH2CFGR2>;
#[doc = "Writer for register DFSDM_CH2CFGR2"]
pub type W = crate::W<u32, super::DFSDM_CH2CFGR2>;
#[doc = "Register DFSDM_CH2CFGR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM_CH2CFGR2 {
    type Type = u32;
    #[inline(always)]
