///Register `DFSDM_CH4AWSCDR` reader
pub type R = crate::R<DFSDM_CH4AWSCDRrs>;
///Register `DFSDM_CH4AWSCDR` writer
pub type W = crate::W<DFSDM_CH4AWSCDRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_CH4AWSCDR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scdt(&mut self) -> SCDT_W<DFSDM_CH4AWSCDRrs> {
        SCDT_W::new(self, 0)
    }
    ///Bits 12:15 - BKSCD
    #[inline(always)]
    #[must_use]
    pub fn bkscd(&mut self) -> BKSCD_W<DFSDM_CH4AWSCDRrs> {
        BKSCD_W::new(self, 12)
    }
    ///Bits 16:20 - AWFOSR
    #[inline(always)]
    #[must_use]
    pub fn awfosr(&mut self) -> AWFOSR_W<DFSDM_CH4AWSCDRrs> {
        AWFOSR_W::new(self, 16)
    }
    ///Bits 22:23 - AWFORD
    #[inline(always)]
    #[must_use]
    pub fn awford(&mut self) -> AWFORD_W<DFSDM_CH4AWSCDRrs> {
        AWFORD_W::new(self, 22)
    }
}
/**Short-circuit detector and analog watchdog settings for channel y.

You can [`read`](crate::Reg::read) this register and get [`dfsdm_ch4awscdr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_ch4awscdr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_CH4AWSCDR)*/
pub struct DFSDM_CH4AWSCDRrs;
impl crate::RegisterSpec for DFSDM_CH4AWSCDRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_ch4awscdr::R`](R) reader structure
impl crate::Readable for DFSDM_CH4AWSCDRrs {}
///`write(|w| ..)` method takes [`dfsdm_ch4awscdr::W`](W) writer structure
impl crate::Writable for DFSDM_CH4AWSCDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CH4AWSCDR to value 0
impl crate::Resettable for DFSDM_CH4AWSCDRrs {
