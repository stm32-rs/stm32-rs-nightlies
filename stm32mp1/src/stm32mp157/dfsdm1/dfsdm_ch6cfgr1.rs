///Register `DFSDM_CH6CFGR1` reader
pub type R = crate::R<DFSDM_CH6CFGR1rs>;
///Register `DFSDM_CH6CFGR1` writer
pub type W = crate::W<DFSDM_CH6CFGR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sitp(&mut self) -> SITP_W<DFSDM_CH6CFGR1rs> {
        SITP_W::new(self, 0)
    }
    ///Bits 2:3 - SPICKSEL
    #[inline(always)]
    #[must_use]
    pub fn spicksel(&mut self) -> SPICKSEL_W<DFSDM_CH6CFGR1rs> {
        SPICKSEL_W::new(self, 2)
    }
    ///Bit 5 - SCDEN
    #[inline(always)]
    #[must_use]
    pub fn scden(&mut self) -> SCDEN_W<DFSDM_CH6CFGR1rs> {
        SCDEN_W::new(self, 5)
    }
    ///Bit 6 - CKABEN
    #[inline(always)]
    #[must_use]
    pub fn ckaben(&mut self) -> CKABEN_W<DFSDM_CH6CFGR1rs> {
        CKABEN_W::new(self, 6)
    }
    ///Bit 7 - CHEN
    #[inline(always)]
    #[must_use]
    pub fn chen(&mut self) -> CHEN_W<DFSDM_CH6CFGR1rs> {
        CHEN_W::new(self, 7)
    }
    ///Bit 8 - CHINSEL
    #[inline(always)]
    #[must_use]
    pub fn chinsel(&mut self) -> CHINSEL_W<DFSDM_CH6CFGR1rs> {
        CHINSEL_W::new(self, 8)
    }
    ///Bits 12:13 - DATMPX
    #[inline(always)]
    #[must_use]
    pub fn datmpx(&mut self) -> DATMPX_W<DFSDM_CH6CFGR1rs> {
        DATMPX_W::new(self, 12)
    }
    ///Bits 14:15 - DATPACK
    #[inline(always)]
    #[must_use]
    pub fn datpack(&mut self) -> DATPACK_W<DFSDM_CH6CFGR1rs> {
        DATPACK_W::new(self, 14)
    }
    ///Bits 16:23 - CKOUTDIV
    #[inline(always)]
    #[must_use]
    pub fn ckoutdiv(&mut self) -> CKOUTDIV_W<DFSDM_CH6CFGR1rs> {
        CKOUTDIV_W::new(self, 16)
    }
    ///Bit 30 - CKOUTSRC
    #[inline(always)]
    #[must_use]
    pub fn ckoutsrc(&mut self) -> CKOUTSRC_W<DFSDM_CH6CFGR1rs> {
        CKOUTSRC_W::new(self, 30)
    }
    ///Bit 31 - DFSDMEN
    #[inline(always)]
    #[must_use]
    pub fn dfsdmen(&mut self) -> DFSDMEN_W<DFSDM_CH6CFGR1rs> {
        DFSDMEN_W::new(self, 31)
    }
}
/**This register specifies the parameters used by channel y.

You can [`read`](crate::Reg::read) this register and get [`dfsdm_ch6cfgr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_ch6cfgr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_CH6CFGR1)*/
pub struct DFSDM_CH6CFGR1rs;
impl crate::RegisterSpec for DFSDM_CH6CFGR1rs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_ch6cfgr1::R`](R) reader structure
impl crate::Readable for DFSDM_CH6CFGR1rs {}
///`write(|w| ..)` method takes [`dfsdm_ch6cfgr1::W`](W) writer structure
impl crate::Writable for DFSDM_CH6CFGR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_CH6CFGR1 to value 0
impl crate::Resettable for DFSDM_CH6CFGR1rs {
