...
#[doc = "Writer for register DFSDM_FLT0EXMIN"]
pub type W = crate::W<u32, super::DFSDM_FLT0EXMIN>;
#[doc = "Register DFSDM_FLT0EXMIN `reset()`'s with value 0x7fff_ff00"]
impl crate::ResetValue for super::DFSDM_FLT0EXMIN {
    type Type = u32;
    #[inline(always)]
