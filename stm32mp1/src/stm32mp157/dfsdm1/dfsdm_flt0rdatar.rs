///Register `DFSDM_FLT0RDATAR` reader
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT0RDATAR")
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT0RDATAR)*/
pub struct DFSDM_FLT0RDATARrs;
impl crate::RegisterSpec for DFSDM_FLT0RDATARrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt0rdatar::R`](R) reader structure
impl crate::Readable for DFSDM_FLT0RDATARrs {}
///`reset()` method sets DFSDM_FLT0RDATAR to value 0
