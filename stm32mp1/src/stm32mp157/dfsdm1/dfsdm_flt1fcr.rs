///Register `DFSDM_FLT1FCR` reader
pub type R = crate::R<DFSDM_FLT1FCRrs>;
///Register `DFSDM_FLT1FCR` writer
pub type W = crate::W<DFSDM_FLT1FCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iosr(&mut self) -> IOSR_W<DFSDM_FLT1FCRrs> {
        IOSR_W::new(self, 0)
    }
    ///Bits 16:25 - FOSR
    #[inline(always)]
    #[must_use]
    pub fn fosr(&mut self) -> FOSR_W<DFSDM_FLT1FCRrs> {
        FOSR_W::new(self, 16)
    }
    ///Bits 29:31 - FORD
    #[inline(always)]
    #[must_use]
    pub fn ford(&mut self) -> FORD_W<DFSDM_FLT1FCRrs> {
        FORD_W::new(self, 29)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT1FCR)*/
pub struct DFSDM_FLT1FCRrs;
impl crate::RegisterSpec for DFSDM_FLT1FCRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt1fcr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT1FCRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt1fcr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT1FCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT1FCR to value 0
impl crate::Resettable for DFSDM_FLT1FCRrs {
