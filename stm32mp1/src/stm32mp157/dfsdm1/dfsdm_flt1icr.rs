///Register `DFSDM_FLT1ICR` reader
pub type R = crate::R<DFSDM_FLT1ICRrs>;
///Register `DFSDM_FLT1ICR` writer
pub type W = crate::W<DFSDM_FLT1ICRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrjovrf(&mut self) -> CLRJOVRF_W<DFSDM_FLT1ICRrs> {
        CLRJOVRF_W::new(self, 2)
    }
    ///Bit 3 - CLRROVRF
    #[inline(always)]
    #[must_use]
    pub fn clrrovrf(&mut self) -> CLRROVRF_W<DFSDM_FLT1ICRrs> {
        CLRROVRF_W::new(self, 3)
    }
    ///Bits 16:23 - CLRCKABF
    #[inline(always)]
    #[must_use]
    pub fn clrckabf(&mut self) -> CLRCKABF_W<DFSDM_FLT1ICRrs> {
        CLRCKABF_W::new(self, 16)
    }
    ///Bits 24:31 - CLRSCDF
    #[inline(always)]
    #[must_use]
    pub fn clrscdf(&mut self) -> CLRSCDF_W<DFSDM_FLT1ICRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT1ICR)*/
pub struct DFSDM_FLT1ICRrs;
impl crate::RegisterSpec for DFSDM_FLT1ICRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt1icr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT1ICRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt1icr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT1ICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT1ICR to value 0
impl crate::Resettable for DFSDM_FLT1ICRrs {
