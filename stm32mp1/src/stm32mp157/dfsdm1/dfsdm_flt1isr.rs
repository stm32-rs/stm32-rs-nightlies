///Register `DFSDM_FLT1ISR` reader
pub type R = crate::R<DFSDM_FLT1ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt1isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT1ISR)*/
pub struct DFSDM_FLT1ISRrs;
impl crate::RegisterSpec for DFSDM_FLT1ISRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt1isr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT1ISRrs {}
///`reset()` method sets DFSDM_FLT1ISR to value 0x00ff_0000
impl crate::Resettable for DFSDM_FLT1ISRrs {
