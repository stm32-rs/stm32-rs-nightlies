///Register `DFSDM_FLT1JDATAR` reader
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT1JDATAR")
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT1JDATAR)*/
pub struct DFSDM_FLT1JDATARrs;
impl crate::RegisterSpec for DFSDM_FLT1JDATARrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt1jdatar::R`](R) reader structure
impl crate::Readable for DFSDM_FLT1JDATARrs {}
///`reset()` method sets DFSDM_FLT1JDATAR to value 0
