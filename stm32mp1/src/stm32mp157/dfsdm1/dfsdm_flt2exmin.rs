...
#[doc = "Writer for register DFSDM_FLT2EXMIN"]
pub type W = crate::W<u32, super::DFSDM_FLT2EXMIN>;
#[doc = "Register DFSDM_FLT2EXMIN `reset()`'s with value 0x7fff_ff00"]
impl crate::ResetValue for super::DFSDM_FLT2EXMIN {
    type Type = u32;
    #[inline(always)]
