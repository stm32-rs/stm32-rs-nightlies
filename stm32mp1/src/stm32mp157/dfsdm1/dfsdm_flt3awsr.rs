///Register `DFSDM_FLT3AWSR` reader
pub type R = crate::R<DFSDM_FLT3AWSRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT3AWSR)*/
pub struct DFSDM_FLT3AWSRrs;
impl crate::RegisterSpec for DFSDM_FLT3AWSRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt3awsr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT3AWSRrs {}
///`reset()` method sets DFSDM_FLT3AWSR to value 0
impl crate::Resettable for DFSDM_FLT3AWSRrs {
