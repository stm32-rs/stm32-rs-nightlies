///Register `DFSDM_FLT4AWSR` reader
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt4awsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT4AWSR)*/
pub struct DFSDM_FLT4AWSRrs;
impl crate::RegisterSpec for DFSDM_FLT4AWSRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt4awsr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT4AWSRrs {}
///`reset()` method sets DFSDM_FLT4AWSR to value 0
