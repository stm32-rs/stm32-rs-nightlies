#[doc = "Reader of register DFSDM_FLT4FCR"]
pub type R = crate::R<u32, super::DFSDM_FLT4FCR>;
#[doc = "Writer for register DFSDM_FLT4FCR"]
pub type W = crate::W<u32, super::DFSDM_FLT4FCR>;
#[doc = "Register DFSDM_FLT4FCR `reset()`'s with value 0"]
impl crate::ResetValue for super::DFSDM_FLT4FCR {
    type Type = u32;
    #[inline(always)]
