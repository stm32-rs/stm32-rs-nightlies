///Register `DFSDM_FLT4ISR` reader
pub type R = crate::R<DFSDM_FLT4ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt4isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT4ISR)*/
pub struct DFSDM_FLT4ISRrs;
impl crate::RegisterSpec for DFSDM_FLT4ISRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt4isr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT4ISRrs {}
///`reset()` method sets DFSDM_FLT4ISR to value 0x00ff_0000
impl crate::Resettable for DFSDM_FLT4ISRrs {
