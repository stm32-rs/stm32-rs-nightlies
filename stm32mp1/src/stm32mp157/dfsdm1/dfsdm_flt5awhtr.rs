///Register `DFSDM_FLT5AWHTR` reader
pub type R = crate::R<DFSDM_FLT5AWHTRrs>;
///Register `DFSDM_FLT5AWHTR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT5AWHTR")
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt5awhtr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_flt5awhtr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT5AWHTR)*/
pub struct DFSDM_FLT5AWHTRrs;
impl crate::RegisterSpec for DFSDM_FLT5AWHTRrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt5awhtr::R`](R) reader structure
impl crate::Readable for DFSDM_FLT5AWHTRrs {}
///`write(|w| ..)` method takes [`dfsdm_flt5awhtr::W`](W) writer structure
impl crate::Writable for DFSDM_FLT5AWHTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT5AWHTR to value 0
