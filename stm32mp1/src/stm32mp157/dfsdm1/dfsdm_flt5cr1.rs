///Register `DFSDM_FLT5CR1` reader
pub type R = crate::R<DFSDM_FLT5CR1rs>;
///Register `DFSDM_FLT5CR1` writer
pub type W = crate::W<DFSDM_FLT5CR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfen(&mut self) -> DFEN_W<DFSDM_FLT5CR1rs> {
        DFEN_W::new(self, 0)
    }
    ///Bit 1 - JSWSTART
    #[inline(always)]
    #[must_use]
    pub fn jswstart(&mut self) -> JSWSTART_W<DFSDM_FLT5CR1rs> {
        JSWSTART_W::new(self, 1)
    }
    ///Bit 3 - JSYNC
    #[inline(always)]
    #[must_use]
    pub fn jsync(&mut self) -> JSYNC_W<DFSDM_FLT5CR1rs> {
        JSYNC_W::new(self, 3)
    }
    ///Bit 4 - JSCAN
    #[inline(always)]
    #[must_use]
    pub fn jscan(&mut self) -> JSCAN_W<DFSDM_FLT5CR1rs> {
        JSCAN_W::new(self, 4)
    }
    ///Bit 5 - JDMAEN
    #[inline(always)]
    #[must_use]
    pub fn jdmaen(&mut self) -> JDMAEN_W<DFSDM_FLT5CR1rs> {
        JDMAEN_W::new(self, 5)
    }
    ///Bits 8:12 - JEXTSEL
    #[inline(always)]
    #[must_use]
    pub fn jextsel(&mut self) -> JEXTSEL_W<DFSDM_FLT5CR1rs> {
        JEXTSEL_W::new(self, 8)
    }
    ///Bits 13:14 - JEXTEN
    #[inline(always)]
    #[must_use]
    pub fn jexten(&mut self) -> JEXTEN_W<DFSDM_FLT5CR1rs> {
        JEXTEN_W::new(self, 13)
    }
    ///Bit 17 - RSWSTART
    #[inline(always)]
    #[must_use]
    pub fn rswstart(&mut self) -> RSWSTART_W<DFSDM_FLT5CR1rs> {
        RSWSTART_W::new(self, 17)
    }
    ///Bit 18 - RCONT
    #[inline(always)]
    #[must_use]
    pub fn rcont(&mut self) -> RCONT_W<DFSDM_FLT5CR1rs> {
        RCONT_W::new(self, 18)
    }
    ///Bit 19 - RSYNC
    #[inline(always)]
    #[must_use]
    pub fn rsync(&mut self) -> RSYNC_W<DFSDM_FLT5CR1rs> {
        RSYNC_W::new(self, 19)
    }
    ///Bit 21 - RDMAEN
    #[inline(always)]
    #[must_use]
    pub fn rdmaen(&mut self) -> RDMAEN_W<DFSDM_FLT5CR1rs> {
        RDMAEN_W::new(self, 21)
    }
    ///Bits 24:26 - RCH
    #[inline(always)]
    #[must_use]
    pub fn rch(&mut self) -> RCH_W<DFSDM_FLT5CR1rs> {
        RCH_W::new(self, 24)
    }
    ///Bit 29 - FAST
    #[inline(always)]
    #[must_use]
    pub fn fast(&mut self) -> FAST_W<DFSDM_FLT5CR1rs> {
        FAST_W::new(self, 29)
    }
    ///Bit 30 - AWFSEL
    #[inline(always)]
    #[must_use]
    pub fn awfsel(&mut self) -> AWFSEL_W<DFSDM_FLT5CR1rs> {
        AWFSEL_W::new(self, 30)
    }
}
/**DFSDM filter 5 control register 1

You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt5cr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dfsdm_flt5cr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT5CR1)*/
pub struct DFSDM_FLT5CR1rs;
impl crate::RegisterSpec for DFSDM_FLT5CR1rs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt5cr1::R`](R) reader structure
impl crate::Readable for DFSDM_FLT5CR1rs {}
///`write(|w| ..)` method takes [`dfsdm_flt5cr1::W`](W) writer structure
impl crate::Writable for DFSDM_FLT5CR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DFSDM_FLT5CR1 to value 0
impl crate::Resettable for DFSDM_FLT5CR1rs {
