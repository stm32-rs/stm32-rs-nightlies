///Register `DFSDM_FLT5EXMAX` reader
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DFSDM_FLT5EXMAX")
...
You can [`read`](crate::Reg::read) this register and get [`dfsdm_flt5exmax::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:DFSDM_FLT5EXMAX)*/
pub struct DFSDM_FLT5EXMAXrs;
impl crate::RegisterSpec for DFSDM_FLT5EXMAXrs {
    type Ux = u32;
}
///`read()` method returns [`dfsdm_flt5exmax::R`](R) reader structure
impl crate::Readable for DFSDM_FLT5EXMAXrs {}
///`reset()` method sets DFSDM_FLT5EXMAX to value 0x8000_0000
