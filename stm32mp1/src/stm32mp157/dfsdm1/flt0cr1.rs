...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfen(&mut self) -> DFEN_W<FLT0CR1rs> {
        DFEN_W::new(self, 0)
    }
    ///Bit 1 - JSWSTART
    #[inline(always)]
    #[must_use]
    pub fn jswstart(&mut self) -> JSWSTART_W<FLT0CR1rs> {
        JSWSTART_W::new(self, 1)
    }
    ///Bit 3 - JSYNC
    #[inline(always)]
    #[must_use]
    pub fn jsync(&mut self) -> JSYNC_W<FLT0CR1rs> {
        JSYNC_W::new(self, 3)
    }
    ///Bit 4 - JSCAN
    #[inline(always)]
    #[must_use]
    pub fn jscan(&mut self) -> JSCAN_W<FLT0CR1rs> {
        JSCAN_W::new(self, 4)
    }
    ///Bit 5 - JDMAEN
    #[inline(always)]
    #[must_use]
    pub fn jdmaen(&mut self) -> JDMAEN_W<FLT0CR1rs> {
        JDMAEN_W::new(self, 5)
    }
    ///Bits 8:12 - JEXTSEL
    #[inline(always)]
    #[must_use]
    pub fn jextsel(&mut self) -> JEXTSEL_W<FLT0CR1rs> {
        JEXTSEL_W::new(self, 8)
    }
    ///Bits 13:14 - JEXTEN
    #[inline(always)]
    #[must_use]
    pub fn jexten(&mut self) -> JEXTEN_W<FLT0CR1rs> {
        JEXTEN_W::new(self, 13)
    }
    ///Bit 17 - RSWSTART
    #[inline(always)]
    #[must_use]
    pub fn rswstart(&mut self) -> RSWSTART_W<FLT0CR1rs> {
        RSWSTART_W::new(self, 17)
    }
    ///Bit 18 - RCONT
    #[inline(always)]
    #[must_use]
    pub fn rcont(&mut self) -> RCONT_W<FLT0CR1rs> {
        RCONT_W::new(self, 18)
    }
    ///Bit 19 - RSYNC
    #[inline(always)]
    #[must_use]
    pub fn rsync(&mut self) -> RSYNC_W<FLT0CR1rs> {
        RSYNC_W::new(self, 19)
    }
    ///Bit 21 - RDMAEN
    #[inline(always)]
    #[must_use]
    pub fn rdmaen(&mut self) -> RDMAEN_W<FLT0CR1rs> {
        RDMAEN_W::new(self, 21)
    }
    ///Bits 24:26 - RCH
    #[inline(always)]
    #[must_use]
    pub fn rch(&mut self) -> RCH_W<FLT0CR1rs> {
        RCH_W::new(self, 24)
    }
    ///Bit 29 - FAST
    #[inline(always)]
    #[must_use]
    pub fn fast(&mut self) -> FAST_W<FLT0CR1rs> {
        FAST_W::new(self, 29)
    }
    ///Bit 30 - AWFSEL
    #[inline(always)]
    #[must_use]
    pub fn awfsel(&mut self) -> AWFSEL_W<FLT0CR1rs> {
