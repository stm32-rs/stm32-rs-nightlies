...
impl W {
    ///Bit 2 - CLRJOVRF
    #[inline(always)]
    pub fn clrjovrf(&mut self) -> CLRJOVRF_W<'_, FLT4ICRrs> {
        CLRJOVRF_W::new(self, 2)
    }
    ///Bit 3 - CLRROVRF
    #[inline(always)]
    pub fn clrrovrf(&mut self) -> CLRROVRF_W<'_, FLT4ICRrs> {
        CLRROVRF_W::new(self, 3)
    }
    ///Bits 16:23 - CLRCKABF
    #[inline(always)]
    pub fn clrckabf(&mut self) -> CLRCKABF_W<'_, FLT4ICRrs> {
        CLRCKABF_W::new(self, 16)
    }
    ///Bits 24:31 - CLRSCDF
    #[inline(always)]
    pub fn clrscdf(&mut self) -> CLRSCDF_W<'_, FLT4ICRrs> {
