///Register `FLT4ISR` reader
pub type R = crate::R<FLT4ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`flt4isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:FLT4ISR)*/
pub struct FLT4ISRrs;
impl crate::RegisterSpec for FLT4ISRrs {
    type Ux = u32;
}
///`read()` method returns [`flt4isr::R`](R) reader structure
impl crate::Readable for FLT4ISRrs {}
///`reset()` method sets FLT4ISR to value 0x00ff_0000
impl crate::Resettable for FLT4ISRrs {
