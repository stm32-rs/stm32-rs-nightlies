///Register `FLT5ICR` reader
pub type R = crate::R<FLT5ICRrs>;
///Register `FLT5ICR` writer
pub type W = crate::W<FLT5ICRrs>;
...
impl W {
    ///Bit 2 - CLRJOVRF
    #[inline(always)]
    pub fn clrjovrf(&mut self) -> CLRJOVRF_W<'_, FLT5ICRrs> {
        CLRJOVRF_W::new(self, 2)
    }
    ///Bit 3 - CLRROVRF
    #[inline(always)]
    pub fn clrrovrf(&mut self) -> CLRROVRF_W<'_, FLT5ICRrs> {
        CLRROVRF_W::new(self, 3)
    }
    ///Bits 16:23 - CLRCKABF
    #[inline(always)]
    pub fn clrckabf(&mut self) -> CLRCKABF_W<'_, FLT5ICRrs> {
        CLRCKABF_W::new(self, 16)
    }
    ///Bits 24:31 - CLRSCDF
    #[inline(always)]
    pub fn clrscdf(&mut self) -> CLRSCDF_W<'_, FLT5ICRrs> {
        CLRSCDF_W::new(self, 24)
    }
}
/**DFSDM filter 5 interrupt flag clear register

You can [`read`](crate::Reg::read) this register and get [`flt5icr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flt5icr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:FLT5ICR)*/
pub struct FLT5ICRrs;
impl crate::RegisterSpec for FLT5ICRrs {
    type Ux = u32;
}
///`read()` method returns [`flt5icr::R`](R) reader structure
impl crate::Readable for FLT5ICRrs {}
///`write(|w| ..)` method takes [`flt5icr::W`](W) writer structure
impl crate::Writable for FLT5ICRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets FLT5ICR to value 0
impl crate::Resettable for FLT5ICRrs {}
