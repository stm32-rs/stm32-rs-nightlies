...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrjovrf(&mut self) -> CLRJOVRF_W<FLT5ICRrs> {
        CLRJOVRF_W::new(self, 2)
    }
    ///Bit 3 - CLRROVRF
    #[inline(always)]
    #[must_use]
    pub fn clrrovrf(&mut self) -> CLRROVRF_W<FLT5ICRrs> {
        CLRROVRF_W::new(self, 3)
    }
    ///Bits 16:23 - CLRCKABF
    #[inline(always)]
    #[must_use]
    pub fn clrckabf(&mut self) -> CLRCKABF_W<FLT5ICRrs> {
        CLRCKABF_W::new(self, 16)
    }
    ///Bits 24:31 - CLRSCDF
    #[inline(always)]
    #[must_use]
    pub fn clrscdf(&mut self) -> CLRSCDF_W<FLT5ICRrs> {
