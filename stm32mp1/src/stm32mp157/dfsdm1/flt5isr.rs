///Register `FLT5ISR` reader
pub type R = crate::R<FLT5ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`flt5isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DFSDM1:FLT5ISR)*/
pub struct FLT5ISRrs;
impl crate::RegisterSpec for FLT5ISRrs {
    type Ux = u32;
}
///`read()` method returns [`flt5isr::R`](R) reader structure
impl crate::Readable for FLT5ISRrs {}
///`reset()` method sets FLT5ISR to value 0x00ff_0000
impl crate::Resettable for FLT5ISRrs {
