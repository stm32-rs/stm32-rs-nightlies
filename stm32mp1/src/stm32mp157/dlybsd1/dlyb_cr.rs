#[doc = "Reader of register DLYB_CR"]
pub type R = crate::R<u32, super::DLYB_CR>;
#[doc = "Writer for register DLYB_CR"]
pub type W = crate::W<u32, super::DLYB_CR>;
#[doc = "Register DLYB_CR `reset()`'s with value 0"]
impl crate::ResetValue for super::DLYB_CR {
    type Type = u32;
    #[inline(always)]
