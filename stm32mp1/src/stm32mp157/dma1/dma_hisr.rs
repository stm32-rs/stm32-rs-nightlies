...
You can [`read`](crate::Reg::read) this register and get [`dma_hisr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dma_hisr::R`](R) reader structure
impl crate::Readable for DMA_HISRrs {}
///`reset()` method sets DMA_HISR to value 0
