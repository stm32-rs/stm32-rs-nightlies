///Register `DMA_S0CR` reader
pub type R = crate::R<DMA_S0CRrs>;
///Register `DMA_S0CR` writer
pub type W = crate::W<DMA_S0CRrs>;
///Field `EN` reader - EN
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<DMA_S0CRrs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - DMEIE
    #[inline(always)]
    #[must_use]
    pub fn dmeie(&mut self) -> DMEIE_W<DMA_S0CRrs> {
        DMEIE_W::new(self, 1)
    }
    ///Bit 2 - TEIE
    #[inline(always)]
    #[must_use]
    pub fn teie(&mut self) -> TEIE_W<DMA_S0CRrs> {
        TEIE_W::new(self, 2)
    }
    ///Bit 3 - HTIE
    #[inline(always)]
    #[must_use]
    pub fn htie(&mut self) -> HTIE_W<DMA_S0CRrs> {
        HTIE_W::new(self, 3)
    }
    ///Bit 4 - TCIE
    #[inline(always)]
    #[must_use]
    pub fn tcie(&mut self) -> TCIE_W<DMA_S0CRrs> {
        TCIE_W::new(self, 4)
    }
    ///Bit 5 - PFCTRL
    #[inline(always)]
    #[must_use]
    pub fn pfctrl(&mut self) -> PFCTRL_W<DMA_S0CRrs> {
        PFCTRL_W::new(self, 5)
    }
    ///Bits 6:7 - DIR
    #[inline(always)]
    #[must_use]
    pub fn dir(&mut self) -> DIR_W<DMA_S0CRrs> {
        DIR_W::new(self, 6)
    }
    ///Bit 8 - CIRC
    #[inline(always)]
    #[must_use]
    pub fn circ(&mut self) -> CIRC_W<DMA_S0CRrs> {
        CIRC_W::new(self, 8)
    }
    ///Bit 9 - PINC
    #[inline(always)]
    #[must_use]
    pub fn pinc(&mut self) -> PINC_W<DMA_S0CRrs> {
        PINC_W::new(self, 9)
    }
    ///Bit 10 - MINC
    #[inline(always)]
    #[must_use]
    pub fn minc(&mut self) -> MINC_W<DMA_S0CRrs> {
        MINC_W::new(self, 10)
    }
    ///Bits 11:12 - PSIZE
    #[inline(always)]
    #[must_use]
    pub fn psize(&mut self) -> PSIZE_W<DMA_S0CRrs> {
        PSIZE_W::new(self, 11)
    }
    ///Bits 13:14 - MSIZE
    #[inline(always)]
    #[must_use]
    pub fn msize(&mut self) -> MSIZE_W<DMA_S0CRrs> {
        MSIZE_W::new(self, 13)
    }
    ///Bit 15 - PINCOS
    #[inline(always)]
    #[must_use]
    pub fn pincos(&mut self) -> PINCOS_W<DMA_S0CRrs> {
        PINCOS_W::new(self, 15)
    }
    ///Bits 16:17 - PL
    #[inline(always)]
    #[must_use]
    pub fn pl(&mut self) -> PL_W<DMA_S0CRrs> {
        PL_W::new(self, 16)
    }
    ///Bit 18 - DBM
    #[inline(always)]
    #[must_use]
    pub fn dbm(&mut self) -> DBM_W<DMA_S0CRrs> {
        DBM_W::new(self, 18)
    }
    ///Bit 19 - CT
    #[inline(always)]
    #[must_use]
    pub fn ct(&mut self) -> CT_W<DMA_S0CRrs> {
        CT_W::new(self, 19)
    }
    ///Bits 21:22 - PBURST
    #[inline(always)]
    #[must_use]
    pub fn pburst(&mut self) -> PBURST_W<DMA_S0CRrs> {
        PBURST_W::new(self, 21)
    }
    ///Bits 23:24 - MBURST
    #[inline(always)]
    #[must_use]
    pub fn mburst(&mut self) -> MBURST_W<DMA_S0CRrs> {
        MBURST_W::new(self, 23)
    }
}
/**This register is used to configure the concerned stream.

You can [`read`](crate::Reg::read) this register and get [`dma_s0cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_s0cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DMA1:DMA_S0CR)*/
pub struct DMA_S0CRrs;
impl crate::RegisterSpec for DMA_S0CRrs {
    type Ux = u32;
}
///`read()` method returns [`dma_s0cr::R`](R) reader structure
impl crate::Readable for DMA_S0CRrs {}
///`write(|w| ..)` method takes [`dma_s0cr::W`](W) writer structure
impl crate::Writable for DMA_S0CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMA_S0CR to value 0
impl crate::Resettable for DMA_S0CRrs {
