#[doc = "Reader of register DMA_S0FCR"]
pub type R = crate::R<u32, super::DMA_S0FCR>;
#[doc = "Writer for register DMA_S0FCR"]
pub type W = crate::W<u32, super::DMA_S0FCR>;
#[doc = "Register DMA_S0FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::DMA_S0FCR {
    type Type = u32;
    #[inline(always)]
