#[doc = "Reader of register DMA_S1FCR"]
pub type R = crate::R<u32, super::DMA_S1FCR>;
#[doc = "Writer for register DMA_S1FCR"]
pub type W = crate::W<u32, super::DMA_S1FCR>;
#[doc = "Register DMA_S1FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::DMA_S1FCR {
    type Type = u32;
    #[inline(always)]
