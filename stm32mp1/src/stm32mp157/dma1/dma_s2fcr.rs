#[doc = "Reader of register DMA_S2FCR"]
pub type R = crate::R<u32, super::DMA_S2FCR>;
#[doc = "Writer for register DMA_S2FCR"]
pub type W = crate::W<u32, super::DMA_S2FCR>;
#[doc = "Register DMA_S2FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::DMA_S2FCR {
    type Type = u32;
    #[inline(always)]
