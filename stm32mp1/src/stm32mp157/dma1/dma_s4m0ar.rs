///Register `DMA_S4M0AR` reader
pub type R = crate::R<DMA_S4M0ARrs>;
///Register `DMA_S4M0AR` writer
...
You can [`read`](crate::Reg::read) this register and get [`dma_s4m0ar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_s4m0ar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dma_s4m0ar::R`](R) reader structure
impl crate::Readable for DMA_S4M0ARrs {}
///`write(|w| ..)` method takes [`dma_s4m0ar::W`](W) writer structure
impl crate::Writable for DMA_S4M0ARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMA_S4M0AR to value 0
