#[doc = "Reader of register DMA_S6FCR"]
pub type R = crate::R<u32, super::DMA_S6FCR>;
#[doc = "Writer for register DMA_S6FCR"]
pub type W = crate::W<u32, super::DMA_S6FCR>;
#[doc = "Register DMA_S6FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::DMA_S6FCR {
    type Type = u32;
    #[inline(always)]
