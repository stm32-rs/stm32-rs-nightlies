...
pub type R = crate::R<DMA_S7FCRrs>;
///Register `DMA_S7FCR` writer
pub type W = crate::W<DMA_S7FCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fth(&mut self) -> FTH_W<DMA_S7FCRrs> {
        FTH_W::new(self, 0)
    }
    ///Bit 2 - DMDIS
    #[inline(always)]
    #[must_use]
    pub fn dmdis(&mut self) -> DMDIS_W<DMA_S7FCRrs> {
        DMDIS_W::new(self, 2)
    }
    ///Bit 7 - FEIE
    #[inline(always)]
    #[must_use]
    pub fn feie(&mut self) -> FEIE_W<DMA_S7FCRrs> {
        FEIE_W::new(self, 7)
    }
}
/**DMA stream 7 FIFO control register

You can [`read`](crate::Reg::read) this register and get [`dma_s7fcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_s7fcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DMA1:DMA_S7FCR)*/
pub struct DMA_S7FCRrs;
impl crate::RegisterSpec for DMA_S7FCRrs {
    type Ux = u32;
}
///`read()` method returns [`dma_s7fcr::R`](R) reader structure
impl crate::Readable for DMA_S7FCRrs {}
///`write(|w| ..)` method takes [`dma_s7fcr::W`](W) writer structure
impl crate::Writable for DMA_S7FCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMA_S7FCR to value 0x21
impl crate::Resettable for DMA_S7FCRrs {
