...
impl W {
    ...
    ///Bit 14 - CSOF14
    #[inline(always)]
    pub fn csof14(&mut self) -> CSOF14_W<CFRrs> {
        CSOF14_W::new(self, 14)
    }
    ///Bit 15 - CSOF15
    #[inline(always)]
    pub fn csof15(&mut self) -> CSOF15_W<CFRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DMAMUX1:CFR)*/
pub struct CFRrs;
