...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmareq_id(&mut self) -> DMAREQ_ID_W<DMAMUX_C1CRrs> {
        DMAREQ_ID_W::new(self, 0)
    }
    ///Bit 8 - SOIE
    #[inline(always)]
    #[must_use]
    pub fn soie(&mut self) -> SOIE_W<DMAMUX_C1CRrs> {
        SOIE_W::new(self, 8)
    }
    ///Bit 9 - EGE
    #[inline(always)]
    #[must_use]
    pub fn ege(&mut self) -> EGE_W<DMAMUX_C1CRrs> {
        EGE_W::new(self, 9)
    }
    ///Bit 16 - SE
    #[inline(always)]
    #[must_use]
    pub fn se(&mut self) -> SE_W<DMAMUX_C1CRrs> {
        SE_W::new(self, 16)
    }
    ///Bits 17:18 - SPOL
    #[inline(always)]
    #[must_use]
    pub fn spol(&mut self) -> SPOL_W<DMAMUX_C1CRrs> {
        SPOL_W::new(self, 17)
    }
    ///Bits 19:23 - NBREQ
    #[inline(always)]
    #[must_use]
    pub fn nbreq(&mut self) -> NBREQ_W<DMAMUX_C1CRrs> {
        NBREQ_W::new(self, 19)
    }
    ///Bits 24:26 - SYNC_ID
    #[inline(always)]
    #[must_use]
    pub fn sync_id(&mut self) -> SYNC_ID_W<DMAMUX_C1CRrs> {
