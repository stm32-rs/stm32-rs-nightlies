///Register `DMAMUX_RG0CR` reader
pub type R = crate::R<DMAMUX_RG0CRrs>;
///Register `DMAMUX_RG0CR` writer
pub type W = crate::W<DMAMUX_RG0CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sig_id(&mut self) -> SIG_ID_W<DMAMUX_RG0CRrs> {
        SIG_ID_W::new(self, 0)
    }
    ///Bit 8 - OIE
    #[inline(always)]
    #[must_use]
    pub fn oie(&mut self) -> OIE_W<DMAMUX_RG0CRrs> {
        OIE_W::new(self, 8)
    }
    ///Bit 16 - GE
    #[inline(always)]
    #[must_use]
    pub fn ge(&mut self) -> GE_W<DMAMUX_RG0CRrs> {
        GE_W::new(self, 16)
    }
    ///Bits 17:18 - GPOL
    #[inline(always)]
    #[must_use]
    pub fn gpol(&mut self) -> GPOL_W<DMAMUX_RG0CRrs> {
        GPOL_W::new(self, 17)
    }
    ///Bits 19:23 - GNBREQ
    #[inline(always)]
    #[must_use]
    pub fn gnbreq(&mut self) -> GNBREQ_W<DMAMUX_RG0CRrs> {
...
pub struct DMAMUX_RG0CRrs;
impl crate::RegisterSpec for DMAMUX_RG0CRrs {
    type Ux = u32;
}
///`read()` method returns [`dmamux_rg0cr::R`](R) reader structure
impl crate::Readable for DMAMUX_RG0CRrs {}
///`write(|w| ..)` method takes [`dmamux_rg0cr::W`](W) writer structure
impl crate::Writable for DMAMUX_RG0CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMAMUX_RG0CR to value 0
impl crate::Resettable for DMAMUX_RG0CRrs {
