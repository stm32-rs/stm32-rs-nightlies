///Register `DMAMUX_RG6CR` reader
pub type R = crate::R<DMAMUX_RG6CRrs>;
///Register `DMAMUX_RG6CR` writer
pub type W = crate::W<DMAMUX_RG6CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sig_id(&mut self) -> SIG_ID_W<DMAMUX_RG6CRrs> {
        SIG_ID_W::new(self, 0)
    }
    ///Bit 8 - OIE
    #[inline(always)]
    #[must_use]
    pub fn oie(&mut self) -> OIE_W<DMAMUX_RG6CRrs> {
        OIE_W::new(self, 8)
    }
    ///Bit 16 - GE
    #[inline(always)]
    #[must_use]
    pub fn ge(&mut self) -> GE_W<DMAMUX_RG6CRrs> {
        GE_W::new(self, 16)
    }
    ///Bits 17:18 - GPOL
    #[inline(always)]
    #[must_use]
    pub fn gpol(&mut self) -> GPOL_W<DMAMUX_RG6CRrs> {
        GPOL_W::new(self, 17)
    }
    ///Bits 19:23 - GNBREQ
    #[inline(always)]
    #[must_use]
    pub fn gnbreq(&mut self) -> GNBREQ_W<DMAMUX_RG6CRrs> {
        GNBREQ_W::new(self, 19)
    }
}
/**DMAMUX request generator channel 6 configuration register

You can [`read`](crate::Reg::read) this register and get [`dmamux_rg6cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmamux_rg6cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DMAMUX1:DMAMUX_RG6CR)*/
pub struct DMAMUX_RG6CRrs;
impl crate::RegisterSpec for DMAMUX_RG6CRrs {
    type Ux = u32;
}
///`read()` method returns [`dmamux_rg6cr::R`](R) reader structure
impl crate::Readable for DMAMUX_RG6CRrs {}
///`write(|w| ..)` method takes [`dmamux_rg6cr::W`](W) writer structure
impl crate::Writable for DMAMUX_RG6CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMAMUX_RG6CR to value 0
impl crate::Resettable for DMAMUX_RG6CRrs {
