...
pub type R = crate::R<RG3CRrs>;
///Register `RG3CR` writer
pub type W = crate::W<RG3CRrs>;
...
impl W {
    ///Bits 0:2 - SIG_ID
    #[inline(always)]
    pub fn sig_id(&mut self) -> SIG_ID_W<'_, RG3CRrs> {
        SIG_ID_W::new(self, 0)
    }
    ///Bit 8 - OIE
    #[inline(always)]
    pub fn oie(&mut self) -> OIE_W<'_, RG3CRrs> {
        OIE_W::new(self, 8)
    }
    ///Bit 16 - GE
    #[inline(always)]
    pub fn ge(&mut self) -> GE_W<'_, RG3CRrs> {
        GE_W::new(self, 16)
    }
    ///Bits 17:18 - GPOL
    #[inline(always)]
    pub fn gpol(&mut self) -> GPOL_W<'_, RG3CRrs> {
        GPOL_W::new(self, 17)
    }
    ///Bits 19:23 - GNBREQ
    #[inline(always)]
    pub fn gnbreq(&mut self) -> GNBREQ_W<'_, RG3CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DMAMUX1:RG3CR)*/
pub struct RG3CRrs;
impl crate::RegisterSpec for RG3CRrs {
    type Ux = u32;
}
///`read()` method returns [`rg3cr::R`](R) reader structure
impl crate::Readable for RG3CRrs {}
///`write(|w| ..)` method takes [`rg3cr::W`](W) writer structure
impl crate::Writable for RG3CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RG3CR to value 0
impl crate::Resettable for RG3CRrs {}
