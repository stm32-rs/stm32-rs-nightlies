///Register `RG5CR` reader
pub type R = crate::R<RG5CRrs>;
///Register `RG5CR` writer
pub type W = crate::W<RG5CRrs>;
...
impl W {
    ///Bits 0:2 - SIG_ID
    #[inline(always)]
    pub fn sig_id(&mut self) -> SIG_ID_W<'_, RG5CRrs> {
        SIG_ID_W::new(self, 0)
    }
    ///Bit 8 - OIE
    #[inline(always)]
    pub fn oie(&mut self) -> OIE_W<'_, RG5CRrs> {
        OIE_W::new(self, 8)
    }
    ///Bit 16 - GE
    #[inline(always)]
    pub fn ge(&mut self) -> GE_W<'_, RG5CRrs> {
        GE_W::new(self, 16)
    }
    ///Bits 17:18 - GPOL
    #[inline(always)]
    pub fn gpol(&mut self) -> GPOL_W<'_, RG5CRrs> {
        GPOL_W::new(self, 17)
    }
    ///Bits 19:23 - GNBREQ
    #[inline(always)]
    pub fn gnbreq(&mut self) -> GNBREQ_W<'_, RG5CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DMAMUX1:RG5CR)*/
pub struct RG5CRrs;
impl crate::RegisterSpec for RG5CRrs {
    type Ux = u32;
}
///`read()` method returns [`rg5cr::R`](R) reader structure
impl crate::Readable for RG5CRrs {}
///`write(|w| ..)` method takes [`rg5cr::W`](W) writer structure
impl crate::Writable for RG5CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RG5CR to value 0
impl crate::Resettable for RG5CRrs {}
