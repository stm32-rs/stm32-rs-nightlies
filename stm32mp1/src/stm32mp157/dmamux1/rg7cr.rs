///Register `RG7CR` reader
pub type R = crate::R<RG7CRrs>;
///Register `RG7CR` writer
pub type W = crate::W<RG7CRrs>;
...
impl W {
    ///Bits 0:2 - SIG_ID
    #[inline(always)]
    pub fn sig_id(&mut self) -> SIG_ID_W<'_, RG7CRrs> {
        SIG_ID_W::new(self, 0)
    }
    ///Bit 8 - OIE
    #[inline(always)]
    pub fn oie(&mut self) -> OIE_W<'_, RG7CRrs> {
        OIE_W::new(self, 8)
    }
    ///Bit 16 - GE
    #[inline(always)]
    pub fn ge(&mut self) -> GE_W<'_, RG7CRrs> {
        GE_W::new(self, 16)
    }
    ///Bits 17:18 - GPOL
    #[inline(always)]
    pub fn gpol(&mut self) -> GPOL_W<'_, RG7CRrs> {
        GPOL_W::new(self, 17)
    }
    ///Bits 19:23 - GNBREQ
    #[inline(always)]
    pub fn gnbreq(&mut self) -> GNBREQ_W<'_, RG7CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#DMAMUX1:RG7CR)*/
pub struct RG7CRrs;
impl crate::RegisterSpec for RG7CRrs {
    type Ux = u32;
}
///`read()` method returns [`rg7cr::R`](R) reader structure
impl crate::Readable for RG7CRrs {}
///`write(|w| ..)` method takes [`rg7cr::W`](W) writer structure
impl crate::Writable for RG7CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RG7CR to value 0
impl crate::Resettable for RG7CRrs {}
