...
impl W {
    ///Bits 0:5 - DT
    #[inline(always)]
    pub fn dt(&mut self) -> DT_W<'_, GHCRrs> {
        DT_W::new(self, 0)
    }
    ///Bits 6:7 - VCID
    #[inline(always)]
    pub fn vcid(&mut self) -> VCID_W<'_, GHCRrs> {
        VCID_W::new(self, 6)
    }
    ///Bits 8:15 - WCLSB
    #[inline(always)]
    pub fn wclsb(&mut self) -> WCLSB_W<'_, GHCRrs> {
        WCLSB_W::new(self, 8)
    }
    ///Bits 16:23 - WCMSB
    #[inline(always)]
    pub fn wcmsb(&mut self) -> WCMSB_W<'_, GHCRrs> {
        WCMSB_W::new(self, 16)
    }
}
