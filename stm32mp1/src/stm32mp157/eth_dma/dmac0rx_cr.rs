...
impl W {
    ///Bit 0 - Start or Stop Receive Command
    #[inline(always)]
    pub fn sr(&mut self) -> SR_W<DMAC0RX_CRrs> {
        SR_W::new(self, 0)
    }
    ///Bits 1:14 - Receive Buffer size
    #[inline(always)]
    pub fn rbsz(&mut self) -> RBSZ_W<DMAC0RX_CRrs> {
        RBSZ_W::new(self, 1)
    }
    ///Bits 16:21 - RXPBL
    #[inline(always)]
    pub fn rxpbl(&mut self) -> RXPBL_W<DMAC0RX_CRrs> {
        RXPBL_W::new(self, 16)
    }
    ///Bits 24:27 - RQOS
    #[inline(always)]
    pub fn rqos(&mut self) -> RQOS_W<DMAC0RX_CRrs> {
        RQOS_W::new(self, 24)
    }
    ///Bit 31 - DMA Rx Channel Packet Flush
    #[inline(always)]
    pub fn rpf(&mut self) -> RPF_W<DMAC0RX_CRrs> {
        RPF_W::new(self, 31)
    }
}
