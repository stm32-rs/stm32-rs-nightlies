...
impl W {
    ///Bit 0 - ST
    #[inline(always)]
    pub fn st(&mut self) -> ST_W<DMAC0TX_CRrs> {
        ST_W::new(self, 0)
    }
    ///Bits 1:3 - TCW
    #[inline(always)]
    pub fn tcw(&mut self) -> TCW_W<DMAC0TX_CRrs> {
        TCW_W::new(self, 1)
    }
    ///Bit 4 - OSF
    #[inline(always)]
    pub fn osf(&mut self) -> OSF_W<DMAC0TX_CRrs> {
        OSF_W::new(self, 4)
    }
    ///Bit 12 - TSE
    #[inline(always)]
    pub fn tse(&mut self) -> TSE_W<DMAC0TX_CRrs> {
        TSE_W::new(self, 12)
    }
    ///Bits 16:21 - TXPBL
    #[inline(always)]
    pub fn txpbl(&mut self) -> TXPBL_W<DMAC0TX_CRrs> {
        TXPBL_W::new(self, 16)
    }
    ///Bits 24:27 - TQOS
    #[inline(always)]
    pub fn tqos(&mut self) -> TQOS_W<DMAC0TX_CRrs> {
        TQOS_W::new(self, 24)
    }
}
