#[doc = "Reader of register ETH_DMAC0RxCR"]
pub type R = crate::R<u32, super::ETH_DMAC0RXCR>;
#[doc = "Writer for register ETH_DMAC0RxCR"]
pub type W = crate::W<u32, super::ETH_DMAC0RXCR>;
#[doc = "Register ETH_DMAC0RxCR `reset()`'s with value 0x8000"]
impl crate::ResetValue for super::ETH_DMAC0RXCR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `RQOS`"]
pub type RQOS_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `RQOS`"]
pub struct RQOS_W<'a> {
    w: &'a mut W,
}
impl<'a> RQOS_W<'a> {
