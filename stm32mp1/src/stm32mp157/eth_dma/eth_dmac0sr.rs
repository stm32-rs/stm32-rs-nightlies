...
pub type R = crate::R<ETH_DMAC0SRrs>;
///Register `ETH_DMAC0SR` writer
pub type W = crate::W<ETH_DMAC0SRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ti(&mut self) -> TI_W<ETH_DMAC0SRrs> {
        TI_W::new(self, 0)
    }
    ///Bit 1 - Transmit Process Stopped
    #[inline(always)]
    #[must_use]
    pub fn tps(&mut self) -> TPS_W<ETH_DMAC0SRrs> {
        TPS_W::new(self, 1)
    }
    ///Bit 2 - Transmit Buffer Unavailable
    #[inline(always)]
    #[must_use]
    pub fn tbu(&mut self) -> TBU_W<ETH_DMAC0SRrs> {
        TBU_W::new(self, 2)
    }
    ///Bit 6 - Receive Interrupt
    #[inline(always)]
    #[must_use]
    pub fn ri(&mut self) -> RI_W<ETH_DMAC0SRrs> {
        RI_W::new(self, 6)
    }
    ///Bit 7 - Receive Buffer Unavailable
    #[inline(always)]
    #[must_use]
    pub fn rbu(&mut self) -> RBU_W<ETH_DMAC0SRrs> {
        RBU_W::new(self, 7)
    }
    ///Bit 8 - Receive Process Stopped
    #[inline(always)]
    #[must_use]
    pub fn rps(&mut self) -> RPS_W<ETH_DMAC0SRrs> {
        RPS_W::new(self, 8)
    }
    ///Bit 9 - Receive Watchdog Timeout
    #[inline(always)]
    #[must_use]
    pub fn rwt(&mut self) -> RWT_W<ETH_DMAC0SRrs> {
        RWT_W::new(self, 9)
    }
    ///Bit 10 - Early Transmit Interrupt
    #[inline(always)]
    #[must_use]
    pub fn eti(&mut self) -> ETI_W<ETH_DMAC0SRrs> {
        ETI_W::new(self, 10)
    }
    ///Bit 11 - Early Receive Interrupt
    #[inline(always)]
    #[must_use]
    pub fn eri(&mut self) -> ERI_W<ETH_DMAC0SRrs> {
        ERI_W::new(self, 11)
    }
    ///Bit 12 - Fatal Bus Error
    #[inline(always)]
    #[must_use]
    pub fn fbe(&mut self) -> FBE_W<ETH_DMAC0SRrs> {
        FBE_W::new(self, 12)
    }
    ///Bit 13 - Context Descriptor Error
    #[inline(always)]
    #[must_use]
    pub fn cde(&mut self) -> CDE_W<ETH_DMAC0SRrs> {
        CDE_W::new(self, 13)
    }
    ///Bit 14 - Abnormal Interrupt Summary
    #[inline(always)]
    #[must_use]
    pub fn ais(&mut self) -> AIS_W<ETH_DMAC0SRrs> {
        AIS_W::new(self, 14)
    }
    ///Bit 15 - Normal Interrupt Summary
    #[inline(always)]
    #[must_use]
    pub fn nis(&mut self) -> NIS_W<ETH_DMAC0SRrs> {
        NIS_W::new(self, 15)
    }
    ///Bits 16:18 - Tx DMA Error Bits
    #[inline(always)]
    #[must_use]
    pub fn teb(&mut self) -> TEB_W<ETH_DMAC0SRrs> {
        TEB_W::new(self, 16)
    }
    ///Bits 19:21 - Rx DMA Error Bits
    #[inline(always)]
    #[must_use]
    pub fn reb(&mut self) -> REB_W<ETH_DMAC0SRrs> {
        REB_W::new(self, 19)
    }
}
/**Channel status register

You can [`read`](crate::Reg::read) this register and get [`eth_dmac0sr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_dmac0sr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_DMA:ETH_DMAC0SR)*/
pub struct ETH_DMAC0SRrs;
impl crate::RegisterSpec for ETH_DMAC0SRrs {
    type Ux = u32;
}
///`read()` method returns [`eth_dmac0sr::R`](R) reader structure
impl crate::Readable for ETH_DMAC0SRrs {}
///`write(|w| ..)` method takes [`eth_dmac0sr::W`](W) writer structure
impl crate::Writable for ETH_DMAC0SRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_DMAC0SR to value 0
impl crate::Resettable for ETH_DMAC0SRrs {
