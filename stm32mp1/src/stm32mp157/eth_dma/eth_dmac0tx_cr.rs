#[doc = "Reader of register ETH_DMAC0TxCR"]
pub type R = crate::R<u32, super::ETH_DMAC0TXCR>;
#[doc = "Writer for register ETH_DMAC0TxCR"]
pub type W = crate::W<u32, super::ETH_DMAC0TXCR>;
#[doc = "Register ETH_DMAC0TxCR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_DMAC0TXCR {
    type Type = u32;
    #[inline(always)]
