#[doc = "Reader of register ETH_DMAC1CR"]
pub type R = crate::R<u32, super::ETH_DMAC1CR>;
#[doc = "Writer for register ETH_DMAC1CR"]
pub type W = crate::W<u32, super::ETH_DMAC1CR>;
#[doc = "Register ETH_DMAC1CR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_DMAC1CR {
    type Type = u32;
    #[inline(always)]
