...
You can [`read`](crate::Reg::read) this register and get [`eth_dmac1mfcr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`eth_dmac1mfcr::R`](R) reader structure
impl crate::Readable for ETH_DMAC1MFCRrs {}
///`reset()` method sets ETH_DMAC1MFCR to value 0
