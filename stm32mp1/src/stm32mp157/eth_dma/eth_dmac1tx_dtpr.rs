///Register `ETH_DMAC1TxDTPR` reader
pub type R = crate::R<ETH_DMAC1TX_DTPRrs>;
///Register `ETH_DMAC1TxDTPR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETH_DMAC1TxDTPR")
            .field("tdt", &self.tdt())
            .finish()
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`eth_dmac1tx_dtpr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_dmac1tx_dtpr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`eth_dmac1tx_dtpr::R`](R) reader structure
impl crate::Readable for ETH_DMAC1TX_DTPRrs {}
///`write(|w| ..)` method takes [`eth_dmac1tx_dtpr::W`](W) writer structure
impl crate::Writable for ETH_DMAC1TX_DTPRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_DMAC1TxDTPR to value 0
