...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACPFR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACWTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACHT1R)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACVHTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACIVIR)
...
For information about available fields see [`mod@macq0tx_fcr`]
module*/
...
For information about available fields see [`mod@mactx_qpmr`]
module*/
#[doc(alias = "MACTxQPMR")]
...
For information about available fields see [`mod@macrx_qc0r`]
module*/
#[doc(alias = "MACRxQC0R")]
...
For information about available fields see [`mod@macrx_qc1r`]
module*/
#[doc(alias = "MACRxQC1R")]
...
For information about available fields see [`mod@macrx_qc2r`]
module*/
#[doc(alias = "MACRxQC2R")]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACRWKPFR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACLCSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACLTCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACPHYCSR)

For information about available fields see [`mod@macphycsr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACVR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACHWF1R)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACMDIOAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACMDIODR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACA0LR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACA1HR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACA3LR)
...
pub mod macl4a0r;
/**MACL3A00R (rw) register accessor: For IPv4 packets, the Layer 3 Address 0 Register 0 register contains the 32-bit IP Source Address field. For IPv6 packets, it contains Bits\[31:0\]
of the 128-bit IP Source Address or Destination Address field.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACL3A00R)
...
of the 128-bit IP Source Address or Destination Address field.*/
pub mod macl3a00r;
/**MACL3A10R (rw) register accessor: For IPv4 packets, the Layer 3 Address 1 Register 0 register contains the 32-bit IP Destination Address field. For IPv6 packets, it contains Bits\[63:32\]
of the 128-bit IP Source Address or Destination Address field.
...
of the 128-bit IP Source Address or Destination Address field.*/
pub mod macl3a10r;
/**MACL3A20 (rw) register accessor: The Layer 3 Address 2 Register 0 register is reserved for IPv4 packets. For IPv6 packets, it contains Bits\[95:64\]
of 128-bit IP Source Address or Destination Address field.
...
of 128-bit IP Source Address or Destination Address field.*/
pub mod macl3a20;
/**MACL3A30 (rw) register accessor: The Layer 3 Address 3 Register 0 register is reserved for IPv4 packets. For IPv6 packets, it contains Bits\[127:96\]
of 128-bit IP Source Address or Destination Address field.
...
(in big-endian mode) of the Layer 3 and Layer 4 Address Registers are written. For proper synchronization updates, you should perform consecutive writes to same Layer 3 and Layer 4 Address Registers after at least four clock cycles delay of the destination clock.*/
pub mod macl4a1r;
/**MACL3A01R (rw) register accessor: For IPv4 packets, the Layer 3 Address 0 Register 0 register contains the 32-bit IP Source Address field. For IPv6 packets, it contains Bits\[31:0\]
of the 128-bit IP Source Address or Destination Address field.
...
of the 128-bit IP Source Address or Destination Address field.*/
pub mod macl3a01r;
/**MACL3A11R (rw) register accessor: For IPv4 packets, the Layer 3 Address 1 Register 0 register contains the 32-bit IP Destination Address field. For IPv6 packets, it contains Bits\[63:32\]
of the 128-bit IP Source Address or Destination Address field.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACL3A11R)
...
of the 128-bit IP Source Address or Destination Address field.*/
pub mod macl3a11r;
/**MACL3A21R (rw) register accessor: The Layer 3 Address 2 Register 0 register is reserved for IPv4 packets. For IPv6 packets, it contains Bits\[95:64\]
of 128-bit IP Source Address or Destination Address field.
...
of 128-bit IP Source Address or Destination Address field.*/
pub mod macl3a21r;
/**MACL3A31R (rw) register accessor: The Layer 3 Address 3 Register 0 register is reserved for IPv4 packets. For IPv6 packets, it contains Bits\[127:96\]
of 128-bit IP Source Address or Destination Address field.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACTSCR)
...
pub mod mactsar;
/**MACTSSR (r) register accessor: The Timestamp Status register is present only when the IEEE 1588 Timestamp feature is selected. All bits except Bits\[27:25\]
gets cleared when the application reads this register.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACTxTSSSR)
...
pub mod macacr;
/**MACATSNR (r) register accessor: The Auxiliary Timestamp Nanoseconds register, along with ETH_MACATSSR, gives the 64-bit timestamp stored as auxiliary snapshot. These two registers form the read port of a 64-bit wide FIFO with a depth of 4 words. You can store multiple snapshots in this FIFO. Bits\[29:25\]
in ETH_MACTSSR indicate the fill-level of the FIFO. The top of the FIFO is removed only when the last byte of MAC Register 91 (Auxiliary Timestamp - Seconds Register) is read. In the little-endian mode, this means when Bits\[31:24\]
are read and in big-endian mode, Bits\[7:0\]
are read.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACTSIACR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACTSICNR)
...
pub mod mactsecnr;
/**MACPPSCR (rw) register accessor: The PPS Control register is present only when the Timestamp feature is selected and External Timestamp is not enabled. Bits\[30:24\]
of this register are valid only when four Flexible PPS outputs are selected. Bits\[22:16\]
are valid only when three or more Flexible PPS outputs are selected. Bits\[14:8\]
are valid only when two or more Flexible PPS outputs are selected. Bits\[6:4\]
are valid only when Flexible PPS feature is selected.
...
are valid only when Flexible PPS feature is selected.*/
pub mod macppscr;
/**MACPPSTTSR (rw) register accessor: The PPS Target Time Seconds register, along with PPS Target Time Nanoseconds register, is used to schedule an interrupt event \[Bit 1 of ETH_MACTSSR\]
when the system time exceeds the value programmed in these registers.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACPPSTTNR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACPPSIR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACPOCR)
...
pub mod macpocr;
/**MACSPI0R (rw) register accessor: This register contains Bits\[31:0\]
of the 80-bit Source Port Identity of the PTP node. This register is available only when the Enable PTP Timestamp Offload feature is selected.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACSPI0R)
...
of the 80-bit Source Port Identity of the PTP node. This register is available only when the Enable PTP Timestamp Offload feature is selected.*/
pub mod macspi0r;
/**MACSPI1R (rw) register accessor: This register contains Bits\[63:32\]
of the 80-bit Source Port Identity of the PTP node. This register is available only when the Enable PTP Timestamp Offload feature is selected.
...
of the 80-bit Source Port Identity of the PTP node. This register is available only when the Enable PTP Timestamp Offload feature is selected.*/
pub mod macspi1r;
/**MACSPI2R (rw) register accessor: This register contains Bits\[79:64\]
of the 80-bit Source Port Identity of the PTP node.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACSPI2R)
