#[doc = "Reader of register ETH_MACA1HR"]
pub type R = crate::R<u32, super::ETH_MACA1HR>;
#[doc = "Writer for register ETH_MACA1HR"]
pub type W = crate::W<u32, super::ETH_MACA1HR>;
#[doc = "Register ETH_MACA1HR `reset()`'s with value 0xffff"]
impl crate::ResetValue for super::ETH_MACA1HR {
    type Type = u32;
    #[inline(always)]
