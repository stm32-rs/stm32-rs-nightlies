#[doc = "Reader of register ETH_MACA3HR"]
pub type R = crate::R<u32, super::ETH_MACA3HR>;
#[doc = "Writer for register ETH_MACA3HR"]
pub type W = crate::W<u32, super::ETH_MACA3HR>;
#[doc = "Register ETH_MACA3HR `reset()`'s with value 0xffff"]
impl crate::ResetValue for super::ETH_MACA3HR {
    type Type = u32;
    #[inline(always)]
