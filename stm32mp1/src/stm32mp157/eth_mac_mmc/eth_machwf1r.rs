...
You can [`read`](crate::Reg::read) this register and get [`eth_machwf1r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:ETH_MACHWF1R)*/
pub struct ETH_MACHWF1Rrs;
impl crate::RegisterSpec for ETH_MACHWF1Rrs {
    type Ux = u32;
}
///`read()` method returns [`eth_machwf1r::R`](R) reader structure
impl crate::Readable for ETH_MACHWF1Rrs {}
///`reset()` method sets ETH_MACHWF1R to value 0x1114_1945
