#[doc = "Reader of register ETH_MACIER"]
pub type R = crate::R<u32, super::ETH_MACIER>;
#[doc = "Writer for register ETH_MACIER"]
pub type W = crate::W<u32, super::ETH_MACIER>;
#[doc = "Register ETH_MACIER `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MACIER {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `RGSMIIIE`"]
pub type RGSMIIIE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RGSMIIIE`"]
