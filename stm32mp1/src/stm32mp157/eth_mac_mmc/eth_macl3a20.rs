///Register `ETH_MACL3A20` reader
pub type R = crate::R<ETH_MACL3A20rs>;
///Register `ETH_MACL3A20` writer
pub type W = crate::W<ETH_MACL3A20rs>;
///Field `L3A20` reader - L3A20
pub type L3A20_R = crate::FieldReader<u32>;
///Field `L3A20` writer - L3A20
...
You can [`read`](crate::Reg::read) this register and get [`eth_macl3a20::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_macl3a20::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:ETH_MACL3A20)*/
pub struct ETH_MACL3A20rs;
impl crate::RegisterSpec for ETH_MACL3A20rs {
    type Ux = u32;
}
///`read()` method returns [`eth_macl3a20::R`](R) reader structure
impl crate::Readable for ETH_MACL3A20rs {}
///`write(|w| ..)` method takes [`eth_macl3a20::W`](W) writer structure
impl crate::Writable for ETH_MACL3A20rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_MACL3A20 to value 0
