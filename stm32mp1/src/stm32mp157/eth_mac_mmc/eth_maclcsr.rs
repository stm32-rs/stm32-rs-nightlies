///Register `ETH_MACLCSR` reader
pub type R = crate::R<ETH_MACLCSRrs>;
///Register `ETH_MACLCSR` writer
pub type W = crate::W<ETH_MACLCSRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpien(&mut self) -> LPIEN_W<ETH_MACLCSRrs> {
        LPIEN_W::new(self, 16)
    }
    ///Bit 17 - PLS
    #[inline(always)]
    #[must_use]
    pub fn pls(&mut self) -> PLS_W<ETH_MACLCSRrs> {
        PLS_W::new(self, 17)
    }
    ///Bit 18 - PLSEN
    #[inline(always)]
    #[must_use]
    pub fn plsen(&mut self) -> PLSEN_W<ETH_MACLCSRrs> {
        PLSEN_W::new(self, 18)
    }
    ///Bit 19 - LPITXA
    #[inline(always)]
    #[must_use]
    pub fn lpitxa(&mut self) -> LPITXA_W<ETH_MACLCSRrs> {
        LPITXA_W::new(self, 19)
    }
    ///Bit 20 - LPITE
    #[inline(always)]
    #[must_use]
    pub fn lpite(&mut self) -> LPITE_W<ETH_MACLCSRrs> {
        LPITE_W::new(self, 20)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`eth_maclcsr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_maclcsr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:ETH_MACLCSR)*/
pub struct ETH_MACLCSRrs;
impl crate::RegisterSpec for ETH_MACLCSRrs {
    type Ux = u32;
}
///`read()` method returns [`eth_maclcsr::R`](R) reader structure
impl crate::Readable for ETH_MACLCSRrs {}
///`write(|w| ..)` method takes [`eth_maclcsr::W`](W) writer structure
impl crate::Writable for ETH_MACLCSRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_MACLCSR to value 0
impl crate::Resettable for ETH_MACLCSRrs {
