#[doc = "Reader of register ETH_MACMDIOAR"]
pub type R = crate::R<u32, super::ETH_MACMDIOAR>;
#[doc = "Writer for register ETH_MACMDIOAR"]
pub type W = crate::W<u32, super::ETH_MACMDIOAR>;
#[doc = "Register ETH_MACMDIOAR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MACMDIOAR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `GB`"]
pub type GB_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `GB`"]
pub struct GB_W<'a> {
    w: &'a mut W,
}
impl<'a> GB_W<'a> {
