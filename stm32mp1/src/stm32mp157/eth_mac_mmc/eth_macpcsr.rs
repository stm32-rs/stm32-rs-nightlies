#[doc = "Reader of register ETH_MACPCSR"]
pub type R = crate::R<u32, super::ETH_MACPCSR>;
#[doc = "Writer for register ETH_MACPCSR"]
pub type W = crate::W<u32, super::ETH_MACPCSR>;
#[doc = "Register ETH_MACPCSR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MACPCSR {
    type Type = u32;
    #[inline(always)]
