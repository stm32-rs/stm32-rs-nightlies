#[doc = "Reader of register ETH_MACPPSTTNR"]
pub type R = crate::R<u32, super::ETH_MACPPSTTNR>;
#[doc = "Writer for register ETH_MACPPSTTNR"]
pub type W = crate::W<u32, super::ETH_MACPPSTTNR>;
#[doc = "Register ETH_MACPPSTTNR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MACPPSTTNR {
    type Type = u32;
    #[inline(always)]
