#[doc = "Reader of register ETH_MACPPSWR"]
pub type R = crate::R<u32, super::ETH_MACPPSWR>;
#[doc = "Writer for register ETH_MACPPSWR"]
pub type W = crate::W<u32, super::ETH_MACPPSWR>;
#[doc = "Register ETH_MACPPSWR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MACPPSWR {
    type Type = u32;
    #[inline(always)]
