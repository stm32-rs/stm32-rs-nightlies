#[doc = "Reader of register ETH_MACRWKPFR"]
pub type R = crate::R<u32, super::ETH_MACRWKPFR>;
#[doc = "Writer for register ETH_MACRWKPFR"]
pub type W = crate::W<u32, super::ETH_MACRWKPFR>;
#[doc = "Register ETH_MACRWKPFR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MACRWKPFR {
    type Type = u32;
    #[inline(always)]
