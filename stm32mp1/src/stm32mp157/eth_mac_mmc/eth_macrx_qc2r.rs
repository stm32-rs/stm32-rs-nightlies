///Register `ETH_MACRxQC2R` reader
pub type R = crate::R<ETH_MACRX_QC2Rrs>;
///Register `ETH_MACRxQC2R` writer
...
You can [`read`](crate::Reg::read) this register and get [`eth_macrx_qc2r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_macrx_qc2r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:ETH_MACRxQC2R)*/
pub struct ETH_MACRX_QC2Rrs;
impl crate::RegisterSpec for ETH_MACRX_QC2Rrs {
    type Ux = u32;
}
///`read()` method returns [`eth_macrx_qc2r::R`](R) reader structure
impl crate::Readable for ETH_MACRX_QC2Rrs {}
///`write(|w| ..)` method takes [`eth_macrx_qc2r::W`](W) writer structure
impl crate::Writable for ETH_MACRX_QC2Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_MACRxQC2R to value 0
