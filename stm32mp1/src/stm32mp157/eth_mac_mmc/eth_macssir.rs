#[doc = "Reader of register ETH_MACSSIR"]
pub type R = crate::R<u32, super::ETH_MACSSIR>;
#[doc = "Writer for register ETH_MACSSIR"]
pub type W = crate::W<u32, super::ETH_MACSSIR>;
#[doc = "Register ETH_MACSSIR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MACSSIR {
    type Type = u32;
    #[inline(always)]
