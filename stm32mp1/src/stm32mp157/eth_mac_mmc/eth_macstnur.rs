#[doc = "Reader of register ETH_MACSTNUR"]
pub type R = crate::R<u32, super::ETH_MACSTNUR>;
#[doc = "Writer for register ETH_MACSTNUR"]
pub type W = crate::W<u32, super::ETH_MACSTNUR>;
#[doc = "Register ETH_MACSTNUR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MACSTNUR {
    type Type = u32;
    #[inline(always)]
