///Register `ETH_MACTSIACR` reader
pub type R = crate::R<ETH_MACTSIACRrs>;
///Register `ETH_MACTSIACR` writer
...
You can [`read`](crate::Reg::read) this register and get [`eth_mactsiacr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_mactsiacr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:ETH_MACTSIACR)*/
pub struct ETH_MACTSIACRrs;
impl crate::RegisterSpec for ETH_MACTSIACRrs {
    type Ux = u32;
}
///`read()` method returns [`eth_mactsiacr::R`](R) reader structure
impl crate::Readable for ETH_MACTSIACRrs {}
///`write(|w| ..)` method takes [`eth_mactsiacr::W`](W) writer structure
impl crate::Writable for ETH_MACTSIACRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_MACTSIACR to value 0
