#[doc = "Reader of register ETH_MACVTR"]
pub type R = crate::R<u32, super::ETH_MACVTR>;
#[doc = "Writer for register ETH_MACVTR"]
pub type W = crate::W<u32, super::ETH_MACVTR>;
#[doc = "Register ETH_MACVTR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MACVTR {
    type Type = u32;
    #[inline(always)]
