...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn psrq0(&mut self) -> PSRQ0_W<MACRX_QC2Rrs> {
        PSRQ0_W::new(self, 0)
    }
    ///Bits 8:15 - PSRQ1
    #[inline(always)]
    #[must_use]
    pub fn psrq1(&mut self) -> PSRQ1_W<MACRX_QC2Rrs> {
        PSRQ1_W::new(self, 8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MAC_MMC:MACRxQC2R)*/
