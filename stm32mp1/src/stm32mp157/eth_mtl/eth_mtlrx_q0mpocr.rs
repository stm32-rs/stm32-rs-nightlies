///Register `ETH_MTLRxQ0MPOCR` reader
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETH_MTLRxQ0MPOCR")
...
You can [`read`](crate::Reg::read) this register and get [`eth_mtlrx_q0mpocr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`eth_mtlrx_q0mpocr::R`](R) reader structure
impl crate::Readable for ETH_MTLRX_Q0MPOCRrs {}
///`reset()` method sets ETH_MTLRxQ0MPOCR to value 0
