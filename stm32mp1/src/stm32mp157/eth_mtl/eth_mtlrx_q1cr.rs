#[doc = "Reader of register ETH_MTLRxQ1CR"]
pub type R = crate::R<u32, super::ETH_MTLRXQ1CR>;
#[doc = "Writer for register ETH_MTLRxQ1CR"]
pub type W = crate::W<u32, super::ETH_MTLRXQ1CR>;
#[doc = "Register ETH_MTLRxQ1CR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MTLRXQ1CR {
    type Type = u32;
    #[inline(always)]
