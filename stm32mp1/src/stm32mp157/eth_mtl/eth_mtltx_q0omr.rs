...
pub type R = crate::R<ETH_MTLTX_Q0OMRrs>;
///Register `ETH_MTLTxQ0OMR` writer
pub type W = crate::W<ETH_MTLTX_Q0OMRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ftq(&mut self) -> FTQ_W<ETH_MTLTX_Q0OMRrs> {
        FTQ_W::new(self, 0)
    }
    ///Bit 1 - TSF
    #[inline(always)]
    #[must_use]
    pub fn tsf(&mut self) -> TSF_W<ETH_MTLTX_Q0OMRrs> {
        TSF_W::new(self, 1)
    }
    ///Bits 2:3 - TXQEN
    #[inline(always)]
    #[must_use]
    pub fn txqen(&mut self) -> TXQEN_W<ETH_MTLTX_Q0OMRrs> {
        TXQEN_W::new(self, 2)
    }
    ///Bits 4:5 - TTC
    #[inline(always)]
    #[must_use]
    pub fn ttc(&mut self) -> TTC_W<ETH_MTLTX_Q0OMRrs> {
        TTC_W::new(self, 4)
    }
    ///Bits 16:24 - TQS
    #[inline(always)]
    #[must_use]
    pub fn tqs(&mut self) -> TQS_W<ETH_MTLTX_Q0OMRrs> {
        TQS_W::new(self, 16)
    }
}
/**Tx queue 0 operating mode Register

You can [`read`](crate::Reg::read) this register and get [`eth_mtltx_q0omr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eth_mtltx_q0omr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MTL:ETH_MTLTxQ0OMR)*/
pub struct ETH_MTLTX_Q0OMRrs;
impl crate::RegisterSpec for ETH_MTLTX_Q0OMRrs {
    type Ux = u32;
}
///`read()` method returns [`eth_mtltx_q0omr::R`](R) reader structure
impl crate::Readable for ETH_MTLTX_Q0OMRrs {}
///`write(|w| ..)` method takes [`eth_mtltx_q0omr::W`](W) writer structure
impl crate::Writable for ETH_MTLTX_Q0OMRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETH_MTLTxQ0OMR to value 0
impl crate::Resettable for ETH_MTLTX_Q0OMRrs {
