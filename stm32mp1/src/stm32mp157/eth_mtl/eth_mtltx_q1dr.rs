...
pub type R = crate::R<ETH_MTLTX_Q1DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`eth_mtltx_q1dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MTL:ETH_MTLTxQ1DR)*/
pub struct ETH_MTLTX_Q1DRrs;
impl crate::RegisterSpec for ETH_MTLTX_Q1DRrs {
    type Ux = u32;
}
///`read()` method returns [`eth_mtltx_q1dr::R`](R) reader structure
impl crate::Readable for ETH_MTLTX_Q1DRrs {}
///`reset()` method sets ETH_MTLTxQ1DR to value 0
impl crate::Resettable for ETH_MTLTX_Q1DRrs {
