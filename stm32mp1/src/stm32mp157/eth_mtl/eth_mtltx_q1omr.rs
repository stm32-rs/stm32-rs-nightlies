#[doc = "Reader of register ETH_MTLTxQ1OMR"]
pub type R = crate::R<u32, super::ETH_MTLTXQ1OMR>;
#[doc = "Writer for register ETH_MTLTxQ1OMR"]
pub type W = crate::W<u32, super::ETH_MTLTXQ1OMR>;
#[doc = "Register ETH_MTLTxQ1OMR `reset()`'s with value 0"]
impl crate::ResetValue for super::ETH_MTLTXQ1OMR {
    type Type = u32;
    #[inline(always)]
