...
pub struct R(crate::R<ETH_MTLTXQ1OMR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_MTLTXQ1OMR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_MTLTXQ1OMR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_MTLTXQ1OMR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ETH_MTLTxQ1OMR` writer"]
pub struct W(crate::W<ETH_MTLTXQ1OMR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ETH_MTLTXQ1OMR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ETH_MTLTXQ1OMR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ETH_MTLTXQ1OMR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct ETH_MTLTXQ1OMR_SPEC;
impl crate::RegisterSpec for ETH_MTLTXQ1OMR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eth_mtltx_q1omr::R](R) reader structure"]
impl crate::Readable for ETH_MTLTXQ1OMR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eth_mtltx_q1omr::W](W) writer structure"]
impl crate::Writable for ETH_MTLTXQ1OMR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ETH_MTLTxQ1OMR to value 0"]
impl crate::Resettable for ETH_MTLTXQ1OMR_SPEC {
    #[inline(always)]
