...
pub type R = crate::R<MTLRX_Q0DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mtlrx_q0dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MTL:MTLRxQ0DR)*/
pub struct MTLRX_Q0DRrs;
impl crate::RegisterSpec for MTLRX_Q0DRrs {
    type Ux = u32;
}
///`read()` method returns [`mtlrx_q0dr::R`](R) reader structure
impl crate::Readable for MTLRX_Q0DRrs {}
///`reset()` method sets MTLRxQ0DR to value 0
impl crate::Resettable for MTLRX_Q0DRrs {}
