...
impl W {
    ///Bits 0:1 - RTC
    #[inline(always)]
    pub fn rtc(&mut self) -> RTC_W<MTLRX_Q0OMRrs> {
        RTC_W::new(self, 0)
    }
    ///Bit 3 - FUP
    #[inline(always)]
    pub fn fup(&mut self) -> FUP_W<MTLRX_Q0OMRrs> {
        FUP_W::new(self, 3)
    }
    ///Bit 4 - FEP
    #[inline(always)]
    pub fn fep(&mut self) -> FEP_W<MTLRX_Q0OMRrs> {
        FEP_W::new(self, 4)
    }
    ///Bit 5 - RSF
    #[inline(always)]
    pub fn rsf(&mut self) -> RSF_W<MTLRX_Q0OMRrs> {
        RSF_W::new(self, 5)
    }
    ///Bit 6 - DIS_TCP_EF
    #[inline(always)]
    pub fn dis_tcp_ef(&mut self) -> DIS_TCP_EF_W<MTLRX_Q0OMRrs> {
        DIS_TCP_EF_W::new(self, 6)
    }
    ///Bit 7 - EHFC
    #[inline(always)]
    pub fn ehfc(&mut self) -> EHFC_W<MTLRX_Q0OMRrs> {
        EHFC_W::new(self, 7)
    }
    ///Bits 8:10 - RFA
    #[inline(always)]
    pub fn rfa(&mut self) -> RFA_W<MTLRX_Q0OMRrs> {
        RFA_W::new(self, 8)
    }
    ///Bits 14:16 - RFD
    #[inline(always)]
    pub fn rfd(&mut self) -> RFD_W<MTLRX_Q0OMRrs> {
        RFD_W::new(self, 14)
    }
}
