...
pub type R = crate::R<MTLTX_Q0DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mtltx_q0dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MTL:MTLTxQ0DR)*/
pub struct MTLTX_Q0DRrs;
impl crate::RegisterSpec for MTLTX_Q0DRrs {
    type Ux = u32;
}
///`read()` method returns [`mtltx_q0dr::R`](R) reader structure
impl crate::Readable for MTLTX_Q0DRrs {}
///`reset()` method sets MTLTxQ0DR to value 0
impl crate::Resettable for MTLTX_Q0DRrs {}
