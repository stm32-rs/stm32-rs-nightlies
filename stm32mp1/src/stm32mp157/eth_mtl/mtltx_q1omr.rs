...
impl W {
    ///Bit 0 - FTQ
    #[inline(always)]
    pub fn ftq(&mut self) -> FTQ_W<MTLTX_Q1OMRrs> {
        FTQ_W::new(self, 0)
    }
    ///Bit 1 - TSF
    #[inline(always)]
    pub fn tsf(&mut self) -> TSF_W<MTLTX_Q1OMRrs> {
        TSF_W::new(self, 1)
    }
    ///Bits 2:3 - TXQEN
    #[inline(always)]
    pub fn txqen(&mut self) -> TXQEN_W<MTLTX_Q1OMRrs> {
        TXQEN_W::new(self, 2)
    }
    ///Bits 4:5 - TTC
    #[inline(always)]
    pub fn ttc(&mut self) -> TTC_W<MTLTX_Q1OMRrs> {
        TTC_W::new(self, 4)
    }
    ///Bits 16:24 - TQS
    #[inline(always)]
    pub fn tqs(&mut self) -> TQS_W<MTLTX_Q1OMRrs> {
        TQS_W::new(self, 16)
    }
}
