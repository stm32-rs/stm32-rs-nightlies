...
pub type R = crate::R<MTLTX_Q1OMRrs>;
///Register `MTLTxQ1OMR` writer
pub type W = crate::W<MTLTX_Q1OMRrs>;
...
impl W {
    ///Bit 0 - FTQ
    #[inline(always)]
    pub fn ftq(&mut self) -> FTQ_W<'_, MTLTX_Q1OMRrs> {
        FTQ_W::new(self, 0)
    }
    ///Bit 1 - TSF
    #[inline(always)]
    pub fn tsf(&mut self) -> TSF_W<'_, MTLTX_Q1OMRrs> {
        TSF_W::new(self, 1)
    }
    ///Bits 2:3 - TXQEN
    #[inline(always)]
    pub fn txqen(&mut self) -> TXQEN_W<'_, MTLTX_Q1OMRrs> {
        TXQEN_W::new(self, 2)
    }
    ///Bits 4:5 - TTC
    #[inline(always)]
    pub fn ttc(&mut self) -> TTC_W<'_, MTLTX_Q1OMRrs> {
        TTC_W::new(self, 4)
    }
    ///Bits 16:24 - TQS
    #[inline(always)]
    pub fn tqs(&mut self) -> TQS_W<'_, MTLTX_Q1OMRrs> {
        TQS_W::new(self, 16)
    }
}
/**Tx queue 1 operating mode Register

You can [`read`](crate::Reg::read) this register and get [`mtltx_q1omr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mtltx_q1omr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETH_MTL:MTLTxQ1OMR)*/
pub struct MTLTX_Q1OMRrs;
impl crate::RegisterSpec for MTLTX_Q1OMRrs {
    type Ux = u32;
}
///`read()` method returns [`mtltx_q1omr::R`](R) reader structure
impl crate::Readable for MTLTX_Q1OMRrs {}
///`write(|w| ..)` method takes [`mtltx_q1omr::W`](W) writer structure
impl crate::Writable for MTLTX_Q1OMRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MTLTxQ1OMR to value 0
impl crate::Resettable for MTLTX_Q1OMRrs {}
