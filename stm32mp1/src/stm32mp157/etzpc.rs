...
For information about available fields see [`mod@tzma0_size`]
module*/
...
For information about available fields see [`mod@tzma1_size`]
module*/
...
For information about available fields see [`mod@decprot0`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETZPC:DECPROT1)

For information about available fields see [`mod@decprot1`]
module*/
...
For information about available fields see [`mod@decprot2`]
module*/
...
For information about available fields see [`mod@decprot3`]
module*/
...
For information about available fields see [`mod@decprot4`]
module*/
...
For information about available fields see [`mod@decprot5`]
module*/
...
For information about available fields see [`mod@decprot_lock0`]
module*/
...
For information about available fields see [`mod@decprot_lock1`]
module*/
...
For information about available fields see [`mod@decprot_lock2`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETZPC:IDR)
