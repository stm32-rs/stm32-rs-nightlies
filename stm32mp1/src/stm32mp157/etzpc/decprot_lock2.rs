///Register `DECPROT_LOCK2` reader
pub type R = crate::R<DECPROT_LOCK2rs>;
///Register `DECPROT_LOCK2` writer
pub type W = crate::W<DECPROT_LOCK2rs>;
...
impl W {
    ///Bit 0 - LOCK0
    #[inline(always)]
    pub fn lock0(&mut self) -> LOCK0_W<'_, DECPROT_LOCK2rs> {
        LOCK0_W::new(self, 0)
    }
    ///Bit 1 - LOCK1
    #[inline(always)]
    pub fn lock1(&mut self) -> LOCK1_W<'_, DECPROT_LOCK2rs> {
        LOCK1_W::new(self, 1)
    }
    ///Bit 2 - LOCK2
    #[inline(always)]
    pub fn lock2(&mut self) -> LOCK2_W<'_, DECPROT_LOCK2rs> {
        LOCK2_W::new(self, 2)
    }
    ///Bit 3 - LOCK3
    #[inline(always)]
    pub fn lock3(&mut self) -> LOCK3_W<'_, DECPROT_LOCK2rs> {
        LOCK3_W::new(self, 3)
    }
    ///Bit 4 - LOCK4
    #[inline(always)]
    pub fn lock4(&mut self) -> LOCK4_W<'_, DECPROT_LOCK2rs> {
        LOCK4_W::new(self, 4)
    }
    ///Bit 5 - LOCK5
    #[inline(always)]
    pub fn lock5(&mut self) -> LOCK5_W<'_, DECPROT_LOCK2rs> {
        LOCK5_W::new(self, 5)
    }
    ///Bit 6 - LOCK6
    #[inline(always)]
    pub fn lock6(&mut self) -> LOCK6_W<'_, DECPROT_LOCK2rs> {
        LOCK6_W::new(self, 6)
    }
    ///Bit 7 - LOCK7
    #[inline(always)]
    pub fn lock7(&mut self) -> LOCK7_W<'_, DECPROT_LOCK2rs> {
        LOCK7_W::new(self, 7)
    }
    ///Bit 8 - LOCK8
    #[inline(always)]
    pub fn lock8(&mut self) -> LOCK8_W<'_, DECPROT_LOCK2rs> {
        LOCK8_W::new(self, 8)
    }
    ///Bit 9 - LOCK9
    #[inline(always)]
    pub fn lock9(&mut self) -> LOCK9_W<'_, DECPROT_LOCK2rs> {
        LOCK9_W::new(self, 9)
    }
    ///Bit 10 - LOCK10
    #[inline(always)]
    pub fn lock10(&mut self) -> LOCK10_W<'_, DECPROT_LOCK2rs> {
        LOCK10_W::new(self, 10)
    }
    ///Bit 11 - LOCK11
    #[inline(always)]
    pub fn lock11(&mut self) -> LOCK11_W<'_, DECPROT_LOCK2rs> {
        LOCK11_W::new(self, 11)
    }
    ///Bit 12 - LOCK12
    #[inline(always)]
    pub fn lock12(&mut self) -> LOCK12_W<'_, DECPROT_LOCK2rs> {
        LOCK12_W::new(self, 12)
    }
    ///Bit 13 - LOCK13
    #[inline(always)]
    pub fn lock13(&mut self) -> LOCK13_W<'_, DECPROT_LOCK2rs> {
        LOCK13_W::new(self, 13)
    }
    ///Bit 14 - LOCK14
    #[inline(always)]
    pub fn lock14(&mut self) -> LOCK14_W<'_, DECPROT_LOCK2rs> {
        LOCK14_W::new(self, 14)
    }
    ///Bit 15 - LOCK15
    #[inline(always)]
    pub fn lock15(&mut self) -> LOCK15_W<'_, DECPROT_LOCK2rs> {
        LOCK15_W::new(self, 15)
    }
    ///Bit 16 - LOCK16
    #[inline(always)]
    pub fn lock16(&mut self) -> LOCK16_W<'_, DECPROT_LOCK2rs> {
        LOCK16_W::new(self, 16)
    }
    ///Bit 17 - LOCK17
    #[inline(always)]
    pub fn lock17(&mut self) -> LOCK17_W<'_, DECPROT_LOCK2rs> {
        LOCK17_W::new(self, 17)
    }
    ///Bit 18 - LOCK18
    #[inline(always)]
    pub fn lock18(&mut self) -> LOCK18_W<'_, DECPROT_LOCK2rs> {
        LOCK18_W::new(self, 18)
    }
    ///Bit 19 - LOCK19
    #[inline(always)]
    pub fn lock19(&mut self) -> LOCK19_W<'_, DECPROT_LOCK2rs> {
        LOCK19_W::new(self, 19)
    }
    ///Bit 20 - LOCK20
    #[inline(always)]
    pub fn lock20(&mut self) -> LOCK20_W<'_, DECPROT_LOCK2rs> {
        LOCK20_W::new(self, 20)
    }
    ///Bit 21 - LOCK21
    #[inline(always)]
    pub fn lock21(&mut self) -> LOCK21_W<'_, DECPROT_LOCK2rs> {
        LOCK21_W::new(self, 21)
    }
    ///Bit 22 - LOCK22
    #[inline(always)]
    pub fn lock22(&mut self) -> LOCK22_W<'_, DECPROT_LOCK2rs> {
        LOCK22_W::new(self, 22)
    }
    ///Bit 23 - LOCK23
    #[inline(always)]
    pub fn lock23(&mut self) -> LOCK23_W<'_, DECPROT_LOCK2rs> {
        LOCK23_W::new(self, 23)
    }
    ///Bit 24 - LOCK24
    #[inline(always)]
    pub fn lock24(&mut self) -> LOCK24_W<'_, DECPROT_LOCK2rs> {
        LOCK24_W::new(self, 24)
    }
    ///Bit 25 - LOCK25
    #[inline(always)]
    pub fn lock25(&mut self) -> LOCK25_W<'_, DECPROT_LOCK2rs> {
        LOCK25_W::new(self, 25)
    }
    ///Bit 26 - LOCK26
    #[inline(always)]
    pub fn lock26(&mut self) -> LOCK26_W<'_, DECPROT_LOCK2rs> {
        LOCK26_W::new(self, 26)
    }
    ///Bit 27 - LOCK27
    #[inline(always)]
    pub fn lock27(&mut self) -> LOCK27_W<'_, DECPROT_LOCK2rs> {
        LOCK27_W::new(self, 27)
    }
    ///Bit 28 - LOCK28
    #[inline(always)]
    pub fn lock28(&mut self) -> LOCK28_W<'_, DECPROT_LOCK2rs> {
        LOCK28_W::new(self, 28)
    }
    ///Bit 29 - LOCK29
    #[inline(always)]
    pub fn lock29(&mut self) -> LOCK29_W<'_, DECPROT_LOCK2rs> {
        LOCK29_W::new(self, 29)
    }
    ///Bit 30 - LOCK30
    #[inline(always)]
    pub fn lock30(&mut self) -> LOCK30_W<'_, DECPROT_LOCK2rs> {
        LOCK30_W::new(self, 30)
    }
    ///Bit 31 - LOCK31
    #[inline(always)]
    pub fn lock31(&mut self) -> LOCK31_W<'_, DECPROT_LOCK2rs> {
        LOCK31_W::new(self, 31)
    }
}
/**ETZPC decprot lock 2 register

You can [`read`](crate::Reg::read) this register and get [`decprot_lock2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`decprot_lock2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETZPC:DECPROT_LOCK2)*/
pub struct DECPROT_LOCK2rs;
impl crate::RegisterSpec for DECPROT_LOCK2rs {
    type Ux = u32;
}
///`read()` method returns [`decprot_lock2::R`](R) reader structure
impl crate::Readable for DECPROT_LOCK2rs {}
///`write(|w| ..)` method takes [`decprot_lock2::W`](W) writer structure
impl crate::Writable for DECPROT_LOCK2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DECPROT_LOCK2 to value 0
impl crate::Resettable for DECPROT_LOCK2rs {}
