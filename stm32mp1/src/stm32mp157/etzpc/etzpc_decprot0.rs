///Register `ETZPC_DECPROT0` reader
pub type R = crate::R<ETZPC_DECPROT0rs>;
///Register `ETZPC_DECPROT0` writer
pub type W = crate::W<ETZPC_DECPROT0rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn decprot0(&mut self) -> DECPROT0_W<ETZPC_DECPROT0rs> {
        DECPROT0_W::new(self, 0)
    }
    ///Bits 2:3 - DECPROT1
    #[inline(always)]
    #[must_use]
    pub fn decprot1(&mut self) -> DECPROT1_W<ETZPC_DECPROT0rs> {
        DECPROT1_W::new(self, 2)
    }
    ///Bits 4:5 - DECPROT2
    #[inline(always)]
    #[must_use]
    pub fn decprot2(&mut self) -> DECPROT2_W<ETZPC_DECPROT0rs> {
        DECPROT2_W::new(self, 4)
    }
    ///Bits 6:7 - DECPROT3
    #[inline(always)]
    #[must_use]
    pub fn decprot3(&mut self) -> DECPROT3_W<ETZPC_DECPROT0rs> {
        DECPROT3_W::new(self, 6)
    }
    ///Bits 8:9 - DECPROT4
    #[inline(always)]
    #[must_use]
    pub fn decprot4(&mut self) -> DECPROT4_W<ETZPC_DECPROT0rs> {
        DECPROT4_W::new(self, 8)
    }
    ///Bits 10:11 - DECPROT5
    #[inline(always)]
    #[must_use]
    pub fn decprot5(&mut self) -> DECPROT5_W<ETZPC_DECPROT0rs> {
        DECPROT5_W::new(self, 10)
    }
    ///Bits 12:13 - DECPROT6
    #[inline(always)]
    #[must_use]
    pub fn decprot6(&mut self) -> DECPROT6_W<ETZPC_DECPROT0rs> {
        DECPROT6_W::new(self, 12)
    }
    ///Bits 14:15 - DECPROT7
    #[inline(always)]
    #[must_use]
    pub fn decprot7(&mut self) -> DECPROT7_W<ETZPC_DECPROT0rs> {
        DECPROT7_W::new(self, 14)
    }
    ///Bits 16:17 - DECPROT8
    #[inline(always)]
    #[must_use]
    pub fn decprot8(&mut self) -> DECPROT8_W<ETZPC_DECPROT0rs> {
        DECPROT8_W::new(self, 16)
    }
    ///Bits 18:19 - DECPROT9
    #[inline(always)]
    #[must_use]
    pub fn decprot9(&mut self) -> DECPROT9_W<ETZPC_DECPROT0rs> {
        DECPROT9_W::new(self, 18)
    }
    ///Bits 20:21 - DECPROT10
    #[inline(always)]
    #[must_use]
    pub fn decprot10(&mut self) -> DECPROT10_W<ETZPC_DECPROT0rs> {
        DECPROT10_W::new(self, 20)
    }
    ///Bits 22:23 - DECPROT11
    #[inline(always)]
    #[must_use]
    pub fn decprot11(&mut self) -> DECPROT11_W<ETZPC_DECPROT0rs> {
        DECPROT11_W::new(self, 22)
    }
    ///Bits 24:25 - DECPROT12
    #[inline(always)]
    #[must_use]
    pub fn decprot12(&mut self) -> DECPROT12_W<ETZPC_DECPROT0rs> {
        DECPROT12_W::new(self, 24)
    }
    ///Bits 26:27 - DECPROT13
    #[inline(always)]
    #[must_use]
    pub fn decprot13(&mut self) -> DECPROT13_W<ETZPC_DECPROT0rs> {
        DECPROT13_W::new(self, 26)
    }
    ///Bits 28:29 - DECPROT14
    #[inline(always)]
    #[must_use]
    pub fn decprot14(&mut self) -> DECPROT14_W<ETZPC_DECPROT0rs> {
        DECPROT14_W::new(self, 28)
    }
    ///Bits 30:31 - DECPROT15
    #[inline(always)]
    #[must_use]
    pub fn decprot15(&mut self) -> DECPROT15_W<ETZPC_DECPROT0rs> {
        DECPROT15_W::new(self, 30)
    }
}
/**Register reset values

You can [`read`](crate::Reg::read) this register and get [`etzpc_decprot0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`etzpc_decprot0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETZPC:ETZPC_DECPROT0)*/
pub struct ETZPC_DECPROT0rs;
impl crate::RegisterSpec for ETZPC_DECPROT0rs {
    type Ux = u32;
}
///`read()` method returns [`etzpc_decprot0::R`](R) reader structure
impl crate::Readable for ETZPC_DECPROT0rs {}
///`write(|w| ..)` method takes [`etzpc_decprot0::W`](W) writer structure
impl crate::Writable for ETZPC_DECPROT0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETZPC_DECPROT0 to value 0
impl crate::Resettable for ETZPC_DECPROT0rs {
