///Register `ETZPC_DECPROT_LOCK0` reader
pub type R = crate::R<ETZPC_DECPROT_LOCK0rs>;
///Register `ETZPC_DECPROT_LOCK0` writer
pub type W = crate::W<ETZPC_DECPROT_LOCK0rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETZPC_DECPROT_LOCK0")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lock0(&mut self) -> LOCK0_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK0_W::new(self, 0)
    }
    ///Bit 1 - LOCK1
    #[inline(always)]
    #[must_use]
    pub fn lock1(&mut self) -> LOCK1_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK1_W::new(self, 1)
    }
    ///Bit 2 - LOCK2
    #[inline(always)]
    #[must_use]
    pub fn lock2(&mut self) -> LOCK2_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK2_W::new(self, 2)
    }
    ///Bit 3 - LOCK3
    #[inline(always)]
    #[must_use]
    pub fn lock3(&mut self) -> LOCK3_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK3_W::new(self, 3)
    }
    ///Bit 4 - LOCK4
    #[inline(always)]
    #[must_use]
    pub fn lock4(&mut self) -> LOCK4_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK4_W::new(self, 4)
    }
    ///Bit 5 - LOCK5
    #[inline(always)]
    #[must_use]
    pub fn lock5(&mut self) -> LOCK5_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK5_W::new(self, 5)
    }
    ///Bit 6 - LOCK6
    #[inline(always)]
    #[must_use]
    pub fn lock6(&mut self) -> LOCK6_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK6_W::new(self, 6)
    }
    ///Bit 7 - LOCK7
    #[inline(always)]
    #[must_use]
    pub fn lock7(&mut self) -> LOCK7_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK7_W::new(self, 7)
    }
    ///Bit 8 - LOCK8
    #[inline(always)]
    #[must_use]
    pub fn lock8(&mut self) -> LOCK8_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK8_W::new(self, 8)
    }
    ///Bit 9 - LOCK9
    #[inline(always)]
    #[must_use]
    pub fn lock9(&mut self) -> LOCK9_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK9_W::new(self, 9)
    }
    ///Bit 10 - LOCK10
    #[inline(always)]
    #[must_use]
    pub fn lock10(&mut self) -> LOCK10_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK10_W::new(self, 10)
    }
    ///Bit 11 - LOCK11
    #[inline(always)]
    #[must_use]
    pub fn lock11(&mut self) -> LOCK11_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK11_W::new(self, 11)
    }
    ///Bit 12 - LOCK12
    #[inline(always)]
    #[must_use]
    pub fn lock12(&mut self) -> LOCK12_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK12_W::new(self, 12)
    }
    ///Bit 13 - LOCK13
    #[inline(always)]
    #[must_use]
    pub fn lock13(&mut self) -> LOCK13_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK13_W::new(self, 13)
    }
    ///Bit 14 - LOCK14
    #[inline(always)]
    #[must_use]
    pub fn lock14(&mut self) -> LOCK14_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK14_W::new(self, 14)
    }
    ///Bit 15 - LOCK15
    #[inline(always)]
    #[must_use]
    pub fn lock15(&mut self) -> LOCK15_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK15_W::new(self, 15)
    }
    ///Bit 16 - LOCK16
    #[inline(always)]
    #[must_use]
    pub fn lock16(&mut self) -> LOCK16_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK16_W::new(self, 16)
    }
    ///Bit 17 - LOCK17
    #[inline(always)]
    #[must_use]
    pub fn lock17(&mut self) -> LOCK17_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK17_W::new(self, 17)
    }
    ///Bit 18 - LOCK18
    #[inline(always)]
    #[must_use]
    pub fn lock18(&mut self) -> LOCK18_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK18_W::new(self, 18)
    }
    ///Bit 19 - LOCK19
    #[inline(always)]
    #[must_use]
    pub fn lock19(&mut self) -> LOCK19_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK19_W::new(self, 19)
    }
    ///Bit 20 - LOCK20
    #[inline(always)]
    #[must_use]
    pub fn lock20(&mut self) -> LOCK20_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK20_W::new(self, 20)
    }
    ///Bit 21 - LOCK21
    #[inline(always)]
    #[must_use]
    pub fn lock21(&mut self) -> LOCK21_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK21_W::new(self, 21)
    }
    ///Bit 22 - LOCK22
    #[inline(always)]
    #[must_use]
    pub fn lock22(&mut self) -> LOCK22_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK22_W::new(self, 22)
    }
    ///Bit 23 - LOCK23
    #[inline(always)]
    #[must_use]
    pub fn lock23(&mut self) -> LOCK23_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK23_W::new(self, 23)
    }
    ///Bit 24 - LOCK24
    #[inline(always)]
    #[must_use]
    pub fn lock24(&mut self) -> LOCK24_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK24_W::new(self, 24)
    }
    ///Bit 25 - LOCK25
    #[inline(always)]
    #[must_use]
    pub fn lock25(&mut self) -> LOCK25_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK25_W::new(self, 25)
    }
    ///Bit 26 - LOCK26
    #[inline(always)]
    #[must_use]
    pub fn lock26(&mut self) -> LOCK26_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK26_W::new(self, 26)
    }
    ///Bit 27 - LOCK27
    #[inline(always)]
    #[must_use]
    pub fn lock27(&mut self) -> LOCK27_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK27_W::new(self, 27)
    }
    ///Bit 28 - LOCK28
    #[inline(always)]
    #[must_use]
    pub fn lock28(&mut self) -> LOCK28_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK28_W::new(self, 28)
    }
    ///Bit 29 - LOCK29
    #[inline(always)]
    #[must_use]
    pub fn lock29(&mut self) -> LOCK29_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK29_W::new(self, 29)
    }
    ///Bit 30 - LOCK30
    #[inline(always)]
    #[must_use]
    pub fn lock30(&mut self) -> LOCK30_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK30_W::new(self, 30)
    }
    ///Bit 31 - LOCK31
    #[inline(always)]
    #[must_use]
    pub fn lock31(&mut self) -> LOCK31_W<ETZPC_DECPROT_LOCK0rs> {
        LOCK31_W::new(self, 31)
    }
}
/**ETZPC decprot lock 0 register

You can [`read`](crate::Reg::read) this register and get [`etzpc_decprot_lock0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`etzpc_decprot_lock0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETZPC:ETZPC_DECPROT_LOCK0)*/
pub struct ETZPC_DECPROT_LOCK0rs;
impl crate::RegisterSpec for ETZPC_DECPROT_LOCK0rs {
    type Ux = u32;
}
///`read()` method returns [`etzpc_decprot_lock0::R`](R) reader structure
impl crate::Readable for ETZPC_DECPROT_LOCK0rs {}
///`write(|w| ..)` method takes [`etzpc_decprot_lock0::W`](W) writer structure
impl crate::Writable for ETZPC_DECPROT_LOCK0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETZPC_DECPROT_LOCK0 to value 0
impl crate::Resettable for ETZPC_DECPROT_LOCK0rs {
