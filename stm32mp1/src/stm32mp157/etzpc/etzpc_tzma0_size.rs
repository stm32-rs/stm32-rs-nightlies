...
pub type R = crate::R<ETZPC_TZMA0_SIZErs>;
///Register `ETZPC_TZMA0_SIZE` writer
pub type W = crate::W<ETZPC_TZMA0_SIZErs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETZPC_TZMA0_SIZE")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn r0size(&mut self) -> R0SIZE_W<ETZPC_TZMA0_SIZErs> {
        R0SIZE_W::new(self, 0)
    }
    ///Bit 31 - LOCK
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<ETZPC_TZMA0_SIZErs> {
        LOCK_W::new(self, 31)
    }
}
/**ETZPC ROM secure size definition

You can [`read`](crate::Reg::read) this register and get [`etzpc_tzma0_size::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`etzpc_tzma0_size::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETZPC:ETZPC_TZMA0_SIZE)*/
pub struct ETZPC_TZMA0_SIZErs;
impl crate::RegisterSpec for ETZPC_TZMA0_SIZErs {
    type Ux = u32;
}
///`read()` method returns [`etzpc_tzma0_size::R`](R) reader structure
impl crate::Readable for ETZPC_TZMA0_SIZErs {}
///`write(|w| ..)` method takes [`etzpc_tzma0_size::W`](W) writer structure
impl crate::Writable for ETZPC_TZMA0_SIZErs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETZPC_TZMA0_SIZE to value 0x03ff
impl crate::Resettable for ETZPC_TZMA0_SIZErs {
