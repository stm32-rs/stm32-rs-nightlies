...
impl W {
    ///Bits 0:9 - R0SIZE
    #[inline(always)]
    pub fn r0size(&mut self) -> R0SIZE_W<TZMA1_SIZErs> {
        R0SIZE_W::new(self, 0)
    }
    ///Bit 31 - LOCK
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<TZMA1_SIZErs> {
        LOCK_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#ETZPC:TZMA1_SIZE)*/
