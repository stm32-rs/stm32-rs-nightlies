...
impl W {
    ///Bit 0 - IM32
    #[inline(always)]
    pub fn im32(&mut self) -> IM32_W<'_, C2IMR2rs> {
        IM32_W::new(self, 0)
    }
    ///Bit 1 - IM33
    #[inline(always)]
    pub fn im33(&mut self) -> IM33_W<'_, C2IMR2rs> {
        IM33_W::new(self, 1)
    }
    ///Bit 2 - IM34
    #[inline(always)]
    ...
    ///Bit 3 - IM35
    #[inline(always)]
    pub fn im35(&mut self) -> IM35_W<'_, C2IMR2rs> {
        IM35_W::new(self, 3)
    }
    ///Bit 4 - IM36
    #[inline(always)]
    ...
    ///Bit 15 - IM47
    #[inline(always)]
    pub fn im47(&mut self) -> IM47_W<'_, C2IMR2rs> {
        IM47_W::new(self, 15)
    }
    ///Bit 16 - IM48
    #[inline(always)]
    pub fn im48(&mut self) -> IM48_W<'_, C2IMR2rs> {
        IM48_W::new(self, 16)
    }
    ///Bit 17 - IM49
    #[inline(always)]
    pub fn im49(&mut self) -> IM49_W<'_, C2IMR2rs> {
        IM49_W::new(self, 17)
    }
    ///Bit 18 - IM50
    #[inline(always)]
    pub fn im50(&mut self) -> IM50_W<'_, C2IMR2rs> {
        IM50_W::new(self, 18)
    }
    ///Bit 19 - IM51
    #[inline(always)]
    pub fn im51(&mut self) -> IM51_W<'_, C2IMR2rs> {
        IM51_W::new(self, 19)
    }
    ///Bit 20 - IM52
    #[inline(always)]
    pub fn im52(&mut self) -> IM52_W<'_, C2IMR2rs> {
        IM52_W::new(self, 20)
    }
    ///Bit 21 - IM53
    #[inline(always)]
    pub fn im53(&mut self) -> IM53_W<'_, C2IMR2rs> {
        IM53_W::new(self, 21)
    }
    ///Bit 22 - IM54
    #[inline(always)]
    pub fn im54(&mut self) -> IM54_W<'_, C2IMR2rs> {
        IM54_W::new(self, 22)
    }
    ///Bit 23 - IM55
    #[inline(always)]
    pub fn im55(&mut self) -> IM55_W<'_, C2IMR2rs> {
        IM55_W::new(self, 23)
    }
    ///Bit 24 - IM56
    #[inline(always)]
    pub fn im56(&mut self) -> IM56_W<'_, C2IMR2rs> {
        IM56_W::new(self, 24)
    }
    ///Bit 25 - IM57
    #[inline(always)]
    pub fn im57(&mut self) -> IM57_W<'_, C2IMR2rs> {
        IM57_W::new(self, 25)
    }
    ///Bit 26 - IM58
    #[inline(always)]
    pub fn im58(&mut self) -> IM58_W<'_, C2IMR2rs> {
        IM58_W::new(self, 26)
    }
    ///Bit 27 - IM59
    #[inline(always)]
    pub fn im59(&mut self) -> IM59_W<'_, C2IMR2rs> {
        IM59_W::new(self, 27)
    }
    ///Bit 28 - IM60
    #[inline(always)]
    pub fn im60(&mut self) -> IM60_W<'_, C2IMR2rs> {
        IM60_W::new(self, 28)
    }
    ///Bit 29 - IM61
    #[inline(always)]
    pub fn im61(&mut self) -> IM61_W<'_, C2IMR2rs> {
        IM61_W::new(self, 29)
    }
    ///Bit 30 - IM62
    #[inline(always)]
    pub fn im62(&mut self) -> IM62_W<'_, C2IMR2rs> {
        IM62_W::new(self, 30)
    }
    ///Bit 31 - IM63
    #[inline(always)]
    pub fn im63(&mut self) -> IM63_W<'_, C2IMR2rs> {
        IM63_W::new(self, 31)
    }
}
