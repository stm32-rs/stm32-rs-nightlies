...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn im64(&mut self) -> IM64_W<C2IMR3rs> {
        IM64_W::new(self, 0)
    }
    ///Bit 1 - IM65
    #[inline(always)]
    #[must_use]
    pub fn im65(&mut self) -> IM65_W<C2IMR3rs> {
        IM65_W::new(self, 1)
    }
    ///Bit 2 - IM66
    #[inline(always)]
    #[must_use]
    pub fn im66(&mut self) -> IM66_W<C2IMR3rs> {
        IM66_W::new(self, 2)
    }
    ///Bit 3 - IM67
    #[inline(always)]
    #[must_use]
    pub fn im67(&mut self) -> IM67_W<C2IMR3rs> {
        IM67_W::new(self, 3)
    }
    ///Bit 4 - IM68
    #[inline(always)]
    #[must_use]
    pub fn im68(&mut self) -> IM68_W<C2IMR3rs> {
        IM68_W::new(self, 4)
    }
    ///Bit 5 - IM69
    #[inline(always)]
    #[must_use]
    pub fn im69(&mut self) -> IM69_W<C2IMR3rs> {
        IM69_W::new(self, 5)
    }
    ///Bit 6 - IM70
    #[inline(always)]
    #[must_use]
    pub fn im70(&mut self) -> IM70_W<C2IMR3rs> {
        IM70_W::new(self, 6)
    }
    ///Bit 7 - IM71
    #[inline(always)]
    #[must_use]
    pub fn im71(&mut self) -> IM71_W<C2IMR3rs> {
        IM71_W::new(self, 7)
    }
    ///Bit 8 - IM72
    #[inline(always)]
    #[must_use]
    pub fn im72(&mut self) -> IM72_W<C2IMR3rs> {
        IM72_W::new(self, 8)
    }
    ///Bit 9 - IM73
    #[inline(always)]
    #[must_use]
    pub fn im73(&mut self) -> IM73_W<C2IMR3rs> {
        IM73_W::new(self, 9)
    }
    ///Bit 10 - IM74
    #[inline(always)]
    #[must_use]
    pub fn im74(&mut self) -> IM74_W<C2IMR3rs> {
        IM74_W::new(self, 10)
    }
    ///Bit 11 - IM75
    #[inline(always)]
    #[must_use]
    pub fn im75(&mut self) -> IM75_W<C2IMR3rs> {
        IM75_W::new(self, 11)
    }
}
