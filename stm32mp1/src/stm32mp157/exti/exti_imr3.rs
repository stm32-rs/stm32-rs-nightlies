///Register `EXTI_IMR3` reader
pub type R = crate::R<EXTI_IMR3rs>;
///Register `EXTI_IMR3` writer
pub type W = crate::W<EXTI_IMR3rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn im64(&mut self) -> IM64_W<EXTI_IMR3rs> {
        IM64_W::new(self, 0)
    }
    ///Bit 1 - IM65
    #[inline(always)]
    #[must_use]
    pub fn im65(&mut self) -> IM65_W<EXTI_IMR3rs> {
        IM65_W::new(self, 1)
    }
    ///Bit 2 - IM66
    #[inline(always)]
    #[must_use]
    pub fn im66(&mut self) -> IM66_W<EXTI_IMR3rs> {
        IM66_W::new(self, 2)
    }
    ///Bit 3 - IM67
    #[inline(always)]
    #[must_use]
    pub fn im67(&mut self) -> IM67_W<EXTI_IMR3rs> {
        IM67_W::new(self, 3)
    }
    ///Bit 4 - IM68
    #[inline(always)]
    #[must_use]
    pub fn im68(&mut self) -> IM68_W<EXTI_IMR3rs> {
        IM68_W::new(self, 4)
    }
    ///Bit 5 - IM69
    #[inline(always)]
    #[must_use]
    pub fn im69(&mut self) -> IM69_W<EXTI_IMR3rs> {
        IM69_W::new(self, 5)
    }
    ///Bit 6 - IM70
    #[inline(always)]
    #[must_use]
    pub fn im70(&mut self) -> IM70_W<EXTI_IMR3rs> {
        IM70_W::new(self, 6)
    }
    ///Bit 7 - IM71
    #[inline(always)]
    #[must_use]
    pub fn im71(&mut self) -> IM71_W<EXTI_IMR3rs> {
        IM71_W::new(self, 7)
    }
    ///Bit 8 - IM72
    #[inline(always)]
    #[must_use]
    pub fn im72(&mut self) -> IM72_W<EXTI_IMR3rs> {
        IM72_W::new(self, 8)
    }
    ///Bit 9 - IM73
    #[inline(always)]
    #[must_use]
    pub fn im73(&mut self) -> IM73_W<EXTI_IMR3rs> {
        IM73_W::new(self, 9)
    }
    ///Bit 10 - IM74
    #[inline(always)]
    #[must_use]
    pub fn im74(&mut self) -> IM74_W<EXTI_IMR3rs> {
        IM74_W::new(self, 10)
    }
    ///Bit 11 - IM75
    #[inline(always)]
    #[must_use]
    pub fn im75(&mut self) -> IM75_W<EXTI_IMR3rs> {
        IM75_W::new(self, 11)
    }
}
/**Contains register bits for configurable events and direct events.

You can [`read`](crate::Reg::read) this register and get [`exti_imr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`exti_imr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#EXTI:EXTI_IMR3)*/
pub struct EXTI_IMR3rs;
impl crate::RegisterSpec for EXTI_IMR3rs {
    type Ux = u32;
}
///`read()` method returns [`exti_imr3::R`](R) reader structure
impl crate::Readable for EXTI_IMR3rs {}
///`write(|w| ..)` method takes [`exti_imr3::W`](W) writer structure
impl crate::Writable for EXTI_IMR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EXTI_IMR3 to value 0x0de9
impl crate::Resettable for EXTI_IMR3rs {
