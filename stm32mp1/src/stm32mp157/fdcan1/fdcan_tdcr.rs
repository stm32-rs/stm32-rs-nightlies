...
#[doc = "Writer for register FDCAN_TDCR"]
pub type W = crate::W<u32, super::FDCAN_TDCR>;
#[doc = "Register FDCAN_TDCR `reset()`'s with value 0"]
impl crate::ResetValue for super::FDCAN_TDCR {
    type Type = u32;
    #[inline(always)]
