#[doc = "Reader of register FDCAN_TXEFC"]
pub type R = crate::R<u32, super::FDCAN_TXEFC>;
#[doc = "Writer for register FDCAN_TXEFC"]
pub type W = crate::W<u32, super::FDCAN_TXEFC>;
#[doc = "Register FDCAN_TXEFC `reset()`'s with value 0"]
impl crate::ResetValue for super::FDCAN_TXEFC {
    type Type = u32;
    #[inline(always)]
