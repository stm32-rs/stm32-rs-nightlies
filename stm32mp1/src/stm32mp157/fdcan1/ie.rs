...
impl W {
    ...
    ///Bit 1 - RF0WE
    #[inline(always)]
    pub fn rf0we(&mut self) -> RF0WE_W<IErs> {
        RF0WE_W::new(self, 1)
    }
    ///Bit 2 - RF0FE
    #[inline(always)]
    ...
    ///Bit 5 - RF1WE
    #[inline(always)]
    pub fn rf1we(&mut self) -> RF1WE_W<IErs> {
        RF1WE_W::new(self, 5)
    }
    ///Bit 6 - RF1FE
    #[inline(always)]
    ...
    ///Bit 13 - TEFWE
    #[inline(always)]
    pub fn tefwe(&mut self) -> TEFWE_W<IErs> {
        TEFWE_W::new(self, 13)
    }
    ///Bit 14 - TEFFE
    #[inline(always)]
    ...
    ///Bit 19 - DRXE
    #[inline(always)]
    pub fn drxe(&mut self) -> DRXE_W<IErs> {
        DRXE_W::new(self, 19)
    }
    ///Bit 20 - BECE
    #[inline(always)]
    pub fn bece(&mut self) -> BECE_W<IErs> {
        BECE_W::new(self, 20)
    }
    ///Bit 21 - BEUE
    #[inline(always)]
    pub fn beue(&mut self) -> BEUE_W<IErs> {
        BEUE_W::new(self, 21)
    }
    ///Bit 22 - ELOE
    #[inline(always)]
