...
impl W {
    ///Bit 0 - ETOC
    #[inline(always)]
    pub fn etoc(&mut self) -> ETOC_W<'_, TOCCrs> {
        ETOC_W::new(self, 0)
    }
    ///Bits 1:2 - TOS
    #[inline(always)]
    pub fn tos(&mut self) -> TOS_W<'_, TOCCrs> {
        TOS_W::new(self, 1)
    }
    ///Bits 16:31 - TOP
    #[inline(always)]
    pub fn top(&mut self) -> TOP_W<'_, TOCCrs> {
        TOP_W::new(self, 16)
    }
}
