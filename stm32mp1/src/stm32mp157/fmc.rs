...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BTR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BTR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:PCSCNTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:PCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:PMEM)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:PATT)
...
For information about available fields see [`mod@hpr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:HECCR)

For information about available fields see [`mod@heccr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BWTR3)
...
For information about available fields see [`mod@csqcr`]
module*/
...
For information about available fields see [`mod@csqcfgr1`]
module*/
...
For information about available fields see [`mod@csqcfgr2`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:CSQCFGR3)

For information about available fields see [`mod@csqcfgr3`]
module*/
...
For information about available fields see [`mod@csqar1`]
module*/
...
For information about available fields see [`mod@csqar2`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:CSQIER)

For information about available fields see [`mod@csqier`]
module*/
...
For information about available fields see [`mod@csqisr`]
module*/
...
For information about available fields see [`mod@csqicr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:CSQEMSR)

For information about available fields see [`mod@csqemsr`]
module*/
...
For information about available fields see [`mod@bchier`]
module*/
...
For information about available fields see [`mod@bchisr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCHICR)

For information about available fields see [`mod@bchicr`]
module*/
pub type BCHICR = crate::Reg<bchicr::BCHICRrs>;
///FMC BCH Interrupt Clear Register
pub mod bchicr;
/**BCHPBR1 (r) register accessor: These registers contain the BCH parity bits (BCHPB). For the BCH 4-bit, only BCHPB\[51:0\]
are significant and for the BCH 8-bit BCHPB\[103:0\]
are significant.

You can [`read`](crate::Reg::read) this register and get [`bchpbr1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCHPBR1)

For information about available fields see [`mod@bchpbr1`]
module*/
...
For information about available fields see [`mod@bchpbr2`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCHPBR3)

For information about available fields see [`mod@bchpbr3`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCHPBR4)

For information about available fields see [`mod@bchpbr4`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCHDSR0)

For information about available fields see [`mod@bchdsr0`]
module*/
...
For information about available fields see [`mod@bchdsr1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCHDSR2)

For information about available fields see [`mod@bchdsr2`]
module*/
...
For information about available fields see [`mod@bchdsr3`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:BCHDSR4)

For information about available fields see [`mod@bchdsr4`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:VERR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:IPIDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:SIDR)
