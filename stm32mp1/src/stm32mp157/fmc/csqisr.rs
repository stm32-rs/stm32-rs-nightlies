...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcf(&mut self) -> TCF_W<CSQISRrs> {
        TCF_W::new(self, 0)
    }
    ///Bit 1 - SCF
    #[inline(always)]
    #[must_use]
    pub fn scf(&mut self) -> SCF_W<CSQISRrs> {
        SCF_W::new(self, 1)
    }
    ///Bit 2 - SEF
    #[inline(always)]
    #[must_use]
    pub fn sef(&mut self) -> SEF_W<CSQISRrs> {
        SEF_W::new(self, 2)
    }
    ///Bit 3 - SUEF
    #[inline(always)]
    #[must_use]
    pub fn suef(&mut self) -> SUEF_W<CSQISRrs> {
        SUEF_W::new(self, 3)
    }
    ///Bit 4 - CMDTCF
    #[inline(always)]
    #[must_use]
    pub fn cmdtcf(&mut self) -> CMDTCF_W<CSQISRrs> {
        CMDTCF_W::new(self, 4)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:CSQISR)*/
pub struct CSQISRrs;
