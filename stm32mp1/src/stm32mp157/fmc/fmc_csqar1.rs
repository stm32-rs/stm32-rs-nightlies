...
You can [`read`](crate::Reg::read) this register and get [`fmc_csqar1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmc_csqar1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#FMC:FMC_CSQAR1)*/
pub struct FMC_CSQAR1rs;
impl crate::RegisterSpec for FMC_CSQAR1rs {
    type Ux = u32;
}
///`read()` method returns [`fmc_csqar1::R`](R) reader structure
impl crate::Readable for FMC_CSQAR1rs {}
///`write(|w| ..)` method takes [`fmc_csqar1::W`](W) writer structure
impl crate::Writable for FMC_CSQAR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FMC_CSQAR1 to value 0
