...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enablegrp0(&mut self) -> ENABLEGRP0_W<CTLRrs> {
        ENABLEGRP0_W::new(self, 0)
    }
    ///Bit 1 - ENABLEGRP1
    #[inline(always)]
    #[must_use]
    pub fn enablegrp1(&mut self) -> ENABLEGRP1_W<CTLRrs> {
        ENABLEGRP1_W::new(self, 1)
    }
    ///Bit 2 - ACKCTL
    #[inline(always)]
    #[must_use]
    pub fn ackctl(&mut self) -> ACKCTL_W<CTLRrs> {
        ACKCTL_W::new(self, 2)
    }
    ///Bit 3 - FIQEN
    #[inline(always)]
    #[must_use]
    pub fn fiqen(&mut self) -> FIQEN_W<CTLRrs> {
        FIQEN_W::new(self, 3)
    }
    ///Bit 4 - CBPR
    #[inline(always)]
    #[must_use]
    pub fn cbpr(&mut self) -> CBPR_W<CTLRrs> {
        CBPR_W::new(self, 4)
    }
    ///Bit 5 - FIQBYPDISGRP0
    #[inline(always)]
    #[must_use]
    pub fn fiqbypdisgrp0(&mut self) -> FIQBYPDISGRP0_W<CTLRrs> {
        FIQBYPDISGRP0_W::new(self, 5)
    }
    ///Bit 6 - IRQBYPDISGRP0
    #[inline(always)]
    #[must_use]
    pub fn irqbypdisgrp0(&mut self) -> IRQBYPDISGRP0_W<CTLRrs> {
        IRQBYPDISGRP0_W::new(self, 6)
    }
    ///Bit 7 - FIQBYPDISGRP1
    #[inline(always)]
    #[must_use]
    pub fn fiqbypdisgrp1(&mut self) -> FIQBYPDISGRP1_W<CTLRrs> {
        FIQBYPDISGRP1_W::new(self, 7)
    }
    ///Bit 8 - IRQBYPDISGRP1
    #[inline(always)]
    #[must_use]
    pub fn irqbypdisgrp1(&mut self) -> IRQBYPDISGRP1_W<CTLRrs> {
        IRQBYPDISGRP1_W::new(self, 8)
    }
    ///Bit 9 - EOIMODES
    #[inline(always)]
    #[must_use]
    pub fn eoimodes(&mut self) -> EOIMODES_W<CTLRrs> {
        EOIMODES_W::new(self, 9)
    }
    ///Bit 10 - EOIMODENS
    #[inline(always)]
    #[must_use]
    pub fn eoimodens(&mut self) -> EOIMODENS_W<CTLRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICC:CTLR)*/
pub struct CTLRrs;
