#[doc = "Writer for register GICC_AEOIR"]
pub type W = crate::W<u32, super::GICC_AEOIR>;
#[doc = "Register GICC_AEOIR `reset()`'s with value 0"]
impl crate::ResetValue for super::GICC_AEOIR {
    type Type = u32;
    #[inline(always)]
