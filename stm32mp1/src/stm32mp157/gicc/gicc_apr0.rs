...
pub type R = crate::R<GICC_APR0rs>;
///Register `GICC_APR0` writer
pub type W = crate::W<GICC_APR0rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn apr0(&mut self) -> APR0_W<GICC_APR0rs> {
        APR0_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICC:GICC_APR0)*/
pub struct GICC_APR0rs;
impl crate::RegisterSpec for GICC_APR0rs {
    type Ux = u32;
}
///`read()` method returns [`gicc_apr0::R`](R) reader structure
impl crate::Readable for GICC_APR0rs {}
///`write(|w| ..)` method takes [`gicc_apr0::W`](W) writer structure
impl crate::Writable for GICC_APR0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICC_APR0 to value 0
impl crate::Resettable for GICC_APR0rs {
