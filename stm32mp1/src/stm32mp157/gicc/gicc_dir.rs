#[doc = "Writer for register GICC_DIR"]
pub type W = crate::W<u32, super::GICC_DIR>;
#[doc = "Register GICC_DIR `reset()`'s with value 0"]
impl crate::ResetValue for super::GICC_DIR {
    type Type = u32;
    #[inline(always)]
