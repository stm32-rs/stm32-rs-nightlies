#[doc = "Writer for register GICC_EOIR"]
pub type W = crate::W<u32, super::GICC_EOIR>;
#[doc = "Register GICC_EOIR `reset()`'s with value 0"]
impl crate::ResetValue for super::GICC_EOIR {
    type Type = u32;
    #[inline(always)]
