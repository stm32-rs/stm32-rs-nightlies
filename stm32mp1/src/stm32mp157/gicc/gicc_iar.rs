...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICC:GICC_IAR)*/
pub struct GICC_IARrs;
impl crate::RegisterSpec for GICC_IARrs {
    type Ux = u32;
}
///`read()` method returns [`gicc_iar::R`](R) reader structure
impl crate::Readable for GICC_IARrs {}
///`reset()` method sets GICC_IAR to value 0x03ff
