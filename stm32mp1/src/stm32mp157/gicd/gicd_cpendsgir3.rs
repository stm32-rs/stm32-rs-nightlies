///Register `GICD_CPENDSGIR3` reader
pub type R = crate::R<GICD_CPENDSGIR3rs>;
///Register `GICD_CPENDSGIR3` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GICD_CPENDSGIR3")
...
You can [`read`](crate::Reg::read) this register and get [`gicd_cpendsgir3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_cpendsgir3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:GICD_CPENDSGIR3)*/
pub struct GICD_CPENDSGIR3rs;
impl crate::RegisterSpec for GICD_CPENDSGIR3rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_cpendsgir3::R`](R) reader structure
impl crate::Readable for GICD_CPENDSGIR3rs {}
///`write(|w| ..)` method takes [`gicd_cpendsgir3::W`](W) writer structure
impl crate::Writable for GICD_CPENDSGIR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICD_CPENDSGIR3 to value 0
