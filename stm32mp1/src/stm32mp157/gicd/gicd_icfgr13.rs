///Register `GICD_ICFGR13` reader
pub type R = crate::R<GICD_ICFGR13rs>;
///Register `GICD_ICFGR13` writer
...
You can [`read`](crate::Reg::read) this register and get [`gicd_icfgr13::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_icfgr13::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:GICD_ICFGR13)*/
pub struct GICD_ICFGR13rs;
impl crate::RegisterSpec for GICD_ICFGR13rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_icfgr13::R`](R) reader structure
impl crate::Readable for GICD_ICFGR13rs {}
///`write(|w| ..)` method takes [`gicd_icfgr13::W`](W) writer structure
impl crate::Writable for GICD_ICFGR13rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICD_ICFGR13 to value 0x5555_5555
