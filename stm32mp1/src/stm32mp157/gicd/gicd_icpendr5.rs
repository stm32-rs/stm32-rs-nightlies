#[doc = "Reader of register GICD_ICPENDR5"]
pub type R = crate::R<u32, super::GICD_ICPENDR5>;
#[doc = "Writer for register GICD_ICPENDR5"]
pub type W = crate::W<u32, super::GICD_ICPENDR5>;
#[doc = "Register GICD_ICPENDR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ICPENDR5 {
    type Type = u32;
    #[inline(always)]
