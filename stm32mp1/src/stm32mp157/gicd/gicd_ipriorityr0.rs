#[doc = "Reader of register GICD_IPRIORITYR0"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR0>;
#[doc = "Writer for register GICD_IPRIORITYR0"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR0>;
#[doc = "Register GICD_IPRIORITYR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR0 {
    type Type = u32;
    #[inline(always)]
