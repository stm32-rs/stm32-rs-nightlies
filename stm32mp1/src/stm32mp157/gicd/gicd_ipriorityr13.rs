#[doc = "Reader of register GICD_IPRIORITYR13"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR13>;
#[doc = "Writer for register GICD_IPRIORITYR13"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR13>;
#[doc = "Register GICD_IPRIORITYR13 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR13 {
    type Type = u32;
    #[inline(always)]
