#[doc = "Reader of register GICD_IPRIORITYR16"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR16>;
#[doc = "Writer for register GICD_IPRIORITYR16"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR16>;
#[doc = "Register GICD_IPRIORITYR16 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR16 {
    type Type = u32;
    #[inline(always)]
