#[doc = "Reader of register GICD_IPRIORITYR17"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR17>;
#[doc = "Writer for register GICD_IPRIORITYR17"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR17>;
#[doc = "Register GICD_IPRIORITYR17 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR17 {
    type Type = u32;
    #[inline(always)]
