#[doc = "Reader of register GICD_IPRIORITYR21"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR21>;
#[doc = "Writer for register GICD_IPRIORITYR21"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR21>;
#[doc = "Register GICD_IPRIORITYR21 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR21 {
    type Type = u32;
    #[inline(always)]
