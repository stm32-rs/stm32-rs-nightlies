#[doc = "Reader of register GICD_IPRIORITYR27"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR27>;
#[doc = "Writer for register GICD_IPRIORITYR27"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR27>;
#[doc = "Register GICD_IPRIORITYR27 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR27 {
    type Type = u32;
    #[inline(always)]
