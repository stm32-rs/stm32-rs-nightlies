#[doc = "Reader of register GICD_IPRIORITYR3"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR3>;
#[doc = "Writer for register GICD_IPRIORITYR3"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR3>;
#[doc = "Register GICD_IPRIORITYR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR3 {
    type Type = u32;
    #[inline(always)]
