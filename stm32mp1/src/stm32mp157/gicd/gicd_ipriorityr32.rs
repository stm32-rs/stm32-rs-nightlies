///Register `GICD_IPRIORITYR32` reader
pub type R = crate::R<GICD_IPRIORITYR32rs>;
///Register `GICD_IPRIORITYR32` writer
pub type W = crate::W<GICD_IPRIORITYR32rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn priority0(&mut self) -> PRIORITY0_W<GICD_IPRIORITYR32rs> {
        PRIORITY0_W::new(self, 3)
    }
    ///Bits 11:15 - PRIORITY1
    #[inline(always)]
    #[must_use]
    pub fn priority1(&mut self) -> PRIORITY1_W<GICD_IPRIORITYR32rs> {
        PRIORITY1_W::new(self, 11)
    }
    ///Bits 19:23 - PRIORITY2
    #[inline(always)]
    #[must_use]
    pub fn priority2(&mut self) -> PRIORITY2_W<GICD_IPRIORITYR32rs> {
        PRIORITY2_W::new(self, 19)
    }
    ///Bits 27:31 - PRIORITY3
    #[inline(always)]
    #[must_use]
    pub fn priority3(&mut self) -> PRIORITY3_W<GICD_IPRIORITYR32rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:GICD_IPRIORITYR32)*/
pub struct GICD_IPRIORITYR32rs;
impl crate::RegisterSpec for GICD_IPRIORITYR32rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_ipriorityr32::R`](R) reader structure
impl crate::Readable for GICD_IPRIORITYR32rs {}
///`write(|w| ..)` method takes [`gicd_ipriorityr32::W`](W) writer structure
impl crate::Writable for GICD_IPRIORITYR32rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICD_IPRIORITYR32 to value 0
impl crate::Resettable for GICD_IPRIORITYR32rs {
