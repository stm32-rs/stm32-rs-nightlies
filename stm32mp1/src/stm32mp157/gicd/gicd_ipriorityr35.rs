#[doc = "Reader of register GICD_IPRIORITYR35"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR35>;
#[doc = "Writer for register GICD_IPRIORITYR35"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR35>;
#[doc = "Register GICD_IPRIORITYR35 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR35 {
    type Type = u32;
    #[inline(always)]
