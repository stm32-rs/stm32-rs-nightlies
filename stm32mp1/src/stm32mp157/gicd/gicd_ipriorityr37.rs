#[doc = "Reader of register GICD_IPRIORITYR37"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR37>;
#[doc = "Writer for register GICD_IPRIORITYR37"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR37>;
#[doc = "Register GICD_IPRIORITYR37 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR37 {
    type Type = u32;
    #[inline(always)]
