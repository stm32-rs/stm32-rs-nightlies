#[doc = "Reader of register GICD_IPRIORITYR40"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR40>;
#[doc = "Writer for register GICD_IPRIORITYR40"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR40>;
#[doc = "Register GICD_IPRIORITYR40 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR40 {
    type Type = u32;
    #[inline(always)]
