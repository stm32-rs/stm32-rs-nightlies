#[doc = "Reader of register GICD_IPRIORITYR47"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR47>;
#[doc = "Writer for register GICD_IPRIORITYR47"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR47>;
#[doc = "Register GICD_IPRIORITYR47 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR47 {
    type Type = u32;
    #[inline(always)]
