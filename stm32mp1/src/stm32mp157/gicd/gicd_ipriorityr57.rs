#[doc = "Reader of register GICD_IPRIORITYR57"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR57>;
#[doc = "Writer for register GICD_IPRIORITYR57"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR57>;
#[doc = "Register GICD_IPRIORITYR57 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR57 {
    type Type = u32;
    #[inline(always)]
