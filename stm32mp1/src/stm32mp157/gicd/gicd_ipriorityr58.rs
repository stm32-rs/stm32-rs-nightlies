...
pub type R = crate::R<GICD_IPRIORITYR58rs>;
///Register `GICD_IPRIORITYR58` writer
pub type W = crate::W<GICD_IPRIORITYR58rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GICD_IPRIORITYR58")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn priority0(&mut self) -> PRIORITY0_W<GICD_IPRIORITYR58rs> {
        PRIORITY0_W::new(self, 3)
    }
    ///Bits 11:15 - PRIORITY1
    #[inline(always)]
    #[must_use]
    pub fn priority1(&mut self) -> PRIORITY1_W<GICD_IPRIORITYR58rs> {
        PRIORITY1_W::new(self, 11)
    }
    ///Bits 19:23 - PRIORITY2
    #[inline(always)]
    #[must_use]
    pub fn priority2(&mut self) -> PRIORITY2_W<GICD_IPRIORITYR58rs> {
        PRIORITY2_W::new(self, 19)
    }
    ///Bits 27:31 - PRIORITY3
    #[inline(always)]
    #[must_use]
    pub fn priority3(&mut self) -> PRIORITY3_W<GICD_IPRIORITYR58rs> {
        PRIORITY3_W::new(self, 27)
    }
}
/**GICD interrupt priority register 58

You can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr58::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr58::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:GICD_IPRIORITYR58)*/
pub struct GICD_IPRIORITYR58rs;
impl crate::RegisterSpec for GICD_IPRIORITYR58rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_ipriorityr58::R`](R) reader structure
impl crate::Readable for GICD_IPRIORITYR58rs {}
///`write(|w| ..)` method takes [`gicd_ipriorityr58::W`](W) writer structure
impl crate::Writable for GICD_IPRIORITYR58rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICD_IPRIORITYR58 to value 0
impl crate::Resettable for GICD_IPRIORITYR58rs {
