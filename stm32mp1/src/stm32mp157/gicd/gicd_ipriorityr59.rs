#[doc = "Reader of register GICD_IPRIORITYR59"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR59>;
#[doc = "Writer for register GICD_IPRIORITYR59"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR59>;
#[doc = "Register GICD_IPRIORITYR59 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR59 {
    type Type = u32;
    #[inline(always)]
