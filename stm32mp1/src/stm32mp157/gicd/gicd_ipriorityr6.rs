#[doc = "Reader of register GICD_IPRIORITYR6"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR6>;
#[doc = "Writer for register GICD_IPRIORITYR6"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR6>;
#[doc = "Register GICD_IPRIORITYR6 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR6 {
    type Type = u32;
    #[inline(always)]
