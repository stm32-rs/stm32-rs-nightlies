#[doc = "Reader of register GICD_IPRIORITYR70"]
pub type R = crate::R<u32, super::GICD_IPRIORITYR70>;
#[doc = "Writer for register GICD_IPRIORITYR70"]
pub type W = crate::W<u32, super::GICD_IPRIORITYR70>;
#[doc = "Register GICD_IPRIORITYR70 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_IPRIORITYR70 {
    type Type = u32;
    #[inline(always)]
