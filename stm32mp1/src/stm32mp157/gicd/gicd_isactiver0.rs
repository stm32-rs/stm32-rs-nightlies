#[doc = "Reader of register GICD_ISACTIVER0"]
pub type R = crate::R<u32, super::GICD_ISACTIVER0>;
#[doc = "Writer for register GICD_ISACTIVER0"]
pub type W = crate::W<u32, super::GICD_ISACTIVER0>;
#[doc = "Register GICD_ISACTIVER0 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ISACTIVER0 {
    type Type = u32;
    #[inline(always)]
