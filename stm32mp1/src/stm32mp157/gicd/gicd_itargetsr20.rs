...
pub type R = crate::R<GICD_ITARGETSR20rs>;
///Register `GICD_ITARGETSR20` writer
pub type W = crate::W<GICD_ITARGETSR20rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_targets0(&mut self) -> CPU_TARGETS0_W<GICD_ITARGETSR20rs> {
        CPU_TARGETS0_W::new(self, 0)
    }
    ///Bits 8:9 - CPU_TARGETS1
    #[inline(always)]
    #[must_use]
    pub fn cpu_targets1(&mut self) -> CPU_TARGETS1_W<GICD_ITARGETSR20rs> {
        CPU_TARGETS1_W::new(self, 8)
    }
    ///Bits 16:17 - CPU_TARGETS2
    #[inline(always)]
    #[must_use]
    pub fn cpu_targets2(&mut self) -> CPU_TARGETS2_W<GICD_ITARGETSR20rs> {
        CPU_TARGETS2_W::new(self, 16)
    }
    ///Bits 24:25 - CPU_TARGETS3
    #[inline(always)]
    #[must_use]
    pub fn cpu_targets3(&mut self) -> CPU_TARGETS3_W<GICD_ITARGETSR20rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:GICD_ITARGETSR20)*/
pub struct GICD_ITARGETSR20rs;
impl crate::RegisterSpec for GICD_ITARGETSR20rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_itargetsr20::R`](R) reader structure
impl crate::Readable for GICD_ITARGETSR20rs {}
///`write(|w| ..)` method takes [`gicd_itargetsr20::W`](W) writer structure
impl crate::Writable for GICD_ITARGETSR20rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICD_ITARGETSR20 to value 0
impl crate::Resettable for GICD_ITARGETSR20rs {
