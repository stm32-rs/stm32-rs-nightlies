#[doc = "Reader of register GICD_ITARGETSR20"]
pub type R = crate::R<u32, super::GICD_ITARGETSR20>;
#[doc = "Writer for register GICD_ITARGETSR20"]
pub type W = crate::W<u32, super::GICD_ITARGETSR20>;
#[doc = "Register GICD_ITARGETSR20 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ITARGETSR20 {
    type Type = u32;
    #[inline(always)]
