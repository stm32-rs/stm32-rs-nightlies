#[doc = "Reader of register GICD_ITARGETSR26"]
pub type R = crate::R<u32, super::GICD_ITARGETSR26>;
#[doc = "Writer for register GICD_ITARGETSR26"]
pub type W = crate::W<u32, super::GICD_ITARGETSR26>;
#[doc = "Register GICD_ITARGETSR26 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ITARGETSR26 {
    type Type = u32;
    #[inline(always)]
