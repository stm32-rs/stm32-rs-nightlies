#[doc = "Reader of register GICD_ITARGETSR27"]
pub type R = crate::R<u32, super::GICD_ITARGETSR27>;
#[doc = "Writer for register GICD_ITARGETSR27"]
pub type W = crate::W<u32, super::GICD_ITARGETSR27>;
#[doc = "Register GICD_ITARGETSR27 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ITARGETSR27 {
    type Type = u32;
    #[inline(always)]
