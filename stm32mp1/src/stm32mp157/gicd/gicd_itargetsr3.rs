///Register `GICD_ITARGETSR3` reader
...
You can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:GICD_ITARGETSR3)*/
pub struct GICD_ITARGETSR3rs;
impl crate::RegisterSpec for GICD_ITARGETSR3rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_itargetsr3::R`](R) reader structure
impl crate::Readable for GICD_ITARGETSR3rs {}
///`reset()` method sets GICD_ITARGETSR3 to value 0
