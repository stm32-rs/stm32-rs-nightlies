...
pub type R = crate::R<GICD_ITARGETSR5rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:GICD_ITARGETSR5)*/
pub struct GICD_ITARGETSR5rs;
impl crate::RegisterSpec for GICD_ITARGETSR5rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_itargetsr5::R`](R) reader structure
impl crate::Readable for GICD_ITARGETSR5rs {}
///`reset()` method sets GICD_ITARGETSR5 to value 0
impl crate::Resettable for GICD_ITARGETSR5rs {
