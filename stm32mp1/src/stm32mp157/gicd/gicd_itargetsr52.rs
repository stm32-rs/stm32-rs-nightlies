#[doc = "Reader of register GICD_ITARGETSR52"]
pub type R = crate::R<u32, super::GICD_ITARGETSR52>;
#[doc = "Writer for register GICD_ITARGETSR52"]
pub type W = crate::W<u32, super::GICD_ITARGETSR52>;
#[doc = "Register GICD_ITARGETSR52 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ITARGETSR52 {
    type Type = u32;
    #[inline(always)]
