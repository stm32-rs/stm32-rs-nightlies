#[doc = "Reader of register GICD_ITARGETSR54"]
pub type R = crate::R<u32, super::GICD_ITARGETSR54>;
#[doc = "Writer for register GICD_ITARGETSR54"]
pub type W = crate::W<u32, super::GICD_ITARGETSR54>;
#[doc = "Register GICD_ITARGETSR54 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ITARGETSR54 {
    type Type = u32;
    #[inline(always)]
