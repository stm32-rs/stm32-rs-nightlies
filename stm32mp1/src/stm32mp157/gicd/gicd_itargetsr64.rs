#[doc = "Reader of register GICD_ITARGETSR64"]
pub type R = crate::R<u32, super::GICD_ITARGETSR64>;
#[doc = "Writer for register GICD_ITARGETSR64"]
pub type W = crate::W<u32, super::GICD_ITARGETSR64>;
#[doc = "Register GICD_ITARGETSR64 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ITARGETSR64 {
    type Type = u32;
    #[inline(always)]
