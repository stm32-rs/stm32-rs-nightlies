#[doc = "Reader of register GICD_ITARGETSR66"]
pub type R = crate::R<u32, super::GICD_ITARGETSR66>;
#[doc = "Writer for register GICD_ITARGETSR66"]
pub type W = crate::W<u32, super::GICD_ITARGETSR66>;
#[doc = "Register GICD_ITARGETSR66 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ITARGETSR66 {
    type Type = u32;
    #[inline(always)]
