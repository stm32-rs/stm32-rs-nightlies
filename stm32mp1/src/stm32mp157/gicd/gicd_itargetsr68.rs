#[doc = "Reader of register GICD_ITARGETSR68"]
pub type R = crate::R<u32, super::GICD_ITARGETSR68>;
#[doc = "Writer for register GICD_ITARGETSR68"]
pub type W = crate::W<u32, super::GICD_ITARGETSR68>;
#[doc = "Register GICD_ITARGETSR68 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_ITARGETSR68 {
    type Type = u32;
    #[inline(always)]
