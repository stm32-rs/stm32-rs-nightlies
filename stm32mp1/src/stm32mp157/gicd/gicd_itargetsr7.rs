///Register `GICD_ITARGETSR7` reader
pub type R = crate::R<GICD_ITARGETSR7rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:GICD_ITARGETSR7)*/
pub struct GICD_ITARGETSR7rs;
impl crate::RegisterSpec for GICD_ITARGETSR7rs {
    type Ux = u32;
}
///`read()` method returns [`gicd_itargetsr7::R`](R) reader structure
impl crate::Readable for GICD_ITARGETSR7rs {}
///`reset()` method sets GICD_ITARGETSR7 to value 0
impl crate::Resettable for GICD_ITARGETSR7rs {
