#[doc = "Reader of register GICD_SPENDSGIR2"]
pub type R = crate::R<u32, super::GICD_SPENDSGIR2>;
#[doc = "Writer for register GICD_SPENDSGIR2"]
pub type W = crate::W<u32, super::GICD_SPENDSGIR2>;
#[doc = "Register GICD_SPENDSGIR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_SPENDSGIR2 {
    type Type = u32;
    #[inline(always)]
