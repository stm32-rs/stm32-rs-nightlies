#[doc = "Reader of register GICD_SPENDSGIR3"]
pub type R = crate::R<u32, super::GICD_SPENDSGIR3>;
#[doc = "Writer for register GICD_SPENDSGIR3"]
pub type W = crate::W<u32, super::GICD_SPENDSGIR3>;
#[doc = "Register GICD_SPENDSGIR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::GICD_SPENDSGIR3 {
    type Type = u32;
    #[inline(always)]
