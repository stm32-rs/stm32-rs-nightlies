///Register `IPRIORITYR32` reader
pub type R = crate::R<IPRIORITYR32rs>;
///Register `IPRIORITYR32` writer
pub type W = crate::W<IPRIORITYR32rs>;
...
impl W {
    ///Bits 3:7 - PRIORITY0
    #[inline(always)]
    pub fn priority0(&mut self) -> PRIORITY0_W<'_, IPRIORITYR32rs> {
        PRIORITY0_W::new(self, 3)
    }
    ///Bits 11:15 - PRIORITY1
    #[inline(always)]
    pub fn priority1(&mut self) -> PRIORITY1_W<'_, IPRIORITYR32rs> {
        PRIORITY1_W::new(self, 11)
    }
    ///Bits 19:23 - PRIORITY2
    #[inline(always)]
    pub fn priority2(&mut self) -> PRIORITY2_W<'_, IPRIORITYR32rs> {
        PRIORITY2_W::new(self, 19)
    }
    ///Bits 27:31 - PRIORITY3
    #[inline(always)]
    pub fn priority3(&mut self) -> PRIORITY3_W<'_, IPRIORITYR32rs> {
        PRIORITY3_W::new(self, 27)
    }
}
/**GICD interrupt priority register 32

You can [`read`](crate::Reg::read) this register and get [`ipriorityr32::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ipriorityr32::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:IPRIORITYR32)*/
pub struct IPRIORITYR32rs;
impl crate::RegisterSpec for IPRIORITYR32rs {
    type Ux = u32;
}
///`read()` method returns [`ipriorityr32::R`](R) reader structure
impl crate::Readable for IPRIORITYR32rs {}
///`write(|w| ..)` method takes [`ipriorityr32::W`](W) writer structure
impl crate::Writable for IPRIORITYR32rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IPRIORITYR32 to value 0
impl crate::Resettable for IPRIORITYR32rs {}
