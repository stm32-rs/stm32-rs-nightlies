///Register `ITARGETSR0` reader
pub type R = crate::R<ITARGETSR0rs>;
...
You can [`read`](crate::Reg::read) this register and get [`itargetsr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:ITARGETSR0)*/
pub struct ITARGETSR0rs;
impl crate::RegisterSpec for ITARGETSR0rs {
    type Ux = u32;
}
///`read()` method returns [`itargetsr0::R`](R) reader structure
impl crate::Readable for ITARGETSR0rs {}
///`reset()` method sets ITARGETSR0 to value 0
impl crate::Resettable for ITARGETSR0rs {}
