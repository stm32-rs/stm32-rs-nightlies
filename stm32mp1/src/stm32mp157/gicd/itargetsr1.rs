///Register `ITARGETSR1` reader
pub type R = crate::R<ITARGETSR1rs>;
...
You can [`read`](crate::Reg::read) this register and get [`itargetsr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:ITARGETSR1)*/
pub struct ITARGETSR1rs;
impl crate::RegisterSpec for ITARGETSR1rs {
    type Ux = u32;
}
///`read()` method returns [`itargetsr1::R`](R) reader structure
impl crate::Readable for ITARGETSR1rs {}
///`reset()` method sets ITARGETSR1 to value 0
impl crate::Resettable for ITARGETSR1rs {}
