///Register `ITARGETSR3` reader
pub type R = crate::R<ITARGETSR3rs>;
...
You can [`read`](crate::Reg::read) this register and get [`itargetsr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:ITARGETSR3)*/
pub struct ITARGETSR3rs;
impl crate::RegisterSpec for ITARGETSR3rs {
    type Ux = u32;
}
///`read()` method returns [`itargetsr3::R`](R) reader structure
impl crate::Readable for ITARGETSR3rs {}
///`reset()` method sets ITARGETSR3 to value 0
impl crate::Resettable for ITARGETSR3rs {}
