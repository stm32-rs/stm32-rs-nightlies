///Register `ITARGETSR4` reader
pub type R = crate::R<ITARGETSR4rs>;
...
You can [`read`](crate::Reg::read) this register and get [`itargetsr4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:ITARGETSR4)*/
pub struct ITARGETSR4rs;
impl crate::RegisterSpec for ITARGETSR4rs {
    type Ux = u32;
}
///`read()` method returns [`itargetsr4::R`](R) reader structure
impl crate::Readable for ITARGETSR4rs {}
///`reset()` method sets ITARGETSR4 to value 0
impl crate::Resettable for ITARGETSR4rs {}
