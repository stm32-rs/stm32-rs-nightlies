...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_targets0(&mut self) -> CPU_TARGETS0_W<ITARGETSR60rs> {
        CPU_TARGETS0_W::new(self, 0)
    }
    ///Bits 8:9 - CPU_TARGETS1
    #[inline(always)]
    #[must_use]
    pub fn cpu_targets1(&mut self) -> CPU_TARGETS1_W<ITARGETSR60rs> {
        CPU_TARGETS1_W::new(self, 8)
    }
    ///Bits 16:17 - CPU_TARGETS2
    #[inline(always)]
    #[must_use]
    pub fn cpu_targets2(&mut self) -> CPU_TARGETS2_W<ITARGETSR60rs> {
        CPU_TARGETS2_W::new(self, 16)
    }
    ///Bits 24:25 - CPU_TARGETS3
    #[inline(always)]
    #[must_use]
    pub fn cpu_targets3(&mut self) -> CPU_TARGETS3_W<ITARGETSR60rs> {
