///Register `ITARGETSR7` reader
pub type R = crate::R<ITARGETSR7rs>;
...
You can [`read`](crate::Reg::read) this register and get [`itargetsr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICD:ITARGETSR7)*/
pub struct ITARGETSR7rs;
impl crate::RegisterSpec for ITARGETSR7rs {
    type Ux = u32;
}
///`read()` method returns [`itargetsr7::R`](R) reader structure
impl crate::Readable for ITARGETSR7rs {}
///`reset()` method sets ITARGETSR7 to value 0
impl crate::Resettable for ITARGETSR7rs {}
