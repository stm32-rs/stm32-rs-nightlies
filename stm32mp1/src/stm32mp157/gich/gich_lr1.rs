...
pub type R = crate::R<GICH_LR1rs>;
///Register `GICH_LR1` writer
pub type W = crate::W<GICH_LR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn virtualid(&mut self) -> VIRTUALID_W<GICH_LR1rs> {
        VIRTUALID_W::new(self, 0)
    }
    ///Bits 10:19 - PHYSICALID
    #[inline(always)]
    #[must_use]
    pub fn physicalid(&mut self) -> PHYSICALID_W<GICH_LR1rs> {
        PHYSICALID_W::new(self, 10)
    }
    ///Bits 23:27 - PRIORITY
    #[inline(always)]
    #[must_use]
    pub fn priority(&mut self) -> PRIORITY_W<GICH_LR1rs> {
        PRIORITY_W::new(self, 23)
    }
    ///Bits 28:29 - STATE
    #[inline(always)]
    #[must_use]
    pub fn state(&mut self) -> STATE_W<GICH_LR1rs> {
        STATE_W::new(self, 28)
    }
    ///Bit 30 - GRP1
    #[inline(always)]
    #[must_use]
    pub fn grp1(&mut self) -> GRP1_W<GICH_LR1rs> {
        GRP1_W::new(self, 30)
    }
    ///Bit 31 - HW
    #[inline(always)]
    #[must_use]
    pub fn hw(&mut self) -> HW_W<GICH_LR1rs> {
        HW_W::new(self, 31)
    }
}
/**GICH list register 1

You can [`read`](crate::Reg::read) this register and get [`gich_lr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gich_lr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICH:GICH_LR1)*/
pub struct GICH_LR1rs;
impl crate::RegisterSpec for GICH_LR1rs {
    type Ux = u32;
}
///`read()` method returns [`gich_lr1::R`](R) reader structure
impl crate::Readable for GICH_LR1rs {}
///`write(|w| ..)` method takes [`gich_lr1::W`](W) writer structure
impl crate::Writable for GICH_LR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GICH_LR1 to value 0
impl crate::Resettable for GICH_LR1rs {
