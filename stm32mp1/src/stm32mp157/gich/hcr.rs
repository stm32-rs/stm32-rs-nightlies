...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<HCRrs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - UIE
    #[inline(always)]
    #[must_use]
    pub fn uie(&mut self) -> UIE_W<HCRrs> {
        UIE_W::new(self, 1)
    }
    ///Bit 2 - LRENPIE
    #[inline(always)]
    #[must_use]
    pub fn lrenpie(&mut self) -> LRENPIE_W<HCRrs> {
        LRENPIE_W::new(self, 2)
    }
    ///Bit 3 - NPIE
    #[inline(always)]
    #[must_use]
    pub fn npie(&mut self) -> NPIE_W<HCRrs> {
        NPIE_W::new(self, 3)
    }
    ///Bit 4 - VGRP0EIE
    #[inline(always)]
    #[must_use]
    pub fn vgrp0eie(&mut self) -> VGRP0EIE_W<HCRrs> {
        VGRP0EIE_W::new(self, 4)
    }
    ///Bit 5 - VGRP0DIE
    #[inline(always)]
    #[must_use]
    pub fn vgrp0die(&mut self) -> VGRP0DIE_W<HCRrs> {
        VGRP0DIE_W::new(self, 5)
    }
    ///Bit 6 - VGRP1EIE
    #[inline(always)]
    #[must_use]
    pub fn vgrp1eie(&mut self) -> VGRP1EIE_W<HCRrs> {
        VGRP1EIE_W::new(self, 6)
    }
    ///Bit 7 - VGRP1DIE
    #[inline(always)]
    #[must_use]
    pub fn vgrp1die(&mut self) -> VGRP1DIE_W<HCRrs> {
        VGRP1DIE_W::new(self, 7)
    }
    ///Bits 27:31 - EOICOUNT
    #[inline(always)]
    #[must_use]
    pub fn eoicount(&mut self) -> EOICOUNT_W<HCRrs> {
