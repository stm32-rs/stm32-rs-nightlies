...
impl W {
    ///Bits 0:9 - VIRTUALID
    #[inline(always)]
    pub fn virtualid(&mut self) -> VIRTUALID_W<LR2rs> {
        VIRTUALID_W::new(self, 0)
    }
    ///Bits 10:19 - PHYSICALID
    #[inline(always)]
    pub fn physicalid(&mut self) -> PHYSICALID_W<LR2rs> {
        PHYSICALID_W::new(self, 10)
    }
    ///Bits 23:27 - PRIORITY
    #[inline(always)]
    pub fn priority(&mut self) -> PRIORITY_W<LR2rs> {
        PRIORITY_W::new(self, 23)
    }
    ///Bits 28:29 - STATE
    #[inline(always)]
    pub fn state(&mut self) -> STATE_W<LR2rs> {
        STATE_W::new(self, 28)
    }
    ///Bit 30 - GRP1
    #[inline(always)]
    pub fn grp1(&mut self) -> GRP1_W<LR2rs> {
        GRP1_W::new(self, 30)
    }
    ///Bit 31 - HW
    #[inline(always)]
    pub fn hw(&mut self) -> HW_W<LR2rs> {
        HW_W::new(self, 31)
    }
}
