///Register `LR2` reader
pub type R = crate::R<LR2rs>;
///Register `LR2` writer
pub type W = crate::W<LR2rs>;
...
impl W {
    ///Bits 0:9 - VIRTUALID
    #[inline(always)]
    pub fn virtualid(&mut self) -> VIRTUALID_W<'_, LR2rs> {
        VIRTUALID_W::new(self, 0)
    }
    ///Bits 10:19 - PHYSICALID
    #[inline(always)]
    pub fn physicalid(&mut self) -> PHYSICALID_W<'_, LR2rs> {
        PHYSICALID_W::new(self, 10)
    }
    ///Bits 23:27 - PRIORITY
    #[inline(always)]
    pub fn priority(&mut self) -> PRIORITY_W<'_, LR2rs> {
        PRIORITY_W::new(self, 23)
    }
    ///Bits 28:29 - STATE
    #[inline(always)]
    pub fn state(&mut self) -> STATE_W<'_, LR2rs> {
        STATE_W::new(self, 28)
    }
    ///Bit 30 - GRP1
    #[inline(always)]
    pub fn grp1(&mut self) -> GRP1_W<'_, LR2rs> {
        GRP1_W::new(self, 30)
    }
    ///Bit 31 - HW
    #[inline(always)]
    pub fn hw(&mut self) -> HW_W<'_, LR2rs> {
        HW_W::new(self, 31)
    }
}
/**GICH list register 2

You can [`read`](crate::Reg::read) this register and get [`lr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GICH:LR2)*/
pub struct LR2rs;
impl crate::RegisterSpec for LR2rs {
    type Ux = u32;
}
///`read()` method returns [`lr2::R`](R) reader structure
impl crate::Readable for LR2rs {}
///`write(|w| ..)` method takes [`lr2::W`](W) writer structure
impl crate::Writable for LR2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets LR2 to value 0
impl crate::Resettable for LR2rs {}
