...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vmgrp0en(&mut self) -> VMGRP0EN_W<VMCRrs> {
        VMGRP0EN_W::new(self, 0)
    }
    ///Bit 1 - VMGRP1EN
    #[inline(always)]
    #[must_use]
    pub fn vmgrp1en(&mut self) -> VMGRP1EN_W<VMCRrs> {
        VMGRP1EN_W::new(self, 1)
    }
    ///Bit 2 - VMACKCTL
    #[inline(always)]
    #[must_use]
    pub fn vmackctl(&mut self) -> VMACKCTL_W<VMCRrs> {
        VMACKCTL_W::new(self, 2)
    }
    ///Bit 3 - VMFIQEN
    #[inline(always)]
    #[must_use]
    pub fn vmfiqen(&mut self) -> VMFIQEN_W<VMCRrs> {
        VMFIQEN_W::new(self, 3)
    }
    ///Bit 4 - VMCBPR
    #[inline(always)]
    #[must_use]
    pub fn vmcbpr(&mut self) -> VMCBPR_W<VMCRrs> {
        VMCBPR_W::new(self, 4)
    }
    ///Bit 9 - VEM
    #[inline(always)]
    #[must_use]
    pub fn vem(&mut self) -> VEM_W<VMCRrs> {
        VEM_W::new(self, 9)
    }
    ///Bits 18:20 - VMABP
    #[inline(always)]
    #[must_use]
    pub fn vmabp(&mut self) -> VMABP_W<VMCRrs> {
        VMABP_W::new(self, 18)
    }
    ///Bits 21:23 - VMBP
    #[inline(always)]
    #[must_use]
    pub fn vmbp(&mut self) -> VMBP_W<VMCRrs> {
        VMBP_W::new(self, 21)
    }
    ///Bits 27:31 - VMPRIMASK
    #[inline(always)]
    #[must_use]
    pub fn vmprimask(&mut self) -> VMPRIMASK_W<VMCRrs> {
