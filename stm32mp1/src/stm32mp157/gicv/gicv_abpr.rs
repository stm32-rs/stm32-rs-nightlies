#[doc = "Reader of register GICV_ABPR"]
pub type R = crate::R<u32, super::GICV_ABPR>;
#[doc = "Writer for register GICV_ABPR"]
pub type W = crate::W<u32, super::GICV_ABPR>;
#[doc = "Register GICV_ABPR `reset()`'s with value 0x03"]
impl crate::ResetValue for super::GICV_ABPR {
    type Type = u32;
    #[inline(always)]
