#[doc = "Writer for register GICV_AEOIR"]
pub type W = crate::W<u32, super::GICV_AEOIR>;
#[doc = "Register GICV_AEOIR `reset()`'s with value 0"]
impl crate::ResetValue for super::GICV_AEOIR {
    type Type = u32;
    #[inline(always)]
