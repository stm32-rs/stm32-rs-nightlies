#[doc = "Reader of register GICV_BPR"]
pub type R = crate::R<u32, super::GICV_BPR>;
#[doc = "Writer for register GICV_BPR"]
pub type W = crate::W<u32, super::GICV_BPR>;
#[doc = "Register GICV_BPR `reset()`'s with value 0x02"]
impl crate::ResetValue for super::GICV_BPR {
    type Type = u32;
    #[inline(always)]
