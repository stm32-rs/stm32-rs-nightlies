#[doc = "Writer for register GPIOA_BRR"]
pub type W = crate::W<u32, super::GPIOA_BRR>;
#[doc = "Register GPIOA_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOA_BRR {
    type Type = u32;
    #[inline(always)]
