#[doc = "Writer for register GPIOA_BSRR"]
pub type W = crate::W<u32, super::GPIOA_BSRR>;
#[doc = "Register GPIOA_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOA_BSRR {
    type Type = u32;
    #[inline(always)]
