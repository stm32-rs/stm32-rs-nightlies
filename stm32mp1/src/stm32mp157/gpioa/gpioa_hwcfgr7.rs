///Register `GPIOA_HWCFGR7` reader
pub type R = crate::R<GPIOA_HWCFGR7rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioa_hwcfgr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOA:GPIOA_HWCFGR7)*/
pub struct GPIOA_HWCFGR7rs;
impl crate::RegisterSpec for GPIOA_HWCFGR7rs {
    type Ux = u32;
}
///`read()` method returns [`gpioa_hwcfgr7::R`](R) reader structure
impl crate::Readable for GPIOA_HWCFGR7rs {}
///`reset()` method sets GPIOA_HWCFGR7 to value 0xffff_ffff
impl crate::Resettable for GPIOA_HWCFGR7rs {
