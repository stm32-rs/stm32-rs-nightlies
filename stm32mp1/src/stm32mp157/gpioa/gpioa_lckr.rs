...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lck0(&mut self) -> LCK0_W<GPIOA_LCKRrs> {
        LCK0_W::new(self, 0)
    }
    ///Bit 1 - LCK1
    #[inline(always)]
    #[must_use]
    pub fn lck1(&mut self) -> LCK1_W<GPIOA_LCKRrs> {
        LCK1_W::new(self, 1)
    }
    ///Bit 2 - LCK2
    #[inline(always)]
    #[must_use]
    pub fn lck2(&mut self) -> LCK2_W<GPIOA_LCKRrs> {
        LCK2_W::new(self, 2)
    }
    ///Bit 3 - LCK3
    #[inline(always)]
    #[must_use]
    pub fn lck3(&mut self) -> LCK3_W<GPIOA_LCKRrs> {
        LCK3_W::new(self, 3)
    }
    ///Bit 4 - LCK4
    #[inline(always)]
    #[must_use]
    pub fn lck4(&mut self) -> LCK4_W<GPIOA_LCKRrs> {
        LCK4_W::new(self, 4)
    }
    ///Bit 5 - LCK5
    #[inline(always)]
    #[must_use]
    pub fn lck5(&mut self) -> LCK5_W<GPIOA_LCKRrs> {
        LCK5_W::new(self, 5)
    }
    ///Bit 6 - LCK6
    #[inline(always)]
    #[must_use]
    pub fn lck6(&mut self) -> LCK6_W<GPIOA_LCKRrs> {
        LCK6_W::new(self, 6)
    }
    ///Bit 7 - LCK7
    #[inline(always)]
    #[must_use]
    pub fn lck7(&mut self) -> LCK7_W<GPIOA_LCKRrs> {
        LCK7_W::new(self, 7)
    }
    ///Bit 8 - LCK8
    #[inline(always)]
    #[must_use]
    pub fn lck8(&mut self) -> LCK8_W<GPIOA_LCKRrs> {
        LCK8_W::new(self, 8)
    }
    ///Bit 9 - LCK9
    #[inline(always)]
    #[must_use]
    pub fn lck9(&mut self) -> LCK9_W<GPIOA_LCKRrs> {
        LCK9_W::new(self, 9)
    }
    ///Bit 10 - LCK10
    #[inline(always)]
    #[must_use]
    pub fn lck10(&mut self) -> LCK10_W<GPIOA_LCKRrs> {
        LCK10_W::new(self, 10)
    }
    ///Bit 11 - LCK11
    #[inline(always)]
    #[must_use]
    pub fn lck11(&mut self) -> LCK11_W<GPIOA_LCKRrs> {
        LCK11_W::new(self, 11)
    }
    ///Bit 12 - LCK12
    #[inline(always)]
    #[must_use]
    pub fn lck12(&mut self) -> LCK12_W<GPIOA_LCKRrs> {
        LCK12_W::new(self, 12)
    }
    ///Bit 13 - LCK13
    #[inline(always)]
    #[must_use]
    pub fn lck13(&mut self) -> LCK13_W<GPIOA_LCKRrs> {
        LCK13_W::new(self, 13)
    }
    ///Bit 14 - LCK14
    #[inline(always)]
    #[must_use]
    pub fn lck14(&mut self) -> LCK14_W<GPIOA_LCKRrs> {
        LCK14_W::new(self, 14)
    }
    ///Bit 15 - LCK15
    #[inline(always)]
    #[must_use]
    pub fn lck15(&mut self) -> LCK15_W<GPIOA_LCKRrs> {
        LCK15_W::new(self, 15)
    }
    ///Bit 16 - LCKK
    #[inline(always)]
    #[must_use]
    pub fn lckk(&mut self) -> LCKK_W<GPIOA_LCKRrs> {
        LCKK_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOA:GPIOA_LCKR)*/
