...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn odr0(&mut self) -> ODR0_W<GPIOA_ODRrs> {
        ODR0_W::new(self, 0)
    }
    #[doc = "Bit 1 - ODR1"]
    #[inline(always)]
    #[must_use]
    pub fn odr1(&mut self) -> ODR1_W<GPIOA_ODRrs> {
        ODR1_W::new(self, 1)
    }
    #[doc = "Bit 2 - ODR2"]
    #[inline(always)]
    #[must_use]
    pub fn odr2(&mut self) -> ODR2_W<GPIOA_ODRrs> {
        ODR2_W::new(self, 2)
    }
    #[doc = "Bit 3 - ODR3"]
    #[inline(always)]
    #[must_use]
    pub fn odr3(&mut self) -> ODR3_W<GPIOA_ODRrs> {
        ODR3_W::new(self, 3)
    }
    #[doc = "Bit 4 - ODR4"]
    #[inline(always)]
    #[must_use]
    pub fn odr4(&mut self) -> ODR4_W<GPIOA_ODRrs> {
        ODR4_W::new(self, 4)
    }
    #[doc = "Bit 5 - ODR5"]
    #[inline(always)]
    #[must_use]
    pub fn odr5(&mut self) -> ODR5_W<GPIOA_ODRrs> {
        ODR5_W::new(self, 5)
    }
    #[doc = "Bit 6 - ODR6"]
    #[inline(always)]
    #[must_use]
    pub fn odr6(&mut self) -> ODR6_W<GPIOA_ODRrs> {
        ODR6_W::new(self, 6)
    }
    #[doc = "Bit 7 - ODR7"]
    #[inline(always)]
    #[must_use]
    pub fn odr7(&mut self) -> ODR7_W<GPIOA_ODRrs> {
        ODR7_W::new(self, 7)
    }
    #[doc = "Bit 8 - ODR8"]
    #[inline(always)]
    #[must_use]
    pub fn odr8(&mut self) -> ODR8_W<GPIOA_ODRrs> {
        ODR8_W::new(self, 8)
    }
    #[doc = "Bit 9 - ODR9"]
    #[inline(always)]
    #[must_use]
    pub fn odr9(&mut self) -> ODR9_W<GPIOA_ODRrs> {
        ODR9_W::new(self, 9)
    }
    #[doc = "Bit 10 - ODR10"]
    #[inline(always)]
    #[must_use]
    pub fn odr10(&mut self) -> ODR10_W<GPIOA_ODRrs> {
        ODR10_W::new(self, 10)
    }
    #[doc = "Bit 11 - ODR11"]
    #[inline(always)]
    #[must_use]
    pub fn odr11(&mut self) -> ODR11_W<GPIOA_ODRrs> {
        ODR11_W::new(self, 11)
    }
    #[doc = "Bit 12 - ODR12"]
    #[inline(always)]
    #[must_use]
    pub fn odr12(&mut self) -> ODR12_W<GPIOA_ODRrs> {
        ODR12_W::new(self, 12)
    }
    #[doc = "Bit 13 - ODR13"]
    #[inline(always)]
    #[must_use]
    pub fn odr13(&mut self) -> ODR13_W<GPIOA_ODRrs> {
        ODR13_W::new(self, 13)
    }
    #[doc = "Bit 14 - ODR14"]
    #[inline(always)]
    #[must_use]
    pub fn odr14(&mut self) -> ODR14_W<GPIOA_ODRrs> {
        ODR14_W::new(self, 14)
    }
    #[doc = "Bit 15 - ODR15"]
    #[inline(always)]
    #[must_use]
    pub fn odr15(&mut self) -> ODR15_W<GPIOA_ODRrs> {
        ODR15_W::new(self, 15)
    }
}
#[doc = "GPIO port output data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpioa_odr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpioa_odr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
