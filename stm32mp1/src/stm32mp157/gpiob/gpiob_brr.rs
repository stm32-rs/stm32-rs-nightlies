#[doc = "Writer for register GPIOB_BRR"]
pub type W = crate::W<u32, super::GPIOB_BRR>;
#[doc = "Register GPIOB_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOB_BRR {
    type Type = u32;
    #[inline(always)]
