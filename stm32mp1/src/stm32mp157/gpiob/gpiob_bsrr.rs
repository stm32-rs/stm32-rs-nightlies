#[doc = "Writer for register GPIOB_BSRR"]
pub type W = crate::W<u32, super::GPIOB_BSRR>;
#[doc = "Register GPIOB_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOB_BSRR {
    type Type = u32;
    #[inline(always)]
