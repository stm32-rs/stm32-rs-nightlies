...
You can [`read`](crate::Reg::read) this register and get [`gpiob_hwcfgr2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`gpiob_hwcfgr2::R`](R) reader structure
impl crate::Readable for GPIOB_HWCFGR2rs {}
///`reset()` method sets GPIOB_HWCFGR2 to value 0
