///Register `GPIOB_HWCFGR8` reader
pub type R = crate::R<GPIOB_HWCFGR8rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiob_hwcfgr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOB:GPIOB_HWCFGR8)*/
pub struct GPIOB_HWCFGR8rs;
impl crate::RegisterSpec for GPIOB_HWCFGR8rs {
    type Ux = u32;
}
///`read()` method returns [`gpiob_hwcfgr8::R`](R) reader structure
impl crate::Readable for GPIOB_HWCFGR8rs {}
///`reset()` method sets GPIOB_HWCFGR8 to value 0
impl crate::Resettable for GPIOB_HWCFGR8rs {
