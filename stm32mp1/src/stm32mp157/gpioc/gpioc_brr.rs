#[doc = "Writer for register GPIOC_BRR"]
pub type W = crate::W<u32, super::GPIOC_BRR>;
#[doc = "Register GPIOC_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOC_BRR {
    type Type = u32;
    #[inline(always)]
