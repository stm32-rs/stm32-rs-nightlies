#[doc = "Writer for register GPIOC_BSRR"]
pub type W = crate::W<u32, super::GPIOC_BSRR>;
#[doc = "Register GPIOC_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOC_BSRR {
    type Type = u32;
    #[inline(always)]
