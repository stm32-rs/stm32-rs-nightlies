...
pub type R = crate::R<GPIOC_HWCFGR1rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioc_hwcfgr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOC:GPIOC_HWCFGR1)*/
pub struct GPIOC_HWCFGR1rs;
impl crate::RegisterSpec for GPIOC_HWCFGR1rs {
    type Ux = u32;
}
///`read()` method returns [`gpioc_hwcfgr1::R`](R) reader structure
impl crate::Readable for GPIOC_HWCFGR1rs {}
///`reset()` method sets GPIOC_HWCFGR1 to value 0
impl crate::Resettable for GPIOC_HWCFGR1rs {
