#[doc = "Writer for register GPIOD_BRR"]
pub type W = crate::W<u32, super::GPIOD_BRR>;
#[doc = "Register GPIOD_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOD_BRR {
    type Type = u32;
    #[inline(always)]
