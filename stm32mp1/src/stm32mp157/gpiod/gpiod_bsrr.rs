#[doc = "Writer for register GPIOD_BSRR"]
pub type W = crate::W<u32, super::GPIOD_BSRR>;
#[doc = "Register GPIOD_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOD_BSRR {
    type Type = u32;
    #[inline(always)]
