...
pub type R = crate::R<GPIOD_HWCFGR3rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiod_hwcfgr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOD:GPIOD_HWCFGR3)*/
pub struct GPIOD_HWCFGR3rs;
impl crate::RegisterSpec for GPIOD_HWCFGR3rs {
    type Ux = u32;
}
///`read()` method returns [`gpiod_hwcfgr3::R`](R) reader structure
impl crate::Readable for GPIOD_HWCFGR3rs {}
///`reset()` method sets GPIOD_HWCFGR3 to value 0
impl crate::Resettable for GPIOD_HWCFGR3rs {
