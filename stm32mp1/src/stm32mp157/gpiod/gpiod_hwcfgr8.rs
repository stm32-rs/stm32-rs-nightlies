...
pub type R = crate::R<GPIOD_HWCFGR8rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiod_hwcfgr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOD:GPIOD_HWCFGR8)*/
pub struct GPIOD_HWCFGR8rs;
impl crate::RegisterSpec for GPIOD_HWCFGR8rs {
    type Ux = u32;
}
///`read()` method returns [`gpiod_hwcfgr8::R`](R) reader structure
impl crate::Readable for GPIOD_HWCFGR8rs {}
///`reset()` method sets GPIOD_HWCFGR8 to value 0
impl crate::Resettable for GPIOD_HWCFGR8rs {
