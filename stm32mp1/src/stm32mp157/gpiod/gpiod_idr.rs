///Register `GPIOD_IDR` reader
pub type R = crate::R<GPIOD_IDRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiod_idr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOD:GPIOD_IDR)*/
pub struct GPIOD_IDRrs;
impl crate::RegisterSpec for GPIOD_IDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpiod_idr::R`](R) reader structure
impl crate::Readable for GPIOD_IDRrs {}
///`reset()` method sets GPIOD_IDR to value 0
impl crate::Resettable for GPIOD_IDRrs {
