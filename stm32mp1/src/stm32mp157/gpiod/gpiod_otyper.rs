...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ot0(&mut self) -> OT0_W<GPIOD_OTYPERrs> {
        OT0_W::new(self, 0)
    }
    ///Bit 1 - OT1
    #[inline(always)]
    #[must_use]
    pub fn ot1(&mut self) -> OT1_W<GPIOD_OTYPERrs> {
        OT1_W::new(self, 1)
    }
    ///Bit 2 - OT2
    #[inline(always)]
    #[must_use]
    pub fn ot2(&mut self) -> OT2_W<GPIOD_OTYPERrs> {
        OT2_W::new(self, 2)
    }
    ///Bit 3 - OT3
    #[inline(always)]
    #[must_use]
    pub fn ot3(&mut self) -> OT3_W<GPIOD_OTYPERrs> {
        OT3_W::new(self, 3)
    }
    ///Bit 4 - OT4
    #[inline(always)]
    #[must_use]
    pub fn ot4(&mut self) -> OT4_W<GPIOD_OTYPERrs> {
        OT4_W::new(self, 4)
    }
    ///Bit 5 - OT5
    #[inline(always)]
    #[must_use]
    pub fn ot5(&mut self) -> OT5_W<GPIOD_OTYPERrs> {
        OT5_W::new(self, 5)
    }
    ///Bit 6 - OT6
    #[inline(always)]
    #[must_use]
    pub fn ot6(&mut self) -> OT6_W<GPIOD_OTYPERrs> {
        OT6_W::new(self, 6)
    }
    ///Bit 7 - OT7
    #[inline(always)]
    #[must_use]
    pub fn ot7(&mut self) -> OT7_W<GPIOD_OTYPERrs> {
        OT7_W::new(self, 7)
    }
    ///Bit 8 - OT8
    #[inline(always)]
    #[must_use]
    pub fn ot8(&mut self) -> OT8_W<GPIOD_OTYPERrs> {
        OT8_W::new(self, 8)
    }
    ///Bit 9 - OT9
    #[inline(always)]
    #[must_use]
    pub fn ot9(&mut self) -> OT9_W<GPIOD_OTYPERrs> {
        OT9_W::new(self, 9)
    }
    ///Bit 10 - OT10
    #[inline(always)]
    #[must_use]
    pub fn ot10(&mut self) -> OT10_W<GPIOD_OTYPERrs> {
        OT10_W::new(self, 10)
    }
    ///Bit 11 - OT11
    #[inline(always)]
    #[must_use]
    pub fn ot11(&mut self) -> OT11_W<GPIOD_OTYPERrs> {
        OT11_W::new(self, 11)
    }
    ///Bit 12 - OT12
    #[inline(always)]
    #[must_use]
    pub fn ot12(&mut self) -> OT12_W<GPIOD_OTYPERrs> {
        OT12_W::new(self, 12)
    }
    ///Bit 13 - OT13
    #[inline(always)]
    #[must_use]
    pub fn ot13(&mut self) -> OT13_W<GPIOD_OTYPERrs> {
        OT13_W::new(self, 13)
    }
    ///Bit 14 - OT14
    #[inline(always)]
    #[must_use]
    pub fn ot14(&mut self) -> OT14_W<GPIOD_OTYPERrs> {
        OT14_W::new(self, 14)
    }
    ///Bit 15 - OT15
    #[inline(always)]
    #[must_use]
    pub fn ot15(&mut self) -> OT15_W<GPIOD_OTYPERrs> {
        OT15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOD:GPIOD_OTYPER)*/
