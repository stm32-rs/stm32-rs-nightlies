#[doc = "Writer for register GPIOE_BRR"]
pub type W = crate::W<u32, super::GPIOE_BRR>;
#[doc = "Register GPIOE_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOE_BRR {
    type Type = u32;
    #[inline(always)]
