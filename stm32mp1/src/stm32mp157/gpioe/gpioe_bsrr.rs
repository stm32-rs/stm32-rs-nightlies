#[doc = "Writer for register GPIOE_BSRR"]
pub type W = crate::W<u32, super::GPIOE_BSRR>;
#[doc = "Register GPIOE_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOE_BSRR {
    type Type = u32;
    #[inline(always)]
