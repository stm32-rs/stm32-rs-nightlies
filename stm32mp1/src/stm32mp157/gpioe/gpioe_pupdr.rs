...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pupdr0(&mut self) -> PUPDR0_W<GPIOE_PUPDRrs> {
        PUPDR0_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - PUPDR1"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr1(&mut self) -> PUPDR1_W<GPIOE_PUPDRrs> {
        PUPDR1_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - PUPDR2"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr2(&mut self) -> PUPDR2_W<GPIOE_PUPDRrs> {
        PUPDR2_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - PUPDR3"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr3(&mut self) -> PUPDR3_W<GPIOE_PUPDRrs> {
        PUPDR3_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - PUPDR4"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr4(&mut self) -> PUPDR4_W<GPIOE_PUPDRrs> {
        PUPDR4_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - PUPDR5"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr5(&mut self) -> PUPDR5_W<GPIOE_PUPDRrs> {
        PUPDR5_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - PUPDR6"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr6(&mut self) -> PUPDR6_W<GPIOE_PUPDRrs> {
        PUPDR6_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - PUPDR7"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr7(&mut self) -> PUPDR7_W<GPIOE_PUPDRrs> {
        PUPDR7_W::new(self, 14)
    }
    #[doc = "Bits 16:17 - PUPDR8"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr8(&mut self) -> PUPDR8_W<GPIOE_PUPDRrs> {
        PUPDR8_W::new(self, 16)
    }
    #[doc = "Bits 18:19 - PUPDR9"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr9(&mut self) -> PUPDR9_W<GPIOE_PUPDRrs> {
        PUPDR9_W::new(self, 18)
    }
    #[doc = "Bits 20:21 - PUPDR10"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr10(&mut self) -> PUPDR10_W<GPIOE_PUPDRrs> {
        PUPDR10_W::new(self, 20)
    }
    #[doc = "Bits 22:23 - PUPDR11"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr11(&mut self) -> PUPDR11_W<GPIOE_PUPDRrs> {
        PUPDR11_W::new(self, 22)
    }
    #[doc = "Bits 24:25 - PUPDR12"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr12(&mut self) -> PUPDR12_W<GPIOE_PUPDRrs> {
        PUPDR12_W::new(self, 24)
    }
    #[doc = "Bits 26:27 - PUPDR13"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr13(&mut self) -> PUPDR13_W<GPIOE_PUPDRrs> {
        PUPDR13_W::new(self, 26)
    }
    #[doc = "Bits 28:29 - PUPDR14"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr14(&mut self) -> PUPDR14_W<GPIOE_PUPDRrs> {
        PUPDR14_W::new(self, 28)
    }
    #[doc = "Bits 30:31 - PUPDR15"]
    #[inline(always)]
    #[must_use]
    pub fn pupdr15(&mut self) -> PUPDR15_W<GPIOE_PUPDRrs> {
        PUPDR15_W::new(self, 30)
    }
}
#[doc = "GPIO port pull-up/pull-down register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpioe_pupdr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpioe_pupdr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
