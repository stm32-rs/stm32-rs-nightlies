#[doc = "Writer for register GPIOF_BRR"]
pub type W = crate::W<u32, super::GPIOF_BRR>;
#[doc = "Register GPIOF_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOF_BRR {
    type Type = u32;
    #[inline(always)]
