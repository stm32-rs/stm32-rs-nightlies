#[doc = "Writer for register GPIOF_BSRR"]
pub type W = crate::W<u32, super::GPIOF_BSRR>;
#[doc = "Register GPIOF_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOF_BSRR {
    type Type = u32;
    #[inline(always)]
