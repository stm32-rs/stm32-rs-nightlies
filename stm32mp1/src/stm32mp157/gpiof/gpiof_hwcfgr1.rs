...
You can [`read`](crate::Reg::read) this register and get [`gpiof_hwcfgr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOF:GPIOF_HWCFGR1)*/
pub struct GPIOF_HWCFGR1rs;
impl crate::RegisterSpec for GPIOF_HWCFGR1rs {
    type Ux = u32;
}
///`read()` method returns [`gpiof_hwcfgr1::R`](R) reader structure
impl crate::Readable for GPIOF_HWCFGR1rs {}
///`reset()` method sets GPIOF_HWCFGR1 to value 0
