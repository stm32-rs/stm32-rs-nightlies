...
pub type R = crate::R<GPIOF_HWCFGR10rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiof_hwcfgr10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOF:GPIOF_HWCFGR10)*/
pub struct GPIOF_HWCFGR10rs;
impl crate::RegisterSpec for GPIOF_HWCFGR10rs {
    type Ux = u32;
}
///`read()` method returns [`gpiof_hwcfgr10::R`](R) reader structure
impl crate::Readable for GPIOF_HWCFGR10rs {}
///`reset()` method sets GPIOF_HWCFGR10 to value 0x0001_1240
impl crate::Resettable for GPIOF_HWCFGR10rs {
