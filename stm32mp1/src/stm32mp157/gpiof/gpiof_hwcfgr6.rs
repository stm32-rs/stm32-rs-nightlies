...
You can [`read`](crate::Reg::read) this register and get [`gpiof_hwcfgr6::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOF:GPIOF_HWCFGR6)*/
pub struct GPIOF_HWCFGR6rs;
impl crate::RegisterSpec for GPIOF_HWCFGR6rs {
    type Ux = u32;
}
///`read()` method returns [`gpiof_hwcfgr6::R`](R) reader structure
impl crate::Readable for GPIOF_HWCFGR6rs {}
///`reset()` method sets GPIOF_HWCFGR6 to value 0xffff_ffff
