///Register `GPIOF_HWCFGR8` reader
pub type R = crate::R<GPIOF_HWCFGR8rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiof_hwcfgr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOF:GPIOF_HWCFGR8)*/
pub struct GPIOF_HWCFGR8rs;
impl crate::RegisterSpec for GPIOF_HWCFGR8rs {
    type Ux = u32;
}
///`read()` method returns [`gpiof_hwcfgr8::R`](R) reader structure
impl crate::Readable for GPIOF_HWCFGR8rs {}
///`reset()` method sets GPIOF_HWCFGR8 to value 0
impl crate::Resettable for GPIOF_HWCFGR8rs {
