#[doc = "Writer for register GPIOG_BRR"]
pub type W = crate::W<u32, super::GPIOG_BRR>;
#[doc = "Register GPIOG_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOG_BRR {
    type Type = u32;
    #[inline(always)]
