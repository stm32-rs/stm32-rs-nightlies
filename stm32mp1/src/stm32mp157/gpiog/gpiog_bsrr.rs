#[doc = "Writer for register GPIOG_BSRR"]
pub type W = crate::W<u32, super::GPIOG_BSRR>;
#[doc = "Register GPIOG_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOG_BSRR {
    type Type = u32;
    #[inline(always)]
