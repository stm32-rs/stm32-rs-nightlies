...
pub type R = crate::R<GPIOG_HWCFGR3rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiog_hwcfgr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOG:GPIOG_HWCFGR3)*/
pub struct GPIOG_HWCFGR3rs;
impl crate::RegisterSpec for GPIOG_HWCFGR3rs {
    type Ux = u32;
}
///`read()` method returns [`gpiog_hwcfgr3::R`](R) reader structure
impl crate::Readable for GPIOG_HWCFGR3rs {}
///`reset()` method sets GPIOG_HWCFGR3 to value 0
impl crate::Resettable for GPIOG_HWCFGR3rs {
