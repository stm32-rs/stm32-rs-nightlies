...
pub type R = crate::R<GPIOG_HWCFGR4rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiog_hwcfgr4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOG:GPIOG_HWCFGR4)*/
pub struct GPIOG_HWCFGR4rs;
impl crate::RegisterSpec for GPIOG_HWCFGR4rs {
    type Ux = u32;
}
///`read()` method returns [`gpiog_hwcfgr4::R`](R) reader structure
impl crate::Readable for GPIOG_HWCFGR4rs {}
///`reset()` method sets GPIOG_HWCFGR4 to value 0
impl crate::Resettable for GPIOG_HWCFGR4rs {
