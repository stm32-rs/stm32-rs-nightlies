...
You can [`read`](crate::Reg::read) this register and get [`gpiog_hwcfgr6::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`gpiog_hwcfgr6::R`](R) reader structure
impl crate::Readable for GPIOG_HWCFGR6rs {}
///`reset()` method sets GPIOG_HWCFGR6 to value 0xffff_ffff
