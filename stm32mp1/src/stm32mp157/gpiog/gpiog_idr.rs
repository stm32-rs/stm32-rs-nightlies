///Register `GPIOG_IDR` reader
pub type R = crate::R<GPIOG_IDRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiog_idr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOG:GPIOG_IDR)*/
pub struct GPIOG_IDRrs;
impl crate::RegisterSpec for GPIOG_IDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpiog_idr::R`](R) reader structure
impl crate::Readable for GPIOG_IDRrs {}
///`reset()` method sets GPIOG_IDR to value 0
impl crate::Resettable for GPIOG_IDRrs {
