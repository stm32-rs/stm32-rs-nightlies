...
pub type R = crate::R<GPIOG_ODRrs>;
///Register `GPIOG_ODR` writer
pub type W = crate::W<GPIOG_ODRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn odr0(&mut self) -> ODR0_W<GPIOG_ODRrs> {
        ODR0_W::new(self, 0)
    }
    ///Bit 1 - ODR1
    #[inline(always)]
    #[must_use]
    pub fn odr1(&mut self) -> ODR1_W<GPIOG_ODRrs> {
        ODR1_W::new(self, 1)
    }
    ///Bit 2 - ODR2
    #[inline(always)]
    #[must_use]
    pub fn odr2(&mut self) -> ODR2_W<GPIOG_ODRrs> {
        ODR2_W::new(self, 2)
    }
    ///Bit 3 - ODR3
    #[inline(always)]
    #[must_use]
    pub fn odr3(&mut self) -> ODR3_W<GPIOG_ODRrs> {
        ODR3_W::new(self, 3)
    }
    ///Bit 4 - ODR4
    #[inline(always)]
    #[must_use]
    pub fn odr4(&mut self) -> ODR4_W<GPIOG_ODRrs> {
        ODR4_W::new(self, 4)
    }
    ///Bit 5 - ODR5
    #[inline(always)]
    #[must_use]
    pub fn odr5(&mut self) -> ODR5_W<GPIOG_ODRrs> {
        ODR5_W::new(self, 5)
    }
    ///Bit 6 - ODR6
    #[inline(always)]
    #[must_use]
    pub fn odr6(&mut self) -> ODR6_W<GPIOG_ODRrs> {
        ODR6_W::new(self, 6)
    }
    ///Bit 7 - ODR7
    #[inline(always)]
    #[must_use]
    pub fn odr7(&mut self) -> ODR7_W<GPIOG_ODRrs> {
        ODR7_W::new(self, 7)
    }
    ///Bit 8 - ODR8
    #[inline(always)]
    #[must_use]
    pub fn odr8(&mut self) -> ODR8_W<GPIOG_ODRrs> {
        ODR8_W::new(self, 8)
    }
    ///Bit 9 - ODR9
    #[inline(always)]
    #[must_use]
    pub fn odr9(&mut self) -> ODR9_W<GPIOG_ODRrs> {
        ODR9_W::new(self, 9)
    }
    ///Bit 10 - ODR10
    #[inline(always)]
    #[must_use]
    pub fn odr10(&mut self) -> ODR10_W<GPIOG_ODRrs> {
        ODR10_W::new(self, 10)
    }
    ///Bit 11 - ODR11
    #[inline(always)]
    #[must_use]
    pub fn odr11(&mut self) -> ODR11_W<GPIOG_ODRrs> {
        ODR11_W::new(self, 11)
    }
    ///Bit 12 - ODR12
    #[inline(always)]
    #[must_use]
    pub fn odr12(&mut self) -> ODR12_W<GPIOG_ODRrs> {
        ODR12_W::new(self, 12)
    }
    ///Bit 13 - ODR13
    #[inline(always)]
    #[must_use]
    pub fn odr13(&mut self) -> ODR13_W<GPIOG_ODRrs> {
        ODR13_W::new(self, 13)
    }
    ///Bit 14 - ODR14
    #[inline(always)]
    #[must_use]
    pub fn odr14(&mut self) -> ODR14_W<GPIOG_ODRrs> {
        ODR14_W::new(self, 14)
    }
    ///Bit 15 - ODR15
    #[inline(always)]
    #[must_use]
    pub fn odr15(&mut self) -> ODR15_W<GPIOG_ODRrs> {
        ODR15_W::new(self, 15)
    }
}
/**GPIO port output data register

You can [`read`](crate::Reg::read) this register and get [`gpiog_odr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiog_odr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOG:GPIOG_ODR)*/
pub struct GPIOG_ODRrs;
impl crate::RegisterSpec for GPIOG_ODRrs {
    type Ux = u32;
}
///`read()` method returns [`gpiog_odr::R`](R) reader structure
impl crate::Readable for GPIOG_ODRrs {}
///`write(|w| ..)` method takes [`gpiog_odr::W`](W) writer structure
impl crate::Writable for GPIOG_ODRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOG_ODR to value 0
impl crate::Resettable for GPIOG_ODRrs {
