#[doc = "Writer for register GPIOH_BRR"]
pub type W = crate::W<u32, super::GPIOH_BRR>;
#[doc = "Register GPIOH_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOH_BRR {
    type Type = u32;
    #[inline(always)]
