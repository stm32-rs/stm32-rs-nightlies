#[doc = "Writer for register GPIOH_BSRR"]
pub type W = crate::W<u32, super::GPIOH_BSRR>;
#[doc = "Register GPIOH_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOH_BSRR {
    type Type = u32;
    #[inline(always)]
