///Register `GPIOH_HWCFGR3` reader
pub type R = crate::R<GPIOH_HWCFGR3rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioh_hwcfgr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOH:GPIOH_HWCFGR3)*/
pub struct GPIOH_HWCFGR3rs;
impl crate::RegisterSpec for GPIOH_HWCFGR3rs {
    type Ux = u32;
}
///`read()` method returns [`gpioh_hwcfgr3::R`](R) reader structure
impl crate::Readable for GPIOH_HWCFGR3rs {}
///`reset()` method sets GPIOH_HWCFGR3 to value 0
impl crate::Resettable for GPIOH_HWCFGR3rs {
