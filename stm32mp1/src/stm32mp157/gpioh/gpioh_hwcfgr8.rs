...
pub type R = crate::R<GPIOH_HWCFGR8rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioh_hwcfgr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOH:GPIOH_HWCFGR8)*/
pub struct GPIOH_HWCFGR8rs;
impl crate::RegisterSpec for GPIOH_HWCFGR8rs {
    type Ux = u32;
}
///`read()` method returns [`gpioh_hwcfgr8::R`](R) reader structure
impl crate::Readable for GPIOH_HWCFGR8rs {}
///`reset()` method sets GPIOH_HWCFGR8 to value 0
impl crate::Resettable for GPIOH_HWCFGR8rs {
