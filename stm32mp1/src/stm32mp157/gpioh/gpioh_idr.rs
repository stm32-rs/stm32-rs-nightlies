///Register `GPIOH_IDR` reader
pub type R = crate::R<GPIOH_IDRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioh_idr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOH:GPIOH_IDR)*/
pub struct GPIOH_IDRrs;
impl crate::RegisterSpec for GPIOH_IDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpioh_idr::R`](R) reader structure
impl crate::Readable for GPIOH_IDRrs {}
///`reset()` method sets GPIOH_IDR to value 0
impl crate::Resettable for GPIOH_IDRrs {
