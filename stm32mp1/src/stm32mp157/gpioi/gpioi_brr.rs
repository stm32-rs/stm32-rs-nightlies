#[doc = "Writer for register GPIOI_BRR"]
pub type W = crate::W<u32, super::GPIOI_BRR>;
#[doc = "Register GPIOI_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOI_BRR {
    type Type = u32;
    #[inline(always)]
