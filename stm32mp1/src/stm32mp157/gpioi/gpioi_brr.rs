...
impl core::fmt::Debug for crate::generic::Reg<GPIOI_BRRrs> {
...
You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioi_brr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`write(|w| ..)` method takes [`gpioi_brr::W`](W) writer structure
impl crate::Writable for GPIOI_BRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOI_BRR to value 0
