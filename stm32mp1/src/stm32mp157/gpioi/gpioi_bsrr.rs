#[doc = "Writer for register GPIOI_BSRR"]
pub type W = crate::W<u32, super::GPIOI_BSRR>;
#[doc = "Register GPIOI_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOI_BSRR {
    type Type = u32;
    #[inline(always)]
