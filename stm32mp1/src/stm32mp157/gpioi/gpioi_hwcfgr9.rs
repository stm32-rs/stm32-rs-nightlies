...
pub type R = crate::R<GPIOI_HWCFGR9rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpioi_hwcfgr9::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOI:GPIOI_HWCFGR9)*/
pub struct GPIOI_HWCFGR9rs;
impl crate::RegisterSpec for GPIOI_HWCFGR9rs {
    type Ux = u32;
}
///`read()` method returns [`gpioi_hwcfgr9::R`](R) reader structure
impl crate::Readable for GPIOI_HWCFGR9rs {}
///`reset()` method sets GPIOI_HWCFGR9 to value 0xff
impl crate::Resettable for GPIOI_HWCFGR9rs {
