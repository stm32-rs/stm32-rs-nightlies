...
You can [`read`](crate::Reg::read) this register and get [`gpioi_verr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`gpioi_verr::R`](R) reader structure
impl crate::Readable for GPIOI_VERRrs {}
///`reset()` method sets GPIOI_VERR to value 0x40
