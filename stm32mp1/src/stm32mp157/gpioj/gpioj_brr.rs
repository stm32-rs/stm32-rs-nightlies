#[doc = "Writer for register GPIOJ_BRR"]
pub type W = crate::W<u32, super::GPIOJ_BRR>;
#[doc = "Register GPIOJ_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOJ_BRR {
    type Type = u32;
    #[inline(always)]
