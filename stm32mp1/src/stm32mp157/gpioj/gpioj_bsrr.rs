#[doc = "Writer for register GPIOJ_BSRR"]
pub type W = crate::W<u32, super::GPIOJ_BSRR>;
#[doc = "Register GPIOJ_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOJ_BSRR {
    type Type = u32;
    #[inline(always)]
