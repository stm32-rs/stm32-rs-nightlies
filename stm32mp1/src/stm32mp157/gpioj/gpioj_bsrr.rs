///Register `GPIOJ_BSRR` writer
pub type W = crate::W<GPIOJ_BSRRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<GPIOJ_BSRRrs> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bs0(&mut self) -> BS0_W<GPIOJ_BSRRrs> {
        BS0_W::new(self, 0)
    }
    ///Bit 1 - BS1
    #[inline(always)]
    #[must_use]
    pub fn bs1(&mut self) -> BS1_W<GPIOJ_BSRRrs> {
        BS1_W::new(self, 1)
    }
    ///Bit 2 - BS2
    #[inline(always)]
    #[must_use]
    pub fn bs2(&mut self) -> BS2_W<GPIOJ_BSRRrs> {
        BS2_W::new(self, 2)
    }
    ///Bit 3 - BS3
    #[inline(always)]
    #[must_use]
    pub fn bs3(&mut self) -> BS3_W<GPIOJ_BSRRrs> {
        BS3_W::new(self, 3)
    }
    ///Bit 4 - BS4
    #[inline(always)]
    #[must_use]
    pub fn bs4(&mut self) -> BS4_W<GPIOJ_BSRRrs> {
        BS4_W::new(self, 4)
    }
    ///Bit 5 - BS5
    #[inline(always)]
    #[must_use]
    pub fn bs5(&mut self) -> BS5_W<GPIOJ_BSRRrs> {
        BS5_W::new(self, 5)
    }
    ///Bit 6 - BS6
    #[inline(always)]
    #[must_use]
    pub fn bs6(&mut self) -> BS6_W<GPIOJ_BSRRrs> {
        BS6_W::new(self, 6)
    }
    ///Bit 7 - BS7
    #[inline(always)]
    #[must_use]
    pub fn bs7(&mut self) -> BS7_W<GPIOJ_BSRRrs> {
        BS7_W::new(self, 7)
    }
    ///Bit 8 - BS8
    #[inline(always)]
    #[must_use]
    pub fn bs8(&mut self) -> BS8_W<GPIOJ_BSRRrs> {
        BS8_W::new(self, 8)
    }
    ///Bit 9 - BS9
    #[inline(always)]
    #[must_use]
    pub fn bs9(&mut self) -> BS9_W<GPIOJ_BSRRrs> {
        BS9_W::new(self, 9)
    }
    ///Bit 10 - BS10
    #[inline(always)]
    #[must_use]
    pub fn bs10(&mut self) -> BS10_W<GPIOJ_BSRRrs> {
        BS10_W::new(self, 10)
    }
    ///Bit 11 - BS11
    #[inline(always)]
    #[must_use]
    pub fn bs11(&mut self) -> BS11_W<GPIOJ_BSRRrs> {
        BS11_W::new(self, 11)
    }
    ///Bit 12 - BS12
    #[inline(always)]
    #[must_use]
    pub fn bs12(&mut self) -> BS12_W<GPIOJ_BSRRrs> {
        BS12_W::new(self, 12)
    }
    ///Bit 13 - BS13
    #[inline(always)]
    #[must_use]
    pub fn bs13(&mut self) -> BS13_W<GPIOJ_BSRRrs> {
        BS13_W::new(self, 13)
    }
    ///Bit 14 - BS14
    #[inline(always)]
    #[must_use]
    pub fn bs14(&mut self) -> BS14_W<GPIOJ_BSRRrs> {
        BS14_W::new(self, 14)
    }
    ///Bit 15 - BS15
    #[inline(always)]
    #[must_use]
    pub fn bs15(&mut self) -> BS15_W<GPIOJ_BSRRrs> {
        BS15_W::new(self, 15)
    }
    ///Bit 16 - BR0
    #[inline(always)]
    #[must_use]
    pub fn br0(&mut self) -> BR0_W<GPIOJ_BSRRrs> {
        BR0_W::new(self, 16)
    }
    ///Bit 17 - BR1
    #[inline(always)]
    #[must_use]
    pub fn br1(&mut self) -> BR1_W<GPIOJ_BSRRrs> {
        BR1_W::new(self, 17)
    }
    ///Bit 18 - BR2
    #[inline(always)]
    #[must_use]
    pub fn br2(&mut self) -> BR2_W<GPIOJ_BSRRrs> {
        BR2_W::new(self, 18)
    }
    ///Bit 19 - BR3
    #[inline(always)]
    #[must_use]
    pub fn br3(&mut self) -> BR3_W<GPIOJ_BSRRrs> {
        BR3_W::new(self, 19)
    }
    ///Bit 20 - BR4
    #[inline(always)]
    #[must_use]
    pub fn br4(&mut self) -> BR4_W<GPIOJ_BSRRrs> {
        BR4_W::new(self, 20)
    }
    ///Bit 21 - BR5
    #[inline(always)]
    #[must_use]
    pub fn br5(&mut self) -> BR5_W<GPIOJ_BSRRrs> {
        BR5_W::new(self, 21)
    }
    ///Bit 22 - BR6
    #[inline(always)]
    #[must_use]
    pub fn br6(&mut self) -> BR6_W<GPIOJ_BSRRrs> {
        BR6_W::new(self, 22)
    }
    ///Bit 23 - BR7
    #[inline(always)]
    #[must_use]
    pub fn br7(&mut self) -> BR7_W<GPIOJ_BSRRrs> {
        BR7_W::new(self, 23)
    }
    ///Bit 24 - BR8
    #[inline(always)]
    #[must_use]
    pub fn br8(&mut self) -> BR8_W<GPIOJ_BSRRrs> {
        BR8_W::new(self, 24)
    }
    ///Bit 25 - BR9
    #[inline(always)]
    #[must_use]
    pub fn br9(&mut self) -> BR9_W<GPIOJ_BSRRrs> {
        BR9_W::new(self, 25)
    }
    ///Bit 26 - BR10
    #[inline(always)]
    #[must_use]
    pub fn br10(&mut self) -> BR10_W<GPIOJ_BSRRrs> {
        BR10_W::new(self, 26)
    }
    ///Bit 27 - BR11
    #[inline(always)]
    #[must_use]
    pub fn br11(&mut self) -> BR11_W<GPIOJ_BSRRrs> {
        BR11_W::new(self, 27)
    }
    ///Bit 28 - BR12
    #[inline(always)]
    #[must_use]
    pub fn br12(&mut self) -> BR12_W<GPIOJ_BSRRrs> {
        BR12_W::new(self, 28)
    }
    ///Bit 29 - BR13
    #[inline(always)]
    #[must_use]
    pub fn br13(&mut self) -> BR13_W<GPIOJ_BSRRrs> {
        BR13_W::new(self, 29)
    }
    ///Bit 30 - BR14
    #[inline(always)]
    #[must_use]
    pub fn br14(&mut self) -> BR14_W<GPIOJ_BSRRrs> {
        BR14_W::new(self, 30)
    }
    ///Bit 31 - BR15
    #[inline(always)]
    #[must_use]
    pub fn br15(&mut self) -> BR15_W<GPIOJ_BSRRrs> {
        BR15_W::new(self, 31)
    }
}
/**GPIO port bit set/reset register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioj_bsrr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOJ:GPIOJ_BSRR)*/
pub struct GPIOJ_BSRRrs;
impl crate::RegisterSpec for GPIOJ_BSRRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`gpioj_bsrr::W`](W) writer structure
impl crate::Writable for GPIOJ_BSRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOJ_BSRR to value 0
impl crate::Resettable for GPIOJ_BSRRrs {
