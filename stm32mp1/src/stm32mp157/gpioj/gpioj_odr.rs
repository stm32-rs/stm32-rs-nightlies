#[doc = "Reader of register GPIOJ_ODR"]
pub type R = crate::R<u32, super::GPIOJ_ODR>;
#[doc = "Writer for register GPIOJ_ODR"]
pub type W = crate::W<u32, super::GPIOJ_ODR>;
#[doc = "Register GPIOJ_ODR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOJ_ODR {
    type Type = u32;
    #[inline(always)]
