///Register `GPIOJ_OTYPER` reader
pub type R = crate::R<GPIOJ_OTYPERrs>;
///Register `GPIOJ_OTYPER` writer
pub type W = crate::W<GPIOJ_OTYPERrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ot0(&mut self) -> OT0_W<GPIOJ_OTYPERrs> {
        OT0_W::new(self, 0)
    }
    ///Bit 1 - OT1
    #[inline(always)]
    #[must_use]
    pub fn ot1(&mut self) -> OT1_W<GPIOJ_OTYPERrs> {
        OT1_W::new(self, 1)
    }
    ///Bit 2 - OT2
    #[inline(always)]
    #[must_use]
    pub fn ot2(&mut self) -> OT2_W<GPIOJ_OTYPERrs> {
        OT2_W::new(self, 2)
    }
    ///Bit 3 - OT3
    #[inline(always)]
    #[must_use]
    pub fn ot3(&mut self) -> OT3_W<GPIOJ_OTYPERrs> {
        OT3_W::new(self, 3)
    }
    ///Bit 4 - OT4
    #[inline(always)]
    #[must_use]
    pub fn ot4(&mut self) -> OT4_W<GPIOJ_OTYPERrs> {
        OT4_W::new(self, 4)
    }
    ///Bit 5 - OT5
    #[inline(always)]
    #[must_use]
    pub fn ot5(&mut self) -> OT5_W<GPIOJ_OTYPERrs> {
        OT5_W::new(self, 5)
    }
    ///Bit 6 - OT6
    #[inline(always)]
    #[must_use]
    pub fn ot6(&mut self) -> OT6_W<GPIOJ_OTYPERrs> {
        OT6_W::new(self, 6)
    }
    ///Bit 7 - OT7
    #[inline(always)]
    #[must_use]
    pub fn ot7(&mut self) -> OT7_W<GPIOJ_OTYPERrs> {
        OT7_W::new(self, 7)
    }
    ///Bit 8 - OT8
    #[inline(always)]
    #[must_use]
    pub fn ot8(&mut self) -> OT8_W<GPIOJ_OTYPERrs> {
        OT8_W::new(self, 8)
    }
    ///Bit 9 - OT9
    #[inline(always)]
    #[must_use]
    pub fn ot9(&mut self) -> OT9_W<GPIOJ_OTYPERrs> {
        OT9_W::new(self, 9)
    }
    ///Bit 10 - OT10
    #[inline(always)]
    #[must_use]
    pub fn ot10(&mut self) -> OT10_W<GPIOJ_OTYPERrs> {
        OT10_W::new(self, 10)
    }
    ///Bit 11 - OT11
    #[inline(always)]
    #[must_use]
    pub fn ot11(&mut self) -> OT11_W<GPIOJ_OTYPERrs> {
        OT11_W::new(self, 11)
    }
    ///Bit 12 - OT12
    #[inline(always)]
    #[must_use]
    pub fn ot12(&mut self) -> OT12_W<GPIOJ_OTYPERrs> {
        OT12_W::new(self, 12)
    }
    ///Bit 13 - OT13
    #[inline(always)]
    #[must_use]
    pub fn ot13(&mut self) -> OT13_W<GPIOJ_OTYPERrs> {
        OT13_W::new(self, 13)
    }
    ///Bit 14 - OT14
    #[inline(always)]
    #[must_use]
    pub fn ot14(&mut self) -> OT14_W<GPIOJ_OTYPERrs> {
        OT14_W::new(self, 14)
    }
    ///Bit 15 - OT15
    #[inline(always)]
    #[must_use]
    pub fn ot15(&mut self) -> OT15_W<GPIOJ_OTYPERrs> {
        OT15_W::new(self, 15)
    }
}
/**GPIO port output type register

You can [`read`](crate::Reg::read) this register and get [`gpioj_otyper::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioj_otyper::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOJ:GPIOJ_OTYPER)*/
pub struct GPIOJ_OTYPERrs;
impl crate::RegisterSpec for GPIOJ_OTYPERrs {
    type Ux = u32;
}
///`read()` method returns [`gpioj_otyper::R`](R) reader structure
impl crate::Readable for GPIOJ_OTYPERrs {}
///`write(|w| ..)` method takes [`gpioj_otyper::W`](W) writer structure
impl crate::Writable for GPIOJ_OTYPERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOJ_OTYPER to value 0
impl crate::Resettable for GPIOJ_OTYPERrs {
