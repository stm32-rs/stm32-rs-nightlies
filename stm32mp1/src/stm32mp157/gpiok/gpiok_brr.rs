#[doc = "Writer for register GPIOK_BRR"]
pub type W = crate::W<u32, super::GPIOK_BRR>;
#[doc = "Register GPIOK_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOK_BRR {
    type Type = u32;
    #[inline(always)]
