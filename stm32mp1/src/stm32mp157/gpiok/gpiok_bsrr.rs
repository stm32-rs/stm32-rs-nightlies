#[doc = "Writer for register GPIOK_BSRR"]
pub type W = crate::W<u32, super::GPIOK_BSRR>;
#[doc = "Register GPIOK_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOK_BSRR {
    type Type = u32;
    #[inline(always)]
