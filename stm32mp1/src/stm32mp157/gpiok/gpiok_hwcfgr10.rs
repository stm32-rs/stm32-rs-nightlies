...
pub type R = crate::R<GPIOK_HWCFGR10rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiok_hwcfgr10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOK:GPIOK_HWCFGR10)*/
pub struct GPIOK_HWCFGR10rs;
impl crate::RegisterSpec for GPIOK_HWCFGR10rs {
    type Ux = u32;
}
///`read()` method returns [`gpiok_hwcfgr10::R`](R) reader structure
impl crate::Readable for GPIOK_HWCFGR10rs {}
///`reset()` method sets GPIOK_HWCFGR10 to value 0x0001_1240
impl crate::Resettable for GPIOK_HWCFGR10rs {
