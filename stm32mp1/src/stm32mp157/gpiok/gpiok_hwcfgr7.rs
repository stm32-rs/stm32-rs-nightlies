...
pub type R = crate::R<GPIOK_HWCFGR7rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiok_hwcfgr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOK:GPIOK_HWCFGR7)*/
pub struct GPIOK_HWCFGR7rs;
impl crate::RegisterSpec for GPIOK_HWCFGR7rs {
    type Ux = u32;
}
///`read()` method returns [`gpiok_hwcfgr7::R`](R) reader structure
impl crate::Readable for GPIOK_HWCFGR7rs {}
///`reset()` method sets GPIOK_HWCFGR7 to value 0xffff_ffff
impl crate::Resettable for GPIOK_HWCFGR7rs {
