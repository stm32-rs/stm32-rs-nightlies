...
pub type R = crate::R<GPIOK_HWCFGR8rs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiok_hwcfgr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOK:GPIOK_HWCFGR8)*/
pub struct GPIOK_HWCFGR8rs;
impl crate::RegisterSpec for GPIOK_HWCFGR8rs {
    type Ux = u32;
}
///`read()` method returns [`gpiok_hwcfgr8::R`](R) reader structure
impl crate::Readable for GPIOK_HWCFGR8rs {}
///`reset()` method sets GPIOK_HWCFGR8 to value 0
impl crate::Resettable for GPIOK_HWCFGR8rs {
