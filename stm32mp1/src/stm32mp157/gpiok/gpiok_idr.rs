...
pub type R = crate::R<GPIOK_IDRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpiok_idr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOK:GPIOK_IDR)*/
pub struct GPIOK_IDRrs;
impl crate::RegisterSpec for GPIOK_IDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpiok_idr::R`](R) reader structure
impl crate::Readable for GPIOK_IDRrs {}
///`reset()` method sets GPIOK_IDR to value 0
impl crate::Resettable for GPIOK_IDRrs {
