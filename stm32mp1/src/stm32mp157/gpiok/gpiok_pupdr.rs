...
pub type R = crate::R<GPIOK_PUPDRrs>;
///Register `GPIOK_PUPDR` writer
pub type W = crate::W<GPIOK_PUPDRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pupdr0(&mut self) -> PUPDR0_W<GPIOK_PUPDRrs> {
        PUPDR0_W::new(self, 0)
    }
    ///Bits 2:3 - PUPDR1
    #[inline(always)]
    #[must_use]
    pub fn pupdr1(&mut self) -> PUPDR1_W<GPIOK_PUPDRrs> {
        PUPDR1_W::new(self, 2)
    }
    ///Bits 4:5 - PUPDR2
    #[inline(always)]
    #[must_use]
    pub fn pupdr2(&mut self) -> PUPDR2_W<GPIOK_PUPDRrs> {
        PUPDR2_W::new(self, 4)
    }
    ///Bits 6:7 - PUPDR3
    #[inline(always)]
    #[must_use]
    pub fn pupdr3(&mut self) -> PUPDR3_W<GPIOK_PUPDRrs> {
        PUPDR3_W::new(self, 6)
    }
    ///Bits 8:9 - PUPDR4
    #[inline(always)]
    #[must_use]
    pub fn pupdr4(&mut self) -> PUPDR4_W<GPIOK_PUPDRrs> {
        PUPDR4_W::new(self, 8)
    }
    ///Bits 10:11 - PUPDR5
    #[inline(always)]
    #[must_use]
    pub fn pupdr5(&mut self) -> PUPDR5_W<GPIOK_PUPDRrs> {
        PUPDR5_W::new(self, 10)
    }
    ///Bits 12:13 - PUPDR6
    #[inline(always)]
    #[must_use]
    pub fn pupdr6(&mut self) -> PUPDR6_W<GPIOK_PUPDRrs> {
        PUPDR6_W::new(self, 12)
    }
    ///Bits 14:15 - PUPDR7
    #[inline(always)]
    #[must_use]
    pub fn pupdr7(&mut self) -> PUPDR7_W<GPIOK_PUPDRrs> {
        PUPDR7_W::new(self, 14)
    }
    ///Bits 16:17 - PUPDR8
    #[inline(always)]
    #[must_use]
    pub fn pupdr8(&mut self) -> PUPDR8_W<GPIOK_PUPDRrs> {
        PUPDR8_W::new(self, 16)
    }
    ///Bits 18:19 - PUPDR9
    #[inline(always)]
    #[must_use]
    pub fn pupdr9(&mut self) -> PUPDR9_W<GPIOK_PUPDRrs> {
        PUPDR9_W::new(self, 18)
    }
    ///Bits 20:21 - PUPDR10
    #[inline(always)]
    #[must_use]
    pub fn pupdr10(&mut self) -> PUPDR10_W<GPIOK_PUPDRrs> {
        PUPDR10_W::new(self, 20)
    }
    ///Bits 22:23 - PUPDR11
    #[inline(always)]
    #[must_use]
    pub fn pupdr11(&mut self) -> PUPDR11_W<GPIOK_PUPDRrs> {
        PUPDR11_W::new(self, 22)
    }
    ///Bits 24:25 - PUPDR12
    #[inline(always)]
    #[must_use]
    pub fn pupdr12(&mut self) -> PUPDR12_W<GPIOK_PUPDRrs> {
        PUPDR12_W::new(self, 24)
    }
    ///Bits 26:27 - PUPDR13
    #[inline(always)]
    #[must_use]
    pub fn pupdr13(&mut self) -> PUPDR13_W<GPIOK_PUPDRrs> {
        PUPDR13_W::new(self, 26)
    }
    ///Bits 28:29 - PUPDR14
    #[inline(always)]
    #[must_use]
    pub fn pupdr14(&mut self) -> PUPDR14_W<GPIOK_PUPDRrs> {
        PUPDR14_W::new(self, 28)
    }
    ///Bits 30:31 - PUPDR15
    #[inline(always)]
    #[must_use]
    pub fn pupdr15(&mut self) -> PUPDR15_W<GPIOK_PUPDRrs> {
        PUPDR15_W::new(self, 30)
    }
}
/**GPIO port pull-up/pull-down register

You can [`read`](crate::Reg::read) this register and get [`gpiok_pupdr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiok_pupdr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#GPIOK:GPIOK_PUPDR)*/
pub struct GPIOK_PUPDRrs;
impl crate::RegisterSpec for GPIOK_PUPDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpiok_pupdr::R`](R) reader structure
impl crate::Readable for GPIOK_PUPDRrs {}
///`write(|w| ..)` method takes [`gpiok_pupdr::W`](W) writer structure
impl crate::Writable for GPIOK_PUPDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOK_PUPDR to value 0
impl crate::Resettable for GPIOK_PUPDRrs {
