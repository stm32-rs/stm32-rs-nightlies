...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn br0(&mut self) -> BR0_W<GPIOZ_BRRrs> {
        BR0_W::new(self, 0)
    }
    #[doc = "Bit 1 - BR1"]
    #[inline(always)]
    #[must_use]
    pub fn br1(&mut self) -> BR1_W<GPIOZ_BRRrs> {
        BR1_W::new(self, 1)
    }
    #[doc = "Bit 2 - BR2"]
    #[inline(always)]
    #[must_use]
    pub fn br2(&mut self) -> BR2_W<GPIOZ_BRRrs> {
        BR2_W::new(self, 2)
    }
    #[doc = "Bit 3 - BR3"]
    #[inline(always)]
    #[must_use]
    pub fn br3(&mut self) -> BR3_W<GPIOZ_BRRrs> {
        BR3_W::new(self, 3)
    }
    #[doc = "Bit 4 - BR4"]
    #[inline(always)]
    #[must_use]
    pub fn br4(&mut self) -> BR4_W<GPIOZ_BRRrs> {
        BR4_W::new(self, 4)
    }
    #[doc = "Bit 5 - BR5"]
    #[inline(always)]
    #[must_use]
    pub fn br5(&mut self) -> BR5_W<GPIOZ_BRRrs> {
        BR5_W::new(self, 5)
    }
    #[doc = "Bit 6 - BR6"]
    #[inline(always)]
    #[must_use]
    pub fn br6(&mut self) -> BR6_W<GPIOZ_BRRrs> {
        BR6_W::new(self, 6)
    }
    #[doc = "Bit 7 - BR7"]
    #[inline(always)]
    #[must_use]
    pub fn br7(&mut self) -> BR7_W<GPIOZ_BRRrs> {
        BR7_W::new(self, 7)
    }
    #[doc = "Bit 8 - BR8"]
    #[inline(always)]
    #[must_use]
    pub fn br8(&mut self) -> BR8_W<GPIOZ_BRRrs> {
        BR8_W::new(self, 8)
    }
    #[doc = "Bit 9 - BR9"]
    #[inline(always)]
    #[must_use]
    pub fn br9(&mut self) -> BR9_W<GPIOZ_BRRrs> {
        BR9_W::new(self, 9)
    }
    #[doc = "Bit 10 - BR10"]
    #[inline(always)]
    #[must_use]
    pub fn br10(&mut self) -> BR10_W<GPIOZ_BRRrs> {
        BR10_W::new(self, 10)
    }
    #[doc = "Bit 11 - BR11"]
    #[inline(always)]
    #[must_use]
    pub fn br11(&mut self) -> BR11_W<GPIOZ_BRRrs> {
        BR11_W::new(self, 11)
    }
    #[doc = "Bit 12 - BR12"]
    #[inline(always)]
    #[must_use]
    pub fn br12(&mut self) -> BR12_W<GPIOZ_BRRrs> {
        BR12_W::new(self, 12)
    }
    #[doc = "Bit 13 - BR13"]
    #[inline(always)]
    #[must_use]
    pub fn br13(&mut self) -> BR13_W<GPIOZ_BRRrs> {
        BR13_W::new(self, 13)
    }
    #[doc = "Bit 14 - BR14"]
    #[inline(always)]
    #[must_use]
    pub fn br14(&mut self) -> BR14_W<GPIOZ_BRRrs> {
        BR14_W::new(self, 14)
    }
    #[doc = "Bit 15 - BR15"]
    #[inline(always)]
    #[must_use]
    pub fn br15(&mut self) -> BR15_W<GPIOZ_BRRrs> {
        BR15_W::new(self, 15)
    }
}
#[doc = "GPIO port bit reset register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpioz_brr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
