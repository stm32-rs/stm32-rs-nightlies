#[doc = "Writer for register GPIOZ_BRR"]
pub type W = crate::W<u32, super::GPIOZ_BRR>;
#[doc = "Register GPIOZ_BRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOZ_BRR {
    type Type = u32;
    #[inline(always)]
