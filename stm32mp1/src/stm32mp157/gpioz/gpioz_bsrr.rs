#[doc = "Writer for register GPIOZ_BSRR"]
pub type W = crate::W<u32, super::GPIOZ_BSRR>;
#[doc = "Register GPIOZ_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOZ_BSRR {
    type Type = u32;
    #[inline(always)]
