...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn moder0(&mut self) -> MODER0_W<GPIOZ_MODERrs> {
        MODER0_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - MODER1"]
    #[inline(always)]
    #[must_use]
    pub fn moder1(&mut self) -> MODER1_W<GPIOZ_MODERrs> {
        MODER1_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - MODER2"]
    #[inline(always)]
    #[must_use]
    pub fn moder2(&mut self) -> MODER2_W<GPIOZ_MODERrs> {
        MODER2_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - MODER3"]
    #[inline(always)]
    #[must_use]
    pub fn moder3(&mut self) -> MODER3_W<GPIOZ_MODERrs> {
        MODER3_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - MODER4"]
    #[inline(always)]
    #[must_use]
    pub fn moder4(&mut self) -> MODER4_W<GPIOZ_MODERrs> {
        MODER4_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - MODER5"]
    #[inline(always)]
    #[must_use]
    pub fn moder5(&mut self) -> MODER5_W<GPIOZ_MODERrs> {
        MODER5_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - MODER6"]
    #[inline(always)]
    #[must_use]
    pub fn moder6(&mut self) -> MODER6_W<GPIOZ_MODERrs> {
        MODER6_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - MODER7"]
    #[inline(always)]
    #[must_use]
    pub fn moder7(&mut self) -> MODER7_W<GPIOZ_MODERrs> {
        MODER7_W::new(self, 14)
    }
    #[doc = "Bits 16:17 - MODER8"]
    #[inline(always)]
    #[must_use]
    pub fn moder8(&mut self) -> MODER8_W<GPIOZ_MODERrs> {
        MODER8_W::new(self, 16)
    }
    #[doc = "Bits 18:19 - MODER9"]
    #[inline(always)]
    #[must_use]
    pub fn moder9(&mut self) -> MODER9_W<GPIOZ_MODERrs> {
        MODER9_W::new(self, 18)
    }
    #[doc = "Bits 20:21 - MODER10"]
    #[inline(always)]
    #[must_use]
    pub fn moder10(&mut self) -> MODER10_W<GPIOZ_MODERrs> {
        MODER10_W::new(self, 20)
    }
    #[doc = "Bits 22:23 - MODER11"]
    #[inline(always)]
    #[must_use]
    pub fn moder11(&mut self) -> MODER11_W<GPIOZ_MODERrs> {
        MODER11_W::new(self, 22)
    }
    #[doc = "Bits 24:25 - MODER12"]
    #[inline(always)]
    #[must_use]
    pub fn moder12(&mut self) -> MODER12_W<GPIOZ_MODERrs> {
        MODER12_W::new(self, 24)
    }
    #[doc = "Bits 26:27 - MODER13"]
    #[inline(always)]
    #[must_use]
    pub fn moder13(&mut self) -> MODER13_W<GPIOZ_MODERrs> {
        MODER13_W::new(self, 26)
    }
    #[doc = "Bits 28:29 - MODER14"]
    #[inline(always)]
    #[must_use]
    pub fn moder14(&mut self) -> MODER14_W<GPIOZ_MODERrs> {
        MODER14_W::new(self, 28)
    }
    #[doc = "Bits 30:31 - MODER15"]
    #[inline(always)]
    #[must_use]
    pub fn moder15(&mut self) -> MODER15_W<GPIOZ_MODERrs> {
        MODER15_W::new(self, 30)
    }
}
#[doc = "GPIO port mode register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpioz_moder::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpioz_moder::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
