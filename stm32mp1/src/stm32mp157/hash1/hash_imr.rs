#[doc = "Reader of register HASH_IMR"]
pub type R = crate::R<u32, super::HASH_IMR>;
#[doc = "Writer for register HASH_IMR"]
pub type W = crate::W<u32, super::HASH_IMR>;
#[doc = "Register HASH_IMR `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_IMR {
    type Type = u32;
    #[inline(always)]
