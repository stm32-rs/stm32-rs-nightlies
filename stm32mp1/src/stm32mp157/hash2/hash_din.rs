#[doc = "Reader of register HASH_DIN"]
pub type R = crate::R<u32, super::HASH_DIN>;
#[doc = "Writer for register HASH_DIN"]
pub type W = crate::W<u32, super::HASH_DIN>;
#[doc = "Register HASH_DIN `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DIN {
    type Type = u32;
    #[inline(always)]
