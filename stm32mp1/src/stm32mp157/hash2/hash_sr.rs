#[doc = "Reader of register HASH_SR"]
pub type R = crate::R<u32, super::HASH_SR>;
#[doc = "Writer for register HASH_SR"]
pub type W = crate::W<u32, super::HASH_SR>;
#[doc = "Register HASH_SR `reset()`'s with value 0x01"]
impl crate::ResetValue for super::HASH_SR {
    type Type = u32;
    #[inline(always)]
