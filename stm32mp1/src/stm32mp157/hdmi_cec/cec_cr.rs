...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txsom(&mut self) -> TXSOM_W<CEC_CRrs> {
        TXSOM_W::new(self, 1)
    }
    ///Bit 2 - TXEOM
    #[inline(always)]
    #[must_use]
    pub fn txeom(&mut self) -> TXEOM_W<CEC_CRrs> {
        TXEOM_W::new(self, 2)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HDMI_CEC:CEC_CR)*/
pub struct CEC_CRrs;
