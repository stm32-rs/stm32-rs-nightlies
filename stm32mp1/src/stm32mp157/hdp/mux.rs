...
impl W {
    ///Bits 0:3 - MUX0
    #[inline(always)]
    pub fn mux0(&mut self) -> MUX0_W<MUXrs> {
        MUX0_W::new(self, 0)
    }
    ///Bits 4:7 - MUX1
    #[inline(always)]
    pub fn mux1(&mut self) -> MUX1_W<MUXrs> {
        MUX1_W::new(self, 4)
    }
    ///Bits 8:11 - MUX2
    #[inline(always)]
    pub fn mux2(&mut self) -> MUX2_W<MUXrs> {
        MUX2_W::new(self, 8)
    }
    ///Bits 12:15 - MUX3
    #[inline(always)]
    pub fn mux3(&mut self) -> MUX3_W<MUXrs> {
        MUX3_W::new(self, 12)
    }
    ///Bits 16:19 - MUX4
    #[inline(always)]
    pub fn mux4(&mut self) -> MUX4_W<MUXrs> {
        MUX4_W::new(self, 16)
    }
    ///Bits 20:23 - MUX5
    #[inline(always)]
    pub fn mux5(&mut self) -> MUX5_W<MUXrs> {
        MUX5_W::new(self, 20)
    }
    ///Bits 24:27 - MUX6
    #[inline(always)]
    pub fn mux6(&mut self) -> MUX6_W<MUXrs> {
        MUX6_W::new(self, 24)
    }
    ///Bits 28:31 - MUX7
    #[inline(always)]
    pub fn mux7(&mut self) -> MUX7_W<MUXrs> {
        MUX7_W::new(self, 28)
    }
}
/**HDP multiplexing
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HDP:MUX)*/
pub struct MUXrs;
