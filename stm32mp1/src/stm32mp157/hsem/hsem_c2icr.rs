///Register `HSEM_C2ICR` reader
pub type R = crate::R<HSEM_C2ICRrs>;
///Register `HSEM_C2ICR` writer
...
///`read()` method returns [`hsem_c2icr::R`](R) reader structure
impl crate::Readable for HSEM_C2ICRrs {}
///`write(|w| ..)` method takes [`hsem_c2icr::W`](W) writer structure
impl crate::Writable for HSEM_C2ICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSEM_C2ICR to value 0
