///Register `HSEM_R13` reader
pub type R = crate::R<HSEM_R13rs>;
///Register `HSEM_R13` writer
pub type W = crate::W<HSEM_R13rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn procid(&mut self) -> PROCID_W<HSEM_R13rs> {
        PROCID_W::new(self, 0)
    }
    ///Bits 8:11 - COREID
    #[inline(always)]
    #[must_use]
    pub fn coreid(&mut self) -> COREID_W<HSEM_R13rs> {
        COREID_W::new(self, 8)
    }
    ///Bit 31 - LOCK
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<HSEM_R13rs> {
        LOCK_W::new(self, 31)
    }
}
...
pub struct HSEM_R13rs;
impl crate::RegisterSpec for HSEM_R13rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_r13::R`](R) reader structure
impl crate::Readable for HSEM_R13rs {}
///`write(|w| ..)` method takes [`hsem_r13::W`](W) writer structure
impl crate::Writable for HSEM_R13rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSEM_R13 to value 0
impl crate::Resettable for HSEM_R13rs {
