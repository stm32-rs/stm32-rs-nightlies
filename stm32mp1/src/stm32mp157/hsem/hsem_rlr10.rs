///Register `HSEM_RLR10` reader
pub type R = crate::R<HSEM_RLR10rs>;
...
pub struct HSEM_RLR10rs;
impl crate::RegisterSpec for HSEM_RLR10rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr10::R`](R) reader structure
impl crate::Readable for HSEM_RLR10rs {}
///`reset()` method sets HSEM_RLR10 to value 0
impl crate::Resettable for HSEM_RLR10rs {
