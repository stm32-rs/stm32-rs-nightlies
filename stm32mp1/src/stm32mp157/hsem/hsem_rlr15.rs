///Register `HSEM_RLR15` reader
pub type R = crate::R<HSEM_RLR15rs>;
...
pub struct HSEM_RLR15rs;
impl crate::RegisterSpec for HSEM_RLR15rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr15::R`](R) reader structure
impl crate::Readable for HSEM_RLR15rs {}
///`reset()` method sets HSEM_RLR15 to value 0
impl crate::Resettable for HSEM_RLR15rs {
