///Register `HSEM_RLR16` reader
pub type R = crate::R<HSEM_RLR16rs>;
...
pub struct HSEM_RLR16rs;
impl crate::RegisterSpec for HSEM_RLR16rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr16::R`](R) reader structure
impl crate::Readable for HSEM_RLR16rs {}
///`reset()` method sets HSEM_RLR16 to value 0
impl crate::Resettable for HSEM_RLR16rs {
