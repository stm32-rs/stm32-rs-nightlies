///Register `HSEM_RLR21` reader
pub type R = crate::R<HSEM_RLR21rs>;
...
pub struct HSEM_RLR21rs;
impl crate::RegisterSpec for HSEM_RLR21rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr21::R`](R) reader structure
impl crate::Readable for HSEM_RLR21rs {}
///`reset()` method sets HSEM_RLR21 to value 0
impl crate::Resettable for HSEM_RLR21rs {
