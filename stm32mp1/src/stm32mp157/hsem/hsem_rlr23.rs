///Register `HSEM_RLR23` reader
pub type R = crate::R<HSEM_RLR23rs>;
...
pub struct HSEM_RLR23rs;
impl crate::RegisterSpec for HSEM_RLR23rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr23::R`](R) reader structure
impl crate::Readable for HSEM_RLR23rs {}
///`reset()` method sets HSEM_RLR23 to value 0
impl crate::Resettable for HSEM_RLR23rs {
