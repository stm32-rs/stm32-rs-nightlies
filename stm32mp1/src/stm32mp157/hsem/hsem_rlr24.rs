///Register `HSEM_RLR24` reader
pub type R = crate::R<HSEM_RLR24rs>;
...
pub struct HSEM_RLR24rs;
impl crate::RegisterSpec for HSEM_RLR24rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr24::R`](R) reader structure
impl crate::Readable for HSEM_RLR24rs {}
///`reset()` method sets HSEM_RLR24 to value 0
impl crate::Resettable for HSEM_RLR24rs {
