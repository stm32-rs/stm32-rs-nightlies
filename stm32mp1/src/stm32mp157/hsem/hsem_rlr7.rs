///Register `HSEM_RLR7` reader
pub type R = crate::R<HSEM_RLR7rs>;
...
pub struct HSEM_RLR7rs;
impl crate::RegisterSpec for HSEM_RLR7rs {
    type Ux = u32;
}
///`read()` method returns [`hsem_rlr7::R`](R) reader structure
impl crate::Readable for HSEM_RLR7rs {}
///`reset()` method sets HSEM_RLR7 to value 0
impl crate::Resettable for HSEM_RLR7rs {
