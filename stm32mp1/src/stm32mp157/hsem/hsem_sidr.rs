...
You can [`read`](crate::Reg::read) this register and get [`hsem_sidr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`hsem_sidr::R`](R) reader structure
impl crate::Readable for HSEM_SIDRrs {}
///`reset()` method sets HSEM_SIDR to value 0xa3c5_dd01
