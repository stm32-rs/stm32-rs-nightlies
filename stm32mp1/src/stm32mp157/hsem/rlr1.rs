...
You can [`read`](crate::Reg::read) this register and get [`rlr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR1)*/
pub struct RLR1rs;
impl crate::RegisterSpec for RLR1rs {
    type Ux = u32;
}
///`read()` method returns [`rlr1::R`](R) reader structure
impl crate::Readable for RLR1rs {}
///`reset()` method sets RLR1 to value 0
impl crate::Resettable for RLR1rs {}
