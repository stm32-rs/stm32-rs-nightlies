...
You can [`read`](crate::Reg::read) this register and get [`rlr12::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR12)*/
pub struct RLR12rs;
impl crate::RegisterSpec for RLR12rs {
    type Ux = u32;
}
///`read()` method returns [`rlr12::R`](R) reader structure
impl crate::Readable for RLR12rs {}
///`reset()` method sets RLR12 to value 0
impl crate::Resettable for RLR12rs {}
