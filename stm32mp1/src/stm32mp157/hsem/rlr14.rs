...
You can [`read`](crate::Reg::read) this register and get [`rlr14::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR14)*/
pub struct RLR14rs;
impl crate::RegisterSpec for RLR14rs {
    type Ux = u32;
}
///`read()` method returns [`rlr14::R`](R) reader structure
impl crate::Readable for RLR14rs {}
///`reset()` method sets RLR14 to value 0
impl crate::Resettable for RLR14rs {}
