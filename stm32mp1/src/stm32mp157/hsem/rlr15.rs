...
You can [`read`](crate::Reg::read) this register and get [`rlr15::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR15)*/
pub struct RLR15rs;
impl crate::RegisterSpec for RLR15rs {
    type Ux = u32;
}
///`read()` method returns [`rlr15::R`](R) reader structure
impl crate::Readable for RLR15rs {}
///`reset()` method sets RLR15 to value 0
impl crate::Resettable for RLR15rs {}
