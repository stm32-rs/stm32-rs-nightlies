///Register `RLR16` reader
pub type R = crate::R<RLR16rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr16::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR16)*/
pub struct RLR16rs;
impl crate::RegisterSpec for RLR16rs {
    type Ux = u32;
}
///`read()` method returns [`rlr16::R`](R) reader structure
impl crate::Readable for RLR16rs {}
///`reset()` method sets RLR16 to value 0
impl crate::Resettable for RLR16rs {}
