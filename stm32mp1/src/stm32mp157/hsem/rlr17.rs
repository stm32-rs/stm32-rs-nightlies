///Register `RLR17` reader
pub type R = crate::R<RLR17rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr17::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR17)*/
pub struct RLR17rs;
impl crate::RegisterSpec for RLR17rs {
    type Ux = u32;
}
///`read()` method returns [`rlr17::R`](R) reader structure
impl crate::Readable for RLR17rs {}
///`reset()` method sets RLR17 to value 0
impl crate::Resettable for RLR17rs {}
