///Register `RLR18` reader
pub type R = crate::R<RLR18rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr18::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR18)*/
pub struct RLR18rs;
impl crate::RegisterSpec for RLR18rs {
    type Ux = u32;
}
///`read()` method returns [`rlr18::R`](R) reader structure
impl crate::Readable for RLR18rs {}
///`reset()` method sets RLR18 to value 0
impl crate::Resettable for RLR18rs {}
