...
You can [`read`](crate::Reg::read) this register and get [`rlr2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR2)*/
pub struct RLR2rs;
impl crate::RegisterSpec for RLR2rs {
    type Ux = u32;
}
///`read()` method returns [`rlr2::R`](R) reader structure
impl crate::Readable for RLR2rs {}
///`reset()` method sets RLR2 to value 0
impl crate::Resettable for RLR2rs {}
