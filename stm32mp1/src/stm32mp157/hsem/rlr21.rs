///Register `RLR21` reader
pub type R = crate::R<RLR21rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr21::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR21)*/
pub struct RLR21rs;
impl crate::RegisterSpec for RLR21rs {
    type Ux = u32;
}
///`read()` method returns [`rlr21::R`](R) reader structure
impl crate::Readable for RLR21rs {}
///`reset()` method sets RLR21 to value 0
impl crate::Resettable for RLR21rs {}
