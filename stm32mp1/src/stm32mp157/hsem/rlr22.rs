///Register `RLR22` reader
pub type R = crate::R<RLR22rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr22::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR22)*/
pub struct RLR22rs;
impl crate::RegisterSpec for RLR22rs {
    type Ux = u32;
}
///`read()` method returns [`rlr22::R`](R) reader structure
impl crate::Readable for RLR22rs {}
///`reset()` method sets RLR22 to value 0
impl crate::Resettable for RLR22rs {}
