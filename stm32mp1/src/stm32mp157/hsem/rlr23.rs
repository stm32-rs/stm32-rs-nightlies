///Register `RLR23` reader
pub type R = crate::R<RLR23rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr23::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR23)*/
pub struct RLR23rs;
impl crate::RegisterSpec for RLR23rs {
    type Ux = u32;
}
///`read()` method returns [`rlr23::R`](R) reader structure
impl crate::Readable for RLR23rs {}
///`reset()` method sets RLR23 to value 0
impl crate::Resettable for RLR23rs {}
