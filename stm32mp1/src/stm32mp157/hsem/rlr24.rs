///Register `RLR24` reader
pub type R = crate::R<RLR24rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr24::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR24)*/
pub struct RLR24rs;
impl crate::RegisterSpec for RLR24rs {
    type Ux = u32;
}
///`read()` method returns [`rlr24::R`](R) reader structure
impl crate::Readable for RLR24rs {}
///`reset()` method sets RLR24 to value 0
impl crate::Resettable for RLR24rs {}
