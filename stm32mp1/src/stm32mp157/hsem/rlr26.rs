///Register `RLR26` reader
pub type R = crate::R<RLR26rs>;
...
You can [`read`](crate::Reg::read) this register and get [`rlr26::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR26)*/
pub struct RLR26rs;
impl crate::RegisterSpec for RLR26rs {
    type Ux = u32;
}
///`read()` method returns [`rlr26::R`](R) reader structure
impl crate::Readable for RLR26rs {}
///`reset()` method sets RLR26 to value 0
impl crate::Resettable for RLR26rs {}
