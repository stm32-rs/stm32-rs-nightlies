...
You can [`read`](crate::Reg::read) this register and get [`rlr6::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR6)*/
pub struct RLR6rs;
impl crate::RegisterSpec for RLR6rs {
    type Ux = u32;
}
///`read()` method returns [`rlr6::R`](R) reader structure
impl crate::Readable for RLR6rs {}
///`reset()` method sets RLR6 to value 0
impl crate::Resettable for RLR6rs {}
