...
You can [`read`](crate::Reg::read) this register and get [`rlr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR7)*/
pub struct RLR7rs;
impl crate::RegisterSpec for RLR7rs {
    type Ux = u32;
}
///`read()` method returns [`rlr7::R`](R) reader structure
impl crate::Readable for RLR7rs {}
///`reset()` method sets RLR7 to value 0
impl crate::Resettable for RLR7rs {}
