...
You can [`read`](crate::Reg::read) this register and get [`rlr8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#HSEM:RLR8)*/
pub struct RLR8rs;
impl crate::RegisterSpec for RLR8rs {
    type Ux = u32;
}
///`read()` method returns [`rlr8::R`](R) reader structure
impl crate::Readable for RLR8rs {}
///`reset()` method sets RLR8 to value 0
impl crate::Resettable for RLR8rs {}
