...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chx_c(&mut self) -> CHX_C_W<C1SCRrs> {
        CHX_C_W::new(self, 0)
    }
    ///Bits 16:21 - CHxS
    #[inline(always)]
    #[must_use]
    pub fn chx_s(&mut self) -> CHX_S_W<C1SCRrs> {
        CHX_S_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#IPCC:C1SCR)*/
pub struct C1SCRrs;
