...
impl W {
    ///Bits 0:5 - CHxOM
    #[inline(always)]
    pub fn chx_om(&mut self) -> CHX_OM_W<'_, C2MRrs> {
        CHX_OM_W::new(self, 0)
    }
    ///Bits 16:21 - CHxFM
    #[inline(always)]
    pub fn chx_fm(&mut self) -> CHX_FM_W<'_, C2MRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#IPCC:C2MR)*/
pub struct C2MRrs;
