#[doc = "Reader of register IPCC_C1CR"]
pub type R = crate::R<u32, super::IPCC_C1CR>;
#[doc = "Writer for register IPCC_C1CR"]
pub type W = crate::W<u32, super::IPCC_C1CR>;
#[doc = "Register IPCC_C1CR `reset()`'s with value 0"]
impl crate::ResetValue for super::IPCC_C1CR {
    type Type = u32;
    #[inline(always)]
