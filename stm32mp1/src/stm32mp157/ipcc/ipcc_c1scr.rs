#[doc = "Reader of register IPCC_C1SCR"]
pub type R = crate::R<u32, super::IPCC_C1SCR>;
#[doc = "Writer for register IPCC_C1SCR"]
pub type W = crate::W<u32, super::IPCC_C1SCR>;
#[doc = "Register IPCC_C1SCR `reset()`'s with value 0"]
impl crate::ResetValue for super::IPCC_C1SCR {
    type Type = u32;
    #[inline(always)]
