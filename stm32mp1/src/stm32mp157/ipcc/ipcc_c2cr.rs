#[doc = "Reader of register IPCC_C2CR"]
pub type R = crate::R<u32, super::IPCC_C2CR>;
#[doc = "Writer for register IPCC_C2CR"]
pub type W = crate::W<u32, super::IPCC_C2CR>;
#[doc = "Register IPCC_C2CR `reset()`'s with value 0"]
impl crate::ResetValue for super::IPCC_C2CR {
    type Type = u32;
    #[inline(always)]
