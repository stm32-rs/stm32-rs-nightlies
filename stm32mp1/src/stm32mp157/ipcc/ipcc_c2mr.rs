#[doc = "Reader of register IPCC_C2MR"]
pub type R = crate::R<u32, super::IPCC_C2MR>;
#[doc = "Writer for register IPCC_C2MR"]
pub type W = crate::W<u32, super::IPCC_C2MR>;
#[doc = "Register IPCC_C2MR `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::IPCC_C2MR {
    type Type = u32;
    #[inline(always)]
