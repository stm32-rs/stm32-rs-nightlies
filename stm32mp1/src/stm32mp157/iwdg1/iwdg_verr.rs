...
You can [`read`](crate::Reg::read) this register and get [`iwdg_verr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#IWDG1:IWDG_VERR)*/
pub struct IWDG_VERRrs;
impl crate::RegisterSpec for IWDG_VERRrs {
    type Ux = u32;
}
///`read()` method returns [`iwdg_verr::R`](R) reader structure
impl crate::Readable for IWDG_VERRrs {}
///`reset()` method sets IWDG_VERR to value 0x23
