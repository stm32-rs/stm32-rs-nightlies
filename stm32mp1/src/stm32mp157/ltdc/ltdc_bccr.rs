#[doc = "Reader of register LTDC_BCCR"]
pub type R = crate::R<u32, super::LTDC_BCCR>;
#[doc = "Writer for register LTDC_BCCR"]
pub type W = crate::W<u32, super::LTDC_BCCR>;
#[doc = "Register LTDC_BCCR `reset()`'s with value 0"]
impl crate::ResetValue for super::LTDC_BCCR {
    type Type = u32;
    #[inline(always)]
