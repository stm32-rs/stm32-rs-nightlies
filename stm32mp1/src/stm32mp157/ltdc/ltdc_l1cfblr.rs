#[doc = "Reader of register LTDC_L1CFBLR"]
pub type R = crate::R<u32, super::LTDC_L1CFBLR>;
#[doc = "Writer for register LTDC_L1CFBLR"]
pub type W = crate::W<u32, super::LTDC_L1CFBLR>;
#[doc = "Register LTDC_L1CFBLR `reset()`'s with value 0"]
impl crate::ResetValue for super::LTDC_L1CFBLR {
    type Type = u32;
    #[inline(always)]
