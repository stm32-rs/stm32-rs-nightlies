#[doc = "Writer for register LTDC_L1CLUTWR"]
pub type W = crate::W<u32, super::LTDC_L1CLUTWR>;
#[doc = "Register LTDC_L1CLUTWR `reset()`'s with value 0"]
impl crate::ResetValue for super::LTDC_L1CLUTWR {
    type Type = u32;
    #[inline(always)]
