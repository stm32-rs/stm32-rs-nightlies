///Register `LTDC_L1DCCR` reader
pub type R = crate::R<LTDC_L1DCCRrs>;
///Register `LTDC_L1DCCR` writer
pub type W = crate::W<LTDC_L1DCCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcblue(&mut self) -> DCBLUE_W<LTDC_L1DCCRrs> {
        DCBLUE_W::new(self, 0)
    }
    ///Bits 8:15 - DCGREEN
    #[inline(always)]
    #[must_use]
    pub fn dcgreen(&mut self) -> DCGREEN_W<LTDC_L1DCCRrs> {
        DCGREEN_W::new(self, 8)
    }
    ///Bits 16:23 - DCRED
    #[inline(always)]
    #[must_use]
    pub fn dcred(&mut self) -> DCRED_W<LTDC_L1DCCRrs> {
        DCRED_W::new(self, 16)
    }
    ///Bits 24:31 - DCALPHA
    #[inline(always)]
    #[must_use]
    pub fn dcalpha(&mut self) -> DCALPHA_W<LTDC_L1DCCRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`ltdc_l1dccr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ltdc_l1dccr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#LTDC:LTDC_L1DCCR)*/
pub struct LTDC_L1DCCRrs;
impl crate::RegisterSpec for LTDC_L1DCCRrs {
    type Ux = u32;
}
///`read()` method returns [`ltdc_l1dccr::R`](R) reader structure
impl crate::Readable for LTDC_L1DCCRrs {}
///`write(|w| ..)` method takes [`ltdc_l1dccr::W`](W) writer structure
impl crate::Writable for LTDC_L1DCCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LTDC_L1DCCR to value 0
impl crate::Resettable for LTDC_L1DCCRrs {
