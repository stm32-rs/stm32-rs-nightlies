///Register `LTDC_L1WVPCR` reader
pub type R = crate::R<LTDC_L1WVPCRrs>;
///Register `LTDC_L1WVPCR` writer
...
You can [`read`](crate::Reg::read) this register and get [`ltdc_l1wvpcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ltdc_l1wvpcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#LTDC:LTDC_L1WVPCR)*/
pub struct LTDC_L1WVPCRrs;
impl crate::RegisterSpec for LTDC_L1WVPCRrs {
    type Ux = u32;
}
///`read()` method returns [`ltdc_l1wvpcr::R`](R) reader structure
impl crate::Readable for LTDC_L1WVPCRrs {}
///`write(|w| ..)` method takes [`ltdc_l1wvpcr::W`](W) writer structure
impl crate::Writable for LTDC_L1WVPCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LTDC_L1WVPCR to value 0
