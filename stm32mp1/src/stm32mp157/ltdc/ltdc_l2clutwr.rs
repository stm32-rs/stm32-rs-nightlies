#[doc = "Writer for register LTDC_L2CLUTWR"]
pub type W = crate::W<u32, super::LTDC_L2CLUTWR>;
#[doc = "Register LTDC_L2CLUTWR `reset()`'s with value 0"]
impl crate::ResetValue for super::LTDC_L2CLUTWR {
    type Type = u32;
    #[inline(always)]
