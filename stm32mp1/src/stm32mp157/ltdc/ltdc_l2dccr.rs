#[doc = "Reader of register LTDC_L2DCCR"]
pub type R = crate::R<u32, super::LTDC_L2DCCR>;
#[doc = "Writer for register LTDC_L2DCCR"]
pub type W = crate::W<u32, super::LTDC_L2DCCR>;
#[doc = "Register LTDC_L2DCCR `reset()`'s with value 0"]
impl crate::ResetValue for super::LTDC_L2DCCR {
    type Type = u32;
    #[inline(always)]
