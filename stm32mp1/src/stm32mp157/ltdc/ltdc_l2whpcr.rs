#[doc = "Reader of register LTDC_L2WHPCR"]
pub type R = crate::R<u32, super::LTDC_L2WHPCR>;
#[doc = "Writer for register LTDC_L2WHPCR"]
pub type W = crate::W<u32, super::LTDC_L2WHPCR>;
#[doc = "Register LTDC_L2WHPCR `reset()`'s with value 0"]
impl crate::ResetValue for super::LTDC_L2WHPCR {
    type Type = u32;
    #[inline(always)]
