#[doc = "Reader of register LTDC_L2WVPCR"]
pub type R = crate::R<u32, super::LTDC_L2WVPCR>;
#[doc = "Writer for register LTDC_L2WVPCR"]
pub type W = crate::W<u32, super::LTDC_L2WVPCR>;
#[doc = "Register LTDC_L2WVPCR `reset()`'s with value 0"]
impl crate::ResetValue for super::LTDC_L2WVPCR {
    type Type = u32;
    #[inline(always)]
