#[doc = "Reader of register LTDC_SRCR"]
pub type R = crate::R<u32, super::LTDC_SRCR>;
#[doc = "Writer for register LTDC_SRCR"]
pub type W = crate::W<u32, super::LTDC_SRCR>;
#[doc = "Register LTDC_SRCR `reset()`'s with value 0"]
impl crate::ResetValue for super::LTDC_SRCR {
    type Type = u32;
    #[inline(always)]
