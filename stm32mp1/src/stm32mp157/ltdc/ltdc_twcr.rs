#[doc = "Reader of register LTDC_TWCR"]
pub type R = crate::R<u32, super::LTDC_TWCR>;
#[doc = "Writer for register LTDC_TWCR"]
pub type W = crate::W<u32, super::LTDC_TWCR>;
#[doc = "Register LTDC_TWCR `reset()`'s with value 0"]
impl crate::ResetValue for super::LTDC_TWCR {
    type Type = u32;
    #[inline(always)]
