...
pub type R = crate::R<MDIOS_DINR1rs>;
...
pub struct MDIOS_DINR1rs;
impl crate::RegisterSpec for MDIOS_DINR1rs {
    type Ux = u32;
}
///`read()` method returns [`mdios_dinr1::R`](R) reader structure
impl crate::Readable for MDIOS_DINR1rs {}
///`reset()` method sets MDIOS_DINR1 to value 0
impl crate::Resettable for MDIOS_DINR1rs {
