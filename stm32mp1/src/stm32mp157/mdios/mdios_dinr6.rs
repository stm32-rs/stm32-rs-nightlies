...
pub type R = crate::R<MDIOS_DINR6rs>;
...
pub struct MDIOS_DINR6rs;
impl crate::RegisterSpec for MDIOS_DINR6rs {
    type Ux = u32;
}
///`read()` method returns [`mdios_dinr6::R`](R) reader structure
impl crate::Readable for MDIOS_DINR6rs {}
///`reset()` method sets MDIOS_DINR6 to value 0
impl crate::Resettable for MDIOS_DINR6rs {
