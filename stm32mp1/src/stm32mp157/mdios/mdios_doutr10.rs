...
You can [`read`](crate::Reg::read) this register and get [`mdios_doutr10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mdios_doutr10::R`](R) reader structure
impl crate::Readable for MDIOS_DOUTR10rs {}
///`reset()` method sets MDIOS_DOUTR10 to value 0
