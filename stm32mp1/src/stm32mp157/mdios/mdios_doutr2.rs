...
You can [`read`](crate::Reg::read) this register and get [`mdios_doutr2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mdios_doutr2::R`](R) reader structure
impl crate::Readable for MDIOS_DOUTR2rs {}
///`reset()` method sets MDIOS_DOUTR2 to value 0
