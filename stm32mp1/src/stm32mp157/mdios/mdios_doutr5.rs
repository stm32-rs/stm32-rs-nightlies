...
You can [`read`](crate::Reg::read) this register and get [`mdios_doutr5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mdios_doutr5::R`](R) reader structure
impl crate::Readable for MDIOS_DOUTR5rs {}
///`reset()` method sets MDIOS_DOUTR5 to value 0
