///Register `C0ISR` reader
pub type R = crate::R<C0ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c0isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C0ISR)*/
pub struct C0ISRrs;
impl crate::RegisterSpec for C0ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c0isr::R`](R) reader structure
impl crate::Readable for C0ISRrs {}
///`reset()` method sets C0ISR to value 0
impl crate::Resettable for C0ISRrs {}
