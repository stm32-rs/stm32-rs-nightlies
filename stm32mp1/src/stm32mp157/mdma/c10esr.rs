///Register `C10ESR` reader
pub type R = crate::R<C10ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c10esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C10ESR)*/
pub struct C10ESRrs;
impl crate::RegisterSpec for C10ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c10esr::R`](R) reader structure
impl crate::Readable for C10ESRrs {}
///`reset()` method sets C10ESR to value 0
impl crate::Resettable for C10ESRrs {}
