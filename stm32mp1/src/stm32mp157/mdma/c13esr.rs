///Register `C13ESR` reader
pub type R = crate::R<C13ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c13esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C13ESR)*/
pub struct C13ESRrs;
impl crate::RegisterSpec for C13ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c13esr::R`](R) reader structure
impl crate::Readable for C13ESRrs {}
///`reset()` method sets C13ESR to value 0
impl crate::Resettable for C13ESRrs {}
