///Register `C14ESR` reader
pub type R = crate::R<C14ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c14esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C14ESR)*/
pub struct C14ESRrs;
impl crate::RegisterSpec for C14ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c14esr::R`](R) reader structure
impl crate::Readable for C14ESRrs {}
///`reset()` method sets C14ESR to value 0
impl crate::Resettable for C14ESRrs {}
