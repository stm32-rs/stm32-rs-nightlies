///Register `C15TBR` reader
pub type R = crate::R<C15TBRrs>;
///Register `C15TBR` writer
pub type W = crate::W<C15TBRrs>;
...
impl W {
    ///Bits 0:5 - TSEL
    #[inline(always)]
    pub fn tsel(&mut self) -> TSEL_W<'_, C15TBRrs> {
        TSEL_W::new(self, 0)
    }
    ///Bit 16 - SBUS
    #[inline(always)]
    pub fn sbus(&mut self) -> SBUS_W<'_, C15TBRrs> {
        SBUS_W::new(self, 16)
    }
    ///Bit 17 - DBUS
    #[inline(always)]
    pub fn dbus(&mut self) -> DBUS_W<'_, C15TBRrs> {
        DBUS_W::new(self, 17)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`c15tbr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c15tbr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C15TBR)*/
pub struct C15TBRrs;
impl crate::RegisterSpec for C15TBRrs {
    type Ux = u32;
}
///`read()` method returns [`c15tbr::R`](R) reader structure
impl crate::Readable for C15TBRrs {}
///`write(|w| ..)` method takes [`c15tbr::W`](W) writer structure
impl crate::Writable for C15TBRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C15TBR to value 0
impl crate::Resettable for C15TBRrs {}
