///Register `C16ESR` reader
pub type R = crate::R<C16ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c16esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C16ESR)*/
pub struct C16ESRrs;
impl crate::RegisterSpec for C16ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c16esr::R`](R) reader structure
impl crate::Readable for C16ESRrs {}
///`reset()` method sets C16ESR to value 0
impl crate::Resettable for C16ESRrs {}
