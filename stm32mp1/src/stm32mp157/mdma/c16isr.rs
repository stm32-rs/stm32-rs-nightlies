///Register `C16ISR` reader
pub type R = crate::R<C16ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c16isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C16ISR)*/
pub struct C16ISRrs;
impl crate::RegisterSpec for C16ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c16isr::R`](R) reader structure
impl crate::Readable for C16ISRrs {}
///`reset()` method sets C16ISR to value 0
impl crate::Resettable for C16ISRrs {}
