///Register `C17ISR` reader
pub type R = crate::R<C17ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c17isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C17ISR)*/
pub struct C17ISRrs;
impl crate::RegisterSpec for C17ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c17isr::R`](R) reader structure
impl crate::Readable for C17ISRrs {}
///`reset()` method sets C17ISR to value 0
impl crate::Resettable for C17ISRrs {}
