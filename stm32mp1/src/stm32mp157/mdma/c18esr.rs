///Register `C18ESR` reader
pub type R = crate::R<C18ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c18esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C18ESR)*/
pub struct C18ESRrs;
impl crate::RegisterSpec for C18ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c18esr::R`](R) reader structure
impl crate::Readable for C18ESRrs {}
///`reset()` method sets C18ESR to value 0
impl crate::Resettable for C18ESRrs {}
