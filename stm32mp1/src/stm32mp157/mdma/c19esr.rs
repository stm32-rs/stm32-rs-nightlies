///Register `C19ESR` reader
pub type R = crate::R<C19ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c19esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C19ESR)*/
pub struct C19ESRrs;
impl crate::RegisterSpec for C19ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c19esr::R`](R) reader structure
impl crate::Readable for C19ESRrs {}
///`reset()` method sets C19ESR to value 0
impl crate::Resettable for C19ESRrs {}
