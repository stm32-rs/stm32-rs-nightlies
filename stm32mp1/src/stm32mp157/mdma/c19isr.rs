///Register `C19ISR` reader
pub type R = crate::R<C19ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c19isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C19ISR)*/
pub struct C19ISRrs;
impl crate::RegisterSpec for C19ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c19isr::R`](R) reader structure
impl crate::Readable for C19ISRrs {}
///`reset()` method sets C19ISR to value 0
impl crate::Resettable for C19ISRrs {}
