///Register `C1ESR` reader
pub type R = crate::R<C1ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c1esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C1ESR)*/
pub struct C1ESRrs;
impl crate::RegisterSpec for C1ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c1esr::R`](R) reader structure
impl crate::Readable for C1ESRrs {}
///`reset()` method sets C1ESR to value 0
impl crate::Resettable for C1ESRrs {}
