///Register `C20ISR` reader
pub type R = crate::R<C20ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c20isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C20ISR)*/
pub struct C20ISRrs;
impl crate::RegisterSpec for C20ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c20isr::R`](R) reader structure
impl crate::Readable for C20ISRrs {}
///`reset()` method sets C20ISR to value 0
impl crate::Resettable for C20ISRrs {}
