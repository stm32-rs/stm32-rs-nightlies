///Register `C21ISR` reader
pub type R = crate::R<C21ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c21isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C21ISR)*/
pub struct C21ISRrs;
impl crate::RegisterSpec for C21ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c21isr::R`](R) reader structure
impl crate::Readable for C21ISRrs {}
///`reset()` method sets C21ISR to value 0
impl crate::Resettable for C21ISRrs {}
