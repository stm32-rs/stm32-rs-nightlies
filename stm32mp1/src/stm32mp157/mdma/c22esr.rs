///Register `C22ESR` reader
pub type R = crate::R<C22ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c22esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C22ESR)*/
pub struct C22ESRrs;
impl crate::RegisterSpec for C22ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c22esr::R`](R) reader structure
impl crate::Readable for C22ESRrs {}
///`reset()` method sets C22ESR to value 0
impl crate::Resettable for C22ESRrs {}
