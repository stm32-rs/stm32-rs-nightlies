///Register `C22ISR` reader
pub type R = crate::R<C22ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c22isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C22ISR)*/
pub struct C22ISRrs;
impl crate::RegisterSpec for C22ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c22isr::R`](R) reader structure
impl crate::Readable for C22ISRrs {}
///`reset()` method sets C22ISR to value 0
impl crate::Resettable for C22ISRrs {}
