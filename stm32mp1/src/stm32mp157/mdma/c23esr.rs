///Register `C23ESR` reader
pub type R = crate::R<C23ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c23esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C23ESR)*/
pub struct C23ESRrs;
impl crate::RegisterSpec for C23ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c23esr::R`](R) reader structure
impl crate::Readable for C23ESRrs {}
///`reset()` method sets C23ESR to value 0
impl crate::Resettable for C23ESRrs {}
