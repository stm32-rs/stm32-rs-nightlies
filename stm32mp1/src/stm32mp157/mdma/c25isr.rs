///Register `C25ISR` reader
pub type R = crate::R<C25ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c25isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C25ISR)*/
pub struct C25ISRrs;
impl crate::RegisterSpec for C25ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c25isr::R`](R) reader structure
impl crate::Readable for C25ISRrs {}
///`reset()` method sets C25ISR to value 0
impl crate::Resettable for C25ISRrs {}
