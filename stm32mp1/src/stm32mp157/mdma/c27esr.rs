///Register `C27ESR` reader
pub type R = crate::R<C27ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c27esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C27ESR)*/
pub struct C27ESRrs;
impl crate::RegisterSpec for C27ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c27esr::R`](R) reader structure
impl crate::Readable for C27ESRrs {}
///`reset()` method sets C27ESR to value 0
impl crate::Resettable for C27ESRrs {}
