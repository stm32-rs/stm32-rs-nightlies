///Register `C27ISR` reader
pub type R = crate::R<C27ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c27isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C27ISR)*/
pub struct C27ISRrs;
impl crate::RegisterSpec for C27ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c27isr::R`](R) reader structure
impl crate::Readable for C27ISRrs {}
///`reset()` method sets C27ISR to value 0
impl crate::Resettable for C27ISRrs {}
