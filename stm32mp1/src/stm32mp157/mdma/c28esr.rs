///Register `C28ESR` reader
pub type R = crate::R<C28ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c28esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C28ESR)*/
pub struct C28ESRrs;
impl crate::RegisterSpec for C28ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c28esr::R`](R) reader structure
impl crate::Readable for C28ESRrs {}
///`reset()` method sets C28ESR to value 0
impl crate::Resettable for C28ESRrs {}
