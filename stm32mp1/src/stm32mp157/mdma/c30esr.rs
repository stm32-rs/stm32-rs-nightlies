///Register `C30ESR` reader
pub type R = crate::R<C30ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c30esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C30ESR)*/
pub struct C30ESRrs;
impl crate::RegisterSpec for C30ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c30esr::R`](R) reader structure
impl crate::Readable for C30ESRrs {}
///`reset()` method sets C30ESR to value 0
impl crate::Resettable for C30ESRrs {}
