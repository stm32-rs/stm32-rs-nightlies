///Register `C30ISR` reader
pub type R = crate::R<C30ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c30isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C30ISR)*/
pub struct C30ISRrs;
impl crate::RegisterSpec for C30ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c30isr::R`](R) reader structure
impl crate::Readable for C30ISRrs {}
///`reset()` method sets C30ISR to value 0
impl crate::Resettable for C30ISRrs {}
