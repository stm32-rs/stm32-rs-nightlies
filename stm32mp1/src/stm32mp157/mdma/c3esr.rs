///Register `C3ESR` reader
pub type R = crate::R<C3ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c3esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C3ESR)*/
pub struct C3ESRrs;
impl crate::RegisterSpec for C3ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c3esr::R`](R) reader structure
impl crate::Readable for C3ESRrs {}
///`reset()` method sets C3ESR to value 0
impl crate::Resettable for C3ESRrs {}
