///Register `C6ESR` reader
pub type R = crate::R<C6ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c6esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C6ESR)*/
pub struct C6ESRrs;
impl crate::RegisterSpec for C6ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c6esr::R`](R) reader structure
impl crate::Readable for C6ESRrs {}
///`reset()` method sets C6ESR to value 0
impl crate::Resettable for C6ESRrs {}
