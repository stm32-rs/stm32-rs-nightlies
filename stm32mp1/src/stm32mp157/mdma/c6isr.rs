///Register `C6ISR` reader
pub type R = crate::R<C6ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c6isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C6ISR)*/
pub struct C6ISRrs;
impl crate::RegisterSpec for C6ISRrs {
    type Ux = u32;
}
///`read()` method returns [`c6isr::R`](R) reader structure
impl crate::Readable for C6ISRrs {}
///`reset()` method sets C6ISR to value 0
impl crate::Resettable for C6ISRrs {}
