///Register `C7ESR` reader
pub type R = crate::R<C7ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c7esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C7ESR)*/
pub struct C7ESRrs;
impl crate::RegisterSpec for C7ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c7esr::R`](R) reader structure
impl crate::Readable for C7ESRrs {}
///`reset()` method sets C7ESR to value 0
impl crate::Resettable for C7ESRrs {}
