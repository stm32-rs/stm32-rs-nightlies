///Register `C8ESR` reader
pub type R = crate::R<C8ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c8esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:C8ESR)*/
pub struct C8ESRrs;
impl crate::RegisterSpec for C8ESRrs {
    type Ux = u32;
}
///`read()` method returns [`c8esr::R`](R) reader structure
impl crate::Readable for C8ESRrs {}
///`reset()` method sets C8ESR to value 0
impl crate::Resettable for C8ESRrs {}
