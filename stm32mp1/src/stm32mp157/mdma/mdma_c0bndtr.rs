///Register `MDMA_C0BNDTR` reader
pub type R = crate::R<MDMA_C0BNDTRrs>;
///Register `MDMA_C0BNDTR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C0BNDTR)*/
pub struct MDMA_C0BNDTRrs;
impl crate::RegisterSpec for MDMA_C0BNDTRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c0bndtr::R`](R) reader structure
impl crate::Readable for MDMA_C0BNDTRrs {}
///`write(|w| ..)` method takes [`mdma_c0bndtr::W`](W) writer structure
impl crate::Writable for MDMA_C0BNDTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C0BNDTR to value 0
