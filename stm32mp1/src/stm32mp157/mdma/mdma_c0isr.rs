...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C0ISR)*/
pub struct MDMA_C0ISRrs;
impl crate::RegisterSpec for MDMA_C0ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c0isr::R`](R) reader structure
impl crate::Readable for MDMA_C0ISRrs {}
///`reset()` method sets MDMA_C0ISR to value 0
