...
pub type R = crate::R<MDMA_C0LARrs>;
#[doc = "Register `MDMA_C0LAR` writer"]
pub type W = crate::W<MDMA_C0LARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lar(&mut self) -> LAR_W<MDMA_C0LARrs> {
        LAR_W::new(self, 0)
    }
}
...
+ 0x14). The new value is only taken into account after all registers are updated, for the next end of block.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c0lar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdma_c0lar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDMA_C0LARrs;
impl crate::RegisterSpec for MDMA_C0LARrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c0lar::R`](R) reader structure"]
impl crate::Readable for MDMA_C0LARrs {}
#[doc = "`write(|w| ..)` method takes [`mdma_c0lar::W`](W) writer structure"]
impl crate::Writable for MDMA_C0LARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDMA_C0LAR to value 0"]
impl crate::Resettable for MDMA_C0LARrs {
