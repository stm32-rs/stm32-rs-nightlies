///Register `MDMA_C10ISR` reader
pub type R = crate::R<MDMA_C10ISRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C10ISR)*/
pub struct MDMA_C10ISRrs;
impl crate::RegisterSpec for MDMA_C10ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c10isr::R`](R) reader structure
impl crate::Readable for MDMA_C10ISRrs {}
///`reset()` method sets MDMA_C10ISR to value 0
impl crate::Resettable for MDMA_C10ISRrs {
