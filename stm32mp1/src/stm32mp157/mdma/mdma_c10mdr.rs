///Register `MDMA_C10MDR` reader
pub type R = crate::R<MDMA_C10MDRrs>;
///Register `MDMA_C10MDR` writer
pub type W = crate::W<MDMA_C10MDRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdr(&mut self) -> MDR_W<MDMA_C10MDRrs> {
        MDR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C10MDR)*/
pub struct MDMA_C10MDRrs;
impl crate::RegisterSpec for MDMA_C10MDRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c10mdr::R`](R) reader structure
impl crate::Readable for MDMA_C10MDRrs {}
///`write(|w| ..)` method takes [`mdma_c10mdr::W`](W) writer structure
impl crate::Writable for MDMA_C10MDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C10MDR to value 0
impl crate::Resettable for MDMA_C10MDRrs {
