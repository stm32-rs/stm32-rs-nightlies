///Register `MDMA_C10TCR` reader
pub type R = crate::R<MDMA_C10TCRrs>;
///Register `MDMA_C10TCR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C10TCR)*/
pub struct MDMA_C10TCRrs;
impl crate::RegisterSpec for MDMA_C10TCRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c10tcr::R`](R) reader structure
impl crate::Readable for MDMA_C10TCRrs {}
///`write(|w| ..)` method takes [`mdma_c10tcr::W`](W) writer structure
impl crate::Writable for MDMA_C10TCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C10TCR to value 0
