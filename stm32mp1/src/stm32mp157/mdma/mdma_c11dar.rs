...
pub type R = crate::R<MDMA_C11DARrs>;
///Register `MDMA_C11DAR` writer
pub type W = crate::W<MDMA_C11DARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dar(&mut self) -> DAR_W<MDMA_C11DARrs> {
        DAR_W::new(self, 0)
    }
}
...
pub struct MDMA_C11DARrs;
impl crate::RegisterSpec for MDMA_C11DARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c11dar::R`](R) reader structure
impl crate::Readable for MDMA_C11DARrs {}
///`write(|w| ..)` method takes [`mdma_c11dar::W`](W) writer structure
impl crate::Writable for MDMA_C11DARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C11DAR to value 0
impl crate::Resettable for MDMA_C11DARrs {
