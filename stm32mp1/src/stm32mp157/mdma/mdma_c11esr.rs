///Register `MDMA_C11ESR` reader
pub type R = crate::R<MDMA_C11ESRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C11ESR)*/
pub struct MDMA_C11ESRrs;
impl crate::RegisterSpec for MDMA_C11ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c11esr::R`](R) reader structure
impl crate::Readable for MDMA_C11ESRrs {}
///`reset()` method sets MDMA_C11ESR to value 0
impl crate::Resettable for MDMA_C11ESRrs {
