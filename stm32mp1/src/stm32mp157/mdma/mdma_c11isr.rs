...
pub type R = crate::R<MDMA_C11ISRrs>;
...
pub struct MDMA_C11ISRrs;
impl crate::RegisterSpec for MDMA_C11ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c11isr::R`](R) reader structure
impl crate::Readable for MDMA_C11ISRrs {}
///`reset()` method sets MDMA_C11ISR to value 0
impl crate::Resettable for MDMA_C11ISRrs {
