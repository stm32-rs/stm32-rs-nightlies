///Register `MDMA_C12DAR` reader
pub type R = crate::R<MDMA_C12DARrs>;
///Register `MDMA_C12DAR` writer
pub type W = crate::W<MDMA_C12DARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dar(&mut self) -> DAR_W<MDMA_C12DARrs> {
        DAR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C12DAR)*/
pub struct MDMA_C12DARrs;
impl crate::RegisterSpec for MDMA_C12DARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c12dar::R`](R) reader structure
impl crate::Readable for MDMA_C12DARrs {}
///`write(|w| ..)` method takes [`mdma_c12dar::W`](W) writer structure
impl crate::Writable for MDMA_C12DARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C12DAR to value 0
impl crate::Resettable for MDMA_C12DARrs {
