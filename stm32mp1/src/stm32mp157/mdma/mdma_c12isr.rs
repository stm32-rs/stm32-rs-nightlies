///Register `MDMA_C12ISR` reader
pub type R = crate::R<MDMA_C12ISRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C12ISR)*/
pub struct MDMA_C12ISRrs;
impl crate::RegisterSpec for MDMA_C12ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c12isr::R`](R) reader structure
impl crate::Readable for MDMA_C12ISRrs {}
///`reset()` method sets MDMA_C12ISR to value 0
impl crate::Resettable for MDMA_C12ISRrs {
