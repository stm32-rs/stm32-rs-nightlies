...
pub type R = crate::R<MDMA_C13ESRrs>;
...
pub struct MDMA_C13ESRrs;
impl crate::RegisterSpec for MDMA_C13ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c13esr::R`](R) reader structure
impl crate::Readable for MDMA_C13ESRrs {}
///`reset()` method sets MDMA_C13ESR to value 0
impl crate::Resettable for MDMA_C13ESRrs {
