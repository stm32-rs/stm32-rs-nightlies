...
pub type R = crate::R<MDMA_C13TBRrs>;
///Register `MDMA_C13TBR` writer
pub type W = crate::W<MDMA_C13TBRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsel(&mut self) -> TSEL_W<MDMA_C13TBRrs> {
        TSEL_W::new(self, 0)
    }
    ///Bit 16 - SBUS
    #[inline(always)]
    #[must_use]
    pub fn sbus(&mut self) -> SBUS_W<MDMA_C13TBRrs> {
        SBUS_W::new(self, 16)
    }
    ///Bit 17 - DBUS
    #[inline(always)]
    #[must_use]
    pub fn dbus(&mut self) -> DBUS_W<MDMA_C13TBRrs> {
        DBUS_W::new(self, 17)
    }
}
...
pub struct MDMA_C13TBRrs;
impl crate::RegisterSpec for MDMA_C13TBRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c13tbr::R`](R) reader structure
impl crate::Readable for MDMA_C13TBRrs {}
///`write(|w| ..)` method takes [`mdma_c13tbr::W`](W) writer structure
impl crate::Writable for MDMA_C13TBRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C13TBR to value 0
impl crate::Resettable for MDMA_C13TBRrs {
