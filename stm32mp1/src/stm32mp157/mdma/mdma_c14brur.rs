...
pub type R = crate::R<MDMA_C14BRURrs>;
///Register `MDMA_C14BRUR` writer
pub type W = crate::W<MDMA_C14BRURrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn suv(&mut self) -> SUV_W<MDMA_C14BRURrs> {
        SUV_W::new(self, 0)
    }
    ///Bits 16:31 - DUV
    #[inline(always)]
    #[must_use]
    pub fn duv(&mut self) -> DUV_W<MDMA_C14BRURrs> {
        DUV_W::new(self, 16)
    }
}
...
pub struct MDMA_C14BRURrs;
impl crate::RegisterSpec for MDMA_C14BRURrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c14brur::R`](R) reader structure
impl crate::Readable for MDMA_C14BRURrs {}
///`write(|w| ..)` method takes [`mdma_c14brur::W`](W) writer structure
impl crate::Writable for MDMA_C14BRURrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C14BRUR to value 0
impl crate::Resettable for MDMA_C14BRURrs {
