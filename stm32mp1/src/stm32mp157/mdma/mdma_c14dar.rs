///Register `MDMA_C14DAR` reader
pub type R = crate::R<MDMA_C14DARrs>;
///Register `MDMA_C14DAR` writer
pub type W = crate::W<MDMA_C14DARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dar(&mut self) -> DAR_W<MDMA_C14DARrs> {
        DAR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C14DAR)*/
pub struct MDMA_C14DARrs;
impl crate::RegisterSpec for MDMA_C14DARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c14dar::R`](R) reader structure
impl crate::Readable for MDMA_C14DARrs {}
///`write(|w| ..)` method takes [`mdma_c14dar::W`](W) writer structure
impl crate::Writable for MDMA_C14DARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C14DAR to value 0
impl crate::Resettable for MDMA_C14DARrs {
