///Register `MDMA_C14ESR` reader
pub type R = crate::R<MDMA_C14ESRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C14ESR)*/
pub struct MDMA_C14ESRrs;
impl crate::RegisterSpec for MDMA_C14ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c14esr::R`](R) reader structure
impl crate::Readable for MDMA_C14ESRrs {}
///`reset()` method sets MDMA_C14ESR to value 0
impl crate::Resettable for MDMA_C14ESRrs {
