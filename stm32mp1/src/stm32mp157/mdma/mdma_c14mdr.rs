///Register `MDMA_C14MDR` reader
pub type R = crate::R<MDMA_C14MDRrs>;
///Register `MDMA_C14MDR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C14MDR)*/
pub struct MDMA_C14MDRrs;
impl crate::RegisterSpec for MDMA_C14MDRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c14mdr::R`](R) reader structure
impl crate::Readable for MDMA_C14MDRrs {}
///`write(|w| ..)` method takes [`mdma_c14mdr::W`](W) writer structure
impl crate::Writable for MDMA_C14MDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C14MDR to value 0
