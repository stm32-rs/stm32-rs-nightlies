...
pub type R = crate::R<MDMA_C14SARrs>;
///Register `MDMA_C14SAR` writer
pub type W = crate::W<MDMA_C14SARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar(&mut self) -> SAR_W<MDMA_C14SARrs> {
        SAR_W::new(self, 0)
    }
}
...
pub struct MDMA_C14SARrs;
impl crate::RegisterSpec for MDMA_C14SARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c14sar::R`](R) reader structure
impl crate::Readable for MDMA_C14SARrs {}
///`write(|w| ..)` method takes [`mdma_c14sar::W`](W) writer structure
impl crate::Writable for MDMA_C14SARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C14SAR to value 0
impl crate::Resettable for MDMA_C14SARrs {
