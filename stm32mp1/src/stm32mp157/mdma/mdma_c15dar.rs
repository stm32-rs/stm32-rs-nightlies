///Register `MDMA_C15DAR` reader
pub type R = crate::R<MDMA_C15DARrs>;
///Register `MDMA_C15DAR` writer
pub type W = crate::W<MDMA_C15DARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dar(&mut self) -> DAR_W<MDMA_C15DARrs> {
        DAR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C15DAR)*/
pub struct MDMA_C15DARrs;
impl crate::RegisterSpec for MDMA_C15DARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c15dar::R`](R) reader structure
impl crate::Readable for MDMA_C15DARrs {}
///`write(|w| ..)` method takes [`mdma_c15dar::W`](W) writer structure
impl crate::Writable for MDMA_C15DARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C15DAR to value 0
impl crate::Resettable for MDMA_C15DARrs {
