///Register `MDMA_C15MAR` reader
pub type R = crate::R<MDMA_C15MARrs>;
///Register `MDMA_C15MAR` writer
pub type W = crate::W<MDMA_C15MARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mar(&mut self) -> MAR_W<MDMA_C15MARrs> {
        MAR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C15MAR)*/
pub struct MDMA_C15MARrs;
impl crate::RegisterSpec for MDMA_C15MARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c15mar::R`](R) reader structure
impl crate::Readable for MDMA_C15MARrs {}
///`write(|w| ..)` method takes [`mdma_c15mar::W`](W) writer structure
impl crate::Writable for MDMA_C15MARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C15MAR to value 0
impl crate::Resettable for MDMA_C15MARrs {
