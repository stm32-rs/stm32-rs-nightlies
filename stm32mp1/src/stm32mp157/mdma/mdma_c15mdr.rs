///Register `MDMA_C15MDR` reader
pub type R = crate::R<MDMA_C15MDRrs>;
///Register `MDMA_C15MDR` writer
pub type W = crate::W<MDMA_C15MDRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdr(&mut self) -> MDR_W<MDMA_C15MDRrs> {
        MDR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C15MDR)*/
pub struct MDMA_C15MDRrs;
impl crate::RegisterSpec for MDMA_C15MDRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c15mdr::R`](R) reader structure
impl crate::Readable for MDMA_C15MDRrs {}
///`write(|w| ..)` method takes [`mdma_c15mdr::W`](W) writer structure
impl crate::Writable for MDMA_C15MDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C15MDR to value 0
impl crate::Resettable for MDMA_C15MDRrs {
