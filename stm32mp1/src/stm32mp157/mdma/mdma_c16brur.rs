///Register `MDMA_C16BRUR` reader
pub type R = crate::R<MDMA_C16BRURrs>;
///Register `MDMA_C16BRUR` writer
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c16brur::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdma_c16brur::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C16BRUR)*/
pub struct MDMA_C16BRURrs;
impl crate::RegisterSpec for MDMA_C16BRURrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c16brur::R`](R) reader structure
impl crate::Readable for MDMA_C16BRURrs {}
///`write(|w| ..)` method takes [`mdma_c16brur::W`](W) writer structure
impl crate::Writable for MDMA_C16BRURrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C16BRUR to value 0
