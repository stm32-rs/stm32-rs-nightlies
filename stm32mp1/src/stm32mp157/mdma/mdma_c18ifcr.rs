...
impl core::fmt::Debug for crate::generic::Reg<MDMA_C18IFCRrs> {
...
You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdma_c18ifcr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C18IFCR)*/
pub struct MDMA_C18IFCRrs;
impl crate::RegisterSpec for MDMA_C18IFCRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`mdma_c18ifcr::W`](W) writer structure
impl crate::Writable for MDMA_C18IFCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C18IFCR to value 0
