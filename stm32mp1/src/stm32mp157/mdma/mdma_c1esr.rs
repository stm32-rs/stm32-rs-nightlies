///Register `MDMA_C1ESR` reader
pub type R = crate::R<MDMA_C1ESRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C1ESR)*/
pub struct MDMA_C1ESRrs;
impl crate::RegisterSpec for MDMA_C1ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c1esr::R`](R) reader structure
impl crate::Readable for MDMA_C1ESRrs {}
///`reset()` method sets MDMA_C1ESR to value 0
impl crate::Resettable for MDMA_C1ESRrs {
