...
pub type R = crate::R<MDMA_C1ISRrs>;
...
pub struct MDMA_C1ISRrs;
impl crate::RegisterSpec for MDMA_C1ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c1isr::R`](R) reader structure
impl crate::Readable for MDMA_C1ISRrs {}
///`reset()` method sets MDMA_C1ISR to value 0
impl crate::Resettable for MDMA_C1ISRrs {
