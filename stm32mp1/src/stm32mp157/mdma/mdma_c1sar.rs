///Register `MDMA_C1SAR` reader
pub type R = crate::R<MDMA_C1SARrs>;
///Register `MDMA_C1SAR` writer
pub type W = crate::W<MDMA_C1SARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar(&mut self) -> SAR_W<MDMA_C1SARrs> {
        SAR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C1SAR)*/
pub struct MDMA_C1SARrs;
impl crate::RegisterSpec for MDMA_C1SARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c1sar::R`](R) reader structure
impl crate::Readable for MDMA_C1SARrs {}
///`write(|w| ..)` method takes [`mdma_c1sar::W`](W) writer structure
impl crate::Writable for MDMA_C1SARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C1SAR to value 0
impl crate::Resettable for MDMA_C1SARrs {
