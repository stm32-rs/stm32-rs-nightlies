...
pub type R = crate::R<MDMA_C22ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c22isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C22ISR)*/
pub struct MDMA_C22ISRrs;
impl crate::RegisterSpec for MDMA_C22ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c22isr::R`](R) reader structure
impl crate::Readable for MDMA_C22ISRrs {}
///`reset()` method sets MDMA_C22ISR to value 0
impl crate::Resettable for MDMA_C22ISRrs {
