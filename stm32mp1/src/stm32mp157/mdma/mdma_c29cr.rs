///Register `MDMA_C29CR` reader
pub type R = crate::R<MDMA_C29CRrs>;
///Register `MDMA_C29CR` writer
pub type W = crate::W<MDMA_C29CRrs>;
///Field `EN` reader - EN
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<MDMA_C29CRrs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - TEIE
    #[inline(always)]
    #[must_use]
    pub fn teie(&mut self) -> TEIE_W<MDMA_C29CRrs> {
        TEIE_W::new(self, 1)
    }
    ///Bit 2 - CTCIE
    #[inline(always)]
    #[must_use]
    pub fn ctcie(&mut self) -> CTCIE_W<MDMA_C29CRrs> {
        CTCIE_W::new(self, 2)
    }
    ///Bit 3 - BRTIE
    #[inline(always)]
    #[must_use]
    pub fn brtie(&mut self) -> BRTIE_W<MDMA_C29CRrs> {
        BRTIE_W::new(self, 3)
    }
    ///Bit 4 - BTIE
    #[inline(always)]
    #[must_use]
    pub fn btie(&mut self) -> BTIE_W<MDMA_C29CRrs> {
        BTIE_W::new(self, 4)
    }
    ///Bit 5 - TCIE
    #[inline(always)]
    #[must_use]
    pub fn tcie(&mut self) -> TCIE_W<MDMA_C29CRrs> {
        TCIE_W::new(self, 5)
    }
    ///Bits 6:7 - PL
    #[inline(always)]
    #[must_use]
    pub fn pl(&mut self) -> PL_W<MDMA_C29CRrs> {
        PL_W::new(self, 6)
    }
    ///Bit 12 - BEX
    #[inline(always)]
    #[must_use]
    pub fn bex(&mut self) -> BEX_W<MDMA_C29CRrs> {
        BEX_W::new(self, 12)
    }
    ///Bit 13 - HEX
    #[inline(always)]
    #[must_use]
    pub fn hex(&mut self) -> HEX_W<MDMA_C29CRrs> {
        HEX_W::new(self, 13)
    }
    ///Bit 14 - WEX
    #[inline(always)]
    #[must_use]
    pub fn wex(&mut self) -> WEX_W<MDMA_C29CRrs> {
        WEX_W::new(self, 14)
    }
    ///Bit 16 - SWRQ
    #[inline(always)]
    #[must_use]
    pub fn swrq(&mut self) -> SWRQ_W<MDMA_C29CRrs> {
        SWRQ_W::new(self, 16)
    }
}
/**This register is used to control the concerned channel.

You can [`read`](crate::Reg::read) this register and get [`mdma_c29cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdma_c29cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C29CR)*/
pub struct MDMA_C29CRrs;
impl crate::RegisterSpec for MDMA_C29CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c29cr::R`](R) reader structure
impl crate::Readable for MDMA_C29CRrs {}
///`write(|w| ..)` method takes [`mdma_c29cr::W`](W) writer structure
impl crate::Writable for MDMA_C29CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C29CR to value 0
impl crate::Resettable for MDMA_C29CRrs {
