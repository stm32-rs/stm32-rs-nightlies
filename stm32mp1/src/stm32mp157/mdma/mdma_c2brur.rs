#[doc = "Reader of register MDMA_C2BRUR"]
pub type R = crate::R<u32, super::MDMA_C2BRUR>;
#[doc = "Writer for register MDMA_C2BRUR"]
pub type W = crate::W<u32, super::MDMA_C2BRUR>;
#[doc = "Register MDMA_C2BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::MDMA_C2BRUR {
    type Type = u32;
    #[inline(always)]
