...
pub type R = crate::R<MDMA_C2ISRrs>;
...
#[doc = "MDMA channel 2 interrupt/status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c2isr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDMA_C2ISRrs;
impl crate::RegisterSpec for MDMA_C2ISRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c2isr::R`](R) reader structure"]
impl crate::Readable for MDMA_C2ISRrs {}
#[doc = "`reset()` method sets MDMA_C2ISR to value 0"]
impl crate::Resettable for MDMA_C2ISRrs {
