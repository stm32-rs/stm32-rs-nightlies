///Register `MDMA_C2TBR` reader
pub type R = crate::R<MDMA_C2TBRrs>;
///Register `MDMA_C2TBR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C2TBR)*/
pub struct MDMA_C2TBRrs;
impl crate::RegisterSpec for MDMA_C2TBRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c2tbr::R`](R) reader structure
impl crate::Readable for MDMA_C2TBRrs {}
///`write(|w| ..)` method takes [`mdma_c2tbr::W`](W) writer structure
impl crate::Writable for MDMA_C2TBRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C2TBR to value 0
