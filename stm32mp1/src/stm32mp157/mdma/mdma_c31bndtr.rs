...
pub type R = crate::R<MDMA_C31BNDTRrs>;
///Register `MDMA_C31BNDTR` writer
pub type W = crate::W<MDMA_C31BNDTRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bndt(&mut self) -> BNDT_W<MDMA_C31BNDTRrs> {
        BNDT_W::new(self, 0)
    }
    ///Bit 18 - BRSUM
    #[inline(always)]
    #[must_use]
    pub fn brsum(&mut self) -> BRSUM_W<MDMA_C31BNDTRrs> {
        BRSUM_W::new(self, 18)
    }
    ///Bit 19 - BRDUM
    #[inline(always)]
    #[must_use]
    pub fn brdum(&mut self) -> BRDUM_W<MDMA_C31BNDTRrs> {
        BRDUM_W::new(self, 19)
    }
    ///Bits 20:31 - BRC
    #[inline(always)]
    #[must_use]
    pub fn brc(&mut self) -> BRC_W<MDMA_C31BNDTRrs> {
        BRC_W::new(self, 20)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c31bndtr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdma_c31bndtr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C31BNDTR)*/
pub struct MDMA_C31BNDTRrs;
impl crate::RegisterSpec for MDMA_C31BNDTRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c31bndtr::R`](R) reader structure
impl crate::Readable for MDMA_C31BNDTRrs {}
///`write(|w| ..)` method takes [`mdma_c31bndtr::W`](W) writer structure
impl crate::Writable for MDMA_C31BNDTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C31BNDTR to value 0
impl crate::Resettable for MDMA_C31BNDTRrs {
