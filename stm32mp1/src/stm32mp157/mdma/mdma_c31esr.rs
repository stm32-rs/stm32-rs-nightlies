...
pub type R = crate::R<MDMA_C31ESRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c31esr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C31ESR)*/
pub struct MDMA_C31ESRrs;
impl crate::RegisterSpec for MDMA_C31ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c31esr::R`](R) reader structure
impl crate::Readable for MDMA_C31ESRrs {}
///`reset()` method sets MDMA_C31ESR to value 0
impl crate::Resettable for MDMA_C31ESRrs {
