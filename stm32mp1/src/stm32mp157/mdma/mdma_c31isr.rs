...
pub type R = crate::R<MDMA_C31ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdma_c31isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C31ISR)*/
pub struct MDMA_C31ISRrs;
impl crate::RegisterSpec for MDMA_C31ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c31isr::R`](R) reader structure
impl crate::Readable for MDMA_C31ISRrs {}
///`reset()` method sets MDMA_C31ISR to value 0
impl crate::Resettable for MDMA_C31ISRrs {
