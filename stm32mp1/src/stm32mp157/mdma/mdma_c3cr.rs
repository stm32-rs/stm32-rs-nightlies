...
pub type R = crate::R<MDMA_C3CRrs>;
#[doc = "Register `MDMA_C3CR` writer"]
pub type W = crate::W<MDMA_C3CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<MDMA_C3CRrs> {
        EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - TEIE"]
    #[inline(always)]
    #[must_use]
    pub fn teie(&mut self) -> TEIE_W<MDMA_C3CRrs> {
        TEIE_W::new(self, 1)
    }
    #[doc = "Bit 2 - CTCIE"]
    #[inline(always)]
    #[must_use]
    pub fn ctcie(&mut self) -> CTCIE_W<MDMA_C3CRrs> {
        CTCIE_W::new(self, 2)
    }
    #[doc = "Bit 3 - BRTIE"]
    #[inline(always)]
    #[must_use]
    pub fn brtie(&mut self) -> BRTIE_W<MDMA_C3CRrs> {
        BRTIE_W::new(self, 3)
    }
    #[doc = "Bit 4 - BTIE"]
    #[inline(always)]
    #[must_use]
    pub fn btie(&mut self) -> BTIE_W<MDMA_C3CRrs> {
        BTIE_W::new(self, 4)
    }
    #[doc = "Bit 5 - TCIE"]
    #[inline(always)]
    #[must_use]
    pub fn tcie(&mut self) -> TCIE_W<MDMA_C3CRrs> {
        TCIE_W::new(self, 5)
    }
    #[doc = "Bits 6:7 - PL"]
    #[inline(always)]
    #[must_use]
    pub fn pl(&mut self) -> PL_W<MDMA_C3CRrs> {
        PL_W::new(self, 6)
    }
    #[doc = "Bit 12 - BEX"]
    #[inline(always)]
    #[must_use]
    pub fn bex(&mut self) -> BEX_W<MDMA_C3CRrs> {
        BEX_W::new(self, 12)
    }
    #[doc = "Bit 13 - HEX"]
    #[inline(always)]
    #[must_use]
    pub fn hex(&mut self) -> HEX_W<MDMA_C3CRrs> {
        HEX_W::new(self, 13)
    }
    #[doc = "Bit 14 - WEX"]
    #[inline(always)]
    #[must_use]
    pub fn wex(&mut self) -> WEX_W<MDMA_C3CRrs> {
        WEX_W::new(self, 14)
    }
    #[doc = "Bit 16 - SWRQ"]
    #[inline(always)]
    #[must_use]
    pub fn swrq(&mut self) -> SWRQ_W<MDMA_C3CRrs> {
        SWRQ_W::new(self, 16)
    }
}
#[doc = "This register is used to control the concerned channel.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c3cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdma_c3cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDMA_C3CRrs;
impl crate::RegisterSpec for MDMA_C3CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c3cr::R`](R) reader structure"]
impl crate::Readable for MDMA_C3CRrs {}
#[doc = "`write(|w| ..)` method takes [`mdma_c3cr::W`](W) writer structure"]
impl crate::Writable for MDMA_C3CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDMA_C3CR to value 0"]
impl crate::Resettable for MDMA_C3CRrs {
