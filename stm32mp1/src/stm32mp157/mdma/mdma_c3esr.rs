...
pub type R = crate::R<MDMA_C3ESRrs>;
...
#[doc = "MDMA channel 3 error status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdma_c3esr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDMA_C3ESRrs;
impl crate::RegisterSpec for MDMA_C3ESRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdma_c3esr::R`](R) reader structure"]
impl crate::Readable for MDMA_C3ESRrs {}
#[doc = "`reset()` method sets MDMA_C3ESR to value 0"]
impl crate::Resettable for MDMA_C3ESRrs {
