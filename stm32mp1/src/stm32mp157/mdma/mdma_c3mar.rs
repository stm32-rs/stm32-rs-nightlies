///Register `MDMA_C3MAR` reader
pub type R = crate::R<MDMA_C3MARrs>;
///Register `MDMA_C3MAR` writer
pub type W = crate::W<MDMA_C3MARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mar(&mut self) -> MAR_W<MDMA_C3MARrs> {
        MAR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C3MAR)*/
pub struct MDMA_C3MARrs;
impl crate::RegisterSpec for MDMA_C3MARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c3mar::R`](R) reader structure
impl crate::Readable for MDMA_C3MARrs {}
///`write(|w| ..)` method takes [`mdma_c3mar::W`](W) writer structure
impl crate::Writable for MDMA_C3MARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C3MAR to value 0
impl crate::Resettable for MDMA_C3MARrs {
