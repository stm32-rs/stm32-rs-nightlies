#[doc = "Reader of register MDMA_C4BRUR"]
pub type R = crate::R<u32, super::MDMA_C4BRUR>;
#[doc = "Writer for register MDMA_C4BRUR"]
pub type W = crate::W<u32, super::MDMA_C4BRUR>;
#[doc = "Register MDMA_C4BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::MDMA_C4BRUR {
    type Type = u32;
    #[inline(always)]
