...
pub type R = crate::R<MDMA_C4DARrs>;
///Register `MDMA_C4DAR` writer
pub type W = crate::W<MDMA_C4DARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dar(&mut self) -> DAR_W<MDMA_C4DARrs> {
        DAR_W::new(self, 0)
    }
}
...
pub struct MDMA_C4DARrs;
impl crate::RegisterSpec for MDMA_C4DARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c4dar::R`](R) reader structure
impl crate::Readable for MDMA_C4DARrs {}
///`write(|w| ..)` method takes [`mdma_c4dar::W`](W) writer structure
impl crate::Writable for MDMA_C4DARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C4DAR to value 0
impl crate::Resettable for MDMA_C4DARrs {
