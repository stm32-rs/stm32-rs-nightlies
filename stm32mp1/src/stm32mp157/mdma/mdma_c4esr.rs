///Register `MDMA_C4ESR` reader
pub type R = crate::R<MDMA_C4ESRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C4ESR)*/
pub struct MDMA_C4ESRrs;
impl crate::RegisterSpec for MDMA_C4ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c4esr::R`](R) reader structure
impl crate::Readable for MDMA_C4ESRrs {}
///`reset()` method sets MDMA_C4ESR to value 0
impl crate::Resettable for MDMA_C4ESRrs {
