///Register `MDMA_C5ESR` reader
pub type R = crate::R<MDMA_C5ESRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C5ESR)*/
pub struct MDMA_C5ESRrs;
impl crate::RegisterSpec for MDMA_C5ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c5esr::R`](R) reader structure
impl crate::Readable for MDMA_C5ESRrs {}
///`reset()` method sets MDMA_C5ESR to value 0
impl crate::Resettable for MDMA_C5ESRrs {
