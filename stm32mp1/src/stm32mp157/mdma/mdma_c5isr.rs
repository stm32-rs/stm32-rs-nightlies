...
pub type R = crate::R<MDMA_C5ISRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C5ISR)*/
pub struct MDMA_C5ISRrs;
impl crate::RegisterSpec for MDMA_C5ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c5isr::R`](R) reader structure
impl crate::Readable for MDMA_C5ISRrs {}
///`reset()` method sets MDMA_C5ISR to value 0
impl crate::Resettable for MDMA_C5ISRrs {
