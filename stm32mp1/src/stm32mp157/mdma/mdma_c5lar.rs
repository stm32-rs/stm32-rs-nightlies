///Register `MDMA_C5LAR` reader
pub type R = crate::R<MDMA_C5LARrs>;
///Register `MDMA_C5LAR` writer
pub type W = crate::W<MDMA_C5LARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lar(&mut self) -> LAR_W<MDMA_C5LARrs> {
        LAR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C5LAR)*/
pub struct MDMA_C5LARrs;
impl crate::RegisterSpec for MDMA_C5LARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c5lar::R`](R) reader structure
impl crate::Readable for MDMA_C5LARrs {}
///`write(|w| ..)` method takes [`mdma_c5lar::W`](W) writer structure
impl crate::Writable for MDMA_C5LARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C5LAR to value 0
impl crate::Resettable for MDMA_C5LARrs {
