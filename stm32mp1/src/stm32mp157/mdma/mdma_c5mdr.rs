...
pub type R = crate::R<MDMA_C5MDRrs>;
///Register `MDMA_C5MDR` writer
pub type W = crate::W<MDMA_C5MDRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdr(&mut self) -> MDR_W<MDMA_C5MDRrs> {
        MDR_W::new(self, 0)
    }
}
...
pub struct MDMA_C5MDRrs;
impl crate::RegisterSpec for MDMA_C5MDRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c5mdr::R`](R) reader structure
impl crate::Readable for MDMA_C5MDRrs {}
///`write(|w| ..)` method takes [`mdma_c5mdr::W`](W) writer structure
impl crate::Writable for MDMA_C5MDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C5MDR to value 0
impl crate::Resettable for MDMA_C5MDRrs {
