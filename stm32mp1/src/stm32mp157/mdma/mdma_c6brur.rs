#[doc = "Reader of register MDMA_C6BRUR"]
pub type R = crate::R<u32, super::MDMA_C6BRUR>;
#[doc = "Writer for register MDMA_C6BRUR"]
pub type W = crate::W<u32, super::MDMA_C6BRUR>;
#[doc = "Register MDMA_C6BRUR `reset()`'s with value 0"]
impl crate::ResetValue for super::MDMA_C6BRUR {
    type Type = u32;
    #[inline(always)]
