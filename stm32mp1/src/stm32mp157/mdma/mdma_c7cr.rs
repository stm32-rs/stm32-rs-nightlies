///Register `MDMA_C7CR` reader
pub type R = crate::R<MDMA_C7CRrs>;
///Register `MDMA_C7CR` writer
pub type W = crate::W<MDMA_C7CRrs>;
///Field `EN` reader - EN
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<MDMA_C7CRrs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - TEIE
    #[inline(always)]
    #[must_use]
    pub fn teie(&mut self) -> TEIE_W<MDMA_C7CRrs> {
        TEIE_W::new(self, 1)
    }
    ///Bit 2 - CTCIE
    #[inline(always)]
    #[must_use]
    pub fn ctcie(&mut self) -> CTCIE_W<MDMA_C7CRrs> {
        CTCIE_W::new(self, 2)
    }
    ///Bit 3 - BRTIE
    #[inline(always)]
    #[must_use]
    pub fn brtie(&mut self) -> BRTIE_W<MDMA_C7CRrs> {
        BRTIE_W::new(self, 3)
    }
    ///Bit 4 - BTIE
    #[inline(always)]
    #[must_use]
    pub fn btie(&mut self) -> BTIE_W<MDMA_C7CRrs> {
        BTIE_W::new(self, 4)
    }
    ///Bit 5 - TCIE
    #[inline(always)]
    #[must_use]
    pub fn tcie(&mut self) -> TCIE_W<MDMA_C7CRrs> {
        TCIE_W::new(self, 5)
    }
    ///Bits 6:7 - PL
    #[inline(always)]
    #[must_use]
    pub fn pl(&mut self) -> PL_W<MDMA_C7CRrs> {
        PL_W::new(self, 6)
    }
    ///Bit 12 - BEX
    #[inline(always)]
    #[must_use]
    pub fn bex(&mut self) -> BEX_W<MDMA_C7CRrs> {
        BEX_W::new(self, 12)
    }
    ///Bit 13 - HEX
    #[inline(always)]
    #[must_use]
    pub fn hex(&mut self) -> HEX_W<MDMA_C7CRrs> {
        HEX_W::new(self, 13)
    }
    ///Bit 14 - WEX
    #[inline(always)]
    #[must_use]
    pub fn wex(&mut self) -> WEX_W<MDMA_C7CRrs> {
        WEX_W::new(self, 14)
    }
    ///Bit 16 - SWRQ
    #[inline(always)]
    #[must_use]
    pub fn swrq(&mut self) -> SWRQ_W<MDMA_C7CRrs> {
        SWRQ_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C7CR)*/
pub struct MDMA_C7CRrs;
impl crate::RegisterSpec for MDMA_C7CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c7cr::R`](R) reader structure
impl crate::Readable for MDMA_C7CRrs {}
///`write(|w| ..)` method takes [`mdma_c7cr::W`](W) writer structure
impl crate::Writable for MDMA_C7CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C7CR to value 0
impl crate::Resettable for MDMA_C7CRrs {
