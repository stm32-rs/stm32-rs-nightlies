...
pub type R = crate::R<MDMA_C7ESRrs>;
...
pub struct MDMA_C7ESRrs;
impl crate::RegisterSpec for MDMA_C7ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c7esr::R`](R) reader structure
impl crate::Readable for MDMA_C7ESRrs {}
///`reset()` method sets MDMA_C7ESR to value 0
impl crate::Resettable for MDMA_C7ESRrs {
