...
pub type R = crate::R<MDMA_C7MARrs>;
///Register `MDMA_C7MAR` writer
pub type W = crate::W<MDMA_C7MARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mar(&mut self) -> MAR_W<MDMA_C7MARrs> {
        MAR_W::new(self, 0)
    }
}
...
pub struct MDMA_C7MARrs;
impl crate::RegisterSpec for MDMA_C7MARrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c7mar::R`](R) reader structure
impl crate::Readable for MDMA_C7MARrs {}
///`write(|w| ..)` method takes [`mdma_c7mar::W`](W) writer structure
impl crate::Writable for MDMA_C7MARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C7MAR to value 0
impl crate::Resettable for MDMA_C7MARrs {
