///Register `MDMA_C7TBR` reader
pub type R = crate::R<MDMA_C7TBRrs>;
///Register `MDMA_C7TBR` writer
pub type W = crate::W<MDMA_C7TBRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsel(&mut self) -> TSEL_W<MDMA_C7TBRrs> {
        TSEL_W::new(self, 0)
    }
    ///Bit 16 - SBUS
    #[inline(always)]
    #[must_use]
    pub fn sbus(&mut self) -> SBUS_W<MDMA_C7TBRrs> {
        SBUS_W::new(self, 16)
    }
    ///Bit 17 - DBUS
    #[inline(always)]
    #[must_use]
    pub fn dbus(&mut self) -> DBUS_W<MDMA_C7TBRrs> {
        DBUS_W::new(self, 17)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C7TBR)*/
pub struct MDMA_C7TBRrs;
impl crate::RegisterSpec for MDMA_C7TBRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c7tbr::R`](R) reader structure
impl crate::Readable for MDMA_C7TBRrs {}
///`write(|w| ..)` method takes [`mdma_c7tbr::W`](W) writer structure
impl crate::Writable for MDMA_C7TBRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDMA_C7TBR to value 0
impl crate::Resettable for MDMA_C7TBRrs {
