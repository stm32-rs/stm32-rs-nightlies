///Register `MDMA_C8ESR` reader
pub type R = crate::R<MDMA_C8ESRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C8ESR)*/
pub struct MDMA_C8ESRrs;
impl crate::RegisterSpec for MDMA_C8ESRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c8esr::R`](R) reader structure
impl crate::Readable for MDMA_C8ESRrs {}
///`reset()` method sets MDMA_C8ESR to value 0
impl crate::Resettable for MDMA_C8ESRrs {
