...
pub type R = crate::R<MDMA_C8ISRrs>;
...
pub struct MDMA_C8ISRrs;
impl crate::RegisterSpec for MDMA_C8ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c8isr::R`](R) reader structure
impl crate::Readable for MDMA_C8ISRrs {}
///`reset()` method sets MDMA_C8ISR to value 0
impl crate::Resettable for MDMA_C8ISRrs {
