///Register `MDMA_C9ISR` reader
pub type R = crate::R<MDMA_C9ISRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_C9ISR)*/
pub struct MDMA_C9ISRrs;
impl crate::RegisterSpec for MDMA_C9ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdma_c9isr::R`](R) reader structure
impl crate::Readable for MDMA_C9ISRrs {}
///`reset()` method sets MDMA_C9ISR to value 0
impl crate::Resettable for MDMA_C9ISRrs {
