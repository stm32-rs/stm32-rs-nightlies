///Register `MDMA_GISR0` reader
pub type R = crate::R<MDMA_GISR0rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#MDMA:MDMA_GISR0)*/
pub struct MDMA_GISR0rs;
impl crate::RegisterSpec for MDMA_GISR0rs {
    type Ux = u32;
}
///`read()` method returns [`mdma_gisr0::R`](R) reader structure
impl crate::Readable for MDMA_GISR0rs {}
///`reset()` method sets MDMA_GISR0 to value 0
impl crate::Resettable for MDMA_GISR0rs {
