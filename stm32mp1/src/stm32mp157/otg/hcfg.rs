...
impl W {
    ...
    ///Bit 23 - DESCDMA
    #[inline(always)]
    pub fn descdma(&mut self) -> DESCDMA_W<'_, HCFGrs> {
        DESCDMA_W::new(self, 23)
    }
    ///Bits 24:25 - FRLSTEN
    #[inline(always)]
    pub fn frlsten(&mut self) -> FRLSTEN_W<'_, HCFGrs> {
        FRLSTEN_W::new(self, 24)
    }
    ///Bit 26 - PERSSCHEDENA
    #[inline(always)]
    pub fn persschedena(&mut self) -> PERSSCHEDENA_W<'_, HCFGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:HCFG)*/
pub struct HCFGrs;
