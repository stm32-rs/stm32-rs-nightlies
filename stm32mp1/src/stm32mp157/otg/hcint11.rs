...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrc(&mut self) -> XFRC_W<HCINT11rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - CHH
    #[inline(always)]
    #[must_use]
    pub fn chh(&mut self) -> CHH_W<HCINT11rs> {
        CHH_W::new(self, 1)
    }
    ///Bit 2 - AHBERR
    #[inline(always)]
    #[must_use]
    pub fn ahberr(&mut self) -> AHBERR_W<HCINT11rs> {
        AHBERR_W::new(self, 2)
    }
    ///Bit 3 - STALL
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<HCINT11rs> {
        STALL_W::new(self, 3)
    }
    ///Bit 4 - NAK
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<HCINT11rs> {
        NAK_W::new(self, 4)
    }
    ///Bit 5 - ACK
    #[inline(always)]
    #[must_use]
    pub fn ack(&mut self) -> ACK_W<HCINT11rs> {
        ACK_W::new(self, 5)
    }
    ///Bit 6 - NYET
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<HCINT11rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - TXERR
    #[inline(always)]
    #[must_use]
    pub fn txerr(&mut self) -> TXERR_W<HCINT11rs> {
        TXERR_W::new(self, 7)
    }
    ///Bit 8 - BBERR
    #[inline(always)]
    #[must_use]
    pub fn bberr(&mut self) -> BBERR_W<HCINT11rs> {
        BBERR_W::new(self, 8)
    }
    ///Bit 9 - FRMOR
    #[inline(always)]
    #[must_use]
    pub fn frmor(&mut self) -> FRMOR_W<HCINT11rs> {
        FRMOR_W::new(self, 9)
    }
    ///Bit 10 - DTERR
    #[inline(always)]
    #[must_use]
    pub fn dterr(&mut self) -> DTERR_W<HCINT11rs> {
        DTERR_W::new(self, 10)
    }
    ///Bit 11 - BNA
    #[inline(always)]
    #[must_use]
    pub fn bna(&mut self) -> BNA_W<HCINT11rs> {
        BNA_W::new(self, 11)
    }
    ///Bit 12 - XCSXACTERR
    #[inline(always)]
    #[must_use]
    pub fn xcsxacterr(&mut self) -> XCSXACTERR_W<HCINT11rs> {
        XCSXACTERR_W::new(self, 12)
    }
    ///Bit 13 - DESCLSTROLL
    #[inline(always)]
    #[must_use]
    pub fn desclstroll(&mut self) -> DESCLSTROLL_W<HCINT11rs> {
