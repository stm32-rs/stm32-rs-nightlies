...
impl W {
    ...
    ///Bit 11 - BNAMSK
    #[inline(always)]
    pub fn bnamsk(&mut self) -> BNAMSK_W<'_, HCINTMSK2rs> {
        BNAMSK_W::new(self, 11)
    }
    ///Bit 13 - DESCLSTROLLMSK
    #[inline(always)]
    pub fn desclstrollmsk(&mut self) -> DESCLSTROLLMSK_W<'_, HCINTMSK2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:HCINTMSK2)*/
