...
impl W {
    ///Bit 0 - XFRCM
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<HS_DIEPEACHMSK1rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - EPDM
    #[inline(always)]
    pub fn epdm(&mut self) -> EPDM_W<HS_DIEPEACHMSK1rs> {
        EPDM_W::new(self, 1)
    }
    ///Bit 2 - AHBERRM
    #[inline(always)]
    pub fn ahberrm(&mut self) -> AHBERRM_W<HS_DIEPEACHMSK1rs> {
        AHBERRM_W::new(self, 2)
    }
    ///Bit 3 - TOM
    #[inline(always)]
    pub fn tom(&mut self) -> TOM_W<HS_DIEPEACHMSK1rs> {
        TOM_W::new(self, 3)
    }
    ///Bit 4 - ITTXFEMSK
    #[inline(always)]
    pub fn ittxfemsk(&mut self) -> ITTXFEMSK_W<HS_DIEPEACHMSK1rs> {
        ITTXFEMSK_W::new(self, 4)
    }
    ///Bit 6 - INEPNEM
    #[inline(always)]
    pub fn inepnem(&mut self) -> INEPNEM_W<HS_DIEPEACHMSK1rs> {
        INEPNEM_W::new(self, 6)
    }
    ///Bit 8 - TXFURM
    #[inline(always)]
    pub fn txfurm(&mut self) -> TXFURM_W<HS_DIEPEACHMSK1rs> {
        TXFURM_W::new(self, 8)
    }
    ///Bit 9 - BNAM
    #[inline(always)]
    pub fn bnam(&mut self) -> BNAM_W<HS_DIEPEACHMSK1rs> {
        BNAM_W::new(self, 9)
    }
    ///Bit 13 - NAKM
    #[inline(always)]
    pub fn nakm(&mut self) -> NAKM_W<HS_DIEPEACHMSK1rs> {
        NAKM_W::new(self, 13)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:HS_DIEPEACHMSK1)*/
