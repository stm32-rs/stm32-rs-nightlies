#[doc = "Reader of register OTG_DEACHINTMSK"]
pub type R = crate::R<u32, super::OTG_DEACHINTMSK>;
#[doc = "Writer for register OTG_DEACHINTMSK"]
pub type W = crate::W<u32, super::OTG_DEACHINTMSK>;
#[doc = "Register OTG_DEACHINTMSK `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_DEACHINTMSK {
    type Type = u32;
    #[inline(always)]
