#[doc = "Reader of register OTG_DIEPCTL7"]
pub type R = crate::R<u32, super::OTG_DIEPCTL7>;
#[doc = "Writer for register OTG_DIEPCTL7"]
pub type W = crate::W<u32, super::OTG_DIEPCTL7>;
#[doc = "Register OTG_DIEPCTL7 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_DIEPCTL7 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `EONUM_DPIP`"]
pub type EONUM_DPIP_R = crate::R<bool, bool>;
...
impl R {
    ...
    pub fn eonum_dpip(&self) -> EONUM_DPIP_R {
        EONUM_DPIP_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 17 - NAKSTS"]
    #[inline(always)]
