...
pub type R = crate::R<OTG_DIEPINT0rs>;
///Register `OTG_DIEPINT0` writer
pub type W = crate::W<OTG_DIEPINT0rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrc(&mut self) -> XFRC_W<OTG_DIEPINT0rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - EPDISD
    #[inline(always)]
    #[must_use]
    pub fn epdisd(&mut self) -> EPDISD_W<OTG_DIEPINT0rs> {
        EPDISD_W::new(self, 1)
    }
    ///Bit 2 - AHBERR
    #[inline(always)]
    #[must_use]
    pub fn ahberr(&mut self) -> AHBERR_W<OTG_DIEPINT0rs> {
        AHBERR_W::new(self, 2)
    }
    ///Bit 3 - TOC
    #[inline(always)]
    #[must_use]
    pub fn toc(&mut self) -> TOC_W<OTG_DIEPINT0rs> {
        TOC_W::new(self, 3)
    }
    ///Bit 4 - ITTXFE
    #[inline(always)]
    #[must_use]
    pub fn ittxfe(&mut self) -> ITTXFE_W<OTG_DIEPINT0rs> {
        ITTXFE_W::new(self, 4)
    }
    ///Bit 5 - INEPNM
    #[inline(always)]
    #[must_use]
    pub fn inepnm(&mut self) -> INEPNM_W<OTG_DIEPINT0rs> {
        INEPNM_W::new(self, 5)
    }
    ///Bit 8 - TXFIFOUDRN
    #[inline(always)]
    #[must_use]
    pub fn txfifoudrn(&mut self) -> TXFIFOUDRN_W<OTG_DIEPINT0rs> {
        TXFIFOUDRN_W::new(self, 8)
    }
    ///Bit 9 - BNA
    #[inline(always)]
    #[must_use]
    pub fn bna(&mut self) -> BNA_W<OTG_DIEPINT0rs> {
        BNA_W::new(self, 9)
    }
    ///Bit 11 - PKTDRPSTS
    #[inline(always)]
    #[must_use]
    pub fn pktdrpsts(&mut self) -> PKTDRPSTS_W<OTG_DIEPINT0rs> {
        PKTDRPSTS_W::new(self, 11)
    }
    ///Bit 13 - NAK
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<OTG_DIEPINT0rs> {
        NAK_W::new(self, 13)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`otg_diepint0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_diepint0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_DIEPINT0)*/
pub struct OTG_DIEPINT0rs;
impl crate::RegisterSpec for OTG_DIEPINT0rs {
    type Ux = u32;
}
///`read()` method returns [`otg_diepint0::R`](R) reader structure
impl crate::Readable for OTG_DIEPINT0rs {}
///`write(|w| ..)` method takes [`otg_diepint0::W`](W) writer structure
impl crate::Writable for OTG_DIEPINT0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_DIEPINT0 to value 0x80
impl crate::Resettable for OTG_DIEPINT0rs {
