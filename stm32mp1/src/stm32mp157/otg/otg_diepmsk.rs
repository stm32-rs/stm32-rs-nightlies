...
pub type R = crate::R<OTG_DIEPMSKrs>;
///Register `OTG_DIEPMSK` writer
pub type W = crate::W<OTG_DIEPMSKrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrcm(&mut self) -> XFRCM_W<OTG_DIEPMSKrs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - EPDM
    #[inline(always)]
    #[must_use]
    pub fn epdm(&mut self) -> EPDM_W<OTG_DIEPMSKrs> {
        EPDM_W::new(self, 1)
    }
    ///Bit 2 - AHBERRM
    #[inline(always)]
    #[must_use]
    pub fn ahberrm(&mut self) -> AHBERRM_W<OTG_DIEPMSKrs> {
        AHBERRM_W::new(self, 2)
    }
    ///Bit 3 - TOM
    #[inline(always)]
    #[must_use]
    pub fn tom(&mut self) -> TOM_W<OTG_DIEPMSKrs> {
        TOM_W::new(self, 3)
    }
    ///Bit 4 - ITTXFEMSK
    #[inline(always)]
    #[must_use]
    pub fn ittxfemsk(&mut self) -> ITTXFEMSK_W<OTG_DIEPMSKrs> {
        ITTXFEMSK_W::new(self, 4)
    }
    ///Bit 5 - INEPNMM
    #[inline(always)]
    #[must_use]
    pub fn inepnmm(&mut self) -> INEPNMM_W<OTG_DIEPMSKrs> {
        INEPNMM_W::new(self, 5)
    }
    ///Bit 6 - INEPNEM
    #[inline(always)]
    #[must_use]
    pub fn inepnem(&mut self) -> INEPNEM_W<OTG_DIEPMSKrs> {
        INEPNEM_W::new(self, 6)
    }
    ///Bit 8 - TXFURM
    #[inline(always)]
    #[must_use]
    pub fn txfurm(&mut self) -> TXFURM_W<OTG_DIEPMSKrs> {
        TXFURM_W::new(self, 8)
    }
    ///Bit 9 - BNAM
    #[inline(always)]
    #[must_use]
    pub fn bnam(&mut self) -> BNAM_W<OTG_DIEPMSKrs> {
        BNAM_W::new(self, 9)
    }
    ///Bit 13 - NAKM
    #[inline(always)]
    #[must_use]
    pub fn nakm(&mut self) -> NAKM_W<OTG_DIEPMSKrs> {
        NAKM_W::new(self, 13)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`otg_diepmsk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_diepmsk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_DIEPMSK)*/
pub struct OTG_DIEPMSKrs;
impl crate::RegisterSpec for OTG_DIEPMSKrs {
    type Ux = u32;
}
///`read()` method returns [`otg_diepmsk::R`](R) reader structure
impl crate::Readable for OTG_DIEPMSKrs {}
///`write(|w| ..)` method takes [`otg_diepmsk::W`](W) writer structure
impl crate::Writable for OTG_DIEPMSKrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_DIEPMSK to value 0
impl crate::Resettable for OTG_DIEPMSKrs {
