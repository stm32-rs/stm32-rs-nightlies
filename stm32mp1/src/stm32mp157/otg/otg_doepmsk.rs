#[doc = "Reader of register OTG_DOEPMSK"]
pub type R = crate::R<u32, super::OTG_DOEPMSK>;
#[doc = "Writer for register OTG_DOEPMSK"]
pub type W = crate::W<u32, super::OTG_DOEPMSK>;
#[doc = "Register OTG_DOEPMSK `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_DOEPMSK {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `STSPHSRXM`"]
pub type STSPHSRXM_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `STSPHSRXM`"]
