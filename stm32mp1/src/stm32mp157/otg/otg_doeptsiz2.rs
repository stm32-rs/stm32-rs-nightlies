...
pub type R = crate::R<OTG_DOEPTSIZ2rs>;
///Register `OTG_DOEPTSIZ2` writer
pub type W = crate::W<OTG_DOEPTSIZ2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<OTG_DOEPTSIZ2rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - PKTCNT
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<OTG_DOEPTSIZ2rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - RXDPID_STUPCNT
    #[inline(always)]
    #[must_use]
    pub fn rxdpid_stupcnt(&mut self) -> RXDPID_STUPCNT_W<OTG_DOEPTSIZ2rs> {
...
You can [`read`](crate::Reg::read) this register and get [`otg_doeptsiz2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_doeptsiz2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_DOEPTSIZ2)*/
pub struct OTG_DOEPTSIZ2rs;
impl crate::RegisterSpec for OTG_DOEPTSIZ2rs {
    type Ux = u32;
}
///`read()` method returns [`otg_doeptsiz2::R`](R) reader structure
impl crate::Readable for OTG_DOEPTSIZ2rs {}
///`write(|w| ..)` method takes [`otg_doeptsiz2::W`](W) writer structure
impl crate::Writable for OTG_DOEPTSIZ2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_DOEPTSIZ2 to value 0
impl crate::Resettable for OTG_DOEPTSIZ2rs {
