#[doc = "Reader of register OTG_DOEPTSIZ3"]
pub type R = crate::R<u32, super::OTG_DOEPTSIZ3>;
#[doc = "Writer for register OTG_DOEPTSIZ3"]
pub type W = crate::W<u32, super::OTG_DOEPTSIZ3>;
#[doc = "Register OTG_DOEPTSIZ3 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_DOEPTSIZ3 {
    type Type = u32;
    #[inline(always)]
