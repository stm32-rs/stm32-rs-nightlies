...
You can [`read`](crate::Reg::read) this register and get [`otg_dtxfsts2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_DTXFSTS2)*/
