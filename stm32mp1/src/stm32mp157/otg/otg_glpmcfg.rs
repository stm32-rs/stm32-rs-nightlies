#[doc = "Reader of register OTG_GLPMCFG"]
pub type R = crate::R<u32, super::OTG_GLPMCFG>;
#[doc = "Writer for register OTG_GLPMCFG"]
pub type W = crate::W<u32, super::OTG_GLPMCFG>;
#[doc = "Register OTG_GLPMCFG `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_GLPMCFG {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `LPMRSP`"]
pub type LPMRSP_R = crate::R<u8, u8>;
