#[doc = "Reader of register OTG_GOTGCTL"]
pub type R = crate::R<u32, super::OTG_GOTGCTL>;
#[doc = "Writer for register OTG_GOTGCTL"]
pub type W = crate::W<u32, super::OTG_GOTGCTL>;
#[doc = "Register OTG_GOTGCTL `reset()`'s with value 0x0001_0000"]
impl crate::ResetValue for super::OTG_GOTGCTL {
    type Type = u32;
    #[inline(always)]
