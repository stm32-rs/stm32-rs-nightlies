///Register `OTG_GOTGCTL` reader
pub type R = crate::R<OTG_GOTGCTLrs>;
///Register `OTG_GOTGCTL` writer
...
You can [`read`](crate::Reg::read) this register and get [`otg_gotgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_gotgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_GOTGCTL)*/
pub struct OTG_GOTGCTLrs;
impl crate::RegisterSpec for OTG_GOTGCTLrs {
    type Ux = u32;
}
///`read()` method returns [`otg_gotgctl::R`](R) reader structure
impl crate::Readable for OTG_GOTGCTLrs {}
///`write(|w| ..)` method takes [`otg_gotgctl::W`](W) writer structure
impl crate::Writable for OTG_GOTGCTLrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_GOTGCTL to value 0x0001_0000
