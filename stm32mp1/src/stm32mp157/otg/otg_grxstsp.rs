...
You can [`read`](crate::Reg::read) this register and get [`otg_grxstsp::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_GRXSTSP)*/
pub struct OTG_GRXSTSPrs;
impl crate::RegisterSpec for OTG_GRXSTSPrs {
    type Ux = u32;
}
///`read()` method returns [`otg_grxstsp::R`](R) reader structure
impl crate::Readable for OTG_GRXSTSPrs {}
///`reset()` method sets OTG_GRXSTSP to value 0
