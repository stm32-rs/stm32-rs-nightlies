...
You can [`read`](crate::Reg::read) this register and get [`otg_hcdmab3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_HCDMAB3)*/
pub struct OTG_HCDMAB3rs;
impl crate::RegisterSpec for OTG_HCDMAB3rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hcdmab3::R`](R) reader structure
impl crate::Readable for OTG_HCDMAB3rs {}
///`reset()` method sets OTG_HCDMAB3 to value 0
