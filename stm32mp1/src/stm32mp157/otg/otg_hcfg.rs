...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_HCFG")
            .field("fslspcs", &self.fslspcs())
            .field("fslss", &self.fslss())
            .field("descdma", &self.descdma())
            .field("frlsten", &self.frlsten())
            .field("persschedena", &self.persschedena())
            .finish()
    }
}
impl W {
...
You can [`read`](crate::Reg::read) this register and get [`otg_hcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_HCFG)*/
