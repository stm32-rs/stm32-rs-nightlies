...
pub type R = crate::R<OTG_HCINT12rs>;
///Register `OTG_HCINT12` writer
pub type W = crate::W<OTG_HCINT12rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrc(&mut self) -> XFRC_W<OTG_HCINT12rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - CHH
    #[inline(always)]
    #[must_use]
    pub fn chh(&mut self) -> CHH_W<OTG_HCINT12rs> {
        CHH_W::new(self, 1)
    }
    ///Bit 2 - AHBERR
    #[inline(always)]
    #[must_use]
    pub fn ahberr(&mut self) -> AHBERR_W<OTG_HCINT12rs> {
        AHBERR_W::new(self, 2)
    }
    ///Bit 3 - STALL
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<OTG_HCINT12rs> {
        STALL_W::new(self, 3)
    }
    ///Bit 4 - NAK
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<OTG_HCINT12rs> {
        NAK_W::new(self, 4)
    }
    ///Bit 5 - ACK
    #[inline(always)]
    #[must_use]
    pub fn ack(&mut self) -> ACK_W<OTG_HCINT12rs> {
        ACK_W::new(self, 5)
    }
    ///Bit 6 - NYET
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<OTG_HCINT12rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - TXERR
    #[inline(always)]
    #[must_use]
    pub fn txerr(&mut self) -> TXERR_W<OTG_HCINT12rs> {
        TXERR_W::new(self, 7)
    }
    ///Bit 8 - BBERR
    #[inline(always)]
    #[must_use]
    pub fn bberr(&mut self) -> BBERR_W<OTG_HCINT12rs> {
        BBERR_W::new(self, 8)
    }
    ///Bit 9 - FRMOR
    #[inline(always)]
    #[must_use]
    pub fn frmor(&mut self) -> FRMOR_W<OTG_HCINT12rs> {
        FRMOR_W::new(self, 9)
    }
    ///Bit 10 - DTERR
    #[inline(always)]
    #[must_use]
    pub fn dterr(&mut self) -> DTERR_W<OTG_HCINT12rs> {
        DTERR_W::new(self, 10)
    }
    ///Bit 11 - BNA
    #[inline(always)]
    #[must_use]
    pub fn bna(&mut self) -> BNA_W<OTG_HCINT12rs> {
        BNA_W::new(self, 11)
    }
    ///Bit 12 - XCSXACTERR
    #[inline(always)]
    #[must_use]
    pub fn xcsxacterr(&mut self) -> XCSXACTERR_W<OTG_HCINT12rs> {
        XCSXACTERR_W::new(self, 12)
    }
    ///Bit 13 - DESCLSTROLL
    #[inline(always)]
    #[must_use]
    pub fn desclstroll(&mut self) -> DESCLSTROLL_W<OTG_HCINT12rs> {
...
You can [`read`](crate::Reg::read) this register and get [`otg_hcint12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hcint12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_HCINT12)*/
pub struct OTG_HCINT12rs;
impl crate::RegisterSpec for OTG_HCINT12rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hcint12::R`](R) reader structure
impl crate::Readable for OTG_HCINT12rs {}
///`write(|w| ..)` method takes [`otg_hcint12::W`](W) writer structure
impl crate::Writable for OTG_HCINT12rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_HCINT12 to value 0
impl crate::Resettable for OTG_HCINT12rs {
