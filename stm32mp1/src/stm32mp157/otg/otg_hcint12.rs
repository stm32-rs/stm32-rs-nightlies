#[doc = "Reader of register OTG_HCINT12"]
pub type R = crate::R<u32, super::OTG_HCINT12>;
#[doc = "Writer for register OTG_HCINT12"]
pub type W = crate::W<u32, super::OTG_HCINT12>;
#[doc = "Register OTG_HCINT12 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HCINT12 {
    type Type = u32;
    #[inline(always)]
