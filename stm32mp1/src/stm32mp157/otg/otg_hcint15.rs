#[doc = "Reader of register OTG_HCINT15"]
pub type R = crate::R<u32, super::OTG_HCINT15>;
#[doc = "Writer for register OTG_HCINT15"]
pub type W = crate::W<u32, super::OTG_HCINT15>;
#[doc = "Register OTG_HCINT15 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HCINT15 {
    type Type = u32;
    #[inline(always)]
