#[doc = "Reader of register OTG_HCINT4"]
pub type R = crate::R<u32, super::OTG_HCINT4>;
#[doc = "Writer for register OTG_HCINT4"]
pub type W = crate::W<u32, super::OTG_HCINT4>;
#[doc = "Register OTG_HCINT4 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HCINT4 {
    type Type = u32;
    #[inline(always)]
