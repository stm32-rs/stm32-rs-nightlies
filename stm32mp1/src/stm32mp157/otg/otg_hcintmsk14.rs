...
pub type R = crate::R<OTG_HCINTMSK14rs>;
///Register `OTG_HCINTMSK14` writer
pub type W = crate::W<OTG_HCINTMSK14rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrcm(&mut self) -> XFRCM_W<OTG_HCINTMSK14rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - CHHM
    #[inline(always)]
    #[must_use]
    pub fn chhm(&mut self) -> CHHM_W<OTG_HCINTMSK14rs> {
        CHHM_W::new(self, 1)
    }
    ///Bit 2 - AHBERRM
    #[inline(always)]
    #[must_use]
    pub fn ahberrm(&mut self) -> AHBERRM_W<OTG_HCINTMSK14rs> {
        AHBERRM_W::new(self, 2)
    }
    ///Bit 3 - STALLM
    #[inline(always)]
    #[must_use]
    pub fn stallm(&mut self) -> STALLM_W<OTG_HCINTMSK14rs> {
        STALLM_W::new(self, 3)
    }
    ///Bit 4 - NAKM
    #[inline(always)]
    #[must_use]
    pub fn nakm(&mut self) -> NAKM_W<OTG_HCINTMSK14rs> {
        NAKM_W::new(self, 4)
    }
    ///Bit 5 - ACKM
    #[inline(always)]
    #[must_use]
    pub fn ackm(&mut self) -> ACKM_W<OTG_HCINTMSK14rs> {
        ACKM_W::new(self, 5)
    }
    ///Bit 6 - NYET
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<OTG_HCINTMSK14rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - TXERRM
    #[inline(always)]
    #[must_use]
    pub fn txerrm(&mut self) -> TXERRM_W<OTG_HCINTMSK14rs> {
        TXERRM_W::new(self, 7)
    }
    ///Bit 8 - BBERRM
    #[inline(always)]
    #[must_use]
    pub fn bberrm(&mut self) -> BBERRM_W<OTG_HCINTMSK14rs> {
        BBERRM_W::new(self, 8)
    }
    ///Bit 9 - FRMORM
    #[inline(always)]
    #[must_use]
    pub fn frmorm(&mut self) -> FRMORM_W<OTG_HCINTMSK14rs> {
        FRMORM_W::new(self, 9)
    }
    ///Bit 10 - DTERRM
    #[inline(always)]
    #[must_use]
    pub fn dterrm(&mut self) -> DTERRM_W<OTG_HCINTMSK14rs> {
        DTERRM_W::new(self, 10)
    }
    ///Bit 11 - BNAMSK
    #[inline(always)]
    #[must_use]
    pub fn bnamsk(&mut self) -> BNAMSK_W<OTG_HCINTMSK14rs> {
        BNAMSK_W::new(self, 11)
    }
    ///Bit 13 - DESCLSTROLLMSK
    #[inline(always)]
    #[must_use]
    pub fn desclstrollmsk(&mut self) -> DESCLSTROLLMSK_W<OTG_HCINTMSK14rs> {
        DESCLSTROLLMSK_W::new(self, 13)
    }
}
/**This register reflects the mask for each channel status described in the previous section.

You can [`read`](crate::Reg::read) this register and get [`otg_hcintmsk14::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hcintmsk14::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_HCINTMSK14)*/
pub struct OTG_HCINTMSK14rs;
impl crate::RegisterSpec for OTG_HCINTMSK14rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hcintmsk14::R`](R) reader structure
impl crate::Readable for OTG_HCINTMSK14rs {}
///`write(|w| ..)` method takes [`otg_hcintmsk14::W`](W) writer structure
impl crate::Writable for OTG_HCINTMSK14rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_HCINTMSK14 to value 0
impl crate::Resettable for OTG_HCINTMSK14rs {
