#[doc = "Reader of register OTG_HCSPLT10"]
pub type R = crate::R<u32, super::OTG_HCSPLT10>;
#[doc = "Writer for register OTG_HCSPLT10"]
pub type W = crate::W<u32, super::OTG_HCSPLT10>;
#[doc = "Register OTG_HCSPLT10 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HCSPLT10 {
    type Type = u32;
    #[inline(always)]
