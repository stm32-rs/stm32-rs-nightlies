///Register `OTG_HCSPLT11` reader
pub type R = crate::R<OTG_HCSPLT11rs>;
///Register `OTG_HCSPLT11` writer
pub type W = crate::W<OTG_HCSPLT11rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prtaddr(&mut self) -> PRTADDR_W<OTG_HCSPLT11rs> {
        PRTADDR_W::new(self, 0)
    }
    ///Bits 7:13 - HUBADDR
    #[inline(always)]
    #[must_use]
    pub fn hubaddr(&mut self) -> HUBADDR_W<OTG_HCSPLT11rs> {
        HUBADDR_W::new(self, 7)
    }
    ///Bits 14:15 - XACTPOS
    #[inline(always)]
    #[must_use]
    pub fn xactpos(&mut self) -> XACTPOS_W<OTG_HCSPLT11rs> {
        XACTPOS_W::new(self, 14)
    }
    ///Bit 16 - COMPLSPLT
    #[inline(always)]
    #[must_use]
    pub fn complsplt(&mut self) -> COMPLSPLT_W<OTG_HCSPLT11rs> {
        COMPLSPLT_W::new(self, 16)
    }
    ///Bit 31 - SPLITEN
    #[inline(always)]
    #[must_use]
    pub fn spliten(&mut self) -> SPLITEN_W<OTG_HCSPLT11rs> {
        SPLITEN_W::new(self, 31)
    }
}
/**OTG host channel 11 split control register

You can [`read`](crate::Reg::read) this register and get [`otg_hcsplt11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_hcsplt11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#OTG:OTG_HCSPLT11)*/
pub struct OTG_HCSPLT11rs;
impl crate::RegisterSpec for OTG_HCSPLT11rs {
    type Ux = u32;
}
///`read()` method returns [`otg_hcsplt11::R`](R) reader structure
impl crate::Readable for OTG_HCSPLT11rs {}
///`write(|w| ..)` method takes [`otg_hcsplt11::W`](W) writer structure
impl crate::Writable for OTG_HCSPLT11rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OTG_HCSPLT11 to value 0
impl crate::Resettable for OTG_HCSPLT11rs {
