#[doc = "Reader of register OTG_HCSPLT3"]
pub type R = crate::R<u32, super::OTG_HCSPLT3>;
#[doc = "Writer for register OTG_HCSPLT3"]
pub type W = crate::W<u32, super::OTG_HCSPLT3>;
#[doc = "Register OTG_HCSPLT3 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HCSPLT3 {
    type Type = u32;
    #[inline(always)]
