#[doc = "Reader of register OTG_HCTSIZ10"]
pub type R = crate::R<u32, super::OTG_HCTSIZ10>;
#[doc = "Writer for register OTG_HCTSIZ10"]
pub type W = crate::W<u32, super::OTG_HCTSIZ10>;
#[doc = "Register OTG_HCTSIZ10 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HCTSIZ10 {
    type Type = u32;
    #[inline(always)]
