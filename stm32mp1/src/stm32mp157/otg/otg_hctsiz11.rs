#[doc = "Reader of register OTG_HCTSIZ11"]
pub type R = crate::R<u32, super::OTG_HCTSIZ11>;
#[doc = "Writer for register OTG_HCTSIZ11"]
pub type W = crate::W<u32, super::OTG_HCTSIZ11>;
#[doc = "Register OTG_HCTSIZ11 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HCTSIZ11 {
    type Type = u32;
    #[inline(always)]
