#[doc = "Reader of register OTG_HCTSIZ14"]
pub type R = crate::R<u32, super::OTG_HCTSIZ14>;
#[doc = "Writer for register OTG_HCTSIZ14"]
pub type W = crate::W<u32, super::OTG_HCTSIZ14>;
#[doc = "Register OTG_HCTSIZ14 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HCTSIZ14 {
    type Type = u32;
    #[inline(always)]
