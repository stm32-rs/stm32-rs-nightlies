#[doc = "Reader of register OTG_HCTSIZ6"]
pub type R = crate::R<u32, super::OTG_HCTSIZ6>;
#[doc = "Writer for register OTG_HCTSIZ6"]
pub type W = crate::W<u32, super::OTG_HCTSIZ6>;
#[doc = "Register OTG_HCTSIZ6 `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HCTSIZ6 {
    type Type = u32;
    #[inline(always)]
