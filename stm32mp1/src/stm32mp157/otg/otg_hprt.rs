#[doc = "Reader of register OTG_HPRT"]
pub type R = crate::R<u32, super::OTG_HPRT>;
#[doc = "Writer for register OTG_HPRT"]
pub type W = crate::W<u32, super::OTG_HPRT>;
#[doc = "Register OTG_HPRT `reset()`'s with value 0"]
impl crate::ResetValue for super::OTG_HPRT {
    type Type = u32;
    #[inline(always)]
