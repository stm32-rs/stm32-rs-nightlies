#[doc = "Reader of register OTG_HPTXFSIZ"]
pub type R = crate::R<u32, super::OTG_HPTXFSIZ>;
#[doc = "Writer for register OTG_HPTXFSIZ"]
pub type W = crate::W<u32, super::OTG_HPTXFSIZ>;
#[doc = "Register OTG_HPTXFSIZ `reset()`'s with value 0x0200_0400"]
impl crate::ResetValue for super::OTG_HPTXFSIZ {
    type Type = u32;
    #[inline(always)]
