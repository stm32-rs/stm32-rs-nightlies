...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wkupen1(&mut self) -> WKUPEN1_W<MCUWKUPENRrs> {
        WKUPEN1_W::new(self, 0)
    }
    ///Bit 1 - WKUPEN2
    #[inline(always)]
    #[must_use]
    pub fn wkupen2(&mut self) -> WKUPEN2_W<MCUWKUPENRrs> {
        WKUPEN2_W::new(self, 1)
    }
    ///Bit 2 - WKUPEN3
    #[inline(always)]
    #[must_use]
    pub fn wkupen3(&mut self) -> WKUPEN3_W<MCUWKUPENRrs> {
        WKUPEN3_W::new(self, 2)
    }
    ///Bit 3 - WKUPEN4
    #[inline(always)]
    #[must_use]
    pub fn wkupen4(&mut self) -> WKUPEN4_W<MCUWKUPENRrs> {
        WKUPEN4_W::new(self, 3)
    }
    ///Bit 4 - WKUPEN5
    #[inline(always)]
    #[must_use]
    pub fn wkupen5(&mut self) -> WKUPEN5_W<MCUWKUPENRrs> {
        WKUPEN5_W::new(self, 4)
    }
    ///Bit 5 - WKUPEN6
    #[inline(always)]
    #[must_use]
    pub fn wkupen6(&mut self) -> WKUPEN6_W<MCUWKUPENRrs> {
