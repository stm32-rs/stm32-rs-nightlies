...
pub type R = crate::R<PWR_MPUWKUPENRrs>;
///Register `PWR_MPUWKUPENR` writer
pub type W = crate::W<PWR_MPUWKUPENRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wkupen1(&mut self) -> WKUPEN1_W<PWR_MPUWKUPENRrs> {
        WKUPEN1_W::new(self, 0)
    }
    ///Bit 1 - WKUPEN2
    #[inline(always)]
    #[must_use]
    pub fn wkupen2(&mut self) -> WKUPEN2_W<PWR_MPUWKUPENRrs> {
        WKUPEN2_W::new(self, 1)
    }
    ///Bit 2 - WKUPEN3
    #[inline(always)]
    #[must_use]
    pub fn wkupen3(&mut self) -> WKUPEN3_W<PWR_MPUWKUPENRrs> {
        WKUPEN3_W::new(self, 2)
    }
    ///Bit 3 - WKUPEN4
    #[inline(always)]
    #[must_use]
    pub fn wkupen4(&mut self) -> WKUPEN4_W<PWR_MPUWKUPENRrs> {
        WKUPEN4_W::new(self, 3)
    }
    ///Bit 4 - WKUPEN5
    #[inline(always)]
    #[must_use]
    pub fn wkupen5(&mut self) -> WKUPEN5_W<PWR_MPUWKUPENRrs> {
        WKUPEN5_W::new(self, 4)
    }
    ///Bit 5 - WKUPEN6
    #[inline(always)]
    #[must_use]
    pub fn wkupen6(&mut self) -> WKUPEN6_W<PWR_MPUWKUPENRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`pwr_mpuwkupenr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pwr_mpuwkupenr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#PWR:PWR_MPUWKUPENR)*/
pub struct PWR_MPUWKUPENRrs;
impl crate::RegisterSpec for PWR_MPUWKUPENRrs {
    type Ux = u32;
}
///`read()` method returns [`pwr_mpuwkupenr::R`](R) reader structure
impl crate::Readable for PWR_MPUWKUPENRrs {}
///`write(|w| ..)` method takes [`pwr_mpuwkupenr::W`](W) writer structure
impl crate::Writable for PWR_MPUWKUPENRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PWR_MPUWKUPENR to value 0
impl crate::Resettable for PWR_MPUWKUPENRrs {
