#[doc = "Reader of register QUADSPI_ABR"]
pub type R = crate::R<u32, super::QUADSPI_ABR>;
#[doc = "Writer for register QUADSPI_ABR"]
pub type W = crate::W<u32, super::QUADSPI_ABR>;
#[doc = "Register QUADSPI_ABR `reset()`'s with value 0"]
impl crate::ResetValue for super::QUADSPI_ABR {
    type Type = u32;
    #[inline(always)]
