///Register `AHB2RSTCLRR` reader
pub type R = crate::R<AHB2RSTCLRRrs>;
///Register `AHB2RSTCLRR` writer
pub type W = crate::W<AHB2RSTCLRRrs>;
...
impl W {
    ///Bit 0 - DMA1RST
    #[inline(always)]
    pub fn dma1rst(&mut self) -> DMA1RST_W<'_, AHB2RSTCLRRrs> {
        DMA1RST_W::new(self, 0)
    }
    ///Bit 1 - DMA2RST
    #[inline(always)]
    pub fn dma2rst(&mut self) -> DMA2RST_W<'_, AHB2RSTCLRRrs> {
        DMA2RST_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXRST
    #[inline(always)]
    pub fn dmamuxrst(&mut self) -> DMAMUXRST_W<'_, AHB2RSTCLRRrs> {
        DMAMUXRST_W::new(self, 2)
    }
    ///Bit 5 - ADC12RST
    #[inline(always)]
    pub fn adc12rst(&mut self) -> ADC12RST_W<'_, AHB2RSTCLRRrs> {
        ADC12RST_W::new(self, 5)
    }
    ///Bit 8 - USBORST
    #[inline(always)]
    pub fn usborst(&mut self) -> USBORST_W<'_, AHB2RSTCLRRrs> {
        USBORST_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3RST
    #[inline(always)]
    pub fn sdmmc3rst(&mut self) -> SDMMC3RST_W<'_, AHB2RSTCLRRrs> {
        SDMMC3RST_W::new(self, 16)
    }
}
/**This register is used to release the reset of the corresponding peripheral.

You can [`read`](crate::Reg::read) this register and get [`ahb2rstclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ahb2rstclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:AHB2RSTCLRR)*/
pub struct AHB2RSTCLRRrs;
impl crate::RegisterSpec for AHB2RSTCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`ahb2rstclrr::R`](R) reader structure
impl crate::Readable for AHB2RSTCLRRrs {}
///`write(|w| ..)` method takes [`ahb2rstclrr::W`](W) writer structure
impl crate::Writable for AHB2RSTCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets AHB2RSTCLRR to value 0
impl crate::Resettable for AHB2RSTCLRRrs {}
