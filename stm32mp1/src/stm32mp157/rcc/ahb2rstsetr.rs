...
impl W {
    ///Bit 0 - DMA1RST
    #[inline(always)]
    pub fn dma1rst(&mut self) -> DMA1RST_W<AHB2RSTSETRrs> {
        DMA1RST_W::new(self, 0)
    }
    ///Bit 1 - DMA2RST
    #[inline(always)]
    pub fn dma2rst(&mut self) -> DMA2RST_W<AHB2RSTSETRrs> {
        DMA2RST_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXRST
    #[inline(always)]
    pub fn dmamuxrst(&mut self) -> DMAMUXRST_W<AHB2RSTSETRrs> {
        DMAMUXRST_W::new(self, 2)
    }
    ///Bit 5 - ADC12RST
    #[inline(always)]
    pub fn adc12rst(&mut self) -> ADC12RST_W<AHB2RSTSETRrs> {
        ADC12RST_W::new(self, 5)
    }
    ///Bit 8 - USBORST
    #[inline(always)]
    pub fn usborst(&mut self) -> USBORST_W<AHB2RSTSETRrs> {
        USBORST_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3RST
    #[inline(always)]
    pub fn sdmmc3rst(&mut self) -> SDMMC3RST_W<AHB2RSTSETRrs> {
