///Register `AHB3RSTCLRR` reader
pub type R = crate::R<AHB3RSTCLRRrs>;
///Register `AHB3RSTCLRR` writer
pub type W = crate::W<AHB3RSTCLRRrs>;
...
impl W {
    ///Bit 0 - DCMIRST
    #[inline(always)]
    pub fn dcmirst(&mut self) -> DCMIRST_W<'_, AHB3RSTCLRRrs> {
        DCMIRST_W::new(self, 0)
    }
    ///Bit 4 - CRYP2RST
    #[inline(always)]
    pub fn cryp2rst(&mut self) -> CRYP2RST_W<'_, AHB3RSTCLRRrs> {
        CRYP2RST_W::new(self, 4)
    }
    ///Bit 5 - HASH2RST
    #[inline(always)]
    pub fn hash2rst(&mut self) -> HASH2RST_W<'_, AHB3RSTCLRRrs> {
        HASH2RST_W::new(self, 5)
    }
    ///Bit 6 - RNG2RST
    #[inline(always)]
    pub fn rng2rst(&mut self) -> RNG2RST_W<'_, AHB3RSTCLRRrs> {
        RNG2RST_W::new(self, 6)
    }
    ///Bit 7 - CRC2RST
    #[inline(always)]
    pub fn crc2rst(&mut self) -> CRC2RST_W<'_, AHB3RSTCLRRrs> {
        CRC2RST_W::new(self, 7)
    }
    ///Bit 11 - HSEMRST
    #[inline(always)]
    pub fn hsemrst(&mut self) -> HSEMRST_W<'_, AHB3RSTCLRRrs> {
        HSEMRST_W::new(self, 11)
    }
    ///Bit 12 - IPCCRST
    #[inline(always)]
    pub fn ipccrst(&mut self) -> IPCCRST_W<'_, AHB3RSTCLRRrs> {
        IPCCRST_W::new(self, 12)
    }
}
/**This register is used to release the reset of the corresponding peripheral.

You can [`read`](crate::Reg::read) this register and get [`ahb3rstclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ahb3rstclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:AHB3RSTCLRR)*/
pub struct AHB3RSTCLRRrs;
impl crate::RegisterSpec for AHB3RSTCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`ahb3rstclrr::R`](R) reader structure
impl crate::Readable for AHB3RSTCLRRrs {}
///`write(|w| ..)` method takes [`ahb3rstclrr::W`](W) writer structure
impl crate::Writable for AHB3RSTCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets AHB3RSTCLRR to value 0
impl crate::Resettable for AHB3RSTCLRRrs {}
