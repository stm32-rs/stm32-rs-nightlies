...
impl W {
    ///Bit 0 - DCMIRST
    #[inline(always)]
    pub fn dcmirst(&mut self) -> DCMIRST_W<AHB3RSTCLRRrs> {
        DCMIRST_W::new(self, 0)
    }
    ///Bit 4 - CRYP2RST
    #[inline(always)]
    pub fn cryp2rst(&mut self) -> CRYP2RST_W<AHB3RSTCLRRrs> {
        CRYP2RST_W::new(self, 4)
    }
    ///Bit 5 - HASH2RST
    #[inline(always)]
    pub fn hash2rst(&mut self) -> HASH2RST_W<AHB3RSTCLRRrs> {
        HASH2RST_W::new(self, 5)
    }
    ///Bit 6 - RNG2RST
    #[inline(always)]
    pub fn rng2rst(&mut self) -> RNG2RST_W<AHB3RSTCLRRrs> {
        RNG2RST_W::new(self, 6)
    }
    ///Bit 7 - CRC2RST
    #[inline(always)]
    pub fn crc2rst(&mut self) -> CRC2RST_W<AHB3RSTCLRRrs> {
        CRC2RST_W::new(self, 7)
    }
    ///Bit 11 - HSEMRST
    #[inline(always)]
    pub fn hsemrst(&mut self) -> HSEMRST_W<AHB3RSTCLRRrs> {
        HSEMRST_W::new(self, 11)
    }
    ///Bit 12 - IPCCRST
    #[inline(always)]
    pub fn ipccrst(&mut self) -> IPCCRST_W<AHB3RSTCLRRrs> {
