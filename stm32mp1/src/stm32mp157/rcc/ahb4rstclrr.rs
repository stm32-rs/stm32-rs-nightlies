...
impl W {
    ///Bit 0 - GPIOARST
    #[inline(always)]
    pub fn gpioarst(&mut self) -> GPIOARST_W<AHB4RSTCLRRrs> {
        GPIOARST_W::new(self, 0)
    }
    ///Bit 1 - GPIOBRST
    #[inline(always)]
    pub fn gpiobrst(&mut self) -> GPIOBRST_W<AHB4RSTCLRRrs> {
        GPIOBRST_W::new(self, 1)
    }
    ///Bit 2 - GPIOCRST
    #[inline(always)]
    pub fn gpiocrst(&mut self) -> GPIOCRST_W<AHB4RSTCLRRrs> {
        GPIOCRST_W::new(self, 2)
    }
    ///Bit 3 - GPIODRST
    #[inline(always)]
    pub fn gpiodrst(&mut self) -> GPIODRST_W<AHB4RSTCLRRrs> {
        GPIODRST_W::new(self, 3)
    }
    ///Bit 4 - GPIOERST
    #[inline(always)]
    pub fn gpioerst(&mut self) -> GPIOERST_W<AHB4RSTCLRRrs> {
        GPIOERST_W::new(self, 4)
    }
    ///Bit 5 - GPIOFRST
    #[inline(always)]
    pub fn gpiofrst(&mut self) -> GPIOFRST_W<AHB4RSTCLRRrs> {
        GPIOFRST_W::new(self, 5)
    }
    ///Bit 6 - GPIOGRST
    #[inline(always)]
    pub fn gpiogrst(&mut self) -> GPIOGRST_W<AHB4RSTCLRRrs> {
        GPIOGRST_W::new(self, 6)
    }
    ///Bit 7 - GPIOHRST
    #[inline(always)]
    pub fn gpiohrst(&mut self) -> GPIOHRST_W<AHB4RSTCLRRrs> {
        GPIOHRST_W::new(self, 7)
    }
    ///Bit 8 - GPIOIRST
    #[inline(always)]
    pub fn gpioirst(&mut self) -> GPIOIRST_W<AHB4RSTCLRRrs> {
        GPIOIRST_W::new(self, 8)
    }
    ///Bit 9 - GPIOJRST
    #[inline(always)]
    pub fn gpiojrst(&mut self) -> GPIOJRST_W<AHB4RSTCLRRrs> {
        GPIOJRST_W::new(self, 9)
    }
    ///Bit 10 - GPIOKRST
    #[inline(always)]
    pub fn gpiokrst(&mut self) -> GPIOKRST_W<AHB4RSTCLRRrs> {
