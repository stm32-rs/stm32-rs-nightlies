...
impl W {
    ///Bit 0 - GPIOZRST
    #[inline(always)]
    pub fn gpiozrst(&mut self) -> GPIOZRST_W<AHB5RSTSETRrs> {
        GPIOZRST_W::new(self, 0)
    }
    ///Bit 4 - CRYP1RST
    #[inline(always)]
    pub fn cryp1rst(&mut self) -> CRYP1RST_W<AHB5RSTSETRrs> {
        CRYP1RST_W::new(self, 4)
    }
    ///Bit 5 - HASH1RST
    #[inline(always)]
    pub fn hash1rst(&mut self) -> HASH1RST_W<AHB5RSTSETRrs> {
        HASH1RST_W::new(self, 5)
    }
    ///Bit 6 - RNG1RST
    #[inline(always)]
    pub fn rng1rst(&mut self) -> RNG1RST_W<AHB5RSTSETRrs> {
        RNG1RST_W::new(self, 6)
    }
    ///Bit 16 - AXIMCRST
    #[inline(always)]
    pub fn aximcrst(&mut self) -> AXIMCRST_W<AHB5RSTSETRrs> {
