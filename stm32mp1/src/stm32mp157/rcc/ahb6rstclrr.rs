...
impl W {
    ///Bit 10 - ETHMACRST
    #[inline(always)]
    pub fn ethmacrst(&mut self) -> ETHMACRST_W<AHB6RSTCLRRrs> {
        ETHMACRST_W::new(self, 10)
    }
    ///Bit 12 - FMCRST
    #[inline(always)]
    pub fn fmcrst(&mut self) -> FMCRST_W<AHB6RSTCLRRrs> {
        FMCRST_W::new(self, 12)
    }
    ///Bit 14 - QSPIRST
    #[inline(always)]
    pub fn qspirst(&mut self) -> QSPIRST_W<AHB6RSTCLRRrs> {
        QSPIRST_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1RST
    #[inline(always)]
    pub fn sdmmc1rst(&mut self) -> SDMMC1RST_W<AHB6RSTCLRRrs> {
        SDMMC1RST_W::new(self, 16)
    }
    ///Bit 17 - SDMMC2RST
    #[inline(always)]
    pub fn sdmmc2rst(&mut self) -> SDMMC2RST_W<AHB6RSTCLRRrs> {
        SDMMC2RST_W::new(self, 17)
    }
    ///Bit 20 - CRC1RST
    #[inline(always)]
    pub fn crc1rst(&mut self) -> CRC1RST_W<AHB6RSTCLRRrs> {
        CRC1RST_W::new(self, 20)
    }
    ///Bit 24 - USBHRST
    #[inline(always)]
    pub fn usbhrst(&mut self) -> USBHRST_W<AHB6RSTCLRRrs> {
