...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpurst(&mut self) -> GPURST_W<AHB6RSTSETRrs> {
        GPURST_W::new(self, 5)
    }
    ///Bit 10 - ETHMACRST
    #[inline(always)]
    #[must_use]
    pub fn ethmacrst(&mut self) -> ETHMACRST_W<AHB6RSTSETRrs> {
        ETHMACRST_W::new(self, 10)
    }
    ///Bit 12 - FMCRST
    #[inline(always)]
    #[must_use]
    pub fn fmcrst(&mut self) -> FMCRST_W<AHB6RSTSETRrs> {
        FMCRST_W::new(self, 12)
    }
    ///Bit 14 - QSPIRST
    #[inline(always)]
    #[must_use]
    pub fn qspirst(&mut self) -> QSPIRST_W<AHB6RSTSETRrs> {
        QSPIRST_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1RST
    #[inline(always)]
    #[must_use]
    pub fn sdmmc1rst(&mut self) -> SDMMC1RST_W<AHB6RSTSETRrs> {
        SDMMC1RST_W::new(self, 16)
    }
    ///Bit 17 - SDMMC2RST
    #[inline(always)]
    #[must_use]
    pub fn sdmmc2rst(&mut self) -> SDMMC2RST_W<AHB6RSTSETRrs> {
        SDMMC2RST_W::new(self, 17)
    }
    ///Bit 20 - CRC1RST
    #[inline(always)]
    #[must_use]
    pub fn crc1rst(&mut self) -> CRC1RST_W<AHB6RSTSETRrs> {
        CRC1RST_W::new(self, 20)
    }
    ///Bit 24 - USBHRST
    #[inline(always)]
    #[must_use]
    pub fn usbhrst(&mut self) -> USBHRST_W<AHB6RSTSETRrs> {
