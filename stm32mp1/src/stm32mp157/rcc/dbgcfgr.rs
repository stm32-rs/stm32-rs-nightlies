...
impl W {
    ///Bits 0:2 - TRACEDIV
    #[inline(always)]
    pub fn tracediv(&mut self) -> TRACEDIV_W<DBGCFGRrs> {
        TRACEDIV_W::new(self, 0)
    }
    ///Bit 8 - DBGCKEN
    #[inline(always)]
    pub fn dbgcken(&mut self) -> DBGCKEN_W<DBGCFGRrs> {
        DBGCKEN_W::new(self, 8)
    }
    ///Bit 9 - TRACECKEN
    #[inline(always)]
    pub fn tracecken(&mut self) -> TRACECKEN_W<DBGCFGRrs> {
        TRACECKEN_W::new(self, 9)
    }
    ///Bit 12 - DBGRST
    #[inline(always)]
    pub fn dbgrst(&mut self) -> DBGRST_W<DBGCFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:DBGCFGR)*/
