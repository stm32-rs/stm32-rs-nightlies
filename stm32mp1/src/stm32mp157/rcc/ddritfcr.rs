...
impl W {
    ///Bit 0 - DDRC1EN
    #[inline(always)]
    pub fn ddrc1en(&mut self) -> DDRC1EN_W<DDRITFCRrs> {
        DDRC1EN_W::new(self, 0)
    }
    ///Bit 1 - DDRC1LPEN
    #[inline(always)]
    pub fn ddrc1lpen(&mut self) -> DDRC1LPEN_W<DDRITFCRrs> {
        DDRC1LPEN_W::new(self, 1)
    }
    ///Bit 2 - DDRC2EN
    #[inline(always)]
    pub fn ddrc2en(&mut self) -> DDRC2EN_W<DDRITFCRrs> {
        DDRC2EN_W::new(self, 2)
    }
    ///Bit 3 - DDRC2LPEN
    #[inline(always)]
    pub fn ddrc2lpen(&mut self) -> DDRC2LPEN_W<DDRITFCRrs> {
        DDRC2LPEN_W::new(self, 3)
    }
    ///Bit 4 - DDRPHYCEN
    #[inline(always)]
    pub fn ddrphycen(&mut self) -> DDRPHYCEN_W<DDRITFCRrs> {
        DDRPHYCEN_W::new(self, 4)
    }
    ///Bit 5 - DDRPHYCLPEN
    #[inline(always)]
    pub fn ddrphyclpen(&mut self) -> DDRPHYCLPEN_W<DDRITFCRrs> {
        DDRPHYCLPEN_W::new(self, 5)
    }
    ///Bit 6 - DDRCAPBEN
    #[inline(always)]
    pub fn ddrcapben(&mut self) -> DDRCAPBEN_W<DDRITFCRrs> {
        DDRCAPBEN_W::new(self, 6)
    }
    ///Bit 7 - DDRCAPBLPEN
    #[inline(always)]
    pub fn ddrcapblpen(&mut self) -> DDRCAPBLPEN_W<DDRITFCRrs> {
        DDRCAPBLPEN_W::new(self, 7)
    }
    ///Bit 8 - AXIDCGEN
    #[inline(always)]
    pub fn axidcgen(&mut self) -> AXIDCGEN_W<DDRITFCRrs> {
        AXIDCGEN_W::new(self, 8)
    }
    ///Bit 9 - DDRPHYCAPBEN
    #[inline(always)]
    pub fn ddrphycapben(&mut self) -> DDRPHYCAPBEN_W<DDRITFCRrs> {
        DDRPHYCAPBEN_W::new(self, 9)
    }
    ///Bit 10 - DDRPHYCAPBLPEN
    #[inline(always)]
    pub fn ddrphycapblpen(&mut self) -> DDRPHYCAPBLPEN_W<DDRITFCRrs> {
        DDRPHYCAPBLPEN_W::new(self, 10)
    }
    ///Bits 11:13 - KERDCG_DLY
    #[inline(always)]
    pub fn kerdcg_dly(&mut self) -> KERDCG_DLY_W<DDRITFCRrs> {
        KERDCG_DLY_W::new(self, 11)
    }
    ///Bit 14 - DDRCAPBRST
    #[inline(always)]
    pub fn ddrcapbrst(&mut self) -> DDRCAPBRST_W<DDRITFCRrs> {
        DDRCAPBRST_W::new(self, 14)
    }
    ///Bit 15 - DDRCAXIRST
    #[inline(always)]
    pub fn ddrcaxirst(&mut self) -> DDRCAXIRST_W<DDRITFCRrs> {
        DDRCAXIRST_W::new(self, 15)
    }
    ///Bit 16 - DDRCORERST
    #[inline(always)]
    pub fn ddrcorerst(&mut self) -> DDRCORERST_W<DDRITFCRrs> {
        DDRCORERST_W::new(self, 16)
    }
    ///Bit 17 - DPHYAPBRST
    #[inline(always)]
    pub fn dphyapbrst(&mut self) -> DPHYAPBRST_W<DDRITFCRrs> {
        DPHYAPBRST_W::new(self, 17)
    }
    ///Bit 18 - DPHYRST
    #[inline(always)]
    pub fn dphyrst(&mut self) -> DPHYRST_W<DDRITFCRrs> {
        DPHYRST_W::new(self, 18)
    }
    ///Bit 19 - DPHYCTLRST
    #[inline(always)]
    pub fn dphyctlrst(&mut self) -> DPHYCTLRST_W<DDRITFCRrs> {
        DPHYCTLRST_W::new(self, 19)
    }
    ///Bits 20:22 - DDRCKMOD
    #[inline(always)]
    pub fn ddrckmod(&mut self) -> DDRCKMOD_W<DDRITFCRrs> {
        DDRCKMOD_W::new(self, 20)
    }
    ///Bit 23 - GSKPMOD
    #[inline(always)]
    pub fn gskpmod(&mut self) -> GSKPMOD_W<DDRITFCRrs> {
        GSKPMOD_W::new(self, 23)
    }
    ///Bit 24 - GSKPCTRL
    #[inline(always)]
    pub fn gskpctrl(&mut self) -> GSKPCTRL_W<DDRITFCRrs> {
        GSKPCTRL_W::new(self, 24)
    }
    ///Bits 25:27 - DFILP_WIDTH
    #[inline(always)]
    pub fn dfilp_width(&mut self) -> DFILP_WIDTH_W<DDRITFCRrs> {
        DFILP_WIDTH_W::new(self, 25)
    }
    ///Bits 28:31 - GSKP_DUR
    #[inline(always)]
    pub fn gskp_dur(&mut self) -> GSKP_DUR_W<DDRITFCRrs> {
