///Register `MC_AHB2ENCLRR` reader
pub type R = crate::R<MC_AHB2ENCLRRrs>;
///Register `MC_AHB2ENCLRR` writer
pub type W = crate::W<MC_AHB2ENCLRRrs>;
...
impl W {
    ///Bit 0 - DMA1EN
    #[inline(always)]
    pub fn dma1en(&mut self) -> DMA1EN_W<'_, MC_AHB2ENCLRRrs> {
        DMA1EN_W::new(self, 0)
    }
    ///Bit 1 - DMA2EN
    #[inline(always)]
    pub fn dma2en(&mut self) -> DMA2EN_W<'_, MC_AHB2ENCLRRrs> {
        DMA2EN_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXEN
    #[inline(always)]
    pub fn dmamuxen(&mut self) -> DMAMUXEN_W<'_, MC_AHB2ENCLRRrs> {
        DMAMUXEN_W::new(self, 2)
    }
    ///Bit 5 - ADC12EN
    #[inline(always)]
    pub fn adc12en(&mut self) -> ADC12EN_W<'_, MC_AHB2ENCLRRrs> {
        ADC12EN_W::new(self, 5)
    }
    ///Bit 8 - USBOEN
    #[inline(always)]
    pub fn usboen(&mut self) -> USBOEN_W<'_, MC_AHB2ENCLRRrs> {
        USBOEN_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3EN
    #[inline(always)]
    pub fn sdmmc3en(&mut self) -> SDMMC3EN_W<'_, MC_AHB2ENCLRRrs> {
        SDMMC3EN_W::new(self, 16)
    }
}
/**This register is used to clear the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`mc_ahb2enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_ahb2enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MC_AHB2ENCLRR)*/
pub struct MC_AHB2ENCLRRrs;
impl crate::RegisterSpec for MC_AHB2ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_ahb2enclrr::R`](R) reader structure
impl crate::Readable for MC_AHB2ENCLRRrs {}
///`write(|w| ..)` method takes [`mc_ahb2enclrr::W`](W) writer structure
impl crate::Writable for MC_AHB2ENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_AHB2ENCLRR to value 0
impl crate::Resettable for MC_AHB2ENCLRRrs {}
