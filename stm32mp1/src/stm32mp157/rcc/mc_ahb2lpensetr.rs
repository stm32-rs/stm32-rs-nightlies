///Register `MC_AHB2LPENSETR` reader
pub type R = crate::R<MC_AHB2LPENSETRrs>;
///Register `MC_AHB2LPENSETR` writer
pub type W = crate::W<MC_AHB2LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MC_AHB2LPENSETR")
...
impl W {
    ///Bit 0 - DMA1LPEN
    #[inline(always)]
    pub fn dma1lpen(&mut self) -> DMA1LPEN_W<'_, MC_AHB2LPENSETRrs> {
        DMA1LPEN_W::new(self, 0)
    }
    ///Bit 1 - DMA2LPEN
    #[inline(always)]
    pub fn dma2lpen(&mut self) -> DMA2LPEN_W<'_, MC_AHB2LPENSETRrs> {
        DMA2LPEN_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXLPEN
    #[inline(always)]
    pub fn dmamuxlpen(&mut self) -> DMAMUXLPEN_W<'_, MC_AHB2LPENSETRrs> {
        DMAMUXLPEN_W::new(self, 2)
    }
    ///Bit 5 - ADC12LPEN
    #[inline(always)]
    pub fn adc12lpen(&mut self) -> ADC12LPEN_W<'_, MC_AHB2LPENSETRrs> {
        ADC12LPEN_W::new(self, 5)
    }
    ///Bit 8 - USBOLPEN
    #[inline(always)]
    pub fn usbolpen(&mut self) -> USBOLPEN_W<'_, MC_AHB2LPENSETRrs> {
        USBOLPEN_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3LPEN
    #[inline(always)]
    pub fn sdmmc3lpen(&mut self) -> SDMMC3LPEN_W<'_, MC_AHB2LPENSETRrs> {
        SDMMC3LPEN_W::new(self, 16)
    }
}
/**This register is used by the MCU in order to set the PERxLPEN bit.

You can [`read`](crate::Reg::read) this register and get [`mc_ahb2lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_ahb2lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MC_AHB2LPENSETR)*/
pub struct MC_AHB2LPENSETRrs;
impl crate::RegisterSpec for MC_AHB2LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_ahb2lpensetr::R`](R) reader structure
impl crate::Readable for MC_AHB2LPENSETRrs {}
///`write(|w| ..)` method takes [`mc_ahb2lpensetr::W`](W) writer structure
impl crate::Writable for MC_AHB2LPENSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_AHB2LPENSETR to value 0x0001_0127
impl crate::Resettable for MC_AHB2LPENSETRrs {
