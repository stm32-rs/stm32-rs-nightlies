///Register `MC_AHB3ENSETR` reader
pub type R = crate::R<MC_AHB3ENSETRrs>;
///Register `MC_AHB3ENSETR` writer
pub type W = crate::W<MC_AHB3ENSETRrs>;
...
impl W {
    ///Bit 0 - DCMIEN
    #[inline(always)]
    pub fn dcmien(&mut self) -> DCMIEN_W<'_, MC_AHB3ENSETRrs> {
        DCMIEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP2EN
    #[inline(always)]
    pub fn cryp2en(&mut self) -> CRYP2EN_W<'_, MC_AHB3ENSETRrs> {
        CRYP2EN_W::new(self, 4)
    }
    ///Bit 5 - HASH2EN
    #[inline(always)]
    pub fn hash2en(&mut self) -> HASH2EN_W<'_, MC_AHB3ENSETRrs> {
        HASH2EN_W::new(self, 5)
    }
    ///Bit 6 - RNG2EN
    #[inline(always)]
    pub fn rng2en(&mut self) -> RNG2EN_W<'_, MC_AHB3ENSETRrs> {
        RNG2EN_W::new(self, 6)
    }
    ///Bit 7 - CRC2EN
    #[inline(always)]
    pub fn crc2en(&mut self) -> CRC2EN_W<'_, MC_AHB3ENSETRrs> {
        CRC2EN_W::new(self, 7)
    }
    ///Bit 11 - HSEMEN
    #[inline(always)]
    pub fn hsemen(&mut self) -> HSEMEN_W<'_, MC_AHB3ENSETRrs> {
        HSEMEN_W::new(self, 11)
    }
    ///Bit 12 - IPCCEN
    #[inline(always)]
    pub fn ipccen(&mut self) -> IPCCEN_W<'_, MC_AHB3ENSETRrs> {
        IPCCEN_W::new(self, 12)
    }
}
/**This register is used to set the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`mc_ahb3ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_ahb3ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MC_AHB3ENSETR)*/
pub struct MC_AHB3ENSETRrs;
impl crate::RegisterSpec for MC_AHB3ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_ahb3ensetr::R`](R) reader structure
impl crate::Readable for MC_AHB3ENSETRrs {}
///`write(|w| ..)` method takes [`mc_ahb3ensetr::W`](W) writer structure
impl crate::Writable for MC_AHB3ENSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_AHB3ENSETR to value 0
impl crate::Resettable for MC_AHB3ENSETRrs {}
