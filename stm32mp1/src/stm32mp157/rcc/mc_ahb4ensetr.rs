...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpioaen(&mut self) -> GPIOAEN_W<MC_AHB4ENSETRrs> {
        GPIOAEN_W::new(self, 0)
    }
    ///Bit 1 - GPIOBEN
    #[inline(always)]
    #[must_use]
    pub fn gpioben(&mut self) -> GPIOBEN_W<MC_AHB4ENSETRrs> {
        GPIOBEN_W::new(self, 1)
    }
    ///Bit 2 - GPIOCEN
    #[inline(always)]
    #[must_use]
    pub fn gpiocen(&mut self) -> GPIOCEN_W<MC_AHB4ENSETRrs> {
        GPIOCEN_W::new(self, 2)
    }
    ///Bit 3 - GPIODEN
    #[inline(always)]
    #[must_use]
    pub fn gpioden(&mut self) -> GPIODEN_W<MC_AHB4ENSETRrs> {
        GPIODEN_W::new(self, 3)
    }
    ///Bit 4 - GPIOEEN
    #[inline(always)]
    #[must_use]
    pub fn gpioeen(&mut self) -> GPIOEEN_W<MC_AHB4ENSETRrs> {
        GPIOEEN_W::new(self, 4)
    }
    ///Bit 5 - GPIOFEN
    #[inline(always)]
    #[must_use]
    pub fn gpiofen(&mut self) -> GPIOFEN_W<MC_AHB4ENSETRrs> {
        GPIOFEN_W::new(self, 5)
    }
    ///Bit 6 - GPIOGEN
    #[inline(always)]
    #[must_use]
    pub fn gpiogen(&mut self) -> GPIOGEN_W<MC_AHB4ENSETRrs> {
        GPIOGEN_W::new(self, 6)
    }
    ///Bit 7 - GPIOHEN
    #[inline(always)]
    #[must_use]
    pub fn gpiohen(&mut self) -> GPIOHEN_W<MC_AHB4ENSETRrs> {
        GPIOHEN_W::new(self, 7)
    }
    ///Bit 8 - GPIOIEN
    #[inline(always)]
    #[must_use]
    pub fn gpioien(&mut self) -> GPIOIEN_W<MC_AHB4ENSETRrs> {
        GPIOIEN_W::new(self, 8)
    }
    ///Bit 9 - GPIOJEN
    #[inline(always)]
    #[must_use]
    pub fn gpiojen(&mut self) -> GPIOJEN_W<MC_AHB4ENSETRrs> {
        GPIOJEN_W::new(self, 9)
    }
    ///Bit 10 - GPIOKEN
    #[inline(always)]
    #[must_use]
    pub fn gpioken(&mut self) -> GPIOKEN_W<MC_AHB4ENSETRrs> {
