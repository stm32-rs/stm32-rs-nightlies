...
impl W {
    ///Bit 0 - GPIOZLPEN
    #[inline(always)]
    pub fn gpiozlpen(&mut self) -> GPIOZLPEN_W<MC_AHB5LPENSETRrs> {
        GPIOZLPEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP1LPEN
    #[inline(always)]
    pub fn cryp1lpen(&mut self) -> CRYP1LPEN_W<MC_AHB5LPENSETRrs> {
        CRYP1LPEN_W::new(self, 4)
    }
    ///Bit 5 - HASH1LPEN
    #[inline(always)]
    pub fn hash1lpen(&mut self) -> HASH1LPEN_W<MC_AHB5LPENSETRrs> {
        HASH1LPEN_W::new(self, 5)
    }
    ///Bit 6 - RNG1LPEN
    #[inline(always)]
    pub fn rng1lpen(&mut self) -> RNG1LPEN_W<MC_AHB5LPENSETRrs> {
        RNG1LPEN_W::new(self, 6)
    }
    ///Bit 8 - BKPSRAMLPEN
    #[inline(always)]
    pub fn bkpsramlpen(&mut self) -> BKPSRAMLPEN_W<MC_AHB5LPENSETRrs> {
