///Register `MC_AHB6LPENCLRR` reader
pub type R = crate::R<MC_AHB6LPENCLRRrs>;
///Register `MC_AHB6LPENCLRR` writer
pub type W = crate::W<MC_AHB6LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MC_AHB6LPENCLRR")
...
impl W {
    ///Bit 0 - MDMALPEN
    #[inline(always)]
    pub fn mdmalpen(&mut self) -> MDMALPEN_W<'_, MC_AHB6LPENCLRRrs> {
        MDMALPEN_W::new(self, 0)
    }
    ///Bit 5 - GPULPEN
    #[inline(always)]
    pub fn gpulpen(&mut self) -> GPULPEN_W<'_, MC_AHB6LPENCLRRrs> {
        GPULPEN_W::new(self, 5)
    }
    ///Bit 7 - ETHCKLPEN
    #[inline(always)]
    pub fn ethcklpen(&mut self) -> ETHCKLPEN_W<'_, MC_AHB6LPENCLRRrs> {
        ETHCKLPEN_W::new(self, 7)
    }
    ///Bit 8 - ETHTXLPEN
    #[inline(always)]
    pub fn ethtxlpen(&mut self) -> ETHTXLPEN_W<'_, MC_AHB6LPENCLRRrs> {
        ETHTXLPEN_W::new(self, 8)
    }
    ///Bit 9 - ETHRXLPEN
    #[inline(always)]
    pub fn ethrxlpen(&mut self) -> ETHRXLPEN_W<'_, MC_AHB6LPENCLRRrs> {
        ETHRXLPEN_W::new(self, 9)
    }
    ///Bit 10 - ETHMACLPEN
    #[inline(always)]
    pub fn ethmaclpen(&mut self) -> ETHMACLPEN_W<'_, MC_AHB6LPENCLRRrs> {
        ETHMACLPEN_W::new(self, 10)
    }
    ///Bit 11 - ETHSTPEN
    #[inline(always)]
    pub fn ethstpen(&mut self) -> ETHSTPEN_W<'_, MC_AHB6LPENCLRRrs> {
        ETHSTPEN_W::new(self, 11)
    }
    ///Bit 12 - FMCLPEN
    #[inline(always)]
    pub fn fmclpen(&mut self) -> FMCLPEN_W<'_, MC_AHB6LPENCLRRrs> {
        FMCLPEN_W::new(self, 12)
    }
    ///Bit 14 - QSPILPEN
    #[inline(always)]
    pub fn qspilpen(&mut self) -> QSPILPEN_W<'_, MC_AHB6LPENCLRRrs> {
        QSPILPEN_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1LPEN
    #[inline(always)]
    pub fn sdmmc1lpen(&mut self) -> SDMMC1LPEN_W<'_, MC_AHB6LPENCLRRrs> {
        SDMMC1LPEN_W::new(self, 16)
    }
    ///Bit 17 - SDMMC2LPEN
    #[inline(always)]
    pub fn sdmmc2lpen(&mut self) -> SDMMC2LPEN_W<'_, MC_AHB6LPENCLRRrs> {
        SDMMC2LPEN_W::new(self, 17)
    }
    ///Bit 20 - CRC1LPEN
    #[inline(always)]
    pub fn crc1lpen(&mut self) -> CRC1LPEN_W<'_, MC_AHB6LPENCLRRrs> {
        CRC1LPEN_W::new(self, 20)
    }
    ///Bit 24 - USBHLPEN
    #[inline(always)]
    pub fn usbhlpen(&mut self) -> USBHLPEN_W<'_, MC_AHB6LPENCLRRrs> {
        USBHLPEN_W::new(self, 24)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bit

You can [`read`](crate::Reg::read) this register and get [`mc_ahb6lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_ahb6lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MC_AHB6LPENCLRR)*/
pub struct MC_AHB6LPENCLRRrs;
impl crate::RegisterSpec for MC_AHB6LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_ahb6lpenclrr::R`](R) reader structure
impl crate::Readable for MC_AHB6LPENCLRRrs {}
///`write(|w| ..)` method takes [`mc_ahb6lpenclrr::W`](W) writer structure
impl crate::Writable for MC_AHB6LPENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_AHB6LPENCLRR to value 0x0113_57a1
impl crate::Resettable for MC_AHB6LPENCLRRrs {
