...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdmalpen(&mut self) -> MDMALPEN_W<MC_AHB6LPENCLRRrs> {
        MDMALPEN_W::new(self, 0)
    }
    ///Bit 5 - GPULPEN
    #[inline(always)]
    #[must_use]
    pub fn gpulpen(&mut self) -> GPULPEN_W<MC_AHB6LPENCLRRrs> {
        GPULPEN_W::new(self, 5)
    }
    ///Bit 7 - ETHCKLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethcklpen(&mut self) -> ETHCKLPEN_W<MC_AHB6LPENCLRRrs> {
        ETHCKLPEN_W::new(self, 7)
    }
    ///Bit 8 - ETHTXLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethtxlpen(&mut self) -> ETHTXLPEN_W<MC_AHB6LPENCLRRrs> {
        ETHTXLPEN_W::new(self, 8)
    }
    ///Bit 9 - ETHRXLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethrxlpen(&mut self) -> ETHRXLPEN_W<MC_AHB6LPENCLRRrs> {
        ETHRXLPEN_W::new(self, 9)
    }
    ///Bit 10 - ETHMACLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethmaclpen(&mut self) -> ETHMACLPEN_W<MC_AHB6LPENCLRRrs> {
        ETHMACLPEN_W::new(self, 10)
    }
    ///Bit 11 - ETHSTPEN
    #[inline(always)]
    #[must_use]
    pub fn ethstpen(&mut self) -> ETHSTPEN_W<MC_AHB6LPENCLRRrs> {
        ETHSTPEN_W::new(self, 11)
    }
    ///Bit 12 - FMCLPEN
    #[inline(always)]
    #[must_use]
    pub fn fmclpen(&mut self) -> FMCLPEN_W<MC_AHB6LPENCLRRrs> {
        FMCLPEN_W::new(self, 12)
    }
    ///Bit 14 - QSPILPEN
    #[inline(always)]
    #[must_use]
    pub fn qspilpen(&mut self) -> QSPILPEN_W<MC_AHB6LPENCLRRrs> {
        QSPILPEN_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1LPEN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc1lpen(&mut self) -> SDMMC1LPEN_W<MC_AHB6LPENCLRRrs> {
        SDMMC1LPEN_W::new(self, 16)
    }
    ///Bit 17 - SDMMC2LPEN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc2lpen(&mut self) -> SDMMC2LPEN_W<MC_AHB6LPENCLRRrs> {
        SDMMC2LPEN_W::new(self, 17)
    }
    ///Bit 20 - CRC1LPEN
    #[inline(always)]
    #[must_use]
    pub fn crc1lpen(&mut self) -> CRC1LPEN_W<MC_AHB6LPENCLRRrs> {
        CRC1LPEN_W::new(self, 20)
    }
    ///Bit 24 - USBHLPEN
    #[inline(always)]
    #[must_use]
    pub fn usbhlpen(&mut self) -> USBHLPEN_W<MC_AHB6LPENCLRRrs> {
