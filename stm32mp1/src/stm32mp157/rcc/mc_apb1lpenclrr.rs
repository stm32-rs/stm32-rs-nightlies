...
impl W {
    ///Bit 0 - TIM2LPEN
    #[inline(always)]
    pub fn tim2lpen(&mut self) -> TIM2LPEN_W<MC_APB1LPENCLRRrs> {
        TIM2LPEN_W::new(self, 0)
    }
    ///Bit 1 - TIM3LPEN
    #[inline(always)]
    pub fn tim3lpen(&mut self) -> TIM3LPEN_W<MC_APB1LPENCLRRrs> {
        TIM3LPEN_W::new(self, 1)
    }
    ///Bit 2 - TIM4LPEN
    #[inline(always)]
    pub fn tim4lpen(&mut self) -> TIM4LPEN_W<MC_APB1LPENCLRRrs> {
        TIM4LPEN_W::new(self, 2)
    }
    ///Bit 3 - TIM5LPEN
    #[inline(always)]
    pub fn tim5lpen(&mut self) -> TIM5LPEN_W<MC_APB1LPENCLRRrs> {
        TIM5LPEN_W::new(self, 3)
    }
    ///Bit 4 - TIM6LPEN
    #[inline(always)]
    pub fn tim6lpen(&mut self) -> TIM6LPEN_W<MC_APB1LPENCLRRrs> {
        TIM6LPEN_W::new(self, 4)
    }
    ///Bit 5 - TIM7LPEN
    #[inline(always)]
    pub fn tim7lpen(&mut self) -> TIM7LPEN_W<MC_APB1LPENCLRRrs> {
        TIM7LPEN_W::new(self, 5)
    }
    ///Bit 6 - TIM12LPEN
    #[inline(always)]
    pub fn tim12lpen(&mut self) -> TIM12LPEN_W<MC_APB1LPENCLRRrs> {
        TIM12LPEN_W::new(self, 6)
    }
    ///Bit 7 - TIM13LPEN
    #[inline(always)]
    pub fn tim13lpen(&mut self) -> TIM13LPEN_W<MC_APB1LPENCLRRrs> {
        TIM13LPEN_W::new(self, 7)
    }
    ///Bit 8 - TIM14LPEN
    #[inline(always)]
    pub fn tim14lpen(&mut self) -> TIM14LPEN_W<MC_APB1LPENCLRRrs> {
        TIM14LPEN_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1LPEN
    #[inline(always)]
    pub fn lptim1lpen(&mut self) -> LPTIM1LPEN_W<MC_APB1LPENCLRRrs> {
        LPTIM1LPEN_W::new(self, 9)
    }
    ///Bit 11 - SPI2LPEN
    #[inline(always)]
    pub fn spi2lpen(&mut self) -> SPI2LPEN_W<MC_APB1LPENCLRRrs> {
        SPI2LPEN_W::new(self, 11)
    }
    ///Bit 12 - SPI3LPEN
    #[inline(always)]
    pub fn spi3lpen(&mut self) -> SPI3LPEN_W<MC_APB1LPENCLRRrs> {
        SPI3LPEN_W::new(self, 12)
    }
    ///Bit 14 - USART2LPEN
    #[inline(always)]
    pub fn usart2lpen(&mut self) -> USART2LPEN_W<MC_APB1LPENCLRRrs> {
        USART2LPEN_W::new(self, 14)
    }
    ///Bit 15 - USART3LPEN
    #[inline(always)]
    pub fn usart3lpen(&mut self) -> USART3LPEN_W<MC_APB1LPENCLRRrs> {
        USART3LPEN_W::new(self, 15)
    }
    ///Bit 16 - UART4LPEN
    #[inline(always)]
    pub fn uart4lpen(&mut self) -> UART4LPEN_W<MC_APB1LPENCLRRrs> {
        UART4LPEN_W::new(self, 16)
    }
    ///Bit 17 - UART5LPEN
    #[inline(always)]
    pub fn uart5lpen(&mut self) -> UART5LPEN_W<MC_APB1LPENCLRRrs> {
        UART5LPEN_W::new(self, 17)
    }
    ///Bit 18 - UART7LPEN
    #[inline(always)]
    pub fn uart7lpen(&mut self) -> UART7LPEN_W<MC_APB1LPENCLRRrs> {
        UART7LPEN_W::new(self, 18)
    }
    ///Bit 19 - UART8LPEN
    #[inline(always)]
    pub fn uart8lpen(&mut self) -> UART8LPEN_W<MC_APB1LPENCLRRrs> {
        UART8LPEN_W::new(self, 19)
    }
    ///Bit 21 - I2C1LPEN
    #[inline(always)]
    pub fn i2c1lpen(&mut self) -> I2C1LPEN_W<MC_APB1LPENCLRRrs> {
        I2C1LPEN_W::new(self, 21)
    }
    ///Bit 22 - I2C2LPEN
    #[inline(always)]
    pub fn i2c2lpen(&mut self) -> I2C2LPEN_W<MC_APB1LPENCLRRrs> {
        I2C2LPEN_W::new(self, 22)
    }
    ///Bit 23 - I2C3LPEN
    #[inline(always)]
    pub fn i2c3lpen(&mut self) -> I2C3LPEN_W<MC_APB1LPENCLRRrs> {
        I2C3LPEN_W::new(self, 23)
    }
    ///Bit 24 - I2C5LPEN
    #[inline(always)]
    pub fn i2c5lpen(&mut self) -> I2C5LPEN_W<MC_APB1LPENCLRRrs> {
        I2C5LPEN_W::new(self, 24)
    }
    ///Bit 26 - SPDIFLPEN
    #[inline(always)]
    pub fn spdiflpen(&mut self) -> SPDIFLPEN_W<MC_APB1LPENCLRRrs> {
        SPDIFLPEN_W::new(self, 26)
    }
    ///Bit 27 - CECLPEN
    #[inline(always)]
    pub fn ceclpen(&mut self) -> CECLPEN_W<MC_APB1LPENCLRRrs> {
        CECLPEN_W::new(self, 27)
    }
    ///Bit 28 - WWDG1LPEN
    #[inline(always)]
    pub fn wwdg1lpen(&mut self) -> WWDG1LPEN_W<MC_APB1LPENCLRRrs> {
        WWDG1LPEN_W::new(self, 28)
    }
    ///Bit 29 - DAC12LPEN
    #[inline(always)]
    pub fn dac12lpen(&mut self) -> DAC12LPEN_W<MC_APB1LPENCLRRrs> {
        DAC12LPEN_W::new(self, 29)
    }
    ///Bit 31 - MDIOSLPEN
    #[inline(always)]
    pub fn mdioslpen(&mut self) -> MDIOSLPEN_W<MC_APB1LPENCLRRrs> {
