///Register `MC_APB2ENCLRR` reader
pub type R = crate::R<MC_APB2ENCLRRrs>;
///Register `MC_APB2ENCLRR` writer
pub type W = crate::W<MC_APB2ENCLRRrs>;
...
impl W {
    ///Bit 0 - TIM1EN
    #[inline(always)]
    pub fn tim1en(&mut self) -> TIM1EN_W<'_, MC_APB2ENCLRRrs> {
        TIM1EN_W::new(self, 0)
    }
    ///Bit 1 - TIM8EN
    #[inline(always)]
    pub fn tim8en(&mut self) -> TIM8EN_W<'_, MC_APB2ENCLRRrs> {
        TIM8EN_W::new(self, 1)
    }
    ///Bit 2 - TIM15EN
    #[inline(always)]
    pub fn tim15en(&mut self) -> TIM15EN_W<'_, MC_APB2ENCLRRrs> {
        TIM15EN_W::new(self, 2)
    }
    ///Bit 3 - TIM16EN
    #[inline(always)]
    pub fn tim16en(&mut self) -> TIM16EN_W<'_, MC_APB2ENCLRRrs> {
        TIM16EN_W::new(self, 3)
    }
    ///Bit 4 - TIM17EN
    #[inline(always)]
    pub fn tim17en(&mut self) -> TIM17EN_W<'_, MC_APB2ENCLRRrs> {
        TIM17EN_W::new(self, 4)
    }
    ///Bit 8 - SPI1EN
    #[inline(always)]
    pub fn spi1en(&mut self) -> SPI1EN_W<'_, MC_APB2ENCLRRrs> {
        SPI1EN_W::new(self, 8)
    }
    ///Bit 9 - SPI4EN
    #[inline(always)]
    pub fn spi4en(&mut self) -> SPI4EN_W<'_, MC_APB2ENCLRRrs> {
        SPI4EN_W::new(self, 9)
    }
    ///Bit 10 - SPI5EN
    #[inline(always)]
    pub fn spi5en(&mut self) -> SPI5EN_W<'_, MC_APB2ENCLRRrs> {
        SPI5EN_W::new(self, 10)
    }
    ///Bit 13 - USART6EN
    #[inline(always)]
    pub fn usart6en(&mut self) -> USART6EN_W<'_, MC_APB2ENCLRRrs> {
        USART6EN_W::new(self, 13)
    }
    ///Bit 16 - SAI1EN
    #[inline(always)]
    pub fn sai1en(&mut self) -> SAI1EN_W<'_, MC_APB2ENCLRRrs> {
        SAI1EN_W::new(self, 16)
    }
    ///Bit 17 - SAI2EN
    #[inline(always)]
    pub fn sai2en(&mut self) -> SAI2EN_W<'_, MC_APB2ENCLRRrs> {
        SAI2EN_W::new(self, 17)
    }
    ///Bit 18 - SAI3EN
    #[inline(always)]
    pub fn sai3en(&mut self) -> SAI3EN_W<'_, MC_APB2ENCLRRrs> {
        SAI3EN_W::new(self, 18)
    }
    ///Bit 20 - DFSDMEN
    #[inline(always)]
    pub fn dfsdmen(&mut self) -> DFSDMEN_W<'_, MC_APB2ENCLRRrs> {
        DFSDMEN_W::new(self, 20)
    }
    ///Bit 21 - ADFSDMEN
    #[inline(always)]
    pub fn adfsdmen(&mut self) -> ADFSDMEN_W<'_, MC_APB2ENCLRRrs> {
        ADFSDMEN_W::new(self, 21)
    }
    ///Bit 24 - FDCANEN
    #[inline(always)]
    pub fn fdcanen(&mut self) -> FDCANEN_W<'_, MC_APB2ENCLRRrs> {
        FDCANEN_W::new(self, 24)
    }
}
/**This register is used to clear the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`mc_apb2enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_apb2enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MC_APB2ENCLRR)*/
pub struct MC_APB2ENCLRRrs;
impl crate::RegisterSpec for MC_APB2ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_apb2enclrr::R`](R) reader structure
impl crate::Readable for MC_APB2ENCLRRrs {}
///`write(|w| ..)` method takes [`mc_apb2enclrr::W`](W) writer structure
impl crate::Writable for MC_APB2ENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_APB2ENCLRR to value 0
impl crate::Resettable for MC_APB2ENCLRRrs {}
