///Register `MC_APB3ENSETR` reader
pub type R = crate::R<MC_APB3ENSETRrs>;
///Register `MC_APB3ENSETR` writer
pub type W = crate::W<MC_APB3ENSETRrs>;
...
impl W {
    ///Bit 0 - LPTIM2EN
    #[inline(always)]
    pub fn lptim2en(&mut self) -> LPTIM2EN_W<'_, MC_APB3ENSETRrs> {
        LPTIM2EN_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3EN
    #[inline(always)]
    pub fn lptim3en(&mut self) -> LPTIM3EN_W<'_, MC_APB3ENSETRrs> {
        LPTIM3EN_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4EN
    #[inline(always)]
    pub fn lptim4en(&mut self) -> LPTIM4EN_W<'_, MC_APB3ENSETRrs> {
        LPTIM4EN_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5EN
    #[inline(always)]
    pub fn lptim5en(&mut self) -> LPTIM5EN_W<'_, MC_APB3ENSETRrs> {
        LPTIM5EN_W::new(self, 3)
    }
    ///Bit 8 - SAI4EN
    #[inline(always)]
    pub fn sai4en(&mut self) -> SAI4EN_W<'_, MC_APB3ENSETRrs> {
        SAI4EN_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGEN
    #[inline(always)]
    pub fn syscfgen(&mut self) -> SYSCFGEN_W<'_, MC_APB3ENSETRrs> {
        SYSCFGEN_W::new(self, 11)
    }
    ///Bit 13 - VREFEN
    #[inline(always)]
    pub fn vrefen(&mut self) -> VREFEN_W<'_, MC_APB3ENSETRrs> {
        VREFEN_W::new(self, 13)
    }
    ///Bit 16 - DTSEN
    #[inline(always)]
    pub fn dtsen(&mut self) -> DTSEN_W<'_, MC_APB3ENSETRrs> {
        DTSEN_W::new(self, 16)
    }
    ///Bit 20 - HDPEN
    #[inline(always)]
    pub fn hdpen(&mut self) -> HDPEN_W<'_, MC_APB3ENSETRrs> {
        HDPEN_W::new(self, 20)
    }
}
/**This register is used to set the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`mc_apb3ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_apb3ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MC_APB3ENSETR)*/
pub struct MC_APB3ENSETRrs;
impl crate::RegisterSpec for MC_APB3ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_apb3ensetr::R`](R) reader structure
impl crate::Readable for MC_APB3ENSETRrs {}
///`write(|w| ..)` method takes [`mc_apb3ensetr::W`](W) writer structure
impl crate::Writable for MC_APB3ENSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_APB3ENSETR to value 0
impl crate::Resettable for MC_APB3ENSETRrs {}
