///Register `MC_CIFR` reader
pub type R = crate::R<MC_CIFRrs>;
///Register `MC_CIFR` writer
pub type W = crate::W<MC_CIFRrs>;
...
impl W {
    ///Bit 0 - LSIRDYF
    #[inline(always)]
    pub fn lsirdyf(&mut self) -> LSIRDYF_W<'_, MC_CIFRrs> {
        LSIRDYF_W::new(self, 0)
    }
    ///Bit 1 - LSERDYF
    #[inline(always)]
    pub fn lserdyf(&mut self) -> LSERDYF_W<'_, MC_CIFRrs> {
        LSERDYF_W::new(self, 1)
    }
    ///Bit 2 - HSIRDYF
    #[inline(always)]
    pub fn hsirdyf(&mut self) -> HSIRDYF_W<'_, MC_CIFRrs> {
        HSIRDYF_W::new(self, 2)
    }
    ///Bit 3 - HSERDYF
    #[inline(always)]
    pub fn hserdyf(&mut self) -> HSERDYF_W<'_, MC_CIFRrs> {
        HSERDYF_W::new(self, 3)
    }
    ///Bit 4 - CSIRDYF
    #[inline(always)]
    pub fn csirdyf(&mut self) -> CSIRDYF_W<'_, MC_CIFRrs> {
        CSIRDYF_W::new(self, 4)
    }
    ///Bit 8 - PLL1DYF
    #[inline(always)]
    pub fn pll1dyf(&mut self) -> PLL1DYF_W<'_, MC_CIFRrs> {
        PLL1DYF_W::new(self, 8)
    }
    ///Bit 9 - PLL2DYF
    #[inline(always)]
    pub fn pll2dyf(&mut self) -> PLL2DYF_W<'_, MC_CIFRrs> {
        PLL2DYF_W::new(self, 9)
    }
    ///Bit 10 - PLL3DYF
    #[inline(always)]
    pub fn pll3dyf(&mut self) -> PLL3DYF_W<'_, MC_CIFRrs> {
        PLL3DYF_W::new(self, 10)
    }
    ///Bit 11 - PLL4DYF
    #[inline(always)]
    pub fn pll4dyf(&mut self) -> PLL4DYF_W<'_, MC_CIFRrs> {
        PLL4DYF_W::new(self, 11)
    }
    ///Bit 16 - LSECSSF
    #[inline(always)]
    pub fn lsecssf(&mut self) -> LSECSSF_W<'_, MC_CIFRrs> {
        LSECSSF_W::new(self, 16)
    }
    ///Bit 20 - WKUPF
    #[inline(always)]
    pub fn wkupf(&mut self) -> WKUPF_W<'_, MC_CIFRrs> {
        WKUPF_W::new(self, 20)
    }
}
/**This register shall be used by the MCU in order to read and clear the interrupt flags.

You can [`read`](crate::Reg::read) this register and get [`mc_cifr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_cifr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MC_CIFR)*/
pub struct MC_CIFRrs;
impl crate::RegisterSpec for MC_CIFRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_cifr::R`](R) reader structure
impl crate::Readable for MC_CIFRrs {}
///`write(|w| ..)` method takes [`mc_cifr::W`](W) writer structure
impl crate::Writable for MC_CIFRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_CIFR to value 0
impl crate::Resettable for MC_CIFRrs {}
