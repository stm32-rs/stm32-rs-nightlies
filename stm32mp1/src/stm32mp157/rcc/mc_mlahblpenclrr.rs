///Register `MC_MLAHBLPENCLRR` reader
pub type R = crate::R<MC_MLAHBLPENCLRRrs>;
///Register `MC_MLAHBLPENCLRR` writer
pub type W = crate::W<MC_MLAHBLPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MC_MLAHBLPENCLRR")
...
impl W {
    ///Bit 0 - SRAM1LPEN
    #[inline(always)]
    pub fn sram1lpen(&mut self) -> SRAM1LPEN_W<'_, MC_MLAHBLPENCLRRrs> {
        SRAM1LPEN_W::new(self, 0)
    }
    ///Bit 1 - SRAM2LPEN
    #[inline(always)]
    pub fn sram2lpen(&mut self) -> SRAM2LPEN_W<'_, MC_MLAHBLPENCLRRrs> {
        SRAM2LPEN_W::new(self, 1)
    }
    ///Bit 2 - SRAM34LPEN
    #[inline(always)]
    pub fn sram34lpen(&mut self) -> SRAM34LPEN_W<'_, MC_MLAHBLPENCLRRrs> {
        SRAM34LPEN_W::new(self, 2)
    }
    ///Bit 4 - RETRAMLPEN
    #[inline(always)]
    pub fn retramlpen(&mut self) -> RETRAMLPEN_W<'_, MC_MLAHBLPENCLRRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`mc_mlahblpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mc_mlahblpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MC_MLAHBLPENCLRR)*/
pub struct MC_MLAHBLPENCLRRrs;
impl crate::RegisterSpec for MC_MLAHBLPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mc_mlahblpenclrr::R`](R) reader structure
impl crate::Readable for MC_MLAHBLPENCLRRrs {}
///`write(|w| ..)` method takes [`mc_mlahblpenclrr::W`](W) writer structure
impl crate::Writable for MC_MLAHBLPENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MC_MLAHBLPENCLRR to value 0x17
impl crate::Resettable for MC_MLAHBLPENCLRRrs {
