...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sram1lpen(&mut self) -> SRAM1LPEN_W<MC_MLAHBLPENSETRrs> {
        SRAM1LPEN_W::new(self, 0)
    }
    ///Bit 1 - SRAM2LPEN
    #[inline(always)]
    #[must_use]
    pub fn sram2lpen(&mut self) -> SRAM2LPEN_W<MC_MLAHBLPENSETRrs> {
        SRAM2LPEN_W::new(self, 1)
    }
    ///Bit 2 - SRAM34LPEN
    #[inline(always)]
    #[must_use]
    pub fn sram34lpen(&mut self) -> SRAM34LPEN_W<MC_MLAHBLPENSETRrs> {
        SRAM34LPEN_W::new(self, 2)
    }
    ///Bit 4 - RETRAMLPEN
    #[inline(always)]
    #[must_use]
    pub fn retramlpen(&mut self) -> RETRAMLPEN_W<MC_MLAHBLPENSETRrs> {
