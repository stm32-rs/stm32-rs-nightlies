...
impl W {
    ///Bit 0 - DMA1LPEN
    #[inline(always)]
    pub fn dma1lpen(&mut self) -> DMA1LPEN_W<MP_AHB2LPENCLRRrs> {
        DMA1LPEN_W::new(self, 0)
    }
    ///Bit 1 - DMA2LPEN
    #[inline(always)]
    pub fn dma2lpen(&mut self) -> DMA2LPEN_W<MP_AHB2LPENCLRRrs> {
        DMA2LPEN_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXLPEN
    #[inline(always)]
    pub fn dmamuxlpen(&mut self) -> DMAMUXLPEN_W<MP_AHB2LPENCLRRrs> {
        DMAMUXLPEN_W::new(self, 2)
    }
    ///Bit 5 - ADC12LPEN
    #[inline(always)]
    pub fn adc12lpen(&mut self) -> ADC12LPEN_W<MP_AHB2LPENCLRRrs> {
        ADC12LPEN_W::new(self, 5)
    }
    ///Bit 8 - USBOLPEN
    #[inline(always)]
    pub fn usbolpen(&mut self) -> USBOLPEN_W<MP_AHB2LPENCLRRrs> {
        USBOLPEN_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3LPEN
    #[inline(always)]
    pub fn sdmmc3lpen(&mut self) -> SDMMC3LPEN_W<MP_AHB2LPENCLRRrs> {
