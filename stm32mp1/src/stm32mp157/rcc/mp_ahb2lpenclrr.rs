///Register `MP_AHB2LPENCLRR` reader
pub type R = crate::R<MP_AHB2LPENCLRRrs>;
///Register `MP_AHB2LPENCLRR` writer
pub type W = crate::W<MP_AHB2LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MP_AHB2LPENCLRR")
...
impl W {
    ///Bit 0 - DMA1LPEN
    #[inline(always)]
    pub fn dma1lpen(&mut self) -> DMA1LPEN_W<'_, MP_AHB2LPENCLRRrs> {
        DMA1LPEN_W::new(self, 0)
    }
    ///Bit 1 - DMA2LPEN
    #[inline(always)]
    pub fn dma2lpen(&mut self) -> DMA2LPEN_W<'_, MP_AHB2LPENCLRRrs> {
        DMA2LPEN_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXLPEN
    #[inline(always)]
    pub fn dmamuxlpen(&mut self) -> DMAMUXLPEN_W<'_, MP_AHB2LPENCLRRrs> {
        DMAMUXLPEN_W::new(self, 2)
    }
    ///Bit 5 - ADC12LPEN
    #[inline(always)]
    pub fn adc12lpen(&mut self) -> ADC12LPEN_W<'_, MP_AHB2LPENCLRRrs> {
        ADC12LPEN_W::new(self, 5)
    }
    ///Bit 8 - USBOLPEN
    #[inline(always)]
    pub fn usbolpen(&mut self) -> USBOLPEN_W<'_, MP_AHB2LPENCLRRrs> {
        USBOLPEN_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3LPEN
    #[inline(always)]
    pub fn sdmmc3lpen(&mut self) -> SDMMC3LPEN_W<'_, MP_AHB2LPENCLRRrs> {
        SDMMC3LPEN_W::new(self, 16)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bits

You can [`read`](crate::Reg::read) this register and get [`mp_ahb2lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_ahb2lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MP_AHB2LPENCLRR)*/
pub struct MP_AHB2LPENCLRRrs;
impl crate::RegisterSpec for MP_AHB2LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_ahb2lpenclrr::R`](R) reader structure
impl crate::Readable for MP_AHB2LPENCLRRrs {}
///`write(|w| ..)` method takes [`mp_ahb2lpenclrr::W`](W) writer structure
impl crate::Writable for MP_AHB2LPENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_AHB2LPENCLRR to value 0x0001_0127
impl crate::Resettable for MP_AHB2LPENCLRRrs {
