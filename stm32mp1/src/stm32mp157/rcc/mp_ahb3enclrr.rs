///Register `MP_AHB3ENCLRR` reader
pub type R = crate::R<MP_AHB3ENCLRRrs>;
///Register `MP_AHB3ENCLRR` writer
pub type W = crate::W<MP_AHB3ENCLRRrs>;
...
impl W {
    ///Bit 0 - DCMIEN
    #[inline(always)]
    pub fn dcmien(&mut self) -> DCMIEN_W<'_, MP_AHB3ENCLRRrs> {
        DCMIEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP2EN
    #[inline(always)]
    pub fn cryp2en(&mut self) -> CRYP2EN_W<'_, MP_AHB3ENCLRRrs> {
        CRYP2EN_W::new(self, 4)
    }
    ///Bit 5 - HASH2EN
    #[inline(always)]
    pub fn hash2en(&mut self) -> HASH2EN_W<'_, MP_AHB3ENCLRRrs> {
        HASH2EN_W::new(self, 5)
    }
    ///Bit 6 - RNG2EN
    #[inline(always)]
    pub fn rng2en(&mut self) -> RNG2EN_W<'_, MP_AHB3ENCLRRrs> {
        RNG2EN_W::new(self, 6)
    }
    ///Bit 7 - CRC2EN
    #[inline(always)]
    pub fn crc2en(&mut self) -> CRC2EN_W<'_, MP_AHB3ENCLRRrs> {
        CRC2EN_W::new(self, 7)
    }
    ///Bit 11 - HSEMEN
    #[inline(always)]
    pub fn hsemen(&mut self) -> HSEMEN_W<'_, MP_AHB3ENCLRRrs> {
        HSEMEN_W::new(self, 11)
    }
    ///Bit 12 - IPCCEN
    #[inline(always)]
    pub fn ipccen(&mut self) -> IPCCEN_W<'_, MP_AHB3ENCLRRrs> {
        IPCCEN_W::new(self, 12)
    }
}
/**This register is used to clear the peripheral clock enable bit of the corresponding peripheral.

You can [`read`](crate::Reg::read) this register and get [`mp_ahb3enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_ahb3enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MP_AHB3ENCLRR)*/
pub struct MP_AHB3ENCLRRrs;
impl crate::RegisterSpec for MP_AHB3ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_ahb3enclrr::R`](R) reader structure
impl crate::Readable for MP_AHB3ENCLRRrs {}
///`write(|w| ..)` method takes [`mp_ahb3enclrr::W`](W) writer structure
impl crate::Writable for MP_AHB3ENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_AHB3ENCLRR to value 0
impl crate::Resettable for MP_AHB3ENCLRRrs {}
