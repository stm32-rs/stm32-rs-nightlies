...
impl W {
    ///Bit 0 - DCMIEN
    #[inline(always)]
    pub fn dcmien(&mut self) -> DCMIEN_W<'_, MP_AHB3ENSETRrs> {
        DCMIEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP2EN
    #[inline(always)]
    pub fn cryp2en(&mut self) -> CRYP2EN_W<'_, MP_AHB3ENSETRrs> {
        CRYP2EN_W::new(self, 4)
    }
    ///Bit 5 - HASH2EN
    #[inline(always)]
    pub fn hash2en(&mut self) -> HASH2EN_W<'_, MP_AHB3ENSETRrs> {
        HASH2EN_W::new(self, 5)
    }
    ///Bit 6 - RNG2EN
    #[inline(always)]
    pub fn rng2en(&mut self) -> RNG2EN_W<'_, MP_AHB3ENSETRrs> {
        RNG2EN_W::new(self, 6)
    }
    ///Bit 7 - CRC2EN
    #[inline(always)]
    pub fn crc2en(&mut self) -> CRC2EN_W<'_, MP_AHB3ENSETRrs> {
        CRC2EN_W::new(self, 7)
    }
    ///Bit 11 - HSEMEN
    #[inline(always)]
    pub fn hsemen(&mut self) -> HSEMEN_W<'_, MP_AHB3ENSETRrs> {
        HSEMEN_W::new(self, 11)
    }
    ///Bit 12 - IPCCEN
    #[inline(always)]
    pub fn ipccen(&mut self) -> IPCCEN_W<'_, MP_AHB3ENSETRrs> {
