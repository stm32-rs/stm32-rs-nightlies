///Register `MP_AHB3LPENCLRR` reader
pub type R = crate::R<MP_AHB3LPENCLRRrs>;
///Register `MP_AHB3LPENCLRR` writer
pub type W = crate::W<MP_AHB3LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MP_AHB3LPENCLRR")
...
impl W {
    ///Bit 0 - DCMILPEN
    #[inline(always)]
    pub fn dcmilpen(&mut self) -> DCMILPEN_W<'_, MP_AHB3LPENCLRRrs> {
        DCMILPEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP2LPEN
    #[inline(always)]
    pub fn cryp2lpen(&mut self) -> CRYP2LPEN_W<'_, MP_AHB3LPENCLRRrs> {
        CRYP2LPEN_W::new(self, 4)
    }
    ///Bit 5 - HASH2LPEN
    #[inline(always)]
    pub fn hash2lpen(&mut self) -> HASH2LPEN_W<'_, MP_AHB3LPENCLRRrs> {
        HASH2LPEN_W::new(self, 5)
    }
    ///Bit 6 - RNG2LPEN
    #[inline(always)]
    pub fn rng2lpen(&mut self) -> RNG2LPEN_W<'_, MP_AHB3LPENCLRRrs> {
        RNG2LPEN_W::new(self, 6)
    }
    ///Bit 7 - CRC2LPEN
    #[inline(always)]
    pub fn crc2lpen(&mut self) -> CRC2LPEN_W<'_, MP_AHB3LPENCLRRrs> {
        CRC2LPEN_W::new(self, 7)
    }
    ///Bit 11 - HSEMLPEN
    #[inline(always)]
    pub fn hsemlpen(&mut self) -> HSEMLPEN_W<'_, MP_AHB3LPENCLRRrs> {
        HSEMLPEN_W::new(self, 11)
    }
    ///Bit 12 - IPCCLPEN
    #[inline(always)]
    pub fn ipcclpen(&mut self) -> IPCCLPEN_W<'_, MP_AHB3LPENCLRRrs> {
        IPCCLPEN_W::new(self, 12)
    }
}
/**This register is used by the MPU in order to clear the PERxLPEN bit

You can [`read`](crate::Reg::read) this register and get [`mp_ahb3lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_ahb3lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MP_AHB3LPENCLRR)*/
pub struct MP_AHB3LPENCLRRrs;
impl crate::RegisterSpec for MP_AHB3LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_ahb3lpenclrr::R`](R) reader structure
impl crate::Readable for MP_AHB3LPENCLRRrs {}
///`write(|w| ..)` method takes [`mp_ahb3lpenclrr::W`](W) writer structure
impl crate::Writable for MP_AHB3LPENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_AHB3LPENCLRR to value 0x18f1
impl crate::Resettable for MP_AHB3LPENCLRRrs {
