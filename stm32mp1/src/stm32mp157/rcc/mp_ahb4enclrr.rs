///Register `MP_AHB4ENCLRR` reader
pub type R = crate::R<MP_AHB4ENCLRRrs>;
///Register `MP_AHB4ENCLRR` writer
pub type W = crate::W<MP_AHB4ENCLRRrs>;
...
impl W {
    ///Bit 0 - GPIOAEN
    #[inline(always)]
    pub fn gpioaen(&mut self) -> GPIOAEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOAEN_W::new(self, 0)
    }
    ///Bit 1 - GPIOBEN
    #[inline(always)]
    pub fn gpioben(&mut self) -> GPIOBEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOBEN_W::new(self, 1)
    }
    ///Bit 2 - GPIOCEN
    #[inline(always)]
    pub fn gpiocen(&mut self) -> GPIOCEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOCEN_W::new(self, 2)
    }
    ///Bit 3 - GPIODEN
    #[inline(always)]
    pub fn gpioden(&mut self) -> GPIODEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIODEN_W::new(self, 3)
    }
    ///Bit 4 - GPIOEEN
    #[inline(always)]
    pub fn gpioeen(&mut self) -> GPIOEEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOEEN_W::new(self, 4)
    }
    ///Bit 5 - GPIOFEN
    #[inline(always)]
    pub fn gpiofen(&mut self) -> GPIOFEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOFEN_W::new(self, 5)
    }
    ///Bit 6 - GPIOGEN
    #[inline(always)]
    pub fn gpiogen(&mut self) -> GPIOGEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOGEN_W::new(self, 6)
    }
    ///Bit 7 - GPIOHEN
    #[inline(always)]
    pub fn gpiohen(&mut self) -> GPIOHEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOHEN_W::new(self, 7)
    }
    ///Bit 8 - GPIOIEN
    #[inline(always)]
    pub fn gpioien(&mut self) -> GPIOIEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOIEN_W::new(self, 8)
    }
    ///Bit 9 - GPIOJEN
    #[inline(always)]
    pub fn gpiojen(&mut self) -> GPIOJEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOJEN_W::new(self, 9)
    }
    ///Bit 10 - GPIOKEN
    #[inline(always)]
    pub fn gpioken(&mut self) -> GPIOKEN_W<'_, MP_AHB4ENCLRRrs> {
        GPIOKEN_W::new(self, 10)
    }
}
/**This register is used to clear the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`mp_ahb4enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_ahb4enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MP_AHB4ENCLRR)*/
pub struct MP_AHB4ENCLRRrs;
impl crate::RegisterSpec for MP_AHB4ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_ahb4enclrr::R`](R) reader structure
impl crate::Readable for MP_AHB4ENCLRRrs {}
///`write(|w| ..)` method takes [`mp_ahb4enclrr::W`](W) writer structure
impl crate::Writable for MP_AHB4ENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_AHB4ENCLRR to value 0
impl crate::Resettable for MP_AHB4ENCLRRrs {}
