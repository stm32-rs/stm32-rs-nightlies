...
impl W {
    ///Bit 0 - GPIOAEN
    #[inline(always)]
    pub fn gpioaen(&mut self) -> GPIOAEN_W<MP_AHB4ENCLRRrs> {
        GPIOAEN_W::new(self, 0)
    }
    ///Bit 1 - GPIOBEN
    #[inline(always)]
    pub fn gpioben(&mut self) -> GPIOBEN_W<MP_AHB4ENCLRRrs> {
        GPIOBEN_W::new(self, 1)
    }
    ///Bit 2 - GPIOCEN
    #[inline(always)]
    pub fn gpiocen(&mut self) -> GPIOCEN_W<MP_AHB4ENCLRRrs> {
        GPIOCEN_W::new(self, 2)
    }
    ///Bit 3 - GPIODEN
    #[inline(always)]
    pub fn gpioden(&mut self) -> GPIODEN_W<MP_AHB4ENCLRRrs> {
        GPIODEN_W::new(self, 3)
    }
    ///Bit 4 - GPIOEEN
    #[inline(always)]
    pub fn gpioeen(&mut self) -> GPIOEEN_W<MP_AHB4ENCLRRrs> {
        GPIOEEN_W::new(self, 4)
    }
    ///Bit 5 - GPIOFEN
    #[inline(always)]
    pub fn gpiofen(&mut self) -> GPIOFEN_W<MP_AHB4ENCLRRrs> {
        GPIOFEN_W::new(self, 5)
    }
    ///Bit 6 - GPIOGEN
    #[inline(always)]
    pub fn gpiogen(&mut self) -> GPIOGEN_W<MP_AHB4ENCLRRrs> {
        GPIOGEN_W::new(self, 6)
    }
    ///Bit 7 - GPIOHEN
    #[inline(always)]
    pub fn gpiohen(&mut self) -> GPIOHEN_W<MP_AHB4ENCLRRrs> {
        GPIOHEN_W::new(self, 7)
    }
    ///Bit 8 - GPIOIEN
    #[inline(always)]
    pub fn gpioien(&mut self) -> GPIOIEN_W<MP_AHB4ENCLRRrs> {
        GPIOIEN_W::new(self, 8)
    }
    ///Bit 9 - GPIOJEN
    #[inline(always)]
    pub fn gpiojen(&mut self) -> GPIOJEN_W<MP_AHB4ENCLRRrs> {
        GPIOJEN_W::new(self, 9)
    }
    ///Bit 10 - GPIOKEN
    #[inline(always)]
    pub fn gpioken(&mut self) -> GPIOKEN_W<MP_AHB4ENCLRRrs> {
