...
impl W {
    ///Bit 0 - GPIOALPEN
    #[inline(always)]
    pub fn gpioalpen(&mut self) -> GPIOALPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIOALPEN_W::new(self, 0)
    }
    ///Bit 1 - GPIOBLPEN
    #[inline(always)]
    pub fn gpioblpen(&mut self) -> GPIOBLPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIOBLPEN_W::new(self, 1)
    }
    ///Bit 2 - GPIOCLPEN
    #[inline(always)]
    pub fn gpioclpen(&mut self) -> GPIOCLPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIOCLPEN_W::new(self, 2)
    }
    ///Bit 3 - GPIODLPEN
    #[inline(always)]
    pub fn gpiodlpen(&mut self) -> GPIODLPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIODLPEN_W::new(self, 3)
    }
    ///Bit 4 - GPIOELPEN
    #[inline(always)]
    pub fn gpioelpen(&mut self) -> GPIOELPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIOELPEN_W::new(self, 4)
    }
    ///Bit 5 - GPIOFLPEN
    #[inline(always)]
    pub fn gpioflpen(&mut self) -> GPIOFLPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIOFLPEN_W::new(self, 5)
    }
    ///Bit 6 - GPIOGLPEN
    #[inline(always)]
    pub fn gpioglpen(&mut self) -> GPIOGLPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIOGLPEN_W::new(self, 6)
    }
    ///Bit 7 - GPIOHLPEN
    #[inline(always)]
    pub fn gpiohlpen(&mut self) -> GPIOHLPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIOHLPEN_W::new(self, 7)
    }
    ///Bit 8 - GPIOILPEN
    #[inline(always)]
    pub fn gpioilpen(&mut self) -> GPIOILPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIOILPEN_W::new(self, 8)
    }
    ///Bit 9 - GPIOJLPEN
    #[inline(always)]
    pub fn gpiojlpen(&mut self) -> GPIOJLPEN_W<'_, MP_AHB4LPENSETRrs> {
        GPIOJLPEN_W::new(self, 9)
    }
    ///Bit 10 - GPIOKLPEN
    #[inline(always)]
    pub fn gpioklpen(&mut self) -> GPIOKLPEN_W<'_, MP_AHB4LPENSETRrs> {
