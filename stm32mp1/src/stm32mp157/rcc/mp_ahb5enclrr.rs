///Register `MP_AHB5ENCLRR` reader
pub type R = crate::R<MP_AHB5ENCLRRrs>;
///Register `MP_AHB5ENCLRR` writer
pub type W = crate::W<MP_AHB5ENCLRRrs>;
...
impl W {
    ///Bit 0 - GPIOZEN
    #[inline(always)]
    pub fn gpiozen(&mut self) -> GPIOZEN_W<'_, MP_AHB5ENCLRRrs> {
        GPIOZEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP1EN
    #[inline(always)]
    pub fn cryp1en(&mut self) -> CRYP1EN_W<'_, MP_AHB5ENCLRRrs> {
        CRYP1EN_W::new(self, 4)
    }
    ///Bit 5 - HASH1EN
    #[inline(always)]
    pub fn hash1en(&mut self) -> HASH1EN_W<'_, MP_AHB5ENCLRRrs> {
        HASH1EN_W::new(self, 5)
    }
    ///Bit 6 - RNG1EN
    #[inline(always)]
    pub fn rng1en(&mut self) -> RNG1EN_W<'_, MP_AHB5ENCLRRrs> {
        RNG1EN_W::new(self, 6)
    }
    ///Bit 8 - BKPSRAMEN
    #[inline(always)]
    pub fn bkpsramen(&mut self) -> BKPSRAMEN_W<'_, MP_AHB5ENCLRRrs> {
        BKPSRAMEN_W::new(self, 8)
    }
    ///Bit 16 - AXIMCEN
    #[inline(always)]
    pub fn aximcen(&mut self) -> AXIMCEN_W<'_, MP_AHB5ENCLRRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`mp_ahb5enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_ahb5enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MP_AHB5ENCLRR)*/
pub struct MP_AHB5ENCLRRrs;
impl crate::RegisterSpec for MP_AHB5ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_ahb5enclrr::R`](R) reader structure
impl crate::Readable for MP_AHB5ENCLRRrs {}
///`write(|w| ..)` method takes [`mp_ahb5enclrr::W`](W) writer structure
impl crate::Writable for MP_AHB5ENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_AHB5ENCLRR to value 0x0001_0000
impl crate::Resettable for MP_AHB5ENCLRRrs {
