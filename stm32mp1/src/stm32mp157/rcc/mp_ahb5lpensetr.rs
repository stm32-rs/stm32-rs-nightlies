///Register `MP_AHB5LPENSETR` reader
pub type R = crate::R<MP_AHB5LPENSETRrs>;
///Register `MP_AHB5LPENSETR` writer
pub type W = crate::W<MP_AHB5LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MP_AHB5LPENSETR")
...
impl W {
    ///Bit 0 - GPIOZLPEN
    #[inline(always)]
    pub fn gpiozlpen(&mut self) -> GPIOZLPEN_W<'_, MP_AHB5LPENSETRrs> {
        GPIOZLPEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP1LPEN
    #[inline(always)]
    pub fn cryp1lpen(&mut self) -> CRYP1LPEN_W<'_, MP_AHB5LPENSETRrs> {
        CRYP1LPEN_W::new(self, 4)
    }
    ///Bit 5 - HASH1LPEN
    #[inline(always)]
    pub fn hash1lpen(&mut self) -> HASH1LPEN_W<'_, MP_AHB5LPENSETRrs> {
        HASH1LPEN_W::new(self, 5)
    }
    ///Bit 6 - RNG1LPEN
    #[inline(always)]
    pub fn rng1lpen(&mut self) -> RNG1LPEN_W<'_, MP_AHB5LPENSETRrs> {
        RNG1LPEN_W::new(self, 6)
    }
    ///Bit 8 - BKPSRAMLPEN
    #[inline(always)]
    pub fn bkpsramlpen(&mut self) -> BKPSRAMLPEN_W<'_, MP_AHB5LPENSETRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`mp_ahb5lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_ahb5lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MP_AHB5LPENSETR)*/
pub struct MP_AHB5LPENSETRrs;
impl crate::RegisterSpec for MP_AHB5LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_ahb5lpensetr::R`](R) reader structure
impl crate::Readable for MP_AHB5LPENSETRrs {}
///`write(|w| ..)` method takes [`mp_ahb5lpensetr::W`](W) writer structure
impl crate::Writable for MP_AHB5LPENSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_AHB5LPENSETR to value 0x0171
impl crate::Resettable for MP_AHB5LPENSETRrs {
