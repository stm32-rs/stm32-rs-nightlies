...
impl W {
    ///Bit 0 - MDMAEN
    #[inline(always)]
    pub fn mdmaen(&mut self) -> MDMAEN_W<'_, MP_AHB6ENCLRRrs> {
        MDMAEN_W::new(self, 0)
    }
    ///Bit 5 - GPUEN
    #[inline(always)]
    pub fn gpuen(&mut self) -> GPUEN_W<'_, MP_AHB6ENCLRRrs> {
        GPUEN_W::new(self, 5)
    }
    ///Bit 7 - ETHCKEN
    #[inline(always)]
    pub fn ethcken(&mut self) -> ETHCKEN_W<'_, MP_AHB6ENCLRRrs> {
        ETHCKEN_W::new(self, 7)
    }
    ///Bit 8 - ETHTXEN
    #[inline(always)]
    pub fn ethtxen(&mut self) -> ETHTXEN_W<'_, MP_AHB6ENCLRRrs> {
        ETHTXEN_W::new(self, 8)
    }
    ///Bit 9 - ETHRXEN
    #[inline(always)]
    pub fn ethrxen(&mut self) -> ETHRXEN_W<'_, MP_AHB6ENCLRRrs> {
        ETHRXEN_W::new(self, 9)
    }
    ///Bit 10 - ETHMACEN
    #[inline(always)]
    pub fn ethmacen(&mut self) -> ETHMACEN_W<'_, MP_AHB6ENCLRRrs> {
        ETHMACEN_W::new(self, 10)
    }
    ///Bit 12 - FMCEN
    #[inline(always)]
    pub fn fmcen(&mut self) -> FMCEN_W<'_, MP_AHB6ENCLRRrs> {
        FMCEN_W::new(self, 12)
    }
    ///Bit 14 - QSPIEN
    #[inline(always)]
    pub fn qspien(&mut self) -> QSPIEN_W<'_, MP_AHB6ENCLRRrs> {
        QSPIEN_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1EN
    #[inline(always)]
    pub fn sdmmc1en(&mut self) -> SDMMC1EN_W<'_, MP_AHB6ENCLRRrs> {
        SDMMC1EN_W::new(self, 16)
    }
    ///Bit 17 - SDMMC2EN
    #[inline(always)]
    pub fn sdmmc2en(&mut self) -> SDMMC2EN_W<'_, MP_AHB6ENCLRRrs> {
        SDMMC2EN_W::new(self, 17)
    }
    ///Bit 20 - CRC1EN
    #[inline(always)]
    pub fn crc1en(&mut self) -> CRC1EN_W<'_, MP_AHB6ENCLRRrs> {
        CRC1EN_W::new(self, 20)
    }
    ///Bit 24 - USBHEN
    #[inline(always)]
    pub fn usbhen(&mut self) -> USBHEN_W<'_, MP_AHB6ENCLRRrs> {
