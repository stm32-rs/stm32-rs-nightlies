...
impl W {
    ///Bit 0 - LPTIM2EN
    #[inline(always)]
    pub fn lptim2en(&mut self) -> LPTIM2EN_W<MP_APB3ENCLRRrs> {
        LPTIM2EN_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3EN
    #[inline(always)]
    pub fn lptim3en(&mut self) -> LPTIM3EN_W<MP_APB3ENCLRRrs> {
        LPTIM3EN_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4EN
    #[inline(always)]
    pub fn lptim4en(&mut self) -> LPTIM4EN_W<MP_APB3ENCLRRrs> {
        LPTIM4EN_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5EN
    #[inline(always)]
    pub fn lptim5en(&mut self) -> LPTIM5EN_W<MP_APB3ENCLRRrs> {
        LPTIM5EN_W::new(self, 3)
    }
    ///Bit 8 - SAI4EN
    #[inline(always)]
    pub fn sai4en(&mut self) -> SAI4EN_W<MP_APB3ENCLRRrs> {
        SAI4EN_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGEN
    #[inline(always)]
    pub fn syscfgen(&mut self) -> SYSCFGEN_W<MP_APB3ENCLRRrs> {
        SYSCFGEN_W::new(self, 11)
    }
    ///Bit 13 - VREFEN
    #[inline(always)]
    pub fn vrefen(&mut self) -> VREFEN_W<MP_APB3ENCLRRrs> {
        VREFEN_W::new(self, 13)
    }
    ///Bit 16 - DTSEN
    #[inline(always)]
    pub fn dtsen(&mut self) -> DTSEN_W<MP_APB3ENCLRRrs> {
        DTSEN_W::new(self, 16)
    }
    ///Bit 20 - HDPEN
    #[inline(always)]
    pub fn hdpen(&mut self) -> HDPEN_W<MP_APB3ENCLRRrs> {
        HDPEN_W::new(self, 20)
    }
}
