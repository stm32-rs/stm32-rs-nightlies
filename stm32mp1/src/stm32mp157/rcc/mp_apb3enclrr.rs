///Register `MP_APB3ENCLRR` reader
pub type R = crate::R<MP_APB3ENCLRRrs>;
///Register `MP_APB3ENCLRR` writer
pub type W = crate::W<MP_APB3ENCLRRrs>;
...
impl W {
    ///Bit 0 - LPTIM2EN
    #[inline(always)]
    pub fn lptim2en(&mut self) -> LPTIM2EN_W<'_, MP_APB3ENCLRRrs> {
        LPTIM2EN_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3EN
    #[inline(always)]
    pub fn lptim3en(&mut self) -> LPTIM3EN_W<'_, MP_APB3ENCLRRrs> {
        LPTIM3EN_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4EN
    #[inline(always)]
    pub fn lptim4en(&mut self) -> LPTIM4EN_W<'_, MP_APB3ENCLRRrs> {
        LPTIM4EN_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5EN
    #[inline(always)]
    pub fn lptim5en(&mut self) -> LPTIM5EN_W<'_, MP_APB3ENCLRRrs> {
        LPTIM5EN_W::new(self, 3)
    }
    ///Bit 8 - SAI4EN
    #[inline(always)]
    pub fn sai4en(&mut self) -> SAI4EN_W<'_, MP_APB3ENCLRRrs> {
        SAI4EN_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGEN
    #[inline(always)]
    pub fn syscfgen(&mut self) -> SYSCFGEN_W<'_, MP_APB3ENCLRRrs> {
        SYSCFGEN_W::new(self, 11)
    }
    ///Bit 13 - VREFEN
    #[inline(always)]
    pub fn vrefen(&mut self) -> VREFEN_W<'_, MP_APB3ENCLRRrs> {
        VREFEN_W::new(self, 13)
    }
    ///Bit 16 - DTSEN
    #[inline(always)]
    pub fn dtsen(&mut self) -> DTSEN_W<'_, MP_APB3ENCLRRrs> {
        DTSEN_W::new(self, 16)
    }
    ///Bit 20 - HDPEN
    #[inline(always)]
    pub fn hdpen(&mut self) -> HDPEN_W<'_, MP_APB3ENCLRRrs> {
        HDPEN_W::new(self, 20)
    }
}
/**This register is used to clear the peripheral clock enable bit of the corresponding peripheral.

You can [`read`](crate::Reg::read) this register and get [`mp_apb3enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_apb3enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MP_APB3ENCLRR)*/
pub struct MP_APB3ENCLRRrs;
impl crate::RegisterSpec for MP_APB3ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_apb3enclrr::R`](R) reader structure
impl crate::Readable for MP_APB3ENCLRRrs {}
///`write(|w| ..)` method takes [`mp_apb3enclrr::W`](W) writer structure
impl crate::Writable for MP_APB3ENCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_APB3ENCLRR to value 0
impl crate::Resettable for MP_APB3ENCLRRrs {}
