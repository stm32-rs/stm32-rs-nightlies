...
impl W {
    ///Bit 0 - LPTIM2LPEN
    #[inline(always)]
    pub fn lptim2lpen(&mut self) -> LPTIM2LPEN_W<'_, MP_APB3LPENCLRRrs> {
        LPTIM2LPEN_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3LPEN
    #[inline(always)]
    pub fn lptim3lpen(&mut self) -> LPTIM3LPEN_W<'_, MP_APB3LPENCLRRrs> {
        LPTIM3LPEN_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4LPEN
    #[inline(always)]
    pub fn lptim4lpen(&mut self) -> LPTIM4LPEN_W<'_, MP_APB3LPENCLRRrs> {
        LPTIM4LPEN_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5LPEN
    #[inline(always)]
    pub fn lptim5lpen(&mut self) -> LPTIM5LPEN_W<'_, MP_APB3LPENCLRRrs> {
        LPTIM5LPEN_W::new(self, 3)
    }
    ///Bit 8 - SAI4LPEN
    #[inline(always)]
    pub fn sai4lpen(&mut self) -> SAI4LPEN_W<'_, MP_APB3LPENCLRRrs> {
        SAI4LPEN_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGLPEN
    #[inline(always)]
    pub fn syscfglpen(&mut self) -> SYSCFGLPEN_W<'_, MP_APB3LPENCLRRrs> {
        SYSCFGLPEN_W::new(self, 11)
    }
    ///Bit 13 - VREFLPEN
    #[inline(always)]
    pub fn vreflpen(&mut self) -> VREFLPEN_W<'_, MP_APB3LPENCLRRrs> {
        VREFLPEN_W::new(self, 13)
    }
    ///Bit 16 - DTSLPEN
    #[inline(always)]
    pub fn dtslpen(&mut self) -> DTSLPEN_W<'_, MP_APB3LPENCLRRrs> {
