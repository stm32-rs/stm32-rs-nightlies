...
impl W {
    ///Bit 0 - LTDCEN
    #[inline(always)]
    pub fn ltdcen(&mut self) -> LTDCEN_W<MP_APB4ENCLRRrs> {
        LTDCEN_W::new(self, 0)
    }
    ///Bit 4 - DSIEN
    #[inline(always)]
    pub fn dsien(&mut self) -> DSIEN_W<MP_APB4ENCLRRrs> {
        DSIEN_W::new(self, 4)
    }
    ///Bit 8 - DDRPERFMEN
    #[inline(always)]
    pub fn ddrperfmen(&mut self) -> DDRPERFMEN_W<MP_APB4ENCLRRrs> {
        DDRPERFMEN_W::new(self, 8)
    }
    ///Bit 15 - IWDG2APBEN
    #[inline(always)]
    pub fn iwdg2apben(&mut self) -> IWDG2APBEN_W<MP_APB4ENCLRRrs> {
        IWDG2APBEN_W::new(self, 15)
    }
    ///Bit 16 - USBPHYEN
    #[inline(always)]
    pub fn usbphyen(&mut self) -> USBPHYEN_W<MP_APB4ENCLRRrs> {
        USBPHYEN_W::new(self, 16)
    }
    ///Bit 20 - STGENROEN
    #[inline(always)]
    pub fn stgenroen(&mut self) -> STGENROEN_W<MP_APB4ENCLRRrs> {
