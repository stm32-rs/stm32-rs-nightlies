...
impl W {
    ///Bit 0 - SPI6LPEN
    #[inline(always)]
    pub fn spi6lpen(&mut self) -> SPI6LPEN_W<MP_APB5LPENCLRRrs> {
        SPI6LPEN_W::new(self, 0)
    }
    ///Bit 2 - I2C4LPEN
    #[inline(always)]
    pub fn i2c4lpen(&mut self) -> I2C4LPEN_W<MP_APB5LPENCLRRrs> {
        I2C4LPEN_W::new(self, 2)
    }
    ///Bit 3 - I2C6LPEN
    #[inline(always)]
    pub fn i2c6lpen(&mut self) -> I2C6LPEN_W<MP_APB5LPENCLRRrs> {
        I2C6LPEN_W::new(self, 3)
    }
    ///Bit 4 - USART1LPEN
    #[inline(always)]
    pub fn usart1lpen(&mut self) -> USART1LPEN_W<MP_APB5LPENCLRRrs> {
        USART1LPEN_W::new(self, 4)
    }
    ///Bit 8 - RTCAPBLPEN
    #[inline(always)]
    pub fn rtcapblpen(&mut self) -> RTCAPBLPEN_W<MP_APB5LPENCLRRrs> {
        RTCAPBLPEN_W::new(self, 8)
    }
    ///Bit 11 - TZC1LPEN
    #[inline(always)]
    pub fn tzc1lpen(&mut self) -> TZC1LPEN_W<MP_APB5LPENCLRRrs> {
        TZC1LPEN_W::new(self, 11)
    }
    ///Bit 12 - TZC2LPEN
    #[inline(always)]
    pub fn tzc2lpen(&mut self) -> TZC2LPEN_W<MP_APB5LPENCLRRrs> {
        TZC2LPEN_W::new(self, 12)
    }
    ///Bit 13 - TZPCLPEN
    #[inline(always)]
    pub fn tzpclpen(&mut self) -> TZPCLPEN_W<MP_APB5LPENCLRRrs> {
        TZPCLPEN_W::new(self, 13)
    }
    ///Bit 15 - IWDG1APBLPEN
    #[inline(always)]
    pub fn iwdg1apblpen(&mut self) -> IWDG1APBLPEN_W<MP_APB5LPENCLRRrs> {
        IWDG1APBLPEN_W::new(self, 15)
    }
    ///Bit 16 - BSECLPEN
    #[inline(always)]
    pub fn bseclpen(&mut self) -> BSECLPEN_W<MP_APB5LPENCLRRrs> {
        BSECLPEN_W::new(self, 16)
    }
    ///Bit 20 - STGENLPEN
    #[inline(always)]
    pub fn stgenlpen(&mut self) -> STGENLPEN_W<MP_APB5LPENCLRRrs> {
        STGENLPEN_W::new(self, 20)
    }
    ///Bit 21 - STGENSTPEN
    #[inline(always)]
    pub fn stgenstpen(&mut self) -> STGENSTPEN_W<MP_APB5LPENCLRRrs> {
