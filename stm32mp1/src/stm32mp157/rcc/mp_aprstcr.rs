...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdctlen(&mut self) -> RDCTLEN_W<MP_APRSTCRrs> {
        RDCTLEN_W::new(self, 0)
    }
    ///Bits 8:14 - RSTTO
    #[inline(always)]
    #[must_use]
    pub fn rstto(&mut self) -> RSTTO_W<MP_APRSTCRrs> {
        RSTTO_W::new(self, 8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MP_APRSTCR)*/
