...
impl W {
    ///Bit 0 - LSIRDYF
    #[inline(always)]
    pub fn lsirdyf(&mut self) -> LSIRDYF_W<MP_CIFRrs> {
        LSIRDYF_W::new(self, 0)
    }
    ///Bit 1 - LSERDYF
    #[inline(always)]
    pub fn lserdyf(&mut self) -> LSERDYF_W<MP_CIFRrs> {
        LSERDYF_W::new(self, 1)
    }
    ///Bit 2 - HSIRDYF
    #[inline(always)]
    pub fn hsirdyf(&mut self) -> HSIRDYF_W<MP_CIFRrs> {
        HSIRDYF_W::new(self, 2)
    }
    ///Bit 3 - HSERDYF
    #[inline(always)]
    pub fn hserdyf(&mut self) -> HSERDYF_W<MP_CIFRrs> {
        HSERDYF_W::new(self, 3)
    }
    ///Bit 4 - CSIRDYF
    #[inline(always)]
    pub fn csirdyf(&mut self) -> CSIRDYF_W<MP_CIFRrs> {
        CSIRDYF_W::new(self, 4)
    }
    ///Bit 8 - PLL1DYF
    #[inline(always)]
    pub fn pll1dyf(&mut self) -> PLL1DYF_W<MP_CIFRrs> {
        PLL1DYF_W::new(self, 8)
    }
    ///Bit 9 - PLL2DYF
    #[inline(always)]
    pub fn pll2dyf(&mut self) -> PLL2DYF_W<MP_CIFRrs> {
        PLL2DYF_W::new(self, 9)
    }
    ///Bit 10 - PLL3DYF
    #[inline(always)]
    pub fn pll3dyf(&mut self) -> PLL3DYF_W<MP_CIFRrs> {
        PLL3DYF_W::new(self, 10)
    }
    ///Bit 11 - PLL4DYF
    #[inline(always)]
    pub fn pll4dyf(&mut self) -> PLL4DYF_W<MP_CIFRrs> {
        PLL4DYF_W::new(self, 11)
    }
    ///Bit 16 - LSECSSF
    #[inline(always)]
    pub fn lsecssf(&mut self) -> LSECSSF_W<MP_CIFRrs> {
        LSECSSF_W::new(self, 16)
    }
    ///Bit 20 - WKUPF
    #[inline(always)]
    pub fn wkupf(&mut self) -> WKUPF_W<MP_CIFRrs> {
        WKUPF_W::new(self, 20)
    }
}
