...
impl W {
    ///Bit 0 - MPSYSRST
    #[inline(always)]
    pub fn mpsysrst(&mut self) -> MPSYSRST_W<MP_GRSTCSETRrs> {
        MPSYSRST_W::new(self, 0)
    }
    ///Bit 1 - MCURST
    #[inline(always)]
    pub fn mcurst(&mut self) -> MCURST_W<MP_GRSTCSETRrs> {
        MCURST_W::new(self, 1)
    }
    ///Bit 4 - MPUP0RST
    #[inline(always)]
    pub fn mpup0rst(&mut self) -> MPUP0RST_W<MP_GRSTCSETRrs> {
        MPUP0RST_W::new(self, 4)
    }
    ///Bit 5 - MPUP1RST
    #[inline(always)]
    pub fn mpup1rst(&mut self) -> MPUP1RST_W<MP_GRSTCSETRrs> {
