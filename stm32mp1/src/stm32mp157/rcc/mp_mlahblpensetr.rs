///Register `MP_MLAHBLPENSETR` reader
pub type R = crate::R<MP_MLAHBLPENSETRrs>;
///Register `MP_MLAHBLPENSETR` writer
pub type W = crate::W<MP_MLAHBLPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MP_MLAHBLPENSETR")
...
impl W {
    ///Bit 0 - SRAM1LPEN
    #[inline(always)]
    pub fn sram1lpen(&mut self) -> SRAM1LPEN_W<'_, MP_MLAHBLPENSETRrs> {
        SRAM1LPEN_W::new(self, 0)
    }
    ///Bit 1 - SRAM2LPEN
    #[inline(always)]
    pub fn sram2lpen(&mut self) -> SRAM2LPEN_W<'_, MP_MLAHBLPENSETRrs> {
        SRAM2LPEN_W::new(self, 1)
    }
    ///Bit 2 - SRAM34LPEN
    #[inline(always)]
    pub fn sram34lpen(&mut self) -> SRAM34LPEN_W<'_, MP_MLAHBLPENSETRrs> {
        SRAM34LPEN_W::new(self, 2)
    }
    ///Bit 4 - RETRAMLPEN
    #[inline(always)]
    pub fn retramlpen(&mut self) -> RETRAMLPEN_W<'_, MP_MLAHBLPENSETRrs> {
        RETRAMLPEN_W::new(self, 4)
    }
}
/**This register is used by the MPU in order to set the PERxLPEN bit

You can [`read`](crate::Reg::read) this register and get [`mp_mlahblpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mp_mlahblpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:MP_MLAHBLPENSETR)*/
pub struct MP_MLAHBLPENSETRrs;
impl crate::RegisterSpec for MP_MLAHBLPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`mp_mlahblpensetr::R`](R) reader structure
impl crate::Readable for MP_MLAHBLPENSETRrs {}
///`write(|w| ..)` method takes [`mp_mlahblpensetr::W`](W) writer structure
impl crate::Writable for MP_MLAHBLPENSETRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MP_MLAHBLPENSETR to value 0x17
impl crate::Resettable for MP_MLAHBLPENSETRrs {
