...
impl W {
    ///Bit 0 - PORRSTF
    #[inline(always)]
    pub fn porrstf(&mut self) -> PORRSTF_W<'_, MP_RSTSCLRRrs> {
        PORRSTF_W::new(self, 0)
    }
    ///Bit 1 - BORRSTF
    #[inline(always)]
    pub fn borrstf(&mut self) -> BORRSTF_W<'_, MP_RSTSCLRRrs> {
        BORRSTF_W::new(self, 1)
    }
    ///Bit 2 - PADRSTF
    #[inline(always)]
    pub fn padrstf(&mut self) -> PADRSTF_W<'_, MP_RSTSCLRRrs> {
        PADRSTF_W::new(self, 2)
    }
    ///Bit 3 - HCSSRSTF
    #[inline(always)]
    pub fn hcssrstf(&mut self) -> HCSSRSTF_W<'_, MP_RSTSCLRRrs> {
        HCSSRSTF_W::new(self, 3)
    }
    ///Bit 4 - VCORERSTF
    #[inline(always)]
    pub fn vcorerstf(&mut self) -> VCORERSTF_W<'_, MP_RSTSCLRRrs> {
        VCORERSTF_W::new(self, 4)
    }
    ///Bit 6 - MPSYSRSTF
    #[inline(always)]
    pub fn mpsysrstf(&mut self) -> MPSYSRSTF_W<'_, MP_RSTSCLRRrs> {
        MPSYSRSTF_W::new(self, 6)
    }
    ///Bit 7 - MCSYSRSTF
    #[inline(always)]
    pub fn mcsysrstf(&mut self) -> MCSYSRSTF_W<'_, MP_RSTSCLRRrs> {
        MCSYSRSTF_W::new(self, 7)
    }
    ///Bit 8 - IWDG1RSTF
    #[inline(always)]
    pub fn iwdg1rstf(&mut self) -> IWDG1RSTF_W<'_, MP_RSTSCLRRrs> {
        IWDG1RSTF_W::new(self, 8)
    }
    ///Bit 9 - IWDG2RSTF
    #[inline(always)]
    pub fn iwdg2rstf(&mut self) -> IWDG2RSTF_W<'_, MP_RSTSCLRRrs> {
        IWDG2RSTF_W::new(self, 9)
    }
    ///Bit 11 - STDBYRSTF
    #[inline(always)]
    pub fn stdbyrstf(&mut self) -> STDBYRSTF_W<'_, MP_RSTSCLRRrs> {
        STDBYRSTF_W::new(self, 11)
    }
    ///Bit 12 - CSTDBYRSTF
    #[inline(always)]
    pub fn cstdbyrstf(&mut self) -> CSTDBYRSTF_W<'_, MP_RSTSCLRRrs> {
        CSTDBYRSTF_W::new(self, 12)
    }
    ///Bit 13 - MPUP0RSTF
    #[inline(always)]
    pub fn mpup0rstf(&mut self) -> MPUP0RSTF_W<'_, MP_RSTSCLRRrs> {
        MPUP0RSTF_W::new(self, 13)
    }
    ///Bit 14 - MPUP1RSTF
    #[inline(always)]
    pub fn mpup1rstf(&mut self) -> MPUP1RSTF_W<'_, MP_RSTSCLRRrs> {
        MPUP1RSTF_W::new(self, 14)
    }
    ///Bit 15 - SPARE
    #[inline(always)]
    pub fn spare(&mut self) -> SPARE_W<'_, MP_RSTSCLRRrs> {
        SPARE_W::new(self, 15)
    }
}
