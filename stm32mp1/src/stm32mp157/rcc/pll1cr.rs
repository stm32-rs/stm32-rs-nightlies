///Register `PLL1CR` reader
pub type R = crate::R<PLL1CRrs>;
///Register `PLL1CR` writer
pub type W = crate::W<PLL1CRrs>;
...
impl W {
    ///Bit 0 - PLLON
    #[inline(always)]
    pub fn pllon(&mut self) -> PLLON_W<'_, PLL1CRrs> {
        PLLON_W::new(self, 0)
    }
    ///Bit 2 - SSCG_CTRL
    #[inline(always)]
    pub fn sscg_ctrl(&mut self) -> SSCG_CTRL_W<'_, PLL1CRrs> {
        SSCG_CTRL_W::new(self, 2)
    }
    ///Bit 4 - DIVPEN
    #[inline(always)]
    pub fn divpen(&mut self) -> DIVPEN_W<'_, PLL1CRrs> {
        DIVPEN_W::new(self, 4)
    }
    ///Bit 5 - DIVQEN
    #[inline(always)]
    pub fn divqen(&mut self) -> DIVQEN_W<'_, PLL1CRrs> {
        DIVQEN_W::new(self, 5)
    }
    ///Bit 6 - DIVREN
    #[inline(always)]
    pub fn divren(&mut self) -> DIVREN_W<'_, PLL1CRrs> {
        DIVREN_W::new(self, 6)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`pll1cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll1cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:PLL1CR)*/
pub struct PLL1CRrs;
impl crate::RegisterSpec for PLL1CRrs {
    type Ux = u32;
}
///`read()` method returns [`pll1cr::R`](R) reader structure
impl crate::Readable for PLL1CRrs {}
///`write(|w| ..)` method takes [`pll1cr::W`](W) writer structure
impl crate::Writable for PLL1CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PLL1CR to value 0
impl crate::Resettable for PLL1CRrs {}
