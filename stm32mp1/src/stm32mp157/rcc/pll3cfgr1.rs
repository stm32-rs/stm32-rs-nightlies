...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn divn(&mut self) -> DIVN_W<PLL3CFGR1rs> {
        DIVN_W::new(self, 0)
    }
    ///Bits 16:21 - DIVM3
    #[inline(always)]
    #[must_use]
    pub fn divm3(&mut self) -> DIVM3_W<PLL3CFGR1rs> {
        DIVM3_W::new(self, 16)
    }
    ///Bits 24:25 - IFRGE
    #[inline(always)]
    #[must_use]
    pub fn ifrge(&mut self) -> IFRGE_W<PLL3CFGR1rs> {
        IFRGE_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:PLL3CFGR1)*/
