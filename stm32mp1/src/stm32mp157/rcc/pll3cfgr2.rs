...
impl W {
    ///Bits 0:6 - DIVP
    #[inline(always)]
    pub fn divp(&mut self) -> DIVP_W<'_, PLL3CFGR2rs> {
        DIVP_W::new(self, 0)
    }
    ///Bits 8:14 - DIVQ
    #[inline(always)]
    pub fn divq(&mut self) -> DIVQ_W<'_, PLL3CFGR2rs> {
        DIVQ_W::new(self, 8)
    }
    ///Bits 16:22 - DIVR
    #[inline(always)]
    pub fn divr(&mut self) -> DIVR_W<'_, PLL3CFGR2rs> {
        DIVR_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:PLL3CFGR2)*/
