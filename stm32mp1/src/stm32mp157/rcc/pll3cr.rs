...
impl W {
    ///Bit 0 - PLLON
    #[inline(always)]
    pub fn pllon(&mut self) -> PLLON_W<'_, PLL3CRrs> {
        PLLON_W::new(self, 0)
    }
    ///Bit 2 - SSCG_CTRL
    #[inline(always)]
    pub fn sscg_ctrl(&mut self) -> SSCG_CTRL_W<'_, PLL3CRrs> {
        SSCG_CTRL_W::new(self, 2)
    }
    ///Bit 4 - DIVPEN
    #[inline(always)]
    pub fn divpen(&mut self) -> DIVPEN_W<'_, PLL3CRrs> {
        DIVPEN_W::new(self, 4)
    }
    ///Bit 5 - DIVQEN
    #[inline(always)]
    pub fn divqen(&mut self) -> DIVQEN_W<'_, PLL3CRrs> {
        DIVQEN_W::new(self, 5)
    }
    ///Bit 6 - DIVREN
    #[inline(always)]
    pub fn divren(&mut self) -> DIVREN_W<'_, PLL3CRrs> {
        DIVREN_W::new(self, 6)
    }
}
