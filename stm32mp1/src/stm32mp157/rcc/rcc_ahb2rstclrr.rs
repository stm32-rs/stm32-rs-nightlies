///Register `RCC_AHB2RSTCLRR` reader
pub type R = crate::R<RCC_AHB2RSTCLRRrs>;
///Register `RCC_AHB2RSTCLRR` writer
pub type W = crate::W<RCC_AHB2RSTCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_AHB2RSTCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma1rst(&mut self) -> DMA1RST_W<RCC_AHB2RSTCLRRrs> {
        DMA1RST_W::new(self, 0)
    }
    ///Bit 1 - DMA2RST
    #[inline(always)]
    #[must_use]
    pub fn dma2rst(&mut self) -> DMA2RST_W<RCC_AHB2RSTCLRRrs> {
        DMA2RST_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXRST
    #[inline(always)]
    #[must_use]
    pub fn dmamuxrst(&mut self) -> DMAMUXRST_W<RCC_AHB2RSTCLRRrs> {
        DMAMUXRST_W::new(self, 2)
    }
    ///Bit 5 - ADC12RST
    #[inline(always)]
    #[must_use]
    pub fn adc12rst(&mut self) -> ADC12RST_W<RCC_AHB2RSTCLRRrs> {
        ADC12RST_W::new(self, 5)
    }
    ///Bit 8 - USBORST
    #[inline(always)]
    #[must_use]
    pub fn usborst(&mut self) -> USBORST_W<RCC_AHB2RSTCLRRrs> {
        USBORST_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3RST
    #[inline(always)]
    #[must_use]
    pub fn sdmmc3rst(&mut self) -> SDMMC3RST_W<RCC_AHB2RSTCLRRrs> {
        SDMMC3RST_W::new(self, 16)
    }
}
/**This register is used to release the reset of the corresponding peripheral.

You can [`read`](crate::Reg::read) this register and get [`rcc_ahb2rstclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_ahb2rstclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_AHB2RSTCLRR)*/
pub struct RCC_AHB2RSTCLRRrs;
impl crate::RegisterSpec for RCC_AHB2RSTCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_ahb2rstclrr::R`](R) reader structure
impl crate::Readable for RCC_AHB2RSTCLRRrs {}
///`write(|w| ..)` method takes [`rcc_ahb2rstclrr::W`](W) writer structure
impl crate::Writable for RCC_AHB2RSTCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_AHB2RSTCLRR to value 0
impl crate::Resettable for RCC_AHB2RSTCLRRrs {
