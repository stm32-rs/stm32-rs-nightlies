///Register `RCC_APB3RSTSETR` reader
pub type R = crate::R<RCC_APB3RSTSETRrs>;
///Register `RCC_APB3RSTSETR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_APB3RSTSETR")
...
///`read()` method returns [`rcc_apb3rstsetr::R`](R) reader structure
impl crate::Readable for RCC_APB3RSTSETRrs {}
///`write(|w| ..)` method takes [`rcc_apb3rstsetr::W`](W) writer structure
impl crate::Writable for RCC_APB3RSTSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_APB3RSTSETR to value 0
