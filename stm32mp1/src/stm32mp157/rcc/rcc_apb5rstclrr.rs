///Register `RCC_APB5RSTCLRR` reader
pub type R = crate::R<RCC_APB5RSTCLRRrs>;
///Register `RCC_APB5RSTCLRR` writer
pub type W = crate::W<RCC_APB5RSTCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_APB5RSTCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi6rst(&mut self) -> SPI6RST_W<RCC_APB5RSTCLRRrs> {
        SPI6RST_W::new(self, 0)
    }
    ///Bit 2 - I2C4RST
    #[inline(always)]
    #[must_use]
    pub fn i2c4rst(&mut self) -> I2C4RST_W<RCC_APB5RSTCLRRrs> {
        I2C4RST_W::new(self, 2)
    }
    ///Bit 3 - I2C6RST
    #[inline(always)]
    #[must_use]
    pub fn i2c6rst(&mut self) -> I2C6RST_W<RCC_APB5RSTCLRRrs> {
        I2C6RST_W::new(self, 3)
    }
    ///Bit 4 - USART1RST
    #[inline(always)]
    #[must_use]
    pub fn usart1rst(&mut self) -> USART1RST_W<RCC_APB5RSTCLRRrs> {
        USART1RST_W::new(self, 4)
    }
    ///Bit 20 - STGENRST
    #[inline(always)]
    #[must_use]
    pub fn stgenrst(&mut self) -> STGENRST_W<RCC_APB5RSTCLRRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`rcc_apb5rstclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_apb5rstclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_APB5RSTCLRR)*/
pub struct RCC_APB5RSTCLRRrs;
impl crate::RegisterSpec for RCC_APB5RSTCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_apb5rstclrr::R`](R) reader structure
impl crate::Readable for RCC_APB5RSTCLRRrs {}
///`write(|w| ..)` method takes [`rcc_apb5rstclrr::W`](W) writer structure
impl crate::Writable for RCC_APB5RSTCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_APB5RSTCLRR to value 0
impl crate::Resettable for RCC_APB5RSTCLRRrs {
