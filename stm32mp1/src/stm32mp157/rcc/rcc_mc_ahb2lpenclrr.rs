...
pub type R = crate::R<RCC_MC_AHB2LPENCLRRrs>;
///Register `RCC_MC_AHB2LPENCLRR` writer
pub type W = crate::W<RCC_MC_AHB2LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_AHB2LPENCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma1lpen(&mut self) -> DMA1LPEN_W<RCC_MC_AHB2LPENCLRRrs> {
        DMA1LPEN_W::new(self, 0)
    }
    ///Bit 1 - DMA2LPEN
    #[inline(always)]
    #[must_use]
    pub fn dma2lpen(&mut self) -> DMA2LPEN_W<RCC_MC_AHB2LPENCLRRrs> {
        DMA2LPEN_W::new(self, 1)
    }
    ///Bit 2 - DMAMUXLPEN
    #[inline(always)]
    #[must_use]
    pub fn dmamuxlpen(&mut self) -> DMAMUXLPEN_W<RCC_MC_AHB2LPENCLRRrs> {
        DMAMUXLPEN_W::new(self, 2)
    }
    ///Bit 5 - ADC12LPEN
    #[inline(always)]
    #[must_use]
    pub fn adc12lpen(&mut self) -> ADC12LPEN_W<RCC_MC_AHB2LPENCLRRrs> {
        ADC12LPEN_W::new(self, 5)
    }
    ///Bit 8 - USBOLPEN
    #[inline(always)]
    #[must_use]
    pub fn usbolpen(&mut self) -> USBOLPEN_W<RCC_MC_AHB2LPENCLRRrs> {
        USBOLPEN_W::new(self, 8)
    }
    ///Bit 16 - SDMMC3LPEN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc3lpen(&mut self) -> SDMMC3LPEN_W<RCC_MC_AHB2LPENCLRRrs> {
...
pub struct RCC_MC_AHB2LPENCLRRrs;
impl crate::RegisterSpec for RCC_MC_AHB2LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_ahb2lpenclrr::R`](R) reader structure
impl crate::Readable for RCC_MC_AHB2LPENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mc_ahb2lpenclrr::W`](W) writer structure
impl crate::Writable for RCC_MC_AHB2LPENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_AHB2LPENCLRR to value 0x0001_0127
impl crate::Resettable for RCC_MC_AHB2LPENCLRRrs {
