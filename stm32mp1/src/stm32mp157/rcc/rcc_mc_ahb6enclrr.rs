...
pub type R = crate::R<RCC_MC_AHB6ENCLRRrs>;
///Register `RCC_MC_AHB6ENCLRR` writer
pub type W = crate::W<RCC_MC_AHB6ENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_AHB6ENCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdmaen(&mut self) -> MDMAEN_W<RCC_MC_AHB6ENCLRRrs> {
        MDMAEN_W::new(self, 0)
    }
    ///Bit 5 - GPUEN
    #[inline(always)]
    #[must_use]
    pub fn gpuen(&mut self) -> GPUEN_W<RCC_MC_AHB6ENCLRRrs> {
        GPUEN_W::new(self, 5)
    }
    ///Bit 7 - ETHCKEN
    #[inline(always)]
    #[must_use]
    pub fn ethcken(&mut self) -> ETHCKEN_W<RCC_MC_AHB6ENCLRRrs> {
        ETHCKEN_W::new(self, 7)
    }
    ///Bit 8 - ETHTXEN
    #[inline(always)]
    #[must_use]
    pub fn ethtxen(&mut self) -> ETHTXEN_W<RCC_MC_AHB6ENCLRRrs> {
        ETHTXEN_W::new(self, 8)
    }
    ///Bit 9 - ETHRXEN
    #[inline(always)]
    #[must_use]
    pub fn ethrxen(&mut self) -> ETHRXEN_W<RCC_MC_AHB6ENCLRRrs> {
        ETHRXEN_W::new(self, 9)
    }
    ///Bit 10 - ETHMACEN
    #[inline(always)]
    #[must_use]
    pub fn ethmacen(&mut self) -> ETHMACEN_W<RCC_MC_AHB6ENCLRRrs> {
        ETHMACEN_W::new(self, 10)
    }
    ///Bit 12 - FMCEN
    #[inline(always)]
    #[must_use]
    pub fn fmcen(&mut self) -> FMCEN_W<RCC_MC_AHB6ENCLRRrs> {
        FMCEN_W::new(self, 12)
    }
    ///Bit 14 - QSPIEN
    #[inline(always)]
    #[must_use]
    pub fn qspien(&mut self) -> QSPIEN_W<RCC_MC_AHB6ENCLRRrs> {
        QSPIEN_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1EN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc1en(&mut self) -> SDMMC1EN_W<RCC_MC_AHB6ENCLRRrs> {
        SDMMC1EN_W::new(self, 16)
    }
    ///Bit 17 - SDMMC2EN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc2en(&mut self) -> SDMMC2EN_W<RCC_MC_AHB6ENCLRRrs> {
        SDMMC2EN_W::new(self, 17)
    }
    ///Bit 20 - CRC1EN
    #[inline(always)]
    #[must_use]
    pub fn crc1en(&mut self) -> CRC1EN_W<RCC_MC_AHB6ENCLRRrs> {
        CRC1EN_W::new(self, 20)
    }
    ///Bit 24 - USBHEN
    #[inline(always)]
    #[must_use]
    pub fn usbhen(&mut self) -> USBHEN_W<RCC_MC_AHB6ENCLRRrs> {
        USBHEN_W::new(self, 24)
    }
}
/**This register is used to clear the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mc_ahb6enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_ahb6enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_MC_AHB6ENCLRR)*/
pub struct RCC_MC_AHB6ENCLRRrs;
impl crate::RegisterSpec for RCC_MC_AHB6ENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_ahb6enclrr::R`](R) reader structure
impl crate::Readable for RCC_MC_AHB6ENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mc_ahb6enclrr::W`](W) writer structure
impl crate::Writable for RCC_MC_AHB6ENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_AHB6ENCLRR to value 0
impl crate::Resettable for RCC_MC_AHB6ENCLRRrs {
