///Register `RCC_MC_AHB6LPENSETR` reader
pub type R = crate::R<RCC_MC_AHB6LPENSETRrs>;
///Register `RCC_MC_AHB6LPENSETR` writer
pub type W = crate::W<RCC_MC_AHB6LPENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_AHB6LPENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdmalpen(&mut self) -> MDMALPEN_W<RCC_MC_AHB6LPENSETRrs> {
        MDMALPEN_W::new(self, 0)
    }
    ///Bit 5 - GPULPEN
    #[inline(always)]
    #[must_use]
    pub fn gpulpen(&mut self) -> GPULPEN_W<RCC_MC_AHB6LPENSETRrs> {
        GPULPEN_W::new(self, 5)
    }
    ///Bit 7 - ETHCKLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethcklpen(&mut self) -> ETHCKLPEN_W<RCC_MC_AHB6LPENSETRrs> {
        ETHCKLPEN_W::new(self, 7)
    }
    ///Bit 8 - ETHTXLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethtxlpen(&mut self) -> ETHTXLPEN_W<RCC_MC_AHB6LPENSETRrs> {
        ETHTXLPEN_W::new(self, 8)
    }
    ///Bit 9 - ETHRXLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethrxlpen(&mut self) -> ETHRXLPEN_W<RCC_MC_AHB6LPENSETRrs> {
        ETHRXLPEN_W::new(self, 9)
    }
    ///Bit 10 - ETHMACLPEN
    #[inline(always)]
    #[must_use]
    pub fn ethmaclpen(&mut self) -> ETHMACLPEN_W<RCC_MC_AHB6LPENSETRrs> {
        ETHMACLPEN_W::new(self, 10)
    }
    ///Bit 11 - ETHSTPEN
    #[inline(always)]
    #[must_use]
    pub fn ethstpen(&mut self) -> ETHSTPEN_W<RCC_MC_AHB6LPENSETRrs> {
        ETHSTPEN_W::new(self, 11)
    }
    ///Bit 12 - FMCLPEN
    #[inline(always)]
    #[must_use]
    pub fn fmclpen(&mut self) -> FMCLPEN_W<RCC_MC_AHB6LPENSETRrs> {
        FMCLPEN_W::new(self, 12)
    }
    ///Bit 14 - QSPILPEN
    #[inline(always)]
    #[must_use]
    pub fn qspilpen(&mut self) -> QSPILPEN_W<RCC_MC_AHB6LPENSETRrs> {
        QSPILPEN_W::new(self, 14)
    }
    ///Bit 16 - SDMMC1LPEN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc1lpen(&mut self) -> SDMMC1LPEN_W<RCC_MC_AHB6LPENSETRrs> {
        SDMMC1LPEN_W::new(self, 16)
    }
    ///Bit 17 - SDMMC2LPEN
    #[inline(always)]
    #[must_use]
    pub fn sdmmc2lpen(&mut self) -> SDMMC2LPEN_W<RCC_MC_AHB6LPENSETRrs> {
        SDMMC2LPEN_W::new(self, 17)
    }
    ///Bit 20 - CRC1LPEN
    #[inline(always)]
    #[must_use]
    pub fn crc1lpen(&mut self) -> CRC1LPEN_W<RCC_MC_AHB6LPENSETRrs> {
        CRC1LPEN_W::new(self, 20)
    }
    ///Bit 24 - USBHLPEN
    #[inline(always)]
    #[must_use]
    pub fn usbhlpen(&mut self) -> USBHLPEN_W<RCC_MC_AHB6LPENSETRrs> {
        USBHLPEN_W::new(self, 24)
    }
}
/**This register is used by the MCU in order to set the PERxLPEN bit.

You can [`read`](crate::Reg::read) this register and get [`rcc_mc_ahb6lpensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_ahb6lpensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_MC_AHB6LPENSETR)*/
pub struct RCC_MC_AHB6LPENSETRrs;
impl crate::RegisterSpec for RCC_MC_AHB6LPENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_ahb6lpensetr::R`](R) reader structure
impl crate::Readable for RCC_MC_AHB6LPENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mc_ahb6lpensetr::W`](W) writer structure
impl crate::Writable for RCC_MC_AHB6LPENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_AHB6LPENSETR to value 0x0113_57a1
impl crate::Resettable for RCC_MC_AHB6LPENSETRrs {
