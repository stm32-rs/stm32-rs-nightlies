///Register `RCC_MC_APB3ENCLRR` reader
pub type R = crate::R<RCC_MC_APB3ENCLRRrs>;
///Register `RCC_MC_APB3ENCLRR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_APB3ENCLRR")
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mc_apb3enclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_apb3enclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`rcc_mc_apb3enclrr::R`](R) reader structure
impl crate::Readable for RCC_MC_APB3ENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mc_apb3enclrr::W`](W) writer structure
impl crate::Writable for RCC_MC_APB3ENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_APB3ENCLRR to value 0
