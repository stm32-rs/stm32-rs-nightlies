...
pub type R = crate::R<RCC_MC_APB4ENSETRrs>;
///Register `RCC_MC_APB4ENSETR` writer
pub type W = crate::W<RCC_MC_APB4ENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_APB4ENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ltdcen(&mut self) -> LTDCEN_W<RCC_MC_APB4ENSETRrs> {
        LTDCEN_W::new(self, 0)
    }
    ///Bit 4 - DSIEN
    #[inline(always)]
    #[must_use]
    pub fn dsien(&mut self) -> DSIEN_W<RCC_MC_APB4ENSETRrs> {
        DSIEN_W::new(self, 4)
    }
    ///Bit 8 - DDRPERFMEN
    #[inline(always)]
    #[must_use]
    pub fn ddrperfmen(&mut self) -> DDRPERFMEN_W<RCC_MC_APB4ENSETRrs> {
        DDRPERFMEN_W::new(self, 8)
    }
    ///Bit 16 - USBPHYEN
    #[inline(always)]
    #[must_use]
    pub fn usbphyen(&mut self) -> USBPHYEN_W<RCC_MC_APB4ENSETRrs> {
        USBPHYEN_W::new(self, 16)
    }
    ///Bit 20 - STGENROEN
    #[inline(always)]
    #[must_use]
    pub fn stgenroen(&mut self) -> STGENROEN_W<RCC_MC_APB4ENSETRrs> {
        STGENROEN_W::new(self, 20)
    }
}
/**This register is used to set the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mc_apb4ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_apb4ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_MC_APB4ENSETR)*/
pub struct RCC_MC_APB4ENSETRrs;
impl crate::RegisterSpec for RCC_MC_APB4ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_apb4ensetr::R`](R) reader structure
impl crate::Readable for RCC_MC_APB4ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mc_apb4ensetr::W`](W) writer structure
impl crate::Writable for RCC_MC_APB4ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_APB4ENSETR to value 0
impl crate::Resettable for RCC_MC_APB4ENSETRrs {
