///Register `RCC_MC_APB4LPENCLRR` reader
pub type R = crate::R<RCC_MC_APB4LPENCLRRrs>;
///Register `RCC_MC_APB4LPENCLRR` writer
pub type W = crate::W<RCC_MC_APB4LPENCLRRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MC_APB4LPENCLRR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ltdclpen(&mut self) -> LTDCLPEN_W<RCC_MC_APB4LPENCLRRrs> {
        LTDCLPEN_W::new(self, 0)
    }
    ///Bit 4 - DSILPEN
    #[inline(always)]
    #[must_use]
    pub fn dsilpen(&mut self) -> DSILPEN_W<RCC_MC_APB4LPENCLRRrs> {
        DSILPEN_W::new(self, 4)
    }
    ///Bit 8 - DDRPERFMLPEN
    #[inline(always)]
    #[must_use]
    pub fn ddrperfmlpen(&mut self) -> DDRPERFMLPEN_W<RCC_MC_APB4LPENCLRRrs> {
        DDRPERFMLPEN_W::new(self, 8)
    }
    ///Bit 16 - USBPHYLPEN
    #[inline(always)]
    #[must_use]
    pub fn usbphylpen(&mut self) -> USBPHYLPEN_W<RCC_MC_APB4LPENCLRRrs> {
        USBPHYLPEN_W::new(self, 16)
    }
    ///Bit 20 - STGENROLPEN
    #[inline(always)]
    #[must_use]
    pub fn stgenrolpen(&mut self) -> STGENROLPEN_W<RCC_MC_APB4LPENCLRRrs> {
        STGENROLPEN_W::new(self, 20)
    }
    ///Bit 21 - STGENROSTPEN
    #[inline(always)]
    #[must_use]
    pub fn stgenrostpen(&mut self) -> STGENROSTPEN_W<RCC_MC_APB4LPENCLRRrs> {
        STGENROSTPEN_W::new(self, 21)
    }
}
/**This register is used by the MCU in order to clear the PERxLPEN bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mc_apb4lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mc_apb4lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_MC_APB4LPENCLRR)*/
pub struct RCC_MC_APB4LPENCLRRrs;
impl crate::RegisterSpec for RCC_MC_APB4LPENCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mc_apb4lpenclrr::R`](R) reader structure
impl crate::Readable for RCC_MC_APB4LPENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mc_apb4lpenclrr::W`](W) writer structure
impl crate::Writable for RCC_MC_APB4LPENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MC_APB4LPENCLRR to value 0x0011_0111
impl crate::Resettable for RCC_MC_APB4LPENCLRRrs {
