...
#[doc = "This register is used by the MPU in order to set the PERxLPEN bit.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rcc_mp_ahb2lpensetr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rcc_mp_ahb2lpensetr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
