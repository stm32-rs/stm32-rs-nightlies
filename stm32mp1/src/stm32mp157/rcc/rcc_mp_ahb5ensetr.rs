...
pub type R = crate::R<RCC_MP_AHB5ENSETRrs>;
///Register `RCC_MP_AHB5ENSETR` writer
pub type W = crate::W<RCC_MP_AHB5ENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_AHB5ENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpiozen(&mut self) -> GPIOZEN_W<RCC_MP_AHB5ENSETRrs> {
        GPIOZEN_W::new(self, 0)
    }
    ///Bit 4 - CRYP1EN
    #[inline(always)]
    #[must_use]
    pub fn cryp1en(&mut self) -> CRYP1EN_W<RCC_MP_AHB5ENSETRrs> {
        CRYP1EN_W::new(self, 4)
    }
    ///Bit 5 - HASH1EN
    #[inline(always)]
    #[must_use]
    pub fn hash1en(&mut self) -> HASH1EN_W<RCC_MP_AHB5ENSETRrs> {
        HASH1EN_W::new(self, 5)
    }
    ///Bit 6 - RNG1EN
    #[inline(always)]
    #[must_use]
    pub fn rng1en(&mut self) -> RNG1EN_W<RCC_MP_AHB5ENSETRrs> {
        RNG1EN_W::new(self, 6)
    }
    ///Bit 8 - BKPSRAMEN
    #[inline(always)]
    #[must_use]
    pub fn bkpsramen(&mut self) -> BKPSRAMEN_W<RCC_MP_AHB5ENSETRrs> {
        BKPSRAMEN_W::new(self, 8)
    }
    ///Bit 16 - AXIMCEN
    #[inline(always)]
    #[must_use]
    pub fn aximcen(&mut self) -> AXIMCEN_W<RCC_MP_AHB5ENSETRrs> {
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_ahb5ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_ahb5ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_MP_AHB5ENSETR)*/
pub struct RCC_MP_AHB5ENSETRrs;
impl crate::RegisterSpec for RCC_MP_AHB5ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_ahb5ensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_AHB5ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_ahb5ensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_AHB5ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_AHB5ENSETR to value 0x0001_0000
impl crate::Resettable for RCC_MP_AHB5ENSETRrs {
