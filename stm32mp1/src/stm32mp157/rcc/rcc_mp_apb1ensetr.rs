///Register `RCC_MP_APB1ENSETR` reader
pub type R = crate::R<RCC_MP_APB1ENSETRrs>;
///Register `RCC_MP_APB1ENSETR` writer
pub type W = crate::W<RCC_MP_APB1ENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_APB1ENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim2en(&mut self) -> TIM2EN_W<RCC_MP_APB1ENSETRrs> {
        TIM2EN_W::new(self, 0)
    }
    ///Bit 1 - TIM3EN
    #[inline(always)]
    #[must_use]
    pub fn tim3en(&mut self) -> TIM3EN_W<RCC_MP_APB1ENSETRrs> {
        TIM3EN_W::new(self, 1)
    }
    ///Bit 2 - TIM4EN
    #[inline(always)]
    #[must_use]
    pub fn tim4en(&mut self) -> TIM4EN_W<RCC_MP_APB1ENSETRrs> {
        TIM4EN_W::new(self, 2)
    }
    ///Bit 3 - TIM5EN
    #[inline(always)]
    #[must_use]
    pub fn tim5en(&mut self) -> TIM5EN_W<RCC_MP_APB1ENSETRrs> {
        TIM5EN_W::new(self, 3)
    }
    ///Bit 4 - TIM6EN
    #[inline(always)]
    #[must_use]
    pub fn tim6en(&mut self) -> TIM6EN_W<RCC_MP_APB1ENSETRrs> {
        TIM6EN_W::new(self, 4)
    }
    ///Bit 5 - TIM7EN
    #[inline(always)]
    #[must_use]
    pub fn tim7en(&mut self) -> TIM7EN_W<RCC_MP_APB1ENSETRrs> {
        TIM7EN_W::new(self, 5)
    }
    ///Bit 6 - TIM12EN
    #[inline(always)]
    #[must_use]
    pub fn tim12en(&mut self) -> TIM12EN_W<RCC_MP_APB1ENSETRrs> {
        TIM12EN_W::new(self, 6)
    }
    ///Bit 7 - TIM13EN
    #[inline(always)]
    #[must_use]
    pub fn tim13en(&mut self) -> TIM13EN_W<RCC_MP_APB1ENSETRrs> {
        TIM13EN_W::new(self, 7)
    }
    ///Bit 8 - TIM14EN
    #[inline(always)]
    #[must_use]
    pub fn tim14en(&mut self) -> TIM14EN_W<RCC_MP_APB1ENSETRrs> {
        TIM14EN_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1EN
    #[inline(always)]
    #[must_use]
    pub fn lptim1en(&mut self) -> LPTIM1EN_W<RCC_MP_APB1ENSETRrs> {
        LPTIM1EN_W::new(self, 9)
    }
    ///Bit 11 - SPI2EN
    #[inline(always)]
    #[must_use]
    pub fn spi2en(&mut self) -> SPI2EN_W<RCC_MP_APB1ENSETRrs> {
        SPI2EN_W::new(self, 11)
    }
    ///Bit 12 - SPI3EN
    #[inline(always)]
    #[must_use]
    pub fn spi3en(&mut self) -> SPI3EN_W<RCC_MP_APB1ENSETRrs> {
        SPI3EN_W::new(self, 12)
    }
    ///Bit 14 - USART2EN
    #[inline(always)]
    #[must_use]
    pub fn usart2en(&mut self) -> USART2EN_W<RCC_MP_APB1ENSETRrs> {
        USART2EN_W::new(self, 14)
    }
    ///Bit 15 - USART3EN
    #[inline(always)]
    #[must_use]
    pub fn usart3en(&mut self) -> USART3EN_W<RCC_MP_APB1ENSETRrs> {
        USART3EN_W::new(self, 15)
    }
    ///Bit 16 - UART4EN
    #[inline(always)]
    #[must_use]
    pub fn uart4en(&mut self) -> UART4EN_W<RCC_MP_APB1ENSETRrs> {
        UART4EN_W::new(self, 16)
    }
    ///Bit 17 - UART5EN
    #[inline(always)]
    #[must_use]
    pub fn uart5en(&mut self) -> UART5EN_W<RCC_MP_APB1ENSETRrs> {
        UART5EN_W::new(self, 17)
    }
    ///Bit 18 - UART7EN
    #[inline(always)]
    #[must_use]
    pub fn uart7en(&mut self) -> UART7EN_W<RCC_MP_APB1ENSETRrs> {
        UART7EN_W::new(self, 18)
    }
    ///Bit 19 - UART8EN
    #[inline(always)]
    #[must_use]
    pub fn uart8en(&mut self) -> UART8EN_W<RCC_MP_APB1ENSETRrs> {
        UART8EN_W::new(self, 19)
    }
    ///Bit 21 - I2C1EN
    #[inline(always)]
    #[must_use]
    pub fn i2c1en(&mut self) -> I2C1EN_W<RCC_MP_APB1ENSETRrs> {
        I2C1EN_W::new(self, 21)
    }
    ///Bit 22 - I2C2EN
    #[inline(always)]
    #[must_use]
    pub fn i2c2en(&mut self) -> I2C2EN_W<RCC_MP_APB1ENSETRrs> {
        I2C2EN_W::new(self, 22)
    }
    ///Bit 23 - I2C3EN
    #[inline(always)]
    #[must_use]
    pub fn i2c3en(&mut self) -> I2C3EN_W<RCC_MP_APB1ENSETRrs> {
        I2C3EN_W::new(self, 23)
    }
    ///Bit 24 - I2C5EN
    #[inline(always)]
    #[must_use]
    pub fn i2c5en(&mut self) -> I2C5EN_W<RCC_MP_APB1ENSETRrs> {
        I2C5EN_W::new(self, 24)
    }
    ///Bit 26 - SPDIFEN
    #[inline(always)]
    #[must_use]
    pub fn spdifen(&mut self) -> SPDIFEN_W<RCC_MP_APB1ENSETRrs> {
        SPDIFEN_W::new(self, 26)
    }
    ///Bit 27 - CECEN
    #[inline(always)]
    #[must_use]
    pub fn cecen(&mut self) -> CECEN_W<RCC_MP_APB1ENSETRrs> {
        CECEN_W::new(self, 27)
    }
    ///Bit 29 - DAC12EN
    #[inline(always)]
    #[must_use]
    pub fn dac12en(&mut self) -> DAC12EN_W<RCC_MP_APB1ENSETRrs> {
        DAC12EN_W::new(self, 29)
    }
    ///Bit 31 - MDIOSEN
    #[inline(always)]
    #[must_use]
    pub fn mdiosen(&mut self) -> MDIOSEN_W<RCC_MP_APB1ENSETRrs> {
        MDIOSEN_W::new(self, 31)
    }
}
/**This register is used to set the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mp_apb1ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_apb1ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_MP_APB1ENSETR)*/
pub struct RCC_MP_APB1ENSETRrs;
impl crate::RegisterSpec for RCC_MP_APB1ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_apb1ensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_APB1ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_apb1ensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_APB1ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_APB1ENSETR to value 0
impl crate::Resettable for RCC_MP_APB1ENSETRrs {
