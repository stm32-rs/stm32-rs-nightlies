///Register `RCC_MP_APB2LPENCLRR` reader
pub type R = crate::R<RCC_MP_APB2LPENCLRRrs>;
///Register `RCC_MP_APB2LPENCLRR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_APB2LPENCLRR")
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_apb2lpenclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_apb2lpenclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`rcc_mp_apb2lpenclrr::R`](R) reader structure
impl crate::Readable for RCC_MP_APB2LPENCLRRrs {}
///`write(|w| ..)` method takes [`rcc_mp_apb2lpenclrr::W`](W) writer structure
impl crate::Writable for RCC_MP_APB2LPENCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_APB2LPENCLRR to value 0x0137_271f
