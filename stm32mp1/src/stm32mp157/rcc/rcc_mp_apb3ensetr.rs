...
pub type R = crate::R<RCC_MP_APB3ENSETRrs>;
///Register `RCC_MP_APB3ENSETR` writer
pub type W = crate::W<RCC_MP_APB3ENSETRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCC_MP_APB3ENSETR")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lptim2en(&mut self) -> LPTIM2EN_W<RCC_MP_APB3ENSETRrs> {
        LPTIM2EN_W::new(self, 0)
    }
    ///Bit 1 - LPTIM3EN
    #[inline(always)]
    #[must_use]
    pub fn lptim3en(&mut self) -> LPTIM3EN_W<RCC_MP_APB3ENSETRrs> {
        LPTIM3EN_W::new(self, 1)
    }
    ///Bit 2 - LPTIM4EN
    #[inline(always)]
    #[must_use]
    pub fn lptim4en(&mut self) -> LPTIM4EN_W<RCC_MP_APB3ENSETRrs> {
        LPTIM4EN_W::new(self, 2)
    }
    ///Bit 3 - LPTIM5EN
    #[inline(always)]
    #[must_use]
    pub fn lptim5en(&mut self) -> LPTIM5EN_W<RCC_MP_APB3ENSETRrs> {
        LPTIM5EN_W::new(self, 3)
    }
    ///Bit 8 - SAI4EN
    #[inline(always)]
    #[must_use]
    pub fn sai4en(&mut self) -> SAI4EN_W<RCC_MP_APB3ENSETRrs> {
        SAI4EN_W::new(self, 8)
    }
    ///Bit 11 - SYSCFGEN
    #[inline(always)]
    #[must_use]
    pub fn syscfgen(&mut self) -> SYSCFGEN_W<RCC_MP_APB3ENSETRrs> {
        SYSCFGEN_W::new(self, 11)
    }
    ///Bit 13 - VREFEN
    #[inline(always)]
    #[must_use]
    pub fn vrefen(&mut self) -> VREFEN_W<RCC_MP_APB3ENSETRrs> {
        VREFEN_W::new(self, 13)
    }
    ///Bit 16 - DTSEN
    #[inline(always)]
    #[must_use]
    pub fn dtsen(&mut self) -> DTSEN_W<RCC_MP_APB3ENSETRrs> {
        DTSEN_W::new(self, 16)
    }
    ///Bit 20 - HDPEN
    #[inline(always)]
    #[must_use]
    pub fn hdpen(&mut self) -> HDPEN_W<RCC_MP_APB3ENSETRrs> {
        HDPEN_W::new(self, 20)
    }
}
/**This register is used to set the peripheral clock enable bit

You can [`read`](crate::Reg::read) this register and get [`rcc_mp_apb3ensetr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_apb3ensetr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_MP_APB3ENSETR)*/
pub struct RCC_MP_APB3ENSETRrs;
impl crate::RegisterSpec for RCC_MP_APB3ENSETRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_apb3ensetr::R`](R) reader structure
impl crate::Readable for RCC_MP_APB3ENSETRrs {}
///`write(|w| ..)` method takes [`rcc_mp_apb3ensetr::W`](W) writer structure
impl crate::Writable for RCC_MP_APB3ENSETRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_APB3ENSETR to value 0
impl crate::Resettable for RCC_MP_APB3ENSETRrs {
