...
pub type R = crate::R<RCC_MP_CIERrs>;
///Register `RCC_MP_CIER` writer
pub type W = crate::W<RCC_MP_CIERrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lsirdyie(&mut self) -> LSIRDYIE_W<RCC_MP_CIERrs> {
        LSIRDYIE_W::new(self, 0)
    }
    ///Bit 1 - LSERDYIE
    #[inline(always)]
    #[must_use]
    pub fn lserdyie(&mut self) -> LSERDYIE_W<RCC_MP_CIERrs> {
        LSERDYIE_W::new(self, 1)
    }
    ///Bit 2 - HSIRDYIE
    #[inline(always)]
    #[must_use]
    pub fn hsirdyie(&mut self) -> HSIRDYIE_W<RCC_MP_CIERrs> {
        HSIRDYIE_W::new(self, 2)
    }
    ///Bit 3 - HSERDYIE
    #[inline(always)]
    #[must_use]
    pub fn hserdyie(&mut self) -> HSERDYIE_W<RCC_MP_CIERrs> {
        HSERDYIE_W::new(self, 3)
    }
    ///Bit 4 - CSIRDYIE
    #[inline(always)]
    #[must_use]
    pub fn csirdyie(&mut self) -> CSIRDYIE_W<RCC_MP_CIERrs> {
        CSIRDYIE_W::new(self, 4)
    }
    ///Bit 8 - PLL1DYIE
    #[inline(always)]
    #[must_use]
    pub fn pll1dyie(&mut self) -> PLL1DYIE_W<RCC_MP_CIERrs> {
        PLL1DYIE_W::new(self, 8)
    }
    ///Bit 9 - PLL2DYIE
    #[inline(always)]
    #[must_use]
    pub fn pll2dyie(&mut self) -> PLL2DYIE_W<RCC_MP_CIERrs> {
        PLL2DYIE_W::new(self, 9)
    }
    ///Bit 10 - PLL3DYIE
    #[inline(always)]
    #[must_use]
    pub fn pll3dyie(&mut self) -> PLL3DYIE_W<RCC_MP_CIERrs> {
        PLL3DYIE_W::new(self, 10)
    }
    ///Bit 11 - PLL4DYIE
    #[inline(always)]
    #[must_use]
    pub fn pll4dyie(&mut self) -> PLL4DYIE_W<RCC_MP_CIERrs> {
        PLL4DYIE_W::new(self, 11)
    }
    ///Bit 16 - LSECSSIE
    #[inline(always)]
    #[must_use]
    pub fn lsecssie(&mut self) -> LSECSSIE_W<RCC_MP_CIERrs> {
        LSECSSIE_W::new(self, 16)
    }
    ///Bit 20 - WKUPIE
    #[inline(always)]
    #[must_use]
    pub fn wkupie(&mut self) -> WKUPIE_W<RCC_MP_CIERrs> {
...
You can [`read`](crate::Reg::read) this register and get [`rcc_mp_cier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_mp_cier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_MP_CIER)*/
pub struct RCC_MP_CIERrs;
impl crate::RegisterSpec for RCC_MP_CIERrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_mp_cier::R`](R) reader structure
impl crate::Readable for RCC_MP_CIERrs {}
///`write(|w| ..)` method takes [`rcc_mp_cier::W`](W) writer structure
impl crate::Writable for RCC_MP_CIERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_MP_CIER to value 0
impl crate::Resettable for RCC_MP_CIERrs {
