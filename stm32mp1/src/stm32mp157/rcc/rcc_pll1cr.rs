///Register `RCC_PLL1CR` reader
pub type R = crate::R<RCC_PLL1CRrs>;
///Register `RCC_PLL1CR` writer
...
You can [`read`](crate::Reg::read) this register and get [`rcc_pll1cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_pll1cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`rcc_pll1cr::R`](R) reader structure
impl crate::Readable for RCC_PLL1CRrs {}
///`write(|w| ..)` method takes [`rcc_pll1cr::W`](W) writer structure
impl crate::Writable for RCC_PLL1CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_PLL1CR to value 0
