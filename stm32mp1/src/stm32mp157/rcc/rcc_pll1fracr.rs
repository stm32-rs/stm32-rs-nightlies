#[doc = "Reader of register RCC_PLL1FRACR"]
pub type R = crate::R<u32, super::RCC_PLL1FRACR>;
#[doc = "Writer for register RCC_PLL1FRACR"]
pub type W = crate::W<u32, super::RCC_PLL1FRACR>;
#[doc = "Register RCC_PLL1FRACR `reset()`'s with value 0"]
impl crate::ResetValue for super::RCC_PLL1FRACR {
    type Type = u32;
    #[inline(always)]
