...
pub type R = crate::R<RCC_PLL4CFGR2rs>;
///Register `RCC_PLL4CFGR2` writer
pub type W = crate::W<RCC_PLL4CFGR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn divp(&mut self) -> DIVP_W<RCC_PLL4CFGR2rs> {
        DIVP_W::new(self, 0)
    }
    ///Bits 8:14 - DIVQ
    #[inline(always)]
    #[must_use]
    pub fn divq(&mut self) -> DIVQ_W<RCC_PLL4CFGR2rs> {
        DIVQ_W::new(self, 8)
    }
    ///Bits 16:22 - DIVR
    #[inline(always)]
    #[must_use]
    pub fn divr(&mut self) -> DIVR_W<RCC_PLL4CFGR2rs> {
        DIVR_W::new(self, 16)
    }
}
/**This register is used to configure the PLL4.

You can [`read`](crate::Reg::read) this register and get [`rcc_pll4cfgr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_pll4cfgr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RCC:RCC_PLL4CFGR2)*/
pub struct RCC_PLL4CFGR2rs;
impl crate::RegisterSpec for RCC_PLL4CFGR2rs {
    type Ux = u32;
}
///`read()` method returns [`rcc_pll4cfgr2::R`](R) reader structure
impl crate::Readable for RCC_PLL4CFGR2rs {}
///`write(|w| ..)` method takes [`rcc_pll4cfgr2::W`](W) writer structure
impl crate::Writable for RCC_PLL4CFGR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_PLL4CFGR2 to value 0
impl crate::Resettable for RCC_PLL4CFGR2rs {
