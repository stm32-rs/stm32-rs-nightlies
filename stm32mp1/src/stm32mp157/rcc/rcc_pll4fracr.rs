#[doc = "Reader of register RCC_PLL4FRACR"]
pub type R = crate::R<u32, super::RCC_PLL4FRACR>;
#[doc = "Writer for register RCC_PLL4FRACR"]
pub type W = crate::W<u32, super::RCC_PLL4FRACR>;
#[doc = "Register RCC_PLL4FRACR `reset()`'s with value 0"]
impl crate::ResetValue for super::RCC_PLL4FRACR {
    type Type = u32;
    #[inline(always)]
