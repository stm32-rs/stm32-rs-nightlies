...
You can [`read`](crate::Reg::read) this register and get [`rcc_verr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`rcc_verr::R`](R) reader structure
impl crate::Readable for RCC_VERRrs {}
///`reset()` method sets RCC_VERR to value 0x11
