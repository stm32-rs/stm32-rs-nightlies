...
impl W {
    ///Bit 0 - LSION
    #[inline(always)]
    pub fn lsion(&mut self) -> LSION_W<RDLSICRrs> {
        LSION_W::new(self, 0)
    }
    ///Bits 16:20 - MRD
    #[inline(always)]
    pub fn mrd(&mut self) -> MRD_W<RDLSICRrs> {
        MRD_W::new(self, 16)
    }
    ///Bits 24:26 - EADLY
    #[inline(always)]
    pub fn eadly(&mut self) -> EADLY_W<RDLSICRrs> {
        EADLY_W::new(self, 24)
    }
    ///Bits 27:31 - SPARE
    #[inline(always)]
    pub fn spare(&mut self) -> SPARE_W<RDLSICRrs> {
        SPARE_W::new(self, 27)
    }
}
