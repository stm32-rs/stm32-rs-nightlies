...
///Field `CALM` reader - CALM
pub type CALM_R = crate::FieldReader<u16>;
///Field `CALM` writer - CALM
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RTC:CALR)*/
pub struct CALRrs;
