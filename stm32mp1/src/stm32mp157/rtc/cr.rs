...
///Field `ALRIE(A,B)` reader - ALR%sIE
...
///Field `ALRIE(A,B)` writer - ALR%sIE
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#RTC:CR)*/
pub struct CRrs;
