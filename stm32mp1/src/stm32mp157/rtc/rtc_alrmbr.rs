#[doc = "Reader of register RTC_ALRMBR"]
pub type R = crate::R<u32, super::RTC_ALRMBR>;
#[doc = "Writer for register RTC_ALRMBR"]
pub type W = crate::W<u32, super::RTC_ALRMBR>;
#[doc = "Register RTC_ALRMBR `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_ALRMBR {
    type Type = u32;
    #[inline(always)]
