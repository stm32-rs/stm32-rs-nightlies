#[doc = "Reader of register RTC_ALRMBSSR"]
pub type R = crate::R<u32, super::RTC_ALRMBSSR>;
#[doc = "Writer for register RTC_ALRMBSSR"]
pub type W = crate::W<u32, super::RTC_ALRMBSSR>;
#[doc = "Register RTC_ALRMBSSR `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_ALRMBSSR {
    type Type = u32;
    #[inline(always)]
