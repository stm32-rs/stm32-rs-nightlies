...
pub struct R(crate::R<RTC_MISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_MISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_MISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_MISR_SPEC>) -> Self {
        R(reader)
    }
}
