#[doc = "Register `RTC_SMCR` reader"]
pub struct R(crate::R<RTC_SMCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_SMCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_SMCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_SMCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_SMCR` writer"]
pub struct W(crate::W<RTC_SMCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_SMCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_SMCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_SMCR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "This register can be written only when the APB access is secure.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_smcr](index.html) module"]
pub struct RTC_SMCR_SPEC;
impl crate::RegisterSpec for RTC_SMCR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_smcr::R](R) reader structure"]
impl crate::Readable for RTC_SMCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_smcr::W](W) writer structure"]
impl crate::Writable for RTC_SMCR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_SMCR to value 0xe00f"]
impl crate::Resettable for RTC_SMCR_SPEC {
    #[inline(always)]
