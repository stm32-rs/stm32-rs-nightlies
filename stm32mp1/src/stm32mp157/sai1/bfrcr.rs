...
impl W {
    ///Bits 0:7 - FRL
    #[inline(always)]
    pub fn frl(&mut self) -> FRL_W<BFRCRrs> {
        FRL_W::new(self, 0)
    }
    ///Bits 8:14 - FSALL
    #[inline(always)]
    pub fn fsall(&mut self) -> FSALL_W<BFRCRrs> {
        FSALL_W::new(self, 8)
    }
    ///Bit 16 - FSDEF
    #[inline(always)]
    pub fn fsdef(&mut self) -> FSDEF_W<BFRCRrs> {
        FSDEF_W::new(self, 16)
    }
    ///Bit 17 - FSPOL
    #[inline(always)]
    pub fn fspol(&mut self) -> FSPOL_W<BFRCRrs> {
        FSPOL_W::new(self, 17)
    }
    ///Bit 18 - FSOFF
    #[inline(always)]
    pub fn fsoff(&mut self) -> FSOFF_W<BFRCRrs> {
        FSOFF_W::new(self, 18)
    }
}
