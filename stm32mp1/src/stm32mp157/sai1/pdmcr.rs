...
///Field `PDMEN` reader - PDMEN
pub type PDMEN_R = crate::BitReader;
///Field `PDMEN` writer - PDMEN
...
///Field `CKEN1` reader - CKEN1
pub type CKEN1_R = crate::BitReader;
///Field `CKEN1` writer - CKEN1
...
impl W {
    ...
    ///Bit 8 - CKEN1
    #[inline(always)]
    pub fn cken1(&mut self) -> CKEN1_W<'_, PDMCRrs> {
        CKEN1_W::new(self, 8)
    }
    ///Bit 9 - CKEN2
    #[inline(always)]
    pub fn cken2(&mut self) -> CKEN2_W<'_, PDMCRrs> {
        CKEN2_W::new(self, 9)
    }
    ///Bit 10 - CKEN3
    #[inline(always)]
    pub fn cken3(&mut self) -> CKEN3_W<'_, PDMCRrs> {
        CKEN3_W::new(self, 10)
    }
    ///Bit 11 - CKEN4
    #[inline(always)]
    pub fn cken4(&mut self) -> CKEN4_W<'_, PDMCRrs> {
        CKEN4_W::new(self, 11)
    }
}
