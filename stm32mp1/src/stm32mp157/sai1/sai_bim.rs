///Register `SAI_BIM` reader
pub type R = crate::R<SAI_BIMrs>;
///Register `SAI_BIM` writer
...
///`read()` method returns [`sai_bim::R`](R) reader structure
impl crate::Readable for SAI_BIMrs {}
///`write(|w| ..)` method takes [`sai_bim::W`](W) writer structure
impl crate::Writable for SAI_BIMrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAI_BIM to value 0
