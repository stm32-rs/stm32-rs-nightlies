...
You can [`read`](crate::Reg::read) this register and get [`sai_sidr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`sai_sidr::R`](R) reader structure
impl crate::Readable for SAI_SIDRrs {}
///`reset()` method sets SAI_SIDR to value 0xa3c5_dd01
