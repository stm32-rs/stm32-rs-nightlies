...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPDIFRX_FMT0_DR")
            .field("dr", &self.dr())
            .field("pe", &self.pe())
            .field("v", &self.v())
            .field("u", &self.u())
...
You can [`read`](crate::Reg::read) this register and get [`spdifrx_fmt0_dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
