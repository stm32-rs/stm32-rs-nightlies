...
impl W {
    ///Bit 0 - AXI_M0
    #[inline(always)]
    pub fn axi_m0(&mut self) -> AXI_M0_W<ICNRrs> {
        AXI_M0_W::new(self, 0)
    }
    ///Bit 1 - AXI_M1
    #[inline(always)]
    pub fn axi_m1(&mut self) -> AXI_M1_W<ICNRrs> {
        AXI_M1_W::new(self, 1)
    }
    ///Bit 2 - AXI_M2
    #[inline(always)]
    pub fn axi_m2(&mut self) -> AXI_M2_W<ICNRrs> {
        AXI_M2_W::new(self, 2)
    }
    ///Bit 3 - AXI_M3
    #[inline(always)]
    pub fn axi_m3(&mut self) -> AXI_M3_W<ICNRrs> {
        AXI_M3_W::new(self, 3)
    }
    ///Bit 5 - AXI_M5
    #[inline(always)]
    pub fn axi_m5(&mut self) -> AXI_M5_W<ICNRrs> {
        AXI_M5_W::new(self, 5)
    }
    ///Bit 6 - AXI_M6
    #[inline(always)]
    pub fn axi_m6(&mut self) -> AXI_M6_W<ICNRrs> {
        AXI_M6_W::new(self, 6)
    }
    ///Bit 7 - AXI_M7
    #[inline(always)]
    pub fn axi_m7(&mut self) -> AXI_M7_W<ICNRrs> {
        AXI_M7_W::new(self, 7)
    }
    ///Bit 8 - AXI_M8
    #[inline(always)]
    pub fn axi_m8(&mut self) -> AXI_M8_W<ICNRrs> {
        AXI_M8_W::new(self, 8)
    }
    ///Bit 9 - AXI_M9
    #[inline(always)]
    pub fn axi_m9(&mut self) -> AXI_M9_W<ICNRrs> {
        AXI_M9_W::new(self, 9)
    }
    ///Bit 10 - AXI_M10
    #[inline(always)]
    pub fn axi_m10(&mut self) -> AXI_M10_W<ICNRrs> {
