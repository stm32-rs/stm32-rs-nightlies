///Register `PMCCLRR` reader
pub type R = crate::R<PMCCLRRrs>;
///Register `PMCCLRR` writer
pub type W = crate::W<PMCCLRRrs>;
...
impl W {
    ///Bit 0 - I2C1_FMP
    #[inline(always)]
    pub fn i2c1_fmp(&mut self) -> I2C1_FMP_W<'_, PMCCLRRrs> {
        I2C1_FMP_W::new(self, 0)
    }
    ///Bit 1 - I2C2_FMP
    #[inline(always)]
    pub fn i2c2_fmp(&mut self) -> I2C2_FMP_W<'_, PMCCLRRrs> {
        I2C2_FMP_W::new(self, 1)
    }
    ///Bit 2 - I2C3_FMP
    #[inline(always)]
    pub fn i2c3_fmp(&mut self) -> I2C3_FMP_W<'_, PMCCLRRrs> {
        I2C3_FMP_W::new(self, 2)
    }
    ///Bit 3 - I2C4_FMP
    #[inline(always)]
    pub fn i2c4_fmp(&mut self) -> I2C4_FMP_W<'_, PMCCLRRrs> {
        I2C4_FMP_W::new(self, 3)
    }
    ///Bit 4 - I2C5_FMP
    #[inline(always)]
    pub fn i2c5_fmp(&mut self) -> I2C5_FMP_W<'_, PMCCLRRrs> {
        I2C5_FMP_W::new(self, 4)
    }
    ///Bit 5 - I2C6_FMP
    #[inline(always)]
    pub fn i2c6_fmp(&mut self) -> I2C6_FMP_W<'_, PMCCLRRrs> {
        I2C6_FMP_W::new(self, 5)
    }
    ///Bit 8 - EN_BOOSTER
    #[inline(always)]
    pub fn en_booster(&mut self) -> EN_BOOSTER_W<'_, PMCCLRRrs> {
        EN_BOOSTER_W::new(self, 8)
    }
    ///Bit 9 - ANASWVDD
    #[inline(always)]
    pub fn anaswvdd(&mut self) -> ANASWVDD_W<'_, PMCCLRRrs> {
        ANASWVDD_W::new(self, 9)
    }
    ///Bit 16 - ETH_CLK_SEL
    #[inline(always)]
    pub fn eth_clk_sel(&mut self) -> ETH_CLK_SEL_W<'_, PMCCLRRrs> {
        ETH_CLK_SEL_W::new(self, 16)
    }
    ///Bit 17 - ETH_REF_CLK_SEL
    #[inline(always)]
    pub fn eth_ref_clk_sel(&mut self) -> ETH_REF_CLK_SEL_W<'_, PMCCLRRrs> {
        ETH_REF_CLK_SEL_W::new(self, 17)
    }
    ///Bit 20 - ETH_SELMII
    #[inline(always)]
    pub fn eth_selmii(&mut self) -> ETH_SELMII_W<'_, PMCCLRRrs> {
        ETH_SELMII_W::new(self, 20)
    }
    ///Bits 21:23 - ETH_SEL
    #[inline(always)]
    pub fn eth_sel(&mut self) -> ETH_SEL_W<'_, PMCCLRRrs> {
        ETH_SEL_W::new(self, 21)
    }
    ///Bit 24 - ANA0_SEL
    #[inline(always)]
    pub fn ana0_sel(&mut self) -> ANA0_SEL_W<'_, PMCCLRRrs> {
        ANA0_SEL_W::new(self, 24)
    }
    ///Bit 25 - ANA1_SEL
    #[inline(always)]
    pub fn ana1_sel(&mut self) -> ANA1_SEL_W<'_, PMCCLRRrs> {
        ANA1_SEL_W::new(self, 25)
    }
}
/**SYSCFG peripheral mode configuration clear register

You can [`read`](crate::Reg::read) this register and get [`pmcclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pmcclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#SYSCFG:PMCCLRR)*/
pub struct PMCCLRRrs;
impl crate::RegisterSpec for PMCCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`pmcclrr::R`](R) reader structure
impl crate::Readable for PMCCLRRrs {}
///`write(|w| ..)` method takes [`pmcclrr::W`](W) writer structure
impl crate::Writable for PMCCLRRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PMCCLRR to value 0
impl crate::Resettable for PMCCLRRrs {}
