#[doc = "Reader of register SYSCFG_CMPENCLRR"]
pub type R = crate::R<u32, super::SYSCFG_CMPENCLRR>;
#[doc = "Writer for register SYSCFG_CMPENCLRR"]
pub type W = crate::W<u32, super::SYSCFG_CMPENCLRR>;
#[doc = "Register SYSCFG_CMPENCLRR `reset()`'s with value 0"]
impl crate::ResetValue for super::SYSCFG_CMPENCLRR {
    type Type = u32;
    #[inline(always)]
