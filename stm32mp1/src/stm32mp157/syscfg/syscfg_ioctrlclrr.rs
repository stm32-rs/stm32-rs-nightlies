///Register `SYSCFG_IOCTRLCLRR` reader
pub type R = crate::R<SYSCFG_IOCTRLCLRRrs>;
///Register `SYSCFG_IOCTRLCLRR` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYSCFG_IOCTRLCLRR")
...
You can [`read`](crate::Reg::read) this register and get [`syscfg_ioctrlclrr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`syscfg_ioctrlclrr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#SYSCFG:SYSCFG_IOCTRLCLRR)*/
pub struct SYSCFG_IOCTRLCLRRrs;
impl crate::RegisterSpec for SYSCFG_IOCTRLCLRRrs {
    type Ux = u32;
}
///`read()` method returns [`syscfg_ioctrlclrr::R`](R) reader structure
impl crate::Readable for SYSCFG_IOCTRLCLRRrs {}
///`write(|w| ..)` method takes [`syscfg_ioctrlclrr::W`](W) writer structure
impl crate::Writable for SYSCFG_IOCTRLCLRRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SYSCFG_IOCTRLCLRR to value 0
