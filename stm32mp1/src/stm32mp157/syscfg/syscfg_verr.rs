...
You can [`read`](crate::Reg::read) this register and get [`syscfg_verr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#SYSCFG:SYSCFG_VERR)*/
pub struct SYSCFG_VERRrs;
impl crate::RegisterSpec for SYSCFG_VERRrs {
    type Ux = u32;
}
///`read()` method returns [`syscfg_verr::R`](R) reader structure
impl crate::Readable for SYSCFG_VERRrs {}
///`reset()` method sets SYSCFG_VERR to value 0x20
