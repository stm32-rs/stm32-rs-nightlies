#[doc = "Reader of register TAMP_FLTCR"]
pub type R = crate::R<u32, super::TAMP_FLTCR>;
#[doc = "Writer for register TAMP_FLTCR"]
pub type W = crate::W<u32, super::TAMP_FLTCR>;
#[doc = "Register TAMP_FLTCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TAMP_FLTCR {
    type Type = u32;
    #[inline(always)]
