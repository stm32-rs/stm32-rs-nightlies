#[doc = "Reader of register TAMP_SMCR"]
pub type R = crate::R<u32, super::TAMP_SMCR>;
#[doc = "Writer for register TAMP_SMCR"]
pub type W = crate::W<u32, super::TAMP_SMCR>;
#[doc = "Register TAMP_SMCR `reset()`'s with value 0x8000_0000"]
impl crate::ResetValue for super::TAMP_SMCR {
    type Type = u32;
    #[inline(always)]
