...
pub struct RegisterBlock {
    ...
    egr: EGR,
    _reserved6: [u8; 0x02],
    ccmr1alternate1: CCMR1ALTERNATE1,
    ccmr2alternate17: CCMR2ALTERNATE17,
    ccer: CCER,
    cnt: CNT,
    psc: PSC,
    _reserved11: [u8; 0x02],
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn ccmr1alternate1(&self) -> &CCMR1ALTERNATE1 {
        &self.ccmr1alternate1
    }
    ...
    #[inline(always)]
    pub const fn ccmr2alternate17(&self) -> &CCMR2ALTERNATE17 {
        &self.ccmr2alternate17
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:EGR)
...
pub mod egr;
/**CCMR1ALTERNATE1 (rw) register accessor: The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`ccmr1alternate1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr1alternate1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCMR1ALTERNATE1)

For information about available fields see [`mod@ccmr1alternate1`]
module*/
pub type CCMR1ALTERNATE1 = crate::Reg<ccmr1alternate1::CCMR1ALTERNATE1rs>;
///The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:
pub mod ccmr1alternate1;
...
You can [`read`](crate::Reg::read) this register and get [`ccmr2alternate17::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr2alternate17::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCMR2ALTERNATE17)

For information about available fields see [`mod@ccmr2alternate17`]
module*/
pub type CCMR2ALTERNATE17 = crate::Reg<ccmr2alternate17::CCMR2ALTERNATE17rs>;
///The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:
pub mod ccmr2alternate17;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CNT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:RCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:BDTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:DMAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCMR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCR5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:CCR6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:AF1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM1:TISEL)
