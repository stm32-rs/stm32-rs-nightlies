...
pub type R = crate::R<TIM12_SMCRrs>;
///Register `TIM12_SMCR` writer
pub type W = crate::W<TIM12_SMCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sms(&mut self) -> SMS_W<TIM12_SMCRrs> {
        SMS_W::new(self, 0)
    }
    ///Bits 4:6 - TS
    #[inline(always)]
    #[must_use]
    pub fn ts(&mut self) -> TS_W<TIM12_SMCRrs> {
        TS_W::new(self, 4)
    }
    ///Bit 7 - MSM
    #[inline(always)]
    #[must_use]
    pub fn msm(&mut self) -> MSM_W<TIM12_SMCRrs> {
        MSM_W::new(self, 7)
    }
    ///Bit 16 - SMS_3
    #[inline(always)]
    #[must_use]
    pub fn sms_3(&mut self) -> SMS_3_W<TIM12_SMCRrs> {
        SMS_3_W::new(self, 16)
    }
    ///Bit 20 - TS_3
    #[inline(always)]
    #[must_use]
    pub fn ts_3(&mut self) -> TS_3_W<TIM12_SMCRrs> {
        TS_3_W::new(self, 20)
    }
    ///Bit 21 - TS_4
    #[inline(always)]
    #[must_use]
    pub fn ts_4(&mut self) -> TS_4_W<TIM12_SMCRrs> {
        TS_4_W::new(self, 21)
    }
}
/**TIM12 slave mode control register

You can [`read`](crate::Reg::read) this register and get [`tim12_smcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim12_smcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM12:TIM12_SMCR)*/
pub struct TIM12_SMCRrs;
impl crate::RegisterSpec for TIM12_SMCRrs {
    type Ux = u32;
}
///`read()` method returns [`tim12_smcr::R`](R) reader structure
impl crate::Readable for TIM12_SMCRrs {}
///`write(|w| ..)` method takes [`tim12_smcr::W`](W) writer structure
impl crate::Writable for TIM12_SMCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM12_SMCR to value 0
impl crate::Resettable for TIM12_SMCRrs {
