#[doc = "Reader of register TIM12_TISEL"]
pub type R = crate::R<u32, super::TIM12_TISEL>;
#[doc = "Writer for register TIM12_TISEL"]
pub type W = crate::W<u32, super::TIM12_TISEL>;
#[doc = "Register TIM12_TISEL `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM12_TISEL {
    type Type = u32;
    #[inline(always)]
