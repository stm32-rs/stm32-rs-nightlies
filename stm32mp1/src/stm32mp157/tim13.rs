...
/**_CR1 (rw) register accessor: TIM13 control register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM13:_CR1)
...
pub mod _cr1;
/**_DIER (rw) register accessor: TIM13 Interrupt enable register
...
pub mod _dier;
/**_SR (rw) register accessor: TIM13 status register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM13:_SR)
...
pub mod _sr;
/**_EGR (w) register accessor: TIM13 event generation register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM13:_EGR)

For information about available fields see [`mod@_egr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM13:_CCMR1)

For information about available fields see [`mod@_ccmr1`]
module*/
pub type _CCMR1 = crate::Reg<_ccmr1::_CCMR1rs>;
///The channels can be used in input (capture mode) or in output (compare mode). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function in input and in output mode. For a given bit, OCxx describes its function when the channel is configured in output, ICxx describes its function when the channel is configured in input. So one must take care that the same bit can have a different meaning for the input stage and for the output stage. Output compare mode
pub mod _ccmr1;
/**_CCER (rw) register accessor: TIM13 capture/compare enable register
...
pub mod _ccer;
/**_CNT (rw) register accessor: TIM13 counter
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM13:_CNT)
...
///TIM13 counter
pub mod _cnt;
/**_PSC (rw) register accessor: TIM13 prescaler
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM13:_PSC)
...
///TIM13 prescaler
pub mod _psc;
/**_ARR (rw) register accessor: TIM13 auto-reload register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM13:_ARR)
...
pub mod _arr;
/**_CCR1 (rw) register accessor: TIM13 capture/compare register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM13:_CCR1)
...
pub mod _ccr1;
/**_TISEL (rw) register accessor: TIM13 timer input selection register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM13:_TISEL)
