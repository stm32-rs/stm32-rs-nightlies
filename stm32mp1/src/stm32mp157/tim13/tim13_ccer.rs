#[doc = "Reader of register TIM13_CCER"]
pub type R = crate::R<u16, super::TIM13_CCER>;
#[doc = "Writer for register TIM13_CCER"]
pub type W = crate::W<u16, super::TIM13_CCER>;
#[doc = "Register TIM13_CCER `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM13_CCER {
    type Type = u16;
    #[inline(always)]
