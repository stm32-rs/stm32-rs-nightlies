///Register `TIM13_CCMR1` reader
pub type R = crate::R<TIM13_CCMR1rs>;
///Register `TIM13_CCMR1` writer
...
You can [`read`](crate::Reg::read) this register and get [`tim13_ccmr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim13_ccmr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`tim13_ccmr1::R`](R) reader structure
impl crate::Readable for TIM13_CCMR1rs {}
///`write(|w| ..)` method takes [`tim13_ccmr1::W`](W) writer structure
impl crate::Writable for TIM13_CCMR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM13_CCMR1 to value 0
