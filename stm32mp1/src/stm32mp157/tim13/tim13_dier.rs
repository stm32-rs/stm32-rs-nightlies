#[doc = "Reader of register TIM13_DIER"]
pub type R = crate::R<u16, super::TIM13_DIER>;
#[doc = "Writer for register TIM13_DIER"]
pub type W = crate::W<u16, super::TIM13_DIER>;
#[doc = "Register TIM13_DIER `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM13_DIER {
    type Type = u16;
    #[inline(always)]
