...
impl W {
    ///Bits 0:1 - CC1S
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<_CCMR1rs> {
        CC1S_W::new(self, 0)
    }
    ///Bit 2 - OC1FE
    #[inline(always)]
    pub fn oc1fe(&mut self) -> OC1FE_W<_CCMR1rs> {
        OC1FE_W::new(self, 2)
    }
    ///Bit 3 - OC1PE
    #[inline(always)]
    pub fn oc1pe(&mut self) -> OC1PE_W<_CCMR1rs> {
        OC1PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC1M
    #[inline(always)]
    pub fn oc1m(&mut self) -> OC1M_W<_CCMR1rs> {
        OC1M_W::new(self, 4)
    }
    ///Bit 16 - OC1M3
    #[inline(always)]
    pub fn oc1m3(&mut self) -> OC1M3_W<_CCMR1rs> {
        OC1M3_W::new(self, 16)
    }
}
