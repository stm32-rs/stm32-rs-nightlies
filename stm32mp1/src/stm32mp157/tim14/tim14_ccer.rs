#[doc = "Reader of register TIM14_CCER"]
pub type R = crate::R<u16, super::TIM14_CCER>;
#[doc = "Writer for register TIM14_CCER"]
pub type W = crate::W<u16, super::TIM14_CCER>;
#[doc = "Register TIM14_CCER `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM14_CCER {
    type Type = u16;
    #[inline(always)]
