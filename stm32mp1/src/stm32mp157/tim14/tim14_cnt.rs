#[doc = "Reader of register TIM14_CNT"]
pub type R = crate::R<u32, super::TIM14_CNT>;
#[doc = "Writer for register TIM14_CNT"]
pub type W = crate::W<u32, super::TIM14_CNT>;
#[doc = "Register TIM14_CNT `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM14_CNT {
    type Type = u32;
    #[inline(always)]
