#[doc = "Reader of register TIM14_SR"]
pub type R = crate::R<u16, super::TIM14_SR>;
#[doc = "Writer for register TIM14_SR"]
pub type W = crate::W<u16, super::TIM14_SR>;
#[doc = "Register TIM14_SR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM14_SR {
    type Type = u16;
    #[inline(always)]
