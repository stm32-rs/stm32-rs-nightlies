...
impl W {
    ...
    ///Bit 5 - COMIE
    #[inline(always)]
    pub fn comie(&mut self) -> COMIE_W<_DIERrs> {
        COMIE_W::new(self, 5)
    }
    ///Bit 6 - TIE
    #[inline(always)]
    ...
    ///Bit 7 - BIE
    #[inline(always)]
    pub fn bie(&mut self) -> BIE_W<_DIERrs> {
        BIE_W::new(self, 7)
    }
    ///Bit 8 - UDE
    #[inline(always)]
    pub fn ude(&mut self) -> UDE_W<_DIERrs> {
        UDE_W::new(self, 8)
    }
    ///Bit 9 - CC1DE
    #[inline(always)]
    pub fn cc1de(&mut self) -> CC1DE_W<_DIERrs> {
        CC1DE_W::new(self, 9)
    }
    ///Bit 10 - CC2DE
    #[inline(always)]
    pub fn cc2de(&mut self) -> CC2DE_W<_DIERrs> {
        CC2DE_W::new(self, 10)
    }
    ///Bit 13 - COMDE
    #[inline(always)]
    pub fn comde(&mut self) -> COMDE_W<_DIERrs> {
        COMDE_W::new(self, 13)
    }
    ///Bit 14 - TDE
    #[inline(always)]
    pub fn tde(&mut self) -> TDE_W<_DIERrs> {
        TDE_W::new(self, 14)
    }
}
