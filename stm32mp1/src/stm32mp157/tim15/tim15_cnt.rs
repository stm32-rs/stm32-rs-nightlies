...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CNT_W<TIM15_CNTrs> {
        CNT_W::new(self, 0)
    }
}
#[doc = "TIM15 counter\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tim15_cnt::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tim15_cnt::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
