#[doc = "Reader of register TIM15_DCR"]
pub type R = crate::R<u16, super::TIM15_DCR>;
#[doc = "Writer for register TIM15_DCR"]
pub type W = crate::W<u16, super::TIM15_DCR>;
#[doc = "Register TIM15_DCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM15_DCR {
    type Type = u16;
    #[inline(always)]
