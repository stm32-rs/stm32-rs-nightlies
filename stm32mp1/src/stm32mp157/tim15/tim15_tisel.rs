#[doc = "Reader of register TIM15_TISEL"]
pub type R = crate::R<u32, super::TIM15_TISEL>;
#[doc = "Writer for register TIM15_TISEL"]
pub type W = crate::W<u32, super::TIM15_TISEL>;
#[doc = "Register TIM15_TISEL `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM15_TISEL {
    type Type = u32;
    #[inline(always)]
