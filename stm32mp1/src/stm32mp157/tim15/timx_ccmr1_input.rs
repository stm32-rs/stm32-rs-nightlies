///Register `TIMx_CCMR1_Input` reader
pub type R = crate::R<TIMX_CCMR1_INPUTrs>;
///Register `TIMx_CCMR1_Input` writer
pub type W = crate::W<TIMX_CCMR1_INPUTrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMx_CCMR1_Input")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1s(&mut self) -> CC1S_W<TIMX_CCMR1_INPUTrs> {
        CC1S_W::new(self, 0)
    }
    ///Bits 2:3 - Input capture 1 prescaler
    #[inline(always)]
    #[must_use]
    pub fn ic1psc(&mut self) -> IC1PSC_W<TIMX_CCMR1_INPUTrs> {
        IC1PSC_W::new(self, 2)
    }
    ///Bits 4:7 - Input capture 1 filter
    #[inline(always)]
    #[must_use]
    pub fn ic1f(&mut self) -> IC1F_W<TIMX_CCMR1_INPUTrs> {
        IC1F_W::new(self, 4)
    }
    ///Bits 8:9 - Capture/compare 2 selection
    #[inline(always)]
    #[must_use]
    pub fn cc2s(&mut self) -> CC2S_W<TIMX_CCMR1_INPUTrs> {
        CC2S_W::new(self, 8)
    }
    ///Bits 10:11 - Input capture 2 prescaler
    #[inline(always)]
    #[must_use]
    pub fn ic2psc(&mut self) -> IC2PSC_W<TIMX_CCMR1_INPUTrs> {
        IC2PSC_W::new(self, 10)
    }
    ///Bits 12:15 - Input capture 2 filter
    #[inline(always)]
    #[must_use]
    pub fn ic2f(&mut self) -> IC2F_W<TIMX_CCMR1_INPUTrs> {
        IC2F_W::new(self, 12)
    }
}
/**capture/compare mode register 1 (input mode)

You can [`read`](crate::Reg::read) this register and get [`timx_ccmr1_input::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timx_ccmr1_input::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM15:TIMx_CCMR1_Input)*/
pub struct TIMX_CCMR1_INPUTrs;
impl crate::RegisterSpec for TIMX_CCMR1_INPUTrs {
    type Ux = u32;
}
///`read()` method returns [`timx_ccmr1_input::R`](R) reader structure
impl crate::Readable for TIMX_CCMR1_INPUTrs {}
///`write(|w| ..)` method takes [`timx_ccmr1_input::W`](W) writer structure
impl crate::Writable for TIMX_CCMR1_INPUTrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMx_CCMR1_Input to value 0
impl crate::Resettable for TIMX_CCMR1_INPUTrs {
