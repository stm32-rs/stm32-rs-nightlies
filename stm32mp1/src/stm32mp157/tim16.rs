...
impl RegisterBlock {
    ...
    ///0x44 - As the BKBID, BKDSRM, BKF\[3:0\], AOE, BKP, BKE, OSSI, OSSR and DTG\[7:0\] bits may be write-locked depending on the LOCK configuration, it may be necessary to configure all of them during the first write access to the TIMx_BDTR register.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:EGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:CNT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:RCR)
...
pub mod rcr;
/**CCR1 (rw) register accessor: TIM16/TIM17 capture/compare register 1

You can [`read`](crate::Reg::read) this register and get [`ccr1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccr1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:CCR1)
...
pub mod ccr1;
/**BDTR (rw) register accessor: As the BKBID, BKDSRM, BKF\[3:0\], AOE, BKP, BKE, OSSI, OSSR and DTG\[7:0\] bits may be write-locked depending on the LOCK configuration, it may be necessary to configure all of them during the first write access to the TIMx_BDTR register.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:BDTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:DMAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:AF1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM16:TISEL)
