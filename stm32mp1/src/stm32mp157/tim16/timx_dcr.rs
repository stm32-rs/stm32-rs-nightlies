#[doc = "Reader of register TIMx_DCR"]
pub type R = crate::R<u16, super::TIMX_DCR>;
#[doc = "Writer for register TIMx_DCR"]
pub type W = crate::W<u16, super::TIMX_DCR>;
#[doc = "Register TIMx_DCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMX_DCR {
    type Type = u16;
    #[inline(always)]
