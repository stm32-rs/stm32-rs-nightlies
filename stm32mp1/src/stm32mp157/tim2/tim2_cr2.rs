...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccpc(&mut self) -> CCPC_W<TIM2_CR2rs> {
        CCPC_W::new(self, 0)
    }
    ///Bit 2 - CCUS
    #[inline(always)]
    #[must_use]
    pub fn ccus(&mut self) -> CCUS_W<TIM2_CR2rs> {
        CCUS_W::new(self, 2)
    }
    ///Bit 3 - CCDS
    #[inline(always)]
    #[must_use]
    pub fn ccds(&mut self) -> CCDS_W<TIM2_CR2rs> {
        CCDS_W::new(self, 3)
    }
    ///Bits 4:6 - MMS
    #[inline(always)]
    #[must_use]
    pub fn mms(&mut self) -> MMS_W<TIM2_CR2rs> {
        MMS_W::new(self, 4)
    }
    ///Bit 7 - TI1S
    #[inline(always)]
    #[must_use]
    pub fn ti1s(&mut self) -> TI1S_W<TIM2_CR2rs> {
        TI1S_W::new(self, 7)
    }
    ///Bit 8 - OIS1
    #[inline(always)]
    #[must_use]
    pub fn ois1(&mut self) -> OIS1_W<TIM2_CR2rs> {
        OIS1_W::new(self, 8)
    }
    ///Bit 9 - OIS1N
    #[inline(always)]
    #[must_use]
    pub fn ois1n(&mut self) -> OIS1N_W<TIM2_CR2rs> {
        OIS1N_W::new(self, 9)
    }
    ///Bit 10 - OIS2
    #[inline(always)]
    #[must_use]
    pub fn ois2(&mut self) -> OIS2_W<TIM2_CR2rs> {
        OIS2_W::new(self, 10)
    }
    ///Bit 11 - OIS2N
    #[inline(always)]
    #[must_use]
    pub fn ois2n(&mut self) -> OIS2N_W<TIM2_CR2rs> {
        OIS2N_W::new(self, 11)
    }
    ///Bit 12 - OIS3
    #[inline(always)]
    #[must_use]
    pub fn ois3(&mut self) -> OIS3_W<TIM2_CR2rs> {
        OIS3_W::new(self, 12)
    }
    ///Bit 13 - OIS3N
    #[inline(always)]
    #[must_use]
    pub fn ois3n(&mut self) -> OIS3N_W<TIM2_CR2rs> {
        OIS3N_W::new(self, 13)
    }
    ///Bit 14 - OIS4
    #[inline(always)]
    #[must_use]
    pub fn ois4(&mut self) -> OIS4_W<TIM2_CR2rs> {
        OIS4_W::new(self, 14)
    }
    ///Bit 16 - OIS5
    #[inline(always)]
    #[must_use]
    pub fn ois5(&mut self) -> OIS5_W<TIM2_CR2rs> {
        OIS5_W::new(self, 16)
    }
    ///Bit 18 - OIS6
    #[inline(always)]
    #[must_use]
    pub fn ois6(&mut self) -> OIS6_W<TIM2_CR2rs> {
        OIS6_W::new(self, 18)
    }
    ///Bits 20:23 - MMS2
    #[inline(always)]
    #[must_use]
    pub fn mms2(&mut self) -> MMS2_W<TIM2_CR2rs> {
        MMS2_W::new(self, 20)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM2:TIM2_CR2)*/
