#[doc = "Reader of register TIM2_DCR"]
pub type R = crate::R<u16, super::TIM2_DCR>;
#[doc = "Writer for register TIM2_DCR"]
pub type W = crate::W<u16, super::TIM2_DCR>;
#[doc = "Register TIM2_DCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM2_DCR {
    type Type = u16;
    #[inline(always)]
