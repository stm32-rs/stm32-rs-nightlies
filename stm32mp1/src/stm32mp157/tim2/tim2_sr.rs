...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comif(&mut self) -> COMIF_W<TIM2_SRrs> {
        COMIF_W::new(self, 5)
    }
    #[doc = "Bit 6 - TIF"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn bif(&mut self) -> BIF_W<TIM2_SRrs> {
        BIF_W::new(self, 7)
    }
    #[doc = "Bit 8 - B2IF"]
    #[inline(always)]
    #[must_use]
    pub fn b2if(&mut self) -> B2IF_W<TIM2_SRrs> {
        B2IF_W::new(self, 8)
    }
    #[doc = "Bit 9 - CC1OF"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn sbif(&mut self) -> SBIF_W<TIM2_SRrs> {
        SBIF_W::new(self, 13)
    }
    #[doc = "Bit 16 - CC5IF"]
    #[inline(always)]
    #[must_use]
    pub fn cc5if(&mut self) -> CC5IF_W<TIM2_SRrs> {
        CC5IF_W::new(self, 16)
    }
    #[doc = "Bit 17 - CC6IF"]
    #[inline(always)]
    #[must_use]
    pub fn cc6if(&mut self) -> CC6IF_W<TIM2_SRrs> {
        CC6IF_W::new(self, 17)
    }
}
#[doc = "TIM2 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tim2_sr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tim2_sr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
