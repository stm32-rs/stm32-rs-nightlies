...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1e(&mut self) -> CC1E_W<TIM3_CCERrs> {
        CC1E_W::new(self, 0)
    }
    #[doc = "Bit 1 - CC1P"]
    #[inline(always)]
    #[must_use]
    pub fn cc1p(&mut self) -> CC1P_W<TIM3_CCERrs> {
        CC1P_W::new(self, 1)
    }
    #[doc = "Bit 2 - CC1NE"]
    #[inline(always)]
    #[must_use]
    pub fn cc1ne(&mut self) -> CC1NE_W<TIM3_CCERrs> {
        CC1NE_W::new(self, 2)
    }
    #[doc = "Bit 3 - CC1NP"]
    #[inline(always)]
    #[must_use]
    pub fn cc1np(&mut self) -> CC1NP_W<TIM3_CCERrs> {
        CC1NP_W::new(self, 3)
    }
    #[doc = "Bit 4 - CC2E"]
    #[inline(always)]
    #[must_use]
    pub fn cc2e(&mut self) -> CC2E_W<TIM3_CCERrs> {
        CC2E_W::new(self, 4)
    }
    #[doc = "Bit 5 - CC2P"]
    #[inline(always)]
    #[must_use]
    pub fn cc2p(&mut self) -> CC2P_W<TIM3_CCERrs> {
        CC2P_W::new(self, 5)
    }
    #[doc = "Bit 6 - CC2NE"]
    #[inline(always)]
    #[must_use]
    pub fn cc2ne(&mut self) -> CC2NE_W<TIM3_CCERrs> {
        CC2NE_W::new(self, 6)
    }
    #[doc = "Bit 7 - CC2NP"]
    #[inline(always)]
    #[must_use]
    pub fn cc2np(&mut self) -> CC2NP_W<TIM3_CCERrs> {
        CC2NP_W::new(self, 7)
    }
    #[doc = "Bit 8 - CC3E"]
    #[inline(always)]
    #[must_use]
    pub fn cc3e(&mut self) -> CC3E_W<TIM3_CCERrs> {
        CC3E_W::new(self, 8)
    }
    #[doc = "Bit 9 - CC3P"]
    #[inline(always)]
    #[must_use]
    pub fn cc3p(&mut self) -> CC3P_W<TIM3_CCERrs> {
        CC3P_W::new(self, 9)
    }
    #[doc = "Bit 10 - CC3NE"]
    #[inline(always)]
    #[must_use]
    pub fn cc3ne(&mut self) -> CC3NE_W<TIM3_CCERrs> {
        CC3NE_W::new(self, 10)
    }
    #[doc = "Bit 11 - CC3NP"]
    #[inline(always)]
    #[must_use]
    pub fn cc3np(&mut self) -> CC3NP_W<TIM3_CCERrs> {
        CC3NP_W::new(self, 11)
    }
    #[doc = "Bit 12 - CC4E"]
    #[inline(always)]
    #[must_use]
    pub fn cc4e(&mut self) -> CC4E_W<TIM3_CCERrs> {
        CC4E_W::new(self, 12)
    }
    #[doc = "Bit 13 - CC4P"]
    #[inline(always)]
    #[must_use]
    pub fn cc4p(&mut self) -> CC4P_W<TIM3_CCERrs> {
        CC4P_W::new(self, 13)
    }
    #[doc = "Bit 15 - CC4NP"]
    #[inline(always)]
    #[must_use]
    pub fn cc4np(&mut self) -> CC4NP_W<TIM3_CCERrs> {
        CC4NP_W::new(self, 15)
    }
    #[doc = "Bit 16 - CC5E"]
    #[inline(always)]
    #[must_use]
    pub fn cc5e(&mut self) -> CC5E_W<TIM3_CCERrs> {
        CC5E_W::new(self, 16)
    }
    #[doc = "Bit 17 - CC5P"]
    #[inline(always)]
    #[must_use]
    pub fn cc5p(&mut self) -> CC5P_W<TIM3_CCERrs> {
        CC5P_W::new(self, 17)
    }
    #[doc = "Bit 20 - CC6E"]
    #[inline(always)]
    #[must_use]
    pub fn cc6e(&mut self) -> CC6E_W<TIM3_CCERrs> {
        CC6E_W::new(self, 20)
    }
    #[doc = "Bit 21 - CC6P"]
    #[inline(always)]
    #[must_use]
    pub fn cc6p(&mut self) -> CC6P_W<TIM3_CCERrs> {
        CC6P_W::new(self, 21)
    }
}
#[doc = "TIM3 capture/compare enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tim3_ccer::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tim3_ccer::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
