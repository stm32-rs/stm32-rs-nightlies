...
pub type R = crate::R<TIM3_CCR5rs>;
///Register `TIM3_CCR5` writer
pub type W = crate::W<TIM3_CCR5rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccr5(&mut self) -> CCR5_W<TIM3_CCR5rs> {
        CCR5_W::new(self, 0)
    }
    ///Bit 29 - GC5C1
    #[inline(always)]
    #[must_use]
    pub fn gc5c1(&mut self) -> GC5C1_W<TIM3_CCR5rs> {
        GC5C1_W::new(self, 29)
    }
    ///Bit 30 - GC5C2
    #[inline(always)]
    #[must_use]
    pub fn gc5c2(&mut self) -> GC5C2_W<TIM3_CCR5rs> {
        GC5C2_W::new(self, 30)
    }
    ///Bit 31 - GC5C3
    #[inline(always)]
    #[must_use]
    pub fn gc5c3(&mut self) -> GC5C3_W<TIM3_CCR5rs> {
        GC5C3_W::new(self, 31)
    }
}
/**TIM3 capture/compare register 5

You can [`read`](crate::Reg::read) this register and get [`tim3_ccr5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim3_ccr5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM3:TIM3_CCR5)*/
pub struct TIM3_CCR5rs;
impl crate::RegisterSpec for TIM3_CCR5rs {
    type Ux = u32;
}
///`read()` method returns [`tim3_ccr5::R`](R) reader structure
impl crate::Readable for TIM3_CCR5rs {}
///`write(|w| ..)` method takes [`tim3_ccr5::W`](W) writer structure
impl crate::Writable for TIM3_CCR5rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM3_CCR5 to value 0
impl crate::Resettable for TIM3_CCR5rs {
