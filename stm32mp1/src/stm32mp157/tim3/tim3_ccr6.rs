///Register `TIM3_CCR6` reader
pub type R = crate::R<TIM3_CCR6rs>;
///Register `TIM3_CCR6` writer
...
You can [`read`](crate::Reg::read) this register and get [`tim3_ccr6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim3_ccr6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`tim3_ccr6::R`](R) reader structure
impl crate::Readable for TIM3_CCR6rs {}
///`write(|w| ..)` method takes [`tim3_ccr6::W`](W) writer structure
impl crate::Writable for TIM3_CCR6rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
///`reset()` method sets TIM3_CCR6 to value 0
