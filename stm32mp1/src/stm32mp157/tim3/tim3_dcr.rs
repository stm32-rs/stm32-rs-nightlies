#[doc = "Reader of register TIM3_DCR"]
pub type R = crate::R<u16, super::TIM3_DCR>;
#[doc = "Writer for register TIM3_DCR"]
pub type W = crate::W<u16, super::TIM3_DCR>;
#[doc = "Register TIM3_DCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM3_DCR {
    type Type = u16;
    #[inline(always)]
