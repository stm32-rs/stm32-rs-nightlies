...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comg(&mut self) -> COMG_W<TIM3_EGRrs> {
        COMG_W::new(self, 5)
    }
    #[doc = "Bit 6 - TG"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn bg(&mut self) -> BG_W<TIM3_EGRrs> {
        BG_W::new(self, 7)
    }
    #[doc = "Bit 8 - B2G"]
    #[inline(always)]
    #[must_use]
    pub fn b2g(&mut self) -> B2G_W<TIM3_EGRrs> {
        B2G_W::new(self, 8)
    }
}
#[doc = "TIM3 event generation register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tim3_egr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
