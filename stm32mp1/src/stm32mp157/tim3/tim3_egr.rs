#[doc = "Writer for register TIM3_EGR"]
pub type W = crate::W<u16, super::TIM3_EGR>;
#[doc = "Register TIM3_EGR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM3_EGR {
    type Type = u16;
    #[inline(always)]
