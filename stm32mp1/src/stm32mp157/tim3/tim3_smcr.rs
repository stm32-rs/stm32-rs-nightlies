...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sms3(&mut self) -> SMS3_W<TIM3_SMCRrs> {
        SMS3_W::new(self, 16)
    }
    #[doc = "Bit 20 - TS3"]
    #[inline(always)]
    #[must_use]
    pub fn ts3(&mut self) -> TS3_W<TIM3_SMCRrs> {
        TS3_W::new(self, 20)
    }
    #[doc = "Bit 21 - TS4"]
    #[inline(always)]
    #[must_use]
    pub fn ts4(&mut self) -> TS4_W<TIM3_SMCRrs> {
        TS4_W::new(self, 21)
    }
}
#[doc = "TIM3 slave mode control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tim3_smcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tim3_smcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
