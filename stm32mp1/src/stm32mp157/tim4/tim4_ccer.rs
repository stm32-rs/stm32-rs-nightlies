#[doc = "Reader of register TIM4_CCER"]
pub type R = crate::R<u32, super::TIM4_CCER>;
#[doc = "Writer for register TIM4_CCER"]
pub type W = crate::W<u32, super::TIM4_CCER>;
#[doc = "Register TIM4_CCER `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM4_CCER {
    type Type = u32;
    #[inline(always)]
