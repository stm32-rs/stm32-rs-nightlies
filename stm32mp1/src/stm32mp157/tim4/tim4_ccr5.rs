#[doc = "Reader of register TIM4_CCR5"]
pub type R = crate::R<u32, super::TIM4_CCR5>;
#[doc = "Writer for register TIM4_CCR5"]
pub type W = crate::W<u32, super::TIM4_CCR5>;
#[doc = "Register TIM4_CCR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM4_CCR5 {
    type Type = u32;
    #[inline(always)]
