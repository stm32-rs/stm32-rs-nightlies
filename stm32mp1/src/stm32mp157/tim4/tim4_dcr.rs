#[doc = "Reader of register TIM4_DCR"]
pub type R = crate::R<u16, super::TIM4_DCR>;
#[doc = "Writer for register TIM4_DCR"]
pub type W = crate::W<u16, super::TIM4_DCR>;
#[doc = "Register TIM4_DCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM4_DCR {
    type Type = u16;
    #[inline(always)]
