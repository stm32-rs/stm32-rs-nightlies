#[doc = "Writer for register TIM4_EGR"]
pub type W = crate::W<u16, super::TIM4_EGR>;
#[doc = "Register TIM4_EGR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM4_EGR {
    type Type = u16;
    #[inline(always)]
