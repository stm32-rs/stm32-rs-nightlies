...
pub type R = crate::R<TIM4_SMCRrs>;
///Register `TIM4_SMCR` writer
pub type W = crate::W<TIM4_SMCRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sms(&mut self) -> SMS_W<TIM4_SMCRrs> {
        SMS_W::new(self, 0)
    }
    ///Bits 4:6 - TS
    #[inline(always)]
    #[must_use]
    pub fn ts(&mut self) -> TS_W<TIM4_SMCRrs> {
        TS_W::new(self, 4)
    }
    ///Bit 7 - MSM
    #[inline(always)]
    #[must_use]
    pub fn msm(&mut self) -> MSM_W<TIM4_SMCRrs> {
        MSM_W::new(self, 7)
    }
    ///Bits 8:11 - ETF
    #[inline(always)]
    #[must_use]
    pub fn etf(&mut self) -> ETF_W<TIM4_SMCRrs> {
        ETF_W::new(self, 8)
    }
    ///Bits 12:13 - ETPS
    #[inline(always)]
    #[must_use]
    pub fn etps(&mut self) -> ETPS_W<TIM4_SMCRrs> {
        ETPS_W::new(self, 12)
    }
    ///Bit 14 - ECE
    #[inline(always)]
    #[must_use]
    pub fn ece(&mut self) -> ECE_W<TIM4_SMCRrs> {
        ECE_W::new(self, 14)
    }
    ///Bit 15 - ETP
    #[inline(always)]
    #[must_use]
    pub fn etp(&mut self) -> ETP_W<TIM4_SMCRrs> {
        ETP_W::new(self, 15)
    }
    ///Bit 16 - SMS3
    #[inline(always)]
    #[must_use]
    pub fn sms3(&mut self) -> SMS3_W<TIM4_SMCRrs> {
        SMS3_W::new(self, 16)
    }
    ///Bit 20 - TS3
    #[inline(always)]
    #[must_use]
    pub fn ts3(&mut self) -> TS3_W<TIM4_SMCRrs> {
        TS3_W::new(self, 20)
    }
    ///Bit 21 - TS4
    #[inline(always)]
    #[must_use]
    pub fn ts4(&mut self) -> TS4_W<TIM4_SMCRrs> {
        TS4_W::new(self, 21)
    }
}
/**TIM4 slave mode control register

You can [`read`](crate::Reg::read) this register and get [`tim4_smcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim4_smcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM4:TIM4_SMCR)*/
pub struct TIM4_SMCRrs;
impl crate::RegisterSpec for TIM4_SMCRrs {
    type Ux = u32;
}
///`read()` method returns [`tim4_smcr::R`](R) reader structure
impl crate::Readable for TIM4_SMCRrs {}
///`write(|w| ..)` method takes [`tim4_smcr::W`](W) writer structure
impl crate::Writable for TIM4_SMCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM4_SMCR to value 0
impl crate::Resettable for TIM4_SMCRrs {
