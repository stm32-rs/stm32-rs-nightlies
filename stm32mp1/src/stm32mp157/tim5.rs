...
pub struct RegisterBlock {
    ...
    egr: EGR,
    _reserved6: [u8; 0x02],
    ccmr1alternate5: CCMR1ALTERNATE5,
    ccmr2alternate21: CCMR2ALTERNATE21,
    ccer: CCER,
    cnt: CNT,
    psc: PSC,
    _reserved11: [u8; 0x02],
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn ccmr1alternate5(&self) -> &CCMR1ALTERNATE5 {
        &self.ccmr1alternate5
    }
    ...
    #[inline(always)]
    pub const fn ccmr2alternate21(&self) -> &CCMR2ALTERNATE21 {
        &self.ccmr2alternate21
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:SR)
...
pub mod egr;
/**CCMR1ALTERNATE5 (rw) register accessor: The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`ccmr1alternate5::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr1alternate5::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCMR1ALTERNATE5)

For information about available fields see [`mod@ccmr1alternate5`]
module*/
pub type CCMR1ALTERNATE5 = crate::Reg<ccmr1alternate5::CCMR1ALTERNATE5rs>;
///The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:
pub mod ccmr1alternate5;
/**CCMR2ALTERNATE21 (rw) register accessor: The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`ccmr2alternate21::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr2alternate21::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCMR2ALTERNATE21)

For information about available fields see [`mod@ccmr2alternate21`]
module*/
pub type CCMR2ALTERNATE21 = crate::Reg<ccmr2alternate21::CCMR2ALTERNATE21rs>;
///The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:
pub mod ccmr2alternate21;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CNT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:ARR)
...
pub mod arr;
/**RCR (rw) register accessor: TIM5 repetition counter register

You can [`read`](crate::Reg::read) this register and get [`rcr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:RCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:BDTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:DMAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCMR3)
...
pub mod ccmr3;
/**CCR5 (rw) register accessor: TIM5 capture/compare register 5
...
pub mod ccr5;
/**CCR6 (rw) register accessor: TIM5 capture/compare register 6
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCR6)
