///Register `CCMR2ALTERNATE21` reader
pub type R = crate::R<CCMR2ALTERNATE21rs>;
///Register `CCMR2ALTERNATE21` writer
pub type W = crate::W<CCMR2ALTERNATE21rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CCMR2ALTERNATE21")
...
impl W {
    ///Bits 0:1 - CC3S
    #[inline(always)]
    pub fn cc3s(&mut self) -> CC3S_W<'_, CCMR2ALTERNATE21rs> {
        CC3S_W::new(self, 0)
    }
    ///Bits 2:3 - IC3PSC
    #[inline(always)]
    pub fn ic3psc(&mut self) -> IC3PSC_W<'_, CCMR2ALTERNATE21rs> {
        IC3PSC_W::new(self, 2)
    }
    ///Bits 4:7 - IC3F
    #[inline(always)]
    pub fn ic3f(&mut self) -> IC3F_W<'_, CCMR2ALTERNATE21rs> {
        IC3F_W::new(self, 4)
    }
    ///Bits 8:9 - CC4S
    #[inline(always)]
    pub fn cc4s(&mut self) -> CC4S_W<'_, CCMR2ALTERNATE21rs> {
        CC4S_W::new(self, 8)
    }
    ///Bits 10:11 - IC4PSC
    #[inline(always)]
    pub fn ic4psc(&mut self) -> IC4PSC_W<'_, CCMR2ALTERNATE21rs> {
        IC4PSC_W::new(self, 10)
    }
    ///Bits 12:15 - IC4F
    #[inline(always)]
    pub fn ic4f(&mut self) -> IC4F_W<'_, CCMR2ALTERNATE21rs> {
        IC4F_W::new(self, 12)
    }
}
/**The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`ccmr2alternate21::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr2alternate21::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM5:CCMR2ALTERNATE21)*/
pub struct CCMR2ALTERNATE21rs;
impl crate::RegisterSpec for CCMR2ALTERNATE21rs {
    type Ux = u32;
}
///`read()` method returns [`ccmr2alternate21::R`](R) reader structure
impl crate::Readable for CCMR2ALTERNATE21rs {}
///`write(|w| ..)` method takes [`ccmr2alternate21::W`](W) writer structure
impl crate::Writable for CCMR2ALTERNATE21rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CCMR2ALTERNATE21 to value 0
impl crate::Resettable for CCMR2ALTERNATE21rs {}
