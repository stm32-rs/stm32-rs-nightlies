#[doc = "Writer for register TIM5_EGR"]
pub type W = crate::W<u16, super::TIM5_EGR>;
#[doc = "Register TIM5_EGR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM5_EGR {
    type Type = u16;
    #[inline(always)]
