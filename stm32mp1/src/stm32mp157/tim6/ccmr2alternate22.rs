...
impl W {
    ///Bits 0:1 - CC3S
    #[inline(always)]
    pub fn cc3s(&mut self) -> CC3S_W<CCMR2ALTERNATE22rs> {
        CC3S_W::new(self, 0)
    }
    ///Bits 2:3 - IC3PSC
    #[inline(always)]
    pub fn ic3psc(&mut self) -> IC3PSC_W<CCMR2ALTERNATE22rs> {
        IC3PSC_W::new(self, 2)
    }
    ///Bits 4:7 - IC3F
    #[inline(always)]
    pub fn ic3f(&mut self) -> IC3F_W<CCMR2ALTERNATE22rs> {
        IC3F_W::new(self, 4)
    }
    ///Bits 8:9 - CC4S
    #[inline(always)]
    pub fn cc4s(&mut self) -> CC4S_W<CCMR2ALTERNATE22rs> {
        CC4S_W::new(self, 8)
    }
    ///Bits 10:11 - IC4PSC
    #[inline(always)]
    pub fn ic4psc(&mut self) -> IC4PSC_W<CCMR2ALTERNATE22rs> {
        IC4PSC_W::new(self, 10)
    }
    ///Bits 12:15 - IC4F
    #[inline(always)]
    pub fn ic4f(&mut self) -> IC4F_W<CCMR2ALTERNATE22rs> {
        IC4F_W::new(self, 12)
    }
}
