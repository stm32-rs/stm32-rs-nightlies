#[doc = "Reader of register TIM6_DCR"]
pub type R = crate::R<u16, super::TIM6_DCR>;
#[doc = "Writer for register TIM6_DCR"]
pub type W = crate::W<u16, super::TIM6_DCR>;
#[doc = "Register TIM6_DCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM6_DCR {
    type Type = u16;
    #[inline(always)]
