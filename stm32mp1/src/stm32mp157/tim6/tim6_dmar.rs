///Register `TIM6_DMAR` reader
pub type R = crate::R<TIM6_DMARrs>;
///Register `TIM6_DMAR` writer
...
You can [`read`](crate::Reg::read) this register and get [`tim6_dmar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim6_dmar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`tim6_dmar::R`](R) reader structure
impl crate::Readable for TIM6_DMARrs {}
///`write(|w| ..)` method takes [`tim6_dmar::W`](W) writer structure
impl crate::Writable for TIM6_DMARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM6_DMAR to value 0
