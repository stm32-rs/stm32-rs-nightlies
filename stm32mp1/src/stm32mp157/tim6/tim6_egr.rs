#[doc = "Writer for register TIM6_EGR"]
pub type W = crate::W<u16, super::TIM6_EGR>;
#[doc = "Register TIM6_EGR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM6_EGR {
    type Type = u16;
    #[inline(always)]
