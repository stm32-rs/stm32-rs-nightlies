...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1if(&mut self) -> CC1IF_W<TIM6_SRrs> {
        CC1IF_W::new(self, 1)
    }
    ///Bit 2 - CC2IF
    #[inline(always)]
    #[must_use]
    pub fn cc2if(&mut self) -> CC2IF_W<TIM6_SRrs> {
        CC2IF_W::new(self, 2)
    }
    ///Bit 3 - CC3IF
    #[inline(always)]
    #[must_use]
    pub fn cc3if(&mut self) -> CC3IF_W<TIM6_SRrs> {
        CC3IF_W::new(self, 3)
    }
    ///Bit 4 - CC4IF
    #[inline(always)]
    #[must_use]
    pub fn cc4if(&mut self) -> CC4IF_W<TIM6_SRrs> {
        CC4IF_W::new(self, 4)
    }
    ///Bit 5 - COMIF
    #[inline(always)]
    #[must_use]
    pub fn comif(&mut self) -> COMIF_W<TIM6_SRrs> {
        COMIF_W::new(self, 5)
    }
    ///Bit 6 - TIF
    #[inline(always)]
    #[must_use]
    pub fn tif(&mut self) -> TIF_W<TIM6_SRrs> {
        TIF_W::new(self, 6)
    }
    ///Bit 7 - BIF
    #[inline(always)]
    #[must_use]
    pub fn bif(&mut self) -> BIF_W<TIM6_SRrs> {
        BIF_W::new(self, 7)
    }
    ///Bit 8 - B2IF
    #[inline(always)]
    #[must_use]
    pub fn b2if(&mut self) -> B2IF_W<TIM6_SRrs> {
        B2IF_W::new(self, 8)
    }
    ///Bit 9 - CC1OF
    #[inline(always)]
    #[must_use]
    pub fn cc1of(&mut self) -> CC1OF_W<TIM6_SRrs> {
        CC1OF_W::new(self, 9)
    }
    ///Bit 10 - CC2OF
    #[inline(always)]
    #[must_use]
    pub fn cc2of(&mut self) -> CC2OF_W<TIM6_SRrs> {
        CC2OF_W::new(self, 10)
    }
    ///Bit 11 - CC3OF
    #[inline(always)]
    #[must_use]
    pub fn cc3of(&mut self) -> CC3OF_W<TIM6_SRrs> {
        CC3OF_W::new(self, 11)
    }
    ///Bit 12 - CC4OF
    #[inline(always)]
    #[must_use]
    pub fn cc4of(&mut self) -> CC4OF_W<TIM6_SRrs> {
        CC4OF_W::new(self, 12)
    }
    ///Bit 13 - SBIF
    #[inline(always)]
    #[must_use]
    pub fn sbif(&mut self) -> SBIF_W<TIM6_SRrs> {
        SBIF_W::new(self, 13)
    }
    ///Bit 16 - CC5IF
    #[inline(always)]
    #[must_use]
    pub fn cc5if(&mut self) -> CC5IF_W<TIM6_SRrs> {
        CC5IF_W::new(self, 16)
    }
    ///Bit 17 - CC6IF
    #[inline(always)]
    #[must_use]
    pub fn cc6if(&mut self) -> CC6IF_W<TIM6_SRrs> {
        CC6IF_W::new(self, 17)
    }
}
