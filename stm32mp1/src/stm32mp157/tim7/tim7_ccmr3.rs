///Register `TIM7_CCMR3` reader
pub type R = crate::R<TIM7_CCMR3rs>;
///Register `TIM7_CCMR3` writer
...
You can [`read`](crate::Reg::read) this register and get [`tim7_ccmr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim7_ccmr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`tim7_ccmr3::R`](R) reader structure
impl crate::Readable for TIM7_CCMR3rs {}
///`write(|w| ..)` method takes [`tim7_ccmr3::W`](W) writer structure
impl crate::Writable for TIM7_CCMR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM7_CCMR3 to value 0
