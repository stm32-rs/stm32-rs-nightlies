#[doc = "Reader of register TIM7_DCR"]
pub type R = crate::R<u16, super::TIM7_DCR>;
#[doc = "Writer for register TIM7_DCR"]
pub type W = crate::W<u16, super::TIM7_DCR>;
#[doc = "Register TIM7_DCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM7_DCR {
    type Type = u16;
    #[inline(always)]
