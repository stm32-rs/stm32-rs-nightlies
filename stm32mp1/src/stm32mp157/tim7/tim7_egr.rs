#[doc = "Writer for register TIM7_EGR"]
pub type W = crate::W<u16, super::TIM7_EGR>;
#[doc = "Register TIM7_EGR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM7_EGR {
    type Type = u16;
    #[inline(always)]
