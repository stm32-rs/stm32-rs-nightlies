...
pub struct RegisterBlock {
    ...
    egr: EGR,
    _reserved6: [u8; 0x02],
    ccmr1alternate8: CCMR1ALTERNATE8,
    ccmr2alternate24: CCMR2ALTERNATE24,
    ccer: CCER,
    cnt: CNT,
    psc: PSC,
    _reserved11: [u8; 0x02],
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn ccmr1alternate8(&self) -> &CCMR1ALTERNATE8 {
        &self.ccmr1alternate8
    }
    ...
    #[inline(always)]
    pub const fn ccmr2alternate24(&self) -> &CCMR2ALTERNATE24 {
        &self.ccmr2alternate24
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:EGR)
...
pub mod egr;
/**CCMR1ALTERNATE8 (rw) register accessor: The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`ccmr1alternate8::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr1alternate8::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CCMR1ALTERNATE8)

For information about available fields see [`mod@ccmr1alternate8`]
module*/
pub type CCMR1ALTERNATE8 = crate::Reg<ccmr1alternate8::CCMR1ALTERNATE8rs>;
///The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:
pub mod ccmr1alternate8;
/**CCMR2ALTERNATE24 (rw) register accessor: The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`ccmr2alternate24::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr2alternate24::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CCMR2ALTERNATE24)

For information about available fields see [`mod@ccmr2alternate24`]
module*/
pub type CCMR2ALTERNATE24 = crate::Reg<ccmr2alternate24::CCMR2ALTERNATE24rs>;
///The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:
pub mod ccmr2alternate24;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CNT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:RCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CCR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CCR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CCR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:BDTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:DMAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CCR5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CCR6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:AF2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:TISEL)
