///Register `CCMR1ALTERNATE8` reader
pub type R = crate::R<CCMR1ALTERNATE8rs>;
///Register `CCMR1ALTERNATE8` writer
pub type W = crate::W<CCMR1ALTERNATE8rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CCMR1ALTERNATE8")
...
impl W {
    ///Bits 0:1 - CC1S
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<'_, CCMR1ALTERNATE8rs> {
        CC1S_W::new(self, 0)
    }
    ///Bits 2:3 - IC1PSC
    #[inline(always)]
    pub fn ic1psc(&mut self) -> IC1PSC_W<'_, CCMR1ALTERNATE8rs> {
        IC1PSC_W::new(self, 2)
    }
    ///Bits 4:7 - IC1F
    #[inline(always)]
    pub fn ic1f(&mut self) -> IC1F_W<'_, CCMR1ALTERNATE8rs> {
        IC1F_W::new(self, 4)
    }
    ///Bits 8:9 - CC2S
    #[inline(always)]
    pub fn cc2s(&mut self) -> CC2S_W<'_, CCMR1ALTERNATE8rs> {
        CC2S_W::new(self, 8)
    }
    ///Bits 10:11 - IC2PSC
    #[inline(always)]
    pub fn ic2psc(&mut self) -> IC2PSC_W<'_, CCMR1ALTERNATE8rs> {
        IC2PSC_W::new(self, 10)
    }
    ///Bits 12:15 - IC2F
    #[inline(always)]
    pub fn ic2f(&mut self) -> IC2F_W<'_, CCMR1ALTERNATE8rs> {
        IC2F_W::new(self, 12)
    }
}
/**The same register can be used for input capture mode (this section) or for output compare mode (next section). The direction of a channel is defined by configuring the corresponding CCxS bits. All the other bits of this register have a different function for input capture and for output compare modes. It is possible to combine both modes independently (e.g. channel 1 in input capture mode and channel 2 in output compare mode). Input capture mode:

You can [`read`](crate::Reg::read) this register and get [`ccmr1alternate8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr1alternate8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TIM8:CCMR1ALTERNATE8)*/
pub struct CCMR1ALTERNATE8rs;
impl crate::RegisterSpec for CCMR1ALTERNATE8rs {
    type Ux = u32;
}
///`read()` method returns [`ccmr1alternate8::R`](R) reader structure
impl crate::Readable for CCMR1ALTERNATE8rs {}
///`write(|w| ..)` method takes [`ccmr1alternate8::W`](W) writer structure
impl crate::Writable for CCMR1ALTERNATE8rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CCMR1ALTERNATE8 to value 0
impl crate::Resettable for CCMR1ALTERNATE8rs {}
