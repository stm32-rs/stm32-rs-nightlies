...
impl W {
    ///Bits 0:1 - CC1S
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<CCMR1ALTERNATE8rs> {
        CC1S_W::new(self, 0)
    }
    ///Bits 2:3 - IC1PSC
    #[inline(always)]
    pub fn ic1psc(&mut self) -> IC1PSC_W<CCMR1ALTERNATE8rs> {
        IC1PSC_W::new(self, 2)
    }
    ///Bits 4:7 - IC1F
    #[inline(always)]
    pub fn ic1f(&mut self) -> IC1F_W<CCMR1ALTERNATE8rs> {
        IC1F_W::new(self, 4)
    }
    ///Bits 8:9 - CC2S
    #[inline(always)]
    pub fn cc2s(&mut self) -> CC2S_W<CCMR1ALTERNATE8rs> {
        CC2S_W::new(self, 8)
    }
    ///Bits 10:11 - IC2PSC
    #[inline(always)]
    pub fn ic2psc(&mut self) -> IC2PSC_W<CCMR1ALTERNATE8rs> {
        IC2PSC_W::new(self, 10)
    }
    ///Bits 12:15 - IC2F
    #[inline(always)]
    pub fn ic2f(&mut self) -> IC2F_W<CCMR1ALTERNATE8rs> {
        IC2F_W::new(self, 12)
    }
}
