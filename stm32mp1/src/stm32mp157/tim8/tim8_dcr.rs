#[doc = "Reader of register TIM8_DCR"]
pub type R = crate::R<u16, super::TIM8_DCR>;
#[doc = "Writer for register TIM8_DCR"]
pub type W = crate::W<u16, super::TIM8_DCR>;
#[doc = "Register TIM8_DCR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM8_DCR {
    type Type = u16;
    #[inline(always)]
