///Register `TIM8_DMAR` reader
pub type R = crate::R<TIM8_DMARrs>;
///Register `TIM8_DMAR` writer
...
You can [`read`](crate::Reg::read) this register and get [`tim8_dmar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim8_dmar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`tim8_dmar::R`](R) reader structure
impl crate::Readable for TIM8_DMARrs {}
///`write(|w| ..)` method takes [`tim8_dmar::W`](W) writer structure
impl crate::Writable for TIM8_DMARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM8_DMAR to value 0
