#[doc = "Writer for register TIM8_EGR"]
pub type W = crate::W<u16, super::TIM8_EGR>;
#[doc = "Register TIM8_EGR `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM8_EGR {
    type Type = u16;
    #[inline(always)]
