#[doc = "Reader of register TIM8_TISEL"]
pub type R = crate::R<u32, super::TIM8_TISEL>;
#[doc = "Writer for register TIM8_TISEL"]
pub type W = crate::W<u32, super::TIM8_TISEL>;
#[doc = "Register TIM8_TISEL `reset()`'s with value 0"]
impl crate::ResetValue for super::TIM8_TISEL {
    type Type = u32;
    #[inline(always)]
