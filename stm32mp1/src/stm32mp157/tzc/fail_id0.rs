///Register `FAIL_ID0` reader
pub type R = crate::R<FAIL_ID0rs>;
///Field `ID` reader - ID
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FAIL_ID0").field("id", &self.id()).finish()
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`fail_id0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TZC:FAIL_ID0)*/
pub struct FAIL_ID0rs;
impl crate::RegisterSpec for FAIL_ID0rs {
    type Ux = u32;
}
///`read()` method returns [`fail_id0::R`](R) reader structure
impl crate::Readable for FAIL_ID0rs {}
///`reset()` method sets FAIL_ID0 to value 0
impl crate::Resettable for FAIL_ID0rs {}
