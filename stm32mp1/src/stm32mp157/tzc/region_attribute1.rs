...
impl W {
    ///Bits 0:1 - FILTER_EN
    #[inline(always)]
    pub fn filter_en(&mut self) -> FILTER_EN_W<REGION_ATTRIBUTE1rs> {
        FILTER_EN_W::new(self, 0)
    }
    ///Bit 30 - S_RD_EN
    #[inline(always)]
    pub fn s_rd_en(&mut self) -> S_RD_EN_W<REGION_ATTRIBUTE1rs> {
        S_RD_EN_W::new(self, 30)
    }
    ///Bit 31 - S_WR_EN
    #[inline(always)]
    pub fn s_wr_en(&mut self) -> S_WR_EN_W<REGION_ATTRIBUTE1rs> {
