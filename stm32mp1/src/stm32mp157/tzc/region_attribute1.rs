///Register `REGION_ATTRIBUTE1` reader
pub type R = crate::R<REGION_ATTRIBUTE1rs>;
///Register `REGION_ATTRIBUTE1` writer
pub type W = crate::W<REGION_ATTRIBUTE1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION_ATTRIBUTE1")
...
impl W {
    ///Bits 0:1 - FILTER_EN
    #[inline(always)]
    pub fn filter_en(&mut self) -> FILTER_EN_W<'_, REGION_ATTRIBUTE1rs> {
        FILTER_EN_W::new(self, 0)
    }
    ///Bit 30 - S_RD_EN
    #[inline(always)]
    pub fn s_rd_en(&mut self) -> S_RD_EN_W<'_, REGION_ATTRIBUTE1rs> {
        S_RD_EN_W::new(self, 30)
    }
    ///Bit 31 - S_WR_EN
    #[inline(always)]
    pub fn s_wr_en(&mut self) -> S_WR_EN_W<'_, REGION_ATTRIBUTE1rs> {
        S_WR_EN_W::new(self, 31)
    }
}
/**Region x attributes.

You can [`read`](crate::Reg::read) this register and get [`region_attribute1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`region_attribute1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TZC:REGION_ATTRIBUTE1)*/
pub struct REGION_ATTRIBUTE1rs;
impl crate::RegisterSpec for REGION_ATTRIBUTE1rs {
    type Ux = u32;
}
///`read()` method returns [`region_attribute1::R`](R) reader structure
impl crate::Readable for REGION_ATTRIBUTE1rs {}
///`write(|w| ..)` method takes [`region_attribute1::W`](W) writer structure
impl crate::Writable for REGION_ATTRIBUTE1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets REGION_ATTRIBUTE1 to value 0
impl crate::Resettable for REGION_ATTRIBUTE1rs {}
