...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TZC_FAIL_CONTROL0")
...
You can [`read`](crate::Reg::read) this register and get [`tzc_fail_control0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
