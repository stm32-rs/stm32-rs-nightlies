///Register `TZC_REGION_ATTRIBUTE8` reader
pub type R = crate::R<TZC_REGION_ATTRIBUTE8rs>;
///Register `TZC_REGION_ATTRIBUTE8` writer
pub type W = crate::W<TZC_REGION_ATTRIBUTE8rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TZC_REGION_ATTRIBUTE8")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn filter_en(&mut self) -> FILTER_EN_W<TZC_REGION_ATTRIBUTE8rs> {
        FILTER_EN_W::new(self, 0)
    }
    ///Bit 30 - S_RD_EN
    #[inline(always)]
    #[must_use]
    pub fn s_rd_en(&mut self) -> S_RD_EN_W<TZC_REGION_ATTRIBUTE8rs> {
        S_RD_EN_W::new(self, 30)
    }
    ///Bit 31 - S_WR_EN
    #[inline(always)]
    #[must_use]
    pub fn s_wr_en(&mut self) -> S_WR_EN_W<TZC_REGION_ATTRIBUTE8rs> {
        S_WR_EN_W::new(self, 31)
    }
}
/**Region x attributes.

You can [`read`](crate::Reg::read) this register and get [`tzc_region_attribute8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tzc_region_attribute8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TZC:TZC_REGION_ATTRIBUTE8)*/
pub struct TZC_REGION_ATTRIBUTE8rs;
impl crate::RegisterSpec for TZC_REGION_ATTRIBUTE8rs {
    type Ux = u32;
}
///`read()` method returns [`tzc_region_attribute8::R`](R) reader structure
impl crate::Readable for TZC_REGION_ATTRIBUTE8rs {}
///`write(|w| ..)` method takes [`tzc_region_attribute8::W`](W) writer structure
impl crate::Writable for TZC_REGION_ATTRIBUTE8rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TZC_REGION_ATTRIBUTE8 to value 0
impl crate::Resettable for TZC_REGION_ATTRIBUTE8rs {
