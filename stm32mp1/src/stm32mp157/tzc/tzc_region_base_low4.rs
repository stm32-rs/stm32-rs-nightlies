///Register `TZC_REGION_BASE_LOW4` reader
pub type R = crate::R<TZC_REGION_BASE_LOW4rs>;
///Register `TZC_REGION_BASE_LOW4` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TZC_REGION_BASE_LOW4")
...
///`read()` method returns [`tzc_region_base_low4::R`](R) reader structure
impl crate::Readable for TZC_REGION_BASE_LOW4rs {}
///`write(|w| ..)` method takes [`tzc_region_base_low4::W`](W) writer structure
impl crate::Writable for TZC_REGION_BASE_LOW4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TZC_REGION_BASE_LOW4 to value 0
