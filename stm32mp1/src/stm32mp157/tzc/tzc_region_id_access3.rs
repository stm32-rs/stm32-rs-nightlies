#[doc = "Reader of register TZC_REGION_ID_ACCESS3"]
pub type R = crate::R<u32, super::TZC_REGION_ID_ACCESS3>;
#[doc = "Writer for register TZC_REGION_ID_ACCESS3"]
pub type W = crate::W<u32, super::TZC_REGION_ID_ACCESS3>;
#[doc = "Register TZC_REGION_ID_ACCESS3 `reset()`'s with value 0"]
impl crate::ResetValue for super::TZC_REGION_ID_ACCESS3 {
    type Type = u32;
    #[inline(always)]
