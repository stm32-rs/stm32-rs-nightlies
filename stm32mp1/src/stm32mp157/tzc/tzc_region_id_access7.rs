///Register `TZC_REGION_ID_ACCESS7` reader
pub type R = crate::R<TZC_REGION_ID_ACCESS7rs>;
///Register `TZC_REGION_ID_ACCESS7` writer
pub type W = crate::W<TZC_REGION_ID_ACCESS7rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TZC_REGION_ID_ACCESS7")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nsaid_rd_en(&mut self) -> NSAID_RD_EN_W<TZC_REGION_ID_ACCESS7rs> {
        NSAID_RD_EN_W::new(self, 0)
    }
    ///Bits 16:31 - NSAID_WR_EN
    #[inline(always)]
    #[must_use]
    pub fn nsaid_wr_en(&mut self) -> NSAID_WR_EN_W<TZC_REGION_ID_ACCESS7rs> {
        NSAID_WR_EN_W::new(self, 16)
    }
}
/**Region non-secure access based on NSAID.

You can [`read`](crate::Reg::read) this register and get [`tzc_region_id_access7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tzc_region_id_access7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#TZC:TZC_REGION_ID_ACCESS7)*/
pub struct TZC_REGION_ID_ACCESS7rs;
impl crate::RegisterSpec for TZC_REGION_ID_ACCESS7rs {
    type Ux = u32;
}
///`read()` method returns [`tzc_region_id_access7::R`](R) reader structure
impl crate::Readable for TZC_REGION_ID_ACCESS7rs {}
///`write(|w| ..)` method takes [`tzc_region_id_access7::W`](W) writer structure
impl crate::Writable for TZC_REGION_ID_ACCESS7rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TZC_REGION_ID_ACCESS7 to value 0
impl crate::Resettable for TZC_REGION_ID_ACCESS7rs {
