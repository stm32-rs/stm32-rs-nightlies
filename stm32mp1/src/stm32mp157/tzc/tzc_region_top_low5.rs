#[doc = "Reader of register TZC_REGION_TOP_LOW5"]
pub type R = crate::R<u32, super::TZC_REGION_TOP_LOW5>;
#[doc = "Writer for register TZC_REGION_TOP_LOW5"]
pub type W = crate::W<u32, super::TZC_REGION_TOP_LOW5>;
#[doc = "Register TZC_REGION_TOP_LOW5 `reset()`'s with value 0x0fff"]
impl crate::ResetValue for super::TZC_REGION_TOP_LOW5 {
    type Type = u32;
    #[inline(always)]
