#[doc = "Reader of register TZC_REGION_TOP_LOW6"]
pub type R = crate::R<u32, super::TZC_REGION_TOP_LOW6>;
#[doc = "Writer for register TZC_REGION_TOP_LOW6"]
pub type W = crate::W<u32, super::TZC_REGION_TOP_LOW6>;
#[doc = "Register TZC_REGION_TOP_LOW6 `reset()`'s with value 0x0fff"]
impl crate::ResetValue for super::TZC_REGION_TOP_LOW6 {
    type Type = u32;
    #[inline(always)]
