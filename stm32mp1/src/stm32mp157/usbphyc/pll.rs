...
impl W {
    ///Bits 0:6 - PLLNDIV
    #[inline(always)]
    pub fn pllndiv(&mut self) -> PLLNDIV_W<PLLrs> {
        PLLNDIV_W::new(self, 0)
    }
    ///Bits 7:9 - PLLODF
    #[inline(always)]
    pub fn pllodf(&mut self) -> PLLODF_W<PLLrs> {
        PLLODF_W::new(self, 7)
    }
    ///Bits 10:25 - PLLFRACIN
    #[inline(always)]
    pub fn pllfracin(&mut self) -> PLLFRACIN_W<PLLrs> {
        PLLFRACIN_W::new(self, 10)
    }
    ///Bit 26 - PLLEN
    #[inline(always)]
    pub fn pllen(&mut self) -> PLLEN_W<PLLrs> {
        PLLEN_W::new(self, 26)
    }
    ///Bit 27 - PLLSTRB
    #[inline(always)]
    pub fn pllstrb(&mut self) -> PLLSTRB_W<PLLrs> {
        PLLSTRB_W::new(self, 27)
    }
    ///Bit 28 - PLLSTRBYP
    #[inline(always)]
    pub fn pllstrbyp(&mut self) -> PLLSTRBYP_W<PLLrs> {
        PLLSTRBYP_W::new(self, 28)
    }
    ///Bit 29 - PLLFRACCTL
    #[inline(always)]
    pub fn pllfracctl(&mut self) -> PLLFRACCTL_W<PLLrs> {
        PLLFRACCTL_W::new(self, 29)
    }
    ///Bit 30 - PLLDITHEN0
    #[inline(always)]
    pub fn plldithen0(&mut self) -> PLLDITHEN0_W<PLLrs> {
        PLLDITHEN0_W::new(self, 30)
    }
    ///Bit 31 - PLLDITHEN1
    #[inline(always)]
    pub fn plldithen1(&mut self) -> PLLDITHEN1_W<PLLrs> {
