...
pub type R = crate::R<USBPHYC_TUNE1rs>;
///Register `USBPHYC_TUNE1` writer
pub type W = crate::W<USBPHYC_TUNE1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn incurren(&mut self) -> INCURREN_W<USBPHYC_TUNE1rs> {
        INCURREN_W::new(self, 0)
    }
    ///Bit 1 - INCURRINT
    #[inline(always)]
    #[must_use]
    pub fn incurrint(&mut self) -> INCURRINT_W<USBPHYC_TUNE1rs> {
        INCURRINT_W::new(self, 1)
    }
    ///Bit 2 - LFSCAPEN
    #[inline(always)]
    #[must_use]
    pub fn lfscapen(&mut self) -> LFSCAPEN_W<USBPHYC_TUNE1rs> {
        LFSCAPEN_W::new(self, 2)
    }
    ///Bit 3 - HSDRVSLEW
    #[inline(always)]
    #[must_use]
    pub fn hsdrvslew(&mut self) -> HSDRVSLEW_W<USBPHYC_TUNE1rs> {
        HSDRVSLEW_W::new(self, 3)
    }
    ///Bit 4 - HSDRVDCCUR
    #[inline(always)]
    #[must_use]
    pub fn hsdrvdccur(&mut self) -> HSDRVDCCUR_W<USBPHYC_TUNE1rs> {
        HSDRVDCCUR_W::new(self, 4)
    }
    ///Bit 5 - HSDRVDCLEV
    #[inline(always)]
    #[must_use]
    pub fn hsdrvdclev(&mut self) -> HSDRVDCLEV_W<USBPHYC_TUNE1rs> {
        HSDRVDCLEV_W::new(self, 5)
    }
    ///Bit 6 - HSDRVCURINCR
    #[inline(always)]
    #[must_use]
    pub fn hsdrvcurincr(&mut self) -> HSDRVCURINCR_W<USBPHYC_TUNE1rs> {
        HSDRVCURINCR_W::new(self, 6)
    }
    ///Bit 7 - FSDRVRFADJ
    #[inline(always)]
    #[must_use]
    pub fn fsdrvrfadj(&mut self) -> FSDRVRFADJ_W<USBPHYC_TUNE1rs> {
        FSDRVRFADJ_W::new(self, 7)
    }
    ///Bit 8 - HSDRVRFRED
    #[inline(always)]
    #[must_use]
    pub fn hsdrvrfred(&mut self) -> HSDRVRFRED_W<USBPHYC_TUNE1rs> {
        HSDRVRFRED_W::new(self, 8)
    }
    ///Bits 9:12 - HSDRVCHKITRM
    #[inline(always)]
    #[must_use]
    pub fn hsdrvchkitrm(&mut self) -> HSDRVCHKITRM_W<USBPHYC_TUNE1rs> {
        HSDRVCHKITRM_W::new(self, 9)
    }
    ///Bits 13:14 - HSDRVCHKZTRM
    #[inline(always)]
    #[must_use]
    pub fn hsdrvchkztrm(&mut self) -> HSDRVCHKZTRM_W<USBPHYC_TUNE1rs> {
        HSDRVCHKZTRM_W::new(self, 13)
    }
    ///Bits 15:19 - OTPCOMP
    #[inline(always)]
    #[must_use]
    pub fn otpcomp(&mut self) -> OTPCOMP_W<USBPHYC_TUNE1rs> {
        OTPCOMP_W::new(self, 15)
    }
    ///Bits 20:21 - SQLCHCTL
    #[inline(always)]
    #[must_use]
    pub fn sqlchctl(&mut self) -> SQLCHCTL_W<USBPHYC_TUNE1rs> {
        SQLCHCTL_W::new(self, 20)
    }
    ///Bit 22 - HDRXGNEQEN
    #[inline(always)]
    #[must_use]
    pub fn hdrxgneqen(&mut self) -> HDRXGNEQEN_W<USBPHYC_TUNE1rs> {
        HDRXGNEQEN_W::new(self, 22)
    }
    ///Bits 23:24 - HSRXOFF
    #[inline(always)]
    #[must_use]
    pub fn hsrxoff(&mut self) -> HSRXOFF_W<USBPHYC_TUNE1rs> {
        HSRXOFF_W::new(self, 23)
    }
    ///Bit 25 - HSFALLPREEM
    #[inline(always)]
    #[must_use]
    pub fn hsfallpreem(&mut self) -> HSFALLPREEM_W<USBPHYC_TUNE1rs> {
        HSFALLPREEM_W::new(self, 25)
    }
    ///Bit 26 - SHTCCTCTLPROT
    #[inline(always)]
    #[must_use]
    pub fn shtcctctlprot(&mut self) -> SHTCCTCTLPROT_W<USBPHYC_TUNE1rs> {
        SHTCCTCTLPROT_W::new(self, 26)
    }
    ///Bit 27 - STAGSEL
    #[inline(always)]
    #[must_use]
    pub fn stagsel(&mut self) -> STAGSEL_W<USBPHYC_TUNE1rs> {
        STAGSEL_W::new(self, 27)
    }
}
/**This register is used to control the tune interface of the HS PHY, port #x.

You can [`read`](crate::Reg::read) this register and get [`usbphyc_tune1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usbphyc_tune1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32MP157.html#USBPHYC:USBPHYC_TUNE1)*/
pub struct USBPHYC_TUNE1rs;
impl crate::RegisterSpec for USBPHYC_TUNE1rs {
    type Ux = u32;
}
///`read()` method returns [`usbphyc_tune1::R`](R) reader structure
impl crate::Readable for USBPHYC_TUNE1rs {}
///`write(|w| ..)` method takes [`usbphyc_tune1::W`](W) writer structure
impl crate::Writable for USBPHYC_TUNE1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets USBPHYC_TUNE1 to value 0x0407_0004
impl crate::Resettable for USBPHYC_TUNE1rs {
