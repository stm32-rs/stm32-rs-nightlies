...
impl W {
    ///Bit 24 - Positive offset enable
    #[inline(always)]
    pub fn posoff(&mut self) -> POSOFF_W<OFCFGR4rs> {
        POSOFF_W::new(self, 24)
    }
    ///Bit 25 - Unsigned saturation enable
    #[inline(always)]
    pub fn usat(&mut self) -> USAT_W<OFCFGR4rs> {
        USAT_W::new(self, 25)
    }
    ///Bit 26 - Signed saturation enable
    #[inline(always)]
    pub fn ssat(&mut self) -> SSAT_W<OFCFGR4rs> {
        SSAT_W::new(self, 26)
    }
    ///Bits 27:31 - Channel selection for the data offset y
    #[inline(always)]
    pub fn offset_ch(&mut self) -> OFFSET_CH_W<OFCFGR4rs> {
