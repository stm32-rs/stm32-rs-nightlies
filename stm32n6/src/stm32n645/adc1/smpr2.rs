...
///Field `SMP12` writer - Channel x sampling time selection
pub type SMP12_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `SMP13` reader - Channel x sampling time selection
pub type SMP13_R = crate::FieldReader;
///Field `SMP13` writer - Channel x sampling time selection
...
impl R {
    ...
    ///Bits 15:17 - Channel x sampling time selection
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ADC1:SMPR2)*/
pub struct SMPR2rs;
