...
///Field `TRGO` reader - Trigger output control
pub type TRGO_R = crate::BitReader;
///Field `TRGO` writer - Trigger output control
pub type TRGO_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Trigger output control
    #[inline(always)]
...
impl W {
    ///Bit 0 - Trigger output control
    #[inline(always)]
    pub fn trgo(&mut self) -> TRGO_W<'_, GCRrs> {
        TRGO_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ADF:GCR)*/
pub struct GCRrs;
