...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SPLOCK0` field.</div>
    #[inline(always)]
    pub fn splock(&mut self, n: u8) -> SPLOCK_W<SPLOCKrs> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        SPLOCK_W::new(self, n)
    }
    ///Bit 0 - Sticky programming lock for word 0
    #[inline(always)]
    pub fn splock0(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 0)
    }
    ///Bit 1 - Sticky programming lock for word 1
    #[inline(always)]
    pub fn splock1(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 1)
    }
    ///Bit 2 - Sticky programming lock for word 2
    #[inline(always)]
    pub fn splock2(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 2)
    }
    ///Bit 3 - Sticky programming lock for word 3
    #[inline(always)]
    pub fn splock3(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 3)
    }
    ///Bit 4 - Sticky programming lock for word 4
    #[inline(always)]
    pub fn splock4(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 4)
    }
    ///Bit 5 - Sticky programming lock for word 5
    #[inline(always)]
    pub fn splock5(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 5)
    }
    ///Bit 6 - Sticky programming lock for word 6
    #[inline(always)]
    pub fn splock6(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 6)
    }
    ///Bit 7 - Sticky programming lock for word 7
    #[inline(always)]
    pub fn splock7(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 7)
    }
    ///Bit 8 - Sticky programming lock for word 8
    #[inline(always)]
    pub fn splock8(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 8)
    }
    ///Bit 9 - Sticky programming lock for word 9
    #[inline(always)]
    pub fn splock9(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 9)
    }
    ///Bit 10 - Sticky programming lock for word 10
    #[inline(always)]
    pub fn splock10(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 10)
    }
    ///Bit 11 - Sticky programming lock for word 11
    #[inline(always)]
    pub fn splock11(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 11)
    }
    ///Bit 12 - Sticky programming lock for word 12
    #[inline(always)]
    pub fn splock12(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 12)
    }
    ///Bit 13 - Sticky programming lock for word 13
    #[inline(always)]
    pub fn splock13(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 13)
    }
    ///Bit 14 - Sticky programming lock for word 14
    #[inline(always)]
    pub fn splock14(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 14)
    }
    ///Bit 15 - Sticky programming lock for word 15
    #[inline(always)]
    pub fn splock15(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 15)
    }
    ///Bit 16 - Sticky programming lock for word 16
    #[inline(always)]
    pub fn splock16(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 16)
    }
    ///Bit 17 - Sticky programming lock for word 17
    #[inline(always)]
    pub fn splock17(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 17)
    }
    ///Bit 18 - Sticky programming lock for word 18
    #[inline(always)]
    pub fn splock18(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 18)
    }
    ///Bit 19 - Sticky programming lock for word 19
    #[inline(always)]
    pub fn splock19(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 19)
    }
    ///Bit 20 - Sticky programming lock for word 20
    #[inline(always)]
    pub fn splock20(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 20)
    }
    ///Bit 21 - Sticky programming lock for word 21
    #[inline(always)]
    pub fn splock21(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 21)
    }
    ///Bit 22 - Sticky programming lock for word 22
    #[inline(always)]
    pub fn splock22(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 22)
    }
    ///Bit 23 - Sticky programming lock for word 23
    #[inline(always)]
    pub fn splock23(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 23)
    }
    ///Bit 24 - Sticky programming lock for word 24
    #[inline(always)]
    pub fn splock24(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 24)
    }
    ///Bit 25 - Sticky programming lock for word 25
    #[inline(always)]
    pub fn splock25(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 25)
    }
    ///Bit 26 - Sticky programming lock for word 26
    #[inline(always)]
    pub fn splock26(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 26)
    }
    ///Bit 27 - Sticky programming lock for word 27
    #[inline(always)]
    pub fn splock27(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 27)
    }
    ///Bit 28 - Sticky programming lock for word 28
    #[inline(always)]
    pub fn splock28(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 28)
    }
    ///Bit 29 - Sticky programming lock for word 29
    #[inline(always)]
    pub fn splock29(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 29)
    }
    ///Bit 30 - Sticky programming lock for word 30
    #[inline(always)]
    pub fn splock30(&mut self) -> SPLOCK_W<SPLOCKrs> {
        SPLOCK_W::new(self, 30)
    }
    ///Bit 31 - Sticky programming lock for word 31
    #[inline(always)]
    pub fn splock31(&mut self) -> SPLOCK_W<SPLOCKrs> {
