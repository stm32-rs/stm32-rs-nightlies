...
impl W {
    ///Bits 0:1 - Line/byte counter 0 linked to a virtual channel
    #[inline(always)]
    pub fn lb0vc(&mut self) -> LB0VC_W<PRGITRrs> {
        LB0VC_W::new(self, 0)
    }
    ///Bit 3 - Line/byte 0 counter enable
    #[inline(always)]
    pub fn lb0en(&mut self) -> LB0EN_W<PRGITRrs> {
        LB0EN_W::new(self, 3)
    }
    ///Bits 4:5 - Line/byte counter 1 linked to a virtual channel
    #[inline(always)]
    pub fn lb1vc(&mut self) -> LB1VC_W<PRGITRrs> {
        LB1VC_W::new(self, 4)
    }
    ///Bit 7 - Line/byte 1 counter enable
    #[inline(always)]
    pub fn lb1en(&mut self) -> LB1EN_W<PRGITRrs> {
        LB1EN_W::new(self, 7)
    }
    ///Bits 8:9 - Line/byte counter 2 linked to a virtual channel
    #[inline(always)]
    pub fn lb2vc(&mut self) -> LB2VC_W<PRGITRrs> {
        LB2VC_W::new(self, 8)
    }
    ///Bit 11 - Line/byte 2 counter enable
    #[inline(always)]
    pub fn lb2en(&mut self) -> LB2EN_W<PRGITRrs> {
        LB2EN_W::new(self, 11)
    }
    ///Bits 12:13 - Line/byte counter 3 linked to a virtual channel
    #[inline(always)]
    pub fn lb3vc(&mut self) -> LB3VC_W<PRGITRrs> {
        LB3VC_W::new(self, 12)
    }
    ///Bit 15 - Line/byte 3 counter enable
    #[inline(always)]
    pub fn lb3en(&mut self) -> LB3EN_W<PRGITRrs> {
        LB3EN_W::new(self, 15)
    }
    ///Bits 16:17 - TIM0 base time linked to a virtual channel
    #[inline(always)]
    pub fn tim0vc(&mut self) -> TIM0VC_W<PRGITRrs> {
        TIM0VC_W::new(self, 16)
    }
    ///Bit 18 - TIM0 base time starting from the EOF
    #[inline(always)]
    pub fn tim0eof(&mut self) -> TIM0EOF_W<PRGITRrs> {
        TIM0EOF_W::new(self, 18)
    }
    ///Bit 19 - TIM0 base time enable
    #[inline(always)]
    pub fn tim0en(&mut self) -> TIM0EN_W<PRGITRrs> {
        TIM0EN_W::new(self, 19)
    }
    ///Bits 20:21 - TIM1 base time linked to a virtual channel
    #[inline(always)]
    pub fn tim1vc(&mut self) -> TIM1VC_W<PRGITRrs> {
        TIM1VC_W::new(self, 20)
    }
    ///Bit 22 - TIM1 base time starting from the EOF
    #[inline(always)]
    pub fn tim1eof(&mut self) -> TIM1EOF_W<PRGITRrs> {
        TIM1EOF_W::new(self, 22)
    }
    ///Bit 23 - TIM1 base time enable
    #[inline(always)]
    pub fn tim1en(&mut self) -> TIM1EN_W<PRGITRrs> {
        TIM1EN_W::new(self, 23)
    }
    ///Bits 24:25 - TIM2 base time linked to a virtual channel
    #[inline(always)]
    pub fn tim2vc(&mut self) -> TIM2VC_W<PRGITRrs> {
        TIM2VC_W::new(self, 24)
    }
    ///Bit 26 - TIM2 base time starting from the EOF
    #[inline(always)]
    pub fn tim2eof(&mut self) -> TIM2EOF_W<PRGITRrs> {
        TIM2EOF_W::new(self, 26)
    }
    ///Bit 27 - TIM2 base time enable
    #[inline(always)]
    pub fn tim2en(&mut self) -> TIM2EN_W<PRGITRrs> {
        TIM2EN_W::new(self, 27)
    }
    ///Bits 28:29 - TIM3 base time linked to a virtual channel
    #[inline(always)]
    pub fn tim3vc(&mut self) -> TIM3VC_W<PRGITRrs> {
        TIM3VC_W::new(self, 28)
    }
    ///Bit 30 - TIM3 base time starting from the EOF
    #[inline(always)]
    pub fn tim3eof(&mut self) -> TIM3EOF_W<PRGITRrs> {
        TIM3EOF_W::new(self, 30)
    }
    ///Bit 31 - TIM3 base time enable
    #[inline(always)]
    pub fn tim3en(&mut self) -> TIM3EN_W<PRGITRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#CSI:PRGITR)*/
pub struct PRGITRrs;
