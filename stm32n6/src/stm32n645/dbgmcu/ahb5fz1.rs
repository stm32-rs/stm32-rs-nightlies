...
impl W {
    ///Bit 0 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch0_stop(&mut self) -> DBG_HPDMA1_CH0_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH0_STOP_W::new(self, 0)
    }
    ///Bit 1 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch1_stop(&mut self) -> DBG_HPDMA1_CH1_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH1_STOP_W::new(self, 1)
    }
    ///Bit 2 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch2_stop(&mut self) -> DBG_HPDMA1_CH2_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH2_STOP_W::new(self, 2)
    }
    ///Bit 3 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch3_stop(&mut self) -> DBG_HPDMA1_CH3_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH3_STOP_W::new(self, 3)
    }
    ///Bit 4 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch4_stop(&mut self) -> DBG_HPDMA1_CH4_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH4_STOP_W::new(self, 4)
    }
    ///Bit 5 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch5_stop(&mut self) -> DBG_HPDMA1_CH5_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH5_STOP_W::new(self, 5)
    }
    ///Bit 6 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch6_stop(&mut self) -> DBG_HPDMA1_CH6_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH6_STOP_W::new(self, 6)
    }
    ///Bit 7 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch7_stop(&mut self) -> DBG_HPDMA1_CH7_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH7_STOP_W::new(self, 7)
    }
    ///Bit 8 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch8_stop(&mut self) -> DBG_HPDMA1_CH8_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH8_STOP_W::new(self, 8)
    }
    ///Bit 9 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch9_stop(&mut self) -> DBG_HPDMA1_CH9_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH9_STOP_W::new(self, 9)
    }
    ///Bit 10 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch10_stop(&mut self) -> DBG_HPDMA1_CH10_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH10_STOP_W::new(self, 10)
    }
    ///Bit 11 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch11_stop(&mut self) -> DBG_HPDMA1_CH11_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH11_STOP_W::new(self, 11)
    }
    ///Bit 12 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch12_stop(&mut self) -> DBG_HPDMA1_CH12_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH12_STOP_W::new(self, 12)
    }
    ///Bit 13 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch13_stop(&mut self) -> DBG_HPDMA1_CH13_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH13_STOP_W::new(self, 13)
    }
    ///Bit 14 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch14_stop(&mut self) -> DBG_HPDMA1_CH14_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH14_STOP_W::new(self, 14)
    }
    ///Bit 15 - HPDMA3_CHn suspend in debug
    #[inline(always)]
    pub fn dbg_hpdma1_ch15_stop(&mut self) -> DBG_HPDMA1_CH15_STOP_W<'_, AHB5FZ1rs> {
        DBG_HPDMA1_CH15_STOP_W::new(self, 15)
    }
    ///Bit 16 - NPU stop in debug mode
    #[inline(always)]
    pub fn npu_dbg_freeze(&mut self) -> NPU_DBG_FREEZE_W<'_, AHB5FZ1rs> {
