...
impl W {
    ///Bits 0:9 - Start word (AXI width = 64 bits) of the FIFO of Clientx.
    #[inline(always)]
    pub fn dpregstart(&mut self) -> DPREGSTART_W<IPC3R3rs> {
        DPREGSTART_W::new(self, 0)
    }
    ///Bits 16:25 - End word (AXI width = 64 bits) of the FIFO of Clientx.
    #[inline(always)]
    pub fn dpregend(&mut self) -> DPREGEND_W<IPC3R3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:IPC3R3)*/
pub struct IPC3R3rs;
