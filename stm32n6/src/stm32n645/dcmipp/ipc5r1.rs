...
impl W {
    ///Bits 0:2 - Burst size as power of 2 of 8-byte units
    #[inline(always)]
    pub fn traffic(&mut self) -> TRAFFIC_W<IPC5R1rs> {
        TRAFFIC_W::new(self, 0)
    }
    ///Bits 8:11 - Maximum outstanding transactions
    #[inline(always)]
    pub fn otr(&mut self) -> OTR_W<IPC5R1rs> {
        OTR_W::new(self, 8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:IPC5R1)*/
pub struct IPC5R1rs;
