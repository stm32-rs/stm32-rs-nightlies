...
impl W {
    ///Bit 0 - Swaps, within a 32-bit word, byte 0-vs-1 and byte 2-vs-3. It corresponds, for YUV422 pixels formats, to swap between UYVY and YUYV.
    #[inline(always)]
    pub fn swapyuv(&mut self) -> SWAPYUV_W<P0PPCRrs> {
    ...
    ///Bit 6 - CSI header dump enable
    #[inline(always)]
    pub fn headeren(&mut self) -> HEADEREN_W<P0PPCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P0PPCR)*/
pub struct P0PPCRrs;
