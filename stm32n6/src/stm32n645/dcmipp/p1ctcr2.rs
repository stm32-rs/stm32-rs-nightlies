...
impl W {
    ///Bits 1:6 - Luminance increase for input luminance of 128 (increase is idle with LUMx = 16)
    #[inline(always)]
    pub fn lum4(&mut self) -> LUM4_W<P1CTCR2rs> {
        LUM4_W::new(self, 1)
    }
    ///Bits 9:14 - Luminance increase for input luminance of 96 (increase is idle with LUMx = 16)
    #[inline(always)]
    pub fn lum3(&mut self) -> LUM3_W<P1CTCR2rs> {
        LUM3_W::new(self, 9)
    }
    ///Bits 17:22 - Luminance increase for input luminance of 64 (increase is idle with LUMx = 16)
    #[inline(always)]
    pub fn lum2(&mut self) -> LUM2_W<P1CTCR2rs> {
        LUM2_W::new(self, 17)
    }
    ///Bits 25:30 - Luminance increase for input luminance of 32 (increase is idle with LUMx = 16)
    #[inline(always)]
    pub fn lum1(&mut self) -> LUM1_W<P1CTCR2rs> {
        LUM1_W::new(self, 25)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P1CTCR2)*/
