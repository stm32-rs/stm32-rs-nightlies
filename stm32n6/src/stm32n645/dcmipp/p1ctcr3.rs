...
impl W {
    ///Bits 1:6 - Luminance increase for input luminance of 256 (increase is idle with LUMx = 16)
    #[inline(always)]
    pub fn lum8(&mut self) -> LUM8_W<P1CTCR3rs> {
        LUM8_W::new(self, 1)
    }
    ///Bits 9:14 - Luminance increase for input luminance of 224 (increase is idle with LUMx = 16)
    #[inline(always)]
    pub fn lum7(&mut self) -> LUM7_W<P1CTCR3rs> {
        LUM7_W::new(self, 9)
    }
    ///Bits 17:22 - Luminance increase for input luminance of 192 (increase is idle with LUMx = 16)
    #[inline(always)]
    pub fn lum6(&mut self) -> LUM6_W<P1CTCR3rs> {
        LUM6_W::new(self, 17)
    }
    ///Bits 25:30 - Luminance increase for input luminance of 160 (increase is idle with LUMx = 16)
    #[inline(always)]
    pub fn lum5(&mut self) -> LUM5_W<P1CTCR3rs> {
        LUM5_W::new(self, 25)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P1CTCR3)*/
