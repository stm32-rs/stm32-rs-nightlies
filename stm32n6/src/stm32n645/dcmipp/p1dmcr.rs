...
impl W {
    ///Bit 0 - None
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<P1DMCRrs> {
        ENABLE_W::new(self, 0)
    }
    ///Bits 1:2 - Raw Bayer type
    #[inline(always)]
    pub fn type_(&mut self) -> TYPE_W<P1DMCRrs> {
        TYPE_W::new(self, 1)
    }
    ///Bits 16:18 - Strength of the peak detection
    #[inline(always)]
    pub fn peak(&mut self) -> PEAK_W<P1DMCRrs> {
        PEAK_W::new(self, 16)
    }
    ///Bits 20:22 - Strength of the vertical line detection
    #[inline(always)]
    pub fn linev(&mut self) -> LINEV_W<P1DMCRrs> {
        LINEV_W::new(self, 20)
    }
    ///Bits 24:26 - Strength of the horizontal line detection
    #[inline(always)]
    pub fn lineh(&mut self) -> LINEH_W<P1DMCRrs> {
        LINEH_W::new(self, 24)
    }
    ///Bits 28:30 - Strength of the edge detection
    #[inline(always)]
    pub fn edge(&mut self) -> EDGE_W<P1DMCRrs> {
        EDGE_W::new(self, 28)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P1DMCR)*/
pub struct P1DMCRrs;
