...
impl W {
    ///Bits 4:11 - Exposure multiplier - Blue
    #[inline(always)]
    pub fn multb(&mut self) -> MULTB_W<P1EXCR2rs> {
        MULTB_W::new(self, 4)
    }
    ///Bits 12:14 - Exposure shift - Blue
    #[inline(always)]
    pub fn shfb(&mut self) -> SHFB_W<P1EXCR2rs> {
        SHFB_W::new(self, 12)
    }
    ///Bits 20:27 - Exposure multiplier - Green
    #[inline(always)]
    pub fn multg(&mut self) -> MULTG_W<P1EXCR2rs> {
        MULTG_W::new(self, 20)
    }
    ///Bits 28:30 - Exposure shift - Green
    #[inline(always)]
    pub fn shfg(&mut self) -> SHFG_W<P1EXCR2rs> {
        SHFG_W::new(self, 28)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P1EXCR2)*/
