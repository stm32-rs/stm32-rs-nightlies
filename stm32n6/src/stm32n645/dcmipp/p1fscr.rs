...
impl W {
    ///Bits 0:5 - Data type selection ID A
    #[inline(always)]
    pub fn dtida(&mut self) -> DTIDA_W<P1FSCRrs> {
        DTIDA_W::new(self, 0)
    }
    ///Bits 8:13 - Data type selection ID B
    #[inline(always)]
    pub fn dtidb(&mut self) -> DTIDB_W<P1FSCRrs> {
        DTIDB_W::new(self, 8)
    }
    ///Bits 16:17 - Flow selection mode
    #[inline(always)]
    pub fn dtmode(&mut self) -> DTMODE_W<P1FSCRrs> {
        DTMODE_W::new(self, 16)
    }
    ///Bit 18 - Differentiates Pipe2 from Pipe1
    #[inline(always)]
    pub fn pipediff(&mut self) -> PIPEDIFF_W<P1FSCRrs> {
        PIPEDIFF_W::new(self, 18)
    }
    ///Bits 19:20 - Flow selection mode
    #[inline(always)]
    pub fn vc(&mut self) -> VC_W<P1FSCRrs> {
        VC_W::new(self, 19)
    }
    ///Bits 24:29 - Force Datatype format.
    #[inline(always)]
    pub fn fdtf(&mut self) -> FDTF_W<P1FSCRrs> {
        FDTF_W::new(self, 24)
    }
    ///Bit 30 - Force Datatype format enable.
    #[inline(always)]
    pub fn fdtfen(&mut self) -> FDTFEN_W<P1FSCRrs> {
        FDTFEN_W::new(self, 30)
    }
    ///Bit 31 - Activation of PipeN
    #[inline(always)]
    pub fn pipen(&mut self) -> PIPEN_W<P1FSCRrs> {
        PIPEN_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P1FSCR)*/
pub struct P1FSCRrs;
