...
impl W {
    ///Bit 0 - None
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<P1ST2CRrs> {
        ENABLE_W::new(self, 0)
    }
    ///Bits 2:3 - Bin definition
    #[inline(always)]
    pub fn bins(&mut self) -> BINS_W<P1ST2CRrs> {
        BINS_W::new(self, 2)
    }
    ///Bits 4:6 - Statistics source
    #[inline(always)]
    pub fn src(&mut self) -> SRC_W<P1ST2CRrs> {
        SRC_W::new(self, 4)
    }
    ///Bit 7 - Statistics mode
    #[inline(always)]
    pub fn mode(&mut self) -> MODE_W<P1ST2CRrs> {
        MODE_W::new(self, 7)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P1ST2CR)*/
