///Register `P2CCMRICR` reader
pub type R = crate::R<P2CCMRICRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`p2ccmricr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P2CCMRICR)*/
pub struct P2CCMRICRrs;
impl crate::RegisterSpec for P2CCMRICRrs {
    type Ux = u32;
}
///`read()` method returns [`p2ccmricr::R`](R) reader structure
impl crate::Readable for P2CCMRICRrs {}
///`reset()` method sets P2CCMRICR to value 0
impl crate::Resettable for P2CCMRICRrs {}
