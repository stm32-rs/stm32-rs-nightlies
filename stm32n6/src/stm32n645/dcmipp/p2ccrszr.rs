///Register `P2CCRSZR` reader
pub type R = crate::R<P2CCRSZRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`p2ccrszr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P2CCRSZR)*/
pub struct P2CCRSZRrs;
impl crate::RegisterSpec for P2CCRSZRrs {
    type Ux = u32;
}
///`read()` method returns [`p2ccrszr::R`](R) reader structure
impl crate::Readable for P2CCRSZRrs {}
///`reset()` method sets P2CCRSZR to value 0
impl crate::Resettable for P2CCRSZRrs {}
