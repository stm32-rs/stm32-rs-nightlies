...
impl W {
    ///Bits 0:5 - Data type ID
    #[inline(always)]
    pub fn dtida(&mut self) -> DTIDA_W<P2FSCRrs> {
        DTIDA_W::new(self, 0)
    }
    ///Bits 19:20 - Flow selection mode
    #[inline(always)]
    pub fn vc(&mut self) -> VC_W<P2FSCRrs> {
        VC_W::new(self, 19)
    }
    ///Bits 24:29 - Force data type format
    #[inline(always)]
    pub fn fdtf(&mut self) -> FDTF_W<P2FSCRrs> {
        FDTF_W::new(self, 24)
    }
    ///Bit 30 - Force data type format enable
    #[inline(always)]
    pub fn fdtfen(&mut self) -> FDTFEN_W<P2FSCRrs> {
        FDTFEN_W::new(self, 30)
    }
    ///Bit 31 - Activation of PipeN
    #[inline(always)]
    pub fn pipen(&mut self) -> PIPEN_W<P2FSCRrs> {
        PIPEN_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:P2FSCR)*/
pub struct P2FSCRrs;
