...
impl W {
    ///Bits 0:7 - Frame start delimiter unmask
    #[inline(always)]
    pub fn fsu(&mut self) -> FSU_W<PRESURrs> {
        FSU_W::new(self, 0)
    }
    ///Bits 8:15 - Line start delimiter unmask
    #[inline(always)]
    pub fn lsu(&mut self) -> LSU_W<PRESURrs> {
        LSU_W::new(self, 8)
    }
    ///Bits 16:23 - Line end delimiter unmask
    #[inline(always)]
    pub fn leu(&mut self) -> LEU_W<PRESURrs> {
        LEU_W::new(self, 16)
    }
    ///Bits 24:31 - Frame end delimiter unmask
    #[inline(always)]
    pub fn feu(&mut self) -> FEU_W<PRESURrs> {
        FEU_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DCMIPP:PRESUR)*/
pub struct PRESURrs;
