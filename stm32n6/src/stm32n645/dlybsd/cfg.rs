...
impl W {
    ///Bit 0 - DLL enable
    #[inline(always)]
    pub fn sdmmc_dll_en(&mut self) -> SDMMC_DLL_EN_W<CFGrs> {
        SDMMC_DLL_EN_W::new(self, 0)
    }
    ///Bits 1:6 - selection of RX delay
    #[inline(always)]
    pub fn sdmmc_rx_tap_sel(&mut self) -> SDMMC_RX_TAP_SEL_W<CFGrs> {
        SDMMC_RX_TAP_SEL_W::new(self, 1)
    }
    ///Bit 16 - DLL configuration
    #[inline(always)]
    pub fn sdmmc_dll_byp_en(&mut self) -> SDMMC_DLL_BYP_EN_W<CFGrs> {
        SDMMC_DLL_BYP_EN_W::new(self, 16)
    }
    ///Bits 17:21 - Bypass command
    #[inline(always)]
    pub fn sdmmc_dll_byp_cmd(&mut self) -> SDMMC_DLL_BYP_CMD_W<CFGrs> {
        SDMMC_DLL_BYP_CMD_W::new(self, 17)
    }
    ///Bit 22 - Antiglitch logic enabled when 1
    #[inline(always)]
    pub fn sdmmc_dll_antiglitch_en(&mut self) -> SDMMC_DLL_ANTIGLITCH_EN_W<CFGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DLYBSD:CFG)*/
pub struct CFGrs;
