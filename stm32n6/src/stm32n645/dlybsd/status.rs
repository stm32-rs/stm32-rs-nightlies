...
impl W {
    ///Bit 0 - SDMMC DLL lock
    #[inline(always)]
    pub fn sdmmc_dll_lock(&mut self) -> SDMMC_DLL_LOCK_W<STATUSrs> {
        SDMMC_DLL_LOCK_W::new(self, 0)
    }
    ///Bit 1 - SDMMC RX delay selection acknowledge
    #[inline(always)]
    pub fn sdmmc_rx_tap_sel_ack(&mut self) -> SDMMC_RX_TAP_SEL_ACK_W<STATUSrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DLYBSD:STATUS)*/
pub struct STATUSrs;
