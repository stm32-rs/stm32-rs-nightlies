...
///Field `MA` reader - Memory address, address of the data used for the foreground image
pub type MA_R = crate::FieldReader<u32>;
///Field `MA` writer - Memory address, address of the data used for the foreground image
pub type MA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Memory address, address of the data used for the foreground image
    #[inline(always)]
    pub fn ma(&self) -> MA_R {
        MA_R::new(self.bits)
    }
