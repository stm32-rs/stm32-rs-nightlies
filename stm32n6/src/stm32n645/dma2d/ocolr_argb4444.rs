...
///Field `BLUE` reader - Blue value of the output image in ARGB4444 mode
pub type BLUE_R = crate::FieldReader;
///Field `BLUE` writer - Blue value of the output image in ARGB4444 mode
pub type BLUE_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `GREEN` reader - Green value of the output image in ARGB4444 mode
pub type GREEN_R = crate::FieldReader;
///Field `GREEN` writer - Green value of the output image in ARGB4444 mode
pub type GREEN_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `RED` reader - Red value of the output image in ARGB4444 mode
pub type RED_R = crate::FieldReader;
///Field `RED` writer - Red value of the output image in ARGB4444 mode
pub type RED_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `ALPHA` reader - Alpha channel of the output color value in ARGB4444
pub type ALPHA_R = crate::FieldReader;
///Field `ALPHA` writer - Alpha channel of the output color value in ARGB4444
...
impl W {
    ///Bits 0:3 - Blue value of the output image in ARGB4444 mode
    #[inline(always)]
    pub fn blue(&mut self) -> BLUE_W<'_, OCOLR_ARGB4444rs> {
        BLUE_W::new(self, 0)
    }
    ///Bits 4:7 - Green value of the output image in ARGB4444 mode
    #[inline(always)]
    pub fn green(&mut self) -> GREEN_W<'_, OCOLR_ARGB4444rs> {
        GREEN_W::new(self, 4)
    }
    ///Bits 8:11 - Red value of the output image in ARGB4444 mode
    #[inline(always)]
    pub fn red(&mut self) -> RED_W<'_, OCOLR_ARGB4444rs> {
        RED_W::new(self, 8)
    }
    ///Bits 12:15 - Alpha channel of the output color value in ARGB4444
    #[inline(always)]
    pub fn alpha(&mut self) -> ALPHA_W<'_, OCOLR_ARGB4444rs> {
        ALPHA_W::new(self, 12)
    }
}
