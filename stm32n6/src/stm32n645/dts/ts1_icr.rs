...
impl W {
    ...
    #[inline(always)]
    pub fn irq_clear_fault(&mut self) -> IRQ_CLEAR_FAULT_W<TS1_ICRrs> {
        IRQ_CLEAR_FAULT_W::new(self, 0)
    }
    ///Bit 1 - Sample done IRQ clear bit
    #[inline(always)]
    pub fn irq_clear_done(&mut self) -> IRQ_CLEAR_DONE_W<TS1_ICRrs> {
        IRQ_CLEAR_DONE_W::new(self, 1)
    }
    ///Bit 3 - Alarm A IRQ clear bit
    #[inline(always)]
    pub fn irq_clear_alarma(&mut self) -> IRQ_CLEAR_ALARMA_W<TS1_ICRrs> {
        IRQ_CLEAR_ALARMA_W::new(self, 3)
    }
    ///Bit 4 - Alarm B IRQ clear bit
    #[inline(always)]
    pub fn irq_clear_alarmb(&mut self) -> IRQ_CLEAR_ALARMB_W<TS1_ICRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DTS:TS1_ICR)*/
