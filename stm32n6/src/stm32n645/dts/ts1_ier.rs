///Register `TS1_IER` reader
pub type R = crate::R<TS1_IERrs>;
///Register `TS1_IER` writer
pub type W = crate::W<TS1_IERrs>;
...
impl W {
    ///Bit 0 - Fault IRQ enable bit
    #[inline(always)]
    pub fn irq_en_fault(&mut self) -> IRQ_EN_FAULT_W<'_, TS1_IERrs> {
        IRQ_EN_FAULT_W::new(self, 0)
    }
    ///Bit 1 - Sample done IRQ enable bit
    #[inline(always)]
    pub fn irq_en_done(&mut self) -> IRQ_EN_DONE_W<'_, TS1_IERrs> {
        IRQ_EN_DONE_W::new(self, 1)
    }
    ///Bit 3 - Alarm A IRQ enable bit
    #[inline(always)]
    pub fn irq_en_alarma(&mut self) -> IRQ_EN_ALARMA_W<'_, TS1_IERrs> {
        IRQ_EN_ALARMA_W::new(self, 3)
    }
    ///Bit 4 - Alarm B IRQ enable bit
    #[inline(always)]
    pub fn irq_en_alarmb(&mut self) -> IRQ_EN_ALARMB_W<'_, TS1_IERrs> {
        IRQ_EN_ALARMB_W::new(self, 4)
    }
}
/**DTS TS1 IRQ enable register

You can [`read`](crate::Reg::read) this register and get [`ts1_ier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ts1_ier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#DTS:TS1_IER)*/
pub struct TS1_IERrs;
impl crate::RegisterSpec for TS1_IERrs {
    type Ux = u32;
}
///`read()` method returns [`ts1_ier::R`](R) reader structure
impl crate::Readable for TS1_IERrs {}
///`write(|w| ..)` method takes [`ts1_ier::W`](W) writer structure
impl crate::Writable for TS1_IERrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TS1_IER to value 0
impl crate::Resettable for TS1_IERrs {}
