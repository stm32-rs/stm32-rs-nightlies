...
impl W {
    ///Bits 0:3 - Receive DMA Write Descriptor Cache Control
    #[inline(always)]
    pub fn rdwc(&mut self) -> RDWC_W<DMAA4RXACRrs> {
        RDWC_W::new(self, 0)
    }
    ///Bits 8:11 - Receive DMA Payload Cache Control
    #[inline(always)]
    pub fn rpc(&mut self) -> RPC_W<DMAA4RXACRrs> {
        RPC_W::new(self, 8)
    }
    ///Bits 16:19 - Receive DMA Header Cache Control
    #[inline(always)]
    pub fn rhc(&mut self) -> RHC_W<DMAA4RXACRrs> {
        RHC_W::new(self, 16)
    }
    ///Bits 24:27 - Receive DMA Buffer Cache Control
    #[inline(always)]
    pub fn rdc(&mut self) -> RDC_W<DMAA4RXACRrs> {
        RDC_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:DMAA4RXACR)*/
