...
impl W {
    ///Bits 0:9 - Receive Descriptor Ring Length
    #[inline(always)]
    pub fn rdrl(&mut self) -> RDRL_W<DMAC1RXRLRrs> {
        RDRL_W::new(self, 0)
    }
    ///Bits 17:23 - Alternate Receive Buffer Size
    #[inline(always)]
    pub fn arbs(&mut self) -> ARBS_W<DMAC1RXRLRrs> {
        ARBS_W::new(self, 17)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:DMAC1RXRLR)*/
