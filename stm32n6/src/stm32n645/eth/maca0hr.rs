...
///Field `DCS` reader - DMA Channel Select
pub type DCS_R = crate::BitReader;
///Field `DCS` writer - DMA Channel Select
...
impl W {
    ...
    ///Bit 16 - DMA Channel Select
    #[inline(always)]
    pub fn dcs(&mut self) -> DCS_W<'_, MACA0HRrs> {
        DCS_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MACA0HR)*/
