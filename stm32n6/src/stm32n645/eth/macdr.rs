...
///Field `RPESTS` reader - MAC GMII or MII Receive Protocol Engine Status
...
///Field `TPESTS` reader - MAC GMII or MII Transmit Protocol Engine Status
...
impl R {
    ///Bit 0 - MAC GMII or MII Receive Protocol Engine Status
    #[inline(always)]
    ...
    ///Bit 16 - MAC GMII or MII Transmit Protocol Engine Status
    #[inline(always)]
