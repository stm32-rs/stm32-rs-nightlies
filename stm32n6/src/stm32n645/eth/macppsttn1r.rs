...
impl W {
    ///Bits 0:30 - Target Time Low for PPS Register
    #[inline(always)]
    pub fn ttsl0(&mut self) -> TTSL0_W<'_, MACPPSTTN1Rrs> {
        TTSL0_W::new(self, 0)
    }
    ///Bit 31 - PPS Target Time Register Busy
    #[inline(always)]
    pub fn trgtbusy0(&mut self) -> TRGTBUSY0_W<'_, MACPPSTTN1Rrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MACPPSTTN1R)*/
