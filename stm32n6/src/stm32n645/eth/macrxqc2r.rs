...
impl W {
    ///Bits 0:7 - Priorities Selected in the Receive Queue 0
    #[inline(always)]
    pub fn psrq0(&mut self) -> PSRQ0_W<'_, MACRXQC2Rrs> {
        PSRQ0_W::new(self, 0)
    }
    ///Bits 8:15 - Priorities Selected in the Receive Queue 1
    #[inline(always)]
    pub fn psrq1(&mut self) -> PSRQ1_W<'_, MACRXQC2Rrs> {
        PSRQ1_W::new(self, 8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MACRXQC2R)*/
