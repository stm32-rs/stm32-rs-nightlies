...
impl W {
    ///Bit 0 - Operation Busy
    #[inline(always)]
    pub fn ob(&mut self) -> OB_W<MACVTCRrs> {
        OB_W::new(self, 0)
    }
    ///Bit 1 - Command Type
    #[inline(always)]
    pub fn ct(&mut self) -> CT_W<MACVTCRrs> {
        CT_W::new(self, 1)
    }
    ///Bits 2:3 - Offset
    #[inline(always)]
    pub fn ofs(&mut self) -> OFS_W<MACVTCRrs> {
        OFS_W::new(self, 2)
    }
    ///Bit 16 - Enable 12-Bit VLAN Tag Comparison
    #[inline(always)]
    pub fn etv(&mut self) -> ETV_W<MACVTCRrs> {
        ETV_W::new(self, 16)
    }
    ///Bit 17 - VLAN Tag Inverse Match Enable
    #[inline(always)]
    pub fn vtim(&mut self) -> VTIM_W<MACVTCRrs> {
        VTIM_W::new(self, 17)
    }
    ///Bit 18 - Enable S-VLAN
    #[inline(always)]
    pub fn esvl(&mut self) -> ESVL_W<MACVTCRrs> {
        ESVL_W::new(self, 18)
    }
    ///Bit 19 - Enable Receive S-VLAN Match
    #[inline(always)]
    pub fn ersvlm(&mut self) -> ERSVLM_W<MACVTCRrs> {
        ERSVLM_W::new(self, 19)
    }
    ///Bit 20 - Disable VLAN Type Check
    #[inline(always)]
    pub fn dovltc(&mut self) -> DOVLTC_W<MACVTCRrs> {
        DOVLTC_W::new(self, 20)
    }
    ///Bits 21:22 - Enable VLAN Tag Stripping on Receive
    #[inline(always)]
    pub fn evls(&mut self) -> EVLS_W<MACVTCRrs> {
        EVLS_W::new(self, 21)
    }
    ///Bit 24 - Enable VLAN Tag in Rx status
    #[inline(always)]
    pub fn evlrxs(&mut self) -> EVLRXS_W<MACVTCRrs> {
        EVLRXS_W::new(self, 24)
    }
    ///Bit 25 - VLAN Tag Hash Table Match Enable
    #[inline(always)]
    pub fn vthm(&mut self) -> VTHM_W<MACVTCRrs> {
        VTHM_W::new(self, 25)
    }
    ///Bit 26 - Enable Double VLAN Processing
    #[inline(always)]
    pub fn edvlp(&mut self) -> EDVLP_W<MACVTCRrs> {
        EDVLP_W::new(self, 26)
    }
    ///Bit 27 - Enable Inner VLAN Tag
    #[inline(always)]
    pub fn erivlt(&mut self) -> ERIVLT_W<MACVTCRrs> {
        ERIVLT_W::new(self, 27)
    }
    ///Bits 28:29 - Enable Inner VLAN Tag Stripping on Receive
    #[inline(always)]
    pub fn eivls(&mut self) -> EIVLS_W<MACVTCRrs> {
        EIVLS_W::new(self, 28)
    }
    ///Bit 31 - Enable Inner VLAN Tag in Rx Status
    #[inline(always)]
    pub fn eivlrxs(&mut self) -> EIVLRXS_W<MACVTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MACVTCR)*/
