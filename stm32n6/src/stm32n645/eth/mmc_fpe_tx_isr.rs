...
impl W {
    ///Bit 0 - MMC Tx FPE Fragment Counter Interrupt status
    #[inline(always)]
    pub fn fcis(&mut self) -> FCIS_W<MMC_FPE_TX_ISRrs> {
        FCIS_W::new(self, 0)
    }
    ///Bit 1 - MMC Tx Hold Request Counter Interrupt Status
    #[inline(always)]
    pub fn hrcis(&mut self) -> HRCIS_W<MMC_FPE_TX_ISRrs> {
        HRCIS_W::new(self, 1)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MMC_FPE_TX_ISR)*/
