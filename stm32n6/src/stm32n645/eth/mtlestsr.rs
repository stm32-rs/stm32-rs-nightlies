...
impl W {
    ///Bit 0 - Switch to S/W owned list Complete
    #[inline(always)]
    pub fn swlc(&mut self) -> SWLC_W<MTLESTSRrs> {
        SWLC_W::new(self, 0)
    }
    ///Bit 1 - BTR Error
    #[inline(always)]
    pub fn btre(&mut self) -> BTRE_W<MTLESTSRrs> {
        BTRE_W::new(self, 1)
    }
    ///Bit 4 - Constant Gate Control Error
    #[inline(always)]
    pub fn cgce(&mut self) -> CGCE_W<MTLESTSRrs> {
        CGCE_W::new(self, 4)
    }
}
/**EST Status Register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MTLESTSR)*/
