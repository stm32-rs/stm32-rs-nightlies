...
impl W {
    ///Bits 0:15 - Hold Advance
    #[inline(always)]
    pub fn hadv(&mut self) -> HADV_W<MTLFPEARrs> {
        HADV_W::new(self, 0)
    }
    ///Bits 16:31 - Release Advance
    #[inline(always)]
    pub fn radv(&mut self) -> RADV_W<MTLFPEARrs> {
        RADV_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MTLFPEAR)*/
