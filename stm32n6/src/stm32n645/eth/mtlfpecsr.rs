...
impl W {
    ///Bits 0:1 - Additional Fragment Size
    #[inline(always)]
    pub fn afsz(&mut self) -> AFSZ_W<MTLFPECSRrs> {
        AFSZ_W::new(self, 0)
    }
    ///Bits 8:9 - Preemption Classification
    #[inline(always)]
    pub fn pec(&mut self) -> PEC_W<MTLFPECSRrs> {
        PEC_W::new(self, 8)
    }
    ///Bit 28 - Hold/Release Status
    #[inline(always)]
    pub fn hrs(&mut self) -> HRS_W<MTLFPECSRrs> {
        HRS_W::new(self, 28)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MTLFPECSR)*/
