...
impl W {
    ///Bit 0 - Transmit Queue Underflow Interrupt Status
    #[inline(always)]
    pub fn txunfis(&mut self) -> TXUNFIS_W<MTLQ1ICSRrs> {
        TXUNFIS_W::new(self, 0)
    }
    ///Bit 1 - Average Bits Per Slot Interrupt Status
    #[inline(always)]
    pub fn abpsis(&mut self) -> ABPSIS_W<MTLQ1ICSRrs> {
        ABPSIS_W::new(self, 1)
    }
    ///Bit 8 - Transmit Queue Underflow Interrupt Enable
    #[inline(always)]
    pub fn txuie(&mut self) -> TXUIE_W<MTLQ1ICSRrs> {
        TXUIE_W::new(self, 8)
    }
    ///Bit 9 - Average Bits Per Slot Interrupt Enable
    #[inline(always)]
    pub fn abpsie(&mut self) -> ABPSIE_W<MTLQ1ICSRrs> {
        ABPSIE_W::new(self, 9)
    }
    ///Bit 16 - Receive Queue Overflow Interrupt Status
    #[inline(always)]
    pub fn rxovfis(&mut self) -> RXOVFIS_W<MTLQ1ICSRrs> {
        RXOVFIS_W::new(self, 16)
    }
    ///Bit 24 - Receive Queue Overflow Interrupt Enable
    #[inline(always)]
    pub fn rxoie(&mut self) -> RXOIE_W<MTLQ1ICSRrs> {
        RXOIE_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MTLQ1ICSR)*/
