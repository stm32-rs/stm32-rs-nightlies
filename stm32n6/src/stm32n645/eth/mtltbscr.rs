...
impl W {
    ///Bit 0 - EST offset mode
    #[inline(always)]
    pub fn estm(&mut self) -> ESTM_W<MTLTBSCRrs> {
        ESTM_W::new(self, 0)
    }
    ///Bit 1 - Launch expiry offset valid
    #[inline(always)]
    pub fn leov(&mut self) -> LEOV_W<MTLTBSCRrs> {
        LEOV_W::new(self, 1)
    }
    ///Bits 4:6 - Launch Expiry GSN Offset
    #[inline(always)]
    pub fn legos(&mut self) -> LEGOS_W<MTLTBSCRrs> {
        LEGOS_W::new(self, 4)
    }
    ///Bits 8:31 - Launch Expiry Offset
    #[inline(always)]
    pub fn leos(&mut self) -> LEOS_W<MTLTBSCRrs> {
        LEOS_W::new(self, 8)
    }
}
