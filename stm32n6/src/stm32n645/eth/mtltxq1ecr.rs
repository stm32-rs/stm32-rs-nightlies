...
impl W {
    ///Bit 2 - AV Algorithm
    #[inline(always)]
    pub fn avalg(&mut self) -> AVALG_W<MTLTXQ1ECRrs> {
        AVALG_W::new(self, 2)
    }
    ///Bit 3 - Credit Control
    #[inline(always)]
    pub fn cc(&mut self) -> CC_W<MTLTXQ1ECRrs> {
        CC_W::new(self, 3)
    }
    ///Bits 4:6 - Slot Count
    #[inline(always)]
    pub fn slc(&mut self) -> SLC_W<MTLTXQ1ECRrs> {
        SLC_W::new(self, 4)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#ETH:MTLTXQ1ECR)*/
