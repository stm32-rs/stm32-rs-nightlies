...
impl W {
    ///Bit 7 - Falling trigger event configuration bit of configurable event input x
    #[inline(always)]
    pub fn ft39(&mut self) -> FT39_W<FTSR2rs> {
        FT39_W::new(self, 7)
    }
    ///Bit 8 - Falling trigger event configuration bit of configurable event input x
    #[inline(always)]
    ...
    ///Bit 19 - Falling trigger event configuration bit of configurable event input 51
    #[inline(always)]
    pub fn ft51(&mut self) -> FT51_W<FTSR2rs> {
        FT51_W::new(self, 19)
    }
    ///Bit 22 - Falling trigger event configuration bit of configurable event input 54
    #[inline(always)]
    pub fn ft54(&mut self) -> FT54_W<FTSR2rs> {
        FT54_W::new(self, 22)
    }
    ///Bit 24 - Falling trigger event configuration bit of configurable event input 56
    #[inline(always)]
    pub fn ft56(&mut self) -> FT56_W<FTSR2rs> {
        FT56_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#EXTI:FTSR2)*/
pub struct FTSR2rs;
