...
impl W {
    ///Bit 0 - Security enable on event input x
    #[inline(always)]
    pub fn sec64(&mut self) -> SEC64_W<SECCFGR3rs> {
        SEC64_W::new(self, 0)
    }
    ///Bit 1 - Security enable on event input x
    #[inline(always)]
    pub fn sec65(&mut self) -> SEC65_W<SECCFGR3rs> {
        SEC65_W::new(self, 1)
    }
    ///Bit 2 - Security enable on event input x
    #[inline(always)]
    pub fn sec66(&mut self) -> SEC66_W<SECCFGR3rs> {
        SEC66_W::new(self, 2)
    }
    ///Bit 4 - Security enable on event input x
    #[inline(always)]
    pub fn sec68(&mut self) -> SEC68_W<SECCFGR3rs> {
        SEC68_W::new(self, 4)
    }
    ///Bit 5 - Security enable on event input x
    #[inline(always)]
    pub fn sec69(&mut self) -> SEC69_W<SECCFGR3rs> {
        SEC69_W::new(self, 5)
    }
    ///Bit 6 - Security enable on event input x
    #[inline(always)]
    pub fn sec70(&mut self) -> SEC70_W<SECCFGR3rs> {
        SEC70_W::new(self, 6)
    }
    ///Bit 7 - Security enable on event input x
    #[inline(always)]
    pub fn sec71(&mut self) -> SEC71_W<SECCFGR3rs> {
        SEC71_W::new(self, 7)
    }
    ///Bit 8 - Security enable on event input x
    #[inline(always)]
    pub fn sec72(&mut self) -> SEC72_W<SECCFGR3rs> {
        SEC72_W::new(self, 8)
    }
    ///Bit 9 - Security enable on event input x
    #[inline(always)]
    pub fn sec73(&mut self) -> SEC73_W<SECCFGR3rs> {
        SEC73_W::new(self, 9)
    }
    ///Bit 10 - Security enable on event input x
    #[inline(always)]
    pub fn sec74(&mut self) -> SEC74_W<SECCFGR3rs> {
        SEC74_W::new(self, 10)
    }
    ///Bit 13 - Security enable on event input 77
    #[inline(always)]
    pub fn sec77(&mut self) -> SEC77_W<SECCFGR3rs> {
        SEC77_W::new(self, 13)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#EXTI:SECCFGR3)*/
