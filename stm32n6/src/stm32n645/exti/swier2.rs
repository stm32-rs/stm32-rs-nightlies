...
impl W {
    ///Bit 7 - Software interrupt on event x
    #[inline(always)]
    pub fn swi39(&mut self) -> SWI39_W<SWIER2rs> {
        SWI39_W::new(self, 7)
    }
    ///Bit 8 - Software interrupt on event x
    #[inline(always)]
    ...
    ///Bit 19 - Software interrupt on event 51
    #[inline(always)]
    pub fn swi51(&mut self) -> SWI51_W<SWIER2rs> {
        SWI51_W::new(self, 19)
    }
    ///Bit 22 - Software interrupt on event 54
    #[inline(always)]
    pub fn swi54(&mut self) -> SWI54_W<SWIER2rs> {
        SWI54_W::new(self, 22)
    }
    ///Bit 24 - Software interrupt on event 56
    #[inline(always)]
    pub fn swi56(&mut self) -> SWI56_W<SWIER2rs> {
        SWI56_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#EXTI:SWIER2)*/
pub struct SWIER2rs;
