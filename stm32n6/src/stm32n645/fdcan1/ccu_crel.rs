///Register `CCU_CREL` reader
pub type R = crate::R<CCU_CRELrs>;
...
///Field `STEP` reader - Step of core release = 1
pub type STEP_R = crate::FieldReader;
///Field `REL` reader - Core release = 1
...
impl R {
    ...
    ///Bits 24:27 - Step of core release = 1
    #[inline(always)]
    pub fn step(&self) -> STEP_R {
        STEP_R::new(((self.bits >> 24) & 0x0f) as u8)
    }
    ///Bits 28:31 - Core release = 1
    #[inline(always)]
...
You can [`read`](crate::Reg::read) this register and get [`ccu_crel::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#FDCAN1:CCU_CREL)*/
pub struct CCU_CRELrs;
impl crate::RegisterSpec for CCU_CRELrs {
    type Ux = u32;
}
///`read()` method returns [`ccu_crel::R`](R) reader structure
impl crate::Readable for CCU_CRELrs {}
///`reset()` method sets CCU_CREL to value 0x3214_1218
impl crate::Resettable for CCU_CRELrs {
