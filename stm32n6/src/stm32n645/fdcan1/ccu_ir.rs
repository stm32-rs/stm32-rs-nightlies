...
impl W {
    ///Bit 0 - Calibration watchdog event
    #[inline(always)]
    pub fn cwe(&mut self) -> CWE_W<CCU_IRrs> {
        CWE_W::new(self, 0)
    }
    ///Bit 1 - Calibration state changed
    #[inline(always)]
    pub fn csc(&mut self) -> CSC_W<CCU_IRrs> {
        CSC_W::new(self, 1)
    }
}
/**FDCAN test register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#FDCAN1:CCU_IR)*/
pub struct CCU_IRrs;
