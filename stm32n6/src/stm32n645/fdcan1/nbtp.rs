...
///Field `NBRP` reader - Bitrate prescaler
pub type NBRP_R = crate::FieldReader<u16>;
///Field `NBRP` writer - Bitrate prescaler
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#FDCAN1:NBTP)*/
pub struct NBTPrs;
