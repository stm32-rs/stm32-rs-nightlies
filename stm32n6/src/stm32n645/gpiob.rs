...
impl RegisterBlock {
    ...
    ///0x34 - GPIO port B privileged configuration register
    #[inline(always)]
    pub const fn privcfgr(&self) -> &PRIVCFGR {
        &self.privcfgr
    }
    ///0x38 - GPIO port B resource configuration lock register
    #[inline(always)]
    pub const fn rcfglockr(&self) -> &RCFGLOCKR {
        &self.rcfglockr
    }
    ///0x40 - GPIO port B delay low register
    #[inline(always)]
    pub const fn delayrl(&self) -> &DELAYRL {
        &self.delayrl
    }
    ///0x44 - GPIO port B delay high register
    #[inline(always)]
    pub const fn delayrh(&self) -> &DELAYRH {
        &self.delayrh
    }
    ///0x48 - GPIO port B PIO control low register
    #[inline(always)]
    pub const fn piocfgrl(&self) -> &PIOCFGRL {
        &self.piocfgrl
    }
    ///0x4c - GPIO port B PIO control high register
    #[inline(always)]
    pub const fn piocfgrh(&self) -> &PIOCFGRH {
        &self.piocfgrh
    }
    ///0x3c8 - GPIO port B hardware configuration register 10
    #[inline(always)]
    pub const fn hwcfgr10(&self) -> &HWCFGR10 {
        &self.hwcfgr10
    }
    ///0x3cc - GPIO port B hardware configuration register 9
    #[inline(always)]
    pub const fn hwcfgr9(&self) -> &HWCFGR9 {
        &self.hwcfgr9
    }
    ///0x3d0 - GPIO port B hardware configuration register 8
    #[inline(always)]
    pub const fn hwcfgr8(&self) -> &HWCFGR8 {
        &self.hwcfgr8
    }
    ///0x3d4 - GPIO port B hardware configuration register 7
    #[inline(always)]
    pub const fn hwcfgr7(&self) -> &HWCFGR7 {
        &self.hwcfgr7
    }
    ///0x3d8 - GPIO port B hardware configuration register 6
    #[inline(always)]
    pub const fn hwcfgr6(&self) -> &HWCFGR6 {
        &self.hwcfgr6
    }
    ///0x3dc - GPIO port B hardware configuration register 5
    #[inline(always)]
    pub const fn hwcfgr5(&self) -> &HWCFGR5 {
        &self.hwcfgr5
    }
    ///0x3e0 - GPIO port B hardware configuration register 4
    #[inline(always)]
    pub const fn hwcfgr4(&self) -> &HWCFGR4 {
        &self.hwcfgr4
    }
    ///0x3e4 - GPIO port B hardware configuration register 3
    #[inline(always)]
    pub const fn hwcfgr3(&self) -> &HWCFGR3 {
        &self.hwcfgr3
    }
    ///0x3e8 - GPIO port B hardware configuration register 2
    #[inline(always)]
    pub const fn hwcfgr2(&self) -> &HWCFGR2 {
        &self.hwcfgr2
    }
    ///0x3ec - GPIO port B hardware configuration register 1
    #[inline(always)]
    pub const fn hwcfgr1(&self) -> &HWCFGR1 {
        &self.hwcfgr1
    }
    ///0x3f0 - GPIO port B hardware configuration register 0
    #[inline(always)]
    pub const fn hwcfgr0(&self) -> &HWCFGR0 {
        &self.hwcfgr0
    }
    ///0x3f4 - GPIO port B version register
    #[inline(always)]
    pub const fn verr(&self) -> &VERR {
        &self.verr
    }
    ///0x3f8 - GPIO port B identification register
    #[inline(always)]
    pub const fn ipidr(&self) -> &IPIDR {
        &self.ipidr
    }
    ///0x3fc - GPIO port B size identification register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:MODER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:OTYPER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:OSPEEDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:PUPDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:IDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:ODR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:BSRR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:LCKR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:AFRL)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:AFRH)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:BRR)

For information about available fields see [`mod@brr`] module*/
pub type BRR = crate::Reg<brr::BRRrs>;
///GPIO port B bit reset register
pub mod brr;
/**SECCFGR (rw) register accessor: GPIO port B secure configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:SECCFGR)
...
pub mod seccfgr;
/**PRIVCFGR (rw) register accessor: GPIO port B privileged configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:PRIVCFGR)
...
pub mod privcfgr;
/**RCFGLOCKR (rw) register accessor: GPIO port B resource configuration lock register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:RCFGLOCKR)
...
pub mod rcfglockr;
/**DELAYRL (rw) register accessor: GPIO port B delay low register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:DELAYRL)
...
pub mod delayrl;
/**DELAYRH (rw) register accessor: GPIO port B delay high register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:DELAYRH)
...
pub mod delayrh;
/**PIOCFGRL (rw) register accessor: GPIO port B PIO control low register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:PIOCFGRL)
...
pub mod piocfgrl;
/**PIOCFGRH (rw) register accessor: GPIO port B PIO control high register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:PIOCFGRH)
...
pub mod piocfgrh;
/**HWCFGR10 (r) register accessor: GPIO port B hardware configuration register 10

You can [`read`](crate::Reg::read) this register and get [`hwcfgr10::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR10)
...
pub mod hwcfgr10;
/**HWCFGR9 (r) register accessor: GPIO port B hardware configuration register 9

You can [`read`](crate::Reg::read) this register and get [`hwcfgr9::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR9)
...
pub mod hwcfgr9;
/**HWCFGR8 (r) register accessor: GPIO port B hardware configuration register 8

You can [`read`](crate::Reg::read) this register and get [`hwcfgr8::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR8)
...
pub mod hwcfgr8;
/**HWCFGR7 (r) register accessor: GPIO port B hardware configuration register 7

You can [`read`](crate::Reg::read) this register and get [`hwcfgr7::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR7)
...
pub mod hwcfgr7;
/**HWCFGR6 (r) register accessor: GPIO port B hardware configuration register 6

You can [`read`](crate::Reg::read) this register and get [`hwcfgr6::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR6)
...
pub mod hwcfgr6;
/**HWCFGR5 (r) register accessor: GPIO port B hardware configuration register 5

You can [`read`](crate::Reg::read) this register and get [`hwcfgr5::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR5)
...
pub mod hwcfgr5;
/**HWCFGR4 (r) register accessor: GPIO port B hardware configuration register 4

You can [`read`](crate::Reg::read) this register and get [`hwcfgr4::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR4)
...
pub mod hwcfgr4;
/**HWCFGR3 (r) register accessor: GPIO port B hardware configuration register 3

You can [`read`](crate::Reg::read) this register and get [`hwcfgr3::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR3)
...
pub mod hwcfgr3;
/**HWCFGR2 (r) register accessor: GPIO port B hardware configuration register 2

You can [`read`](crate::Reg::read) this register and get [`hwcfgr2::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR2)
...
pub mod hwcfgr2;
/**HWCFGR1 (r) register accessor: GPIO port B hardware configuration register 1

You can [`read`](crate::Reg::read) this register and get [`hwcfgr1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR1)
...
pub mod hwcfgr1;
/**HWCFGR0 (r) register accessor: GPIO port B hardware configuration register 0

You can [`read`](crate::Reg::read) this register and get [`hwcfgr0::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:HWCFGR0)
...
pub mod ipidr;
/**SIDR (r) register accessor: GPIO port B size identification register

You can [`read`](crate::Reg::read) this register and get [`sidr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOB:SIDR)
