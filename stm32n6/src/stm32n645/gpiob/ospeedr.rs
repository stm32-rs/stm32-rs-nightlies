...
pub use crate::stm32n645::gpioa::ospeedr::OSPEED_R;
///Field `OSPEED(0-15)` writer - Port x configuration pin %s
pub use crate::stm32n645::gpioa::ospeedr::OSPEED_W;
///Port x configuration pin %s
pub use crate::stm32n645::gpioa::ospeedr::OUTPUT_SPEED;
impl R {
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `OSPEED0` field.</div>
    #[inline(always)]
    pub fn ospeed(&mut self, n: u8) -> OSPEED_W<'_, OSPEEDRrs> {
        #[allow(clippy::no_effect)]
        [(); 16][n as usize];
    ...
    ///Bits 0:1 - Port x configuration pin 0
    #[inline(always)]
    pub fn ospeed0(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 0)
    }
    ///Bits 2:3 - Port x configuration pin 1
    #[inline(always)]
    pub fn ospeed1(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 2)
    }
    ///Bits 4:5 - Port x configuration pin 2
    #[inline(always)]
    pub fn ospeed2(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 4)
    }
    ///Bits 6:7 - Port x configuration pin 3
    #[inline(always)]
    pub fn ospeed3(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 6)
    }
    ///Bits 8:9 - Port x configuration pin 4
    #[inline(always)]
    pub fn ospeed4(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 8)
    }
    ///Bits 10:11 - Port x configuration pin 5
    #[inline(always)]
    pub fn ospeed5(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 10)
    }
    ///Bits 12:13 - Port x configuration pin 6
    #[inline(always)]
    pub fn ospeed6(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 12)
    }
    ///Bits 14:15 - Port x configuration pin 7
    #[inline(always)]
    pub fn ospeed7(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 14)
    }
    ///Bits 16:17 - Port x configuration pin 8
    #[inline(always)]
    pub fn ospeed8(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 16)
    }
    ///Bits 18:19 - Port x configuration pin 9
    #[inline(always)]
    pub fn ospeed9(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 18)
    }
    ///Bits 20:21 - Port x configuration pin 10
    #[inline(always)]
    pub fn ospeed10(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 20)
    }
    ///Bits 22:23 - Port x configuration pin 11
    #[inline(always)]
    pub fn ospeed11(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 22)
    }
    ///Bits 24:25 - Port x configuration pin 12
    #[inline(always)]
    pub fn ospeed12(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 24)
    }
    ///Bits 26:27 - Port x configuration pin 13
    #[inline(always)]
    pub fn ospeed13(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 26)
    }
    ///Bits 28:29 - Port x configuration pin 14
    #[inline(always)]
    pub fn ospeed14(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
        OSPEED_W::new(self, 28)
    }
    ///Bits 30:31 - Port x configuration pin 15
    #[inline(always)]
    pub fn ospeed15(&mut self) -> OSPEED_W<'_, OSPEEDRrs> {
