...
///Field `SEC0` reader - I/O pin y of Port x security configuration
pub type SEC0_R = crate::BitReader;
///Field `SEC0` writer - I/O pin y of Port x security configuration
pub type SEC0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC1` reader - I/O pin y of Port x security configuration
pub type SEC1_R = crate::BitReader;
///Field `SEC1` writer - I/O pin y of Port x security configuration
pub type SEC1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC2` reader - I/O pin y of Port x security configuration
pub type SEC2_R = crate::BitReader;
///Field `SEC2` writer - I/O pin y of Port x security configuration
pub type SEC2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC3` reader - I/O pin y of Port x security configuration
pub type SEC3_R = crate::BitReader;
///Field `SEC3` writer - I/O pin y of Port x security configuration
pub type SEC3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC4` reader - I/O pin y of Port x security configuration
pub type SEC4_R = crate::BitReader;
///Field `SEC4` writer - I/O pin y of Port x security configuration
pub type SEC4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC5` reader - I/O pin y of Port x security configuration
pub type SEC5_R = crate::BitReader;
///Field `SEC5` writer - I/O pin y of Port x security configuration
pub type SEC5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC6` reader - I/O pin y of Port x security configuration
pub type SEC6_R = crate::BitReader;
///Field `SEC6` writer - I/O pin y of Port x security configuration
pub type SEC6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC7` reader - I/O pin y of Port x security configuration
pub type SEC7_R = crate::BitReader;
///Field `SEC7` writer - I/O pin y of Port x security configuration
pub type SEC7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC8` reader - I/O pin y of Port x security configuration
pub type SEC8_R = crate::BitReader;
///Field `SEC8` writer - I/O pin y of Port x security configuration
pub type SEC8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC9` reader - I/O pin y of Port x security configuration
pub type SEC9_R = crate::BitReader;
///Field `SEC9` writer - I/O pin y of Port x security configuration
pub type SEC9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC10` reader - I/O pin y of Port x security configuration
pub type SEC10_R = crate::BitReader;
///Field `SEC10` writer - I/O pin y of Port x security configuration
pub type SEC10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC11` reader - I/O pin y of Port x security configuration
pub type SEC11_R = crate::BitReader;
///Field `SEC11` writer - I/O pin y of Port x security configuration
pub type SEC11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC12` reader - I/O pin y of Port x security configuration
pub type SEC12_R = crate::BitReader;
///Field `SEC12` writer - I/O pin y of Port x security configuration
pub type SEC12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC13` reader - I/O pin y of Port x security configuration
pub type SEC13_R = crate::BitReader;
///Field `SEC13` writer - I/O pin y of Port x security configuration
pub type SEC13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC14` reader - I/O pin y of Port x security configuration
pub type SEC14_R = crate::BitReader;
///Field `SEC14` writer - I/O pin y of Port x security configuration
pub type SEC14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC15` reader - I/O pin y of Port x security configuration
pub type SEC15_R = crate::BitReader;
///Field `SEC15` writer - I/O pin y of Port x security configuration
pub type SEC15_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec0(&self) -> SEC0_R {
        SEC0_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec1(&self) -> SEC1_R {
        SEC1_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec2(&self) -> SEC2_R {
        SEC2_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec3(&self) -> SEC3_R {
        SEC3_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec4(&self) -> SEC4_R {
        SEC4_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec5(&self) -> SEC5_R {
        SEC5_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec6(&self) -> SEC6_R {
        SEC6_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec7(&self) -> SEC7_R {
        SEC7_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec8(&self) -> SEC8_R {
        SEC8_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec9(&self) -> SEC9_R {
        SEC9_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec10(&self) -> SEC10_R {
        SEC10_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec11(&self) -> SEC11_R {
        SEC11_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec12(&self) -> SEC12_R {
        SEC12_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec13(&self) -> SEC13_R {
        SEC13_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - I/O pin y of Port x security configuration
    #[inline(always)]
    pub fn sec14(&self) -> SEC14_R {
        SEC14_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - I/O pin y of Port x security configuration
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOD:SECCFGR)*/
