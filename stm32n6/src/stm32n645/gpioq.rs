...
pub mod moder;
/**OTYPER (rw) register accessor: GPIO port Q output type register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:OTYPER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:OSPEEDR)
...
pub mod pupdr;
/**IDR (r) register accessor: GPIO port Q input data register

You can [`read`](crate::Reg::read) this register and get [`idr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:IDR)

For information about available fields see [`mod@idr`] module*/
pub type IDR = crate::Reg<idr::IDRrs>;
///GPIO port Q input data register
pub mod idr;
/**ODR (rw) register accessor: GPIO port Q output data register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:ODR)
...
pub mod odr;
/**BSRR (w) register accessor: GPIO port Q bit set/reset register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:BSRR)
...
pub mod bsrr;
/**LCKR (rw) register accessor: GPIO port Q configuration lock register
...
pub mod lckr;
/**AFRL (rw) register accessor: GPIO port Q alternate function low register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:AFRL)
...
pub mod afrl;
/**AFRH (rw) register accessor: GPIO port Q alternate function high register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:AFRH)
...
pub mod afrh;
/**BRR (w) register accessor: GPIO port Q bit reset register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:BRR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:PRIVCFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:RCFGLOCKR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:DELAYRH)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:PIOCFGRL)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:PIOCFGRH)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:HWCFGR10)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:HWCFGR9)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:HWCFGR8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:HWCFGR7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:HWCFGR6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:HWCFGR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:HWCFGR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:HWCFGR0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:IPIDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#GPIOQ:SIDR)
