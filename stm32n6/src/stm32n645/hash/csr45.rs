...
///Field `CS45` reader - Context swap x
pub type CS45_R = crate::FieldReader<u32>;
///Field `CS45` writer - Context swap x
...
impl W {
    ///Bits 0:31 - Context swap x
    #[inline(always)]
    pub fn cs45(&mut self) -> CS45_W<'_, CSR45rs> {
        CS45_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#HASH:CSR45)*/
pub struct CSR45rs;
