///Register `C11LLR` reader
pub type R = crate::R<C11LLRrs>;
///Register `C11LLR` writer
pub type W = crate::W<C11LLRrs>;
...
impl W {
    ///Bits 2:15 - pointer (16-bit low-significant address) to the next linked-list data structure
    #[inline(always)]
    pub fn la(&mut self) -> LA_W<'_, C11LLRrs> {
        LA_W::new(self, 2)
    }
    ///Bit 16 - Update HPDMA_CxLLR register from memory
    #[inline(always)]
    pub fn ull(&mut self) -> ULL_W<'_, C11LLRrs> {
        ULL_W::new(self, 16)
    }
    ///Bit 27 - Update HPDMA_CxDAR register from memory
    #[inline(always)]
    pub fn uda(&mut self) -> UDA_W<'_, C11LLRrs> {
        UDA_W::new(self, 27)
    }
    ///Bit 28 - update HPDMA_CxSAR from memory
    #[inline(always)]
    pub fn usa(&mut self) -> USA_W<'_, C11LLRrs> {
        USA_W::new(self, 28)
    }
    ///Bit 29 - Update HPDMA_CxBR1 from memory
    #[inline(always)]
    pub fn ub1(&mut self) -> UB1_W<'_, C11LLRrs> {
        UB1_W::new(self, 29)
    }
    ///Bit 30 - Update HPDMA_CxTR2 from memory
    #[inline(always)]
    pub fn ut2(&mut self) -> UT2_W<'_, C11LLRrs> {
        UT2_W::new(self, 30)
    }
    ///Bit 31 - Update HPDMA_CxTR1 from memory
    #[inline(always)]
    pub fn ut1(&mut self) -> UT1_W<'_, C11LLRrs> {
        UT1_W::new(self, 31)
    }
}
/**HPDMA channel 11 linked-list address register

You can [`read`](crate::Reg::read) this register and get [`c11llr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c11llr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#HPDMA:C11LLR)*/
pub struct C11LLRrs;
impl crate::RegisterSpec for C11LLRrs {
    type Ux = u32;
}
///`read()` method returns [`c11llr::R`](R) reader structure
impl crate::Readable for C11LLRrs {}
///`write(|w| ..)` method takes [`c11llr::W`](W) writer structure
impl crate::Writable for C11LLRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C11LLR to value 0
impl crate::Resettable for C11LLRrs {}
