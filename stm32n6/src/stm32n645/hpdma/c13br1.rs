...
impl W {
    ///Bits 0:15 - block number of data bytes to transfer from the source
    #[inline(always)]
    pub fn bndt(&mut self) -> BNDT_W<'_, C13BR1rs> {
        BNDT_W::new(self, 0)
    }
    ///Bits 16:26 - Block repeat counter
    #[inline(always)]
    pub fn brc(&mut self) -> BRC_W<'_, C13BR1rs> {
        BRC_W::new(self, 16)
    }
    ///Bit 28 - source address decrement
    #[inline(always)]
    pub fn sdec(&mut self) -> SDEC_W<'_, C13BR1rs> {
        SDEC_W::new(self, 28)
    }
    ///Bit 29 - destination address decrement
    #[inline(always)]
    pub fn ddec(&mut self) -> DDEC_W<'_, C13BR1rs> {
        DDEC_W::new(self, 29)
    }
    ///Bit 30 - Block repeat source address decrement
    #[inline(always)]
    pub fn brsdec(&mut self) -> BRSDEC_W<'_, C13BR1rs> {
        BRSDEC_W::new(self, 30)
    }
    ///Bit 31 - Block repeat destination address decrement
    #[inline(always)]
    pub fn brddec(&mut self) -> BRDDEC_W<'_, C13BR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#HPDMA:C13BR1)*/
pub struct C13BR1rs;
