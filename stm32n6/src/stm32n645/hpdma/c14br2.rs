...
impl W {
    ///Bits 0:15 - Block repeated source address offset
    #[inline(always)]
    pub fn brsao(&mut self) -> BRSAO_W<'_, C14BR2rs> {
        BRSAO_W::new(self, 0)
    }
    ///Bits 16:31 - Block repeated destination address offset
    #[inline(always)]
    pub fn brdao(&mut self) -> BRDAO_W<'_, C14BR2rs> {
        BRDAO_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#HPDMA:C14BR2)*/
pub struct C14BR2rs;
