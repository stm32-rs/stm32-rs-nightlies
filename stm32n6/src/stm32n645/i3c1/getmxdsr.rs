...
///Field `TSCO` reader - clock-to-data turnaround time (t less than sub>SCO less than /sub>)
pub type TSCO_R = crate::BitReader;
///Field `TSCO` writer - clock-to-data turnaround time (t less than sub>SCO less than /sub>)
...
impl R {
    ...
    ///Bit 24 - clock-to-data turnaround time (t less than sub>SCO less than /sub>)
    #[inline(always)]
