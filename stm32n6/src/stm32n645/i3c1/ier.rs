...
///Field `CFNFIE` reader - C-FIFO not full interrupt enable (whatever the I3C acts as controller/target)
pub type CFNFIE_R = crate::BitReader;
///Field `SFNEIE` reader - S-FIFO not empty interrupt enable (whatever the I3C acts as controller/target)
pub type SFNEIE_R = crate::BitReader;
///Field `TXFNFIE` reader - TX-FIFO not full interrupt enable (whatever the I3C acts as controller/target)
pub type TXFNFIE_R = crate::BitReader;
///Field `RXFNEIE` reader - RX-FIFO not empty interrupt enable (whatever the I3C acts as controller/target)
pub type RXFNEIE_R = crate::BitReader;
///Field `FCIE` reader - frame complete interrupt enable (whatever the I3C acts as controller/target)
pub type FCIE_R = crate::BitReader;
///Field `RXTGTENDIE` reader - target-initiated read end interrupt enable (when the I3C acts as controller)
pub type RXTGTENDIE_R = crate::BitReader;
///Field `ERRIE` reader - error interrupt enable (whatever the I3C acts as controller/target)
pub type ERRIE_R = crate::BitReader;
///Field `IBIIE` reader - IBI request interrupt enable (when the I3C acts as controller)
pub type IBIIE_R = crate::BitReader;
///Field `IBIENDIE` reader - IBI end interrupt enable (when the I3C acts as target)
pub type IBIENDIE_R = crate::BitReader;
///Field `CRIE` reader - Controller-role request interrupt enable (when the I3C acts as controller)
pub type CRIE_R = crate::BitReader;
///Field `CRUPDIE` reader - Controller-role update interrupt enable (when the I3C acts as target)
pub type CRUPDIE_R = crate::BitReader;
///Field `HJIE` reader - Hot-join interrupt enable (when the I3C acts as controller)
pub type HJIE_R = crate::BitReader;
///Field `WKPIE` reader - Wake-up interrupt enable (when the I3C acts as target)
pub type WKPIE_R = crate::BitReader;
///Field `GETIE` reader - GETxxx CCC interrupt enable (except GETSTATUS of format 1) (when the I3C acts as target)
pub type GETIE_R = crate::BitReader;
///Field `STAIE` reader - format 1 GETSTATUS CCC interrupt enable (when the I3C acts as target)
pub type STAIE_R = crate::BitReader;
///Field `DAUPDIE` reader - ENTDAA/RSTDAA/SETNEWDA CCC interrupt enable (when the I3C acts as target)
pub type DAUPDIE_R = crate::BitReader;
///Field `MWLUPDIE` reader - SETMWL CCC interrupt enable (when the I3C acts as target)
pub type MWLUPDIE_R = crate::BitReader;
///Field `MRLUPDIE` reader - SETMRL CCC interrupt enable (when the I3C acts as target)
pub type MRLUPDIE_R = crate::BitReader;
///Field `RSTIE` reader - reset pattern interrupt enable (when the I3C acts as target)
pub type RSTIE_R = crate::BitReader;
///Field `ASUPDIE` reader - ENTASx CCC interrupt enable (when the I3C acts as target)
pub type ASUPDIE_R = crate::BitReader;
///Field `INTUPDIE` reader - ENEC/DISEC CCC interrupt enable (when the I3C acts as target)
pub type INTUPDIE_R = crate::BitReader;
///Field `DEFIE` reader - DEFTGTS CCC interrupt enable (when the I3C acts as target)
pub type DEFIE_R = crate::BitReader;
///Field `GRPIE` reader - DEFGRPA CCC interrupt enable (when the I3C acts as target)
pub type GRPIE_R = crate::BitReader;
impl R {
    ///Bit 2 - C-FIFO not full interrupt enable (whatever the I3C acts as controller/target)
    #[inline(always)]
    pub fn cfnfie(&self) -> CFNFIE_R {
        CFNFIE_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - S-FIFO not empty interrupt enable (whatever the I3C acts as controller/target)
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#I3C1:IER)*/
pub struct IERrs;
