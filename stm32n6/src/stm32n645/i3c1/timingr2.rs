...
///Field `STALLT` reader - Controller clock stall enable on T-bit phase of data (and on the ACK/NACK phase of data byte of a legacy I less than sup>2 less than /sup>C read)
pub type STALLT_R = crate::BitReader;
///Field `STALLT` writer - Controller clock stall enable on T-bit phase of data (and on the ACK/NACK phase of data byte of a legacy I less than sup>2 less than /sup>C read)
...
impl R {
    ///Bit 0 - Controller clock stall enable on T-bit phase of data (and on the ACK/NACK phase of data byte of a legacy I less than sup>2 less than /sup>C read)
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#I3C1:TIMINGR2)*/
