...
impl W {
    ///Bits 0:7 - Huffman table data 4
    #[inline(always)]
    pub fn data4(&mut self) -> DATA4_W<'_, DHTMEM1rs> {
        DATA4_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 5
    #[inline(always)]
    pub fn data5(&mut self) -> DATA5_W<'_, DHTMEM1rs> {
        DATA5_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 6
    #[inline(always)]
    pub fn data6(&mut self) -> DATA6_W<'_, DHTMEM1rs> {
        DATA6_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 7
    #[inline(always)]
    pub fn data7(&mut self) -> DATA7_W<'_, DHTMEM1rs> {
        DATA7_W::new(self, 24)
    }
}
/**JPEG DHT memory
