...
impl W {
    ///Bits 0:7 - Huffman table data 40
    #[inline(always)]
    pub fn data40(&mut self) -> DATA40_W<DHTMEM10rs> {
        DATA40_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 41
    #[inline(always)]
    pub fn data41(&mut self) -> DATA41_W<DHTMEM10rs> {
        DATA41_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 42
    #[inline(always)]
    pub fn data42(&mut self) -> DATA42_W<DHTMEM10rs> {
        DATA42_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 43
    #[inline(always)]
    pub fn data43(&mut self) -> DATA43_W<DHTMEM10rs> {
