...
impl W {
    ///Bits 0:7 - Huffman table data 400
    #[inline(always)]
    pub fn data400(&mut self) -> DATA400_W<DHTMEM100rs> {
        DATA400_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 401
    #[inline(always)]
    pub fn data401(&mut self) -> DATA401_W<DHTMEM100rs> {
        DATA401_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 402
    #[inline(always)]
    pub fn data402(&mut self) -> DATA402_W<DHTMEM100rs> {
        DATA402_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 403
    #[inline(always)]
    pub fn data403(&mut self) -> DATA403_W<DHTMEM100rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM100)*/
