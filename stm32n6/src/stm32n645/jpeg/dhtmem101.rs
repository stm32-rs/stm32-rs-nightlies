...
impl W {
    ///Bits 0:7 - Huffman table data 404
    #[inline(always)]
    pub fn data404(&mut self) -> DATA404_W<DHTMEM101rs> {
        DATA404_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 405
    #[inline(always)]
    pub fn data405(&mut self) -> DATA405_W<DHTMEM101rs> {
        DATA405_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 406
    #[inline(always)]
    pub fn data406(&mut self) -> DATA406_W<DHTMEM101rs> {
        DATA406_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 407
    #[inline(always)]
    pub fn data407(&mut self) -> DATA407_W<DHTMEM101rs> {
