...
impl W {
    ///Bits 0:7 - Huffman table data 68
    #[inline(always)]
    pub fn data68(&mut self) -> DATA68_W<DHTMEM17rs> {
        DATA68_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 69
    #[inline(always)]
    pub fn data69(&mut self) -> DATA69_W<DHTMEM17rs> {
        DATA69_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 70
    #[inline(always)]
    pub fn data70(&mut self) -> DATA70_W<DHTMEM17rs> {
        DATA70_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 71
    #[inline(always)]
    pub fn data71(&mut self) -> DATA71_W<DHTMEM17rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM17)*/
