...
impl W {
    ///Bits 0:7 - Huffman table data 144
    #[inline(always)]
    pub fn data144(&mut self) -> DATA144_W<DHTMEM36rs> {
        DATA144_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 145
    #[inline(always)]
    pub fn data145(&mut self) -> DATA145_W<DHTMEM36rs> {
        DATA145_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 146
    #[inline(always)]
    pub fn data146(&mut self) -> DATA146_W<DHTMEM36rs> {
        DATA146_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 147
    #[inline(always)]
    pub fn data147(&mut self) -> DATA147_W<DHTMEM36rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM36)*/
