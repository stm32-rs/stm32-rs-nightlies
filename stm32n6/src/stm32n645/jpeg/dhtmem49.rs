...
impl W {
    ///Bits 0:7 - Huffman table data 196
    #[inline(always)]
    pub fn data196(&mut self) -> DATA196_W<DHTMEM49rs> {
        DATA196_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 197
    #[inline(always)]
    pub fn data197(&mut self) -> DATA197_W<DHTMEM49rs> {
        DATA197_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 198
    #[inline(always)]
    pub fn data198(&mut self) -> DATA198_W<DHTMEM49rs> {
        DATA198_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 199
    #[inline(always)]
    pub fn data199(&mut self) -> DATA199_W<DHTMEM49rs> {
