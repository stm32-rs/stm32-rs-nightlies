...
impl W {
    ///Bits 0:7 - Huffman table data 20
    #[inline(always)]
    pub fn data20(&mut self) -> DATA20_W<'_, DHTMEM5rs> {
        DATA20_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 21
    #[inline(always)]
    pub fn data21(&mut self) -> DATA21_W<'_, DHTMEM5rs> {
        DATA21_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 22
    #[inline(always)]
    pub fn data22(&mut self) -> DATA22_W<'_, DHTMEM5rs> {
        DATA22_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 23
    #[inline(always)]
    pub fn data23(&mut self) -> DATA23_W<'_, DHTMEM5rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM5)*/
