...
impl W {
    ///Bits 0:7 - Huffman table data 200
    #[inline(always)]
    pub fn data200(&mut self) -> DATA200_W<DHTMEM50rs> {
        DATA200_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 201
    #[inline(always)]
    pub fn data201(&mut self) -> DATA201_W<DHTMEM50rs> {
        DATA201_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 202
    #[inline(always)]
    pub fn data202(&mut self) -> DATA202_W<DHTMEM50rs> {
        DATA202_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 203
    #[inline(always)]
    pub fn data203(&mut self) -> DATA203_W<DHTMEM50rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM50)*/
