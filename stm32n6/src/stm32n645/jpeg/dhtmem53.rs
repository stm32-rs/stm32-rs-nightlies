...
impl W {
    ///Bits 0:7 - Huffman table data 212
    #[inline(always)]
    pub fn data212(&mut self) -> DATA212_W<DHTMEM53rs> {
        DATA212_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 213
    #[inline(always)]
    pub fn data213(&mut self) -> DATA213_W<DHTMEM53rs> {
        DATA213_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 214
    #[inline(always)]
    pub fn data214(&mut self) -> DATA214_W<DHTMEM53rs> {
        DATA214_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 215
    #[inline(always)]
    pub fn data215(&mut self) -> DATA215_W<DHTMEM53rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM53)*/
