...
impl W {
    ///Bits 0:7 - Huffman table data 236
    #[inline(always)]
    pub fn data236(&mut self) -> DATA236_W<DHTMEM59rs> {
        DATA236_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 237
    #[inline(always)]
    pub fn data237(&mut self) -> DATA237_W<DHTMEM59rs> {
        DATA237_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 238
    #[inline(always)]
    pub fn data238(&mut self) -> DATA238_W<DHTMEM59rs> {
        DATA238_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 239
    #[inline(always)]
    pub fn data239(&mut self) -> DATA239_W<DHTMEM59rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM59)*/
