...
impl W {
    ///Bits 0:7 - Huffman table data 260
    #[inline(always)]
    pub fn data260(&mut self) -> DATA260_W<DHTMEM65rs> {
        DATA260_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 261
    #[inline(always)]
    pub fn data261(&mut self) -> DATA261_W<DHTMEM65rs> {
        DATA261_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 262
    #[inline(always)]
    pub fn data262(&mut self) -> DATA262_W<DHTMEM65rs> {
        DATA262_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 263
    #[inline(always)]
    pub fn data263(&mut self) -> DATA263_W<DHTMEM65rs> {
