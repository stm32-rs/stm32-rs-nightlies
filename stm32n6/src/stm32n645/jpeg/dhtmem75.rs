...
impl W {
    ///Bits 0:7 - Huffman table data 300
    #[inline(always)]
    pub fn data300(&mut self) -> DATA300_W<DHTMEM75rs> {
        DATA300_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 301
    #[inline(always)]
    pub fn data301(&mut self) -> DATA301_W<DHTMEM75rs> {
        DATA301_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 302
    #[inline(always)]
    pub fn data302(&mut self) -> DATA302_W<DHTMEM75rs> {
        DATA302_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 303
    #[inline(always)]
    pub fn data303(&mut self) -> DATA303_W<DHTMEM75rs> {
