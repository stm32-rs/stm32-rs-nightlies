...
impl W {
    ///Bits 0:7 - Huffman table data 308
    #[inline(always)]
    pub fn data308(&mut self) -> DATA308_W<DHTMEM77rs> {
        DATA308_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 309
    #[inline(always)]
    pub fn data309(&mut self) -> DATA309_W<DHTMEM77rs> {
        DATA309_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 310
    #[inline(always)]
    pub fn data310(&mut self) -> DATA310_W<DHTMEM77rs> {
        DATA310_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 311
    #[inline(always)]
    pub fn data311(&mut self) -> DATA311_W<DHTMEM77rs> {
