...
impl W {
    ///Bits 0:7 - Huffman table data 32
    #[inline(always)]
    pub fn data32(&mut self) -> DATA32_W<DHTMEM8rs> {
        DATA32_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 33
    #[inline(always)]
    pub fn data33(&mut self) -> DATA33_W<DHTMEM8rs> {
        DATA33_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 34
    #[inline(always)]
    pub fn data34(&mut self) -> DATA34_W<DHTMEM8rs> {
        DATA34_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 35
    #[inline(always)]
    pub fn data35(&mut self) -> DATA35_W<DHTMEM8rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM8)*/
