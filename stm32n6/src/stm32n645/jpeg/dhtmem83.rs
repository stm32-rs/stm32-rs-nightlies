...
impl W {
    ///Bits 0:7 - Huffman table data 332
    #[inline(always)]
    pub fn data332(&mut self) -> DATA332_W<DHTMEM83rs> {
        DATA332_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 333
    #[inline(always)]
    pub fn data333(&mut self) -> DATA333_W<DHTMEM83rs> {
        DATA333_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 334
    #[inline(always)]
    pub fn data334(&mut self) -> DATA334_W<DHTMEM83rs> {
        DATA334_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 335
    #[inline(always)]
    pub fn data335(&mut self) -> DATA335_W<DHTMEM83rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM83)*/
