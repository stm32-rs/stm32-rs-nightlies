...
impl W {
    ///Bits 0:7 - Huffman table data 336
    #[inline(always)]
    pub fn data336(&mut self) -> DATA336_W<DHTMEM84rs> {
        DATA336_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 337
    #[inline(always)]
    pub fn data337(&mut self) -> DATA337_W<DHTMEM84rs> {
        DATA337_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 338
    #[inline(always)]
    pub fn data338(&mut self) -> DATA338_W<DHTMEM84rs> {
        DATA338_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 339
    #[inline(always)]
    pub fn data339(&mut self) -> DATA339_W<DHTMEM84rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM84)*/
