...
impl W {
    ///Bits 0:7 - Huffman table data 340
    #[inline(always)]
    pub fn data340(&mut self) -> DATA340_W<DHTMEM85rs> {
        DATA340_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 341
    #[inline(always)]
    pub fn data341(&mut self) -> DATA341_W<DHTMEM85rs> {
        DATA341_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 342
    #[inline(always)]
    pub fn data342(&mut self) -> DATA342_W<DHTMEM85rs> {
        DATA342_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 343
    #[inline(always)]
    pub fn data343(&mut self) -> DATA343_W<DHTMEM85rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM85)*/
