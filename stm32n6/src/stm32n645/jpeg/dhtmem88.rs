...
impl W {
    ///Bits 0:7 - Huffman table data 352
    #[inline(always)]
    pub fn data352(&mut self) -> DATA352_W<DHTMEM88rs> {
        DATA352_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 353
    #[inline(always)]
    pub fn data353(&mut self) -> DATA353_W<DHTMEM88rs> {
        DATA353_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 354
    #[inline(always)]
    pub fn data354(&mut self) -> DATA354_W<DHTMEM88rs> {
        DATA354_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 355
    #[inline(always)]
    pub fn data355(&mut self) -> DATA355_W<DHTMEM88rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM88)*/
