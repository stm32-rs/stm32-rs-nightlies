...
impl W {
    ///Bits 0:7 - Huffman table data 356
    #[inline(always)]
    pub fn data356(&mut self) -> DATA356_W<DHTMEM89rs> {
        DATA356_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 357
    #[inline(always)]
    pub fn data357(&mut self) -> DATA357_W<DHTMEM89rs> {
        DATA357_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 358
    #[inline(always)]
    pub fn data358(&mut self) -> DATA358_W<DHTMEM89rs> {
        DATA358_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 359
    #[inline(always)]
    pub fn data359(&mut self) -> DATA359_W<DHTMEM89rs> {
