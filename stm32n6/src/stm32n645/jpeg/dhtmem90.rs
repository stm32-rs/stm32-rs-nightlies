...
impl W {
    ///Bits 0:7 - Huffman table data 360
    #[inline(always)]
    pub fn data360(&mut self) -> DATA360_W<DHTMEM90rs> {
        DATA360_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 361
    #[inline(always)]
    pub fn data361(&mut self) -> DATA361_W<DHTMEM90rs> {
        DATA361_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 362
    #[inline(always)]
    pub fn data362(&mut self) -> DATA362_W<DHTMEM90rs> {
        DATA362_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 363
    #[inline(always)]
    pub fn data363(&mut self) -> DATA363_W<DHTMEM90rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM90)*/
