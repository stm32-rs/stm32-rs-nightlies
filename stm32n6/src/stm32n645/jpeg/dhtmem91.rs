...
impl W {
    ///Bits 0:7 - Huffman table data 364
    #[inline(always)]
    pub fn data364(&mut self) -> DATA364_W<DHTMEM91rs> {
        DATA364_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 365
    #[inline(always)]
    pub fn data365(&mut self) -> DATA365_W<DHTMEM91rs> {
        DATA365_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 366
    #[inline(always)]
    pub fn data366(&mut self) -> DATA366_W<DHTMEM91rs> {
        DATA366_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 367
    #[inline(always)]
    pub fn data367(&mut self) -> DATA367_W<DHTMEM91rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:DHTMEM91)*/
