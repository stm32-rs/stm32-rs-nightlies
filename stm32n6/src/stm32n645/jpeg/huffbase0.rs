...
impl W {
    ///Bits 0:8 - Data 0
    #[inline(always)]
    pub fn data0(&mut self) -> DATA0_W<HUFFBASE0rs> {
        DATA0_W::new(self, 0)
    }
    ///Bits 16:24 - Data 1
    #[inline(always)]
    pub fn data1(&mut self) -> DATA1_W<HUFFBASE0rs> {
        DATA1_W::new(self, 16)
    }
}
/**JPEG Huffman base
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFBASE0)*/
