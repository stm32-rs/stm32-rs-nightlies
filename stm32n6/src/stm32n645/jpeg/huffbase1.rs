...
impl W {
    ///Bits 0:8 - Data 2
    #[inline(always)]
    pub fn data2(&mut self) -> DATA2_W<HUFFBASE1rs> {
        DATA2_W::new(self, 0)
    }
    ///Bits 16:24 - Data 3
    #[inline(always)]
    pub fn data3(&mut self) -> DATA3_W<HUFFBASE1rs> {
        DATA3_W::new(self, 16)
    }
}
/**JPEG Huffman base
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFBASE1)*/
