...
impl W {
    ///Bits 0:8 - Data 20
    #[inline(always)]
    pub fn data20(&mut self) -> DATA20_W<HUFFBASE10rs> {
        DATA20_W::new(self, 0)
    }
    ///Bits 16:24 - Data 21
    #[inline(always)]
    pub fn data21(&mut self) -> DATA21_W<HUFFBASE10rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFBASE10)*/
