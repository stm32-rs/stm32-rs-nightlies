...
impl W {
    ///Bits 0:8 - Data 26
    #[inline(always)]
    pub fn data26(&mut self) -> DATA26_W<HUFFBASE13rs> {
        DATA26_W::new(self, 0)
    }
    ///Bits 16:24 - Data 27
    #[inline(always)]
    pub fn data27(&mut self) -> DATA27_W<HUFFBASE13rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFBASE13)*/
