...
impl W {
    ///Bits 0:8 - Data 30
    #[inline(always)]
    pub fn data30(&mut self) -> DATA30_W<HUFFBASE15rs> {
        DATA30_W::new(self, 0)
    }
    ///Bits 16:24 - Data 31
    #[inline(always)]
    pub fn data31(&mut self) -> DATA31_W<HUFFBASE15rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFBASE15)*/
