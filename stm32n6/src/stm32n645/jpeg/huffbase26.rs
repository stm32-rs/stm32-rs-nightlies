...
impl W {
    ///Bits 0:8 - Data 52
    #[inline(always)]
    pub fn data52(&mut self) -> DATA52_W<HUFFBASE26rs> {
        DATA52_W::new(self, 0)
    }
    ///Bits 16:24 - Data 53
    #[inline(always)]
    pub fn data53(&mut self) -> DATA53_W<HUFFBASE26rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFBASE26)*/
