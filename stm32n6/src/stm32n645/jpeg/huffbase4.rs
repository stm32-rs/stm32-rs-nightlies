...
impl W {
    ///Bits 0:8 - Data 8
    #[inline(always)]
    pub fn data8(&mut self) -> DATA8_W<HUFFBASE4rs> {
        DATA8_W::new(self, 0)
    }
    ///Bits 16:24 - Data 9
    #[inline(always)]
    pub fn data9(&mut self) -> DATA9_W<HUFFBASE4rs> {
        DATA9_W::new(self, 16)
    }
}
/**JPEG Huffman base
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFBASE4)*/
