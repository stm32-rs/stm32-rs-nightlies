...
impl W {
    ///Bits 0:7 - Huffman code 2
    #[inline(always)]
    pub fn hcode2(&mut self) -> HCODE2_W<HUFFENC_AC0_1rs> {
        HCODE2_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 2
    #[inline(always)]
    pub fn hlen2(&mut self) -> HLEN2_W<HUFFENC_AC0_1rs> {
        HLEN2_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 3
    #[inline(always)]
    pub fn hcode3(&mut self) -> HCODE3_W<HUFFENC_AC0_1rs> {
        HCODE3_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 3
    #[inline(always)]
    pub fn hlen3(&mut self) -> HLEN3_W<HUFFENC_AC0_1rs> {
        HLEN3_W::new(self, 24)
    }
}
