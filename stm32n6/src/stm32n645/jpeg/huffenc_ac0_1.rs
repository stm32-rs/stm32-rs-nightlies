///Register `HUFFENC_AC0_1` reader
pub type R = crate::R<HUFFENC_AC0_1rs>;
///Register `HUFFENC_AC0_1` writer
pub type W = crate::W<HUFFENC_AC0_1rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 2
    #[inline(always)]
    pub fn hcode2(&mut self) -> HCODE2_W<'_, HUFFENC_AC0_1rs> {
        HCODE2_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 2
    #[inline(always)]
    pub fn hlen2(&mut self) -> HLEN2_W<'_, HUFFENC_AC0_1rs> {
        HLEN2_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 3
    #[inline(always)]
    pub fn hcode3(&mut self) -> HCODE3_W<'_, HUFFENC_AC0_1rs> {
        HCODE3_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 3
    #[inline(always)]
    pub fn hlen3(&mut self) -> HLEN3_W<'_, HUFFENC_AC0_1rs> {
        HLEN3_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_1)*/
pub struct HUFFENC_AC0_1rs;
impl crate::RegisterSpec for HUFFENC_AC0_1rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_1::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_1rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_1::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_1 to value 0
impl crate::Resettable for HUFFENC_AC0_1rs {}
