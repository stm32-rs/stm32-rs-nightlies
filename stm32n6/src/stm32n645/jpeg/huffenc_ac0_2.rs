///Register `HUFFENC_AC0_2` reader
pub type R = crate::R<HUFFENC_AC0_2rs>;
///Register `HUFFENC_AC0_2` writer
pub type W = crate::W<HUFFENC_AC0_2rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 4
    #[inline(always)]
    pub fn hcode4(&mut self) -> HCODE4_W<'_, HUFFENC_AC0_2rs> {
        HCODE4_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 4
    #[inline(always)]
    pub fn hlen4(&mut self) -> HLEN4_W<'_, HUFFENC_AC0_2rs> {
        HLEN4_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 5
    #[inline(always)]
    pub fn hcode5(&mut self) -> HCODE5_W<'_, HUFFENC_AC0_2rs> {
        HCODE5_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 5
    #[inline(always)]
    pub fn hlen5(&mut self) -> HLEN5_W<'_, HUFFENC_AC0_2rs> {
        HLEN5_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_2)*/
pub struct HUFFENC_AC0_2rs;
impl crate::RegisterSpec for HUFFENC_AC0_2rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_2::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_2rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_2::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_2 to value 0
impl crate::Resettable for HUFFENC_AC0_2rs {}
