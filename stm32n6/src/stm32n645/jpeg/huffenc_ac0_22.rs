///Register `HUFFENC_AC0_22` reader
pub type R = crate::R<HUFFENC_AC0_22rs>;
///Register `HUFFENC_AC0_22` writer
pub type W = crate::W<HUFFENC_AC0_22rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 44
    #[inline(always)]
    pub fn hcode44(&mut self) -> HCODE44_W<'_, HUFFENC_AC0_22rs> {
        HCODE44_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 44
    #[inline(always)]
    pub fn hlen44(&mut self) -> HLEN44_W<'_, HUFFENC_AC0_22rs> {
        HLEN44_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 45
    #[inline(always)]
    pub fn hcode45(&mut self) -> HCODE45_W<'_, HUFFENC_AC0_22rs> {
        HCODE45_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 45
    #[inline(always)]
    pub fn hlen45(&mut self) -> HLEN45_W<'_, HUFFENC_AC0_22rs> {
        HLEN45_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_22::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_22::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_22)*/
pub struct HUFFENC_AC0_22rs;
impl crate::RegisterSpec for HUFFENC_AC0_22rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_22::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_22rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_22::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_22rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_22 to value 0
impl crate::Resettable for HUFFENC_AC0_22rs {}
