...
impl W {
    ///Bits 0:7 - Huffman code 44
    #[inline(always)]
    pub fn hcode44(&mut self) -> HCODE44_W<HUFFENC_AC0_22rs> {
        HCODE44_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 44
    #[inline(always)]
    pub fn hlen44(&mut self) -> HLEN44_W<HUFFENC_AC0_22rs> {
        HLEN44_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 45
    #[inline(always)]
    pub fn hcode45(&mut self) -> HCODE45_W<HUFFENC_AC0_22rs> {
        HCODE45_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 45
    #[inline(always)]
    pub fn hlen45(&mut self) -> HLEN45_W<HUFFENC_AC0_22rs> {
