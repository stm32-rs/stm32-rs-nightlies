...
impl W {
    ///Bits 0:7 - Huffman code 56
    #[inline(always)]
    pub fn hcode56(&mut self) -> HCODE56_W<HUFFENC_AC0_28rs> {
        HCODE56_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 56
    #[inline(always)]
    pub fn hlen56(&mut self) -> HLEN56_W<HUFFENC_AC0_28rs> {
        HLEN56_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 57
    #[inline(always)]
    pub fn hcode57(&mut self) -> HCODE57_W<HUFFENC_AC0_28rs> {
        HCODE57_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 57
    #[inline(always)]
    pub fn hlen57(&mut self) -> HLEN57_W<HUFFENC_AC0_28rs> {
