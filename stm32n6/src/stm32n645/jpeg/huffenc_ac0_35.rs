///Register `HUFFENC_AC0_35` reader
pub type R = crate::R<HUFFENC_AC0_35rs>;
///Register `HUFFENC_AC0_35` writer
pub type W = crate::W<HUFFENC_AC0_35rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 70
    #[inline(always)]
    pub fn hcode70(&mut self) -> HCODE70_W<'_, HUFFENC_AC0_35rs> {
        HCODE70_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 70
    #[inline(always)]
    pub fn hlen70(&mut self) -> HLEN70_W<'_, HUFFENC_AC0_35rs> {
        HLEN70_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 71
    #[inline(always)]
    pub fn hcode71(&mut self) -> HCODE71_W<'_, HUFFENC_AC0_35rs> {
        HCODE71_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 71
    #[inline(always)]
    pub fn hlen71(&mut self) -> HLEN71_W<'_, HUFFENC_AC0_35rs> {
        HLEN71_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_35::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_35::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_35)*/
pub struct HUFFENC_AC0_35rs;
impl crate::RegisterSpec for HUFFENC_AC0_35rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_35::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_35rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_35::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_35rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_35 to value 0
impl crate::Resettable for HUFFENC_AC0_35rs {}
