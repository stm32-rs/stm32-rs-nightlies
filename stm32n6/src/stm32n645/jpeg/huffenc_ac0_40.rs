...
impl W {
    ///Bits 0:7 - Huffman code 80
    #[inline(always)]
    pub fn hcode80(&mut self) -> HCODE80_W<HUFFENC_AC0_40rs> {
        HCODE80_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 80
    #[inline(always)]
    pub fn hlen80(&mut self) -> HLEN80_W<HUFFENC_AC0_40rs> {
        HLEN80_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 81
    #[inline(always)]
    pub fn hcode81(&mut self) -> HCODE81_W<HUFFENC_AC0_40rs> {
        HCODE81_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 81
    #[inline(always)]
    pub fn hlen81(&mut self) -> HLEN81_W<HUFFENC_AC0_40rs> {
