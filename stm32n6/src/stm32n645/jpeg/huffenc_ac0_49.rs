...
impl W {
    ///Bits 0:7 - Huffman code 98
    #[inline(always)]
    pub fn hcode98(&mut self) -> HCODE98_W<HUFFENC_AC0_49rs> {
        HCODE98_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 98
    #[inline(always)]
    pub fn hlen98(&mut self) -> HLEN98_W<HUFFENC_AC0_49rs> {
        HLEN98_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 99
    #[inline(always)]
    pub fn hcode99(&mut self) -> HCODE99_W<HUFFENC_AC0_49rs> {
        HCODE99_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 99
    #[inline(always)]
    pub fn hlen99(&mut self) -> HLEN99_W<HUFFENC_AC0_49rs> {
