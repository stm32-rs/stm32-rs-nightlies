///Register `HUFFENC_AC0_49` reader
pub type R = crate::R<HUFFENC_AC0_49rs>;
///Register `HUFFENC_AC0_49` writer
pub type W = crate::W<HUFFENC_AC0_49rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 98
    #[inline(always)]
    pub fn hcode98(&mut self) -> HCODE98_W<'_, HUFFENC_AC0_49rs> {
        HCODE98_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 98
    #[inline(always)]
    pub fn hlen98(&mut self) -> HLEN98_W<'_, HUFFENC_AC0_49rs> {
        HLEN98_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 99
    #[inline(always)]
    pub fn hcode99(&mut self) -> HCODE99_W<'_, HUFFENC_AC0_49rs> {
        HCODE99_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 99
    #[inline(always)]
    pub fn hlen99(&mut self) -> HLEN99_W<'_, HUFFENC_AC0_49rs> {
        HLEN99_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_49::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_49::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_49)*/
pub struct HUFFENC_AC0_49rs;
impl crate::RegisterSpec for HUFFENC_AC0_49rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_49::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_49rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_49::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_49rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_49 to value 0
impl crate::Resettable for HUFFENC_AC0_49rs {}
