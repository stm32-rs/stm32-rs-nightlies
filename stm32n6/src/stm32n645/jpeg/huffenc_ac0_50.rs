...
impl W {
    ///Bits 0:7 - Huffman code 100
    #[inline(always)]
    pub fn hcode100(&mut self) -> HCODE100_W<HUFFENC_AC0_50rs> {
        HCODE100_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 100
    #[inline(always)]
    pub fn hlen100(&mut self) -> HLEN100_W<HUFFENC_AC0_50rs> {
        HLEN100_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 101
    #[inline(always)]
    pub fn hcode101(&mut self) -> HCODE101_W<HUFFENC_AC0_50rs> {
        HCODE101_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 101
    #[inline(always)]
    pub fn hlen101(&mut self) -> HLEN101_W<HUFFENC_AC0_50rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_50)*/
