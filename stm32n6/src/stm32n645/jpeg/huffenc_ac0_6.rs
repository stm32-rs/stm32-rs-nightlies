///Register `HUFFENC_AC0_6` reader
pub type R = crate::R<HUFFENC_AC0_6rs>;
///Register `HUFFENC_AC0_6` writer
pub type W = crate::W<HUFFENC_AC0_6rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 12
    #[inline(always)]
    pub fn hcode12(&mut self) -> HCODE12_W<'_, HUFFENC_AC0_6rs> {
        HCODE12_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 12
    #[inline(always)]
    pub fn hlen12(&mut self) -> HLEN12_W<'_, HUFFENC_AC0_6rs> {
        HLEN12_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 13
    #[inline(always)]
    pub fn hcode13(&mut self) -> HCODE13_W<'_, HUFFENC_AC0_6rs> {
        HCODE13_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 13
    #[inline(always)]
    pub fn hlen13(&mut self) -> HLEN13_W<'_, HUFFENC_AC0_6rs> {
        HLEN13_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_6)*/
pub struct HUFFENC_AC0_6rs;
impl crate::RegisterSpec for HUFFENC_AC0_6rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_6::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_6rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_6::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_6rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_6 to value 0
impl crate::Resettable for HUFFENC_AC0_6rs {}
