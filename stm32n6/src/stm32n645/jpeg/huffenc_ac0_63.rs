...
impl W {
    ///Bits 0:7 - Huffman code 126
    #[inline(always)]
    pub fn hcode126(&mut self) -> HCODE126_W<HUFFENC_AC0_63rs> {
        HCODE126_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 126
    #[inline(always)]
    pub fn hlen126(&mut self) -> HLEN126_W<HUFFENC_AC0_63rs> {
        HLEN126_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 127
    #[inline(always)]
    pub fn hcode127(&mut self) -> HCODE127_W<HUFFENC_AC0_63rs> {
        HCODE127_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 127
    #[inline(always)]
    pub fn hlen127(&mut self) -> HLEN127_W<HUFFENC_AC0_63rs> {
