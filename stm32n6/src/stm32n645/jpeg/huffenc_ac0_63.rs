///Register `HUFFENC_AC0_63` reader
pub type R = crate::R<HUFFENC_AC0_63rs>;
///Register `HUFFENC_AC0_63` writer
pub type W = crate::W<HUFFENC_AC0_63rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 126
    #[inline(always)]
    pub fn hcode126(&mut self) -> HCODE126_W<'_, HUFFENC_AC0_63rs> {
        HCODE126_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 126
    #[inline(always)]
    pub fn hlen126(&mut self) -> HLEN126_W<'_, HUFFENC_AC0_63rs> {
        HLEN126_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 127
    #[inline(always)]
    pub fn hcode127(&mut self) -> HCODE127_W<'_, HUFFENC_AC0_63rs> {
        HCODE127_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 127
    #[inline(always)]
    pub fn hlen127(&mut self) -> HLEN127_W<'_, HUFFENC_AC0_63rs> {
        HLEN127_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_63::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_63::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_63)*/
pub struct HUFFENC_AC0_63rs;
impl crate::RegisterSpec for HUFFENC_AC0_63rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_63::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_63rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_63::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_63rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_63 to value 0
impl crate::Resettable for HUFFENC_AC0_63rs {}
