///Register `HUFFENC_AC0_64` reader
pub type R = crate::R<HUFFENC_AC0_64rs>;
///Register `HUFFENC_AC0_64` writer
pub type W = crate::W<HUFFENC_AC0_64rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 128
    #[inline(always)]
    pub fn hcode128(&mut self) -> HCODE128_W<'_, HUFFENC_AC0_64rs> {
        HCODE128_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 128
    #[inline(always)]
    pub fn hlen128(&mut self) -> HLEN128_W<'_, HUFFENC_AC0_64rs> {
        HLEN128_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 129
    #[inline(always)]
    pub fn hcode129(&mut self) -> HCODE129_W<'_, HUFFENC_AC0_64rs> {
        HCODE129_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 129
    #[inline(always)]
    pub fn hlen129(&mut self) -> HLEN129_W<'_, HUFFENC_AC0_64rs> {
        HLEN129_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_64::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_64::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_64)*/
pub struct HUFFENC_AC0_64rs;
impl crate::RegisterSpec for HUFFENC_AC0_64rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_64::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_64rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_64::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_64rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_64 to value 0
impl crate::Resettable for HUFFENC_AC0_64rs {}
