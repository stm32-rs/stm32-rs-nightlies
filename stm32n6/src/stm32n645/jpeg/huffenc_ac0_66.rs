...
impl W {
    ///Bits 0:7 - Huffman code 132
    #[inline(always)]
    pub fn hcode132(&mut self) -> HCODE132_W<HUFFENC_AC0_66rs> {
        HCODE132_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 132
    #[inline(always)]
    pub fn hlen132(&mut self) -> HLEN132_W<HUFFENC_AC0_66rs> {
        HLEN132_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 133
    #[inline(always)]
    pub fn hcode133(&mut self) -> HCODE133_W<HUFFENC_AC0_66rs> {
        HCODE133_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 133
    #[inline(always)]
    pub fn hlen133(&mut self) -> HLEN133_W<HUFFENC_AC0_66rs> {
