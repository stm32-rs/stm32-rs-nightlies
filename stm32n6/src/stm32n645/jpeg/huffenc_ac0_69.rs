///Register `HUFFENC_AC0_69` reader
pub type R = crate::R<HUFFENC_AC0_69rs>;
///Register `HUFFENC_AC0_69` writer
pub type W = crate::W<HUFFENC_AC0_69rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 138
    #[inline(always)]
    pub fn hcode138(&mut self) -> HCODE138_W<'_, HUFFENC_AC0_69rs> {
        HCODE138_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 138
    #[inline(always)]
    pub fn hlen138(&mut self) -> HLEN138_W<'_, HUFFENC_AC0_69rs> {
        HLEN138_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 139
    #[inline(always)]
    pub fn hcode139(&mut self) -> HCODE139_W<'_, HUFFENC_AC0_69rs> {
        HCODE139_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 139
    #[inline(always)]
    pub fn hlen139(&mut self) -> HLEN139_W<'_, HUFFENC_AC0_69rs> {
        HLEN139_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_69::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_69::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_69)*/
pub struct HUFFENC_AC0_69rs;
impl crate::RegisterSpec for HUFFENC_AC0_69rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_69::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_69rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_69::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_69rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_69 to value 0
impl crate::Resettable for HUFFENC_AC0_69rs {}
