...
impl W {
    ///Bits 0:7 - Huffman code 138
    #[inline(always)]
    pub fn hcode138(&mut self) -> HCODE138_W<HUFFENC_AC0_69rs> {
        HCODE138_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 138
    #[inline(always)]
    pub fn hlen138(&mut self) -> HLEN138_W<HUFFENC_AC0_69rs> {
        HLEN138_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 139
    #[inline(always)]
    pub fn hcode139(&mut self) -> HCODE139_W<HUFFENC_AC0_69rs> {
        HCODE139_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 139
    #[inline(always)]
    pub fn hlen139(&mut self) -> HLEN139_W<HUFFENC_AC0_69rs> {
