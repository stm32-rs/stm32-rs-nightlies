///Register `HUFFENC_AC0_83` reader
pub type R = crate::R<HUFFENC_AC0_83rs>;
///Register `HUFFENC_AC0_83` writer
pub type W = crate::W<HUFFENC_AC0_83rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 166
    #[inline(always)]
    pub fn hcode166(&mut self) -> HCODE166_W<'_, HUFFENC_AC0_83rs> {
        HCODE166_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 166
    #[inline(always)]
    pub fn hlen166(&mut self) -> HLEN166_W<'_, HUFFENC_AC0_83rs> {
        HLEN166_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 167
    #[inline(always)]
    pub fn hcode167(&mut self) -> HCODE167_W<'_, HUFFENC_AC0_83rs> {
        HCODE167_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 167
    #[inline(always)]
    pub fn hlen167(&mut self) -> HLEN167_W<'_, HUFFENC_AC0_83rs> {
        HLEN167_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_83::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_83::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_83)*/
pub struct HUFFENC_AC0_83rs;
impl crate::RegisterSpec for HUFFENC_AC0_83rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_83::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_83rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_83::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_83rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_83 to value 0
impl crate::Resettable for HUFFENC_AC0_83rs {}
