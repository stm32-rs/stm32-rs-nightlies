///Register `HUFFENC_AC0_84` reader
pub type R = crate::R<HUFFENC_AC0_84rs>;
///Register `HUFFENC_AC0_84` writer
pub type W = crate::W<HUFFENC_AC0_84rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 168
    #[inline(always)]
    pub fn hcode168(&mut self) -> HCODE168_W<'_, HUFFENC_AC0_84rs> {
        HCODE168_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 168
    #[inline(always)]
    pub fn hlen168(&mut self) -> HLEN168_W<'_, HUFFENC_AC0_84rs> {
        HLEN168_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 169
    #[inline(always)]
    pub fn hcode169(&mut self) -> HCODE169_W<'_, HUFFENC_AC0_84rs> {
        HCODE169_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 169
    #[inline(always)]
    pub fn hlen169(&mut self) -> HLEN169_W<'_, HUFFENC_AC0_84rs> {
        HLEN169_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_84::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_84::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_84)*/
pub struct HUFFENC_AC0_84rs;
impl crate::RegisterSpec for HUFFENC_AC0_84rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_84::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_84rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_84::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_84rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_84 to value 0
impl crate::Resettable for HUFFENC_AC0_84rs {}
