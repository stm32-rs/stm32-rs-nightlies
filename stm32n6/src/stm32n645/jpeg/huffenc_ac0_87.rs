...
impl W {
    ///Bits 0:7 - Huffman code 174
    #[inline(always)]
    pub fn hcode174(&mut self) -> HCODE174_W<HUFFENC_AC0_87rs> {
        HCODE174_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 174
    #[inline(always)]
    pub fn hlen174(&mut self) -> HLEN174_W<HUFFENC_AC0_87rs> {
        HLEN174_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 175
    #[inline(always)]
    pub fn hcode175(&mut self) -> HCODE175_W<HUFFENC_AC0_87rs> {
        HCODE175_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 175
    #[inline(always)]
    pub fn hlen175(&mut self) -> HLEN175_W<HUFFENC_AC0_87rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC0_87)*/
