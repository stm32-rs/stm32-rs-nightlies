///Register `HUFFENC_AC1_11` reader
pub type R = crate::R<HUFFENC_AC1_11rs>;
///Register `HUFFENC_AC1_11` writer
pub type W = crate::W<HUFFENC_AC1_11rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 22
    #[inline(always)]
    pub fn hcode22(&mut self) -> HCODE22_W<'_, HUFFENC_AC1_11rs> {
        HCODE22_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 22
    #[inline(always)]
    pub fn hlen22(&mut self) -> HLEN22_W<'_, HUFFENC_AC1_11rs> {
        HLEN22_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 23
    #[inline(always)]
    pub fn hcode23(&mut self) -> HCODE23_W<'_, HUFFENC_AC1_11rs> {
        HCODE23_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 23
    #[inline(always)]
    pub fn hlen23(&mut self) -> HLEN23_W<'_, HUFFENC_AC1_11rs> {
        HLEN23_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_11)*/
pub struct HUFFENC_AC1_11rs;
impl crate::RegisterSpec for HUFFENC_AC1_11rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_11::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_11rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_11::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_11rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_11 to value 0
impl crate::Resettable for HUFFENC_AC1_11rs {}
