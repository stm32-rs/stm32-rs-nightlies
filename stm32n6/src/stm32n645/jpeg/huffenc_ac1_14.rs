...
impl W {
    ///Bits 0:7 - Huffman code 28
    #[inline(always)]
    pub fn hcode28(&mut self) -> HCODE28_W<HUFFENC_AC1_14rs> {
        HCODE28_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 28
    #[inline(always)]
    pub fn hlen28(&mut self) -> HLEN28_W<HUFFENC_AC1_14rs> {
        HLEN28_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 29
    #[inline(always)]
    pub fn hcode29(&mut self) -> HCODE29_W<HUFFENC_AC1_14rs> {
        HCODE29_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 29
    #[inline(always)]
    pub fn hlen29(&mut self) -> HLEN29_W<HUFFENC_AC1_14rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_14)*/
