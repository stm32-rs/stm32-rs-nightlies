...
impl W {
    ///Bits 0:7 - Huffman code 34
    #[inline(always)]
    pub fn hcode34(&mut self) -> HCODE34_W<HUFFENC_AC1_17rs> {
        HCODE34_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 34
    #[inline(always)]
    pub fn hlen34(&mut self) -> HLEN34_W<HUFFENC_AC1_17rs> {
        HLEN34_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 35
    #[inline(always)]
    pub fn hcode35(&mut self) -> HCODE35_W<HUFFENC_AC1_17rs> {
        HCODE35_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 35
    #[inline(always)]
    pub fn hlen35(&mut self) -> HLEN35_W<HUFFENC_AC1_17rs> {
