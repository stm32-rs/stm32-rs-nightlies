///Register `HUFFENC_AC1_17` reader
pub type R = crate::R<HUFFENC_AC1_17rs>;
///Register `HUFFENC_AC1_17` writer
pub type W = crate::W<HUFFENC_AC1_17rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 34
    #[inline(always)]
    pub fn hcode34(&mut self) -> HCODE34_W<'_, HUFFENC_AC1_17rs> {
        HCODE34_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 34
    #[inline(always)]
    pub fn hlen34(&mut self) -> HLEN34_W<'_, HUFFENC_AC1_17rs> {
        HLEN34_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 35
    #[inline(always)]
    pub fn hcode35(&mut self) -> HCODE35_W<'_, HUFFENC_AC1_17rs> {
        HCODE35_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 35
    #[inline(always)]
    pub fn hlen35(&mut self) -> HLEN35_W<'_, HUFFENC_AC1_17rs> {
        HLEN35_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_17::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_17::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_17)*/
pub struct HUFFENC_AC1_17rs;
impl crate::RegisterSpec for HUFFENC_AC1_17rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_17::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_17rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_17::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_17rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_17 to value 0
impl crate::Resettable for HUFFENC_AC1_17rs {}
