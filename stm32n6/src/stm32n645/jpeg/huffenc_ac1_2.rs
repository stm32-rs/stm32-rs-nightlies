...
impl W {
    ///Bits 0:7 - Huffman code 4
    #[inline(always)]
    pub fn hcode4(&mut self) -> HCODE4_W<HUFFENC_AC1_2rs> {
        HCODE4_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 4
    #[inline(always)]
    pub fn hlen4(&mut self) -> HLEN4_W<HUFFENC_AC1_2rs> {
        HLEN4_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 5
    #[inline(always)]
    pub fn hcode5(&mut self) -> HCODE5_W<HUFFENC_AC1_2rs> {
        HCODE5_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 5
    #[inline(always)]
    pub fn hlen5(&mut self) -> HLEN5_W<HUFFENC_AC1_2rs> {
        HLEN5_W::new(self, 24)
    }
}
