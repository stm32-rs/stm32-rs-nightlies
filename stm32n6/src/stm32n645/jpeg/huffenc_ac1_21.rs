...
impl W {
    ///Bits 0:7 - Huffman code 42
    #[inline(always)]
    pub fn hcode42(&mut self) -> HCODE42_W<HUFFENC_AC1_21rs> {
        HCODE42_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 42
    #[inline(always)]
    pub fn hlen42(&mut self) -> HLEN42_W<HUFFENC_AC1_21rs> {
        HLEN42_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 43
    #[inline(always)]
    pub fn hcode43(&mut self) -> HCODE43_W<HUFFENC_AC1_21rs> {
        HCODE43_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 43
    #[inline(always)]
    pub fn hlen43(&mut self) -> HLEN43_W<HUFFENC_AC1_21rs> {
