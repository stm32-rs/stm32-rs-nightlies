...
impl W {
    ///Bits 0:7 - Huffman code 60
    #[inline(always)]
    pub fn hcode60(&mut self) -> HCODE60_W<HUFFENC_AC1_30rs> {
        HCODE60_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 60
    #[inline(always)]
    pub fn hlen60(&mut self) -> HLEN60_W<HUFFENC_AC1_30rs> {
        HLEN60_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 61
    #[inline(always)]
    pub fn hcode61(&mut self) -> HCODE61_W<HUFFENC_AC1_30rs> {
        HCODE61_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 61
    #[inline(always)]
    pub fn hlen61(&mut self) -> HLEN61_W<HUFFENC_AC1_30rs> {
