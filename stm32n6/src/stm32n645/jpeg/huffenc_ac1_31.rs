...
impl W {
    ///Bits 0:7 - Huffman code 62
    #[inline(always)]
    pub fn hcode62(&mut self) -> HCODE62_W<HUFFENC_AC1_31rs> {
        HCODE62_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 62
    #[inline(always)]
    pub fn hlen62(&mut self) -> HLEN62_W<HUFFENC_AC1_31rs> {
        HLEN62_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 63
    #[inline(always)]
    pub fn hcode63(&mut self) -> HCODE63_W<HUFFENC_AC1_31rs> {
        HCODE63_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 63
    #[inline(always)]
    pub fn hlen63(&mut self) -> HLEN63_W<HUFFENC_AC1_31rs> {
