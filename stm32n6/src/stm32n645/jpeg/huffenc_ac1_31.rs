///Register `HUFFENC_AC1_31` reader
pub type R = crate::R<HUFFENC_AC1_31rs>;
///Register `HUFFENC_AC1_31` writer
pub type W = crate::W<HUFFENC_AC1_31rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 62
    #[inline(always)]
    pub fn hcode62(&mut self) -> HCODE62_W<'_, HUFFENC_AC1_31rs> {
        HCODE62_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 62
    #[inline(always)]
    pub fn hlen62(&mut self) -> HLEN62_W<'_, HUFFENC_AC1_31rs> {
        HLEN62_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 63
    #[inline(always)]
    pub fn hcode63(&mut self) -> HCODE63_W<'_, HUFFENC_AC1_31rs> {
        HCODE63_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 63
    #[inline(always)]
    pub fn hlen63(&mut self) -> HLEN63_W<'_, HUFFENC_AC1_31rs> {
        HLEN63_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_31::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_31::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_31)*/
pub struct HUFFENC_AC1_31rs;
impl crate::RegisterSpec for HUFFENC_AC1_31rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_31::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_31rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_31::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_31rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_31 to value 0
impl crate::Resettable for HUFFENC_AC1_31rs {}
