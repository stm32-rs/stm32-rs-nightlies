...
impl W {
    ///Bits 0:7 - Huffman code 88
    #[inline(always)]
    pub fn hcode88(&mut self) -> HCODE88_W<HUFFENC_AC1_44rs> {
        HCODE88_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 88
    #[inline(always)]
    pub fn hlen88(&mut self) -> HLEN88_W<HUFFENC_AC1_44rs> {
        HLEN88_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 89
    #[inline(always)]
    pub fn hcode89(&mut self) -> HCODE89_W<HUFFENC_AC1_44rs> {
        HCODE89_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 89
    #[inline(always)]
    pub fn hlen89(&mut self) -> HLEN89_W<HUFFENC_AC1_44rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_44)*/
