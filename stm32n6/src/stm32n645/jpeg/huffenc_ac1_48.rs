///Register `HUFFENC_AC1_48` reader
pub type R = crate::R<HUFFENC_AC1_48rs>;
///Register `HUFFENC_AC1_48` writer
pub type W = crate::W<HUFFENC_AC1_48rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 96
    #[inline(always)]
    pub fn hcode96(&mut self) -> HCODE96_W<'_, HUFFENC_AC1_48rs> {
        HCODE96_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 96
    #[inline(always)]
    pub fn hlen96(&mut self) -> HLEN96_W<'_, HUFFENC_AC1_48rs> {
        HLEN96_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 97
    #[inline(always)]
    pub fn hcode97(&mut self) -> HCODE97_W<'_, HUFFENC_AC1_48rs> {
        HCODE97_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 97
    #[inline(always)]
    pub fn hlen97(&mut self) -> HLEN97_W<'_, HUFFENC_AC1_48rs> {
        HLEN97_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_48::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_48::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_48)*/
pub struct HUFFENC_AC1_48rs;
impl crate::RegisterSpec for HUFFENC_AC1_48rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_48::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_48rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_48::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_48rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_48 to value 0
impl crate::Resettable for HUFFENC_AC1_48rs {}
