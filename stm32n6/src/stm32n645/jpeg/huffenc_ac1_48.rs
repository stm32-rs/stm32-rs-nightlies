...
impl W {
    ///Bits 0:7 - Huffman code 96
    #[inline(always)]
    pub fn hcode96(&mut self) -> HCODE96_W<HUFFENC_AC1_48rs> {
        HCODE96_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 96
    #[inline(always)]
    pub fn hlen96(&mut self) -> HLEN96_W<HUFFENC_AC1_48rs> {
        HLEN96_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 97
    #[inline(always)]
    pub fn hcode97(&mut self) -> HCODE97_W<HUFFENC_AC1_48rs> {
        HCODE97_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 97
    #[inline(always)]
    pub fn hlen97(&mut self) -> HLEN97_W<HUFFENC_AC1_48rs> {
