///Register `HUFFENC_AC1_51` reader
pub type R = crate::R<HUFFENC_AC1_51rs>;
///Register `HUFFENC_AC1_51` writer
pub type W = crate::W<HUFFENC_AC1_51rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 102
    #[inline(always)]
    pub fn hcode102(&mut self) -> HCODE102_W<'_, HUFFENC_AC1_51rs> {
        HCODE102_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 102
    #[inline(always)]
    pub fn hlen102(&mut self) -> HLEN102_W<'_, HUFFENC_AC1_51rs> {
        HLEN102_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 103
    #[inline(always)]
    pub fn hcode103(&mut self) -> HCODE103_W<'_, HUFFENC_AC1_51rs> {
        HCODE103_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 103
    #[inline(always)]
    pub fn hlen103(&mut self) -> HLEN103_W<'_, HUFFENC_AC1_51rs> {
        HLEN103_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_51::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_51::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_51)*/
pub struct HUFFENC_AC1_51rs;
impl crate::RegisterSpec for HUFFENC_AC1_51rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_51::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_51rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_51::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_51rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_51 to value 0
impl crate::Resettable for HUFFENC_AC1_51rs {}
