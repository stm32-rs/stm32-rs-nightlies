...
impl W {
    ///Bits 0:7 - Huffman code 110
    #[inline(always)]
    pub fn hcode110(&mut self) -> HCODE110_W<HUFFENC_AC1_55rs> {
        HCODE110_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 110
    #[inline(always)]
    pub fn hlen110(&mut self) -> HLEN110_W<HUFFENC_AC1_55rs> {
        HLEN110_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 111
    #[inline(always)]
    pub fn hcode111(&mut self) -> HCODE111_W<HUFFENC_AC1_55rs> {
        HCODE111_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 111
    #[inline(always)]
    pub fn hlen111(&mut self) -> HLEN111_W<HUFFENC_AC1_55rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_55)*/
