...
impl W {
    ///Bits 0:7 - Huffman code 144
    #[inline(always)]
    pub fn hcode144(&mut self) -> HCODE144_W<HUFFENC_AC1_72rs> {
        HCODE144_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 144
    #[inline(always)]
    pub fn hlen144(&mut self) -> HLEN144_W<HUFFENC_AC1_72rs> {
        HLEN144_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 145
    #[inline(always)]
    pub fn hcode145(&mut self) -> HCODE145_W<HUFFENC_AC1_72rs> {
        HCODE145_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 145
    #[inline(always)]
    pub fn hlen145(&mut self) -> HLEN145_W<HUFFENC_AC1_72rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_72)*/
