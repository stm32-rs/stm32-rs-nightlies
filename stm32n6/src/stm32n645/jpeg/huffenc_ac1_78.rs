...
impl W {
    ///Bits 0:7 - Huffman code 156
    #[inline(always)]
    pub fn hcode156(&mut self) -> HCODE156_W<HUFFENC_AC1_78rs> {
        HCODE156_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 156
    #[inline(always)]
    pub fn hlen156(&mut self) -> HLEN156_W<HUFFENC_AC1_78rs> {
        HLEN156_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 157
    #[inline(always)]
    pub fn hcode157(&mut self) -> HCODE157_W<HUFFENC_AC1_78rs> {
        HCODE157_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 157
    #[inline(always)]
    pub fn hlen157(&mut self) -> HLEN157_W<HUFFENC_AC1_78rs> {
