///Register `HUFFENC_AC1_78` reader
pub type R = crate::R<HUFFENC_AC1_78rs>;
///Register `HUFFENC_AC1_78` writer
pub type W = crate::W<HUFFENC_AC1_78rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 156
    #[inline(always)]
    pub fn hcode156(&mut self) -> HCODE156_W<'_, HUFFENC_AC1_78rs> {
        HCODE156_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 156
    #[inline(always)]
    pub fn hlen156(&mut self) -> HLEN156_W<'_, HUFFENC_AC1_78rs> {
        HLEN156_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 157
    #[inline(always)]
    pub fn hcode157(&mut self) -> HCODE157_W<'_, HUFFENC_AC1_78rs> {
        HCODE157_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 157
    #[inline(always)]
    pub fn hlen157(&mut self) -> HLEN157_W<'_, HUFFENC_AC1_78rs> {
        HLEN157_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_78::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_78::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_AC1_78)*/
pub struct HUFFENC_AC1_78rs;
impl crate::RegisterSpec for HUFFENC_AC1_78rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_78::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_78rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_78::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_78rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_78 to value 0
impl crate::Resettable for HUFFENC_AC1_78rs {}
