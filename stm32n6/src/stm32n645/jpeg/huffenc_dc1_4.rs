...
impl W {
    ///Bits 0:7 - Huffman code 8
    #[inline(always)]
    pub fn hcode8(&mut self) -> HCODE8_W<HUFFENC_DC1_4rs> {
        HCODE8_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 8
    #[inline(always)]
    pub fn hlen8(&mut self) -> HLEN8_W<HUFFENC_DC1_4rs> {
        HLEN8_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 9
    #[inline(always)]
    pub fn hcode9(&mut self) -> HCODE9_W<HUFFENC_DC1_4rs> {
        HCODE9_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 9
    #[inline(always)]
    pub fn hlen9(&mut self) -> HLEN9_W<HUFFENC_DC1_4rs> {
        HLEN9_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFENC_DC1_4)*/
