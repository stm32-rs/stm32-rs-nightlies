...
impl W {
    ///Bits 0:7 - Huffman code 12
    #[inline(always)]
    pub fn hcode12(&mut self) -> HCODE12_W<HUFFENC_DC1_6rs> {
        HCODE12_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 12
    #[inline(always)]
    pub fn hlen12(&mut self) -> HLEN12_W<HUFFENC_DC1_6rs> {
        HLEN12_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 13
    #[inline(always)]
    pub fn hcode13(&mut self) -> HCODE13_W<HUFFENC_DC1_6rs> {
        HCODE13_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 13
    #[inline(always)]
    pub fn hlen13(&mut self) -> HLEN13_W<HUFFENC_DC1_6rs> {
