...
impl W {
    ///Bits 0:7 - Data 64
    #[inline(always)]
    pub fn data64(&mut self) -> DATA64_W<HUFFSYMB16rs> {
        DATA64_W::new(self, 0)
    }
    ///Bits 8:15 - Data 65
    #[inline(always)]
    pub fn data65(&mut self) -> DATA65_W<HUFFSYMB16rs> {
        DATA65_W::new(self, 8)
    }
    ///Bits 16:23 - Data 66
    #[inline(always)]
    pub fn data66(&mut self) -> DATA66_W<HUFFSYMB16rs> {
        DATA66_W::new(self, 16)
    }
    ///Bits 24:31 - Data 67
    #[inline(always)]
    pub fn data67(&mut self) -> DATA67_W<HUFFSYMB16rs> {
