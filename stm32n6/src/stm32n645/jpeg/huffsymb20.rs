...
impl W {
    ///Bits 0:7 - Data 80
    #[inline(always)]
    pub fn data80(&mut self) -> DATA80_W<HUFFSYMB20rs> {
        DATA80_W::new(self, 0)
    }
    ///Bits 8:15 - Data 81
    #[inline(always)]
    pub fn data81(&mut self) -> DATA81_W<HUFFSYMB20rs> {
        DATA81_W::new(self, 8)
    }
    ///Bits 16:23 - Data 82
    #[inline(always)]
    pub fn data82(&mut self) -> DATA82_W<HUFFSYMB20rs> {
        DATA82_W::new(self, 16)
    }
    ///Bits 24:31 - Data 83
    #[inline(always)]
    pub fn data83(&mut self) -> DATA83_W<HUFFSYMB20rs> {
