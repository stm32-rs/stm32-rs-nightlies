...
impl W {
    ///Bits 0:7 - Data 84
    #[inline(always)]
    pub fn data84(&mut self) -> DATA84_W<HUFFSYMB21rs> {
        DATA84_W::new(self, 0)
    }
    ///Bits 8:15 - Data 85
    #[inline(always)]
    pub fn data85(&mut self) -> DATA85_W<HUFFSYMB21rs> {
        DATA85_W::new(self, 8)
    }
    ///Bits 16:23 - Data 86
    #[inline(always)]
    pub fn data86(&mut self) -> DATA86_W<HUFFSYMB21rs> {
        DATA86_W::new(self, 16)
    }
    ///Bits 24:31 - Data 87
    #[inline(always)]
    pub fn data87(&mut self) -> DATA87_W<HUFFSYMB21rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB21)*/
