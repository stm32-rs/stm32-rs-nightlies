...
impl W {
    ///Bits 0:7 - Data 112
    #[inline(always)]
    pub fn data112(&mut self) -> DATA112_W<HUFFSYMB28rs> {
        DATA112_W::new(self, 0)
    }
    ///Bits 8:15 - Data 113
    #[inline(always)]
    pub fn data113(&mut self) -> DATA113_W<HUFFSYMB28rs> {
        DATA113_W::new(self, 8)
    }
    ///Bits 16:23 - Data 114
    #[inline(always)]
    pub fn data114(&mut self) -> DATA114_W<HUFFSYMB28rs> {
        DATA114_W::new(self, 16)
    }
    ///Bits 24:31 - Data 115
    #[inline(always)]
    pub fn data115(&mut self) -> DATA115_W<HUFFSYMB28rs> {
