...
impl W {
    ///Bits 0:7 - Data 120
    #[inline(always)]
    pub fn data120(&mut self) -> DATA120_W<HUFFSYMB30rs> {
        DATA120_W::new(self, 0)
    }
    ///Bits 8:15 - Data 121
    #[inline(always)]
    pub fn data121(&mut self) -> DATA121_W<HUFFSYMB30rs> {
        DATA121_W::new(self, 8)
    }
    ///Bits 16:23 - Data 122
    #[inline(always)]
    pub fn data122(&mut self) -> DATA122_W<HUFFSYMB30rs> {
        DATA122_W::new(self, 16)
    }
    ///Bits 24:31 - Data 123
    #[inline(always)]
    pub fn data123(&mut self) -> DATA123_W<HUFFSYMB30rs> {
