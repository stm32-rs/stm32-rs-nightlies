...
impl W {
    ///Bits 0:7 - Data 124
    #[inline(always)]
    pub fn data124(&mut self) -> DATA124_W<HUFFSYMB31rs> {
        DATA124_W::new(self, 0)
    }
    ///Bits 8:15 - Data 125
    #[inline(always)]
    pub fn data125(&mut self) -> DATA125_W<HUFFSYMB31rs> {
        DATA125_W::new(self, 8)
    }
    ///Bits 16:23 - Data 126
    #[inline(always)]
    pub fn data126(&mut self) -> DATA126_W<HUFFSYMB31rs> {
        DATA126_W::new(self, 16)
    }
    ///Bits 24:31 - Data 127
    #[inline(always)]
    pub fn data127(&mut self) -> DATA127_W<HUFFSYMB31rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB31)*/
