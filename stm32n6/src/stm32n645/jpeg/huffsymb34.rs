...
impl W {
    ///Bits 0:7 - Data 136
    #[inline(always)]
    pub fn data136(&mut self) -> DATA136_W<HUFFSYMB34rs> {
        DATA136_W::new(self, 0)
    }
    ///Bits 8:15 - Data 137
    #[inline(always)]
    pub fn data137(&mut self) -> DATA137_W<HUFFSYMB34rs> {
        DATA137_W::new(self, 8)
    }
    ///Bits 16:23 - Data 138
    #[inline(always)]
    pub fn data138(&mut self) -> DATA138_W<HUFFSYMB34rs> {
        DATA138_W::new(self, 16)
    }
    ///Bits 24:31 - Data 139
    #[inline(always)]
    pub fn data139(&mut self) -> DATA139_W<HUFFSYMB34rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB34)*/
