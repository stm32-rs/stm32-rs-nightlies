...
impl W {
    ///Bits 0:7 - Data 16
    #[inline(always)]
    pub fn data16(&mut self) -> DATA16_W<HUFFSYMB4rs> {
        DATA16_W::new(self, 0)
    }
    ///Bits 8:15 - Data 17
    #[inline(always)]
    pub fn data17(&mut self) -> DATA17_W<HUFFSYMB4rs> {
        DATA17_W::new(self, 8)
    }
    ///Bits 16:23 - Data 18
    #[inline(always)]
    pub fn data18(&mut self) -> DATA18_W<HUFFSYMB4rs> {
        DATA18_W::new(self, 16)
    }
    ///Bits 24:31 - Data 19
    #[inline(always)]
    pub fn data19(&mut self) -> DATA19_W<HUFFSYMB4rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB4)*/
