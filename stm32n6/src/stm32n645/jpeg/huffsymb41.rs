...
impl W {
    ///Bits 0:7 - Data 164
    #[inline(always)]
    pub fn data164(&mut self) -> DATA164_W<HUFFSYMB41rs> {
        DATA164_W::new(self, 0)
    }
    ///Bits 8:15 - Data 165
    #[inline(always)]
    pub fn data165(&mut self) -> DATA165_W<HUFFSYMB41rs> {
        DATA165_W::new(self, 8)
    }
    ///Bits 16:23 - Data 166
    #[inline(always)]
    pub fn data166(&mut self) -> DATA166_W<HUFFSYMB41rs> {
        DATA166_W::new(self, 16)
    }
    ///Bits 24:31 - Data 167
    #[inline(always)]
    pub fn data167(&mut self) -> DATA167_W<HUFFSYMB41rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB41)*/
