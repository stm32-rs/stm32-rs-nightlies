...
impl W {
    ///Bits 0:7 - Data 172
    #[inline(always)]
    pub fn data172(&mut self) -> DATA172_W<HUFFSYMB43rs> {
        DATA172_W::new(self, 0)
    }
    ///Bits 8:15 - Data 173
    #[inline(always)]
    pub fn data173(&mut self) -> DATA173_W<HUFFSYMB43rs> {
        DATA173_W::new(self, 8)
    }
    ///Bits 16:23 - Data 174
    #[inline(always)]
    pub fn data174(&mut self) -> DATA174_W<HUFFSYMB43rs> {
        DATA174_W::new(self, 16)
    }
    ///Bits 24:31 - Data 175
    #[inline(always)]
    pub fn data175(&mut self) -> DATA175_W<HUFFSYMB43rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB43)*/
