...
impl W {
    ///Bits 0:7 - Data 176
    #[inline(always)]
    pub fn data176(&mut self) -> DATA176_W<HUFFSYMB44rs> {
        DATA176_W::new(self, 0)
    }
    ///Bits 8:15 - Data 177
    #[inline(always)]
    pub fn data177(&mut self) -> DATA177_W<HUFFSYMB44rs> {
        DATA177_W::new(self, 8)
    }
    ///Bits 16:23 - Data 178
    #[inline(always)]
    pub fn data178(&mut self) -> DATA178_W<HUFFSYMB44rs> {
        DATA178_W::new(self, 16)
    }
    ///Bits 24:31 - Data 179
    #[inline(always)]
    pub fn data179(&mut self) -> DATA179_W<HUFFSYMB44rs> {
