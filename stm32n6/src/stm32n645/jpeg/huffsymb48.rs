...
impl W {
    ///Bits 0:7 - Data 192
    #[inline(always)]
    pub fn data192(&mut self) -> DATA192_W<HUFFSYMB48rs> {
        DATA192_W::new(self, 0)
    }
    ///Bits 8:15 - Data 193
    #[inline(always)]
    pub fn data193(&mut self) -> DATA193_W<HUFFSYMB48rs> {
        DATA193_W::new(self, 8)
    }
    ///Bits 16:23 - Data 194
    #[inline(always)]
    pub fn data194(&mut self) -> DATA194_W<HUFFSYMB48rs> {
        DATA194_W::new(self, 16)
    }
    ///Bits 24:31 - Data 195
    #[inline(always)]
    pub fn data195(&mut self) -> DATA195_W<HUFFSYMB48rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB48)*/
