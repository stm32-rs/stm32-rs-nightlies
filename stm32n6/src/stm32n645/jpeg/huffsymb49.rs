...
impl W {
    ///Bits 0:7 - Data 196
    #[inline(always)]
    pub fn data196(&mut self) -> DATA196_W<HUFFSYMB49rs> {
        DATA196_W::new(self, 0)
    }
    ///Bits 8:15 - Data 197
    #[inline(always)]
    pub fn data197(&mut self) -> DATA197_W<HUFFSYMB49rs> {
        DATA197_W::new(self, 8)
    }
    ///Bits 16:23 - Data 198
    #[inline(always)]
    pub fn data198(&mut self) -> DATA198_W<HUFFSYMB49rs> {
        DATA198_W::new(self, 16)
    }
    ///Bits 24:31 - Data 199
    #[inline(always)]
    pub fn data199(&mut self) -> DATA199_W<HUFFSYMB49rs> {
