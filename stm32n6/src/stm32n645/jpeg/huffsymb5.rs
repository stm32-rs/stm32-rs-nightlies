...
impl W {
    ///Bits 0:7 - Data 20
    #[inline(always)]
    pub fn data20(&mut self) -> DATA20_W<HUFFSYMB5rs> {
        DATA20_W::new(self, 0)
    }
    ///Bits 8:15 - Data 21
    #[inline(always)]
    pub fn data21(&mut self) -> DATA21_W<HUFFSYMB5rs> {
        DATA21_W::new(self, 8)
    }
    ///Bits 16:23 - Data 22
    #[inline(always)]
    pub fn data22(&mut self) -> DATA22_W<HUFFSYMB5rs> {
        DATA22_W::new(self, 16)
    }
    ///Bits 24:31 - Data 23
    #[inline(always)]
    pub fn data23(&mut self) -> DATA23_W<HUFFSYMB5rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB5)*/
