...
impl W {
    ///Bits 0:7 - Data 220
    #[inline(always)]
    pub fn data220(&mut self) -> DATA220_W<HUFFSYMB55rs> {
        DATA220_W::new(self, 0)
    }
    ///Bits 8:15 - Data 221
    #[inline(always)]
    pub fn data221(&mut self) -> DATA221_W<HUFFSYMB55rs> {
        DATA221_W::new(self, 8)
    }
    ///Bits 16:23 - Data 222
    #[inline(always)]
    pub fn data222(&mut self) -> DATA222_W<HUFFSYMB55rs> {
        DATA222_W::new(self, 16)
    }
    ///Bits 24:31 - Data 223
    #[inline(always)]
    pub fn data223(&mut self) -> DATA223_W<HUFFSYMB55rs> {
