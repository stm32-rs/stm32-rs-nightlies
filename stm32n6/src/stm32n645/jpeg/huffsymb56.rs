...
impl W {
    ///Bits 0:7 - Data 224
    #[inline(always)]
    pub fn data224(&mut self) -> DATA224_W<HUFFSYMB56rs> {
        DATA224_W::new(self, 0)
    }
    ///Bits 8:15 - Data 225
    #[inline(always)]
    pub fn data225(&mut self) -> DATA225_W<HUFFSYMB56rs> {
        DATA225_W::new(self, 8)
    }
    ///Bits 16:23 - Data 226
    #[inline(always)]
    pub fn data226(&mut self) -> DATA226_W<HUFFSYMB56rs> {
        DATA226_W::new(self, 16)
    }
    ///Bits 24:31 - Data 227
    #[inline(always)]
    pub fn data227(&mut self) -> DATA227_W<HUFFSYMB56rs> {
