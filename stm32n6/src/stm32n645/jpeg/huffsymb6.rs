...
impl W {
    ///Bits 0:7 - Data 24
    #[inline(always)]
    pub fn data24(&mut self) -> DATA24_W<HUFFSYMB6rs> {
        DATA24_W::new(self, 0)
    }
    ///Bits 8:15 - Data 25
    #[inline(always)]
    pub fn data25(&mut self) -> DATA25_W<HUFFSYMB6rs> {
        DATA25_W::new(self, 8)
    }
    ///Bits 16:23 - Data 26
    #[inline(always)]
    pub fn data26(&mut self) -> DATA26_W<HUFFSYMB6rs> {
        DATA26_W::new(self, 16)
    }
    ///Bits 24:31 - Data 27
    #[inline(always)]
    pub fn data27(&mut self) -> DATA27_W<HUFFSYMB6rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB6)*/
