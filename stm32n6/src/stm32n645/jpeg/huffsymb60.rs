...
impl W {
    ///Bits 0:7 - Data 240
    #[inline(always)]
    pub fn data240(&mut self) -> DATA240_W<HUFFSYMB60rs> {
        DATA240_W::new(self, 0)
    }
    ///Bits 8:15 - Data 241
    #[inline(always)]
    pub fn data241(&mut self) -> DATA241_W<HUFFSYMB60rs> {
        DATA241_W::new(self, 8)
    }
    ///Bits 16:23 - Data 242
    #[inline(always)]
    pub fn data242(&mut self) -> DATA242_W<HUFFSYMB60rs> {
        DATA242_W::new(self, 16)
    }
    ///Bits 24:31 - Data 243
    #[inline(always)]
    pub fn data243(&mut self) -> DATA243_W<HUFFSYMB60rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB60)*/
