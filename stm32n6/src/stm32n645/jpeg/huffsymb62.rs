...
impl W {
    ///Bits 0:7 - Data 248
    #[inline(always)]
    pub fn data248(&mut self) -> DATA248_W<HUFFSYMB62rs> {
        DATA248_W::new(self, 0)
    }
    ///Bits 8:15 - Data 249
    #[inline(always)]
    pub fn data249(&mut self) -> DATA249_W<HUFFSYMB62rs> {
        DATA249_W::new(self, 8)
    }
    ///Bits 16:23 - Data 250
    #[inline(always)]
    pub fn data250(&mut self) -> DATA250_W<HUFFSYMB62rs> {
        DATA250_W::new(self, 16)
    }
    ///Bits 24:31 - Data 251
    #[inline(always)]
    pub fn data251(&mut self) -> DATA251_W<HUFFSYMB62rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB62)*/
