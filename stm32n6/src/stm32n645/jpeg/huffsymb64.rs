...
impl W {
    ///Bits 0:7 - Data 256
    #[inline(always)]
    pub fn data256(&mut self) -> DATA256_W<HUFFSYMB64rs> {
        DATA256_W::new(self, 0)
    }
    ///Bits 8:15 - Data 257
    #[inline(always)]
    pub fn data257(&mut self) -> DATA257_W<HUFFSYMB64rs> {
        DATA257_W::new(self, 8)
    }
    ///Bits 16:23 - Data 258
    #[inline(always)]
    pub fn data258(&mut self) -> DATA258_W<HUFFSYMB64rs> {
        DATA258_W::new(self, 16)
    }
    ///Bits 24:31 - Data 259
    #[inline(always)]
    pub fn data259(&mut self) -> DATA259_W<HUFFSYMB64rs> {
