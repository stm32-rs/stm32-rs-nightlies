...
impl W {
    ///Bits 0:7 - Data 268
    #[inline(always)]
    pub fn data268(&mut self) -> DATA268_W<HUFFSYMB67rs> {
        DATA268_W::new(self, 0)
    }
    ///Bits 8:15 - Data 269
    #[inline(always)]
    pub fn data269(&mut self) -> DATA269_W<HUFFSYMB67rs> {
        DATA269_W::new(self, 8)
    }
    ///Bits 16:23 - Data 270
    #[inline(always)]
    pub fn data270(&mut self) -> DATA270_W<HUFFSYMB67rs> {
        DATA270_W::new(self, 16)
    }
    ///Bits 24:31 - Data 271
    #[inline(always)]
    pub fn data271(&mut self) -> DATA271_W<HUFFSYMB67rs> {
