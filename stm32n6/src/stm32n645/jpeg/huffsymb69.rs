...
impl W {
    ///Bits 0:7 - Data 276
    #[inline(always)]
    pub fn data276(&mut self) -> DATA276_W<HUFFSYMB69rs> {
        DATA276_W::new(self, 0)
    }
    ///Bits 8:15 - Data 277
    #[inline(always)]
    pub fn data277(&mut self) -> DATA277_W<HUFFSYMB69rs> {
        DATA277_W::new(self, 8)
    }
    ///Bits 16:23 - Data 278
    #[inline(always)]
    pub fn data278(&mut self) -> DATA278_W<HUFFSYMB69rs> {
        DATA278_W::new(self, 16)
    }
    ///Bits 24:31 - Data 279
    #[inline(always)]
    pub fn data279(&mut self) -> DATA279_W<HUFFSYMB69rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB69)*/
