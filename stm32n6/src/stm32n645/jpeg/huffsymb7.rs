...
impl W {
    ///Bits 0:7 - Data 28
    #[inline(always)]
    pub fn data28(&mut self) -> DATA28_W<HUFFSYMB7rs> {
        DATA28_W::new(self, 0)
    }
    ///Bits 8:15 - Data 29
    #[inline(always)]
    pub fn data29(&mut self) -> DATA29_W<HUFFSYMB7rs> {
        DATA29_W::new(self, 8)
    }
    ///Bits 16:23 - Data 30
    #[inline(always)]
    pub fn data30(&mut self) -> DATA30_W<HUFFSYMB7rs> {
        DATA30_W::new(self, 16)
    }
    ///Bits 24:31 - Data 31
    #[inline(always)]
    pub fn data31(&mut self) -> DATA31_W<HUFFSYMB7rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB7)*/
