...
impl W {
    ///Bits 0:7 - Data 288
    #[inline(always)]
    pub fn data288(&mut self) -> DATA288_W<HUFFSYMB72rs> {
        DATA288_W::new(self, 0)
    }
    ///Bits 8:15 - Data 289
    #[inline(always)]
    pub fn data289(&mut self) -> DATA289_W<HUFFSYMB72rs> {
        DATA289_W::new(self, 8)
    }
    ///Bits 16:23 - Data 290
    #[inline(always)]
    pub fn data290(&mut self) -> DATA290_W<HUFFSYMB72rs> {
        DATA290_W::new(self, 16)
    }
    ///Bits 24:31 - Data 291
    #[inline(always)]
    pub fn data291(&mut self) -> DATA291_W<HUFFSYMB72rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB72)*/
