...
impl W {
    ///Bits 0:7 - Data 304
    #[inline(always)]
    pub fn data304(&mut self) -> DATA304_W<HUFFSYMB76rs> {
        DATA304_W::new(self, 0)
    }
    ///Bits 8:15 - Data 305
    #[inline(always)]
    pub fn data305(&mut self) -> DATA305_W<HUFFSYMB76rs> {
        DATA305_W::new(self, 8)
    }
    ///Bits 16:23 - Data 306
    #[inline(always)]
    pub fn data306(&mut self) -> DATA306_W<HUFFSYMB76rs> {
        DATA306_W::new(self, 16)
    }
    ///Bits 24:31 - Data 307
    #[inline(always)]
    pub fn data307(&mut self) -> DATA307_W<HUFFSYMB76rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB76)*/
