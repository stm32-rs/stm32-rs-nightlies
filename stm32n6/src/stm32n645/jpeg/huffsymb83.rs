...
impl W {
    ///Bits 0:7 - Data 332
    #[inline(always)]
    pub fn data332(&mut self) -> DATA332_W<HUFFSYMB83rs> {
        DATA332_W::new(self, 0)
    }
    ///Bits 8:15 - Data 333
    #[inline(always)]
    pub fn data333(&mut self) -> DATA333_W<HUFFSYMB83rs> {
        DATA333_W::new(self, 8)
    }
    ///Bits 16:23 - Data 334
    #[inline(always)]
    pub fn data334(&mut self) -> DATA334_W<HUFFSYMB83rs> {
        DATA334_W::new(self, 16)
    }
    ///Bits 24:31 - Data 335
    #[inline(always)]
    pub fn data335(&mut self) -> DATA335_W<HUFFSYMB83rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:HUFFSYMB83)*/
