///Register `QMEM0_12` reader
pub type R = crate::R<QMEM0_12rs>;
///Register `QMEM0_12` writer
pub type W = crate::W<QMEM0_12rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 48
    #[inline(always)]
    pub fn qcoef48(&mut self) -> QCOEF48_W<'_, QMEM0_12rs> {
        QCOEF48_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 49
    #[inline(always)]
    pub fn qcoef49(&mut self) -> QCOEF49_W<'_, QMEM0_12rs> {
        QCOEF49_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 50
    #[inline(always)]
    pub fn qcoef50(&mut self) -> QCOEF50_W<'_, QMEM0_12rs> {
        QCOEF50_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 51
    #[inline(always)]
    pub fn qcoef51(&mut self) -> QCOEF51_W<'_, QMEM0_12rs> {
        QCOEF51_W::new(self, 24)
    }
}
/**JPEG quantization memory 0

You can [`read`](crate::Reg::read) this register and get [`qmem0_12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem0_12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:QMEM0_12)*/
pub struct QMEM0_12rs;
impl crate::RegisterSpec for QMEM0_12rs {
    type Ux = u32;
}
///`read()` method returns [`qmem0_12::R`](R) reader structure
impl crate::Readable for QMEM0_12rs {}
///`write(|w| ..)` method takes [`qmem0_12::W`](W) writer structure
impl crate::Writable for QMEM0_12rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM0_12 to value 0
impl crate::Resettable for QMEM0_12rs {}
