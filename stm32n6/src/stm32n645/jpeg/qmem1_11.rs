...
impl W {
    ///Bits 0:7 - Quantization coefficient 44
    #[inline(always)]
    pub fn qcoef44(&mut self) -> QCOEF44_W<QMEM1_11rs> {
        QCOEF44_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 45
    #[inline(always)]
    pub fn qcoef45(&mut self) -> QCOEF45_W<QMEM1_11rs> {
        QCOEF45_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 46
    #[inline(always)]
    pub fn qcoef46(&mut self) -> QCOEF46_W<QMEM1_11rs> {
        QCOEF46_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 47
    #[inline(always)]
    pub fn qcoef47(&mut self) -> QCOEF47_W<QMEM1_11rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:QMEM1_11)*/
