///Register `QMEM1_15` reader
pub type R = crate::R<QMEM1_15rs>;
///Register `QMEM1_15` writer
pub type W = crate::W<QMEM1_15rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 60
    #[inline(always)]
    pub fn qcoef60(&mut self) -> QCOEF60_W<'_, QMEM1_15rs> {
        QCOEF60_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 61
    #[inline(always)]
    pub fn qcoef61(&mut self) -> QCOEF61_W<'_, QMEM1_15rs> {
        QCOEF61_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 62
    #[inline(always)]
    pub fn qcoef62(&mut self) -> QCOEF62_W<'_, QMEM1_15rs> {
        QCOEF62_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 63
    #[inline(always)]
    pub fn qcoef63(&mut self) -> QCOEF63_W<'_, QMEM1_15rs> {
        QCOEF63_W::new(self, 24)
    }
}
/**JPEG quantization memory 1

You can [`read`](crate::Reg::read) this register and get [`qmem1_15::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem1_15::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:QMEM1_15)*/
pub struct QMEM1_15rs;
impl crate::RegisterSpec for QMEM1_15rs {
    type Ux = u32;
}
///`read()` method returns [`qmem1_15::R`](R) reader structure
impl crate::Readable for QMEM1_15rs {}
///`write(|w| ..)` method takes [`qmem1_15::W`](W) writer structure
impl crate::Writable for QMEM1_15rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM1_15 to value 0
impl crate::Resettable for QMEM1_15rs {}
