...
impl W {
    ///Bits 0:7 - Quantization coefficient 12
    #[inline(always)]
    pub fn qcoef12(&mut self) -> QCOEF12_W<QMEM1_3rs> {
        QCOEF12_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 13
    #[inline(always)]
    pub fn qcoef13(&mut self) -> QCOEF13_W<QMEM1_3rs> {
        QCOEF13_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 14
    #[inline(always)]
    pub fn qcoef14(&mut self) -> QCOEF14_W<QMEM1_3rs> {
        QCOEF14_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 15
    #[inline(always)]
    pub fn qcoef15(&mut self) -> QCOEF15_W<QMEM1_3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:QMEM1_3)*/
