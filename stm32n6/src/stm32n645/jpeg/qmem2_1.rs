...
impl W {
    ///Bits 0:7 - Quantization coefficient 4
    #[inline(always)]
    pub fn qcoef4(&mut self) -> QCOEF4_W<QMEM2_1rs> {
        QCOEF4_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 5
    #[inline(always)]
    pub fn qcoef5(&mut self) -> QCOEF5_W<QMEM2_1rs> {
        QCOEF5_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 6
    #[inline(always)]
    pub fn qcoef6(&mut self) -> QCOEF6_W<QMEM2_1rs> {
        QCOEF6_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 7
    #[inline(always)]
    pub fn qcoef7(&mut self) -> QCOEF7_W<QMEM2_1rs> {
