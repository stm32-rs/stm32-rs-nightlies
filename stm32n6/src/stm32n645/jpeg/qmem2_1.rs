///Register `QMEM2_1` reader
pub type R = crate::R<QMEM2_1rs>;
///Register `QMEM2_1` writer
pub type W = crate::W<QMEM2_1rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 4
    #[inline(always)]
    pub fn qcoef4(&mut self) -> QCOEF4_W<'_, QMEM2_1rs> {
        QCOEF4_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 5
    #[inline(always)]
    pub fn qcoef5(&mut self) -> QCOEF5_W<'_, QMEM2_1rs> {
        QCOEF5_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 6
    #[inline(always)]
    pub fn qcoef6(&mut self) -> QCOEF6_W<'_, QMEM2_1rs> {
        QCOEF6_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 7
    #[inline(always)]
    pub fn qcoef7(&mut self) -> QCOEF7_W<'_, QMEM2_1rs> {
        QCOEF7_W::new(self, 24)
    }
}
/**JPEG quantization memory 2

You can [`read`](crate::Reg::read) this register and get [`qmem2_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem2_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:QMEM2_1)*/
pub struct QMEM2_1rs;
impl crate::RegisterSpec for QMEM2_1rs {
    type Ux = u32;
}
///`read()` method returns [`qmem2_1::R`](R) reader structure
impl crate::Readable for QMEM2_1rs {}
///`write(|w| ..)` method takes [`qmem2_1::W`](W) writer structure
impl crate::Writable for QMEM2_1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM2_1 to value 0
impl crate::Resettable for QMEM2_1rs {}
