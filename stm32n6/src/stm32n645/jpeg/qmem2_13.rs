///Register `QMEM2_13` reader
pub type R = crate::R<QMEM2_13rs>;
///Register `QMEM2_13` writer
pub type W = crate::W<QMEM2_13rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 52
    #[inline(always)]
    pub fn qcoef52(&mut self) -> QCOEF52_W<'_, QMEM2_13rs> {
        QCOEF52_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 53
    #[inline(always)]
    pub fn qcoef53(&mut self) -> QCOEF53_W<'_, QMEM2_13rs> {
        QCOEF53_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 54
    #[inline(always)]
    pub fn qcoef54(&mut self) -> QCOEF54_W<'_, QMEM2_13rs> {
        QCOEF54_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 55
    #[inline(always)]
    pub fn qcoef55(&mut self) -> QCOEF55_W<'_, QMEM2_13rs> {
        QCOEF55_W::new(self, 24)
    }
}
/**JPEG quantization memory 2

You can [`read`](crate::Reg::read) this register and get [`qmem2_13::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem2_13::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:QMEM2_13)*/
pub struct QMEM2_13rs;
impl crate::RegisterSpec for QMEM2_13rs {
    type Ux = u32;
}
///`read()` method returns [`qmem2_13::R`](R) reader structure
impl crate::Readable for QMEM2_13rs {}
///`write(|w| ..)` method takes [`qmem2_13::W`](W) writer structure
impl crate::Writable for QMEM2_13rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM2_13 to value 0
impl crate::Resettable for QMEM2_13rs {}
