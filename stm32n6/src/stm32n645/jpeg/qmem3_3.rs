///Register `QMEM3_3` reader
pub type R = crate::R<QMEM3_3rs>;
///Register `QMEM3_3` writer
pub type W = crate::W<QMEM3_3rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 12
    #[inline(always)]
    pub fn qcoef12(&mut self) -> QCOEF12_W<'_, QMEM3_3rs> {
        QCOEF12_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 13
    #[inline(always)]
    pub fn qcoef13(&mut self) -> QCOEF13_W<'_, QMEM3_3rs> {
        QCOEF13_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 14
    #[inline(always)]
    pub fn qcoef14(&mut self) -> QCOEF14_W<'_, QMEM3_3rs> {
        QCOEF14_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 15
    #[inline(always)]
    pub fn qcoef15(&mut self) -> QCOEF15_W<'_, QMEM3_3rs> {
        QCOEF15_W::new(self, 24)
    }
}
/**JPEG quantization memory 3

You can [`read`](crate::Reg::read) this register and get [`qmem3_3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem3_3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#JPEG:QMEM3_3)*/
pub struct QMEM3_3rs;
impl crate::RegisterSpec for QMEM3_3rs {
    type Ux = u32;
}
///`read()` method returns [`qmem3_3::R`](R) reader structure
impl crate::Readable for QMEM3_3rs {}
///`write(|w| ..)` method takes [`qmem3_3::W`](W) writer structure
impl crate::Writable for QMEM3_3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM3_3 to value 0
impl crate::Resettable for QMEM3_3rs {}
