...
impl W {
    ///Bit 0 - Line interrupt enable
    #[inline(always)]
    pub fn lie(&mut self) -> LIE_W<IER2rs> {
        LIE_W::new(self, 0)
    }
    ///Bit 1 - FIFO underrun warning interrupt enable
    #[inline(always)]
    pub fn fuwie(&mut self) -> FUWIE_W<IER2rs> {
        FUWIE_W::new(self, 1)
    }
    ///Bit 2 - Transfer error interrupt enable
    #[inline(always)]
    pub fn terrie(&mut self) -> TERRIE_W<IER2rs> {
        TERRIE_W::new(self, 2)
    }
    ///Bit 3 - Register reload interrupt enable
    #[inline(always)]
    pub fn rrie(&mut self) -> RRIE_W<IER2rs> {
        RRIE_W::new(self, 3)
    }
    ///Bit 6 - FIFO underrun interrupt enable
    #[inline(always)]
    pub fn fuie(&mut self) -> FUIE_W<IER2rs> {
        FUIE_W::new(self, 6)
    }
    ///Bit 7 - CRC error interrupt enable
    #[inline(always)]
