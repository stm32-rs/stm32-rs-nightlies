///Register `L1FPF0R` reader
pub type R = crate::R<L1FPF0Rrs>;
///Register `L1FPF0R` writer
pub type W = crate::W<L1FPF0Rrs>;
...
impl W {
    ///Bits 0:4 - Location of the Alpha component inside the pixel memory word (in bits)
    #[inline(always)]
    pub fn apos(&mut self) -> APOS_W<'_, L1FPF0Rrs> {
        APOS_W::new(self, 0)
    }
    ///Bits 5:8 - Width of the Alpha component (in bits)
    #[inline(always)]
    pub fn alen(&mut self) -> ALEN_W<'_, L1FPF0Rrs> {
        ALEN_W::new(self, 5)
    }
    ///Bits 9:13 - Location of the Red component inside the pixel memory word (in bits)
    #[inline(always)]
    pub fn rpos(&mut self) -> RPOS_W<'_, L1FPF0Rrs> {
        RPOS_W::new(self, 9)
    }
    ///Bits 14:17 - Width of the Red component (in bits)
    #[inline(always)]
    pub fn rlen(&mut self) -> RLEN_W<'_, L1FPF0Rrs> {
        RLEN_W::new(self, 14)
    }
}
/**LTDC layerx flexible pixel format 0 register

You can [`read`](crate::Reg::read) this register and get [`l1fpf0r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l1fpf0r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#LTDC:L1FPF0R)*/
pub struct L1FPF0Rrs;
impl crate::RegisterSpec for L1FPF0Rrs {
    type Ux = u32;
}
///`read()` method returns [`l1fpf0r::R`](R) reader structure
impl crate::Readable for L1FPF0Rrs {}
///`write(|w| ..)` method takes [`l1fpf0r::W`](W) writer structure
impl crate::Writable for L1FPF0Rrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets L1FPF0R to value 0x0001_1100
impl crate::Resettable for L1FPF0Rrs {
