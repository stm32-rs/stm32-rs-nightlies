///Register `L2PCR` reader
pub type R = crate::R<L2PCRrs>;
///Register `L2PCR` writer
pub type W = crate::W<L2PCRrs>;
...
impl W {
    ///Bit 3 - YCbCr-to-RGB conversion enable
    #[inline(always)]
    pub fn ycen(&mut self) -> YCEN_W<'_, L2PCRrs> {
        YCEN_W::new(self, 3)
    }
    ///Bits 4:5 - YCbCr conversion mode
    #[inline(always)]
    pub fn ycm(&mut self) -> YCM_W<'_, L2PCRrs> {
        YCM_W::new(self, 4)
    }
    ///Bit 6 - Y component first
    #[inline(always)]
    pub fn yf(&mut self) -> YF_W<'_, L2PCRrs> {
        YF_W::new(self, 6)
    }
    ///Bit 7 - Cb component first
    #[inline(always)]
    pub fn cbf(&mut self) -> CBF_W<'_, L2PCRrs> {
        CBF_W::new(self, 7)
    }
    ///Bit 8 - Odd pixel first
    #[inline(always)]
    pub fn of(&mut self) -> OF_W<'_, L2PCRrs> {
        OF_W::new(self, 8)
    }
    ///Bit 9 - Y rescale enable for the color dynamic range
    #[inline(always)]
    pub fn yren(&mut self) -> YREN_W<'_, L2PCRrs> {
        YREN_W::new(self, 9)
    }
}
/**LTDC layerx planar configuration register

You can [`read`](crate::Reg::read) this register and get [`l2pcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l2pcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#LTDC:L2PCR)*/
pub struct L2PCRrs;
impl crate::RegisterSpec for L2PCRrs {
    type Ux = u32;
}
///`read()` method returns [`l2pcr::R`](R) reader structure
impl crate::Readable for L2PCRrs {}
///`write(|w| ..)` method takes [`l2pcr::W`](W) writer structure
impl crate::Writable for L2PCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets L2PCR to value 0
impl crate::Resettable for L2PCRrs {}
