...
impl W {
    ///Bit 1 - Data overflow flag
    #[inline(always)]
    pub fn dovrf(&mut self) -> DOVRF_W<DFLT1ISRrs> {
        DOVRF_W::new(self, 1)
    }
    ///Bit 2 - Snapshot data ready flag
    #[inline(always)]
    pub fn ssdrf(&mut self) -> SSDRF_W<DFLT1ISRrs> {
        SSDRF_W::new(self, 2)
    }
    ///Bit 4 - OLDx flag
    #[inline(always)]
    pub fn oldf(&mut self) -> OLDF_W<DFLT1ISRrs> {
        OLDF_W::new(self, 4)
    }
    ///Bit 7 - Snapshot overrun flag
    #[inline(always)]
    pub fn ssovrf(&mut self) -> SSOVRF_W<DFLT1ISRrs> {
        SSOVRF_W::new(self, 7)
    }
    ///Bit 8 - Short-circuit detector flag
    #[inline(always)]
    pub fn scdf(&mut self) -> SCDF_W<DFLT1ISRrs> {
        SCDF_W::new(self, 8)
    }
    ///Bit 9 - Saturation detection flag
    #[inline(always)]
    pub fn satf(&mut self) -> SATF_W<DFLT1ISRrs> {
        SATF_W::new(self, 9)
    }
    ///Bit 10 - Clock absence detection flag
    #[inline(always)]
    pub fn ckabf(&mut self) -> CKABF_W<DFLT1ISRrs> {
        CKABF_W::new(self, 10)
    }
    ///Bit 11 - Reshape filter overrun detection flag
    #[inline(always)]
    pub fn rfovrf(&mut self) -> RFOVRF_W<DFLT1ISRrs> {
