///Register `DFLT1ISR` reader
pub type R = crate::R<DFLT1ISRrs>;
///Register `DFLT1ISR` writer
pub type W = crate::W<DFLT1ISRrs>;
...
impl W {
    ///Bit 1 - Data overflow flag
    #[inline(always)]
    pub fn dovrf(&mut self) -> DOVRF_W<'_, DFLT1ISRrs> {
        DOVRF_W::new(self, 1)
    }
    ///Bit 2 - Snapshot data ready flag
    #[inline(always)]
    pub fn ssdrf(&mut self) -> SSDRF_W<'_, DFLT1ISRrs> {
        SSDRF_W::new(self, 2)
    }
    ///Bit 4 - OLDx flag
    #[inline(always)]
    pub fn oldf(&mut self) -> OLDF_W<'_, DFLT1ISRrs> {
        OLDF_W::new(self, 4)
    }
    ///Bit 7 - Snapshot overrun flag
    #[inline(always)]
    pub fn ssovrf(&mut self) -> SSOVRF_W<'_, DFLT1ISRrs> {
        SSOVRF_W::new(self, 7)
    }
    ///Bit 8 - Short-circuit detector flag
    #[inline(always)]
    pub fn scdf(&mut self) -> SCDF_W<'_, DFLT1ISRrs> {
        SCDF_W::new(self, 8)
    }
    ///Bit 9 - Saturation detection flag
    #[inline(always)]
    pub fn satf(&mut self) -> SATF_W<'_, DFLT1ISRrs> {
        SATF_W::new(self, 9)
    }
    ///Bit 10 - Clock absence detection flag
    #[inline(always)]
    pub fn ckabf(&mut self) -> CKABF_W<'_, DFLT1ISRrs> {
        CKABF_W::new(self, 10)
    }
    ///Bit 11 - Reshape filter overrun detection flag
    #[inline(always)]
    pub fn rfovrf(&mut self) -> RFOVRF_W<'_, DFLT1ISRrs> {
        RFOVRF_W::new(self, 11)
    }
}
/**MDF DFLT1 interrupt status register 1

You can [`read`](crate::Reg::read) this register and get [`dflt1isr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dflt1isr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#MDF1:DFLT1ISR)*/
pub struct DFLT1ISRrs;
impl crate::RegisterSpec for DFLT1ISRrs {
    type Ux = u32;
}
///`read()` method returns [`dflt1isr::R`](R) reader structure
impl crate::Readable for DFLT1ISRrs {}
///`write(|w| ..)` method takes [`dflt1isr::W`](W) writer structure
impl crate::Writable for DFLT1ISRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DFLT1ISR to value 0
impl crate::Resettable for DFLT1ISRrs {}
