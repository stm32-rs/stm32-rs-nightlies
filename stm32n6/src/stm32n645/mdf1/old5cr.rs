///Register `OLD5CR` reader
pub type R = crate::R<OLD5CRrs>;
///Register `OLD5CR` writer
pub type W = crate::W<OLD5CRrs>;
...
impl W {
    ///Bit 0 - OLDx enable
    #[inline(always)]
    pub fn olden(&mut self) -> OLDEN_W<'_, OLD5CRrs> {
        OLDEN_W::new(self, 0)
    }
    ///Bit 1 - Threshold In band
    #[inline(always)]
    pub fn thinb(&mut self) -> THINB_W<'_, OLD5CRrs> {
        THINB_W::new(self, 1)
    }
    ///Bits 4:7 - Break signal assignment for out-of limit detector
    #[inline(always)]
    pub fn bkold(&mut self) -> BKOLD_W<'_, OLD5CRrs> {
        BKOLD_W::new(self, 4)
    }
    ///Bits 12:13 - OLDx CIC order selection
    #[inline(always)]
    pub fn acicn(&mut self) -> ACICN_W<'_, OLD5CRrs> {
        ACICN_W::new(self, 12)
    }
    ///Bits 17:21 - OLDx CIC decimation ratio selection
    #[inline(always)]
    pub fn acicd(&mut self) -> ACICD_W<'_, OLD5CRrs> {
        ACICD_W::new(self, 17)
    }
}
/**MDF out-of limit detector control register 5

You can [`read`](crate::Reg::read) this register and get [`old5cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`old5cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#MDF1:OLD5CR)*/
pub struct OLD5CRrs;
impl crate::RegisterSpec for OLD5CRrs {
    type Ux = u32;
}
///`read()` method returns [`old5cr::R`](R) reader structure
impl crate::Readable for OLD5CRrs {}
///`write(|w| ..)` method takes [`old5cr::W`](W) writer structure
impl crate::Writable for OLD5CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OLD5CR to value 0
impl crate::Resettable for OLD5CRrs {}
