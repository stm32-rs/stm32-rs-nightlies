///Register `SNPS2DR` reader
pub type R = crate::R<SNPS2DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`snps2dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#MDF1:SNPS2DR)*/
pub struct SNPS2DRrs;
impl crate::RegisterSpec for SNPS2DRrs {
    type Ux = u32;
}
///`read()` method returns [`snps2dr::R`](R) reader structure
impl crate::Readable for SNPS2DRrs {}
///`reset()` method sets SNPS2DR to value 0
impl crate::Resettable for SNPS2DRrs {}
