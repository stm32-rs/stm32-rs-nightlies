...
///Field `PERSCHIVL` reader - Periodic schedule interval
pub type PERSCHIVL_R = crate::FieldReader;
///Field `PERSCHIVL` writer - Periodic schedule interval
...
impl R {
    ...
    ///Bits 24:25 - Periodic schedule interval
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#OTG1:DCFG)*/
pub struct DCFGrs;
