...
impl W {
    ///Bit 1 - Mode mismatch interrupt mask
    #[inline(always)]
    pub fn mmism(&mut self) -> MMISM_W<'_, GINTMSK_ALTERNATErs> {
        MMISM_W::new(self, 1)
    }
    ///Bit 2 - OTG interrupt mask
    #[inline(always)]
    pub fn otgint(&mut self) -> OTGINT_W<'_, GINTMSK_ALTERNATErs> {
        OTGINT_W::new(self, 2)
    }
    ///Bit 3 - Start of frame mask
    #[inline(always)]
    pub fn sofm(&mut self) -> SOFM_W<'_, GINTMSK_ALTERNATErs> {
        SOFM_W::new(self, 3)
    }
    ///Bit 4 - Receive FIFO non-empty mask
    #[inline(always)]
    pub fn rxflvlm(&mut self) -> RXFLVLM_W<'_, GINTMSK_ALTERNATErs> {
        RXFLVLM_W::new(self, 4)
    }
    ///Bit 6 - Global non-periodic IN NAK effective mask
    #[inline(always)]
    pub fn ginakeffm(&mut self) -> GINAKEFFM_W<'_, GINTMSK_ALTERNATErs> {
        GINAKEFFM_W::new(self, 6)
    }
    ///Bit 7 - Global OUT NAK effective mask
    #[inline(always)]
    pub fn gonakeffm(&mut self) -> GONAKEFFM_W<'_, GINTMSK_ALTERNATErs> {
        GONAKEFFM_W::new(self, 7)
    }
    ///Bit 10 - Early suspend mask
    #[inline(always)]
    pub fn esuspm(&mut self) -> ESUSPM_W<'_, GINTMSK_ALTERNATErs> {
        ESUSPM_W::new(self, 10)
    }
    ///Bit 11 - USB suspend mask
    #[inline(always)]
    pub fn usbsuspm(&mut self) -> USBSUSPM_W<'_, GINTMSK_ALTERNATErs> {
        USBSUSPM_W::new(self, 11)
    }
    ///Bit 12 - USB reset mask
    #[inline(always)]
    pub fn usbrst(&mut self) -> USBRST_W<'_, GINTMSK_ALTERNATErs> {
        USBRST_W::new(self, 12)
    }
    ///Bit 13 - Enumeration done mask
    #[inline(always)]
    pub fn enumdnem(&mut self) -> ENUMDNEM_W<'_, GINTMSK_ALTERNATErs> {
        ENUMDNEM_W::new(self, 13)
    }
    ///Bit 14 - Isochronous OUT packet dropped interrupt mask
    #[inline(always)]
    pub fn isoodrpm(&mut self) -> ISOODRPM_W<'_, GINTMSK_ALTERNATErs> {
        ISOODRPM_W::new(self, 14)
    }
    ///Bit 15 - End of periodic frame interrupt mask
    #[inline(always)]
    pub fn eopfm(&mut self) -> EOPFM_W<'_, GINTMSK_ALTERNATErs> {
        EOPFM_W::new(self, 15)
    }
    ///Bit 18 - IN endpoints interrupt mask
    #[inline(always)]
    pub fn iepint(&mut self) -> IEPINT_W<'_, GINTMSK_ALTERNATErs> {
        IEPINT_W::new(self, 18)
    }
    ///Bit 19 - OUT endpoints interrupt mask
    #[inline(always)]
    pub fn oepint(&mut self) -> OEPINT_W<'_, GINTMSK_ALTERNATErs> {
        OEPINT_W::new(self, 19)
    }
    ///Bit 20 - Incomplete isochronous IN transfer mask
    #[inline(always)]
    pub fn iisoixfrm(&mut self) -> IISOIXFRM_W<'_, GINTMSK_ALTERNATErs> {
        IISOIXFRM_W::new(self, 20)
    }
    ///Bit 21 - Incomplete isochronous OUT transfer mask
    #[inline(always)]
    pub fn iisooxfrm(&mut self) -> IISOOXFRM_W<'_, GINTMSK_ALTERNATErs> {
        IISOOXFRM_W::new(self, 21)
    }
    ///Bit 22 - Data fetch suspended mask
    #[inline(always)]
    pub fn fsuspm(&mut self) -> FSUSPM_W<'_, GINTMSK_ALTERNATErs> {
        FSUSPM_W::new(self, 22)
    }
    ///Bit 23 - Reset detected interrupt mask
    #[inline(always)]
    pub fn rstdetm(&mut self) -> RSTDETM_W<'_, GINTMSK_ALTERNATErs> {
        RSTDETM_W::new(self, 23)
    }
    ///Bit 27 - LPM interrupt mask
    #[inline(always)]
    pub fn lpmintm(&mut self) -> LPMINTM_W<'_, GINTMSK_ALTERNATErs> {
        LPMINTM_W::new(self, 27)
    }
    ///Bit 28 - Connector ID status change mask
    #[inline(always)]
    pub fn cidschgm(&mut self) -> CIDSCHGM_W<'_, GINTMSK_ALTERNATErs> {
        CIDSCHGM_W::new(self, 28)
    }
    ///Bit 30 - Session request/new session detected interrupt mask
    #[inline(always)]
    pub fn srqim(&mut self) -> SRQIM_W<'_, GINTMSK_ALTERNATErs> {
        SRQIM_W::new(self, 30)
    }
    ///Bit 31 - Resume/remote wake-up detected interrupt mask
    #[inline(always)]
    pub fn wuim(&mut self) -> WUIM_W<'_, GINTMSK_ALTERNATErs> {
        WUIM_W::new(self, 31)
    }
}
