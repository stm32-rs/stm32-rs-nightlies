...
///Field `NPTXFD` reader - Non-periodic Tx FIFO depth
pub type NPTXFD_R = crate::FieldReader<u16>;
///Field `NPTXFD` writer - Non-periodic Tx FIFO depth
...
impl R {
    ...
    ///Bits 16:31 - Non-periodic Tx FIFO depth
    #[inline(always)]
...
impl W {
    ///Bits 0:15 - Non-periodic transmit RAM start address
    #[inline(always)]
    pub fn nptxfsa(&mut self) -> NPTXFSA_W<'_, HNPTXFSIZrs> {
        NPTXFSA_W::new(self, 0)
    }
    ///Bits 16:31 - Non-periodic Tx FIFO depth
    #[inline(always)]
    pub fn nptxfd(&mut self) -> NPTXFD_W<'_, HNPTXFSIZrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#OTG1:HNPTXFSIZ)*/
