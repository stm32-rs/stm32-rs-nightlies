...
///Field `SEC2` reader - V less than sub>DDCORE less than /sub> monitor secure protection
pub type SEC2_R = crate::BitReader;
///Field `SEC2` writer - V less than sub>DDCORE less than /sub> monitor secure protection
...
impl R {
    ...
    ///Bit 2 - V less than sub>DDCORE less than /sub> monitor secure protection
    #[inline(always)]
...
impl W {
    ...
    ///Bit 16 - WKUP1 pin secure protection
    #[inline(always)]
    pub fn wkupsec1(&mut self) -> WKUPSEC1_W<SECCFGRrs> {
        WKUPSEC1_W::new(self, 16)
    }
    ///Bit 17 - WKUP2 pin secure protection
    #[inline(always)]
    pub fn wkupsec2(&mut self) -> WKUPSEC2_W<SECCFGRrs> {
        WKUPSEC2_W::new(self, 17)
    }
    ///Bit 18 - WKUP3 pin secure protection
    #[inline(always)]
    pub fn wkupsec3(&mut self) -> WKUPSEC3_W<SECCFGRrs> {
        WKUPSEC3_W::new(self, 18)
    }
    ///Bit 19 - WKUP4 pin secure protection
    #[inline(always)]
    pub fn wkupsec4(&mut self) -> WKUPSEC4_W<SECCFGRrs> {
