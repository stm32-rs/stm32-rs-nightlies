...
///Field `VDDIO4VMEN` reader - V less than sub>DDIO4 less than /sub>independent I/O voltage monitor enable
pub type VDDIO4VMEN_R = crate::BitReader;
///Field `VDDIO4VMEN` writer - V less than sub>DDIO4 less than /sub>independent I/O voltage monitor enable
pub type VDDIO4VMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `VDDIO4SV` reader - V less than sub>DDIO4 less than /sub>independent I/O supply valid.
pub type VDDIO4SV_R = crate::BitReader;
///Field `VDDIO4SV` writer - V less than sub>DDIO4 less than /sub>independent I/O supply valid.
pub type VDDIO4SV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `VDDIO4RDY` reader - V less than sub>DDIO4 less than /sub>ready
pub type VDDIO4RDY_R = crate::BitReader;
///Field `VDDIO4VRSEL` reader - V less than sub>DDIO4 less than /sub> I/O voltage range selection
pub type VDDIO4VRSEL_R = crate::BitReader;
///Field `VDDIO4VRSEL` writer - V less than sub>DDIO4 less than /sub> I/O voltage range selection
pub type VDDIO4VRSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `VDDIO4VRSTBY` reader - V less than sub>DDIO4 less than /sub> I/O voltage range Standby mode
pub type VDDIO4VRSTBY_R = crate::BitReader;
///Field `VDDIO4VRSTBY` writer - V less than sub>DDIO4 less than /sub> I/O voltage range Standby mode
pub type VDDIO4VRSTBY_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - V less than sub>DDIO4 less than /sub>independent I/O voltage monitor enable
    #[inline(always)]
    pub fn vddio4vmen(&self) -> VDDIO4VMEN_R {
        VDDIO4VMEN_R::new((self.bits & 1) != 0)
    }
    ///Bit 8 - V less than sub>DDIO4 less than /sub>independent I/O supply valid.
    #[inline(always)]
    pub fn vddio4sv(&self) -> VDDIO4SV_R {
        VDDIO4SV_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 16 - V less than sub>DDIO4 less than /sub>ready
    #[inline(always)]
    pub fn vddio4rdy(&self) -> VDDIO4RDY_R {
        VDDIO4RDY_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 24 - V less than sub>DDIO4 less than /sub> I/O voltage range selection
    #[inline(always)]
    pub fn vddio4vrsel(&self) -> VDDIO4VRSEL_R {
        VDDIO4VRSEL_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - V less than sub>DDIO4 less than /sub> I/O voltage range Standby mode
    #[inline(always)]
