...
///Field `VDDIO5VMEN` reader - V less than sub>DDIO5 less than /sub>independent voltage monitor enable
pub type VDDIO5VMEN_R = crate::BitReader;
///Field `VDDIO5VMEN` writer - V less than sub>DDIO5 less than /sub>independent voltage monitor enable
pub type VDDIO5VMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `VDDIO5SV` reader - V less than sub>DDIO5 less than /sub>independent supply valid
pub type VDDIO5SV_R = crate::BitReader;
///Field `VDDIO5SV` writer - V less than sub>DDIO5 less than /sub>independent supply valid
pub type VDDIO5SV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `VDDIO5RDY` reader - V less than sub>DDIO5 less than /sub>ready
pub type VDDIO5RDY_R = crate::BitReader;
///Field `VDDIO5VRSEL` reader - V less than sub>DDIO5 less than /sub> I/O voltage range selection
pub type VDDIO5VRSEL_R = crate::BitReader;
///Field `VDDIO5VRSEL` writer - V less than sub>DDIO5 less than /sub> I/O voltage range selection
pub type VDDIO5VRSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `VDDIO5VRSTBY` reader - V less than sub>DDIO5 less than /sub> I/O voltage range Standby mode
pub type VDDIO5VRSTBY_R = crate::BitReader;
///Field `VDDIO5VRSTBY` writer - V less than sub>DDIO5 less than /sub> I/O voltage range Standby mode
pub type VDDIO5VRSTBY_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - V less than sub>DDIO5 less than /sub>independent voltage monitor enable
    #[inline(always)]
    pub fn vddio5vmen(&self) -> VDDIO5VMEN_R {
        VDDIO5VMEN_R::new((self.bits & 1) != 0)
    }
    ///Bit 8 - V less than sub>DDIO5 less than /sub>independent supply valid
    #[inline(always)]
    pub fn vddio5sv(&self) -> VDDIO5SV_R {
        VDDIO5SV_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 16 - V less than sub>DDIO5 less than /sub>ready
    #[inline(always)]
    pub fn vddio5rdy(&self) -> VDDIO5RDY_R {
        VDDIO5RDY_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 24 - V less than sub>DDIO5 less than /sub> I/O voltage range selection
    #[inline(always)]
    pub fn vddio5vrsel(&self) -> VDDIO5VRSEL_R {
        VDDIO5VRSEL_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - V less than sub>DDIO5 less than /sub> I/O voltage range Standby mode
    #[inline(always)]
...
impl W {
    ///Bit 0 - V less than sub>DDIO5 less than /sub>independent voltage monitor enable
    #[inline(always)]
    pub fn vddio5vmen(&mut self) -> VDDIO5VMEN_W<SVMCR2rs> {
        VDDIO5VMEN_W::new(self, 0)
    }
    ///Bit 8 - V less than sub>DDIO5 less than /sub>independent supply valid
    #[inline(always)]
    pub fn vddio5sv(&mut self) -> VDDIO5SV_W<SVMCR2rs> {
        VDDIO5SV_W::new(self, 8)
    }
    ///Bit 24 - V less than sub>DDIO5 less than /sub> I/O voltage range selection
    #[inline(always)]
    pub fn vddio5vrsel(&mut self) -> VDDIO5VRSEL_W<SVMCR2rs> {
        VDDIO5VRSEL_W::new(self, 24)
    }
    ///Bit 25 - V less than sub>DDIO5 less than /sub> I/O voltage range Standby mode
    #[inline(always)]
    pub fn vddio5vrstby(&mut self) -> VDDIO5VRSTBY_W<SVMCR2rs> {
