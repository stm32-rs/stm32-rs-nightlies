...
impl W {
    ...
    #[inline(always)]
    pub fn gpdma1lpenc(&mut self) -> GPDMA1LPENC_W<AHB1LPENCRrs> {
        GPDMA1LPENC_W::new(self, 4)
    }
    ///Bit 5 - ADC12 sleep enable
    #[inline(always)]
    pub fn adc12lpenc(&mut self) -> ADC12LPENC_W<AHB1LPENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:AHB1LPENCR)*/
