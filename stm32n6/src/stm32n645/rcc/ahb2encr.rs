...
impl W {
    ...
    #[inline(always)]
    pub fn ramcfgenc(&mut self) -> RAMCFGENC_W<AHB2ENCRrs> {
        RAMCFGENC_W::new(self, 12)
    }
    ///Bit 16 - MDF1 enable
    #[inline(always)]
    pub fn mdf1enc(&mut self) -> MDF1ENC_W<AHB2ENCRrs> {
        MDF1ENC_W::new(self, 16)
    }
    ///Bit 17 - ADF1 enable
    #[inline(always)]
    pub fn adf1enc(&mut self) -> ADF1ENC_W<AHB2ENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:AHB2ENCR)*/
