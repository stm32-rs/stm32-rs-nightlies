...
impl W {
    ...
    ///Bit 2 - CRYP enable
    #[inline(always)]
    pub fn crypen(&mut self) -> CRYPEN_W<AHB3ENRrs> {
        CRYPEN_W::new(self, 2)
    }
    ///Bit 4 - SAES enable
    #[inline(always)]
    pub fn saesen(&mut self) -> SAESEN_W<AHB3ENRrs> {
        SAESEN_W::new(self, 4)
    }
    ///Bit 8 - PKA enable
    #[inline(always)]
    ...
    ///Bit 9 - RIFSC enable
    #[inline(always)]
    pub fn rifscen(&mut self) -> RIFSCEN_W<AHB3ENRrs> {
        RIFSCEN_W::new(self, 9)
    }
    ///Bit 10 - IAC enable
    #[inline(always)]
    pub fn iacen(&mut self) -> IACEN_W<AHB3ENRrs> {
        IACEN_W::new(self, 10)
    }
    ///Bit 14 - RISAF enable
    #[inline(always)]
    pub fn risafen(&mut self) -> RISAFEN_W<AHB3ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:AHB3ENR)*/
