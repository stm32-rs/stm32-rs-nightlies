...
impl W {
    ///Bit 0 - RNG enable
    #[inline(always)]
    pub fn rngens(&mut self) -> RNGENS_W<AHB3ENSRrs> {
        RNGENS_W::new(self, 0)
    }
    ///Bit 1 - HASH enable
    #[inline(always)]
    pub fn hashens(&mut self) -> HASHENS_W<AHB3ENSRrs> {
        HASHENS_W::new(self, 1)
    }
    ///Bit 2 - CRYP enable
    #[inline(always)]
    pub fn crypens(&mut self) -> CRYPENS_W<AHB3ENSRrs> {
        CRYPENS_W::new(self, 2)
    }
    ///Bit 4 - SAES enable
    #[inline(always)]
    pub fn saesens(&mut self) -> SAESENS_W<AHB3ENSRrs> {
        SAESENS_W::new(self, 4)
    }
    ///Bit 8 - PKA enable
    #[inline(always)]
    pub fn pkaens(&mut self) -> PKAENS_W<AHB3ENSRrs> {
        PKAENS_W::new(self, 8)
    }
    ///Bit 9 - RIFSC enable
    #[inline(always)]
    pub fn rifscens(&mut self) -> RIFSCENS_W<AHB3ENSRrs> {
        RIFSCENS_W::new(self, 9)
    }
    ///Bit 10 - IAC enable
    #[inline(always)]
    pub fn iacens(&mut self) -> IACENS_W<AHB3ENSRrs> {
        IACENS_W::new(self, 10)
    }
    ///Bit 14 - RISAF enable
    #[inline(always)]
    pub fn risafens(&mut self) -> RISAFENS_W<AHB3ENSRrs> {
