...
impl W {
    ///Bit 0 - RNG sleep enable
    #[inline(always)]
    pub fn rnglpen(&mut self) -> RNGLPEN_W<AHB3LPENRrs> {
        RNGLPEN_W::new(self, 0)
    }
    ///Bit 1 - HASH sleep enable
    #[inline(always)]
    pub fn hashlpen(&mut self) -> HASHLPEN_W<AHB3LPENRrs> {
        HASHLPEN_W::new(self, 1)
    }
    ///Bit 2 - CRYP sleep enable
    #[inline(always)]
    pub fn cryplpen(&mut self) -> CRYPLPEN_W<AHB3LPENRrs> {
        CRYPLPEN_W::new(self, 2)
    }
    ///Bit 4 - SAES sleep enable
    #[inline(always)]
    pub fn saeslpen(&mut self) -> SAESLPEN_W<AHB3LPENRrs> {
        SAESLPEN_W::new(self, 4)
    }
    ///Bit 8 - PKA sleep enable
    #[inline(always)]
    pub fn pkalpen(&mut self) -> PKALPEN_W<AHB3LPENRrs> {
        PKALPEN_W::new(self, 8)
    }
    ///Bit 9 - RIFSC sleep enable
    #[inline(always)]
    pub fn rifsclpen(&mut self) -> RIFSCLPEN_W<AHB3LPENRrs> {
        RIFSCLPEN_W::new(self, 9)
    }
    ///Bit 10 - IAC sleep enable
    #[inline(always)]
    pub fn iaclpen(&mut self) -> IACLPEN_W<AHB3LPENRrs> {
        IACLPEN_W::new(self, 10)
    }
    ///Bit 14 - RISAF sleep enable
    #[inline(always)]
    pub fn risaflpen(&mut self) -> RISAFLPEN_W<AHB3LPENRrs> {
