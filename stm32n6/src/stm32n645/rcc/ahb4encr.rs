...
impl W {
    ///Bit 0 - GPIOA enable
    #[inline(always)]
    pub fn gpioaenc(&mut self) -> GPIOAENC_W<AHB4ENCRrs> {
        GPIOAENC_W::new(self, 0)
    }
    ///Bit 1 - GPIOB enable
    #[inline(always)]
    pub fn gpiobenc(&mut self) -> GPIOBENC_W<AHB4ENCRrs> {
        GPIOBENC_W::new(self, 1)
    }
    ///Bit 2 - GPIOC enable
    #[inline(always)]
    pub fn gpiocenc(&mut self) -> GPIOCENC_W<AHB4ENCRrs> {
        GPIOCENC_W::new(self, 2)
    }
    ///Bit 3 - GPIOD enable
    #[inline(always)]
    pub fn gpiodenc(&mut self) -> GPIODENC_W<AHB4ENCRrs> {
        GPIODENC_W::new(self, 3)
    }
    ///Bit 4 - GPIOE enable
    #[inline(always)]
    pub fn gpioeenc(&mut self) -> GPIOEENC_W<AHB4ENCRrs> {
        GPIOEENC_W::new(self, 4)
    }
    ///Bit 5 - GPIOF enable
    #[inline(always)]
    pub fn gpiofenc(&mut self) -> GPIOFENC_W<AHB4ENCRrs> {
        GPIOFENC_W::new(self, 5)
    }
    ///Bit 6 - GPIOG enable
    #[inline(always)]
    pub fn gpiogenc(&mut self) -> GPIOGENC_W<AHB4ENCRrs> {
        GPIOGENC_W::new(self, 6)
    }
    ///Bit 7 - GPIOH enable
    #[inline(always)]
    pub fn gpiohenc(&mut self) -> GPIOHENC_W<AHB4ENCRrs> {
        GPIOHENC_W::new(self, 7)
    }
    ///Bit 13 - GPION enable
    #[inline(always)]
    pub fn gpionenc(&mut self) -> GPIONENC_W<AHB4ENCRrs> {
        GPIONENC_W::new(self, 13)
    }
    ///Bit 14 - GPIOO enable
    #[inline(always)]
    pub fn gpiooenc(&mut self) -> GPIOOENC_W<AHB4ENCRrs> {
        GPIOOENC_W::new(self, 14)
    }
    ///Bit 15 - GPIOP enable
    #[inline(always)]
    pub fn gpiopenc(&mut self) -> GPIOPENC_W<AHB4ENCRrs> {
        GPIOPENC_W::new(self, 15)
    }
    ///Bit 16 - GPIOQ enable
    #[inline(always)]
    pub fn gpioqenc(&mut self) -> GPIOQENC_W<AHB4ENCRrs> {
        GPIOQENC_W::new(self, 16)
    }
    ///Bit 18 - PWR enable
    #[inline(always)]
    pub fn pwrenc(&mut self) -> PWRENC_W<AHB4ENCRrs> {
        PWRENC_W::new(self, 18)
    }
    ///Bit 19 - CRC enable
    #[inline(always)]
    pub fn crcenc(&mut self) -> CRCENC_W<AHB4ENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:AHB4ENCR)*/
