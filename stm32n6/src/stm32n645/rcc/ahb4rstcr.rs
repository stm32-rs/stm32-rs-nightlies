...
impl W {
    ///Bit 0 - GPIOA reset
    #[inline(always)]
    pub fn gpioarstc(&mut self) -> GPIOARSTC_W<AHB4RSTCRrs> {
        GPIOARSTC_W::new(self, 0)
    }
    ///Bit 1 - GPIOB reset
    #[inline(always)]
    pub fn gpiobrstc(&mut self) -> GPIOBRSTC_W<AHB4RSTCRrs> {
        GPIOBRSTC_W::new(self, 1)
    }
    ///Bit 2 - GPIOC reset
    #[inline(always)]
    pub fn gpiocrstc(&mut self) -> GPIOCRSTC_W<AHB4RSTCRrs> {
        GPIOCRSTC_W::new(self, 2)
    }
    ///Bit 3 - GPIOD reset
    #[inline(always)]
    pub fn gpiodrstc(&mut self) -> GPIODRSTC_W<AHB4RSTCRrs> {
        GPIODRSTC_W::new(self, 3)
    }
    ///Bit 4 - GPIOE reset
    #[inline(always)]
    pub fn gpioerstc(&mut self) -> GPIOERSTC_W<AHB4RSTCRrs> {
        GPIOERSTC_W::new(self, 4)
    }
    ///Bit 5 - GPIOF reset
    #[inline(always)]
    pub fn gpiofrstc(&mut self) -> GPIOFRSTC_W<AHB4RSTCRrs> {
        GPIOFRSTC_W::new(self, 5)
    }
    ///Bit 6 - GPIOG reset
    #[inline(always)]
    pub fn gpiogrstc(&mut self) -> GPIOGRSTC_W<AHB4RSTCRrs> {
        GPIOGRSTC_W::new(self, 6)
    }
    ///Bit 7 - GPIOH reset
    #[inline(always)]
    pub fn gpiohrstc(&mut self) -> GPIOHRSTC_W<AHB4RSTCRrs> {
        GPIOHRSTC_W::new(self, 7)
    }
    ///Bit 13 - GPION reset
    #[inline(always)]
    pub fn gpionrstc(&mut self) -> GPIONRSTC_W<AHB4RSTCRrs> {
        GPIONRSTC_W::new(self, 13)
    }
    ///Bit 14 - GPIOO reset
    #[inline(always)]
    pub fn gpioorstc(&mut self) -> GPIOORSTC_W<AHB4RSTCRrs> {
        GPIOORSTC_W::new(self, 14)
    }
    ///Bit 15 - GPIOP reset
    #[inline(always)]
    pub fn gpioprstc(&mut self) -> GPIOPRSTC_W<AHB4RSTCRrs> {
        GPIOPRSTC_W::new(self, 15)
    }
    ///Bit 16 - GPIOQ reset
    #[inline(always)]
    pub fn gpioqrstc(&mut self) -> GPIOQRSTC_W<AHB4RSTCRrs> {
        GPIOQRSTC_W::new(self, 16)
    }
    ///Bit 18 - PWR reset
    #[inline(always)]
    pub fn pwrrstc(&mut self) -> PWRRSTC_W<AHB4RSTCRrs> {
        PWRRSTC_W::new(self, 18)
    }
    ///Bit 19 - CRC reset
    #[inline(always)]
    pub fn crcrstc(&mut self) -> CRCRSTC_W<AHB4RSTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:AHB4RSTCR)*/
