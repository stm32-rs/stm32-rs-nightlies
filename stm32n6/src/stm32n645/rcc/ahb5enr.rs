...
impl W {
    ...
    ///Bit 6 - PSSI enable
    #[inline(always)]
    pub fn pssien(&mut self) -> PSSIEN_W<AHB5ENRrs> {
        PSSIEN_W::new(self, 6)
    }
    ///Bit 7 - SDMMC2 enable
    #[inline(always)]
    pub fn sdmmc2en(&mut self) -> SDMMC2EN_W<AHB5ENRrs> {
    ...
    ///Bit 14 - MCE1 enable
    #[inline(always)]
    pub fn mce1en(&mut self) -> MCE1EN_W<AHB5ENRrs> {
        MCE1EN_W::new(self, 14)
    }
    ///Bit 15 - MCE2 enable
    #[inline(always)]
    pub fn mce2en(&mut self) -> MCE2EN_W<AHB5ENRrs> {
        MCE2EN_W::new(self, 15)
    }
    ///Bit 16 - MCE3 enable
    #[inline(always)]
    pub fn mce3en(&mut self) -> MCE3EN_W<AHB5ENRrs> {
        MCE3EN_W::new(self, 16)
    }
    ///Bit 17 - XSPI3 enable
    #[inline(always)]
    pub fn xspi3en(&mut self) -> XSPI3EN_W<AHB5ENRrs> {
        XSPI3EN_W::new(self, 17)
    }
    ///Bit 18 - MCE4 enable
    #[inline(always)]
    pub fn mce4en(&mut self) -> MCE4EN_W<AHB5ENRrs> {
    ...
    ///Bit 22 - ETH1MAC enable
    #[inline(always)]
    pub fn eth1macen(&mut self) -> ETH1MACEN_W<AHB5ENRrs> {
        ETH1MACEN_W::new(self, 22)
    }
    ///Bit 23 - ETH1TX enable
    #[inline(always)]
    pub fn eth1txen(&mut self) -> ETH1TXEN_W<AHB5ENRrs> {
        ETH1TXEN_W::new(self, 23)
    }
    ///Bit 24 - ETH1RX enable
    #[inline(always)]
    pub fn eth1rxen(&mut self) -> ETH1RXEN_W<AHB5ENRrs> {
        ETH1RXEN_W::new(self, 24)
    }
    ///Bit 25 - ETH1 enable
    #[inline(always)]
    pub fn eth1en(&mut self) -> ETH1EN_W<AHB5ENRrs> {
        ETH1EN_W::new(self, 25)
    }
    ///Bit 26 - OTG1 enable
    #[inline(always)]
    pub fn otg1en(&mut self) -> OTG1EN_W<AHB5ENRrs> {
        OTG1EN_W::new(self, 26)
    }
    ///Bit 27 - OTGPHY1 enable
    #[inline(always)]
    pub fn otgphy1en(&mut self) -> OTGPHY1EN_W<AHB5ENRrs> {
        OTGPHY1EN_W::new(self, 27)
    }
    ///Bit 28 - OTGPHY2 enable
    #[inline(always)]
    pub fn otgphy2en(&mut self) -> OTGPHY2EN_W<AHB5ENRrs> {
        OTGPHY2EN_W::new(self, 28)
    }
    ///Bit 29 - OTG2 enable
    #[inline(always)]
    pub fn otg2en(&mut self) -> OTG2EN_W<AHB5ENRrs> {
        OTG2EN_W::new(self, 29)
    }
    ///Bit 30 - NPUCACHE enable
    #[inline(always)]
    pub fn npucacheen(&mut self) -> NPUCACHEEN_W<AHB5ENRrs> {
        NPUCACHEEN_W::new(self, 30)
    }
    ///Bit 31 - NPU enable
    #[inline(always)]
    pub fn npuen(&mut self) -> NPUEN_W<AHB5ENRrs> {
        NPUEN_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:AHB5ENR)*/
