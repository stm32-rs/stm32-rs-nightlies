...
impl W {
    ...
    ///Bit 6 - PSSI sleep enable
    #[inline(always)]
    pub fn pssilpen(&mut self) -> PSSILPEN_W<AHB5LPENRrs> {
        PSSILPEN_W::new(self, 6)
    }
    ///Bit 7 - SDMMC2 sleep enable
    #[inline(always)]
    pub fn sdmmc2lpen(&mut self) -> SDMMC2LPEN_W<AHB5LPENRrs> {
    ...
    ///Bit 14 - MCE1 sleep enable
    #[inline(always)]
    pub fn mce1lpen(&mut self) -> MCE1LPEN_W<AHB5LPENRrs> {
        MCE1LPEN_W::new(self, 14)
    }
    ///Bit 15 - MCE2 sleep enable
    #[inline(always)]
    pub fn mce2lpen(&mut self) -> MCE2LPEN_W<AHB5LPENRrs> {
        MCE2LPEN_W::new(self, 15)
    }
    ///Bit 16 - MCE3 sleep enable
    #[inline(always)]
    pub fn mce3lpen(&mut self) -> MCE3LPEN_W<AHB5LPENRrs> {
        MCE3LPEN_W::new(self, 16)
    }
    ///Bit 17 - XSPI3 sleep enable
    #[inline(always)]
    pub fn xspi3lpen(&mut self) -> XSPI3LPEN_W<AHB5LPENRrs> {
        XSPI3LPEN_W::new(self, 17)
    }
    ///Bit 18 - MCE4 sleep enable
    #[inline(always)]
    pub fn mce4lpen(&mut self) -> MCE4LPEN_W<AHB5LPENRrs> {
    ...
    ///Bit 22 - ETH1MAC sleep enable
    #[inline(always)]
    pub fn eth1maclpen(&mut self) -> ETH1MACLPEN_W<AHB5LPENRrs> {
        ETH1MACLPEN_W::new(self, 22)
    }
    ///Bit 23 - ETH1TX sleep enable
    #[inline(always)]
    pub fn eth1txlpen(&mut self) -> ETH1TXLPEN_W<AHB5LPENRrs> {
        ETH1TXLPEN_W::new(self, 23)
    }
    ///Bit 24 - ETH1RX sleep enable
    #[inline(always)]
    pub fn eth1rxlpen(&mut self) -> ETH1RXLPEN_W<AHB5LPENRrs> {
        ETH1RXLPEN_W::new(self, 24)
    }
    ///Bit 25 - ETH1 sleep enable
    #[inline(always)]
    pub fn eth1lpen(&mut self) -> ETH1LPEN_W<AHB5LPENRrs> {
        ETH1LPEN_W::new(self, 25)
    }
    ///Bit 26 - OTG1 sleep enable
    #[inline(always)]
    pub fn otg1lpen(&mut self) -> OTG1LPEN_W<AHB5LPENRrs> {
        OTG1LPEN_W::new(self, 26)
    }
    ///Bit 27 - OTGPHY1 sleep enable
    #[inline(always)]
    pub fn otgphy1lpen(&mut self) -> OTGPHY1LPEN_W<AHB5LPENRrs> {
        OTGPHY1LPEN_W::new(self, 27)
    }
    ///Bit 28 - OTGPHY2 sleep enable
    #[inline(always)]
    pub fn otgphy2lpen(&mut self) -> OTGPHY2LPEN_W<AHB5LPENRrs> {
        OTGPHY2LPEN_W::new(self, 28)
    }
    ///Bit 29 - OTG2 sleep enable
    #[inline(always)]
    pub fn otg2lpen(&mut self) -> OTG2LPEN_W<AHB5LPENRrs> {
        OTG2LPEN_W::new(self, 29)
    }
    ///Bit 30 - NPUCACHE sleep enable
    #[inline(always)]
    pub fn npucachelpen(&mut self) -> NPUCACHELPEN_W<AHB5LPENRrs> {
        NPUCACHELPEN_W::new(self, 30)
    }
    ///Bit 31 - NPU sleep enable
    #[inline(always)]
    pub fn npulpen(&mut self) -> NPULPEN_W<AHB5LPENRrs> {
