...
impl W {
    ///Bit 0 - HPDMA1 reset
    #[inline(always)]
    pub fn hpdma1rsts(&mut self) -> HPDMA1RSTS_W<AHB5RSTSRrs> {
        HPDMA1RSTS_W::new(self, 0)
    }
    ///Bit 1 - DMA2D reset
    #[inline(always)]
    pub fn dma2drsts(&mut self) -> DMA2DRSTS_W<AHB5RSTSRrs> {
        DMA2DRSTS_W::new(self, 1)
    }
    ///Bit 3 - JPEG reset
    #[inline(always)]
    pub fn jpegrsts(&mut self) -> JPEGRSTS_W<AHB5RSTSRrs> {
        JPEGRSTS_W::new(self, 3)
    }
    ///Bit 4 - FMC reset
    #[inline(always)]
    pub fn fmcrsts(&mut self) -> FMCRSTS_W<AHB5RSTSRrs> {
        FMCRSTS_W::new(self, 4)
    }
    ///Bit 5 - XSPI1 reset
    #[inline(always)]
    pub fn xspi1rsts(&mut self) -> XSPI1RSTS_W<AHB5RSTSRrs> {
        XSPI1RSTS_W::new(self, 5)
    }
    ///Bit 6 - PSSI reset
    #[inline(always)]
    pub fn pssirsts(&mut self) -> PSSIRSTS_W<AHB5RSTSRrs> {
        PSSIRSTS_W::new(self, 6)
    }
    ///Bit 7 - SDMMC2 reset
    #[inline(always)]
    pub fn sdmmc2rsts(&mut self) -> SDMMC2RSTS_W<AHB5RSTSRrs> {
        SDMMC2RSTS_W::new(self, 7)
    }
    ///Bit 8 - SDMMC1 reset
    #[inline(always)]
    pub fn sdmmc1rsts(&mut self) -> SDMMC1RSTS_W<AHB5RSTSRrs> {
        SDMMC1RSTS_W::new(self, 8)
    }
    ///Bit 12 - XSPI2 reset
    #[inline(always)]
    pub fn xspi2rsts(&mut self) -> XSPI2RSTS_W<AHB5RSTSRrs> {
        XSPI2RSTS_W::new(self, 12)
    }
    ///Bit 13 - XSPIM reset
    #[inline(always)]
    pub fn xspimrsts(&mut self) -> XSPIMRSTS_W<AHB5RSTSRrs> {
        XSPIMRSTS_W::new(self, 13)
    }
    ///Bit 17 - XSPI3 reset
    #[inline(always)]
    pub fn xspi3rsts(&mut self) -> XSPI3RSTS_W<AHB5RSTSRrs> {
        XSPI3RSTS_W::new(self, 17)
    }
    ///Bit 18 - MCE4 reset
    #[inline(always)]
    pub fn mce4rsts(&mut self) -> MCE4RSTS_W<AHB5RSTSRrs> {
        MCE4RSTS_W::new(self, 18)
    }
    ///Bit 19 - GFXMMU reset
    #[inline(always)]
    pub fn gfxmmursts(&mut self) -> GFXMMURSTS_W<AHB5RSTSRrs> {
        GFXMMURSTS_W::new(self, 19)
    }
    ///Bit 20 - GPU reset
    #[inline(always)]
    pub fn gpursts(&mut self) -> GPURSTS_W<AHB5RSTSRrs> {
        GPURSTS_W::new(self, 20)
    }
    ///Bit 23 - SYSCFGOTGHSPHY1 reset
    #[inline(always)]
    pub fn syscfgotghsphy1rsts(&mut self) -> SYSCFGOTGHSPHY1RSTS_W<AHB5RSTSRrs> {
        SYSCFGOTGHSPHY1RSTS_W::new(self, 23)
    }
    ///Bit 24 - SYSCFGOTGHSPHY2 reset
    #[inline(always)]
    pub fn syscfgotghsphy2rsts(&mut self) -> SYSCFGOTGHSPHY2RSTS_W<AHB5RSTSRrs> {
        SYSCFGOTGHSPHY2RSTS_W::new(self, 24)
    }
    ///Bit 25 - ETH1 reset
    #[inline(always)]
    pub fn eth1rsts(&mut self) -> ETH1RSTS_W<AHB5RSTSRrs> {
        ETH1RSTS_W::new(self, 25)
    }
    ///Bit 26 - OTG1 reset
    #[inline(always)]
    pub fn otg1rsts(&mut self) -> OTG1RSTS_W<AHB5RSTSRrs> {
        OTG1RSTS_W::new(self, 26)
    }
    ///Bit 27 - OTGPHY1 reset
    #[inline(always)]
    pub fn otgphy1rsts(&mut self) -> OTGPHY1RSTS_W<AHB5RSTSRrs> {
        OTGPHY1RSTS_W::new(self, 27)
    }
    ///Bit 28 - OTGPHY2 reset
    #[inline(always)]
    pub fn otgphy2rsts(&mut self) -> OTGPHY2RSTS_W<AHB5RSTSRrs> {
        OTGPHY2RSTS_W::new(self, 28)
    }
    ///Bit 29 - OTG2 reset
    #[inline(always)]
    pub fn otg2rsts(&mut self) -> OTG2RSTS_W<AHB5RSTSRrs> {
        OTG2RSTS_W::new(self, 29)
    }
    ///Bit 30 - NPUCACHE reset
    #[inline(always)]
    pub fn npucachersts(&mut self) -> NPUCACHERSTS_W<AHB5RSTSRrs> {
        NPUCACHERSTS_W::new(self, 30)
    }
    ///Bit 31 - NPU reset
    #[inline(always)]
    pub fn npursts(&mut self) -> NPURSTS_W<AHB5RSTSRrs> {
