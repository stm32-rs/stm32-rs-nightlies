...
impl W {
    ...
    ///Bit 12 - TIM10 enable
    #[inline(always)]
    pub fn tim10en(&mut self) -> TIM10EN_W<APB1LENRrs> {
        TIM10EN_W::new(self, 12)
    }
    ///Bit 13 - TIM11 enable
    #[inline(always)]
    pub fn tim11en(&mut self) -> TIM11EN_W<APB1LENRrs> {
    ...
    ///Bit 16 - SPDIFRX1 enable
    #[inline(always)]
    pub fn spdifrx1en(&mut self) -> SPDIFRX1EN_W<APB1LENRrs> {
    ...
    ///Bit 25 - I3C2 enable
    #[inline(always)]
    pub fn i3c2en(&mut self) -> I3C2EN_W<APB1LENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:APB1LENR)*/
