...
impl W {
    ///Bit 0 - SYSCFG enable
    #[inline(always)]
    pub fn syscfgenc(&mut self) -> SYSCFGENC_W<APB4HENCRrs> {
        SYSCFGENC_W::new(self, 0)
    }
    ///Bit 1 - BSEC enable
    #[inline(always)]
    pub fn bsecenc(&mut self) -> BSECENC_W<APB4HENCRrs> {
        BSECENC_W::new(self, 1)
    }
    ///Bit 2 - DTS enable
    #[inline(always)]
    pub fn dtsenc(&mut self) -> DTSENC_W<APB4HENCRrs> {
        DTSENC_W::new(self, 2)
    }
    ///Bit 4 - BUSPERFM enable
    #[inline(always)]
    pub fn busperfmenc(&mut self) -> BUSPERFMENC_W<APB4HENCRrs> {
