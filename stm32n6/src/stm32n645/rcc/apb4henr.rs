...
impl W {
    ///Bit 0 - SYSCFG enable
    #[inline(always)]
    pub fn syscfgen(&mut self) -> SYSCFGEN_W<APB4HENRrs> {
        SYSCFGEN_W::new(self, 0)
    }
    ///Bit 1 - BSEC enable
    #[inline(always)]
    pub fn bsecen(&mut self) -> BSECEN_W<APB4HENRrs> {
        BSECEN_W::new(self, 1)
    }
    ///Bit 2 - DTS enable
    #[inline(always)]
    pub fn dtsen(&mut self) -> DTSEN_W<APB4HENRrs> {
        DTSEN_W::new(self, 2)
    }
    ///Bit 4 - BUSPERFM enable
    #[inline(always)]
    pub fn busperfmen(&mut self) -> BUSPERFMEN_W<APB4HENRrs> {
