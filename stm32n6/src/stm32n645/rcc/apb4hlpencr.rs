...
impl W {
    ...
    #[inline(always)]
    pub fn syscfglpenc(&mut self) -> SYSCFGLPENC_W<APB4HLPENCRrs> {
        SYSCFGLPENC_W::new(self, 0)
    }
    ///Bit 1 - BSEC sleep enable
    #[inline(always)]
    pub fn bseclpenc(&mut self) -> BSECLPENC_W<APB4HLPENCRrs> {
        BSECLPENC_W::new(self, 1)
    }
    ///Bit 2 - DTS sleep enable
    #[inline(always)]
    pub fn dtslpenc(&mut self) -> DTSLPENC_W<APB4HLPENCRrs> {
        DTSLPENC_W::new(self, 2)
    }
    ///Bit 4 - BUSPERFM sleep enable
    #[inline(always)]
    pub fn busperfmlpenc(&mut self) -> BUSPERFMLPENC_W<APB4HLPENCRrs> {
