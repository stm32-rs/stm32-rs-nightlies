...
impl W {
    ///Bit 0 - SYSCFG reset
    #[inline(always)]
    pub fn syscfgrsts(&mut self) -> SYSCFGRSTS_W<APB4HRSTSRrs> {
        SYSCFGRSTS_W::new(self, 0)
    }
    ///Bit 2 - DTS reset
    #[inline(always)]
    pub fn dtsrsts(&mut self) -> DTSRSTS_W<APB4HRSTSRrs> {
        DTSRSTS_W::new(self, 2)
    }
    ///Bit 4 - BUSPERFM reset
    #[inline(always)]
    pub fn busperfmrsts(&mut self) -> BUSPERFMRSTS_W<APB4HRSTSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:APB4HRSTSR)*/
