...
impl W {
    ///Bit 2 - HDP enable
    #[inline(always)]
    pub fn hdpens(&mut self) -> HDPENS_W<APB4LENSRrs> {
        HDPENS_W::new(self, 2)
    }
    ///Bit 3 - LPUART1 enable
    #[inline(always)]
    pub fn lpuart1ens(&mut self) -> LPUART1ENS_W<APB4LENSRrs> {
        LPUART1ENS_W::new(self, 3)
    }
    ///Bit 5 - SPI6 enable
    #[inline(always)]
    pub fn spi6ens(&mut self) -> SPI6ENS_W<APB4LENSRrs> {
        SPI6ENS_W::new(self, 5)
    }
    ///Bit 7 - I2C4 enable
    #[inline(always)]
    pub fn i2c4ens(&mut self) -> I2C4ENS_W<APB4LENSRrs> {
        I2C4ENS_W::new(self, 7)
    }
    ///Bit 9 - LPTIM2 enable
    #[inline(always)]
    pub fn lptim2ens(&mut self) -> LPTIM2ENS_W<APB4LENSRrs> {
        LPTIM2ENS_W::new(self, 9)
    }
    ///Bit 10 - LPTIM3 enable
    #[inline(always)]
    pub fn lptim3ens(&mut self) -> LPTIM3ENS_W<APB4LENSRrs> {
        LPTIM3ENS_W::new(self, 10)
    }
    ///Bit 11 - LPTIM4 enable
    #[inline(always)]
    pub fn lptim4ens(&mut self) -> LPTIM4ENS_W<APB4LENSRrs> {
        LPTIM4ENS_W::new(self, 11)
    }
    ///Bit 12 - LPTIM5 enable
    #[inline(always)]
    pub fn lptim5ens(&mut self) -> LPTIM5ENS_W<APB4LENSRrs> {
        LPTIM5ENS_W::new(self, 12)
    }
    ///Bit 15 - VREFBUF enable
    #[inline(always)]
    pub fn vrefbufens(&mut self) -> VREFBUFENS_W<APB4LENSRrs> {
        VREFBUFENS_W::new(self, 15)
    }
    ///Bit 16 - RTC enable
    #[inline(always)]
    pub fn rtcens(&mut self) -> RTCENS_W<APB4LENSRrs> {
        RTCENS_W::new(self, 16)
    }
    ///Bit 17 - RTCAPB enable
    #[inline(always)]
    pub fn rtcapbens(&mut self) -> RTCAPBENS_W<APB4LENSRrs> {
        RTCAPBENS_W::new(self, 17)
    }
    ///Bit 22 - R2GRET enable
    #[inline(always)]
    pub fn r2gretens(&mut self) -> R2GRETENS_W<APB4LENSRrs> {
        R2GRETENS_W::new(self, 22)
    }
    ///Bit 23 - R2GNPU enable
    #[inline(always)]
    pub fn r2gnpuens(&mut self) -> R2GNPUENS_W<APB4LENSRrs> {
        R2GNPUENS_W::new(self, 23)
    }
    ///Bit 31 - SERF enable
    #[inline(always)]
    pub fn serfens(&mut self) -> SERFENS_W<APB4LENSRrs> {
