...
impl W {
    ///Bit 2 - HDP sleep enable
    #[inline(always)]
    pub fn hdplpen(&mut self) -> HDPLPEN_W<APB4LLPENRrs> {
        HDPLPEN_W::new(self, 2)
    }
    ///Bit 3 - LPUART1 sleep enable
    #[inline(always)]
    pub fn lpuart1lpen(&mut self) -> LPUART1LPEN_W<APB4LLPENRrs> {
        LPUART1LPEN_W::new(self, 3)
    }
    ///Bit 5 - SPI6 sleep enable
    #[inline(always)]
    pub fn spi6lpen(&mut self) -> SPI6LPEN_W<APB4LLPENRrs> {
        SPI6LPEN_W::new(self, 5)
    }
    ///Bit 7 - I2C4 sleep enable
    #[inline(always)]
    pub fn i2c4lpen(&mut self) -> I2C4LPEN_W<APB4LLPENRrs> {
        I2C4LPEN_W::new(self, 7)
    }
    ///Bit 9 - LPTIM2 sleep enable
    #[inline(always)]
    pub fn lptim2lpen(&mut self) -> LPTIM2LPEN_W<APB4LLPENRrs> {
        LPTIM2LPEN_W::new(self, 9)
    }
    ///Bit 10 - LPTIM3 sleep enable
    #[inline(always)]
    pub fn lptim3lpen(&mut self) -> LPTIM3LPEN_W<APB4LLPENRrs> {
        LPTIM3LPEN_W::new(self, 10)
    }
    ///Bit 11 - LPTIM4 sleep enable
    #[inline(always)]
    pub fn lptim4lpen(&mut self) -> LPTIM4LPEN_W<APB4LLPENRrs> {
        LPTIM4LPEN_W::new(self, 11)
    }
    ///Bit 12 - LPTIM5 sleep enable
    #[inline(always)]
    pub fn lptim5lpen(&mut self) -> LPTIM5LPEN_W<APB4LLPENRrs> {
        LPTIM5LPEN_W::new(self, 12)
    }
    ///Bit 15 - VREFBUF sleep enable
    #[inline(always)]
    pub fn vrefbuflpen(&mut self) -> VREFBUFLPEN_W<APB4LLPENRrs> {
        VREFBUFLPEN_W::new(self, 15)
    }
    ///Bit 16 - RTC sleep enable
    #[inline(always)]
    pub fn rtclpen(&mut self) -> RTCLPEN_W<APB4LLPENRrs> {
        RTCLPEN_W::new(self, 16)
    }
    ///Bit 17 - RTCAPB sleep enable
    #[inline(always)]
    pub fn rtcapblpen(&mut self) -> RTCAPBLPEN_W<APB4LLPENRrs> {
        RTCAPBLPEN_W::new(self, 17)
    }
    ///Bit 22 - R2GRET sleep enable
    #[inline(always)]
    pub fn r2gretlpen(&mut self) -> R2GRETLPEN_W<APB4LLPENRrs> {
        R2GRETLPEN_W::new(self, 22)
    }
    ///Bit 23 - R2GNPU sleep enable
    #[inline(always)]
    pub fn r2gnpulpen(&mut self) -> R2GNPULPEN_W<APB4LLPENRrs> {
        R2GNPULPEN_W::new(self, 23)
    }
    ///Bit 31 - SERF sleep enable
    #[inline(always)]
    pub fn serflpen(&mut self) -> SERFLPEN_W<APB4LLPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:APB4LLPENR)*/
