...
impl W {
    ///Bit 2 - HDP reset
    #[inline(always)]
    pub fn hdprsts(&mut self) -> HDPRSTS_W<APB4LRSTSRrs> {
        HDPRSTS_W::new(self, 2)
    }
    ///Bit 3 - LPUART1 reset
    #[inline(always)]
    pub fn lpuart1rsts(&mut self) -> LPUART1RSTS_W<APB4LRSTSRrs> {
        LPUART1RSTS_W::new(self, 3)
    }
    ///Bit 5 - SPI6 reset
    #[inline(always)]
    pub fn spi6rsts(&mut self) -> SPI6RSTS_W<APB4LRSTSRrs> {
        SPI6RSTS_W::new(self, 5)
    }
    ///Bit 7 - I2C4 reset
    #[inline(always)]
    pub fn i2c4rsts(&mut self) -> I2C4RSTS_W<APB4LRSTSRrs> {
        I2C4RSTS_W::new(self, 7)
    }
    ///Bit 9 - LPTIM2 reset
    #[inline(always)]
    pub fn lptim2rsts(&mut self) -> LPTIM2RSTS_W<APB4LRSTSRrs> {
        LPTIM2RSTS_W::new(self, 9)
    }
    ///Bit 10 - LPTIM3 reset
    #[inline(always)]
    pub fn lptim3rsts(&mut self) -> LPTIM3RSTS_W<APB4LRSTSRrs> {
        LPTIM3RSTS_W::new(self, 10)
    }
    ///Bit 11 - LPTIM4 reset
    #[inline(always)]
    pub fn lptim4rsts(&mut self) -> LPTIM4RSTS_W<APB4LRSTSRrs> {
        LPTIM4RSTS_W::new(self, 11)
    }
    ///Bit 12 - LPTIM5 reset
    #[inline(always)]
    pub fn lptim5rsts(&mut self) -> LPTIM5RSTS_W<APB4LRSTSRrs> {
        LPTIM5RSTS_W::new(self, 12)
    }
    ///Bit 15 - VREFBUF reset
    #[inline(always)]
    pub fn vrefbufrsts(&mut self) -> VREFBUFRSTS_W<APB4LRSTSRrs> {
        VREFBUFRSTS_W::new(self, 15)
    }
    ///Bit 16 - RTC reset
    #[inline(always)]
    pub fn rtcrsts(&mut self) -> RTCRSTS_W<APB4LRSTSRrs> {
        RTCRSTS_W::new(self, 16)
    }
    ///Bit 22 - R2GRET reset
    #[inline(always)]
    pub fn r2gretrsts(&mut self) -> R2GRETRSTS_W<APB4LRSTSRrs> {
        R2GRETRSTS_W::new(self, 22)
    }
    ///Bit 23 - R2GNPU reset
    #[inline(always)]
    pub fn r2gnpursts(&mut self) -> R2GNPURSTS_W<APB4LRSTSRrs> {
        R2GNPURSTS_W::new(self, 23)
    }
    ///Bit 31 - SERF reset
    #[inline(always)]
    pub fn serfrsts(&mut self) -> SERFRSTS_W<APB4LRSTSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:APB4LRSTSR)*/
