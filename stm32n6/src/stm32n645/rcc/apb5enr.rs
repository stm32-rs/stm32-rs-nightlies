...
impl W {
    ...
    ///Bit 5 - VENC enable
    #[inline(always)]
    pub fn vencen(&mut self) -> VENCEN_W<APB5ENRrs> {
        VENCEN_W::new(self, 5)
    }
    ///Bit 6 - CSI enable
    #[inline(always)]
    pub fn csien(&mut self) -> CSIEN_W<APB5ENRrs> {
        CSIEN_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:APB5ENR)*/
