...
impl W {
    ...
    #[inline(always)]
    pub fn ltdclpens(&mut self) -> LTDCLPENS_W<APB5LPENSRrs> {
        LTDCLPENS_W::new(self, 1)
    }
    ///Bit 2 - DCMIPP sleep enable
    #[inline(always)]
    pub fn dcmipplpens(&mut self) -> DCMIPPLPENS_W<APB5LPENSRrs> {
        DCMIPPLPENS_W::new(self, 2)
    }
    ///Bit 4 - GFXTIM sleep enable
    #[inline(always)]
    pub fn gfxtimlpens(&mut self) -> GFXTIMLPENS_W<APB5LPENSRrs> {
        GFXTIMLPENS_W::new(self, 4)
    }
    ///Bit 5 - VENC sleep enable
    #[inline(always)]
    pub fn venclpens(&mut self) -> VENCLPENS_W<APB5LPENSRrs> {
        VENCLPENS_W::new(self, 5)
    }
    ///Bit 6 - CSI sleep enable
    #[inline(always)]
    pub fn csilpens(&mut self) -> CSILPENS_W<APB5LPENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:APB5LPENSR)*/
