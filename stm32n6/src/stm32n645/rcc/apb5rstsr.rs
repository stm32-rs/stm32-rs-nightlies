...
impl W {
    ///Bit 1 - LTDC reset
    #[inline(always)]
    pub fn ltdcrsts(&mut self) -> LTDCRSTS_W<APB5RSTSRrs> {
        LTDCRSTS_W::new(self, 1)
    }
    ///Bit 2 - DCMIPP reset
    #[inline(always)]
    pub fn dcmipprsts(&mut self) -> DCMIPPRSTS_W<APB5RSTSRrs> {
        DCMIPPRSTS_W::new(self, 2)
    }
    ///Bit 4 - GFXTIM reset
    #[inline(always)]
    pub fn gfxtimrsts(&mut self) -> GFXTIMRSTS_W<APB5RSTSRrs> {
        GFXTIMRSTS_W::new(self, 4)
    }
    ///Bit 5 - VENC reset
    #[inline(always)]
    pub fn vencrsts(&mut self) -> VENCRSTS_W<APB5RSTSRrs> {
        VENCRSTS_W::new(self, 5)
    }
    ///Bit 6 - CSI reset
    #[inline(always)]
    pub fn csirsts(&mut self) -> CSIRSTS_W<APB5RSTSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:APB5RSTSR)*/
