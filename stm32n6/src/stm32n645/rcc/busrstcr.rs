...
impl W {
    ///Bit 0 - ACLKN reset
    #[inline(always)]
    pub fn aclknrstc(&mut self) -> ACLKNRSTC_W<BUSRSTCRrs> {
        ACLKNRSTC_W::new(self, 0)
    }
    ///Bit 2 - AHBM reset
    #[inline(always)]
    pub fn ahbmrstc(&mut self) -> AHBMRSTC_W<BUSRSTCRrs> {
        AHBMRSTC_W::new(self, 2)
    }
    ///Bit 3 - AHB1 reset
    #[inline(always)]
    pub fn ahb1rstc(&mut self) -> AHB1RSTC_W<BUSRSTCRrs> {
        AHB1RSTC_W::new(self, 3)
    }
    ///Bit 4 - AHB2 reset
    #[inline(always)]
    pub fn ahb2rstc(&mut self) -> AHB2RSTC_W<BUSRSTCRrs> {
        AHB2RSTC_W::new(self, 4)
    }
    ///Bit 5 - AHB3 reset
    #[inline(always)]
    pub fn ahb3rstc(&mut self) -> AHB3RSTC_W<BUSRSTCRrs> {
        AHB3RSTC_W::new(self, 5)
    }
    ///Bit 6 - AHB4 reset
    #[inline(always)]
    pub fn ahb4rstc(&mut self) -> AHB4RSTC_W<BUSRSTCRrs> {
        AHB4RSTC_W::new(self, 6)
    }
    ///Bit 7 - AHB5 reset
    #[inline(always)]
    pub fn ahb5rstc(&mut self) -> AHB5RSTC_W<BUSRSTCRrs> {
        AHB5RSTC_W::new(self, 7)
    }
    ///Bit 8 - APB1 reset
    #[inline(always)]
    pub fn apb1rstc(&mut self) -> APB1RSTC_W<BUSRSTCRrs> {
        APB1RSTC_W::new(self, 8)
    }
    ///Bit 9 - APB2 reset
    #[inline(always)]
    pub fn apb2rstc(&mut self) -> APB2RSTC_W<BUSRSTCRrs> {
        APB2RSTC_W::new(self, 9)
    }
    ///Bit 10 - APB3 reset
    #[inline(always)]
    pub fn apb3rstc(&mut self) -> APB3RSTC_W<BUSRSTCRrs> {
        APB3RSTC_W::new(self, 10)
    }
    ///Bit 11 - APB4 reset
    #[inline(always)]
    pub fn apb4rstc(&mut self) -> APB4RSTC_W<BUSRSTCRrs> {
        APB4RSTC_W::new(self, 11)
    }
    ///Bit 12 - APB5 reset
    #[inline(always)]
    pub fn apb5rstc(&mut self) -> APB5RSTC_W<BUSRSTCRrs> {
        APB5RSTC_W::new(self, 12)
    }
    ///Bit 13 - NOC reset
    #[inline(always)]
    pub fn nocrstc(&mut self) -> NOCRSTC_W<BUSRSTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:BUSRSTCR)*/
