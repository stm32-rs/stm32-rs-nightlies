...
impl W {
    ///Bit 0 - ACLKN reset
    #[inline(always)]
    pub fn aclknrst(&mut self) -> ACLKNRST_W<BUSRSTRrs> {
        ACLKNRST_W::new(self, 0)
    }
    ///Bit 2 - AHBM reset
    #[inline(always)]
    pub fn ahbmrst(&mut self) -> AHBMRST_W<BUSRSTRrs> {
        AHBMRST_W::new(self, 2)
    }
    ///Bit 3 - AHB1 reset
    #[inline(always)]
    pub fn ahb1rst(&mut self) -> AHB1RST_W<BUSRSTRrs> {
        AHB1RST_W::new(self, 3)
    }
    ///Bit 4 - AHB2 reset
    #[inline(always)]
    pub fn ahb2rst(&mut self) -> AHB2RST_W<BUSRSTRrs> {
        AHB2RST_W::new(self, 4)
    }
    ///Bit 5 - AHB3 reset
    #[inline(always)]
    pub fn ahb3rst(&mut self) -> AHB3RST_W<BUSRSTRrs> {
        AHB3RST_W::new(self, 5)
    }
    ///Bit 6 - AHB4 reset
    #[inline(always)]
    pub fn ahb4rst(&mut self) -> AHB4RST_W<BUSRSTRrs> {
        AHB4RST_W::new(self, 6)
    }
    ///Bit 7 - AHB5 reset
    #[inline(always)]
    pub fn ahb5rst(&mut self) -> AHB5RST_W<BUSRSTRrs> {
        AHB5RST_W::new(self, 7)
    }
    ///Bit 8 - APB1 reset
    #[inline(always)]
    pub fn apb1rst(&mut self) -> APB1RST_W<BUSRSTRrs> {
        APB1RST_W::new(self, 8)
    }
    ///Bit 9 - APB2 reset
    #[inline(always)]
    pub fn apb2rst(&mut self) -> APB2RST_W<BUSRSTRrs> {
        APB2RST_W::new(self, 9)
    }
    ///Bit 10 - APB3 reset
    #[inline(always)]
    pub fn apb3rst(&mut self) -> APB3RST_W<BUSRSTRrs> {
        APB3RST_W::new(self, 10)
    }
    ///Bit 11 - APB4 reset
    #[inline(always)]
    pub fn apb4rst(&mut self) -> APB4RST_W<BUSRSTRrs> {
        APB4RST_W::new(self, 11)
    }
    ///Bit 12 - APB5 reset
    #[inline(always)]
    pub fn apb5rst(&mut self) -> APB5RST_W<BUSRSTRrs> {
        APB5RST_W::new(self, 12)
    }
    ///Bit 13 - NOC reset
    #[inline(always)]
    pub fn nocrst(&mut self) -> NOCRST_W<BUSRSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:BUSRSTR)*/
