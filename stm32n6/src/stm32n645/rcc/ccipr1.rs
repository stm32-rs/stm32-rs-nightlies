...
impl W {
    ///Bits 0:2 - Source selection for the ADF1 kernel clock
    #[inline(always)]
    pub fn adf1sel(&mut self) -> ADF1SEL_W<CCIPR1rs> {
        ADF1SEL_W::new(self, 0)
    }
    ///Bits 4:6 - Source selection for the ADC12 kernel clock
    #[inline(always)]
    pub fn adc12sel(&mut self) -> ADC12SEL_W<CCIPR1rs> {
        ADC12SEL_W::new(self, 4)
    }
    ///Bits 8:15 - ADC12 Prog clock divider selection (for clock ck_icn_p_adf1)
    #[inline(always)]
    pub fn adcpre(&mut self) -> ADCPRE_W<CCIPR1rs> {
        ADCPRE_W::new(self, 8)
    }
    ///Bits 20:21 - Source selection for the DCMIPP kernel clock
    #[inline(always)]
    pub fn dcmippsel(&mut self) -> DCMIPPSEL_W<CCIPR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:CCIPR1)*/
pub struct CCIPR1rs;
