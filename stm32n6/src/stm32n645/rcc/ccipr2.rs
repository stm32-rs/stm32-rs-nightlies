...
impl W {
    ///Bits 0:1 - Source selection for the ETH1 kernel clock
    #[inline(always)]
    pub fn eth1ptpsel(&mut self) -> ETH1PTPSEL_W<CCIPR2rs> {
        ETH1PTPSEL_W::new(self, 0)
    }
    ///Bits 4:7 - ETH1 Kernel clock divider selection (for clock ck_ker_eth1ptp)
    #[inline(always)]
    pub fn eth1ptpdiv(&mut self) -> ETH1PTPDIV_W<CCIPR2rs> {
        ETH1PTPDIV_W::new(self, 4)
    }
    ///Bits 12:13 - Source selection for the ETH1 kernel clock
    #[inline(always)]
    pub fn eth1clksel(&mut self) -> ETH1CLKSEL_W<CCIPR2rs> {
        ETH1CLKSEL_W::new(self, 12)
    }
    ///Bits 16:18 - Set and reset by software
    #[inline(always)]
    pub fn eth1sel(&mut self) -> ETH1SEL_W<CCIPR2rs> {
        ETH1SEL_W::new(self, 16)
    }
    ///Bit 20 - Set and reset by software
    #[inline(always)]
    pub fn eth1refclksel(&mut self) -> ETH1REFCLKSEL_W<CCIPR2rs> {
        ETH1REFCLKSEL_W::new(self, 20)
    }
    ///Bit 24 - Set and reset by software.
    #[inline(always)]
    pub fn eth1gtxclksel(&mut self) -> ETH1GTXCLKSEL_W<CCIPR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:CCIPR2)*/
pub struct CCIPR2rs;
