...
impl W {
    ///Bits 0:1 - Source selection for the SDMMC1 kernel clock
    #[inline(always)]
    pub fn sdmmc1sel(&mut self) -> SDMMC1SEL_W<CCIPR8rs> {
        SDMMC1SEL_W::new(self, 0)
    }
    ///Bits 4:5 - Source selection for the SDMMC2 kernel clock
    #[inline(always)]
    pub fn sdmmc2sel(&mut self) -> SDMMC2SEL_W<CCIPR8rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:CCIPR8)*/
pub struct CCIPR8rs;
