...
impl W {
    ///Bits 0:2 - Source selection for the SPDIFRX1 kernel clock
    #[inline(always)]
    pub fn spdifrx1sel(&mut self) -> SPDIFRX1SEL_W<CCIPR9rs> {
        SPDIFRX1SEL_W::new(self, 0)
    }
    ///Bits 4:6 - Source selection for the SPI1 kernel clock
    #[inline(always)]
    pub fn spi1sel(&mut self) -> SPI1SEL_W<CCIPR9rs> {
        SPI1SEL_W::new(self, 4)
    }
    ///Bits 8:10 - Source selection for the SPI2 kernel clock
    #[inline(always)]
    pub fn spi2sel(&mut self) -> SPI2SEL_W<CCIPR9rs> {
        SPI2SEL_W::new(self, 8)
    }
    ///Bits 12:14 - Source selection for the SPI3 kernel clock
    #[inline(always)]
    pub fn spi3sel(&mut self) -> SPI3SEL_W<CCIPR9rs> {
        SPI3SEL_W::new(self, 12)
    }
    ///Bits 16:18 - Source selection for the SPI4 kernel clock
    #[inline(always)]
    pub fn spi4sel(&mut self) -> SPI4SEL_W<CCIPR9rs> {
        SPI4SEL_W::new(self, 16)
    }
    ///Bits 20:22 - Source selection for the SPI5 kernel clock
    #[inline(always)]
    pub fn spi5sel(&mut self) -> SPI5SEL_W<CCIPR9rs> {
        SPI5SEL_W::new(self, 20)
    }
    ///Bits 24:26 - Source selection for the SPI6 kernel clock
    #[inline(always)]
    pub fn spi6sel(&mut self) -> SPI6SEL_W<CCIPR9rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:CCIPR9)*/
pub struct CCIPR9rs;
