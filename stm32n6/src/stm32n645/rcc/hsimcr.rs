...
impl W {
    ///Bits 0:10 - HSI clock cycle counter reference value.
    #[inline(always)]
    pub fn hsiref(&mut self) -> HSIREF_W<HSIMCRrs> {
        HSIREF_W::new(self, 0)
    }
    ///Bits 16:21 - HSI clock count deviation value
    #[inline(always)]
    pub fn hsidev(&mut self) -> HSIDEV_W<HSIMCRrs> {
        HSIDEV_W::new(self, 16)
    }
    ///Bit 31 - HSI clock period monitor enable
    #[inline(always)]
    pub fn hsimonen(&mut self) -> HSIMONEN_W<HSIMCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:HSIMCR)*/
pub struct HSIMCRrs;
