...
impl W {
    ///Bits 16:23 - Divider IC11 integer division factor
    #[inline(always)]
    pub fn ic11int(&mut self) -> IC11INT_W<IC11CFGRrs> {
        IC11INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC11 Source Selection
    #[inline(always)]
    pub fn ic11sel(&mut self) -> IC11SEL_W<IC11CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:IC11CFGR)*/
