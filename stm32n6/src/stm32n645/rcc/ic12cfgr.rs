...
impl W {
    ///Bits 16:23 - Divider IC12 integer division factor
    #[inline(always)]
    pub fn ic12int(&mut self) -> IC12INT_W<IC12CFGRrs> {
        IC12INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC12 Source Selection
    #[inline(always)]
    pub fn ic12sel(&mut self) -> IC12SEL_W<IC12CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:IC12CFGR)*/
