...
impl W {
    ///Bits 16:23 - Divider IC15 integer division factor
    #[inline(always)]
    pub fn ic15int(&mut self) -> IC15INT_W<IC15CFGRrs> {
        IC15INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC15 Source Selection
    #[inline(always)]
    pub fn ic15sel(&mut self) -> IC15SEL_W<IC15CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:IC15CFGR)*/
