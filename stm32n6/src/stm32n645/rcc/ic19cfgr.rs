...
impl W {
    ///Bits 16:23 - Divider IC19 integer division factor
    #[inline(always)]
    pub fn ic19int(&mut self) -> IC19INT_W<IC19CFGRrs> {
        IC19INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC19 Source Selection
    #[inline(always)]
    pub fn ic19sel(&mut self) -> IC19SEL_W<IC19CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:IC19CFGR)*/
