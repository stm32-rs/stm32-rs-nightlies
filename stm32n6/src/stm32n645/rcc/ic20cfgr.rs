...
impl W {
    ///Bits 16:23 - Divider IC20 integer division factor
    #[inline(always)]
    pub fn ic20int(&mut self) -> IC20INT_W<IC20CFGRrs> {
        IC20INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC20 Source Selection
    #[inline(always)]
    pub fn ic20sel(&mut self) -> IC20SEL_W<IC20CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:IC20CFGR)*/
