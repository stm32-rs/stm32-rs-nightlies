...
impl W {
    ///Bit 0 - AXISRAM3 sleep enable
    #[inline(always)]
    pub fn axisram3lpen(&mut self) -> AXISRAM3LPEN_W<MEMLPENRrs> {
        AXISRAM3LPEN_W::new(self, 0)
    }
    ///Bit 1 - AXISRAM4 sleep enable
    #[inline(always)]
    pub fn axisram4lpen(&mut self) -> AXISRAM4LPEN_W<MEMLPENRrs> {
        AXISRAM4LPEN_W::new(self, 1)
    }
    ///Bit 2 - AXISRAM5 sleep enable
    #[inline(always)]
    pub fn axisram5lpen(&mut self) -> AXISRAM5LPEN_W<MEMLPENRrs> {
        AXISRAM5LPEN_W::new(self, 2)
    }
    ///Bit 3 - AXISRAM6 sleep enable
    #[inline(always)]
    pub fn axisram6lpen(&mut self) -> AXISRAM6LPEN_W<MEMLPENRrs> {
        AXISRAM6LPEN_W::new(self, 3)
    }
    ///Bit 4 - AHBSRAM1 sleep enable
    #[inline(always)]
    pub fn ahbsram1lpen(&mut self) -> AHBSRAM1LPEN_W<MEMLPENRrs> {
        AHBSRAM1LPEN_W::new(self, 4)
    }
    ///Bit 5 - AHBSRAM2 sleep enable
    #[inline(always)]
    pub fn ahbsram2lpen(&mut self) -> AHBSRAM2LPEN_W<MEMLPENRrs> {
        AHBSRAM2LPEN_W::new(self, 5)
    }
    ///Bit 6 - BKPSRAM sleep enable
    #[inline(always)]
    pub fn bkpsramlpen(&mut self) -> BKPSRAMLPEN_W<MEMLPENRrs> {
        BKPSRAMLPEN_W::new(self, 6)
    }
    ///Bit 7 - AXISRAM1 sleep enable
    #[inline(always)]
    pub fn axisram1lpen(&mut self) -> AXISRAM1LPEN_W<MEMLPENRrs> {
        AXISRAM1LPEN_W::new(self, 7)
    }
    ///Bit 8 - AXISRAM2 sleep enable
    #[inline(always)]
    pub fn axisram2lpen(&mut self) -> AXISRAM2LPEN_W<MEMLPENRrs> {
        AXISRAM2LPEN_W::new(self, 8)
    }
    ///Bit 9 - FLEXRAM sleep enable
    #[inline(always)]
    pub fn flexramlpen(&mut self) -> FLEXRAMLPEN_W<MEMLPENRrs> {
        FLEXRAMLPEN_W::new(self, 9)
    }
    ///Bit 10 - NPUCACHERAM sleep enable
    #[inline(always)]
    pub fn npucacheramlpen(&mut self) -> NPUCACHERAMLPEN_W<MEMLPENRrs> {
        NPUCACHERAMLPEN_W::new(self, 10)
    }
    ///Bit 11 - VENCRAM sleep enable
    #[inline(always)]
    pub fn vencramlpen(&mut self) -> VENCRAMLPEN_W<MEMLPENRrs> {
        VENCRAMLPEN_W::new(self, 11)
    }
    ///Bit 12 - BOOTROM sleep enable
    #[inline(always)]
    pub fn bootromlpen(&mut self) -> BOOTROMLPEN_W<MEMLPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:MEMLPENR)*/
