...
impl W {
    ///Bit 0 - DBG enable
    #[inline(always)]
    pub fn dbgen(&mut self) -> DBGEN_W<MISCENRrs> {
        DBGEN_W::new(self, 0)
    }
    ///Bit 1 - MCO1 enable
    #[inline(always)]
    pub fn mco1en(&mut self) -> MCO1EN_W<MISCENRrs> {
        MCO1EN_W::new(self, 1)
    }
    ///Bit 2 - MCO2 enable
    #[inline(always)]
    pub fn mco2en(&mut self) -> MCO2EN_W<MISCENRrs> {
        MCO2EN_W::new(self, 2)
    }
    ///Bit 3 - XSPIPHYCOMP enable
    #[inline(always)]
    pub fn xspiphycompen(&mut self) -> XSPIPHYCOMPEN_W<MISCENRrs> {
        XSPIPHYCOMPEN_W::new(self, 3)
    }
    ///Bit 6 - PER enable
    #[inline(always)]
    pub fn peren(&mut self) -> PEREN_W<MISCENRrs> {
        PEREN_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:MISCENR)*/
