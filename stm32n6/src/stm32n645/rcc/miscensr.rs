...
impl W {
    ///Bit 0 - DBG enable
    #[inline(always)]
    pub fn dbgens(&mut self) -> DBGENS_W<MISCENSRrs> {
        DBGENS_W::new(self, 0)
    }
    ///Bit 1 - MCO1 enable
    #[inline(always)]
    pub fn mco1ens(&mut self) -> MCO1ENS_W<MISCENSRrs> {
        MCO1ENS_W::new(self, 1)
    }
    ///Bit 2 - MCO2 enable
    #[inline(always)]
    pub fn mco2ens(&mut self) -> MCO2ENS_W<MISCENSRrs> {
        MCO2ENS_W::new(self, 2)
    }
    ///Bit 3 - XSPIPHYCOMP enable
    #[inline(always)]
    pub fn xspiphycompens(&mut self) -> XSPIPHYCOMPENS_W<MISCENSRrs> {
        XSPIPHYCOMPENS_W::new(self, 3)
    }
    ///Bit 6 - PER enable
    #[inline(always)]
    pub fn perens(&mut self) -> PERENS_W<MISCENSRrs> {
        PERENS_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:MISCENSR)*/
