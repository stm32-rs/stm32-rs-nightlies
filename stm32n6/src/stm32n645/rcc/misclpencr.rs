...
impl W {
    ...
    #[inline(always)]
    pub fn dbglpenc(&mut self) -> DBGLPENC_W<MISCLPENCRrs> {
        DBGLPENC_W::new(self, 0)
    }
    ///Bit 3 - XSPIPHYCOMP sleep enable
    #[inline(always)]
    pub fn xspiphycomplpenc(&mut self) -> XSPIPHYCOMPLPENC_W<MISCLPENCRrs> {
        XSPIPHYCOMPLPENC_W::new(self, 3)
    }
    ///Bit 6 - PER sleep enable
    #[inline(always)]
    pub fn perlpenc(&mut self) -> PERLPENC_W<MISCLPENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:MISCLPENCR)*/
