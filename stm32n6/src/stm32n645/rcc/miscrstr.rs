...
impl W {
    ///Bit 0 - DBG reset
    #[inline(always)]
    pub fn dbgrst(&mut self) -> DBGRST_W<MISCRSTRrs> {
        DBGRST_W::new(self, 0)
    }
    ///Bit 4 - XSPIPHY1 reset
    #[inline(always)]
    pub fn xspiphy1rst(&mut self) -> XSPIPHY1RST_W<MISCRSTRrs> {
        XSPIPHY1RST_W::new(self, 4)
    }
    ///Bit 5 - XSPIPHY2 reset
    #[inline(always)]
    pub fn xspiphy2rst(&mut self) -> XSPIPHY2RST_W<MISCRSTRrs> {
        XSPIPHY2RST_W::new(self, 5)
    }
    ///Bit 7 - SDMMC1DLL reset
    #[inline(always)]
    pub fn sdmmc1dllrst(&mut self) -> SDMMC1DLLRST_W<MISCRSTRrs> {
        SDMMC1DLLRST_W::new(self, 7)
    }
    ///Bit 8 - SDMMC2DLL reset
    #[inline(always)]
    pub fn sdmmc2dllrst(&mut self) -> SDMMC2DLLRST_W<MISCRSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:MISCRSTR)*/
