...
impl W {
    ///Bit 0 - DBG reset
    #[inline(always)]
    pub fn dbgrsts(&mut self) -> DBGRSTS_W<MISCRSTSRrs> {
        DBGRSTS_W::new(self, 0)
    }
    ///Bit 4 - XSPIPHY1 reset
    #[inline(always)]
    pub fn xspiphy1rsts(&mut self) -> XSPIPHY1RSTS_W<MISCRSTSRrs> {
        XSPIPHY1RSTS_W::new(self, 4)
    }
    ///Bit 5 - XSPIPHY2 reset
    #[inline(always)]
    pub fn xspiphy2rsts(&mut self) -> XSPIPHY2RSTS_W<MISCRSTSRrs> {
        XSPIPHY2RSTS_W::new(self, 5)
    }
    ///Bit 7 - SDMMC1DLL reset
    #[inline(always)]
    pub fn sdmmc1dllrsts(&mut self) -> SDMMC1DLLRSTS_W<MISCRSTSRrs> {
        SDMMC1DLLRSTS_W::new(self, 7)
    }
    ///Bit 8 - SDMMC2DLL reset
    #[inline(always)]
    pub fn sdmmc2dllrsts(&mut self) -> SDMMC2DLLRSTS_W<MISCRSTSRrs> {
