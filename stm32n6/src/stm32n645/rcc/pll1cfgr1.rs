...
impl W {
    ///Bits 8:19 - PLL1 Integer part for the VCO multiplication factor
    #[inline(always)]
    pub fn pll1divn(&mut self) -> PLL1DIVN_W<PLL1CFGR1rs> {
        PLL1DIVN_W::new(self, 8)
    }
    ///Bits 20:25 - PLL1 reference input clock divide frequency ratio
    #[inline(always)]
    pub fn pll1divm(&mut self) -> PLL1DIVM_W<PLL1CFGR1rs> {
        PLL1DIVM_W::new(self, 20)
    }
    ///Bit 27 - PLL1 bypass
    #[inline(always)]
    pub fn pll1byp(&mut self) -> PLL1BYP_W<PLL1CFGR1rs> {
        PLL1BYP_W::new(self, 27)
    }
    ///Bits 28:30 - PLL1 source selection of the reference clock
    #[inline(always)]
    pub fn pll1sel(&mut self) -> PLL1SEL_W<PLL1CFGR1rs> {
