...
impl W {
    ///Bits 8:19 - PLL2 Integer part for the VCO multiplication factor
    #[inline(always)]
    pub fn pll2divn(&mut self) -> PLL2DIVN_W<PLL2CFGR1rs> {
        PLL2DIVN_W::new(self, 8)
    }
    ///Bits 20:25 - PLL2 reference input clock divide frequency ratio
    #[inline(always)]
    pub fn pll2divm(&mut self) -> PLL2DIVM_W<PLL2CFGR1rs> {
        PLL2DIVM_W::new(self, 20)
    }
    ///Bit 27 - PLL2 bypass
    #[inline(always)]
    pub fn pll2byp(&mut self) -> PLL2BYP_W<PLL2CFGR1rs> {
        PLL2BYP_W::new(self, 27)
    }
    ///Bits 28:30 - PLL2 source selection of the reference clock
    #[inline(always)]
    pub fn pll2sel(&mut self) -> PLL2SEL_W<PLL2CFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:PLL2CFGR1)*/
