...
impl W {
    ///Bits 8:19 - PLL4 Integer part for the VCO multiplication factor
    #[inline(always)]
    pub fn pll4divn(&mut self) -> PLL4DIVN_W<PLL4CFGR1rs> {
        PLL4DIVN_W::new(self, 8)
    }
    ///Bits 20:25 - PLL4 reference input clock divide frequency ratio
    #[inline(always)]
    pub fn pll4divm(&mut self) -> PLL4DIVM_W<PLL4CFGR1rs> {
        PLL4DIVM_W::new(self, 20)
    }
    ///Bit 27 - PLL4 bypass
    #[inline(always)]
    pub fn pll4byp(&mut self) -> PLL4BYP_W<PLL4CFGR1rs> {
        PLL4BYP_W::new(self, 27)
    }
    ///Bits 28:30 - PLL4 source selection of the reference clock
    #[inline(always)]
    pub fn pll4sel(&mut self) -> PLL4SEL_W<PLL4CFGR1rs> {
