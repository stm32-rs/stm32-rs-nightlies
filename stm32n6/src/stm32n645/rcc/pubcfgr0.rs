...
impl W {
    ///Bit 0 - Defines the public protection of the LSI oscillator configuration bits.
    #[inline(always)]
    pub fn lsipub(&mut self) -> LSIPUB_W<PUBCFGR0rs> {
        LSIPUB_W::new(self, 0)
    }
    ///Bit 1 - Defines the public protection of the LSE oscillator configuration bits.
    #[inline(always)]
    pub fn lsepub(&mut self) -> LSEPUB_W<PUBCFGR0rs> {
        LSEPUB_W::new(self, 1)
    }
    ///Bit 2 - Defines the public protection of the MSI oscillator configuration bits.
    #[inline(always)]
    pub fn msipub(&mut self) -> MSIPUB_W<PUBCFGR0rs> {
        MSIPUB_W::new(self, 2)
    }
    ///Bit 3 - Defines the public protection of the HSI oscillator configuration bits.
    #[inline(always)]
    pub fn hsipub(&mut self) -> HSIPUB_W<PUBCFGR0rs> {
        HSIPUB_W::new(self, 3)
    }
    ///Bit 4 - Defines the public protection of the HSE oscillator configuration bits.
    #[inline(always)]
    pub fn hsepub(&mut self) -> HSEPUB_W<PUBCFGR0rs> {
        HSEPUB_W::new(self, 4)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:PUBCFGR0)*/
