...
impl W {
    ///Bit 0 - Defines the secure protection of the MOD system configuration bits.
    #[inline(always)]
    pub fn modsec(&mut self) -> MODSEC_W<SECCFGR3rs> {
        MODSEC_W::new(self, 0)
    }
    ///Bit 1 - Defines the secure protection of the SYS system configuration bits.
    #[inline(always)]
    pub fn syssec(&mut self) -> SYSSEC_W<SECCFGR3rs> {
        SYSSEC_W::new(self, 1)
    }
    ///Bit 2 - Defines the secure protection of the BUS system configuration bits.
    #[inline(always)]
    pub fn bussec(&mut self) -> BUSSEC_W<SECCFGR3rs> {
        BUSSEC_W::new(self, 2)
    }
    ///Bit 3 - Defines the secure protection of the PER system configuration bits.
    #[inline(always)]
    pub fn persec(&mut self) -> PERSEC_W<SECCFGR3rs> {
        PERSEC_W::new(self, 3)
    }
    ///Bit 4 - Defines the secure protection of the INT system configuration bits.
    #[inline(always)]
    pub fn intsec(&mut self) -> INTSEC_W<SECCFGR3rs> {
        INTSEC_W::new(self, 4)
    }
    ///Bit 5 - Defines the secure protection of the RST system configuration bits.
    #[inline(always)]
    pub fn rstsec(&mut self) -> RSTSEC_W<SECCFGR3rs> {
        RSTSEC_W::new(self, 5)
    }
    ///Bit 6 - Defines the secure protection of the DFT system configuration bits.
    #[inline(always)]
    pub fn dftsec(&mut self) -> DFTSEC_W<SECCFGR3rs> {
        DFTSEC_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:SECCFGR3)*/
