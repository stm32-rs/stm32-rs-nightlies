...
impl W {
    ///Bit 0 - MSISTOPENS
    #[inline(always)]
    pub fn msistopens(&mut self) -> MSISTOPENS_W<STOPCSRrs> {
        MSISTOPENS_W::new(self, 0)
    }
    ///Bit 1 - HSISTOPENS
    #[inline(always)]
    pub fn hsistopens(&mut self) -> HSISTOPENS_W<STOPCSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RCC:STOPCSR)*/
