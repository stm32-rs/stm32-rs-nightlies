...
impl W {
    ///Bit 0 - security configuration for peripheral 64
    #[inline(always)]
    pub fn sec64(&mut self) -> SEC64_W<'_, RISC_SECCFGR2rs> {
        SEC64_W::new(self, 0)
    }
    ///Bit 1 - security configuration for peripheral 65
    #[inline(always)]
    pub fn sec65(&mut self) -> SEC65_W<'_, RISC_SECCFGR2rs> {
        SEC65_W::new(self, 1)
    }
    ///Bit 2 - security configuration for peripheral 66
    #[inline(always)]
    pub fn sec66(&mut self) -> SEC66_W<'_, RISC_SECCFGR2rs> {
        SEC66_W::new(self, 2)
    }
    ///Bit 3 - security configuration for peripheral 67
    #[inline(always)]
    pub fn sec67(&mut self) -> SEC67_W<'_, RISC_SECCFGR2rs> {
        SEC67_W::new(self, 3)
    }
    ///Bit 4 - security configuration for peripheral 68
    #[inline(always)]
    pub fn sec68(&mut self) -> SEC68_W<'_, RISC_SECCFGR2rs> {
        SEC68_W::new(self, 4)
    }
    ///Bit 5 - security configuration for peripheral 69
    #[inline(always)]
    pub fn sec69(&mut self) -> SEC69_W<'_, RISC_SECCFGR2rs> {
        SEC69_W::new(self, 5)
    }
    ///Bit 6 - security configuration for peripheral 70
    #[inline(always)]
    pub fn sec70(&mut self) -> SEC70_W<'_, RISC_SECCFGR2rs> {
        SEC70_W::new(self, 6)
    }
    ///Bit 7 - security configuration for peripheral 71
    #[inline(always)]
    pub fn sec71(&mut self) -> SEC71_W<'_, RISC_SECCFGR2rs> {
        SEC71_W::new(self, 7)
    }
    ///Bit 8 - security configuration for peripheral 72
    #[inline(always)]
    pub fn sec72(&mut self) -> SEC72_W<'_, RISC_SECCFGR2rs> {
        SEC72_W::new(self, 8)
    }
    ///Bit 9 - security configuration for peripheral 73
    #[inline(always)]
    pub fn sec73(&mut self) -> SEC73_W<'_, RISC_SECCFGR2rs> {
        SEC73_W::new(self, 9)
    }
    ///Bit 10 - security configuration for peripheral 74
    #[inline(always)]
    pub fn sec74(&mut self) -> SEC74_W<'_, RISC_SECCFGR2rs> {
        SEC74_W::new(self, 10)
    }
    ///Bit 11 - security configuration for peripheral 75
    #[inline(always)]
    pub fn sec75(&mut self) -> SEC75_W<'_, RISC_SECCFGR2rs> {
        SEC75_W::new(self, 11)
    }
    ///Bit 12 - security configuration for peripheral 76
    #[inline(always)]
    pub fn sec76(&mut self) -> SEC76_W<'_, RISC_SECCFGR2rs> {
        SEC76_W::new(self, 12)
    }
    ///Bit 13 - security configuration for peripheral 77
    #[inline(always)]
    pub fn sec77(&mut self) -> SEC77_W<'_, RISC_SECCFGR2rs> {
        SEC77_W::new(self, 13)
    }
    ///Bit 14 - security configuration for peripheral 78
    #[inline(always)]
    pub fn sec78(&mut self) -> SEC78_W<'_, RISC_SECCFGR2rs> {
        SEC78_W::new(self, 14)
    }
    ///Bit 15 - security configuration for peripheral 79
    #[inline(always)]
    pub fn sec79(&mut self) -> SEC79_W<'_, RISC_SECCFGR2rs> {
        SEC79_W::new(self, 15)
    }
    ///Bit 16 - security configuration for peripheral 80
    #[inline(always)]
    pub fn sec80(&mut self) -> SEC80_W<'_, RISC_SECCFGR2rs> {
        SEC80_W::new(self, 16)
    }
    ///Bit 17 - security configuration for peripheral 81
    #[inline(always)]
    pub fn sec81(&mut self) -> SEC81_W<'_, RISC_SECCFGR2rs> {
        SEC81_W::new(self, 17)
    }
    ///Bit 18 - security configuration for peripheral 82
    #[inline(always)]
    pub fn sec82(&mut self) -> SEC82_W<'_, RISC_SECCFGR2rs> {
        SEC82_W::new(self, 18)
    }
    ///Bit 19 - security configuration for peripheral 83
    #[inline(always)]
    pub fn sec83(&mut self) -> SEC83_W<'_, RISC_SECCFGR2rs> {
        SEC83_W::new(self, 19)
    }
    ///Bit 20 - security configuration for peripheral 84
    #[inline(always)]
    pub fn sec84(&mut self) -> SEC84_W<'_, RISC_SECCFGR2rs> {
        SEC84_W::new(self, 20)
    }
    ///Bit 21 - security configuration for peripheral 85
    #[inline(always)]
    pub fn sec85(&mut self) -> SEC85_W<'_, RISC_SECCFGR2rs> {
        SEC85_W::new(self, 21)
    }
    ///Bit 22 - security configuration for peripheral 86
    #[inline(always)]
    pub fn sec86(&mut self) -> SEC86_W<'_, RISC_SECCFGR2rs> {
        SEC86_W::new(self, 22)
    }
    ///Bit 23 - security configuration for peripheral 87
    #[inline(always)]
    pub fn sec87(&mut self) -> SEC87_W<'_, RISC_SECCFGR2rs> {
        SEC87_W::new(self, 23)
    }
    ///Bit 24 - security configuration for peripheral 88
    #[inline(always)]
    pub fn sec88(&mut self) -> SEC88_W<'_, RISC_SECCFGR2rs> {
        SEC88_W::new(self, 24)
    }
    ///Bit 25 - security configuration for peripheral 89
    #[inline(always)]
    pub fn sec89(&mut self) -> SEC89_W<'_, RISC_SECCFGR2rs> {
        SEC89_W::new(self, 25)
    }
    ///Bit 26 - security configuration for peripheral 90
    #[inline(always)]
    pub fn sec90(&mut self) -> SEC90_W<'_, RISC_SECCFGR2rs> {
        SEC90_W::new(self, 26)
    }
    ///Bit 27 - security configuration for peripheral 91
    #[inline(always)]
    pub fn sec91(&mut self) -> SEC91_W<'_, RISC_SECCFGR2rs> {
        SEC91_W::new(self, 27)
    }
    ///Bit 28 - security configuration for peripheral 92
    #[inline(always)]
    pub fn sec92(&mut self) -> SEC92_W<'_, RISC_SECCFGR2rs> {
        SEC92_W::new(self, 28)
    }
    ///Bit 29 - security configuration for peripheral 93
    #[inline(always)]
    pub fn sec93(&mut self) -> SEC93_W<'_, RISC_SECCFGR2rs> {
        SEC93_W::new(self, 29)
    }
    ///Bit 30 - security configuration for peripheral 94
    #[inline(always)]
    pub fn sec94(&mut self) -> SEC94_W<'_, RISC_SECCFGR2rs> {
        SEC94_W::new(self, 30)
    }
    ///Bit 31 - security configuration for peripheral 95
    #[inline(always)]
    pub fn sec95(&mut self) -> SEC95_W<'_, RISC_SECCFGR2rs> {
        SEC95_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#RIFSC:RISC_SECCFGR2)*/
