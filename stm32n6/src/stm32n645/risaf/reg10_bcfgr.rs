...
impl W {
    ///Bit 0 - subregion enable
    #[inline(always)]
    pub fn sren(&mut self) -> SREN_W<REG10_BCFGRrs> {
        SREN_W::new(self, 0)
    }
    ///Bit 1 - resource lock
    #[inline(always)]
    pub fn rlock(&mut self) -> RLOCK_W<REG10_BCFGRrs> {
        RLOCK_W::new(self, 1)
    }
    ///Bits 4:6 - subregion CID
    #[inline(always)]
    pub fn srcid(&mut self) -> SRCID_W<REG10_BCFGRrs> {
        SRCID_W::new(self, 4)
    }
    ///Bit 8 - secure subregion
    #[inline(always)]
    pub fn sec(&mut self) -> SEC_W<REG10_BCFGRrs> {
        SEC_W::new(self, 8)
    }
    ///Bit 9 - privileged subregion
    #[inline(always)]
    pub fn priv_(&mut self) -> PRIV_W<REG10_BCFGRrs> {
        PRIV_W::new(self, 9)
    }
    ///Bit 12 - read enable
    #[inline(always)]
    pub fn rden(&mut self) -> RDEN_W<REG10_BCFGRrs> {
        RDEN_W::new(self, 12)
    }
    ///Bit 13 - write enable
    #[inline(always)]
    pub fn wren(&mut self) -> WREN_W<REG10_BCFGRrs> {
        WREN_W::new(self, 13)
    }
}
