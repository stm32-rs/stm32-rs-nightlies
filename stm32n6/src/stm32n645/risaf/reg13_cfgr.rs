...
impl W {
    ///Bit 0 - base region enable
    #[inline(always)]
    pub fn bren(&mut self) -> BREN_W<REG13_CFGRrs> {
        BREN_W::new(self, 0)
    }
    ///Bit 8 - secure region
    #[inline(always)]
    pub fn sec(&mut self) -> SEC_W<REG13_CFGRrs> {
        SEC_W::new(self, 8)
    }
    ///Bit 16 - privileged access for compartment y
    #[inline(always)]
    pub fn privc0(&mut self) -> PRIVC0_W<REG13_CFGRrs> {
        PRIVC0_W::new(self, 16)
    }
    ///Bit 17 - privileged access for compartment y
    #[inline(always)]
    pub fn privc1(&mut self) -> PRIVC1_W<REG13_CFGRrs> {
        PRIVC1_W::new(self, 17)
    }
    ///Bit 18 - privileged access for compartment y
    #[inline(always)]
    pub fn privc2(&mut self) -> PRIVC2_W<REG13_CFGRrs> {
        PRIVC2_W::new(self, 18)
    }
    ///Bit 19 - privileged access for compartment y
    #[inline(always)]
    pub fn privc3(&mut self) -> PRIVC3_W<REG13_CFGRrs> {
        PRIVC3_W::new(self, 19)
    }
    ///Bit 20 - privileged access for compartment y
    #[inline(always)]
    pub fn privc4(&mut self) -> PRIVC4_W<REG13_CFGRrs> {
        PRIVC4_W::new(self, 20)
    }
    ///Bit 21 - privileged access for compartment y
    #[inline(always)]
    pub fn privc5(&mut self) -> PRIVC5_W<REG13_CFGRrs> {
        PRIVC5_W::new(self, 21)
    }
    ///Bit 22 - privileged access for compartment y
    #[inline(always)]
    pub fn privc6(&mut self) -> PRIVC6_W<REG13_CFGRrs> {
        PRIVC6_W::new(self, 22)
    }
    ///Bit 23 - privileged access for compartment y
    #[inline(always)]
    pub fn privc7(&mut self) -> PRIVC7_W<REG13_CFGRrs> {
