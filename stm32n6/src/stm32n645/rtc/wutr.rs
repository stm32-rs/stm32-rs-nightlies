...
///Field `WUT` reader - Wake-up auto-reload value bits
pub type WUT_R = crate::FieldReader<u16>;
///Field `WUT` writer - Wake-up auto-reload value bits
pub type WUT_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `WUTOCLR` reader - Wake-up auto-reload output clear value
pub type WUTOCLR_R = crate::FieldReader<u16>;
///Field `WUTOCLR` writer - Wake-up auto-reload output clear value
