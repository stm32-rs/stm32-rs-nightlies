...
///Field `NEGEDGE` reader - SDMMC_CK dephasing selection bit for data and command
pub type NEGEDGE_R = crate::BitReader;
///Field `NEGEDGE` writer - SDMMC_CK dephasing selection bit for data and command
pub type NEGEDGE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HWFC_EN` reader - Hardware flow control enable
pub type HWFC_EN_R = crate::BitReader;
///Field `HWFC_EN` writer - Hardware flow control enable
...
///Field `BUSSPEED` reader - Bus speed for selection of SDMMC operating modes
pub type BUSSPEED_R = crate::BitReader;
///Field `BUSSPEED` writer - Bus speed for selection of SDMMC operating modes
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#SDMMC1:CLKCR)*/
pub struct CLKCRrs;
