...
///Field `I2SSTD` reader - I less than sup>2 less than /sup>S standard selection
pub type I2SSTD_R = crate::FieldReader;
///Field `I2SSTD` writer - I less than sup>2 less than /sup>S standard selection
...
///Field `I2SDIV` reader - I less than sup>2 less than /sup>S linear prescaler
pub type I2SDIV_R = crate::FieldReader;
///Field `I2SDIV` writer - I less than sup>2 less than /sup>S linear prescaler
...
impl R {
    ...
    ///Bits 4:5 - I less than sup>2 less than /sup>S standard selection
    #[inline(always)]
    ...
    ///Bits 16:23 - I less than sup>2 less than /sup>S linear prescaler
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N645.html#SPI1:I2SCFGR)*/
