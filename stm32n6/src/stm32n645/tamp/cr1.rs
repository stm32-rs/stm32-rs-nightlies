...
///Field `TAMP2E` reader - Tamper detection on TAMP_IN2 enable less than sup>(1) less than /sup>
pub type TAMP2E_R = crate::BitReader;
///Field `TAMP2E` writer - Tamper detection on TAMP_IN2 enable less than sup>(1) less than /sup>
pub type TAMP2E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP3E` reader - Tamper detection on TAMP_IN3 enable less than sup>(1) less than /sup>
pub type TAMP3E_R = crate::BitReader;
///Field `TAMP3E` writer - Tamper detection on TAMP_IN3 enable less than sup>(1) less than /sup>
pub type TAMP3E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP4E` reader - Tamper detection on TAMP_IN4 enable less than sup>(1) less than /sup>
pub type TAMP4E_R = crate::BitReader;
///Field `TAMP4E` writer - Tamper detection on TAMP_IN4 enable less than sup>(1) less than /sup>
pub type TAMP4E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP5E` reader - Tamper detection on TAMP_IN5 enable less than sup>(1) less than /sup>
pub type TAMP5E_R = crate::BitReader;
///Field `TAMP5E` writer - Tamper detection on TAMP_IN5 enable less than sup>(1) less than /sup>
pub type TAMP5E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP6E` reader - Tamper detection on TAMP_IN6 enable less than sup>(1) less than /sup>
pub type TAMP6E_R = crate::BitReader;
///Field `TAMP6E` writer - Tamper detection on TAMP_IN6 enable less than sup>(1) less than /sup>
pub type TAMP6E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP7E` reader - Tamper detection on TAMP_IN7 enable less than sup>(1) less than /sup>
pub type TAMP7E_R = crate::BitReader;
///Field `TAMP7E` writer - Tamper detection on TAMP_IN7 enable less than sup>(1) less than /sup>
...
impl R {
    ...
    ///Bit 1 - Tamper detection on TAMP_IN2 enable less than sup>(1) less than /sup>
    #[inline(always)]
    pub fn tamp2e(&self) -> TAMP2E_R {
        TAMP2E_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Tamper detection on TAMP_IN3 enable less than sup>(1) less than /sup>
    #[inline(always)]
    pub fn tamp3e(&self) -> TAMP3E_R {
        TAMP3E_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Tamper detection on TAMP_IN4 enable less than sup>(1) less than /sup>
    #[inline(always)]
    pub fn tamp4e(&self) -> TAMP4E_R {
        TAMP4E_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Tamper detection on TAMP_IN5 enable less than sup>(1) less than /sup>
    #[inline(always)]
    pub fn tamp5e(&self) -> TAMP5E_R {
        TAMP5E_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Tamper detection on TAMP_IN6 enable less than sup>(1) less than /sup>
    #[inline(always)]
    pub fn tamp6e(&self) -> TAMP6E_R {
        TAMP6E_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Tamper detection on TAMP_IN7 enable less than sup>(1) less than /sup>
    #[inline(always)]
...
impl W {
    ...
    ///Bit 22 - Internal tamper 7 enable
    #[inline(always)]
    pub fn itamp7e(&mut self) -> ITAMP7E_W<'_, CR1rs> {
    ...
    ///Bit 24 - Internal tamper 9 enable
    #[inline(always)]
    pub fn itamp9e(&mut self) -> ITAMP9E_W<'_, CR1rs> {
        ITAMP9E_W::new(self, 24)
    }
    ///Bit 26 - Internal tamper 11 enable
    #[inline(always)]
    pub fn itamp11e(&mut self) -> ITAMP11E_W<'_, CR1rs> {
