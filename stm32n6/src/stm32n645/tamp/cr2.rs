...
///Field `BKBLOCK` reader - Backup registers and device secrets less than sup>(1) less than /sup> access blocked
pub type BKBLOCK_R = crate::BitReader;
///Field `BKBLOCK` writer - Backup registers and device secrets less than sup>(1) less than /sup> access blocked
pub type BKBLOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BKERASE` writer - Backup registers and device secrets less than sup>(1) less than /sup> erase
...
impl R {
    ...
    ///Bit 22 - Backup registers and device secrets less than sup>(1) less than /sup> access blocked
    #[inline(always)]
...
impl W {
    ...
    ///Bit 23 - Backup registers and device secrets less than sup>(1) less than /sup> erase
    #[inline(always)]
