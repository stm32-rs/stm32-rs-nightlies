...
///Field `BSYENDIE` reader - interrupt enable on busy end
pub type BSYENDIE_R = crate::BitReader;
///Field `BSYENDIE` writer - interrupt enable on busy end
pub type BSYENDIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ERRIE` reader - interrupt enable on cache error
pub type ERRIE_R = crate::BitReader;
///Field `ERRIE` writer - interrupt enable on cache error
pub type ERRIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CMDENDIE` reader - interrupt enable on command end
pub type CMDENDIE_R = crate::BitReader;
///Field `CMDENDIE` writer - interrupt enable on command end
...
impl W {
    ...
    ///Bit 4 - interrupt enable on command end
    #[inline(always)]
    pub fn cmdendie(&mut self) -> CMDENDIE_W<'_, IERrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#CACHEAXI:IER)*/
pub struct IERrs;
