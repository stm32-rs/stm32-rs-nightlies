...
impl W {
    ///Bits 0:15 - Byte counter
    #[inline(always)]
    pub fn bytecnt(&mut self) -> BYTECNT_W<LB0CFGRrs> {
        BYTECNT_W::new(self, 0)
    }
    ///Bits 16:31 - Line counter
    #[inline(always)]
    pub fn linecnt(&mut self) -> LINECNT_W<LB0CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#CSI:LB0CFGR)*/
