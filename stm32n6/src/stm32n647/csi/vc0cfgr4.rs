...
impl W {
    ///Bits 0:5 - Data type 5 class selection for virtual channel x
    #[inline(always)]
    pub fn dt5(&mut self) -> DT5_W<VC0CFGR4rs> {
        DT5_W::new(self, 0)
    }
    ///Bits 8:12 - Data type 5 format
    #[inline(always)]
    pub fn dt5ft(&mut self) -> DT5FT_W<VC0CFGR4rs> {
        DT5FT_W::new(self, 8)
    }
    ///Bits 16:21 - Data type 6 class selection for virtual channel x
    #[inline(always)]
    pub fn dt6(&mut self) -> DT6_W<VC0CFGR4rs> {
        DT6_W::new(self, 16)
    }
    ///Bits 24:28 - Data type 6 format
    #[inline(always)]
    pub fn dt6ft(&mut self) -> DT6FT_W<VC0CFGR4rs> {
        DT6FT_W::new(self, 24)
    }
}
