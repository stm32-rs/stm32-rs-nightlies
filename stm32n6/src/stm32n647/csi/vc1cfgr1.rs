///Register `VC1CFGR1` reader
pub type R = crate::R<VC1CFGR1rs>;
///Register `VC1CFGR1` writer
pub type W = crate::W<VC1CFGR1rs>;
...
impl W {
    ///Bit 0 - All data types enable for the virtual channel x
    #[inline(always)]
    pub fn alldt(&mut self) -> ALLDT_W<'_, VC1CFGR1rs> {
        ALLDT_W::new(self, 0)
    }
    ///Bit 1 - Data type 0 enable
    #[inline(always)]
    pub fn dt0en(&mut self) -> DT0EN_W<'_, VC1CFGR1rs> {
        DT0EN_W::new(self, 1)
    }
    ///Bit 2 - Data type 1 enable
    #[inline(always)]
    pub fn dt1en(&mut self) -> DT1EN_W<'_, VC1CFGR1rs> {
        DT1EN_W::new(self, 2)
    }
    ///Bit 3 - Data type 2 enable
    #[inline(always)]
    pub fn dt2en(&mut self) -> DT2EN_W<'_, VC1CFGR1rs> {
        DT2EN_W::new(self, 3)
    }
    ///Bit 4 - Data type 3 enable
    #[inline(always)]
    pub fn dt3en(&mut self) -> DT3EN_W<'_, VC1CFGR1rs> {
        DT3EN_W::new(self, 4)
    }
    ///Bit 5 - Data type 4 enable
    #[inline(always)]
    pub fn dt4en(&mut self) -> DT4EN_W<'_, VC1CFGR1rs> {
        DT4EN_W::new(self, 5)
    }
    ///Bit 6 - Data type 5 enable
    #[inline(always)]
    pub fn dt5en(&mut self) -> DT5EN_W<'_, VC1CFGR1rs> {
        DT5EN_W::new(self, 6)
    }
    ///Bit 7 - Data type 6 enable
    #[inline(always)]
    pub fn dt6en(&mut self) -> DT6EN_W<'_, VC1CFGR1rs> {
        DT6EN_W::new(self, 7)
    }
    ///Bits 8:12 - Common format for all data types
    #[inline(always)]
    pub fn cdtft(&mut self) -> CDTFT_W<'_, VC1CFGR1rs> {
        CDTFT_W::new(self, 8)
    }
    ///Bits 16:21 - Data type 0 class selection for virtual channel x
    #[inline(always)]
    pub fn dt0(&mut self) -> DT0_W<'_, VC1CFGR1rs> {
        DT0_W::new(self, 16)
    }
    ///Bits 24:28 - Data type 0 format
    #[inline(always)]
    pub fn dt0ft(&mut self) -> DT0FT_W<'_, VC1CFGR1rs> {
        DT0FT_W::new(self, 24)
    }
}
/**CSI-2 Host virtual channel 1 configuration register 1

You can [`read`](crate::Reg::read) this register and get [`vc1cfgr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vc1cfgr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#CSI:VC1CFGR1)*/
pub struct VC1CFGR1rs;
impl crate::RegisterSpec for VC1CFGR1rs {
    type Ux = u32;
}
///`read()` method returns [`vc1cfgr1::R`](R) reader structure
impl crate::Readable for VC1CFGR1rs {}
///`write(|w| ..)` method takes [`vc1cfgr1::W`](W) writer structure
impl crate::Writable for VC1CFGR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets VC1CFGR1 to value 0
impl crate::Resettable for VC1CFGR1rs {}
