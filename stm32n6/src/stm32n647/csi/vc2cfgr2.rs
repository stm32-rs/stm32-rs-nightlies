...
impl W {
    ///Bits 0:5 - Data type 1 class selection for virtual channel x
    #[inline(always)]
    pub fn dt1(&mut self) -> DT1_W<VC2CFGR2rs> {
        DT1_W::new(self, 0)
    }
    ///Bits 8:12 - Data type 1 format
    #[inline(always)]
    pub fn dt1ft(&mut self) -> DT1FT_W<VC2CFGR2rs> {
        DT1FT_W::new(self, 8)
    }
    ///Bits 16:21 - Data type 2 class selection for virtual channel x
    #[inline(always)]
    pub fn dt2(&mut self) -> DT2_W<VC2CFGR2rs> {
        DT2_W::new(self, 16)
    }
    ///Bits 24:28 - Data type 2 format
    #[inline(always)]
    pub fn dt2ft(&mut self) -> DT2FT_W<VC2CFGR2rs> {
        DT2FT_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#CSI:VC2CFGR2)*/
