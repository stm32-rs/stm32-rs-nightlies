...
impl W {
    ///Bits 0:5 - Data type 3 class selection for virtual channel x
    #[inline(always)]
    pub fn dt3(&mut self) -> DT3_W<VC3CFGR3rs> {
        DT3_W::new(self, 0)
    }
    ///Bits 8:12 - Data type 3 format
    #[inline(always)]
    pub fn dt3ft(&mut self) -> DT3FT_W<VC3CFGR3rs> {
        DT3FT_W::new(self, 8)
    }
    ///Bits 16:21 - Data type 4 class selection for virtual channel x
    #[inline(always)]
    pub fn dt4(&mut self) -> DT4_W<VC3CFGR3rs> {
        DT4_W::new(self, 16)
    }
    ///Bits 24:28 - Data type 4 format
    #[inline(always)]
    pub fn dt4ft(&mut self) -> DT4FT_W<VC3CFGR3rs> {
        DT4FT_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#CSI:VC3CFGR3)*/
