///Register `VC3CFGR4` reader
pub type R = crate::R<VC3CFGR4rs>;
///Register `VC3CFGR4` writer
pub type W = crate::W<VC3CFGR4rs>;
...
impl W {
    ///Bits 0:5 - Data type 5 class selection for virtual channel x
    #[inline(always)]
    pub fn dt5(&mut self) -> DT5_W<'_, VC3CFGR4rs> {
        DT5_W::new(self, 0)
    }
    ///Bits 8:12 - Data type 5 format
    #[inline(always)]
    pub fn dt5ft(&mut self) -> DT5FT_W<'_, VC3CFGR4rs> {
        DT5FT_W::new(self, 8)
    }
    ///Bits 16:21 - Data type 6 class selection for virtual channel x
    #[inline(always)]
    pub fn dt6(&mut self) -> DT6_W<'_, VC3CFGR4rs> {
        DT6_W::new(self, 16)
    }
    ///Bits 24:28 - Data type 6 format
    #[inline(always)]
    pub fn dt6ft(&mut self) -> DT6FT_W<'_, VC3CFGR4rs> {
        DT6FT_W::new(self, 24)
    }
}
/**CSI-2 Host virtual channel 3 configuration register 4

You can [`read`](crate::Reg::read) this register and get [`vc3cfgr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vc3cfgr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#CSI:VC3CFGR4)*/
pub struct VC3CFGR4rs;
impl crate::RegisterSpec for VC3CFGR4rs {
    type Ux = u32;
}
///`read()` method returns [`vc3cfgr4::R`](R) reader structure
impl crate::Readable for VC3CFGR4rs {}
///`write(|w| ..)` method takes [`vc3cfgr4::W`](W) writer structure
impl crate::Writable for VC3CFGR4rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets VC3CFGR4 to value 0
impl crate::Resettable for VC3CFGR4rs {}
