...
impl W {
    ///Bit 0 - TIM2 stop in debug
    #[inline(always)]
    pub fn dbg_tim2_stop(&mut self) -> DBG_TIM2_STOP_W<APB1LFZ1rs> {
        DBG_TIM2_STOP_W::new(self, 0)
    }
    ///Bit 1 - TIM3 stop in debug
    #[inline(always)]
    pub fn dbg_tim3_stop(&mut self) -> DBG_TIM3_STOP_W<APB1LFZ1rs> {
        DBG_TIM3_STOP_W::new(self, 1)
    }
    ///Bit 2 - TIM4 stop in debug
    #[inline(always)]
    pub fn dbg_tim4_stop(&mut self) -> DBG_TIM4_STOP_W<APB1LFZ1rs> {
        DBG_TIM4_STOP_W::new(self, 2)
    }
    ///Bit 3 - TIM5 stop in debug
    #[inline(always)]
    pub fn dbg_tim5_stop(&mut self) -> DBG_TIM5_STOP_W<APB1LFZ1rs> {
        DBG_TIM5_STOP_W::new(self, 3)
    }
    ///Bit 4 - TIM6 stop in debug
    #[inline(always)]
    pub fn dbg_tim6_stop(&mut self) -> DBG_TIM6_STOP_W<APB1LFZ1rs> {
        DBG_TIM6_STOP_W::new(self, 4)
    }
    ///Bit 5 - TIM7 stop in debug
    #[inline(always)]
    pub fn dbg_tim7_stop(&mut self) -> DBG_TIM7_STOP_W<APB1LFZ1rs> {
        DBG_TIM7_STOP_W::new(self, 5)
    }
    ///Bit 6 - TIM12 stop in debug
    #[inline(always)]
    pub fn dbg_tim12_stop(&mut self) -> DBG_TIM12_STOP_W<APB1LFZ1rs> {
        DBG_TIM12_STOP_W::new(self, 6)
    }
    ///Bit 7 - TIM13 stop in debug
    #[inline(always)]
    pub fn dbg_tim13_stop(&mut self) -> DBG_TIM13_STOP_W<APB1LFZ1rs> {
        DBG_TIM13_STOP_W::new(self, 7)
    }
    ///Bit 8 - TIM14 stop in debug
    #[inline(always)]
    pub fn dbg_tim14_stop(&mut self) -> DBG_TIM14_STOP_W<APB1LFZ1rs> {
        DBG_TIM14_STOP_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1 stop in debug
    #[inline(always)]
    pub fn dbg_lptim1_stop(&mut self) -> DBG_LPTIM1_STOP_W<APB1LFZ1rs> {
        DBG_LPTIM1_STOP_W::new(self, 9)
    }
    ///Bit 11 - WWDG1 stop in debug
    #[inline(always)]
    pub fn dbg_wwdg1_stop(&mut self) -> DBG_WWDG1_STOP_W<APB1LFZ1rs> {
        DBG_WWDG1_STOP_W::new(self, 11)
    }
    ///Bit 12 - TIM10 stop in debug
    #[inline(always)]
    pub fn dbg_tim10_stop(&mut self) -> DBG_TIM10_STOP_W<APB1LFZ1rs> {
        DBG_TIM10_STOP_W::new(self, 12)
    }
    ///Bit 13 - TIM11 stop in debug
    #[inline(always)]
    pub fn dbg_tim11_stop(&mut self) -> DBG_TIM11_STOP_W<APB1LFZ1rs> {
        DBG_TIM11_STOP_W::new(self, 13)
    }
    ///Bit 21 - I2C1 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c1_stop(&mut self) -> DBG_I2C1_STOP_W<APB1LFZ1rs> {
        DBG_I2C1_STOP_W::new(self, 21)
    }
    ///Bit 22 - I2C2 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c2_stop(&mut self) -> DBG_I2C2_STOP_W<APB1LFZ1rs> {
        DBG_I2C2_STOP_W::new(self, 22)
    }
    ///Bit 23 - I2C3 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c3_stop(&mut self) -> DBG_I2C3_STOP_W<APB1LFZ1rs> {
        DBG_I2C3_STOP_W::new(self, 23)
    }
    ///Bit 24 - I3C1 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i3c1_stop(&mut self) -> DBG_I3C1_STOP_W<APB1LFZ1rs> {
        DBG_I3C1_STOP_W::new(self, 24)
    }
    ///Bit 25 - I3C2 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i3c2_stop(&mut self) -> DBG_I3C2_STOP_W<APB1LFZ1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DBGMCU:APB1LFZ1)*/
