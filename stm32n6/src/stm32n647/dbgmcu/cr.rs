...
impl W {
    ...
    ///Bit 20 - Debug clock enable through software
    #[inline(always)]
    pub fn dbgclken(&mut self) -> DBGCLKEN_W<CRrs> {
    ...
    ///Bit 28 - DBTRGIO connection control
    #[inline(always)]
    pub fn dbtrgoen(&mut self) -> DBTRGOEN_W<CRrs> {
        DBTRGOEN_W::new(self, 28)
    }
    ///Bit 31 - TSGEN halt enable
    #[inline(always)]
    pub fn hlt_tsgen_en(&mut self) -> HLT_TSGEN_EN_W<CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DBGMCU:CR)*/
pub struct CRrs;
