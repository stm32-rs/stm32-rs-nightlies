...
impl W {
    ///Bit 0 - input selection
    #[inline(always)]
    pub fn insel(&mut self) -> INSEL_W<CMCRrs> {
        INSEL_W::new(self, 0)
    }
    ///Bits 1:2 - Pipe selection for the frame counter
    #[inline(always)]
    pub fn psfc(&mut self) -> PSFC_W<CMCRrs> {
        PSFC_W::new(self, 1)
    }
    ///Bit 4 - Clear frame counter
    #[inline(always)]
    pub fn cfc(&mut self) -> CFC_W<CMCRrs> {
        CFC_W::new(self, 4)
    }
    ///Bit 7 - Swap R/U and B/V
    #[inline(always)]
    pub fn swaprb(&mut self) -> SWAPRB_W<CMCRrs> {
        SWAPRB_W::new(self, 7)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:CMCR)*/
pub struct CMCRrs;
