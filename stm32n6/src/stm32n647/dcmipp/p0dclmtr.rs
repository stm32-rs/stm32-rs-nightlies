...
impl W {
    ///Bits 0:23 - Maximum number of 32-bit data that can be dumped during a frame, after the crop 2D operation.
    #[inline(always)]
    pub fn limit(&mut self) -> LIMIT_W<P0DCLMTRrs> {
        LIMIT_W::new(self, 0)
    }
    ///Bit 31 - None
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<P0DCLMTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P0DCLMTR)*/
