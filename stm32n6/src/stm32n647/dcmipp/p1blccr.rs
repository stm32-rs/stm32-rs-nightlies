...
impl W {
    ///Bit 0 - Black level calibration
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<P1BLCCRrs> {
        ENABLE_W::new(self, 0)
    }
    ///Bits 8:15 - Black level calibration - Blue
    #[inline(always)]
    pub fn blcb(&mut self) -> BLCB_W<P1BLCCRrs> {
        BLCB_W::new(self, 8)
    }
    ///Bits 16:23 - Black level calibration - Green
    #[inline(always)]
    pub fn blcg(&mut self) -> BLCG_W<P1BLCCRrs> {
        BLCG_W::new(self, 16)
    }
    ///Bits 24:31 - Black level calibration - Red
    #[inline(always)]
    pub fn blcr(&mut self) -> BLCR_W<P1BLCCRrs> {
        BLCR_W::new(self, 24)
    }
}
