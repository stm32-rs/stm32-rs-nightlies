///Register `P1CCRSTR` reader
pub type R = crate::R<P1CCRSTRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`p1ccrstr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P1CCRSTR)*/
pub struct P1CCRSTRrs;
impl crate::RegisterSpec for P1CCRSTRrs {
    type Ux = u32;
}
///`read()` method returns [`p1ccrstr::R`](R) reader structure
impl crate::Readable for P1CCRSTRrs {}
///`reset()` method sets P1CCRSTR to value 0
impl crate::Resettable for P1CCRSTRrs {}
