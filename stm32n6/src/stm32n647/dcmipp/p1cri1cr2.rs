///Register `P1CRI1CR2` reader
pub type R = crate::R<P1CRI1CR2rs>;
...
You can [`read`](crate::Reg::read) this register and get [`p1cri1cr2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P1CRI1CR2)*/
pub struct P1CRI1CR2rs;
impl crate::RegisterSpec for P1CRI1CR2rs {
    type Ux = u32;
}
///`read()` method returns [`p1cri1cr2::R`](R) reader structure
impl crate::Readable for P1CRI1CR2rs {}
///`reset()` method sets P1CRI1CR2 to value 0
impl crate::Resettable for P1CRI1CR2rs {}
