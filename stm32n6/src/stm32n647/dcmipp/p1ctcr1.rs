...
impl W {
    ///Bit 0 - None
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<P1CTCR1rs> {
        ENABLE_W::new(self, 0)
    }
    ///Bits 9:14 - Luminance increase for input luminance of 0 (increase is idle with LUMx = 16)
    #[inline(always)]
    pub fn lum0(&mut self) -> LUM0_W<P1CTCR1rs> {
        LUM0_W::new(self, 9)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P1CTCR1)*/
