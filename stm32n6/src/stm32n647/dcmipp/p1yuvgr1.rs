...
impl W {
    ///Bits 0:10 - Coefficient row 2 column 1 of the matrix
    #[inline(always)]
    pub fn gr(&mut self) -> GR_W<P1YUVGR1rs> {
        GR_W::new(self, 0)
    }
    ///Bits 16:26 - Coefficient row 2 column 2 of the matrix
    #[inline(always)]
    pub fn gg(&mut self) -> GG_W<P1YUVGR1rs> {
        GG_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P1YUVGR1)*/
