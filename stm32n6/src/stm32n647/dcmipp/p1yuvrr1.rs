...
impl W {
    ///Bits 0:10 - Coefficient row 1 column 1 of the matrix
    #[inline(always)]
    pub fn rr(&mut self) -> RR_W<P1YUVRR1rs> {
        RR_W::new(self, 0)
    }
    ///Bits 16:26 - Coefficient row 1 column 2 of the matrix
    #[inline(always)]
    pub fn rg(&mut self) -> RG_W<P1YUVRR1rs> {
        RG_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P1YUVRR1)*/
