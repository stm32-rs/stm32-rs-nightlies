...
impl W {
    ///Bit 0 - None
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<P2CDCCRrs> {
        ENABLE_W::new(self, 0)
    }
    ///Bits 1:2 - Horizontal decimation ratio
    #[inline(always)]
    pub fn hdec(&mut self) -> HDEC_W<P2CDCCRrs> {
        HDEC_W::new(self, 1)
    }
    ///Bits 3:4 - Vertical decimation ratio
    #[inline(always)]
    pub fn vdec(&mut self) -> VDEC_W<P2CDCCRrs> {
        VDEC_W::new(self, 3)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P2CDCCR)*/
