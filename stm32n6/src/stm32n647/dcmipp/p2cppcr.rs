///Register `P2CPPCR` reader
pub type R = crate::R<P2CPPCRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`p2cppcr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P2CPPCR)*/
pub struct P2CPPCRrs;
impl crate::RegisterSpec for P2CPPCRrs {
    type Ux = u32;
}
///`read()` method returns [`p2cppcr::R`](R) reader structure
impl crate::Readable for P2CPPCRrs {}
///`reset()` method sets P2CPPCR to value 0
impl crate::Resettable for P2CPPCRrs {}
