///Register `P2CRI1CR1` reader
pub type R = crate::R<P2CRI1CR1rs>;
...
You can [`read`](crate::Reg::read) this register and get [`p2cri1cr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P2CRI1CR1)*/
pub struct P2CRI1CR1rs;
impl crate::RegisterSpec for P2CRI1CR1rs {
    type Ux = u32;
}
///`read()` method returns [`p2cri1cr1::R`](R) reader structure
impl crate::Readable for P2CRI1CR1rs {}
///`reset()` method sets P2CRI1CR1 to value 0
impl crate::Resettable for P2CRI1CR1rs {}
