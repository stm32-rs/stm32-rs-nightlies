...
impl W {
    ///Bits 0:9 - Horizontal division factor, from 128 (8x) to 1023 (1x)
    #[inline(always)]
    pub fn hdiv(&mut self) -> HDIV_W<P2DSCRrs> {
        HDIV_W::new(self, 0)
    }
    ///Bits 16:25 - Vertical division factor, from 128 (8x) to 1023 (1x)
    #[inline(always)]
    pub fn vdiv(&mut self) -> VDIV_W<P2DSCRrs> {
        VDIV_W::new(self, 16)
    }
    ///Bit 31 - None
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<P2DSCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P2DSCR)*/
pub struct P2DSCRrs;
