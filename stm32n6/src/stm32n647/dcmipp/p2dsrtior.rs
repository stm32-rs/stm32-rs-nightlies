...
impl W {
    ///Bits 0:15 - Horizontal ratio, from 8192 (1x) to 65535 (8x)
    #[inline(always)]
    pub fn hratio(&mut self) -> HRATIO_W<P2DSRTIORrs> {
        HRATIO_W::new(self, 0)
    }
    ///Bits 16:31 - Vertical ratio, from 8192 (1x) to 65535 (8x)
    #[inline(always)]
    pub fn vratio(&mut self) -> VRATIO_W<P2DSRTIORrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P2DSRTIOR)*/
