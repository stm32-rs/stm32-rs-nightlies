...
impl W {
    ///Bits 0:11 - Horizontal start, from 0 to 4094 pixels wide
    #[inline(always)]
    pub fn hstart(&mut self) -> HSTART_W<P2RI5CR1rs> {
        HSTART_W::new(self, 0)
    }
    ///Bits 12:13 - Color line blue
    #[inline(always)]
    pub fn clb(&mut self) -> CLB_W<P2RI5CR1rs> {
        CLB_W::new(self, 12)
    }
    ///Bits 14:15 - Color line green
    #[inline(always)]
    pub fn clg(&mut self) -> CLG_W<P2RI5CR1rs> {
        CLG_W::new(self, 14)
    }
    ///Bits 16:27 - Vertical start, from 0 to 4094 pixels high
    #[inline(always)]
    pub fn vstart(&mut self) -> VSTART_W<P2RI5CR1rs> {
        VSTART_W::new(self, 16)
    }
    ///Bits 28:29 - Color line red
    #[inline(always)]
    pub fn clr(&mut self) -> CLR_W<P2RI5CR1rs> {
        CLR_W::new(self, 28)
    }
}
