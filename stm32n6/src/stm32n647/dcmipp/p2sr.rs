///Register `P2SR` reader
pub type R = crate::R<P2SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`p2sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#DCMIPP:P2SR)*/
pub struct P2SRrs;
impl crate::RegisterSpec for P2SRrs {
    type Ux = u32;
}
///`read()` method returns [`p2sr::R`](R) reader structure
impl crate::Readable for P2SRrs {}
///`reset()` method sets P2SR to value 0
impl crate::Resettable for P2SRrs {}
