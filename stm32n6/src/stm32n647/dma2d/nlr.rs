...
///Field `PL` reader - Pixel per lines per lines of the area to be transferred
pub type PL_R = crate::FieldReader<u16>;
///Field `PL` writer - Pixel per lines per lines of the area to be transferred
...
impl R {
    ...
    ///Bits 16:29 - Pixel per lines per lines of the area to be transferred
    #[inline(always)]
    pub fn pl(&self) -> PL_R {
