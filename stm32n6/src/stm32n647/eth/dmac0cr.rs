...
impl W {
    ///Bits 0:13 - Maximum Segment Size
    #[inline(always)]
    pub fn mss(&mut self) -> MSS_W<'_, DMAC0CRrs> {
        MSS_W::new(self, 0)
    }
    ///Bit 16 - 8xPBL mode
    #[inline(always)]
    pub fn pblx8(&mut self) -> PBLX8_W<'_, DMAC0CRrs> {
        PBLX8_W::new(self, 16)
    }
    ///Bits 18:20 - Descriptor Skip Length
    #[inline(always)]
    pub fn dsl(&mut self) -> DSL_W<'_, DMAC0CRrs> {
        DSL_W::new(self, 18)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:DMAC0CR)*/
