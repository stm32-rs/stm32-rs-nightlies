...
impl W {
    ///Bits 0:7 - Receive Interrupt Watchdog Timer Count
    #[inline(always)]
    pub fn rwt(&mut self) -> RWT_W<DMAC0RXIWTRrs> {
        RWT_W::new(self, 0)
    }
    ///Bits 16:17 - Receive Interrupt Watchdog Timer Count Units
    #[inline(always)]
    pub fn rwtu(&mut self) -> RWTU_W<DMAC0RXIWTRrs> {
        RWTU_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:DMAC0RXIWTR)*/
