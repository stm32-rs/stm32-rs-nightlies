...
impl W {
    ///Bit 0 - Start or Stop Transmission Command
    #[inline(always)]
    pub fn st(&mut self) -> ST_W<DMAC1TXCRrs> {
        ST_W::new(self, 0)
    }
    ///Bit 4 - Operate on Second Packet
    #[inline(always)]
    pub fn osf(&mut self) -> OSF_W<DMAC1TXCRrs> {
        OSF_W::new(self, 4)
    }
    ///Bit 12 - TCP Segmentation Enabled
    #[inline(always)]
    pub fn tse(&mut self) -> TSE_W<DMAC1TXCRrs> {
        TSE_W::new(self, 12)
    }
    ///Bit 15 - Ignore PBL Requirement
    #[inline(always)]
    pub fn ipbl(&mut self) -> IPBL_W<DMAC1TXCRrs> {
        IPBL_W::new(self, 15)
    }
    ///Bits 16:21 - Transmit Programmable Burst Length
    #[inline(always)]
    pub fn txpbl(&mut self) -> TXPBL_W<DMAC1TXCRrs> {
        TXPBL_W::new(self, 16)
    }
    ///Bits 24:27 - Transmit QOS
    #[inline(always)]
    pub fn tqos(&mut self) -> TQOS_W<DMAC1TXCRrs> {
        TQOS_W::new(self, 24)
    }
    ///Bit 28 - Enhanced Descriptor Enable
    #[inline(always)]
    pub fn edse(&mut self) -> EDSE_W<DMAC1TXCRrs> {
        EDSE_W::new(self, 28)
    }
}
