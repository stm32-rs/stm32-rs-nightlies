///Register `DMAC1TXCR` reader
pub type R = crate::R<DMAC1TXCRrs>;
///Register `DMAC1TXCR` writer
pub type W = crate::W<DMAC1TXCRrs>;
...
impl W {
    ///Bit 0 - Start or Stop Transmission Command
    #[inline(always)]
    pub fn st(&mut self) -> ST_W<'_, DMAC1TXCRrs> {
        ST_W::new(self, 0)
    }
    ///Bit 4 - Operate on Second Packet
    #[inline(always)]
    pub fn osf(&mut self) -> OSF_W<'_, DMAC1TXCRrs> {
        OSF_W::new(self, 4)
    }
    ///Bit 12 - TCP Segmentation Enabled
    #[inline(always)]
    pub fn tse(&mut self) -> TSE_W<'_, DMAC1TXCRrs> {
        TSE_W::new(self, 12)
    }
    ///Bit 15 - Ignore PBL Requirement
    #[inline(always)]
    pub fn ipbl(&mut self) -> IPBL_W<'_, DMAC1TXCRrs> {
        IPBL_W::new(self, 15)
    }
    ///Bits 16:21 - Transmit Programmable Burst Length
    #[inline(always)]
    pub fn txpbl(&mut self) -> TXPBL_W<'_, DMAC1TXCRrs> {
        TXPBL_W::new(self, 16)
    }
    ///Bits 24:27 - Transmit QOS
    #[inline(always)]
    pub fn tqos(&mut self) -> TQOS_W<'_, DMAC1TXCRrs> {
        TQOS_W::new(self, 24)
    }
    ///Bit 28 - Enhanced Descriptor Enable
    #[inline(always)]
    pub fn edse(&mut self) -> EDSE_W<'_, DMAC1TXCRrs> {
        EDSE_W::new(self, 28)
    }
}
/**Channel 1 transmit control register

You can [`read`](crate::Reg::read) this register and get [`dmac1txcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmac1txcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:DMAC1TXCR)*/
pub struct DMAC1TXCRrs;
impl crate::RegisterSpec for DMAC1TXCRrs {
    type Ux = u32;
}
///`read()` method returns [`dmac1txcr::R`](R) reader structure
impl crate::Readable for DMAC1TXCRrs {}
///`write(|w| ..)` method takes [`dmac1txcr::W`](W) writer structure
impl crate::Writable for DMAC1TXCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DMAC1TXCR to value 0
impl crate::Resettable for DMAC1TXCRrs {}
