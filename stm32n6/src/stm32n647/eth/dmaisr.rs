...
///Field `DC0IS` reader - DMA Channel 0 Interrupt Status
pub type DC0IS_R = crate::BitReader;
///Field `DC1IS` reader - DMA Channel 1 Interrupt Status
...
impl R {
    ///Bit 0 - DMA Channel 0 Interrupt Status
    #[inline(always)]
    pub fn dc0is(&self) -> DC0IS_R {
        DC0IS_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - DMA Channel 1 Interrupt Status
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:DMAISR)*/
pub struct DMAISRrs;
