...
impl W {
    ///Bits 0:15 - Type field Value
    #[inline(always)]
    pub fn typ(&mut self) -> TYP_W<MAC_TMRQRrs> {
        TYP_W::new(self, 0)
    }
    ///Bits 16:18 - Type Match Rx Queue Number
    #[inline(always)]
    pub fn tmrq(&mut self) -> TMRQ_W<MAC_TMRQRrs> {
        TMRQ_W::new(self, 16)
    }
    ///Bit 20 - Preemption or Express Packet
    #[inline(always)]
    pub fn pfex(&mut self) -> PFEX_W<MAC_TMRQRrs> {
        PFEX_W::new(self, 20)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MAC_TMRQR)*/
