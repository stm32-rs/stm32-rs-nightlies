...
impl W {
    ///Bit 0 - Enable Tx Frame Preemption
    #[inline(always)]
    pub fn efpe(&mut self) -> EFPE_W<MACFPECSRrs> {
        EFPE_W::new(self, 0)
    }
    ///Bit 1 - Send Verify mPacket
    #[inline(always)]
    pub fn sver(&mut self) -> SVER_W<MACFPECSRrs> {
        SVER_W::new(self, 1)
    }
    ///Bit 2 - Send Respond mPacket
    #[inline(always)]
    pub fn srsp(&mut self) -> SRSP_W<MACFPECSRrs> {
        SRSP_W::new(self, 2)
    }
    ///Bit 16 - Received Verify Frame
    #[inline(always)]
    pub fn rver(&mut self) -> RVER_W<MACFPECSRrs> {
        RVER_W::new(self, 16)
    }
    ///Bit 17 - Received Respond Frame
    #[inline(always)]
    pub fn rrsp(&mut self) -> RRSP_W<MACFPECSRrs> {
        RRSP_W::new(self, 17)
    }
    ///Bit 18 - Transmitted Verify Frame
    #[inline(always)]
    pub fn tver(&mut self) -> TVER_W<MACFPECSRrs> {
        TVER_W::new(self, 18)
    }
    ///Bit 19 - Transmitted Respond Frame
    #[inline(always)]
    pub fn trsp(&mut self) -> TRSP_W<MACFPECSRrs> {
        TRSP_W::new(self, 19)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MACFPECSR)*/
