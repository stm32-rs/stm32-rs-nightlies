...
///Field `SPRAM` reader - Single Port RAM Enable
pub type SPRAM_R = crate::BitReader;
...
///Field `RAVSEL` reader - Rx Side Only AV Feature Enable
pub type RAVSEL_R = crate::BitReader;
///Field `POUOST` reader - One Step for PTP over UDP/IP Feature Enable
...
impl R {
    ...
    ///Bit 5 - Single Port RAM Enable
    #[inline(always)]
    pub fn spram(&self) -> SPRAM_R {
        SPRAM_R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    ///Bit 21 - Rx Side Only AV Feature Enable
    #[inline(always)]
    pub fn ravsel(&self) -> RAVSEL_R {
        RAVSEL_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Bit 23 - One Step for PTP over UDP/IP Feature Enable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MACHWF1R)*/
...
///`reset()` method sets MACHWF1R to value 0x1114_1965
impl crate::Resettable for MACHWF1Rrs {
    const RESET_VALUE: u32 = 0x1114_1965;
}
