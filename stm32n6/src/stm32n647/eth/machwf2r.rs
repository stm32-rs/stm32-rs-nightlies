...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MACHWF2R)*/
...
///`reset()` method sets MACHWF2R to value 0x4104_1041
impl crate::Resettable for MACHWF2Rrs {
    const RESET_VALUE: u32 = 0x4104_1041;
}
