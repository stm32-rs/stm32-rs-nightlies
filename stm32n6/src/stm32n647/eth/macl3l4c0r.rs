...
impl W {
    ...
    ///Bit 24 - DMA Channel Number
    #[inline(always)]
    pub fn dmchn0(&mut self) -> DMCHN0_W<MACL3L4C0Rrs> {
        DMCHN0_W::new(self, 24)
    }
    ///Bit 28 - DMA Channel Select Enable
    #[inline(always)]
    pub fn dmchen0(&mut self) -> DMCHEN0_W<MACL3L4C0Rrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MACL3L4C0R)*/
