...
///Field `LPITCSE` reader - LPI Tx Clock Stop Enable
pub type LPITCSE_R = crate::BitReader;
///Field `LPITCSE` writer - LPI Tx Clock Stop Enable
...
impl R {
    ...
    ///Bit 21 - LPI Tx Clock Stop Enable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MACLCSR)*/
