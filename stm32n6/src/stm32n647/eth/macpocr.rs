...
///Field `PDRDIS` reader - Disable Peer Delay Response response generation
pub type PDRDIS_R = crate::BitReader;
///Field `PDRDIS` writer - Disable Peer Delay Response response generation
pub type PDRDIS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    ///Bit 7 - Disable Peer Delay Response response generation
    #[inline(always)]
    pub fn pdrdis(&self) -> PDRDIS_R {
        PDRDIS_R::new(((self.bits >> 7) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 7 - Disable Peer Delay Response response generation
    #[inline(always)]
    pub fn pdrdis(&mut self) -> PDRDIS_W<'_, MACPOCRrs> {
        PDRDIS_W::new(self, 7)
    }
    ///Bits 8:15 - Domain Number
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MACPOCR)*/
