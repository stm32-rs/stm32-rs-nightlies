...
impl W {
    ///Bit 0 - Flow Control Busy or Backpressure Activate
    #[inline(always)]
    pub fn fcb_bpa(&mut self) -> FCB_BPA_W<MACQ0TXFCRrs> {
        FCB_BPA_W::new(self, 0)
    }
    ///Bit 1 - Transmit Flow Control Enable
    #[inline(always)]
    pub fn tfe(&mut self) -> TFE_W<MACQ0TXFCRrs> {
        TFE_W::new(self, 1)
    }
    ///Bits 4:6 - Pause Low Threshold
    #[inline(always)]
    pub fn plt(&mut self) -> PLT_W<MACQ0TXFCRrs> {
        PLT_W::new(self, 4)
    }
    ///Bit 7 - Disable Zero-Quanta Pause
    #[inline(always)]
    pub fn dzpq(&mut self) -> DZPQ_W<MACQ0TXFCRrs> {
        DZPQ_W::new(self, 7)
    }
    ///Bits 16:31 - Pause Time
    #[inline(always)]
    pub fn pt(&mut self) -> PT_W<MACQ0TXFCRrs> {
        PT_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MACQ0TXFCR)*/
