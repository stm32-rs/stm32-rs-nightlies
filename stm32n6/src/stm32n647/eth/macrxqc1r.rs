...
impl W {
    ///Bit 0 - AV Untagged Control Packets Queue
    #[inline(always)]
    pub fn avcpq0(&mut self) -> AVCPQ0_W<MACRXQC1Rrs> {
        AVCPQ0_W::new(self, 0)
    }
    ///Bit 1 - AV Untagged Control Packets Queue
    #[inline(always)]
    pub fn avcpq1(&mut self) -> AVCPQ1_W<MACRXQC1Rrs> {
        AVCPQ1_W::new(self, 1)
    }
    ///Bit 2 - AV Untagged Control Packets Queue
    #[inline(always)]
    pub fn avcpq2(&mut self) -> AVCPQ2_W<MACRXQC1Rrs> {
        AVCPQ2_W::new(self, 2)
    }
    ///Bits 4:6 - PTP Packets Queue
    #[inline(always)]
    pub fn ptpq(&mut self) -> PTPQ_W<MACRXQC1Rrs> {
        PTPQ_W::new(self, 4)
    }
    ///Bits 12:14 - Untagged Packet Queue
    #[inline(always)]
    pub fn upq(&mut self) -> UPQ_W<MACRXQC1Rrs> {
        UPQ_W::new(self, 12)
    }
    ///Bits 16:18 - Multicast and Broadcast Queue
    #[inline(always)]
    pub fn mcbcq(&mut self) -> MCBCQ_W<MACRXQC1Rrs> {
        MCBCQ_W::new(self, 16)
    }
    ///Bit 20 - Multicast and Broadcast Queue Enable
    #[inline(always)]
    pub fn mcbcqen(&mut self) -> MCBCQEN_W<MACRXQC1Rrs> {
        MCBCQEN_W::new(self, 20)
    }
    ///Bit 21 - Tagged AV Control Packets Queuing Enable
    #[inline(always)]
    pub fn tacpqe(&mut self) -> TACPQE_W<MACRXQC1Rrs> {
        TACPQE_W::new(self, 21)
    }
    ///Bits 22:23 - Tagged PTP over Ethernet Packets Queuing Control
    #[inline(always)]
    pub fn tpqc(&mut self) -> TPQC_W<MACRXQC1Rrs> {
        TPQC_W::new(self, 22)
    }
    ///Bit 24 - Frame Preemption Residue Queue
    #[inline(always)]
    pub fn fprq0(&mut self) -> FPRQ0_W<MACRXQC1Rrs> {
        FPRQ0_W::new(self, 24)
    }
    ///Bit 25 - Frame Preemption Residue Queue
    #[inline(always)]
    pub fn fprq1(&mut self) -> FPRQ1_W<MACRXQC1Rrs> {
        FPRQ1_W::new(self, 25)
    }
    ///Bit 26 - Frame Preemption Residue Queue
    #[inline(always)]
    pub fn fprq2(&mut self) -> FPRQ2_W<MACRXQC1Rrs> {
        FPRQ2_W::new(self, 26)
    }
    ///Bit 28 - Overriding MC-BC queue priority select
    #[inline(always)]
    pub fn omcbcq(&mut self) -> OMCBCQ_W<MACRXQC1Rrs> {
        OMCBCQ_W::new(self, 28)
    }
    ///Bit 29 - Type Field Based Rx Queuing Enable
    #[inline(always)]
    pub fn tbrqe(&mut self) -> TBRQE_W<MACRXQC1Rrs> {
        TBRQE_W::new(self, 29)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MACRXQC1R)*/
