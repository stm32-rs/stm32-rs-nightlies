...
///Field `PTGE` reader - Presentation Time Generation Enable
pub type PTGE_R = crate::BitReader;
///Field `PTGE` writer - Presentation Time Generation Enable
pub type PTGE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
///Field `ESTI` reader - External System Time Input
pub type ESTI_R = crate::BitReader;
///Field `ESTI` writer - External System Time Input
pub type ESTI_W<'a, REG> = crate::BitWriter<'a, REG>;
...
///Field `AV8021ASMEN` reader - AV 802.1AS Mode Enable
pub type AV8021ASMEN_R = crate::BitReader;
///Field `AV8021ASMEN` writer - AV 802.1AS Mode Enable
...
impl R {
    ...
    ///Bit 6 - Presentation Time Generation Enable
    #[inline(always)]
    pub fn ptge(&self) -> PTGE_R {
        PTGE_R::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    ///Bit 20 - External System Time Input
    #[inline(always)]
    pub fn esti(&self) -> ESTI_R {
        ESTI_R::new(((self.bits >> 20) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 6 - Presentation Time Generation Enable
    #[inline(always)]
    pub fn ptge(&mut self) -> PTGE_W<'_, MACTSCRrs> {
        PTGE_W::new(self, 6)
    }
    ///Bit 8 - Enable Timestamp for All Packets
    #[inline(always)]
    ...
    ///Bit 20 - External System Time Input
    #[inline(always)]
    pub fn esti(&mut self) -> ESTI_W<'_, MACTSCRrs> {
        ESTI_W::new(self, 20)
    }
    ///Bit 24 - Transmit Timestamp Status Mode
    #[inline(always)]
