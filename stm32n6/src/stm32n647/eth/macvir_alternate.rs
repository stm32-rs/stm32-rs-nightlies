...
impl W {
    ///Bits 0:15 - VLAN Tag for Transmit Packets
    #[inline(always)]
    pub fn vlt(&mut self) -> VLT_W<MACVIR_ALTERNATErs> {
        VLT_W::new(self, 0)
    }
    ///Bit 19 - C-VLAN or S-VLAN
    #[inline(always)]
    pub fn csvl(&mut self) -> CSVL_W<MACVIR_ALTERNATErs> {
        CSVL_W::new(self, 19)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MACVIR_alternate)*/
