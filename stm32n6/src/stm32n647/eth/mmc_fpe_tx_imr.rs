...
impl W {
    ///Bit 0 - MMC Transmit Fragment Counter Interrupt Mask
    #[inline(always)]
    pub fn fcim(&mut self) -> FCIM_W<MMC_FPE_TX_IMRrs> {
        FCIM_W::new(self, 0)
    }
    ///Bit 1 - MMC Transmit Hold Request Counter Interrupt Mask
    #[inline(always)]
    pub fn hrcim(&mut self) -> HRCIM_W<MMC_FPE_TX_IMRrs> {
        HRCIM_W::new(self, 1)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MMC_FPE_TX_IMR)*/
