...
impl W {
    ///Bits 0:2 - Receive Queue Weight
    #[inline(always)]
    pub fn rxq_wegt(&mut self) -> RXQ_WEGT_W<MTLRXQ1CRrs> {
        RXQ_WEGT_W::new(self, 0)
    }
    ///Bit 3 - Receive Queue Packet Arbitration
    #[inline(always)]
    pub fn rxq_frm_arbit(&mut self) -> RXQ_FRM_ARBIT_W<MTLRXQ1CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MTLRXQ1CR)*/
