...
pub type R = crate::R<MTLRXQ1DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mtlrxq1dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MTLRXQ1DR)*/
pub struct MTLRXQ1DRrs;
impl crate::RegisterSpec for MTLRXQ1DRrs {
    type Ux = u32;
}
///`read()` method returns [`mtlrxq1dr::R`](R) reader structure
impl crate::Readable for MTLRXQ1DRrs {}
///`reset()` method sets MTLRXQ1DR to value 0
impl crate::Resettable for MTLRXQ1DRrs {}
