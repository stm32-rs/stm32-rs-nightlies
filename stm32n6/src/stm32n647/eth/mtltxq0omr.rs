...
impl W {
    ///Bit 0 - Flush Transmit Queue
    #[inline(always)]
    pub fn ftq(&mut self) -> FTQ_W<MTLTXQ0OMRrs> {
        FTQ_W::new(self, 0)
    }
    ///Bit 1 - Transmit Store and Forward
    #[inline(always)]
    pub fn tsf(&mut self) -> TSF_W<MTLTXQ0OMRrs> {
        TSF_W::new(self, 1)
    }
    ///Bits 2:3 - Transmit Queue Enable
    #[inline(always)]
    pub fn txqen(&mut self) -> TXQEN_W<MTLTXQ0OMRrs> {
        TXQEN_W::new(self, 2)
    }
    ///Bits 4:6 - Transmit Threshold Control
    #[inline(always)]
    pub fn ttc(&mut self) -> TTC_W<MTLTXQ0OMRrs> {
        TTC_W::new(self, 4)
    }
    ///Bits 16:19 - Transmit queue size
    #[inline(always)]
    pub fn tqs(&mut self) -> TQS_W<MTLTXQ0OMRrs> {
        TQS_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#ETH:MTLTXQ0OMR)*/
