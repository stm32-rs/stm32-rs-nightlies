...
///Field `EXTI8` reader - EXTI8 GPIO port selection.
pub type EXTI8_R = crate::FieldReader;
///Field `EXTI8` writer - EXTI8 GPIO port selection.
pub type EXTI8_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `EXTI9` reader - EXTI9 GPIO port selection.
pub type EXTI9_R = crate::FieldReader;
///Field `EXTI9` writer - EXTI9 GPIO port selection.
pub type EXTI9_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `EXTI10` reader - EXTI10 GPIO port selection.
pub type EXTI10_R = crate::FieldReader;
///Field `EXTI10` writer - EXTI10 GPIO port selection.
pub type EXTI10_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `EXTI11` reader - EXTI11 GPIO port selection.
pub type EXTI11_R = crate::FieldReader;
///Field `EXTI11` writer - EXTI11 GPIO port selection.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#EXTI:EXTICR3)*/
