...
impl W {
    ///Bit 7 - Configurable event input x falling edge pending bit
    #[inline(always)]
    pub fn fpif39(&mut self) -> FPIF39_W<FPR2rs> {
        FPIF39_W::new(self, 7)
    }
    ///Bit 8 - Configurable event input x falling edge pending bit
    #[inline(always)]
    pub fn fpif40(&mut self) -> FPIF40_W<FPR2rs> {
        FPIF40_W::new(self, 8)
    }
    ///Bit 19 - Configurable event input 51 falling edge pending bit
    #[inline(always)]
    pub fn fpif51(&mut self) -> FPIF51_W<FPR2rs> {
        FPIF51_W::new(self, 19)
    }
    ///Bit 22 - Configurable event input 54 falling edge pending bit
    #[inline(always)]
    pub fn fpif54(&mut self) -> FPIF54_W<FPR2rs> {
        FPIF54_W::new(self, 22)
    }
    ///Bit 24 - Configurable event input 56 falling edge pending bit
    #[inline(always)]
    pub fn fpif56(&mut self) -> FPIF56_W<FPR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#EXTI:FPR2)*/
pub struct FPR2rs;
