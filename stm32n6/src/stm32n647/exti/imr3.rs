...
impl W {
    ///Bit 0 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im64(&mut self) -> IM64_W<IMR3rs> {
        IM64_W::new(self, 0)
    }
    ///Bit 1 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im65(&mut self) -> IM65_W<IMR3rs> {
        IM65_W::new(self, 1)
    }
    ///Bit 2 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im66(&mut self) -> IM66_W<IMR3rs> {
        IM66_W::new(self, 2)
    }
    ///Bit 4 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im68(&mut self) -> IM68_W<IMR3rs> {
        IM68_W::new(self, 4)
    }
    ///Bit 5 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im69(&mut self) -> IM69_W<IMR3rs> {
        IM69_W::new(self, 5)
    }
    ///Bit 6 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im70(&mut self) -> IM70_W<IMR3rs> {
        IM70_W::new(self, 6)
    }
    ///Bit 7 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im71(&mut self) -> IM71_W<IMR3rs> {
        IM71_W::new(self, 7)
    }
    ///Bit 8 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im72(&mut self) -> IM72_W<IMR3rs> {
        IM72_W::new(self, 8)
    }
    ///Bit 9 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im73(&mut self) -> IM73_W<IMR3rs> {
        IM73_W::new(self, 9)
    }
    ///Bit 10 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im74(&mut self) -> IM74_W<IMR3rs> {
        IM74_W::new(self, 10)
    }
    ///Bit 13 - CPU wake-up with interrupt mask on event input 77
    #[inline(always)]
    pub fn im77(&mut self) -> IM77_W<IMR3rs> {
        IM77_W::new(self, 13)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#EXTI:IMR3)*/
pub struct IMR3rs;
