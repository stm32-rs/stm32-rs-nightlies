...
impl W {
    ///Bit 7 - Configurable event input x rising edge pending bit
    #[inline(always)]
    pub fn rpif39(&mut self) -> RPIF39_W<RPR2rs> {
        RPIF39_W::new(self, 7)
    }
    ///Bit 8 - Configurable event input x rising edge pending bit
    #[inline(always)]
    pub fn rpif40(&mut self) -> RPIF40_W<RPR2rs> {
        RPIF40_W::new(self, 8)
    }
    ///Bit 19 - Configurable event input 51 rising edge pending bit
    #[inline(always)]
    pub fn rpif51(&mut self) -> RPIF51_W<RPR2rs> {
        RPIF51_W::new(self, 19)
    }
    ///Bit 22 - Configurable event input 54 rising edge pending bit
    #[inline(always)]
    pub fn rpif54(&mut self) -> RPIF54_W<RPR2rs> {
        RPIF54_W::new(self, 22)
    }
    ///Bit 24 - Configurable event input 56 rising edge pending bit
    #[inline(always)]
    pub fn rpif56(&mut self) -> RPIF56_W<RPR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#EXTI:RPR2)*/
pub struct RPR2rs;
