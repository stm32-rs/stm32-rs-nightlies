...
///Field `SEC23` reader - Security enable on event input x
pub type SEC23_R = crate::BitReader;
///Field `SEC23` writer - Security enable on event input x
pub type SEC23_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC24` reader - Security enable on event input x
pub type SEC24_R = crate::BitReader;
///Field `SEC24` writer - Security enable on event input x
pub type SEC24_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC25` reader - Security enable on event input x
pub type SEC25_R = crate::BitReader;
///Field `SEC25` writer - Security enable on event input x
pub type SEC25_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC26` reader - Security enable on event input x
pub type SEC26_R = crate::BitReader;
///Field `SEC26` writer - Security enable on event input x
pub type SEC26_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC27` reader - Security enable on event input x
pub type SEC27_R = crate::BitReader;
///Field `SEC27` writer - Security enable on event input x
pub type SEC27_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC28` reader - Security enable on event input x
pub type SEC28_R = crate::BitReader;
///Field `SEC28` writer - Security enable on event input x
pub type SEC28_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC29` reader - Security enable on event input x
pub type SEC29_R = crate::BitReader;
///Field `SEC29` writer - Security enable on event input x
pub type SEC29_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC30` reader - Security enable on event input x
pub type SEC30_R = crate::BitReader;
///Field `SEC30` writer - Security enable on event input x
pub type SEC30_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEC31` reader - Security enable on event input x
pub type SEC31_R = crate::BitReader;
///Field `SEC31` writer - Security enable on event input x
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#EXTI:SECCFGR1)*/
