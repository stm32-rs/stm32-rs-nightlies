...
impl W {
    ///Bits 0:3 - Address setup phase duration.
    #[inline(always)]
    pub fn addset(&mut self) -> ADDSET_W<'_, BWTR4rs> {
        ADDSET_W::new(self, 0)
    }
    ///Bits 4:7 - Address-hold phase duration.
    #[inline(always)]
    pub fn addhld(&mut self) -> ADDHLD_W<'_, BWTR4rs> {
        ADDHLD_W::new(self, 4)
    }
    ///Bits 8:15 - Data-phase duration.
    #[inline(always)]
    pub fn datast(&mut self) -> DATAST_W<'_, BWTR4rs> {
        DATAST_W::new(self, 8)
    }
    ///Bits 16:19 - Bus turnaround phase duration
    #[inline(always)]
    pub fn busturn(&mut self) -> BUSTURN_W<'_, BWTR4rs> {
        BUSTURN_W::new(self, 16)
    }
    ///Bits 28:29 - Access mode.
    #[inline(always)]
    pub fn accmod(&mut self) -> ACCMOD_W<'_, BWTR4rs> {
        ACCMOD_W::new(self, 28)
    }
    ///Bits 30:31 - Data Hold phase duration
    #[inline(always)]
    pub fn datahld(&mut self) -> DATAHLD_W<'_, BWTR4rs> {
