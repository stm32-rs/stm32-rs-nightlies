...
impl W {
    ///Bits 16:19 - Clock divide ratio (for FMC_CLK signal)
    #[inline(always)]
    pub fn clkdiv(&mut self) -> CLKDIV_W<CFGRrs> {
        CLKDIV_W::new(self, 16)
    }
    ///Bit 20 - Continuous clock enable
    #[inline(always)]
    pub fn cclken(&mut self) -> CCLKEN_W<CFGRrs> {
        CCLKEN_W::new(self, 20)
    }
    ///Bit 24 - FMC memory region mapping
    #[inline(always)]
    pub fn bmap0(&mut self) -> BMAP0_W<CFGRrs> {
        BMAP0_W::new(self, 24)
    }
    ///Bit 25 - FMC memory region mapping
    #[inline(always)]
    pub fn bmap1(&mut self) -> BMAP1_W<CFGRrs> {
        BMAP1_W::new(self, 25)
    }
    ///Bit 31 - FMC controller enable
    #[inline(always)]
    pub fn fmcen(&mut self) -> FMCEN_W<CFGRrs> {
        FMCEN_W::new(self, 31)
    }
}
