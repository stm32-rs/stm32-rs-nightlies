...
impl W {
    ///Bits 0:7 - Address Cycle 1
    #[inline(always)]
    pub fn addc1(&mut self) -> ADDC1_W<CSQAR1rs> {
        ADDC1_W::new(self, 0)
    }
    ///Bits 8:15 - Address Cycle 2
    #[inline(always)]
    pub fn addc2(&mut self) -> ADDC2_W<CSQAR1rs> {
        ADDC2_W::new(self, 8)
    }
    ///Bits 16:23 - Address Cycle 3
    #[inline(always)]
    pub fn addc3(&mut self) -> ADDC3_W<CSQAR1rs> {
        ADDC3_W::new(self, 16)
    }
    ///Bits 24:31 - Address Cycle 4
    #[inline(always)]
    pub fn addc4(&mut self) -> ADDC4_W<CSQAR1rs> {
        ADDC4_W::new(self, 24)
    }
}
