...
///Field `CB0OF` reader - Clear buffer 0 overflow flag
...
///Field `CB1OF` reader - Clear buffer 1 overflow flag
...
///Field `CB2OF` reader - Clear buffer 2 overflow flag
...
///Field `CB3OF` reader - Clear buffer 3 overflow flag
...
///Field `CAMEF` reader - Clear AXI master error flag
pub type CAMEF_R = crate::BitReader;
///Field `CAMEF` writer - Clear AXI master error flag
...
impl R {
    ...
    ///Bit 4 - Clear AXI master error flag
    #[inline(always)]
