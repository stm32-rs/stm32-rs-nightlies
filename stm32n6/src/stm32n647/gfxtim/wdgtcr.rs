...
///Field `WDGEN` writer - watchdog enable
pub type WDGEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDGDIS` writer - watchdog disable
pub type WDGDIS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDGS` reader - watchdog status
pub type WDGS_R = crate::BitReader;
///Field `WDGHRC` reader - watchdog hardware reload configuration
pub type WDGHRC_R = crate::FieldReader;
///Field `WDGHRC` writer - watchdog hardware reload configuration
pub type WDGHRC_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `WDGCS` reader - watchdog clock source
pub type WDGCS_R = crate::FieldReader;
///Field `WDGCS` writer - watchdog clock source
pub type WDGCS_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `FWDGR` writer - force watchdog reload
pub type FWDGR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 2 - watchdog status
    #[inline(always)]
    pub fn wdgs(&self) -> WDGS_R {
        WDGS_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bits 4:5 - watchdog hardware reload configuration
    #[inline(always)]
    pub fn wdghrc(&self) -> WDGHRC_R {
        WDGHRC_R::new(((self.bits >> 4) & 3) as u8)
    }
    ///Bits 8:11 - watchdog clock source
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#GFXTIM:WDGTCR)*/
pub struct WDGTCRrs;
