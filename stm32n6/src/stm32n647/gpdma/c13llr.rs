///Register `C13LLR` reader
pub type R = crate::R<C13LLRrs>;
///Register `C13LLR` writer
pub type W = crate::W<C13LLRrs>;
...
impl W {
    ///Bits 2:15 - pointer (16-bit low-significant address) to the next linked-list data structure
    #[inline(always)]
    pub fn la(&mut self) -> LA_W<'_, C13LLRrs> {
        LA_W::new(self, 2)
    }
    ///Bit 16 - Update GPDMA_CxLLR register from memory
    #[inline(always)]
    pub fn ull(&mut self) -> ULL_W<'_, C13LLRrs> {
        ULL_W::new(self, 16)
    }
    ///Bit 25 - Update GPDMA_CxBR2 from memory
    #[inline(always)]
    pub fn ub2(&mut self) -> UB2_W<'_, C13LLRrs> {
        UB2_W::new(self, 25)
    }
    ///Bit 26 - Update GPDMA_CxTR3 from memory
    #[inline(always)]
    pub fn ut3(&mut self) -> UT3_W<'_, C13LLRrs> {
        UT3_W::new(self, 26)
    }
    ///Bit 27 - Update GPDMA_CxDAR register from memory
    #[inline(always)]
    pub fn uda(&mut self) -> UDA_W<'_, C13LLRrs> {
        UDA_W::new(self, 27)
    }
    ///Bit 28 - update GPDMA_CxSAR from memory
    #[inline(always)]
    pub fn usa(&mut self) -> USA_W<'_, C13LLRrs> {
        USA_W::new(self, 28)
    }
    ///Bit 29 - Update GPDMA_CxBR1 from memory
    #[inline(always)]
    pub fn ub1(&mut self) -> UB1_W<'_, C13LLRrs> {
        UB1_W::new(self, 29)
    }
    ///Bit 30 - Update GPDMA_CxTR2 from memory
    #[inline(always)]
    pub fn ut2(&mut self) -> UT2_W<'_, C13LLRrs> {
        UT2_W::new(self, 30)
    }
    ///Bit 31 - Update GPDMA_CxTR1 from memory
    #[inline(always)]
    pub fn ut1(&mut self) -> UT1_W<'_, C13LLRrs> {
        UT1_W::new(self, 31)
    }
}
/**GPDMA channel 13 alternate linked-list address register

You can [`read`](crate::Reg::read) this register and get [`c13llr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c13llr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#GPDMA:C13LLR)*/
pub struct C13LLRrs;
impl crate::RegisterSpec for C13LLRrs {
    type Ux = u32;
}
///`read()` method returns [`c13llr::R`](R) reader structure
impl crate::Readable for C13LLRrs {}
///`write(|w| ..)` method takes [`c13llr::W`](W) writer structure
impl crate::Writable for C13LLRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C13LLR to value 0
impl crate::Resettable for C13LLRrs {}
