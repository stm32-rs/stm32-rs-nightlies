///Register `C14FCR` writer
pub type W = crate::W<C14FCRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<C14FCRrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn tcf(&mut self) -> TCF_W<'_, C14FCRrs> {
        TCF_W::new(self, 8)
    }
    ///Bit 9 - half transfer flag clear
    #[inline(always)]
    pub fn htf(&mut self) -> HTF_W<'_, C14FCRrs> {
        HTF_W::new(self, 9)
    }
    ///Bit 10 - data transfer error flag clear
    #[inline(always)]
    pub fn dtef(&mut self) -> DTEF_W<'_, C14FCRrs> {
        DTEF_W::new(self, 10)
    }
    ///Bit 11 - update link transfer error flag clear
    #[inline(always)]
    pub fn ulef(&mut self) -> ULEF_W<'_, C14FCRrs> {
        ULEF_W::new(self, 11)
    }
    ///Bit 12 - user setting error flag clear
    #[inline(always)]
    pub fn usef(&mut self) -> USEF_W<'_, C14FCRrs> {
        USEF_W::new(self, 12)
    }
    ///Bit 13 - completed suspension flag clear
    #[inline(always)]
    pub fn suspf(&mut self) -> SUSPF_W<'_, C14FCRrs> {
        SUSPF_W::new(self, 13)
    }
    ///Bit 14 - trigger overrun flag clear
    #[inline(always)]
    pub fn tof(&mut self) -> TOF_W<'_, C14FCRrs> {
        TOF_W::new(self, 14)
    }
}
/**GPDMA channel 14 flag clear register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c14fcr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#GPDMA:C14FCR)*/
pub struct C14FCRrs;
impl crate::RegisterSpec for C14FCRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`c14fcr::W`](W) writer structure
impl crate::Writable for C14FCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C14FCR to value 0
impl crate::Resettable for C14FCRrs {}
