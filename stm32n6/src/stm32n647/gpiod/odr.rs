...
///Field `OD0` reader - Port x output data I/O pin y
pub type OD0_R = crate::BitReader;
///Field `OD0` writer - Port x output data I/O pin y
pub type OD0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD1` reader - Port x output data I/O pin y
pub type OD1_R = crate::BitReader;
///Field `OD1` writer - Port x output data I/O pin y
pub type OD1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD2` reader - Port x output data I/O pin y
pub type OD2_R = crate::BitReader;
///Field `OD2` writer - Port x output data I/O pin y
pub type OD2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD3` reader - Port x output data I/O pin y
pub type OD3_R = crate::BitReader;
///Field `OD3` writer - Port x output data I/O pin y
pub type OD3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD4` reader - Port x output data I/O pin y
pub type OD4_R = crate::BitReader;
///Field `OD4` writer - Port x output data I/O pin y
pub type OD4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD5` reader - Port x output data I/O pin y
pub type OD5_R = crate::BitReader;
///Field `OD5` writer - Port x output data I/O pin y
pub type OD5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD6` reader - Port x output data I/O pin y
pub type OD6_R = crate::BitReader;
///Field `OD6` writer - Port x output data I/O pin y
pub type OD6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD7` reader - Port x output data I/O pin y
pub type OD7_R = crate::BitReader;
///Field `OD7` writer - Port x output data I/O pin y
pub type OD7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD8` reader - Port x output data I/O pin y
pub type OD8_R = crate::BitReader;
///Field `OD8` writer - Port x output data I/O pin y
pub type OD8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD9` reader - Port x output data I/O pin y
pub type OD9_R = crate::BitReader;
///Field `OD9` writer - Port x output data I/O pin y
pub type OD9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD10` reader - Port x output data I/O pin y
pub type OD10_R = crate::BitReader;
///Field `OD10` writer - Port x output data I/O pin y
pub type OD10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD11` reader - Port x output data I/O pin y
pub type OD11_R = crate::BitReader;
///Field `OD11` writer - Port x output data I/O pin y
pub type OD11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD12` reader - Port x output data I/O pin y
pub type OD12_R = crate::BitReader;
///Field `OD12` writer - Port x output data I/O pin y
pub type OD12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD13` reader - Port x output data I/O pin y
pub type OD13_R = crate::BitReader;
///Field `OD13` writer - Port x output data I/O pin y
pub type OD13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD14` reader - Port x output data I/O pin y
pub type OD14_R = crate::BitReader;
///Field `OD14` writer - Port x output data I/O pin y
pub type OD14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD15` reader - Port x output data I/O pin y
pub type OD15_R = crate::BitReader;
///Field `OD15` writer - Port x output data I/O pin y
pub type OD15_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od0(&self) -> OD0_R {
        OD0_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od1(&self) -> OD1_R {
        OD1_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od2(&self) -> OD2_R {
        OD2_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od3(&self) -> OD3_R {
        OD3_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od4(&self) -> OD4_R {
        OD4_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od5(&self) -> OD5_R {
        OD5_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od6(&self) -> OD6_R {
        OD6_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od7(&self) -> OD7_R {
        OD7_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od8(&self) -> OD8_R {
        OD8_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od9(&self) -> OD9_R {
        OD9_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od10(&self) -> OD10_R {
        OD10_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od11(&self) -> OD11_R {
        OD11_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od12(&self) -> OD12_R {
        OD12_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od13(&self) -> OD13_R {
        OD13_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - Port x output data I/O pin y
    #[inline(always)]
    pub fn od14(&self) -> OD14_R {
        OD14_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - Port x output data I/O pin y
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#GPIOD:ODR)*/
pub struct ODRrs;
