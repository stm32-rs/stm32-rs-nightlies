...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DELAY8` field.</div>
    #[inline(always)]
    pub fn delay(&mut self, n: u8) -> DELAY_W<DELAYRHrs> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    ///Bits 0:3 - Port x I/O pin y delay setup
    #[inline(always)]
    pub fn delay8(&mut self) -> DELAY_W<DELAYRHrs> {
        DELAY_W::new(self, 0)
    }
    ///Bits 4:7 - Port x I/O pin y delay setup
    #[inline(always)]
    pub fn delay9(&mut self) -> DELAY_W<DELAYRHrs> {
        DELAY_W::new(self, 4)
    }
    ///Bits 8:11 - Port x I/O pin y delay setup
    #[inline(always)]
    pub fn delay10(&mut self) -> DELAY_W<DELAYRHrs> {
        DELAY_W::new(self, 8)
    }
    ///Bits 12:15 - Port x I/O pin y delay setup
    #[inline(always)]
    pub fn delay11(&mut self) -> DELAY_W<DELAYRHrs> {
        DELAY_W::new(self, 12)
    }
    ///Bits 16:19 - Port x I/O pin y delay setup
    #[inline(always)]
    pub fn delay12(&mut self) -> DELAY_W<DELAYRHrs> {
        DELAY_W::new(self, 16)
    }
    ///Bits 20:23 - Port x I/O pin y delay setup
    #[inline(always)]
    pub fn delay13(&mut self) -> DELAY_W<DELAYRHrs> {
        DELAY_W::new(self, 20)
    }
    ///Bits 24:27 - Port x I/O pin y delay setup
    #[inline(always)]
    pub fn delay14(&mut self) -> DELAY_W<DELAYRHrs> {
        DELAY_W::new(self, 24)
    }
    ///Bits 28:31 - Port x I/O pin y delay setup
    #[inline(always)]
    pub fn delay15(&mut self) -> DELAY_W<DELAYRHrs> {
        DELAY_W::new(self, 28)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#GPIOH:DELAYRH)*/
