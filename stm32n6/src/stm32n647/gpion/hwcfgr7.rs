...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#GPION:HWCFGR7)*/
...
///`reset()` method sets HWCFGR7 to value 0x9999_9999
impl crate::Resettable for HWCFGR7rs {
    const RESET_VALUE: u32 = 0x9999_9999;
}
