...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `PIOCFG0` field.</div>
    #[inline(always)]
    pub fn piocfg(&mut self, n: u8) -> PIOCFG_W<PIOCFGRLrs> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    ///Bits 0:3 - Port x I/O pin y configuration
    #[inline(always)]
    pub fn piocfg0(&mut self) -> PIOCFG_W<PIOCFGRLrs> {
        PIOCFG_W::new(self, 0)
    }
    ///Bits 4:7 - Port x I/O pin y configuration
    #[inline(always)]
    pub fn piocfg1(&mut self) -> PIOCFG_W<PIOCFGRLrs> {
        PIOCFG_W::new(self, 4)
    }
    ///Bits 8:11 - Port x I/O pin y configuration
    #[inline(always)]
    pub fn piocfg2(&mut self) -> PIOCFG_W<PIOCFGRLrs> {
        PIOCFG_W::new(self, 8)
    }
    ///Bits 12:15 - Port x I/O pin y configuration
    #[inline(always)]
    pub fn piocfg3(&mut self) -> PIOCFG_W<PIOCFGRLrs> {
        PIOCFG_W::new(self, 12)
    }
    ///Bits 16:19 - Port x I/O pin y configuration
    #[inline(always)]
    pub fn piocfg4(&mut self) -> PIOCFG_W<PIOCFGRLrs> {
        PIOCFG_W::new(self, 16)
    }
    ///Bits 20:23 - Port x I/O pin y configuration
    #[inline(always)]
    pub fn piocfg5(&mut self) -> PIOCFG_W<PIOCFGRLrs> {
        PIOCFG_W::new(self, 20)
    }
    ///Bits 24:27 - Port x I/O pin y configuration
    #[inline(always)]
    pub fn piocfg6(&mut self) -> PIOCFG_W<PIOCFGRLrs> {
        PIOCFG_W::new(self, 24)
    }
    ///Bits 28:31 - Port x I/O pin y configuration
    #[inline(always)]
    pub fn piocfg7(&mut self) -> PIOCFG_W<PIOCFGRLrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#GPIOQ:PIOCFGRL)*/
