///Register `C2SEMCR` reader
pub type R = crate::R<C2SEMCRrs>;
///Register `C2SEMCR` writer
pub type W = crate::W<C2SEMCRrs>;
...
impl W {
    ///Bit 0 - mutual exclusion semaphore for the CID allocation of the channel x (in semaphore mode)
    #[inline(always)]
    pub fn sem_mutex(&mut self) -> SEM_MUTEX_W<'_, C2SEMCRrs> {
        SEM_MUTEX_W::new(self, 0)
    }
}
/**HPDMA channel 2 semaphore control register

You can [`read`](crate::Reg::read) this register and get [`c2semcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c2semcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#HPDMA:C2SEMCR)*/
pub struct C2SEMCRrs;
impl crate::RegisterSpec for C2SEMCRrs {
    type Ux = u32;
}
///`read()` method returns [`c2semcr::R`](R) reader structure
impl crate::Readable for C2SEMCRrs {}
///`write(|w| ..)` method takes [`c2semcr::W`](W) writer structure
impl crate::Writable for C2SEMCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C2SEMCR to value 0
impl crate::Resettable for C2SEMCRrs {}
