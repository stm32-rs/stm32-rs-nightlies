...
///Field `OA1` reader - Interface own slave address
pub type OA1_R = crate::FieldReader<u16>;
///Field `OA1` writer - Interface own slave address
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#I2C1:OAR1)*/
pub struct OAR1rs;
