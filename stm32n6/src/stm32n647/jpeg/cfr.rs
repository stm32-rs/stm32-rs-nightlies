...
///Field `CEOCF` reader - Clear end of conversion flag
...
///Field `CHPDF` reader - Clear header parsing done flag
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:CFR)*/
pub struct CFRrs;
