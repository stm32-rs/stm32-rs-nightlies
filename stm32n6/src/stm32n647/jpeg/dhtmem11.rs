...
impl W {
    ///Bits 0:7 - Huffman table data 44
    #[inline(always)]
    pub fn data44(&mut self) -> DATA44_W<DHTMEM11rs> {
        DATA44_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 45
    #[inline(always)]
    pub fn data45(&mut self) -> DATA45_W<DHTMEM11rs> {
        DATA45_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 46
    #[inline(always)]
    pub fn data46(&mut self) -> DATA46_W<DHTMEM11rs> {
        DATA46_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 47
    #[inline(always)]
    pub fn data47(&mut self) -> DATA47_W<DHTMEM11rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM11)*/
