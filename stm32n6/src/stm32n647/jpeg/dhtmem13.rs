...
impl W {
    ///Bits 0:7 - Huffman table data 52
    #[inline(always)]
    pub fn data52(&mut self) -> DATA52_W<DHTMEM13rs> {
        DATA52_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 53
    #[inline(always)]
    pub fn data53(&mut self) -> DATA53_W<DHTMEM13rs> {
        DATA53_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 54
    #[inline(always)]
    pub fn data54(&mut self) -> DATA54_W<DHTMEM13rs> {
        DATA54_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 55
    #[inline(always)]
    pub fn data55(&mut self) -> DATA55_W<DHTMEM13rs> {
