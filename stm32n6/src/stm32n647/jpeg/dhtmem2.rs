...
impl W {
    ///Bits 0:7 - Huffman table data 8
    #[inline(always)]
    pub fn data8(&mut self) -> DATA8_W<DHTMEM2rs> {
        DATA8_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 9
    #[inline(always)]
    pub fn data9(&mut self) -> DATA9_W<DHTMEM2rs> {
        DATA9_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 10
    #[inline(always)]
    pub fn data10(&mut self) -> DATA10_W<DHTMEM2rs> {
        DATA10_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 11
    #[inline(always)]
    pub fn data11(&mut self) -> DATA11_W<DHTMEM2rs> {
