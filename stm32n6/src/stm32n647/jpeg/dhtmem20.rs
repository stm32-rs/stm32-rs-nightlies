...
impl W {
    ///Bits 0:7 - Huffman table data 80
    #[inline(always)]
    pub fn data80(&mut self) -> DATA80_W<DHTMEM20rs> {
        DATA80_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 81
    #[inline(always)]
    pub fn data81(&mut self) -> DATA81_W<DHTMEM20rs> {
        DATA81_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 82
    #[inline(always)]
    pub fn data82(&mut self) -> DATA82_W<DHTMEM20rs> {
        DATA82_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 83
    #[inline(always)]
    pub fn data83(&mut self) -> DATA83_W<DHTMEM20rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM20)*/
