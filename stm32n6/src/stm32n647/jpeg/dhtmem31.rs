...
impl W {
    ///Bits 0:7 - Huffman table data 124
    #[inline(always)]
    pub fn data124(&mut self) -> DATA124_W<DHTMEM31rs> {
        DATA124_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 125
    #[inline(always)]
    pub fn data125(&mut self) -> DATA125_W<DHTMEM31rs> {
        DATA125_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 126
    #[inline(always)]
    pub fn data126(&mut self) -> DATA126_W<DHTMEM31rs> {
        DATA126_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 127
    #[inline(always)]
    pub fn data127(&mut self) -> DATA127_W<DHTMEM31rs> {
