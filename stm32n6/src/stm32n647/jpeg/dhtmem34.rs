...
impl W {
    ///Bits 0:7 - Huffman table data 136
    #[inline(always)]
    pub fn data136(&mut self) -> DATA136_W<DHTMEM34rs> {
        DATA136_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 137
    #[inline(always)]
    pub fn data137(&mut self) -> DATA137_W<DHTMEM34rs> {
        DATA137_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 138
    #[inline(always)]
    pub fn data138(&mut self) -> DATA138_W<DHTMEM34rs> {
        DATA138_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 139
    #[inline(always)]
    pub fn data139(&mut self) -> DATA139_W<DHTMEM34rs> {
