...
impl W {
    ///Bits 0:7 - Huffman table data 156
    #[inline(always)]
    pub fn data156(&mut self) -> DATA156_W<DHTMEM39rs> {
        DATA156_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 157
    #[inline(always)]
    pub fn data157(&mut self) -> DATA157_W<DHTMEM39rs> {
        DATA157_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 158
    #[inline(always)]
    pub fn data158(&mut self) -> DATA158_W<DHTMEM39rs> {
        DATA158_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 159
    #[inline(always)]
    pub fn data159(&mut self) -> DATA159_W<DHTMEM39rs> {
