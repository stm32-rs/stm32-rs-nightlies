...
impl W {
    ///Bits 0:7 - Huffman table data 16
    #[inline(always)]
    pub fn data16(&mut self) -> DATA16_W<DHTMEM4rs> {
        DATA16_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 17
    #[inline(always)]
    pub fn data17(&mut self) -> DATA17_W<DHTMEM4rs> {
        DATA17_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 18
    #[inline(always)]
    pub fn data18(&mut self) -> DATA18_W<DHTMEM4rs> {
        DATA18_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 19
    #[inline(always)]
    pub fn data19(&mut self) -> DATA19_W<DHTMEM4rs> {
