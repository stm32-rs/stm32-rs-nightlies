...
impl W {
    ///Bits 0:7 - Huffman table data 216
    #[inline(always)]
    pub fn data216(&mut self) -> DATA216_W<DHTMEM54rs> {
        DATA216_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 217
    #[inline(always)]
    pub fn data217(&mut self) -> DATA217_W<DHTMEM54rs> {
        DATA217_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 218
    #[inline(always)]
    pub fn data218(&mut self) -> DATA218_W<DHTMEM54rs> {
        DATA218_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 219
    #[inline(always)]
    pub fn data219(&mut self) -> DATA219_W<DHTMEM54rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM54)*/
