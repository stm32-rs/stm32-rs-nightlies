...
impl W {
    ///Bits 0:7 - Huffman table data 220
    #[inline(always)]
    pub fn data220(&mut self) -> DATA220_W<DHTMEM55rs> {
        DATA220_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 221
    #[inline(always)]
    pub fn data221(&mut self) -> DATA221_W<DHTMEM55rs> {
        DATA221_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 222
    #[inline(always)]
    pub fn data222(&mut self) -> DATA222_W<DHTMEM55rs> {
        DATA222_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 223
    #[inline(always)]
    pub fn data223(&mut self) -> DATA223_W<DHTMEM55rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM55)*/
