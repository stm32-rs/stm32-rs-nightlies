...
impl W {
    ///Bits 0:7 - Huffman table data 248
    #[inline(always)]
    pub fn data248(&mut self) -> DATA248_W<DHTMEM62rs> {
        DATA248_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 249
    #[inline(always)]
    pub fn data249(&mut self) -> DATA249_W<DHTMEM62rs> {
        DATA249_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 250
    #[inline(always)]
    pub fn data250(&mut self) -> DATA250_W<DHTMEM62rs> {
        DATA250_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 251
    #[inline(always)]
    pub fn data251(&mut self) -> DATA251_W<DHTMEM62rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM62)*/
