...
impl W {
    ///Bits 0:7 - Huffman table data 256
    #[inline(always)]
    pub fn data256(&mut self) -> DATA256_W<DHTMEM64rs> {
        DATA256_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 257
    #[inline(always)]
    pub fn data257(&mut self) -> DATA257_W<DHTMEM64rs> {
        DATA257_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 258
    #[inline(always)]
    pub fn data258(&mut self) -> DATA258_W<DHTMEM64rs> {
        DATA258_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 259
    #[inline(always)]
    pub fn data259(&mut self) -> DATA259_W<DHTMEM64rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM64)*/
