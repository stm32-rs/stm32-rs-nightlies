...
impl W {
    ///Bits 0:7 - Huffman table data 276
    #[inline(always)]
    pub fn data276(&mut self) -> DATA276_W<DHTMEM69rs> {
        DATA276_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 277
    #[inline(always)]
    pub fn data277(&mut self) -> DATA277_W<DHTMEM69rs> {
        DATA277_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 278
    #[inline(always)]
    pub fn data278(&mut self) -> DATA278_W<DHTMEM69rs> {
        DATA278_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 279
    #[inline(always)]
    pub fn data279(&mut self) -> DATA279_W<DHTMEM69rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM69)*/
