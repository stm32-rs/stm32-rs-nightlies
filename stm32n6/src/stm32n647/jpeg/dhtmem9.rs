...
impl W {
    ///Bits 0:7 - Huffman table data 36
    #[inline(always)]
    pub fn data36(&mut self) -> DATA36_W<DHTMEM9rs> {
        DATA36_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 37
    #[inline(always)]
    pub fn data37(&mut self) -> DATA37_W<DHTMEM9rs> {
        DATA37_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 38
    #[inline(always)]
    pub fn data38(&mut self) -> DATA38_W<DHTMEM9rs> {
        DATA38_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 39
    #[inline(always)]
    pub fn data39(&mut self) -> DATA39_W<DHTMEM9rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM9)*/
