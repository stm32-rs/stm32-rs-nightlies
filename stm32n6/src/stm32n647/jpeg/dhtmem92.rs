...
impl W {
    ///Bits 0:7 - Huffman table data 368
    #[inline(always)]
    pub fn data368(&mut self) -> DATA368_W<DHTMEM92rs> {
        DATA368_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 369
    #[inline(always)]
    pub fn data369(&mut self) -> DATA369_W<DHTMEM92rs> {
        DATA369_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 370
    #[inline(always)]
    pub fn data370(&mut self) -> DATA370_W<DHTMEM92rs> {
        DATA370_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 371
    #[inline(always)]
    pub fn data371(&mut self) -> DATA371_W<DHTMEM92rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM92)*/
