...
impl W {
    ///Bits 0:7 - Huffman table data 372
    #[inline(always)]
    pub fn data372(&mut self) -> DATA372_W<DHTMEM93rs> {
        DATA372_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 373
    #[inline(always)]
    pub fn data373(&mut self) -> DATA373_W<DHTMEM93rs> {
        DATA373_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 374
    #[inline(always)]
    pub fn data374(&mut self) -> DATA374_W<DHTMEM93rs> {
        DATA374_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 375
    #[inline(always)]
    pub fn data375(&mut self) -> DATA375_W<DHTMEM93rs> {
