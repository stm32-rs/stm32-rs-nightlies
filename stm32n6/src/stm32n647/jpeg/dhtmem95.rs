...
impl W {
    ///Bits 0:7 - Huffman table data 380
    #[inline(always)]
    pub fn data380(&mut self) -> DATA380_W<DHTMEM95rs> {
        DATA380_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 381
    #[inline(always)]
    pub fn data381(&mut self) -> DATA381_W<DHTMEM95rs> {
        DATA381_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 382
    #[inline(always)]
    pub fn data382(&mut self) -> DATA382_W<DHTMEM95rs> {
        DATA382_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 383
    #[inline(always)]
    pub fn data383(&mut self) -> DATA383_W<DHTMEM95rs> {
