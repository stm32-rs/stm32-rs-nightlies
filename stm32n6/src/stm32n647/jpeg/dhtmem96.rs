...
impl W {
    ///Bits 0:7 - Huffman table data 384
    #[inline(always)]
    pub fn data384(&mut self) -> DATA384_W<DHTMEM96rs> {
        DATA384_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 385
    #[inline(always)]
    pub fn data385(&mut self) -> DATA385_W<DHTMEM96rs> {
        DATA385_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 386
    #[inline(always)]
    pub fn data386(&mut self) -> DATA386_W<DHTMEM96rs> {
        DATA386_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 387
    #[inline(always)]
    pub fn data387(&mut self) -> DATA387_W<DHTMEM96rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM96)*/
