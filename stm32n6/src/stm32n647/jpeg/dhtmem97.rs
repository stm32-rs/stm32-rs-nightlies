...
impl W {
    ///Bits 0:7 - Huffman table data 388
    #[inline(always)]
    pub fn data388(&mut self) -> DATA388_W<DHTMEM97rs> {
        DATA388_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 389
    #[inline(always)]
    pub fn data389(&mut self) -> DATA389_W<DHTMEM97rs> {
        DATA389_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 390
    #[inline(always)]
    pub fn data390(&mut self) -> DATA390_W<DHTMEM97rs> {
        DATA390_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 391
    #[inline(always)]
    pub fn data391(&mut self) -> DATA391_W<DHTMEM97rs> {
