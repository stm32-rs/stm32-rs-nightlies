...
impl W {
    ///Bits 0:7 - Huffman table data 392
    #[inline(always)]
    pub fn data392(&mut self) -> DATA392_W<DHTMEM98rs> {
        DATA392_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 393
    #[inline(always)]
    pub fn data393(&mut self) -> DATA393_W<DHTMEM98rs> {
        DATA393_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 394
    #[inline(always)]
    pub fn data394(&mut self) -> DATA394_W<DHTMEM98rs> {
        DATA394_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 395
    #[inline(always)]
    pub fn data395(&mut self) -> DATA395_W<DHTMEM98rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:DHTMEM98)*/
