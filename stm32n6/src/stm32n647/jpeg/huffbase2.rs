...
impl W {
    ///Bits 0:8 - Data 4
    #[inline(always)]
    pub fn data4(&mut self) -> DATA4_W<HUFFBASE2rs> {
        DATA4_W::new(self, 0)
    }
    ///Bits 16:24 - Data 5
    #[inline(always)]
    pub fn data5(&mut self) -> DATA5_W<HUFFBASE2rs> {
        DATA5_W::new(self, 16)
    }
}
/**JPEG Huffman base
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFBASE2)*/
