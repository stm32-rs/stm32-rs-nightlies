...
impl W {
    ///Bits 0:8 - Data 6
    #[inline(always)]
    pub fn data6(&mut self) -> DATA6_W<HUFFBASE3rs> {
        DATA6_W::new(self, 0)
    }
    ///Bits 16:24 - Data 7
    #[inline(always)]
    pub fn data7(&mut self) -> DATA7_W<HUFFBASE3rs> {
        DATA7_W::new(self, 16)
    }
}
/**JPEG Huffman base
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFBASE3)*/
