...
impl W {
    ///Bits 0:8 - Data 60
    #[inline(always)]
    pub fn data60(&mut self) -> DATA60_W<HUFFBASE30rs> {
        DATA60_W::new(self, 0)
    }
    ///Bits 16:24 - Data 61
    #[inline(always)]
    pub fn data61(&mut self) -> DATA61_W<HUFFBASE30rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFBASE30)*/
