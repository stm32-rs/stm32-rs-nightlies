...
impl W {
    ///Bits 0:8 - Data 62
    #[inline(always)]
    pub fn data62(&mut self) -> DATA62_W<HUFFBASE31rs> {
        DATA62_W::new(self, 0)
    }
    ///Bits 16:24 - Data 63
    #[inline(always)]
    pub fn data63(&mut self) -> DATA63_W<HUFFBASE31rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFBASE31)*/
