...
impl W {
    ///Bits 0:8 - Data 12
    #[inline(always)]
    pub fn data12(&mut self) -> DATA12_W<HUFFBASE6rs> {
        DATA12_W::new(self, 0)
    }
    ///Bits 16:24 - Data 13
    #[inline(always)]
    pub fn data13(&mut self) -> DATA13_W<HUFFBASE6rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFBASE6)*/
