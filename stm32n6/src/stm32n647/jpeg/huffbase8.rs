...
impl W {
    ///Bits 0:8 - Data 16
    #[inline(always)]
    pub fn data16(&mut self) -> DATA16_W<HUFFBASE8rs> {
        DATA16_W::new(self, 0)
    }
    ///Bits 16:24 - Data 17
    #[inline(always)]
    pub fn data17(&mut self) -> DATA17_W<HUFFBASE8rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFBASE8)*/
