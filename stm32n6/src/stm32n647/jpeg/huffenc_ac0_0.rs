...
impl W {
    ///Bits 0:7 - Huffman code 0
    #[inline(always)]
    pub fn hcode0(&mut self) -> HCODE0_W<HUFFENC_AC0_0rs> {
        HCODE0_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 0
    #[inline(always)]
    pub fn hlen0(&mut self) -> HLEN0_W<HUFFENC_AC0_0rs> {
        HLEN0_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 1
    #[inline(always)]
    pub fn hcode1(&mut self) -> HCODE1_W<HUFFENC_AC0_0rs> {
        HCODE1_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 1
    #[inline(always)]
    pub fn hlen1(&mut self) -> HLEN1_W<HUFFENC_AC0_0rs> {
        HLEN1_W::new(self, 24)
    }
}
