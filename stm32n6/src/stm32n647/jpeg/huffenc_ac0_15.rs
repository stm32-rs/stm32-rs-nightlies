...
impl W {
    ///Bits 0:7 - Huffman code 30
    #[inline(always)]
    pub fn hcode30(&mut self) -> HCODE30_W<HUFFENC_AC0_15rs> {
        HCODE30_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 30
    #[inline(always)]
    pub fn hlen30(&mut self) -> HLEN30_W<HUFFENC_AC0_15rs> {
        HLEN30_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 31
    #[inline(always)]
    pub fn hcode31(&mut self) -> HCODE31_W<HUFFENC_AC0_15rs> {
        HCODE31_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 31
    #[inline(always)]
    pub fn hlen31(&mut self) -> HLEN31_W<HUFFENC_AC0_15rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_15)*/
