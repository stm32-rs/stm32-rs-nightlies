...
impl W {
    ///Bits 0:7 - Huffman code 32
    #[inline(always)]
    pub fn hcode32(&mut self) -> HCODE32_W<HUFFENC_AC0_16rs> {
        HCODE32_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 32
    #[inline(always)]
    pub fn hlen32(&mut self) -> HLEN32_W<HUFFENC_AC0_16rs> {
        HLEN32_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 33
    #[inline(always)]
    pub fn hcode33(&mut self) -> HCODE33_W<HUFFENC_AC0_16rs> {
        HCODE33_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 33
    #[inline(always)]
    pub fn hlen33(&mut self) -> HLEN33_W<HUFFENC_AC0_16rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_16)*/
