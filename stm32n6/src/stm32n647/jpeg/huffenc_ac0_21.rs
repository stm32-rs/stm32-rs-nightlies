///Register `HUFFENC_AC0_21` reader
pub type R = crate::R<HUFFENC_AC0_21rs>;
///Register `HUFFENC_AC0_21` writer
pub type W = crate::W<HUFFENC_AC0_21rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 42
    #[inline(always)]
    pub fn hcode42(&mut self) -> HCODE42_W<'_, HUFFENC_AC0_21rs> {
        HCODE42_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 42
    #[inline(always)]
    pub fn hlen42(&mut self) -> HLEN42_W<'_, HUFFENC_AC0_21rs> {
        HLEN42_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 43
    #[inline(always)]
    pub fn hcode43(&mut self) -> HCODE43_W<'_, HUFFENC_AC0_21rs> {
        HCODE43_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 43
    #[inline(always)]
    pub fn hlen43(&mut self) -> HLEN43_W<'_, HUFFENC_AC0_21rs> {
        HLEN43_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_21::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_21::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_21)*/
pub struct HUFFENC_AC0_21rs;
impl crate::RegisterSpec for HUFFENC_AC0_21rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_21::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_21rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_21::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_21rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_21 to value 0
impl crate::Resettable for HUFFENC_AC0_21rs {}
