...
impl W {
    ///Bits 0:7 - Huffman code 48
    #[inline(always)]
    pub fn hcode48(&mut self) -> HCODE48_W<HUFFENC_AC0_24rs> {
        HCODE48_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 48
    #[inline(always)]
    pub fn hlen48(&mut self) -> HLEN48_W<HUFFENC_AC0_24rs> {
        HLEN48_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 49
    #[inline(always)]
    pub fn hcode49(&mut self) -> HCODE49_W<HUFFENC_AC0_24rs> {
        HCODE49_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 49
    #[inline(always)]
    pub fn hlen49(&mut self) -> HLEN49_W<HUFFENC_AC0_24rs> {
