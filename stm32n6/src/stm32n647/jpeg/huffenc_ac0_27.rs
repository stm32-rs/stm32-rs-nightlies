...
impl W {
    ///Bits 0:7 - Huffman code 54
    #[inline(always)]
    pub fn hcode54(&mut self) -> HCODE54_W<HUFFENC_AC0_27rs> {
        HCODE54_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 54
    #[inline(always)]
    pub fn hlen54(&mut self) -> HLEN54_W<HUFFENC_AC0_27rs> {
        HLEN54_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 55
    #[inline(always)]
    pub fn hcode55(&mut self) -> HCODE55_W<HUFFENC_AC0_27rs> {
        HCODE55_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 55
    #[inline(always)]
    pub fn hlen55(&mut self) -> HLEN55_W<HUFFENC_AC0_27rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_27)*/
