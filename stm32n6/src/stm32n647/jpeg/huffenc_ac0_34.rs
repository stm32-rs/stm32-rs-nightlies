...
impl W {
    ///Bits 0:7 - Huffman code 68
    #[inline(always)]
    pub fn hcode68(&mut self) -> HCODE68_W<'_, HUFFENC_AC0_34rs> {
        HCODE68_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 68
    #[inline(always)]
    pub fn hlen68(&mut self) -> HLEN68_W<'_, HUFFENC_AC0_34rs> {
        HLEN68_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 69
    #[inline(always)]
    pub fn hcode69(&mut self) -> HCODE69_W<'_, HUFFENC_AC0_34rs> {
        HCODE69_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 69
    #[inline(always)]
    pub fn hlen69(&mut self) -> HLEN69_W<'_, HUFFENC_AC0_34rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_34)*/
