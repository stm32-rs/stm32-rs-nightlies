...
impl W {
    ///Bits 0:7 - Huffman code 106
    #[inline(always)]
    pub fn hcode106(&mut self) -> HCODE106_W<HUFFENC_AC0_53rs> {
        HCODE106_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 106
    #[inline(always)]
    pub fn hlen106(&mut self) -> HLEN106_W<HUFFENC_AC0_53rs> {
        HLEN106_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 107
    #[inline(always)]
    pub fn hcode107(&mut self) -> HCODE107_W<HUFFENC_AC0_53rs> {
        HCODE107_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 107
    #[inline(always)]
    pub fn hlen107(&mut self) -> HLEN107_W<HUFFENC_AC0_53rs> {
