...
impl W {
    ///Bits 0:7 - Huffman code 116
    #[inline(always)]
    pub fn hcode116(&mut self) -> HCODE116_W<HUFFENC_AC0_58rs> {
        HCODE116_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 116
    #[inline(always)]
    pub fn hlen116(&mut self) -> HLEN116_W<HUFFENC_AC0_58rs> {
        HLEN116_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 117
    #[inline(always)]
    pub fn hcode117(&mut self) -> HCODE117_W<HUFFENC_AC0_58rs> {
        HCODE117_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 117
    #[inline(always)]
    pub fn hlen117(&mut self) -> HLEN117_W<HUFFENC_AC0_58rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_58)*/
