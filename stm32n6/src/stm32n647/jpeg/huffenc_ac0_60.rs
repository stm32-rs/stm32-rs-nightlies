///Register `HUFFENC_AC0_60` reader
pub type R = crate::R<HUFFENC_AC0_60rs>;
///Register `HUFFENC_AC0_60` writer
pub type W = crate::W<HUFFENC_AC0_60rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 120
    #[inline(always)]
    pub fn hcode120(&mut self) -> HCODE120_W<'_, HUFFENC_AC0_60rs> {
        HCODE120_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 120
    #[inline(always)]
    pub fn hlen120(&mut self) -> HLEN120_W<'_, HUFFENC_AC0_60rs> {
        HLEN120_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 121
    #[inline(always)]
    pub fn hcode121(&mut self) -> HCODE121_W<'_, HUFFENC_AC0_60rs> {
        HCODE121_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 121
    #[inline(always)]
    pub fn hlen121(&mut self) -> HLEN121_W<'_, HUFFENC_AC0_60rs> {
        HLEN121_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_60::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_60::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_60)*/
pub struct HUFFENC_AC0_60rs;
impl crate::RegisterSpec for HUFFENC_AC0_60rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_60::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_60rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_60::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_60rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_60 to value 0
impl crate::Resettable for HUFFENC_AC0_60rs {}
