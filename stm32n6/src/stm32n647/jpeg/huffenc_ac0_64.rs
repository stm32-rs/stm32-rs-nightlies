...
impl W {
    ///Bits 0:7 - Huffman code 128
    #[inline(always)]
    pub fn hcode128(&mut self) -> HCODE128_W<HUFFENC_AC0_64rs> {
        HCODE128_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 128
    #[inline(always)]
    pub fn hlen128(&mut self) -> HLEN128_W<HUFFENC_AC0_64rs> {
        HLEN128_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 129
    #[inline(always)]
    pub fn hcode129(&mut self) -> HCODE129_W<HUFFENC_AC0_64rs> {
        HCODE129_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 129
    #[inline(always)]
    pub fn hlen129(&mut self) -> HLEN129_W<HUFFENC_AC0_64rs> {
