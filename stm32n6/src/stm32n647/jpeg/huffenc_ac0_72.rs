///Register `HUFFENC_AC0_72` reader
pub type R = crate::R<HUFFENC_AC0_72rs>;
///Register `HUFFENC_AC0_72` writer
pub type W = crate::W<HUFFENC_AC0_72rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 144
    #[inline(always)]
    pub fn hcode144(&mut self) -> HCODE144_W<'_, HUFFENC_AC0_72rs> {
        HCODE144_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 144
    #[inline(always)]
    pub fn hlen144(&mut self) -> HLEN144_W<'_, HUFFENC_AC0_72rs> {
        HLEN144_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 145
    #[inline(always)]
    pub fn hcode145(&mut self) -> HCODE145_W<'_, HUFFENC_AC0_72rs> {
        HCODE145_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 145
    #[inline(always)]
    pub fn hlen145(&mut self) -> HLEN145_W<'_, HUFFENC_AC0_72rs> {
        HLEN145_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_72::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_72::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_72)*/
pub struct HUFFENC_AC0_72rs;
impl crate::RegisterSpec for HUFFENC_AC0_72rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_72::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_72rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_72::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_72rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_72 to value 0
impl crate::Resettable for HUFFENC_AC0_72rs {}
