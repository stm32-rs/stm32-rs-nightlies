...
impl W {
    ///Bits 0:7 - Huffman code 160
    #[inline(always)]
    pub fn hcode160(&mut self) -> HCODE160_W<HUFFENC_AC0_80rs> {
        HCODE160_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 160
    #[inline(always)]
    pub fn hlen160(&mut self) -> HLEN160_W<HUFFENC_AC0_80rs> {
        HLEN160_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 161
    #[inline(always)]
    pub fn hcode161(&mut self) -> HCODE161_W<HUFFENC_AC0_80rs> {
        HCODE161_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 161
    #[inline(always)]
    pub fn hlen161(&mut self) -> HLEN161_W<HUFFENC_AC0_80rs> {
