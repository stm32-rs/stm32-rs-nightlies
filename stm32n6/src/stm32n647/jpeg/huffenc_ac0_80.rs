///Register `HUFFENC_AC0_80` reader
pub type R = crate::R<HUFFENC_AC0_80rs>;
///Register `HUFFENC_AC0_80` writer
pub type W = crate::W<HUFFENC_AC0_80rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 160
    #[inline(always)]
    pub fn hcode160(&mut self) -> HCODE160_W<'_, HUFFENC_AC0_80rs> {
        HCODE160_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 160
    #[inline(always)]
    pub fn hlen160(&mut self) -> HLEN160_W<'_, HUFFENC_AC0_80rs> {
        HLEN160_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 161
    #[inline(always)]
    pub fn hcode161(&mut self) -> HCODE161_W<'_, HUFFENC_AC0_80rs> {
        HCODE161_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 161
    #[inline(always)]
    pub fn hlen161(&mut self) -> HLEN161_W<'_, HUFFENC_AC0_80rs> {
        HLEN161_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_80::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_80::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_80)*/
pub struct HUFFENC_AC0_80rs;
impl crate::RegisterSpec for HUFFENC_AC0_80rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_80::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_80rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_80::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_80rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_80 to value 0
impl crate::Resettable for HUFFENC_AC0_80rs {}
