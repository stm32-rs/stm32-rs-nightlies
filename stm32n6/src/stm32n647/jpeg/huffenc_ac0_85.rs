///Register `HUFFENC_AC0_85` reader
pub type R = crate::R<HUFFENC_AC0_85rs>;
///Register `HUFFENC_AC0_85` writer
pub type W = crate::W<HUFFENC_AC0_85rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 170
    #[inline(always)]
    pub fn hcode170(&mut self) -> HCODE170_W<'_, HUFFENC_AC0_85rs> {
        HCODE170_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 170
    #[inline(always)]
    pub fn hlen170(&mut self) -> HLEN170_W<'_, HUFFENC_AC0_85rs> {
        HLEN170_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 171
    #[inline(always)]
    pub fn hcode171(&mut self) -> HCODE171_W<'_, HUFFENC_AC0_85rs> {
        HCODE171_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 171
    #[inline(always)]
    pub fn hlen171(&mut self) -> HLEN171_W<'_, HUFFENC_AC0_85rs> {
        HLEN171_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_85::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_85::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC0_85)*/
pub struct HUFFENC_AC0_85rs;
impl crate::RegisterSpec for HUFFENC_AC0_85rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_85::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_85rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_85::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_85rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_85 to value 0
impl crate::Resettable for HUFFENC_AC0_85rs {}
