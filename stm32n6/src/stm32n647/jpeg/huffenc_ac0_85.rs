...
impl W {
    ///Bits 0:7 - Huffman code 170
    #[inline(always)]
    pub fn hcode170(&mut self) -> HCODE170_W<HUFFENC_AC0_85rs> {
        HCODE170_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 170
    #[inline(always)]
    pub fn hlen170(&mut self) -> HLEN170_W<HUFFENC_AC0_85rs> {
        HLEN170_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 171
    #[inline(always)]
    pub fn hcode171(&mut self) -> HCODE171_W<HUFFENC_AC0_85rs> {
        HCODE171_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 171
    #[inline(always)]
    pub fn hlen171(&mut self) -> HLEN171_W<HUFFENC_AC0_85rs> {
