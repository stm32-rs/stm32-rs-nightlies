...
impl W {
    ///Bits 0:7 - Huffman code 24
    #[inline(always)]
    pub fn hcode24(&mut self) -> HCODE24_W<HUFFENC_AC1_12rs> {
        HCODE24_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 24
    #[inline(always)]
    pub fn hlen24(&mut self) -> HLEN24_W<HUFFENC_AC1_12rs> {
        HLEN24_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 25
    #[inline(always)]
    pub fn hcode25(&mut self) -> HCODE25_W<HUFFENC_AC1_12rs> {
        HCODE25_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 25
    #[inline(always)]
    pub fn hlen25(&mut self) -> HLEN25_W<HUFFENC_AC1_12rs> {
