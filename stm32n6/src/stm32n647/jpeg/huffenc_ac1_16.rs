///Register `HUFFENC_AC1_16` reader
pub type R = crate::R<HUFFENC_AC1_16rs>;
///Register `HUFFENC_AC1_16` writer
pub type W = crate::W<HUFFENC_AC1_16rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 32
    #[inline(always)]
    pub fn hcode32(&mut self) -> HCODE32_W<'_, HUFFENC_AC1_16rs> {
        HCODE32_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 32
    #[inline(always)]
    pub fn hlen32(&mut self) -> HLEN32_W<'_, HUFFENC_AC1_16rs> {
        HLEN32_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 33
    #[inline(always)]
    pub fn hcode33(&mut self) -> HCODE33_W<'_, HUFFENC_AC1_16rs> {
        HCODE33_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 33
    #[inline(always)]
    pub fn hlen33(&mut self) -> HLEN33_W<'_, HUFFENC_AC1_16rs> {
...
pub struct HUFFENC_AC1_16rs;
impl crate::RegisterSpec for HUFFENC_AC1_16rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_16::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_16rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_16::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_16rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_16 to value 0
impl crate::Resettable for HUFFENC_AC1_16rs {}
