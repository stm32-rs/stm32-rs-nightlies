///Register `HUFFENC_AC1_29` reader
pub type R = crate::R<HUFFENC_AC1_29rs>;
///Register `HUFFENC_AC1_29` writer
pub type W = crate::W<HUFFENC_AC1_29rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 58
    #[inline(always)]
    pub fn hcode58(&mut self) -> HCODE58_W<'_, HUFFENC_AC1_29rs> {
        HCODE58_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 58
    #[inline(always)]
    pub fn hlen58(&mut self) -> HLEN58_W<'_, HUFFENC_AC1_29rs> {
        HLEN58_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 59
    #[inline(always)]
    pub fn hcode59(&mut self) -> HCODE59_W<'_, HUFFENC_AC1_29rs> {
        HCODE59_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 59
    #[inline(always)]
    pub fn hlen59(&mut self) -> HLEN59_W<'_, HUFFENC_AC1_29rs> {
        HLEN59_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_29::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_29::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_29)*/
pub struct HUFFENC_AC1_29rs;
impl crate::RegisterSpec for HUFFENC_AC1_29rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_29::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_29rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_29::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_29rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_29 to value 0
impl crate::Resettable for HUFFENC_AC1_29rs {}
