///Register `HUFFENC_AC1_46` reader
pub type R = crate::R<HUFFENC_AC1_46rs>;
///Register `HUFFENC_AC1_46` writer
pub type W = crate::W<HUFFENC_AC1_46rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 92
    #[inline(always)]
    pub fn hcode92(&mut self) -> HCODE92_W<'_, HUFFENC_AC1_46rs> {
        HCODE92_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 92
    #[inline(always)]
    pub fn hlen92(&mut self) -> HLEN92_W<'_, HUFFENC_AC1_46rs> {
        HLEN92_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 93
    #[inline(always)]
    pub fn hcode93(&mut self) -> HCODE93_W<'_, HUFFENC_AC1_46rs> {
        HCODE93_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 93
    #[inline(always)]
    pub fn hlen93(&mut self) -> HLEN93_W<'_, HUFFENC_AC1_46rs> {
        HLEN93_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_46::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_46::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_46)*/
pub struct HUFFENC_AC1_46rs;
impl crate::RegisterSpec for HUFFENC_AC1_46rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_46::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_46rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_46::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_46rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_46 to value 0
impl crate::Resettable for HUFFENC_AC1_46rs {}
