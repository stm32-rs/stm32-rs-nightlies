...
impl W {
    ///Bits 0:7 - Huffman code 92
    #[inline(always)]
    pub fn hcode92(&mut self) -> HCODE92_W<HUFFENC_AC1_46rs> {
        HCODE92_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 92
    #[inline(always)]
    pub fn hlen92(&mut self) -> HLEN92_W<HUFFENC_AC1_46rs> {
        HLEN92_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 93
    #[inline(always)]
    pub fn hcode93(&mut self) -> HCODE93_W<HUFFENC_AC1_46rs> {
        HCODE93_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 93
    #[inline(always)]
    pub fn hlen93(&mut self) -> HLEN93_W<HUFFENC_AC1_46rs> {
