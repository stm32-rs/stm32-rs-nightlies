///Register `HUFFENC_AC1_50` reader
pub type R = crate::R<HUFFENC_AC1_50rs>;
///Register `HUFFENC_AC1_50` writer
pub type W = crate::W<HUFFENC_AC1_50rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 100
    #[inline(always)]
    pub fn hcode100(&mut self) -> HCODE100_W<'_, HUFFENC_AC1_50rs> {
        HCODE100_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 100
    #[inline(always)]
    pub fn hlen100(&mut self) -> HLEN100_W<'_, HUFFENC_AC1_50rs> {
        HLEN100_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 101
    #[inline(always)]
    pub fn hcode101(&mut self) -> HCODE101_W<'_, HUFFENC_AC1_50rs> {
        HCODE101_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 101
    #[inline(always)]
    pub fn hlen101(&mut self) -> HLEN101_W<'_, HUFFENC_AC1_50rs> {
        HLEN101_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_50::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_50::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_50)*/
pub struct HUFFENC_AC1_50rs;
impl crate::RegisterSpec for HUFFENC_AC1_50rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_50::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_50rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_50::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_50rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_50 to value 0
impl crate::Resettable for HUFFENC_AC1_50rs {}
