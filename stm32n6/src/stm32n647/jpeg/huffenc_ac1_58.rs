///Register `HUFFENC_AC1_58` reader
pub type R = crate::R<HUFFENC_AC1_58rs>;
///Register `HUFFENC_AC1_58` writer
pub type W = crate::W<HUFFENC_AC1_58rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 116
    #[inline(always)]
    pub fn hcode116(&mut self) -> HCODE116_W<'_, HUFFENC_AC1_58rs> {
        HCODE116_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 116
    #[inline(always)]
    pub fn hlen116(&mut self) -> HLEN116_W<'_, HUFFENC_AC1_58rs> {
        HLEN116_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 117
    #[inline(always)]
    pub fn hcode117(&mut self) -> HCODE117_W<'_, HUFFENC_AC1_58rs> {
        HCODE117_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 117
    #[inline(always)]
    pub fn hlen117(&mut self) -> HLEN117_W<'_, HUFFENC_AC1_58rs> {
        HLEN117_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_58::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_58::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_58)*/
pub struct HUFFENC_AC1_58rs;
impl crate::RegisterSpec for HUFFENC_AC1_58rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_58::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_58rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_58::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_58rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_58 to value 0
impl crate::Resettable for HUFFENC_AC1_58rs {}
