///Register `HUFFENC_AC1_61` reader
pub type R = crate::R<HUFFENC_AC1_61rs>;
///Register `HUFFENC_AC1_61` writer
pub type W = crate::W<HUFFENC_AC1_61rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 122
    #[inline(always)]
    pub fn hcode122(&mut self) -> HCODE122_W<'_, HUFFENC_AC1_61rs> {
        HCODE122_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 122
    #[inline(always)]
    pub fn hlen122(&mut self) -> HLEN122_W<'_, HUFFENC_AC1_61rs> {
        HLEN122_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 123
    #[inline(always)]
    pub fn hcode123(&mut self) -> HCODE123_W<'_, HUFFENC_AC1_61rs> {
        HCODE123_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 123
    #[inline(always)]
    pub fn hlen123(&mut self) -> HLEN123_W<'_, HUFFENC_AC1_61rs> {
        HLEN123_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_61::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_61::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_61)*/
pub struct HUFFENC_AC1_61rs;
impl crate::RegisterSpec for HUFFENC_AC1_61rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_61::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_61rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_61::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_61rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_61 to value 0
impl crate::Resettable for HUFFENC_AC1_61rs {}
