...
impl W {
    ///Bits 0:7 - Huffman code 124
    #[inline(always)]
    pub fn hcode124(&mut self) -> HCODE124_W<HUFFENC_AC1_62rs> {
        HCODE124_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 124
    #[inline(always)]
    pub fn hlen124(&mut self) -> HLEN124_W<HUFFENC_AC1_62rs> {
        HLEN124_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 125
    #[inline(always)]
    pub fn hcode125(&mut self) -> HCODE125_W<HUFFENC_AC1_62rs> {
        HCODE125_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 125
    #[inline(always)]
    pub fn hlen125(&mut self) -> HLEN125_W<HUFFENC_AC1_62rs> {
