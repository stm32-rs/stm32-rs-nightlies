///Register `HUFFENC_AC1_62` reader
pub type R = crate::R<HUFFENC_AC1_62rs>;
///Register `HUFFENC_AC1_62` writer
pub type W = crate::W<HUFFENC_AC1_62rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 124
    #[inline(always)]
    pub fn hcode124(&mut self) -> HCODE124_W<'_, HUFFENC_AC1_62rs> {
        HCODE124_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 124
    #[inline(always)]
    pub fn hlen124(&mut self) -> HLEN124_W<'_, HUFFENC_AC1_62rs> {
        HLEN124_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 125
    #[inline(always)]
    pub fn hcode125(&mut self) -> HCODE125_W<'_, HUFFENC_AC1_62rs> {
        HCODE125_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 125
    #[inline(always)]
    pub fn hlen125(&mut self) -> HLEN125_W<'_, HUFFENC_AC1_62rs> {
        HLEN125_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_62::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_62::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_62)*/
pub struct HUFFENC_AC1_62rs;
impl crate::RegisterSpec for HUFFENC_AC1_62rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_62::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_62rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_62::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_62rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_62 to value 0
impl crate::Resettable for HUFFENC_AC1_62rs {}
