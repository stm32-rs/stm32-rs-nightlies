...
impl W {
    ///Bits 0:7 - Huffman code 134
    #[inline(always)]
    pub fn hcode134(&mut self) -> HCODE134_W<HUFFENC_AC1_67rs> {
        HCODE134_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 134
    #[inline(always)]
    pub fn hlen134(&mut self) -> HLEN134_W<HUFFENC_AC1_67rs> {
        HLEN134_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 135
    #[inline(always)]
    pub fn hcode135(&mut self) -> HCODE135_W<HUFFENC_AC1_67rs> {
        HCODE135_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 135
    #[inline(always)]
    pub fn hlen135(&mut self) -> HLEN135_W<HUFFENC_AC1_67rs> {
