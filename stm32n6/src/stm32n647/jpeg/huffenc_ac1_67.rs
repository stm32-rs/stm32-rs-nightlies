///Register `HUFFENC_AC1_67` reader
pub type R = crate::R<HUFFENC_AC1_67rs>;
///Register `HUFFENC_AC1_67` writer
pub type W = crate::W<HUFFENC_AC1_67rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 134
    #[inline(always)]
    pub fn hcode134(&mut self) -> HCODE134_W<'_, HUFFENC_AC1_67rs> {
        HCODE134_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 134
    #[inline(always)]
    pub fn hlen134(&mut self) -> HLEN134_W<'_, HUFFENC_AC1_67rs> {
        HLEN134_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 135
    #[inline(always)]
    pub fn hcode135(&mut self) -> HCODE135_W<'_, HUFFENC_AC1_67rs> {
        HCODE135_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 135
    #[inline(always)]
    pub fn hlen135(&mut self) -> HLEN135_W<'_, HUFFENC_AC1_67rs> {
        HLEN135_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_67::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_67::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_67)*/
pub struct HUFFENC_AC1_67rs;
impl crate::RegisterSpec for HUFFENC_AC1_67rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_67::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_67rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_67::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_67rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_67 to value 0
impl crate::Resettable for HUFFENC_AC1_67rs {}
