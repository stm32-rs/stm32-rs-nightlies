///Register `HUFFENC_AC1_70` reader
pub type R = crate::R<HUFFENC_AC1_70rs>;
///Register `HUFFENC_AC1_70` writer
pub type W = crate::W<HUFFENC_AC1_70rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 140
    #[inline(always)]
    pub fn hcode140(&mut self) -> HCODE140_W<'_, HUFFENC_AC1_70rs> {
        HCODE140_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 140
    #[inline(always)]
    pub fn hlen140(&mut self) -> HLEN140_W<'_, HUFFENC_AC1_70rs> {
        HLEN140_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 141
    #[inline(always)]
    pub fn hcode141(&mut self) -> HCODE141_W<'_, HUFFENC_AC1_70rs> {
        HCODE141_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 141
    #[inline(always)]
    pub fn hlen141(&mut self) -> HLEN141_W<'_, HUFFENC_AC1_70rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_70)*/
pub struct HUFFENC_AC1_70rs;
impl crate::RegisterSpec for HUFFENC_AC1_70rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_70::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_70rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_70::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_70rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_70 to value 0
impl crate::Resettable for HUFFENC_AC1_70rs {}
