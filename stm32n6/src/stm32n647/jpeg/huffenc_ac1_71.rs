...
impl W {
    ///Bits 0:7 - Huffman code 142
    #[inline(always)]
    pub fn hcode142(&mut self) -> HCODE142_W<HUFFENC_AC1_71rs> {
        HCODE142_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 142
    #[inline(always)]
    pub fn hlen142(&mut self) -> HLEN142_W<HUFFENC_AC1_71rs> {
        HLEN142_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 143
    #[inline(always)]
    pub fn hcode143(&mut self) -> HCODE143_W<HUFFENC_AC1_71rs> {
        HCODE143_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 143
    #[inline(always)]
    pub fn hlen143(&mut self) -> HLEN143_W<HUFFENC_AC1_71rs> {
