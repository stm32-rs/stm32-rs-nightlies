///Register `HUFFENC_AC1_71` reader
pub type R = crate::R<HUFFENC_AC1_71rs>;
///Register `HUFFENC_AC1_71` writer
pub type W = crate::W<HUFFENC_AC1_71rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 142
    #[inline(always)]
    pub fn hcode142(&mut self) -> HCODE142_W<'_, HUFFENC_AC1_71rs> {
        HCODE142_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 142
    #[inline(always)]
    pub fn hlen142(&mut self) -> HLEN142_W<'_, HUFFENC_AC1_71rs> {
        HLEN142_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 143
    #[inline(always)]
    pub fn hcode143(&mut self) -> HCODE143_W<'_, HUFFENC_AC1_71rs> {
        HCODE143_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 143
    #[inline(always)]
    pub fn hlen143(&mut self) -> HLEN143_W<'_, HUFFENC_AC1_71rs> {
        HLEN143_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_71::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_71::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_71)*/
pub struct HUFFENC_AC1_71rs;
impl crate::RegisterSpec for HUFFENC_AC1_71rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_71::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_71rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_71::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_71rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_71 to value 0
impl crate::Resettable for HUFFENC_AC1_71rs {}
