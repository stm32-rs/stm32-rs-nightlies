...
impl W {
    ///Bits 0:7 - Huffman code 146
    #[inline(always)]
    pub fn hcode146(&mut self) -> HCODE146_W<HUFFENC_AC1_73rs> {
        HCODE146_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 146
    #[inline(always)]
    pub fn hlen146(&mut self) -> HLEN146_W<HUFFENC_AC1_73rs> {
        HLEN146_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 147
    #[inline(always)]
    pub fn hcode147(&mut self) -> HCODE147_W<HUFFENC_AC1_73rs> {
        HCODE147_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 147
    #[inline(always)]
    pub fn hlen147(&mut self) -> HLEN147_W<HUFFENC_AC1_73rs> {
