///Register `HUFFENC_AC1_73` reader
pub type R = crate::R<HUFFENC_AC1_73rs>;
///Register `HUFFENC_AC1_73` writer
pub type W = crate::W<HUFFENC_AC1_73rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 146
    #[inline(always)]
    pub fn hcode146(&mut self) -> HCODE146_W<'_, HUFFENC_AC1_73rs> {
        HCODE146_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 146
    #[inline(always)]
    pub fn hlen146(&mut self) -> HLEN146_W<'_, HUFFENC_AC1_73rs> {
        HLEN146_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 147
    #[inline(always)]
    pub fn hcode147(&mut self) -> HCODE147_W<'_, HUFFENC_AC1_73rs> {
        HCODE147_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 147
    #[inline(always)]
    pub fn hlen147(&mut self) -> HLEN147_W<'_, HUFFENC_AC1_73rs> {
        HLEN147_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_73::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_73::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_73)*/
pub struct HUFFENC_AC1_73rs;
impl crate::RegisterSpec for HUFFENC_AC1_73rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_73::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_73rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_73::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_73rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_73 to value 0
impl crate::Resettable for HUFFENC_AC1_73rs {}
