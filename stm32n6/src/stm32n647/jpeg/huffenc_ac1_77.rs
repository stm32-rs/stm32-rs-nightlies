///Register `HUFFENC_AC1_77` reader
pub type R = crate::R<HUFFENC_AC1_77rs>;
///Register `HUFFENC_AC1_77` writer
pub type W = crate::W<HUFFENC_AC1_77rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 154
    #[inline(always)]
    pub fn hcode154(&mut self) -> HCODE154_W<'_, HUFFENC_AC1_77rs> {
        HCODE154_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 154
    #[inline(always)]
    pub fn hlen154(&mut self) -> HLEN154_W<'_, HUFFENC_AC1_77rs> {
        HLEN154_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 155
    #[inline(always)]
    pub fn hcode155(&mut self) -> HCODE155_W<'_, HUFFENC_AC1_77rs> {
        HCODE155_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 155
    #[inline(always)]
    pub fn hlen155(&mut self) -> HLEN155_W<'_, HUFFENC_AC1_77rs> {
        HLEN155_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_77::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_77::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_77)*/
pub struct HUFFENC_AC1_77rs;
impl crate::RegisterSpec for HUFFENC_AC1_77rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_77::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_77rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_77::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_77rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_77 to value 0
impl crate::Resettable for HUFFENC_AC1_77rs {}
