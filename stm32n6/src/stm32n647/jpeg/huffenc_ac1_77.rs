...
impl W {
    ///Bits 0:7 - Huffman code 154
    #[inline(always)]
    pub fn hcode154(&mut self) -> HCODE154_W<HUFFENC_AC1_77rs> {
        HCODE154_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 154
    #[inline(always)]
    pub fn hlen154(&mut self) -> HLEN154_W<HUFFENC_AC1_77rs> {
        HLEN154_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 155
    #[inline(always)]
    pub fn hcode155(&mut self) -> HCODE155_W<HUFFENC_AC1_77rs> {
        HCODE155_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 155
    #[inline(always)]
    pub fn hlen155(&mut self) -> HLEN155_W<HUFFENC_AC1_77rs> {
