///Register `HUFFENC_AC1_79` reader
pub type R = crate::R<HUFFENC_AC1_79rs>;
///Register `HUFFENC_AC1_79` writer
pub type W = crate::W<HUFFENC_AC1_79rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 158
    #[inline(always)]
    pub fn hcode158(&mut self) -> HCODE158_W<'_, HUFFENC_AC1_79rs> {
        HCODE158_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 158
    #[inline(always)]
    pub fn hlen158(&mut self) -> HLEN158_W<'_, HUFFENC_AC1_79rs> {
        HLEN158_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 159
    #[inline(always)]
    pub fn hcode159(&mut self) -> HCODE159_W<'_, HUFFENC_AC1_79rs> {
        HCODE159_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 159
    #[inline(always)]
    pub fn hlen159(&mut self) -> HLEN159_W<'_, HUFFENC_AC1_79rs> {
        HLEN159_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_79::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_79::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_79)*/
pub struct HUFFENC_AC1_79rs;
impl crate::RegisterSpec for HUFFENC_AC1_79rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_79::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_79rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_79::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_79rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_79 to value 0
impl crate::Resettable for HUFFENC_AC1_79rs {}
