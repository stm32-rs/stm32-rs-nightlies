///Register `HUFFENC_AC1_8` reader
pub type R = crate::R<HUFFENC_AC1_8rs>;
///Register `HUFFENC_AC1_8` writer
pub type W = crate::W<HUFFENC_AC1_8rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 16
    #[inline(always)]
    pub fn hcode16(&mut self) -> HCODE16_W<'_, HUFFENC_AC1_8rs> {
        HCODE16_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 16
    #[inline(always)]
    pub fn hlen16(&mut self) -> HLEN16_W<'_, HUFFENC_AC1_8rs> {
        HLEN16_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 17
    #[inline(always)]
    pub fn hcode17(&mut self) -> HCODE17_W<'_, HUFFENC_AC1_8rs> {
        HCODE17_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 17
    #[inline(always)]
    pub fn hlen17(&mut self) -> HLEN17_W<'_, HUFFENC_AC1_8rs> {
        HLEN17_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_8)*/
pub struct HUFFENC_AC1_8rs;
impl crate::RegisterSpec for HUFFENC_AC1_8rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_8::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_8rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_8::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_8rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_8 to value 0
impl crate::Resettable for HUFFENC_AC1_8rs {}
