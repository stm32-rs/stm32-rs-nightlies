///Register `HUFFENC_AC1_82` reader
pub type R = crate::R<HUFFENC_AC1_82rs>;
///Register `HUFFENC_AC1_82` writer
pub type W = crate::W<HUFFENC_AC1_82rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 164
    #[inline(always)]
    pub fn hcode164(&mut self) -> HCODE164_W<'_, HUFFENC_AC1_82rs> {
        HCODE164_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 164
    #[inline(always)]
    pub fn hlen164(&mut self) -> HLEN164_W<'_, HUFFENC_AC1_82rs> {
        HLEN164_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 165
    #[inline(always)]
    pub fn hcode165(&mut self) -> HCODE165_W<'_, HUFFENC_AC1_82rs> {
        HCODE165_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 165
    #[inline(always)]
    pub fn hlen165(&mut self) -> HLEN165_W<'_, HUFFENC_AC1_82rs> {
        HLEN165_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_82::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_82::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_82)*/
pub struct HUFFENC_AC1_82rs;
impl crate::RegisterSpec for HUFFENC_AC1_82rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_82::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_82rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_82::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_82rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_82 to value 0
impl crate::Resettable for HUFFENC_AC1_82rs {}
