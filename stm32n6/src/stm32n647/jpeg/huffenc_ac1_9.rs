///Register `HUFFENC_AC1_9` reader
pub type R = crate::R<HUFFENC_AC1_9rs>;
///Register `HUFFENC_AC1_9` writer
pub type W = crate::W<HUFFENC_AC1_9rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 18
    #[inline(always)]
    pub fn hcode18(&mut self) -> HCODE18_W<'_, HUFFENC_AC1_9rs> {
        HCODE18_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 18
    #[inline(always)]
    pub fn hlen18(&mut self) -> HLEN18_W<'_, HUFFENC_AC1_9rs> {
        HLEN18_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 19
    #[inline(always)]
    pub fn hcode19(&mut self) -> HCODE19_W<'_, HUFFENC_AC1_9rs> {
        HCODE19_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 19
    #[inline(always)]
    pub fn hlen19(&mut self) -> HLEN19_W<'_, HUFFENC_AC1_9rs> {
        HLEN19_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFENC_AC1_9)*/
pub struct HUFFENC_AC1_9rs;
impl crate::RegisterSpec for HUFFENC_AC1_9rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_9::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_9rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_9::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_9rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_9 to value 0
impl crate::Resettable for HUFFENC_AC1_9rs {}
