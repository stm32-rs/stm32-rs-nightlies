...
impl W {
    ///Bits 0:7 - Data 0
    #[inline(always)]
    pub fn data0(&mut self) -> DATA0_W<HUFFSYMB0rs> {
        DATA0_W::new(self, 0)
    }
    ///Bits 8:15 - Data 1
    #[inline(always)]
    pub fn data1(&mut self) -> DATA1_W<HUFFSYMB0rs> {
        DATA1_W::new(self, 8)
    }
    ///Bits 16:23 - Data 2
    #[inline(always)]
    pub fn data2(&mut self) -> DATA2_W<HUFFSYMB0rs> {
        DATA2_W::new(self, 16)
    }
    ///Bits 24:31 - Data 3
    #[inline(always)]
    pub fn data3(&mut self) -> DATA3_W<HUFFSYMB0rs> {
        DATA3_W::new(self, 24)
    }
}
/**JPEG Huffman symbol
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB0)*/
