...
impl W {
    ///Bits 0:7 - Data 40
    #[inline(always)]
    pub fn data40(&mut self) -> DATA40_W<HUFFSYMB10rs> {
        DATA40_W::new(self, 0)
    }
    ///Bits 8:15 - Data 41
    #[inline(always)]
    pub fn data41(&mut self) -> DATA41_W<HUFFSYMB10rs> {
        DATA41_W::new(self, 8)
    }
    ///Bits 16:23 - Data 42
    #[inline(always)]
    pub fn data42(&mut self) -> DATA42_W<HUFFSYMB10rs> {
        DATA42_W::new(self, 16)
    }
    ///Bits 24:31 - Data 43
    #[inline(always)]
    pub fn data43(&mut self) -> DATA43_W<HUFFSYMB10rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB10)*/
