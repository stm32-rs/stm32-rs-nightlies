...
impl W {
    ///Bits 0:7 - Data 52
    #[inline(always)]
    pub fn data52(&mut self) -> DATA52_W<HUFFSYMB13rs> {
        DATA52_W::new(self, 0)
    }
    ///Bits 8:15 - Data 53
    #[inline(always)]
    pub fn data53(&mut self) -> DATA53_W<HUFFSYMB13rs> {
        DATA53_W::new(self, 8)
    }
    ///Bits 16:23 - Data 54
    #[inline(always)]
    pub fn data54(&mut self) -> DATA54_W<HUFFSYMB13rs> {
        DATA54_W::new(self, 16)
    }
    ///Bits 24:31 - Data 55
    #[inline(always)]
    pub fn data55(&mut self) -> DATA55_W<HUFFSYMB13rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB13)*/
