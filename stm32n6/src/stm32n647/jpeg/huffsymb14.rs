...
impl W {
    ///Bits 0:7 - Data 56
    #[inline(always)]
    pub fn data56(&mut self) -> DATA56_W<HUFFSYMB14rs> {
        DATA56_W::new(self, 0)
    }
    ///Bits 8:15 - Data 57
    #[inline(always)]
    pub fn data57(&mut self) -> DATA57_W<HUFFSYMB14rs> {
        DATA57_W::new(self, 8)
    }
    ///Bits 16:23 - Data 58
    #[inline(always)]
    pub fn data58(&mut self) -> DATA58_W<HUFFSYMB14rs> {
        DATA58_W::new(self, 16)
    }
    ///Bits 24:31 - Data 59
    #[inline(always)]
    pub fn data59(&mut self) -> DATA59_W<HUFFSYMB14rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB14)*/
