...
impl W {
    ///Bits 0:7 - Data 60
    #[inline(always)]
    pub fn data60(&mut self) -> DATA60_W<'_, HUFFSYMB15rs> {
        DATA60_W::new(self, 0)
    }
    ///Bits 8:15 - Data 61
    #[inline(always)]
    pub fn data61(&mut self) -> DATA61_W<'_, HUFFSYMB15rs> {
        DATA61_W::new(self, 8)
    }
    ///Bits 16:23 - Data 62
    #[inline(always)]
    pub fn data62(&mut self) -> DATA62_W<'_, HUFFSYMB15rs> {
        DATA62_W::new(self, 16)
    }
    ///Bits 24:31 - Data 63
    #[inline(always)]
    pub fn data63(&mut self) -> DATA63_W<'_, HUFFSYMB15rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB15)*/
