...
impl W {
    ///Bits 0:7 - Data 68
    #[inline(always)]
    pub fn data68(&mut self) -> DATA68_W<HUFFSYMB17rs> {
        DATA68_W::new(self, 0)
    }
    ///Bits 8:15 - Data 69
    #[inline(always)]
    pub fn data69(&mut self) -> DATA69_W<HUFFSYMB17rs> {
        DATA69_W::new(self, 8)
    }
    ///Bits 16:23 - Data 70
    #[inline(always)]
    pub fn data70(&mut self) -> DATA70_W<HUFFSYMB17rs> {
        DATA70_W::new(self, 16)
    }
    ///Bits 24:31 - Data 71
    #[inline(always)]
    pub fn data71(&mut self) -> DATA71_W<HUFFSYMB17rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB17)*/
