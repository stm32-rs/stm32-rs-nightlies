...
impl W {
    ///Bits 0:7 - Data 96
    #[inline(always)]
    pub fn data96(&mut self) -> DATA96_W<HUFFSYMB24rs> {
        DATA96_W::new(self, 0)
    }
    ///Bits 8:15 - Data 97
    #[inline(always)]
    pub fn data97(&mut self) -> DATA97_W<HUFFSYMB24rs> {
        DATA97_W::new(self, 8)
    }
    ///Bits 16:23 - Data 98
    #[inline(always)]
    pub fn data98(&mut self) -> DATA98_W<HUFFSYMB24rs> {
        DATA98_W::new(self, 16)
    }
    ///Bits 24:31 - Data 99
    #[inline(always)]
    pub fn data99(&mut self) -> DATA99_W<HUFFSYMB24rs> {
