...
impl W {
    ///Bits 0:7 - Data 100
    #[inline(always)]
    pub fn data100(&mut self) -> DATA100_W<HUFFSYMB25rs> {
        DATA100_W::new(self, 0)
    }
    ///Bits 8:15 - Data 101
    #[inline(always)]
    pub fn data101(&mut self) -> DATA101_W<HUFFSYMB25rs> {
        DATA101_W::new(self, 8)
    }
    ///Bits 16:23 - Data 102
    #[inline(always)]
    pub fn data102(&mut self) -> DATA102_W<HUFFSYMB25rs> {
        DATA102_W::new(self, 16)
    }
    ///Bits 24:31 - Data 103
    #[inline(always)]
    pub fn data103(&mut self) -> DATA103_W<HUFFSYMB25rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB25)*/
