...
impl W {
    ///Bits 0:7 - Data 108
    #[inline(always)]
    pub fn data108(&mut self) -> DATA108_W<HUFFSYMB27rs> {
        DATA108_W::new(self, 0)
    }
    ///Bits 8:15 - Data 109
    #[inline(always)]
    pub fn data109(&mut self) -> DATA109_W<HUFFSYMB27rs> {
        DATA109_W::new(self, 8)
    }
    ///Bits 16:23 - Data 110
    #[inline(always)]
    pub fn data110(&mut self) -> DATA110_W<HUFFSYMB27rs> {
        DATA110_W::new(self, 16)
    }
    ///Bits 24:31 - Data 111
    #[inline(always)]
    pub fn data111(&mut self) -> DATA111_W<HUFFSYMB27rs> {
