...
impl W {
    ///Bits 0:7 - Data 128
    #[inline(always)]
    pub fn data128(&mut self) -> DATA128_W<HUFFSYMB32rs> {
        DATA128_W::new(self, 0)
    }
    ///Bits 8:15 - Data 129
    #[inline(always)]
    pub fn data129(&mut self) -> DATA129_W<HUFFSYMB32rs> {
        DATA129_W::new(self, 8)
    }
    ///Bits 16:23 - Data 130
    #[inline(always)]
    pub fn data130(&mut self) -> DATA130_W<HUFFSYMB32rs> {
        DATA130_W::new(self, 16)
    }
    ///Bits 24:31 - Data 131
    #[inline(always)]
    pub fn data131(&mut self) -> DATA131_W<HUFFSYMB32rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB32)*/
