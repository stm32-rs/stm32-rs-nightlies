...
impl W {
    ///Bits 0:7 - Data 144
    #[inline(always)]
    pub fn data144(&mut self) -> DATA144_W<HUFFSYMB36rs> {
        DATA144_W::new(self, 0)
    }
    ///Bits 8:15 - Data 145
    #[inline(always)]
    pub fn data145(&mut self) -> DATA145_W<HUFFSYMB36rs> {
        DATA145_W::new(self, 8)
    }
    ///Bits 16:23 - Data 146
    #[inline(always)]
    pub fn data146(&mut self) -> DATA146_W<HUFFSYMB36rs> {
        DATA146_W::new(self, 16)
    }
    ///Bits 24:31 - Data 147
    #[inline(always)]
    pub fn data147(&mut self) -> DATA147_W<HUFFSYMB36rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB36)*/
