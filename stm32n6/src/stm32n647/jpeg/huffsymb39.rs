...
impl W {
    ///Bits 0:7 - Data 156
    #[inline(always)]
    pub fn data156(&mut self) -> DATA156_W<HUFFSYMB39rs> {
        DATA156_W::new(self, 0)
    }
    ///Bits 8:15 - Data 157
    #[inline(always)]
    pub fn data157(&mut self) -> DATA157_W<HUFFSYMB39rs> {
        DATA157_W::new(self, 8)
    }
    ///Bits 16:23 - Data 158
    #[inline(always)]
    pub fn data158(&mut self) -> DATA158_W<HUFFSYMB39rs> {
        DATA158_W::new(self, 16)
    }
    ///Bits 24:31 - Data 159
    #[inline(always)]
    pub fn data159(&mut self) -> DATA159_W<HUFFSYMB39rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB39)*/
