...
impl W {
    ///Bits 0:7 - Data 160
    #[inline(always)]
    pub fn data160(&mut self) -> DATA160_W<HUFFSYMB40rs> {
        DATA160_W::new(self, 0)
    }
    ///Bits 8:15 - Data 161
    #[inline(always)]
    pub fn data161(&mut self) -> DATA161_W<HUFFSYMB40rs> {
        DATA161_W::new(self, 8)
    }
    ///Bits 16:23 - Data 162
    #[inline(always)]
    pub fn data162(&mut self) -> DATA162_W<HUFFSYMB40rs> {
        DATA162_W::new(self, 16)
    }
    ///Bits 24:31 - Data 163
    #[inline(always)]
    pub fn data163(&mut self) -> DATA163_W<HUFFSYMB40rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB40)*/
