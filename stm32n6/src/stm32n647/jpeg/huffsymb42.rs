...
impl W {
    ///Bits 0:7 - Data 168
    #[inline(always)]
    pub fn data168(&mut self) -> DATA168_W<HUFFSYMB42rs> {
        DATA168_W::new(self, 0)
    }
    ///Bits 8:15 - Data 169
    #[inline(always)]
    pub fn data169(&mut self) -> DATA169_W<HUFFSYMB42rs> {
        DATA169_W::new(self, 8)
    }
    ///Bits 16:23 - Data 170
    #[inline(always)]
    pub fn data170(&mut self) -> DATA170_W<HUFFSYMB42rs> {
        DATA170_W::new(self, 16)
    }
    ///Bits 24:31 - Data 171
    #[inline(always)]
    pub fn data171(&mut self) -> DATA171_W<HUFFSYMB42rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB42)*/
