...
impl W {
    ///Bits 0:7 - Data 180
    #[inline(always)]
    pub fn data180(&mut self) -> DATA180_W<HUFFSYMB45rs> {
        DATA180_W::new(self, 0)
    }
    ///Bits 8:15 - Data 181
    #[inline(always)]
    pub fn data181(&mut self) -> DATA181_W<HUFFSYMB45rs> {
        DATA181_W::new(self, 8)
    }
    ///Bits 16:23 - Data 182
    #[inline(always)]
    pub fn data182(&mut self) -> DATA182_W<HUFFSYMB45rs> {
        DATA182_W::new(self, 16)
    }
    ///Bits 24:31 - Data 183
    #[inline(always)]
    pub fn data183(&mut self) -> DATA183_W<HUFFSYMB45rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB45)*/
