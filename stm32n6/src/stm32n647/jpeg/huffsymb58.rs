...
impl W {
    ///Bits 0:7 - Data 232
    #[inline(always)]
    pub fn data232(&mut self) -> DATA232_W<HUFFSYMB58rs> {
        DATA232_W::new(self, 0)
    }
    ///Bits 8:15 - Data 233
    #[inline(always)]
    pub fn data233(&mut self) -> DATA233_W<HUFFSYMB58rs> {
        DATA233_W::new(self, 8)
    }
    ///Bits 16:23 - Data 234
    #[inline(always)]
    pub fn data234(&mut self) -> DATA234_W<HUFFSYMB58rs> {
        DATA234_W::new(self, 16)
    }
    ///Bits 24:31 - Data 235
    #[inline(always)]
    pub fn data235(&mut self) -> DATA235_W<HUFFSYMB58rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB58)*/
