...
impl W {
    ///Bits 0:7 - Data 252
    #[inline(always)]
    pub fn data252(&mut self) -> DATA252_W<HUFFSYMB63rs> {
        DATA252_W::new(self, 0)
    }
    ///Bits 8:15 - Data 253
    #[inline(always)]
    pub fn data253(&mut self) -> DATA253_W<HUFFSYMB63rs> {
        DATA253_W::new(self, 8)
    }
    ///Bits 16:23 - Data 254
    #[inline(always)]
    pub fn data254(&mut self) -> DATA254_W<HUFFSYMB63rs> {
        DATA254_W::new(self, 16)
    }
    ///Bits 24:31 - Data 255
    #[inline(always)]
    pub fn data255(&mut self) -> DATA255_W<HUFFSYMB63rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB63)*/
