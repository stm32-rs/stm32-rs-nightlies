...
impl W {
    ///Bits 0:7 - Data 264
    #[inline(always)]
    pub fn data264(&mut self) -> DATA264_W<HUFFSYMB66rs> {
        DATA264_W::new(self, 0)
    }
    ///Bits 8:15 - Data 265
    #[inline(always)]
    pub fn data265(&mut self) -> DATA265_W<HUFFSYMB66rs> {
        DATA265_W::new(self, 8)
    }
    ///Bits 16:23 - Data 266
    #[inline(always)]
    pub fn data266(&mut self) -> DATA266_W<HUFFSYMB66rs> {
        DATA266_W::new(self, 16)
    }
    ///Bits 24:31 - Data 267
    #[inline(always)]
    pub fn data267(&mut self) -> DATA267_W<HUFFSYMB66rs> {
