...
impl W {
    ///Bits 0:7 - Data 272
    #[inline(always)]
    pub fn data272(&mut self) -> DATA272_W<'_, HUFFSYMB68rs> {
        DATA272_W::new(self, 0)
    }
    ///Bits 8:15 - Data 273
    #[inline(always)]
    pub fn data273(&mut self) -> DATA273_W<'_, HUFFSYMB68rs> {
        DATA273_W::new(self, 8)
    }
    ///Bits 16:23 - Data 274
    #[inline(always)]
    pub fn data274(&mut self) -> DATA274_W<'_, HUFFSYMB68rs> {
        DATA274_W::new(self, 16)
    }
    ///Bits 24:31 - Data 275
    #[inline(always)]
    pub fn data275(&mut self) -> DATA275_W<'_, HUFFSYMB68rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB68)*/
