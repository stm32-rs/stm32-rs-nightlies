...
impl W {
    ///Bits 0:7 - Data 284
    #[inline(always)]
    pub fn data284(&mut self) -> DATA284_W<HUFFSYMB71rs> {
        DATA284_W::new(self, 0)
    }
    ///Bits 8:15 - Data 285
    #[inline(always)]
    pub fn data285(&mut self) -> DATA285_W<HUFFSYMB71rs> {
        DATA285_W::new(self, 8)
    }
    ///Bits 16:23 - Data 286
    #[inline(always)]
    pub fn data286(&mut self) -> DATA286_W<HUFFSYMB71rs> {
        DATA286_W::new(self, 16)
    }
    ///Bits 24:31 - Data 287
    #[inline(always)]
    pub fn data287(&mut self) -> DATA287_W<HUFFSYMB71rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB71)*/
