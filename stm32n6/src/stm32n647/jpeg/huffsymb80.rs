...
impl W {
    ///Bits 0:7 - Data 320
    #[inline(always)]
    pub fn data320(&mut self) -> DATA320_W<HUFFSYMB80rs> {
        DATA320_W::new(self, 0)
    }
    ///Bits 8:15 - Data 321
    #[inline(always)]
    pub fn data321(&mut self) -> DATA321_W<HUFFSYMB80rs> {
        DATA321_W::new(self, 8)
    }
    ///Bits 16:23 - Data 322
    #[inline(always)]
    pub fn data322(&mut self) -> DATA322_W<HUFFSYMB80rs> {
        DATA322_W::new(self, 16)
    }
    ///Bits 24:31 - Data 323
    #[inline(always)]
    pub fn data323(&mut self) -> DATA323_W<HUFFSYMB80rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:HUFFSYMB80)*/
