...
impl W {
    ///Bits 0:7 - Quantization coefficient 28
    #[inline(always)]
    pub fn qcoef28(&mut self) -> QCOEF28_W<QMEM0_7rs> {
        QCOEF28_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 29
    #[inline(always)]
    pub fn qcoef29(&mut self) -> QCOEF29_W<QMEM0_7rs> {
        QCOEF29_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 30
    #[inline(always)]
    pub fn qcoef30(&mut self) -> QCOEF30_W<QMEM0_7rs> {
        QCOEF30_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 31
    #[inline(always)]
    pub fn qcoef31(&mut self) -> QCOEF31_W<QMEM0_7rs> {
