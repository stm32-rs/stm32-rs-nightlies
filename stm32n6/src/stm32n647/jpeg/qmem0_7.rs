///Register `QMEM0_7` reader
pub type R = crate::R<QMEM0_7rs>;
///Register `QMEM0_7` writer
pub type W = crate::W<QMEM0_7rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 28
    #[inline(always)]
    pub fn qcoef28(&mut self) -> QCOEF28_W<'_, QMEM0_7rs> {
        QCOEF28_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 29
    #[inline(always)]
    pub fn qcoef29(&mut self) -> QCOEF29_W<'_, QMEM0_7rs> {
        QCOEF29_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 30
    #[inline(always)]
    pub fn qcoef30(&mut self) -> QCOEF30_W<'_, QMEM0_7rs> {
        QCOEF30_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 31
    #[inline(always)]
    pub fn qcoef31(&mut self) -> QCOEF31_W<'_, QMEM0_7rs> {
        QCOEF31_W::new(self, 24)
    }
}
/**JPEG quantization memory 0

You can [`read`](crate::Reg::read) this register and get [`qmem0_7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem0_7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:QMEM0_7)*/
pub struct QMEM0_7rs;
impl crate::RegisterSpec for QMEM0_7rs {
    type Ux = u32;
}
///`read()` method returns [`qmem0_7::R`](R) reader structure
impl crate::Readable for QMEM0_7rs {}
///`write(|w| ..)` method takes [`qmem0_7::W`](W) writer structure
impl crate::Writable for QMEM0_7rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM0_7 to value 0
impl crate::Resettable for QMEM0_7rs {}
