...
impl W {
    ///Bits 0:7 - Quantization coefficient 36
    #[inline(always)]
    pub fn qcoef36(&mut self) -> QCOEF36_W<QMEM0_9rs> {
        QCOEF36_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 37
    #[inline(always)]
    pub fn qcoef37(&mut self) -> QCOEF37_W<QMEM0_9rs> {
        QCOEF37_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 38
    #[inline(always)]
    pub fn qcoef38(&mut self) -> QCOEF38_W<QMEM0_9rs> {
        QCOEF38_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 39
    #[inline(always)]
    pub fn qcoef39(&mut self) -> QCOEF39_W<QMEM0_9rs> {
