...
impl W {
    ///Bits 0:7 - Quantization coefficient 16
    #[inline(always)]
    pub fn qcoef16(&mut self) -> QCOEF16_W<QMEM1_4rs> {
        QCOEF16_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 17
    #[inline(always)]
    pub fn qcoef17(&mut self) -> QCOEF17_W<QMEM1_4rs> {
        QCOEF17_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 18
    #[inline(always)]
    pub fn qcoef18(&mut self) -> QCOEF18_W<QMEM1_4rs> {
        QCOEF18_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 19
    #[inline(always)]
    pub fn qcoef19(&mut self) -> QCOEF19_W<QMEM1_4rs> {
