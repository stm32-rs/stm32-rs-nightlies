///Register `QMEM1_5` reader
pub type R = crate::R<QMEM1_5rs>;
///Register `QMEM1_5` writer
pub type W = crate::W<QMEM1_5rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 20
    #[inline(always)]
    pub fn qcoef20(&mut self) -> QCOEF20_W<'_, QMEM1_5rs> {
        QCOEF20_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 21
    #[inline(always)]
    pub fn qcoef21(&mut self) -> QCOEF21_W<'_, QMEM1_5rs> {
        QCOEF21_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 22
    #[inline(always)]
    pub fn qcoef22(&mut self) -> QCOEF22_W<'_, QMEM1_5rs> {
        QCOEF22_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 23
    #[inline(always)]
    pub fn qcoef23(&mut self) -> QCOEF23_W<'_, QMEM1_5rs> {
        QCOEF23_W::new(self, 24)
    }
}
/**JPEG quantization memory 1

You can [`read`](crate::Reg::read) this register and get [`qmem1_5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem1_5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:QMEM1_5)*/
pub struct QMEM1_5rs;
impl crate::RegisterSpec for QMEM1_5rs {
    type Ux = u32;
}
///`read()` method returns [`qmem1_5::R`](R) reader structure
impl crate::Readable for QMEM1_5rs {}
///`write(|w| ..)` method takes [`qmem1_5::W`](W) writer structure
impl crate::Writable for QMEM1_5rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM1_5 to value 0
impl crate::Resettable for QMEM1_5rs {}
