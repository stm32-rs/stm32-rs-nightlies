...
impl W {
    ///Bits 0:7 - Quantization coefficient 24
    #[inline(always)]
    pub fn qcoef24(&mut self) -> QCOEF24_W<QMEM1_6rs> {
        QCOEF24_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 25
    #[inline(always)]
    pub fn qcoef25(&mut self) -> QCOEF25_W<QMEM1_6rs> {
        QCOEF25_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 26
    #[inline(always)]
    pub fn qcoef26(&mut self) -> QCOEF26_W<QMEM1_6rs> {
        QCOEF26_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 27
    #[inline(always)]
    pub fn qcoef27(&mut self) -> QCOEF27_W<QMEM1_6rs> {
