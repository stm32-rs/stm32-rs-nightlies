///Register `QMEM1_8` reader
pub type R = crate::R<QMEM1_8rs>;
///Register `QMEM1_8` writer
pub type W = crate::W<QMEM1_8rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 32
    #[inline(always)]
    pub fn qcoef32(&mut self) -> QCOEF32_W<'_, QMEM1_8rs> {
        QCOEF32_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 33
    #[inline(always)]
    pub fn qcoef33(&mut self) -> QCOEF33_W<'_, QMEM1_8rs> {
        QCOEF33_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 34
    #[inline(always)]
    pub fn qcoef34(&mut self) -> QCOEF34_W<'_, QMEM1_8rs> {
        QCOEF34_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 35
    #[inline(always)]
    pub fn qcoef35(&mut self) -> QCOEF35_W<'_, QMEM1_8rs> {
        QCOEF35_W::new(self, 24)
    }
}
/**JPEG quantization memory 1

You can [`read`](crate::Reg::read) this register and get [`qmem1_8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem1_8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:QMEM1_8)*/
pub struct QMEM1_8rs;
impl crate::RegisterSpec for QMEM1_8rs {
    type Ux = u32;
}
///`read()` method returns [`qmem1_8::R`](R) reader structure
impl crate::Readable for QMEM1_8rs {}
///`write(|w| ..)` method takes [`qmem1_8::W`](W) writer structure
impl crate::Writable for QMEM1_8rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM1_8 to value 0
impl crate::Resettable for QMEM1_8rs {}
