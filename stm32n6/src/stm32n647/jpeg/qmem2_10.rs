///Register `QMEM2_10` reader
pub type R = crate::R<QMEM2_10rs>;
///Register `QMEM2_10` writer
pub type W = crate::W<QMEM2_10rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 40
    #[inline(always)]
    pub fn qcoef40(&mut self) -> QCOEF40_W<'_, QMEM2_10rs> {
        QCOEF40_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 41
    #[inline(always)]
    pub fn qcoef41(&mut self) -> QCOEF41_W<'_, QMEM2_10rs> {
        QCOEF41_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 42
    #[inline(always)]
    pub fn qcoef42(&mut self) -> QCOEF42_W<'_, QMEM2_10rs> {
        QCOEF42_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 43
    #[inline(always)]
    pub fn qcoef43(&mut self) -> QCOEF43_W<'_, QMEM2_10rs> {
        QCOEF43_W::new(self, 24)
    }
}
/**JPEG quantization memory 2

You can [`read`](crate::Reg::read) this register and get [`qmem2_10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem2_10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:QMEM2_10)*/
pub struct QMEM2_10rs;
impl crate::RegisterSpec for QMEM2_10rs {
    type Ux = u32;
}
///`read()` method returns [`qmem2_10::R`](R) reader structure
impl crate::Readable for QMEM2_10rs {}
///`write(|w| ..)` method takes [`qmem2_10::W`](W) writer structure
impl crate::Writable for QMEM2_10rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM2_10 to value 0
impl crate::Resettable for QMEM2_10rs {}
