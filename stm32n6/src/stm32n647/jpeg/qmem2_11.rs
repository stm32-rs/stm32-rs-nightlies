///Register `QMEM2_11` reader
pub type R = crate::R<QMEM2_11rs>;
///Register `QMEM2_11` writer
pub type W = crate::W<QMEM2_11rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 44
    #[inline(always)]
    pub fn qcoef44(&mut self) -> QCOEF44_W<'_, QMEM2_11rs> {
        QCOEF44_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 45
    #[inline(always)]
    pub fn qcoef45(&mut self) -> QCOEF45_W<'_, QMEM2_11rs> {
        QCOEF45_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 46
    #[inline(always)]
    pub fn qcoef46(&mut self) -> QCOEF46_W<'_, QMEM2_11rs> {
        QCOEF46_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 47
    #[inline(always)]
    pub fn qcoef47(&mut self) -> QCOEF47_W<'_, QMEM2_11rs> {
        QCOEF47_W::new(self, 24)
    }
}
/**JPEG quantization memory 2

You can [`read`](crate::Reg::read) this register and get [`qmem2_11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem2_11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:QMEM2_11)*/
pub struct QMEM2_11rs;
impl crate::RegisterSpec for QMEM2_11rs {
    type Ux = u32;
}
///`read()` method returns [`qmem2_11::R`](R) reader structure
impl crate::Readable for QMEM2_11rs {}
///`write(|w| ..)` method takes [`qmem2_11::W`](W) writer structure
impl crate::Writable for QMEM2_11rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM2_11 to value 0
impl crate::Resettable for QMEM2_11rs {}
