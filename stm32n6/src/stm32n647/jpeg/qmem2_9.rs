///Register `QMEM2_9` reader
pub type R = crate::R<QMEM2_9rs>;
///Register `QMEM2_9` writer
pub type W = crate::W<QMEM2_9rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 36
    #[inline(always)]
    pub fn qcoef36(&mut self) -> QCOEF36_W<'_, QMEM2_9rs> {
        QCOEF36_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 37
    #[inline(always)]
    pub fn qcoef37(&mut self) -> QCOEF37_W<'_, QMEM2_9rs> {
        QCOEF37_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 38
    #[inline(always)]
    pub fn qcoef38(&mut self) -> QCOEF38_W<'_, QMEM2_9rs> {
        QCOEF38_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 39
    #[inline(always)]
    pub fn qcoef39(&mut self) -> QCOEF39_W<'_, QMEM2_9rs> {
        QCOEF39_W::new(self, 24)
    }
}
/**JPEG quantization memory 2

You can [`read`](crate::Reg::read) this register and get [`qmem2_9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem2_9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:QMEM2_9)*/
pub struct QMEM2_9rs;
impl crate::RegisterSpec for QMEM2_9rs {
    type Ux = u32;
}
///`read()` method returns [`qmem2_9::R`](R) reader structure
impl crate::Readable for QMEM2_9rs {}
///`write(|w| ..)` method takes [`qmem2_9::W`](W) writer structure
impl crate::Writable for QMEM2_9rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM2_9 to value 0
impl crate::Resettable for QMEM2_9rs {}
