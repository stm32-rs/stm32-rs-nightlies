///Register `QMEM3_4` reader
pub type R = crate::R<QMEM3_4rs>;
///Register `QMEM3_4` writer
pub type W = crate::W<QMEM3_4rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 16
    #[inline(always)]
    pub fn qcoef16(&mut self) -> QCOEF16_W<'_, QMEM3_4rs> {
        QCOEF16_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 17
    #[inline(always)]
    pub fn qcoef17(&mut self) -> QCOEF17_W<'_, QMEM3_4rs> {
        QCOEF17_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 18
    #[inline(always)]
    pub fn qcoef18(&mut self) -> QCOEF18_W<'_, QMEM3_4rs> {
        QCOEF18_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 19
    #[inline(always)]
    pub fn qcoef19(&mut self) -> QCOEF19_W<'_, QMEM3_4rs> {
        QCOEF19_W::new(self, 24)
    }
}
/**JPEG quantization memory 3

You can [`read`](crate::Reg::read) this register and get [`qmem3_4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem3_4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:QMEM3_4)*/
pub struct QMEM3_4rs;
impl crate::RegisterSpec for QMEM3_4rs {
    type Ux = u32;
}
///`read()` method returns [`qmem3_4::R`](R) reader structure
impl crate::Readable for QMEM3_4rs {}
///`write(|w| ..)` method takes [`qmem3_4::W`](W) writer structure
impl crate::Writable for QMEM3_4rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM3_4 to value 0
impl crate::Resettable for QMEM3_4rs {}
