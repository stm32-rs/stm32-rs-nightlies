///Register `QMEM3_6` reader
pub type R = crate::R<QMEM3_6rs>;
///Register `QMEM3_6` writer
pub type W = crate::W<QMEM3_6rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 24
    #[inline(always)]
    pub fn qcoef24(&mut self) -> QCOEF24_W<'_, QMEM3_6rs> {
        QCOEF24_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 25
    #[inline(always)]
    pub fn qcoef25(&mut self) -> QCOEF25_W<'_, QMEM3_6rs> {
        QCOEF25_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 26
    #[inline(always)]
    pub fn qcoef26(&mut self) -> QCOEF26_W<'_, QMEM3_6rs> {
        QCOEF26_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 27
    #[inline(always)]
    pub fn qcoef27(&mut self) -> QCOEF27_W<'_, QMEM3_6rs> {
        QCOEF27_W::new(self, 24)
    }
}
/**JPEG quantization memory 3

You can [`read`](crate::Reg::read) this register and get [`qmem3_6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem3_6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#JPEG:QMEM3_6)*/
pub struct QMEM3_6rs;
impl crate::RegisterSpec for QMEM3_6rs {
    type Ux = u32;
}
///`read()` method returns [`qmem3_6::R`](R) reader structure
impl crate::Readable for QMEM3_6rs {}
///`write(|w| ..)` method takes [`qmem3_6::W`](W) writer structure
impl crate::Writable for QMEM3_6rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM3_6 to value 0
impl crate::Resettable for QMEM3_6rs {}
