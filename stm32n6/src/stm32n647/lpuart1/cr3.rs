...
impl W {
    ...
    ///Bit 20 - Wake-up from low-power mode interrupt flag selection
    #[inline(always)]
    pub fn wus0(&mut self) -> WUS0_W<'_, CR3rs> {
        WUS0_W::new(self, 20)
    }
    ///Bit 21 - Wake-up from low-power mode interrupt flag selection
    #[inline(always)]
    pub fn wus1(&mut self) -> WUS1_W<'_, CR3rs> {
        WUS1_W::new(self, 21)
    }
    ///Bit 22 - Wake-up from low-power mode interrupt enable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#LPUART1:CR3)*/
pub struct CR3rs;
