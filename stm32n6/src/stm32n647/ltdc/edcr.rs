...
impl W {
    ///Bit 25 - output conversion to YCbCr 422 enable
    #[inline(always)]
    pub fn ocyen(&mut self) -> OCYEN_W<EDCRrs> {
        OCYEN_W::new(self, 25)
    }
    ///Bit 26 - output conversion to YCbCr 422
    #[inline(always)]
    pub fn ocysel(&mut self) -> OCYSEL_W<EDCRrs> {
        OCYSEL_W::new(self, 26)
    }
    ///Bit 27 - output conversion to YCbCr 422
    #[inline(always)]
    pub fn ocyco(&mut self) -> OCYCO_W<EDCRrs> {
        OCYCO_W::new(self, 27)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#LTDC:EDCR)*/
pub struct EDCRrs;
