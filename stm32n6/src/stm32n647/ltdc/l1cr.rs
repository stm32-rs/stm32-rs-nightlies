...
impl W {
    ...
    ///Bit 1 - color keying enable
    #[inline(always)]
    pub fn cken(&mut self) -> CKEN_W<L1CRrs> {
        CKEN_W::new(self, 1)
    }
    ///Bit 4 - color look-up table enable
    #[inline(always)]
    ...
    ///Bit 8 - horizontal mirroring enable
    #[inline(always)]
    pub fn hmen(&mut self) -> HMEN_W<L1CRrs> {
        HMEN_W::new(self, 8)
    }
    ///Bit 9 - default color blending enable
    #[inline(always)]
    pub fn dcben(&mut self) -> DCBEN_W<L1CRrs> {
        DCBEN_W::new(self, 9)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#LTDC:L1CR)*/
pub struct L1CRrs;
