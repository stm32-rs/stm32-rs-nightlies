...
impl W {
    ///Bit 3 - YCbCr-to-RGB conversion enable
    #[inline(always)]
    pub fn ycen(&mut self) -> YCEN_W<L1PCRrs> {
        YCEN_W::new(self, 3)
    }
    ///Bits 4:5 - YCbCr conversion mode
    #[inline(always)]
    pub fn ycm(&mut self) -> YCM_W<L1PCRrs> {
        YCM_W::new(self, 4)
    }
    ///Bit 6 - Y component first
    #[inline(always)]
    pub fn yf(&mut self) -> YF_W<L1PCRrs> {
        YF_W::new(self, 6)
    }
    ///Bit 7 - Cb component first
    #[inline(always)]
    pub fn cbf(&mut self) -> CBF_W<L1PCRrs> {
        CBF_W::new(self, 7)
    }
    ///Bit 8 - Odd pixel first
    #[inline(always)]
    pub fn of(&mut self) -> OF_W<L1PCRrs> {
        OF_W::new(self, 8)
    }
    ///Bit 9 - Y rescale enable for the color dynamic range
    #[inline(always)]
    pub fn yren(&mut self) -> YREN_W<L1PCRrs> {
        YREN_W::new(self, 9)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#LTDC:L1PCR)*/
pub struct L1PCRrs;
