...
impl W {
    ///Bits 0:4 - Location of the Alpha component inside the pixel memory word (in bits)
    #[inline(always)]
    pub fn apos(&mut self) -> APOS_W<L2FPF0Rrs> {
        APOS_W::new(self, 0)
    }
    ///Bits 5:8 - Width of the Alpha component (in bits)
    #[inline(always)]
    pub fn alen(&mut self) -> ALEN_W<L2FPF0Rrs> {
        ALEN_W::new(self, 5)
    }
    ///Bits 9:13 - Location of the Red component inside the pixel memory word (in bits)
    #[inline(always)]
    pub fn rpos(&mut self) -> RPOS_W<L2FPF0Rrs> {
        RPOS_W::new(self, 9)
    }
    ///Bits 14:17 - Width of the Red component (in bits)
    #[inline(always)]
    pub fn rlen(&mut self) -> RLEN_W<L2FPF0Rrs> {
        RLEN_W::new(self, 14)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#LTDC:L2FPF0R)*/
