...
impl W {
    ///Bits 0:4 - Location of the Green component inside the pixel memory word (in bits)
    #[inline(always)]
    pub fn gpos(&mut self) -> GPOS_W<L2FPF1Rrs> {
        GPOS_W::new(self, 0)
    }
    ///Bits 5:8 - Width of the Green component (in bits)
    #[inline(always)]
    pub fn glen(&mut self) -> GLEN_W<L2FPF1Rrs> {
        GLEN_W::new(self, 5)
    }
    ///Bits 9:13 - Location of the Blue component inside the pixel memory word (in bits)
    #[inline(always)]
    pub fn bpos(&mut self) -> BPOS_W<L2FPF1Rrs> {
        BPOS_W::new(self, 9)
    }
    ///Bits 14:17 - Width of the Blue component (in bits)
    #[inline(always)]
    pub fn blen(&mut self) -> BLEN_W<L2FPF1Rrs> {
        BLEN_W::new(self, 14)
    }
    ///Bits 18:20 - Pixel size (in bytes)
    #[inline(always)]
    pub fn psize(&mut self) -> PSIZE_W<L2FPF1Rrs> {
        PSIZE_W::new(self, 18)
    }
}
