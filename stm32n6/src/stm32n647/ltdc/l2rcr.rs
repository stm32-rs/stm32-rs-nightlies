...
impl W {
    ...
    #[inline(always)]
    pub fn imr(&mut self) -> IMR_W<L2RCRrs> {
        IMR_W::new(self, 0)
    }
    ///Bit 1 - vertical blanking reload request
    #[inline(always)]
    pub fn vbr(&mut self) -> VBR_W<L2RCRrs> {
        VBR_W::new(self, 1)
    }
    ///Bit 2 - shadow reload control, global (centralized) reload masked
    #[inline(always)]
    pub fn grmsk(&mut self) -> GRMSK_W<L2RCRrs> {
        GRMSK_W::new(self, 2)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#LTDC:L2RCR)*/
pub struct L2RCRrs;
