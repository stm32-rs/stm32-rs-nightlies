...
impl W {
    ...
    ///Bit 2 - Snapshot data ready interrupt enable
    #[inline(always)]
    pub fn ssdrie(&mut self) -> SSDRIE_W<DFLT0IERrs> {
        SSDRIE_W::new(self, 2)
    }
    ///Bit 4 - OLD0 interrupt enable
    #[inline(always)]
    pub fn oldie(&mut self) -> OLDIE_W<DFLT0IERrs> {
        OLDIE_W::new(self, 4)
    }
    ///Bit 7 - Snapshot overrun interrupt enable
    #[inline(always)]
    pub fn ssovrie(&mut self) -> SSOVRIE_W<DFLT0IERrs> {
        SSOVRIE_W::new(self, 7)
    }
    ///Bit 8 - SCD0 interrupt enable
    #[inline(always)]
    pub fn scdie(&mut self) -> SCDIE_W<DFLT0IERrs> {
        SCDIE_W::new(self, 8)
    }
    ///Bit 9 - Saturation detection interrupt enable
    #[inline(always)]
