///Register `DFLT1RSFR` reader
pub type R = crate::R<DFLT1RSFRrs>;
///Register `DFLT1RSFR` writer
pub type W = crate::W<DFLT1RSFRrs>;
...
impl W {
    ///Bit 0 - Reshaper filter bypass
    #[inline(always)]
    pub fn rsfltbyp(&mut self) -> RSFLTBYP_W<'_, DFLT1RSFRrs> {
        RSFLTBYP_W::new(self, 0)
    }
    ///Bit 4 - Reshaper filter decimation ratio
    #[inline(always)]
    pub fn rsfltd(&mut self) -> RSFLTD_W<'_, DFLT1RSFRrs> {
        RSFLTD_W::new(self, 4)
    }
    ///Bit 7 - High-pass filter bypass
    #[inline(always)]
    pub fn hpfbyp(&mut self) -> HPFBYP_W<'_, DFLT1RSFRrs> {
        HPFBYP_W::new(self, 7)
    }
    ///Bits 8:9 - High-pass filter cut-off frequency
    #[inline(always)]
    pub fn hpfc(&mut self) -> HPFC_W<'_, DFLT1RSFRrs> {
        HPFC_W::new(self, 8)
    }
}
/**MDF reshape filter configuration register 1

You can [`read`](crate::Reg::read) this register and get [`dflt1rsfr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dflt1rsfr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#MDF1:DFLT1RSFR)*/
pub struct DFLT1RSFRrs;
impl crate::RegisterSpec for DFLT1RSFRrs {
    type Ux = u32;
}
///`read()` method returns [`dflt1rsfr::R`](R) reader structure
impl crate::Readable for DFLT1RSFRrs {}
///`write(|w| ..)` method takes [`dflt1rsfr::W`](W) writer structure
impl crate::Writable for DFLT1RSFRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DFLT1RSFR to value 0
impl crate::Resettable for DFLT1RSFRrs {}
