///Register `DFLT2CICR` reader
pub type R = crate::R<DFLT2CICRrs>;
///Register `DFLT2CICR` writer
pub type W = crate::W<DFLT2CICRrs>;
...
impl W {
    ///Bits 0:1 - Source data for the digital filter
    #[inline(always)]
    pub fn datsrc(&mut self) -> DATSRC_W<'_, DFLT2CICRrs> {
        DATSRC_W::new(self, 0)
    }
    ///Bits 4:6 - Select the CIC mode
    #[inline(always)]
    pub fn cicmod(&mut self) -> CICMOD_W<'_, DFLT2CICRrs> {
        CICMOD_W::new(self, 4)
    }
    ///Bits 8:15 - CIC decimation ratio selection
    #[inline(always)]
    pub fn mcicd(&mut self) -> MCICD_W<'_, DFLT2CICRrs> {
        MCICD_W::new(self, 8)
    }
    ///Bit 16 - CIC decimation ratio selection
    #[inline(always)]
    pub fn mcicd8(&mut self) -> MCICD8_W<'_, DFLT2CICRrs> {
        MCICD8_W::new(self, 16)
    }
    ///Bits 20:25 - Scaling factor selection
    #[inline(always)]
    pub fn scale(&mut self) -> SCALE_W<'_, DFLT2CICRrs> {
        SCALE_W::new(self, 20)
    }
}
/**MDF digital filter configuration register 2

You can [`read`](crate::Reg::read) this register and get [`dflt2cicr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dflt2cicr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#MDF1:DFLT2CICR)*/
pub struct DFLT2CICRrs;
impl crate::RegisterSpec for DFLT2CICRrs {
    type Ux = u32;
}
///`read()` method returns [`dflt2cicr::R`](R) reader structure
impl crate::Readable for DFLT2CICRrs {}
///`write(|w| ..)` method takes [`dflt2cicr::W`](W) writer structure
impl crate::Writable for DFLT2CICRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DFLT2CICR to value 0
impl crate::Resettable for DFLT2CICRrs {}
