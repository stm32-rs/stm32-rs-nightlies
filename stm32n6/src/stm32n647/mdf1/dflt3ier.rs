///Register `DFLT3IER` reader
pub type R = crate::R<DFLT3IERrs>;
///Register `DFLT3IER` writer
pub type W = crate::W<DFLT3IERrs>;
...
impl W {
    ///Bit 0 - RXFIFO threshold interrupt enable
    #[inline(always)]
    pub fn fthie(&mut self) -> FTHIE_W<'_, DFLT3IERrs> {
        FTHIE_W::new(self, 0)
    }
    ///Bit 1 - Data overflow interrupt enable
    #[inline(always)]
    pub fn dovrie(&mut self) -> DOVRIE_W<'_, DFLT3IERrs> {
        DOVRIE_W::new(self, 1)
    }
    ///Bit 2 - Snapshot data ready interrupt enable
    #[inline(always)]
    pub fn ssdrie(&mut self) -> SSDRIE_W<'_, DFLT3IERrs> {
        SSDRIE_W::new(self, 2)
    }
    ///Bit 4 - OLDx interrupt enable
    #[inline(always)]
    pub fn oldie(&mut self) -> OLDIE_W<'_, DFLT3IERrs> {
        OLDIE_W::new(self, 4)
    }
    ///Bit 7 - Snapshot overrun interrupt enable
    #[inline(always)]
    pub fn ssovrie(&mut self) -> SSOVRIE_W<'_, DFLT3IERrs> {
        SSOVRIE_W::new(self, 7)
    }
    ///Bit 8 - SCDx interrupt enable
    #[inline(always)]
    pub fn scdie(&mut self) -> SCDIE_W<'_, DFLT3IERrs> {
        SCDIE_W::new(self, 8)
    }
    ///Bit 9 - Saturation detection interrupt enable
    #[inline(always)]
    pub fn satie(&mut self) -> SATIE_W<'_, DFLT3IERrs> {
        SATIE_W::new(self, 9)
    }
    ///Bit 10 - Clock absence detection interrupt enable
    #[inline(always)]
    pub fn ckabie(&mut self) -> CKABIE_W<'_, DFLT3IERrs> {
        CKABIE_W::new(self, 10)
    }
    ///Bit 11 - Reshape filter overrun interrupt enable
    #[inline(always)]
    pub fn rfovrie(&mut self) -> RFOVRIE_W<'_, DFLT3IERrs> {
        RFOVRIE_W::new(self, 11)
    }
}
/**MDF DFLT3 interrupt enable register 3

You can [`read`](crate::Reg::read) this register and get [`dflt3ier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dflt3ier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#MDF1:DFLT3IER)*/
pub struct DFLT3IERrs;
impl crate::RegisterSpec for DFLT3IERrs {
    type Ux = u32;
}
///`read()` method returns [`dflt3ier::R`](R) reader structure
impl crate::Readable for DFLT3IERrs {}
///`write(|w| ..)` method takes [`dflt3ier::W`](W) writer structure
impl crate::Writable for DFLT3IERrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DFLT3IER to value 0
impl crate::Resettable for DFLT3IERrs {}
