///Register `DFLT4ISR` reader
pub type R = crate::R<DFLT4ISRrs>;
///Register `DFLT4ISR` writer
pub type W = crate::W<DFLT4ISRrs>;
...
impl W {
    ///Bit 1 - Data overflow flag
    #[inline(always)]
    pub fn dovrf(&mut self) -> DOVRF_W<'_, DFLT4ISRrs> {
        DOVRF_W::new(self, 1)
    }
    ///Bit 2 - Snapshot data ready flag
    #[inline(always)]
    pub fn ssdrf(&mut self) -> SSDRF_W<'_, DFLT4ISRrs> {
        SSDRF_W::new(self, 2)
    }
    ///Bit 4 - OLDx flag
    #[inline(always)]
    pub fn oldf(&mut self) -> OLDF_W<'_, DFLT4ISRrs> {
        OLDF_W::new(self, 4)
    }
    ///Bit 7 - Snapshot overrun flag
    #[inline(always)]
    pub fn ssovrf(&mut self) -> SSOVRF_W<'_, DFLT4ISRrs> {
        SSOVRF_W::new(self, 7)
    }
    ///Bit 8 - Short-circuit detector flag
    #[inline(always)]
    pub fn scdf(&mut self) -> SCDF_W<'_, DFLT4ISRrs> {
        SCDF_W::new(self, 8)
    }
    ///Bit 9 - Saturation detection flag
    #[inline(always)]
    pub fn satf(&mut self) -> SATF_W<'_, DFLT4ISRrs> {
        SATF_W::new(self, 9)
    }
    ///Bit 10 - Clock absence detection flag
    #[inline(always)]
    pub fn ckabf(&mut self) -> CKABF_W<'_, DFLT4ISRrs> {
        CKABF_W::new(self, 10)
    }
    ///Bit 11 - Reshape filter overrun detection flag
    #[inline(always)]
    pub fn rfovrf(&mut self) -> RFOVRF_W<'_, DFLT4ISRrs> {
        RFOVRF_W::new(self, 11)
    }
}
/**MDF DFLT4 interrupt status register 4

You can [`read`](crate::Reg::read) this register and get [`dflt4isr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dflt4isr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#MDF1:DFLT4ISR)*/
pub struct DFLT4ISRrs;
impl crate::RegisterSpec for DFLT4ISRrs {
    type Ux = u32;
}
///`read()` method returns [`dflt4isr::R`](R) reader structure
impl crate::Readable for DFLT4ISRrs {}
///`write(|w| ..)` method takes [`dflt4isr::W`](W) writer structure
impl crate::Writable for DFLT4ISRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DFLT4ISR to value 0
impl crate::Resettable for DFLT4ISRrs {}
