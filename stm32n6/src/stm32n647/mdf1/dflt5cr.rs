///Register `DFLT5CR` reader
pub type R = crate::R<DFLT5CRrs>;
///Register `DFLT5CR` writer
pub type W = crate::W<DFLT5CRrs>;
...
impl W {
    ...
    #[inline(always)]
    pub fn dflten(&mut self) -> DFLTEN_W<'_, DFLT5CRrs> {
        DFLTEN_W::new(self, 0)
    }
    ///Bit 1 - DMA requests enable
    #[inline(always)]
    pub fn dmaen(&mut self) -> DMAEN_W<'_, DFLT5CRrs> {
        DMAEN_W::new(self, 1)
    }
    ///Bit 2 - RXFIFO Threshold selection
    #[inline(always)]
    pub fn fth(&mut self) -> FTH_W<'_, DFLT5CRrs> {
        FTH_W::new(self, 2)
    }
    ///Bits 4:6 - Digital filter trigger mode
    #[inline(always)]
    pub fn acqmod(&mut self) -> ACQMOD_W<'_, DFLT5CRrs> {
        ACQMOD_W::new(self, 4)
    }
    ///Bit 8 - Digital filter trigger sensitivity selection
    #[inline(always)]
    pub fn trgsens(&mut self) -> TRGSENS_W<'_, DFLT5CRrs> {
        TRGSENS_W::new(self, 8)
    }
    ///Bits 12:15 - Digital filter trigger signal selection
    #[inline(always)]
    pub fn trgsrc(&mut self) -> TRGSRC_W<'_, DFLT5CRrs> {
        TRGSRC_W::new(self, 12)
    }
    ///Bit 16 - Snapshot data format
    #[inline(always)]
    pub fn snpsfmt(&mut self) -> SNPSFMT_W<'_, DFLT5CRrs> {
        SNPSFMT_W::new(self, 16)
    }
    ///Bits 20:27 - Number of samples to be discarded
    #[inline(always)]
    pub fn nbdis(&mut self) -> NBDIS_W<'_, DFLT5CRrs> {
        NBDIS_W::new(self, 20)
    }
}
/**MDF digital filter control register 5

You can [`read`](crate::Reg::read) this register and get [`dflt5cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dflt5cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#MDF1:DFLT5CR)*/
pub struct DFLT5CRrs;
impl crate::RegisterSpec for DFLT5CRrs {
    type Ux = u32;
}
///`read()` method returns [`dflt5cr::R`](R) reader structure
impl crate::Readable for DFLT5CRrs {}
///`write(|w| ..)` method takes [`dflt5cr::W`](W) writer structure
impl crate::Writable for DFLT5CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DFLT5CR to value 0
impl crate::Resettable for DFLT5CRrs {}
