///Register `SCD4CR` reader
pub type R = crate::R<SCD4CRrs>;
///Register `SCD4CR` writer
pub type W = crate::W<SCD4CRrs>;
...
impl W {
    ///Bit 0 - SCDx enable
    #[inline(always)]
    pub fn scden(&mut self) -> SCDEN_W<'_, SCD4CRrs> {
        SCDEN_W::new(self, 0)
    }
    ///Bits 4:7 - Break signal assignment for short circuit detector
    #[inline(always)]
    pub fn bkscd(&mut self) -> BKSCD_W<'_, SCD4CRrs> {
        BKSCD_W::new(self, 4)
    }
    ///Bits 12:19 - SCDx threshold
    #[inline(always)]
    pub fn scdt(&mut self) -> SCDT_W<'_, SCD4CRrs> {
        SCDT_W::new(self, 12)
    }
}
/**MDF short circuit detector control register 4

You can [`read`](crate::Reg::read) this register and get [`scd4cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scd4cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#MDF1:SCD4CR)*/
pub struct SCD4CRrs;
impl crate::RegisterSpec for SCD4CRrs {
    type Ux = u32;
}
///`read()` method returns [`scd4cr::R`](R) reader structure
impl crate::Readable for SCD4CRrs {}
///`write(|w| ..)` method takes [`scd4cr::W`](W) writer structure
impl crate::Writable for SCD4CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SCD4CR to value 0
impl crate::Resettable for SCD4CRrs {}
