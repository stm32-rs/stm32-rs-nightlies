...
impl W {
    ///Bit 0 - Serial interface enable
    #[inline(always)]
    pub fn sitfen(&mut self) -> SITFEN_W<SITF2CRrs> {
        SITFEN_W::new(self, 0)
    }
    ///Bits 1:2 - Serial clock source
    #[inline(always)]
    pub fn scksrc(&mut self) -> SCKSRC_W<SITF2CRrs> {
        SCKSRC_W::new(self, 1)
    }
    ///Bits 4:5 - Serial interface type
    #[inline(always)]
    pub fn sitfmod(&mut self) -> SITFMOD_W<SITF2CRrs> {
        SITFMOD_W::new(self, 4)
    }
    ///Bits 8:12 - Manchester symbol threshold/SPI threshold
    #[inline(always)]
    pub fn sth(&mut self) -> STH_W<SITF2CRrs> {
        STH_W::new(self, 8)
    }
}
