///Register `SITF5CR` reader
pub type R = crate::R<SITF5CRrs>;
///Register `SITF5CR` writer
pub type W = crate::W<SITF5CRrs>;
...
impl W {
    ///Bit 0 - Serial interface enable
    #[inline(always)]
    pub fn sitfen(&mut self) -> SITFEN_W<'_, SITF5CRrs> {
        SITFEN_W::new(self, 0)
    }
    ///Bits 1:2 - Serial clock source
    #[inline(always)]
    pub fn scksrc(&mut self) -> SCKSRC_W<'_, SITF5CRrs> {
        SCKSRC_W::new(self, 1)
    }
    ///Bits 4:5 - Serial interface type
    #[inline(always)]
    pub fn sitfmod(&mut self) -> SITFMOD_W<'_, SITF5CRrs> {
        SITFMOD_W::new(self, 4)
    }
    ///Bits 8:12 - Manchester symbol threshold/SPI threshold
    #[inline(always)]
    pub fn sth(&mut self) -> STH_W<'_, SITF5CRrs> {
        STH_W::new(self, 8)
    }
}
/**MDF serial interface control register 5

You can [`read`](crate::Reg::read) this register and get [`sitf5cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sitf5cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#MDF1:SITF5CR)*/
pub struct SITF5CRrs;
impl crate::RegisterSpec for SITF5CRrs {
    type Ux = u32;
}
///`read()` method returns [`sitf5cr::R`](R) reader structure
impl crate::Readable for SITF5CRrs {}
///`write(|w| ..)` method takes [`sitf5cr::W`](W) writer structure
impl crate::Writable for SITF5CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SITF5CR to value 0x1f00
impl crate::Resettable for SITF5CRrs {
