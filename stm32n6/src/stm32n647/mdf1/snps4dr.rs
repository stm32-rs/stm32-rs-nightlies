///Register `SNPS4DR` reader
pub type R = crate::R<SNPS4DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`snps4dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#MDF1:SNPS4DR)*/
pub struct SNPS4DRrs;
impl crate::RegisterSpec for SNPS4DRrs {
    type Ux = u32;
}
///`read()` method returns [`snps4dr::R`](R) reader structure
impl crate::Readable for SNPS4DRrs {}
///`reset()` method sets SNPS4DR to value 0
impl crate::Resettable for SNPS4DRrs {}
