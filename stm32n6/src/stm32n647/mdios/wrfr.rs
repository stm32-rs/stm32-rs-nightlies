...
///Field `WRF` reader - write flags for MDIOS registers 0 to 31.
pub type WRF_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - write flags for MDIOS registers 0 to 31.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#MDIOS:WRFR)*/
pub struct WRFRrs;
