...
impl W {
    ///Bits 0:31 - Product ID field
    #[inline(always)]
    pub fn product_id(&mut self) -> PRODUCT_ID_W<'_, CIDrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#OTG1:CID)*/
pub struct CIDrs;
...
///`reset()` method sets CID to value 0x5000
