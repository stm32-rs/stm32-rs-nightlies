///Register `DIEPCTL1_ALTERNATE` reader
pub type R = crate::R<DIEPCTL1_ALTERNATErs>;
///Register `DIEPCTL1_ALTERNATE` writer
pub type W = crate::W<DIEPCTL1_ALTERNATErs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DIEPCTL1_ALTERNATE")
...
impl W {
    ///Bits 0:10 - Maximum packet size
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MPSIZ_W<'_, DIEPCTL1_ALTERNATErs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bit 15 - USB active endpoint
    #[inline(always)]
    pub fn usbaep(&mut self) -> USBAEP_W<'_, DIEPCTL1_ALTERNATErs> {
        USBAEP_W::new(self, 15)
    }
    ///Bits 18:19 - Endpoint type
    #[inline(always)]
    pub fn eptyp(&mut self) -> EPTYP_W<'_, DIEPCTL1_ALTERNATErs> {
        EPTYP_W::new(self, 18)
    }
    ///Bit 21 - STALL handshake
    #[inline(always)]
    pub fn stall(&mut self) -> STALL_W<'_, DIEPCTL1_ALTERNATErs> {
        STALL_W::new(self, 21)
    }
    ///Bits 22:25 - Tx FIFO number
    #[inline(always)]
    pub fn txfnum(&mut self) -> TXFNUM_W<'_, DIEPCTL1_ALTERNATErs> {
        TXFNUM_W::new(self, 22)
    }
    ///Bit 26 - Clear NAK
    #[inline(always)]
    pub fn cnak(&mut self) -> CNAK_W<'_, DIEPCTL1_ALTERNATErs> {
        CNAK_W::new(self, 26)
    }
    ///Bit 27 - Set NAK
    #[inline(always)]
    pub fn snak(&mut self) -> SNAK_W<'_, DIEPCTL1_ALTERNATErs> {
        SNAK_W::new(self, 27)
    }
    ///Bit 28 - Set even frame
    #[inline(always)]
    pub fn sevnfrm(&mut self) -> SEVNFRM_W<'_, DIEPCTL1_ALTERNATErs> {
        SEVNFRM_W::new(self, 28)
    }
    ///Bit 29 - Set odd frame
    #[inline(always)]
    pub fn soddfrm(&mut self) -> SODDFRM_W<'_, DIEPCTL1_ALTERNATErs> {
        SODDFRM_W::new(self, 29)
    }
    ///Bit 30 - Endpoint disable
    #[inline(always)]
    pub fn epdis(&mut self) -> EPDIS_W<'_, DIEPCTL1_ALTERNATErs> {
        EPDIS_W::new(self, 30)
    }
    ///Bit 31 - Endpoint enable
    #[inline(always)]
    pub fn epena(&mut self) -> EPENA_W<'_, DIEPCTL1_ALTERNATErs> {
        EPENA_W::new(self, 31)
    }
}
/**OTG device IN endpoint 1 control register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`diepctl1_alternate::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`diepctl1_alternate::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#OTG1:DIEPCTL1_ALTERNATE)*/
pub struct DIEPCTL1_ALTERNATErs;
impl crate::RegisterSpec for DIEPCTL1_ALTERNATErs {
    type Ux = u32;
}
///`read()` method returns [`diepctl1_alternate::R`](R) reader structure
impl crate::Readable for DIEPCTL1_ALTERNATErs {}
///`write(|w| ..)` method takes [`diepctl1_alternate::W`](W) writer structure
impl crate::Writable for DIEPCTL1_ALTERNATErs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DIEPCTL1_ALTERNATE to value 0
impl crate::Resettable for DIEPCTL1_ALTERNATErs {}
