...
impl W {
    ///Bits 0:10 - Maximum packet size
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MPSIZ_W<DIEPCTL2_ALTERNATErs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bit 15 - USB active endpoint
    #[inline(always)]
    pub fn usbaep(&mut self) -> USBAEP_W<DIEPCTL2_ALTERNATErs> {
        USBAEP_W::new(self, 15)
    }
    ///Bits 18:19 - Endpoint type
    #[inline(always)]
    pub fn eptyp(&mut self) -> EPTYP_W<DIEPCTL2_ALTERNATErs> {
        EPTYP_W::new(self, 18)
    }
    ///Bit 21 - STALL handshake
    #[inline(always)]
    pub fn stall(&mut self) -> STALL_W<DIEPCTL2_ALTERNATErs> {
        STALL_W::new(self, 21)
    }
    ///Bits 22:25 - Tx FIFO number
    #[inline(always)]
    pub fn txfnum(&mut self) -> TXFNUM_W<DIEPCTL2_ALTERNATErs> {
        TXFNUM_W::new(self, 22)
    }
    ///Bit 26 - Clear NAK
    #[inline(always)]
    pub fn cnak(&mut self) -> CNAK_W<DIEPCTL2_ALTERNATErs> {
        CNAK_W::new(self, 26)
    }
    ///Bit 27 - Set NAK
    #[inline(always)]
    pub fn snak(&mut self) -> SNAK_W<DIEPCTL2_ALTERNATErs> {
        SNAK_W::new(self, 27)
    }
    ///Bit 28 - Set even frame
    #[inline(always)]
    pub fn sevnfrm(&mut self) -> SEVNFRM_W<DIEPCTL2_ALTERNATErs> {
        SEVNFRM_W::new(self, 28)
    }
    ///Bit 29 - Set odd frame
    #[inline(always)]
    pub fn soddfrm(&mut self) -> SODDFRM_W<DIEPCTL2_ALTERNATErs> {
        SODDFRM_W::new(self, 29)
    }
    ///Bit 30 - Endpoint disable
    #[inline(always)]
    pub fn epdis(&mut self) -> EPDIS_W<DIEPCTL2_ALTERNATErs> {
        EPDIS_W::new(self, 30)
    }
    ///Bit 31 - Endpoint enable
    #[inline(always)]
    pub fn epena(&mut self) -> EPENA_W<DIEPCTL2_ALTERNATErs> {
        EPENA_W::new(self, 31)
    }
}
