...
impl W {
    ...
    #[inline(always)]
    pub fn sd0pid(&mut self) -> SD0PID_W<'_, DIEPCTL8rs> {
        SD0PID_W::new(self, 28)
    }
    ///Bit 29 - Set DATA1 PID
    #[inline(always)]
    pub fn sd1pid(&mut self) -> SD1PID_W<'_, DIEPCTL8rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#OTG1:DIEPCTL8)*/
