///Register `DOEPCTL8_ALTERNATE` reader
pub type R = crate::R<DOEPCTL8_ALTERNATErs>;
///Register `DOEPCTL8_ALTERNATE` writer
pub type W = crate::W<DOEPCTL8_ALTERNATErs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DOEPCTL8_ALTERNATE")
...
impl W {
    ///Bits 0:10 - Maximum packet size
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MPSIZ_W<'_, DOEPCTL8_ALTERNATErs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bit 15 - USB active endpoint
    #[inline(always)]
    pub fn usbaep(&mut self) -> USBAEP_W<'_, DOEPCTL8_ALTERNATErs> {
        USBAEP_W::new(self, 15)
    }
    ///Bits 18:19 - Endpoint type
    #[inline(always)]
    pub fn eptyp(&mut self) -> EPTYP_W<'_, DOEPCTL8_ALTERNATErs> {
        EPTYP_W::new(self, 18)
    }
    ///Bit 20 - Snoop mode
    #[inline(always)]
    pub fn snpm(&mut self) -> SNPM_W<'_, DOEPCTL8_ALTERNATErs> {
        SNPM_W::new(self, 20)
    }
    ///Bit 21 - STALL handshake
    #[inline(always)]
    pub fn stall(&mut self) -> STALL_W<'_, DOEPCTL8_ALTERNATErs> {
        STALL_W::new(self, 21)
    }
    ///Bit 26 - Clear NAK
    #[inline(always)]
    pub fn cnak(&mut self) -> CNAK_W<'_, DOEPCTL8_ALTERNATErs> {
        CNAK_W::new(self, 26)
    }
    ///Bit 27 - Set NAK
    #[inline(always)]
    pub fn snak(&mut self) -> SNAK_W<'_, DOEPCTL8_ALTERNATErs> {
        SNAK_W::new(self, 27)
    }
    ///Bit 28 - Set even frame
    #[inline(always)]
    pub fn sevnfrm(&mut self) -> SEVNFRM_W<'_, DOEPCTL8_ALTERNATErs> {
        SEVNFRM_W::new(self, 28)
    }
    ///Bit 29 - Set odd frame
    #[inline(always)]
    pub fn soddfrm(&mut self) -> SODDFRM_W<'_, DOEPCTL8_ALTERNATErs> {
        SODDFRM_W::new(self, 29)
    }
    ///Bit 30 - Endpoint disable
    #[inline(always)]
    pub fn epdis(&mut self) -> EPDIS_W<'_, DOEPCTL8_ALTERNATErs> {
        EPDIS_W::new(self, 30)
    }
    ///Bit 31 - Endpoint enable
    #[inline(always)]
    pub fn epena(&mut self) -> EPENA_W<'_, DOEPCTL8_ALTERNATErs> {
        EPENA_W::new(self, 31)
    }
}
/**OTG device OUT endpoint 8 control register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`doepctl8_alternate::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`doepctl8_alternate::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#OTG1:DOEPCTL8_ALTERNATE)*/
pub struct DOEPCTL8_ALTERNATErs;
impl crate::RegisterSpec for DOEPCTL8_ALTERNATErs {
    type Ux = u32;
}
///`read()` method returns [`doepctl8_alternate::R`](R) reader structure
impl crate::Readable for DOEPCTL8_ALTERNATErs {}
///`write(|w| ..)` method takes [`doepctl8_alternate::W`](W) writer structure
impl crate::Writable for DOEPCTL8_ALTERNATErs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DOEPCTL8_ALTERNATE to value 0
impl crate::Resettable for DOEPCTL8_ALTERNATErs {}
