...
///Field `PRIV2` reader - Vless thansub>DDCOREless than/sub> monitor privileged protection
pub type PRIV2_R = crate::BitReader;
///Field `PRIV2` writer - Vless thansub>DDCOREless than/sub> monitor privileged protection
...
impl R {
    ...
    ///Bit 2 - Vless thansub>DDCOREless than/sub> monitor privileged protection
    #[inline(always)]
...
impl W {
    ...
    ///Bit 16 - WKUP1 pin privileged protection
    #[inline(always)]
    pub fn wkuppriv1(&mut self) -> WKUPPRIV1_W<PRIVCFGRrs> {
        WKUPPRIV1_W::new(self, 16)
    }
    ///Bit 17 - WKUP2 pin privileged protection
    #[inline(always)]
    pub fn wkuppriv2(&mut self) -> WKUPPRIV2_W<PRIVCFGRrs> {
        WKUPPRIV2_W::new(self, 17)
    }
    ///Bit 18 - WKUP3 pin privileged protection
    #[inline(always)]
    pub fn wkuppriv3(&mut self) -> WKUPPRIV3_W<PRIVCFGRrs> {
        WKUPPRIV3_W::new(self, 18)
    }
    ///Bit 19 - WKUP4 pin privileged protection
    #[inline(always)]
    pub fn wkuppriv4(&mut self) -> WKUPPRIV4_W<PRIVCFGRrs> {
