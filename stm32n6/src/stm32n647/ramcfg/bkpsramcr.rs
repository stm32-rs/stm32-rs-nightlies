...
impl W {
    ///Bit 0 - ECC enable
    #[inline(always)]
    pub fn ecce(&mut self) -> ECCE_W<BKPSRAMCRrs> {
        ECCE_W::new(self, 0)
    }
    ///Bit 4 - Address latch enable
    #[inline(always)]
    pub fn ale(&mut self) -> ALE_W<BKPSRAMCRrs> {
        ALE_W::new(self, 4)
    }
    ///Bit 8 - SRAM erase
    #[inline(always)]
    pub fn sramer(&mut self) -> SRAMER_W<BKPSRAMCRrs> {
        SRAMER_W::new(self, 8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#RAMCFG:BKPSRAMCR)*/
