...
impl W {
    ...
    #[inline(always)]
    pub fn csed(&mut self) -> CSED_W<BKPSRAMICRrs> {
        CSED_W::new(self, 0)
    }
    ///Bit 1 - Clear ECC double-error interrupt
    #[inline(always)]
    pub fn cded(&mut self) -> CDED_W<BKPSRAMICRrs> {
        CDED_W::new(self, 1)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#RAMCFG:BKPSRAMICR)*/
