...
impl W {
    ///Bit 8 - SRAM erase
    #[inline(always)]
    pub fn sramer(&mut self) -> SRAMER_W<FLEXRAMCRrs> {
        SRAMER_W::new(self, 8)
    }
    ///Bit 12 - SRAM hardware erase disable
    #[inline(always)]
    pub fn sramhwerdis(&mut self) -> SRAMHWERDIS_W<FLEXRAMCRrs> {
        SRAMHWERDIS_W::new(self, 12)
    }
    ///Bits 16:17 - Configuration of the FLEXMEM I-TCM extension
    #[inline(always)]
    pub fn itcmcfg(&mut self) -> ITCMCFG_W<FLEXRAMCRrs> {
        ITCMCFG_W::new(self, 16)
    }
    ///Bit 24 - Configuration of the FLEXMEM D-TCM extension
    #[inline(always)]
    pub fn dtcmcfg(&mut self) -> DTCMCFG_W<FLEXRAMCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#RAMCFG:FLEXRAMCR)*/
