...
impl W {
    ...
    #[inline(always)]
    pub fn rnglpenc(&mut self) -> RNGLPENC_W<AHB3LPENCRrs> {
        RNGLPENC_W::new(self, 0)
    }
    ///Bit 1 - HASH sleep enable
    #[inline(always)]
    pub fn hashlpenc(&mut self) -> HASHLPENC_W<AHB3LPENCRrs> {
        HASHLPENC_W::new(self, 1)
    }
    ///Bit 2 - CRYP sleep enable
    #[inline(always)]
    pub fn cryplpenc(&mut self) -> CRYPLPENC_W<AHB3LPENCRrs> {
        CRYPLPENC_W::new(self, 2)
    }
    ///Bit 4 - SAES sleep enable
    #[inline(always)]
    pub fn saeslpenc(&mut self) -> SAESLPENC_W<AHB3LPENCRrs> {
        SAESLPENC_W::new(self, 4)
    }
    ///Bit 8 - PKA sleep enable
    #[inline(always)]
    pub fn pkalpenc(&mut self) -> PKALPENC_W<AHB3LPENCRrs> {
        PKALPENC_W::new(self, 8)
    }
    ///Bit 9 - RIFSC sleep enable
    #[inline(always)]
    pub fn rifsclpenc(&mut self) -> RIFSCLPENC_W<AHB3LPENCRrs> {
        RIFSCLPENC_W::new(self, 9)
    }
    ///Bit 10 - IAC sleep enable
    #[inline(always)]
    pub fn iaclpenc(&mut self) -> IACLPENC_W<AHB3LPENCRrs> {
        IACLPENC_W::new(self, 10)
    }
    ///Bit 14 - RISAF sleep enable
    #[inline(always)]
    pub fn risaflpenc(&mut self) -> RISAFLPENC_W<AHB3LPENCRrs> {
