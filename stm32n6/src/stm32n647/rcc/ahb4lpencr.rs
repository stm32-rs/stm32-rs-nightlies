...
impl W {
    ...
    #[inline(always)]
    pub fn gpioalpenc(&mut self) -> GPIOALPENC_W<AHB4LPENCRrs> {
        GPIOALPENC_W::new(self, 0)
    }
    ///Bit 1 - GPIOB sleep enable
    #[inline(always)]
    pub fn gpioblpenc(&mut self) -> GPIOBLPENC_W<AHB4LPENCRrs> {
        GPIOBLPENC_W::new(self, 1)
    }
    ///Bit 2 - GPIOC sleep enable
    #[inline(always)]
    pub fn gpioclpenc(&mut self) -> GPIOCLPENC_W<AHB4LPENCRrs> {
        GPIOCLPENC_W::new(self, 2)
    }
    ///Bit 3 - GPIOD sleep enable
    #[inline(always)]
    pub fn gpiodlpenc(&mut self) -> GPIODLPENC_W<AHB4LPENCRrs> {
        GPIODLPENC_W::new(self, 3)
    }
    ///Bit 4 - GPIOE sleep enable
    #[inline(always)]
    pub fn gpioelpenc(&mut self) -> GPIOELPENC_W<AHB4LPENCRrs> {
        GPIOELPENC_W::new(self, 4)
    }
    ///Bit 5 - GPIOF sleep enable
    #[inline(always)]
    pub fn gpioflpenc(&mut self) -> GPIOFLPENC_W<AHB4LPENCRrs> {
        GPIOFLPENC_W::new(self, 5)
    }
    ///Bit 6 - GPIOG sleep enable
    #[inline(always)]
    pub fn gpioglpenc(&mut self) -> GPIOGLPENC_W<AHB4LPENCRrs> {
        GPIOGLPENC_W::new(self, 6)
    }
    ///Bit 7 - GPIOH sleep enable
    #[inline(always)]
    pub fn gpiohlpenc(&mut self) -> GPIOHLPENC_W<AHB4LPENCRrs> {
        GPIOHLPENC_W::new(self, 7)
    }
    ///Bit 13 - GPION sleep enable
    #[inline(always)]
    pub fn gpionlpenc(&mut self) -> GPIONLPENC_W<AHB4LPENCRrs> {
        GPIONLPENC_W::new(self, 13)
    }
    ///Bit 14 - GPIOO sleep enable
    #[inline(always)]
    pub fn gpioolpenc(&mut self) -> GPIOOLPENC_W<AHB4LPENCRrs> {
        GPIOOLPENC_W::new(self, 14)
    }
    ///Bit 15 - GPIOP sleep enable
    #[inline(always)]
    pub fn gpioplpenc(&mut self) -> GPIOPLPENC_W<AHB4LPENCRrs> {
        GPIOPLPENC_W::new(self, 15)
    }
    ///Bit 16 - GPIOQ sleep enable
    #[inline(always)]
    pub fn gpioqlpenc(&mut self) -> GPIOQLPENC_W<AHB4LPENCRrs> {
        GPIOQLPENC_W::new(self, 16)
    }
    ///Bit 18 - PWR sleep enable
    #[inline(always)]
    pub fn pwrlpenc(&mut self) -> PWRLPENC_W<AHB4LPENCRrs> {
        PWRLPENC_W::new(self, 18)
    }
    ///Bit 19 - CRC sleep enable
    #[inline(always)]
    pub fn crclpenc(&mut self) -> CRCLPENC_W<AHB4LPENCRrs> {
