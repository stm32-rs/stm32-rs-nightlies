...
impl W {
    ...
    #[inline(always)]
    pub fn gpioalpens(&mut self) -> GPIOALPENS_W<AHB4LPENSRrs> {
        GPIOALPENS_W::new(self, 0)
    }
    ///Bit 1 - GPIOB sleep enable
    #[inline(always)]
    pub fn gpioblpens(&mut self) -> GPIOBLPENS_W<AHB4LPENSRrs> {
        GPIOBLPENS_W::new(self, 1)
    }
    ///Bit 2 - GPIOC sleep enable
    #[inline(always)]
    pub fn gpioclpens(&mut self) -> GPIOCLPENS_W<AHB4LPENSRrs> {
        GPIOCLPENS_W::new(self, 2)
    }
    ///Bit 3 - GPIOD sleep enable
    #[inline(always)]
    pub fn gpiodlpens(&mut self) -> GPIODLPENS_W<AHB4LPENSRrs> {
        GPIODLPENS_W::new(self, 3)
    }
    ///Bit 4 - GPIOE sleep enable
    #[inline(always)]
    pub fn gpioelpens(&mut self) -> GPIOELPENS_W<AHB4LPENSRrs> {
        GPIOELPENS_W::new(self, 4)
    }
    ///Bit 5 - GPIOF sleep enable
    #[inline(always)]
    pub fn gpioflpens(&mut self) -> GPIOFLPENS_W<AHB4LPENSRrs> {
        GPIOFLPENS_W::new(self, 5)
    }
    ///Bit 6 - GPIOG sleep enable
    #[inline(always)]
    pub fn gpioglpens(&mut self) -> GPIOGLPENS_W<AHB4LPENSRrs> {
        GPIOGLPENS_W::new(self, 6)
    }
    ///Bit 7 - GPIOH sleep enable
    #[inline(always)]
    pub fn gpiohlpens(&mut self) -> GPIOHLPENS_W<AHB4LPENSRrs> {
        GPIOHLPENS_W::new(self, 7)
    }
    ///Bit 13 - GPION sleep enable
    #[inline(always)]
    pub fn gpionlpens(&mut self) -> GPIONLPENS_W<AHB4LPENSRrs> {
        GPIONLPENS_W::new(self, 13)
    }
    ///Bit 14 - GPIOO sleep enable
    #[inline(always)]
    pub fn gpioolpens(&mut self) -> GPIOOLPENS_W<AHB4LPENSRrs> {
        GPIOOLPENS_W::new(self, 14)
    }
    ///Bit 15 - GPIOP sleep enable
    #[inline(always)]
    pub fn gpioplpens(&mut self) -> GPIOPLPENS_W<AHB4LPENSRrs> {
        GPIOPLPENS_W::new(self, 15)
    }
    ///Bit 16 - GPIOQ sleep enable
    #[inline(always)]
    pub fn gpioqlpens(&mut self) -> GPIOQLPENS_W<AHB4LPENSRrs> {
        GPIOQLPENS_W::new(self, 16)
    }
    ///Bit 18 - PWR sleep enable
    #[inline(always)]
    pub fn pwrlpens(&mut self) -> PWRLPENS_W<AHB4LPENSRrs> {
        PWRLPENS_W::new(self, 18)
    }
    ///Bit 19 - CRC sleep enable
    #[inline(always)]
    pub fn crclpens(&mut self) -> CRCLPENS_W<AHB4LPENSRrs> {
