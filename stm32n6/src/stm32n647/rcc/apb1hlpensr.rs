...
impl W {
    ...
    #[inline(always)]
    pub fn mdioslpens(&mut self) -> MDIOSLPENS_W<APB1HLPENSRrs> {
        MDIOSLPENS_W::new(self, 5)
    }
    ///Bit 8 - FDCAN sleep enable
    #[inline(always)]
    pub fn fdcanlpens(&mut self) -> FDCANLPENS_W<APB1HLPENSRrs> {
        FDCANLPENS_W::new(self, 8)
    }
    ///Bit 18 - UCPD1 sleep enable
    #[inline(always)]
    pub fn ucpd1lpens(&mut self) -> UCPD1LPENS_W<APB1HLPENSRrs> {
