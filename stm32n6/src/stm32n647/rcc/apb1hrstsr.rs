...
impl W {
    ///Bit 5 - MDIOS reset
    #[inline(always)]
    pub fn mdiosrsts(&mut self) -> MDIOSRSTS_W<APB1HRSTSRrs> {
        MDIOSRSTS_W::new(self, 5)
    }
    ///Bit 8 - FDCAN reset
    #[inline(always)]
    pub fn fdcanrsts(&mut self) -> FDCANRSTS_W<APB1HRSTSRrs> {
        FDCANRSTS_W::new(self, 8)
    }
    ///Bit 18 - UCPD1 reset
    #[inline(always)]
    pub fn ucpd1rsts(&mut self) -> UCPD1RSTS_W<APB1HRSTSRrs> {
