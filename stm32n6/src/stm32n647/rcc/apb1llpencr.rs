...
impl W {
    ...
    #[inline(always)]
    pub fn tim2lpenc(&mut self) -> TIM2LPENC_W<APB1LLPENCRrs> {
        TIM2LPENC_W::new(self, 0)
    }
    ///Bit 1 - TIM3 sleep enable
    #[inline(always)]
    pub fn tim3lpenc(&mut self) -> TIM3LPENC_W<APB1LLPENCRrs> {
        TIM3LPENC_W::new(self, 1)
    }
    ///Bit 2 - TIM4 sleep enable
    #[inline(always)]
    pub fn tim4lpenc(&mut self) -> TIM4LPENC_W<APB1LLPENCRrs> {
        TIM4LPENC_W::new(self, 2)
    }
    ///Bit 3 - TIM5 sleep enable
    #[inline(always)]
    pub fn tim5lpenc(&mut self) -> TIM5LPENC_W<APB1LLPENCRrs> {
        TIM5LPENC_W::new(self, 3)
    }
    ///Bit 4 - TIM6 sleep enable
    #[inline(always)]
    pub fn tim6lpenc(&mut self) -> TIM6LPENC_W<APB1LLPENCRrs> {
        TIM6LPENC_W::new(self, 4)
    }
    ///Bit 5 - TIM7 sleep enable
    #[inline(always)]
    pub fn tim7lpenc(&mut self) -> TIM7LPENC_W<APB1LLPENCRrs> {
        TIM7LPENC_W::new(self, 5)
    }
    ///Bit 6 - TIM12 sleep enable
    #[inline(always)]
    pub fn tim12lpenc(&mut self) -> TIM12LPENC_W<APB1LLPENCRrs> {
        TIM12LPENC_W::new(self, 6)
    }
    ///Bit 7 - TIM13 sleep enable
    #[inline(always)]
    pub fn tim13lpenc(&mut self) -> TIM13LPENC_W<APB1LLPENCRrs> {
        TIM13LPENC_W::new(self, 7)
    }
    ///Bit 8 - TIM14 sleep enable
    #[inline(always)]
    pub fn tim14lpenc(&mut self) -> TIM14LPENC_W<APB1LLPENCRrs> {
        TIM14LPENC_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1 sleep enable
    #[inline(always)]
    pub fn lptim1lpenc(&mut self) -> LPTIM1LPENC_W<APB1LLPENCRrs> {
        LPTIM1LPENC_W::new(self, 9)
    }
    ///Bit 11 - WWDG sleep enable
    #[inline(always)]
    pub fn wwdglpenc(&mut self) -> WWDGLPENC_W<APB1LLPENCRrs> {
        WWDGLPENC_W::new(self, 11)
    }
    ///Bit 12 - TIM10 sleep enable
    #[inline(always)]
    pub fn tim10lpenc(&mut self) -> TIM10LPENC_W<APB1LLPENCRrs> {
        TIM10LPENC_W::new(self, 12)
    }
    ///Bit 13 - TIM11 sleep enable
    #[inline(always)]
    pub fn tim11lpenc(&mut self) -> TIM11LPENC_W<APB1LLPENCRrs> {
        TIM11LPENC_W::new(self, 13)
    }
    ///Bit 14 - SPI2 sleep enable
    #[inline(always)]
    pub fn spi2lpenc(&mut self) -> SPI2LPENC_W<APB1LLPENCRrs> {
        SPI2LPENC_W::new(self, 14)
    }
    ///Bit 15 - SPI3 sleep enable
    #[inline(always)]
    pub fn spi3lpenc(&mut self) -> SPI3LPENC_W<APB1LLPENCRrs> {
        SPI3LPENC_W::new(self, 15)
    }
    ///Bit 16 - SPDIFRX1 sleep enable
    #[inline(always)]
    pub fn spdifrx1lpenc(&mut self) -> SPDIFRX1LPENC_W<APB1LLPENCRrs> {
        SPDIFRX1LPENC_W::new(self, 16)
    }
    ///Bit 17 - USART2 sleep enable
    #[inline(always)]
    pub fn usart2lpenc(&mut self) -> USART2LPENC_W<APB1LLPENCRrs> {
        USART2LPENC_W::new(self, 17)
    }
    ///Bit 18 - USART3 sleep enable
    #[inline(always)]
    pub fn usart3lpenc(&mut self) -> USART3LPENC_W<APB1LLPENCRrs> {
        USART3LPENC_W::new(self, 18)
    }
    ///Bit 19 - UART4 sleep enable
    #[inline(always)]
    pub fn uart4lpenc(&mut self) -> UART4LPENC_W<APB1LLPENCRrs> {
        UART4LPENC_W::new(self, 19)
    }
    ///Bit 20 - UART5 sleep enable
    #[inline(always)]
    pub fn uart5lpenc(&mut self) -> UART5LPENC_W<APB1LLPENCRrs> {
        UART5LPENC_W::new(self, 20)
    }
    ///Bit 21 - I2C1 sleep enable
    #[inline(always)]
    pub fn i2c1lpenc(&mut self) -> I2C1LPENC_W<APB1LLPENCRrs> {
        I2C1LPENC_W::new(self, 21)
    }
    ///Bit 22 - I2C2 sleep enable
    #[inline(always)]
    pub fn i2c2lpenc(&mut self) -> I2C2LPENC_W<APB1LLPENCRrs> {
        I2C2LPENC_W::new(self, 22)
    }
    ///Bit 23 - I2C3 sleep enable
    #[inline(always)]
    pub fn i2c3lpenc(&mut self) -> I2C3LPENC_W<APB1LLPENCRrs> {
        I2C3LPENC_W::new(self, 23)
    }
    ///Bit 24 - I3C1 sleep enable
    #[inline(always)]
    pub fn i3c1lpenc(&mut self) -> I3C1LPENC_W<APB1LLPENCRrs> {
        I3C1LPENC_W::new(self, 24)
    }
    ///Bit 25 - I3C2 sleep enable
    #[inline(always)]
    pub fn i3c2lpenc(&mut self) -> I3C2LPENC_W<APB1LLPENCRrs> {
        I3C2LPENC_W::new(self, 25)
    }
    ///Bit 30 - UART7 sleep enable
    #[inline(always)]
    pub fn uart7lpenc(&mut self) -> UART7LPENC_W<APB1LLPENCRrs> {
        UART7LPENC_W::new(self, 30)
    }
    ///Bit 31 - UART8 sleep enable
    #[inline(always)]
    pub fn uart8lpenc(&mut self) -> UART8LPENC_W<APB1LLPENCRrs> {
