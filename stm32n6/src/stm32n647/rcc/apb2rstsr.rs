...
impl W {
    ///Bit 0 - TIM1 reset
    #[inline(always)]
    pub fn tim1rsts(&mut self) -> TIM1RSTS_W<APB2RSTSRrs> {
        TIM1RSTS_W::new(self, 0)
    }
    ///Bit 1 - TIM8 reset
    #[inline(always)]
    pub fn tim8rsts(&mut self) -> TIM8RSTS_W<APB2RSTSRrs> {
        TIM8RSTS_W::new(self, 1)
    }
    ///Bit 4 - USART1 reset
    #[inline(always)]
    pub fn usart1rsts(&mut self) -> USART1RSTS_W<APB2RSTSRrs> {
        USART1RSTS_W::new(self, 4)
    }
    ///Bit 5 - USART6 reset
    #[inline(always)]
    pub fn usart6rsts(&mut self) -> USART6RSTS_W<APB2RSTSRrs> {
        USART6RSTS_W::new(self, 5)
    }
    ///Bit 6 - UART9 reset
    #[inline(always)]
    pub fn uart9rsts(&mut self) -> UART9RSTS_W<APB2RSTSRrs> {
        UART9RSTS_W::new(self, 6)
    }
    ///Bit 7 - USART10 reset
    #[inline(always)]
    pub fn usart10rsts(&mut self) -> USART10RSTS_W<APB2RSTSRrs> {
        USART10RSTS_W::new(self, 7)
    }
    ///Bit 12 - SPI1 reset
    #[inline(always)]
    pub fn spi1rsts(&mut self) -> SPI1RSTS_W<APB2RSTSRrs> {
        SPI1RSTS_W::new(self, 12)
    }
    ///Bit 13 - SPI4 reset
    #[inline(always)]
    pub fn spi4rsts(&mut self) -> SPI4RSTS_W<APB2RSTSRrs> {
        SPI4RSTS_W::new(self, 13)
    }
    ///Bit 15 - TIM18 reset
    #[inline(always)]
    pub fn tim18rsts(&mut self) -> TIM18RSTS_W<APB2RSTSRrs> {
        TIM18RSTS_W::new(self, 15)
    }
    ///Bit 16 - TIM15 reset
    #[inline(always)]
    pub fn tim15rsts(&mut self) -> TIM15RSTS_W<APB2RSTSRrs> {
        TIM15RSTS_W::new(self, 16)
    }
    ///Bit 17 - TIM16 reset
    #[inline(always)]
    pub fn tim16rsts(&mut self) -> TIM16RSTS_W<APB2RSTSRrs> {
        TIM16RSTS_W::new(self, 17)
    }
    ///Bit 18 - TIM17 reset
    #[inline(always)]
    pub fn tim17rsts(&mut self) -> TIM17RSTS_W<APB2RSTSRrs> {
        TIM17RSTS_W::new(self, 18)
    }
    ///Bit 19 - TIM9 reset
    #[inline(always)]
    pub fn tim9rsts(&mut self) -> TIM9RSTS_W<APB2RSTSRrs> {
        TIM9RSTS_W::new(self, 19)
    }
    ///Bit 20 - SPI5 reset
    #[inline(always)]
    pub fn spi5rsts(&mut self) -> SPI5RSTS_W<APB2RSTSRrs> {
        SPI5RSTS_W::new(self, 20)
    }
    ///Bit 21 - SAI1 reset
    #[inline(always)]
    pub fn sai1rsts(&mut self) -> SAI1RSTS_W<APB2RSTSRrs> {
        SAI1RSTS_W::new(self, 21)
    }
    ///Bit 22 - SAI2 reset
    #[inline(always)]
    pub fn sai2rsts(&mut self) -> SAI2RSTS_W<APB2RSTSRrs> {
