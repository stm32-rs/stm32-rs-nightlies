...
impl W {
    ...
    #[inline(always)]
    pub fn hdplpenc(&mut self) -> HDPLPENC_W<APB4LLPENCRrs> {
        HDPLPENC_W::new(self, 2)
    }
    ///Bit 3 - LPUART1 sleep enable
    #[inline(always)]
    pub fn lpuart1lpenc(&mut self) -> LPUART1LPENC_W<APB4LLPENCRrs> {
        LPUART1LPENC_W::new(self, 3)
    }
    ///Bit 5 - SPI6 sleep enable
    #[inline(always)]
    pub fn spi6lpenc(&mut self) -> SPI6LPENC_W<APB4LLPENCRrs> {
        SPI6LPENC_W::new(self, 5)
    }
    ///Bit 7 - I2C4 sleep enable
    #[inline(always)]
    pub fn i2c4lpenc(&mut self) -> I2C4LPENC_W<APB4LLPENCRrs> {
        I2C4LPENC_W::new(self, 7)
    }
    ///Bit 9 - LPTIM2 sleep enable
    #[inline(always)]
    pub fn lptim2lpenc(&mut self) -> LPTIM2LPENC_W<APB4LLPENCRrs> {
        LPTIM2LPENC_W::new(self, 9)
    }
    ///Bit 10 - LPTIM3 sleep enable
    #[inline(always)]
    pub fn lptim3lpenc(&mut self) -> LPTIM3LPENC_W<APB4LLPENCRrs> {
        LPTIM3LPENC_W::new(self, 10)
    }
    ///Bit 11 - LPTIM4 sleep enable
    #[inline(always)]
    pub fn lptim4lpenc(&mut self) -> LPTIM4LPENC_W<APB4LLPENCRrs> {
        LPTIM4LPENC_W::new(self, 11)
    }
    ///Bit 12 - LPTIM5 sleep enable
    #[inline(always)]
    pub fn lptim5lpenc(&mut self) -> LPTIM5LPENC_W<APB4LLPENCRrs> {
        LPTIM5LPENC_W::new(self, 12)
    }
    ///Bit 15 - VREFBUF sleep enable
    #[inline(always)]
    pub fn vrefbuflpenc(&mut self) -> VREFBUFLPENC_W<APB4LLPENCRrs> {
        VREFBUFLPENC_W::new(self, 15)
    }
    ///Bit 16 - RTC sleep enable
    #[inline(always)]
    pub fn rtclpenc(&mut self) -> RTCLPENC_W<APB4LLPENCRrs> {
        RTCLPENC_W::new(self, 16)
    }
    ///Bit 17 - RTCAPB sleep enable
    #[inline(always)]
    pub fn rtcapblpenc(&mut self) -> RTCAPBLPENC_W<APB4LLPENCRrs> {
        RTCAPBLPENC_W::new(self, 17)
    }
    ///Bit 22 - R2GRET sleep enable
    #[inline(always)]
    pub fn r2gretlpenc(&mut self) -> R2GRETLPENC_W<APB4LLPENCRrs> {
        R2GRETLPENC_W::new(self, 22)
    }
    ///Bit 23 - R2GNPU sleep enable
    #[inline(always)]
    pub fn r2gnpulpenc(&mut self) -> R2GNPULPENC_W<APB4LLPENCRrs> {
        R2GNPULPENC_W::new(self, 23)
    }
    ///Bit 31 - SERF sleep enable
    #[inline(always)]
    pub fn serflpenc(&mut self) -> SERFLPENC_W<APB4LLPENCRrs> {
