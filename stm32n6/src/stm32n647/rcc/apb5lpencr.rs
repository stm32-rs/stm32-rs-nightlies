...
impl W {
    ...
    #[inline(always)]
    pub fn ltdclpenc(&mut self) -> LTDCLPENC_W<APB5LPENCRrs> {
        LTDCLPENC_W::new(self, 1)
    }
    ///Bit 2 - DCMIPP sleep enable
    #[inline(always)]
    pub fn dcmipplpenc(&mut self) -> DCMIPPLPENC_W<APB5LPENCRrs> {
        DCMIPPLPENC_W::new(self, 2)
    }
    ///Bit 4 - GFXTIM sleep enable
    #[inline(always)]
    pub fn gfxtimlpenc(&mut self) -> GFXTIMLPENC_W<APB5LPENCRrs> {
        GFXTIMLPENC_W::new(self, 4)
    }
    ///Bit 5 - VENC sleep enable
    #[inline(always)]
    pub fn venclpenc(&mut self) -> VENCLPENC_W<APB5LPENCRrs> {
        VENCLPENC_W::new(self, 5)
    }
    ///Bit 6 - CSI sleep enable
    #[inline(always)]
    pub fn csilpenc(&mut self) -> CSILPENC_W<APB5LPENCRrs> {
