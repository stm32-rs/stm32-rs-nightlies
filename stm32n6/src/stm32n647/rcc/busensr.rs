...
impl W {
    ///Bit 0 - ACLKN enable
    #[inline(always)]
    pub fn aclknens(&mut self) -> ACLKNENS_W<BUSENSRrs> {
        ACLKNENS_W::new(self, 0)
    }
    ///Bit 1 - ACLKNC enable
    #[inline(always)]
    pub fn aclkncens(&mut self) -> ACLKNCENS_W<BUSENSRrs> {
        ACLKNCENS_W::new(self, 1)
    }
    ///Bit 2 - AHBM enable
    #[inline(always)]
    pub fn ahbmens(&mut self) -> AHBMENS_W<BUSENSRrs> {
        AHBMENS_W::new(self, 2)
    }
    ///Bit 3 - AHB1 enable
    #[inline(always)]
    pub fn ahb1ens(&mut self) -> AHB1ENS_W<BUSENSRrs> {
        AHB1ENS_W::new(self, 3)
    }
    ///Bit 4 - AHB2 enable
    #[inline(always)]
    pub fn ahb2ens(&mut self) -> AHB2ENS_W<BUSENSRrs> {
        AHB2ENS_W::new(self, 4)
    }
    ///Bit 5 - AHB3 enable
    #[inline(always)]
    pub fn ahb3ens(&mut self) -> AHB3ENS_W<BUSENSRrs> {
        AHB3ENS_W::new(self, 5)
    }
    ///Bit 6 - AHB4 enable
    #[inline(always)]
    pub fn ahb4ens(&mut self) -> AHB4ENS_W<BUSENSRrs> {
        AHB4ENS_W::new(self, 6)
    }
    ///Bit 7 - AHB5 enable
    #[inline(always)]
    pub fn ahb5ens(&mut self) -> AHB5ENS_W<BUSENSRrs> {
        AHB5ENS_W::new(self, 7)
    }
    ///Bit 8 - APB1 enable
    #[inline(always)]
    pub fn apb1ens(&mut self) -> APB1ENS_W<BUSENSRrs> {
        APB1ENS_W::new(self, 8)
    }
    ///Bit 9 - APB2 enable
    #[inline(always)]
    pub fn apb2ens(&mut self) -> APB2ENS_W<BUSENSRrs> {
        APB2ENS_W::new(self, 9)
    }
    ///Bit 10 - APB3 enable
    #[inline(always)]
    pub fn apb3ens(&mut self) -> APB3ENS_W<BUSENSRrs> {
        APB3ENS_W::new(self, 10)
    }
    ///Bit 11 - APB4 enable
    #[inline(always)]
    pub fn apb4ens(&mut self) -> APB4ENS_W<BUSENSRrs> {
        APB4ENS_W::new(self, 11)
    }
    ///Bit 12 - APB5 enable
    #[inline(always)]
    pub fn apb5ens(&mut self) -> APB5ENS_W<BUSENSRrs> {
