...
impl W {
    ...
    #[inline(always)]
    pub fn lsecsson(&mut self) -> LSECSSON_W<LSECFGRrs> {
        LSECSSON_W::new(self, 7)
    }
    ///Bit 8 - LSE clock security system (CSS) re-arm function
    #[inline(always)]
    pub fn lsecssra(&mut self) -> LSECSSRA_W<LSECFGRrs> {
        LSECSSRA_W::new(self, 8)
    }
    ///Bit 15 - LSE clock bypass
    #[inline(always)]
    pub fn lsebyp(&mut self) -> LSEBYP_W<LSECFGRrs> {
        LSEBYP_W::new(self, 15)
    }
    ///Bit 16 - LSE clock type in Bypass mode
    #[inline(always)]
    pub fn lseext(&mut self) -> LSEEXT_W<LSECFGRrs> {
        LSEEXT_W::new(self, 16)
    }
    ///Bit 17 - LSE clock glitch filter enable
    #[inline(always)]
    pub fn lsegfon(&mut self) -> LSEGFON_W<LSECFGRrs> {
        LSEGFON_W::new(self, 17)
    }
    ///Bits 18:19 - LSE oscillator driving capability
    #[inline(always)]
    pub fn lsedrv(&mut self) -> LSEDRV_W<LSECFGRrs> {
