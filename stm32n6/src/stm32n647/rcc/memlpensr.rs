...
impl W {
    ...
    #[inline(always)]
    pub fn axisram3lpens(&mut self) -> AXISRAM3LPENS_W<MEMLPENSRrs> {
        AXISRAM3LPENS_W::new(self, 0)
    }
    ///Bit 1 - AXISRAM4 sleep enable
    #[inline(always)]
    pub fn axisram4lpens(&mut self) -> AXISRAM4LPENS_W<MEMLPENSRrs> {
        AXISRAM4LPENS_W::new(self, 1)
    }
    ///Bit 2 - AXISRAM5 sleep enable
    #[inline(always)]
    pub fn axisram5lpens(&mut self) -> AXISRAM5LPENS_W<MEMLPENSRrs> {
        AXISRAM5LPENS_W::new(self, 2)
    }
    ///Bit 3 - AXISRAM6 sleep enable
    #[inline(always)]
    pub fn axisram6lpens(&mut self) -> AXISRAM6LPENS_W<MEMLPENSRrs> {
        AXISRAM6LPENS_W::new(self, 3)
    }
    ///Bit 4 - AHBSRAM1 sleep enable
    #[inline(always)]
    pub fn ahbsram1lpens(&mut self) -> AHBSRAM1LPENS_W<MEMLPENSRrs> {
        AHBSRAM1LPENS_W::new(self, 4)
    }
    ///Bit 5 - AHBSRAM2 sleep enable
    #[inline(always)]
    pub fn ahbsram2lpens(&mut self) -> AHBSRAM2LPENS_W<MEMLPENSRrs> {
        AHBSRAM2LPENS_W::new(self, 5)
    }
    ///Bit 6 - BKPSRAM sleep enable
    #[inline(always)]
    pub fn bkpsramlpens(&mut self) -> BKPSRAMLPENS_W<MEMLPENSRrs> {
        BKPSRAMLPENS_W::new(self, 6)
    }
    ///Bit 7 - AXISRAM1 sleep enable
    #[inline(always)]
    pub fn axisram1lpens(&mut self) -> AXISRAM1LPENS_W<MEMLPENSRrs> {
        AXISRAM1LPENS_W::new(self, 7)
    }
    ///Bit 8 - AXISRAM2 sleep enable
    #[inline(always)]
    pub fn axisram2lpens(&mut self) -> AXISRAM2LPENS_W<MEMLPENSRrs> {
        AXISRAM2LPENS_W::new(self, 8)
    }
    ///Bit 9 - FLEXRAM sleep enable
    #[inline(always)]
    pub fn flexramlpens(&mut self) -> FLEXRAMLPENS_W<MEMLPENSRrs> {
        FLEXRAMLPENS_W::new(self, 9)
    }
    ///Bit 10 - NPUCACHERAM sleep enable
    #[inline(always)]
    pub fn npucacheramlpens(&mut self) -> NPUCACHERAMLPENS_W<MEMLPENSRrs> {
        NPUCACHERAMLPENS_W::new(self, 10)
    }
    ///Bit 11 - VENCRAM sleep enable
    #[inline(always)]
    pub fn vencramlpens(&mut self) -> VENCRAMLPENS_W<MEMLPENSRrs> {
        VENCRAMLPENS_W::new(self, 11)
    }
    ///Bit 12 - BOOTROM sleep enable
    #[inline(always)]
    pub fn bootromlpens(&mut self) -> BOOTROMLPENS_W<MEMLPENSRrs> {
