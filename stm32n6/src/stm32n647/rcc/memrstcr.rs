...
impl W {
    ...
    #[inline(always)]
    pub fn axisram3rstc(&mut self) -> AXISRAM3RSTC_W<MEMRSTCRrs> {
        AXISRAM3RSTC_W::new(self, 0)
    }
    ///Bit 1 - AXISRAM4 reset
    #[inline(always)]
    pub fn axisram4rstc(&mut self) -> AXISRAM4RSTC_W<MEMRSTCRrs> {
        AXISRAM4RSTC_W::new(self, 1)
    }
    ///Bit 2 - AXISRAM5 reset
    #[inline(always)]
    pub fn axisram5rstc(&mut self) -> AXISRAM5RSTC_W<MEMRSTCRrs> {
        AXISRAM5RSTC_W::new(self, 2)
    }
    ///Bit 3 - AXISRAM6 reset
    #[inline(always)]
    pub fn axisram6rstc(&mut self) -> AXISRAM6RSTC_W<MEMRSTCRrs> {
        AXISRAM6RSTC_W::new(self, 3)
    }
    ///Bit 4 - AHBSRAM1 reset
    #[inline(always)]
    pub fn ahbsram1rstc(&mut self) -> AHBSRAM1RSTC_W<MEMRSTCRrs> {
        AHBSRAM1RSTC_W::new(self, 4)
    }
    ///Bit 5 - AHBSRAM2 reset
    #[inline(always)]
    pub fn ahbsram2rstc(&mut self) -> AHBSRAM2RSTC_W<MEMRSTCRrs> {
        AHBSRAM2RSTC_W::new(self, 5)
    }
    ///Bit 7 - AXISRAM1 reset
    #[inline(always)]
    pub fn axisram1rstc(&mut self) -> AXISRAM1RSTC_W<MEMRSTCRrs> {
        AXISRAM1RSTC_W::new(self, 7)
    }
    ///Bit 8 - AXISRAM2 reset
    #[inline(always)]
    pub fn axisram2rstc(&mut self) -> AXISRAM2RSTC_W<MEMRSTCRrs> {
        AXISRAM2RSTC_W::new(self, 8)
    }
    ///Bit 9 - FLEXRAM reset
    #[inline(always)]
    pub fn flexramrstc(&mut self) -> FLEXRAMRSTC_W<MEMRSTCRrs> {
        FLEXRAMRSTC_W::new(self, 9)
    }
    ///Bit 10 - NPUCACHERAM reset
    #[inline(always)]
    pub fn npucacheramrstc(&mut self) -> NPUCACHERAMRSTC_W<MEMRSTCRrs> {
        NPUCACHERAMRSTC_W::new(self, 10)
    }
    ///Bit 11 - VENCRAM reset
    #[inline(always)]
    pub fn vencramrstc(&mut self) -> VENCRAMRSTC_W<MEMRSTCRrs> {
        VENCRAMRSTC_W::new(self, 11)
    }
    ///Bit 12 - BOOTROM reset
    #[inline(always)]
    pub fn bootromrstc(&mut self) -> BOOTROMRSTC_W<MEMRSTCRrs> {
