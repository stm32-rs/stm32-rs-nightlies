...
impl W {
    ...
    #[inline(always)]
    pub fn axisram3rsts(&mut self) -> AXISRAM3RSTS_W<MEMRSTSRrs> {
        AXISRAM3RSTS_W::new(self, 0)
    }
    ///Bit 1 - AXISRAM4 reset
    #[inline(always)]
    pub fn axisram4rsts(&mut self) -> AXISRAM4RSTS_W<MEMRSTSRrs> {
        AXISRAM4RSTS_W::new(self, 1)
    }
    ///Bit 2 - AXISRAM5 reset
    #[inline(always)]
    pub fn axisram5rsts(&mut self) -> AXISRAM5RSTS_W<MEMRSTSRrs> {
        AXISRAM5RSTS_W::new(self, 2)
    }
    ///Bit 3 - AXISRAM6 reset
    #[inline(always)]
    pub fn axisram6rsts(&mut self) -> AXISRAM6RSTS_W<MEMRSTSRrs> {
        AXISRAM6RSTS_W::new(self, 3)
    }
    ///Bit 4 - AHBSRAM1 reset
    #[inline(always)]
    pub fn ahbsram1rsts(&mut self) -> AHBSRAM1RSTS_W<MEMRSTSRrs> {
        AHBSRAM1RSTS_W::new(self, 4)
    }
    ///Bit 5 - AHBSRAM2 reset
    #[inline(always)]
    pub fn ahbsram2rsts(&mut self) -> AHBSRAM2RSTS_W<MEMRSTSRrs> {
        AHBSRAM2RSTS_W::new(self, 5)
    }
    ///Bit 7 - AXISRAM1 reset
    #[inline(always)]
    pub fn axisram1rsts(&mut self) -> AXISRAM1RSTS_W<MEMRSTSRrs> {
        AXISRAM1RSTS_W::new(self, 7)
    }
    ///Bit 8 - AXISRAM2 reset
    #[inline(always)]
    pub fn axisram2rsts(&mut self) -> AXISRAM2RSTS_W<MEMRSTSRrs> {
        AXISRAM2RSTS_W::new(self, 8)
    }
    ///Bit 9 - FLEXRAM reset
    #[inline(always)]
    pub fn flexramrsts(&mut self) -> FLEXRAMRSTS_W<MEMRSTSRrs> {
        FLEXRAMRSTS_W::new(self, 9)
    }
    ///Bit 10 - NPUCACHERAM reset
    #[inline(always)]
    pub fn npucacheramrsts(&mut self) -> NPUCACHERAMRSTS_W<MEMRSTSRrs> {
        NPUCACHERAMRSTS_W::new(self, 10)
    }
    ///Bit 11 - VENCRAM reset
    #[inline(always)]
    pub fn vencramrsts(&mut self) -> VENCRAMRSTS_W<MEMRSTSRrs> {
        VENCRAMRSTS_W::new(self, 11)
    }
    ///Bit 12 - BOOTROM reset
    #[inline(always)]
    pub fn bootromrsts(&mut self) -> BOOTROMRSTS_W<MEMRSTSRrs> {
