...
impl W {
    ...
    #[inline(always)]
    pub fn dbglpens(&mut self) -> DBGLPENS_W<MISCLPENSRrs> {
        DBGLPENS_W::new(self, 0)
    }
    ///Bit 3 - XSPIPHYCOMP sleep enable
    #[inline(always)]
    pub fn xspiphycomplpens(&mut self) -> XSPIPHYCOMPLPENS_W<MISCLPENSRrs> {
        XSPIPHYCOMPLPENS_W::new(self, 3)
    }
    ///Bit 6 - PER sleep enable
    #[inline(always)]
    pub fn perlpens(&mut self) -> PERLPENS_W<MISCLPENSRrs> {
