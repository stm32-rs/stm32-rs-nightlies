...
impl W {
    ///Bit 0 - DBG reset
    #[inline(always)]
    pub fn dbgrstc(&mut self) -> DBGRSTC_W<MISCRSTCRrs> {
        DBGRSTC_W::new(self, 0)
    }
    ///Bit 4 - XSPIPHY1 reset
    #[inline(always)]
    pub fn xspiphy1rstc(&mut self) -> XSPIPHY1RSTC_W<MISCRSTCRrs> {
        XSPIPHY1RSTC_W::new(self, 4)
    }
    ///Bit 5 - XSPIPHY2 reset
    #[inline(always)]
    pub fn xspiphy2rstc(&mut self) -> XSPIPHY2RSTC_W<MISCRSTCRrs> {
        XSPIPHY2RSTC_W::new(self, 5)
    }
    ///Bit 7 - SDMMC1DLL reset
    #[inline(always)]
    pub fn sdmmc1dllrstc(&mut self) -> SDMMC1DLLRSTC_W<MISCRSTCRrs> {
        SDMMC1DLLRSTC_W::new(self, 7)
    }
    ///Bit 8 - SDMMC2DLL reset
    #[inline(always)]
    pub fn sdmmc2dllrstc(&mut self) -> SDMMC2DLLRSTC_W<MISCRSTCRrs> {
