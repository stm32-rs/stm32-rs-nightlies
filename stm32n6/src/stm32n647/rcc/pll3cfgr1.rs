...
impl W {
    ///Bits 8:19 - PLL3 Integer part for the VCO multiplication factor
    #[inline(always)]
    pub fn pll3divn(&mut self) -> PLL3DIVN_W<PLL3CFGR1rs> {
        PLL3DIVN_W::new(self, 8)
    }
    ///Bits 20:25 - PLL3 reference input clock divide frequency ratio
    #[inline(always)]
    pub fn pll3divm(&mut self) -> PLL3DIVM_W<PLL3CFGR1rs> {
        PLL3DIVM_W::new(self, 20)
    }
    ///Bit 27 - PLL3 bypass
    #[inline(always)]
    pub fn pll3byp(&mut self) -> PLL3BYP_W<PLL3CFGR1rs> {
        PLL3BYP_W::new(self, 27)
    }
    ///Bits 28:30 - PLL3 source selection of the reference clock
    #[inline(always)]
    pub fn pll3sel(&mut self) -> PLL3SEL_W<PLL3CFGR1rs> {
