///Register `REG6_CIDCFGR` reader
pub type R = crate::R<REG6_CIDCFGRrs>;
///Register `REG6_CIDCFGR` writer
pub type W = crate::W<REG6_CIDCFGRrs>;
...
impl W {
    ///Bit 0 - read enable for compartment y
    #[inline(always)]
    pub fn rdenc0(&mut self) -> RDENC0_W<'_, REG6_CIDCFGRrs> {
        RDENC0_W::new(self, 0)
    }
    ///Bit 1 - read enable for compartment y
    #[inline(always)]
    pub fn rdenc1(&mut self) -> RDENC1_W<'_, REG6_CIDCFGRrs> {
        RDENC1_W::new(self, 1)
    }
    ///Bit 2 - read enable for compartment y
    #[inline(always)]
    pub fn rdenc2(&mut self) -> RDENC2_W<'_, REG6_CIDCFGRrs> {
        RDENC2_W::new(self, 2)
    }
    ///Bit 3 - read enable for compartment y
    #[inline(always)]
    pub fn rdenc3(&mut self) -> RDENC3_W<'_, REG6_CIDCFGRrs> {
        RDENC3_W::new(self, 3)
    }
    ///Bit 4 - read enable for compartment y
    #[inline(always)]
    pub fn rdenc4(&mut self) -> RDENC4_W<'_, REG6_CIDCFGRrs> {
        RDENC4_W::new(self, 4)
    }
    ///Bit 5 - read enable for compartment y
    #[inline(always)]
    pub fn rdenc5(&mut self) -> RDENC5_W<'_, REG6_CIDCFGRrs> {
        RDENC5_W::new(self, 5)
    }
    ///Bit 6 - read enable for compartment y
    #[inline(always)]
    pub fn rdenc6(&mut self) -> RDENC6_W<'_, REG6_CIDCFGRrs> {
        RDENC6_W::new(self, 6)
    }
    ///Bit 7 - read enable for compartment y
    #[inline(always)]
    pub fn rdenc7(&mut self) -> RDENC7_W<'_, REG6_CIDCFGRrs> {
        RDENC7_W::new(self, 7)
    }
    ///Bit 16 - write enable for compartment y
    #[inline(always)]
    pub fn wrenc0(&mut self) -> WRENC0_W<'_, REG6_CIDCFGRrs> {
        WRENC0_W::new(self, 16)
    }
    ///Bit 17 - write enable for compartment y
    #[inline(always)]
    pub fn wrenc1(&mut self) -> WRENC1_W<'_, REG6_CIDCFGRrs> {
        WRENC1_W::new(self, 17)
    }
    ///Bit 18 - write enable for compartment y
    #[inline(always)]
    pub fn wrenc2(&mut self) -> WRENC2_W<'_, REG6_CIDCFGRrs> {
        WRENC2_W::new(self, 18)
    }
    ///Bit 19 - write enable for compartment y
    #[inline(always)]
    pub fn wrenc3(&mut self) -> WRENC3_W<'_, REG6_CIDCFGRrs> {
        WRENC3_W::new(self, 19)
    }
    ///Bit 20 - write enable for compartment y
    #[inline(always)]
    pub fn wrenc4(&mut self) -> WRENC4_W<'_, REG6_CIDCFGRrs> {
        WRENC4_W::new(self, 20)
    }
    ///Bit 21 - write enable for compartment y
    #[inline(always)]
    pub fn wrenc5(&mut self) -> WRENC5_W<'_, REG6_CIDCFGRrs> {
        WRENC5_W::new(self, 21)
    }
    ///Bit 22 - write enable for compartment y
    #[inline(always)]
    pub fn wrenc6(&mut self) -> WRENC6_W<'_, REG6_CIDCFGRrs> {
        WRENC6_W::new(self, 22)
    }
    ///Bit 23 - write enable for compartment y
    #[inline(always)]
    pub fn wrenc7(&mut self) -> WRENC7_W<'_, REG6_CIDCFGRrs> {
        WRENC7_W::new(self, 23)
    }
}
/**RISAF region 6 CID configuration register

You can [`read`](crate::Reg::read) this register and get [`reg6_cidcfgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`reg6_cidcfgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#RISAF:REG6_CIDCFGR)*/
pub struct REG6_CIDCFGRrs;
impl crate::RegisterSpec for REG6_CIDCFGRrs {
    type Ux = u32;
}
///`read()` method returns [`reg6_cidcfgr::R`](R) reader structure
impl crate::Readable for REG6_CIDCFGRrs {}
///`write(|w| ..)` method takes [`reg6_cidcfgr::W`](W) writer structure
impl crate::Writable for REG6_CIDCFGRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets REG6_CIDCFGR to value 0
impl crate::Resettable for REG6_CIDCFGRrs {}
