...
///Field `WUTPRIV` reader - Wake-up timer privilege protection
pub type WUTPRIV_R = crate::BitReader;
///Field `WUTPRIV` writer - Wake-up timer privilege protection
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#RTC:PRIVCFGR)*/
