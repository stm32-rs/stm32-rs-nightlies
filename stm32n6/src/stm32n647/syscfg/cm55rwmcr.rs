...
impl W {
    ///Bit 0 - RW margin enable input for TCM memories
    #[inline(always)]
    pub fn rme_tcm(&mut self) -> RME_TCM_W<CM55RWMCRrs> {
        RME_TCM_W::new(self, 0)
    }
    ///Bits 1:4 - External RW margin inputs for TCM memories
    #[inline(always)]
    pub fn rm_tcm(&mut self) -> RM_TCM_W<CM55RWMCRrs> {
        RM_TCM_W::new(self, 1)
    }
    ///Bit 5 - Biasing level adjust input recommended for Vnom
    #[inline(always)]
    pub fn bc1_tcm(&mut self) -> BC1_TCM_W<CM55RWMCRrs> {
        BC1_TCM_W::new(self, 5)
    }
    ///Bit 6 - Biasing level adjust input recommended for Vnom + 10%
    #[inline(always)]
    pub fn bc2_tcm(&mut self) -> BC2_TCM_W<CM55RWMCRrs> {
        BC2_TCM_W::new(self, 6)
    }
    ///Bit 7 - RW margin enable input for caches memories
    #[inline(always)]
    pub fn rme_cache(&mut self) -> RME_CACHE_W<CM55RWMCRrs> {
        RME_CACHE_W::new(self, 7)
    }
    ///Bits 8:11 - External read/write (RW) margin inputs for caches memories
    #[inline(always)]
    pub fn rm_cache(&mut self) -> RM_CACHE_W<CM55RWMCRrs> {
        RM_CACHE_W::new(self, 8)
    }
    ///Bit 12 - Biasing level adjust input recommended for Vnom.
    #[inline(always)]
    pub fn bc1_cache(&mut self) -> BC1_CACHE_W<CM55RWMCRrs> {
        BC1_CACHE_W::new(self, 12)
    }
    ///Bit 13 - Biasing level adjust input recommended for Vnom + 10%
    #[inline(always)]
    pub fn bc2_cache(&mut self) -> BC2_CACHE_W<CM55RWMCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#SYSCFG:CM55RWMCR)*/
