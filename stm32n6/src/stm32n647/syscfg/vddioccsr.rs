///Register `VDDIOCCSR` reader
pub type R = crate::R<VDDIOCCSRrs>;
...
///Field `READY` reader - Provides the compensation cell status of I/Os supplied by VDDIO
...
impl R {
    ...
    ///Bit 8 - Provides the compensation cell status of I/Os supplied by VDDIO
    #[inline(always)]
...
You can [`read`](crate::Reg::read) this register and get [`vddioccsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#SYSCFG:VDDIOCCSR)*/
pub struct VDDIOCCSRrs;
impl crate::RegisterSpec for VDDIOCCSRrs {
    type Ux = u32;
}
///`read()` method returns [`vddioccsr::R`](R) reader structure
impl crate::Readable for VDDIOCCSRrs {}
///`reset()` method sets VDDIOCCSR to value 0
impl crate::Resettable for VDDIOCCSRrs {}
