...
///Field `TAMP2E` reader - Tamper detection on TAMP_IN2 enableless thansup>(1)less than/sup>
pub type TAMP2E_R = crate::BitReader;
///Field `TAMP2E` writer - Tamper detection on TAMP_IN2 enableless thansup>(1)less than/sup>
pub type TAMP2E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP3E` reader - Tamper detection on TAMP_IN3 enableless thansup>(1)less than/sup>
pub type TAMP3E_R = crate::BitReader;
///Field `TAMP3E` writer - Tamper detection on TAMP_IN3 enableless thansup>(1)less than/sup>
pub type TAMP3E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP4E` reader - Tamper detection on TAMP_IN4 enableless thansup>(1)less than/sup>
pub type TAMP4E_R = crate::BitReader;
///Field `TAMP4E` writer - Tamper detection on TAMP_IN4 enableless thansup>(1)less than/sup>
pub type TAMP4E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP5E` reader - Tamper detection on TAMP_IN5 enableless thansup>(1)less than/sup>
pub type TAMP5E_R = crate::BitReader;
///Field `TAMP5E` writer - Tamper detection on TAMP_IN5 enableless thansup>(1)less than/sup>
pub type TAMP5E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP6E` reader - Tamper detection on TAMP_IN6 enableless thansup>(1)less than/sup>
pub type TAMP6E_R = crate::BitReader;
///Field `TAMP6E` writer - Tamper detection on TAMP_IN6 enableless thansup>(1)less than/sup>
pub type TAMP6E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAMP7E` reader - Tamper detection on TAMP_IN7 enableless thansup>(1)less than/sup>
pub type TAMP7E_R = crate::BitReader;
///Field `TAMP7E` writer - Tamper detection on TAMP_IN7 enableless thansup>(1)less than/sup>
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#TAMP:CR1)*/
pub struct CR1rs;
