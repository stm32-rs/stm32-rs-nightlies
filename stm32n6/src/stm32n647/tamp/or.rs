...
///Field `VCOREMEN` reader - Vless thansub>COREless than/sub> monitoring
pub type VCOREMEN_R = crate::BitReader;
///Field `VCOREMEN` writer - Vless thansub>COREless than/sub> monitoring
...
impl R {
    ///Bit 0 - Vless thansub>COREless than/sub> monitoring
    #[inline(always)]
...
impl W {
    ///Bit 0 - Vless thansub>COREless than/sub> monitoring
    #[inline(always)]
    pub fn vcoremen(&mut self) -> VCOREMEN_W<ORrs> {
        VCOREMEN_W::new(self, 0)
    }
    ///Bit 1 - Boundary scan enable
    #[inline(always)]
    pub fn bsen(&mut self) -> BSEN_W<ORrs> {
        BSEN_W::new(self, 1)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#TAMP:OR)*/
pub struct ORrs;
