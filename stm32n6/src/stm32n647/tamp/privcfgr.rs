...
///Field `TAMPPRIV` reader - Tamper privilege protection (excluding backup registers)
pub type TAMPPRIV_R = crate::BitReader;
///Field `TAMPPRIV` writer - Tamper privilege protection (excluding backup registers)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#TAMP:PRIVCFGR)*/
