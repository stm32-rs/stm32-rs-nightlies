...
///Field `BK2INE` reader - TIMx_BKIN2 input enable
pub type BK2INE_R = crate::BitReader;
///Field `BK2INE` writer - TIMx_BKIN2 input enable
pub type BK2INE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BK2CMP1E` reader - tim_brk2_cmp1 enable
pub type BK2CMP1E_R = crate::BitReader;
///Field `BK2CMP1E` writer - tim_brk2_cmp1 enable
pub type BK2CMP1E_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BK2CMP2E` reader - tim_brk2_cmp2 enable
pub type BK2CMP2E_R = crate::BitReader;
///Field `BK2CMP2E` writer - tim_brk2_cmp2 enable
