...
impl W {
    ...
    ///Bits 10:11 - Input capture 2 prescaler
    #[inline(always)]
    pub fn ic2psc(&mut self) -> IC2PSC_W<'_, CCMR1_INPUTrs> {
        IC2PSC_W::new(self, 10)
    }
    ///Bits 12:15 - Input capture 2 filter
    #[inline(always)]
    pub fn ic2f(&mut self) -> IC2F_W<'_, CCMR1_INPUTrs> {
        IC2F_W::new(self, 12)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#TIM12:CCMR1_Input)*/
