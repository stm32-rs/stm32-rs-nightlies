...
pub type R = crate::R<ISR_FIFO_DISABLEDrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ISR_FIFO_DISABLED")
            .field("pe", &self.pe())
            .field("fe", &self.fe())
            .field("ne", &self.ne())
            .field("ore", &self.ore())
...
pub struct ISR_FIFO_DISABLEDrs;
impl crate::RegisterSpec for ISR_FIFO_DISABLEDrs {
    type Ux = u32;
}
///`read()` method returns [`isr_fifo_disabled::R`](R) reader structure
impl crate::Readable for ISR_FIFO_DISABLEDrs {}
///`reset()` method sets ISR_FIFO_DISABLED to value 0xc0
impl crate::Resettable for ISR_FIFO_DISABLEDrs {
