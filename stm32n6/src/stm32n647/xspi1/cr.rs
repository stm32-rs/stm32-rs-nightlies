...
impl W {
    ...
    ///Bit 25 - no prefetch data
    #[inline(always)]
    pub fn nopref(&mut self) -> NOPREF_W<CRrs> {
        NOPREF_W::new(self, 25)
    }
    ///Bit 26 - no prefetch for signaled AXI transactions
    #[inline(always)]
    pub fn nopref_axi(&mut self) -> NOPREF_AXI_W<CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#XSPI1:CR)*/
pub struct CRrs;
