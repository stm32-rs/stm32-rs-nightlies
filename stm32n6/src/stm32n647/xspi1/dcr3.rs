...
///Field `CSBOUND` reader - NCS boundary
pub type CSBOUND_R = crate::FieldReader;
///Field `CSBOUND` writer - NCS boundary
...
impl W {
    ///Bits 0:7 - Maximum transfer
    #[inline(always)]
    pub fn maxtran(&mut self) -> MAXTRAN_W<'_, DCR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#XSPI1:DCR3)*/
pub struct DCR3rs;
