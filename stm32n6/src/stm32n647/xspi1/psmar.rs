...
///Field `MATCH` reader - None
pub type MATCH_R = crate::FieldReader<u32>;
///Field `MATCH` writer - None
...
impl W {
    ///Bits 0:31 - None
    #[inline(always)]
    pub fn match_(&mut self) -> MATCH_W<'_, PSMARrs> {
        MATCH_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#XSPI1:PSMAR)*/
pub struct PSMARrs;
