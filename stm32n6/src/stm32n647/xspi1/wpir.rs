...
///Field `INSTRUCTION` reader - None
pub type INSTRUCTION_R = crate::FieldReader<u32>;
///Field `INSTRUCTION` writer - None
...
impl W {
    ///Bits 0:31 - None
    #[inline(always)]
    pub fn instruction(&mut self) -> INSTRUCTION_W<'_, WPIRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N647.html#XSPI1:WPIR)*/
pub struct WPIRrs;
