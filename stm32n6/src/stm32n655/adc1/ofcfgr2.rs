///Register `OFCFGR2` reader
pub type R = crate::R<OFCFGR2rs>;
///Register `OFCFGR2` writer
pub type W = crate::W<OFCFGR2rs>;
...
impl W {
    ///Bit 24 - Positive offset enable
    #[inline(always)]
    pub fn posoff(&mut self) -> POSOFF_W<'_, OFCFGR2rs> {
        POSOFF_W::new(self, 24)
    }
    ///Bit 25 - Unsigned saturation enable
    #[inline(always)]
    pub fn usat(&mut self) -> USAT_W<'_, OFCFGR2rs> {
        USAT_W::new(self, 25)
    }
    ///Bit 26 - Signed saturation enable
    #[inline(always)]
    pub fn ssat(&mut self) -> SSAT_W<'_, OFCFGR2rs> {
        SSAT_W::new(self, 26)
    }
    ///Bits 27:31 - Channel selection for the data offset y
    #[inline(always)]
    pub fn offset_ch(&mut self) -> OFFSET_CH_W<'_, OFCFGR2rs> {
        OFFSET_CH_W::new(self, 27)
    }
}
/**ADC offset 2 configuration register

You can [`read`](crate::Reg::read) this register and get [`ofcfgr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ofcfgr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#ADC1:OFCFGR2)*/
pub struct OFCFGR2rs;
impl crate::RegisterSpec for OFCFGR2rs {
    type Ux = u32;
}
///`read()` method returns [`ofcfgr2::R`](R) reader structure
impl crate::Readable for OFCFGR2rs {}
///`write(|w| ..)` method takes [`ofcfgr2::W`](W) writer structure
impl crate::Writable for OFCFGR2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OFCFGR2 to value 0
impl crate::Resettable for OFCFGR2rs {}
