...
///Field `TRGSENS` reader - DFLT0 trigger sensitivity selection
pub type TRGSENS_R = crate::BitReader;
///Field `TRGSENS` writer - DFLT0 trigger sensitivity selection
...
impl R {
    ...
    ///Bit 8 - DFLT0 trigger sensitivity selection
    #[inline(always)]
...
impl W {
    ///Bit 0 - DFLT0 enable
    #[inline(always)]
    pub fn dflten(&mut self) -> DFLTEN_W<'_, DFLT0CRrs> {
        DFLTEN_W::new(self, 0)
    }
    ///Bit 1 - DMA requests enable
    #[inline(always)]
    pub fn dmaen(&mut self) -> DMAEN_W<'_, DFLT0CRrs> {
        DMAEN_W::new(self, 1)
    }
    ///Bit 2 - RXFIFO threshold selection
    #[inline(always)]
    pub fn fth(&mut self) -> FTH_W<'_, DFLT0CRrs> {
        FTH_W::new(self, 2)
    }
    ///Bits 4:6 - DFLT0 trigger mode
    #[inline(always)]
    pub fn acqmod(&mut self) -> ACQMOD_W<'_, DFLT0CRrs> {
        ACQMOD_W::new(self, 4)
    }
    ///Bit 8 - DFLT0 trigger sensitivity selection
    #[inline(always)]
    pub fn trgsens(&mut self) -> TRGSENS_W<'_, DFLT0CRrs> {
        TRGSENS_W::new(self, 8)
    }
    ///Bits 12:15 - DFLT0 trigger signal selection
    #[inline(always)]
    pub fn trgsrc(&mut self) -> TRGSRC_W<'_, DFLT0CRrs> {
        TRGSRC_W::new(self, 12)
    }
    ///Bits 20:27 - Number of samples to be discarded
    #[inline(always)]
    pub fn nbdis(&mut self) -> NBDIS_W<'_, DFLT0CRrs> {
        NBDIS_W::new(self, 20)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#ADF:DFLT0CR)*/
