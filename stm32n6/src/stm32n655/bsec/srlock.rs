...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SRLOCK0` field.</div>
    #[inline(always)]
    pub fn srlock(&mut self, n: u8) -> SRLOCK_W<SRLOCKrs> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        SRLOCK_W::new(self, n)
    }
    ///Bit 0 - sticky reload lock for fuse word 0
    #[inline(always)]
    pub fn srlock0(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 0)
    }
    ///Bit 1 - sticky reload lock for fuse word 1
    #[inline(always)]
    pub fn srlock1(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 1)
    }
    ///Bit 2 - sticky reload lock for fuse word 2
    #[inline(always)]
    pub fn srlock2(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 2)
    }
    ///Bit 3 - sticky reload lock for fuse word 3
    #[inline(always)]
    pub fn srlock3(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 3)
    }
    ///Bit 4 - sticky reload lock for fuse word 4
    #[inline(always)]
    pub fn srlock4(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 4)
    }
    ///Bit 5 - sticky reload lock for fuse word 5
    #[inline(always)]
    pub fn srlock5(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 5)
    }
    ///Bit 6 - sticky reload lock for fuse word 6
    #[inline(always)]
    pub fn srlock6(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 6)
    }
    ///Bit 7 - sticky reload lock for fuse word 7
    #[inline(always)]
    pub fn srlock7(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 7)
    }
    ///Bit 8 - sticky reload lock for fuse word 8
    #[inline(always)]
    pub fn srlock8(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 8)
    }
    ///Bit 9 - sticky reload lock for fuse word 9
    #[inline(always)]
    pub fn srlock9(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 9)
    }
    ///Bit 10 - sticky reload lock for fuse word 10
    #[inline(always)]
    pub fn srlock10(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 10)
    }
    ///Bit 11 - sticky reload lock for fuse word 11
    #[inline(always)]
    pub fn srlock11(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 11)
    }
    ///Bit 12 - sticky reload lock for fuse word 12
    #[inline(always)]
    pub fn srlock12(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 12)
    }
    ///Bit 13 - sticky reload lock for fuse word 13
    #[inline(always)]
    pub fn srlock13(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 13)
    }
    ///Bit 14 - sticky reload lock for fuse word 14
    #[inline(always)]
    pub fn srlock14(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 14)
    }
    ///Bit 15 - sticky reload lock for fuse word 15
    #[inline(always)]
    pub fn srlock15(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 15)
    }
    ///Bit 16 - sticky reload lock for fuse word 16
    #[inline(always)]
    pub fn srlock16(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 16)
    }
    ///Bit 17 - sticky reload lock for fuse word 17
    #[inline(always)]
    pub fn srlock17(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 17)
    }
    ///Bit 18 - sticky reload lock for fuse word 18
    #[inline(always)]
    pub fn srlock18(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 18)
    }
    ///Bit 19 - sticky reload lock for fuse word 19
    #[inline(always)]
    pub fn srlock19(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 19)
    }
    ///Bit 20 - sticky reload lock for fuse word 20
    #[inline(always)]
    pub fn srlock20(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 20)
    }
    ///Bit 21 - sticky reload lock for fuse word 21
    #[inline(always)]
    pub fn srlock21(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 21)
    }
    ///Bit 22 - sticky reload lock for fuse word 22
    #[inline(always)]
    pub fn srlock22(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 22)
    }
    ///Bit 23 - sticky reload lock for fuse word 23
    #[inline(always)]
    pub fn srlock23(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 23)
    }
    ///Bit 24 - sticky reload lock for fuse word 24
    #[inline(always)]
    pub fn srlock24(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 24)
    }
    ///Bit 25 - sticky reload lock for fuse word 25
    #[inline(always)]
    pub fn srlock25(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 25)
    }
    ///Bit 26 - sticky reload lock for fuse word 26
    #[inline(always)]
    pub fn srlock26(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 26)
    }
    ///Bit 27 - sticky reload lock for fuse word 27
    #[inline(always)]
    pub fn srlock27(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 27)
    }
    ///Bit 28 - sticky reload lock for fuse word 28
    #[inline(always)]
    pub fn srlock28(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 28)
    }
    ///Bit 29 - sticky reload lock for fuse word 29
    #[inline(always)]
    pub fn srlock29(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 29)
    }
    ///Bit 30 - sticky reload lock for fuse word 30
    #[inline(always)]
    pub fn srlock30(&mut self) -> SRLOCK_W<SRLOCKrs> {
        SRLOCK_W::new(self, 30)
    }
    ///Bit 31 - sticky reload lock for fuse word 31
    #[inline(always)]
    pub fn srlock31(&mut self) -> SRLOCK_W<SRLOCKrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#BSEC:SRLOCK[0])*/
pub struct SRLOCKrs;
