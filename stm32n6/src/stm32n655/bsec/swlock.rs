...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SWLOCK0` field.</div>
    #[inline(always)]
    pub fn swlock(&mut self, n: u8) -> SWLOCK_W<SWLOCKrs> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        SWLOCK_W::new(self, n)
    }
    ///Bit 0 - sticky write lock for shadow register 0
    #[inline(always)]
    pub fn swlock0(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 0)
    }
    ///Bit 1 - sticky write lock for shadow register 1
    #[inline(always)]
    pub fn swlock1(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 1)
    }
    ///Bit 2 - sticky write lock for shadow register 2
    #[inline(always)]
    pub fn swlock2(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 2)
    }
    ///Bit 3 - sticky write lock for shadow register 3
    #[inline(always)]
    pub fn swlock3(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 3)
    }
    ///Bit 4 - sticky write lock for shadow register 4
    #[inline(always)]
    pub fn swlock4(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 4)
    }
    ///Bit 5 - sticky write lock for shadow register 5
    #[inline(always)]
    pub fn swlock5(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 5)
    }
    ///Bit 6 - sticky write lock for shadow register 6
    #[inline(always)]
    pub fn swlock6(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 6)
    }
    ///Bit 7 - sticky write lock for shadow register 7
    #[inline(always)]
    pub fn swlock7(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 7)
    }
    ///Bit 8 - sticky write lock for shadow register 8
    #[inline(always)]
    pub fn swlock8(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 8)
    }
    ///Bit 9 - sticky write lock for shadow register 9
    #[inline(always)]
    pub fn swlock9(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 9)
    }
    ///Bit 10 - sticky write lock for shadow register 10
    #[inline(always)]
    pub fn swlock10(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 10)
    }
    ///Bit 11 - sticky write lock for shadow register 11
    #[inline(always)]
    pub fn swlock11(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 11)
    }
    ///Bit 12 - sticky write lock for shadow register 12
    #[inline(always)]
    pub fn swlock12(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 12)
    }
    ///Bit 13 - sticky write lock for shadow register 13
    #[inline(always)]
    pub fn swlock13(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 13)
    }
    ///Bit 14 - sticky write lock for shadow register 14
    #[inline(always)]
    pub fn swlock14(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 14)
    }
    ///Bit 15 - sticky write lock for shadow register 15
    #[inline(always)]
    pub fn swlock15(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 15)
    }
    ///Bit 16 - sticky write lock for shadow register 16
    #[inline(always)]
    pub fn swlock16(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 16)
    }
    ///Bit 17 - sticky write lock for shadow register 17
    #[inline(always)]
    pub fn swlock17(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 17)
    }
    ///Bit 18 - sticky write lock for shadow register 18
    #[inline(always)]
    pub fn swlock18(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 18)
    }
    ///Bit 19 - sticky write lock for shadow register 19
    #[inline(always)]
    pub fn swlock19(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 19)
    }
    ///Bit 20 - sticky write lock for shadow register 20
    #[inline(always)]
    pub fn swlock20(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 20)
    }
    ///Bit 21 - sticky write lock for shadow register 21
    #[inline(always)]
    pub fn swlock21(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 21)
    }
    ///Bit 22 - sticky write lock for shadow register 22
    #[inline(always)]
    pub fn swlock22(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 22)
    }
    ///Bit 23 - sticky write lock for shadow register 23
    #[inline(always)]
    pub fn swlock23(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 23)
    }
    ///Bit 24 - sticky write lock for shadow register 24
    #[inline(always)]
    pub fn swlock24(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 24)
    }
    ///Bit 25 - sticky write lock for shadow register 25
    #[inline(always)]
    pub fn swlock25(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 25)
    }
    ///Bit 26 - sticky write lock for shadow register 26
    #[inline(always)]
    pub fn swlock26(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 26)
    }
    ///Bit 27 - sticky write lock for shadow register 27
    #[inline(always)]
    pub fn swlock27(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 27)
    }
    ///Bit 28 - sticky write lock for shadow register 28
    #[inline(always)]
    pub fn swlock28(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 28)
    }
    ///Bit 29 - sticky write lock for shadow register 29
    #[inline(always)]
    pub fn swlock29(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 29)
    }
    ///Bit 30 - sticky write lock for shadow register 30
    #[inline(always)]
    pub fn swlock30(&mut self) -> SWLOCK_W<SWLOCKrs> {
        SWLOCK_W::new(self, 30)
    }
    ///Bit 31 - sticky write lock for shadow register 31
    #[inline(always)]
    pub fn swlock31(&mut self) -> SWLOCK_W<SWLOCKrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#BSEC:SWLOCK[0])*/
pub struct SWLOCKrs;
