...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DCMIPP:IPC1R3)*/
pub struct IPC1R3rs;
...
///`reset()` method sets IPC1R3 to value 0x007f_0000
impl crate::Resettable for IPC1R3rs {
    const RESET_VALUE: u32 = 0x007f_0000;
}
