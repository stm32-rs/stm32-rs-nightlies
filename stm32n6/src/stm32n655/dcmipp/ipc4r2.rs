...
impl W {
    ///Bits 8:11 - Non-user, must be kept at reset value.
    #[inline(always)]
    pub fn svcmapping(&mut self) -> SVCMAPPING_W<IPC4R2rs> {
        SVCMAPPING_W::new(self, 8)
    }
    ///Bits 16:19 - Ratio for WLRU\[3:0\] arbitration
    #[inline(always)]
    pub fn wlru(&mut self) -> WLRU_W<IPC4R2rs> {
        WLRU_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DCMIPP:IPC4R2)*/
pub struct IPC4R2rs;
