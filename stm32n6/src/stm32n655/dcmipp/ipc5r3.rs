///Register `IPC5R3` reader
pub type R = crate::R<IPC5R3rs>;
///Register `IPC5R3` writer
pub type W = crate::W<IPC5R3rs>;
...
impl W {
    ///Bits 0:9 - Start word (AXI width = 64 bits) of the FIFO of Clientx.
    #[inline(always)]
    pub fn dpregstart(&mut self) -> DPREGSTART_W<'_, IPC5R3rs> {
        DPREGSTART_W::new(self, 0)
    }
    ///Bits 16:25 - End word (AXI width = 64 bits) of the FIFO of Clientx.
    #[inline(always)]
    pub fn dpregend(&mut self) -> DPREGEND_W<'_, IPC5R3rs> {
        DPREGEND_W::new(self, 16)
    }
}
/**DCMIPP IPPLUG Clientx register 3

You can [`read`](crate::Reg::read) this register and get [`ipc5r3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ipc5r3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DCMIPP:IPC5R3)*/
pub struct IPC5R3rs;
impl crate::RegisterSpec for IPC5R3rs {
    type Ux = u32;
}
///`read()` method returns [`ipc5r3::R`](R) reader structure
impl crate::Readable for IPC5R3rs {}
///`write(|w| ..)` method takes [`ipc5r3::W`](W) writer structure
impl crate::Writable for IPC5R3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IPC5R3 to value 0x027f_01c0
impl crate::Resettable for IPC5R3rs {
    const RESET_VALUE: u32 = 0x027f_01c0;
}
