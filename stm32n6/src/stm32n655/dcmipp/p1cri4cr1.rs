///Register `P1CRI4CR1` reader
pub type R = crate::R<P1CRI4CR1rs>;
...
You can [`read`](crate::Reg::read) this register and get [`p1cri4cr1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DCMIPP:P1CRI4CR1)*/
pub struct P1CRI4CR1rs;
impl crate::RegisterSpec for P1CRI4CR1rs {
    type Ux = u32;
}
///`read()` method returns [`p1cri4cr1::R`](R) reader structure
impl crate::Readable for P1CRI4CR1rs {}
///`reset()` method sets P1CRI4CR1 to value 0
impl crate::Resettable for P1CRI4CR1rs {}
