///Register `P1CST3CR` reader
pub type R = crate::R<P1CST3CRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`p1cst3cr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DCMIPP:P1CST3CR)*/
pub struct P1CST3CRrs;
impl crate::RegisterSpec for P1CST3CRrs {
    type Ux = u32;
}
///`read()` method returns [`p1cst3cr::R`](R) reader structure
impl crate::Readable for P1CST3CRrs {}
///`reset()` method sets P1CST3CR to value 0
impl crate::Resettable for P1CST3CRrs {}
