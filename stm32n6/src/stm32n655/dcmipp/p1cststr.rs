///Register `P1CSTSTR` reader
pub type R = crate::R<P1CSTSTRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`p1cststr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DCMIPP:P1CSTSTR)*/
pub struct P1CSTSTRrs;
impl crate::RegisterSpec for P1CSTSTRrs {
    type Ux = u32;
}
///`read()` method returns [`p1cststr::R`](R) reader structure
impl crate::Readable for P1CSTSTRrs {}
///`reset()` method sets P1CSTSTR to value 0
impl crate::Resettable for P1CSTSTRrs {}
