///Register `P2CDSCR` reader
pub type R = crate::R<P2CDSCRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`p2cdscr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DCMIPP:P2CDSCR)*/
pub struct P2CDSCRrs;
impl crate::RegisterSpec for P2CDSCRrs {
    type Ux = u32;
}
///`read()` method returns [`p2cdscr::R`](R) reader structure
impl crate::Readable for P2CDSCRrs {}
///`reset()` method sets P2CDSCR to value 0
impl crate::Resettable for P2CDSCRrs {}
