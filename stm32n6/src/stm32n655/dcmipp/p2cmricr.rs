...
impl W {
    ///Bits 0:1 - Region of interest line size width
    #[inline(always)]
    pub fn roilsz(&mut self) -> ROILSZ_W<P2CMRICRrs> {
        ROILSZ_W::new(self, 0)
    }
    ///Bit 16 - Region of interest 1 enable
    #[inline(always)]
    pub fn roi1en(&mut self) -> ROI1EN_W<P2CMRICRrs> {
        ROI1EN_W::new(self, 16)
    }
    ///Bit 17 - Region of interest 2 enable
    #[inline(always)]
    pub fn roi2en(&mut self) -> ROI2EN_W<P2CMRICRrs> {
        ROI2EN_W::new(self, 17)
    }
    ///Bit 18 - Region of interest 3 enable
    #[inline(always)]
    pub fn roi3en(&mut self) -> ROI3EN_W<P2CMRICRrs> {
        ROI3EN_W::new(self, 18)
    }
    ///Bit 19 - Region of interest 4 enable
    #[inline(always)]
    pub fn roi4en(&mut self) -> ROI4EN_W<P2CMRICRrs> {
        ROI4EN_W::new(self, 19)
    }
    ///Bit 20 - Region of interest 5 enable
    #[inline(always)]
    pub fn roi5en(&mut self) -> ROI5EN_W<P2CMRICRrs> {
        ROI5EN_W::new(self, 20)
    }
    ///Bit 21 - Region of interest 6 enable
    #[inline(always)]
    pub fn roi6en(&mut self) -> ROI6EN_W<P2CMRICRrs> {
        ROI6EN_W::new(self, 21)
    }
    ///Bit 22 - Region of interest 7 enable
    #[inline(always)]
    pub fn roi7en(&mut self) -> ROI7EN_W<P2CMRICRrs> {
        ROI7EN_W::new(self, 22)
    }
    ///Bit 23 - Region of interest 8 enable
    #[inline(always)]
    pub fn roi8en(&mut self) -> ROI8EN_W<P2CMRICRrs> {
