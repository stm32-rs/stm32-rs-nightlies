...
impl W {
    ///Bits 0:1 - Frame capture rate control
    #[inline(always)]
    pub fn frate(&mut self) -> FRATE_W<P2FCTCRrs> {
        FRATE_W::new(self, 0)
    }
    ///Bit 2 - Capture mode
    #[inline(always)]
    pub fn cptmode(&mut self) -> CPTMODE_W<P2FCTCRrs> {
        CPTMODE_W::new(self, 2)
    }
    ///Bit 3 - Capture requested
    #[inline(always)]
    pub fn cptreq(&mut self) -> CPTREQ_W<P2FCTCRrs> {
        CPTREQ_W::new(self, 3)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DCMIPP:P2FCTCR)*/
