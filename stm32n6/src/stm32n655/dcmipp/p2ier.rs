...
impl W {
    ///Bit 0 - Multi-line capture completed interrupt enable
    #[inline(always)]
    pub fn lineie(&mut self) -> LINEIE_W<P2IERrs> {
        LINEIE_W::new(self, 0)
    }
    ///Bit 1 - Frame capture completed interrupt enable
    #[inline(always)]
    pub fn frameie(&mut self) -> FRAMEIE_W<P2IERrs> {
        FRAMEIE_W::new(self, 1)
    }
    ///Bit 2 - VSYNC interrupt enable
    #[inline(always)]
    pub fn vsyncie(&mut self) -> VSYNCIE_W<P2IERrs> {
        VSYNCIE_W::new(self, 2)
    }
    ///Bit 7 - Overrun interrupt enable
    #[inline(always)]
    pub fn ovrie(&mut self) -> OVRIE_W<P2IERrs> {
        OVRIE_W::new(self, 7)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DCMIPP:P2IER)*/
pub struct P2IERrs;
