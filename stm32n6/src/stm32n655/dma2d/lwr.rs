...
///Field `LW` reader - Line watermark for interrupt generation
pub type LW_R = crate::FieldReader<u16>;
///Field `LW` writer - Line watermark for interrupt generation
pub type LW_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - Line watermark for interrupt generation
    #[inline(always)]
    pub fn lw(&self) -> LW_R {
...
impl W {
    ///Bits 0:15 - Line watermark for interrupt generation
    #[inline(always)]
    pub fn lw(&mut self) -> LW_W<'_, LWRrs> {
        LW_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DMA2D:LWR)*/
pub struct LWRrs;
