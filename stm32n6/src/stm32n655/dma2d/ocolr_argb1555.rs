...
///Field `BLUE` reader - Blue value of the output image in ARGB1555 mode
pub type BLUE_R = crate::FieldReader;
///Field `BLUE` writer - Blue value of the output image in ARGB1555 mode
pub type BLUE_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `GREEN` reader - Green value of the output image in ARGB1555 mode
pub type GREEN_R = crate::FieldReader;
///Field `GREEN` writer - Green value of the output image in ARGB1555 mode
pub type GREEN_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `RED` reader - Red value of the output image in ARGB1555 mode
pub type RED_R = crate::FieldReader;
///Field `RED` writer - Red value of the output image in ARGB1555 mode
pub type RED_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `A` reader - Alpha channel value of the output color in ARGB1555 mode
pub type A_R = crate::BitReader;
///Field `A` writer - Alpha channel value of the output color in ARGB1555 mode
...
impl W {
    ///Bits 0:4 - Blue value of the output image in ARGB1555 mode
    #[inline(always)]
    pub fn blue(&mut self) -> BLUE_W<'_, OCOLR_ARGB1555rs> {
        BLUE_W::new(self, 0)
    }
    ///Bits 5:9 - Green value of the output image in ARGB1555 mode
    #[inline(always)]
    pub fn green(&mut self) -> GREEN_W<'_, OCOLR_ARGB1555rs> {
        GREEN_W::new(self, 5)
    }
    ///Bits 10:14 - Red value of the output image in ARGB1555 mode
    #[inline(always)]
    pub fn red(&mut self) -> RED_W<'_, OCOLR_ARGB1555rs> {
        RED_W::new(self, 10)
    }
    ///Bit 15 - Alpha channel value of the output color in ARGB1555 mode
    #[inline(always)]
    pub fn a(&mut self) -> A_W<'_, OCOLR_ARGB1555rs> {
        A_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DMA2D:OCOLR_ARGB1555)*/
