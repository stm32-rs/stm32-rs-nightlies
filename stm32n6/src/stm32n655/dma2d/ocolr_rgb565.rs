...
///Field `BLUE` reader - Blue value of the output image in RGB565 mode
pub type BLUE_R = crate::FieldReader;
///Field `BLUE` writer - Blue value of the output image in RGB565 mode
pub type BLUE_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `GREEN` reader - Green value of the output image in RGB565 mode
pub type GREEN_R = crate::FieldReader;
///Field `GREEN` writer - Green value of the output image in RGB565 mode
pub type GREEN_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `RED` reader - Red value of the output image in RGB565 mode
pub type RED_R = crate::FieldReader;
///Field `RED` writer - Red value of the output image in RGB565 mode
...
impl W {
    ///Bits 0:4 - Blue value of the output image in RGB565 mode
    #[inline(always)]
    pub fn blue(&mut self) -> BLUE_W<'_, OCOLR_RGB565rs> {
        BLUE_W::new(self, 0)
    }
    ///Bits 5:10 - Green value of the output image in RGB565 mode
    #[inline(always)]
    pub fn green(&mut self) -> GREEN_W<'_, OCOLR_RGB565rs> {
        GREEN_W::new(self, 5)
    }
    ///Bits 11:15 - Red value of the output image in RGB565 mode
    #[inline(always)]
    pub fn red(&mut self) -> RED_W<'_, OCOLR_RGB565rs> {
        RED_W::new(self, 11)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DMA2D:OCOLR_RGB565)*/
