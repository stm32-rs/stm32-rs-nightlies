...
impl W {
    ...
    #[inline(always)]
    pub fn smpl_lo_set(&mut self) -> SMPL_LO_SET_W<TS1HILORESETRrs> {
        SMPL_LO_SET_W::new(self, 0)
    }
    ///Bit 1 - Sample high clear 0
    #[inline(always)]
    pub fn smpl_hi_clr(&mut self) -> SMPL_HI_CLR_W<TS1HILORESETRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DTS:TS1HILORESETR)*/
