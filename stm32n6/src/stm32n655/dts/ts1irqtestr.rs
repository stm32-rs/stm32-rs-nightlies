...
impl W {
    ///Bit 0 - Fault IRQ test bit
    #[inline(always)]
    pub fn irq_test_fault(&mut self) -> IRQ_TEST_FAULT_W<'_, TS1IRQTESTRrs> {
        IRQ_TEST_FAULT_W::new(self, 0)
    }
    ///Bit 1 - Sample done IRQ test bit
    #[inline(always)]
    pub fn irq_test_done(&mut self) -> IRQ_TEST_DONE_W<'_, TS1IRQTESTRrs> {
        IRQ_TEST_DONE_W::new(self, 1)
    }
    ///Bit 3 - Alarm A IRQ test bit
    #[inline(always)]
    pub fn irq_test_alarma(&mut self) -> IRQ_TEST_ALARMA_W<'_, TS1IRQTESTRrs> {
        IRQ_TEST_ALARMA_W::new(self, 3)
    }
    ///Bit 4 - Alarm B IRQ test bit
    #[inline(always)]
    pub fn irq_test_alarmb(&mut self) -> IRQ_TEST_ALARMB_W<'_, TS1IRQTESTRrs> {
