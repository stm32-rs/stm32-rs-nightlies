...
impl W {
    ///Bits 0:7 - Synthesized clk_ts low period
    #[inline(always)]
    pub fn clk_synth_lo(&mut self) -> CLK_SYNTH_LO_W<TSCCLKSYNTHRrs> {
        CLK_SYNTH_LO_W::new(self, 0)
    }
    ///Bits 8:15 - Synthesized clk_ts high period
    #[inline(always)]
    pub fn clk_synth_hi(&mut self) -> CLK_SYNTH_HI_W<TSCCLKSYNTHRrs> {
        CLK_SYNTH_HI_W::new(self, 8)
    }
    ///Bits 16:19 - SDA master-to-SDA slave output hold delay/SDA slave-to-SDA master input setup delay
    #[inline(always)]
    pub fn clk_synth_hold(&mut self) -> CLK_SYNTH_HOLD_W<TSCCLKSYNTHRrs> {
        CLK_SYNTH_HOLD_W::new(self, 16)
    }
    ///Bit 24 - Synthesized clk_ts enable bit
    #[inline(always)]
    pub fn clk_syth_en(&mut self) -> CLK_SYTH_EN_W<TSCCLKSYNTHRrs> {
