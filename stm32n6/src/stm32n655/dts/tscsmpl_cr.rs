...
impl W {
    ///Bit 0 - Sample counter disable bit
    #[inline(always)]
    pub fn smpl_ctr_disable(&mut self) -> SMPL_CTR_DISABLE_W<TSCSMPL_CRrs> {
        SMPL_CTR_DISABLE_W::new(self, 0)
    }
    ///Bit 1 - Sample counter hold bit
    #[inline(always)]
    pub fn smpl_ctr_hold(&mut self) -> SMPL_CTR_HOLD_W<TSCSMPL_CRrs> {
        SMPL_CTR_HOLD_W::new(self, 1)
    }
    ///Bit 2 - Sample discard bit
    #[inline(always)]
    pub fn smpl_discard(&mut self) -> SMPL_DISCARD_W<TSCSMPL_CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#DTS:TSCSMPL_CR)*/
