...
impl W {
    ///Bit 0 - Start or Stop Receive
    #[inline(always)]
    pub fn sr(&mut self) -> SR_W<DMAC0RXCRrs> {
        SR_W::new(self, 0)
    }
    ///Bits 1:14 - Receive Buffer size
    #[inline(always)]
    pub fn rbsz(&mut self) -> RBSZ_W<DMAC0RXCRrs> {
        RBSZ_W::new(self, 1)
    }
    ///Bits 16:21 - Receive Programmable Burst Length
    #[inline(always)]
    pub fn rxpbl(&mut self) -> RXPBL_W<DMAC0RXCRrs> {
        RXPBL_W::new(self, 16)
    }
    ///Bits 24:27 - Rx AXI4 QOS.
    #[inline(always)]
    pub fn rqos(&mut self) -> RQOS_W<DMAC0RXCRrs> {
        RQOS_W::new(self, 24)
    }
    ///Bit 31 - DMA Rx Channel x Packet Flush
    #[inline(always)]
    pub fn rpf(&mut self) -> RPF_W<DMAC0RXCRrs> {
        RPF_W::new(self, 31)
    }
}
