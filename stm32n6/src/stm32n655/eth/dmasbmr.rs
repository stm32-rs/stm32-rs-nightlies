...
impl W {
    ...
    ///Bit 1 - AXI Burst Length 4
    #[inline(always)]
    pub fn blen4(&mut self) -> BLEN4_W<DMASBMRrs> {
        BLEN4_W::new(self, 1)
    }
    ///Bit 2 - AXI Burst Length 8
    #[inline(always)]
    pub fn blen8(&mut self) -> BLEN8_W<DMASBMRrs> {
        BLEN8_W::new(self, 2)
    }
    ///Bit 3 - AXI Burst Length 16
    #[inline(always)]
    pub fn blen16(&mut self) -> BLEN16_W<DMASBMRrs> {
        BLEN16_W::new(self, 3)
    }
    ///Bit 4 - AXI Burst Length 32
    #[inline(always)]
    pub fn blen32(&mut self) -> BLEN32_W<DMASBMRrs> {
        BLEN32_W::new(self, 4)
    }
    ///Bit 5 - AXI Burst Length 64
    #[inline(always)]
    pub fn blen64(&mut self) -> BLEN64_W<DMASBMRrs> {
        BLEN64_W::new(self, 5)
    }
    ///Bit 6 - AXI Burst Length 128
    #[inline(always)]
    pub fn blen128(&mut self) -> BLEN128_W<DMASBMRrs> {
        BLEN128_W::new(self, 6)
    }
    ///Bit 7 - AXI Burst Length 256
    #[inline(always)]
    pub fn blen256(&mut self) -> BLEN256_W<DMASBMRrs> {
        BLEN256_W::new(self, 7)
    }
    ///Bit 10 - Automatic AXI LPI enable
    #[inline(always)]
    pub fn aale(&mut self) -> AALE_W<DMASBMRrs> {
        AALE_W::new(self, 10)
    }
    ///Bit 12 - Address-Aligned Beats
    #[inline(always)]
    ...
    ///Bit 13 - 1 Kbyte Boundary Crossing Enable for the AXI Master
    #[inline(always)]
    pub fn onekbbe(&mut self) -> ONEKBBE_W<DMASBMRrs> {
        ONEKBBE_W::new(self, 13)
    }
    ///Bits 16:17 - AXI Maximum Read Outstanding Request Limit
    #[inline(always)]
    pub fn rd_osr_lmt(&mut self) -> RD_OSR_LMT_W<DMASBMRrs> {
        RD_OSR_LMT_W::new(self, 16)
    }
    ///Bits 24:25 - AXI Maximum Write Outstanding Request Limit
    #[inline(always)]
    pub fn wr_osr_lmt(&mut self) -> WR_OSR_LMT_W<DMASBMRrs> {
        WR_OSR_LMT_W::new(self, 24)
    }
    ///Bit 30 - Unlock on Magic Packet or Remote wake-up packet
    #[inline(always)]
    pub fn lpi_xit_pkt(&mut self) -> LPI_XIT_PKT_W<DMASBMRrs> {
        LPI_XIT_PKT_W::new(self, 30)
    }
    ///Bit 31 - Enable Low Power Interface (LPI)
    #[inline(always)]
    pub fn en_lpi(&mut self) -> EN_LPI_W<DMASBMRrs> {
