...
///Field `GB` reader - GMII Busy
pub type GB_R = crate::BitReader;
///Field `GB` writer - GMII Busy
...
///Field `GOC` reader - GMII Operation Command
pub type GOC_R = crate::FieldReader;
///Field `GOC` writer - GMII Operation Command
...
impl R {
    ...
    ///Bits 2:3 - GMII Operation Command
    #[inline(always)]
