...
impl W {
    ///Bit 0 - Enable EST
    #[inline(always)]
    pub fn eest(&mut self) -> EEST_W<MTLESTCRrs> {
        EEST_W::new(self, 0)
    }
    ///Bit 1 - Switch to S/W owned list
    #[inline(always)]
    pub fn sswl(&mut self) -> SSWL_W<MTLESTCRrs> {
        SSWL_W::new(self, 1)
    }
    ///Bit 4 - Do not Drop frames during Frame Size Error
    #[inline(always)]
    pub fn ddbf(&mut self) -> DDBF_W<MTLESTCRrs> {
        DDBF_W::new(self, 4)
    }
    ///Bit 5 - Drop Frames causing Scheduling Error
    #[inline(always)]
    pub fn dfbs(&mut self) -> DFBS_W<MTLESTCRrs> {
        DFBS_W::new(self, 5)
    }
    ///Bits 6:7 - Loop Count to report Scheduling Error
    #[inline(always)]
    pub fn lcse(&mut self) -> LCSE_W<MTLESTCRrs> {
        LCSE_W::new(self, 6)
    }
    ///Bits 8:10 - Time Interval Left Shift Amount
    #[inline(always)]
    pub fn tils(&mut self) -> TILS_W<MTLESTCRrs> {
        TILS_W::new(self, 8)
    }
    ///Bits 12:23 - Current Time Offset Value
    #[inline(always)]
    pub fn ctov(&mut self) -> CTOV_W<MTLESTCRrs> {
        CTOV_W::new(self, 12)
    }
    ///Bits 24:31 - PTP Time Offset Value
    #[inline(always)]
    pub fn ptov(&mut self) -> PTOV_W<MTLESTCRrs> {
        PTOV_W::new(self, 24)
    }
}
