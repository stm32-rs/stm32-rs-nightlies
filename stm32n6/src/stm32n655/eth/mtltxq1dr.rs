...
pub type R = crate::R<MTLTXQ1DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mtltxq1dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#ETH:MTLTXQ1DR)*/
pub struct MTLTXQ1DRrs;
impl crate::RegisterSpec for MTLTXQ1DRrs {
    type Ux = u32;
}
///`read()` method returns [`mtltxq1dr::R`](R) reader structure
impl crate::Readable for MTLTXQ1DRrs {}
///`reset()` method sets MTLTXQ1DR to value 0
impl crate::Resettable for MTLTXQ1DRrs {}
