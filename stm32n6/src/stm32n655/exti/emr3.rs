...
impl W {
    ///Bit 0 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em64(&mut self) -> EM64_W<EMR3rs> {
        EM64_W::new(self, 0)
    }
    ///Bit 1 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em65(&mut self) -> EM65_W<EMR3rs> {
        EM65_W::new(self, 1)
    }
    ///Bit 2 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em66(&mut self) -> EM66_W<EMR3rs> {
        EM66_W::new(self, 2)
    }
    ///Bit 4 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em68(&mut self) -> EM68_W<EMR3rs> {
        EM68_W::new(self, 4)
    }
    ///Bit 5 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em69(&mut self) -> EM69_W<EMR3rs> {
        EM69_W::new(self, 5)
    }
    ///Bit 6 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em70(&mut self) -> EM70_W<EMR3rs> {
        EM70_W::new(self, 6)
    }
    ///Bit 7 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em71(&mut self) -> EM71_W<EMR3rs> {
        EM71_W::new(self, 7)
    }
    ///Bit 8 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em72(&mut self) -> EM72_W<EMR3rs> {
        EM72_W::new(self, 8)
    }
    ///Bit 9 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em73(&mut self) -> EM73_W<EMR3rs> {
        EM73_W::new(self, 9)
    }
    ///Bit 10 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn em74(&mut self) -> EM74_W<EMR3rs> {
        EM74_W::new(self, 10)
    }
    ///Bit 13 - CPU wake-up with event on event input 77
    #[inline(always)]
    pub fn em77(&mut self) -> EM77_W<EMR3rs> {
        EM77_W::new(self, 13)
    }
}
