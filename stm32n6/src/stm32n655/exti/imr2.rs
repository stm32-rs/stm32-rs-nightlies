...
impl W {
    ...
    ///Bit 26 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im58(&mut self) -> IM58_W<'_, IMR2rs> {
        IM58_W::new(self, 26)
    }
    ///Bit 28 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im60(&mut self) -> IM60_W<'_, IMR2rs> {
        IM60_W::new(self, 28)
    }
    ///Bit 29 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im61(&mut self) -> IM61_W<'_, IMR2rs> {
        IM61_W::new(self, 29)
    }
    ///Bit 30 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im62(&mut self) -> IM62_W<'_, IMR2rs> {
        IM62_W::new(self, 30)
    }
    ///Bit 31 - CPU wake-up with interrupt mask on event input x
    #[inline(always)]
    pub fn im63(&mut self) -> IM63_W<'_, IMR2rs> {
        IM63_W::new(self, 31)
    }
}
