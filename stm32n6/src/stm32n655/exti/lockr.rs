...
///Field `GLOCK` reader - Global security privilege EXTI_SECCFGRx/PRIVCFGRx
pub type GLOCK_R = crate::BitReader;
///Field `GLOCK` writer - Global security privilege EXTI_SECCFGRx/PRIVCFGRx
pub type GLOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Global security privilege EXTI_SECCFGRx/PRIVCFGRx
    #[inline(always)]
...
impl W {
    ///Bit 0 - Global security privilege EXTI_SECCFGRx/PRIVCFGRx
    #[inline(always)]
    pub fn glock(&mut self) -> GLOCK_W<'_, LOCKRrs> {
        GLOCK_W::new(self, 0)
    }
}
/**EXTI lock register
