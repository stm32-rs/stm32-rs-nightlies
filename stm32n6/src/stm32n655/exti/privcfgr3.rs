...
impl W {
    ///Bit 0 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv64(&mut self) -> PRIV64_W<PRIVCFGR3rs> {
        PRIV64_W::new(self, 0)
    }
    ///Bit 1 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv65(&mut self) -> PRIV65_W<PRIVCFGR3rs> {
        PRIV65_W::new(self, 1)
    }
    ///Bit 2 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv66(&mut self) -> PRIV66_W<PRIVCFGR3rs> {
        PRIV66_W::new(self, 2)
    }
    ///Bit 4 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv68(&mut self) -> PRIV68_W<PRIVCFGR3rs> {
        PRIV68_W::new(self, 4)
    }
    ///Bit 5 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv69(&mut self) -> PRIV69_W<PRIVCFGR3rs> {
        PRIV69_W::new(self, 5)
    }
    ///Bit 6 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv70(&mut self) -> PRIV70_W<PRIVCFGR3rs> {
        PRIV70_W::new(self, 6)
    }
    ///Bit 7 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv71(&mut self) -> PRIV71_W<PRIVCFGR3rs> {
        PRIV71_W::new(self, 7)
    }
    ///Bit 8 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv72(&mut self) -> PRIV72_W<PRIVCFGR3rs> {
        PRIV72_W::new(self, 8)
    }
    ///Bit 9 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv73(&mut self) -> PRIV73_W<PRIVCFGR3rs> {
        PRIV73_W::new(self, 9)
    }
    ///Bit 10 - Privilege enable on event input x
    #[inline(always)]
    pub fn priv74(&mut self) -> PRIV74_W<PRIVCFGR3rs> {
        PRIV74_W::new(self, 10)
    }
    ///Bit 13 - Privilege enable on event input 77
    #[inline(always)]
    pub fn priv77(&mut self) -> PRIV77_W<PRIVCFGR3rs> {
