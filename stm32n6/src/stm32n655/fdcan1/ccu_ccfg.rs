...
impl W {
    ///Bits 0:4 - Time quanta per bit time
    #[inline(always)]
    pub fn tqbt(&mut self) -> TQBT_W<CCU_CCFGrs> {
        TQBT_W::new(self, 0)
    }
    ///Bit 6 - Bypass clock calibration
    #[inline(always)]
    pub fn bcc(&mut self) -> BCC_W<CCU_CCFGrs> {
        BCC_W::new(self, 6)
    }
    ///Bit 7 - Calibration field length
    #[inline(always)]
    pub fn cfl(&mut self) -> CFL_W<CCU_CCFGrs> {
        CFL_W::new(self, 7)
    }
    ///Bits 8:15 - Oscillator clock periods minimum
    #[inline(always)]
    pub fn ocpm(&mut self) -> OCPM_W<CCU_CCFGrs> {
        OCPM_W::new(self, 8)
    }
    ///Bits 16:19 - Clock divider
    #[inline(always)]
    pub fn cdiv(&mut self) -> CDIV_W<CCU_CCFGrs> {
        CDIV_W::new(self, 16)
    }
    ///Bit 31 - Software reset
    #[inline(always)]
    pub fn swr(&mut self) -> SWR_W<CCU_CCFGrs> {
        SWR_W::new(self, 31)
    }
}
