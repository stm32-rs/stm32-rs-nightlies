...
impl W {
    ///Bit 0 - Decoder Uncorrectable Errors Interrupt enable
    #[inline(always)]
    pub fn dueie(&mut self) -> DUEIE_W<BCHIERrs> {
        DUEIE_W::new(self, 0)
    }
    ///Bit 1 - Decoder Error Ready Interrupt enable
    #[inline(always)]
    pub fn derie(&mut self) -> DERIE_W<BCHIERrs> {
        DERIE_W::new(self, 1)
    }
    ///Bit 2 - Decoder Error Found Interrupt enable
    #[inline(always)]
    pub fn defie(&mut self) -> DEFIE_W<BCHIERrs> {
        DEFIE_W::new(self, 2)
    }
    ///Bit 3 - Decoder Syndrome Ready Interrupt enable
    #[inline(always)]
    pub fn dsrie(&mut self) -> DSRIE_W<BCHIERrs> {
        DSRIE_W::new(self, 3)
    }
    ///Bit 4 - Decoder Parity Bits Ready Interrupt enable
    #[inline(always)]
    pub fn epbrie(&mut self) -> EPBRIE_W<BCHIERrs> {
        EPBRIE_W::new(self, 4)
    }
}
