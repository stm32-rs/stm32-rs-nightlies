...
pub type CSCOUNT0_R = crate::BitReader;
///Field `CSCOUNT0` writer - Chip Select (CS) counter
pub type CSCOUNT0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CSCOUNT1` reader - Chip Select (CS) counter
pub type CSCOUNT1_R = crate::BitReader;
///Field `CSCOUNT1` writer - Chip Select (CS) counter
pub type CSCOUNT1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    ///Bit 20 - Chip Select (CS) counter
    #[inline(always)]
    pub fn cscount0(&self) -> CSCOUNT0_R {
        CSCOUNT0_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - Chip Select (CS) counter
    #[inline(always)]
    pub fn cscount1(&self) -> CSCOUNT1_R {
        CSCOUNT1_R::new(((self.bits >> 21) & 1) != 0)
    }
...
impl W {
    ///Bit 0 - Memory region enable bit
    #[inline(always)]
    pub fn mbken(&mut self) -> MBKEN_W<'_, BCR3rs> {
        MBKEN_W::new(self, 0)
    }
    ///Bit 1 - Address/data multiplexing enable bit
    #[inline(always)]
    pub fn muxen(&mut self) -> MUXEN_W<'_, BCR3rs> {
        MUXEN_W::new(self, 1)
    }
    ///Bits 2:3 - Memory type
    #[inline(always)]
    pub fn mtyp(&mut self) -> MTYP_W<'_, BCR3rs> {
        MTYP_W::new(self, 2)
    }
    ///Bits 4:5 - Memory data bus width
    #[inline(always)]
    pub fn mwid(&mut self) -> MWID_W<'_, BCR3rs> {
        MWID_W::new(self, 4)
    }
    ///Bit 6 - Flash memory access enable
    #[inline(always)]
    pub fn faccen(&mut self) -> FACCEN_W<'_, BCR3rs> {
        FACCEN_W::new(self, 6)
    }
    ///Bit 8 - Burst enable bit
    #[inline(always)]
    pub fn bursten(&mut self) -> BURSTEN_W<'_, BCR3rs> {
        BURSTEN_W::new(self, 8)
    }
    ///Bit 9 - Wait signal polarity bit
    #[inline(always)]
    pub fn waitpol(&mut self) -> WAITPOL_W<'_, BCR3rs> {
        WAITPOL_W::new(self, 9)
    }
    ///Bit 11 - Wait timing configuration
    #[inline(always)]
    pub fn waitcfg(&mut self) -> WAITCFG_W<'_, BCR3rs> {
        WAITCFG_W::new(self, 11)
    }
    ///Bit 12 - Write enable bit
    #[inline(always)]
    pub fn wren(&mut self) -> WREN_W<'_, BCR3rs> {
        WREN_W::new(self, 12)
    }
    ///Bit 13 - Wait enable bit
    #[inline(always)]
    pub fn waiten(&mut self) -> WAITEN_W<'_, BCR3rs> {
        WAITEN_W::new(self, 13)
    }
    ///Bit 14 - Extended mode enable
    #[inline(always)]
    pub fn extmod(&mut self) -> EXTMOD_W<'_, BCR3rs> {
        EXTMOD_W::new(self, 14)
    }
    ///Bit 15 - Wait signal during asynchronous transfers
    #[inline(always)]
    pub fn asyncwait(&mut self) -> ASYNCWAIT_W<'_, BCR3rs> {
        ASYNCWAIT_W::new(self, 15)
    }
    ///Bits 16:18 - CRAM page size
    #[inline(always)]
    pub fn cpsize(&mut self) -> CPSIZE_W<'_, BCR3rs> {
        CPSIZE_W::new(self, 16)
    }
    ///Bit 19 - Write burst enable
    #[inline(always)]
    pub fn cburstrw(&mut self) -> CBURSTRW_W<'_, BCR3rs> {
        CBURSTRW_W::new(self, 19)
    }
    ///Bit 20 - Chip Select (CS) counter
    #[inline(always)]
    pub fn cscount0(&mut self) -> CSCOUNT0_W<'_, BCR3rs> {
        CSCOUNT0_W::new(self, 20)
    }
    ///Bit 21 - Chip Select (CS) counter
    #[inline(always)]
    pub fn cscount1(&mut self) -> CSCOUNT1_W<'_, BCR3rs> {
        CSCOUNT1_W::new(self, 21)
    }
    ///Bits 22:23 - Byte lane (NBL) setup
    #[inline(always)]
    pub fn nblset(&mut self) -> NBLSET_W<'_, BCR3rs> {
