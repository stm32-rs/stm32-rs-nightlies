...
impl W {
    ///Bit 0 - Sequencer spare data transfer enable
    #[inline(always)]
    pub fn sqsdten(&mut self) -> SQSDTEN_W<CSQCFGR2rs> {
        SQSDTEN_W::new(self, 0)
    }
    ///Bit 1 - Random Command 2 sequencer enable
    #[inline(always)]
    pub fn rcmd2en(&mut self) -> RCMD2EN_W<CSQCFGR2rs> {
        RCMD2EN_W::new(self, 1)
    }
    ///Bit 2 - Command sequencer DMA request decoding status enable
    #[inline(always)]
    pub fn dmasen(&mut self) -> DMASEN_W<CSQCFGR2rs> {
        DMASEN_W::new(self, 2)
    }
    ///Bits 8:15 - Random Command 1 sequencer
    #[inline(always)]
    pub fn rcmd1(&mut self) -> RCMD1_W<CSQCFGR2rs> {
        RCMD1_W::new(self, 8)
    }
    ///Bits 16:23 - Random Command 2 sequencer
    #[inline(always)]
    pub fn rcmd2(&mut self) -> RCMD2_W<CSQCFGR2rs> {
        RCMD2_W::new(self, 16)
    }
    ///Bit 24 - Command 1 sequencer timings
    #[inline(always)]
    pub fn rcmd1t(&mut self) -> RCMD1T_W<CSQCFGR2rs> {
        RCMD1T_W::new(self, 24)
    }
    ///Bit 25 - Command 1 sequencer timings
    #[inline(always)]
    pub fn rcmd2t(&mut self) -> RCMD2T_W<CSQCFGR2rs> {
