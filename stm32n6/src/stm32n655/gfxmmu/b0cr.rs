...
impl W {
    ///Bits 4:22 - Physical buffer offset
    #[inline(always)]
    pub fn pbo(&mut self) -> PBO_W<'_, B0CRrs> {
        PBO_W::new(self, 4)
    }
    ///Bits 23:31 - Physical buffer base address
    #[inline(always)]
    pub fn pbba(&mut self) -> PBBA_W<'_, B0CRrs> {
        PBBA_W::new(self, 23)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GFXMMU:B0CR)*/
pub struct B0CRrs;
