...
impl W {
    ///Bits 2:15 - pointer (16-bit low-significant address) to the next linked-list data structure
    #[inline(always)]
    pub fn la(&mut self) -> LA_W<'_, C15LLRrs> {
        LA_W::new(self, 2)
    }
    ///Bit 16 - Update GPDMA_CxLLR register from memory
    #[inline(always)]
    pub fn ull(&mut self) -> ULL_W<'_, C15LLRrs> {
        ULL_W::new(self, 16)
    }
    ///Bit 25 - Update GPDMA_CxBR2 from memory
    #[inline(always)]
    pub fn ub2(&mut self) -> UB2_W<'_, C15LLRrs> {
        UB2_W::new(self, 25)
    }
    ///Bit 26 - Update GPDMA_CxTR3 from memory
    #[inline(always)]
    pub fn ut3(&mut self) -> UT3_W<'_, C15LLRrs> {
        UT3_W::new(self, 26)
    }
    ///Bit 27 - Update GPDMA_CxDAR register from memory
    #[inline(always)]
    pub fn uda(&mut self) -> UDA_W<'_, C15LLRrs> {
        UDA_W::new(self, 27)
    }
    ///Bit 28 - update GPDMA_CxSAR from memory
    #[inline(always)]
    pub fn usa(&mut self) -> USA_W<'_, C15LLRrs> {
        USA_W::new(self, 28)
    }
    ///Bit 29 - Update GPDMA_CxBR1 from memory
    #[inline(always)]
    pub fn ub1(&mut self) -> UB1_W<'_, C15LLRrs> {
        UB1_W::new(self, 29)
    }
    ///Bit 30 - Update GPDMA_CxTR2 from memory
    #[inline(always)]
    pub fn ut2(&mut self) -> UT2_W<'_, C15LLRrs> {
        UT2_W::new(self, 30)
    }
    ///Bit 31 - Update GPDMA_CxTR1 from memory
    #[inline(always)]
    pub fn ut1(&mut self) -> UT1_W<'_, C15LLRrs> {
        UT1_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPDMA:C15LLR)*/
pub struct C15LLRrs;
