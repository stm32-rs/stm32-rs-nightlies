///Register `C6FCR` writer
pub type W = crate::W<C6FCRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<C6FCRrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn tcf(&mut self) -> TCF_W<'_, C6FCRrs> {
        TCF_W::new(self, 8)
    }
    ///Bit 9 - half transfer flag clear
    #[inline(always)]
    pub fn htf(&mut self) -> HTF_W<'_, C6FCRrs> {
        HTF_W::new(self, 9)
    }
    ///Bit 10 - data transfer error flag clear
    #[inline(always)]
    pub fn dtef(&mut self) -> DTEF_W<'_, C6FCRrs> {
        DTEF_W::new(self, 10)
    }
    ///Bit 11 - update link transfer error flag clear
    #[inline(always)]
    pub fn ulef(&mut self) -> ULEF_W<'_, C6FCRrs> {
        ULEF_W::new(self, 11)
    }
    ///Bit 12 - user setting error flag clear
    #[inline(always)]
    pub fn usef(&mut self) -> USEF_W<'_, C6FCRrs> {
        USEF_W::new(self, 12)
    }
    ///Bit 13 - completed suspension flag clear
    #[inline(always)]
    pub fn suspf(&mut self) -> SUSPF_W<'_, C6FCRrs> {
        SUSPF_W::new(self, 13)
    }
    ///Bit 14 - trigger overrun flag clear
    #[inline(always)]
    pub fn tof(&mut self) -> TOF_W<'_, C6FCRrs> {
        TOF_W::new(self, 14)
    }
}
/**GPDMA channel 6 flag clear register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c6fcr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPDMA:C6FCR)*/
pub struct C6FCRrs;
impl crate::RegisterSpec for C6FCRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`c6fcr::W`](W) writer structure
impl crate::Writable for C6FCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C6FCR to value 0
impl crate::Resettable for C6FCRrs {}
