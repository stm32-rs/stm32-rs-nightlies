...
impl W {
    ///Bit 0 - enable
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<C8CRrs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - reset
    #[inline(always)]
    pub fn reset(&mut self) -> RESET_W<C8CRrs> {
        RESET_W::new(self, 1)
    }
    ///Bit 2 - suspend
    #[inline(always)]
    pub fn susp(&mut self) -> SUSP_W<C8CRrs> {
        SUSP_W::new(self, 2)
    }
    ///Bit 8 - transfer complete interrupt enable
    #[inline(always)]
    pub fn tcie(&mut self) -> TCIE_W<C8CRrs> {
        TCIE_W::new(self, 8)
    }
    ///Bit 9 - half transfer complete interrupt enable
    #[inline(always)]
    pub fn htie(&mut self) -> HTIE_W<C8CRrs> {
        HTIE_W::new(self, 9)
    }
    ///Bit 10 - data transfer error interrupt enable
    #[inline(always)]
    pub fn dteie(&mut self) -> DTEIE_W<C8CRrs> {
        DTEIE_W::new(self, 10)
    }
    ///Bit 11 - update link transfer error interrupt enable
    #[inline(always)]
    pub fn uleie(&mut self) -> ULEIE_W<C8CRrs> {
        ULEIE_W::new(self, 11)
    }
    ///Bit 12 - user setting error interrupt enable
    #[inline(always)]
    pub fn useie(&mut self) -> USEIE_W<C8CRrs> {
        USEIE_W::new(self, 12)
    }
    ///Bit 13 - completed suspension interrupt enable
    #[inline(always)]
    pub fn suspie(&mut self) -> SUSPIE_W<C8CRrs> {
        SUSPIE_W::new(self, 13)
    }
    ///Bit 14 - trigger overrun interrupt enable
    #[inline(always)]
    pub fn toie(&mut self) -> TOIE_W<C8CRrs> {
        TOIE_W::new(self, 14)
    }
    ///Bit 16 - Link step mode
    #[inline(always)]
    pub fn lsm(&mut self) -> LSM_W<C8CRrs> {
        LSM_W::new(self, 16)
    }
    ///Bit 17 - linked-list allocated port
    #[inline(always)]
    pub fn lap(&mut self) -> LAP_W<C8CRrs> {
        LAP_W::new(self, 17)
    }
    ///Bits 22:23 - priority level of the channel x GPDMA transfer versus others
    #[inline(always)]
    pub fn prio(&mut self) -> PRIO_W<C8CRrs> {
        PRIO_W::new(self, 22)
    }
}
