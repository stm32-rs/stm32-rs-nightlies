...
///Field `AFSEL(0-7)` reader - Alternate function selection for port x I/O pin y
...
///Field `AFSEL(0-7)` writer - Alternate function selection for port x I/O pin y
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPIOA:AFRL)*/
pub struct AFRLrs;
