...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPIOA:HWCFGR7)*/
...
///`reset()` method sets HWCFGR7 to value 0xccce_eccc
impl crate::Resettable for HWCFGR7rs {
    const RESET_VALUE: u32 = 0xccce_eccc;
}
