...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `RLOCK0` field.</div>
    #[inline(always)]
    pub fn rlock(&mut self, n: u8) -> RLOCK_W<RCFGLOCKRrs> {
        #[allow(clippy::no_effect)]
        [(); 16][n as usize];
        RLOCK_W::new(self, n)
    }
    ///Bit 0 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock0(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 0)
    }
    ///Bit 1 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock1(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 1)
    }
    ///Bit 2 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock2(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 2)
    }
    ///Bit 3 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock3(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 3)
    }
    ///Bit 4 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock4(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 4)
    }
    ///Bit 5 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock5(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 5)
    }
    ///Bit 6 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock6(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 6)
    }
    ///Bit 7 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock7(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 7)
    }
    ///Bit 8 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock8(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 8)
    }
    ///Bit 9 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock9(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 9)
    }
    ///Bit 10 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock10(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 10)
    }
    ///Bit 11 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock11(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 11)
    }
    ///Bit 12 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock12(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 12)
    }
    ///Bit 13 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock13(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 13)
    }
    ///Bit 14 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock14(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 14)
    }
    ///Bit 15 - I/O pin y of port x resource lock
    #[inline(always)]
    pub fn rlock15(&mut self) -> RLOCK_W<RCFGLOCKRrs> {
        RLOCK_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPIOA:RCFGLOCKR)*/
