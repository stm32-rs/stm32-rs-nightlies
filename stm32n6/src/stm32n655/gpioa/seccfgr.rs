...
///Field `SEC(0-15)` reader - I/O pin y of Port x security configuration
pub type SEC_R = crate::BitReader<SECURE_PIN>;
impl SEC_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> SECURE_PIN {
        match self.bits {
            false => SECURE_PIN::NonSecure,
            true => SECURE_PIN::Secure,
        }
    }
    ///The I/O pin is non-secure
    #[inline(always)]
    pub fn is_non_secure(&self) -> bool {
        *self == SECURE_PIN::NonSecure
    }
    ///The I/O pin is secure
    #[inline(always)]
    pub fn is_secure(&self) -> bool {
        *self == SECURE_PIN::Secure
    }
}
///Field `SEC(0-15)` writer - I/O pin y of Port x security configuration
pub type SEC_W<'a, REG> = crate::BitWriter<'a, REG, SECURE_PIN>;
