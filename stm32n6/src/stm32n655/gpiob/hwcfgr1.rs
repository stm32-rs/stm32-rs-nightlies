...
///Field `AFRH_RES` reader - AF register high reset value
pub type AFRH_RES_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - AF register high reset value
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPIOB:HWCFGR1)*/
