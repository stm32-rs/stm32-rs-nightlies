...
///Field `BR8` writer - Port x reset IO pin y
pub type BR8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR9` writer - Port x reset IO pin y
pub type BR9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR10` writer - Port x reset IO pin y
pub type BR10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR11` writer - Port x reset IO pin y
pub type BR11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR12` writer - Port x reset IO pin y
pub type BR12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR13` writer - Port x reset IO pin y
pub type BR13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR14` writer - Port x reset IO pin y
pub type BR14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR15` writer - Port x reset IO pin y
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPIOC:BRR)*/
pub struct BRRrs;
