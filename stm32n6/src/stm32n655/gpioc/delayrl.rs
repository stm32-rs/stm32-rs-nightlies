...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `DELAY0` field.</div>
    #[inline(always)]
    pub fn delay(&mut self, n: u8) -> DELAY_W<DELAYRLrs> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    ///Bits 0:3 - Port x IO pin y delay setup
    #[inline(always)]
    pub fn delay0(&mut self) -> DELAY_W<DELAYRLrs> {
        DELAY_W::new(self, 0)
    }
    ///Bits 4:7 - Port x IO pin y delay setup
    #[inline(always)]
    pub fn delay1(&mut self) -> DELAY_W<DELAYRLrs> {
        DELAY_W::new(self, 4)
    }
    ///Bits 8:11 - Port x IO pin y delay setup
    #[inline(always)]
    pub fn delay2(&mut self) -> DELAY_W<DELAYRLrs> {
        DELAY_W::new(self, 8)
    }
    ///Bits 12:15 - Port x IO pin y delay setup
    #[inline(always)]
    pub fn delay3(&mut self) -> DELAY_W<DELAYRLrs> {
        DELAY_W::new(self, 12)
    }
    ///Bits 16:19 - Port x IO pin y delay setup
    #[inline(always)]
    pub fn delay4(&mut self) -> DELAY_W<DELAYRLrs> {
        DELAY_W::new(self, 16)
    }
    ///Bits 20:23 - Port x IO pin y delay setup
    #[inline(always)]
    pub fn delay5(&mut self) -> DELAY_W<DELAYRLrs> {
        DELAY_W::new(self, 20)
    }
    ///Bits 24:27 - Port x IO pin y delay setup
    #[inline(always)]
    pub fn delay6(&mut self) -> DELAY_W<DELAYRLrs> {
        DELAY_W::new(self, 24)
    }
    ///Bits 28:31 - Port x IO pin y delay setup
    #[inline(always)]
    pub fn delay7(&mut self) -> DELAY_W<DELAYRLrs> {
        DELAY_W::new(self, 28)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPIOC:DELAYRL)*/
