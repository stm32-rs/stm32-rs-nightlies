...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPIOG:HWCFGR8)*/
...
///`reset()` method sets HWCFGR8 to value 0xbbbb_bbbb
impl crate::Resettable for HWCFGR8rs {
    const RESET_VALUE: u32 = 0xbbbb_bbbb;
}
