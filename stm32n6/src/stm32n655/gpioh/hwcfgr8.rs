...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#GPIOH:HWCFGR8)*/
...
///`reset()` method sets HWCFGR8 to value 0xffff_fff2
impl crate::Resettable for HWCFGR8rs {
    const RESET_VALUE: u32 = 0xffff_fff2;
}
