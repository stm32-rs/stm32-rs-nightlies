///Register `C5BR1` reader
pub type R = crate::R<C5BR1rs>;
///Register `C5BR1` writer
pub type W = crate::W<C5BR1rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("C5BR1").field("bndt", &self.bndt()).finish()
    }
}
impl W {
    ///Bits 0:15 - block number of data bytes to transfer from the source
    #[inline(always)]
    pub fn bndt(&mut self) -> BNDT_W<'_, C5BR1rs> {
        BNDT_W::new(self, 0)
    }
}
...
pub struct C5BR1rs;
impl crate::RegisterSpec for C5BR1rs {
    type Ux = u32;
}
///`read()` method returns [`c5br1::R`](R) reader structure
impl crate::Readable for C5BR1rs {}
///`write(|w| ..)` method takes [`c5br1::W`](W) writer structure
impl crate::Writable for C5BR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C5BR1 to value 0
impl crate::Resettable for C5BR1rs {}
