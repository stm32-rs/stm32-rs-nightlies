...
///Field `TIMEOUT` reader - Timeout or tless thansub>LOWless than/sub> detection flag
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#I2C1:ISR)*/
pub struct ISRrs;
