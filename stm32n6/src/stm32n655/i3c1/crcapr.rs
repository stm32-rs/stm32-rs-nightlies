...
impl W {
    ///Bit 3 - delayed controller-role hand-off
    #[inline(always)]
    pub fn capdhoff(&mut self) -> CAPDHOFF_W<CRCAPRrs> {
        CAPDHOFF_W::new(self, 3)
    }
    ///Bit 9 - group management support (when acting as controller)
    #[inline(always)]
    pub fn capgrp(&mut self) -> CAPGRP_W<CRCAPRrs> {
        CAPGRP_W::new(self, 9)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#I3C1:CRCAPR)*/
pub struct CRCAPRrs;
