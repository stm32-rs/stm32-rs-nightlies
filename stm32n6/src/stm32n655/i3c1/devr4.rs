///Register `DEVR4` reader
pub type R = crate::R<DEVR4rs>;
///Register `DEVR4` writer
pub type W = crate::W<DEVR4rs>;
...
impl W {
    ///Bits 1:7 - Assigned I3C dynamic address to target x (when the I3C acts as controller)
    #[inline(always)]
    pub fn da(&mut self) -> DA_W<'_, DEVR4rs> {
        DA_W::new(self, 1)
    }
    ///Bit 16 - IBI request acknowledge (when the I3C acts as controller)
    #[inline(always)]
    pub fn ibiack(&mut self) -> IBIACK_W<'_, DEVR4rs> {
        IBIACK_W::new(self, 16)
    }
    ///Bit 17 - Controller-role request acknowledge (when the I3C acts as controller)
    #[inline(always)]
    pub fn crack(&mut self) -> CRACK_W<'_, DEVR4rs> {
        CRACK_W::new(self, 17)
    }
    ///Bit 18 - IBI data enable (when the I3C acts as controller)
    #[inline(always)]
    pub fn ibiden(&mut self) -> IBIDEN_W<'_, DEVR4rs> {
        IBIDEN_W::new(self, 18)
    }
    ///Bit 19 - Suspend/stop I3C transfer on received IBI (when the I3C acts as controller)
    #[inline(always)]
    pub fn susp(&mut self) -> SUSP_W<'_, DEVR4rs> {
        SUSP_W::new(self, 19)
    }
}
/**I3C device 4 characteristics register

You can [`read`](crate::Reg::read) this register and get [`devr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#I3C1:DEVR4)*/
pub struct DEVR4rs;
impl crate::RegisterSpec for DEVR4rs {
    type Ux = u32;
}
///`read()` method returns [`devr4::R`](R) reader structure
impl crate::Readable for DEVR4rs {}
///`write(|w| ..)` method takes [`devr4::W`](W) writer structure
impl crate::Writable for DEVR4rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DEVR4 to value 0
impl crate::Resettable for DEVR4rs {}
