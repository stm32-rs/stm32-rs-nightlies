///Register `IISR4` reader
pub type R = crate::R<IISR4rs>;
...
You can [`read`](crate::Reg::read) this register and get [`iisr4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#IAC:IISR4)*/
pub struct IISR4rs;
impl crate::RegisterSpec for IISR4rs {
    type Ux = u32;
}
///`read()` method returns [`iisr4::R`](R) reader structure
impl crate::Readable for IISR4rs {}
///`reset()` method sets IISR4 to value 0x7bef_ffef
impl crate::Resettable for IISR4rs {
    const RESET_VALUE: u32 = 0x7bef_ffef;
}
