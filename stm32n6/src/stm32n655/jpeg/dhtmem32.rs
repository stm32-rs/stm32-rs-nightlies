...
impl W {
    ///Bits 0:7 - Huffman table data 128
    #[inline(always)]
    pub fn data128(&mut self) -> DATA128_W<DHTMEM32rs> {
        DATA128_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 129
    #[inline(always)]
    pub fn data129(&mut self) -> DATA129_W<DHTMEM32rs> {
        DATA129_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 130
    #[inline(always)]
    pub fn data130(&mut self) -> DATA130_W<DHTMEM32rs> {
        DATA130_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 131
    #[inline(always)]
    pub fn data131(&mut self) -> DATA131_W<DHTMEM32rs> {
