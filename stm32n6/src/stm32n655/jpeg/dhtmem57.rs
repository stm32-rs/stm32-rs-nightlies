...
impl W {
    ///Bits 0:7 - Huffman table data 228
    #[inline(always)]
    pub fn data228(&mut self) -> DATA228_W<DHTMEM57rs> {
        DATA228_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 229
    #[inline(always)]
    pub fn data229(&mut self) -> DATA229_W<DHTMEM57rs> {
        DATA229_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 230
    #[inline(always)]
    pub fn data230(&mut self) -> DATA230_W<DHTMEM57rs> {
        DATA230_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 231
    #[inline(always)]
    pub fn data231(&mut self) -> DATA231_W<DHTMEM57rs> {
