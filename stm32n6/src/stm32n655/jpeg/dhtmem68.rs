...
impl W {
    ///Bits 0:7 - Huffman table data 272
    #[inline(always)]
    pub fn data272(&mut self) -> DATA272_W<DHTMEM68rs> {
        DATA272_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 273
    #[inline(always)]
    pub fn data273(&mut self) -> DATA273_W<DHTMEM68rs> {
        DATA273_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 274
    #[inline(always)]
    pub fn data274(&mut self) -> DATA274_W<DHTMEM68rs> {
        DATA274_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 275
    #[inline(always)]
    pub fn data275(&mut self) -> DATA275_W<DHTMEM68rs> {
