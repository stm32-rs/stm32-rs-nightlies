...
impl W {
    ///Bits 0:7 - Huffman table data 296
    #[inline(always)]
    pub fn data296(&mut self) -> DATA296_W<DHTMEM74rs> {
        DATA296_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 297
    #[inline(always)]
    pub fn data297(&mut self) -> DATA297_W<DHTMEM74rs> {
        DATA297_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 298
    #[inline(always)]
    pub fn data298(&mut self) -> DATA298_W<DHTMEM74rs> {
        DATA298_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 299
    #[inline(always)]
    pub fn data299(&mut self) -> DATA299_W<DHTMEM74rs> {
