...
impl W {
    ///Bits 0:7 - Huffman table data 344
    #[inline(always)]
    pub fn data344(&mut self) -> DATA344_W<DHTMEM86rs> {
        DATA344_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 345
    #[inline(always)]
    pub fn data345(&mut self) -> DATA345_W<DHTMEM86rs> {
        DATA345_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 346
    #[inline(always)]
    pub fn data346(&mut self) -> DATA346_W<DHTMEM86rs> {
        DATA346_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 347
    #[inline(always)]
    pub fn data347(&mut self) -> DATA347_W<DHTMEM86rs> {
