...
impl W {
    ///Bits 0:7 - Huffman table data 396
    #[inline(always)]
    pub fn data396(&mut self) -> DATA396_W<DHTMEM99rs> {
        DATA396_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 397
    #[inline(always)]
    pub fn data397(&mut self) -> DATA397_W<DHTMEM99rs> {
        DATA397_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 398
    #[inline(always)]
    pub fn data398(&mut self) -> DATA398_W<DHTMEM99rs> {
        DATA398_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 399
    #[inline(always)]
    pub fn data399(&mut self) -> DATA399_W<DHTMEM99rs> {
