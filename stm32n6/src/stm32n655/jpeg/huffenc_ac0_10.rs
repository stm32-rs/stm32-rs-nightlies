///Register `HUFFENC_AC0_10` reader
pub type R = crate::R<HUFFENC_AC0_10rs>;
///Register `HUFFENC_AC0_10` writer
pub type W = crate::W<HUFFENC_AC0_10rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 20
    #[inline(always)]
    pub fn hcode20(&mut self) -> HCODE20_W<'_, HUFFENC_AC0_10rs> {
        HCODE20_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 20
    #[inline(always)]
    pub fn hlen20(&mut self) -> HLEN20_W<'_, HUFFENC_AC0_10rs> {
        HLEN20_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 21
    #[inline(always)]
    pub fn hcode21(&mut self) -> HCODE21_W<'_, HUFFENC_AC0_10rs> {
        HCODE21_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 21
    #[inline(always)]
    pub fn hlen21(&mut self) -> HLEN21_W<'_, HUFFENC_AC0_10rs> {
        HLEN21_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC0_10)*/
pub struct HUFFENC_AC0_10rs;
impl crate::RegisterSpec for HUFFENC_AC0_10rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_10::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_10rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_10::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_10rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_10 to value 0
impl crate::Resettable for HUFFENC_AC0_10rs {}
