...
impl W {
    ///Bits 0:7 - Huffman code 20
    #[inline(always)]
    pub fn hcode20(&mut self) -> HCODE20_W<HUFFENC_AC0_10rs> {
        HCODE20_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 20
    #[inline(always)]
    pub fn hlen20(&mut self) -> HLEN20_W<HUFFENC_AC0_10rs> {
        HLEN20_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 21
    #[inline(always)]
    pub fn hcode21(&mut self) -> HCODE21_W<HUFFENC_AC0_10rs> {
        HCODE21_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 21
    #[inline(always)]
    pub fn hlen21(&mut self) -> HLEN21_W<HUFFENC_AC0_10rs> {
