///Register `HUFFENC_AC0_13` reader
pub type R = crate::R<HUFFENC_AC0_13rs>;
///Register `HUFFENC_AC0_13` writer
pub type W = crate::W<HUFFENC_AC0_13rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 26
    #[inline(always)]
    pub fn hcode26(&mut self) -> HCODE26_W<'_, HUFFENC_AC0_13rs> {
        HCODE26_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 26
    #[inline(always)]
    pub fn hlen26(&mut self) -> HLEN26_W<'_, HUFFENC_AC0_13rs> {
        HLEN26_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 27
    #[inline(always)]
    pub fn hcode27(&mut self) -> HCODE27_W<'_, HUFFENC_AC0_13rs> {
        HCODE27_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 27
    #[inline(always)]
    pub fn hlen27(&mut self) -> HLEN27_W<'_, HUFFENC_AC0_13rs> {
        HLEN27_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_13::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_13::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC0_13)*/
pub struct HUFFENC_AC0_13rs;
impl crate::RegisterSpec for HUFFENC_AC0_13rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_13::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_13rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_13::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_13rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_13 to value 0
impl crate::Resettable for HUFFENC_AC0_13rs {}
