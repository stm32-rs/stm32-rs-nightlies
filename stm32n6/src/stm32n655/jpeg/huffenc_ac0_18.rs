...
impl W {
    ///Bits 0:7 - Huffman code 36
    #[inline(always)]
    pub fn hcode36(&mut self) -> HCODE36_W<HUFFENC_AC0_18rs> {
        HCODE36_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 36
    #[inline(always)]
    pub fn hlen36(&mut self) -> HLEN36_W<HUFFENC_AC0_18rs> {
        HLEN36_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 37
    #[inline(always)]
    pub fn hcode37(&mut self) -> HCODE37_W<HUFFENC_AC0_18rs> {
        HCODE37_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 37
    #[inline(always)]
    pub fn hlen37(&mut self) -> HLEN37_W<HUFFENC_AC0_18rs> {
