...
impl W {
    ///Bits 0:7 - Huffman code 38
    #[inline(always)]
    pub fn hcode38(&mut self) -> HCODE38_W<HUFFENC_AC0_19rs> {
        HCODE38_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 38
    #[inline(always)]
    pub fn hlen38(&mut self) -> HLEN38_W<HUFFENC_AC0_19rs> {
        HLEN38_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 39
    #[inline(always)]
    pub fn hcode39(&mut self) -> HCODE39_W<HUFFENC_AC0_19rs> {
        HCODE39_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 39
    #[inline(always)]
    pub fn hlen39(&mut self) -> HLEN39_W<HUFFENC_AC0_19rs> {
