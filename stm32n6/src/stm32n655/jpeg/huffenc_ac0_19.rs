///Register `HUFFENC_AC0_19` reader
pub type R = crate::R<HUFFENC_AC0_19rs>;
///Register `HUFFENC_AC0_19` writer
pub type W = crate::W<HUFFENC_AC0_19rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 38
    #[inline(always)]
    pub fn hcode38(&mut self) -> HCODE38_W<'_, HUFFENC_AC0_19rs> {
        HCODE38_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 38
    #[inline(always)]
    pub fn hlen38(&mut self) -> HLEN38_W<'_, HUFFENC_AC0_19rs> {
        HLEN38_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 39
    #[inline(always)]
    pub fn hcode39(&mut self) -> HCODE39_W<'_, HUFFENC_AC0_19rs> {
        HCODE39_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 39
    #[inline(always)]
    pub fn hlen39(&mut self) -> HLEN39_W<'_, HUFFENC_AC0_19rs> {
        HLEN39_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_19::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_19::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC0_19)*/
pub struct HUFFENC_AC0_19rs;
impl crate::RegisterSpec for HUFFENC_AC0_19rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_19::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_19rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_19::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_19rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_19 to value 0
impl crate::Resettable for HUFFENC_AC0_19rs {}
