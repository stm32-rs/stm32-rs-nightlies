...
impl W {
    ///Bits 0:7 - Huffman code 58
    #[inline(always)]
    pub fn hcode58(&mut self) -> HCODE58_W<HUFFENC_AC0_29rs> {
        HCODE58_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 58
    #[inline(always)]
    pub fn hlen58(&mut self) -> HLEN58_W<HUFFENC_AC0_29rs> {
        HLEN58_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 59
    #[inline(always)]
    pub fn hcode59(&mut self) -> HCODE59_W<HUFFENC_AC0_29rs> {
        HCODE59_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 59
    #[inline(always)]
    pub fn hlen59(&mut self) -> HLEN59_W<HUFFENC_AC0_29rs> {
