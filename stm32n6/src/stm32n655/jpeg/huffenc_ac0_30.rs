///Register `HUFFENC_AC0_30` reader
pub type R = crate::R<HUFFENC_AC0_30rs>;
///Register `HUFFENC_AC0_30` writer
pub type W = crate::W<HUFFENC_AC0_30rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 60
    #[inline(always)]
    pub fn hcode60(&mut self) -> HCODE60_W<'_, HUFFENC_AC0_30rs> {
        HCODE60_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 60
    #[inline(always)]
    pub fn hlen60(&mut self) -> HLEN60_W<'_, HUFFENC_AC0_30rs> {
        HLEN60_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 61
    #[inline(always)]
    pub fn hcode61(&mut self) -> HCODE61_W<'_, HUFFENC_AC0_30rs> {
        HCODE61_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 61
    #[inline(always)]
    pub fn hlen61(&mut self) -> HLEN61_W<'_, HUFFENC_AC0_30rs> {
        HLEN61_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_30::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_30::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC0_30)*/
pub struct HUFFENC_AC0_30rs;
impl crate::RegisterSpec for HUFFENC_AC0_30rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_30::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_30rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_30::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_30rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_30 to value 0
impl crate::Resettable for HUFFENC_AC0_30rs {}
