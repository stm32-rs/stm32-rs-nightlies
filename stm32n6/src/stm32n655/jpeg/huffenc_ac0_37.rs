///Register `HUFFENC_AC0_37` reader
pub type R = crate::R<HUFFENC_AC0_37rs>;
///Register `HUFFENC_AC0_37` writer
pub type W = crate::W<HUFFENC_AC0_37rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 74
    #[inline(always)]
    pub fn hcode74(&mut self) -> HCODE74_W<'_, HUFFENC_AC0_37rs> {
        HCODE74_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 74
    #[inline(always)]
    pub fn hlen74(&mut self) -> HLEN74_W<'_, HUFFENC_AC0_37rs> {
        HLEN74_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 75
    #[inline(always)]
    pub fn hcode75(&mut self) -> HCODE75_W<'_, HUFFENC_AC0_37rs> {
        HCODE75_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 75
    #[inline(always)]
    pub fn hlen75(&mut self) -> HLEN75_W<'_, HUFFENC_AC0_37rs> {
        HLEN75_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_37::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_37::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC0_37)*/
pub struct HUFFENC_AC0_37rs;
impl crate::RegisterSpec for HUFFENC_AC0_37rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_37::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_37rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_37::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_37rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_37 to value 0
impl crate::Resettable for HUFFENC_AC0_37rs {}
