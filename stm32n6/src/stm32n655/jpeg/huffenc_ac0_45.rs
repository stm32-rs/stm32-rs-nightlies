...
impl W {
    ///Bits 0:7 - Huffman code 90
    #[inline(always)]
    pub fn hcode90(&mut self) -> HCODE90_W<HUFFENC_AC0_45rs> {
        HCODE90_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 90
    #[inline(always)]
    pub fn hlen90(&mut self) -> HLEN90_W<HUFFENC_AC0_45rs> {
        HLEN90_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 91
    #[inline(always)]
    pub fn hcode91(&mut self) -> HCODE91_W<HUFFENC_AC0_45rs> {
        HCODE91_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 91
    #[inline(always)]
    pub fn hlen91(&mut self) -> HLEN91_W<HUFFENC_AC0_45rs> {
