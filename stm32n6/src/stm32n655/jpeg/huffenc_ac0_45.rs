///Register `HUFFENC_AC0_45` reader
pub type R = crate::R<HUFFENC_AC0_45rs>;
///Register `HUFFENC_AC0_45` writer
pub type W = crate::W<HUFFENC_AC0_45rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 90
    #[inline(always)]
    pub fn hcode90(&mut self) -> HCODE90_W<'_, HUFFENC_AC0_45rs> {
        HCODE90_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 90
    #[inline(always)]
    pub fn hlen90(&mut self) -> HLEN90_W<'_, HUFFENC_AC0_45rs> {
        HLEN90_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 91
    #[inline(always)]
    pub fn hcode91(&mut self) -> HCODE91_W<'_, HUFFENC_AC0_45rs> {
        HCODE91_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 91
    #[inline(always)]
    pub fn hlen91(&mut self) -> HLEN91_W<'_, HUFFENC_AC0_45rs> {
        HLEN91_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_45::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_45::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC0_45)*/
pub struct HUFFENC_AC0_45rs;
impl crate::RegisterSpec for HUFFENC_AC0_45rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_45::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_45rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_45::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_45rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_45 to value 0
impl crate::Resettable for HUFFENC_AC0_45rs {}
