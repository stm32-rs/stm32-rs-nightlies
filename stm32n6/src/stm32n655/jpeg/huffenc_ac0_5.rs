///Register `HUFFENC_AC0_5` reader
pub type R = crate::R<HUFFENC_AC0_5rs>;
///Register `HUFFENC_AC0_5` writer
pub type W = crate::W<HUFFENC_AC0_5rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 10
    #[inline(always)]
    pub fn hcode10(&mut self) -> HCODE10_W<'_, HUFFENC_AC0_5rs> {
        HCODE10_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 10
    #[inline(always)]
    pub fn hlen10(&mut self) -> HLEN10_W<'_, HUFFENC_AC0_5rs> {
        HLEN10_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 11
    #[inline(always)]
    pub fn hcode11(&mut self) -> HCODE11_W<'_, HUFFENC_AC0_5rs> {
        HCODE11_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 11
    #[inline(always)]
    pub fn hlen11(&mut self) -> HLEN11_W<'_, HUFFENC_AC0_5rs> {
        HLEN11_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC0_5)*/
pub struct HUFFENC_AC0_5rs;
impl crate::RegisterSpec for HUFFENC_AC0_5rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_5::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_5rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_5::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_5rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_5 to value 0
impl crate::Resettable for HUFFENC_AC0_5rs {}
