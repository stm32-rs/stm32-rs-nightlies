///Register `HUFFENC_AC0_59` reader
pub type R = crate::R<HUFFENC_AC0_59rs>;
///Register `HUFFENC_AC0_59` writer
pub type W = crate::W<HUFFENC_AC0_59rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 118
    #[inline(always)]
    pub fn hcode118(&mut self) -> HCODE118_W<'_, HUFFENC_AC0_59rs> {
        HCODE118_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 118
    #[inline(always)]
    pub fn hlen118(&mut self) -> HLEN118_W<'_, HUFFENC_AC0_59rs> {
        HLEN118_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 119
    #[inline(always)]
    pub fn hcode119(&mut self) -> HCODE119_W<'_, HUFFENC_AC0_59rs> {
        HCODE119_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 119
    #[inline(always)]
    pub fn hlen119(&mut self) -> HLEN119_W<'_, HUFFENC_AC0_59rs> {
        HLEN119_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_59::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_59::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC0_59)*/
pub struct HUFFENC_AC0_59rs;
impl crate::RegisterSpec for HUFFENC_AC0_59rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_59::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_59rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_59::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_59rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_59 to value 0
impl crate::Resettable for HUFFENC_AC0_59rs {}
