...
impl W {
    ///Bits 0:7 - Huffman code 118
    #[inline(always)]
    pub fn hcode118(&mut self) -> HCODE118_W<HUFFENC_AC0_59rs> {
        HCODE118_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 118
    #[inline(always)]
    pub fn hlen118(&mut self) -> HLEN118_W<HUFFENC_AC0_59rs> {
        HLEN118_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 119
    #[inline(always)]
    pub fn hcode119(&mut self) -> HCODE119_W<HUFFENC_AC0_59rs> {
        HCODE119_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 119
    #[inline(always)]
    pub fn hlen119(&mut self) -> HLEN119_W<HUFFENC_AC0_59rs> {
