...
impl W {
    ///Bits 0:7 - Huffman code 16
    #[inline(always)]
    pub fn hcode16(&mut self) -> HCODE16_W<'_, HUFFENC_AC0_8rs> {
        HCODE16_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 16
    #[inline(always)]
    pub fn hlen16(&mut self) -> HLEN16_W<'_, HUFFENC_AC0_8rs> {
        HLEN16_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 17
    #[inline(always)]
    pub fn hcode17(&mut self) -> HCODE17_W<'_, HUFFENC_AC0_8rs> {
        HCODE17_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 17
    #[inline(always)]
    pub fn hlen17(&mut self) -> HLEN17_W<'_, HUFFENC_AC0_8rs> {
