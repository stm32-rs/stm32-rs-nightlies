...
impl W {
    ///Bits 0:7 - Huffman code 164
    #[inline(always)]
    pub fn hcode164(&mut self) -> HCODE164_W<HUFFENC_AC0_82rs> {
        HCODE164_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 164
    #[inline(always)]
    pub fn hlen164(&mut self) -> HLEN164_W<HUFFENC_AC0_82rs> {
        HLEN164_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 165
    #[inline(always)]
    pub fn hcode165(&mut self) -> HCODE165_W<HUFFENC_AC0_82rs> {
        HCODE165_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 165
    #[inline(always)]
    pub fn hlen165(&mut self) -> HLEN165_W<HUFFENC_AC0_82rs> {
