///Register `HUFFENC_AC1_15` reader
pub type R = crate::R<HUFFENC_AC1_15rs>;
///Register `HUFFENC_AC1_15` writer
pub type W = crate::W<HUFFENC_AC1_15rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 30
    #[inline(always)]
    pub fn hcode30(&mut self) -> HCODE30_W<'_, HUFFENC_AC1_15rs> {
        HCODE30_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 30
    #[inline(always)]
    pub fn hlen30(&mut self) -> HLEN30_W<'_, HUFFENC_AC1_15rs> {
        HLEN30_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 31
    #[inline(always)]
    pub fn hcode31(&mut self) -> HCODE31_W<'_, HUFFENC_AC1_15rs> {
        HCODE31_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 31
    #[inline(always)]
    pub fn hlen31(&mut self) -> HLEN31_W<'_, HUFFENC_AC1_15rs> {
        HLEN31_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_15::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_15::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC1_15)*/
pub struct HUFFENC_AC1_15rs;
impl crate::RegisterSpec for HUFFENC_AC1_15rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_15::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_15rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_15::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_15rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_15 to value 0
impl crate::Resettable for HUFFENC_AC1_15rs {}
