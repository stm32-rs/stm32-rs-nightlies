...
impl W {
    ///Bits 0:7 - Huffman code 40
    #[inline(always)]
    pub fn hcode40(&mut self) -> HCODE40_W<HUFFENC_AC1_20rs> {
        HCODE40_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 40
    #[inline(always)]
    pub fn hlen40(&mut self) -> HLEN40_W<HUFFENC_AC1_20rs> {
        HLEN40_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 41
    #[inline(always)]
    pub fn hcode41(&mut self) -> HCODE41_W<HUFFENC_AC1_20rs> {
        HCODE41_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 41
    #[inline(always)]
    pub fn hlen41(&mut self) -> HLEN41_W<HUFFENC_AC1_20rs> {
