///Register `HUFFENC_AC1_40` reader
pub type R = crate::R<HUFFENC_AC1_40rs>;
///Register `HUFFENC_AC1_40` writer
pub type W = crate::W<HUFFENC_AC1_40rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 80
    #[inline(always)]
    pub fn hcode80(&mut self) -> HCODE80_W<'_, HUFFENC_AC1_40rs> {
        HCODE80_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 80
    #[inline(always)]
    pub fn hlen80(&mut self) -> HLEN80_W<'_, HUFFENC_AC1_40rs> {
        HLEN80_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 81
    #[inline(always)]
    pub fn hcode81(&mut self) -> HCODE81_W<'_, HUFFENC_AC1_40rs> {
        HCODE81_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 81
    #[inline(always)]
    pub fn hlen81(&mut self) -> HLEN81_W<'_, HUFFENC_AC1_40rs> {
        HLEN81_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_40::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_40::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC1_40)*/
pub struct HUFFENC_AC1_40rs;
impl crate::RegisterSpec for HUFFENC_AC1_40rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_40::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_40rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_40::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_40rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_40 to value 0
impl crate::Resettable for HUFFENC_AC1_40rs {}
