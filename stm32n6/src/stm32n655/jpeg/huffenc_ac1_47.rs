...
impl W {
    ///Bits 0:7 - Huffman code 94
    #[inline(always)]
    pub fn hcode94(&mut self) -> HCODE94_W<HUFFENC_AC1_47rs> {
        HCODE94_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 94
    #[inline(always)]
    pub fn hlen94(&mut self) -> HLEN94_W<HUFFENC_AC1_47rs> {
        HLEN94_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 95
    #[inline(always)]
    pub fn hcode95(&mut self) -> HCODE95_W<HUFFENC_AC1_47rs> {
        HCODE95_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 95
    #[inline(always)]
    pub fn hlen95(&mut self) -> HLEN95_W<HUFFENC_AC1_47rs> {
