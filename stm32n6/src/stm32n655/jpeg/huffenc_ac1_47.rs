///Register `HUFFENC_AC1_47` reader
pub type R = crate::R<HUFFENC_AC1_47rs>;
///Register `HUFFENC_AC1_47` writer
pub type W = crate::W<HUFFENC_AC1_47rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 94
    #[inline(always)]
    pub fn hcode94(&mut self) -> HCODE94_W<'_, HUFFENC_AC1_47rs> {
        HCODE94_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 94
    #[inline(always)]
    pub fn hlen94(&mut self) -> HLEN94_W<'_, HUFFENC_AC1_47rs> {
        HLEN94_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 95
    #[inline(always)]
    pub fn hcode95(&mut self) -> HCODE95_W<'_, HUFFENC_AC1_47rs> {
        HCODE95_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 95
    #[inline(always)]
    pub fn hlen95(&mut self) -> HLEN95_W<'_, HUFFENC_AC1_47rs> {
        HLEN95_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_47::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_47::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC1_47)*/
pub struct HUFFENC_AC1_47rs;
impl crate::RegisterSpec for HUFFENC_AC1_47rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_47::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_47rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_47::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_47rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_47 to value 0
impl crate::Resettable for HUFFENC_AC1_47rs {}
