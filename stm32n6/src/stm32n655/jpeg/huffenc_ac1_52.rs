...
impl W {
    ///Bits 0:7 - Huffman code 104
    #[inline(always)]
    pub fn hcode104(&mut self) -> HCODE104_W<HUFFENC_AC1_52rs> {
        HCODE104_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 104
    #[inline(always)]
    pub fn hlen104(&mut self) -> HLEN104_W<HUFFENC_AC1_52rs> {
        HLEN104_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 105
    #[inline(always)]
    pub fn hcode105(&mut self) -> HCODE105_W<HUFFENC_AC1_52rs> {
        HCODE105_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 105
    #[inline(always)]
    pub fn hlen105(&mut self) -> HLEN105_W<HUFFENC_AC1_52rs> {
