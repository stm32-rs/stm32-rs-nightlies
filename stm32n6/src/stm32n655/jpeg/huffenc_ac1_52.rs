///Register `HUFFENC_AC1_52` reader
pub type R = crate::R<HUFFENC_AC1_52rs>;
///Register `HUFFENC_AC1_52` writer
pub type W = crate::W<HUFFENC_AC1_52rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 104
    #[inline(always)]
    pub fn hcode104(&mut self) -> HCODE104_W<'_, HUFFENC_AC1_52rs> {
        HCODE104_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 104
    #[inline(always)]
    pub fn hlen104(&mut self) -> HLEN104_W<'_, HUFFENC_AC1_52rs> {
        HLEN104_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 105
    #[inline(always)]
    pub fn hcode105(&mut self) -> HCODE105_W<'_, HUFFENC_AC1_52rs> {
        HCODE105_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 105
    #[inline(always)]
    pub fn hlen105(&mut self) -> HLEN105_W<'_, HUFFENC_AC1_52rs> {
        HLEN105_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_52::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_52::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC1_52)*/
pub struct HUFFENC_AC1_52rs;
impl crate::RegisterSpec for HUFFENC_AC1_52rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_52::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_52rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_52::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_52rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_52 to value 0
impl crate::Resettable for HUFFENC_AC1_52rs {}
