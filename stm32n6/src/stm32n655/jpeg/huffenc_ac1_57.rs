///Register `HUFFENC_AC1_57` reader
pub type R = crate::R<HUFFENC_AC1_57rs>;
///Register `HUFFENC_AC1_57` writer
pub type W = crate::W<HUFFENC_AC1_57rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 114
    #[inline(always)]
    pub fn hcode114(&mut self) -> HCODE114_W<'_, HUFFENC_AC1_57rs> {
        HCODE114_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 114
    #[inline(always)]
    pub fn hlen114(&mut self) -> HLEN114_W<'_, HUFFENC_AC1_57rs> {
        HLEN114_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 115
    #[inline(always)]
    pub fn hcode115(&mut self) -> HCODE115_W<'_, HUFFENC_AC1_57rs> {
        HCODE115_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 115
    #[inline(always)]
    pub fn hlen115(&mut self) -> HLEN115_W<'_, HUFFENC_AC1_57rs> {
        HLEN115_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_57::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_57::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC1_57)*/
pub struct HUFFENC_AC1_57rs;
impl crate::RegisterSpec for HUFFENC_AC1_57rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_57::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_57rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_57::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_57rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_57 to value 0
impl crate::Resettable for HUFFENC_AC1_57rs {}
