...
impl W {
    ///Bits 0:7 - Huffman code 130
    #[inline(always)]
    pub fn hcode130(&mut self) -> HCODE130_W<HUFFENC_AC1_65rs> {
        HCODE130_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 130
    #[inline(always)]
    pub fn hlen130(&mut self) -> HLEN130_W<HUFFENC_AC1_65rs> {
        HLEN130_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 131
    #[inline(always)]
    pub fn hcode131(&mut self) -> HCODE131_W<HUFFENC_AC1_65rs> {
        HCODE131_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 131
    #[inline(always)]
    pub fn hlen131(&mut self) -> HLEN131_W<HUFFENC_AC1_65rs> {
