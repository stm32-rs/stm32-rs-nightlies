///Register `HUFFENC_AC1_66` reader
pub type R = crate::R<HUFFENC_AC1_66rs>;
///Register `HUFFENC_AC1_66` writer
pub type W = crate::W<HUFFENC_AC1_66rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 132
    #[inline(always)]
    pub fn hcode132(&mut self) -> HCODE132_W<'_, HUFFENC_AC1_66rs> {
        HCODE132_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 132
    #[inline(always)]
    pub fn hlen132(&mut self) -> HLEN132_W<'_, HUFFENC_AC1_66rs> {
        HLEN132_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 133
    #[inline(always)]
    pub fn hcode133(&mut self) -> HCODE133_W<'_, HUFFENC_AC1_66rs> {
        HCODE133_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 133
    #[inline(always)]
    pub fn hlen133(&mut self) -> HLEN133_W<'_, HUFFENC_AC1_66rs> {
        HLEN133_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_66::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_66::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC1_66)*/
pub struct HUFFENC_AC1_66rs;
impl crate::RegisterSpec for HUFFENC_AC1_66rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_66::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_66rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_66::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_66rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_66 to value 0
impl crate::Resettable for HUFFENC_AC1_66rs {}
