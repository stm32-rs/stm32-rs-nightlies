...
impl W {
    ///Bits 0:7 - Huffman code 148
    #[inline(always)]
    pub fn hcode148(&mut self) -> HCODE148_W<'_, HUFFENC_AC1_74rs> {
        HCODE148_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 148
    #[inline(always)]
    pub fn hlen148(&mut self) -> HLEN148_W<'_, HUFFENC_AC1_74rs> {
        HLEN148_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 149
    #[inline(always)]
    pub fn hcode149(&mut self) -> HCODE149_W<'_, HUFFENC_AC1_74rs> {
        HCODE149_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 149
    #[inline(always)]
    pub fn hlen149(&mut self) -> HLEN149_W<'_, HUFFENC_AC1_74rs> {
