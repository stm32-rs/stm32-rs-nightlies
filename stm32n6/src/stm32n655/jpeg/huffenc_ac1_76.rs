...
impl W {
    ///Bits 0:7 - Huffman code 152
    #[inline(always)]
    pub fn hcode152(&mut self) -> HCODE152_W<HUFFENC_AC1_76rs> {
        HCODE152_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 152
    #[inline(always)]
    pub fn hlen152(&mut self) -> HLEN152_W<HUFFENC_AC1_76rs> {
        HLEN152_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 153
    #[inline(always)]
    pub fn hcode153(&mut self) -> HCODE153_W<HUFFENC_AC1_76rs> {
        HCODE153_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 153
    #[inline(always)]
    pub fn hlen153(&mut self) -> HLEN153_W<HUFFENC_AC1_76rs> {
