///Register `HUFFENC_AC1_76` reader
pub type R = crate::R<HUFFENC_AC1_76rs>;
///Register `HUFFENC_AC1_76` writer
pub type W = crate::W<HUFFENC_AC1_76rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 152
    #[inline(always)]
    pub fn hcode152(&mut self) -> HCODE152_W<'_, HUFFENC_AC1_76rs> {
        HCODE152_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 152
    #[inline(always)]
    pub fn hlen152(&mut self) -> HLEN152_W<'_, HUFFENC_AC1_76rs> {
        HLEN152_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 153
    #[inline(always)]
    pub fn hcode153(&mut self) -> HCODE153_W<'_, HUFFENC_AC1_76rs> {
        HCODE153_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 153
    #[inline(always)]
    pub fn hlen153(&mut self) -> HLEN153_W<'_, HUFFENC_AC1_76rs> {
        HLEN153_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_76::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_76::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:HUFFENC_AC1_76)*/
pub struct HUFFENC_AC1_76rs;
impl crate::RegisterSpec for HUFFENC_AC1_76rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_76::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_76rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_76::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_76rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_76 to value 0
impl crate::Resettable for HUFFENC_AC1_76rs {}
