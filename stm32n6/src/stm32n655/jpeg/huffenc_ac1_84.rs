...
impl W {
    ///Bits 0:7 - Huffman code 168
    #[inline(always)]
    pub fn hcode168(&mut self) -> HCODE168_W<HUFFENC_AC1_84rs> {
        HCODE168_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 168
    #[inline(always)]
    pub fn hlen168(&mut self) -> HLEN168_W<HUFFENC_AC1_84rs> {
        HLEN168_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 169
    #[inline(always)]
    pub fn hcode169(&mut self) -> HCODE169_W<HUFFENC_AC1_84rs> {
        HCODE169_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 169
    #[inline(always)]
    pub fn hlen169(&mut self) -> HLEN169_W<HUFFENC_AC1_84rs> {
