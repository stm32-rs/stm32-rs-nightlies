...
impl W {
    ///Bits 0:7 - Data 72
    #[inline(always)]
    pub fn data72(&mut self) -> DATA72_W<HUFFSYMB18rs> {
        DATA72_W::new(self, 0)
    }
    ///Bits 8:15 - Data 73
    #[inline(always)]
    pub fn data73(&mut self) -> DATA73_W<HUFFSYMB18rs> {
        DATA73_W::new(self, 8)
    }
    ///Bits 16:23 - Data 74
    #[inline(always)]
    pub fn data74(&mut self) -> DATA74_W<HUFFSYMB18rs> {
        DATA74_W::new(self, 16)
    }
    ///Bits 24:31 - Data 75
    #[inline(always)]
    pub fn data75(&mut self) -> DATA75_W<HUFFSYMB18rs> {
