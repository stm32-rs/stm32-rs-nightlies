...
impl W {
    ///Bits 0:7 - Data 88
    #[inline(always)]
    pub fn data88(&mut self) -> DATA88_W<HUFFSYMB22rs> {
        DATA88_W::new(self, 0)
    }
    ///Bits 8:15 - Data 89
    #[inline(always)]
    pub fn data89(&mut self) -> DATA89_W<HUFFSYMB22rs> {
        DATA89_W::new(self, 8)
    }
    ///Bits 16:23 - Data 90
    #[inline(always)]
    pub fn data90(&mut self) -> DATA90_W<HUFFSYMB22rs> {
        DATA90_W::new(self, 16)
    }
    ///Bits 24:31 - Data 91
    #[inline(always)]
    pub fn data91(&mut self) -> DATA91_W<HUFFSYMB22rs> {
