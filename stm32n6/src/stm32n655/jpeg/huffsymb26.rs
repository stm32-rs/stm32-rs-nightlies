...
impl W {
    ///Bits 0:7 - Data 104
    #[inline(always)]
    pub fn data104(&mut self) -> DATA104_W<HUFFSYMB26rs> {
        DATA104_W::new(self, 0)
    }
    ///Bits 8:15 - Data 105
    #[inline(always)]
    pub fn data105(&mut self) -> DATA105_W<HUFFSYMB26rs> {
        DATA105_W::new(self, 8)
    }
    ///Bits 16:23 - Data 106
    #[inline(always)]
    pub fn data106(&mut self) -> DATA106_W<HUFFSYMB26rs> {
        DATA106_W::new(self, 16)
    }
    ///Bits 24:31 - Data 107
    #[inline(always)]
    pub fn data107(&mut self) -> DATA107_W<HUFFSYMB26rs> {
