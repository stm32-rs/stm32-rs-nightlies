...
impl W {
    ///Bits 0:7 - Data 132
    #[inline(always)]
    pub fn data132(&mut self) -> DATA132_W<HUFFSYMB33rs> {
        DATA132_W::new(self, 0)
    }
    ///Bits 8:15 - Data 133
    #[inline(always)]
    pub fn data133(&mut self) -> DATA133_W<HUFFSYMB33rs> {
        DATA133_W::new(self, 8)
    }
    ///Bits 16:23 - Data 134
    #[inline(always)]
    pub fn data134(&mut self) -> DATA134_W<HUFFSYMB33rs> {
        DATA134_W::new(self, 16)
    }
    ///Bits 24:31 - Data 135
    #[inline(always)]
    pub fn data135(&mut self) -> DATA135_W<HUFFSYMB33rs> {
