...
impl W {
    ///Bits 0:7 - Data 308
    #[inline(always)]
    pub fn data308(&mut self) -> DATA308_W<HUFFSYMB77rs> {
        DATA308_W::new(self, 0)
    }
    ///Bits 8:15 - Data 309
    #[inline(always)]
    pub fn data309(&mut self) -> DATA309_W<HUFFSYMB77rs> {
        DATA309_W::new(self, 8)
    }
    ///Bits 16:23 - Data 310
    #[inline(always)]
    pub fn data310(&mut self) -> DATA310_W<HUFFSYMB77rs> {
        DATA310_W::new(self, 16)
    }
    ///Bits 24:31 - Data 311
    #[inline(always)]
    pub fn data311(&mut self) -> DATA311_W<HUFFSYMB77rs> {
