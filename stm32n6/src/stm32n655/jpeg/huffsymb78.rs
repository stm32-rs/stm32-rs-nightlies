...
impl W {
    ///Bits 0:7 - Data 312
    #[inline(always)]
    pub fn data312(&mut self) -> DATA312_W<HUFFSYMB78rs> {
        DATA312_W::new(self, 0)
    }
    ///Bits 8:15 - Data 313
    #[inline(always)]
    pub fn data313(&mut self) -> DATA313_W<HUFFSYMB78rs> {
        DATA313_W::new(self, 8)
    }
    ///Bits 16:23 - Data 314
    #[inline(always)]
    pub fn data314(&mut self) -> DATA314_W<HUFFSYMB78rs> {
        DATA314_W::new(self, 16)
    }
    ///Bits 24:31 - Data 315
    #[inline(always)]
    pub fn data315(&mut self) -> DATA315_W<HUFFSYMB78rs> {
