...
impl W {
    ///Bits 0:7 - Quantization coefficient 52
    #[inline(always)]
    pub fn qcoef52(&mut self) -> QCOEF52_W<QMEM0_13rs> {
        QCOEF52_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 53
    #[inline(always)]
    pub fn qcoef53(&mut self) -> QCOEF53_W<QMEM0_13rs> {
        QCOEF53_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 54
    #[inline(always)]
    pub fn qcoef54(&mut self) -> QCOEF54_W<QMEM0_13rs> {
        QCOEF54_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 55
    #[inline(always)]
    pub fn qcoef55(&mut self) -> QCOEF55_W<QMEM0_13rs> {
