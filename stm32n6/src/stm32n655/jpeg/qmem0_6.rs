///Register `QMEM0_6` reader
pub type R = crate::R<QMEM0_6rs>;
///Register `QMEM0_6` writer
pub type W = crate::W<QMEM0_6rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 24
    #[inline(always)]
    pub fn qcoef24(&mut self) -> QCOEF24_W<'_, QMEM0_6rs> {
        QCOEF24_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 25
    #[inline(always)]
    pub fn qcoef25(&mut self) -> QCOEF25_W<'_, QMEM0_6rs> {
        QCOEF25_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 26
    #[inline(always)]
    pub fn qcoef26(&mut self) -> QCOEF26_W<'_, QMEM0_6rs> {
        QCOEF26_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 27
    #[inline(always)]
    pub fn qcoef27(&mut self) -> QCOEF27_W<'_, QMEM0_6rs> {
        QCOEF27_W::new(self, 24)
    }
}
/**JPEG quantization memory 0

You can [`read`](crate::Reg::read) this register and get [`qmem0_6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem0_6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:QMEM0_6)*/
pub struct QMEM0_6rs;
impl crate::RegisterSpec for QMEM0_6rs {
    type Ux = u32;
}
///`read()` method returns [`qmem0_6::R`](R) reader structure
impl crate::Readable for QMEM0_6rs {}
///`write(|w| ..)` method takes [`qmem0_6::W`](W) writer structure
impl crate::Writable for QMEM0_6rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM0_6 to value 0
impl crate::Resettable for QMEM0_6rs {}
