///Register `QMEM1_2` reader
pub type R = crate::R<QMEM1_2rs>;
///Register `QMEM1_2` writer
pub type W = crate::W<QMEM1_2rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 8
    #[inline(always)]
    pub fn qcoef8(&mut self) -> QCOEF8_W<'_, QMEM1_2rs> {
        QCOEF8_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 9
    #[inline(always)]
    pub fn qcoef9(&mut self) -> QCOEF9_W<'_, QMEM1_2rs> {
        QCOEF9_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 10
    #[inline(always)]
    pub fn qcoef10(&mut self) -> QCOEF10_W<'_, QMEM1_2rs> {
        QCOEF10_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 11
    #[inline(always)]
    pub fn qcoef11(&mut self) -> QCOEF11_W<'_, QMEM1_2rs> {
        QCOEF11_W::new(self, 24)
    }
}
/**JPEG quantization memory 1

You can [`read`](crate::Reg::read) this register and get [`qmem1_2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem1_2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:QMEM1_2)*/
pub struct QMEM1_2rs;
impl crate::RegisterSpec for QMEM1_2rs {
    type Ux = u32;
}
///`read()` method returns [`qmem1_2::R`](R) reader structure
impl crate::Readable for QMEM1_2rs {}
///`write(|w| ..)` method takes [`qmem1_2::W`](W) writer structure
impl crate::Writable for QMEM1_2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM1_2 to value 0
impl crate::Resettable for QMEM1_2rs {}
