...
impl W {
    ///Bits 0:7 - Quantization coefficient 0
    #[inline(always)]
    pub fn qcoef0(&mut self) -> QCOEF0_W<QMEM2_0rs> {
        QCOEF0_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 1
    #[inline(always)]
    pub fn qcoef1(&mut self) -> QCOEF1_W<QMEM2_0rs> {
        QCOEF1_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 2
    #[inline(always)]
    pub fn qcoef2(&mut self) -> QCOEF2_W<QMEM2_0rs> {
        QCOEF2_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 3
    #[inline(always)]
    pub fn qcoef3(&mut self) -> QCOEF3_W<QMEM2_0rs> {
