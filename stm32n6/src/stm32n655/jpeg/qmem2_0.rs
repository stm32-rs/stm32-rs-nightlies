///Register `QMEM2_0` reader
pub type R = crate::R<QMEM2_0rs>;
///Register `QMEM2_0` writer
pub type W = crate::W<QMEM2_0rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 0
    #[inline(always)]
    pub fn qcoef0(&mut self) -> QCOEF0_W<'_, QMEM2_0rs> {
        QCOEF0_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 1
    #[inline(always)]
    pub fn qcoef1(&mut self) -> QCOEF1_W<'_, QMEM2_0rs> {
        QCOEF1_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 2
    #[inline(always)]
    pub fn qcoef2(&mut self) -> QCOEF2_W<'_, QMEM2_0rs> {
        QCOEF2_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 3
    #[inline(always)]
    pub fn qcoef3(&mut self) -> QCOEF3_W<'_, QMEM2_0rs> {
        QCOEF3_W::new(self, 24)
    }
}
/**JPEG quantization memory 2

You can [`read`](crate::Reg::read) this register and get [`qmem2_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem2_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#JPEG:QMEM2_0)*/
pub struct QMEM2_0rs;
impl crate::RegisterSpec for QMEM2_0rs {
    type Ux = u32;
}
///`read()` method returns [`qmem2_0::R`](R) reader structure
impl crate::Readable for QMEM2_0rs {}
///`write(|w| ..)` method takes [`qmem2_0::W`](W) writer structure
impl crate::Writable for QMEM2_0rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM2_0 to value 0
impl crate::Resettable for QMEM2_0rs {}
