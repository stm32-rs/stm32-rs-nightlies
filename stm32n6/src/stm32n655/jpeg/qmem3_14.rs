...
impl W {
    ///Bits 0:7 - Quantization coefficient 56
    #[inline(always)]
    pub fn qcoef56(&mut self) -> QCOEF56_W<QMEM3_14rs> {
        QCOEF56_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 57
    #[inline(always)]
    pub fn qcoef57(&mut self) -> QCOEF57_W<QMEM3_14rs> {
        QCOEF57_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 58
    #[inline(always)]
    pub fn qcoef58(&mut self) -> QCOEF58_W<QMEM3_14rs> {
        QCOEF58_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 59
    #[inline(always)]
    pub fn qcoef59(&mut self) -> QCOEF59_W<QMEM3_14rs> {
