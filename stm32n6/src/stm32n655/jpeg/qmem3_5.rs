...
impl W {
    ///Bits 0:7 - Quantization coefficient 20
    #[inline(always)]
    pub fn qcoef20(&mut self) -> QCOEF20_W<QMEM3_5rs> {
        QCOEF20_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 21
    #[inline(always)]
    pub fn qcoef21(&mut self) -> QCOEF21_W<QMEM3_5rs> {
        QCOEF21_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 22
    #[inline(always)]
    pub fn qcoef22(&mut self) -> QCOEF22_W<QMEM3_5rs> {
        QCOEF22_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 23
    #[inline(always)]
    pub fn qcoef23(&mut self) -> QCOEF23_W<QMEM3_5rs> {
