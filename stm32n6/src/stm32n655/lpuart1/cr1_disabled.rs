...
impl W {
    ///Bit 0 - LPUART enable
    #[inline(always)]
    pub fn ue(&mut self) -> UE_W<'_, CR1_DISABLEDrs> {
        UE_W::new(self, 0)
    }
    ///Bit 1 - LPUART enable in low-power mode
    #[inline(always)]
    pub fn uesm(&mut self) -> UESM_W<'_, CR1_DISABLEDrs> {
        UESM_W::new(self, 1)
    }
    ///Bit 2 - Receiver enable
    #[inline(always)]
    pub fn re(&mut self) -> RE_W<'_, CR1_DISABLEDrs> {
        RE_W::new(self, 2)
    }
    ///Bit 3 - Transmitter enable
    #[inline(always)]
    pub fn te(&mut self) -> TE_W<'_, CR1_DISABLEDrs> {
        TE_W::new(self, 3)
    }
    ///Bit 4 - IDLE interrupt enable
    #[inline(always)]
    pub fn idleie(&mut self) -> IDLEIE_W<'_, CR1_DISABLEDrs> {
        IDLEIE_W::new(self, 4)
    }
    ///Bit 5 - Receive data register not empty
    #[inline(always)]
    pub fn rxneie(&mut self) -> RXNEIE_W<'_, CR1_DISABLEDrs> {
        RXNEIE_W::new(self, 5)
    }
    ///Bit 6 - Transmission complete interrupt enable
    #[inline(always)]
    pub fn tcie(&mut self) -> TCIE_W<'_, CR1_DISABLEDrs> {
        TCIE_W::new(self, 6)
    }
    ///Bit 7 - Transmit data register empty
    #[inline(always)]
    pub fn txeie(&mut self) -> TXEIE_W<'_, CR1_DISABLEDrs> {
        TXEIE_W::new(self, 7)
    }
    ///Bit 8 - PE interrupt enable
    #[inline(always)]
    pub fn peie(&mut self) -> PEIE_W<'_, CR1_DISABLEDrs> {
        PEIE_W::new(self, 8)
    }
    ///Bit 9 - Parity selection
    #[inline(always)]
    pub fn ps(&mut self) -> PS_W<'_, CR1_DISABLEDrs> {
        PS_W::new(self, 9)
    }
    ///Bit 10 - Parity control enable
    #[inline(always)]
    pub fn pce(&mut self) -> PCE_W<'_, CR1_DISABLEDrs> {
        PCE_W::new(self, 10)
    }
    ///Bit 11 - Receiver wake-up method
    #[inline(always)]
    pub fn wake(&mut self) -> WAKE_W<'_, CR1_DISABLEDrs> {
        WAKE_W::new(self, 11)
    }
    ///Bit 12 - Word length
    #[inline(always)]
    pub fn m0(&mut self) -> M0_W<'_, CR1_DISABLEDrs> {
        M0_W::new(self, 12)
    }
    ///Bit 13 - Mute mode enable
    #[inline(always)]
    pub fn mme(&mut self) -> MME_W<'_, CR1_DISABLEDrs> {
        MME_W::new(self, 13)
    }
    ///Bit 14 - Character match interrupt enable
    #[inline(always)]
    pub fn cmie(&mut self) -> CMIE_W<'_, CR1_DISABLEDrs> {
        CMIE_W::new(self, 14)
    }
    ///Bits 16:20 - Driver Enable deassertion time
    #[inline(always)]
    pub fn dedt(&mut self) -> DEDT_W<'_, CR1_DISABLEDrs> {
        DEDT_W::new(self, 16)
    }
    ///Bits 21:25 - Driver Enable assertion time
    #[inline(always)]
    pub fn deat(&mut self) -> DEAT_W<'_, CR1_DISABLEDrs> {
        DEAT_W::new(self, 21)
    }
    ///Bit 28 - Word length
    #[inline(always)]
    pub fn m1(&mut self) -> M1_W<'_, CR1_DISABLEDrs> {
        M1_W::new(self, 28)
    }
    ///Bit 29 - FIFO mode enable
    #[inline(always)]
    pub fn fifoen(&mut self) -> FIFOEN_W<'_, CR1_DISABLEDrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#LPUART1:CR1_DISABLED)*/
