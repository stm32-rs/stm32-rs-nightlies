...
impl W {
    ...
    #[inline(always)]
    pub fn cfuwif(&mut self) -> CFUWIF_W<ICRrs> {
        CFUWIF_W::new(self, 1)
    }
    ...
    #[inline(always)]
    pub fn ccrcif(&mut self) -> CCRCIF_W<ICRrs> {
        CCRCIF_W::new(self, 7)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#LTDC:ICR)*/
pub struct ICRrs;
