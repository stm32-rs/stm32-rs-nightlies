///Register `L1FPF1R` reader
pub type R = crate::R<L1FPF1Rrs>;
///Register `L1FPF1R` writer
pub type W = crate::W<L1FPF1Rrs>;
...
impl W {
    ///Bits 0:4 - Location of the Green component inside the pixel memory word (in bits)
    #[inline(always)]
    pub fn gpos(&mut self) -> GPOS_W<'_, L1FPF1Rrs> {
        GPOS_W::new(self, 0)
    }
    ///Bits 5:8 - Width of the Green component (in bits)
    #[inline(always)]
    pub fn glen(&mut self) -> GLEN_W<'_, L1FPF1Rrs> {
        GLEN_W::new(self, 5)
    }
    ///Bits 9:13 - Location of the Blue component inside the pixel memory word (in bits)
    #[inline(always)]
    pub fn bpos(&mut self) -> BPOS_W<'_, L1FPF1Rrs> {
        BPOS_W::new(self, 9)
    }
    ///Bits 14:17 - Width of the Blue component (in bits)
    #[inline(always)]
    pub fn blen(&mut self) -> BLEN_W<'_, L1FPF1Rrs> {
        BLEN_W::new(self, 14)
    }
    ///Bits 18:20 - Pixel size (in bytes)
    #[inline(always)]
    pub fn psize(&mut self) -> PSIZE_W<'_, L1FPF1Rrs> {
        PSIZE_W::new(self, 18)
    }
}
/**LTDC layerx flexible pixel format 1 register

You can [`read`](crate::Reg::read) this register and get [`l1fpf1r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l1fpf1r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#LTDC:L1FPF1R)*/
pub struct L1FPF1Rrs;
impl crate::RegisterSpec for L1FPF1Rrs {
    type Ux = u32;
}
///`read()` method returns [`l1fpf1r::R`](R) reader structure
impl crate::Readable for L1FPF1Rrs {}
///`write(|w| ..)` method takes [`l1fpf1r::W`](W) writer structure
impl crate::Writable for L1FPF1Rrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets L1FPF1R to value 0x0009_3110
impl crate::Resettable for L1FPF1Rrs {
