///Register `L2C0R` reader
pub type R = crate::R<L2C0Rrs>;
...
You can [`read`](crate::Reg::read) this register and get [`l2c0r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#LTDC:L2C0R)*/
pub struct L2C0Rrs;
impl crate::RegisterSpec for L2C0Rrs {
    type Ux = u32;
}
///`read()` method returns [`l2c0r::R`](R) reader structure
impl crate::Readable for L2C0Rrs {}
///`reset()` method sets L2C0R to value 0xff50_a076
impl crate::Resettable for L2C0Rrs {
