///Register `L2C1R` reader
pub type R = crate::R<L2C1Rrs>;
///Register `L2C1R` writer
pub type W = crate::W<L2C1Rrs>;
...
impl W {
    ...
    #[inline(always)]
    pub fn yia(&mut self) -> YIA_W<'_, L2C1Rrs> {
        YIA_W::new(self, 0)
    }
    ///Bit 1 - YCbCr 420 semi-planar ability for that layer
    #[inline(always)]
    pub fn yspa(&mut self) -> YSPA_W<'_, L2C1Rrs> {
        YSPA_W::new(self, 1)
    }
    ///Bit 2 - YCbCr 420 full-planar ability for that layer
    #[inline(always)]
    pub fn yfpa(&mut self) -> YFPA_W<'_, L2C1Rrs> {
        YFPA_W::new(self, 2)
    }
    ///Bit 31 - scaling ability for that layer
    #[inline(always)]
    pub fn sca(&mut self) -> SCA_W<'_, L2C1Rrs> {
        SCA_W::new(self, 31)
    }
}
/**LTDC layerx configuration 1 register

You can [`read`](crate::Reg::read) this register and get [`l2c1r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l2c1r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#LTDC:L2C1R)*/
pub struct L2C1Rrs;
impl crate::RegisterSpec for L2C1Rrs {
    type Ux = u32;
}
///`read()` method returns [`l2c1r::R`](R) reader structure
impl crate::Readable for L2C1Rrs {}
///`write(|w| ..)` method takes [`l2c1r::W`](W) writer structure
impl crate::Writable for L2C1Rrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets L2C1R to value 0x8000_0001
impl crate::Resettable for L2C1Rrs {
