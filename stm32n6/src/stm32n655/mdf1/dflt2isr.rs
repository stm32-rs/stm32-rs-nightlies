///Register `DFLT2ISR` reader
pub type R = crate::R<DFLT2ISRrs>;
///Register `DFLT2ISR` writer
pub type W = crate::W<DFLT2ISRrs>;
...
impl W {
    ///Bit 1 - Data overflow flag
    #[inline(always)]
    pub fn dovrf(&mut self) -> DOVRF_W<'_, DFLT2ISRrs> {
        DOVRF_W::new(self, 1)
    }
    ///Bit 2 - Snapshot data ready flag
    #[inline(always)]
    pub fn ssdrf(&mut self) -> SSDRF_W<'_, DFLT2ISRrs> {
        SSDRF_W::new(self, 2)
    }
    ///Bit 4 - OLDx flag
    #[inline(always)]
    pub fn oldf(&mut self) -> OLDF_W<'_, DFLT2ISRrs> {
        OLDF_W::new(self, 4)
    }
    ///Bit 7 - Snapshot overrun flag
    #[inline(always)]
    pub fn ssovrf(&mut self) -> SSOVRF_W<'_, DFLT2ISRrs> {
        SSOVRF_W::new(self, 7)
    }
    ///Bit 8 - Short-circuit detector flag
    #[inline(always)]
    pub fn scdf(&mut self) -> SCDF_W<'_, DFLT2ISRrs> {
        SCDF_W::new(self, 8)
    }
    ///Bit 9 - Saturation detection flag
    #[inline(always)]
    pub fn satf(&mut self) -> SATF_W<'_, DFLT2ISRrs> {
        SATF_W::new(self, 9)
    }
    ///Bit 10 - Clock absence detection flag
    #[inline(always)]
    pub fn ckabf(&mut self) -> CKABF_W<'_, DFLT2ISRrs> {
        CKABF_W::new(self, 10)
    }
    ///Bit 11 - Reshape filter overrun detection flag
    #[inline(always)]
    pub fn rfovrf(&mut self) -> RFOVRF_W<'_, DFLT2ISRrs> {
        RFOVRF_W::new(self, 11)
    }
}
/**MDF DFLT2 interrupt status register 2

You can [`read`](crate::Reg::read) this register and get [`dflt2isr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dflt2isr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#MDF1:DFLT2ISR)*/
pub struct DFLT2ISRrs;
impl crate::RegisterSpec for DFLT2ISRrs {
    type Ux = u32;
}
///`read()` method returns [`dflt2isr::R`](R) reader structure
impl crate::Readable for DFLT2ISRrs {}
///`write(|w| ..)` method takes [`dflt2isr::W`](W) writer structure
impl crate::Writable for DFLT2ISRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DFLT2ISR to value 0
impl crate::Resettable for DFLT2ISRrs {}
