...
impl W {
    ///Bits 0:1 - Source data for the digital filter
    #[inline(always)]
    pub fn datsrc(&mut self) -> DATSRC_W<DFLT3CICRrs> {
        DATSRC_W::new(self, 0)
    }
    ///Bits 4:6 - Select the CIC mode
    #[inline(always)]
    pub fn cicmod(&mut self) -> CICMOD_W<DFLT3CICRrs> {
        CICMOD_W::new(self, 4)
    }
    ///Bits 8:15 - CIC decimation ratio selection
    #[inline(always)]
    pub fn mcicd(&mut self) -> MCICD_W<DFLT3CICRrs> {
        MCICD_W::new(self, 8)
    }
    ///Bit 16 - CIC decimation ratio selection
    #[inline(always)]
    pub fn mcicd8(&mut self) -> MCICD8_W<DFLT3CICRrs> {
        MCICD8_W::new(self, 16)
    }
    ///Bits 20:25 - Scaling factor selection
    #[inline(always)]
    pub fn scale(&mut self) -> SCALE_W<DFLT3CICRrs> {
        SCALE_W::new(self, 20)
    }
}
