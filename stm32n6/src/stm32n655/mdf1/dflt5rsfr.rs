///Register `DFLT5RSFR` reader
pub type R = crate::R<DFLT5RSFRrs>;
///Register `DFLT5RSFR` writer
pub type W = crate::W<DFLT5RSFRrs>;
...
impl W {
    ///Bit 0 - Reshaper filter bypass
    #[inline(always)]
    pub fn rsfltbyp(&mut self) -> RSFLTBYP_W<'_, DFLT5RSFRrs> {
        RSFLTBYP_W::new(self, 0)
    }
    ///Bit 4 - Reshaper filter decimation ratio
    #[inline(always)]
    pub fn rsfltd(&mut self) -> RSFLTD_W<'_, DFLT5RSFRrs> {
        RSFLTD_W::new(self, 4)
    }
    ///Bit 7 - High-pass filter bypass
    #[inline(always)]
    pub fn hpfbyp(&mut self) -> HPFBYP_W<'_, DFLT5RSFRrs> {
        HPFBYP_W::new(self, 7)
    }
    ///Bits 8:9 - High-pass filter cut-off frequency
    #[inline(always)]
    pub fn hpfc(&mut self) -> HPFC_W<'_, DFLT5RSFRrs> {
        HPFC_W::new(self, 8)
    }
}
/**MDF reshape filter configuration register 5

You can [`read`](crate::Reg::read) this register and get [`dflt5rsfr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dflt5rsfr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#MDF1:DFLT5RSFR)*/
pub struct DFLT5RSFRrs;
impl crate::RegisterSpec for DFLT5RSFRrs {
    type Ux = u32;
}
///`read()` method returns [`dflt5rsfr::R`](R) reader structure
impl crate::Readable for DFLT5RSFRrs {}
///`write(|w| ..)` method takes [`dflt5rsfr::W`](W) writer structure
impl crate::Writable for DFLT5RSFRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DFLT5RSFR to value 0
impl crate::Resettable for DFLT5RSFRrs {}
