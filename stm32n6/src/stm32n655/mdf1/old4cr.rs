///Register `OLD4CR` reader
pub type R = crate::R<OLD4CRrs>;
///Register `OLD4CR` writer
pub type W = crate::W<OLD4CRrs>;
...
impl W {
    ///Bit 0 - OLDx enable
    #[inline(always)]
    pub fn olden(&mut self) -> OLDEN_W<'_, OLD4CRrs> {
        OLDEN_W::new(self, 0)
    }
    ///Bit 1 - Threshold In band
    #[inline(always)]
    pub fn thinb(&mut self) -> THINB_W<'_, OLD4CRrs> {
        THINB_W::new(self, 1)
    }
    ///Bits 4:7 - Break signal assignment for out-of limit detector
    #[inline(always)]
    pub fn bkold(&mut self) -> BKOLD_W<'_, OLD4CRrs> {
        BKOLD_W::new(self, 4)
    }
    ///Bits 12:13 - OLDx CIC order selection
    #[inline(always)]
    pub fn acicn(&mut self) -> ACICN_W<'_, OLD4CRrs> {
        ACICN_W::new(self, 12)
    }
    ///Bits 17:21 - OLDx CIC decimation ratio selection
    #[inline(always)]
    pub fn acicd(&mut self) -> ACICD_W<'_, OLD4CRrs> {
        ACICD_W::new(self, 17)
    }
}
/**MDF out-of limit detector control register 4

You can [`read`](crate::Reg::read) this register and get [`old4cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`old4cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#MDF1:OLD4CR)*/
pub struct OLD4CRrs;
impl crate::RegisterSpec for OLD4CRrs {
    type Ux = u32;
}
///`read()` method returns [`old4cr::R`](R) reader structure
impl crate::Readable for OLD4CRrs {}
///`write(|w| ..)` method takes [`old4cr::W`](W) writer structure
impl crate::Writable for OLD4CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets OLD4CR to value 0
impl crate::Resettable for OLD4CRrs {}
