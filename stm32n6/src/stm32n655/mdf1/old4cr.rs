...
impl W {
    ///Bit 0 - OLDx enable
    #[inline(always)]
    pub fn olden(&mut self) -> OLDEN_W<OLD4CRrs> {
        OLDEN_W::new(self, 0)
    }
    ///Bit 1 - Threshold In band
    #[inline(always)]
    pub fn thinb(&mut self) -> THINB_W<OLD4CRrs> {
        THINB_W::new(self, 1)
    }
    ///Bits 4:7 - Break signal assignment for out-of limit detector
    #[inline(always)]
    pub fn bkold(&mut self) -> BKOLD_W<OLD4CRrs> {
        BKOLD_W::new(self, 4)
    }
    ///Bits 12:13 - OLDx CIC order selection
    #[inline(always)]
    pub fn acicn(&mut self) -> ACICN_W<OLD4CRrs> {
        ACICN_W::new(self, 12)
    }
    ///Bits 17:21 - OLDx CIC decimation ratio selection
    #[inline(always)]
    pub fn acicd(&mut self) -> ACICD_W<OLD4CRrs> {
        ACICD_W::new(self, 17)
    }
}
