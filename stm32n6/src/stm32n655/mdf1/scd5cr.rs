///Register `SCD5CR` reader
pub type R = crate::R<SCD5CRrs>;
///Register `SCD5CR` writer
pub type W = crate::W<SCD5CRrs>;
...
impl W {
    ///Bit 0 - SCDx enable
    #[inline(always)]
    pub fn scden(&mut self) -> SCDEN_W<'_, SCD5CRrs> {
        SCDEN_W::new(self, 0)
    }
    ///Bits 4:7 - Break signal assignment for short circuit detector
    #[inline(always)]
    pub fn bkscd(&mut self) -> BKSCD_W<'_, SCD5CRrs> {
        BKSCD_W::new(self, 4)
    }
    ///Bits 12:19 - SCDx threshold
    #[inline(always)]
    pub fn scdt(&mut self) -> SCDT_W<'_, SCD5CRrs> {
        SCDT_W::new(self, 12)
    }
}
/**MDF short circuit detector control register 5

You can [`read`](crate::Reg::read) this register and get [`scd5cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scd5cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#MDF1:SCD5CR)*/
pub struct SCD5CRrs;
impl crate::RegisterSpec for SCD5CRrs {
    type Ux = u32;
}
///`read()` method returns [`scd5cr::R`](R) reader structure
impl crate::Readable for SCD5CRrs {}
///`write(|w| ..)` method takes [`scd5cr::W`](W) writer structure
impl crate::Writable for SCD5CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SCD5CR to value 0
impl crate::Resettable for SCD5CRrs {}
