///Register `SNPS0DR` reader
pub type R = crate::R<SNPS0DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`snps0dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#MDF1:SNPS0DR)*/
pub struct SNPS0DRrs;
impl crate::RegisterSpec for SNPS0DRrs {
    type Ux = u32;
}
///`read()` method returns [`snps0dr::R`](R) reader structure
impl crate::Readable for SNPS0DRrs {}
///`reset()` method sets SNPS0DR to value 0
impl crate::Resettable for SNPS0DRrs {}
