...
impl W {
    ///Bit 0 - Power-down deepsleep selection
    #[inline(always)]
    pub fn pdds(&mut self) -> PDDS_W<CPUCRrs> {
        PDDS_W::new(self, 0)
    }
    ///Bit 1 - Clear Standby and Stop flags (always read as 0)
    #[inline(always)]
    ...
    ///Bit 16 - System Stop mode voltage scaling selection
    #[inline(always)]
    pub fn svos(&mut self) -> SVOS_W<CPUCRrs> {
        SVOS_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#PWR:CPUCR)*/
pub struct CPUCRrs;
