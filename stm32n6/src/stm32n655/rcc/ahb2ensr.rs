...
impl W {
    ...
    #[inline(always)]
    pub fn ramcfgens(&mut self) -> RAMCFGENS_W<AHB2ENSRrs> {
        RAMCFGENS_W::new(self, 12)
    }
    ///Bit 16 - MDF1 enable
    #[inline(always)]
    pub fn mdf1ens(&mut self) -> MDF1ENS_W<AHB2ENSRrs> {
        MDF1ENS_W::new(self, 16)
    }
    ///Bit 17 - ADF1 enable
    #[inline(always)]
    pub fn adf1ens(&mut self) -> ADF1ENS_W<AHB2ENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:AHB2ENSR)*/
