...
impl W {
    ...
    #[inline(always)]
    pub fn ramcfglpenc(&mut self) -> RAMCFGLPENC_W<AHB2LPENCRrs> {
        RAMCFGLPENC_W::new(self, 12)
    }
    ///Bit 16 - MDF1 sleep enable
    #[inline(always)]
    pub fn mdf1lpenc(&mut self) -> MDF1LPENC_W<AHB2LPENCRrs> {
        MDF1LPENC_W::new(self, 16)
    }
    ///Bit 17 - ADF1 sleep enable
    #[inline(always)]
    pub fn adf1lpenc(&mut self) -> ADF1LPENC_W<AHB2LPENCRrs> {
