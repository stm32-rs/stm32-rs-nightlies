...
impl W {
    ///Bit 0 - RNG reset
    #[inline(always)]
    pub fn rngrstc(&mut self) -> RNGRSTC_W<AHB3RSTCRrs> {
        RNGRSTC_W::new(self, 0)
    }
    ///Bit 1 - HASH reset
    #[inline(always)]
    pub fn hashrstc(&mut self) -> HASHRSTC_W<AHB3RSTCRrs> {
        HASHRSTC_W::new(self, 1)
    }
    ///Bit 2 - CRYP reset
    #[inline(always)]
    pub fn cryprstc(&mut self) -> CRYPRSTC_W<AHB3RSTCRrs> {
        CRYPRSTC_W::new(self, 2)
    }
    ///Bit 4 - SAES reset
    #[inline(always)]
    pub fn saesrstc(&mut self) -> SAESRSTC_W<AHB3RSTCRrs> {
        SAESRSTC_W::new(self, 4)
    }
    ///Bit 8 - PKA reset
    #[inline(always)]
    pub fn pkarstc(&mut self) -> PKARSTC_W<AHB3RSTCRrs> {
        PKARSTC_W::new(self, 8)
    }
    ///Bit 10 - IAC reset
    #[inline(always)]
    pub fn iacrstc(&mut self) -> IACRSTC_W<AHB3RSTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:AHB3RSTCR)*/
