...
impl W {
    ///Bit 0 - RNG reset
    #[inline(always)]
    pub fn rngrsts(&mut self) -> RNGRSTS_W<AHB3RSTSRrs> {
        RNGRSTS_W::new(self, 0)
    }
    ///Bit 1 - HASH reset
    #[inline(always)]
    pub fn hashrsts(&mut self) -> HASHRSTS_W<AHB3RSTSRrs> {
        HASHRSTS_W::new(self, 1)
    }
    ///Bit 2 - CRYP reset
    #[inline(always)]
    pub fn cryprsts(&mut self) -> CRYPRSTS_W<AHB3RSTSRrs> {
        CRYPRSTS_W::new(self, 2)
    }
    ///Bit 4 - SAES reset
    #[inline(always)]
    pub fn saesrsts(&mut self) -> SAESRSTS_W<AHB3RSTSRrs> {
        SAESRSTS_W::new(self, 4)
    }
    ///Bit 8 - PKA reset
    #[inline(always)]
    pub fn pkarsts(&mut self) -> PKARSTS_W<AHB3RSTSRrs> {
        PKARSTS_W::new(self, 8)
    }
    ///Bit 10 - IAC reset
    #[inline(always)]
    pub fn iacrsts(&mut self) -> IACRSTS_W<AHB3RSTSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:AHB3RSTSR)*/
