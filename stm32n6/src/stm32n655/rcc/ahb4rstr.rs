...
impl W {
    ...
    ///Bit 16 - GPIOQ reset
    #[inline(always)]
    pub fn gpioqrst(&mut self) -> GPIOQRST_W<AHB4RSTRrs> {
        GPIOQRST_W::new(self, 16)
    }
    ///Bit 18 - PWR reset
    #[inline(always)]
    pub fn pwrrst(&mut self) -> PWRRST_W<AHB4RSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:AHB4RSTR)*/
