...
impl W {
    ///Bit 0 - GPIOA reset
    #[inline(always)]
    pub fn gpioarsts(&mut self) -> GPIOARSTS_W<AHB4RSTSRrs> {
        GPIOARSTS_W::new(self, 0)
    }
    ///Bit 1 - GPIOB reset
    #[inline(always)]
    pub fn gpiobrsts(&mut self) -> GPIOBRSTS_W<AHB4RSTSRrs> {
        GPIOBRSTS_W::new(self, 1)
    }
    ///Bit 2 - GPIOC reset
    #[inline(always)]
    pub fn gpiocrsts(&mut self) -> GPIOCRSTS_W<AHB4RSTSRrs> {
        GPIOCRSTS_W::new(self, 2)
    }
    ///Bit 3 - GPIOD reset
    #[inline(always)]
    pub fn gpiodrsts(&mut self) -> GPIODRSTS_W<AHB4RSTSRrs> {
        GPIODRSTS_W::new(self, 3)
    }
    ///Bit 4 - GPIOE reset
    #[inline(always)]
    pub fn gpioersts(&mut self) -> GPIOERSTS_W<AHB4RSTSRrs> {
        GPIOERSTS_W::new(self, 4)
    }
    ///Bit 5 - GPIOF reset
    #[inline(always)]
    pub fn gpiofrsts(&mut self) -> GPIOFRSTS_W<AHB4RSTSRrs> {
        GPIOFRSTS_W::new(self, 5)
    }
    ///Bit 6 - GPIOG reset
    #[inline(always)]
    pub fn gpiogrsts(&mut self) -> GPIOGRSTS_W<AHB4RSTSRrs> {
        GPIOGRSTS_W::new(self, 6)
    }
    ///Bit 7 - GPIOH reset
    #[inline(always)]
    pub fn gpiohrsts(&mut self) -> GPIOHRSTS_W<AHB4RSTSRrs> {
        GPIOHRSTS_W::new(self, 7)
    }
    ///Bit 13 - GPION reset
    #[inline(always)]
    pub fn gpionrsts(&mut self) -> GPIONRSTS_W<AHB4RSTSRrs> {
        GPIONRSTS_W::new(self, 13)
    }
    ///Bit 14 - GPIOO reset
    #[inline(always)]
    pub fn gpioorsts(&mut self) -> GPIOORSTS_W<AHB4RSTSRrs> {
        GPIOORSTS_W::new(self, 14)
    }
    ///Bit 15 - GPIOP reset
    #[inline(always)]
    pub fn gpioprsts(&mut self) -> GPIOPRSTS_W<AHB4RSTSRrs> {
        GPIOPRSTS_W::new(self, 15)
    }
    ///Bit 16 - GPIOQ reset
    #[inline(always)]
    pub fn gpioqrsts(&mut self) -> GPIOQRSTS_W<AHB4RSTSRrs> {
        GPIOQRSTS_W::new(self, 16)
    }
    ///Bit 18 - PWR reset
    #[inline(always)]
    pub fn pwrrsts(&mut self) -> PWRRSTS_W<AHB4RSTSRrs> {
        PWRRSTS_W::new(self, 18)
    }
    ///Bit 19 - CRC reset
    #[inline(always)]
    pub fn crcrsts(&mut self) -> CRCRSTS_W<AHB4RSTSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:AHB4RSTSR)*/
