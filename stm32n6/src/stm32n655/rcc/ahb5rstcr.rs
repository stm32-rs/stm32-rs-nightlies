...
impl W {
    ///Bit 0 - HPDMA1 reset
    #[inline(always)]
    pub fn hpdma1rstc(&mut self) -> HPDMA1RSTC_W<AHB5RSTCRrs> {
        HPDMA1RSTC_W::new(self, 0)
    }
    ///Bit 1 - DMA2D reset
    #[inline(always)]
    pub fn dma2drstc(&mut self) -> DMA2DRSTC_W<AHB5RSTCRrs> {
        DMA2DRSTC_W::new(self, 1)
    }
    ///Bit 3 - JPEG reset
    #[inline(always)]
    pub fn jpegrstc(&mut self) -> JPEGRSTC_W<AHB5RSTCRrs> {
        JPEGRSTC_W::new(self, 3)
    }
    ///Bit 4 - FMC reset
    #[inline(always)]
    pub fn fmcrstc(&mut self) -> FMCRSTC_W<AHB5RSTCRrs> {
        FMCRSTC_W::new(self, 4)
    }
    ///Bit 5 - XSPI1 reset
    #[inline(always)]
    pub fn xspi1rstc(&mut self) -> XSPI1RSTC_W<AHB5RSTCRrs> {
        XSPI1RSTC_W::new(self, 5)
    }
    ///Bit 6 - PSSI reset
    #[inline(always)]
    pub fn pssirstc(&mut self) -> PSSIRSTC_W<AHB5RSTCRrs> {
        PSSIRSTC_W::new(self, 6)
    }
    ///Bit 7 - SDMMC2 reset
    #[inline(always)]
    pub fn sdmmc2rstc(&mut self) -> SDMMC2RSTC_W<AHB5RSTCRrs> {
        SDMMC2RSTC_W::new(self, 7)
    }
    ///Bit 8 - SDMMC1 reset
    #[inline(always)]
    pub fn sdmmc1rstc(&mut self) -> SDMMC1RSTC_W<AHB5RSTCRrs> {
        SDMMC1RSTC_W::new(self, 8)
    }
    ///Bit 12 - XSPI2 reset
    #[inline(always)]
    pub fn xspi2rstc(&mut self) -> XSPI2RSTC_W<AHB5RSTCRrs> {
        XSPI2RSTC_W::new(self, 12)
    }
    ///Bit 13 - XSPIM reset
    #[inline(always)]
    pub fn xspimrstc(&mut self) -> XSPIMRSTC_W<AHB5RSTCRrs> {
        XSPIMRSTC_W::new(self, 13)
    }
    ///Bit 17 - XSPI3 reset
    #[inline(always)]
    pub fn xspi3rstc(&mut self) -> XSPI3RSTC_W<AHB5RSTCRrs> {
        XSPI3RSTC_W::new(self, 17)
    }
    ///Bit 18 - MCE4 reset
    #[inline(always)]
    pub fn mce4rstc(&mut self) -> MCE4RSTC_W<AHB5RSTCRrs> {
        MCE4RSTC_W::new(self, 18)
    }
    ///Bit 19 - GFXMMU reset
    #[inline(always)]
    pub fn gfxmmurstc(&mut self) -> GFXMMURSTC_W<AHB5RSTCRrs> {
        GFXMMURSTC_W::new(self, 19)
    }
    ///Bit 20 - GPU reset
    #[inline(always)]
    pub fn gpurstc(&mut self) -> GPURSTC_W<AHB5RSTCRrs> {
        GPURSTC_W::new(self, 20)
    }
    ///Bit 23 - SYSCFGOTGHSPHY1 reset
    #[inline(always)]
    pub fn syscfgotghsphy1rstc(&mut self) -> SYSCFGOTGHSPHY1RSTC_W<AHB5RSTCRrs> {
        SYSCFGOTGHSPHY1RSTC_W::new(self, 23)
    }
    ///Bit 24 - SYSCFGOTGHSPHY2 reset
    #[inline(always)]
    pub fn syscfgotghsphy2rstc(&mut self) -> SYSCFGOTGHSPHY2RSTC_W<AHB5RSTCRrs> {
        SYSCFGOTGHSPHY2RSTC_W::new(self, 24)
    }
    ///Bit 25 - ETH1 reset
    #[inline(always)]
    pub fn eth1rstc(&mut self) -> ETH1RSTC_W<AHB5RSTCRrs> {
        ETH1RSTC_W::new(self, 25)
    }
    ///Bit 26 - OTG1 reset
    #[inline(always)]
    pub fn otg1rstc(&mut self) -> OTG1RSTC_W<AHB5RSTCRrs> {
        OTG1RSTC_W::new(self, 26)
    }
    ///Bit 27 - OTGPHY1 reset
    #[inline(always)]
    pub fn otgphy1rstc(&mut self) -> OTGPHY1RSTC_W<AHB5RSTCRrs> {
        OTGPHY1RSTC_W::new(self, 27)
    }
    ///Bit 28 - OTGPHY2 reset
    #[inline(always)]
    pub fn otgphy2rstc(&mut self) -> OTGPHY2RSTC_W<AHB5RSTCRrs> {
        OTGPHY2RSTC_W::new(self, 28)
    }
    ///Bit 29 - OTG2 reset
    #[inline(always)]
    pub fn otg2rstc(&mut self) -> OTG2RSTC_W<AHB5RSTCRrs> {
        OTG2RSTC_W::new(self, 29)
    }
    ///Bit 30 - NPUCACHE reset
    #[inline(always)]
    pub fn npucacherstc(&mut self) -> NPUCACHERSTC_W<AHB5RSTCRrs> {
        NPUCACHERSTC_W::new(self, 30)
    }
    ///Bit 31 - NPU reset
    #[inline(always)]
    pub fn npurstc(&mut self) -> NPURSTC_W<AHB5RSTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:AHB5RSTCR)*/
