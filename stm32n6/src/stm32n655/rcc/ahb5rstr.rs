...
impl W {
    ...
    ///Bit 6 - PSSI reset
    #[inline(always)]
    pub fn pssirst(&mut self) -> PSSIRST_W<AHB5RSTRrs> {
        PSSIRST_W::new(self, 6)
    }
    ///Bit 7 - SDMMC2 reset
    #[inline(always)]
    pub fn sdmmc2rst(&mut self) -> SDMMC2RST_W<AHB5RSTRrs> {
    ...
    ///Bit 17 - XSPI3 reset
    #[inline(always)]
    pub fn xspi3rst(&mut self) -> XSPI3RST_W<AHB5RSTRrs> {
        XSPI3RST_W::new(self, 17)
    }
    ///Bit 18 - MCE4 reset
    #[inline(always)]
    pub fn mce4rst(&mut self) -> MCE4RST_W<AHB5RSTRrs> {
    ...
    ///Bit 23 - SYSCFGOTGHSPHY1 reset
    #[inline(always)]
    pub fn syscfgotghsphy1rst(&mut self) -> SYSCFGOTGHSPHY1RST_W<AHB5RSTRrs> {
        SYSCFGOTGHSPHY1RST_W::new(self, 23)
    }
    ///Bit 24 - SYSCFGOTGHSPHY2 reset
    #[inline(always)]
    pub fn syscfgotghsphy2rst(&mut self) -> SYSCFGOTGHSPHY2RST_W<AHB5RSTRrs> {
        SYSCFGOTGHSPHY2RST_W::new(self, 24)
    }
    ///Bit 25 - ETH1 reset
    #[inline(always)]
    pub fn eth1rst(&mut self) -> ETH1RST_W<AHB5RSTRrs> {
        ETH1RST_W::new(self, 25)
    }
    ///Bit 26 - OTG1 reset
    #[inline(always)]
    pub fn otg1rst(&mut self) -> OTG1RST_W<AHB5RSTRrs> {
        OTG1RST_W::new(self, 26)
    }
    ///Bit 27 - OTGPHY1 reset
    #[inline(always)]
    pub fn otgphy1rst(&mut self) -> OTGPHY1RST_W<AHB5RSTRrs> {
        OTGPHY1RST_W::new(self, 27)
    }
    ///Bit 28 - OTGPHY2 reset
    #[inline(always)]
    pub fn otgphy2rst(&mut self) -> OTGPHY2RST_W<AHB5RSTRrs> {
        OTGPHY2RST_W::new(self, 28)
    }
    ///Bit 29 - OTG2 reset
    #[inline(always)]
    pub fn otg2rst(&mut self) -> OTG2RST_W<AHB5RSTRrs> {
        OTG2RST_W::new(self, 29)
    }
    ///Bit 30 - NPUCACHE reset
    #[inline(always)]
    pub fn npucacherst(&mut self) -> NPUCACHERST_W<AHB5RSTRrs> {
        NPUCACHERST_W::new(self, 30)
    }
    ///Bit 31 - NPU reset
    #[inline(always)]
    pub fn npurst(&mut self) -> NPURST_W<AHB5RSTRrs> {
