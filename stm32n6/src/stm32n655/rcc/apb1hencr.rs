...
impl W {
    ///Bit 5 - MDIOS enable
    #[inline(always)]
    pub fn mdiosenc(&mut self) -> MDIOSENC_W<APB1HENCRrs> {
        MDIOSENC_W::new(self, 5)
    }
    ///Bit 8 - FDCAN enable
    #[inline(always)]
    pub fn fdcanenc(&mut self) -> FDCANENC_W<APB1HENCRrs> {
        FDCANENC_W::new(self, 8)
    }
    ///Bit 18 - UCPD1 enable
    #[inline(always)]
    pub fn ucpd1enc(&mut self) -> UCPD1ENC_W<APB1HENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:APB1HENCR)*/
