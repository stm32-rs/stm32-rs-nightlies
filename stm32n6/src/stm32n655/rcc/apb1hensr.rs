...
impl W {
    ///Bit 5 - MDIOS enable
    #[inline(always)]
    pub fn mdiosens(&mut self) -> MDIOSENS_W<APB1HENSRrs> {
        MDIOSENS_W::new(self, 5)
    }
    ///Bit 8 - FDCAN enable
    #[inline(always)]
    pub fn fdcanens(&mut self) -> FDCANENS_W<APB1HENSRrs> {
        FDCANENS_W::new(self, 8)
    }
    ///Bit 18 - UCPD1 enable
    #[inline(always)]
    pub fn ucpd1ens(&mut self) -> UCPD1ENS_W<APB1HENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:APB1HENSR)*/
