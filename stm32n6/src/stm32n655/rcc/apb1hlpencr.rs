...
impl W {
    ...
    #[inline(always)]
    pub fn mdioslpenc(&mut self) -> MDIOSLPENC_W<APB1HLPENCRrs> {
        MDIOSLPENC_W::new(self, 5)
    }
    ///Bit 8 - FDCAN sleep enable
    #[inline(always)]
    pub fn fdcanlpenc(&mut self) -> FDCANLPENC_W<APB1HLPENCRrs> {
        FDCANLPENC_W::new(self, 8)
    }
    ///Bit 18 - UCPD1 sleep enable
    #[inline(always)]
    pub fn ucpd1lpenc(&mut self) -> UCPD1LPENC_W<APB1HLPENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:APB1HLPENCR)*/
