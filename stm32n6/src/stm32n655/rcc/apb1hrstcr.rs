...
impl W {
    ///Bit 5 - MDIOS reset
    #[inline(always)]
    pub fn mdiosrstc(&mut self) -> MDIOSRSTC_W<APB1HRSTCRrs> {
        MDIOSRSTC_W::new(self, 5)
    }
    ///Bit 8 - FDCAN reset
    #[inline(always)]
    pub fn fdcanrstc(&mut self) -> FDCANRSTC_W<APB1HRSTCRrs> {
        FDCANRSTC_W::new(self, 8)
    }
    ///Bit 18 - UCPD1 reset
    #[inline(always)]
    pub fn ucpd1rstc(&mut self) -> UCPD1RSTC_W<APB1HRSTCRrs> {
