...
impl W {
    ...
    ///Bit 12 - TIM10 sleep enable
    #[inline(always)]
    pub fn tim10lpen(&mut self) -> TIM10LPEN_W<APB1LLPENRrs> {
        TIM10LPEN_W::new(self, 12)
    }
    ///Bit 13 - TIM11 sleep enable
    #[inline(always)]
    pub fn tim11lpen(&mut self) -> TIM11LPEN_W<APB1LLPENRrs> {
    ...
    ///Bit 16 - SPDIFRX1 sleep enable
    #[inline(always)]
    pub fn spdifrx1lpen(&mut self) -> SPDIFRX1LPEN_W<APB1LLPENRrs> {
    ...
    ///Bit 25 - I3C2 sleep enable
    #[inline(always)]
    pub fn i3c2lpen(&mut self) -> I3C2LPEN_W<APB1LLPENRrs> {
