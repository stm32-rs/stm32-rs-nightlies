...
impl W {
    ...
    #[inline(always)]
    pub fn tim2lpens(&mut self) -> TIM2LPENS_W<APB1LLPENSRrs> {
        TIM2LPENS_W::new(self, 0)
    }
    ///Bit 1 - TIM3 sleep enable
    #[inline(always)]
    pub fn tim3lpens(&mut self) -> TIM3LPENS_W<APB1LLPENSRrs> {
        TIM3LPENS_W::new(self, 1)
    }
    ///Bit 2 - TIM4 sleep enable
    #[inline(always)]
    pub fn tim4lpens(&mut self) -> TIM4LPENS_W<APB1LLPENSRrs> {
        TIM4LPENS_W::new(self, 2)
    }
    ///Bit 3 - TIM5 sleep enable
    #[inline(always)]
    pub fn tim5lpens(&mut self) -> TIM5LPENS_W<APB1LLPENSRrs> {
        TIM5LPENS_W::new(self, 3)
    }
    ///Bit 4 - TIM6 sleep enable
    #[inline(always)]
    pub fn tim6lpens(&mut self) -> TIM6LPENS_W<APB1LLPENSRrs> {
        TIM6LPENS_W::new(self, 4)
    }
    ///Bit 5 - TIM7 sleep enable
    #[inline(always)]
    pub fn tim7lpens(&mut self) -> TIM7LPENS_W<APB1LLPENSRrs> {
        TIM7LPENS_W::new(self, 5)
    }
    ///Bit 6 - TIM12 sleep enable
    #[inline(always)]
    pub fn tim12lpens(&mut self) -> TIM12LPENS_W<APB1LLPENSRrs> {
        TIM12LPENS_W::new(self, 6)
    }
    ///Bit 7 - TIM13 sleep enable
    #[inline(always)]
    pub fn tim13lpens(&mut self) -> TIM13LPENS_W<APB1LLPENSRrs> {
        TIM13LPENS_W::new(self, 7)
    }
    ///Bit 8 - TIM14 sleep enable
    #[inline(always)]
    pub fn tim14lpens(&mut self) -> TIM14LPENS_W<APB1LLPENSRrs> {
        TIM14LPENS_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1 sleep enable
    #[inline(always)]
    pub fn lptim1lpens(&mut self) -> LPTIM1LPENS_W<APB1LLPENSRrs> {
        LPTIM1LPENS_W::new(self, 9)
    }
    ///Bit 11 - WWDG sleep enable
    #[inline(always)]
    pub fn wwdglpens(&mut self) -> WWDGLPENS_W<APB1LLPENSRrs> {
        WWDGLPENS_W::new(self, 11)
    }
    ///Bit 12 - TIM10 sleep enable
    #[inline(always)]
    pub fn tim10lpens(&mut self) -> TIM10LPENS_W<APB1LLPENSRrs> {
        TIM10LPENS_W::new(self, 12)
    }
    ///Bit 13 - TIM11 sleep enable
    #[inline(always)]
    pub fn tim11lpens(&mut self) -> TIM11LPENS_W<APB1LLPENSRrs> {
        TIM11LPENS_W::new(self, 13)
    }
    ///Bit 14 - SPI2 sleep enable
    #[inline(always)]
    pub fn spi2lpens(&mut self) -> SPI2LPENS_W<APB1LLPENSRrs> {
        SPI2LPENS_W::new(self, 14)
    }
    ///Bit 15 - SPI3 sleep enable
    #[inline(always)]
    pub fn spi3lpens(&mut self) -> SPI3LPENS_W<APB1LLPENSRrs> {
        SPI3LPENS_W::new(self, 15)
    }
    ///Bit 16 - SPDIFRX1 sleep enable
    #[inline(always)]
    pub fn spdifrx1lpens(&mut self) -> SPDIFRX1LPENS_W<APB1LLPENSRrs> {
        SPDIFRX1LPENS_W::new(self, 16)
    }
    ///Bit 17 - USART2 sleep enable
    #[inline(always)]
    pub fn usart2lpens(&mut self) -> USART2LPENS_W<APB1LLPENSRrs> {
        USART2LPENS_W::new(self, 17)
    }
    ///Bit 18 - USART3 sleep enable
    #[inline(always)]
    pub fn usart3lpens(&mut self) -> USART3LPENS_W<APB1LLPENSRrs> {
        USART3LPENS_W::new(self, 18)
    }
    ///Bit 19 - UART4 sleep enable
    #[inline(always)]
    pub fn uart4lpens(&mut self) -> UART4LPENS_W<APB1LLPENSRrs> {
        UART4LPENS_W::new(self, 19)
    }
    ///Bit 20 - UART5 sleep enable
    #[inline(always)]
    pub fn uart5lpens(&mut self) -> UART5LPENS_W<APB1LLPENSRrs> {
        UART5LPENS_W::new(self, 20)
    }
    ///Bit 21 - I2C1 sleep enable
    #[inline(always)]
    pub fn i2c1lpens(&mut self) -> I2C1LPENS_W<APB1LLPENSRrs> {
        I2C1LPENS_W::new(self, 21)
    }
    ///Bit 22 - I2C2 sleep enable
    #[inline(always)]
    pub fn i2c2lpens(&mut self) -> I2C2LPENS_W<APB1LLPENSRrs> {
        I2C2LPENS_W::new(self, 22)
    }
    ///Bit 23 - I2C3 sleep enable
    #[inline(always)]
    pub fn i2c3lpens(&mut self) -> I2C3LPENS_W<APB1LLPENSRrs> {
        I2C3LPENS_W::new(self, 23)
    }
    ///Bit 24 - I3C1 sleep enable
    #[inline(always)]
    pub fn i3c1lpens(&mut self) -> I3C1LPENS_W<APB1LLPENSRrs> {
        I3C1LPENS_W::new(self, 24)
    }
    ///Bit 25 - I3C2 sleep enable
    #[inline(always)]
    pub fn i3c2lpens(&mut self) -> I3C2LPENS_W<APB1LLPENSRrs> {
        I3C2LPENS_W::new(self, 25)
    }
    ///Bit 30 - UART7 sleep enable
    #[inline(always)]
    pub fn uart7lpens(&mut self) -> UART7LPENS_W<APB1LLPENSRrs> {
        UART7LPENS_W::new(self, 30)
    }
    ///Bit 31 - UART8 sleep enable
    #[inline(always)]
    pub fn uart8lpens(&mut self) -> UART8LPENS_W<APB1LLPENSRrs> {
