...
impl W {
    ...
    #[inline(always)]
    pub fn tim1lpens(&mut self) -> TIM1LPENS_W<APB2LPENSRrs> {
        TIM1LPENS_W::new(self, 0)
    }
    ///Bit 1 - TIM8 sleep enable
    #[inline(always)]
    pub fn tim8lpens(&mut self) -> TIM8LPENS_W<APB2LPENSRrs> {
        TIM8LPENS_W::new(self, 1)
    }
    ///Bit 4 - USART1 sleep enable
    #[inline(always)]
    pub fn usart1lpens(&mut self) -> USART1LPENS_W<APB2LPENSRrs> {
        USART1LPENS_W::new(self, 4)
    }
    ///Bit 5 - USART6 sleep enable
    #[inline(always)]
    pub fn usart6lpens(&mut self) -> USART6LPENS_W<APB2LPENSRrs> {
        USART6LPENS_W::new(self, 5)
    }
    ///Bit 6 - UART9 sleep enable
    #[inline(always)]
    pub fn uart9lpens(&mut self) -> UART9LPENS_W<APB2LPENSRrs> {
        UART9LPENS_W::new(self, 6)
    }
    ///Bit 7 - USART10 sleep enable
    #[inline(always)]
    pub fn usart10lpens(&mut self) -> USART10LPENS_W<APB2LPENSRrs> {
        USART10LPENS_W::new(self, 7)
    }
    ///Bit 12 - SPI1 sleep enable
    #[inline(always)]
    pub fn spi1lpens(&mut self) -> SPI1LPENS_W<APB2LPENSRrs> {
        SPI1LPENS_W::new(self, 12)
    }
    ///Bit 13 - SPI4 sleep enable
    #[inline(always)]
    pub fn spi4lpens(&mut self) -> SPI4LPENS_W<APB2LPENSRrs> {
        SPI4LPENS_W::new(self, 13)
    }
    ///Bit 15 - TIM18 sleep enable
    #[inline(always)]
    pub fn tim18lpens(&mut self) -> TIM18LPENS_W<APB2LPENSRrs> {
        TIM18LPENS_W::new(self, 15)
    }
    ///Bit 16 - TIM15 sleep enable
    #[inline(always)]
    pub fn tim15lpens(&mut self) -> TIM15LPENS_W<APB2LPENSRrs> {
        TIM15LPENS_W::new(self, 16)
    }
    ///Bit 17 - TIM16 sleep enable
    #[inline(always)]
    pub fn tim16lpens(&mut self) -> TIM16LPENS_W<APB2LPENSRrs> {
        TIM16LPENS_W::new(self, 17)
    }
    ///Bit 18 - TIM17 sleep enable
    #[inline(always)]
    pub fn tim17lpens(&mut self) -> TIM17LPENS_W<APB2LPENSRrs> {
        TIM17LPENS_W::new(self, 18)
    }
    ///Bit 19 - TIM9 sleep enable
    #[inline(always)]
    pub fn tim9lpens(&mut self) -> TIM9LPENS_W<APB2LPENSRrs> {
        TIM9LPENS_W::new(self, 19)
    }
    ///Bit 20 - SPI5 sleep enable
    #[inline(always)]
    pub fn spi5lpens(&mut self) -> SPI5LPENS_W<APB2LPENSRrs> {
        SPI5LPENS_W::new(self, 20)
    }
    ///Bit 21 - SAI1 sleep enable
    #[inline(always)]
    pub fn sai1lpens(&mut self) -> SAI1LPENS_W<APB2LPENSRrs> {
        SAI1LPENS_W::new(self, 21)
    }
    ///Bit 22 - SAI2 sleep enable
    #[inline(always)]
    pub fn sai2lpens(&mut self) -> SAI2LPENS_W<APB2LPENSRrs> {
