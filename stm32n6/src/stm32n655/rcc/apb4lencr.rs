...
impl W {
    ///Bit 2 - HDP enable
    #[inline(always)]
    pub fn hdpenc(&mut self) -> HDPENC_W<APB4LENCRrs> {
        HDPENC_W::new(self, 2)
    }
    ///Bit 3 - LPUART1 enable
    #[inline(always)]
    pub fn lpuart1enc(&mut self) -> LPUART1ENC_W<APB4LENCRrs> {
        LPUART1ENC_W::new(self, 3)
    }
    ///Bit 5 - SPI6 enable
    #[inline(always)]
    pub fn spi6enc(&mut self) -> SPI6ENC_W<APB4LENCRrs> {
        SPI6ENC_W::new(self, 5)
    }
    ///Bit 7 - I2C4 enable
    #[inline(always)]
    pub fn i2c4enc(&mut self) -> I2C4ENC_W<APB4LENCRrs> {
        I2C4ENC_W::new(self, 7)
    }
    ///Bit 9 - LPTIM2 enable
    #[inline(always)]
    pub fn lptim2enc(&mut self) -> LPTIM2ENC_W<APB4LENCRrs> {
        LPTIM2ENC_W::new(self, 9)
    }
    ///Bit 10 - LPTIM3 enable
    #[inline(always)]
    pub fn lptim3enc(&mut self) -> LPTIM3ENC_W<APB4LENCRrs> {
        LPTIM3ENC_W::new(self, 10)
    }
    ///Bit 11 - LPTIM4 enable
    #[inline(always)]
    pub fn lptim4enc(&mut self) -> LPTIM4ENC_W<APB4LENCRrs> {
        LPTIM4ENC_W::new(self, 11)
    }
    ///Bit 12 - LPTIM5 enable
    #[inline(always)]
    pub fn lptim5enc(&mut self) -> LPTIM5ENC_W<APB4LENCRrs> {
        LPTIM5ENC_W::new(self, 12)
    }
    ///Bit 15 - VREFBUF enable
    #[inline(always)]
    pub fn vrefbufenc(&mut self) -> VREFBUFENC_W<APB4LENCRrs> {
        VREFBUFENC_W::new(self, 15)
    }
    ///Bit 16 - RTC enable
    #[inline(always)]
    pub fn rtcenc(&mut self) -> RTCENC_W<APB4LENCRrs> {
        RTCENC_W::new(self, 16)
    }
    ///Bit 17 - RTCAPB enable
    #[inline(always)]
    pub fn rtcapbenc(&mut self) -> RTCAPBENC_W<APB4LENCRrs> {
        RTCAPBENC_W::new(self, 17)
    }
    ///Bit 22 - R2GRET enable
    #[inline(always)]
    pub fn r2gretenc(&mut self) -> R2GRETENC_W<APB4LENCRrs> {
        R2GRETENC_W::new(self, 22)
    }
    ///Bit 23 - R2GNPU enable
    #[inline(always)]
    pub fn r2gnpuenc(&mut self) -> R2GNPUENC_W<APB4LENCRrs> {
        R2GNPUENC_W::new(self, 23)
    }
    ///Bit 31 - SERF enable
    #[inline(always)]
    pub fn serfenc(&mut self) -> SERFENC_W<APB4LENCRrs> {
