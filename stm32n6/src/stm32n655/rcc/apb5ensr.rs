...
impl W {
    ///Bit 1 - LTDC enable
    #[inline(always)]
    pub fn ltdcens(&mut self) -> LTDCENS_W<APB5ENSRrs> {
        LTDCENS_W::new(self, 1)
    }
    ///Bit 2 - DCMIPP enable
    #[inline(always)]
    pub fn dcmippens(&mut self) -> DCMIPPENS_W<APB5ENSRrs> {
        DCMIPPENS_W::new(self, 2)
    }
    ///Bit 4 - GFXTIM enable
    #[inline(always)]
    pub fn gfxtimens(&mut self) -> GFXTIMENS_W<APB5ENSRrs> {
        GFXTIMENS_W::new(self, 4)
    }
    ///Bit 5 - VENC enable
    #[inline(always)]
    pub fn vencens(&mut self) -> VENCENS_W<APB5ENSRrs> {
        VENCENS_W::new(self, 5)
    }
    ///Bit 6 - CSI enable
    #[inline(always)]
    pub fn csiens(&mut self) -> CSIENS_W<APB5ENSRrs> {
        CSIENS_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:APB5ENSR)*/
