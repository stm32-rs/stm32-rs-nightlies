...
impl W {
    ...
    #[inline(always)]
    pub fn pll4rdyc(&mut self) -> PLL4RDYC_W<CICRrs> {
    ...
    #[inline(always)]
    pub fn wkupfc(&mut self) -> WKUPFC_W<CICRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:CICR)*/
pub struct CICRrs;
