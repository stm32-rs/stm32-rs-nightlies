...
impl W {
    ...
    #[inline(always)]
    pub fn ic1lpenc(&mut self) -> IC1LPENC_W<DIVLPENCRrs> {
        IC1LPENC_W::new(self, 0)
    }
    ///Bit 1 - IC2 sleep enable
    #[inline(always)]
    pub fn ic2lpenc(&mut self) -> IC2LPENC_W<DIVLPENCRrs> {
        IC2LPENC_W::new(self, 1)
    }
    ///Bit 2 - IC3 sleep enable
    #[inline(always)]
    pub fn ic3lpenc(&mut self) -> IC3LPENC_W<DIVLPENCRrs> {
        IC3LPENC_W::new(self, 2)
    }
    ///Bit 3 - IC4 sleep enable
    #[inline(always)]
    pub fn ic4lpenc(&mut self) -> IC4LPENC_W<DIVLPENCRrs> {
        IC4LPENC_W::new(self, 3)
    }
    ///Bit 4 - IC5 sleep enable
    #[inline(always)]
    pub fn ic5lpenc(&mut self) -> IC5LPENC_W<DIVLPENCRrs> {
        IC5LPENC_W::new(self, 4)
    }
    ///Bit 5 - IC6 sleep enable
    #[inline(always)]
    pub fn ic6lpenc(&mut self) -> IC6LPENC_W<DIVLPENCRrs> {
        IC6LPENC_W::new(self, 5)
    }
    ///Bit 6 - IC7 sleep enable
    #[inline(always)]
    pub fn ic7lpenc(&mut self) -> IC7LPENC_W<DIVLPENCRrs> {
        IC7LPENC_W::new(self, 6)
    }
    ///Bit 7 - IC8 sleep enable
    #[inline(always)]
    pub fn ic8lpenc(&mut self) -> IC8LPENC_W<DIVLPENCRrs> {
        IC8LPENC_W::new(self, 7)
    }
    ///Bit 8 - IC9 sleep enable
    #[inline(always)]
    pub fn ic9lpenc(&mut self) -> IC9LPENC_W<DIVLPENCRrs> {
        IC9LPENC_W::new(self, 8)
    }
    ///Bit 9 - IC10 sleep enable
    #[inline(always)]
    pub fn ic10lpenc(&mut self) -> IC10LPENC_W<DIVLPENCRrs> {
        IC10LPENC_W::new(self, 9)
    }
    ///Bit 10 - IC11 sleep enable
    #[inline(always)]
    pub fn ic11lpenc(&mut self) -> IC11LPENC_W<DIVLPENCRrs> {
        IC11LPENC_W::new(self, 10)
    }
    ///Bit 11 - IC12 sleep enable
    #[inline(always)]
    pub fn ic12lpenc(&mut self) -> IC12LPENC_W<DIVLPENCRrs> {
        IC12LPENC_W::new(self, 11)
    }
    ///Bit 12 - IC13 sleep enable
    #[inline(always)]
    pub fn ic13lpenc(&mut self) -> IC13LPENC_W<DIVLPENCRrs> {
        IC13LPENC_W::new(self, 12)
    }
    ///Bit 13 - IC14 sleep enable
    #[inline(always)]
    pub fn ic14lpenc(&mut self) -> IC14LPENC_W<DIVLPENCRrs> {
        IC14LPENC_W::new(self, 13)
    }
    ///Bit 14 - IC15 sleep enable
    #[inline(always)]
    pub fn ic15lpenc(&mut self) -> IC15LPENC_W<DIVLPENCRrs> {
        IC15LPENC_W::new(self, 14)
    }
    ///Bit 15 - IC16 sleep enable
    #[inline(always)]
    pub fn ic16lpenc(&mut self) -> IC16LPENC_W<DIVLPENCRrs> {
        IC16LPENC_W::new(self, 15)
    }
    ///Bit 16 - IC17 sleep enable
    #[inline(always)]
    pub fn ic17lpenc(&mut self) -> IC17LPENC_W<DIVLPENCRrs> {
        IC17LPENC_W::new(self, 16)
    }
    ///Bit 17 - IC18 sleep enable
    #[inline(always)]
    pub fn ic18lpenc(&mut self) -> IC18LPENC_W<DIVLPENCRrs> {
        IC18LPENC_W::new(self, 17)
    }
    ///Bit 18 - IC19 sleep enable
    #[inline(always)]
    pub fn ic19lpenc(&mut self) -> IC19LPENC_W<DIVLPENCRrs> {
        IC19LPENC_W::new(self, 18)
    }
    ///Bit 19 - IC20 sleep enable
    #[inline(always)]
    pub fn ic20lpenc(&mut self) -> IC20LPENC_W<DIVLPENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:DIVLPENCR)*/
