...
impl W {
    ...
    #[inline(always)]
    pub fn ic1lpens(&mut self) -> IC1LPENS_W<DIVLPENSRrs> {
        IC1LPENS_W::new(self, 0)
    }
    ///Bit 1 - IC2 sleep enable
    #[inline(always)]
    pub fn ic2lpens(&mut self) -> IC2LPENS_W<DIVLPENSRrs> {
        IC2LPENS_W::new(self, 1)
    }
    ///Bit 2 - IC3 sleep enable
    #[inline(always)]
    pub fn ic3lpens(&mut self) -> IC3LPENS_W<DIVLPENSRrs> {
        IC3LPENS_W::new(self, 2)
    }
    ///Bit 3 - IC4 sleep enable
    #[inline(always)]
    pub fn ic4lpens(&mut self) -> IC4LPENS_W<DIVLPENSRrs> {
        IC4LPENS_W::new(self, 3)
    }
    ///Bit 4 - IC5 sleep enable
    #[inline(always)]
    pub fn ic5lpens(&mut self) -> IC5LPENS_W<DIVLPENSRrs> {
        IC5LPENS_W::new(self, 4)
    }
    ///Bit 5 - IC6 sleep enable
    #[inline(always)]
    pub fn ic6lpens(&mut self) -> IC6LPENS_W<DIVLPENSRrs> {
        IC6LPENS_W::new(self, 5)
    }
    ///Bit 6 - IC7 sleep enable
    #[inline(always)]
    pub fn ic7lpens(&mut self) -> IC7LPENS_W<DIVLPENSRrs> {
        IC7LPENS_W::new(self, 6)
    }
    ///Bit 7 - IC8 sleep enable
    #[inline(always)]
    pub fn ic8lpens(&mut self) -> IC8LPENS_W<DIVLPENSRrs> {
        IC8LPENS_W::new(self, 7)
    }
    ///Bit 8 - IC9 sleep enable
    #[inline(always)]
    pub fn ic9lpens(&mut self) -> IC9LPENS_W<DIVLPENSRrs> {
        IC9LPENS_W::new(self, 8)
    }
    ///Bit 9 - IC10 sleep enable
    #[inline(always)]
    pub fn ic10lpens(&mut self) -> IC10LPENS_W<DIVLPENSRrs> {
        IC10LPENS_W::new(self, 9)
    }
    ///Bit 10 - IC11 sleep enable
    #[inline(always)]
    pub fn ic11lpens(&mut self) -> IC11LPENS_W<DIVLPENSRrs> {
        IC11LPENS_W::new(self, 10)
    }
    ///Bit 11 - IC12 sleep enable
    #[inline(always)]
    pub fn ic12lpens(&mut self) -> IC12LPENS_W<DIVLPENSRrs> {
        IC12LPENS_W::new(self, 11)
    }
    ///Bit 12 - IC13 sleep enable
    #[inline(always)]
    pub fn ic13lpens(&mut self) -> IC13LPENS_W<DIVLPENSRrs> {
        IC13LPENS_W::new(self, 12)
    }
    ///Bit 13 - IC14 sleep enable
    #[inline(always)]
    pub fn ic14lpens(&mut self) -> IC14LPENS_W<DIVLPENSRrs> {
        IC14LPENS_W::new(self, 13)
    }
    ///Bit 14 - IC15 sleep enable
    #[inline(always)]
    pub fn ic15lpens(&mut self) -> IC15LPENS_W<DIVLPENSRrs> {
        IC15LPENS_W::new(self, 14)
    }
    ///Bit 15 - IC16 sleep enable
    #[inline(always)]
    pub fn ic16lpens(&mut self) -> IC16LPENS_W<DIVLPENSRrs> {
        IC16LPENS_W::new(self, 15)
    }
    ///Bit 16 - IC17 sleep enable
    #[inline(always)]
    pub fn ic17lpens(&mut self) -> IC17LPENS_W<DIVLPENSRrs> {
        IC17LPENS_W::new(self, 16)
    }
    ///Bit 17 - IC18 sleep enable
    #[inline(always)]
    pub fn ic18lpens(&mut self) -> IC18LPENS_W<DIVLPENSRrs> {
        IC18LPENS_W::new(self, 17)
    }
    ///Bit 18 - IC19 sleep enable
    #[inline(always)]
    pub fn ic19lpens(&mut self) -> IC19LPENS_W<DIVLPENSRrs> {
        IC19LPENS_W::new(self, 18)
    }
    ///Bit 19 - IC20 sleep enable
    #[inline(always)]
    pub fn ic20lpens(&mut self) -> IC20LPENS_W<DIVLPENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:DIVLPENSR)*/
