...
impl W {
    ///Bit 6 - HSE div2 oscillator clock in Bypass mode
    #[inline(always)]
    pub fn hsediv2byp(&mut self) -> HSEDIV2BYP_W<HSECFGRrs> {
        HSEDIV2BYP_W::new(self, 6)
    }
    ///Bit 7 - HSE clock security system (CSS) enable
    #[inline(always)]
    pub fn hsecsson(&mut self) -> HSECSSON_W<HSECFGRrs> {
        HSECSSON_W::new(self, 7)
    }
    ///Bit 8 - HSE clock security system (CSS) re-arm function
    #[inline(always)]
    pub fn hsecssra(&mut self) -> HSECSSRA_W<HSECFGRrs> {
        HSECSSRA_W::new(self, 8)
    }
    ///Bit 10 - HSE clock security system (CSS) bypass enable
    #[inline(always)]
    pub fn hsecssbyp(&mut self) -> HSECSSBYP_W<HSECFGRrs> {
        HSECSSBYP_W::new(self, 10)
    }
    ///Bits 11:14 - HSE clock security system (CSS) bypass divider
    #[inline(always)]
    pub fn hsecssbpre(&mut self) -> HSECSSBPRE_W<HSECFGRrs> {
        HSECSSBPRE_W::new(self, 11)
    }
    ///Bit 15 - HSE clock bypass
    #[inline(always)]
    pub fn hsebyp(&mut self) -> HSEBYP_W<HSECFGRrs> {
        HSEBYP_W::new(self, 15)
    }
    ///Bit 16 - HSE clock type in Bypass mode
    #[inline(always)]
    pub fn hseext(&mut self) -> HSEEXT_W<HSECFGRrs> {
        HSEEXT_W::new(self, 16)
    }
    ///Bit 17 - HSE clock glitch filter enable
    #[inline(always)]
    pub fn hsegfon(&mut self) -> HSEGFON_W<HSECFGRrs> {
        HSEGFON_W::new(self, 17)
    }
    ///Bits 18:19 - HSE oscillator driving capability
    #[inline(always)]
    pub fn hsedrv(&mut self) -> HSEDRV_W<HSECFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:HSECFGR)*/
