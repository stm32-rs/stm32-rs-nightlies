...
impl W {
    ///Bits 16:23 - Divider IC2 integer division factor
    #[inline(always)]
    pub fn ic2int(&mut self) -> IC2INT_W<IC2CFGRrs> {
        IC2INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC2 Source Selection
    #[inline(always)]
    pub fn ic2sel(&mut self) -> IC2SEL_W<IC2CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:IC2CFGR)*/
