...
impl W {
    ///Bits 16:23 - Divider IC3 integer division factor
    #[inline(always)]
    pub fn ic3int(&mut self) -> IC3INT_W<IC3CFGRrs> {
        IC3INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC3 Source Selection
    #[inline(always)]
    pub fn ic3sel(&mut self) -> IC3SEL_W<IC3CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:IC3CFGR)*/
