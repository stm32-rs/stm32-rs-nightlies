...
impl W {
    ///Bits 16:23 - Divider IC7 integer division factor
    #[inline(always)]
    pub fn ic7int(&mut self) -> IC7INT_W<IC7CFGRrs> {
        IC7INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC7 Source Selection
    #[inline(always)]
    pub fn ic7sel(&mut self) -> IC7SEL_W<IC7CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:IC7CFGR)*/
