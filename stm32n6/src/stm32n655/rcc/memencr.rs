...
impl W {
    ...
    #[inline(always)]
    pub fn axisram3enc(&mut self) -> AXISRAM3ENC_W<MEMENCRrs> {
        AXISRAM3ENC_W::new(self, 0)
    }
    ///Bit 1 - AXISRAM4 enable
    #[inline(always)]
    pub fn axisram4enc(&mut self) -> AXISRAM4ENC_W<MEMENCRrs> {
        AXISRAM4ENC_W::new(self, 1)
    }
    ///Bit 2 - AXISRAM5 enable
    #[inline(always)]
    pub fn axisram5enc(&mut self) -> AXISRAM5ENC_W<MEMENCRrs> {
        AXISRAM5ENC_W::new(self, 2)
    }
    ///Bit 3 - AXISRAM6 enable
    #[inline(always)]
    pub fn axisram6enc(&mut self) -> AXISRAM6ENC_W<MEMENCRrs> {
        AXISRAM6ENC_W::new(self, 3)
    }
    ///Bit 4 - AHBSRAM1 enable
    #[inline(always)]
    pub fn ahbsram1enc(&mut self) -> AHBSRAM1ENC_W<MEMENCRrs> {
        AHBSRAM1ENC_W::new(self, 4)
    }
    ///Bit 5 - AHBSRAM2 enable
    #[inline(always)]
    pub fn ahbsram2enc(&mut self) -> AHBSRAM2ENC_W<MEMENCRrs> {
        AHBSRAM2ENC_W::new(self, 5)
    }
    ///Bit 6 - BKPSRAM enable
    #[inline(always)]
    pub fn bkpsramenc(&mut self) -> BKPSRAMENC_W<MEMENCRrs> {
        BKPSRAMENC_W::new(self, 6)
    }
    ///Bit 7 - AXISRAM1 enable
    #[inline(always)]
    pub fn axisram1enc(&mut self) -> AXISRAM1ENC_W<MEMENCRrs> {
        AXISRAM1ENC_W::new(self, 7)
    }
    ///Bit 8 - AXISRAM2 enable
    #[inline(always)]
    pub fn axisram2enc(&mut self) -> AXISRAM2ENC_W<MEMENCRrs> {
        AXISRAM2ENC_W::new(self, 8)
    }
    ///Bit 9 - FLEXRAM enable
    #[inline(always)]
    pub fn flexramenc(&mut self) -> FLEXRAMENC_W<MEMENCRrs> {
        FLEXRAMENC_W::new(self, 9)
    }
    ///Bit 10 - NPUCACHERAM enable
    #[inline(always)]
    pub fn npucacheramenc(&mut self) -> NPUCACHERAMENC_W<MEMENCRrs> {
        NPUCACHERAMENC_W::new(self, 10)
    }
    ///Bit 11 - VENCRAM enable
    #[inline(always)]
    pub fn vencramenc(&mut self) -> VENCRAMENC_W<MEMENCRrs> {
        VENCRAMENC_W::new(self, 11)
    }
    ///Bit 12 - BOOTROM enable
    #[inline(always)]
    pub fn bootromenc(&mut self) -> BOOTROMENC_W<MEMENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:MEMENCR)*/
