...
impl W {
    ///Bit 0 - AXISRAM3 enable
    #[inline(always)]
    pub fn axisram3en(&mut self) -> AXISRAM3EN_W<MEMENRrs> {
        AXISRAM3EN_W::new(self, 0)
    }
    ///Bit 1 - AXISRAM4 enable
    #[inline(always)]
    pub fn axisram4en(&mut self) -> AXISRAM4EN_W<MEMENRrs> {
        AXISRAM4EN_W::new(self, 1)
    }
    ///Bit 2 - AXISRAM5 enable
    #[inline(always)]
    pub fn axisram5en(&mut self) -> AXISRAM5EN_W<MEMENRrs> {
        AXISRAM5EN_W::new(self, 2)
    }
    ///Bit 3 - AXISRAM6 enable
    #[inline(always)]
    pub fn axisram6en(&mut self) -> AXISRAM6EN_W<MEMENRrs> {
        AXISRAM6EN_W::new(self, 3)
    }
    ///Bit 4 - AHBSRAM1 enable
    #[inline(always)]
    pub fn ahbsram1en(&mut self) -> AHBSRAM1EN_W<MEMENRrs> {
        AHBSRAM1EN_W::new(self, 4)
    }
    ///Bit 5 - AHBSRAM2 enable
    #[inline(always)]
    pub fn ahbsram2en(&mut self) -> AHBSRAM2EN_W<MEMENRrs> {
        AHBSRAM2EN_W::new(self, 5)
    }
    ///Bit 6 - BKPSRAM enable
    #[inline(always)]
    pub fn bkpsramen(&mut self) -> BKPSRAMEN_W<MEMENRrs> {
        BKPSRAMEN_W::new(self, 6)
    }
    ///Bit 7 - AXISRAM1 enable
    #[inline(always)]
    pub fn axisram1en(&mut self) -> AXISRAM1EN_W<MEMENRrs> {
        AXISRAM1EN_W::new(self, 7)
    }
    ///Bit 8 - AXISRAM2 enable
    #[inline(always)]
    pub fn axisram2en(&mut self) -> AXISRAM2EN_W<MEMENRrs> {
        AXISRAM2EN_W::new(self, 8)
    }
    ///Bit 9 - FLEXRAM enable
    #[inline(always)]
    pub fn flexramen(&mut self) -> FLEXRAMEN_W<MEMENRrs> {
        FLEXRAMEN_W::new(self, 9)
    }
    ///Bit 10 - NPUCACHERAM enable
    #[inline(always)]
    pub fn npucacheramen(&mut self) -> NPUCACHERAMEN_W<MEMENRrs> {
        NPUCACHERAMEN_W::new(self, 10)
    }
    ///Bit 11 - VENCRAM enable
    #[inline(always)]
    pub fn vencramen(&mut self) -> VENCRAMEN_W<MEMENRrs> {
        VENCRAMEN_W::new(self, 11)
    }
    ///Bit 12 - BOOTROM enable
    #[inline(always)]
    pub fn bootromen(&mut self) -> BOOTROMEN_W<MEMENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:MEMENR)*/
pub struct MEMENRrs;
