...
impl W {
    ...
    #[inline(always)]
    pub fn axisram3ens(&mut self) -> AXISRAM3ENS_W<MEMENSRrs> {
        AXISRAM3ENS_W::new(self, 0)
    }
    ///Bit 1 - AXISRAM4 enable
    #[inline(always)]
    pub fn axisram4ens(&mut self) -> AXISRAM4ENS_W<MEMENSRrs> {
        AXISRAM4ENS_W::new(self, 1)
    }
    ///Bit 2 - AXISRAM5 enable
    #[inline(always)]
    pub fn axisram5ens(&mut self) -> AXISRAM5ENS_W<MEMENSRrs> {
        AXISRAM5ENS_W::new(self, 2)
    }
    ///Bit 3 - AXISRAM6 enable
    #[inline(always)]
    pub fn axisram6ens(&mut self) -> AXISRAM6ENS_W<MEMENSRrs> {
        AXISRAM6ENS_W::new(self, 3)
    }
    ///Bit 4 - AHBSRAM1 enable
    #[inline(always)]
    pub fn ahbsram1ens(&mut self) -> AHBSRAM1ENS_W<MEMENSRrs> {
        AHBSRAM1ENS_W::new(self, 4)
    }
    ///Bit 5 - AHBSRAM2 enable
    #[inline(always)]
    pub fn ahbsram2ens(&mut self) -> AHBSRAM2ENS_W<MEMENSRrs> {
        AHBSRAM2ENS_W::new(self, 5)
    }
    ///Bit 6 - BKPSRAM enable
    #[inline(always)]
    pub fn bkpsramens(&mut self) -> BKPSRAMENS_W<MEMENSRrs> {
        BKPSRAMENS_W::new(self, 6)
    }
    ///Bit 7 - AXISRAM1 enable
    #[inline(always)]
    pub fn axisram1ens(&mut self) -> AXISRAM1ENS_W<MEMENSRrs> {
        AXISRAM1ENS_W::new(self, 7)
    }
    ///Bit 8 - AXISRAM2 enable
    #[inline(always)]
    pub fn axisram2ens(&mut self) -> AXISRAM2ENS_W<MEMENSRrs> {
        AXISRAM2ENS_W::new(self, 8)
    }
    ///Bit 9 - FLEXRAM enable
    #[inline(always)]
    pub fn flexramens(&mut self) -> FLEXRAMENS_W<MEMENSRrs> {
        FLEXRAMENS_W::new(self, 9)
    }
    ///Bit 10 - NPUCACHERAM enable
    #[inline(always)]
    pub fn npucacheramens(&mut self) -> NPUCACHERAMENS_W<MEMENSRrs> {
        NPUCACHERAMENS_W::new(self, 10)
    }
    ///Bit 11 - VENCRAM enable
    #[inline(always)]
    pub fn vencramens(&mut self) -> VENCRAMENS_W<MEMENSRrs> {
        VENCRAMENS_W::new(self, 11)
    }
    ///Bit 12 - BOOTROM enable
    #[inline(always)]
    pub fn bootromens(&mut self) -> BOOTROMENS_W<MEMENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:MEMENSR)*/
