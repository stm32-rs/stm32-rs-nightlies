...
impl W {
    ///Bit 0 - DBG sleep enable
    #[inline(always)]
    pub fn dbglpen(&mut self) -> DBGLPEN_W<MISCLPENRrs> {
        DBGLPEN_W::new(self, 0)
    }
    ///Bit 3 - XSPIPHYCOMP sleep enable
    #[inline(always)]
    pub fn xspiphycomplpen(&mut self) -> XSPIPHYCOMPLPEN_W<MISCLPENRrs> {
        XSPIPHYCOMPLPEN_W::new(self, 3)
    }
    ///Bit 6 - PER sleep enable
    #[inline(always)]
    pub fn perlpen(&mut self) -> PERLPEN_W<MISCLPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:MISCLPENR)*/
