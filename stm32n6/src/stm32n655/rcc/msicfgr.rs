...
impl W {
    ///Bit 9 - MSI oscillator frequency select
    #[inline(always)]
    pub fn msifreqsel(&mut self) -> MSIFREQSEL_W<MSICFGRrs> {
        MSIFREQSEL_W::new(self, 9)
    }
    ///Bits 16:20 - MSI clock trimming
    #[inline(always)]
    pub fn msitrim(&mut self) -> MSITRIM_W<MSICFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:MSICFGR)*/
