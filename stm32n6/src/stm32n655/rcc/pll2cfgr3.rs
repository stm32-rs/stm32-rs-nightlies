...
impl W {
    ///Bit 0 - PLL2 Modulation Spread Spectrum reset
    #[inline(always)]
    pub fn pll2modssrst(&mut self) -> PLL2MODSSRST_W<PLL2CFGR3rs> {
        PLL2MODSSRST_W::new(self, 0)
    }
    ///Bit 1 - PLL2 noise canceling DAC enable in fractional mode.
    #[inline(always)]
    pub fn pll2dacen(&mut self) -> PLL2DACEN_W<PLL2CFGR3rs> {
        PLL2DACEN_W::new(self, 1)
    }
    ///Bit 2 - PLL2 Modulation Spread-Spectrum Disable
    #[inline(always)]
    pub fn pll2modssdis(&mut self) -> PLL2MODSSDIS_W<PLL2CFGR3rs> {
        PLL2MODSSDIS_W::new(self, 2)
    }
    ///Bit 3 - PLL2 Modulation Spread-Spectrum (and Fractional Divide) enable
    #[inline(always)]
    pub fn pll2moddsen(&mut self) -> PLL2MODDSEN_W<PLL2CFGR3rs> {
        PLL2MODDSEN_W::new(self, 3)
    }
    ///Bit 4 - PLL2 Modulation Down Spread
    #[inline(always)]
    pub fn pll2modsprdw(&mut self) -> PLL2MODSPRDW_W<PLL2CFGR3rs> {
        PLL2MODSPRDW_W::new(self, 4)
    }
    ///Bits 8:11 - PLL2 Modulation Division frequency adjustment
    #[inline(always)]
    pub fn pll2moddiv(&mut self) -> PLL2MODDIV_W<PLL2CFGR3rs> {
        PLL2MODDIV_W::new(self, 8)
    }
    ///Bits 16:20 - PLL2 Modulation Spread depth adjustment
    #[inline(always)]
    pub fn pll2modspr(&mut self) -> PLL2MODSPR_W<PLL2CFGR3rs> {
        PLL2MODSPR_W::new(self, 16)
    }
    ///Bits 24:26 - PLL2 VCO frequency divider level 2
    #[inline(always)]
    pub fn pll2pdiv2(&mut self) -> PLL2PDIV2_W<PLL2CFGR3rs> {
        PLL2PDIV2_W::new(self, 24)
    }
    ///Bits 27:29 - PLL2 VCO frequency divider level 1
    #[inline(always)]
    pub fn pll2pdiv1(&mut self) -> PLL2PDIV1_W<PLL2CFGR3rs> {
        PLL2PDIV1_W::new(self, 27)
    }
    ///Bit 30 - PLL2 post divider POSTDIV1, POSTDIV2, and PLL clock output enable
    #[inline(always)]
    pub fn pll2pdiven(&mut self) -> PLL2PDIVEN_W<PLL2CFGR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:PLL2CFGR3)*/
