...
impl W {
    ///Bit 0 - Defines the privilege protection of the PLL1 PLL configuration bits.
    #[inline(always)]
    pub fn pll1pv(&mut self) -> PLL1PV_W<PRIVCFGR1rs> {
        PLL1PV_W::new(self, 0)
    }
    ///Bit 1 - Defines the privilege protection of the PLL2 PLL configuration bits.
    #[inline(always)]
    pub fn pll2pv(&mut self) -> PLL2PV_W<PRIVCFGR1rs> {
        PLL2PV_W::new(self, 1)
    }
    ///Bit 2 - Defines the privilege protection of the PLL3 PLL configuration bits.
    #[inline(always)]
    pub fn pll3pv(&mut self) -> PLL3PV_W<PRIVCFGR1rs> {
        PLL3PV_W::new(self, 2)
    }
    ///Bit 3 - Defines the privilege protection of the PLL4 PLL configuration bits.
    #[inline(always)]
    pub fn pll4pv(&mut self) -> PLL4PV_W<PRIVCFGR1rs> {
        PLL4PV_W::new(self, 3)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:PRIVCFGR1)*/
