...
impl W {
    ///Bit 0 - Defines the public protection of the MOD system configuration bits.
    #[inline(always)]
    pub fn modpub(&mut self) -> MODPUB_W<PUBCFGR3rs> {
        MODPUB_W::new(self, 0)
    }
    ///Bit 1 - Defines the public protection of the SYS system configuration bits.
    #[inline(always)]
    pub fn syspub(&mut self) -> SYSPUB_W<PUBCFGR3rs> {
        SYSPUB_W::new(self, 1)
    }
    ///Bit 2 - Defines the public protection of the BUS system configuration bits.
    #[inline(always)]
    pub fn buspub(&mut self) -> BUSPUB_W<PUBCFGR3rs> {
        BUSPUB_W::new(self, 2)
    }
    ///Bit 3 - Defines the public protection of the PER system configuration bits.
    #[inline(always)]
    pub fn perpub(&mut self) -> PERPUB_W<PUBCFGR3rs> {
        PERPUB_W::new(self, 3)
    }
    ///Bit 4 - Defines the public protection of the INT system configuration bits.
    #[inline(always)]
    pub fn intpub(&mut self) -> INTPUB_W<PUBCFGR3rs> {
        INTPUB_W::new(self, 4)
    }
    ///Bit 5 - Defines the public protection of the RST system configuration bits.
    #[inline(always)]
    pub fn rstpub(&mut self) -> RSTPUB_W<PUBCFGR3rs> {
        RSTPUB_W::new(self, 5)
    }
    ///Bit 6 - Defines the public protection of the DFT system configuration bits.
    #[inline(always)]
    pub fn dftpub(&mut self) -> DFTPUB_W<PUBCFGR3rs> {
        DFTPUB_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RCC:PUBCFGR3)*/
