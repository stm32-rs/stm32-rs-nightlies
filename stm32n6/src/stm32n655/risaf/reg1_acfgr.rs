///Register `REG1_ACFGR` reader
pub type R = crate::R<REG1_ACFGRrs>;
///Register `REG1_ACFGR` writer
pub type W = crate::W<REG1_ACFGRrs>;
...
impl W {
    ///Bit 0 - subregion enable
    #[inline(always)]
    pub fn sren(&mut self) -> SREN_W<'_, REG1_ACFGRrs> {
        SREN_W::new(self, 0)
    }
    ///Bit 1 - resource lock
    #[inline(always)]
    pub fn rlock(&mut self) -> RLOCK_W<'_, REG1_ACFGRrs> {
        RLOCK_W::new(self, 1)
    }
    ///Bits 4:6 - subregion CID
    #[inline(always)]
    pub fn srcid(&mut self) -> SRCID_W<'_, REG1_ACFGRrs> {
        SRCID_W::new(self, 4)
    }
    ///Bit 8 - secure subregion
    #[inline(always)]
    pub fn sec(&mut self) -> SEC_W<'_, REG1_ACFGRrs> {
        SEC_W::new(self, 8)
    }
    ///Bit 9 - privileged subregion
    #[inline(always)]
    pub fn priv_(&mut self) -> PRIV_W<'_, REG1_ACFGRrs> {
        PRIV_W::new(self, 9)
    }
    ///Bit 12 - read enable
    #[inline(always)]
    pub fn rden(&mut self) -> RDEN_W<'_, REG1_ACFGRrs> {
        RDEN_W::new(self, 12)
    }
    ///Bit 13 - write enable
    #[inline(always)]
    pub fn wren(&mut self) -> WREN_W<'_, REG1_ACFGRrs> {
        WREN_W::new(self, 13)
    }
}
/**RISAF region 1 subregion A configuration register

You can [`read`](crate::Reg::read) this register and get [`reg1_acfgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`reg1_acfgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RISAF:REG1_ACFGR)*/
pub struct REG1_ACFGRrs;
impl crate::RegisterSpec for REG1_ACFGRrs {
    type Ux = u32;
}
///`read()` method returns [`reg1_acfgr::R`](R) reader structure
impl crate::Readable for REG1_ACFGRrs {}
///`write(|w| ..)` method takes [`reg1_acfgr::W`](W) writer structure
impl crate::Writable for REG1_ACFGRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets REG1_ACFGR to value 0
impl crate::Resettable for REG1_ACFGRrs {}
