///Register `REG1_CFGR` reader
pub type R = crate::R<REG1_CFGRrs>;
///Register `REG1_CFGR` writer
pub type W = crate::W<REG1_CFGRrs>;
...
impl W {
    ///Bit 0 - base region enable
    #[inline(always)]
    pub fn bren(&mut self) -> BREN_W<'_, REG1_CFGRrs> {
        BREN_W::new(self, 0)
    }
    ///Bit 8 - secure region
    #[inline(always)]
    pub fn sec(&mut self) -> SEC_W<'_, REG1_CFGRrs> {
        SEC_W::new(self, 8)
    }
    ///Bit 16 - privileged access for compartment y
    #[inline(always)]
    pub fn privc0(&mut self) -> PRIVC0_W<'_, REG1_CFGRrs> {
        PRIVC0_W::new(self, 16)
    }
    ///Bit 17 - privileged access for compartment y
    #[inline(always)]
    pub fn privc1(&mut self) -> PRIVC1_W<'_, REG1_CFGRrs> {
        PRIVC1_W::new(self, 17)
    }
    ///Bit 18 - privileged access for compartment y
    #[inline(always)]
    pub fn privc2(&mut self) -> PRIVC2_W<'_, REG1_CFGRrs> {
        PRIVC2_W::new(self, 18)
    }
    ///Bit 19 - privileged access for compartment y
    #[inline(always)]
    pub fn privc3(&mut self) -> PRIVC3_W<'_, REG1_CFGRrs> {
        PRIVC3_W::new(self, 19)
    }
    ///Bit 20 - privileged access for compartment y
    #[inline(always)]
    pub fn privc4(&mut self) -> PRIVC4_W<'_, REG1_CFGRrs> {
        PRIVC4_W::new(self, 20)
    }
    ///Bit 21 - privileged access for compartment y
    #[inline(always)]
    pub fn privc5(&mut self) -> PRIVC5_W<'_, REG1_CFGRrs> {
        PRIVC5_W::new(self, 21)
    }
    ///Bit 22 - privileged access for compartment y
    #[inline(always)]
    pub fn privc6(&mut self) -> PRIVC6_W<'_, REG1_CFGRrs> {
        PRIVC6_W::new(self, 22)
    }
    ///Bit 23 - privileged access for compartment y
    #[inline(always)]
    pub fn privc7(&mut self) -> PRIVC7_W<'_, REG1_CFGRrs> {
        PRIVC7_W::new(self, 23)
    }
}
/**RISAF region 1 configuration register

You can [`read`](crate::Reg::read) this register and get [`reg1_cfgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`reg1_cfgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#RISAF:REG1_CFGR)*/
pub struct REG1_CFGRrs;
impl crate::RegisterSpec for REG1_CFGRrs {
    type Ux = u32;
}
///`read()` method returns [`reg1_cfgr::R`](R) reader structure
impl crate::Readable for REG1_CFGRrs {}
///`write(|w| ..)` method takes [`reg1_cfgr::W`](W) writer structure
impl crate::Writable for REG1_CFGRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets REG1_CFGR to value 0
impl crate::Resettable for REG1_CFGRrs {}
