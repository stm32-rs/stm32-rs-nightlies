...
impl W {
    ///Bit 0 - Retiming on Rx path
    #[inline(always)]
    pub fn cfg_retime_rx(&mut self) -> CFG_RETIME_RX_W<FMC_RETIMECRrs> {
        CFG_RETIME_RX_W::new(self, 0)
    }
    ///Bit 1 - Retiming on Tx path
    #[inline(always)]
    pub fn cfg_retime_tx(&mut self) -> CFG_RETIME_TX_W<FMC_RETIMECRrs> {
        CFG_RETIME_TX_W::new(self, 1)
    }
    ///Bit 2 - Delay on feedback clock
    #[inline(always)]
    pub fn sdfbclk_180(&mut self) -> SDFBCLK_180_W<FMC_RETIMECRrs> {
