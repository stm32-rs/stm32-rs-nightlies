///Register `VDDIO2CCCR` reader
pub type R = crate::R<VDDIO2CCCRrs>;
///Register `VDDIO2CCCR` writer
pub type W = crate::W<VDDIO2CCCRrs>;
...
impl W {
    ///Bits 0:3 - These bits are written by software to define an I/O compensation code for NMOS transistors. This code is applied to the I/O compensation cell when the CS = 1.
    #[inline(always)]
    pub fn ransrc(&mut self) -> RANSRC_W<'_, VDDIO2CCCRrs> {
        RANSRC_W::new(self, 0)
    }
    ///Bits 4:7 - These bits are written by software to define an I/O compensation code for PMOS transistors. This code is applied to the I/O compensation cell when CS = 1.
    #[inline(always)]
    pub fn rapsrc(&mut self) -> RAPSRC_W<'_, VDDIO2CCCRrs> {
        RAPSRC_W::new(self, 4)
    }
    ///Bit 8 - Enables the compensation cell of I/Os supplied by VDDIOx.
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, VDDIO2CCCRrs> {
        EN_W::new(self, 8)
    }
    ///Bit 9 - Selects the code to be applied for the compensation cell of I/Os supplied by VDDIOx.
    #[inline(always)]
    pub fn cs(&mut self) -> CS_W<'_, VDDIO2CCCRrs> {
        CS_W::new(self, 9)
    }
}
/**SYSCFG VDDIO2 compensation cell control register

You can [`read`](crate::Reg::read) this register and get [`vddio2cccr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vddio2cccr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#SYSCFG:VDDIO2CCCR)*/
pub struct VDDIO2CCCRrs;
impl crate::RegisterSpec for VDDIO2CCCRrs {
    type Ux = u32;
}
///`read()` method returns [`vddio2cccr::R`](R) reader structure
impl crate::Readable for VDDIO2CCCRrs {}
///`write(|w| ..)` method takes [`vddio2cccr::W`](W) writer structure
impl crate::Writable for VDDIO2CCCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets VDDIO2CCCR to value 0
impl crate::Resettable for VDDIO2CCCRrs {}
