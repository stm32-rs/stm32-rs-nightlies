...
impl W {
    ///Bit 0 - Tamper 1 potential mode
    #[inline(always)]
    pub fn tamp1pom(&mut self) -> TAMP1POM_W<CR2rs> {
        TAMP1POM_W::new(self, 0)
    }
    ///Bit 1 - Tamper 2 potential mode
    #[inline(always)]
    pub fn tamp2pom(&mut self) -> TAMP2POM_W<CR2rs> {
        TAMP2POM_W::new(self, 1)
    }
    ///Bit 2 - Tamper 3 potential mode
    #[inline(always)]
    pub fn tamp3pom(&mut self) -> TAMP3POM_W<CR2rs> {
        TAMP3POM_W::new(self, 2)
    }
    ///Bit 3 - Tamper 4 potential mode
    #[inline(always)]
    pub fn tamp4pom(&mut self) -> TAMP4POM_W<CR2rs> {
        TAMP4POM_W::new(self, 3)
    }
    ///Bit 4 - Tamper 5 potential mode
    #[inline(always)]
    pub fn tamp5pom(&mut self) -> TAMP5POM_W<CR2rs> {
        TAMP5POM_W::new(self, 4)
    }
    ///Bit 5 - Tamper 6 potential mode
    #[inline(always)]
    pub fn tamp6pom(&mut self) -> TAMP6POM_W<CR2rs> {
        TAMP6POM_W::new(self, 5)
    }
    ///Bit 6 - Tamper 7 potential mode
    #[inline(always)]
    pub fn tamp7pom(&mut self) -> TAMP7POM_W<CR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N655.html#TAMP:CR2)*/
pub struct CR2rs;
