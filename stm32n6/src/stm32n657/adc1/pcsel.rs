...
///Field `PCSEL` reader - Channel i (Vless thansub>INPless than/sub>\[i\]) preselection
pub type PCSEL_R = crate::FieldReader<u32>;
///Field `PCSEL` writer - Channel i (Vless thansub>INPless than/sub>\[i\]) preselection
pub type PCSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19 - Channel i (Vless thansub>INPless than/sub>\[i\]) preselection
    #[inline(always)]
