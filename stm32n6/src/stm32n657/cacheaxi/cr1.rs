...
impl W {
    ///Bit 0 - enable
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<CR1rs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - full cache invalidation
    #[inline(always)]
    pub fn cacheinv(&mut self) -> CACHEINV_W<CR1rs> {
        CACHEINV_W::new(self, 1)
    }
    ///Bit 16 - read-hit monitor enable
    #[inline(always)]
    pub fn rhitmen(&mut self) -> RHITMEN_W<CR1rs> {
        RHITMEN_W::new(self, 16)
    }
    ///Bit 17 - read-miss monitor enable
    #[inline(always)]
    pub fn rmissmen(&mut self) -> RMISSMEN_W<CR1rs> {
        RMISSMEN_W::new(self, 17)
    }
    ///Bit 18 - read-hit monitor reset
    #[inline(always)]
    pub fn rhitmrst(&mut self) -> RHITMRST_W<CR1rs> {
        RHITMRST_W::new(self, 18)
    }
    ///Bit 19 - read-miss monitor reset
    #[inline(always)]
    pub fn rmissmrst(&mut self) -> RMISSMRST_W<CR1rs> {
        RMISSMRST_W::new(self, 19)
    }
    ///Bit 20 - write-hit monitor enable
    #[inline(always)]
    pub fn whitmen(&mut self) -> WHITMEN_W<CR1rs> {
        WHITMEN_W::new(self, 20)
    }
    ///Bit 21 - write-miss monitor enable
    #[inline(always)]
    pub fn wmissmen(&mut self) -> WMISSMEN_W<CR1rs> {
        WMISSMEN_W::new(self, 21)
    }
    ///Bit 22 - write-hit monitor reset
    #[inline(always)]
    pub fn whitmrst(&mut self) -> WHITMRST_W<CR1rs> {
        WHITMRST_W::new(self, 22)
    }
    ///Bit 23 - write-miss monitor reset
    #[inline(always)]
    pub fn wmissmrst(&mut self) -> WMISSMRST_W<CR1rs> {
        WMISSMRST_W::new(self, 23)
    }
    ///Bit 24 - read-allocate miss monitor enable
    #[inline(always)]
    pub fn rammen(&mut self) -> RAMMEN_W<CR1rs> {
        RAMMEN_W::new(self, 24)
    }
    ///Bit 25 - write-allocate miss monitor enable
    #[inline(always)]
    pub fn wammen(&mut self) -> WAMMEN_W<CR1rs> {
        WAMMEN_W::new(self, 25)
    }
    ///Bit 26 - read-allocate miss monitor reset
    #[inline(always)]
    pub fn rammrst(&mut self) -> RAMMRST_W<CR1rs> {
        RAMMRST_W::new(self, 26)
    }
    ///Bit 27 - write-allocate miss monitor reset
    #[inline(always)]
    pub fn wammrst(&mut self) -> WAMMRST_W<CR1rs> {
        WAMMRST_W::new(self, 27)
    }
    ///Bit 28 - write-through monitor enable
    #[inline(always)]
    pub fn wtmen(&mut self) -> WTMEN_W<CR1rs> {
        WTMEN_W::new(self, 28)
    }
    ///Bit 29 - eviction monitor enable
    #[inline(always)]
    pub fn evimen(&mut self) -> EVIMEN_W<CR1rs> {
        EVIMEN_W::new(self, 29)
    }
    ///Bit 30 - write-through monitor reset
    #[inline(always)]
    pub fn wtmrst(&mut self) -> WTMRST_W<CR1rs> {
        WTMRST_W::new(self, 30)
    }
    ///Bit 31 - eviction monitor reset
    #[inline(always)]
    pub fn evimrst(&mut self) -> EVIMRST_W<CR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#CACHEAXI:CR1)*/
pub struct CR1rs;
