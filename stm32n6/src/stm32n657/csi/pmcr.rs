...
impl W {
    ///Bit 0 - Force to Rx mode the data lane 0
    #[inline(always)]
    pub fn frxmdl0(&mut self) -> FRXMDL0_W<PMCRrs> {
        FRXMDL0_W::new(self, 0)
    }
    ///Bit 1 - Force to Rx mode the data lane 1
    #[inline(always)]
    pub fn frxmdl1(&mut self) -> FRXMDL1_W<PMCRrs> {
        FRXMDL1_W::new(self, 1)
    }
    ///Bit 2 - Force to Tx Stop mode the data lane 0
    #[inline(always)]
    pub fn ftxsmdl0(&mut self) -> FTXSMDL0_W<PMCRrs> {
        FTXSMDL0_W::new(self, 2)
    }
    ///Bit 4 - Disable turn-around data lane 0
    #[inline(always)]
    pub fn dtdl(&mut self) -> DTDL_W<PMCRrs> {
        DTDL_W::new(self, 4)
    }
    ///Bit 8 - Turn-around request data lane 0
    #[inline(always)]
    pub fn rtdl0(&mut self) -> RTDL0_W<PMCRrs> {
        RTDL0_W::new(self, 8)
    }
    ///Bit 12 - Tx ULP escape-mode data lane 0
    #[inline(always)]
    pub fn tuesdl0(&mut self) -> TUESDL0_W<PMCRrs> {
        TUESDL0_W::new(self, 12)
    }
    ///Bit 16 - Tx ULP exit sequence data lane 0
    #[inline(always)]
    pub fn tuexdl0(&mut self) -> TUEXDL0_W<PMCRrs> {
