...
impl W {
    ///Bit 0 - All data types enable for the virtual channel x
    #[inline(always)]
    pub fn alldt(&mut self) -> ALLDT_W<VC0CFGR1rs> {
        ALLDT_W::new(self, 0)
    }
    ///Bit 1 - Data type 0 enable
    #[inline(always)]
    pub fn dt0en(&mut self) -> DT0EN_W<VC0CFGR1rs> {
        DT0EN_W::new(self, 1)
    }
    ///Bit 2 - Data type 1 enable
    #[inline(always)]
    pub fn dt1en(&mut self) -> DT1EN_W<VC0CFGR1rs> {
        DT1EN_W::new(self, 2)
    }
    ///Bit 3 - Data type 2 enable
    #[inline(always)]
    pub fn dt2en(&mut self) -> DT2EN_W<VC0CFGR1rs> {
        DT2EN_W::new(self, 3)
    }
    ///Bit 4 - Data type 3 enable
    #[inline(always)]
    pub fn dt3en(&mut self) -> DT3EN_W<VC0CFGR1rs> {
        DT3EN_W::new(self, 4)
    }
    ///Bit 5 - Data type 4 enable
    #[inline(always)]
    pub fn dt4en(&mut self) -> DT4EN_W<VC0CFGR1rs> {
        DT4EN_W::new(self, 5)
    }
    ///Bit 6 - Data type 5 enable
    #[inline(always)]
    pub fn dt5en(&mut self) -> DT5EN_W<VC0CFGR1rs> {
        DT5EN_W::new(self, 6)
    }
    ///Bit 7 - Data type 6 enable
    #[inline(always)]
    pub fn dt6en(&mut self) -> DT6EN_W<VC0CFGR1rs> {
        DT6EN_W::new(self, 7)
    }
    ///Bits 8:12 - Common format for all data types
    #[inline(always)]
    pub fn cdtft(&mut self) -> CDTFT_W<VC0CFGR1rs> {
        CDTFT_W::new(self, 8)
    }
    ///Bits 16:21 - Data type 0 class selection for virtual channel x
    #[inline(always)]
    pub fn dt0(&mut self) -> DT0_W<VC0CFGR1rs> {
        DT0_W::new(self, 16)
    }
    ///Bits 24:28 - Data type 0 format
    #[inline(always)]
    pub fn dt0ft(&mut self) -> DT0FT_W<VC0CFGR1rs> {
        DT0FT_W::new(self, 24)
    }
}
