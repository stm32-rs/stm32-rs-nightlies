...
impl W {
    ///Bit 8 - I2C4 stop in debug
    #[inline(always)]
    pub fn dbg_i2c4_stop(&mut self) -> DBG_I2C4_STOP_W<APB4FZ1rs> {
        DBG_I2C4_STOP_W::new(self, 8)
    }
    ///Bit 9 - LPTIM2 stop in debug
    #[inline(always)]
    pub fn dbg_lptim2_stop(&mut self) -> DBG_LPTIM2_STOP_W<APB4FZ1rs> {
        DBG_LPTIM2_STOP_W::new(self, 9)
    }
    ///Bit 10 - LPTIM3 stop in debug
    #[inline(always)]
    pub fn dbg_lptim3_stop(&mut self) -> DBG_LPTIM3_STOP_W<APB4FZ1rs> {
        DBG_LPTIM3_STOP_W::new(self, 10)
    }
    ///Bit 11 - LPTIM4 stop in debug
    #[inline(always)]
    pub fn dbg_lptim4_stop(&mut self) -> DBG_LPTIM4_STOP_W<APB4FZ1rs> {
        DBG_LPTIM4_STOP_W::new(self, 11)
    }
    ///Bit 12 - LPTIM5 stop in debug
    #[inline(always)]
    pub fn dbg_lptim5_stop(&mut self) -> DBG_LPTIM5_STOP_W<APB4FZ1rs> {
        DBG_LPTIM5_STOP_W::new(self, 12)
    }
    ///Bit 16 - RTC clock is suspended in debug
    #[inline(always)]
    pub fn dbg_rtc_stop(&mut self) -> DBG_RTC_STOP_W<APB4FZ1rs> {
        DBG_RTC_STOP_W::new(self, 16)
    }
    ///Bit 18 - WWDG stop in debug
    #[inline(always)]
    pub fn dbg_iwdg_stop(&mut self) -> DBG_IWDG_STOP_W<APB4FZ1rs> {
