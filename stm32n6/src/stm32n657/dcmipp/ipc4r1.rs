///Register `IPC4R1` reader
pub type R = crate::R<IPC4R1rs>;
///Register `IPC4R1` writer
pub type W = crate::W<IPC4R1rs>;
...
impl W {
    ///Bits 0:2 - Burst size as power of 2 of 8-byte units
    #[inline(always)]
    pub fn traffic(&mut self) -> TRAFFIC_W<'_, IPC4R1rs> {
        TRAFFIC_W::new(self, 0)
    }
    ///Bits 8:11 - Maximum outstanding transactions
    #[inline(always)]
    pub fn otr(&mut self) -> OTR_W<'_, IPC4R1rs> {
        OTR_W::new(self, 8)
    }
}
/**DCMIPP IPPLUG Clientx register 1

You can [`read`](crate::Reg::read) this register and get [`ipc4r1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ipc4r1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#DCMIPP:IPC4R1)*/
pub struct IPC4R1rs;
impl crate::RegisterSpec for IPC4R1rs {
    type Ux = u32;
}
///`read()` method returns [`ipc4r1::R`](R) reader structure
impl crate::Readable for IPC4R1rs {}
///`write(|w| ..)` method takes [`ipc4r1::W`](W) writer structure
impl crate::Writable for IPC4R1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets IPC4R1 to value 0x04
impl crate::Resettable for IPC4R1rs {
