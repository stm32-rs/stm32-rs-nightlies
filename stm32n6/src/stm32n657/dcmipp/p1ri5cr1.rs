///Register `P1RI5CR1` reader
pub type R = crate::R<P1RI5CR1rs>;
///Register `P1RI5CR1` writer
pub type W = crate::W<P1RI5CR1rs>;
...
impl W {
    ///Bits 0:11 - Horizontal start, from 0 to 4094 pixels wide
    #[inline(always)]
    pub fn hstart(&mut self) -> HSTART_W<'_, P1RI5CR1rs> {
        HSTART_W::new(self, 0)
    }
    ///Bits 12:13 - Color line blue
    #[inline(always)]
    pub fn clb(&mut self) -> CLB_W<'_, P1RI5CR1rs> {
        CLB_W::new(self, 12)
    }
    ///Bits 14:15 - Color line green
    #[inline(always)]
    pub fn clg(&mut self) -> CLG_W<'_, P1RI5CR1rs> {
        CLG_W::new(self, 14)
    }
    ///Bits 16:27 - Vertical start, from 0 to 4094 pixels high
    #[inline(always)]
    pub fn vstart(&mut self) -> VSTART_W<'_, P1RI5CR1rs> {
        VSTART_W::new(self, 16)
    }
    ///Bits 28:29 - Color line red
    #[inline(always)]
    pub fn clr(&mut self) -> CLR_W<'_, P1RI5CR1rs> {
        CLR_W::new(self, 28)
    }
}
/**DCMIPP Pipe1 ROI5 configuration register 1

You can [`read`](crate::Reg::read) this register and get [`p1ri5cr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1ri5cr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#DCMIPP:P1RI5CR1)*/
pub struct P1RI5CR1rs;
impl crate::RegisterSpec for P1RI5CR1rs {
    type Ux = u32;
}
///`read()` method returns [`p1ri5cr1::R`](R) reader structure
impl crate::Readable for P1RI5CR1rs {}
///`write(|w| ..)` method takes [`p1ri5cr1::W`](W) writer structure
impl crate::Writable for P1RI5CR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P1RI5CR1 to value 0
impl crate::Resettable for P1RI5CR1rs {}
