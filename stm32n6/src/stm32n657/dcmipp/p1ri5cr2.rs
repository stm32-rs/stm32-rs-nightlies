///Register `P1RI5CR2` reader
pub type R = crate::R<P1RI5CR2rs>;
///Register `P1RI5CR2` writer
pub type W = crate::W<P1RI5CR2rs>;
...
impl W {
    ///Bits 0:11 - Horizontal size, from 0 to 4094 pixels wide
    #[inline(always)]
    pub fn hsize(&mut self) -> HSIZE_W<'_, P1RI5CR2rs> {
        HSIZE_W::new(self, 0)
    }
    ///Bits 16:27 - Vertical size, from 0 to 4094 pixels high
    #[inline(always)]
    pub fn vsize(&mut self) -> VSIZE_W<'_, P1RI5CR2rs> {
        VSIZE_W::new(self, 16)
    }
}
/**DCMIPP Pipe1 ROI5 configuration register 2

You can [`read`](crate::Reg::read) this register and get [`p1ri5cr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1ri5cr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#DCMIPP:P1RI5CR2)*/
pub struct P1RI5CR2rs;
impl crate::RegisterSpec for P1RI5CR2rs {
    type Ux = u32;
}
///`read()` method returns [`p1ri5cr2::R`](R) reader structure
impl crate::Readable for P1RI5CR2rs {}
///`write(|w| ..)` method takes [`p1ri5cr2::W`](W) writer structure
impl crate::Writable for P1RI5CR2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P1RI5CR2 to value 0
impl crate::Resettable for P1RI5CR2rs {}
