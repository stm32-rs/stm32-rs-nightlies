...
///Field `BLUE` reader - Blue value for the A4 or A8 mode of the foreground image
pub type BLUE_R = crate::FieldReader;
///Field `BLUE` writer - Blue value for the A4 or A8 mode of the foreground image
pub type BLUE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GREEN` reader - Green value for the A4 or A8 mode of the foreground image
pub type GREEN_R = crate::FieldReader;
///Field `GREEN` writer - Green value for the A4 or A8 mode of the foreground image
pub type GREEN_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `RED` reader - Red value for the A4 or A8 mode of the foreground image
pub type RED_R = crate::FieldReader;
///Field `RED` writer - Red value for the A4 or A8 mode of the foreground image
pub type RED_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - Blue value for the A4 or A8 mode of the foreground image
    #[inline(always)]
    pub fn blue(&self) -> BLUE_R {
        BLUE_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - Green value for the A4 or A8 mode of the foreground image
    #[inline(always)]
    pub fn green(&self) -> GREEN_R {
        GREEN_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - Red value for the A4 or A8 mode of the foreground image
    #[inline(always)]
