...
impl W {
    ///Bit 0 - Fault IRQ enable bit
    #[inline(always)]
    pub fn irq_en_fault(&mut self) -> IRQ_EN_FAULT_W<TS0_IERrs> {
        IRQ_EN_FAULT_W::new(self, 0)
    }
    ///Bit 1 - Sample done IRQ enable bit
    #[inline(always)]
    pub fn irq_en_done(&mut self) -> IRQ_EN_DONE_W<TS0_IERrs> {
        IRQ_EN_DONE_W::new(self, 1)
    }
    ///Bit 3 - Alarm A IRQ enable bit
    #[inline(always)]
    pub fn irq_en_alarma(&mut self) -> IRQ_EN_ALARMA_W<TS0_IERrs> {
        IRQ_EN_ALARMA_W::new(self, 3)
    }
    ///Bit 4 - Alarm B IRQ enable bit
    #[inline(always)]
    pub fn irq_en_alarmb(&mut self) -> IRQ_EN_ALARMB_W<TS0_IERrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#DTS:TS0_IER)*/
