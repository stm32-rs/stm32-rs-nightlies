...
impl W {
    ///Bits 0:15 - Alarm B hysteresis threshold
    #[inline(always)]
    pub fn hystb_thresh(&mut self) -> HYSTB_THRESH_W<TS1ALARMB_CFGRrs> {
        HYSTB_THRESH_W::new(self, 0)
    }
    ///Bits 16:31 - Alarm B threshold
    #[inline(always)]
    pub fn alarmb_thresh(&mut self) -> ALARMB_THRESH_W<TS1ALARMB_CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#DTS:TS1ALARMB_CFGR)*/
