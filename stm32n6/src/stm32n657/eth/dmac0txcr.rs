...
impl W {
    ///Bit 0 - Start or Stop Transmission Command
    #[inline(always)]
    pub fn st(&mut self) -> ST_W<DMAC0TXCRrs> {
        ST_W::new(self, 0)
    }
    ///Bit 4 - Operate on Second Packet
    #[inline(always)]
    pub fn osf(&mut self) -> OSF_W<DMAC0TXCRrs> {
        OSF_W::new(self, 4)
    }
    ///Bit 12 - TCP Segmentation Enabled
    #[inline(always)]
    pub fn tse(&mut self) -> TSE_W<DMAC0TXCRrs> {
        TSE_W::new(self, 12)
    }
    ///Bit 15 - Ignore PBL Requirement
    #[inline(always)]
    pub fn ipbl(&mut self) -> IPBL_W<DMAC0TXCRrs> {
        IPBL_W::new(self, 15)
    }
    ///Bits 16:21 - Transmit Programmable Burst Length
    #[inline(always)]
    pub fn txpbl(&mut self) -> TXPBL_W<DMAC0TXCRrs> {
        TXPBL_W::new(self, 16)
    }
    ///Bits 24:27 - Transmit QOS
    #[inline(always)]
    pub fn tqos(&mut self) -> TQOS_W<DMAC0TXCRrs> {
        TQOS_W::new(self, 24)
    }
    ///Bit 28 - Enhanced Descriptor Enable
    #[inline(always)]
    pub fn edse(&mut self) -> EDSE_W<DMAC0TXCRrs> {
        EDSE_W::new(self, 28)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:DMAC0TXCR)*/
