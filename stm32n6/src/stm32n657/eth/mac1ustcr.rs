...
///Field `TIC_1US_CNTR` reader - 1 s tick Counter
pub type TIC_1US_CNTR_R = crate::FieldReader<u16>;
///Field `TIC_1US_CNTR` writer - 1 s tick Counter
pub type TIC_1US_CNTR_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - 1 s tick Counter
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:MAC1USTCR)*/
