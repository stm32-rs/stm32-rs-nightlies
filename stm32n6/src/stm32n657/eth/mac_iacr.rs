...
impl W {
    ///Bit 0 - Operation Busy.
    #[inline(always)]
    pub fn ob(&mut self) -> OB_W<MAC_IACRrs> {
        OB_W::new(self, 0)
    }
    ///Bit 1 - Command type
    #[inline(always)]
    pub fn com(&mut self) -> COM_W<MAC_IACRrs> {
        COM_W::new(self, 1)
    }
    ///Bit 5 - Auto-increment
    #[inline(always)]
    pub fn auto(&mut self) -> AUTO_W<MAC_IACRrs> {
        AUTO_W::new(self, 5)
    }
    ///Bits 8:15 - Address Offset
    #[inline(always)]
    pub fn aoff(&mut self) -> AOFF_W<MAC_IACRrs> {
        AOFF_W::new(self, 8)
    }
    ///Bits 16:19 - Mode Select
    #[inline(always)]
    pub fn msel(&mut self) -> MSEL_W<MAC_IACRrs> {
        MSEL_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:MAC_IACR)*/
