...
///Field `PS` reader - Port Select
pub type PS_R = crate::BitReader;
///Field `PS` writer - Port Select
...
///Field `BE` reader - Packet Burst Enable
pub type BE_R = crate::BitReader;
///Field `BE` writer - Packet Burst Enable
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:MACCR)*/
pub struct MACCRrs;
