...
///Field `APDIM` reader - ARP Packet Drop if IP Address Mismatch
pub type APDIM_R = crate::BitReader;
///Field `APDIM` writer - ARP Packet Drop if IP Address Mismatch
pub type APDIM_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    ///Bit 30 - ARP Packet Drop if IP Address Mismatch
    #[inline(always)]
    pub fn apdim(&self) -> APDIM_R {
        APDIM_R::new(((self.bits >> 30) & 1) != 0)
    }
}
...
impl W {
    ...
    ///Bit 30 - ARP Packet Drop if IP Address Mismatch
    #[inline(always)]
    pub fn apdim(&mut self) -> APDIM_W<'_, MACECRrs> {
        APDIM_W::new(self, 30)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:MACECR)*/
pub struct MACECRrs;
