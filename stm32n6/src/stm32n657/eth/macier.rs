...
impl W {
    ...
    ///Bit 17 - Frame Preemption Interrupt Enable
    #[inline(always)]
    pub fn fpeie(&mut self) -> FPEIE_W<'_, MACIERrs> {
        FPEIE_W::new(self, 17)
    }
    ///Bit 18 - MDIO Interrupt Enable
    #[inline(always)]
    pub fn mdioie(&mut self) -> MDIOIE_W<'_, MACIERrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:MACIER)*/
pub struct MACIERrs;
