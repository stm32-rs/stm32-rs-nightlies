...
impl W {
    ///Bit 0 - Unicast Address Filter Fail Packets Queuing Enable.
    #[inline(always)]
    pub fn uffqe(&mut self) -> UFFQE_W<MACRXQCRrs> {
        UFFQE_W::new(self, 0)
    }
    ///Bit 1 - Unicast Address Filter Fail Packets Queue.
    #[inline(always)]
    pub fn uffq(&mut self) -> UFFQ_W<MACRXQCRrs> {
        UFFQ_W::new(self, 1)
    }
    ///Bit 8 - Multicast Address Filter Fail Packets Queuing Enable.
    #[inline(always)]
    pub fn mffqe(&mut self) -> MFFQE_W<MACRXQCRrs> {
        MFFQE_W::new(self, 8)
    }
    ///Bit 9 - Multicast Address Filter Fail Packets Queue.
    #[inline(always)]
    pub fn mffq(&mut self) -> MFFQ_W<MACRXQCRrs> {
        MFFQ_W::new(self, 9)
    }
    ///Bit 16 - VLAN Tag Filter Fail Packets Queuing Enable
    #[inline(always)]
    pub fn vffqe(&mut self) -> VFFQE_W<MACRXQCRrs> {
        VFFQE_W::new(self, 16)
    }
    ///Bit 17 - VLAN Tag Filter Fail Packets Queue
    #[inline(always)]
    pub fn vffq(&mut self) -> VFFQ_W<MACRXQCRrs> {
        VFFQ_W::new(self, 17)
    }
}
