...
impl W {
    ...
    ///Bit 21 - Channel based tag insertion
    #[inline(always)]
    pub fn cbti(&mut self) -> CBTI_W<MACVIRrs> {
        CBTI_W::new(self, 21)
    }
    ///Bit 24 - Address
    #[inline(always)]
    pub fn addr(&mut self) -> ADDR_W<MACVIRrs> {
        ADDR_W::new(self, 24)
    }
    ///Bit 30 - Read write control
    #[inline(always)]
    pub fn rdwr(&mut self) -> RDWR_W<MACVIRrs> {
        RDWR_W::new(self, 30)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:MACVIR)*/
pub struct MACVIRrs;
