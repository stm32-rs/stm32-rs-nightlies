...
///Field `TXSCOLGPIS` writer - MMC Transmit Single Collision Good Packet Counter Interrupt Status
...
///Field `TXMCOLGPIS` writer - MMC Transmit Multiple Collision Good Packet Counter Interrupt Status
...
///Field `TXGPKTIS` writer - MMC Transmit Good Packet Counter Interrupt Status
...
///Field `TXLPIUSCIS` writer - MMC Transmit LPI microsecond counter interrupt status
...
///Field `TXLPITRCIS` writer - MMC Transmit LPI transition counter interrupt status
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:MMC_TX_INTERRUPT)*/
