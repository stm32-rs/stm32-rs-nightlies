...
impl W {
    ///Bit 0 - Interrupt Enable for Switch List
    #[inline(always)]
    pub fn iecc(&mut self) -> IECC_W<MTLESTIERrs> {
        IECC_W::new(self, 0)
    }
    ///Bit 1 - Interrupt Enable for BTR Error
    #[inline(always)]
    pub fn iebe(&mut self) -> IEBE_W<MTLESTIERrs> {
        IEBE_W::new(self, 1)
    }
    ///Bit 2 - Interrupt Enable for HLBF
    #[inline(always)]
    pub fn iehf(&mut self) -> IEHF_W<MTLESTIERrs> {
        IEHF_W::new(self, 2)
    }
    ///Bit 3 - Interrupt Enable for HLBS
    #[inline(always)]
    pub fn iehs(&mut self) -> IEHS_W<MTLESTIERrs> {
        IEHS_W::new(self, 3)
    }
    ///Bit 4 - Interrupt Enable for CGCE
    #[inline(always)]
    pub fn cgce(&mut self) -> CGCE_W<MTLESTIERrs> {
        CGCE_W::new(self, 4)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:MTLESTIER)*/
