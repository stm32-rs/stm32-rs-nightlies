///Register `MTLRXQ1OMR` reader
pub type R = crate::R<MTLRXQ1OMRrs>;
///Register `MTLRXQ1OMR` writer
pub type W = crate::W<MTLRXQ1OMRrs>;
...
impl W {
    ///Bits 0:1 - Receive Queue Threshold Control
    #[inline(always)]
    pub fn rtc(&mut self) -> RTC_W<'_, MTLRXQ1OMRrs> {
        RTC_W::new(self, 0)
    }
    ///Bit 3 - Forward Undersized Good Packets
    #[inline(always)]
    pub fn fup(&mut self) -> FUP_W<'_, MTLRXQ1OMRrs> {
        FUP_W::new(self, 3)
    }
    ///Bit 4 - Forward Error Packets
    #[inline(always)]
    pub fn fep(&mut self) -> FEP_W<'_, MTLRXQ1OMRrs> {
        FEP_W::new(self, 4)
    }
    ///Bit 5 - Receive Queue Store and Forward
    #[inline(always)]
    pub fn rsf(&mut self) -> RSF_W<'_, MTLRXQ1OMRrs> {
        RSF_W::new(self, 5)
    }
    ///Bit 6 - Disable Dropping of TCP/IP Checksum Error Packets
    #[inline(always)]
    pub fn dis_tcp_ef(&mut self) -> DIS_TCP_EF_W<'_, MTLRXQ1OMRrs> {
        DIS_TCP_EF_W::new(self, 6)
    }
    ///Bit 7 - Enable Hardware Flow Control
    #[inline(always)]
    pub fn ehfc(&mut self) -> EHFC_W<'_, MTLRXQ1OMRrs> {
        EHFC_W::new(self, 7)
    }
    ///Bits 8:10 - Threshold for Activating Flow Control (in Half-duplex and Full-duplex)
    #[inline(always)]
    pub fn rfa(&mut self) -> RFA_W<'_, MTLRXQ1OMRrs> {
        RFA_W::new(self, 8)
    }
    ///Bits 14:16 - Threshold for Deactivating Flow Control (in Half-duplex and Full-duplex modes)
    #[inline(always)]
    pub fn rfd(&mut self) -> RFD_W<'_, MTLRXQ1OMRrs> {
        RFD_W::new(self, 14)
    }
    ///Bits 20:23 - Receive Queue Size
    #[inline(always)]
    pub fn rqs(&mut self) -> RQS_W<'_, MTLRXQ1OMRrs> {
        RQS_W::new(self, 20)
    }
}
/**R1 queue 1 operating mode register

You can [`read`](crate::Reg::read) this register and get [`mtlrxq1omr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mtlrxq1omr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#ETH:MTLRXQ1OMR)*/
pub struct MTLRXQ1OMRrs;
impl crate::RegisterSpec for MTLRXQ1OMRrs {
    type Ux = u32;
}
///`read()` method returns [`mtlrxq1omr::R`](R) reader structure
impl crate::Readable for MTLRXQ1OMRrs {}
///`write(|w| ..)` method takes [`mtlrxq1omr::W`](W) writer structure
impl crate::Writable for MTLRXQ1OMRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MTLRXQ1OMR to value 0
impl crate::Resettable for MTLRXQ1OMRrs {}
