...
impl W {
    ///Bit 2 - configurable event input 66 falling edge pending bit
    #[inline(always)]
    pub fn fpif66(&mut self) -> FPIF66_W<FPR3rs> {
        FPIF66_W::new(self, 2)
    }
    ///Bit 4 - configurable event input x falling edge pending bit
    #[inline(always)]
    pub fn fpif68(&mut self) -> FPIF68_W<FPR3rs> {
        FPIF68_W::new(self, 4)
    }
    ///Bit 5 - configurable event input x falling edge pending bit
    #[inline(always)]
    pub fn fpif69(&mut self) -> FPIF69_W<FPR3rs> {
        FPIF69_W::new(self, 5)
    }
    ///Bit 6 - configurable event input x falling edge pending bit
    #[inline(always)]
    pub fn fpif70(&mut self) -> FPIF70_W<FPR3rs> {
        FPIF70_W::new(self, 6)
    }
    ///Bit 7 - configurable event input x falling edge pending bit
    #[inline(always)]
    pub fn fpif71(&mut self) -> FPIF71_W<FPR3rs> {
        FPIF71_W::new(self, 7)
    }
    ///Bit 8 - configurable event input x falling edge pending bit
    #[inline(always)]
    pub fn fpif72(&mut self) -> FPIF72_W<FPR3rs> {
        FPIF72_W::new(self, 8)
    }
    ///Bit 9 - configurable event input x falling edge pending bit
    #[inline(always)]
    pub fn fpif73(&mut self) -> FPIF73_W<FPR3rs> {
        FPIF73_W::new(self, 9)
    }
    ///Bit 10 - configurable event input x falling edge pending bit
    #[inline(always)]
    pub fn fpif74(&mut self) -> FPIF74_W<FPR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#EXTI:FPR3)*/
pub struct FPR3rs;
