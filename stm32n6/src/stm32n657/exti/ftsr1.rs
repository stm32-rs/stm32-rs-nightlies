...
///Field `FT20` reader - Falling trigger event configuration bit of configurable event input x
pub type FT20_R = crate::BitReader;
///Field `FT20` writer - Falling trigger event configuration bit of configurable event input x
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#EXTI:FTSR1)*/
pub struct FTSR1rs;
