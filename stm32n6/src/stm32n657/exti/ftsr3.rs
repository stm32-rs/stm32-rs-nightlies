...
impl W {
    ///Bit 2 - Falling trigger event configuration bit of configurable event input 66
    #[inline(always)]
    pub fn ft66(&mut self) -> FT66_W<FTSR3rs> {
        FT66_W::new(self, 2)
    }
    ///Bit 4 - Falling trigger event configuration bit of configurable event input x
    #[inline(always)]
    pub fn ft68(&mut self) -> FT68_W<FTSR3rs> {
        FT68_W::new(self, 4)
    }
    ///Bit 5 - Falling trigger event configuration bit of configurable event input x
    #[inline(always)]
    pub fn ft69(&mut self) -> FT69_W<FTSR3rs> {
        FT69_W::new(self, 5)
    }
    ///Bit 6 - Falling trigger event configuration bit of configurable event input x
    #[inline(always)]
    pub fn ft70(&mut self) -> FT70_W<FTSR3rs> {
        FT70_W::new(self, 6)
    }
    ///Bit 7 - Falling trigger event configuration bit of configurable event input x
    #[inline(always)]
    pub fn ft71(&mut self) -> FT71_W<FTSR3rs> {
        FT71_W::new(self, 7)
    }
    ///Bit 8 - Falling trigger event configuration bit of configurable event input x
    #[inline(always)]
    pub fn ft72(&mut self) -> FT72_W<FTSR3rs> {
        FT72_W::new(self, 8)
    }
    ///Bit 9 - Falling trigger event configuration bit of configurable event input x
    #[inline(always)]
    pub fn ft73(&mut self) -> FT73_W<FTSR3rs> {
        FT73_W::new(self, 9)
    }
    ///Bit 10 - Falling trigger event configuration bit of configurable event input x
    #[inline(always)]
    pub fn ft74(&mut self) -> FT74_W<FTSR3rs> {
        FT74_W::new(self, 10)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#EXTI:FTSR3)*/
pub struct FTSR3rs;
