...
impl W {
    ///Bit 2 - configurable event input 66rising edge pending bit
    #[inline(always)]
    pub fn rpif66(&mut self) -> RPIF66_W<RPR3rs> {
        RPIF66_W::new(self, 2)
    }
    ///Bit 4 - configurable event input x rising edge pending bit
    #[inline(always)]
    pub fn rpif68(&mut self) -> RPIF68_W<RPR3rs> {
        RPIF68_W::new(self, 4)
    }
    ///Bit 5 - configurable event input x rising edge pending bit
    #[inline(always)]
    pub fn rpif69(&mut self) -> RPIF69_W<RPR3rs> {
        RPIF69_W::new(self, 5)
    }
    ///Bit 6 - configurable event input x rising edge pending bit
    #[inline(always)]
    pub fn rpif70(&mut self) -> RPIF70_W<RPR3rs> {
        RPIF70_W::new(self, 6)
    }
    ///Bit 7 - configurable event input x rising edge pending bit
    #[inline(always)]
    pub fn rpif71(&mut self) -> RPIF71_W<RPR3rs> {
        RPIF71_W::new(self, 7)
    }
    ///Bit 8 - configurable event input x rising edge pending bit
    #[inline(always)]
    pub fn rpif72(&mut self) -> RPIF72_W<RPR3rs> {
        RPIF72_W::new(self, 8)
    }
    ///Bit 9 - configurable event input x rising edge pending bit
    #[inline(always)]
    pub fn rpif73(&mut self) -> RPIF73_W<RPR3rs> {
        RPIF73_W::new(self, 9)
    }
    ///Bit 10 - configurable event input x rising edge pending bit
    #[inline(always)]
    pub fn rpif74(&mut self) -> RPIF74_W<RPR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#EXTI:RPR3)*/
pub struct RPR3rs;
