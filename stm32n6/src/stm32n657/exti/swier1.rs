...
///Field `SWI20` reader - Software interrupt on event x
pub type SWI20_R = crate::BitReader;
///Field `SWI20` writer - Software interrupt on event x
...
impl R {
    ...
    ///Bit 20 - Software interrupt on event x
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#EXTI:SWIER1)*/
pub struct SWIER1rs;
