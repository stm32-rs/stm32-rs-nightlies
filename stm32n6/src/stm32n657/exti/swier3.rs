...
impl W {
    ///Bit 2 - Software interrupt on event 66
    #[inline(always)]
    pub fn swi66(&mut self) -> SWI66_W<SWIER3rs> {
        SWI66_W::new(self, 2)
    }
    ///Bit 4 - Software interrupt on event x
    #[inline(always)]
    pub fn swi68(&mut self) -> SWI68_W<SWIER3rs> {
        SWI68_W::new(self, 4)
    }
    ///Bit 5 - Software interrupt on event x
    #[inline(always)]
    pub fn swi69(&mut self) -> SWI69_W<SWIER3rs> {
        SWI69_W::new(self, 5)
    }
    ///Bit 6 - Software interrupt on event x
    #[inline(always)]
    pub fn swi70(&mut self) -> SWI70_W<SWIER3rs> {
        SWI70_W::new(self, 6)
    }
    ///Bit 7 - Software interrupt on event x
    #[inline(always)]
    pub fn swi71(&mut self) -> SWI71_W<SWIER3rs> {
        SWI71_W::new(self, 7)
    }
    ///Bit 8 - Software interrupt on event x
    #[inline(always)]
    pub fn swi72(&mut self) -> SWI72_W<SWIER3rs> {
        SWI72_W::new(self, 8)
    }
    ///Bit 9 - Software interrupt on event x
    #[inline(always)]
    pub fn swi73(&mut self) -> SWI73_W<SWIER3rs> {
        SWI73_W::new(self, 9)
    }
    ///Bit 10 - Software interrupt on event x
    #[inline(always)]
    pub fn swi74(&mut self) -> SWI74_W<SWIER3rs> {
        SWI74_W::new(self, 10)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#EXTI:SWIER3)*/
pub struct SWIER3rs;
