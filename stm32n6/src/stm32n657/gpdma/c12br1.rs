///Register `C12BR1` reader
pub type R = crate::R<C12BR1rs>;
///Register `C12BR1` writer
pub type W = crate::W<C12BR1rs>;
...
impl W {
    ///Bits 0:15 - block number of data bytes to transfer from the source
    #[inline(always)]
    pub fn bndt(&mut self) -> BNDT_W<'_, C12BR1rs> {
        BNDT_W::new(self, 0)
    }
    ///Bits 16:26 - Block repeat counter
    #[inline(always)]
    pub fn brc(&mut self) -> BRC_W<'_, C12BR1rs> {
        BRC_W::new(self, 16)
    }
    ///Bit 28 - source address decrement
    #[inline(always)]
    pub fn sdec(&mut self) -> SDEC_W<'_, C12BR1rs> {
        SDEC_W::new(self, 28)
    }
    ///Bit 29 - destination address decrement
    #[inline(always)]
    pub fn ddec(&mut self) -> DDEC_W<'_, C12BR1rs> {
        DDEC_W::new(self, 29)
    }
    ///Bit 30 - Block repeat source address decrement
    #[inline(always)]
    pub fn brsdec(&mut self) -> BRSDEC_W<'_, C12BR1rs> {
        BRSDEC_W::new(self, 30)
    }
    ///Bit 31 - Block repeat destination address decrement
    #[inline(always)]
    pub fn brddec(&mut self) -> BRDDEC_W<'_, C12BR1rs> {
        BRDDEC_W::new(self, 31)
    }
}
/**GPDMA channel 12 alternate block register 1

You can [`read`](crate::Reg::read) this register and get [`c12br1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c12br1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#GPDMA:C12BR1)*/
pub struct C12BR1rs;
impl crate::RegisterSpec for C12BR1rs {
    type Ux = u32;
}
///`read()` method returns [`c12br1::R`](R) reader structure
impl crate::Readable for C12BR1rs {}
///`write(|w| ..)` method takes [`c12br1::W`](W) writer structure
impl crate::Writable for C12BR1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C12BR1 to value 0
impl crate::Resettable for C12BR1rs {}
