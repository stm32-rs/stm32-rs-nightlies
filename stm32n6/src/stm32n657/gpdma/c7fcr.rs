///Register `C7FCR` writer
pub type W = crate::W<C7FCRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<C7FCRrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn tcf(&mut self) -> TCF_W<'_, C7FCRrs> {
        TCF_W::new(self, 8)
    }
    ///Bit 9 - half transfer flag clear
    #[inline(always)]
    pub fn htf(&mut self) -> HTF_W<'_, C7FCRrs> {
        HTF_W::new(self, 9)
    }
    ///Bit 10 - data transfer error flag clear
    #[inline(always)]
    pub fn dtef(&mut self) -> DTEF_W<'_, C7FCRrs> {
        DTEF_W::new(self, 10)
    }
    ///Bit 11 - update link transfer error flag clear
    #[inline(always)]
    pub fn ulef(&mut self) -> ULEF_W<'_, C7FCRrs> {
        ULEF_W::new(self, 11)
    }
    ///Bit 12 - user setting error flag clear
    #[inline(always)]
    pub fn usef(&mut self) -> USEF_W<'_, C7FCRrs> {
        USEF_W::new(self, 12)
    }
    ///Bit 13 - completed suspension flag clear
    #[inline(always)]
    pub fn suspf(&mut self) -> SUSPF_W<'_, C7FCRrs> {
        SUSPF_W::new(self, 13)
    }
    ///Bit 14 - trigger overrun flag clear
    #[inline(always)]
    pub fn tof(&mut self) -> TOF_W<'_, C7FCRrs> {
        TOF_W::new(self, 14)
    }
}
/**GPDMA channel 7 flag clear register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c7fcr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#GPDMA:C7FCR)*/
pub struct C7FCRrs;
impl crate::RegisterSpec for C7FCRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`c7fcr::W`](W) writer structure
impl crate::Writable for C7FCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets C7FCR to value 0
impl crate::Resettable for C7FCRrs {}
