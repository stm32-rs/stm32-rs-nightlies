...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#GPIOB:HWCFGR8)*/
...
///`reset()` method sets HWCFGR8 to value 0xfffc_cccc
impl crate::Resettable for HWCFGR8rs {
    const RESET_VALUE: u32 = 0xfffc_cccc;
}
