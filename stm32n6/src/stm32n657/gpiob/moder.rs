...
pub use crate::stm32n657::gpioa::moder::MODE;
///Field `MODE(0-15)` reader - Port x configuration pin %s
pub use crate::stm32n657::gpioa::moder::MODE_R;
///Field `MODE(0-15)` writer - Port x configuration pin %s
pub use crate::stm32n657::gpioa::moder::MODE_W;
impl R {
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `MODE0` field.</div>
    #[inline(always)]
    pub fn mode(&mut self, n: u8) -> MODE_W<'_, MODERrs> {
        #[allow(clippy::no_effect)]
        [(); 16][n as usize];
        MODE_W::new(self, n * 2)
    }
    ///Bits 0:1 - Port x configuration pin 0
    #[inline(always)]
    pub fn mode0(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 0)
    }
    ///Bits 2:3 - Port x configuration pin 1
    #[inline(always)]
    pub fn mode1(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 2)
    }
    ///Bits 4:5 - Port x configuration pin 2
    #[inline(always)]
    pub fn mode2(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 4)
    }
    ///Bits 6:7 - Port x configuration pin 3
    #[inline(always)]
    pub fn mode3(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 6)
    }
    ///Bits 8:9 - Port x configuration pin 4
    #[inline(always)]
    pub fn mode4(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 8)
    }
    ///Bits 10:11 - Port x configuration pin 5
    #[inline(always)]
    pub fn mode5(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 10)
    }
    ///Bits 12:13 - Port x configuration pin 6
    #[inline(always)]
    pub fn mode6(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 12)
    }
    ///Bits 14:15 - Port x configuration pin 7
    #[inline(always)]
    pub fn mode7(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 14)
    }
    ///Bits 16:17 - Port x configuration pin 8
    #[inline(always)]
    pub fn mode8(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 16)
    }
    ///Bits 18:19 - Port x configuration pin 9
    #[inline(always)]
    pub fn mode9(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 18)
    }
    ///Bits 20:21 - Port x configuration pin 10
    #[inline(always)]
    pub fn mode10(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 20)
    }
    ///Bits 22:23 - Port x configuration pin 11
    #[inline(always)]
    pub fn mode11(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 22)
    }
    ///Bits 24:25 - Port x configuration pin 12
    #[inline(always)]
    pub fn mode12(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 24)
    }
    ///Bits 26:27 - Port x configuration pin 13
    #[inline(always)]
    pub fn mode13(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 26)
    }
    ///Bits 28:29 - Port x configuration pin 14
    #[inline(always)]
    pub fn mode14(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 28)
    }
    ///Bits 30:31 - Port x configuration pin 15
    #[inline(always)]
    pub fn mode15(&mut self) -> MODE_W<'_, MODERrs> {
        MODE_W::new(self, 30)
    }
}
