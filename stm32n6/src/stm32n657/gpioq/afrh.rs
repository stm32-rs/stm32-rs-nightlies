...
///Field `AFSEL8` reader - Alternate function selection for port x I/O pin y
pub type AFSEL8_R = crate::FieldReader;
///Field `AFSEL8` writer - Alternate function selection for port x I/O pin y
pub type AFSEL8_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `AFSEL9` reader - Alternate function selection for port x I/O pin y
pub type AFSEL9_R = crate::FieldReader;
///Field `AFSEL9` writer - Alternate function selection for port x I/O pin y
pub type AFSEL9_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `AFSEL10` reader - Alternate function selection for port x I/O pin y
pub type AFSEL10_R = crate::FieldReader;
///Field `AFSEL10` writer - Alternate function selection for port x I/O pin y
pub type AFSEL10_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `AFSEL11` reader - Alternate function selection for port x I/O pin y
pub type AFSEL11_R = crate::FieldReader;
///Field `AFSEL11` writer - Alternate function selection for port x I/O pin y
pub type AFSEL11_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `AFSEL12` reader - Alternate function selection for port x I/O pin y
pub type AFSEL12_R = crate::FieldReader;
///Field `AFSEL12` writer - Alternate function selection for port x I/O pin y
pub type AFSEL12_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `AFSEL13` reader - Alternate function selection for port x I/O pin y
pub type AFSEL13_R = crate::FieldReader;
///Field `AFSEL13` writer - Alternate function selection for port x I/O pin y
pub type AFSEL13_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `AFSEL14` reader - Alternate function selection for port x I/O pin y
pub type AFSEL14_R = crate::FieldReader;
///Field `AFSEL14` writer - Alternate function selection for port x I/O pin y
pub type AFSEL14_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `AFSEL15` reader - Alternate function selection for port x I/O pin y
pub type AFSEL15_R = crate::FieldReader;
///Field `AFSEL15` writer - Alternate function selection for port x I/O pin y
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#GPIOQ:AFRH)*/
pub struct AFRHrs;
