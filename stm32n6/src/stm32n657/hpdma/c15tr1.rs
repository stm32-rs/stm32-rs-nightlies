...
impl W {
    ///Bits 0:1 - binary logarithm of the source data width of a burst in bytes
    #[inline(always)]
    pub fn sdw_log2(&mut self) -> SDW_LOG2_W<'_, C15TR1rs> {
        SDW_LOG2_W::new(self, 0)
    }
    ///Bit 3 - source incrementing burst
    #[inline(always)]
    pub fn sinc(&mut self) -> SINC_W<'_, C15TR1rs> {
        SINC_W::new(self, 3)
    }
    ///Bits 4:9 - source burst length minus 1, between 0 and 63
    #[inline(always)]
    pub fn sbl_1(&mut self) -> SBL_1_W<'_, C15TR1rs> {
        SBL_1_W::new(self, 4)
    }
    ///Bits 11:12 - padding/alignment mode
    #[inline(always)]
    pub fn pam(&mut self) -> PAM_W<'_, C15TR1rs> {
        PAM_W::new(self, 11)
    }
    ///Bit 13 - source byte exchange within the unaligned half-word of each source word
    #[inline(always)]
    pub fn sbx(&mut self) -> SBX_W<'_, C15TR1rs> {
        SBX_W::new(self, 13)
    }
    ///Bit 14 - source allocated port
    #[inline(always)]
    pub fn sap(&mut self) -> SAP_W<'_, C15TR1rs> {
        SAP_W::new(self, 14)
    }
    ///Bit 15 - security attribute of the HPDMA transfer from the source
    #[inline(always)]
    pub fn ssec(&mut self) -> SSEC_W<'_, C15TR1rs> {
        SSEC_W::new(self, 15)
    }
    ///Bits 16:17 - binary logarithm of the destination data width of a burst, in bytes
    #[inline(always)]
    pub fn ddw_log2(&mut self) -> DDW_LOG2_W<'_, C15TR1rs> {
        DDW_LOG2_W::new(self, 16)
    }
    ///Bit 19 - destination incrementing burst
    #[inline(always)]
    pub fn dinc(&mut self) -> DINC_W<'_, C15TR1rs> {
        DINC_W::new(self, 19)
    }
    ///Bits 20:25 - destination burst length minus 1, between 0 and 63
    #[inline(always)]
    pub fn dbl_1(&mut self) -> DBL_1_W<'_, C15TR1rs> {
        DBL_1_W::new(self, 20)
    }
    ///Bit 26 - destination byte exchange
    #[inline(always)]
    pub fn dbx(&mut self) -> DBX_W<'_, C15TR1rs> {
        DBX_W::new(self, 26)
    }
    ///Bit 27 - destination half-word exchange
    #[inline(always)]
    pub fn dhx(&mut self) -> DHX_W<'_, C15TR1rs> {
        DHX_W::new(self, 27)
    }
    ///Bit 28 - destination word exchange
    #[inline(always)]
    pub fn dwx(&mut self) -> DWX_W<'_, C15TR1rs> {
        DWX_W::new(self, 28)
    }
    ///Bit 30 - destination allocated port
    #[inline(always)]
    pub fn dap(&mut self) -> DAP_W<'_, C15TR1rs> {
        DAP_W::new(self, 30)
    }
    ///Bit 31 - security attribute of the HPDMA transfer to the destination
    #[inline(always)]
    pub fn dsec(&mut self) -> DSEC_W<'_, C15TR1rs> {
        DSEC_W::new(self, 31)
    }
}
