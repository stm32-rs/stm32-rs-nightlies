...
///Field `MIS8` reader - masked interrupt status of channel x
pub type MIS8_R = crate::BitReader;
///Field `MIS9` reader - masked interrupt status of channel x
pub type MIS9_R = crate::BitReader;
///Field `MIS10` reader - masked interrupt status of channel x
pub type MIS10_R = crate::BitReader;
///Field `MIS11` reader - masked interrupt status of channel x
pub type MIS11_R = crate::BitReader;
///Field `MIS12` reader - masked interrupt status of channel x
pub type MIS12_R = crate::BitReader;
///Field `MIS13` reader - masked interrupt status of channel x
pub type MIS13_R = crate::BitReader;
///Field `MIS14` reader - masked interrupt status of channel x
pub type MIS14_R = crate::BitReader;
///Field `MIS15` reader - masked interrupt status of channel x
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#HPDMA:MISR)*/
pub struct MISRrs;
