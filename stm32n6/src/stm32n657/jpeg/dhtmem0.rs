...
impl W {
    ///Bits 0:7 - Huffman table data 0
    #[inline(always)]
    pub fn data0(&mut self) -> DATA0_W<DHTMEM0rs> {
        DATA0_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 1
    #[inline(always)]
    pub fn data1(&mut self) -> DATA1_W<DHTMEM0rs> {
        DATA1_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 2
    #[inline(always)]
    pub fn data2(&mut self) -> DATA2_W<DHTMEM0rs> {
        DATA2_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 3
    #[inline(always)]
    pub fn data3(&mut self) -> DATA3_W<DHTMEM0rs> {
        DATA3_W::new(self, 24)
    }
}
/**JPEG DHT memory
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM0)*/
