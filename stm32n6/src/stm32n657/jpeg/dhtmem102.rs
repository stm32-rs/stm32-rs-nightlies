...
impl W {
    ///Bits 0:7 - Huffman table data 408
    #[inline(always)]
    pub fn data408(&mut self) -> DATA408_W<DHTMEM102rs> {
        DATA408_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 409
    #[inline(always)]
    pub fn data409(&mut self) -> DATA409_W<DHTMEM102rs> {
        DATA409_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 410
    #[inline(always)]
    pub fn data410(&mut self) -> DATA410_W<DHTMEM102rs> {
        DATA410_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 411
    #[inline(always)]
    pub fn data411(&mut self) -> DATA411_W<DHTMEM102rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM102)*/
