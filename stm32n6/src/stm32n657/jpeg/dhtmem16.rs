...
impl W {
    ///Bits 0:7 - Huffman table data 64
    #[inline(always)]
    pub fn data64(&mut self) -> DATA64_W<DHTMEM16rs> {
        DATA64_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 65
    #[inline(always)]
    pub fn data65(&mut self) -> DATA65_W<DHTMEM16rs> {
        DATA65_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 66
    #[inline(always)]
    pub fn data66(&mut self) -> DATA66_W<DHTMEM16rs> {
        DATA66_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 67
    #[inline(always)]
    pub fn data67(&mut self) -> DATA67_W<DHTMEM16rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM16)*/
