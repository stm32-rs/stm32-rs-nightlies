...
impl W {
    ///Bits 0:7 - Huffman table data 76
    #[inline(always)]
    pub fn data76(&mut self) -> DATA76_W<DHTMEM19rs> {
        DATA76_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 77
    #[inline(always)]
    pub fn data77(&mut self) -> DATA77_W<DHTMEM19rs> {
        DATA77_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 78
    #[inline(always)]
    pub fn data78(&mut self) -> DATA78_W<DHTMEM19rs> {
        DATA78_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 79
    #[inline(always)]
    pub fn data79(&mut self) -> DATA79_W<DHTMEM19rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM19)*/
