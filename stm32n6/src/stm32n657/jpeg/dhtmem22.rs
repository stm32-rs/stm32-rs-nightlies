...
impl W {
    ///Bits 0:7 - Huffman table data 88
    #[inline(always)]
    pub fn data88(&mut self) -> DATA88_W<DHTMEM22rs> {
        DATA88_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 89
    #[inline(always)]
    pub fn data89(&mut self) -> DATA89_W<DHTMEM22rs> {
        DATA89_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 90
    #[inline(always)]
    pub fn data90(&mut self) -> DATA90_W<DHTMEM22rs> {
        DATA90_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 91
    #[inline(always)]
    pub fn data91(&mut self) -> DATA91_W<DHTMEM22rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM22)*/
