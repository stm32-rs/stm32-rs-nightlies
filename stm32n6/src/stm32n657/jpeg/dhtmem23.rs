...
impl W {
    ///Bits 0:7 - Huffman table data 92
    #[inline(always)]
    pub fn data92(&mut self) -> DATA92_W<'_, DHTMEM23rs> {
        DATA92_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 93
    #[inline(always)]
    pub fn data93(&mut self) -> DATA93_W<'_, DHTMEM23rs> {
        DATA93_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 94
    #[inline(always)]
    pub fn data94(&mut self) -> DATA94_W<'_, DHTMEM23rs> {
        DATA94_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 95
    #[inline(always)]
    pub fn data95(&mut self) -> DATA95_W<'_, DHTMEM23rs> {
