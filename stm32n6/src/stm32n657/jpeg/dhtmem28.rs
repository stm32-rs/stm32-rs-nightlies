...
impl W {
    ///Bits 0:7 - Huffman table data 112
    #[inline(always)]
    pub fn data112(&mut self) -> DATA112_W<'_, DHTMEM28rs> {
        DATA112_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 113
    #[inline(always)]
    pub fn data113(&mut self) -> DATA113_W<'_, DHTMEM28rs> {
        DATA113_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 114
    #[inline(always)]
    pub fn data114(&mut self) -> DATA114_W<'_, DHTMEM28rs> {
        DATA114_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 115
    #[inline(always)]
    pub fn data115(&mut self) -> DATA115_W<'_, DHTMEM28rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM28)*/
