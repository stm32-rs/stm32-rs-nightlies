...
impl W {
    ///Bits 0:7 - Huffman table data 12
    #[inline(always)]
    pub fn data12(&mut self) -> DATA12_W<DHTMEM3rs> {
        DATA12_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 13
    #[inline(always)]
    pub fn data13(&mut self) -> DATA13_W<DHTMEM3rs> {
        DATA13_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 14
    #[inline(always)]
    pub fn data14(&mut self) -> DATA14_W<DHTMEM3rs> {
        DATA14_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 15
    #[inline(always)]
    pub fn data15(&mut self) -> DATA15_W<DHTMEM3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM3)*/
