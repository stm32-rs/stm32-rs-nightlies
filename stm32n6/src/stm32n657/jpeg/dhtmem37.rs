...
impl W {
    ///Bits 0:7 - Huffman table data 148
    #[inline(always)]
    pub fn data148(&mut self) -> DATA148_W<DHTMEM37rs> {
        DATA148_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 149
    #[inline(always)]
    pub fn data149(&mut self) -> DATA149_W<DHTMEM37rs> {
        DATA149_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 150
    #[inline(always)]
    pub fn data150(&mut self) -> DATA150_W<DHTMEM37rs> {
        DATA150_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 151
    #[inline(always)]
    pub fn data151(&mut self) -> DATA151_W<DHTMEM37rs> {
