...
impl W {
    ///Bits 0:7 - Huffman table data 152
    #[inline(always)]
    pub fn data152(&mut self) -> DATA152_W<DHTMEM38rs> {
        DATA152_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 153
    #[inline(always)]
    pub fn data153(&mut self) -> DATA153_W<DHTMEM38rs> {
        DATA153_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 154
    #[inline(always)]
    pub fn data154(&mut self) -> DATA154_W<DHTMEM38rs> {
        DATA154_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 155
    #[inline(always)]
    pub fn data155(&mut self) -> DATA155_W<DHTMEM38rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM38)*/
