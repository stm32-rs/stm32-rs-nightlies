...
impl W {
    ///Bits 0:7 - Huffman table data 164
    #[inline(always)]
    pub fn data164(&mut self) -> DATA164_W<DHTMEM41rs> {
        DATA164_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 165
    #[inline(always)]
    pub fn data165(&mut self) -> DATA165_W<DHTMEM41rs> {
        DATA165_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 166
    #[inline(always)]
    pub fn data166(&mut self) -> DATA166_W<DHTMEM41rs> {
        DATA166_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 167
    #[inline(always)]
    pub fn data167(&mut self) -> DATA167_W<DHTMEM41rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM41)*/
