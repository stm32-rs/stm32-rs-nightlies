...
impl W {
    ///Bits 0:7 - Huffman table data 176
    #[inline(always)]
    pub fn data176(&mut self) -> DATA176_W<DHTMEM44rs> {
        DATA176_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 177
    #[inline(always)]
    pub fn data177(&mut self) -> DATA177_W<DHTMEM44rs> {
        DATA177_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 178
    #[inline(always)]
    pub fn data178(&mut self) -> DATA178_W<DHTMEM44rs> {
        DATA178_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 179
    #[inline(always)]
    pub fn data179(&mut self) -> DATA179_W<DHTMEM44rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM44)*/
