...
impl W {
    ///Bits 0:7 - Huffman table data 188
    #[inline(always)]
    pub fn data188(&mut self) -> DATA188_W<DHTMEM47rs> {
        DATA188_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 189
    #[inline(always)]
    pub fn data189(&mut self) -> DATA189_W<DHTMEM47rs> {
        DATA189_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 190
    #[inline(always)]
    pub fn data190(&mut self) -> DATA190_W<DHTMEM47rs> {
        DATA190_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 191
    #[inline(always)]
    pub fn data191(&mut self) -> DATA191_W<DHTMEM47rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM47)*/
