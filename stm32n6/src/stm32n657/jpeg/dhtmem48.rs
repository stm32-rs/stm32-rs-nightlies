...
impl W {
    ///Bits 0:7 - Huffman table data 192
    #[inline(always)]
    pub fn data192(&mut self) -> DATA192_W<DHTMEM48rs> {
        DATA192_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 193
    #[inline(always)]
    pub fn data193(&mut self) -> DATA193_W<DHTMEM48rs> {
        DATA193_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 194
    #[inline(always)]
    pub fn data194(&mut self) -> DATA194_W<DHTMEM48rs> {
        DATA194_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 195
    #[inline(always)]
    pub fn data195(&mut self) -> DATA195_W<DHTMEM48rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM48)*/
