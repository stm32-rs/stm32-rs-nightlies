...
impl W {
    ///Bits 0:7 - Huffman table data 204
    #[inline(always)]
    pub fn data204(&mut self) -> DATA204_W<DHTMEM51rs> {
        DATA204_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 205
    #[inline(always)]
    pub fn data205(&mut self) -> DATA205_W<DHTMEM51rs> {
        DATA205_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 206
    #[inline(always)]
    pub fn data206(&mut self) -> DATA206_W<DHTMEM51rs> {
        DATA206_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 207
    #[inline(always)]
    pub fn data207(&mut self) -> DATA207_W<DHTMEM51rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM51)*/
