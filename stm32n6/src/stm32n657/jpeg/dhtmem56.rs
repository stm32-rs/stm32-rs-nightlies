...
impl W {
    ///Bits 0:7 - Huffman table data 224
    #[inline(always)]
    pub fn data224(&mut self) -> DATA224_W<DHTMEM56rs> {
        DATA224_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 225
    #[inline(always)]
    pub fn data225(&mut self) -> DATA225_W<DHTMEM56rs> {
        DATA225_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 226
    #[inline(always)]
    pub fn data226(&mut self) -> DATA226_W<DHTMEM56rs> {
        DATA226_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 227
    #[inline(always)]
    pub fn data227(&mut self) -> DATA227_W<DHTMEM56rs> {
