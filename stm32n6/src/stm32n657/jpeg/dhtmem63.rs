...
impl W {
    ///Bits 0:7 - Huffman table data 252
    #[inline(always)]
    pub fn data252(&mut self) -> DATA252_W<DHTMEM63rs> {
        DATA252_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 253
    #[inline(always)]
    pub fn data253(&mut self) -> DATA253_W<DHTMEM63rs> {
        DATA253_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 254
    #[inline(always)]
    pub fn data254(&mut self) -> DATA254_W<DHTMEM63rs> {
        DATA254_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 255
    #[inline(always)]
    pub fn data255(&mut self) -> DATA255_W<DHTMEM63rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM63)*/
