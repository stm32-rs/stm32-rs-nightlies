...
impl W {
    ///Bits 0:7 - Huffman table data 264
    #[inline(always)]
    pub fn data264(&mut self) -> DATA264_W<DHTMEM66rs> {
        DATA264_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 265
    #[inline(always)]
    pub fn data265(&mut self) -> DATA265_W<DHTMEM66rs> {
        DATA265_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 266
    #[inline(always)]
    pub fn data266(&mut self) -> DATA266_W<DHTMEM66rs> {
        DATA266_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 267
    #[inline(always)]
    pub fn data267(&mut self) -> DATA267_W<DHTMEM66rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM66)*/
