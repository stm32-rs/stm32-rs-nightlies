...
impl W {
    ///Bits 0:7 - Huffman table data 28
    #[inline(always)]
    pub fn data28(&mut self) -> DATA28_W<DHTMEM7rs> {
        DATA28_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 29
    #[inline(always)]
    pub fn data29(&mut self) -> DATA29_W<DHTMEM7rs> {
        DATA29_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 30
    #[inline(always)]
    pub fn data30(&mut self) -> DATA30_W<DHTMEM7rs> {
        DATA30_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 31
    #[inline(always)]
    pub fn data31(&mut self) -> DATA31_W<DHTMEM7rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM7)*/
