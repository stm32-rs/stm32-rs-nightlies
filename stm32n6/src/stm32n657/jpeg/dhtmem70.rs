...
impl W {
    ///Bits 0:7 - Huffman table data 280
    #[inline(always)]
    pub fn data280(&mut self) -> DATA280_W<DHTMEM70rs> {
        DATA280_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 281
    #[inline(always)]
    pub fn data281(&mut self) -> DATA281_W<DHTMEM70rs> {
        DATA281_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 282
    #[inline(always)]
    pub fn data282(&mut self) -> DATA282_W<DHTMEM70rs> {
        DATA282_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 283
    #[inline(always)]
    pub fn data283(&mut self) -> DATA283_W<DHTMEM70rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM70)*/
