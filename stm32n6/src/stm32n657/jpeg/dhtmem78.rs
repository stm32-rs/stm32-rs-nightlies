...
impl W {
    ///Bits 0:7 - Huffman table data 312
    #[inline(always)]
    pub fn data312(&mut self) -> DATA312_W<DHTMEM78rs> {
        DATA312_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 313
    #[inline(always)]
    pub fn data313(&mut self) -> DATA313_W<DHTMEM78rs> {
        DATA313_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 314
    #[inline(always)]
    pub fn data314(&mut self) -> DATA314_W<DHTMEM78rs> {
        DATA314_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 315
    #[inline(always)]
    pub fn data315(&mut self) -> DATA315_W<DHTMEM78rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM78)*/
