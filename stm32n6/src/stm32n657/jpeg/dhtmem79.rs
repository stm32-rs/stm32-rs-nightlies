...
impl W {
    ///Bits 0:7 - Huffman table data 316
    #[inline(always)]
    pub fn data316(&mut self) -> DATA316_W<DHTMEM79rs> {
        DATA316_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 317
    #[inline(always)]
    pub fn data317(&mut self) -> DATA317_W<DHTMEM79rs> {
        DATA317_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 318
    #[inline(always)]
    pub fn data318(&mut self) -> DATA318_W<DHTMEM79rs> {
        DATA318_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 319
    #[inline(always)]
    pub fn data319(&mut self) -> DATA319_W<DHTMEM79rs> {
