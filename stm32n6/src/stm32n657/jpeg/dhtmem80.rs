...
impl W {
    ///Bits 0:7 - Huffman table data 320
    #[inline(always)]
    pub fn data320(&mut self) -> DATA320_W<DHTMEM80rs> {
        DATA320_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 321
    #[inline(always)]
    pub fn data321(&mut self) -> DATA321_W<DHTMEM80rs> {
        DATA321_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 322
    #[inline(always)]
    pub fn data322(&mut self) -> DATA322_W<DHTMEM80rs> {
        DATA322_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 323
    #[inline(always)]
    pub fn data323(&mut self) -> DATA323_W<DHTMEM80rs> {
