...
impl W {
    ///Bits 0:7 - Huffman table data 324
    #[inline(always)]
    pub fn data324(&mut self) -> DATA324_W<'_, DHTMEM81rs> {
        DATA324_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 325
    #[inline(always)]
    pub fn data325(&mut self) -> DATA325_W<'_, DHTMEM81rs> {
        DATA325_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 326
    #[inline(always)]
    pub fn data326(&mut self) -> DATA326_W<'_, DHTMEM81rs> {
        DATA326_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 327
    #[inline(always)]
    pub fn data327(&mut self) -> DATA327_W<'_, DHTMEM81rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM81)*/
