...
impl W {
    ///Bits 0:7 - Huffman table data 328
    #[inline(always)]
    pub fn data328(&mut self) -> DATA328_W<DHTMEM82rs> {
        DATA328_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 329
    #[inline(always)]
    pub fn data329(&mut self) -> DATA329_W<DHTMEM82rs> {
        DATA329_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 330
    #[inline(always)]
    pub fn data330(&mut self) -> DATA330_W<DHTMEM82rs> {
        DATA330_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 331
    #[inline(always)]
    pub fn data331(&mut self) -> DATA331_W<DHTMEM82rs> {
