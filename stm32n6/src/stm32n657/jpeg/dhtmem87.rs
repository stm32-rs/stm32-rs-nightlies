...
impl W {
    ///Bits 0:7 - Huffman table data 348
    #[inline(always)]
    pub fn data348(&mut self) -> DATA348_W<DHTMEM87rs> {
        DATA348_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 349
    #[inline(always)]
    pub fn data349(&mut self) -> DATA349_W<DHTMEM87rs> {
        DATA349_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 350
    #[inline(always)]
    pub fn data350(&mut self) -> DATA350_W<DHTMEM87rs> {
        DATA350_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 351
    #[inline(always)]
    pub fn data351(&mut self) -> DATA351_W<DHTMEM87rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM87)*/
