...
impl W {
    ///Bits 0:7 - Huffman table data 376
    #[inline(always)]
    pub fn data376(&mut self) -> DATA376_W<DHTMEM94rs> {
        DATA376_W::new(self, 0)
    }
    ///Bits 8:15 - Huffman table data 377
    #[inline(always)]
    pub fn data377(&mut self) -> DATA377_W<DHTMEM94rs> {
        DATA377_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman table data 378
    #[inline(always)]
    pub fn data378(&mut self) -> DATA378_W<DHTMEM94rs> {
        DATA378_W::new(self, 16)
    }
    ///Bits 24:31 - Huffman table data 379
    #[inline(always)]
    pub fn data379(&mut self) -> DATA379_W<DHTMEM94rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:DHTMEM94)*/
