...
impl W {
    ///Bits 0:8 - Data 24
    #[inline(always)]
    pub fn data24(&mut self) -> DATA24_W<HUFFBASE12rs> {
        DATA24_W::new(self, 0)
    }
    ///Bits 16:24 - Data 25
    #[inline(always)]
    pub fn data25(&mut self) -> DATA25_W<HUFFBASE12rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE12)*/
