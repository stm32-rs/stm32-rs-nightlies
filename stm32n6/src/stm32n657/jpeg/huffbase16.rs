...
impl W {
    ///Bits 0:8 - Data 32
    #[inline(always)]
    pub fn data32(&mut self) -> DATA32_W<HUFFBASE16rs> {
        DATA32_W::new(self, 0)
    }
    ///Bits 16:24 - Data 33
    #[inline(always)]
    pub fn data33(&mut self) -> DATA33_W<HUFFBASE16rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE16)*/
