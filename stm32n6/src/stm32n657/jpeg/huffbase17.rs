...
impl W {
    ///Bits 0:8 - Data 34
    #[inline(always)]
    pub fn data34(&mut self) -> DATA34_W<HUFFBASE17rs> {
        DATA34_W::new(self, 0)
    }
    ///Bits 16:24 - Data 35
    #[inline(always)]
    pub fn data35(&mut self) -> DATA35_W<HUFFBASE17rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE17)*/
