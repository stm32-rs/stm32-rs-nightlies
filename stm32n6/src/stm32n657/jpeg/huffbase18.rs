...
impl W {
    ///Bits 0:8 - Data 36
    #[inline(always)]
    pub fn data36(&mut self) -> DATA36_W<HUFFBASE18rs> {
        DATA36_W::new(self, 0)
    }
    ///Bits 16:24 - Data 37
    #[inline(always)]
    pub fn data37(&mut self) -> DATA37_W<HUFFBASE18rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE18)*/
