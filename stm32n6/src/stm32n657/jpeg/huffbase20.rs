...
impl W {
    ///Bits 0:8 - Data 40
    #[inline(always)]
    pub fn data40(&mut self) -> DATA40_W<HUFFBASE20rs> {
        DATA40_W::new(self, 0)
    }
    ///Bits 16:24 - Data 41
    #[inline(always)]
    pub fn data41(&mut self) -> DATA41_W<HUFFBASE20rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE20)*/
