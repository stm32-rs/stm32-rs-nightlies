...
impl W {
    ///Bits 0:8 - Data 42
    #[inline(always)]
    pub fn data42(&mut self) -> DATA42_W<HUFFBASE21rs> {
        DATA42_W::new(self, 0)
    }
    ///Bits 16:24 - Data 43
    #[inline(always)]
    pub fn data43(&mut self) -> DATA43_W<HUFFBASE21rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE21)*/
