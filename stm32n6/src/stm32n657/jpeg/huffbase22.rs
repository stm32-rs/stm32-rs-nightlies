...
impl W {
    ///Bits 0:8 - Data 44
    #[inline(always)]
    pub fn data44(&mut self) -> DATA44_W<HUFFBASE22rs> {
        DATA44_W::new(self, 0)
    }
    ///Bits 16:24 - Data 45
    #[inline(always)]
    pub fn data45(&mut self) -> DATA45_W<HUFFBASE22rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE22)*/
