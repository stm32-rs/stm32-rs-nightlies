...
impl W {
    ///Bits 0:8 - Data 46
    #[inline(always)]
    pub fn data46(&mut self) -> DATA46_W<HUFFBASE23rs> {
        DATA46_W::new(self, 0)
    }
    ///Bits 16:24 - Data 47
    #[inline(always)]
    pub fn data47(&mut self) -> DATA47_W<HUFFBASE23rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE23)*/
