...
impl W {
    ///Bits 0:8 - Data 50
    #[inline(always)]
    pub fn data50(&mut self) -> DATA50_W<HUFFBASE25rs> {
        DATA50_W::new(self, 0)
    }
    ///Bits 16:24 - Data 51
    #[inline(always)]
    pub fn data51(&mut self) -> DATA51_W<HUFFBASE25rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE25)*/
