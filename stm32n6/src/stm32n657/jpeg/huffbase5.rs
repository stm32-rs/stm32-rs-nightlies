...
impl W {
    ///Bits 0:8 - Data 10
    #[inline(always)]
    pub fn data10(&mut self) -> DATA10_W<HUFFBASE5rs> {
        DATA10_W::new(self, 0)
    }
    ///Bits 16:24 - Data 11
    #[inline(always)]
    pub fn data11(&mut self) -> DATA11_W<HUFFBASE5rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFBASE5)*/
