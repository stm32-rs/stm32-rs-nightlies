...
impl W {
    ///Bits 0:7 - Huffman code 22
    #[inline(always)]
    pub fn hcode22(&mut self) -> HCODE22_W<HUFFENC_AC0_11rs> {
        HCODE22_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 22
    #[inline(always)]
    pub fn hlen22(&mut self) -> HLEN22_W<HUFFENC_AC0_11rs> {
        HLEN22_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 23
    #[inline(always)]
    pub fn hcode23(&mut self) -> HCODE23_W<HUFFENC_AC0_11rs> {
        HCODE23_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 23
    #[inline(always)]
    pub fn hlen23(&mut self) -> HLEN23_W<HUFFENC_AC0_11rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_11)*/
