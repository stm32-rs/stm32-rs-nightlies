///Register `HUFFENC_AC0_12` reader
pub type R = crate::R<HUFFENC_AC0_12rs>;
///Register `HUFFENC_AC0_12` writer
pub type W = crate::W<HUFFENC_AC0_12rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 24
    #[inline(always)]
    pub fn hcode24(&mut self) -> HCODE24_W<'_, HUFFENC_AC0_12rs> {
        HCODE24_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 24
    #[inline(always)]
    pub fn hlen24(&mut self) -> HLEN24_W<'_, HUFFENC_AC0_12rs> {
        HLEN24_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 25
    #[inline(always)]
    pub fn hcode25(&mut self) -> HCODE25_W<'_, HUFFENC_AC0_12rs> {
        HCODE25_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 25
    #[inline(always)]
    pub fn hlen25(&mut self) -> HLEN25_W<'_, HUFFENC_AC0_12rs> {
        HLEN25_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_12)*/
pub struct HUFFENC_AC0_12rs;
impl crate::RegisterSpec for HUFFENC_AC0_12rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_12::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_12rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_12::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_12rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_12 to value 0
impl crate::Resettable for HUFFENC_AC0_12rs {}
