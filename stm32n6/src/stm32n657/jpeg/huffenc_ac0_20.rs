///Register `HUFFENC_AC0_20` reader
pub type R = crate::R<HUFFENC_AC0_20rs>;
///Register `HUFFENC_AC0_20` writer
pub type W = crate::W<HUFFENC_AC0_20rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 40
    #[inline(always)]
    pub fn hcode40(&mut self) -> HCODE40_W<'_, HUFFENC_AC0_20rs> {
        HCODE40_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 40
    #[inline(always)]
    pub fn hlen40(&mut self) -> HLEN40_W<'_, HUFFENC_AC0_20rs> {
        HLEN40_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 41
    #[inline(always)]
    pub fn hcode41(&mut self) -> HCODE41_W<'_, HUFFENC_AC0_20rs> {
        HCODE41_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 41
    #[inline(always)]
    pub fn hlen41(&mut self) -> HLEN41_W<'_, HUFFENC_AC0_20rs> {
        HLEN41_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_20::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_20::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_20)*/
pub struct HUFFENC_AC0_20rs;
impl crate::RegisterSpec for HUFFENC_AC0_20rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_20::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_20rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_20::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_20rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_20 to value 0
impl crate::Resettable for HUFFENC_AC0_20rs {}
