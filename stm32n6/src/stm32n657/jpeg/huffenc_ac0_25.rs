...
impl W {
    ///Bits 0:7 - Huffman code 50
    #[inline(always)]
    pub fn hcode50(&mut self) -> HCODE50_W<HUFFENC_AC0_25rs> {
        HCODE50_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 50
    #[inline(always)]
    pub fn hlen50(&mut self) -> HLEN50_W<HUFFENC_AC0_25rs> {
        HLEN50_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 51
    #[inline(always)]
    pub fn hcode51(&mut self) -> HCODE51_W<HUFFENC_AC0_25rs> {
        HCODE51_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 51
    #[inline(always)]
    pub fn hlen51(&mut self) -> HLEN51_W<HUFFENC_AC0_25rs> {
