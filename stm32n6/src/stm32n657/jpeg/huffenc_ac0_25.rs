///Register `HUFFENC_AC0_25` reader
pub type R = crate::R<HUFFENC_AC0_25rs>;
///Register `HUFFENC_AC0_25` writer
pub type W = crate::W<HUFFENC_AC0_25rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 50
    #[inline(always)]
    pub fn hcode50(&mut self) -> HCODE50_W<'_, HUFFENC_AC0_25rs> {
        HCODE50_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 50
    #[inline(always)]
    pub fn hlen50(&mut self) -> HLEN50_W<'_, HUFFENC_AC0_25rs> {
        HLEN50_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 51
    #[inline(always)]
    pub fn hcode51(&mut self) -> HCODE51_W<'_, HUFFENC_AC0_25rs> {
        HCODE51_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 51
    #[inline(always)]
    pub fn hlen51(&mut self) -> HLEN51_W<'_, HUFFENC_AC0_25rs> {
        HLEN51_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_25::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_25::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_25)*/
pub struct HUFFENC_AC0_25rs;
impl crate::RegisterSpec for HUFFENC_AC0_25rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_25::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_25rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_25::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_25rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_25 to value 0
impl crate::Resettable for HUFFENC_AC0_25rs {}
