...
impl W {
    ///Bits 0:7 - Huffman code 52
    #[inline(always)]
    pub fn hcode52(&mut self) -> HCODE52_W<HUFFENC_AC0_26rs> {
        HCODE52_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 52
    #[inline(always)]
    pub fn hlen52(&mut self) -> HLEN52_W<HUFFENC_AC0_26rs> {
        HLEN52_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 53
    #[inline(always)]
    pub fn hcode53(&mut self) -> HCODE53_W<HUFFENC_AC0_26rs> {
        HCODE53_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 53
    #[inline(always)]
    pub fn hlen53(&mut self) -> HLEN53_W<HUFFENC_AC0_26rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_26)*/
