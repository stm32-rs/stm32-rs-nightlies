///Register `HUFFENC_AC0_32` reader
pub type R = crate::R<HUFFENC_AC0_32rs>;
///Register `HUFFENC_AC0_32` writer
pub type W = crate::W<HUFFENC_AC0_32rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 64
    #[inline(always)]
    pub fn hcode64(&mut self) -> HCODE64_W<'_, HUFFENC_AC0_32rs> {
        HCODE64_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 64
    #[inline(always)]
    pub fn hlen64(&mut self) -> HLEN64_W<'_, HUFFENC_AC0_32rs> {
        HLEN64_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 65
    #[inline(always)]
    pub fn hcode65(&mut self) -> HCODE65_W<'_, HUFFENC_AC0_32rs> {
        HCODE65_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 65
    #[inline(always)]
    pub fn hlen65(&mut self) -> HLEN65_W<'_, HUFFENC_AC0_32rs> {
        HLEN65_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_32::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_32::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_32)*/
pub struct HUFFENC_AC0_32rs;
impl crate::RegisterSpec for HUFFENC_AC0_32rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_32::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_32rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_32::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_32rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_32 to value 0
impl crate::Resettable for HUFFENC_AC0_32rs {}
