...
impl W {
    ///Bits 0:7 - Huffman code 64
    #[inline(always)]
    pub fn hcode64(&mut self) -> HCODE64_W<HUFFENC_AC0_32rs> {
        HCODE64_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 64
    #[inline(always)]
    pub fn hlen64(&mut self) -> HLEN64_W<HUFFENC_AC0_32rs> {
        HLEN64_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 65
    #[inline(always)]
    pub fn hcode65(&mut self) -> HCODE65_W<HUFFENC_AC0_32rs> {
        HCODE65_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 65
    #[inline(always)]
    pub fn hlen65(&mut self) -> HLEN65_W<HUFFENC_AC0_32rs> {
