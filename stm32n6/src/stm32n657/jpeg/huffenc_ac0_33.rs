///Register `HUFFENC_AC0_33` reader
pub type R = crate::R<HUFFENC_AC0_33rs>;
///Register `HUFFENC_AC0_33` writer
pub type W = crate::W<HUFFENC_AC0_33rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 66
    #[inline(always)]
    pub fn hcode66(&mut self) -> HCODE66_W<'_, HUFFENC_AC0_33rs> {
        HCODE66_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 66
    #[inline(always)]
    pub fn hlen66(&mut self) -> HLEN66_W<'_, HUFFENC_AC0_33rs> {
        HLEN66_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 67
    #[inline(always)]
    pub fn hcode67(&mut self) -> HCODE67_W<'_, HUFFENC_AC0_33rs> {
        HCODE67_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 67
    #[inline(always)]
    pub fn hlen67(&mut self) -> HLEN67_W<'_, HUFFENC_AC0_33rs> {
        HLEN67_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_33::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_33::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_33)*/
pub struct HUFFENC_AC0_33rs;
impl crate::RegisterSpec for HUFFENC_AC0_33rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_33::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_33rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_33::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_33rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_33 to value 0
impl crate::Resettable for HUFFENC_AC0_33rs {}
