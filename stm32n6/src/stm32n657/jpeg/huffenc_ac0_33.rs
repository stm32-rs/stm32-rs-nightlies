...
impl W {
    ///Bits 0:7 - Huffman code 66
    #[inline(always)]
    pub fn hcode66(&mut self) -> HCODE66_W<HUFFENC_AC0_33rs> {
        HCODE66_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 66
    #[inline(always)]
    pub fn hlen66(&mut self) -> HLEN66_W<HUFFENC_AC0_33rs> {
        HLEN66_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 67
    #[inline(always)]
    pub fn hcode67(&mut self) -> HCODE67_W<HUFFENC_AC0_33rs> {
        HCODE67_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 67
    #[inline(always)]
    pub fn hlen67(&mut self) -> HLEN67_W<HUFFENC_AC0_33rs> {
