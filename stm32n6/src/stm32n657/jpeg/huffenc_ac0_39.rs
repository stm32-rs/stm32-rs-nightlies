///Register `HUFFENC_AC0_39` reader
pub type R = crate::R<HUFFENC_AC0_39rs>;
///Register `HUFFENC_AC0_39` writer
pub type W = crate::W<HUFFENC_AC0_39rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 78
    #[inline(always)]
    pub fn hcode78(&mut self) -> HCODE78_W<'_, HUFFENC_AC0_39rs> {
        HCODE78_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 78
    #[inline(always)]
    pub fn hlen78(&mut self) -> HLEN78_W<'_, HUFFENC_AC0_39rs> {
        HLEN78_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 79
    #[inline(always)]
    pub fn hcode79(&mut self) -> HCODE79_W<'_, HUFFENC_AC0_39rs> {
        HCODE79_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 79
    #[inline(always)]
    pub fn hlen79(&mut self) -> HLEN79_W<'_, HUFFENC_AC0_39rs> {
        HLEN79_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_39::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_39::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_39)*/
pub struct HUFFENC_AC0_39rs;
impl crate::RegisterSpec for HUFFENC_AC0_39rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_39::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_39rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_39::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_39rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_39 to value 0
impl crate::Resettable for HUFFENC_AC0_39rs {}
