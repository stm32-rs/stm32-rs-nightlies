...
impl W {
    ///Bits 0:7 - Huffman code 78
    #[inline(always)]
    pub fn hcode78(&mut self) -> HCODE78_W<HUFFENC_AC0_39rs> {
        HCODE78_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 78
    #[inline(always)]
    pub fn hlen78(&mut self) -> HLEN78_W<HUFFENC_AC0_39rs> {
        HLEN78_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 79
    #[inline(always)]
    pub fn hcode79(&mut self) -> HCODE79_W<HUFFENC_AC0_39rs> {
        HCODE79_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 79
    #[inline(always)]
    pub fn hlen79(&mut self) -> HLEN79_W<HUFFENC_AC0_39rs> {
