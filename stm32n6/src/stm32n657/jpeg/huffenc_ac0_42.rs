...
impl W {
    ///Bits 0:7 - Huffman code 84
    #[inline(always)]
    pub fn hcode84(&mut self) -> HCODE84_W<HUFFENC_AC0_42rs> {
        HCODE84_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 84
    #[inline(always)]
    pub fn hlen84(&mut self) -> HLEN84_W<HUFFENC_AC0_42rs> {
        HLEN84_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 85
    #[inline(always)]
    pub fn hcode85(&mut self) -> HCODE85_W<HUFFENC_AC0_42rs> {
        HCODE85_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 85
    #[inline(always)]
    pub fn hlen85(&mut self) -> HLEN85_W<HUFFENC_AC0_42rs> {
