///Register `HUFFENC_AC0_42` reader
pub type R = crate::R<HUFFENC_AC0_42rs>;
///Register `HUFFENC_AC0_42` writer
pub type W = crate::W<HUFFENC_AC0_42rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 84
    #[inline(always)]
    pub fn hcode84(&mut self) -> HCODE84_W<'_, HUFFENC_AC0_42rs> {
        HCODE84_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 84
    #[inline(always)]
    pub fn hlen84(&mut self) -> HLEN84_W<'_, HUFFENC_AC0_42rs> {
        HLEN84_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 85
    #[inline(always)]
    pub fn hcode85(&mut self) -> HCODE85_W<'_, HUFFENC_AC0_42rs> {
        HCODE85_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 85
    #[inline(always)]
    pub fn hlen85(&mut self) -> HLEN85_W<'_, HUFFENC_AC0_42rs> {
        HLEN85_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_42::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_42::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_42)*/
pub struct HUFFENC_AC0_42rs;
impl crate::RegisterSpec for HUFFENC_AC0_42rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_42::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_42rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_42::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_42rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_42 to value 0
impl crate::Resettable for HUFFENC_AC0_42rs {}
