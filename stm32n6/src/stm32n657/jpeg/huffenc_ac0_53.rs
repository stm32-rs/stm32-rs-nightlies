///Register `HUFFENC_AC0_53` reader
pub type R = crate::R<HUFFENC_AC0_53rs>;
///Register `HUFFENC_AC0_53` writer
pub type W = crate::W<HUFFENC_AC0_53rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 106
    #[inline(always)]
    pub fn hcode106(&mut self) -> HCODE106_W<'_, HUFFENC_AC0_53rs> {
        HCODE106_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 106
    #[inline(always)]
    pub fn hlen106(&mut self) -> HLEN106_W<'_, HUFFENC_AC0_53rs> {
        HLEN106_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 107
    #[inline(always)]
    pub fn hcode107(&mut self) -> HCODE107_W<'_, HUFFENC_AC0_53rs> {
        HCODE107_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 107
    #[inline(always)]
    pub fn hlen107(&mut self) -> HLEN107_W<'_, HUFFENC_AC0_53rs> {
        HLEN107_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_53::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_53::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_53)*/
pub struct HUFFENC_AC0_53rs;
impl crate::RegisterSpec for HUFFENC_AC0_53rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_53::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_53rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_53::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_53rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_53 to value 0
impl crate::Resettable for HUFFENC_AC0_53rs {}
