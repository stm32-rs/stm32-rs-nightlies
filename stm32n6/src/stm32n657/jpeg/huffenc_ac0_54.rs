///Register `HUFFENC_AC0_54` reader
pub type R = crate::R<HUFFENC_AC0_54rs>;
///Register `HUFFENC_AC0_54` writer
pub type W = crate::W<HUFFENC_AC0_54rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 108
    #[inline(always)]
    pub fn hcode108(&mut self) -> HCODE108_W<'_, HUFFENC_AC0_54rs> {
        HCODE108_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 108
    #[inline(always)]
    pub fn hlen108(&mut self) -> HLEN108_W<'_, HUFFENC_AC0_54rs> {
        HLEN108_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 109
    #[inline(always)]
    pub fn hcode109(&mut self) -> HCODE109_W<'_, HUFFENC_AC0_54rs> {
        HCODE109_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 109
    #[inline(always)]
    pub fn hlen109(&mut self) -> HLEN109_W<'_, HUFFENC_AC0_54rs> {
        HLEN109_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_54::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_54::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_54)*/
pub struct HUFFENC_AC0_54rs;
impl crate::RegisterSpec for HUFFENC_AC0_54rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_54::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_54rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_54::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_54rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_54 to value 0
impl crate::Resettable for HUFFENC_AC0_54rs {}
