...
impl W {
    ///Bits 0:7 - Huffman code 108
    #[inline(always)]
    pub fn hcode108(&mut self) -> HCODE108_W<HUFFENC_AC0_54rs> {
        HCODE108_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 108
    #[inline(always)]
    pub fn hlen108(&mut self) -> HLEN108_W<HUFFENC_AC0_54rs> {
        HLEN108_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 109
    #[inline(always)]
    pub fn hcode109(&mut self) -> HCODE109_W<HUFFENC_AC0_54rs> {
        HCODE109_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 109
    #[inline(always)]
    pub fn hlen109(&mut self) -> HLEN109_W<HUFFENC_AC0_54rs> {
