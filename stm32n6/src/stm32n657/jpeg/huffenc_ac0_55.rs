///Register `HUFFENC_AC0_55` reader
pub type R = crate::R<HUFFENC_AC0_55rs>;
///Register `HUFFENC_AC0_55` writer
pub type W = crate::W<HUFFENC_AC0_55rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 110
    #[inline(always)]
    pub fn hcode110(&mut self) -> HCODE110_W<'_, HUFFENC_AC0_55rs> {
        HCODE110_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 110
    #[inline(always)]
    pub fn hlen110(&mut self) -> HLEN110_W<'_, HUFFENC_AC0_55rs> {
        HLEN110_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 111
    #[inline(always)]
    pub fn hcode111(&mut self) -> HCODE111_W<'_, HUFFENC_AC0_55rs> {
        HCODE111_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 111
    #[inline(always)]
    pub fn hlen111(&mut self) -> HLEN111_W<'_, HUFFENC_AC0_55rs> {
        HLEN111_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_55::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_55::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_55)*/
pub struct HUFFENC_AC0_55rs;
impl crate::RegisterSpec for HUFFENC_AC0_55rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_55::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_55rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_55::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_55rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_55 to value 0
impl crate::Resettable for HUFFENC_AC0_55rs {}
