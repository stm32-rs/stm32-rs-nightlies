...
impl W {
    ///Bits 0:7 - Huffman code 112
    #[inline(always)]
    pub fn hcode112(&mut self) -> HCODE112_W<HUFFENC_AC0_56rs> {
        HCODE112_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 112
    #[inline(always)]
    pub fn hlen112(&mut self) -> HLEN112_W<HUFFENC_AC0_56rs> {
        HLEN112_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 113
    #[inline(always)]
    pub fn hcode113(&mut self) -> HCODE113_W<HUFFENC_AC0_56rs> {
        HCODE113_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 113
    #[inline(always)]
    pub fn hlen113(&mut self) -> HLEN113_W<HUFFENC_AC0_56rs> {
