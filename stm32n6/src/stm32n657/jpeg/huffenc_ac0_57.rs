...
impl W {
    ///Bits 0:7 - Huffman code 114
    #[inline(always)]
    pub fn hcode114(&mut self) -> HCODE114_W<HUFFENC_AC0_57rs> {
        HCODE114_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 114
    #[inline(always)]
    pub fn hlen114(&mut self) -> HLEN114_W<HUFFENC_AC0_57rs> {
        HLEN114_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 115
    #[inline(always)]
    pub fn hcode115(&mut self) -> HCODE115_W<HUFFENC_AC0_57rs> {
        HCODE115_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 115
    #[inline(always)]
    pub fn hlen115(&mut self) -> HLEN115_W<HUFFENC_AC0_57rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_57)*/
