...
impl W {
    ///Bits 0:7 - Huffman code 122
    #[inline(always)]
    pub fn hcode122(&mut self) -> HCODE122_W<HUFFENC_AC0_61rs> {
        HCODE122_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 122
    #[inline(always)]
    pub fn hlen122(&mut self) -> HLEN122_W<HUFFENC_AC0_61rs> {
        HLEN122_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 123
    #[inline(always)]
    pub fn hcode123(&mut self) -> HCODE123_W<HUFFENC_AC0_61rs> {
        HCODE123_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 123
    #[inline(always)]
    pub fn hlen123(&mut self) -> HLEN123_W<HUFFENC_AC0_61rs> {
