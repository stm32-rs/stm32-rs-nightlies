///Register `HUFFENC_AC0_65` reader
pub type R = crate::R<HUFFENC_AC0_65rs>;
///Register `HUFFENC_AC0_65` writer
pub type W = crate::W<HUFFENC_AC0_65rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 130
    #[inline(always)]
    pub fn hcode130(&mut self) -> HCODE130_W<'_, HUFFENC_AC0_65rs> {
        HCODE130_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 130
    #[inline(always)]
    pub fn hlen130(&mut self) -> HLEN130_W<'_, HUFFENC_AC0_65rs> {
        HLEN130_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 131
    #[inline(always)]
    pub fn hcode131(&mut self) -> HCODE131_W<'_, HUFFENC_AC0_65rs> {
        HCODE131_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 131
    #[inline(always)]
    pub fn hlen131(&mut self) -> HLEN131_W<'_, HUFFENC_AC0_65rs> {
        HLEN131_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_65::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_65::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_65)*/
pub struct HUFFENC_AC0_65rs;
impl crate::RegisterSpec for HUFFENC_AC0_65rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_65::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_65rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_65::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_65rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_65 to value 0
impl crate::Resettable for HUFFENC_AC0_65rs {}
