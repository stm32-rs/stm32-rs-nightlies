...
impl W {
    ///Bits 0:7 - Huffman code 136
    #[inline(always)]
    pub fn hcode136(&mut self) -> HCODE136_W<HUFFENC_AC0_68rs> {
        HCODE136_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 136
    #[inline(always)]
    pub fn hlen136(&mut self) -> HLEN136_W<HUFFENC_AC0_68rs> {
        HLEN136_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 137
    #[inline(always)]
    pub fn hcode137(&mut self) -> HCODE137_W<HUFFENC_AC0_68rs> {
        HCODE137_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 137
    #[inline(always)]
    pub fn hlen137(&mut self) -> HLEN137_W<HUFFENC_AC0_68rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_68)*/
