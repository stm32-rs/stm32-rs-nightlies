...
impl W {
    ///Bits 0:7 - Huffman code 140
    #[inline(always)]
    pub fn hcode140(&mut self) -> HCODE140_W<HUFFENC_AC0_70rs> {
        HCODE140_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 140
    #[inline(always)]
    pub fn hlen140(&mut self) -> HLEN140_W<HUFFENC_AC0_70rs> {
        HLEN140_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 141
    #[inline(always)]
    pub fn hcode141(&mut self) -> HCODE141_W<HUFFENC_AC0_70rs> {
        HCODE141_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 141
    #[inline(always)]
    pub fn hlen141(&mut self) -> HLEN141_W<HUFFENC_AC0_70rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_70)*/
