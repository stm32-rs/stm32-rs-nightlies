...
impl W {
    ///Bits 0:7 - Huffman code 148
    #[inline(always)]
    pub fn hcode148(&mut self) -> HCODE148_W<HUFFENC_AC0_74rs> {
        HCODE148_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 148
    #[inline(always)]
    pub fn hlen148(&mut self) -> HLEN148_W<HUFFENC_AC0_74rs> {
        HLEN148_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 149
    #[inline(always)]
    pub fn hcode149(&mut self) -> HCODE149_W<HUFFENC_AC0_74rs> {
        HCODE149_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 149
    #[inline(always)]
    pub fn hlen149(&mut self) -> HLEN149_W<HUFFENC_AC0_74rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_74)*/
