///Register `HUFFENC_AC0_75` reader
pub type R = crate::R<HUFFENC_AC0_75rs>;
///Register `HUFFENC_AC0_75` writer
pub type W = crate::W<HUFFENC_AC0_75rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 150
    #[inline(always)]
    pub fn hcode150(&mut self) -> HCODE150_W<'_, HUFFENC_AC0_75rs> {
        HCODE150_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 150
    #[inline(always)]
    pub fn hlen150(&mut self) -> HLEN150_W<'_, HUFFENC_AC0_75rs> {
        HLEN150_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 151
    #[inline(always)]
    pub fn hcode151(&mut self) -> HCODE151_W<'_, HUFFENC_AC0_75rs> {
        HCODE151_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 151
    #[inline(always)]
    pub fn hlen151(&mut self) -> HLEN151_W<'_, HUFFENC_AC0_75rs> {
        HLEN151_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac0_75::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac0_75::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_75)*/
pub struct HUFFENC_AC0_75rs;
impl crate::RegisterSpec for HUFFENC_AC0_75rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac0_75::R`](R) reader structure
impl crate::Readable for HUFFENC_AC0_75rs {}
///`write(|w| ..)` method takes [`huffenc_ac0_75::W`](W) writer structure
impl crate::Writable for HUFFENC_AC0_75rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC0_75 to value 0
impl crate::Resettable for HUFFENC_AC0_75rs {}
