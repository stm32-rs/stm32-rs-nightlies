...
impl W {
    ///Bits 0:7 - Huffman code 150
    #[inline(always)]
    pub fn hcode150(&mut self) -> HCODE150_W<HUFFENC_AC0_75rs> {
        HCODE150_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 150
    #[inline(always)]
    pub fn hlen150(&mut self) -> HLEN150_W<HUFFENC_AC0_75rs> {
        HLEN150_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 151
    #[inline(always)]
    pub fn hcode151(&mut self) -> HCODE151_W<HUFFENC_AC0_75rs> {
        HCODE151_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 151
    #[inline(always)]
    pub fn hlen151(&mut self) -> HLEN151_W<HUFFENC_AC0_75rs> {
