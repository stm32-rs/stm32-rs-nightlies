...
impl W {
    ///Bits 0:7 - Huffman code 162
    #[inline(always)]
    pub fn hcode162(&mut self) -> HCODE162_W<HUFFENC_AC0_81rs> {
        HCODE162_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 162
    #[inline(always)]
    pub fn hlen162(&mut self) -> HLEN162_W<HUFFENC_AC0_81rs> {
        HLEN162_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 163
    #[inline(always)]
    pub fn hcode163(&mut self) -> HCODE163_W<HUFFENC_AC0_81rs> {
        HCODE163_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 163
    #[inline(always)]
    pub fn hlen163(&mut self) -> HLEN163_W<HUFFENC_AC0_81rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_81)*/
