...
impl W {
    ///Bits 0:7 - Huffman code 166
    #[inline(always)]
    pub fn hcode166(&mut self) -> HCODE166_W<HUFFENC_AC0_83rs> {
        HCODE166_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 166
    #[inline(always)]
    pub fn hlen166(&mut self) -> HLEN166_W<HUFFENC_AC0_83rs> {
        HLEN166_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 167
    #[inline(always)]
    pub fn hcode167(&mut self) -> HCODE167_W<HUFFENC_AC0_83rs> {
        HCODE167_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 167
    #[inline(always)]
    pub fn hlen167(&mut self) -> HLEN167_W<HUFFENC_AC0_83rs> {
