...
impl W {
    ///Bits 0:7 - Huffman code 18
    #[inline(always)]
    pub fn hcode18(&mut self) -> HCODE18_W<HUFFENC_AC0_9rs> {
        HCODE18_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 18
    #[inline(always)]
    pub fn hlen18(&mut self) -> HLEN18_W<HUFFENC_AC0_9rs> {
        HLEN18_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 19
    #[inline(always)]
    pub fn hcode19(&mut self) -> HCODE19_W<HUFFENC_AC0_9rs> {
        HCODE19_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 19
    #[inline(always)]
    pub fn hlen19(&mut self) -> HLEN19_W<HUFFENC_AC0_9rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC0_9)*/
