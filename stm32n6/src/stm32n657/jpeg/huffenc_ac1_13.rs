...
impl W {
    ///Bits 0:7 - Huffman code 26
    #[inline(always)]
    pub fn hcode26(&mut self) -> HCODE26_W<HUFFENC_AC1_13rs> {
        HCODE26_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 26
    #[inline(always)]
    pub fn hlen26(&mut self) -> HLEN26_W<HUFFENC_AC1_13rs> {
        HLEN26_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 27
    #[inline(always)]
    pub fn hcode27(&mut self) -> HCODE27_W<HUFFENC_AC1_13rs> {
        HCODE27_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 27
    #[inline(always)]
    pub fn hlen27(&mut self) -> HLEN27_W<HUFFENC_AC1_13rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_13)*/
