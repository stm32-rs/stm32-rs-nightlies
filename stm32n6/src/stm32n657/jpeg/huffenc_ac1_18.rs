///Register `HUFFENC_AC1_18` reader
pub type R = crate::R<HUFFENC_AC1_18rs>;
///Register `HUFFENC_AC1_18` writer
pub type W = crate::W<HUFFENC_AC1_18rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 36
    #[inline(always)]
    pub fn hcode36(&mut self) -> HCODE36_W<'_, HUFFENC_AC1_18rs> {
        HCODE36_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 36
    #[inline(always)]
    pub fn hlen36(&mut self) -> HLEN36_W<'_, HUFFENC_AC1_18rs> {
        HLEN36_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 37
    #[inline(always)]
    pub fn hcode37(&mut self) -> HCODE37_W<'_, HUFFENC_AC1_18rs> {
        HCODE37_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 37
    #[inline(always)]
    pub fn hlen37(&mut self) -> HLEN37_W<'_, HUFFENC_AC1_18rs> {
        HLEN37_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_18::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_18::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_18)*/
pub struct HUFFENC_AC1_18rs;
impl crate::RegisterSpec for HUFFENC_AC1_18rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_18::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_18rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_18::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_18rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_18 to value 0
impl crate::Resettable for HUFFENC_AC1_18rs {}
