...
impl W {
    ///Bits 0:7 - Huffman code 46
    #[inline(always)]
    pub fn hcode46(&mut self) -> HCODE46_W<HUFFENC_AC1_23rs> {
        HCODE46_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 46
    #[inline(always)]
    pub fn hlen46(&mut self) -> HLEN46_W<HUFFENC_AC1_23rs> {
        HLEN46_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 47
    #[inline(always)]
    pub fn hcode47(&mut self) -> HCODE47_W<HUFFENC_AC1_23rs> {
        HCODE47_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 47
    #[inline(always)]
    pub fn hlen47(&mut self) -> HLEN47_W<HUFFENC_AC1_23rs> {
