///Register `HUFFENC_AC1_26` reader
pub type R = crate::R<HUFFENC_AC1_26rs>;
///Register `HUFFENC_AC1_26` writer
pub type W = crate::W<HUFFENC_AC1_26rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 52
    #[inline(always)]
    pub fn hcode52(&mut self) -> HCODE52_W<'_, HUFFENC_AC1_26rs> {
        HCODE52_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 52
    #[inline(always)]
    pub fn hlen52(&mut self) -> HLEN52_W<'_, HUFFENC_AC1_26rs> {
        HLEN52_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 53
    #[inline(always)]
    pub fn hcode53(&mut self) -> HCODE53_W<'_, HUFFENC_AC1_26rs> {
        HCODE53_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 53
    #[inline(always)]
    pub fn hlen53(&mut self) -> HLEN53_W<'_, HUFFENC_AC1_26rs> {
        HLEN53_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_26::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_26::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_26)*/
pub struct HUFFENC_AC1_26rs;
impl crate::RegisterSpec for HUFFENC_AC1_26rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_26::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_26rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_26::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_26rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_26 to value 0
impl crate::Resettable for HUFFENC_AC1_26rs {}
