///Register `HUFFENC_AC1_27` reader
pub type R = crate::R<HUFFENC_AC1_27rs>;
///Register `HUFFENC_AC1_27` writer
pub type W = crate::W<HUFFENC_AC1_27rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 54
    #[inline(always)]
    pub fn hcode54(&mut self) -> HCODE54_W<'_, HUFFENC_AC1_27rs> {
        HCODE54_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 54
    #[inline(always)]
    pub fn hlen54(&mut self) -> HLEN54_W<'_, HUFFENC_AC1_27rs> {
        HLEN54_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 55
    #[inline(always)]
    pub fn hcode55(&mut self) -> HCODE55_W<'_, HUFFENC_AC1_27rs> {
        HCODE55_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 55
    #[inline(always)]
    pub fn hlen55(&mut self) -> HLEN55_W<'_, HUFFENC_AC1_27rs> {
        HLEN55_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_27::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_27::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_27)*/
pub struct HUFFENC_AC1_27rs;
impl crate::RegisterSpec for HUFFENC_AC1_27rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_27::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_27rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_27::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_27rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_27 to value 0
impl crate::Resettable for HUFFENC_AC1_27rs {}
