...
impl W {
    ///Bits 0:7 - Huffman code 70
    #[inline(always)]
    pub fn hcode70(&mut self) -> HCODE70_W<HUFFENC_AC1_35rs> {
        HCODE70_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 70
    #[inline(always)]
    pub fn hlen70(&mut self) -> HLEN70_W<HUFFENC_AC1_35rs> {
        HLEN70_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 71
    #[inline(always)]
    pub fn hcode71(&mut self) -> HCODE71_W<HUFFENC_AC1_35rs> {
        HCODE71_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 71
    #[inline(always)]
    pub fn hlen71(&mut self) -> HLEN71_W<HUFFENC_AC1_35rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_35)*/
