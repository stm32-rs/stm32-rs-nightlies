...
impl W {
    ///Bits 0:7 - Huffman code 72
    #[inline(always)]
    pub fn hcode72(&mut self) -> HCODE72_W<HUFFENC_AC1_36rs> {
        HCODE72_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 72
    #[inline(always)]
    pub fn hlen72(&mut self) -> HLEN72_W<HUFFENC_AC1_36rs> {
        HLEN72_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 73
    #[inline(always)]
    pub fn hcode73(&mut self) -> HCODE73_W<HUFFENC_AC1_36rs> {
        HCODE73_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 73
    #[inline(always)]
    pub fn hlen73(&mut self) -> HLEN73_W<HUFFENC_AC1_36rs> {
