///Register `HUFFENC_AC1_36` reader
pub type R = crate::R<HUFFENC_AC1_36rs>;
///Register `HUFFENC_AC1_36` writer
pub type W = crate::W<HUFFENC_AC1_36rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 72
    #[inline(always)]
    pub fn hcode72(&mut self) -> HCODE72_W<'_, HUFFENC_AC1_36rs> {
        HCODE72_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 72
    #[inline(always)]
    pub fn hlen72(&mut self) -> HLEN72_W<'_, HUFFENC_AC1_36rs> {
        HLEN72_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 73
    #[inline(always)]
    pub fn hcode73(&mut self) -> HCODE73_W<'_, HUFFENC_AC1_36rs> {
        HCODE73_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 73
    #[inline(always)]
    pub fn hlen73(&mut self) -> HLEN73_W<'_, HUFFENC_AC1_36rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_36)*/
pub struct HUFFENC_AC1_36rs;
impl crate::RegisterSpec for HUFFENC_AC1_36rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_36::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_36rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_36::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_36rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_36 to value 0
impl crate::Resettable for HUFFENC_AC1_36rs {}
