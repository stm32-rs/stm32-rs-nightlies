...
impl W {
    ///Bits 0:7 - Huffman code 74
    #[inline(always)]
    pub fn hcode74(&mut self) -> HCODE74_W<HUFFENC_AC1_37rs> {
        HCODE74_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 74
    #[inline(always)]
    pub fn hlen74(&mut self) -> HLEN74_W<HUFFENC_AC1_37rs> {
        HLEN74_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 75
    #[inline(always)]
    pub fn hcode75(&mut self) -> HCODE75_W<HUFFENC_AC1_37rs> {
        HCODE75_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 75
    #[inline(always)]
    pub fn hlen75(&mut self) -> HLEN75_W<HUFFENC_AC1_37rs> {
