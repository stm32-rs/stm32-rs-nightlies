///Register `HUFFENC_AC1_38` reader
pub type R = crate::R<HUFFENC_AC1_38rs>;
///Register `HUFFENC_AC1_38` writer
pub type W = crate::W<HUFFENC_AC1_38rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 76
    #[inline(always)]
    pub fn hcode76(&mut self) -> HCODE76_W<'_, HUFFENC_AC1_38rs> {
        HCODE76_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 76
    #[inline(always)]
    pub fn hlen76(&mut self) -> HLEN76_W<'_, HUFFENC_AC1_38rs> {
        HLEN76_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 77
    #[inline(always)]
    pub fn hcode77(&mut self) -> HCODE77_W<'_, HUFFENC_AC1_38rs> {
        HCODE77_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 77
    #[inline(always)]
    pub fn hlen77(&mut self) -> HLEN77_W<'_, HUFFENC_AC1_38rs> {
        HLEN77_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_38::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_38::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_38)*/
pub struct HUFFENC_AC1_38rs;
impl crate::RegisterSpec for HUFFENC_AC1_38rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_38::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_38rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_38::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_38rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_38 to value 0
impl crate::Resettable for HUFFENC_AC1_38rs {}
