...
impl W {
    ///Bits 0:7 - Huffman code 76
    #[inline(always)]
    pub fn hcode76(&mut self) -> HCODE76_W<HUFFENC_AC1_38rs> {
        HCODE76_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 76
    #[inline(always)]
    pub fn hlen76(&mut self) -> HLEN76_W<HUFFENC_AC1_38rs> {
        HLEN76_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 77
    #[inline(always)]
    pub fn hcode77(&mut self) -> HCODE77_W<HUFFENC_AC1_38rs> {
        HCODE77_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 77
    #[inline(always)]
    pub fn hlen77(&mut self) -> HLEN77_W<HUFFENC_AC1_38rs> {
