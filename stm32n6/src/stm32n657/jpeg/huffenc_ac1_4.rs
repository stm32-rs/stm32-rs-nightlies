///Register `HUFFENC_AC1_4` reader
pub type R = crate::R<HUFFENC_AC1_4rs>;
///Register `HUFFENC_AC1_4` writer
pub type W = crate::W<HUFFENC_AC1_4rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 8
    #[inline(always)]
    pub fn hcode8(&mut self) -> HCODE8_W<'_, HUFFENC_AC1_4rs> {
        HCODE8_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 8
    #[inline(always)]
    pub fn hlen8(&mut self) -> HLEN8_W<'_, HUFFENC_AC1_4rs> {
        HLEN8_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 9
    #[inline(always)]
    pub fn hcode9(&mut self) -> HCODE9_W<'_, HUFFENC_AC1_4rs> {
        HCODE9_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 9
    #[inline(always)]
    pub fn hlen9(&mut self) -> HLEN9_W<'_, HUFFENC_AC1_4rs> {
        HLEN9_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_4)*/
pub struct HUFFENC_AC1_4rs;
impl crate::RegisterSpec for HUFFENC_AC1_4rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_4::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_4rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_4::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_4rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_4 to value 0
impl crate::Resettable for HUFFENC_AC1_4rs {}
