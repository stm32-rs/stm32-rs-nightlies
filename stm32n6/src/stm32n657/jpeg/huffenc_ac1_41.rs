...
impl W {
    ///Bits 0:7 - Huffman code 82
    #[inline(always)]
    pub fn hcode82(&mut self) -> HCODE82_W<HUFFENC_AC1_41rs> {
        HCODE82_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 82
    #[inline(always)]
    pub fn hlen82(&mut self) -> HLEN82_W<HUFFENC_AC1_41rs> {
        HLEN82_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 83
    #[inline(always)]
    pub fn hcode83(&mut self) -> HCODE83_W<HUFFENC_AC1_41rs> {
        HCODE83_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 83
    #[inline(always)]
    pub fn hlen83(&mut self) -> HLEN83_W<HUFFENC_AC1_41rs> {
