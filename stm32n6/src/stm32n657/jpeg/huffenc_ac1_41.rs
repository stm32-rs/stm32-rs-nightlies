///Register `HUFFENC_AC1_41` reader
pub type R = crate::R<HUFFENC_AC1_41rs>;
///Register `HUFFENC_AC1_41` writer
pub type W = crate::W<HUFFENC_AC1_41rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 82
    #[inline(always)]
    pub fn hcode82(&mut self) -> HCODE82_W<'_, HUFFENC_AC1_41rs> {
        HCODE82_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 82
    #[inline(always)]
    pub fn hlen82(&mut self) -> HLEN82_W<'_, HUFFENC_AC1_41rs> {
        HLEN82_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 83
    #[inline(always)]
    pub fn hcode83(&mut self) -> HCODE83_W<'_, HUFFENC_AC1_41rs> {
        HCODE83_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 83
    #[inline(always)]
    pub fn hlen83(&mut self) -> HLEN83_W<'_, HUFFENC_AC1_41rs> {
        HLEN83_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_41::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_41::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_41)*/
pub struct HUFFENC_AC1_41rs;
impl crate::RegisterSpec for HUFFENC_AC1_41rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_41::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_41rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_41::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_41rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_41 to value 0
impl crate::Resettable for HUFFENC_AC1_41rs {}
