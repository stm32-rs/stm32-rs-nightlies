///Register `HUFFENC_AC1_43` reader
pub type R = crate::R<HUFFENC_AC1_43rs>;
///Register `HUFFENC_AC1_43` writer
pub type W = crate::W<HUFFENC_AC1_43rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 86
    #[inline(always)]
    pub fn hcode86(&mut self) -> HCODE86_W<'_, HUFFENC_AC1_43rs> {
        HCODE86_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 86
    #[inline(always)]
    pub fn hlen86(&mut self) -> HLEN86_W<'_, HUFFENC_AC1_43rs> {
        HLEN86_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 87
    #[inline(always)]
    pub fn hcode87(&mut self) -> HCODE87_W<'_, HUFFENC_AC1_43rs> {
        HCODE87_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 87
    #[inline(always)]
    pub fn hlen87(&mut self) -> HLEN87_W<'_, HUFFENC_AC1_43rs> {
        HLEN87_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_43::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_43::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_43)*/
pub struct HUFFENC_AC1_43rs;
impl crate::RegisterSpec for HUFFENC_AC1_43rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_43::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_43rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_43::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_43rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_43 to value 0
impl crate::Resettable for HUFFENC_AC1_43rs {}
