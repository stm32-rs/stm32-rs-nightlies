...
impl W {
    ///Bits 0:7 - Huffman code 86
    #[inline(always)]
    pub fn hcode86(&mut self) -> HCODE86_W<HUFFENC_AC1_43rs> {
        HCODE86_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 86
    #[inline(always)]
    pub fn hlen86(&mut self) -> HLEN86_W<HUFFENC_AC1_43rs> {
        HLEN86_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 87
    #[inline(always)]
    pub fn hcode87(&mut self) -> HCODE87_W<HUFFENC_AC1_43rs> {
        HCODE87_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 87
    #[inline(always)]
    pub fn hlen87(&mut self) -> HLEN87_W<HUFFENC_AC1_43rs> {
