...
impl W {
    ///Bits 0:7 - Huffman code 102
    #[inline(always)]
    pub fn hcode102(&mut self) -> HCODE102_W<HUFFENC_AC1_51rs> {
        HCODE102_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 102
    #[inline(always)]
    pub fn hlen102(&mut self) -> HLEN102_W<HUFFENC_AC1_51rs> {
        HLEN102_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 103
    #[inline(always)]
    pub fn hcode103(&mut self) -> HCODE103_W<HUFFENC_AC1_51rs> {
        HCODE103_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 103
    #[inline(always)]
    pub fn hlen103(&mut self) -> HLEN103_W<HUFFENC_AC1_51rs> {
