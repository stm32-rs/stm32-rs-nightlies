...
impl W {
    ///Bits 0:7 - Huffman code 120
    #[inline(always)]
    pub fn hcode120(&mut self) -> HCODE120_W<HUFFENC_AC1_60rs> {
        HCODE120_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 120
    #[inline(always)]
    pub fn hlen120(&mut self) -> HLEN120_W<HUFFENC_AC1_60rs> {
        HLEN120_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 121
    #[inline(always)]
    pub fn hcode121(&mut self) -> HCODE121_W<HUFFENC_AC1_60rs> {
        HCODE121_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 121
    #[inline(always)]
    pub fn hlen121(&mut self) -> HLEN121_W<HUFFENC_AC1_60rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_60)*/
