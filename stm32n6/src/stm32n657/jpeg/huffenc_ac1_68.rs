///Register `HUFFENC_AC1_68` reader
pub type R = crate::R<HUFFENC_AC1_68rs>;
///Register `HUFFENC_AC1_68` writer
pub type W = crate::W<HUFFENC_AC1_68rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 136
    #[inline(always)]
    pub fn hcode136(&mut self) -> HCODE136_W<'_, HUFFENC_AC1_68rs> {
        HCODE136_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 136
    #[inline(always)]
    pub fn hlen136(&mut self) -> HLEN136_W<'_, HUFFENC_AC1_68rs> {
        HLEN136_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 137
    #[inline(always)]
    pub fn hcode137(&mut self) -> HCODE137_W<'_, HUFFENC_AC1_68rs> {
        HCODE137_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 137
    #[inline(always)]
    pub fn hlen137(&mut self) -> HLEN137_W<'_, HUFFENC_AC1_68rs> {
        HLEN137_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_68::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_68::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_68)*/
pub struct HUFFENC_AC1_68rs;
impl crate::RegisterSpec for HUFFENC_AC1_68rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_68::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_68rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_68::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_68rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_68 to value 0
impl crate::Resettable for HUFFENC_AC1_68rs {}
