...
impl W {
    ///Bits 0:7 - Huffman code 14
    #[inline(always)]
    pub fn hcode14(&mut self) -> HCODE14_W<HUFFENC_AC1_7rs> {
        HCODE14_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 14
    #[inline(always)]
    pub fn hlen14(&mut self) -> HLEN14_W<HUFFENC_AC1_7rs> {
        HLEN14_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 15
    #[inline(always)]
    pub fn hcode15(&mut self) -> HCODE15_W<HUFFENC_AC1_7rs> {
        HCODE15_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 15
    #[inline(always)]
    pub fn hlen15(&mut self) -> HLEN15_W<HUFFENC_AC1_7rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_7)*/
