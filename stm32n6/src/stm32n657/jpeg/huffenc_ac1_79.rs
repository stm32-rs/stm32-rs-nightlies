...
impl W {
    ///Bits 0:7 - Huffman code 158
    #[inline(always)]
    pub fn hcode158(&mut self) -> HCODE158_W<HUFFENC_AC1_79rs> {
        HCODE158_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 158
    #[inline(always)]
    pub fn hlen158(&mut self) -> HLEN158_W<HUFFENC_AC1_79rs> {
        HLEN158_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 159
    #[inline(always)]
    pub fn hcode159(&mut self) -> HCODE159_W<HUFFENC_AC1_79rs> {
        HCODE159_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 159
    #[inline(always)]
    pub fn hlen159(&mut self) -> HLEN159_W<HUFFENC_AC1_79rs> {
