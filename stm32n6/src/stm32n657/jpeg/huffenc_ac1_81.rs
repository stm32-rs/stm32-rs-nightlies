///Register `HUFFENC_AC1_81` reader
pub type R = crate::R<HUFFENC_AC1_81rs>;
///Register `HUFFENC_AC1_81` writer
pub type W = crate::W<HUFFENC_AC1_81rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 162
    #[inline(always)]
    pub fn hcode162(&mut self) -> HCODE162_W<'_, HUFFENC_AC1_81rs> {
        HCODE162_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 162
    #[inline(always)]
    pub fn hlen162(&mut self) -> HLEN162_W<'_, HUFFENC_AC1_81rs> {
        HLEN162_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 163
    #[inline(always)]
    pub fn hcode163(&mut self) -> HCODE163_W<'_, HUFFENC_AC1_81rs> {
        HCODE163_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 163
    #[inline(always)]
    pub fn hlen163(&mut self) -> HLEN163_W<'_, HUFFENC_AC1_81rs> {
        HLEN163_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_81::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_81::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_81)*/
pub struct HUFFENC_AC1_81rs;
impl crate::RegisterSpec for HUFFENC_AC1_81rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_81::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_81rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_81::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_81rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_81 to value 0
impl crate::Resettable for HUFFENC_AC1_81rs {}
