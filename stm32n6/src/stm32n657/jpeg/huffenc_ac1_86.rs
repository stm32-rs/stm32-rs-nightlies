...
impl W {
    ///Bits 0:7 - Huffman code 172
    #[inline(always)]
    pub fn hcode172(&mut self) -> HCODE172_W<HUFFENC_AC1_86rs> {
        HCODE172_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 172
    #[inline(always)]
    pub fn hlen172(&mut self) -> HLEN172_W<HUFFENC_AC1_86rs> {
        HLEN172_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 173
    #[inline(always)]
    pub fn hcode173(&mut self) -> HCODE173_W<HUFFENC_AC1_86rs> {
        HCODE173_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 173
    #[inline(always)]
    pub fn hlen173(&mut self) -> HLEN173_W<HUFFENC_AC1_86rs> {
