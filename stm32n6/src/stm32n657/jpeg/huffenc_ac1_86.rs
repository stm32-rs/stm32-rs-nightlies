///Register `HUFFENC_AC1_86` reader
pub type R = crate::R<HUFFENC_AC1_86rs>;
///Register `HUFFENC_AC1_86` writer
pub type W = crate::W<HUFFENC_AC1_86rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 172
    #[inline(always)]
    pub fn hcode172(&mut self) -> HCODE172_W<'_, HUFFENC_AC1_86rs> {
        HCODE172_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 172
    #[inline(always)]
    pub fn hlen172(&mut self) -> HLEN172_W<'_, HUFFENC_AC1_86rs> {
        HLEN172_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 173
    #[inline(always)]
    pub fn hcode173(&mut self) -> HCODE173_W<'_, HUFFENC_AC1_86rs> {
        HCODE173_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 173
    #[inline(always)]
    pub fn hlen173(&mut self) -> HLEN173_W<'_, HUFFENC_AC1_86rs> {
        HLEN173_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_86::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_86::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_86)*/
pub struct HUFFENC_AC1_86rs;
impl crate::RegisterSpec for HUFFENC_AC1_86rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_86::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_86rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_86::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_86rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_86 to value 0
impl crate::Resettable for HUFFENC_AC1_86rs {}
