///Register `HUFFENC_AC1_87` reader
pub type R = crate::R<HUFFENC_AC1_87rs>;
///Register `HUFFENC_AC1_87` writer
pub type W = crate::W<HUFFENC_AC1_87rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 174
    #[inline(always)]
    pub fn hcode174(&mut self) -> HCODE174_W<'_, HUFFENC_AC1_87rs> {
        HCODE174_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 174
    #[inline(always)]
    pub fn hlen174(&mut self) -> HLEN174_W<'_, HUFFENC_AC1_87rs> {
        HLEN174_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 175
    #[inline(always)]
    pub fn hcode175(&mut self) -> HCODE175_W<'_, HUFFENC_AC1_87rs> {
        HCODE175_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 175
    #[inline(always)]
    pub fn hlen175(&mut self) -> HLEN175_W<'_, HUFFENC_AC1_87rs> {
        HLEN175_W::new(self, 24)
    }
}
/**JPEG Huffman encoder AC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_ac1_87::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_ac1_87::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_AC1_87)*/
pub struct HUFFENC_AC1_87rs;
impl crate::RegisterSpec for HUFFENC_AC1_87rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_ac1_87::R`](R) reader structure
impl crate::Readable for HUFFENC_AC1_87rs {}
///`write(|w| ..)` method takes [`huffenc_ac1_87::W`](W) writer structure
impl crate::Writable for HUFFENC_AC1_87rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_AC1_87 to value 0
impl crate::Resettable for HUFFENC_AC1_87rs {}
