///Register `HUFFENC_DC0_0` reader
pub type R = crate::R<HUFFENC_DC0_0rs>;
///Register `HUFFENC_DC0_0` writer
pub type W = crate::W<HUFFENC_DC0_0rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 0
    #[inline(always)]
    pub fn hcode0(&mut self) -> HCODE0_W<'_, HUFFENC_DC0_0rs> {
        HCODE0_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 0
    #[inline(always)]
    pub fn hlen0(&mut self) -> HLEN0_W<'_, HUFFENC_DC0_0rs> {
        HLEN0_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 1
    #[inline(always)]
    pub fn hcode1(&mut self) -> HCODE1_W<'_, HUFFENC_DC0_0rs> {
        HCODE1_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 1
    #[inline(always)]
    pub fn hlen1(&mut self) -> HLEN1_W<'_, HUFFENC_DC0_0rs> {
        HLEN1_W::new(self, 24)
    }
}
/**JPEG Huffman encoder DC0

You can [`read`](crate::Reg::read) this register and get [`huffenc_dc0_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_dc0_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_DC0_0)*/
pub struct HUFFENC_DC0_0rs;
impl crate::RegisterSpec for HUFFENC_DC0_0rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_dc0_0::R`](R) reader structure
impl crate::Readable for HUFFENC_DC0_0rs {}
///`write(|w| ..)` method takes [`huffenc_dc0_0::W`](W) writer structure
impl crate::Writable for HUFFENC_DC0_0rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_DC0_0 to value 0
impl crate::Resettable for HUFFENC_DC0_0rs {}
