...
impl W {
    ///Bits 0:7 - Huffman code 6
    #[inline(always)]
    pub fn hcode6(&mut self) -> HCODE6_W<HUFFENC_DC0_3rs> {
        HCODE6_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 6
    #[inline(always)]
    pub fn hlen6(&mut self) -> HLEN6_W<HUFFENC_DC0_3rs> {
        HLEN6_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 7
    #[inline(always)]
    pub fn hcode7(&mut self) -> HCODE7_W<HUFFENC_DC0_3rs> {
        HCODE7_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 7
    #[inline(always)]
    pub fn hlen7(&mut self) -> HLEN7_W<HUFFENC_DC0_3rs> {
        HLEN7_W::new(self, 24)
    }
}
