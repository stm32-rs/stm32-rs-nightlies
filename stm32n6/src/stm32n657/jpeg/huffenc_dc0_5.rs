...
impl W {
    ///Bits 0:7 - Huffman code 10
    #[inline(always)]
    pub fn hcode10(&mut self) -> HCODE10_W<HUFFENC_DC0_5rs> {
        HCODE10_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 10
    #[inline(always)]
    pub fn hlen10(&mut self) -> HLEN10_W<HUFFENC_DC0_5rs> {
        HLEN10_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 11
    #[inline(always)]
    pub fn hcode11(&mut self) -> HCODE11_W<HUFFENC_DC0_5rs> {
        HCODE11_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 11
    #[inline(always)]
    pub fn hlen11(&mut self) -> HLEN11_W<HUFFENC_DC0_5rs> {
