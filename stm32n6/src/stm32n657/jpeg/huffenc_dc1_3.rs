///Register `HUFFENC_DC1_3` reader
pub type R = crate::R<HUFFENC_DC1_3rs>;
///Register `HUFFENC_DC1_3` writer
pub type W = crate::W<HUFFENC_DC1_3rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 6
    #[inline(always)]
    pub fn hcode6(&mut self) -> HCODE6_W<'_, HUFFENC_DC1_3rs> {
        HCODE6_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 6
    #[inline(always)]
    pub fn hlen6(&mut self) -> HLEN6_W<'_, HUFFENC_DC1_3rs> {
        HLEN6_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 7
    #[inline(always)]
    pub fn hcode7(&mut self) -> HCODE7_W<'_, HUFFENC_DC1_3rs> {
        HCODE7_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 7
    #[inline(always)]
    pub fn hlen7(&mut self) -> HLEN7_W<'_, HUFFENC_DC1_3rs> {
        HLEN7_W::new(self, 24)
    }
}
/**JPEG Huffman encoder DC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_dc1_3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_dc1_3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_DC1_3)*/
pub struct HUFFENC_DC1_3rs;
impl crate::RegisterSpec for HUFFENC_DC1_3rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_dc1_3::R`](R) reader structure
impl crate::Readable for HUFFENC_DC1_3rs {}
///`write(|w| ..)` method takes [`huffenc_dc1_3::W`](W) writer structure
impl crate::Writable for HUFFENC_DC1_3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_DC1_3 to value 0
impl crate::Resettable for HUFFENC_DC1_3rs {}
