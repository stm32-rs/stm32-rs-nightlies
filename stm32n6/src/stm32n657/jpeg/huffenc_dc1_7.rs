///Register `HUFFENC_DC1_7` reader
pub type R = crate::R<HUFFENC_DC1_7rs>;
///Register `HUFFENC_DC1_7` writer
pub type W = crate::W<HUFFENC_DC1_7rs>;
...
impl W {
    ///Bits 0:7 - Huffman code 14
    #[inline(always)]
    pub fn hcode14(&mut self) -> HCODE14_W<'_, HUFFENC_DC1_7rs> {
        HCODE14_W::new(self, 0)
    }
    ///Bits 8:11 - Huffman length 14
    #[inline(always)]
    pub fn hlen14(&mut self) -> HLEN14_W<'_, HUFFENC_DC1_7rs> {
        HLEN14_W::new(self, 8)
    }
    ///Bits 16:23 - Huffman code 15
    #[inline(always)]
    pub fn hcode15(&mut self) -> HCODE15_W<'_, HUFFENC_DC1_7rs> {
        HCODE15_W::new(self, 16)
    }
    ///Bits 24:27 - Huffman length 15
    #[inline(always)]
    pub fn hlen15(&mut self) -> HLEN15_W<'_, HUFFENC_DC1_7rs> {
        HLEN15_W::new(self, 24)
    }
}
/**JPEG Huffman encoder DC1

You can [`read`](crate::Reg::read) this register and get [`huffenc_dc1_7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`huffenc_dc1_7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFENC_DC1_7)*/
pub struct HUFFENC_DC1_7rs;
impl crate::RegisterSpec for HUFFENC_DC1_7rs {
    type Ux = u32;
}
///`read()` method returns [`huffenc_dc1_7::R`](R) reader structure
impl crate::Readable for HUFFENC_DC1_7rs {}
///`write(|w| ..)` method takes [`huffenc_dc1_7::W`](W) writer structure
impl crate::Writable for HUFFENC_DC1_7rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HUFFENC_DC1_7 to value 0
impl crate::Resettable for HUFFENC_DC1_7rs {}
