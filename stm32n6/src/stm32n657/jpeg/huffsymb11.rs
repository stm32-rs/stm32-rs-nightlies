...
impl W {
    ///Bits 0:7 - Data 44
    #[inline(always)]
    pub fn data44(&mut self) -> DATA44_W<HUFFSYMB11rs> {
        DATA44_W::new(self, 0)
    }
    ///Bits 8:15 - Data 45
    #[inline(always)]
    pub fn data45(&mut self) -> DATA45_W<HUFFSYMB11rs> {
        DATA45_W::new(self, 8)
    }
    ///Bits 16:23 - Data 46
    #[inline(always)]
    pub fn data46(&mut self) -> DATA46_W<HUFFSYMB11rs> {
        DATA46_W::new(self, 16)
    }
    ///Bits 24:31 - Data 47
    #[inline(always)]
    pub fn data47(&mut self) -> DATA47_W<HUFFSYMB11rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB11)*/
