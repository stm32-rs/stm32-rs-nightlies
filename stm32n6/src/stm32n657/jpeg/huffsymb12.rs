...
impl W {
    ///Bits 0:7 - Data 48
    #[inline(always)]
    pub fn data48(&mut self) -> DATA48_W<HUFFSYMB12rs> {
        DATA48_W::new(self, 0)
    }
    ///Bits 8:15 - Data 49
    #[inline(always)]
    pub fn data49(&mut self) -> DATA49_W<HUFFSYMB12rs> {
        DATA49_W::new(self, 8)
    }
    ///Bits 16:23 - Data 50
    #[inline(always)]
    pub fn data50(&mut self) -> DATA50_W<HUFFSYMB12rs> {
        DATA50_W::new(self, 16)
    }
    ///Bits 24:31 - Data 51
    #[inline(always)]
    pub fn data51(&mut self) -> DATA51_W<HUFFSYMB12rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB12)*/
