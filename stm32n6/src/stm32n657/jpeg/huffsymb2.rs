...
impl W {
    ///Bits 0:7 - Data 8
    #[inline(always)]
    pub fn data8(&mut self) -> DATA8_W<HUFFSYMB2rs> {
        DATA8_W::new(self, 0)
    }
    ///Bits 8:15 - Data 9
    #[inline(always)]
    pub fn data9(&mut self) -> DATA9_W<HUFFSYMB2rs> {
        DATA9_W::new(self, 8)
    }
    ///Bits 16:23 - Data 10
    #[inline(always)]
    pub fn data10(&mut self) -> DATA10_W<HUFFSYMB2rs> {
        DATA10_W::new(self, 16)
    }
    ///Bits 24:31 - Data 11
    #[inline(always)]
    pub fn data11(&mut self) -> DATA11_W<HUFFSYMB2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB2)*/
