...
impl W {
    ///Bits 0:7 - Data 92
    #[inline(always)]
    pub fn data92(&mut self) -> DATA92_W<HUFFSYMB23rs> {
        DATA92_W::new(self, 0)
    }
    ///Bits 8:15 - Data 93
    #[inline(always)]
    pub fn data93(&mut self) -> DATA93_W<HUFFSYMB23rs> {
        DATA93_W::new(self, 8)
    }
    ///Bits 16:23 - Data 94
    #[inline(always)]
    pub fn data94(&mut self) -> DATA94_W<HUFFSYMB23rs> {
        DATA94_W::new(self, 16)
    }
    ///Bits 24:31 - Data 95
    #[inline(always)]
    pub fn data95(&mut self) -> DATA95_W<HUFFSYMB23rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB23)*/
