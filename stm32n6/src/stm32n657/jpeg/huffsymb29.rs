...
impl W {
    ///Bits 0:7 - Data 116
    #[inline(always)]
    pub fn data116(&mut self) -> DATA116_W<HUFFSYMB29rs> {
        DATA116_W::new(self, 0)
    }
    ///Bits 8:15 - Data 117
    #[inline(always)]
    pub fn data117(&mut self) -> DATA117_W<HUFFSYMB29rs> {
        DATA117_W::new(self, 8)
    }
    ///Bits 16:23 - Data 118
    #[inline(always)]
    pub fn data118(&mut self) -> DATA118_W<HUFFSYMB29rs> {
        DATA118_W::new(self, 16)
    }
    ///Bits 24:31 - Data 119
    #[inline(always)]
    pub fn data119(&mut self) -> DATA119_W<HUFFSYMB29rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB29)*/
