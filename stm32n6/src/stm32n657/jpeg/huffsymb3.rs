...
impl W {
    ///Bits 0:7 - Data 12
    #[inline(always)]
    pub fn data12(&mut self) -> DATA12_W<HUFFSYMB3rs> {
        DATA12_W::new(self, 0)
    }
    ///Bits 8:15 - Data 13
    #[inline(always)]
    pub fn data13(&mut self) -> DATA13_W<HUFFSYMB3rs> {
        DATA13_W::new(self, 8)
    }
    ///Bits 16:23 - Data 14
    #[inline(always)]
    pub fn data14(&mut self) -> DATA14_W<HUFFSYMB3rs> {
        DATA14_W::new(self, 16)
    }
    ///Bits 24:31 - Data 15
    #[inline(always)]
    pub fn data15(&mut self) -> DATA15_W<HUFFSYMB3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB3)*/
