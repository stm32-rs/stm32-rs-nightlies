...
impl W {
    ///Bits 0:7 - Data 140
    #[inline(always)]
    pub fn data140(&mut self) -> DATA140_W<HUFFSYMB35rs> {
        DATA140_W::new(self, 0)
    }
    ///Bits 8:15 - Data 141
    #[inline(always)]
    pub fn data141(&mut self) -> DATA141_W<HUFFSYMB35rs> {
        DATA141_W::new(self, 8)
    }
    ///Bits 16:23 - Data 142
    #[inline(always)]
    pub fn data142(&mut self) -> DATA142_W<HUFFSYMB35rs> {
        DATA142_W::new(self, 16)
    }
    ///Bits 24:31 - Data 143
    #[inline(always)]
    pub fn data143(&mut self) -> DATA143_W<HUFFSYMB35rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB35)*/
