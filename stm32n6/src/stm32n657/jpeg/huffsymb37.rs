...
impl W {
    ///Bits 0:7 - Data 148
    #[inline(always)]
    pub fn data148(&mut self) -> DATA148_W<HUFFSYMB37rs> {
        DATA148_W::new(self, 0)
    }
    ///Bits 8:15 - Data 149
    #[inline(always)]
    pub fn data149(&mut self) -> DATA149_W<HUFFSYMB37rs> {
        DATA149_W::new(self, 8)
    }
    ///Bits 16:23 - Data 150
    #[inline(always)]
    pub fn data150(&mut self) -> DATA150_W<HUFFSYMB37rs> {
        DATA150_W::new(self, 16)
    }
    ///Bits 24:31 - Data 151
    #[inline(always)]
    pub fn data151(&mut self) -> DATA151_W<HUFFSYMB37rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB37)*/
