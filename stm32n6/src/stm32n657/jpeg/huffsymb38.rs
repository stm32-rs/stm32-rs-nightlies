...
impl W {
    ///Bits 0:7 - Data 152
    #[inline(always)]
    pub fn data152(&mut self) -> DATA152_W<HUFFSYMB38rs> {
        DATA152_W::new(self, 0)
    }
    ///Bits 8:15 - Data 153
    #[inline(always)]
    pub fn data153(&mut self) -> DATA153_W<HUFFSYMB38rs> {
        DATA153_W::new(self, 8)
    }
    ///Bits 16:23 - Data 154
    #[inline(always)]
    pub fn data154(&mut self) -> DATA154_W<HUFFSYMB38rs> {
        DATA154_W::new(self, 16)
    }
    ///Bits 24:31 - Data 155
    #[inline(always)]
    pub fn data155(&mut self) -> DATA155_W<HUFFSYMB38rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB38)*/
