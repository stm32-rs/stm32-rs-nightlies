...
impl W {
    ///Bits 0:7 - Data 184
    #[inline(always)]
    pub fn data184(&mut self) -> DATA184_W<HUFFSYMB46rs> {
        DATA184_W::new(self, 0)
    }
    ///Bits 8:15 - Data 185
    #[inline(always)]
    pub fn data185(&mut self) -> DATA185_W<HUFFSYMB46rs> {
        DATA185_W::new(self, 8)
    }
    ///Bits 16:23 - Data 186
    #[inline(always)]
    pub fn data186(&mut self) -> DATA186_W<HUFFSYMB46rs> {
        DATA186_W::new(self, 16)
    }
    ///Bits 24:31 - Data 187
    #[inline(always)]
    pub fn data187(&mut self) -> DATA187_W<HUFFSYMB46rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB46)*/
