...
impl W {
    ///Bits 0:7 - Data 200
    #[inline(always)]
    pub fn data200(&mut self) -> DATA200_W<HUFFSYMB50rs> {
        DATA200_W::new(self, 0)
    }
    ///Bits 8:15 - Data 201
    #[inline(always)]
    pub fn data201(&mut self) -> DATA201_W<HUFFSYMB50rs> {
        DATA201_W::new(self, 8)
    }
    ///Bits 16:23 - Data 202
    #[inline(always)]
    pub fn data202(&mut self) -> DATA202_W<HUFFSYMB50rs> {
        DATA202_W::new(self, 16)
    }
    ///Bits 24:31 - Data 203
    #[inline(always)]
    pub fn data203(&mut self) -> DATA203_W<HUFFSYMB50rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB50)*/
