...
impl W {
    ///Bits 0:7 - Data 204
    #[inline(always)]
    pub fn data204(&mut self) -> DATA204_W<HUFFSYMB51rs> {
        DATA204_W::new(self, 0)
    }
    ///Bits 8:15 - Data 205
    #[inline(always)]
    pub fn data205(&mut self) -> DATA205_W<HUFFSYMB51rs> {
        DATA205_W::new(self, 8)
    }
    ///Bits 16:23 - Data 206
    #[inline(always)]
    pub fn data206(&mut self) -> DATA206_W<HUFFSYMB51rs> {
        DATA206_W::new(self, 16)
    }
    ///Bits 24:31 - Data 207
    #[inline(always)]
    pub fn data207(&mut self) -> DATA207_W<HUFFSYMB51rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB51)*/
