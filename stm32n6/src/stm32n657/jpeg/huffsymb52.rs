...
impl W {
    ///Bits 0:7 - Data 208
    #[inline(always)]
    pub fn data208(&mut self) -> DATA208_W<HUFFSYMB52rs> {
        DATA208_W::new(self, 0)
    }
    ///Bits 8:15 - Data 209
    #[inline(always)]
    pub fn data209(&mut self) -> DATA209_W<HUFFSYMB52rs> {
        DATA209_W::new(self, 8)
    }
    ///Bits 16:23 - Data 210
    #[inline(always)]
    pub fn data210(&mut self) -> DATA210_W<HUFFSYMB52rs> {
        DATA210_W::new(self, 16)
    }
    ///Bits 24:31 - Data 211
    #[inline(always)]
    pub fn data211(&mut self) -> DATA211_W<HUFFSYMB52rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB52)*/
