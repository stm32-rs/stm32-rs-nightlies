...
impl W {
    ///Bits 0:7 - Data 216
    #[inline(always)]
    pub fn data216(&mut self) -> DATA216_W<HUFFSYMB54rs> {
        DATA216_W::new(self, 0)
    }
    ///Bits 8:15 - Data 217
    #[inline(always)]
    pub fn data217(&mut self) -> DATA217_W<HUFFSYMB54rs> {
        DATA217_W::new(self, 8)
    }
    ///Bits 16:23 - Data 218
    #[inline(always)]
    pub fn data218(&mut self) -> DATA218_W<HUFFSYMB54rs> {
        DATA218_W::new(self, 16)
    }
    ///Bits 24:31 - Data 219
    #[inline(always)]
    pub fn data219(&mut self) -> DATA219_W<HUFFSYMB54rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB54)*/
