...
impl W {
    ///Bits 0:7 - Data 228
    #[inline(always)]
    pub fn data228(&mut self) -> DATA228_W<HUFFSYMB57rs> {
        DATA228_W::new(self, 0)
    }
    ///Bits 8:15 - Data 229
    #[inline(always)]
    pub fn data229(&mut self) -> DATA229_W<HUFFSYMB57rs> {
        DATA229_W::new(self, 8)
    }
    ///Bits 16:23 - Data 230
    #[inline(always)]
    pub fn data230(&mut self) -> DATA230_W<HUFFSYMB57rs> {
        DATA230_W::new(self, 16)
    }
    ///Bits 24:31 - Data 231
    #[inline(always)]
    pub fn data231(&mut self) -> DATA231_W<HUFFSYMB57rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB57)*/
