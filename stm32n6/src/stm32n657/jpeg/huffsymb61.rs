...
impl W {
    ///Bits 0:7 - Data 244
    #[inline(always)]
    pub fn data244(&mut self) -> DATA244_W<HUFFSYMB61rs> {
        DATA244_W::new(self, 0)
    }
    ///Bits 8:15 - Data 245
    #[inline(always)]
    pub fn data245(&mut self) -> DATA245_W<HUFFSYMB61rs> {
        DATA245_W::new(self, 8)
    }
    ///Bits 16:23 - Data 246
    #[inline(always)]
    pub fn data246(&mut self) -> DATA246_W<HUFFSYMB61rs> {
        DATA246_W::new(self, 16)
    }
    ///Bits 24:31 - Data 247
    #[inline(always)]
    pub fn data247(&mut self) -> DATA247_W<HUFFSYMB61rs> {
