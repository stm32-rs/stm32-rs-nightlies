...
impl W {
    ///Bits 0:7 - Data 260
    #[inline(always)]
    pub fn data260(&mut self) -> DATA260_W<HUFFSYMB65rs> {
        DATA260_W::new(self, 0)
    }
    ///Bits 8:15 - Data 261
    #[inline(always)]
    pub fn data261(&mut self) -> DATA261_W<HUFFSYMB65rs> {
        DATA261_W::new(self, 8)
    }
    ///Bits 16:23 - Data 262
    #[inline(always)]
    pub fn data262(&mut self) -> DATA262_W<HUFFSYMB65rs> {
        DATA262_W::new(self, 16)
    }
    ///Bits 24:31 - Data 263
    #[inline(always)]
    pub fn data263(&mut self) -> DATA263_W<HUFFSYMB65rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB65)*/
