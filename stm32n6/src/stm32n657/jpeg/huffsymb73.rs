...
impl W {
    ///Bits 0:7 - Data 292
    #[inline(always)]
    pub fn data292(&mut self) -> DATA292_W<HUFFSYMB73rs> {
        DATA292_W::new(self, 0)
    }
    ///Bits 8:15 - Data 293
    #[inline(always)]
    pub fn data293(&mut self) -> DATA293_W<HUFFSYMB73rs> {
        DATA293_W::new(self, 8)
    }
    ///Bits 16:23 - Data 294
    #[inline(always)]
    pub fn data294(&mut self) -> DATA294_W<HUFFSYMB73rs> {
        DATA294_W::new(self, 16)
    }
    ///Bits 24:31 - Data 295
    #[inline(always)]
    pub fn data295(&mut self) -> DATA295_W<HUFFSYMB73rs> {
