...
impl W {
    ///Bits 0:7 - Data 300
    #[inline(always)]
    pub fn data300(&mut self) -> DATA300_W<HUFFSYMB75rs> {
        DATA300_W::new(self, 0)
    }
    ///Bits 8:15 - Data 301
    #[inline(always)]
    pub fn data301(&mut self) -> DATA301_W<HUFFSYMB75rs> {
        DATA301_W::new(self, 8)
    }
    ///Bits 16:23 - Data 302
    #[inline(always)]
    pub fn data302(&mut self) -> DATA302_W<HUFFSYMB75rs> {
        DATA302_W::new(self, 16)
    }
    ///Bits 24:31 - Data 303
    #[inline(always)]
    pub fn data303(&mut self) -> DATA303_W<HUFFSYMB75rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB75)*/
