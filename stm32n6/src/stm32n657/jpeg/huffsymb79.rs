...
impl W {
    ///Bits 0:7 - Data 316
    #[inline(always)]
    pub fn data316(&mut self) -> DATA316_W<HUFFSYMB79rs> {
        DATA316_W::new(self, 0)
    }
    ///Bits 8:15 - Data 317
    #[inline(always)]
    pub fn data317(&mut self) -> DATA317_W<HUFFSYMB79rs> {
        DATA317_W::new(self, 8)
    }
    ///Bits 16:23 - Data 318
    #[inline(always)]
    pub fn data318(&mut self) -> DATA318_W<HUFFSYMB79rs> {
        DATA318_W::new(self, 16)
    }
    ///Bits 24:31 - Data 319
    #[inline(always)]
    pub fn data319(&mut self) -> DATA319_W<HUFFSYMB79rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB79)*/
