...
impl W {
    ///Bits 0:7 - Data 324
    #[inline(always)]
    pub fn data324(&mut self) -> DATA324_W<HUFFSYMB81rs> {
        DATA324_W::new(self, 0)
    }
    ///Bits 8:15 - Data 325
    #[inline(always)]
    pub fn data325(&mut self) -> DATA325_W<HUFFSYMB81rs> {
        DATA325_W::new(self, 8)
    }
    ///Bits 16:23 - Data 326
    #[inline(always)]
    pub fn data326(&mut self) -> DATA326_W<HUFFSYMB81rs> {
        DATA326_W::new(self, 16)
    }
    ///Bits 24:31 - Data 327
    #[inline(always)]
    pub fn data327(&mut self) -> DATA327_W<HUFFSYMB81rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB81)*/
