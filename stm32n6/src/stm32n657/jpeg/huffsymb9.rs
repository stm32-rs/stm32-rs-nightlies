...
impl W {
    ///Bits 0:7 - Data 36
    #[inline(always)]
    pub fn data36(&mut self) -> DATA36_W<HUFFSYMB9rs> {
        DATA36_W::new(self, 0)
    }
    ///Bits 8:15 - Data 37
    #[inline(always)]
    pub fn data37(&mut self) -> DATA37_W<HUFFSYMB9rs> {
        DATA37_W::new(self, 8)
    }
    ///Bits 16:23 - Data 38
    #[inline(always)]
    pub fn data38(&mut self) -> DATA38_W<HUFFSYMB9rs> {
        DATA38_W::new(self, 16)
    }
    ///Bits 24:31 - Data 39
    #[inline(always)]
    pub fn data39(&mut self) -> DATA39_W<HUFFSYMB9rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:HUFFSYMB9)*/
