...
impl W {
    ///Bits 0:7 - Quantization coefficient 48
    #[inline(always)]
    pub fn qcoef48(&mut self) -> QCOEF48_W<QMEM0_12rs> {
        QCOEF48_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 49
    #[inline(always)]
    pub fn qcoef49(&mut self) -> QCOEF49_W<QMEM0_12rs> {
        QCOEF49_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 50
    #[inline(always)]
    pub fn qcoef50(&mut self) -> QCOEF50_W<QMEM0_12rs> {
        QCOEF50_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 51
    #[inline(always)]
    pub fn qcoef51(&mut self) -> QCOEF51_W<QMEM0_12rs> {
