///Register `QMEM0_14` reader
pub type R = crate::R<QMEM0_14rs>;
///Register `QMEM0_14` writer
pub type W = crate::W<QMEM0_14rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 56
    #[inline(always)]
    pub fn qcoef56(&mut self) -> QCOEF56_W<'_, QMEM0_14rs> {
        QCOEF56_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 57
    #[inline(always)]
    pub fn qcoef57(&mut self) -> QCOEF57_W<'_, QMEM0_14rs> {
        QCOEF57_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 58
    #[inline(always)]
    pub fn qcoef58(&mut self) -> QCOEF58_W<'_, QMEM0_14rs> {
        QCOEF58_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 59
    #[inline(always)]
    pub fn qcoef59(&mut self) -> QCOEF59_W<'_, QMEM0_14rs> {
        QCOEF59_W::new(self, 24)
    }
}
/**JPEG quantization memory 0

You can [`read`](crate::Reg::read) this register and get [`qmem0_14::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem0_14::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:QMEM0_14)*/
pub struct QMEM0_14rs;
impl crate::RegisterSpec for QMEM0_14rs {
    type Ux = u32;
}
///`read()` method returns [`qmem0_14::R`](R) reader structure
impl crate::Readable for QMEM0_14rs {}
///`write(|w| ..)` method takes [`qmem0_14::W`](W) writer structure
impl crate::Writable for QMEM0_14rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM0_14 to value 0
impl crate::Resettable for QMEM0_14rs {}
