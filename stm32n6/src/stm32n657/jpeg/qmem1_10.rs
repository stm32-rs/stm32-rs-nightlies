///Register `QMEM1_10` reader
pub type R = crate::R<QMEM1_10rs>;
///Register `QMEM1_10` writer
pub type W = crate::W<QMEM1_10rs>;
...
impl W {
    ///Bits 0:7 - Quantization coefficient 40
    #[inline(always)]
    pub fn qcoef40(&mut self) -> QCOEF40_W<'_, QMEM1_10rs> {
        QCOEF40_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 41
    #[inline(always)]
    pub fn qcoef41(&mut self) -> QCOEF41_W<'_, QMEM1_10rs> {
        QCOEF41_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 42
    #[inline(always)]
    pub fn qcoef42(&mut self) -> QCOEF42_W<'_, QMEM1_10rs> {
        QCOEF42_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 43
    #[inline(always)]
    pub fn qcoef43(&mut self) -> QCOEF43_W<'_, QMEM1_10rs> {
        QCOEF43_W::new(self, 24)
    }
}
/**JPEG quantization memory 1

You can [`read`](crate::Reg::read) this register and get [`qmem1_10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qmem1_10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:QMEM1_10)*/
pub struct QMEM1_10rs;
impl crate::RegisterSpec for QMEM1_10rs {
    type Ux = u32;
}
///`read()` method returns [`qmem1_10::R`](R) reader structure
impl crate::Readable for QMEM1_10rs {}
///`write(|w| ..)` method takes [`qmem1_10::W`](W) writer structure
impl crate::Writable for QMEM1_10rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets QMEM1_10 to value 0
impl crate::Resettable for QMEM1_10rs {}
