...
impl W {
    ///Bits 0:7 - Quantization coefficient 40
    #[inline(always)]
    pub fn qcoef40(&mut self) -> QCOEF40_W<QMEM1_10rs> {
        QCOEF40_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 41
    #[inline(always)]
    pub fn qcoef41(&mut self) -> QCOEF41_W<QMEM1_10rs> {
        QCOEF41_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 42
    #[inline(always)]
    pub fn qcoef42(&mut self) -> QCOEF42_W<QMEM1_10rs> {
        QCOEF42_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 43
    #[inline(always)]
    pub fn qcoef43(&mut self) -> QCOEF43_W<QMEM1_10rs> {
