...
impl W {
    ///Bits 0:7 - Quantization coefficient 60
    #[inline(always)]
    pub fn qcoef60(&mut self) -> QCOEF60_W<QMEM1_15rs> {
        QCOEF60_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 61
    #[inline(always)]
    pub fn qcoef61(&mut self) -> QCOEF61_W<QMEM1_15rs> {
        QCOEF61_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 62
    #[inline(always)]
    pub fn qcoef62(&mut self) -> QCOEF62_W<QMEM1_15rs> {
        QCOEF62_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 63
    #[inline(always)]
    pub fn qcoef63(&mut self) -> QCOEF63_W<QMEM1_15rs> {
