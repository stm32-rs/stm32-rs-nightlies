...
impl W {
    ///Bits 0:7 - Quantization coefficient 32
    #[inline(always)]
    pub fn qcoef32(&mut self) -> QCOEF32_W<QMEM1_8rs> {
        QCOEF32_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 33
    #[inline(always)]
    pub fn qcoef33(&mut self) -> QCOEF33_W<QMEM1_8rs> {
        QCOEF33_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 34
    #[inline(always)]
    pub fn qcoef34(&mut self) -> QCOEF34_W<QMEM1_8rs> {
        QCOEF34_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 35
    #[inline(always)]
    pub fn qcoef35(&mut self) -> QCOEF35_W<QMEM1_8rs> {
