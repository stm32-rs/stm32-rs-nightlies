...
impl W {
    ///Bits 0:7 - Quantization coefficient 8
    #[inline(always)]
    pub fn qcoef8(&mut self) -> QCOEF8_W<QMEM2_2rs> {
        QCOEF8_W::new(self, 0)
    }
    ///Bits 8:15 - Quantization coefficient 9
    #[inline(always)]
    pub fn qcoef9(&mut self) -> QCOEF9_W<QMEM2_2rs> {
        QCOEF9_W::new(self, 8)
    }
    ///Bits 16:23 - Quantization coefficient 10
    #[inline(always)]
    pub fn qcoef10(&mut self) -> QCOEF10_W<QMEM2_2rs> {
        QCOEF10_W::new(self, 16)
    }
    ///Bits 24:31 - Quantization coefficient 11
    #[inline(always)]
    pub fn qcoef11(&mut self) -> QCOEF11_W<QMEM2_2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#JPEG:QMEM2_2)*/
