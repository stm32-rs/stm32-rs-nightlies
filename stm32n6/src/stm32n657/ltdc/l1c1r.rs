...
impl W {
    ...
    #[inline(always)]
    pub fn yia(&mut self) -> YIA_W<L1C1Rrs> {
        YIA_W::new(self, 0)
    }
    ///Bit 1 - YCbCr 420 semi-planar ability for that layer
    #[inline(always)]
    pub fn yspa(&mut self) -> YSPA_W<L1C1Rrs> {
        YSPA_W::new(self, 1)
    }
    ///Bit 2 - YCbCr 420 full-planar ability for that layer
    #[inline(always)]
    pub fn yfpa(&mut self) -> YFPA_W<L1C1Rrs> {
        YFPA_W::new(self, 2)
    }
    ///Bit 31 - scaling ability for that layer
    #[inline(always)]
    pub fn sca(&mut self) -> SCA_W<L1C1Rrs> {
        SCA_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#LTDC:L1C1R)*/
pub struct L1C1Rrs;
