...
impl W {
    ///Bit 0 - Cipher context enable
    #[inline(always)]
    pub fn ccen(&mut self) -> CCEN_W<CC2CFGRrs> {
        CCEN_W::new(self, 0)
    }
    ///Bit 1 - Cipher context lock
    #[inline(always)]
    pub fn cclock(&mut self) -> CCLOCK_W<CC2CFGRrs> {
        CCLOCK_W::new(self, 1)
    }
    ///Bit 2 - Key lock
    #[inline(always)]
    pub fn keylock(&mut self) -> KEYLOCK_W<CC2CFGRrs> {
        KEYLOCK_W::new(self, 2)
    }
    ///Bits 4:5 - Authorized cipher mode
    #[inline(always)]
    pub fn mode(&mut self) -> MODE_W<CC2CFGRrs> {
        MODE_W::new(self, 4)
    }
    ///Bits 16:31 - Version
    #[inline(always)]
    pub fn version(&mut self) -> VERSION_W<CC2CFGRrs> {
