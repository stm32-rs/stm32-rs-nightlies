...
impl W {
    ///Bit 0 - Base region enable
    #[inline(always)]
    pub fn bren(&mut self) -> BREN_W<REGCR2rs> {
        BREN_W::new(self, 0)
    }
    ///Bits 9:10 - Context ID
    #[inline(always)]
    pub fn ctxid(&mut self) -> CTXID_W<REGCR2rs> {
        CTXID_W::new(self, 9)
    }
    ///Bits 14:15 - Encrypted region
    #[inline(always)]
    pub fn enc(&mut self) -> ENC_W<REGCR2rs> {
        ENC_W::new(self, 14)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#MCE1:REGCR2)*/
pub struct REGCR2rs;
