...
impl W {
    ...
    #[inline(always)]
    pub fn dflten(&mut self) -> DFLTEN_W<DFLT4CRrs> {
        DFLTEN_W::new(self, 0)
    }
    ///Bit 1 - DMA requests enable
    #[inline(always)]
    pub fn dmaen(&mut self) -> DMAEN_W<DFLT4CRrs> {
        DMAEN_W::new(self, 1)
    }
    ///Bit 2 - RXFIFO Threshold selection
    #[inline(always)]
    pub fn fth(&mut self) -> FTH_W<DFLT4CRrs> {
        FTH_W::new(self, 2)
    }
    ///Bits 4:6 - Digital filter trigger mode
    #[inline(always)]
    pub fn acqmod(&mut self) -> ACQMOD_W<DFLT4CRrs> {
        ACQMOD_W::new(self, 4)
    }
    ///Bit 8 - Digital filter trigger sensitivity selection
    #[inline(always)]
    pub fn trgsens(&mut self) -> TRGSENS_W<DFLT4CRrs> {
        TRGSENS_W::new(self, 8)
    }
    ///Bits 12:15 - Digital filter trigger signal selection
    #[inline(always)]
    pub fn trgsrc(&mut self) -> TRGSRC_W<DFLT4CRrs> {
        TRGSRC_W::new(self, 12)
    }
    ///Bit 16 - Snapshot data format
    #[inline(always)]
    pub fn snpsfmt(&mut self) -> SNPSFMT_W<DFLT4CRrs> {
        SNPSFMT_W::new(self, 16)
    }
    ///Bits 20:27 - Number of samples to be discarded
    #[inline(always)]
    pub fn nbdis(&mut self) -> NBDIS_W<DFLT4CRrs> {
        NBDIS_W::new(self, 20)
    }
}
