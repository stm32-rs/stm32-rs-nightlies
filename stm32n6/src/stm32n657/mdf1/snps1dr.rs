///Register `SNPS1DR` reader
pub type R = crate::R<SNPS1DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`snps1dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#MDF1:SNPS1DR)*/
pub struct SNPS1DRrs;
impl crate::RegisterSpec for SNPS1DRrs {
    type Ux = u32;
}
///`read()` method returns [`snps1dr::R`](R) reader structure
impl crate::Readable for SNPS1DRrs {}
///`reset()` method sets SNPS1DR to value 0
impl crate::Resettable for SNPS1DRrs {}
