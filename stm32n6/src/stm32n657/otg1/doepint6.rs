...
impl W {
    ///Bit 0 - Transfer completed interrupt
    #[inline(always)]
    pub fn xfrc(&mut self) -> XFRC_W<'_, DOEPINT6rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - Endpoint disabled interrupt
    #[inline(always)]
    pub fn epdisd(&mut self) -> EPDISD_W<'_, DOEPINT6rs> {
        EPDISD_W::new(self, 1)
    }
    ///Bit 2 - AHB error
    #[inline(always)]
    pub fn ahberr(&mut self) -> AHBERR_W<'_, DOEPINT6rs> {
        AHBERR_W::new(self, 2)
    }
    ///Bit 3 - SETUP phase done
    #[inline(always)]
    pub fn stup(&mut self) -> STUP_W<'_, DOEPINT6rs> {
        STUP_W::new(self, 3)
    }
    ///Bit 4 - OUT token received when endpoint disabled
    #[inline(always)]
    pub fn otepdis(&mut self) -> OTEPDIS_W<'_, DOEPINT6rs> {
        OTEPDIS_W::new(self, 4)
    }
    ///Bit 5 - Status phase received for control write
    #[inline(always)]
    pub fn stsphsrx(&mut self) -> STSPHSRX_W<'_, DOEPINT6rs> {
        STSPHSRX_W::new(self, 5)
    }
    ///Bit 6 - Back-to-back SETUP packets received
    #[inline(always)]
    pub fn b2bstup(&mut self) -> B2BSTUP_W<'_, DOEPINT6rs> {
        B2BSTUP_W::new(self, 6)
    }
    ///Bit 8 - OUT packet error
    #[inline(always)]
    pub fn outpkterr(&mut self) -> OUTPKTERR_W<'_, DOEPINT6rs> {
        OUTPKTERR_W::new(self, 8)
    }
    ///Bit 12 - Babble error interrupt
    #[inline(always)]
    pub fn berr(&mut self) -> BERR_W<'_, DOEPINT6rs> {
        BERR_W::new(self, 12)
    }
    ///Bit 13 - NAK input
    #[inline(always)]
    pub fn nak(&mut self) -> NAK_W<'_, DOEPINT6rs> {
        NAK_W::new(self, 13)
    }
    ///Bit 14 - NYET interrupt
    #[inline(always)]
    pub fn nyet(&mut self) -> NYET_W<'_, DOEPINT6rs> {
        NYET_W::new(self, 14)
    }
    ///Bit 15 - Setup packet received
    #[inline(always)]
    pub fn stpktrx(&mut self) -> STPKTRX_W<'_, DOEPINT6rs> {
