...
impl W {
    ///Bit 16 - Host CDP behavior enable
    #[inline(always)]
    pub fn hcdpen(&mut self) -> HCDPEN_W<GCCFGrs> {
        HCDPEN_W::new(self, 16)
    }
    ///Bit 17 - Host CDP port voltage detector enable on DP
    #[inline(always)]
    pub fn hcdpdeten(&mut self) -> HCDPDETEN_W<GCCFGrs> {
        HCDPDETEN_W::new(self, 17)
    }
    ///Bit 18 - Host CDP port Voltage source enable on DM
    #[inline(always)]
    pub fn hvdmsrcen(&mut self) -> HVDMSRCEN_W<GCCFGrs> {
    ...
    ///Bit 23 - Software override value of the VBUS B-session detection
    #[inline(always)]
    pub fn vbvaloval(&mut self) -> VBVALOVAL_W<GCCFGrs> {
        VBVALOVAL_W::new(self, 23)
    }
    ///Bit 25 - Force host mode pull-downs
    #[inline(always)]
    pub fn forcehostpd(&mut self) -> FORCEHOSTPD_W<GCCFGrs> {
    ...
    ///Bit 28 - Disable ID pin pull-up
    #[inline(always)]
    pub fn idpullupdis(&mut self) -> IDPULLUPDIS_W<GCCFGrs> {
