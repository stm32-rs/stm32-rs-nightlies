...
impl W {
    ///Bit 1 - Mode mismatch interrupt
    #[inline(always)]
    pub fn mmis(&mut self) -> MMIS_W<'_, GINTSTS_ALTERNATErs> {
        MMIS_W::new(self, 1)
    }
    ///Bit 3 - Start of frame
    #[inline(always)]
    pub fn sof(&mut self) -> SOF_W<'_, GINTSTS_ALTERNATErs> {
        SOF_W::new(self, 3)
    }
    ///Bit 10 - Early suspend
    #[inline(always)]
    pub fn esusp(&mut self) -> ESUSP_W<'_, GINTSTS_ALTERNATErs> {
        ESUSP_W::new(self, 10)
    }
    ///Bit 11 - USB suspend
    #[inline(always)]
    pub fn usbsusp(&mut self) -> USBSUSP_W<'_, GINTSTS_ALTERNATErs> {
        USBSUSP_W::new(self, 11)
    }
    ///Bit 12 - USB reset
    #[inline(always)]
    pub fn usbrst(&mut self) -> USBRST_W<'_, GINTSTS_ALTERNATErs> {
        USBRST_W::new(self, 12)
    }
    ///Bit 13 - Enumeration done
    #[inline(always)]
    pub fn enumdne(&mut self) -> ENUMDNE_W<'_, GINTSTS_ALTERNATErs> {
        ENUMDNE_W::new(self, 13)
    }
    ///Bit 14 - Isochronous OUT packet dropped interrupt
    #[inline(always)]
    pub fn isoodrp(&mut self) -> ISOODRP_W<'_, GINTSTS_ALTERNATErs> {
        ISOODRP_W::new(self, 14)
    }
    ///Bit 15 - End of periodic frame interrupt
    #[inline(always)]
    pub fn eopf(&mut self) -> EOPF_W<'_, GINTSTS_ALTERNATErs> {
        EOPF_W::new(self, 15)
    }
    ///Bit 20 - Incomplete isochronous IN transfer
    #[inline(always)]
    pub fn iisoixfr(&mut self) -> IISOIXFR_W<'_, GINTSTS_ALTERNATErs> {
        IISOIXFR_W::new(self, 20)
    }
    ///Bit 21 - Incomplete isochronous OUT transfer
    #[inline(always)]
    pub fn incompisoout(&mut self) -> INCOMPISOOUT_W<'_, GINTSTS_ALTERNATErs> {
        INCOMPISOOUT_W::new(self, 21)
    }
    ///Bit 22 - Data fetch suspended
    #[inline(always)]
    pub fn datafsusp(&mut self) -> DATAFSUSP_W<'_, GINTSTS_ALTERNATErs> {
        DATAFSUSP_W::new(self, 22)
    }
    ///Bit 23 - Reset detected interrupt
    #[inline(always)]
    pub fn rstdet(&mut self) -> RSTDET_W<'_, GINTSTS_ALTERNATErs> {
        RSTDET_W::new(self, 23)
    }
    ///Bit 27 - LPM interrupt
    #[inline(always)]
    pub fn lpmint(&mut self) -> LPMINT_W<'_, GINTSTS_ALTERNATErs> {
        LPMINT_W::new(self, 27)
    }
    ///Bit 28 - Connector ID status change
    #[inline(always)]
    pub fn cidschg(&mut self) -> CIDSCHG_W<'_, GINTSTS_ALTERNATErs> {
        CIDSCHG_W::new(self, 28)
    }
    ///Bit 29 - Disconnect detected interrupt
    #[inline(always)]
    pub fn discint(&mut self) -> DISCINT_W<'_, GINTSTS_ALTERNATErs> {
        DISCINT_W::new(self, 29)
    }
    ///Bit 30 - Session request/new session detected interrupt
    #[inline(always)]
    pub fn srqint(&mut self) -> SRQINT_W<'_, GINTSTS_ALTERNATErs> {
        SRQINT_W::new(self, 30)
    }
    ///Bit 31 - Resume/remote wake-up detected interrupt
    #[inline(always)]
    pub fn wkupint(&mut self) -> WKUPINT_W<'_, GINTSTS_ALTERNATErs> {
