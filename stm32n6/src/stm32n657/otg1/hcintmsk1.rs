...
impl W {
    ///Bit 0 - Transfer completed mask
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, HCINTMSK1rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - Channel halted mask
    #[inline(always)]
    pub fn chhm(&mut self) -> CHHM_W<'_, HCINTMSK1rs> {
        CHHM_W::new(self, 1)
    }
    ///Bit 2 - AHB error.
    #[inline(always)]
    pub fn ahberrm(&mut self) -> AHBERRM_W<'_, HCINTMSK1rs> {
        AHBERRM_W::new(self, 2)
    }
    ///Bit 3 - STALL response received interrupt mask.
    #[inline(always)]
    pub fn stallm(&mut self) -> STALLM_W<'_, HCINTMSK1rs> {
        STALLM_W::new(self, 3)
    }
    ///Bit 4 - NAK response received interrupt mask.
    #[inline(always)]
    pub fn nakm(&mut self) -> NAKM_W<'_, HCINTMSK1rs> {
        NAKM_W::new(self, 4)
    }
    ///Bit 5 - ACK response received/transmitted interrupt mask.
    #[inline(always)]
    pub fn ackm(&mut self) -> ACKM_W<'_, HCINTMSK1rs> {
        ACKM_W::new(self, 5)
    }
    ///Bit 6 - response received interrupt mask.
    #[inline(always)]
    pub fn nyet(&mut self) -> NYET_W<'_, HCINTMSK1rs> {
        NYET_W::new(self, 6)
    }
    ///Bit 7 - Transaction error mask.
    #[inline(always)]
    pub fn txerrm(&mut self) -> TXERRM_W<'_, HCINTMSK1rs> {
        TXERRM_W::new(self, 7)
    }
    ///Bit 8 - Babble error mask.
    #[inline(always)]
    pub fn bberrm(&mut self) -> BBERRM_W<'_, HCINTMSK1rs> {
        BBERRM_W::new(self, 8)
    }
    ///Bit 9 - Frame overrun mask.
    #[inline(always)]
    pub fn frmorm(&mut self) -> FRMORM_W<'_, HCINTMSK1rs> {
        FRMORM_W::new(self, 9)
    }
    ///Bit 10 - Data toggle error mask.
    #[inline(always)]
    pub fn dterrm(&mut self) -> DTERRM_W<'_, HCINTMSK1rs> {
