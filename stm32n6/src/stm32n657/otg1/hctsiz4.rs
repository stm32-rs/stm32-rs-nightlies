///Register `HCTSIZ4` reader
pub type R = crate::R<HCTSIZ4rs>;
///Register `HCTSIZ4` writer
...
impl W {
    ///Bits 0:18 - Transfer size
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, HCTSIZ4rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - Packet count
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, HCTSIZ4rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - Data PID
    #[inline(always)]
    pub fn dpid(&mut self) -> DPID_W<'_, HCTSIZ4rs> {
        DPID_W::new(self, 29)
    }
    ///Bit 31 - Do Ping
    #[inline(always)]
    pub fn dopng(&mut self) -> DOPNG_W<'_, HCTSIZ4rs> {
        DOPNG_W::new(self, 31)
    }
}
...
///`read()` method returns [`hctsiz4::R`](R) reader structure
impl crate::Readable for HCTSIZ4rs {}
///`write(|w| ..)` method takes [`hctsiz4::W`](W) writer structure
