...
impl W {
    ///Bit 5 - Parallel data clock polarity
    #[inline(always)]
    pub fn ckpol(&mut self) -> CKPOL_W<'_, CRrs> {
        CKPOL_W::new(self, 5)
    }
    ///Bit 6 - Data enable (PSSI_DE) polarity
    #[inline(always)]
    pub fn depol(&mut self) -> DEPOL_W<'_, CRrs> {
        DEPOL_W::new(self, 6)
    }
    ///Bit 8 - Ready (PSSI_RDY) polarity
    #[inline(always)]
    pub fn rdypol(&mut self) -> RDYPOL_W<'_, CRrs> {
        RDYPOL_W::new(self, 8)
    }
    ///Bits 10:11 - Extended data mode
    #[inline(always)]
    ...
    ///Bits 18:20 - Data enable and ready configuration
    #[inline(always)]
    pub fn derdycfg(&mut self) -> DERDYCFG_W<'_, CRrs> {
        DERDYCFG_W::new(self, 18)
    }
    ///Bit 29 - Clock source
    #[inline(always)]
    pub fn cksrc(&mut self) -> CKSRC_W<'_, CRrs> {
        CKSRC_W::new(self, 29)
    }
    ///Bit 30 - DMA enable bit
    #[inline(always)]
    ...
    ///Bit 31 - Data direction selection bit
    #[inline(always)]
    pub fn outen(&mut self) -> OUTEN_W<'_, CRrs> {
        OUTEN_W::new(self, 31)
    }
}
