...
///Field `VOSRDY` reader - VOS ready bit for Vless thansub>COREless than/sub> voltage scaling output selection
pub type VOSRDY_R = crate::BitReader;
///Field `ACTVOS` reader - VOS currently applied for Vless thansub>COREless than/sub> voltage scaling selection
...
impl R {
    ...
    ///Bit 1 - VOS ready bit for Vless thansub>COREless than/sub> voltage scaling output selection
    #[inline(always)]
    pub fn vosrdy(&self) -> VOSRDY_R {
        VOSRDY_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 16 - VOS currently applied for Vless thansub>COREless than/sub> voltage scaling selection
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#PWR:VOSCR)*/
pub struct VOSCRrs;
