...
impl W {
    ///Bit 4 - GPDMA1 enable
    #[inline(always)]
    pub fn gpdma1enc(&mut self) -> GPDMA1ENC_W<AHB1ENCRrs> {
        GPDMA1ENC_W::new(self, 4)
    }
    ///Bit 5 - ADC12 enable
    #[inline(always)]
    pub fn adc12enc(&mut self) -> ADC12ENC_W<AHB1ENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:AHB1ENCR)*/
