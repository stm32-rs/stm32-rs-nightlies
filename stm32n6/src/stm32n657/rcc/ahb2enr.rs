...
impl W {
    ///Bit 12 - RAMCFG enable
    #[inline(always)]
    pub fn ramcfgen(&mut self) -> RAMCFGEN_W<AHB2ENRrs> {
        RAMCFGEN_W::new(self, 12)
    }
    ///Bit 16 - MDF1 enable
    #[inline(always)]
    pub fn mdf1en(&mut self) -> MDF1EN_W<AHB2ENRrs> {
        MDF1EN_W::new(self, 16)
    }
    ///Bit 17 - ADF enable
    #[inline(always)]
    pub fn adf1en(&mut self) -> ADF1EN_W<AHB2ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:AHB2ENR)*/
