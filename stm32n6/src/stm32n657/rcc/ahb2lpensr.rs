...
impl W {
    ...
    #[inline(always)]
    pub fn ramcfglpens(&mut self) -> RAMCFGLPENS_W<AHB2LPENSRrs> {
        RAMCFGLPENS_W::new(self, 12)
    }
    ///Bit 16 - MDF1 sleep enable
    #[inline(always)]
    pub fn mdf1lpens(&mut self) -> MDF1LPENS_W<AHB2LPENSRrs> {
        MDF1LPENS_W::new(self, 16)
    }
    ///Bit 17 - ADF1 sleep enable
    #[inline(always)]
    pub fn adf1lpens(&mut self) -> ADF1LPENS_W<AHB2LPENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:AHB2LPENSR)*/
