...
impl W {
    ///Bit 0 - RNG enable
    #[inline(always)]
    pub fn rngenc(&mut self) -> RNGENC_W<AHB3ENCRrs> {
        RNGENC_W::new(self, 0)
    }
    ///Bit 1 - HASH enable
    #[inline(always)]
    pub fn hashenc(&mut self) -> HASHENC_W<AHB3ENCRrs> {
        HASHENC_W::new(self, 1)
    }
    ///Bit 2 - CRYP enable
    #[inline(always)]
    pub fn crypenc(&mut self) -> CRYPENC_W<AHB3ENCRrs> {
        CRYPENC_W::new(self, 2)
    }
    ///Bit 4 - SAES enable
    #[inline(always)]
    pub fn saesenc(&mut self) -> SAESENC_W<AHB3ENCRrs> {
        SAESENC_W::new(self, 4)
    }
    ///Bit 8 - PKA enable
    #[inline(always)]
    pub fn pkaenc(&mut self) -> PKAENC_W<AHB3ENCRrs> {
        PKAENC_W::new(self, 8)
    }
    ///Bit 9 - RIFSC enable
    #[inline(always)]
    pub fn rifscenc(&mut self) -> RIFSCENC_W<AHB3ENCRrs> {
        RIFSCENC_W::new(self, 9)
    }
    ///Bit 10 - IAC enable
    #[inline(always)]
    pub fn iacenc(&mut self) -> IACENC_W<AHB3ENCRrs> {
        IACENC_W::new(self, 10)
    }
    ///Bit 14 - RISAF enable
    #[inline(always)]
    pub fn risafenc(&mut self) -> RISAFENC_W<AHB3ENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:AHB3ENCR)*/
