...
impl W {
    ...
    ///Bit 16 - GPIOQ enable
    #[inline(always)]
    pub fn gpioqen(&mut self) -> GPIOQEN_W<AHB4ENRrs> {
        GPIOQEN_W::new(self, 16)
    }
    ///Bit 18 - PWR enable
    #[inline(always)]
    pub fn pwren(&mut self) -> PWREN_W<AHB4ENRrs> {
        PWREN_W::new(self, 18)
    }
    ///Bit 19 - CRC enable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:AHB4ENR)*/
