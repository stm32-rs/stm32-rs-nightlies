...
impl W {
    ///Bit 0 - TIM2 enable
    #[inline(always)]
    pub fn tim2enc(&mut self) -> TIM2ENC_W<APB1LENCRrs> {
        TIM2ENC_W::new(self, 0)
    }
    ///Bit 1 - TIM3 enable
    #[inline(always)]
    pub fn tim3enc(&mut self) -> TIM3ENC_W<APB1LENCRrs> {
        TIM3ENC_W::new(self, 1)
    }
    ///Bit 2 - TIM4 enable
    #[inline(always)]
    pub fn tim4enc(&mut self) -> TIM4ENC_W<APB1LENCRrs> {
        TIM4ENC_W::new(self, 2)
    }
    ///Bit 3 - TIM5 enable
    #[inline(always)]
    pub fn tim5enc(&mut self) -> TIM5ENC_W<APB1LENCRrs> {
        TIM5ENC_W::new(self, 3)
    }
    ///Bit 4 - TIM6 enable
    #[inline(always)]
    pub fn tim6enc(&mut self) -> TIM6ENC_W<APB1LENCRrs> {
        TIM6ENC_W::new(self, 4)
    }
    ///Bit 5 - TIM7 enable
    #[inline(always)]
    pub fn tim7enc(&mut self) -> TIM7ENC_W<APB1LENCRrs> {
        TIM7ENC_W::new(self, 5)
    }
    ///Bit 6 - TIM12 enable
    #[inline(always)]
    pub fn tim12enc(&mut self) -> TIM12ENC_W<APB1LENCRrs> {
        TIM12ENC_W::new(self, 6)
    }
    ///Bit 7 - TIM13 enable
    #[inline(always)]
    pub fn tim13enc(&mut self) -> TIM13ENC_W<APB1LENCRrs> {
        TIM13ENC_W::new(self, 7)
    }
    ///Bit 8 - TIM14 enable
    #[inline(always)]
    pub fn tim14enc(&mut self) -> TIM14ENC_W<APB1LENCRrs> {
        TIM14ENC_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1 enable
    #[inline(always)]
    pub fn lptim1enc(&mut self) -> LPTIM1ENC_W<APB1LENCRrs> {
        LPTIM1ENC_W::new(self, 9)
    }
    ///Bit 12 - TIM10 enable
    #[inline(always)]
    pub fn tim10enc(&mut self) -> TIM10ENC_W<APB1LENCRrs> {
        TIM10ENC_W::new(self, 12)
    }
    ///Bit 13 - TIM11 enable
    #[inline(always)]
    pub fn tim11enc(&mut self) -> TIM11ENC_W<APB1LENCRrs> {
        TIM11ENC_W::new(self, 13)
    }
    ///Bit 14 - SPI2 enable
    #[inline(always)]
    pub fn spi2enc(&mut self) -> SPI2ENC_W<APB1LENCRrs> {
        SPI2ENC_W::new(self, 14)
    }
    ///Bit 15 - SPI3 enable
    #[inline(always)]
    pub fn spi3enc(&mut self) -> SPI3ENC_W<APB1LENCRrs> {
        SPI3ENC_W::new(self, 15)
    }
    ///Bit 16 - SPDIFRX1 enable
    #[inline(always)]
    pub fn spdifrx1enc(&mut self) -> SPDIFRX1ENC_W<APB1LENCRrs> {
        SPDIFRX1ENC_W::new(self, 16)
    }
    ///Bit 17 - USART2 enable
    #[inline(always)]
    pub fn usart2enc(&mut self) -> USART2ENC_W<APB1LENCRrs> {
        USART2ENC_W::new(self, 17)
    }
    ///Bit 18 - USART3 enable
    #[inline(always)]
    pub fn usart3enc(&mut self) -> USART3ENC_W<APB1LENCRrs> {
        USART3ENC_W::new(self, 18)
    }
    ///Bit 19 - UART4 enable
    #[inline(always)]
    pub fn uart4enc(&mut self) -> UART4ENC_W<APB1LENCRrs> {
        UART4ENC_W::new(self, 19)
    }
    ///Bit 20 - UART5 enable
    #[inline(always)]
    pub fn uart5enc(&mut self) -> UART5ENC_W<APB1LENCRrs> {
        UART5ENC_W::new(self, 20)
    }
    ///Bit 21 - I2C1 enable
    #[inline(always)]
    pub fn i2c1enc(&mut self) -> I2C1ENC_W<APB1LENCRrs> {
        I2C1ENC_W::new(self, 21)
    }
    ///Bit 22 - I2C2 enable
    #[inline(always)]
    pub fn i2c2enc(&mut self) -> I2C2ENC_W<APB1LENCRrs> {
        I2C2ENC_W::new(self, 22)
    }
    ///Bit 23 - I2C3 enable
    #[inline(always)]
    pub fn i2c3enc(&mut self) -> I2C3ENC_W<APB1LENCRrs> {
        I2C3ENC_W::new(self, 23)
    }
    ///Bit 24 - I3C1 enable
    #[inline(always)]
    pub fn i3c1enc(&mut self) -> I3C1ENC_W<APB1LENCRrs> {
        I3C1ENC_W::new(self, 24)
    }
    ///Bit 25 - I3C2 enable
    #[inline(always)]
    pub fn i3c2enc(&mut self) -> I3C2ENC_W<APB1LENCRrs> {
        I3C2ENC_W::new(self, 25)
    }
    ///Bit 30 - UART7 enable
    #[inline(always)]
    pub fn uart7enc(&mut self) -> UART7ENC_W<APB1LENCRrs> {
        UART7ENC_W::new(self, 30)
    }
    ///Bit 31 - UART8 enable
    #[inline(always)]
    pub fn uart8enc(&mut self) -> UART8ENC_W<APB1LENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB1LENCR)*/
