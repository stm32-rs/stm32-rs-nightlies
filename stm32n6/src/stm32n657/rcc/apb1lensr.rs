...
impl W {
    ///Bit 0 - TIM2 enable
    #[inline(always)]
    pub fn tim2ens(&mut self) -> TIM2ENS_W<APB1LENSRrs> {
        TIM2ENS_W::new(self, 0)
    }
    ///Bit 1 - TIM3 enable
    #[inline(always)]
    pub fn tim3ens(&mut self) -> TIM3ENS_W<APB1LENSRrs> {
        TIM3ENS_W::new(self, 1)
    }
    ///Bit 2 - TIM4 enable
    #[inline(always)]
    pub fn tim4ens(&mut self) -> TIM4ENS_W<APB1LENSRrs> {
        TIM4ENS_W::new(self, 2)
    }
    ///Bit 3 - TIM5 enable
    #[inline(always)]
    pub fn tim5ens(&mut self) -> TIM5ENS_W<APB1LENSRrs> {
        TIM5ENS_W::new(self, 3)
    }
    ///Bit 4 - TIM6 enable
    #[inline(always)]
    pub fn tim6ens(&mut self) -> TIM6ENS_W<APB1LENSRrs> {
        TIM6ENS_W::new(self, 4)
    }
    ///Bit 5 - TIM7 enable
    #[inline(always)]
    pub fn tim7ens(&mut self) -> TIM7ENS_W<APB1LENSRrs> {
        TIM7ENS_W::new(self, 5)
    }
    ///Bit 6 - TIM12 enable
    #[inline(always)]
    pub fn tim12ens(&mut self) -> TIM12ENS_W<APB1LENSRrs> {
        TIM12ENS_W::new(self, 6)
    }
    ///Bit 7 - TIM13 enable
    #[inline(always)]
    pub fn tim13ens(&mut self) -> TIM13ENS_W<APB1LENSRrs> {
        TIM13ENS_W::new(self, 7)
    }
    ///Bit 8 - TIM14 enable
    #[inline(always)]
    pub fn tim14ens(&mut self) -> TIM14ENS_W<APB1LENSRrs> {
        TIM14ENS_W::new(self, 8)
    }
    ///Bit 9 - LPTIM1 enable
    #[inline(always)]
    pub fn lptim1ens(&mut self) -> LPTIM1ENS_W<APB1LENSRrs> {
        LPTIM1ENS_W::new(self, 9)
    }
    ///Bit 11 - WWDG enable
    #[inline(always)]
    pub fn wwdgens(&mut self) -> WWDGENS_W<APB1LENSRrs> {
        WWDGENS_W::new(self, 11)
    }
    ///Bit 12 - TIM10 enable
    #[inline(always)]
    pub fn tim10ens(&mut self) -> TIM10ENS_W<APB1LENSRrs> {
        TIM10ENS_W::new(self, 12)
    }
    ///Bit 13 - TIM11 enable
    #[inline(always)]
    pub fn tim11ens(&mut self) -> TIM11ENS_W<APB1LENSRrs> {
        TIM11ENS_W::new(self, 13)
    }
    ///Bit 14 - SPI2 enable
    #[inline(always)]
    pub fn spi2ens(&mut self) -> SPI2ENS_W<APB1LENSRrs> {
        SPI2ENS_W::new(self, 14)
    }
    ///Bit 15 - SPI3 enable
    #[inline(always)]
    pub fn spi3ens(&mut self) -> SPI3ENS_W<APB1LENSRrs> {
        SPI3ENS_W::new(self, 15)
    }
    ///Bit 16 - SPDIFRX1 enable
    #[inline(always)]
    pub fn spdifrx1ens(&mut self) -> SPDIFRX1ENS_W<APB1LENSRrs> {
        SPDIFRX1ENS_W::new(self, 16)
    }
    ///Bit 17 - USART2 enable
    #[inline(always)]
    pub fn usart2ens(&mut self) -> USART2ENS_W<APB1LENSRrs> {
        USART2ENS_W::new(self, 17)
    }
    ///Bit 18 - USART3 enable
    #[inline(always)]
    pub fn usart3ens(&mut self) -> USART3ENS_W<APB1LENSRrs> {
        USART3ENS_W::new(self, 18)
    }
    ///Bit 19 - UART4 enable
    #[inline(always)]
    pub fn uart4ens(&mut self) -> UART4ENS_W<APB1LENSRrs> {
        UART4ENS_W::new(self, 19)
    }
    ///Bit 20 - UART5 enable
    #[inline(always)]
    pub fn uart5ens(&mut self) -> UART5ENS_W<APB1LENSRrs> {
        UART5ENS_W::new(self, 20)
    }
    ///Bit 21 - I2C1 enable
    #[inline(always)]
    pub fn i2c1ens(&mut self) -> I2C1ENS_W<APB1LENSRrs> {
        I2C1ENS_W::new(self, 21)
    }
    ///Bit 22 - I2C2 enable
    #[inline(always)]
    pub fn i2c2ens(&mut self) -> I2C2ENS_W<APB1LENSRrs> {
        I2C2ENS_W::new(self, 22)
    }
    ///Bit 23 - I2C3 enable
    #[inline(always)]
    pub fn i2c3ens(&mut self) -> I2C3ENS_W<APB1LENSRrs> {
        I2C3ENS_W::new(self, 23)
    }
    ///Bit 24 - I3C1 enable
    #[inline(always)]
    pub fn i3c1ens(&mut self) -> I3C1ENS_W<APB1LENSRrs> {
        I3C1ENS_W::new(self, 24)
    }
    ///Bit 25 - I3C2 enable
    #[inline(always)]
    pub fn i3c2ens(&mut self) -> I3C2ENS_W<APB1LENSRrs> {
        I3C2ENS_W::new(self, 25)
    }
    ///Bit 30 - UART7 enable
    #[inline(always)]
    pub fn uart7ens(&mut self) -> UART7ENS_W<APB1LENSRrs> {
        UART7ENS_W::new(self, 30)
    }
    ///Bit 31 - UART8 enable
    #[inline(always)]
    pub fn uart8ens(&mut self) -> UART8ENS_W<APB1LENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB1LENSR)*/
