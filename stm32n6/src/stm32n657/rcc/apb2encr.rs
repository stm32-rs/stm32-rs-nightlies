...
impl W {
    ///Bit 0 - TIM1 enable
    #[inline(always)]
    pub fn tim1enc(&mut self) -> TIM1ENC_W<APB2ENCRrs> {
        TIM1ENC_W::new(self, 0)
    }
    ///Bit 1 - TIM8 enable
    #[inline(always)]
    pub fn tim8enc(&mut self) -> TIM8ENC_W<APB2ENCRrs> {
        TIM8ENC_W::new(self, 1)
    }
    ///Bit 4 - USART1 enable
    #[inline(always)]
    pub fn usart1enc(&mut self) -> USART1ENC_W<APB2ENCRrs> {
        USART1ENC_W::new(self, 4)
    }
    ///Bit 5 - USART6 enable
    #[inline(always)]
    pub fn usart6enc(&mut self) -> USART6ENC_W<APB2ENCRrs> {
        USART6ENC_W::new(self, 5)
    }
    ///Bit 6 - UART9 enable
    #[inline(always)]
    pub fn uart9enc(&mut self) -> UART9ENC_W<APB2ENCRrs> {
        UART9ENC_W::new(self, 6)
    }
    ///Bit 7 - USART10 enable
    #[inline(always)]
    pub fn usart10enc(&mut self) -> USART10ENC_W<APB2ENCRrs> {
        USART10ENC_W::new(self, 7)
    }
    ///Bit 12 - SPI1 enable
    #[inline(always)]
    pub fn spi1enc(&mut self) -> SPI1ENC_W<APB2ENCRrs> {
        SPI1ENC_W::new(self, 12)
    }
    ///Bit 13 - SPI4 enable
    #[inline(always)]
    pub fn spi4enc(&mut self) -> SPI4ENC_W<APB2ENCRrs> {
        SPI4ENC_W::new(self, 13)
    }
    ///Bit 15 - TIM18 enable
    #[inline(always)]
    pub fn tim18enc(&mut self) -> TIM18ENC_W<APB2ENCRrs> {
        TIM18ENC_W::new(self, 15)
    }
    ///Bit 16 - TIM15 enable
    #[inline(always)]
    pub fn tim15enc(&mut self) -> TIM15ENC_W<APB2ENCRrs> {
        TIM15ENC_W::new(self, 16)
    }
    ///Bit 17 - TIM16 enable
    #[inline(always)]
    pub fn tim16enc(&mut self) -> TIM16ENC_W<APB2ENCRrs> {
        TIM16ENC_W::new(self, 17)
    }
    ///Bit 18 - TIM17 enable
    #[inline(always)]
    pub fn tim17enc(&mut self) -> TIM17ENC_W<APB2ENCRrs> {
        TIM17ENC_W::new(self, 18)
    }
    ///Bit 19 - TIM9 enable
    #[inline(always)]
    pub fn tim9enc(&mut self) -> TIM9ENC_W<APB2ENCRrs> {
        TIM9ENC_W::new(self, 19)
    }
    ///Bit 20 - SPI5 enable
    #[inline(always)]
    pub fn spi5enc(&mut self) -> SPI5ENC_W<APB2ENCRrs> {
        SPI5ENC_W::new(self, 20)
    }
    ///Bit 21 - SAI1 enable
    #[inline(always)]
    pub fn sai1enc(&mut self) -> SAI1ENC_W<APB2ENCRrs> {
        SAI1ENC_W::new(self, 21)
    }
    ///Bit 22 - SAI2 enable
    #[inline(always)]
    pub fn sai2enc(&mut self) -> SAI2ENC_W<APB2ENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB2ENCR)*/
