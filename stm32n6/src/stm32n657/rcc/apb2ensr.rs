...
impl W {
    ///Bit 0 - TIM1 enable
    #[inline(always)]
    pub fn tim1ens(&mut self) -> TIM1ENS_W<APB2ENSRrs> {
        TIM1ENS_W::new(self, 0)
    }
    ///Bit 1 - TIM8 enable
    #[inline(always)]
    pub fn tim8ens(&mut self) -> TIM8ENS_W<APB2ENSRrs> {
        TIM8ENS_W::new(self, 1)
    }
    ///Bit 4 - USART1 enable
    #[inline(always)]
    pub fn usart1ens(&mut self) -> USART1ENS_W<APB2ENSRrs> {
        USART1ENS_W::new(self, 4)
    }
    ///Bit 5 - USART6 enable
    #[inline(always)]
    pub fn usart6ens(&mut self) -> USART6ENS_W<APB2ENSRrs> {
        USART6ENS_W::new(self, 5)
    }
    ///Bit 6 - UART9 enable
    #[inline(always)]
    pub fn uart9ens(&mut self) -> UART9ENS_W<APB2ENSRrs> {
        UART9ENS_W::new(self, 6)
    }
    ///Bit 7 - USART10 enable
    #[inline(always)]
    pub fn usart10ens(&mut self) -> USART10ENS_W<APB2ENSRrs> {
        USART10ENS_W::new(self, 7)
    }
    ///Bit 12 - SPI1 enable
    #[inline(always)]
    pub fn spi1ens(&mut self) -> SPI1ENS_W<APB2ENSRrs> {
        SPI1ENS_W::new(self, 12)
    }
    ///Bit 13 - SPI4 enable
    #[inline(always)]
    pub fn spi4ens(&mut self) -> SPI4ENS_W<APB2ENSRrs> {
        SPI4ENS_W::new(self, 13)
    }
    ///Bit 15 - TIM18 enable
    #[inline(always)]
    pub fn tim18ens(&mut self) -> TIM18ENS_W<APB2ENSRrs> {
        TIM18ENS_W::new(self, 15)
    }
    ///Bit 16 - TIM15 enable
    #[inline(always)]
    pub fn tim15ens(&mut self) -> TIM15ENS_W<APB2ENSRrs> {
        TIM15ENS_W::new(self, 16)
    }
    ///Bit 17 - TIM16 enable
    #[inline(always)]
    pub fn tim16ens(&mut self) -> TIM16ENS_W<APB2ENSRrs> {
        TIM16ENS_W::new(self, 17)
    }
    ///Bit 18 - TIM17 enable
    #[inline(always)]
    pub fn tim17ens(&mut self) -> TIM17ENS_W<APB2ENSRrs> {
        TIM17ENS_W::new(self, 18)
    }
    ///Bit 19 - TIM9 enable
    #[inline(always)]
    pub fn tim9ens(&mut self) -> TIM9ENS_W<APB2ENSRrs> {
        TIM9ENS_W::new(self, 19)
    }
    ///Bit 20 - SPI5 enable
    #[inline(always)]
    pub fn spi5ens(&mut self) -> SPI5ENS_W<APB2ENSRrs> {
        SPI5ENS_W::new(self, 20)
    }
    ///Bit 21 - SAI1 enable
    #[inline(always)]
    pub fn sai1ens(&mut self) -> SAI1ENS_W<APB2ENSRrs> {
        SAI1ENS_W::new(self, 21)
    }
    ///Bit 22 - SAI2 enable
    #[inline(always)]
    pub fn sai2ens(&mut self) -> SAI2ENS_W<APB2ENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB2ENSR)*/
