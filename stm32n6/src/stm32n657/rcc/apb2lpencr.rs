...
impl W {
    ...
    #[inline(always)]
    pub fn tim1lpenc(&mut self) -> TIM1LPENC_W<APB2LPENCRrs> {
        TIM1LPENC_W::new(self, 0)
    }
    ///Bit 1 - TIM8 sleep enable
    #[inline(always)]
    pub fn tim8lpenc(&mut self) -> TIM8LPENC_W<APB2LPENCRrs> {
        TIM8LPENC_W::new(self, 1)
    }
    ///Bit 4 - USART1 sleep enable
    #[inline(always)]
    pub fn usart1lpenc(&mut self) -> USART1LPENC_W<APB2LPENCRrs> {
        USART1LPENC_W::new(self, 4)
    }
    ///Bit 5 - USART6 sleep enable
    #[inline(always)]
    pub fn usart6lpenc(&mut self) -> USART6LPENC_W<APB2LPENCRrs> {
        USART6LPENC_W::new(self, 5)
    }
    ///Bit 6 - UART9 sleep enable
    #[inline(always)]
    pub fn uart9lpenc(&mut self) -> UART9LPENC_W<APB2LPENCRrs> {
        UART9LPENC_W::new(self, 6)
    }
    ///Bit 7 - USART10 sleep enable
    #[inline(always)]
    pub fn usart10lpenc(&mut self) -> USART10LPENC_W<APB2LPENCRrs> {
        USART10LPENC_W::new(self, 7)
    }
    ///Bit 12 - SPI1 sleep enable
    #[inline(always)]
    pub fn spi1lpenc(&mut self) -> SPI1LPENC_W<APB2LPENCRrs> {
        SPI1LPENC_W::new(self, 12)
    }
    ///Bit 13 - SPI4 sleep enable
    #[inline(always)]
    pub fn spi4lpenc(&mut self) -> SPI4LPENC_W<APB2LPENCRrs> {
        SPI4LPENC_W::new(self, 13)
    }
    ///Bit 15 - TIM18 sleep enable
    #[inline(always)]
    pub fn tim18lpenc(&mut self) -> TIM18LPENC_W<APB2LPENCRrs> {
        TIM18LPENC_W::new(self, 15)
    }
    ///Bit 16 - TIM15 sleep enable
    #[inline(always)]
    pub fn tim15lpenc(&mut self) -> TIM15LPENC_W<APB2LPENCRrs> {
        TIM15LPENC_W::new(self, 16)
    }
    ///Bit 17 - TIM16 sleep enable
    #[inline(always)]
    pub fn tim16lpenc(&mut self) -> TIM16LPENC_W<APB2LPENCRrs> {
        TIM16LPENC_W::new(self, 17)
    }
    ///Bit 18 - TIM17 sleep enable
    #[inline(always)]
    pub fn tim17lpenc(&mut self) -> TIM17LPENC_W<APB2LPENCRrs> {
        TIM17LPENC_W::new(self, 18)
    }
    ///Bit 19 - TIM9 sleep enable
    #[inline(always)]
    pub fn tim9lpenc(&mut self) -> TIM9LPENC_W<APB2LPENCRrs> {
        TIM9LPENC_W::new(self, 19)
    }
    ///Bit 20 - SPI5 sleep enable
    #[inline(always)]
    pub fn spi5lpenc(&mut self) -> SPI5LPENC_W<APB2LPENCRrs> {
        SPI5LPENC_W::new(self, 20)
    }
    ///Bit 21 - SAI1 sleep enable
    #[inline(always)]
    pub fn sai1lpenc(&mut self) -> SAI1LPENC_W<APB2LPENCRrs> {
        SAI1LPENC_W::new(self, 21)
    }
    ///Bit 22 - SAI2 sleep enable
    #[inline(always)]
    pub fn sai2lpenc(&mut self) -> SAI2LPENC_W<APB2LPENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB2LPENCR)*/
