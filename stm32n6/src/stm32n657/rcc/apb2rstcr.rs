...
impl W {
    ///Bit 0 - TIM1 reset
    #[inline(always)]
    pub fn tim1rstc(&mut self) -> TIM1RSTC_W<APB2RSTCRrs> {
        TIM1RSTC_W::new(self, 0)
    }
    ///Bit 1 - TIM8 reset
    #[inline(always)]
    pub fn tim8rstc(&mut self) -> TIM8RSTC_W<APB2RSTCRrs> {
        TIM8RSTC_W::new(self, 1)
    }
    ///Bit 4 - USART1 reset
    #[inline(always)]
    pub fn usart1rstc(&mut self) -> USART1RSTC_W<APB2RSTCRrs> {
        USART1RSTC_W::new(self, 4)
    }
    ///Bit 5 - USART6 reset
    #[inline(always)]
    pub fn usart6rstc(&mut self) -> USART6RSTC_W<APB2RSTCRrs> {
        USART6RSTC_W::new(self, 5)
    }
    ///Bit 6 - UART9 reset
    #[inline(always)]
    pub fn uart9rstc(&mut self) -> UART9RSTC_W<APB2RSTCRrs> {
        UART9RSTC_W::new(self, 6)
    }
    ///Bit 7 - USART10 reset
    #[inline(always)]
    pub fn usart10rstc(&mut self) -> USART10RSTC_W<APB2RSTCRrs> {
        USART10RSTC_W::new(self, 7)
    }
    ///Bit 12 - SPI1 reset
    #[inline(always)]
    pub fn spi1rstc(&mut self) -> SPI1RSTC_W<APB2RSTCRrs> {
        SPI1RSTC_W::new(self, 12)
    }
    ///Bit 13 - SPI4 reset
    #[inline(always)]
    pub fn spi4rstc(&mut self) -> SPI4RSTC_W<APB2RSTCRrs> {
        SPI4RSTC_W::new(self, 13)
    }
    ///Bit 15 - TIM18 reset
    #[inline(always)]
    pub fn tim18rstc(&mut self) -> TIM18RSTC_W<APB2RSTCRrs> {
        TIM18RSTC_W::new(self, 15)
    }
    ///Bit 16 - TIM15 reset
    #[inline(always)]
    pub fn tim15rstc(&mut self) -> TIM15RSTC_W<APB2RSTCRrs> {
        TIM15RSTC_W::new(self, 16)
    }
    ///Bit 17 - TIM16 reset
    #[inline(always)]
    pub fn tim16rstc(&mut self) -> TIM16RSTC_W<APB2RSTCRrs> {
        TIM16RSTC_W::new(self, 17)
    }
    ///Bit 18 - TIM17 reset
    #[inline(always)]
    pub fn tim17rstc(&mut self) -> TIM17RSTC_W<APB2RSTCRrs> {
        TIM17RSTC_W::new(self, 18)
    }
    ///Bit 19 - TIM9 reset
    #[inline(always)]
    pub fn tim9rstc(&mut self) -> TIM9RSTC_W<APB2RSTCRrs> {
        TIM9RSTC_W::new(self, 19)
    }
    ///Bit 20 - SPI5 reset
    #[inline(always)]
    pub fn spi5rstc(&mut self) -> SPI5RSTC_W<APB2RSTCRrs> {
        SPI5RSTC_W::new(self, 20)
    }
    ///Bit 21 - SAI1 reset
    #[inline(always)]
    pub fn sai1rstc(&mut self) -> SAI1RSTC_W<APB2RSTCRrs> {
        SAI1RSTC_W::new(self, 21)
    }
    ///Bit 22 - SAI2 reset
    #[inline(always)]
    pub fn sai2rstc(&mut self) -> SAI2RSTC_W<APB2RSTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB2RSTCR)*/
