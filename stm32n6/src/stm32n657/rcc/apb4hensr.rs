...
impl W {
    ///Bit 0 - SYSCFG enable
    #[inline(always)]
    pub fn syscfgens(&mut self) -> SYSCFGENS_W<APB4HENSRrs> {
        SYSCFGENS_W::new(self, 0)
    }
    ///Bit 1 - BSEC enable
    #[inline(always)]
    pub fn bsecens(&mut self) -> BSECENS_W<APB4HENSRrs> {
        BSECENS_W::new(self, 1)
    }
    ///Bit 2 - DTS enable
    #[inline(always)]
    pub fn dtsens(&mut self) -> DTSENS_W<APB4HENSRrs> {
        DTSENS_W::new(self, 2)
    }
    ///Bit 4 - BUSPERFM enable
    #[inline(always)]
    pub fn busperfmens(&mut self) -> BUSPERFMENS_W<APB4HENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB4HENSR)*/
