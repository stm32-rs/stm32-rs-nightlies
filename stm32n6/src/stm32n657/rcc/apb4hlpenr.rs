...
impl W {
    ///Bit 0 - SYSCFG sleep enable
    #[inline(always)]
    pub fn syscfglpen(&mut self) -> SYSCFGLPEN_W<APB4HLPENRrs> {
        SYSCFGLPEN_W::new(self, 0)
    }
    ///Bit 1 - BSEC sleep enable
    #[inline(always)]
    pub fn bseclpen(&mut self) -> BSECLPEN_W<APB4HLPENRrs> {
        BSECLPEN_W::new(self, 1)
    }
    ///Bit 2 - DTS sleep enable
    #[inline(always)]
    pub fn dtslpen(&mut self) -> DTSLPEN_W<APB4HLPENRrs> {
        DTSLPEN_W::new(self, 2)
    }
    ///Bit 4 - BUSPERFM sleep enable
    #[inline(always)]
    pub fn busperfmlpen(&mut self) -> BUSPERFMLPEN_W<APB4HLPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB4HLPENR)*/
