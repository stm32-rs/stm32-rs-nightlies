...
impl W {
    ...
    #[inline(always)]
    pub fn syscfglpens(&mut self) -> SYSCFGLPENS_W<APB4HLPENSRrs> {
        SYSCFGLPENS_W::new(self, 0)
    }
    ///Bit 1 - BSEC sleep enable
    #[inline(always)]
    pub fn bseclpens(&mut self) -> BSECLPENS_W<APB4HLPENSRrs> {
        BSECLPENS_W::new(self, 1)
    }
    ///Bit 2 - DTS sleep enable
    #[inline(always)]
    pub fn dtslpens(&mut self) -> DTSLPENS_W<APB4HLPENSRrs> {
        DTSLPENS_W::new(self, 2)
    }
    ///Bit 4 - BUSPERFM sleep enable
    #[inline(always)]
    pub fn busperfmlpens(&mut self) -> BUSPERFMLPENS_W<APB4HLPENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB4HLPENSR)*/
