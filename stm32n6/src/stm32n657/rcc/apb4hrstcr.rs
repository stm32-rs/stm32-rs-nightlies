...
impl W {
    ///Bit 0 - SYSCFG reset
    #[inline(always)]
    pub fn syscfgrstc(&mut self) -> SYSCFGRSTC_W<APB4HRSTCRrs> {
        SYSCFGRSTC_W::new(self, 0)
    }
    ///Bit 2 - DTS reset
    #[inline(always)]
    pub fn dtsrstc(&mut self) -> DTSRSTC_W<APB4HRSTCRrs> {
        DTSRSTC_W::new(self, 2)
    }
    ///Bit 4 - BUSPERFM reset
    #[inline(always)]
    pub fn busperfmrstc(&mut self) -> BUSPERFMRSTC_W<APB4HRSTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB4HRSTCR)*/
