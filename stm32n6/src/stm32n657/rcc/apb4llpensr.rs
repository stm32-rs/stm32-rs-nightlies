...
impl W {
    ...
    #[inline(always)]
    pub fn hdplpens(&mut self) -> HDPLPENS_W<APB4LLPENSRrs> {
        HDPLPENS_W::new(self, 2)
    }
    ///Bit 3 - LPUART1 sleep enable
    #[inline(always)]
    pub fn lpuart1lpens(&mut self) -> LPUART1LPENS_W<APB4LLPENSRrs> {
        LPUART1LPENS_W::new(self, 3)
    }
    ///Bit 5 - SPI6 sleep enable
    #[inline(always)]
    pub fn spi6lpens(&mut self) -> SPI6LPENS_W<APB4LLPENSRrs> {
        SPI6LPENS_W::new(self, 5)
    }
    ///Bit 7 - I2C4 sleep enable
    #[inline(always)]
    pub fn i2c4lpens(&mut self) -> I2C4LPENS_W<APB4LLPENSRrs> {
        I2C4LPENS_W::new(self, 7)
    }
    ///Bit 9 - LPTIM2 sleep enable
    #[inline(always)]
    pub fn lptim2lpens(&mut self) -> LPTIM2LPENS_W<APB4LLPENSRrs> {
        LPTIM2LPENS_W::new(self, 9)
    }
    ///Bit 10 - LPTIM3 sleep enable
    #[inline(always)]
    pub fn lptim3lpens(&mut self) -> LPTIM3LPENS_W<APB4LLPENSRrs> {
        LPTIM3LPENS_W::new(self, 10)
    }
    ///Bit 11 - LPTIM4 sleep enable
    #[inline(always)]
    pub fn lptim4lpens(&mut self) -> LPTIM4LPENS_W<APB4LLPENSRrs> {
        LPTIM4LPENS_W::new(self, 11)
    }
    ///Bit 12 - LPTIM5 sleep enable
    #[inline(always)]
    pub fn lptim5lpens(&mut self) -> LPTIM5LPENS_W<APB4LLPENSRrs> {
        LPTIM5LPENS_W::new(self, 12)
    }
    ///Bit 15 - VREFBUF sleep enable
    #[inline(always)]
    pub fn vrefbuflpens(&mut self) -> VREFBUFLPENS_W<APB4LLPENSRrs> {
        VREFBUFLPENS_W::new(self, 15)
    }
    ///Bit 16 - RTC sleep enable
    #[inline(always)]
    pub fn rtclpens(&mut self) -> RTCLPENS_W<APB4LLPENSRrs> {
        RTCLPENS_W::new(self, 16)
    }
    ///Bit 17 - RTCAPB sleep enable
    #[inline(always)]
    pub fn rtcapblpens(&mut self) -> RTCAPBLPENS_W<APB4LLPENSRrs> {
        RTCAPBLPENS_W::new(self, 17)
    }
    ///Bit 22 - R2GRET sleep enable
    #[inline(always)]
    pub fn r2gretlpens(&mut self) -> R2GRETLPENS_W<APB4LLPENSRrs> {
        R2GRETLPENS_W::new(self, 22)
    }
    ///Bit 23 - R2GNPU sleep enable
    #[inline(always)]
    pub fn r2gnpulpens(&mut self) -> R2GNPULPENS_W<APB4LLPENSRrs> {
        R2GNPULPENS_W::new(self, 23)
    }
    ///Bit 31 - SERF sleep enable
    #[inline(always)]
    pub fn serflpens(&mut self) -> SERFLPENS_W<APB4LLPENSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB4LLPENSR)*/
