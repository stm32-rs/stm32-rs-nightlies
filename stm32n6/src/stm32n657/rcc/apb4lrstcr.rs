...
impl W {
    ///Bit 2 - HDP reset
    #[inline(always)]
    pub fn hdprstc(&mut self) -> HDPRSTC_W<APB4LRSTCRrs> {
        HDPRSTC_W::new(self, 2)
    }
    ///Bit 3 - LPUART1 reset
    #[inline(always)]
    pub fn lpuart1rstc(&mut self) -> LPUART1RSTC_W<APB4LRSTCRrs> {
        LPUART1RSTC_W::new(self, 3)
    }
    ///Bit 5 - SPI6 reset
    #[inline(always)]
    pub fn spi6rstc(&mut self) -> SPI6RSTC_W<APB4LRSTCRrs> {
        SPI6RSTC_W::new(self, 5)
    }
    ///Bit 7 - I2C4 reset
    #[inline(always)]
    pub fn i2c4rstc(&mut self) -> I2C4RSTC_W<APB4LRSTCRrs> {
        I2C4RSTC_W::new(self, 7)
    }
    ///Bit 9 - LPTIM2 reset
    #[inline(always)]
    pub fn lptim2rstc(&mut self) -> LPTIM2RSTC_W<APB4LRSTCRrs> {
        LPTIM2RSTC_W::new(self, 9)
    }
    ///Bit 10 - LPTIM3 reset
    #[inline(always)]
    pub fn lptim3rstc(&mut self) -> LPTIM3RSTC_W<APB4LRSTCRrs> {
        LPTIM3RSTC_W::new(self, 10)
    }
    ///Bit 11 - LPTIM4 reset
    #[inline(always)]
    pub fn lptim4rstc(&mut self) -> LPTIM4RSTC_W<APB4LRSTCRrs> {
        LPTIM4RSTC_W::new(self, 11)
    }
    ///Bit 12 - LPTIM5 reset
    #[inline(always)]
    pub fn lptim5rstc(&mut self) -> LPTIM5RSTC_W<APB4LRSTCRrs> {
        LPTIM5RSTC_W::new(self, 12)
    }
    ///Bit 15 - VREFBUF reset
    #[inline(always)]
    pub fn vrefbufrstc(&mut self) -> VREFBUFRSTC_W<APB4LRSTCRrs> {
        VREFBUFRSTC_W::new(self, 15)
    }
    ///Bit 16 - RTC reset
    #[inline(always)]
    pub fn rtcrstc(&mut self) -> RTCRSTC_W<APB4LRSTCRrs> {
        RTCRSTC_W::new(self, 16)
    }
    ///Bit 22 - R2GRET reset
    #[inline(always)]
    pub fn r2gretrstc(&mut self) -> R2GRETRSTC_W<APB4LRSTCRrs> {
        R2GRETRSTC_W::new(self, 22)
    }
    ///Bit 23 - R2GNPU reset
    #[inline(always)]
    pub fn r2gnpurstc(&mut self) -> R2GNPURSTC_W<APB4LRSTCRrs> {
        R2GNPURSTC_W::new(self, 23)
    }
    ///Bit 31 - SERF reset
    #[inline(always)]
    pub fn serfrstc(&mut self) -> SERFRSTC_W<APB4LRSTCRrs> {
