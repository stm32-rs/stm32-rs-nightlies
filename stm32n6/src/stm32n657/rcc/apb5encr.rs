...
impl W {
    ///Bit 1 - LTDC enable
    #[inline(always)]
    pub fn ltdcenc(&mut self) -> LTDCENC_W<APB5ENCRrs> {
        LTDCENC_W::new(self, 1)
    }
    ///Bit 2 - DCMIPP enable
    #[inline(always)]
    pub fn dcmippenc(&mut self) -> DCMIPPENC_W<APB5ENCRrs> {
        DCMIPPENC_W::new(self, 2)
    }
    ///Bit 4 - GFXTIM enable
    #[inline(always)]
    pub fn gfxtimenc(&mut self) -> GFXTIMENC_W<APB5ENCRrs> {
        GFXTIMENC_W::new(self, 4)
    }
    ///Bit 5 - VENC enable
    #[inline(always)]
    pub fn vencenc(&mut self) -> VENCENC_W<APB5ENCRrs> {
        VENCENC_W::new(self, 5)
    }
    ///Bit 6 - CSI enable
    #[inline(always)]
    pub fn csienc(&mut self) -> CSIENC_W<APB5ENCRrs> {
        CSIENC_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:APB5ENCR)*/
