...
impl W {
    ///Bit 0 - ACLKN enable
    #[inline(always)]
    pub fn aclknenc(&mut self) -> ACLKNENC_W<BUSENCRrs> {
        ACLKNENC_W::new(self, 0)
    }
    ///Bit 1 - ACLKNC enable
    #[inline(always)]
    pub fn aclkncenc(&mut self) -> ACLKNCENC_W<BUSENCRrs> {
        ACLKNCENC_W::new(self, 1)
    }
    ///Bit 2 - AHBM enable
    #[inline(always)]
    pub fn ahbmenc(&mut self) -> AHBMENC_W<BUSENCRrs> {
        AHBMENC_W::new(self, 2)
    }
    ///Bit 3 - AHB1 enable
    #[inline(always)]
    pub fn ahb1enc(&mut self) -> AHB1ENC_W<BUSENCRrs> {
        AHB1ENC_W::new(self, 3)
    }
    ///Bit 4 - AHB2 enable
    #[inline(always)]
    pub fn ahb2enc(&mut self) -> AHB2ENC_W<BUSENCRrs> {
        AHB2ENC_W::new(self, 4)
    }
    ///Bit 5 - AHB3 enable
    #[inline(always)]
    pub fn ahb3enc(&mut self) -> AHB3ENC_W<BUSENCRrs> {
        AHB3ENC_W::new(self, 5)
    }
    ///Bit 6 - AHB4 enable
    #[inline(always)]
    pub fn ahb4enc(&mut self) -> AHB4ENC_W<BUSENCRrs> {
        AHB4ENC_W::new(self, 6)
    }
    ///Bit 7 - AHB5 enable
    #[inline(always)]
    pub fn ahb5enc(&mut self) -> AHB5ENC_W<BUSENCRrs> {
        AHB5ENC_W::new(self, 7)
    }
    ///Bit 8 - APB1 enable
    #[inline(always)]
    pub fn apb1enc(&mut self) -> APB1ENC_W<BUSENCRrs> {
        APB1ENC_W::new(self, 8)
    }
    ///Bit 9 - APB2 enable
    #[inline(always)]
    pub fn apb2enc(&mut self) -> APB2ENC_W<BUSENCRrs> {
        APB2ENC_W::new(self, 9)
    }
    ///Bit 10 - APB3 enable
    #[inline(always)]
    pub fn apb3enc(&mut self) -> APB3ENC_W<BUSENCRrs> {
        APB3ENC_W::new(self, 10)
    }
    ///Bit 11 - APB4 enable
    #[inline(always)]
    pub fn apb4enc(&mut self) -> APB4ENC_W<BUSENCRrs> {
        APB4ENC_W::new(self, 11)
    }
    ///Bit 12 - APB5 enable
    #[inline(always)]
    pub fn apb5enc(&mut self) -> APB5ENC_W<BUSENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:BUSENCR)*/
