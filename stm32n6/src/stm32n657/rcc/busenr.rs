...
impl W {
    ///Bit 0 - ACLKN enable
    #[inline(always)]
    pub fn aclknen(&mut self) -> ACLKNEN_W<BUSENRrs> {
        ACLKNEN_W::new(self, 0)
    }
    ///Bit 1 - ACLKNC enable
    #[inline(always)]
    pub fn aclkncen(&mut self) -> ACLKNCEN_W<BUSENRrs> {
        ACLKNCEN_W::new(self, 1)
    }
    ///Bit 2 - AHBM enable
    #[inline(always)]
    pub fn ahbmen(&mut self) -> AHBMEN_W<BUSENRrs> {
        AHBMEN_W::new(self, 2)
    }
    ///Bit 3 - AHB1 enable
    #[inline(always)]
    pub fn ahb1en(&mut self) -> AHB1EN_W<BUSENRrs> {
        AHB1EN_W::new(self, 3)
    }
    ///Bit 4 - AHB2 enable
    #[inline(always)]
    pub fn ahb2en(&mut self) -> AHB2EN_W<BUSENRrs> {
        AHB2EN_W::new(self, 4)
    }
    ///Bit 5 - AHB3 enable
    #[inline(always)]
    pub fn ahb3en(&mut self) -> AHB3EN_W<BUSENRrs> {
        AHB3EN_W::new(self, 5)
    }
    ///Bit 6 - AHB4 enable
    #[inline(always)]
    pub fn ahb4en(&mut self) -> AHB4EN_W<BUSENRrs> {
        AHB4EN_W::new(self, 6)
    }
    ///Bit 7 - AHB5 enable
    #[inline(always)]
    pub fn ahb5en(&mut self) -> AHB5EN_W<BUSENRrs> {
        AHB5EN_W::new(self, 7)
    }
    ///Bit 8 - APB1 enable
    #[inline(always)]
    pub fn apb1en(&mut self) -> APB1EN_W<BUSENRrs> {
        APB1EN_W::new(self, 8)
    }
    ///Bit 9 - APB2 enable
    #[inline(always)]
    pub fn apb2en(&mut self) -> APB2EN_W<BUSENRrs> {
        APB2EN_W::new(self, 9)
    }
    ///Bit 10 - APB3 enable
    #[inline(always)]
    pub fn apb3en(&mut self) -> APB3EN_W<BUSENRrs> {
        APB3EN_W::new(self, 10)
    }
    ///Bit 11 - APB4 enable
    #[inline(always)]
    pub fn apb4en(&mut self) -> APB4EN_W<BUSENRrs> {
        APB4EN_W::new(self, 11)
    }
    ///Bit 12 - APB5 enable
    #[inline(always)]
    pub fn apb5en(&mut self) -> APB5EN_W<BUSENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:BUSENR)*/
pub struct BUSENRrs;
