...
impl W {
    ...
    #[inline(always)]
    pub fn aclknlpenc(&mut self) -> ACLKNLPENC_W<BUSLPENCRrs> {
        ACLKNLPENC_W::new(self, 0)
    }
    ///Bit 1 - ACLKNC sleep enable
    #[inline(always)]
    pub fn aclknclpenc(&mut self) -> ACLKNCLPENC_W<BUSLPENCRrs> {
        ACLKNCLPENC_W::new(self, 1)
    }
    ///Bit 2 - AHBM sleep enable
    #[inline(always)]
    pub fn ahbmlpenc(&mut self) -> AHBMLPENC_W<BUSLPENCRrs> {
        AHBMLPENC_W::new(self, 2)
    }
    ///Bit 3 - AHB1 sleep enable
    #[inline(always)]
    pub fn ahb1lpenc(&mut self) -> AHB1LPENC_W<BUSLPENCRrs> {
        AHB1LPENC_W::new(self, 3)
    }
    ///Bit 4 - AHB2 sleep enable
    #[inline(always)]
    pub fn ahb2lpenc(&mut self) -> AHB2LPENC_W<BUSLPENCRrs> {
        AHB2LPENC_W::new(self, 4)
    }
    ///Bit 5 - AHB3 sleep enable
    #[inline(always)]
    pub fn ahb3lpenc(&mut self) -> AHB3LPENC_W<BUSLPENCRrs> {
        AHB3LPENC_W::new(self, 5)
    }
    ///Bit 6 - AHB4 sleep enable
    #[inline(always)]
    pub fn ahb4lpenc(&mut self) -> AHB4LPENC_W<BUSLPENCRrs> {
        AHB4LPENC_W::new(self, 6)
    }
    ///Bit 7 - AHB5 sleep enable
    #[inline(always)]
    pub fn ahb5lpenc(&mut self) -> AHB5LPENC_W<BUSLPENCRrs> {
        AHB5LPENC_W::new(self, 7)
    }
    ///Bit 8 - APB1 sleep enable
    #[inline(always)]
    pub fn apb1lpenc(&mut self) -> APB1LPENC_W<BUSLPENCRrs> {
        APB1LPENC_W::new(self, 8)
    }
    ///Bit 9 - APB2 sleep enable
    #[inline(always)]
    pub fn apb2lpenc(&mut self) -> APB2LPENC_W<BUSLPENCRrs> {
        APB2LPENC_W::new(self, 9)
    }
    ///Bit 10 - APB3 sleep enable
    #[inline(always)]
    pub fn apb3lpenc(&mut self) -> APB3LPENC_W<BUSLPENCRrs> {
        APB3LPENC_W::new(self, 10)
    }
    ///Bit 11 - APB4 sleep enable
    #[inline(always)]
    pub fn apb4lpenc(&mut self) -> APB4LPENC_W<BUSLPENCRrs> {
        APB4LPENC_W::new(self, 11)
    }
    ///Bit 12 - APB5 sleep enable
    #[inline(always)]
    pub fn apb5lpenc(&mut self) -> APB5LPENC_W<BUSLPENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:BUSLPENCR)*/
