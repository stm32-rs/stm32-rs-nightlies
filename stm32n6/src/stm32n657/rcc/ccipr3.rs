...
impl W {
    ///Bits 0:1 - Source selection for the FDCAN kernel clock
    #[inline(always)]
    pub fn fdcansel(&mut self) -> FDCANSEL_W<CCIPR3rs> {
        FDCANSEL_W::new(self, 0)
    }
    ///Bits 4:5 - Source selection for the FMC kernel clock
    #[inline(always)]
    pub fn fmcsel(&mut self) -> FMCSEL_W<CCIPR3rs> {
        FMCSEL_W::new(self, 4)
    }
    ///Bit 8 - Source selection for the DFT kernel clock
    #[inline(always)]
    pub fn dftsel(&mut self) -> DFTSEL_W<CCIPR3rs> {
        DFTSEL_W::new(self, 8)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:CCIPR3)*/
pub struct CCIPR3rs;
