...
impl W {
    ...
    ///Bits 16:17 - CPU clock switch selection
    #[inline(always)]
    pub fn cpusw(&mut self) -> CPUSW_W<CFGR1rs> {
        CPUSW_W::new(self, 16)
    }
    ///Bits 24:25 - System clock switch selection
    #[inline(always)]
    pub fn syssw(&mut self) -> SYSSW_W<CFGR1rs> {
        SYSSW_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:CFGR1)*/
pub struct CFGR1rs;
