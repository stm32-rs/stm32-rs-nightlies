...
impl W {
    ...
    ///Bit 11 - PLL4 ready interrupt enable
    #[inline(always)]
    pub fn pll4rdyie(&mut self) -> PLL4RDYIE_W<CIERrs> {
    ...
    ///Bit 17 - HSE clock security system (CSS) interrupt enable
    #[inline(always)]
    pub fn hsecssie(&mut self) -> HSECSSIE_W<CIERrs> {
        HSECSSIE_W::new(self, 17)
    }
    ///Bit 24 - CPU wakeup from Stop interrupt enable
    #[inline(always)]
    pub fn wkupie(&mut self) -> WKUPIE_W<CIERrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:CIER)*/
pub struct CIERrs;
