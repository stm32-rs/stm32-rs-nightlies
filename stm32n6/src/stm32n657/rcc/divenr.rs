...
impl W {
    ///Bit 0 - IC1 enable
    #[inline(always)]
    pub fn ic1en(&mut self) -> IC1EN_W<DIVENRrs> {
        IC1EN_W::new(self, 0)
    }
    ///Bit 1 - IC2 enable
    #[inline(always)]
    pub fn ic2en(&mut self) -> IC2EN_W<DIVENRrs> {
        IC2EN_W::new(self, 1)
    }
    ///Bit 2 - IC3 enable
    #[inline(always)]
    pub fn ic3en(&mut self) -> IC3EN_W<DIVENRrs> {
        IC3EN_W::new(self, 2)
    }
    ///Bit 3 - IC4 enable
    #[inline(always)]
    pub fn ic4en(&mut self) -> IC4EN_W<DIVENRrs> {
        IC4EN_W::new(self, 3)
    }
    ///Bit 4 - IC5 enable
    #[inline(always)]
    pub fn ic5en(&mut self) -> IC5EN_W<DIVENRrs> {
        IC5EN_W::new(self, 4)
    }
    ///Bit 5 - IC6 enable
    #[inline(always)]
    pub fn ic6en(&mut self) -> IC6EN_W<DIVENRrs> {
        IC6EN_W::new(self, 5)
    }
    ///Bit 6 - IC7 enable
    #[inline(always)]
    pub fn ic7en(&mut self) -> IC7EN_W<DIVENRrs> {
        IC7EN_W::new(self, 6)
    }
    ///Bit 7 - IC8 enable
    #[inline(always)]
    pub fn ic8en(&mut self) -> IC8EN_W<DIVENRrs> {
        IC8EN_W::new(self, 7)
    }
    ///Bit 8 - IC9 enable
    #[inline(always)]
    pub fn ic9en(&mut self) -> IC9EN_W<DIVENRrs> {
        IC9EN_W::new(self, 8)
    }
    ///Bit 9 - IC10 enable
    #[inline(always)]
    pub fn ic10en(&mut self) -> IC10EN_W<DIVENRrs> {
        IC10EN_W::new(self, 9)
    }
    ///Bit 10 - IC11 enable
    #[inline(always)]
    pub fn ic11en(&mut self) -> IC11EN_W<DIVENRrs> {
        IC11EN_W::new(self, 10)
    }
    ///Bit 11 - IC12 enable
    #[inline(always)]
    pub fn ic12en(&mut self) -> IC12EN_W<DIVENRrs> {
        IC12EN_W::new(self, 11)
    }
    ///Bit 12 - IC13 enable
    #[inline(always)]
    pub fn ic13en(&mut self) -> IC13EN_W<DIVENRrs> {
        IC13EN_W::new(self, 12)
    }
    ///Bit 13 - IC14 enable
    #[inline(always)]
    pub fn ic14en(&mut self) -> IC14EN_W<DIVENRrs> {
        IC14EN_W::new(self, 13)
    }
    ///Bit 14 - IC15 enable
    #[inline(always)]
    pub fn ic15en(&mut self) -> IC15EN_W<DIVENRrs> {
        IC15EN_W::new(self, 14)
    }
    ///Bit 15 - IC16 enable
    #[inline(always)]
    pub fn ic16en(&mut self) -> IC16EN_W<DIVENRrs> {
        IC16EN_W::new(self, 15)
    }
    ///Bit 16 - IC17 enable
    #[inline(always)]
    pub fn ic17en(&mut self) -> IC17EN_W<DIVENRrs> {
        IC17EN_W::new(self, 16)
    }
    ///Bit 17 - IC18 enable
    #[inline(always)]
    pub fn ic18en(&mut self) -> IC18EN_W<DIVENRrs> {
        IC18EN_W::new(self, 17)
    }
    ///Bit 18 - IC19 enable
    #[inline(always)]
    pub fn ic19en(&mut self) -> IC19EN_W<DIVENRrs> {
        IC19EN_W::new(self, 18)
    }
    ///Bit 19 - IC20 enable
    #[inline(always)]
    pub fn ic20en(&mut self) -> IC20EN_W<DIVENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:DIVENR)*/
pub struct DIVENRrs;
