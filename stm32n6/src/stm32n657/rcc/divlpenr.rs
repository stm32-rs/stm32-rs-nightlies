...
impl W {
    ///Bit 0 - IC1 sleep enable
    #[inline(always)]
    pub fn ic1lpen(&mut self) -> IC1LPEN_W<DIVLPENRrs> {
        IC1LPEN_W::new(self, 0)
    }
    ///Bit 1 - IC2 sleep enable
    #[inline(always)]
    pub fn ic2lpen(&mut self) -> IC2LPEN_W<DIVLPENRrs> {
        IC2LPEN_W::new(self, 1)
    }
    ///Bit 2 - IC3 sleep enable
    #[inline(always)]
    pub fn ic3lpen(&mut self) -> IC3LPEN_W<DIVLPENRrs> {
        IC3LPEN_W::new(self, 2)
    }
    ///Bit 3 - IC4 sleep enable
    #[inline(always)]
    pub fn ic4lpen(&mut self) -> IC4LPEN_W<DIVLPENRrs> {
        IC4LPEN_W::new(self, 3)
    }
    ///Bit 4 - IC5 sleep enable
    #[inline(always)]
    pub fn ic5lpen(&mut self) -> IC5LPEN_W<DIVLPENRrs> {
        IC5LPEN_W::new(self, 4)
    }
    ///Bit 5 - IC6 sleep enable
    #[inline(always)]
    pub fn ic6lpen(&mut self) -> IC6LPEN_W<DIVLPENRrs> {
        IC6LPEN_W::new(self, 5)
    }
    ///Bit 6 - IC7 sleep enable
    #[inline(always)]
    pub fn ic7lpen(&mut self) -> IC7LPEN_W<DIVLPENRrs> {
        IC7LPEN_W::new(self, 6)
    }
    ///Bit 7 - IC8 sleep enable
    #[inline(always)]
    pub fn ic8lpen(&mut self) -> IC8LPEN_W<DIVLPENRrs> {
        IC8LPEN_W::new(self, 7)
    }
    ///Bit 8 - IC9 sleep enable
    #[inline(always)]
    pub fn ic9lpen(&mut self) -> IC9LPEN_W<DIVLPENRrs> {
        IC9LPEN_W::new(self, 8)
    }
    ///Bit 9 - IC10 sleep enable
    #[inline(always)]
    pub fn ic10lpen(&mut self) -> IC10LPEN_W<DIVLPENRrs> {
        IC10LPEN_W::new(self, 9)
    }
    ///Bit 10 - IC11 sleep enable
    #[inline(always)]
    pub fn ic11lpen(&mut self) -> IC11LPEN_W<DIVLPENRrs> {
        IC11LPEN_W::new(self, 10)
    }
    ///Bit 11 - IC12 sleep enable
    #[inline(always)]
    pub fn ic12lpen(&mut self) -> IC12LPEN_W<DIVLPENRrs> {
        IC12LPEN_W::new(self, 11)
    }
    ///Bit 12 - IC13 sleep enable
    #[inline(always)]
    pub fn ic13lpen(&mut self) -> IC13LPEN_W<DIVLPENRrs> {
        IC13LPEN_W::new(self, 12)
    }
    ///Bit 13 - IC14 sleep enable
    #[inline(always)]
    pub fn ic14lpen(&mut self) -> IC14LPEN_W<DIVLPENRrs> {
        IC14LPEN_W::new(self, 13)
    }
    ///Bit 14 - IC15 sleep enable
    #[inline(always)]
    pub fn ic15lpen(&mut self) -> IC15LPEN_W<DIVLPENRrs> {
        IC15LPEN_W::new(self, 14)
    }
    ///Bit 15 - IC16 sleep enable
    #[inline(always)]
    pub fn ic16lpen(&mut self) -> IC16LPEN_W<DIVLPENRrs> {
        IC16LPEN_W::new(self, 15)
    }
    ///Bit 16 - IC17 sleep enable
    #[inline(always)]
    pub fn ic17lpen(&mut self) -> IC17LPEN_W<DIVLPENRrs> {
        IC17LPEN_W::new(self, 16)
    }
    ///Bit 17 - IC18 sleep enable
    #[inline(always)]
    pub fn ic18lpen(&mut self) -> IC18LPEN_W<DIVLPENRrs> {
        IC18LPEN_W::new(self, 17)
    }
    ///Bit 18 - IC19 sleep enable
    #[inline(always)]
    pub fn ic19lpen(&mut self) -> IC19LPEN_W<DIVLPENRrs> {
        IC19LPEN_W::new(self, 18)
    }
    ///Bit 19 - IC20 sleep enable
    #[inline(always)]
    pub fn ic20lpen(&mut self) -> IC20LPEN_W<DIVLPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:DIVLPENR)*/
