...
impl W {
    ///Bits 16:23 - Divider IC10 integer division factor
    #[inline(always)]
    pub fn ic10int(&mut self) -> IC10INT_W<IC10CFGRrs> {
        IC10INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC10 Source Selection
    #[inline(always)]
    pub fn ic10sel(&mut self) -> IC10SEL_W<IC10CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:IC10CFGR)*/
