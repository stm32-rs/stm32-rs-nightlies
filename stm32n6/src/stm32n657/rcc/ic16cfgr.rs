...
impl W {
    ///Bits 16:23 - Divider IC16 integer division factor
    #[inline(always)]
    pub fn ic16int(&mut self) -> IC16INT_W<IC16CFGRrs> {
        IC16INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC16 Source Selection
    #[inline(always)]
    pub fn ic16sel(&mut self) -> IC16SEL_W<IC16CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:IC16CFGR)*/
