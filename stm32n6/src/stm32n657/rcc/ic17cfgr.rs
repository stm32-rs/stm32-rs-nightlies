...
impl W {
    ///Bits 16:23 - Divider IC17 integer division factor
    #[inline(always)]
    pub fn ic17int(&mut self) -> IC17INT_W<IC17CFGRrs> {
        IC17INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC17 Source Selection
    #[inline(always)]
    pub fn ic17sel(&mut self) -> IC17SEL_W<IC17CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:IC17CFGR)*/
