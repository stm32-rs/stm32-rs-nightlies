...
impl W {
    ///Bits 16:23 - Divider IC4 integer division factor
    #[inline(always)]
    pub fn ic4int(&mut self) -> IC4INT_W<IC4CFGRrs> {
        IC4INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC4 Source Selection
    #[inline(always)]
    pub fn ic4sel(&mut self) -> IC4SEL_W<IC4CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:IC4CFGR)*/
