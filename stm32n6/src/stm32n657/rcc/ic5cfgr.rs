...
impl W {
    ///Bits 16:23 - Divider IC5 integer division factor
    #[inline(always)]
    pub fn ic5int(&mut self) -> IC5INT_W<IC5CFGRrs> {
        IC5INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC5 Source Selection
    #[inline(always)]
    pub fn ic5sel(&mut self) -> IC5SEL_W<IC5CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:IC5CFGR)*/
