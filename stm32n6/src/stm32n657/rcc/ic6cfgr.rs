...
impl W {
    ///Bits 16:23 - Divider IC6 integer division factor
    #[inline(always)]
    pub fn ic6int(&mut self) -> IC6INT_W<IC6CFGRrs> {
        IC6INT_W::new(self, 16)
    }
    ///Bits 28:29 - Divider IC6 Source Selection
    #[inline(always)]
    pub fn ic6sel(&mut self) -> IC6SEL_W<IC6CFGRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:IC6CFGR)*/
