...
impl W {
    ...
    #[inline(always)]
    pub fn axisram3lpenc(&mut self) -> AXISRAM3LPENC_W<MEMLPENCRrs> {
        AXISRAM3LPENC_W::new(self, 0)
    }
    ///Bit 1 - AXISRAM4 sleep enable
    #[inline(always)]
    pub fn axisram4lpenc(&mut self) -> AXISRAM4LPENC_W<MEMLPENCRrs> {
        AXISRAM4LPENC_W::new(self, 1)
    }
    ///Bit 2 - AXISRAM5 sleep enable
    #[inline(always)]
    pub fn axisram5lpenc(&mut self) -> AXISRAM5LPENC_W<MEMLPENCRrs> {
        AXISRAM5LPENC_W::new(self, 2)
    }
    ///Bit 3 - AXISRAM6 sleep enable
    #[inline(always)]
    pub fn axisram6lpenc(&mut self) -> AXISRAM6LPENC_W<MEMLPENCRrs> {
        AXISRAM6LPENC_W::new(self, 3)
    }
    ///Bit 4 - AHBSRAM1 sleep enable
    #[inline(always)]
    pub fn ahbsram1lpenc(&mut self) -> AHBSRAM1LPENC_W<MEMLPENCRrs> {
        AHBSRAM1LPENC_W::new(self, 4)
    }
    ///Bit 5 - AHBSRAM2 sleep enable
    #[inline(always)]
    pub fn ahbsram2lpenc(&mut self) -> AHBSRAM2LPENC_W<MEMLPENCRrs> {
        AHBSRAM2LPENC_W::new(self, 5)
    }
    ///Bit 6 - BKPSRAM sleep enable
    #[inline(always)]
    pub fn bkpsramlpenc(&mut self) -> BKPSRAMLPENC_W<MEMLPENCRrs> {
        BKPSRAMLPENC_W::new(self, 6)
    }
    ///Bit 7 - AXISRAM1 sleep enable
    #[inline(always)]
    pub fn axisram1lpenc(&mut self) -> AXISRAM1LPENC_W<MEMLPENCRrs> {
        AXISRAM1LPENC_W::new(self, 7)
    }
    ///Bit 8 - AXISRAM2 sleep enable
    #[inline(always)]
    pub fn axisram2lpenc(&mut self) -> AXISRAM2LPENC_W<MEMLPENCRrs> {
        AXISRAM2LPENC_W::new(self, 8)
    }
    ///Bit 9 - FLEXRAM sleep enable
    #[inline(always)]
    pub fn flexramlpenc(&mut self) -> FLEXRAMLPENC_W<MEMLPENCRrs> {
        FLEXRAMLPENC_W::new(self, 9)
    }
    ///Bit 10 - NPUCACHERAM sleep enable
    #[inline(always)]
    pub fn npucacheramlpenc(&mut self) -> NPUCACHERAMLPENC_W<MEMLPENCRrs> {
        NPUCACHERAMLPENC_W::new(self, 10)
    }
    ///Bit 11 - VENCRAM sleep enable
    #[inline(always)]
    pub fn vencramlpenc(&mut self) -> VENCRAMLPENC_W<MEMLPENCRrs> {
        VENCRAMLPENC_W::new(self, 11)
    }
    ///Bit 12 - BOOTROM sleep enable
    #[inline(always)]
    pub fn bootromlpenc(&mut self) -> BOOTROMLPENC_W<MEMLPENCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:MEMLPENCR)*/
