...
impl W {
    ///Bit 0 - AXISRAM3 reset
    #[inline(always)]
    pub fn axisram3rst(&mut self) -> AXISRAM3RST_W<MEMRSTRrs> {
        AXISRAM3RST_W::new(self, 0)
    }
    ///Bit 1 - AXISRAM4reset
    #[inline(always)]
    pub fn axisram4rst(&mut self) -> AXISRAM4RST_W<MEMRSTRrs> {
        AXISRAM4RST_W::new(self, 1)
    }
    ///Bit 2 - AXISRAM5 reset
    #[inline(always)]
    pub fn axisram5rst(&mut self) -> AXISRAM5RST_W<MEMRSTRrs> {
        AXISRAM5RST_W::new(self, 2)
    }
    ///Bit 3 - AXISRAM6 reset
    #[inline(always)]
    pub fn axisram6rst(&mut self) -> AXISRAM6RST_W<MEMRSTRrs> {
        AXISRAM6RST_W::new(self, 3)
    }
    ///Bit 4 - AHBSRAM1 reset
    #[inline(always)]
    pub fn ahbsram1rst(&mut self) -> AHBSRAM1RST_W<MEMRSTRrs> {
        AHBSRAM1RST_W::new(self, 4)
    }
    ///Bit 5 - AHBSRAM2 reset
    #[inline(always)]
    pub fn ahbsram2rst(&mut self) -> AHBSRAM2RST_W<MEMRSTRrs> {
        AHBSRAM2RST_W::new(self, 5)
    }
    ///Bit 7 - AXISRAM1 reset
    #[inline(always)]
    pub fn axisram1rst(&mut self) -> AXISRAM1RST_W<MEMRSTRrs> {
        AXISRAM1RST_W::new(self, 7)
    }
    ///Bit 8 - AXISRAM2 reset
    #[inline(always)]
    pub fn axisram2rst(&mut self) -> AXISRAM2RST_W<MEMRSTRrs> {
        AXISRAM2RST_W::new(self, 8)
    }
    ///Bit 9 - FLEXRAM reset
    #[inline(always)]
    pub fn flexramrst(&mut self) -> FLEXRAMRST_W<MEMRSTRrs> {
        FLEXRAMRST_W::new(self, 9)
    }
    ///Bit 10 - NPUCACHERAM reset
    #[inline(always)]
    pub fn npucacheramrst(&mut self) -> NPUCACHERAMRST_W<MEMRSTRrs> {
        NPUCACHERAMRST_W::new(self, 10)
    }
    ///Bit 11 - VENCRAM reset
    #[inline(always)]
    pub fn vencramrst(&mut self) -> VENCRAMRST_W<MEMRSTRrs> {
        VENCRAMRST_W::new(self, 11)
    }
    ///Bit 12 - BOOTROM reset
    #[inline(always)]
    pub fn bootromrst(&mut self) -> BOOTROMRST_W<MEMRSTRrs> {
