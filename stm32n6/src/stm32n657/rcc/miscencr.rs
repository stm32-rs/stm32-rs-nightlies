...
impl W {
    ///Bit 0 - DBG enable
    #[inline(always)]
    pub fn dbgenc(&mut self) -> DBGENC_W<MISCENCRrs> {
        DBGENC_W::new(self, 0)
    }
    ///Bit 1 - MCO1 enable
    #[inline(always)]
    pub fn mco1enc(&mut self) -> MCO1ENC_W<MISCENCRrs> {
        MCO1ENC_W::new(self, 1)
    }
    ///Bit 2 - MCO2 enable
    #[inline(always)]
    pub fn mco2enc(&mut self) -> MCO2ENC_W<MISCENCRrs> {
        MCO2ENC_W::new(self, 2)
    }
    ///Bit 3 - XSPIPHYCOMP enable
    #[inline(always)]
    pub fn xspiphycompenc(&mut self) -> XSPIPHYCOMPENC_W<MISCENCRrs> {
        XSPIPHYCOMPENC_W::new(self, 3)
    }
    ///Bit 6 - PER enable
    #[inline(always)]
    pub fn perenc(&mut self) -> PERENC_W<MISCENCRrs> {
        PERENC_W::new(self, 6)
    }
}
