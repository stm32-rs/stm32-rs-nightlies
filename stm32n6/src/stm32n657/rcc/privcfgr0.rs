...
impl W {
    ///Bit 0 - Defines the privilege protection of the LSI oscillator configuration bits.
    #[inline(always)]
    pub fn lsipv(&mut self) -> LSIPV_W<PRIVCFGR0rs> {
        LSIPV_W::new(self, 0)
    }
    ///Bit 1 - Defines the privilege protection of the LSE oscillator configuration bits.
    #[inline(always)]
    pub fn lsepv(&mut self) -> LSEPV_W<PRIVCFGR0rs> {
        LSEPV_W::new(self, 1)
    }
    ///Bit 2 - Defines the privilege protection of the MSI oscillator configuration bits.
    #[inline(always)]
    pub fn msipv(&mut self) -> MSIPV_W<PRIVCFGR0rs> {
        MSIPV_W::new(self, 2)
    }
    ///Bit 3 - Defines the privilege protection of the HSI oscillator configuration bits.
    #[inline(always)]
    pub fn hsipv(&mut self) -> HSIPV_W<PRIVCFGR0rs> {
        HSIPV_W::new(self, 3)
    }
    ///Bit 4 - Defines the privilege protection of the HSE oscillator configuration bits.
    #[inline(always)]
    pub fn hsepv(&mut self) -> HSEPV_W<PRIVCFGR0rs> {
        HSEPV_W::new(self, 4)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:PRIVCFGR0)*/
