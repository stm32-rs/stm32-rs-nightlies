...
impl W {
    ///Bit 0 - Defines the secure protection of the LSI oscillator configuration bits.
    #[inline(always)]
    pub fn lsisec(&mut self) -> LSISEC_W<SECCFGR0rs> {
        LSISEC_W::new(self, 0)
    }
    ///Bit 1 - Defines the secure protection of the LSE oscillator configuration bits.
    #[inline(always)]
    pub fn lsesec(&mut self) -> LSESEC_W<SECCFGR0rs> {
        LSESEC_W::new(self, 1)
    }
    ///Bit 2 - Defines the secure protection of the MSI oscillator configuration bits.
    #[inline(always)]
    pub fn msisec(&mut self) -> MSISEC_W<SECCFGR0rs> {
        MSISEC_W::new(self, 2)
    }
    ///Bit 3 - Defines the secure protection of the HSI oscillator configuration bits.
    #[inline(always)]
    pub fn hsisec(&mut self) -> HSISEC_W<SECCFGR0rs> {
        HSISEC_W::new(self, 3)
    }
    ///Bit 4 - Defines the secure protection of the HSE oscillator configuration bits.
    #[inline(always)]
    pub fn hsesec(&mut self) -> HSESEC_W<SECCFGR0rs> {
        HSESEC_W::new(self, 4)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:SECCFGR0)*/
