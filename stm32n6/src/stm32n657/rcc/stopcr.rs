...
impl W {
    ///Bit 0 - LSI oscillator enable in Stop mode.
    #[inline(always)]
    pub fn lsistopen(&mut self) -> LSISTOPEN_W<STOPCRrs> {
        LSISTOPEN_W::new(self, 0)
    }
    ///Bit 1 - LSE oscillator enable in Stop mode.
    #[inline(always)]
    pub fn lsestopen(&mut self) -> LSESTOPEN_W<STOPCRrs> {
        LSESTOPEN_W::new(self, 1)
    }
    ///Bit 2 - MSI oscillator enable in Stop mode.
    #[inline(always)]
    pub fn msistopen(&mut self) -> MSISTOPEN_W<STOPCRrs> {
        MSISTOPEN_W::new(self, 2)
    }
    ///Bit 3 - HSI oscillator enable in Stop mode.
    #[inline(always)]
    pub fn hsistopen(&mut self) -> HSISTOPEN_W<STOPCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#RCC:STOPCR)*/
pub struct STOPCRrs;
