...
///Field `WAITPEND` reader - CPSM waits for end of data transfer (CmdPend internal signal) from DPSM
pub type WAITPEND_R = crate::BitReader;
///Field `WAITPEND` writer - CPSM waits for end of data transfer (CmdPend internal signal) from DPSM
