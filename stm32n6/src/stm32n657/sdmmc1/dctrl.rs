...
///Field `DTEN` reader - Data transfer enable bit
pub type DTEN_R = crate::BitReader;
///Field `DTEN` writer - Data transfer enable bit
...
///Field `SDIOEN` reader - SD I/O interrupt enable functions
pub type SDIOEN_R = crate::BitReader;
///Field `SDIOEN` writer - SD I/O interrupt enable functions
...
///Field `FIFORST` reader - FIFO reset, flushes any remaining data
pub type FIFORST_R = crate::BitReader;
///Field `FIFORST` writer - FIFO reset, flushes any remaining data
