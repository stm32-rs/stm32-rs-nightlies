...
///Field `CSRNE` reader - Control buffer register not empty
...
///Field `WIDTH5` reader - duration of 5 symbols counted with spdifrx_ker_ck
...
impl R {
    ...
    ///Bit 1 - Control buffer register not empty
    #[inline(always)]
    ...
    ///Bits 16:30 - duration of 5 symbols counted with spdifrx_ker_ck
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#SPDIFRX:SR)*/
pub struct SRrs;
