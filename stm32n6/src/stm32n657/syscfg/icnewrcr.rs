...
impl W {
    ///Bit 0 - None
    #[inline(always)]
    pub fn sdmmc1_early_wr_rsp_enable(&mut self) -> SDMMC1_EARLY_WR_RSP_ENABLE_W<ICNEWRCRrs> {
        SDMMC1_EARLY_WR_RSP_ENABLE_W::new(self, 0)
    }
    ///Bit 1 - None
    #[inline(always)]
    pub fn sdmmc2_early_wr_rsp_enable(&mut self) -> SDMMC2_EARLY_WR_RSP_ENABLE_W<ICNEWRCRrs> {
        SDMMC2_EARLY_WR_RSP_ENABLE_W::new(self, 1)
    }
    ///Bit 2 - None
    #[inline(always)]
    pub fn usb1_early_wr_rsp_enable(&mut self) -> USB1_EARLY_WR_RSP_ENABLE_W<ICNEWRCRrs> {
        USB1_EARLY_WR_RSP_ENABLE_W::new(self, 2)
    }
    ///Bit 3 - None
    #[inline(always)]
    pub fn usb2_early_wr_rsp_enable(&mut self) -> USB2_EARLY_WR_RSP_ENABLE_W<ICNEWRCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#SYSCFG:ICNEWRCR)*/
