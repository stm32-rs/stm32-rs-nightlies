///Register `VDDIO1CCCR` reader
pub type R = crate::R<VDDIO1CCCRrs>;
///Register `VDDIO1CCCR` writer
pub type W = crate::W<VDDIO1CCCRrs>;
...
impl W {
    ///Bits 0:3 - These bits are written by software to define an I/O compensation code for NMOS transistors. This code is applied to the I/O compensation cell when the CS = 1.
    #[inline(always)]
    pub fn ransrc(&mut self) -> RANSRC_W<'_, VDDIO1CCCRrs> {
        RANSRC_W::new(self, 0)
    }
    ///Bits 4:7 - These bits are written by software to define an I/O compensation code for PMOS transistors. This code is applied to the I/O compensation cell when CS = 1.
    #[inline(always)]
    pub fn rapsrc(&mut self) -> RAPSRC_W<'_, VDDIO1CCCRrs> {
        RAPSRC_W::new(self, 4)
    }
    ///Bit 8 - Enables the compensation cell of I/Os supplied by VDDIOx.
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, VDDIO1CCCRrs> {
        EN_W::new(self, 8)
    }
    ///Bit 9 - Selects the code to be applied for the compensation cell of I/Os supplied by VDDIOx.
    #[inline(always)]
    pub fn cs(&mut self) -> CS_W<'_, VDDIO1CCCRrs> {
        CS_W::new(self, 9)
    }
}
/**SYSCFG VDDIO1 compensation cell control register

You can [`read`](crate::Reg::read) this register and get [`vddio1cccr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vddio1cccr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#SYSCFG:VDDIO1CCCR)*/
pub struct VDDIO1CCCRrs;
impl crate::RegisterSpec for VDDIO1CCCRrs {
    type Ux = u32;
}
///`read()` method returns [`vddio1cccr::R`](R) reader structure
impl crate::Readable for VDDIO1CCCRrs {}
///`write(|w| ..)` method takes [`vddio1cccr::W`](W) writer structure
impl crate::Writable for VDDIO1CCCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets VDDIO1CCCR to value 0
impl crate::Resettable for VDDIO1CCCRrs {}
