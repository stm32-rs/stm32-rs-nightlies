...
///Field `WUS0` reader - Wakeup from low-power mode interrupt flag selection
pub type WUS0_R = crate::BitReader;
///Field `WUS0` writer - Wakeup from low-power mode interrupt flag selection
pub type WUS0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WUS1` reader - Wakeup from low-power mode interrupt flag selection
pub type WUS1_R = crate::BitReader;
///Field `WUS1` writer - Wakeup from low-power mode interrupt flag selection
...
impl R {
    ...
    ///Bit 20 - Wakeup from low-power mode interrupt flag selection
    #[inline(always)]
    pub fn wus0(&self) -> WUS0_R {
        WUS0_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - Wakeup from low-power mode interrupt flag selection
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32N657.html#USART1:CR3)*/
pub struct CR3rs;
