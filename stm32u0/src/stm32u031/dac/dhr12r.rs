...
///Field `DACCDHR` reader - DAC channel1 12-bit right-aligned data These bits are written by software. They specify 12-bit data for DAC channel1.
pub type DACCDHR_R = crate::FieldReader<u16>;
///Field `DACCDHR` writer - DAC channel1 12-bit right-aligned data These bits are written by software. They specify 12-bit data for DAC channel1.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#DAC:DHR12R[1])*/
pub struct DHR12Rrs;
