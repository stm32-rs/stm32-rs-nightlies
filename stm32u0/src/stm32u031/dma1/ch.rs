...
impl CH {
    ...
    ///0x04 - DMA channel 1 number of data to transfer register
    #[inline(always)]
...
pub mod cr;
/**NDTR (rw) register accessor: DMA channel 1 number of data to transfer register
...
pub mod ndtr;
/**PAR (rw) register accessor: DMA channel 1 peripheral address register
...
pub mod par;
/**MAR (rw) register accessor: DMA channel 1 memory address register
