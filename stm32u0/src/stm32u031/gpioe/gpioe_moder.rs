///Register `GPIOE_MODER` reader
pub type R = crate::R<GPIOE_MODERrs>;
///Register `GPIOE_MODER` writer
pub type W = crate::W<GPIOE_MODERrs>;
...
impl W {
    ///Bits 0:1 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode0(&mut self) -> MODE0_W<GPIOE_MODERrs> {
        MODE0_W::new(self, 0)
    }
    ///Bits 2:3 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode1(&mut self) -> MODE1_W<GPIOE_MODERrs> {
        MODE1_W::new(self, 2)
    }
    ///Bits 4:5 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode2(&mut self) -> MODE2_W<GPIOE_MODERrs> {
        MODE2_W::new(self, 4)
    }
    ///Bits 6:7 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode3(&mut self) -> MODE3_W<GPIOE_MODERrs> {
        MODE3_W::new(self, 6)
    }
    ///Bits 8:9 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode4(&mut self) -> MODE4_W<GPIOE_MODERrs> {
        MODE4_W::new(self, 8)
    }
    ///Bits 10:11 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode5(&mut self) -> MODE5_W<GPIOE_MODERrs> {
        MODE5_W::new(self, 10)
    }
    ///Bits 12:13 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode6(&mut self) -> MODE6_W<GPIOE_MODERrs> {
        MODE6_W::new(self, 12)
    }
    ///Bits 14:15 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode7(&mut self) -> MODE7_W<GPIOE_MODERrs> {
        MODE7_W::new(self, 14)
    }
    ///Bits 16:17 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode8(&mut self) -> MODE8_W<GPIOE_MODERrs> {
        MODE8_W::new(self, 16)
    }
    ///Bits 18:19 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode9(&mut self) -> MODE9_W<GPIOE_MODERrs> {
        MODE9_W::new(self, 18)
    }
    ///Bits 20:21 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode10(&mut self) -> MODE10_W<GPIOE_MODERrs> {
        MODE10_W::new(self, 20)
    }
    ///Bits 22:23 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode11(&mut self) -> MODE11_W<GPIOE_MODERrs> {
        MODE11_W::new(self, 22)
    }
    ///Bits 24:25 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode12(&mut self) -> MODE12_W<GPIOE_MODERrs> {
        MODE12_W::new(self, 24)
    }
    ///Bits 26:27 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode13(&mut self) -> MODE13_W<GPIOE_MODERrs> {
        MODE13_W::new(self, 26)
    }
    ///Bits 28:29 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode14(&mut self) -> MODE14_W<GPIOE_MODERrs> {
        MODE14_W::new(self, 28)
    }
    ///Bits 30:31 - Port x configuration I/O pin y These bits are written by software to configure the I/O mode.
    #[inline(always)]
    pub fn mode15(&mut self) -> MODE15_W<GPIOE_MODERrs> {
        MODE15_W::new(self, 30)
    }
}
/**GPIO port mode register

You can [`read`](crate::Reg::read) this register and get [`gpioe_moder::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioe_moder::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#GPIOE:GPIOE_MODER)*/
pub struct GPIOE_MODERrs;
impl crate::RegisterSpec for GPIOE_MODERrs {
    type Ux = u32;
}
///`read()` method returns [`gpioe_moder::R`](R) reader structure
impl crate::Readable for GPIOE_MODERrs {}
///`write(|w| ..)` method takes [`gpioe_moder::W`](W) writer structure
impl crate::Writable for GPIOE_MODERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIOE_MODER to value 0xffff_ffff
impl crate::Resettable for GPIOE_MODERrs {
