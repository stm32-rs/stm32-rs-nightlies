///Register `LPTIM2_ISR_INPUT` reader
pub type R = crate::R<LPTIM2_ISR_INPUTrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LPTIM2_ISR_INPUT")
...
You can [`read`](crate::Reg::read) this register and get [`lptim2_isr_input::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#LPTIM2:LPTIM2_ISR_INPUT)*/
pub struct LPTIM2_ISR_INPUTrs;
impl crate::RegisterSpec for LPTIM2_ISR_INPUTrs {
    type Ux = u32;
}
///`read()` method returns [`lptim2_isr_input::R`](R) reader structure
impl crate::Readable for LPTIM2_ISR_INPUTrs {}
///`reset()` method sets LPTIM2_ISR_INPUT to value 0
impl crate::Resettable for LPTIM2_ISR_INPUTrs {
