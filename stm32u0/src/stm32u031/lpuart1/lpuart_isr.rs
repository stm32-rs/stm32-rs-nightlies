///Register `LPUART_ISR` reader
pub type R = crate::R<LPUART_ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`lpuart_isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#LPUART1:LPUART_ISR)*/
pub struct LPUART_ISRrs;
impl crate::RegisterSpec for LPUART_ISRrs {
    type Ux = u32;
}
///`read()` method returns [`lpuart_isr::R`](R) reader structure
impl crate::Readable for LPUART_ISRrs {}
///`reset()` method sets LPUART_ISR to value 0x0080_00c0
impl crate::Resettable for LPUART_ISRrs {
