///Register `RTC_ALRABINR` reader
pub type R = crate::R<RTC_ALRABINRrs>;
///Register `RTC_ALRABINR` writer
pub type W = crate::W<RTC_ALRABINRrs>;
...
impl W {
    ...
    in the RTC_ALRMASSRR, and so can also be read or written through RTC_ALRMASSR.*/
    #[inline(always)]
    pub fn ss(&mut self) -> SS_W<RTC_ALRABINRrs> {
        SS_W::new(self, 0)
    }
}
/**RTC alarm A binary mode register

You can [`read`](crate::Reg::read) this register and get [`rtc_alrabinr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rtc_alrabinr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#RTC:RTC_ALRABINR)*/
pub struct RTC_ALRABINRrs;
impl crate::RegisterSpec for RTC_ALRABINRrs {
    type Ux = u32;
}
///`read()` method returns [`rtc_alrabinr::R`](R) reader structure
impl crate::Readable for RTC_ALRABINRrs {}
///`write(|w| ..)` method takes [`rtc_alrabinr::W`](W) writer structure
impl crate::Writable for RTC_ALRABINRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RTC_ALRABINR to value 0
impl crate::Resettable for RTC_ALRABINRrs {
