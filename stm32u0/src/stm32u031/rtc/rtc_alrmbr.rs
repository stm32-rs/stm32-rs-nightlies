///Register `RTC_ALRMBR` reader
pub type R = crate::R<RTC_ALRMBRrs>;
///Register `RTC_ALRMBR` writer
pub type W = crate::W<RTC_ALRMBRrs>;
...
impl W {
    ///Bits 0:3 - Second units in BCD format
    #[inline(always)]
    pub fn su(&mut self) -> SU_W<RTC_ALRMBRrs> {
        SU_W::new(self, 0)
    }
    ///Bits 4:6 - Second tens in BCD format
    #[inline(always)]
    pub fn st(&mut self) -> ST_W<RTC_ALRMBRrs> {
        ST_W::new(self, 4)
    }
    ///Bit 7 - Alarm B seconds mask
    #[inline(always)]
    pub fn msk1(&mut self) -> MSK1_W<RTC_ALRMBRrs> {
        MSK1_W::new(self, 7)
    }
    ///Bits 8:11 - Minute units in BCD format
    #[inline(always)]
    pub fn mnu(&mut self) -> MNU_W<RTC_ALRMBRrs> {
        MNU_W::new(self, 8)
    }
    ///Bits 12:14 - Minute tens in BCD format
    #[inline(always)]
    pub fn mnt(&mut self) -> MNT_W<RTC_ALRMBRrs> {
        MNT_W::new(self, 12)
    }
    ///Bit 15 - Alarm B minutes mask
    #[inline(always)]
    pub fn msk2(&mut self) -> MSK2_W<RTC_ALRMBRrs> {
        MSK2_W::new(self, 15)
    }
    ///Bits 16:19 - Hour units in BCD format
    #[inline(always)]
    pub fn hu(&mut self) -> HU_W<RTC_ALRMBRrs> {
        HU_W::new(self, 16)
    }
    ///Bits 20:21 - Hour tens in BCD format
    #[inline(always)]
    pub fn ht(&mut self) -> HT_W<RTC_ALRMBRrs> {
        HT_W::new(self, 20)
    }
    ///Bit 22 - AM/PM notation
    #[inline(always)]
    pub fn pm(&mut self) -> PM_W<RTC_ALRMBRrs> {
        PM_W::new(self, 22)
    }
    ///Bit 23 - Alarm B hours mask
    #[inline(always)]
    pub fn msk3(&mut self) -> MSK3_W<RTC_ALRMBRrs> {
        MSK3_W::new(self, 23)
    }
    ///Bits 24:27 - Date units or day in BCD format
    #[inline(always)]
    pub fn du(&mut self) -> DU_W<RTC_ALRMBRrs> {
        DU_W::new(self, 24)
    }
    ///Bits 28:29 - Date tens in BCD format
    #[inline(always)]
    pub fn dt(&mut self) -> DT_W<RTC_ALRMBRrs> {
        DT_W::new(self, 28)
    }
    ///Bit 30 - Week day selection
    #[inline(always)]
    pub fn wdsel(&mut self) -> WDSEL_W<RTC_ALRMBRrs> {
        WDSEL_W::new(self, 30)
    }
    ///Bit 31 - Alarm B date mask
    #[inline(always)]
    pub fn msk4(&mut self) -> MSK4_W<RTC_ALRMBRrs> {
        MSK4_W::new(self, 31)
    }
}
...
pub struct RTC_ALRMBRrs;
impl crate::RegisterSpec for RTC_ALRMBRrs {
    type Ux = u32;
}
///`read()` method returns [`rtc_alrmbr::R`](R) reader structure
impl crate::Readable for RTC_ALRMBRrs {}
///`write(|w| ..)` method takes [`rtc_alrmbr::W`](W) writer structure
impl crate::Writable for RTC_ALRMBRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RTC_ALRMBR to value 0
impl crate::Resettable for RTC_ALRMBRrs {
