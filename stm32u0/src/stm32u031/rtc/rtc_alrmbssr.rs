///Register `RTC_ALRMBSSR` reader
pub type R = crate::R<RTC_ALRMBSSRrs>;
///Register `RTC_ALRMBSSR` writer
pub type W = crate::W<RTC_ALRMBSSRrs>;
...
impl W {
    ...
    in the RTC_ALRBBINR, and so can also be read or written through RTC_ALRBBINR.*/
    #[inline(always)]
    pub fn ss(&mut self) -> SS_W<RTC_ALRMBSSRrs> {
        SS_W::new(self, 0)
    }
    ///Bits 24:29 - Mask the most-significant bits starting at this bit ... From 32 to 63: All 32 SS bits are compared and must match to activate alarm. Note: In BCD mode (BIN=00)The overflow bits of the synchronous counter (bits 15) is never compared. This bit can be different from 0 only after a shift operation.
    #[inline(always)]
    pub fn maskss(&mut self) -> MASKSS_W<RTC_ALRMBSSRrs> {
        MASKSS_W::new(self, 24)
    }
    ///Bit 31 - Clear synchronous counter on alarm (Binary mode only) Note: SSCLR must be kept to 0 when BCD or mixed mode is used (BIN = 00, 10 or 11).
    #[inline(always)]
    pub fn ssclr(&mut self) -> SSCLR_W<RTC_ALRMBSSRrs> {
        SSCLR_W::new(self, 31)
    }
}
...
pub struct RTC_ALRMBSSRrs;
impl crate::RegisterSpec for RTC_ALRMBSSRrs {
    type Ux = u32;
}
///`read()` method returns [`rtc_alrmbssr::R`](R) reader structure
impl crate::Readable for RTC_ALRMBSSRrs {}
///`write(|w| ..)` method takes [`rtc_alrmbssr::W`](W) writer structure
impl crate::Writable for RTC_ALRMBSSRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RTC_ALRMBSSR to value 0
impl crate::Resettable for RTC_ALRMBSSRrs {
