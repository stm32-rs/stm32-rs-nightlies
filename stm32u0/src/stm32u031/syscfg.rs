...
pub struct RegisterBlock {
    ...
    syscfg_scsr: SYSCFG_SCSR,
    syscfg_skr: SYSCFG_SKR,
    syscfg_tsccr: SYSCFG_TSCCR,
    _reserved5: [u8; 0x58],
    ...
    syscfg_itline17: SYSCFG_ITLINE17,
    syscfg_itline18: SYSCFG_ITLINE18,
    syscfg_itline19: SYSCFG_ITLINE19,
    syscfg_itline20: SYSCFG_ITLINE20,
    ...
    syscfg_itline29: SYSCFG_ITLINE29,
    syscfg_itline30: SYSCFG_ITLINE30,
    syscfg_itline31: SYSCFG_ITLINE31,
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn syscfg_scsr(&self) -> &SYSCFG_SCSR {
        &self.syscfg_scsr
    }
    ///0x20 - SYSCFG SRAM2 key register
    #[inline(always)]
    pub const fn syscfg_skr(&self) -> &SYSCFG_SKR {
        &self.syscfg_skr
    }
    ///0x24 - SYSCFG TSC comparator register
    #[inline(always)]
    pub const fn syscfg_tsccr(&self) -> &SYSCFG_TSCCR {
        &self.syscfg_tsccr
    }
    ...
    #[inline(always)]
    pub const fn syscfg_itline17(&self) -> &SYSCFG_ITLINE17 {
        &self.syscfg_itline17
    }
    ///0xc8 - SYSCFG interrupt line 18 status register
    #[inline(always)]
    pub const fn syscfg_itline18(&self) -> &SYSCFG_ITLINE18 {
    ...
    #[inline(always)]
    pub const fn syscfg_itline20(&self) -> &SYSCFG_ITLINE20 {
    ...
    #[inline(always)]
    pub const fn syscfg_itline29(&self) -> &SYSCFG_ITLINE29 {
        &self.syscfg_itline29
    }
    ///0xf8 - SYSCFG interrupt line 30 status register
    #[inline(always)]
    pub const fn syscfg_itline30(&self) -> &SYSCFG_ITLINE30 {
        &self.syscfg_itline30
    }
    ///0xfc - SYSCFG interrupt line 31 status register
    #[inline(always)]
    pub const fn syscfg_itline31(&self) -> &SYSCFG_ITLINE31 {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_CFGR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_CFGR2)
...
/**SYSCFG_SCSR (rw) register accessor: SYSCFG SRAM2 control and status register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_SCSR)

For information about available fields see [`mod@syscfg_scsr`]
module*/
pub type SYSCFG_SCSR = crate::Reg<syscfg_scsr::SYSCFG_SCSRrs>;
///SYSCFG SRAM2 control and status register
pub mod syscfg_scsr;
/**SYSCFG_SKR (w) register accessor: SYSCFG SRAM2 key register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_SKR)

For information about available fields see [`mod@syscfg_skr`]
module*/
pub type SYSCFG_SKR = crate::Reg<syscfg_skr::SYSCFG_SKRrs>;
///SYSCFG SRAM2 key register
pub mod syscfg_skr;
/**SYSCFG_TSCCR (rw) register accessor: SYSCFG TSC comparator register

You can [`read`](crate::Reg::read) this register and get [`syscfg_tsccr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`syscfg_tsccr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_TSCCR)

For information about available fields see [`mod@syscfg_tsccr`]
module*/
pub type SYSCFG_TSCCR = crate::Reg<syscfg_tsccr::SYSCFG_TSCCRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE7)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE8)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE9)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE10)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE11)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE12)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE13)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE14)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE15)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE16)
...
/**SYSCFG_ITLINE17 (r) register accessor: SYSCFG interrupt line 17 status register

You can [`read`](crate::Reg::read) this register and get [`syscfg_itline17::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE17)

For information about available fields see [`mod@syscfg_itline17`]
module*/
pub type SYSCFG_ITLINE17 = crate::Reg<syscfg_itline17::SYSCFG_ITLINE17rs>;
///SYSCFG interrupt line 17 status register
pub mod syscfg_itline17;
/**SYSCFG_ITLINE18 (r) register accessor: SYSCFG interrupt line 18 status register

You can [`read`](crate::Reg::read) this register and get [`syscfg_itline18::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE18)

For information about available fields see [`mod@syscfg_itline18`]
module*/
pub type SYSCFG_ITLINE18 = crate::Reg<syscfg_itline18::SYSCFG_ITLINE18rs>;
...
/**SYSCFG_ITLINE20 (r) register accessor: SYSCFG interrupt line 20 status register

You can [`read`](crate::Reg::read) this register and get [`syscfg_itline20::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE20)

For information about available fields see [`mod@syscfg_itline20`]
module*/
pub type SYSCFG_ITLINE20 = crate::Reg<syscfg_itline20::SYSCFG_ITLINE20rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE21)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE22)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE23)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE24)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE25)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE26)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE27)
...
/**SYSCFG_ITLINE29 (r) register accessor: SYSCFG interrupt line 29 status register

You can [`read`](crate::Reg::read) this register and get [`syscfg_itline29::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
module*/
pub type SYSCFG_ITLINE29 = crate::Reg<syscfg_itline29::SYSCFG_ITLINE29rs>;
///SYSCFG interrupt line 29 status register
pub mod syscfg_itline29;
/**SYSCFG_ITLINE30 (r) register accessor: SYSCFG interrupt line 30 status register

You can [`read`](crate::Reg::read) this register and get [`syscfg_itline30::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE30)

For information about available fields see [`mod@syscfg_itline30`]
module*/
pub type SYSCFG_ITLINE30 = crate::Reg<syscfg_itline30::SYSCFG_ITLINE30rs>;
///SYSCFG interrupt line 30 status register
pub mod syscfg_itline30;
/**SYSCFG_ITLINE31 (r) register accessor: SYSCFG interrupt line 31 status register

You can [`read`](crate::Reg::read) this register and get [`syscfg_itline31::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#SYSCFG:SYSCFG_ITLINE31)

For information about available fields see [`mod@syscfg_itline31`]
module*/
pub type SYSCFG_ITLINE31 = crate::Reg<syscfg_itline31::SYSCFG_ITLINE31rs>;
