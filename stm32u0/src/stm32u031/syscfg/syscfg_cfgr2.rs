...
/**Field `PVDL` reader - PVD lock enable bit This bit is set by software and cleared by a system reset. It can be used to enable and lock the PVD connection to TIM1/15/16 Break input, as well as the PVDE and PLS\[2:0\]
in the PWR_CR register.*/
pub type PVDL_R = crate::BitReader;
/**Field `PVDL` writer - PVD lock enable bit This bit is set by software and cleared by a system reset. It can be used to enable and lock the PVD connection to TIM1/15/16 Break input, as well as the PVDE and PLS\[2:0\]
in the PWR_CR register.*/
...
impl R {
    ...
    /**Bit 2 - PVD lock enable bit This bit is set by software and cleared by a system reset. It can be used to enable and lock the PVD connection to TIM1/15/16 Break input, as well as the PVDE and PLS\[2:0\]
    in the PWR_CR register.*/
    #[inline(always)]
...
impl W {
    ///Bit 0 - Cortex<Superscript>1<Default 1 Font>-M0+ LOCKUP bit enable bit This bit is set by software and cleared by a system reset. It can be use to enable and lock the connection of Cortex<Superscript>1<Default 1 Font>-M0+ LOCKUP (Hardfault) output to TIM1/15/16 Break input.
    #[inline(always)]
    pub fn ccl(&mut self) -> CCL_W<SYSCFG_CFGR2rs> {
        CCL_W::new(self, 0)
    }
    ///Bit 1 - SRAM1 parity lock bit This bit is set by software and cleared by a system reset. It can be used to enable and lock the SRAM1 parity error signal connection to TIM1/15/16 Break input.
    #[inline(always)]
    pub fn spl(&mut self) -> SPL_W<SYSCFG_CFGR2rs> {
        SPL_W::new(self, 1)
    }
    /**Bit 2 - PVD lock enable bit This bit is set by software and cleared by a system reset. It can be used to enable and lock the PVD connection to TIM1/15/16 Break input, as well as the PVDE and PLS\[2:0\]
    in the PWR_CR register.*/
    #[inline(always)]
    pub fn pvdl(&mut self) -> PVDL_W<SYSCFG_CFGR2rs> {
        PVDL_W::new(self, 2)
    }
    ///Bit 3 - ECC error lock bit This bit is set by software and cleared by a system reset. It can be used to enable and lock the flash ECC 2-bit error detection signal connection to TIM1/15/16 Break input.
    #[inline(always)]
    pub fn eccl(&mut self) -> ECCL_W<SYSCFG_CFGR2rs> {
        ECCL_W::new(self, 3)
    }
    ///Bit 4 - Backup SRAM2 parity lock This bit is set by software and cleared by a system reset. It can be used to enable and lock the SRAM2 parity error signal connection to TIM1/15/16 Break input.
    #[inline(always)]
    pub fn bkpl(&mut self) -> BKPL_W<SYSCFG_CFGR2rs> {
        BKPL_W::new(self, 4)
    }
    ///Bit 7 - Backup SRAM2 parity error flag This bit is set by hardware when an SRAM2 parity error is detected. It is cleared by software by writing 1.
    #[inline(always)]
    pub fn bkpf(&mut self) -> BKPF_W<SYSCFG_CFGR2rs> {
        BKPF_W::new(self, 7)
    }
    ///Bit 8 - SRAM1 parity error flag This bit is set by hardware when an SRAM1 parity error is detected. It is cleared by software by writing 1.
    #[inline(always)]
    pub fn spf(&mut self) -> SPF_W<SYSCFG_CFGR2rs> {
        SPF_W::new(self, 8)
    }
}
