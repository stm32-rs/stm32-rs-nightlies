...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYSCFG_ITLINE11")
...
You can [`read`](crate::Reg::read) this register and get [`syscfg_itline11::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
