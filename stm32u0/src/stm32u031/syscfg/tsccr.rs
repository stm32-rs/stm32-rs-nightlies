...
impl W {
    ///Bit 0 - Comparator mode for group 2 on I/O 1
    #[inline(always)]
    pub fn g2_io1(&mut self) -> G2_IO1_W<TSCCRrs> {
        G2_IO1_W::new(self, 0)
    }
    ///Bit 1 - Comparator mode for group 2 on I/O 3
    #[inline(always)]
    pub fn g2_io3(&mut self) -> G2_IO3_W<TSCCRrs> {
        G2_IO3_W::new(self, 1)
    }
    ///Bit 2 - Comparator mode for group 4 on I/O 3
    #[inline(always)]
    pub fn g4_io3(&mut self) -> G4_IO3_W<TSCCRrs> {
        G4_IO3_W::new(self, 2)
    }
    ///Bit 3 - Comparator mode for group 6 on I/O 1
    #[inline(always)]
    pub fn g6_io1(&mut self) -> G6_IO1_W<TSCCRrs> {
        G6_IO1_W::new(self, 3)
    }
    ///Bit 4 - Comparator mode for group 7 on I/O 1
    #[inline(always)]
    pub fn g7_io1(&mut self) -> G7_IO1_W<TSCCRrs> {
        G7_IO1_W::new(self, 4)
    }
    ///Bit 5 - I/O control in comparator mode The I/O control in comparator mode can be overwritten by hardware.
    #[inline(always)]
    pub fn tsc_ioctrl(&mut self) -> TSC_IOCTRL_W<TSCCRrs> {
