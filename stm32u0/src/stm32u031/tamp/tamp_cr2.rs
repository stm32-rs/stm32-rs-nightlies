...
impl W {
    ///Bit 0 - Tamper 1 potential mode
    #[inline(always)]
    pub fn tamp1pom(&mut self) -> TAMP1POM_W<TAMP_CR2rs> {
        TAMP1POM_W::new(self, 0)
    }
    ///Bit 1 - Tamper 2 potential mode
    #[inline(always)]
    pub fn tamp2pom(&mut self) -> TAMP2POM_W<TAMP_CR2rs> {
        TAMP2POM_W::new(self, 1)
    }
    ///Bit 2 - Tamper 3 potential mode
    #[inline(always)]
    pub fn tamp3pom(&mut self) -> TAMP3POM_W<TAMP_CR2rs> {
        TAMP3POM_W::new(self, 2)
    }
    ///Bit 3 - Tamper 4 potential mode
    #[inline(always)]
    pub fn tamp4pom(&mut self) -> TAMP4POM_W<TAMP_CR2rs> {
        TAMP4POM_W::new(self, 3)
    }
    ///Bit 4 - Tamper 5 potential mode
    #[inline(always)]
    pub fn tamp5pom(&mut self) -> TAMP5POM_W<TAMP_CR2rs> {
