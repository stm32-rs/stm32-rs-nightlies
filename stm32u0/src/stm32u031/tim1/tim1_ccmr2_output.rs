...
/**Field `OC3M` reader - OC3M\[2:0\]: Output compare 3 mode Refer to OC1M\[3:0\]
description.*/
pub type OC3M_R = crate::FieldReader;
/**Field `OC3M` writer - OC3M\[2:0\]: Output compare 3 mode Refer to OC1M\[3:0\]
description.*/
...
impl R {
    ...
    /**Bits 4:6 - OC3M\[2:0\]: Output compare 3 mode Refer to OC1M\[3:0\]
    description.*/
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM1_CCMR2_OUTPUT")
...
impl W {
    ///Bits 0:1 - Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc3s(&mut self) -> CC3S_W<TIM1_CCMR2_OUTPUTrs> {
        CC3S_W::new(self, 0)
    }
    ///Bit 2 - Output compare 3 fast enable Refer to OC1FE description.
    #[inline(always)]
    ...
    description.*/
    #[inline(always)]
    pub fn oc3m(&mut self) -> OC3M_W<TIM1_CCMR2_OUTPUTrs> {
        OC3M_W::new(self, 4)
    }
    ///Bit 7 - Output compare 3 clear enable Refer to OC1CE description.
    #[inline(always)]
    ...
    ///Bits 8:9 - Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc4s(&mut self) -> CC4S_W<TIM1_CCMR2_OUTPUTrs> {
        CC4S_W::new(self, 8)
    }
    ///Bit 10 - Output compare 4 fast enable Refer to OC1FE description.
    #[inline(always)]
    ...
    description.*/
    #[inline(always)]
    pub fn oc4m(&mut self) -> OC4M_W<TIM1_CCMR2_OUTPUTrs> {
        OC4M_W::new(self, 12)
    }
    ///Bit 15 - Output compare 4 clear enable Refer to OC1CE description.
    #[inline(always)]
    ...
    ///Bit 16 - OC3M\[3\]
    #[inline(always)]
    pub fn oc3m_1(&mut self) -> OC3M_1_W<TIM1_CCMR2_OUTPUTrs> {
        OC3M_1_W::new(self, 16)
    }
    ///Bit 24 - OC4M\[3\]
    #[inline(always)]
    pub fn oc4m_1(&mut self) -> OC4M_1_W<TIM1_CCMR2_OUTPUTrs> {
        OC4M_1_W::new(self, 24)
    }
}
/**TIM1 capture/compare mode register 1

You can [`read`](crate::Reg::read) this register and get [`tim1_ccmr2_output::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim1_ccmr2_output::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM1:TIM1_CCMR2_OUTPUT)*/
