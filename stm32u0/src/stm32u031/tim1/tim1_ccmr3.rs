...
///Field `OC5M` reader - OC5M\[0\]: Output compare 5 mode Refer to OC1M description.
pub type OC5M_R = crate::FieldReader;
///Field `OC5M` writer - OC5M\[0\]: Output compare 5 mode Refer to OC1M description.
...
///Field `OC6M` reader - OC6M\[0\]: Output compare 6 mode Refer to OC1M description.
pub type OC6M_R = crate::FieldReader;
///Field `OC6M` writer - OC6M\[0\]: Output compare 6 mode Refer to OC1M description.
...
impl R {
    ...
    ///Bits 4:6 - OC5M\[0\]: Output compare 5 mode Refer to OC1M description.
    #[inline(always)]
    ...
    ///Bits 12:14 - OC6M\[0\]: Output compare 6 mode Refer to OC1M description.
    #[inline(always)]
...
impl W {
    ///Bit 2 - Output compare 5 fast enable Refer to OC1FE description.
    #[inline(always)]
    pub fn oc5fe(&mut self) -> OC5FE_W<TIM1_CCMR3rs> {
        OC5FE_W::new(self, 2)
    }
    ///Bit 3 - Output compare 5 preload enable Refer to OC1PE description.
    #[inline(always)]
    pub fn oc5pe(&mut self) -> OC5PE_W<TIM1_CCMR3rs> {
        OC5PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC5M\[0\]: Output compare 5 mode Refer to OC1M description.
    #[inline(always)]
    pub fn oc5m(&mut self) -> OC5M_W<TIM1_CCMR3rs> {
        OC5M_W::new(self, 4)
    }
    ///Bit 7 - Output compare 5 clear enable Refer to OC1CE description.
    #[inline(always)]
    pub fn oc5ce(&mut self) -> OC5CE_W<TIM1_CCMR3rs> {
        OC5CE_W::new(self, 7)
    }
    ///Bit 10 - Output compare 6 fast enable Refer to OC1FE description.
    #[inline(always)]
    pub fn oc6fe(&mut self) -> OC6FE_W<TIM1_CCMR3rs> {
        OC6FE_W::new(self, 10)
    }
    ///Bit 11 - Output compare 6 preload enable Refer to OC1PE description.
    #[inline(always)]
    pub fn oc6pe(&mut self) -> OC6PE_W<TIM1_CCMR3rs> {
        OC6PE_W::new(self, 11)
    }
    ///Bits 12:14 - OC6M\[0\]: Output compare 6 mode Refer to OC1M description.
    #[inline(always)]
    pub fn oc6m(&mut self) -> OC6M_W<TIM1_CCMR3rs> {
        OC6M_W::new(self, 12)
    }
    ///Bit 15 - Output compare 6 clear enable Refer to OC1CE description.
    #[inline(always)]
    pub fn oc6ce(&mut self) -> OC6CE_W<TIM1_CCMR3rs> {
        OC6CE_W::new(self, 15)
    }
    ///Bit 16 - OC5M\[3\]
    #[inline(always)]
    pub fn oc5m_1(&mut self) -> OC5M_1_W<TIM1_CCMR3rs> {
        OC5M_1_W::new(self, 16)
    }
    ///Bit 24 - OC6M\[3\]
    #[inline(always)]
    pub fn oc6m_1(&mut self) -> OC6M_1_W<TIM1_CCMR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM1:TIM1_CCMR3)*/
