...
impl RegisterBlock {
    ...
    ///0x50 - TIM3 option register 1
    #[inline(always)]
    pub const fn tim3_or1(&self) -> &TIM3_OR1 {
        &self.tim3_or1
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_SR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_EGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CCMR1)

For information about available fields see [`mod@tim3_ccmr1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CCMR1_ALTERNATE1)

For information about available fields see [`mod@tim3_ccmr1_alternate1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CCMR2)

For information about available fields see [`mod@tim3_ccmr2`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CCMR2_ALTERNATE1)

For information about available fields see [`mod@tim3_ccmr2_alternate1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CCER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CNT)
...
For information about available fields see [`mod@tim3_cnt_alternate1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_PSC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CCR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CCR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CCR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_CCR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_DCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_DMAR)
...
pub mod tim3_dmar;
/**TIM3_OR1 (rw) register accessor: TIM3 option register 1

You can [`read`](crate::Reg::read) this register and get [`tim3_or1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim3_or1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_OR1)

For information about available fields see [`mod@tim3_or1`]
module*/
pub type TIM3_OR1 = crate::Reg<tim3_or1::TIM3_OR1rs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_AF1)

For information about available fields see [`mod@tim3_af1`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#TIM3:TIM3_TISEL)

For information about available fields see [`mod@tim3_tisel`]
module*/
