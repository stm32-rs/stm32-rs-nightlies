...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn usart_cr1_alternate(&self) -> &USART_CR1_ALTERNATE {
    ...
    #[inline(always)]
    pub const fn usart_isr_alternate(&self) -> &USART_ISR_ALTERNATE {
...
pub mod usart_cr1;
/**USART_CR1_ALTERNATE (rw) register accessor: USART control register 1

You can [`read`](crate::Reg::read) this register and get [`usart_cr1_alternate::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usart_cr1_alternate::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
module*/
pub type USART_CR1_ALTERNATE = crate::Reg<usart_cr1_alternate::USART_CR1_ALTERNATErs>;
///USART control register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_CR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_BRR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_GTPR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_RTOR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_RQR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_ISR)
...
pub mod usart_isr;
/**USART_ISR_ALTERNATE (r) register accessor: USART interrupt and status register

You can [`read`](crate::Reg::read) this register and get [`usart_isr_alternate::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_ISR_ALTERNATE)

For information about available fields see [`mod@usart_isr_alternate`]
module*/
pub type USART_ISR_ALTERNATE = crate::Reg<usart_isr_alternate::USART_ISR_ALTERNATErs>;
///USART interrupt and status register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_RDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_TDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U031.html#USART1:USART_PRESC)
