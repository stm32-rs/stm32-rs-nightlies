///Register `CRS_CR` reader
pub type R = crate::R<CRS_CRrs>;
///Register `CRS_CR` writer
pub type W = crate::W<CRS_CRrs>;
...
///Field `AUTOTRIMEN` reader - Automatic trimming enable This bit enables the automatic hardware adjustment of TRIM bits according to the measured frequency error between two SYNC events. If this bit is set, the TRIM bits are read-only. The TRIM value can be adjusted by hardware by one or two steps at a time, depending on the measured frequency error value. Refer to Section15.4.4 for more details.
pub type AUTOTRIMEN_R = crate::BitReader;
///Field `AUTOTRIMEN` writer - Automatic trimming enable This bit enables the automatic hardware adjustment of TRIM bits according to the measured frequency error between two SYNC events. If this bit is set, the TRIM bits are read-only. The TRIM value can be adjusted by hardware by one or two steps at a time, depending on the measured frequency error value. Refer to Section15.4.4 for more details.
...
impl W {
    ///Bit 0 - SYNC event OK interrupt enable
    #[inline(always)]
    pub fn syncokie(&mut self) -> SYNCOKIE_W<CRS_CRrs> {
        SYNCOKIE_W::new(self, 0)
    }
    ///Bit 1 - SYNC warning interrupt enable
    #[inline(always)]
    pub fn syncwarnie(&mut self) -> SYNCWARNIE_W<CRS_CRrs> {
        SYNCWARNIE_W::new(self, 1)
    }
    ///Bit 2 - Synchronization or trimming error interrupt enable
    #[inline(always)]
    pub fn errie(&mut self) -> ERRIE_W<CRS_CRrs> {
        ERRIE_W::new(self, 2)
    }
    ///Bit 3 - Expected SYNC interrupt enable
    #[inline(always)]
    pub fn esyncie(&mut self) -> ESYNCIE_W<CRS_CRrs> {
        ESYNCIE_W::new(self, 3)
    }
    ///Bit 5 - Frequency error counter enable This bit enables the oscillator clock for the frequency error counter. When this bit is set, the CRS_CFGR register is write-protected and cannot be modified.
    #[inline(always)]
    pub fn cen(&mut self) -> CEN_W<CRS_CRrs> {
        CEN_W::new(self, 5)
    }
    ///Bit 6 - Automatic trimming enable This bit enables the automatic hardware adjustment of TRIM bits according to the measured frequency error between two SYNC events. If this bit is set, the TRIM bits are read-only. The TRIM value can be adjusted by hardware by one or two steps at a time, depending on the measured frequency error value. Refer to Section15.4.4 for more details.
    #[inline(always)]
    pub fn autotrimen(&mut self) -> AUTOTRIMEN_W<CRS_CRrs> {
        AUTOTRIMEN_W::new(self, 6)
    }
    ///Bit 7 - Generate software SYNC event This bit is set by software in order to generate a software SYNC event. It is automatically cleared by hardware.
    #[inline(always)]
    pub fn swsync(&mut self) -> SWSYNC_W<CRS_CRrs> {
        SWSYNC_W::new(self, 7)
    }
    ///Bits 8:14 - HSI48 oscillator smooth trimming The default value of the HSI48 oscillator smooth trimming is 64, which corresponds to the middle of the trimming interval.
    #[inline(always)]
    pub fn trim(&mut self) -> TRIM_W<CRS_CRrs> {
        TRIM_W::new(self, 8)
    }
}
/**CRS control register

You can [`read`](crate::Reg::read) this register and get [`crs_cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`crs_cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#CRS:CRS_CR)*/
pub struct CRS_CRrs;
impl crate::RegisterSpec for CRS_CRrs {
    type Ux = u32;
}
///`read()` method returns [`crs_cr::R`](R) reader structure
impl crate::Readable for CRS_CRrs {}
///`write(|w| ..)` method takes [`crs_cr::W`](W) writer structure
impl crate::Writable for CRS_CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CRS_CR to value 0x4000
impl crate::Resettable for CRS_CRrs {
