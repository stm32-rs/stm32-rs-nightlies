///Register `CRS_ISR` reader
pub type R = crate::R<CRS_ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`crs_isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#CRS:CRS_ISR)*/
pub struct CRS_ISRrs;
impl crate::RegisterSpec for CRS_ISRrs {
    type Ux = u32;
}
///`read()` method returns [`crs_isr::R`](R) reader structure
impl crate::Readable for CRS_ISRrs {}
///`reset()` method sets CRS_ISR to value 0
impl crate::Resettable for CRS_ISRrs {
