...
///Field `EMPTY` reader - Main flash memory area empty This bit indicates whether the first location of the main flash memory area is erased or has a programmed value. The bit can be set and reset by software.
pub type EMPTY_R = crate::BitReader;
///Field `EMPTY` writer - Main flash memory area empty This bit indicates whether the first location of the main flash memory area is erased or has a programmed value. The bit can be set and reset by software.
...
impl R {
    ...
    ///Bit 16 - Main flash memory area empty This bit indicates whether the first location of the main flash memory area is erased or has a programmed value. The bit can be set and reset by software.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 9 - CPU Instruction cache enable
    #[inline(always)]
    pub fn icen(&mut self) -> ICEN_W<FLASH_ACRrs> {
        ICEN_W::new(self, 9)
    }
    ///Bit 11 - CPU Instruction cache reset This bit can be written only when the instruction cache is disabled.
    #[inline(always)]
    pub fn icrst(&mut self) -> ICRST_W<FLASH_ACRrs> {
        ICRST_W::new(self, 11)
    }
    ///Bit 16 - Main flash memory area empty This bit indicates whether the first location of the main flash memory area is erased or has a programmed value. The bit can be set and reset by software.
    #[inline(always)]
    pub fn empty(&mut self) -> EMPTY_W<FLASH_ACRrs> {
        EMPTY_W::new(self, 16)
    }
    ///Bit 18 - Debug access software enable Software may use this bit to enable/disable the debugger read access.
    #[inline(always)]
    pub fn dbg_swen(&mut self) -> DBG_SWEN_W<FLASH_ACRrs> {
        DBG_SWEN_W::new(self, 18)
    }
}
/**FLASH access control register

You can [`read`](crate::Reg::read) this register and get [`flash_acr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flash_acr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`reset()` method sets FLASH_ACR to value 0x0004_0600
