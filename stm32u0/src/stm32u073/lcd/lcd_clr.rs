///Register `LCD_CLR` writer
pub type W = crate::W<LCD_CLRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<LCD_CLRrs> {
...
pub struct LCD_CLRrs;
impl crate::RegisterSpec for LCD_CLRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`lcd_clr::W`](W) writer structure
impl crate::Writable for LCD_CLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LCD_CLR to value 0
impl crate::Resettable for LCD_CLRrs {
