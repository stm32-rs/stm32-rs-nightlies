///Register `LCD_CR` reader
pub type R = crate::R<LCD_CRrs>;
///Register `LCD_CR` writer
pub type W = crate::W<LCD_CRrs>;
...
/**Field `MUX_SEG` reader - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with1SEG\[31:28\]
or SEG\[15:12\]. See Section118.3.7.*/
pub type MUX_SEG_R = crate::BitReader;
/**Field `MUX_SEG` writer - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with1SEG\[31:28\]
or SEG\[15:12\]. See Section118.3.7.*/
...
impl R {
    ...
    /**Bit 7 - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with1SEG\[31:28\]
    or SEG\[15:12\]. See Section118.3.7.*/
    #[inline(always)]
...
impl W {
    ///Bit 0 - LCD controller enable This bit is set by software to enable the LCD controller/driver. It is cleared by software to turn off the LCD at the beginning of the next frame. When the LCD is disabled, all COM and SEG pins are driven to V<sub>SS</sub>.
    #[inline(always)]
    pub fn lcden(&mut self) -> LCDEN_W<LCD_CRrs> {
        LCDEN_W::new(self, 0)
    }
    ///Bit 1 - Voltage source selection This bit determines the voltage source for the LCD.
    #[inline(always)]
    pub fn vsel(&mut self) -> VSEL_W<LCD_CRrs> {
        VSEL_W::new(self, 1)
    }
    ///Bits 2:4 - Duty selection These bits determine the duty cycle. Values 101, 110 and 111 are forbidden. Others: Reserved
    #[inline(always)]
    pub fn duty(&mut self) -> DUTY_W<LCD_CRrs> {
        DUTY_W::new(self, 2)
    }
    ///Bits 5:6 - Bias selector These bits determine the bias used. Value 11 is forbidden.
    #[inline(always)]
    pub fn bias(&mut self) -> BIAS_W<LCD_CRrs> {
        BIAS_W::new(self, 5)
    }
    /**Bit 7 - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with1SEG\[31:28\]
    or SEG\[15:12\]. See Section118.3.7.*/
    #[inline(always)]
    pub fn mux_seg(&mut self) -> MUX_SEG_W<LCD_CRrs> {
        MUX_SEG_W::new(self, 7)
    }
    ///Bit 8 - Voltage output buffer enable This bit is used to enable/disable the voltage output buffer for higher driving capability.
    #[inline(always)]
    pub fn bufen(&mut self) -> BUFEN_W<LCD_CRrs> {
        BUFEN_W::new(self, 8)
    }
}
...
pub struct LCD_CRrs;
impl crate::RegisterSpec for LCD_CRrs {
    type Ux = u32;
}
///`read()` method returns [`lcd_cr::R`](R) reader structure
impl crate::Readable for LCD_CRrs {}
///`write(|w| ..)` method takes [`lcd_cr::W`](W) writer structure
impl crate::Writable for LCD_CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LCD_CR to value 0
impl crate::Resettable for LCD_CRrs {
