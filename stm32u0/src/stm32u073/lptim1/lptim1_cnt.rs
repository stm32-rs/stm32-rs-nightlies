///Register `LPTIM1_CNT` reader
pub type R = crate::R<LPTIM1_CNTrs>;
...
You can [`read`](crate::Reg::read) this register and get [`lptim1_cnt::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#LPTIM1:LPTIM1_CNT)*/
pub struct LPTIM1_CNTrs;
impl crate::RegisterSpec for LPTIM1_CNTrs {
    type Ux = u32;
}
///`read()` method returns [`lptim1_cnt::R`](R) reader structure
impl crate::Readable for LPTIM1_CNTrs {}
///`reset()` method sets LPTIM1_CNT to value 0
impl crate::Resettable for LPTIM1_CNTrs {
