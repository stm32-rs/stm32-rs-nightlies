///Register `LPTIM1_ICR_OUTPUT` writer
pub type W = crate::W<LPTIM1_ICR_OUTPUTrs>;
...
impl core::fmt::Debug for crate::generic::Reg<LPTIM1_ICR_OUTPUTrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn cmp1okcf(&mut self) -> CMP1OKCF_W<LPTIM1_ICR_OUTPUTrs> {
    ...
    #[inline(always)]
    pub fn arrokcf(&mut self) -> ARROKCF_W<LPTIM1_ICR_OUTPUTrs> {
    ...
    #[inline(always)]
    pub fn upcf(&mut self) -> UPCF_W<LPTIM1_ICR_OUTPUTrs> {
        UPCF_W::new(self, 5)
    }
    ...
    #[inline(always)]
    pub fn cc2cf(&mut self) -> CC2CF_W<LPTIM1_ICR_OUTPUTrs> {
        CC2CF_W::new(self, 9)
    }
    ...
    #[inline(always)]
    pub fn cc3cf(&mut self) -> CC3CF_W<LPTIM1_ICR_OUTPUTrs> {
        CC3CF_W::new(self, 10)
    }
    ...
    #[inline(always)]
    pub fn cc4cf(&mut self) -> CC4CF_W<LPTIM1_ICR_OUTPUTrs> {
        CC4CF_W::new(self, 11)
    }
    ...
    #[inline(always)]
    pub fn cmp2okcf(&mut self) -> CMP2OKCF_W<LPTIM1_ICR_OUTPUTrs> {
    ...
    #[inline(always)]
    pub fn cmp3okcf(&mut self) -> CMP3OKCF_W<LPTIM1_ICR_OUTPUTrs> {
    ...
    #[inline(always)]
    pub fn cmp4okcf(&mut self) -> CMP4OKCF_W<LPTIM1_ICR_OUTPUTrs> {
    ...
    #[inline(always)]
    pub fn dierokcf(&mut self) -> DIEROKCF_W<LPTIM1_ICR_OUTPUTrs> {
        DIEROKCF_W::new(self, 24)
    }
}
/**LPTIM1 interrupt clear register \[alternate\]

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lptim1_icr_output::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#LPTIM1:LPTIM1_ICR_OUTPUT)*/
pub struct LPTIM1_ICR_OUTPUTrs;
impl crate::RegisterSpec for LPTIM1_ICR_OUTPUTrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`lptim1_icr_output::W`](W) writer structure
impl crate::Writable for LPTIM1_ICR_OUTPUTrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPTIM1_ICR_OUTPUT to value 0
impl crate::Resettable for LPTIM1_ICR_OUTPUTrs {
