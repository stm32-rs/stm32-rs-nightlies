...
///Field `ARR` reader - Auto reload value ARR is the autoreload value for the LPTIM. This value must be strictly greater than the CCRx\[15:0\] value.
pub type ARR_R = crate::FieldReader<u16>;
///Field `ARR` writer - Auto reload value ARR is the autoreload value for the LPTIM. This value must be strictly greater than the CCRx\[15:0\] value.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#LPTIM3:ARR)*/
pub struct ARRrs;
