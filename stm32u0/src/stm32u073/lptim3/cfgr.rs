...
///Field `PRELOAD` reader - Registers update mode The PRELOAD bit controls the LPTIM3_ARR, LPTIM3_RCR and the LPTIM3_CCRx registers update modality
pub type PRELOAD_R = crate::BitReader;
///Field `PRELOAD` writer - Registers update mode The PRELOAD bit controls the LPTIM3_ARR, LPTIM3_RCR and the LPTIM3_CCRx registers update modality
...
impl R {
    ...
    ///Bit 22 - Registers update mode The PRELOAD bit controls the LPTIM3_ARR, LPTIM3_RCR and the LPTIM3_CCRx registers update modality
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#LPTIM3:CFGR)*/
pub struct CFGRrs;
