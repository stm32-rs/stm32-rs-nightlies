///Register `LPTIM3_DIER_OUTPUT` reader
pub type R = crate::R<LPTIM3_DIER_OUTPUTrs>;
///Register `LPTIM3_DIER_OUTPUT` writer
pub type W = crate::W<LPTIM3_DIER_OUTPUTrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LPTIM3_DIER_OUTPUT")
...
impl W {
    ///Bit 0 - Capture/compare 1 interrupt enable
    #[inline(always)]
    pub fn cc1ie(&mut self) -> CC1IE_W<LPTIM3_DIER_OUTPUTrs> {
        CC1IE_W::new(self, 0)
    }
    ///Bit 1 - Autoreload match Interrupt Enable
    #[inline(always)]
    pub fn arrmie(&mut self) -> ARRMIE_W<LPTIM3_DIER_OUTPUTrs> {
        ARRMIE_W::new(self, 1)
    }
    ///Bit 2 - External trigger valid edge Interrupt Enable
    #[inline(always)]
    pub fn exttrigie(&mut self) -> EXTTRIGIE_W<LPTIM3_DIER_OUTPUTrs> {
        EXTTRIGIE_W::new(self, 2)
    }
    ///Bit 3 - Compare register 1 update OK interrupt enable
    #[inline(always)]
    pub fn cmp1okie(&mut self) -> CMP1OKIE_W<LPTIM3_DIER_OUTPUTrs> {
        CMP1OKIE_W::new(self, 3)
    }
    ///Bit 4 - Autoreload register update OK Interrupt Enable
    #[inline(always)]
    pub fn arrokie(&mut self) -> ARROKIE_W<LPTIM3_DIER_OUTPUTrs> {
        ARROKIE_W::new(self, 4)
    }
    ///Bit 5 - Direction change to UP Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn upie(&mut self) -> UPIE_W<LPTIM3_DIER_OUTPUTrs> {
        UPIE_W::new(self, 5)
    }
    ///Bit 6 - Direction change to down Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn downie(&mut self) -> DOWNIE_W<LPTIM3_DIER_OUTPUTrs> {
        DOWNIE_W::new(self, 6)
    }
    ///Bit 7 - Update event interrupt enable
    #[inline(always)]
    pub fn ueie(&mut self) -> UEIE_W<LPTIM3_DIER_OUTPUTrs> {
        UEIE_W::new(self, 7)
    }
    ///Bit 8 - Repetition register update OK interrupt Enable
    #[inline(always)]
    pub fn repokie(&mut self) -> REPOKIE_W<LPTIM3_DIER_OUTPUTrs> {
        REPOKIE_W::new(self, 8)
    }
    ///Bit 9 - Capture/compare 2 interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc2ie(&mut self) -> CC2IE_W<LPTIM3_DIER_OUTPUTrs> {
        CC2IE_W::new(self, 9)
    }
    ///Bit 10 - Capture/compare 3 interrupt enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc3ie(&mut self) -> CC3IE_W<LPTIM3_DIER_OUTPUTrs> {
        CC3IE_W::new(self, 10)
    }
    ///Bit 11 - Capture/compare 4 interrupt enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc4ie(&mut self) -> CC4IE_W<LPTIM3_DIER_OUTPUTrs> {
        CC4IE_W::new(self, 11)
    }
    ///Bit 19 - Compare register 2 update OK interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cmp2okie(&mut self) -> CMP2OKIE_W<LPTIM3_DIER_OUTPUTrs> {
        CMP2OKIE_W::new(self, 19)
    }
    ///Bit 20 - Compare register 3 update OK interrupt enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cmp3okie(&mut self) -> CMP3OKIE_W<LPTIM3_DIER_OUTPUTrs> {
        CMP3OKIE_W::new(self, 20)
    }
    ///Bit 21 - Compare register 4 update OK interrupt enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cmp4okie(&mut self) -> CMP4OKIE_W<LPTIM3_DIER_OUTPUTrs> {
        CMP4OKIE_W::new(self, 21)
    }
    ///Bit 23 - Update event DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn uede(&mut self) -> UEDE_W<LPTIM3_DIER_OUTPUTrs> {
        UEDE_W::new(self, 23)
    }
}
/**LPTIM3 interrupt enable register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`lptim3_dier_output::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lptim3_dier_output::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#LPTIM3:LPTIM3_DIER_OUTPUT)*/
pub struct LPTIM3_DIER_OUTPUTrs;
impl crate::RegisterSpec for LPTIM3_DIER_OUTPUTrs {
    type Ux = u32;
}
///`read()` method returns [`lptim3_dier_output::R`](R) reader structure
impl crate::Readable for LPTIM3_DIER_OUTPUTrs {}
///`write(|w| ..)` method takes [`lptim3_dier_output::W`](W) writer structure
impl crate::Writable for LPTIM3_DIER_OUTPUTrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPTIM3_DIER_OUTPUT to value 0
impl crate::Resettable for LPTIM3_DIER_OUTPUTrs {
