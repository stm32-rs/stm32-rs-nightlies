///Register `LPUART_ISR_ALTERNATE` reader
pub type R = crate::R<LPUART_ISR_ALTERNATErs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LPUART_ISR_ALTERNATE")
            .field("pe", &self.pe())
            .field("fe", &self.fe())
            .field("ne", &self.ne())
            .field("ore", &self.ore())
...
You can [`read`](crate::Reg::read) this register and get [`lpuart_isr_alternate::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#LPUART1:LPUART_ISR_ALTERNATE)*/
pub struct LPUART_ISR_ALTERNATErs;
impl crate::RegisterSpec for LPUART_ISR_ALTERNATErs {
    type Ux = u32;
}
///`read()` method returns [`lpuart_isr_alternate::R`](R) reader structure
impl crate::Readable for LPUART_ISR_ALTERNATErs {}
///`reset()` method sets LPUART_ISR_ALTERNATE to value 0x0080_00c0
impl crate::Resettable for LPUART_ISR_ALTERNATErs {
