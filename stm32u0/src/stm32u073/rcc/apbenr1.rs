...
impl W {
    ...
    ///Bit 9 - LCD clock enable<sup>(1)</sup> Set and cleared by software.
    #[inline(always)]
    pub fn lcden(&mut self) -> LCDEN_W<APBENR1rs> {
        LCDEN_W::new(self, 9)
    }
    ///Bit 10 - RTC APB clock enable Set and cleared by software.
    #[inline(always)]
    ...
    ///Bit 12 - LPUART3 clock enable Set and cleared by software.
    #[inline(always)]
    pub fn lpuart3en(&mut self) -> LPUART3EN_W<APBENR1rs> {
    ...
    ///Bit 24 - OPAMP clock enable Set and cleared by software.
    #[inline(always)]
    pub fn opampen(&mut self) -> OPAMPEN_W<APBENR1rs> {
        OPAMPEN_W::new(self, 24)
    }
    ///Bit 25 - I2C4EN clock enable<sup>(1)</sup> Set and cleared by software.
    #[inline(always)]
    pub fn i2c4en(&mut self) -> I2C4EN_W<APBENR1rs> {
        I2C4EN_W::new(self, 25)
    }
    ///Bit 26 - LPTIM3 clock enable Set and cleared by software.
    #[inline(always)]
    pub fn lptim3en(&mut self) -> LPTIM3EN_W<APBENR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#RCC:APBENR1)*/
