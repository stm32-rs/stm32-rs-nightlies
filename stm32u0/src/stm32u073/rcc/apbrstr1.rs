...
impl W {
    ...
    ///Bit 9 - LCD reset<sup>(1)</sup> Set and cleared by software.
    #[inline(always)]
    pub fn lcdrst(&mut self) -> LCDRST_W<'_, APBRSTR1rs> {
        LCDRST_W::new(self, 9)
    }
    ///Bit 12 - LPUART3 reset<sup>(1)</sup> Set and cleared by software.
    #[inline(always)]
    pub fn lpuart3rst(&mut self) -> LPUART3RST_W<'_, APBRSTR1rs> {
    ...
    ///Bit 24 - OPAMP reset Set and cleared by software.
    #[inline(always)]
    pub fn opamprst(&mut self) -> OPAMPRST_W<'_, APBRSTR1rs> {
        OPAMPRST_W::new(self, 24)
    }
    ///Bit 25 - I2C4 reset<sup>(1)</sup> Set and cleared by software.
    #[inline(always)]
    pub fn i2c4rst(&mut self) -> I2C4RST_W<'_, APBRSTR1rs> {
        I2C4RST_W::new(self, 25)
    }
    ///Bit 26 - LPTIM3 reset Set and cleared by software.
    #[inline(always)]
    pub fn lptim3rst(&mut self) -> LPTIM3RST_W<'_, APBRSTR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#RCC:APBRSTR1)*/
