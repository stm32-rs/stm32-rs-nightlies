...
impl W {
    ...
    ///Bit 12 - LPUART3 reset<sup>(1)</sup> Set and cleared by software.
    #[inline(always)]
    pub fn lpuart3rst(&mut self) -> LPUART3RST_W<RCC_APBRSTR1rs> {
    ...
    ///Bit 15 - SPI3 reset<sup>(1)</sup> Set and cleared by software.
    #[inline(always)]
    pub fn spi3rst(&mut self) -> SPI3RST_W<RCC_APBRSTR1rs> {
        SPI3RST_W::new(self, 15)
    }
    ///Bit 16 - CRS reset<sup>(1)</sup> Set and cleared by software.
    #[inline(always)]
    pub fn crsrst(&mut self) -> CRSRST_W<RCC_APBRSTR1rs> {
    ...
    ///Bit 25 - I2C4 reset<sup>(1)</sup> Set and cleared by software.
    #[inline(always)]
    pub fn i2c4rst(&mut self) -> I2C4RST_W<RCC_APBRSTR1rs> {
        I2C4RST_W::new(self, 25)
    }
    ///Bit 26 - LPTIM3 reset Set and cleared by software.
    #[inline(always)]
    pub fn lptim3rst(&mut self) -> LPTIM3RST_W<RCC_APBRSTR1rs> {
