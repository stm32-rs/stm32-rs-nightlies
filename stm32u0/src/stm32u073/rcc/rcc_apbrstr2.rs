...
impl W {
    ///Bit 0 - SYSCFG, COMP and VREFBUF reset Set and cleared by software.
    #[inline(always)]
    pub fn syscfgrst(&mut self) -> SYSCFGRST_W<RCC_APBRSTR2rs> {
        SYSCFGRST_W::new(self, 0)
    }
    ///Bit 11 - TIM1 timer reset Set and cleared by software.
    #[inline(always)]
    pub fn tim1rst(&mut self) -> TIM1RST_W<RCC_APBRSTR2rs> {
        TIM1RST_W::new(self, 11)
    }
    ///Bit 12 - SPI1 reset Set and cleared by software.
    #[inline(always)]
    pub fn spi1rst(&mut self) -> SPI1RST_W<RCC_APBRSTR2rs> {
        SPI1RST_W::new(self, 12)
    }
    ///Bit 14 - USART1 reset Set and cleared by software.
    #[inline(always)]
    pub fn usart1rst(&mut self) -> USART1RST_W<RCC_APBRSTR2rs> {
        USART1RST_W::new(self, 14)
    }
    ///Bit 16 - TIM15 timer reset Set and cleared by software.
    #[inline(always)]
    pub fn tim15rst(&mut self) -> TIM15RST_W<RCC_APBRSTR2rs> {
        TIM15RST_W::new(self, 16)
    }
    ///Bit 17 - TIM16 timer reset Set and cleared by software.
    #[inline(always)]
    pub fn tim16rst(&mut self) -> TIM16RST_W<RCC_APBRSTR2rs> {
        TIM16RST_W::new(self, 17)
    }
    ///Bit 20 - ADC reset Set and cleared by software.
    #[inline(always)]
    pub fn adcrst(&mut self) -> ADCRST_W<RCC_APBRSTR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#RCC:RCC_APBRSTR2)*/
