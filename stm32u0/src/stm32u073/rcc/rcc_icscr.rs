///Register `RCC_ICSCR` reader
pub type R = crate::R<RCC_ICSCRrs>;
///Register `RCC_ICSCR` writer
pub type W = crate::W<RCC_ICSCRrs>;
...
/**Field `MSITRIM` reader - MSI clock trimming These bits provide an additional user-programmable trimming value that is added to the MSICAL\[7:0\]
...
/**Field `MSITRIM` writer - MSI clock trimming These bits provide an additional user-programmable trimming value that is added to the MSICAL\[7:0\]
bits. It can be programmed to adjust to variations in voltage and temperature that influence the frequency of the MSI.*/
...
impl R {
    ...
    /**Bits 8:15 - MSI clock trimming These bits provide an additional user-programmable trimming value that is added to the MSICAL\[7:0\]
    bits. It can be programmed to adjust to variations in voltage and temperature that influence the frequency of the MSI.*/
    #[inline(always)]
...
impl W {
    ...
    bits. It can be programmed to adjust to variations in voltage and temperature that influence the frequency of the MSI.*/
    #[inline(always)]
    pub fn msitrim(&mut self) -> MSITRIM_W<RCC_ICSCRrs> {
        MSITRIM_W::new(self, 8)
    }
    /**Bits 24:30 - HSI16 clock trimming These bits provide an additional user-programmable trimming value that is added to the HSICAL\[7:0\]
    bits. It can be programmed to adjust to variations in voltage and temperature that influence the frequency of the HSI16. The default value is 64 when added to the HSICAL value, trim the HSI16 to 161MHz 1 11%.*/
    #[inline(always)]
    pub fn hsitrim(&mut self) -> HSITRIM_W<RCC_ICSCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#RCC:RCC_ICSCR)*/
pub struct RCC_ICSCRrs;
impl crate::RegisterSpec for RCC_ICSCRrs {
    type Ux = u32;
}
///`read()` method returns [`rcc_icscr::R`](R) reader structure
impl crate::Readable for RCC_ICSCRrs {}
///`write(|w| ..)` method takes [`rcc_icscr::W`](W) writer structure
impl crate::Writable for RCC_ICSCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCC_ICSCR to value 0x4000_4000
impl crate::Resettable for RCC_ICSCRrs {
