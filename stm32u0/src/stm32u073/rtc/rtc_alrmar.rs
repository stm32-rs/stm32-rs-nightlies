...
impl W {
    ///Bits 0:3 - Second units in BCD format.
    #[inline(always)]
    pub fn su(&mut self) -> SU_W<RTC_ALRMARrs> {
        SU_W::new(self, 0)
    }
    ///Bits 4:6 - Second tens in BCD format.
    #[inline(always)]
    pub fn st(&mut self) -> ST_W<RTC_ALRMARrs> {
        ST_W::new(self, 4)
    }
    ///Bit 7 - Alarm A seconds mask
    #[inline(always)]
    pub fn msk1(&mut self) -> MSK1_W<RTC_ALRMARrs> {
        MSK1_W::new(self, 7)
    }
    ///Bits 8:11 - Minute units in BCD format
    #[inline(always)]
    pub fn mnu(&mut self) -> MNU_W<RTC_ALRMARrs> {
        MNU_W::new(self, 8)
    }
    ///Bits 12:14 - Minute tens in BCD format
    #[inline(always)]
    pub fn mnt(&mut self) -> MNT_W<RTC_ALRMARrs> {
        MNT_W::new(self, 12)
    }
    ///Bit 15 - Alarm A minutes mask
    #[inline(always)]
    pub fn msk2(&mut self) -> MSK2_W<RTC_ALRMARrs> {
        MSK2_W::new(self, 15)
    }
    ///Bits 16:19 - Hour units in BCD format
    #[inline(always)]
    pub fn hu(&mut self) -> HU_W<RTC_ALRMARrs> {
        HU_W::new(self, 16)
    }
    ///Bits 20:21 - Hour tens in BCD format
    #[inline(always)]
    pub fn ht(&mut self) -> HT_W<RTC_ALRMARrs> {
        HT_W::new(self, 20)
    }
    ///Bit 22 - AM/PM notation
    #[inline(always)]
    pub fn pm(&mut self) -> PM_W<RTC_ALRMARrs> {
        PM_W::new(self, 22)
    }
    ///Bit 23 - Alarm A hours mask
    #[inline(always)]
    pub fn msk3(&mut self) -> MSK3_W<RTC_ALRMARrs> {
        MSK3_W::new(self, 23)
    }
    ///Bits 24:27 - Date units or day in BCD format
    #[inline(always)]
    pub fn du(&mut self) -> DU_W<RTC_ALRMARrs> {
        DU_W::new(self, 24)
    }
    ///Bits 28:29 - Date tens in BCD format
    #[inline(always)]
    pub fn dt(&mut self) -> DT_W<RTC_ALRMARrs> {
        DT_W::new(self, 28)
    }
    ///Bit 30 - Week day selection
    #[inline(always)]
    pub fn wdsel(&mut self) -> WDSEL_W<RTC_ALRMARrs> {
        WDSEL_W::new(self, 30)
    }
    ///Bit 31 - Alarm A date mask
    #[inline(always)]
    pub fn msk4(&mut self) -> MSK4_W<RTC_ALRMARrs> {
        MSK4_W::new(self, 31)
    }
}
