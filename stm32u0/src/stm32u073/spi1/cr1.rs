    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn eight_bit(self) -> &'a mut crate::W<REG> {
        self.variant(CRCL::EightBit)
    }
    ///16-bit CRC length
    #[inline(always)]
    pub fn sixteen_bit(self) -> &'a mut crate::W<REG> {
        self.variant(CRCL::SixteenBit)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U073.html#SPI1:CR1)*/
pub struct CR1rs;
