...
impl W {
    ///Bit 2 - Internal tamper 3 potential mode
    #[inline(always)]
    pub fn itamp3pom(&mut self) -> ITAMP3POM_W<TAMP_CR3rs> {
        ITAMP3POM_W::new(self, 2)
    }
    ///Bit 3 - Internal tamper 4 potential mode
    #[inline(always)]
    pub fn itamp4pom(&mut self) -> ITAMP4POM_W<TAMP_CR3rs> {
        ITAMP4POM_W::new(self, 3)
    }
    ///Bit 4 - Internal tamper 5 potential mode
    #[inline(always)]
    pub fn itamp5pom(&mut self) -> ITAMP5POM_W<TAMP_CR3rs> {
        ITAMP5POM_W::new(self, 4)
    }
    ///Bit 5 - Internal tamper 6 potential mode
    #[inline(always)]
    pub fn itamp6pom(&mut self) -> ITAMP6POM_W<TAMP_CR3rs> {
