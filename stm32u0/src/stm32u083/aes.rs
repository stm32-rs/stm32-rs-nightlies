...
/**CR (rw) register accessor: AES control register
...
pub mod cr;
/**SR (r) register accessor: AES status register
...
///AES status register
pub mod sr;
/**DINR (w) register accessor: AES data input register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:DINR)
...
pub mod dinr;
/**DOUTR (r) register accessor: AES data output register

You can [`read`](crate::Reg::read) this register and get [`doutr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:DOUTR)
...
pub mod doutr;
/**KEYR0 (w) register accessor: AES key register 0
...
///AES key register 0
pub mod keyr0;
/**KEYR1 (w) register accessor: AES key register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:KEYR1)
...
///AES key register 1
pub mod keyr1;
/**KEYR2 (w) register accessor: AES key register 2
...
///AES key register 2
pub mod keyr2;
/**KEYR3 (w) register accessor: AES key register 3
...
///AES key register 3
pub mod keyr3;
/**IVR0 (rw) register accessor: AES initialization vector register 0
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:IVR0)
...
pub mod ivr0;
/**IVR1 (rw) register accessor: AES initialization vector register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:IVR1)
...
pub mod ivr1;
/**IVR2 (rw) register accessor: AES initialization vector register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:IVR2)
...
pub mod ivr2;
/**IVR3 (rw) register accessor: AES initialization vector register 3
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:IVR3)
...
pub mod ivr3;
/**KEYR4 (w) register accessor: AES key register 4
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:KEYR4)
...
///AES key register 4
pub mod keyr4;
/**KEYR5 (w) register accessor: AES key register 5
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:KEYR5)
...
///AES key register 5
pub mod keyr5;
/**KEYR6 (w) register accessor: AES key register 6
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:KEYR6)
...
///AES key register 6
pub mod keyr6;
/**KEYR7 (w) register accessor: AES key register 7
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:KEYR7)
...
///AES key register 7
pub mod keyr7;
/**SUSPR0 (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:SUSPR0)

For information about available fields see [`mod@suspr0`]
module*/
pub type SUSPR0 = crate::Reg<suspr0::SUSPR0rs>;
///AES suspend registers
pub mod suspr0;
/**SUSPR1 (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:SUSPR1)

For information about available fields see [`mod@suspr1`]
module*/
pub type SUSPR1 = crate::Reg<suspr1::SUSPR1rs>;
///AES suspend registers
pub mod suspr1;
/**SUSPR2 (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:SUSPR2)

For information about available fields see [`mod@suspr2`]
module*/
pub type SUSPR2 = crate::Reg<suspr2::SUSPR2rs>;
///AES suspend registers
pub mod suspr2;
/**SUSPR3 (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:SUSPR3)

For information about available fields see [`mod@suspr3`]
module*/
pub type SUSPR3 = crate::Reg<suspr3::SUSPR3rs>;
///AES suspend registers
pub mod suspr3;
/**SUSPR4 (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:SUSPR4)

For information about available fields see [`mod@suspr4`]
module*/
pub type SUSPR4 = crate::Reg<suspr4::SUSPR4rs>;
///AES suspend registers
pub mod suspr4;
/**SUSPR5 (rw) register accessor: AES suspend registers
...
For information about available fields see [`mod@suspr5`]
module*/
pub type SUSPR5 = crate::Reg<suspr5::SUSPR5rs>;
///AES suspend registers
pub mod suspr5;
/**SUSPR6 (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:SUSPR6)

For information about available fields see [`mod@suspr6`]
module*/
pub type SUSPR6 = crate::Reg<suspr6::SUSPR6rs>;
///AES suspend registers
pub mod suspr6;
/**SUSPR7 (rw) register accessor: AES suspend registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:SUSPR7)

For information about available fields see [`mod@suspr7`]
module*/
pub type SUSPR7 = crate::Reg<suspr7::SUSPR7rs>;
///AES suspend registers
pub mod suspr7;
/**IER (rw) register accessor: AES interrupt enable register

You can [`read`](crate::Reg::read) this register and get [`ier::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ier::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:IER)
...
pub mod ier;
/**ISR (r) register accessor: AES interrupt status register
...
pub mod isr;
/**ICR (w) register accessor: AES interrupt clear register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:ICR)
