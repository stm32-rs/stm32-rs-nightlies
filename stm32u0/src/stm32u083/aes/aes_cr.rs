...
/**Field `EN` reader - Enable This bit enables/disables the AES peripheral. At any moment, clearing then setting the bit re-initializes the AES peripheral. This bit is automatically cleared by hardware upon the completion of the key preparation (MODE\[1:0\]
...
/**Field `EN` writer - Enable This bit enables/disables the AES peripheral. At any moment, clearing then setting the bit re-initializes the AES peripheral. This bit is automatically cleared by hardware upon the completion of the key preparation (MODE\[1:0\]
at 0x1) and upon the completion of GCM/GMAC/CCM initialization phase. The bit cannot be set as long as KEYVALID1is cleared*/
...
/**Field `DMAINEN` reader - DMA input enable This bit enables automatic generation of DMA requests during the data phase, for incoming data transfers to AES via DMA. Setting this bit is ignored when MODE\[1:0\]
is at 0x1 (key derivation).*/
pub type DMAINEN_R = crate::BitReader;
/**Field `DMAINEN` writer - DMA input enable This bit enables automatic generation of DMA requests during the data phase, for incoming data transfers to AES via DMA. Setting this bit is ignored when MODE\[1:0\]
is at 0x1 (key derivation).*/
pub type DMAINEN_W<'a, REG> = crate::BitWriter<'a, REG>;
/**Field `DMAOUTEN` reader - DMA output enable This bit enables automatic generation of DMA requests during the data phase, for outgoing data transfers from AES via DMA. Setting this bit is ignored when MODE\[1:0\]
is at 0x1 (key derivation).*/
pub type DMAOUTEN_R = crate::BitReader;
/**Field `DMAOUTEN` writer - DMA output enable This bit enables automatic generation of DMA requests during the data phase, for outgoing data transfers from AES via DMA. Setting this bit is ignored when MODE\[1:0\]
is at 0x1 (key derivation).*/
...
impl R {
    /**Bit 0 - Enable This bit enables/disables the AES peripheral. At any moment, clearing then setting the bit re-initializes the AES peripheral. This bit is automatically cleared by hardware upon the completion of the key preparation (MODE\[1:0\]
    at 0x1) and upon the completion of GCM/GMAC/CCM initialization phase. The bit cannot be set as long as KEYVALID1is cleared*/
    #[inline(always)]
    pub fn en(&self) -> EN_R {
    ...
    /**Bit 11 - DMA input enable This bit enables automatic generation of DMA requests during the data phase, for incoming data transfers to AES via DMA. Setting this bit is ignored when MODE\[1:0\]
    is at 0x1 (key derivation).*/
    #[inline(always)]
    pub fn dmainen(&self) -> DMAINEN_R {
        DMAINEN_R::new(((self.bits >> 11) & 1) != 0)
    }
    /**Bit 12 - DMA output enable This bit enables automatic generation of DMA requests during the data phase, for outgoing data transfers from AES via DMA. Setting this bit is ignored when MODE\[1:0\]
    is at 0x1 (key derivation).*/
    #[inline(always)]
...
impl W {
    ...
    ///Bits 5:6 - CHMOD\[1:0\]: Chaining mode This bitfield selects the AES chaining mode: others: Reserved Attempts to write the bitfield are ignored when EN is set before the write access and it is not cleared by that write access.
    #[inline(always)]
    pub fn chmod(&mut self) -> CHMOD_W<AES_CRrs> {
        CHMOD_W::new(self, 5)
    }
    /**Bit 11 - DMA input enable This bit enables automatic generation of DMA requests during the data phase, for incoming data transfers to AES via DMA. Setting this bit is ignored when MODE\[1:0\]
    is at 0x1 (key derivation).*/
    ...
    ///Bit 16 - CHMOD\[2\]
    #[inline(always)]
    pub fn chmod_1(&mut self) -> CHMOD_1_W<AES_CRrs> {
    ...
    ///Bit 31 - AES peripheral software reset Setting the bit resets the AES peripheral, putting all registers to their default values, except the IPRST bit itself. Hence, any key-relative data are lost. For this reason, it is recommended to set the bit before handing over the AES to a less secure application. The bit must be kept low while writing any configuration registers.
    #[inline(always)]
    pub fn iprst(&mut self) -> IPRST_W<AES_CRrs> {
        IPRST_W::new(self, 31)
    }
}
