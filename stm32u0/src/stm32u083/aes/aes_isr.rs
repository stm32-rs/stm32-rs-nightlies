///Register `AES_ISR` reader
pub type R = crate::R<AES_ISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`aes_isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#AES:AES_ISR)*/
pub struct AES_ISRrs;
impl crate::RegisterSpec for AES_ISRrs {
    type Ux = u32;
}
///`read()` method returns [`aes_isr::R`](R) reader structure
impl crate::Readable for AES_ISRrs {}
///`reset()` method sets AES_ISR to value 0
impl crate::Resettable for AES_ISRrs {
