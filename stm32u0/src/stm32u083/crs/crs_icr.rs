///Register `CRS_ICR` reader
pub type R = crate::R<CRS_ICRrs>;
///Register `CRS_ICR` writer
pub type W = crate::W<CRS_ICRrs>;
...
impl W {
    ///Bit 0 - SYNC event OK clear flag Writing 1 to this bit clears the SYNCOKF flag in the CRS_ISR register.
    #[inline(always)]
    pub fn syncokc(&mut self) -> SYNCOKC_W<CRS_ICRrs> {
        SYNCOKC_W::new(self, 0)
    }
    ///Bit 1 - SYNC warning clear flag Writing 1 to this bit clears the SYNCWARNF flag in the CRS_ISR register.
    #[inline(always)]
    pub fn syncwarnc(&mut self) -> SYNCWARNC_W<CRS_ICRrs> {
        SYNCWARNC_W::new(self, 1)
    }
    ///Bit 2 - Error clear flag Writing 1 to this bit clears TRIMOVF, SYNCMISS and SYNCERR bits and consequently also the ERRF flag in the CRS_ISR register.
    #[inline(always)]
    pub fn errc(&mut self) -> ERRC_W<CRS_ICRrs> {
        ERRC_W::new(self, 2)
    }
    ///Bit 3 - Expected SYNC clear flag Writing 1 to this bit clears the ESYNCF flag in the CRS_ISR register.
    #[inline(always)]
    pub fn esyncc(&mut self) -> ESYNCC_W<CRS_ICRrs> {
        ESYNCC_W::new(self, 3)
    }
}
/**CRS interrupt flag clear register

You can [`read`](crate::Reg::read) this register and get [`crs_icr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`crs_icr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#CRS:CRS_ICR)*/
pub struct CRS_ICRrs;
impl crate::RegisterSpec for CRS_ICRrs {
    type Ux = u32;
}
///`read()` method returns [`crs_icr::R`](R) reader structure
impl crate::Readable for CRS_ICRrs {}
///`write(|w| ..)` method takes [`crs_icr::W`](W) writer structure
impl crate::Writable for CRS_ICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CRS_ICR to value 0
impl crate::Resettable for CRS_ICRrs {
