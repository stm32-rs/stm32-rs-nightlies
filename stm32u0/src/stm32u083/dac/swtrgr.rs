...
///Field `SWTRIG(1-1)` writer - DAC channel%s software trigger
...
impl W {
    ///DAC channel(1-1) software trigger
    ///
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#DAC:SWTRGR)*/
pub struct SWTRGRrs;
