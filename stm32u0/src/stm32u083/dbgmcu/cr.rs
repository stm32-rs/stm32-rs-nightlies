...
///Field `DBG_STOP` reader - Debug Stop mode Debug options in Stop mode.
pub type DBG_STOP_R = crate::BitReader;
///Field `DBG_STOP` writer - Debug Stop mode Debug options in Stop mode.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#DBGMCU:CR)*/
pub struct CRrs;
