///Register `DBGMCU_APB1FZR` reader
pub type R = crate::R<DBGMCU_APB1FZRrs>;
///Register `DBGMCU_APB1FZR` writer
pub type W = crate::W<DBGMCU_APB1FZRrs>;
...
impl W {
    ///Bit 0 - TIM2 stop in debug
    #[inline(always)]
    pub fn dbg_tim2_stop(&mut self) -> DBG_TIM2_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_TIM2_STOP_W::new(self, 0)
    }
    ///Bit 1 - TIM3 stop in debug
    #[inline(always)]
    pub fn dbg_tim3_stop(&mut self) -> DBG_TIM3_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_TIM3_STOP_W::new(self, 1)
    }
    ///Bit 2 - TIM4 stop in debug
    #[inline(always)]
    pub fn dbg_tim4_stop(&mut self) -> DBG_TIM4_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_TIM4_STOP_W::new(self, 2)
    }
    ///Bit 4 - TIM6 stop in debug
    #[inline(always)]
    pub fn dbg_tim6_stop(&mut self) -> DBG_TIM6_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_TIM6_STOP_W::new(self, 4)
    }
    ///Bit 5 - TIM7 stop in debug
    #[inline(always)]
    pub fn dbg_tim7_stop(&mut self) -> DBG_TIM7_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_TIM7_STOP_W::new(self, 5)
    }
    ///Bit 10 - RTC stop in debug
    #[inline(always)]
    pub fn dbg_rtc_stop(&mut self) -> DBG_RTC_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_RTC_STOP_W::new(self, 10)
    }
    ///Bit 11 - WWDG stop in debug
    #[inline(always)]
    pub fn dbg_wwdg_stop(&mut self) -> DBG_WWDG_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_WWDG_STOP_W::new(self, 11)
    }
    ///Bit 12 - IWDG stop in debug
    #[inline(always)]
    pub fn dbg_iwdg_stop(&mut self) -> DBG_IWDG_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_IWDG_STOP_W::new(self, 12)
    }
    ///Bit 21 - I2C3 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c3_stop(&mut self) -> DBG_I2C3_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_I2C3_STOP_W::new(self, 21)
    }
    ///Bit 22 - I2C1 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c1_stop(&mut self) -> DBG_I2C1_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_I2C1_STOP_W::new(self, 22)
    }
    ///Bit 30 - LPTIM2 stop in debug
    #[inline(always)]
    pub fn dbg_lptim2_stop(&mut self) -> DBG_LPTIM2_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_LPTIM2_STOP_W::new(self, 30)
    }
    ///Bit 31 - LPTIM1 stop in debug
    #[inline(always)]
    pub fn dbg_lptim1_stop(&mut self) -> DBG_LPTIM1_STOP_W<DBGMCU_APB1FZRrs> {
        DBG_LPTIM1_STOP_W::new(self, 31)
    }
}
/**DBGMCU APB1 freeze register

You can [`read`](crate::Reg::read) this register and get [`dbgmcu_apb1fzr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dbgmcu_apb1fzr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#DBGMCU:DBGMCU_APB1FZR)*/
pub struct DBGMCU_APB1FZRrs;
impl crate::RegisterSpec for DBGMCU_APB1FZRrs {
    type Ux = u32;
}
///`read()` method returns [`dbgmcu_apb1fzr::R`](R) reader structure
impl crate::Readable for DBGMCU_APB1FZRrs {}
///`write(|w| ..)` method takes [`dbgmcu_apb1fzr::W`](W) writer structure
impl crate::Writable for DBGMCU_APB1FZRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DBGMCU_APB1FZR to value 0
impl crate::Resettable for DBGMCU_APB1FZRrs {
