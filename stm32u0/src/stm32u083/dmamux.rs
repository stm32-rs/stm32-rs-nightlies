...
impl RegisterBlock {
    ///0x00..0x30 - DMA Multiplexer Channel %s Control register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#DMAMUX:CCR[0])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#DMAMUX:RGCR[0])
