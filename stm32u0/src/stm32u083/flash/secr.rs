...
impl W {
    ///Bits 0:6 - Last page of the first hide protection area
    #[inline(always)]
    pub fn hdp1_pend(&mut self) -> HDP1_PEND_W<SECRrs> {
    ...
    ///Bits 24:31 - Hide protection area enable
    #[inline(always)]
    pub fn hdp1en(&mut self) -> HDP1EN_W<SECRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#FLASH:SECR)*/
pub struct SECRrs;
