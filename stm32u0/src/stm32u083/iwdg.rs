...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn iwdg_ewcr(&self) -> &IWDG_EWCR {
        &self.iwdg_ewcr
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#IWDG:IWDG_RLR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#IWDG:IWDG_SR)
...
pub mod iwdg_winr;
/**IWDG_EWCR (rw) register accessor: IWDG early wake-up interrupt register

You can [`read`](crate::Reg::read) this register and get [`iwdg_ewcr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`iwdg_ewcr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#IWDG:IWDG_EWCR)

For information about available fields see [`mod@iwdg_ewcr`]
module*/
pub type IWDG_EWCR = crate::Reg<iwdg_ewcr::IWDG_EWCRrs>;
