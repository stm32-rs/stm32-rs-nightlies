///Register `LCD_RAM11` reader
pub type R = crate::R<LCD_RAM11rs>;
///Register `LCD_RAM11` writer
pub type W = crate::W<LCD_RAM11rs>;
...
impl W {
    ///Bits 0:15 - Each bit corresponds to one pixel of the LCD display.
    #[inline(always)]
    pub fn segment_data(&mut self) -> SEGMENT_DATA_W<LCD_RAM11rs> {
...
pub struct LCD_RAM11rs;
impl crate::RegisterSpec for LCD_RAM11rs {
    type Ux = u32;
}
///`read()` method returns [`lcd_ram11::R`](R) reader structure
impl crate::Readable for LCD_RAM11rs {}
///`write(|w| ..)` method takes [`lcd_ram11::W`](W) writer structure
impl crate::Writable for LCD_RAM11rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LCD_RAM11 to value 0
impl crate::Resettable for LCD_RAM11rs {
