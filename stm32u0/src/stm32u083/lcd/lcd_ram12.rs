///Register `LCD_RAM12` reader
pub type R = crate::R<LCD_RAM12rs>;
///Register `LCD_RAM12` writer
pub type W = crate::W<LCD_RAM12rs>;
...
impl W {
    ///Bits 0:31 - Each bit corresponds to one pixel of the LCD display.
    #[inline(always)]
    pub fn segment_data(&mut self) -> SEGMENT_DATA_W<LCD_RAM12rs> {
...
pub struct LCD_RAM12rs;
impl crate::RegisterSpec for LCD_RAM12rs {
    type Ux = u32;
}
///`read()` method returns [`lcd_ram12::R`](R) reader structure
impl crate::Readable for LCD_RAM12rs {}
///`write(|w| ..)` method takes [`lcd_ram12::W`](W) writer structure
impl crate::Writable for LCD_RAM12rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LCD_RAM12 to value 0
impl crate::Resettable for LCD_RAM12rs {
