///Register `LCD_RAM7` reader
pub type R = crate::R<LCD_RAM7rs>;
///Register `LCD_RAM7` writer
pub type W = crate::W<LCD_RAM7rs>;
...
impl W {
    ///Bits 0:19 - Each bit corresponds to one pixel of the LCD display.
    #[inline(always)]
    pub fn segment_data(&mut self) -> SEGMENT_DATA_W<LCD_RAM7rs> {
...
pub struct LCD_RAM7rs;
impl crate::RegisterSpec for LCD_RAM7rs {
    type Ux = u32;
}
///`read()` method returns [`lcd_ram7::R`](R) reader structure
impl crate::Readable for LCD_RAM7rs {}
///`write(|w| ..)` method takes [`lcd_ram7::W`](W) writer structure
impl crate::Writable for LCD_RAM7rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LCD_RAM7 to value 0
impl crate::Resettable for LCD_RAM7rs {
