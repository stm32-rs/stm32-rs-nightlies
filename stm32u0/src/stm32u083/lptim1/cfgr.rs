...
///Field `PRELOAD` reader - Registers update mode The PRELOAD bit controls the LPTIM1_ARR, LPTIM1_RCR and the LPTIM1_CCRx registers update modality
pub type PRELOAD_R = crate::BitReader;
///Field `PRELOAD` writer - Registers update mode The PRELOAD bit controls the LPTIM1_ARR, LPTIM1_RCR and the LPTIM1_CCRx registers update modality
...
impl R {
    ...
    ///Bit 22 - Registers update mode The PRELOAD bit controls the LPTIM1_ARR, LPTIM1_RCR and the LPTIM1_CCRx registers update modality
    #[inline(always)]
