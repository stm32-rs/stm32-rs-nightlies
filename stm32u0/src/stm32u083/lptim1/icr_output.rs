...
impl W {
    ...
    #[inline(always)]
    pub fn cc3cf(&mut self) -> CC3CF_W<ICR_OUTPUTrs> {
        CC3CF_W::new(self, 10)
    }
    ...
    #[inline(always)]
    pub fn cc4cf(&mut self) -> CC4CF_W<ICR_OUTPUTrs> {
        CC4CF_W::new(self, 11)
    }
    ...
    #[inline(always)]
    pub fn cmp3okcf(&mut self) -> CMP3OKCF_W<ICR_OUTPUTrs> {
    ...
    #[inline(always)]
    pub fn cmp4okcf(&mut self) -> CMP4OKCF_W<ICR_OUTPUTrs> {
