///Register `LPTIM1_DIER_INPUT` reader
pub type R = crate::R<LPTIM1_DIER_INPUTrs>;
///Register `LPTIM1_DIER_INPUT` writer
pub type W = crate::W<LPTIM1_DIER_INPUTrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LPTIM1_DIER_INPUT")
...
impl W {
    ///Bit 0 - Capture/compare 1 interrupt enable
    #[inline(always)]
    pub fn cc1ie(&mut self) -> CC1IE_W<LPTIM1_DIER_INPUTrs> {
        CC1IE_W::new(self, 0)
    }
    ///Bit 1 - Autoreload match Interrupt Enable
    #[inline(always)]
    pub fn arrmie(&mut self) -> ARRMIE_W<LPTIM1_DIER_INPUTrs> {
        ARRMIE_W::new(self, 1)
    }
    ///Bit 2 - External trigger valid edge Interrupt Enable
    #[inline(always)]
    pub fn exttrigie(&mut self) -> EXTTRIGIE_W<LPTIM1_DIER_INPUTrs> {
        EXTTRIGIE_W::new(self, 2)
    }
    ///Bit 4 - Autoreload register update OK Interrupt Enable
    #[inline(always)]
    pub fn arrokie(&mut self) -> ARROKIE_W<LPTIM1_DIER_INPUTrs> {
        ARROKIE_W::new(self, 4)
    }
    ///Bit 5 - Direction change to UP Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn upie(&mut self) -> UPIE_W<LPTIM1_DIER_INPUTrs> {
        UPIE_W::new(self, 5)
    }
    ///Bit 6 - Direction change to down Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn downie(&mut self) -> DOWNIE_W<LPTIM1_DIER_INPUTrs> {
        DOWNIE_W::new(self, 6)
    }
    ///Bit 7 - Update event interrupt enable
    #[inline(always)]
    pub fn ueie(&mut self) -> UEIE_W<LPTIM1_DIER_INPUTrs> {
        UEIE_W::new(self, 7)
    }
    ///Bit 8 - Repetition register update OK interrupt Enable
    #[inline(always)]
    pub fn repokie(&mut self) -> REPOKIE_W<LPTIM1_DIER_INPUTrs> {
        REPOKIE_W::new(self, 8)
    }
    ///Bit 9 - Capture/compare 2 interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc2ie(&mut self) -> CC2IE_W<LPTIM1_DIER_INPUTrs> {
        CC2IE_W::new(self, 9)
    }
    ///Bit 10 - Capture/compare 3 interrupt enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc3ie(&mut self) -> CC3IE_W<LPTIM1_DIER_INPUTrs> {
        CC3IE_W::new(self, 10)
    }
    ///Bit 11 - Capture/compare 4 interrupt enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc4ie(&mut self) -> CC4IE_W<LPTIM1_DIER_INPUTrs> {
        CC4IE_W::new(self, 11)
    }
    ///Bit 12 - Capture/compare 1 over-capture interrupt enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc1oie(&mut self) -> CC1OIE_W<LPTIM1_DIER_INPUTrs> {
        CC1OIE_W::new(self, 12)
    }
    ///Bit 13 - Capture/compare 2 over-capture interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc2oie(&mut self) -> CC2OIE_W<LPTIM1_DIER_INPUTrs> {
        CC2OIE_W::new(self, 13)
    }
    ///Bit 14 - Capture/compare 3 over-capture interrupt enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc3oie(&mut self) -> CC3OIE_W<LPTIM1_DIER_INPUTrs> {
        CC3OIE_W::new(self, 14)
    }
    ///Bit 15 - Capture/compare 4 over-capture interrupt enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc4oie(&mut self) -> CC4OIE_W<LPTIM1_DIER_INPUTrs> {
        CC4OIE_W::new(self, 15)
    }
    ///Bit 16 - Capture/compare 1 DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc1de(&mut self) -> CC1DE_W<LPTIM1_DIER_INPUTrs> {
        CC1DE_W::new(self, 16)
    }
    ///Bit 23 - Update event DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn uede(&mut self) -> UEDE_W<LPTIM1_DIER_INPUTrs> {
        UEDE_W::new(self, 23)
    }
    ///Bit 25 - Capture/compare 2 DMA request enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc2de(&mut self) -> CC2DE_W<LPTIM1_DIER_INPUTrs> {
        CC2DE_W::new(self, 25)
    }
    ///Bit 26 - Capture/compare 3 DMA request enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc3de(&mut self) -> CC3DE_W<LPTIM1_DIER_INPUTrs> {
        CC3DE_W::new(self, 26)
    }
    ///Bit 27 - Capture/compare 4 DMA request enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3.
    #[inline(always)]
    pub fn cc4de(&mut self) -> CC4DE_W<LPTIM1_DIER_INPUTrs> {
        CC4DE_W::new(self, 27)
    }
}
/**LPTIM1 interrupt enable register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`lptim1_dier_input::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lptim1_dier_input::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#LPTIM1:LPTIM1_DIER_INPUT)*/
pub struct LPTIM1_DIER_INPUTrs;
impl crate::RegisterSpec for LPTIM1_DIER_INPUTrs {
    type Ux = u32;
}
///`read()` method returns [`lptim1_dier_input::R`](R) reader structure
impl crate::Readable for LPTIM1_DIER_INPUTrs {}
///`write(|w| ..)` method takes [`lptim1_dier_input::W`](W) writer structure
impl crate::Writable for LPTIM1_DIER_INPUTrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPTIM1_DIER_INPUT to value 0
impl crate::Resettable for LPTIM1_DIER_INPUTrs {
