...
impl W {
    ...
    #[inline(always)]
    pub fn cc3cf(&mut self) -> CC3CF_W<ICR_INPUTrs> {
        CC3CF_W::new(self, 10)
    }
    ...
    #[inline(always)]
    pub fn cc4cf(&mut self) -> CC4CF_W<ICR_INPUTrs> {
        CC4CF_W::new(self, 11)
    }
    ...
    #[inline(always)]
    pub fn cc3ocf(&mut self) -> CC3OCF_W<ICR_INPUTrs> {
    ...
    #[inline(always)]
    pub fn cc4ocf(&mut self) -> CC4OCF_W<ICR_INPUTrs> {
