///Register `LPTIM3_CCR1` reader
pub type R = crate::R<LPTIM3_CCR1rs>;
///Register `LPTIM3_CCR1` writer
pub type W = crate::W<LPTIM3_CCR1rs>;
...
impl W {
    ///Bits 0:15 - Capture/compare 1 value If channel CC1 is configured as output: CCR1 is the value to be loaded in the capture/compare 1 register. Depending on the PRELOAD option, the CCR1 register is immediately updated if the PRELOAD bit is reset and updated at next LPTIM update event if PREOAD bit is reset. The capture/compare register 1 contains the value to be compared to the counter LPTIM3_CNT and signaled on OC1 output. If channel CC1 is configured as input: CCR1 becomes read-only, it contains the counter value transferred by the last input capture 1 event. The LPTIM3_CCR1 register is read-only and cannot be programmed.
    #[inline(always)]
    pub fn ccr1(&mut self) -> CCR1_W<LPTIM3_CCR1rs> {
        CCR1_W::new(self, 0)
    }
}
/**LPTIM compare register 1

You can [`read`](crate::Reg::read) this register and get [`lptim3_ccr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lptim3_ccr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#LPTIM3:LPTIM3_CCR1)*/
pub struct LPTIM3_CCR1rs;
impl crate::RegisterSpec for LPTIM3_CCR1rs {
    type Ux = u32;
}
///`read()` method returns [`lptim3_ccr1::R`](R) reader structure
impl crate::Readable for LPTIM3_CCR1rs {}
///`write(|w| ..)` method takes [`lptim3_ccr1::W`](W) writer structure
impl crate::Writable for LPTIM3_CCR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPTIM3_CCR1 to value 0
impl crate::Resettable for LPTIM3_CCR1rs {
