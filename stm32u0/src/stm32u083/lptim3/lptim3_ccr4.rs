///Register `LPTIM3_CCR4` reader
pub type R = crate::R<LPTIM3_CCR4rs>;
///Register `LPTIM3_CCR4` writer
pub type W = crate::W<LPTIM3_CCR4rs>;
...
impl W {
    ///Bits 0:15 - Capture/compare 4 value If channel CC4 is configured as output: CCR4 is the value to be loaded in the capture/compare 4 register. Depending on the PRELOAD option, the CCR4 register is immediately updated if the PRELOAD bit is reset and updated at next LPTIM update event if PREOAD bit is reset. The capture/compare register 4 contains the value to be compared to the counter LPTIM3_CNT and signaled on OC4 output. If channel CC4 is configured as input: CCR4 becomes read-only, it contains the counter value transferred by the last input capture 4 event. The LPTIM3_CCR4 register is read-only and cannot be programmed.
    #[inline(always)]
    pub fn ccr4(&mut self) -> CCR4_W<LPTIM3_CCR4rs> {
        CCR4_W::new(self, 0)
    }
}
/**LPTIM compare register 4

You can [`read`](crate::Reg::read) this register and get [`lptim3_ccr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lptim3_ccr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#LPTIM3:LPTIM3_CCR4)*/
pub struct LPTIM3_CCR4rs;
impl crate::RegisterSpec for LPTIM3_CCR4rs {
    type Ux = u32;
}
///`read()` method returns [`lptim3_ccr4::R`](R) reader structure
impl crate::Readable for LPTIM3_CCR4rs {}
///`write(|w| ..)` method takes [`lptim3_ccr4::W`](W) writer structure
impl crate::Writable for LPTIM3_CCR4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPTIM3_CCR4 to value 0
impl crate::Resettable for LPTIM3_CCR4rs {
