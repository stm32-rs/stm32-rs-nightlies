///Register `LPTIM3_ICR_INPUT` writer
pub type W = crate::W<LPTIM3_ICR_INPUTrs>;
...
impl core::fmt::Debug for crate::generic::Reg<LPTIM3_ICR_INPUTrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn arrokcf(&mut self) -> ARROKCF_W<LPTIM3_ICR_INPUTrs> {
    ...
    #[inline(always)]
    pub fn upcf(&mut self) -> UPCF_W<LPTIM3_ICR_INPUTrs> {
        UPCF_W::new(self, 5)
    }
    ...
    #[inline(always)]
    pub fn cc2cf(&mut self) -> CC2CF_W<LPTIM3_ICR_INPUTrs> {
        CC2CF_W::new(self, 9)
    }
    ...
    #[inline(always)]
    pub fn cc3cf(&mut self) -> CC3CF_W<LPTIM3_ICR_INPUTrs> {
        CC3CF_W::new(self, 10)
    }
    ...
    #[inline(always)]
    pub fn cc4cf(&mut self) -> CC4CF_W<LPTIM3_ICR_INPUTrs> {
        CC4CF_W::new(self, 11)
    }
    ...
    #[inline(always)]
    pub fn cc1ocf(&mut self) -> CC1OCF_W<LPTIM3_ICR_INPUTrs> {
    ...
    #[inline(always)]
    pub fn cc2ocf(&mut self) -> CC2OCF_W<LPTIM3_ICR_INPUTrs> {
    ...
    #[inline(always)]
    pub fn cc3ocf(&mut self) -> CC3OCF_W<LPTIM3_ICR_INPUTrs> {
    ...
    #[inline(always)]
    pub fn cc4ocf(&mut self) -> CC4OCF_W<LPTIM3_ICR_INPUTrs> {
    ...
    #[inline(always)]
    pub fn dierokcf(&mut self) -> DIEROKCF_W<LPTIM3_ICR_INPUTrs> {
        DIEROKCF_W::new(self, 24)
    }
}
/**LPTIM3 interrupt clear register \[alternate\]

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lptim3_icr_input::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#LPTIM3:LPTIM3_ICR_INPUT)*/
pub struct LPTIM3_ICR_INPUTrs;
impl crate::RegisterSpec for LPTIM3_ICR_INPUTrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`lptim3_icr_input::W`](W) writer structure
impl crate::Writable for LPTIM3_ICR_INPUTrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPTIM3_ICR_INPUT to value 0
impl crate::Resettable for LPTIM3_ICR_INPUTrs {
