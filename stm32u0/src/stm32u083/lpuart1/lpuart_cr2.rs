///Register `LPUART_CR2` reader
pub type R = crate::R<LPUART_CR2rs>;
///Register `LPUART_CR2` writer
pub type W = crate::W<LPUART_CR2rs>;
...
impl R {
    /**Bit 4 - 7-bit Address Detection/4-bit Address Detection This bit is for selection between 4-bit address detection or 7-bit address detection. This bit can only be written when the LPUART is disabled (UE=0) Note: In 7-bit and 9-bit data modes, the address detection is done on 6-bit and 8-bit address (ADD\[5:0\]
    and ADD\[7:0\]) respectively.*/
    #[inline(always)]
...
impl W {
    ...
    and ADD\[7:0\]) respectively.*/
    #[inline(always)]
    pub fn addm7(&mut self) -> ADDM7_W<LPUART_CR2rs> {
        ADDM7_W::new(self, 4)
    }
    ///Bits 12:13 - STOP bits These bits are used for programming the stop bits. This bitfield can only be written when the LPUART is disabled (UE=0).
    #[inline(always)]
    pub fn stop(&mut self) -> STOP_W<LPUART_CR2rs> {
        STOP_W::new(self, 12)
    }
    ///Bit 15 - Swap TX/RX pins This bit is set and cleared by software. This bitfield can only be written when the LPUART is disabled (UE=0).
    #[inline(always)]
    pub fn swap(&mut self) -> SWAP_W<LPUART_CR2rs> {
        SWAP_W::new(self, 15)
    }
    ///Bit 16 - RX pin active level inversion This bit is set and cleared by software. This enables the use of an external inverter on the RX line. This bitfield can only be written when the LPUART is disabled (UE=0).
    #[inline(always)]
    pub fn rxinv(&mut self) -> RXINV_W<LPUART_CR2rs> {
        RXINV_W::new(self, 16)
    }
    ///Bit 17 - TX pin active level inversion This bit is set and cleared by software. This enables the use of an external inverter on the TX line. This bitfield can only be written when the LPUART is disabled (UE=0).
    #[inline(always)]
    pub fn txinv(&mut self) -> TXINV_W<LPUART_CR2rs> {
        TXINV_W::new(self, 17)
    }
    ///Bit 18 - Binary data inversion This bit is set and cleared by software. This bitfield can only be written when the LPUART is disabled (UE=0).
    #[inline(always)]
    pub fn datainv(&mut self) -> DATAINV_W<LPUART_CR2rs> {
        DATAINV_W::new(self, 18)
    }
    ///Bit 19 - Most significant bit first This bit is set and cleared by software. This bitfield can only be written when the LPUART is disabled (UE=0).
    #[inline(always)]
    pub fn msbfirst(&mut self) -> MSBFIRST_W<LPUART_CR2rs> {
    ...
    value and CMF flag is set on match. An interrupt is generated if the CMIE bit is set. These bits can only be written when the reception is disabled (RE1=10) or when the USART is disabled (UE1=10).*/
    #[inline(always)]
    pub fn add(&mut self) -> ADD_W<LPUART_CR2rs> {
        ADD_W::new(self, 24)
    }
}
/**LPUART control register 2

You can [`read`](crate::Reg::read) this register and get [`lpuart_cr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpuart_cr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#LPUART1:LPUART_CR2)*/
pub struct LPUART_CR2rs;
impl crate::RegisterSpec for LPUART_CR2rs {
    type Ux = u32;
}
///`read()` method returns [`lpuart_cr2::R`](R) reader structure
impl crate::Readable for LPUART_CR2rs {}
///`write(|w| ..)` method takes [`lpuart_cr2::W`](W) writer structure
impl crate::Writable for LPUART_CR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPUART_CR2 to value 0
impl crate::Resettable for LPUART_CR2rs {
