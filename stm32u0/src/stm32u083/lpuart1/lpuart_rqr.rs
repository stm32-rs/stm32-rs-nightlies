///Register `LPUART_RQR` writer
pub type W = crate::W<LPUART_RQRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<LPUART_RQRrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn rxfrq(&mut self) -> RXFRQ_W<LPUART_RQRrs> {
        RXFRQ_W::new(self, 3)
    }
    ...
    #[inline(always)]
    pub fn txfrq(&mut self) -> TXFRQ_W<LPUART_RQRrs> {
        TXFRQ_W::new(self, 4)
    }
}
/**LPUART request register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpuart_rqr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#LPUART1:LPUART_RQR)*/
pub struct LPUART_RQRrs;
impl crate::RegisterSpec for LPUART_RQRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`lpuart_rqr::W`](W) writer structure
impl crate::Writable for LPUART_RQRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPUART_RQR to value 0
impl crate::Resettable for LPUART_RQRrs {
