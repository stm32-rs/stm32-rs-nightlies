...
impl W {
    ///Bits 0:8 - Calibration minus The frequency of the calendar is reduced by masking CALM out of 2<sup>20</sup> RTCCLK pulses (321seconds if the input frequency is 327681Hz). This decreases the frequency of the calendar with a resolution of 0.95371ppm. To increase the frequency of the calendar, this feature should be used in conjunction with CALP. See Section128.3.14: RTC smooth digital calibration on page1733.
    #[inline(always)]
    pub fn calm(&mut self) -> CALM_W<RTC_CALRrs> {
        CALM_W::new(self, 0)
    }
    ///Bit 12 - RTC low-power mode
    #[inline(always)]
    pub fn lpcal(&mut self) -> LPCAL_W<RTC_CALRrs> {
        LPCAL_W::new(self, 12)
    }
    /**Bit 13 - Use a 16-second calibration cycle period When CALW16 is set to 1, the 16-second calibration cycle period is selected. This bit must not be set to 1 if CALW8 = 1. Note: CALM\[0\]
    is stuck at 0 when CALW16 = 1. Refer to Section128.3.14: RTC smooth digital calibration.*/
    #[inline(always)]
    pub fn calw16(&mut self) -> CALW16_W<RTC_CALRrs> {
        CALW16_W::new(self, 13)
    }
    /**Bit 14 - Use an 8-second calibration cycle period When CALW8 is set to 1, the 8-second calibration cycle period is selected. Note: CALM\[1:0\]
    are stuck at 00 when CALW8 = 1. Refer to Section128.3.14: RTC smooth digital calibration.*/
    #[inline(always)]
    pub fn calw8(&mut self) -> CALW8_W<RTC_CALRrs> {
        CALW8_W::new(self, 14)
    }
    ///Bit 15 - Increase frequency of RTC by 488.51ppm.
    #[inline(always)]
    pub fn calp(&mut self) -> CALP_W<RTC_CALRrs> {
        CALP_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#RTC:RTC_CALR)*/
