...
impl W {
    ///Bits 0:2 - ck_wut wake-up clock selection 10x: ck_spre (usually 11Hz) clock is selected in BCD mode. In binary or mixed mode, this is the clock selected by BCDU. 11x: ck_spre (usually 1 Hz) clock is selected in BCD mode. In binary or mixed mode, this is the clock selected by BCDU. Furthermore, 2<sup>16</sup> is added to the WUT counter value.
    #[inline(always)]
    pub fn wucksel(&mut self) -> WUCKSEL_W<RTC_CRrs> {
        WUCKSEL_W::new(self, 0)
    }
    ///Bit 3 - Timestamp event active edge TSE must be reset when TSEDGE is changed to avoid unwanted TSF setting.
    #[inline(always)]
    pub fn tsedge(&mut self) -> TSEDGE_W<RTC_CRrs> {
        TSEDGE_W::new(self, 3)
    }
    ///Bit 4 - RTC_REFIN reference clock detection enable (50 or 601Hz) Note: BIN must be 0x00 and PREDIV_S must be 0x00FF.
    #[inline(always)]
    pub fn refckon(&mut self) -> REFCKON_W<RTC_CRrs> {
        REFCKON_W::new(self, 4)
    }
    ///Bit 5 - Bypass the shadow registers Note: If the frequency of the APB clock is less than seven times the frequency of RTCCLK, BYPSHAD must be set to 1.
    #[inline(always)]
    pub fn bypshad(&mut self) -> BYPSHAD_W<RTC_CRrs> {
        BYPSHAD_W::new(self, 5)
    }
    ///Bit 6 - Hour format
    #[inline(always)]
    pub fn fmt(&mut self) -> FMT_W<RTC_CRrs> {
        FMT_W::new(self, 6)
    }
    ///Bit 7 - SSR underflow interrupt enable
    #[inline(always)]
    pub fn ssruie(&mut self) -> SSRUIE_W<RTC_CRrs> {
        SSRUIE_W::new(self, 7)
    }
    ///Bit 8 - Alarm A enable
    #[inline(always)]
    pub fn alrae(&mut self) -> ALRAE_W<RTC_CRrs> {
        ALRAE_W::new(self, 8)
    }
    ///Bit 9 - Alarm B enable
    #[inline(always)]
    pub fn alrbe(&mut self) -> ALRBE_W<RTC_CRrs> {
        ALRBE_W::new(self, 9)
    }
    ///Bit 10 - Wake-up timer enable Note: When the wake-up timer is disabled, wait for WUTWF = 1 before enabling it again.
    #[inline(always)]
    pub fn wute(&mut self) -> WUTE_W<RTC_CRrs> {
        WUTE_W::new(self, 10)
    }
    ///Bit 11 - timestamp enable
    #[inline(always)]
    pub fn tse(&mut self) -> TSE_W<RTC_CRrs> {
        TSE_W::new(self, 11)
    }
    ///Bit 12 - Alarm A interrupt enable
    #[inline(always)]
    pub fn alraie(&mut self) -> ALRAIE_W<RTC_CRrs> {
        ALRAIE_W::new(self, 12)
    }
    ///Bit 13 - Alarm B interrupt enable
    #[inline(always)]
    pub fn alrbie(&mut self) -> ALRBIE_W<RTC_CRrs> {
        ALRBIE_W::new(self, 13)
    }
    ///Bit 14 - Wake-up timer interrupt enable
    #[inline(always)]
    pub fn wutie(&mut self) -> WUTIE_W<RTC_CRrs> {
        WUTIE_W::new(self, 14)
    }
    ///Bit 15 - Timestamp interrupt enable
    #[inline(always)]
    pub fn tsie(&mut self) -> TSIE_W<RTC_CRrs> {
        TSIE_W::new(self, 15)
    }
    ...
    #[inline(always)]
    pub fn add1h(&mut self) -> ADD1H_W<RTC_CRrs> {
        ADD1H_W::new(self, 16)
    }
    ...
    #[inline(always)]
    pub fn sub1h(&mut self) -> SUB1H_W<RTC_CRrs> {
        SUB1H_W::new(self, 17)
    }
    ///Bit 18 - Backup This bit can be written by the user to memorize whether the daylight saving time change has been performed or not.
    #[inline(always)]
    pub fn bkp(&mut self) -> BKP_W<RTC_CRrs> {
        BKP_W::new(self, 18)
    }
    ///Bit 19 - Calibration output selection When COE = 1, this bit selects which signal is output on CALIB. These frequencies are valid for RTCCLK at 32.7681kHz and prescalers at their default values (PREDIV_A = 127 and PREDIV_S = 255). Refer to Section128.3.16: Calibration clock output.
    #[inline(always)]
    pub fn cosel(&mut self) -> COSEL_W<RTC_CRrs> {
        COSEL_W::new(self, 19)
    }
    ///Bit 20 - Output polarity This bit is used to configure the polarity of TAMPALRM output.
    #[inline(always)]
    pub fn pol(&mut self) -> POL_W<RTC_CRrs> {
        POL_W::new(self, 20)
    }
    ///Bits 21:22 - Output selection These bits are used to select the flag to be routed to TAMPALRM output.
    #[inline(always)]
    pub fn osel(&mut self) -> OSEL_W<RTC_CRrs> {
        OSEL_W::new(self, 21)
    }
    ///Bit 23 - Calibration output enable This bit enables the CALIB output
    #[inline(always)]
    pub fn coe(&mut self) -> COE_W<RTC_CRrs> {
        COE_W::new(self, 23)
    }
    ///Bit 24 - timestamp on internal event enable
    #[inline(always)]
    pub fn itse(&mut self) -> ITSE_W<RTC_CRrs> {
        ITSE_W::new(self, 24)
    }
    ///Bit 25 - Activate timestamp on tamper detection event TAMPTS is valid even if TSE = 0 in the RTC_CR register. Timestamp flag is set up to 3 ck_apre cycles after the tamper flags. Note: TAMPTS must be cleared before entering RTC initialization mode.
    #[inline(always)]
    pub fn tampts(&mut self) -> TAMPTS_W<RTC_CRrs> {
        TAMPTS_W::new(self, 25)
    }
    ///Bit 26 - Tamper detection output enable on TAMPALRM
    #[inline(always)]
    pub fn tampoe(&mut self) -> TAMPOE_W<RTC_CRrs> {
        TAMPOE_W::new(self, 26)
    }
    ///Bit 27 - Alarm A flag automatic clear
    #[inline(always)]
    pub fn alrafclr(&mut self) -> ALRAFCLR_W<RTC_CRrs> {
        ALRAFCLR_W::new(self, 27)
    }
    ///Bit 28 - Alarm B flag automatic clear
    #[inline(always)]
    pub fn alrbfclr(&mut self) -> ALRBFCLR_W<RTC_CRrs> {
        ALRBFCLR_W::new(self, 28)
    }
    ///Bit 29 - TAMPALRM pull-up enable
    #[inline(always)]
    pub fn tampalrm_pu(&mut self) -> TAMPALRM_PU_W<RTC_CRrs> {
        TAMPALRM_PU_W::new(self, 29)
    }
    ///Bit 30 - TAMPALRM output type
    #[inline(always)]
    pub fn tampalrm_type(&mut self) -> TAMPALRM_TYPE_W<RTC_CRrs> {
        TAMPALRM_TYPE_W::new(self, 30)
    }
    ///Bit 31 - RTC_OUT2 output enable
    #[inline(always)]
    pub fn out2en(&mut self) -> OUT2EN_W<RTC_CRrs> {
