...
///Field `SPI3` reader - SPI3 interrupt request pending
...
impl R {
    ...
    ///Bit 1 - SPI3 interrupt request pending
    #[inline(always)]
    pub fn spi3(&self) -> SPI3_R {
        SPI3_R::new(((self.bits >> 1) & 1) != 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#SYSCFG:ITLINE26)*/
