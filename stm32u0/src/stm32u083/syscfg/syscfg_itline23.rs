...
///Field `I2C1` reader - I2C1 interrupt request pending (EXTI line 33)
pub type I2C1_R = crate::BitReader;
impl R {
    ///Bit 0 - I2C1 interrupt request pending (EXTI line 33)
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#SYSCFG:SYSCFG_ITLINE23)*/
