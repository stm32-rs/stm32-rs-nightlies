...
///Field `DMA1_CH1` reader - DMA1 channel 1 interrupt request pending
pub type DMA1_CH1_R = crate::BitReader;
impl R {
    ///Bit 0 - DMA1 channel 1 interrupt request pending
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#SYSCFG:SYSCFG_ITLINE9)*/
