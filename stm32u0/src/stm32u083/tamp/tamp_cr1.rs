///Register `TAMP_CR1` reader
pub type R = crate::R<TAMP_CR1rs>;
///Register `TAMP_CR1` writer
...
impl W {
    ...
    ///Bit 19 - Internal tamper 4 enable
    #[inline(always)]
    pub fn itamp4e(&mut self) -> ITAMP4E_W<TAMP_CR1rs> {
...
///`read()` method returns [`tamp_cr1::R`](R) reader structure
impl crate::Readable for TAMP_CR1rs {}
///`write(|w| ..)` method takes [`tamp_cr1::W`](W) writer structure
impl crate::Writable for TAMP_CR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TAMP_CR1 to value 0
