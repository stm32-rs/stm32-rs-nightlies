...
///Field `OCREF_CLR` reader - Ocref_clr source selection This bit selects the ocref_clr input source. Others: Reserved Note: COMP3 is available on STM32G0B1xx and STM32G0C1xx salestypes only.
pub type OCREF_CLR_R = crate::FieldReader;
///Field `OCREF_CLR` writer - Ocref_clr source selection This bit selects the ocref_clr input source. Others: Reserved Note: COMP3 is available on STM32G0B1xx and STM32G0C1xx salestypes only.
pub type OCREF_CLR_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - Ocref_clr source selection This bit selects the ocref_clr input source. Others: Reserved Note: COMP3 is available on STM32G0B1xx and STM32G0C1xx salestypes only.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#TIM1:OR1)*/
pub struct OR1rs;
