///Register `TIM1_CCMR1_INPUT` reader
pub type R = crate::R<TIM1_CCMR1_INPUTrs>;
///Register `TIM1_CCMR1_INPUT` writer
pub type W = crate::W<TIM1_CCMR1_INPUTrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM1_CCMR1_INPUT")
...
impl W {
    ///Bits 0:1 - Capture/Compare 1 Selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<TIM1_CCMR1_INPUTrs> {
        CC1S_W::new(self, 0)
    }
    ///Bits 2:3 - Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E=0 (TIMx_CCER register).
    #[inline(always)]
    pub fn ic1psc(&mut self) -> IC1PSC_W<TIM1_CCMR1_INPUTrs> {
        IC1PSC_W::new(self, 2)
    }
    ///Bits 4:7 - Input capture 1 filter This bit-field defines the frequency used to sample TI1 input and the length of the digital filter applied to TI1. The digital filter is made of an event counter in which N consecutive events are needed to validate a transition on the output:
    #[inline(always)]
    pub fn ic1f(&mut self) -> IC1F_W<TIM1_CCMR1_INPUTrs> {
        IC1F_W::new(self, 4)
    }
    ///Bits 8:9 - Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc2s(&mut self) -> CC2S_W<TIM1_CCMR1_INPUTrs> {
        CC2S_W::new(self, 8)
    }
    /**Bits 10:11 - Input capture 2 prescaler Refer to IC1PSC\[1:0\]
    description.*/
    #[inline(always)]
    pub fn ic2psc(&mut self) -> IC2PSC_W<TIM1_CCMR1_INPUTrs> {
        IC2PSC_W::new(self, 10)
    }
    /**Bits 12:15 - Input capture 2 filter Refer to IC1F\[3:0\]
    description.*/
    #[inline(always)]
    pub fn ic2f(&mut self) -> IC2F_W<TIM1_CCMR1_INPUTrs> {
        IC2F_W::new(self, 12)
    }
}
/**TIM1 capture/compare mode register 1

You can [`read`](crate::Reg::read) this register and get [`tim1_ccmr1_input::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim1_ccmr1_input::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#TIM1:TIM1_CCMR1_INPUT)*/
pub struct TIM1_CCMR1_INPUTrs;
impl crate::RegisterSpec for TIM1_CCMR1_INPUTrs {
    type Ux = u32;
}
///`read()` method returns [`tim1_ccmr1_input::R`](R) reader structure
impl crate::Readable for TIM1_CCMR1_INPUTrs {}
///`write(|w| ..)` method takes [`tim1_ccmr1_input::W`](W) writer structure
impl crate::Writable for TIM1_CCMR1_INPUTrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIM1_CCMR1_INPUT to value 0
impl crate::Resettable for TIM1_CCMR1_INPUTrs {
