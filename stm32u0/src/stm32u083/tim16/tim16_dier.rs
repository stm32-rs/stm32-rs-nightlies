///Register `TIM16_DIER` reader
pub type R = crate::R<TIM16_DIERrs>;
///Register `TIM16_DIER` writer
pub type W = crate::W<TIM16_DIERrs>;
...
impl W {
    ///Bit 0 - Update interrupt enable
    #[inline(always)]
    pub fn uie(&mut self) -> UIE_W<TIM16_DIERrs> {
        UIE_W::new(self, 0)
    }
    ///Bit 1 - Capture/Compare 1 interrupt enable
    #[inline(always)]
    pub fn cc1ie(&mut self) -> CC1IE_W<TIM16_DIERrs> {
        CC1IE_W::new(self, 1)
    }
    ///Bit 5 - COM interrupt enable
    #[inline(always)]
    pub fn comie(&mut self) -> COMIE_W<TIM16_DIERrs> {
        COMIE_W::new(self, 5)
    }
    ///Bit 7 - Break interrupt enable
    #[inline(always)]
    pub fn bie(&mut self) -> BIE_W<TIM16_DIERrs> {
        BIE_W::new(self, 7)
    }
    ///Bit 8 - Update DMA request enable
    #[inline(always)]
    pub fn ude(&mut self) -> UDE_W<TIM16_DIERrs> {
        UDE_W::new(self, 8)
    }
    ///Bit 9 - Capture/Compare 1 DMA request enable
    #[inline(always)]
    pub fn cc1de(&mut self) -> CC1DE_W<TIM16_DIERrs> {
        CC1DE_W::new(self, 9)
    }
}
/**TIM16 DMA/interrupt enable register

You can [`read`](crate::Reg::read) this register and get [`tim16_dier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim16_dier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#TIM16:TIM16_DIER)*/
pub struct TIM16_DIERrs;
impl crate::RegisterSpec for TIM16_DIERrs {
    type Ux = u16;
}
///`read()` method returns [`tim16_dier::R`](R) reader structure
impl crate::Readable for TIM16_DIERrs {}
///`write(|w| ..)` method takes [`tim16_dier::W`](W) writer structure
impl crate::Writable for TIM16_DIERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
///`reset()` method sets TIM16_DIER to value 0
impl crate::Resettable for TIM16_DIERrs {
