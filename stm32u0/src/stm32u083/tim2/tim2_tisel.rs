...
impl W {
    ...
    input selection*/
    #[inline(always)]
    pub fn ti1sel(&mut self) -> TI1SEL_W<TIM2_TISELrs> {
        TI1SEL_W::new(self, 0)
    }
    /**Bits 8:11 - TI2\[0\]
    to TI2\[15\]
    input selection*/
    #[inline(always)]
    pub fn ti2sel(&mut self) -> TI2SEL_W<TIM2_TISELrs> {
        TI2SEL_W::new(self, 8)
    }
    /**Bits 16:19 - TI3\[0\]
    to TI3\[15\]
    input selection*/
    #[inline(always)]
    pub fn ti3sel(&mut self) -> TI3SEL_W<TIM2_TISELrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#TIM2:TIM2_TISEL)*/
