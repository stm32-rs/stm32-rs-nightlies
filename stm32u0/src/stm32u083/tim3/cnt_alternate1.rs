...
impl W {
    ///Bits 0:30 - Least significant part of counter value
    #[inline(always)]
    pub fn cnt(&mut self) -> CNT_W<CNT_ALTERNATE1rs> {
        CNT_W::new(self, 0)
    }
    ///Bit 31 - UIF Copy
    #[inline(always)]
    pub fn uifcpy(&mut self) -> UIFCPY_W<CNT_ALTERNATE1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#TIM3:CNT_ALTERNATE1)*/
