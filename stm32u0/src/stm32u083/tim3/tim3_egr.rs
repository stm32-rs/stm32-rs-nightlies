...
impl W {
    ...
    #[inline(always)]
    pub fn ug(&mut self) -> UG_W<TIM3_EGRrs> {
        UG_W::new(self, 0)
    }
    ///Bit 1 - Capture/compare 1 generation
    #[inline(always)]
    pub fn cc1g(&mut self) -> CC1G_W<TIM3_EGRrs> {
        CC1G_W::new(self, 1)
    }
    ///Bit 2 - Capture/compare 2 generation
    #[inline(always)]
    pub fn cc2g(&mut self) -> CC2G_W<TIM3_EGRrs> {
        CC2G_W::new(self, 2)
    }
    ///Bit 3 - Capture/compare 3 generation
    #[inline(always)]
    pub fn cc3g(&mut self) -> CC3G_W<TIM3_EGRrs> {
        CC3G_W::new(self, 3)
    }
    ///Bit 4 - Capture/compare 4 generation
    #[inline(always)]
    pub fn cc4g(&mut self) -> CC4G_W<TIM3_EGRrs> {
        CC4G_W::new(self, 4)
    }
    ///Bit 6 - Trigger generation
    #[inline(always)]
    pub fn tg(&mut self) -> TG_W<TIM3_EGRrs> {
        TG_W::new(self, 6)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#TIM3:TIM3_EGR)*/
