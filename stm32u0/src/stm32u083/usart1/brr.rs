...
///Field `BRR` reader - USART baud rate BRR\[15:4\] BRR\[15:4\] correspond to USARTDIV\[15:4\] BRR\[3:0\] When OVER8 = 0, BRR\[3:0\] = USARTDIV\[3:0\]. When OVER8 = 1: BRR\[2:0\] = USARTDIV\[3:0\] shifted 1 bit to the right. BRR\[3\] must be kept cleared.
pub type BRR_R = crate::FieldReader<u16>;
///Field `BRR` writer - USART baud rate BRR\[15:4\] BRR\[15:4\] correspond to USARTDIV\[15:4\] BRR\[3:0\] When OVER8 = 0, BRR\[3:0\] = USARTDIV\[3:0\]. When OVER8 = 1: BRR\[2:0\] = USARTDIV\[3:0\] shifted 1 bit to the right. BRR\[3\] must be kept cleared.
...
impl W {
    ///Bits 0:15 - USART baud rate BRR\[15:4\] BRR\[15:4\] correspond to USARTDIV\[15:4\] BRR\[3:0\] When OVER8 = 0, BRR\[3:0\] = USARTDIV\[3:0\]. When OVER8 = 1: BRR\[2:0\] = USARTDIV\[3:0\] shifted 1 bit to the right. BRR\[3\] must be kept cleared.
    #[inline(always)]
    pub fn brr(&mut self) -> BRR_W<'_, BRRrs> {
        BRR_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#USART1:BRR)*/
pub struct BRRrs;
