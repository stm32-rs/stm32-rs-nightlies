///Register `USART_ISR_ALTERNATE` reader
pub type R = crate::R<USART_ISR_ALTERNATErs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USART_ISR_ALTERNATE")
            .field("pe", &self.pe())
            .field("fe", &self.fe())
            .field("ne", &self.ne())
            .field("ore", &self.ore())
...
You can [`read`](crate::Reg::read) this register and get [`usart_isr_alternate::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#USART1:USART_ISR_ALTERNATE)*/
pub struct USART_ISR_ALTERNATErs;
impl crate::RegisterSpec for USART_ISR_ALTERNATErs {
    type Ux = u32;
}
///`read()` method returns [`usart_isr_alternate::R`](R) reader structure
impl crate::Readable for USART_ISR_ALTERNATErs {}
///`reset()` method sets USART_ISR_ALTERNATE to value 0xc0
impl crate::Resettable for USART_ISR_ALTERNATErs {
