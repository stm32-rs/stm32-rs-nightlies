///Register `USB_FNR` reader
pub type R = crate::R<USB_FNRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`usb_fnr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#USB:USB_FNR)*/
pub struct USB_FNRrs;
impl crate::RegisterSpec for USB_FNRrs {
    type Ux = u32;
}
///`read()` method returns [`usb_fnr::R`](R) reader structure
impl crate::Readable for USB_FNRrs {}
///`reset()` method sets USB_FNR to value 0
impl crate::Resettable for USB_FNRrs {
