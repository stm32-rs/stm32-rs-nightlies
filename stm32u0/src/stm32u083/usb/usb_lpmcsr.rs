///Register `USB_LPMCSR` reader
pub type R = crate::R<USB_LPMCSRrs>;
///Register `USB_LPMCSR` writer
pub type W = crate::W<USB_LPMCSRrs>;
...
impl W {
    ///Bit 0 - LPM support enable Device mode This bit is set by the software to enable the LPM support within the USB Device. If this bit is at 0 no LPM transactions are handled.
    #[inline(always)]
    pub fn lpmen(&mut self) -> LPMEN_W<USB_LPMCSRrs> {
        LPMEN_W::new(self, 0)
    }
    ///Bit 1 - LPM token acknowledge enable Device mode: The NYET/ACK is returned only on a successful LPM transaction: No errors in both the EXT token and the LPM token (else ERROR) A valid bLinkState = 0001B (L1) is received (else STALL)
    #[inline(always)]
    pub fn lpmack(&mut self) -> LPMACK_W<USB_LPMCSRrs> {
        LPMACK_W::new(self, 1)
    }
}
/**LPM control and status register

You can [`read`](crate::Reg::read) this register and get [`usb_lpmcsr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb_lpmcsr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U083.html#USB:USB_LPMCSR)*/
pub struct USB_LPMCSRrs;
impl crate::RegisterSpec for USB_LPMCSRrs {
    type Ux = u32;
}
///`read()` method returns [`usb_lpmcsr::R`](R) reader structure
impl crate::Readable for USB_LPMCSRrs {}
///`write(|w| ..)` method takes [`usb_lpmcsr::W`](W) writer structure
impl crate::Writable for USB_LPMCSRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets USB_LPMCSR to value 0
impl crate::Resettable for USB_LPMCSRrs {
