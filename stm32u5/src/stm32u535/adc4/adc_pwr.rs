#[doc = "Register `ADC_PWR` reader"]
pub type R = crate::R<ADC_PWRrs>;
#[doc = "Register `ADC_PWR` writer"]
...
#[doc = "Field `DPD` reader - DPD"]
pub type DPD_R = crate::BitReader;
#[doc = "Field `DPD` writer - DPD"]
pub type DPD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `VREFPROT` reader - VREFPROT"]
pub type VREFPROT_R = crate::BitReader;
#[doc = "Field `VREFPROT` writer - VREFPROT"]
pub type VREFPROT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `VREFSECSMP` reader - VREFSECSMP"]
pub type VREFSECSMP_R = crate::BitReader;
#[doc = "Field `VREFSECSMP` writer - VREFSECSMP"]
...
#[doc = "ADC data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adc_pwr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adc_pwr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ADC_PWRrs;
impl crate::RegisterSpec for ADC_PWRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc_pwr::R`](R) reader structure"]
impl crate::Readable for ADC_PWRrs {}
#[doc = "`write(|w| ..)` method takes [`adc_pwr::W`](W) writer structure"]
impl crate::Writable for ADC_PWRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADC_PWR to value 0"]
