...
impl W {
    ...
    ///Bit 30 - DFLT0 run status flag
    #[inline(always)]
    pub fn dfltrun(&mut self) -> DFLTRUN_W<'_, DFLT0CRrs> {
        DFLTRUN_W::new(self, 30)
    }
    ///Bit 31 - DFLT0 active flag
    #[inline(always)]
    pub fn dfltactive(&mut self) -> DFLTACTIVE_W<'_, DFLT0CRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#ADF1:DFLT0CR)*/
