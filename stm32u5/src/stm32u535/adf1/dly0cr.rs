...
impl W {
    ///Bits 0:6 - Delay to apply to a bitstream
    #[inline(always)]
    pub fn skpdly(&mut self) -> SKPDLY_W<'_, DLY0CRrs> {
        SKPDLY_W::new(self, 0)
    }
    ///Bit 31 - Skip busy flag
    #[inline(always)]
    pub fn skpbf(&mut self) -> SKPBF_W<'_, DLY0CRrs> {
        SKPBF_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#ADF1:DLY0CR)*/
pub struct DLY0CRrs;
