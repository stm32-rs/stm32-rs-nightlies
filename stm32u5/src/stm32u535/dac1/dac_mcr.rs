...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmadouble1(&mut self) -> DMADOUBLE1_W<DAC_MCRrs> {
        DMADOUBLE1_W::new(self, 8)
    }
    ///Bit 9 - Enable signed format for DAC channel1
    #[inline(always)]
    #[must_use]
    pub fn sinformat1(&mut self) -> SINFORMAT1_W<DAC_MCRrs> {
        SINFORMAT1_W::new(self, 9)
    }
    ///Bits 14:15 - High frequency interface mode selection
    #[inline(always)]
    #[must_use]
    pub fn hfsel(&mut self) -> HFSEL_W<DAC_MCRrs> {
        HFSEL_W::new(self, 14)
    }
    ///Bits 16:18 - DAC Channel 2 mode
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmadouble2(&mut self) -> DMADOUBLE2_W<DAC_MCRrs> {
        DMADOUBLE2_W::new(self, 24)
    }
    ///Bit 25 - Enable signed format for DAC channel2
    #[inline(always)]
    #[must_use]
    pub fn sinformat2(&mut self) -> SINFORMAT2_W<DAC_MCRrs> {
