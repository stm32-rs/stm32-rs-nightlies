...
#[doc = "Field `TSAMPLE2` reader - DAC Channel 2 sample Time (only valid in sample and hold mode)"]
pub type TSAMPLE2_R = crate::FieldReader<u16>;
#[doc = "Field `TSAMPLE2` writer - DAC Channel 2 sample Time (only valid in sample and hold mode)"]
pub type TSAMPLE2_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    #[doc = "Bits 0:9 - DAC Channel 2 sample Time (only valid in sample and hold mode)"]
    #[inline(always)]
