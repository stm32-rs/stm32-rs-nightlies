///Register `EXTI_SECCFGR1` reader
pub type R = crate::R<EXTI_SECCFGR1rs>;
///Register `EXTI_SECCFGR1` writer
...
You can [`read`](crate::Reg::read) this register and get [`exti_seccfgr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`exti_seccfgr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`exti_seccfgr1::R`](R) reader structure
impl crate::Readable for EXTI_SECCFGR1rs {}
///`write(|w| ..)` method takes [`exti_seccfgr1::W`](W) writer structure
impl crate::Writable for EXTI_SECCFGR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EXTI_SECCFGR1 to value 0
