...
impl W {
    ///Bit 0 - Enable Interrupt Line 0
    #[inline(always)]
    pub fn eint0(&mut self) -> EINT0_W<'_, ILErs> {
        EINT0_W::new(self, 0)
    }
    ///Bit 1 - Enable Interrupt Line 1
    #[inline(always)]
    pub fn eint1(&mut self) -> EINT1_W<'_, ILErs> {
        EINT1_W::new(self, 1)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#FDCAN1_RAM:ILE)*/
pub struct ILErs;
