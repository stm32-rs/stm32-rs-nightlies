///Register `C4SR` reader
pub type R = crate::R<C4SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c4sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GPDMA1:C4SR)*/
pub struct C4SRrs;
impl crate::RegisterSpec for C4SRrs {
    type Ux = u32;
}
///`read()` method returns [`c4sr::R`](R) reader structure
impl crate::Readable for C4SRrs {}
///`reset()` method sets C4SR to value 0x01
impl crate::Resettable for C4SRrs {
