...
impl CH2D {
    ...
    ///0x54 - GPDMA channel x transfer register 3
    #[inline(always)]
    pub const fn tr3(&self) -> &TR3 {
        &self.tr3
    }
    ///0x58 - GPDMA channel x block register 2
    #[inline(always)]
...
pub mod dar;
/**TR3 (rw) register accessor: GPDMA channel x transfer register 3
...
pub mod tr3;
/**BR2 (rw) register accessor: GPDMA channel x block register 2
...
For information about available fields see [`mod@br2`]
module*/
