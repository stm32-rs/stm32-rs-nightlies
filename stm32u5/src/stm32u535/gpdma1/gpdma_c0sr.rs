///Register `GPDMA_C0SR` reader
pub type R = crate::R<GPDMA_C0SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c0sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GPDMA1:GPDMA_C0SR)*/
pub struct GPDMA_C0SRrs;
impl crate::RegisterSpec for GPDMA_C0SRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c0sr::R`](R) reader structure
impl crate::Readable for GPDMA_C0SRrs {}
///`reset()` method sets GPDMA_C0SR to value 0x01
impl crate::Resettable for GPDMA_C0SRrs {
