///Register `GPDMA_C10SR` reader
pub type R = crate::R<GPDMA_C10SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c10sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GPDMA1:GPDMA_C10SR)*/
pub struct GPDMA_C10SRrs;
impl crate::RegisterSpec for GPDMA_C10SRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c10sr::R`](R) reader structure
impl crate::Readable for GPDMA_C10SRrs {}
///`reset()` method sets GPDMA_C10SR to value 0x01
impl crate::Resettable for GPDMA_C10SRrs {
