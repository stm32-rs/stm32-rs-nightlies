///Register `GPDMA_C11SR` reader
pub type R = crate::R<GPDMA_C11SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c11sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GPDMA1:GPDMA_C11SR)*/
pub struct GPDMA_C11SRrs;
impl crate::RegisterSpec for GPDMA_C11SRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c11sr::R`](R) reader structure
impl crate::Readable for GPDMA_C11SRrs {}
///`reset()` method sets GPDMA_C11SR to value 0x01
impl crate::Resettable for GPDMA_C11SRrs {
