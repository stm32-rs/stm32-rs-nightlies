///Register `GPDMA_C12FCR` writer
pub type W = crate::W<GPDMA_C12FCRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<GPDMA_C12FCRrs> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcf(&mut self) -> TCF_W<GPDMA_C12FCRrs> {
        TCF_W::new(self, 8)
    }
    ///Bit 9 - half transfer flag clear - 0: no effect - 1: clears the corresponding HTF flag
    #[inline(always)]
    #[must_use]
    pub fn htf(&mut self) -> HTF_W<GPDMA_C12FCRrs> {
        HTF_W::new(self, 9)
    }
    ///Bit 10 - data transfer error flag clear - 0: no effect - 1: clears the corresponding DTEF flag
    #[inline(always)]
    #[must_use]
    pub fn dtef(&mut self) -> DTEF_W<GPDMA_C12FCRrs> {
        DTEF_W::new(self, 10)
    }
    ///Bit 11 - update link transfer error flag clear - 0: no effect - 1: clears the corresponding ULEF flag
    #[inline(always)]
    #[must_use]
    pub fn ulef(&mut self) -> ULEF_W<GPDMA_C12FCRrs> {
        ULEF_W::new(self, 11)
    }
    ///Bit 12 - user setting error flag clear - 0: no effect - 1: clears the corresponding USEF flag
    #[inline(always)]
    #[must_use]
    pub fn usef(&mut self) -> USEF_W<GPDMA_C12FCRrs> {
        USEF_W::new(self, 12)
    }
    ///Bit 13 - completed suspension flag clear - 0: no effect - 1: clears the corresponding SUSPF flag
    #[inline(always)]
    #[must_use]
    pub fn suspf(&mut self) -> SUSPF_W<GPDMA_C12FCRrs> {
        SUSPF_W::new(self, 13)
    }
    ///Bit 14 - trigger overrun flag clear
    #[inline(always)]
    #[must_use]
    pub fn tof(&mut self) -> TOF_W<GPDMA_C12FCRrs> {
        TOF_W::new(self, 14)
    }
}
/**GPDMA channel x flag clear register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c12fcr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GPDMA1:GPDMA_C12FCR)*/
pub struct GPDMA_C12FCRrs;
impl crate::RegisterSpec for GPDMA_C12FCRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`gpdma_c12fcr::W`](W) writer structure
impl crate::Writable for GPDMA_C12FCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C12FCR to value 0
impl crate::Resettable for GPDMA_C12FCRrs {
