#[doc = "Register `GPDMA_C12LLR` reader"]
pub type R = crate::R<GPDMA_C12LLRrs>;
#[doc = "Register `GPDMA_C12LLR` writer"]
...
#[doc = "Field `UB2` reader - Update GPDMA_CxBR2 from memory This bit controls the update of the GPDMA_CxBR2 register from the memory during the link transfer. - 0: no GPDMA_CxBR2 update - 1: GPDMA_CxBR2 update"]
pub type UB2_R = crate::BitReader;
#[doc = "Field `UB2` writer - Update GPDMA_CxBR2 from memory This bit controls the update of the GPDMA_CxBR2 register from the memory during the link transfer. - 0: no GPDMA_CxBR2 update - 1: GPDMA_CxBR2 update"]
pub type UB2_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `UT3` reader - Update GPDMA_CxTR3 from memory This bit controls the update of the GPDMA_CxTR3 register from the memory during the link transfer. - 0: no GPDMA_CxTR3 update - 1: GPDMA_CxTR3 update"]
pub type UT3_R = crate::BitReader;
#[doc = "Field `UT3` writer - Update GPDMA_CxTR3 from memory This bit controls the update of the GPDMA_CxTR3 register from the memory during the link transfer. - 0: no GPDMA_CxTR3 update - 1: GPDMA_CxTR3 update"]
...
impl R {
    ...
    #[doc = "Bit 25 - Update GPDMA_CxBR2 from memory This bit controls the update of the GPDMA_CxBR2 register from the memory during the link transfer. - 0: no GPDMA_CxBR2 update - 1: GPDMA_CxBR2 update"]
    #[inline(always)]
    pub fn ub2(&self) -> UB2_R {
        UB2_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - Update GPDMA_CxTR3 from memory This bit controls the update of the GPDMA_CxTR3 register from the memory during the link transfer. - 0: no GPDMA_CxTR3 update - 1: GPDMA_CxTR3 update"]
    #[inline(always)]
...
#[doc = "GPDMA channel x linked-list address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c12llr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c12llr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C12LLRrs;
impl crate::RegisterSpec for GPDMA_C12LLRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c12llr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C12LLRrs {}
#[doc = "`write(|w| ..)` method takes [`gpdma_c12llr::W`](W) writer structure"]
impl crate::Writable for GPDMA_C12LLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C12LLR to value 0"]
