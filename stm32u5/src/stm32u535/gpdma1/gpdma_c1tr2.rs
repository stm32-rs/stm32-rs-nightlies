///Register `GPDMA_C1TR2` reader
pub type R = crate::R<GPDMA_C1TR2rs>;
///Register `GPDMA_C1TR2` writer
...
///Field `TRIGM` reader - TRIGM mode
pub type TRIGM_R = crate::FieldReader;
///Field `TRIGM` writer - TRIGM mode
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c1tr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c1tr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GPDMA1:GPDMA_C1TR2)*/
pub struct GPDMA_C1TR2rs;
impl crate::RegisterSpec for GPDMA_C1TR2rs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c1tr2::R`](R) reader structure
impl crate::Readable for GPDMA_C1TR2rs {}
///`write(|w| ..)` method takes [`gpdma_c1tr2::W`](W) writer structure
impl crate::Writable for GPDMA_C1TR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C1TR2 to value 0
