#[doc = "Register `GPDMA_C9CR` reader"]
pub type R = crate::R<GPDMA_C9CRrs>;
#[doc = "Register `GPDMA_C9CR` writer"]
...
#[doc = "channel x control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c9cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c9cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C9CRrs;
impl crate::RegisterSpec for GPDMA_C9CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c9cr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C9CRrs {}
#[doc = "`write(|w| ..)` method takes [`gpdma_c9cr::W`](W) writer structure"]
impl crate::Writable for GPDMA_C9CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C9CR to value 0"]
