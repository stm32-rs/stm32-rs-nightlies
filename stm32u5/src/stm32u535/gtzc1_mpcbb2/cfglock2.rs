...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SPLCK32` field.</div>
    #[inline(always)]
    pub fn splck(&mut self, n: u8) -> SPLCK_W<'_, CFGLOCK2rs> {
        #[allow(clippy::no_effect)]
        [(); 20][n as usize];
        SPLCK_W::new(self, n)
    }
    ///Bit 0 - SPLCK32
    #[inline(always)]
    pub fn splck32(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 0)
    }
    ///Bit 1 - SPLCK33
    #[inline(always)]
    pub fn splck33(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 1)
    }
    ///Bit 2 - SPLCK34
    #[inline(always)]
    pub fn splck34(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 2)
    }
    ///Bit 3 - SPLCK35
    #[inline(always)]
    pub fn splck35(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 3)
    }
    ///Bit 4 - SPLCK36
    #[inline(always)]
    pub fn splck36(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 4)
    }
    ///Bit 5 - SPLCK37
    #[inline(always)]
    pub fn splck37(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 5)
    }
    ///Bit 6 - SPLCK38
    #[inline(always)]
    pub fn splck38(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 6)
    }
    ///Bit 7 - SPLCK39
    #[inline(always)]
    pub fn splck39(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 7)
    }
    ///Bit 8 - SPLCK40
    #[inline(always)]
    pub fn splck40(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 8)
    }
    ///Bit 9 - SPLCK41
    #[inline(always)]
    pub fn splck41(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 9)
    }
    ///Bit 10 - SPLCK42
    #[inline(always)]
    pub fn splck42(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 10)
    }
    ///Bit 11 - SPLCK43
    #[inline(always)]
    pub fn splck43(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 11)
    }
    ///Bit 12 - SPLCK44
    #[inline(always)]
    pub fn splck44(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 12)
    }
    ///Bit 13 - SPLCK45
    #[inline(always)]
    pub fn splck45(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 13)
    }
    ///Bit 14 - SPLCK46
    #[inline(always)]
    pub fn splck46(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 14)
    }
    ///Bit 15 - SPLCK47
    #[inline(always)]
    pub fn splck47(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 15)
    }
    ///Bit 16 - SPLCK48
    #[inline(always)]
    pub fn splck48(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 16)
    }
    ///Bit 17 - SPLCK49
    #[inline(always)]
    pub fn splck49(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 17)
    }
    ///Bit 18 - SPLCK50
    #[inline(always)]
    pub fn splck50(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 18)
    }
    ///Bit 19 - SPLCK51
    #[inline(always)]
    pub fn splck51(&mut self) -> SPLCK_W<'_, CFGLOCK2rs> {
        SPLCK_W::new(self, 19)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GTZC1_MPCBB2:CFGLOCK2)*/
