///Register `MPCBB2_CR` reader
pub type R = crate::R<MPCBB2_CRrs>;
///Register `MPCBB2_CR` writer
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn glock(&mut self) -> GLOCK_W<MPCBB2_CRrs> {
        GLOCK_W::new(self, 0)
    }
    ///Bit 30 - SRAMx clocks security state
    #[inline(always)]
...
You can [`read`](crate::Reg::read) this register and get [`mpcbb2_cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb2_cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GTZC1_MPCBB2:MPCBB2_CR)*/
pub struct MPCBB2_CRrs;
impl crate::RegisterSpec for MPCBB2_CRrs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb2_cr::R`](R) reader structure
impl crate::Readable for MPCBB2_CRrs {}
///`write(|w| ..)` method takes [`mpcbb2_cr::W`](W) writer structure
impl crate::Writable for MPCBB2_CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB2_CR to value 0
