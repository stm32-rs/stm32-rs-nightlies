///Register `MPCBB2_PRIVCFGR24` reader
pub type R = crate::R<MPCBB2_PRIVCFGR24rs>;
///Register `MPCBB2_PRIVCFGR24` writer
pub type W = crate::W<MPCBB2_PRIVCFGR24rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB2_PRIVCFGR24")
...
impl W {
    ///Bit 0 - PRIV0
    #[inline(always)]
    pub fn priv0(&mut self) -> PRIV0_W<MPCBB2_PRIVCFGR24rs> {
        PRIV0_W::new(self, 0)
    }
    ///Bit 1 - PRIV1
    #[inline(always)]
    pub fn priv1(&mut self) -> PRIV1_W<MPCBB2_PRIVCFGR24rs> {
        PRIV1_W::new(self, 1)
    }
    ///Bit 2 - PRIV2
    #[inline(always)]
    pub fn priv2(&mut self) -> PRIV2_W<MPCBB2_PRIVCFGR24rs> {
        PRIV2_W::new(self, 2)
    }
    ///Bit 3 - PRIV3
    #[inline(always)]
    pub fn priv3(&mut self) -> PRIV3_W<MPCBB2_PRIVCFGR24rs> {
        PRIV3_W::new(self, 3)
    }
    ///Bit 4 - PRIV4
    #[inline(always)]
    pub fn priv4(&mut self) -> PRIV4_W<MPCBB2_PRIVCFGR24rs> {
        PRIV4_W::new(self, 4)
    }
    ///Bit 5 - PRIV5
    #[inline(always)]
    pub fn priv5(&mut self) -> PRIV5_W<MPCBB2_PRIVCFGR24rs> {
        PRIV5_W::new(self, 5)
    }
    ///Bit 6 - PRIV6
    #[inline(always)]
    pub fn priv6(&mut self) -> PRIV6_W<MPCBB2_PRIVCFGR24rs> {
        PRIV6_W::new(self, 6)
    }
    ///Bit 7 - PRIV7
    #[inline(always)]
    pub fn priv7(&mut self) -> PRIV7_W<MPCBB2_PRIVCFGR24rs> {
        PRIV7_W::new(self, 7)
    }
    ///Bit 8 - PRIV8
    #[inline(always)]
    pub fn priv8(&mut self) -> PRIV8_W<MPCBB2_PRIVCFGR24rs> {
        PRIV8_W::new(self, 8)
    }
    ///Bit 9 - PRIV9
    #[inline(always)]
    pub fn priv9(&mut self) -> PRIV9_W<MPCBB2_PRIVCFGR24rs> {
        PRIV9_W::new(self, 9)
    }
    ///Bit 10 - PRIV10
    #[inline(always)]
    pub fn priv10(&mut self) -> PRIV10_W<MPCBB2_PRIVCFGR24rs> {
        PRIV10_W::new(self, 10)
    }
    ///Bit 11 - PRIV11
    #[inline(always)]
    pub fn priv11(&mut self) -> PRIV11_W<MPCBB2_PRIVCFGR24rs> {
        PRIV11_W::new(self, 11)
    }
    ///Bit 12 - PRIV12
    #[inline(always)]
    pub fn priv12(&mut self) -> PRIV12_W<MPCBB2_PRIVCFGR24rs> {
        PRIV12_W::new(self, 12)
    }
    ///Bit 13 - PRIV13
    #[inline(always)]
    pub fn priv13(&mut self) -> PRIV13_W<MPCBB2_PRIVCFGR24rs> {
        PRIV13_W::new(self, 13)
    }
    ///Bit 14 - PRIV14
    #[inline(always)]
    pub fn priv14(&mut self) -> PRIV14_W<MPCBB2_PRIVCFGR24rs> {
        PRIV14_W::new(self, 14)
    }
    ///Bit 15 - PRIV15
    #[inline(always)]
    pub fn priv15(&mut self) -> PRIV15_W<MPCBB2_PRIVCFGR24rs> {
        PRIV15_W::new(self, 15)
    }
    ///Bit 16 - PRIV16
    #[inline(always)]
    pub fn priv16(&mut self) -> PRIV16_W<MPCBB2_PRIVCFGR24rs> {
        PRIV16_W::new(self, 16)
    }
    ///Bit 17 - PRIV17
    #[inline(always)]
    pub fn priv17(&mut self) -> PRIV17_W<MPCBB2_PRIVCFGR24rs> {
        PRIV17_W::new(self, 17)
    }
    ///Bit 18 - PRIV18
    #[inline(always)]
    pub fn priv18(&mut self) -> PRIV18_W<MPCBB2_PRIVCFGR24rs> {
        PRIV18_W::new(self, 18)
    }
    ///Bit 19 - PRIV19
    #[inline(always)]
    pub fn priv19(&mut self) -> PRIV19_W<MPCBB2_PRIVCFGR24rs> {
        PRIV19_W::new(self, 19)
    }
    ///Bit 20 - PRIV20
    #[inline(always)]
    pub fn priv20(&mut self) -> PRIV20_W<MPCBB2_PRIVCFGR24rs> {
        PRIV20_W::new(self, 20)
    }
    ///Bit 21 - PRIV21
    #[inline(always)]
    pub fn priv21(&mut self) -> PRIV21_W<MPCBB2_PRIVCFGR24rs> {
        PRIV21_W::new(self, 21)
    }
    ///Bit 22 - PRIV22
    #[inline(always)]
    pub fn priv22(&mut self) -> PRIV22_W<MPCBB2_PRIVCFGR24rs> {
        PRIV22_W::new(self, 22)
    }
    ///Bit 23 - PRIV23
    #[inline(always)]
    pub fn priv23(&mut self) -> PRIV23_W<MPCBB2_PRIVCFGR24rs> {
        PRIV23_W::new(self, 23)
    }
    ///Bit 24 - PRIV24
    #[inline(always)]
    pub fn priv24(&mut self) -> PRIV24_W<MPCBB2_PRIVCFGR24rs> {
        PRIV24_W::new(self, 24)
    }
    ///Bit 25 - PRIV25
    #[inline(always)]
    pub fn priv25(&mut self) -> PRIV25_W<MPCBB2_PRIVCFGR24rs> {
        PRIV25_W::new(self, 25)
    }
    ///Bit 26 - PRIV26
    #[inline(always)]
    pub fn priv26(&mut self) -> PRIV26_W<MPCBB2_PRIVCFGR24rs> {
        PRIV26_W::new(self, 26)
    }
    ///Bit 27 - PRIV27
    #[inline(always)]
    pub fn priv27(&mut self) -> PRIV27_W<MPCBB2_PRIVCFGR24rs> {
        PRIV27_W::new(self, 27)
    }
    ///Bit 28 - PRIV28
    #[inline(always)]
    pub fn priv28(&mut self) -> PRIV28_W<MPCBB2_PRIVCFGR24rs> {
        PRIV28_W::new(self, 28)
    }
    ///Bit 29 - PRIV29
    #[inline(always)]
    pub fn priv29(&mut self) -> PRIV29_W<MPCBB2_PRIVCFGR24rs> {
        PRIV29_W::new(self, 29)
    }
    ///Bit 30 - PRIV30
    #[inline(always)]
    pub fn priv30(&mut self) -> PRIV30_W<MPCBB2_PRIVCFGR24rs> {
        PRIV30_W::new(self, 30)
    }
    ///Bit 31 - PRIV31
    #[inline(always)]
    pub fn priv31(&mut self) -> PRIV31_W<MPCBB2_PRIVCFGR24rs> {
        PRIV31_W::new(self, 31)
    }
}
/**MPCBB privileged configuration for super-block x register

You can [`read`](crate::Reg::read) this register and get [`mpcbb2_privcfgr24::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb2_privcfgr24::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GTZC1_MPCBB2:MPCBB2_PRIVCFGR24)*/
pub struct MPCBB2_PRIVCFGR24rs;
impl crate::RegisterSpec for MPCBB2_PRIVCFGR24rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb2_privcfgr24::R`](R) reader structure
impl crate::Readable for MPCBB2_PRIVCFGR24rs {}
///`write(|w| ..)` method takes [`mpcbb2_privcfgr24::W`](W) writer structure
impl crate::Writable for MPCBB2_PRIVCFGR24rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB2_PRIVCFGR24 to value 0xffff_ffff
impl crate::Resettable for MPCBB2_PRIVCFGR24rs {
