...
impl W {
    ///Bits 0:10 - Start of sub-region A
    #[inline(always)]
    pub fn subb_start(&mut self) -> SUBB_START_W<'_, MPCWM1BRrs> {
        SUBB_START_W::new(self, 0)
    }
    ///Bits 16:27 - Length of sub-region A
    #[inline(always)]
    pub fn subb_length(&mut self) -> SUBB_LENGTH_W<'_, MPCWM1BRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GTZC1_TZSC:MPCWM1BR)*/
