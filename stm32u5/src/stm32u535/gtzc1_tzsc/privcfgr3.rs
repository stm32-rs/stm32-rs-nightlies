...
///Field `SDMMC1PRIV` reader - privileged access mode
pub type SDMMC1PRIV_R = crate::BitReader;
///Field `SDMMC1PRIV` writer - privileged access mode
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GTZC1_TZSC:PRIVCFGR3)*/
