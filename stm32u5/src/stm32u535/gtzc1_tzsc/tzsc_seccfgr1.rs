...
impl W {
    ///Bit 0 - secure access mode for TIM2
    #[inline(always)]
    pub fn tim2sec(&mut self) -> TIM2SEC_W<TZSC_SECCFGR1rs> {
        TIM2SEC_W::new(self, 0)
    }
    ///Bit 1 - secure access mode for TIM3
    #[inline(always)]
    pub fn tim3sec(&mut self) -> TIM3SEC_W<TZSC_SECCFGR1rs> {
        TIM3SEC_W::new(self, 1)
    }
    ///Bit 2 - secure access mode for TIM4
    #[inline(always)]
    pub fn tim4sec(&mut self) -> TIM4SEC_W<TZSC_SECCFGR1rs> {
        TIM4SEC_W::new(self, 2)
    }
    ///Bit 3 - secure access mode for TIM5
    #[inline(always)]
    pub fn tim5sec(&mut self) -> TIM5SEC_W<TZSC_SECCFGR1rs> {
        TIM5SEC_W::new(self, 3)
    }
    ///Bit 4 - secure access mode for TIM6
    #[inline(always)]
    pub fn tim6sec(&mut self) -> TIM6SEC_W<TZSC_SECCFGR1rs> {
        TIM6SEC_W::new(self, 4)
    }
    ///Bit 5 - secure access mode for TIM7
    #[inline(always)]
    pub fn tim7sec(&mut self) -> TIM7SEC_W<TZSC_SECCFGR1rs> {
        TIM7SEC_W::new(self, 5)
    }
    ///Bit 6 - secure access mode for WWDG
    #[inline(always)]
    pub fn wwdgsec(&mut self) -> WWDGSEC_W<TZSC_SECCFGR1rs> {
        WWDGSEC_W::new(self, 6)
    }
    ///Bit 7 - secure access mode for IWDG
    #[inline(always)]
    pub fn iwdgsec(&mut self) -> IWDGSEC_W<TZSC_SECCFGR1rs> {
        IWDGSEC_W::new(self, 7)
    }
    ///Bit 8 - secure access mode for SPI2
    #[inline(always)]
    pub fn spi2sec(&mut self) -> SPI2SEC_W<TZSC_SECCFGR1rs> {
        SPI2SEC_W::new(self, 8)
    }
    ///Bit 10 - secure access mode for USART3
    #[inline(always)]
    pub fn usart3sec(&mut self) -> USART3SEC_W<TZSC_SECCFGR1rs> {
        USART3SEC_W::new(self, 10)
    }
    ///Bit 11 - secure access mode for UART4
    #[inline(always)]
    pub fn uart4sec(&mut self) -> UART4SEC_W<TZSC_SECCFGR1rs> {
        UART4SEC_W::new(self, 11)
    }
    ///Bit 12 - secure access mode for UART5
    #[inline(always)]
    pub fn uart5sec(&mut self) -> UART5SEC_W<TZSC_SECCFGR1rs> {
        UART5SEC_W::new(self, 12)
    }
    ///Bit 13 - secure access mode for I2C1
    #[inline(always)]
    pub fn i2c1sec(&mut self) -> I2C1SEC_W<TZSC_SECCFGR1rs> {
        I2C1SEC_W::new(self, 13)
    }
    ///Bit 14 - secure access mode for I2C2
    #[inline(always)]
    pub fn i2c2sec(&mut self) -> I2C2SEC_W<TZSC_SECCFGR1rs> {
        I2C2SEC_W::new(self, 14)
    }
    ///Bit 15 - secure access mode for CRS
    #[inline(always)]
    pub fn crssec(&mut self) -> CRSSEC_W<TZSC_SECCFGR1rs> {
        CRSSEC_W::new(self, 15)
    }
    ///Bit 16 - secure access mode for I2C4
    #[inline(always)]
    pub fn i2c4sec(&mut self) -> I2C4SEC_W<TZSC_SECCFGR1rs> {
        I2C4SEC_W::new(self, 16)
    }
    ///Bit 17 - secure access mode for LPTIM2
    #[inline(always)]
    pub fn lptim2sec(&mut self) -> LPTIM2SEC_W<TZSC_SECCFGR1rs> {
        LPTIM2SEC_W::new(self, 17)
    }
    ///Bit 18 - secure access mode for FDCAN1
    #[inline(always)]
    pub fn fdcan1sec(&mut self) -> FDCAN1SEC_W<TZSC_SECCFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#GTZC1_TZSC:TZSC_SECCFGR1)*/
