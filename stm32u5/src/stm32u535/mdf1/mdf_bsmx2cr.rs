#[doc = "Register `MDF_BSMX2CR` reader"]
pub type R = crate::R<MDF_BSMX2CRrs>;
#[doc = "Register `MDF_BSMX2CR` writer"]
...
#[doc = "This register is used to select the bitstream to be provided to the corresponding digital filter and to the SCD.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_bsmx2cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdf_bsmx2cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_BSMX2CRrs;
impl crate::RegisterSpec for MDF_BSMX2CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_bsmx2cr::R`](R) reader structure"]
impl crate::Readable for MDF_BSMX2CRrs {}
#[doc = "`write(|w| ..)` method takes [`mdf_bsmx2cr::W`](W) writer structure"]
impl crate::Writable for MDF_BSMX2CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDF_BSMX2CR to value 0"]
