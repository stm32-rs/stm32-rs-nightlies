#[doc = "Register `MDF_DFLT2ISR` reader"]
pub type R = crate::R<MDF_DFLT2ISRrs>;
#[doc = "Register `MDF_DFLT2ISR` writer"]
pub type W = crate::W<MDF_DFLT2ISRrs>;
#[doc = "Field `FTHF` reader - RXFIFO threshold flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that the RXFIFO threshold is not reached, writing 0 has no effect. - 1: Reading 1 means that the RXFIFO reached the threshold, writing 1 clears this flag."]
...
#[doc = "Field `SSDRF` reader - Snapshot data ready flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no data is available on MDF_SNPSxDR, writing 0 has no effect. - 1: Reading 1 means that a new data is available on MDF_SNPSxDR, writing 1 clears this flag."]
pub type SSDRF_R = crate::BitReader;
#[doc = "Field `SSDRF` writer - Snapshot data ready flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no data is available on MDF_SNPSxDR, writing 0 has no effect. - 1: Reading 1 means that a new data is available on MDF_SNPSxDR, writing 1 clears this flag."]
...
impl R {
    #[doc = "Bit 0 - RXFIFO threshold flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that the RXFIFO threshold is not reached, writing 0 has no effect. - 1: Reading 1 means that the RXFIFO reached the threshold, writing 1 clears this flag."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - Snapshot data ready flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no data is available on MDF_SNPSxDR, writing 0 has no effect. - 1: Reading 1 means that a new data is available on MDF_SNPSxDR, writing 1 clears this flag."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dovrf(&mut self) -> DOVRF_W<MDF_DFLT2ISRrs> {
        DOVRF_W::new(self, 1)
    }
    #[doc = "Bit 2 - Snapshot data ready flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no data is available on MDF_SNPSxDR, writing 0 has no effect. - 1: Reading 1 means that a new data is available on MDF_SNPSxDR, writing 1 clears this flag."]
    #[inline(always)]
    #[must_use]
    pub fn ssdrf(&mut self) -> SSDRF_W<MDF_DFLT2ISRrs> {
        SSDRF_W::new(self, 2)
    }
    #[doc = "Bit 4 - Out-of Limit Detector flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no OLD event is detected, writing 0 has no effect. - 1: Reading 1 means that an OLD event is detected, writing 1 clears THHF, THLF and OLDF flags."]
    #[inline(always)]
    #[must_use]
    pub fn oldf(&mut self) -> OLDF_W<MDF_DFLT2ISRrs> {
        OLDF_W::new(self, 4)
    }
    #[doc = "Bit 7 - Snapshot overrun flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no snapshot overrun event is detected, writing 0 has no effect. - 1: Reading 1 means that a snapshot overrun event is detected, writing 1 clears this flag."]
    #[inline(always)]
    #[must_use]
    pub fn ssovrf(&mut self) -> SSOVRF_W<MDF_DFLT2ISRrs> {
        SSOVRF_W::new(self, 7)
    }
    #[doc = "Bit 8 - Short-Circuit Detector flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no SCD event is detected, writing 0 has no effect. - 1: Reading 1 means that a SCD event is detected, writing 1 clears this flag."]
    #[inline(always)]
    #[must_use]
    pub fn scdf(&mut self) -> SCDF_W<MDF_DFLT2ISRrs> {
        SCDF_W::new(self, 8)
    }
    #[doc = "Bit 9 - Saturation detection flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no saturation is detected, writing 0 has no effect. - 1: Reading 1 means that a saturation is detected, writing 1 clears this flag."]
    #[inline(always)]
    #[must_use]
    pub fn satf(&mut self) -> SATF_W<MDF_DFLT2ISRrs> {
        SATF_W::new(self, 9)
    }
    #[doc = "Bit 10 - Clock absence detection flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no clock absence is detected, writing 0 has no effect. - 1: Reading 1 means that a clock absence is detected, writing 1 clears this flag."]
    #[inline(always)]
    #[must_use]
    pub fn ckabf(&mut self) -> CKABF_W<MDF_DFLT2ISRrs> {
        CKABF_W::new(self, 10)
    }
    #[doc = "Bit 11 - Reshape Filter Overrun detection flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no reshape filter overrun is detected, writing 0 has no effect. - 1: Reading 1 means that reshape filter overrun is detected, writing 1 clears this flag."]
    #[inline(always)]
    #[must_use]
    pub fn rfovrf(&mut self) -> RFOVRF_W<MDF_DFLT2ISRrs> {
        RFOVRF_W::new(self, 11)
    }
}
#[doc = "This register contains the status flags for each digital filter path.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_dflt2isr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdf_dflt2isr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_DFLT2ISRrs;
impl crate::RegisterSpec for MDF_DFLT2ISRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_dflt2isr::R`](R) reader structure"]
impl crate::Readable for MDF_DFLT2ISRrs {}
#[doc = "`write(|w| ..)` method takes [`mdf_dflt2isr::W`](W) writer structure"]
impl crate::Writable for MDF_DFLT2ISRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDF_DFLT2ISR to value 0"]
impl crate::Resettable for MDF_DFLT2ISRrs {
