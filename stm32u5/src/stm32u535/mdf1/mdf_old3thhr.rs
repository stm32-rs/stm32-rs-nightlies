///Register `MDF_OLD3THHR` reader
pub type R = crate::R<MDF_OLD3THHRrs>;
///Register `MDF_OLD3THHR` writer
pub type W = crate::W<MDF_OLD3THHRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn oldthh(&mut self) -> OLDTHH_W<MDF_OLD3THHRrs> {
        OLDTHH_W::new(self, 0)
    }
}
/**This register is used for the adjustment of the Out-off Limit high threshold.

You can [`read`](crate::Reg::read) this register and get [`mdf_old3thhr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_old3thhr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#MDF1:MDF_OLD3THHR)*/
pub struct MDF_OLD3THHRrs;
impl crate::RegisterSpec for MDF_OLD3THHRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_old3thhr::R`](R) reader structure
impl crate::Readable for MDF_OLD3THHRrs {}
///`write(|w| ..)` method takes [`mdf_old3thhr::W`](W) writer structure
impl crate::Writable for MDF_OLD3THHRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_OLD3THHR to value 0
impl crate::Resettable for MDF_OLD3THHRrs {
