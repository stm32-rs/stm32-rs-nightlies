///Register `MDF_OLD5THLR` reader
pub type R = crate::R<MDF_OLD5THLRrs>;
///Register `MDF_OLD5THLR` writer
pub type W = crate::W<MDF_OLD5THLRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn oldthl(&mut self) -> OLDTHL_W<MDF_OLD5THLRrs> {
        OLDTHL_W::new(self, 0)
    }
}
/**This register is used for the adjustment of the Out-off Limit low threshold.

You can [`read`](crate::Reg::read) this register and get [`mdf_old5thlr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_old5thlr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#MDF1:MDF_OLD5THLR)*/
pub struct MDF_OLD5THLRrs;
impl crate::RegisterSpec for MDF_OLD5THLRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_old5thlr::R`](R) reader structure
impl crate::Readable for MDF_OLD5THLRrs {}
///`write(|w| ..)` method takes [`mdf_old5thlr::W`](W) writer structure
impl crate::Writable for MDF_OLD5THLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_OLD5THLR to value 0
impl crate::Resettable for MDF_OLD5THLRrs {
