///Register `MDF_SNPS2DR` reader
pub type R = crate::R<MDF_SNPS2DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdf_snps2dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#MDF1:MDF_SNPS2DR)*/
pub struct MDF_SNPS2DRrs;
impl crate::RegisterSpec for MDF_SNPS2DRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_snps2dr::R`](R) reader structure
impl crate::Readable for MDF_SNPS2DRrs {}
///`reset()` method sets MDF_SNPS2DR to value 0
impl crate::Resettable for MDF_SNPS2DRrs {
