...
///Field `PD14` reader - Port A pull-down bit 14 When set, this bit activates the pull-down on PA14 when the APC bit is set in PWR_APCR.
pub type PD14_R = crate::BitReader;
///Field `PD14` writer - Port A pull-down bit 14 When set, this bit activates the pull-down on PA14 when the APC bit is set in PWR_APCR.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#PWR:PWR_PDCRA)*/
