#[doc = "Register `PWR_PDCRH` reader"]
pub type R = crate::R<PWR_PDCRHrs>;
#[doc = "Register `PWR_PDCRH` writer"]
...
#[doc = "PWR port H pull-down control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwr_pdcrh::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwr_pdcrh::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PWR_PDCRHrs;
impl crate::RegisterSpec for PWR_PDCRHrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwr_pdcrh::R`](R) reader structure"]
impl crate::Readable for PWR_PDCRHrs {}
#[doc = "`write(|w| ..)` method takes [`pwr_pdcrh::W`](W) writer structure"]
impl crate::Writable for PWR_PDCRHrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWR_PDCRH to value 0"]
