///Register `PWR_PDCRJ` reader
pub type R = crate::R<PWR_PDCRJrs>;
///Register `PWR_PDCRJ` writer
...
You can [`read`](crate::Reg::read) this register and get [`pwr_pdcrj::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pwr_pdcrj::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#PWR:PWR_PDCRJ)*/
pub struct PWR_PDCRJrs;
impl crate::RegisterSpec for PWR_PDCRJrs {
    type Ux = u32;
}
///`read()` method returns [`pwr_pdcrj::R`](R) reader structure
impl crate::Readable for PWR_PDCRJrs {}
///`write(|w| ..)` method takes [`pwr_pdcrj::W`](W) writer structure
impl crate::Writable for PWR_PDCRJrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PWR_PDCRJ to value 0
