...
impl W {
    ///Bit 0 - CSEDC
    #[inline(always)]
    pub fn csedc(&mut self) -> CSEDC_W<'_, M2ICRrs> {
        CSEDC_W::new(self, 0)
    }
    ///Bit 1 - CDED
    #[inline(always)]
    pub fn cded(&mut self) -> CDED_W<'_, M2ICRrs> {
        CDED_W::new(self, 1)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#RAMCFG:M2ICR)*/
pub struct M2ICRrs;
