...
///Field `NCV3` reader - NCV3
pub type NCV3_R = crate::FieldReader;
///Field `PCV3` reader - PCV3
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CCVR")
            ...
            .field("ncv3", &self.ncv3())
            .field("pcv3", &self.pcv3())
            .finish()
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#SYSCFG:CCVR)*/
pub struct CCVRrs;
