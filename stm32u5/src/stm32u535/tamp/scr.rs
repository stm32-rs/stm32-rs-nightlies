...
impl W {
    ...
    ///Bit 21 - CITAMP6F_bit21
    #[inline(always)]
    pub fn citamp6f_bit21(&mut self) -> CITAMP6F_BIT21_W<'_, SCRrs> {
        CITAMP6F_BIT21_W::new(self, 21)
    }
    ///Bit 22 - CITAMP7F_bit22
    #[inline(always)]
    pub fn citamp7f_bit22(&mut self) -> CITAMP7F_BIT22_W<'_, SCRrs> {
        CITAMP7F_BIT22_W::new(self, 22)
    }
    ///Bit 23 - CITAMP8F_bit23
    #[inline(always)]
    pub fn citamp8f_bit23(&mut self) -> CITAMP8F_BIT23_W<'_, SCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U535.html#TAMP:SCR)*/
pub struct SCRrs;
