...
///Field `BK2DSRAM` reader - Break2 Disarm
pub type BK2DSRAM_R = crate::BitReader;
///Field `BK2DSRAM` writer - Break2 Disarm
pub type BK2DSRAM_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn bk2dsram(&self) -> BK2DSRAM_R {
        BK2DSRAM_R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 27 - Break2 Disarm
    #[inline(always)]
    pub fn bk2dsram(&mut self) -> BK2DSRAM_W<'_, BDTRrs> {
        BK2DSRAM_W::new(self, 27)
    }
    ///Bit 28 - Break Bidirectional
    #[inline(always)]
