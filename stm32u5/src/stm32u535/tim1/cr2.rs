...
#[doc = "Field `MMS0_2` reader - Master mode selection"]
pub type MMS0_2_R = crate::FieldReader;
#[doc = "Field `MMS0_2` writer - Master mode selection"]
...
#[doc = "Field `OIS4N` reader - Output Idle state 4 (OC5 output)"]
pub type OIS4N_R = crate::BitReader;
#[doc = "Field `OIS4N` writer - Output Idle state 4 (OC5 output)"]
...
#[doc = "Field `MMS_3` reader - Master mode selection 2"]
pub type MMS_3_R = crate::BitReader;
#[doc = "Field `MMS_3` writer - Master mode selection 2"]
...
impl R {
    ...
    #[doc = "Bit 15 - Output Idle state 4 (OC5 output)"]
    #[inline(always)]
    ...
    #[doc = "Bit 25 - Master mode selection 2"]
    #[inline(always)]
