...
impl RegisterBlock {
    ...
    #[doc = "0x58 - DMA address for full transfer"]
    #[inline(always)]
    pub const fn ecr(&self) -> &ECR {
        &self.ecr
    }
    #[doc = "0x5c - timer input selection register"]
    #[inline(always)]
