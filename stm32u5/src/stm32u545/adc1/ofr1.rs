...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn offset(&mut self) -> OFFSET_W<OFR1rs> {
        OFFSET_W::new(self, 0)
    }
    ///Bit 24 - POSOFF
    #[inline(always)]
    #[must_use]
    pub fn posoff(&mut self) -> POSOFF_W<OFR1rs> {
        POSOFF_W::new(self, 24)
    }
    ///Bit 25 - USAT
    #[inline(always)]
    #[must_use]
    pub fn usat(&mut self) -> USAT_W<OFR1rs> {
        USAT_W::new(self, 25)
    }
    ///Bit 26 - SSAT
    #[inline(always)]
    #[must_use]
    pub fn ssat(&mut self) -> SSAT_W<OFR1rs> {
        SSAT_W::new(self, 26)
    }
    ///Bits 27:31 - OFFSET_CH
    #[inline(always)]
    #[must_use]
    pub fn offset_ch(&mut self) -> OFFSET_CH_W<OFR1rs> {
