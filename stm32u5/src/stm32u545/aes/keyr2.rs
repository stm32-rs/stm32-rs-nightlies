...
pub type KEYR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
...
impl W {
    ...
    #[inline(always)]
    pub fn keyr(&mut self) -> KEYR_W<'_, KEYR2rs> {
        KEYR_W::new(self, 0)
    }
}
/**key register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#AES:KEYR2)*/
pub struct KEYR2rs;
