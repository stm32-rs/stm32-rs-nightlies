...
#[doc = "Field `SRAM1345_RST` reader - SRAM1,SRAM4 and SRAM5 erase upon system reset"]
pub type SRAM1345_RST_R = crate::BitReader;
#[doc = "Field `SRAM1345_RST` writer - SRAM1,SRAM4 and SRAM5 erase upon system reset"]
...
impl R {
    ...
    #[doc = "Bit 15 - SRAM1,SRAM4 and SRAM5 erase upon system reset"]
    #[inline(always)]
