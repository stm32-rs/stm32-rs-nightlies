...
#[doc = "Field `ERRIE` reader - Secure error interrupt enable This bit enables the interrupt generation when the OPERR bit in the FLASH_SECSR is set to 1."]
pub type ERRIE_R = crate::BitReader;
#[doc = "Field `ERRIE` writer - Secure error interrupt enable This bit enables the interrupt generation when the OPERR bit in the FLASH_SECSR is set to 1."]
pub type ERRIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RDERRIE` reader - Secure PCROP read error interrupt enable This bit enables the interrupt generation when the RDERR bit in the FLASH_SECSR is set to 1."]
pub type RDERRIE_R = crate::BitReader;
#[doc = "Field `RDERRIE` writer - Secure PCROP read error interrupt enable This bit enables the interrupt generation when the RDERR bit in the FLASH_SECSR is set to 1."]
...
impl R {
    ...
    #[doc = "Bits 3:10 - Secure page number selection These bits select the page to erase. ... ..."]
    #[inline(always)]
    ...
    #[doc = "Bit 25 - Secure error interrupt enable This bit enables the interrupt generation when the OPERR bit in the FLASH_SECSR is set to 1."]
    #[inline(always)]
    pub fn errie(&self) -> ERRIE_R {
        ERRIE_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - Secure PCROP read error interrupt enable This bit enables the interrupt generation when the RDERR bit in the FLASH_SECSR is set to 1."]
    #[inline(always)]
