...
impl R {
    #[doc = "Bits 0:7 - Start page of first secure area This field contains the first page of the secure area in bank 1."]
    #[inline(always)]
    pub fn secwm1_pstrt(&self) -> SECWM1_PSTRT_R {
        SECWM1_PSTRT_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - End page of first secure area This field contains the last page of the secure area in bank 1."]
    #[inline(always)]
