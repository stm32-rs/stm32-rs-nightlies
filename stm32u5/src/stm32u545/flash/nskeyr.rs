...
///Field `NSKEY` writer - Flash memory non-secure key The following values must be written consecutively to unlock the FLASH_NSCR register, allowing the Flash memory non-secure programming/erasing operations: KEY1: 0x4567 0123 KEY2: 0xCDEF 89AB
...
impl W {
    ...
    #[inline(always)]
    pub fn nskey(&mut self) -> NSKEY_W<'_, NSKEYRrs> {
        NSKEY_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#FLASH:NSKEYR)*/
pub struct NSKEYRrs;
