///Register `C10SR` reader
pub type R = crate::R<C10SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c10sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#GPDMA1:C10SR)*/
pub struct C10SRrs;
impl crate::RegisterSpec for C10SRrs {
    type Ux = u32;
}
///`read()` method returns [`c10sr::R`](R) reader structure
impl crate::Readable for C10SRrs {}
///`reset()` method sets C10SR to value 0x01
impl crate::Resettable for C10SRrs {
