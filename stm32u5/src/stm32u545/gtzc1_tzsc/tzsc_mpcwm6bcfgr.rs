#[doc = "Register `TZSC_MPCWM6BCFGR` reader"]
pub type R = crate::R<TZSC_MPCWM6BCFGRrs>;
#[doc = "Register `TZSC_MPCWM6BCFGR` writer"]
...
#[doc = "TZSC memory 6 sub-region B watermark configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tzsc_mpcwm6bcfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tzsc_mpcwm6bcfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TZSC_MPCWM6BCFGRrs;
impl crate::RegisterSpec for TZSC_MPCWM6BCFGRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tzsc_mpcwm6bcfgr::R`](R) reader structure"]
impl crate::Readable for TZSC_MPCWM6BCFGRrs {}
#[doc = "`write(|w| ..)` method takes [`tzsc_mpcwm6bcfgr::W`](W) writer structure"]
impl crate::Writable for TZSC_MPCWM6BCFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TZSC_MPCWM6BCFGR to value 0"]
