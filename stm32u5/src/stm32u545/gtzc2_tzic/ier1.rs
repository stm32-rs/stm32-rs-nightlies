...
#[doc = "Field `ADC2IE` reader - illegal access interrupt enable for ADC2"]
pub type ADC2IE_R = crate::BitReader;
#[doc = "Field `ADC2IE` writer - illegal access interrupt enable for ADC2"]
...
impl R {
    ...
    #[doc = "Bit 8 - illegal access interrupt enable for ADC2"]
    #[inline(always)]
