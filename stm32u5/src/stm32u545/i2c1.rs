...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn i2c_autocr(&self) -> &I2C_AUTOCR {
        &self.i2c_autocr
    }
}
...
pub mod txdr;
/**I2C_AUTOCR (rw) register accessor: I2C Autonomous mode control register

You can [`read`](crate::Reg::read) this register and get [`i2c_autocr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c_autocr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#I2C1:I2C_AUTOCR)

For information about available fields see [`mod@i2c_autocr`]
module*/
pub type I2C_AUTOCR = crate::Reg<i2c_autocr::I2C_AUTOCRrs>;
