///Register `LPDMA_C3TR2` reader
pub type R = crate::R<LPDMA_C3TR2rs>;
///Register `LPDMA_C3TR2` writer
...
You can [`read`](crate::Reg::read) this register and get [`lpdma_c3tr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpdma_c3tr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#LPDMA1:LPDMA_C3TR2)*/
pub struct LPDMA_C3TR2rs;
impl crate::RegisterSpec for LPDMA_C3TR2rs {
    type Ux = u32;
}
///`read()` method returns [`lpdma_c3tr2::R`](R) reader structure
impl crate::Readable for LPDMA_C3TR2rs {}
///`write(|w| ..)` method takes [`lpdma_c3tr2::W`](W) writer structure
impl crate::Writable for LPDMA_C3TR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPDMA_C3TR2 to value 0
