///Register `MDF_DLY3CR` reader
pub type R = crate::R<MDF_DLY3CRrs>;
///Register `MDF_DLY3CR` writer
pub type W = crate::W<MDF_DLY3CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn skpdly(&mut self) -> SKPDLY_W<MDF_DLY3CRrs> {
        SKPDLY_W::new(self, 0)
    }
}
/**This register is used for the adjustment stream delays.

You can [`read`](crate::Reg::read) this register and get [`mdf_dly3cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_dly3cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#MDF1:MDF_DLY3CR)*/
pub struct MDF_DLY3CRrs;
impl crate::RegisterSpec for MDF_DLY3CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_dly3cr::R`](R) reader structure
impl crate::Readable for MDF_DLY3CRrs {}
///`write(|w| ..)` method takes [`mdf_dly3cr::W`](W) writer structure
impl crate::Writable for MDF_DLY3CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_DLY3CR to value 0
impl crate::Resettable for MDF_DLY3CRrs {
