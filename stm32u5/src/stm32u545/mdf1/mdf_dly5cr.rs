///Register `MDF_DLY5CR` reader
pub type R = crate::R<MDF_DLY5CRrs>;
///Register `MDF_DLY5CR` writer
...
You can [`read`](crate::Reg::read) this register and get [`mdf_dly5cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_dly5cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mdf_dly5cr::R`](R) reader structure
impl crate::Readable for MDF_DLY5CRrs {}
///`write(|w| ..)` method takes [`mdf_dly5cr::W`](W) writer structure
impl crate::Writable for MDF_DLY5CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_DLY5CR to value 0
