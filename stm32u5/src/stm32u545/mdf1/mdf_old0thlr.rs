///Register `MDF_OLD0THLR` reader
pub type R = crate::R<MDF_OLD0THLRrs>;
///Register `MDF_OLD0THLR` writer
...
You can [`read`](crate::Reg::read) this register and get [`mdf_old0thlr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_old0thlr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mdf_old0thlr::R`](R) reader structure
impl crate::Readable for MDF_OLD0THLRrs {}
///`write(|w| ..)` method takes [`mdf_old0thlr::W`](W) writer structure
impl crate::Writable for MDF_OLD0THLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_OLD0THLR to value 0
