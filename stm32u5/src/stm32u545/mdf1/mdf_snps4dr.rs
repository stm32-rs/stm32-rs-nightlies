#[doc = "Register `MDF_SNPS4DR` reader"]
...
#[doc = "This register is used to read the data processed by each digital filter in snapshot mode.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_snps4dr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_SNPS4DRrs;
impl crate::RegisterSpec for MDF_SNPS4DRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_snps4dr::R`](R) reader structure"]
impl crate::Readable for MDF_SNPS4DRrs {}
#[doc = "`reset()` method sets MDF_SNPS4DR to value 0"]
