///Register `MDF_SNPS5DR` reader
pub type R = crate::R<MDF_SNPS5DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdf_snps5dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#MDF1:MDF_SNPS5DR)*/
pub struct MDF_SNPS5DRrs;
impl crate::RegisterSpec for MDF_SNPS5DRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_snps5dr::R`](R) reader structure
impl crate::Readable for MDF_SNPS5DRrs {}
///`reset()` method sets MDF_SNPS5DR to value 0
impl crate::Resettable for MDF_SNPS5DRrs {
