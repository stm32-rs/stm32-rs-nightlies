#![doc = "Peripheral access API for STM32U545 microcontrollers (generated using svd2rust v0.32.0 (8fe79e6 2024-02-26))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            SEC_DLYBOS: SEC_DLYBOS {
                _marker: PhantomData,
            },
            DLYBSD: DLYBSD {
                _marker: PhantomData,
            },
            SEC_DLYBSD: SEC_DLYBSD {
                _marker: PhantomData,
            },
            EXTI: EXTI {
                _marker: PhantomData,
