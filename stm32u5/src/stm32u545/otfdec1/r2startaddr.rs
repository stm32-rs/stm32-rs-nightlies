///Register `R2STARTADDR` reader
pub type R = crate::R<R2STARTADDRrs>;
///Register `R2STARTADDR` writer
pub type W = crate::W<R2STARTADDRrs>;
///Field `REG2_START_ADDR` reader - Region AXI start address
pub type REG2_START_ADDR_R = crate::FieldReader<u32>;
///Field `REG2_START_ADDR` writer - Region AXI start address
pub type REG2_START_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Region AXI start address
    #[inline(always)]
    pub fn reg2_start_addr(&self) -> REG2_START_ADDR_R {
        REG2_START_ADDR_R::new(self.bits)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("R2STARTADDR")
            .field("reg2_start_addr", &self.reg2_start_addr())
            .finish()
    }
}
impl W {
    ///Bits 0:31 - Region AXI start address
    #[inline(always)]
    pub fn reg2_start_addr(&mut self) -> REG2_START_ADDR_W<'_, R2STARTADDRrs> {
        REG2_START_ADDR_W::new(self, 0)
    }
}
