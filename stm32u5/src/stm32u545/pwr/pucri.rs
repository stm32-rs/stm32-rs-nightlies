...
impl W {
    ...
    ///Bit 12
    #[inline(always)]
    pub fn pu12(&mut self) -> PU12_W<'_, PUCRIrs> {
        PU12_W::new(self, 12)
    }
    ///Bit 13
    #[inline(always)]
    pub fn pu13(&mut self) -> PU13_W<'_, PUCRIrs> {
        PU13_W::new(self, 13)
    }
    ///Bit 14
    #[inline(always)]
    pub fn pu14(&mut self) -> PU14_W<'_, PUCRIrs> {
        PU14_W::new(self, 14)
    }
    ///Bit 15
    #[inline(always)]
    pub fn pu15(&mut self) -> PU15_W<'_, PUCRIrs> {
        PU15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#PWR:PUCRI)*/
pub struct PUCRIrs;
