...
#[doc = "Field `PKARAMPDS` reader - PKA32 SRAM power-down in Stop modes (Stop 0, 1, 2, 3)"]
pub type PKARAMPDS_R = crate::BitReader;
#[doc = "Field `PKARAMPDS` writer - PKA32 SRAM power-down in Stop modes (Stop 0, 1, 2, 3)"]
...
impl R {
    ...
    #[doc = "Bit 12 - PKA32 SRAM power-down in Stop modes (Stop 0, 1, 2, 3)"]
    #[inline(always)]
