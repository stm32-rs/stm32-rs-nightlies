...
impl W {
    ///Bit 0 - LPGPIO1 reset This bit is set and cleared by software.
    #[inline(always)]
    pub fn lpgpio1rst(&mut self) -> LPGPIO1RST_W<'_, AHB3RSTRrs> {
        LPGPIO1RST_W::new(self, 0)
    }
    ///Bit 5 - ADC4 reset This bit is set and cleared by software.
    #[inline(always)]
    pub fn adc4rst(&mut self) -> ADC4RST_W<'_, AHB3RSTRrs> {
        ADC4RST_W::new(self, 5)
    }
    ///Bit 6 - DAC1 reset This bit is set and cleared by software.
    #[inline(always)]
    pub fn dac1rst(&mut self) -> DAC1RST_W<'_, AHB3RSTRrs> {
        DAC1RST_W::new(self, 6)
    }
    ///Bit 9 - LPDMA1 reset This bit is set and cleared by software.
    #[inline(always)]
    pub fn lpdma1rst(&mut self) -> LPDMA1RST_W<'_, AHB3RSTRrs> {
        LPDMA1RST_W::new(self, 9)
    }
    ///Bit 10 - ADF1 reset This bit is set and cleared by software.
    #[inline(always)]
    pub fn adf1rst(&mut self) -> ADF1RST_W<'_, AHB3RSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#RCC:AHB3RSTR)*/
