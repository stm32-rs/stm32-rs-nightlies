...
/**MSI clock range selection This bit is set by software to select the MSIS and MSIK clocks range with MSISRANGE\[3:0\]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MSIRGSEL {
    /**0: MSIS/MSIK ranges provided by MSISSRANGE\[3:0\]
    and MSIKSRANGE\[3:0\]
    in RCC_CSR*/
    Csr = 0,
    /**1: MSIS/MSIK ranges provided by MSISRANGE\[3:0\]
    and MSIKRANGE\[3:0\]
    in RCC_ICSCR1*/
    Icscr1 = 1,
}
...
impl MSIRGSEL_R {
    ...
    /**MSIS/MSIK ranges provided by MSISSRANGE\[3:0\]
    and MSIKSRANGE\[3:0\]
    in RCC_CSR*/
    #[inline(always)]
    ...
    /**MSIS/MSIK ranges provided by MSISRANGE\[3:0\]
    and MSIKRANGE\[3:0\]
    in RCC_ICSCR1*/
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#RCC:ICSCR1)*/
pub struct ICSCR1rs;
