...
#[doc = "Field `SSRUIE` reader - SSRUIE"]
pub type SSRUIE_R = crate::BitReader;
#[doc = "Field `SSRUIE` writer - SSRUIE"]
...
#[doc = "Field `ALRAFCLR` reader - ALRAFCLR"]
pub type ALRAFCLR_R = crate::BitReader;
#[doc = "Field `ALRAFCLR` writer - ALRAFCLR"]
pub type ALRAFCLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ALRBFCLR` reader - ALRBFCLR"]
pub type ALRBFCLR_R = crate::BitReader;
#[doc = "Field `ALRBFCLR` writer - ALRBFCLR"]
