...
#[doc = "Field `CKSTOPIE` reader - Voltage Switch clock stopped interrupt enable"]
pub type CKSTOPIE_R = crate::BitReader;
#[doc = "Field `CKSTOPIE` writer - Voltage Switch clock stopped interrupt enable"]
pub type CKSTOPIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IDMABTCIE` reader - IDMA buffer transfer complete interrupt enable"]
pub type IDMABTCIE_R = crate::BitReader;
#[doc = "Field `IDMABTCIE` writer - IDMA buffer transfer complete interrupt enable"]
...
impl R {
    ...
    #[doc = "Bit 26 - Voltage Switch clock stopped interrupt enable"]
    #[inline(always)]
    pub fn ckstopie(&self) -> CKSTOPIE_R {
        CKSTOPIE_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 28 - IDMA buffer transfer complete interrupt enable"]
    #[inline(always)]
