...
///Field `DPXPIE` reader - DXP interrupt enabled
pub type DPXPIE_R = crate::BitReader;
///Field `DPXPIE` writer - DXP interrupt enabled
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#SPI1:IER)*/
pub struct IERrs;
