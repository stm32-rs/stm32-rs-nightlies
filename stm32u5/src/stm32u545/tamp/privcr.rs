...
impl W {
    ///Bit 15 - CNT1PRIV
    #[inline(always)]
    pub fn cnt1priv(&mut self) -> CNT1PRIV_W<'_, PRIVCRrs> {
        CNT1PRIV_W::new(self, 15)
    }
    ///Bit 29 - BKPRWPRIV
    #[inline(always)]
    pub fn bkprwpriv(&mut self) -> BKPRWPRIV_W<'_, PRIVCRrs> {
        BKPRWPRIV_W::new(self, 29)
    }
    ///Bit 30 - BKPWPRIV
    #[inline(always)]
    pub fn bkpwpriv(&mut self) -> BKPWPRIV_W<'_, PRIVCRrs> {
        BKPWPRIV_W::new(self, 30)
    }
    ///Bit 31 - TAMPPRIV
    #[inline(always)]
    pub fn tamppriv(&mut self) -> TAMPPRIV_W<'_, PRIVCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U545.html#TAMP:PRIVCR)*/
pub struct PRIVCRrs;
