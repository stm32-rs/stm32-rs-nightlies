///Register `DAC_DHR8R1` reader
pub type R = crate::R<DAC_DHR8R1rs>;
///Register `DAC_DHR8R1` writer
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dacc1dhrb(&mut self) -> DACC1DHRB_W<DAC_DHR8R1rs> {
        DACC1DHRB_W::new(self, 8)
    }
}
/**DAC channel1 8-bit right aligned data holding register

You can [`read`](crate::Reg::read) this register and get [`dac_dhr8r1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dac_dhr8r1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dac_dhr8r1::R`](R) reader structure
impl crate::Readable for DAC_DHR8R1rs {}
///`write(|w| ..)` method takes [`dac_dhr8r1::W`](W) writer structure
impl crate::Writable for DAC_DHR8R1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DAC_DHR8R1 to value 0
