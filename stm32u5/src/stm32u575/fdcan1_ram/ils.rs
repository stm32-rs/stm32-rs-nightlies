...
impl W {
    ///Bit 0 - RxFIFO0
    #[inline(always)]
    pub fn rx_fifo0(&mut self) -> RX_FIFO0_W<'_, ILSrs> {
        RX_FIFO0_W::new(self, 0)
    }
    ///Bit 1 - RxFIFO1
    #[inline(always)]
    pub fn rx_fifo1(&mut self) -> RX_FIFO1_W<'_, ILSrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#FDCAN1_RAM:ILS)*/
pub struct ILSrs;
