...
impl R {
    #[doc = "Bits 0:6 - bank 1 WPR first area A start page This field contains the first page of the first WPR area for bank 1."]
    #[inline(always)]
    pub fn wrp1a_pstrt(&self) -> WRP1A_PSTRT_R {
        WRP1A_PSTRT_R::new((self.bits & 0x7f) as u8)
    }
    #[doc = "Bits 16:22 - Bank 1 WPR first area A end page This field contains the last page of the first WPR area in bank 1."]
    #[inline(always)]
