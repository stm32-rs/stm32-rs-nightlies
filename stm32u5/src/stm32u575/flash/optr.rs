...
impl W {
    ...
    ///Bit 15 - SRAM1, SRAM3 and SRAM4 erase upon system reset
    #[inline(always)]
    pub fn sram1345_rst(&mut self) -> SRAM1345_RST_W<'_, OPTRrs> {
    ...
    ///Bit 22 - Backup RAM ECC detection and correction enable
    #[inline(always)]
    pub fn bkpram_ecc(&mut self) -> BKPRAM_ECC_W<'_, OPTRrs> {
        BKPRAM_ECC_W::new(self, 22)
    }
    ///Bit 23 - SRAM3 ECC detection and correction enable
    #[inline(always)]
    pub fn sram3_ecc(&mut self) -> SRAM3_ECC_W<'_, OPTRrs> {
        SRAM3_ECC_W::new(self, 23)
    }
    ///Bit 24 - SRAM2 ECC detection and correction enable
    #[inline(always)]
    pub fn sram2_ecc(&mut self) -> SRAM2_ECC_W<'_, OPTRrs> {
    ...
    ///Bit 29 - High-speed IO at low VDD voltage configuration bit This bit can be set only with VDD below 2.5V
    #[inline(always)]
    pub fn io_vdd_hslv(&mut self) -> IO_VDD_HSLV_W<'_, OPTRrs> {
        IO_VDD_HSLV_W::new(self, 29)
    }
    ///Bit 30 - High-speed IO at low VDDIO2 voltage configuration bit This bit can be set only with VDDIO2 below 2.5 V.
    #[inline(always)]
    pub fn io_vddio2_hslv(&mut self) -> IO_VDDIO2_HSLV_W<'_, OPTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#FLASH:OPTR)*/
pub struct OPTRrs;
