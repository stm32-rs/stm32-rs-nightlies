///Register `PRIV1BBR4` reader
pub type R = crate::R<PRIV1BBR4rs>;
///Register `PRIV1BBR4` writer
pub type W = crate::W<PRIV1BBR4rs>;
...
impl W {
    ///Bit 0 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb0(&mut self) -> PRIV1BB0_W<'_, PRIV1BBR4rs> {
        PRIV1BB0_W::new(self, 0)
    }
    ///Bit 1 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb1(&mut self) -> PRIV1BB1_W<'_, PRIV1BBR4rs> {
        PRIV1BB1_W::new(self, 1)
    }
    ///Bit 2 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb2(&mut self) -> PRIV1BB2_W<'_, PRIV1BBR4rs> {
        PRIV1BB2_W::new(self, 2)
    }
    ///Bit 3 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb3(&mut self) -> PRIV1BB3_W<'_, PRIV1BBR4rs> {
        PRIV1BB3_W::new(self, 3)
    }
    ///Bit 4 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb4(&mut self) -> PRIV1BB4_W<'_, PRIV1BBR4rs> {
        PRIV1BB4_W::new(self, 4)
    }
    ///Bit 5 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb5(&mut self) -> PRIV1BB5_W<'_, PRIV1BBR4rs> {
        PRIV1BB5_W::new(self, 5)
    }
    ///Bit 6 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb6(&mut self) -> PRIV1BB6_W<'_, PRIV1BBR4rs> {
        PRIV1BB6_W::new(self, 6)
    }
    ///Bit 7 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb7(&mut self) -> PRIV1BB7_W<'_, PRIV1BBR4rs> {
        PRIV1BB7_W::new(self, 7)
    }
    ///Bit 8 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb8(&mut self) -> PRIV1BB8_W<'_, PRIV1BBR4rs> {
        PRIV1BB8_W::new(self, 8)
    }
    ///Bit 9 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb9(&mut self) -> PRIV1BB9_W<'_, PRIV1BBR4rs> {
        PRIV1BB9_W::new(self, 9)
    }
    ///Bit 10 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb10(&mut self) -> PRIV1BB10_W<'_, PRIV1BBR4rs> {
        PRIV1BB10_W::new(self, 10)
    }
    ///Bit 11 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb11(&mut self) -> PRIV1BB11_W<'_, PRIV1BBR4rs> {
        PRIV1BB11_W::new(self, 11)
    }
    ///Bit 12 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb12(&mut self) -> PRIV1BB12_W<'_, PRIV1BBR4rs> {
        PRIV1BB12_W::new(self, 12)
    }
    ///Bit 13 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb13(&mut self) -> PRIV1BB13_W<'_, PRIV1BBR4rs> {
        PRIV1BB13_W::new(self, 13)
    }
    ///Bit 14 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb14(&mut self) -> PRIV1BB14_W<'_, PRIV1BBR4rs> {
        PRIV1BB14_W::new(self, 14)
    }
    ///Bit 15 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb15(&mut self) -> PRIV1BB15_W<'_, PRIV1BBR4rs> {
        PRIV1BB15_W::new(self, 15)
    }
    ///Bit 16 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb16(&mut self) -> PRIV1BB16_W<'_, PRIV1BBR4rs> {
        PRIV1BB16_W::new(self, 16)
    }
    ///Bit 17 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb17(&mut self) -> PRIV1BB17_W<'_, PRIV1BBR4rs> {
        PRIV1BB17_W::new(self, 17)
    }
    ///Bit 18 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb18(&mut self) -> PRIV1BB18_W<'_, PRIV1BBR4rs> {
        PRIV1BB18_W::new(self, 18)
    }
    ///Bit 19 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb19(&mut self) -> PRIV1BB19_W<'_, PRIV1BBR4rs> {
        PRIV1BB19_W::new(self, 19)
    }
    ///Bit 20 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb20(&mut self) -> PRIV1BB20_W<'_, PRIV1BBR4rs> {
        PRIV1BB20_W::new(self, 20)
    }
    ///Bit 21 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb21(&mut self) -> PRIV1BB21_W<'_, PRIV1BBR4rs> {
        PRIV1BB21_W::new(self, 21)
    }
    ///Bit 22 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb22(&mut self) -> PRIV1BB22_W<'_, PRIV1BBR4rs> {
        PRIV1BB22_W::new(self, 22)
    }
    ///Bit 23 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb23(&mut self) -> PRIV1BB23_W<'_, PRIV1BBR4rs> {
        PRIV1BB23_W::new(self, 23)
    }
    ///Bit 24 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb24(&mut self) -> PRIV1BB24_W<'_, PRIV1BBR4rs> {
        PRIV1BB24_W::new(self, 24)
    }
    ///Bit 25 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb25(&mut self) -> PRIV1BB25_W<'_, PRIV1BBR4rs> {
        PRIV1BB25_W::new(self, 25)
    }
    ///Bit 26 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb26(&mut self) -> PRIV1BB26_W<'_, PRIV1BBR4rs> {
        PRIV1BB26_W::new(self, 26)
    }
    ///Bit 27 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb27(&mut self) -> PRIV1BB27_W<'_, PRIV1BBR4rs> {
        PRIV1BB27_W::new(self, 27)
    }
    ///Bit 28 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb28(&mut self) -> PRIV1BB28_W<'_, PRIV1BBR4rs> {
        PRIV1BB28_W::new(self, 28)
    }
    ///Bit 29 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb29(&mut self) -> PRIV1BB29_W<'_, PRIV1BBR4rs> {
        PRIV1BB29_W::new(self, 29)
    }
    ///Bit 30 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb30(&mut self) -> PRIV1BB30_W<'_, PRIV1BBR4rs> {
        PRIV1BB30_W::new(self, 30)
    }
    ///Bit 31 - page privileged/unprivileged attribution
    #[inline(always)]
    pub fn priv1bb31(&mut self) -> PRIV1BB31_W<'_, PRIV1BBR4rs> {
        PRIV1BB31_W::new(self, 31)
    }
}
/**FLASH privilege block based bank 1 register 4

You can [`read`](crate::Reg::read) this register and get [`priv1bbr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`priv1bbr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#FLASH:PRIV1BBR4)*/
pub struct PRIV1BBR4rs;
impl crate::RegisterSpec for PRIV1BBR4rs {
    type Ux = u32;
}
///`read()` method returns [`priv1bbr4::R`](R) reader structure
impl crate::Readable for PRIV1BBR4rs {}
///`write(|w| ..)` method takes [`priv1bbr4::W`](W) writer structure
impl crate::Writable for PRIV1BBR4rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PRIV1BBR4 to value 0
impl crate::Resettable for PRIV1BBR4rs {}
