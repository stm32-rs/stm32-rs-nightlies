///Register `SEC2BBR2` reader
pub type R = crate::R<SEC2BBR2rs>;
///Register `SEC2BBR2` writer
pub type W = crate::W<SEC2BBR2rs>;
...
impl W {
    ///Bit 0 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb0(&mut self) -> SEC2BB0_W<'_, SEC2BBR2rs> {
        SEC2BB0_W::new(self, 0)
    }
    ///Bit 1 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb1(&mut self) -> SEC2BB1_W<'_, SEC2BBR2rs> {
        SEC2BB1_W::new(self, 1)
    }
    ///Bit 2 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb2(&mut self) -> SEC2BB2_W<'_, SEC2BBR2rs> {
        SEC2BB2_W::new(self, 2)
    }
    ///Bit 3 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb3(&mut self) -> SEC2BB3_W<'_, SEC2BBR2rs> {
        SEC2BB3_W::new(self, 3)
    }
    ///Bit 4 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb4(&mut self) -> SEC2BB4_W<'_, SEC2BBR2rs> {
        SEC2BB4_W::new(self, 4)
    }
    ///Bit 5 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb5(&mut self) -> SEC2BB5_W<'_, SEC2BBR2rs> {
        SEC2BB5_W::new(self, 5)
    }
    ///Bit 6 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb6(&mut self) -> SEC2BB6_W<'_, SEC2BBR2rs> {
        SEC2BB6_W::new(self, 6)
    }
    ///Bit 7 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb7(&mut self) -> SEC2BB7_W<'_, SEC2BBR2rs> {
        SEC2BB7_W::new(self, 7)
    }
    ///Bit 8 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb8(&mut self) -> SEC2BB8_W<'_, SEC2BBR2rs> {
        SEC2BB8_W::new(self, 8)
    }
    ///Bit 9 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb9(&mut self) -> SEC2BB9_W<'_, SEC2BBR2rs> {
        SEC2BB9_W::new(self, 9)
    }
    ///Bit 10 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb10(&mut self) -> SEC2BB10_W<'_, SEC2BBR2rs> {
        SEC2BB10_W::new(self, 10)
    }
    ///Bit 11 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb11(&mut self) -> SEC2BB11_W<'_, SEC2BBR2rs> {
        SEC2BB11_W::new(self, 11)
    }
    ///Bit 12 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb12(&mut self) -> SEC2BB12_W<'_, SEC2BBR2rs> {
        SEC2BB12_W::new(self, 12)
    }
    ///Bit 13 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb13(&mut self) -> SEC2BB13_W<'_, SEC2BBR2rs> {
        SEC2BB13_W::new(self, 13)
    }
    ///Bit 14 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb14(&mut self) -> SEC2BB14_W<'_, SEC2BBR2rs> {
        SEC2BB14_W::new(self, 14)
    }
    ///Bit 15 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb15(&mut self) -> SEC2BB15_W<'_, SEC2BBR2rs> {
        SEC2BB15_W::new(self, 15)
    }
    ///Bit 16 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb16(&mut self) -> SEC2BB16_W<'_, SEC2BBR2rs> {
        SEC2BB16_W::new(self, 16)
    }
    ///Bit 17 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb17(&mut self) -> SEC2BB17_W<'_, SEC2BBR2rs> {
        SEC2BB17_W::new(self, 17)
    }
    ///Bit 18 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb18(&mut self) -> SEC2BB18_W<'_, SEC2BBR2rs> {
        SEC2BB18_W::new(self, 18)
    }
    ///Bit 19 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb19(&mut self) -> SEC2BB19_W<'_, SEC2BBR2rs> {
        SEC2BB19_W::new(self, 19)
    }
    ///Bit 20 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb20(&mut self) -> SEC2BB20_W<'_, SEC2BBR2rs> {
        SEC2BB20_W::new(self, 20)
    }
    ///Bit 21 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb21(&mut self) -> SEC2BB21_W<'_, SEC2BBR2rs> {
        SEC2BB21_W::new(self, 21)
    }
    ///Bit 22 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb22(&mut self) -> SEC2BB22_W<'_, SEC2BBR2rs> {
        SEC2BB22_W::new(self, 22)
    }
    ///Bit 23 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb23(&mut self) -> SEC2BB23_W<'_, SEC2BBR2rs> {
        SEC2BB23_W::new(self, 23)
    }
    ///Bit 24 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb24(&mut self) -> SEC2BB24_W<'_, SEC2BBR2rs> {
        SEC2BB24_W::new(self, 24)
    }
    ///Bit 25 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb25(&mut self) -> SEC2BB25_W<'_, SEC2BBR2rs> {
        SEC2BB25_W::new(self, 25)
    }
    ///Bit 26 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb26(&mut self) -> SEC2BB26_W<'_, SEC2BBR2rs> {
        SEC2BB26_W::new(self, 26)
    }
    ///Bit 27 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb27(&mut self) -> SEC2BB27_W<'_, SEC2BBR2rs> {
        SEC2BB27_W::new(self, 27)
    }
    ///Bit 28 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb28(&mut self) -> SEC2BB28_W<'_, SEC2BBR2rs> {
        SEC2BB28_W::new(self, 28)
    }
    ///Bit 29 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb29(&mut self) -> SEC2BB29_W<'_, SEC2BBR2rs> {
        SEC2BB29_W::new(self, 29)
    }
    ///Bit 30 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb30(&mut self) -> SEC2BB30_W<'_, SEC2BBR2rs> {
        SEC2BB30_W::new(self, 30)
    }
    ///Bit 31 - page secure/non-secure attribution
    #[inline(always)]
    pub fn sec2bb31(&mut self) -> SEC2BB31_W<'_, SEC2BBR2rs> {
        SEC2BB31_W::new(self, 31)
    }
}
/**FLASH secure block based bank 2 register 2

You can [`read`](crate::Reg::read) this register and get [`sec2bbr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sec2bbr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#FLASH:SEC2BBR2)*/
pub struct SEC2BBR2rs;
impl crate::RegisterSpec for SEC2BBR2rs {
    type Ux = u32;
}
///`read()` method returns [`sec2bbr2::R`](R) reader structure
impl crate::Readable for SEC2BBR2rs {}
///`write(|w| ..)` method takes [`sec2bbr2::W`](W) writer structure
impl crate::Writable for SEC2BBR2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SEC2BBR2 to value 0
impl crate::Resettable for SEC2BBR2rs {}
