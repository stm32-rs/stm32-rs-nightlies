#[doc = "Register `GPDMA_C0SR` reader"]
...
#[doc = "GPDMA channel 0 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c0sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C0SRrs;
impl crate::RegisterSpec for GPDMA_C0SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c0sr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C0SRrs {}
#[doc = "`reset()` method sets GPDMA_C0SR to value 0x01"]
