#[doc = "Register `GPDMA_C12TR2` reader"]
pub type R = crate::R<GPDMA_C12TR2rs>;
#[doc = "Register `GPDMA_C12TR2` writer"]
pub type W = crate::W<GPDMA_C12TR2rs>;
...
value) to different active GPDMA channels (GPDMA_CxCR.EN = 1 and GPDMA_CxTR2.SWREQ = 0 for these channels). GPDMA is not intended to hardware support the case of simultaneous enabled channels incorrectly configured with a same hardware peripheral request signal, and there is no user setting error reporting."]
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> REQSEL_W<GPDMA_C12TR2rs> {
        REQSEL_W::new(self, 0)
    }
    #[doc = "Bit 9 - software request This bit is internally taken into account when GPDMA_CxCR.EN is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn swreq(&mut self) -> SWREQ_W<GPDMA_C12TR2rs> {
        SWREQ_W::new(self, 9)
    }
    #[doc = "Bit 10 - destination hardware request This bit is ignored if channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer). Else: Note:"]
    #[inline(always)]
    #[must_use]
    pub fn dreq(&mut self) -> DREQ_W<GPDMA_C12TR2rs> {
        DREQ_W::new(self, 10)
    }
    #[doc = "Bit 11 - Block hardware request If the channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer), this bit is ignored. Else:"]
    #[inline(always)]
    #[must_use]
    pub fn breq(&mut self) -> BREQ_W<GPDMA_C12TR2rs> {
        BREQ_W::new(self, 11)
    }
    #[doc = "Bits 14:15 - trigger mode These bits define the transfer granularity for its conditioning by the trigger. If the channel x is enabled (GPDMA_CxCR.EN asserted) with TRIGPOL\\[1:0\\]
= 00 or 11, these TRIGM\\[1:0\\]
...
= 11 and SWREQ = 0 and DREQ = 1), this shortened destination burst transfer is conditioned once by the trigger."]
    #[inline(always)]
    #[must_use]
    pub fn trigm(&mut self) -> TRIGM_W<GPDMA_C12TR2rs> {
        TRIGM_W::new(self, 14)
    }
    #[doc = "Bits 16:21 - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per ), with an active trigger event if TRIGPOL\\[1:0\\]
≠ 00."]
    #[inline(always)]
    #[must_use]
    pub fn trigsel(&mut self) -> TRIGSEL_W<GPDMA_C12TR2rs> {
        TRIGSEL_W::new(self, 16)
    }
    #[doc = "Bits 24:25 - trigger event polarity These bits define the polarity of the selected trigger event input defined by TRIGSEL\\[5:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn trigpol(&mut self) -> TRIGPOL_W<GPDMA_C12TR2rs> {
...
=0 ), then the half transfer event is not generated, and the transfer complete event is generated when is completed the loading of the LLI1."]
    #[inline(always)]
    #[must_use]
    pub fn tcem(&mut self) -> TCEM_W<GPDMA_C12TR2rs> {
        TCEM_W::new(self, 30)
    }
}
#[doc = "GPDMA channel 12 transfer register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c12tr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c12tr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C12TR2rs;
impl crate::RegisterSpec for GPDMA_C12TR2rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c12tr2::R`](R) reader structure"]
impl crate::Readable for GPDMA_C12TR2rs {}
#[doc = "`write(|w| ..)` method takes [`gpdma_c12tr2::W`](W) writer structure"]
impl crate::Writable for GPDMA_C12TR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C12TR2 to value 0"]
impl crate::Resettable for GPDMA_C12TR2rs {
