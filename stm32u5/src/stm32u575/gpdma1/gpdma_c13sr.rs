#[doc = "Register `GPDMA_C13SR` reader"]
...
#[doc = "GPDMA channel 13 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c13sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C13SRrs;
impl crate::RegisterSpec for GPDMA_C13SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c13sr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C13SRrs {}
#[doc = "`reset()` method sets GPDMA_C13SR to value 0x01"]
