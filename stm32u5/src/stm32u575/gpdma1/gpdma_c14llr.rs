#[doc = "Register `GPDMA_C14LLR` reader"]
pub type R = crate::R<GPDMA_C14LLRrs>;
#[doc = "Register `GPDMA_C14LLR` writer"]
...
#[doc = "GPDMA channel 14 alternate linked-list address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c14llr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c14llr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C14LLRrs;
impl crate::RegisterSpec for GPDMA_C14LLRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c14llr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C14LLRrs {}
#[doc = "`write(|w| ..)` method takes [`gpdma_c14llr::W`](W) writer structure"]
impl crate::Writable for GPDMA_C14LLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C14LLR to value 0"]
