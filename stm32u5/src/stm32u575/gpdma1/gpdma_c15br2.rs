#[doc = "Register `GPDMA_C15BR2` reader"]
pub type R = crate::R<GPDMA_C15BR2rs>;
#[doc = "Register `GPDMA_C15BR2` writer"]
pub type W = crate::W<GPDMA_C15BR2rs>;
...
versus GPDMA_CxTR1.SDW_LOG2\\[1:0\\]). Else a user setting error is reported and no transfer is issued."]
    #[inline(always)]
    #[must_use]
    pub fn brsao(&mut self) -> BRSAO_W<GPDMA_C15BR2rs> {
        BRSAO_W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Block repeated destination address offset For a channel with 2D addressing capability, this field is used to update (by addition or subtraction depending on GPDMA_CxBR1.BRDDEC) the current destination address (GPDMA_CxDAR) at the end of a block transfer. Note: A block repeated destination address offset must be aligned with the programmed data width of a destination burst (BRDAO\\[2:0\\]
versus GPDMA_CxTR1.DDW_LOG2\\[1:0\\]). Else a user setting error is reported and no transfer is issued."]
    #[inline(always)]
    #[must_use]
    pub fn brdao(&mut self) -> BRDAO_W<GPDMA_C15BR2rs> {
        BRDAO_W::new(self, 16)
    }
}
#[doc = "GPDMA channel 15 block register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c15br2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c15br2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C15BR2rs;
impl crate::RegisterSpec for GPDMA_C15BR2rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c15br2::R`](R) reader structure"]
impl crate::Readable for GPDMA_C15BR2rs {}
#[doc = "`write(|w| ..)` method takes [`gpdma_c15br2::W`](W) writer structure"]
impl crate::Writable for GPDMA_C15BR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C15BR2 to value 0"]
impl crate::Resettable for GPDMA_C15BR2rs {
