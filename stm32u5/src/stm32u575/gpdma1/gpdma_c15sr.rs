#[doc = "Register `GPDMA_C15SR` reader"]
...
#[doc = "GPDMA channel 15 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c15sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C15SRrs;
impl crate::RegisterSpec for GPDMA_C15SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c15sr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C15SRrs {}
#[doc = "`reset()` method sets GPDMA_C15SR to value 0x01"]
