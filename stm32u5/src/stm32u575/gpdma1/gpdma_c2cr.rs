#[doc = "Register `GPDMA_C2CR` reader"]
pub type R = crate::R<GPDMA_C2CRrs>;
#[doc = "Register `GPDMA_C2CR` writer"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn toie(&mut self) -> TOIE_W<GPDMA_C2CRrs> {
        TOIE_W::new(self, 14)
    }
    #[doc = "Bit 16 - Link step mode First the (possible 1D/repeated) block transfer is executed as defined by the current internal register file until GPDMA_CxBR1.BNDT\\[15:0\\]
= 0 and GPDMA_CxBR1.BRC\\[10:0\\]
...
#[doc = "GPDMA channel 2 control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c2cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c2cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C2CRrs;
impl crate::RegisterSpec for GPDMA_C2CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c2cr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C2CRrs {}
#[doc = "`write(|w| ..)` method takes [`gpdma_c2cr::W`](W) writer structure"]
impl crate::Writable for GPDMA_C2CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C2CR to value 0"]
