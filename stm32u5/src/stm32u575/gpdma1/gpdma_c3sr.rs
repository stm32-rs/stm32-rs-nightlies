#[doc = "Register `GPDMA_C3SR` reader"]
...
#[doc = "GPDMA channel 3 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c3sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C3SRrs;
impl crate::RegisterSpec for GPDMA_C3SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c3sr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C3SRrs {}
#[doc = "`reset()` method sets GPDMA_C3SR to value 0x01"]
