#[doc = "Register `GPDMA_C4DAR` reader"]
pub type R = crate::R<GPDMA_C4DARrs>;
#[doc = "Register `GPDMA_C4DAR` writer"]
...
#[doc = "GPDMA channel 4 destination address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c4dar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c4dar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C4DARrs;
impl crate::RegisterSpec for GPDMA_C4DARrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c4dar::R`](R) reader structure"]
impl crate::Readable for GPDMA_C4DARrs {}
#[doc = "`write(|w| ..)` method takes [`gpdma_c4dar::W`](W) writer structure"]
impl crate::Writable for GPDMA_C4DARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C4DAR to value 0"]
