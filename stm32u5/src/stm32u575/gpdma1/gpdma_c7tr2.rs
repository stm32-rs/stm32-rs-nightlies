///Register `GPDMA_C7TR2` reader
pub type R = crate::R<GPDMA_C7TR2rs>;
///Register `GPDMA_C7TR2` writer
pub type W = crate::W<GPDMA_C7TR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> REQSEL_W<GPDMA_C7TR2rs> {
        REQSEL_W::new(self, 0)
    }
    ///Bit 9 - software request This bit is internally taken into account when GPDMA_CxCR.EN is asserted.
    #[inline(always)]
    #[must_use]
    pub fn swreq(&mut self) -> SWREQ_W<GPDMA_C7TR2rs> {
        SWREQ_W::new(self, 9)
    }
    ///Bit 10 - destination hardware request This bit is ignored if channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer). Else: Note:
    #[inline(always)]
    #[must_use]
    pub fn dreq(&mut self) -> DREQ_W<GPDMA_C7TR2rs> {
        DREQ_W::new(self, 10)
    }
    ///Bit 11 - Block hardware request If the channel x is activated (GPDMA_CxCR.EN asserted) with SWREQ = 1 (software request for a memory-to-memory transfer), this bit is ignored. Else:
    #[inline(always)]
    #[must_use]
    pub fn breq(&mut self) -> BREQ_W<GPDMA_C7TR2rs> {
        BREQ_W::new(self, 11)
    }
    /**Bits 14:15 - trigger mode These bits define the transfer granularity for its conditioning by the trigger. If the channel x is enabled (GPDMA_CxCR.EN asserted) with TRIGPOL\[1:0\]
    = 00 or 11, these TRIGM\[1:0\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn trigm(&mut self) -> TRIGM_W<GPDMA_C7TR2rs> {
        TRIGM_W::new(self, 14)
    }
    /**Bits 16:21 - trigger event input selection These bits select the trigger event input of the GPDMA transfer (as per ), with an active trigger event if TRIGPOL\[1:0\]
    ≠ 00.*/
    #[inline(always)]
    #[must_use]
    pub fn trigsel(&mut self) -> TRIGSEL_W<GPDMA_C7TR2rs> {
        TRIGSEL_W::new(self, 16)
    }
    ///Bits 24:25 - trigger event polarity These bits define the polarity of the selected trigger event input defined by TRIGSEL\[5:0\].
    #[inline(always)]
    #[must_use]
    pub fn trigpol(&mut self) -> TRIGPOL_W<GPDMA_C7TR2rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcem(&mut self) -> TCEM_W<GPDMA_C7TR2rs> {
        TCEM_W::new(self, 30)
    }
}
/**GPDMA channel 7 transfer register 2

You can [`read`](crate::Reg::read) this register and get [`gpdma_c7tr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c7tr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#GPDMA1:GPDMA_C7TR2)*/
pub struct GPDMA_C7TR2rs;
impl crate::RegisterSpec for GPDMA_C7TR2rs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c7tr2::R`](R) reader structure
impl crate::Readable for GPDMA_C7TR2rs {}
///`write(|w| ..)` method takes [`gpdma_c7tr2::W`](W) writer structure
impl crate::Writable for GPDMA_C7TR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C7TR2 to value 0
impl crate::Resettable for GPDMA_C7TR2rs {
