///Register `GPDMA_C9LLR` reader
pub type R = crate::R<GPDMA_C9LLRrs>;
///Register `GPDMA_C9LLR` writer
pub type W = crate::W<GPDMA_C9LLRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn la(&mut self) -> LA_W<GPDMA_C9LLRrs> {
        LA_W::new(self, 2)
    }
    ///Bit 16 - Update GPDMA_CxLLR register from memory This bit is used to control the update of GPDMA_CxLLR from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn ull(&mut self) -> ULL_W<GPDMA_C9LLRrs> {
        ULL_W::new(self, 16)
    }
    ///Bit 27 - Update GPDMA_CxDAR register from memory This bit is used to control the update of GPDMA_CxDAR from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn uda(&mut self) -> UDA_W<GPDMA_C9LLRrs> {
        UDA_W::new(self, 27)
    }
    ///Bit 28 - update GPDMA_CxSAR from memory This bit controls the update of GPDMA_CxSAR from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn usa(&mut self) -> USA_W<GPDMA_C9LLRrs> {
        USA_W::new(self, 28)
    }
    /**Bit 29 - Update GPDMA_CxBR1 from memory This bit controls the update of GPDMA_CxBR1 from the memory during the link transfer. If UB1 = 0 and if GPDMA_CxLLR ≠ 0, the linked-list is not completed. GPDMA_CxBR1.BNDT\[15:0\]
    is then restored to the programmed value after data transfer is completed and before the link transfer.*/
    #[inline(always)]
    #[must_use]
    pub fn ub1(&mut self) -> UB1_W<GPDMA_C9LLRrs> {
        UB1_W::new(self, 29)
    }
    ///Bit 30 - Update GPDMA_CxTR2 from memory This bit controls the update of GPDMA_CxTR2 from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn ut2(&mut self) -> UT2_W<GPDMA_C9LLRrs> {
        UT2_W::new(self, 30)
    }
    ///Bit 31 - Update GPDMA_CxTR1 from memory This bit controls the update of GPDMA_CxTR1 from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn ut1(&mut self) -> UT1_W<GPDMA_C9LLRrs> {
        UT1_W::new(self, 31)
    }
}
/**GPDMA channel 9 linked-list address register

You can [`read`](crate::Reg::read) this register and get [`gpdma_c9llr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c9llr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#GPDMA1:GPDMA_C9LLR)*/
pub struct GPDMA_C9LLRrs;
impl crate::RegisterSpec for GPDMA_C9LLRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c9llr::R`](R) reader structure
impl crate::Readable for GPDMA_C9LLRrs {}
///`write(|w| ..)` method takes [`gpdma_c9llr::W`](W) writer structure
impl crate::Writable for GPDMA_C9LLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C9LLR to value 0
impl crate::Resettable for GPDMA_C9LLRrs {
