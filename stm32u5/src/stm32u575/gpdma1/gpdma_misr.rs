#[doc = "Register `GPDMA_MISR` reader"]
...
#[doc = "GPDMA non-secure masked interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_misr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_MISRrs;
impl crate::RegisterSpec for GPDMA_MISRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_misr::R`](R) reader structure"]
impl crate::Readable for GPDMA_MISRrs {}
#[doc = "`reset()` method sets GPDMA_MISR to value 0"]
