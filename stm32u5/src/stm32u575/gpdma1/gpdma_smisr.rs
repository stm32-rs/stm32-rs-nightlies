#[doc = "Register `GPDMA_SMISR` reader"]
...
#[doc = "GPDMA secure masked interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_smisr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_SMISRrs;
impl crate::RegisterSpec for GPDMA_SMISRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_smisr::R`](R) reader structure"]
impl crate::Readable for GPDMA_SMISRrs {}
#[doc = "`reset()` method sets GPDMA_SMISR to value 0"]
