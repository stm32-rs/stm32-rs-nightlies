///Register `GPIO_PUPDR` reader
pub type R = crate::R<GPIO_PUPDRrs>;
///Register `GPIO_PUPDR` writer
...
You can [`read`](crate::Reg::read) this register and get [`gpio_pupdr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio_pupdr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#GPIOA:GPIO_PUPDR)*/
pub struct GPIO_PUPDRrs;
impl crate::RegisterSpec for GPIO_PUPDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpio_pupdr::R`](R) reader structure
impl crate::Readable for GPIO_PUPDRrs {}
///`write(|w| ..)` method takes [`gpio_pupdr::W`](W) writer structure
impl crate::Writable for GPIO_PUPDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO_PUPDR to value 0x6400_0000
