...
pub use crate::stm32u575::gpioa::ospeedr::OSPEED_R;
///Field `OSPEED(0-15)` writer - Port x configuration pin %s
pub use crate::stm32u575::gpioa::ospeedr::OSPEED_W;
///Port x configuration pin %s
pub use crate::stm32u575::gpioa::ospeedr::OUTPUT_SPEED;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#GPIOI:OSPEEDR)*/
