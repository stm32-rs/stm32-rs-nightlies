///Register `MPCBB2_SECCFGR25` reader
pub type R = crate::R<MPCBB2_SECCFGR25rs>;
///Register `MPCBB2_SECCFGR25` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB2_SECCFGR25")
...
You can [`read`](crate::Reg::read) this register and get [`mpcbb2_seccfgr25::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb2_seccfgr25::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mpcbb2_seccfgr25::R`](R) reader structure
impl crate::Readable for MPCBB2_SECCFGR25rs {}
///`write(|w| ..)` method takes [`mpcbb2_seccfgr25::W`](W) writer structure
impl crate::Writable for MPCBB2_SECCFGR25rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB2_SECCFGR25 to value 0xffff_ffff
