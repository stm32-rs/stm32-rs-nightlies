#[doc = "Register `MPCBB3_CR` reader"]
pub type R = crate::R<MPCBB3_CRrs>;
#[doc = "Register `MPCBB3_CR` writer"]
...
#[doc = "MPCBB control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcbb3_cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcbb3_cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPCBB3_CRrs;
impl crate::RegisterSpec for MPCBB3_CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpcbb3_cr::R`](R) reader structure"]
impl crate::Readable for MPCBB3_CRrs {}
#[doc = "`write(|w| ..)` method takes [`mpcbb3_cr::W`](W) writer structure"]
impl crate::Writable for MPCBB3_CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPCBB3_CR to value 0"]
