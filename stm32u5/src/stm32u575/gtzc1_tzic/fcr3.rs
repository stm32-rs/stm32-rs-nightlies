...
impl W {
    ...
    #[inline(always)]
    pub fn cadc1f(&mut self) -> CADC1F_W<'_, FCR3rs> {
        CADC1F_W::new(self, 8)
    }
    ...
    #[inline(always)]
    pub fn cotgfsf(&mut self) -> COTGFSF_W<'_, FCR3rs> {
    ...
    #[inline(always)]
    pub fn cfsmcf(&mut self) -> CFSMCF_W<'_, FCR3rs> {
    ...
    #[inline(always)]
    pub fn coctospi2f(&mut self) -> COCTOSPI2F_W<'_, FCR3rs> {
