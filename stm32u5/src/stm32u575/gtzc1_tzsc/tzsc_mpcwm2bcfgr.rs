#[doc = "Register `TZSC_MPCWM2BCFGR` reader"]
pub type R = crate::R<TZSC_MPCWM2BCFGRrs>;
#[doc = "Register `TZSC_MPCWM2BCFGR` writer"]
...
#[doc = "TZSC memory 2 sub-region B watermark configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tzsc_mpcwm2bcfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tzsc_mpcwm2bcfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TZSC_MPCWM2BCFGRrs;
impl crate::RegisterSpec for TZSC_MPCWM2BCFGRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tzsc_mpcwm2bcfgr::R`](R) reader structure"]
impl crate::Readable for TZSC_MPCWM2BCFGRrs {}
#[doc = "`write(|w| ..)` method takes [`tzsc_mpcwm2bcfgr::W`](W) writer structure"]
impl crate::Writable for TZSC_MPCWM2BCFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TZSC_MPCWM2BCFGR to value 0"]
