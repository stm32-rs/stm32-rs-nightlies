...
impl W {
    ...
    ///Bit 8 - privileged access mode for ADC4
    #[inline(always)]
    pub fn adc4priv(&mut self) -> ADC4PRIV_W<'_, TZSC_PRIVCFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#GTZC2_TZSC:TZSC_PRIVCFGR1)*/
