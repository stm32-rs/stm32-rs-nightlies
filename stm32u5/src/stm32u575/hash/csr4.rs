...
///Field `CSR4` reader - CSR4
pub type CSR4_R = crate::FieldReader<u32>;
///Field `CSR4` writer - CSR4
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CSR4").field("csr4", &self.csr4()).finish()
    }
}
impl W {
    ///Bits 0:31 - CSR4
    #[inline(always)]
    pub fn csr4(&mut self) -> CSR4_W<'_, CSR4rs> {
        CSR4_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#HASH:CSR4)*/
pub struct CSR4rs;
