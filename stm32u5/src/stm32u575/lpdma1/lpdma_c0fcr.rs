#[doc = "Register `LPDMA_C0FCR` writer"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tof(&mut self) -> TOF_W<LPDMA_C0FCRrs> {
        TOF_W::new(self, 14)
    }
}
#[doc = "LPDMA channel 0 flag clear register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpdma_c0fcr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPDMA_C0FCRrs;
impl crate::RegisterSpec for LPDMA_C0FCRrs {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`lpdma_c0fcr::W`](W) writer structure"]
impl crate::Writable for LPDMA_C0FCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPDMA_C0FCR to value 0"]
