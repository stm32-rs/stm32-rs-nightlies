...
You can [`read`](crate::Reg::read) this register and get [`lpdma_c0sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`lpdma_c0sr::R`](R) reader structure
impl crate::Readable for LPDMA_C0SRrs {}
///`reset()` method sets LPDMA_C0SR to value 0x01
