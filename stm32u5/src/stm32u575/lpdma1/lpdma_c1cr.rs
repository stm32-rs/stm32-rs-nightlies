#[doc = "Register `LPDMA_C1CR` reader"]
pub type R = crate::R<LPDMA_C1CRrs>;
#[doc = "Register `LPDMA_C1CR` writer"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn toie(&mut self) -> TOIE_W<LPDMA_C1CRrs> {
        TOIE_W::new(self, 14)
    }
    #[doc = "Bit 16 - Link step mode First the block transfer is executed as defined by the current internal register file until LPDMA_CxBR1.BNDT\\[15:0 \\]
=0). Secondly the next linked-list data structure is conditionally uploaded from memory as defined by LPDMA_CxLLR. Then channel execution is completed. Note: This bit must be written when EN=0. This bit is read-only when EN=1."]
...
#[doc = "LPDMA channel 1 control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpdma_c1cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpdma_c1cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPDMA_C1CRrs;
impl crate::RegisterSpec for LPDMA_C1CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpdma_c1cr::R`](R) reader structure"]
impl crate::Readable for LPDMA_C1CRrs {}
#[doc = "`write(|w| ..)` method takes [`lpdma_c1cr::W`](W) writer structure"]
impl crate::Writable for LPDMA_C1CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPDMA_C1CR to value 0"]
