///Register `LPDMA_C1DAR` reader
pub type R = crate::R<LPDMA_C1DARrs>;
///Register `LPDMA_C1DAR` writer
...
You can [`read`](crate::Reg::read) this register and get [`lpdma_c1dar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpdma_c1dar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`lpdma_c1dar::R`](R) reader structure
impl crate::Readable for LPDMA_C1DARrs {}
///`write(|w| ..)` method takes [`lpdma_c1dar::W`](W) writer structure
impl crate::Writable for LPDMA_C1DARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPDMA_C1DAR to value 0
