#[doc = "Register `LPDMA_C1SR` reader"]
...
#[doc = "LPDMA channel 1 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpdma_c1sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPDMA_C1SRrs;
impl crate::RegisterSpec for LPDMA_C1SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpdma_c1sr::R`](R) reader structure"]
impl crate::Readable for LPDMA_C1SRrs {}
#[doc = "`reset()` method sets LPDMA_C1SR to value 0x01"]
