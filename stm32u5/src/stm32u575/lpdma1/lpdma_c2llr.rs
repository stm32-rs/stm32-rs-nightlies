///Register `LPDMA_C2LLR` reader
pub type R = crate::R<LPDMA_C2LLRrs>;
///Register `LPDMA_C2LLR` writer
pub type W = crate::W<LPDMA_C2LLRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn la(&mut self) -> LA_W<LPDMA_C2LLRrs> {
        LA_W::new(self, 2)
    }
    ///Bit 16 - Update LPDMA_CxLLR register from memory This bit is used to control the update of the LPDMA_CxLLR register from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn ull(&mut self) -> ULL_W<LPDMA_C2LLRrs> {
        ULL_W::new(self, 16)
    }
    ///Bit 27 - Update LPDMA_CxDAR register from memory This bit is used to control the update of the LPDMA_CxDAR register from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn uda(&mut self) -> UDA_W<LPDMA_C2LLRrs> {
        UDA_W::new(self, 27)
    }
    ///Bit 28 - update LPDMA_CxSAR from memory This bit controls the update of the LPDMA_CxSAR register from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn usa(&mut self) -> USA_W<LPDMA_C2LLRrs> {
        USA_W::new(self, 28)
    }
    ///Bit 29 - Update LPDMA_CxBR1 from memory This bit controls the update of the LPDMA_CxBR1 register from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn ub1(&mut self) -> UB1_W<LPDMA_C2LLRrs> {
        UB1_W::new(self, 29)
    }
    ///Bit 30 - Update LPDMA_CxTR2 from memory This bit controls the update of the LPDMA_CxTR2 register from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn ut2(&mut self) -> UT2_W<LPDMA_C2LLRrs> {
        UT2_W::new(self, 30)
    }
    ///Bit 31 - Update LPDMA_CxTR1 from memory This bit controls the update of the LPDMA_CxTR1 register from the memory during the link transfer.
    #[inline(always)]
    #[must_use]
    pub fn ut1(&mut self) -> UT1_W<LPDMA_C2LLRrs> {
        UT1_W::new(self, 31)
    }
}
/**LPDMA channel 2 linked-list address register

You can [`read`](crate::Reg::read) this register and get [`lpdma_c2llr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpdma_c2llr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#LPDMA1:LPDMA_C2LLR)*/
pub struct LPDMA_C2LLRrs;
impl crate::RegisterSpec for LPDMA_C2LLRrs {
    type Ux = u32;
}
///`read()` method returns [`lpdma_c2llr::R`](R) reader structure
impl crate::Readable for LPDMA_C2LLRrs {}
///`write(|w| ..)` method takes [`lpdma_c2llr::W`](W) writer structure
impl crate::Writable for LPDMA_C2LLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPDMA_C2LLR to value 0
impl crate::Resettable for LPDMA_C2LLRrs {
