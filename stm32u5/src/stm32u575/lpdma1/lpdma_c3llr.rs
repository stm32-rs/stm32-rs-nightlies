#[doc = "Register `LPDMA_C3LLR` reader"]
pub type R = crate::R<LPDMA_C3LLRrs>;
#[doc = "Register `LPDMA_C3LLR` writer"]
...
#[doc = "LPDMA channel 3 linked-list address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpdma_c3llr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpdma_c3llr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPDMA_C3LLRrs;
impl crate::RegisterSpec for LPDMA_C3LLRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpdma_c3llr::R`](R) reader structure"]
impl crate::Readable for LPDMA_C3LLRrs {}
#[doc = "`write(|w| ..)` method takes [`lpdma_c3llr::W`](W) writer structure"]
impl crate::Writable for LPDMA_C3LLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPDMA_C3LLR to value 0"]
