#[doc = "Register `LPDMA_C3SR` reader"]
...
#[doc = "LPDMA channel 3 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpdma_c3sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPDMA_C3SRrs;
impl crate::RegisterSpec for LPDMA_C3SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpdma_c3sr::R`](R) reader structure"]
impl crate::Readable for LPDMA_C3SRrs {}
#[doc = "`reset()` method sets LPDMA_C3SR to value 0x01"]
