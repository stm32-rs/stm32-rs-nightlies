...
pub mod bsrr;
/**BRR (r) register accessor: LPGPIO port bit reset register

You can [`read`](crate::Reg::read) this register and get [`brr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
