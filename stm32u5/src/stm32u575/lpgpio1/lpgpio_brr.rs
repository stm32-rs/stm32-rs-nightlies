...
You can [`read`](crate::Reg::read) this register and get [`lpgpio_brr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#LPGPIO1:LPGPIO_BRR)*/
