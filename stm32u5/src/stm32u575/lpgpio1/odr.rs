...
impl W {
    ///Bit 0 - ODy0
    #[inline(always)]
    pub fn ody0(&mut self) -> ODY0_W<ODRrs> {
        ODY0_W::new(self, 0)
    }
    ///Bit 1 - ODy1
    #[inline(always)]
    pub fn ody1(&mut self) -> ODY1_W<ODRrs> {
        ODY1_W::new(self, 1)
    }
    ///Bit 2 - ODy2
    #[inline(always)]
    pub fn ody2(&mut self) -> ODY2_W<ODRrs> {
        ODY2_W::new(self, 2)
    }
    ///Bit 3 - ODy3
    #[inline(always)]
    pub fn ody3(&mut self) -> ODY3_W<ODRrs> {
        ODY3_W::new(self, 3)
    }
    ///Bit 4 - ODy4
    #[inline(always)]
    pub fn ody4(&mut self) -> ODY4_W<ODRrs> {
        ODY4_W::new(self, 4)
    }
    ///Bit 5 - ODy5
    #[inline(always)]
    pub fn ody5(&mut self) -> ODY5_W<ODRrs> {
        ODY5_W::new(self, 5)
    }
    ///Bit 6 - ODy6
    #[inline(always)]
    pub fn ody6(&mut self) -> ODY6_W<ODRrs> {
        ODY6_W::new(self, 6)
    }
    ///Bit 7 - ODy7
    #[inline(always)]
    pub fn ody7(&mut self) -> ODY7_W<ODRrs> {
        ODY7_W::new(self, 7)
    }
    ///Bit 8 - ODy8
    #[inline(always)]
    pub fn ody8(&mut self) -> ODY8_W<ODRrs> {
        ODY8_W::new(self, 8)
    }
    ///Bit 9 - ODy9
    #[inline(always)]
    pub fn ody9(&mut self) -> ODY9_W<ODRrs> {
        ODY9_W::new(self, 9)
    }
    ///Bit 10 - ODy10
    #[inline(always)]
    pub fn ody10(&mut self) -> ODY10_W<ODRrs> {
        ODY10_W::new(self, 10)
    }
    ///Bit 11 - ODy11
    #[inline(always)]
    pub fn ody11(&mut self) -> ODY11_W<ODRrs> {
        ODY11_W::new(self, 11)
    }
    ///Bit 12 - ODy12
    #[inline(always)]
    pub fn ody12(&mut self) -> ODY12_W<ODRrs> {
        ODY12_W::new(self, 12)
    }
    ///Bit 13 - ODy13
    #[inline(always)]
    pub fn ody13(&mut self) -> ODY13_W<ODRrs> {
        ODY13_W::new(self, 13)
    }
    ///Bit 14 - ODy14
    #[inline(always)]
    pub fn ody14(&mut self) -> ODY14_W<ODRrs> {
        ODY14_W::new(self, 14)
    }
    ///Bit 15 - ODy15
    #[inline(always)]
    pub fn ody15(&mut self) -> ODY15_W<ODRrs> {
        ODY15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#LPGPIO1:ODR)*/
pub struct ODRrs;
