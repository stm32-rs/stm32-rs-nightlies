///Register `MDF_DFLT1CICR` reader
pub type R = crate::R<MDF_DFLT1CICRrs>;
///Register `MDF_DFLT1CICR` writer
...
You can [`read`](crate::Reg::read) this register and get [`mdf_dflt1cicr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_dflt1cicr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#MDF1:MDF_DFLT1CICR)*/
pub struct MDF_DFLT1CICRrs;
impl crate::RegisterSpec for MDF_DFLT1CICRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_dflt1cicr::R`](R) reader structure
impl crate::Readable for MDF_DFLT1CICRrs {}
///`write(|w| ..)` method takes [`mdf_dflt1cicr::W`](W) writer structure
impl crate::Writable for MDF_DFLT1CICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_DFLT1CICR to value 0
