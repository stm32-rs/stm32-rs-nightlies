///Register `MDF_DFLT2RSFR` reader
pub type R = crate::R<MDF_DFLT2RSFRrs>;
///Register `MDF_DFLT2RSFR` writer
pub type W = crate::W<MDF_DFLT2RSFRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rsfltbyp(&mut self) -> RSFLTBYP_W<MDF_DFLT2RSFRrs> {
        RSFLTBYP_W::new(self, 0)
    }
    ///Bit 4 - Reshaper filter decimation ratio Set and cleared by software. This bit is used to select the decimation ratio for the reshape filter - 0: Decimation ratio is 4 (Default value) - 1: Decimation ratio is 1 This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
    #[inline(always)]
    #[must_use]
    pub fn rsfltd(&mut self) -> RSFLTD_W<MDF_DFLT2RSFRrs> {
        RSFLTD_W::new(self, 4)
    }
    ///Bit 7 - High-Pass Filter bypass Set and cleared by software. This bit is used to bypass the high-pass filter. - 0: The high pass filter is not bypassed (Default value) - 1: The high pass filter is bypassed This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
    #[inline(always)]
    #[must_use]
    pub fn hpfbyp(&mut self) -> HPFBYP_W<MDF_DFLT2RSFRrs> {
        HPFBYP_W::new(self, 7)
    }
    ///Bits 8:9 - High-pass filter cut-off frequency Set and cleared by software. This field is used to select the cut-off frequency of the high-pass filter. FPCM represents the sampling frequency at HPF input. - 00: Cut-off frequency = 0.000625 x FPCM - 01: Cut-off frequency = 0.00125 x FPCM - 10: Cut-off frequency = 0.00250 x FPCM - 11: Cut-off frequency = 0.00950 x FPCM This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
    #[inline(always)]
    #[must_use]
    pub fn hpfc(&mut self) -> HPFC_W<MDF_DFLT2RSFRrs> {
        HPFC_W::new(self, 8)
    }
}
/**This register is used to control the reshape and HPF filters.

You can [`read`](crate::Reg::read) this register and get [`mdf_dflt2rsfr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_dflt2rsfr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#MDF1:MDF_DFLT2RSFR)*/
pub struct MDF_DFLT2RSFRrs;
impl crate::RegisterSpec for MDF_DFLT2RSFRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_dflt2rsfr::R`](R) reader structure
impl crate::Readable for MDF_DFLT2RSFRrs {}
///`write(|w| ..)` method takes [`mdf_dflt2rsfr::W`](W) writer structure
impl crate::Writable for MDF_DFLT2RSFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_DFLT2RSFR to value 0
impl crate::Resettable for MDF_DFLT2RSFRrs {
