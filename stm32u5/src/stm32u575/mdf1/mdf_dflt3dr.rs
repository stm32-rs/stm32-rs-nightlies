#[doc = "Register `MDF_DFLT3DR` reader"]
...
#[doc = "This register is used to read the data processed by each digital filter.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_dflt3dr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_DFLT3DRrs;
impl crate::RegisterSpec for MDF_DFLT3DRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_dflt3dr::R`](R) reader structure"]
impl crate::Readable for MDF_DFLT3DRrs {}
#[doc = "`reset()` method sets MDF_DFLT3DR to value 0"]
