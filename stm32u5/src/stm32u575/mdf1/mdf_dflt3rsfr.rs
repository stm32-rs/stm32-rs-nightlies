#[doc = "Register `MDF_DFLT3RSFR` reader"]
pub type R = crate::R<MDF_DFLT3RSFRrs>;
#[doc = "Register `MDF_DFLT3RSFR` writer"]
...
#[doc = "This register is used to control the reshape and HPF filters.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_dflt3rsfr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdf_dflt3rsfr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_DFLT3RSFRrs;
impl crate::RegisterSpec for MDF_DFLT3RSFRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_dflt3rsfr::R`](R) reader structure"]
impl crate::Readable for MDF_DFLT3RSFRrs {}
#[doc = "`write(|w| ..)` method takes [`mdf_dflt3rsfr::W`](W) writer structure"]
impl crate::Writable for MDF_DFLT3RSFRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDF_DFLT3RSFR to value 0"]
