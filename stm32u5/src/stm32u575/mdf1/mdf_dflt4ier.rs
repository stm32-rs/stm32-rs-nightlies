///Register `MDF_DFLT4IER` reader
pub type R = crate::R<MDF_DFLT4IERrs>;
///Register `MDF_DFLT4IER` writer
pub type W = crate::W<MDF_DFLT4IERrs>;
...
impl W {
    ///Bit 0 - RXFIFO threshold interrupt enable Set and cleared by software. - 0: RXFIFO threshold interrupt disabled - 1: RXFIFO threshold interrupt enabled
    #[inline(always)]
    pub fn fthie(&mut self) -> FTHIE_W<MDF_DFLT4IERrs> {
        FTHIE_W::new(self, 0)
    }
    ///Bit 1 - Data overflow interrupt enable Set and cleared by software. - 0: Data overflow interrupt disabled - 1: Data overflow interrupt enabled
    #[inline(always)]
    pub fn dovrie(&mut self) -> DOVRIE_W<MDF_DFLT4IERrs> {
        DOVRIE_W::new(self, 1)
    }
    ///Bit 2 - Snapshot data ready interrupt enable Set and cleared by software. - 0: Snapshot data ready interrupt disabled - 1: Snapshot data ready interrupt enabled
    #[inline(always)]
    pub fn ssdrie(&mut self) -> SSDRIE_W<MDF_DFLT4IERrs> {
        SSDRIE_W::new(self, 2)
    }
    ///Bit 4 - Out-of Limit interrupt enable Set and cleared by software. - 0: OLD event interrupt disabled - 1: OLD event interrupt enabled
    #[inline(always)]
    pub fn oldie(&mut self) -> OLDIE_W<MDF_DFLT4IERrs> {
        OLDIE_W::new(self, 4)
    }
    ///Bit 7 - Snapshot overrun interrupt enable Set and cleared by software. - 0: Snapshot overrun interrupt disabled - 1: Snapshot overrun interrupt enabled
    #[inline(always)]
    pub fn ssovrie(&mut self) -> SSOVRIE_W<MDF_DFLT4IERrs> {
        SSOVRIE_W::new(self, 7)
    }
    ///Bit 8 - Short-Circuit Detector interrupt enable Set and cleared by software. - 0: SCD interrupt disabled - 1: SCD interrupt enabled
    #[inline(always)]
    pub fn scdie(&mut self) -> SCDIE_W<MDF_DFLT4IERrs> {
        SCDIE_W::new(self, 8)
    }
    ///Bit 9 - Saturation detection interrupt enable Set and cleared by software. - 0: Saturation interrupt disabled - 1: Saturation interrupt enabled
    #[inline(always)]
    pub fn satie(&mut self) -> SATIE_W<MDF_DFLT4IERrs> {
        SATIE_W::new(self, 9)
    }
    ///Bit 10 - Clock absence detection interrupt enable Set and cleared by software. - 0: Clock absence interrupt disabled - 1: Clock absence interrupt enabled
    #[inline(always)]
    pub fn ckabie(&mut self) -> CKABIE_W<MDF_DFLT4IERrs> {
        CKABIE_W::new(self, 10)
    }
    ///Bit 11 - Reshape Filter Overrun interrupt enable Set and cleared by software. - 0: Reshape filter overrun interrupt disabled - 1: Reshape filter overrun interrupt enabled
    #[inline(always)]
    pub fn rfovrie(&mut self) -> RFOVRIE_W<MDF_DFLT4IERrs> {
        RFOVRIE_W::new(self, 11)
    }
}
/**MDF DFLTx interrupt enable register x

You can [`read`](crate::Reg::read) this register and get [`mdf_dflt4ier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_dflt4ier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#MDF1:MDF_DFLT4IER)*/
pub struct MDF_DFLT4IERrs;
impl crate::RegisterSpec for MDF_DFLT4IERrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_dflt4ier::R`](R) reader structure
impl crate::Readable for MDF_DFLT4IERrs {}
///`write(|w| ..)` method takes [`mdf_dflt4ier::W`](W) writer structure
impl crate::Writable for MDF_DFLT4IERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_DFLT4IER to value 0
impl crate::Resettable for MDF_DFLT4IERrs {
