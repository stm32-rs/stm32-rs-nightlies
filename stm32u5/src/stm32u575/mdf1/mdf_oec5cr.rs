///Register `MDF_OEC5CR` reader
pub type R = crate::R<MDF_OEC5CRrs>;
///Register `MDF_OEC5CR` writer
pub type W = crate::W<MDF_OEC5CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn offset(&mut self) -> OFFSET_W<MDF_OEC5CRrs> {
        OFFSET_W::new(self, 0)
    }
}
/**This register contains the offset compensation value.

You can [`read`](crate::Reg::read) this register and get [`mdf_oec5cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_oec5cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#MDF1:MDF_OEC5CR)*/
pub struct MDF_OEC5CRrs;
impl crate::RegisterSpec for MDF_OEC5CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_oec5cr::R`](R) reader structure
impl crate::Readable for MDF_OEC5CRrs {}
///`write(|w| ..)` method takes [`mdf_oec5cr::W`](W) writer structure
impl crate::Writable for MDF_OEC5CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_OEC5CR to value 0
impl crate::Resettable for MDF_OEC5CRrs {
