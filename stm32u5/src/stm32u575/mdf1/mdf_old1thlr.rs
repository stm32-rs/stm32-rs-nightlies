#[doc = "Register `MDF_OLD1THLR` reader"]
pub type R = crate::R<MDF_OLD1THLRrs>;
#[doc = "Register `MDF_OLD1THLR` writer"]
...
#[doc = "This register is used for the adjustment of the Out-off Limit low threshold.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_old1thlr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdf_old1thlr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_OLD1THLRrs;
impl crate::RegisterSpec for MDF_OLD1THLRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_old1thlr::R`](R) reader structure"]
impl crate::Readable for MDF_OLD1THLRrs {}
#[doc = "`write(|w| ..)` method takes [`mdf_old1thlr::W`](W) writer structure"]
impl crate::Writable for MDF_OLD1THLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDF_OLD1THLR to value 0"]
