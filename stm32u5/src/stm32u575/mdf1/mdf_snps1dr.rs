...
You can [`read`](crate::Reg::read) this register and get [`mdf_snps1dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#MDF1:MDF_SNPS1DR)*/
pub struct MDF_SNPS1DRrs;
impl crate::RegisterSpec for MDF_SNPS1DRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_snps1dr::R`](R) reader structure
impl crate::Readable for MDF_SNPS1DRrs {}
///`reset()` method sets MDF_SNPS1DR to value 0
