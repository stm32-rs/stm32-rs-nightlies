...
impl W {
    ///Bits 0:31 - Region AXI start address
    #[inline(always)]
    pub fn regx_start_addr(&mut self) -> REGX_START_ADDR_W<'_, R2STARTADDRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#OTFDEC1:R2STARTADDR)*/
