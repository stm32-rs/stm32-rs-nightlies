...
pub type R = crate::R<HCTSIZ6rs>;
///Register `HCTSIZ6` writer
pub type W = crate::W<HCTSIZ6rs>;
...
impl W {
    ///Bits 0:18 - XFRSIZ
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, HCTSIZ6rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - PKTCNT
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, HCTSIZ6rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - DPID
    #[inline(always)]
    pub fn dpid(&mut self) -> DPID_W<'_, HCTSIZ6rs> {
        DPID_W::new(self, 29)
    }
    ///Bit 31 - DOPNG
    #[inline(always)]
    pub fn dopng(&mut self) -> DOPNG_W<'_, HCTSIZ6rs> {
        DOPNG_W::new(self, 31)
    }
}
...
pub struct HCTSIZ6rs;
impl crate::RegisterSpec for HCTSIZ6rs {
    type Ux = u32;
}
///`read()` method returns [`hctsiz6::R`](R) reader structure
impl crate::Readable for HCTSIZ6rs {}
///`write(|w| ..)` method takes [`hctsiz6::W`](W) writer structure
impl crate::Writable for HCTSIZ6rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HCTSIZ6 to value 0
impl crate::Resettable for HCTSIZ6rs {}
