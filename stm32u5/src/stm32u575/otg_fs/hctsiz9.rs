///Register `HCTSIZ9` reader
pub type R = crate::R<HCTSIZ9rs>;
///Register `HCTSIZ9` writer
pub type W = crate::W<HCTSIZ9rs>;
...
impl W {
    ///Bits 0:18 - XFRSIZ
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, HCTSIZ9rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - PKTCNT
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, HCTSIZ9rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - DPID
    #[inline(always)]
    pub fn dpid(&mut self) -> DPID_W<'_, HCTSIZ9rs> {
        DPID_W::new(self, 29)
    }
    ///Bit 31 - DOPNG
    #[inline(always)]
    pub fn dopng(&mut self) -> DOPNG_W<'_, HCTSIZ9rs> {
        DOPNG_W::new(self, 31)
    }
}
...
pub struct HCTSIZ9rs;
impl crate::RegisterSpec for HCTSIZ9rs {
    type Ux = u32;
}
///`read()` method returns [`hctsiz9::R`](R) reader structure
impl crate::Readable for HCTSIZ9rs {}
///`write(|w| ..)` method takes [`hctsiz9::W`](W) writer structure
impl crate::Writable for HCTSIZ9rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HCTSIZ9 to value 0
impl crate::Resettable for HCTSIZ9rs {}
