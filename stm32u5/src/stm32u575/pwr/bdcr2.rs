...
impl W {
    ///Bit 0 - VBAT charging enable
    #[inline(always)]
    pub fn vbe(&mut self) -> VBE_W<'_, BDCR2rs> {
        VBE_W::new(self, 0)
    }
    ///Bit 1 - VBAT charging resistor selection
    #[inline(always)]
    pub fn vbrs(&mut self) -> VBRS_W<'_, BDCR2rs> {
        VBRS_W::new(self, 1)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#PWR:BDCR2)*/
pub struct BDCR2rs;
