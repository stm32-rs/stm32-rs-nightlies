...
impl W {
    ///Bit 0
    #[inline(always)]
    pub fn sram1pds4(&mut self) -> SRAM1PDS4_W<'_, CR4rs> {
        SRAM1PDS4_W::new(self, 0)
    }
    ///Bit 1
    #[inline(always)]
    pub fn sram1pds5(&mut self) -> SRAM1PDS5_W<'_, CR4rs> {
        SRAM1PDS5_W::new(self, 1)
    }
    ///Bit 2
    #[inline(always)]
    pub fn sram1pds6(&mut self) -> SRAM1PDS6_W<'_, CR4rs> {
        SRAM1PDS6_W::new(self, 2)
    }
    ///Bit 3
    #[inline(always)]
    pub fn sram1pds7(&mut self) -> SRAM1PDS7_W<'_, CR4rs> {
        SRAM1PDS7_W::new(self, 3)
    }
    ///Bit 4
    #[inline(always)]
    pub fn sram1pds8(&mut self) -> SRAM1PDS8_W<'_, CR4rs> {
        SRAM1PDS8_W::new(self, 4)
    }
    ///Bit 5
    #[inline(always)]
    pub fn sram1pds9(&mut self) -> SRAM1PDS9_W<'_, CR4rs> {
        SRAM1PDS9_W::new(self, 5)
    }
    ///Bit 6
    #[inline(always)]
    pub fn sram1pds10(&mut self) -> SRAM1PDS10_W<'_, CR4rs> {
        SRAM1PDS10_W::new(self, 6)
    }
    ///Bit 7
    #[inline(always)]
    pub fn sram1pds11(&mut self) -> SRAM1PDS11_W<'_, CR4rs> {
        SRAM1PDS11_W::new(self, 7)
    }
    ///Bit 8
    #[inline(always)]
    pub fn sram1pds12(&mut self) -> SRAM1PDS12_W<'_, CR4rs> {
        SRAM1PDS12_W::new(self, 8)
    }
    ///Bit 10
    #[inline(always)]
    pub fn sram3pds9(&mut self) -> SRAM3PDS9_W<'_, CR4rs> {
        SRAM3PDS9_W::new(self, 10)
    }
    ///Bit 11
    #[inline(always)]
    pub fn sram3pds10(&mut self) -> SRAM3PDS10_W<'_, CR4rs> {
        SRAM3PDS10_W::new(self, 11)
    }
    ///Bit 12
    #[inline(always)]
    pub fn sram3pds11(&mut self) -> SRAM3PDS11_W<'_, CR4rs> {
        SRAM3PDS11_W::new(self, 12)
    }
    ///Bit 13
    #[inline(always)]
    pub fn sram3pds12(&mut self) -> SRAM3PDS12_W<'_, CR4rs> {
        SRAM3PDS12_W::new(self, 13)
    }
    ///Bit 14
    #[inline(always)]
    pub fn sram3pds13(&mut self) -> SRAM3PDS13_W<'_, CR4rs> {
