...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pu0(&mut self) -> PU0_W<PWR_PUCRErs> {
        PU0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Port E pull-up bit"]
    #[inline(always)]
    #[must_use]
    pub fn pu1(&mut self) -> PU1_W<PWR_PUCRErs> {
        PU1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Port E pull-up bit"]
    #[inline(always)]
    #[must_use]
    pub fn pu2(&mut self) -> PU2_W<PWR_PUCRErs> {
        PU2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Port E pull-up bit"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pu4(&mut self) -> PU4_W<PWR_PUCRErs> {
        PU4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Port E pull-up bit"]
    #[inline(always)]
    #[must_use]
    pub fn pu5(&mut self) -> PU5_W<PWR_PUCRErs> {
        PU5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Port E pull-up bit"]
    #[inline(always)]
    #[must_use]
    pub fn pu6(&mut self) -> PU6_W<PWR_PUCRErs> {
        PU6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Port E pull-up bit"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pu10(&mut self) -> PU10_W<PWR_PUCRErs> {
        PU10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Port E pull-up bit"]
    #[inline(always)]
    #[must_use]
    pub fn pu11(&mut self) -> PU11_W<PWR_PUCRErs> {
        PU11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Port E pull-up bit"]
    #[inline(always)]
    #[must_use]
    pub fn pu12(&mut self) -> PU12_W<PWR_PUCRErs> {
        PU12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Port E pull-up bit"]
    #[inline(always)]
    #[must_use]
    pub fn pu13(&mut self) -> PU13_W<PWR_PUCRErs> {
        PU13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Port E pull-up bit"]
    #[inline(always)]
    #[must_use]
    pub fn pu14(&mut self) -> PU14_W<PWR_PUCRErs> {
        PU14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Port E pull-up bit"]
    #[inline(always)]
    #[must_use]
    pub fn pu15(&mut self) -> PU15_W<PWR_PUCRErs> {
        PU15_W::new(self, 15)
    }
}
