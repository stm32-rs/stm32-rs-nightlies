#[doc = "Register `RAM2CR` reader"]
pub type R = crate::R<RAM2CRrs>;
#[doc = "Register `RAM2CR` writer"]
...
#[doc = "RAMCFG SRAM x control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram2cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ram2cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAM2CRrs;
impl crate::RegisterSpec for RAM2CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram2cr::R`](R) reader structure"]
impl crate::Readable for RAM2CRrs {}
#[doc = "`write(|w| ..)` method takes [`ram2cr::W`](W) writer structure"]
impl crate::Writable for RAM2CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM2CR to value 0"]
