...
impl W {
    ///Bit 0 - P0WP
    #[inline(always)]
    pub fn p0wp(&mut self) -> P0WP_W<'_, RAM2WPR1rs> {
        P0WP_W::new(self, 0)
    }
    ///Bit 1 - P1WP
    #[inline(always)]
    pub fn p1wp(&mut self) -> P1WP_W<'_, RAM2WPR1rs> {
        P1WP_W::new(self, 1)
    }
    ///Bit 2 - P2WP
    #[inline(always)]
    pub fn p2wp(&mut self) -> P2WP_W<'_, RAM2WPR1rs> {
        P2WP_W::new(self, 2)
    }
    ///Bit 3 - P3WP
    #[inline(always)]
    pub fn p3wp(&mut self) -> P3WP_W<'_, RAM2WPR1rs> {
        P3WP_W::new(self, 3)
    }
    ///Bit 4 - P4WP
    #[inline(always)]
    pub fn p4wp(&mut self) -> P4WP_W<'_, RAM2WPR1rs> {
        P4WP_W::new(self, 4)
    }
    ///Bit 5 - P5WP
    #[inline(always)]
    pub fn p5wp(&mut self) -> P5WP_W<'_, RAM2WPR1rs> {
        P5WP_W::new(self, 5)
    }
    ///Bit 6 - P6WP
    #[inline(always)]
    pub fn p6wp(&mut self) -> P6WP_W<'_, RAM2WPR1rs> {
        P6WP_W::new(self, 6)
    }
    ///Bit 7 - P7WP
    #[inline(always)]
    pub fn p7wp(&mut self) -> P7WP_W<'_, RAM2WPR1rs> {
        P7WP_W::new(self, 7)
    }
    ///Bit 8 - P8WP
    #[inline(always)]
    pub fn p8wp(&mut self) -> P8WP_W<'_, RAM2WPR1rs> {
        P8WP_W::new(self, 8)
    }
    ///Bit 9 - P9WP
    #[inline(always)]
    pub fn p9wp(&mut self) -> P9WP_W<'_, RAM2WPR1rs> {
        P9WP_W::new(self, 9)
    }
    ///Bit 10 - P10WP
    #[inline(always)]
    pub fn p10wp(&mut self) -> P10WP_W<'_, RAM2WPR1rs> {
        P10WP_W::new(self, 10)
    }
    ///Bit 11 - P11WP
    #[inline(always)]
    pub fn p11wp(&mut self) -> P11WP_W<'_, RAM2WPR1rs> {
        P11WP_W::new(self, 11)
    }
    ///Bit 12 - P12WP
    #[inline(always)]
    pub fn p12wp(&mut self) -> P12WP_W<'_, RAM2WPR1rs> {
        P12WP_W::new(self, 12)
    }
    ///Bit 13 - P13WP
    #[inline(always)]
    pub fn p13wp(&mut self) -> P13WP_W<'_, RAM2WPR1rs> {
        P13WP_W::new(self, 13)
    }
    ///Bit 14 - P14WP
    #[inline(always)]
    pub fn p14wp(&mut self) -> P14WP_W<'_, RAM2WPR1rs> {
        P14WP_W::new(self, 14)
    }
    ///Bit 15 - P15WP
    #[inline(always)]
    pub fn p15wp(&mut self) -> P15WP_W<'_, RAM2WPR1rs> {
        P15WP_W::new(self, 15)
    }
    ///Bit 16 - P16WP
    #[inline(always)]
    pub fn p16wp(&mut self) -> P16WP_W<'_, RAM2WPR1rs> {
        P16WP_W::new(self, 16)
    }
    ///Bit 17 - P17WP
    #[inline(always)]
    pub fn p17wp(&mut self) -> P17WP_W<'_, RAM2WPR1rs> {
        P17WP_W::new(self, 17)
    }
    ///Bit 18 - P18WP
    #[inline(always)]
    pub fn p18wp(&mut self) -> P18WP_W<'_, RAM2WPR1rs> {
        P18WP_W::new(self, 18)
    }
    ///Bit 19 - P19WP
    #[inline(always)]
    pub fn p19wp(&mut self) -> P19WP_W<'_, RAM2WPR1rs> {
        P19WP_W::new(self, 19)
    }
    ///Bit 20 - P20WP
    #[inline(always)]
    pub fn p20wp(&mut self) -> P20WP_W<'_, RAM2WPR1rs> {
        P20WP_W::new(self, 20)
    }
    ///Bit 21 - P21WP
    #[inline(always)]
    pub fn p21wp(&mut self) -> P21WP_W<'_, RAM2WPR1rs> {
        P21WP_W::new(self, 21)
    }
    ///Bit 22 - P22WP
    #[inline(always)]
    pub fn p22wp(&mut self) -> P22WP_W<'_, RAM2WPR1rs> {
        P22WP_W::new(self, 22)
    }
    ///Bit 23 - P23WP
    #[inline(always)]
    pub fn p23wp(&mut self) -> P23WP_W<'_, RAM2WPR1rs> {
        P23WP_W::new(self, 23)
    }
    ///Bit 24 - P24WP
    #[inline(always)]
    pub fn p24wp(&mut self) -> P24WP_W<'_, RAM2WPR1rs> {
        P24WP_W::new(self, 24)
    }
    ///Bit 25 - P25WP
    #[inline(always)]
    pub fn p25wp(&mut self) -> P25WP_W<'_, RAM2WPR1rs> {
        P25WP_W::new(self, 25)
    }
    ///Bit 26 - P26WP
    #[inline(always)]
    pub fn p26wp(&mut self) -> P26WP_W<'_, RAM2WPR1rs> {
        P26WP_W::new(self, 26)
    }
    ///Bit 27 - P27WP
    #[inline(always)]
    pub fn p27wp(&mut self) -> P27WP_W<'_, RAM2WPR1rs> {
        P27WP_W::new(self, 27)
    }
    ///Bit 28 - P28WP
    #[inline(always)]
    pub fn p28wp(&mut self) -> P28WP_W<'_, RAM2WPR1rs> {
        P28WP_W::new(self, 28)
    }
    ///Bit 29 - P29WP
    #[inline(always)]
    pub fn p29wp(&mut self) -> P29WP_W<'_, RAM2WPR1rs> {
        P29WP_W::new(self, 29)
    }
    ///Bit 30 - P30WP
    #[inline(always)]
    pub fn p30wp(&mut self) -> P30WP_W<'_, RAM2WPR1rs> {
        P30WP_W::new(self, 30)
    }
    ///Bit 31 - P31WP
    #[inline(always)]
    pub fn p31wp(&mut self) -> P31WP_W<'_, RAM2WPR1rs> {
        P31WP_W::new(self, 31)
    }
}
/**RAMCFG SRAM2 write protection register 1

You can [`read`](crate::Reg::read) this register and get [`ram2wpr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram2wpr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#RAMCFG:RAM2WPR1)*/
