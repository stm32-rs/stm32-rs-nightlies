...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0wp(&mut self) -> P0WP_W<RAM2WPR1rs> {
        P0WP_W::new(self, 0)
    }
    #[doc = "Bit 1 - P1WP"]
    #[inline(always)]
    #[must_use]
    pub fn p1wp(&mut self) -> P1WP_W<RAM2WPR1rs> {
        P1WP_W::new(self, 1)
    }
    #[doc = "Bit 2 - P2WP"]
    #[inline(always)]
    #[must_use]
    pub fn p2wp(&mut self) -> P2WP_W<RAM2WPR1rs> {
        P2WP_W::new(self, 2)
    }
    #[doc = "Bit 3 - P3WP"]
    #[inline(always)]
    #[must_use]
    pub fn p3wp(&mut self) -> P3WP_W<RAM2WPR1rs> {
        P3WP_W::new(self, 3)
    }
    #[doc = "Bit 4 - P4WP"]
    #[inline(always)]
    #[must_use]
    pub fn p4wp(&mut self) -> P4WP_W<RAM2WPR1rs> {
        P4WP_W::new(self, 4)
    }
    #[doc = "Bit 5 - P5WP"]
    #[inline(always)]
    #[must_use]
    pub fn p5wp(&mut self) -> P5WP_W<RAM2WPR1rs> {
        P5WP_W::new(self, 5)
    }
    #[doc = "Bit 6 - P6WP"]
    #[inline(always)]
    #[must_use]
    pub fn p6wp(&mut self) -> P6WP_W<RAM2WPR1rs> {
        P6WP_W::new(self, 6)
    }
    #[doc = "Bit 7 - P7WP"]
    #[inline(always)]
    #[must_use]
    pub fn p7wp(&mut self) -> P7WP_W<RAM2WPR1rs> {
        P7WP_W::new(self, 7)
    }
    #[doc = "Bit 8 - P8WP"]
    #[inline(always)]
    #[must_use]
    pub fn p8wp(&mut self) -> P8WP_W<RAM2WPR1rs> {
        P8WP_W::new(self, 8)
    }
    #[doc = "Bit 9 - P9WP"]
    #[inline(always)]
    #[must_use]
    pub fn p9wp(&mut self) -> P9WP_W<RAM2WPR1rs> {
        P9WP_W::new(self, 9)
    }
    #[doc = "Bit 10 - P10WP"]
    #[inline(always)]
    #[must_use]
    pub fn p10wp(&mut self) -> P10WP_W<RAM2WPR1rs> {
        P10WP_W::new(self, 10)
    }
    #[doc = "Bit 11 - P11WP"]
    #[inline(always)]
    #[must_use]
    pub fn p11wp(&mut self) -> P11WP_W<RAM2WPR1rs> {
        P11WP_W::new(self, 11)
    }
    #[doc = "Bit 12 - P12WP"]
    #[inline(always)]
    #[must_use]
    pub fn p12wp(&mut self) -> P12WP_W<RAM2WPR1rs> {
        P12WP_W::new(self, 12)
    }
    #[doc = "Bit 13 - P13WP"]
    #[inline(always)]
    #[must_use]
    pub fn p13wp(&mut self) -> P13WP_W<RAM2WPR1rs> {
        P13WP_W::new(self, 13)
    }
    #[doc = "Bit 14 - P14WP"]
    #[inline(always)]
    #[must_use]
    pub fn p14wp(&mut self) -> P14WP_W<RAM2WPR1rs> {
        P14WP_W::new(self, 14)
    }
    #[doc = "Bit 15 - P15WP"]
    #[inline(always)]
    #[must_use]
    pub fn p15wp(&mut self) -> P15WP_W<RAM2WPR1rs> {
        P15WP_W::new(self, 15)
    }
    #[doc = "Bit 16 - P16WP"]
    #[inline(always)]
    #[must_use]
    pub fn p16wp(&mut self) -> P16WP_W<RAM2WPR1rs> {
        P16WP_W::new(self, 16)
    }
    #[doc = "Bit 17 - P17WP"]
    #[inline(always)]
    #[must_use]
    pub fn p17wp(&mut self) -> P17WP_W<RAM2WPR1rs> {
        P17WP_W::new(self, 17)
    }
    #[doc = "Bit 18 - P18WP"]
    #[inline(always)]
    #[must_use]
    pub fn p18wp(&mut self) -> P18WP_W<RAM2WPR1rs> {
        P18WP_W::new(self, 18)
    }
    #[doc = "Bit 19 - P19WP"]
    #[inline(always)]
    #[must_use]
    pub fn p19wp(&mut self) -> P19WP_W<RAM2WPR1rs> {
        P19WP_W::new(self, 19)
    }
    #[doc = "Bit 20 - P20WP"]
    #[inline(always)]
    #[must_use]
    pub fn p20wp(&mut self) -> P20WP_W<RAM2WPR1rs> {
        P20WP_W::new(self, 20)
    }
    #[doc = "Bit 21 - P21WP"]
    #[inline(always)]
    #[must_use]
    pub fn p21wp(&mut self) -> P21WP_W<RAM2WPR1rs> {
        P21WP_W::new(self, 21)
    }
    #[doc = "Bit 22 - P22WP"]
    #[inline(always)]
    #[must_use]
    pub fn p22wp(&mut self) -> P22WP_W<RAM2WPR1rs> {
        P22WP_W::new(self, 22)
    }
    #[doc = "Bit 23 - P23WP"]
    #[inline(always)]
    #[must_use]
    pub fn p23wp(&mut self) -> P23WP_W<RAM2WPR1rs> {
        P23WP_W::new(self, 23)
    }
    #[doc = "Bit 24 - P24WP"]
    #[inline(always)]
    #[must_use]
    pub fn p24wp(&mut self) -> P24WP_W<RAM2WPR1rs> {
        P24WP_W::new(self, 24)
    }
    #[doc = "Bit 25 - P25WP"]
    #[inline(always)]
    #[must_use]
    pub fn p25wp(&mut self) -> P25WP_W<RAM2WPR1rs> {
        P25WP_W::new(self, 25)
    }
    #[doc = "Bit 26 - P26WP"]
    #[inline(always)]
    #[must_use]
    pub fn p26wp(&mut self) -> P26WP_W<RAM2WPR1rs> {
        P26WP_W::new(self, 26)
    }
    #[doc = "Bit 27 - P27WP"]
    #[inline(always)]
    #[must_use]
    pub fn p27wp(&mut self) -> P27WP_W<RAM2WPR1rs> {
        P27WP_W::new(self, 27)
    }
    #[doc = "Bit 28 - P28WP"]
    #[inline(always)]
    #[must_use]
    pub fn p28wp(&mut self) -> P28WP_W<RAM2WPR1rs> {
        P28WP_W::new(self, 28)
    }
    #[doc = "Bit 29 - P29WP"]
    #[inline(always)]
    #[must_use]
    pub fn p29wp(&mut self) -> P29WP_W<RAM2WPR1rs> {
        P29WP_W::new(self, 29)
    }
    #[doc = "Bit 30 - P30WP"]
    #[inline(always)]
    #[must_use]
    pub fn p30wp(&mut self) -> P30WP_W<RAM2WPR1rs> {
        P30WP_W::new(self, 30)
    }
    #[doc = "Bit 31 - P31WP"]
    #[inline(always)]
    #[must_use]
    pub fn p31wp(&mut self) -> P31WP_W<RAM2WPR1rs> {
        P31WP_W::new(self, 31)
    }
}
#[doc = "RAMCFG SRAM2 write protection register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram2wpr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ram2wpr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAM2WPR1rs;
impl crate::RegisterSpec for RAM2WPR1rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram2wpr1::R`](R) reader structure"]
impl crate::Readable for RAM2WPR1rs {}
#[doc = "`write(|w| ..)` method takes [`ram2wpr1::W`](W) writer structure"]
impl crate::Writable for RAM2WPR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM2WPR1 to value 0"]
impl crate::Resettable for RAM2WPR1rs {
