...
impl W {
    ///Bit 0 - ECCE
    #[inline(always)]
    pub fn ecce(&mut self) -> ECCE_W<'_, RAM3CRrs> {
        ECCE_W::new(self, 0)
    }
    ///Bit 4 - ALE
    #[inline(always)]
    pub fn ale(&mut self) -> ALE_W<'_, RAM3CRrs> {
        ALE_W::new(self, 4)
    }
    ///Bit 8 - SRAMER
    #[inline(always)]
    pub fn sramer(&mut self) -> SRAMER_W<'_, RAM3CRrs> {
        SRAMER_W::new(self, 8)
    }
    ///Bits 16:18 - WSC
    #[inline(always)]
    pub fn wsc(&mut self) -> WSC_W<'_, RAM3CRrs> {
        WSC_W::new(self, 16)
    }
}
/**RAMCFG SRAM x control register

You can [`read`](crate::Reg::read) this register and get [`ram3cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram3cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
