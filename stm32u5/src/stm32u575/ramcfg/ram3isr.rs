...
#[doc = "RAMCFG RAMx interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram3isr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAM3ISRrs;
impl crate::RegisterSpec for RAM3ISRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram3isr::R`](R) reader structure"]
impl crate::Readable for RAM3ISRrs {}
#[doc = "`reset()` method sets RAM3ISR to value 0"]
