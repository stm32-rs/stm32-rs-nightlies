#[doc = "Register `RAM5ICR` reader"]
pub type R = crate::R<RAM5ICRrs>;
#[doc = "Register `RAM5ICR` writer"]
...
#[doc = "RAMCFG RAM x interrupt clear register x\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram5icr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ram5icr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAM5ICRrs;
impl crate::RegisterSpec for RAM5ICRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram5icr::R`](R) reader structure"]
impl crate::Readable for RAM5ICRrs {}
#[doc = "`write(|w| ..)` method takes [`ram5icr::W`](W) writer structure"]
impl crate::Writable for RAM5ICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM5ICR to value 0"]
