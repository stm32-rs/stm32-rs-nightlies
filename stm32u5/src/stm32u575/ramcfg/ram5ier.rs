...
impl W {
    ///Bit 0 - SEIE
    #[inline(always)]
    pub fn seie(&mut self) -> SEIE_W<'_, RAM5IERrs> {
        SEIE_W::new(self, 0)
    }
    ///Bit 1 - DEIE
    #[inline(always)]
    pub fn deie(&mut self) -> DEIE_W<'_, RAM5IERrs> {
        DEIE_W::new(self, 1)
    }
    ///Bit 3 - ECCNMI
    #[inline(always)]
    pub fn eccnmi(&mut self) -> ECCNMI_W<'_, RAM5IERrs> {
        ECCNMI_W::new(self, 3)
    }
}
/**RAMCFG SRAM x interrupt enable register

You can [`read`](crate::Reg::read) this register and get [`ram5ier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram5ier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
