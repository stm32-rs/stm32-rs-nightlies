...
#[doc = "Field `CCFIE` reader - Computation complete flag interrupt enable"]
pub type CCFIE_R = crate::BitReader;
#[doc = "Field `CCFIE` writer - Computation complete flag interrupt enable"]
pub type CCFIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWEIE` reader - Read or write error interrupt enable"]
pub type RWEIE_R = crate::BitReader;
#[doc = "Field `RWEIE` writer - Read or write error interrupt enable"]
pub type RWEIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `KEIE` reader - Key error interrupt enable"]
pub type KEIE_R = crate::BitReader;
#[doc = "Field `KEIE` writer - Key error interrupt enable"]
pub type KEIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RNGEIE` reader - RNGEIE"]
pub type RNGEIE_R = crate::BitReader;
#[doc = "Field `RNGEIE` writer - RNGEIE"]
pub type RNGEIE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Computation complete flag interrupt enable"]
    #[inline(always)]
    pub fn ccfie(&self) -> CCFIE_R {
        CCFIE_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Read or write error interrupt enable"]
    #[inline(always)]
    pub fn rweie(&self) -> RWEIE_R {
        RWEIE_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Key error interrupt enable"]
    #[inline(always)]
