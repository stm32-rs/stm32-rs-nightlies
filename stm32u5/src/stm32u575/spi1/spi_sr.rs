...
You can [`read`](crate::Reg::read) this register and get [`spi_sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`reset()` method sets SPI_SR to value 0x1002
