...
pub type R = crate::R<TAMP_ATCR1rs>;
///Register `TAMP_ATCR1` writer
pub type W = crate::W<TAMP_ATCR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tamp1am(&mut self) -> TAMP1AM_W<TAMP_ATCR1rs> {
        TAMP1AM_W::new(self, 0)
    }
    ///Bit 1 - Tamper 2 active mode
    #[inline(always)]
    #[must_use]
    pub fn tamp2am(&mut self) -> TAMP2AM_W<TAMP_ATCR1rs> {
        TAMP2AM_W::new(self, 1)
    }
    ///Bit 2 - Tamper 3 active mode
    #[inline(always)]
    #[must_use]
    pub fn tamp3am(&mut self) -> TAMP3AM_W<TAMP_ATCR1rs> {
        TAMP3AM_W::new(self, 2)
    }
    ///Bit 3 - Tamper 4 active mode
    #[inline(always)]
    #[must_use]
    pub fn tamp4am(&mut self) -> TAMP4AM_W<TAMP_ATCR1rs> {
        TAMP4AM_W::new(self, 3)
    }
    ///Bit 4 - Tamper 5 active mode
    #[inline(always)]
    #[must_use]
    pub fn tamp5am(&mut self) -> TAMP5AM_W<TAMP_ATCR1rs> {
        TAMP5AM_W::new(self, 4)
    }
    ///Bit 5 - Tamper 6 active mode
    #[inline(always)]
    #[must_use]
    pub fn tamp6am(&mut self) -> TAMP6AM_W<TAMP_ATCR1rs> {
        TAMP6AM_W::new(self, 5)
    }
    ///Bit 6 - Tamper 7 active mode
    #[inline(always)]
    #[must_use]
    pub fn tamp7am(&mut self) -> TAMP7AM_W<TAMP_ATCR1rs> {
        TAMP7AM_W::new(self, 6)
    }
    ///Bit 7 - Tamper 8 active mode
    #[inline(always)]
    #[must_use]
    pub fn tamp8am(&mut self) -> TAMP8AM_W<TAMP_ATCR1rs> {
        TAMP8AM_W::new(self, 7)
    }
    ///Bits 8:9 - Active tamper shared output 1 selection The selected output must be available in the package pinout
    #[inline(always)]
    #[must_use]
    pub fn atosel1(&mut self) -> ATOSEL1_W<TAMP_ATCR1rs> {
        ATOSEL1_W::new(self, 8)
    }
    ///Bits 10:11 - Active tamper shared output 2 selection The selected output must be available in the package pinout
    #[inline(always)]
    #[must_use]
    pub fn atosel2(&mut self) -> ATOSEL2_W<TAMP_ATCR1rs> {
        ATOSEL2_W::new(self, 10)
    }
    ///Bits 12:13 - Active tamper shared output 3 selection The selected output must be available in the package pinout
    #[inline(always)]
    #[must_use]
    pub fn atosel3(&mut self) -> ATOSEL3_W<TAMP_ATCR1rs> {
        ATOSEL3_W::new(self, 12)
    }
    ///Bits 14:15 - Active tamper shared output 4 selection The selected output must be available in the package pinout.
    #[inline(always)]
    #[must_use]
    pub fn atosel4(&mut self) -> ATOSEL4_W<TAMP_ATCR1rs> {
        ATOSEL4_W::new(self, 14)
    }
    ///Bits 16:18 - Active tamper RTC asynchronous prescaler clock selection These bits selects the RTC asynchronous prescaler stage output.The selected clock is CK_ATPRE. fCK_ATPRE = fRTCCLK / 2ATCKSEL when (PREDIV_A+1) = 128. ... These bits can be written only when all active tampers are disabled. The write protection remains for up to 1.5 ck_atpre cycles after all the active tampers are disable.
    #[inline(always)]
    #[must_use]
    pub fn atcksel(&mut self) -> ATCKSEL_W<TAMP_ATCR1rs> {
        ATCKSEL_W::new(self, 16)
    }
    ///Bits 24:26 - Active tamper output change period The tamper output is changed every CK_ATPER = (2ATPER x CK_ATPRE) cycles. Refer to .
    #[inline(always)]
    #[must_use]
    pub fn atper(&mut self) -> ATPER_W<TAMP_ATCR1rs> {
        ATPER_W::new(self, 24)
    }
    ///Bit 30 - Active tamper output sharing TAMP_IN1 is compared with TAMPOUTSEL1 TAMP_IN2 is compared with TAMPOUTSEL2 TAMP_IN3 is compared with TAMPOUTSEL3 TAMP_IN4 is compared with TAMPOUTSEL4 TAMP_IN5 is compared with TAMPOUTSEL5 TAMP_IN6 is compared with TAMPOUTSEL6 TAMP_IN7 is compared with TAMPOUTSEL7 TAMP_IN8 is compared with TAMPOUTSEL8
    #[inline(always)]
    #[must_use]
    pub fn atoshare(&mut self) -> ATOSHARE_W<TAMP_ATCR1rs> {
        ATOSHARE_W::new(self, 30)
    }
    ///Bit 31 - Active tamper filter enable
    #[inline(always)]
    #[must_use]
    pub fn flten(&mut self) -> FLTEN_W<TAMP_ATCR1rs> {
        FLTEN_W::new(self, 31)
    }
}
/**TAMP active tamper control register 1

You can [`read`](crate::Reg::read) this register and get [`tamp_atcr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tamp_atcr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#TAMP:TAMP_ATCR1)*/
pub struct TAMP_ATCR1rs;
impl crate::RegisterSpec for TAMP_ATCR1rs {
    type Ux = u32;
}
///`read()` method returns [`tamp_atcr1::R`](R) reader structure
impl crate::Readable for TAMP_ATCR1rs {}
///`write(|w| ..)` method takes [`tamp_atcr1::W`](W) writer structure
impl crate::Writable for TAMP_ATCR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TAMP_ATCR1 to value 0x0007_0000
impl crate::Resettable for TAMP_ATCR1rs {
