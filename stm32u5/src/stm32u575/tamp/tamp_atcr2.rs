...
pub type R = crate::R<TAMP_ATCR2rs>;
///Register `TAMP_ATCR2` writer
pub type W = crate::W<TAMP_ATCR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn atosel1(&mut self) -> ATOSEL1_W<TAMP_ATCR2rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn atosel2(&mut self) -> ATOSEL2_W<TAMP_ATCR2rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn atosel3(&mut self) -> ATOSEL3_W<TAMP_ATCR2rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn atosel4(&mut self) -> ATOSEL4_W<TAMP_ATCR2rs> {
        ATOSEL4_W::new(self, 17)
    }
    ///Bits 20:22 - Active tamper shared output 5 selection The selected output must be available in the package pinout.
    #[inline(always)]
    #[must_use]
    pub fn atosel5(&mut self) -> ATOSEL5_W<TAMP_ATCR2rs> {
        ATOSEL5_W::new(self, 20)
    }
    ///Bits 23:25 - Active tamper shared output 6 selection The selected output must be available in the package pinout.
    #[inline(always)]
    #[must_use]
    pub fn atosel6(&mut self) -> ATOSEL6_W<TAMP_ATCR2rs> {
        ATOSEL6_W::new(self, 23)
    }
    ///Bits 26:28 - Active tamper shared output 7 selection The selected output must be available in the package pinout.
    #[inline(always)]
    #[must_use]
    pub fn atosel7(&mut self) -> ATOSEL7_W<TAMP_ATCR2rs> {
        ATOSEL7_W::new(self, 26)
    }
    ///Bits 29:31 - Active tamper shared output 8 selection The selected output must be available in the package pinout.
    #[inline(always)]
    #[must_use]
    pub fn atosel8(&mut self) -> ATOSEL8_W<TAMP_ATCR2rs> {
        ATOSEL8_W::new(self, 29)
    }
}
/**TAMP active tamper control register 2

You can [`read`](crate::Reg::read) this register and get [`tamp_atcr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tamp_atcr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#TAMP:TAMP_ATCR2)*/
pub struct TAMP_ATCR2rs;
impl crate::RegisterSpec for TAMP_ATCR2rs {
    type Ux = u32;
}
///`read()` method returns [`tamp_atcr2::R`](R) reader structure
impl crate::Readable for TAMP_ATCR2rs {}
///`write(|w| ..)` method takes [`tamp_atcr2::W`](W) writer structure
impl crate::Writable for TAMP_ATCR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TAMP_ATCR2 to value 0
impl crate::Resettable for TAMP_ATCR2rs {
