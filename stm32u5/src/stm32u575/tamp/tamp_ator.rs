...
pub type R = crate::R<TAMP_ATORrs>;
...
You can [`read`](crate::Reg::read) this register and get [`tamp_ator::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#TAMP:TAMP_ATOR)*/
pub struct TAMP_ATORrs;
impl crate::RegisterSpec for TAMP_ATORrs {
    type Ux = u32;
}
///`read()` method returns [`tamp_ator::R`](R) reader structure
impl crate::Readable for TAMP_ATORrs {}
///`reset()` method sets TAMP_ATOR to value 0
impl crate::Resettable for TAMP_ATORrs {
