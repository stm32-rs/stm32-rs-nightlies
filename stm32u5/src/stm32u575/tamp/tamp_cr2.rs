///Register `TAMP_CR2` reader
pub type R = crate::R<TAMP_CR2rs>;
///Register `TAMP_CR2` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#TAMP:TAMP_CR2)*/
pub struct TAMP_CR2rs;
impl crate::RegisterSpec for TAMP_CR2rs {
    type Ux = u32;
}
///`read()` method returns [`tamp_cr2::R`](R) reader structure
impl crate::Readable for TAMP_CR2rs {}
///`write(|w| ..)` method takes [`tamp_cr2::W`](W) writer structure
impl crate::Writable for TAMP_CR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TAMP_CR2 to value 0
