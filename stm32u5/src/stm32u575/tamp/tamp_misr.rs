...
///Field `ITAMP7MF` reader - VCORE monitoring tamper non-secure interrupt masked flag This flag is set by hardware when the internal tamper 7 non-secure interrupt is raised.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#TAMP:TAMP_MISR)*/
