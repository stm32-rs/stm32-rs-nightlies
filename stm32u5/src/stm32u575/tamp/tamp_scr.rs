...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn citamp7f(&mut self) -> CITAMP7F_W<TAMP_SCRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn citamp9f(&mut self) -> CITAMP9F_W<TAMP_SCRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn citamp11f(&mut self) -> CITAMP11F_W<TAMP_SCRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn citamp12f(&mut self) -> CITAMP12F_W<TAMP_SCRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn citamp13f(&mut self) -> CITAMP13F_W<TAMP_SCRrs> {
