...
pub type R = crate::R<TAMP_SECCFGRrs>;
#[doc = "Register `TAMP_SECCFGR` writer"]
pub type W = crate::W<TAMP_SECCFGRrs>;
...
#[doc = "Field `BKPWSEC` reader - Backup registers write protection offset Protection zone 2 is defined for backup registers from TAMP_BKPyR (y = BKPRWSEC, from 0 to 128) to TAMP_BKPzR (z = BKPWSEC-1, from 0 to 128, BKPWSEC \u{89}¥ BKPRWSEC): if TZEN=1, these backup registers can be written only with secure access. They can be read with secure or non-secure access. Protection zone 3 defined for backup registers from TAMP_BKPtR (t = BKPWSEC, from 0 to 127). They can be read or written with secure or non-secure access. If TZEN=0: the protection zone 2 can be read and written with non-secure access. If BKPWSEC = 0 or if BKPWSEC \u{89}¤ BKPRWSEC: there is no protection zone 2. If BKPWPRIV is set, BKPRWSEC\\[7:0\\]
can be written only in privileged mode."]
pub type BKPWSEC_R = crate::FieldReader;
#[doc = "Field `BKPWSEC` writer - Backup registers write protection offset Protection zone 2 is defined for backup registers from TAMP_BKPyR (y = BKPRWSEC, from 0 to 128) to TAMP_BKPzR (z = BKPWSEC-1, from 0 to 128, BKPWSEC \u{89}¥ BKPRWSEC): if TZEN=1, these backup registers can be written only with secure access. They can be read with secure or non-secure access. Protection zone 3 defined for backup registers from TAMP_BKPtR (t = BKPWSEC, from 0 to 127). They can be read or written with secure or non-secure access. If TZEN=0: the protection zone 2 can be read and written with non-secure access. If BKPWSEC = 0 or if BKPWSEC \u{89}¤ BKPRWSEC: there is no protection zone 2. If BKPWPRIV is set, BKPRWSEC\\[7:0\\]
can be written only in privileged mode."]
...
can be written only in privileged mode."]
    ...
    #[doc = "Bits 16:23 - Backup registers write protection offset Protection zone 2 is defined for backup registers from TAMP_BKPyR (y = BKPRWSEC, from 0 to 128) to TAMP_BKPzR (z = BKPWSEC-1, from 0 to 128, BKPWSEC \u{89}¥ BKPRWSEC): if TZEN=1, these backup registers can be written only with secure access. They can be read with secure or non-secure access. Protection zone 3 defined for backup registers from TAMP_BKPtR (t = BKPWSEC, from 0 to 127). They can be read or written with secure or non-secure access. If TZEN=0: the protection zone 2 can be read and written with non-secure access. If BKPWSEC = 0 or if BKPWSEC \u{89}¤ BKPRWSEC: there is no protection zone 2. If BKPWPRIV is set, BKPRWSEC\\[7:0\\]
can be written only in privileged mode."]
    #[inline(always)]
...
can be written only in privileged mode."]
    #[inline(always)]
    #[must_use]
    pub fn bkprwsec(&mut self) -> BKPRWSEC_W<TAMP_SECCFGRrs> {
        BKPRWSEC_W::new(self, 0)
    }
    #[doc = "Bit 15 - Monotonic counter 1 secure protection"]
    #[inline(always)]
    #[must_use]
    pub fn cnt1sec(&mut self) -> CNT1SEC_W<TAMP_SECCFGRrs> {
...
can be written only in privileged mode."]
    #[inline(always)]
    #[must_use]
    pub fn bkpwsec(&mut self) -> BKPWSEC_W<TAMP_SECCFGRrs> {
        BKPWSEC_W::new(self, 16)
    }
    #[doc = "Bit 30 - Boot hardware key lock This bit can be read and can only be written to 1 by software. It is cleared by hardware together with the backup registers following a tamper detection event or when the readout protection (RDP) is disabled."]
    #[inline(always)]
    #[must_use]
    pub fn bhklock(&mut self) -> BHKLOCK_W<TAMP_SECCFGRrs> {
        BHKLOCK_W::new(self, 30)
    }
    #[doc = "Bit 31 - Tamper protection (excluding monotonic counters and backup registers) Note: Refer to for details on the read protection."]
    #[inline(always)]
    #[must_use]
    pub fn tampsec(&mut self) -> TAMPSEC_W<TAMP_SECCFGRrs> {
        TAMPSEC_W::new(self, 31)
    }
}
#[doc = "TAMP secure mode register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tamp_seccfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tamp_seccfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TAMP_SECCFGRrs;
impl crate::RegisterSpec for TAMP_SECCFGRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tamp_seccfgr::R`](R) reader structure"]
impl crate::Readable for TAMP_SECCFGRrs {}
#[doc = "`write(|w| ..)` method takes [`tamp_seccfgr::W`](W) writer structure"]
impl crate::Writable for TAMP_SECCFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TAMP_SECCFGR to value 0"]
impl crate::Resettable for TAMP_SECCFGRrs {
