...
///Field `TS1` reader - Trigger selection - bit 4:3 Refer to TS\[2:0\] description - bits 6:4 null Trigger selection This bitfield is combined with TS\[4:3\] bits. This bit-field selects the trigger input to be used to synchronize the counter. others: Reserved See for more details on tim_itrx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
