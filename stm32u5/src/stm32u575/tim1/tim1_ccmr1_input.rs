...
#[doc = "Field `IC1PSC` reader - Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (tim_ic1). The prescaler is reset as soon as CC1E=â\u{80}\u{99}0â\u{80}\u{99} (TIMx_CCER register)."]
pub type IC1PSC_R = crate::FieldReader;
#[doc = "Field `IC1PSC` writer - Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (tim_ic1). The prescaler is reset as soon as CC1E=â\u{80}\u{99}0â\u{80}\u{99} (TIMx_CCER register)."]
...
impl R {
    ...
    #[doc = "Bits 2:3 - Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (tim_ic1). The prescaler is reset as soon as CC1E=â\u{80}\u{99}0â\u{80}\u{99} (TIMx_CCER register)."]
    #[inline(always)]
