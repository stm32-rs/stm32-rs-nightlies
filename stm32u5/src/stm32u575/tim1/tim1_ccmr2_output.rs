...
pub type R = crate::R<TIM1_CCMR2_OUTPUTrs>;
#[doc = "Register `TIM1_CCMR2_Output` writer"]
pub type W = crate::W<TIM1_CCMR2_OUTPUTrs>;
#[doc = "Field `CC3S_1_0` reader - Capture/Compare 3 selection"]
pub type CC3S_1_0_R = crate::FieldReader;
#[doc = "Field `CC3S_1_0` writer - Capture/Compare 3 selection"]
...
#[doc = "Field `OC3M_2_0` reader - Output compare 3 mode"]
pub type OC3M_2_0_R = crate::FieldReader;
#[doc = "Field `OC3M_2_0` writer - Output compare 3 mode"]
...
#[doc = "Field `CC4S_1_0` reader - Capture/Compare 4 selection"]
pub type CC4S_1_0_R = crate::FieldReader;
#[doc = "Field `CC4S_1_0` writer - Capture/Compare 4 selection"]
...
#[doc = "Field `OC4M_3_0` reader - Output compare 4 mode"]
pub type OC4M_3_0_R = crate::FieldReader;
#[doc = "Field `OC4M_3_0` writer - Output compare 4 mode"]
...
#[doc = "Field `OC3M_3` reader - Output compare 3 mode"]
pub type OC3M_3_R = crate::BitReader;
#[doc = "Field `OC3M_3` writer - Output compare 3 mode"]
pub type OC3M_3_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OC4M_bit3` reader - Output Compare 4 mode - bit 3"]
pub type OC4M_BIT3_R = crate::BitReader;
#[doc = "Field `OC4M_bit3` writer - Output Compare 4 mode - bit 3"]
...
impl R {
    ...
    #[doc = "Bit 16 - Output compare 3 mode"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3s_1_0(&mut self) -> CC3S_1_0_W<TIM1_CCMR2_OUTPUTrs> {
        CC3S_1_0_W::new(self, 0)
    }
    #[doc = "Bit 2 - Output compare 3 fast enable"]
    #[inline(always)]
    #[must_use]
    pub fn oc3fe(&mut self) -> OC3FE_W<TIM1_CCMR2_OUTPUTrs> {
        OC3FE_W::new(self, 2)
    }
    #[doc = "Bit 3 - Output compare 3 preload enable"]
    #[inline(always)]
    #[must_use]
    pub fn oc3pe(&mut self) -> OC3PE_W<TIM1_CCMR2_OUTPUTrs> {
        OC3PE_W::new(self, 3)
    }
    #[doc = "Bits 4:6 - Output compare 3 mode"]
    #[inline(always)]
    #[must_use]
    pub fn oc3m_2_0(&mut self) -> OC3M_2_0_W<TIM1_CCMR2_OUTPUTrs> {
        OC3M_2_0_W::new(self, 4)
    }
    #[doc = "Bit 7 - Output compare 3 clear enable"]
    #[inline(always)]
    #[must_use]
    pub fn oc3ce(&mut self) -> OC3CE_W<TIM1_CCMR2_OUTPUTrs> {
        OC3CE_W::new(self, 7)
    }
    #[doc = "Bits 8:9 - Capture/Compare 4 selection"]
    #[inline(always)]
    #[must_use]
    pub fn cc4s_1_0(&mut self) -> CC4S_1_0_W<TIM1_CCMR2_OUTPUTrs> {
        CC4S_1_0_W::new(self, 8)
    }
    #[doc = "Bit 10 - Output compare 4 fast enable"]
    #[inline(always)]
    #[must_use]
    pub fn oc4fe(&mut self) -> OC4FE_W<TIM1_CCMR2_OUTPUTrs> {
        OC4FE_W::new(self, 10)
    }
    #[doc = "Bit 11 - Output compare 4 preload enable"]
    #[inline(always)]
    #[must_use]
    pub fn oc4pe(&mut self) -> OC4PE_W<TIM1_CCMR2_OUTPUTrs> {
        OC4PE_W::new(self, 11)
    }
    #[doc = "Bits 12:14 - Output compare 4 mode"]
    #[inline(always)]
    #[must_use]
    pub fn oc4m_3_0(&mut self) -> OC4M_3_0_W<TIM1_CCMR2_OUTPUTrs> {
        OC4M_3_0_W::new(self, 12)
    }
    #[doc = "Bit 15 - Output compare 4 clear enable"]
    #[inline(always)]
    #[must_use]
    pub fn oc4ce(&mut self) -> OC4CE_W<TIM1_CCMR2_OUTPUTrs> {
        OC4CE_W::new(self, 15)
    }
    #[doc = "Bit 16 - Output compare 3 mode"]
    #[inline(always)]
    #[must_use]
    pub fn oc3m_3(&mut self) -> OC3M_3_W<TIM1_CCMR2_OUTPUTrs> {
        OC3M_3_W::new(self, 16)
    }
    #[doc = "Bit 24 - Output Compare 4 mode - bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn oc4m_bit3(&mut self) -> OC4M_BIT3_W<TIM1_CCMR2_OUTPUTrs> {
...
pub struct TIM1_CCMR2_OUTPUTrs;
impl crate::RegisterSpec for TIM1_CCMR2_OUTPUTrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tim1_ccmr2_output::R`](R) reader structure"]
impl crate::Readable for TIM1_CCMR2_OUTPUTrs {}
#[doc = "`write(|w| ..)` method takes [`tim1_ccmr2_output::W`](W) writer structure"]
impl crate::Writable for TIM1_CCMR2_OUTPUTrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIM1_CCMR2_Output to value 0"]
impl crate::Resettable for TIM1_CCMR2_OUTPUTrs {
