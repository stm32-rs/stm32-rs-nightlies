...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn oc5m1(&mut self) -> OC5M1_W<TIM1_CCMR3rs> {
        OC5M1_W::new(self, 4)
    }
    ///Bit 7 - Output compare 5 clear enable
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn oc6m1(&mut self) -> OC6M1_W<TIM1_CCMR3rs> {
        OC6M1_W::new(self, 12)
    }
    ///Bit 15 - Output compare 6 clear enable
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn oc5m2(&mut self) -> OC5M2_W<TIM1_CCMR3rs> {
        OC5M2_W::new(self, 16)
    }
    ///Bit 24 - Output compare 6 mode
    #[inline(always)]
    #[must_use]
    pub fn oc6m2(&mut self) -> OC6M2_W<TIM1_CCMR3rs> {
        OC6M2_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#TIM1:TIM1_CCMR3)*/
