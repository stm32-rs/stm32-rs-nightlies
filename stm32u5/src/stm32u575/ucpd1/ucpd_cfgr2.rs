///Register `UCPD_CFGR2` reader
pub type R = crate::R<UCPD_CFGR2rs>;
///Register `UCPD_CFGR2` writer
...
You can [`read`](crate::Reg::read) this register and get [`ucpd_cfgr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucpd_cfgr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`ucpd_cfgr2::R`](R) reader structure
impl crate::Readable for UCPD_CFGR2rs {}
///`write(|w| ..)` method takes [`ucpd_cfgr2::W`](W) writer structure
impl crate::Writable for UCPD_CFGR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets UCPD_CFGR2 to value 0
