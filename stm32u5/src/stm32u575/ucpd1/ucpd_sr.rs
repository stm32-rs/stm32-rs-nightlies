///Register `UCPD_SR` reader
pub type R = crate::R<UCPD_SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`ucpd_sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U575.html#UCPD1:UCPD_SR)*/
pub struct UCPD_SRrs;
impl crate::RegisterSpec for UCPD_SRrs {
    type Ux = u32;
}
///`read()` method returns [`ucpd_sr::R`](R) reader structure
impl crate::Readable for UCPD_SRrs {}
///`reset()` method sets UCPD_SR to value 0
impl crate::Resettable for UCPD_SRrs {
