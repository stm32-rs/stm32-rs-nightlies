...
impl RegisterBlock {
    ...
    #[doc = "0x70 - ADC gain compensation register"]
    #[inline(always)]
    ...
    #[doc = "0xa8 - ADC watchdog threshold register 1"]
    #[inline(always)]
    pub const fn adc_ltr1(&self) -> &ADC_LTR1 {
        &self.adc_ltr1
    }
    #[doc = "0xac - ADC watchdog threshold register 1"]
    #[inline(always)]
    ...
    #[doc = "0xc4 - ADC user control register"]
    #[inline(always)]
    pub const fn adc_calfact(&self) -> &ADC_CALFACT {
        &self.adc_calfact
    }
    #[doc = "0xc8 - ADC calibration factor register"]
    #[inline(always)]
...
#[doc = "ADC offset register"]
pub mod adc_ofr4;
#[doc = "ADC_GCOMP (rw) register accessor: ADC gain compensation register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adc_gcomp::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adc_gcomp::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@adc_gcomp`]
module"]
