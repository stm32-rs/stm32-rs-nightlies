...
///Field `LATCH_COEF` reader - Calibration factor latch enable bit This bit latches the calibration factor in the CALFACT\[31:0\] bits.
...
///Field `LATCH_COEF` writer - Calibration factor latch enable bit This bit latches the calibration factor in the CALFACT\[31:0\] bits.
...
impl W {
    ///Bit 24 - Calibration factor latch enable bit This bit latches the calibration factor in the CALFACT\[31:0\] bits.
    #[inline(always)]
    pub fn latch_coef(&mut self) -> LATCH_COEF_W<'_, CALFACTrs> {
        LATCH_COEF_W::new(self, 24)
    }
    ///Bit 25 - Calibration factor capture enable bit This bit enables the internal calibration factor capture.
    #[inline(always)]
    pub fn capture_coef(&mut self) -> CAPTURE_COEF_W<'_, CALFACTrs> {
