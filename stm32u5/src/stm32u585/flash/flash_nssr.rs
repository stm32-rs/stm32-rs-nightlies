...
#[doc = "Field `EOP` reader - Non-secure end of operation"]
pub type EOP_R = crate::BitReader;
#[doc = "Field `EOP` writer - Non-secure end of operation"]
pub type EOP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OPERR` reader - Non-secure operation error"]
pub type OPERR_R = crate::BitReader;
#[doc = "Field `OPERR` writer - Non-secure operation error"]
...
#[doc = "Field `WRPERR` reader - Non-secure write protection error This bit is set by hardware when an non-secure address to be erased/programmed belongs to a write-protected part (by WRP, HDP or RDP level 1) of the Flash memory. This bit is cleared by writing 1. Refer to for full conditions of error flag setting."]
pub type WRPERR_R = crate::BitReader;
#[doc = "Field `WRPERR` writer - Non-secure write protection error This bit is set by hardware when an non-secure address to be erased/programmed belongs to a write-protected part (by WRP, HDP or RDP level 1) of the Flash memory. This bit is cleared by writing 1. Refer to for full conditions of error flag setting."]
...
impl R {
    #[doc = "Bit 0 - Non-secure end of operation"]
    #[inline(always)]
    pub fn eop(&self) -> EOP_R {
        EOP_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Non-secure operation error"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Non-secure write protection error This bit is set by hardware when an non-secure address to be erased/programmed belongs to a write-protected part (by WRP, HDP or RDP level 1) of the Flash memory. This bit is cleared by writing 1. Refer to for full conditions of error flag setting."]
    #[inline(always)]
