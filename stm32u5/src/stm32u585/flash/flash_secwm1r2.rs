...
impl R {
    #[doc = "Bits 16:22 - End page of first hide protection area This field contains the last page of the HDP area in bank 1."]
    #[inline(always)]
...
#[doc = "`reset()` method sets FLASH_SECWM1R2 to value 0x0f00_ffff"]
