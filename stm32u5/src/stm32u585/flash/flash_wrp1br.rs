...
impl R {
    #[doc = "Bits 0:6 - Bank 1 WRP second area B start page This field contains the first page of the second WRP area for bank 1."]
    #[inline(always)]
    pub fn wrp1b_pstrt(&self) -> WRP1B_PSTRT_R {
        WRP1B_PSTRT_R::new((self.bits & 0x7f) as u8)
    }
    #[doc = "Bits 16:22 - Bank 1 WRP second area B end page This field contains the last page of the second WRP area in bank 1."]
    #[inline(always)]
