...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cclken(&mut self) -> CCLKEN_W<BCR4rs> {
        CCLKEN_W::new(self, 20)
    }
    ///Bit 21 - Write FIFO disable
    #[inline(always)]
    #[must_use]
    pub fn wfdis(&mut self) -> WFDIS_W<BCR4rs> {
        WFDIS_W::new(self, 21)
    }
    ///Bits 22:23 - Byte lane (NBL) setup
    #[inline(always)]
    #[must_use]
    pub fn nblset(&mut self) -> NBLSET_W<BCR4rs> {
        NBLSET_W::new(self, 22)
    }
    ///Bit 31 - FMC controller enable
    #[inline(always)]
    #[must_use]
    pub fn fmcen(&mut self) -> FMCEN_W<BCR4rs> {
        FMCEN_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#FMC:BCR4)*/
pub struct BCR4rs;
