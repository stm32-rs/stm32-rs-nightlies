///Register `C11SR` reader
pub type R = crate::R<C11SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c11sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#GPDMA1:C11SR)*/
pub struct C11SRrs;
impl crate::RegisterSpec for C11SRrs {
    type Ux = u32;
}
///`read()` method returns [`c11sr::R`](R) reader structure
impl crate::Readable for C11SRrs {}
///`reset()` method sets C11SR to value 0x01
impl crate::Resettable for C11SRrs {
