///Register `GPDMA_C0DAR` reader
pub type R = crate::R<GPDMA_C0DARrs>;
///Register `GPDMA_C0DAR` writer
pub type W = crate::W<GPDMA_C0DARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn da(&mut self) -> DA_W<GPDMA_C0DARrs> {
        DA_W::new(self, 0)
    }
}
/**GPDMA channel 0 destination address register

You can [`read`](crate::Reg::read) this register and get [`gpdma_c0dar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c0dar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#GPDMA1:GPDMA_C0DAR)*/
pub struct GPDMA_C0DARrs;
impl crate::RegisterSpec for GPDMA_C0DARrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c0dar::R`](R) reader structure
impl crate::Readable for GPDMA_C0DARrs {}
///`write(|w| ..)` method takes [`gpdma_c0dar::W`](W) writer structure
impl crate::Writable for GPDMA_C0DARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C0DAR to value 0
impl crate::Resettable for GPDMA_C0DARrs {
