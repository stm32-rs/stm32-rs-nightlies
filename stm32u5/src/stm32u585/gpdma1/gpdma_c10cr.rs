///Register `GPDMA_C10CR` reader
pub type R = crate::R<GPDMA_C10CRrs>;
///Register `GPDMA_C10CR` writer
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn toie(&mut self) -> TOIE_W<GPDMA_C10CRrs> {
        TOIE_W::new(self, 14)
    }
    /**Bit 16 - Link step mode First the (possible 1D/repeated) block transfer is executed as defined by the current internal register file until GPDMA_CxBR1.BNDT\[15:0\]
    = 0 and GPDMA_CxBR1.BRC\[10:0\]
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c10cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c10cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`gpdma_c10cr::R`](R) reader structure
impl crate::Readable for GPDMA_C10CRrs {}
///`write(|w| ..)` method takes [`gpdma_c10cr::W`](W) writer structure
impl crate::Writable for GPDMA_C10CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C10CR to value 0
