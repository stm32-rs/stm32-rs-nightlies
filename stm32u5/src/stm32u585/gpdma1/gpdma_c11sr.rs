#[doc = "Register `GPDMA_C11SR` reader"]
...
#[doc = "GPDMA channel 11 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c11sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C11SRrs;
impl crate::RegisterSpec for GPDMA_C11SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c11sr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C11SRrs {}
#[doc = "`reset()` method sets GPDMA_C11SR to value 0x01"]
