///Register `GPDMA_C14LBAR` reader
pub type R = crate::R<GPDMA_C14LBARrs>;
///Register `GPDMA_C14LBAR` writer
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c14lbar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c14lbar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`gpdma_c14lbar::R`](R) reader structure
impl crate::Readable for GPDMA_C14LBARrs {}
///`write(|w| ..)` method takes [`gpdma_c14lbar::W`](W) writer structure
impl crate::Writable for GPDMA_C14LBARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C14LBAR to value 0
