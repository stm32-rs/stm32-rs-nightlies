///Register `GPDMA_C15BR1` reader
pub type R = crate::R<GPDMA_C15BR1rs>;
///Register `GPDMA_C15BR1` writer
pub type W = crate::W<GPDMA_C15BR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bndt(&mut self) -> BNDT_W<GPDMA_C15BR1rs> {
        BNDT_W::new(self, 0)
    }
    /**Bits 16:26 - Block repeat counter This field contains the number of repetitions of the current block (0 to 2047). When the channel is enabled, this field becomes read-only. After decrements, this field indicates the remaining number of blocks, excluding the current one. This counter is hardware decremented for each completed block transfer. Once the last block transfer is completed (BRC\[10:0\]
    = BNDT\[15:0\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn brc(&mut self) -> BRC_W<GPDMA_C15BR1rs> {
        BRC_W::new(self, 16)
    }
    ///Bit 28 - source address decrement
    #[inline(always)]
    #[must_use]
    pub fn sdec(&mut self) -> SDEC_W<GPDMA_C15BR1rs> {
        SDEC_W::new(self, 28)
    }
    ///Bit 29 - destination address decrement
    #[inline(always)]
    #[must_use]
    pub fn ddec(&mut self) -> DDEC_W<GPDMA_C15BR1rs> {
        DDEC_W::new(self, 29)
    }
    ///Bit 30 - Block repeat source address decrement Note: On top of this increment/decrement (depending on BRSDEC), GPDMA_CxSAR is in the same time also updated by the increment/decrement (depending on SDEC) of the GPDMA_CxTR3.SAO value, as it is done after any programmed burst transfer.
    #[inline(always)]
    #[must_use]
    pub fn brsdec(&mut self) -> BRSDEC_W<GPDMA_C15BR1rs> {
        BRSDEC_W::new(self, 30)
    }
    ///Bit 31 - Block repeat destination address decrement Note: On top of this increment/decrement (depending on BRDDEC), GPDMA_CxDAR is in the same time also updated by the increment/decrement (depending on DDEC) of the GPDMA_CxTR3.DAO value, as it is usually done at the end of each programmed burst transfer.
    #[inline(always)]
    #[must_use]
    pub fn brddec(&mut self) -> BRDDEC_W<GPDMA_C15BR1rs> {
        BRDDEC_W::new(self, 31)
    }
}
/**GPDMA channel 15 alternate block register 1

You can [`read`](crate::Reg::read) this register and get [`gpdma_c15br1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c15br1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#GPDMA1:GPDMA_C15BR1)*/
pub struct GPDMA_C15BR1rs;
impl crate::RegisterSpec for GPDMA_C15BR1rs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c15br1::R`](R) reader structure
impl crate::Readable for GPDMA_C15BR1rs {}
///`write(|w| ..)` method takes [`gpdma_c15br1::W`](W) writer structure
impl crate::Writable for GPDMA_C15BR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C15BR1 to value 0
impl crate::Resettable for GPDMA_C15BR1rs {
