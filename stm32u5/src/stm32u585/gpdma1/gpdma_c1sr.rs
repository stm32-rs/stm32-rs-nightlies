#[doc = "Register `GPDMA_C1SR` reader"]
...
#[doc = "GPDMA channel 1 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c1sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C1SRrs;
impl crate::RegisterSpec for GPDMA_C1SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c1sr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C1SRrs {}
#[doc = "`reset()` method sets GPDMA_C1SR to value 0x01"]
