///Register `GPDMA_C4SAR` reader
pub type R = crate::R<GPDMA_C4SARrs>;
///Register `GPDMA_C4SAR` writer
pub type W = crate::W<GPDMA_C4SARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sa(&mut self) -> SA_W<GPDMA_C4SARrs> {
        SA_W::new(self, 0)
    }
}
/**GPDMA channel 4 source address register

You can [`read`](crate::Reg::read) this register and get [`gpdma_c4sar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c4sar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#GPDMA1:GPDMA_C4SAR)*/
pub struct GPDMA_C4SARrs;
impl crate::RegisterSpec for GPDMA_C4SARrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c4sar::R`](R) reader structure
impl crate::Readable for GPDMA_C4SARrs {}
///`write(|w| ..)` method takes [`gpdma_c4sar::W`](W) writer structure
impl crate::Writable for GPDMA_C4SARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C4SAR to value 0
impl crate::Resettable for GPDMA_C4SARrs {
