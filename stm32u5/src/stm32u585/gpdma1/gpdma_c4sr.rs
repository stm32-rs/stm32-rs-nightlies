#[doc = "Register `GPDMA_C4SR` reader"]
...
#[doc = "GPDMA channel 4 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c4sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C4SRrs;
impl crate::RegisterSpec for GPDMA_C4SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c4sr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C4SRrs {}
#[doc = "`reset()` method sets GPDMA_C4SR to value 0x01"]
