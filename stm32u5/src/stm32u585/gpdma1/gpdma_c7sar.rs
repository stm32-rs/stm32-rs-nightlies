#[doc = "Register `GPDMA_C7SAR` reader"]
pub type R = crate::R<GPDMA_C7SARrs>;
#[doc = "Register `GPDMA_C7SAR` writer"]
...
#[doc = "GPDMA channel 7 source address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c7sar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c7sar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C7SARrs;
impl crate::RegisterSpec for GPDMA_C7SARrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c7sar::R`](R) reader structure"]
impl crate::Readable for GPDMA_C7SARrs {}
#[doc = "`write(|w| ..)` method takes [`gpdma_c7sar::W`](W) writer structure"]
impl crate::Writable for GPDMA_C7SARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C7SAR to value 0"]
