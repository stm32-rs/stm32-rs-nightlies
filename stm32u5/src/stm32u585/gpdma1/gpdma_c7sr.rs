#[doc = "Register `GPDMA_C7SR` reader"]
...
#[doc = "GPDMA channel 7 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c7sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C7SRrs;
impl crate::RegisterSpec for GPDMA_C7SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c7sr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C7SRrs {}
#[doc = "`reset()` method sets GPDMA_C7SR to value 0x01"]
