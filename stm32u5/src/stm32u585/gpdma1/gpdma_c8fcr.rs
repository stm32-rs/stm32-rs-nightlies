#[doc = "Register `GPDMA_C8FCR` writer"]
...
#[doc = "GPDMA channel 8 flag clear register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c8fcr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C8FCRrs;
impl crate::RegisterSpec for GPDMA_C8FCRrs {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpdma_c8fcr::W`](W) writer structure"]
impl crate::Writable for GPDMA_C8FCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C8FCR to value 0"]
