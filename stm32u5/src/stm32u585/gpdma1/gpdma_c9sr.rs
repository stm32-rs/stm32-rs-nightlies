#[doc = "Register `GPDMA_C9SR` reader"]
pub type R = crate::R<GPDMA_C9SRrs>;
...
#[doc = "GPDMA channel 9 status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c9sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C9SRrs;
impl crate::RegisterSpec for GPDMA_C9SRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c9sr::R`](R) reader structure"]
impl crate::Readable for GPDMA_C9SRrs {}
#[doc = "`reset()` method sets GPDMA_C9SR to value 0x01"]
impl crate::Resettable for GPDMA_C9SRrs {
