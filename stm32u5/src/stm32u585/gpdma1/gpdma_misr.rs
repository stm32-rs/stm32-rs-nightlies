...
pub type R = crate::R<GPDMA_MISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_misr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#GPDMA1:GPDMA_MISR)*/
pub struct GPDMA_MISRrs;
impl crate::RegisterSpec for GPDMA_MISRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_misr::R`](R) reader structure
impl crate::Readable for GPDMA_MISRrs {}
///`reset()` method sets GPDMA_MISR to value 0
impl crate::Resettable for GPDMA_MISRrs {
