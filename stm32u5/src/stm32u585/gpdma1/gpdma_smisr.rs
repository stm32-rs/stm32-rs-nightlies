///Register `GPDMA_SMISR` reader
pub type R = crate::R<GPDMA_SMISRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_smisr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#GPDMA1:GPDMA_SMISR)*/
pub struct GPDMA_SMISRrs;
impl crate::RegisterSpec for GPDMA_SMISRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_smisr::R`](R) reader structure
impl crate::Readable for GPDMA_SMISRrs {}
///`reset()` method sets GPDMA_SMISR to value 0
impl crate::Resettable for GPDMA_SMISRrs {
