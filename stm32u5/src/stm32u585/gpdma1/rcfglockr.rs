...
impl W {
    ...
    ///Bit 8 - LOCK8
    #[inline(always)]
    pub fn lock8(&mut self) -> LOCK_W<'_, RCFGLOCKRrs> {
        LOCK_W::new(self, 8)
    }
    ///Bit 9 - LOCK9
    #[inline(always)]
    pub fn lock9(&mut self) -> LOCK_W<'_, RCFGLOCKRrs> {
        LOCK_W::new(self, 9)
    }
    ///Bit 10 - LOCK10
    #[inline(always)]
    pub fn lock10(&mut self) -> LOCK_W<'_, RCFGLOCKRrs> {
        LOCK_W::new(self, 10)
    }
    ///Bit 11 - LOCK11
    #[inline(always)]
    pub fn lock11(&mut self) -> LOCK_W<'_, RCFGLOCKRrs> {
        LOCK_W::new(self, 11)
    }
    ///Bit 12 - LOCK12
    #[inline(always)]
    pub fn lock12(&mut self) -> LOCK_W<'_, RCFGLOCKRrs> {
        LOCK_W::new(self, 12)
    }
    ///Bit 13 - LOCK13
    #[inline(always)]
    pub fn lock13(&mut self) -> LOCK_W<'_, RCFGLOCKRrs> {
        LOCK_W::new(self, 13)
    }
    ///Bit 14 - LOCK14
    #[inline(always)]
    pub fn lock14(&mut self) -> LOCK_W<'_, RCFGLOCKRrs> {
        LOCK_W::new(self, 14)
    }
    ///Bit 15 - LOCK15
    #[inline(always)]
    pub fn lock15(&mut self) -> LOCK_W<'_, RCFGLOCKRrs> {
        LOCK_W::new(self, 15)
    }
}
