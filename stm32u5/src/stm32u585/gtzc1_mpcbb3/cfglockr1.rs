...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SPLCK0` field.</div>
    #[inline(always)]
    pub fn splck(&mut self, n: u8) -> SPLCK_W<'_, CFGLOCKR1rs> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        SPLCK_W::new(self, n)
    }
    ///Bit 0 - SPLCK0
    #[inline(always)]
    pub fn splck0(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 0)
    }
    ///Bit 1 - SPLCK1
    #[inline(always)]
    pub fn splck1(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 1)
    }
    ///Bit 2 - SPLCK2
    #[inline(always)]
    pub fn splck2(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 2)
    }
    ///Bit 3 - SPLCK3
    #[inline(always)]
    pub fn splck3(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 3)
    }
    ///Bit 4 - SPLCK4
    #[inline(always)]
    pub fn splck4(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 4)
    }
    ///Bit 5 - SPLCK5
    #[inline(always)]
    pub fn splck5(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 5)
    }
    ///Bit 6 - SPLCK6
    #[inline(always)]
    pub fn splck6(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 6)
    }
    ///Bit 7 - SPLCK7
    #[inline(always)]
    pub fn splck7(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 7)
    }
    ///Bit 8 - SPLCK8
    #[inline(always)]
    pub fn splck8(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 8)
    }
    ///Bit 9 - SPLCK9
    #[inline(always)]
    pub fn splck9(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 9)
    }
    ///Bit 10 - SPLCK10
    #[inline(always)]
    pub fn splck10(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 10)
    }
    ///Bit 11 - SPLCK11
    #[inline(always)]
    pub fn splck11(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 11)
    }
    ///Bit 12 - SPLCK12
    #[inline(always)]
    pub fn splck12(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 12)
    }
    ///Bit 13 - SPLCK13
    #[inline(always)]
    pub fn splck13(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 13)
    }
    ///Bit 14 - SPLCK14
    #[inline(always)]
    pub fn splck14(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 14)
    }
    ///Bit 15 - SPLCK15
    #[inline(always)]
    pub fn splck15(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 15)
    }
    ///Bit 16 - SPLCK16
    #[inline(always)]
    pub fn splck16(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 16)
    }
    ///Bit 17 - SPLCK17
    #[inline(always)]
    pub fn splck17(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 17)
    }
    ///Bit 18 - SPLCK18
    #[inline(always)]
    pub fn splck18(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 18)
    }
    ///Bit 19 - SPLCK19
    #[inline(always)]
    pub fn splck19(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 19)
    }
    ///Bit 20 - SPLCK20
    #[inline(always)]
    pub fn splck20(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 20)
    }
    ///Bit 21 - SPLCK21
    #[inline(always)]
    pub fn splck21(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 21)
    }
    ///Bit 22 - SPLCK22
    #[inline(always)]
    pub fn splck22(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 22)
    }
    ///Bit 23 - SPLCK23
    #[inline(always)]
    pub fn splck23(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 23)
    }
    ///Bit 24 - SPLCK24
    #[inline(always)]
    pub fn splck24(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 24)
    }
    ///Bit 25 - SPLCK25
    #[inline(always)]
    pub fn splck25(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 25)
    }
    ///Bit 26 - SPLCK26
    #[inline(always)]
    pub fn splck26(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 26)
    }
    ///Bit 27 - SPLCK27
    #[inline(always)]
    pub fn splck27(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 27)
    }
    ///Bit 28 - SPLCK28
    #[inline(always)]
    pub fn splck28(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 28)
    }
    ///Bit 29 - SPLCK29
    #[inline(always)]
    pub fn splck29(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 29)
    }
    ///Bit 30 - SPLCK30
    #[inline(always)]
    pub fn splck30(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 30)
    }
    ///Bit 31 - SPLCK31
    #[inline(always)]
    pub fn splck31(&mut self) -> SPLCK_W<'_, CFGLOCKR1rs> {
        SPLCK_W::new(self, 31)
    }
}
