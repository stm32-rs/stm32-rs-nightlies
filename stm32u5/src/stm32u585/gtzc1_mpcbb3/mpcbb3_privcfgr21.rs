///Register `MPCBB3_PRIVCFGR21` reader
pub type R = crate::R<MPCBB3_PRIVCFGR21rs>;
///Register `MPCBB3_PRIVCFGR21` writer
pub type W = crate::W<MPCBB3_PRIVCFGR21rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB3_PRIVCFGR21")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn priv0(&mut self) -> PRIV0_W<MPCBB3_PRIVCFGR21rs> {
        PRIV0_W::new(self, 0)
    }
    ///Bit 1 - PRIV1
    #[inline(always)]
    #[must_use]
    pub fn priv1(&mut self) -> PRIV1_W<MPCBB3_PRIVCFGR21rs> {
        PRIV1_W::new(self, 1)
    }
    ///Bit 2 - PRIV2
    #[inline(always)]
    #[must_use]
    pub fn priv2(&mut self) -> PRIV2_W<MPCBB3_PRIVCFGR21rs> {
        PRIV2_W::new(self, 2)
    }
    ///Bit 3 - PRIV3
    #[inline(always)]
    #[must_use]
    pub fn priv3(&mut self) -> PRIV3_W<MPCBB3_PRIVCFGR21rs> {
        PRIV3_W::new(self, 3)
    }
    ///Bit 4 - PRIV4
    #[inline(always)]
    #[must_use]
    pub fn priv4(&mut self) -> PRIV4_W<MPCBB3_PRIVCFGR21rs> {
        PRIV4_W::new(self, 4)
    }
    ///Bit 5 - PRIV5
    #[inline(always)]
    #[must_use]
    pub fn priv5(&mut self) -> PRIV5_W<MPCBB3_PRIVCFGR21rs> {
        PRIV5_W::new(self, 5)
    }
    ///Bit 6 - PRIV6
    #[inline(always)]
    #[must_use]
    pub fn priv6(&mut self) -> PRIV6_W<MPCBB3_PRIVCFGR21rs> {
        PRIV6_W::new(self, 6)
    }
    ///Bit 7 - PRIV7
    #[inline(always)]
    #[must_use]
    pub fn priv7(&mut self) -> PRIV7_W<MPCBB3_PRIVCFGR21rs> {
        PRIV7_W::new(self, 7)
    }
    ///Bit 8 - PRIV8
    #[inline(always)]
    #[must_use]
    pub fn priv8(&mut self) -> PRIV8_W<MPCBB3_PRIVCFGR21rs> {
        PRIV8_W::new(self, 8)
    }
    ///Bit 9 - PRIV9
    #[inline(always)]
    #[must_use]
    pub fn priv9(&mut self) -> PRIV9_W<MPCBB3_PRIVCFGR21rs> {
        PRIV9_W::new(self, 9)
    }
    ///Bit 10 - PRIV10
    #[inline(always)]
    #[must_use]
    pub fn priv10(&mut self) -> PRIV10_W<MPCBB3_PRIVCFGR21rs> {
        PRIV10_W::new(self, 10)
    }
    ///Bit 11 - PRIV11
    #[inline(always)]
    #[must_use]
    pub fn priv11(&mut self) -> PRIV11_W<MPCBB3_PRIVCFGR21rs> {
        PRIV11_W::new(self, 11)
    }
    ///Bit 12 - PRIV12
    #[inline(always)]
    #[must_use]
    pub fn priv12(&mut self) -> PRIV12_W<MPCBB3_PRIVCFGR21rs> {
        PRIV12_W::new(self, 12)
    }
    ///Bit 13 - PRIV13
    #[inline(always)]
    #[must_use]
    pub fn priv13(&mut self) -> PRIV13_W<MPCBB3_PRIVCFGR21rs> {
        PRIV13_W::new(self, 13)
    }
    ///Bit 14 - PRIV14
    #[inline(always)]
    #[must_use]
    pub fn priv14(&mut self) -> PRIV14_W<MPCBB3_PRIVCFGR21rs> {
        PRIV14_W::new(self, 14)
    }
    ///Bit 15 - PRIV15
    #[inline(always)]
    #[must_use]
    pub fn priv15(&mut self) -> PRIV15_W<MPCBB3_PRIVCFGR21rs> {
        PRIV15_W::new(self, 15)
    }
    ///Bit 16 - PRIV16
    #[inline(always)]
    #[must_use]
    pub fn priv16(&mut self) -> PRIV16_W<MPCBB3_PRIVCFGR21rs> {
        PRIV16_W::new(self, 16)
    }
    ///Bit 17 - PRIV17
    #[inline(always)]
    #[must_use]
    pub fn priv17(&mut self) -> PRIV17_W<MPCBB3_PRIVCFGR21rs> {
        PRIV17_W::new(self, 17)
    }
    ///Bit 18 - PRIV18
    #[inline(always)]
    #[must_use]
    pub fn priv18(&mut self) -> PRIV18_W<MPCBB3_PRIVCFGR21rs> {
        PRIV18_W::new(self, 18)
    }
    ///Bit 19 - PRIV19
    #[inline(always)]
    #[must_use]
    pub fn priv19(&mut self) -> PRIV19_W<MPCBB3_PRIVCFGR21rs> {
        PRIV19_W::new(self, 19)
    }
    ///Bit 20 - PRIV20
    #[inline(always)]
    #[must_use]
    pub fn priv20(&mut self) -> PRIV20_W<MPCBB3_PRIVCFGR21rs> {
        PRIV20_W::new(self, 20)
    }
    ///Bit 21 - PRIV21
    #[inline(always)]
    #[must_use]
    pub fn priv21(&mut self) -> PRIV21_W<MPCBB3_PRIVCFGR21rs> {
        PRIV21_W::new(self, 21)
    }
    ///Bit 22 - PRIV22
    #[inline(always)]
    #[must_use]
    pub fn priv22(&mut self) -> PRIV22_W<MPCBB3_PRIVCFGR21rs> {
        PRIV22_W::new(self, 22)
    }
    ///Bit 23 - PRIV23
    #[inline(always)]
    #[must_use]
    pub fn priv23(&mut self) -> PRIV23_W<MPCBB3_PRIVCFGR21rs> {
        PRIV23_W::new(self, 23)
    }
    ///Bit 24 - PRIV24
    #[inline(always)]
    #[must_use]
    pub fn priv24(&mut self) -> PRIV24_W<MPCBB3_PRIVCFGR21rs> {
        PRIV24_W::new(self, 24)
    }
    ///Bit 25 - PRIV25
    #[inline(always)]
    #[must_use]
    pub fn priv25(&mut self) -> PRIV25_W<MPCBB3_PRIVCFGR21rs> {
        PRIV25_W::new(self, 25)
    }
    ///Bit 26 - PRIV26
    #[inline(always)]
    #[must_use]
    pub fn priv26(&mut self) -> PRIV26_W<MPCBB3_PRIVCFGR21rs> {
        PRIV26_W::new(self, 26)
    }
    ///Bit 27 - PRIV27
    #[inline(always)]
    #[must_use]
    pub fn priv27(&mut self) -> PRIV27_W<MPCBB3_PRIVCFGR21rs> {
        PRIV27_W::new(self, 27)
    }
    ///Bit 28 - PRIV28
    #[inline(always)]
    #[must_use]
    pub fn priv28(&mut self) -> PRIV28_W<MPCBB3_PRIVCFGR21rs> {
        PRIV28_W::new(self, 28)
    }
    ///Bit 29 - PRIV29
    #[inline(always)]
    #[must_use]
    pub fn priv29(&mut self) -> PRIV29_W<MPCBB3_PRIVCFGR21rs> {
        PRIV29_W::new(self, 29)
    }
    ///Bit 30 - PRIV30
    #[inline(always)]
    #[must_use]
    pub fn priv30(&mut self) -> PRIV30_W<MPCBB3_PRIVCFGR21rs> {
        PRIV30_W::new(self, 30)
    }
    ///Bit 31 - PRIV31
    #[inline(always)]
    #[must_use]
    pub fn priv31(&mut self) -> PRIV31_W<MPCBB3_PRIVCFGR21rs> {
        PRIV31_W::new(self, 31)
    }
}
/**MPCBB privileged configuration for super-block x register

You can [`read`](crate::Reg::read) this register and get [`mpcbb3_privcfgr21::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb3_privcfgr21::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#GTZC1_MPCBB3:MPCBB3_PRIVCFGR21)*/
pub struct MPCBB3_PRIVCFGR21rs;
impl crate::RegisterSpec for MPCBB3_PRIVCFGR21rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb3_privcfgr21::R`](R) reader structure
impl crate::Readable for MPCBB3_PRIVCFGR21rs {}
///`write(|w| ..)` method takes [`mpcbb3_privcfgr21::W`](W) writer structure
impl crate::Writable for MPCBB3_PRIVCFGR21rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB3_PRIVCFGR21 to value 0xffff_ffff
impl crate::Resettable for MPCBB3_PRIVCFGR21rs {
