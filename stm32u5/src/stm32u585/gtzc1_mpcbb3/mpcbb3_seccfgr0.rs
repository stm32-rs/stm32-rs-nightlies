///Register `MPCBB3_SECCFGR0` reader
pub type R = crate::R<MPCBB3_SECCFGR0rs>;
///Register `MPCBB3_SECCFGR0` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB3_SECCFGR0")
...
You can [`read`](crate::Reg::read) this register and get [`mpcbb3_seccfgr0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb3_seccfgr0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mpcbb3_seccfgr0::R`](R) reader structure
impl crate::Readable for MPCBB3_SECCFGR0rs {}
///`write(|w| ..)` method takes [`mpcbb3_seccfgr0::W`](W) writer structure
impl crate::Writable for MPCBB3_SECCFGR0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB3_SECCFGR0 to value 0xffff_ffff
