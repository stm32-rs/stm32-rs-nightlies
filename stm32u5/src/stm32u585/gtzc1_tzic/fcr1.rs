...
#[doc = "Field `CUCPD1F` writer - clear the illegal access flag for UCPD1"]
...
impl W {
    ...
    #[doc = "Bit 9 - clear the illegal access flag for USART2"]
    #[inline(always)]
    #[must_use]
    ...
    #[doc = "Bit 19 - clear the illegal access flag for UCPD1"]
    #[inline(always)]
    #[must_use]
