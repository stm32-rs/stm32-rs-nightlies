...
#[doc = "Field `CICACHEF` writer - clear the illegal access flag for ICACHE registers"]
pub type CICACHEF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CDCACHEF` writer - clear the illegal access flag for DCACHE registers"]
pub type CDCACHEF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CADC1F` writer - clear the illegal access flag for ADC1"]
...
#[doc = "Field `COTGFSF` writer - clear the illegal access flag for OTG_FS"]
...
#[doc = "Field `CFSMCF` writer - clear the illegal access flag for FSMC registers"]
pub type CFSMCF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `COCTOSPI1F` writer - clear the illegal access flag for OCTOSPI1 registers"]
pub type COCTOSPI1F_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `COCTOSPI2F` writer - clear the illegal access flag for OCTOSPI2 registers"]
...
impl W {
    ...
    #[doc = "Bit 7 - clear the illegal access flag for DCACHE registers"]
    #[inline(always)]
    #[must_use]
    pub fn cdcachef(&mut self) -> CDCACHEF_W<FCR3rs> {
        CDCACHEF_W::new(self, 7)
    }
    #[doc = "Bit 8 - clear the illegal access flag for ADC1"]
    #[inline(always)]
    #[must_use]
