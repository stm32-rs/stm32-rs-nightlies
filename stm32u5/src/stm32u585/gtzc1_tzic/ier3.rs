...
impl W {
    ...
    ///Bit 8 - illegal access interrupt enable for ADC1
    #[inline(always)]
    pub fn adc1ie(&mut self) -> ADC1IE_W<'_, IER3rs> {
        ADC1IE_W::new(self, 8)
    }
    ///Bit 9 - illegal access interrupt enable for DCMI
    #[inline(always)]
    ...
    ///Bit 10 - illegal access interrupt enable for OTG_FS
    #[inline(always)]
    pub fn otgfsie(&mut self) -> OTGFSIE_W<'_, IER3rs> {
    ...
    ///Bit 19 - illegal access interrupt enable for FSMC registers
    #[inline(always)]
    pub fn fsmcie(&mut self) -> FSMCIE_W<'_, IER3rs> {
    ...
    ///Bit 21 - illegal access interrupt enable for OCTOSPI2 registers
    #[inline(always)]
    pub fn octospi2ie(&mut self) -> OCTOSPI2IE_W<'_, IER3rs> {
