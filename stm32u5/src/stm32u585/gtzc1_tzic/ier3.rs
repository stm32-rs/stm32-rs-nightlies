...
#[doc = "Field `DMA2DIE` reader - illegal access interrupt enable for register of DMA2D"]
pub type DMA2DIE_R = crate::BitReader;
#[doc = "Field `DMA2DIE` writer - illegal access interrupt enable for register of DMA2D"]
pub type DMA2DIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ICACHEIE` reader - illegal access interrupt enable for ICACHE registers"]
pub type ICACHEIE_R = crate::BitReader;
#[doc = "Field `ICACHEIE` writer - illegal access interrupt enable for ICACHE registers"]
pub type ICACHEIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DCACHEIE` reader - illegal access interrupt enable for DCACHE registers"]
pub type DCACHEIE_R = crate::BitReader;
#[doc = "Field `DCACHEIE` writer - illegal access interrupt enable for DCACHE registers"]
pub type DCACHEIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ADC1IE` reader - illegal access interrupt enable for ADC1"]
pub type ADC1IE_R = crate::BitReader;
#[doc = "Field `ADC1IE` writer - illegal access interrupt enable for ADC1"]
...
#[doc = "Field `OTGFSIE` reader - illegal access interrupt enable for OTG_FS"]
pub type OTGFSIE_R = crate::BitReader;
#[doc = "Field `OTGFSIE` writer - illegal access interrupt enable for OTG_FS"]
...
#[doc = "Field `OCTOSPIMIE` reader - illegal access interrupt enable for OCTOSPIM"]
pub type OCTOSPIMIE_R = crate::BitReader;
#[doc = "Field `OCTOSPIMIE` writer - illegal access interrupt enable for OCTOSPIM"]
pub type OCTOSPIMIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDMMC1IE` reader - illegal access interrupt enable for SDMMC2"]
pub type SDMMC1IE_R = crate::BitReader;
#[doc = "Field `SDMMC1IE` writer - illegal access interrupt enable for SDMMC2"]
pub type SDMMC1IE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDMMC2IE` reader - illegal access interrupt enable for SDMMC1"]
pub type SDMMC2IE_R = crate::BitReader;
#[doc = "Field `SDMMC2IE` writer - illegal access interrupt enable for SDMMC1"]
pub type SDMMC2IE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FSMCIE` reader - illegal access interrupt enable for FSMC registers"]
pub type FSMCIE_R = crate::BitReader;
#[doc = "Field `FSMCIE` writer - illegal access interrupt enable for FSMC registers"]
pub type FSMCIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OCTOSPI1IE` reader - illegal access interrupt enable for OCTOSPI1 registers"]
pub type OCTOSPI1IE_R = crate::BitReader;
#[doc = "Field `OCTOSPI1IE` writer - illegal access interrupt enable for OCTOSPI1 registers"]
pub type OCTOSPI1IE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OCTOSPI2IE` reader - illegal access interrupt enable for OCTOSPI2 registers"]
pub type OCTOSPI2IE_R = crate::BitReader;
#[doc = "Field `OCTOSPI2IE` writer - illegal access interrupt enable for OCTOSPI2 registers"]
...
impl R {
    ...
    #[doc = "Bit 5 - illegal access interrupt enable for register of DMA2D"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - illegal access interrupt enable for ADC1"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - illegal access interrupt enable for OTG_FS"]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - illegal access interrupt enable for OCTOSPIM"]
    #[inline(always)]
    pub fn octospimie(&self) -> OCTOSPIMIE_R {
        OCTOSPIMIE_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - illegal access interrupt enable for SDMMC2"]
    #[inline(always)]
    pub fn sdmmc1ie(&self) -> SDMMC1IE_R {
        SDMMC1IE_R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - illegal access interrupt enable for SDMMC1"]
    #[inline(always)]
    pub fn sdmmc2ie(&self) -> SDMMC2IE_R {
        SDMMC2IE_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - illegal access interrupt enable for FSMC registers"]
    #[inline(always)]
    ...
    #[doc = "Bit 21 - illegal access interrupt enable for OCTOSPI2 registers"]
    #[inline(always)]
