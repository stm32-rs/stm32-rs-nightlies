...
#[doc = "Field `ICACHEF` reader - illegal access flag for ICACHE registers"]
pub type ICACHEF_R = crate::BitReader;
#[doc = "Field `DCACHEF` reader - illegal access flag for DCACHE registers"]
pub type DCACHEF_R = crate::BitReader;
#[doc = "Field `ADC1F` reader - illegal access flag for ADC1"]
pub type ADC1F_R = crate::BitReader;
#[doc = "Field `DCMIF` reader - illegal access flag for DCMI"]
pub type DCMIF_R = crate::BitReader;
#[doc = "Field `OTGFSF` reader - illegal access flag for OTG_FS"]
...
#[doc = "Field `FSMCF` reader - illegal access flag for FSMC registers"]
pub type FSMCF_R = crate::BitReader;
#[doc = "Field `OCTOSPI1F` reader - illegal access flag for OCTOSPI1 registers"]
pub type OCTOSPI1F_R = crate::BitReader;
#[doc = "Field `OCTOSPI2F` reader - illegal access flag for OCTOSPI2 registers"]
...
impl R {
    ...
    #[doc = "Bit 8 - illegal access flag for ADC1"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - illegal access flag for OTG_FS"]
    #[inline(always)]
