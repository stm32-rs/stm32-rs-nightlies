...
impl W {
    ...
    ///Bit 7 - secure access mode for DCACHE registers
    #[inline(always)]
    pub fn dcache_regsec(&mut self) -> DCACHE_REGSEC_W<SECCFGR3rs> {
    ...
    ///Bit 11 - secure access mode for AES
    #[inline(always)]
    pub fn aessec(&mut self) -> AESSEC_W<SECCFGR3rs> {
    ...
    ///Bit 14 - secure access mode for PKA
    #[inline(always)]
    pub fn pkasec(&mut self) -> PKASEC_W<SECCFGR3rs> {
        PKASEC_W::new(self, 14)
    }
    ///Bit 15 - secure access mode for SAES
    #[inline(always)]
    pub fn saessec(&mut self) -> SAESSEC_W<SECCFGR3rs> {
