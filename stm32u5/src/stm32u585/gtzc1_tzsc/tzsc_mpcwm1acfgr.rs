#[doc = "Register `TZSC_MPCWM1ACFGR` reader"]
pub type R = crate::R<TZSC_MPCWM1ACFGRrs>;
#[doc = "Register `TZSC_MPCWM1ACFGR` writer"]
...
#[doc = "TZSC memory 1 sub-region A watermark configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tzsc_mpcwm1acfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tzsc_mpcwm1acfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TZSC_MPCWM1ACFGRrs;
impl crate::RegisterSpec for TZSC_MPCWM1ACFGRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tzsc_mpcwm1acfgr::R`](R) reader structure"]
impl crate::Readable for TZSC_MPCWM1ACFGRrs {}
#[doc = "`write(|w| ..)` method takes [`tzsc_mpcwm1acfgr::W`](W) writer structure"]
impl crate::Writable for TZSC_MPCWM1ACFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TZSC_MPCWM1ACFGR to value 0"]
