...
pub type R = crate::R<TZSC_MPCWM1ARrs>;
///Register `TZSC_MPCWM1AR` writer
pub type W = crate::W<TZSC_MPCWM1ARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn suba_start(&mut self) -> SUBA_START_W<TZSC_MPCWM1ARrs> {
        SUBA_START_W::new(self, 0)
    }
    ///Bits 16:27 - Length of sub-region A
    #[inline(always)]
    #[must_use]
    pub fn suba_length(&mut self) -> SUBA_LENGTH_W<TZSC_MPCWM1ARrs> {
        SUBA_LENGTH_W::new(self, 16)
    }
}
/**TZSC memory 1 sub-region A watermark register

You can [`read`](crate::Reg::read) this register and get [`tzsc_mpcwm1ar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tzsc_mpcwm1ar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#GTZC1_TZSC:TZSC_MPCWM1AR)*/
pub struct TZSC_MPCWM1ARrs;
impl crate::RegisterSpec for TZSC_MPCWM1ARrs {
    type Ux = u32;
}
///`read()` method returns [`tzsc_mpcwm1ar::R`](R) reader structure
impl crate::Readable for TZSC_MPCWM1ARrs {}
///`write(|w| ..)` method takes [`tzsc_mpcwm1ar::W`](W) writer structure
impl crate::Writable for TZSC_MPCWM1ARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TZSC_MPCWM1AR to value 0
impl crate::Resettable for TZSC_MPCWM1ARrs {
