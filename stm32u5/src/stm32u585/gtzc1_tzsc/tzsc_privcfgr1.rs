...
#[doc = "Field `UCPD1PRIV` reader - privileged access mode for UCPD1"]
pub type UCPD1PRIV_R = crate::BitReader;
#[doc = "Field `UCPD1PRIV` writer - privileged access mode for UCPD1"]
...
impl R {
    ...
    #[doc = "Bit 9 - privileged access mode for USART2"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - privileged access mode for UCPD1"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart2priv(&mut self) -> USART2PRIV_W<TZSC_PRIVCFGR1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucpd1priv(&mut self) -> UCPD1PRIV_W<TZSC_PRIVCFGR1rs> {
