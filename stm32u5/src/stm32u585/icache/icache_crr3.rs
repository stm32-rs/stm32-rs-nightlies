///Register `ICACHE_CRR3` reader
pub type R = crate::R<ICACHE_CRR3rs>;
///Register `ICACHE_CRR3` writer
...
You can [`read`](crate::Reg::read) this register and get [`icache_crr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icache_crr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`icache_crr3::R`](R) reader structure
impl crate::Readable for ICACHE_CRR3rs {}
///`write(|w| ..)` method takes [`icache_crr3::W`](W) writer structure
impl crate::Writable for ICACHE_CRR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ICACHE_CRR3 to value 0x0200
