#[doc = "Register `LPDMA_C0DAR` reader"]
pub type R = crate::R<LPDMA_C0DARrs>;
#[doc = "Register `LPDMA_C0DAR` writer"]
...
#[doc = "LPDMA channel 0 destination address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpdma_c0dar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpdma_c0dar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPDMA_C0DARrs;
impl crate::RegisterSpec for LPDMA_C0DARrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpdma_c0dar::R`](R) reader structure"]
impl crate::Readable for LPDMA_C0DARrs {}
#[doc = "`write(|w| ..)` method takes [`lpdma_c0dar::W`](W) writer structure"]
impl crate::Writable for LPDMA_C0DARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPDMA_C0DAR to value 0"]
