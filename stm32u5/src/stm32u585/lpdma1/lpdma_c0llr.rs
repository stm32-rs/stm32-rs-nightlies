#[doc = "Register `LPDMA_C0LLR` reader"]
pub type R = crate::R<LPDMA_C0LLRrs>;
#[doc = "Register `LPDMA_C0LLR` writer"]
...
#[doc = "LPDMA channel 0 linked-list address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpdma_c0llr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpdma_c0llr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPDMA_C0LLRrs;
impl crate::RegisterSpec for LPDMA_C0LLRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpdma_c0llr::R`](R) reader structure"]
impl crate::Readable for LPDMA_C0LLRrs {}
#[doc = "`write(|w| ..)` method takes [`lpdma_c0llr::W`](W) writer structure"]
impl crate::Writable for LPDMA_C0LLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPDMA_C0LLR to value 0"]
