...
impl core::fmt::Debug for crate::generic::Reg<LPDMA_C1FCRrs> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tof(&mut self) -> TOF_W<LPDMA_C1FCRrs> {
        TOF_W::new(self, 14)
    }
}
/**LPDMA channel 1 flag clear register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpdma_c1fcr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`write(|w| ..)` method takes [`lpdma_c1fcr::W`](W) writer structure
impl crate::Writable for LPDMA_C1FCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPDMA_C1FCR to value 0
