///Register `LPDMA_C3SAR` reader
pub type R = crate::R<LPDMA_C3SARrs>;
///Register `LPDMA_C3SAR` writer
pub type W = crate::W<LPDMA_C3SARrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sa(&mut self) -> SA_W<LPDMA_C3SARrs> {
        SA_W::new(self, 0)
    }
}
/**LPDMA channel 3 source address register

You can [`read`](crate::Reg::read) this register and get [`lpdma_c3sar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpdma_c3sar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#LPDMA1:LPDMA_C3SAR)*/
pub struct LPDMA_C3SARrs;
impl crate::RegisterSpec for LPDMA_C3SARrs {
    type Ux = u32;
}
///`read()` method returns [`lpdma_c3sar::R`](R) reader structure
impl crate::Readable for LPDMA_C3SARrs {}
///`write(|w| ..)` method takes [`lpdma_c3sar::W`](W) writer structure
impl crate::Writable for LPDMA_C3SARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPDMA_C3SAR to value 0
impl crate::Resettable for LPDMA_C3SARrs {
