#[doc = "Register `LPDMA_MISR` reader"]
pub type R = crate::R<LPDMA_MISRrs>;
...
#[doc = "LPDMA non-secure masked interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpdma_misr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPDMA_MISRrs;
impl crate::RegisterSpec for LPDMA_MISRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpdma_misr::R`](R) reader structure"]
impl crate::Readable for LPDMA_MISRrs {}
#[doc = "`reset()` method sets LPDMA_MISR to value 0"]
impl crate::Resettable for LPDMA_MISRrs {
