///Register `MDF_BSMX1CR` reader
pub type R = crate::R<MDF_BSMX1CRrs>;
///Register `MDF_BSMX1CR` writer
pub type W = crate::W<MDF_BSMX1CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bssel(&mut self) -> BSSEL_W<MDF_BSMX1CRrs> {
        BSSEL_W::new(self, 0)
    }
}
/**This register is used to select the bitstream to be provided to the corresponding digital filter and to the SCD.

You can [`read`](crate::Reg::read) this register and get [`mdf_bsmx1cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_bsmx1cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#MDF1:MDF_BSMX1CR)*/
pub struct MDF_BSMX1CRrs;
impl crate::RegisterSpec for MDF_BSMX1CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_bsmx1cr::R`](R) reader structure
impl crate::Readable for MDF_BSMX1CRrs {}
///`write(|w| ..)` method takes [`mdf_bsmx1cr::W`](W) writer structure
impl crate::Writable for MDF_BSMX1CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_BSMX1CR to value 0
impl crate::Resettable for MDF_BSMX1CRrs {
