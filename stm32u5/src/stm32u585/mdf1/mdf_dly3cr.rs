#[doc = "Register `MDF_DLY3CR` reader"]
pub type R = crate::R<MDF_DLY3CRrs>;
#[doc = "Register `MDF_DLY3CR` writer"]
...
#[doc = "This register is used for the adjustment stream delays.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_dly3cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdf_dly3cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_DLY3CRrs;
impl crate::RegisterSpec for MDF_DLY3CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_dly3cr::R`](R) reader structure"]
impl crate::Readable for MDF_DLY3CRrs {}
#[doc = "`write(|w| ..)` method takes [`mdf_dly3cr::W`](W) writer structure"]
impl crate::Writable for MDF_DLY3CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDF_DLY3CR to value 0"]
