///Register `MDF_SITF2CR` reader
pub type R = crate::R<MDF_SITF2CRrs>;
///Register `MDF_SITF2CR` writer
...
You can [`read`](crate::Reg::read) this register and get [`mdf_sitf2cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_sitf2cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#MDF1:MDF_SITF2CR)*/
pub struct MDF_SITF2CRrs;
impl crate::RegisterSpec for MDF_SITF2CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_sitf2cr::R`](R) reader structure
impl crate::Readable for MDF_SITF2CRrs {}
///`write(|w| ..)` method takes [`mdf_sitf2cr::W`](W) writer structure
impl crate::Writable for MDF_SITF2CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_SITF2CR to value 0x1f00
