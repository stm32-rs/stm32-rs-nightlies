...
impl W {
    ///Bit 0 - Port G pull-down bit
    #[inline(always)]
    pub fn pd0(&mut self) -> PD0_W<'_, PDCRGrs> {
        PD0_W::new(self, 0)
    }
    ///Bit 1 - Port G pull-down bit
    #[inline(always)]
    pub fn pd1(&mut self) -> PD1_W<'_, PDCRGrs> {
        PD1_W::new(self, 1)
    }
    ///Bit 2 - Port G pull-down bit
    #[inline(always)]
    pub fn pd2(&mut self) -> PD2_W<'_, PDCRGrs> {
        PD2_W::new(self, 2)
    }
    ///Bit 3 - Port G pull-down bit
    #[inline(always)]
    pub fn pd3(&mut self) -> PD3_W<'_, PDCRGrs> {
        PD3_W::new(self, 3)
    }
    ///Bit 4 - Port G pull-down bit
    #[inline(always)]
    pub fn pd4(&mut self) -> PD4_W<'_, PDCRGrs> {
        PD4_W::new(self, 4)
    }
    ///Bit 5 - Port G pull-down bit
    #[inline(always)]
    pub fn pd5(&mut self) -> PD5_W<'_, PDCRGrs> {
        PD5_W::new(self, 5)
    }
    ///Bit 6 - Port G pull-down bit
    #[inline(always)]
    pub fn pd6(&mut self) -> PD6_W<'_, PDCRGrs> {
        PD6_W::new(self, 6)
    }
    ///Bit 7 - Port G pull-down bit
    #[inline(always)]
    pub fn pd7(&mut self) -> PD7_W<'_, PDCRGrs> {
        PD7_W::new(self, 7)
    }
    ///Bit 8 - Port G pull-down bit
    #[inline(always)]
    pub fn pd8(&mut self) -> PD8_W<'_, PDCRGrs> {
        PD8_W::new(self, 8)
    }
    ///Bit 9 - Port G pull-down bit
    #[inline(always)]
    pub fn pd9(&mut self) -> PD9_W<'_, PDCRGrs> {
        PD9_W::new(self, 9)
    }
    ///Bit 10 - Port G pull-down bit
    #[inline(always)]
    pub fn pd10(&mut self) -> PD10_W<'_, PDCRGrs> {
        PD10_W::new(self, 10)
    }
    ///Bit 11 - Port G pull-down bit
    #[inline(always)]
    pub fn pd11(&mut self) -> PD11_W<'_, PDCRGrs> {
        PD11_W::new(self, 11)
    }
    ///Bit 12 - Port G pull-down bit
    #[inline(always)]
    pub fn pd12(&mut self) -> PD12_W<'_, PDCRGrs> {
        PD12_W::new(self, 12)
    }
    ///Bit 13 - Port G pull-down bit
    #[inline(always)]
    pub fn pd13(&mut self) -> PD13_W<'_, PDCRGrs> {
        PD13_W::new(self, 13)
    }
    ///Bit 14 - Port G pull-down bit
    #[inline(always)]
    pub fn pd14(&mut self) -> PD14_W<'_, PDCRGrs> {
        PD14_W::new(self, 14)
    }
    ///Bit 15 - Port G pull-down bit
    #[inline(always)]
    pub fn pd15(&mut self) -> PD15_W<'_, PDCRGrs> {
        PD15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#PWR:PDCRG)*/
pub struct PDCRGrs;
