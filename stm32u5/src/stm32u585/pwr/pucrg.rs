...
impl W {
    ...
    ///Bit 11 - Port G pull-up bit
    #[inline(always)]
    pub fn pu11(&mut self) -> PU11_W<'_, PUCRGrs> {
        PU11_W::new(self, 11)
    }
    ///Bit 12 - Port G pull-up bit
    #[inline(always)]
    pub fn pu12(&mut self) -> PU12_W<'_, PUCRGrs> {
        PU12_W::new(self, 12)
    }
    ///Bit 13 - Port G pull-up bit
    #[inline(always)]
    pub fn pu13(&mut self) -> PU13_W<'_, PUCRGrs> {
        PU13_W::new(self, 13)
    }
    ///Bit 14 - Port G pull-up bit
    #[inline(always)]
    pub fn pu14(&mut self) -> PU14_W<'_, PUCRGrs> {
        PU14_W::new(self, 14)
    }
    ///Bit 15 - Port G pull-up bit
    #[inline(always)]
    pub fn pu15(&mut self) -> PU15_W<'_, PUCRGrs> {
        PU15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#PWR:PUCRG)*/
pub struct PUCRGrs;
