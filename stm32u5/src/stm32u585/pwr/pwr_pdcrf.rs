...
///Field `PD0` reader - Port F pull-down bit
pub type PD0_R = crate::BitReader;
///Field `PD0` writer - Port F pull-down bit
pub type PD0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD1` reader - Port F pull-down bit
pub type PD1_R = crate::BitReader;
///Field `PD1` writer - Port F pull-down bit
pub type PD1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD2` reader - Port F pull-down bit
pub type PD2_R = crate::BitReader;
///Field `PD2` writer - Port F pull-down bit
pub type PD2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD3` reader - Port F pull-down bit
pub type PD3_R = crate::BitReader;
///Field `PD3` writer - Port F pull-down bit
pub type PD3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD4` reader - Port F pull-down bit
pub type PD4_R = crate::BitReader;
///Field `PD4` writer - Port F pull-down bit
pub type PD4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD5` reader - Port F pull-down bit
pub type PD5_R = crate::BitReader;
///Field `PD5` writer - Port F pull-down bit
pub type PD5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD6` reader - Port F pull-down bit
pub type PD6_R = crate::BitReader;
///Field `PD6` writer - Port F pull-down bit
pub type PD6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD7` reader - Port F pull-down bit
pub type PD7_R = crate::BitReader;
///Field `PD7` writer - Port F pull-down bit
pub type PD7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD8` reader - Port F pull-down bit
pub type PD8_R = crate::BitReader;
///Field `PD8` writer - Port F pull-down bit
pub type PD8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD9` reader - Port F pull-down bit
pub type PD9_R = crate::BitReader;
///Field `PD9` writer - Port F pull-down bit
pub type PD9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD10` reader - Port F pull-down bit
pub type PD10_R = crate::BitReader;
///Field `PD10` writer - Port F pull-down bit
pub type PD10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD11` reader - Port F pull-down bit
pub type PD11_R = crate::BitReader;
///Field `PD11` writer - Port F pull-down bit
pub type PD11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD12` reader - Port F pull-down bit
pub type PD12_R = crate::BitReader;
///Field `PD12` writer - Port F pull-down bit
pub type PD12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD13` reader - Port F pull-down bit
pub type PD13_R = crate::BitReader;
///Field `PD13` writer - Port F pull-down bit
pub type PD13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD14` reader - Port F pull-down bit
pub type PD14_R = crate::BitReader;
///Field `PD14` writer - Port F pull-down bit
pub type PD14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD15` reader - Port F pull-down bit
pub type PD15_R = crate::BitReader;
///Field `PD15` writer - Port F pull-down bit
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd4(&mut self) -> PD4_W<PWR_PDCRFrs> {
        PD4_W::new(self, 4)
    }
    ///Bit 5 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd5(&mut self) -> PD5_W<PWR_PDCRFrs> {
        PD5_W::new(self, 5)
    }
    ///Bit 6 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd6(&mut self) -> PD6_W<PWR_PDCRFrs> {
        PD6_W::new(self, 6)
    }
    ///Bit 7 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd7(&mut self) -> PD7_W<PWR_PDCRFrs> {
        PD7_W::new(self, 7)
    }
    ///Bit 8 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd8(&mut self) -> PD8_W<PWR_PDCRFrs> {
        PD8_W::new(self, 8)
    }
    ///Bit 9 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd9(&mut self) -> PD9_W<PWR_PDCRFrs> {
        PD9_W::new(self, 9)
    }
    ///Bit 10 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd10(&mut self) -> PD10_W<PWR_PDCRFrs> {
        PD10_W::new(self, 10)
    }
    ///Bit 11 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd11(&mut self) -> PD11_W<PWR_PDCRFrs> {
        PD11_W::new(self, 11)
    }
    ///Bit 12 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd12(&mut self) -> PD12_W<PWR_PDCRFrs> {
        PD12_W::new(self, 12)
    }
    ///Bit 13 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd13(&mut self) -> PD13_W<PWR_PDCRFrs> {
        PD13_W::new(self, 13)
    }
    ///Bit 14 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd14(&mut self) -> PD14_W<PWR_PDCRFrs> {
        PD14_W::new(self, 14)
    }
    ///Bit 15 - Port F pull-down bit
    #[inline(always)]
    #[must_use]
    pub fn pd15(&mut self) -> PD15_W<PWR_PDCRFrs> {
        PD15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#PWR:PWR_PDCRF)*/
