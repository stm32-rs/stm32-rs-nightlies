///Register `PWR_PUCRG` reader
pub type R = crate::R<PWR_PUCRGrs>;
///Register `PWR_PUCRG` writer
pub type W = crate::W<PWR_PUCRGrs>;
///Field `PU0` reader - Port G pull-up bit
pub type PU0_R = crate::BitReader;
///Field `PU0` writer - Port G pull-up bit
pub type PU0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU1` reader - Port G pull-up bit
pub type PU1_R = crate::BitReader;
///Field `PU1` writer - Port G pull-up bit
pub type PU1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU2` reader - Port G pull-up bit
pub type PU2_R = crate::BitReader;
///Field `PU2` writer - Port G pull-up bit
pub type PU2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU3` reader - Port G pull-up bit
pub type PU3_R = crate::BitReader;
///Field `PU3` writer - Port G pull-up bit
pub type PU3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU4` reader - Port G pull-up bit
pub type PU4_R = crate::BitReader;
///Field `PU4` writer - Port G pull-up bit
pub type PU4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU5` reader - Port G pull-up bit
pub type PU5_R = crate::BitReader;
///Field `PU5` writer - Port G pull-up bit
pub type PU5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU6` reader - Port G pull-up bit
pub type PU6_R = crate::BitReader;
///Field `PU6` writer - Port G pull-up bit
pub type PU6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU7` reader - Port G pull-up bit
pub type PU7_R = crate::BitReader;
///Field `PU7` writer - Port G pull-up bit
pub type PU7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU8` reader - Port G pull-up bit
pub type PU8_R = crate::BitReader;
///Field `PU8` writer - Port G pull-up bit
pub type PU8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU9` reader - Port G pull-up bit
pub type PU9_R = crate::BitReader;
///Field `PU9` writer - Port G pull-up bit
pub type PU9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU10` reader - Port G pull-up bit
pub type PU10_R = crate::BitReader;
///Field `PU10` writer - Port G pull-up bit
pub type PU10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU11` reader - Port G pull-up bit
pub type PU11_R = crate::BitReader;
///Field `PU11` writer - Port G pull-up bit
pub type PU11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU12` reader - Port G pull-up bit
pub type PU12_R = crate::BitReader;
///Field `PU12` writer - Port G pull-up bit
pub type PU12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU13` reader - Port G pull-up bit
pub type PU13_R = crate::BitReader;
///Field `PU13` writer - Port G pull-up bit
pub type PU13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU14` reader - Port G pull-up bit
pub type PU14_R = crate::BitReader;
///Field `PU14` writer - Port G pull-up bit
pub type PU14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PU15` reader - Port G pull-up bit
pub type PU15_R = crate::BitReader;
///Field `PU15` writer - Port G pull-up bit
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#PWR:PWR_PUCRG)*/
pub struct PWR_PUCRGrs;
impl crate::RegisterSpec for PWR_PUCRGrs {
    type Ux = u32;
}
///`read()` method returns [`pwr_pucrg::R`](R) reader structure
impl crate::Readable for PWR_PUCRGrs {}
///`write(|w| ..)` method takes [`pwr_pucrg::W`](W) writer structure
impl crate::Writable for PWR_PUCRGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PWR_PUCRG to value 0
