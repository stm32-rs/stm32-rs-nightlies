#[doc = "Register `RAM1CR` reader"]
pub type R = crate::R<RAM1CRrs>;
#[doc = "Register `RAM1CR` writer"]
...
#[doc = "RAMCFG SRAM x control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram1cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ram1cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAM1CRrs;
impl crate::RegisterSpec for RAM1CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram1cr::R`](R) reader structure"]
impl crate::Readable for RAM1CRrs {}
#[doc = "`write(|w| ..)` method takes [`ram1cr::W`](W) writer structure"]
impl crate::Writable for RAM1CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM1CR to value 0"]
