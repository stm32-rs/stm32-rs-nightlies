...
#[doc = "RAMCFG RAMx interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram1isr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAM1ISRrs;
impl crate::RegisterSpec for RAM1ISRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram1isr::R`](R) reader structure"]
impl crate::Readable for RAM1ISRrs {}
#[doc = "`reset()` method sets RAM1ISR to value 0"]
