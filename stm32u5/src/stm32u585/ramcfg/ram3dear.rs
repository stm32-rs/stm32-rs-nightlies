...
#[doc = "RAMCFG RAM x ECC double error address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram3dear::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAM3DEARrs;
impl crate::RegisterSpec for RAM3DEARrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram3dear::R`](R) reader structure"]
impl crate::Readable for RAM3DEARrs {}
#[doc = "`reset()` method sets RAM3DEAR to value 0"]
