#[doc = "Register `RAM3ICR` reader"]
pub type R = crate::R<RAM3ICRrs>;
#[doc = "Register `RAM3ICR` writer"]
...
#[doc = "RAMCFG RAM x interrupt clear register x\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram3icr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ram3icr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAM3ICRrs;
impl crate::RegisterSpec for RAM3ICRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram3icr::R`](R) reader structure"]
impl crate::Readable for RAM3ICRrs {}
#[doc = "`write(|w| ..)` method takes [`ram3icr::W`](W) writer structure"]
impl crate::Writable for RAM3ICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM3ICR to value 0"]
