...
pub type R = crate::R<RAM5CRrs>;
///Register `RAM5CR` writer
pub type W = crate::W<RAM5CRrs>;
...
impl W {
    ///Bit 0 - ECCE
    #[inline(always)]
    pub fn ecce(&mut self) -> ECCE_W<'_, RAM5CRrs> {
        ECCE_W::new(self, 0)
    }
    ///Bit 4 - ALE
    #[inline(always)]
    pub fn ale(&mut self) -> ALE_W<'_, RAM5CRrs> {
        ALE_W::new(self, 4)
    }
    ///Bit 8 - SRAMER
    #[inline(always)]
    pub fn sramer(&mut self) -> SRAMER_W<'_, RAM5CRrs> {
        SRAMER_W::new(self, 8)
    }
    ///Bits 16:18 - WSC
    #[inline(always)]
    pub fn wsc(&mut self) -> WSC_W<'_, RAM5CRrs> {
        WSC_W::new(self, 16)
    }
}
/**RAMCFG SRAM x control register

You can [`read`](crate::Reg::read) this register and get [`ram5cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram5cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#RAMCFG:RAM5CR)*/
pub struct RAM5CRrs;
impl crate::RegisterSpec for RAM5CRrs {
    type Ux = u32;
}
///`read()` method returns [`ram5cr::R`](R) reader structure
impl crate::Readable for RAM5CRrs {}
///`write(|w| ..)` method takes [`ram5cr::W`](W) writer structure
impl crate::Writable for RAM5CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RAM5CR to value 0
impl crate::Resettable for RAM5CRrs {}
