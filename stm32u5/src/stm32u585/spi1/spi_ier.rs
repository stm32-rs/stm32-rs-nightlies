...
You can [`read`](crate::Reg::read) this register and get [`spi_ier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_ier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#SPI1:SPI_IER)*/
pub struct SPI_IERrs;
impl crate::RegisterSpec for SPI_IERrs {
    type Ux = u32;
}
///`read()` method returns [`spi_ier::R`](R) reader structure
impl crate::Readable for SPI_IERrs {}
///`write(|w| ..)` method takes [`spi_ier::W`](W) writer structure
