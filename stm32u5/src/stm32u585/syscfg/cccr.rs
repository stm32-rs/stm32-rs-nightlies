...
impl W {
    ...
    ///Bits 8:11 - NCC2
    #[inline(always)]
    pub fn ncc2(&mut self) -> NCC2_W<'_, CCCRrs> {
        NCC2_W::new(self, 8)
    }
    ///Bits 12:15 - PCC2
    #[inline(always)]
    pub fn pcc2(&mut self) -> PCC2_W<'_, CCCRrs> {
        PCC2_W::new(self, 12)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#SYSCFG:CCCR)*/
pub struct CCCRrs;
