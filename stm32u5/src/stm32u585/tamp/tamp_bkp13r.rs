...
pub type R = crate::R<TAMP_BKP13Rrs>;
///Register `TAMP_BKP13R` writer
pub type W = crate::W<TAMP_BKP13Rrs>;
...
impl W {
    ///Bits 0:31 - The application can write or read data to and from these registers. In the default (ERASE) configuration this register is reset on a tamper detection event. It is forced to reset value as long as there is at least one internal or external tamper flag being set. This register is also reset when the readout protection (RDP) is disabled.
    #[inline(always)]
    pub fn bkp(&mut self) -> BKP_W<TAMP_BKP13Rrs> {
        BKP_W::new(self, 0)
    }
}
/**TAMP backup 13 register

You can [`read`](crate::Reg::read) this register and get [`tamp_bkp13r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tamp_bkp13r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#TAMP:TAMP_BKP13R)*/
pub struct TAMP_BKP13Rrs;
impl crate::RegisterSpec for TAMP_BKP13Rrs {
    type Ux = u32;
}
///`read()` method returns [`tamp_bkp13r::R`](R) reader structure
impl crate::Readable for TAMP_BKP13Rrs {}
///`write(|w| ..)` method takes [`tamp_bkp13r::W`](W) writer structure
impl crate::Writable for TAMP_BKP13Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TAMP_BKP13R to value 0
impl crate::Resettable for TAMP_BKP13Rrs {
