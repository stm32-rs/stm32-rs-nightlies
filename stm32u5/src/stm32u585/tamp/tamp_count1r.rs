...
pub type R = crate::R<TAMP_COUNT1Rrs>;
...
You can [`read`](crate::Reg::read) this register and get [`tamp_count1r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#TAMP:TAMP_COUNT1R)*/
pub struct TAMP_COUNT1Rrs;
impl crate::RegisterSpec for TAMP_COUNT1Rrs {
    type Ux = u32;
}
///`read()` method returns [`tamp_count1r::R`](R) reader structure
impl crate::Readable for TAMP_COUNT1Rrs {}
///`reset()` method sets TAMP_COUNT1R to value 0
impl crate::Resettable for TAMP_COUNT1Rrs {
