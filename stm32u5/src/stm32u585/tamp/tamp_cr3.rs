...
pub type R = crate::R<TAMP_CR3rs>;
///Register `TAMP_CR3` writer
pub type W = crate::W<TAMP_CR3rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn itamp1noer(&mut self) -> ITAMP1NOER_W<TAMP_CR3rs> {
        ITAMP1NOER_W::new(self, 0)
    }
    ///Bit 1 - Internal Tamper 2 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp2noer(&mut self) -> ITAMP2NOER_W<TAMP_CR3rs> {
        ITAMP2NOER_W::new(self, 1)
    }
    ///Bit 2 - Internal Tamper 3 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp3noer(&mut self) -> ITAMP3NOER_W<TAMP_CR3rs> {
        ITAMP3NOER_W::new(self, 2)
    }
    ///Bit 4 - Internal Tamper 5 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp5noer(&mut self) -> ITAMP5NOER_W<TAMP_CR3rs> {
        ITAMP5NOER_W::new(self, 4)
    }
    ///Bit 5 - Internal Tamper 6 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp6noer(&mut self) -> ITAMP6NOER_W<TAMP_CR3rs> {
        ITAMP6NOER_W::new(self, 5)
    }
    ///Bit 6 - Internal Tamper 7 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp7noer(&mut self) -> ITAMP7NOER_W<TAMP_CR3rs> {
        ITAMP7NOER_W::new(self, 6)
    }
    ///Bit 7 - Internal Tamper 8 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp8noer(&mut self) -> ITAMP8NOER_W<TAMP_CR3rs> {
        ITAMP8NOER_W::new(self, 7)
    }
    ///Bit 8 - Internal Tamper 9 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp9noer(&mut self) -> ITAMP9NOER_W<TAMP_CR3rs> {
        ITAMP9NOER_W::new(self, 8)
    }
    ///Bit 10 - Internal Tamper 11 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp11noer(&mut self) -> ITAMP11NOER_W<TAMP_CR3rs> {
        ITAMP11NOER_W::new(self, 10)
    }
    ///Bit 11 - Internal Tamper 12 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp12noer(&mut self) -> ITAMP12NOER_W<TAMP_CR3rs> {
        ITAMP12NOER_W::new(self, 11)
    }
    ///Bit 12 - Internal Tamper 13 no erase
    #[inline(always)]
    #[must_use]
    pub fn itamp13noer(&mut self) -> ITAMP13NOER_W<TAMP_CR3rs> {
        ITAMP13NOER_W::new(self, 12)
    }
}
/**TAMP control register 3

You can [`read`](crate::Reg::read) this register and get [`tamp_cr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tamp_cr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#TAMP:TAMP_CR3)*/
pub struct TAMP_CR3rs;
impl crate::RegisterSpec for TAMP_CR3rs {
    type Ux = u32;
}
///`read()` method returns [`tamp_cr3::R`](R) reader structure
impl crate::Readable for TAMP_CR3rs {}
///`write(|w| ..)` method takes [`tamp_cr3::W`](W) writer structure
impl crate::Writable for TAMP_CR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TAMP_CR3 to value 0
impl crate::Resettable for TAMP_CR3rs {
