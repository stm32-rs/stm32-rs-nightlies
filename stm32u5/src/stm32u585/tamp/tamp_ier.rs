...
pub type R = crate::R<TAMP_IERrs>;
///Register `TAMP_IER` writer
pub type W = crate::W<TAMP_IERrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tamp1ie(&mut self) -> TAMP1IE_W<TAMP_IERrs> {
        TAMP1IE_W::new(self, 0)
    }
    ///Bit 1 - Tamper 2 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn tamp2ie(&mut self) -> TAMP2IE_W<TAMP_IERrs> {
        TAMP2IE_W::new(self, 1)
    }
    ///Bit 2 - Tamper 3 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn tamp3ie(&mut self) -> TAMP3IE_W<TAMP_IERrs> {
        TAMP3IE_W::new(self, 2)
    }
    ///Bit 3 - Tamper 4 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn tamp4ie(&mut self) -> TAMP4IE_W<TAMP_IERrs> {
        TAMP4IE_W::new(self, 3)
    }
    ///Bit 4 - Tamper 5 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn tamp5ie(&mut self) -> TAMP5IE_W<TAMP_IERrs> {
        TAMP5IE_W::new(self, 4)
    }
    ///Bit 5 - Tamper 6 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn tamp6ie(&mut self) -> TAMP6IE_W<TAMP_IERrs> {
        TAMP6IE_W::new(self, 5)
    }
    ///Bit 6 - Tamper 7interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn tamp7ie(&mut self) -> TAMP7IE_W<TAMP_IERrs> {
        TAMP7IE_W::new(self, 6)
    }
    ///Bit 7 - Tamper 8 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn tamp8ie(&mut self) -> TAMP8IE_W<TAMP_IERrs> {
        TAMP8IE_W::new(self, 7)
    }
    ///Bit 16 - Internal tamper 1 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp1ie(&mut self) -> ITAMP1IE_W<TAMP_IERrs> {
        ITAMP1IE_W::new(self, 16)
    }
    ///Bit 17 - Internal tamper 2 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp2ie(&mut self) -> ITAMP2IE_W<TAMP_IERrs> {
        ITAMP2IE_W::new(self, 17)
    }
    ///Bit 18 - Internal tamper 3 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp3ie(&mut self) -> ITAMP3IE_W<TAMP_IERrs> {
        ITAMP3IE_W::new(self, 18)
    }
    ///Bit 20 - Internal tamper 5 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp5ie(&mut self) -> ITAMP5IE_W<TAMP_IERrs> {
        ITAMP5IE_W::new(self, 20)
    }
    ///Bit 21 - Internal tamper 6 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp6ie(&mut self) -> ITAMP6IE_W<TAMP_IERrs> {
        ITAMP6IE_W::new(self, 21)
    }
    ///Bit 22 - Internal tamper 7 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp7ie(&mut self) -> ITAMP7IE_W<TAMP_IERrs> {
        ITAMP7IE_W::new(self, 22)
    }
    ///Bit 23 - Internal tamper 8 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp8ie(&mut self) -> ITAMP8IE_W<TAMP_IERrs> {
        ITAMP8IE_W::new(self, 23)
    }
    ///Bit 24 - Internal tamper 9 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp9ie(&mut self) -> ITAMP9IE_W<TAMP_IERrs> {
        ITAMP9IE_W::new(self, 24)
    }
    ///Bit 26 - Internal tamper 11 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp11ie(&mut self) -> ITAMP11IE_W<TAMP_IERrs> {
        ITAMP11IE_W::new(self, 26)
    }
    ///Bit 27 - Internal tamper 12 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp12ie(&mut self) -> ITAMP12IE_W<TAMP_IERrs> {
        ITAMP12IE_W::new(self, 27)
    }
    ///Bit 28 - Internal tamper 13 interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn itamp13ie(&mut self) -> ITAMP13IE_W<TAMP_IERrs> {
...
pub struct TAMP_IERrs;
impl crate::RegisterSpec for TAMP_IERrs {
    type Ux = u32;
}
///`read()` method returns [`tamp_ier::R`](R) reader structure
impl crate::Readable for TAMP_IERrs {}
///`write(|w| ..)` method takes [`tamp_ier::W`](W) writer structure
impl crate::Writable for TAMP_IERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TAMP_IER to value 0
impl crate::Resettable for TAMP_IERrs {
