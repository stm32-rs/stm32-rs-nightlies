...
#[doc = "Field `OC1M_bit3` reader - Output Compare 1 mode - bit 3"]
pub type OC1M_BIT3_R = crate::BitReader;
#[doc = "Field `OC1M_bit3` writer - Output Compare 1 mode - bit 3"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn oc1m_bit3(&mut self) -> OC1M_BIT3_W<TIM1_CCMR1_OUTPUTrs> {
        OC1M_BIT3_W::new(self, 16)
    }
    #[doc = "Bit 24 - Output Compare 2 mode - bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn oc2m_bit3(&mut self) -> OC2M_BIT3_W<TIM1_CCMR1_OUTPUTrs> {
