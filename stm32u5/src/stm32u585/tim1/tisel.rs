...
///Field `TI1SEL` reader - Selects tim_ti1\[0..15\] input ... Refer to for interconnects list.
pub type TI1SEL_R = crate::FieldReader;
///Field `TI1SEL` writer - Selects tim_ti1\[0..15\] input ... Refer to for interconnects list.
pub type TI1SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TI2SEL` reader - Selects tim_ti2\[0..15\] input ... Refer to for interconnects list.
pub type TI2SEL_R = crate::FieldReader;
///Field `TI2SEL` writer - Selects tim_ti2\[0..15\] input ... Refer to for interconnects list.
pub type TI2SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TI3SEL` reader - Selects tim_ti3\[0..15\] input ... Refer to for interconnects list.
pub type TI3SEL_R = crate::FieldReader;
///Field `TI3SEL` writer - Selects tim_ti3\[0..15\] input ... Refer to for interconnects list.
pub type TI3SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TI4SEL` reader - Selects tim_ti4\[0..15\] input ... Refer to for interconnects list.
pub type TI4SEL_R = crate::FieldReader;
///Field `TI4SEL` writer - Selects tim_ti4\[0..15\] input ... Refer to for interconnects list.
