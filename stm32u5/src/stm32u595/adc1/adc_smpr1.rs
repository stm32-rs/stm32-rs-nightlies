///Register `ADC_SMPR1` reader
pub type R = crate::R<ADC_SMPR1rs>;
///Register `ADC_SMPR1` writer
pub type W = crate::W<ADC_SMPR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn smp0(&mut self) -> SMP0_W<ADC_SMPR1rs> {
        SMP0_W::new(self, 0)
    }
    ///Bits 3:5 - SMP1
    #[inline(always)]
    #[must_use]
    pub fn smp1(&mut self) -> SMP1_W<ADC_SMPR1rs> {
        SMP1_W::new(self, 3)
    }
    ///Bits 6:8 - SMP2
    #[inline(always)]
    #[must_use]
    pub fn smp2(&mut self) -> SMP2_W<ADC_SMPR1rs> {
        SMP2_W::new(self, 6)
    }
    ///Bits 9:11 - SMP3
    #[inline(always)]
    #[must_use]
    pub fn smp3(&mut self) -> SMP3_W<ADC_SMPR1rs> {
        SMP3_W::new(self, 9)
    }
    ///Bits 12:14 - SMP4
    #[inline(always)]
    #[must_use]
    pub fn smp4(&mut self) -> SMP4_W<ADC_SMPR1rs> {
        SMP4_W::new(self, 12)
    }
    ///Bits 15:17 - SMP5
    #[inline(always)]
    #[must_use]
    pub fn smp5(&mut self) -> SMP5_W<ADC_SMPR1rs> {
        SMP5_W::new(self, 15)
    }
    ///Bits 18:20 - SMP6
    #[inline(always)]
    #[must_use]
    pub fn smp6(&mut self) -> SMP6_W<ADC_SMPR1rs> {
        SMP6_W::new(self, 18)
    }
    ///Bits 21:23 - SMP7
    #[inline(always)]
    #[must_use]
    pub fn smp7(&mut self) -> SMP7_W<ADC_SMPR1rs> {
        SMP7_W::new(self, 21)
    }
    ///Bits 24:26 - SMP8
    #[inline(always)]
    #[must_use]
    pub fn smp8(&mut self) -> SMP8_W<ADC_SMPR1rs> {
        SMP8_W::new(self, 24)
    }
    ///Bits 27:29 - SMP9
    #[inline(always)]
    #[must_use]
    pub fn smp9(&mut self) -> SMP9_W<ADC_SMPR1rs> {
        SMP9_W::new(self, 27)
    }
}
/**ADC sample time register 1

You can [`read`](crate::Reg::read) this register and get [`adc_smpr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc_smpr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#ADC1:ADC_SMPR1)*/
pub struct ADC_SMPR1rs;
impl crate::RegisterSpec for ADC_SMPR1rs {
    type Ux = u32;
}
///`read()` method returns [`adc_smpr1::R`](R) reader structure
impl crate::Readable for ADC_SMPR1rs {}
///`write(|w| ..)` method takes [`adc_smpr1::W`](W) writer structure
impl crate::Writable for ADC_SMPR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ADC_SMPR1 to value 0
impl crate::Resettable for ADC_SMPR1rs {
