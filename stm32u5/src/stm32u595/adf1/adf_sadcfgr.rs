...
pub type R = crate::R<ADF_SADCFGRrs>;
///Register `ADF_SADCFGR` writer
pub type W = crate::W<ADF_SADCFGRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn snthr(&mut self) -> SNTHR_W<ADF_SADCFGRrs> {
        SNTHR_W::new(self, 0)
    }
    ///Bits 4:6 - ANSLP
    #[inline(always)]
    #[must_use]
    pub fn anslp(&mut self) -> ANSLP_W<ADF_SADCFGRrs> {
        ANSLP_W::new(self, 4)
    }
    ///Bits 8:10 - LFRNB
    #[inline(always)]
    #[must_use]
    pub fn lfrnb(&mut self) -> LFRNB_W<ADF_SADCFGRrs> {
        LFRNB_W::new(self, 8)
    }
    ///Bits 12:14 - Hangover time window
    #[inline(always)]
    #[must_use]
    pub fn hgovr(&mut self) -> HGOVR_W<ADF_SADCFGRrs> {
        HGOVR_W::new(self, 12)
    }
    ///Bits 16:28 - ANMIN
    #[inline(always)]
    #[must_use]
    pub fn anmin(&mut self) -> ANMIN_W<ADF_SADCFGRrs> {
        ANMIN_W::new(self, 16)
    }
}
/**ADF SAD configuration register

You can [`read`](crate::Reg::read) this register and get [`adf_sadcfgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adf_sadcfgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#ADF1:ADF_SADCFGR)*/
pub struct ADF_SADCFGRrs;
impl crate::RegisterSpec for ADF_SADCFGRrs {
    type Ux = u32;
}
///`read()` method returns [`adf_sadcfgr::R`](R) reader structure
impl crate::Readable for ADF_SADCFGRrs {}
///`write(|w| ..)` method takes [`adf_sadcfgr::W`](W) writer structure
impl crate::Writable for ADF_SADCFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ADF_SADCFGR to value 0
impl crate::Resettable for ADF_SADCFGRrs {
