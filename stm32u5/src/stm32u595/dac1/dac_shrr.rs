...
#[doc = "Field `TREFRESH2` reader - DAC Channel 2 refresh Time (only valid in sample and hold mode)"]
pub type TREFRESH2_R = crate::FieldReader;
#[doc = "Field `TREFRESH2` writer - DAC Channel 2 refresh Time (only valid in sample and hold mode)"]
...
impl R {
    ...
    #[doc = "Bits 16:23 - DAC Channel 2 refresh Time (only valid in sample and hold mode)"]
    #[inline(always)]
