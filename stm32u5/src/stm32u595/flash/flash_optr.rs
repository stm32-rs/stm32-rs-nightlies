...
///Field `SRAM1345_RST` reader - SRAM1, SRAM3, SRAM4 and SRAM5 erase upon system reset
pub type SRAM1345_RST_R = crate::BitReader;
///Field `SRAM1345_RST` writer - SRAM1, SRAM3, SRAM4 and SRAM5 erase upon system reset
...
impl R {
    ...
    ///Bit 15 - SRAM1, SRAM3, SRAM4 and SRAM5 erase upon system reset
    #[inline(always)]
...
You can [`read`](crate::Reg::read) this register and get [`flash_optr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flash_optr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
