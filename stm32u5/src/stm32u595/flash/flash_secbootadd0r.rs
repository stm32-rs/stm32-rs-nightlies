...
pub type R = crate::R<FLASH_SECBOOTADD0Rrs>;
///Register `FLASH_SECBOOTADD0R` writer
pub type W = crate::W<FLASH_SECBOOTADD0Rrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FLASH_SECBOOTADD0R")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn boot_lock(&mut self) -> BOOT_LOCK_W<FLASH_SECBOOTADD0Rrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn secbootadd0(&mut self) -> SECBOOTADD0_W<FLASH_SECBOOTADD0Rrs> {
        SECBOOTADD0_W::new(self, 7)
    }
}
/**FLASH secure boot address 0 register

You can [`read`](crate::Reg::read) this register and get [`flash_secbootadd0r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flash_secbootadd0r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#FLASH:FLASH_SECBOOTADD0R)*/
pub struct FLASH_SECBOOTADD0Rrs;
impl crate::RegisterSpec for FLASH_SECBOOTADD0Rrs {
    type Ux = u32;
}
///`read()` method returns [`flash_secbootadd0r::R`](R) reader structure
impl crate::Readable for FLASH_SECBOOTADD0Rrs {}
///`write(|w| ..)` method takes [`flash_secbootadd0r::W`](W) writer structure
impl crate::Writable for FLASH_SECBOOTADD0Rrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FLASH_SECBOOTADD0R to value 0
impl crate::Resettable for FLASH_SECBOOTADD0Rrs {
