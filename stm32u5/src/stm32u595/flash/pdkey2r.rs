...
///Field `PDKEY2` writer - Bank 2 power-down key The following values must be written consecutively to unlock the PDREQ2 bit in FLASH_ACR: PDKEY2_1: 0x4051 6273 PDKEY2_2: 0xAFBF CFDF
...
impl W {
    ...
    #[inline(always)]
    pub fn pdkey2(&mut self) -> PDKEY2_W<'_, PDKEY2Rrs> {
        PDKEY2_W::new(self, 0)
    }
}
