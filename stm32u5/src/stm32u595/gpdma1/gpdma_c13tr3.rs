///Register `GPDMA_C13TR3` reader
pub type R = crate::R<GPDMA_C13TR3rs>;
///Register `GPDMA_C13TR3` writer
pub type W = crate::W<GPDMA_C13TR3rs>;
...
for each programmed source burst. This offset is not including and is added to the programmed burst size when the completed burst is addressed in incremented mode i.e. if GPDMA_CxTR1.SINC=1. Note: A source address offset must be aligned with the programmed data width of a source burst (c.f. SAO\[2:0\]
...
vs GPDMA_CxTR1.DDW_LOG2\[1:0\]). Else a user setting error is reported and none transfer is issued. Note: When the source block size is not a multiple of the destination burst size and is a multiple of the source data width, then the last programmed source burst is not completed and is internally shorten to match the block size. In this case, the additional GPDMA_CxTR3.SAO\[12:0\]
is not applied.*/
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sao(&mut self) -> SAO_W<GPDMA_C13TR3rs> {
        SAO_W::new(self, 0)
    }
    /**Bits 16:28 - destination address offset increment The destination address, pointed by GPDMA_CxDAR, is incremented or decremented (depending on GPDMA_CxBR1.DDEC) by this offset DAO\[12:0\]
    for each programmed destination burst. This offset is not including and is added to the programmed burst size when the completed burst is addressed in incremented mode i.e. if GPDMA_CxTR1.DINC=1. Note: A destination address offset must be aligned with the programmed data width of a destination burst (c.f. DAO\[2:0\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dao(&mut self) -> DAO_W<GPDMA_C13TR3rs> {
        DAO_W::new(self, 16)
    }
}
/**GPDMA channel x transfer register 3

You can [`read`](crate::Reg::read) this register and get [`gpdma_c13tr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c13tr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#GPDMA1:GPDMA_C13TR3)*/
pub struct GPDMA_C13TR3rs;
impl crate::RegisterSpec for GPDMA_C13TR3rs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c13tr3::R`](R) reader structure
impl crate::Readable for GPDMA_C13TR3rs {}
///`write(|w| ..)` method takes [`gpdma_c13tr3::W`](W) writer structure
impl crate::Writable for GPDMA_C13TR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C13TR3 to value 0
impl crate::Resettable for GPDMA_C13TR3rs {
