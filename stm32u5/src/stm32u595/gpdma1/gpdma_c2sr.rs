...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c2sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#GPDMA1:GPDMA_C2SR)*/
pub struct GPDMA_C2SRrs;
impl crate::RegisterSpec for GPDMA_C2SRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c2sr::R`](R) reader structure
impl crate::Readable for GPDMA_C2SRrs {}
///`reset()` method sets GPDMA_C2SR to value 0x01
