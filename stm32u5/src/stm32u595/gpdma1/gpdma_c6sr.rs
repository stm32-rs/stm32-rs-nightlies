...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c6sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#GPDMA1:GPDMA_C6SR)*/
pub struct GPDMA_C6SRrs;
impl crate::RegisterSpec for GPDMA_C6SRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c6sr::R`](R) reader structure
impl crate::Readable for GPDMA_C6SRrs {}
///`reset()` method sets GPDMA_C6SR to value 0x01
