...
#[doc = "Field `CFSMC_MEMF` writer - clear the illegal access flag for MPCWM2 (FSMC NAND) and MPCWM3"]
...
#[doc = "Field `COCTOSPI2_MEMF` writer - clear the illegal access flag for OCTOSPI2 memory bank"]
...
#[doc = "Field `CMPCBB5_REGF` writer - clear the illegal access flag for MPCBB5 registers"]
...
impl W {
    ...
    #[doc = "Bit 17 - clear the illegal access flag for MPCWM2 (FSMC NAND) and MPCWM3"]
    #[inline(always)]
    #[must_use]
    ...
    #[doc = "Bit 19 - clear the illegal access flag for OCTOSPI2 memory bank"]
    #[inline(always)]
    #[must_use]
    ...
    #[doc = "Bit 31 - clear the illegal access flag for MPCBB5 registers"]
    #[inline(always)]
    #[must_use]
