...
impl W {
    ///Bit 0 - secure access mode for MDF1
    #[inline(always)]
    pub fn mdf1sec(&mut self) -> MDF1SEC_W<'_, SECCFGR3rs> {
    ...
    ///Bit 5 - secure access mode for register of DMA2D
    #[inline(always)]
    pub fn dma2dsec(&mut self) -> DMA2DSEC_W<'_, SECCFGR3rs> {
    ...
    ///Bit 7 - secure access mode for DCACHE1 registers
    #[inline(always)]
    pub fn dcache1_regsec(&mut self) -> DCACHE1_REGSEC_W<'_, SECCFGR3rs> {
        DCACHE1_REGSEC_W::new(self, 7)
    }
    ///Bit 8 - secure access mode for ADC1
    #[inline(always)]
    pub fn adc1sec(&mut self) -> ADC1SEC_W<'_, SECCFGR3rs> {
    ...
    ///Bit 10 - secure access mode for OTG_FS
    #[inline(always)]
    pub fn otgfssec(&mut self) -> OTGFSSEC_W<'_, SECCFGR3rs> {
    ...
    ///Bit 16 - secure access mode for OCTOSPIM
    #[inline(always)]
    pub fn octospimsec(&mut self) -> OCTOSPIMSEC_W<'_, SECCFGR3rs> {
    ...
    ///Bit 19 - secure access mode for FSMC registers
    #[inline(always)]
    pub fn fsmc_regsec(&mut self) -> FSMC_REGSEC_W<'_, SECCFGR3rs> {
        FSMC_REGSEC_W::new(self, 19)
    }
    ///Bit 20 - secure access mode for OCTOSPI1 registers
    #[inline(always)]
    pub fn octospi1_regsec(&mut self) -> OCTOSPI1_REGSEC_W<'_, SECCFGR3rs> {
        OCTOSPI1_REGSEC_W::new(self, 20)
    }
    ///Bit 21 - secure access mode for OCTOSPI2 registers
    #[inline(always)]
    pub fn octospi2_regsec(&mut self) -> OCTOSPI2_REGSEC_W<'_, SECCFGR3rs> {
    ...
    ///Bit 26 - HSPI1_REGSEC
    #[inline(always)]
    pub fn hspi1_regsec(&mut self) -> HSPI1_REGSEC_W<'_, SECCFGR3rs> {
