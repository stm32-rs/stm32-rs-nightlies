...
pub type R = crate::R<TZSC_MPCWM3ACFGRrs>;
///Register `TZSC_MPCWM3ACFGR` writer
pub type W = crate::W<TZSC_MPCWM3ACFGRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TZSC_MPCWM3ACFGR")
...
impl W {
    ///Bit 0 - Sub-region enable
    #[inline(always)]
    pub fn sren(&mut self) -> SREN_W<TZSC_MPCWM3ACFGRrs> {
        SREN_W::new(self, 0)
    }
    ///Bit 1 - Sub-region lock
    #[inline(always)]
    pub fn srlock(&mut self) -> SRLOCK_W<TZSC_MPCWM3ACFGRrs> {
        SRLOCK_W::new(self, 1)
    }
    ///Bit 8 - Secure sub-region
    #[inline(always)]
    pub fn sec(&mut self) -> SEC_W<TZSC_MPCWM3ACFGRrs> {
        SEC_W::new(self, 8)
    }
    ///Bit 9 - Privileged sub-region
    #[inline(always)]
    pub fn priv_(&mut self) -> PRIV_W<TZSC_MPCWM3ACFGRrs> {
        PRIV_W::new(self, 9)
    }
}
/**TZSC memory 3 sub-region A watermark configuration register

You can [`read`](crate::Reg::read) this register and get [`tzsc_mpcwm3acfgr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tzsc_mpcwm3acfgr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#GTZC1_TZSC:TZSC_MPCWM3ACFGR)*/
pub struct TZSC_MPCWM3ACFGRrs;
impl crate::RegisterSpec for TZSC_MPCWM3ACFGRrs {
    type Ux = u32;
}
///`read()` method returns [`tzsc_mpcwm3acfgr::R`](R) reader structure
impl crate::Readable for TZSC_MPCWM3ACFGRrs {}
///`write(|w| ..)` method takes [`tzsc_mpcwm3acfgr::W`](W) writer structure
impl crate::Writable for TZSC_MPCWM3ACFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TZSC_MPCWM3ACFGR to value 0
impl crate::Resettable for TZSC_MPCWM3ACFGRrs {
