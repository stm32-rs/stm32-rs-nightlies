///Register `TZSC_MPCWM3AR` reader
pub type R = crate::R<TZSC_MPCWM3ARrs>;
///Register `TZSC_MPCWM3AR` writer
...
You can [`read`](crate::Reg::read) this register and get [`tzsc_mpcwm3ar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tzsc_mpcwm3ar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`tzsc_mpcwm3ar::R`](R) reader structure
impl crate::Readable for TZSC_MPCWM3ARrs {}
///`write(|w| ..)` method takes [`tzsc_mpcwm3ar::W`](W) writer structure
impl crate::Writable for TZSC_MPCWM3ARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TZSC_MPCWM3AR to value 0
