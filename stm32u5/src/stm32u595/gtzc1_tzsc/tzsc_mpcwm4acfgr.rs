...
impl W {
    ///Bit 0 - Sub-region enable
    #[inline(always)]
    pub fn sren(&mut self) -> SREN_W<TZSC_MPCWM4ACFGRrs> {
        SREN_W::new(self, 0)
    }
    ///Bit 1 - Sub-region lock
    #[inline(always)]
    pub fn srlock(&mut self) -> SRLOCK_W<TZSC_MPCWM4ACFGRrs> {
        SRLOCK_W::new(self, 1)
    }
    ///Bit 8 - Secure sub-region
    #[inline(always)]
    pub fn sec(&mut self) -> SEC_W<TZSC_MPCWM4ACFGRrs> {
        SEC_W::new(self, 8)
    }
    ///Bit 9 - Privileged sub-region
    #[inline(always)]
    pub fn priv_(&mut self) -> PRIV_W<TZSC_MPCWM4ACFGRrs> {
        PRIV_W::new(self, 9)
    }
}
