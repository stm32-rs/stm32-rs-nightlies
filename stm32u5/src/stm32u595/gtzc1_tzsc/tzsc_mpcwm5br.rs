...
pub type R = crate::R<TZSC_MPCWM5BRrs>;
///Register `TZSC_MPCWM5BR` writer
pub type W = crate::W<TZSC_MPCWM5BRrs>;
...
impl W {
    ///Bits 0:10 - Start of sub-region A
    #[inline(always)]
    pub fn subb_start(&mut self) -> SUBB_START_W<TZSC_MPCWM5BRrs> {
        SUBB_START_W::new(self, 0)
    }
    ///Bits 16:27 - Length of sub-region A
    #[inline(always)]
    pub fn subb_length(&mut self) -> SUBB_LENGTH_W<TZSC_MPCWM5BRrs> {
        SUBB_LENGTH_W::new(self, 16)
    }
}
/**TZSC memory 5 sub-region B watermark register

You can [`read`](crate::Reg::read) this register and get [`tzsc_mpcwm5br::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tzsc_mpcwm5br::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#GTZC1_TZSC:TZSC_MPCWM5BR)*/
pub struct TZSC_MPCWM5BRrs;
impl crate::RegisterSpec for TZSC_MPCWM5BRrs {
    type Ux = u32;
}
///`read()` method returns [`tzsc_mpcwm5br::R`](R) reader structure
impl crate::Readable for TZSC_MPCWM5BRrs {}
///`write(|w| ..)` method takes [`tzsc_mpcwm5br::W`](W) writer structure
impl crate::Writable for TZSC_MPCWM5BRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TZSC_MPCWM5BR to value 0
impl crate::Resettable for TZSC_MPCWM5BRrs {
