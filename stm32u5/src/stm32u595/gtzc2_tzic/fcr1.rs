...
///Field `CADC2F` writer - clear the illegal access flag for ADC2
...
impl W {
    ...
    #[inline(always)]
    pub fn cadf1f(&mut self) -> CADF1F_W<'_, FCR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#GTZC2_TZIC:FCR1)*/
pub struct FCR1rs;
