///Register `LPDMA_C2CR` reader
pub type R = crate::R<LPDMA_C2CRrs>;
///Register `LPDMA_C2CR` writer
...
///Field `LSM` writer - Link Step mode:- 0: channel is executed for the full linked-list, and completed at the end (if any) of the last LLI i.e. when LPDMA_CxLLR=0: the 16 low significant bits of the link address are null (LA\[15:0\]=0) and all the update bits are null i.e. UT1=UB1=UT2=USA=UDA=UB2 =UT3=ULL=0. Then LPDMA_CxBR1.BRC\[10:0\]=0 and LPDMA_CxBR1.BNDT\[15:0\]=0.- 1: channel is executed once for the current LLI:* First the (possibly 2D/repeated) block transfer is executed as defined by the current internal register file until that (LPDMA_CxBR1.BRC\[10:0\]=0 and LPDMA_CxBR1.BNDT\[15:0\]=0).* Secondly the next linked-list data structure is conditionally uploaded from memory as defined by LPDMA_CxLLR register. Then channel execution is completed.Note: This bit must be written when EN=0. This bit is read-only when EN=1.
...
You can [`read`](crate::Reg::read) this register and get [`lpdma_c2cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpdma_c2cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#LPDMA1:LPDMA_C2CR)*/
pub struct LPDMA_C2CRrs;
impl crate::RegisterSpec for LPDMA_C2CRrs {
    type Ux = u32;
}
///`read()` method returns [`lpdma_c2cr::R`](R) reader structure
impl crate::Readable for LPDMA_C2CRrs {}
///`write(|w| ..)` method takes [`lpdma_c2cr::W`](W) writer structure
impl crate::Writable for LPDMA_C2CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPDMA_C2CR to value 0
