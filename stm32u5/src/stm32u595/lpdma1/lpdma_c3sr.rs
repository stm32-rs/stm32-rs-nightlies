///Register `LPDMA_C3SR` reader
pub type R = crate::R<LPDMA_C3SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`lpdma_c3sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#LPDMA1:LPDMA_C3SR)*/
pub struct LPDMA_C3SRrs;
impl crate::RegisterSpec for LPDMA_C3SRrs {
    type Ux = u32;
}
///`read()` method returns [`lpdma_c3sr::R`](R) reader structure
impl crate::Readable for LPDMA_C3SRrs {}
///`reset()` method sets LPDMA_C3SR to value 0x01
impl crate::Resettable for LPDMA_C3SRrs {
