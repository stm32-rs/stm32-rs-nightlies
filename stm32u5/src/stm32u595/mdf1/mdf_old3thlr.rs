...
pub type R = crate::R<MDF_OLD3THLRrs>;
///Register `MDF_OLD3THLR` writer
pub type W = crate::W<MDF_OLD3THLRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn oldthl(&mut self) -> OLDTHL_W<MDF_OLD3THLRrs> {
        OLDTHL_W::new(self, 0)
    }
}
/**This register is used for the adjustment of the Out-off Limit low threshold.

You can [`read`](crate::Reg::read) this register and get [`mdf_old3thlr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_old3thlr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#MDF1:MDF_OLD3THLR)*/
pub struct MDF_OLD3THLRrs;
impl crate::RegisterSpec for MDF_OLD3THLRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_old3thlr::R`](R) reader structure
impl crate::Readable for MDF_OLD3THLRrs {}
///`write(|w| ..)` method takes [`mdf_old3thlr::W`](W) writer structure
impl crate::Writable for MDF_OLD3THLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_OLD3THLR to value 0
impl crate::Resettable for MDF_OLD3THLRrs {
