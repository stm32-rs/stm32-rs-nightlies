///Register `MDF_SITF4CR` reader
pub type R = crate::R<MDF_SITF4CRrs>;
///Register `MDF_SITF4CR` writer
pub type W = crate::W<MDF_SITF4CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sitfen(&mut self) -> SITFEN_W<MDF_SITF4CRrs> {
        SITFEN_W::new(self, 0)
    }
    ///Bits 1:2 - Serial clock source Set and cleared by software. This bit is used to select the clock source of the serial interface. - 00: Serial clock source is MDF_CCK0 - 01: Serial clock source is MDF_CCK1 1x: Serial clock source is MDF_CKIx, not allowed in LF_MASTER SPI mode This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
    #[inline(always)]
    #[must_use]
    pub fn scksrc(&mut self) -> SCKSRC_W<MDF_SITF4CRrs> {
        SCKSRC_W::new(self, 1)
    }
    ///Bits 4:5 - Serial interface type Set and cleared by software. This field is used to defined the serial interface type. - 00: LF_MASTER (Low-Frequency MASTER) SPI mode - 01: Normal SPI mode - 10: Manchester mode: rising edge = logic 0, falling edge = logic 1 - 11: Manchester mode: rising edge = logic 1, falling edge = logic 0 This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
    #[inline(always)]
    #[must_use]
    pub fn sitfmod(&mut self) -> SITFMOD_W<MDF_SITF4CRrs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sth(&mut self) -> STH_W<MDF_SITF4CRrs> {
        STH_W::new(self, 8)
    }
}
/**This register is used to control the serial interfaces (SITFx).

You can [`read`](crate::Reg::read) this register and get [`mdf_sitf4cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_sitf4cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#MDF1:MDF_SITF4CR)*/
pub struct MDF_SITF4CRrs;
impl crate::RegisterSpec for MDF_SITF4CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_sitf4cr::R`](R) reader structure
impl crate::Readable for MDF_SITF4CRrs {}
///`write(|w| ..)` method takes [`mdf_sitf4cr::W`](W) writer structure
impl crate::Writable for MDF_SITF4CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_SITF4CR to value 0x1f00
impl crate::Resettable for MDF_SITF4CRrs {
