...
pub type R = crate::R<MDF_SNPS0DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdf_snps0dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#MDF1:MDF_SNPS0DR)*/
pub struct MDF_SNPS0DRrs;
impl crate::RegisterSpec for MDF_SNPS0DRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_snps0dr::R`](R) reader structure
impl crate::Readable for MDF_SNPS0DRrs {}
///`reset()` method sets MDF_SNPS0DR to value 0
impl crate::Resettable for MDF_SNPS0DRrs {
