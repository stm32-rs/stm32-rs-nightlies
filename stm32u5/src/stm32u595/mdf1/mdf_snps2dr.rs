#[doc = "Register `MDF_SNPS2DR` reader"]
...
#[doc = "This register is used to read the data processed by each digital filter in snapshot mode.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_snps2dr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_SNPS2DRrs;
impl crate::RegisterSpec for MDF_SNPS2DRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_snps2dr::R`](R) reader structure"]
impl crate::Readable for MDF_SNPS2DRrs {}
#[doc = "`reset()` method sets MDF_SNPS2DR to value 0"]
