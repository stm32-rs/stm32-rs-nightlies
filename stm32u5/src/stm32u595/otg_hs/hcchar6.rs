...
impl W {
    ///Bits 0:10 - MPSIZ
    #[inline(always)]
    pub fn mpsiz(&mut self) -> MPSIZ_W<HCCHAR6rs> {
        MPSIZ_W::new(self, 0)
    }
    ///Bits 11:14 - EPNUM
    #[inline(always)]
    pub fn epnum(&mut self) -> EPNUM_W<HCCHAR6rs> {
        EPNUM_W::new(self, 11)
    }
    ///Bit 15 - EPDIR
    #[inline(always)]
    pub fn epdir(&mut self) -> EPDIR_W<HCCHAR6rs> {
        EPDIR_W::new(self, 15)
    }
    ///Bit 17 - LSDEV
    #[inline(always)]
    pub fn lsdev(&mut self) -> LSDEV_W<HCCHAR6rs> {
        LSDEV_W::new(self, 17)
    }
    ///Bits 18:19 - EPTYP
    #[inline(always)]
    pub fn eptyp(&mut self) -> EPTYP_W<HCCHAR6rs> {
        EPTYP_W::new(self, 18)
    }
    ///Bits 20:21 - MCNT
    #[inline(always)]
    pub fn mcnt(&mut self) -> MCNT_W<HCCHAR6rs> {
        MCNT_W::new(self, 20)
    }
    ///Bits 22:28 - DAD
    #[inline(always)]
    pub fn dad(&mut self) -> DAD_W<HCCHAR6rs> {
        DAD_W::new(self, 22)
    }
    ///Bit 29 - ODDFRM
    #[inline(always)]
    pub fn oddfrm(&mut self) -> ODDFRM_W<HCCHAR6rs> {
        ODDFRM_W::new(self, 29)
    }
    ///Bit 30 - CHDIS
    #[inline(always)]
    pub fn chdis(&mut self) -> CHDIS_W<HCCHAR6rs> {
        CHDIS_W::new(self, 30)
    }
    ///Bit 31 - CHENA
    #[inline(always)]
    pub fn chena(&mut self) -> CHENA_W<HCCHAR6rs> {
        CHENA_W::new(self, 31)
    }
}
