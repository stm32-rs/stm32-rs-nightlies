...
#[doc = "RAMCFG RAMx interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`m4isr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct M4ISRrs;
impl crate::RegisterSpec for M4ISRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`m4isr::R`](R) reader structure"]
impl crate::Readable for M4ISRrs {}
#[doc = "`reset()` method sets M4ISR to value 0"]
