#[doc = "Register `RAM1ERKEYR` writer"]
...
#[doc = "RAMCFG SRAM x erase key register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ram1erkeyr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RAM1ERKEYRrs;
impl crate::RegisterSpec for RAM1ERKEYRrs {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ram1erkeyr::W`](W) writer structure"]
impl crate::Writable for RAM1ERKEYRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM1ERKEYR to value 0"]
