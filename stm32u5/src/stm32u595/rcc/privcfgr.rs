...
/**RCC secure function privilege configuration This bit is set and reset by software. It can be written only by a secure privileged access.
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn unprivileged(self) -> &'a mut crate::W<REG> {
        self.variant(SPRIV::Unprivileged)
    }
    ///Read and write to RCC secure functions can be done by privileged access only
    #[inline(always)]
    pub fn privileged(self) -> &'a mut crate::W<REG> {
        self.variant(SPRIV::Privileged)
    }
}
/**RCC non-secure function privilege configuration This bit is set and reset by software. It can be written only by privileged access, secure or non-secure.
...
impl NSPRIV_R {
    ...
    ///Read and write to RCC nonsecure functions can be done by privileged or unprivileged access
    #[inline(always)]
    pub fn is_unprivileged(&self) -> bool {
        *self == NSPRIV::Unprivileged
    }
    ///Read and write to RCC nonsecure functions can be done by privileged access only
    #[inline(always)]
    pub fn is_privileged(&self) -> bool {
