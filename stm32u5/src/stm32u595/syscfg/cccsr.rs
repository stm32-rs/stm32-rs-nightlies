...
impl W {
    ...
    ///Bit 4 - EN3
    #[inline(always)]
    pub fn en3(&mut self) -> EN3_W<'_, CCCSRrs> {
        EN3_W::new(self, 4)
    }
    ///Bit 5 - CS3
    #[inline(always)]
    pub fn cs3(&mut self) -> CS3_W<'_, CCCSRrs> {
        CS3_W::new(self, 5)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#SYSCFG:CCCSR)*/
pub struct CCCSRrs;
