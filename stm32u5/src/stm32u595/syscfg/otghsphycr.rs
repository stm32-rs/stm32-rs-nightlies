...
impl W {
    ///Bit 0 - EN
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, OTGHSPHYCRrs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - PDCTRL
    #[inline(always)]
    pub fn pdctrl(&mut self) -> PDCTRL_W<'_, OTGHSPHYCRrs> {
        PDCTRL_W::new(self, 1)
    }
    ///Bits 2:5 - CLKSEL
    #[inline(always)]
    pub fn clksel(&mut self) -> CLKSEL_W<'_, OTGHSPHYCRrs> {
        CLKSEL_W::new(self, 2)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#SYSCFG:OTGHSPHYCR)*/
