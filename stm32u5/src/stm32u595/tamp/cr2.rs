...
impl W {
    ...
    ///Bit 3 - TAMP4NOER
    #[inline(always)]
    pub fn tamp4noer(&mut self) -> TAMP4NOER_W<'_, CR2rs> {
        TAMP4NOER_W::new(self, 3)
    }
    ///Bit 4 - TAMP5NOER
    #[inline(always)]
    pub fn tamp5noer(&mut self) -> TAMP5NOER_W<'_, CR2rs> {
        TAMP5NOER_W::new(self, 4)
    }
    ///Bit 5 - TAMP6NOER
    #[inline(always)]
    pub fn tamp6noer(&mut self) -> TAMP6NOER_W<'_, CR2rs> {
        TAMP6NOER_W::new(self, 5)
    }
    ///Bit 6 - TAMP7NOER
    #[inline(always)]
    pub fn tamp7noer(&mut self) -> TAMP7NOER_W<'_, CR2rs> {
        TAMP7NOER_W::new(self, 6)
    }
    ///Bit 7 - TAMP8NOER
    #[inline(always)]
    pub fn tamp8noer(&mut self) -> TAMP8NOER_W<'_, CR2rs> {
    ...
    ///Bit 31 - TAMP8TRG
    #[inline(always)]
    pub fn tamp8trg(&mut self) -> TAMP8TRG_W<'_, CR2rs> {
