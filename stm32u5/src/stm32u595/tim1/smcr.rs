...
///Field `SMS3_0` reader - Slave mode selection
pub type SMS3_0_R = crate::BitReader;
///Field `SMS3_0` writer - Slave mode selection
pub type SMS3_0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TS4_3` reader - Trigger selection
pub type TS4_3_R = crate::FieldReader;
///Field `TS4_3` writer - Trigger selection
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SMCR")
            ...
            .field("ts4_3", &self.ts4_3())
            .field("sms3_0", &self.sms3_0())
            .field("etp", &self.etp())
            .field("ece", &self.ece())
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#TIM1:SMCR)*/
pub struct SMCRrs;
