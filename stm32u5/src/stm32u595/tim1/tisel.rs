...
/**Field `TI1SEL` reader - Selects tim_ti3\[0..15\]
input*/
pub type TI1SEL_R = crate::FieldReader;
/**Field `TI1SEL` writer - Selects tim_ti3\[0..15\]
input*/
pub type TI1SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
/**Field `TI2SEL` reader - Selects tim_ti3\[0..15\]
input*/
pub type TI2SEL_R = crate::FieldReader;
/**Field `TI2SEL` writer - Selects tim_ti3\[0..15\]
input*/
...
impl R {
    /**Bits 0:3 - Selects tim_ti3\[0..15\]
    input*/
    #[inline(always)]
    pub fn ti1sel(&self) -> TI1SEL_R {
        TI1SEL_R::new((self.bits & 0x0f) as u8)
    }
    /**Bits 8:11 - Selects tim_ti3\[0..15\]
    input*/
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U595.html#TIM1:TISEL)*/
pub struct TISELrs;
