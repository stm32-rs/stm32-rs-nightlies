...
#[doc = "Field `OCRSEL` reader - tim_ocref_clr source selection"]
pub type OCRSEL_R = crate::FieldReader;
#[doc = "Field `OCRSEL` writer - tim_ocref_clr source selection"]
pub type OCRSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 16:18 - tim_ocref_clr source selection"]
    #[inline(always)]
