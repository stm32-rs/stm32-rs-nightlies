...
pub type SQ1_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
///Field `SQ2` reader - SQ2
pub type SQ2_R = crate::FieldReader;
///Field `SQ2` writer - SQ2
pub type SQ2_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
///Field `SQ3` reader - SQ3
pub type SQ3_R = crate::FieldReader;
///Field `SQ3` writer - SQ3
pub type SQ3_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
///Field `SQ4` reader - SQ4
pub type SQ4_R = crate::FieldReader;
///Field `SQ4` writer - SQ4
pub type SQ4_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
impl R {
    ///Bits 0:3 - L
    #[inline(always)]
    pub fn l(&self) -> L_R {
