...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn chselrmod1(&self) -> &CHSELRMOD1 {
        unsafe { &*(self as *const Self).cast::<u8>().add(40).cast() }
    }
    ///0x28 - ADC channel selection register \[alternate\]
    #[inline(always)]
    pub const fn chselrmod0(&self) -> &CHSELRMOD0 {
        unsafe { &*(self as *const Self).cast::<u8>().add(40).cast() }
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:IER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:CFGR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:CFGR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:SMPR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:AWD1TR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:AWD2TR)
...
///ADC watchdog threshold register
pub mod awd2tr;
/**CHSELRMOD0 (rw) register accessor: ADC channel selection register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`chselrmod0::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`chselrmod0::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:CHSELRMOD0)

For information about available fields see [`mod@chselrmod0`]
module*/
pub type CHSELRMOD0 = crate::Reg<chselrmod0::CHSELRMOD0rs>;
///ADC channel selection register \[alternate\]
pub mod chselrmod0;
/**CHSELRMOD1 (rw) register accessor: ADC channel selection register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`chselrmod1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`chselrmod1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:CHSELRMOD1)

For information about available fields see [`mod@chselrmod1`]
module*/
pub type CHSELRMOD1 = crate::Reg<chselrmod1::CHSELRMOD1rs>;
///ADC channel selection register \[alternate\]
pub mod chselrmod1;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:AWD3TR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:DR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:PWRR)

For information about available fields see [`mod@pwrr`]
module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:AWD2CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:AWD3CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:CALFACT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:OR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADC4:CCR)
