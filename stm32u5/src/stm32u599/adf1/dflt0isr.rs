...
impl W {
    ...
    ///Bit 12 - Sound activity detection flag
    #[inline(always)]
    pub fn sddetf(&mut self) -> SDDETF_W<'_, DFLT0ISRrs> {
        SDDETF_W::new(self, 12)
    }
    ///Bit 13 - Sound level value ready flag
    #[inline(always)]
    pub fn sdlvlf(&mut self) -> SDLVLF_W<'_, DFLT0ISRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#ADF1:DFLT0ISR)*/
