...
#[doc = "Field `COM2_EN` reader - Comparator 2 enable bit"]
pub type COM2_EN_R = crate::BitReader;
#[doc = "Field `COM2_EN` writer - Comparator 2 enable bit"]
pub type COM2_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `COM2_INMSEL` reader - Comparator 2 Input Minus connection configuration bit"]
pub type COM2_INMSEL_R = crate::FieldReader;
#[doc = "Field `COM2_INMSEL` writer - Comparator 2 Input Minus connection configuration bit"]
pub type COM2_INMSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `COM2_INPSEL` reader - Comparator 2 input plus selection bit"]
pub type COM2_INPSEL_R = crate::FieldReader;
#[doc = "Field `COM2_INPSEL` writer - Comparator 2 input plus selection bit"]
pub type COM2_INPSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `COM2_WINMODE` reader - COM2_WINMODE"]
pub type COM2_WINMODE_R = crate::BitReader;
#[doc = "Field `COM2_WINMODE` writer - COM2_WINMODE"]
pub type COM2_WINMODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `COM2_WINOUT` reader - COM2_WINOUT"]
pub type COM2_WINOUT_R = crate::BitReader;
#[doc = "Field `COM2_WINOUT` writer - COM2_WINOUT"]
pub type COM2_WINOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `COM2_POLARITY` reader - Comparator 2 polarity selection bit"]
pub type COM2_POLARITY_R = crate::BitReader;
#[doc = "Field `COM2_POLARITY` writer - Comparator 2 polarity selection bit"]
pub type COM2_POLARITY_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `COM2_HYST` reader - Comparator 2 hysteresis selection bits"]
pub type COM2_HYST_R = crate::FieldReader;
#[doc = "Field `COM2_HYST` writer - Comparator 2 hysteresis selection bits"]
pub type COM2_HYST_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `COM2_PWRMODE` reader - COM2_PWRMODE"]
pub type COM2_PWRMODE_R = crate::FieldReader;
#[doc = "Field `COM2_PWRMODE` writer - COM2_PWRMODE"]
pub type COM2_PWRMODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `COM2_BLANKSEL` reader - COM2_BLANKSEL"]
pub type COM2_BLANKSEL_R = crate::FieldReader;
#[doc = "Field `COM2_BLANKSEL` writer - COM2_BLANKSEL"]
pub type COM2_BLANKSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `COM2_VALUE` reader - Comparator 2 output status bit"]
pub type COM2_VALUE_R = crate::BitReader;
#[doc = "Field `COM2_LOCK` reader - COMP2_CSR register lock bit"]
pub type COM2_LOCK_R = crate::BitReader;
#[doc = "Field `COM2_LOCK` writer - COMP2_CSR register lock bit"]
