...
#[doc = "Field `DACC1DHRB` reader - DAC channel1 8-bit right-aligned Sdata"]
pub type DACC1DHRB_R = crate::FieldReader;
#[doc = "Field `DACC1DHRB` writer - DAC channel1 8-bit right-aligned Sdata"]
...
impl R {
    ...
    #[doc = "Bits 8:15 - DAC channel1 8-bit right-aligned Sdata"]
    #[inline(always)]
