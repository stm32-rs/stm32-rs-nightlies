///Register `DSI_CCR` reader
pub type R = crate::R<DSI_CCRrs>;
///Register `DSI_CCR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#DSI:DSI_CCR)*/
pub struct DSI_CCRrs;
impl crate::RegisterSpec for DSI_CCRrs {
    type Ux = u32;
}
///`read()` method returns [`dsi_ccr::R`](R) reader structure
impl crate::Readable for DSI_CCRrs {}
///`write(|w| ..)` method takes [`dsi_ccr::W`](W) writer structure
impl crate::Writable for DSI_CCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_CCR to value 0
