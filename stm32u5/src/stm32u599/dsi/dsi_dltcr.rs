///Register `DSI_DLTCR` reader
pub type R = crate::R<DSI_DLTCRrs>;
///Register `DSI_DLTCR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#DSI:DSI_DLTCR)*/
pub struct DSI_DLTCRrs;
impl crate::RegisterSpec for DSI_DLTCRrs {
    type Ux = u32;
}
///`read()` method returns [`dsi_dltcr::R`](R) reader structure
impl crate::Readable for DSI_DLTCRrs {}
///`write(|w| ..)` method takes [`dsi_dltcr::W`](W) writer structure
impl crate::Writable for DSI_DLTCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_DLTCR to value 0
