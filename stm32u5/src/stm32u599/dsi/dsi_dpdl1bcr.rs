#[doc = "Register `DSI_DPDL1BCR` reader"]
pub type R = crate::R<DSI_DPDL1BCRrs>;
#[doc = "Register `DSI_DPDL1BCR` writer"]
...
impl R {
    #[doc = "Bits 0:4 - Band control This field selects the frequency band used by the D-PHY. Others: Reserved"]
    #[inline(always)]
    pub fn bc(&self) -> BC_R {
