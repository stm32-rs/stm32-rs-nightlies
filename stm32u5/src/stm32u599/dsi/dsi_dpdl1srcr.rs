///Register `DSI_DPDL1SRCR` reader
pub type R = crate::R<DSI_DPDL1SRCRrs>;
///Register `DSI_DPDL1SRCR` writer
...
You can [`read`](crate::Reg::read) this register and get [`dsi_dpdl1srcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dsi_dpdl1srcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dsi_dpdl1srcr::R`](R) reader structure
impl crate::Readable for DSI_DPDL1SRCRrs {}
///`write(|w| ..)` method takes [`dsi_dpdl1srcr::W`](W) writer structure
impl crate::Writable for DSI_DPDL1SRCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_DPDL1SRCR to value 0
