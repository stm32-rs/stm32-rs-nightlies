...
You can [`read`](crate::Reg::read) this register and get [`dsi_fbsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dsi_fbsr::R`](R) reader structure
impl crate::Readable for DSI_FBSRrs {}
///`reset()` method sets DSI_FBSR to value 0x0005_0015
