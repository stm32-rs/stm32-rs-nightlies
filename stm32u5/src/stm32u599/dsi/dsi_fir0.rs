...
impl core::fmt::Debug for crate::generic::Reg<DSI_FIR0rs> {
...
///`write(|w| ..)` method takes [`dsi_fir0::W`](W) writer structure
impl crate::Writable for DSI_FIR0rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_FIR0 to value 0
