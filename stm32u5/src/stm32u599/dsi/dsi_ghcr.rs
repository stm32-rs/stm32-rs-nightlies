///Register `DSI_GHCR` reader
pub type R = crate::R<DSI_GHCRrs>;
///Register `DSI_GHCR` writer
...
///`read()` method returns [`dsi_ghcr::R`](R) reader structure
impl crate::Readable for DSI_GHCRrs {}
///`write(|w| ..)` method takes [`dsi_ghcr::W`](W) writer structure
impl crate::Writable for DSI_GHCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_GHCR to value 0
