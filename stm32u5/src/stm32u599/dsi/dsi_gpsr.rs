...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#DSI:DSI_GPSR)*/
pub struct DSI_GPSRrs;
impl crate::RegisterSpec for DSI_GPSRrs {
    type Ux = u32;
}
///`read()` method returns [`dsi_gpsr::R`](R) reader structure
impl crate::Readable for DSI_GPSRrs {}
///`reset()` method sets DSI_GPSR to value 0x0005_0015
