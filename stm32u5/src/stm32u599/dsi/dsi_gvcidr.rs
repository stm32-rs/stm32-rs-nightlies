///Register `DSI_GVCIDR` reader
pub type R = crate::R<DSI_GVCIDRrs>;
///Register `DSI_GVCIDR` writer
...
You can [`read`](crate::Reg::read) this register and get [`dsi_gvcidr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dsi_gvcidr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`dsi_gvcidr::R`](R) reader structure
impl crate::Readable for DSI_GVCIDRrs {}
///`write(|w| ..)` method takes [`dsi_gvcidr::W`](W) writer structure
impl crate::Writable for DSI_GVCIDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_GVCIDR to value 0
