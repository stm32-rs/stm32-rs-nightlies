///Register `DSI_IER1` reader
pub type R = crate::R<DSI_IER1rs>;
///Register `DSI_IER1` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#DSI:DSI_IER1)*/
pub struct DSI_IER1rs;
impl crate::RegisterSpec for DSI_IER1rs {
    type Ux = u32;
}
///`read()` method returns [`dsi_ier1::R`](R) reader structure
impl crate::Readable for DSI_IER1rs {}
///`write(|w| ..)` method takes [`dsi_ier1::W`](W) writer structure
impl crate::Writable for DSI_IER1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_IER1 to value 0
