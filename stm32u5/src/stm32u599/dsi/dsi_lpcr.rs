...
#[doc = "Field `DEP` reader - Data enable polarity This bit configures the polarity of data enable pin."]
pub type DEP_R = crate::BitReader;
#[doc = "Field `DEP` writer - Data enable polarity This bit configures the polarity of data enable pin."]
pub type DEP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `VSP` reader - VSYNC polarity This bit configures the polarity of VSYNC pin."]
pub type VSP_R = crate::BitReader;
#[doc = "Field `VSP` writer - VSYNC polarity This bit configures the polarity of VSYNC pin."]
pub type VSP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HSP` reader - HSYNC polarity This bit configures the polarity of HSYNC pin."]
pub type HSP_R = crate::BitReader;
#[doc = "Field `HSP` writer - HSYNC polarity This bit configures the polarity of HSYNC pin."]
pub type HSP_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Data enable polarity This bit configures the polarity of data enable pin."]
    #[inline(always)]
    pub fn dep(&self) -> DEP_R {
        DEP_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - VSYNC polarity This bit configures the polarity of VSYNC pin."]
    #[inline(always)]
    pub fn vsp(&self) -> VSP_R {
        VSP_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - HSYNC polarity This bit configures the polarity of HSYNC pin."]
    #[inline(always)]
