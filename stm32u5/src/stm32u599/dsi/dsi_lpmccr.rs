...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#DSI:DSI_LPMCCR)*/
pub struct DSI_LPMCCRrs;
impl crate::RegisterSpec for DSI_LPMCCRrs {
    type Ux = u32;
}
///`read()` method returns [`dsi_lpmccr::R`](R) reader structure
impl crate::Readable for DSI_LPMCCRrs {}
///`reset()` method sets DSI_LPMCCR to value 0
