///Register `DSI_PCR` reader
pub type R = crate::R<DSI_PCRrs>;
///Register `DSI_PCR` writer
...
///`read()` method returns [`dsi_pcr::R`](R) reader structure
impl crate::Readable for DSI_PCRrs {}
///`write(|w| ..)` method takes [`dsi_pcr::W`](W) writer structure
impl crate::Writable for DSI_PCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_PCR to value 0
