///Register `DSI_PUCR` reader
pub type R = crate::R<DSI_PUCRrs>;
///Register `DSI_PUCR` writer
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#DSI:DSI_PUCR)*/
pub struct DSI_PUCRrs;
impl crate::RegisterSpec for DSI_PUCRrs {
    type Ux = u32;
}
///`read()` method returns [`dsi_pucr::R`](R) reader structure
impl crate::Readable for DSI_PUCRrs {}
///`write(|w| ..)` method takes [`dsi_pucr::W`](W) writer structure
impl crate::Writable for DSI_PUCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_PUCR to value 0
