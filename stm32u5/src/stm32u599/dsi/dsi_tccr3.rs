///Register `DSI_TCCR3` reader
pub type R = crate::R<DSI_TCCR3rs>;
///Register `DSI_TCCR3` writer
...
///`read()` method returns [`dsi_tccr3::R`](R) reader structure
impl crate::Readable for DSI_TCCR3rs {}
///`write(|w| ..)` method takes [`dsi_tccr3::W`](W) writer structure
impl crate::Writable for DSI_TCCR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_TCCR3 to value 0
