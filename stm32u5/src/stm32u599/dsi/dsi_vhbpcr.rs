///Register `DSI_VHBPCR` reader
pub type R = crate::R<DSI_VHBPCRrs>;
///Register `DSI_VHBPCR` writer
...
///`read()` method returns [`dsi_vhbpcr::R`](R) reader structure
impl crate::Readable for DSI_VHBPCRrs {}
///`write(|w| ..)` method takes [`dsi_vhbpcr::W`](W) writer structure
impl crate::Writable for DSI_VHBPCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_VHBPCR to value 0
