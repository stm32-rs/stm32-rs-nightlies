///Register `DSI_WCFGR` reader
pub type R = crate::R<DSI_WCFGRrs>;
///Register `DSI_WCFGR` writer
...
///`read()` method returns [`dsi_wcfgr::R`](R) reader structure
impl crate::Readable for DSI_WCFGRrs {}
///`write(|w| ..)` method takes [`dsi_wcfgr::W`](W) writer structure
impl crate::Writable for DSI_WCFGRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_WCFGR to value 0
