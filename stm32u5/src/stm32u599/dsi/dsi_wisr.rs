...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#DSI:DSI_WISR)*/
pub struct DSI_WISRrs;
impl crate::RegisterSpec for DSI_WISRrs {
    type Ux = u32;
}
///`read()` method returns [`dsi_wisr::R`](R) reader structure
impl crate::Readable for DSI_WISRrs {}
///`reset()` method sets DSI_WISR to value 0
