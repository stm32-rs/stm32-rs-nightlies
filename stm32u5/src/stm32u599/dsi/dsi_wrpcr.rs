///Register `DSI_WRPCR` reader
pub type R = crate::R<DSI_WRPCRrs>;
///Register `DSI_WRPCR` writer
...
///`read()` method returns [`dsi_wrpcr::R`](R) reader structure
impl crate::Readable for DSI_WRPCRrs {}
///`write(|w| ..)` method takes [`dsi_wrpcr::W`](W) writer structure
impl crate::Writable for DSI_WRPCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_WRPCR to value 0
