...
#[doc = "Field `EXTI4` reader - EXTIm GPIO port selection"]
pub type EXTI4_R = crate::FieldReader;
#[doc = "Field `EXTI4` writer - EXTIm GPIO port selection"]
pub type EXTI4_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `EXTI5` reader - EXTIm+1 GPIO port selection"]
pub type EXTI5_R = crate::FieldReader;
#[doc = "Field `EXTI5` writer - EXTIm+1 GPIO port selection"]
pub type EXTI5_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `EXTI6` reader - EXTIm+2 GPIO port selection"]
pub type EXTI6_R = crate::FieldReader;
#[doc = "Field `EXTI6` writer - EXTIm+2 GPIO port selection"]
pub type EXTI6_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `EXTI7` reader - EXTIm+3 GPIO port selection"]
pub type EXTI7_R = crate::FieldReader;
#[doc = "Field `EXTI7` writer - EXTIm+3 GPIO port selection"]
