...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `CNTB1EN` field.</div>
    #[inline(always)]
    pub fn cntben(&mut self, n: u8) -> CNTBEN_W<'_, PCSCNTRrs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    ///Bit 16 - Counter Bank 1 enable
    #[inline(always)]
    pub fn cntb1en(&mut self) -> CNTBEN_W<'_, PCSCNTRrs> {
        CNTBEN_W::new(self, 16)
    }
    ///Bit 17 - Counter Bank 2 enable
    #[inline(always)]
    pub fn cntb2en(&mut self) -> CNTBEN_W<'_, PCSCNTRrs> {
        CNTBEN_W::new(self, 17)
    }
    ///Bit 18 - Counter Bank 3 enable
    #[inline(always)]
    pub fn cntb3en(&mut self) -> CNTBEN_W<'_, PCSCNTRrs> {
        CNTBEN_W::new(self, 18)
    }
    ///Bit 19 - Counter Bank 4 enable
    #[inline(always)]
    pub fn cntb4en(&mut self) -> CNTBEN_W<'_, PCSCNTRrs> {
