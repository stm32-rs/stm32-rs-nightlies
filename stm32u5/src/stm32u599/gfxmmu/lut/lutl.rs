...
#[doc = "Field `EN` reader - Enable Line enable."]
pub type EN_R = crate::BitReader;
#[doc = "Field `EN` writer - Enable Line enable."]
pub type EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FVB` reader - First Valid Block Number of the first valid block of line number x."]
pub type FVB_R = crate::FieldReader;
#[doc = "Field `FVB` writer - First Valid Block Number of the first valid block of line number x."]
pub type FVB_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `LVB` reader - Last Valid Block Number of the last valid block of line number X."]
pub type LVB_R = crate::FieldReader;
#[doc = "Field `LVB` writer - Last Valid Block Number of the last valid block of line number X."]
pub type LVB_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bit 0 - Enable Line enable."]
    #[inline(always)]
    pub fn en(&self) -> EN_R {
        EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 8:15 - First Valid Block Number of the first valid block of line number x."]
    #[inline(always)]
    pub fn fvb(&self) -> FVB_R {
        FVB_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Last Valid Block Number of the last valid block of line number X."]
    #[inline(always)]
