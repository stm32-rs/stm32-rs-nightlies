///Register `C8SR` reader
pub type R = crate::R<C8SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c8sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GPDMA1:C8SR)*/
pub struct C8SRrs;
impl crate::RegisterSpec for C8SRrs {
    type Ux = u32;
}
///`read()` method returns [`c8sr::R`](R) reader structure
impl crate::Readable for C8SRrs {}
///`reset()` method sets C8SR to value 0x01
impl crate::Resettable for C8SRrs {
