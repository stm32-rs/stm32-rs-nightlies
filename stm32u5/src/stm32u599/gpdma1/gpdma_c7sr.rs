///Register `GPDMA_C7SR` reader
pub type R = crate::R<GPDMA_C7SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c7sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GPDMA1:GPDMA_C7SR)*/
pub struct GPDMA_C7SRrs;
impl crate::RegisterSpec for GPDMA_C7SRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c7sr::R`](R) reader structure
impl crate::Readable for GPDMA_C7SRrs {}
///`reset()` method sets GPDMA_C7SR to value 0x01
impl crate::Resettable for GPDMA_C7SRrs {
