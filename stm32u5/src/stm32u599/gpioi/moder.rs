...
pub use crate::stm32u599::gpioa::moder::MODE;
///Field `MODE(0-15)` reader - Port x configuration pin %s
pub use crate::stm32u599::gpioa::moder::MODE_R;
///Field `MODE(0-15)` writer - Port x configuration pin %s
pub use crate::stm32u599::gpioa::moder::MODE_W;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GPIOI:MODER)*/
pub struct MODERrs;
