///Register `MPCBB2_CFGLOCK2` reader
pub type R = crate::R<MPCBB2_CFGLOCK2rs>;
///Register `MPCBB2_CFGLOCK2` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB2_CFGLOCK2")
...
You can [`read`](crate::Reg::read) this register and get [`mpcbb2_cfglock2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb2_cfglock2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC1_MPCBB2:MPCBB2_CFGLOCK2)*/
pub struct MPCBB2_CFGLOCK2rs;
impl crate::RegisterSpec for MPCBB2_CFGLOCK2rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb2_cfglock2::R`](R) reader structure
impl crate::Readable for MPCBB2_CFGLOCK2rs {}
///`write(|w| ..)` method takes [`mpcbb2_cfglock2::W`](W) writer structure
impl crate::Writable for MPCBB2_CFGLOCK2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB2_CFGLOCK2 to value 0
