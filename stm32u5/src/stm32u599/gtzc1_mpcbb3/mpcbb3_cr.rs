///Register `MPCBB3_CR` reader
pub type R = crate::R<MPCBB3_CRrs>;
///Register `MPCBB3_CR` writer
pub type W = crate::W<MPCBB3_CRrs>;
...
impl W {
    ///Bit 0 - lock the control register of the MPCBB until next reset
    #[inline(always)]
    pub fn glock(&mut self) -> GLOCK_W<MPCBB3_CRrs> {
        GLOCK_W::new(self, 0)
    }
    ///Bit 30 - SRAMx clocks security state
    #[inline(always)]
    pub fn invsecstate(&mut self) -> INVSECSTATE_W<MPCBB3_CRrs> {
        INVSECSTATE_W::new(self, 30)
    }
    ///Bit 31 - secure read/write illegal access disable
    #[inline(always)]
    pub fn srwiladis(&mut self) -> SRWILADIS_W<MPCBB3_CRrs> {
        SRWILADIS_W::new(self, 31)
    }
}
/**MPCBB control register

You can [`read`](crate::Reg::read) this register and get [`mpcbb3_cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb3_cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC1_MPCBB3:MPCBB3_CR)*/
pub struct MPCBB3_CRrs;
impl crate::RegisterSpec for MPCBB3_CRrs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb3_cr::R`](R) reader structure
impl crate::Readable for MPCBB3_CRrs {}
///`write(|w| ..)` method takes [`mpcbb3_cr::W`](W) writer structure
impl crate::Writable for MPCBB3_CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB3_CR to value 0
impl crate::Resettable for MPCBB3_CRrs {
