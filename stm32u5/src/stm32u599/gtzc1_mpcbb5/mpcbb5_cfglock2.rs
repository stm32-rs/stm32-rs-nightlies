///Register `MPCBB5_CFGLOCK2` reader
pub type R = crate::R<MPCBB5_CFGLOCK2rs>;
///Register `MPCBB5_CFGLOCK2` writer
pub type W = crate::W<MPCBB5_CFGLOCK2rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB5_CFGLOCK2")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn splck32(&mut self) -> SPLCK32_W<MPCBB5_CFGLOCK2rs> {
        SPLCK32_W::new(self, 0)
    }
    ///Bit 1 - SPLCK33
    #[inline(always)]
    #[must_use]
    pub fn splck33(&mut self) -> SPLCK33_W<MPCBB5_CFGLOCK2rs> {
        SPLCK33_W::new(self, 1)
    }
    ///Bit 2 - SPLCK34
    #[inline(always)]
    #[must_use]
    pub fn splck34(&mut self) -> SPLCK34_W<MPCBB5_CFGLOCK2rs> {
        SPLCK34_W::new(self, 2)
    }
    ///Bit 3 - SPLCK35
    #[inline(always)]
    #[must_use]
    pub fn splck35(&mut self) -> SPLCK35_W<MPCBB5_CFGLOCK2rs> {
        SPLCK35_W::new(self, 3)
    }
    ///Bit 4 - SPLCK36
    #[inline(always)]
    #[must_use]
    pub fn splck36(&mut self) -> SPLCK36_W<MPCBB5_CFGLOCK2rs> {
        SPLCK36_W::new(self, 4)
    }
    ///Bit 5 - SPLCK37
    #[inline(always)]
    #[must_use]
    pub fn splck37(&mut self) -> SPLCK37_W<MPCBB5_CFGLOCK2rs> {
        SPLCK37_W::new(self, 5)
    }
    ///Bit 6 - SPLCK38
    #[inline(always)]
    #[must_use]
    pub fn splck38(&mut self) -> SPLCK38_W<MPCBB5_CFGLOCK2rs> {
        SPLCK38_W::new(self, 6)
    }
    ///Bit 7 - SPLCK39
    #[inline(always)]
    #[must_use]
    pub fn splck39(&mut self) -> SPLCK39_W<MPCBB5_CFGLOCK2rs> {
        SPLCK39_W::new(self, 7)
    }
    ///Bit 8 - SPLCK40
    #[inline(always)]
    #[must_use]
    pub fn splck40(&mut self) -> SPLCK40_W<MPCBB5_CFGLOCK2rs> {
        SPLCK40_W::new(self, 8)
    }
    ///Bit 9 - SPLCK41
    #[inline(always)]
    #[must_use]
    pub fn splck41(&mut self) -> SPLCK41_W<MPCBB5_CFGLOCK2rs> {
        SPLCK41_W::new(self, 9)
    }
    ///Bit 10 - SPLCK42
    #[inline(always)]
    #[must_use]
    pub fn splck42(&mut self) -> SPLCK42_W<MPCBB5_CFGLOCK2rs> {
        SPLCK42_W::new(self, 10)
    }
    ///Bit 11 - SPLCK43
    #[inline(always)]
    #[must_use]
    pub fn splck43(&mut self) -> SPLCK43_W<MPCBB5_CFGLOCK2rs> {
        SPLCK43_W::new(self, 11)
    }
    ///Bit 12 - SPLCK44
    #[inline(always)]
    #[must_use]
    pub fn splck44(&mut self) -> SPLCK44_W<MPCBB5_CFGLOCK2rs> {
        SPLCK44_W::new(self, 12)
    }
    ///Bit 13 - SPLCK45
    #[inline(always)]
    #[must_use]
    pub fn splck45(&mut self) -> SPLCK45_W<MPCBB5_CFGLOCK2rs> {
        SPLCK45_W::new(self, 13)
    }
    ///Bit 14 - SPLCK46
    #[inline(always)]
    #[must_use]
    pub fn splck46(&mut self) -> SPLCK46_W<MPCBB5_CFGLOCK2rs> {
        SPLCK46_W::new(self, 14)
    }
    ///Bit 15 - SPLCK47
    #[inline(always)]
    #[must_use]
    pub fn splck47(&mut self) -> SPLCK47_W<MPCBB5_CFGLOCK2rs> {
        SPLCK47_W::new(self, 15)
    }
    ///Bit 16 - SPLCK48
    #[inline(always)]
    #[must_use]
    pub fn splck48(&mut self) -> SPLCK48_W<MPCBB5_CFGLOCK2rs> {
        SPLCK48_W::new(self, 16)
    }
    ///Bit 17 - SPLCK49
    #[inline(always)]
    #[must_use]
    pub fn splck49(&mut self) -> SPLCK49_W<MPCBB5_CFGLOCK2rs> {
        SPLCK49_W::new(self, 17)
    }
    ///Bit 18 - SPLCK50
    #[inline(always)]
    #[must_use]
    pub fn splck50(&mut self) -> SPLCK50_W<MPCBB5_CFGLOCK2rs> {
        SPLCK50_W::new(self, 18)
    }
    ///Bit 19 - SPLCK51
    #[inline(always)]
    #[must_use]
    pub fn splck51(&mut self) -> SPLCK51_W<MPCBB5_CFGLOCK2rs> {
        SPLCK51_W::new(self, 19)
    }
}
/**GTZC1 SRAMz MPCBB configuration lock register 2

You can [`read`](crate::Reg::read) this register and get [`mpcbb5_cfglock2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb5_cfglock2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC1_MPCBB5:MPCBB5_CFGLOCK2)*/
pub struct MPCBB5_CFGLOCK2rs;
impl crate::RegisterSpec for MPCBB5_CFGLOCK2rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb5_cfglock2::R`](R) reader structure
impl crate::Readable for MPCBB5_CFGLOCK2rs {}
///`write(|w| ..)` method takes [`mpcbb5_cfglock2::W`](W) writer structure
impl crate::Writable for MPCBB5_CFGLOCK2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB5_CFGLOCK2 to value 0
impl crate::Resettable for MPCBB5_CFGLOCK2rs {
