#[doc = "Register `MPCBB5_PRIVCFGR41` reader"]
pub type R = crate::R<MPCBB5_PRIVCFGR41rs>;
#[doc = "Register `MPCBB5_PRIVCFGR41` writer"]
pub type W = crate::W<MPCBB5_PRIVCFGR41rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn priv0(&mut self) -> PRIV0_W<MPCBB5_PRIVCFGR41rs> {
        PRIV0_W::new(self, 0)
    }
    #[doc = "Bit 1 - PRIV1"]
    #[inline(always)]
    #[must_use]
    pub fn priv1(&mut self) -> PRIV1_W<MPCBB5_PRIVCFGR41rs> {
        PRIV1_W::new(self, 1)
    }
    #[doc = "Bit 2 - PRIV2"]
    #[inline(always)]
    #[must_use]
    pub fn priv2(&mut self) -> PRIV2_W<MPCBB5_PRIVCFGR41rs> {
        PRIV2_W::new(self, 2)
    }
    #[doc = "Bit 3 - PRIV3"]
    #[inline(always)]
    #[must_use]
    pub fn priv3(&mut self) -> PRIV3_W<MPCBB5_PRIVCFGR41rs> {
        PRIV3_W::new(self, 3)
    }
    #[doc = "Bit 4 - PRIV4"]
    #[inline(always)]
    #[must_use]
    pub fn priv4(&mut self) -> PRIV4_W<MPCBB5_PRIVCFGR41rs> {
        PRIV4_W::new(self, 4)
    }
    #[doc = "Bit 5 - PRIV5"]
    #[inline(always)]
    #[must_use]
    pub fn priv5(&mut self) -> PRIV5_W<MPCBB5_PRIVCFGR41rs> {
        PRIV5_W::new(self, 5)
    }
    #[doc = "Bit 6 - PRIV6"]
    #[inline(always)]
    #[must_use]
    pub fn priv6(&mut self) -> PRIV6_W<MPCBB5_PRIVCFGR41rs> {
        PRIV6_W::new(self, 6)
    }
    #[doc = "Bit 7 - PRIV7"]
    #[inline(always)]
    #[must_use]
    pub fn priv7(&mut self) -> PRIV7_W<MPCBB5_PRIVCFGR41rs> {
        PRIV7_W::new(self, 7)
    }
    #[doc = "Bit 8 - PRIV8"]
    #[inline(always)]
    #[must_use]
    pub fn priv8(&mut self) -> PRIV8_W<MPCBB5_PRIVCFGR41rs> {
        PRIV8_W::new(self, 8)
    }
    #[doc = "Bit 9 - PRIV9"]
    #[inline(always)]
    #[must_use]
    pub fn priv9(&mut self) -> PRIV9_W<MPCBB5_PRIVCFGR41rs> {
        PRIV9_W::new(self, 9)
    }
    #[doc = "Bit 10 - PRIV10"]
    #[inline(always)]
    #[must_use]
    pub fn priv10(&mut self) -> PRIV10_W<MPCBB5_PRIVCFGR41rs> {
        PRIV10_W::new(self, 10)
    }
    #[doc = "Bit 11 - PRIV11"]
    #[inline(always)]
    #[must_use]
    pub fn priv11(&mut self) -> PRIV11_W<MPCBB5_PRIVCFGR41rs> {
        PRIV11_W::new(self, 11)
    }
    #[doc = "Bit 12 - PRIV12"]
    #[inline(always)]
    #[must_use]
    pub fn priv12(&mut self) -> PRIV12_W<MPCBB5_PRIVCFGR41rs> {
        PRIV12_W::new(self, 12)
    }
    #[doc = "Bit 13 - PRIV13"]
    #[inline(always)]
    #[must_use]
    pub fn priv13(&mut self) -> PRIV13_W<MPCBB5_PRIVCFGR41rs> {
        PRIV13_W::new(self, 13)
    }
    #[doc = "Bit 14 - PRIV14"]
    #[inline(always)]
    #[must_use]
    pub fn priv14(&mut self) -> PRIV14_W<MPCBB5_PRIVCFGR41rs> {
        PRIV14_W::new(self, 14)
    }
    #[doc = "Bit 15 - PRIV15"]
    #[inline(always)]
    #[must_use]
    pub fn priv15(&mut self) -> PRIV15_W<MPCBB5_PRIVCFGR41rs> {
        PRIV15_W::new(self, 15)
    }
    #[doc = "Bit 16 - PRIV16"]
    #[inline(always)]
    #[must_use]
    pub fn priv16(&mut self) -> PRIV16_W<MPCBB5_PRIVCFGR41rs> {
        PRIV16_W::new(self, 16)
    }
    #[doc = "Bit 17 - PRIV17"]
    #[inline(always)]
    #[must_use]
    pub fn priv17(&mut self) -> PRIV17_W<MPCBB5_PRIVCFGR41rs> {
        PRIV17_W::new(self, 17)
    }
    #[doc = "Bit 18 - PRIV18"]
    #[inline(always)]
    #[must_use]
    pub fn priv18(&mut self) -> PRIV18_W<MPCBB5_PRIVCFGR41rs> {
        PRIV18_W::new(self, 18)
    }
    #[doc = "Bit 19 - PRIV19"]
    #[inline(always)]
    #[must_use]
    pub fn priv19(&mut self) -> PRIV19_W<MPCBB5_PRIVCFGR41rs> {
        PRIV19_W::new(self, 19)
    }
    #[doc = "Bit 20 - PRIV20"]
    #[inline(always)]
    #[must_use]
    pub fn priv20(&mut self) -> PRIV20_W<MPCBB5_PRIVCFGR41rs> {
        PRIV20_W::new(self, 20)
    }
    #[doc = "Bit 21 - PRIV21"]
    #[inline(always)]
    #[must_use]
    pub fn priv21(&mut self) -> PRIV21_W<MPCBB5_PRIVCFGR41rs> {
        PRIV21_W::new(self, 21)
    }
    #[doc = "Bit 22 - PRIV22"]
    #[inline(always)]
    #[must_use]
    pub fn priv22(&mut self) -> PRIV22_W<MPCBB5_PRIVCFGR41rs> {
        PRIV22_W::new(self, 22)
    }
    #[doc = "Bit 23 - PRIV23"]
    #[inline(always)]
    #[must_use]
    pub fn priv23(&mut self) -> PRIV23_W<MPCBB5_PRIVCFGR41rs> {
        PRIV23_W::new(self, 23)
    }
    #[doc = "Bit 24 - PRIV24"]
    #[inline(always)]
    #[must_use]
    pub fn priv24(&mut self) -> PRIV24_W<MPCBB5_PRIVCFGR41rs> {
        PRIV24_W::new(self, 24)
    }
    #[doc = "Bit 25 - PRIV25"]
    #[inline(always)]
    #[must_use]
    pub fn priv25(&mut self) -> PRIV25_W<MPCBB5_PRIVCFGR41rs> {
        PRIV25_W::new(self, 25)
    }
    #[doc = "Bit 26 - PRIV26"]
    #[inline(always)]
    #[must_use]
    pub fn priv26(&mut self) -> PRIV26_W<MPCBB5_PRIVCFGR41rs> {
        PRIV26_W::new(self, 26)
    }
    #[doc = "Bit 27 - PRIV27"]
    #[inline(always)]
    #[must_use]
    pub fn priv27(&mut self) -> PRIV27_W<MPCBB5_PRIVCFGR41rs> {
        PRIV27_W::new(self, 27)
    }
    #[doc = "Bit 28 - PRIV28"]
    #[inline(always)]
    #[must_use]
    pub fn priv28(&mut self) -> PRIV28_W<MPCBB5_PRIVCFGR41rs> {
        PRIV28_W::new(self, 28)
    }
    #[doc = "Bit 29 - PRIV29"]
    #[inline(always)]
    #[must_use]
    pub fn priv29(&mut self) -> PRIV29_W<MPCBB5_PRIVCFGR41rs> {
        PRIV29_W::new(self, 29)
    }
    #[doc = "Bit 30 - PRIV30"]
    #[inline(always)]
    #[must_use]
    pub fn priv30(&mut self) -> PRIV30_W<MPCBB5_PRIVCFGR41rs> {
        PRIV30_W::new(self, 30)
    }
    #[doc = "Bit 31 - PRIV31"]
    #[inline(always)]
    #[must_use]
    pub fn priv31(&mut self) -> PRIV31_W<MPCBB5_PRIVCFGR41rs> {
        PRIV31_W::new(self, 31)
    }
}
#[doc = "MPCBB privileged configuration for super-block x register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcbb5_privcfgr41::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcbb5_privcfgr41::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPCBB5_PRIVCFGR41rs;
impl crate::RegisterSpec for MPCBB5_PRIVCFGR41rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpcbb5_privcfgr41::R`](R) reader structure"]
impl crate::Readable for MPCBB5_PRIVCFGR41rs {}
#[doc = "`write(|w| ..)` method takes [`mpcbb5_privcfgr41::W`](W) writer structure"]
impl crate::Writable for MPCBB5_PRIVCFGR41rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPCBB5_PRIVCFGR41 to value 0xffff_ffff"]
impl crate::Resettable for MPCBB5_PRIVCFGR41rs {
