...
#[doc = "Field `CI2C5F` writer - clear the illegal access flag for I2C5"]
pub type CI2C5F_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CI2C6F` writer - clear the illegal access flag for I2C6"]
...
impl W {
    ...
    #[doc = "Bit 22 - clear the illegal access flag for I2C5"]
    #[inline(always)]
    #[must_use]
    pub fn ci2c5f(&mut self) -> CI2C5F_W<FCR1rs> {
        CI2C5F_W::new(self, 22)
    }
    #[doc = "Bit 23 - clear the illegal access flag for I2C6"]
    #[inline(always)]
    #[must_use]
