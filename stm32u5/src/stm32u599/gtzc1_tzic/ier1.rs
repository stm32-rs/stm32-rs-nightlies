...
#[doc = "Field `I2C5IE` reader - illegal access interrupt enable for I2C5"]
pub type I2C5IE_R = crate::BitReader;
#[doc = "Field `I2C5IE` writer - illegal access interrupt enable for I2C5"]
pub type I2C5IE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `I2C6IE` reader - illegal access interrupt enable for I2C6"]
pub type I2C6IE_R = crate::BitReader;
#[doc = "Field `I2C6IE` writer - illegal access interrupt enable for I2C6"]
...
impl R {
    ...
    #[doc = "Bit 22 - illegal access interrupt enable for I2C5"]
    #[inline(always)]
    pub fn i2c5ie(&self) -> I2C5IE_R {
        I2C5IE_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - illegal access interrupt enable for I2C6"]
    #[inline(always)]
