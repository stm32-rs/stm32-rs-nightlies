...
///Field `GFXMMUIE` reader - GFXMMUIE
pub type GFXMMUIE_R = crate::BitReader;
///Field `GFXMMUIE` writer - GFXMMUIE
pub type GFXMMUIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GFXMMU_REGIE` reader - GFXMMU_REGIE
pub type GFXMMU_REGIE_R = crate::BitReader;
///Field `GFXMMU_REGIE` writer - GFXMMU_REGIE
pub type GFXMMU_REGIE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
///Field `DCACHE2_REGIE` reader - DCACHE2_REGIE
pub type DCACHE2_REGIE_R = crate::BitReader;
///Field `DCACHE2_REGIE` writer - DCACHE2_REGIE
pub type DCACHE2_REGIE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    ///Bit 24 - GFXMMUIE
    #[inline(always)]
    pub fn gfxmmuie(&self) -> GFXMMUIE_R {
        GFXMMUIE_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - GFXMMU_REGIE
    #[inline(always)]
    pub fn gfxmmu_regie(&self) -> GFXMMU_REGIE_R {
        GFXMMU_REGIE_R::new(((self.bits >> 25) & 1) != 0)
    }
    ///Bit 26 - HSPI1_REGIE
    #[inline(always)]
    ...
    ///Bit 27 - DCACHE2_REGIE
    #[inline(always)]
    pub fn dcache2_regie(&self) -> DCACHE2_REGIE_R {
        DCACHE2_REGIE_R::new(((self.bits >> 27) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IER3")
            ...
            .field("gfxmmuie", &self.gfxmmuie())
            .field("gfxmmu_regie", &self.gfxmmu_regie())
            .field("hspi1_regie", &self.hspi1_regie())
            .field("dcache2_regie", &self.dcache2_regie())
            .finish()
    }
}
impl W {
    ...
    ///Bit 24 - GFXMMUIE
    #[inline(always)]
    pub fn gfxmmuie(&mut self) -> GFXMMUIE_W<'_, IER3rs> {
        GFXMMUIE_W::new(self, 24)
    }
    ///Bit 25 - GFXMMU_REGIE
    #[inline(always)]
    pub fn gfxmmu_regie(&mut self) -> GFXMMU_REGIE_W<'_, IER3rs> {
        GFXMMU_REGIE_W::new(self, 25)
    }
    ///Bit 26 - HSPI1_REGIE
    #[inline(always)]
    ...
    ///Bit 27 - DCACHE2_REGIE
    #[inline(always)]
    pub fn dcache2_regie(&mut self) -> DCACHE2_REGIE_W<'_, IER3rs> {
        DCACHE2_REGIE_W::new(self, 27)
    }
}
