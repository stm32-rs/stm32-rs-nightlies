...
///Field `DCACHE1_REGPRIV` reader - privileged access mode for DCACHE1 registers
pub type DCACHE1_REGPRIV_R = crate::BitReader;
///Field `DCACHE1_REGPRIV` writer - privileged access mode for DCACHE1 registers
...
///Field `GPU2DPRIV` reader - GPU2DPRIV
pub type GPU2DPRIV_R = crate::BitReader;
///Field `GPU2DPRIV` writer - GPU2DPRIV
pub type GPU2DPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GFXMMUPRIV` reader - GFXMMUPRIV
pub type GFXMMUPRIV_R = crate::BitReader;
///Field `GFXMMUPRIV` writer - GFXMMUPRIV
pub type GFXMMUPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GFXMMU_REGPRIV` reader - GFXMMU_REGPRIV
pub type GFXMMU_REGPRIV_R = crate::BitReader;
///Field `GFXMMU_REGPRIV` writer - GFXMMU_REGPRIV
pub type GFXMMU_REGPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HSPI1_REGPRIV` reader - HSPI1_REGPRIV
pub type HSPI1_REGPRIV_R = crate::BitReader;
///Field `HSPI1_REGPRIV` writer - HSPI1_REGPRIV
pub type HSPI1_REGPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE2_REGPRIV` reader - DCACHE2_REGPRIV
pub type DCACHE2_REGPRIV_R = crate::BitReader;
///Field `DCACHE2_REGPRIV` writer - DCACHE2_REGPRIV
pub type DCACHE2_REGPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    ///Bit 24 - GFXMMUPRIV
    #[inline(always)]
    pub fn gfxmmupriv(&self) -> GFXMMUPRIV_R {
        GFXMMUPRIV_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - GFXMMU_REGPRIV
    #[inline(always)]
    pub fn gfxmmu_regpriv(&self) -> GFXMMU_REGPRIV_R {
        GFXMMU_REGPRIV_R::new(((self.bits >> 25) & 1) != 0)
    }
    ...
    ///Bit 27 - DCACHE2_REGPRIV
    #[inline(always)]
    pub fn dcache2_regpriv(&self) -> DCACHE2_REGPRIV_R {
        DCACHE2_REGPRIV_R::new(((self.bits >> 27) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRIVCFGR3")
            ...
            .field("dcache1_regpriv", &self.dcache1_regpriv())
            ...
            .field("gpu2dpriv", &self.gpu2dpriv())
            .field("gfxmmupriv", &self.gfxmmupriv())
            .field("gfxmmu_regpriv", &self.gfxmmu_regpriv())
            .field("hspi1_regpriv", &self.hspi1_regpriv())
            .field("dcache2_regpriv", &self.dcache2_regpriv())
            .finish()
    }
}
impl W {
    ///Bit 0 - privileged access mode for MDF1
    #[inline(always)]
    pub fn mdf1priv(&mut self) -> MDF1PRIV_W<'_, PRIVCFGR3rs> {
    ...
    ///Bit 5 - privileged access mode for register of DMA2D
    #[inline(always)]
    pub fn dma2dpriv(&mut self) -> DMA2DPRIV_W<'_, PRIVCFGR3rs> {
    ...
    ///Bit 7 - privileged access mode for DCACHE1 registers
    #[inline(always)]
    pub fn dcache1_regpriv(&mut self) -> DCACHE1_REGPRIV_W<'_, PRIVCFGR3rs> {
        DCACHE1_REGPRIV_W::new(self, 7)
    }
    ///Bit 8 - privileged access mode for ADC1
    #[inline(always)]
    pub fn adc1priv(&mut self) -> ADC1PRIV_W<'_, PRIVCFGR3rs> {
    ...
    ///Bit 10 - privileged access mode for OTG_FS
    #[inline(always)]
    pub fn otgfspriv(&mut self) -> OTGFSPRIV_W<'_, PRIVCFGR3rs> {
    ...
    ///Bit 16 - privileged access mode for OCTOSPIM
    #[inline(always)]
    pub fn octospimpriv(&mut self) -> OCTOSPIMPRIV_W<'_, PRIVCFGR3rs> {
    ...
    ///Bit 18 - privileged access mode for SDMMC1
    #[inline(always)]
    pub fn sdmmc2priv(&mut self) -> SDMMC2PRIV_W<'_, PRIVCFGR3rs> {
        SDMMC2PRIV_W::new(self, 18)
    }
    ///Bit 19 - privileged access mode for FSMC registers
    #[inline(always)]
    pub fn fsmc_regpriv(&mut self) -> FSMC_REGPRIV_W<'_, PRIVCFGR3rs> {
        FSMC_REGPRIV_W::new(self, 19)
    }
    ///Bit 20 - privileged access mode for OCTOSPI1
    #[inline(always)]
    pub fn octospi1_regpriv(&mut self) -> OCTOSPI1_REGPRIV_W<'_, PRIVCFGR3rs> {
        OCTOSPI1_REGPRIV_W::new(self, 20)
    }
    ///Bit 21 - privileged access mode for OCTOSPI2
    #[inline(always)]
    pub fn octospi2_regpriv(&mut self) -> OCTOSPI2_REGPRIV_W<'_, PRIVCFGR3rs> {
    ...
    ///Bit 23 - GPU2DPRIV
    #[inline(always)]
    pub fn gpu2dpriv(&mut self) -> GPU2DPRIV_W<'_, PRIVCFGR3rs> {
        GPU2DPRIV_W::new(self, 23)
    }
    ///Bit 24 - GFXMMUPRIV
    #[inline(always)]
    pub fn gfxmmupriv(&mut self) -> GFXMMUPRIV_W<'_, PRIVCFGR3rs> {
        GFXMMUPRIV_W::new(self, 24)
    }
    ///Bit 25 - GFXMMU_REGPRIV
    #[inline(always)]
    pub fn gfxmmu_regpriv(&mut self) -> GFXMMU_REGPRIV_W<'_, PRIVCFGR3rs> {
        GFXMMU_REGPRIV_W::new(self, 25)
    }
    ///Bit 26 - HSPI1_REGPRIV
    #[inline(always)]
    pub fn hspi1_regpriv(&mut self) -> HSPI1_REGPRIV_W<'_, PRIVCFGR3rs> {
        HSPI1_REGPRIV_W::new(self, 26)
    }
    ///Bit 27 - DCACHE2_REGPRIV
    #[inline(always)]
    pub fn dcache2_regpriv(&mut self) -> DCACHE2_REGPRIV_W<'_, PRIVCFGR3rs> {
        DCACHE2_REGPRIV_W::new(self, 27)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC1_TZSC:PRIVCFGR3)*/
