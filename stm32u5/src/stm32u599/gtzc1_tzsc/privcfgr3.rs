...
impl W {
    ...
    ///Bit 7 - privileged access mode for DCACHE1 registers
    #[inline(always)]
    pub fn dcache1_regpriv(&mut self) -> DCACHE1_REGPRIV_W<PRIVCFGR3rs> {
    ...
    ///Bit 23 - GPU2DPRIV
    #[inline(always)]
    pub fn gpu2dpriv(&mut self) -> GPU2DPRIV_W<PRIVCFGR3rs> {
        GPU2DPRIV_W::new(self, 23)
    }
    ///Bit 24 - GFXMMUPRIV
    #[inline(always)]
    pub fn gfxmmupriv(&mut self) -> GFXMMUPRIV_W<PRIVCFGR3rs> {
        GFXMMUPRIV_W::new(self, 24)
    }
    ///Bit 25 - GFXMMU_REGPRIV
    #[inline(always)]
    pub fn gfxmmu_regpriv(&mut self) -> GFXMMU_REGPRIV_W<PRIVCFGR3rs> {
        GFXMMU_REGPRIV_W::new(self, 25)
    }
    ///Bit 26 - HSPI1_REGPRIV
    #[inline(always)]
    pub fn hspi1_regpriv(&mut self) -> HSPI1_REGPRIV_W<PRIVCFGR3rs> {
        HSPI1_REGPRIV_W::new(self, 26)
    }
    ///Bit 27 - DCACHE2_REGPRIV
    #[inline(always)]
    pub fn dcache2_regpriv(&mut self) -> DCACHE2_REGPRIV_W<PRIVCFGR3rs> {
