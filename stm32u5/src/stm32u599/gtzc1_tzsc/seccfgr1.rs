...
///Field `USART6SEC` reader - USART6SEC
pub type USART6SEC_R = crate::BitReader;
///Field `USART6SEC` writer - USART6SEC
pub type USART6SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C5SEC` reader - I2C5SEC
pub type I2C5SEC_R = crate::BitReader;
///Field `I2C5SEC` writer - I2C5SEC
pub type I2C5SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C6SEC` reader - I2C6SEC
pub type I2C6SEC_R = crate::BitReader;
///Field `I2C6SEC` writer - I2C6SEC
pub type I2C6SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    ///Bit 22 - I2C5SEC
    #[inline(always)]
    pub fn i2c5sec(&self) -> I2C5SEC_R {
        I2C5SEC_R::new(((self.bits >> 22) & 1) != 0)
    }
    ///Bit 23 - I2C6SEC
    #[inline(always)]
    pub fn i2c6sec(&self) -> I2C6SEC_R {
        I2C6SEC_R::new(((self.bits >> 23) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SECCFGR1")
            ...
            .field("i2c5sec", &self.i2c5sec())
            .field("i2c6sec", &self.i2c6sec())
            .finish()
    }
}
impl W {
    ...
    ///Bit 16 - secure access mode for I2C4
    #[inline(always)]
    pub fn i2c4sec(&mut self) -> I2C4SEC_W<'_, SECCFGR1rs> {
    ...
    ///Bit 18 - secure access mode for FDCAN1
    #[inline(always)]
    pub fn fdcan1sec(&mut self) -> FDCAN1SEC_W<'_, SECCFGR1rs> {
        FDCAN1SEC_W::new(self, 18)
    }
    ///Bit 19 - secure access mode for UCPD1
    #[inline(always)]
    pub fn ucpd1sec(&mut self) -> UCPD1SEC_W<'_, SECCFGR1rs> {
        UCPD1SEC_W::new(self, 19)
    }
    ///Bit 21 - USART6SEC
    #[inline(always)]
    ...
    ///Bit 22 - I2C5SEC
    #[inline(always)]
    pub fn i2c5sec(&mut self) -> I2C5SEC_W<'_, SECCFGR1rs> {
        I2C5SEC_W::new(self, 22)
    }
    ///Bit 23 - I2C6SEC
    #[inline(always)]
    pub fn i2c6sec(&mut self) -> I2C6SEC_W<'_, SECCFGR1rs> {
        I2C6SEC_W::new(self, 23)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC1_TZSC:SECCFGR1)*/
