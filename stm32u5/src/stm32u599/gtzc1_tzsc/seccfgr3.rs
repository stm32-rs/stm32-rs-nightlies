...
impl W {
    ...
    ///Bit 23 - GPU2DSEC
    #[inline(always)]
    pub fn gpu2dsec(&mut self) -> GPU2DSEC_W<'_, SECCFGR3rs> {
        GPU2DSEC_W::new(self, 23)
    }
    ///Bit 24 - GFXMMUSEC
    #[inline(always)]
    pub fn gfxmmusec(&mut self) -> GFXMMUSEC_W<'_, SECCFGR3rs> {
        GFXMMUSEC_W::new(self, 24)
    }
    ///Bit 25 - GFXMMU_REGSEC
    #[inline(always)]
    pub fn gfxmmu_regsec(&mut self) -> GFXMMU_REGSEC_W<'_, SECCFGR3rs> {
    ...
    ///Bit 27 - DCACHE2_REGSEC
    #[inline(always)]
    pub fn dcache2_regsec(&mut self) -> DCACHE2_REGSEC_W<'_, SECCFGR3rs> {
