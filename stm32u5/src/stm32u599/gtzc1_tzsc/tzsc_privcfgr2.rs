...
#[doc = "Field `LTDCPRIV` reader - LTDCPRIV"]
pub type LTDCPRIV_R = crate::BitReader;
#[doc = "Field `LTDCPRIV` writer - LTDCPRIV"]
pub type LTDCPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DSIPRIV` reader - DSIPRIV"]
pub type DSIPRIV_R = crate::BitReader;
#[doc = "Field `DSIPRIV` writer - DSIPRIV"]
...
impl R {
    ...
    #[doc = "Bit 8 - privileged access mode for SAI2"]
    #[inline(always)]
