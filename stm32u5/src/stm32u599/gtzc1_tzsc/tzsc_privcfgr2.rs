...
///Field `LTDCPRIV` reader - LTDCPRIV
pub type LTDCPRIV_R = crate::BitReader;
///Field `LTDCPRIV` writer - LTDCPRIV
pub type LTDCPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DSIPRIV` reader - DSIPRIV
pub type DSIPRIV_R = crate::BitReader;
///Field `DSIPRIV` writer - DSIPRIV
pub type DSIPRIV_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    ///Bit 9 - LTDCPRIV
    #[inline(always)]
    pub fn ltdcpriv(&self) -> LTDCPRIV_R {
        LTDCPRIV_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - DSIPRIV
    #[inline(always)]
    pub fn dsipriv(&self) -> DSIPRIV_R {
        DSIPRIV_R::new(((self.bits >> 10) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TZSC_PRIVCFGR2")
            ...
            .field("ltdcpriv", &self.ltdcpriv())
            .field("dsipriv", &self.dsipriv())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sai2priv(&mut self) -> SAI2PRIV_W<TZSC_PRIVCFGR2rs> {
        SAI2PRIV_W::new(self, 8)
    }
    ///Bit 9 - LTDCPRIV
    #[inline(always)]
    #[must_use]
    pub fn ltdcpriv(&mut self) -> LTDCPRIV_W<TZSC_PRIVCFGR2rs> {
        LTDCPRIV_W::new(self, 9)
    }
    ///Bit 10 - DSIPRIV
    #[inline(always)]
    #[must_use]
    pub fn dsipriv(&mut self) -> DSIPRIV_W<TZSC_PRIVCFGR2rs> {
        DSIPRIV_W::new(self, 10)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC1_TZSC:TZSC_PRIVCFGR2)*/
