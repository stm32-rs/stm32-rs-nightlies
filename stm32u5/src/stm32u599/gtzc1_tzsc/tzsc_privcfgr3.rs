...
impl W {
    ...
    ///Bit 24 - GFXMMUPRIV
    #[inline(always)]
    pub fn gfxmmupriv(&mut self) -> GFXMMUPRIV_W<TZSC_PRIVCFGR3rs> {
        GFXMMUPRIV_W::new(self, 24)
    }
    ///Bit 25 - GFXMMU_REGPRIV
    #[inline(always)]
    pub fn gfxmmu_regpriv(&mut self) -> GFXMMU_REGPRIV_W<TZSC_PRIVCFGR3rs> {
    ...
    ///Bit 27 - DCACHE2_REGPRIV
    #[inline(always)]
    pub fn dcache2_regpriv(&mut self) -> DCACHE2_REGPRIV_W<TZSC_PRIVCFGR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC1_TZSC:TZSC_PRIVCFGR3)*/
