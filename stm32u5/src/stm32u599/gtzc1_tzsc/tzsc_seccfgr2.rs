...
///Field `LTDCSEC` reader - LTDCSEC
pub type LTDCSEC_R = crate::BitReader;
///Field `LTDCSEC` writer - LTDCSEC
pub type LTDCSEC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DSISEC` reader - DSISEC
pub type DSISEC_R = crate::BitReader;
///Field `DSISEC` writer - DSISEC
pub type DSISEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    ///Bit 9 - LTDCSEC
    #[inline(always)]
    pub fn ltdcsec(&self) -> LTDCSEC_R {
        LTDCSEC_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - DSISEC
    #[inline(always)]
    pub fn dsisec(&self) -> DSISEC_R {
        DSISEC_R::new(((self.bits >> 10) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TZSC_SECCFGR2")
            ...
            .field("ltdcsec", &self.ltdcsec())
            .field("dsisec", &self.dsisec())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ltdcsec(&mut self) -> LTDCSEC_W<TZSC_SECCFGR2rs> {
        LTDCSEC_W::new(self, 9)
    }
    ///Bit 10 - DSISEC
    #[inline(always)]
    #[must_use]
    pub fn dsisec(&mut self) -> DSISEC_W<TZSC_SECCFGR2rs> {
        DSISEC_W::new(self, 10)
    }
}
/**TZSC secure configuration register 2

You can [`read`](crate::Reg::read) this register and get [`tzsc_seccfgr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tzsc_seccfgr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC1_TZSC:TZSC_SECCFGR2)*/
