...
#[doc = "Field `GFXMMUSEC` reader - GFXMMUSEC"]
pub type GFXMMUSEC_R = crate::BitReader;
#[doc = "Field `GFXMMUSEC` writer - GFXMMUSEC"]
pub type GFXMMUSEC_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `GFXMMU_REGSEC` reader - GFXMMU_REGSEC"]
pub type GFXMMU_REGSEC_R = crate::BitReader;
#[doc = "Field `GFXMMU_REGSEC` writer - GFXMMU_REGSEC"]
...
#[doc = "Field `DCACHE2_REGSEC` reader - DCACHE2_REGSEC"]
pub type DCACHE2_REGSEC_R = crate::BitReader;
#[doc = "Field `DCACHE2_REGSEC` writer - DCACHE2_REGSEC"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gfxmmusec(&mut self) -> GFXMMUSEC_W<TZSC_SECCFGR3rs> {
        GFXMMUSEC_W::new(self, 24)
    }
    #[doc = "Bit 25 - GFXMMU_REGSEC"]
    #[inline(always)]
    #[must_use]
    pub fn gfxmmu_regsec(&mut self) -> GFXMMU_REGSEC_W<TZSC_SECCFGR3rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcache2_regsec(&mut self) -> DCACHE2_REGSEC_W<TZSC_SECCFGR3rs> {
