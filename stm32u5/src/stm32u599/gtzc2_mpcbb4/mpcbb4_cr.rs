#[doc = "Register `MPCBB4_CR` reader"]
pub type R = crate::R<MPCBB4_CRrs>;
#[doc = "Register `MPCBB4_CR` writer"]
...
#[doc = "MPCBB control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mpcbb4_cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mpcbb4_cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPCBB4_CRrs;
impl crate::RegisterSpec for MPCBB4_CRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpcbb4_cr::R`](R) reader structure"]
impl crate::Readable for MPCBB4_CRrs {}
#[doc = "`write(|w| ..)` method takes [`mpcbb4_cr::W`](W) writer structure"]
impl crate::Writable for MPCBB4_CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPCBB4_CR to value 0"]
