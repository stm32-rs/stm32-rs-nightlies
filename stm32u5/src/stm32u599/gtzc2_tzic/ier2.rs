...
impl W {
    ...
    ///Bit 2 - illegal access interrupt enable for TAMP
    #[inline(always)]
    pub fn tampie(&mut self) -> TAMPIE_W<'_, IER2rs> {
        TAMPIE_W::new(self, 2)
    }
    ///Bit 3 - illegal access interrupt enable for PWR
    #[inline(always)]
    ...
    ///Bit 5 - illegal access interrupt enable for LPDMA
    #[inline(always)]
    pub fn lpdma1ie(&mut self) -> LPDMA1IE_W<'_, IER2rs> {
    ...
    ///Bit 14 - illegal access interrupt enable for GTZC2 TZSC registers
    #[inline(always)]
    pub fn tzsc2ie(&mut self) -> TZSC2IE_W<'_, IER2rs> {
        TZSC2IE_W::new(self, 14)
    }
    ///Bit 15 - illegal access interrupt enable for GTZC2 TZIC registers
    #[inline(always)]
    pub fn tzic2ie(&mut self) -> TZIC2IE_W<'_, IER2rs> {
        TZIC2IE_W::new(self, 15)
    }
    ///Bit 24 - illegal access interrupt enable for SRAM4
    #[inline(always)]
    pub fn sram4ie(&mut self) -> SRAM4IE_W<'_, IER2rs> {
        SRAM4IE_W::new(self, 24)
    }
    ///Bit 25 - illegal access interrupt enable for MPCBB4 registers
    #[inline(always)]
    pub fn mpcbb4_regie(&mut self) -> MPCBB4_REGIE_W<'_, IER2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC2_TZIC:IER2)*/
pub struct IER2rs;
