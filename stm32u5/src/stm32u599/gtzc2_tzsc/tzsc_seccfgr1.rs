...
///Field `ADC2SEC` reader - secure access mode for ADC2
pub type ADC2SEC_R = crate::BitReader;
///Field `ADC2SEC` writer - secure access mode for ADC2
pub type ADC2SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    ///Bit 8 - secure access mode for ADC2
    #[inline(always)]
    pub fn adc2sec(&self) -> ADC2SEC_R {
        ADC2SEC_R::new(((self.bits >> 8) & 1) != 0)
    }
...
impl W {
    ///Bit 0 - secure access mode for SPI3
    #[inline(always)]
    pub fn spi3sec(&mut self) -> SPI3SEC_W<'_, TZSC_SECCFGR1rs> {
        SPI3SEC_W::new(self, 0)
    }
    ///Bit 1 - secure access mode for LPUART1
    #[inline(always)]
    pub fn lpuart1sec(&mut self) -> LPUART1SEC_W<'_, TZSC_SECCFGR1rs> {
        LPUART1SEC_W::new(self, 1)
    }
    ///Bit 2 - secure access mode for I2C3
    #[inline(always)]
    pub fn i2c3sec(&mut self) -> I2C3SEC_W<'_, TZSC_SECCFGR1rs> {
        I2C3SEC_W::new(self, 2)
    }
    ///Bit 3 - secure access mode for LPTIM1
    #[inline(always)]
    pub fn lptim1sec(&mut self) -> LPTIM1SEC_W<'_, TZSC_SECCFGR1rs> {
        LPTIM1SEC_W::new(self, 3)
    }
    ///Bit 4 - secure access mode for LPTIM3
    #[inline(always)]
    pub fn lptim3sec(&mut self) -> LPTIM3SEC_W<'_, TZSC_SECCFGR1rs> {
        LPTIM3SEC_W::new(self, 4)
    }
    ///Bit 5 - secure access mode for LPTIM4
    #[inline(always)]
    pub fn lptim4sec(&mut self) -> LPTIM4SEC_W<'_, TZSC_SECCFGR1rs> {
        LPTIM4SEC_W::new(self, 5)
    }
    ///Bit 6 - secure access mode for OPAMP
    #[inline(always)]
    pub fn opampsec(&mut self) -> OPAMPSEC_W<'_, TZSC_SECCFGR1rs> {
        OPAMPSEC_W::new(self, 6)
    }
    ///Bit 7 - secure access mode for COMP
    #[inline(always)]
    pub fn compsec(&mut self) -> COMPSEC_W<'_, TZSC_SECCFGR1rs> {
        COMPSEC_W::new(self, 7)
    }
    ///Bit 8 - secure access mode for ADC2
    #[inline(always)]
    pub fn adc2sec(&mut self) -> ADC2SEC_W<'_, TZSC_SECCFGR1rs> {
        ADC2SEC_W::new(self, 8)
    }
    ///Bit 9 - secure access mode for VREFBUF
    #[inline(always)]
    pub fn vrefbufsec(&mut self) -> VREFBUFSEC_W<'_, TZSC_SECCFGR1rs> {
        VREFBUFSEC_W::new(self, 9)
    }
    ///Bit 11 - secure access mode for DAC1
    #[inline(always)]
    pub fn dac1sec(&mut self) -> DAC1SEC_W<'_, TZSC_SECCFGR1rs> {
        DAC1SEC_W::new(self, 11)
    }
    ///Bit 12 - secure access mode for ADF1
    #[inline(always)]
    pub fn adf1sec(&mut self) -> ADF1SEC_W<'_, TZSC_SECCFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#GTZC2_TZSC:TZSC_SECCFGR1)*/
