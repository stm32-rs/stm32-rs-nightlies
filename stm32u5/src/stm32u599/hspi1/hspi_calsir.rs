///Register `HSPI_CALSIR` reader
pub type R = crate::R<HSPI_CALSIRrs>;
///Register `HSPI_CALSIR` writer
...
You can [`read`](crate::Reg::read) this register and get [`hspi_calsir::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_calsir::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#HSPI1:HSPI_CALSIR)*/
pub struct HSPI_CALSIRrs;
impl crate::RegisterSpec for HSPI_CALSIRrs {
    type Ux = u32;
}
///`read()` method returns [`hspi_calsir::R`](R) reader structure
impl crate::Readable for HSPI_CALSIRrs {}
///`write(|w| ..)` method takes [`hspi_calsir::W`](W) writer structure
impl crate::Writable for HSPI_CALSIRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_CALSIR to value 0
