#[doc = "Register `HSPI_CCR` reader"]
pub type R = crate::R<HSPI_CCRrs>;
#[doc = "Register `HSPI_CCR` writer"]
pub type W = crate::W<HSPI_CCRrs>;
...
#[doc = "Field `ABMODE` reader - Alternate-byte mode This field defines the alternate byte phase mode of operation. 100-111: Reserved"]
pub type ABMODE_R = crate::FieldReader;
#[doc = "Field `ABMODE` writer - Alternate-byte mode This field defines the alternate byte phase mode of operation. 100-111: Reserved"]
pub type ABMODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `ABDTR` reader - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSYÂ =Â 0."]
pub type ABDTR_R = crate::BitReader;
#[doc = "Field `ABDTR` writer - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSYÂ =Â 0."]
...
#[doc = "Field `DMODE` reader - Data mode This field defines the data phase mode of operation. 110-111: Reserved"]
pub type DMODE_R = crate::FieldReader;
#[doc = "Field `DMODE` writer - Data mode This field defines the data phase mode of operation. 110-111: Reserved"]
...
#[doc = "Field `SIOO` reader - Send instruction only once mode This bit has no effect when IMODEÂ =Â 00 (see )."]
pub type SIOO_R = crate::BitReader;
#[doc = "Field `SIOO` writer - Send instruction only once mode This bit has no effect when IMODEÂ =Â 00 (see )."]
...
impl R {
    ...
    #[doc = "Bits 16:18 - Alternate-byte mode This field defines the alternate byte phase mode of operation. 100-111: Reserved"]
    #[inline(always)]
    pub fn abmode(&self) -> ABMODE_R {
        ABMODE_R::new(((self.bits >> 16) & 7) as u8)
    }
    #[doc = "Bit 19 - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSYÂ =Â 0."]
    #[inline(always)]
    ...
    #[doc = "Bits 24:26 - Data mode This field defines the data phase mode of operation. 110-111: Reserved"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - Send instruction only once mode This bit has no effect when IMODEÂ =Â 00 (see )."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn imode(&mut self) -> IMODE_W<HSPI_CCRrs> {
        IMODE_W::new(self, 0)
    }
    #[doc = "Bit 3 - Instruction double transfer rate This bit sets the DTR mode for the instruction phase."]
    #[inline(always)]
    #[must_use]
    pub fn idtr(&mut self) -> IDTR_W<HSPI_CCRrs> {
        IDTR_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Instruction size This bit defines instruction size."]
    #[inline(always)]
    #[must_use]
    pub fn isize(&mut self) -> ISIZE_W<HSPI_CCRrs> {
        ISIZE_W::new(self, 4)
    }
    #[doc = "Bits 8:10 - Address mode This field defines the address phase mode of operation. 101-111: Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn admode(&mut self) -> ADMODE_W<HSPI_CCRrs> {
        ADMODE_W::new(self, 8)
    }
    #[doc = "Bit 11 - Address double transfer rate This bit sets the DTR mode for the address phase."]
    #[inline(always)]
    #[must_use]
    pub fn addtr(&mut self) -> ADDTR_W<HSPI_CCRrs> {
        ADDTR_W::new(self, 11)
    }
    #[doc = "Bits 12:13 - Address size This field defines address size."]
    #[inline(always)]
    #[must_use]
    pub fn adsize(&mut self) -> ADSIZE_W<HSPI_CCRrs> {
        ADSIZE_W::new(self, 12)
    }
    #[doc = "Bits 16:18 - Alternate-byte mode This field defines the alternate byte phase mode of operation. 100-111: Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn abmode(&mut self) -> ABMODE_W<HSPI_CCRrs> {
        ABMODE_W::new(self, 16)
    }
    #[doc = "Bit 19 - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSYÂ =Â 0."]
    #[inline(always)]
    #[must_use]
    pub fn abdtr(&mut self) -> ABDTR_W<HSPI_CCRrs> {
        ABDTR_W::new(self, 19)
    }
    #[doc = "Bits 20:21 - Alternate bytes size This bit defines alternate bytes size."]
    #[inline(always)]
    #[must_use]
    pub fn absize(&mut self) -> ABSIZE_W<HSPI_CCRrs> {
        ABSIZE_W::new(self, 20)
    }
    #[doc = "Bits 24:26 - Data mode This field defines the data phase mode of operation. 110-111: Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn dmode(&mut self) -> DMODE_W<HSPI_CCRrs> {
        DMODE_W::new(self, 24)
    }
    #[doc = "Bit 27 - Data double transfer rate This bit sets the DTR mode for the data phase."]
    #[inline(always)]
    #[must_use]
    pub fn ddtr(&mut self) -> DDTR_W<HSPI_CCRrs> {
        DDTR_W::new(self, 27)
    }
    #[doc = "Bit 29 - DQS enable This bit enables the data strobe management."]
    #[inline(always)]
    #[must_use]
    pub fn dqse(&mut self) -> DQSE_W<HSPI_CCRrs> {
        DQSE_W::new(self, 29)
    }
    #[doc = "Bit 31 - Send instruction only once mode This bit has no effect when IMODEÂ =Â 00 (see )."]
    #[inline(always)]
    #[must_use]
    pub fn sioo(&mut self) -> SIOO_W<HSPI_CCRrs> {
        SIOO_W::new(self, 31)
    }
}
#[doc = "HSPI communication configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hspi_ccr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hspi_ccr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSPI_CCRrs;
impl crate::RegisterSpec for HSPI_CCRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hspi_ccr::R`](R) reader structure"]
impl crate::Readable for HSPI_CCRrs {}
#[doc = "`write(|w| ..)` method takes [`hspi_ccr::W`](W) writer structure"]
impl crate::Writable for HSPI_CCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSPI_CCR to value 0"]
impl crate::Resettable for HSPI_CCRrs {
