#[doc = "Register `HSPI_DCR1` reader"]
pub type R = crate::R<HSPI_DCR1rs>;
#[doc = "Register `HSPI_DCR1` writer"]
pub type W = crate::W<HSPI_DCR1rs>;
#[doc = "Field `CKMODE` reader - Mode 0/Mode 3 This bit indicates the level taken by the CLK between commands (when nCSÂ =Â 1)."]
pub type CKMODE_R = crate::BitReader;
#[doc = "Field `CKMODE` writer - Mode 0/Mode 3 This bit indicates the level taken by the CLK between commands (when nCSÂ =Â 1)."]
...
impl R {
    #[doc = "Bit 0 - Mode 0/Mode 3 This bit indicates the level taken by the CLK between commands (when nCSÂ =Â 1)."]
    #[inline(always)]
    ...
    #[doc = "Bits 8:13 - Chip-select high time CSHTÂ +Â 1 defines the minimum number of CLK cycles where the chip-select (nCS) must remain high between commands issued to the external device. ... 63: nCS stays high for at least 64 cycles between external device commands. Note: When the extended CSHT timeout feature is not supported, CSHT\\[5:3\\]
are reserved and the number of cycles is limited to eight (refer to implementation)."]
    #[inline(always)]
