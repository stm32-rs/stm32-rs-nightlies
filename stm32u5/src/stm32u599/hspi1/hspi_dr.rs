#[doc = "Register `HSPI_DR` reader"]
pub type R = crate::R<HSPI_DRrs>;
#[doc = "Register `HSPI_DR` writer"]
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hspi_dr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hspi_dr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSPI_DRrs;
impl crate::RegisterSpec for HSPI_DRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hspi_dr::R`](R) reader structure"]
impl crate::Readable for HSPI_DRrs {}
#[doc = "`write(|w| ..)` method takes [`hspi_dr::W`](W) writer structure"]
impl crate::Writable for HSPI_DRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSPI_DR to value 0"]
