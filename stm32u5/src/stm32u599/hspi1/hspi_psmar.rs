#[doc = "Register `HSPI_PSMAR` reader"]
pub type R = crate::R<HSPI_PSMARrs>;
#[doc = "Register `HSPI_PSMAR` writer"]
...
#[doc = "HSPI polling status match register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hspi_psmar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hspi_psmar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSPI_PSMARrs;
impl crate::RegisterSpec for HSPI_PSMARrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hspi_psmar::R`](R) reader structure"]
impl crate::Readable for HSPI_PSMARrs {}
#[doc = "`write(|w| ..)` method takes [`hspi_psmar::W`](W) writer structure"]
impl crate::Writable for HSPI_PSMARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSPI_PSMAR to value 0"]
