...
You can [`read`](crate::Reg::read) this register and get [`hspi_sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#HSPI1:HSPI_SR)*/
pub struct HSPI_SRrs;
impl crate::RegisterSpec for HSPI_SRrs {
    type Ux = u32;
}
///`read()` method returns [`hspi_sr::R`](R) reader structure
impl crate::Readable for HSPI_SRrs {}
///`reset()` method sets HSPI_SR to value 0
