///Register `HSPI_TCR` reader
pub type R = crate::R<HSPI_TCRrs>;
///Register `HSPI_TCR` writer
pub type W = crate::W<HSPI_TCRrs>;
...
impl W {
    ///Bits 0:4 - Number of dummy cycles This field defines the duration of the dummy phase. In both SDR and DTR modes, it specifies a number of CLK cycles (0-31).
    #[inline(always)]
    pub fn dcyc(&mut self) -> DCYC_W<HSPI_TCRrs> {
        DCYC_W::new(self, 0)
    }
    ///Bit 28 - Delay hold quarter cycle
    #[inline(always)]
    pub fn dhqc(&mut self) -> DHQC_W<HSPI_TCRrs> {
        DHQC_W::new(self, 28)
    }
    ///Bit 30 - Sample shift By default, the HSPI samples data 1/2 of a CLK cycle after the data is driven by the external device. This bit allows the data to be sampled later in order to consider the external signal delays. The software must ensure that SSHIFTÂ =Â 0 when the data phase is configured in DTR mode (when DDTRÂ =Â 1.)
    #[inline(always)]
    pub fn sshift(&mut self) -> SSHIFT_W<HSPI_TCRrs> {
        SSHIFT_W::new(self, 30)
    }
}
/**HSPI timing configuration register

You can [`read`](crate::Reg::read) this register and get [`hspi_tcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_tcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#HSPI1:HSPI_TCR)*/
pub struct HSPI_TCRrs;
impl crate::RegisterSpec for HSPI_TCRrs {
    type Ux = u32;
}
///`read()` method returns [`hspi_tcr::R`](R) reader structure
impl crate::Readable for HSPI_TCRrs {}
///`write(|w| ..)` method takes [`hspi_tcr::W`](W) writer structure
impl crate::Writable for HSPI_TCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_TCR to value 0
impl crate::Resettable for HSPI_TCRrs {
