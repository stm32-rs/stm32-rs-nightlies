///Register `HSPI_WCCR` reader
pub type R = crate::R<HSPI_WCCRrs>;
///Register `HSPI_WCCR` writer
...
You can [`read`](crate::Reg::read) this register and get [`hspi_wccr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_wccr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#HSPI1:HSPI_WCCR)*/
pub struct HSPI_WCCRrs;
impl crate::RegisterSpec for HSPI_WCCRrs {
    type Ux = u32;
}
///`read()` method returns [`hspi_wccr::R`](R) reader structure
impl crate::Readable for HSPI_WCCRrs {}
///`write(|w| ..)` method takes [`hspi_wccr::W`](W) writer structure
impl crate::Writable for HSPI_WCCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_WCCR to value 0
