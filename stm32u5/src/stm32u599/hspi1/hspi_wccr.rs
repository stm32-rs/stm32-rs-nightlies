#[doc = "Register `HSPI_WCCR` reader"]
pub type R = crate::R<HSPI_WCCRrs>;
#[doc = "Register `HSPI_WCCR` writer"]
pub type W = crate::W<HSPI_WCCRrs>;
...
#[doc = "Field `DMODE` reader - Data mode This field defines the data phase mode of operation."]
pub type DMODE_R = crate::FieldReader;
#[doc = "Field `DMODE` writer - Data mode This field defines the data phase mode of operation."]
...
impl R {
    ...
    #[doc = "Bits 24:26 - Data mode This field defines the data phase mode of operation."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn imode(&mut self) -> IMODE_W<HSPI_WCCRrs> {
        IMODE_W::new(self, 0)
    }
    #[doc = "Bit 3 - Instruction double transfer rate This bit sets the DTR mode for the instruction phase."]
    #[inline(always)]
    #[must_use]
    pub fn idtr(&mut self) -> IDTR_W<HSPI_WCCRrs> {
        IDTR_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Instruction size This bit defines instruction size:"]
    #[inline(always)]
    #[must_use]
    pub fn isize(&mut self) -> ISIZE_W<HSPI_WCCRrs> {
        ISIZE_W::new(self, 4)
    }
    #[doc = "Bits 8:10 - Address mode This field defines the address phase mode of operation. 101-111: Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn admode(&mut self) -> ADMODE_W<HSPI_WCCRrs> {
        ADMODE_W::new(self, 8)
    }
    #[doc = "Bit 11 - Address double transfer rate This bit sets the DTR mode for the address phase."]
    #[inline(always)]
    #[must_use]
    pub fn addtr(&mut self) -> ADDTR_W<HSPI_WCCRrs> {
        ADDTR_W::new(self, 11)
    }
    #[doc = "Bits 12:13 - Address size This field defines address size."]
    #[inline(always)]
    #[must_use]
    pub fn adsize(&mut self) -> ADSIZE_W<HSPI_WCCRrs> {
        ADSIZE_W::new(self, 12)
    }
    #[doc = "Bits 16:18 - Alternate-byte mode This field defines the alternate-byte phase mode of operation. 101-111: Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn abmode(&mut self) -> ABMODE_W<HSPI_WCCRrs> {
        ABMODE_W::new(self, 16)
    }
    #[doc = "Bit 19 - Alternate bytes double-transfer rate This bit sets the DTR mode for the alternate-bytes phase."]
    #[inline(always)]
    #[must_use]
    pub fn abdtr(&mut self) -> ABDTR_W<HSPI_WCCRrs> {
        ABDTR_W::new(self, 19)
    }
    #[doc = "Bits 20:21 - Alternate bytes size This field defines alternate bytes size:"]
    #[inline(always)]
    #[must_use]
    pub fn absize(&mut self) -> ABSIZE_W<HSPI_WCCRrs> {
        ABSIZE_W::new(self, 20)
    }
    #[doc = "Bits 24:26 - Data mode This field defines the data phase mode of operation."]
    #[inline(always)]
    #[must_use]
    pub fn dmode(&mut self) -> DMODE_W<HSPI_WCCRrs> {
        DMODE_W::new(self, 24)
    }
    #[doc = "Bit 27 - data double transfer rate This bit sets the DTR mode for the data phase."]
    #[inline(always)]
    #[must_use]
    pub fn ddtr(&mut self) -> DDTR_W<HSPI_WCCRrs> {
        DDTR_W::new(self, 27)
    }
    #[doc = "Bit 29 - DQS enable This bit enables the data strobe management."]
    #[inline(always)]
    #[must_use]
    pub fn dqse(&mut self) -> DQSE_W<HSPI_WCCRrs> {
        DQSE_W::new(self, 29)
    }
}
#[doc = "HSPI write communication configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hspi_wccr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hspi_wccr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSPI_WCCRrs;
impl crate::RegisterSpec for HSPI_WCCRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hspi_wccr::R`](R) reader structure"]
impl crate::Readable for HSPI_WCCRrs {}
#[doc = "`write(|w| ..)` method takes [`hspi_wccr::W`](W) writer structure"]
impl crate::Writable for HSPI_WCCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSPI_WCCR to value 0"]
impl crate::Resettable for HSPI_WCCRrs {
