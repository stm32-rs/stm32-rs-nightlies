///Register `HSPI_WTCR` reader
pub type R = crate::R<HSPI_WTCRrs>;
///Register `HSPI_WTCR` writer
...
You can [`read`](crate::Reg::read) this register and get [`hspi_wtcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_wtcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#HSPI1:HSPI_WTCR)*/
pub struct HSPI_WTCRrs;
impl crate::RegisterSpec for HSPI_WTCRrs {
    type Ux = u32;
}
///`read()` method returns [`hspi_wtcr::R`](R) reader structure
impl crate::Readable for HSPI_WTCRrs {}
///`write(|w| ..)` method takes [`hspi_wtcr::W`](W) writer structure
impl crate::Writable for HSPI_WTCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_WTCR to value 0
