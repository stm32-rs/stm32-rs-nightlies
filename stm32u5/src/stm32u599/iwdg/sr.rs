...
#[doc = "Field `EWU` reader - Watchdog interrupt comparator value update"]
pub type EWU_R = crate::BitReader;
#[doc = "Field `EWIF` reader - Watchdog Early interrupt flag"]
...
impl R {
    ...
    #[doc = "Bit 3 - Watchdog interrupt comparator value update"]
    #[inline(always)]
    pub fn ewu(&self) -> EWU_R {
        EWU_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 14 - Watchdog Early interrupt flag"]
    #[inline(always)]
