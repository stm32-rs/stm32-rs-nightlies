///Register `LPDMA_C1TR2` reader
pub type R = crate::R<LPDMA_C1TR2rs>;
///Register `LPDMA_C1TR2` writer
pub type W = crate::W<LPDMA_C1TR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> REQSEL_W<LPDMA_C1TR2rs> {
        REQSEL_W::new(self, 0)
    }
    /**Bit 9 - Software request When LPDMA_CxCR.EN is asserted, this field is internally taken into account: - 0: no software request. The selected hardware request REQSEL\[6:0\]
    is taken into account. - 1: software request (for a memory-to-memory transfer). And the default selected hardware request as per REQSEL\[6:0\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn swreq(&mut self) -> SWREQ_W<LPDMA_C1TR2rs> {
        SWREQ_W::new(self, 9)
    }
    ///Bit 11 - BREQ
    #[inline(always)]
    #[must_use]
    pub fn breq(&mut self) -> BREQ_W<LPDMA_C1TR2rs> {
        BREQ_W::new(self, 11)
    }
    ///Bits 14:15 - Trigger mode
    #[inline(always)]
    #[must_use]
    pub fn trigm(&mut self) -> TRIGM_W<LPDMA_C1TR2rs> {
        TRIGM_W::new(self, 14)
    }
    /**Bits 16:20 - Trigger event input selection Note: Selects the trigger event input as per Table 13 of the DMA transfer, with an active trigger event if TRIGPOL\[1:0\]
    !=00.*/
    #[inline(always)]
    #[must_use]
    pub fn trigsel(&mut self) -> TRIGSEL_W<LPDMA_C1TR2rs> {
        TRIGSEL_W::new(self, 16)
    }
    ///Bits 24:25 - Trigger event polarity Defines the polarity of the selected trigger event input defined by TRIGSEL\[5:0\]. - 00: no trigger. Masked trigger event. - 01: trigger on the rising edge - 10: trigger on the falling edge - 11: same as 00
    #[inline(always)]
    #[must_use]
    pub fn trigpol(&mut self) -> TRIGPOL_W<LPDMA_C1TR2rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcem(&mut self) -> TCEM_W<LPDMA_C1TR2rs> {
        TCEM_W::new(self, 30)
    }
}
/**LPDMA channel x transfer register 2

You can [`read`](crate::Reg::read) this register and get [`lpdma_c1tr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpdma_c1tr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#LPDMA1:LPDMA_C1TR2)*/
pub struct LPDMA_C1TR2rs;
impl crate::RegisterSpec for LPDMA_C1TR2rs {
    type Ux = u32;
}
///`read()` method returns [`lpdma_c1tr2::R`](R) reader structure
impl crate::Readable for LPDMA_C1TR2rs {}
///`write(|w| ..)` method takes [`lpdma_c1tr2::W`](W) writer structure
impl crate::Writable for LPDMA_C1TR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPDMA_C1TR2 to value 0
impl crate::Resettable for LPDMA_C1TR2rs {
