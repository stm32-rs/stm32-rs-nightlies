#[doc = "Register `LPDMA_C3TR2` reader"]
pub type R = crate::R<LPDMA_C3TR2rs>;
#[doc = "Register `LPDMA_C3TR2` writer"]
pub type W = crate::W<LPDMA_C3TR2rs>;
...
#[doc = "Field `SWREQ` reader - Software request When LPDMA_CxCR.EN is asserted, this field is internally taken into account: - 0: no software request. The selected hardware request REQSEL\\[6:0\\]
...
#[doc = "Field `SWREQ` writer - Software request When LPDMA_CxCR.EN is asserted, this field is internally taken into account: - 0: no software request. The selected hardware request REQSEL\\[6:0\\]
is taken into account. - 1: software request (for a memory-to-memory transfer). And the default selected hardware request as per REQSEL\\[6:0\\]
is ignored."]
...
#[doc = "Field `TRIGM` reader - Trigger mode"]
pub type TRIGM_R = crate::FieldReader;
#[doc = "Field `TRIGM` writer - Trigger mode"]
...
impl R {
    #[doc = "Bits 0:4 - DMA hardware request selection If the channel x is activated (i.e. LPDMA_CxCR.EN is asserted) with SWREQ=1 (i.e. software request for a memory-to-memory transfer), this bit is ignored. Else, the selected hardware request as per Table 12 is internally taken into account. Note: The user must not assign a same input hardware request (i.e. a same REQSEL\\[6:0\\]
value) to different active DMA channels (i.e. if LPDMA_CxCR.EN=1 and LPDMA_CxTR2.SWREQ=0 for the related x channels). In other words, DMA is not intended to hardware support the case of simultaneous enabled channels having been -incorrectly- configured with a same hardware peripheral request signal, and there is no user setting error reporting."]
    #[inline(always)]
    pub fn reqsel(&self) -> REQSEL_R {
        REQSEL_R::new((self.bits & 0x1f) as u8)
    }
    #[doc = "Bit 9 - Software request When LPDMA_CxCR.EN is asserted, this field is internally taken into account: - 0: no software request. The selected hardware request REQSEL\\[6:0\\]
is taken into account. - 1: software request (for a memory-to-memory transfer). And the default selected hardware request as per REQSEL\\[6:0\\]
is ignored."]
    #[inline(always)]
    ...
    #[doc = "Bits 14:15 - Trigger mode"]
    #[inline(always)]
    pub fn trigm(&self) -> TRIGM_R {
        TRIGM_R::new(((self.bits >> 14) & 3) as u8)
    }
    #[doc = "Bits 16:20 - Trigger event input selection Note: Selects the trigger event input as per Table 13 of the DMA transfer, with an active trigger event if TRIGPOL\\[1:0\\]
!=00."]
    #[inline(always)]
...
value) to different active DMA channels (i.e. if LPDMA_CxCR.EN=1 and LPDMA_CxTR2.SWREQ=0 for the related x channels). In other words, DMA is not intended to hardware support the case of simultaneous enabled channels having been -incorrectly- configured with a same hardware peripheral request signal, and there is no user setting error reporting."]
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> REQSEL_W<LPDMA_C3TR2rs> {
        REQSEL_W::new(self, 0)
    }
    #[doc = "Bit 9 - Software request When LPDMA_CxCR.EN is asserted, this field is internally taken into account: - 0: no software request. The selected hardware request REQSEL\\[6:0\\]
is taken into account. - 1: software request (for a memory-to-memory transfer). And the default selected hardware request as per REQSEL\\[6:0\\]
is ignored."]
    #[inline(always)]
    #[must_use]
    pub fn swreq(&mut self) -> SWREQ_W<LPDMA_C3TR2rs> {
        SWREQ_W::new(self, 9)
    }
    #[doc = "Bit 11 - BREQ"]
    #[inline(always)]
    #[must_use]
    pub fn breq(&mut self) -> BREQ_W<LPDMA_C3TR2rs> {
        BREQ_W::new(self, 11)
    }
    #[doc = "Bits 14:15 - Trigger mode"]
    #[inline(always)]
    #[must_use]
    pub fn trigm(&mut self) -> TRIGM_W<LPDMA_C3TR2rs> {
        TRIGM_W::new(self, 14)
    }
    #[doc = "Bits 16:20 - Trigger event input selection Note: Selects the trigger event input as per Table 13 of the DMA transfer, with an active trigger event if TRIGPOL\\[1:0\\]
!=00."]
    #[inline(always)]
    #[must_use]
    pub fn trigsel(&mut self) -> TRIGSEL_W<LPDMA_C3TR2rs> {
        TRIGSEL_W::new(self, 16)
    }
    #[doc = "Bits 24:25 - Trigger event polarity Defines the polarity of the selected trigger event input defined by TRIGSEL\\[5:0\\]. - 00: no trigger. Masked trigger event. - 01: trigger on the rising edge - 10: trigger on the falling edge - 11: same as 00"]
    #[inline(always)]
    #[must_use]
    pub fn trigpol(&mut self) -> TRIGPOL_W<LPDMA_C3TR2rs> {
...
to zero and that clears all the update bits - UT1, UT2, UB1, USA, UDA, if present UT3, UB2 and ULL - of the LPDMA_CxLLR register. If the channel transfer is continuous/infinite, no event is generated."]
    #[inline(always)]
    #[must_use]
    pub fn tcem(&mut self) -> TCEM_W<LPDMA_C3TR2rs> {
        TCEM_W::new(self, 30)
    }
}
#[doc = "LPDMA channel x transfer register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpdma_c3tr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpdma_c3tr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPDMA_C3TR2rs;
impl crate::RegisterSpec for LPDMA_C3TR2rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpdma_c3tr2::R`](R) reader structure"]
impl crate::Readable for LPDMA_C3TR2rs {}
#[doc = "`write(|w| ..)` method takes [`lpdma_c3tr2::W`](W) writer structure"]
impl crate::Writable for LPDMA_C3TR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPDMA_C3TR2 to value 0"]
impl crate::Resettable for LPDMA_C3TR2rs {
