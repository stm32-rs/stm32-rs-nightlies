///Register `LPGPIO_BRR` writer
pub type W = crate::W<LPGPIO_BRRrs>;
...
impl core::fmt::Debug for crate::generic::Reg<LPGPIO_BRRrs> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn br0(&mut self) -> BR0_W<LPGPIO_BRRrs> {
        BR0_W::new(self, 0)
    }
    ///Bit 1 - BR1
    #[inline(always)]
    #[must_use]
    pub fn br1(&mut self) -> BR1_W<LPGPIO_BRRrs> {
        BR1_W::new(self, 1)
    }
    ///Bit 2 - BR2
    #[inline(always)]
    #[must_use]
    pub fn br2(&mut self) -> BR2_W<LPGPIO_BRRrs> {
        BR2_W::new(self, 2)
    }
    ///Bit 3 - BR3
    #[inline(always)]
    #[must_use]
    pub fn br3(&mut self) -> BR3_W<LPGPIO_BRRrs> {
        BR3_W::new(self, 3)
    }
    ///Bit 4 - BR4
    #[inline(always)]
    #[must_use]
    pub fn br4(&mut self) -> BR4_W<LPGPIO_BRRrs> {
        BR4_W::new(self, 4)
    }
    ///Bit 5 - BR5
    #[inline(always)]
    #[must_use]
    pub fn br5(&mut self) -> BR5_W<LPGPIO_BRRrs> {
        BR5_W::new(self, 5)
    }
    ///Bit 6 - BR6
    #[inline(always)]
    #[must_use]
    pub fn br6(&mut self) -> BR6_W<LPGPIO_BRRrs> {
        BR6_W::new(self, 6)
    }
    ///Bit 7 - BR7
    #[inline(always)]
    #[must_use]
    pub fn br7(&mut self) -> BR7_W<LPGPIO_BRRrs> {
        BR7_W::new(self, 7)
    }
    ///Bit 8 - BR8
    #[inline(always)]
    #[must_use]
    pub fn br8(&mut self) -> BR8_W<LPGPIO_BRRrs> {
        BR8_W::new(self, 8)
    }
    ///Bit 9 - BR9
    #[inline(always)]
    #[must_use]
    pub fn br9(&mut self) -> BR9_W<LPGPIO_BRRrs> {
        BR9_W::new(self, 9)
    }
    ///Bit 10 - BR10
    #[inline(always)]
    #[must_use]
    pub fn br10(&mut self) -> BR10_W<LPGPIO_BRRrs> {
        BR10_W::new(self, 10)
    }
    ///Bit 11 - BR11
    #[inline(always)]
    #[must_use]
    pub fn br11(&mut self) -> BR11_W<LPGPIO_BRRrs> {
        BR11_W::new(self, 11)
    }
    ///Bit 12 - BR12
    #[inline(always)]
    #[must_use]
    pub fn br12(&mut self) -> BR12_W<LPGPIO_BRRrs> {
        BR12_W::new(self, 12)
    }
    ///Bit 13 - BR13
    #[inline(always)]
    #[must_use]
    pub fn br13(&mut self) -> BR13_W<LPGPIO_BRRrs> {
        BR13_W::new(self, 13)
    }
    ///Bit 14 - BR14
    #[inline(always)]
    #[must_use]
    pub fn br14(&mut self) -> BR14_W<LPGPIO_BRRrs> {
        BR14_W::new(self, 14)
    }
    ///Bit 15 - BR15
    #[inline(always)]
    #[must_use]
    pub fn br15(&mut self) -> BR15_W<LPGPIO_BRRrs> {
        BR15_W::new(self, 15)
    }
}
/**LPGPIO port bit reset register

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpgpio_brr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#LPGPIO1:LPGPIO_BRR)*/
pub struct LPGPIO_BRRrs;
impl crate::RegisterSpec for LPGPIO_BRRrs {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`lpgpio_brr::W`](W) writer structure
impl crate::Writable for LPGPIO_BRRrs {
