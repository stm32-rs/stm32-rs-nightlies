...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `OD0` field.</div>
    #[inline(always)]
    pub fn od(&mut self, n: u8) -> OD_W<'_, ODRrs> {
        #[allow(clippy::no_effect)]
        [(); 16][n as usize];
        OD_W::new(self, n)
    }
    ///Bit 0 - OD0
    #[inline(always)]
    pub fn od0(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 0)
    }
    ///Bit 1 - OD1
    #[inline(always)]
    pub fn od1(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 1)
    }
    ///Bit 2 - OD2
    #[inline(always)]
    pub fn od2(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 2)
    }
    ///Bit 3 - OD3
    #[inline(always)]
    pub fn od3(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 3)
    }
    ///Bit 4 - OD4
    #[inline(always)]
    pub fn od4(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 4)
    }
    ///Bit 5 - OD5
    #[inline(always)]
    pub fn od5(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 5)
    }
    ///Bit 6 - OD6
    #[inline(always)]
    pub fn od6(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 6)
    }
    ///Bit 7 - OD7
    #[inline(always)]
    pub fn od7(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 7)
    }
    ///Bit 8 - OD8
    #[inline(always)]
    pub fn od8(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 8)
    }
    ///Bit 9 - OD9
    #[inline(always)]
    pub fn od9(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 9)
    }
    ///Bit 10 - OD10
    #[inline(always)]
    pub fn od10(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 10)
    }
    ///Bit 11 - OD11
    #[inline(always)]
    pub fn od11(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 11)
    }
    ///Bit 12 - OD12
    #[inline(always)]
    pub fn od12(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 12)
    }
    ///Bit 13 - OD13
    #[inline(always)]
    pub fn od13(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 13)
    }
    ///Bit 14 - OD14
    #[inline(always)]
    pub fn od14(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 14)
    }
    ///Bit 15 - OD15
    #[inline(always)]
    pub fn od15(&mut self) -> OD_W<'_, ODRrs> {
        OD_W::new(self, 15)
    }
}
