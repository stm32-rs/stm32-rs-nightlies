...
#[doc = "Field `IC1SEL` reader - LPTIM input capture 1 selection"]
pub type IC1SEL_R = crate::FieldReader;
#[doc = "Field `IC1SEL` writer - LPTIM input capture 1 selection"]
pub type IC1SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `IC2SEL` reader - LPTIM input capture 2 selection"]
pub type IC2SEL_R = crate::FieldReader;
#[doc = "Field `IC2SEL` writer - LPTIM input capture 2 selection"]
...
impl R {
    ...
    #[doc = "Bits 16:17 - LPTIM input capture 1 selection"]
    #[inline(always)]
    pub fn ic1sel(&self) -> IC1SEL_R {
        IC1SEL_R::new(((self.bits >> 16) & 3) as u8)
    }
    #[doc = "Bits 20:21 - LPTIM input capture 2 selection"]
    #[inline(always)]
