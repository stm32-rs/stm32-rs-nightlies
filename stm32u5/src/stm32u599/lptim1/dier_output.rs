...
#[doc = "Field `CMP2OKIE` reader - Compare register 2 update OK interrupt enable"]
pub type CMP2OKIE_R = crate::BitReader;
#[doc = "Field `CMP2OKIE` writer - Compare register 2 update OK interrupt enable"]
pub type CMP2OKIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `UEDE` reader - Update event DMA request enable"]
pub type UEDE_R = crate::BitReader;
#[doc = "Field `UEDE` writer - Update event DMA request enable"]
...
impl R {
    ...
    #[doc = "Bit 19 - Compare register 2 update OK interrupt enable"]
    #[inline(always)]
    pub fn cmp2okie(&self) -> CMP2OKIE_R {
        CMP2OKIE_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 23 - Update event DMA request enable"]
    #[inline(always)]
