///Register `LTDC_L2CFBLR` reader
pub type R = crate::R<LTDC_L2CFBLRrs>;
///Register `LTDC_L2CFBLR` writer
...
You can [`read`](crate::Reg::read) this register and get [`ltdc_l2cfblr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ltdc_l2cfblr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`ltdc_l2cfblr::R`](R) reader structure
impl crate::Readable for LTDC_L2CFBLRrs {}
///`write(|w| ..)` method takes [`ltdc_l2cfblr::W`](W) writer structure
impl crate::Writable for LTDC_L2CFBLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LTDC_L2CFBLR to value 0
