...
#[doc = "Field `IMR` reader - immediate reload This bit is set by software and cleared only by hardware after reload."]
pub type IMR_R = crate::BitReader;
#[doc = "Field `IMR` writer - immediate reload This bit is set by software and cleared only by hardware after reload."]
pub type IMR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `VBR` reader - vertical blanking reload This bit is set by software and cleared only by hardware after reload (it cannot be cleared through register write once it is set)."]
pub type VBR_R = crate::BitReader;
#[doc = "Field `VBR` writer - vertical blanking reload This bit is set by software and cleared only by hardware after reload (it cannot be cleared through register write once it is set)."]
pub type VBR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - immediate reload This bit is set by software and cleared only by hardware after reload."]
    #[inline(always)]
    pub fn imr(&self) -> IMR_R {
        IMR_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - vertical blanking reload This bit is set by software and cleared only by hardware after reload (it cannot be cleared through register write once it is set)."]
    #[inline(always)]
