#[doc = "Register `MDF_DFLT4IER` reader"]
pub type R = crate::R<MDF_DFLT4IERrs>;
#[doc = "Register `MDF_DFLT4IER` writer"]
...
#[doc = "MDF DFLTx interrupt enable register x\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_dflt4ier::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdf_dflt4ier::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_DFLT4IERrs;
impl crate::RegisterSpec for MDF_DFLT4IERrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_dflt4ier::R`](R) reader structure"]
impl crate::Readable for MDF_DFLT4IERrs {}
#[doc = "`write(|w| ..)` method takes [`mdf_dflt4ier::W`](W) writer structure"]
impl crate::Writable for MDF_DFLT4IERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MDF_DFLT4IER to value 0"]
