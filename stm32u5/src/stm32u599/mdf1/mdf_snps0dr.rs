#[doc = "Register `MDF_SNPS0DR` reader"]
...
#[doc = "This register is used to read the data processed by each digital filter in snapshot mode.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdf_snps0dr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MDF_SNPS0DRrs;
impl crate::RegisterSpec for MDF_SNPS0DRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mdf_snps0dr::R`](R) reader structure"]
impl crate::Readable for MDF_SNPS0DRrs {}
#[doc = "`reset()` method sets MDF_SNPS0DR to value 0"]
