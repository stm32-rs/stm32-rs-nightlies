...
impl W {
    ///Bit 0 - XFRC
    #[inline(always)]
    pub fn xfrc(&mut self) -> XFRC_W<DIEPINT7rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - EPDISD
    #[inline(always)]
    pub fn epdisd(&mut self) -> EPDISD_W<DIEPINT7rs> {
        EPDISD_W::new(self, 1)
    }
    ///Bit 2 - AHBERR
    #[inline(always)]
    pub fn ahberr(&mut self) -> AHBERR_W<DIEPINT7rs> {
        AHBERR_W::new(self, 2)
    }
    ///Bit 3 - TOC
    #[inline(always)]
    pub fn toc(&mut self) -> TOC_W<DIEPINT7rs> {
        TOC_W::new(self, 3)
    }
    ///Bit 4 - ITTXFE
    #[inline(always)]
    pub fn ittxfe(&mut self) -> ITTXFE_W<DIEPINT7rs> {
        ITTXFE_W::new(self, 4)
    }
    ///Bit 5 - INEPNM
    #[inline(always)]
    pub fn inepnm(&mut self) -> INEPNM_W<DIEPINT7rs> {
        INEPNM_W::new(self, 5)
    }
    ///Bit 8 - TXFIFOUDRN
    #[inline(always)]
    pub fn txfifoudrn(&mut self) -> TXFIFOUDRN_W<DIEPINT7rs> {
        TXFIFOUDRN_W::new(self, 8)
    }
    ///Bit 9 - BNA
    #[inline(always)]
    pub fn bna(&mut self) -> BNA_W<DIEPINT7rs> {
        BNA_W::new(self, 9)
    }
    ///Bit 11 - PKTDRPSTS
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PKTDRPSTS_W<DIEPINT7rs> {
        PKTDRPSTS_W::new(self, 11)
    }
    ///Bit 13 - NAK
    #[inline(always)]
    pub fn nak(&mut self) -> NAK_W<DIEPINT7rs> {
        NAK_W::new(self, 13)
    }
}
