...
pub type R = crate::R<DIEPTSIZ5rs>;
///Register `DIEPTSIZ5` writer
pub type W = crate::W<DIEPTSIZ5rs>;
...
impl W {
    ///Bits 0:18 - XFRSIZ
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, DIEPTSIZ5rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - PKTCNT
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, DIEPTSIZ5rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - MCNT
    #[inline(always)]
    pub fn mcnt(&mut self) -> MCNT_W<'_, DIEPTSIZ5rs> {
        MCNT_W::new(self, 29)
    }
}
...
pub struct DIEPTSIZ5rs;
impl crate::RegisterSpec for DIEPTSIZ5rs {
    type Ux = u32;
}
///`read()` method returns [`dieptsiz5::R`](R) reader structure
impl crate::Readable for DIEPTSIZ5rs {}
///`write(|w| ..)` method takes [`dieptsiz5::W`](W) writer structure
impl crate::Writable for DIEPTSIZ5rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DIEPTSIZ5 to value 0
impl crate::Resettable for DIEPTSIZ5rs {}
