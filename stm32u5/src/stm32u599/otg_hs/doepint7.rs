...
impl W {
    ///Bit 0 - XFRC
    #[inline(always)]
    pub fn xfrc(&mut self) -> XFRC_W<'_, DOEPINT7rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - EPDISD
    #[inline(always)]
    pub fn epdisd(&mut self) -> EPDISD_W<'_, DOEPINT7rs> {
        EPDISD_W::new(self, 1)
    }
    ///Bit 2 - AHBERR
    #[inline(always)]
    pub fn ahberr(&mut self) -> AHBERR_W<'_, DOEPINT7rs> {
        AHBERR_W::new(self, 2)
    }
    ///Bit 3 - STUP
    #[inline(always)]
    pub fn stup(&mut self) -> STUP_W<'_, DOEPINT7rs> {
        STUP_W::new(self, 3)
    }
    ///Bit 4 - OTEPDIS
    #[inline(always)]
    pub fn otepdis(&mut self) -> OTEPDIS_W<'_, DOEPINT7rs> {
        OTEPDIS_W::new(self, 4)
    }
    ///Bit 5 - STSPHSRX
    #[inline(always)]
    pub fn stsphsrx(&mut self) -> STSPHSRX_W<'_, DOEPINT7rs> {
        STSPHSRX_W::new(self, 5)
    }
    ///Bit 6 - B2BSTUP
    #[inline(always)]
    pub fn b2bstup(&mut self) -> B2BSTUP_W<'_, DOEPINT7rs> {
        B2BSTUP_W::new(self, 6)
    }
    ///Bit 8 - OUTPKTERR
    #[inline(always)]
    pub fn outpkterr(&mut self) -> OUTPKTERR_W<'_, DOEPINT7rs> {
        OUTPKTERR_W::new(self, 8)
    }
    ///Bit 9 - BNA
    #[inline(always)]
    pub fn bna(&mut self) -> BNA_W<'_, DOEPINT7rs> {
        BNA_W::new(self, 9)
    }
    ///Bit 12 - BERR
    #[inline(always)]
    pub fn berr(&mut self) -> BERR_W<'_, DOEPINT7rs> {
        BERR_W::new(self, 12)
    }
    ///Bit 13 - NAK
    #[inline(always)]
    pub fn nak(&mut self) -> NAK_W<'_, DOEPINT7rs> {
        NAK_W::new(self, 13)
    }
    ///Bit 14 - NYET
    #[inline(always)]
    pub fn nyet(&mut self) -> NYET_W<'_, DOEPINT7rs> {
        NYET_W::new(self, 14)
    }
    ///Bit 15 - STPKTRX
    #[inline(always)]
    pub fn stpktrx(&mut self) -> STPKTRX_W<'_, DOEPINT7rs> {
