///Register `HCDMA13` reader
pub type R = crate::R<HCDMA13rs>;
///Register `HCDMA13` writer
pub type W = crate::W<HCDMA13rs>;
...
impl W {
    ///Bits 0:31 - DMA address This field holds the start address in the external memory from which the data for the endpoint must be fetched or to which it must be stored. This register is incremented on every AHB transaction.
    #[inline(always)]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<'_, HCDMA13rs> {
...
pub struct HCDMA13rs;
impl crate::RegisterSpec for HCDMA13rs {
    type Ux = u32;
}
///`read()` method returns [`hcdma13::R`](R) reader structure
impl crate::Readable for HCDMA13rs {}
///`write(|w| ..)` method takes [`hcdma13::W`](W) writer structure
impl crate::Writable for HCDMA13rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HCDMA13 to value 0
impl crate::Resettable for HCDMA13rs {}
