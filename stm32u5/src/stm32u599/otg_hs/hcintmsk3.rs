///Register `HCINTMSK3` reader
pub type R = crate::R<HCINTMSK3rs>;
///Register `HCINTMSK3` writer
pub type W = crate::W<HCINTMSK3rs>;
...
impl W {
    ///Bit 0 - XFRCM
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, HCINTMSK3rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - CHHM
    #[inline(always)]
    pub fn chhm(&mut self) -> CHHM_W<'_, HCINTMSK3rs> {
        CHHM_W::new(self, 1)
    }
    ///Bit 3 - STALLM
    #[inline(always)]
    pub fn stallm(&mut self) -> STALLM_W<'_, HCINTMSK3rs> {
        STALLM_W::new(self, 3)
    }
    ///Bit 4 - NAKM
    #[inline(always)]
    pub fn nakm(&mut self) -> NAKM_W<'_, HCINTMSK3rs> {
        NAKM_W::new(self, 4)
    }
    ///Bit 5 - ACKM
    #[inline(always)]
    pub fn ackm(&mut self) -> ACKM_W<'_, HCINTMSK3rs> {
        ACKM_W::new(self, 5)
    }
    ///Bit 7 - TXERRM
    #[inline(always)]
    pub fn txerrm(&mut self) -> TXERRM_W<'_, HCINTMSK3rs> {
        TXERRM_W::new(self, 7)
    }
    ///Bit 8 - BBERRM
    #[inline(always)]
    pub fn bberrm(&mut self) -> BBERRM_W<'_, HCINTMSK3rs> {
        BBERRM_W::new(self, 8)
    }
    ///Bit 9 - FRMORM
    #[inline(always)]
    pub fn frmorm(&mut self) -> FRMORM_W<'_, HCINTMSK3rs> {
        FRMORM_W::new(self, 9)
    }
    ///Bit 10 - DTERRM
    #[inline(always)]
    pub fn dterrm(&mut self) -> DTERRM_W<'_, HCINTMSK3rs> {
...
pub struct HCINTMSK3rs;
impl crate::RegisterSpec for HCINTMSK3rs {
    type Ux = u32;
}
///`read()` method returns [`hcintmsk3::R`](R) reader structure
impl crate::Readable for HCINTMSK3rs {}
///`write(|w| ..)` method takes [`hcintmsk3::W`](W) writer structure
impl crate::Writable for HCINTMSK3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HCINTMSK3 to value 0
impl crate::Resettable for HCINTMSK3rs {}
