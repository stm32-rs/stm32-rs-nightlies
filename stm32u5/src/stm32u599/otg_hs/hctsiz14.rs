...
impl W {
    ///Bits 0:18 - XFRSIZ
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, HCTSIZ14rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - PKTCNT
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, HCTSIZ14rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - DPID
    #[inline(always)]
    pub fn dpid(&mut self) -> DPID_W<'_, HCTSIZ14rs> {
        DPID_W::new(self, 29)
    }
    ///Bit 31 - DOPNG
    #[inline(always)]
    pub fn dopng(&mut self) -> DOPNG_W<'_, HCTSIZ14rs> {
        DOPNG_W::new(self, 31)
    }
}
