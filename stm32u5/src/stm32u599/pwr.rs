...
impl RegisterBlock {
    ...
    #[doc = "0x3c - PWR supply voltage monitoring status register"]
    #[inline(always)]
    ...
    #[doc = "0x60 - Power port C pull up control register"]
    #[inline(always)]
    ...
    #[doc = "0x98 - PWR port J pull-up control register"]
    #[inline(always)]
    pub const fn pwr_pucrj(&self) -> &PWR_PUCRJ {
        &self.pwr_pucrj
    }
    #[doc = "0x9c - PWR port J pull-down control register"]
    #[inline(always)]
    pub const fn pwr_pdcrj(&self) -> &PWR_PDCRJ {
        &self.pwr_pdcrj
    }
    #[doc = "0xa8 - PWR control register 4"]
    #[inline(always)]
...
pub mod pwr_wusr;
#[doc = "PWR_WUSCR (rw) register accessor: PWR wakeup status clear register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwr_wuscr::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwr_wuscr::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pwr_wuscr`]
module"]
...
pub mod pwr_pdcri;
#[doc = "PWR_PUCRJ (rw) register accessor: PWR port J pull-up control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwr_pucrj::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwr_pucrj::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pwr_pucrj`]
module"]
pub type PWR_PUCRJ = crate::Reg<pwr_pucrj::PWR_PUCRJrs>;
#[doc = "PWR port J pull-up control register"]
pub mod pwr_pucrj;
#[doc = "PWR_PDCRJ (rw) register accessor: PWR port J pull-down control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwr_pdcrj::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwr_pdcrj::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pwr_pdcrj`]
module"]
pub type PWR_PDCRJ = crate::Reg<pwr_pdcrj::PWR_PDCRJrs>;
#[doc = "PWR port J pull-down control register"]
pub mod pwr_pdcrj;
#[doc = "PWR_CR4 (rw) register accessor: PWR control register 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwr_cr4::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwr_cr4::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pwr_cr4`]
module"]
