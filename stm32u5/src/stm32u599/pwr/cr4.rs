...
impl W {
    ...
    ///Bit 16
    #[inline(always)]
    pub fn sram5pds1(&mut self) -> SRAM5PDS1_W<'_, CR4rs> {
        SRAM5PDS1_W::new(self, 16)
    }
    ///Bit 17
    #[inline(always)]
    pub fn sram5pds2(&mut self) -> SRAM5PDS2_W<'_, CR4rs> {
        SRAM5PDS2_W::new(self, 17)
    }
    ///Bit 18
    #[inline(always)]
    pub fn sram5pds3(&mut self) -> SRAM5PDS3_W<'_, CR4rs> {
        SRAM5PDS3_W::new(self, 18)
    }
    ///Bit 19
    #[inline(always)]
    pub fn sram5pds4(&mut self) -> SRAM5PDS4_W<'_, CR4rs> {
        SRAM5PDS4_W::new(self, 19)
    }
    ///Bit 20
    #[inline(always)]
    pub fn sram5pds5(&mut self) -> SRAM5PDS5_W<'_, CR4rs> {
        SRAM5PDS5_W::new(self, 20)
    }
    ///Bit 21
    #[inline(always)]
    pub fn sram5pds6(&mut self) -> SRAM5PDS6_W<'_, CR4rs> {
        SRAM5PDS6_W::new(self, 21)
    }
    ///Bit 22
    #[inline(always)]
    pub fn sram5pds7(&mut self) -> SRAM5PDS7_W<'_, CR4rs> {
        SRAM5PDS7_W::new(self, 22)
    }
    ///Bit 23
    #[inline(always)]
    pub fn sram5pds8(&mut self) -> SRAM5PDS8_W<'_, CR4rs> {
        SRAM5PDS8_W::new(self, 23)
    }
    ///Bit 24
    #[inline(always)]
    pub fn sram5pds9(&mut self) -> SRAM5PDS9_W<'_, CR4rs> {
        SRAM5PDS9_W::new(self, 24)
    }
    ///Bit 25
    #[inline(always)]
    pub fn sram5pds10(&mut self) -> SRAM5PDS10_W<'_, CR4rs> {
        SRAM5PDS10_W::new(self, 25)
    }
    ///Bit 26
    #[inline(always)]
    pub fn sram5pds11(&mut self) -> SRAM5PDS11_W<'_, CR4rs> {
        SRAM5PDS11_W::new(self, 26)
    }
    ///Bit 27
    #[inline(always)]
    pub fn sram5pds12(&mut self) -> SRAM5PDS12_W<'_, CR4rs> {
        SRAM5PDS12_W::new(self, 27)
    }
    ///Bit 28
    #[inline(always)]
    pub fn sram5pds13(&mut self) -> SRAM5PDS13_W<'_, CR4rs> {
