...
impl W {
    ...
    ///Bit 12
    #[inline(always)]
    pub fn pd12(&mut self) -> PD12_W<'_, PDCRIrs> {
        PD12_W::new(self, 12)
    }
    ///Bit 13
    #[inline(always)]
    pub fn pd13(&mut self) -> PD13_W<'_, PDCRIrs> {
        PD13_W::new(self, 13)
    }
    ///Bit 14
    #[inline(always)]
    pub fn pd14(&mut self) -> PD14_W<'_, PDCRIrs> {
        PD14_W::new(self, 14)
    }
    ///Bit 15
    #[inline(always)]
    pub fn pd15(&mut self) -> PD15_W<'_, PDCRIrs> {
        PD15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#PWR:PDCRI)*/
pub struct PDCRIrs;
