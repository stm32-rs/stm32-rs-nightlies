///Register `PUCRJ` reader
pub type R = crate::R<PUCRJrs>;
///Register `PUCRJ` writer
pub type W = crate::W<PUCRJrs>;
/**
...
impl W {
    ///Bit 0
    #[inline(always)]
    pub fn pu0(&mut self) -> PU0_W<'_, PUCRJrs> {
        PU0_W::new(self, 0)
    }
    ///Bit 1
    #[inline(always)]
    pub fn pu1(&mut self) -> PU1_W<'_, PUCRJrs> {
        PU1_W::new(self, 1)
    }
    ///Bit 2
    #[inline(always)]
    pub fn pu2(&mut self) -> PU2_W<'_, PUCRJrs> {
        PU2_W::new(self, 2)
    }
    ///Bit 3
    #[inline(always)]
    pub fn pu3(&mut self) -> PU3_W<'_, PUCRJrs> {
        PU3_W::new(self, 3)
    }
    ///Bit 4
    #[inline(always)]
    pub fn pu4(&mut self) -> PU4_W<'_, PUCRJrs> {
        PU4_W::new(self, 4)
    }
    ///Bit 5
    #[inline(always)]
    pub fn pu5(&mut self) -> PU5_W<'_, PUCRJrs> {
        PU5_W::new(self, 5)
    }
    ///Bit 6
    #[inline(always)]
    pub fn pu6(&mut self) -> PU6_W<'_, PUCRJrs> {
        PU6_W::new(self, 6)
    }
    ///Bit 7
    #[inline(always)]
    pub fn pu7(&mut self) -> PU7_W<'_, PUCRJrs> {
        PU7_W::new(self, 7)
    }
    ///Bit 8
    #[inline(always)]
    pub fn pu8(&mut self) -> PU8_W<'_, PUCRJrs> {
        PU8_W::new(self, 8)
    }
    ///Bit 9
    #[inline(always)]
    pub fn pu9(&mut self) -> PU9_W<'_, PUCRJrs> {
        PU9_W::new(self, 9)
    }
    ///Bit 10
    #[inline(always)]
    pub fn pu10(&mut self) -> PU10_W<'_, PUCRJrs> {
        PU10_W::new(self, 10)
    }
    ///Bit 11
    #[inline(always)]
    pub fn pu11(&mut self) -> PU11_W<'_, PUCRJrs> {
        PU11_W::new(self, 11)
    }
}
/**PWR port J pull-up control register

You can [`read`](crate::Reg::read) this register and get [`pucrj::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pucrj::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#PWR:PUCRJ)*/
pub struct PUCRJrs;
impl crate::RegisterSpec for PUCRJrs {
    type Ux = u32;
}
///`read()` method returns [`pucrj::R`](R) reader structure
impl crate::Readable for PUCRJrs {}
///`write(|w| ..)` method takes [`pucrj::W`](W) writer structure
impl crate::Writable for PUCRJrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets PUCRJ to value 0
impl crate::Resettable for PUCRJrs {}
