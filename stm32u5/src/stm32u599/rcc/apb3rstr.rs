...
impl W {
    ///Bit 1 - SYSCFG reset This bit is set and cleared by software.
    #[inline(always)]
    pub fn syscfgrst(&mut self) -> SYSCFGRST_W<'_, APB3RSTRrs> {
        SYSCFGRST_W::new(self, 1)
    }
    ///Bit 5 - SPI3 reset This bit is set and cleared by software.
    #[inline(always)]
    pub fn spi3rst(&mut self) -> SPI3RST_W<'_, APB3RSTRrs> {
    ...
    ///Bit 14 - OPAMP reset This bit is set and cleared by software.
    #[inline(always)]
    pub fn opamprst(&mut self) -> OPAMPRST_W<'_, APB3RSTRrs> {
        OPAMPRST_W::new(self, 14)
    }
    ///Bit 15 - COMP reset This bit is set and cleared by software.
    #[inline(always)]
    pub fn comprst(&mut self) -> COMPRST_W<'_, APB3RSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#RCC:APB3RSTR)*/
