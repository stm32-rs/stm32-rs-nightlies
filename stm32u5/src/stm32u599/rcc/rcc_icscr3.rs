...
/**Field `HSITRIM` reader - HSI clock trimming These bits provide an additional user-programmable trimming value that is added to HSICAL\[11:0\]
...
/**Field `HSITRIM` writer - HSI clock trimming These bits provide an additional user-programmable trimming value that is added to HSICAL\[11:0\]
bits. It can be programmed to adjust to voltage and temperature variations that influence the frequency of the HSI.*/
...
impl R {
    ...
    /**Bits 16:20 - HSI clock trimming These bits provide an additional user-programmable trimming value that is added to HSICAL\[11:0\]
    bits. It can be programmed to adjust to voltage and temperature variations that influence the frequency of the HSI.*/
    #[inline(always)]
...
You can [`read`](crate::Reg::read) this register and get [`rcc_icscr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcc_icscr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#RCC:RCC_ICSCR3)*/
