...
#[doc = "Field `DATATIME` reader - Data and R1b busy timeout period"]
pub type DATATIME_R = crate::FieldReader<u32>;
#[doc = "Field `DATATIME` writer - Data and R1b busy timeout period"]
pub type DATATIME_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Data and R1b busy timeout period"]
    #[inline(always)]
