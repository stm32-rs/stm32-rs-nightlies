...
#[doc = "Field `IDMABA` reader - Word aligned Linked list memory base address"]
pub type IDMABA_R = crate::FieldReader<u32>;
#[doc = "Field `IDMABA` writer - Word aligned Linked list memory base address"]
pub type IDMABA_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    #[doc = "Bits 2:31 - Word aligned Linked list memory base address"]
    #[inline(always)]
