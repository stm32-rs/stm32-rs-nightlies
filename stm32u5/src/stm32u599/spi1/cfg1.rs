...
///Field `FTHVL` reader - threshold level
pub type FTHVL_R = crate::FieldReader;
///Field `FTHVL` writer - threshold level
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SPI1:CFG1)*/
pub struct CFG1rs;
