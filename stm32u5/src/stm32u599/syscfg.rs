...
impl RegisterBlock {
    ...
    ///0x74 - SYSCFG USB OTG_HS PHY register
    #[inline(always)]
    pub const fn otghsphycr(&self) -> &OTGHSPHYCR {
        &self.otghsphycr
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:SECCFGR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:CFGR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:FPUIMR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:CNSLCKR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:CSLOCKR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:MESR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:CCCSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:CCVR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:CCCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:RSSCMDR)
...
pub mod rsscmdr;
/**OTGHSPHYCR (rw) register accessor: SYSCFG USB OTG_HS PHY register

You can [`read`](crate::Reg::read) this register and get [`otghsphycr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otghsphycr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#SYSCFG:OTGHSPHYCR)

For information about available fields see [`mod@otghsphycr`]
module*/
pub type OTGHSPHYCR = crate::Reg<otghsphycr::OTGHSPHYCRrs>;
