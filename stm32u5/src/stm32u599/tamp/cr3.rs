...
impl W {
    ...
    ///Bit 4 - TAMP5NOER
    #[inline(always)]
    pub fn tamp5noer(&mut self) -> TAMP5NOER_W<'_, CR3rs> {
        TAMP5NOER_W::new(self, 4)
    }
    ///Bit 5 - TAMP6NOER
    #[inline(always)]
    pub fn tamp6noer(&mut self) -> TAMP6NOER_W<'_, CR3rs> {
        TAMP6NOER_W::new(self, 5)
    }
    ///Bit 6 - TAMP7NOER
    #[inline(always)]
    pub fn tamp7noer(&mut self) -> TAMP7NOER_W<'_, CR3rs> {
        TAMP7NOER_W::new(self, 6)
    }
    ///Bit 7 - TAMP8NOER
    #[inline(always)]
    pub fn tamp8noer(&mut self) -> TAMP8NOER_W<'_, CR3rs> {
        TAMP8NOER_W::new(self, 7)
    }
    ///Bit 8 - ITAMP9NOER
    #[inline(always)]
    pub fn itamp9noer(&mut self) -> ITAMP9NOER_W<'_, CR3rs> {
        ITAMP9NOER_W::new(self, 8)
    }
    ///Bit 10 - ITAMP11NOER
    #[inline(always)]
    pub fn itamp11noer(&mut self) -> ITAMP11NOER_W<'_, CR3rs> {
        ITAMP11NOER_W::new(self, 10)
    }
    ///Bit 11 - ITAMP12NOER
    #[inline(always)]
    pub fn itamp12noer(&mut self) -> ITAMP12NOER_W<'_, CR3rs> {
        ITAMP12NOER_W::new(self, 11)
    }
    ///Bit 12 - ITAMP13NOER
    #[inline(always)]
    pub fn itamp13noer(&mut self) -> ITAMP13NOER_W<'_, CR3rs> {
