...
///Field `ERCFG0` reader - ERCFG0
pub type ERCFG0_R = crate::BitReader;
///Field `ERCFG0` writer - ERCFG0
...
impl W {
    ///Bit 0 - ERCFG0
    #[inline(always)]
    pub fn ercfg0(&mut self) -> ERCFG0_W<'_, ERCFGRrs> {
        ERCFG0_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#TAMP:ERCFGR)*/
pub struct ERCFGRrs;
