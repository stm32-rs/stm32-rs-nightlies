...
///Field `OC1M_bit3` reader - Output Compare 1 mode - bit 3
pub type OC1M_BIT3_R = crate::BitReader;
///Field `OC1M_bit3` writer - Output Compare 1 mode - bit 3
pub type OC1M_BIT3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OC2M_bit3` reader - Output Compare 2 mode - bit 3
pub type OC2M_BIT3_R = crate::BitReader;
///Field `OC2M_bit3` writer - Output Compare 2 mode - bit 3
...
impl R {
    ...
    #[inline(always)]
    pub fn oc1m_bit3(&self) -> OC1M_BIT3_R {
        OC1M_BIT3_R::new(((self.bits >> 16) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CCMR1_Output")
            .field("oc2m_bit3", &self.oc2m_bit3())
            .field("oc1m_bit3", &self.oc1m_bit3())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn oc1m_bit3(&mut self) -> OC1M_BIT3_W<CCMR1_OUTPUTrs> {
        OC1M_BIT3_W::new(self, 16)
    }
    ///Bit 24 - Output Compare 2 mode - bit 3
    #[inline(always)]
    #[must_use]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U599.html#TIM1:CCMR1_Output)*/
