///Register `ADC12_CSR` reader
pub type R = crate::R<ADC12_CSRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`adc12_csr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#ADC12_Common:ADC12_CSR)*/
pub struct ADC12_CSRrs;
impl crate::RegisterSpec for ADC12_CSRrs {
    type Ux = u32;
}
///`read()` method returns [`adc12_csr::R`](R) reader structure
impl crate::Readable for ADC12_CSRrs {}
///`reset()` method sets ADC12_CSR to value 0
impl crate::Resettable for ADC12_CSRrs {
