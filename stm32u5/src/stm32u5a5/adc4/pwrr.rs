...
impl W {
    ///Bit 0 - AUTOFF
    #[inline(always)]
    pub fn autoff(&mut self) -> AUTOFF_W<'_, PWRRrs> {
        AUTOFF_W::new(self, 0)
    }
    ///Bit 1 - DPD
    #[inline(always)]
    pub fn dpd(&mut self) -> DPD_W<'_, PWRRrs> {
        DPD_W::new(self, 1)
    }
    ///Bit 2 - VREFPROT
    #[inline(always)]
    pub fn vrefprot(&mut self) -> VREFPROT_W<'_, PWRRrs> {
        VREFPROT_W::new(self, 2)
    }
    ///Bit 3 - VREFSECSMP
    #[inline(always)]
    pub fn vrefsecsmp(&mut self) -> VREFSECSMP_W<'_, PWRRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#ADC4:PWRR)*/
pub struct PWRRrs;
