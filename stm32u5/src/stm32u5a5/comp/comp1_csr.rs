...
impl W {
    ...
    ///Bit 11 - COMP1_WINMODE
    #[inline(always)]
    pub fn comp1_winmode(&mut self) -> COMP1_WINMODE_W<'_, COMP1_CSRrs> {
        COMP1_WINMODE_W::new(self, 11)
    }
    ///Bit 14 - COMP1_WINOUT
    #[inline(always)]
    pub fn comp1_winout(&mut self) -> COMP1_WINOUT_W<'_, COMP1_CSRrs> {
    ...
    ///Bits 20:24 - COMP1_BLANKSEL
    #[inline(always)]
    pub fn comp1_blanksel(&mut self) -> COMP1_BLANKSEL_W<'_, COMP1_CSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#COMP:COMP1_CSR)*/
