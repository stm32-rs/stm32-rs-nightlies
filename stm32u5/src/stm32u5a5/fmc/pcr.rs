...
#[doc = "Field `PBKEN` reader - NAND Flash memory bank enable bit"]
pub type PBKEN_R = crate::BitReader;
#[doc = "Field `PBKEN` writer - NAND Flash memory bank enable bit"]
...
#[doc = "Field `PWID` reader - Data bus width"]
pub type PWID_R = crate::FieldReader;
#[doc = "Field `PWID` writer - Data bus width"]
...
impl R {
    ...
    #[doc = "Bit 2 - NAND Flash memory bank enable bit"]
    #[inline(always)]
    ...
    #[doc = "Bits 13:15 - ALE to RE delay"]
    #[inline(always)]
