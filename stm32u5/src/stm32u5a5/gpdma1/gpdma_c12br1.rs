#[doc = "Register `GPDMA_C12BR1` reader"]
pub type R = crate::R<GPDMA_C12BR1rs>;
#[doc = "Register `GPDMA_C12BR1` writer"]
...
#[doc = "GPDMA channel x block register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpdma_c12br1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpdma_c12br1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPDMA_C12BR1rs;
impl crate::RegisterSpec for GPDMA_C12BR1rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpdma_c12br1::R`](R) reader structure"]
impl crate::Readable for GPDMA_C12BR1rs {}
#[doc = "`write(|w| ..)` method takes [`gpdma_c12br1::W`](W) writer structure"]
impl crate::Writable for GPDMA_C12BR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPDMA_C12BR1 to value 0"]
