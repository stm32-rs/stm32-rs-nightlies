///Register `GPDMA_C13BR1` reader
pub type R = crate::R<GPDMA_C13BR1rs>;
///Register `GPDMA_C13BR1` writer
pub type W = crate::W<GPDMA_C13BR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bndt(&mut self) -> BNDT_W<GPDMA_C13BR1rs> {
        BNDT_W::new(self, 0)
    }
    ///Bits 16:26 - BRC
    #[inline(always)]
    #[must_use]
    pub fn brc(&mut self) -> BRC_W<GPDMA_C13BR1rs> {
        BRC_W::new(self, 16)
    }
    ///Bit 28 - SDEC
    #[inline(always)]
    #[must_use]
    pub fn sdec(&mut self) -> SDEC_W<GPDMA_C13BR1rs> {
        SDEC_W::new(self, 28)
    }
    ///Bit 29 - DDEC
    #[inline(always)]
    #[must_use]
    pub fn ddec(&mut self) -> DDEC_W<GPDMA_C13BR1rs> {
        DDEC_W::new(self, 29)
    }
    ///Bit 30 - BRSDEC
    #[inline(always)]
    #[must_use]
    pub fn brsdec(&mut self) -> BRSDEC_W<GPDMA_C13BR1rs> {
        BRSDEC_W::new(self, 30)
    }
    ///Bit 31 - BRDDEC
    #[inline(always)]
    #[must_use]
    pub fn brddec(&mut self) -> BRDDEC_W<GPDMA_C13BR1rs> {
        BRDDEC_W::new(self, 31)
    }
}
/**GPDMA channel x block register 1

You can [`read`](crate::Reg::read) this register and get [`gpdma_c13br1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c13br1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#GPDMA1:GPDMA_C13BR1)*/
pub struct GPDMA_C13BR1rs;
impl crate::RegisterSpec for GPDMA_C13BR1rs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c13br1::R`](R) reader structure
impl crate::Readable for GPDMA_C13BR1rs {}
///`write(|w| ..)` method takes [`gpdma_c13br1::W`](W) writer structure
impl crate::Writable for GPDMA_C13BR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C13BR1 to value 0
impl crate::Resettable for GPDMA_C13BR1rs {
