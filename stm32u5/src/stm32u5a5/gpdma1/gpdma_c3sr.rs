///Register `GPDMA_C3SR` reader
pub type R = crate::R<GPDMA_C3SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c3sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#GPDMA1:GPDMA_C3SR)*/
pub struct GPDMA_C3SRrs;
impl crate::RegisterSpec for GPDMA_C3SRrs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c3sr::R`](R) reader structure
impl crate::Readable for GPDMA_C3SRrs {}
///`reset()` method sets GPDMA_C3SR to value 0x01
impl crate::Resettable for GPDMA_C3SRrs {
