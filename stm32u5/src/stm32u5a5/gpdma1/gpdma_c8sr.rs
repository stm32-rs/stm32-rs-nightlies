...
You can [`read`](crate::Reg::read) this register and get [`gpdma_c8sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`gpdma_c8sr::R`](R) reader structure
impl crate::Readable for GPDMA_C8SRrs {}
///`reset()` method sets GPDMA_C8SR to value 0x01
