///Register `GPIO_OSPEEDR` reader
pub type R = crate::R<GPIO_OSPEEDRrs>;
///Register `GPIO_OSPEEDR` writer
...
You can [`read`](crate::Reg::read) this register and get [`gpio_ospeedr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio_ospeedr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#GPIOA:GPIO_OSPEEDR)*/
pub struct GPIO_OSPEEDRrs;
impl crate::RegisterSpec for GPIO_OSPEEDRrs {
    type Ux = u32;
}
///`read()` method returns [`gpio_ospeedr::R`](R) reader structure
impl crate::Readable for GPIO_OSPEEDRrs {}
///`write(|w| ..)` method takes [`gpio_ospeedr::W`](W) writer structure
impl crate::Writable for GPIO_OSPEEDRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO_OSPEEDR to value 0x0c00_0000
