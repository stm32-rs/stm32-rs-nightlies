///Register `MPCBB1_PRIVCFGR2` reader
pub type R = crate::R<MPCBB1_PRIVCFGR2rs>;
///Register `MPCBB1_PRIVCFGR2` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB1_PRIVCFGR2")
...
You can [`read`](crate::Reg::read) this register and get [`mpcbb1_privcfgr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb1_privcfgr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mpcbb1_privcfgr2::R`](R) reader structure
impl crate::Readable for MPCBB1_PRIVCFGR2rs {}
///`write(|w| ..)` method takes [`mpcbb1_privcfgr2::W`](W) writer structure
impl crate::Writable for MPCBB1_PRIVCFGR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB1_PRIVCFGR2 to value 0xffff_ffff
