///Register `MPCBB3_SECCFGR40` reader
pub type R = crate::R<MPCBB3_SECCFGR40rs>;
///Register `MPCBB3_SECCFGR40` writer
pub type W = crate::W<MPCBB3_SECCFGR40rs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB3_SECCFGR40")
...
impl W {
    ///Bit 0 - SEC0
    #[inline(always)]
    pub fn sec0(&mut self) -> SEC0_W<MPCBB3_SECCFGR40rs> {
        SEC0_W::new(self, 0)
    }
    ///Bit 1 - SEC1
    #[inline(always)]
    pub fn sec1(&mut self) -> SEC1_W<MPCBB3_SECCFGR40rs> {
        SEC1_W::new(self, 1)
    }
    ///Bit 2 - SEC2
    #[inline(always)]
    pub fn sec2(&mut self) -> SEC2_W<MPCBB3_SECCFGR40rs> {
        SEC2_W::new(self, 2)
    }
    ///Bit 3 - SEC3
    #[inline(always)]
    pub fn sec3(&mut self) -> SEC3_W<MPCBB3_SECCFGR40rs> {
        SEC3_W::new(self, 3)
    }
    ///Bit 4 - SEC4
    #[inline(always)]
    pub fn sec4(&mut self) -> SEC4_W<MPCBB3_SECCFGR40rs> {
        SEC4_W::new(self, 4)
    }
    ///Bit 5 - SEC5
    #[inline(always)]
    pub fn sec5(&mut self) -> SEC5_W<MPCBB3_SECCFGR40rs> {
        SEC5_W::new(self, 5)
    }
    ///Bit 6 - SEC6
    #[inline(always)]
    pub fn sec6(&mut self) -> SEC6_W<MPCBB3_SECCFGR40rs> {
        SEC6_W::new(self, 6)
    }
    ///Bit 7 - SEC7
    #[inline(always)]
    pub fn sec7(&mut self) -> SEC7_W<MPCBB3_SECCFGR40rs> {
        SEC7_W::new(self, 7)
    }
    ///Bit 8 - SEC8
    #[inline(always)]
    pub fn sec8(&mut self) -> SEC8_W<MPCBB3_SECCFGR40rs> {
        SEC8_W::new(self, 8)
    }
    ///Bit 9 - SEC9
    #[inline(always)]
    pub fn sec9(&mut self) -> SEC9_W<MPCBB3_SECCFGR40rs> {
        SEC9_W::new(self, 9)
    }
    ///Bit 10 - SEC10
    #[inline(always)]
    pub fn sec10(&mut self) -> SEC10_W<MPCBB3_SECCFGR40rs> {
        SEC10_W::new(self, 10)
    }
    ///Bit 11 - SEC11
    #[inline(always)]
    pub fn sec11(&mut self) -> SEC11_W<MPCBB3_SECCFGR40rs> {
        SEC11_W::new(self, 11)
    }
    ///Bit 12 - SEC12
    #[inline(always)]
    pub fn sec12(&mut self) -> SEC12_W<MPCBB3_SECCFGR40rs> {
        SEC12_W::new(self, 12)
    }
    ///Bit 13 - SEC13
    #[inline(always)]
    pub fn sec13(&mut self) -> SEC13_W<MPCBB3_SECCFGR40rs> {
        SEC13_W::new(self, 13)
    }
    ///Bit 14 - SEC14
    #[inline(always)]
    pub fn sec14(&mut self) -> SEC14_W<MPCBB3_SECCFGR40rs> {
        SEC14_W::new(self, 14)
    }
    ///Bit 15 - SEC15
    #[inline(always)]
    pub fn sec15(&mut self) -> SEC15_W<MPCBB3_SECCFGR40rs> {
        SEC15_W::new(self, 15)
    }
    ///Bit 16 - SEC16
    #[inline(always)]
    pub fn sec16(&mut self) -> SEC16_W<MPCBB3_SECCFGR40rs> {
        SEC16_W::new(self, 16)
    }
    ///Bit 17 - SEC17
    #[inline(always)]
    pub fn sec17(&mut self) -> SEC17_W<MPCBB3_SECCFGR40rs> {
        SEC17_W::new(self, 17)
    }
    ///Bit 18 - SEC18
    #[inline(always)]
    pub fn sec18(&mut self) -> SEC18_W<MPCBB3_SECCFGR40rs> {
        SEC18_W::new(self, 18)
    }
    ///Bit 19 - SEC19
    #[inline(always)]
    pub fn sec19(&mut self) -> SEC19_W<MPCBB3_SECCFGR40rs> {
        SEC19_W::new(self, 19)
    }
    ///Bit 20 - SEC20
    #[inline(always)]
    pub fn sec20(&mut self) -> SEC20_W<MPCBB3_SECCFGR40rs> {
        SEC20_W::new(self, 20)
    }
    ///Bit 21 - SEC21
    #[inline(always)]
    pub fn sec21(&mut self) -> SEC21_W<MPCBB3_SECCFGR40rs> {
        SEC21_W::new(self, 21)
    }
    ///Bit 22 - SEC22
    #[inline(always)]
    pub fn sec22(&mut self) -> SEC22_W<MPCBB3_SECCFGR40rs> {
        SEC22_W::new(self, 22)
    }
    ///Bit 23 - SEC23
    #[inline(always)]
    pub fn sec23(&mut self) -> SEC23_W<MPCBB3_SECCFGR40rs> {
        SEC23_W::new(self, 23)
    }
    ///Bit 24 - SEC24
    #[inline(always)]
    pub fn sec24(&mut self) -> SEC24_W<MPCBB3_SECCFGR40rs> {
        SEC24_W::new(self, 24)
    }
    ///Bit 25 - SEC25
    #[inline(always)]
    pub fn sec25(&mut self) -> SEC25_W<MPCBB3_SECCFGR40rs> {
        SEC25_W::new(self, 25)
    }
    ///Bit 26 - SEC26
    #[inline(always)]
    pub fn sec26(&mut self) -> SEC26_W<MPCBB3_SECCFGR40rs> {
        SEC26_W::new(self, 26)
    }
    ///Bit 27 - SEC27
    #[inline(always)]
    pub fn sec27(&mut self) -> SEC27_W<MPCBB3_SECCFGR40rs> {
        SEC27_W::new(self, 27)
    }
    ///Bit 28 - SEC28
    #[inline(always)]
    pub fn sec28(&mut self) -> SEC28_W<MPCBB3_SECCFGR40rs> {
        SEC28_W::new(self, 28)
    }
    ///Bit 29 - SEC29
    #[inline(always)]
    pub fn sec29(&mut self) -> SEC29_W<MPCBB3_SECCFGR40rs> {
        SEC29_W::new(self, 29)
    }
    ///Bit 30 - SEC30
    #[inline(always)]
    pub fn sec30(&mut self) -> SEC30_W<MPCBB3_SECCFGR40rs> {
        SEC30_W::new(self, 30)
    }
    ///Bit 31 - SEC31
    #[inline(always)]
    pub fn sec31(&mut self) -> SEC31_W<MPCBB3_SECCFGR40rs> {
        SEC31_W::new(self, 31)
    }
}
/**MPCBBx security configuration for super-block x register

You can [`read`](crate::Reg::read) this register and get [`mpcbb3_seccfgr40::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb3_seccfgr40::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#GTZC1_MPCBB3:MPCBB3_SECCFGR40)*/
pub struct MPCBB3_SECCFGR40rs;
impl crate::RegisterSpec for MPCBB3_SECCFGR40rs {
    type Ux = u32;
}
///`read()` method returns [`mpcbb3_seccfgr40::R`](R) reader structure
impl crate::Readable for MPCBB3_SECCFGR40rs {}
///`write(|w| ..)` method takes [`mpcbb3_seccfgr40::W`](W) writer structure
impl crate::Writable for MPCBB3_SECCFGR40rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB3_SECCFGR40 to value 0xffff_ffff
impl crate::Resettable for MPCBB3_SECCFGR40rs {
