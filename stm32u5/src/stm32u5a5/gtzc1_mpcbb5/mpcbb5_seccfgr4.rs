///Register `MPCBB5_SECCFGR4` reader
pub type R = crate::R<MPCBB5_SECCFGR4rs>;
///Register `MPCBB5_SECCFGR4` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB5_SECCFGR4")
...
///`read()` method returns [`mpcbb5_seccfgr4::R`](R) reader structure
impl crate::Readable for MPCBB5_SECCFGR4rs {}
///`write(|w| ..)` method takes [`mpcbb5_seccfgr4::W`](W) writer structure
impl crate::Writable for MPCBB5_SECCFGR4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB5_SECCFGR4 to value 0xffff_ffff
