///Register `MPCBB5_SECCFGR43` reader
pub type R = crate::R<MPCBB5_SECCFGR43rs>;
///Register `MPCBB5_SECCFGR43` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MPCBB5_SECCFGR43")
...
You can [`read`](crate::Reg::read) this register and get [`mpcbb5_seccfgr43::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpcbb5_seccfgr43::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`mpcbb5_seccfgr43::R`](R) reader structure
impl crate::Readable for MPCBB5_SECCFGR43rs {}
///`write(|w| ..)` method takes [`mpcbb5_seccfgr43::W`](W) writer structure
impl crate::Writable for MPCBB5_SECCFGR43rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MPCBB5_SECCFGR43 to value 0xffff_ffff
