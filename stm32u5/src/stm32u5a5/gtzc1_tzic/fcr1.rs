...
impl W {
    ...
    #[inline(always)]
    pub fn ci2c4f(&mut self) -> CI2C4F_W<'_, FCR1rs> {
    ...
    #[inline(always)]
    pub fn cfdcan1f(&mut self) -> CFDCAN1F_W<'_, FCR1rs> {
        CFDCAN1F_W::new(self, 18)
    }
    ///Bit 19 - clear the illegal access flag for UCPD1
    #[inline(always)]
    pub fn cucpd1f(&mut self) -> CUCPD1F_W<'_, FCR1rs> {
    ...
    #[inline(always)]
    pub fn ci2c5f(&mut self) -> CI2C5F_W<'_, FCR1rs> {
        CI2C5F_W::new(self, 22)
    }
    ///Bit 23 - clear the illegal access flag for I2C6
    #[inline(always)]
    pub fn ci2c6f(&mut self) -> CI2C6F_W<'_, FCR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#GTZC1_TZIC:FCR1)*/
pub struct FCR1rs;
