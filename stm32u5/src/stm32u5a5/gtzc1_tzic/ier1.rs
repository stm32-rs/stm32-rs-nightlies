...
impl W {
    ...
    ///Bit 11 - illegal access interrupt enable for UART4
    #[inline(always)]
    pub fn usart4ie(&mut self) -> USART4IE_W<'_, IER1rs> {
    ...
    ///Bit 22 - illegal access interrupt enable for I2C5
    #[inline(always)]
    pub fn i2c5ie(&mut self) -> I2C5IE_W<'_, IER1rs> {
        I2C5IE_W::new(self, 22)
    }
    ///Bit 23 - illegal access interrupt enable for I2C6
    #[inline(always)]
    pub fn i2c6ie(&mut self) -> I2C6IE_W<'_, IER1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#GTZC1_TZIC:IER1)*/
pub struct IER1rs;
