...
///Field `OTGIE` reader - illegal access interrupt enable for OTG_FS or OTG_HS
pub type OTGIE_R = crate::BitReader;
///Field `OTGIE` writer - illegal access interrupt enable for OTG_FS or OTG_HS
...
///Field `FSMC_REGIE` reader - illegal access interrupt enable for FSMC registers
pub type FSMC_REGIE_R = crate::BitReader;
///Field `FSMC_REGIE` writer - illegal access interrupt enable for FSMC registers
...
///Field `OCTOSPI2_REGIE` reader - illegal access interrupt enable for OCTOSPI2 registers
pub type OCTOSPI2_REGIE_R = crate::BitReader;
///Field `OCTOSPI2_REGIE` writer - illegal access interrupt enable for OCTOSPI2 registers
...
impl R {
    ...
    ///Bit 10 - illegal access interrupt enable for OTG_FS or OTG_HS
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IER3")
            ...
            .field("fsmc_regie", &self.fsmc_regie())
            .field("octospi1_regie", &self.octospi1_regie())
            .field("octospi2_regie", &self.octospi2_regie())
...
impl W {
    ///Bit 0 - illegal access interrupt enable for MDF1
    #[inline(always)]
    pub fn mdf1ie(&mut self) -> MDF1IE_W<'_, IER3rs> {
        MDF1IE_W::new(self, 0)
    }
    ///Bit 1 - illegal access interrupt enable for CORDIC
    #[inline(always)]
    ...
    ///Bit 5 - illegal access interrupt enable for register of DMA2D
    #[inline(always)]
    pub fn dma2die(&mut self) -> DMA2DIE_W<'_, IER3rs> {
        DMA2DIE_W::new(self, 5)
    }
    ///Bit 6 - illegal access interrupt enable for ICACHE registers
    #[inline(always)]
    pub fn icache_regie(&mut self) -> ICACHE_REGIE_W<'_, IER3rs> {
        ICACHE_REGIE_W::new(self, 6)
    }
    ///Bit 7 - illegal access interrupt enable for DCACHE registers
    #[inline(always)]
    pub fn dcache1_regie(&mut self) -> DCACHE1_REGIE_W<'_, IER3rs> {
        DCACHE1_REGIE_W::new(self, 7)
    }
    ///Bit 8 - illegal access interrupt enable for ADC1 or ADC2
    #[inline(always)]
    pub fn adc1i2e(&mut self) -> ADC1I2E_W<'_, IER3rs> {
    ...
    ///Bit 10 - illegal access interrupt enable for OTG_FS or OTG_HS
    #[inline(always)]
    pub fn otgie(&mut self) -> OTGIE_W<'_, IER3rs> {
        OTGIE_W::new(self, 10)
    }
    ///Bit 11 - illegal access interrupt enable for AES
    #[inline(always)]
    ...
    ///Bit 16 - illegal access interrupt enable for OCTOSPIM
    #[inline(always)]
    pub fn octospimie(&mut self) -> OCTOSPIMIE_W<'_, IER3rs> {
    ...
    ///Bit 18 - illegal access interrupt enable for SDMMC1
    #[inline(always)]
    pub fn sdmmc2ie(&mut self) -> SDMMC2IE_W<'_, IER3rs> {
        SDMMC2IE_W::new(self, 18)
    }
    ///Bit 19 - illegal access interrupt enable for FSMC registers
    #[inline(always)]
    pub fn fsmc_regie(&mut self) -> FSMC_REGIE_W<'_, IER3rs> {
        FSMC_REGIE_W::new(self, 19)
    }
    ///Bit 20 - illegal access interrupt enable for OCTOSPI1 registers
    #[inline(always)]
    pub fn octospi1_regie(&mut self) -> OCTOSPI1_REGIE_W<'_, IER3rs> {
        OCTOSPI1_REGIE_W::new(self, 20)
    }
    ///Bit 21 - illegal access interrupt enable for OCTOSPI2 registers
    #[inline(always)]
    pub fn octospi2_regie(&mut self) -> OCTOSPI2_REGIE_W<'_, IER3rs> {
    ...
    ///Bit 26 - HSPI1_REGIE
    #[inline(always)]
    pub fn hspi1_regie(&mut self) -> HSPI1_REGIE_W<'_, IER3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#GTZC1_TZIC:IER3)*/
pub struct IER3rs;
