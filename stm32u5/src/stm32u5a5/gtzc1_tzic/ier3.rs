...
#[doc = "Field `OTGIE` reader - illegal access interrupt enable for OTG_FS or OTG_HS"]
pub type OTGIE_R = crate::BitReader;
#[doc = "Field `OTGIE` writer - illegal access interrupt enable for OTG_FS or OTG_HS"]
...
#[doc = "Field `FSMC_REGIE` reader - illegal access interrupt enable for FSMC registers"]
pub type FSMC_REGIE_R = crate::BitReader;
#[doc = "Field `FSMC_REGIE` writer - illegal access interrupt enable for FSMC registers"]
pub type FSMC_REGIE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `OCTOSPI2_REGIE` reader - illegal access interrupt enable for OCTOSPI2 registers"]
pub type OCTOSPI2_REGIE_R = crate::BitReader;
#[doc = "Field `OCTOSPI2_REGIE` writer - illegal access interrupt enable for OCTOSPI2 registers"]
pub type OCTOSPI2_REGIE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 10 - illegal access interrupt enable for OTG_FS or OTG_HS"]
    #[inline(always)]
    pub fn otgie(&self) -> OTGIE_R {
        OTGIE_R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn fsmc_regie(&self) -> FSMC_REGIE_R {
        FSMC_REGIE_R::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn octospi2_regie(&self) -> OCTOSPI2_REGIE_R {
        OCTOSPI2_REGIE_R::new(((self.bits >> 21) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn otgie(&mut self) -> OTGIE_W<IER3rs> {
        OTGIE_W::new(self, 10)
    }
    #[doc = "Bit 11 - illegal access interrupt enable for AES"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsmc_regie(&mut self) -> FSMC_REGIE_W<IER3rs> {
        FSMC_REGIE_W::new(self, 19)
    }
    #[doc = "Bit 20 - illegal access interrupt enable for OCTOSPI1 registers"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn octospi2_regie(&mut self) -> OCTOSPI2_REGIE_W<IER3rs> {
        OCTOSPI2_REGIE_W::new(self, 21)
    }
    #[doc = "Bit 22 - illegal access interrupt enable for RAMCFG"]
    #[inline(always)]
    #[must_use]
