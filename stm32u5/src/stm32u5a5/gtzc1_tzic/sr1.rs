...
#[doc = "Field `UCPD1F` reader - illegal access flag for UCPD1"]
...
#[doc = "Field `I2C5F` reader - illegal access flag for I2C5"]
pub type I2C5F_R = crate::BitReader;
#[doc = "Field `I2C6F` reader - illegal access flag for I2C6"]
...
impl R {
    ...
    #[doc = "Bit 22 - illegal access flag for I2C5"]
    #[inline(always)]
    pub fn i2c5f(&self) -> I2C5F_R {
        I2C5F_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - illegal access flag for I2C6"]
    #[inline(always)]
