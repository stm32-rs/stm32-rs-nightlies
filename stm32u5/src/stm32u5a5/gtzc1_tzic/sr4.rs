...
#[doc = "Field `HSPI1_MEMF` reader - illegal access flag for HSPI1 memory bank"]
...
#[doc = "Field `SRAM5F` reader - illegal access flag for SRAM5"]
pub type SRAM5F_R = crate::BitReader;
#[doc = "Field `MPCBB5_REGF` reader - illegal access flag for MPCBB5 registers"]
...
impl R {
    ...
    #[doc = "Bit 20 - illegal access flag for HSPI1 memory bank"]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - illegal access flag for SRAM5"]
    #[inline(always)]
    pub fn sram5f(&self) -> SRAM5F_R {
        SRAM5F_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - illegal access flag for MPCBB5 registers"]
    #[inline(always)]
