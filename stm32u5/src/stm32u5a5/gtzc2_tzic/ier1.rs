...
impl W {
    ...
    ///Bit 5 - illegal access interrupt enable for LPTIM4
    #[inline(always)]
    pub fn lptim4ie(&mut self) -> LPTIM4IE_W<'_, IER1rs> {
    ...
    ///Bit 8 - illegal access interrupt enable for ADC2
    #[inline(always)]
    pub fn adc2ie(&mut self) -> ADC2IE_W<'_, IER1rs> {
        ADC2IE_W::new(self, 8)
    }
    ///Bit 9 - illegal access interrupt enable for VREFBUF
    #[inline(always)]
    ...
    ///Bit 12 - illegal access interrupt enable for ADF1
    #[inline(always)]
    pub fn adf1ie(&mut self) -> ADF1IE_W<'_, IER1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#GTZC2_TZIC:IER1)*/
pub struct IER1rs;
