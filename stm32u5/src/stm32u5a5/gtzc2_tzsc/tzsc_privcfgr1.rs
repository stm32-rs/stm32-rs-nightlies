...
impl W {
    ...
    ///Bit 1 - privileged access mode for LPUART1
    #[inline(always)]
    pub fn lpuart1priv(&mut self) -> LPUART1PRIV_W<'_, TZSC_PRIVCFGR1rs> {
        LPUART1PRIV_W::new(self, 1)
    }
    ///Bit 2 - privileged access mode for I2C3
    #[inline(always)]
    pub fn i2c3priv(&mut self) -> I2C3PRIV_W<'_, TZSC_PRIVCFGR1rs> {
        I2C3PRIV_W::new(self, 2)
    }
    ///Bit 3 - privileged access mode for LPTIM1
    #[inline(always)]
    pub fn lptim1priv(&mut self) -> LPTIM1PRIV_W<'_, TZSC_PRIVCFGR1rs> {
        LPTIM1PRIV_W::new(self, 3)
    }
    ///Bit 4 - privileged access mode for LPTIM3
    #[inline(always)]
    pub fn lptim3priv(&mut self) -> LPTIM3PRIV_W<'_, TZSC_PRIVCFGR1rs> {
        LPTIM3PRIV_W::new(self, 4)
    }
    ///Bit 5 - privileged access mode for LPTIM4
    #[inline(always)]
    pub fn lptim4priv(&mut self) -> LPTIM4PRIV_W<'_, TZSC_PRIVCFGR1rs> {
        LPTIM4PRIV_W::new(self, 5)
    }
    ///Bit 6 - privileged access mode for OPAMP
    #[inline(always)]
    pub fn opamppriv(&mut self) -> OPAMPPRIV_W<'_, TZSC_PRIVCFGR1rs> {
        OPAMPPRIV_W::new(self, 6)
    }
    ///Bit 7 - privileged access mode for COMP
    #[inline(always)]
    pub fn comppriv(&mut self) -> COMPPRIV_W<'_, TZSC_PRIVCFGR1rs> {
        COMPPRIV_W::new(self, 7)
    }
    ///Bit 8 - privileged access mode for ADC2
    #[inline(always)]
    pub fn adc2priv(&mut self) -> ADC2PRIV_W<'_, TZSC_PRIVCFGR1rs> {
        ADC2PRIV_W::new(self, 8)
    }
    ///Bit 9 - privileged access mode for VREFBUF
    #[inline(always)]
    pub fn vrefbufpriv(&mut self) -> VREFBUFPRIV_W<'_, TZSC_PRIVCFGR1rs> {
    ...
    ///Bit 12 - privileged access mode for ADF1
    #[inline(always)]
    pub fn adf1priv(&mut self) -> ADF1PRIV_W<'_, TZSC_PRIVCFGR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#GTZC2_TZSC:TZSC_PRIVCFGR1)*/
