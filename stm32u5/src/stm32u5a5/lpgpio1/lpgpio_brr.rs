#[doc = "Register `LPGPIO_BRR` writer"]
...
#[doc = "LPGPIO port bit reset register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpgpio_brr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LPGPIO_BRRrs;
impl crate::RegisterSpec for LPGPIO_BRRrs {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`lpgpio_brr::W`](W) writer structure"]
