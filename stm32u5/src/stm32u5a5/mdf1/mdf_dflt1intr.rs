///Register `MDF_DFLT1INTR` reader
pub type R = crate::R<MDF_DFLT1INTRrs>;
///Register `MDF_DFLT1INTR` writer
pub type W = crate::W<MDF_DFLT1INTRrs>;
...
impl W {
    ///Bits 0:1 - Integrator output division Set and cleared by software. This bit is used to rescale the signal at the integrator output in order keep the data width lower than 24 bits. - 00: The integrator data outputs are divided by 128 (Default value) - 01: The integrator data outputs are divided by 32 - 10: The integrator data outputs are divided by 4 - 11: The integrator data outputs are not divided This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
    #[inline(always)]
    pub fn intdiv(&mut self) -> INTDIV_W<MDF_DFLT1INTRrs> {
        INTDIV_W::new(self, 0)
    }
    ///Bits 4:10 - Integration value selection Set and cleared by software. This field is used to select the integration value. - 0: The integration value is 1, meaning bypass mode (default after reset) - 1: The integration value is 2 - 2: The integration value is 3 ... - 127: The integration value is 128 This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
    #[inline(always)]
    pub fn intval(&mut self) -> INTVAL_W<MDF_DFLT1INTRrs> {
        INTVAL_W::new(self, 4)
    }
}
/**This register is used to the integrator (INT) settings.

You can [`read`](crate::Reg::read) this register and get [`mdf_dflt1intr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_dflt1intr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#MDF1:MDF_DFLT1INTR)*/
pub struct MDF_DFLT1INTRrs;
impl crate::RegisterSpec for MDF_DFLT1INTRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_dflt1intr::R`](R) reader structure
impl crate::Readable for MDF_DFLT1INTRrs {}
///`write(|w| ..)` method takes [`mdf_dflt1intr::W`](W) writer structure
impl crate::Writable for MDF_DFLT1INTRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_DFLT1INTR to value 0
impl crate::Resettable for MDF_DFLT1INTRrs {
