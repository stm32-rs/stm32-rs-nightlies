///Register `MDF_DFLT2CICR` reader
pub type R = crate::R<MDF_DFLT2CICRrs>;
///Register `MDF_DFLT2CICR` writer
...
You can [`read`](crate::Reg::read) this register and get [`mdf_dflt2cicr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_dflt2cicr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#MDF1:MDF_DFLT2CICR)*/
pub struct MDF_DFLT2CICRrs;
impl crate::RegisterSpec for MDF_DFLT2CICRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_dflt2cicr::R`](R) reader structure
impl crate::Readable for MDF_DFLT2CICRrs {}
///`write(|w| ..)` method takes [`mdf_dflt2cicr::W`](W) writer structure
impl crate::Writable for MDF_DFLT2CICRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_DFLT2CICR to value 0
