///Register `MDF_DFLT2ISR` reader
pub type R = crate::R<MDF_DFLT2ISRrs>;
///Register `MDF_DFLT2ISR` writer
pub type W = crate::W<MDF_DFLT2ISRrs>;
///Field `FTHF` reader - RXFIFO threshold flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that the RXFIFO threshold is not reached, writing 0 has no effect. - 1: Reading 1 means that the RXFIFO reached the threshold, writing 1 clears this flag.
...
///Field `SSDRF` reader - Snapshot data ready flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no data is available on MDF_SNPSxDR, writing 0 has no effect. - 1: Reading 1 means that a new data is available on MDF_SNPSxDR, writing 1 clears this flag.
pub type SSDRF_R = crate::BitReader;
///Field `SSDRF` writer - Snapshot data ready flag Set by hardware, and cleared by software by writing this bit to 1 . - 0: Reading 0 means that no data is available on MDF_SNPSxDR, writing 0 has no effect. - 1: Reading 1 means that a new data is available on MDF_SNPSxDR, writing 1 clears this flag.
...
You can [`read`](crate::Reg::read) this register and get [`mdf_dflt2isr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_dflt2isr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#MDF1:MDF_DFLT2ISR)*/
pub struct MDF_DFLT2ISRrs;
impl crate::RegisterSpec for MDF_DFLT2ISRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_dflt2isr::R`](R) reader structure
impl crate::Readable for MDF_DFLT2ISRrs {}
///`write(|w| ..)` method takes [`mdf_dflt2isr::W`](W) writer structure
impl crate::Writable for MDF_DFLT2ISRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_DFLT2ISR to value 0
