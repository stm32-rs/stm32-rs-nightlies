///Register `MDF_SCD0CR` reader
pub type R = crate::R<MDF_SCD0CRrs>;
///Register `MDF_SCD0CR` writer
...
You can [`read`](crate::Reg::read) this register and get [`mdf_scd0cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_scd0cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#MDF1:MDF_SCD0CR)*/
pub struct MDF_SCD0CRrs;
impl crate::RegisterSpec for MDF_SCD0CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_scd0cr::R`](R) reader structure
impl crate::Readable for MDF_SCD0CRrs {}
///`write(|w| ..)` method takes [`mdf_scd0cr::W`](W) writer structure
impl crate::Writable for MDF_SCD0CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_SCD0CR to value 0
