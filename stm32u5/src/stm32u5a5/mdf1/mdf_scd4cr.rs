///Register `MDF_SCD4CR` reader
pub type R = crate::R<MDF_SCD4CRrs>;
///Register `MDF_SCD4CR` writer
pub type W = crate::W<MDF_SCD4CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scden(&mut self) -> SCDEN_W<MDF_SCD4CRrs> {
        SCDEN_W::new(self, 0)
    }
    /**Bits 4:7 - Break signal assignment for short circuit detector Set and cleared by software. BKSCD\[i\]
    = 0: Break signal (mdf_break\[i\]) is not assigned to this SCD event BKSCD\[i\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkscd(&mut self) -> BKSCD_W<MDF_SCD4CRrs> {
        BKSCD_W::new(self, 4)
    }
    ///Bits 12:19 - Short-circuit detector threshold Set and cleared by software. These bits are written by software to define the threshold counter for the short-circuit detector. If this value is reached, then a short-circuit detector event occurs on a given input stream. - 0: 2 consecutive 1 s or 0 s will generate an event, - 1: 2 consecutive 1 s or 0 s will generate an event - 2: 3 consecutive 1 s or 0 s will generate an event, ... - 255: 256 consecutive 1 s or 0 s will generate an event, This field can be write-protected, please refer to Section 1.4.15: Register protection for details.
    #[inline(always)]
    #[must_use]
    pub fn scdt(&mut self) -> SCDT_W<MDF_SCD4CRrs> {
        SCDT_W::new(self, 12)
    }
}
/**This register is used for the adjustment stream delays.

You can [`read`](crate::Reg::read) this register and get [`mdf_scd4cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_scd4cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#MDF1:MDF_SCD4CR)*/
pub struct MDF_SCD4CRrs;
impl crate::RegisterSpec for MDF_SCD4CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_scd4cr::R`](R) reader structure
impl crate::Readable for MDF_SCD4CRrs {}
///`write(|w| ..)` method takes [`mdf_scd4cr::W`](W) writer structure
impl crate::Writable for MDF_SCD4CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_SCD4CR to value 0
impl crate::Resettable for MDF_SCD4CRrs {
