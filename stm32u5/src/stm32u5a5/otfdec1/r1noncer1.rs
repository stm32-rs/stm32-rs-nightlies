...
///Field `REG1_NONCE` reader - Region nonce
pub type REG1_NONCE_R = crate::FieldReader<u32>;
///Field `REG1_NONCE` writer - Region nonce
...
impl W {
    ///Bits 0:31 - Region nonce
    #[inline(always)]
    pub fn reg1_nonce(&mut self) -> REG1_NONCE_W<'_, R1NONCER1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#OTFDEC1:R1NONCER1)*/
