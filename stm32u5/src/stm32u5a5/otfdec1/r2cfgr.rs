...
///Field `REG2_VERSION` reader - region firmware version
pub type REG2_VERSION_R = crate::FieldReader<u16>;
///Field `REG2_VERSION` writer - region firmware version
pub type REG2_VERSION_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ...
    #[inline(always)]
    pub fn reg2_version(&self) -> REG2_VERSION_R {
        REG2_VERSION_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("R2CFGR")
            ...
            .field("reg2_version", &self.reg2_version())
            .finish()
    }
}
impl W {
    ...
    ///Bits 16:31 - region firmware version
    #[inline(always)]
    pub fn reg2_version(&mut self) -> REG2_VERSION_W<'_, R2CFGRrs> {
        REG2_VERSION_W::new(self, 16)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#OTFDEC1:R2CFGR)*/
pub struct R2CFGRrs;
