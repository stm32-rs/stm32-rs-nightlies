...
///Field `REG2_NONCE` reader - Region nonce, bits \[63:32\]REGx_NONCE\[63:32\]
pub type REG2_NONCE_R = crate::FieldReader<u32>;
///Field `REG2_NONCE` writer - Region nonce, bits \[63:32\]REGx_NONCE\[63:32\]
...
impl W {
    ///Bits 0:31 - Region nonce, bits \[63:32\]REGx_NONCE\[63:32\]
    #[inline(always)]
    pub fn reg2_nonce(&mut self) -> REG2_NONCE_W<'_, R2NONCER1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#OTFDEC1:R2NONCER1)*/
