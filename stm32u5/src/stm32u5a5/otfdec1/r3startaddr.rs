...
impl W {
    ///Bits 0:31 - Region AXI start address
    #[inline(always)]
    pub fn reg3_start_addr(&mut self) -> REG3_START_ADDR_W<'_, R3STARTADDRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#OTFDEC1:R3STARTADDR)*/
