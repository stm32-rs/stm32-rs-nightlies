...
pub type R = crate::R<HCCHAR11rs>;
#[doc = "Register `HCCHAR11` writer"]
pub type W = crate::W<HCCHAR11rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mpsiz(&mut self) -> MPSIZ_W<HCCHAR11rs> {
        MPSIZ_W::new(self, 0)
    }
    #[doc = "Bits 11:14 - EPNUM"]
    #[inline(always)]
    #[must_use]
    pub fn epnum(&mut self) -> EPNUM_W<HCCHAR11rs> {
        EPNUM_W::new(self, 11)
    }
    #[doc = "Bit 15 - EPDIR"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EPDIR_W<HCCHAR11rs> {
        EPDIR_W::new(self, 15)
    }
    #[doc = "Bit 17 - LSDEV"]
    #[inline(always)]
    #[must_use]
    pub fn lsdev(&mut self) -> LSDEV_W<HCCHAR11rs> {
        LSDEV_W::new(self, 17)
    }
    #[doc = "Bits 18:19 - EPTYP"]
    #[inline(always)]
    #[must_use]
    pub fn eptyp(&mut self) -> EPTYP_W<HCCHAR11rs> {
        EPTYP_W::new(self, 18)
    }
    #[doc = "Bits 20:21 - MCNT"]
    #[inline(always)]
    #[must_use]
    pub fn mcnt(&mut self) -> MCNT_W<HCCHAR11rs> {
        MCNT_W::new(self, 20)
    }
    #[doc = "Bits 22:28 - DAD"]
    #[inline(always)]
    #[must_use]
    pub fn dad(&mut self) -> DAD_W<HCCHAR11rs> {
        DAD_W::new(self, 22)
    }
    #[doc = "Bit 29 - ODDFRM"]
    #[inline(always)]
    #[must_use]
    pub fn oddfrm(&mut self) -> ODDFRM_W<HCCHAR11rs> {
        ODDFRM_W::new(self, 29)
    }
    #[doc = "Bit 30 - CHDIS"]
    #[inline(always)]
    #[must_use]
    pub fn chdis(&mut self) -> CHDIS_W<HCCHAR11rs> {
        CHDIS_W::new(self, 30)
    }
    #[doc = "Bit 31 - CHENA"]
    #[inline(always)]
    #[must_use]
    pub fn chena(&mut self) -> CHENA_W<HCCHAR11rs> {
        CHENA_W::new(self, 31)
    }
}
#[doc = "OTG host channel 11 characteristics register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hcchar11::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hcchar11::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCCHAR11rs;
impl crate::RegisterSpec for HCCHAR11rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcchar11::R`](R) reader structure"]
impl crate::Readable for HCCHAR11rs {}
#[doc = "`write(|w| ..)` method takes [`hcchar11::W`](W) writer structure"]
impl crate::Writable for HCCHAR11rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCCHAR11 to value 0"]
impl crate::Resettable for HCCHAR11rs {
