...
pub type R = crate::R<HCTSIZ10rs>;
#[doc = "Register `HCTSIZ10` writer"]
pub type W = crate::W<HCTSIZ10rs>;
...
#[doc = "Field `DOPNG` reader - DOPNG"]
pub type DOPNG_R = crate::BitReader;
#[doc = "Field `DOPNG` writer - DOPNG"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<HCTSIZ10rs> {
        XFRSIZ_W::new(self, 0)
    }
    #[doc = "Bits 19:28 - PKTCNT"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<HCTSIZ10rs> {
        PKTCNT_W::new(self, 19)
    }
    #[doc = "Bits 29:30 - DPID"]
    #[inline(always)]
    #[must_use]
    pub fn dpid(&mut self) -> DPID_W<HCTSIZ10rs> {
        DPID_W::new(self, 29)
    }
    #[doc = "Bit 31 - DOPNG"]
    #[inline(always)]
    #[must_use]
    pub fn dopng(&mut self) -> DOPNG_W<HCTSIZ10rs> {
        DOPNG_W::new(self, 31)
    }
}
#[doc = "OTG host channel 10 transfer size register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hctsiz10::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hctsiz10::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCTSIZ10rs;
impl crate::RegisterSpec for HCTSIZ10rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hctsiz10::R`](R) reader structure"]
impl crate::Readable for HCTSIZ10rs {}
#[doc = "`write(|w| ..)` method takes [`hctsiz10::W`](W) writer structure"]
impl crate::Writable for HCTSIZ10rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCTSIZ10 to value 0"]
impl crate::Resettable for HCTSIZ10rs {
