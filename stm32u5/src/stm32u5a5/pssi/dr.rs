...
impl W {
    ///Bits 0:7 - Data byte 0
    #[inline(always)]
    pub fn byte0(&mut self) -> BYTE0_W<'_, DRrs> {
        BYTE0_W::new(self, 0)
    }
    ///Bits 8:15 - Data byte 1
    #[inline(always)]
    pub fn byte1(&mut self) -> BYTE1_W<'_, DRrs> {
        BYTE1_W::new(self, 8)
    }
    ///Bits 16:23 - Data byte 2
    #[inline(always)]
    pub fn byte2(&mut self) -> BYTE2_W<'_, DRrs> {
        BYTE2_W::new(self, 16)
    }
    ///Bits 24:31 - Data byte 3
    #[inline(always)]
    pub fn byte3(&mut self) -> BYTE3_W<'_, DRrs> {
        BYTE3_W::new(self, 24)
    }
}
/**PSSI data register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#PSSI:DR)*/
pub struct DRrs;
