...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd7(&mut self) -> PD7_W<PWR_PDCRDrs> {
        PD7_W::new(self, 7)
    }
    ///Bit 8
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd14(&mut self) -> PD14_W<PWR_PDCRDrs> {
        PD14_W::new(self, 14)
    }
    ///Bit 15
    #[inline(always)]
    #[must_use]
    pub fn pd15(&mut self) -> PD15_W<PWR_PDCRDrs> {
        PD15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#PWR:PWR_PDCRD)*/
