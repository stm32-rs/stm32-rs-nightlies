///Register `PWR_PDCRH` reader
pub type R = crate::R<PWR_PDCRHrs>;
///Register `PWR_PDCRH` writer
pub type W = crate::W<PWR_PDCRHrs>;
///Field `PD0` reader -
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd0(&mut self) -> PD0_W<PWR_PDCRHrs> {
        PD0_W::new(self, 0)
    }
    ///Bit 1
    #[inline(always)]
    #[must_use]
    pub fn pd1(&mut self) -> PD1_W<PWR_PDCRHrs> {
        PD1_W::new(self, 1)
    }
    ///Bit 2
    #[inline(always)]
    #[must_use]
    pub fn pd2(&mut self) -> PD2_W<PWR_PDCRHrs> {
        PD2_W::new(self, 2)
    }
    ///Bit 3
    #[inline(always)]
    #[must_use]
    pub fn pd3(&mut self) -> PD3_W<PWR_PDCRHrs> {
        PD3_W::new(self, 3)
    }
    ///Bit 4
    #[inline(always)]
    #[must_use]
    pub fn pd4(&mut self) -> PD4_W<PWR_PDCRHrs> {
        PD4_W::new(self, 4)
    }
    ///Bit 5
    #[inline(always)]
    #[must_use]
    pub fn pd5(&mut self) -> PD5_W<PWR_PDCRHrs> {
        PD5_W::new(self, 5)
    }
    ///Bit 6
    #[inline(always)]
    #[must_use]
    pub fn pd6(&mut self) -> PD6_W<PWR_PDCRHrs> {
        PD6_W::new(self, 6)
    }
    ///Bit 7
    #[inline(always)]
    #[must_use]
    pub fn pd7(&mut self) -> PD7_W<PWR_PDCRHrs> {
        PD7_W::new(self, 7)
    }
    ///Bit 8
    #[inline(always)]
    #[must_use]
    pub fn pd8(&mut self) -> PD8_W<PWR_PDCRHrs> {
        PD8_W::new(self, 8)
    }
    ///Bit 9
    #[inline(always)]
    #[must_use]
    pub fn pd9(&mut self) -> PD9_W<PWR_PDCRHrs> {
        PD9_W::new(self, 9)
    }
    ///Bit 10
    #[inline(always)]
    #[must_use]
    pub fn pd10(&mut self) -> PD10_W<PWR_PDCRHrs> {
        PD10_W::new(self, 10)
    }
    ///Bit 11
    #[inline(always)]
    #[must_use]
    pub fn pd11(&mut self) -> PD11_W<PWR_PDCRHrs> {
        PD11_W::new(self, 11)
    }
    ///Bit 12
    #[inline(always)]
    #[must_use]
    pub fn pd12(&mut self) -> PD12_W<PWR_PDCRHrs> {
        PD12_W::new(self, 12)
    }
    ///Bit 13
    #[inline(always)]
    #[must_use]
    pub fn pd13(&mut self) -> PD13_W<PWR_PDCRHrs> {
        PD13_W::new(self, 13)
    }
    ///Bit 14
    #[inline(always)]
    #[must_use]
    pub fn pd14(&mut self) -> PD14_W<PWR_PDCRHrs> {
        PD14_W::new(self, 14)
    }
    ///Bit 15
    #[inline(always)]
    #[must_use]
    pub fn pd15(&mut self) -> PD15_W<PWR_PDCRHrs> {
        PD15_W::new(self, 15)
    }
}
/**PWR port H pull-down control register

You can [`read`](crate::Reg::read) this register and get [`pwr_pdcrh::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pwr_pdcrh::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#PWR:PWR_PDCRH)*/
pub struct PWR_PDCRHrs;
impl crate::RegisterSpec for PWR_PDCRHrs {
    type Ux = u32;
}
///`read()` method returns [`pwr_pdcrh::R`](R) reader structure
impl crate::Readable for PWR_PDCRHrs {}
///`write(|w| ..)` method takes [`pwr_pdcrh::W`](W) writer structure
impl crate::Writable for PWR_PDCRHrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PWR_PDCRH to value 0
impl crate::Resettable for PWR_PDCRHrs {
