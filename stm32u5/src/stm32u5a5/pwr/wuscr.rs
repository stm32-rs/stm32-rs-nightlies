///Register `WUSCR` reader
pub type R = crate::R<WUSCRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`wuscr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wuscr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#PWR:WUSCR)*/
pub struct WUSCRrs;
impl crate::RegisterSpec for WUSCRrs {
    type Ux = u32;
}
///`read()` method returns [`wuscr::R`](R) reader structure
impl crate::Readable for WUSCRrs {}
