///Register `M6CR` reader
pub type R = crate::R<M6CRrs>;
///Register `M6CR` writer
...
impl W {
    ///Bit 0 - ECCE
    #[inline(always)]
    pub fn ecce(&mut self) -> ECCE_W<'_, M6CRrs> {
        ECCE_W::new(self, 0)
    }
    ///Bit 4 - ALE
    #[inline(always)]
    pub fn ale(&mut self) -> ALE_W<'_, M6CRrs> {
        ALE_W::new(self, 4)
    }
    ///Bit 8 - SRAMER
    #[inline(always)]
    pub fn sramer(&mut self) -> SRAMER_W<'_, M6CRrs> {
        SRAMER_W::new(self, 8)
    }
    ///Bits 16:18 - WSC
    #[inline(always)]
    pub fn wsc(&mut self) -> WSC_W<'_, M6CRrs> {
        WSC_W::new(self, 16)
    }
}
/**memory x control register

You can [`read`](crate::Reg::read) this register and get [`m6cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m6cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`m6cr::R`](R) reader structure
impl crate::Readable for M6CRrs {}
///`write(|w| ..)` method takes [`m6cr::W`](W) writer structure
impl crate::Writable for M6CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets M6CR to value 0
