...
/**Clock sources for TIM16,TIM17, and LPTIM2 internal input capture When TIMICSEL2 is set, the TIM16, TIM17, and LPTIM2 internal input capture can be connected either to HSI/256, MSI/4, or MSI/1024. Depending on TIMICSEL\[1:0\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#RCC:CCIPR1)*/
pub struct CCIPR1rs;
