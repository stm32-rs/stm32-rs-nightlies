...
#[doc = "Field `WAITPEND` reader - CPSM Waits for ends of data transfer (CmdPend internal signal) from DPSM"]
pub type WAITPEND_R = crate::BitReader;
#[doc = "Field `WAITPEND` writer - CPSM Waits for ends of data transfer (CmdPend internal signal) from DPSM"]
...
impl R {
    ...
    #[doc = "Bit 11 - CPSM Waits for ends of data transfer (CmdPend internal signal) from DPSM"]
    #[inline(always)]
