...
impl W {
    ...
    ///Bit 16 - PB6_FMP
    #[inline(always)]
    pub fn pb6_fmp(&mut self) -> PB6_FMP_W<'_, CFGR1rs> {
        PB6_FMP_W::new(self, 16)
    }
    ///Bit 17 - PB7_FMP
    #[inline(always)]
    pub fn pb7_fmp(&mut self) -> PB7_FMP_W<'_, CFGR1rs> {
        PB7_FMP_W::new(self, 17)
    }
    ///Bit 18 - PB8_FMP
    #[inline(always)]
    pub fn pb8_fmp(&mut self) -> PB8_FMP_W<'_, CFGR1rs> {
        PB8_FMP_W::new(self, 18)
    }
    ///Bit 19 - PB9_FMP
    #[inline(always)]
    pub fn pb9_fmp(&mut self) -> PB9_FMP_W<'_, CFGR1rs> {
        PB9_FMP_W::new(self, 19)
    }
    ///Bits 24:25 - ENDCAP
    #[inline(always)]
    pub fn endcap(&mut self) -> ENDCAP_W<'_, CFGR1rs> {
