...
impl W {
    ...
    ///Bit 28 - G8_IO1
    #[inline(always)]
    pub fn g8_io1(&mut self) -> G8_IO1_W<IOCCRrs> {
        G8_IO1_W::new(self, 28)
    }
    ///Bit 29 - G8_IO2
    #[inline(always)]
    pub fn g8_io2(&mut self) -> G8_IO2_W<IOCCRrs> {
        G8_IO2_W::new(self, 29)
    }
    ///Bit 30 - G8_IO3
    #[inline(always)]
    pub fn g8_io3(&mut self) -> G8_IO3_W<IOCCRrs> {
        G8_IO3_W::new(self, 30)
    }
    ///Bit 31 - G8_IO4
    #[inline(always)]
    pub fn g8_io4(&mut self) -> G8_IO4_W<IOCCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A5.html#TSC:IOCCR)*/
pub struct IOCCRrs;
