...
pub type JSQ1_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
///Field `JSQ2` reader - JSQ2
pub type JSQ2_R = crate::FieldReader;
///Field `JSQ2` writer - JSQ2
pub type JSQ2_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
///Field `JSQ3` reader - JSQ3
pub type JSQ3_R = crate::FieldReader;
///Field `JSQ3` writer - JSQ3
pub type JSQ3_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
///Field `JSQ4` reader - JSQ4
pub type JSQ4_R = crate::FieldReader;
///Field `JSQ4` writer - JSQ4
pub type JSQ4_W<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
impl R {
    ///Bits 0:1 - JL
    #[inline(always)]
    pub fn jl(&self) -> JL_R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#ADC1:JSQR)*/
pub struct JSQRrs;
