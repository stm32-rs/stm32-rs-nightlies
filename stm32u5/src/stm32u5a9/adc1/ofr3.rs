...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn posoff(&mut self) -> POSOFF_W<OFR3rs> {
        POSOFF_W::new(self, 24)
    }
    ///Bit 25 - USAT
    #[inline(always)]
    #[must_use]
    pub fn usat(&mut self) -> USAT_W<OFR3rs> {
        USAT_W::new(self, 25)
    }
    ///Bit 26 - SSAT
    #[inline(always)]
    #[must_use]
    pub fn ssat(&mut self) -> SSAT_W<OFR3rs> {
        SSAT_W::new(self, 26)
    }
    ///Bits 27:31 - OFFSET_CH
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#ADC1:OFR3)*/
pub struct OFR3rs;
