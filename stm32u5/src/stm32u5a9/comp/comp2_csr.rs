...
impl W {
    ///Bit 0 - Comparator 2 enable bit
    #[inline(always)]
    pub fn com2_en(&mut self) -> COM2_EN_W<'_, COMP2_CSRrs> {
        COM2_EN_W::new(self, 0)
    }
    ///Bits 4:7 - Comparator 2 Input Minus connection configuration bit
    #[inline(always)]
    pub fn com2_inmsel(&mut self) -> COM2_INMSEL_W<'_, COMP2_CSRrs> {
        COM2_INMSEL_W::new(self, 4)
    }
    ///Bits 8:9 - Comparator 2 input plus selection bit
    #[inline(always)]
    pub fn com2_inpsel(&mut self) -> COM2_INPSEL_W<'_, COMP2_CSRrs> {
        COM2_INPSEL_W::new(self, 8)
    }
    ///Bit 11 - COM2_WINMODE
    #[inline(always)]
    pub fn com2_winmode(&mut self) -> COM2_WINMODE_W<'_, COMP2_CSRrs> {
        COM2_WINMODE_W::new(self, 11)
    }
    ///Bit 14 - COM2_WINOUT
    #[inline(always)]
    pub fn com2_winout(&mut self) -> COM2_WINOUT_W<'_, COMP2_CSRrs> {
        COM2_WINOUT_W::new(self, 14)
    }
    ///Bit 15 - Comparator 2 polarity selection bit
    #[inline(always)]
    pub fn com2_polarity(&mut self) -> COM2_POLARITY_W<'_, COMP2_CSRrs> {
        COM2_POLARITY_W::new(self, 15)
    }
    ///Bits 16:17 - Comparator 2 hysteresis selection bits
    #[inline(always)]
    pub fn com2_hyst(&mut self) -> COM2_HYST_W<'_, COMP2_CSRrs> {
        COM2_HYST_W::new(self, 16)
    }
    ///Bits 18:19 - COM2_PWRMODE
    #[inline(always)]
    pub fn com2_pwrmode(&mut self) -> COM2_PWRMODE_W<'_, COMP2_CSRrs> {
        COM2_PWRMODE_W::new(self, 18)
    }
    ///Bits 20:24 - COM2_BLANKSEL
    #[inline(always)]
    pub fn com2_blanksel(&mut self) -> COM2_BLANKSEL_W<'_, COMP2_CSRrs> {
        COM2_BLANKSEL_W::new(self, 20)
    }
    ///Bit 31 - COMP2_CSR register lock bit
    #[inline(always)]
    pub fn com2_lock(&mut self) -> COM2_LOCK_W<'_, COMP2_CSRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#COMP:COMP2_CSR)*/
