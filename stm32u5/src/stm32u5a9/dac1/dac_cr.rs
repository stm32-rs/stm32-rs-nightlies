...
///Field `CEN1` reader - DAC channel1 calibration enable
pub type CEN1_R = crate::BitReader;
///Field `CEN1` writer - DAC channel1 calibration enable
...
///Field `CEN2` reader - DAC channel2 calibration enable
pub type CEN2_R = crate::BitReader;
///Field `CEN2` writer - DAC channel2 calibration enable
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsel2(&mut self) -> TSEL2_W<DAC_CRrs> {
        TSEL2_W::new(self, 18)
    }
    ///Bits 22:23 - DAC channel2 noise/triangle wave generation enable
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#DAC1:DAC_CR)*/
pub struct DAC_CRrs;
