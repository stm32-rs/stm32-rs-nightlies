...
impl W {
    ///Bit 0 - GPDMA channel 0 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma0_stop(&mut self) -> DBG_GPDMA0_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA0_STOP_W::new(self, 0)
    }
    ///Bit 1 - GPDMA channel 1 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma1_stop(&mut self) -> DBG_GPDMA1_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA1_STOP_W::new(self, 1)
    }
    ///Bit 2 - GPDMA channel 2 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma2_stop(&mut self) -> DBG_GPDMA2_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA2_STOP_W::new(self, 2)
    }
    ///Bit 3 - GPDMA channel 3 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma3_stop(&mut self) -> DBG_GPDMA3_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA3_STOP_W::new(self, 3)
    }
    ///Bit 4 - GPDMA channel 4 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma4_stop(&mut self) -> DBG_GPDMA4_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA4_STOP_W::new(self, 4)
    }
    ///Bit 5 - GPDMA channel 5 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma5_stop(&mut self) -> DBG_GPDMA5_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA5_STOP_W::new(self, 5)
    }
    ///Bit 6 - GPDMA channel 6 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma6_stop(&mut self) -> DBG_GPDMA6_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA6_STOP_W::new(self, 6)
    }
    ///Bit 7 - GPDMA channel 7 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma7_stop(&mut self) -> DBG_GPDMA7_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA7_STOP_W::new(self, 7)
    }
    ///Bit 8 - GPDMA channel 8 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma8_stop(&mut self) -> DBG_GPDMA8_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA8_STOP_W::new(self, 8)
    }
    ///Bit 9 - GPDMA channel 9 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma9_stop(&mut self) -> DBG_GPDMA9_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA9_STOP_W::new(self, 9)
    }
    ///Bit 10 - GPDMA channel 10 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma10_stop(&mut self) -> DBG_GPDMA10_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA10_STOP_W::new(self, 10)
    }
    ///Bit 11 - GPDMA channel 11 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma11_stop(&mut self) -> DBG_GPDMA11_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA11_STOP_W::new(self, 11)
    }
    ///Bit 12 - GPDMA channel 12 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma12_stop(&mut self) -> DBG_GPDMA12_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA12_STOP_W::new(self, 12)
    }
    ///Bit 13 - GPDMA channel 13 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma13_stop(&mut self) -> DBG_GPDMA13_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA13_STOP_W::new(self, 13)
    }
    ///Bit 14 - GPDMA channel 14 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma14_stop(&mut self) -> DBG_GPDMA14_STOP_W<'_, AHB1FZRrs> {
        DBG_GPDMA14_STOP_W::new(self, 14)
    }
    ///Bit 15 - GPDMA channel 15 stop in debug
    #[inline(always)]
    pub fn dbg_gpdma15_stop(&mut self) -> DBG_GPDMA15_STOP_W<'_, AHB1FZRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#DBGMCU:AHB1FZR)*/
