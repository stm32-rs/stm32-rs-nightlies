...
impl W {
    ///Bit 0 - LPDMA channel 0 stop in debug
    #[inline(always)]
    pub fn dbg_lpdma0_stop(&mut self) -> DBG_LPDMA0_STOP_W<'_, AHB3FZRrs> {
        DBG_LPDMA0_STOP_W::new(self, 0)
    }
    ///Bit 1 - LPDMA channel 1 stop in debug
    #[inline(always)]
    pub fn dbg_lpdma1_stop(&mut self) -> DBG_LPDMA1_STOP_W<'_, AHB3FZRrs> {
        DBG_LPDMA1_STOP_W::new(self, 1)
    }
    ///Bit 2 - LPDMA channel 2 stop in debug
    #[inline(always)]
    pub fn dbg_lpdma2_stop(&mut self) -> DBG_LPDMA2_STOP_W<'_, AHB3FZRrs> {
        DBG_LPDMA2_STOP_W::new(self, 2)
    }
    ///Bit 3 - LPDMA channel 3 stop in debug
    #[inline(always)]
    pub fn dbg_lpdma3_stop(&mut self) -> DBG_LPDMA3_STOP_W<'_, AHB3FZRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#DBGMCU:AHB3FZR)*/
