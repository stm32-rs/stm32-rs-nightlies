///Register `DSI_CMCR` reader
pub type R = crate::R<DSI_CMCRrs>;
///Register `DSI_CMCR` writer
...
///`read()` method returns [`dsi_cmcr::R`](R) reader structure
impl crate::Readable for DSI_CMCRrs {}
///`write(|w| ..)` method takes [`dsi_cmcr::W`](W) writer structure
impl crate::Writable for DSI_CMCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_CMCR to value 0
