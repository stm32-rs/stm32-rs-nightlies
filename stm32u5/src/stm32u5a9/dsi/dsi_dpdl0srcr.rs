#[doc = "Register `DSI_DPDL0SRCR` reader"]
pub type R = crate::R<DSI_DPDL0SRCRrs>;
#[doc = "Register `DSI_DPDL0SRCR` writer"]
...
#[doc = "DSI D-PHY data lane 0 skew rate control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dsi_dpdl0srcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dsi_dpdl0srcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DSI_DPDL0SRCRrs;
impl crate::RegisterSpec for DSI_DPDL0SRCRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dsi_dpdl0srcr::R`](R) reader structure"]
impl crate::Readable for DSI_DPDL0SRCRrs {}
#[doc = "`write(|w| ..)` method takes [`dsi_dpdl0srcr::W`](W) writer structure"]
impl crate::Writable for DSI_DPDL0SRCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSI_DPDL0SRCR to value 0"]
