///Register `DSI_LPMCR` reader
pub type R = crate::R<DSI_LPMCRrs>;
///Register `DSI_LPMCR` writer
...
///`read()` method returns [`dsi_lpmcr::R`](R) reader structure
impl crate::Readable for DSI_LPMCRrs {}
///`write(|w| ..)` method takes [`dsi_lpmcr::W`](W) writer structure
impl crate::Writable for DSI_LPMCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_LPMCR to value 0
