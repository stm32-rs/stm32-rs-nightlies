///Register `DSI_VMCR` reader
pub type R = crate::R<DSI_VMCRrs>;
///Register `DSI_VMCR` writer
...
///`read()` method returns [`dsi_vmcr::R`](R) reader structure
impl crate::Readable for DSI_VMCRrs {}
///`write(|w| ..)` method takes [`dsi_vmcr::W`](W) writer structure
impl crate::Writable for DSI_VMCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_VMCR to value 0
