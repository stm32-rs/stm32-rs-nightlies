///Register `DSI_WIER` reader
pub type R = crate::R<DSI_WIERrs>;
///Register `DSI_WIER` writer
...
///`read()` method returns [`dsi_wier::R`](R) reader structure
impl crate::Readable for DSI_WIERrs {}
///`write(|w| ..)` method takes [`dsi_wier::W`](W) writer structure
impl crate::Writable for DSI_WIERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DSI_WIER to value 0
