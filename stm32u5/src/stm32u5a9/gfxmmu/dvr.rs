...
#[doc = "Field `DV` reader - Default value This field indicates the default 32-bit value which is returned when a master accesses a virtual memory location not physically mapped."]
pub type DV_R = crate::FieldReader<u32>;
#[doc = "Field `DV` writer - Default value This field indicates the default 32-bit value which is returned when a master accesses a virtual memory location not physically mapped."]
pub type DV_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Default value This field indicates the default 32-bit value which is returned when a master accesses a virtual memory location not physically mapped."]
    #[inline(always)]
    pub fn dv(&self) -> DV_R {
        DV_R::new(self.bits)
    }
