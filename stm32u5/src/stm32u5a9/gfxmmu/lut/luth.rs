...
#[doc = "Field `LO` reader - Line offset Line offset of line number x (i.e. offset of block 0 of line x)"]
pub type LO_R = crate::FieldReader<u32>;
#[doc = "Field `LO` writer - Line offset Line offset of line number x (i.e. offset of block 0 of line x)"]
pub type LO_W<'a, REG> = crate::FieldWriter<'a, REG, 18, u32>;
impl R {
    #[doc = "Bits 4:21 - Line offset Line offset of line number x (i.e. offset of block 0 of line x)"]
    #[inline(always)]
    pub fn lo(&self) -> LO_R {
