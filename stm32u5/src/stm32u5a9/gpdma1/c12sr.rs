///Register `C12SR` reader
pub type R = crate::R<C12SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c12sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GPDMA1:C12SR)*/
pub struct C12SRrs;
impl crate::RegisterSpec for C12SRrs {
    type Ux = u32;
}
///`read()` method returns [`c12sr::R`](R) reader structure
impl crate::Readable for C12SRrs {}
///`reset()` method sets C12SR to value 0x01
impl crate::Resettable for C12SRrs {
