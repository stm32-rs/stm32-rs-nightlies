///Register `C13SR` reader
pub type R = crate::R<C13SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c13sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GPDMA1:C13SR)*/
pub struct C13SRrs;
impl crate::RegisterSpec for C13SRrs {
    type Ux = u32;
}
///`read()` method returns [`c13sr::R`](R) reader structure
impl crate::Readable for C13SRrs {}
///`reset()` method sets C13SR to value 0x01
impl crate::Resettable for C13SRrs {
