///Register `C14SR` reader
pub type R = crate::R<C14SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c14sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GPDMA1:C14SR)*/
pub struct C14SRrs;
impl crate::RegisterSpec for C14SRrs {
    type Ux = u32;
}
///`read()` method returns [`c14sr::R`](R) reader structure
impl crate::Readable for C14SRrs {}
///`reset()` method sets C14SR to value 0x01
impl crate::Resettable for C14SRrs {
