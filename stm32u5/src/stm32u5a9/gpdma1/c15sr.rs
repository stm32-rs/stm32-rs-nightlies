///Register `C15SR` reader
pub type R = crate::R<C15SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c15sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GPDMA1:C15SR)*/
pub struct C15SRrs;
impl crate::RegisterSpec for C15SRrs {
    type Ux = u32;
}
///`read()` method returns [`c15sr::R`](R) reader structure
impl crate::Readable for C15SRrs {}
///`reset()` method sets C15SR to value 0x01
impl crate::Resettable for C15SRrs {
