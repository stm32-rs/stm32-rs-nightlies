///Register `C9SR` reader
pub type R = crate::R<C9SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c9sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GPDMA1:C9SR)*/
pub struct C9SRrs;
impl crate::RegisterSpec for C9SRrs {
    type Ux = u32;
}
///`read()` method returns [`c9sr::R`](R) reader structure
impl crate::Readable for C9SRrs {}
///`reset()` method sets C9SR to value 0x01
impl crate::Resettable for C9SRrs {
