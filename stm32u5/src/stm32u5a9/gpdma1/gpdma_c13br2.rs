///Register `GPDMA_C13BR2` reader
pub type R = crate::R<GPDMA_C13BR2rs>;
///Register `GPDMA_C13BR2` writer
pub type W = crate::W<GPDMA_C13BR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn brsao(&mut self) -> BRSAO_W<GPDMA_C13BR2rs> {
        BRSAO_W::new(self, 0)
    }
    /**Bits 16:31 - Block repeated destination address offset For a channel with 2D addressing capability, this field BRDAO\[15:0\]
    is used to update (by addition or subtraction depending on GPDMA_CxBR1.BRDDEC) the current destination address (i.e. GPDMA_CxDAR) at the end of a block transfer. Note: A block repeated destination address offset must be aligned with the programmed data width of a destination burst (c.f. BRDAO\[2:0\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn brdao(&mut self) -> BRDAO_W<GPDMA_C13BR2rs> {
        BRDAO_W::new(self, 16)
    }
}
/**GPDMA channel x block register 2

You can [`read`](crate::Reg::read) this register and get [`gpdma_c13br2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c13br2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GPDMA1:GPDMA_C13BR2)*/
pub struct GPDMA_C13BR2rs;
impl crate::RegisterSpec for GPDMA_C13BR2rs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c13br2::R`](R) reader structure
impl crate::Readable for GPDMA_C13BR2rs {}
///`write(|w| ..)` method takes [`gpdma_c13br2::W`](W) writer structure
impl crate::Writable for GPDMA_C13BR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C13BR2 to value 0
impl crate::Resettable for GPDMA_C13BR2rs {
