///Register `GPDMA_C15TR3` reader
pub type R = crate::R<GPDMA_C15TR3rs>;
///Register `GPDMA_C15TR3` writer
pub type W = crate::W<GPDMA_C15TR3rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sao(&mut self) -> SAO_W<GPDMA_C15TR3rs> {
        SAO_W::new(self, 0)
    }
    /**Bits 16:28 - destination address offset increment The destination address, pointed by GPDMA_CxDAR, is incremented or decremented (depending on GPDMA_CxBR1.DDEC) by this offset DAO\[12:0\]
    for each programmed destination burst. This offset is not including and is added to the programmed burst size when the completed burst is addressed in incremented mode i.e. if GPDMA_CxTR1.DINC=1. Note: A destination address offset must be aligned with the programmed data width of a destination burst (c.f. DAO\[2:0\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dao(&mut self) -> DAO_W<GPDMA_C15TR3rs> {
        DAO_W::new(self, 16)
    }
}
/**GPDMA channel x transfer register 3

You can [`read`](crate::Reg::read) this register and get [`gpdma_c15tr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c15tr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GPDMA1:GPDMA_C15TR3)*/
pub struct GPDMA_C15TR3rs;
impl crate::RegisterSpec for GPDMA_C15TR3rs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c15tr3::R`](R) reader structure
impl crate::Readable for GPDMA_C15TR3rs {}
///`write(|w| ..)` method takes [`gpdma_c15tr3::W`](W) writer structure
impl crate::Writable for GPDMA_C15TR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C15TR3 to value 0
impl crate::Resettable for GPDMA_C15TR3rs {
