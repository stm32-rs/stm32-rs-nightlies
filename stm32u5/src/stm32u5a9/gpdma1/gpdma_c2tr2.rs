///Register `GPDMA_C2TR2` reader
pub type R = crate::R<GPDMA_C2TR2rs>;
///Register `GPDMA_C2TR2` writer
pub type W = crate::W<GPDMA_C2TR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> REQSEL_W<GPDMA_C2TR2rs> {
        REQSEL_W::new(self, 0)
    }
    /**Bit 9 - Software request When GPDMA_CxCR.EN is asserted, this field is internally taken into account: - 0: no software request. The selected hardware request REQSEL\[6:0\]
    is taken into account. - 1: software request (for a memory-to-memory transfer). And the default selected hardware request as per REQSEL\[6:0\]
    ...
    #[inline(always)]
    #[must_use]
    pub fn swreq(&mut self) -> SWREQ_W<GPDMA_C2TR2rs> {
        SWREQ_W::new(self, 9)
    }
    ///Bit 10 - Destination hardware request If the channel x is activated (i.e. GPDMA_CxCR.EN is asserted) with SWREQ=1 (i.e. software request for a memory-to-memory transfer), this bit is ignored. Else: - 0: the selected hardware request is driven by a source peripheral (i.e. this request signal is taken into account by the DMA transfer scheduler over the source/read port) - 1: the selected hardware request is driven by a destination peripheral (.e. this request signal is taken into account by the DMA transfer scheduler over the destination/write port)
    #[inline(always)]
    #[must_use]
    pub fn dreq(&mut self) -> DREQ_W<GPDMA_C2TR2rs> {
        DREQ_W::new(self, 10)
    }
    ///Bit 11 - BREQ
    #[inline(always)]
    #[must_use]
    pub fn breq(&mut self) -> BREQ_W<GPDMA_C2TR2rs> {
        BREQ_W::new(self, 11)
    }
    ///Bits 14:15 - Trigger mode
    #[inline(always)]
    #[must_use]
    pub fn trigm(&mut self) -> TRIGM_W<GPDMA_C2TR2rs> {
        TRIGM_W::new(self, 14)
    }
    /**Bits 16:21 - Trigger event input selection Note: Selects the trigger event input as per Table 13 of the DMA transfer, with an active trigger event if TRIGPOL\[1:0\]
    !=00.*/
    #[inline(always)]
    #[must_use]
    pub fn trigsel(&mut self) -> TRIGSEL_W<GPDMA_C2TR2rs> {
        TRIGSEL_W::new(self, 16)
    }
    ///Bits 24:25 - Trigger event polarity Defines the polarity of the selected trigger event input defined by TRIGSEL\[5:0\]. - 00: no trigger. Masked trigger event. - 01: trigger on the rising edge - 10: trigger on the falling edge - 11: same as 00
    #[inline(always)]
    #[must_use]
    pub fn trigpol(&mut self) -> TRIGPOL_W<GPDMA_C2TR2rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcem(&mut self) -> TCEM_W<GPDMA_C2TR2rs> {
        TCEM_W::new(self, 30)
    }
}
/**GPDMA channel x transfer register 2

You can [`read`](crate::Reg::read) this register and get [`gpdma_c2tr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpdma_c2tr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GPDMA1:GPDMA_C2TR2)*/
pub struct GPDMA_C2TR2rs;
impl crate::RegisterSpec for GPDMA_C2TR2rs {
    type Ux = u32;
}
///`read()` method returns [`gpdma_c2tr2::R`](R) reader structure
impl crate::Readable for GPDMA_C2TR2rs {}
///`write(|w| ..)` method takes [`gpdma_c2tr2::W`](W) writer structure
impl crate::Writable for GPDMA_C2TR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPDMA_C2TR2 to value 0
impl crate::Resettable for GPDMA_C2TR2rs {
