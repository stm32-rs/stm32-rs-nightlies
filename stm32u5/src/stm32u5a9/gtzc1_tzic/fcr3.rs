...
#[doc = "Field `CGFXMMUF` writer - clear the illegal access flag for GFXMMU"]
pub type CGFXMMUF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CGFXMMU_REGF` writer - clear the illegal access flag for GFXMMU registers"]
pub type CGFXMMU_REGF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CHSPI1_REGF` writer - clear the illegal access flag for GFXMMU registers"]
pub type CHSPI1_REGF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CDCACHE2_REGF` writer - clear the illegal access flag for GFXMMU registers"]
...
impl W {
    ...
    #[doc = "Bit 24 - clear the illegal access flag for GFXMMU"]
    #[inline(always)]
    #[must_use]
    pub fn cgfxmmuf(&mut self) -> CGFXMMUF_W<FCR3rs> {
        CGFXMMUF_W::new(self, 24)
    }
    #[doc = "Bit 25 - clear the illegal access flag for GFXMMU registers"]
    #[inline(always)]
    #[must_use]
    pub fn cgfxmmu_regf(&mut self) -> CGFXMMU_REGF_W<FCR3rs> {
        CGFXMMU_REGF_W::new(self, 25)
    }
    #[doc = "Bit 26 - clear the illegal access flag for GFXMMU registers"]
    #[inline(always)]
    #[must_use]
    pub fn chspi1_regf(&mut self) -> CHSPI1_REGF_W<FCR3rs> {
        CHSPI1_REGF_W::new(self, 26)
    }
    #[doc = "Bit 27 - clear the illegal access flag for GFXMMU registers"]
    #[inline(always)]
    #[must_use]
