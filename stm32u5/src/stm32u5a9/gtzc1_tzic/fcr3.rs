...
///Field `CGFXMMUF` writer - clear the illegal access flag for GFXMMU
pub type CGFXMMUF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CGFXMMU_REGF` writer - clear the illegal access flag for GFXMMU registers
pub type CGFXMMU_REGF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CHSPI1_REGF` writer - clear the illegal access flag for GFXMMU registers
pub type CHSPI1_REGF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CDCACHE2_REGF` writer - clear the illegal access flag for GFXMMU registers
pub type CDCACHE2_REGF_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn cmdf1f(&mut self) -> CMDF1F_W<'_, FCR3rs> {
        CMDF1F_W::new(self, 0)
    }
    ...
    #[inline(always)]
    pub fn cotgf(&mut self) -> COTGF_W<'_, FCR3rs> {
        COTGF_W::new(self, 10)
    }
    ...
    #[inline(always)]
    pub fn coctospimf(&mut self) -> COCTOSPIMF_W<'_, FCR3rs> {
    ...
    #[inline(always)]
    pub fn cgpu2df(&mut self) -> CGPU2DF_W<'_, FCR3rs> {
        CGPU2DF_W::new(self, 23)
    }
    ///Bit 24 - clear the illegal access flag for GFXMMU
    #[inline(always)]
    pub fn cgfxmmuf(&mut self) -> CGFXMMUF_W<'_, FCR3rs> {
        CGFXMMUF_W::new(self, 24)
    }
    ///Bit 25 - clear the illegal access flag for GFXMMU registers
    #[inline(always)]
    pub fn cgfxmmu_regf(&mut self) -> CGFXMMU_REGF_W<'_, FCR3rs> {
        CGFXMMU_REGF_W::new(self, 25)
    }
    ///Bit 26 - clear the illegal access flag for GFXMMU registers
    #[inline(always)]
    pub fn chspi1_regf(&mut self) -> CHSPI1_REGF_W<'_, FCR3rs> {
        CHSPI1_REGF_W::new(self, 26)
    }
    ///Bit 27 - clear the illegal access flag for GFXMMU registers
    #[inline(always)]
    pub fn cdcache2_regf(&mut self) -> CDCACHE2_REGF_W<'_, FCR3rs> {
        CDCACHE2_REGF_W::new(self, 27)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GTZC1_TZIC:FCR3)*/
pub struct FCR3rs;
