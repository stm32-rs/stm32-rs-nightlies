...
///Field `COTFDEC2F` writer - clear the illegal access flag for OTFDEC2
pub type COTFDEC2F_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn cotfdec1f(&mut self) -> COTFDEC1F_W<'_, FCR4rs> {
        COTFDEC1F_W::new(self, 3)
    }
    ///Bit 4 - clear the illegal access flag for OTFDEC2
    #[inline(always)]
    pub fn cotfdec2f(&mut self) -> COTFDEC2F_W<'_, FCR4rs> {
        COTFDEC2F_W::new(self, 4)
    }
    ...
    #[inline(always)]
    pub fn cfsmc_memf(&mut self) -> CFSMC_MEMF_W<'_, FCR4rs> {
    ...
    #[inline(always)]
    pub fn coctospi2_memf(&mut self) -> COCTOSPI2_MEMF_W<'_, FCR4rs> {
        COCTOSPI2_MEMF_W::new(self, 19)
    }
    ///Bit 20 - clear the illegal access flag for HSPI1 memory bank
    #[inline(always)]
    pub fn chspi1_memf(&mut self) -> CHSPI1_MEMF_W<'_, FCR4rs> {
    ...
    #[inline(always)]
    pub fn csram5f(&mut self) -> CSRAM5F_W<'_, FCR4rs> {
        CSRAM5F_W::new(self, 30)
    }
    ///Bit 31 - clear the illegal access flag for MPCBB5 registers
    #[inline(always)]
    pub fn cmpcbb5_regf(&mut self) -> CMPCBB5_REGF_W<'_, FCR4rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GTZC1_TZIC:FCR4)*/
pub struct FCR4rs;
