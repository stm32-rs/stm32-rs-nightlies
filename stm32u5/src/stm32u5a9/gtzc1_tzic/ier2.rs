...
///Field `LTDCIE` reader - illegal access interrupt enable for LTDC
pub type LTDCIE_R = crate::BitReader;
///Field `LTDCIE` writer - illegal access interrupt enable for LTDC
pub type LTDCIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DSIIE` reader - illegal access interrupt enable for DSI
pub type DSIIE_R = crate::BitReader;
///Field `DSIIE` writer - illegal access interrupt enable for DSI
...
impl R {
    ...
    ///Bit 9 - illegal access interrupt enable for LTDC
    #[inline(always)]
    pub fn ltdcie(&self) -> LTDCIE_R {
        LTDCIE_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - illegal access interrupt enable for DSI
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IER2")
            ...
            .field("ltdcie", &self.ltdcie())
            .field("dsiie", &self.dsiie())
            .finish()
    }
}
impl W {
    ...
    ///Bit 9 - illegal access interrupt enable for LTDC
    #[inline(always)]
    pub fn ltdcie(&mut self) -> LTDCIE_W<'_, IER2rs> {
        LTDCIE_W::new(self, 9)
    }
    ///Bit 10 - illegal access interrupt enable for DSI
    #[inline(always)]
    pub fn dsiie(&mut self) -> DSIIE_W<'_, IER2rs> {
        DSIIE_W::new(self, 10)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GTZC1_TZIC:IER2)*/
pub struct IER2rs;
