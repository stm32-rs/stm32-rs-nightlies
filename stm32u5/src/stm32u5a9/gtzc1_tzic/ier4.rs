...
///Field `MPCBB5_REGIE` reader - illegal access interrupt enable for MPCBB5 registers
pub type MPCBB5_REGIE_R = crate::BitReader;
///Field `MPCBB5_REGIE` writer - illegal access interrupt enable for MPCBB5 registers
...
impl R {
    ...
    ///Bit 31 - illegal access interrupt enable for MPCBB5 registers
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IER4")
            ...
            .field("mpcbb5_regie", &self.mpcbb5_regie())
            .finish()
    }
}
impl W {
    ...
    ///Bit 3 - illegal access interrupt enable for OTFDEC1
    #[inline(always)]
    pub fn otfdec1ie(&mut self) -> OTFDEC1IE_W<'_, IER4rs> {
        OTFDEC1IE_W::new(self, 3)
    }
    ///Bit 4 - illegal access interrupt enable for OTFDEC2
    #[inline(always)]
    pub fn otfdec2ie(&mut self) -> OTFDEC2IE_W<'_, IER4rs> {
        OTFDEC2IE_W::new(self, 4)
    }
    ///Bit 14 - illegal access interrupt enable for GTZC1 TZSC registers
    #[inline(always)]
    pub fn tzsc1ie(&mut self) -> TZSC1IE_W<'_, IER4rs> {
        TZSC1IE_W::new(self, 14)
    }
    ///Bit 15 - illegal access interrupt enable for GTZC1 TZIC registers
    #[inline(always)]
    pub fn tzic1ie(&mut self) -> TZIC1IE_W<'_, IER4rs> {
        TZIC1IE_W::new(self, 15)
    }
    ///Bit 16 - illegal access interrupt enable for MPCWM1 (OCTOSPI1) memory bank
    #[inline(always)]
    pub fn octospi1_memie(&mut self) -> OCTOSPI1_MEMIE_W<'_, IER4rs> {
        OCTOSPI1_MEMIE_W::new(self, 16)
    }
    ///Bit 17 - illegal access interrupt enable for MPCWM2 (FSMC NAND) and MPCWM3
    #[inline(always)]
    pub fn fsmc_memie(&mut self) -> FSMC_MEMIE_W<'_, IER4rs> {
        FSMC_MEMIE_W::new(self, 17)
    }
    ///Bit 18 - illegal access interrupt enable for MPCWM3 (BKPSRAM) memory bank
    #[inline(always)]
    pub fn bkpsramie(&mut self) -> BKPSRAMIE_W<'_, IER4rs> {
        BKPSRAMIE_W::new(self, 18)
    }
    ///Bit 19 - illegal access interrupt enable for OCTOSPI2 memory bank
    #[inline(always)]
    pub fn octospi2_memie(&mut self) -> OCTOSPI2_MEMIE_W<'_, IER4rs> {
        OCTOSPI2_MEMIE_W::new(self, 19)
    }
    ///Bit 20 - illegal access interrupt enable for HSPI1 memory bank
    #[inline(always)]
    pub fn hspi1_memie(&mut self) -> HSPI1_MEMIE_W<'_, IER4rs> {
    ...
    ///Bit 25 - illegal access interrupt enable for MPCBB1 registers
    #[inline(always)]
    pub fn mpcbb1_regie(&mut self) -> MPCBB1_REGIE_W<'_, IER4rs> {
    ...
    ///Bit 27 - illegal access interrupt enable for MPCBB2 registers
    #[inline(always)]
    pub fn mpcbb2_regie(&mut self) -> MPCBB2_REGIE_W<'_, IER4rs> {
        MPCBB2_REGIE_W::new(self, 27)
    }
    ///Bit 28 - illegal access interrupt enable for SRAM3
    #[inline(always)]
    pub fn sram3ie(&mut self) -> SRAM3IE_W<'_, IER4rs> {
        SRAM3IE_W::new(self, 28)
    }
    ///Bit 29 - illegal access interrupt enable for MPCBB3 registers
    #[inline(always)]
    pub fn mpcbb3_regie(&mut self) -> MPCBB3_REGIE_W<'_, IER4rs> {
        MPCBB3_REGIE_W::new(self, 29)
    }
    ///Bit 30 - illegal access interrupt enable for SRAM5
    #[inline(always)]
    pub fn sram5ie(&mut self) -> SRAM5IE_W<'_, IER4rs> {
        SRAM5IE_W::new(self, 30)
    }
    ///Bit 31 - illegal access interrupt enable for MPCBB5 registers
    #[inline(always)]
    pub fn mpcbb5_regie(&mut self) -> MPCBB5_REGIE_W<'_, IER4rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GTZC1_TZIC:IER4)*/
pub struct IER4rs;
