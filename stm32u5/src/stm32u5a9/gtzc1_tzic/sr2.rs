...
#[doc = "Field `LTDCF` reader - illegal access flag for LTDC"]
pub type LTDCF_R = crate::BitReader;
#[doc = "Field `DSIF` reader - illegal access flag for DSI"]
...
impl R {
    ...
    #[doc = "Bit 8 - illegal access flag for SAI2"]
    #[inline(always)]
    pub fn sai2f(&self) -> SAI2F_R {
        SAI2F_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - illegal access flag for LTDC"]
    #[inline(always)]
    pub fn ltdcf(&self) -> LTDCF_R {
        LTDCF_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - illegal access flag for DSI"]
    #[inline(always)]
