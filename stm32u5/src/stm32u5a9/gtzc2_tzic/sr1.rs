...
///Field `ADC2F` reader - illegal access flag for ADC2
...
impl R {
    ...
    ///Bit 8 - illegal access flag for ADC2
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#GTZC2_TZIC:SR1)*/
pub struct SR1rs;
