...
#[doc = "Field `ADC2PRIV` reader - privileged access mode for ADC2"]
pub type ADC2PRIV_R = crate::BitReader;
#[doc = "Field `ADC2PRIV` writer - privileged access mode for ADC2"]
...
impl R {
    ...
    #[doc = "Bit 8 - privileged access mode for ADC2"]
    #[inline(always)]
