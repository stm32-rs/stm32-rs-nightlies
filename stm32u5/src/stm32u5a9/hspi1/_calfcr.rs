///Register `_CALFCR` reader
pub type R = crate::R<_CALFCRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`_calfcr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#HSPI1:_CALFCR)*/
pub struct _CALFCRrs;
impl crate::RegisterSpec for _CALFCRrs {
    type Ux = u32;
}
///`read()` method returns [`_calfcr::R`](R) reader structure
impl crate::Readable for _CALFCRrs {}
///`reset()` method sets _CALFCR to value 0
impl crate::Resettable for _CALFCRrs {
