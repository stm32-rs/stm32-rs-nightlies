///Register `_CALMR` reader
pub type R = crate::R<_CALMRrs>;
///Register `_CALMR` writer
pub type W = crate::W<_CALMRrs>;
...
impl W {
    ///Bits 0:6 - 6: 0\]: Fine calibration The unitary value of delay for this field depends on product technology (refer to the product datasheet).
    #[inline(always)]
    pub fn fine(&mut self) -> FINE_W<'_, _CALMRrs> {
        FINE_W::new(self, 0)
    }
    ///Bits 16:20 - 4: 0\]: Coarse calibration The unitary value of delay for this field depends on product technology (refer to the product datasheet).
    #[inline(always)]
    pub fn coarse(&mut self) -> COARSE_W<'_, _CALMRrs> {
        COARSE_W::new(self, 16)
    }
}
/**HSPI DLL master calibration configuration

You can [`read`](crate::Reg::read) this register and get [`_calmr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_calmr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#HSPI1:_CALMR)*/
pub struct _CALMRrs;
impl crate::RegisterSpec for _CALMRrs {
    type Ux = u32;
}
///`read()` method returns [`_calmr::R`](R) reader structure
impl crate::Readable for _CALMRrs {}
///`write(|w| ..)` method takes [`_calmr::W`](W) writer structure
impl crate::Writable for _CALMRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets _CALMR to value 0
impl crate::Resettable for _CALMRrs {}
