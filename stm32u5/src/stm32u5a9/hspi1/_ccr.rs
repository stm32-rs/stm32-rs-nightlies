///Register `_CCR` reader
pub type R = crate::R<_CCRrs>;
///Register `_CCR` writer
pub type W = crate::W<_CCRrs>;
...
///Field `ABMODE` reader - Alternate-byte mode This field defines the alternate byte phase mode of operation. 100-111: Reserved
pub type ABMODE_R = crate::FieldReader;
///Field `ABMODE` writer - Alternate-byte mode This field defines the alternate byte phase mode of operation. 100-111: Reserved
pub type ABMODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `ABDTR` reader - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSYÂ =Â 0.
pub type ABDTR_R = crate::BitReader;
///Field `ABDTR` writer - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSYÂ =Â 0.
...
///Field `DMODE` reader - Data mode This field defines the data phase mode of operation. 110-111: Reserved
pub type DMODE_R = crate::FieldReader;
///Field `DMODE` writer - Data mode This field defines the data phase mode of operation. 110-111: Reserved
...
///Field `SIOO` reader - Send instruction only once mode This bit has no effect when IMODEÂ =Â 00 (see ).
pub type SIOO_R = crate::BitReader;
///Field `SIOO` writer - Send instruction only once mode This bit has no effect when IMODEÂ =Â 00 (see ).
...
impl R {
    ...
    ///Bits 16:18 - Alternate-byte mode This field defines the alternate byte phase mode of operation. 100-111: Reserved
    #[inline(always)]
    pub fn abmode(&self) -> ABMODE_R {
        ABMODE_R::new(((self.bits >> 16) & 7) as u8)
    }
    ///Bit 19 - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSYÂ =Â 0.
    #[inline(always)]
    ...
    ///Bits 24:26 - Data mode This field defines the data phase mode of operation. 110-111: Reserved
    #[inline(always)]
    ...
    ///Bit 31 - Send instruction only once mode This bit has no effect when IMODEÂ =Â 00 (see ).
    #[inline(always)]
...
impl W {
    ///Bits 0:2 - Instruction mode This field defines the instruction phase mode of operation. 101-111: Reserved
    #[inline(always)]
    pub fn imode(&mut self) -> IMODE_W<'_, _CCRrs> {
        IMODE_W::new(self, 0)
    }
    ///Bit 3 - Instruction double transfer rate This bit sets the DTR mode for the instruction phase.
    #[inline(always)]
    pub fn idtr(&mut self) -> IDTR_W<'_, _CCRrs> {
        IDTR_W::new(self, 3)
    }
    ///Bits 4:5 - Instruction size This bit defines instruction size.
    #[inline(always)]
    pub fn isize(&mut self) -> ISIZE_W<'_, _CCRrs> {
        ISIZE_W::new(self, 4)
    }
    ///Bits 8:10 - Address mode This field defines the address phase mode of operation. 101-111: Reserved
    #[inline(always)]
    pub fn admode(&mut self) -> ADMODE_W<'_, _CCRrs> {
        ADMODE_W::new(self, 8)
    }
    ///Bit 11 - Address double transfer rate This bit sets the DTR mode for the address phase.
    #[inline(always)]
    pub fn addtr(&mut self) -> ADDTR_W<'_, _CCRrs> {
        ADDTR_W::new(self, 11)
    }
    ///Bits 12:13 - Address size This field defines address size.
    #[inline(always)]
    pub fn adsize(&mut self) -> ADSIZE_W<'_, _CCRrs> {
        ADSIZE_W::new(self, 12)
    }
    ///Bits 16:18 - Alternate-byte mode This field defines the alternate byte phase mode of operation. 100-111: Reserved
    #[inline(always)]
    pub fn abmode(&mut self) -> ABMODE_W<'_, _CCRrs> {
        ABMODE_W::new(self, 16)
    }
    ///Bit 19 - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. This field can be written only when BUSYÂ =Â 0.
    #[inline(always)]
    pub fn abdtr(&mut self) -> ABDTR_W<'_, _CCRrs> {
        ABDTR_W::new(self, 19)
    }
    ///Bits 20:21 - Alternate bytes size This bit defines alternate bytes size.
    #[inline(always)]
    pub fn absize(&mut self) -> ABSIZE_W<'_, _CCRrs> {
        ABSIZE_W::new(self, 20)
    }
    ///Bits 24:26 - Data mode This field defines the data phase mode of operation. 110-111: Reserved
    #[inline(always)]
    pub fn dmode(&mut self) -> DMODE_W<'_, _CCRrs> {
        DMODE_W::new(self, 24)
    }
    ///Bit 27 - Data double transfer rate This bit sets the DTR mode for the data phase.
    #[inline(always)]
    pub fn ddtr(&mut self) -> DDTR_W<'_, _CCRrs> {
        DDTR_W::new(self, 27)
    }
    ///Bit 29 - DQS enable This bit enables the data strobe management.
    #[inline(always)]
    pub fn dqse(&mut self) -> DQSE_W<'_, _CCRrs> {
        DQSE_W::new(self, 29)
    }
    ///Bit 31 - Send instruction only once mode This bit has no effect when IMODEÂ =Â 00 (see ).
    #[inline(always)]
    pub fn sioo(&mut self) -> SIOO_W<'_, _CCRrs> {
        SIOO_W::new(self, 31)
    }
}
/**HSPI communication configuration register

You can [`read`](crate::Reg::read) this register and get [`_ccr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_ccr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#HSPI1:_CCR)*/
pub struct _CCRrs;
impl crate::RegisterSpec for _CCRrs {
    type Ux = u32;
}
///`read()` method returns [`_ccr::R`](R) reader structure
impl crate::Readable for _CCRrs {}
///`write(|w| ..)` method takes [`_ccr::W`](W) writer structure
impl crate::Writable for _CCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets _CCR to value 0
impl crate::Resettable for _CCRrs {}
