///Register `_WTCR` reader
pub type R = crate::R<_WTCRrs>;
///Register `_WTCR` writer
pub type W = crate::W<_WTCRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("_WTCR").field("dcyc", &self.dcyc()).finish()
    }
}
impl W {
    ///Bits 0:4 - Number of dummy cycles This field defines the duration of the dummy phase. In both SDR and DTR modes, it specifies a number of CLK cycles (0-31). It is recommended to have at least 5 dummy cycles when using memories with DQS activated.
    #[inline(always)]
    pub fn dcyc(&mut self) -> DCYC_W<'_, _WTCRrs> {
        DCYC_W::new(self, 0)
    }
}
/**HSPI write timing configuration register

You can [`read`](crate::Reg::read) this register and get [`_wtcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_wtcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#HSPI1:_WTCR)*/
pub struct _WTCRrs;
impl crate::RegisterSpec for _WTCRrs {
    type Ux = u32;
}
///`read()` method returns [`_wtcr::R`](R) reader structure
impl crate::Readable for _WTCRrs {}
///`write(|w| ..)` method takes [`_wtcr::W`](W) writer structure
impl crate::Writable for _WTCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets _WTCR to value 0
impl crate::Resettable for _WTCRrs {}
