...
You can [`read`](crate::Reg::read) this register and get [`hspi_calfcr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`hspi_calfcr::R`](R) reader structure
impl crate::Readable for HSPI_CALFCRrs {}
///`reset()` method sets HSPI_CALFCR to value 0
