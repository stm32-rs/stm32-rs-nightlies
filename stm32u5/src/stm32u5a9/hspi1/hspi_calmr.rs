///Register `HSPI_CALMR` reader
pub type R = crate::R<HSPI_CALMRrs>;
///Register `HSPI_CALMR` writer
...
You can [`read`](crate::Reg::read) this register and get [`hspi_calmr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_calmr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`hspi_calmr::R`](R) reader structure
impl crate::Readable for HSPI_CALMRrs {}
///`write(|w| ..)` method takes [`hspi_calmr::W`](W) writer structure
impl crate::Writable for HSPI_CALMRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_CALMR to value 0
