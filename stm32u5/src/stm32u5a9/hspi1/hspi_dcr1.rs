///Register `HSPI_DCR1` reader
pub type R = crate::R<HSPI_DCR1rs>;
///Register `HSPI_DCR1` writer
pub type W = crate::W<HSPI_DCR1rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ckmode(&mut self) -> CKMODE_W<HSPI_DCR1rs> {
        CKMODE_W::new(self, 0)
    }
    ///Bit 1 - Free running clock This bit configures the free running clock.
    #[inline(always)]
    #[must_use]
    pub fn frck(&mut self) -> FRCK_W<HSPI_DCR1rs> {
        FRCK_W::new(self, 1)
    }
    ///Bit 3 - Delay block bypass
    #[inline(always)]
    #[must_use]
    pub fn dlybyp(&mut self) -> DLYBYP_W<HSPI_DCR1rs> {
        DLYBYP_W::new(self, 3)
    }
    /**Bits 8:13 - Chip-select high time CSHTÂ +Â 1 defines the minimum number of CLK cycles where the chip-select (nCS) must remain high between commands issued to the external device. ... 63: nCS stays high for at least 64 cycles between external device commands. Note: When the extended CSHT timeout feature is not supported, CSHT\[5:3\]
    are reserved and the number of cycles is limited to eight (refer to implementation).*/
    #[inline(always)]
    #[must_use]
    pub fn csht(&mut self) -> CSHT_W<HSPI_DCR1rs> {
        CSHT_W::new(self, 8)
    }
    /**Bits 16:20 - Device size This field defines the size of the external device using the following formula: Number of bytes in device = 2\[DEVSIZE+1\]. DEVSIZE+1 is effectively the number of address bits required to address the external device. The device capacity can be up to 4Â Gbytes (addressed using 32-bits) in Indirect mode, but the addressable space in Memory-mapped mode is limited to 256Â Mbytes. In Regular-command mode, if DMMÂ =Â 1, DEVSIZE\[4:0\]
    indicates the total capacity of the two devices together.*/
    #[inline(always)]
    #[must_use]
    pub fn devsize(&mut self) -> DEVSIZE_W<HSPI_DCR1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mtyp(&mut self) -> MTYP_W<HSPI_DCR1rs> {
        MTYP_W::new(self, 24)
    }
}
/**HSPI device configuration register 1

You can [`read`](crate::Reg::read) this register and get [`hspi_dcr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_dcr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#HSPI1:HSPI_DCR1)*/
pub struct HSPI_DCR1rs;
impl crate::RegisterSpec for HSPI_DCR1rs {
    type Ux = u32;
}
///`read()` method returns [`hspi_dcr1::R`](R) reader structure
impl crate::Readable for HSPI_DCR1rs {}
///`write(|w| ..)` method takes [`hspi_dcr1::W`](W) writer structure
impl crate::Writable for HSPI_DCR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_DCR1 to value 0
impl crate::Resettable for HSPI_DCR1rs {
