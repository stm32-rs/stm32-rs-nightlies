///Register `HSPI_DCR4` reader
pub type R = crate::R<HSPI_DCR4rs>;
///Register `HSPI_DCR4` writer
...
You can [`read`](crate::Reg::read) this register and get [`hspi_dcr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_dcr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`hspi_dcr4::R`](R) reader structure
impl crate::Readable for HSPI_DCR4rs {}
///`write(|w| ..)` method takes [`hspi_dcr4::W`](W) writer structure
impl crate::Writable for HSPI_DCR4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_DCR4 to value 0
