#[doc = "Register `HSPI_DLR` reader"]
pub type R = crate::R<HSPI_DLRrs>;
#[doc = "Register `HSPI_DLR` writer"]
...
#[doc = "HSPI data length register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hspi_dlr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hspi_dlr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSPI_DLRrs;
impl crate::RegisterSpec for HSPI_DLRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hspi_dlr::R`](R) reader structure"]
impl crate::Readable for HSPI_DLRrs {}
#[doc = "`write(|w| ..)` method takes [`hspi_dlr::W`](W) writer structure"]
impl crate::Writable for HSPI_DLRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSPI_DLR to value 0"]
