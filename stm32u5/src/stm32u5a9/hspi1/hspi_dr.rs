///Register `HSPI_DR` reader
pub type R = crate::R<HSPI_DRrs>;
///Register `HSPI_DR` writer
pub type W = crate::W<HSPI_DRrs>;
...
impl W {
    ...
    and a half-word read must read DATA\[15:0\].*/
    #[inline(always)]
    pub fn data(&mut self) -> DATA_W<HSPI_DRrs> {
        DATA_W::new(self, 0)
    }
}
/**

You can [`read`](crate::Reg::read) this register and get [`hspi_dr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_dr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#HSPI1:HSPI_DR)*/
pub struct HSPI_DRrs;
impl crate::RegisterSpec for HSPI_DRrs {
    type Ux = u32;
}
///`read()` method returns [`hspi_dr::R`](R) reader structure
impl crate::Readable for HSPI_DRrs {}
///`write(|w| ..)` method takes [`hspi_dr::W`](W) writer structure
impl crate::Writable for HSPI_DRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_DR to value 0
impl crate::Resettable for HSPI_DRrs {
