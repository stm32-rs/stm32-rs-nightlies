///Register `HSPI_WPCCR` reader
pub type R = crate::R<HSPI_WPCCRrs>;
///Register `HSPI_WPCCR` writer
pub type W = crate::W<HSPI_WPCCRrs>;
...
///Field `ABMODE` reader - Alternate-byte mode This field defines the alternate byte phase mode of operation.
pub type ABMODE_R = crate::FieldReader;
///Field `ABMODE` writer - Alternate-byte mode This field defines the alternate byte phase mode of operation.
...
///Field `DMODE` reader - Data mode This field defines the data phase mode of operation. 101; Data on 16 lines 110-111: Reserved
pub type DMODE_R = crate::FieldReader;
///Field `DMODE` writer - Data mode This field defines the data phase mode of operation. 101; Data on 16 lines 110-111: Reserved
...
impl R {
    ...
    ///Bits 24:26 - Data mode This field defines the data phase mode of operation. 101; Data on 16 lines 110-111: Reserved
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn imode(&mut self) -> IMODE_W<HSPI_WPCCRrs> {
        IMODE_W::new(self, 0)
    }
    ///Bit 3 - Instruction double transfer rate This bit sets the DTR mode for the instruction phase.
    #[inline(always)]
    #[must_use]
    pub fn idtr(&mut self) -> IDTR_W<HSPI_WPCCRrs> {
        IDTR_W::new(self, 3)
    }
    ///Bits 4:5 - Instruction size This field defines instruction size.
    #[inline(always)]
    #[must_use]
    pub fn isize(&mut self) -> ISIZE_W<HSPI_WPCCRrs> {
        ISIZE_W::new(self, 4)
    }
    ///Bits 8:10 - Address mode This field defines the address phase mode of operation. 101-111: Reserved
    #[inline(always)]
    #[must_use]
    pub fn admode(&mut self) -> ADMODE_W<HSPI_WPCCRrs> {
        ADMODE_W::new(self, 8)
    }
    ///Bit 11 - Address double transfer rate This bit sets the DTR mode for the address phase.
    #[inline(always)]
    #[must_use]
    pub fn addtr(&mut self) -> ADDTR_W<HSPI_WPCCRrs> {
        ADDTR_W::new(self, 11)
    }
    ///Bits 12:13 - Address size This field defines address size.
    #[inline(always)]
    #[must_use]
    pub fn adsize(&mut self) -> ADSIZE_W<HSPI_WPCCRrs> {
        ADSIZE_W::new(self, 12)
    }
    ///Bits 16:18 - Alternate-byte mode This field defines the alternate byte phase mode of operation.
    #[inline(always)]
    #[must_use]
    pub fn abmode(&mut self) -> ABMODE_W<HSPI_WPCCRrs> {
        ABMODE_W::new(self, 16)
    }
    ///Bit 19 - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase.
    #[inline(always)]
    #[must_use]
    pub fn abdtr(&mut self) -> ABDTR_W<HSPI_WPCCRrs> {
        ABDTR_W::new(self, 19)
    }
    ///Bits 20:21 - Alternate bytes size This bit defines alternate bytes size.
    #[inline(always)]
    #[must_use]
    pub fn absize(&mut self) -> ABSIZE_W<HSPI_WPCCRrs> {
        ABSIZE_W::new(self, 20)
    }
    ///Bits 24:26 - Data mode This field defines the data phase mode of operation. 101; Data on 16 lines 110-111: Reserved
    #[inline(always)]
    #[must_use]
    pub fn dmode(&mut self) -> DMODE_W<HSPI_WPCCRrs> {
        DMODE_W::new(self, 24)
    }
    ///Bit 27 - Data double transfer rate This bit sets the DTR mode for the data phase.
    #[inline(always)]
    #[must_use]
    pub fn ddtr(&mut self) -> DDTR_W<HSPI_WPCCRrs> {
        DDTR_W::new(self, 27)
    }
    ///Bit 29 - DQS enable This bit enables the data strobe management.
    #[inline(always)]
    #[must_use]
    pub fn dqse(&mut self) -> DQSE_W<HSPI_WPCCRrs> {
        DQSE_W::new(self, 29)
    }
}
/**HSPI wrap communication configuration register

You can [`read`](crate::Reg::read) this register and get [`hspi_wpccr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_wpccr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#HSPI1:HSPI_WPCCR)*/
pub struct HSPI_WPCCRrs;
impl crate::RegisterSpec for HSPI_WPCCRrs {
    type Ux = u32;
}
///`read()` method returns [`hspi_wpccr::R`](R) reader structure
impl crate::Readable for HSPI_WPCCRrs {}
///`write(|w| ..)` method takes [`hspi_wpccr::W`](W) writer structure
impl crate::Writable for HSPI_WPCCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_WPCCR to value 0
impl crate::Resettable for HSPI_WPCCRrs {
