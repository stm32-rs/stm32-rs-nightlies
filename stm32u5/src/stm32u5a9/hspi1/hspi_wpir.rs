#[doc = "Register `HSPI_WPIR` reader"]
pub type R = crate::R<HSPI_WPIRrs>;
#[doc = "Register `HSPI_WPIR` writer"]
...
#[doc = "HSPI wrap instruction register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hspi_wpir::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hspi_wpir::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSPI_WPIRrs;
impl crate::RegisterSpec for HSPI_WPIRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hspi_wpir::R`](R) reader structure"]
impl crate::Readable for HSPI_WPIRrs {}
#[doc = "`write(|w| ..)` method takes [`hspi_wpir::W`](W) writer structure"]
impl crate::Writable for HSPI_WPIRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSPI_WPIR to value 0"]
