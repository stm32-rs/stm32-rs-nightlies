///Register `HSPI_WPTCR` reader
pub type R = crate::R<HSPI_WPTCRrs>;
///Register `HSPI_WPTCR` writer
pub type W = crate::W<HSPI_WPTCRrs>;
...
impl W {
    ///Bits 0:4 - Number of dummy cycles This field defines the duration of the dummy phase. In both SDR and DTR modes, it specifies a number of CLK cycles (0-31). It is recommended to have at least 5 dummy cycles when using memories with DQS activated.
    #[inline(always)]
    pub fn dcyc(&mut self) -> DCYC_W<HSPI_WPTCRrs> {
        DCYC_W::new(self, 0)
    }
    ///Bit 28 - Delay hold quarter cycle Add a quarter cycle delay on the outputs in DTR communication to match hold requirement.
    #[inline(always)]
    pub fn dhqc(&mut self) -> DHQC_W<HSPI_WPTCRrs> {
        DHQC_W::new(self, 28)
    }
    ///Bit 30 - Sample shift By default, the HSPI samples data 1/2 of a CLK cycle after the data is driven by the external device. This bit allows the data to be sampled later in order to consider the external signal delays. The firmware must assure that SSHIFT=0 when the data phase is configured in DTR mode (when DDTRÂ =Â 1).
    #[inline(always)]
    pub fn sshift(&mut self) -> SSHIFT_W<HSPI_WPTCRrs> {
        SSHIFT_W::new(self, 30)
    }
}
/**HSPI wrap timing configuration register

You can [`read`](crate::Reg::read) this register and get [`hspi_wptcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hspi_wptcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#HSPI1:HSPI_WPTCR)*/
pub struct HSPI_WPTCRrs;
impl crate::RegisterSpec for HSPI_WPTCRrs {
    type Ux = u32;
}
///`read()` method returns [`hspi_wptcr::R`](R) reader structure
impl crate::Readable for HSPI_WPTCRrs {}
///`write(|w| ..)` method takes [`hspi_wptcr::W`](W) writer structure
impl crate::Writable for HSPI_WPTCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HSPI_WPTCR to value 0
impl crate::Resettable for HSPI_WPTCRrs {
