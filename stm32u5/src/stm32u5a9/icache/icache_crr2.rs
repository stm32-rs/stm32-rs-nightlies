...
pub type R = crate::R<ICACHE_CRR2rs>;
///Register `ICACHE_CRR2` writer
pub type W = crate::W<ICACHE_CRR2rs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn baseaddr(&mut self) -> BASEADDR_W<ICACHE_CRR2rs> {
        BASEADDR_W::new(self, 0)
    }
    ///Bits 9:11 - RSIZE
    #[inline(always)]
    #[must_use]
    pub fn rsize(&mut self) -> RSIZE_W<ICACHE_CRR2rs> {
        RSIZE_W::new(self, 9)
    }
    ///Bit 15 - REN
    #[inline(always)]
    #[must_use]
    pub fn ren(&mut self) -> REN_W<ICACHE_CRR2rs> {
        REN_W::new(self, 15)
    }
    ///Bits 16:26 - REMAPADDR
    #[inline(always)]
    #[must_use]
    pub fn remapaddr(&mut self) -> REMAPADDR_W<ICACHE_CRR2rs> {
        REMAPADDR_W::new(self, 16)
    }
    ///Bit 28 - MSTSEL
    #[inline(always)]
    #[must_use]
    pub fn mstsel(&mut self) -> MSTSEL_W<ICACHE_CRR2rs> {
        MSTSEL_W::new(self, 28)
    }
    ///Bit 31 - HBURST
    #[inline(always)]
    #[must_use]
    pub fn hburst(&mut self) -> HBURST_W<ICACHE_CRR2rs> {
        HBURST_W::new(self, 31)
    }
}
/**ICACHE region configuration register

You can [`read`](crate::Reg::read) this register and get [`icache_crr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icache_crr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#ICache:ICACHE_CRR2)*/
pub struct ICACHE_CRR2rs;
impl crate::RegisterSpec for ICACHE_CRR2rs {
    type Ux = u32;
}
///`read()` method returns [`icache_crr2::R`](R) reader structure
impl crate::Readable for ICACHE_CRR2rs {}
///`write(|w| ..)` method takes [`icache_crr2::W`](W) writer structure
impl crate::Writable for ICACHE_CRR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ICACHE_CRR2 to value 0x0200
impl crate::Resettable for ICACHE_CRR2rs {
