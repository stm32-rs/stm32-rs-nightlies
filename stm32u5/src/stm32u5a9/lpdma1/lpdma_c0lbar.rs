///Register `LPDMA_C0LBAR` reader
pub type R = crate::R<LPDMA_C0LBARrs>;
///Register `LPDMA_C0LBAR` writer
...
You can [`read`](crate::Reg::read) this register and get [`lpdma_c0lbar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpdma_c0lbar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#LPDMA1:LPDMA_C0LBAR)*/
pub struct LPDMA_C0LBARrs;
impl crate::RegisterSpec for LPDMA_C0LBARrs {
    type Ux = u32;
}
///`read()` method returns [`lpdma_c0lbar::R`](R) reader structure
impl crate::Readable for LPDMA_C0LBARrs {}
///`write(|w| ..)` method takes [`lpdma_c0lbar::W`](W) writer structure
impl crate::Writable for LPDMA_C0LBARrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPDMA_C0LBAR to value 0
