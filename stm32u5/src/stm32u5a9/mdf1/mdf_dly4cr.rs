///Register `MDF_DLY4CR` reader
pub type R = crate::R<MDF_DLY4CRrs>;
///Register `MDF_DLY4CR` writer
pub type W = crate::W<MDF_DLY4CRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn skpdly(&mut self) -> SKPDLY_W<MDF_DLY4CRrs> {
        SKPDLY_W::new(self, 0)
    }
}
/**This register is used for the adjustment stream delays.

You can [`read`](crate::Reg::read) this register and get [`mdf_dly4cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mdf_dly4cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#MDF1:MDF_DLY4CR)*/
pub struct MDF_DLY4CRrs;
impl crate::RegisterSpec for MDF_DLY4CRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_dly4cr::R`](R) reader structure
impl crate::Readable for MDF_DLY4CRrs {}
///`write(|w| ..)` method takes [`mdf_dly4cr::W`](W) writer structure
impl crate::Writable for MDF_DLY4CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MDF_DLY4CR to value 0
impl crate::Resettable for MDF_DLY4CRrs {
