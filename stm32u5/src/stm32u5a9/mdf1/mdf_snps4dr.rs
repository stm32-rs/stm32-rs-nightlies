///Register `MDF_SNPS4DR` reader
pub type R = crate::R<MDF_SNPS4DRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`mdf_snps4dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#MDF1:MDF_SNPS4DR)*/
pub struct MDF_SNPS4DRrs;
impl crate::RegisterSpec for MDF_SNPS4DRrs {
    type Ux = u32;
}
///`read()` method returns [`mdf_snps4dr::R`](R) reader structure
impl crate::Readable for MDF_SNPS4DRrs {}
///`reset()` method sets MDF_SNPS4DR to value 0
impl crate::Resettable for MDF_SNPS4DRrs {
