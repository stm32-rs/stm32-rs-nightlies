    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    ///Send instruction only for the first command
    #[inline(always)]
    pub fn send_only_first_cmd(self) -> &'a mut crate::W<REG> {
        self.variant(SIOO::SendOnlyFirstCmd)
    }
}
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#OCTOSPI1:CCR)*/
pub struct CCRrs;
