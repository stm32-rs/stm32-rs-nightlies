///Register `HCDMA8` reader
pub type R = crate::R<HCDMA8rs>;
///Register `HCDMA8` writer
pub type W = crate::W<HCDMA8rs>;
...
impl W {
    ///Bits 0:31 - DMA address This field holds the start address in the external memory from which the data for the endpoint must be fetched or to which it must be stored. This register is incremented on every AHB transaction.
    #[inline(always)]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<'_, HCDMA8rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#OTG_HS:HCDMA8)*/
pub struct HCDMA8rs;
impl crate::RegisterSpec for HCDMA8rs {
    type Ux = u32;
}
///`read()` method returns [`hcdma8::R`](R) reader structure
impl crate::Readable for HCDMA8rs {}
///`write(|w| ..)` method takes [`hcdma8::W`](W) writer structure
impl crate::Writable for HCDMA8rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HCDMA8 to value 0
impl crate::Resettable for HCDMA8rs {}
