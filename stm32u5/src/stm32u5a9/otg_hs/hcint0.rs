///Register `HCINT0` reader
pub type R = crate::R<HCINT0rs>;
///Register `HCINT0` writer
pub type W = crate::W<HCINT0rs>;
...
impl W {
    ///Bit 0 - XFRC
    #[inline(always)]
    pub fn xfrc(&mut self) -> XFRC_W<'_, HCINT0rs> {
        XFRC_W::new(self, 0)
    }
    ///Bit 1 - CHH
    #[inline(always)]
    pub fn chh(&mut self) -> CHH_W<'_, HCINT0rs> {
        CHH_W::new(self, 1)
    }
    ///Bit 3 - STALL
    #[inline(always)]
    pub fn stall(&mut self) -> STALL_W<'_, HCINT0rs> {
        STALL_W::new(self, 3)
    }
    ///Bit 4 - NAK
    #[inline(always)]
    pub fn nak(&mut self) -> NAK_W<'_, HCINT0rs> {
        NAK_W::new(self, 4)
    }
    ///Bit 5 - ACK
    #[inline(always)]
    pub fn ack(&mut self) -> ACK_W<'_, HCINT0rs> {
        ACK_W::new(self, 5)
    }
    ///Bit 7 - TXERR
    #[inline(always)]
    pub fn txerr(&mut self) -> TXERR_W<'_, HCINT0rs> {
        TXERR_W::new(self, 7)
    }
    ///Bit 8 - BBERR
    #[inline(always)]
    pub fn bberr(&mut self) -> BBERR_W<'_, HCINT0rs> {
        BBERR_W::new(self, 8)
    }
    ///Bit 9 - FRMOR
    #[inline(always)]
    pub fn frmor(&mut self) -> FRMOR_W<'_, HCINT0rs> {
        FRMOR_W::new(self, 9)
    }
    ///Bit 10 - DTERR
    #[inline(always)]
    pub fn dterr(&mut self) -> DTERR_W<'_, HCINT0rs> {
        DTERR_W::new(self, 10)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#OTG_HS:HCINT0)*/
pub struct HCINT0rs;
impl crate::RegisterSpec for HCINT0rs {
    type Ux = u32;
}
///`read()` method returns [`hcint0::R`](R) reader structure
impl crate::Readable for HCINT0rs {}
///`write(|w| ..)` method takes [`hcint0::W`](W) writer structure
impl crate::Writable for HCINT0rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HCINT0 to value 0
impl crate::Resettable for HCINT0rs {}
