///Register `HCTSIZ2` reader
pub type R = crate::R<HCTSIZ2rs>;
///Register `HCTSIZ2` writer
pub type W = crate::W<HCTSIZ2rs>;
...
impl W {
    ///Bits 0:18 - XFRSIZ
    #[inline(always)]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<'_, HCTSIZ2rs> {
        XFRSIZ_W::new(self, 0)
    }
    ///Bits 19:28 - PKTCNT
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, HCTSIZ2rs> {
        PKTCNT_W::new(self, 19)
    }
    ///Bits 29:30 - DPID
    #[inline(always)]
    pub fn dpid(&mut self) -> DPID_W<'_, HCTSIZ2rs> {
        DPID_W::new(self, 29)
    }
    ///Bit 31 - DOPNG
    #[inline(always)]
    pub fn dopng(&mut self) -> DOPNG_W<'_, HCTSIZ2rs> {
        DOPNG_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#OTG_HS:HCTSIZ2)*/
pub struct HCTSIZ2rs;
impl crate::RegisterSpec for HCTSIZ2rs {
    type Ux = u32;
}
///`read()` method returns [`hctsiz2::R`](R) reader structure
impl crate::Readable for HCTSIZ2rs {}
///`write(|w| ..)` method takes [`hctsiz2::W`](W) writer structure
impl crate::Writable for HCTSIZ2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets HCTSIZ2 to value 0
impl crate::Resettable for HCTSIZ2rs {}
