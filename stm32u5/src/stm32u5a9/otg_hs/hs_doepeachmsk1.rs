...
impl W {
    ///Bit 0 - XFRCM
    #[inline(always)]
    pub fn xfrcm(&mut self) -> XFRCM_W<'_, HS_DOEPEACHMSK1rs> {
        XFRCM_W::new(self, 0)
    }
    ///Bit 1 - EPDM
    #[inline(always)]
    pub fn epdm(&mut self) -> EPDM_W<'_, HS_DOEPEACHMSK1rs> {
        EPDM_W::new(self, 1)
    }
    ///Bit 2 - AHBERRM
    #[inline(always)]
    pub fn ahberrm(&mut self) -> AHBERRM_W<'_, HS_DOEPEACHMSK1rs> {
        AHBERRM_W::new(self, 2)
    }
    ///Bit 3 - STUPM
    #[inline(always)]
    pub fn stupm(&mut self) -> STUPM_W<'_, HS_DOEPEACHMSK1rs> {
        STUPM_W::new(self, 3)
    }
    ///Bit 4 - OTEPDM
    #[inline(always)]
    pub fn otepdm(&mut self) -> OTEPDM_W<'_, HS_DOEPEACHMSK1rs> {
        OTEPDM_W::new(self, 4)
    }
    ///Bit 6 - B2BSTUPM
    #[inline(always)]
    pub fn b2bstupm(&mut self) -> B2BSTUPM_W<'_, HS_DOEPEACHMSK1rs> {
        B2BSTUPM_W::new(self, 6)
    }
    ///Bit 8 - OUTPKTERRM
    #[inline(always)]
    pub fn outpkterrm(&mut self) -> OUTPKTERRM_W<'_, HS_DOEPEACHMSK1rs> {
        OUTPKTERRM_W::new(self, 8)
    }
    ///Bit 9 - BNAM
    #[inline(always)]
    pub fn bnam(&mut self) -> BNAM_W<'_, HS_DOEPEACHMSK1rs> {
        BNAM_W::new(self, 9)
    }
    ///Bit 12 - BERRM
    #[inline(always)]
    pub fn berrm(&mut self) -> BERRM_W<'_, HS_DOEPEACHMSK1rs> {
        BERRM_W::new(self, 12)
    }
    ///Bit 13 - NAKMSK
    #[inline(always)]
    pub fn nakmsk(&mut self) -> NAKMSK_W<'_, HS_DOEPEACHMSK1rs> {
        NAKMSK_W::new(self, 13)
    }
    ///Bit 14 - NYETMSK
    #[inline(always)]
    pub fn nyetmsk(&mut self) -> NYETMSK_W<'_, HS_DOEPEACHMSK1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#OTG_HS:HS_DOEPEACHMSK1)*/
