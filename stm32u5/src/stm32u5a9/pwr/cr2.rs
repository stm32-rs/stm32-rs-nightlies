...
impl From<DC2RAMPDS> for bool {
    #[inline(always)]
    fn from(variant: DC2RAMPDS) -> Self {
        variant as u8 != 0
    }
}
...
pub type DC2RAMPDS_R = crate::BitReader<DC2RAMPDS>;
impl DC2RAMPDS_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> DC2RAMPDS {
        match self.bits {
            false => DC2RAMPDS::Disabled,
            true => DC2RAMPDS::Enabled,
        }
    }
    ///DCACHE2 SRAM content retained in Stop modes
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == DC2RAMPDS::Disabled
    }
    ///DCACHE2 SRAM content lost in Stop modes
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == DC2RAMPDS::Enabled
    }
}
...
pub type DC2RAMPDS_W<'a, REG> = crate::BitWriter<'a, REG, DC2RAMPDS>;
impl<'a, REG> DC2RAMPDS_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///DCACHE2 SRAM content retained in Stop modes
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(DC2RAMPDS::Disabled)
    }
    ///DCACHE2 SRAM content lost in Stop modes
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(DC2RAMPDS::Enabled)
    }
}
...
/**PKA32 SRAM power-down in Stop modes (Stop 0, 1, 2, 3)
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum GPRAMPDS {
    ///0: Graphic peripherals SRAM content retained in Stop 0 and Stop 1 modes
    Disabled = 0,
    ///1: Graphic peripherals SRAM content lost in Stop 0 and Stop 1 modes
    Enabled = 1,
}
impl From<GPRAMPDS> for bool {
    #[inline(always)]
    fn from(variant: GPRAMPDS) -> Self {
        variant as u8 != 0
    }
}
...
pub type GPRAMPDS_R = crate::BitReader<GPRAMPDS>;
impl GPRAMPDS_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> GPRAMPDS {
        match self.bits {
            false => GPRAMPDS::Disabled,
            true => GPRAMPDS::Enabled,
        }
    }
    ///Graphic peripherals SRAM content retained in Stop 0 and Stop 1 modes
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == GPRAMPDS::Disabled
    }
    ///Graphic peripherals SRAM content lost in Stop 0 and Stop 1 modes
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == GPRAMPDS::Enabled
    }
}
...
pub type GPRAMPDS_W<'a, REG> = crate::BitWriter<'a, REG, GPRAMPDS>;
impl<'a, REG> GPRAMPDS_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Graphic peripherals SRAM content retained in Stop 0 and Stop 1 modes
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(GPRAMPDS::Disabled)
    }
    ///Graphic peripherals SRAM content lost in Stop 0 and Stop 1 modes
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(GPRAMPDS::Enabled)
    }
}
...
impl From<DSIRAMPDS> for bool {
    #[inline(always)]
    fn from(variant: DSIRAMPDS) -> Self {
        variant as u8 != 0
    }
}
...
pub type DSIRAMPDS_R = crate::BitReader<DSIRAMPDS>;
impl DSIRAMPDS_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> DSIRAMPDS {
        match self.bits {
            false => DSIRAMPDS::Disabled,
            true => DSIRAMPDS::Enabled,
        }
    }
    ///DSI SRAM content retained in Stop 0 and Stop 1 modes
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == DSIRAMPDS::Disabled
    }
    ///DSI SRAM content lost in Stop 0 and Stop 1 modes
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == DSIRAMPDS::Enabled
    }
}
...
pub type DSIRAMPDS_W<'a, REG> = crate::BitWriter<'a, REG, DSIRAMPDS>;
impl<'a, REG> DSIRAMPDS_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///DSI SRAM content retained in Stop 0 and Stop 1 modes
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(DSIRAMPDS::Disabled)
    }
    ///DSI SRAM content lost in Stop 0 and Stop 1 modes
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(DSIRAMPDS::Enabled)
    }
}
...
impl W {
    ...
    ///Bit 1 - SRAM1 page 2 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram1pds2(&mut self) -> SRAM1PDS2_W<'_, CR2rs> {
        SRAM1PDS2_W::new(self, 1)
    }
    ///Bit 2 - SRAM1 page 3 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram1pds3(&mut self) -> SRAM1PDS3_W<'_, CR2rs> {
    ...
    ///Bit 5 - SRAM2 page 2 (56 Kbytes) power-down in Stop modes (Stop 0, 1, 2) Note: The SRAM2 page 2 retention in Stop 3 is controlled by RRSB2 bit in PWR_CR1.
    #[inline(always)]
    pub fn sram2pds2(&mut self) -> SRAM2PDS2_W<'_, CR2rs> {
        SRAM2PDS2_W::new(self, 5)
    }
    ///Bit 6 - SRAM4 power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram4pds(&mut self) -> SRAM4PDS_W<'_, CR2rs> {
        SRAM4PDS_W::new(self, 6)
    }
    ///Bit 7 - DCACHE2 SRAM power-down in Stop modes (Stop 0, 1, 2, 3) Note: This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585.
    #[inline(always)]
    pub fn dc2rampds(&mut self) -> DC2RAMPDS_W<'_, CR2rs> {
    ...
    ///Bit 9 - DCACHE1 SRAM power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn dc1rampds(&mut self) -> DC1RAMPDS_W<'_, CR2rs> {
        DC1RAMPDS_W::new(self, 9)
    }
    ///Bit 10 - DMA2D SRAM power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn dma2drampds(&mut self) -> DMA2DRAMPDS_W<'_, CR2rs> {
        DMA2DRAMPDS_W::new(self, 10)
    }
    ///Bit 11 - FMAC, FDCAN and USB peripherals SRAM power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn prampds(&mut self) -> PRAMPDS_W<'_, CR2rs> {
        PRAMPDS_W::new(self, 11)
    }
    ///Bit 12 - PKA32 SRAM power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn pkarampds(&mut self) -> PKARAMPDS_W<'_, CR2rs> {
        PKARAMPDS_W::new(self, 12)
    }
    ///Bit 13 - SRAM4 fast wakeup from Stop 0, Stop 1 and Stop 2 modes This bit is used to obtain the best trade-off between low-power consumption and wakeup time. SRAM4 wakeup time increases the wakeup time when exiting Stop 0, 1 and 2 modes, and also increases the LPDMA access time to SRAM4 during Stop modes.
    #[inline(always)]
    pub fn sram4fwu(&mut self) -> SRAM4FWU_W<'_, CR2rs> {
    ...
    ///Bit 16 - SRAM3 page 1 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram3pds1(&mut self) -> SRAM3PDS1_W<'_, CR2rs> {
        SRAM3PDS1_W::new(self, 16)
    }
    ///Bit 17 - SRAM3 page 2 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram3pds2(&mut self) -> SRAM3PDS2_W<'_, CR2rs> {
        SRAM3PDS2_W::new(self, 17)
    }
    ///Bit 18 - SRAM3 page 3 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram3pds3(&mut self) -> SRAM3PDS3_W<'_, CR2rs> {
        SRAM3PDS3_W::new(self, 18)
    }
    ///Bit 19 - SRAM3 page 4 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram3pds4(&mut self) -> SRAM3PDS4_W<'_, CR2rs> {
        SRAM3PDS4_W::new(self, 19)
    }
    ///Bit 20 - SRAM3 page 5 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram3pds5(&mut self) -> SRAM3PDS5_W<'_, CR2rs> {
        SRAM3PDS5_W::new(self, 20)
    }
    ///Bit 21 - SRAM3 page 6 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram3pds6(&mut self) -> SRAM3PDS6_W<'_, CR2rs> {
        SRAM3PDS6_W::new(self, 21)
    }
    ///Bit 22 - SRAM3 page 7 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram3pds7(&mut self) -> SRAM3PDS7_W<'_, CR2rs> {
        SRAM3PDS7_W::new(self, 22)
    }
    ///Bit 23 - SRAM3 page 8 (64 Kbytes) power-down in Stop modes (Stop 0, 1, 2, 3)
    #[inline(always)]
    pub fn sram3pds8(&mut self) -> SRAM3PDS8_W<'_, CR2rs> {
        SRAM3PDS8_W::new(self, 23)
    }
    ///Bit 24 - Graphic peripherals (LTDC, GFXMMU) SRAM power-down in Stop modes (Stop 0, 1, 2, 3) Note: LTDC SRAM content is always lost in Stop 2 and Stop 3 modes. It can be retained only in Stop 0 and Stop 1 modes. This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585.
    #[inline(always)]
    pub fn gprampds(&mut self) -> GPRAMPDS_W<'_, CR2rs> {
        GPRAMPDS_W::new(self, 24)
    }
    ///Bit 25 - DSI SRAM power-down in Stop modes (Stop 0, 1) DSI SRAM content is always lost in Stop 2 and Stop 3 modes. Note: This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585.
    #[inline(always)]
    pub fn dsirampds(&mut self) -> DSIRAMPDS_W<'_, CR2rs> {
        DSIRAMPDS_W::new(self, 25)
    }
    ///Bit 31 - SmartRun domain in Run mode
    #[inline(always)]
    pub fn srdrun(&mut self) -> SRDRUN_W<'_, CR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#PWR:CR2)*/
pub struct CR2rs;
