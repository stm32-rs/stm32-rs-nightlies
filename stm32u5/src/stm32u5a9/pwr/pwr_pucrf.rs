...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pu4(&mut self) -> PU4_W<PWR_PUCRFrs> {
        PU4_W::new(self, 4)
    }
    ///Bit 5
    #[inline(always)]
    #[must_use]
    pub fn pu5(&mut self) -> PU5_W<PWR_PUCRFrs> {
        PU5_W::new(self, 5)
    }
    ///Bit 6
    #[inline(always)]
    #[must_use]
    pub fn pu6(&mut self) -> PU6_W<PWR_PUCRFrs> {
        PU6_W::new(self, 6)
    }
    ///Bit 7
    #[inline(always)]
    #[must_use]
    pub fn pu7(&mut self) -> PU7_W<PWR_PUCRFrs> {
        PU7_W::new(self, 7)
    }
    ///Bit 8
    #[inline(always)]
    #[must_use]
    pub fn pu8(&mut self) -> PU8_W<PWR_PUCRFrs> {
        PU8_W::new(self, 8)
    }
    ///Bit 9
    #[inline(always)]
    #[must_use]
    pub fn pu9(&mut self) -> PU9_W<PWR_PUCRFrs> {
        PU9_W::new(self, 9)
    }
    ///Bit 10
    #[inline(always)]
    #[must_use]
    pub fn pu10(&mut self) -> PU10_W<PWR_PUCRFrs> {
        PU10_W::new(self, 10)
    }
    ///Bit 11
    #[inline(always)]
    #[must_use]
    pub fn pu11(&mut self) -> PU11_W<PWR_PUCRFrs> {
        PU11_W::new(self, 11)
    }
    ///Bit 12
    #[inline(always)]
    #[must_use]
    pub fn pu12(&mut self) -> PU12_W<PWR_PUCRFrs> {
        PU12_W::new(self, 12)
    }
    ///Bit 13
    #[inline(always)]
    #[must_use]
    pub fn pu13(&mut self) -> PU13_W<PWR_PUCRFrs> {
        PU13_W::new(self, 13)
    }
    ///Bit 14
    #[inline(always)]
    #[must_use]
    pub fn pu14(&mut self) -> PU14_W<PWR_PUCRFrs> {
        PU14_W::new(self, 14)
    }
    ///Bit 15
    #[inline(always)]
    #[must_use]
    pub fn pu15(&mut self) -> PU15_W<PWR_PUCRFrs> {
        PU15_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#PWR:PWR_PUCRF)*/
