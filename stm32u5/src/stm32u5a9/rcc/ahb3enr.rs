...
impl W {
    ///Bit 0 - LPGPIO1 enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn lpgpio1en(&mut self) -> LPGPIO1EN_W<'_, AHB3ENRrs> {
        LPGPIO1EN_W::new(self, 0)
    }
    ///Bit 2 - PWR clock enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn pwren(&mut self) -> PWREN_W<'_, AHB3ENRrs> {
        PWREN_W::new(self, 2)
    }
    ///Bit 5 - ADC4 clock enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn adc4en(&mut self) -> ADC4EN_W<'_, AHB3ENRrs> {
        ADC4EN_W::new(self, 5)
    }
    ///Bit 6 - DAC1 clock enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn dac1en(&mut self) -> DAC1EN_W<'_, AHB3ENRrs> {
        DAC1EN_W::new(self, 6)
    }
    ///Bit 9 - LPDMA1 clock enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn lpdma1en(&mut self) -> LPDMA1EN_W<'_, AHB3ENRrs> {
        LPDMA1EN_W::new(self, 9)
    }
    ///Bit 10 - ADF1 clock enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn adf1en(&mut self) -> ADF1EN_W<'_, AHB3ENRrs> {
        ADF1EN_W::new(self, 10)
    }
    ///Bit 12 - GTZC2 clock enable This bit is set and cleared by software.
    #[inline(always)]
    pub fn gtzc2en(&mut self) -> GTZC2EN_W<'_, AHB3ENRrs> {
        GTZC2EN_W::new(self, 12)
    }
    ///Bit 31 - SRAM4 clock enable This bit is set and reset by software.
    #[inline(always)]
    pub fn sram4en(&mut self) -> SRAM4EN_W<'_, AHB3ENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#RCC:AHB3ENR)*/
