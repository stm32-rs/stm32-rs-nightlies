...
impl RegisterBlock {
    ...
    #[doc = "0x74 - SYSCFG USB OTG_HS PHY register"]
    #[inline(always)]
...
pub mod rsscmdr;
#[doc = "OTGHSPHYCR (rw) register accessor: SYSCFG USB OTG_HS PHY register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`otghsphycr::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`otghsphycr::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otghsphycr`]
module"]
