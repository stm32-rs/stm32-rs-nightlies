...
#[doc = "Field `CLL` reader - LOCKUP (hardfault) output enable bit"]
...
#[doc = "Field `SPL` reader - SRAM ECC lock bit"]
pub type SPL_R = crate::BitReader;
#[doc = "Field `SPL` writer - SRAM ECC lock bit"]
