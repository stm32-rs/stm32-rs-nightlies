...
///Field `SMS_bit3` reader - Slave mode selection - bit 3
pub type SMS_BIT3_R = crate::BitReader;
///Field `SMS_bit3` writer - Slave mode selection - bit 3
pub type SMS_BIT3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    ///Bit 16 - Slave mode selection - bit 3
    #[inline(always)]
    pub fn sms_bit3(&mut self) -> SMS_BIT3_W<SMCRrs> {
        SMS_BIT3_W::new(self, 16)
    }
    ///Bits 20:21 - Trigger selection
    #[inline(always)]
