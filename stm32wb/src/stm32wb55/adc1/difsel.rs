...
///Field `DIFSEL0` reader - ADC channel differential or single-ended mode for channel 0
...
///Field `DIFSEL0` writer - ADC channel differential or single-ended mode for channel 0
...
///Field `DIFSEL1` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL1_R;
///Field `DIFSEL2` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL2_R;
///Field `DIFSEL3` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL3_R;
///Field `DIFSEL4` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL4_R;
///Field `DIFSEL5` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL5_R;
///Field `DIFSEL6` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL6_R;
///Field `DIFSEL7` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL7_R;
///Field `DIFSEL8` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL8_R;
///Field `DIFSEL9` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL9_R;
///Field `DIFSEL10` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL10_R;
///Field `DIFSEL11` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL11_R;
///Field `DIFSEL12` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL12_R;
///Field `DIFSEL13` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL13_R;
///Field `DIFSEL14` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL14_R;
///Field `DIFSEL15` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL15_R;
///Field `DIFSEL16` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL16_R;
///Field `DIFSEL17` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL17_R;
///Field `DIFSEL18` reader - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_R as DIFSEL18_R;
///Field `DIFSEL1` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL1_W;
///Field `DIFSEL2` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL2_W;
///Field `DIFSEL3` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL3_W;
///Field `DIFSEL4` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL4_W;
///Field `DIFSEL5` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL5_W;
///Field `DIFSEL6` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL6_W;
///Field `DIFSEL7` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL7_W;
///Field `DIFSEL8` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL8_W;
///Field `DIFSEL9` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL9_W;
///Field `DIFSEL10` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL10_W;
///Field `DIFSEL11` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL11_W;
///Field `DIFSEL12` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL12_W;
///Field `DIFSEL13` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL13_W;
///Field `DIFSEL14` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL14_W;
///Field `DIFSEL15` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL15_W;
///Field `DIFSEL16` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL16_W;
///Field `DIFSEL17` writer - ADC channel differential or single-ended mode for channel 0
pub use DIFSEL0_W as DIFSEL17_W;
///Field `DIFSEL18` writer - ADC channel differential or single-ended mode for channel 0
...
impl R {
    ...
    ///Bit 1 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel1(&self) -> DIFSEL1_R {
        DIFSEL1_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel2(&self) -> DIFSEL2_R {
        DIFSEL2_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel3(&self) -> DIFSEL3_R {
        DIFSEL3_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel4(&self) -> DIFSEL4_R {
        DIFSEL4_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel5(&self) -> DIFSEL5_R {
        DIFSEL5_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel6(&self) -> DIFSEL6_R {
        DIFSEL6_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel7(&self) -> DIFSEL7_R {
        DIFSEL7_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel8(&self) -> DIFSEL8_R {
        DIFSEL8_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel9(&self) -> DIFSEL9_R {
        DIFSEL9_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel10(&self) -> DIFSEL10_R {
        DIFSEL10_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel11(&self) -> DIFSEL11_R {
        DIFSEL11_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel12(&self) -> DIFSEL12_R {
        DIFSEL12_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel13(&self) -> DIFSEL13_R {
        DIFSEL13_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel14(&self) -> DIFSEL14_R {
        DIFSEL14_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel15(&self) -> DIFSEL15_R {
        DIFSEL15_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bit 16 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel16(&self) -> DIFSEL16_R {
        DIFSEL16_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
    pub fn difsel17(&self) -> DIFSEL17_R {
        DIFSEL17_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - ADC channel differential or single-ended mode for channel 0
    #[inline(always)]
