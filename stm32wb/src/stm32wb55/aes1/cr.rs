...
pub type CHMOD10_R = crate::FieldReader;
///Field `CHMOD10` writer - AES chaining mode Bit1 Bit0
pub type CHMOD10_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#AES1:CR)*/
pub struct CRrs;
