...
impl W {
    ///Bit 0 - LPTIM2 counter stopped when core is halted
    #[inline(always)]
    pub fn dbg_lptim2_stop(&mut self) -> DBG_LPTIM2_STOP_W<'_, C2AP_B1FZR1rs> {
        DBG_LPTIM2_STOP_W::new(self, 0)
    }
    ///Bit 10 - RTC counter stopped when core is halted
    #[inline(always)]
    pub fn dbg_rtc_stop(&mut self) -> DBG_RTC_STOP_W<'_, C2AP_B1FZR1rs> {
        DBG_RTC_STOP_W::new(self, 10)
    }
    ///Bit 12 - IWDG stopped when core is halted
    #[inline(always)]
    pub fn dbg_iwdg_stop(&mut self) -> DBG_IWDG_STOP_W<'_, C2AP_B1FZR1rs> {
        DBG_IWDG_STOP_W::new(self, 12)
    }
    ///Bit 21 - I2C1 SMBUS timeout stopped when core is halted
    #[inline(always)]
    pub fn dbg_i2c1_stop(&mut self) -> DBG_I2C1_STOP_W<'_, C2AP_B1FZR1rs> {
        DBG_I2C1_STOP_W::new(self, 21)
    }
    ///Bit 23 - I2C3 SMBUS timeout stopped when core is halted
    #[inline(always)]
    pub fn dbg_i2c3_stop(&mut self) -> DBG_I2C3_STOP_W<'_, C2AP_B1FZR1rs> {
        DBG_I2C3_STOP_W::new(self, 23)
    }
    ///Bit 31 - LPTIM1 counter stopped when core is halted
    #[inline(always)]
    pub fn dbg_lptim1_stop(&mut self) -> DBG_LPTIM1_STOP_W<'_, C2AP_B1FZR1rs> {
        DBG_LPTIM1_STOP_W::new(self, 31)
    }
}
/**APB1 Low Freeze Register CPU2

You can [`read`](crate::Reg::read) this register and get [`c2ap_b1fzr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c2ap_b1fzr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
