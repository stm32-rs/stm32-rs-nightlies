...
pub mod ccr;
/**CSR (r) register accessor: DMA Multiplexer Channel Status register
...
pub mod csr;
/**CFR (w) register accessor: DMA Channel Clear Flag Register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#DMAMUX1:RGCR[0])
...
pub mod rgsr;
/**RGCFR (r) register accessor: DMA Request Generator Clear Flag Register

You can [`read`](crate::Reg::read) this register and get [`rgcfr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
