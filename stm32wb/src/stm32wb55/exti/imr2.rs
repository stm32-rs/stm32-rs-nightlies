...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn im0(&mut self) -> IM0_W<IMR2rs> {
        IM0_W::new(self, 0)
    }
    #[doc = "Bit 1 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im1(&mut self) -> IM1_W<IMR2rs> {
        IM1_W::new(self, 1)
    }
    #[doc = "Bit 2 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im2(&mut self) -> IM2_W<IMR2rs> {
        IM2_W::new(self, 2)
    }
    #[doc = "Bit 3 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im3(&mut self) -> IM3_W<IMR2rs> {
        IM3_W::new(self, 3)
    }
    #[doc = "Bit 4 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im4(&mut self) -> IM4_W<IMR2rs> {
        IM4_W::new(self, 4)
    }
    #[doc = "Bit 5 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im5(&mut self) -> IM5_W<IMR2rs> {
        IM5_W::new(self, 5)
    }
    #[doc = "Bit 6 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im6(&mut self) -> IM6_W<IMR2rs> {
        IM6_W::new(self, 6)
    }
    #[doc = "Bit 7 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im7(&mut self) -> IM7_W<IMR2rs> {
        IM7_W::new(self, 7)
    }
    #[doc = "Bit 8 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im8(&mut self) -> IM8_W<IMR2rs> {
        IM8_W::new(self, 8)
    }
    #[doc = "Bit 9 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im9(&mut self) -> IM9_W<IMR2rs> {
        IM9_W::new(self, 9)
    }
    #[doc = "Bit 10 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im10(&mut self) -> IM10_W<IMR2rs> {
        IM10_W::new(self, 10)
    }
    #[doc = "Bit 11 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im11(&mut self) -> IM11_W<IMR2rs> {
        IM11_W::new(self, 11)
    }
    #[doc = "Bit 12 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im12(&mut self) -> IM12_W<IMR2rs> {
        IM12_W::new(self, 12)
    }
    #[doc = "Bit 13 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im13(&mut self) -> IM13_W<IMR2rs> {
        IM13_W::new(self, 13)
    }
    #[doc = "Bit 14 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im14(&mut self) -> IM14_W<IMR2rs> {
        IM14_W::new(self, 14)
    }
    #[doc = "Bit 15 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im15(&mut self) -> IM15_W<IMR2rs> {
        IM15_W::new(self, 15)
    }
    #[doc = "Bit 16 - CPUm Wakeup with interrupt Mask on Event input"]
    #[inline(always)]
    #[must_use]
    pub fn im16(&mut self) -> IM16_W<IMR2rs> {
        IM16_W::new(self, 16)
    }
}
