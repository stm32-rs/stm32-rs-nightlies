...
pub type AGC_TRIM_R = crate::FieldReader;
///Field `AGC_TRIM` writer - Radio Automatic Gain Control Trimming
pub type AGC_TRIM_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
...
impl W {
    ...
    ///Bits 29:31 - Radio Automatic Gain Control Trimming
    #[inline(always)]
    pub fn agc_trim(&mut self) -> AGC_TRIM_W<'_, OPTRrs> {
        AGC_TRIM_W::new(self, 29)
    }
}
...
impl crate::Resettable for OPTRrs {
    const RESET_VALUE: u32 = 0x1070_8000;
}
