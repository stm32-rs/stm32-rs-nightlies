...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#HSEM:R[0])
...
pub mod rlr;
/**CR (rw) register accessor: Semaphore Clear register
...
pub mod cr;
/**KEYR (rw) register accessor: Interrupt clear register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#HSEM:KEYR)

For information about available fields see [`mod@keyr`] module*/
pub type KEYR = crate::Reg<keyr::KEYRrs>;
///Interrupt clear register
pub mod keyr;
/**HWCFGR2 (r) register accessor: Semaphore hardware configuration register 2

You can [`read`](crate::Reg::read) this register and get [`hwcfgr2::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#HSEM:HWCFGR2)
...
pub mod hwcfgr2;
/**HWCFGR1 (r) register accessor: Semaphore hardware configuration register 1
...
pub mod ipidr;
/**SIDR (r) register accessor: HSEM size indentification register

You can [`read`](crate::Reg::read) this register and get [`sidr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#HSEM:SIDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#HSEM:C2IER)
