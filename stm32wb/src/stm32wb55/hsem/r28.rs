#[doc = "Register `R28` reader"]
pub struct R(crate::R<R28_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R28_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R28_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R28_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R28` writer"]
pub struct W(crate::W<R28_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R28_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R28_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R28_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Semaphore 28 register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [r28](index.html) module"]
pub struct R28_SPEC;
impl crate::RegisterSpec for R28_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [r28::R](R) reader structure"]
impl crate::Readable for R28_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r28::W](W) writer structure"]
impl crate::Writable for R28_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R28 to value 0"]
impl crate::Resettable for R28_SPEC {
    #[inline(always)]
