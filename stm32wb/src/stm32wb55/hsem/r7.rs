...
#[doc = "`read()` method returns [r7::R](R) reader structure"]
impl crate::Readable for R7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r7::W](W) writer structure"]
impl crate::Writable for R7_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R7 to value 0"]
