...
#[doc = "`read()` method returns [r8::R](R) reader structure"]
impl crate::Readable for R8_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r8::W](W) writer structure"]
impl crate::Writable for R8_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R8 to value 0"]
