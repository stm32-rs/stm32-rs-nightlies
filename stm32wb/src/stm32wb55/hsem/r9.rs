...
#[doc = "`read()` method returns [r9::R](R) reader structure"]
impl crate::Readable for R9_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r9::W](W) writer structure"]
impl crate::Writable for R9_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R9 to value 0"]
