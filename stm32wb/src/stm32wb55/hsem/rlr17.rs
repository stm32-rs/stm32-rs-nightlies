#[doc = "Register `RLR17` reader"]
pub struct R(crate::R<RLR17_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR17_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR17_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR17_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Semaphore 17 read lock register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rlr17](index.html) module"]
pub struct RLR17_SPEC;
impl crate::RegisterSpec for RLR17_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rlr17::R](R) reader structure"]
impl crate::Readable for RLR17_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RLR17 to value 0"]
impl crate::Resettable for RLR17_SPEC {
    #[inline(always)]
