#[doc = "Register `RLR20` reader"]
pub struct R(crate::R<RLR20_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR20_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR20_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR20_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Semaphore 20 read lock register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rlr20](index.html) module"]
pub struct RLR20_SPEC;
impl crate::RegisterSpec for RLR20_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rlr20::R](R) reader structure"]
impl crate::Readable for RLR20_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RLR20 to value 0"]
impl crate::Resettable for RLR20_SPEC {
    #[inline(always)]
