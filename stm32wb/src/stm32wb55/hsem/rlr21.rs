#[doc = "Register `RLR21` reader"]
pub struct R(crate::R<RLR21_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR21_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR21_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR21_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Semaphore 21 read lock register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rlr21](index.html) module"]
pub struct RLR21_SPEC;
impl crate::RegisterSpec for RLR21_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rlr21::R](R) reader structure"]
impl crate::Readable for RLR21_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RLR21 to value 0"]
impl crate::Resettable for RLR21_SPEC {
    #[inline(always)]
