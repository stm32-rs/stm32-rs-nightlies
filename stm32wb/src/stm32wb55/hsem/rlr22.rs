#[doc = "Register `RLR22` reader"]
pub struct R(crate::R<RLR22_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR22_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR22_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR22_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Semaphore 22 read lock register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rlr22](index.html) module"]
pub struct RLR22_SPEC;
impl crate::RegisterSpec for RLR22_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rlr22::R](R) reader structure"]
impl crate::Readable for RLR22_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RLR22 to value 0"]
impl crate::Resettable for RLR22_SPEC {
    #[inline(always)]
