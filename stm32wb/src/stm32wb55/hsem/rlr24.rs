#[doc = "Register `RLR24` reader"]
pub struct R(crate::R<RLR24_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR24_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR24_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR24_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Semaphore 24 read lock register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rlr24](index.html) module"]
pub struct RLR24_SPEC;
impl crate::RegisterSpec for RLR24_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rlr24::R](R) reader structure"]
impl crate::Readable for RLR24_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RLR24 to value 0"]
impl crate::Resettable for RLR24_SPEC {
    #[inline(always)]
