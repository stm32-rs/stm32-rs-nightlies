#[doc = "Register `RLR27` reader"]
pub struct R(crate::R<RLR27_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR27_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR27_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR27_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Semaphore 27 read lock register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rlr27](index.html) module"]
pub struct RLR27_SPEC;
impl crate::RegisterSpec for RLR27_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rlr27::R](R) reader structure"]
impl crate::Readable for RLR27_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RLR27 to value 0"]
impl crate::Resettable for RLR27_SPEC {
    #[inline(always)]
