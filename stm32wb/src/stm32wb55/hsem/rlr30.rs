#[doc = "Register `RLR30` reader"]
pub struct R(crate::R<RLR30_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR30_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR30_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR30_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Semaphore 30 read lock register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rlr30](index.html) module"]
pub struct RLR30_SPEC;
impl crate::RegisterSpec for RLR30_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rlr30::R](R) reader structure"]
impl crate::Readable for RLR30_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RLR30 to value 0"]
impl crate::Resettable for RLR30_SPEC {
    #[inline(always)]
