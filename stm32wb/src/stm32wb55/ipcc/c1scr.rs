...
impl core::fmt::Debug for crate::generic::Reg<C1SCRrs> {
...
impl W {
    ...
    #[inline(always)]
    pub fn ch1c(&mut self) -> CH1C_W<'_, C1SCRrs> {
        CH1C_W::new(self, 0)
    }
    ///Bit 1 - processor 1 Receive channel 2 status clear
    #[inline(always)]
    pub fn ch2c(&mut self) -> CH2C_W<'_, C1SCRrs> {
        CH2C_W::new(self, 1)
    }
    ///Bit 2 - processor 1 Receive channel 3 status clear
    #[inline(always)]
    pub fn ch3c(&mut self) -> CH3C_W<'_, C1SCRrs> {
        CH3C_W::new(self, 2)
    }
    ///Bit 3 - processor 1 Receive channel 4 status clear
    #[inline(always)]
    pub fn ch4c(&mut self) -> CH4C_W<'_, C1SCRrs> {
        CH4C_W::new(self, 3)
    }
    ///Bit 4 - processor 1 Receive channel 5 status clear
    #[inline(always)]
    pub fn ch5c(&mut self) -> CH5C_W<'_, C1SCRrs> {
        CH5C_W::new(self, 4)
    }
    ///Bit 5 - processor 1 Receive channel 6 status clear
    #[inline(always)]
    pub fn ch6c(&mut self) -> CH6C_W<'_, C1SCRrs> {
        CH6C_W::new(self, 5)
    }
    ///Bit 16 - processor 1 Transmit channel 1 status set
    #[inline(always)]
    pub fn ch1s(&mut self) -> CH1S_W<'_, C1SCRrs> {
        CH1S_W::new(self, 16)
    }
    ///Bit 17 - processor 1 Transmit channel 2 status set
    #[inline(always)]
    pub fn ch2s(&mut self) -> CH2S_W<'_, C1SCRrs> {
        CH2S_W::new(self, 17)
    }
    ///Bit 18 - processor 1 Transmit channel 3 status set
    #[inline(always)]
    pub fn ch3s(&mut self) -> CH3S_W<'_, C1SCRrs> {
        CH3S_W::new(self, 18)
    }
    ///Bit 19 - processor 1 Transmit channel 4 status set
    #[inline(always)]
    pub fn ch4s(&mut self) -> CH4S_W<'_, C1SCRrs> {
        CH4S_W::new(self, 19)
    }
    ///Bit 20 - processor 1 Transmit channel 5 status set
    #[inline(always)]
    pub fn ch5s(&mut self) -> CH5S_W<'_, C1SCRrs> {
        CH5S_W::new(self, 20)
    }
    ///Bit 21 - processor 1 Transmit channel 6 status set
    #[inline(always)]
    pub fn ch6s(&mut self) -> CH6S_W<'_, C1SCRrs> {
        CH6S_W::new(self, 21)
    }
}
/**Status Set or Clear register CPU1

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c1scr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
