...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:CR4)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:PUCRA)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:PDCRA)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:PUCRB)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:PDCRB)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:PUCRC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:PDCRC)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:PUCRD)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:PDCRD)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#PWR:PDCRH)
...
pub mod pdcrh;
/**C2CR1 (rw) register accessor: CPU2 Power control register 1
...
For information about available fields see [`mod@c2cr1`]
module*/
pub type C2CR1 = crate::Reg<c2cr1::C2CR1rs>;
///CPU2 Power control register 1
pub mod c2cr1;
/**C2CR3 (rw) register accessor: CPU2 Power control register 3
...
For information about available fields see [`mod@c2cr3`]
module*/
pub type C2CR3 = crate::Reg<c2cr3::C2CR3rs>;
///CPU2 Power control register 3
pub mod c2cr3;
/**EXTSCR (rw) register accessor: Power status clear register
