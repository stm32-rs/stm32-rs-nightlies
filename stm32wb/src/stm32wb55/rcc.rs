...
pub struct RegisterBlock {
    ...
    pub smpscr: crate::Reg<smpscr::SMPSCR_SPEC>,
    ...
    pub hsecr: crate::Reg<hsecr::HSECR_SPEC>,
    _reserved33: [u8; 0x68],
...
pub mod cicr;
#[doc = "SMPSCR register accessor: an alias for `Reg<SMPSCR_SPEC>`"]
...
pub mod crrcr;
#[doc = "HSECR register accessor: an alias for `Reg<HSECR_SPEC>`"]
