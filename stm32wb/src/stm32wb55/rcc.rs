...
#[doc(hidden)]
pub struct _SMPSCR;
#[doc = "`read()` method returns [smpscr::R](smpscr::R) reader structure"]
impl crate::Readable for SMPSCR {}
#[doc = "`write(|w| ..)` method takes [smpscr::W](smpscr::W) writer structure"]
...
#[doc(hidden)]
pub struct _HSECR;
#[doc = "`read()` method returns [hsecr::R](hsecr::R) reader structure"]
impl crate::Readable for HSECR {}
#[doc = "`write(|w| ..)` method takes [hsecr::W](hsecr::W) writer structure"]
