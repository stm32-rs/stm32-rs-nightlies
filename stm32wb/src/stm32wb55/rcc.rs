...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn smpscr(&self) -> &SMPSCR {
        &self.smpscr
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:ICSCR)
...
pub mod cfgr;
/**PLLCFGR (rw) register accessor: PLLSYS configuration register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:CICR)
...
pub mod cicr;
/**SMPSCR (rw) register accessor: Step Down converter control register
...
For information about available fields see [`mod@smpscr`]
module*/
pub type SMPSCR = crate::Reg<smpscr::SMPSCRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:AHB1RSTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:APB1RSTR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:APB2RSTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:AHB2SMENR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:APB1SMENR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:BDCR)
...
pub mod crrcr;
/**HSECR (rw) register accessor: Clock HSE register
...
For information about available fields see [`mod@hsecr`]
module*/
pub type HSECR = crate::Reg<hsecr::HSECRrs>;
///Clock HSE register
pub mod hsecr;
...
pub mod c2ahb2enr;
/**C2AHB3ENR (rw) register accessor: CPU2 AHB3 peripheral clock enable register
...
pub mod c2ahb3enr;
/**C2APB1ENR1 (rw) register accessor: CPU2 APB1ENR1
...
///CPU2 APB1ENR1
pub mod c2apb1enr1;
/**C2APB1ENR2 (rw) register accessor: CPU2 APB1 peripheral clock enable register 2
...
pub mod c2apb1enr2;
/**C2APB2ENR (rw) register accessor: CPU2 APB2ENR
...
///CPU2 APB2ENR
pub mod c2apb2enr;
/**C2APB3ENR (rw) register accessor: CPU2 APB3ENR
...
///CPU2 APB3ENR
pub mod c2apb3enr;
/**C2AHB1SMENR (rw) register accessor: CPU2 AHB1 peripheral clocks enable in Sleep and Stop modes register
...
pub mod c2ahb1smenr;
/**C2AHB2SMENR (rw) register accessor: CPU2 AHB2 peripheral clocks enable in Sleep and Stop modes register
...
pub mod c2ahb2smenr;
/**C2AHB3SMENR (rw) register accessor: CPU2 AHB3 peripheral clocks enable in Sleep and Stop modes register
...
pub mod c2ahb3smenr;
/**C2APB1SMENR1 (rw) register accessor: CPU2 APB1SMENR1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:C2APB1SMENR1)
...
/**C2APB1SMENR2 (rw) register accessor: CPU2 APB1 peripheral clocks enable in Sleep and Stop modes register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:C2APB1SMENR2)
...
/**C2APB2SMENR (rw) register accessor: CPU2 APB2SMENR
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:C2APB2SMENR)
...
///CPU2 APB2SMENR
pub mod c2apb2smenr;
/**C2APB3SMENR (rw) register accessor: CPU2 APB3SMENR
...
///CPU2 APB3SMENR
pub mod c2apb3smenr;
/**HSECR_KEY (w) register accessor:

You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hsecr_key::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:HSECR_KEY)

For information about available fields see [`mod@hsecr_key`]
module*/
pub type HSECR_KEY = crate::Reg<hsecr_key::HSECR_KEYrs>;
///
pub mod hsecr_key;
