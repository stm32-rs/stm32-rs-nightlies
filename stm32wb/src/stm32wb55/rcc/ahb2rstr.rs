...
pub use GPIOARST_R as AES1RST_R;
...
pub use GPIOARST_W as AES1RST_W;
impl R {
...
impl W {
    ...
    ///Bit 16 - AES1 hardware accelerator reset
    #[inline(always)]
    pub fn aes1rst(&mut self) -> AES1RST_W<'_, AHB2RSTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:AHB2RSTR)*/
