...
impl crate::FieldSpec for LSCOSEL {
    type Ux = u8;
}
impl crate::IsEnum for LSCOSEL {}
///Field `LSCOSEL` reader - Low speed clock output selection
pub type LSCOSEL_R = crate::FieldReader<LSCOSEL>;
impl LSCOSEL_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> Option<LSCOSEL> {
        match self.bits {
            0 => Some(LSCOSEL::Lsi),
            1 => Some(LSCOSEL::Lse),
            _ => None,
...
pub type LSCOSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2, LSCOSEL>;
