...
pub struct LSCOSEL_R(crate::FieldReader<u8, u8>);
impl LSCOSEL_R {
...
pub struct LSECSSD__R(crate::FieldReader<bool, bool>);
impl LSECSSD__R {
    pub(crate) fn new(bits: bool) -> Self {
        LSECSSD__R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LSECSSD__R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
