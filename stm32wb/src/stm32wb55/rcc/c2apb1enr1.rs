...
impl W {
    ...
    ///Bit 9 - CPU2 LCD clock enable
    #[inline(always)]
    pub fn lcden(&mut self) -> LCDEN_W<'_, C2APB1ENR1rs> {
        LCDEN_W::new(self, 9)
    }
    ///Bit 10 - CPU2 RTC APB clock enable
    #[inline(always)]
    ...
    ///Bit 14 - CPU2 SPI2 clock enable
    #[inline(always)]
    pub fn spi2en(&mut self) -> SPI2EN_W<'_, C2APB1ENR1rs> {
    ...
    ///Bit 24 - CPU2 CRS clock enable
    #[inline(always)]
    pub fn crsen(&mut self) -> CRSEN_W<'_, C2APB1ENR1rs> {
        CRSEN_W::new(self, 24)
    }
    ///Bit 26 - CPU2 USB clock enable
    #[inline(always)]
    pub fn usben(&mut self) -> USBEN_W<'_, C2APB1ENR1rs> {
        USBEN_W::new(self, 26)
    }
    ///Bit 31 - CPU2 Low power timer 1 clock enable
    #[inline(always)]
