...
impl W {
    ///Bit 0 - TIM2 timer clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn tim2smen(&mut self) -> TIM2SMEN_W<'_, C2APB1SMENR1rs> {
        TIM2SMEN_W::new(self, 0)
    }
    ///Bit 9 - LCD clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn lcdsmen(&mut self) -> LCDSMEN_W<'_, C2APB1SMENR1rs> {
        LCDSMEN_W::new(self, 9)
    }
    ///Bit 10 - RTC APB clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn rtcapbsmen(&mut self) -> RTCAPBSMEN_W<'_, C2APB1SMENR1rs> {
        RTCAPBSMEN_W::new(self, 10)
    }
    ///Bit 14 - SPI2 clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn spi2smen(&mut self) -> SPI2SMEN_W<'_, C2APB1SMENR1rs> {
        SPI2SMEN_W::new(self, 14)
    }
    ///Bit 21 - I2C1 clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn i2c1smen(&mut self) -> I2C1SMEN_W<'_, C2APB1SMENR1rs> {
        I2C1SMEN_W::new(self, 21)
    }
    ///Bit 23 - I2C3 clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn i2c3smen(&mut self) -> I2C3SMEN_W<'_, C2APB1SMENR1rs> {
        I2C3SMEN_W::new(self, 23)
    }
    ///Bit 24 - CRS clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn crsmen(&mut self) -> CRSMEN_W<'_, C2APB1SMENR1rs> {
        CRSMEN_W::new(self, 24)
    }
    ///Bit 26 - USB FS clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn usbsmen(&mut self) -> USBSMEN_W<'_, C2APB1SMENR1rs> {
        USBSMEN_W::new(self, 26)
    }
    ///Bit 31 - Low power timer 1 clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn lptim1smen(&mut self) -> LPTIM1SMEN_W<'_, C2APB1SMENR1rs> {
...
impl crate::Resettable for C2APB1SMENR1rs {
    const RESET_VALUE: u32 = 0x85a0_4601;
}
