...
impl W {
    ...
    ///Bit 9 - LCD clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn lcdsmen(&mut self) -> LCDSMEN_W<C2APB1SMENR1rs> {
    ...
    ///Bit 14 - SPI2 clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn spi2smen(&mut self) -> SPI2SMEN_W<C2APB1SMENR1rs> {
    ...
    ///Bit 24 - CRS clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn crsmen(&mut self) -> CRSMEN_W<C2APB1SMENR1rs> {
        CRSMEN_W::new(self, 24)
    }
    ///Bit 26 - USB FS clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn usbsmen(&mut self) -> USBSMEN_W<C2APB1SMENR1rs> {
