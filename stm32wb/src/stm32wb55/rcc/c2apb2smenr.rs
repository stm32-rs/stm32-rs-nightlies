...
impl W {
    ///Bit 11 - TIM1 timer clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn tim1smen(&mut self) -> TIM1SMEN_W<'_, C2APB2SMENRrs> {
        TIM1SMEN_W::new(self, 11)
    }
    ///Bit 12 - SPI1 clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn spi1smen(&mut self) -> SPI1SMEN_W<'_, C2APB2SMENRrs> {
        SPI1SMEN_W::new(self, 12)
    }
    ///Bit 14 - USART1clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn usart1smen(&mut self) -> USART1SMEN_W<'_, C2APB2SMENRrs> {
        USART1SMEN_W::new(self, 14)
    }
    ///Bit 17 - TIM16 timer clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn tim16smen(&mut self) -> TIM16SMEN_W<'_, C2APB2SMENRrs> {
        TIM16SMEN_W::new(self, 17)
    }
    ///Bit 18 - TIM17 timer clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn tim17smen(&mut self) -> TIM17SMEN_W<'_, C2APB2SMENRrs> {
        TIM17SMEN_W::new(self, 18)
    }
    ///Bit 21 - SAI1 clocks enable during CPU2 Sleep mode
    #[inline(always)]
    pub fn sai1smen(&mut self) -> SAI1SMEN_W<'_, C2APB2SMENRrs> {
