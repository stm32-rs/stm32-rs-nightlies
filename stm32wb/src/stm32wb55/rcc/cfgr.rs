...
impl PPRE2_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> PPRE2 {
        match self.bits {
            4 => PPRE2::Div2,
            5 => PPRE2::Div4,
            6 => PPRE2::Div8,
    ...
    #[inline(always)]
    pub fn is_div1(&self) -> bool {
        matches!(self.variant(), PPRE2::Div1)
    }
}
///Field `PPRE2` writer - APB high-speed prescaler (APB2)
pub type PPRE2_W<'a, REG> = crate::FieldWriter<'a, REG, 3, PPRE2, crate::Safe>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#RCC:CFGR)*/
pub struct CFGRrs;
