...
impl From<LSI1RDYC> for bool {
    #[inline(always)]
    fn from(variant: LSI1RDYC) -> Self {
        variant as u8 != 0
    }
}
///Field `LSI1RDYC` writer - LSI1 ready interrupt clear
pub type LSI1RDYC_W<'a, REG> = crate::BitWriter<'a, REG, LSI1RDYC>;
impl<'a, REG> LSI1RDYC_W<'a, REG>
where
...
impl W {
    ...
    #[inline(always)]
    pub fn lsi2rdyc(&mut self) -> LSI2RDYC_W<'_, CICRrs> {
