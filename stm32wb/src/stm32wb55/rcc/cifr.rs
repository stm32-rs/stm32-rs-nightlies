...
pub struct LSI2RDYF_R(crate::FieldReader<bool, bool>);
impl LSI2RDYF_R {
    pub(crate) fn new(bits: bool) -> Self {
        LSI2RDYF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LSI2RDYF_R {
...
pub struct LSI1RDYF_R(crate::FieldReader<bool, bool>);
impl LSI1RDYF_R {
    pub(crate) fn new(bits: bool) -> Self {
        LSI1RDYF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LSI1RDYF_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
