...
pub use super::exticr2::EXTI5_R as EXTI12_R;
///Field `EXTI13` reader - EXTI13 configuration bits
pub use super::exticr2::EXTI5_R as EXTI13_R;
///Field `EXTI14` reader - EXTI14 configuration bits
pub use super::exticr2::EXTI5_R as EXTI14_R;
///Field `EXTI15` reader - EXTI15 configuration bits
pub use super::exticr2::EXTI5_R as EXTI15_R;
///Field `EXTI12` writer - EXTI12 configuration bits
pub use super::exticr2::EXTI5_W as EXTI12_W;
///Field `EXTI13` writer - EXTI13 configuration bits
pub use super::exticr2::EXTI5_W as EXTI13_W;
///Field `EXTI14` writer - EXTI14 configuration bits
pub use super::exticr2::EXTI5_W as EXTI14_W;
///Field `EXTI15` writer - EXTI15 configuration bits
pub use super::exticr2::EXTI5_W as EXTI15_W;
///EXTI12 configuration bits
pub use super::exticr2::EXTI_ABCD;
impl R {
