...
pub enum MEM_MODE {
    ...
    Sram = 3,
    ///6: QUADSPI memory mapped at 0x0000_0000
    Quadspi = 6,
}
...
impl MEM_MODE_R {
    ...
    ///QUADSPI memory mapped at 0x0000_0000
    #[inline(always)]
    pub fn is_quadspi(&self) -> bool {
        *self == MEM_MODE::Quadspi
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    ///QUADSPI memory mapped at 0x0000_0000
    #[inline(always)]
    pub fn quadspi(self) -> &'a mut crate::W<REG> {
        self.variant(MEM_MODE::Quadspi)
    }
}
impl R {
