...
pub type C1F_R = crate::FieldReader;
///Field `C1F` writer - Input capture 1 filter
pub type C1F_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
impl W {
    ...
    ///Bits 4:7 - Input capture 1 filter
    #[inline(always)]
    pub fn c1f(&mut self) -> C1F_W<CCMR1_INPUTrs> {
        C1F_W::new(self, 4)
    }
    ///Bits 8:9 - capture/Compare 2 selection
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB55.html#TIM1:CCMR1_Input)*/
