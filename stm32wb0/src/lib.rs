//! Peripheral access API for STM32WB0 microcontrollers
...
//!
//! This crate supports all STM32WB0 devices; for the complete list please
//! see:
//! [stm32wb0](https://crates.io/crates/stm32wb0)
//!
