...
impl W {
    ///Bit 0 - AES manual encryption.
    #[inline(always)]
    pub fn aesmanencint(&mut self) -> AESMANENCINT_W<INTERRUPT2REGrs> {
        AESMANENCINT_W::new(self, 0)
    }
    ///Bit 1 - AES LE privacy engine.
    #[inline(always)]
    pub fn aesleprivint(&mut self) -> AESLEPRIVINT_W<INTERRUPT2REGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#BLUE:INTERRUPT2REG)*/
