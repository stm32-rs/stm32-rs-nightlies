...
impl W {
    ///Bits 0:7 - Transmission ready timeout.
    #[inline(always)]
    pub fn tx_ready_timeout(&mut self) -> TX_READY_TIMEOUT_W<WORD4rs> {
        TX_READY_TIMEOUT_W::new(self, 0)
    }
    ///Bits 8:27 - Receive window timeout.
    #[inline(always)]
    pub fn rcv_timeout(&mut self) -> RCV_TIMEOUT_W<WORD4rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#GLOBALSTATMACH:WORD4)*/
pub struct WORD4rs;
