///Register `BSRR` reader
pub type R = crate::R<BSRRrs>;
...
///Field `BS(0-11)` writer - Port x set pin %s
...
///Field `BR(0-11)` writer - Port x reset pin %s
...
///`read()` method returns [`bsrr::R`](R) reader structure
impl crate::Readable for BSRRrs {}
