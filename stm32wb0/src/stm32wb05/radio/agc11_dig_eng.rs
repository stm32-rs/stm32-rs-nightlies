...
impl W {
    ///Bits 0:2 - Attenuation at IF Level for the AGC step 1
    #[inline(always)]
    pub fn att_if_1(&mut self) -> ATT_IF_1_W<AGC11_DIG_ENGrs> {
        ATT_IF_1_W::new(self, 0)
    }
    ///Bit 3 - Attenuation at LNA Level for the AGC step 1
    #[inline(always)]
    pub fn att_lna_1(&mut self) -> ATT_LNA_1_W<AGC11_DIG_ENGrs> {
        ATT_LNA_1_W::new(self, 3)
    }
    ///Bits 4:5 - Attenuation at Antenna Level for the AGC step 1
    #[inline(always)]
    pub fn att_ant_1(&mut self) -> ATT_ANT_1_W<AGC11_DIG_ENGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RADIO:AGC11_DIG_ENG)*/
