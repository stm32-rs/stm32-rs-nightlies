...
impl W {
    ///Bits 0:2 - Attenuation at IF Level for the AGC step 2
    #[inline(always)]
    pub fn att_if_2(&mut self) -> ATT_IF_2_W<AGC12_DIG_ENGrs> {
        ATT_IF_2_W::new(self, 0)
    }
    ///Bit 3 - Attenuation at LNA Level for the AGC step 2
    #[inline(always)]
    pub fn att_lna_2(&mut self) -> ATT_LNA_2_W<AGC12_DIG_ENGrs> {
        ATT_LNA_2_W::new(self, 3)
    }
    ///Bits 4:5 - Attenuation at Antenna Level for the AGC step 2
    #[inline(always)]
    pub fn att_ant_2(&mut self) -> ATT_ANT_2_W<AGC12_DIG_ENGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RADIO:AGC12_DIG_ENG)*/
