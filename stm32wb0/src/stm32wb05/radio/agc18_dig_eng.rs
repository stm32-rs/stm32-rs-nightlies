...
impl W {
    ///Bits 0:2 - Attenuation at IF Level for the AGC step 8
    #[inline(always)]
    pub fn att_if_8(&mut self) -> ATT_IF_8_W<AGC18_DIG_ENGrs> {
        ATT_IF_8_W::new(self, 0)
    }
    ///Bit 3 - Attenuation at LNA Level for the AGC step 8
    #[inline(always)]
    pub fn att_lna_8(&mut self) -> ATT_LNA_8_W<AGC18_DIG_ENGrs> {
        ATT_LNA_8_W::new(self, 3)
    }
    ///Bits 4:5 - Attenuation at Antenna Level for the AGC step 8
    #[inline(always)]
    pub fn att_ant_8(&mut self) -> ATT_ANT_8_W<AGC18_DIG_ENGrs> {
