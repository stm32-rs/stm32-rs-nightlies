...
impl W {
    ///Bits 0:6 - specifies the exact timing of the antenna switching during transmission at LE_1M baud rate (in AoD).
    #[inline(always)]
    pub fn tx_time_to_switch(&mut self) -> TX_TIME_TO_SWITCH_W<ANTSW2_DIG_USRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RADIO:ANTSW2_DIG_USR)*/
