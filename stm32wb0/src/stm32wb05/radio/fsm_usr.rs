...
impl W {
    ///Bit 1 - CBP calibration enable bit.
    #[inline(always)]
    pub fn en_calib_cbp(&mut self) -> EN_CALIB_CBP_W<FSM_USRrs> {
        EN_CALIB_CBP_W::new(self, 1)
    }
    ///Bit 2 - SYNTH calibration enable bit.
    #[inline(always)]
    pub fn en_calib_synth(&mut self) -> EN_CALIB_SYNTH_W<FSM_USRrs> {
        EN_CALIB_SYNTH_W::new(self, 2)
    }
    ///Bits 3:7 - PA Power coefficient.
    #[inline(always)]
    pub fn pa_power(&mut self) -> PA_POWER_W<FSM_USRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RADIO:FSM_USR)*/
