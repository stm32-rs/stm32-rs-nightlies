...
impl W {
    ///Bit 0 - mask slow clock measurement interrupt
    #[inline(always)]
    pub fn slow_clk_irq_mask(&mut self) -> SLOW_CLK_IRQ_MASK_W<IRQ_ENABLErs> {
        SLOW_CLK_IRQ_MASK_W::new(self, 0)
    }
    ///Bits 8:13 - mask for each RfFsm_event (Radio FSM) interrupt.
    #[inline(always)]
    pub fn radio_fsm_irq_mask(&mut self) -> RADIO_FSM_IRQ_MASK_W<IRQ_ENABLErs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RADIO_CONTROL:IRQ_ENABLE)*/
