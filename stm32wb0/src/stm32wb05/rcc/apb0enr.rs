...
///Field `TIM2EN` reader - TIM2: Advanced Timer clock enable Set and enable by software.
pub type TIM2EN_R = crate::BitReader;
///Field `TIM2EN` writer - TIM2: Advanced Timer clock enable Set and enable by software.
...
impl W {
    ///Bit 0 - TIM2: Advanced Timer clock enable Set and enable by software.
    #[inline(always)]
    pub fn tim2en(&mut self) -> TIM2EN_W<APB0ENRrs> {
        TIM2EN_W::new(self, 0)
    }
    ///Bit 1 - TIM16 enable
    #[inline(always)]
    pub fn tim16en(&mut self) -> TIM16EN_W<APB0ENRrs> {
        TIM16EN_W::new(self, 1)
    }
    ///Bit 2 - TIM17 enable
    #[inline(always)]
    pub fn tim17en(&mut self) -> TIM17EN_W<APB0ENRrs> {
        TIM17EN_W::new(self, 2)
    }
    ///Bit 8 - SYSTEM CONFIG enable Set and enable by software.
    #[inline(always)]
