...
impl W {
    ///Bit 0 - TIM1: Advanced Timer reset Set and reset by software.
    #[inline(always)]
    pub fn tim1rst(&mut self) -> TIM1RST_W<APB0RSTRrs> {
        TIM1RST_W::new(self, 0)
    }
    ///Bit 1 - TIM16 reset
    #[inline(always)]
    pub fn tim16rst(&mut self) -> TIM16RST_W<APB0RSTRrs> {
        TIM16RST_W::new(self, 1)
    }
    ///Bit 2 - TIM17 reset
    #[inline(always)]
    pub fn tim17rst(&mut self) -> TIM17RST_W<APB0RSTRrs> {
        TIM17RST_W::new(self, 2)
    }
    ///Bit 8 - SYSTEM CONFIG reset Set and reset by software.
    #[inline(always)]
    pub fn syscfgrst(&mut self) -> SYSCFGRST_W<APB0RSTRrs> {
        SYSCFGRST_W::new(self, 8)
    }
    ///Bit 12 - RTC reset Set and reset by software.
    #[inline(always)]
    pub fn rtcrst(&mut self) -> RTCRST_W<APB0RSTRrs> {
        RTCRST_W::new(self, 12)
    }
    ///Bit 14 - WATCHDOG reset Set and reset by software.
    #[inline(always)]
    pub fn wdrst(&mut self) -> WDRST_W<APB0RSTRrs> {
        WDRST_W::new(self, 14)
    }
}
/**APB0RSTR register
