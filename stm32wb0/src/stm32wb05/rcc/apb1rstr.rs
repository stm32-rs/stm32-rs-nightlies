...
impl W {
    ///Bit 4 - AUXADC reset for Aux-ADC digital clock Set and reset by software.
    #[inline(always)]
    pub fn auxadcrst(&mut self) -> AUXADCRST_W<APB1RSTRrs> {
        AUXADCRST_W::new(self, 4)
    }
    ///Bit 8 - LPUART reset Set and reset by software.
    #[inline(always)]
    pub fn lpuartrst(&mut self) -> LPUARTRST_W<APB1RSTRrs> {
        LPUARTRST_W::new(self, 8)
    }
    ///Bit 10 - USART reset Set and reset by software.
    #[inline(always)]
    pub fn usartrst(&mut self) -> USARTRST_W<APB1RSTRrs> {
    ...
    ///Bit 21 - I2C1 reset Set and reset by software.
    #[inline(always)]
    pub fn i2c21rst(&mut self) -> I2C21RST_W<APB1RSTRrs> {
