...
impl W {
    ///Bit 0 - IP_BLE Port grant interrupt enable
    #[inline(always)]
    pub fn port_grant(&mut self) -> PORT_GRANT_W<'_, BLE_IRQ_ENABLErs> {
        PORT_GRANT_W::new(self, 0)
    }
    ///Bit 1 - IP_BLE Port release interrupt enable
    #[inline(always)]
    pub fn port_release(&mut self) -> PORT_RELEASE_W<'_, BLE_IRQ_ENABLErs> {
        PORT_RELEASE_W::new(self, 1)
    }
    ///Bit 3 - IP_BLE Port command start interrup enable
    #[inline(always)]
    pub fn port_cmd_start(&mut self) -> PORT_CMD_START_W<'_, BLE_IRQ_ENABLErs> {
        PORT_CMD_START_W::new(self, 3)
    }
    ///Bit 4 - IP_BLE Port command end interrup enable
    #[inline(always)]
    pub fn port_cmd_end(&mut self) -> PORT_CMD_END_W<'_, BLE_IRQ_ENABLErs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RRM:BLE_IRQ_ENABLE)*/
