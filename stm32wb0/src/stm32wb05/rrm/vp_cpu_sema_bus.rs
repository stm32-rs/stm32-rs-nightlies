...
impl W {
    ///Bits 0:2 - semaphore priority: priority value (between 0 and 7) of the take request.
    #[inline(always)]
    pub fn take_prio(&mut self) -> TAKE_PRIO_W<VP_CPU_SEMA_BUSrs> {
        TAKE_PRIO_W::new(self, 0)
    }
    ///Bit 3 - semaphore token request:
    #[inline(always)]
    pub fn take_req(&mut self) -> TAKE_REQ_W<VP_CPU_SEMA_BUSrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RRM:VP_CPU_SEMA_BUS)*/
