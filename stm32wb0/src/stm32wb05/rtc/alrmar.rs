...
///Field `MSK1` reader - Alarm A seconds mask 0: Alarm A set if the seconds match 1: Seconds don't care in Alarm A comparison
pub type MSK1_R = crate::BitReader;
///Field `MSK1` writer - Alarm A seconds mask 0: Alarm A set if the seconds match 1: Seconds don't care in Alarm A comparison
...
///Field `MSK2` reader - Alarm A minutes mask 0: Alarm A set if the minutes match 1: Minutes don't care in Alarm A comparison
pub type MSK2_R = crate::BitReader;
///Field `MSK2` writer - Alarm A minutes mask 0: Alarm A set if the minutes match 1: Minutes don't care in Alarm A comparison
...
///Field `MSK3` reader - Alarm A hours mask 0: Alarm A set if the hours match 1: Hours don't care in Alarm A comparison
pub type MSK3_R = crate::BitReader;
///Field `MSK3` writer - Alarm A hours mask 0: Alarm A set if the hours match 1: Hours don't care in Alarm A comparison
...
///Field `WDSEL` reader - Week day selection 0: DU\[3:0\] represents the date units 1: DU\[3:0\] represents the week day. DT\[1:0\] is don't care.
pub type WDSEL_R = crate::BitReader;
///Field `WDSEL` writer - Week day selection 0: DU\[3:0\] represents the date units 1: DU\[3:0\] represents the week day. DT\[1:0\] is don't care.
pub type WDSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MSK4` reader - Alarm A date mask 0: Alarm A set if the date/day match 1: Date/day don't care in Alarm A comparison
pub type MSK4_R = crate::BitReader;
///Field `MSK4` writer - Alarm A date mask 0: Alarm A set if the date/day match 1: Date/day don't care in Alarm A comparison
...
impl W {
    ///Bits 0:3 - Second units in BCD format.
    #[inline(always)]
    pub fn su(&mut self) -> SU_W<'_, ALRMARrs> {
        SU_W::new(self, 0)
    }
    ///Bits 4:6 - Second tens in BCD format.
    #[inline(always)]
    pub fn st(&mut self) -> ST_W<'_, ALRMARrs> {
        ST_W::new(self, 4)
    }
    ///Bit 7 - Alarm A seconds mask 0: Alarm A set if the seconds match 1: Seconds don't care in Alarm A comparison
    #[inline(always)]
    pub fn msk1(&mut self) -> MSK1_W<'_, ALRMARrs> {
        MSK1_W::new(self, 7)
    }
    ///Bits 8:11 - Minute units in BCD format.
    #[inline(always)]
    pub fn mnu(&mut self) -> MNU_W<'_, ALRMARrs> {
        MNU_W::new(self, 8)
    }
    ///Bits 12:14 - Minute tens in BCD format.
    #[inline(always)]
    pub fn mnt(&mut self) -> MNT_W<'_, ALRMARrs> {
        MNT_W::new(self, 12)
    }
    ///Bit 15 - Alarm A minutes mask 0: Alarm A set if the minutes match 1: Minutes don't care in Alarm A comparison
    #[inline(always)]
    pub fn msk2(&mut self) -> MSK2_W<'_, ALRMARrs> {
        MSK2_W::new(self, 15)
    }
    ///Bits 16:19 - Hour units in BCD format.
    #[inline(always)]
    pub fn hu(&mut self) -> HU_W<'_, ALRMARrs> {
        HU_W::new(self, 16)
    }
    ///Bits 20:21 - Hour tens in BCD format.
    #[inline(always)]
    pub fn ht(&mut self) -> HT_W<'_, ALRMARrs> {
        HT_W::new(self, 20)
    }
    ///Bit 22 - AM/PM notation 0: AM or 24-hour format 1: PM
    #[inline(always)]
    pub fn pm(&mut self) -> PM_W<'_, ALRMARrs> {
        PM_W::new(self, 22)
    }
    ///Bit 23 - Alarm A hours mask 0: Alarm A set if the hours match 1: Hours don't care in Alarm A comparison
    #[inline(always)]
    pub fn msk3(&mut self) -> MSK3_W<'_, ALRMARrs> {
        MSK3_W::new(self, 23)
    }
    ///Bits 24:27 - Date units or day in BCD format.
    #[inline(always)]
    pub fn du(&mut self) -> DU_W<'_, ALRMARrs> {
        DU_W::new(self, 24)
    }
    ///Bits 28:29 - Date tens in BCD format.
    #[inline(always)]
    pub fn dt(&mut self) -> DT_W<'_, ALRMARrs> {
        DT_W::new(self, 28)
    }
    ///Bit 30 - Week day selection 0: DU\[3:0\] represents the date units 1: DU\[3:0\] represents the week day. DT\[1:0\] is don't care.
    #[inline(always)]
    pub fn wdsel(&mut self) -> WDSEL_W<'_, ALRMARrs> {
        WDSEL_W::new(self, 30)
    }
    ///Bit 31 - Alarm A date mask 0: Alarm A set if the date/day match 1: Date/day don't care in Alarm A comparison
    #[inline(always)]
    pub fn msk4(&mut self) -> MSK4_W<'_, ALRMARrs> {
        MSK4_W::new(self, 31)
    }
}
/**RTC_ALRMAR register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RTC:ALRMAR)*/
pub struct ALRMARrs;
