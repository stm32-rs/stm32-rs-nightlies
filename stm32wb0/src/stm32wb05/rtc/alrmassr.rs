...
///Field `SS` reader - Sub seconds value This value is compared with the contents of the synchronous prescaler's counter to determine if Alarm A is to be activated. Only bits 0 up MASKSS-1 are compared.
pub type SS_R = crate::FieldReader<u16>;
///Field `SS` writer - Sub seconds value This value is compared with the contents of the synchronous prescaler's counter to determine if Alarm A is to be activated. Only bits 0 up MASKSS-1 are compared.
pub type SS_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `MASKSS` reader - Mask the most-significant bits starting at this bit 0: No comparison on sub seconds for Alarm A. The alarm is set when the seconds unit is incremented (assuming that the rest of the fields match). 1: SS\[14:1\] are don't care in Alarm A comparison. Only SS\[0\] is compared. 2: SS\[14:2\] are don't care in Alarm A comparison. Only SS\[1:0\] are compared. 3: SS\[14:3\] are don't care in Alarm A comparison. Only SS\[2:0\] are compared. ... 12: SS\[14:12\] are don't care in Alarm A comparison. SS\[11:0\] are compared. 13: SS\[14:13\] are don't care in Alarm A comparison. SS\[12:0\] are compared. 14: SS\[14\] is don't care in Alarm A comparison. SS\[13:0\] are compared. 15: All 15 SS bits are compared and must match to activate alarm. The overflow bits of the synchronous counter (bits 15) is never compared. This bit can be different from 0 only after a shift operation.
pub type MASKSS_R = crate::FieldReader;
///Field `MASKSS` writer - Mask the most-significant bits starting at this bit 0: No comparison on sub seconds for Alarm A. The alarm is set when the seconds unit is incremented (assuming that the rest of the fields match). 1: SS\[14:1\] are don't care in Alarm A comparison. Only SS\[0\] is compared. 2: SS\[14:2\] are don't care in Alarm A comparison. Only SS\[1:0\] are compared. 3: SS\[14:3\] are don't care in Alarm A comparison. Only SS\[2:0\] are compared. ... 12: SS\[14:12\] are don't care in Alarm A comparison. SS\[11:0\] are compared. 13: SS\[14:13\] are don't care in Alarm A comparison. SS\[12:0\] are compared. 14: SS\[14\] is don't care in Alarm A comparison. SS\[13:0\] are compared. 15: All 15 SS bits are compared and must match to activate alarm. The overflow bits of the synchronous counter (bits 15) is never compared. This bit can be different from 0 only after a shift operation.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RTC:ALRMASSR)*/
