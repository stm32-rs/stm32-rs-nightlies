...
///Field `CALW16` reader - Use a 16-second calibration cycle period When CALW16 is set to 1' , the 16-second calibration cycle period is selected.This bit must not be set to 1' if CALW8=1. Note: CALM\[0\] is stucked at 0' when CALW16='1'.
pub type CALW16_R = crate::BitReader;
///Field `CALW16` writer - Use a 16-second calibration cycle period When CALW16 is set to 1' , the 16-second calibration cycle period is selected.This bit must not be set to 1' if CALW8=1. Note: CALM\[0\] is stucked at 0' when CALW16='1'.
pub type CALW16_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CALW8` reader - Use an 8-second calibration cycle period When CALW8 is set to 1' , the 8-second calibration cycle period is selected. Note: CALM\[1:0\] are stucked at '00' when CALW8='1'.
pub type CALW8_R = crate::BitReader;
///Field `CALW8` writer - Use an 8-second calibration cycle period When CALW8 is set to 1' , the 8-second calibration cycle period is selected. Note: CALM\[1:0\] are stucked at '00' when CALW8='1'.
pub type CALW8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CALP` reader - Increase frequency of RTC by 488.5 ppm 0: No RTCCLK pulses are added. 1: One RTCCLK pulse is effectively inserted every 211 pulses (frequency incresed by 488.5 ppm). This feature is intended to be used in conjunction with CALM, which lowers the frequency of the calendar with a fine resolution. if the input frequency is 32768 Hz, the number of RTCCLK pulses added during a 32-second window is calculated as follows: (512 * CALP) - CALM.
pub type CALP_R = crate::BitReader;
///Field `CALP` writer - Increase frequency of RTC by 488.5 ppm 0: No RTCCLK pulses are added. 1: One RTCCLK pulse is effectively inserted every 211 pulses (frequency incresed by 488.5 ppm). This feature is intended to be used in conjunction with CALM, which lowers the frequency of the calendar with a fine resolution. if the input frequency is 32768 Hz, the number of RTCCLK pulses added during a 32-second window is calculated as follows: (512 * CALP) - CALM.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RTC:CALR)*/
pub struct CALRrs;
