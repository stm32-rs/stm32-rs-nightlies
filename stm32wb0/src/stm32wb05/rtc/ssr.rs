...
///Field `SS` reader - Sub second value SS\[15:0\] is the value in the synchronous prescaler's counter. The fraction of a second is given by the formula below: Second fraction = ( PREDIV_S - SS ) / ( PREDIV_S + 1 )
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB05.html#RTC:SSR)*/
pub struct SSRrs;
