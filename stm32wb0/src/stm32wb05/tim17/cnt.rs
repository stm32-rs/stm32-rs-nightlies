...
///Field `UIF_CPY` reader - UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register. If the UIFREMAP bit in TIMx_CR1 is reset, bit 31 is reserved and read as 0.
pub type UIF_CPY_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn uif_cpy(&self) -> UIF_CPY_R {
        UIF_CPY_R::new(((self.bits >> 31) & 1) != 0)
    }
}
