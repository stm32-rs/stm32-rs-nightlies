...
///Field `GAIN3` reader - third calibration point: gain AUXADC_GAIN_1V2\[11:0\]
pub type GAIN3_R = crate::FieldReader<u16>;
///Field `GAIN3` writer - third calibration point: gain AUXADC_GAIN_1V2\[11:0\]
pub type GAIN3_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `OFFSET3` reader - third calibration point: signed offset compensation\[6:0\]
pub type OFFSET3_R = crate::FieldReader;
///Field `OFFSET3` writer - third calibration point: signed offset compensation\[6:0\]
pub type OFFSET3_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    ...
    pub fn offset3(&self) -> OFFSET3_R {
        OFFSET3_R::new(((self.bits >> 12) & 0x7f) as u8)
    }
}
...
impl W {
    ///Bits 0:11 - third calibration point: gain AUXADC_GAIN_1V2\[11:0\]
    #[inline(always)]
    pub fn gain3(&mut self) -> GAIN3_W<COMP_3rs> {
        GAIN3_W::new(self, 0)
    }
    ///Bits 12:18 - third calibration point: signed offset compensation\[6:0\]
    #[inline(always)]
    pub fn offset3(&mut self) -> OFFSET3_W<COMP_3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#ADC:COMP_3)*/
pub struct COMP_3rs;
