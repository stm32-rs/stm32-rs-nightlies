...
impl W {
    ///Bit 0 - (Used in test mode only): End of ADC conversion interrupt enable
    #[inline(always)]
    pub fn eoc_irq_ena(&mut self) -> EOC_IRQ_ENA_W<IRQ_ENABLErs> {
        EOC_IRQ_ENA_W::new(self, 0)
    }
    ///Bit 1 - End of conversion interrupt enable for the Down Sampler output
    #[inline(always)]
    pub fn eods_irq_ena(&mut self) -> EODS_IRQ_ENA_W<IRQ_ENABLErs> {
        EODS_IRQ_ENA_W::new(self, 1)
    }
    ///Bit 2 - End of conversion interrupt enable for the decimation filter output
    #[inline(always)]
    pub fn eodf_irq_ena(&mut self) -> EODF_IRQ_ENA_W<IRQ_ENABLErs> {
        EODF_IRQ_ENA_W::new(self, 2)
    }
    ///Bit 3 - End of regular sequence interrupt enable
    #[inline(always)]
    pub fn eos_irq_ena(&mut self) -> EOS_IRQ_ENA_W<IRQ_ENABLErs> {
        EOS_IRQ_ENA_W::new(self, 3)
    }
    ///Bit 4 - analog watchdog interrupt enable
    #[inline(always)]
    pub fn awd_irq_ena(&mut self) -> AWD_IRQ_ENA_W<IRQ_ENABLErs> {
        AWD_IRQ_ENA_W::new(self, 4)
    }
    ///Bit 5 - Down Sampler overrun interrupt enable
    #[inline(always)]
    pub fn ovr_ds_irq_ena(&mut self) -> OVR_DS_IRQ_ENA_W<IRQ_ENABLErs> {
        OVR_DS_IRQ_ENA_W::new(self, 5)
    }
    ///Bit 6 - decimation filter overrun interrupt enable
    #[inline(always)]
    pub fn ovr_df_irq_ena(&mut self) -> OVR_DF_IRQ_ENA_W<IRQ_ENABLErs> {
        OVR_DF_IRQ_ENA_W::new(self, 6)
    }
    ///Bit 7 - decimation filter saturation interrupt enable
    #[inline(always)]
    pub fn df_ovrfl_irq_ena(&mut self) -> DF_OVRFL_IRQ_ENA_W<IRQ_ENABLErs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#ADC:IRQ_ENABLE)*/
