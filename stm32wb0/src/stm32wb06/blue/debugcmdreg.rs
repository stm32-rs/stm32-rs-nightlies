...
impl W {
    ///Bit 0 - CLEARDEBUGINT
    #[inline(always)]
    pub fn cleardebugint(&mut self) -> CLEARDEBUGINT_W<DEBUGCMDREGrs> {
        CLEARDEBUGINT_W::new(self, 0)
    }
    ///Bit 1 - SEQDEBUGMODE
    #[inline(always)]
    pub fn seqdebugmode(&mut self) -> SEQDEBUGMODE_W<DEBUGCMDREGrs> {
        SEQDEBUGMODE_W::new(self, 1)
    }
    ///Bits 2:5 - SEQDEBUGBUSSEL
    #[inline(always)]
    pub fn seqdebugbussel(&mut self) -> SEQDEBUGBUSSEL_W<DEBUGCMDREGrs> {
        SEQDEBUGBUSSEL_W::new(self, 2)
    }
    ///Bits 16:19 - AESDEBUGMODE
    #[inline(always)]
    pub fn aesdebugmode(&mut self) -> AESDEBUGMODE_W<DEBUGCMDREGrs> {
