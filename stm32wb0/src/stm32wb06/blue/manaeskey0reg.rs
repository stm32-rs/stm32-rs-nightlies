...
impl W {
    ///Bits 0:31 - Manual mode AES key
    #[inline(always)]
    pub fn manaeskey_31_0(&mut self) -> MANAESKEY_31_0_W<MANAESKEY0REGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#BLUE:MANAESKEY0REG)*/
