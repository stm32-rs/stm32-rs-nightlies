...
impl W {
    ///Bits 0:31 - Manual mode AES key
    #[inline(always)]
    pub fn manaeskey_63_32(&mut self) -> MANAESKEY_63_32_W<MANAESKEY1REGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#BLUE:MANAESKEY1REG)*/
