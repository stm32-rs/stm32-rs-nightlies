...
impl W {
    ///Bits 0:31 - Manual mode AES key
    #[inline(always)]
    pub fn manaeskey_95_64(&mut self) -> MANAESKEY_95_64_W<MANAESKEY2REGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#BLUE:MANAESKEY2REG)*/
