...
///Field `AFSEL(8-15)` reader - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os.
pub use super::afrl::AFSEL_R;
///Field `AFSEL(8-15)` writer - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#GPIOA:AFRH)*/
pub struct AFRHrs;
