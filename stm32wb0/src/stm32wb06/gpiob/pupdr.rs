...
pub use crate::stm32wb06::gpioa::pupdr::PULL;
///Field `PUPD(0-15)` reader - Port x configuration pin %s
pub use crate::stm32wb06::gpioa::pupdr::PUPD_R;
///Field `PUPD(0-15)` writer - Port x configuration pin %s
pub use crate::stm32wb06::gpioa::pupdr::PUPD_W;
impl R {
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `PUPD0` field.</div>
    #[inline(always)]
    pub fn pupd(&mut self, n: u8) -> PUPD_W<'_, PUPDRrs> {
        #[allow(clippy::no_effect)]
        [(); 16][n as usize];
        PUPD_W::new(self, n * 2)
    }
    ///Bits 0:1 - Port x configuration pin 0
    #[inline(always)]
    pub fn pupd0(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 0)
    }
    ///Bits 2:3 - Port x configuration pin 1
    #[inline(always)]
    pub fn pupd1(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 2)
    }
    ///Bits 4:5 - Port x configuration pin 2
    #[inline(always)]
    pub fn pupd2(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 4)
    }
    ///Bits 6:7 - Port x configuration pin 3
    #[inline(always)]
    pub fn pupd3(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 6)
    }
    ///Bits 8:9 - Port x configuration pin 4
    #[inline(always)]
    pub fn pupd4(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 8)
    }
    ///Bits 10:11 - Port x configuration pin 5
    #[inline(always)]
    pub fn pupd5(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 10)
    }
    ///Bits 12:13 - Port x configuration pin 6
    #[inline(always)]
    pub fn pupd6(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 12)
    }
    ///Bits 14:15 - Port x configuration pin 7
    #[inline(always)]
    pub fn pupd7(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 14)
    }
    ///Bits 16:17 - Port x configuration pin 8
    #[inline(always)]
    pub fn pupd8(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 16)
    }
    ///Bits 18:19 - Port x configuration pin 9
    #[inline(always)]
    pub fn pupd9(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 18)
    }
    ///Bits 20:21 - Port x configuration pin 10
    #[inline(always)]
    pub fn pupd10(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 20)
    }
    ///Bits 22:23 - Port x configuration pin 11
    #[inline(always)]
    pub fn pupd11(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 22)
    }
    ///Bits 24:25 - Port x configuration pin 12
    #[inline(always)]
    pub fn pupd12(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 24)
    }
    ///Bits 26:27 - Port x configuration pin 13
    #[inline(always)]
    pub fn pupd13(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 26)
    }
    ///Bits 28:29 - Port x configuration pin 14
    #[inline(always)]
    pub fn pupd14(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 28)
    }
    ///Bits 30:31 - Port x configuration pin 15
    #[inline(always)]
    pub fn pupd15(&mut self) -> PUPD_W<'_, PUPDRrs> {
        PUPD_W::new(self, 30)
    }
}
/**PUPDR register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#GPIOB:PUPDR)*/
pub struct PUPDRrs;
...
///`reset()` method sets PUPDR to value 0x5500_5555
impl crate::Resettable for PUPDRrs {
    const RESET_VALUE: u32 = 0x5500_5555;
}
