...
impl W {
    ...
    ///Bit 5 - RAMRET1: RAM1 retention during low power mode
    #[inline(always)]
    pub fn ramret1(&mut self) -> RAMRET1_W<CR2rs> {
        RAMRET1_W::new(self, 5)
    }
    ///Bit 6 - Enables the RAM2 bank retention in DEEPSTOP mode.
    #[inline(always)]
    pub fn ramret2(&mut self) -> RAMRET2_W<CR2rs> {
        RAMRET2_W::new(self, 6)
    }
    ///Bit 7 - Enables the RAM3 bank retention in DEEPSTOP mode.
    #[inline(always)]
    pub fn ramret3(&mut self) -> RAMRET3_W<CR2rs> {
        RAMRET3_W::new(self, 7)
    }
    ///Bit 9 - Enable the temperature sensor.
    #[inline(always)]
    pub fn ents(&mut self) -> ENTS_W<CR2rs> {
        ENTS_W::new(self, 9)
    }
    ///Bit 10 - LSI LPMU force enable.
    #[inline(always)]
    pub fn lsilpmufen(&mut self) -> LSILPMUFEN_W<CR2rs> {
