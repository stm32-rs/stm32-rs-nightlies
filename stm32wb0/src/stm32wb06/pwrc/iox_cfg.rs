...
impl W {
    ///Bits 0:1 - Drive configuration for PA8.
    #[inline(always)]
    pub fn iocfg0(&mut self) -> IOCFG0_W<IOX_CFGrs> {
        IOCFG0_W::new(self, 0)
    }
    ///Bits 2:3 - Drive configuration for PA9.
    #[inline(always)]
    pub fn iocfg1(&mut self) -> IOCFG1_W<IOX_CFGrs> {
        IOCFG1_W::new(self, 2)
    }
    ///Bits 4:5 - Drive configuration for PA10.
    #[inline(always)]
    pub fn iocfg2(&mut self) -> IOCFG2_W<IOX_CFGrs> {
        IOCFG2_W::new(self, 4)
    }
    ///Bits 6:7 - Drive configuration for PA11.
    #[inline(always)]
    pub fn iocfg3(&mut self) -> IOCFG3_W<IOX_CFGrs> {
        IOCFG3_W::new(self, 6)
    }
    ///Bits 8:9 - Drive configuration for PA4.
    #[inline(always)]
    pub fn iocfg4(&mut self) -> IOCFG4_W<IOX_CFGrs> {
        IOCFG4_W::new(self, 8)
    }
    ///Bits 10:11 - Drive configuration for PA5.
    #[inline(always)]
    pub fn iocfg5(&mut self) -> IOCFG5_W<IOX_CFGrs> {
        IOCFG5_W::new(self, 10)
    }
    ///Bits 12:13 - Drive configuration for PA6.
    #[inline(always)]
    pub fn iocfg6(&mut self) -> IOCFG6_W<IOX_CFGrs> {
        IOCFG6_W::new(self, 12)
    }
    ///Bits 14:15 - Drive configuration for PA7.
    #[inline(always)]
    pub fn iocfg7(&mut self) -> IOCFG7_W<IOX_CFGrs> {
