...
impl W {
    ...
    ///Bit 8 - PB8 I/O wake-up flag.
    #[inline(always)]
    pub fn wuf20(&mut self) -> WUF20_W<SR3rs> {
        WUF20_W::new(self, 8)
    }
    ///Bit 9 - PB9 I/O wake-up flag.
    #[inline(always)]
    pub fn wuf21(&mut self) -> WUF21_W<SR3rs> {
        WUF21_W::new(self, 9)
    }
    ///Bit 10 - PB10 I/O wake-up flag.
    #[inline(always)]
    pub fn wuf22(&mut self) -> WUF22_W<SR3rs> {
        WUF22_W::new(self, 10)
    }
    ///Bit 11 - PB11 I/O wake-up flag.
    #[inline(always)]
    pub fn wuf23(&mut self) -> WUF23_W<SR3rs> {
        WUF23_W::new(self, 11)
    }
    ///Bit 12 - PB12 I/O wake-up flag.
    #[inline(always)]
    pub fn wuf24(&mut self) -> WUF24_W<SR3rs> {
        WUF24_W::new(self, 12)
    }
    ///Bit 13 - PB13 I/O wake-up flag.
    #[inline(always)]
    pub fn wuf25(&mut self) -> WUF25_W<SR3rs> {
        WUF25_W::new(self, 13)
    }
    ///Bit 14 - PB14 I/O wake-up flag.
    #[inline(always)]
    pub fn wuf26(&mut self) -> WUF26_W<SR3rs> {
        WUF26_W::new(self, 14)
    }
    ///Bit 15 - PB15 I/O wake-up flag.
    #[inline(always)]
    pub fn wuf27(&mut self) -> WUF27_W<SR3rs> {
        WUF27_W::new(self, 15)
    }
}
/**SR3 register
