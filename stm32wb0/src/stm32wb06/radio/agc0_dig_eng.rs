...
impl W {
    ///Bits 0:5 - High AGC threshold
    #[inline(always)]
    pub fn agc_thr_high(&mut self) -> AGC_THR_HIGH_W<AGC0_DIG_ENGrs> {
        AGC_THR_HIGH_W::new(self, 0)
    }
    ///Bit 6 - Enable AGC
    #[inline(always)]
    pub fn agc_enable(&mut self) -> AGC_ENABLE_W<AGC0_DIG_ENGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#RADIO:AGC0_DIG_ENG)*/
