...
impl W {
    ///Bits 0:2 - Attenuation at IF Level for the AGC step 4
    #[inline(always)]
    pub fn att_if_4(&mut self) -> ATT_IF_4_W<AGC14_DIG_ENGrs> {
        ATT_IF_4_W::new(self, 0)
    }
    ///Bit 3 - Attenuation at LNA Level for the AGC step 4
    #[inline(always)]
    pub fn att_lna_4(&mut self) -> ATT_LNA_4_W<AGC14_DIG_ENGrs> {
        ATT_LNA_4_W::new(self, 3)
    }
    ///Bits 4:5 - Attenuation at Antenna Level for the AGC step 4
    #[inline(always)]
    pub fn att_ant_4(&mut self) -> ATT_ANT_4_W<AGC14_DIG_ENGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#RADIO:AGC14_DIG_ENG)*/
