...
impl W {
    ///Bits 0:2 - Attenuation at IF Level for the AGC step 6
    #[inline(always)]
    pub fn att_if_6(&mut self) -> ATT_IF_6_W<AGC16_DIG_ENGrs> {
        ATT_IF_6_W::new(self, 0)
    }
    ///Bit 3 - Attenuation at LNA Level for the AGC step 6
    #[inline(always)]
    pub fn att_lna_6(&mut self) -> ATT_LNA_6_W<AGC16_DIG_ENGrs> {
        ATT_LNA_6_W::new(self, 3)
    }
    ///Bits 4:5 - Attenuation at Antenna Level for the AGC step 6
    #[inline(always)]
    pub fn att_ant_6(&mut self) -> ATT_ANT_6_W<AGC16_DIG_ENGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#RADIO:AGC16_DIG_ENG)*/
