...
impl W {
    ///Bit 0 - Selection:
    #[inline(always)]
    pub fn agc2_ana_tst_sel(&mut self) -> AGC2_ANA_TST_SEL_W<AGC2_ANA_TSTrs> {
        AGC2_ANA_TST_SEL_W::new(self, 0)
    }
    ///Bits 1:3 - the AGC antenna trimming value ( when AGC2_ANA_TST_SEL = 1)
    #[inline(always)]
    pub fn agc_antennae_usr_trim(&mut self) -> AGC_ANTENNAE_USR_TRIM_W<AGC2_ANA_TSTrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#RADIO:AGC2_ANA_TST)*/
