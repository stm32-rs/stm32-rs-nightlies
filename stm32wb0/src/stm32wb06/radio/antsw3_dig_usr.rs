...
impl W {
    ///Bits 0:6 - specifies the exact timing of the antenna switching during transmission at LE_2M baud rate (in AoD).
    #[inline(always)]
    pub fn tx_time_to_switch_2m(&mut self) -> TX_TIME_TO_SWITCH_2M_W<ANTSW3_DIG_USRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#RADIO:ANTSW3_DIG_USR)*/
