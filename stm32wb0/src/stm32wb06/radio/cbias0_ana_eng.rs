...
impl W {
    ///Bits 0:3 - overloaded value for cbias current trimming (when CBIAS0_TRIM_TST_SEL = 1)
    #[inline(always)]
    pub fn rfd_cbias_ibias_trim(&mut self) -> RFD_CBIAS_IBIAS_TRIM_W<CBIAS0_ANA_ENGrs> {
        RFD_CBIAS_IBIAS_TRIM_W::new(self, 0)
    }
    ///Bits 4:7 - overloaded value for cbias current trimming (when CBIAS0_TRIM_TST_SEL = 1)
    #[inline(always)]
    pub fn rfd_cbias_iptat_trim(&mut self) -> RFD_CBIAS_IPTAT_TRIM_W<CBIAS0_ANA_ENGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#RADIO:CBIAS0_ANA_ENG)*/
