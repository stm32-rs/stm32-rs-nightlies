...
impl W {
    ///Bits 1:7 - Index for internal lock up table in which the synthesizer setup is contained.
    #[inline(always)]
    pub fn channel_num(&mut self) -> CHANNEL_NUM_W<DEM_MOD_DIG_USRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#RADIO:DEM_MOD_DIG_USR)*/
