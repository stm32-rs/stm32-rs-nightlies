...
impl W {
    ///Bits 0:7 - RSSI or peak threshold value
    #[inline(always)]
    pub fn lr_rssi_thr(&mut self) -> LR_RSSI_THR_W<LR_RSSI_THR_DIG_ENGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB06.html#RADIO:LR_RSSI_THR_DIG_ENG)*/
