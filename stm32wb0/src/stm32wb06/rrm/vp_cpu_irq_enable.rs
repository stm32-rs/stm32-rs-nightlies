...
impl W {
    ///Bit 0 - CPU virtual port grant interrupt enable
    #[inline(always)]
    pub fn port_grant(&mut self) -> PORT_GRANT_W<VP_CPU_IRQ_ENABLErs> {
        PORT_GRANT_W::new(self, 0)
    }
    ///Bit 1 - CPU virtual port release interrupt enable
    #[inline(always)]
    pub fn port_release(&mut self) -> PORT_RELEASE_W<VP_CPU_IRQ_ENABLErs> {
        PORT_RELEASE_W::new(self, 1)
    }
    ///Bit 3 - CPU virtual port command start interrup enable
    #[inline(always)]
    pub fn port_cmd_start(&mut self) -> PORT_CMD_START_W<VP_CPU_IRQ_ENABLErs> {
        PORT_CMD_START_W::new(self, 3)
    }
    ///Bit 4 - CPU virtual port command end interrup enable
    #[inline(always)]
    pub fn port_cmd_end(&mut self) -> PORT_CMD_END_W<VP_CPU_IRQ_ENABLErs> {
