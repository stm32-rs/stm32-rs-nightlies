...
impl W {
    ///Bit 29 - IP_BLE sleeping mode enable:
    #[inline(always)]
    pub fn sleep_en(&mut self) -> SLEEP_EN_W<BLUE_SLEEP_REQUEST_MODErs> {
        SLEEP_EN_W::new(self, 29)
    }
    ///Bit 30 - IP_BLE wakeup enable:
    #[inline(always)]
    pub fn ble_wakeup_en(&mut self) -> BLE_WAKEUP_EN_W<BLUE_SLEEP_REQUEST_MODErs> {
        BLE_WAKEUP_EN_W::new(self, 30)
    }
    ///Bit 31 - IP_BLE sleeping control:
    #[inline(always)]
    pub fn force_sleeping(&mut self) -> FORCE_SLEEPING_W<BLUE_SLEEP_REQUEST_MODErs> {
