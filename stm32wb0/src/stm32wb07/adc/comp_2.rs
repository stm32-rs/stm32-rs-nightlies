...
///Field `GAIN2` reader - second calibration point: gain AUXADC_GAIN_1V2\[11:0\]
pub type GAIN2_R = crate::FieldReader<u16>;
///Field `GAIN2` writer - second calibration point: gain AUXADC_GAIN_1V2\[11:0\]
pub type GAIN2_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `OFFSET2` reader - second calibration point: signed offset compensation\[6:0\]
pub type OFFSET2_R = crate::FieldReader;
///Field `OFFSET2` writer - second calibration point: signed offset compensation\[6:0\]
pub type OFFSET2_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    ...
    pub fn offset2(&self) -> OFFSET2_R {
        OFFSET2_R::new(((self.bits >> 12) & 0x7f) as u8)
    }
}
...
impl W {
    ///Bits 0:11 - second calibration point: gain AUXADC_GAIN_1V2\[11:0\]
    #[inline(always)]
    pub fn gain2(&mut self) -> GAIN2_W<COMP_2rs> {
        GAIN2_W::new(self, 0)
    }
    ///Bits 12:18 - second calibration point: signed offset compensation\[6:0\]
    #[inline(always)]
    pub fn offset2(&mut self) -> OFFSET2_W<COMP_2rs> {
