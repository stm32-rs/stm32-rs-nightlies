...
impl W {
    ///Bit 4 - Address Pointer Error.
    #[inline(always)]
    pub fn addpointerror(&mut self) -> ADDPOINTERROR_W<INTERRUPT1REGrs> {
        ADDPOINTERROR_W::new(self, 4)
    }
    ///Bit 5 - Receive Overflow error.
    #[inline(always)]
    pub fn rxoverflowerror(&mut self) -> RXOVERFLOWERROR_W<INTERRUPT1REGrs> {
        RXOVERFLOWERROR_W::new(self, 5)
    }
    ///Bit 7 - Sequencer end of task.
    #[inline(always)]
    pub fn seqdone(&mut self) -> SEQDONE_W<INTERRUPT1REGrs> {
        SEQDONE_W::new(self, 7)
    }
    ///Bit 8 - Transmission error 0: transmit block missing data error.
    #[inline(always)]
    pub fn txerror_0(&mut self) -> TXERROR_0_W<INTERRUPT1REGrs> {
        TXERROR_0_W::new(self, 8)
    }
    ///Bit 9 - Transmission error 1: a TX skip happened during an on-going transmission.
    #[inline(always)]
    pub fn txerror_1(&mut self) -> TXERROR_1_W<INTERRUPT1REGrs> {
        TXERROR_1_W::new(self, 9)
    }
    ///Bit 10 - Transmission error 2: channel index is greater than 39.
    #[inline(always)]
    pub fn txerror_2(&mut self) -> TXERROR_2_W<INTERRUPT1REGrs> {
        TXERROR_2_W::new(self, 10)
    }
    ///Bit 11 - Transmission error 3: error while waiting for the confirmation the Radio FSM is in TX state.
    #[inline(always)]
    pub fn txerror_3(&mut self) -> TXERROR_3_W<INTERRUPT1REGrs> {
        TXERROR_3_W::new(self, 11)
    }
    ///Bit 12 - Transmission error 4: a CTE issue occurred.
    #[inline(always)]
    pub fn txerror_4(&mut self) -> TXERROR_4_W<INTERRUPT1REGrs> {
        TXERROR_4_W::new(self, 12)
    }
    ///Bit 13 - Encryption error on reception.
    #[inline(always)]
    pub fn encerror(&mut self) -> ENCERROR_W<INTERRUPT1REGrs> {
        ENCERROR_W::new(self, 13)
    }
    ///Bit 14 - All RAM Table not ready on time.
    #[inline(always)]
    pub fn alltablereadyerror(&mut self) -> ALLTABLEREADYERROR_W<INTERRUPT1REGrs> {
        ALLTABLEREADYERROR_W::new(self, 14)
    }
    ///Bit 15 - Transmit data pack not ready error
    #[inline(always)]
    pub fn txdatareadyerror(&mut self) -> TXDATAREADYERROR_W<INTERRUPT1REGrs> {
        TXDATAREADYERROR_W::new(self, 15)
    }
    ///Bit 16 - GlobalStatMach.
    #[inline(always)]
    pub fn noactivelerror(&mut self) -> NOACTIVELERROR_W<INTERRUPT1REGrs> {
        NOACTIVELERROR_W::new(self, 16)
    }
    ///Bit 18 - Receive length error.
    #[inline(always)]
    pub fn rcvlengtherror(&mut self) -> RCVLENGTHERROR_W<INTERRUPT1REGrs> {
        RCVLENGTHERROR_W::new(self, 18)
    }
    ///Bit 19 - Semaphore timeout error
    #[inline(always)]
    pub fn sematimeouterror(&mut self) -> SEMATIMEOUTERROR_W<INTERRUPT1REGrs> {
        SEMATIMEOUTERROR_W::new(self, 19)
    }
    ///Bit 21 - Transmission/Reception skip.
    #[inline(always)]
    pub fn txrxskip(&mut self) -> TXRXSKIP_W<INTERRUPT1REGrs> {
        TXRXSKIP_W::new(self, 21)
    }
    ///Bit 22 - Active2 Radio state error.
    #[inline(always)]
    pub fn active2error(&mut self) -> ACTIVE2ERROR_W<INTERRUPT1REGrs> {
        ACTIVE2ERROR_W::new(self, 22)
    }
    ///Bit 23 - Data pointer configuration error.
    #[inline(always)]
    pub fn configerror(&mut self) -> CONFIGERROR_W<INTERRUPT1REGrs> {
        CONFIGERROR_W::new(self, 23)
    }
    ///Bit 24 - Previous transmitted packet received OK by the peer device.
    #[inline(always)]
    pub fn txok(&mut self) -> TXOK_W<INTERRUPT1REGrs> {
        TXOK_W::new(self, 24)
    }
    ///Bit 25 - Receive/Transmit done.
    #[inline(always)]
    pub fn done(&mut self) -> DONE_W<INTERRUPT1REGrs> {
        DONE_W::new(self, 25)
    }
    ///Bit 26 - Receive timeout (no preamble found).
    #[inline(always)]
    pub fn rcvtimeout(&mut self) -> RCVTIMEOUT_W<INTERRUPT1REGrs> {
        RCVTIMEOUT_W::new(self, 26)
    }
    ///Bit 27 - Received low MD bit.
    #[inline(always)]
    pub fn rcvnomd(&mut self) -> RCVNOMD_W<INTERRUPT1REGrs> {
        RCVNOMD_W::new(self, 27)
    }
    ///Bit 28 - Received command
    #[inline(always)]
    pub fn rcvcmd(&mut self) -> RCVCMD_W<INTERRUPT1REGrs> {
        RCVCMD_W::new(self, 28)
    }
    ///Bit 29 - A time has been captured in TIMERCAPTUREREG.
    #[inline(always)]
    pub fn timecapturetrig(&mut self) -> TIMECAPTURETRIG_W<INTERRUPT1REGrs> {
        TIMECAPTURETRIG_W::new(self, 29)
    }
    ///Bit 30 - Receive data fail
    #[inline(always)]
    pub fn rcvcrcerr(&mut self) -> RCVCRCERR_W<INTERRUPT1REGrs> {
        RCVCRCERR_W::new(self, 30)
    }
    ///Bit 31 - Receive data OK.
    #[inline(always)]
    pub fn rcvok(&mut self) -> RCVOK_W<INTERRUPT1REGrs> {
        RCVOK_W::new(self, 31)
    }
}
