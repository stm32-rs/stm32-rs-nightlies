...
impl W {
    ///Bit 0 - Command done mask
    #[inline(always)]
    pub fn cmddonem(&mut self) -> CMDDONEM_W<IRQMASKrs> {
        CMDDONEM_W::new(self, 0)
    }
    ///Bit 1 - Command started mask.
    #[inline(always)]
    pub fn cmdstartm(&mut self) -> CMDSTARTM_W<IRQMASKrs> {
        CMDSTARTM_W::new(self, 1)
    }
    ///Bit 2 - Command error mask.
    #[inline(always)]
    pub fn cmderrm(&mut self) -> CMDERRM_W<IRQMASKrs> {
        CMDERRM_W::new(self, 2)
    }
    ///Bit 3 - Illegal command mask.
    #[inline(always)]
    pub fn illcmdm(&mut self) -> ILLCMDM_W<IRQMASKrs> {
        ILLCMDM_W::new(self, 3)
    }
    ///Bit 4 - Mass read OK mask.
    #[inline(always)]
    pub fn readokm(&mut self) -> READOKM_W<IRQMASKrs> {
