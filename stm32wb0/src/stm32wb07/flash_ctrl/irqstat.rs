...
impl W {
    ///Bit 0 - Command done masked interrupt status.
    #[inline(always)]
    pub fn cmddone_mis(&mut self) -> CMDDONE_MIS_W<IRQSTATrs> {
        CMDDONE_MIS_W::new(self, 0)
    }
    ///Bit 1 - Command started masked interrupt status.
    #[inline(always)]
    pub fn cmdstart_mis(&mut self) -> CMDSTART_MIS_W<IRQSTATrs> {
        CMDSTART_MIS_W::new(self, 1)
    }
    ///Bit 2 - Command error masked interrupt status.
    #[inline(always)]
    pub fn cmderr_mis(&mut self) -> CMDERR_MIS_W<IRQSTATrs> {
        CMDERR_MIS_W::new(self, 2)
    }
    ///Bit 3 - Illegal command masked interrupt status
    #[inline(always)]
    pub fn illcmd_mis(&mut self) -> ILLCMD_MIS_W<IRQSTATrs> {
        ILLCMD_MIS_W::new(self, 3)
    }
    ///Bit 4 - Mass read OK masked interrupt status.
    #[inline(always)]
    pub fn readok_mis(&mut self) -> READOK_MIS_W<IRQSTATrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#FLASH_CTRL:IRQSTAT)*/
