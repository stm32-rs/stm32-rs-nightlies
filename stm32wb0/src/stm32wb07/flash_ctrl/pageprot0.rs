...
impl W {
    ///Bits 0:15 - First segment definition.
    #[inline(always)]
    pub fn seg0(&mut self) -> SEG0_W<PAGEPROT0rs> {
        SEG0_W::new(self, 0)
    }
    ///Bits 16:31 - Second segment definition. See SEG0 description for details on SEG1\[31:16\] content
    #[inline(always)]
    pub fn seg1(&mut self) -> SEG1_W<PAGEPROT0rs> {
        SEG1_W::new(self, 16)
    }
}
/**PAGEPROT0 register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#FLASH_CTRL:PAGEPROT0)*/
