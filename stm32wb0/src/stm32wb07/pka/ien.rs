...
impl W {
    ///Bit 0 - READY interrupt enable.
    #[inline(always)]
    pub fn ready_en(&mut self) -> READY_EN_W<IENrs> {
        READY_EN_W::new(self, 0)
    }
    ///Bit 2 - RAM access error interrupt enable.
    #[inline(always)]
    pub fn ramerr_en(&mut self) -> RAMERR_EN_W<IENrs> {
        RAMERR_EN_W::new(self, 2)
    }
    ///Bit 3 - AHB Address error interrupt enable.
    #[inline(always)]
    pub fn adderr_en(&mut self) -> ADDERR_EN_W<IENrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#PKA:IEN)*/
pub struct IENrs;
