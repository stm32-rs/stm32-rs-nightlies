...
impl W {
    ...
    ///Bit 8 - Enable wakeup on PB8 I/O event.
    #[inline(always)]
    pub fn ewu20(&mut self) -> EWU20_W<'_, CR6rs> {
        EWU20_W::new(self, 8)
    }
    ///Bit 9 - Enable wakeup on PB9 I/O event.
    #[inline(always)]
    pub fn ewu21(&mut self) -> EWU21_W<'_, CR6rs> {
        EWU21_W::new(self, 9)
    }
    ///Bit 10 - Enable wakeup on PB10 I/O event.
    #[inline(always)]
    pub fn ewu22(&mut self) -> EWU22_W<'_, CR6rs> {
        EWU22_W::new(self, 10)
    }
    ///Bit 11 - Enable wakeup on PB11 I/O event.
    #[inline(always)]
    pub fn ewu23(&mut self) -> EWU23_W<'_, CR6rs> {
        EWU23_W::new(self, 11)
    }
    ///Bit 12 - Enable wakeup on PA12 I/O event.
    #[inline(always)]
    pub fn ewu24(&mut self) -> EWU24_W<'_, CR6rs> {
        EWU24_W::new(self, 12)
    }
    ///Bit 13 - Enable wakeup on PA13 I/O event.
    #[inline(always)]
    pub fn ewu25(&mut self) -> EWU25_W<'_, CR6rs> {
        EWU25_W::new(self, 13)
    }
    ///Bit 14 - Enable wakeup on PA14 I/O event.
    #[inline(always)]
    pub fn ewu26(&mut self) -> EWU26_W<'_, CR6rs> {
        EWU26_W::new(self, 14)
    }
    ///Bit 15 - Enable wakeup on PA15 I/O event.
    #[inline(always)]
    pub fn ewu27(&mut self) -> EWU27_W<'_, CR6rs> {
        EWU27_W::new(self, 15)
    }
}
/**CR6 register
