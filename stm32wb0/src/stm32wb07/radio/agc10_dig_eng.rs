...
impl W {
    ///Bits 0:2 - Attenuation at IF Level for the AGC step 0:
    #[inline(always)]
    pub fn att_if_0(&mut self) -> ATT_IF_0_W<AGC10_DIG_ENGrs> {
        ATT_IF_0_W::new(self, 0)
    }
    ///Bit 3 - Attenuation at LNA Level for the AGC step 0:
    #[inline(always)]
    pub fn att_lna_0(&mut self) -> ATT_LNA_0_W<AGC10_DIG_ENGrs> {
        ATT_LNA_0_W::new(self, 3)
    }
    ///Bits 4:5 - Attenuation at Antenna Level for the AGC step 0:
    #[inline(always)]
    pub fn att_ant_0(&mut self) -> ATT_ANT_0_W<AGC10_DIG_ENGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#RADIO:AGC10_DIG_ENG)*/
