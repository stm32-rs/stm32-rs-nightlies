...
impl W {
    ///Bits 0:2 - Attenuation at IF Level for the AGC step 7
    #[inline(always)]
    pub fn att_if_7(&mut self) -> ATT_IF_7_W<AGC17_DIG_ENGrs> {
        ATT_IF_7_W::new(self, 0)
    }
    ///Bit 3 - Attenuation at LNA Level for the AGC step 7
    #[inline(always)]
    pub fn att_lna_7(&mut self) -> ATT_LNA_7_W<AGC17_DIG_ENGrs> {
        ATT_LNA_7_W::new(self, 3)
    }
    ///Bits 4:5 - Attenuation at Antenna Level for the AGC step 7
    #[inline(always)]
    pub fn att_ant_7(&mut self) -> ATT_ANT_7_W<AGC17_DIG_ENGrs> {
