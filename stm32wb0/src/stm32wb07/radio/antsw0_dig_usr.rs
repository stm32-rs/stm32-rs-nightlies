...
impl W {
    ///Bits 0:6 - specifies the exact timing of the first I/Q sampling in the reference period.
    #[inline(always)]
    pub fn rx_time_to_sample(&mut self) -> RX_TIME_TO_SAMPLE_W<ANTSW0_DIG_USRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#RADIO:ANTSW0_DIG_USR)*/
