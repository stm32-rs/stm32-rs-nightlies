...
impl W {
    ///Bits 0:3 - Set the gain of the clock recovery loop before Access Address detection to the value
    #[inline(always)]
    pub fn cr_gain_after(&mut self) -> CR_GAIN_AFTER_W<CR0_DIG_ENGrs> {
        CR_GAIN_AFTER_W::new(self, 0)
    }
    ///Bits 4:7 - Set the gain of the clock recovery loop before Access Address detection to the value
    #[inline(always)]
    pub fn cr_gain_before(&mut self) -> CR_GAIN_BEFORE_W<CR0_DIG_ENGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#RADIO:CR0_DIG_ENG)*/
