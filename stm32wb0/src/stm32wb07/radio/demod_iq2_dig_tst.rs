...
impl W {
    ///Bits 0:1 - Defines the sampling time, when extended configuration is enabled:
    #[inline(always)]
    pub fn extcfg_sampling_time(&mut self) -> EXTCFG_SAMPLING_TIME_W<DEMOD_IQ2_DIG_TSTrs> {
        EXTCFG_SAMPLING_TIME_W::new(self, 0)
    }
    ///Bits 2:3 - Defines the trigger/anchor point of the IQ sampling, when extended configuration is enabled:
    #[inline(always)]
    pub fn extcfg_trig_selection(&mut self) -> EXTCFG_TRIG_SELECTION_W<DEMOD_IQ2_DIG_TSTrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#RADIO:DEMOD_IQ2_DIG_TST)*/
