...
impl W {
    ///Bit 0 - TIM1 enable
    #[inline(always)]
    pub fn tim1en(&mut self) -> TIM1EN_W<APB0ENRrs> {
        TIM1EN_W::new(self, 0)
    }
    ///Bit 8 - SYSTEM CONFIG enable Set and enable by software.
    #[inline(always)]
    pub fn syscfgen(&mut self) -> SYSCFGEN_W<APB0ENRrs> {
        SYSCFGEN_W::new(self, 8)
    }
    ///Bit 12 - RTC clock enable Set and enable by software. Reset source only for this field: PORESETn
    #[inline(always)]
    pub fn rtcen(&mut self) -> RTCEN_W<APB0ENRrs> {
        RTCEN_W::new(self, 12)
    }
    ///Bit 14 - Watchdog clock enable. Set and enable by software.
    #[inline(always)]
    pub fn wdgen(&mut self) -> WDGEN_W<APB0ENRrs> {
        WDGEN_W::new(self, 14)
    }
}
/**APB0ENR register
