...
///Field `WDGRST` reader - WATCHDOG reset Set and reset by software.
pub type WDGRST_R = crate::BitReader;
///Field `WDGRST` writer - WATCHDOG reset Set and reset by software.
...
impl W {
    ...
    ///Bit 14 - WATCHDOG reset Set and reset by software.
    #[inline(always)]
    pub fn wdgrst(&mut self) -> WDGRST_W<APB0RSTRrs> {
