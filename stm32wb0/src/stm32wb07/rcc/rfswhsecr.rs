...
impl W {
    ///Bit 3 - Sense Amplifier threshold Set by software.
    #[inline(always)]
    pub fn satrg(&mut self) -> SATRG_W<RFSWHSECRrs> {
        SATRG_W::new(self, 3)
    }
    ///Bits 4:6 - High Speed External XO current control Set by software.
    #[inline(always)]
    pub fn gmc(&mut self) -> GMC_W<RFSWHSECRrs> {
        GMC_W::new(self, 4)
    }
    ///Bit 7 - RF-HSE capacitor bank tuning by SW enable Set by software
    #[inline(always)]
    pub fn swxotuneen(&mut self) -> SWXOTUNEEN_W<RFSWHSECRrs> {
        SWXOTUNEEN_W::new(self, 7)
    }
    ///Bits 8:13 - RF-HSE capacitor bank tuning value by SW Set by software
    #[inline(always)]
    pub fn swxotune(&mut self) -> SWXOTUNE_W<RFSWHSECRrs> {
