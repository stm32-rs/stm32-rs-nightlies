...
impl W {
    ///Bit 0 - On read, returns the semaphore locked interrupt status.
    #[inline(always)]
    pub fn lock(&mut self) -> LOCK_W<SEMA_IRQ_STATUSrs> {
        LOCK_W::new(self, 0)
    }
    ///Bit 1 - On read, returns the semaphore unlocked interrupt status.
    #[inline(always)]
    pub fn unlock(&mut self) -> UNLOCK_W<SEMA_IRQ_STATUSrs> {
        UNLOCK_W::new(self, 1)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#RRM:SEMA_IRQ_STATUS)*/
