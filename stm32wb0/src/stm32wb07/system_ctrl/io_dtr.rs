...
///Field `PA4_DT` reader - PA4_DT:Interrupt Detection Type for port A I/Os.
pub type PA4_DT_R = crate::BitReader;
///Field `PA4_DT` writer - PA4_DT:Interrupt Detection Type for port A I/Os.
pub type PA4_DT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PA5_DT` reader - PA5_DT:Interrupt Detection Type for port A I/Os.
pub type PA5_DT_R = crate::BitReader;
///Field `PA5_DT` writer - PA5_DT:Interrupt Detection Type for port A I/Os.
pub type PA5_DT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PA6_DT` reader - PA6_DT:Interrupt Detection Type for port A I/Os.
pub type PA6_DT_R = crate::BitReader;
///Field `PA6_DT` writer - PA6_DT:Interrupt Detection Type for port A I/Os.
pub type PA6_DT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PA7_DT` reader - PA7_DT:Interrupt Detection Type for port A I/Os.
pub type PA7_DT_R = crate::BitReader;
///Field `PA7_DT` writer - PA7_DT:Interrupt Detection Type for port A I/Os.
...
///Field `PB8_DT` reader - PB8_DT:Interrupt Detection Type for port B I/Os.
pub type PB8_DT_R = crate::BitReader;
///Field `PB8_DT` writer - PB8_DT:Interrupt Detection Type for port B I/Os.
pub type PB8_DT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PB9_DT` reader - PB9_DT:Interrupt Detection Type for port B I/Os.
pub type PB9_DT_R = crate::BitReader;
///Field `PB9_DT` writer - PB9_DT:Interrupt Detection Type for port B I/Os.
pub type PB9_DT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PB10_DT` reader - PB10_DT:Interrupt Detection Type for port B I/Os.
pub type PB10_DT_R = crate::BitReader;
///Field `PB10_DT` writer - PB10_DT:Interrupt Detection Type for port B I/Os.
pub type PB10_DT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PB11_DT` reader - PB11_DT:Interrupt Detection Type for port B I/Os.
pub type PB11_DT_R = crate::BitReader;
///Field `PB11_DT` writer - PB11_DT:Interrupt Detection Type for port B I/Os.
...
impl R {
    ...
    ///Bit 4 - PA4_DT:Interrupt Detection Type for port A I/Os.
    #[inline(always)]
    pub fn pa4_dt(&self) -> PA4_DT_R {
        PA4_DT_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - PA5_DT:Interrupt Detection Type for port A I/Os.
    #[inline(always)]
    pub fn pa5_dt(&self) -> PA5_DT_R {
        PA5_DT_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - PA6_DT:Interrupt Detection Type for port A I/Os.
    #[inline(always)]
    pub fn pa6_dt(&self) -> PA6_DT_R {
        PA6_DT_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - PA7_DT:Interrupt Detection Type for port A I/Os.
    #[inline(always)]
    ...
    ///Bit 24 - PB8_DT:Interrupt Detection Type for port B I/Os.
    #[inline(always)]
    pub fn pb8_dt(&self) -> PB8_DT_R {
        PB8_DT_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - PB9_DT:Interrupt Detection Type for port B I/Os.
    #[inline(always)]
    pub fn pb9_dt(&self) -> PB9_DT_R {
        PB9_DT_R::new(((self.bits >> 25) & 1) != 0)
    }
    ///Bit 26 - PB10_DT:Interrupt Detection Type for port B I/Os.
    #[inline(always)]
    pub fn pb10_dt(&self) -> PB10_DT_R {
        PB10_DT_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bit 27 - PB11_DT:Interrupt Detection Type for port B I/Os.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 4 - PA4_DT:Interrupt Detection Type for port A I/Os.
    #[inline(always)]
    pub fn pa4_dt(&mut self) -> PA4_DT_W<IO_DTRrs> {
        PA4_DT_W::new(self, 4)
    }
    ///Bit 5 - PA5_DT:Interrupt Detection Type for port A I/Os.
    #[inline(always)]
    pub fn pa5_dt(&mut self) -> PA5_DT_W<IO_DTRrs> {
        PA5_DT_W::new(self, 5)
    }
    ///Bit 6 - PA6_DT:Interrupt Detection Type for port A I/Os.
    #[inline(always)]
    pub fn pa6_dt(&mut self) -> PA6_DT_W<IO_DTRrs> {
        PA6_DT_W::new(self, 6)
    }
    ///Bit 7 - PA7_DT:Interrupt Detection Type for port A I/Os.
    #[inline(always)]
    pub fn pa7_dt(&mut self) -> PA7_DT_W<IO_DTRrs> {
        PA7_DT_W::new(self, 7)
    }
    ///Bit 8 - PA8_DT: Interrupt Detection Type for port A I/Os. 0: edge detection. 1: level detection.
    #[inline(always)]
    ...
    ///Bit 24 - PB8_DT:Interrupt Detection Type for port B I/Os.
    #[inline(always)]
    pub fn pb8_dt(&mut self) -> PB8_DT_W<IO_DTRrs> {
        PB8_DT_W::new(self, 24)
    }
    ///Bit 25 - PB9_DT:Interrupt Detection Type for port B I/Os.
    #[inline(always)]
    pub fn pb9_dt(&mut self) -> PB9_DT_W<IO_DTRrs> {
        PB9_DT_W::new(self, 25)
    }
    ///Bit 26 - PB10_DT:Interrupt Detection Type for port B I/Os.
    #[inline(always)]
    pub fn pb10_dt(&mut self) -> PB10_DT_W<IO_DTRrs> {
        PB10_DT_W::new(self, 26)
    }
    ///Bit 27 - PB11_DT:Interrupt Detection Type for port B I/Os.
    #[inline(always)]
    pub fn pb11_dt(&mut self) -> PB11_DT_W<IO_DTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#SYSTEM_CTRL:IO_DTR)*/
pub struct IO_DTRrs;
