...
///Field `PA4_IE` reader - PA4_IE: Interrupt enable for port A I/Os.
pub type PA4_IE_R = crate::BitReader;
///Field `PA4_IE` writer - PA4_IE: Interrupt enable for port A I/Os.
pub type PA4_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PA5_IE` reader - PA5_IE: Interrupt enable for port A I/Os.
pub type PA5_IE_R = crate::BitReader;
///Field `PA5_IE` writer - PA5_IE: Interrupt enable for port A I/Os.
pub type PA5_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PA6_IE` reader - PA6_IE: Interrupt enable for port A I/Os.
pub type PA6_IE_R = crate::BitReader;
///Field `PA6_IE` writer - PA6_IE: Interrupt enable for port A I/Os.
pub type PA6_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PA7_IE` reader - PA7_IE: Interrupt enable for port A I/Os.
pub type PA7_IE_R = crate::BitReader;
///Field `PA7_IE` writer - PA7_IE: Interrupt enable for port A I/Os.
...
///Field `PA12_IE` reader - PA12_IE: Interrupt enable for port A I/Os.
pub type PA12_IE_R = crate::BitReader;
///Field `PA12_IE` writer - PA12_IE: Interrupt enable for port A I/Os.
pub type PA12_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PA13_IE` reader - PA13_IE: Interrupt enable for port A I/Os.
pub type PA13_IE_R = crate::BitReader;
///Field `PA13_IE` writer - PA13_IE: Interrupt enable for port A I/Os.
pub type PA13_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PA14_IE` reader - PA14_IE: Interrupt enable for port A I/Os.
pub type PA14_IE_R = crate::BitReader;
///Field `PA14_IE` writer - PA14_IE: Interrupt enable for port A I/Os.
pub type PA14_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PA15_IE` reader - PA15_IE: Interrupt enable for port A I/Os.
pub type PA15_IE_R = crate::BitReader;
///Field `PA15_IE` writer - PA15_IE: Interrupt enable for port A I/Os.
...
///Field `PB8_IE` reader - PB8_IE: Interrupt enable for port B I/Os.
pub type PB8_IE_R = crate::BitReader;
///Field `PB8_IE` writer - PB8_IE: Interrupt enable for port B I/Os.
pub type PB8_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PB9_IE` reader - PB9_IE: Interrupt enable for port B I/Os.
pub type PB9_IE_R = crate::BitReader;
///Field `PB9_IE` writer - PB9_IE: Interrupt enable for port B I/Os.
pub type PB9_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PB10_IE` reader - PB10_IE: Interrupt enable for port B I/Os.
pub type PB10_IE_R = crate::BitReader;
///Field `PB10_IE` writer - PB10_IE: Interrupt enable for port B I/Os.
pub type PB10_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PB11_IE` reader - PB11_IE: Interrupt enable for port B I/Os.
pub type PB11_IE_R = crate::BitReader;
///Field `PB11_IE` writer - PB11_IE: Interrupt enable for port B I/Os.
...
impl R {
    ...
    ///Bit 4 - PA4_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa4_ie(&self) -> PA4_IE_R {
        PA4_IE_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - PA5_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa5_ie(&self) -> PA5_IE_R {
        PA5_IE_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - PA6_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa6_ie(&self) -> PA6_IE_R {
        PA6_IE_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - PA7_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    ...
    ///Bit 12 - PA12_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa12_ie(&self) -> PA12_IE_R {
        PA12_IE_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - PA13_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa13_ie(&self) -> PA13_IE_R {
        PA13_IE_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - PA14_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa14_ie(&self) -> PA14_IE_R {
        PA14_IE_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - PA15_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    ...
    ///Bit 24 - PB8_IE: Interrupt enable for port B I/Os.
    #[inline(always)]
    pub fn pb8_ie(&self) -> PB8_IE_R {
        PB8_IE_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - PB9_IE: Interrupt enable for port B I/Os.
    #[inline(always)]
    pub fn pb9_ie(&self) -> PB9_IE_R {
        PB9_IE_R::new(((self.bits >> 25) & 1) != 0)
    }
    ///Bit 26 - PB10_IE: Interrupt enable for port B I/Os.
    #[inline(always)]
    pub fn pb10_ie(&self) -> PB10_IE_R {
        PB10_IE_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bit 27 - PB11_IE: Interrupt enable for port B I/Os.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 4 - PA4_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa4_ie(&mut self) -> PA4_IE_W<IO_IERrs> {
        PA4_IE_W::new(self, 4)
    }
    ///Bit 5 - PA5_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa5_ie(&mut self) -> PA5_IE_W<IO_IERrs> {
        PA5_IE_W::new(self, 5)
    }
    ///Bit 6 - PA6_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa6_ie(&mut self) -> PA6_IE_W<IO_IERrs> {
        PA6_IE_W::new(self, 6)
    }
    ///Bit 7 - PA7_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa7_ie(&mut self) -> PA7_IE_W<IO_IERrs> {
        PA7_IE_W::new(self, 7)
    }
    ///Bit 8 - PA8_IE: Interrupt enable for port A I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
    #[inline(always)]
    ...
    ///Bit 12 - PA12_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa12_ie(&mut self) -> PA12_IE_W<IO_IERrs> {
        PA12_IE_W::new(self, 12)
    }
    ///Bit 13 - PA13_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa13_ie(&mut self) -> PA13_IE_W<IO_IERrs> {
        PA13_IE_W::new(self, 13)
    }
    ///Bit 14 - PA14_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa14_ie(&mut self) -> PA14_IE_W<IO_IERrs> {
        PA14_IE_W::new(self, 14)
    }
    ///Bit 15 - PA15_IE: Interrupt enable for port A I/Os.
    #[inline(always)]
    pub fn pa15_ie(&mut self) -> PA15_IE_W<IO_IERrs> {
    ...
    ///Bit 24 - PB8_IE: Interrupt enable for port B I/Os.
    #[inline(always)]
    pub fn pb8_ie(&mut self) -> PB8_IE_W<IO_IERrs> {
        PB8_IE_W::new(self, 24)
    }
    ///Bit 25 - PB9_IE: Interrupt enable for port B I/Os.
    #[inline(always)]
    pub fn pb9_ie(&mut self) -> PB9_IE_W<IO_IERrs> {
        PB9_IE_W::new(self, 25)
    }
    ///Bit 26 - PB10_IE: Interrupt enable for port B I/Os.
    #[inline(always)]
    pub fn pb10_ie(&mut self) -> PB10_IE_W<IO_IERrs> {
        PB10_IE_W::new(self, 26)
    }
    ///Bit 27 - PB11_IE: Interrupt enable for port B I/Os.
    #[inline(always)]
    pub fn pb11_ie(&mut self) -> PB11_IE_W<IO_IERrs> {
