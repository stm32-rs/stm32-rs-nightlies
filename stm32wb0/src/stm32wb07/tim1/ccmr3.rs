...
///Field `OC5M_2_0` reader - Output compare 5 mode.
pub type OC5M_2_0_R = crate::FieldReader;
///Field `OC5M_2_0` writer - Output compare 5 mode.
pub type OC5M_2_0_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
///Field `OC6M_2_0` reader - Output compare 6 mode.
pub type OC6M_2_0_R = crate::FieldReader;
///Field `OC6M_2_0` writer - Output compare 6 mode.
pub type OC6M_2_0_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type OC5M_3_R = crate::BitReader;
///Field `OC5M_3` writer - Output compare 5 mode - bit 3.
pub type OC5M_3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OC6M_3` reader - Output compare 6 mode - bit 3.
pub type OC6M_3_R = crate::BitReader;
///Field `OC6M_3` writer - Output compare 6 mode - bit 3.
pub type OC6M_3_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn oc5m_2_0(&self) -> OC5M_2_0_R {
        OC5M_2_0_R::new(((self.bits >> 4) & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn oc6m_2_0(&self) -> OC6M_2_0_R {
        OC6M_2_0_R::new(((self.bits >> 12) & 7) as u8)
    }
...
impl W {
    ...
    ///Bits 4:6 - Output compare 5 mode.
    #[inline(always)]
    pub fn oc5m_2_0(&mut self) -> OC5M_2_0_W<CCMR3rs> {
        OC5M_2_0_W::new(self, 4)
    }
    ///Bit 7 - Output compare 5 clear enable.
    #[inline(always)]
    ...
    ///Bits 12:14 - Output compare 6 mode.
    #[inline(always)]
    pub fn oc6m_2_0(&mut self) -> OC6M_2_0_W<CCMR3rs> {
        OC6M_2_0_W::new(self, 12)
    }
    ///Bit 15 - Output compare 6 clear enable.
    #[inline(always)]
    ...
    ///Bit 16 - Output compare 5 mode - bit 3.
    #[inline(always)]
    pub fn oc5m_3(&mut self) -> OC5M_3_W<CCMR3rs> {
        OC5M_3_W::new(self, 16)
    }
    ///Bit 24 - Output compare 6 mode - bit 3.
    #[inline(always)]
    pub fn oc6m_3(&mut self) -> OC6M_3_W<CCMR3rs> {
