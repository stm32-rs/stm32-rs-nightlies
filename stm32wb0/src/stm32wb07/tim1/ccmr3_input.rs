...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `IC5PSC` field.</div>
    #[inline(always)]
    pub fn icpsc(&mut self, n: u8) -> ICPSC_W<CCMR3_INPUTrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bits 2:3 - Input capture 5 prescaler
    #[inline(always)]
    pub fn ic5psc(&mut self) -> ICPSC_W<CCMR3_INPUTrs> {
        ICPSC_W::new(self, 2)
    }
    ///Bits 10:11 - Input capture 6 prescaler
    #[inline(always)]
    pub fn ic6psc(&mut self) -> ICPSC_W<CCMR3_INPUTrs> {
        ICPSC_W::new(self, 10)
    }
    ///Input capture (5-6) filter
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `IC5F` field.</div>
    #[inline(always)]
    pub fn icf(&mut self, n: u8) -> ICF_W<CCMR3_INPUTrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bits 4:7 - Input capture 5 filter
    #[inline(always)]
    pub fn ic5f(&mut self) -> ICF_W<CCMR3_INPUTrs> {
        ICF_W::new(self, 4)
    }
    ///Bits 12:15 - Input capture 6 filter
    #[inline(always)]
    pub fn ic6f(&mut self) -> ICF_W<CCMR3_INPUTrs> {
        ICF_W::new(self, 12)
    }
}
/**
