...
impl W {
    ///Bits 4:31 - programmed wakeup time for CPU.
    #[inline(always)]
    pub fn wakeup_time(&mut self) -> WAKEUP_TIME_W<CM0_WAKEUP_TIMErs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB07.html#WAKEUP:CM0_WAKEUP_TIME)*/
