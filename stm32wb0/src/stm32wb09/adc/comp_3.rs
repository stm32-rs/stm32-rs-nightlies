...
///Field `OFFSET3` reader - OFFSET3\[7:0\]: third calibration point: offset compensation\[7:0\] with sign
pub type OFFSET3_R = crate::FieldReader;
///Field `OFFSET3` writer - OFFSET3\[7:0\]: third calibration point: offset compensation\[7:0\] with sign
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#ADC:COMP_3)*/
pub struct COMP_3rs;
