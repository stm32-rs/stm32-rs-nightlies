...
impl RegisterBlock {
    ...
    ///0x7c - STATUS2REG register
    #[inline(always)]
    pub const fn status2reg(&self) -> &STATUS2REG {
        &self.status2reg
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:INTERRUPT2REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:TIMEOUTDESTREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:TIMEOUTREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:TIMERCAPTUREREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:CMDREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:STATUSREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:INTERRUPT1ENABLEREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:INTERRUPT1LATENCYREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESKEY0REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESKEY1REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESKEY2REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESKEY3REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESCLEARTEXT0REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESCLEARTEXT3REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESCIPHERTEXT1REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESCIPHERTEXT2REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESCIPHERTEXT3REG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESCMDREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:MANAESSTATREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:AESLEPRIVPOINTERREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:AESLEPRIVHASHREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:AESLEPRIVPRANDREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:AESLEPRIVCMDREG)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:AESLEPRIVSTATREG)
...
/**STATUS2REG (r) register accessor: STATUS2REG register

You can [`read`](crate::Reg::read) this register and get [`status2reg::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#BLUE:STATUS2REG)

For information about available fields see [`mod@status2reg`] module*/
pub type STATUS2REG = crate::Reg<status2reg::STATUS2REGrs>;
///STATUS2REG register
pub mod status2reg;
