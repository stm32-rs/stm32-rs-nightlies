...
impl W {
    ...
    #[inline(always)]
    pub fn cgif8(&mut self) -> CGIF8_W<IFCRrs> {
        CGIF8_W::new(self, 28)
    }
    ...
    #[inline(always)]
    pub fn ctcif8(&mut self) -> CTCIF8_W<IFCRrs> {
    ...
    #[inline(always)]
    pub fn chtif8(&mut self) -> CHTIF8_W<IFCRrs> {
    ...
    #[inline(always)]
    pub fn cteif8(&mut self) -> CTEIF8_W<IFCRrs> {
