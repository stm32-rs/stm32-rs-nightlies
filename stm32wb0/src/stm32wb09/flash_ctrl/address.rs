...
impl W {
    ///Bits 0:5 - Flash column address offset to be used with some COMMAND
    #[inline(always)]
    pub fn yaddr(&mut self) -> YADDR_W<ADDRESSrs> {
        YADDR_W::new(self, 0)
    }
    ///Bits 6:15 - Flash row address offset to be used with some COMMAND
    #[inline(always)]
    pub fn xaddr(&mut self) -> XADDR_W<ADDRESSrs> {
        XADDR_W::new(self, 6)
    }
}
/**ADDRESS register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#FLASH_CTRL:ADDRESS)*/
