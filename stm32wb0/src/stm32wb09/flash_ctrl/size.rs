...
///Field `FLASH_SIZE` reader - Maximum valid address for flash memory: 00 : 0x03FFF (64kb) 01 : 0x07FFF (128kb) 10 : 0x09FFF (160kb) 11 : 0x0BFFF (192kb)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#FLASH_CTRL:SIZE)*/
pub struct SIZErs;
...
///`reset()` method sets SIZE to value 0x0006_bfff
impl crate::Resettable for SIZErs {
    const RESET_VALUE: u32 = 0x0006_bfff;
}
