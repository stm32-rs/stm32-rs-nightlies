...
///Field `OT(0-11)` reader - Port x configuration pin %s
...
///Field `OT(0-11)` writer - Port x configuration pin %s
...
impl R {
    ...
    pub fn ot_iter(&self) -> impl Iterator<Item = OT_R> + '_ {
        (0..12).map(move |n| OT_R::new(((self.bits >> n) & 1) != 0))
    }
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `OT0` field.</div>
    #[inline(always)]
    pub fn ot(&mut self, n: u8) -> OT_W<'_, OTYPERrs> {
        #[allow(clippy::no_effect)]
        [(); 12][n as usize];
        OT_W::new(self, n)
    }
    ///Bit 0 - Port x configuration pin 0
    #[inline(always)]
    pub fn ot0(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 0)
    }
    ///Bit 1 - Port x configuration pin 1
    #[inline(always)]
    pub fn ot1(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 1)
    }
    ///Bit 2 - Port x configuration pin 2
    #[inline(always)]
    pub fn ot2(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 2)
    }
    ///Bit 3 - Port x configuration pin 3
    #[inline(always)]
    pub fn ot3(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 3)
    }
    ///Bit 4 - Port x configuration pin 4
    #[inline(always)]
    pub fn ot4(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 4)
    }
    ///Bit 5 - Port x configuration pin 5
    #[inline(always)]
    pub fn ot5(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 5)
    }
    ///Bit 6 - Port x configuration pin 6
    #[inline(always)]
    pub fn ot6(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 6)
    }
    ///Bit 7 - Port x configuration pin 7
    #[inline(always)]
    pub fn ot7(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 7)
    }
    ///Bit 8 - Port x configuration pin 8
    #[inline(always)]
    pub fn ot8(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 8)
    }
    ///Bit 9 - Port x configuration pin 9
    #[inline(always)]
    pub fn ot9(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 9)
    }
    ///Bit 10 - Port x configuration pin 10
    #[inline(always)]
    pub fn ot10(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 10)
    }
    ///Bit 11 - Port x configuration pin 11
    #[inline(always)]
    pub fn ot11(&mut self) -> OT_W<'_, OTYPERrs> {
        OT_W::new(self, 11)
    }
}
/**OTYPER register
