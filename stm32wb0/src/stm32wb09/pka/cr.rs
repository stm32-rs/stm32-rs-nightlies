...
///Field `FAULTFSMIE` reader - Fault FSM interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTFSMF (PKA_SR\[22\]) is set.
pub type FAULTFSMIE_R = crate::BitReader;
///Field `FAULTFSMIE` writer - Fault FSM interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTFSMF (PKA_SR\[22\]) is set.
pub type FAULTFSMIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FAULTERRORCODEIE` reader - Fault error code interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTERRORCODEF (PKA_SR\[23\]) is set.
pub type FAULTERRORCODEIE_R = crate::BitReader;
///Field `FAULTERRORCODEIE` writer - Fault error code interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTERRORCODEF (PKA_SR\[23\]) is set.
pub type FAULTERRORCODEIE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn faultfsmie(&self) -> FAULTFSMIE_R {
        FAULTFSMIE_R::new(((self.bits >> 22) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn faulterrorcodeie(&self) -> FAULTERRORCODEIE_R {
        FAULTERRORCODEIE_R::new(((self.bits >> 23) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CR")
            ...
            .field("faultfsmie", &self.faultfsmie())
            .field("faulterrorcodeie", &self.faulterrorcodeie())
            .finish()
    }
}
impl W {
    ...
    ///Bit 2 - Security enable. 0: No side channel countermeasure 1: Square and Multiply always / Double and Add always
    #[inline(always)]
    pub fn seclvl(&mut self) -> SECLVL_W<CRrs> {
        SECLVL_W::new(self, 2)
    }
    ///Bits 8:13 - PKA operation code 000000 : Compute Montgomery parameter and modular exponentiation 000001 : Compute Montgomery parameter 000010 : Compute modular exponentiation only (Montgomery parameter should be loaded) 100000 : Compute Montgomery parameter and compute ECC kP operation 100010 : Compute the ECC kP primitive only (Montgomery parameter should be loaded) 100100 : ECDSA sign 100110 : ECDSA Verification 101000 : Point Check 000111 : RSA CRT exponentiation 001000 : Modular inversion 001001 : Arithmetic addition 001010 : Arithmetic Subtraction 001011 : Arithmetic multiplication 001100 : Comparison 001101 : Modular Reduction 001110 : Modular Addition 001111 : Modular Subtraction 010000 : Montgomery Multiplication
    #[inline(always)]
    ...
    ///Bit 22 - Fault FSM interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTFSMF (PKA_SR\[22\]) is set.
    #[inline(always)]
    pub fn faultfsmie(&mut self) -> FAULTFSMIE_W<CRrs> {
        FAULTFSMIE_W::new(self, 22)
    }
    ///Bit 23 - Fault error code interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTERRORCODEF (PKA_SR\[23\]) is set.
    #[inline(always)]
    pub fn faulterrorcodeie(&mut self) -> FAULTERRORCODEIE_W<CRrs> {
        FAULTERRORCODEIE_W::new(self, 23)
    }
}
/**PKA_CR register
