...
impl W {
    ///Bits 0:2 - Attenuation at IF Level for the AGC step 5
    #[inline(always)]
    pub fn att_if_5(&mut self) -> ATT_IF_5_W<AGC15_DIG_ENGrs> {
        ATT_IF_5_W::new(self, 0)
    }
    ///Bit 3 - Attenuation at LNA Level for the AGC step 5
    #[inline(always)]
    pub fn att_lna_5(&mut self) -> ATT_LNA_5_W<AGC15_DIG_ENGrs> {
        ATT_LNA_5_W::new(self, 3)
    }
    ///Bits 4:5 - Attenuation at Antenna Level for the AGC step 5
    #[inline(always)]
    pub fn att_ant_5(&mut self) -> ATT_ANT_5_W<AGC15_DIG_ENGrs> {
