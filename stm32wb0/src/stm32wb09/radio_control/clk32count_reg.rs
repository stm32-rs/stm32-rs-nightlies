...
impl W {
    ///Bits 0:8 - program the window length (in slow clock period) for slow clock measurement.
    #[inline(always)]
    pub fn slow_count(&mut self) -> SLOW_COUNT_W<CLK32COUNT_REGrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#RADIO_CONTROL:CLK32COUNT_REG)*/
