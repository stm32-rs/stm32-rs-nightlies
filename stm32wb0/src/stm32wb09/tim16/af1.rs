...
impl W {
    ...
    ///Bits 3:8 - AF1\[13:12\] Not used in Blue51. Not available in IUM
    #[inline(always)]
    pub fn af1_8_3(&mut self) -> AF1_8_3_W<AF1rs> {
    ...
    ///Bits 12:13 - AF1\[13:12\] Not used in Blue51. Not available in IUM
    #[inline(always)]
    pub fn af1_13_12(&mut self) -> AF1_13_12_W<AF1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#TIM16:AF1)*/
pub struct AF1rs;
