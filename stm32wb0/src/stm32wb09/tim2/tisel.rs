...
///Field `TI2SEL` reader - selects TI2\[0\] to TI2\[15\] inputt
pub type TI2SEL_R = crate::FieldReader;
///Field `TI2SEL` writer - selects TI2\[0\] to TI2\[15\] inputt
pub type TI2SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TI3SEL` reader - selects TI3\[0\] to TI3\[15\] input
pub type TI3SEL_R = crate::FieldReader;
///Field `TI3SEL` writer - selects TI3\[0\] to TI3\[15\] input
pub type TI3SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TI4SEL` reader - selects TI4\[0\] to TI4\[15\] input
pub type TI4SEL_R = crate::FieldReader;
///Field `TI4SEL` writer - selects TI4\[0\] to TI4\[15\] input
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#TIM2:TISEL)*/
pub struct TISELrs;
