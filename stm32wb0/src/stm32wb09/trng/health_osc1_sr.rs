///Register `HEALTH_OSC1_SR` reader
pub type R = crate::R<HEALTH_OSC1_SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`health_osc1_sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WB09.html#TRNG:HEALTH_OSC1_SR)*/
pub struct HEALTH_OSC1_SRrs;
impl crate::RegisterSpec for HEALTH_OSC1_SRrs {
    type Ux = u32;
}
///`read()` method returns [`health_osc1_sr::R`](R) reader structure
impl crate::Readable for HEALTH_OSC1_SRrs {}
///`reset()` method sets HEALTH_OSC1_SR to value 0
impl crate::Resettable for HEALTH_OSC1_SRrs {}
