...
///Field `KEY` writer - Cryptographic key, bits \[159:128\] Refer to the AES_KEYR0 register for description of the KEY\[255:0\] bitfield. Writing to this register has no effect when key size is 128-bit (KEYSIZE=0). When KEYVALID is set in AES_SR a write to this register clears KEYVALID if EN is cleared in AES_CR.
