...
///Field `DBG_LPTIM2_STOP` reader - LPTIM2 stop in CPU debug Write access can be protected by GTZC_TZSC.LPTIM2SEC.
pub type DBG_LPTIM2_STOP_R = crate::BitReader;
///Field `DBG_LPTIM2_STOP` writer - LPTIM2 stop in CPU debug Write access can be protected by GTZC_TZSC.LPTIM2SEC.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#DBGMCU:APB1HFZR)*/
