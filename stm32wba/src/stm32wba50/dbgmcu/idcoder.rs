...
///Field `REV_ID` reader - Revision ID
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#DBGMCU:IDCODER)*/
...
///`reset()` method sets IDCODER to value 0x6492
impl crate::Resettable for IDCODERrs {
    const RESET_VALUE: u32 = 0x6492;
}
