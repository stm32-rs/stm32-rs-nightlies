...
///Field `OEM1KEY` writer - OEM1 key most significant bytes
...
impl W {
    ///Bits 0:31 - OEM1 key most significant bytes
    #[inline(always)]
    pub fn oem1key(&mut self) -> OEM1KEY_W<'_, OEM1KEYR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#FLASH:OEM1KEYR2)*/
