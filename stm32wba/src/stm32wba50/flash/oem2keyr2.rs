...
///Field `OEM2KEY` writer - OEM2 key most significant bytes
...
impl W {
    ///Bits 0:31 - OEM2 key most significant bytes
    #[inline(always)]
    pub fn oem2key(&mut self) -> OEM2KEY_W<'_, OEM2KEYR2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#FLASH:OEM2KEYR2)*/
