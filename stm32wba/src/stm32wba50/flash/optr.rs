...
impl W {
    ...
    ///Bit 15 - SRAM1 erase upon system reset
    #[inline(always)]
    pub fn sram1_rst(&mut self) -> SRAM1_RST_W<OPTRrs> {
    ...
    ///Bit 26 - Software BOOT0
    #[inline(always)]
    pub fn nswboot0(&mut self) -> NSWBOOT0_W<OPTRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#FLASH:OPTR)*/
pub struct OPTRrs;
