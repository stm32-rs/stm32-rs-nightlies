...
impl W {
    ///Bits 16:22 - End page of secure hide protection area This field contains the last page of the secure HDP area.
    #[inline(always)]
    pub fn hdp_pend(&mut self) -> HDP_PEND_W<SECWMR2rs> {
        HDP_PEND_W::new(self, 16)
    }
    ///Bit 31 - Secure Hide protection area enable
    #[inline(always)]
    pub fn hdpen(&mut self) -> HDPEN_W<SECWMR2rs> {
        HDPEN_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#FLASH:SECWMR2)*/
