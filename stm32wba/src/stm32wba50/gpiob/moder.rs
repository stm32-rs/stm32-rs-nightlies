...
///Field `MODE4` reader - Port configuration I/O pin 4
...
///Field `MODE10` reader - Port configuration I/O pin 10 Note that bits 21:20 are reserved on STM32WBA55xx devices.
...
///Field `MODE15` reader - Port configuration I/O pin 15 These bits are written by software to configure the I/O mode. Access can be protected by GPIOB SEC15.
...
///Field `MODE4` writer - Port configuration I/O pin 4
...
///Field `MODE10` writer - Port configuration I/O pin 10 Note that bits 21:20 are reserved on STM32WBA55xx devices.
...
///Field `MODE15` writer - Port configuration I/O pin 15 These bits are written by software to configure the I/O mode. Access can be protected by GPIOB SEC15.
...
impl R {
    ...
    ///Bits 30:31 - Port configuration I/O pin 15 These bits are written by software to configure the I/O mode. Access can be protected by GPIOB SEC15.
    #[inline(always)]
