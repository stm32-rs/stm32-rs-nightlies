...
///Field `CS2` reader - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
pub type CS2_R = crate::FieldReader<u32>;
///Field `CS2` writer - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
...
impl W {
    ///Bits 0:31 - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
    #[inline(always)]
    pub fn cs2(&mut self) -> CS2_W<'_, CSR2rs> {
        CS2_W::new(self, 0)
    }
}
