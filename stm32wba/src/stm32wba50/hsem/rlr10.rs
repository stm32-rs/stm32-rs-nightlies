...
You can [`read`](crate::Reg::read) this register and get [`rlr10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#HSEM:RLR10)*/
pub struct RLR10rs;
impl crate::RegisterSpec for RLR10rs {
    type Ux = u32;
}
///`read()` method returns [`rlr10::R`](R) reader structure
impl crate::Readable for RLR10rs {}
///`reset()` method sets RLR10 to value 0
impl crate::Resettable for RLR10rs {}
