...
You can [`read`](crate::Reg::read) this register and get [`rlr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#HSEM:RLR3)*/
pub struct RLR3rs;
impl crate::RegisterSpec for RLR3rs {
    type Ux = u32;
}
///`read()` method returns [`rlr3::R`](R) reader structure
impl crate::Readable for RLR3rs {}
///`reset()` method sets RLR3 to value 0
impl crate::Resettable for RLR3rs {}
