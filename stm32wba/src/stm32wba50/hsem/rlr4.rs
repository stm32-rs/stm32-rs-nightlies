...
You can [`read`](crate::Reg::read) this register and get [`rlr4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#HSEM:RLR4)*/
pub struct RLR4rs;
impl crate::RegisterSpec for RLR4rs {
    type Ux = u32;
}
///`read()` method returns [`rlr4::R`](R) reader structure
impl crate::Readable for RLR4rs {}
///`reset()` method sets RLR4 to value 0
impl crate::Resettable for RLR4rs {}
