...
///Field `TRIGSEL` reader - Trigger selection (refer to Section 52.4.3: FMPI2C pins and internal signals I2C interconnections tables). ... Note: This bit can be written only when PE = 0
pub type TRIGSEL_R = crate::FieldReader;
///Field `TRIGSEL` writer - Trigger selection (refer to Section 52.4.3: FMPI2C pins and internal signals I2C interconnections tables). ... Note: This bit can be written only when PE = 0
pub type TRIGSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TRIGPOL` reader - Trigger polarity Note: This bit can be written only when PE = 0
pub type TRIGPOL_R = crate::BitReader;
///Field `TRIGPOL` writer - Trigger polarity Note: This bit can be written only when PE = 0
pub type TRIGPOL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRIGEN` reader - Trigger enable When a trigger is detected, a START condition is sent and the transfer is launched as defined in I2C_CR2.
pub type TRIGEN_R = crate::BitReader;
///Field `TRIGEN` writer - Trigger enable When a trigger is detected, a START condition is sent and the transfer is launched as defined in I2C_CR2.
...
impl R {
    ...
    ///Bits 16:19 - Trigger selection (refer to Section 52.4.3: FMPI2C pins and internal signals I2C interconnections tables). ... Note: This bit can be written only when PE = 0
    #[inline(always)]
    pub fn trigsel(&self) -> TRIGSEL_R {
        TRIGSEL_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
    ///Bit 20 - Trigger polarity Note: This bit can be written only when PE = 0
    #[inline(always)]
    pub fn trigpol(&self) -> TRIGPOL_R {
        TRIGPOL_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - Trigger enable When a trigger is detected, a START condition is sent and the transfer is launched as defined in I2C_CR2.
    #[inline(always)]
...
impl W {
    ///Bit 6 - DMA request enable on Transfer Complete event
    #[inline(always)]
    pub fn tcdmaen(&mut self) -> TCDMAEN_W<'_, AUTOCRrs> {
        TCDMAEN_W::new(self, 6)
    }
    ///Bit 7 - DMA request enable on Transfer Complete Reload event
    #[inline(always)]
    pub fn tcrdmaen(&mut self) -> TCRDMAEN_W<'_, AUTOCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#I2C3:AUTOCR)*/
pub struct AUTOCRrs;
