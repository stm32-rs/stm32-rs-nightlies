...
/**Watchdog enable status bit Set to '1' by hardware as soon as the IWDG is started, remains to '1' until the IWDG is reset.
...
///Field `ONF` reader - Watchdog enable status bit Set to '1' by hardware as soon as the IWDG is started, remains to '1' until the IWDG is reset.
...
impl R {
    ...
    ///Bit 8 - Watchdog enable status bit Set to '1' by hardware as soon as the IWDG is started, remains to '1' until the IWDG is reset.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#IWDG:SR)*/
pub struct SRrs;
