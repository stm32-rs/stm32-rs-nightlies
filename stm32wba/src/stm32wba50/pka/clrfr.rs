...
///Field `OPERRFC` writer - Clear operation error flag
...
impl W {
    ...
    #[inline(always)]
    pub fn operrfc(&mut self) -> OPERRFC_W<'_, CLRFRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#PKA:CLRFR)*/
pub struct CLRFRrs;
