...
///Field `ERASEKEY` writer - Erase write protection key The following steps are required to unlock the write protection of the SRAMER bit in the RAMCFG_MxCR register. Write 0xCA into ERASEKEY\[7:0\] Write 0x53 into ERASEKEY\[7:0\] Note: Writing a wrong key reactivates the write protection.
...
impl W {
    ///Bits 0:7 - Erase write protection key The following steps are required to unlock the write protection of the SRAMER bit in the RAMCFG_MxCR register. Write 0xCA into ERASEKEY\[7:0\] Write 0x53 into ERASEKEY\[7:0\] Note: Writing a wrong key reactivates the write protection.
    #[inline(always)]
