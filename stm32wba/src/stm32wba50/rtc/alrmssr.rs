...
///Field `SS` writer - Subseconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm A is to be activated. Only bits 0 up MASKSS-1 are compared. This field is the mirror of SS\[14:0\] in the RTC_ALRMABINR, and so can also be read or written through RTC_ALRMABINR.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#RTC:ALRM[A]SSR)*/
