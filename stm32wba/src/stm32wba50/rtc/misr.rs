...
/**Timestamp non-secure masked flag This flag is set by hardware when a timestamp non-secure interrupt occurs.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#RTC:MISR)*/
pub struct MISRrs;
