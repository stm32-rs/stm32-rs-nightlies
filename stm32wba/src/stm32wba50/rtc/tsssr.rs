...
///Field `SS` reader - Subsecond value/synchronous binary counter values SS\[31:0\] is the value of the synchronous prescaler counter when the timestamp event occurred.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA50.html#RTC:TSSSR)*/
pub struct TSSSRrs;
