///Register `CCMR1_ALTERNATE` reader
pub type R = crate::R<CCMR1_ALTERNATErs>;
///Register `CCMR1_ALTERNATE` writer
pub type W = crate::W<CCMR1_ALTERNATErs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CCMR1_ALTERNATE")
...
impl W {
    ///Bits 0:1 - Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc1s(&mut self) -> CC1S_W<CCMR1_ALTERNATErs> {
        CC1S_W::new(self, 0)
    }
    ///Bit 2 - Output compare 1 fast enable This bit decreases the latency between a trigger event and a transition on the timer output. It must be used in one-pulse mode (OPM bit set in TIMx_CR1 register), to have the output pulse starting as soon as possible after the starting trigger.
    #[inline(always)]
    pub fn oc1fe(&mut self) -> OC1FE_W<CCMR1_ALTERNATErs> {
        OC1FE_W::new(self, 2)
    }
    ///Bit 3 - Output compare 1 preload enable
    #[inline(always)]
    pub fn oc1pe(&mut self) -> OC1PE_W<CCMR1_ALTERNATErs> {
        OC1PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC1M\[2:0\]: Output compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 is derived. tim_oc1ref is active high whereas tim_oc1 active level depends on CC1P bit. Note: In PWM mode, the tim_ocref_clr level changes only when the result of the comparison changes or when the output compare mode switches from 'frozen' mode to 'PWM' mode.
    #[inline(always)]
    pub fn oc1m(&mut self) -> OC1M_W<CCMR1_ALTERNATErs> {
        OC1M_W::new(self, 4)
    }
    ///Bit 7 - Output compare 1 clear enable
    #[inline(always)]
    pub fn oc1ce(&mut self) -> OC1CE_W<CCMR1_ALTERNATErs> {
        OC1CE_W::new(self, 7)
    }
    ///Bits 8:9 - Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc2s(&mut self) -> CC2S_W<CCMR1_ALTERNATErs> {
        CC2S_W::new(self, 8)
    }
    ///Bit 10 - Output compare 2 fast enable
    #[inline(always)]
    pub fn oc2fe(&mut self) -> OC2FE_W<CCMR1_ALTERNATErs> {
        OC2FE_W::new(self, 10)
    }
    ///Bit 11 - Output compare 2 preload enable
    #[inline(always)]
    pub fn oc2pe(&mut self) -> OC2PE_W<CCMR1_ALTERNATErs> {
        OC2PE_W::new(self, 11)
    }
    ///Bits 12:14 - OC2M\[2:0\]: Output compare 2 mode refer to OC1M description on bits 6:4
    #[inline(always)]
    pub fn oc2m(&mut self) -> OC2M_W<CCMR1_ALTERNATErs> {
        OC2M_W::new(self, 12)
    }
    ///Bit 15 - Output compare 2 clear enable
    #[inline(always)]
    pub fn oc2ce(&mut self) -> OC2CE_W<CCMR1_ALTERNATErs> {
        OC2CE_W::new(self, 15)
    }
    ///Bit 16 - OC1M\[3\]
    #[inline(always)]
    pub fn oc1m_1(&mut self) -> OC1M_1_W<CCMR1_ALTERNATErs> {
        OC1M_1_W::new(self, 16)
    }
    ///Bit 24 - OC2M\[3\]
    #[inline(always)]
    pub fn oc2m_1(&mut self) -> OC2M_1_W<CCMR1_ALTERNATErs> {
...
pub struct CCMR1_ALTERNATErs;
impl crate::RegisterSpec for CCMR1_ALTERNATErs {
    type Ux = u32;
}
///`read()` method returns [`ccmr1_alternate::R`](R) reader structure
impl crate::Readable for CCMR1_ALTERNATErs {}
///`write(|w| ..)` method takes [`ccmr1_alternate::W`](W) writer structure
impl crate::Writable for CCMR1_ALTERNATErs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CCMR1_ALTERNATE to value 0
impl crate::Resettable for CCMR1_ALTERNATErs {}
