...
impl W {
    ///Bits 0:6 - Start page of secure area This field contains the first page of the secure area.
    #[inline(always)]
    pub fn secwm_pstrt(&mut self) -> SECWM_PSTRT_W<SECWMR1rs> {
        SECWM_PSTRT_W::new(self, 0)
    }
    ///Bits 16:22 - End page of secure area This field contains the last page of the secure area.
    #[inline(always)]
    pub fn secwm_pend(&mut self) -> SECWM_PEND_W<SECWMR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA52.html#FLASH:SECWMR1)*/
