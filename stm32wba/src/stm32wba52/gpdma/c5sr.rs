///Register `C5SR` reader
pub type R = crate::R<C5SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c5sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA52.html#GPDMA:C5SR)*/
pub struct C5SRrs;
impl crate::RegisterSpec for C5SRrs {
    type Ux = u32;
}
///`read()` method returns [`c5sr::R`](R) reader structure
impl crate::Readable for C5SRrs {}
///`reset()` method sets C5SR to value 0x01
impl crate::Resettable for C5SRrs {
