...
impl W {
    ...
    #[inline(always)]
    pub fn chsemf(&mut self) -> CHSEMF_W<FCR3rs> {
    ...
    #[inline(always)]
    pub fn cradiof(&mut self) -> CRADIOF_W<FCR3rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA52.html#GTZC1_TZIC:FCR3)*/
pub struct FCR3rs;
