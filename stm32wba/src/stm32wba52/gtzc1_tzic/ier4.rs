...
impl W {
    ...
    ///Bit 7 - illegal access interrupt enable for SYSCFG
    #[inline(always)]
    pub fn syscfgie(&mut self) -> SYSCFGIE_W<IER4rs> {
    ...
    ///Bit 14 - illegal access interrupt enable for GTZC1 TZSC
    #[inline(always)]
    pub fn tzscie(&mut self) -> TZSCIE_W<IER4rs> {
        TZSCIE_W::new(self, 14)
    }
    ///Bit 15 - illegal access interrupt enable for GTZC1 TZIC
    #[inline(always)]
    pub fn tzicie(&mut self) -> TZICIE_W<IER4rs> {
    ...
    ///Bit 23 - illegal access interrupt enable for MPCBB1
    #[inline(always)]
    pub fn mpcbb1ie(&mut self) -> MPCBB1IE_W<IER4rs> {
    ...
    ///Bit 25 - illegal access interrupt enable for MPCBB2
    #[inline(always)]
    pub fn mpcbb2ie(&mut self) -> MPCBB2IE_W<IER4rs> {
        MPCBB2IE_W::new(self, 25)
    }
    ///Bit 30 - illegal access interrupt enable for 2.4GHz RXTXRAM memory
    #[inline(always)]
    pub fn sram6ie(&mut self) -> SRAM6IE_W<IER4rs> {
        SRAM6IE_W::new(self, 30)
    }
    ///Bit 31 - illegal access interrupt enable for MPCBB6
    #[inline(always)]
    pub fn mpcbb6ie(&mut self) -> MPCBB6IE_W<IER4rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA52.html#GTZC1_TZIC:IER4)*/
pub struct IER4rs;
