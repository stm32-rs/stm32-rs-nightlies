...
///Field `CS18` reader - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
pub type CS18_R = crate::FieldReader<u32>;
///Field `CS18` writer - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
