...
///Field `CS42` reader - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
pub type CS42_R = crate::FieldReader<u32>;
///Field `CS42` writer - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
...
impl W {
    ///Bits 0:31 - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
    #[inline(always)]
    pub fn cs42(&mut self) -> CS42_W<'_, CSR42rs> {
        CS42_W::new(self, 0)
    }
}
