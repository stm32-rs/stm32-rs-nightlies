...
///Field `CS5` reader - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
pub type CS5_R = crate::FieldReader<u32>;
///Field `CS5` writer - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
...
impl W {
    ///Bits 0:31 - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
    #[inline(always)]
    pub fn cs5(&mut self) -> CS5_W<'_, CSR5rs> {
        CS5_W::new(self, 0)
    }
}
