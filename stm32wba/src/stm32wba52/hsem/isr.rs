...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `ISF0` field.</div>
    #[inline(always)]
    pub fn isf(&mut self, n: u8) -> ISF_W<ISRrs> {
        #[allow(clippy::no_effect)]
        [(); 16][n as usize];
        ISF_W::new(self, n)
    }
    ///Bit 0 - Interrupt semaphore 0 status bit before enable (mask)
    #[inline(always)]
    pub fn isf0(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 0)
    }
    ///Bit 1 - Interrupt semaphore 1 status bit before enable (mask)
    #[inline(always)]
    pub fn isf1(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 1)
    }
    ///Bit 2 - Interrupt semaphore 2 status bit before enable (mask)
    #[inline(always)]
    pub fn isf2(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 2)
    }
    ///Bit 3 - Interrupt semaphore 3 status bit before enable (mask)
    #[inline(always)]
    pub fn isf3(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 3)
    }
    ///Bit 4 - Interrupt semaphore 4 status bit before enable (mask)
    #[inline(always)]
    pub fn isf4(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 4)
    }
    ///Bit 5 - Interrupt semaphore 5 status bit before enable (mask)
    #[inline(always)]
    pub fn isf5(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 5)
    }
    ///Bit 6 - Interrupt semaphore 6 status bit before enable (mask)
    #[inline(always)]
    pub fn isf6(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 6)
    }
    ///Bit 7 - Interrupt semaphore 7 status bit before enable (mask)
    #[inline(always)]
    pub fn isf7(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 7)
    }
    ///Bit 8 - Interrupt semaphore 8 status bit before enable (mask)
    #[inline(always)]
    pub fn isf8(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 8)
    }
    ///Bit 9 - Interrupt semaphore 9 status bit before enable (mask)
    #[inline(always)]
    pub fn isf9(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 9)
    }
    ///Bit 10 - Interrupt semaphore 10 status bit before enable (mask)
    #[inline(always)]
    pub fn isf10(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 10)
    }
    ///Bit 11 - Interrupt semaphore 11 status bit before enable (mask)
    #[inline(always)]
    pub fn isf11(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 11)
    }
    ///Bit 12 - Interrupt semaphore 12 status bit before enable (mask)
    #[inline(always)]
    pub fn isf12(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 12)
    }
    ///Bit 13 - Interrupt semaphore 13 status bit before enable (mask)
    #[inline(always)]
    pub fn isf13(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 13)
    }
    ///Bit 14 - Interrupt semaphore 14 status bit before enable (mask)
    #[inline(always)]
    pub fn isf14(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 14)
    }
    ///Bit 15 - Interrupt semaphore 15 status bit before enable (mask)
    #[inline(always)]
    pub fn isf15(&mut self) -> ISF_W<ISRrs> {
        ISF_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA52.html#HSEM:ISR)*/
pub struct ISRrs;
