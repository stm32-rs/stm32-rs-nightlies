...
You can [`read`](crate::Reg::read) this register and get [`rlr5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA52.html#HSEM:RLR5)*/
pub struct RLR5rs;
impl crate::RegisterSpec for RLR5rs {
    type Ux = u32;
}
///`read()` method returns [`rlr5::R`](R) reader structure
impl crate::Readable for RLR5rs {}
///`reset()` method sets RLR5 to value 0
impl crate::Resettable for RLR5rs {}
