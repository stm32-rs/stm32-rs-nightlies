...
impl W {
    ///Bit 1 - Configurable device secrets configuration
    #[inline(always)]
    pub fn ercfg1(&mut self) -> ERCFG1_W<ERCFGRrs> {
        ERCFG1_W::new(self, 1)
    }
    ///Bit 2 - Configurable device secrets configuration
    #[inline(always)]
    pub fn ercfg2(&mut self) -> ERCFG2_W<ERCFGRrs> {
        ERCFG2_W::new(self, 2)
    }
    ///Bit 3 - Configurable device secrets configuration
    #[inline(always)]
    pub fn ercfg3(&mut self) -> ERCFG3_W<ERCFGRrs> {
        ERCFG3_W::new(self, 3)
    }
    ///Bit 4 - Configurable device secrets configuration
    #[inline(always)]
    pub fn ercfg4(&mut self) -> ERCFG4_W<ERCFGRrs> {
        ERCFG4_W::new(self, 4)
    }
    ///Bit 5 - Configurable device secrets configuration
    #[inline(always)]
    pub fn ercfg5(&mut self) -> ERCFG5_W<ERCFGRrs> {
        ERCFG5_W::new(self, 5)
    }
}
