///Register `TIM_CCMR2` reader
pub type R = crate::R<TIM_CCMR2rs>;
///Register `TIM_CCMR2` writer
pub type W = crate::W<TIM_CCMR2rs>;
...
impl W {
    ///Bits 0:1 - Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc3s(&mut self) -> CC3S_W<TIM_CCMR2rs> {
        CC3S_W::new(self, 0)
    }
    ///Bits 2:3 - Input capture 3 prescaler
    #[inline(always)]
    pub fn ic3psc(&mut self) -> IC3PSC_W<TIM_CCMR2rs> {
        IC3PSC_W::new(self, 2)
    }
    ///Bits 4:7 - Input capture 3 filter
    #[inline(always)]
    pub fn ic3f(&mut self) -> IC3F_W<TIM_CCMR2rs> {
        IC3F_W::new(self, 4)
    }
    ///Bits 8:9 - Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc4s(&mut self) -> CC4S_W<TIM_CCMR2rs> {
        CC4S_W::new(self, 8)
    }
    ///Bits 10:11 - Input capture 4 prescaler
    #[inline(always)]
    pub fn ic4psc(&mut self) -> IC4PSC_W<TIM_CCMR2rs> {
        IC4PSC_W::new(self, 10)
    }
    ///Bits 12:15 - Input capture 4 filter
    #[inline(always)]
    pub fn ic4f(&mut self) -> IC4F_W<TIM_CCMR2rs> {
        IC4F_W::new(self, 12)
    }
}
/**TIM capture/compare mode register 2 \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`tim_ccmr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim_ccmr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA52.html#TIM2:TIM_CCMR2)*/
pub struct TIM_CCMR2rs;
impl crate::RegisterSpec for TIM_CCMR2rs {
    type Ux = u32;
}
///`read()` method returns [`tim_ccmr2::R`](R) reader structure
impl crate::Readable for TIM_CCMR2rs {}
///`write(|w| ..)` method takes [`tim_ccmr2::W`](W) writer structure
impl crate::Writable for TIM_CCMR2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM_CCMR2 to value 0
impl crate::Resettable for TIM_CCMR2rs {}
