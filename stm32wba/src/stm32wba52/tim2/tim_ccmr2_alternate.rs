///Register `TIM_CCMR2_ALTERNATE` reader
pub type R = crate::R<TIM_CCMR2_ALTERNATErs>;
///Register `TIM_CCMR2_ALTERNATE` writer
pub type W = crate::W<TIM_CCMR2_ALTERNATErs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM_CCMR2_ALTERNATE")
...
impl W {
    ///Bits 0:1 - Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc3s(&mut self) -> CC3S_W<TIM_CCMR2_ALTERNATErs> {
        CC3S_W::new(self, 0)
    }
    ///Bit 2 - Output compare 3 fast enable
    #[inline(always)]
    pub fn oc3fe(&mut self) -> OC3FE_W<TIM_CCMR2_ALTERNATErs> {
        OC3FE_W::new(self, 2)
    }
    ///Bit 3 - Output compare 3 preload enable
    #[inline(always)]
    pub fn oc3pe(&mut self) -> OC3PE_W<TIM_CCMR2_ALTERNATErs> {
        OC3PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC3M\[2:0\]: Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
    #[inline(always)]
    pub fn oc3m(&mut self) -> OC3M_W<TIM_CCMR2_ALTERNATErs> {
        OC3M_W::new(self, 4)
    }
    ///Bit 7 - Output compare 3 clear enable
    #[inline(always)]
    pub fn oc3ce(&mut self) -> OC3CE_W<TIM_CCMR2_ALTERNATErs> {
        OC3CE_W::new(self, 7)
    }
    ///Bits 8:9 - Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
    #[inline(always)]
    pub fn cc4s(&mut self) -> CC4S_W<TIM_CCMR2_ALTERNATErs> {
        CC4S_W::new(self, 8)
    }
    ///Bit 10 - Output compare 4 fast enable
    #[inline(always)]
    pub fn oc4fe(&mut self) -> OC4FE_W<TIM_CCMR2_ALTERNATErs> {
        OC4FE_W::new(self, 10)
    }
    ///Bit 11 - Output compare 4 preload enable
    #[inline(always)]
    pub fn oc4pe(&mut self) -> OC4PE_W<TIM_CCMR2_ALTERNATErs> {
        OC4PE_W::new(self, 11)
    }
    ///Bits 12:14 - OC4M\[2:0\]: Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
    #[inline(always)]
    pub fn oc4m(&mut self) -> OC4M_W<TIM_CCMR2_ALTERNATErs> {
        OC4M_W::new(self, 12)
    }
    ///Bit 15 - Output compare 4 clear enable
    #[inline(always)]
    pub fn oc4ce(&mut self) -> OC4CE_W<TIM_CCMR2_ALTERNATErs> {
        OC4CE_W::new(self, 15)
    }
    ///Bit 16 - OC3M\[3\]
    #[inline(always)]
    pub fn oc3m_1(&mut self) -> OC3M_1_W<TIM_CCMR2_ALTERNATErs> {
        OC3M_1_W::new(self, 16)
    }
    ///Bit 24 - OC4M\[3\]
    #[inline(always)]
    pub fn oc4m_1(&mut self) -> OC4M_1_W<TIM_CCMR2_ALTERNATErs> {
        OC4M_1_W::new(self, 24)
    }
}
/**TIM capture/compare mode register 2 \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`tim_ccmr2_alternate::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim_ccmr2_alternate::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA52.html#TIM2:TIM_CCMR2_ALTERNATE)*/
pub struct TIM_CCMR2_ALTERNATErs;
impl crate::RegisterSpec for TIM_CCMR2_ALTERNATErs {
    type Ux = u32;
}
///`read()` method returns [`tim_ccmr2_alternate::R`](R) reader structure
impl crate::Readable for TIM_CCMR2_ALTERNATErs {}
///`write(|w| ..)` method takes [`tim_ccmr2_alternate::W`](W) writer structure
impl crate::Writable for TIM_CCMR2_ALTERNATErs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM_CCMR2_ALTERNATE to value 0
impl crate::Resettable for TIM_CCMR2_ALTERNATErs {}
