...
///Field `INIT` reader - Programmable initial CRC value This register is used to write the CRC initial value.
pub type INIT_R = crate::FieldReader<u32>;
///Field `INIT` writer - Programmable initial CRC value This register is used to write the CRC initial value.
...
impl W {
    ///Bits 0:31 - Programmable initial CRC value This register is used to write the CRC initial value.
    #[inline(always)]
    pub fn init(&mut self) -> INIT_W<'_, INITrs> {
        INIT_W::new(self, 0)
    }
}
/**CRC initial value
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#CRC:INIT)*/
pub struct INITrs;
