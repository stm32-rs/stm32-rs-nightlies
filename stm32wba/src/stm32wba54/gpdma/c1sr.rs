///Register `C1SR` reader
pub type R = crate::R<C1SRrs>;
...
pub struct C1SRrs;
impl crate::RegisterSpec for C1SRrs {
    type Ux = u32;
}
///`read()` method returns [`c1sr::R`](R) reader structure
impl crate::Readable for C1SRrs {}
///`reset()` method sets C1SR to value 0x01
impl crate::Resettable for C1SRrs {
