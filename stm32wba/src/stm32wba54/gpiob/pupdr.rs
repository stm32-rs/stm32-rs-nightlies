...
///Field `PUPD4` reader - Port configuration I/O pin 4
pub type PUPD4_R = crate::FieldReader;
///Field `PUPD4` writer - Port configuration I/O pin 4
...
///Field `PUPD10` reader - Port configuration I/O pin 10 Note that bits 21:20 are reserved on STM32WBA55xx devices.
pub type PUPD10_R = crate::FieldReader;
///Field `PUPD10` writer - Port configuration I/O pin 10 Note that bits 21:20 are reserved on STM32WBA55xx devices.
...
///Field `PUPD15` reader - Port configuration I/O pin 15 These bits are written by software to configure the I/O pull-up or pull-down Access can be protected by GPIOB SEC15.
pub type PUPD15_R = crate::FieldReader;
///Field `PUPD15` writer - Port configuration I/O pin 15 These bits are written by software to configure the I/O pull-up or pull-down Access can be protected by GPIOB SEC15.
...
impl R {
    ...
    ///Bits 30:31 - Port configuration I/O pin 15 These bits are written by software to configure the I/O pull-up or pull-down Access can be protected by GPIOB SEC15.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#GPIOB:PUPDR)*/
pub struct PUPDRrs;
