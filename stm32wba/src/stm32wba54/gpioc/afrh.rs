...
/**Alternate function selection for port C I/O pin 13
...
pub type AFSEL13_R = crate::FieldReader<ALTERNATE_FUNCTION>;
impl AFSEL13_R {
...
pub type AFSEL13_W<'a, REG> = crate::FieldWriter<'a, REG, 4, ALTERNATE_FUNCTION, crate::Safe>;
...
pub use AFSEL13_R as AFSEL14_R;
...
pub use AFSEL13_W as AFSEL15_W;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#GPIOC:AFRH)*/
pub struct AFRHrs;
