...
impl RegisterBlock {
    ...
    ///0x100..0x110 - MPCBBz security configuration for super-block %s register
    #[inline(always)]
    ...
    ///0x200..0x210 - MPCBBz privileged configuration for super-block %s register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#GTZC1_MPCBB1:SECCFGR[0])
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#GTZC1_MPCBB1:PRIVCFGR[0])
