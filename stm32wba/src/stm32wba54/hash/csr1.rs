...
///Field `CS1` reader - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
pub type CS1_R = crate::FieldReader<u32>;
///Field `CS1` writer - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
...
impl W {
    ///Bits 0:31 - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
    #[inline(always)]
    pub fn cs1(&mut self) -> CS1_W<'_, CSR1rs> {
        CS1_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#HASH:CSR1)*/
pub struct CSR1rs;
