...
///Field `CS17` reader - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
pub type CS17_R = crate::FieldReader<u32>;
///Field `CS17` writer - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
...
impl W {
    ///Bits 0:31 - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
    #[inline(always)]
    pub fn cs17(&mut self) -> CS17_W<'_, CSR17rs> {
        CS17_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#HASH:CSR17)*/
pub struct CSR17rs;
