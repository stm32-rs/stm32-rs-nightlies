...
///Field `CS20` reader - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
pub type CS20_R = crate::FieldReader<u32>;
///Field `CS20` writer - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
...
impl W {
    ///Bits 0:31 - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
    #[inline(always)]
    pub fn cs20(&mut self) -> CS20_W<'_, CSR20rs> {
        CS20_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#HASH:CSR20)*/
pub struct CSR20rs;
