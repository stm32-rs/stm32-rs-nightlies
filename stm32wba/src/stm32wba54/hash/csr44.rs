...
///Field `CS44` reader - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
pub type CS44_R = crate::FieldReader<u32>;
///Field `CS44` writer - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
...
impl W {
    ///Bits 0:31 - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
    #[inline(always)]
    pub fn cs44(&mut self) -> CS44_W<'_, CSR44rs> {
        CS44_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#HASH:CSR44)*/
pub struct CSR44rs;
