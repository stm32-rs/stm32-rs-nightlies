...
///Field `CS45` reader - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
pub type CS45_R = crate::FieldReader<u32>;
///Field `CS45` writer - Context swap x Refer to Section 25.7.7: HASH context swap registers introduction.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#HASH:CSR45)*/
pub struct CSR45rs;
