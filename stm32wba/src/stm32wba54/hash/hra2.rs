...
///Field `H2` reader - Hash data x Refer to Section 25.7.4: HASH digest registers introduction.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#HASH:HRA2)*/
pub struct HRA2rs;
