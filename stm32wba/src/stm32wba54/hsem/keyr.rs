...
///Field `KEY` reader - Semaphore clear key This field can be written and read by software. Key value to match when clearing semaphores.
pub type KEY_R = crate::FieldReader<u16>;
///Field `KEY` writer - Semaphore clear key This field can be written and read by software. Key value to match when clearing semaphores.
pub type KEY_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 16:31 - Semaphore clear key This field can be written and read by software. Key value to match when clearing semaphores.
    #[inline(always)]
