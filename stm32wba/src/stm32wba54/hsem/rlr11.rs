...
You can [`read`](crate::Reg::read) this register and get [`rlr11::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#HSEM:RLR11)*/
pub struct RLR11rs;
impl crate::RegisterSpec for RLR11rs {
    type Ux = u32;
}
///`read()` method returns [`rlr11::R`](R) reader structure
impl crate::Readable for RLR11rs {}
///`reset()` method sets RLR11 to value 0
impl crate::Resettable for RLR11rs {}
