...
impl RegisterBlock {
    ...
    ///0x00 - LPTIM interrupt and status register \[alternate\]
    #[inline(always)]
    ...
    ///0x04 - LPTIM interrupt clear register \[alternate\]
    #[inline(always)]
    ...
    ///0x08 - LPTIM interrupt enable register \[alternate\]
    #[inline(always)]
    pub const fn dier_output(&self) -> &DIER_OUTPUT {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(8).cast() }
    }
}
/**ISR_output (r) register accessor: LPTIM interrupt and status register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`isr_output::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#LPTIM1:ISR_output)
...
///LPTIM interrupt and status register \[alternate\]
pub mod isr_output;
...
pub mod isr_intput;
/**ICR_output (w) register accessor: LPTIM interrupt clear register \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#LPTIM1:ICR_output)
...
///LPTIM interrupt clear register \[alternate\]
pub mod icr_output;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#LPTIM1:ICR_intput)
...
pub mod icr_intput;
/**DIER_output (rw) register accessor: LPTIM interrupt enable register \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#LPTIM1:DIER_output)
...
///LPTIM interrupt enable register \[alternate\]
pub mod dier_output;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#LPTIM1:DIER_intput)
