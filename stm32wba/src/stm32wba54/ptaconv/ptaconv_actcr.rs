...
impl W {
    ///Bits 0:7 - PTA_ACTIVE setup time in us
    #[inline(always)]
    pub fn tactive(&mut self) -> TACTIVE_W<PTACONV_ACTCRrs> {
        TACTIVE_W::new(self, 0)
    }
    ///Bit 15 - PTA_ACTIVE polarity
    #[inline(always)]
    pub fn actpol(&mut self) -> ACTPOL_W<PTACONV_ACTCRrs> {
        ACTPOL_W::new(self, 15)
    }
    ///Bits 16:19 - PTA_ACTIVE delay to cease an ongoing transmission in us
    #[inline(always)]
    pub fn tabort(&mut self) -> TABORT_W<PTACONV_ACTCRrs> {
        TABORT_W::new(self, 16)
    }
    ///Bit 20 - Disable PTA_ACTIVE deny to abort an ongoing transmission
    #[inline(always)]
    pub fn abortdis(&mut self) -> ABORTDIS_W<PTACONV_ACTCRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#PTACONV:PTACONV_ACTCR)*/
