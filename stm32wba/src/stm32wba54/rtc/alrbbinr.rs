...
///Field `SS` writer - Synchronous counter alarm value in Binary mode This value is compared with the contents of the synchronous counter to determine if Alarm Bis to be activated. Only bits 0 up MASKSS-1 are compared. SS\[14:0\] is the mirror of SS\[14:0\] in the RTC_ALRMBSSRR, and so can also be read or written through RTC_ALRMBSSR.
