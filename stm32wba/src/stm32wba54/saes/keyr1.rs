...
///Field `KEY` writer - Cryptographic key, bits \[63:32\] Refer to the SAES_KEYR0 register for description of the KEY\[255:0\] bitfield. When KEYVALID is set in SAES_SR a write to this register clears KEYVALID if EN is cleared in SAES_CR.
...
impl W {
    ///Bits 0:31 - Cryptographic key, bits \[63:32\] Refer to the SAES_KEYR0 register for description of the KEY\[255:0\] bitfield. When KEYVALID is set in SAES_SR a write to this register clears KEYVALID if EN is cleared in SAES_CR.
    #[inline(always)]
