...
///Field `RSSCMD` reader - RSS commands This field defines a command to be executed by the RSS.
pub type RSSCMD_R = crate::FieldReader<u16>;
///Field `RSSCMD` writer - RSS commands This field defines a command to be executed by the RSS.
pub type RSSCMD_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - RSS commands This field defines a command to be executed by the RSS.
    #[inline(always)]
