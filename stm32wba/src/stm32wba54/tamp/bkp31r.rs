///Register `BKP31R` reader
pub type R = crate::R<BKP31Rrs>;
///Register `BKP31R` writer
pub type W = crate::W<BKP31Rrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BKP31R").field("bkp", &self.bkp()).finish()
    }
}
impl W {
    ///Bits 0:31 - The application can write or read data to and from these registers. In the default (ERASE) configuration this register is reset on a tamper detection event. It is forced to reset value as long as there is at least one internal or external tamper flag being set. This register is also reset when the readout protection (RDP) is disabled.
    #[inline(always)]
    pub fn bkp(&mut self) -> BKP_W<BKP31Rrs> {
        BKP_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TAMP:BKP31R)*/
pub struct BKP31Rrs;
impl crate::RegisterSpec for BKP31Rrs {
    type Ux = u32;
}
///`read()` method returns [`bkp31r::R`](R) reader structure
impl crate::Readable for BKP31Rrs {}
///`write(|w| ..)` method takes [`bkp31r::W`](W) writer structure
impl crate::Writable for BKP31Rrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets BKP31R to value 0
impl crate::Resettable for BKP31Rrs {}
