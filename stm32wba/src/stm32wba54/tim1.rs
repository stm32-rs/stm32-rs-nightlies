...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn ccmr1_alternate1(&self) -> &CCMR1_ALTERNATE1 {
    ...
    #[inline(always)]
    pub const fn ccmr2_alternate1(&self) -> &CCMR2_ALTERNATE1 {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:SMCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:DIER)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:EGR)

For information about available fields see [`mod@egr`] module*/
pub type EGR = crate::Reg<egr::EGRrs>;
///TIM1 event generation register
pub mod egr;
/**CCMR1 (rw) register accessor: TIM1 capture/compare mode register 1 \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CCMR1)
...
pub mod ccmr1;
/**CCMR1_ALTERNATE1 (rw) register accessor: TIM1 capture/compare mode register 1 \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`ccmr1_alternate1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr1_alternate1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CCMR1_ALTERNATE1)

For information about available fields see [`mod@ccmr1_alternate1`] module*/
pub type CCMR1_ALTERNATE1 = crate::Reg<ccmr1_alternate1::CCMR1_ALTERNATE1rs>;
///TIM1 capture/compare mode register 1 \[alternate\]
pub mod ccmr1_alternate1;
/**CCMR2 (rw) register accessor: TIM1 capture/compare mode register 2 \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CCMR2)
...
pub mod ccmr2;
/**CCMR2_ALTERNATE1 (rw) register accessor: TIM1 capture/compare mode register 2 \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`ccmr2_alternate1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr2_alternate1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CCMR2_ALTERNATE1)

For information about available fields see [`mod@ccmr2_alternate1`] module*/
pub type CCMR2_ALTERNATE1 = crate::Reg<ccmr2_alternate1::CCMR2_ALTERNATE1rs>;
///TIM1 capture/compare mode register 2 \[alternate\]
pub mod ccmr2_alternate1;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:ARR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CCR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CCR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:BDTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CCR5)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CCR6)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:CCMR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:DTR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:AF1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:AF2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:DMAR)
