...
/**Selects tim_ti1\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
...
///Field `TI1SEL` reader - Selects tim_ti1\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
...
///Field `TI1SEL` writer - Selects tim_ti1\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
...
///Field `TI2SEL` reader - Selects tim_ti2\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
pub use TI1SEL_R as TI2SEL_R;
///Field `TI3SEL` reader - Selects tim_ti3\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
pub use TI1SEL_R as TI3SEL_R;
///Field `TI4SEL` reader - Selects tim_ti4\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
pub use TI1SEL_R as TI4SEL_R;
///Field `TI2SEL` writer - Selects tim_ti2\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
pub use TI1SEL_W as TI2SEL_W;
///Field `TI3SEL` writer - Selects tim_ti3\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
pub use TI1SEL_W as TI3SEL_W;
///Field `TI4SEL` writer - Selects tim_ti4\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
pub use TI1SEL_W as TI4SEL_W;
impl R {
    ///Bits 0:3 - Selects tim_ti1\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
    #[inline(always)]
    pub fn ti1sel(&self) -> TI1SEL_R {
        TI1SEL_R::new((self.bits & 0x0f) as u8)
    }
    ///Bits 8:11 - Selects tim_ti2\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
    #[inline(always)]
    pub fn ti2sel(&self) -> TI2SEL_R {
        TI2SEL_R::new(((self.bits >> 8) & 0x0f) as u8)
    }
    ///Bits 16:19 - Selects tim_ti3\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
    #[inline(always)]
    pub fn ti3sel(&self) -> TI3SEL_R {
        TI3SEL_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
    ///Bits 24:27 - Selects tim_ti4\[15:0\] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM1:TISEL)*/
pub struct TISELrs;
