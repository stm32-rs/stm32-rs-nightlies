///Register `TIM_DTR2` reader
pub type R = crate::R<TIM_DTR2rs>;
///Register `TIM_DTR2` writer
pub type W = crate::W<TIM_DTR2rs>;
...
impl W {
    ///Bits 0:7 - Dead-time falling edge generator setup This bit-field defines the duration of the dead-time inserted between the complementary outputs, on the falling edge. DTGF\[7:5\]=0xx = DTF=DTGF\[7:0\]x tsubdtg/sub with tsubdtg/sub=tsubDTS/sub. DTGF\[7:5\]=10x = DTF=(64+DTGF\[5:0\])xtsubdtg/sub with Tsubdtg/sub=2xtsubDTS/sub. DTGF\[7:5\]=110 = DTF=(32+DTGF\[4:0\])xtsubdtg/sub with Tsubdtg/sub=8xtsubDTS/sub. DTGF\[7:5\]=111 = DTF=(32+DTGF\[4:0\])xtsubdtg/sub with Tsubdtg/sub=16xtsubDTS/sub. Example if TsubDTS/sub=125ns (8MHz), dead-time possible values are: 0 to 15875 ns by 125 ns steps, 16 us to 31750 ns by 250 ns steps, 32 us to 63us by 1 us steps, 64 us to 126 us by 2 us steps Note: This bit-field can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
    #[inline(always)]
    pub fn dtgf(&mut self) -> DTGF_W<TIM_DTR2rs> {
        DTGF_W::new(self, 0)
    }
    ///Bit 16 - Deadtime asymmetric enable Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
    #[inline(always)]
    pub fn dtae(&mut self) -> DTAE_W<TIM_DTR2rs> {
        DTAE_W::new(self, 16)
    }
    ///Bit 17 - Deadtime preload enable Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
    #[inline(always)]
    pub fn dtpe(&mut self) -> DTPE_W<TIM_DTR2rs> {
        DTPE_W::new(self, 17)
    }
}
/**TIM timer deadtime register 2

You can [`read`](crate::Reg::read) this register and get [`tim_dtr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim_dtr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM16:TIM_DTR2)*/
pub struct TIM_DTR2rs;
impl crate::RegisterSpec for TIM_DTR2rs {
    type Ux = u32;
}
///`read()` method returns [`tim_dtr2::R`](R) reader structure
impl crate::Readable for TIM_DTR2rs {}
///`write(|w| ..)` method takes [`tim_dtr2::W`](W) writer structure
impl crate::Writable for TIM_DTR2rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM_DTR2 to value 0
impl crate::Resettable for TIM_DTR2rs {}
