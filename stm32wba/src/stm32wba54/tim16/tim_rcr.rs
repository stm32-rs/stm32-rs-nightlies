///Register `TIM_RCR` reader
pub type R = crate::R<TIM_RCRrs>;
///Register `TIM_RCR` writer
pub type W = crate::W<TIM_RCRrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIM_RCR").field("rep", &self.rep()).finish()
    }
}
impl W {
    ///Bits 0:7 - Repetition counter reload value This bitfield defines the update rate of the compare registers (i.e. periodic transfers from preload to active registers) when preload registers are enable. It also defines the update interrupt generation rate, if this interrupt is enable. When the repetition down-counter reaches zero, an update event is generated and it restarts counting from REP value. As the repetition counter is reloaded with REP value only at the repetition update event UEV, any write to the TIMx_RCR register is not taken in account until the next repetition update event. It means in PWM mode (REP+1) corresponds to the number of PWM periods in edge-aligned mode: the number of PWM periods in edge-aligned mode the number of half PWM period in center-aligned mode
    #[inline(always)]
    pub fn rep(&mut self) -> REP_W<TIM_RCRrs> {
        REP_W::new(self, 0)
    }
}
/**TIM repetition counter register

You can [`read`](crate::Reg::read) this register and get [`tim_rcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim_rcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM16:TIM_RCR)*/
pub struct TIM_RCRrs;
impl crate::RegisterSpec for TIM_RCRrs {
    type Ux = u16;
}
///`read()` method returns [`tim_rcr::R`](R) reader structure
impl crate::Readable for TIM_RCRrs {}
///`write(|w| ..)` method takes [`tim_rcr::W`](W) writer structure
impl crate::Writable for TIM_RCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM_RCR to value 0
impl crate::Resettable for TIM_RCRrs {}
