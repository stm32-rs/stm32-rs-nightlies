...
///Field `ARR` reader - Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 29.4.3: Time-base unit on page 1245 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. Non-dithering mode (DITHEN = 0) The register holds the auto-reload value. Dithering mode (DITHEN = 1) The register holds the integer part in ARR\[31:4\]. The ARR\[3:0\] bitfield contains the dithered part.
pub type ARR_R = crate::FieldReader<u32>;
///Field `ARR` writer - Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 29.4.3: Time-base unit on page 1245 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. Non-dithering mode (DITHEN = 0) The register holds the auto-reload value. Dithering mode (DITHEN = 1) The register holds the integer part in ARR\[31:4\]. The ARR\[3:0\] bitfield contains the dithered part.
pub type ARR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
    ///Bits 0:31 - Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 29.4.3: Time-base unit on page 1245 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. Non-dithering mode (DITHEN = 0) The register holds the auto-reload value. Dithering mode (DITHEN = 1) The register holds the integer part in ARR\[31:4\]. The ARR\[3:0\] bitfield contains the dithered part.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA54.html#TIM2:ARR)*/
pub struct ARRrs;
