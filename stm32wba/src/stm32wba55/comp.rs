...
impl RegisterBlock {
    ///0x00 - COMP1 control and status register
    #[inline(always)]
    pub const fn comp1_csr(&self) -> &COMP1_CSR {
        &self.comp1_csr
    }
    ///0x04 - COMP2 control and status register
    #[inline(always)]
    pub const fn comp2_csr(&self) -> &COMP2_CSR {
        &self.comp2_csr
    }
}
/**COMP1_CSR (rw) register accessor: COMP1 control and status register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#COMP:COMP1_CSR)
...
pub mod comp1_csr;
/**COMP2_CSR (rw) register accessor: COMP2 control and status register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#COMP:COMP2_CSR)
