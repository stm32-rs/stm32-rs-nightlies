...
///Field `NSBOOTADD1` reader - Non-secure boot address 1 This address is only used when TZEN = 0. The non-secure boot memory address can be programmed to any address in the valid address range (see Table 28: Boot space versus RDP protection) with a granularity of 128 bytes. These bits correspond to address \[31:7\]. The NSBOOTADD0 option bytes are selected following the BOOT0 pin or NSWBOOT0 state. Examples: NSBOOTADD1\[24:0\] = 0x0100000: Boot from Flash memory (0x0800 0000) NSBOOTADD1\[24:0\] = 0x017F100: Boot from system memory bootloader (0x0BF8 8000) NSBOOTADD1\[24:0\] = 0x0400200: Boot from SRAM2 (0x2001 0000)
pub type NSBOOTADD1_R = crate::FieldReader<u32>;
///Field `NSBOOTADD1` writer - Non-secure boot address 1 This address is only used when TZEN = 0. The non-secure boot memory address can be programmed to any address in the valid address range (see Table 28: Boot space versus RDP protection) with a granularity of 128 bytes. These bits correspond to address \[31:7\]. The NSBOOTADD0 option bytes are selected following the BOOT0 pin or NSWBOOT0 state. Examples: NSBOOTADD1\[24:0\] = 0x0100000: Boot from Flash memory (0x0800 0000) NSBOOTADD1\[24:0\] = 0x017F100: Boot from system memory bootloader (0x0BF8 8000) NSBOOTADD1\[24:0\] = 0x0400200: Boot from SRAM2 (0x2001 0000)
pub type NSBOOTADD1_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
    ///Bits 7:31 - Non-secure boot address 1 This address is only used when TZEN = 0. The non-secure boot memory address can be programmed to any address in the valid address range (see Table 28: Boot space versus RDP protection) with a granularity of 128 bytes. These bits correspond to address \[31:7\]. The NSBOOTADD0 option bytes are selected following the BOOT0 pin or NSWBOOT0 state. Examples: NSBOOTADD1\[24:0\] = 0x0100000: Boot from Flash memory (0x0800 0000) NSBOOTADD1\[24:0\] = 0x017F100: Boot from system memory bootloader (0x0BF8 8000) NSBOOTADD1\[24:0\] = 0x0400200: Boot from SRAM2 (0x2001 0000)
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#FLASH:NSBOOTADD1R)*/
