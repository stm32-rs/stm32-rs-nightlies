...
///Field `OEM1KEY` writer - OEM1 key least significant bytes
...
impl W {
    ///Bits 0:31 - OEM1 key least significant bytes
    #[inline(always)]
    pub fn oem1key(&mut self) -> OEM1KEY_W<'_, OEM1KEYR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#FLASH:OEM1KEYR1)*/
