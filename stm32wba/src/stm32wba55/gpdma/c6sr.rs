...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#GPDMA:C6SR)*/
pub struct C6SRrs;
impl crate::RegisterSpec for C6SRrs {
    type Ux = u32;
}
///`read()` method returns [`c6sr::R`](R) reader structure
impl crate::Readable for C6SRrs {}
///`reset()` method sets C6SR to value 0x01
impl crate::Resettable for C6SRrs {
