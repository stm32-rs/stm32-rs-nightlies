///Register `C7SR` reader
pub type R = crate::R<C7SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`c7sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#GPDMA:C7SR)*/
pub struct C7SRrs;
impl crate::RegisterSpec for C7SRrs {
    type Ux = u32;
}
///`read()` method returns [`c7sr::R`](R) reader structure
impl crate::Readable for C7SRrs {}
///`reset()` method sets C7SR to value 0x01
impl crate::Resettable for C7SRrs {
