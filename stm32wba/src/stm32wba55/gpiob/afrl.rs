...
///Field `AFSEL4` reader - Alternate function selection for port I/O pin 4
...
///Field `AFSEL7` reader - Alternate function selection for port I/O pin 7 These bits are written by software to configure alternate function I/Os. Access can be protected by GPIOB SEC7.
...
///Field `AFSEL4` writer - Alternate function selection for port I/O pin 4
...
///Field `AFSEL7` writer - Alternate function selection for port I/O pin 7 These bits are written by software to configure alternate function I/Os. Access can be protected by GPIOB SEC7.
...
impl R {
    ...
    ///Bits 16:19 - Alternate function selection for port I/O pin 4
    #[inline(always)]
    ...
    ///Bits 28:31 - Alternate function selection for port I/O pin 7 These bits are written by software to configure alternate function I/Os. Access can be protected by GPIOB SEC7.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#GPIOB:AFRL)*/
pub struct AFRLrs;
