...
///Field `OSPEED4` reader - Port configuration I/O pin 4
pub type OSPEED4_R = crate::FieldReader;
///Field `OSPEED4` writer - Port configuration I/O pin 4
...
///Field `OSPEED10` reader - Port configuration I/O pin 10 Note that bits 21:20 are reserved on STM32WBA55xx devices.
pub type OSPEED10_R = crate::FieldReader;
///Field `OSPEED10` writer - Port configuration I/O pin 10 Note that bits 21:20 are reserved on STM32WBA55xx devices.
...
///Field `OSPEED15` reader - Port configuration I/O pin 15 These bits are written by software to configure the I/O output speed. Access can be protected by GPIOB SEC15. Note: Refer to the device datasheet for the frequency specifications and the power supply and load conditions for each speed.
pub type OSPEED15_R = crate::FieldReader;
///Field `OSPEED15` writer - Port configuration I/O pin 15 These bits are written by software to configure the I/O output speed. Access can be protected by GPIOB SEC15. Note: Refer to the device datasheet for the frequency specifications and the power supply and load conditions for each speed.
...
impl R {
    ...
    ///Bits 8:9 - Port configuration I/O pin 4
    #[inline(always)]
    ...
    ///Bits 20:21 - Port configuration I/O pin 10 Note that bits 21:20 are reserved on STM32WBA55xx devices.
    #[inline(always)]
    ...
    ///Bits 30:31 - Port configuration I/O pin 15 These bits are written by software to configure the I/O output speed. Access can be protected by GPIOB SEC15. Note: Refer to the device datasheet for the frequency specifications and the power supply and load conditions for each speed.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#GPIOB:OSPEEDR)*/
...
///`reset()` method sets OSPEEDR to value 0x80
