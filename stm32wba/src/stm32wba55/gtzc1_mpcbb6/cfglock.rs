...
///Field `SPLCK0` reader - Security/privilege configuration lock super-block; This bit is set by software and can be cleared only by system reset.; note that bit \[3:2\] are reserved on sales type STM32WBA5xEx for MPCBB1.
pub type SPLCK0_R = crate::BitReader;
///Field `SPLCK0` writer - Security/privilege configuration lock super-block; This bit is set by software and can be cleared only by system reset.; note that bit \[3:2\] are reserved on sales type STM32WBA5xEx for MPCBB1.
...
impl W {
    ///Bit 0 - Security/privilege configuration lock super-block; This bit is set by software and can be cleared only by system reset.; note that bit \[3:2\] are reserved on sales type STM32WBA5xEx for MPCBB1.
    #[inline(always)]
    pub fn splck0(&mut self) -> SPLCK0_W<CFGLOCKrs> {
        SPLCK0_W::new(self, 0)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#GTZC1_MPCBB6:CFGLOCK)*/
