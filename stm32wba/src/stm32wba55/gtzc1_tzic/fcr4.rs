...
impl W {
    ...
    #[inline(always)]
    pub fn cmpcbb1f(&mut self) -> CMPCBB1F_W<FCR4rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#GTZC1_TZIC:FCR4)*/
pub struct FCR4rs;
