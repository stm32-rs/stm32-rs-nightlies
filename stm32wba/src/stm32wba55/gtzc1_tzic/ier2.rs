...
impl W {
    ...
    ///Bit 16 - illegal access interrupt enable for SPI3
    #[inline(always)]
    pub fn spi3ie(&mut self) -> SPI3IE_W<IER2rs> {
    ...
    ///Bit 23 - illegal access interrupt enable for COMP Note that bit 23 is reserved on sales type STM32WBA52.
    #[inline(always)]
    pub fn compie(&mut self) -> COMPIE_W<IER2rs> {
        COMPIE_W::new(self, 23)
    }
    ///Bit 24 - illegal access interrupt enable for ADC4
    #[inline(always)]
    pub fn adc4ie(&mut self) -> ADC4IE_W<IER2rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#GTZC1_TZIC:IER2)*/
pub struct IER2rs;
