...
You can [`read`](crate::Reg::read) this register and get [`rlr9::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#HSEM:RLR9)*/
pub struct RLR9rs;
impl crate::RegisterSpec for RLR9rs {
    type Ux = u32;
}
///`read()` method returns [`rlr9::R`](R) reader structure
impl crate::Readable for RLR9rs {}
///`reset()` method sets RLR9 to value 0
impl crate::Resettable for RLR9rs {}
