...
///Field `RXDATA` reader - 8-bit receive data Data byte received from the Isup2/supC bus
pub type RXDATA_R = crate::FieldReader;
impl R {
    ///Bits 0:7 - 8-bit receive data Data byte received from the Isup2/supC bus
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#I2C:RXDR)*/
pub struct RXDRrs;
