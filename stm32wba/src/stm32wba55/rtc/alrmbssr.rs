...
///Field `SS` writer - Subseconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm B is to be activated. Only bits 0 up to MASKSS-1 are compared. This field is the mirror of SS\[14:0\] in the RTC_ALRMBBINR, and so can also be read or written through RTC_ALRMBBINR.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#RTC:ALRMBSSR)*/
