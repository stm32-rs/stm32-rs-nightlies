...
///Field `CTSF` writer - Clear timestamp flag Writing 1 in this bit clears the TSF bit in the RTC_SR register.
...
impl W {
    ...
    ///Bit 3 - Clear timestamp flag Writing 1 in this bit clears the TSF bit in the RTC_SR register.
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#RTC:SCR)*/
pub struct SCRrs;
