...
///Field `CCNE(1-4)` reader - Capture/Compare %s complementary output enable
...
///Field `CCNE(1-4)` writer - Capture/Compare %s complementary output enable
...
impl R {
    ...
    ///Capture/Compare (1-4) complementary output enable
    ///
    ...
    pub fn ccne_iter(&self) -> impl Iterator<Item = CCNE_R> + '_ {
        (0..4).map(move |n| CCNE_R::new(((self.bits >> (n * 4 + 2)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn cc4ne(&self) -> CCNE_R {
        CCNE_R::new(((self.bits >> 14) & 1) != 0)
    }
...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `CC1E` field.</div>
    #[inline(always)]
    pub fn cce(&mut self, n: u8) -> CCE_W<'_, CCERrs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
        CCE_W::new(self, n * 4)
    }
    ///Bit 0 - Capture/Compare 1 output enable
    #[inline(always)]
    pub fn cc1e(&mut self) -> CCE_W<'_, CCERrs> {
        CCE_W::new(self, 0)
    }
    ///Bit 4 - Capture/Compare 2 output enable
    #[inline(always)]
    pub fn cc2e(&mut self) -> CCE_W<'_, CCERrs> {
        CCE_W::new(self, 4)
    }
    ///Bit 8 - Capture/Compare 3 output enable
    #[inline(always)]
    pub fn cc3e(&mut self) -> CCE_W<'_, CCERrs> {
        CCE_W::new(self, 8)
    }
    ///Bit 12 - Capture/Compare 4 output enable
    #[inline(always)]
    pub fn cc4e(&mut self) -> CCE_W<'_, CCERrs> {
        CCE_W::new(self, 12)
    }
    ///Bit 16 - Capture/Compare 5 output enable
    #[inline(always)]
    pub fn cc5e(&mut self) -> CCE_W<'_, CCERrs> {
        CCE_W::new(self, 16)
    }
    ///Bit 20 - Capture/Compare 6 output enable
    #[inline(always)]
    pub fn cc6e(&mut self) -> CCE_W<'_, CCERrs> {
        CCE_W::new(self, 20)
    }
    ///Capture/Compare (1-6) output Polarity
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `CC1P` field.</div>
    #[inline(always)]
    pub fn ccp(&mut self, n: u8) -> CCP_W<'_, CCERrs> {
        #[allow(clippy::no_effect)]
        [(); 6][n as usize];
    ...
    ///Bit 1 - Capture/Compare 1 output Polarity
    #[inline(always)]
    pub fn cc1p(&mut self) -> CCP_W<'_, CCERrs> {
        CCP_W::new(self, 1)
    }
    ///Bit 5 - Capture/Compare 2 output Polarity
    #[inline(always)]
    pub fn cc2p(&mut self) -> CCP_W<'_, CCERrs> {
        CCP_W::new(self, 5)
    }
    ///Bit 9 - Capture/Compare 3 output Polarity
    #[inline(always)]
    pub fn cc3p(&mut self) -> CCP_W<'_, CCERrs> {
        CCP_W::new(self, 9)
    }
    ///Bit 13 - Capture/Compare 4 output Polarity
    #[inline(always)]
    pub fn cc4p(&mut self) -> CCP_W<'_, CCERrs> {
        CCP_W::new(self, 13)
    }
    ///Bit 17 - Capture/Compare 5 output Polarity
    #[inline(always)]
    pub fn cc5p(&mut self) -> CCP_W<'_, CCERrs> {
        CCP_W::new(self, 17)
    }
    ///Bit 21 - Capture/Compare 6 output Polarity
    #[inline(always)]
    pub fn cc6p(&mut self) -> CCP_W<'_, CCERrs> {
        CCP_W::new(self, 21)
    }
    ///Capture/Compare (1-4) complementary output enable
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `CC1NE` field.</div>
    #[inline(always)]
    pub fn ccne(&mut self, n: u8) -> CCNE_W<'_, CCERrs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    ///Bit 2 - Capture/Compare 1 complementary output enable
    #[inline(always)]
    pub fn cc1ne(&mut self) -> CCNE_W<'_, CCERrs> {
        CCNE_W::new(self, 2)
    }
    ///Bit 6 - Capture/Compare 2 complementary output enable
    #[inline(always)]
    pub fn cc2ne(&mut self) -> CCNE_W<'_, CCERrs> {
        CCNE_W::new(self, 6)
    }
    ///Bit 10 - Capture/Compare 3 complementary output enable
    #[inline(always)]
    pub fn cc3ne(&mut self) -> CCNE_W<'_, CCERrs> {
        CCNE_W::new(self, 10)
    }
    ///Bit 14 - Capture/Compare 4 complementary output enable
    #[inline(always)]
    pub fn cc4ne(&mut self) -> CCNE_W<'_, CCERrs> {
        CCNE_W::new(self, 14)
    }
    ///Capture/Compare (1-4) output Polarity
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `CC1NP` field.</div>
    #[inline(always)]
    pub fn ccnp(&mut self, n: u8) -> CCNP_W<'_, CCERrs> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    ///Bit 3 - Capture/Compare 1 output Polarity
    #[inline(always)]
    pub fn cc1np(&mut self) -> CCNP_W<'_, CCERrs> {
        CCNP_W::new(self, 3)
    }
    ///Bit 7 - Capture/Compare 2 output Polarity
    #[inline(always)]
    pub fn cc2np(&mut self) -> CCNP_W<'_, CCERrs> {
        CCNP_W::new(self, 7)
    }
    ///Bit 11 - Capture/Compare 3 output Polarity
    #[inline(always)]
    pub fn cc3np(&mut self) -> CCNP_W<'_, CCERrs> {
        CCNP_W::new(self, 11)
    }
    ///Bit 15 - Capture/Compare 4 output Polarity
    #[inline(always)]
    pub fn cc4np(&mut self) -> CCNP_W<'_, CCERrs> {
        CCNP_W::new(self, 15)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#TIM1:CCER)*/
pub struct CCERrs;
