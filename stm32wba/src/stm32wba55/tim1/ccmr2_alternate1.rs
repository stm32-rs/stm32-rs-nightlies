///Register `CCMR2_ALTERNATE1` reader
pub type R = crate::R<CCMR2_ALTERNATE1rs>;
///Register `CCMR2_ALTERNATE1` writer
pub type W = crate::W<CCMR2_ALTERNATE1rs>;
...
///Field `OC4M` reader - OC4M\[2:0\]: Output compare 4 mode Refer to OC3M\[3:0\] bit description
pub type OC4M_R = crate::FieldReader;
///Field `OC4M` writer - OC4M\[2:0\]: Output compare 4 mode Refer to OC3M\[3:0\] bit description
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CCMR2_ALTERNATE1")
...
impl W {
    ///Bits 0:1 - Capture/compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = '0' in TIMx_CCER).
    #[inline(always)]
    pub fn cc3s(&mut self) -> CC3S_W<CCMR2_ALTERNATE1rs> {
        CC3S_W::new(self, 0)
    }
    ///Bit 2 - Output compare 3 fast enable
    #[inline(always)]
    pub fn oc3fe(&mut self) -> OC3FE_W<CCMR2_ALTERNATE1rs> {
        OC3FE_W::new(self, 2)
    }
    ///Bit 3 - Output compare 3 preload enable
    #[inline(always)]
    pub fn oc3pe(&mut self) -> OC3PE_W<CCMR2_ALTERNATE1rs> {
        OC3PE_W::new(self, 3)
    }
    ///Bits 4:6 - OC3M\[2:0\]: Output compare 3 mode These bits define the behavior of the output reference signal tim_oc3ref from which tim_oc3 and tim_oc3n are derived. tim_oc3ref is active high whereas tim_oc3 and tim_oc3n active level depends on CC3P and CC3NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S='00' (the channel is configured in output). Note: In PWM mode, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from 'frozen' mode to 'PWM' mode. On channels having a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIMx_CR2 register then the OC3M active bits take the new value from the preloaded bits only when a COM event is generated.
    #[inline(always)]
    pub fn oc3m(&mut self) -> OC3M_W<CCMR2_ALTERNATE1rs> {
        OC3M_W::new(self, 4)
    }
    ///Bit 7 - Output compare 3 clear enable
    #[inline(always)]
    pub fn oc3ce(&mut self) -> OC3CE_W<CCMR2_ALTERNATE1rs> {
        OC3CE_W::new(self, 7)
    }
    ///Bits 8:9 - Capture/compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = '0' in TIMx_CCER).
    #[inline(always)]
    pub fn cc4s(&mut self) -> CC4S_W<CCMR2_ALTERNATE1rs> {
        CC4S_W::new(self, 8)
    }
    ///Bit 10 - Output compare 4 fast enable
    #[inline(always)]
    pub fn oc4fe(&mut self) -> OC4FE_W<CCMR2_ALTERNATE1rs> {
        OC4FE_W::new(self, 10)
    }
    ///Bit 11 - Output compare 4 preload enable
    #[inline(always)]
    pub fn oc4pe(&mut self) -> OC4PE_W<CCMR2_ALTERNATE1rs> {
        OC4PE_W::new(self, 11)
    }
    ///Bits 12:14 - OC4M\[2:0\]: Output compare 4 mode Refer to OC3M\[3:0\] bit description
    #[inline(always)]
    pub fn oc4m(&mut self) -> OC4M_W<CCMR2_ALTERNATE1rs> {
        OC4M_W::new(self, 12)
    }
    ///Bit 15 - Output compare 4 clear enable
    #[inline(always)]
    pub fn oc4ce(&mut self) -> OC4CE_W<CCMR2_ALTERNATE1rs> {
        OC4CE_W::new(self, 15)
    }
    ///Bit 16 - OC3M\[3\]
    #[inline(always)]
    pub fn oc3m_1(&mut self) -> OC3M_1_W<CCMR2_ALTERNATE1rs> {
        OC3M_1_W::new(self, 16)
    }
    ///Bit 24 - OC4M\[3\]
    #[inline(always)]
    pub fn oc4m_1(&mut self) -> OC4M_1_W<CCMR2_ALTERNATE1rs> {
        OC4M_1_W::new(self, 24)
    }
}
/**TIM1 capture/compare mode register 2 \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`ccmr2_alternate1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr2_alternate1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#TIM1:CCMR2_ALTERNATE1)*/
pub struct CCMR2_ALTERNATE1rs;
impl crate::RegisterSpec for CCMR2_ALTERNATE1rs {
    type Ux = u32;
}
///`read()` method returns [`ccmr2_alternate1::R`](R) reader structure
impl crate::Readable for CCMR2_ALTERNATE1rs {}
///`write(|w| ..)` method takes [`ccmr2_alternate1::W`](W) writer structure
impl crate::Writable for CCMR2_ALTERNATE1rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CCMR2_ALTERNATE1 to value 0
impl crate::Resettable for CCMR2_ALTERNATE1rs {}
