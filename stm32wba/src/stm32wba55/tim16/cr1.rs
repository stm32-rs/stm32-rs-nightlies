...
/**Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tsubDTS/sub)used by the dead-time generators and the digital filters (tim_tix),
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#TIM16:CR1)*/
pub struct CR1rs;
