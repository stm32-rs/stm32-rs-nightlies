...
impl W {
    ...
    ///Bit 4 - Capture/Compare 2 output enable. Refer to CC1E description
    #[inline(always)]
    pub fn cc2e(&mut self) -> CC2E_W<TIM_CCERrs> {
        CC2E_W::new(self, 4)
    }
    ///Bit 5 - Capture/Compare 2 output Polarity. refer to CC1P description
    #[inline(always)]
    pub fn cc2p(&mut self) -> CC2P_W<TIM_CCERrs> {
        CC2P_W::new(self, 5)
    }
    ///Bit 7 - Capture/Compare 2 output Polarity. Refer to CC1NP description
    #[inline(always)]
    pub fn cc2np(&mut self) -> CC2NP_W<TIM_CCERrs> {
        CC2NP_W::new(self, 7)
    }
    ///Bit 8 - Capture/Compare 3 output enable. Refer to CC1E description
    #[inline(always)]
    pub fn cc3e(&mut self) -> CC3E_W<TIM_CCERrs> {
        CC3E_W::new(self, 8)
    }
    ///Bit 9 - Capture/Compare 3 output Polarity. Refer to CC1P description
    #[inline(always)]
    pub fn cc3p(&mut self) -> CC3P_W<TIM_CCERrs> {
        CC3P_W::new(self, 9)
    }
    ///Bit 11 - Capture/Compare 3 output Polarity. Refer to CC1NP description
    #[inline(always)]
    pub fn cc3np(&mut self) -> CC3NP_W<TIM_CCERrs> {
        CC3NP_W::new(self, 11)
    }
    ///Bit 12 - Capture/Compare 4 output enable. refer to CC1E description
    #[inline(always)]
    pub fn cc4e(&mut self) -> CC4E_W<TIM_CCERrs> {
        CC4E_W::new(self, 12)
    }
    ///Bit 13 - Capture/Compare 4 output Polarity. Refer to CC1P description
    #[inline(always)]
    pub fn cc4p(&mut self) -> CC4P_W<TIM_CCERrs> {
        CC4P_W::new(self, 13)
    }
    ///Bit 15 - Capture/Compare 4 output Polarity. Refer to CC1NP description
    #[inline(always)]
    pub fn cc4np(&mut self) -> CC4NP_W<TIM_CCERrs> {
        CC4NP_W::new(self, 15)
    }
}
