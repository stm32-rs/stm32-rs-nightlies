///Register `TIM_ECR` reader
pub type R = crate::R<TIM_ECRrs>;
///Register `TIM_ECR` writer
pub type W = crate::W<TIM_ECRrs>;
...
///Field `PW` reader - Pulse width This bitfield defines the pulse duration, as following: tsubPW/sub = PW\[7:0\] x tsubPWG/sub
pub type PW_R = crate::FieldReader;
///Field `PW` writer - Pulse width This bitfield defines the pulse duration, as following: tsubPW/sub = PW\[7:0\] x tsubPWG/sub
pub type PW_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PWPRSC` reader - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tsubPWG/sub = (2sup(PWPRSC\[2:0\])/sup) x tsubtim_ker_ck/sub
pub type PWPRSC_R = crate::FieldReader;
///Field `PWPRSC` writer - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tsubPWG/sub = (2sup(PWPRSC\[2:0\])/sup) x tsubtim_ker_ck/sub
...
impl R {
    ...
    ///Bits 16:23 - Pulse width This bitfield defines the pulse duration, as following: tsubPW/sub = PW\[7:0\] x tsubPWG/sub
    #[inline(always)]
    pub fn pw(&self) -> PW_R {
        PW_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:26 - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tsubPWG/sub = (2sup(PWPRSC\[2:0\])/sup) x tsubtim_ker_ck/sub
    #[inline(always)]
...
impl W {
    ///Bit 0 - Index enable This bit indicates if the Index event resets the counter.
    #[inline(always)]
    pub fn ie(&mut self) -> IE_W<TIM_ECRrs> {
        IE_W::new(self, 0)
    }
    ///Bits 1:2 - Index direction This bit indicates in which direction the Index event resets the counter. Note: The IDR\[1:0\] bitfield must be written when IE bit is reset (index disabled).
    #[inline(always)]
    pub fn idir(&mut self) -> IDIR_W<TIM_ECRrs> {
        IDIR_W::new(self, 1)
    }
    ///Bits 3:4 - Index blanking This bit indicates if the Index event is conditioned by the tim_ti3 input
    #[inline(always)]
    pub fn iblk(&mut self) -> IBLK_W<TIM_ECRrs> {
        IBLK_W::new(self, 3)
    }
    ///Bit 5 - First index This bit indicates if the first index only is taken into account
    #[inline(always)]
    pub fn fidx(&mut self) -> FIDX_W<TIM_ECRrs> {
        FIDX_W::new(self, 5)
    }
    ///Bits 6:7 - Index positioning In quadrature encoder mode (SMS\[3:0\] = 0001, 0010, 0011, 1110, 1111), this bit indicates in which AB input configuration the Index event resets the counter. In directional clock mode or clock plus direction mode (SMS\[3:0\] = 1010, 1011, 1100, 1101), these bits indicates on which level the Index event resets the counter. In bidirectional clock mode, this applies for both clock inputs. x0: Index resets the counter when clock is 0 x1: Index resets the counter when clock is 1 Note: IPOS\[1\] bit is not significant
    #[inline(always)]
    pub fn ipos(&mut self) -> IPOS_W<TIM_ECRrs> {
        IPOS_W::new(self, 6)
    }
    ///Bits 16:23 - Pulse width This bitfield defines the pulse duration, as following: tsubPW/sub = PW\[7:0\] x tsubPWG/sub
    #[inline(always)]
    pub fn pw(&mut self) -> PW_W<TIM_ECRrs> {
        PW_W::new(self, 16)
    }
    ///Bits 24:26 - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tsubPWG/sub = (2sup(PWPRSC\[2:0\])/sup) x tsubtim_ker_ck/sub
    #[inline(always)]
    pub fn pwprsc(&mut self) -> PWPRSC_W<TIM_ECRrs> {
        PWPRSC_W::new(self, 24)
    }
}
/**TIM timer encoder control register

You can [`read`](crate::Reg::read) this register and get [`tim_ecr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim_ecr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#TIM2:TIM_ECR)*/
pub struct TIM_ECRrs;
impl crate::RegisterSpec for TIM_ECRrs {
    type Ux = u32;
}
///`read()` method returns [`tim_ecr::R`](R) reader structure
impl crate::Readable for TIM_ECRrs {}
///`write(|w| ..)` method takes [`tim_ecr::W`](W) writer structure
impl crate::Writable for TIM_ECRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM_ECR to value 0
impl crate::Resettable for TIM_ECRrs {}
