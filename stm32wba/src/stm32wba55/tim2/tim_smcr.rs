///Register `TIM_SMCR` reader
pub type R = crate::R<TIM_SMCRrs>;
///Register `TIM_SMCR` writer
pub type W = crate::W<TIM_SMCRrs>;
...
impl W {
    ///Bits 0:2 - SMS\[0\]: Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS=00100). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on tim_ti1f, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo signal must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer.
    #[inline(always)]
    pub fn sms(&mut self) -> SMS_W<TIM_SMCRrs> {
        SMS_W::new(self, 0)
    }
    ///Bit 3 - OCREF clear selection This bit is used to select the OCREF clear source Note: If the OCREF clear selection feature is not supported, this bit is reserved and forced by hardware to '0'. Section 29.3: TIM2/TIM3 implementation.
    #[inline(always)]
    pub fn occs(&mut self) -> OCCS_W<TIM_SMCRrs> {
        OCCS_W::new(self, 3)
    }
    ///Bits 4:6 - TS\[0\]: Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See Section 29.4.2: TIM2/TIM3 pins and internal signals for product specific implementation details. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
    #[inline(always)]
    pub fn ts(&mut self) -> TS_W<TIM_SMCRrs> {
        TS_W::new(self, 4)
    }
    ///Bit 7 - Master/Slave mode
    #[inline(always)]
    pub fn msm(&mut self) -> MSM_W<TIM_SMCRrs> {
        MSM_W::new(self, 7)
    }
    ///Bits 8:11 - External trigger filter This bit-field then defines the frequency used to sample tim_etrp signal and the length of the digital filter applied to tim_etrp. The digital filter is made of an event counter in which N consecutive events are needed to validate a transition on the output:
    #[inline(always)]
    pub fn etf(&mut self) -> ETF_W<TIM_SMCRrs> {
        ETF_W::new(self, 8)
    }
    ///Bits 12:13 - External trigger prescaler External trigger signal tim_etrp frequency must be at most 1/4 of tim_ker_ck frequency. A prescaler can be enabled to reduce tim_etrp frequency. It is useful when inputting fast external clocks on tim_etr_in.
    #[inline(always)]
    pub fn etps(&mut self) -> ETPS_W<TIM_SMCRrs> {
        ETPS_W::new(self, 12)
    }
    ///Bit 14 - External clock enable This bit enables External clock mode 2. Setting the ECE bit has the same effect as selecting external clock mode 1 with tim_trgi connected to tim_etrf (SMS=111 and TS=00111). It is possible to simultaneously use external clock mode 2 with the following slave modes: reset mode, gated mode and trigger mode. Nevertheless, tim_trgi must not be connected to tim_etrf in this case (TS bits must not be 00111). Note: If external clock mode 1 and external clock mode 2 are enabled at the same time, the external clock input is tim_etrf.
    #[inline(always)]
    pub fn ece(&mut self) -> ECE_W<TIM_SMCRrs> {
        ECE_W::new(self, 14)
    }
    ///Bit 15 - External trigger polarity This bit selects whether tim_etr_in or tim_etr_in is used for trigger operations
    #[inline(always)]
    pub fn etp(&mut self) -> ETP_W<TIM_SMCRrs> {
        ETP_W::new(self, 15)
    }
    ///Bit 16 - SMS\[3\]
    #[inline(always)]
    pub fn sms_1(&mut self) -> SMS_1_W<TIM_SMCRrs> {
        SMS_1_W::new(self, 16)
    }
    ///Bits 20:21 - TS\[4:3\]
    #[inline(always)]
    pub fn ts_1(&mut self) -> TS_1_W<TIM_SMCRrs> {
        TS_1_W::new(self, 20)
    }
    ///Bit 24 - SMS preload enable This bit selects whether the SMS\[3:0\] bitfield is preloaded
    #[inline(always)]
    pub fn smspe(&mut self) -> SMSPE_W<TIM_SMCRrs> {
        SMSPE_W::new(self, 24)
    }
    ///Bit 25 - SMS preload source This bit selects whether the events that triggers the SMS\[3:0\] bitfield transfer from preload to active
    #[inline(always)]
    pub fn smsps(&mut self) -> SMSPS_W<TIM_SMCRrs> {
        SMSPS_W::new(self, 25)
    }
}
/**TIM slave mode control register

You can [`read`](crate::Reg::read) this register and get [`tim_smcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tim_smcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#TIM2:TIM_SMCR)*/
pub struct TIM_SMCRrs;
impl crate::RegisterSpec for TIM_SMCRrs {
    type Ux = u32;
}
///`read()` method returns [`tim_smcr::R`](R) reader structure
impl crate::Readable for TIM_SMCRrs {}
///`write(|w| ..)` method takes [`tim_smcr::W`](W) writer structure
impl crate::Writable for TIM_SMCRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TIM_SMCR to value 0
impl crate::Resettable for TIM_SMCRrs {}
