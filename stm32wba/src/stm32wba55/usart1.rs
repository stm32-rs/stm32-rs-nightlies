...
impl RegisterBlock {
    ...
    ///0x30 - USART Autonomous mode control register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:CR1)

For information about available fields see [`mod@cr1`] module*/
pub type CR1 = crate::Reg<cr1::CR1rs>;
///USART control register 1 \[alternate\]
pub mod cr1;
/**CR1_ALTERNATE1 (rw) register accessor: USART control register 1 \[alternate\]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:CR1_ALTERNATE1)

For information about available fields see [`mod@cr1_alternate1`] module*/
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:CR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:BRR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:GTPR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:RTOR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:RQR)

For information about available fields see [`mod@rqr`] module*/
pub type RQR = crate::Reg<rqr::RQRrs>;
///USART request register
pub mod rqr;
/**ISR (r) register accessor: USART interrupt and status register \[alternate\]
...
pub mod isr;
/**ISR_ALTERNATE1 (r) register accessor: USART interrupt and status register \[alternate\]

You can [`read`](crate::Reg::read) this register and get [`isr_alternate1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:ISR_ALTERNATE1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:ICR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:RDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:TDR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:PRESC)

For information about available fields see [`mod@presc`] module*/
pub type PRESC = crate::Reg<presc::PRESCrs>;
///USART prescaler register
pub mod presc;
/**AUTOCR (rw) register accessor: USART Autonomous mode control register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WBA55.html#USART1:AUTOCR)
