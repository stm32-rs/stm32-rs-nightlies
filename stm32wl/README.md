...
```rust
use stm32wl::stm32wl33;

let mut peripherals = stm32wl33::Peripherals::take().unwrap();
...
|:------:|:-------:|:-----:|
| stm32wl33 | STM32WL33 | [RM0511](https://www.st.com/resource/en/reference_manual/rm0511-stm32wl30xx31xx33xx-armbased-wireless-mcus-with-subghz-radio-solution-stmicroelectronics.pdf), [st.com](https://www.st.com/en/microcontrollers-microprocessors/stm32wl3x.html) |
