...
///Field `DINR` reader - DINR\[x+31:x\]: One of four 32-bit words of a 128-bit input data block being written into the peripheral
pub type DINR_R = crate::FieldReader<u32>;
///Field `DINR` writer - DINR\[x+31:x\]: One of four 32-bit words of a 128-bit input data block being written into the peripheral
