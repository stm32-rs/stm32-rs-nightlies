...
///Field `IVI` reader - IVI \[((32*x)+31):((32*x)+0)\]: Initialization vector register (LSB IVR\[((32*x)+31):((32*x)+0)\])
pub type IVI_R = crate::FieldReader<u32>;
///Field `IVI` writer - IVI \[((32*x)+31):((32*x)+0)\]: Initialization vector register (LSB IVR\[((32*x)+31):((32*x)+0)\])
