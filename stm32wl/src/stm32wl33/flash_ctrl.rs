...
impl RegisterBlock {
    ...
    ///0x50 - UNLOCK012 register
    #[inline(always)]
    pub const fn unlock012(&self) -> &UNLOCK012 {
        &self.unlock012
    }
    ///0x54 - UNLOCK3 register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:IRQSTAT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:IRQMASK)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:IRQRAW)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:ADDRESS)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:PAGEPROT0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:PAGEPROT1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:DATA0)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:DATA1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:DATA2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#FLASH_CTRL:DATA3)

For information about available fields see [`mod@data3`] module*/
pub type DATA3 = crate::Reg<data3::DATA3rs>;
///DATA3 register
pub mod data3;
/**UNLOCK012 (rw) register accessor: UNLOCK012 register
...
pub type UNLOCK012 = crate::Reg<unlock012::UNLOCK012rs>;
///UNLOCK012 register
pub mod unlock012;
/**UNLOCK3 (rw) register accessor: UNLOCK3 register
...
pub type UNLOCK3 = crate::Reg<unlock3::UNLOCK3rs>;
///UNLOCK3 register
pub mod unlock3;
