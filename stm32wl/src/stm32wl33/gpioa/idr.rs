...
///Field `ID0` reader - ID0: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID0_R = crate::BitReader;
///Field `ID1` reader - ID1: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID1_R = crate::BitReader;
///Field `ID2` reader - ID2: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID2_R = crate::BitReader;
///Field `ID3` reader - ID3: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID3_R = crate::BitReader;
///Field `ID4` reader - ID4: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID4_R = crate::BitReader;
///Field `ID5` reader - ID5: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID5_R = crate::BitReader;
///Field `ID6` reader - ID6: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID6_R = crate::BitReader;
///Field `ID7` reader - ID7: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID7_R = crate::BitReader;
///Field `ID8` reader - ID8: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID8_R = crate::BitReader;
///Field `ID9` reader - ID9: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID9_R = crate::BitReader;
///Field `ID10` reader - ID10: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID10_R = crate::BitReader;
///Field `ID11` reader - ID11: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID11_R = crate::BitReader;
///Field `ID12` reader - ID12: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID12_R = crate::BitReader;
///Field `ID13` reader - ID13: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID13_R = crate::BitReader;
///Field `ID14` reader - ID14: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
pub type ID14_R = crate::BitReader;
///Field `ID15` reader - ID15: Port A input data bit.These bits are read-only. They contain the input value of the corresponding I/O port
