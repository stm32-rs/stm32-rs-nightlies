...
///Field `OD0` reader - OD0: Port A output data bit These bits can be read and written by software
pub type OD0_R = crate::BitReader;
///Field `OD0` writer - OD0: Port A output data bit These bits can be read and written by software
pub type OD0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD1` reader - OD1: Port A output data bit These bits can be read and written by software
pub type OD1_R = crate::BitReader;
///Field `OD1` writer - OD1: Port A output data bit These bits can be read and written by software
pub type OD1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD2` reader - OD2: Port A output data bit These bits can be read and written by software
pub type OD2_R = crate::BitReader;
///Field `OD2` writer - OD2: Port A output data bit These bits can be read and written by software
pub type OD2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD3` reader - OD3: Port A output data bit These bits can be read and written by software
pub type OD3_R = crate::BitReader;
///Field `OD3` writer - OD3: Port A output data bit These bits can be read and written by software
pub type OD3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD4` reader - OD4: Port A output data bit These bits can be read and written by software
pub type OD4_R = crate::BitReader;
///Field `OD4` writer - OD4: Port A output data bit These bits can be read and written by software
pub type OD4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD5` reader - OD5: Port A output data bit These bits can be read and written by software
pub type OD5_R = crate::BitReader;
///Field `OD5` writer - OD5: Port A output data bit These bits can be read and written by software
pub type OD5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD6` reader - OD6: Port A output data bit These bits can be read and written by software
pub type OD6_R = crate::BitReader;
///Field `OD6` writer - OD6: Port A output data bit These bits can be read and written by software
pub type OD6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD7` reader - OD7: Port A output data bit These bits can be read and written by software
pub type OD7_R = crate::BitReader;
///Field `OD7` writer - OD7: Port A output data bit These bits can be read and written by software
pub type OD7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD8` reader - OD8: Port A output data bit These bits can be read and written by software
pub type OD8_R = crate::BitReader;
///Field `OD8` writer - OD8: Port A output data bit These bits can be read and written by software
pub type OD8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD9` reader - OD9: Port A output data bit These bits can be read and written by software
pub type OD9_R = crate::BitReader;
///Field `OD9` writer - OD9: Port A output data bit These bits can be read and written by software
pub type OD9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD10` reader - OD10: Port A output data bit These bits can be read and written by software
pub type OD10_R = crate::BitReader;
///Field `OD10` writer - OD10: Port A output data bit These bits can be read and written by software
pub type OD10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD11` reader - OD11: Port A output data bit These bits can be read and written by software
pub type OD11_R = crate::BitReader;
///Field `OD11` writer - OD11: Port A output data bit These bits can be read and written by software
pub type OD11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD12` reader - OD12: Port A output data bit These bits can be read and written by software
pub type OD12_R = crate::BitReader;
///Field `OD12` writer - OD12: Port A output data bit These bits can be read and written by software
pub type OD12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD13` reader - OD13: Port A output data bit These bits can be read and written by software
pub type OD13_R = crate::BitReader;
///Field `OD13` writer - OD13: Port A output data bit These bits can be read and written by software
pub type OD13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD14` reader - OD14: Port A output data bit These bits can be read and written by software
pub type OD14_R = crate::BitReader;
///Field `OD14` writer - OD14: Port A output data bit These bits can be read and written by software
pub type OD14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OD15` reader - OD15: Port A output data bit These bits can be read and written by software
pub type OD15_R = crate::BitReader;
///Field `OD15` writer - OD15: Port A output data bit These bits can be read and written by software
