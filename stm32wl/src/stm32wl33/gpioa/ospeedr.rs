...
///Field `OSPEED0` reader - OSPEED0\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED0_R = crate::FieldReader;
///Field `OSPEED0` writer - OSPEED0\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED1` reader - OSPEED1\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED1_R = crate::FieldReader;
///Field `OSPEED1` writer - OSPEED1\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED2` reader - OSPEED2\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED2_R = crate::FieldReader;
///Field `OSPEED2` writer - OSPEED2\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED3` reader - OSPEED3\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED3_R = crate::FieldReader;
///Field `OSPEED3` writer - OSPEED3\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED3_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED4` reader - OSPEED4\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED4_R = crate::FieldReader;
///Field `OSPEED4` writer - OSPEED4\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED4_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED5` reader - OSPEED5\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED5_R = crate::FieldReader;
///Field `OSPEED5` writer - OSPEED5\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED5_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED6` reader - OSPEED6\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED6_R = crate::FieldReader;
///Field `OSPEED6` writer - OSPEED6\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED6_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED7` reader - OSPEED7\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED7_R = crate::FieldReader;
///Field `OSPEED7` writer - OSPEED7\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED7_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED8` reader - OSPEED8\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED8_R = crate::FieldReader;
///Field `OSPEED8` writer - OSPEED8\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED8_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED9` reader - OSPEED9\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED9_R = crate::FieldReader;
///Field `OSPEED9` writer - OSPEED9\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED9_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED10` reader - OSPEED10\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED10_R = crate::FieldReader;
///Field `OSPEED10` writer - OSPEED10\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED10_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED11` reader - OSPEED11\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED11_R = crate::FieldReader;
///Field `OSPEED11` writer - OSPEED11\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED11_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED12` reader - OSPEED12\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED12_R = crate::FieldReader;
///Field `OSPEED12` writer - OSPEED12\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED12_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED13` reader - OSPEED13\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED13_R = crate::FieldReader;
///Field `OSPEED13` writer - OSPEED13\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED13_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED14` reader - OSPEED14\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED14_R = crate::FieldReader;
///Field `OSPEED14` writer - OSPEED14\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED14_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `OSPEED15` reader - OSPEED15\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
pub type OSPEED15_R = crate::FieldReader;
///Field `OSPEED15` writer - OSPEED15\[1:0\]: Port A configuration bits These bits are written by software to configure the I/O output speed.
...
///`reset()` method sets OSPEEDR to value 0x30
