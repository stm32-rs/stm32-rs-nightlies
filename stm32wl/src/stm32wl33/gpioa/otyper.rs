...
///Field `OT0` reader - OT0: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT0_R = crate::BitReader;
///Field `OT0` writer - OT0: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT1` reader - OT1: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT1_R = crate::BitReader;
///Field `OT1` writer - OT1: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT2` reader - OT2: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT2_R = crate::BitReader;
///Field `OT2` writer - OT2: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT3` reader - OT3: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT3_R = crate::BitReader;
///Field `OT3` writer - OT3: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT4` reader - OT4: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT4_R = crate::BitReader;
///Field `OT4` writer - OT4: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT5` reader - OT5: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT5_R = crate::BitReader;
///Field `OT5` writer - OT5: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT6` reader - OT6: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT6_R = crate::BitReader;
///Field `OT6` writer - OT6: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT7` reader - OT7: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT7_R = crate::BitReader;
///Field `OT7` writer - OT7: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT8` reader - OT8: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT8_R = crate::BitReader;
///Field `OT8` writer - OT8: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT9` reader - OT9: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT9_R = crate::BitReader;
///Field `OT9` writer - OT9: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT10` reader - OT10: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT10_R = crate::BitReader;
///Field `OT10` writer - OT10: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT11` reader - OT11: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT11_R = crate::BitReader;
///Field `OT11` writer - OT11: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT12` reader - OT12: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT12_R = crate::BitReader;
///Field `OT12` writer - OT12: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT13` reader - OT13: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT13_R = crate::BitReader;
///Field `OT13` writer - OT13: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT14` reader - OT14: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT14_R = crate::BitReader;
///Field `OT14` writer - OT14: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OT15` reader - OT15: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
pub type OT15_R = crate::BitReader;
///Field `OT15` writer - OT15: Port A configuration bits These bits are written by software to configure the I/O output type. -0: Output push-pull (reset state) -1: Output open-drain
