...
///Field `BS0` writer - BS0: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS1` writer - BS1: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS2` writer - BS2: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS3` writer - BS3: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS4` writer - BS4: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS5` writer - BS5: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS6` writer - BS6: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS7` writer - BS7: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS8` writer - BS8: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS9` writer - BS9: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS10` writer - BS10: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS11` writer - BS11: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS12` writer - BS12: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS13` writer - BS13: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS14` writer - BS14: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS15` writer - BS15: Port B set bit y These bits are write-only. A read to these bits returns the value 0x0000.
pub type BS15_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR0` writer - BR0: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR1` writer - BR1: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR2` writer - BR2: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR3` writer - BR3: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR4` writer - BR4: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR5` writer - BR5: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR6` writer - BR6: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR7` writer - BR7: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR8` writer - BR8: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR9` writer - BR9: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR10` writer - BR10: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR11` writer - BR11: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR12` writer - BR12: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR13` writer - BR13: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR14` writer - BR14: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
pub type BR14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BR15` writer - BR15: Port B reset bit y These bits are write-only. A read to these bits returns the value 0x0000. -0: No action on the corresponding ODx bit -1: Resets the corresponding ODx bit Note: If both BSx and BRx are set, BSx has priority.
