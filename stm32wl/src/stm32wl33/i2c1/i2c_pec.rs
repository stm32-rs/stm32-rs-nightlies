...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C_PEC").field("pec", &self.pec()).finish()
    }
}
/**I2C_PEC register
...
pub struct I2C_PECrs;
impl crate::RegisterSpec for I2C_PECrs {
    type Ux = u32;
}
///`read()` method returns [`i2c_pec::R`](R) reader structure
impl crate::Readable for I2C_PECrs {}
///`reset()` method sets I2C_PEC to value 0
impl crate::Resettable for I2C_PECrs {}
