...
///Field `RXDATA` reader - Eight bit (8-bit) receive data Data byte received from the I2C bus.
pub type RXDATA_R = crate::FieldReader;
impl R {
    ///Bits 0:7 - Eight bit (8-bit) receive data Data byte received from the I2C bus.
    #[inline(always)]
