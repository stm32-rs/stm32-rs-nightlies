...
///Field `LPMS` reader - LPMS Low Power Mode Selection Selection of the low power mode entered when CPU enters DEEP SLEEP mode and BLE is rdy2sleep. - 0: Deep Stop mode (default) - 1: Shutdown mode
pub type LPMS_R = crate::BitReader;
///Field `LPMS` writer - LPMS Low Power Mode Selection Selection of the low power mode entered when CPU enters DEEP SLEEP mode and BLE is rdy2sleep. - 0: Deep Stop mode (default) - 1: Shutdown mode
pub type LPMS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENSDNBOR` reader - ENSDNBOR: Enable BOR supply monitoring during shutdown mode. - 1: the PD_ALL_SHUTDOWN signal is not set during SHUTDOWN mode - 0: the PD_ALL_SHUTDOWN signal is set during SHUTDOWN mode.
pub type ENSDNBOR_R = crate::BitReader;
///Field `ENSDNBOR` writer - ENSDNBOR: Enable BOR supply monitoring during shutdown mode. - 1: the PD_ALL_SHUTDOWN signal is not set during SHUTDOWN mode - 0: the PD_ALL_SHUTDOWN signal is set during SHUTDOWN mode.
...
///Field `APC` reader - APC Apply Pull-up and pull-down configuration from CPU - 1: the I/O pull-up and pull-down configurations defined in the PUCRx and PDCRx registers is applied. - 0: the PUCRx and PDCRx are not used to control the I/O pull-up and pull-down configuration of the product I/Os.
pub type APC_R = crate::BitReader;
///Field `APC` writer - APC Apply Pull-up and pull-down configuration from CPU - 1: the I/O pull-up and pull-down configurations defined in the PUCRx and PDCRx registers is applied. - 0: the PUCRx and PDCRx are not used to control the I/O pull-up and pull-down configuration of the product I/Os.
pub type APC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENBORH` reader - ENBORH: enable BORH configuration - 1: BORH is enabled, threshold level depends on SELBOR\[1:0\] - 0: BORH off (VBOR0): threshold level for above 1.60V voltage operation.
pub type ENBORH_R = crate::BitReader;
///Field `ENBORH` writer - ENBORH: enable BORH configuration - 1: BORH is enabled, threshold level depends on SELBOR\[1:0\] - 0: BORH off (VBOR0): threshold level for above 1.60V voltage operation.
pub type ENBORH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SELBORH` reader - SELBORH\[1:0\]: BORH selection of Vbor threshold - 11: BORH Level 4(VBOR4): threshold level for above 2.81 V voltage operation. - 10: BORH Level 3 (VBOR3): threshold level for above 2.52 V voltage operation - 01: BORH Level 2 (VBOR2): threshold level for above 2.21 V voltage operation - 00: BORH Level 1 (VBOR1): threshold level for above 2.0V voltage operation.
pub type SELBORH_R = crate::FieldReader;
///Field `SELBORH` writer - SELBORH\[1:0\]: BORH selection of Vbor threshold - 11: BORH Level 4(VBOR4): threshold level for above 2.81 V voltage operation. - 10: BORH Level 3 (VBOR3): threshold level for above 2.52 V voltage operation - 01: BORH Level 2 (VBOR2): threshold level for above 2.21 V voltage operation - 00: BORH Level 1 (VBOR1): threshold level for above 2.0V voltage operation.
