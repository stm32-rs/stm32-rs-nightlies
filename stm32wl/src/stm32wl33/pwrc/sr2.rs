...
///Field `SMPSRDY` reader - SMPSRDY: SMPS Ready Status This bit provides the information whether SMPS is ready. - 0: SMPS regulator is not ready - 1: SMPS regulator is ready.
...
///Field `REGLPS` reader - REGLPS: Regulator Low Power Started This bit provides the information whether low power regulator is ready. - 0: LP regulator is not ready. - 1: LP regulator is ready.
pub type REGLPS_R = crate::BitReader;
///Field `REGMS` reader - REGMS: Main regulator ready status. - 0: The Main regulator is not ready. - 1: The Main regulator is ready.
...
///`reset()` method sets SR2 to value 0xf3f6
