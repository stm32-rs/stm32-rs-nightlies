...
///Field `DMAEN` reader - DMA and DMAMUX enable Set and enable by software. 0: does not enable 1: enable
pub type DMAEN_R = crate::BitReader;
///Field `DMAEN` writer - DMA and DMAMUX enable Set and enable by software. 0: does not enable 1: enable
...
///Field `CRCEN` reader - CRC enable Set and enable by software. 0: does not enable 1: enable
pub type CRCEN_R = crate::BitReader;
///Field `CRCEN` writer - CRC enable Set and enable by software. 0: does not enable 1: enable
pub type CRCEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RNGEN` reader - RNG clock enable Set and enable by software. 0: does not enable 1: enable
pub type RNGEN_R = crate::BitReader;
///Field `RNGEN` writer - RNG clock enable Set and enable by software. 0: does not enable 1: enable
pub type RNGEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AESEN` reader - AESEN: AES clock enable. 0: AES IP is clock gated. 1: AES IP is clocked.
pub type AESEN_R = crate::BitReader;
///Field `AESEN` writer - AESEN: AES clock enable. 0: AES IP is clock gated. 1: AES IP is clocked.
