...
///Field `DMARST` reader - DMA and DMAMUX reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type DMARST_R = crate::BitReader;
///Field `DMARST` writer - DMA and DMAMUX reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type DMARST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPIOARST` reader - GPIOA reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type GPIOARST_R = crate::BitReader;
///Field `GPIOARST` writer - GPIOA reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type GPIOARST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPIOBRST` reader - GPIOB reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type GPIOBRST_R = crate::BitReader;
///Field `GPIOBRST` writer - GPIOB reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type GPIOBRST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRCRST` reader - CRC reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type CRCRST_R = crate::BitReader;
///Field `CRCRST` writer - CRC reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type CRCRST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RNGRST` reader - RNG reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type RNGRST_R = crate::BitReader;
///Field `RNGRST` writer - RNG reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type RNGRST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AESRST` reader - AES reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type AESRST_R = crate::BitReader;
///Field `AESRST` writer - AES reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
