...
///Field `SPI1RST` reader - SPI1 reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type SPI1RST_R = crate::BitReader;
///Field `SPI1RST` writer - SPI1 reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type SPI1RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADCRST` reader - ADC reset for Aux-ADC IP Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type ADCRST_R = crate::BitReader;
///Field `ADCRST` writer - ADC reset for Aux-ADC IP Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type ADCRST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPUARTRST` reader - LPUART reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type LPUARTRST_R = crate::BitReader;
///Field `LPUARTRST` writer - LPUART reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type LPUARTRST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USARTRST` reader - USART reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type USARTRST_R = crate::BitReader;
///Field `USARTRST` writer - USART reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type USARTRST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI3RST` reader - SPI3 reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type SPI3RST_R = crate::BitReader;
///Field `SPI3RST` writer - SPI3 reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type SPI3RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C1RST` reader - I2C1 reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type I2C1RST_R = crate::BitReader;
///Field `I2C1RST` writer - I2C1 reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type I2C1RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C2RST` reader - I2C2 reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
pub type I2C2RST_R = crate::BitReader;
///Field `I2C2RST` writer - I2C2 reset Set and reset by software. 0: IP is not under reset. 1: IP is under reset.
