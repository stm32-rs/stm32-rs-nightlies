...
///Field `LSION` reader - Internal Low Speed oscillator enable Set and reset by software. Reset source only for this field: PORESETn 0: LSI RC oscillator OFF 1: LSI RC oscillator ON
pub type LSION_R = crate::BitReader;
///Field `LSION` writer - Internal Low Speed oscillator enable Set and reset by software. Reset source only for this field: PORESETn 0: LSI RC oscillator OFF 1: LSI RC oscillator ON
pub type LSION_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LSIRDY` reader - Internal Low Speed oscillator Ready Set and reset by hardware to indicate when the Low Speed Internal RC oscillator is stable. Reset source only for this field: PORESETn 0: LSI RC oscillator not ready 1: LSI RC oscillator ready
pub type LSIRDY_R = crate::BitReader;
///Field `LSEON` reader - External Low Speed Clock enable. Set and reset by software. Reset source only for this field: PORESETn 0: LSE oscillator OFF 1: LSE oscillator ON Note that enablng this bit, the configuration of PB12 and PB13 will be bypassed (whatever DFTMUX or AF selection)
pub type LSEON_R = crate::BitReader;
///Field `LSEON` writer - External Low Speed Clock enable. Set and reset by software. Reset source only for this field: PORESETn 0: LSE oscillator OFF 1: LSE oscillator ON Note that enablng this bit, the configuration of PB12 and PB13 will be bypassed (whatever DFTMUX or AF selection)
pub type LSEON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LSERDY` reader - External Low Speed Clock ready flag. Set by hardware to indicate that LSE oscillator is stable. 0: LSE oscillator not ready 1: LSE oscillator ready
pub type LSERDY_R = crate::BitReader;
///Field `LSEBYP` reader - External Low Speed Clock bypass. Set and reset by software. Reset source only for this field: PORESETn 0: LSE oscillator bypass OFF 1: LSE oscillator bypass ON Note that enablng this bit, the configuration of PB13 will be bypassed (whatever DFTMUX or AF selection)
pub type LSEBYP_R = crate::BitReader;
///Field `LSEBYP` writer - External Low Speed Clock bypass. Set and reset by software. Reset source only for this field: PORESETn 0: LSE oscillator bypass OFF 1: LSE oscillator bypass ON Note that enablng this bit, the configuration of PB13 will be bypassed (whatever DFTMUX or AF selection)
...
///Field `HSIRDY` reader - Internal High Speed clock ready flag. Set by hardware to indicate that internal RC 64MHz oscillator is stable. This bit is activated only if the RC is enabled by HSION (it is not activated if the RC is enabled by an IP request). 0: internal RC 64 MHz oscillator not ready 1: internal RC 64 MHz oscillator ready
pub type HSIRDY_R = crate::BitReader;
///Field `HSEPLLBUFON` reader - External High Speed Clock Buffer for PLL RF enable. Set and reset by software. 0: HSE PLL Buffer OFF 1: HSE PLL Buffer ON (default)
pub type HSEPLLBUFON_R = crate::BitReader;
///Field `HSEPLLBUFON` writer - External High Speed Clock Buffer for PLL RF enable. Set and reset by software. 0: HSE PLL Buffer OFF 1: HSE PLL Buffer ON (default)
pub type HSEPLLBUFON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HSIPLLON` reader - Internal High Speed Clock PLL enable 0: PLL is OFF 1: PLL is ON
pub type HSIPLLON_R = crate::BitReader;
///Field `HSIPLLON` writer - Internal High Speed Clock PLL enable 0: PLL is OFF 1: PLL is ON
pub type HSIPLLON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HSIPLLRDY` reader - Internal High Speed Clock PLL ready flag. 0: PLL is unlocked 1: PLL is locked
pub type HSIPLLRDY_R = crate::BitReader;
///Field `FMRAT` reader - Force MRSUBG accurate clock ready status (for debug purpose) 0: no effect 1: active_transmission is force to '1' whatever the HSIPLLRDY/HSE status
pub type FMRAT_R = crate::BitReader;
///Field `FMRAT` writer - Force MRSUBG accurate clock ready status (for debug purpose) 0: no effect 1: active_transmission is force to '1' whatever the HSIPLLRDY/HSE status
pub type FMRAT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HSEON` reader - External High Speed Clock enable. Set and reset by software. in low power mode, HSE is turned off. HSE is turned ON only when RFSUBG LDO is Ready 0: HSE oscillator OFF 1: HSE oscillator ON
pub type HSEON_R = crate::BitReader;
///Field `HSEON` writer - External High Speed Clock enable. Set and reset by software. in low power mode, HSE is turned off. HSE is turned ON only when RFSUBG LDO is Ready 0: HSE oscillator OFF 1: HSE oscillator ON
pub type HSEON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HSERDY` reader - External High Speed Clock ready flag. Set by hardware to indicate that HSE oscillator is stable. 0: HSE oscillator not ready 1: HSE oscillator ready
...
impl R {
    ...
    #[inline(always)]
    pub fn fmrat(&self) -> FMRAT_R {
        FMRAT_R::new(((self.bits >> 15) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 15 - Force MRSUBG accurate clock ready status (for debug purpose) 0: no effect 1: active_transmission is force to '1' whatever the HSIPLLRDY/HSE status
    #[inline(always)]
    pub fn fmrat(&mut self) -> FMRAT_W<'_, CRrs> {
        FMRAT_W::new(self, 15)
    }
    ///Bit 16 - External High Speed Clock enable. Set and reset by software. in low power mode, HSE is turned off. HSE is turned ON only when RFSUBG LDO is Ready 0: HSE oscillator OFF 1: HSE oscillator ON
    #[inline(always)]
