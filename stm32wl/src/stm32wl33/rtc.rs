...
impl RegisterBlock {
    ...
    ///0x30 - RTC_TSTR register
    #[inline(always)]
    pub const fn tstr(&self) -> &TSTR {
        &self.tstr
    }
    ///0x34 - RTC_TSDR register
    #[inline(always)]
    pub const fn tsdr(&self) -> &TSDR {
        &self.tsdr
    }
    ///0x38 - RTC_TSSSR register
    #[inline(always)]
    ...
    ///0x4c - RTC_OR register
    #[inline(always)]
    pub const fn or(&self) -> &OR {
        &self.or
    }
    ///0x50 - RTC_BKPxR register
    #[inline(always)]
    pub const fn bkp0r(&self) -> &BKP0R {
        &self.bkp0r
    }
    ///0x54 - RTC_BKPxR register
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#RTC:DR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#RTC:CR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#RTC:WPR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#RTC:SHIFTR)

For information about available fields see [`mod@shiftr`] module*/
pub type SHIFTR = crate::Reg<shiftr::SHIFTRrs>;
///RTC_SHIFTR register
pub mod shiftr;
/**TSTR (rw) register accessor: RTC_TSTR register

You can [`read`](crate::Reg::read) this register and get [`tstr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tstr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///RTC_TSTR register
pub mod tstr;
/**TSDR (rw) register accessor: RTC_TSDR register

You can [`read`](crate::Reg::read) this register and get [`tsdr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tsdr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///RTC_TSDR register
pub mod tsdr;
/**TSSSR (r) register accessor: RTC_TSSSR register

You can [`read`](crate::Reg::read) this register and get [`tsssr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#RTC:TSSSR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#RTC:CALR)

For information about available fields see [`mod@calr`] module*/
pub type CALR = crate::Reg<calr::CALRrs>;
///RTC_CALR register
pub mod calr;
/**TAMPCR (rw) register accessor: RTC_TAMPCR register
...
pub mod alrmassr;
/**OR (rw) register accessor: RTC_OR register
...
///RTC_OR register
pub mod or;
/**BKP0R (rw) register accessor: RTC_BKPxR register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#RTC:BKP0R)

For information about available fields see [`mod@bkp0r`] module*/
pub type BKP0R = crate::Reg<bkp0r::BKP0Rrs>;
///RTC_BKPxR register
pub mod bkp0r;
/**BKP1R (rw) register accessor: RTC_BKPxR register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#RTC:BKP1R)
