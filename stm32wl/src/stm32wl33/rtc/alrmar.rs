...
///Field `MSK1` reader - Alarm A seconds mask 0: Alarm A set if the seconds match 1: Seconds dont care in Alarm A comparison
pub type MSK1_R = crate::BitReader;
///Field `MSK1` writer - Alarm A seconds mask 0: Alarm A set if the seconds match 1: Seconds dont care in Alarm A comparison
...
///Field `MSK2` reader - Alarm A minutes mask 0: Alarm A set if the minutes match 1: Minutes dont care in Alarm A comparison
pub type MSK2_R = crate::BitReader;
///Field `MSK2` writer - Alarm A minutes mask 0: Alarm A set if the minutes match 1: Minutes dont care in Alarm A comparison
...
///Field `MSK3` reader - Alarm A hours mask 0: Alarm A set if the hours match 1: Hours dont care in Alarm A comparison
pub type MSK3_R = crate::BitReader;
///Field `MSK3` writer - Alarm A hours mask 0: Alarm A set if the hours match 1: Hours dont care in Alarm A comparison
...
///Field `WDSEL` reader - Week day selection 0: DU\[3:0\] represents the date units 1: DU\[3:0\] represents the week day. DT\[1:0\] is dont care.
pub type WDSEL_R = crate::BitReader;
///Field `WDSEL` writer - Week day selection 0: DU\[3:0\] represents the date units 1: DU\[3:0\] represents the week day. DT\[1:0\] is dont care.
pub type WDSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MSK4` reader - Alarm A date mask 0: Alarm A set if the date/day match 1: Date/day dont care in Alarm A comparison
pub type MSK4_R = crate::BitReader;
///Field `MSK4` writer - Alarm A date mask 0: Alarm A set if the date/day match 1: Date/day dont care in Alarm A comparison
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#RTC:ALRMAR)*/
pub struct ALRMARrs;
