...
///Field `TSEDGE` reader - Time-stamp event active edge 0: RTC_TS input rising edge generates a time-stamp event 1: RTC_TS input falling edge generates a time-stamp event TSE must be reset when TSEDGE is changed to avoid unwanted TSF setting.
pub type TSEDGE_R = crate::BitReader;
///Field `TSEDGE` writer - Time-stamp event active edge 0: RTC_TS input rising edge generates a time-stamp event 1: RTC_TS input falling edge generates a time-stamp event TSE must be reset when TSEDGE is changed to avoid unwanted TSF setting.
...
///Field `TSE` reader - Timestamp enable 0: Timestamp disable 1: Timestamp enable
pub type TSE_R = crate::BitReader;
///Field `TSE` writer - Timestamp enable 0: Timestamp disable 1: Timestamp enable
...
///Field `ITSE` reader - Timestamp on internal event enable 0: Internal event timestamp disable 1: Internal event timestamp enable
pub type ITSE_R = crate::BitReader;
///Field `ITSE` writer - Timestamp on internal event enable 0: Internal event timestamp disable 1: Internal event timestamp enable
