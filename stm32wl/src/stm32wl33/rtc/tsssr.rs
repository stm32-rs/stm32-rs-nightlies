...
///Field `SS` reader - Sub second value SS\[15:0\] is the value of the synchronous prescalers counter when the timestamp event occurred.
pub type SS_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - Sub second value SS\[15:0\] is the value of the synchronous prescalers counter when the timestamp event occurred.
    #[inline(always)]
    pub fn ss(&self) -> SS_R {
