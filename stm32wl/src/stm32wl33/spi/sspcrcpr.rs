///Register `SSPCRCPR` reader
pub type R = crate::R<SSPCRCPRrs>;
///Register `SSPCRCPR` writer
pub type W = crate::W<SSPCRCPRrs>;
...
impl W {
    ///Bits 0:15 - CRC polynomial register This register contains the polynomial for the CRC calculation. The CRC polynomial (0007h) is the reset value of this register. Another polynomial can be configured as required.
    #[inline(always)]
    pub fn crcpoly(&mut self) -> CRCPOLY_W<'_, SSPCRCPRrs> {
        CRCPOLY_W::new(self, 0)
    }
}
/**SPI_SSPCRCPR register

You can [`read`](crate::Reg::read) this register and get [`sspcrcpr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sspcrcpr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#SPI:SSPCRCPR)*/
pub struct SSPCRCPRrs;
impl crate::RegisterSpec for SSPCRCPRrs {
    type Ux = u32;
}
///`read()` method returns [`sspcrcpr::R`](R) reader structure
impl crate::Readable for SSPCRCPRrs {}
///`write(|w| ..)` method takes [`sspcrcpr::W`](W) writer structure
impl crate::Writable for SSPCRCPRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SSPCRCPR to value 0x07
impl crate::Resettable for SSPCRCPRrs {
