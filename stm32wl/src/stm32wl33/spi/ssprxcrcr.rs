///Register `SSPRXCRCR` reader
pub type R = crate::R<SSPRXCRCRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`ssprxcrcr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#SPI:SSPRXCRCR)*/
pub struct SSPRXCRCRrs;
impl crate::RegisterSpec for SSPRXCRCRrs {
    type Ux = u32;
}
///`read()` method returns [`ssprxcrcr::R`](R) reader structure
impl crate::Readable for SSPRXCRCRrs {}
///`reset()` method sets SSPRXCRCR to value 0
impl crate::Resettable for SSPRXCRCRrs {}
