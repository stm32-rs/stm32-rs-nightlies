...
pub type R = crate::R<SSPSRrs>;
///Register `SSPSR` writer
pub type W = crate::W<SSPSRrs>;
...
impl W {
    ///Bit 4 - CRC error flag - 0: CRC value received matches the SPIx_RXCRCR value - 1: CRC value received does not match the SPIx_RXCRCR value This flag is set by hardware and cleared by software writing 0.
    #[inline(always)]
    pub fn crcerr(&mut self) -> CRCERR_W<'_, SSPSRrs> {
        CRCERR_W::new(self, 4)
    }
}
/**SPI_SSPSR register

You can [`read`](crate::Reg::read) this register and get [`sspsr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sspsr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#SPI:SSPSR)*/
pub struct SSPSRrs;
impl crate::RegisterSpec for SSPSRrs {
    type Ux = u32;
}
///`read()` method returns [`sspsr::R`](R) reader structure
impl crate::Readable for SSPSRrs {}
///`write(|w| ..)` method takes [`sspsr::W`](W) writer structure
impl crate::Writable for SSPSRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SSPSR to value 0x02
impl crate::Resettable for SSPSRrs {
