///Register `SSPTXCRCR` reader
pub type R = crate::R<SSPTXCRCRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`ssptxcrcr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#SPI:SSPTXCRCR)*/
pub struct SSPTXCRCRrs;
impl crate::RegisterSpec for SSPTXCRCRrs {
    type Ux = u32;
}
///`read()` method returns [`ssptxcrcr::R`](R) reader structure
impl crate::Readable for SSPTXCRCRrs {}
///`reset()` method sets SSPTXCRCR to value 0
impl crate::Resettable for SSPTXCRCRrs {}
