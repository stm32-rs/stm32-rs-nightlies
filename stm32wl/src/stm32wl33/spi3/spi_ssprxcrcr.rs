///Register `SPI_SSPRXCRCR` reader
pub type R = crate::R<SPI_SSPRXCRCRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`spi_ssprxcrcr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#SPI3:SPI_SSPRXCRCR)*/
pub struct SPI_SSPRXCRCRrs;
impl crate::RegisterSpec for SPI_SSPRXCRCRrs {
    type Ux = u32;
}
///`read()` method returns [`spi_ssprxcrcr::R`](R) reader structure
impl crate::Readable for SPI_SSPRXCRCRrs {}
///`reset()` method sets SPI_SSPRXCRCR to value 0
impl crate::Resettable for SPI_SSPRXCRCRrs {}
