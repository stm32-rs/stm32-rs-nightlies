...
impl R {
    ...
    pub fn txcrc(&self) -> TXCRC_R {
        TXCRC_R::new((self.bits & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_SSPTXCRCR")
...
pub struct SPI_SSPTXCRCRrs;
impl crate::RegisterSpec for SPI_SSPTXCRCRrs {
    type Ux = u32;
}
///`read()` method returns [`spi_ssptxcrcr::R`](R) reader structure
impl crate::Readable for SPI_SSPTXCRCRrs {}
///`reset()` method sets SPI_SSPTXCRCR to value 0
impl crate::Resettable for SPI_SSPTXCRCRrs {}
