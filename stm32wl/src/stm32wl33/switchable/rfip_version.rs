...
///Field `REVISION` reader - Revision of the RFIP to be used for metal fixes)
pub type REVISION_R = crate::FieldReader;
///Field `VERSION` reader - Version of the RFIP (to be used for cut upgrades)
...
///`reset()` method sets RFIP_VERSION to value 0x1100
