...
///Field `BRR` reader - BRR\[15:4\] BRR\[15:4\] = USARTDIV\[15:4\]BRR\[3:0\] When OVER8 = 0, BRR\[3:0\] = USARTDIV\[3:0\]. When OVER8 = 1: BRR\[2:0\] = USARTDIV\[3:0\] shifted 1 bit to the right. BRR\[3\] must be kept cleared
pub type BRR_R = crate::FieldReader<u16>;
///Field `BRR` writer - BRR\[15:4\] BRR\[15:4\] = USARTDIV\[15:4\]BRR\[3:0\] When OVER8 = 0, BRR\[3:0\] = USARTDIV\[3:0\]. When OVER8 = 1: BRR\[2:0\] = USARTDIV\[3:0\] shifted 1 bit to the right. BRR\[3\] must be kept cleared
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL33.html#USART:BRR)*/
pub struct BRRrs;
