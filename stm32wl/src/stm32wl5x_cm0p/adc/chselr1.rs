...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `SQ1` field.</div>
    #[inline(always)]
    pub fn sq(&mut self, n: u8) -> SQ_W<'_, CHSELR1rs> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
        SQ_W::new(self, n * 4)
    }
    ///Bits 0:3 - 1 conversion of the sequence
    #[inline(always)]
    pub fn sq1(&mut self) -> SQ_W<'_, CHSELR1rs> {
        SQ_W::new(self, 0)
    }
    ///Bits 4:7 - 2 conversion of the sequence
    #[inline(always)]
    pub fn sq2(&mut self) -> SQ_W<'_, CHSELR1rs> {
        SQ_W::new(self, 4)
    }
    ///Bits 8:11 - 3 conversion of the sequence
    #[inline(always)]
    pub fn sq3(&mut self) -> SQ_W<'_, CHSELR1rs> {
        SQ_W::new(self, 8)
    }
    ///Bits 12:15 - 4 conversion of the sequence
    #[inline(always)]
    pub fn sq4(&mut self) -> SQ_W<'_, CHSELR1rs> {
        SQ_W::new(self, 12)
    }
    ///Bits 16:19 - 5 conversion of the sequence
    #[inline(always)]
    pub fn sq5(&mut self) -> SQ_W<'_, CHSELR1rs> {
        SQ_W::new(self, 16)
    }
    ///Bits 20:23 - 6 conversion of the sequence
    #[inline(always)]
    pub fn sq6(&mut self) -> SQ_W<'_, CHSELR1rs> {
        SQ_W::new(self, 20)
    }
    ///Bits 24:27 - 7 conversion of the sequence
    #[inline(always)]
    pub fn sq7(&mut self) -> SQ_W<'_, CHSELR1rs> {
        SQ_W::new(self, 24)
    }
    ///Bits 28:31 - 8 conversion of the sequence
    #[inline(always)]
    pub fn sq8(&mut self) -> SQ_W<'_, CHSELR1rs> {
        SQ_W::new(self, 28)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#ADC:CHSELR1)*/
