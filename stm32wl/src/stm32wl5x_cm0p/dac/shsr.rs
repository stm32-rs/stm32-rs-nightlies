...
///Field `TSAMPLE` reader - DAC Channel 1 sample Time (only valid in Sample and Hold mode)
pub type TSAMPLE_R = crate::FieldReader<u16>;
///Field `TSAMPLE` writer - DAC Channel 1 sample Time (only valid in Sample and Hold mode)
