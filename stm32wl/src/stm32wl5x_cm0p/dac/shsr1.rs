...
pub type TSAMPLE1_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16, crate::Safe>;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#DAC:SHSR1)*/
pub struct SHSR1rs;
