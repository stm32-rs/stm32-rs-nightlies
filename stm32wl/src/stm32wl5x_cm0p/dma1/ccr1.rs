...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn secm(&mut self) -> SECM_W<CCR1rs> {
        SECM_W::new(self, 17)
    }
    ///Bit 18 - ecurity of the DMA transfer from the source
    #[inline(always)]
    #[must_use]
    pub fn ssec(&mut self) -> SSEC_W<CCR1rs> {
        SSEC_W::new(self, 18)
    }
    ///Bit 19 - ecurity of the DMA transfer to the destination
    #[inline(always)]
    #[must_use]
    pub fn dsec(&mut self) -> DSEC_W<CCR1rs> {
        DSEC_W::new(self, 19)
    }
    ///Bit 20 - rivileged mode
    #[inline(always)]
    #[must_use]
    pub fn priv_(&mut self) -> PRIV_W<CCR1rs> {
        PRIV_W::new(self, 20)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#DMA1:CCR1)*/
pub struct CCR1rs;
