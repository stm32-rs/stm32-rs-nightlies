...
impl W {
    ...
    ///Bit 17 - ecure mode
    #[inline(always)]
    pub fn secm(&mut self) -> SECM_W<CCR2rs> {
        SECM_W::new(self, 17)
    }
    ///Bit 18 - ecurity of the DMA transfer from the source
    #[inline(always)]
    pub fn ssec(&mut self) -> SSEC_W<CCR2rs> {
        SSEC_W::new(self, 18)
    }
    ///Bit 19 - ecurity of the DMA transfer to the destination
    #[inline(always)]
    pub fn dsec(&mut self) -> DSEC_W<CCR2rs> {
        DSEC_W::new(self, 19)
    }
    ///Bit 20 - rivileged mode
    #[inline(always)]
    pub fn priv_(&mut self) -> PRIV_W<CCR2rs> {
        PRIV_W::new(self, 20)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#DMA1:CCR2)*/
pub struct CCR2rs;
