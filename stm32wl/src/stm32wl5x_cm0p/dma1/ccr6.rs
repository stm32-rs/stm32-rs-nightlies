...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<CCR6rs> {
        EN_W::new(self, 0)
    }
    ///Bit 1 - transfer complete interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn tcie(&mut self) -> TCIE_W<CCR6rs> {
        TCIE_W::new(self, 1)
    }
    ///Bit 2 - half transfer interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn htie(&mut self) -> HTIE_W<CCR6rs> {
        HTIE_W::new(self, 2)
    }
    ///Bit 3 - transfer error interrupt enable
    #[inline(always)]
    #[must_use]
    pub fn teie(&mut self) -> TEIE_W<CCR6rs> {
        TEIE_W::new(self, 3)
    }
    ///Bit 4 - data transfer direction
    #[inline(always)]
    #[must_use]
    pub fn dir(&mut self) -> DIR_W<CCR6rs> {
        DIR_W::new(self, 4)
    }
    ///Bit 5 - circular mode
    #[inline(always)]
    #[must_use]
    pub fn circ(&mut self) -> CIRC_W<CCR6rs> {
        CIRC_W::new(self, 5)
    }
    ///Bit 6 - peripheral increment mode
    #[inline(always)]
    #[must_use]
    pub fn pinc(&mut self) -> PINC_W<CCR6rs> {
        PINC_W::new(self, 6)
    }
    ///Bit 7 - memory increment mode
    #[inline(always)]
    #[must_use]
    pub fn minc(&mut self) -> MINC_W<CCR6rs> {
        MINC_W::new(self, 7)
    }
    ///Bits 8:9 - peripheral size
    #[inline(always)]
    #[must_use]
    pub fn psize(&mut self) -> PSIZE_W<CCR6rs> {
        PSIZE_W::new(self, 8)
    }
    ///Bits 10:11 - memory size
    #[inline(always)]
    #[must_use]
    pub fn msize(&mut self) -> MSIZE_W<CCR6rs> {
        MSIZE_W::new(self, 10)
    }
    ///Bits 12:13 - priority level
    #[inline(always)]
    #[must_use]
    pub fn pl(&mut self) -> PL_W<CCR6rs> {
        PL_W::new(self, 12)
    }
    ///Bit 14 - memory-to-memory mode
    #[inline(always)]
    #[must_use]
    pub fn mem2mem(&mut self) -> MEM2MEM_W<CCR6rs> {
        MEM2MEM_W::new(self, 14)
    }
    ///Bit 17 - ecure mode
    #[inline(always)]
    #[must_use]
    pub fn secm(&mut self) -> SECM_W<CCR6rs> {
        SECM_W::new(self, 17)
    }
    ///Bit 18 - ecurity of the DMA transfer from the source
    #[inline(always)]
    #[must_use]
    pub fn ssec(&mut self) -> SSEC_W<CCR6rs> {
        SSEC_W::new(self, 18)
    }
    ///Bit 19 - ecurity of the DMA transfer to the destination
    #[inline(always)]
    #[must_use]
    pub fn dsec(&mut self) -> DSEC_W<CCR6rs> {
        DSEC_W::new(self, 19)
    }
    ///Bit 20 - rivileged mode
    #[inline(always)]
    #[must_use]
    pub fn priv_(&mut self) -> PRIV_W<CCR6rs> {
        PRIV_W::new(self, 20)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#DMA1:CCR6)*/
pub struct CCR6rs;
