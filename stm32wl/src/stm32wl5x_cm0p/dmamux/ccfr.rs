...
impl W {
    ...
    #[inline(always)]
    pub fn csof(&mut self, n: u8) -> CSOF_W<CCFRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#DMAMUX:CCFR)*/
pub struct CCFRrs;
