...
impl W {
    ///Bit 0 - Wake-up with event generation mask on event input 0
    #[inline(always)]
    pub fn em0(&mut self) -> EM0_W<'_, C1EMR1rs> {
        EM0_W::new(self, 0)
    }
    ///Bit 1 - Wake-up with event generation mask on event input 1
    #[inline(always)]
    pub fn em1(&mut self) -> EM1_W<'_, C1EMR1rs> {
        EM1_W::new(self, 1)
    }
    ///Bit 2 - Wake-up with event generation mask on event input 2
    #[inline(always)]
    pub fn em2(&mut self) -> EM2_W<'_, C1EMR1rs> {
        EM2_W::new(self, 2)
    }
    ///Bit 3 - Wake-up with event generation mask on event input 3
    #[inline(always)]
    pub fn em3(&mut self) -> EM3_W<'_, C1EMR1rs> {
        EM3_W::new(self, 3)
    }
    ///Bit 4 - Wake-up with event generation mask on event input 4
    #[inline(always)]
    pub fn em4(&mut self) -> EM4_W<'_, C1EMR1rs> {
        EM4_W::new(self, 4)
    }
    ///Bit 5 - Wake-up with event generation mask on event input 5
    #[inline(always)]
    pub fn em5(&mut self) -> EM5_W<'_, C1EMR1rs> {
        EM5_W::new(self, 5)
    }
    ///Bit 6 - Wake-up with event generation mask on event input 6
    #[inline(always)]
    pub fn em6(&mut self) -> EM6_W<'_, C1EMR1rs> {
        EM6_W::new(self, 6)
    }
    ///Bit 7 - Wake-up with event generation mask on event input 7
    #[inline(always)]
    pub fn em7(&mut self) -> EM7_W<'_, C1EMR1rs> {
        EM7_W::new(self, 7)
    }
    ///Bit 8 - Wake-up with event generation mask on event input 8
    #[inline(always)]
    pub fn em8(&mut self) -> EM8_W<'_, C1EMR1rs> {
        EM8_W::new(self, 8)
    }
    ///Bit 9 - Wake-up with event generation mask on event input 19
    #[inline(always)]
    pub fn em9(&mut self) -> EM9_W<'_, C1EMR1rs> {
        EM9_W::new(self, 9)
    }
    ///Bit 10 - Wake-up with event generation mask on event input 10
    #[inline(always)]
    pub fn em10(&mut self) -> EM10_W<'_, C1EMR1rs> {
        EM10_W::new(self, 10)
    }
    ///Bit 11 - Wake-up with event generation mask on event input 11
    #[inline(always)]
    pub fn em11(&mut self) -> EM11_W<'_, C1EMR1rs> {
        EM11_W::new(self, 11)
    }
    ///Bit 12 - Wake-up with event generation mask on event input 12
    #[inline(always)]
    pub fn em12(&mut self) -> EM12_W<'_, C1EMR1rs> {
        EM12_W::new(self, 12)
    }
    ///Bit 13 - Wake-up with event generation mask on event input 13
    #[inline(always)]
    pub fn em13(&mut self) -> EM13_W<'_, C1EMR1rs> {
        EM13_W::new(self, 13)
    }
    ///Bit 14 - Wake-up with event generation mask on event input 14
    #[inline(always)]
    pub fn em14(&mut self) -> EM14_W<'_, C1EMR1rs> {
        EM14_W::new(self, 14)
    }
    ///Bit 15 - Wake-up with event generation mask on event input 15
    #[inline(always)]
    pub fn em15(&mut self) -> EM15_W<'_, C1EMR1rs> {
        EM15_W::new(self, 15)
    }
    ///Bit 17 - Wake-up with event generation mask on event input 17
    #[inline(always)]
    pub fn em17(&mut self) -> EM17_W<'_, C1EMR1rs> {
        EM17_W::new(self, 17)
    }
    ///Bit 18 - Wake-up with event generation mask on event input 18
    #[inline(always)]
    pub fn em18(&mut self) -> EM18_W<'_, C1EMR1rs> {
        EM18_W::new(self, 18)
    }
    ///Bit 19 - Wake-up with event generation mask on event input 19
    #[inline(always)]
    pub fn em19(&mut self) -> EM19_W<'_, C1EMR1rs> {
        EM19_W::new(self, 19)
    }
    ///Bit 20 - Wake-up with event generation mask on event input 20
    #[inline(always)]
    pub fn em20(&mut self) -> EM20_W<'_, C1EMR1rs> {
        EM20_W::new(self, 20)
    }
    ///Bit 21 - Wake-up with event generation mask on event input 21
    #[inline(always)]
    pub fn em21(&mut self) -> EM21_W<'_, C1EMR1rs> {
        EM21_W::new(self, 21)
    }
    ///Bit 22 - Wake-up with event generation mask on event input 22
    #[inline(always)]
    pub fn em22(&mut self) -> EM22_W<'_, C1EMR1rs> {
        EM22_W::new(self, 22)
    }
}
