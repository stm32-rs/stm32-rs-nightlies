...
pub type WRP1B_STRT_W<'a, REG> = crate::FieldWriter<'a, REG, 7, u8, crate::Safe>;
...
pub type WRP1B_END_W<'a, REG> = crate::FieldWriter<'a, REG, 7, u8, crate::Safe>;
impl R {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#FLASH:WRP1BR)*/
pub struct WRP1BRrs;
