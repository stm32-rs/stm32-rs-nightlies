...
pub type PUPDR_R = crate::FieldReader<PULL>;
impl PUPDR_R {
...
pub type PUPDR_W<'a, REG> = crate::FieldWriter<'a, REG, 2, PULL>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#GPIOA:PUPDR)*/
pub struct PUPDRrs;
