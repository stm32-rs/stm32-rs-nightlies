...
pub use crate::stm32wl5x_cm0p::gpioa::ospeedr::OSPEEDR_R;
///Field `OSPEEDR(0-15)` writer - Port x configuration pin %s
pub use crate::stm32wl5x_cm0p::gpioa::ospeedr::OSPEEDR_W;
///Port x configuration pin %s
pub use crate::stm32wl5x_cm0p::gpioa::ospeedr::OUTPUT_SPEED;
impl R {
