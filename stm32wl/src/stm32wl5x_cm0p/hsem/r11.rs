...
#[doc = "`read()` method returns [r11::R](R) reader structure"]
impl crate::Readable for R11_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r11::W](W) writer structure"]
impl crate::Writable for R11_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R11 to value 0"]
