...
#[doc = "`read()` method returns [r14::R](R) reader structure"]
impl crate::Readable for R14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r14::W](W) writer structure"]
impl crate::Writable for R14_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R14 to value 0"]
