...
#[doc = "`read()` method returns [r15::R](R) reader structure"]
impl crate::Readable for R15_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r15::W](W) writer structure"]
impl crate::Writable for R15_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R15 to value 0"]
