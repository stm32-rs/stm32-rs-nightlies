...
#[doc = "IPCC Hardware configuration register"]
pub mod ipcc_hwcfgr;
#[doc = "IPCC IP Version register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ipcc_verr](ipcc_verr) module"]
pub type IPCC_VERR = crate::Reg<u32, _IPCC_VERR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _IPCC_VERR;
#[doc = "`read()` method returns [ipcc_verr::R](ipcc_verr::R) reader structure"]
impl crate::Readable for IPCC_VERR {}
#[doc = "IPCC IP Version register"]
pub mod ipcc_verr;
#[doc = "IPCC IP Identification register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ipcc_ipidr](ipcc_ipidr) module"]
pub type IPCC_IPIDR = crate::Reg<u32, _IPCC_IPIDR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _IPCC_IPIDR;
#[doc = "`read()` method returns [ipcc_ipidr::R](ipcc_ipidr::R) reader structure"]
impl crate::Readable for IPCC_IPIDR {}
#[doc = "IPCC IP Identification register"]
pub mod ipcc_ipidr;
#[doc = "IPCC Size ID register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ipcc_sidr](ipcc_sidr) module"]
pub type IPCC_SIDR = crate::Reg<u32, _IPCC_SIDR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _IPCC_SIDR;
#[doc = "`read()` method returns [ipcc_sidr::R](ipcc_sidr::R) reader structure"]
impl crate::Readable for IPCC_SIDR {}
#[doc = "IPCC Size ID register"]
pub mod ipcc_sidr;
