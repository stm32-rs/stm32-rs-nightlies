...
impl From<UECFW> for bool {
    #[inline(always)]
    fn from(variant: UECFW) -> Self {
        variant as u8 != 0
    }
}
///Field `UECF` writer - Update event clear flag
pub type UECF_W<'a, REG> = crate::BitWriter<'a, REG, UECFW>;
impl<'a, REG> UECF_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
...
impl From<REPOKCFW> for bool {
    #[inline(always)]
    fn from(variant: REPOKCFW) -> Self {
        variant as u8 != 0
    }
}
///Field `REPOKCF` writer - Repetition register update OK clear flag
pub type REPOKCF_W<'a, REG> = crate::BitWriter<'a, REG, REPOKCFW>;
impl<'a, REG> REPOKCF_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Clear REPOK flag
