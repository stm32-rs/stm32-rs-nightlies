...
impl W {
    ///Bit 0 - CPU2 TIM2 timer clock enable
    #[inline(always)]
    pub fn tim2en(&mut self) -> TIM2EN_W<'_, C2APB1ENR1rs> {
        TIM2EN_W::new(self, 0)
    }
    ///Bit 10 - CPU2 RTC APB clock enable
    #[inline(always)]
    pub fn rtcapben(&mut self) -> RTCAPBEN_W<'_, C2APB1ENR1rs> {
        RTCAPBEN_W::new(self, 10)
    }
    ///Bit 14 - CPU2 SPI2S2 clock enable
    #[inline(always)]
    pub fn spi2s2en(&mut self) -> SPI2S2EN_W<'_, C2APB1ENR1rs> {
        SPI2S2EN_W::new(self, 14)
    }
    ///Bit 17 - CPU2 USART2 clock enable
    #[inline(always)]
    pub fn usart2en(&mut self) -> USART2EN_W<'_, C2APB1ENR1rs> {
        USART2EN_W::new(self, 17)
    }
    ///Bit 21 - CPU2 I2C1 clocks enable
    #[inline(always)]
    pub fn i2c1en(&mut self) -> I2C1EN_W<'_, C2APB1ENR1rs> {
        I2C1EN_W::new(self, 21)
    }
    ///Bit 22 - CPU2 I2C2 clocks enable
    #[inline(always)]
    pub fn i2c2en(&mut self) -> I2C2EN_W<'_, C2APB1ENR1rs> {
        I2C2EN_W::new(self, 22)
    }
    ///Bit 23 - CPU2 I2C3 clocks enable
    #[inline(always)]
    pub fn i2c3en(&mut self) -> I2C3EN_W<'_, C2APB1ENR1rs> {
        I2C3EN_W::new(self, 23)
    }
    ///Bit 29 - CPU2 DAC1 clock enable
    #[inline(always)]
    pub fn dac1en(&mut self) -> DAC1EN_W<'_, C2APB1ENR1rs> {
        DAC1EN_W::new(self, 29)
    }
    ///Bit 31 - CPU2 Low power timer 1 clocks enable
    #[inline(always)]
    pub fn lptim1en(&mut self) -> LPTIM1EN_W<'_, C2APB1ENR1rs> {
