...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi2s2en(&mut self) -> SPI2S2EN_W<C2APB1ENR1rs> {
        SPI2S2EN_W::new(self, 14)
    }
    ///Bit 17 - CPU2 USART2 clock enable
    #[inline(always)]
    #[must_use]
    pub fn usart2en(&mut self) -> USART2EN_W<C2APB1ENR1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c2en(&mut self) -> I2C2EN_W<C2APB1ENR1rs> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac1en(&mut self) -> DAC1EN_W<C2APB1ENR1rs> {
