...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:MEMRMP)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:CFGR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:EXTICR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:EXTICR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:EXTICR3)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:CFGR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:SKR)

For information about available fields see [`mod@skr`] module*/
pub type SKR = crate::Reg<skr::SKRrs>;
///SKR
pub mod skr;
/**IMR1 (rw) register accessor: SYSCFG CPU1 interrupt mask register 1
...
pub mod imr1;
/**IMR2 (rw) register accessor: SYSCFG CPU1 interrupt mask register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:IMR2)
...
pub mod imr2;
/**C2IMR1 (rw) register accessor: SYSCFG CPU2 interrupt mask register 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:C2IMR1)
...
pub mod c2imr1;
/**C2IMR2 (rw) register accessor: SYSCFG CPU2 interrupt mask register 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:C2IMR2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#SYSCFG:RFDCR)
