...
#[doc = "Reader of field `AESIM`"]
pub type AESIM_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `AESIM`"]
...
#[doc = "Reader of field `DACIM`"]
pub type DACIM_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DACIM`"]
