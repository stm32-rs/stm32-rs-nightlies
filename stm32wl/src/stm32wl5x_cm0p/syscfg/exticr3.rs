...
pub use super::exticr2::EXTI7_R as EXTI8_R;
///Field `EXTI9` reader - EXTI 9 configuration bits
pub use super::exticr2::EXTI7_R as EXTI9_R;
///Field `EXTI10` reader - EXTI 10 configuration bits
pub use super::exticr2::EXTI7_R as EXTI10_R;
///Field `EXTI11` reader - EXTI 11 configuration bits
pub use super::exticr2::EXTI7_R as EXTI11_R;
///Field `EXTI8` writer - EXTI 8 configuration bits
pub use super::exticr2::EXTI7_W as EXTI8_W;
///Field `EXTI9` writer - EXTI 9 configuration bits
pub use super::exticr2::EXTI7_W as EXTI9_W;
///Field `EXTI10` writer - EXTI 10 configuration bits
pub use super::exticr2::EXTI7_W as EXTI10_W;
///Field `EXTI11` writer - EXTI 11 configuration bits
pub use super::exticr2::EXTI7_W as EXTI11_W;
