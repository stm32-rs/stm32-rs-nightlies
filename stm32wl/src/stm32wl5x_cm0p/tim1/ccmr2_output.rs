...
impl W {
    ...
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `CC3S` field.</div>
    #[inline(always)]
    pub fn ccs(&mut self, n: u8) -> CCS_W<'_, CCMR2_OUTPUTrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        CCS_W::new(self, n * 8)
    }
    ///Bits 0:1 - Capture/Compare 3 selection
    #[inline(always)]
    pub fn cc3s(&mut self) -> CCS_W<'_, CCMR2_OUTPUTrs> {
        CCS_W::new(self, 0)
    }
    ///Bits 8:9 - Capture/Compare 4 selection
    #[inline(always)]
    pub fn cc4s(&mut self) -> CCS_W<'_, CCMR2_OUTPUTrs> {
        CCS_W::new(self, 8)
    }
    ///Output compare (3-4) fast enable
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `OC3FE` field.</div>
    #[inline(always)]
    pub fn ocfe(&mut self, n: u8) -> OCFE_W<'_, CCMR2_OUTPUTrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 2 - Output compare 3 fast enable
    #[inline(always)]
    pub fn oc3fe(&mut self) -> OCFE_W<'_, CCMR2_OUTPUTrs> {
        OCFE_W::new(self, 2)
    }
    ///Bit 10 - Output compare 4 fast enable
    #[inline(always)]
    pub fn oc4fe(&mut self) -> OCFE_W<'_, CCMR2_OUTPUTrs> {
        OCFE_W::new(self, 10)
    }
    ///Output compare (3-4) preload enable
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `OC3PE` field.</div>
    #[inline(always)]
    pub fn ocpe(&mut self, n: u8) -> OCPE_W<'_, CCMR2_OUTPUTrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 3 - Output compare 3 preload enable
    #[inline(always)]
    pub fn oc3pe(&mut self) -> OCPE_W<'_, CCMR2_OUTPUTrs> {
        OCPE_W::new(self, 3)
    }
    ///Bit 11 - Output compare 4 preload enable
    #[inline(always)]
    pub fn oc4pe(&mut self) -> OCPE_W<'_, CCMR2_OUTPUTrs> {
        OCPE_W::new(self, 11)
    }
    ///Output compare (3-4) mode
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `OC3M` field.</div>
    #[inline(always)]
    pub fn ocm(&mut self, n: u8) -> OCM_W<'_, CCMR2_OUTPUTrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bits 4:6 - Output compare 3 mode
    #[inline(always)]
    pub fn oc3m(&mut self) -> OCM_W<'_, CCMR2_OUTPUTrs> {
        OCM_W::new(self, 4)
    }
    ///Bits 12:14 - Output compare 4 mode
    #[inline(always)]
    pub fn oc4m(&mut self) -> OCM_W<'_, CCMR2_OUTPUTrs> {
        OCM_W::new(self, 12)
    }
    ///Output compare (3-4) clear enable
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `OC3CE` field.</div>
    #[inline(always)]
    pub fn occe(&mut self, n: u8) -> OCCE_W<'_, CCMR2_OUTPUTrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 7 - Output compare 3 clear enable
    #[inline(always)]
    pub fn oc3ce(&mut self) -> OCCE_W<'_, CCMR2_OUTPUTrs> {
        OCCE_W::new(self, 7)
    }
    ///Bit 15 - Output compare 4 clear enable
    #[inline(always)]
    pub fn oc4ce(&mut self) -> OCCE_W<'_, CCMR2_OUTPUTrs> {
        OCCE_W::new(self, 15)
    }
    ///Output compare (3-4) mode, bit 3
    ///
    ///<div class="warning">`n` is number of field in register. `n == 0` corresponds to `OC3M_3` field.</div>
    #[inline(always)]
    pub fn ocm_3(&mut self, n: u8) -> OCM_3_W<'_, CCMR2_OUTPUTrs> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    ///Bit 16 - Output compare 3 mode, bit 3
    #[inline(always)]
    pub fn oc3m_3(&mut self) -> OCM_3_W<'_, CCMR2_OUTPUTrs> {
        OCM_3_W::new(self, 16)
    }
    ///Bit 24 - Output compare 4 mode, bit 3
    #[inline(always)]
    pub fn oc4m_3(&mut self) -> OCM_3_W<'_, CCMR2_OUTPUTrs> {
        OCM_3_W::new(self, 24)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#TIM1:CCMR2_Output)*/
