...
impl TXFTCFG_R {
    ...
    #[doc = "Checks if the value of the field is `DEPTH_1_8`"]
    #[inline(always)]
    pub fn is_depth_1_8(&self) -> bool {
        **self == TXFTCFG_A::DEPTH_1_8
    }
    #[doc = "Checks if the value of the field is `DEPTH_1_4`"]
    #[inline(always)]
    pub fn is_depth_1_4(&self) -> bool {
        **self == TXFTCFG_A::DEPTH_1_4
    }
    #[doc = "Checks if the value of the field is `DEPTH_1_2`"]
    #[inline(always)]
    pub fn is_depth_1_2(&self) -> bool {
        **self == TXFTCFG_A::DEPTH_1_2
    }
    #[doc = "Checks if the value of the field is `DEPTH_3_4`"]
    #[inline(always)]
    pub fn is_depth_3_4(&self) -> bool {
        **self == TXFTCFG_A::DEPTH_3_4
    }
    #[doc = "Checks if the value of the field is `DEPTH_7_8`"]
    #[inline(always)]
