...
impl WDGTB_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<WDGTB> {
        match self.bits {
            0 => Some(WDGTB::Div1),
            1 => Some(WDGTB::Div2),
            2 => Some(WDGTB::Div4),
...
pub type WDGTB_W<'a, REG> = crate::FieldWriter<'a, REG, 3, WDGTB>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM0P.html#WWDG:CFR)*/
pub struct CFRrs;
