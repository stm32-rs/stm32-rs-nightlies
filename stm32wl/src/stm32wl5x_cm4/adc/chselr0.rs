...
///Field `CHSEL(0-17)` reader - Channel-%s selection
...
///Field `CHSEL(0-17)` writer - Channel-%s selection
...
impl R {
    ...
    pub fn chsel_iter(&self) -> impl Iterator<Item = CHSEL_R> + '_ {
        (0..18).map(move |n| CHSEL_R::new(((self.bits >> n) & 1) != 0))
    }
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#ADC:CHSELR0)*/
