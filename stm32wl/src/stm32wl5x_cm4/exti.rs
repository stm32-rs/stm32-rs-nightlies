...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#EXTI:RTSR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#EXTI:SWIER1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#EXTI:PR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#EXTI:RTSR2)
...
///pending register
pub mod pr2;
/**C1IMR1 (rw) register accessor: interrupt mask register
...
pub mod c1imr1;
/**C1EMR1 (rw) register accessor: event mask register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#EXTI:C1EMR1)
...
///event mask register
pub mod c1emr1;
/**C1IMR2 (rw) register accessor: wakeup with interrupt mask register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#EXTI:C1IMR2)
...
pub mod c1imr2;
/**C1EMR2 (rw) register accessor: wakeup with event mask register
...
pub mod c1emr2;
/**C2IMR1 (rw) register accessor: interrupt mask register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#EXTI:C2IMR1)
...
///interrupt mask register
pub mod c2imr1;
/**C2EMR1 (rw) register accessor: event mask register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#EXTI:C2EMR1)
...
///event mask register
pub mod c2emr1;
/**C2IMR2 (rw) register accessor: wakeup with interrupt mask register
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#EXTI:C2IMR2)
...
///wakeup with interrupt mask register
pub mod c2imr2;
/**C2EMR2 (rw) register accessor: wakeup with event mask register
