...
impl W {
    ///Bit 2 - Wake-up with interrupt mask on event input 34
    #[inline(always)]
    pub fn im34(&mut self) -> IM34_W<'_, C2IMR2rs> {
        IM34_W::new(self, 2)
    }
    ///Bit 4 - Wake-up with interrupt mask on event input 36
    #[inline(always)]
    pub fn im36(&mut self) -> IM36_W<'_, C2IMR2rs> {
        IM36_W::new(self, 4)
    }
    ///Bit 5 - Wake-up with interrupt mask on event input 37
    #[inline(always)]
    pub fn im37(&mut self) -> IM37_W<'_, C2IMR2rs> {
        IM37_W::new(self, 5)
    }
    ///Bit 6 - Wake-up with interrupt mask on event input 38
    #[inline(always)]
    pub fn im38(&mut self) -> IM38_W<'_, C2IMR2rs> {
        IM38_W::new(self, 6)
    }
    ///Bit 7 - Wake-up with interrupt mask on event input 39
    #[inline(always)]
    pub fn im39(&mut self) -> IM39_W<'_, C2IMR2rs> {
        IM39_W::new(self, 7)
    }
    ///Bit 8 - Wake-up with interrupt mask on event input 40
    #[inline(always)]
    pub fn im40(&mut self) -> IM40_W<'_, C2IMR2rs> {
        IM40_W::new(self, 8)
    }
    ///Bit 9 - Wake-up with interrupt mask on event input 41
    #[inline(always)]
    pub fn im41(&mut self) -> IM41_W<'_, C2IMR2rs> {
        IM41_W::new(self, 9)
    }
    ///Bit 10 - Wake-up with interrupt mask on event input 42
    #[inline(always)]
    pub fn im42(&mut self) -> IM42_W<'_, C2IMR2rs> {
        IM42_W::new(self, 10)
    }
    ///Bit 11 - Wake-up with interrupt mask on event input 43
    #[inline(always)]
    pub fn im43(&mut self) -> IM43_W<'_, C2IMR2rs> {
        IM43_W::new(self, 11)
    }
    ///Bit 12 - Wake-up with interrupt mask on event input 44
    #[inline(always)]
    pub fn im44(&mut self) -> IM44_W<'_, C2IMR2rs> {
        IM44_W::new(self, 12)
    }
    ///Bit 13 - Wake-up with interrupt mask on event input 45
    #[inline(always)]
    pub fn im45(&mut self) -> IM45_W<'_, C2IMR2rs> {
        IM45_W::new(self, 13)
    }
    ///Bit 14 - Wake-up with interrupt mask on event input 46
    #[inline(always)]
    pub fn im46(&mut self) -> IM46_W<'_, C2IMR2rs> {
        IM46_W::new(self, 14)
    }
}
