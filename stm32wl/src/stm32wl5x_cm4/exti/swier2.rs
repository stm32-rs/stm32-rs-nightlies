...
/**software interrupt on event 34
...
///Field `SWI34` reader - software interrupt on event 34
...
///Field `SWI34` writer - software interrupt on event 34
...
///Field `SWI40` reader - software interrupt on event 40
pub use SWI34_R as SWI40_R;
///Field `SWI41` reader - software interrupt on event 41
pub use SWI34_R as SWI41_R;
///Field `SWI45` reader - software interrupt on event 45 A software interrupt is generated independently from the setting in EXTI_RTSR and EXTI_FTSR. This bit always returns 0 when read. This bit is automatically cleared by hardware.
pub use SWI34_R as SWI45_R;
///Field `SWI40` writer - software interrupt on event 40
pub use SWI34_W as SWI40_W;
///Field `SWI41` writer - software interrupt on event 41
pub use SWI34_W as SWI41_W;
///Field `SWI45` writer - software interrupt on event 45 A software interrupt is generated independently from the setting in EXTI_RTSR and EXTI_FTSR. This bit always returns 0 when read. This bit is automatically cleared by hardware.
pub use SWI34_W as SWI45_W;
impl R {
    ///Bit 2 - software interrupt on event 34
    #[inline(always)]
    pub fn swi34(&self) -> SWI34_R {
        SWI34_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 8 - software interrupt on event 40
    #[inline(always)]
    pub fn swi40(&self) -> SWI40_R {
        SWI40_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - software interrupt on event 41
    #[inline(always)]
    pub fn swi41(&self) -> SWI41_R {
        SWI41_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 13 - software interrupt on event 45 A software interrupt is generated independently from the setting in EXTI_RTSR and EXTI_FTSR. This bit always returns 0 when read. This bit is automatically cleared by hardware.
    #[inline(always)]
