...
impl W {
    ///Bit 0 - CH1OM
    #[inline(always)]
    pub fn ch1om(&mut self) -> CH1OM_W<'_, C1MRrs> {
        CH1OM_W::new(self, 0)
    }
    ///Bit 1 - CH2OM
    #[inline(always)]
    pub fn ch2om(&mut self) -> CH2OM_W<'_, C1MRrs> {
        CH2OM_W::new(self, 1)
    }
    ///Bit 2 - CH3OM
    #[inline(always)]
    pub fn ch3om(&mut self) -> CH3OM_W<'_, C1MRrs> {
        CH3OM_W::new(self, 2)
    }
    ///Bit 3 - CH4OM
    #[inline(always)]
    pub fn ch4om(&mut self) -> CH4OM_W<'_, C1MRrs> {
        CH4OM_W::new(self, 3)
    }
    ///Bit 4 - CH5OM
    #[inline(always)]
    pub fn ch5om(&mut self) -> CH5OM_W<'_, C1MRrs> {
        CH5OM_W::new(self, 4)
    }
    ///Bit 5 - CH6OM
    #[inline(always)]
    pub fn ch6om(&mut self) -> CH6OM_W<'_, C1MRrs> {
        CH6OM_W::new(self, 5)
    }
    ///Bit 16 - CH1FM
    #[inline(always)]
    pub fn ch1fm(&mut self) -> CH1FM_W<'_, C1MRrs> {
        CH1FM_W::new(self, 16)
    }
    ///Bit 17 - CH2FM
    #[inline(always)]
    pub fn ch2fm(&mut self) -> CH2FM_W<'_, C1MRrs> {
        CH2FM_W::new(self, 17)
    }
    ///Bit 18 - CH3FM
    #[inline(always)]
    pub fn ch3fm(&mut self) -> CH3FM_W<'_, C1MRrs> {
        CH3FM_W::new(self, 18)
    }
    ///Bit 19 - CH4FM
    #[inline(always)]
    pub fn ch4fm(&mut self) -> CH4FM_W<'_, C1MRrs> {
        CH4FM_W::new(self, 19)
    }
    ///Bit 20 - CH5FM
    #[inline(always)]
    pub fn ch5fm(&mut self) -> CH5FM_W<'_, C1MRrs> {
        CH5FM_W::new(self, 20)
    }
    ///Bit 21 - CH6FM
    #[inline(always)]
    pub fn ch6fm(&mut self) -> CH6FM_W<'_, C1MRrs> {
        CH6FM_W::new(self, 21)
    }
}
