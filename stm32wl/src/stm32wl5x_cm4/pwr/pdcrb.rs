...
pub enum PD0 {
    ///0: Disable the pull-down on PB\[y\] when both APC bits are set in PWR control register 3 (PWR_CR3)
    Disabled = 0,
    ///1: Enable the pull-down on PB\[y\] when both APC bits are set in PWR control register 3 (PWR_CR3)
    Enabled = 1,
}
...
///Field `PD3` reader - Port PB\[y\] pull-down (y=0 to 3)
...
///Field `PD3` writer - Port PB\[y\] pull-down (y=0 to 3)
...
///Field `PD15` reader - Port PB\[y\] pull-down (y=5 to 15)
...
///Field `PD15` writer - Port PB\[y\] pull-down (y=5 to 15)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#PWR:PDCRB)*/
pub struct PDCRBrs;
