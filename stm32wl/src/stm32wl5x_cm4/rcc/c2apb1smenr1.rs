...
impl W {
    ...
    ///Bit 14 - SPI2S2 clock enable during CPU2 CSleep mode.
    #[inline(always)]
    pub fn spi2s2smen(&mut self) -> SPI2S2SMEN_W<'_, C2APB1SMENR1rs> {
        SPI2S2SMEN_W::new(self, 14)
    }
    ///Bit 17 - USART2 clock enable during CPU2 CSleep mode.
    #[inline(always)]
    pub fn usart2smen(&mut self) -> USART2SMEN_W<'_, C2APB1SMENR1rs> {
    ...
    ///Bit 22 - I2C2 clock enable during CPU2 CSleep and CStop modes
    #[inline(always)]
    pub fn i2c2smen(&mut self) -> I2C2SMEN_W<'_, C2APB1SMENR1rs> {
    ...
    ///Bit 29 - DAC1 clock enable during CPU2 CSleep mode.
    #[inline(always)]
    pub fn dac1smen(&mut self) -> DAC1SMEN_W<'_, C2APB1SMENR1rs> {
