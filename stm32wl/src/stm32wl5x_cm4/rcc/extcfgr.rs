...
///Field `C2HPRE` reader - dual core device only\] HCLK2 prescaler (CPU2)
pub type C2HPRE_R = crate::FieldReader;
///Field `C2HPRE` writer - dual core device only\] HCLK2 prescaler (CPU2)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WL5X_CM4.html#RCC:EXTCFGR)*/
