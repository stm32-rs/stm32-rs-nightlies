...
impl W {
    ///Bit 0 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im0(&mut self) -> IM0_W<'_, C1IMR1rs> {
        IM0_W::new(self, 0)
    }
    ///Bit 1 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im1(&mut self) -> IM1_W<'_, C1IMR1rs> {
        IM1_W::new(self, 1)
    }
    ///Bit 2 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im2(&mut self) -> IM2_W<'_, C1IMR1rs> {
        IM2_W::new(self, 2)
    }
    ///Bit 3 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im3(&mut self) -> IM3_W<'_, C1IMR1rs> {
        IM3_W::new(self, 3)
    }
    ///Bit 4 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im4(&mut self) -> IM4_W<'_, C1IMR1rs> {
        IM4_W::new(self, 4)
    }
    ///Bit 5 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im5(&mut self) -> IM5_W<'_, C1IMR1rs> {
        IM5_W::new(self, 5)
    }
    ///Bit 6 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im6(&mut self) -> IM6_W<'_, C1IMR1rs> {
        IM6_W::new(self, 6)
    }
    ///Bit 7 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im7(&mut self) -> IM7_W<'_, C1IMR1rs> {
        IM7_W::new(self, 7)
    }
    ///Bit 8 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im8(&mut self) -> IM8_W<'_, C1IMR1rs> {
        IM8_W::new(self, 8)
    }
    ///Bit 9 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im9(&mut self) -> IM9_W<'_, C1IMR1rs> {
        IM9_W::new(self, 9)
    }
    ///Bit 10 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im10(&mut self) -> IM10_W<'_, C1IMR1rs> {
        IM10_W::new(self, 10)
    }
    ///Bit 11 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im11(&mut self) -> IM11_W<'_, C1IMR1rs> {
        IM11_W::new(self, 11)
    }
    ///Bit 12 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im12(&mut self) -> IM12_W<'_, C1IMR1rs> {
        IM12_W::new(self, 12)
    }
    ///Bit 13 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im13(&mut self) -> IM13_W<'_, C1IMR1rs> {
        IM13_W::new(self, 13)
    }
    ///Bit 14 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im14(&mut self) -> IM14_W<'_, C1IMR1rs> {
        IM14_W::new(self, 14)
    }
    ///Bit 15 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im15(&mut self) -> IM15_W<'_, C1IMR1rs> {
        IM15_W::new(self, 15)
    }
    ///Bit 16 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im16(&mut self) -> IM16_W<'_, C1IMR1rs> {
        IM16_W::new(self, 16)
    }
    ///Bit 17 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im17(&mut self) -> IM17_W<'_, C1IMR1rs> {
        IM17_W::new(self, 17)
    }
    ///Bit 18 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im18(&mut self) -> IM18_W<'_, C1IMR1rs> {
        IM18_W::new(self, 18)
    }
    ///Bit 19 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im19(&mut self) -> IM19_W<'_, C1IMR1rs> {
        IM19_W::new(self, 19)
    }
    ///Bit 20 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im20(&mut self) -> IM20_W<'_, C1IMR1rs> {
        IM20_W::new(self, 20)
    }
    ///Bit 21 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im21(&mut self) -> IM21_W<'_, C1IMR1rs> {
        IM21_W::new(self, 21)
    }
    ///Bit 22 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im22(&mut self) -> IM22_W<'_, C1IMR1rs> {
        IM22_W::new(self, 22)
    }
    ///Bit 23 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im23(&mut self) -> IM23_W<'_, C1IMR1rs> {
        IM23_W::new(self, 23)
    }
    ///Bit 24 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im24(&mut self) -> IM24_W<'_, C1IMR1rs> {
        IM24_W::new(self, 24)
    }
    ///Bit 25 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im25(&mut self) -> IM25_W<'_, C1IMR1rs> {
        IM25_W::new(self, 25)
    }
    ///Bit 26 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im26(&mut self) -> IM26_W<'_, C1IMR1rs> {
        IM26_W::new(self, 26)
    }
    ///Bit 27 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im27(&mut self) -> IM27_W<'_, C1IMR1rs> {
        IM27_W::new(self, 27)
    }
    ///Bit 28 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im28(&mut self) -> IM28_W<'_, C1IMR1rs> {
        IM28_W::new(self, 28)
    }
    ///Bit 29 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im29(&mut self) -> IM29_W<'_, C1IMR1rs> {
        IM29_W::new(self, 29)
    }
    ///Bit 30 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im30(&mut self) -> IM30_W<'_, C1IMR1rs> {
        IM30_W::new(self, 30)
    }
    ///Bit 31 - wakeup with interrupt Mask on event input
    #[inline(always)]
    pub fn im31(&mut self) -> IM31_W<'_, C1IMR1rs> {
        IM31_W::new(self, 31)
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WLE5.html#EXTI:C1IMR1)*/
pub struct C1IMR1rs;
