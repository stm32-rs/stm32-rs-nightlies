...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn im0(&mut self) -> IM0_W<C1IMR1rs> {
        IM0_W::new(self, 0)
    }
    #[doc = "Bit 1 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im1(&mut self) -> IM1_W<C1IMR1rs> {
        IM1_W::new(self, 1)
    }
    #[doc = "Bit 2 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im2(&mut self) -> IM2_W<C1IMR1rs> {
        IM2_W::new(self, 2)
    }
    #[doc = "Bit 3 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im3(&mut self) -> IM3_W<C1IMR1rs> {
        IM3_W::new(self, 3)
    }
    #[doc = "Bit 4 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im4(&mut self) -> IM4_W<C1IMR1rs> {
        IM4_W::new(self, 4)
    }
    #[doc = "Bit 5 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im5(&mut self) -> IM5_W<C1IMR1rs> {
        IM5_W::new(self, 5)
    }
    #[doc = "Bit 6 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im6(&mut self) -> IM6_W<C1IMR1rs> {
        IM6_W::new(self, 6)
    }
    #[doc = "Bit 7 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im7(&mut self) -> IM7_W<C1IMR1rs> {
        IM7_W::new(self, 7)
    }
    #[doc = "Bit 8 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im8(&mut self) -> IM8_W<C1IMR1rs> {
        IM8_W::new(self, 8)
    }
    #[doc = "Bit 9 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im9(&mut self) -> IM9_W<C1IMR1rs> {
        IM9_W::new(self, 9)
    }
    #[doc = "Bit 10 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im10(&mut self) -> IM10_W<C1IMR1rs> {
        IM10_W::new(self, 10)
    }
    #[doc = "Bit 11 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im11(&mut self) -> IM11_W<C1IMR1rs> {
        IM11_W::new(self, 11)
    }
    #[doc = "Bit 12 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im12(&mut self) -> IM12_W<C1IMR1rs> {
        IM12_W::new(self, 12)
    }
    #[doc = "Bit 13 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im13(&mut self) -> IM13_W<C1IMR1rs> {
        IM13_W::new(self, 13)
    }
    #[doc = "Bit 14 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im14(&mut self) -> IM14_W<C1IMR1rs> {
        IM14_W::new(self, 14)
    }
    #[doc = "Bit 15 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im15(&mut self) -> IM15_W<C1IMR1rs> {
        IM15_W::new(self, 15)
    }
    #[doc = "Bit 16 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im16(&mut self) -> IM16_W<C1IMR1rs> {
        IM16_W::new(self, 16)
    }
    #[doc = "Bit 17 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im17(&mut self) -> IM17_W<C1IMR1rs> {
        IM17_W::new(self, 17)
    }
    #[doc = "Bit 18 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im18(&mut self) -> IM18_W<C1IMR1rs> {
        IM18_W::new(self, 18)
    }
    #[doc = "Bit 19 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im19(&mut self) -> IM19_W<C1IMR1rs> {
        IM19_W::new(self, 19)
    }
    #[doc = "Bit 20 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im20(&mut self) -> IM20_W<C1IMR1rs> {
        IM20_W::new(self, 20)
    }
    #[doc = "Bit 21 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im21(&mut self) -> IM21_W<C1IMR1rs> {
        IM21_W::new(self, 21)
    }
    #[doc = "Bit 22 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im22(&mut self) -> IM22_W<C1IMR1rs> {
        IM22_W::new(self, 22)
    }
    #[doc = "Bit 23 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im23(&mut self) -> IM23_W<C1IMR1rs> {
        IM23_W::new(self, 23)
    }
    #[doc = "Bit 24 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im24(&mut self) -> IM24_W<C1IMR1rs> {
        IM24_W::new(self, 24)
    }
    #[doc = "Bit 25 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im25(&mut self) -> IM25_W<C1IMR1rs> {
        IM25_W::new(self, 25)
    }
    #[doc = "Bit 26 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im26(&mut self) -> IM26_W<C1IMR1rs> {
        IM26_W::new(self, 26)
    }
    #[doc = "Bit 27 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im27(&mut self) -> IM27_W<C1IMR1rs> {
        IM27_W::new(self, 27)
    }
    #[doc = "Bit 28 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im28(&mut self) -> IM28_W<C1IMR1rs> {
        IM28_W::new(self, 28)
    }
    #[doc = "Bit 29 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im29(&mut self) -> IM29_W<C1IMR1rs> {
        IM29_W::new(self, 29)
    }
    #[doc = "Bit 30 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im30(&mut self) -> IM30_W<C1IMR1rs> {
        IM30_W::new(self, 30)
    }
    #[doc = "Bit 31 - wakeup with interrupt Mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im31(&mut self) -> IM31_W<C1IMR1rs> {
        IM31_W::new(self, 31)
    }
}
