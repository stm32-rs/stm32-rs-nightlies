...
pub type AFRL3_R = crate::FieldReader<ALTERNATE_FUNCTION>;
impl AFRL3_R {
...
pub type AFRL3_W<'a, REG> = crate::FieldWriter<'a, REG, 4, ALTERNATE_FUNCTION, crate::Safe>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WLE5.html#GPIOH:AFRL)*/
pub struct AFRLrs;
