...
#[doc = "`read()` method returns [r13::R](R) reader structure"]
impl crate::Readable for R13_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r13::W](W) writer structure"]
impl crate::Writable for R13_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R13 to value 0"]
