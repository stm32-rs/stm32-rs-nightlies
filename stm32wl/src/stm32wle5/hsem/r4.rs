...
#[doc = "`read()` method returns [r4::R](R) reader structure"]
impl crate::Readable for R4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r4::W](W) writer structure"]
impl crate::Writable for R4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R4 to value 0"]
