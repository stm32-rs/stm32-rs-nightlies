#[doc = "Reader of register CR1_enabled"]
pub type R = crate::R<u32, super::CR1_ENABLED>;
#[doc = "Writer for register CR1_enabled"]
pub type W = crate::W<u32, super::CR1_ENABLED>;
#[doc = "Register CR1_enabled `reset()`'s with value 0"]
impl crate::ResetValue for super::CR1_ENABLED {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `TXFNFIE`"]
pub type TXFNFIE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TXFNFIE`"]
