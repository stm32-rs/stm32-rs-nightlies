...
///Field `PU15` reader - Port PB\[y\] pull-up (y=0 to 15)
...
///Field `PU15` writer - Port PB\[y\] pull-up (y=0 to 15)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WLE5.html#PWR:PUCRB)*/
pub struct PUCRBrs;
