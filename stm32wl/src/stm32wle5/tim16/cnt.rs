...
pub type UIFCPYOR_RES_R = crate::BitReader;
impl R {
    ///Bits 0:15 - CNT
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CNT")
            .field("uifcpyor_res", &self.uifcpyor_res())
            .field("cnt", &self.cnt())
            .finish()
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32WLE5.html#TIM16:CNT)*/
pub struct CNTrs;
